...
# %bb.26:
	...
	move	$a2, $a3
	b	.LBB4_36
.LBB4_27:                               # %vector.main.loop.iter.check102
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB4_32
# %bb.28:
	move	$a4, $zero
	move	$a6, $zero
.LBB4_29:                               # %vec.epilog.ph126
	move	$a5, $a0
	...
	vld	$vr1, $a6, %pc_lo12(.LCPI4_0)
	sub.d	$a4, $s2, $a4
	addi.d	$a4, $a4, -8
	xvrepli.w	$xr2, -48
	.p2align	4, , 16
.LBB4_30:                               # %vec.epilog.vector.body129
                                        # =>This Inner Loop Header: Depth=1
	ldx.d	$a6, $a4, $a0
	...
	addi.d	$a4, $a4, -8
	bnez	$a3, .LBB4_30
# %bb.31:                               # %vec.epilog.middle.block136
...
# %bb.34:                               # %middle.block117
	...
	xvpickve2gr.d	$a6, $xr0, 0
	beq	$a0, $a4, .LBB4_37
# %bb.35:                               # %vec.epilog.iter.check124
	bnez	$a5, .LBB4_29
	.p2align	4, , 16
.LBB4_36:                               # %.lr.ph65
                                        # =>This Inner Loop Header: Depth=1
...
.LBB4_42:                               # %.preheader
	...
	ld.b	$a0, $s7, 0
	blt	$a0, $s8, .LBB4_41
# %bb.43:                               # %.lr.ph68.preheader
                                        #   in Loop: Header=BB4_42 Depth=1
	move	$s6, $zero
	b	.LBB4_46
	.p2align	4, , 16
.LBB4_44:                               # %._crit_edge.thread.i
                                        #   in Loop: Header=BB4_46 Depth=2
	addi.d	$a1, $a1, 1
.LBB4_45:                               # %_F_stradd.exit
                                        #   in Loop: Header=BB4_46 Depth=2
...
.LBB4_53:                               #   in Loop: Header=BB4_49 Depth=3
	...
	addi.d	$a4, $a4, -48
	addi.d	$a0, $a0, -1
.LBB4_54:                               #   in Loop: Header=BB4_49 Depth=3
	add.d	$a1, $a1, $a2
	add.w	$a6, $a1, $a4
	slt	$a2, $fp, $a6
	addi.d	$a1, $a6, 246
...
# %bb.56:                               # %._crit_edge.i
                                        #   in Loop: Header=BB4_46 Depth=2
	blt	$a6, $s0, .LBB4_44
# %bb.57:                               #   in Loop: Header=BB4_46 Depth=2
	st.b	$s8, $a1, 0
	b	.LBB4_45
.LBB4_58:
	ori	$a1, $zero, 1
