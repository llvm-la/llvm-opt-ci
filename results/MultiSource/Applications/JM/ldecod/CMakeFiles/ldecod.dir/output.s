...
.LBB3_102:                              # %.preheader.i244
	sub.w	$a0, $fp, $a2
	st.d	$a0, $sp, 128                   # 8-byte Folded Spill
	bge	$s6, $a0, .LBB3_128
# %bb.103:                              # %.lr.ph143.i246
	st.d	$fp, $sp, 104                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	sub.w	$fp, $s2, $a0
	bge	$a1, $fp, .LBB3_127
# %bb.104:                              # %.lr.ph.us.preheader.i247
	st.d	$s8, $sp, 64                    # 8-byte Folded Spill
	move	$s4, $zero
	slli.d	$a0, $a1, 1
	st.d	$a0, $sp, 120                   # 8-byte Folded Spill
...
.LBB3_105:                              # %.lr.ph.us.i248
	...
	move	$s5, $a1
	.p2align	4, , 16
.LBB3_106:                              #   Parent Loop BB3_105 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a0, $s0, $s7
	move	$a1, $s2
	move	$a2, $s1
...
# %bb.110:
	...
	move	$s1, $s3
	bnez	$a0, .LBB3_102
# %bb.111:                              # %.preheader135.i229
	blez	$s2, .LBB3_128
# %bb.112:                              # %.preheader135.i229
	blez	$fp, .LBB3_128
# %bb.113:                              # %.preheader134.us.preheader.i231
	move	$a0, $zero
	slli.d	$a1, $s2, 1
	move	$a2, $s0
	.p2align	4, , 16
.LBB3_114:                              # %.preheader134.us.i234
                                        # =>This Loop Header: Depth=1
	...
	alsl.d	$a4, $a0, $a4, 3
	.p2align	4, , 16
.LBB3_115:                              #   Parent Loop BB3_114 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	ldx.b	$a5, $a5, $a3
	st.b	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 1
	bne	$a1, $a3, .LBB3_115
# %bb.116:                              # %._crit_edge.us.i241
                                        #   in Loop: Header=BB3_114 Depth=1
	addi.d	$a0, $a0, 1
	bne	$a0, $fp, .LBB3_114
# %bb.117:                              # %img2buf.exit255.loopexit318
	ld.w	$a0, $s4, 16
	ld.w	$fp, $s4, 20
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	sub.d	$s7, $a0, $a1
...
# %bb.121:                              # %.preheader135.i258
	addi.w	$a1, $t5, 0
	blt	$a1, $a0, .LBB3_97
# %bb.122:                              # %.preheader134.us.preheader.i260
	move	$a0, $zero
	move	$a1, $s0
	.p2align	4, , 16
.LBB3_123:                              # %.preheader134.us.i263
                                        # =>This Loop Header: Depth=1
	...
	move	$a4, $t7
	.p2align	4, , 16
.LBB3_124:                              #   Parent Loop BB3_123 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a3, 0
	ldx.b	$a5, $a5, $a2
	st.b	$a5, $a1, 0
	...
	addi.d	$a2, $a2, 2
	bnez	$a4, .LBB3_124
# %bb.125:                              # %._crit_edge.us.i270
                                        #   in Loop: Header=BB3_123 Depth=1
	addi.d	$a0, $a0, 1
	bne	$a0, $s2, .LBB3_123
# %bb.126:                              # %img2buf.exit284.loopexit316
	ld.w	$t6, $fp, 12
	ld.w	$t5, $fp, 8
	b	.LBB3_97
.LBB3_127:
	ld.d	$fp, $sp, 104                   # 8-byte Folded Reload
.LBB3_128:                              # %img2buf.exit255
	sub.d	$a0, $fp, $s8
	mul.d	$a0, $a0, $s3
	mul.w	$a2, $a0, $s7
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
...
.LBB6_32:                               # %vec.epilog.scalar.ph93.preheader
	...
	sub.d	$t6, $a3, $t6
	.p2align	4, , 16
.LBB6_33:                               # %vec.epilog.scalar.ph93
                                        #   Parent Loop BB6_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a5, $t5, 0
	addi.d	$t6, $t6, -1
...
.LBB6_48:                               # %vec.epilog.scalar.ph122.preheader
	...
	sub.d	$t4, $a3, $t4
	.p2align	4, , 16
.LBB6_49:                               # %vec.epilog.scalar.ph122
                                        #   Parent Loop BB6_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a0, $t3, 0
	addi.d	$t4, $t4, -1
...
.LBB7_33:                               # %vec.epilog.scalar.ph108.preheader
	...
	alsl.d	$t8, $s3, $t8, 1
	.p2align	4, , 16
.LBB7_34:                               # %vec.epilog.scalar.ph108
                                        #   Parent Loop BB7_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$t1, $t8, 0
	addi.d	$s2, $s2, -1
...
.LBB7_48:                               # %vec.epilog.scalar.ph137.preheader
	...
	alsl.d	$t3, $t5, $t3, 1
	.p2align	4, , 16
.LBB7_49:                               # %vec.epilog.scalar.ph137
                                        #   Parent Loop BB7_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a3, $t3, 0
	addi.d	$t4, $t4, -1
...
.LBB7_67:                               # %vec.epilog.scalar.ph166.preheader
	...
	alsl.d	$t4, $t6, $t4, 1
	.p2align	4, , 16
.LBB7_68:                               # %vec.epilog.scalar.ph166
                                        #   Parent Loop BB7_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a4, $t4, 0
	addi.d	$t5, $t5, -1
...
.LBB7_99:                               # %vec.epilog.scalar.ph224.preheader
	...
	alsl.d	$t4, $t6, $t4, 1
	.p2align	4, , 16
.LBB7_100:                              # %vec.epilog.scalar.ph224
                                        #   Parent Loop BB7_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a4, $t4, 0
	addi.d	$t5, $t5, -1
