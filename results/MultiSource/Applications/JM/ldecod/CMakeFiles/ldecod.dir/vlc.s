...
# %bb.1:
	move	$t4, $zero
	ori	$a5, $zero, 1
.LBB0_2:                                # %GetVLCSymbol.exit.thread18.i
	add.d	$a0, $a5, $a0
	st.w	$a0, $a1, 8
	bstrpick.d	$a0, $a5, 32, 1
	sll.w	$a0, $a2, $a0
	add.d	$a0, $t4, $a0
	addi.d	$a0, $a0, -1
	move	$t1, $a5
	b	.LBB0_10
.LBB0_3:                                # %.lr.ph.i.preheader.i
	move	$a6, $zero
	ld.w	$a7, $a1, 12
	xori	$t0, $a5, 7
	ori	$a5, $zero, 1
...
# %bb.0:
	...
	andi	$a5, $a5, 128
	beqz	$a5, .LBB2_4
# %bb.1:                                # %GetVLCSymbol.exit.thread18
	move	$t0, $zero
	ori	$a4, $zero, 1
	st.d	$a4, $a0, 12
.LBB2_2:
...
# %bb.1:
	move	$t4, $zero
	ori	$a3, $zero, 1
.LBB3_2:                                # %GetVLCSymbol.exit.thread18.i
	add.d	$a0, $a3, $a0
	st.w	$a0, $a1, 8
...
.LBB5_8:
	move	$t1, $zero
.LBB5_9:                                # %GetBits.exit.thread13.i
	add.d	$a1, $a1, $a0
	st.w	$a1, $a2, 8
...
# %bb.0:
	...
	andi	$a5, $a5, 128
	beqz	$a5, .LBB13_4
# %bb.1:                                # %GetVLCSymbol.exit.thread18.i
	move	$t0, $zero
	ori	$a4, $zero, 1
	st.d	$a4, $a0, 12
.LBB13_2:
...
.LBB14_2:                               # %.thread
	...
	ori	$a5, $zero, 4
	ori	$a1, $zero, 1
.LBB14_3:                               # %GetVLCSymbol_IntraMode.exit.thread
	stx.w	$a3, $a0, $a5
	move	$a0, $a1
	ret
.LBB14_4:
...
.LBB21_26:                              #   in Loop: Header=BB21_27 Depth=2
	...
	move	$fp, $s1
	beqz	$t8, .LBB21_21
.LBB21_27:                              #   Parent Loop BB21_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$s1, $a4, $t7
	bnez	$s0, .LBB21_25
...
.LBB22_18:                              #   in Loop: Header=BB22_19 Depth=2
	...
	move	$fp, $s1
	beqz	$t8, .LBB22_13
.LBB22_19:                              #   Parent Loop BB22_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$s1, $a4, $t7
	bnez	$s0, .LBB22_17
...
.LBB22_30:                              #   in Loop: Header=BB22_31 Depth=2
	...
	move	$fp, $s1
	beqz	$t8, .LBB22_25
.LBB22_31:                              #   Parent Loop BB22_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$s1, $a4, $t7
	bnez	$s0, .LBB22_29
...
.LBB22_42:                              #   in Loop: Header=BB22_43 Depth=2
	...
	move	$t7, $fp
	beqz	$t6, .LBB22_37
.LBB22_43:                              #   Parent Loop BB22_39 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$fp, $a4, $t5
	bnez	$t8, .LBB22_41
...
# %bb.8:                                # %.thread
	...
	ori	$a4, $zero, 6
	b	.LBB23_29
.LBB23_9:                               # %ShowBits.exit.preheader
	move	$t2, $zero
	addi.d	$t1, $a2, 1
	.p2align	4, , 16
.LBB23_10:                              # %ShowBits.exit
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a5, $t0, 0
	ldx.b	$a5, $a4, $a5
	sll.w	$a5, $a5, $a7
...
# %bb.8:                                #   in Loop: Header=BB24_6 Depth=1
	...
	ori	$t6, $zero, 7
	b	.LBB24_5
.LBB24_9:                               # %ShowBits.exit.preheader
	move	$t4, $zero
	addi.d	$t3, $a3, 1
	.p2align	4, , 16
.LBB24_10:                              # %ShowBits.exit
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$t1, $t2, 0
	ldx.b	$t1, $a5, $t1
	sll.w	$a7, $t1, $a7
...
.LBB24_24:
	addi.d	$t4, $zero, -1
.LBB24_25:                              # %ShowBits.exit82
	add.d	$a7, $t4, $a7
	add.d	$a6, $t1, $a1
.LBB24_26:                              # %ShowBits.exit105
	add.w	$a1, $a6, $a3
	srai.d	$t0, $a1, 3
	ldx.bu	$a5, $a5, $t0
	andi	$t1, $a1, 7
...
# %bb.27:
	blt	$t0, $a4, .LBB24_29
# %bb.28:                               # %ShowBits.exit93.thread
	sub.d	$a1, $zero, $a7
	b	.LBB24_30
.LBB24_29:                              # %ShowBits.exit93
	andi	$a1, $a1, 1
	sltui	$a1, $a1, 1
	sub.d	$a4, $zero, $a7
	masknez	$a4, $a4, $a1
...
# %bb.0:
	...
	andi	$a3, $a3, 128
	beqz	$a3, .LBB28_4
# %bb.1:                                # %GetVLCSymbol.exit.thread19
	move	$a7, $zero
	ori	$a4, $zero, 1
	st.d	$a4, $a0, 12
.LBB28_2:
