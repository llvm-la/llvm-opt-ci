...
.LBB0_30:                               # %vector.body150
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_30
# %bb.31:                               # %middle.block155
	beq	$a2, $a3, .LBB0_34
.LBB0_32:                               # %scalar.ph145.preheader
	sub.d	$a3, $a3, $a2
	alsl.d	$a0, $a2, $a0, 2
	alsl.d	$a1, $a2, $a1, 2
	.p2align	4, , 16
.LBB0_33:                               # %scalar.ph145
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a1, 0
	st.w	$a2, $a0, 0
	addi.d	$a3, $a3, -1
...
# %bb.49:                               # %.lr.ph.i.i
	...
	addi.w	$a2, $a2, 1
	bltu	$a3, $a5, .LBB0_52
# %bb.50:                               # %vector.memcheck123
	ori	$a3, $s3, 1728
	add.d	$a3, $a4, $a3
	bgeu	$a0, $a3, .LBB0_115
# %bb.51:                               # %vector.memcheck123
	alsl.d	$a3, $s4, $a0, 2
	bgeu	$a1, $a3, .LBB0_115
.LBB0_52:
	move	$a3, $zero
.LBB0_53:                               # %scalar.ph125.preheader
	sub.d	$a4, $s4, $a3
	alsl.d	$a0, $a3, $a0, 2
	.p2align	4, , 16
.LBB0_54:                               # %scalar.ph125
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a1, 0
	addi.w	$a6, $a3, 0
	div.wu	$a6, $a6, $a5
...
.LBB0_55:
	...
	ldptr.w	$a3, $a0, 5820
	beqz	$a3, .LBB0_21
# %bb.56:                               # %.preheader.lr.ph.i62.i
	ldptr.w	$a1, $a0, 5824
	beqz	$a1, .LBB0_21
# %bb.57:                               # %.preheader.i63.i.preheader
	ld.w	$a4, $fp, 1096
	ori	$a1, $s3, 1552
	ldx.w	$a5, $a0, $a1
	move	$a1, $zero
...
.LBB0_75:                               # %vector.body93
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_75
# %bb.76:                               # %middle.block96
	beq	$a4, $s4, .LBB0_21
.LBB0_77:                               # %scalar.ph84.preheader
	alsl.d	$a0, $a4, $a0, 2
	.p2align	4, , 16
.LBB0_78:                               # %scalar.ph84
                                        # =>This Inner Loop Header: Depth=1
...
.LBB0_80:                               # %vector.body117
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_80
# %bb.81:                               # %middle.block120
	beq	$a1, $s4, .LBB0_84
.LBB0_82:                               # %.lr.ph.i39.i.preheader168
	sub.d	$a3, $s4, $a1
	alsl.d	$a0, $a1, $a0, 2
	.p2align	4, , 16
.LBB0_83:                               # %.lr.ph.i39.i
...
.LBB0_94:                               # %vector.body104
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB0_94
# %bb.95:                               # %middle.block107
	beq	$a3, $s4, .LBB0_98
.LBB0_96:                               # %.lr.ph.i48.i.preheader170
	sub.d	$a6, $s4, $a3
	alsl.d	$a3, $a3, $a0, 2
	ori	$a7, $zero, 2
	.p2align	4, , 16
