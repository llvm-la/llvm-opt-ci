...
.LBB0_21:                               # %FmoGenerateMapUnitToSliceGroupMap.exit
	pcalau12i	$s5, %pc_hi20(MbToSliceGroupMap)
	ld.d	$a0, $s5, %pc_lo12(MbToSliceGroupMap)
	beqz	$a0, .LBB0_23
# %bb.22:
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_23:
	...
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, %pc_lo12(MbToSliceGroupMap)
	beqz	$a0, .LBB0_155
# %bb.24:
	ldptr.w	$a1, $s0, 2076
	bnez	$a1, .LBB0_26
...
# %bb.28:                               # %iter.check243
	...
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB0_42
# %bb.29:                               # %vector.main.loop.iter.check230
	ori	$a3, $zero, 16
	bgeu	$a4, $a3, .LBB0_35
# %bb.30:
	move	$a3, $zero
...
.LBB0_36:                               # %vector.body235
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_36
# %bb.37:                               # %middle.block240
	beq	$a3, $a2, .LBB0_44
# %bb.38:                               # %vec.epilog.iter.check245
	beqz	$a4, .LBB0_42
.LBB0_39:                               # %vec.epilog.ph247
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $a1, 2
	.p2align	4, , 16
.LBB0_40:                               # %vec.epilog.vector.body250
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB0_40
# %bb.41:                               # %vec.epilog.middle.block254
	beq	$a3, $a2, .LBB0_44
.LBB0_42:                               # %vec.epilog.scalar.ph244.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a0, $a3, $a0, 2
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB0_43:                               # %vec.epilog.scalar.ph244
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a1, 0
	st.w	$a3, $a0, 0
	addi.d	$a2, $a2, -1
...
.LBB0_58:
	move	$a3, $zero
.LBB0_59:                               # %vec.epilog.scalar.ph206.preheader
	sub.d	$a4, $s4, $a3
	alsl.d	$a0, $a3, $a0, 2
	.p2align	4, , 16
.LBB0_60:                               # %vec.epilog.scalar.ph206
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a1, 0
	addi.w	$a6, $a3, 0
	div.wu	$a6, $a6, $a5
...
# %bb.78:
	move	$a4, $zero
	b	.LBB0_87
.LBB0_79:                               # %vector.main.loop.iter.check156
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_92
# %bb.80:
	move	$a1, $zero
	b	.LBB0_96
.LBB0_81:                               # %vector.main.loop.iter.check131
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_112
# %bb.82:
	move	$a3, $zero
...
.LBB0_84:                               # %vector.body101
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB0_84
# %bb.85:                               # %middle.block104
	beq	$a4, $s4, .LBB0_21
# %bb.86:                               # %vec.epilog.iter.check109
	beqz	$a6, .LBB0_90
.LBB0_87:                               # %vec.epilog.ph111
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a0, 2
	.p2align	4, , 16
.LBB0_88:                               # %vec.epilog.vector.body122
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_88
# %bb.89:                               # %vec.epilog.middle.block127
	beq	$a4, $s4, .LBB0_21
.LBB0_90:                               # %vec.epilog.scalar.ph108.preheader
	alsl.d	$a0, $a4, $a0, 2
	.p2align	4, , 16
.LBB0_91:                               # %vec.epilog.scalar.ph108
                                        # =>This Inner Loop Header: Depth=1
	sltu	$a5, $a4, $a2
	masknez	$a6, $a3, $a5
	maskeqz	$a5, $a1, $a5
...
# %bb.109:                              # %._crit_edge5.i.i
	...
	bgeu	$a6, $a5, .LBB0_107
	b	.LBB0_103
.LBB0_110:                              # %vector.main.loop.iter.check187
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB0_147
# %bb.111:
	move	$a3, $zero
...
# %bb.114:                              # %middle.block139
	beq	$a3, $s4, .LBB0_121
# %bb.115:                              # %vec.epilog.iter.check144
	beqz	$a6, .LBB0_119
.LBB0_116:                              # %vec.epilog.ph146
	move	$a7, $a3
	...
	vrepli.w	$vr0, 2
	.p2align	4, , 16
.LBB0_117:                              # %vec.epilog.vector.body149
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	addi.d	$a6, $a6, 4
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB0_117
# %bb.118:                              # %vec.epilog.middle.block152
	beq	$a3, $s4, .LBB0_121
...
.LBB0_148:                              # %vector.body194
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_148
# %bb.149:                              # %middle.block202
	beq	$a3, $s4, .LBB0_21
# %bb.150:                              # %vec.epilog.iter.check207
	beqz	$a4, .LBB0_59
.LBB0_151:                              # %vec.epilog.ph209
	move	$a5, $a3
	bstrpick.d	$a3, $s4, 31, 2
	slli.d	$a3, $a3, 2
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB0_152:                              # %vec.epilog.vector.body217
                                        # =>This Inner Loop Header: Depth=1
	vdiv.wu	$vr3, $vr2, $vr0
	vaddi.wu	$vr4, $vr2, 4
	vmsub.w	$vr2, $vr3, $vr0
	...
	vori.b	$vr2, $vr4, 0
	bnez	$a4, .LBB0_152
# %bb.153:                              # %vec.epilog.middle.block224
	beq	$a3, $s4, .LBB0_21
	b	.LBB0_59
.LBB0_154:
	ld.w	$a0, $fp, 1100
...
# %bb.0:
	...
	bltz	$a1, .LBB3_4
# %bb.1:                                # %.lr.ph
	pcalau12i	$a2, %pc_hi20(NumberOfSliceGroups)
	ld.w	$a2, $a2, %pc_lo12(NumberOfSliceGroups)
	pcalau12i	$a3, %pc_hi20(MbToSliceGroupMap)
	ld.d	$a3, $a3, %pc_lo12(MbToSliceGroupMap)
	addi.w	$a2, $a2, -1
...
# %bb.3:                                #   in Loop: Header=BB3_2 Depth=1
	...
	addi.d	$a3, $a3, -4
	bgez	$a1, .LBB3_2
.LBB3_4:                                # %FmoGetLastMBInSliceGroup.exit
	ret
.LBB3_5:
	move	$a0, $a1
	ret
...
# %bb.1:                                # %.lr.ph.preheader
	pcalau12i	$a4, %pc_hi20(MbToSliceGroupMap)
	ld.d	$a6, $a4, %pc_lo12(MbToSliceGroupMap)
	slli.d	$a4, $a1, 2
	ldx.w	$a5, $a6, $a4
	addi.w	$a4, $a1, 1
	alsl.d	$a1, $a1, $a6, 2
