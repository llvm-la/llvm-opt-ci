...
# %bb.35:                               #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $zero
	b	.LBB19_40
.LBB19_36:                              # %vector.body243.preheader
                                        #   in Loop: Header=BB19_25 Depth=1
	addi.d	$s0, $t6, 32
	addi.d	$s1, $fp, 32
	addi.d	$s2, $t7, 32
...
# %bb.38:                               # %middle.block250
                                        #   in Loop: Header=BB19_25 Depth=1
	beq	$t1, $a3, .LBB19_24
# %bb.39:                               # %vec.epilog.iter.check254
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $t1
	move	$s0, $t1
	beqz	$t0, .LBB19_27
.LBB19_40:                              # %vec.epilog.ph256
                                        #   in Loop: Header=BB19_25 Depth=1
	add.d	$s0, $t3, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB19_41:                              # %vec.epilog.vector.body259
                                        #   Parent Loop BB19_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB19_41
# %bb.42:                               # %vec.epilog.middle.block264
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s0, $t2
	beq	$t2, $a3, .LBB19_24
	b	.LBB19_27
