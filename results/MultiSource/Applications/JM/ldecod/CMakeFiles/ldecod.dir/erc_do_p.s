...
.LBB0_13:                               #   Parent Loop BB0_10 Depth=1
	...
	ori	$a2, $zero, 1
	blt	$a2, $a1, .LBB0_11
# %bb.14:                               # %.preheader155.us.preheader
                                        #   in Loop: Header=BB0_13 Depth=2
	addi.d	$a1, $s2, 1
	bge	$a1, $s1, .LBB0_22
...
# %bb.20:                               #   in Loop: Header=BB0_13 Depth=2
	addi.d	$a0, $a6, 1
	blt	$a6, $s2, .LBB0_12
# %bb.21:                               # %.lr.ph161.us.preheader
                                        #   in Loop: Header=BB0_13 Depth=2
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
	move	$s8, $zero
	b	.LBB0_30
	.p2align	4, , 16
.LBB0_22:                               # %.preheader153.us
                                        #   in Loop: Header=BB0_13 Depth=2
	move	$a0, $s1
...
# %bb.27:                               #   in Loop: Header=BB0_26 Depth=3
	...
	b	.LBB0_25
	.p2align	4, , 16
.LBB0_28:                               #   in Loop: Header=BB0_30 Depth=3
	ld.d	$a6, $fp, 8
	addi.d	$a4, $sp, 104
...
.LBB0_33:                               # %.loopexit.us
	...
	ori	$a5, $zero, 2
	b	.LBB0_12
.LBB0_34:                               # %.preheader.us
                                        #   in Loop: Header=BB0_13 Depth=2
	move	$s2, $a6
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
	bgez	$a2, .LBB0_38
.LBB0_35:                               # %._crit_edge.us
                                        #   in Loop: Header=BB0_13 Depth=2
	addi.d	$a0, $s2, 1
	b	.LBB0_33
	.p2align	4, , 16
.LBB0_36:                               #   in Loop: Header=BB0_38 Depth=3
	ld.d	$a6, $fp, 8
	addi.d	$a4, $sp, 104
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
...
.Lfunc_end0:
	.size	ercConcealInterFrame, .Lfunc_end0-ercConcealInterFrame
                                        # -- End function
	.p2align	2                               # -- Begin function concealByTrial
...
# %bb.19:                               #   in Loop: Header=BB1_5 Depth=2
	...
	sltu	$fp, $zero, $a0
	beqz	$s5, .LBB1_27
# %bb.20:                               #   in Loop: Header=BB1_5 Depth=2
	move	$a0, $zero
...
# %bb.23:                               #   in Loop: Header=BB1_5 Depth=2
	bnez	$s2, .LBB1_32
.LBB1_24:                               # %.preheader235.preheader.peel
                                        #   in Loop: Header=BB1_5 Depth=2
	ld.w	$a1, $sp, 160
	ld.d	$a2, $sp, 152
	ld.bu	$a0, $s0, 0
...
# %bb.25:                               #   in Loop: Header=BB1_5 Depth=2
	...
	ori	$a1, $zero, 4
	bne	$a0, $a1, .LBB1_30
.LBB1_26:                               #   in Loop: Header=BB1_5 Depth=2
	move	$a0, $zero
	b	.LBB1_31
...
# %bb.34:                               # %.peel.next
	...
	ld.bu	$a0, $s0, 0
	bltu	$a0, $a4, .LBB1_37
# %bb.35:                               #   in Loop: Header=BB1_5 Depth=2
	slli.d	$a0, $a7, 4
	alsl.d	$a0, $a7, $a0, 3
	ldx.bu	$a1, $s0, $a0
	ori	$a0, $zero, 4
...
.LBB1_41:                               #   in Loop: Header=BB1_5 Depth=2
	...
	st.d	$a0, $sp, 88                    # 8-byte Folded Spill
	b	.LBB1_22
.LBB1_42:                               #   in Loop: Header=BB1_5 Depth=2
	move	$a0, $zero
...
.LBB1_44:                               #   in Loop: Header=BB1_5 Depth=2
	...
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 88                    # 8-byte Folded Spill
.LBB1_45:                               #   in Loop: Header=BB1_5 Depth=2
	pcalau12i	$a0, %pc_hi20(erc_img)
	ld.d	$a0, $a0, %pc_lo12(erc_img)
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	ld.w	$a2, $a3, 4
...
# %bb.46:                               #   in Loop: Header=BB1_5 Depth=2
	beqz	$s1, .LBB1_48
# %bb.47:                               #   in Loop: Header=BB1_5 Depth=2
	ld.d	$a3, $sp, 72                    # 8-byte Folded Reload
	move	$a7, $s5
	ori	$a2, $zero, 32
	ori	$a4, $zero, 3
...
.LBB1_48:                               # %.preheader235.preheader
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB1_51
# %bb.49:                               #   in Loop: Header=BB1_5 Depth=2
	slli.d	$a0, $s5, 4
	alsl.d	$a0, $s5, $a0, 3
	ldx.bu	$a0, $s0, $a0
	ori	$a1, $zero, 4
...
.LBB1_52:                               #   in Loop: Header=BB1_5 Depth=2
	ori	$a0, $zero, 1
.LBB1_53:                               #   in Loop: Header=BB1_5 Depth=2
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	st.b	$a0, $a1, 0
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
...
.LJTI1_0:
	...
	.word	.LBB1_10-.LJTI1_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function concealByCopy
...
.LBB5_23:                               # %._crit_edge158
	...
	bge	$a0, $a1, .LBB5_48
	b	.LBB5_58
.LBB5_24:                               # %._crit_edge100.loopexit
	ld.d	$a0, $s1, 0
.LBB5_25:                               # %._crit_edge100
...
# %bb.30:                               #   in Loop: Header=BB5_28 Depth=1
	...
	stx.d	$a5, $a0, $a6
	b	.LBB5_27
.LBB5_31:                               # %._crit_edge106.loopexit
	ld.d	$a0, $s1, 0
	b	.LBB5_33
.LBB5_32:
	move	$s3, $fp
.LBB5_33:                               # %._crit_edge106
	alsl.d	$a0, $fp, $a0, 3
	sub.w	$s0, $s3, $fp
...
.LBB5_43:                               # %vector.body180
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB5_43
# %bb.44:                               # %middle.block185
	beq	$a3, $s0, .LBB5_47
.LBB5_45:                               # %scalar.ph175.preheader
	slli.d	$a3, $fp, 3
	sub.d	$a0, $a3, $a0
	add.d	$a0, $a2, $a0
	alsl.d	$a2, $fp, $a1, 3
...
.LBB5_46:                               # %scalar.ph175
	...
	addi.d	$a2, $a2, 8
	bnez	$a3, .LBB5_46
.LBB5_47:                               # %._crit_edge113
	pcalau12i	$a0, %got_pc_hi20(listXsize)
	ld.d	$s0, $a0, %got_pc_lo12(listXsize)
	st.w	$s3, $s0, 4
	st.w	$s3, $s0, 0
	alsl.d	$a0, $s3, $a1, 3
...
# %bb.53:                               # %middle.block201
	...
	sltu	$a5, $zero, $a5
	beq	$a4, $a3, .LBB5_56
.LBB5_54:                               # %scalar.ph188.preheader
	alsl.d	$a6, $a4, $a1, 3
	alsl.d	$a2, $a4, $a2, 3
	sub.d	$a3, $a3, $a4
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB5_55:                               # %scalar.ph188
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a2, 0
	ld.d	$t0, $a6, 0
	xor	$a7, $a7, $t0
...
.LBB18_19:                              #   in Loop: Header=BB18_8 Depth=1
	ld.d	$a0, $a5, 48
	move	$s3, $a4
.LBB18_20:                              # %get_pic_from_dpb.exit
                                        #   in Loop: Header=BB18_8 Depth=1
	ldx.w	$a3, $a0, $s8
	...
	stptr.w	$a3, $a2, 6076
	bgez	$a5, .LBB18_25
.LBB18_21:                              # %update_ref_list_for_concealment.exit
                                        #   in Loop: Header=BB18_8 Depth=1
	pcalau12i	$a1, %pc_hi20(active_pps)
	ld.d	$a1, $a1, %pc_lo12(active_pps)
	ld.w	$a1, $a1, 1112
...
.Lfunc_end18:
	.size	conceal_non_ref_pics, .Lfunc_end18-conceal_non_ref_pics
                                        # -- End function
	.p2align	2                               # -- Begin function copy_to_conceal
...
# %bb.0:
	...
	ld.d	$s8, $a2, %got_pc_lo12(dec_picture)
	ldptr.w	$a2, $s1, 6068
	ori	$a4, $zero, 2
	st.d	$a0, $s8, 0
	beq	$a2, $a4, .LBB19_19
...
# %bb.26:                               #   in Loop: Header=BB19_25 Depth=1
	move	$s0, $zero
.LBB19_27:                              # %vec.epilog.scalar.ph251.preheader
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $a3, $s0
	alsl.d	$fp, $s0, $fp, 1
	alsl.d	$t8, $s0, $t8, 1
	...
	alsl.d	$t6, $s0, $t6, 1
	.p2align	4, , 16
.LBB19_28:                              # %vec.epilog.scalar.ph251
	...
	b	.LBB19_24
	.p2align	4, , 16
.LBB19_29:                              # %vector.memcheck225
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $fp, $t7
	move	$s0, $zero
	bltu	$s1, $t5, .LBB19_27
# %bb.30:                               # %vector.memcheck225
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $t7, $t6
	bltu	$s1, $t5, .LBB19_27
...
# %bb.35:                               #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $zero
	b	.LBB19_40
.LBB19_36:                              # %vector.body240.preheader
                                        #   in Loop: Header=BB19_25 Depth=1
	addi.d	$s0, $t6, 32
	addi.d	$s1, $fp, 32
	addi.d	$s2, $t7, 32
...
.LBB19_37:                              # %vector.body240
	...
	addi.d	$s3, $s3, 64
	bnez	$s4, .LBB19_37
# %bb.38:                               # %middle.block247
                                        #   in Loop: Header=BB19_25 Depth=1
	beq	$t1, $a3, .LBB19_24
# %bb.39:                               # %vec.epilog.iter.check252
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $t1
	move	$s0, $t1
	beqz	$t0, .LBB19_27
.LBB19_40:                              # %vec.epilog.ph254
                                        #   in Loop: Header=BB19_25 Depth=1
	add.d	$s0, $t3, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB19_41:                              # %vec.epilog.vector.body257
                                        #   Parent Loop BB19_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB19_41
# %bb.42:                               # %vec.epilog.middle.block262
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s0, $t2
	beq	$t2, $a3, .LBB19_24
	b	.LBB19_27
...
.Lfunc_end22:
	.size	write_lost_ref_after_idr, .Lfunc_end22-write_lost_ref_after_idr
                                        # -- End function
	.p2align	2                               # -- Begin function buildPredRegionYUV
...
.LBB23_9:                               #   Parent Loop BB23_7 Depth=1
	...
	vpickve2gr.w	$s4, $vr3, 1
	vpickve2gr.w	$s6, $vr3, 2
	slli.d	$t4, $s3, 5
	alsl.d	$t3, $t3, $t4, 1
...
.Lfunc_end23:
	.size	buildPredRegionYUV, .Lfunc_end23-buildPredRegionYUV
                                        # -- End function
	.p2align	2                               # -- Begin function edgeDistortion
...
.LJTI24_0:
	...
	.word	.LBB24_11-.LJTI24_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function copyPredMB
...
.LBB25_6:                               # %.lr.ph8.split
	...
	andi	$a0, $fp, 24
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
	bstrpick.d	$a0, $fp, 32, 5
	slli.d	$s4, $a0, 5
	add.d	$a0, $s4, $a3
	st.d	$a0, $sp, 8                     # 8-byte Folded Spill
	bstrpick.d	$a0, $fp, 32, 3
	slli.d	$t7, $a0, 3
	alsl.d	$a0, $a0, $a3, 3
