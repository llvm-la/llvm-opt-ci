...
.LBB5_19:                               # =>This Inner Loop Header: Depth=1
	...
	bnez	$a3, .LBB5_19
	b	.LBB5_42
.LBB5_20:                               # %vector.main.loop.iter.check166
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB5_24
# %bb.21:
	move	$a4, $zero
...
# %bb.26:                               # %middle.block180
	...
	sltui	$a2, $a2, 1
	beq	$a4, $a3, .LBB5_42
# %bb.27:                               # %vec.epilog.iter.check188
	beqz	$a5, .LBB5_31
.LBB5_28:                               # %vec.epilog.ph190
	move	$a5, $a4
	sltui	$a2, $a2, 1
	...
	add.d	$a5, $a1, $a6
	add.d	$a6, $a0, $a6
.LBB5_29:                               # %vec.epilog.vector.body195
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vld	$vr2, $a5, 0
	vseq.w	$vr1, $vr1, $vr2
	...
	addi.d	$a6, $a6, 16
	bnez	$a2, .LBB5_29
# %bb.30:                               # %vec.epilog.middle.block201
	vslli.w	$vr0, $vr0, 31
	vmskltz.w	$vr0, $vr0
	vpickve2gr.hu	$a2, $vr0, 0
	sltui	$a2, $a2, 1
	beq	$a4, $a3, .LBB5_42
.LBB5_31:                               # %vec.epilog.scalar.ph187.preheader
	slli.d	$a5, $a4, 2
	addi.d	$a6, $a5, 996
	add.d	$a5, $a0, $a6
	add.d	$a6, $a1, $a6
	sub.d	$a3, $a3, $a4
.LBB5_32:                               # %vec.epilog.scalar.ph187
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a5, 0
	ld.w	$a7, $a6, 0
	xor	$a4, $a4, $a7
