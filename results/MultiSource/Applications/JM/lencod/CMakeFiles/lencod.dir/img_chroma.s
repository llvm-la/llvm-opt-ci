...
# %bb.32:                               # %vector.memcheck257
	...
	and	$a3, $t5, $a3
	bnez	$a3, .LBB0_15
# %bb.33:                               # %vector.main.loop.iter.check269
                                        #   in Loop: Header=BB0_12 Depth=3
	ori	$a0, $zero, 32
	bgeu	$a7, $a0, .LBB0_46
...
# %bb.36:                               # %vector.memcheck196
	...
	move	$a5, $a3
	bnez	$a0, .LBB0_23
# %bb.37:                               # %vector.main.loop.iter.check209
                                        #   in Loop: Header=BB0_12 Depth=3
	ori	$a0, $zero, 17
	bgeu	$a6, $a0, .LBB0_53
# %bb.38:                               #   in Loop: Header=BB0_12 Depth=3
	move	$s1, $zero
.LBB0_39:                               # %vec.epilog.ph235
                                        #   in Loop: Header=BB0_12 Depth=3
	...
	add.d	$s1, $a0, $s1
	.p2align	4, , 16
.LBB0_40:                               # %vec.epilog.vector.body246
                                        #   Parent Loop BB0_8 Depth=1
                                        #     Parent Loop BB0_10 Depth=2
                                        #       Parent Loop BB0_12 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$t7, $t7, 16
	bnez	$s1, .LBB0_40
# %bb.41:                               # %vec.epilog.middle.block253
                                        #   in Loop: Header=BB0_12 Depth=3
...
.LBB0_47:                               # %vector.body282
	...
	addi.d	$a3, $a3, 64
	bnez	$a5, .LBB0_47
# %bb.48:                               # %middle.block285
                                        #   in Loop: Header=BB0_12 Depth=3
	move	$a3, $a7
	ld.d	$t6, $sp, 344                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	beq	$a0, $a7, .LBB0_19
# %bb.49:                               # %vec.epilog.iter.check290
                                        #   in Loop: Header=BB0_12 Depth=3
	ld.d	$a5, $sp, 256                   # 8-byte Folded Reload
	move	$a3, $a5
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_15
.LBB0_50:                               # %vec.epilog.ph292
                                        #   in Loop: Header=BB0_12 Depth=3
	ld.h	$a5, $s5, 0
	...
	alsl.d	$a3, $a3, $a2, 1
	.p2align	4, , 16
.LBB0_51:                               # %vec.epilog.vector.body303
                                        #   Parent Loop BB0_8 Depth=1
                                        #     Parent Loop BB0_10 Depth=2
                                        #       Parent Loop BB0_12 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a3, $a3, 8
	bnez	$a5, .LBB0_51
# %bb.52:                               # %vec.epilog.middle.block306
                                        #   in Loop: Header=BB0_12 Depth=3
...
.LBB0_54:                               # %vector.body222
	...
	addi.d	$t6, $t6, 32
	bnez	$t7, .LBB0_54
# %bb.55:                               # %middle.block228
                                        #   in Loop: Header=BB0_12 Depth=3
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 232                   # 8-byte Folded Reload
	beq	$s4, $a0, .LBB0_25
# %bb.56:                               # %vec.epilog.iter.check233
                                        #   in Loop: Header=BB0_12 Depth=3
	move	$s1, $s4
...
.LBB0_87:                               #   in Loop: Header=BB0_70 Depth=3
	move	$a4, $s3
	move	$t5, $t0
.LBB0_88:                               # %vec.epilog.scalar.ph344.preheader
                                        #   in Loop: Header=BB0_70 Depth=3
	alsl.d	$a4, $a4, $a5, 1
	ld.d	$a0, $sp, 312                   # 8-byte Folded Reload
	sub.d	$a5, $a0, $t5
	.p2align	4, , 16
.LBB0_89:                               # %vec.epilog.scalar.ph344
                                        #   Parent Loop BB0_66 Depth=1
                                        #     Parent Loop BB0_68 Depth=2
                                        #       Parent Loop BB0_70 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.91:                               # %vector.memcheck429
	...
	and	$a0, $a0, $a3
	bnez	$a0, .LBB0_73
# %bb.92:                               # %vector.main.loop.iter.check441
                                        #   in Loop: Header=BB0_70 Depth=3
	ori	$a0, $zero, 32
	bgeu	$a7, $a0, .LBB0_105
...
# %bb.95:                               # %vector.memcheck365
	...
	move	$s1, $s3
	bnez	$a0, .LBB0_81
# %bb.96:                               # %vector.main.loop.iter.check379
                                        #   in Loop: Header=BB0_70 Depth=3
	ori	$a0, $zero, 17
	bgeu	$a6, $a0, .LBB0_112
# %bb.97:                               #   in Loop: Header=BB0_70 Depth=3
	move	$t5, $zero
.LBB0_98:                               # %vec.epilog.ph407
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	add.d	$s1, $a0, $s3
	slli.d	$a0, $t5, 1
	...
	add.d	$s3, $a0, $t5
	.p2align	4, , 16
.LBB0_99:                               # %vec.epilog.vector.body418
                                        #   Parent Loop BB0_66 Depth=1
                                        #     Parent Loop BB0_68 Depth=2
                                        #       Parent Loop BB0_70 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$t6, $t6, 16
	bnez	$s3, .LBB0_99
# %bb.100:                              # %vec.epilog.middle.block425
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
	move	$s4, $a3
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
...
# %bb.102:                              # %vector.memcheck308
	...
	and	$a0, $a0, $a4
	bnez	$a0, .LBB0_87
# %bb.103:                              # %vector.main.loop.iter.check322
                                        #   in Loop: Header=BB0_70 Depth=3
	ori	$a0, $zero, 31
	bgeu	$a7, $a0, .LBB0_116
...
# %bb.107:                              # %middle.block457
	...
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	beq	$a0, $a7, .LBB0_77
# %bb.108:                              # %vec.epilog.iter.check462
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.d	$a4, $sp, 256                   # 8-byte Folded Reload
	move	$a3, $a4
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_73
.LBB0_109:                              # %vec.epilog.ph464
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.h	$a0, $ra, 0
	vinsgr2vr.h	$vr10, $a0, 0
	vinsgr2vr.h	$vr10, $a0, 1
	...
	alsl.d	$a3, $a3, $a5, 1
	.p2align	4, , 16
.LBB0_110:                              # %vec.epilog.vector.body475
                                        #   Parent Loop BB0_66 Depth=1
                                        #     Parent Loop BB0_68 Depth=2
                                        #       Parent Loop BB0_70 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB0_110
# %bb.111:                              # %vec.epilog.middle.block478
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	move	$a4, $a0
	move	$s3, $a7
...
.LBB0_113:                              # %vector.body392
	...
	addi.d	$t6, $t6, 32
	bnez	$a4, .LBB0_113
# %bb.114:                              # %middle.block399
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 232                   # 8-byte Folded Reload
	beq	$s4, $a0, .LBB0_84
# %bb.115:                              # %vec.epilog.iter.check405
                                        #   in Loop: Header=BB0_70 Depth=3
	move	$t5, $s4
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_81
	b	.LBB0_98
.LBB0_116:                              # %vector.ph324
                                        #   in Loop: Header=BB0_70 Depth=3
	vldrepl.h	$vr10, $s1, 0
	vldrepl.h	$vr11, $a3, 0
...
# %bb.118:                              # %middle.block338
	...
	ori	$t8, $zero, 4
	beq	$a0, $t2, .LBB0_69
# %bb.119:                              # %vec.epilog.iter.check345
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.d	$t6, $sp, 240                   # 8-byte Folded Reload
	ld.d	$t5, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_88
.LBB0_120:                              # %vec.epilog.ph347
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.h	$a0, $s1, 0
	vinsgr2vr.h	$vr10, $a0, 0
	vinsgr2vr.h	$vr10, $a0, 1
	...
	add.d	$t6, $a0, $t6
	.p2align	4, , 16
.LBB0_121:                              # %vec.epilog.vector.body358
                                        #   Parent Loop BB0_66 Depth=1
                                        #     Parent Loop BB0_68 Depth=2
                                        #       Parent Loop BB0_70 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$t5, $t5, 8
	bnez	$t6, .LBB0_121
# %bb.122:                              # %vec.epilog.middle.block361
                                        #   in Loop: Header=BB0_70 Depth=3
	ld.d	$t5, $sp, 208                   # 8-byte Folded Reload
	addi.d	$a0, $a7, 1
	ld.d	$t2, $sp, 264                   # 8-byte Folded Reload
