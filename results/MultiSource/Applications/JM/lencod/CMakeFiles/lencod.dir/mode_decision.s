...
# %bb.35:                               #   in Loop: Header=BB8_6 Depth=1
	ld.hu	$a4, $s6, 54
	beqz	$a4, .LBB8_86
# %bb.36:                               #   in Loop: Header=BB8_6 Depth=1
	ld.hu	$a4, $s6, 56
	beqz	$a4, .LBB8_86
...
# %bb.54:                               #   in Loop: Header=BB8_50 Depth=2
	ld.w	$t4, $s2, %pc_lo12(si_frame_indicator)
	bnez	$t4, .LBB8_56
# %bb.55:                               #   in Loop: Header=BB8_50 Depth=2
	ld.d	$t1, $a6, 0
	slli.d	$t2, $t3, 2
	ldx.w	$t1, $t1, $t2
	st.w	$t1, $a4, -24
	ld.w	$t1, $a0, 176
	ld.w	$t2, $a0, 20
.LBB8_56:                               #   in Loop: Header=BB8_50 Depth=2
	add.w	$t3, $t1, $t8
	slli.d	$t4, $t3, 1
	ldx.h	$t4, $a7, $t4
	st.h	$t4, $a2, -522
	...
	st.h	$t4, $a2, -10
	bne	$t2, $s5, .LBB8_59
# %bb.57:                               #   in Loop: Header=BB8_50 Depth=2
	ld.w	$t4, $s2, %pc_lo12(si_frame_indicator)
	bnez	$t4, .LBB8_59
# %bb.58:                               #   in Loop: Header=BB8_50 Depth=2
	ld.d	$t1, $a6, 0
	slli.d	$t2, $t3, 2
	ldx.w	$t1, $t1, $t2
	st.w	$t1, $a4, -20
	ld.w	$t1, $a0, 176
	ld.w	$t2, $a0, 20
.LBB8_59:                               #   in Loop: Header=BB8_50 Depth=2
	add.w	$t3, $t1, $fp
	slli.d	$t4, $t3, 1
	ldx.h	$t4, $a7, $t4
	st.h	$t4, $a2, -520
	...
	st.h	$t4, $a2, -8
	bne	$t2, $s5, .LBB8_62
# %bb.60:                               #   in Loop: Header=BB8_50 Depth=2
	ld.w	$t4, $s2, %pc_lo12(si_frame_indicator)
	bnez	$t4, .LBB8_62
# %bb.61:                               #   in Loop: Header=BB8_50 Depth=2
	ld.d	$t1, $a6, 0
	slli.d	$t2, $t3, 2
	ldx.w	$t1, $t1, $t2
	st.w	$t1, $a4, -16
	ld.w	$t1, $a0, 176
	ld.w	$t2, $a0, 20
.LBB8_62:                               #   in Loop: Header=BB8_50 Depth=2
	add.w	$t3, $t1, $s0
	slli.d	$t4, $t3, 1
	ldx.h	$t4, $a7, $t4
	st.h	$t4, $a2, -518
	...
	st.h	$t4, $a2, -6
	bne	$t2, $s5, .LBB8_65
# %bb.63:                               #   in Loop: Header=BB8_50 Depth=2
	ld.w	$t4, $s2, %pc_lo12(si_frame_indicator)
	bnez	$t4, .LBB8_65
# %bb.64:                               #   in Loop: Header=BB8_50 Depth=2
	ld.d	$t1, $a6, 0
	slli.d	$t2, $t3, 2
	ldx.w	$t1, $t1, $t2
	st.w	$t1, $a4, -12
	ld.w	$t1, $a0, 176
	ld.w	$t2, $a0, 20
.LBB8_65:                               #   in Loop: Header=BB8_50 Depth=2
	add.w	$t3, $t1, $s1
	slli.d	$t4, $t3, 1
	ldx.h	$t4, $a7, $t4
	st.h	$t4, $a2, -516
	...
	st.h	$t4, $a2, -4
	bne	$t2, $s5, .LBB8_68
# %bb.66:                               #   in Loop: Header=BB8_50 Depth=2
	ld.w	$t4, $s2, %pc_lo12(si_frame_indicator)
	bnez	$t4, .LBB8_68
# %bb.67:                               #   in Loop: Header=BB8_50 Depth=2
	ld.d	$t1, $a6, 0
	slli.d	$t2, $t3, 2
	ldx.w	$t1, $t1, $t2
	st.w	$t1, $a4, -8
	ld.w	$t1, $a0, 176
	ld.w	$t2, $a0, 20
.LBB8_68:                               #   in Loop: Header=BB8_50 Depth=2
	add.w	$t3, $t1, $s4
	slli.d	$t4, $t3, 1
	ldx.h	$t4, $a7, $t4
	st.h	$t4, $a2, -514
	...
	st.h	$t0, $a2, -2
	bne	$t2, $s5, .LBB8_71
# %bb.69:                               #   in Loop: Header=BB8_50 Depth=2
	ld.w	$t0, $s2, %pc_lo12(si_frame_indicator)
	bnez	$t0, .LBB8_71
# %bb.70:                               #   in Loop: Header=BB8_50 Depth=2
	ld.d	$t0, $a6, 0
	slli.d	$t1, $t3, 2
	ldx.w	$t0, $t0, $t1
	st.w	$t0, $a4, -4
	ld.w	$t1, $a0, 176
	ld.w	$t2, $a0, 20
.LBB8_71:                               #   in Loop: Header=BB8_50 Depth=2
	add.w	$t0, $t1, $s6
	slli.d	$t1, $t0, 1
	ldx.h	$a7, $a7, $t1
	st.h	$a7, $a2, -512
	...
	st.h	$a7, $a2, 0
	bne	$t2, $s5, .LBB8_49
# %bb.72:                               #   in Loop: Header=BB8_50 Depth=2
	ld.w	$a7, $s2, %pc_lo12(si_frame_indicator)
	bnez	$a7, .LBB8_49
# %bb.73:                               #   in Loop: Header=BB8_50 Depth=2
	ld.d	$a6, $a6, 0
	slli.d	$a7, $t0, 2
	ldx.w	$a6, $a6, $a7
	st.w	$a6, $a4, 0
	b	.LBB8_49
	.p2align	4, , 16
.LBB8_74:                               #   in Loop: Header=BB8_6 Depth=1
	bnez	$a0, .LBB8_4
# %bb.75:                               #   in Loop: Header=BB8_6 Depth=1
	ld.w	$a1, $s1, 0
	ld.d	$a0, $sp, 360                   # 8-byte Folded Reload
	bge	$a1, $a0, .LBB8_4
	b	.LBB8_47
...
# %bb.78:                               # %.preheader365
	...
	.p2align	4, , 16
.LBB8_79:                               #   Parent Loop BB8_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a4, $a1, 0
	xvldx	$xr0, $a4, $a5
	xvst	$xr0, $a2, 0
...
.LBB8_91:                               # %.preheader361
	...
	b	.LBB8_93
	.p2align	4, , 16
.LBB8_92:                               #   in Loop: Header=BB8_93 Depth=1
	addi.d	$a0, $a0, 8
	addi.d	$a1, $a1, 1
	addi.d	$a2, $a2, 32
	addi.d	$a3, $a3, 64
...
# %bb.94:                               #   in Loop: Header=BB8_93 Depth=1
	...
	bnez	$t1, .LBB8_92
# %bb.95:                               #   in Loop: Header=BB8_93 Depth=1
	ld.d	$t1, $fp, %pc_lo12(lrec)
	ld.w	$t2, $t0, 180
	ld.w	$t0, $t0, 176
	alsl.d	$t1, $t2, $t1, 3
	ldx.d	$t1, $t1, $a0
