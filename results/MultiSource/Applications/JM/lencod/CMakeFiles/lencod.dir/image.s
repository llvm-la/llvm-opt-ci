...
# %bb.112:                              # %vec.epilog.middle.block
	...
	b	.LBB2_117
	.p2align	4, , 16
.LBB2_113:                              # %vector.body419.preheader
                                        #   in Loop: Header=BB2_106 Depth=1
	addi.d	$s1, $s0, 16
	addi.d	$s2, $fp, 16
	move	$s3, $t3
	.p2align	4, , 16
.LBB2_114:                              # %vector.body419
                                        #   Parent Loop BB2_106 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s2, -16
	vld	$vr1, $s2, 0
...
# %bb.135:                              #   in Loop: Header=BB2_134 Depth=1
	move	$s0, $zero
.LBB2_136:                              # %vec.epilog.scalar.ph459.preheader
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $a3, $s0
	alsl.d	$fp, $s0, $fp, 1
	alsl.d	$t8, $s0, $t8, 1
	...
	alsl.d	$t6, $s0, $t6, 1
	.p2align	4, , 16
.LBB2_137:                              # %vec.epilog.scalar.ph459
	...
	b	.LBB2_133
	.p2align	4, , 16
.LBB2_138:                              # %vector.memcheck432
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $fp, $t7
	move	$s0, $zero
	bltu	$s1, $t4, .LBB2_136
# %bb.139:                              # %vector.memcheck432
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $t7, $t6
	bltu	$s1, $t4, .LBB2_136
# %bb.140:                              # %vector.memcheck432
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $t8, $t7
	bltu	$s1, $t4, .LBB2_136
# %bb.141:                              # %vector.memcheck432
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $fp, $t6
	bltu	$s1, $t4, .LBB2_136
# %bb.142:                              # %vector.memcheck432
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $fp, $t8
	bltu	$s1, $t4, .LBB2_136
# %bb.143:                              # %vector.main.loop.iter.check443
                                        #   in Loop: Header=BB2_134 Depth=1
	bgeu	$a3, $t5, .LBB2_148
...
.LBB2_145:                              # %vec.epilog.ph462
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB2_146:                              # %vec.epilog.vector.body465
                                        #   Parent Loop BB2_134 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB2_146
# %bb.147:                              # %vec.epilog.middle.block470
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s0, $t1
	beq	$t1, $a3, .LBB2_133
	b	.LBB2_136
.LBB2_148:                              # %vector.body448.preheader
                                        #   in Loop: Header=BB2_134 Depth=1
	addi.d	$s0, $t6, 16
	addi.d	$s1, $fp, 16
	addi.d	$s2, $t7, 16
...
.LBB2_149:                              # %vector.body448
	...
	addi.d	$s3, $s3, 32
	bnez	$s4, .LBB2_149
# %bb.150:                              # %middle.block455
                                        #   in Loop: Header=BB2_134 Depth=1
	beq	$t0, $a3, .LBB2_133
# %bb.151:                              # %vec.epilog.iter.check460
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s4, $t0
	move	$s0, $t0
	beqz	$a7, .LBB2_136
...
# %bb.306:                              #   in Loop: Header=BB2_305 Depth=1
	...
	b	.LBB2_310
	.p2align	4, , 16
.LBB2_307:                              # %vector.body478.preheader
                                        #   in Loop: Header=BB2_305 Depth=1
	move	$t6, $zero
	move	$t7, $t1
	move	$t8, $t3
...
.LBB2_308:                              # %vector.body478
	...
	addi.d	$t8, $t8, 16
	bnez	$t7, .LBB2_308
# %bb.309:                              # %middle.block482
                                        #   in Loop: Header=BB2_305 Depth=1
	add.d	$a2, $t6, $a2
	move	$t8, $t1
	beq	$t1, $a3, .LBB2_304
.LBB2_310:                              # %scalar.ph473.preheader
                                        #   in Loop: Header=BB2_305 Depth=1
	sub.d	$t6, $a3, $t8
	alsl.d	$t7, $t8, $a7, 3
	alsl.d	$t8, $t8, $a6, 3
	.p2align	4, , 16
.LBB2_311:                              # %scalar.ph473
                                        #   Parent Loop BB2_305 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$fp, $t8, 0
	ld.d	$s0, $t7, 0
...
# %bb.320:                              #   in Loop: Header=BB2_319 Depth=1
	...
	b	.LBB2_324
	.p2align	4, , 16
.LBB2_321:                              # %vector.body490.preheader
                                        #   in Loop: Header=BB2_319 Depth=1
	move	$t7, $zero
	move	$t8, $t2
	move	$fp, $t4
...
.LBB2_322:                              # %vector.body490
	...
	addi.d	$fp, $fp, 16
	bnez	$t8, .LBB2_322
# %bb.323:                              # %middle.block495
                                        #   in Loop: Header=BB2_319 Depth=1
	add.d	$a2, $t7, $a2
	move	$fp, $t2
	beq	$t2, $a3, .LBB2_318
.LBB2_324:                              # %scalar.ph485.preheader
                                        #   in Loop: Header=BB2_319 Depth=1
	sub.d	$t7, $a3, $fp
	alsl.d	$t8, $fp, $t1, 3
	alsl.d	$fp, $fp, $a6, 3
	.p2align	4, , 16
.LBB2_325:                              # %scalar.ph485
                                        #   Parent Loop BB2_319 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $fp, 0
	ld.d	$s1, $t8, 0
...
.Lfunc_end9:
	.size	find_distortion, .Lfunc_end9-find_distortion
                                        # -- End function
	.p2align	2                               # -- Begin function init_field
...
.LBB14_45:                              #   in Loop: Header=BB14_42 Depth=1
	move	$t4, $zero
.LBB14_46:                              # %vec.epilog.scalar.ph172.preheader
                                        #   in Loop: Header=BB14_42 Depth=1
	alsl.d	$t3, $t4, $t3, 1
	.p2align	4, , 16
.LBB14_47:                              # %vec.epilog.scalar.ph172
	...
	b	.LBB14_41
	.p2align	4, , 16
.LBB14_48:                              # %vector.main.loop.iter.check158
                                        #   in Loop: Header=BB14_42 Depth=1
	bgeu	$s2, $t1, .LBB14_53
# %bb.49:                               #   in Loop: Header=BB14_42 Depth=1
	move	$t6, $zero
.LBB14_50:                              # %vec.epilog.ph175
                                        #   in Loop: Header=BB14_42 Depth=1
	add.d	$t4, $a7, $t6
	alsl.d	$t5, $t6, $t3, 1
	add.d	$t6, $t2, $t6
	.p2align	4, , 16
.LBB14_51:                              # %vec.epilog.vector.body178
                                        #   Parent Loop BB14_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t6, 0
	...
	addi.d	$t6, $t6, 8
	bnez	$t4, .LBB14_51
# %bb.52:                               # %vec.epilog.middle.block182
                                        #   in Loop: Header=BB14_42 Depth=1
	move	$t4, $a5
	beq	$a5, $s2, .LBB14_41
	b	.LBB14_46
.LBB14_53:                              # %vector.body163.preheader
                                        #   in Loop: Header=BB14_42 Depth=1
	addi.d	$t4, $t3, 16
	move	$t5, $a6
	move	$t6, $a4
	.p2align	4, , 16
.LBB14_54:                              # %vector.body163
                                        #   Parent Loop BB14_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t5, -8
	ld.d	$t8, $t5, 0
	...
	addi.d	$t5, $t5, 16
	bnez	$t6, .LBB14_54
# %bb.55:                               # %middle.block168
                                        #   in Loop: Header=BB14_42 Depth=1
	beq	$a4, $s2, .LBB14_41
# %bb.56:                               # %vec.epilog.iter.check173
                                        #   in Loop: Header=BB14_42 Depth=1
	move	$t6, $a4
	move	$t4, $a4
	bnez	$a3, .LBB14_50
