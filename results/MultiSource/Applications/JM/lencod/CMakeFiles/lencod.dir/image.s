...
# %bb.144:                              #   in Loop: Header=BB2_134 Depth=1
	move	$s4, $zero
	b	.LBB2_149
.LBB2_145:                              # %vector.body451.preheader
                                        #   in Loop: Header=BB2_134 Depth=1
	addi.d	$s0, $t6, 32
	addi.d	$s1, $fp, 32
	addi.d	$s2, $t7, 32
...
# %bb.147:                              # %middle.block458
                                        #   in Loop: Header=BB2_134 Depth=1
	beq	$t0, $a3, .LBB2_133
# %bb.148:                              # %vec.epilog.iter.check462
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s4, $t0
	move	$s0, $t0
	beqz	$a7, .LBB2_136
.LBB2_149:                              # %vec.epilog.ph464
                                        #   in Loop: Header=BB2_134 Depth=1
	add.d	$s0, $t2, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB2_150:                              # %vec.epilog.vector.body467
                                        #   Parent Loop BB2_134 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB2_150
# %bb.151:                              # %vec.epilog.middle.block472
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s0, $t1
	beq	$t1, $a3, .LBB2_133
	b	.LBB2_136
