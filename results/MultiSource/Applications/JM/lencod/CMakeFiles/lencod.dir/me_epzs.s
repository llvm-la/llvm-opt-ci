...
.LBB6_4:
	...
	ldx.w	$a1, $a1, $a6
	slli.d	$a5, $a5, 1
	pcalau12i	$s0, %pc_hi20(mv_rescale)
	st.w	$a5, $s0, %pc_lo12(mv_rescale)
...
.LBB6_6:                                # %.lr.ph.i
	...
	addi.d	$a2, $a1, %pc_lo12(sdiamond)
	ld.wu	$a1, $s0, %pc_lo12(mv_rescale)
...
.LBB6_8:                                # %.lr.ph.i26
	...
	st.d	$a0, $fp, 8
	ld.wu	$a1, $s0, %pc_lo12(mv_rescale)
	pcalau12i	$a2, %pc_hi20(square)
	st.d	$fp, $a2, %pc_lo12(square)
	st.w	$zero, $a0, 0
	srl.w	$a2, $s2, $a1
	st.w	$a2, $a0, 4
	ori	$s2, $zero, 7
...
.LBB6_10:                               # %.lr.ph.i31
	...
	pcaddu18i	$ra, %call36(calloc)
	jirl	$ra, $ra, 0
	ld.wu	$a2, $s0, %pc_lo12(mv_rescale)
	st.d	$a0, $fp, 8
...
.LBB6_12:                               # %.lr.ph.i36
	...
	st.d	$a0, $fp, 8
	ld.wu	$a1, $s0, %pc_lo12(mv_rescale)
	pcalau12i	$a2, %pc_hi20(ldiamond)
	st.d	$fp, $a2, %pc_lo12(ldiamond)
	st.w	$zero, $a0, 0
	srl.w	$a2, $s5, $a1
	st.w	$a2, $a0, 4
	ori	$s2, $zero, 6
...
# %bb.1:                                # %.preheader941.lr.ph
	...
	andn	$t1, $t1, $t2
	addi.d	$t1, $t1, 1
	pcalau12i	$t2, %got_pc_hi20(listXsize)
	ld.d	$t2, $t2, %got_pc_lo12(listXsize)
	move	$t3, $zero
	ori	$t4, $zero, 1
	ori	$t5, $zero, 127
	ori	$t6, $zero, 2047
...
.LBB8_31:                               #   in Loop: Header=BB8_23 Depth=2
	...
	addi.d	$a5, $a5, -256
	b	.LBB8_22
.LBB8_32:                               # %._crit_edge963
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	beqz	$a1, .LBB8_36
.LBB8_33:                               # %._crit_edge963.thread
	ori	$a1, $zero, 16
...
# %bb.44:                               # %.preheader927
	...
	ori	$a5, $zero, 8
	blt	$a1, $a5, .LBB8_81
# %bb.45:                               # %.preheader926.lr.ph
	ldptr.w	$a5, $a3, 6392
	ori	$t0, $zero, 4
	blt	$a5, $t0, .LBB8_81
# %bb.46:                               # %.preheader926.us.preheader
...
.LBB8_50:                               #   in Loop: Header=BB8_51 Depth=2
	...
	st.h	$a1, $t2, 2
	beq	$t3, $s0, .LBB8_47
.LBB8_51:                               #   Parent Loop BB8_48 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_54 Depth 3
	slli.d	$t8, $t3, 3
	ldx.d	$a1, $a5, $t8
...
# %bb.52:                               # %.preheader920.us.us
	...
	ori	$t2, $zero, 256
	blez	$t0, .LBB8_56
# %bb.53:                               # %.lr.ph981.us.us.preheader
                                        #   in Loop: Header=BB8_51 Depth=2
	move	$s3, $zero
	slli.d	$t4, $t0, 2
	move	$t0, $t7
	.p2align	4, , 16
.LBB8_54:                               # %.lr.ph981.us.us
...
# %bb.55:                               #   in Loop: Header=BB8_54 Depth=3
	...
	addi.d	$t0, $t0, 8
	bne	$t4, $s3, .LBB8_54
.LBB8_56:                               #   in Loop: Header=BB8_51 Depth=2
	move	$a1, $zero
	b	.LBB8_58
...
.LBB8_61:                               #   in Loop: Header=BB8_62 Depth=2
	addi.d	$s4, $s4, 1
	beq	$s4, $s0, .LBB8_47
.LBB8_62:                               #   Parent Loop BB8_48 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_65 Depth 3
                                        #       Child Loop BB8_75 Depth 3
	slli.d	$a5, $s4, 3
...
# %bb.66:                               #   in Loop: Header=BB8_65 Depth=3
	...
	addi.d	$t0, $t0, 8
	bne	$t4, $t3, .LBB8_65
.LBB8_67:                               #   in Loop: Header=BB8_62 Depth=2
	move	$s7, $zero
	b	.LBB8_70
	.p2align	4, , 16
.LBB8_68:                               #   in Loop: Header=BB8_62 Depth=2
	ld.d	$t0, $a0, 32
	ld.d	$a1, $t0, 0
	ldx.d	$a1, $a1, $t6
	ldx.d	$a1, $a1, $a5
	...
	bnez	$t0, .LBB8_72
	b	.LBB8_71
.LBB8_69:                               #   in Loop: Header=BB8_62 Depth=2
	addi.d	$t0, $sp, 624
	masknez	$t0, $t0, $s5
	addi.d	$t1, $sp, 1416
	maskeqz	$t1, $t1, $s5
...
.LBB8_70:                               # %.loopexit925.us
	...
	ldx.bu	$t0, $s2, $s4
	bnez	$t0, .LBB8_72
.LBB8_71:                               #   in Loop: Header=BB8_62 Depth=2
	ld.h	$t0, $a1, 2
	addi.d	$t0, $t0, 1
	srli.d	$t0, $t0, 1
	st.h	$t0, $a1, 2
	...
	srli.d	$a1, $a1, 1
	st.h	$a1, $t2, 2
.LBB8_72:                               #   in Loop: Header=BB8_62 Depth=2
	ldx.d	$a1, $s3, $a5
	ld.w	$t0, $a4, 0
	slti	$a1, $a1, 0
	slt	$t0, $s8, $t0
...
.LBB8_75:                               # %.lr.ph979.us
	...
	ld.d	$t1, $t0, 0
	beq	$t1, $s7, .LBB8_79
# %bb.76:                               #   in Loop: Header=BB8_75 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$t0, $t0, 8
	bne	$t4, $t3, .LBB8_75
.LBB8_77:                               #   in Loop: Header=BB8_62 Depth=2
	move	$s7, $zero
	b	.LBB8_80
	.p2align	4, , 16
.LBB8_78:                               #   in Loop: Header=BB8_62 Depth=2
	ld.d	$t0, $a0, 24
	ld.d	$a1, $t0, 0
	ldx.d	$a1, $a1, $t6
	ldx.d	$a1, $a1, $a5
	...
	bnez	$t0, .LBB8_61
	b	.LBB8_60
.LBB8_79:                               #   in Loop: Header=BB8_62 Depth=2
	addi.d	$t0, $sp, 360
	masknez	$t0, $t0, $s5
	addi.d	$t1, $sp, 1152
	maskeqz	$t1, $t1, $s5
...
.LBB8_81:                               # %.loopexit928
	...
	beqz	$a1, .LBB8_131
# %bb.82:                               # %.critedge.preheader
	blez	$t4, .LBB8_167
# %bb.83:                               # %.preheader919.lr.ph
	ldptr.w	$a1, $a3, 6392
	srai.d	$a5, $a1, 2
	blez	$a5, .LBB8_167
# %bb.84:                               # %.preheader919.lr.ph.split.us
	ldptr.d	$a1, $a3, 6504
	ld.d	$a7, $a1, 0
	addi.d	$t1, $sp, 1020
	pcalau12i	$a1, %got_pc_hi20(enc_picture)
	...
	b	.LBB8_86
	.p2align	4, , 16
.LBB8_85:                               # %._crit_edge993.us
                                        #   in Loop: Header=BB8_86 Depth=1
	addi.d	$t3, $t3, 1
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	beq	$t3, $a1, .LBB8_167
.LBB8_86:                               # %.preheader919.us
                                        # =>This Loop Header: Depth=1
...
.LBB8_87:                               #   in Loop: Header=BB8_88 Depth=2
	...
	st.h	$a1, $s3, 2
	beq	$s1, $a5, .LBB8_85
.LBB8_88:                               #   Parent Loop BB8_86 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_91 Depth 3
	slli.d	$s3, $s1, 3
	ldx.d	$a1, $s0, $s3
...
.LBB8_91:                               # %.lr.ph990.us
	...
	ld.d	$t0, $ra, 0
	beq	$t0, $s6, .LBB8_94
# %bb.92:                               #   in Loop: Header=BB8_91 Depth=3
	addi.d	$s7, $s7, 4
	addi.d	$ra, $ra, 8
	bne	$s8, $s7, .LBB8_91
...
# %bb.98:                               # %.lr.ph972.us.preheader
	...
	b	.LBB8_100
	.p2align	4, , 16
.LBB8_99:                               # %._crit_edge973.us
                                        #   in Loop: Header=BB8_100 Depth=1
	addi.d	$fp, $fp, 1
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	beq	$fp, $a1, .LBB8_43
.LBB8_100:                              # %.lr.ph972.us
                                        # =>This Loop Header: Depth=1
...
.LBB8_101:                              #   in Loop: Header=BB8_102 Depth=2
	...
	st.h	$a1, $t7, 2
	beq	$s5, $t4, .LBB8_99
.LBB8_102:                              #   Parent Loop BB8_100 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_120 Depth 3
                                        #       Child Loop BB8_108 Depth 3
                                        #       Child Loop BB8_114 Depth 3
...
# %bb.106:                              # %.preheader931.us
	...
	ori	$a1, $zero, 256
	blez	$t0, .LBB8_110
# %bb.107:                              # %.lr.ph967.us.preheader
                                        #   in Loop: Header=BB8_102 Depth=2
	move	$t8, $zero
	slli.d	$t3, $t0, 2
	move	$t6, $s2
	.p2align	4, , 16
.LBB8_108:                              # %.lr.ph967.us
                                        #   Parent Loop BB8_100 Depth=1
...
# %bb.109:                              #   in Loop: Header=BB8_108 Depth=3
	...
	addi.d	$t6, $t6, 8
	bne	$t3, $t8, .LBB8_108
.LBB8_110:                              #   in Loop: Header=BB8_102 Depth=2
	move	$a5, $zero
	b	.LBB8_126
	.p2align	4, , 16
.LBB8_111:                              #   in Loop: Header=BB8_102 Depth=2
	ldptr.d	$a1, $a3, 6504
	ld.d	$a1, $a1, 0
	ldx.d	$a1, $a1, $t5
	ldx.d	$a1, $a1, $t7
...
# %bb.112:                              # %.preheader929.us
	...
	ori	$a5, $zero, 256
	blez	$t0, .LBB8_116
# %bb.113:                              # %.lr.ph969.us.preheader
                                        #   in Loop: Header=BB8_102 Depth=2
	move	$t3, $zero
	slli.d	$t6, $t0, 2
	move	$ra, $s2
	.p2align	4, , 16
.LBB8_114:                              # %.lr.ph969.us
                                        #   Parent Loop BB8_100 Depth=1
                                        #     Parent Loop BB8_102 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t0, $ra, 0
...
# %bb.115:                              #   in Loop: Header=BB8_114 Depth=3
	...
	addi.d	$ra, $ra, 8
	bne	$t6, $t3, .LBB8_114
.LBB8_116:                              #   in Loop: Header=BB8_102 Depth=2
	move	$a1, $zero
	b	.LBB8_124
.LBB8_117:                              #   in Loop: Header=BB8_102 Depth=2
	ld.d	$a1, $a1, 32
	ldx.d	$a5, $a1, $t7
	beq	$a5, $s1, .LBB8_101
# %bb.118:                              # %.preheader933.us
                                        #   in Loop: Header=BB8_102 Depth=2
	ld.w	$a1, $a4, 0
	ldptr.w	$t0, $a2, 14456
	slti	$t2, $a5, 0
	...
	ori	$a1, $zero, 256
	blez	$t0, .LBB8_122
# %bb.119:                              # %.lr.ph965.us.preheader
                                        #   in Loop: Header=BB8_102 Depth=2
	move	$t8, $zero
	slli.d	$t3, $t0, 2
	move	$t6, $s2
	.p2align	4, , 16
.LBB8_120:                              # %.lr.ph965.us
                                        #   Parent Loop BB8_100 Depth=1
                                        #     Parent Loop BB8_102 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t0, $t6, 0
...
# %bb.121:                              #   in Loop: Header=BB8_120 Depth=3
	...
	addi.d	$t6, $t6, 8
	bne	$t3, $t8, .LBB8_120
.LBB8_122:                              #   in Loop: Header=BB8_102 Depth=2
	move	$a5, $zero
	b	.LBB8_128
.LBB8_123:                              #   in Loop: Header=BB8_102 Depth=2
	addi.d	$a5, $sp, 96
	masknez	$a5, $a5, $a1
	addi.d	$t0, $sp, 888
	maskeqz	$t0, $t0, $a1
...
.LBB8_124:                              # %.loopexit930.us
	...
	mul.d	$a1, $a1, $a5
	b	.LBB8_130
.LBB8_125:                              #   in Loop: Header=BB8_102 Depth=2
	addi.d	$a1, $sp, 96
	masknez	$a1, $a1, $t2
	addi.d	$a5, $sp, 888
	maskeqz	$a5, $a5, $t2
...
.LBB8_126:                              # %.loopexit932.us
	...
	maskeqz	$t2, $t1, $t2
	b	.LBB8_129
.LBB8_127:                              #   in Loop: Header=BB8_102 Depth=2
	addi.d	$a1, $sp, 96
	masknez	$a1, $a1, $t2
	addi.d	$a5, $sp, 888
	maskeqz	$a5, $a5, $t2
	...
	or	$a5, $t0, $a5
	ldx.w	$a5, $a5, $t8
.LBB8_128:                              # %.loopexit934.us
                                        #   in Loop: Header=BB8_102 Depth=2
	ld.d	$t0, $sp, 88                    # 8-byte Folded Reload
	masknez	$t0, $t0, $t2
	maskeqz	$t2, $a6, $t2
.LBB8_129:                              #   in Loop: Header=BB8_102 Depth=2
	or	$t0, $t2, $t0
	ldptr.d	$t0, $t0, 6512
	ld.d	$t0, $t0, 0
	slli.d	$t2, $s6, 3
	...
	ld.h	$a1, $t2, 2
	mul.d	$a1, $a5, $a1
.LBB8_130:                              #   in Loop: Header=BB8_102 Depth=2
	addi.w	$a1, $a1, 128
	srai.d	$a1, $a1, 8
	slt	$a5, $s3, $a1
	maskeqz	$a1, $a1, $a5
...
.LBB8_131:
	...
	beqz	$a1, .LBB8_147
.LBB8_132:                              # %.critedge913.preheader
	ld.d	$t3, $sp, 16                    # 8-byte Folded Reload
	blez	$t4, .LBB8_167
.LBB8_133:                              # %.preheader.lr.ph
	ldptr.w	$a1, $a3, 6392
	srai.d	$a4, $a1, 2
	blez	$a4, .LBB8_167
# %bb.134:                              # %.preheader.us.preheader
	ldptr.d	$a1, $a3, 6528
	move	$a2, $zero
	slli.d	$a3, $a4, 3
	b	.LBB8_136
	.p2align	4, , 16
.LBB8_135:                              # %._crit_edge1005.us
                                        #   in Loop: Header=BB8_136 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $t4, .LBB8_167
.LBB8_136:                              # %.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB8_141
	.p2align	4, , 16
.LBB8_137:                              #   in Loop: Header=BB8_141 Depth=2
	beqz	$t1, .LBB8_144
.LBB8_138:                              #   in Loop: Header=BB8_141 Depth=2
	ld.d	$t0, $a0, 16
	ld.d	$t1, $t0, 0
	ldx.d	$t1, $t1, $a4
	ld.d	$t0, $t0, 8
	...
	ld.h	$t1, $t0, 2
	slli.d	$t1, $t1, 1
.LBB8_139:                              # %.thread899.thread.us
                                        #   in Loop: Header=BB8_141 Depth=2
	st.h	$t1, $t0, 2
.LBB8_140:                              # %.thread899.thread.us
                                        #   in Loop: Header=BB8_141 Depth=2
	addi.d	$a6, $a6, 8
	addi.d	$a5, $a5, 1
	beq	$a3, $a6, .LBB8_135
.LBB8_141:                              #   Parent Loop BB8_136 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$t1, $a5, 0
	beqz	$a7, .LBB8_137
# %bb.142:                              #   in Loop: Header=BB8_141 Depth=2
	beqz	$t3, .LBB8_146
# %bb.143:                              # %.thread899.thread900.us
                                        #   in Loop: Header=BB8_141 Depth=2
	bnez	$t1, .LBB8_140
	b	.LBB8_145
.LBB8_144:                              # %.thread899.us
                                        #   in Loop: Header=BB8_141 Depth=2
	beqz	$t3, .LBB8_140
.LBB8_145:                              # %.thread899.thread900.us.thread
                                        #   in Loop: Header=BB8_141 Depth=2
	ld.d	$t0, $a0, 16
	ld.d	$t1, $t0, 0
	ldx.d	$t1, $t1, $a4
...
.LBB8_151:                              # %.lr.ph999.us
	...
	b	.LBB8_155
	.p2align	4, , 16
.LBB8_152:                              #   in Loop: Header=BB8_155 Depth=2
	ld.d	$a1, $a0, 16
	ld.d	$t0, $a1, 0
	ldx.d	$t0, $t0, $s5
	ldx.d	$t0, $t0, $ra
	...
	st.h	$zero, $a1, 0
.LBB8_153:                              # %.sink.split
                                        #   in Loop: Header=BB8_155 Depth=2
	st.h	$t1, $a1, 2
...
# %bb.157:                              # %.preheader914.us
	...
	ori	$t3, $zero, 256
	blez	$t4, .LBB8_161
# %bb.158:                              # %.lr.ph996.us.preheader
                                        #   in Loop: Header=BB8_155 Depth=2
	move	$t2, $zero
	slli.d	$t4, $t4, 2
	addi.d	$fp, $s4, 24
	.p2align	4, , 16
.LBB8_159:                              # %.lr.ph996.us
                                        #   Parent Loop BB8_151 Depth=1
                                        #     Parent Loop BB8_155 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t0, $fp, 0
	beq	$t0, $t5, .LBB8_162
# %bb.160:                              #   in Loop: Header=BB8_159 Depth=3
	addi.d	$t2, $t2, 4
	addi.d	$fp, $fp, 8
	bne	$t4, $t2, .LBB8_159
.LBB8_161:                              #   in Loop: Header=BB8_155 Depth=2
	move	$t1, $zero
	b	.LBB8_163
.LBB8_162:                              #   in Loop: Header=BB8_155 Depth=2
	addi.d	$t0, $sp, 96
	masknez	$t0, $t0, $t1
	addi.d	$t3, $sp, 888
	maskeqz	$t3, $t3, $t1
...
.LBB8_163:                              # %.loopexit915.us
	...
	slli.d	$t4, $s3, 3
	bgeu	$t0, $s7, .LBB8_165
# %bb.164:                              #   in Loop: Header=BB8_155 Depth=2
	ldptr.d	$t0, $fp, 6512
	b	.LBB8_166
.LBB8_165:                              #   in Loop: Header=BB8_155 Depth=2
	ldptr.d	$t0, $t2, 6512
.LBB8_166:                              # %.sink.split
                                        #   in Loop: Header=BB8_155 Depth=2
	ld.d	$t0, $t0, 0
...
.LBB9_110:
	...
	sltu	$a0, $zero, $a0
	add.w	$a1, $a1, $a0
.LBB9_111:                              # %EPZSBlockTypePredictors.exit
	add.d	$a0, $t7, $t4
	st.d	$a0, $sp, 280                   # 8-byte Folded Spill
	blez	$a1, .LBB9_131
# %bb.112:                              # %.lr.ph.preheader
...
# %bb.118:                              #   in Loop: Header=BB9_115 Depth=1
	...
	st.h	$a3, $a4, 0
	bge	$s3, $s5, .LBB9_114
# %bb.119:                              #   in Loop: Header=BB9_115 Depth=1
	move	$s6, $t3
	ori	$a2, $zero, 1
	ld.d	$a7, $sp, 344                   # 8-byte Folded Reload
	bltz	$a0, .LBB9_123
# %bb.120:                              #   in Loop: Header=BB9_115 Depth=1
	ori	$a2, $zero, 1
	bltz	$a1, .LBB9_123
# %bb.121:                              #   in Loop: Header=BB9_115 Depth=1
	...
	ori	$a2, $zero, 1
	bge	$a0, $a3, .LBB9_123
# %bb.122:                              #   in Loop: Header=BB9_115 Depth=1
	ld.d	$a2, $sp, 224                   # 8-byte Folded Reload
	ld.h	$a2, $a2, 0
	...
	slt	$a2, $a1, $a2
	xori	$a2, $a2, 1
.LBB9_123:                              #   in Loop: Header=BB9_115 Depth=1
	...
	move	$t3, $s6
	blt	$a0, $s6, .LBB9_113
# %bb.124:                              #   in Loop: Header=BB9_115 Depth=1
	ld.d	$ra, $sp, 336                   # 8-byte Folded Reload
	ld.d	$t5, $sp, 312                   # 8-byte Folded Reload
	ld.d	$t6, $sp, 320                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 288                   # 8-byte Folded Reload
	ld.d	$t2, $sp, 296                   # 8-byte Folded Reload
	bge	$a0, $s5, .LBB9_114
# %bb.125:                              #   in Loop: Header=BB9_115 Depth=1
	st.d	$s8, $sp, 168                   # 8-byte Folded Spill
	st.d	$s7, $sp, 160                   # 8-byte Folded Spill
	move	$s5, $a0
	ori	$s4, $zero, 1
	b	.LBB9_114
.LBB9_126:                              # %._crit_edge.loopexit
	sltu	$a1, $zero, $s4
	ld.d	$s6, $sp, 208                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
...
.LBB9_143:                              # =>This Loop Header: Depth=1
	...
	b	.LBB9_146
	.p2align	4, , 16
.LBB9_144:                              #   in Loop: Header=BB9_146 Depth=2
...
.LBB9_145:                              #   in Loop: Header=BB9_146 Depth=2
	...
	move	$a0, $fp
	beq	$a2, $s4, .LBB9_164
.LBB9_146:                              #   Parent Loop BB9_143 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB9_150 Depth 3
	...
	addi.d	$s5, $a0, 1
	b	.LBB9_150
.LBB9_147:                              #   in Loop: Header=BB9_150 Depth=3
	st.d	$s8, $sp, 256                   # 8-byte Folded Spill
	st.d	$s3, $sp, 248                   # 8-byte Folded Spill
	move	$t3, $a0
	st.d	$s1, $sp, 304                   # 8-byte Folded Spill
.LBB9_148:                              #   in Loop: Header=BB9_150 Depth=3
	ld.d	$ra, $sp, 336                   # 8-byte Folded Reload
	ld.d	$t5, $sp, 312                   # 8-byte Folded Reload
	...
	ld.d	$t2, $sp, 296                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB9_149:                              #   in Loop: Header=BB9_150 Depth=3
	ld.w	$a0, $fp, 0
	addi.w	$a2, $s1, 1
	slt	$a3, $a2, $a0
	masknez	$a0, $a0, $a3
	...
	sub.w	$s1, $a2, $a0
	bge	$s4, $s5, .LBB9_144
.LBB9_150:                              #   Parent Loop BB9_143 Depth=1
	...
	sub.w	$a2, $a2, $a3
	blt	$s0, $a2, .LBB9_149
# %bb.151:                              #   in Loop: Header=BB9_150 Depth=3
	alsl.d	$a0, $s1, $a0, 4
	ld.w	$a0, $a0, 4
	ld.h	$a2, $ra, 2
	add.w	$s3, $a0, $s2
	...
	sub.w	$a0, $a0, $a2
	bltu	$s0, $a0, .LBB9_149
# %bb.152:                              #   in Loop: Header=BB9_150 Depth=3
	ld.d	$a0, $t6, %pc_lo12(EPZSMap)
	add.w	$a2, $s3, $t2
	slli.d	$a2, $a2, 3
	ldx.d	$a4, $a0, $a2
	...
	ld.hu	$a3, $t5, %pc_lo12(EPZSBlkCount)
	beq	$a0, $a3, .LBB9_149
# %bb.153:                              #   in Loop: Header=BB9_150 Depth=3
	ld.d	$a0, $sp, 384                   # 8-byte Folded Reload
	add.d	$a0, $s8, $a0
	sll.w	$a0, $a0, $a1
	...
	st.h	$a3, $a4, 0
	bge	$s6, $t3, .LBB9_149
# %bb.154:                              #   in Loop: Header=BB9_150 Depth=3
	ori	$a1, $zero, 1
	bltz	$a0, .LBB9_158
# %bb.155:                              #   in Loop: Header=BB9_150 Depth=3
	ld.d	$a3, $sp, 240                   # 8-byte Folded Reload
	ld.h	$a3, $a3, 0
	ld.d	$a2, $sp, 344                   # 8-byte Folded Reload
	sub.d	$a3, $a3, $a2
	bge	$a0, $a3, .LBB9_159
# %bb.156:                              #   in Loop: Header=BB9_150 Depth=3
	bltz	$t1, .LBB9_159
# %bb.157:                              #   in Loop: Header=BB9_150 Depth=3
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	ld.h	$a1, $a1, 0
	ld.d	$a3, $sp, 368                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a3
...
.LBB9_158:                              #   in Loop: Header=BB9_150 Depth=3
	ld.d	$a2, $sp, 344                   # 8-byte Folded Reload
.LBB9_159:                              #   in Loop: Header=BB9_150 Depth=3
	ld.d	$a3, $sp, 328                   # 8-byte Folded Reload
	st.w	$a1, $a3, 0
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
	ld.d	$a6, $a1, 0
...
# %bb.160:                              #   in Loop: Header=BB9_150 Depth=3
	...
	b	.LBB9_148
	.p2align	4, , 16
.LBB9_161:                              #   in Loop: Header=BB9_146 Depth=2
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	bne	$a0, $s7, .LBB9_163
# %bb.162:                              #   in Loop: Header=BB9_146 Depth=2
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	beq	$a0, $s2, .LBB9_145
.LBB9_163:                              #   in Loop: Header=BB9_146 Depth=2
	ld.d	$a0, $fp, 8
	ld.d	$a2, $sp, 304                   # 8-byte Folded Reload
	alsl.d	$a0, $a2, $a0, 4
	ld.w	$s1, $a0, 8
	...
	bne	$a2, $s4, .LBB9_146
	.p2align	4, , 16
.LBB9_164:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$s6, $sp, 208                   # 8-byte Folded Reload
	blez	$s6, .LBB9_169
# %bb.165:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.w	$a0, $a0, 24
	bnez	$a0, .LBB9_169
# %bb.166:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	slli.w	$a2, $a0, 2
	blt	$a2, $t3, .LBB9_185
# %bb.167:                              #   in Loop: Header=BB9_143 Depth=1
	alsl.w	$a2, $a0, $a0, 1
	bge	$a2, $t3, .LBB9_169
# %bb.168:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$a2, $sp, 192                   # 8-byte Folded Reload
	bge	$a2, $a0, .LBB9_185
	.p2align	4, , 16
.LBB9_169:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	andi	$a0, $a0, 1
	ld.d	$s3, $sp, 256                   # 8-byte Folded Reload
	ld.d	$s8, $sp, 248                   # 8-byte Folded Reload
	beqz	$a0, .LBB9_178
# %bb.170:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.w	$a0, $a0, 20
	sltu	$a0, $zero, $a0
	...
	and	$a0, $a2, $a0
	bnez	$a0, .LBB9_178
# %bb.171:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	bge	$a0, $t3, .LBB9_178
# %bb.172:                              #   in Loop: Header=BB9_143 Depth=1
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldptr.w	$a0, $a0, 4092
	blez	$a0, .LBB9_178
# %bb.173:                              #   in Loop: Header=BB9_143 Depth=1
	ld.h	$a2, $ra, 0
	or	$a0, $s3, $s8
	bnez	$a0, .LBB9_176
.LBB9_174:                              # %._crit_edge666
	...
	srl.w	$a2, $a2, $a1
	bgeu	$a0, $a2, .LBB9_141
# %bb.175:                              #   in Loop: Header=BB9_143 Depth=1
	ld.h	$a0, $ra, 2
	sub.w	$a0, $s8, $a0
	srai.d	$a3, $a0, 31
	xor	$a0, $a0, $a3
	...
	b	.LBB9_142
	.p2align	4, , 16
.LBB9_176:                              #   in Loop: Header=BB9_143 Depth=1
	pcalau12i	$a0, %pc_hi20(searchPatternD)
	addi.d	$a0, $a0, %pc_lo12(searchPatternD)
	bne	$s3, $a2, .LBB9_142
# %bb.177:                              #   in Loop: Header=BB9_143 Depth=1
	ld.h	$a3, $ra, 2
	bne	$s8, $a3, .LBB9_142
	b	.LBB9_174
.LBB9_178:
...
# %bb.55:
	...
	ldptr.w	$a1, $a1, 4088
	pcalau12i	$a2, %pc_hi20(square)
	addi.d	$a2, $a2, %pc_lo12(square)
	st.d	$a2, $sp, 48                    # 8-byte Folded Spill
	pcalau12i	$a2, %pc_hi20(sdiamond)
	addi.d	$a2, $a2, %pc_lo12(sdiamond)
...
.LBB11_64:
	...
	ld.wu	$a3, $a3, %pc_lo12(mv_rescale)
	xor	$a1, $a1, $a2
	sub.w	$a2, $a1, $a2
	ori	$a1, $zero, 8
	srl.w	$a1, $a1, $a3
...
.LBB11_91:                              # %._crit_edge543
	...
	srl.w	$a2, $a2, $a1
	bgeu	$a0, $a2, .LBB11_69
# %bb.92:                               #   in Loop: Header=BB11_71 Depth=1
	ld.h	$a0, $t5, 2
	sub.w	$a0, $a5, $a0
	srai.d	$a3, $a0, 31
	xor	$a0, $a0, $a3
	...
	b	.LBB11_70
	.p2align	4, , 16
.LBB11_93:                              #   in Loop: Header=BB11_71 Depth=1
	pcalau12i	$a0, %pc_hi20(searchPatternD)
	addi.d	$a0, $a0, %pc_lo12(searchPatternD)
	bne	$a4, $a2, .LBB11_70
# %bb.94:                               #   in Loop: Header=BB11_71 Depth=1
	ld.h	$a3, $t5, 2
	bne	$a5, $a3, .LBB11_70
	b	.LBB11_91
.LBB11_95:
...
.LBB14_26:
	...
	ld.d	$a6, $a2, %got_pc_lo12(bipred2_access_method)
	ld.h	$a2, $s8, 0
...
.LBB14_66:
	ori	$a1, $zero, 1
.LBB14_67:
	ld.w	$s1, $a6, %pc_lo12(start_me_refinement_qp)
	ld.w	$a5, $sp, 312
...
.LBB14_73:
	...
	move	$a4, $zero
	move	$s5, $zero
.LBB14_74:                              # %._crit_edge476.thread
	add.d	$a0, $a4, $s5
	addi.w	$a2, $a0, -1
	ori	$a3, $zero, 6
	ori	$a0, $zero, 5
	bltu	$a3, $a2, .LBB14_77
# %bb.75:                               # %._crit_edge476.thread
	ori	$a3, $zero, 83
	srl.d	$a3, $a3, $a2
	andi	$a3, $a3, 1
	beqz	$a3, .LBB14_77
# %bb.76:                               # %switch.lookup569
	slli.d	$a2, $a2, 2
...
.LJTI14_0:
	...
	.word	.LBB14_50-.LJTI14_0
	.word	.LBB14_49-.LJTI14_0
	.word	.LBB14_50-.LJTI14_0
	.word	.LBB14_95-.LJTI14_0
	.word	.LBB14_50-.LJTI14_0
	.word	.LBB14_97-.LJTI14_0
.LJTI14_1:
	.word	.LBB14_80-.LJTI14_1
	.word	.LBB14_79-.LJTI14_1
