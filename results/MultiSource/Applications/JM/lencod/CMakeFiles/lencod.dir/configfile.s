...
.LBB1_37:                               # %.lr.ph114
	...
	b	.LBB1_39
	.p2align	4, , 16
.LBB1_38:                               #   in Loop: Header=BB1_40 Depth=3
	st.b	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	addi.d	$s6, $s6, 1
	ld.bu	$a1, $s6, 0
	bne	$a1, $s2, .LBB1_40
.LBB1_39:                               #   Parent Loop BB1_21 Depth=1
	...
	ld.bu	$a1, $s6, 0
	beq	$a1, $s2, .LBB1_39
.LBB1_40:                               #   Parent Loop BB1_21 Depth=1
                                        #     Parent Loop BB1_37 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bnez	$a1, .LBB1_38
...
# %bb.45:                               # %.lr.ph.i.i
	...
	b	.LBB1_50
.LBB1_46:                               # %._crit_edge52.i.i
                                        #   in Loop: Header=BB1_50 Depth=1
	ori	$a1, $zero, 300
	move	$a0, $fp
	move	$a2, $s0
.LBB1_47:                               # %.sink.split.i.i
                                        #   in Loop: Header=BB1_50 Depth=1
	pcaddu18i	$ra, %call36(snprintf)
	jirl	$ra, $ra, 0
.LBB1_48:                               # %.sink.split.i.i
                                        #   in Loop: Header=BB1_50 Depth=1
	ori	$a1, $zero, 400
	move	$a0, $fp
	pcaddu18i	$ra, %call36(error)
...
# %bb.59:                               #   in Loop: Header=BB1_50 Depth=1
	...
	b	.LBB1_48
	.p2align	4, , 16
.LBB1_60:                               #   in Loop: Header=BB1_50 Depth=1
	ld.w	$a0, $s5, -16
	bnez	$a0, .LBB1_49
# %bb.61:                               #   in Loop: Header=BB1_50 Depth=1
	ld.d	$a0, $s5, -24
	fld.d	$fa0, $s5, 8
	ld.w	$a0, $a0, 0
	fld.d	$fa1, $s5, 16
	fsub.d	$fa0, $fa0, $fs0
.LBB1_62:                               #   in Loop: Header=BB1_50 Depth=1
	ftintrz.w.d	$fa0, $fa0
	movfr2gr.s	$a4, $fa0
	ftintrz.w.d	$fa0, $fa1
	movfr2gr.s	$a5, $fa0
	blt	$a0, $a4, .LBB1_46
# %bb.63:                               #   in Loop: Header=BB1_50 Depth=1
	bge	$a5, $a0, .LBB1_49
	b	.LBB1_46
.LBB1_64:                               #   in Loop: Header=BB1_50 Depth=1
	ld.d	$a0, $s5, -24
	fld.d	$fa1, $a0, 0
	fld.d	$fa0, $s5, 8
	fcmp.cule.d	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB1_49
# %bb.65:                               #   in Loop: Header=BB1_50 Depth=1
	movfr2gr.d	$a4, $fa0
	ori	$a1, $zero, 300
	move	$a0, $fp
	move	$a2, $s6
	...
	jirl	$ra, $ra, 0
	b	.LBB1_48
.LBB1_66:                               #   in Loop: Header=BB1_50 Depth=1
	ld.d	$a0, $s5, -24
	fld.d	$fa2, $a0, 0
	fld.d	$fa0, $s5, 8
	fld.d	$fa1, $s5, 16
	...
	bcnez	$fcc0, .LBB1_68
# %bb.67:                               #   in Loop: Header=BB1_50 Depth=1
	fcmp.cule.d	$fcc0, $fa2, $fa1
	bcnez	$fcc0, .LBB1_49
.LBB1_68:                               # %._crit_edge53.i.i
                                        #   in Loop: Header=BB1_50 Depth=1
	movfr2gr.d	$a4, $fa0
	movfr2gr.d	$a5, $fa1
	ori	$a1, $zero, 300
...
# %bb.239:
	...
	ld.w	$a1, $a0, 1564
	beqz	$a1, .LBB1_241
.LBB1_240:                              # %.thread293.i
	ori	$a1, $zero, 1
	stptr.w	$a1, $a0, 4000
.LBB1_241:                              # %.thread291.i
	ldptr.w	$a1, $a0, 5084
	beqz	$a1, .LBB1_253
# %bb.242:
	ldptr.w	$a1, $a0, 4704
...
# %bb.29:                               #   in Loop: Header=BB3_28 Depth=2
	...
	addi.d	$s3, $s3, 56
	bnez	$a0, .LBB3_28
.LBB3_30:                               # %ParameterNameToMapIndex.exit.thread
                                        #   in Loop: Header=BB3_26 Depth=1
	ori	$a1, $zero, 300
	move	$a0, $fp
	...
	b	.LBB3_32
	.p2align	4, , 16
.LBB3_31:                               # %ParameterNameToMapIndex.exit.loopexit
                                        #   in Loop: Header=BB3_26 Depth=1
	srai.d	$s1, $s1, 32
