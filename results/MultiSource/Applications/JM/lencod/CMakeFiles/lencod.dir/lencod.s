...
.LBB6_15:
	...
	bne	$a0, $a2, .LBB6_22
# %bb.16:
	pcalau12i	$fp, %pc_hi20(decs)
	ld.d	$a0, $fp, %pc_lo12(decs)
	ori	$a1, $zero, 16
	ori	$a2, $zero, 16
	pcaddu18i	$ra, %call36(get_mem2Dint)
	jirl	$ra, $ra, 0
	ld.d	$s4, $s0, %pc_lo12(input)
	ldptr.w	$a2, $s4, 4728
	add.d	$s3, $a0, $s3
	ori	$a1, $zero, 8
	move	$a0, $a2
...
# %bb.132:
	...
	addi.w	$t1, $t0, 0
	ld.d	$a1, $a1, 736
	fld.d	$fa6, $s4, %pc_lo12(tot_time)
	pcalau12i	$t2, %pc_hi20(.LCPI14_0)
	fld.d	$fa7, $t2, %pc_lo12(.LCPI14_0)
	div.d	$a6, $a6, $t1
	div.d	$a1, $a1, $a5
	ffint.d.l	$fa6, $fa6
	fmul.d	$fa6, $fa6, $fa7
...
# %bb.134:
	...
	ld.d	$a1, $a1, 16
	fld.d	$fa6, $s4, %pc_lo12(tot_time)
	pcalau12i	$a6, %pc_hi20(.LCPI14_0)
	fld.d	$fa7, $a6, %pc_lo12(.LCPI14_0)
	add.d	$a1, $a1, $a5
	div.d	$a1, $a1, $a2
	ffint.d.l	$fa6, $fa6
	fmul.d	$fa6, $fa6, $fa7
