...
.LBB0_51:                               # %call.sqrt
	...
	jirl	$ra, $ra, 0
	b	.LBB0_31
.LBB0_52:                               # %call.sqrt650
                                        #   in Loop: Header=BB0_29 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_33
.LBB0_53:                               # %call.sqrt652
                                        #   in Loop: Header=BB0_29 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
...
.LBB0_98:                               # %.lr.ph.preheader
	...
	b	.LBB0_101
	.p2align	4, , 16
.LBB0_99:                               # %.loopexit501.loopexit
                                        #   in Loop: Header=BB0_101 Depth=1
	ld.d	$s3, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a2, $s3, 416
.LBB0_100:                              # %.loopexit501
                                        #   in Loop: Header=BB0_101 Depth=1
	addi.w	$a1, $a2, 1
	st.w	$a1, $s3, 416
...
.LBB0_211:
	move	$a1, $zero
	ori	$fp, $zero, 3
.LBB0_212:                              # %.lr.ph528.preheader
	ld.d	$a6, $sp, 112                   # 8-byte Folded Reload
	move	$a7, $s7
.LBB0_213:                              # %.lr.ph528.preheader
	addi.d	$a0, $s8, -2
	ld.w	$s7, $s5, 20
	sltui	$a2, $a0, 1
	st.w	$a1, $s0, 416
