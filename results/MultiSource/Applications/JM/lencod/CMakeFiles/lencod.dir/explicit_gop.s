...
.LBB0_30:                               # %vector.body120
	...
	add.d	$s1, $s1, $s2
	bnez	$s3, .LBB0_30
# %bb.31:                               # %middle.block124
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$fp, $s0, .LBB0_22
.LBB0_32:                               # %scalar.ph115.preheader
                                        #   in Loop: Header=BB0_23 Depth=1
	mul.d	$fp, $t8, $t2
	add.d	$fp, $a6, $fp
	.p2align	4, , 16
.LBB0_33:                               # %scalar.ph115
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t3, $fp, 0
	st.w	$a5, $fp, -8
...
.LBB0_35:                               # %vector.body106
	...
	add.d	$s1, $s1, $s2
	bnez	$s3, .LBB0_35
# %bb.36:                               # %middle.block109
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$fp, $s0, .LBB0_22
.LBB0_37:                               # %scalar.ph101.preheader
                                        #   in Loop: Header=BB0_23 Depth=1
	mul.d	$fp, $t8, $t2
	add.d	$fp, $a6, $fp
	.p2align	4, , 16
.LBB0_38:                               # %scalar.ph101
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t3, $fp, 0
	st.w	$a5, $fp, -8
