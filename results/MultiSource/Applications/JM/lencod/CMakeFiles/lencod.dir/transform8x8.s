...
# %bb.49:
	...
	vld	$vr4, $t6, %pc_lo12(.LCPI2_0)
	pcalau12i	$t6, %pc_hi20(.LCPI2_1)
	vld	$vr6, $t6, %pc_lo12(.LCPI2_1)
...
# %bb.51:                               # %.thread
	...
	vstelm.h	$vr0, $t2, 0, 2
	vstelm.h	$vr0, $a6, 0, 4
	vstelm.h	$vr0, $a0, 44, 1
	vstelm.h	$vr0, $a0, 24, 1
	vstelm.h	$vr0, $a0, 4, 1
	vstelm.h	$vr0, $a0, 28, 3
	vstelm.h	$vr0, $a0, 8, 3
	vstelm.h	$vr0, $a0, 12, 5
	b	.LBB2_53
.LBB2_52:
	ld.d	$s2, $sp, 24                    # 8-byte Folded Reload
	beqz	$s1, .LBB2_54
