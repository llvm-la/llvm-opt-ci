...
# %bb.22:                               # %middle.block268
	...
	move	$t6, $t2
	beq	$t2, $s3, .LBB6_25
.LBB6_23:                               # %scalar.ph232.preheader
                                        #   in Loop: Header=BB6_18 Depth=1
	sub.d	$a0, $s3, $t6
	.p2align	4, , 16
.LBB6_24:                               # %scalar.ph232
                                        #   Parent Loop BB6_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t5, $a2, 0
	mul.d	$t5, $t0, $t5
...
# %bb.37:                               # %middle.block311
	...
	move	$t6, $t2
	beq	$t2, $s3, .LBB6_40
.LBB6_38:                               # %scalar.ph275.preheader
                                        #   in Loop: Header=BB6_33 Depth=1
	sub.d	$a0, $s3, $t6
	.p2align	4, , 16
.LBB6_39:                               # %scalar.ph275
                                        #   Parent Loop BB6_33 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t5, $a2, 0
	mul.d	$t5, $t0, $t5
...
# %bb.22:                               # %middle.block373
	...
	ori	$t8, $zero, 8
	beq	$t2, $s5, .LBB8_25
.LBB8_23:                               # %scalar.ph327.preheader
                                        #   in Loop: Header=BB8_18 Depth=1
	sub.d	$a0, $s5, $t7
	.p2align	4, , 16
.LBB8_24:                               # %scalar.ph327
                                        #   Parent Loop BB8_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	ld.hu	$t5, $a3, 0
...
# %bb.37:                               # %middle.block427
	...
	ori	$t8, $zero, 8
	beq	$t2, $s5, .LBB8_40
.LBB8_38:                               # %scalar.ph381.preheader
                                        #   in Loop: Header=BB8_33 Depth=1
	sub.d	$a0, $s5, $t7
	.p2align	4, , 16
.LBB8_39:                               # %scalar.ph381
                                        #   Parent Loop BB8_33 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	ld.hu	$t5, $a3, 0
...
.LBB10_14:                              #   Parent Loop BB10_13 Depth=1
	...
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	ld.w	$a3, $a1, %pc_lo12(wp_luma_round)
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.wu	$a2, $a1, %pc_lo12(luma_log_weight_denom)
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(offset_luma)
	ldx.w	$a6, $a5, $s3
	ld.hu	$a7, $a0, 6
	ld.hu	$t0, $a0, 4
	ld.hu	$t1, $a0, 2
...
.LBB12_14:                              #   Parent Loop BB12_13 Depth=1
	...
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ld.d	$t0, $s7, %pc_lo12(ref2_line)
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.h	$a2, $a2, %pc_lo12(offsetBi)
	ld.d	$a5, $s3, %pc_lo12(src_line)
	alsl.d	$a7, $fp, $a0, 1
	alsl.d	$a6, $fp, $t0, 1
	ld.hu	$t1, $a0, 6
	ld.hu	$t2, $a0, 4
	...
	alsl.d	$a1, $fp, $a1, 1
	addi.d	$a1, $a1, 8
	st.d	$a1, $s7, %pc_lo12(ref2_line)
	alsl.d	$a0, $s4, $a0, 1
	alsl.d	$a0, $s4, $a0, 1
	st.d	$a0, $s3, %pc_lo12(src_line)
	vmaxi.w	$vr0, $vr0, 0
	vmin.w	$vr0, $vr0, $vr1
	...
	vmaxi.w	$vr0, $vr3, 0
	vmin.w	$vr0, $vr0, $vr1
	vilvl.h	$vr2, $vr10, $vr4
	vsub.w	$vr0, $vr2, $vr0
	vst	$vr0, $a0, 16
	vmaxi.w	$vr0, $vr5, 0
	vmin.w	$vr0, $vr0, $vr1
	vilvl.h	$vr1, $vr10, $vr6
	vsub.w	$vr0, $vr1, $vr0
	vst	$vr0, $a0, 32
	vmaxi.w	$vr0, $vr7, 0
	vmin.w	$vr0, $vr0, $vr8
	vilvl.h	$vr1, $vr10, $vr9
	vsub.w	$vr0, $vr1, $vr0
	vst	$vr0, $a0, 48
	pcaddu18i	$ra, %call36(HadamardSAD4x4)
	jirl	$ra, $ra, 0
...
# %bb.22:                               # %middle.block274
	...
	move	$t5, $t1
	beq	$t1, $s3, .LBB14_25
.LBB14_23:                              # %scalar.ph238.preheader
                                        #   in Loop: Header=BB14_18 Depth=1
	sub.d	$a0, $s3, $t5
	.p2align	4, , 16
.LBB14_24:                              # %scalar.ph238
                                        #   Parent Loop BB14_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	mul.d	$t4, $a7, $t4
...
# %bb.37:                               # %middle.block317
	...
	move	$t5, $t1
	beq	$t1, $s3, .LBB14_40
.LBB14_38:                              # %scalar.ph281.preheader
                                        #   in Loop: Header=BB14_33 Depth=1
	sub.d	$a0, $s3, $t5
	.p2align	4, , 16
.LBB14_39:                              # %scalar.ph281
                                        #   Parent Loop BB14_33 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	mul.d	$t4, $a7, $t4
...
# %bb.22:                               # %middle.block379
	...
	move	$t6, $t1
	beq	$t1, $s5, .LBB16_25
.LBB16_23:                              # %scalar.ph333.preheader
                                        #   in Loop: Header=BB16_18 Depth=1
	sub.d	$a0, $s5, $t6
	.p2align	4, , 16
.LBB16_24:                              # %scalar.ph333
                                        #   Parent Loop BB16_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	ld.hu	$t5, $a3, 0
...
# %bb.37:                               # %middle.block433
	...
	move	$t6, $t1
	beq	$t1, $s5, .LBB16_40
.LBB16_38:                              # %scalar.ph387.preheader
                                        #   in Loop: Header=BB16_33 Depth=1
	sub.d	$a0, $s5, $t6
	.p2align	4, , 16
.LBB16_39:                              # %scalar.ph387
                                        #   Parent Loop BB16_33 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	ld.hu	$t5, $a3, 0
...
.LBB16_45:
	move	$s2, $zero
	b	.LBB16_47
.LBB16_46:                              # %.preheader.us171.preheader.1
