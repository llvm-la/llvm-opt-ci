...
# %bb.3:                                # %.preheader90.us.preheader
	...
	pcalau12i	$s6, %pc_hi20(offset_luma)
...
.LBB10_5:                               #   Parent Loop BB10_4 Depth=1
	...
	ld.w	$a6, $s6, %pc_lo12(offset_luma)
	ori	$a7, $zero, 8
	move	$a4, $s2
	move	$t0, $fp
	.p2align	4, , 16
...
.LBB12_14:                              #   Parent Loop BB12_13 Depth=1
	...
	ld.d	$t1, $s7, %pc_lo12(ref2_line)
	ld.d	$a5, $s5, %pc_lo12(src_line)
