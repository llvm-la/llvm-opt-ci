...
# %bb.0:
	...
	move	$a2, $s3
	jirl	$ra, $a3, 0
	pcalau12i	$a6, %pc_hi20(ref1_line)
	st.d	$a0, $a6, %pc_lo12(ref1_line)
	st.d	$s2, $sp, 104                   # 8-byte Folded Spill
	blez	$s6, .LBB8_12
# %bb.1:                                # %.preheader103.lr.ph
	ld.d	$t7, $s2, %pc_lo12(ref2_line)
	blez	$s5, .LBB8_13
# %bb.2:                                # %.preheader103.lr.ph.split.us
	st.d	$a6, $sp, 96                    # 8-byte Folded Spill
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s3, $a1, %pc_lo12(src_line)
...
# %bb.16:                               # %.preheader.lr.ph.us.preheader
	...
	slli.d	$a0, $a1, 3
	pcalau12i	$a1, %pc_hi20(get_crline)
	addi.d	$s6, $a1, %pc_lo12(get_crline)
	ldx.d	$a3, $s6, $a0
	...
	st.d	$a0, $s6, %pc_lo12(ref2_line)
	move	$a0, $a1
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 72                    # 8-byte Folded Reload
	jirl	$ra, $a3, 0
	ld.d	$t5, $s6, %pc_lo12(ref2_line)
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
...
.LBB8_45:
	move	$s2, $zero
	b	.LBB8_47
.LBB8_46:                               # %.preheader.us165.preheader.1
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	add.d	$a1, $t5, $a2
	add.d	$a0, $a0, $a2
...
# %bb.3:                                # %.preheader90.us.preheader
	...
	pcalau12i	$s8, %pc_hi20(weight_luma)
	pcalau12i	$s1, %pc_hi20(wp_luma_round)
...
.LBB10_5:                               #   Parent Loop BB10_4 Depth=1
	...
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ld.w	$a2, $s8, %pc_lo12(weight_luma)
	ld.w	$a3, $s1, %pc_lo12(wp_luma_round)
...
.LBB10_14:                              #   Parent Loop BB10_13 Depth=1
	...
	ld.d	$a1, $a1, 0
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	ld.w	$a4, $a2, %pc_lo12(weight_luma)
	ld.hu	$a6, $a0, 0
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	ld.w	$a5, $a2, %pc_lo12(wp_luma_round)
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
...
.LBB11_5:                               #   Parent Loop BB11_4 Depth=1
	...
	move	$a2, $s2
	jirl	$ra, $a3, 0
	ld.d	$a5, $fp, %pc_lo12(ref2_line)
	ld.d	$a4, $s3, %pc_lo12(src_line)
	alsl.d	$a2, $s1, $a0, 1
	alsl.d	$a1, $s1, $a5, 1
	ld.hu	$a3, $a4, 14
	ld.d	$a6, $a4, 0
	...
	xvinsgr2vr.w	$xr2, $t7, 5
	xvinsgr2vr.w	$xr2, $t6, 6
	xvinsgr2vr.w	$xr2, $t2, 7
	xvavgr.wu	$xr1, $xr1, $xr2
