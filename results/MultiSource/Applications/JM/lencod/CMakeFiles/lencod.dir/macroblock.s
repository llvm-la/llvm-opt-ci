...
.LBB17_124:                             # %.preheader451
	...
	beqz	$a0, .LBB17_131
	b	.LBB17_146
.LBB17_125:                             # %vector.body840.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	addi.d	$a0, $sp, 588
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	addi.d	$a2, $sp, 954
	.p2align	4, , 16
.LBB17_126:                             # %vector.body840
                                        #   Parent Loop BB17_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a0, -24
	ld.w	$a4, $a0, 0
...
# %bb.127:                              # %middle.block843
	...
	move	$a2, $a0
	beq	$a0, $ra, .LBB17_130
.LBB17_128:                             # %.lr.ph492.preheader849
                                        #   in Loop: Header=BB17_27 Depth=1
	addi.d	$a0, $sp, 952
	alsl.d	$a0, $a2, $a0, 1
	sub.d	$a1, $ra, $a2
...
# %bb.139:                              # %vec.epilog.middle.block
	...
	b	.LBB17_144
	.p2align	4, , 16
.LBB17_140:                             # %vector.body822.preheader
                                        #   in Loop: Header=BB17_133 Depth=2
	addi.d	$a4, $sp, 968
	move	$a5, $a2
	ld.d	$a6, $sp, 480                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB17_141:                             # %vector.body822
                                        #   Parent Loop BB17_27 Depth=1
                                        #     Parent Loop BB17_133 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$a7, $a4, -16
...
# %bb.143:                              # %vec.epilog.iter.check
	...
	bnez	$a4, .LBB17_137
	.p2align	4, , 16
.LBB17_144:                             # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB17_133 Depth=2
	addi.d	$a4, $sp, 952
	alsl.d	$a4, $a6, $a4, 1
	slli.d	$a5, $a6, 5
	...
	sub.d	$a6, $ra, $a6
	.p2align	4, , 16
.LBB17_145:                             # %vec.epilog.scalar.ph
                                        #   Parent Loop BB17_27 Depth=1
                                        #     Parent Loop BB17_133 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$a7, $a4, 0
...
# %bb.152:                              # %middle.block810
	...
	beq	$a5, $a3, .LBB17_155
.LBB17_153:                             # %.lr.ph501.preheader848
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a5, $a7, 1
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	alsl.d	$a3, $a7, $a3, 1
...
# %bb.162:                              # %middle.block788
	...
	beq	$a5, $a2, .LBB17_165
.LBB17_163:                             # %.lr.ph507.preheader847
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a5, $a7, 1
...
.LBB17_164:                             # %.lr.ph507
	...
	addi.d	$a7, $a7, 1
	bnez	$a6, .LBB17_164
.LBB17_165:                             # %._crit_edge508.thread
                                        #   in Loop: Header=BB17_27 Depth=1
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	mul.d	$a2, $a4, $a2
	ld.d	$a4, $sp, 208                   # 8-byte Folded Reload
	...
	sra.w	$a2, $a2, $a4
	blez	$s2, .LBB17_26
.LBB17_166:                             # %.preheader448.lr.ph.split.us
                                        #   in Loop: Header=BB17_27 Depth=1
	move	$a4, $zero
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	mul.d	$a1, $a1, $a5
	...
	b	.LBB17_168
	.p2align	4, , 16
.LBB17_167:                             # %._crit_edge512.us
                                        #   in Loop: Header=BB17_168 Depth=2
	addi.d	$a4, $a4, 1
	addi.d	$a0, $a0, 32
	add.d	$a6, $a6, $a2
	beq	$a4, $s6, .LBB17_26
.LBB17_168:                             # %.preheader448.us
                                        #   Parent Loop BB17_27 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_171 Depth 3
                                        #       Child Loop BB17_174 Depth 3
...
.LBB17_181:                             # %.split537.us
	...
	ori	$a7, $zero, 2
	ori	$t0, $zero, 4
.LBB17_182:                             #   in Loop: Header=BB17_183 Depth=1
	addi.d	$a3, $a3, 1
	...
	addi.d	$a5, $a5, 512
	beq	$a3, $t0, .LBB17_202
.LBB17_183:                             # =>This Loop Header: Depth=1
	...
	ld.d	$a0, $s2, 0
	bne	$a1, $a7, .LBB17_187
# %bb.184:                              #   in Loop: Header=BB17_183 Depth=1
	ldptr.w	$a1, $a0, 4048
	beqz	$a1, .LBB17_187
# %bb.185:                              #   in Loop: Header=BB17_183 Depth=1
	bne	$a3, $a7, .LBB17_189
# %bb.186:                              #   in Loop: Header=BB17_183 Depth=1
	beqz	$a2, .LBB17_182
	b	.LBB17_189
	.p2align	4, , 16
.LBB17_187:                             #   in Loop: Header=BB17_183 Depth=1
	ldptr.w	$a0, $a0, 4072
	addi.d	$a0, $a0, -1
	sltui	$a0, $a0, 1
	sltu	$a1, $zero, $a3
	and	$a0, $a1, $a0
	bnez	$a0, .LBB17_182
# %bb.188:                              #   in Loop: Header=BB17_183 Depth=1
	addi.d	$a0, $a3, -2
	sltu	$a0, $zero, $a0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	or	$a0, $a0, $a1
	beqz	$a0, .LBB17_182
.LBB17_189:                             #   in Loop: Header=BB17_183 Depth=1
	ori	$a0, $zero, 3
	beq	$a3, $a0, .LBB17_192
# %bb.190:                              #   in Loop: Header=BB17_183 Depth=1
	ori	$a0, $zero, 1
	bne	$a3, $a0, .LBB17_193
# %bb.191:                              #   in Loop: Header=BB17_183 Depth=1
	ld.d	$a0, $sp, 376                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_182
	b	.LBB17_193
.LBB17_192:                             #   in Loop: Header=BB17_183 Depth=1
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_182
.LBB17_193:                             #   in Loop: Header=BB17_183 Depth=1
	...
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	bnez	$a0, .LBB17_180
# %bb.194:                              # %.preheader433.lr.ph.us.us
                                        #   in Loop: Header=BB17_183 Depth=1
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
	...
	.p2align	4, , 16
.LBB17_195:                             # %.preheader433.us.us.us
	...
	add.d	$s0, $a2, $a0
	.p2align	4, , 16
.LBB17_196:                             # %.preheader432.us.us.us
                                        #   Parent Loop BB17_183 Depth=1
...
# %bb.197:                              # %._crit_edge524.us.us.us
	...
	ld.d	$a0, $sp, 472                   # 8-byte Folded Reload
	blt	$a1, $a0, .LBB17_195
# %bb.198:                              # %._crit_edge528.split.us.us.us
                                        #   in Loop: Header=BB17_183 Depth=1
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(imgUV_org)
	ld.d	$s8, $a0, 8
	...
	.p2align	4, , 16
.LBB17_199:                             # %.preheader433.us.us.us.1
                                        #   Parent Loop BB17_183 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_200 Depth 3
	st.d	$a1, $sp, 456                   # 8-byte Folded Spill
	...
	add.d	$s7, $a2, $a0
	.p2align	4, , 16
.LBB17_200:                             # %.preheader432.us.us.us.1
                                        #   Parent Loop BB17_183 Depth=1
	...
	ld.d	$a0, $sp, 512                   # 8-byte Folded Reload
	blt	$s4, $a0, .LBB17_200
# %bb.201:                              # %._crit_edge524.us.us.us.1
