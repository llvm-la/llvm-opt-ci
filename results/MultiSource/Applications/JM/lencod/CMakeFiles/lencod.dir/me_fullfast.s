...
.LBB4_26:                               # %.loopexit553
	...
	vst	$vr14, $sp, 192                 # 16-byte Folded Spill
	b	.LBB4_28
	.p2align	4, , 16
.LBB4_27:                               # %.loopexit
...
.LBB4_39:                               #   Parent Loop BB4_28 Depth=1
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr5, $t1, -16
	vilvh.h	$vr6, $vr14, $vr5
	vilvl.h	$vr5, $vr14, $vr5
	vori.b	$vr7, $vr1, 0
	vmadd.w	$vr7, $vr0, $vr5
	vori.b	$vr5, $vr1, 0
	vmadd.w	$vr5, $vr0, $vr6
	...
	vmaxi.w	$vr6, $vr6, 0
	vmin.w	$vr6, $vr6, $vr4
	vilvl.h	$vr8, $vr14, $vr7
	vsub.w	$vr6, $vr6, $vr8
	vpickve2gr.w	$t5, $vr6, 0
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $s5, $t5
	vmin.w	$vr5, $vr5, $vr4
	vilvh.h	$vr7, $vr14, $vr7
	vsub.w	$vr5, $vr5, $vr7
	add.d	$t0, $t5, $t0
