...
# %bb.6:                                #   in Loop: Header=BB3_5 Depth=1
	move	$s1, $zero
.LBB3_7:                                # %vec.epilog.scalar.ph199.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$t0, $s1, $s5, 1
	alsl.d	$s4, $s1, $s2, 1
	alsl.d	$s5, $s1, $ra, 1
	sub.d	$s6, $s3, $s1
	.p2align	4, , 16
.LBB3_8:                                # %vec.epilog.scalar.ph199
	...
	addi.d	$s5, $s5, 2
	bnez	$s6, .LBB3_8
.LBB3_9:                                # %iter.check164
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s5, $a4, $s0, 1
	move	$t0, $s3
	bgeu	$a7, $s8, .LBB3_19
.LBB3_10:                               # %vec.epilog.scalar.ph165.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s0, $t0, $ra, 1
	alsl.d	$s2, $t0, $s2, 1
	.p2align	4, , 16
.LBB3_11:                               # %vec.epilog.scalar.ph165
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t8, $s2, 0
	ld.hu	$s1, $s5, 0
	...
	b	.LBB3_4
	.p2align	4, , 16
.LBB3_12:                               # %vector.memcheck180
                                        #   in Loop: Header=BB3_5 Depth=1
	sub.d	$t0, $ra, $s2
	move	$s1, $zero
	bltu	$t0, $t7, .LBB3_7
# %bb.13:                               # %vector.memcheck180
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$t0, $t6, $s0
	sub.d	$t0, $ra, $t0
	bltu	$t0, $t7, .LBB3_7
# %bb.14:                               # %vector.main.loop.iter.check185
                                        #   in Loop: Header=BB3_5 Depth=1
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB3_23
# %bb.15:                               #   in Loop: Header=BB3_5 Depth=1
	move	$t8, $zero
.LBB3_16:                               # %vec.epilog.ph202
                                        #   in Loop: Header=BB3_5 Depth=1
	...
	alsl.d	$s1, $t8, $s2, 1
	.p2align	4, , 16
.LBB3_17:                               # %vec.epilog.vector.body205
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s1, 0
	vld	$vr1, $s6, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$t0, .LBB3_17
# %bb.18:                               # %vec.epilog.middle.block210
                                        #   in Loop: Header=BB3_5 Depth=1
...
# %bb.22:                               #   in Loop: Header=BB3_5 Depth=1
	move	$s0, $zero
	b	.LBB3_31
.LBB3_23:                               # %vector.body190.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$t0, $a7, $s0, 1
	move	$s1, $s2
	move	$s4, $ra
...
.LBB3_24:                               # %vector.body190
	...
	addi.d	$s1, $s1, 32
	bnez	$s6, .LBB3_24
# %bb.25:                               # %middle.block195
                                        #   in Loop: Header=BB3_5 Depth=1
	beq	$fp, $s3, .LBB3_9
# %bb.26:                               # %vec.epilog.iter.check200
                                        #   in Loop: Header=BB3_5 Depth=1
	move	$t8, $fp
	move	$s1, $fp
...
.LBB3_28:                               # %vector.body156
	...
	addi.d	$s4, $s4, 32
	bnez	$t0, .LBB3_28
# %bb.29:                               # %middle.block160
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.d	$t0, $sp, 80                    # 8-byte Folded Reload
	beq	$t5, $t0, .LBB3_4
# %bb.30:                               # %vec.epilog.iter.check166
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.d	$s0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$t0, $sp, 16                    # 8-byte Folded Reload
	ld.d	$t8, $sp, 24                    # 8-byte Folded Reload
	beqz	$t8, .LBB3_10
.LBB3_31:                               # %vec.epilog.ph168
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.h	$t0, $s5, 0
	...
	alsl.d	$s1, $t8, $s2, 1
	.p2align	4, , 16
.LBB3_32:                               # %vec.epilog.vector.body173
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t8, $s1, 0
