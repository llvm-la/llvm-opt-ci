...
# %bb.13:                               # %vector.memcheck166
	...
	sub.d	$t0, $t8, $t0
	bltu	$t0, $s8, .LBB3_7
# %bb.14:                               # %vector.body175.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$t0, $a7, $s3, 1
	move	$fp, $ra
	move	$s0, $t8
...
# %bb.18:                               # %vector.memcheck119
	...
	move	$t0, $s7
	bnez	$fp, .LBB3_10
# %bb.19:                               # %vector.main.loop.iter.check134
                                        #   in Loop: Header=BB3_5 Depth=1
	ori	$t0, $zero, 15
	bgeu	$a7, $t0, .LBB3_21
...
.LBB3_26:                               # %vec.epilog.vector.body159
	...
	addi.d	$s2, $s2, 8
	bnez	$t0, .LBB3_26
# %bb.27:                               # %vec.epilog.middle.block163
                                        #   in Loop: Header=BB3_5 Depth=1
...
.LBB3_50:                               # %scalar.ph
	...
	b	.LBB3_46
	.p2align	4, , 16
.LBB3_51:                               # %vector.memcheck105
                                        #   in Loop: Header=BB3_47 Depth=1
	sub.d	$t8, $t5, $t4
	move	$t7, $zero
	bltu	$t8, $t3, .LBB3_49
# %bb.52:                               # %vector.memcheck105
                                        #   in Loop: Header=BB3_47 Depth=1
	add.d	$t8, $t0, $t6
	sub.d	$t8, $t5, $t8
	bltu	$t8, $t3, .LBB3_49
# %bb.53:                               # %vector.body112.preheader
                                        #   in Loop: Header=BB3_47 Depth=1
	alsl.d	$t7, $a7, $t6, 1
	move	$t8, $t4
	move	$fp, $t5
