...
.LBB3_9:                                # %..preheader_crit_edge.us.us
	...
	move	$s8, $t0
	bgeu	$a7, $s2, .LBB3_17
.LBB3_10:                               # %scalar.ph124.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s0, $s8, $s5, 1
	alsl.d	$s4, $s8, $s4, 1
	.p2align	4, , 16
.LBB3_11:                               # %scalar.ph124
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t5, $s4, 0
	ld.hu	$fp, $s7, 0
	...
	b	.LBB3_4
	.p2align	4, , 16
.LBB3_12:                               # %vector.memcheck140
                                        #   in Loop: Header=BB3_5 Depth=1
	sub.d	$s7, $s5, $s4
	move	$s0, $zero
	bltu	$s7, $s3, .LBB3_7
# %bb.13:                               # %vector.memcheck140
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$s7, $t6, $s6
	sub.d	$s7, $s5, $s7
	bltu	$s7, $s3, .LBB3_7
# %bb.14:                               # %vector.body149.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s7, $a7, $s6, 1
	move	$s8, $s4
	move	$s0, $s5
...
.LBB3_15:                               # %vector.body149
	...
	addi.d	$s8, $s8, 8
	bnez	$ra, .LBB3_15
# %bb.16:                               # %middle.block154
                                        #   in Loop: Header=BB3_5 Depth=1
	move	$s0, $t7
	bne	$t7, $t0, .LBB3_7
	b	.LBB3_9
	.p2align	4, , 16
.LBB3_17:                               # %vector.memcheck111
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$s0, $s5, $t2
	add.d	$ra, $s5, $t3
	add.d	$t5, $s4, $t2
...
.LBB3_38:                               # %scalar.ph98
	...
	b	.LBB3_34
	.p2align	4, , 16
.LBB3_39:                               # %vector.memcheck95
                                        #   in Loop: Header=BB3_35 Depth=1
	sub.d	$t8, $t5, $t4
	move	$t7, $zero
	bltu	$t8, $t3, .LBB3_37
# %bb.40:                               # %vector.memcheck95
                                        #   in Loop: Header=BB3_35 Depth=1
	add.d	$t8, $t0, $t6
	sub.d	$t8, $t5, $t8
	bltu	$t8, $t3, .LBB3_37
# %bb.41:                               # %vector.body103.preheader
                                        #   in Loop: Header=BB3_35 Depth=1
	alsl.d	$t7, $a7, $t6, 1
	move	$t8, $t4
	move	$fp, $t5
