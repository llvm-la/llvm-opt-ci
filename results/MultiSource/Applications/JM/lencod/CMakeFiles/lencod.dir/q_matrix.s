...
# %bb.14:                               # %.preheader51.9
	...
	ori	$a1, $zero, 255
	bltu	$a1, $a0, .LBB2_21
# %bb.15:                               # %.preheader51.10
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.hu	$a0, $s3, 20
	ori	$a1, $zero, 255
	bltu	$a1, $a0, .LBB2_21
# %bb.16:                               # %.preheader51.11
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.hu	$a0, $s3, 22
	ori	$a1, $zero, 255
	bltu	$a1, $a0, .LBB2_21
# %bb.17:                               # %.preheader51.12
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.hu	$a0, $s3, 24
	ori	$a1, $zero, 255
	bltu	$a1, $a0, .LBB2_21
# %bb.18:                               # %.preheader51.13
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.hu	$a0, $s3, 26
	ori	$a1, $zero, 255
	bltu	$a1, $a0, .LBB2_21
# %bb.19:                               # %.preheader51.14
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.hu	$a0, $s3, 28
	ori	$a1, $zero, 255
	bltu	$a1, $a0, .LBB2_21
# %bb.20:                               # %.preheader51.15
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.hu	$a0, $s3, 30
	bltu	$a0, $s0, .LBB2_24
	.p2align	4, , 16
