...
.LBB13_55:                              # %_ZN3vecI3LitE6growToEi.exit.i144
	...
	bgtz	$s3, .LBB13_98
	b	.LBB13_129
.LBB13_56:                              # %vector.main.loop.iter.check318
	ori	$a4, $zero, 17
	addi.d	$a3, $s3, -1
	bgeu	$s3, $a4, .LBB13_58
# %bb.57:
...
# %bb.60:                               # %middle.block328
	...
	beq	$a3, $a4, .LBB13_67
# %bb.61:                               # %vec.epilog.iter.check332
	beqz	$a5, .LBB13_141
.LBB13_62:                              # %vec.epilog.ph334
	move	$a6, $a3
	...
	sub.d	$a4, $a4, $a6
	.p2align	4, , 16
.LBB13_63:                              # %vec.epilog.vector.body337
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vsrai.w	$vr1, $vr1, 1
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB13_63
# %bb.64:                               # %vec.epilog.middle.block343
	vbsrl.v	$vr1, $vr0, 8
	vor.v	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vor.v	$vr0, $vr1, $vr0
	vpickve2gr.w	$s2, $vr0, 0
	beq	$a3, $a6, .LBB13_67
.LBB13_65:                              # %vec.epilog.scalar.ph331.preheader
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $s3, $a5
	.p2align	4, , 16
.LBB13_66:                              # %vec.epilog.scalar.ph331
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
.LBB13_71:                              # %.preheader.i.i.i
	...
	blt	$a2, $s3, .LBB13_71
	b	.LBB13_82
.LBB13_72:                              # %._ZN3vecI3LitE5clearEb.exit_crit_edge.i
	ld.w	$a1, $fp, 512
	blt	$a1, $s3, .LBB13_69
...
.LBB13_75:                              # %.loopexit.i.i.i159
	...
	st.d	$a0, $fp, 504
	ld.d	$ra, $sp, 56                    # 8-byte Folded Reload
.LBB13_76:                              # %_ZN3vecI3LitE4growEi.exit.i.i150
	bge	$a1, $s3, .LBB13_97
# %bb.77:                               # %iter.check
	sub.d	$a2, $s3, $a1
	ori	$a3, $zero, 4
...
# %bb.85:
	move	$a4, $a1
	b	.LBB13_116
.LBB13_86:                              # %vector.main.loop.iter.check353
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB13_109
# %bb.87:
	move	$a3, $zero
	b	.LBB13_113
.LBB13_88:                              # %vector.ph299
	andi	$a4, $a2, 12
	move	$a3, $a2
...
# %bb.94:                               # %vec.epilog.middle.block
	beq	$a2, $a5, .LBB13_97
.LBB13_95:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a1, $s3, $a4
	alsl.d	$a2, $a4, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_96:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB13_96
.LBB13_97:                              # %._crit_edge.i.i151
	st.w	$s3, $fp, 512
	ld.w	$s3, $s1, 8
	ori	$s4, $zero, 1
	blez	$s3, .LBB13_129
...
.LBB13_99:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 4
	blt	$a2, $s3, .LBB13_99
# %bb.100:                              # %_ZNK3vecI3LitE6copyToERS1_.exit164
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB13_129
# %bb.101:                              # %.lr.ph193
	ld.d	$a0, $s1, 0
...
# %bb.107:                              #   in Loop: Header=BB13_106 Depth=2
	...
	ldx.w	$t0, $a5, $t0
	blez	$t0, .LBB13_105
# %bb.108:                              #   in Loop: Header=BB13_103 Depth=1
	slli.d	$a5, $s4, 2
	stx.w	$a4, $a0, $a5
	ld.w	$s3, $s1, 8
	addi.w	$s4, $s4, 1
	b	.LBB13_102
.LBB13_109:                             # %vector.ph354
	andi	$a4, $a2, 12
	move	$a3, $a2
	bstrins.d	$a3, $zero, 3, 0
	alsl.d	$a5, $a1, $a0, 2
...
.LBB13_110:                             # %vector.body357
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB13_110
# %bb.111:                              # %middle.block360
	beq	$a2, $a3, .LBB13_118
# %bb.112:                              # %vec.epilog.iter.check364
	beqz	$a4, .LBB13_143
.LBB13_113:                             # %vec.epilog.ph366
	move	$a5, $a2
	bstrins.d	$a5, $zero, 1, 0
	add.d	$a4, $a5, $a1
	slli.d	$a6, $a3, 2
	...
	vrepli.w	$vr0, -2
	.p2align	4, , 16
.LBB13_114:                             # %vec.epilog.vector.body369
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a1, 0
	addi.d	$a3, $a3, 4
	addi.d	$a1, $a1, 16
	bnez	$a3, .LBB13_114
# %bb.115:                              # %vec.epilog.middle.block373
	beq	$a2, $a5, .LBB13_118
.LBB13_116:                             # %vec.epilog.scalar.ph363.preheader
	sub.d	$a1, $s3, $a4
	alsl.d	$a2, $a4, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_117:                             # %vec.epilog.scalar.ph363
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB13_117
.LBB13_118:                             # %._crit_edge.i.i
	st.w	$s3, $fp, 512
	ld.w	$s3, $s1, 8
	ori	$s4, $zero, 1
	blez	$s3, .LBB13_129
.LBB13_119:                             # %.lr.ph.i134
	ld.d	$a1, $s1, 0
	move	$a2, $zero
	.p2align	4, , 16
...
# %bb.122:                              # %.lr.ph202.preheader
	...
	b	.LBB13_126
	.p2align	4, , 16
.LBB13_123:                             # %._crit_edge242
                                        #   in Loop: Header=BB13_126 Depth=1
	ld.d	$a0, $s1, 0
	ldx.w	$a1, $a0, $s5
	ld.d	$ra, $sp, 56                    # 8-byte Folded Reload
.LBB13_124:                             #   in Loop: Header=BB13_126 Depth=1
	slli.d	$a2, $s4, 2
	addi.w	$s4, $s4, 1
	stx.w	$a1, $a0, $a2
.LBB13_125:                             #   in Loop: Header=BB13_126 Depth=1
	ld.w	$s3, $s1, 8
	addi.d	$s6, $s6, 1
	addi.d	$s5, $s5, 4
	addi.d	$s0, $s0, 1
...
.LBB13_126:                             # %.lr.ph202
	...
	ldx.d	$a2, $a2, $a3
	beqz	$a2, .LBB13_124
# %bb.127:                              #   in Loop: Header=BB13_126 Depth=1
