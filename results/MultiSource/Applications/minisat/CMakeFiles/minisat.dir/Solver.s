...
.LBB5_34:
	...
	move	$a0, $zero
	b	.LBB5_36
.LBB5_35:                               # %._crit_edge98.loopexit
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
.LBB5_36:                               # %._crit_edge98
	ld.d	$a2, $fp, 128
	ld.d	$a1, $fp, 384
	add.d	$a2, $a2, $a4
	st.d	$a2, $fp, 128
...
.LBB13_56:                              # %_ZN3vecI3LitE6growToEi.exit.i144
	...
	bgtz	$s3, .LBB13_99
	b	.LBB13_130
.LBB13_57:                              # %vector.main.loop.iter.check326
	ori	$a4, $zero, 17
	addi.d	$a3, $s3, -1
	bgeu	$s3, $a4, .LBB13_59
# %bb.58:
...
# %bb.61:                               # %middle.block336
	...
	beq	$a3, $a4, .LBB13_68
# %bb.62:                               # %vec.epilog.iter.check340
	beqz	$a5, .LBB13_142
.LBB13_63:                              # %vec.epilog.ph342
	move	$a6, $a3
	...
	sub.d	$a4, $a4, $a6
	.p2align	4, , 16
.LBB13_64:                              # %vec.epilog.vector.body345
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vsrai.w	$vr1, $vr1, 1
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB13_64
# %bb.65:                               # %vec.epilog.middle.block351
	vbsrl.v	$vr1, $vr0, 8
	vor.v	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vor.v	$vr0, $vr1, $vr0
	vpickve2gr.w	$s2, $vr0, 0
	beq	$a3, $a6, .LBB13_68
.LBB13_66:                              # %vec.epilog.scalar.ph339.preheader
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $s3, $a5
	.p2align	4, , 16
.LBB13_67:                              # %vec.epilog.scalar.ph339
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
.LBB13_72:                              # %.preheader.i.i.i
	...
	blt	$a2, $s3, .LBB13_72
	b	.LBB13_83
.LBB13_73:                              # %._ZN3vecI3LitE5clearEb.exit_crit_edge.i
	ld.w	$a1, $fp, 512
	blt	$a1, $s3, .LBB13_70
.LBB13_74:                              # %_ZN3vecI3LitE6growToEi.exit.i
	ori	$s4, $zero, 1
	bgtz	$s3, .LBB13_120
	b	.LBB13_130
.LBB13_75:
...
.LBB13_76:                              # %.loopexit.i.i.i159
	...
	st.d	$a0, $fp, 504
	ld.d	$ra, $sp, 48                    # 8-byte Folded Reload
.LBB13_77:                              # %_ZN3vecI3LitE4growEi.exit.i.i150
	bge	$a1, $s3, .LBB13_98
# %bb.78:                               # %iter.check
	sub.d	$a2, $s3, $a1
	ori	$a3, $zero, 4
...
# %bb.86:
	move	$a4, $a1
	b	.LBB13_117
.LBB13_87:                              # %vector.main.loop.iter.check361
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB13_110
# %bb.88:
	move	$a3, $zero
	b	.LBB13_114
.LBB13_89:                              # %vector.ph307
	andi	$a4, $a2, 12
	move	$a3, $a2
...
.LBB13_111:                             # %vector.body365
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB13_111
# %bb.112:                              # %middle.block368
	beq	$a2, $a3, .LBB13_119
# %bb.113:                              # %vec.epilog.iter.check372
	beqz	$a4, .LBB13_144
.LBB13_114:                             # %vec.epilog.ph374
	move	$a5, $a2
	bstrins.d	$a5, $zero, 1, 0
	add.d	$a4, $a5, $a1
	slli.d	$a6, $a3, 2
	...
	vrepli.w	$vr0, -2
	.p2align	4, , 16
.LBB13_115:                             # %vec.epilog.vector.body377
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a1, 0
	addi.d	$a3, $a3, 4
	addi.d	$a1, $a1, 16
	bnez	$a3, .LBB13_115
# %bb.116:                              # %vec.epilog.middle.block381
	beq	$a2, $a5, .LBB13_119
.LBB13_117:                             # %vec.epilog.scalar.ph371.preheader
	sub.d	$a1, $s3, $a4
	alsl.d	$a2, $a4, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_118:                             # %vec.epilog.scalar.ph371
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
