...
# %bb.58:                               # %middle.block317
	...
	beq	$a4, $a5, .LBB13_61
.LBB13_59:                              # %scalar.ph306.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a3, $s3, $a3
	.p2align	4, , 16
.LBB13_60:                              # %scalar.ph306
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
.LBB13_65:                              # %.preheader.i.i.i
	...
	blt	$a2, $s3, .LBB13_65
	b	.LBB13_91
.LBB13_66:                              # %._ZN3vecI3LitE5clearEb.exit_crit_edge.i
	ld.w	$a1, $fp, 512
	blt	$a1, $s3, .LBB13_63
.LBB13_67:                              # %_ZN3vecI3LitE6growToEi.exit.i
	ori	$s4, $zero, 1
	bgtz	$s3, .LBB13_101
	b	.LBB13_111
.LBB13_68:
...
.LBB13_69:                              # %.loopexit.i.i.i159
	...
	st.d	$a0, $fp, 504
	ld.d	$t8, $sp, 40                    # 8-byte Folded Reload
.LBB13_70:                              # %_ZN3vecI3LitE4growEi.exit.i.i150
	bge	$a1, $s3, .LBB13_78
# %bb.71:                               # %.lr.ph.i.i153
	sub.d	$a3, $s3, $a1
	ori	$a2, $zero, 8
...
.LBB13_74:                              # %vector.body300
	...
	addi.d	$a1, $a1, 32
	bnez	$a5, .LBB13_74
# %bb.75:                               # %middle.block303
	beq	$a3, $a4, .LBB13_78
.LBB13_76:                              # %scalar.ph295.preheader
	sub.d	$a1, $s3, $a2
	alsl.d	$a2, $a2, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_77:                              # %scalar.ph295
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB13_77
.LBB13_78:                              # %._crit_edge.i.i151
	st.w	$s3, $fp, 512
	ld.w	$s3, $s1, 8
	ori	$s4, $zero, 1
	blez	$s3, .LBB13_111
...
.LBB13_80:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 4
	blt	$a2, $s3, .LBB13_80
# %bb.81:                               # %_ZNK3vecI3LitE6copyToERS1_.exit164
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB13_111
# %bb.82:                               # %.lr.ph193
	ld.d	$a0, $s1, 0
...
.LBB13_96:                              # %vector.body325
	...
	addi.d	$a1, $a1, 32
	bnez	$a5, .LBB13_96
# %bb.97:                               # %middle.block328
	beq	$a3, $a4, .LBB13_100
.LBB13_98:                              # %scalar.ph320.preheader
	sub.d	$a1, $s3, $a2
	alsl.d	$a2, $a2, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_99:                              # %scalar.ph320
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB13_99
.LBB13_100:                             # %._crit_edge.i.i
	st.w	$s3, $fp, 512
	ld.w	$s3, $s1, 8
	ori	$s4, $zero, 1
	blez	$s3, .LBB13_111
.LBB13_101:                             # %.lr.ph.i134
	ld.d	$a1, $s1, 0
	move	$a2, $zero
	.p2align	4, , 16
.LBB13_102:                             # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 4
	blt	$a2, $s3, .LBB13_102
# %bb.103:                              # %_ZNK3vecI3LitE6copyToERS1_.exit
	ori	$a0, $zero, 2
	ori	$s0, $zero, 1
	blt	$s3, $a0, .LBB13_112
# %bb.104:                              # %.lr.ph202.preheader
	ori	$s0, $zero, 1
	ori	$s5, $zero, 4
	ori	$s6, $zero, 1
	ori	$s4, $zero, 1
	b	.LBB13_108
	.p2align	4, , 16
.LBB13_105:                             # %._crit_edge242
                                        #   in Loop: Header=BB13_108 Depth=1
	ld.d	$a0, $s1, 0
	ldx.w	$a1, $a0, $s5
	ld.d	$t8, $sp, 40                    # 8-byte Folded Reload
.LBB13_106:                             #   in Loop: Header=BB13_108 Depth=1
	slli.d	$a2, $s4, 2
	addi.w	$s4, $s4, 1
	stx.w	$a1, $a0, $a2
...
.LBB13_108:                             # %.lr.ph202
	...
	ldx.d	$a2, $a2, $a3
	beqz	$a2, .LBB13_106
# %bb.109:                              #   in Loop: Header=BB13_108 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB13_105
# %bb.110:                              #   in Loop: Header=BB13_108 Depth=1
	ld.d	$t8, $sp, 40                    # 8-byte Folded Reload
	b	.LBB13_107
.LBB13_111:
	ori	$s0, $zero, 1
...
# %bb.113:                              # %.lr.ph.i165
	sub.w	$s3, $s3, $a0
	st.w	$s3, $s1, 8
.LBB13_114:                             # %_ZN3vecI3LitE6shrinkEi.exit
	ld.d	$a0, $fp, 168
	add.d	$a0, $a0, $s3
	ori	$a2, $zero, 1
	st.d	$a0, $fp, 168
