...
# %bb.3:
	ld.w	$a0, $s2, 940
	bge	$s1, $a0, .LBB14_22
# %bb.4:                                # %flag_SetFlagToDefault.exit19
	st.w	$s1, $fp, 156
	ld.w	$s1, $s0, 36
	ld.w	$a0, $s2, 216
	bge	$a0, $s1, .LBB14_23
...
# %bb.11:
	ld.w	$a0, $s2, 1252
	blez	$a0, .LBB14_30
# %bb.12:                               # %flag_SetFlagValue.exit27
	st.w	$zero, $fp, 208
	ld.w	$s1, $s0, 180
	ld.w	$a0, $s2, 1080
	bge	$a0, $s1, .LBB14_31
# %bb.13:
	ld.w	$a0, $s2, 1084
	bge	$s1, $a0, .LBB14_32
# %bb.14:                               # %flag_TransferFlag.exit30
	st.w	$s1, $fp, 180
	ld.w	$s1, $s0, 184
	ld.w	$a0, $s2, 1104
	bge	$a0, $s1, .LBB14_33
# %bb.15:
	ld.w	$a0, $s2, 1108
	bge	$s1, $a0, .LBB14_35
# %bb.16:                               # %flag_TransferFlag.exit33
	st.w	$s1, $fp, 184
	ld.w	$s0, $s0, 152
	ld.w	$a0, $s2, 912
	bge	$a0, $s0, .LBB14_37
# %bb.17:
	ld.w	$a0, $s2, 916
	bge	$s0, $a0, .LBB14_38
# %bb.18:                               # %flag_TransferFlag.exit36
	st.w	$s0, $fp, 152
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
...
# %bb.3:
	ld.w	$a1, $s2, 1084
	bge	$s1, $a1, .LBB15_30
# %bb.4:                                # %flag_SetFlagToDefault.exit27
	st.w	$s1, $fp, 180
	ld.w	$s1, $a0, 184
	ld.w	$a0, $s2, 1104
	bge	$a0, $s1, .LBB15_31
# %bb.5:
	ld.w	$a0, $s2, 1108
	bge	$s1, $a0, .LBB15_32
# %bb.6:                                # %flag_SetFlagToDefault.exit30
	st.w	$s1, $fp, 184
	ld.w	$s1, $s0, 224
	ld.w	$a0, $s2, 1344
	bge	$a0, $s1, .LBB15_33
...
# %bb.9:
	ld.w	$a0, $s2, 1276
	bge	$s1, $a0, .LBB15_36
# %bb.10:                               # %flag_TransferFlag.exit35
	st.w	$s1, $fp, 212
	ld.w	$s1, $s0, 216
	ld.w	$a0, $s2, 1296
	bge	$a0, $s1, .LBB15_37
# %bb.11:
	ld.w	$a0, $s2, 1300
	bge	$s1, $a0, .LBB15_38
# %bb.12:                               # %flag_TransferFlag.exit38
	st.w	$s1, $fp, 216
	ld.w	$s1, $s0, 148
	ld.w	$a0, $s2, 888
	bge	$a0, $s1, .LBB15_39
# %bb.13:
	ld.w	$a0, $s2, 892
	bge	$s1, $a0, .LBB15_40
# %bb.14:                               # %flag_TransferFlag.exit41
	st.w	$s1, $fp, 148
	ld.w	$s1, $s0, 140
	ld.w	$a0, $s2, 840
	bge	$a0, $s1, .LBB15_41
# %bb.15:
	ld.w	$a0, $s2, 844
	bge	$s1, $a0, .LBB15_42
# %bb.16:                               # %flag_TransferFlag.exit44
	st.w	$s1, $fp, 140
	ld.w	$s1, $s0, 144
	ld.w	$a0, $s2, 864
	bge	$a0, $s1, .LBB15_43
# %bb.17:
	ld.w	$a0, $s2, 868
	bge	$s1, $a0, .LBB15_44
# %bb.18:                               # %flag_TransferFlag.exit47
	st.w	$s1, $fp, 144
	ld.w	$s1, $s0, 228
	ld.w	$a0, $s2, 1368
	bge	$a0, $s1, .LBB15_45
# %bb.19:
	ld.w	$a0, $s2, 1372
	bge	$s1, $a0, .LBB15_46
# %bb.20:                               # %flag_TransferFlag.exit50
	st.w	$s1, $fp, 228
	ld.w	$s1, $s0, 132
	ld.w	$a0, $s2, 792
	bge	$a0, $s1, .LBB15_47
# %bb.21:
	ld.w	$a0, $s2, 796
	bge	$s1, $a0, .LBB15_48
# %bb.22:                               # %flag_TransferFlag.exit53
	st.w	$s1, $fp, 132
	ld.w	$s1, $s0, 136
	ld.w	$a0, $s2, 816
	bge	$a0, $s1, .LBB15_49
# %bb.23:
	ld.w	$a0, $s2, 820
	bge	$s1, $a0, .LBB15_51
# %bb.24:                               # %flag_TransferFlag.exit56
	st.w	$s1, $fp, 136
	ld.w	$s0, $s0, 8
	ld.w	$a0, $s2, 48
	bge	$a0, $s0, .LBB15_53
# %bb.25:
	ld.w	$a0, $s2, 52
	bge	$s0, $a0, .LBB15_54
# %bb.26:                               # %flag_TransferFlag.exit59
	st.w	$s0, $fp, 8
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
...
# %bb.0:
	...
	b	.LBB16_2
	.p2align	4, , 16
.LBB16_1:                               # %flag_CheckFlagValueInRange.exit
