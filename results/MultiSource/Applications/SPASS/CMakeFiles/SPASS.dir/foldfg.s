...
.Lfunc_end5:
	.size	fol_GetNonFOLPredicates, .Lfunc_end5-fol_GetNonFOLPredicates
                                        # -- End function
	.p2align	2                               # -- Begin function fol_IsPredefinedPred
...
.Lfunc_end8:
	.size	fol_NormalizeVars, .Lfunc_end8-fol_NormalizeVars
                                        # -- End function
	.p2align	2                               # -- Begin function fol_NormalizeVarsIntern
...
# %bb.4:                                # %.preheader.i66
	...
	addi.w	$a2, $zero, -2
	b	.LBB13_8
.LBB13_5:                               # %vector.body123.preheader
	pcalau12i	$a2, %got_pc_hi20(term_BIND)
	ld.d	$a2, $a2, %got_pc_lo12(term_BIND)
	addi.d	$a3, $a2, 16
	ori	$a4, $zero, 3000
	.p2align	4, , 16
.LBB13_6:                               # %vector.body123
                                        # =>This Inner Loop Header: Depth=1
	st.d	$zero, $a3, -16
	st.d	$zero, $a3, 0
	addi.d	$a4, $a4, -2
...
.Lfunc_end19:
	.size	fol_FPrintOtter, .Lfunc_end19-fol_FPrintOtter
                                        # -- End function
	.p2align	2                               # -- Begin function fol_FPrintOtterFormula
...
.Lfunc_end22:
	.size	fol_FPrintDFG, .Lfunc_end22-fol_FPrintDFG
                                        # -- End function
	.p2align	2                               # -- Begin function fol_TermListFPrintDFG
...
.Lfunc_end27:
	.size	fol_FPrintDFGProblem, .Lfunc_end27-fol_FPrintDFGProblem
                                        # -- End function
	.p2align	2                               # -- Begin function fol_FPrintFormulaList
...
# %bb.6:
	...
	b	.LBB31_12
	.p2align	4, , 16
.LBB31_7:                               # %symbol_IsPredicate.exit.thread.i
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	...
	vld	$vr0, $sp, 32                   # 16-byte Folded Reload
	beq	$a2, $a1, .LBB31_10
# %bb.8:                                # %symbol_IsPredicate.exit.thread.i
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
...
.Lfunc_end35:
	.size	fol_PrettyPrintDFG, .Lfunc_end35-fol_PrettyPrintDFG
                                        # -- End function
	.p2align	2                               # -- Begin function fol_PrettyPrintInternDFG
...
.Lfunc_end39:
	.size	fol_PrettyPrint, .Lfunc_end39-fol_PrettyPrint
                                        # -- End function
	.p2align	2                               # -- Begin function fol_PrettyPrintIntern
...
.Lfunc_end50:
	.size	fol_PropagateWitness, .Lfunc_end50-fol_PropagateWitness
                                        # -- End function
	.p2align	2                               # -- Begin function fol_PropagateWitnessIntern
...
.Lfunc_end53:
	.size	fol_AlphaEqual, .Lfunc_end53-fol_AlphaEqual
                                        # -- End function
	.p2align	2                               # -- Begin function fol_AlphaEqualIntern
...
.Lfunc_end55:
	.size	fol_VarBoundTwice, .Lfunc_end55-fol_VarBoundTwice
                                        # -- End function
	.p2align	2                               # -- Begin function fol_VarBoundTwiceIntern
...
.Lfunc_end58:
	.size	fol_ApplyContextToTerm, .Lfunc_end58-fol_ApplyContextToTerm
                                        # -- End function
	.p2align	2                               # -- Begin function fol_CheckApplyContextToTerm
...
.Lfunc_end59:
	.size	fol_CheckApplyContextToTerm, .Lfunc_end59-fol_CheckApplyContextToTerm
                                        # -- End function
	.p2align	2                               # -- Begin function fol_ApplyContextToTermIntern
...
# %bb.20:                               #   in Loop: Header=BB62_18 Depth=1
	...
	slli.d	$a0, $a0, 3
	stx.d	$a1, $a4, $a0
.LBB62_21:                              #   in Loop: Header=BB62_18 Depth=1
	ld.w	$a1, $s4, 0
	ori	$a0, $zero, 1
	beq	$a1, $s5, .LBB62_32
	.p2align	4, , 16
...
.LBB62_24:                              # %.critedge
	...
	b	.LBB62_1
	.p2align	4, , 16
.LBB62_25:                              #   in Loop: Header=BB62_18 Depth=1
	blez	$s8, .LBB62_21
...
# %bb.28:                               #   in Loop: Header=BB62_18 Depth=1
	blez	$s7, .LBB62_31
.LBB62_29:                              #   in Loop: Header=BB62_18 Depth=1
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	st.d	$a1, $a0, 0
	st.d	$s7, $a0, 8
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
...
.L.str.27:
	.asciz	"/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
	.size	.L.str.27, 123
