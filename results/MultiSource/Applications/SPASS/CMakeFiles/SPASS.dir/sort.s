...
.Lfunc_end31:
	.size	sort_TheoryComputeAllSubsortHits, .Lfunc_end31-sort_TheoryComputeAllSubsortHits
                                        # -- End function
	.p2align	2                               # -- Begin function sort_PairDelete
...
.Lfunc_end34:
	.size	sort_ApproxMaxDeclClauses, .Lfunc_end34-sort_ApproxMaxDeclClauses
                                        # -- End function
	.p2align	2                               # -- Begin function sort_ApproxPseudoLinear
...
# %bb.26:                               #   in Loop: Header=BB39_25 Depth=4
	bne	$a0, $a2, .LBB39_25
.LBB39_27:                              # %..critedge_crit_edge.us.i
...
# %bb.56:                               # %._crit_edge
                                        #   in Loop: Header=BB39_18 Depth=1
	bnez	$s7, .LBB39_18
.LBB39_57:                              # %._crit_edge193.loopexit
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	sltui	$a0, $a0, 1
	addi.d	$a1, $s7, 1
	ori	$a2, $zero, 3
