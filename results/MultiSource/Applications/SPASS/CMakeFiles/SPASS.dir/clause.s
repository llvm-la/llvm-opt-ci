...
.LBB11_9:                               # %._crit_edge27
	...
	xvld	$xr2, $a5, %pc_lo12(.LCPI11_1)
	pcalau12i	$a5, %pc_hi20(.LCPI11_2)
	xvld	$xr3, $a5, %pc_lo12(.LCPI11_2)
	pcalau12i	$a5, %pc_hi20(.LCPI11_3)
	xvld	$xr4, $a5, %pc_lo12(.LCPI11_3)
	xvand.v	$xr1, $xr0, $xr1
	xvand.v	$xr2, $xr0, $xr2
	xvand.v	$xr3, $xr0, $xr3
	xvand.v	$xr4, $xr0, $xr4
	pcalau12i	$a5, %pc_hi20(.LCPI11_4)
	xvld	$xr5, $a5, %pc_lo12(.LCPI11_4)
...
.LBB11_11:                              # %vector.body.interim
	...
	xvld	$xr2, $a6, %pc_lo12(.LCPI11_9)
	pcalau12i	$a6, %pc_hi20(.LCPI11_10)
	xvld	$xr3, $a6, %pc_lo12(.LCPI11_10)
	pcalau12i	$a6, %pc_hi20(.LCPI11_11)
	xvld	$xr4, $a6, %pc_lo12(.LCPI11_11)
	pcalau12i	$a6, %pc_hi20(.LCPI11_12)
	xvld	$xr5, $a6, %pc_lo12(.LCPI11_12)
	xvand.v	$xr2, $xr0, $xr2
	xvand.v	$xr3, $xr0, $xr3
	xvand.v	$xr4, $xr0, $xr4
	xvand.v	$xr5, $xr0, $xr5
...
.LBB11_12:                              # %vector.early.exit
	pcalau12i	$a4, %pc_hi20(.LCPI11_17)
	xvld	$xr0, $a4, %pc_lo12(.LCPI11_17)
	xvslli.b	$xr1, $xr2, 7
	xvsrai.b	$xr1, $xr1, 7
	xvand.v	$xr0, $xr1, $xr0
	xvpermi.q	$xr1, $xr0, 1
...
.LBB22_4:                               # %clause_LiteralIsEquality.exit.thread
	...
	ld.w	$a2, $a2, 0
	bne	$a1, $a2, .LBB22_6
# %bb.5:                                # %clause_LiteralAtom.exit23
	addi.d	$sp, $sp, -16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	ld.d	$a0, $a0, 16
	ld.d	$a1, $a0, 0
...
# %bb.1:                                # %.lr.ph.i
	...
	b	.LBB43_4
	.p2align	4, , 16
.LBB43_2:                               # %.lr.ph.clause_LiteralMaxVar.exit.i.loopexit_crit_edge
...
# %bb.13:                               # %.lr.ph
	...
	b	.LBB43_2
	.p2align	4, , 16
.LBB43_14:                              # %.lr.ph.i.i..critedge.i.i_crit_edge
                                        #   in Loop: Header=BB43_4 Depth=1
	alsl.d	$t4, $t1, $t4, 3
	st.w	$t2, $a2, 0
	move	$t0, $t2
...
.Lfunc_end49:
	.size	clause_MoveBestLiteralToFront, .Lfunc_end49-clause_MoveBestLiteralToFront
                                        # -- End function
	.p2align	2                               # -- Begin function clause_ComputeTermSize
...
# %bb.18:                               # %.lr.ph40
	...
	move	$a2, $a5
	bne	$a4, $a5, .LBB50_17
.LBB50_19:                              # %.lr.ph40.._crit_edge31.split.us_crit_edge
	st.w	$a4, $a3, 0
.LBB50_20:                              # %._crit_edge
	ret
.Lfunc_end50:
...
.Lfunc_end64:
	.size	clause_CompareAbstract, .Lfunc_end64-clause_CompareAbstract
                                        # -- End function
	.p2align	2                               # -- Begin function clause_CompareByLiterals
...
.Lfunc_end65:
	.size	clause_CompareByLiterals, .Lfunc_end65-clause_CompareByLiterals
                                        # -- End function
	.p2align	2                               # -- Begin function clause_CompareBySymbolOccurences
...
.Lfunc_end66:
	.size	clause_CompareBySymbolOccurences, .Lfunc_end66-clause_CompareBySymbolOccurences
                                        # -- End function
	.p2align	2                               # -- Begin function clause_CompareByPredicateDistribution
...
.Lfunc_end67:
	.size	clause_CompareByPredicateDistribution, .Lfunc_end67-clause_CompareByPredicateDistribution
                                        # -- End function
	.p2align	2                               # -- Begin function clause_CompareByConstantDistribution
...
.Lfunc_end68:
	.size	clause_CompareByConstantDistribution, .Lfunc_end68-clause_CompareByConstantDistribution
                                        # -- End function
	.p2align	2                               # -- Begin function clause_CompareByFunctionDistribution
...
.Lfunc_end69:
	.size	clause_CompareByFunctionDistribution, .Lfunc_end69-clause_CompareByFunctionDistribution
                                        # -- End function
	.p2align	2                               # -- Begin function clause_CompareByVariableDistribution
...
.Lfunc_end77:
	.size	clause_SetSortConstraint, .Lfunc_end77-clause_SetSortConstraint
                                        # -- End function
	.p2align	2                               # -- Begin function clause_ReInit
...
# %bb.4:                                # %.lr.ph.i.i
	...
	b	.LBB78_6
	.p2align	4, , 16
.LBB78_5:                               # %.lr.ph.i8.clause_UpdateLiteralWeight.exit.i.loopexit.i_crit_edge
...
# %bb.12:                               #   in Loop: Header=BB78_6 Depth=1
	...
	b	.LBB78_17
	.p2align	4, , 16
.LBB78_13:                              # %.lr.ph.i8.preheader
                                        #   in Loop: Header=BB78_6 Depth=1
	beq	$t3, $a2, .LBB78_5
	.p2align	4, , 16
.LBB78_14:                              # %.lr.ph.i.i.i.i
...
# %bb.15:                               # %.lr.ph.i8
	...
	b	.LBB78_5
	.p2align	4, , 16
.LBB78_16:                              # %.lr.ph.i.i.i..critedge.i.i.i_crit_edge.i
                                        #   in Loop: Header=BB78_6 Depth=1
	alsl.d	$t4, $t1, $a4, 3
	st.w	$t3, $a1, 0
	move	$t0, $t3
...
.Lfunc_end113:
	.size	clause_NumberSort, .Lfunc_end113-clause_NumberSort
                                        # -- End function
	.p2align	2                               # -- Begin function clause_NumberLower
...
.Lfunc_end138:
	.size	clause_PParentsListPrint, .Lfunc_end138-clause_PParentsListPrint
                                        # -- End function
	.p2align	2                               # -- Begin function clause_LiteralsCompare
