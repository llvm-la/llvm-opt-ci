...
# %bb.71:                               # %.lr.ph.i51.preheader
	...
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	b	.LBB0_74
.LBB0_72:                               #   in Loop: Header=BB0_74 Depth=4
	slli.d	$a4, $a4, 2
	ldx.w	$a4, $s6, $a4
...
.LBB0_76:                               # %yy_get_next_buffer.exit
	...
	st.d	$a0, $s1, %pc_lo12(dfg_text)
	ld.d	$s5, $sp, 40                    # 8-byte Folded Reload
.LBB0_77:                               # %yy_get_next_buffer.exit.thread72
                                        #   in Loop: Header=BB0_21 Depth=3
	ld.w	$a3, $s3, %pc_lo12(yy_start)
	add.d	$s7, $a2, $a4
	add.d	$a0, $a0, $a1
	...
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	bgeu	$a0, $s7, .LBB0_21
# %bb.78:                               # %.lr.ph.i66.preheader
                                        #   in Loop: Header=BB0_21 Depth=3
	move	$a2, $a0
	b	.LBB0_81
.LBB0_79:                               #   in Loop: Header=BB0_81 Depth=4
	slli.d	$a4, $a4, 2
	ldx.w	$a4, $s6, $a4
...
.LBB0_87:                               # %.thread65.i
	...
	st.w	$fp, $s0, 28
	ld.d	$s1, $sp, 48                    # 8-byte Folded Reload
.LBB0_88:                               #   in Loop: Header=BB0_18 Depth=2
	ld.d	$a2, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_90
.LBB0_89:                               # %thread-pre-split.thread88.i
                                        #   in Loop: Header=BB0_18 Depth=2
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s0, $a0, %pc_lo12(yy_current_buffer)
	ld.d	$a2, $s0, 8
...
.LBB0_96:                               #   in Loop: Header=BB0_18 Depth=2
	ld.d	$a4, $sp, 96                    # 8-byte Folded Reload
	b	.LBB0_18
.LBB0_97:                               #   in Loop: Header=BB0_18 Depth=2
	addi.d	$a3, $s7, 1
	st.d	$a3, $s4, %pc_lo12(yy_c_buf_p)
	b	.LBB0_18
...
.LBB0_135:                              # %.loopexit
	ori	$a0, $zero, 258
	b	.LBB0_171
.LBB0_136:                              # %.loopexit85.loopexit392
	ori	$a0, $zero, 261
	b	.LBB0_171
.LBB0_137:
	ori	$a0, $zero, 282
...
.LBB0_141:
	ori	$a0, $zero, 270
	b	.LBB0_171
.LBB0_142:                              # %.loopexit85.loopexit1137
	ori	$a0, $zero, 263
	b	.LBB0_171
.LBB0_143:
	ori	$a0, $zero, 297
	b	.LBB0_171
.LBB0_144:                              # %.loopexit85.loopexit204
	ori	$a0, $zero, 260
	b	.LBB0_171
.LBB0_145:
	ori	$a0, $zero, 274
...
.LBB0_148:
	ori	$a0, $zero, 267
	b	.LBB0_171
.LBB0_149:                              # %.loopexit85.loopexit652
	ori	$a0, $zero, 262
	b	.LBB0_171
.LBB0_150:
	ori	$a0, $zero, 295
...
.Lfunc_end2:
	.size	dfg__load_buffer_state, .Lfunc_end2-dfg__load_buffer_state
                                        # -- End function
	.p2align	2                               # -- Begin function dfg_StringCopy
...
# %bb.0:
	...
	beqz	$fp, .LBB6_2
# %bb.1:                                # %.dfg__init_buffer.exit_crit_edge
	ld.d	$a0, $fp, 8
	b	.LBB6_5
.LBB6_2:
	move	$s2, $a1
...
.LBB11_3:
	move	$a0, $zero
.LBB11_4:                               # %dfg__switch_to_buffer.exit
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 32
...
.LBB13_11:                              # %dfg__scan_buffer.exit
	ori	$a1, $zero, 1
	st.w	$a1, $a0, 32
	ld.d	$s1, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
