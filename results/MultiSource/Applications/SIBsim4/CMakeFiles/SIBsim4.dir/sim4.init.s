...
.LBB0_49:                               #   in Loop: Header=BB0_40 Depth=1
	addi.d	$a2, $sp, 176
.LBB0_50:                               # %seq_revcomp_inplace.exit
                                        #   in Loop: Header=BB0_40 Depth=1
	addi.d	$a0, $sp, 192
	addi.d	$a1, $sp, 232
	pcaddu18i	$ra, %call36(SIM4)
...
# %bb.57:                               # %middle.block221
	...
	beq	$a3, $a0, .LBB0_60
.LBB0_58:                               # %scalar.ph209.preheader
                                        #   in Loop: Header=BB0_40 Depth=1
	alsl.d	$a2, $a3, $a2, 3
	sub.d	$a3, $a0, $a3
	.p2align	4, , 16
.LBB0_59:                               # %scalar.ph209
                                        #   Parent Loop BB0_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a2, 0
	ld.w	$a5, $a5, 36
...
.LBB0_85:                               # %.lr.ph.i113
	...
	move	$a0, $a2
	bltu	$a2, $a3, .LBB0_85
.LBB0_86:                               # %seq_revcomp_inplace.exit116
                                        #   in Loop: Header=BB0_40 Depth=1
	ld.w	$a0, $sp, 184
	beqz	$a0, .LBB0_39
# %bb.87:                               # %.lr.ph153.preheader
                                        #   in Loop: Header=BB0_40 Depth=1
	move	$s8, $zero
	move	$s0, $zero
	.p2align	4, , 16
...
.LJTI0_0:
	...
	.p2align	2                               # -- Begin function bug_handler
...
.Lfunc_end1:
	.size	bug_handler, .Lfunc_end1-bug_handler
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function init_seq
...
.Lfunc_end2:
	.size	init_seq, .Lfunc_end2-init_seq
                                        # -- End function
	.p2align	2                               # -- Begin function get_next_seq
...
# %bb.28:                               # %.loopexit.loopexit
	ld.d	$s1, $fp, 8
	b	.LBB3_30
.LBB3_29:                               # %.critedge2..loopexit_crit_edge
	pcaddu18i	$ra, %call36(__ctype_b_loc)
	jirl	$ra, $ra, 0
.LBB3_30:                               # %.loopexit
...
.Lfunc_end3:
	.size	get_next_seq, .Lfunc_end3-get_next_seq
                                        # -- End function
	.p2align	2                               # -- Begin function print_res
...
.LBB4_29:                               # %scalar.ph
	...
	bnez	$a4, .LBB4_29
	b	.LBB4_31
.LBB4_30:                               # %.critedge2.._crit_edge_crit_edge.i
	ld.w	$t1, $s3, 8
	ld.d	$t0, $s1, 16
	move	$t2, $zero
.LBB4_31:                               # %._crit_edge.i
	ld.w	$a4, $s4, 68
	ld.d	$a6, $s0, 16
	add.d	$a4, $t1, $a4
	addi.w	$a4, $a4, 1
...
# %bb.73:                               # %middle.block
	...
	bne	$a6, $a4, .LBB4_28
	b	.LBB4_31
.LBB4_74:                               # %vector.scevcheck49
	addi.w	$t3, $a4, -2
	addi.d	$t2, $a6, -1
	addi.w	$t4, $t2, 0
	move	$t1, $zero
	bltu	$t3, $t4, .LBB4_80
# %bb.75:                               # %vector.scevcheck49
	srli.d	$t4, $t2, 32
	move	$t2, $t1
	bnez	$t4, .LBB4_55
# %bb.76:                               # %vector.ph52
...
.LJTI4_0:
	...
	.word	.LBB4_7-.LJTI4_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function print_align_lat
...
.Lfunc_end5:
	.size	print_align_lat, .Lfunc_end5-print_align_lat
                                        # -- End function
	.p2align	2                               # -- Begin function read_line_buf
...
.Lfunc_end6:
	.size	read_line_buf, .Lfunc_end6-read_line_buf
                                        # -- End function
	.p2align	2                               # -- Begin function shuffle_line
