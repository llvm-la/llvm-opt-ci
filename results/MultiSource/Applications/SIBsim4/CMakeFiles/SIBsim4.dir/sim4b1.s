...
# %bb.381:                              #   in Loop: Header=BB0_379 Depth=4
	...
	and	$a4, $a5, $a4
	beqz	$a4, .LBB0_378
.LBB0_382:                              # %._crit_edge1580
                                        #   in Loop: Header=BB0_321 Depth=3
	move	$s8, $s2
	st.d	$s3, $sp, 272                   # 8-byte Folded Spill
	b	.LBB0_320
	.p2align	4, , 16
.LBB0_383:                              # %.loopexit597
                                        #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a1, $s6, 8
	ld.d	$a0, $sp, 280                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 16
...
.LBB0_413:                              # %.thread563.thread
	...
	sub.w	$a2, $a0, $fp
	st.w	$a2, $s4, 16
.LBB0_414:                              # %thread-pre-split566
                                        #   in Loop: Header=BB0_6 Depth=1
	addi.w	$a0, $a2, -1
	bltz	$a0, .LBB0_422
# %bb.415:                              # %.lr.ph675.preheader
                                        #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a1, $ra, 0
	slli.d	$a0, $a0, 3
	ldx.d	$a0, $a1, $a0
...
# %bb.428:                              #   in Loop: Header=BB0_427 Depth=2
	...
	sltui	$t3, $t3, 1
	bltu	$a6, $s8, .LBB0_435
# %bb.429:                              # %.lr.ph.i.i532.preheader
                                        #   in Loop: Header=BB0_427 Depth=2
	move	$t7, $zero
	move	$t5, $zero
	sub.d	$t4, $s1, $t0
	.p2align	4, , 16
.LBB0_430:                              # %.lr.ph.i.i532
                                        #   Parent Loop BB0_6 Depth=1
...
# %bb.561:                              # %.lr.ph246.i
                                        #   in Loop: Header=BB0_559 Depth=3
	bne	$a7, $s1, .LBB0_558
# %bb.562:                              # %.preheader.i509
                                        #   in Loop: Header=BB0_559 Depth=3
	ld.w	$a7, $a0, 8
	blez	$a7, .LBB0_558
# %bb.563:                              # %.lr.ph.i515.preheader
                                        #   in Loop: Header=BB0_559 Depth=3
	ori	$t0, $zero, 8
	bgeu	$a7, $t0, .LBB0_566
...
# %bb.568:                              # %middle.block
	...
	beq	$t2, $a7, .LBB0_571
.LBB0_569:                              # %.lr.ph.i515.preheader1163
                                        #   in Loop: Header=BB0_559 Depth=3
	sub.d	$t2, $a7, $t2
	.p2align	4, , 16
.LBB0_570:                              # %.lr.ph.i515
...
.LBB0_589:                              # %.critedge8.i
	...
	move	$s4, $s0
	b	.LBB0_208
.LBB0_590:                              # %._crit_edge680.loopexit
	ld.d	$fp, $sp, 472
	b	.LBB0_592
.LBB0_591:
	move	$fp, $zero
.LBB0_592:                              # %._crit_edge680
	ld.d	$a0, $sp, 488
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $fp
