...
# %bb.54:                               # %iter.check679
	...
	move	$a2, $s6
	bltu	$s0, $a1, .LBB0_82
# %bb.55:                               # %vector.main.loop.iter.check668
...
.LBB0_76:                               # %vector.body673
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_76
# %bb.77:                               # %middle.block676
	beq	$a1, $t0, .LBB0_84
# %bb.78:                               # %vec.epilog.iter.check681
	beqz	$a4, .LBB0_82
.LBB0_79:                               # %vec.epilog.ph683
	...
	sub.d	$a6, $t0, $a4
	.p2align	4, , 16
.LBB0_80:                               # %vec.epilog.vector.body688
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a6, $a6, 4
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB0_80
# %bb.81:                               # %vec.epilog.middle.block691
	beq	$a1, $a4, .LBB0_84
.LBB0_82:                               # %vec.epilog.scalar.ph680.preheader
	slli.d	$a1, $a2, 2
	...
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
.LBB0_83:                               # %vec.epilog.scalar.ph680
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	addi.w	$a2, $a2, -1
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB0_83
.LBB0_84:                               # %._crit_edge504
...
# %bb.124:                              # %.lr.ph649
	...
	addi.d	$a0, $a0, -1
	.p2align	4, , 16
.LBB0_125:                              #   Parent Loop BB0_109 Depth=1
...
.LBB0_128:                              #   in Loop: Header=BB0_112 Depth=2
	...
	add.w	$s8, $fp, $s0
	bge	$t1, $s8, .LBB0_122
.LBB0_129:                              #   in Loop: Header=BB0_112 Depth=2
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	pcalau12i	$a1, %pc_hi20(.L.str.9)
	...
	b	.LBB0_111
	.p2align	4, , 16
.LBB0_130:                              # %iter.check719
                                        #   in Loop: Header=BB0_109 Depth=1
	ld.d	$a6, $sp, 144                   # 8-byte Folded Reload
	ori	$a0, $zero, 4
	ld.d	$s0, $sp, 248                   # 8-byte Folded Reload
	bltu	$s0, $a0, .LBB0_135
# %bb.131:                              # %iter.check719
                                        #   in Loop: Header=BB0_109 Depth=1
	...
	bltu	$a0, $a1, .LBB0_134
# %bb.132:                              # %vector.main.loop.iter.check706
                                        #   in Loop: Header=BB0_109 Depth=1
...
.LBB0_134:                              #   in Loop: Header=BB0_109 Depth=1
	...
	ld.d	$fp, $sp, 264                   # 8-byte Folded Reload
	b	.LBB0_143
.LBB0_135:                              #   in Loop: Header=BB0_109 Depth=1
...
.LBB0_137:                              # %vector.body711
	...
	addi.d	$s1, $s1, 64
	bnez	$s7, .LBB0_137
# %bb.138:                              # %middle.block716
                                        #   in Loop: Header=BB0_109 Depth=1
	ld.d	$s1, $sp, 176                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 160                   # 8-byte Folded Reload
	ld.d	$s6, $sp, 152                   # 8-byte Folded Reload
	beq	$s0, $a1, .LBB0_108
# %bb.139:                              # %vec.epilog.iter.check721
                                        #   in Loop: Header=BB0_109 Depth=1
	beqz	$a2, .LBB0_143
.LBB0_140:                              # %vec.epilog.ph723
                                        #   in Loop: Header=BB0_109 Depth=1
	move	$a2, $s0
	...
	alsl.d	$a4, $a4, $t5, 2
	.p2align	4, , 16
.LBB0_141:                              # %vec.epilog.vector.body726
                                        #   Parent Loop BB0_109 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a1, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB0_141
# %bb.142:                              # %vec.epilog.middle.block730
                                        #   in Loop: Header=BB0_109 Depth=1
	beq	$s0, $a2, .LBB0_108
.LBB0_143:                              # %.lr.ph511.preheader
                                        #   in Loop: Header=BB0_109 Depth=1
	addi.d	$a1, $a0, -1
	alsl.d	$a2, $a0, $t5, 2
	alsl.d	$a0, $a0, $t2, 2
...
# %bb.46:                               # %iter.check249
	...
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB1_49
# %bb.47:                               # %vector.main.loop.iter.check237
                                        #   in Loop: Header=BB1_27 Depth=1
	ori	$a5, $zero, 16
	bgeu	$t7, $a5, .LBB1_50
...
.LBB1_51:                               # %vector.body242
	...
	addi.d	$t1, $t1, 64
	bnez	$ra, .LBB1_51
# %bb.52:                               # %middle.block246
                                        #   in Loop: Header=BB1_27 Depth=1
	ld.d	$fp, $sp, 112                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 88                    # 8-byte Folded Reload
	beq	$t7, $t3, .LBB1_59
# %bb.53:                               # %vec.epilog.iter.check251
                                        #   in Loop: Header=BB1_27 Depth=1
	beqz	$s6, .LBB1_57
.LBB1_54:                               # %vec.epilog.ph253
                                        #   in Loop: Header=BB1_27 Depth=1
	move	$a7, $t7
	...
	alsl.d	$t3, $t0, $a2, 2
	.p2align	4, , 16
.LBB1_55:                               # %vec.epilog.vector.body256
                                        #   Parent Loop BB1_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t3, 0
	vst	$vr0, $t2, 0
	...
	addi.d	$t3, $t3, 16
	bnez	$t1, .LBB1_55
# %bb.56:                               # %vec.epilog.middle.block260
                                        #   in Loop: Header=BB1_27 Depth=1
	beq	$t7, $a7, .LBB1_59
.LBB1_57:                               # %.lr.ph175.preheader
                                        #   in Loop: Header=BB1_27 Depth=1
	addi.d	$a7, $a5, -1
	alsl.d	$t1, $a5, $a2, 2
	alsl.d	$a5, $a5, $a0, 2
