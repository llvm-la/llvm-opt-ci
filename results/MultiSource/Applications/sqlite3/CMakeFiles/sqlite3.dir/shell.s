...
.LBB5_115:                              # %output_html_string.exit
	...
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	beq	$fp, $a0, .LBB5_142
.LBB5_116:                              # =>This Loop Header: Depth=1
...
# %bb.117:                              #   in Loop: Header=BB5_116 Depth=1
	...
	b	.LBB5_115
	.p2align	4, , 16
.LBB5_118:                              #   in Loop: Header=BB5_120 Depth=2
	ori	$a1, $zero, 5
	ori	$a2, $zero, 1
...
.LBB5_120:                              # %.preheader.i
	...
	b	.LBB5_122
	.p2align	4, , 16
.LBB5_121:                              #   in Loop: Header=BB5_122 Depth=3
	add.d	$a0, $s8, $s4
	ld.bu	$a0, $a0, 1
	addi.d	$s4, $s4, 1
	addi.w	$a2, $a2, 1
.LBB5_122:                              #   Parent Loop BB5_116 Depth=1
                                        #     Parent Loop BB5_120 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bltu	$s3, $a0, .LBB5_121
# %bb.123:                              #   in Loop: Header=BB5_122 Depth=3
	sll.d	$a1, $s2, $a0
	and	$a1, $a1, $s1
	beqz	$a1, .LBB5_121
# %bb.124:                              # %.critedge.i
	...
	beqz	$s4, .LBB5_126
# %bb.125:                              #   in Loop: Header=BB5_120 Depth=2
	move	$a0, $s7
	move	$a1, $s6
	move	$a3, $s8
	pcaddu18i	$ra, %call36(fprintf)
	jirl	$ra, $ra, 0
	ldx.bu	$a0, $s8, $s4
.LBB5_126:                              #   in Loop: Header=BB5_120 Depth=2
	ori	$a1, $zero, 38
	beq	$a0, $a1, .LBB5_118
# %bb.127:                              #   in Loop: Header=BB5_120 Depth=2
	bne	$a0, $s3, .LBB5_114
# %bb.128:                              #   in Loop: Header=BB5_120 Depth=2
	ori	$a1, $zero, 4
	ori	$a2, $zero, 1
	move	$a0, $s0
	b	.LBB5_119
.LBB5_129:                              # %.preheader324
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	blez	$a0, .LBB5_144
# %bb.130:                              # %.lr.ph364
...
.LBB5_134:                              # %.thread
	...
	jirl	$ra, $ra, 0
	beqz	$s5, .LBB5_136
# %bb.135:                              #   in Loop: Header=BB5_132 Depth=1
	ld.d	$a1, $s0, 0
	bnez	$a1, .LBB5_137
.LBB5_136:                              #   in Loop: Header=BB5_132 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
.LBB5_137:                              #   in Loop: Header=BB5_132 Depth=1
	addi.w	$s8, $a0, 0
	move	$a0, $a1
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
.LBB5_138:                              # %.thread312
                                        #   in Loop: Header=BB5_132 Depth=1
	st.w	$a2, $s1, 0
.LBB5_139:                              #   in Loop: Header=BB5_132 Depth=1
	ld.w	$a0, $s8, 32
	beqz	$a0, .LBB5_131
# %bb.140:                              #   in Loop: Header=BB5_132 Depth=1
	ld.d	$a0, $s8, 16
	ld.d	$a4, $s2, 0
	xor	$a1, $s4, $s3
	sltui	$a1, $a1, 1
