...
.LBB2_31:                               # %._crit_edge.i.i
	...
	ld.w	$a0, $a0, 16
	blez	$a0, .LBB2_28
# %bb.32:                               # %.lr.ph31.i.i.preheader
                                        #   in Loop: Header=BB2_29 Depth=1
	move	$s7, $zero
	b	.LBB2_34
	.p2align	4, , 16
.LBB2_33:                               # %._crit_edge28.i.i
...
# %bb.46:                               #   in Loop: Header=BB2_41 Depth=1
	...
	rotri.w	$a0, $a0, 1
	bltu	$s3, $a0, .LBB2_40
# %bb.47:                               #   in Loop: Header=BB2_41 Depth=1
	ld.d	$a0, $s4, 0
	addi.w	$a2, $s1, -9
	move	$a1, $fp
	move	$a3, $s1
...
.LJTI2_0:
	...
	.word	.LBB2_64-.LJTI2_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function stateCompare
...
.Lfunc_end3:
	.size	stateCompare, .Lfunc_end3-stateCompare
                                        # -- End function
	.p2align	2                               # -- Begin function assignRules
...
.Lfunc_end4:
	.size	assignRules, .Lfunc_end4-assignRules
                                        # -- End function
	.p2align	2                               # -- Begin function ruleCompare
...
.Lfunc_end5:
	.size	ruleCompare, .Lfunc_end5-ruleCompare
                                        # -- End function
	.p2align	2                               # -- Begin function doDimPmaps
...
.Lfunc_end6:
	.size	doDimPmaps, .Lfunc_end6-doDimPmaps
                                        # -- End function
	.p2align	2                               # -- Begin function doNonTermPmaps
...
.Lfunc_end7:
	.size	doNonTermPmaps, .Lfunc_end7-doNonTermPmaps
                                        # -- End function
	.p2align	2                               # -- Begin function enterStateMap
...
# %bb.18:                               #   in Loop: Header=BB8_15 Depth=1
	...
	st.d	$a0, $s1, 0
	b	.LBB8_14
.LBB8_19:                               # %.preheader.thread
	ld.d	$s5, $a4, 0
.LBB8_20:                               # %._crit_edge75
	ld.w	$a0, $s5, 16
	st.d	$s5, $s1, 16
	bge	$a0, $s0, .LBB8_22
# %bb.21:
...
.Lfunc_end8:
	.size	enterStateMap, .Lfunc_end8-enterStateMap
                                        # -- End function
	.p2align	2                               # -- Begin function mapToPmap
...
.Lfunc_end9:
	.size	mapToPmap, .Lfunc_end9-mapToPmap
                                        # -- End function
	.p2align	2                               # -- Begin function doPlankLabelMacrosSafely
...
.LJTI10_0:
	...
	.word	.LBB10_11-.LJTI10_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function doPlankLabelSafely
