...
# %bb.46:                               # %pred.store.continue
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_54
.LBB1_47:                               # %pred.store.continue730
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 2
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_55
.LBB1_48:                               # %pred.store.continue732
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 3
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_56
.LBB1_49:                               # %pred.store.continue734
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 4
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_57
.LBB1_50:                               # %pred.store.continue736
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 5
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_58
.LBB1_51:                               # %pred.store.continue738
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 6
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_59
.LBB1_52:                               # %pred.store.continue740
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 7
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_44
...
.LBB1_113:                              # %vector.body632
	...
	xvaddi.wu	$xr11, $xr10, 1
	xvbitsel.v	$xr11, $xr8, $xr11, $xr12
	xvffint.s.wu	$xr11, $xr11
	xvfdiv.s	$xr11, $xr9, $xr11
...
# %bb.145:                              # %.lr.ph464
	...
	xvreplve0.w	$xr1, $xr0
	pcalau12i	$a5, %pc_hi20(.LCPI1_2)
	fld.d	$fa2, $a5, %pc_lo12(.LCPI1_2)
	pcalau12i	$a5, %pc_hi20(.LCPI1_0)
	xvld	$xr3, $a5, %pc_lo12(.LCPI1_0)
	pcalau12i	$a5, %pc_hi20(.LCPI1_1)
	xvld	$xr4, $a5, %pc_lo12(.LCPI1_1)
	lu12i.w	$a5, 172394
	ori	$a5, $a5, 433
	lu32i.d	$a5, 184019
	lu52i.d	$a5, $a5, 1149
...
# %bb.234:                              # %middle.block860
                                        #   in Loop: Header=BB1_225 Depth=1
	beq	$t3, $a3, .LBB1_224
# %bb.235:                              # %vec.epilog.iter.check864
                                        #   in Loop: Header=BB1_225 Depth=1
	move	$s0, $t3
	beqz	$t2, .LBB1_239
.LBB1_236:                              # %vec.epilog.ph866
                                        #   in Loop: Header=BB1_225 Depth=1
	add.d	$ra, $t5, $t7
	vldrepl.w	$vr0, $s8, 0
	alsl.d	$fp, $s0, $a4, 2
	...
	add.d	$s0, $s5, $s0
	.p2align	4, , 16
.LBB1_237:                              # %vec.epilog.vector.body870
                                        #   Parent Loop BB1_225 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $t5, 0
	vld	$vr2, $fp, 0
	...
	addi.d	$t5, $t5, 16
	bnez	$s0, .LBB1_237
# %bb.238:                              # %vec.epilog.middle.block881
                                        #   in Loop: Header=BB1_225 Depth=1
	move	$t5, $t8
	move	$fp, $t6
	beq	$t6, $a3, .LBB1_224
