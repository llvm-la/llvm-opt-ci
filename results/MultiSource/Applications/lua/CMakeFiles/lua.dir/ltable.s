...
.LBB0_15:
	...
	jirl	$ra, $ra, 0
	move	$a3, $zero
.LBB0_16:                               # %findindex.exit
	ld.w	$a0, $s0, 56
	addi.d	$a1, $a3, 1
	bge	$a1, $a0, .LBB0_14
.LBB0_17:                               # %.lr.ph87.preheader
	ld.d	$a4, $s0, 24
	slli.d	$a2, $a3, 4
	addi.w	$a3, $a3, 2
	addi.d	$a4, $a4, 24
...
# %bb.14:
	...
	addi.w	$a2, $a1, -1
	bgeu	$a2, $a3, .LBB8_18
# %bb.15:                               # %luaH_getnum.exit.thread31
	ld.d	$a0, $a0, 24
	alsl.d	$fp, $a2, $a0, 4
	b	.LBB8_27
.LBB8_16:                               # %.thread
...
# %bb.0:
	...
	ori	$s0, $zero, 1
	pcalau12i	$a0, %pc_hi20(dummynode_)
	addi.d	$s4, $a0, %pc_lo12(dummynode_)
	addi.d	$s6, $sp, 48
	ori	$s7, $zero, 27
	ori	$s8, $zero, 7
	vrepli.b	$vr0, 0
...
.LBB10_28:                              # %countint.exit.i
	...
	add.d	$s2, $a0, $s2
	addi.d	$s0, $s0, 1
.LBB10_29:                              #   in Loop: Header=BB10_30 Depth=2
	addi.d	$a0, $s8, -1
	addi.d	$s5, $s5, -40
	beqz	$s8, .LBB10_35
...
.LBB10_52:                              # %.preheader.i.i
	...
	mod.wu	$a0, $a0, $a2
	b	.LBB10_5
.LBB10_53:                              # %getfreepos.exit
	ld.w	$a3, $a0, 24
	addi.d	$a3, $a3, -1
	ori	$a4, $zero, 3
	bltu	$a4, $a3, .LBB10_56
# %bb.54:                               # %getfreepos.exit
	slli.d	$a3, $a3, 2
