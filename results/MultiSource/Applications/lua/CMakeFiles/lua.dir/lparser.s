...
.LBB2_117:                              # %vector.body239
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_117
# %bb.118:                              # %middle.block242
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_121
.LBB2_119:                              # %scalar.ph234.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_120:                              # %scalar.ph234
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_144:                              # %vector.body283
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_144
# %bb.145:                              # %middle.block286
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_148
.LBB2_146:                              # %scalar.ph278.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_147:                              # %scalar.ph278
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_159:                              # %vector.body294
	...
	addi.d	$a7, $a7, 8
	bnez	$t0, .LBB2_159
# %bb.160:                              # %middle.block297
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a6, $a5, .LBB2_163
.LBB2_161:                              # %scalar.ph289.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_170:                              # %vector.body250
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_170
# %bb.171:                              # %middle.block253
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_201
.LBB2_172:                              # %scalar.ph245.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_173:                              # %scalar.ph245
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_185:                              # %vector.body272
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_185
# %bb.186:                              # %middle.block275
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_189
.LBB2_187:                              # %scalar.ph267.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_188:                              # %scalar.ph267
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_197:                              # %vector.body261
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_197
# %bb.198:                              # %middle.block264
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_201
.LBB2_199:                              # %scalar.ph256.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_200:                              # %scalar.ph256
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
