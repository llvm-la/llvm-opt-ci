...
.LBB2_118:                              # %vector.body240
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_118
# %bb.119:                              # %middle.block244
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_122
.LBB2_120:                              # %scalar.ph235.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_121:                              # %scalar.ph235
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_145:                              # %vector.body288
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_145
# %bb.146:                              # %middle.block292
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_149
.LBB2_147:                              # %scalar.ph283.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_148:                              # %scalar.ph283
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_160:                              # %vector.body300
	...
	addi.d	$a7, $a7, 16
	bnez	$t0, .LBB2_160
# %bb.161:                              # %middle.block304
                                        #   in Loop: Header=BB2_5 Depth=1
	ori	$s7, $zero, 27
	beq	$a6, $a5, .LBB2_164
.LBB2_162:                              # %scalar.ph295.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_171:                              # %vector.body252
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_171
# %bb.172:                              # %middle.block256
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_173:                              # %scalar.ph247.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_174:                              # %scalar.ph247
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_186:                              # %vector.body276
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_186
# %bb.187:                              # %middle.block280
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_190
.LBB2_188:                              # %scalar.ph271.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_189:                              # %scalar.ph271
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_198:                              # %vector.body264
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_198
# %bb.199:                              # %middle.block268
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_200:                              # %scalar.ph259.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_201:                              # %scalar.ph259
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
