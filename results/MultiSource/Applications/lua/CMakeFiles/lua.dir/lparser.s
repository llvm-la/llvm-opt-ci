...
# %bb.14:                               #   in Loop: Header=BB2_5 Depth=1
	...
	pcaddu18i	$ra, %call36(luaX_syntaxerror)
	jirl	$ra, $ra, 0
.LBB2_15:                               # %str_checkname.exit.i31
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$s0, $fp, 24
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
...
# %bb.26:                               #   in Loop: Header=BB2_5 Depth=1
	...
	pcaddu18i	$ra, %call36(luaX_syntaxerror)
	jirl	$ra, $ra, 0
.LBB2_27:                               # %str_checkname.exit.i19
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$s0, $fp, 24
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
...
# %bb.53:                               #   in Loop: Header=BB2_49 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB2_49
.LBB2_54:                               # %checknext.exit91.sink.split
                                        #   in Loop: Header=BB2_49 Depth=2
	ld.d	$s2, $fp, 56
	ori	$a1, $zero, 274
	move	$a0, $fp
...
.LBB2_118:                              # %vector.body241
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_118
# %bb.119:                              # %middle.block246
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_122
.LBB2_120:                              # %scalar.ph236.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_121:                              # %scalar.ph236
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_129:                              # %vector.body228
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_129
# %bb.130:                              # %middle.block233
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_133
.LBB2_131:                              # %scalar.ph223.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_132:                              # %scalar.ph223
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_132
.LBB2_133:                              # %._crit_edge.i.i.i52
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
.LBB2_134:                              # %removevars.exit.i.i46
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_136
...
.LBB2_145:                              # %vector.body293
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_145
# %bb.146:                              # %middle.block298
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_149
.LBB2_147:                              # %scalar.ph288.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_148:                              # %scalar.ph288
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_148
.LBB2_149:                              # %._crit_edge.i.i28.i
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
.LBB2_150:                              # %removevars.exit.i23.i
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_152
...
.LBB2_155:                              #   in Loop: Header=BB2_5 Depth=1
	blez	$s5, .LBB2_157
.LBB2_156:                              #   in Loop: Header=BB2_5 Depth=1
	ld.w	$s1, $s0, 60
	move	$a0, $s0
	move	$a1, $s5
	pcaddu18i	$ra, %call36(luaK_reserveregs)
...
.LBB2_160:                              # %vector.body306
	...
	addi.d	$a7, $a7, 16
	bnez	$t0, .LBB2_160
# %bb.161:                              # %middle.block310
                                        #   in Loop: Header=BB2_5 Depth=1
	ori	$s7, $zero, 19
	beq	$a6, $a5, .LBB2_164
.LBB2_162:                              # %scalar.ph301.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
# %bb.172:                              # %middle.block259
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_173:                              # %scalar.ph249.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_174:                              # %scalar.ph249
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_179:                              # %scalar.ph
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_179
.LBB2_180:                              # %._crit_edge.i.i86
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
.LBB2_181:                              # %removevars.exit.i81
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_183
...
.LBB2_186:                              # %vector.body280
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_186
# %bb.187:                              # %middle.block285
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_190
.LBB2_188:                              # %scalar.ph275.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_189:                              # %scalar.ph275
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_191:                              # %removevars.exit.i.i
	...
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_193
# %bb.192:                              #   in Loop: Header=BB2_5 Depth=1
	ori	$a1, $zero, 35
	move	$a0, $s5
	move	$a3, $zero
	move	$a4, $zero
...
.LBB2_198:                              # %vector.body267
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_198
# %bb.199:                              # %middle.block272
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_200:                              # %scalar.ph262.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_201:                              # %scalar.ph262
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_201
.LBB2_202:                              # %._crit_edge.i.i.i40
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
.LBB2_203:                              # %removevars.exit.i.i35
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_205
# %bb.204:                              #   in Loop: Header=BB2_5 Depth=1
	ori	$a1, $zero, 35
	move	$a0, $s5
	move	$a3, $zero
	move	$a4, $zero
...
# %bb.210:                              #   in Loop: Header=BB2_5 Depth=1
	ori	$a0, $zero, 44
	beq	$s1, $a0, .LBB2_213
# %bb.211:                              #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a0, $s0, 0
	ld.w	$a1, $sp, 112
	ld.d	$a0, $a0, 24
	slli.d	$a1, $a1, 2
...
.LBB17_20:
	move	$a1, $zero
	move	$a2, $s4
.LBB17_21:                              # %._crit_edge.thread.i
	bge	$a1, $a2, .LBB17_25
.LBB17_22:                              # %._crit_edge.thread.i._crit_edge
	ld.d	$s3, $s2, 56
	blt	$s4, $a2, .LBB17_26
	b	.LBB17_27
.LBB17_23:
...
.LBB17_30:
	...
	addi.d	$a1, $a0, 1
	st.b	$a1, $s2, 112
.LBB17_31:                              # %indexupvalue.exit
	st.w	$a0, $fp, 8
	ori	$a0, $zero, 7
	st.w	$a0, $fp, 0
.LBB17_32:                              # %markupval.exit
	ld.d	$s4, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s3, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
...
# %bb.29:                               # %middle.block74
	beq	$a5, $a6, .LBB18_32
.LBB18_30:                              # %scalar.ph64.preheader
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB18_31:                              # %scalar.ph64
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	alsl.d	$a6, $a6, $a3, 4
