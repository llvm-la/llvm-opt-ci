...
.LJTI5_1:
	...
	.word	.LBB5_47-.LJTI5_1
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function gfind_nodef
...
.LBB17_28:
	move	$s1, $s6
.LBB17_29:                              # %lmemfind.exit.thread70
	sub.d	$s0, $s1, $s0
	addi.d	$a1, $s0, 1
	move	$a0, $fp
	pcaddu18i	$ra, %call36(lua_pushinteger)
...
# %bb.118:                              # %.lr.ph526
	...
	addi.w	$a2, $zero, -1
	.p2align	4, , 16
.LBB18_119:                             # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 0
	beq	$a3, $a2, .LBB18_132
# %bb.120:                              #   in Loop: Header=BB18_119 Depth=1
	addi.w	$a0, $a0, -1
	addi.d	$a1, $a1, -16
	bgtz	$a0, .LBB18_119
.LBB18_121:                             # %._crit_edge
	ld.d	$a0, $s8, 16
...
# %bb.131:
	...
	st.w	$a1, $s8, 24
	b	.LBB18_224
.LBB18_132:                             # %capture_to_close.exit.loopexit
	addi.w	$a0, $a0, -1
.LBB18_133:                             # %capture_to_close.exit
	slli.d	$a1, $a0, 4
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	ldx.d	$a1, $a2, $a1
	alsl.d	$fp, $a0, $a2, 4
...
.LBB18_138:                             #   in Loop: Header=BB18_140 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB18_218
.LBB18_139:                             # %singlematch.exit172.thread
...
.LBB18_144:                             #   in Loop: Header=BB18_140 Depth=1
	...
	or	$fp, $a3, $a0
	addi.d	$a0, $fp, 1
	bgeu	$a0, $s2, .LBB18_157
# %bb.145:                              # %.lr.ph.i.i166.preheader
                                        #   in Loop: Header=BB18_140 Depth=1
	sltu	$a1, $zero, $a2
...
.LBB18_147:                             #   in Loop: Header=BB18_148 Depth=2
	move	$fp, $a0
	addi.d	$a0, $a0, 1
	bgeu	$a0, $s2, .LBB18_158
.LBB18_148:                             # %.lr.ph.i.i166
...
# %bb.152:                              #   in Loop: Header=BB18_148 Depth=2
	addi.d	$a1, $fp, 3
	bgeu	$a1, $s2, .LBB18_146
# %bb.153:                              #   in Loop: Header=BB18_148 Depth=2
	bgeu	$s1, $a2, .LBB18_155
...
.LBB18_155:                             #   in Loop: Header=BB18_148 Depth=2
	ld.bu	$a2, $a1, 0
	move	$a0, $a1
	bltu	$a2, $s1, .LBB18_147
.LBB18_156:                             #   in Loop: Header=BB18_140 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	b	.LBB18_159
.LBB18_157:                             # %singlematch.exit172
                                        #   in Loop: Header=BB18_140 Depth=1
	ld.d	$fp, $sp, 48                    # 8-byte Folded Reload
	ori	$s6, $zero, 91
	ori	$a0, $zero, 94
...
.LBB18_158:                             #   in Loop: Header=BB18_140 Depth=1
	move	$a0, $s6
.LBB18_159:                             # %matchbracketclass.exit.i161.loopexit
                                        #   in Loop: Header=BB18_140 Depth=1
	ld.d	$fp, $sp, 48                    # 8-byte Folded Reload
	ori	$s6, $zero, 91
	bnez	$a0, .LBB18_139
	b	.LBB18_218
.LBB18_160:                             # %.preheader217
	addi.d	$s1, $s2, 1
	move	$a0, $s8
	move	$a1, $s6
	move	$a2, $s1
...
.LBB18_162:                             #   in Loop: Header=BB18_164 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB18_223
.LBB18_163:                             # %singlematch.exit186.thread
...
.LBB18_169:                             #   in Loop: Header=BB18_164 Depth=1
	...
	or	$s0, $a3, $a0
	addi.d	$a0, $s0, 1
	bgeu	$a0, $s3, .LBB18_181
# %bb.170:                              # %.lr.ph.i.i180.preheader
                                        #   in Loop: Header=BB18_164 Depth=1
	sltu	$s8, $zero, $a2
	b	.LBB18_173
...
.LBB18_180:                             #   in Loop: Header=BB18_173 Depth=2
	...
	b	.LBB18_183
.LBB18_181:                             # %singlematch.exit186
                                        #   in Loop: Header=BB18_164 Depth=1
	ori	$a0, $zero, 94
	ori	$fp, $zero, 46
	beq	$a1, $a0, .LBB18_163
	b	.LBB18_223
.LBB18_182:                             #   in Loop: Header=BB18_164 Depth=1
	move	$s8, $fp
.LBB18_183:                             # %matchbracketclass.exit.i175.loopexit
                                        #   in Loop: Header=BB18_164 Depth=1
	ori	$fp, $zero, 46
	bnez	$s8, .LBB18_163
	b	.LBB18_223
...
.LBB18_214:                             # %.lr.ph532
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB18_224
# %bb.215:                              #   in Loop: Header=BB18_214 Depth=1
	move	$a0, $zero
	addi.d	$s3, $fp, -1
	bgtz	$fp, .LBB18_214
	b	.LBB18_224
...
.LBB18_218:                             # %.critedge.i132
	ld.d	$s8, $sp, 56                    # 8-byte Folded Reload
.LBB18_219:                             # %.critedge.i132
	bltz	$s3, .LBB18_223
# %bb.220:                              # %.lr.ph528.preheader
	addi.d	$s1, $s4, 1
	addi.d	$fp, $s3, 1
.LBB18_221:                             # %.lr.ph528
                                        # =>This Inner Loop Header: Depth=1
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB18_224
# %bb.222:                              #   in Loop: Header=BB18_221 Depth=1
	addi.d	$fp, $fp, -1
	move	$a0, $zero
	bgtz	$fp, .LBB18_221
	b	.LBB18_224
