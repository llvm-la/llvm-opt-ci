...
.LBB2_18:                               # %vector.body664
	...
	addi.d	$t8, $t8, 64
	bnez	$fp, .LBB2_18
# %bb.19:                               # %middle.block671
	beq	$t4, $t5, .LBB2_26
# %bb.20:                               # %vec.epilog.iter.check676
	beqz	$t6, .LBB2_24
.LBB2_21:                               # %vec.epilog.ph678
	move	$t0, $t4
	...
	sub.d	$t5, $t5, $t0
	.p2align	4, , 16
.LBB2_22:                               # %vec.epilog.vector.body683
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t6, 0
	vld	$vr2, $t6, -4
	vsub.w	$vr1, $vr1, $vr2
	...
	addi.d	$t8, $t8, 16
	bnez	$t5, .LBB2_22
# %bb.23:                               # %vec.epilog.middle.block688
	beq	$t4, $t0, .LBB2_26
...
.LBB2_70:                               #   in Loop: Header=BB2_67 Depth=1
	...
	b	.LBB2_82
	.p2align	4, , 16
.LBB2_71:                               # %vector.main.loop.iter.check692
                                        #   in Loop: Header=BB2_67 Depth=1
...
.LBB2_73:                               # %vec.epilog.ph715
	...
	alsl.d	$s7, $s8, $a3, 1
	.p2align	4, , 16
.LBB2_74:                               # %vec.epilog.vector.body720
	...
	addi.d	$s7, $s7, 16
	bnez	$t0, .LBB2_74
# %bb.75:                               # %vec.epilog.middle.block727
                                        #   in Loop: Header=BB2_67 Depth=1
...
# %bb.78:                               # %middle.block708
	...
	beq	$t3, $t1, .LBB2_82
# %bb.79:                               # %vec.epilog.iter.check713
                                        #   in Loop: Header=BB2_67 Depth=1
	move	$s8, $t3
	move	$ra, $t3
