...
.Lfunc_end16:
	.size	d_pass, .Lfunc_end16-d_pass
                                        # -- End function
	.p2align	2                               # -- Begin function pass_preorder
...
.Lfunc_end17:
	.size	pass_preorder, .Lfunc_end17-pass_preorder
                                        # -- End function
	.p2align	2                               # -- Begin function pass_postorder
...
.Lfunc_end20:
	...
	.p2align	2                               # -- Begin function syntax_error_report_fn
...
.Lfunc_end21:
	.size	syntax_error_report_fn, .Lfunc_end21-syntax_error_report_fn
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function parse_whitespace
...
.Lfunc_end22:
	.size	parse_whitespace, .Lfunc_end22-parse_whitespace
                                        # -- End function
	.p2align	2                               # -- Begin function white_space
...
.LBB23_12:                              #   in Loop: Header=BB23_4 Depth=1
	bne	$a4, $a2, .LBB23_29
# %bb.13:                               # %.preheader111.preheader
                                        #   in Loop: Header=BB23_4 Depth=1
	move	$a4, $zero
.LBB23_14:                              # %.preheader111
                                        #   Parent Loop BB23_4 Depth=1
...
.LBB23_25:                              #   in Loop: Header=BB23_15 Depth=3
	...
	b	.LBB23_27
	.p2align	4, , 16
.LBB23_26:                              # %.preheader111.loopexit
...
.Lfunc_end25:
	.size	free_D_ParseNode, .Lfunc_end25-free_D_ParseNode
                                        # -- End function
	.p2align	2                               # -- Begin function free_PNode
...
.Lfunc_end26:
	.size	free_PNode, .Lfunc_end26-free_PNode
                                        # -- End function
	.p2align	2                               # -- Begin function free_parser_working_data
...
.Lfunc_end29:
	.size	dparse, .Lfunc_end29-dparse
                                        # -- End function
	.p2align	2                               # -- Begin function exhaustive_parse
...
.LBB30_182:                             # %error_recovery.exit.thread.sink.split
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB30_183:                             # %error_recovery.exit.thread
	ori	$a0, $zero, 1
	b	.LBB30_185
.LBB30_184:
	move	$a0, $zero
.LBB30_185:                             # %error_recovery.exit.thread
...
.Lfunc_end30:
	.size	exhaustive_parse, .Lfunc_end30-exhaustive_parse
                                        # -- End function
	.p2align	2                               # -- Begin function commit_tree
...
# %bb.40:                               # %.lr.ph
	...
	and	$a0, $a0, $a1
	beqz	$a0, .LBB31_85
# %bb.41:                               # %.lr.ph.split.us.preheader
	addi.d	$s5, $s0, 56
	ori	$s6, $zero, 2
...
.LBB31_53:                              # %vector.body123
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB31_53
# %bb.54:                               # %middle.block128
                                        #   in Loop: Header=BB31_44 Depth=1
	beq	$a3, $a4, .LBB31_57
.LBB31_55:                              # %scalar.ph118.preheader
                                        #   in Loop: Header=BB31_44 Depth=1
	alsl.d	$a1, $a2, $a1, 3
	addi.d	$a1, $a1, 8
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB31_56:                              # %scalar.ph118
                                        #   Parent Loop BB31_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a1, 0
	st.d	$a2, $a1, -8
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB31_56
.LBB31_57:                              # %._crit_edge.i59.us
                                        #   in Loop: Header=BB31_44 Depth=1
	ld.w	$a0, $s1, 0
	addi.d	$a0, $a0, -1
	st.w	$a0, $s1, 0
	b	.LBB31_76
.LBB31_58:                              # %.preheader64.i.us
                                        #   in Loop: Header=BB31_44 Depth=1
	blt	$s2, $s6, .LBB31_69
# %bb.59:                               # %.lr.ph68.i.us
                                        #   in Loop: Header=BB31_44 Depth=1
...
.LBB31_61:                              #   in Loop: Header=BB31_62 Depth=2
	addi.w	$s4, $s4, -1
	beqz	$s4, .LBB31_69
.LBB31_62:                              #   Parent Loop BB31_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s0, 48
	beqz	$a0, .LBB31_60
...
# %bb.65:                               #   in Loop: Header=BB31_62 Depth=2
	...
	b	.LBB31_61
	.p2align	4, , 16
.LBB31_66:                              #   in Loop: Header=BB31_62 Depth=2
	ori	$a2, $zero, 3
	bgeu	$a1, $a2, .LBB31_68
...
# %bb.74:                               # %.lr.ph73.i.us
	...
	alsl.d	$a1, $s7, $a1, 3
	.p2align	4, , 16
.LBB31_75:                              #   Parent Loop BB31_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 0
	ld.w	$a3, $a2, 32
	addi.d	$a3, $a3, 1
	...
	addi.d	$a0, $a0, 8
	bnez	$s2, .LBB31_75
.LBB31_76:                              # %.loopexit.i.us
                                        #   in Loop: Header=BB31_44 Depth=1
	ld.w	$a0, $s3, 32
	addi.w	$a0, $a0, -1
	st.w	$a0, $s3, 32
	bnez	$a0, .LBB31_42
# %bb.77:                               #   in Loop: Header=BB31_44 Depth=1
	move	$a0, $fp
	move	$a1, $s3
	pcaddu18i	$ra, %call36(free_PNode)
	jirl	$ra, $ra, 0
...
.LBB31_84:
	move	$s8, $zero
	b	.LBB31_87
.LBB31_85:                              # %.lr.ph.split.preheader
	ld.d	$a1, $s0, 48
	move	$s2, $zero
	move	$s3, $zero
	.p2align	4, , 16
.LBB31_86:                              # %.lr.ph.split
                                        # =>This Inner Loop Header: Depth=1
	ldx.d	$a1, $a1, $s2
	move	$a0, $fp
	pcaddu18i	$ra, %call36(commit_tree)
...
# %bb.97:                               #   in Loop: Header=BB31_96 Depth=1
	...
	ld.wu	$a0, $s1, 0
	b	.LBB31_95
.LBB31_98:                              # %._crit_edge.i65
	ld.d	$a0, $s0, 48
	beqz	$a0, .LBB31_101
# %bb.99:                               # %._crit_edge.i65
	addi.d	$a1, $s0, 56
	beq	$a0, $a1, .LBB31_101
# %bb.100:
	pcaddu18i	$ra, %call36(free)
...
.Lfunc_end31:
	.size	commit_tree, .Lfunc_end31-commit_tree
                                        # -- End function
	.p2align	2                               # -- Begin function free_SNode
...
.Lfunc_end32:
	.size	free_SNode, .Lfunc_end32-free_SNode
                                        # -- End function
	.p2align	2                               # -- Begin function free_old_nodes
...
.Lfunc_end33:
	.size	free_old_nodes, .Lfunc_end33-free_old_nodes
                                        # -- End function
	.p2align	2                               # -- Begin function add_SNode
...
.Lfunc_end34:
	.size	add_SNode, .Lfunc_end34-add_SNode
                                        # -- End function
	.p2align	2                               # -- Begin function add_PNode
...
.Lfunc_end35:
	.size	add_PNode, .Lfunc_end35-add_PNode
                                        # -- End function
	.p2align	2                               # -- Begin function set_add_znode
...
.Lfunc_end36:
	.size	set_add_znode, .Lfunc_end36-set_add_znode
                                        # -- End function
	.p2align	2                               # -- Begin function reduce_one
...
.LBB37_4:                               #   in Loop: Header=BB37_6 Depth=1
	...
	beqz	$a0, .LBB37_47
	.p2align	4, , 16
.LBB37_5:                               # %check_path_priorities_internal.exit.thread82
...
.Lfunc_end37:
	.size	reduce_one, .Lfunc_end37-reduce_one
                                        # -- End function
	.p2align	2                               # -- Begin function commit_stack
...
.Lfunc_end38:
	.size	commit_stack, .Lfunc_end38-commit_stack
                                        # -- End function
	.p2align	2                               # -- Begin function new_SNode
...
.Lfunc_end39:
	.size	new_SNode, .Lfunc_end39-new_SNode
                                        # -- End function
	.p2align	2                               # -- Begin function add_Reduction
...
.Lfunc_end40:
	.size	add_Reduction, .Lfunc_end40-add_Reduction
                                        # -- End function
	.p2align	2                               # -- Begin function get_exp_one
...
.Lfunc_end41:
	.size	get_exp_one, .Lfunc_end41-get_exp_one
                                        # -- End function
	.p2align	2                               # -- Begin function get_exp_all
...
.Lfunc_end42:
	.size	get_exp_all, .Lfunc_end42-get_exp_all
                                        # -- End function
	.p2align	2                               # -- Begin function set_add_znode_hash
...
.Lfunc_end43:
	.size	set_add_znode_hash, .Lfunc_end43-set_add_znode_hash
                                        # -- End function
	.p2align	2                               # -- Begin function goto_PNode
...
.Lfunc_end44:
	.size	goto_PNode, .Lfunc_end44-goto_PNode
                                        # -- End function
	.p2align	2                               # -- Begin function new_VecZNode
...
.Lfunc_end45:
	.size	new_VecZNode, .Lfunc_end45-new_VecZNode
                                        # -- End function
	.p2align	2                               # -- Begin function build_paths_internal
...
.Lfunc_end46:
	.size	build_paths_internal, .Lfunc_end46-build_paths_internal
                                        # -- End function
	.p2align	2                               # -- Begin function check_assoc_priority
...
.Lfunc_end47:
	.size	check_assoc_priority, .Lfunc_end47-check_assoc_priority
                                        # -- End function
	.p2align	2                               # -- Begin function final_actionless
