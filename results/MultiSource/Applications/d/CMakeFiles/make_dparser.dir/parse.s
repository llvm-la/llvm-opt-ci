...
# %bb.70:                               # %.lr.ph71.i.us
	...
	addi.d	$a3, $a3, -8
	.p2align	4, , 16
.LBB31_71:                              #   Parent Loop BB31_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a4, $a3, 0
	addi.d	$s8, $s8, -1
	slli.d	$a5, $a2, 3
...
# %bb.73:                               # %.lr.ph73.i.us
	...
	alsl.d	$a1, $s7, $a1, 3
	.p2align	4, , 16
.LBB31_74:                              #   Parent Loop BB31_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 0
	ld.w	$a3, $a2, 32
	addi.d	$a3, $a3, 1
	...
	addi.d	$a0, $a0, 8
	bnez	$s2, .LBB31_74
.LBB31_75:                              # %.loopexit.i.us
                                        #   in Loop: Header=BB31_44 Depth=1
	ld.w	$a0, $s3, 32
	addi.w	$a0, $a0, -1
	st.w	$a0, $s3, 32
	bnez	$a0, .LBB31_42
# %bb.76:                               #   in Loop: Header=BB31_44 Depth=1
	move	$a0, $fp
	move	$a1, $s3
	pcaddu18i	$ra, %call36(free_PNode)
	jirl	$ra, $ra, 0
...
.LBB31_77:
	move	$s8, $zero
	b	.LBB31_80
.LBB31_78:                              # %.lr.ph.split.preheader
	ld.d	$a1, $s0, 48
	move	$s2, $zero
	move	$s3, $zero
	.p2align	4, , 16
.LBB31_79:                              # %.lr.ph.split
                                        # =>This Inner Loop Header: Depth=1
	ldx.d	$a1, $a1, $s2
	move	$a0, $fp
	pcaddu18i	$ra, %call36(commit_tree)
...
# %bb.90:                               #   in Loop: Header=BB31_89 Depth=1
	...
	ld.wu	$a0, $s1, 0
	b	.LBB31_88
.LBB31_91:                              # %._crit_edge.i65
	ld.d	$a0, $s0, 48
	beqz	$a0, .LBB31_94
# %bb.92:                               # %._crit_edge.i65
	addi.d	$a1, $s0, 56
	beq	$a0, $a1, .LBB31_94
# %bb.93:
	pcaddu18i	$ra, %call36(free)
