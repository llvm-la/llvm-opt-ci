...
.LBB8_140:                              #   in Loop: Header=BB8_141 Depth=2
	...
	addi.d	$s5, $s5, 1
	bge	$s7, $a0, .LBB8_176
.LBB8_141:                              #   Parent Loop BB8_102 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_154 Depth 3
                                        #       Child Loop BB8_172 Depth 3
	ld.w	$a0, $s3, 0
...
# %bb.178:                              # %.lr.ph461.preheader.i
	...
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB8_180
# %bb.179:                              #   in Loop: Header=BB8_102 Depth=1
	lu12i.w	$a0, 1
	ori	$a0, $a0, 480
	add.d	$a0, $sp, $a0
	...
	jirl	$ra, $ra, 0
	bne	$a0, $s7, .LBB8_181
.LBB8_180:                              #   in Loop: Header=BB8_102 Depth=1
	...
	pcaddu18i	$ra, %call36(fprintf)
	jirl	$ra, $ra, 0
.LBB8_181:                              #   in Loop: Header=BB8_102 Depth=1
	ld.d	$a0, $s3, 304
	ldx.d	$a0, $a0, $s4
	ldptr.w	$a1, $a0, 2056
	ori	$a2, $zero, 2
...
.LBB8_313:                              # %._crit_edge179.i
	...
	b	.LBB8_319
	.p2align	4, , 16
.LBB8_314:                              #   in Loop: Header=BB8_284 Depth=1
...
# %bb.316:                              # %.lr.ph182.i
	...
	move	$s2, $zero
	.p2align	4, , 16
.LBB8_317:                              #   Parent Loop BB8_284 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s6, 184
	ldx.d	$a1, $a1, $s1
	ld.d	$a1, $a1, 16
...
.LBB8_318:                              # %._crit_edge183.i
	...
	jirl	$ra, $ra, 0
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
.LBB8_319:                              #   in Loop: Header=BB8_284 Depth=1
	ld.w	$a0, $s6, 216
	beqz	$a0, .LBB8_283
# %bb.320:                              #   in Loop: Header=BB8_284 Depth=1
	move	$a0, $s0
...
# %bb.321:                              # %.lr.ph186.i
	...
	move	$s2, $zero
	.p2align	4, , 16
.LBB8_322:                              #   Parent Loop BB8_284 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s6, 224
	ldx.d	$a1, $a1, $s1
	ld.d	$a4, $a1, 16
...
# %bb.325:                              # %.lr.ph194.i.preheader
	...
	b	.LBB8_327
	.p2align	4, , 16
.LBB8_326:                              #   in Loop: Header=BB8_327 Depth=1
	lu12i.w	$a0, 1
	ori	$a0, $a0, 736
	add.d	$a0, $sp, $a0
	ld.wu	$a0, $a0, 0
...
.LBB8_327:                              # %.lr.ph194.i
	...
	bstrpick.d	$a0, $a0, 31, 0
	beq	$s3, $a0, .LBB8_329
# %bb.328:                              #   in Loop: Header=BB8_327 Depth=1
	ori	$a0, $zero, 44
	move	$a1, $s0
	pcaddu18i	$ra, %call36(fputc)
	jirl	$ra, $ra, 0
.LBB8_329:                              #   in Loop: Header=BB8_327 Depth=1
	andi	$a0, $s3, 15
	bne	$a0, $s4, .LBB8_326
# %bb.330:                              #   in Loop: Header=BB8_327 Depth=1
	ori	$a0, $zero, 10
	move	$a1, $s0
	pcaddu18i	$ra, %call36(fputc)
	jirl	$ra, $ra, 0
	b	.LBB8_326
.LBB8_331:                              # %._crit_edge191.thread.i
...
.LBB8_334:                              # %._crit_edge.i112
	...
	ld.d	$s8, $sp, 176                   # 8-byte Folded Reload
	ld.d	$s1, $sp, 160                   # 8-byte Folded Reload
.LBB8_335:                              #   in Loop: Header=BB8_336 Depth=1
	ld.wu	$a0, $fp, 88
	addi.d	$s6, $s6, 1
	bgeu	$s6, $a0, .LBB8_341
.LBB8_336:                              # =>This Loop Header: Depth=1
	...
	ld.w	$a0, $s7, 256
	beqz	$a0, .LBB8_335
# %bb.337:                              #   in Loop: Header=BB8_336 Depth=1
	addi.d	$a0, $sp, 184
	move	$a1, $s7
	move	$a2, $s1
	pcaddu18i	$ra, %call36(set_add_fn)
	jirl	$ra, $ra, 0
	bne	$a0, $s7, .LBB8_335
# %bb.338:                              #   in Loop: Header=BB8_336 Depth=1
	ld.w	$a0, $s7, 256
	ori	$a1, $zero, 1
	sltu	$a0, $a1, $a0
...
# %bb.339:                              # %.lr.ph.i109
	...
	move	$s3, $zero
	.p2align	4, , 16
.LBB8_340:                              #   Parent Loop BB8_336 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s7, 264
	ldx.d	$a0, $a0, $s1
	ld.d	$a0, $a0, 16
...
# %bb.343:                              # %.lr.ph.i114
	...
	b	.LBB8_346
	.p2align	4, , 16
.LBB8_344:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 2
	ori	$a2, $zero, 1
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB8_345:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a0, $fp, 88
	addi.d	$a0, $a0, -1
	bstrpick.d	$a0, $a0, 31, 0
	xor	$a0, $s8, $a0
...
.LBB8_346:                              # =>This Inner Loop Header: Depth=1
	...
	ld.w	$a0, $s4, 96
	beqz	$a0, .LBB8_348
# %bb.347:                              #   in Loop: Header=BB8_346 Depth=1
	...
	b	.LBB8_349
	.p2align	4, , 16
.LBB8_348:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 6
	ori	$a2, $zero, 1
	move	$a0, $s3
	move	$a3, $s0
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB8_349:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $s4, 392
	move	$a0, $s0
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(fprintf)
	...
	ld.w	$a2, $s4, 176
	beqz	$a2, .LBB8_358
# %bb.350:                              #   in Loop: Header=BB8_346 Depth=1
	...
	ld.w	$a2, $s4, 216
	beqz	$a2, .LBB8_359
.LBB8_351:                              #   in Loop: Header=BB8_346 Depth=1
	...
	ld.w	$a0, $s4, 256
	beqz	$a0, .LBB8_360
.LBB8_352:                              #   in Loop: Header=BB8_346 Depth=1
	pcalau12i	$a0, %pc_hi20(er_hint_hash_fns)
	...
	ld.w	$a0, $s4, 136
	beqz	$a0, .LBB8_361
.LBB8_353:                              #   in Loop: Header=BB8_346 Depth=1
	ld.d	$a0, $s4, 400
	move	$a2, $s2
	beqz	$a0, .LBB8_355
# %bb.354:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
.LBB8_355:                              #   in Loop: Header=BB8_346 Depth=1
	...
	ld.bu	$a0, $s4, 376
	beqz	$a2, .LBB8_368
.LBB8_356:                              #   in Loop: Header=BB8_346 Depth=1
	andi	$a0, $a0, 4
	bnez	$a0, .LBB8_365
# %bb.357:                              #   in Loop: Header=BB8_346 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.12)
	...
	b	.LBB8_370
	.p2align	4, , 16
.LBB8_358:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 12
	ori	$a2, $zero, 1
	move	$a0, $s5
	move	$a3, $s0
	...
	ld.w	$a2, $s4, 216
	bnez	$a2, .LBB8_351
.LBB8_359:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 12
	ori	$a2, $zero, 1
	move	$a0, $s5
	move	$a3, $s0
	...
	ld.w	$a0, $s4, 256
	bnez	$a0, .LBB8_352
.LBB8_360:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 12
	ori	$a2, $zero, 1
	move	$a0, $s5
	move	$a3, $s0
	...
	ld.w	$a0, $s4, 136
	bnez	$a0, .LBB8_353
.LBB8_361:                              #   in Loop: Header=BB8_346 Depth=1
	ld.bu	$a0, $s4, 376
	andi	$a1, $a0, 2
	bnez	$a1, .LBB8_364
# %bb.362:                              #   in Loop: Header=BB8_346 Depth=1
	andi	$a0, $a0, 4
	beqz	$a0, .LBB8_366
# %bb.363:                              #   in Loop: Header=BB8_346 Depth=1
	ld.d	$a0, $fp, 128
	beqz	$a0, .LBB8_366
.LBB8_364:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 15
	ori	$a2, $zero, 1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	b	.LBB8_367
	.p2align	4, , 16
.LBB8_365:                              #   in Loop: Header=BB8_346 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.11)
	...
	bnez	$a0, .LBB8_371
	b	.LBB8_377
.LBB8_366:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 6
	ori	$a2, $zero, 1
	move	$a0, $s3
.LBB8_367:                              #   in Loop: Header=BB8_346 Depth=1
	move	$a3, $s0
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	ld.d	$a2, $fp, 128
	ld.bu	$a0, $s4, 376
	bnez	$a2, .LBB8_356
.LBB8_368:                              #   in Loop: Header=BB8_346 Depth=1
	andi	$a0, $a0, 2
	bnez	$a0, .LBB8_376
# %bb.369:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 6
	ori	$a2, $zero, 1
	move	$a0, $s3
.LBB8_370:                              #   in Loop: Header=BB8_346 Depth=1
	move	$a3, $s0
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s4, 296
	beqz	$a0, .LBB8_377
.LBB8_371:                              #   in Loop: Header=BB8_346 Depth=1
	ld.d	$a0, $s4, 400
	move	$a2, $s2
	beqz	$a0, .LBB8_373
# %bb.372:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
.LBB8_373:                              #   in Loop: Header=BB8_346 Depth=1
	...
	ori	$a1, $zero, 254
	bltu	$a1, $a0, .LBB8_378
.LBB8_374:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a0, $s4, 336
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	ori	$a1, $zero, 255
	bltu	$a0, $a1, .LBB8_382
# %bb.375:                              # %.thread.i.i.i123
                                        #   in Loop: Header=BB8_346 Depth=1
	bstrpick.d	$a0, $a0, 31, 7
	ori	$a1, $zero, 253
	bltu	$a0, $a1, .LBB8_380
	b	.LBB8_381
.LBB8_376:                              #   in Loop: Header=BB8_346 Depth=1
	move	$a0, $s0
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	move	$a2, $s2
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	...
	bnez	$a0, .LBB8_371
	.p2align	4, , 16
.LBB8_377:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 6
	ori	$a2, $zero, 1
	move	$a0, $s3
	move	$a3, $s0
	...
	ori	$a1, $zero, 254
	bgeu	$a1, $a0, .LBB8_374
.LBB8_378:                              #   in Loop: Header=BB8_346 Depth=1
	bstrpick.d	$a0, $a0, 31, 7
	ori	$a1, $zero, 252
	bltu	$a1, $a0, .LBB8_381
# %bb.379:                              # %..thread_crit_edge.i.i.i121
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a0, $s4, 336
	bstrpick.d	$a0, $a0, 31, 7
	ori	$a1, $zero, 253
...
.LBB8_380:                              #   in Loop: Header=BB8_346 Depth=1
	...
	b	.LBB8_382
	.p2align	4, , 16
.LBB8_381:                              # %scanner_size.exit.i.i116
                                        #   in Loop: Header=BB8_346 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.102)
	addi.d	$a2, $a0, %pc_lo12(.L.str.102)
.LBB8_382:                              # %scanner_type.exit.i117
                                        #   in Loop: Header=BB8_346 Depth=1
	move	$a0, $s0
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(fprintf)
	...
	ori	$a1, $zero, 8
	beq	$a0, $a1, .LBB8_387
# %bb.383:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a0, $s4, 296
	beqz	$a0, .LBB8_387
# %bb.384:                              #   in Loop: Header=BB8_346 Depth=1
	ld.d	$a0, $s4, 400
	move	$a2, $s2
	beqz	$a0, .LBB8_386
# %bb.385:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
.LBB8_386:                              #   in Loop: Header=BB8_346 Depth=1
	...
	b	.LBB8_392
	.p2align	4, , 16
.LBB8_387:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 6
	ori	$a2, $zero, 1
	move	$a0, $s3
	move	$a3, $s0
	...
	ori	$a1, $zero, 8
	beq	$a0, $a1, .LBB8_392
.LBB8_388:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a0, $s4, 296
	beqz	$a0, .LBB8_392
# %bb.389:                              #   in Loop: Header=BB8_346 Depth=1
	ld.d	$a0, $s4, 400
	move	$a2, $s2
	beqz	$a0, .LBB8_391
# %bb.390:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
.LBB8_391:                              #   in Loop: Header=BB8_346 Depth=1
	...
	b	.LBB8_344
	.p2align	4, , 16
.LBB8_392:                              #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 18
	ori	$a2, $zero, 1
	...
	ld.d	$a0, $s4, 408
	beqz	$a0, .LBB8_344
.LBB8_393:                              #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str.30)
	addi.d	$a1, $a0, %pc_lo12(.L.str.30)
	move	$a0, $s0
...
# %bb.400:                              # %.lr.ph27.i
	...
	move	$s7, $zero
	.p2align	4, , 16
.LBB8_401:                              # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 56
	ldx.d	$a0, $a0, $s6
	ld.d	$a0, $a0, 24
	pcaddu18i	$ra, %call36(escape_string)
...
# %bb.404:                              # %.lr.ph.i132
	...
	move	$s3, $zero
	.p2align	4, , 16
.LBB8_405:                              # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 208
	ldx.d	$a1, $a1, $s1
	ld.d	$a2, $a1, 0
	ld.w	$a3, $a1, 8
