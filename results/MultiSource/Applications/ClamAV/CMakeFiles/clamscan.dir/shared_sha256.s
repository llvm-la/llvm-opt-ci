...
.LBB4_3:                                # =>This Inner Loop Header: Depth=1
	...
	rotri.w	$a5, $a7, 19
	xor	$a4, $a4, $a5
	bstrpick.d	$a5, $a7, 31, 10
	bstrpick.d	$a5, $a5, 53, 0
	xor	$a4, $a4, $a5
	rotri.w	$a5, $t3, 7
	rotri.w	$s2, $t3, 18
	xor	$a5, $a5, $s2
	...
	rotri.w	$a4, $t8, 19
	xor	$a3, $a3, $a4
	bstrpick.d	$a4, $t8, 31, 10
	xor	$a3, $a3, $a4
	rotri.w	$a4, $t0, 7
	rotri.w	$a5, $t0, 18
	xor	$a4, $a4, $a5
	bstrpick.d	$a5, $t0, 31, 3
	xor	$a4, $a4, $a5
	st.w	$fp, $a1, 32
	ld.w	$a5, $s0, 36
	add.d	$a4, $a4, $s3
