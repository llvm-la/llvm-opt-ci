...
# %bb.926:                              # %.lr.ph1873
	...
	beqz	$a1, .LBB3_961
# %bb.927:                              # %.lr.ph1873.split
	addi.d	$s6, $a1, 4
	move	$s2, $zero
	beqz	$a0, .LBB3_970
# %bb.928:                              # %.lr.ph1873.split.split.preheader
	lu12i.w	$s7, 2
	b	.LBB3_930
	.p2align	4, , 16
.LBB3_929:                              # %html_output_c.exit1605
	...
	ld.d	$s8, $sp, 288                   # 8-byte Folded Reload
	bgeu	$s2, $a0, .LBB3_974
.LBB3_930:                              # %.lr.ph1873.split.split
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a0, $s0, $s2
	ld.d	$a1, $s4, 0
	slli.d	$a2, $a0, 2
...
.LBB3_960:
	...
	jirl	$ra, $ra, 0
	b	.LBB3_978
.LBB3_961:                              # %.lr.ph1873.split.us
	beqz	$a0, .LBB3_974
# %bb.962:                              # %.lr.ph1873.split.us.split.preheader
	move	$s2, $zero
	lu12i.w	$s6, 2
	b	.LBB3_964
	.p2align	4, , 16
.LBB3_963:                              # %html_output_c.exit1605.us
	...
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	bgeu	$s2, $a0, .LBB3_974
.LBB3_964:                              # %.lr.ph1873.split.us.split
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a0, $s0, $s2
	ld.d	$a1, $s4, 0
	slli.d	$a2, $a0, 2
...
.LBB3_969:
	...
	ld.d	$s5, $sp, 336                   # 8-byte Folded Reload
	b	.LBB3_992
.LBB3_970:                              # %.lr.ph1873.split.split.us.preheader
	lu12i.w	$s5, 2
	b	.LBB3_972
	.p2align	4, , 16
.LBB3_971:                              # %html_output_c.exit1605.us1876
	...
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	bgeu	$s2, $a0, .LBB3_974
.LBB3_972:                              # %.lr.ph1873.split.split.us
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a0, $s0, $s2
	ld.d	$a1, $s4, 0
	slli.d	$a2, $a0, 2
