...
.Lfunc_end2:
	.size	html_normalise_mem, .Lfunc_end2-html_normalise_mem
                                        # -- End function
	.p2align	2                               # -- Begin function cli_html_normalise
...
.LBB3_627:                              #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
.LBB3_628:                              # %._crit_edge1799
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_688
# %bb.629:                              # %._crit_edge1799
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	ori	$s0, $zero, 10
	move	$s2, $s1
...
.LBB3_792:                              # %._crit_edge1803
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_917
# %bb.793:                              # %.preheader1674
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a1, $a0, 0
	beqz	$a1, .LBB3_796
.LBB3_794:                              # %.preheader1674
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ori	$a2, $zero, 61
...
# %bb.926:                              # %.lr.ph1875
	...
	beqz	$a1, .LBB3_961
# %bb.927:                              # %.lr.ph1875.split
	addi.d	$s6, $a1, 4
	move	$s2, $zero
	beqz	$a0, .LBB3_970
# %bb.928:                              # %.lr.ph1875.split.split.preheader
	lu12i.w	$s7, 2
	b	.LBB3_930
	.p2align	4, , 16
.LBB3_929:                              # %html_output_c.exit1605
	...
	ld.d	$s8, $sp, 288                   # 8-byte Folded Reload
	bgeu	$s2, $a0, .LBB3_974
.LBB3_930:                              # %.lr.ph1875.split.split
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a0, $s0, $s2
	ld.d	$a1, $s4, 0
	slli.d	$a2, $a0, 2
...
.LBB3_960:
	...
	jirl	$ra, $ra, 0
	b	.LBB3_978
.LBB3_961:                              # %.lr.ph1875.split.us
	beqz	$a0, .LBB3_974
# %bb.962:                              # %.lr.ph1875.split.us.split.preheader
	move	$s2, $zero
	lu12i.w	$s6, 2
	ld.d	$s7, $sp, 344                   # 8-byte Folded Reload
	b	.LBB3_964
...
.LBB3_963:                              # %html_output_c.exit1605.us
	...
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	bgeu	$s2, $a0, .LBB3_974
.LBB3_964:                              # %.lr.ph1875.split.us.split
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a0, $s0, $s2
	ld.d	$a1, $s4, 0
	slli.d	$a2, $a0, 2
...
.LBB3_969:
	...
	ld.d	$s5, $sp, 336                   # 8-byte Folded Reload
	b	.LBB3_992
.LBB3_970:                              # %.lr.ph1875.split.split.us.preheader
	lu12i.w	$s5, 2
	ld.d	$s3, $sp, 336                   # 8-byte Folded Reload
	b	.LBB3_972
	.p2align	4, , 16
.LBB3_971:                              # %html_output_c.exit1605.us1878
	...
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	bgeu	$s2, $a0, .LBB3_974
.LBB3_972:                              # %.lr.ph1875.split.split.us
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a0, $s0, $s2
	ld.d	$a1, $s4, 0
	slli.d	$a2, $a0, 2
...
.LJTI5_0:
	...
	.word	.LBB5_60-.LJTI5_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function html_output_c
...
.Lfunc_end6:
	.size	html_output_c, .Lfunc_end6-html_output_c
                                        # -- End function
	.p2align	2                               # -- Begin function html_tag_contents_append
...
.Lfunc_end7:
	.size	html_tag_contents_append, .Lfunc_end7-html_tag_contents_append
                                        # -- End function
	.p2align	2                               # -- Begin function html_tag_arg_add
...
.Lfunc_end8:
	.size	html_tag_arg_add, .Lfunc_end8-html_tag_arg_add
                                        # -- End function
	.p2align	2                               # -- Begin function html_tag_contents_done
...
.Lfunc_end9:
	.size	html_tag_contents_done, .Lfunc_end9-html_tag_contents_done
                                        # -- End function
	.p2align	2                               # -- Begin function html_tag_arg_value
...
.Lfunc_end10:
	.size	html_tag_arg_value, .Lfunc_end10-html_tag_arg_value
                                        # -- End function
	.p2align	2                               # -- Begin function html_tag_set_inahref
