...
.LBB0_32:                               #   in Loop: Header=BB0_1 Depth=1
	move	$a1, $s7
	move	$s4, $s1
.LBB0_33:                               # %scalar.ph576.preheader
                                        #   in Loop: Header=BB0_1 Depth=1
	move	$t1, $a1
	.p2align	4, , 16
...
.LBB0_57:                               #   in Loop: Header=BB0_1 Depth=1
	move	$s0, $s7
	move	$a1, $s4
.LBB0_58:                               # %scalar.ph596.preheader
                                        #   in Loop: Header=BB0_1 Depth=1
	move	$t1, $s0
	.p2align	4, , 16
.LBB0_59:                               # %scalar.ph596
                                        #   Parent Loop BB0_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$t3, $t5, 0
	addi.d	$t5, $t5, 1
...
.LBB0_72:                               #   in Loop: Header=BB0_1 Depth=1
	...
	move	$a1, $t4
	move	$t3, $s3
.LBB0_73:                               # %scalar.ph556.preheader
                                        #   in Loop: Header=BB0_1 Depth=1
	move	$t1, $s7
	.p2align	4, , 16
.LBB0_74:                               # %scalar.ph556
                                        #   Parent Loop BB0_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$t5, $t3, 0
	addi.d	$t3, $t3, 1
...
.LBB0_79:                               # %vector.body582
	...
	addi.d	$s7, $s7, 64
	bnez	$t3, .LBB0_79
# %bb.80:                               # %middle.block589
                                        #   in Loop: Header=BB0_1 Depth=1
	ld.d	$t1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$t3, $sp, 24                    # 8-byte Folded Reload
	bne	$t1, $t3, .LBB0_33
	b	.LBB0_35
.LBB0_81:                               # %vector.ph598
                                        #   in Loop: Header=BB0_1 Depth=1
	st.d	$s1, $sp, 32                    # 8-byte Folded Spill
	bstrpick.d	$a1, $a1, 31, 0
	addi.d	$a1, $a1, 1
...
.LBB0_88:                               # %.loopexit.sink.split.sink.split
	st.d	$a1, $a0, 48
	lu12i.w	$a1, 3
	ori	$a1, $a1, 3921
.LBB0_89:                               # %.loopexit
