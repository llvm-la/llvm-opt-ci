...
# %bb.44:
	addi.w	$a0, $zero, -1748
	blt	$fp, $a0, .LBB0_57
# %bb.45:                               # %.preheader639.preheader
	lu12i.w	$a0, 2
	ori	$a0, $a0, 2284
	add.d	$s6, $s8, $a0
	addi.d	$fp, $s8, 1748
	ori	$s1, $zero, 417
.LBB0_46:                               # %.preheader639
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a0, $fp, 0
	andi	$a1, $s1, 255
	addi.d	$a3, $sp, 84
...
# %bb.95:
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_104
# %bb.96:                               # %.lr.ph697.split.preheader
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
.LBB0_97:                               # %.lr.ph697.split
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
# %bb.103:                              #   in Loop: Header=BB0_102 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB0_101
.LBB0_104:                              # %._crit_edge698
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_26
.LBB0_105:                              # %.lr.ph693.peel.next.preheader
	add.d	$fp, $s4, $fp
	addi.d	$s1, $s0, -1
	addi.d	$s5, $s3, 48
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
...
.Lfunc_end0:
	.size	unspin, .Lfunc_end0-unspin
                                        # -- End function
	.p2align	2                               # -- Begin function summit
...
.Lfunc_end1:
	.size	summit, .Lfunc_end1-summit
                                        # -- End function
	.p2align	2                               # -- Begin function exec86
