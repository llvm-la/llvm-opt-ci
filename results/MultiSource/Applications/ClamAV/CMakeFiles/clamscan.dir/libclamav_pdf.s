...
.LBB0_57:                               #   in Loop: Header=BB0_58 Depth=2
	...
	move	$s7, $a0
	beqz	$a0, .LBB0_82
.LBB0_58:                               #   Parent Loop BB0_44 Depth=1
...
.LBB0_65:                               #   in Loop: Header=BB0_58 Depth=2
	...
	add.d	$s0, $a2, $s7
	.p2align	4, , 16
.LBB0_66:                               #   Parent Loop BB0_44 Depth=1
...
.LBB0_72:                               #   in Loop: Header=BB0_58 Depth=2
	...
	st.d	$a0, $sp, 72                    # 8-byte Folded Spill
	addi.d	$s8, $s7, 9
.LBB0_73:                               #   Parent Loop BB0_44 Depth=1
                                        #     Parent Loop BB0_58 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.b	$a0, $s8, 2
	slli.d	$a0, $a0, 1
...
.LBB0_82:                               #   in Loop: Header=BB0_44 Depth=1
	...
	beqz	$a0, .LBB0_86
# %bb.83:                               #   in Loop: Header=BB0_44 Depth=1
...
.LBB0_85:                               #   in Loop: Header=BB0_44 Depth=1
	...
	b	.LBB0_111
.LBB0_86:                               #   in Loop: Header=BB0_44 Depth=1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	addi.w	$a1, $a0, 0
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_90
# %bb.87:                               #   in Loop: Header=BB0_44 Depth=1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	bnez	$a0, .LBB0_89
# %bb.88:                               #   in Loop: Header=BB0_44 Depth=1
...
# %bb.91:                               #   in Loop: Header=BB0_44 Depth=1
	...
	move	$s7, $a0
	bnez	$a0, .LBB0_93
# %bb.92:                               #   in Loop: Header=BB0_44 Depth=1
...
# %bb.94:                               #   in Loop: Header=BB0_44 Depth=1
	...
	ori	$a1, $zero, 13
	beq	$a2, $a1, .LBB0_96
# %bb.95:                               #   in Loop: Header=BB0_44 Depth=1
	ori	$a1, $zero, 10
	bne	$a2, $a1, .LBB0_99
...
.LBB0_99:                               #   in Loop: Header=BB0_44 Depth=1
	bgeu	$s6, $s7, .LBB0_109
# %bb.100:                              #   in Loop: Header=BB0_44 Depth=1
	st.d	$a0, $sp, 136                   # 8-byte Folded Spill
	sub.w	$s4, $s7, $s6
...
.LBB0_102:                              #   in Loop: Header=BB0_44 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$s7, .LBB0_114
# %bb.103:                              #   in Loop: Header=BB0_44 Depth=1
	alsl.d	$a0, $s4, $s4, 2
	pcaddu18i	$ra, %call36(cli_malloc)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_147
# %bb.104:                              #   in Loop: Header=BB0_44 Depth=1
	move	$s8, $a0
	move	$a0, $s6
	move	$a1, $s4
	move	$a2, $s8
...
# %bb.107:                              #   in Loop: Header=BB0_44 Depth=1
	...
	beqz	$a0, .LBB0_118
# %bb.108:                              #   in Loop: Header=BB0_44 Depth=1
	move	$a0, $s4
	move	$a1, $s7
	move	$a2, $s7
...
.LBB0_114:                              #   in Loop: Header=BB0_44 Depth=1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	beqz	$a0, .LBB0_117
# %bb.115:                              #   in Loop: Header=BB0_44 Depth=1
	move	$a0, $s6
...
.LBB0_116:                              #   in Loop: Header=BB0_44 Depth=1
	move	$s4, $s8
	b	.LBB0_119
.LBB0_117:                              #   in Loop: Header=BB0_44 Depth=1
...
.LBB0_122:                              #   in Loop: Header=BB0_44 Depth=1
	...
	jirl	$ra, $ra, 0
.LBB0_123:                              #   in Loop: Header=BB0_44 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	addi.w	$s0, $s0, 1
...
.Lfunc_end0:
	.size	cli_pdf, .Lfunc_end0-cli_pdf
                                        # -- End function
	.p2align	2                               # -- Begin function cli_pmemstr
...
.Lfunc_end1:
	.size	cli_pmemstr, .Lfunc_end1-cli_pmemstr
                                        # -- End function
	.p2align	2                               # -- Begin function pdf_nextobject
...
.LBB2_21:
	move	$a0, $zero
.LBB2_22:                               # %pdf_nextlinestart.exit.thread
	ret
.Lfunc_end2:
...
.LJTI2_0:
	...
	.word	.LBB2_4-.LJTI2_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function pdf_nextlinestart
...
# %bb.44:
	...
	move	$a2, $s8
	b	.LBB4_54
.LBB4_45:                               # %vector.main.loop.iter.check222
	addi.d	$a1, $s1, -1
...
# %bb.46:
	move	$a4, $zero
	b	.LBB4_51
.LBB4_47:                               # %vector.ph224
	andi	$a5, $a1, 24
	bstrpick.d	$a2, $a1, 31, 5
	pcalau12i	$a4, %pc_hi20(.LCPI4_0)
	xvld	$xr2, $a4, %pc_lo12(.LCPI4_0)
	pcalau12i	$a4, %pc_hi20(.LCPI4_1)
	xvld	$xr3, $a4, %pc_lo12(.LCPI4_1)
	pcalau12i	$a4, %pc_hi20(.LCPI4_2)
	xvld	$xr4, $a4, %pc_lo12(.LCPI4_2)
	xvld	$xr5, $a3, %pc_lo12(.LCPI4_3)
	pcalau12i	$a4, %pc_hi20(.LCPI4_4)
	xvld	$xr6, $a4, %pc_lo12(.LCPI4_4)
	slli.d	$a4, $a2, 5
	add.d	$a2, $s8, $a4
	xvrepli.w	$xr7, 32
	move	$a6, $s8
	move	$a7, $a4
.LBB4_48:                               # %vector.body227
                                        # =>This Inner Loop Header: Depth=1
	xvslli.w	$xr8, $xr3, 3
	xvslli.w	$xr9, $xr2, 3
	xvslli.w	$xr10, $xr5, 3
	xvslli.w	$xr11, $xr4, 3
	xvsub.w	$xr11, $xr1, $xr11
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_48
# %bb.49:                               # %middle.block230
	beq	$a4, $a1, .LBB4_56
# %bb.50:                               # %vec.epilog.iter.check236
	beqz	$a5, .LBB4_54
.LBB4_51:                               # %vec.epilog.ph238
	...
	sub.d	$a5, $a4, $a3
	add.d	$a4, $s8, $a4
.LBB4_52:                               # %vec.epilog.vector.body245
                                        # =>This Inner Loop Header: Depth=1
	xvslli.w	$xr3, $xr2, 3
	xvsub.w	$xr3, $xr1, $xr3
	xvsrl.w	$xr3, $xr0, $xr3
	...
	addi.d	$a4, $a4, 8
	bnez	$a5, .LBB4_52
# %bb.53:                               # %vec.epilog.middle.block251
	move	$a4, $a3
	beq	$a3, $a1, .LBB4_56
...
.Lfunc_end4:
	.size	ascii85decode, .Lfunc_end4-ascii85decode
                                        # -- End function
	.p2align	2                               # -- Begin function try_flatedecode
...
.Lfunc_end5:
	.size	try_flatedecode, .Lfunc_end5-try_flatedecode
                                        # -- End function
	.p2align	2                               # -- Begin function flatedecode
