...
# %bb.41:
	move	$a2, $zero
	b	.LBB4_52
.LBB4_42:                               # %vector.main.loop.iter.check
...
.LBB4_44:                               # %vector.ph219
	...
	vld	$vr5, $a3, %pc_lo12(.LCPI4_3)
	bstrpick.d	$a2, $a1, 32, 4
	slli.d	$a2, $a2, 4
	move	$a4, $fp
	move	$a5, $a2
.LBB4_45:                               # %vector.body222
                                        # =>This Inner Loop Header: Depth=1
	vslli.w	$vr6, $vr3, 3
	vslli.w	$vr7, $vr2, 3
	vslli.w	$vr8, $vr5, 3
...
.LBB4_48:                               # %vec.epilog.ph
	...
	slli.d	$a4, $a4, 2
	vld	$vr3, $a3, %pc_lo12(.LCPI4_3)
	vreplgr2vr.w	$vr4, $a2
	pcalau12i	$a3, %pc_hi20(.LCPI4_4)
	vld	$vr2, $a3, %pc_lo12(.LCPI4_4)
	vadd.w	$vr3, $vr4, $vr3
	sub.d	$a3, $a2, $a4
	add.d	$a2, $fp, $a2
	.p2align	4, , 16
