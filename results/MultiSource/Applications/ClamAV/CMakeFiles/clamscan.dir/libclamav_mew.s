...
# %bb.11:                               #   in Loop: Header=BB0_10 Depth=1
	...
	move	$s7, $t5
	.p2align	4, , 16
.LBB0_12:                               # %thread-pre-split.us.us868
...
.LBB0_15:                               # %.split.us.split.split.us.us
	...
	ld.w	$s5, $t4, 0
	beqz	$s5, .LBB0_250
# %bb.16:                               # %.preheader620.us.us.us
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.w	$a1, $t4, 4
	ld.wu	$a2, $t4, 8
	move	$a6, $t0
	.p2align	4, , 16
.LBB0_17:                               # %vector.body1243
                                        #   Parent Loop BB0_10 Depth=1
...
.LBB0_64:                               # %.lr.ph839.us
	...
	add.d	$a6, $a5, $a0
	.p2align	4, , 16
.LBB0_65:                               #   Parent Loop BB0_10 Depth=1
...
.LBB0_73:                               #   in Loop: Header=BB0_65 Depth=3
	move	$a5, $a0
	move	$t0, $t3
.LBB0_74:                               # %lzma_486248.exit69.i.us
...
# %bb.85:                               #   in Loop: Header=BB0_82 Depth=3
	...
	b	.LBB0_87
	.p2align	4, , 16
.LBB0_86:                               #   in Loop: Header=BB0_82 Depth=3
	sub.w	$a1, $a1, $t0
	sub.w	$t0, $a6, $t0
	st.w	$a1, $sp, 292
...
.LBB0_87:                               #   in Loop: Header=BB0_82 Depth=3
	...
	st.w	$a6, $a7, 0
	bnez	$t1, .LBB0_89
# %bb.88:                               #   in Loop: Header=BB0_82 Depth=3
	ld.bu	$a3, $a3, 0
	slli.w	$a1, $a1, 8
	or	$a1, $a1, $a3
	slli.d	$a6, $t0, 8
...
.LBB0_90:                               #   in Loop: Header=BB0_82 Depth=3
	addi.w	$a7, $a0, 0
	bgeu	$a7, $t7, .LBB0_76
# %bb.91:                               #   in Loop: Header=BB0_82 Depth=3
	slli.d	$a0, $a0, 1
	addi.w	$a5, $a0, 0
	add.d	$t0, $a4, $a5
	add.d	$a7, $a2, $a5
...
# %bb.94:                               #   in Loop: Header=BB0_20 Depth=2
	...
	st.w	$t1, $sp, 276
	bltu	$t0, $t2, .LBB0_101
.LBB0_95:                               #   in Loop: Header=BB0_20 Depth=2
...
# %bb.97:                               #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a4, $a3, 1
	bltu	$t6, $a4, .LBB0_249
# %bb.98:                               #   in Loop: Header=BB0_20 Depth=2
	ld.wu	$t2, $a2, 432
...
# %bb.103:                              #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a2, $a3, 1
	bltu	$t6, $a2, .LBB0_249
# %bb.104:                              #   in Loop: Header=BB0_20 Depth=2
	ld.wu	$t0, $a4, 0
...
# %bb.105:                              #   in Loop: Header=BB0_20 Depth=2
	...
	move	$t1, $a1
	b	.LBB0_173
.LBB0_106:                              #   in Loop: Header=BB0_20 Depth=2
	sub.w	$a2, $a2, $t0
	sub.w	$t0, $a7, $t0
	st.w	$a2, $sp, 292
...
.LBB0_109:                              #   in Loop: Header=BB0_20 Depth=2
	move	$a5, $a6
.LBB0_110:                              # %lzma_486248.exit.i.us
                                        #   in Loop: Header=BB0_20 Depth=2
	add.d	$a6, $a4, $a7
	bltu	$ra, $a6, .LBB0_251
...
.LBB0_118:                              #   in Loop: Header=BB0_20 Depth=2
	move	$a6, $a5
.LBB0_119:                              # %lzma_486248.exit.i.us.1
                                        #   in Loop: Header=BB0_20 Depth=2
	alsl.d	$a5, $t0, $a4, 1
	bltu	$ra, $a5, .LBB0_251
...
.LBB0_127:                              #   in Loop: Header=BB0_20 Depth=2
	move	$a5, $a6
.LBB0_128:                              # %lzma_486248.exit.i.us.2
                                        #   in Loop: Header=BB0_20 Depth=2
	alsl.d	$a6, $t0, $a4, 1
	bltu	$ra, $a6, .LBB0_251
...
.LBB0_136:                              #   in Loop: Header=BB0_20 Depth=2
	move	$a6, $a5
.LBB0_137:                              # %lzma_486248.exit.i.us.3
                                        #   in Loop: Header=BB0_20 Depth=2
	alsl.d	$a5, $a7, $a4, 1
	bltu	$ra, $a5, .LBB0_251
...
.LBB0_145:                              #   in Loop: Header=BB0_20 Depth=2
	move	$a5, $a6
.LBB0_146:                              # %lzma_486248.exit.i.us.4
                                        #   in Loop: Header=BB0_20 Depth=2
	alsl.d	$a4, $t1, $a4, 1
	bltu	$ra, $a4, .LBB0_251
...
.LBB0_154:                              #   in Loop: Header=BB0_20 Depth=2
	move	$a4, $a5
.LBB0_155:                              # %lzma_486248.exit.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	st.d	$t0, $sp, 264
	ori	$a5, $zero, 64
	st.w	$a5, $sp, 272
	...
	ori	$a5, $zero, 68
	bge	$a6, $a5, .LBB0_157
.LBB0_156:                              #   in Loop: Header=BB0_20 Depth=2
	addi.w	$t1, $a7, 1
	b	.LBB0_200
.LBB0_157:                              #   in Loop: Header=BB0_20 Depth=2
	bstrpick.d	$t0, $a7, 31, 1
	addi.d	$t1, $t0, -1
	move	$a5, $a6
	ori	$t2, $zero, 1
	bstrins.d	$a5, $t2, 63, 1
	sll.w	$a5, $a5, $t1
	ori	$t2, $zero, 77
	bge	$t2, $a6, .LBB0_183
# %bb.158:                              # %.preheader.i472.preheader.us
                                        #   in Loop: Header=BB0_20 Depth=2
	move	$a6, $zero
	addi.d	$a7, $t0, -5
	st.w	$a7, $sp, 272
...
# %bb.163:                              #   in Loop: Header=BB0_161 Depth=3
	...
	bgeu	$t6, $t1, .LBB0_159
	b	.LBB0_251
.LBB0_164:                              #   in Loop: Header=BB0_20 Depth=2
	sub.w	$a7, $a1, $t0
	sub.w	$t0, $a6, $t0
	st.w	$a7, $sp, 292
	bstrpick.d	$a6, $t3, 31, 5
...
# %bb.166:                              #   in Loop: Header=BB0_20 Depth=2
	...
	st.w	$a6, $sp, 276
	bltu	$a1, $t1, .LBB0_181
.LBB0_167:                              #   in Loop: Header=BB0_20 Depth=2
...
# %bb.169:                              #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a1, $a4, 1
	bltu	$t6, $a1, .LBB0_249
# %bb.170:                              #   in Loop: Header=BB0_20 Depth=2
	ld.wu	$a6, $a2, 456
	...
	addi.w	$a3, $a5, 0
	bgeu	$a7, $a3, .LBB0_193
# %bb.171:                              #   in Loop: Header=BB0_20 Depth=2
	sub.d	$t0, $t8, $t2
	bstrpick.d	$t0, $t0, 31, 5
	add.w	$t0, $t0, $a6
	move	$t1, $a7
	b	.LBB0_194
.LBB0_172:                              #   in Loop: Header=BB0_20 Depth=2
	sub.d	$t1, $a1, $a7
	sub.w	$a7, $a6, $a7
	st.w	$t1, $sp, 292
	bstrpick.d	$a6, $t2, 31, 5
...
# %bb.174:                              #   in Loop: Header=BB0_20 Depth=2
	...
	st.w	$a4, $sp, 288
	st.d	$a2, $sp, 280
.LBB0_175:                              # %lzma_486248.exit532.us
                                        #   in Loop: Header=BB0_20 Depth=2
	st.w	$a6, $sp, 276
	bgeu	$a1, $a5, .LBB0_182
...
.LBB0_182:                              #   in Loop: Header=BB0_20 Depth=2
	...
	b	.LBB0_198
.LBB0_183:                              #   in Loop: Header=BB0_20 Depth=2
	sub.d	$a6, $a5, $a7
	slli.d	$a6, $a6, 1
...
.LBB0_184:                              # %.preheader.i557.us
	...
	b	.LBB0_77
	.p2align	4, , 16
.LBB0_185:                              # %lzma_486248.exit80.i.us
                                        #   in Loop: Header=BB0_186 Depth=3
	addi.w	$a3, $a0, 0
	move	$t0, $a6
	bgeu	$a3, $t7, .LBB0_76
.LBB0_186:                              # %.lr.ph92.i.us
                                        #   Parent Loop BB0_10 Depth=1
                                        #     Parent Loop BB0_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bltu	$a4, $s2, .LBB0_249
...
.LBB0_190:                              #   in Loop: Header=BB0_186 Depth=3
	...
	sub.w	$t0, $a7, $t0
	ori	$a0, $a0, 1
.LBB0_191:                              #   in Loop: Header=BB0_186 Depth=3
	srli.d	$a7, $a7, 16
	...
	st.w	$t0, $a5, 0
	bnez	$a7, .LBB0_185
# %bb.192:                              #   in Loop: Header=BB0_186 Depth=3
	ld.bu	$a4, $a4, 0
	slli.w	$a1, $a1, 8
	or	$a1, $a1, $a4
	slli.d	$a6, $a6, 8
...
.LBB0_194:                              #   in Loop: Header=BB0_20 Depth=2
	...
	st.w	$t0, $a2, 456
	bnez	$a6, .LBB0_196
# %bb.195:                              #   in Loop: Header=BB0_20 Depth=2
	st.d	$a4, $sp, 264
	ld.bu	$a2, $a4, 0
	slli.d	$a4, $t1, 8
	or	$a2, $a4, $a2
	...
	st.w	$a4, $sp, 288
	st.d	$a1, $sp, 280
.LBB0_196:                              # %lzma_486248.exit521.us
                                        #   in Loop: Header=BB0_20 Depth=2
	sltu	$a1, $a7, $a3
	masknez	$a2, $t3, $a1
	maskeqz	$a3, $t2, $a1
...
.LBB0_198:                              #   in Loop: Header=BB0_20 Depth=2
	...
	move	$a0, $a2
	beq	$a1, $a2, .LBB0_251
# %bb.199:                              #   in Loop: Header=BB0_20 Depth=2
	ld.w	$a1, $sp, 276
	ori	$a0, $zero, 6
...
# %bb.206:                              #   in Loop: Header=BB0_20 Depth=2
	or	$a5, $a5, $s0
	beqz	$a5, .LBB0_249
.LBB0_207:                              #   in Loop: Header=BB0_20 Depth=2
	beq	$s5, $s3, .LBB0_249
...
# %bb.211:                              #   in Loop: Header=BB0_20 Depth=2
	...
	bltu	$ra, $a5, .LBB0_249
# %bb.212:                              # %.preheader614.us.preheader
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$a5, $s3, 1
	sltu	$a6, $a5, $s5
	masknez	$a5, $a5, $a6
	...
	ori	$a7, $zero, 16
	bgeu	$a3, $a7, .LBB0_217
.LBB0_213:                              # %.preheader614.us.preheader1262
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$a3, $a0, -1
	move	$a1, $s3
	.p2align	4, , 16
.LBB0_214:                              # %.preheader614.us
                                        #   Parent Loop BB0_10 Depth=1
                                        #     Parent Loop BB0_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
...
.LBB0_234:                              #   in Loop: Header=BB0_232 Depth=3
	...
	ori	$t5, $zero, 1
	ori	$t8, $zero, 2048
.LBB0_235:                              #   in Loop: Header=BB0_232 Depth=3
	srli.d	$t7, $t7, 16
	...
	st.w	$a3, $t3, 0
	bnez	$t7, .LBB0_237
# %bb.236:                              #   in Loop: Header=BB0_232 Depth=3
	ld.bu	$a3, $a4, 0
	slli.w	$a2, $a2, 8
	or	$a2, $a2, $a3
	slli.d	$a3, $t6, 8
...
.LBB0_237:                              #   in Loop: Header=BB0_232 Depth=3
	move	$a3, $t6
	move	$t2, $t3
.LBB0_238:                              # %lzma_486248.exit.i488.us
	...
	ori	$t7, $zero, 256
	beq	$t1, $t0, .LBB0_243
# %bb.239:                              #   in Loop: Header=BB0_232 Depth=3
	slli.d	$t4, $t3, 1
	bstrpick.d	$t2, $t4, 31, 1
	alsl.d	$t3, $t2, $a6, 1
	bltu	$t3, $s2, .LBB0_251
# %bb.240:                              #   in Loop: Header=BB0_232 Depth=3
	addi.d	$t2, $t3, 4
	bltu	$t6, $t2, .LBB0_251
# %bb.241:                              #   in Loop: Header=BB0_232 Depth=3
	bltu	$a4, $s2, .LBB0_251
# %bb.242:                              #   in Loop: Header=BB0_232 Depth=3
	addi.d	$t2, $a4, 1
	addi.w	$t0, $t0, 1
	bgeu	$t6, $t2, .LBB0_232
	b	.LBB0_251
...
.LBB0_250:
	move	$a0, $zero
.LBB0_251:                              # %lzma_4862e0.exit.thread
...
.Lfunc_end0:
	.size	mew_lzma, .Lfunc_end0-mew_lzma
                                        # -- End function
	.p2align	2                               # -- Begin function lzma_4863da
...
# %bb.45:
	...
	st.w	$t2, $a1, 8
	st.d	$t1, $a1, 0
.LBB1_46:                               # %lzma_486248.exit.i88
	add.d	$t1, $a7, $t0
	st.d	$t1, $a2, 0
	bltu	$t1, $a5, .LBB1_2
# %bb.47:                               # %lzma_486248.exit.i88
	addi.d	$t3, $t1, 4
	bltu	$a6, $t3, .LBB1_2
# %bb.48:
	ld.d	$t3, $a1, 0
...
# %bb.55:
	...
	st.w	$t1, $a1, 8
	st.d	$t2, $a1, 0
.LBB1_56:                               # %lzma_486248.exit.i88.1
	alsl.d	$a7, $t0, $a7, 1
	st.d	$a7, $a2, 0
	bltu	$a7, $a5, .LBB1_2
# %bb.57:                               # %lzma_486248.exit.i88.1
	addi.d	$t2, $a7, 4
	bltu	$a6, $t2, .LBB1_2
# %bb.58:
	ld.d	$t2, $a1, 0
...
# %bb.64:
	...
	st.w	$t2, $a1, 8
	st.d	$t1, $a1, 0
.LBB1_65:                               # %lzma_486248.exit.i68
	add.d	$t1, $t0, $a7
	st.d	$t1, $a2, 0
	bltu	$t1, $a5, .LBB1_2
# %bb.66:                               # %lzma_486248.exit.i68
	addi.d	$t3, $t1, 4
	bltu	$a6, $t3, .LBB1_2
# %bb.67:
	ld.d	$t3, $a1, 0
...
# %bb.73:
	...
	st.w	$a2, $a1, 8
	st.d	$a6, $a1, 0
.LBB1_74:                               # %lzma_486248.exit.i88.2
	ori	$a1, $zero, 8
	st.w	$a1, $a3, 0
	addi.d	$a5, $a0, -8
	move	$a0, $zero
...
# %bb.77:
	...
	st.w	$t1, $a1, 8
	st.d	$t2, $a1, 0
.LBB1_78:                               # %lzma_486248.exit.i68.1
	alsl.d	$t0, $a7, $t0, 1
	st.d	$t0, $a2, 0
	bltu	$t0, $a5, .LBB1_2
# %bb.79:                               # %lzma_486248.exit.i68.1
	addi.d	$t2, $t0, 4
	bltu	$a6, $t2, .LBB1_2
# %bb.80:
	ld.d	$t2, $a1, 0
...
# %bb.86:
	...
	st.w	$a0, $a1, 8
	st.d	$a6, $a1, 0
.LBB1_87:                               # %lzma_486248.exit.i68.2
	ori	$a0, $zero, 8
	st.w	$a0, $a3, 0
	move	$a0, $zero
	st.w	$a5, $a4, 0
...
# %bb.35:
	...
	ld.w	$a1, $a2, 0
	beqz	$a1, .LBB5_46
# %bb.36:                               # %.outer.us353.preheader409
	sub.d	$a1, $s2, $s7
	add.w	$a2, $s1, $a1
	sub.d	$a1, $s5, $s3
	add.w	$s1, $s4, $a1
