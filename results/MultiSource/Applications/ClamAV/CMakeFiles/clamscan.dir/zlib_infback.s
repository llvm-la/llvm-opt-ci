...
.LBB1_50:                               #   in Loop: Header=BB1_6 Depth=1
	ori	$a4, $zero, 19
.LBB1_51:                               # %.lr.ph872.preheader1570
                                        #   in Loop: Header=BB1_6 Depth=1
	alsl.d	$a1, $a0, $a1, 1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
...
# %bb.103:                              # %iter.check1537
	...
	ori	$a3, $zero, 4
	bltu	$a4, $a3, .LBB1_107
# %bb.104:                              # %iter.check1537
                                        #   in Loop: Header=BB1_72 Depth=2
	sub.d	$a3, $zero, $a4
	bltu	$a3, $a6, .LBB1_107
# %bb.105:                              # %vector.main.loop.iter.check1525
                                        #   in Loop: Header=BB1_72 Depth=2
	ori	$a3, $zero, 16
	bgeu	$a4, $a3, .LBB1_108
# %bb.106:                              #   in Loop: Header=BB1_72 Depth=2
	move	$a7, $zero
	b	.LBB1_112
.LBB1_107:                              #   in Loop: Header=BB1_72 Depth=2
	move	$a5, $a4
	move	$a3, $a6
	b	.LBB1_115
.LBB1_108:                              # %vector.ph1527
                                        #   in Loop: Header=BB1_72 Depth=2
	andi	$t0, $a4, 12
	andi	$a7, $a4, 240
	andi	$a5, $a4, 15
...
.LBB1_109:                              # %vector.body1530
	...
	addi.w	$t1, $t1, 16
	bnez	$t2, .LBB1_109
# %bb.110:                              # %middle.block1533
                                        #   in Loop: Header=BB1_72 Depth=2
	beq	$a4, $a7, .LBB1_116
# %bb.111:                              # %vec.epilog.iter.check1539
                                        #   in Loop: Header=BB1_72 Depth=2
	beqz	$t0, .LBB1_115
.LBB1_112:                              # %vec.epilog.ph1541
                                        #   in Loop: Header=BB1_72 Depth=2
	andi	$t0, $a4, 252
	andi	$a5, $a4, 3
	add.w	$a3, $a6, $t0
	...
	add.w	$a6, $a7, $a6
	.p2align	4, , 16
.LBB1_113:                              # %vec.epilog.vector.body1546
                                        #   Parent Loop BB1_6 Depth=1
                                        #     Parent Loop BB1_72 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	addi.w	$a6, $a6, 4
	bnez	$t1, .LBB1_113
# %bb.114:                              # %vec.epilog.middle.block1549
                                        #   in Loop: Header=BB1_72 Depth=2
	beq	$a4, $t0, .LBB1_116
	.p2align	4, , 16
.LBB1_115:                              # %.preheader
...
# %bb.130:                              # %.preheader690
	...
	addi.w	$s3, $s6, 0
	bgeu	$s3, $a4, .LBB1_140
# %bb.131:                              # %.lr.ph951.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	nor	$s4, $a3, $zero
	b	.LBB1_138
	.p2align	4, , 16
.LBB1_132:                              # %._crit_edge1247
...
# %bb.194:                              # %iter.check
	...
	ori	$a5, $zero, 32
	bltu	$a3, $a5, .LBB1_197
# %bb.195:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB1_189 Depth=2
...
# %bb.196:                              #   in Loop: Header=BB1_189 Depth=2
	move	$a6, $zero
	b	.LBB1_202
.LBB1_197:                              #   in Loop: Header=BB1_189 Depth=2
	move	$s7, $s2
	move	$a1, $a0
	move	$a3, $a4
	b	.LBB1_205
...
# %bb.200:                              # %middle.block
                                        #   in Loop: Header=BB1_189 Depth=2
	beq	$a5, $a6, .LBB1_188
# %bb.201:                              # %vec.epilog.iter.check
                                        #   in Loop: Header=BB1_189 Depth=2
	beqz	$a7, .LBB1_205
.LBB1_202:                              # %vec.epilog.ph
                                        #   in Loop: Header=BB1_189 Depth=2
	bstrpick.d	$a3, $a5, 32, 3
	slli.d	$a7, $a3, 3
	alsl.d	$s7, $a3, $s2, 3
	sub.d	$a1, $a0, $a7
	alsl.d	$a3, $a3, $a4, 3
	...
	add.d	$a6, $s2, $a6
	.p2align	4, , 16
.LBB1_203:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB1_6 Depth=1
                                        #     Parent Loop BB1_189 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$t0, $a6, $a2
	...
	addi.d	$a6, $a6, 8
	bnez	$a4, .LBB1_203
# %bb.204:                              # %vec.epilog.middle.block
                                        #   in Loop: Header=BB1_189 Depth=2
	beq	$a5, $a7, .LBB1_188
	.p2align	4, , 16
.LBB1_205:                              # %vec.epilog.scalar.ph
                                        #   Parent Loop BB1_6 Depth=1
                                        #     Parent Loop BB1_189 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.b	$a2, $a3, 0
...
.LBB1_208:                              # %.split1037
	move	$s5, $zero
	st.d	$zero, $sp, 128
.LBB1_209:                              # %.loopexit684
	addi.w	$s3, $zero, -5
.LBB1_210:                              # %.loopexit684
	ld.d	$a0, $sp, 128
	st.d	$a0, $s4, 0
	st.w	$s5, $s4, 8
.LBB1_211:
...
.LBB1_212:
	...
	ld.d	$s4, $sp, 8                     # 8-byte Folded Reload
	b	.LBB1_210
.LBB1_213:                              # %.loopexit684.loopexit1571
	addi.w	$s3, $zero, -3
	b	.LBB1_210
.LBB1_214:
	ld.w	$a0, $s0, 60
