...
# %bb.316:                              #   in Loop: Header=BB0_315 Depth=2
	bne	$a3, $s0, .LBB0_313
	b	.LBB0_318
.LBB0_317:                              # %.loopexit3346.loopexit
                                        #   in Loop: Header=BB0_302 Depth=1
	addi.w	$a1, $s8, 1
	move	$a0, $s8
	move	$s8, $a1
.LBB0_318:                              # %.loopexit3346
                                        #   in Loop: Header=BB0_302 Depth=1
	bstrpick.d	$a0, $a0, 31, 0
	slli.d	$a0, $a0, 2
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
...
.LBB0_336:                              # %.critedge81
	...
	and	$a0, $a0, $a1
	beqz	$a0, .LBB0_360
# %bb.337:                              # %.preheader3345
	move	$s8, $zero
	addi.d	$a0, $s2, -1
	beqz	$a0, .LBB0_360
# %bb.338:                              # %.lr.ph3439.preheader
	move	$s3, $zero
	bstrpick.d	$a1, $a0, 31, 0
	ori	$a2, $zero, 36
	mul.d	$a1, $a1, $a2
...
# %bb.572:
	...
	bgeu	$s2, $a1, .LBB0_522
	b	.LBB0_528
.LBB0_573:                              # %vector.main.loop.iter.check3985
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB0_605
# %bb.574:
	move	$a0, $zero
...
# %bb.594:
	...
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	bne	$a0, $a2, .LBB0_751
# %bb.595:                              # %.preheader3343
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 72                    # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_655
# %bb.596:                              # %.lr.ph3443.preheader
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	addi.d	$a0, $a0, 8
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	ori	$s3, $zero, 12
...
# %bb.599:                              #   in Loop: Header=BB0_597 Depth=1
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s4, 0
.LBB0_600:                              #   in Loop: Header=BB0_597 Depth=1
...
# %bb.601:                              #   in Loop: Header=BB0_597 Depth=1
	...
	sub.w	$a1, $a1, $a0
	bgeu	$a1, $a2, .LBB0_839
# %bb.602:                              #   in Loop: Header=BB0_597 Depth=1
	addi.w	$s3, $s3, 4
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	bltu	$s3, $a1, .LBB0_597
	b	.LBB0_655
...
# %bb.607:                              # %middle.block3995
	...
	beq	$a0, $s2, .LBB0_614
# %bb.608:                              # %vec.epilog.iter.check4002
	beqz	$a1, .LBB0_612
.LBB0_609:                              # %vec.epilog.ph4004
	move	$a2, $a0
	andi	$a0, $s2, 124
	vreplgr2vr.w	$vr0, $s0
	sub.d	$a1, $a2, $a0
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_610:                              # %vec.epilog.vector.body4009
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_610
# %bb.611:                              # %vec.epilog.middle.block4013
	vbsrl.v	$vr1, $vr0, 8
	vmax.wu	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.wu	$vr0, $vr1, $vr0
...
# %bb.621:
	...
	move	$s7, $s2
	b	.LBB0_623
.LBB0_622:                              #   in Loop: Header=BB0_623 Depth=1
	addi.w	$s7, $s7, -1
	addi.d	$s4, $s4, -1
	addi.d	$s6, $s6, 36
	beqz	$s4, .LBB0_662
.LBB0_623:                              # %.lr.ph3476
	...
	ld.w	$a0, $s6, 12
	beqz	$a0, .LBB0_622
# %bb.624:                              #   in Loop: Header=BB0_623 Depth=1
	move	$a0, $s1
	move	$a1, $s6
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_628
# %bb.625:                              #   in Loop: Header=BB0_623 Depth=1
	ld.wu	$a0, $s6, 12
	addi.w	$a1, $a0, -1
	bgeu	$a1, $s0, .LBB0_628
# %bb.626:                              #   in Loop: Header=BB0_623 Depth=1
	ld.wu	$a1, $s6, 0
	add.d	$a2, $a1, $a0
	bltu	$s3, $a2, .LBB0_628
# %bb.627:                              #   in Loop: Header=BB0_623 Depth=1
	addi.w	$a2, $a0, 0
	add.d	$a1, $s5, $a1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(cli_readn)
...
# %bb.629:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_630:                              # %.critedge200.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_631:                              # %.critedge200
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_638
...
.LBB0_661:                              # %.critedge3021
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_662:                              # %._crit_edge3477.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_685
...
.LBB0_725:
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_726:                              # %vector.main.loop.iter.check
	ori	$a2, $zero, 17
	bgeu	$s2, $a2, .LBB0_771
# %bb.727:
	move	$a2, $zero
	b	.LBB0_775
.LBB0_728:                              # %._crit_edge3588
	ld.w	$a0, $sp, 216
.LBB0_729:                              # %.thread3819
	add.d	$a0, $a0, $s6
	bstrpick.d	$a0, $a0, 31, 0
...
# %bb.784:
	...
	b	.LBB0_202
.LBB0_785:                              # %._crit_edge3464._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_786:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.789:                              # %.lr.ph3467
	...
	sub.d	$s6, $a0, $a1
	b	.LBB0_791
.LBB0_790:                              #   in Loop: Header=BB0_791 Depth=1
	addi.d	$s8, $s8, 36
	beq	$s7, $s8, .LBB0_805
.LBB0_791:                              # =>This Inner Loop Header: Depth=1
	...
	ld.w	$a0, $s3, 12
	beqz	$a0, .LBB0_790
# %bb.792:                              #   in Loop: Header=BB0_791 Depth=1
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_796
# %bb.793:                              #   in Loop: Header=BB0_791 Depth=1
	ld.wu	$a0, $s3, 0
	ld.w	$a2, $s3, 12
	add.d	$a1, $s6, $a0
	move	$a0, $s1
...
.LBB0_801:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a3, $a4, -1
	bltu	$a3, $a2, .LBB0_889
# %bb.802:                              #   in Loop: Header=BB0_801 Depth=1
	ld.w	$a3, $s5, 0
	slli.d	$a4, $a4, 12
	add.w	$a4, $a4, $a1
	...
	bltu	$a4, $a3, .LBB0_888
# %bb.803:                              #   in Loop: Header=BB0_801 Depth=1
	ld.w	$a5, $s5, 4
	sub.w	$a3, $a4, $a3
	bgeu	$a3, $a5, .LBB0_888
# %bb.804:                              #   in Loop: Header=BB0_801 Depth=1
	addi.w	$s7, $s7, 2
	bltu	$s7, $a0, .LBB0_801
	b	.LBB0_889
.LBB0_805:                              # %._crit_edge3468
	ld.wu	$a0, $s5, 12
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
	jirl	$ra, $ra, 0
...
# %bb.849:                              # %middle.block
	beq	$a2, $a3, .LBB0_852
.LBB0_850:                              # %.lr.ph3447.preheader4030
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_866:
	move	$s0, $s5
.LBB0_867:                              # %.thread3309.sink.split
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_638
...
# %bb.893:                              # %vector.memcheck3932
	...
	move	$a1, $zero
	bnez	$a4, .LBB0_922
# %bb.894:                              # %vector.memcheck3932
	alsl.d	$a4, $a0, $s6, 1
	sltu	$a2, $a2, $a4
	sltu	$a3, $s6, $a3
	and	$a2, $a2, $a3
	bnez	$a2, .LBB0_922
# %bb.895:                              # %vector.ph3946
...
.LBB0_896:                              # %vector.body3949
	...
	mul.d	$t3, $t3, $a2
	add.d	$t3, $s5, $t3
	xvstelm.w	$xr4, $a4, 0, 0
	xvstelm.w	$xr4, $a5, 0, 1
	xvstelm.w	$xr4, $a6, 0, 2
	xvstelm.w	$xr4, $a7, 0, 3
	xvstelm.w	$xr4, $t0, 0, 4
	xvstelm.w	$xr4, $t1, 0, 5
	xvstelm.w	$xr4, $t2, 0, 6
	xvstelm.w	$xr4, $t3, 0, 7
	xvaddi.du	$xr1, $xr1, 8
	xvaddi.du	$xr0, $xr0, 8
	addi.d	$a3, $a3, -8
	xvaddi.wu	$xr2, $xr2, 8
	bnez	$a3, .LBB0_896
# %bb.897:                              # %middle.block3956
	bne	$a1, $a0, .LBB0_922
	b	.LBB0_924
.LBB0_898:
...
.LBB0_921:
	move	$a1, $zero
.LBB0_922:                              # %scalar.ph3944.preheader
	slli.d	$a2, $a1, 1
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $a1, 3
	slli.d	$a1, $a1, 2
...
.LJTI0_3:
	...
	.word	.LBB0_242-.LJTI0_3
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function cli_md5sect
...
.Lfunc_end1:
	.size	cli_md5sect, .Lfunc_end1-cli_md5sect
                                        # -- End function
	.p2align	2                               # -- Begin function cli_rawaddr
...
.Lfunc_end2:
	.size	cli_rawaddr, .Lfunc_end2-cli_rawaddr
                                        # -- End function
	.p2align	2                               # -- Begin function cli_seeksect
...
.Lfunc_end3:
	.size	cli_seeksect, .Lfunc_end3-cli_seeksect
                                        # -- End function
	.p2align	2                               # -- Begin function cli_multifree
