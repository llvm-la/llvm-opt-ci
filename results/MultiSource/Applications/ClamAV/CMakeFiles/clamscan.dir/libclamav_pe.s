...
# %bb.569:
	...
	bgeu	$s2, $a0, .LBB0_519
	b	.LBB0_525
.LBB0_570:                              # %vector.main.loop.iter.check3963
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB0_603
# %bb.571:
	move	$a0, $zero
...
.LBB0_580:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
.LBB0_581:                              # %.critedge3021
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s7
	b	.LBB0_658
.LBB0_582:                              # %._crit_edge3462
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_653
...
# %bb.592:
	...
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	bne	$a0, $a2, .LBB0_753
# %bb.593:                              # %.preheader3345
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 72                    # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_651
# %bb.594:                              # %.lr.ph3445.preheader
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	addi.d	$a0, $a0, 8
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	ori	$s3, $zero, 12
...
# %bb.596:                              #   in Loop: Header=BB0_595 Depth=1
	...
	beqz	$a1, .LBB0_598
# %bb.597:                              #   in Loop: Header=BB0_595 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s4, 0
.LBB0_598:                              #   in Loop: Header=BB0_595 Depth=1
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	nor	$a1, $a1, $zero
	add.w	$a1, $s7, $a1
	bltu	$a1, $a0, .LBB0_840
# %bb.599:                              #   in Loop: Header=BB0_595 Depth=1
	ld.w	$a2, $s4, 4
	sub.w	$a1, $a1, $a0
	bgeu	$a1, $a2, .LBB0_840
# %bb.600:                              #   in Loop: Header=BB0_595 Depth=1
	addi.w	$s3, $s3, 4
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	bltu	$s3, $a1, .LBB0_595
	b	.LBB0_651
...
# %bb.605:                              # %middle.block3972
	...
	beq	$a0, $s2, .LBB0_612
# %bb.606:                              # %vec.epilog.iter.check3978
	beqz	$a1, .LBB0_610
.LBB0_607:                              # %vec.epilog.ph3980
	move	$a2, $a0
	andi	$a0, $s2, 124
	vreplgr2vr.w	$vr0, $s0
	sub.d	$a1, $a2, $a0
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_608:                              # %vec.epilog.vector.body3985
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_608
# %bb.609:                              # %vec.epilog.middle.block3989
	vbsrl.v	$vr1, $vr0, 8
	vmax.wu	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.wu	$vr0, $vr1, $vr0
...
# %bb.619:
	...
	move	$s7, $s2
	b	.LBB0_621
.LBB0_620:                              #   in Loop: Header=BB0_621 Depth=1
	addi.w	$s7, $s7, -1
	addi.d	$s4, $s4, -1
	addi.d	$s3, $s3, 36
	beqz	$s4, .LBB0_659
.LBB0_621:                              # %.lr.ph3478
	...
	ld.w	$a0, $s3, 12
	beqz	$a0, .LBB0_620
# %bb.622:                              #   in Loop: Header=BB0_621 Depth=1
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_626
# %bb.623:                              #   in Loop: Header=BB0_621 Depth=1
	ld.wu	$a0, $s3, 12
	addi.w	$a1, $a0, -1
	bgeu	$a1, $s0, .LBB0_626
# %bb.624:                              #   in Loop: Header=BB0_621 Depth=1
	ld.wu	$a1, $s3, 0
	add.d	$a2, $a1, $a0
	bltu	$s6, $a2, .LBB0_626
# %bb.625:                              #   in Loop: Header=BB0_621 Depth=1
	addi.w	$a2, $a0, 0
	add.d	$a1, $s5, $a1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(cli_readn)
...
# %bb.627:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_628:                              # %.critedge200.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_629:                              # %.critedge200
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_721
...
.LBB0_658:                              # %.critedge3021
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_659:                              # %._crit_edge3479.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_664
...
.LBB0_720:                              # %.critedge3021
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_721:
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
.LBB0_722:                              # %.critedge3021
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_16
.LBB0_723:
...
# %bb.771:                              # %middle.block3946
	...
	vpickve2gr.w	$s0, $vr0, 0
	beq	$a0, $s6, .LBB0_778
# %bb.772:                              # %vec.epilog.iter.check
	beqz	$a1, .LBB0_776
.LBB0_773:                              # %vec.epilog.ph
	move	$a2, $a0
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 80
.LBB0_774:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_774
# %bb.775:                              # %vec.epilog.middle.block
	vbsrl.v	$vr1, $vr0, 8
	vmin.wu	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmin.wu	$vr0, $vr1, $vr0
...
# %bb.782:
	...
	b	.LBB0_202
.LBB0_783:                              # %._crit_edge3466._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_784:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.787:                              # %.lr.ph3469
	...
	sub.d	$s6, $a0, $a1
	b	.LBB0_789
.LBB0_788:                              #   in Loop: Header=BB0_789 Depth=1
	addi.d	$s8, $s8, 36
	beq	$s7, $s8, .LBB0_803
.LBB0_789:                              # =>This Inner Loop Header: Depth=1
	...
	ld.w	$a0, $s3, 12
	beqz	$a0, .LBB0_788
# %bb.790:                              #   in Loop: Header=BB0_789 Depth=1
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_794
# %bb.791:                              #   in Loop: Header=BB0_789 Depth=1
	ld.wu	$a0, $s3, 0
	ld.w	$a2, $s3, 12
	add.d	$a1, $s6, $a0
	move	$a0, $s1
...
.LBB0_799:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a4, $a5, -1
	bltu	$a4, $a2, .LBB0_890
# %bb.800:                              #   in Loop: Header=BB0_799 Depth=1
	ld.w	$a4, $s7, 0
	slli.d	$a5, $a5, 12
	sub.d	$a5, $a5, $a1
	add.w	$a5, $a5, $a3
	...
	bltu	$a5, $a4, .LBB0_889
# %bb.801:                              #   in Loop: Header=BB0_799 Depth=1
	ld.w	$a6, $s7, 4
	sub.w	$a4, $a5, $a4
	bgeu	$a4, $a6, .LBB0_889
# %bb.802:                              #   in Loop: Header=BB0_799 Depth=1
	addi.w	$s6, $s6, 2
	bltu	$s6, $a0, .LBB0_799
	b	.LBB0_890
.LBB0_803:                              # %._crit_edge3470
	ld.wu	$a0, $s5, 12
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
	jirl	$ra, $ra, 0
...
# %bb.850:                              # %middle.block
	beq	$a2, $a3, .LBB0_853
.LBB0_851:                              # %.lr.ph3449.preheader4049
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_867:
	move	$s0, $s5
.LBB0_868:                              # %.thread3311.sink.split
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_721
