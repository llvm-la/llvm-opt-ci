...
.LBB0_837:                              # %vector.body
	...
	vadd.w	$vr1, $vr2, $vr1
	vstelm.w	$vr1, $a4, -36, 0
	vstelm.w	$vr1, $a4, 0, 1
	vstelm.w	$vr1, $a4, 36, 2
	vstelm.w	$vr1, $a4, 72, 3
	addi.d	$a3, $a3, 16
	addi.d	$a4, $a4, 144
	bne	$a5, $a3, .LBB0_837
# %bb.838:                              # %middle.block
...
# %bb.839:
	addi.d	$a1, $a2, 1
.LBB0_840:                              # %.lr.ph3447.preheader4021
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_855:
	move	$s0, $s5
.LBB0_856:                              # %.thread3309.sink.split
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_612
...
.LBB0_915:
	move	$a1, $zero
.LBB0_916:                              # %scalar.ph3944.preheader
	slli.d	$a2, $a1, 1
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $a1, 3
	slli.d	$a1, $a1, 2
