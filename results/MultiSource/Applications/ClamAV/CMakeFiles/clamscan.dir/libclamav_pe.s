...
.LBB0_657:                              # %.critedge3021
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_658:                              # %._crit_edge3477.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_682
...
.LBB0_678:                              # %.critedge3021
	...
	move	$a0, $s0
	b	.LBB0_657
.LBB0_679:                              # %.preheader3340
	beqz	$s4, .LBB0_726
# %bb.680:                              # %.lr.ph3463.preheader
	ori	$a0, $zero, 9
	bgeu	$s2, $a0, .LBB0_721
# %bb.681:
	move	$a0, $zero
...
# %bb.840:
	addi.d	$a1, $a2, 1
.LBB0_841:                              # %.lr.ph3447.preheader4021
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_856:
	move	$s0, $s5
.LBB0_857:                              # %.thread3309.sink.split
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_612
...
.LBB0_916:
	move	$a1, $zero
.LBB0_917:                              # %scalar.ph3944.preheader
	slli.d	$a2, $a1, 1
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $a1, 3
	slli.d	$a1, $a1, 2
