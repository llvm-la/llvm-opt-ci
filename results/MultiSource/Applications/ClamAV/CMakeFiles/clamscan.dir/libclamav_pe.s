...
# %bb.507:
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_496
.LBB0_508:                              # %.critedge3051
	ori	$s3, $zero, 2
	bltu	$s2, $s3, .LBB0_513
.LBB0_509:                              # %.critedge3051
	ld.d	$a0, $fp, 56
	ld.wu	$a0, $a0, 0
	andi	$a0, $a0, 512
	beqz	$a0, .LBB0_513
...
.LBB0_556:                              # =>This Inner Loop Header: Depth=1
	...
	ld.w	$a0, $s3, 8
	beqz	$a0, .LBB0_555
# %bb.557:                              #   in Loop: Header=BB0_556 Depth=1
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
...
# %bb.569:
	...
	bgeu	$s2, $a1, .LBB0_519
	b	.LBB0_525
.LBB0_570:                              # %vector.main.loop.iter.check3961
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB0_602
# %bb.571:
	move	$a0, $zero
...
# %bb.591:
	...
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	bne	$a0, $a2, .LBB0_751
# %bb.592:                              # %.preheader3343
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 72                    # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_650
# %bb.593:                              # %.lr.ph3443.preheader
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	addi.d	$a0, $a0, 8
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	ori	$s3, $zero, 12
...
# %bb.596:                              #   in Loop: Header=BB0_594 Depth=1
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s4, 0
.LBB0_597:                              #   in Loop: Header=BB0_594 Depth=1
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	nor	$a1, $a1, $zero
	add.w	$a1, $s0, $a1
	bltu	$a1, $a0, .LBB0_841
# %bb.598:                              #   in Loop: Header=BB0_594 Depth=1
	ld.w	$a2, $s4, 4
	sub.w	$a1, $a1, $a0
	bgeu	$a1, $a2, .LBB0_841
# %bb.599:                              #   in Loop: Header=BB0_594 Depth=1
	addi.w	$s3, $s3, 4
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	bltu	$s3, $a1, .LBB0_594
	b	.LBB0_650
...
# %bb.604:                              # %middle.block3970
	...
	beq	$a0, $s2, .LBB0_611
# %bb.605:                              # %vec.epilog.iter.check3976
	beqz	$a1, .LBB0_609
.LBB0_606:                              # %vec.epilog.ph3978
	move	$a2, $a0
	andi	$a0, $s2, 124
	vreplgr2vr.w	$vr0, $s0
	sub.d	$a1, $a2, $a0
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_607:                              # %vec.epilog.vector.body3983
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_607
# %bb.608:                              # %vec.epilog.middle.block3987
	vbsrl.v	$vr1, $vr0, 8
	vmax.wu	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.wu	$vr0, $vr1, $vr0
...
# %bb.618:
	...
	move	$s7, $s2
	b	.LBB0_620
.LBB0_619:                              #   in Loop: Header=BB0_620 Depth=1
	addi.w	$s7, $s7, -1
	addi.d	$s4, $s4, -1
	addi.d	$s6, $s6, 36
	beqz	$s4, .LBB0_657
.LBB0_620:                              # %.lr.ph3476
	...
	ld.w	$a0, $s6, 12
	beqz	$a0, .LBB0_619
# %bb.621:                              #   in Loop: Header=BB0_620 Depth=1
	move	$a0, $s1
	move	$a1, $s6
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_625
# %bb.622:                              #   in Loop: Header=BB0_620 Depth=1
	ld.wu	$a0, $s6, 12
	addi.w	$a1, $a0, -1
	bgeu	$a1, $s0, .LBB0_625
# %bb.623:                              #   in Loop: Header=BB0_620 Depth=1
	ld.wu	$a1, $s6, 0
	add.d	$a2, $a1, $a0
	bltu	$s3, $a2, .LBB0_625
# %bb.624:                              #   in Loop: Header=BB0_620 Depth=1
	addi.w	$a2, $a0, 0
	add.d	$a1, $s5, $a1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(cli_readn)
...
# %bb.626:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_627:                              # %.critedge200.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_628:                              # %.critedge200
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_720
...
.LBB0_656:                              # %.critedge3021
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_657:                              # %._crit_edge3477.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_680
...
.LBB0_717:
	addi.w	$a1, $s5, 0
.LBB0_718:                              # %.critedge3021
	pcalau12i	$a0, %pc_hi20(.L.str.154)
	addi.d	$a0, $a0, %pc_lo12(.L.str.154)
.LBB0_719:                              # %.critedge3021
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_720:
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
.LBB0_721:                              # %.critedge3021
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_16
.LBB0_722:
...
# %bb.772:                              # %middle.block3944
	...
	vpickve2gr.w	$s0, $vr0, 0
	beq	$a2, $a1, .LBB0_779
# %bb.773:                              # %vec.epilog.iter.check
	beqz	$a3, .LBB0_777
.LBB0_774:                              # %vec.epilog.ph
	move	$a4, $a2
	...
	add.d	$a4, $a4, $a5
	addi.d	$a4, $a4, 80
.LBB0_775:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a4, -72
	ld.w	$a6, $a4, -36
	ld.w	$a7, $a4, 0
	...
	addi.d	$a4, $a4, 144
	bnez	$a3, .LBB0_775
# %bb.776:                              # %vec.epilog.middle.block
	vbsrl.v	$vr1, $vr0, 8
	vmin.wu	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmin.wu	$vr0, $vr1, $vr0
...
# %bb.783:
	...
	b	.LBB0_202
.LBB0_784:                              # %._crit_edge3464._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_785:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.788:                              # %.lr.ph3467
	...
	sub.d	$s6, $a0, $a1
	b	.LBB0_790
.LBB0_789:                              #   in Loop: Header=BB0_790 Depth=1
	addi.d	$s8, $s8, 36
	beq	$s7, $s8, .LBB0_804
...
# %bb.791:                              #   in Loop: Header=BB0_790 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_795
# %bb.792:                              #   in Loop: Header=BB0_790 Depth=1
	ld.wu	$a0, $s3, 0
	ld.w	$a2, $s3, 12
	add.d	$a1, $s6, $a0
	move	$a0, $s1
...
.LBB0_800:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a4, $a5, -1
	bltu	$a4, $a2, .LBB0_891
# %bb.801:                              #   in Loop: Header=BB0_800 Depth=1
	ld.w	$a4, $s7, 0
	slli.d	$a5, $a5, 12
	sub.d	$a5, $a5, $a1
	add.w	$a5, $a5, $a3
	...
	bltu	$a5, $a4, .LBB0_890
# %bb.802:                              #   in Loop: Header=BB0_800 Depth=1
	ld.w	$a6, $s7, 4
	sub.w	$a4, $a5, $a4
	bgeu	$a4, $a6, .LBB0_890
# %bb.803:                              #   in Loop: Header=BB0_800 Depth=1
	addi.w	$s6, $s6, 2
	bltu	$s6, $a0, .LBB0_800
	b	.LBB0_891
.LBB0_804:                              # %._crit_edge3468
	ld.wu	$a0, $s5, 12
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
	jirl	$ra, $ra, 0
...
# %bb.851:                              # %middle.block
	beq	$a2, $a3, .LBB0_854
.LBB0_852:                              # %.lr.ph3447.preheader4047
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_868:
	move	$s0, $s5
.LBB0_869:                              # %.thread3309.sink.split
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_720
