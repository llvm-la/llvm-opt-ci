...
.LBB0_69:
	...
	b	.LBB0_72
.LBB0_70:                               # %decomp_block.exit.thread
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_71:                               # %.critedge172
...
.LBB0_82:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_92
.LBB0_83:                               # %vector.ph305
	bstrpick.d	$a0, $s2, 15, 1
	slli.d	$a0, $a0, 1
	addi.d	$a1, $fp, 36
	move	$a2, $a0
.LBB0_84:                               # %vector.body308
	...
	addi.d	$a1, $a1, 72
	bnez	$a2, .LBB0_84
# %bb.85:                               # %middle.block311
	beq	$a0, $s2, .LBB0_88
.LBB0_86:                               # %.lr.ph215.preheader314
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	add.d	$a1, $a1, $fp
	addi.d	$a1, $a1, 8
...
.Lfunc_end0:
	...
	.p2align	5, 0x0                          # -- Begin function build_decrypt_dictionaries
.LCPI1_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
	.dword	2                               # 0x2
