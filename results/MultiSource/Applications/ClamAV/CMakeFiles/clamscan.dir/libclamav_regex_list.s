...
.LJTI0_0:
	...
	.word	.LBB0_31-.LJTI0_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function get_char_at_pos_with_skip
...
.LBB3_225:
	...
	pcaddu18i	$ra, %call36(cli_errmsg)
	jirl	$ra, $ra, 0
.LBB3_226:                              # %functionality_level_check.exit.thread157
	move	$a0, $s3
	lu12i.w	$a1, 1
	ori	$a1, $a1, 2320
	add.d	$sp, $sp, $a1
...
.LJTI7_0:
	...
	.word	.LBB7_2-.LJTI7_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function tree_node_insert_nonbin
...
.Lfunc_end8:
	.size	tree_node_insert_nonbin, .Lfunc_end8-tree_node_insert_nonbin
                                        # -- End function
	.p2align	2                               # -- Begin function destroy_tree_internal
