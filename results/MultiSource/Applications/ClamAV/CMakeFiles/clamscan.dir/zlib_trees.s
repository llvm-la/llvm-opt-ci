...
.LBB5_57:                               #   in Loop: Header=BB5_48 Depth=1
	...
	ori	$t3, $zero, 138
	b	.LBB5_47
.LBB5_58:                               #   in Loop: Header=BB5_48 Depth=1
	blt	$a5, $t4, .LBB5_60
...
.LBB5_112:
	ori	$a1, $zero, 1
	b	.LBB5_26
.LBB5_113:                              # %.preheader.i.preheader
	move	$a2, $zero
	addi.d	$a3, $fp, 340
	ori	$a4, $zero, 896
.LBB5_114:                              # %.preheader.i
                                        # =>This Inner Loop Header: Depth=1
	ldx.hu	$a1, $a3, $a2
	bnez	$a1, .LBB5_112
...
.Lfunc_end5:
	.size	_tr_flush_block, .Lfunc_end5-_tr_flush_block
                                        # -- End function
	.p2align	2                               # -- Begin function build_tree
...
.LBB6_30:                               #   in Loop: Header=BB6_28 Depth=2
	...
	b	.LBB6_34
	.p2align	4, , 16
.LBB6_31:                               #   in Loop: Header=BB6_28 Depth=2
	bne	$s2, $s3, .LBB6_33
# %bb.32:                               #   in Loop: Header=BB6_28 Depth=2
	...
	b	.LBB6_34
	.p2align	4, , 16
.LBB6_33:                               # %._crit_edge65.i99
                                        #   in Loop: Header=BB6_28 Depth=2
	move	$fp, $t8
.LBB6_34:                               #   in Loop: Header=BB6_28 Depth=2
	slli.d	$t8, $t8, 2
	ldx.w	$t8, $a6, $t8
	ld.hu	$s0, $t6, 0
	slli.d	$s1, $t8, 2
...
# %bb.42:                               #   in Loop: Header=BB6_41 Depth=2
	...
	ldx.hu	$s1, $a2, $s1
	bgeu	$s0, $s1, .LBB6_44
.LBB6_43:                               #   in Loop: Header=BB6_41 Depth=2
	move	$t6, $t8
	move	$t7, $t8
	b	.LBB6_47
	.p2align	4, , 16
.LBB6_44:                               #   in Loop: Header=BB6_41 Depth=2
	bne	$s0, $s1, .LBB6_46
# %bb.45:                               #   in Loop: Header=BB6_41 Depth=2
	ldx.bu	$s0, $a7, $t7
	ldx.bu	$fp, $a7, $fp
	move	$t7, $t6
	bgeu	$fp, $s0, .LBB6_43
	b	.LBB6_47
	.p2align	4, , 16
.LBB6_46:                               # %._crit_edge65.i113
                                        #   in Loop: Header=BB6_41 Depth=2
	move	$t7, $t6
.LBB6_47:                               #   in Loop: Header=BB6_41 Depth=2
	slli.d	$t6, $t6, 2
	ldx.w	$t6, $a6, $t6
	ld.hu	$t8, $t4, 0
	slli.d	$fp, $t6, 2
	ldx.hu	$fp, $a2, $fp
	bltu	$t8, $fp, .LBB6_23
# %bb.48:                               #   in Loop: Header=BB6_41 Depth=2
	bne	$t8, $fp, .LBB6_40
# %bb.49:                               #   in Loop: Header=BB6_41 Depth=2
	ldx.bu	$t8, $a7, $a5
	ldx.bu	$fp, $a7, $t6
	bltu	$fp, $t8, .LBB6_40
	b	.LBB6_23
...
# %bb.64:                               # %.preheader.i
	beqz	$a7, .LBB6_73
# %bb.65:                               # %.lr.ph123.i.preheader
	addi.d	$t1, $a3, 957
	ori	$t2, $zero, 573
	b	.LBB6_67
	.p2align	4, , 16
.LBB6_66:                               # %.outer.split.us.i
...
.LBB6_70:                               #   Parent Loop BB6_67 Depth=1
	...
	addi.d	$t4, $t4, -4
	blt	$a1, $t5, .LBB6_70
# %bb.71:                               #   in Loop: Header=BB6_69 Depth=2
	alsl.d	$t4, $t5, $a5, 2
	ld.hu	$t5, $t4, 2
	beq	$a7, $t5, .LBB6_68
...
# %bb.74:                               # %.lr.ph.preheader.i
	...
	b	.LBB6_76
	.p2align	4, , 16
.LBB6_75:                               #   in Loop: Header=BB6_76 Depth=1
	addi.d	$a0, $a0, 1
	beq	$a0, $a1, .LBB6_80
.LBB6_76:                               # %.lr.ph.i126
                                        # =>This Loop Header: Depth=1
...
# %bb.77:                               #   in Loop: Header=BB6_76 Depth=1
	...
	addi.d	$a7, $a7, 1
	.p2align	4, , 16
.LBB6_78:                               #   Parent Loop BB6_76 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$t1, $a6, 1
	or	$t1, $t0, $t1
