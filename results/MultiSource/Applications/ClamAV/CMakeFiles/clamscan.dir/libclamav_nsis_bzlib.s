...
.LBB3_221:                              #   Parent Loop BB3_4 Depth=1
	...
	ldx.bu	$a1, $a2, $t4
	beqz	$a2, .LBB3_220
# %bb.222:                              # %iter.check586
                                        #   in Loop: Header=BB3_221 Depth=2
	ori	$a3, $zero, 8
	bltu	$a2, $a3, .LBB3_224
# %bb.223:                              # %vector.scevcheck565
                                        #   in Loop: Header=BB3_221 Depth=2
	addi.d	$a3, $a2, -1
	andi	$a4, $a3, 255
	bgeu	$a3, $a4, .LBB3_227
...
# %bb.228:                              #   in Loop: Header=BB3_221 Depth=2
	...
	move	$t0, $ra
	b	.LBB3_225
.LBB3_229:                              # %vector.main.loop.iter.check570
                                        #   in Loop: Header=BB3_221 Depth=2
	bgeu	$a2, $a4, .LBB3_234
# %bb.230:                              #   in Loop: Header=BB3_221 Depth=2
	move	$a6, $zero
.LBB3_231:                              # %vec.epilog.ph590
                                        #   in Loop: Header=BB3_221 Depth=2
	andi	$a7, $a2, 248
	andi	$a4, $a2, 7
	sub.d	$a3, $a2, $a7
	...
	add.d	$a6, $a6, $t1
	add.d	$a5, $t1, $a5
.LBB3_232:                              # %vec.epilog.vector.body593
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_221 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	addi.d	$a5, $a5, -8
	bnez	$t0, .LBB3_232
# %bb.233:                              # %vec.epilog.middle.block599
                                        #   in Loop: Header=BB3_221 Depth=2
	ld.d	$t1, $sp, 80                    # 8-byte Folded Reload
	move	$t0, $ra
	beq	$a7, $a2, .LBB3_220
	b	.LBB3_225
.LBB3_234:                              # %vector.ph572
                                        #   in Loop: Header=BB3_221 Depth=2
	move	$a7, $fp
	move	$fp, $s4
	move	$s4, $t5
...
# %bb.236:                              # %middle.block581
	...
	ld.d	$t2, $sp, 64                    # 8-byte Folded Reload
	beq	$a6, $a2, .LBB3_220
# %bb.237:                              # %vec.epilog.iter.check588
                                        #   in Loop: Header=BB3_221 Depth=2
...
.LBB3_241:                              # %vector.scevcheck603
	...
	move	$a0, $zero
	beq	$a2, $a3, .LBB3_217
# %bb.242:                              # %vector.scevcheck603
                                        #   in Loop: Header=BB3_4 Depth=1
	ori	$a2, $zero, 255
	bltu	$a2, $a1, .LBB3_217
# %bb.243:                              # %vector.main.loop.iter.check606
                                        #   in Loop: Header=BB3_4 Depth=1
	ori	$a0, $zero, 32
	bgeu	$ra, $a0, .LBB3_246
...
.LBB3_247:                              # %vector.body611
	...
	addi.d	$a3, $a3, 32
	bnez	$a2, .LBB3_247
# %bb.248:                              # %middle.block614
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$ra, $a0, .LBB3_218
# %bb.249:                              # %vec.epilog.iter.check620
                                        #   in Loop: Header=BB3_4 Depth=1
	beqz	$a1, .LBB3_217
.LBB3_250:                              # %vec.epilog.ph622
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a1, $ra, 504
	...
	vadd.b	$vr0, $vr0, $vr1
.LBB3_251:                              # %vec.epilog.vector.body625
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$a2, $a0, 248
	add.d	$a2, $t4, $a2
	...
	vaddi.bu	$vr0, $vr0, 8
	bne	$a1, $a0, .LBB3_251
# %bb.252:                              # %vec.epilog.middle.block630
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a0, $a1
	bne	$ra, $a1, .LBB3_217
	b	.LBB3_218
...
.LBB3_279:                              # %.preheader68.i.thread.i
	...
	ori	$s7, $zero, 32
	b	.LBB3_294
.LBB3_280:                              # %vector.body552.preheader
                                        #   in Loop: Header=BB3_276 Depth=2
	move	$a0, $a1
...
# %bb.282:                              # %middle.block560
	...
	move	$a1, $a0
	beq	$a0, $s5, .LBB3_285
.LBB3_283:                              # %scalar.ph547.preheader
                                        #   in Loop: Header=BB3_276 Depth=2
	sub.d	$a0, $s5, $a1
	add.d	$a1, $s3, $a1
	.p2align	4, , 16
.LBB3_284:                              # %scalar.ph547
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_276 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a2, $a1, 0
...
# %bb.315:                              #   in Loop: Header=BB3_314 Depth=2
	...
	addi.d	$a7, $a7, 1
	st.w	$a7, $a1, 16
.LBB3_316:                              #   in Loop: Header=BB3_314 Depth=2
	bge	$a0, $fp, .LBB3_321
# %bb.317:                              #   in Loop: Header=BB3_314 Depth=2
	addi.w	$a4, $a4, 1
	addi.d	$a5, $a5, 1
	addi.w	$a6, $a6, -1
	addi.w	$a7, $zero, -1
...
# %bb.318:                              #   in Loop: Header=BB3_4 Depth=1
	...
	move	$t7, $t2
	b	.LBB3_328
.LBB3_319:                              # %.._crit_edge1550_crit_edge.i
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.w	$a3, $s2, 32
	b	.LBB3_322
.LBB3_320:                              #   in Loop: Header=BB3_4 Depth=1
	...
	move	$s6, $a4
	b	.LBB3_329
.LBB3_321:                              #   in Loop: Header=BB3_4 Depth=1
	move	$a7, $t0
	move	$t0, $t4
	move	$t4, $t7
	move	$t7, $t2
...
# %bb.327:                              #   in Loop: Header=BB3_4 Depth=1
	addi.w	$t3, $t3, 1
	b	.LBB3_264
.LBB3_328:                              # %BZ2_decompress.exit
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$t2, $t3
.LBB3_329:                              # %BZ2_decompress.exit
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$t3, $s4
	ld.d	$s4, $sp, 72                    # 8-byte Folded Reload
	b	.LBB3_170
...
# %bb.376:                              #   in Loop: Header=BB3_375 Depth=2
	...
	addi.d	$a7, $a7, 1
	st.w	$a7, $a1, 16
.LBB3_377:                              #   in Loop: Header=BB3_375 Depth=2
	bge	$a0, $fp, .LBB3_393
# %bb.378:                              #   in Loop: Header=BB3_375 Depth=2
	addi.w	$a4, $a4, 1
	addi.d	$a5, $a5, 1
	addi.w	$a6, $a6, -1
	addi.w	$a7, $zero, -1
...
# %bb.388:                              # %vector.memcheck
	...
	ori	$t0, $zero, 16
	bgeu	$a7, $t0, .LBB3_476
.LBB3_389:                              # %.lr.ph1573.i.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	addi.w	$a5, $a6, 0
.LBB3_390:                              # %.lr.ph1573.i
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a6, $a5, -1
	...
	move	$a5, $a6
	bnez	$a3, .LBB3_390
.LBB3_391:                              # %._crit_edge1574.i
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.d	$a3, $sp, 296                   # 8-byte Folded Reload
	stx.b	$a1, $a3, $a4
	b	.LBB3_430
.LBB3_392:                              #   in Loop: Header=BB3_4 Depth=1
	move	$t4, $zero
	b	.LBB3_331
...
# %bb.422:                              #   in Loop: Header=BB3_4 Depth=1
	...
	move	$t5, $t1
	b	.LBB3_460
.LBB3_423:                              # %.preheader.i45
                                        #   in Loop: Header=BB3_4 Depth=1
	ldptr.d	$a1, $s2, 3152
	move	$a0, $zero
	move	$a2, $a1
	move	$a3, $s8
.LBB3_424:                              #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a4, $a2, 0
	slli.d	$a4, $a4, 2
	ldx.w	$a5, $s5, $a4
...
# %bb.426:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$ra, $sp, 264                   # 8-byte Folded Reload
	b	.LBB3_170
.LBB3_427:                              # %.preheader1385.i.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a3, $zero
	ori	$a4, $zero, 4080
	ld.d	$a5, $sp, 176                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 72                    # 8-byte Folded Reload
.LBB3_428:                              # %.preheader1385.i
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	ld.d	$t0, $sp, 296                   # 8-byte Folded Reload
...
# %bb.434:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$a1, $sp, 480                   # 8-byte Folded Reload
	bge	$t0, $a1, .LBB3_456
# %bb.435:                              #   in Loop: Header=BB3_4 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ldx.bu	$a3, $a0, $t0
	slli.d	$a0, $a3, 2
	ld.d	$a1, $sp, 392                   # 8-byte Folded Reload
...
# %bb.441:                              #   in Loop: Header=BB3_440 Depth=2
	...
	addi.d	$a7, $a7, 1
	st.w	$a7, $a1, 16
.LBB3_442:                              #   in Loop: Header=BB3_440 Depth=2
	bge	$a0, $fp, .LBB3_446
# %bb.443:                              #   in Loop: Header=BB3_440 Depth=2
	addi.w	$a4, $a4, 1
	addi.d	$a5, $a5, 1
	addi.w	$a6, $a6, -1
	addi.w	$a7, $zero, -1
...
.LBB3_450:                              #   in Loop: Header=BB3_4 Depth=1
	...
	addi.w	$a5, $s4, 0
	bge	$a4, $a5, .LBB3_349
# %bb.451:                              #   in Loop: Header=BB3_4 Depth=1
	addi.w	$fp, $fp, 1
	b	.LBB3_153
.LBB3_452:                              # %.preheader1375.i
                                        #   in Loop: Header=BB3_4 Depth=1
	bltz	$ra, .LBB3_455
# %bb.453:                              # %.lr.ph1605.i
                                        #   in Loop: Header=BB3_4 Depth=1
...
# %bb.465:                              #   in Loop: Header=BB3_4 Depth=1
	move	$t4, $a5
.LBB3_466:                              # %scalar.ph491.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	slli.d	$a5, $t4, 2
	sub.d	$a6, $a4, $t4
	st.d	$t3, $sp, 472                   # 8-byte Folded Spill
	st.d	$s4, $sp, 504                   # 8-byte Folded Spill
.LBB3_467:                              # %scalar.ph491
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t0, $a1
	beqz	$a6, .LBB3_470
...
.LBB3_470:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$t3, $sp, 360                   # 8-byte Folded Reload
	b	.LBB3_170
.LBB3_471:                              # %unRLE_obuf_to_output_SMALL.exit.thread.loopexit889
	addi.w	$a0, $zero, -1
...
.LBB3_478:                              # %vec.epilog.vector.body
	...
	addi.w	$a0, $a0, -8
	b	.LBB3_478
.LBB3_479:                              # %vector.body518.preheader
	move	$a1, $s1
.LBB3_480:                              # %vector.body518
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $a5, -1
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a0, $a1, $a0
