...
# %bb.115:
	...
	move	$a0, $s1
	b	.LBB0_64
.LBB0_116:                              # %vector.main.loop.iter.check
	move	$t4, $t3
	move	$a6, $a0
	ori	$a0, $zero, 16
	bgeu	$s4, $a0, .LBB0_118
...
# %bb.121:
	...
	bgeu	$s2, $a2, .LBB0_41
	b	.LBB0_64
.LBB0_122:                              # %vec.epilog.iter.check
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	move	$a0, $a6
	ld.d	$t1, $sp, 72                    # 8-byte Folded Reload
	move	$t2, $t3
...
.LBB0_123:                              # %vec.epilog.ph
	...
	sub.d	$a7, $a7, $t1
	add.d	$a3, $a3, $a7
.LBB0_124:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a0, $a0, 4
...
# %bb.139:
	...
	move	$a0, $s1
	bltu	$s7, $a3, .LBB0_64
# %bb.140:                              # %.preheader1085.preheader
	add.d	$a2, $s8, $a2
	ld.w	$a3, $a2, 0
	add.d	$a1, $s8, $a1
	st.w	$a3, $a1, 0
...
# %bb.148:
	...
	move	$a0, $s1
	bltu	$s7, $a2, .LBB0_64
# %bb.149:                              # %.preheader1086.preheader
	ldx.w	$a2, $s8, $a1
	add.d	$a0, $s8, $a1
