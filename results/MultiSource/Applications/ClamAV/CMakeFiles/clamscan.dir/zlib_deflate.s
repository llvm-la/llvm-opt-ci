...
# %bb.3:                                #   in Loop: Header=BB5_1 Depth=1
	...
	b	.LBB5_13
	.p2align	4, , 16
.LBB5_4:                                # %vector.main.loop.iter.check130
                                        #   in Loop: Header=BB5_1 Depth=1
...
.LBB5_7:                                # %vec.epilog.vector.body157
	...
	addi.d	$a5, $a5, -16
	bnez	$a7, .LBB5_7
# %bb.8:                                # %vec.epilog.middle.block164
                                        #   in Loop: Header=BB5_1 Depth=1
	bne	$a3, $t1, .LBB5_13
	b	.LBB5_15
.LBB5_9:                                # %vector.ph132
...
.LBB5_10:                               # %vector.body137
	...
	addi.d	$t2, $t2, -32
	bnez	$t3, .LBB5_10
# %bb.11:                               # %middle.block144
                                        #   in Loop: Header=BB5_1 Depth=1
	beq	$a3, $t0, .LBB5_15
# %bb.12:                               # %vec.epilog.iter.check150
                                        #   in Loop: Header=BB5_1 Depth=1
	bnez	$t1, .LBB5_6
	.p2align	4, , 16
.LBB5_13:                               # %vec.epilog.scalar.ph149.preheader
                                        #   in Loop: Header=BB5_1 Depth=1
	addi.d	$a3, $a4, -2
	.p2align	4, , 16
.LBB5_14:                               # %vec.epilog.scalar.ph149
                                        #   Parent Loop BB5_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a4, $a3, 0
	sub.d	$a5, $a4, $a1
...
# %bb.16:                               #   in Loop: Header=BB5_1 Depth=1
	...
	b	.LBB5_26
	.p2align	4, , 16
.LBB5_17:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB5_1 Depth=1
	bstrpick.d	$a3, $a2, 31, 0
	addi.d	$a3, $a3, 1
	ori	$a4, $zero, 15
...
# %bb.25:                               # %vec.epilog.iter.check
	...
	bnez	$t0, .LBB5_19
	.p2align	4, , 16
.LBB5_26:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB5_1 Depth=1
	addi.d	$a3, $a4, -2
	.p2align	4, , 16
.LBB5_27:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB5_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a4, $a3, 0
	sub.d	$a5, $a4, $a1
...
# %bb.10:                               # %vec.epilog.iter.check
	bnez	$t1, .LBB13_4
.LBB13_11:                              # %vec.epilog.scalar.ph.preheader
	addi.d	$a3, $a4, -2
	.p2align	4, , 16
.LBB13_12:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a4, $a3, 0
	sub.d	$a5, $a4, $a1
	sltu	$a4, $a4, $a5
...
# %bb.14:
	...
	move	$a0, $a1
	b	.LBB13_24
.LBB13_15:                              # %vector.main.loop.iter.check41
...
# %bb.16:
	move	$a6, $zero
.LBB13_17:                              # %vec.epilog.ph63
	bstrpick.d	$a0, $a2, 32, 3
	slli.d	$a7, $a0, 3
	slli.d	$a0, $a0, 4
	sub.d	$a3, $a5, $a0
	sub.d	$a0, $a1, $a7
...
.LBB13_18:                              # %vec.epilog.vector.body68
	...
	addi.d	$a4, $a4, -16
	bnez	$a5, .LBB13_18
# %bb.19:                               # %vec.epilog.middle.block75
	bne	$a2, $a7, .LBB13_24
	b	.LBB13_26
.LBB13_20:                              # %vector.ph43
	andi	$a7, $a2, 8
	bstrpick.d	$a0, $a2, 32, 4
	slli.d	$a6, $a0, 4
	slli.d	$a0, $a0, 5
	sub.d	$a3, $a5, $a0
	sub.d	$a0, $a1, $a6
...
.LBB13_21:                              # %vector.body48
	...
	addi.d	$t0, $t0, -32
	bnez	$t1, .LBB13_21
# %bb.22:                               # %middle.block55
	beq	$a2, $a6, .LBB13_26
# %bb.23:                               # %vec.epilog.iter.check61
	bnez	$a7, .LBB13_17
.LBB13_24:                              # %vec.epilog.scalar.ph60.preheader
	addi.d	$a2, $a3, -2
	.p2align	4, , 16
.LBB13_25:                              # %vec.epilog.scalar.ph60
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a3, $a2, 0
	sub.d	$a4, $a3, $a1
	sltu	$a3, $a3, $a4
