...
# %bb.22:                               #   in Loop: Header=BB2_21 Depth=1
	...
	beqz	$s2, .LBB2_48
# %bb.23:                               # %.preheader63.i.i.i.preheader
                                        #   in Loop: Header=BB2_21 Depth=1
	move	$s3, $zero
.LBB2_24:                               # %.preheader63.i.i.i
...
.LBB2_35:                               #   in Loop: Header=BB2_24 Depth=2
	...
	ori	$a1, $zero, 9
	ori	$a0, $zero, 7
.LBB2_36:                               # %.lr.ph.preheader.sink.split.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ld.hu	$a2, $sp, 1186
	srl.d	$s2, $a2, $a0
	addi.d	$a0, $sp, 1168
...
# %bb.43:                               #   in Loop: Header=BB2_42 Depth=3
	...
	ori	$a3, $zero, 1
	blt	$a3, $a2, .LBB2_42
.LBB2_44:                               # %.loopexit60.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ext.w.h	$a0, $s3
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	blt	$a0, $a1, .LBB2_24
# %bb.45:                               # %.preheader59.i.i.i
                                        #   in Loop: Header=BB2_21 Depth=1
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	blt	$a4, $a0, .LBB2_47
# %bb.46:                               # %.lr.ph71.i.i.i
...
.LBB2_53:                               # %read_c_len.exit.i.i
	...
	ld.hu	$a1, $sp, 1184
	ori	$a5, $zero, 509
.LBB2_54:                               #   in Loop: Header=BB2_21 Depth=1
	ld.hu	$a0, $sp, 1186
	srli.d	$a2, $a0, 3
	lu12i.w	$a3, 1
	ori	$a3, $a3, 4094
...
# %bb.55:                               # %.preheader.i.i
	...
	ori	$a1, $zero, 8
	.p2align	4, , 16
.LBB2_56:                               #   Parent Loop BB2_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
...
# %bb.59:                               #   in Loop: Header=BB2_21 Depth=1
	...
	ori	$a1, $zero, 17
	bltu	$s2, $a1, .LBB2_63
# %bb.60:                               # %.preheader.i62.i
                                        #   in Loop: Header=BB2_21 Depth=1
	ori	$a1, $zero, 128
	.p2align	4, , 16
.LBB2_61:                               #   Parent Loop BB2_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$a2, $s2, 15, 0
	bgeu	$a2, $s5, .LBB2_65
...
.LBB2_63:                               # %.loopexit.i60.i
	...
	beqz	$s2, .LBB2_66
# %bb.64:                               #   in Loop: Header=BB2_21 Depth=1
	addi.d	$a0, $s2, -1
	ld.hu	$a2, $sp, 1186
...
.LBB2_66:                               # %decode_p.exit.i
	...
	ori	$a1, $zero, 13
	bgeu	$a0, $a1, .LBB2_82
# %bb.67:                               #   in Loop: Header=BB2_21 Depth=1
	addi.d	$a0, $s3, -253
...
.Lfunc_end2:
	.size	cli_unarj_extract_file, .Lfunc_end2-cli_unarj_extract_file
                                        # -- End function
	.p2align	2                               # -- Begin function arj_unstore
...
.Lfunc_end3:
	.size	arj_unstore, .Lfunc_end3-arj_unstore
                                        # -- End function
	.p2align	2                               # -- Begin function decode_f
...
.Lfunc_end5:
	.size	fill_buf, .Lfunc_end5-fill_buf
                                        # -- End function
	.p2align	2                               # -- Begin function read_pt_len
...
# %bb.6:                                # %vector.body
	...
	xvld	$xr1, $t3, %pc_lo12(.LCPI7_0)
	pcalau12i	$t3, %pc_hi20(.LCPI7_1)
	xvld	$xr2, $t3, %pc_lo12(.LCPI7_1)
	addi.d	$t2, $t2, -3
	xvreplgr2vr.d	$xr3, $t2
	xvsle.du	$xr1, $xr1, $xr3
	xvsle.du	$xr2, $xr2, $xr3
...
.LBB7_9:                                # %pred.store.continue4
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB7_22
.LBB7_10:                               # %pred.store.continue6
	vpickve2gr.h	$t3, $vr1, 4
	andi	$t3, $t3, 1
	bnez	$t3, .LBB7_23
.LBB7_11:                               # %pred.store.continue8
	vpickve2gr.h	$t3, $vr1, 5
	andi	$t3, $t3, 1
	bnez	$t3, .LBB7_24
.LBB7_12:                               # %pred.store.continue10
...
# %bb.42:                               #   in Loop: Header=BB7_40 Depth=1
	...
	alsl.d	$s2, $s1, $a4, 1
	beqz	$s3, .LBB7_37
# %bb.43:                               # %.lr.ph124.preheader
                                        #   in Loop: Header=BB7_40 Depth=1
	sub.w	$s1, $a3, $t8
	b	.LBB7_45
	.p2align	4, , 16
.LBB7_44:                               #   in Loop: Header=BB7_45 Depth=2
	and	$s2, $s0, $t1
	sltui	$s2, $s2, 1
...
# %bb.46:                               #   in Loop: Header=BB7_45 Depth=2
	...
	b	.LBB7_44
	.p2align	4, , 16
.LBB7_47:                               #   in Loop: Header=BB7_40 Depth=1
	bltu	$a5, $fp, .LBB7_3
# %bb.48:                               # %.preheader
                                        #   in Loop: Header=BB7_40 Depth=1
	beqz	$s1, .LBB7_38
...
# %bb.50:                               #   in Loop: Header=BB7_40 Depth=1
	move	$s1, $s0
	b	.LBB7_60
.LBB7_51:                               # %vector.main.loop.iter.check26
                                        #   in Loop: Header=BB7_40 Depth=1
	bgeu	$s2, $t6, .LBB7_53
...
.LBB7_54:                               # %vector.body33
	...
	addi.d	$s5, $s5, 64
	bnez	$s6, .LBB7_54
# %bb.55:                               # %middle.block36
                                        #   in Loop: Header=BB7_40 Depth=1
	beq	$s2, $s3, .LBB7_38
# %bb.56:                               # %vec.epilog.iter.check41
                                        #   in Loop: Header=BB7_40 Depth=1
	beqz	$s4, .LBB7_60
.LBB7_57:                               # %vec.epilog.ph43
                                        #   in Loop: Header=BB7_40 Depth=1
	move	$s4, $s2
	...
	sub.d	$s3, $s3, $s4
	.p2align	4, , 16
.LBB7_58:                               # %vec.epilog.vector.body48
                                        #   Parent Loop BB7_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s0, 0
	addi.d	$s3, $s3, 8
	addi.d	$s0, $s0, 16
	bnez	$s3, .LBB7_58
# %bb.59:                               # %vec.epilog.middle.block51
                                        #   in Loop: Header=BB7_40 Depth=1
	beq	$s2, $s4, .LBB7_38
.LBB7_60:                               # %vec.epilog.scalar.ph40.preheader
                                        #   in Loop: Header=BB7_40 Depth=1
	alsl.d	$s0, $s1, $a4, 1
	.p2align	4, , 16
.LBB7_61:                               # %vec.epilog.scalar.ph40
                                        #   Parent Loop BB7_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$t0, $s0, 0
	addi.d	$s1, $s1, 1
