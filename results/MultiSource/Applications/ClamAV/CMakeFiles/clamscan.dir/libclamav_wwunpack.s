...
# %bb.55:                               #   in Loop: Header=BB0_15 Depth=2
	ld.d	$a1, $sp, 144
	bltu	$a1, $s7, .LBB0_222
# %bb.56:                               #   in Loop: Header=BB0_15 Depth=2
	addi.d	$a2, $a1, 4
	bltu	$s5, $a2, .LBB0_222
# %bb.57:                               # %getbitmap.exit41.i311.i
                                        #   in Loop: Header=BB0_15 Depth=2
	ld.w	$a3, $a1, 0
	st.d	$a2, $sp, 144
	ori	$a1, $zero, 32
...
# %bb.59:                               #   in Loop: Header=BB0_15 Depth=2
	addi.d	$a4, $a2, 4
	bltu	$s5, $a4, .LBB0_222
# %bb.60:                               #   in Loop: Header=BB0_15 Depth=2
	xori	$a5, $a1, 3
	andi	$a6, $a5, 255
	ld.wu	$a2, $a2, 0
	srl.w	$a3, $a3, $a5
...
# %bb.72:                               #   in Loop: Header=BB0_15 Depth=2
	addi.d	$a5, $a3, 4
	bltu	$s5, $a5, .LBB0_222
# %bb.73:                               #   in Loop: Header=BB0_15 Depth=2
	sub.d	$a1, $a4, $a1
	andi	$a4, $a1, 255
	ld.w	$a3, $a3, 0
	st.d	$a5, $sp, 144
...
.LBB0_79:                               #   in Loop: Header=BB0_15 Depth=2
	ld.d	$a1, $sp, 144
	bltu	$a1, $s7, .LBB0_222
# %bb.80:                               #   in Loop: Header=BB0_15 Depth=2
	addi.d	$a3, $a1, 4
	bltu	$s5, $a3, .LBB0_222
# %bb.81:                               # %getbitmap.exit41.i323.i
                                        #   in Loop: Header=BB0_15 Depth=2
	ld.w	$a1, $a1, 0
	st.w	$a1, $sp, 140
	st.d	$a3, $sp, 144
	ori	$a1, $zero, 32
.LBB0_82:                               #   in Loop: Header=BB0_15 Depth=2
...
.LBB0_229:                              # %.split151
	...
	b	.LBB0_223
.LBB0_230:                              # %.split147.us
	pcalau12i	$a0, %pc_hi20(.L.str.2)
	addi.d	$a0, $a0, %pc_lo12(.L.str.2)
	b	.LBB0_223
.LBB0_231:                              # %.split149.us
	addi.w	$a1, $fp, 0
