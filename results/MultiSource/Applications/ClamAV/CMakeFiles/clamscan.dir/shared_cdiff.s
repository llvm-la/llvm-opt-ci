...
.LBB0_58:
	...
	b	.LBB0_62
.LBB0_59:                               # %._crit_edge124.loopexit
	addi.w	$s2, $s2, -1
.LBB0_60:                               # %._crit_edge124
	move	$a0, $s1
...
.Lfunc_end0:
	.size	cdiff_apply, .Lfunc_end0-cdiff_apply
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_ctx_free
...
.Lfunc_end1:
	.size	cdiff_ctx_free, .Lfunc_end1-cdiff_ctx_free
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_execute
...
.LBB2_18:                               # %.thread52
	ld.bu	$a0, $s0, 0
	pcalau12i	$a1, %pc_hi20(cdiff_cmd_close)
	addi.d	$a2, $a1, %pc_lo12(cdiff_cmd_close)
	b	.LBB2_26
.LBB2_19:
	addi.d	$a1, $s2, 120
	b	.LBB2_21
...
.LBB2_25:
	move	$a0, $a5
.LBB2_26:                               # %._crit_edge.i
	beqz	$a0, .LBB2_29
# %bb.27:                               # %cdiff_token.exit33
	move	$a0, $s0
	move	$a1, $s1
	jirl	$ra, $a2, 0
	beqz	$a0, .LBB2_31
# %bb.28:
	...
	b	.LBB2_30
.LBB2_29:                               # %cdiff_token.exit33.thread
...
.Lfunc_end2:
	.size	cdiff_execute, .Lfunc_end2-cdiff_execute
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_token
...
.Lfunc_end3:
	.size	cdiff_token, .Lfunc_end3-cdiff_token
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_cmd_open
...
.Lfunc_end4:
	.size	cdiff_cmd_open, .Lfunc_end4-cdiff_cmd_open
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_cmd_add
...
# %bb.8:
	...
	st.d	$a0, $fp, 16
	b	.LBB5_14
.LBB5_9:                                # %cdiff_token.exit.thread
...
.Lfunc_end5:
	.size	cdiff_cmd_add, .Lfunc_end5-cdiff_cmd_add
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_cmd_del
...
# %bb.12:                               # %.lr.ph.i51
	...
	move	$a1, $a6
	bne	$a2, $a4, .LBB6_11
.LBB6_13:                               # %._crit_edge.i45
	beqz	$a6, .LBB6_27
# %bb.14:                               # %cdiff_token.exit55
	add.d	$a0, $a0, $a5
	pcaddu18i	$ra, %call36(strdup)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB6_27
...
# %bb.26:                               #   in Loop: Header=BB6_24 Depth=1
	...
	bgeu	$a3, $a4, .LBB6_23
	b	.LBB6_31
.LBB6_27:                               # %cdiff_token.exit55.thread
...
.Lfunc_end6:
	.size	cdiff_cmd_del, .Lfunc_end6-cdiff_cmd_del
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_cmd_xchg
...
# %bb.12:                               # %.lr.ph.i61
	...
	move	$a3, $a2
	bne	$a4, $a5, .LBB7_11
.LBB7_13:                               # %._crit_edge.i52
	beqz	$a2, .LBB7_37
# %bb.14:                               # %.preheader.i57.preheader
	add.d	$s1, $a0, $a6
	ori	$s2, $zero, 1
...
# %bb.21:                               # %.lr.ph.i72
	...
	move	$a0, $a5
	bne	$a1, $a3, .LBB7_20
.LBB7_22:                               # %._crit_edge.i66
	beqz	$a5, .LBB7_36
# %bb.23:                               # %cdiff_token.exit76
	add.d	$a0, $s4, $a4
	pcaddu18i	$ra, %call36(strdup)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB7_36
...
# %bb.35:                               #   in Loop: Header=BB7_33 Depth=1
	...
	bgeu	$a3, $a4, .LBB7_32
	b	.LBB7_41
.LBB7_36:                               # %cdiff_token.exit76.thread
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB7_37:                               # %._crit_edge.i52.thread
...
.Lfunc_end7:
	.size	cdiff_cmd_xchg, .Lfunc_end7-cdiff_cmd_xchg
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_cmd_close
...
# %bb.11:                               #   in Loop: Header=BB8_9 Depth=3
	ld.w	$a0, $s7, 0
	beq	$s4, $a0, .LBB8_13
# %bb.12:                               #   in Loop: Header=BB8_9 Depth=3
	addi.d	$a0, $sp, 8
	move	$a1, $s2
...
# %bb.16:                               # %.outer106
	...
	ld.d	$s7, $s7, 24
	bnez	$s7, .LBB8_8
.LBB8_17:                               # %.outer106.split.split.us.preheader
                                        #   in Loop: Header=BB8_7 Depth=1
	addi.w	$s4, $s4, 1
	.p2align	4, , 16
.LBB8_18:                               # %.outer106.split.split.us
                                        #   Parent Loop BB8_7 Depth=1
...
# %bb.23:                               # %.outer
	...
	ld.d	$s8, $s8, 24
	bnez	$s8, .LBB8_7
.LBB8_24:                               # %.outer.split.us
	beqz	$s7, .LBB8_36
# %bb.25:
	addi.w	$s5, $zero, -1
.LBB8_26:                               # %.outer106.split.us.split.us182.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB8_27 Depth 2
	addi.w	$s4, $s4, 1
	.p2align	4, , 16
.LBB8_27:                               # %.outer106.split.us.split.us182
...
.Lfunc_end8:
	.size	cdiff_cmd_close, .Lfunc_end8-cdiff_cmd_close
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_cmd_move
...
# %bb.14:                               # %.lr.ph.i166
	...
	move	$a3, $a2
	bne	$a4, $a5, .LBB9_13
.LBB9_15:                               # %._crit_edge.i157
	beqz	$a2, .LBB9_26
# %bb.16:                               # %.preheader.i162.preheader
	add.d	$s1, $a0, $a6
	ori	$s0, $zero, 1
	bstrins.d	$a2, $zero, 5, 5
	beqz	$a2, .LBB9_18
...
# %bb.30:                               # %.lr.ph.i180
	...
	move	$a3, $a2
	bne	$a4, $a5, .LBB9_29
.LBB9_31:                               # %._crit_edge.i171
	beqz	$a2, .LBB9_74
# %bb.32:                               # %.preheader.i176.preheader
	add.d	$s2, $a0, $a6
	ori	$s3, $zero, 1
	bstrins.d	$a2, $zero, 5, 5
	beqz	$a2, .LBB9_34
...
# %bb.39:                               # %.lr.ph.i194
	...
	move	$a3, $a2
	bne	$a4, $a5, .LBB9_38
.LBB9_40:                               # %._crit_edge.i185
	beqz	$a2, .LBB9_75
# %bb.41:                               # %.preheader.i190.preheader
	add.d	$s2, $a0, $a6
	ori	$s5, $zero, 1
	bstrins.d	$a2, $zero, 5, 5
	beqz	$a2, .LBB9_43
...
# %bb.48:                               # %.lr.ph.i208
	...
	move	$a2, $a1
	bne	$a3, $a4, .LBB9_47
.LBB9_49:                               # %._crit_edge.i199
	beqz	$a1, .LBB9_77
# %bb.50:                               # %.preheader.i204.preheader
	move	$a2, $s4
	add.d	$s5, $s4, $a6
	ori	$s6, $zero, 1
...
.LBB9_60:                               # %.outer
	...
	sub.d	$s4, $fp, $s5
.LBB9_61:                               #   Parent Loop BB9_60 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $sp, 40
	ori	$a1, $zero, 1024
	move	$a2, $s6
...
# %bb.63:                               #   in Loop: Header=BB9_61 Depth=2
	...
	bne	$a0, $s7, .LBB9_61
	b	.LBB9_87
.LBB9_64:                               #   in Loop: Header=BB9_60 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	move	$a2, $a0
...
# %bb.69:                               #   in Loop: Header=BB9_66 Depth=2
	...
	bne	$s4, $s5, .LBB9_66
	b	.LBB9_72
.LBB9_70:                               #   in Loop: Header=BB9_60 Depth=1
	ld.d	$s5, $sp, 8                     # 8-byte Folded Reload
	b	.LBB9_72
.LBB9_71:                               #   in Loop: Header=BB9_60 Depth=1
	move	$s5, $s4
.LBB9_72:                               # %.critedge
                                        #   in Loop: Header=BB9_60 Depth=1
...
# %bb.73:
	...
	b	.LBB9_98
.LBB9_74:                               # %._crit_edge.i171.thread
	pcalau12i	$a0, %pc_hi20(.L.str.59)
	addi.d	$a0, $a0, %pc_lo12(.L.str.59)
	b	.LBB9_23
.LBB9_75:                               # %._crit_edge.i185.thread
...
.LBB9_76:
	...
	jirl	$ra, $ra, 0
	b	.LBB9_24
.LBB9_77:                               # %._crit_edge.i199.thread
...
.Lfunc_end9:
	.size	cdiff_cmd_move, .Lfunc_end9-cdiff_cmd_move
                                        # -- End function
	.p2align	2                               # -- Begin function cdiff_cmd_unlink
...
.LBB10_16:                              # %.split
	...
	jirl	$ra, $ra, 0
	b	.LBB10_18
.LBB10_17:                              # %cdiff_token.exit.thread
