...
# %bb.20:
	ld.d	$a1, $a0, 0
	beqz	$a1, .LBB2_23
# %bb.21:                               # %thread-pre-split.i30
	ld.d	$a0, $a0, 8
	bstrpick.d	$a1, $a0, 31, 3
	slli.d	$a1, $a1, 3
	bnez	$a1, .LBB2_23
# %bb.22:                               # %switch.lookup41
	andi	$a0, $a0, 7
	slli.d	$a0, $a0, 3
	pcalau12i	$a1, %pc_hi20(.Lswitch.table.iconv_open_cached)
	addi.d	$a1, $a1, %pc_lo12(.Lswitch.table.iconv_open_cached)
	ldx.d	$s1, $a1, $a0
.LBB2_23:                               # %encoding_bytes.exit32
	ld.d	$s3, $fp, 0
	bne	$s2, $s1, .LBB2_25
.LBB2_24:
	move	$a0, $s3
...
.LBB4_59:                               # %process_bom.exit.thread243
	maskeqz	$a2, $a2, $a0
	or	$a1, $a2, $a1
	ori	$a2, $zero, 2
	masknez	$a2, $a2, $a0
	...
	maskeqz	$a0, $a3, $a0
	or	$a0, $a0, $a2
.LBB4_60:                               # %process_bom.exit.thread243
	addi.d	$fp, $s0, 8
	st.d	$a1, $s0, 8
	addi.d	$s3, $s0, 33
	st.b	$a0, $s0, 33
...
.LBB4_89:
	beqz	$s5, .LBB4_154
# %bb.90:                               # %.lr.ph35.i.preheader
	pcalau12i	$a0, %pc_hi20(.L.str.1694)
	addi.d	$s6, $a0, %pc_lo12(.L.str.1694)
	move	$fp, $zero
	b	.LBB4_92
.LBB4_91:                               #   in Loop: Header=BB4_92 Depth=1
	srli.d	$s7, $fp, 1
	move	$a0, $s6
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
...
# %bb.106:                              # %.lr.ph
	...
	b	.LBB4_110
	.p2align	4, , 16
.LBB4_107:                              #   in Loop: Header=BB4_110 Depth=1
	addi.d	$a0, $s1, 1
	st.b	$s5, $s1, 0
.LBB4_108:                              # %.thread
...
# %bb.114:                              #   in Loop: Header=BB4_110 Depth=1
	...
	b	.LBB4_107
	.p2align	4, , 16
.LBB4_115:                              #   in Loop: Header=BB4_110 Depth=1
	bltz	$s6, .LBB4_109
# %bb.116:                              #   in Loop: Header=BB4_110 Depth=1
	ld.w	$a0, $s0, 168
	bnez	$a0, .LBB4_109
# %bb.117:                              #   in Loop: Header=BB4_110 Depth=1
	ori	$a0, $zero, 1
	st.w	$a0, $s0, 168
	...
	b	.LBB4_109
	.p2align	4, , 16
.LBB4_118:                              #   in Loop: Header=BB4_110 Depth=1
	bne	$a3, $s3, .LBB4_121
# %bb.119:                              #   in Loop: Header=BB4_110 Depth=1
	bgeu	$s1, $fp, .LBB4_123
# %bb.120:                              #   in Loop: Header=BB4_110 Depth=1
	addi.d	$a0, $s1, 1
	ori	$a1, $zero, 32
	st.b	$a1, $s1, 0
	b	.LBB4_108
.LBB4_121:                              #   in Loop: Header=BB4_110 Depth=1
	addi.d	$a0, $sp, 72
	ori	$a1, $zero, 9
	move	$a2, $s4
	pcaddu18i	$ra, %call36(snprintf)
...
.LBB4_135:                              # %.lr.ph23.i
	...
	addi.d	$a1, $a1, 2
	bnez	$a3, .LBB4_135
.LBB4_136:                              # %._crit_edge.i
	sub.d	$s3, $s3, $a0
	alsl.d	$s4, $a0, $s4, 1
	b	.LBB4_97
.LBB4_137:                              # %.preheader.i
	srli.d	$a0, $s5, 1
	beqz	$a0, .LBB4_154
# %bb.138:                              # %.lr.ph32.i.preheader
	move	$a1, $zero
	addi.d	$a2, $s2, 2
	lu12i.w	$a3, 15
	ori	$a3, $a3, 4095
...
.LBB4_142:
	...
	jirl	$ra, $ra, 0
	b	.LBB4_154
.LBB4_143:                              # %.preheader2.i
	srli.d	$a0, $s5, 1
	beqz	$a0, .LBB4_154
# %bb.144:                              # %.lr.ph30.i.preheader
	move	$a1, $zero
	addi.d	$a2, $s2, 2
	lu12i.w	$a3, 15
	ori	$a3, $a3, 4095
...
# %bb.147:                              #   in Loop: Header=BB4_146 Depth=1
	ld.hu	$a4, $a2, -2
	b	.LBB4_145
.LBB4_148:                              # %.preheader4.i
	beqz	$s5, .LBB4_154
# %bb.149:                              # %.lr.ph28.i.preheader
	move	$a0, $zero
	move	$a1, $s4
	b	.LBB4_151
...
.LBB4_161:                              #   in Loop: Header=BB4_159 Depth=1
	andi	$a2, $a1, 224
	beq	$a2, $a5, .LBB4_165
# %bb.162:                              #   in Loop: Header=BB4_159 Depth=1
	bne	$a2, $a6, .LBB4_168
# %bb.163:                              #   in Loop: Header=BB4_159 Depth=1
	ld.b	$a2, $a0, 1
	blt	$fp, $a2, .LBB4_175
# %bb.164:                              #   in Loop: Header=BB4_159 Depth=1
	...
	addi.d	$s5, $s5, 2
	b	.LBB4_173
.LBB4_165:                              #   in Loop: Header=BB4_159 Depth=1
	ld.b	$a2, $a0, 1
	blt	$fp, $a2, .LBB4_175
# %bb.166:                              #   in Loop: Header=BB4_159 Depth=1
	ld.b	$a3, $a0, 2
	blt	$fp, $a3, .LBB4_175
# %bb.167:                              #   in Loop: Header=BB4_159 Depth=1
	srli.d	$a2, $a2, 2
	...
	addi.d	$s5, $s5, 3
	b	.LBB4_173
.LBB4_168:                              #   in Loop: Header=BB4_159 Depth=1
	andi	$a1, $a1, 248
	ori	$a2, $zero, 240
	bne	$a1, $a2, .LBB4_175
# %bb.169:                              #   in Loop: Header=BB4_159 Depth=1
	ld.b	$a1, $a0, 1
	blt	$fp, $a1, .LBB4_175
# %bb.170:                              #   in Loop: Header=BB4_159 Depth=1
	ld.b	$a1, $a0, 2
	blt	$fp, $a1, .LBB4_175
# %bb.171:                              #   in Loop: Header=BB4_159 Depth=1
	ld.b	$a0, $a0, 3
	blt	$fp, $a0, .LBB4_175
# %bb.172:                              #   in Loop: Header=BB4_159 Depth=1
	...
	stx.h	$a0, $s4, $s6
	addi.d	$s5, $s5, 4
.LBB4_173:                              #   in Loop: Header=BB4_159 Depth=1
	addi.d	$s6, $s6, 2
	bgeu	$s5, $s3, .LBB4_176
# %bb.174:                              #   in Loop: Header=BB4_159 Depth=1
	bltu	$s6, $s7, .LBB4_159
	b	.LBB4_176
.LBB4_175:                              # %.loopexit8.sink.split.i
	pcalau12i	$a0, %pc_hi20(.L.str.1695)
	addi.d	$a0, $a0, %pc_lo12(.L.str.1695)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB4_176:                              # %.loopexit8.i
	sub.d	$s3, $s3, $s5
	add.d	$fp, $s2, $s5
	add.d	$s4, $s4, $s6
	beqz	$s3, .LBB4_155
...
.LBB4_186:                              # %vec.epilog.ph
	...
	xvld	$xr0, $a6, %pc_lo12(.LCPI4_4)
	xvld	$xr1, $a5, %pc_lo12(.LCPI4_5)
	xvld	$xr2, $a4, %pc_lo12(.LCPI4_6)
	xvld	$xr4, $a3, %pc_lo12(.LCPI4_7)
	xvor.v	$xr0, $xr3, $xr0
	xvor.v	$xr1, $xr3, $xr1
	xvor.v	$xr2, $xr3, $xr2
	xvor.v	$xr3, $xr3, $xr4
...
.LBB4_193:                              # %vector.ph
	...
	xvld	$xr2, $a2, %pc_lo12(.LCPI4_2)
	pcalau12i	$a2, %pc_hi20(.LCPI4_3)
	xvld	$xr3, $a2, %pc_lo12(.LCPI4_3)
	xvld	$xr4, $a6, %pc_lo12(.LCPI4_4)
	xvld	$xr5, $a5, %pc_lo12(.LCPI4_5)
	xvld	$xr6, $a4, %pc_lo12(.LCPI4_6)
	xvld	$xr7, $a3, %pc_lo12(.LCPI4_7)
	bstrpick.d	$a2, $a0, 62, 5
	slli.d	$t6, $a2, 5
	xvrepli.d	$xr8, 32
	move	$t0, $s2
	move	$t1, $t6
.LBB4_194:                              # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	xvslli.d	$xr9, $xr0, 1
	xvslli.d	$xr10, $xr1, 1
	xvslli.d	$xr11, $xr2, 1
	...
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 0
	xvpickve2gr.d	$t2, $xr16, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 1
	xvpickve2gr.d	$t2, $xr16, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 2
	xvpickve2gr.d	$t2, $xr16, 3
	xvslli.d	$xr16, $xr6, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 3
	xvpickve2gr.d	$t2, $xr16, 0
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 4
	xvpickve2gr.d	$t2, $xr16, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 5
	xvpickve2gr.d	$t2, $xr16, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 6
	xvpickve2gr.d	$t2, $xr16, 3
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 7
	xvpickve2gr.d	$t2, $xr14, 0
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 8
	xvpickve2gr.d	$t2, $xr14, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 9
	xvpickve2gr.d	$t2, $xr14, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 10
	xvpickve2gr.d	$t2, $xr14, 3
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 11
	xvpickve2gr.d	$t2, $xr13, 0
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 12
	xvpickve2gr.d	$t2, $xr13, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 13
	xvpickve2gr.d	$t2, $xr13, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 14
	xvpickve2gr.d	$t2, $xr13, 3
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 15
	xvpickve2gr.d	$t2, $xr12, 0
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 16
	xvpickve2gr.d	$t2, $xr12, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 17
	xvpickve2gr.d	$t2, $xr12, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 18
	xvpickve2gr.d	$t2, $xr12, 3
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 19
	xvpickve2gr.d	$t2, $xr11, 0
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 20
	xvpickve2gr.d	$t2, $xr11, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 21
	xvpickve2gr.d	$t2, $xr11, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 22
	xvpickve2gr.d	$t2, $xr11, 3
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 23
	xvpickve2gr.d	$t2, $xr10, 0
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 24
	xvpickve2gr.d	$t2, $xr10, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 25
	xvpickve2gr.d	$t2, $xr10, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 26
	xvpickve2gr.d	$t2, $xr10, 3
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 27
	xvpickve2gr.d	$t2, $xr9, 0
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 28
	xvpickve2gr.d	$t2, $xr9, 1
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 29
	xvpickve2gr.d	$t2, $xr9, 2
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 30
	xvpickve2gr.d	$t2, $xr9, 3
	stx.b	$zero, $s4, $t2
	add.d	$t2, $s4, $t2
	xvstelm.b	$xr15, $t2, 1, 31
	xvadd.d	$xr7, $xr7, $xr8
	xvadd.d	$xr6, $xr6, $xr8
	xvadd.d	$xr5, $xr5, $xr8
	xvadd.d	$xr4, $xr4, $xr8
...
.LJTI4_0:
	...
	.word	.LBB4_129-.LJTI4_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function iconv_open_cached
...
# %bb.12:
	...
	st.w	$a0, $s2, 0
	b	.LBB5_18
.LBB5_13:                               # %init_iconv_pool_ifneeded.exit.thread
...
.LBB5_21:                               # %iconv_open.exit
	...
	st.d	$a1, $s2, 8
	beq	$s2, $a0, .LBB5_25
.LBB5_22:                               # %iconv_open.exit.thread
	ld.d	$s3, $s4, 16
	ld.d	$a1, $s4, 8
	addi.d	$a0, $s3, 1
	st.d	$a0, $s4, 16
...
.Lfunc_end5:
	.size	iconv_open_cached, .Lfunc_end5-iconv_open_cached
                                        # -- End function
	.p2align	2                               # -- Begin function iconv_cache_cleanup_main
