...
.LBB6_135:                              # %.loopexit
	...
	st.w	$t1, $s4, 140
	move	$a7, $t1
.LBB6_136:                              #   in Loop: Header=BB6_100 Depth=2
	move	$t2, $fp
	move	$t3, $s8
	bltu	$a7, $a2, .LBB6_100
.LBB6_137:                              # %._crit_edge1996
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.hu	$a4, $s4, 664
	beqz	$a4, .LBB6_162
...
.LBB6_151:                              #   in Loop: Header=BB6_16 Depth=1
	move	$s0, $s8
.LBB6_152:                              # %._crit_edge2325
                                        #   in Loop: Header=BB6_16 Depth=1
	st.d	$t6, $sp, 40                    # 8-byte Folded Spill
	move	$s6, $s3
	andi	$a4, $a2, 2
	beqz	$a4, .LBB6_170
# %bb.153:                              # %._crit_edge2325
                                        #   in Loop: Header=BB6_16 Depth=1
	lu12i.w	$a4, 8
	ori	$s3, $a4, 2847
	bne	$s5, $s3, .LBB6_170
...
# %bb.161:                              #   in Loop: Header=BB6_16 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB6_273
.LBB6_162:                              #   in Loop: Header=BB6_16 Depth=1
	pcalau12i	$a2, %pc_hi20(.L.str.11)
	addi.d	$a2, $a2, %pc_lo12(.L.str.11)
	b	.LBB6_350
.LBB6_163:                              # %vector.scevcheck3785
                                        #   in Loop: Header=BB6_16 Depth=1
	ori	$a4, $zero, 19
	sub.d	$a3, $a4, $a3
	addi.w	$a4, $a3, 0
...
# %bb.169:                              # %vec.epilog.middle.block
	...
	bne	$a1, $a5, .LBB6_92
	b	.LBB6_94
.LBB6_170:                              #   in Loop: Header=BB6_16 Depth=1
	ld.d	$a4, $s4, 48
	st.w	$zero, $s4, 24
	beqz	$a4, .LBB6_172
# %bb.171:                              #   in Loop: Header=BB6_16 Depth=1
	addi.w	$a5, $zero, -1
	lu32i.d	$a5, 0
	st.w	$a5, $a4, 72
...
.LBB6_300:                              # %.thread
	...
	ld.d	$t7, $sp, 104                   # 8-byte Folded Reload
	b	.LBB6_15
.LBB6_301:                              #   in Loop: Header=BB6_16 Depth=1
	ld.wu	$a2, $s4, 120
...
.LBB6_314:                              #   in Loop: Header=BB6_16 Depth=1
	...
	st.w	$t1, $s4, 92
	beqz	$t4, .LBB6_366
# %bb.315:                              #   in Loop: Header=BB6_16 Depth=1
	andi	$a5, $t4, 32
	bnez	$a5, .LBB6_368
...
.LBB6_324:                              #   in Loop: Header=BB6_16 Depth=1
	...
	move	$a2, $fp
	move	$a4, $s1
.LBB6_325:                              # %._crit_edge2057
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.bu	$t3, $a7, 0
	ld.hu	$a7, $a7, 2
	ori	$t1, $zero, 16
	bgeu	$t3, $t1, .LBB6_330
# %bb.326:                              # %.preheader1296
                                        #   in Loop: Header=BB6_16 Depth=1
	move	$s7, $s2
	move	$s2, $t6
	add.d	$t1, $a5, $t3
...
# %bb.329:                              #   in Loop: Header=BB6_328 Depth=2
	...
	bltu	$t3, $t8, .LBB6_328
	b	.LBB6_332
.LBB6_330:                              # %._crit_edge2057._crit_edge
                                        #   in Loop: Header=BB6_16 Depth=1
	lu12i.w	$a6, 1
	ori	$a6, $a6, 3052
	ldx.w	$a6, $s4, $a6
...
.LBB6_333:                              #   in Loop: Header=BB6_16 Depth=1
	...
	stptr.w	$a4, $s4, 7148
	bnez	$a5, .LBB6_340
# %bb.334:                              #   in Loop: Header=BB6_16 Depth=1
	st.w	$a7, $s4, 96
	andi	$a4, $t3, 15
	st.w	$a4, $s4, 100
	ori	$a5, $s3, 3915
...
.LBB6_335:                              #   in Loop: Header=BB6_16 Depth=1
	beqz	$a4, .LBB6_344
# %bb.336:                              # %.preheader1294
                                        #   in Loop: Header=BB6_16 Depth=1
	addi.w	$a2, $s1, 0
	bgeu	$a2, $a4, .LBB6_342
# %bb.337:                              # %.lr.ph2086.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	move	$a5, $s1
	move	$a2, $fp
	move	$a7, $s8
.LBB6_338:                              # %.lr.ph2086
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$a2, .LBB6_387
# %bb.339:                              #   in Loop: Header=BB6_338 Depth=2
	ld.bu	$t0, $a7, 0
	addi.w	$a2, $a2, -1
	addi.d	$a6, $a7, 1
	sll.d	$a7, $t0, $a5
...
.LBB6_343:                              # %._crit_edge2087
	...
	move	$s8, $a6
	move	$fp, $a2
.LBB6_344:                              #   in Loop: Header=BB6_16 Depth=1
	ori	$a2, $s3, 3916
	st.w	$a2, $s4, 8
...
.LBB6_356:                              #   in Loop: Header=BB6_16 Depth=1
	...
	st.w	$a5, $s4, 92
	bltu	$a4, $a6, .LBB6_361
# %bb.357:                              #   in Loop: Header=BB6_16 Depth=1
	sub.d	$a5, $ra, $a7
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB6_361
# %bb.358:                              # %vector.ph
...
.LBB6_362:                              # %scalar.ph
	...
	addi.d	$a4, $a4, 1
	bnez	$a5, .LBB6_362
.LBB6_363:                              # %.loopexit3807
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.w	$a5, $s4, 92
	sub.w	$t6, $t6, $a2
	bnez	$a5, .LBB6_365
# %bb.364:                              #   in Loop: Header=BB6_16 Depth=1
	ori	$a2, $s3, 3912
	st.w	$a2, $s4, 8
...
# %bb.371:                              #   in Loop: Header=BB6_16 Depth=1
	...
	addi.w	$a1, $a0, 8
	bnez	$a2, .LBB6_373
# %bb.372:                              #   in Loop: Header=BB6_16 Depth=1
	st.w	$a1, $s4, 56
	move	$a2, $a1
...
# %bb.374:                              #   in Loop: Header=BB6_16 Depth=1
	bltu	$a2, $a1, .LBB6_378
# %bb.375:                              #   in Loop: Header=BB6_16 Depth=1
	ori	$a1, $zero, 256
	sll.w	$a0, $a1, $a0
	st.w	$a0, $s4, 28
	move	$a0, $zero
...
.LBB6_383:
	...
	move	$s8, $a2
	b	.LBB6_393
.LBB6_384:                              # %.loopexit1268.loopexit2946
	bstrpick.d	$a2, $fp, 31, 0
	alsl.w	$s1, $fp, $s1, 3
	b	.LBB6_388
.LBB6_385:
	...
	move	$s8, $a4
	b	.LBB6_393
.LBB6_386:                              # %.loopexit1268.loopexit2943
	move	$fp, $zero
	...
	move	$s7, $a4
	b	.LBB6_395
.LBB6_387:                              # %.loopexit1268.loopexit2944
	alsl.w	$s1, $fp, $s1, 3
	bstrpick.d	$a2, $fp, 31, 0
.LBB6_388:                              # %.loopexit1268
	...
	move	$fp, $zero
	b	.LBB6_395
.LBB6_389:                              # %.loopexit1268.loopexit2945
	move	$fp, $zero
...
.LBB6_390:
	...
	move	$s1, $t0
	b	.LBB6_393
.LBB6_391:                              # %..loopexit1268.loopexit4622_crit_edge
	add.d	$s8, $s8, $s0
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	st.d	$a2, $sp, 72                    # 8-byte Folded Spill
	move	$s3, $s2
...
.LBB6_411:
	...
	addi.d	$sp, $sp, 224
.LBB6_412:                              # %inflateStateCheck.exit.thread
	move	$a0, $a3
	ret
.LBB6_413:
	move	$s0, $s8
	b	.LBB6_419
.LBB6_414:                              # %.loopexit1268.loopexit2948
	move	$fp, $zero
	bstrpick.d	$a3, $a2, 31, 0
	alsl.w	$s1, $a2, $a5, 3
.LBB6_415:                              # %.loopexit1268
	add.d	$s8, $s0, $a3
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	st.d	$a2, $sp, 72                    # 8-byte Folded Spill
	move	$t6, $s2
...
.LBB6_419:
	...
	move	$s8, $s0
	b	.LBB6_395
.LBB6_420:                              # %.loopexit1268.loopexit3813
	ori	$a2, $zero, 1
	b	.LBB6_394
.LBB6_421:
	move	$s1, $s5
