...
.LBB1_3:                                # %.preheader.outer507.outer
...
.LBB1_39:                               # %.loopexit2332
	...
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_3
.LBB1_40:                               # %.loopexit544.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_79
.LBB1_41:                               # %.loopexit550.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 160                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_86
.LBB1_42:                               # %.loopexit543.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_92
.LBB1_43:                               # %.loopexit1952
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a3, $sp, 200                   # 8-byte Folded Reload
	addi.w	$a3, $a3, 0
	sltui	$a3, $a3, 1
...
# %bb.56:                               #   in Loop: Header=BB1_3 Depth=2
	...
	ori	$a3, $zero, 19
	b	.LBB1_74
.LBB1_57:                               # %.loopexit4590
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	bnez	$s7, .LBB1_78
	b	.LBB1_156
.LBB1_58:                               # %.loopexit2201
                                        #   in Loop: Header=BB1_3 Depth=2
	ori	$a3, $zero, 18
...
.LBB1_73:                               #   in Loop: Header=BB1_3 Depth=2
	...
	addi.d	$s0, $a3, 480
	ori	$a3, $zero, 9
.LBB1_74:                               # %.loopexit549.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	st.d	$a3, $sp, 176                   # 8-byte Folded Spill
.LBB1_75:                               # %.loopexit549.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 160                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
...
.LBB1_102:                              # %.loopexit1968
	...
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_120
.LBB1_103:                              # %.preheader500.loopexit
                                        #   in Loop: Header=BB1_2 Depth=1
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_123
.LBB1_104:                              # %.loopexit503.loopexit
                                        #   in Loop: Header=BB1_2 Depth=1
	ld.d	$a7, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_114
.LBB1_105:                              # %.loopexit506.loopexit
                                        #   in Loop: Header=BB1_2 Depth=1
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_135
.LBB1_106:                              # %.loopexit504.loopexit
                                        #   in Loop: Header=BB1_2 Depth=1
	ld.d	$a4, $sp, 200                   # 8-byte Folded Reload
...
.LBB1_144:
	...
	move	$a5, $zero
	ori	$a3, $zero, 13
.LBB1_145:                              # %.loopexit501
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
.LBB1_146:                              # %.loopexit501
	move	$s2, $zero
	st.w	$a3, $a0, 0
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	st.w	$a3, $a0, 4
