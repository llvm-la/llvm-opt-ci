...
.LJTI0_1:
	...
	.word	.LBB0_90-.LJTI0_1
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function sis_extract_simple
...
.LBB1_3:
	...
	addi.d	$s7, $a0, %pc_lo12(.L.str.151)
.LBB1_4:
	move	$s6, $zero
	move	$s8, $zero
	ld.w	$fp, $s4, 8
...
.LBB1_16:
	...
	addi.d	$s7, $a0, %pc_lo12(.L.str.155)
	b	.LBB1_22
.LBB1_17:
	move	$s0, $a4
	st.d	$a3, $sp, 88                    # 8-byte Folded Spill
...
.LBB1_21:
	...
	addi.d	$s7, $a0, %pc_lo12(.L.str.153)
.LBB1_22:
	move	$s8, $zero
	ori	$s6, $zero, 1
	ld.w	$fp, $s4, 8
...
.LBB1_43:
	...
	addi.d	$s7, $a1, %pc_lo12(.L.str.157)
	beqz	$a0, .LBB1_4
# %bb.44:
	ori	$a1, $zero, 512
	beq	$a0, $a1, .LBB1_47
...
# %bb.77:                               #   in Loop: Header=BB1_66 Depth=1
	ld.d	$a0, $sp, 128
	bgeu	$a2, $a0, .LBB1_79
# %bb.78:                               #   in Loop: Header=BB1_66 Depth=1
	addi.w	$a1, $a0, 0
...
.LBB1_79:                               #   in Loop: Header=BB1_66 Depth=1
	...
	alsl.d	$a1, $s4, $s4, 1
	bgeu	$a1, $a0, .LBB1_83
# %bb.80:                               #   in Loop: Header=BB1_66 Depth=1
	ld.d	$a2, $a3, 32
	beqz	$a2, .LBB1_84
# %bb.81:                               #   in Loop: Header=BB1_66 Depth=1
	ld.d	$a2, $a2, 24
	beqz	$a2, .LBB1_84
# %bb.82:                               #   in Loop: Header=BB1_66 Depth=1
	bgeu	$a2, $a0, .LBB1_84
.LBB1_83:                               #   in Loop: Header=BB1_66 Depth=1
	st.d	$a1, $sp, 128
	move	$a0, $a1
.LBB1_84:                               #   in Loop: Header=BB1_66 Depth=1
	move	$fp, $s8
	pcaddu18i	$ra, %call36(cli_malloc)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_131
# %bb.85:                               #   in Loop: Header=BB1_66 Depth=1
	move	$s8, $a0
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB1_132
# %bb.86:                               #   in Loop: Header=BB1_66 Depth=1
	ld.d	$a0, $sp, 128
	bne	$a0, $fp, .LBB1_90
# %bb.87:                               #   in Loop: Header=BB1_66 Depth=1
	move	$s4, $s5
	b	.LBB1_91
.LBB1_88:                               #   in Loop: Header=BB1_66 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	add.d	$s8, $a0, $a1
	b	.LBB1_91
.LBB1_89:                               #   in Loop: Header=BB1_66 Depth=1
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	move	$a0, $s3
	...
	ori	$s0, $zero, 1
	b	.LBB1_65
.LBB1_90:                               #   in Loop: Header=BB1_66 Depth=1
	addi.w	$a1, $a0, 0
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	ld.d	$s4, $sp, 128
.LBB1_91:                               #   in Loop: Header=BB1_66 Depth=1
	ori	$a1, $zero, 577
	ori	$a2, $zero, 384
	move	$a0, $s3
	...
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	beq	$fp, $a0, .LBB1_110
# %bb.92:                               #   in Loop: Header=BB1_66 Depth=1
	addi.w	$s4, $s4, 0
	move	$a0, $fp
	move	$a1, $s8
	move	$a2, $s4
	...
	jirl	$ra, $ra, 0
	bne	$a0, $s4, .LBB1_111
# %bb.93:                               #   in Loop: Header=BB1_66 Depth=1
	...
	beq	$a0, $a1, .LBB1_114
# %bb.94:                               #   in Loop: Header=BB1_66 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$fp, $sp, 120                   # 8-byte Folded Reload
	...
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	beqz	$a0, .LBB1_65
# %bb.95:                               #   in Loop: Header=BB1_66 Depth=1
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB1_65
...
.LBB1_107:
	...
	addi.w	$a0, $zero, -114
	b	.LBB1_99
.LBB1_108:                              # %vector.main.loop.iter.check
	ori	$a4, $zero, 30
	vrepli.b	$vr0, 37
	bgeu	$a3, $a4, .LBB1_121
# %bb.109:
...
.LBB1_125:                              # %vec.epilog.ph
	...
	add.d	$a1, $a1, $s2
	addi.d	$a7, $a1, 3
.LBB1_126:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a1, $a7, -2
	ld.b	$a2, $a7, 0
	ld.b	$a4, $a7, 2
...
# %bb.127:                              # %vec.epilog.middle.block
	beq	$a3, $t2, .LBB1_130
.LBB1_128:                              # %.preheader.i.preheader
	add.d	$a0, $t3, $a0
	add.d	$a0, $a0, $s2
	addi.d	$a0, $a0, 1
	sub.d	$a1, $t1, $a3
...
.LBB1_129:                              # %.preheader.i
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB1_129
.LBB1_130:                              # %sis_utf16_decode.exit
...
# %bb.139:                              # %middle.block40
	...
	ld.d	$t3, $sp, 72                    # 8-byte Folded Reload
	beq	$a3, $t2, .LBB1_146
# %bb.140:                              # %vec.epilog.iter.check45
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beqz	$a1, .LBB1_144
.LBB1_141:                              # %vec.epilog.ph47
	move	$a1, $a3
	bstrpick.d	$a2, $t2, 30, 2
	slli.d	$a3, $a2, 2
	slli.d	$t3, $a2, 3
	...
	addi.d	$a7, $a1, 3
	vrepli.b	$vr0, 37
.LBB1_142:                              # %vec.epilog.vector.body50
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a1, $a7, -2
	ld.b	$a2, $a7, 0
	ld.b	$a4, $a7, 2
...
# %bb.143:                              # %vec.epilog.middle.block53
	beq	$a3, $t2, .LBB1_146
.LBB1_144:                              # %.preheader.i230.preheader
	add.d	$a0, $t3, $a0
	add.d	$a0, $a0, $s2
	addi.d	$a0, $a0, 1
	sub.d	$a1, $t1, $a3
...
.LBB1_145:                              # %.preheader.i230
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB1_145
.LBB1_146:                              # %sis_utf16_decode.exit237
