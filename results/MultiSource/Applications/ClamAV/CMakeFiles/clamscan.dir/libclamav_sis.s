...
# %bb.56:                               #   in Loop: Header=BB1_51 Depth=1
	add.w	$a0, $s5, $s3
	bltu	$s4, $a0, .LBB1_111
# %bb.57:                               #   in Loop: Header=BB1_51 Depth=1
	move	$s0, $s4
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
...
# %bb.60:                               #   in Loop: Header=BB1_51 Depth=1
	...
	ld.d	$a0, $a3, 32
	beqz	$a0, .LBB1_64
# %bb.61:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a2, $a0, 24
	beqz	$a2, .LBB1_64
# %bb.62:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a0, $sp, 128
	bgeu	$a2, $a0, .LBB1_64
# %bb.63:                               #   in Loop: Header=BB1_51 Depth=1
	addi.w	$a1, $a0, 0
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB1_143
.LBB1_64:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a0, $sp, 128
	alsl.d	$a1, $s3, $s3, 1
	bgeu	$a1, $a0, .LBB1_68
# %bb.65:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a2, $a3, 32
	beqz	$a2, .LBB1_69
# %bb.66:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a2, $a2, 24
	beqz	$a2, .LBB1_69
# %bb.67:                               #   in Loop: Header=BB1_51 Depth=1
	bgeu	$a2, $a0, .LBB1_69
.LBB1_68:                               #   in Loop: Header=BB1_51 Depth=1
	st.d	$a1, $sp, 128
	move	$a0, $a1
...
# %bb.70:                               #   in Loop: Header=BB1_51 Depth=1
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB1_131
# %bb.71:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a0, $sp, 128
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	bne	$a0, $a1, .LBB1_75
# %bb.72:                               #   in Loop: Header=BB1_51 Depth=1
	move	$s3, $fp
	b	.LBB1_76
.LBB1_73:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	add.d	$s5, $a0, $a1
	b	.LBB1_76
.LBB1_74:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	move	$a0, $s4
	...
	ori	$fp, $zero, 1
	b	.LBB1_50
.LBB1_75:                               #   in Loop: Header=BB1_51 Depth=1
	addi.w	$a1, $a0, 0
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	ld.d	$s3, $sp, 128
.LBB1_76:                               #   in Loop: Header=BB1_51 Depth=1
	ori	$a1, $zero, 577
	ori	$a2, $zero, 384
	move	$a0, $s4
	...
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	beq	$fp, $a0, .LBB1_116
# %bb.77:                               #   in Loop: Header=BB1_51 Depth=1
	addi.w	$s3, $s3, 0
	move	$a0, $fp
	move	$a1, $s5
	move	$a2, $s3
	...
	jirl	$ra, $ra, 0
	bne	$a0, $s3, .LBB1_117
# %bb.78:                               #   in Loop: Header=BB1_51 Depth=1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	move	$a1, $s4
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	...
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB1_120
# %bb.79:                               #   in Loop: Header=BB1_51 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$s4, $s0
	...
	ori	$fp, $zero, 1
	beqz	$a0, .LBB1_50
# %bb.80:                               #   in Loop: Header=BB1_51 Depth=1
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB1_50
...
# %bb.90:                               # %iter.check32
	...
	bstrpick.d	$t2, $a1, 31, 1
	bltu	$s7, $a2, .LBB1_93
# %bb.91:                               # %vector.memcheck24
	alsl.d	$a2, $t2, $s2, 1
	add.d	$a2, $a2, $a0
	addi.d	$a2, $a2, 2
	addi.d	$t3, $t2, 1
	bgeu	$s6, $a2, .LBB1_134
# %bb.92:                               # %vector.memcheck24
	add.d	$a2, $s2, $a0
	add.d	$a4, $s6, $t3
	bgeu	$a2, $a4, .LBB1_134
.LBB1_93:
	...
	move	$a2, $zero
	move	$s4, $s1
.LBB1_94:                               # %.preheader.i230.preheader
	add.d	$a0, $a4, $a0
	add.d	$a0, $a0, $s2
	addi.d	$a0, $a0, 1
	sub.d	$a1, $t2, $a2
...
.LBB1_95:                               # %.preheader.i230
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB1_95
.LBB1_96:                               # %sis_utf16_decode.exit237
...
.LBB1_113:
	...
	addi.w	$a0, $zero, -114
	b	.LBB1_84
.LBB1_114:                              # %vector.main.loop.iter.check
	ori	$a3, $zero, 31
	vrepli.b	$vr0, 37
	bgeu	$s6, $a3, .LBB1_123
# %bb.115:
...
.LBB1_127:                              # %vec.epilog.ph
	...
	add.d	$a1, $a1, $s2
	addi.d	$a7, $a1, 3
.LBB1_128:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a1, $a7, -2
	ld.b	$a2, $a7, 0
	ld.b	$t0, $a7, 2
	...
	addi.d	$a7, $a7, 8
	bnez	$a6, .LBB1_128
# %bb.129:                              # %vec.epilog.middle.block
	bne	$a3, $t3, .LBB1_14
	b	.LBB1_16
.LBB1_130:
...
.LBB1_133:
	...
	addi.w	$a0, $zero, -123
	b	.LBB1_84
.LBB1_134:                              # %vector.main.loop.iter.check34
	ori	$a2, $zero, 31
	bgeu	$s7, $a2, .LBB1_136
# %bb.135:
	move	$a2, $zero
...
.LBB1_137:                              # %vector.body38
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_137
# %bb.138:                              # %middle.block41
	move	$s4, $s1
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	ld.d	$t3, $sp, 72                    # 8-byte Folded Reload
	beq	$a2, $t3, .LBB1_96
# %bb.139:                              # %vec.epilog.iter.check45
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beqz	$a1, .LBB1_145
.LBB1_140:                              # %vec.epilog.ph47
	move	$a1, $a2
	...
	addi.d	$a7, $a1, 3
	vrepli.b	$vr0, 37
.LBB1_141:                              # %vec.epilog.vector.body50
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a1, $a7, -2
	ld.b	$a3, $a7, 0
	ld.b	$t0, $a7, 2
	...
	addi.d	$a7, $a7, 8
	bnez	$a6, .LBB1_141
# %bb.142:                              # %vec.epilog.middle.block54
	bne	$a2, $t3, .LBB1_94
	b	.LBB1_96
.LBB1_143:
	ld.d	$a0, $a3, 0
