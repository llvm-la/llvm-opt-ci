...
# %bb.40:                               # %iter.check32
	...
	bstrpick.d	$a1, $a1, 31, 1
	bltu	$fp, $a2, .LBB1_43
# %bb.41:                               # %vector.memcheck24
	alsl.d	$a2, $a1, $s2, 1
	add.d	$a2, $a2, $a0
	addi.d	$a2, $a2, 2
	addi.d	$a3, $a1, 1
	bgeu	$s6, $a2, .LBB1_138
# %bb.42:                               # %vector.memcheck24
	add.d	$a2, $s2, $a0
	add.d	$a4, $s6, $a3
	bgeu	$a2, $a4, .LBB1_138
.LBB1_43:
...
.LBB1_137:
	...
	addi.w	$a0, $zero, -123
	b	.LBB1_110
.LBB1_138:                              # %vector.main.loop.iter.check34
	ori	$a2, $zero, 63
	bgeu	$fp, $a2, .LBB1_143
# %bb.139:
	st.d	$a1, $sp, 112                   # 8-byte Folded Spill
...
.LBB1_144:                              # %vector.body38
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_144
# %bb.145:                              # %middle.block41
	beq	$a2, $a3, .LBB1_46
# %bb.146:                              # %vec.epilog.iter.check45
	bnez	$a4, .LBB1_150
# %bb.147:
	slli.d	$a4, $a2, 1
	b	.LBB1_44
