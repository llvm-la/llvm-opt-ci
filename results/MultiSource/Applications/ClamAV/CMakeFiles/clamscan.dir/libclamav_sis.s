...
.LBB1_43:
	move	$a4, $zero
	move	$a3, $zero
.LBB1_44:                               # %.preheader.i230.preheader
	add.d	$a0, $a4, $a0
	add.d	$a0, $a0, $s2
	addi.d	$a0, $a0, 1
	sub.d	$a1, $a1, $a3
...
.LBB1_45:                               # %.preheader.i230
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB1_45
.LBB1_46:                               # %sis_utf16_decode.exit237
...
# %bb.85:                               #   in Loop: Header=BB1_77 Depth=1
	...
	st.d	$s0, $sp, 144
	beqz	$s5, .LBB1_100
# %bb.86:                               #   in Loop: Header=BB1_77 Depth=1
	...
	ld.d	$a0, $a3, 32
	beqz	$a0, .LBB1_90
# %bb.87:                               #   in Loop: Header=BB1_77 Depth=1
	ld.d	$a2, $a0, 24
	beqz	$a2, .LBB1_90
# %bb.88:                               #   in Loop: Header=BB1_77 Depth=1
	ld.d	$a0, $sp, 144
	bgeu	$a2, $a0, .LBB1_90
# %bb.89:                               #   in Loop: Header=BB1_77 Depth=1
	addi.w	$a1, $a0, 0
...
# %bb.91:                               #   in Loop: Header=BB1_77 Depth=1
	ld.d	$a2, $a3, 32
	beqz	$a2, .LBB1_95
# %bb.92:                               #   in Loop: Header=BB1_77 Depth=1
	ld.d	$a2, $a2, 24
	beqz	$a2, .LBB1_95
# %bb.93:                               #   in Loop: Header=BB1_77 Depth=1
	bgeu	$a2, $a0, .LBB1_95
...
.LBB1_101:                              #   in Loop: Header=BB1_77 Depth=1
	...
	jirl	$ra, $ra, 0
	ld.d	$fp, $sp, 144
.LBB1_102:                              #   in Loop: Header=BB1_77 Depth=1
	ld.d	$s5, $sp, 136                   # 8-byte Folded Reload
	ori	$a1, $zero, 577
	ori	$a2, $zero, 384
	move	$a0, $s3
...
.LBB1_136:
	...
	addi.w	$a0, $zero, -123
	b	.LBB1_110
.LBB1_137:                              # %vector.main.loop.iter.check32
	ori	$a4, $zero, 62
	bgeu	$a3, $a4, .LBB1_142
# %bb.138:
	move	$a3, $zero
.LBB1_139:                              # %vec.epilog.ph47
	move	$a7, $a3
	bstrpick.d	$a4, $a2, 30, 4
	slli.d	$a3, $a4, 4
	slli.d	$a2, $a4, 5
	...
	addi.d	$a7, $a7, 15
	vrepli.b	$vr0, 37
.LBB1_140:                              # %vec.epilog.vector.body50
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$t0, $a7, -14
	ld.b	$t1, $a7, -12
	ld.b	$t2, $a7, -10
	...
	addi.d	$a7, $a7, 32
	bnez	$a5, .LBB1_140
# %bb.141:                              # %vec.epilog.middle.block53
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	addi.d	$a2, $a1, 1
	ld.d	$a4, $sp, 112                   # 8-byte Folded Reload
	bne	$a3, $a2, .LBB1_44
	b	.LBB1_46
.LBB1_142:                              # %vector.ph34
	andi	$a5, $a2, 16
	bstrpick.d	$a4, $a2, 30, 5
	slli.d	$a3, $a4, 5
	slli.d	$a4, $a4, 6
...
.LBB1_143:                              # %vector.body37
	...
	addi.d	$a6, $a6, 64
	bnez	$t0, .LBB1_143
# %bb.144:                              # %middle.block40
	beq	$a3, $a2, .LBB1_46
# %bb.145:                              # %vec.epilog.iter.check45
	beqz	$a5, .LBB1_44
	b	.LBB1_139
.LBB1_146:
	ld.d	$a0, $a3, 0
