...
# %bb.132:                              #   in Loop: Header=BB0_110 Depth=1
	...
	andi	$a1, $a1, 8
	bnez	$a1, .LBB0_138
# %bb.133:                              #   in Loop: Header=BB0_110 Depth=1
	ori	$a2, $zero, 95
	beq	$s4, $a2, .LBB0_138
...
.LBB0_136:                              #   in Loop: Header=BB0_110 Depth=1
	ori	$a0, $zero, 128
	beq	$s4, $a0, .LBB0_140
# %bb.137:                              # %..thread140_crit_edge.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	pcaddu18i	$ra, %call36(__ctype_b_loc)
	jirl	$ra, $ra, 0
	ld.d	$a0, $a0, 0
...
.LBB0_138:                              #   in Loop: Header=BB0_110 Depth=1
	move	$s8, $fp
	bnez	$a1, .LBB0_141
.LBB0_139:                              # %.thread140.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a1, $zero, 95
	beq	$s4, $a1, .LBB0_141
.LBB0_140:                              # %.thread.i.i32
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a4, $zero, 133
	beq	$s8, $a4, .LBB0_142
	b	.LBB0_143
...
# %bb.151:                              #   in Loop: Header=BB0_110 Depth=1
	ld.w	$a0, $s7, 120
	beqz	$a0, .LBB0_182
.LBB0_152:                              #   in Loop: Header=BB0_110 Depth=1
	addi.d	$a0, $sp, 104
	move	$a1, $s6
	.p2align	4, , 16
.LBB0_153:                              # %.lr.ph235.i
...
.LBB0_155:                              #   in Loop: Header=BB0_110 Depth=1
	move	$s3, $a0
	bne	$s4, $s1, .LBB0_157
# %bb.156:                              #   in Loop: Header=BB0_110 Depth=1
	ld.w	$a0, $s7, 120
	beqz	$a0, .LBB0_177
.LBB0_157:                              #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $sp, 120
	bnez	$a0, .LBB0_159
# %bb.158:                              #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $sp, 104
	ld.d	$a0, $a0, 112
	slli.d	$a0, $a0, 4
	addi.d	$a0, $a0, 16
	...
	st.d	$a0, $sp, 120
	beqz	$a0, .LBB0_200
.LBB0_159:                              # %.preheader208.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a1, $sp, 104
	ld.d	$a1, $a1, 112
	beqz	$a1, .LBB0_161
# %bb.160:                              # %.lr.ph240.preheader.i
                                        #   in Loop: Header=BB0_110 Depth=1
	addi.d	$a0, $a0, 16
	addi.d	$a1, $a1, 1
	ori	$a3, $zero, 2
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_161:                              # %._crit_edge241.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.w	$a0, $s7, 120
	bnez	$a0, .LBB0_164
# %bb.162:                              #   in Loop: Header=BB0_110 Depth=1
	ld.bu	$a0, $sp, 113
	andi	$a0, $a0, 4
	bnez	$a0, .LBB0_164
...
# %bb.168:                              #   in Loop: Header=BB0_110 Depth=1
	beqz	$a0, .LBB0_199
.LBB0_169:                              #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a1, $sp, 152
	addi.d	$a0, $sp, 104
	move	$a2, $s3
	move	$a3, $s2
...
.LBB0_174:                              #   in Loop: Header=BB0_110 Depth=1
	move	$s3, $zero
.LBB0_175:                              #   in Loop: Header=BB0_110 Depth=1
	addi.d	$s5, $a1, 1
	bne	$a1, $fp, .LBB0_110
.LBB0_176:                              # %.loopexit.i38
	beqz	$s4, .LBB0_182
.LBB0_177:                              # %.thread202.i
	ld.d	$a0, $sp, 152
	ld.d	$a1, $sp, 128
	sub.d	$a0, $a0, $a1
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
...
.LBB0_184:
	...
	move	$a1, $zero
	beqz	$a0, .LBB0_186
.LBB0_185:                              # %.sink.split.sink.split.i
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a1, $fp
.LBB0_186:                              # %.sink.split.i
	ld.d	$a0, $sp, 176
	move	$fp, $a1
	b	.LBB0_197
.LBB0_187:
...
.LBB0_195:
	...
	move	$a0, $zero
	beqz	$a1, .LBB0_198
# %bb.196:                              # %.loopexit189.sink.split.i
	move	$a0, $a1
.LBB0_197:
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
.Lfunc_end0:
	.size	cli_regexec, .Lfunc_end0-cli_regexec
                                        # -- End function
	.p2align	2                               # -- Begin function sslow
...
.Lfunc_end1:
	.size	sslow, .Lfunc_end1-sslow
                                        # -- End function
	.p2align	2                               # -- Begin function sdissect
...
.LBB2_19:                               # %._crit_edge
	...
	b	.LBB2_3
.LBB2_20:                               # %.preheader154.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$a2, $s0
	.p2align	4, , 16
.LBB2_21:                               # %.preheader154
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s1
	move	$a1, $s2
...
.LJTI2_0:
	...
	.word	.LBB2_14-.LJTI2_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function sbackref
...
.LJTI3_1:
	...
	.word	.LBB3_72-.LJTI3_1
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function sstep
...
.LJTI4_0:
	...
	.word	.LBB4_27-.LJTI4_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function lslow
...
.Lfunc_end5:
	.size	lslow, .Lfunc_end5-lslow
                                        # -- End function
	.p2align	2                               # -- Begin function ldissect
...
.LBB6_19:                               # %._crit_edge
	...
	lu12i.w	$s8, 360448
	b	.LBB6_31
.LBB6_20:                               # %.preheader154.preheader
                                        #   in Loop: Header=BB6_4 Depth=1
	move	$a2, $s0
	.p2align	4, , 16
.LBB6_21:                               # %.preheader154
                                        #   Parent Loop BB6_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s1
	move	$a1, $s2
...
.LBB6_25:                               #   in Loop: Header=BB6_4 Depth=1
	...
	b	.LBB6_3
.LBB6_26:                               # %.preheader155.preheader
                                        #   in Loop: Header=BB6_4 Depth=1
	move	$a2, $s0
	.p2align	4, , 16
.LBB6_27:                               # %.preheader155
                                        #   Parent Loop BB6_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s1
	move	$a1, $s2
...
.LJTI6_0:
	...
	.word	.LBB6_14-.LJTI6_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function lbackref
...
.LJTI7_1:
	...
	.word	.LBB7_72-.LJTI7_1
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function lstep
