...
# %bb.193:                              #   in Loop: Header=BB7_67 Depth=3
	ori	$a0, $zero, 3
	bne	$s3, $a0, .LBB7_213
# %bb.194:                              # %.preheader1343
                                        #   in Loop: Header=BB7_67 Depth=3
	ori	$a0, $zero, 15
	blt	$a0, $s7, .LBB7_219
# %bb.195:                              # %.lr.ph2954.preheader
                                        #   in Loop: Header=BB7_67 Depth=3
	ori	$a0, $zero, 16
	sub.d	$s2, $a0, $s7
	b	.LBB7_198
...
.LBB7_206:                              #   in Loop: Header=BB7_67 Depth=3
	...
	ori	$a1, $zero, 8
	bltu	$a0, $a1, .LBB7_211
# %bb.207:                              # %.preheader1338.preheader
                                        #   in Loop: Header=BB7_67 Depth=3
	lu12i.w	$a1, 8192
.LBB7_208:                              # %.preheader1338
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_67 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB7_212:                              #   in Loop: Header=BB7_67 Depth=3
	...
	ori	$s3, $zero, 1
	b	.LBB7_227
.LBB7_213:                              # %.preheader1340
                                        #   in Loop: Header=BB7_67 Depth=3
	bge	$s7, $s3, .LBB7_224
# %bb.214:                              # %.lr.ph2964.preheader
                                        #   in Loop: Header=BB7_67 Depth=3
	ori	$a0, $zero, 16
	sub.d	$s2, $a0, $s7
	b	.LBB7_217
...
.LBB7_219:                              # %._crit_edge2955
	...
	ori	$a0, $zero, 8
	bltu	$a1, $a0, .LBB7_225
# %bb.220:                              # %.preheader1341.preheader
                                        #   in Loop: Header=BB7_67 Depth=3
	lu12i.w	$a0, 8192
	addi.d	$s4, $fp, 240
	ori	$s3, $zero, 1
	ld.d	$s2, $sp, 32                    # 8-byte Folded Reload
.LBB7_221:                              # %.preheader1341
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_67 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB7_304:                              #   in Loop: Header=BB7_62 Depth=2
	addi.d	$s4, $fp, 240
	b	.LBB7_494
.LBB7_305:                              # %.preheader1354
                                        #   in Loop: Header=BB7_62 Depth=2
	blez	$a0, .LBB7_493
# %bb.306:                              # %.preheader1333.preheader
                                        #   in Loop: Header=BB7_62 Depth=2
...
.LBB7_319:                              # %._crit_edge3047
	...
	ori	$a1, $zero, 656
	bltu	$s3, $a1, .LBB7_361
# %bb.320:                              # %.preheader1331.preheader
                                        #   in Loop: Header=BB7_307 Depth=3
	bstrpick.d	$a1, $s3, 14, 4
	ori	$a2, $zero, 168
	bltu	$a2, $a1, .LBB7_626
...
.LBB7_363:                              #   in Loop: Header=BB7_307 Depth=3
	...
	ori	$a2, $zero, 7
	bne	$s4, $a2, .LBB7_419
# %bb.364:                              # %.preheader1329
                                        #   in Loop: Header=BB7_307 Depth=3
	ori	$a2, $zero, 15
	blt	$a2, $s7, .LBB7_376
# %bb.365:                              # %.lr.ph3056.preheader
                                        #   in Loop: Header=BB7_307 Depth=3
	sub.d	$a0, $a1, $a0
	addi.d	$s4, $a0, 16
	b	.LBB7_368
...
.LBB7_439:                              # %vector.body4071
	...
	addi.d	$a4, $a4, 32
	bnez	$t1, .LBB7_439
# %bb.440:                              # %middle.block4078
                                        #   in Loop: Header=BB7_307 Depth=3
	bne	$a7, $a5, .LBB7_457
	b	.LBB7_459
.LBB7_441:                              # %iter.check4088
                                        #   in Loop: Header=BB7_307 Depth=3
	bstrpick.d	$a5, $a5, 31, 0
	sub.d	$a2, $a1, $a5
	ori	$a6, $zero, 6
	bltu	$s4, $a6, .LBB7_445
# %bb.442:                              # %iter.check4088
                                        #   in Loop: Header=BB7_307 Depth=3
	ori	$a6, $zero, 32
	bltu	$a3, $a6, .LBB7_445
# %bb.443:                              # %vector.main.loop.iter.check4090
                                        #   in Loop: Header=BB7_307 Depth=3
	sub.d	$a3, $zero, $a5
	ori	$a5, $zero, 30
	bgeu	$s4, $a5, .LBB7_447
...
.LBB7_448:                              # %vector.body4094
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB7_448
# %bb.449:                              # %middle.block4101
                                        #   in Loop: Header=BB7_307 Depth=3
	beq	$a6, $a0, .LBB7_475
# %bb.450:                              # %vec.epilog.iter.check4105
                                        #   in Loop: Header=BB7_307 Depth=3
	beqz	$a5, .LBB7_477
.LBB7_451:                              # %vec.epilog.ph4107
                                        #   in Loop: Header=BB7_307 Depth=3
	bstrpick.d	$t0, $a0, 15, 3
	slli.d	$a7, $t0, 3
	sub.d	$a5, $a0, $a7
	...
	ld.d	$a6, $sp, 120                   # 8-byte Folded Reload
	add.d	$a4, $a6, $a4
.LBB7_452:                              # %vec.epilog.vector.body4111
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_307 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a4, $a4, 8
	bnez	$t0, .LBB7_452
# %bb.453:                              # %vec.epilog.middle.block4117
                                        #   in Loop: Header=BB7_307 Depth=3
	beq	$a7, $a0, .LBB7_475
.LBB7_454:                              # %.lr.ph3077.preheader
                                        #   in Loop: Header=BB7_307 Depth=3
	addi.d	$a3, $a5, 1
.LBB7_455:                              # %.lr.ph3077
                                        #   Parent Loop BB7_11 Depth=1
...
.LBB7_456:                              #   in Loop: Header=BB7_307 Depth=3
	move	$a6, $a5
.LBB7_457:                              # %.lr.ph3082.preheader4242
                                        #   in Loop: Header=BB7_307 Depth=3
	addi.d	$a4, $a6, 1
.LBB7_458:                              # %.lr.ph3082
                                        #   Parent Loop BB7_11 Depth=1
...
.LBB7_497:                              #   in Loop: Header=BB7_62 Depth=2
	...
	bgtz	$a0, .LBB7_62
	b	.LBB7_588
.LBB7_498:                              # %._crit_edge2877.loopexit
                                        #   in Loop: Header=BB7_62 Depth=2
	addi.w	$a0, $s3, 16
.LBB7_499:                              # %._crit_edge2877
                                        #   in Loop: Header=BB7_62 Depth=2
	slli.d	$s3, $s1, 16
	ori	$a1, $zero, 23
	blt	$a1, $a0, .LBB7_511
# %bb.500:                              # %.lr.ph2887.preheader
                                        #   in Loop: Header=BB7_62 Depth=2
	addi.d	$s4, $a0, -32
	sub.d	$s6, $s2, $a0
	b	.LBB7_504
...
.LBB7_511:                              #   in Loop: Header=BB7_62 Depth=2
	addi.w	$a0, $a0, -16
	b	.LBB7_513
.LBB7_512:                              # %._crit_edge2888.loopexit
                                        #   in Loop: Header=BB7_62 Depth=2
	addi.w	$a0, $s4, 16
	ld.d	$s6, $sp, 168                   # 8-byte Folded Reload
.LBB7_513:                              # %._crit_edge2888
                                        #   in Loop: Header=BB7_62 Depth=2
...
# %bb.515:                              # %._crit_edge2888
	...
	ori	$a0, $zero, 2
	bne	$a1, $a0, .LBB7_640
# %bb.516:                              # %.preheader1352.preheader
                                        #   in Loop: Header=BB7_62 Depth=2
	move	$s1, $zero
	b	.LBB7_518
.LBB7_517:                              # %._crit_edge2911
...
# %bb.541:                              #   in Loop: Header=BB7_534 Depth=3
	...
	ori	$a0, $zero, 2
	b	.LBB7_532
.LBB7_542:                              # %._crit_edge2898.loopexit
                                        #   in Loop: Header=BB7_62 Depth=2
	addi.w	$s4, $s1, 16
.LBB7_543:                              # %._crit_edge2898
                                        #   in Loop: Header=BB7_62 Depth=2
	addi.d	$a0, $s4, -16
	sltui	$a0, $a0, 1
	addi.w	$a1, $zero, -2
...
# %bb.587:                              #   in Loop: Header=BB7_62 Depth=2
	...
	beqz	$a0, .LBB7_63
	b	.LBB7_641
.LBB7_588:                              # %._crit_edge3118.loopexit
                                        #   in Loop: Header=BB7_11 Depth=1
	ld.w	$a0, $fp, 48
.LBB7_589:                              # %._crit_edge3118
                                        #   in Loop: Header=BB7_11 Depth=1
	sub.w	$a1, $s2, $a0
...
# %bb.593:                              #   in Loop: Header=BB7_11 Depth=1
	ld.d	$s8, $fp, 112
	ld.d	$s5, $fp, 120
.LBB7_594:                              # %.loopexit1366.loopexit
                                        #   in Loop: Header=BB7_11 Depth=1
	ld.hu	$a0, $s8, 0
	ori	$a1, $zero, 16
	sub.d	$a1, $a1, $s7
...
.LBB7_618:                              #   in Loop: Header=BB7_11 Depth=1
	...
	lu12i.w	$a2, 8
	bltu	$a0, $a1, .LBB7_11
# %bb.619:                              # %._crit_edge3143
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	beqz	$a0, .LBB7_637
.LBB7_620:                              # %._crit_edge3143.thread
