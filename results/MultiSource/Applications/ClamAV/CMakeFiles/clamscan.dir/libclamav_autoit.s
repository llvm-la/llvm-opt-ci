...
# %bb.301:                              #   in Loop: Header=BB0_277 Depth=2
	...
	b	.LBB0_308
.LBB0_302:                              #   in Loop: Header=BB0_277 Depth=2
	move	$s4, $a0
	b	.LBB0_312
.LBB0_303:                              # %.lr.ph.preheader.i381.i
                                        #   in Loop: Header=BB0_277 Depth=2
	move	$a3, $zero
	move	$a2, $zero
	sltui	$a4, $t3, 20
	...
	or	$a4, $a4, $a5
	b	.LBB0_305
.LBB0_304:                              #   in Loop: Header=BB0_305 Depth=3
	add.d	$a5, $a1, $a3
	ld.bu	$a5, $a5, 1
	sltui	$a5, $a5, 1
	addi.d	$a3, $a3, 2
...
# %bb.306:                              #   in Loop: Header=BB0_305 Depth=3
	...
	add.d	$a2, $a5, $a2
	bltu	$a3, $a4, .LBB0_305
.LBB0_307:                              # %._crit_edge.i387.i
                                        #   in Loop: Header=BB0_277 Depth=2
	slli.w	$a3, $a2, 2
	move	$a2, $a1
	bltu	$a3, $a4, .LBB0_311
.LBB0_308:                              # %.lr.ph49.preheader.i389.i
                                        #   in Loop: Header=BB0_277 Depth=2
	move	$a3, $zero
	move	$a4, $a1
.LBB0_309:                              # %.lr.ph49.i392.i
                                        #   Parent Loop BB0_14 Depth=1
                                        #     Parent Loop BB0_277 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.b	$a5, $a2, $a3
	...
	bltu	$a3, $t2, .LBB0_309
	b	.LBB0_311
.LBB0_310:                              # %._crit_edge820.thread.i
                                        #   in Loop: Header=BB0_277 Depth=2
	add.d	$a1, $s5, $a1
.LBB0_311:                              # %u2a.exit398.i
                                        #   in Loop: Header=BB0_277 Depth=2
	...
	add.w	$a4, $a0, $a4
	ori	$a2, $zero, 32
.LBB0_312:                              #   in Loop: Header=BB0_277 Depth=2
	ori	$s7, $zero, 8
	ori	$a0, $zero, 52
	beq	$s6, $a0, .LBB0_275
# %bb.313:                              #   in Loop: Header=BB0_277 Depth=2
	...
	move	$a5, $s4
	bne	$s6, $a0, .LBB0_315
# %bb.314:                              #   in Loop: Header=BB0_277 Depth=2
	bstrpick.d	$a0, $t1, 31, 0
	addi.w	$t1, $t1, 1
	ori	$a3, $zero, 34
	stx.b	$a3, $a5, $a0
.LBB0_315:                              #   in Loop: Header=BB0_277 Depth=2
	...
	stx.b	$a2, $a5, $a0
	b	.LBB0_276
.LBB0_316:                              #   in Loop: Header=BB0_277 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bltu	$a0, $s7, .LBB0_356
...
# %bb.319:                              #   in Loop: Header=BB0_277 Depth=2
	...
	move	$a4, $a3
	b	.LBB0_332
.LBB0_320:                              #   in Loop: Header=BB0_277 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bltu	$a0, $s7, .LBB0_355
...
# %bb.322:                              #   in Loop: Header=BB0_277 Depth=2
	...
	addi.w	$a1, $a2, 0
	bgeu	$a0, $a1, .LBB0_333
# %bb.323:                              #   in Loop: Header=BB0_277 Depth=2
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	move	$a4, $a3
	b	.LBB0_334
.LBB0_324:                              #   in Loop: Header=BB0_277 Depth=2
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	bgeu	$s4, $a0, .LBB0_357
# %bb.325:                              #   in Loop: Header=BB0_277 Depth=2
	...
	addi.w	$a1, $a2, 0
	bgeu	$a0, $a1, .LBB0_336
# %bb.326:                              #   in Loop: Header=BB0_277 Depth=2
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	move	$a4, $a3
	b	.LBB0_337
.LBB0_327:                              #   in Loop: Header=BB0_277 Depth=2
	addi.w	$s6, $t1, 1
	addi.w	$a0, $a2, 0
	bgeu	$s6, $a0, .LBB0_329
# %bb.328:                              #   in Loop: Header=BB0_277 Depth=2
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	move	$a5, $a3
	b	.LBB0_330
.LBB0_329:                              #   in Loop: Header=BB0_277 Depth=2
	addi.w	$a2, $a2, 512
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	bstrpick.d	$a1, $a2, 31, 0
	move	$a0, $a3
...
.LBB0_330:                              # %.thread690.i
	...
	stx.b	$a1, $a5, $a0
	b	.LBB0_284
.LBB0_331:                              #   in Loop: Header=BB0_277 Depth=2
	addi.w	$a2, $a2, 512
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	bstrpick.d	$a1, $a2, 31, 0
	move	$a0, $a3
...
.LBB0_333:                              #   in Loop: Header=BB0_277 Depth=2
	...
	move	$a4, $a0
	beqz	$a0, .LBB0_344
.LBB0_334:                              #   in Loop: Header=BB0_277 Depth=2
	addi.d	$a0, $s2, 5
	bstrpick.d	$a0, $a0, 31, 0
	ldx.w	$a0, $s5, $a0
	bstrpick.d	$a1, $s4, 31, 0
	...
	move	$a5, $s6
	addi.w	$s6, $s4, 19
.LBB0_335:                              # %.thread676.i
                                        #   in Loop: Header=BB0_277 Depth=2
	addi.w	$a4, $s2, 9
	ori	$s7, $zero, 8
	b	.LBB0_276
.LBB0_336:                              #   in Loop: Header=BB0_277 Depth=2
	addi.w	$a2, $a2, 512
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	bstrpick.d	$a1, $a2, 31, 0
	move	$a0, $a3
...
.LBB0_506:                              # %vector.body668
	...
	addi.w	$a6, $a6, 32
	bnez	$a7, .LBB0_506
# %bb.507:                              # %middle.block673
                                        #   in Loop: Header=BB0_405 Depth=2
	beq	$a0, $a3, .LBB0_512
# %bb.508:                              # %vec.epilog.iter.check679
                                        #   in Loop: Header=BB0_405 Depth=2
	beqz	$a4, .LBB0_513
.LBB0_509:                              # %vec.epilog.ph681
                                        #   in Loop: Header=BB0_405 Depth=2
	move	$a4, $a0
	bstrins.d	$a4, $zero, 2, 0
	andi	$a1, $a0, 7
	...
	add.w	$a3, $s6, $a3
	sub.w	$a6, $zero, $t5
.LBB0_510:                              # %vec.epilog.vector.body684
                                        #   Parent Loop BB0_362 Depth=1
                                        #     Parent Loop BB0_405 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a7, $a6, $a3
	...
	addi.w	$a3, $a3, 8
	bnez	$a5, .LBB0_510
# %bb.511:                              # %vec.epilog.middle.block688
                                        #   in Loop: Header=BB0_405 Depth=2
	bne	$a0, $a4, .LBB0_513
