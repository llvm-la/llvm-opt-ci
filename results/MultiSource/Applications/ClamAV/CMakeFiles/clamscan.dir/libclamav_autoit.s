...
.LBB0_524:                              # %vector.body720
	...
	addi.w	$a6, $a6, 64
	bnez	$a7, .LBB0_524
# %bb.525:                              # %middle.block725
                                        #   in Loop: Header=BB0_423 Depth=2
	beq	$a0, $a3, .LBB0_530
# %bb.526:                              # %vec.epilog.iter.check732
                                        #   in Loop: Header=BB0_423 Depth=2
	beqz	$a4, .LBB0_531
.LBB0_527:                              # %vec.epilog.ph734
                                        #   in Loop: Header=BB0_423 Depth=2
	move	$a4, $a0
	bstrins.d	$a4, $zero, 3, 0
	andi	$a1, $a0, 15
	...
	add.w	$a3, $s6, $a3
	sub.w	$a6, $zero, $t5
.LBB0_528:                              # %vec.epilog.vector.body737
                                        #   Parent Loop BB0_380 Depth=1
                                        #     Parent Loop BB0_423 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a7, $a6, $a3
	...
	addi.w	$a3, $a3, 16
	bnez	$a5, .LBB0_528
# %bb.529:                              # %vec.epilog.middle.block741
                                        #   in Loop: Header=BB0_423 Depth=2
	bne	$a0, $a4, .LBB0_531
