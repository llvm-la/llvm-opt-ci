...
# %bb.5:                                # %iter.check
	...
	st.w	$zero, $a0, 0
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.w	$s7, $a1, %pc_lo12(q)
	sub.d	$a3, $zero, $s7
	ld.w	$a2, $t8, %pc_lo12(r)
	ld.d	$a6, $s3, %pc_lo12(DD)
	addi.d	$a7, $s0, 1
...
.LBB8_59:
                                        # implicit-def: $r4
                                        # kill: killed $r4
.LBB8_60:                               # %tailrecurse._crit_edge
...
.LBB8_67:                               # =>This Loop Header: Depth=1
	...
	move	$t1, $a4
	.p2align	4, , 16
.LBB8_68:                               #   Parent Loop BB8_67 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t1, $t1, 8
