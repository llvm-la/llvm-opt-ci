...
# %bb.109:                              # %middle.block480
	beq	$a2, $a1, .LBB21_116
# %bb.110:                              # %vec.epilog.iter.check484
	beqz	$a3, .LBB21_114
.LBB21_111:                             # %vec.epilog.ph486
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s0, 2
	.p2align	4, , 16
.LBB21_112:                             # %vec.epilog.vector.body489
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB21_112
# %bb.113:                              # %vec.epilog.middle.block493
	beq	$a2, $a1, .LBB21_116
...
# %bb.122:
	move	$a1, $zero
	b	.LBB21_132
.LBB21_123:                             # %vector.main.loop.iter.check500
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB21_125
# %bb.124:
	move	$a1, $zero
	b	.LBB21_129
.LBB21_125:                             # %vector.ph501
	andi	$a2, $s2, 12
...
.LBB21_126:                             # %vector.body504
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB21_126
# %bb.127:                              # %middle.block507
	beq	$a1, $s2, .LBB21_134
# %bb.128:                              # %vec.epilog.iter.check511
	beqz	$a2, .LBB21_132
.LBB21_129:                             # %vec.epilog.ph513
	move	$a3, $a1
	...
	alsl.d	$a3, $a3, $a0, 2
	.p2align	4, , 16
.LBB21_130:                             # %vec.epilog.vector.body516
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a3, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB21_130
# %bb.131:                              # %vec.epilog.middle.block521
	beq	$a1, $s2, .LBB21_134
.LBB21_132:                             # %vec.epilog.scalar.ph510.preheader
	alsl.d	$a0, $a1, $a0, 2
	sub.d	$a2, $s2, $a1
	.p2align	4, , 16
.LBB21_133:                             # %vec.epilog.scalar.ph510
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a1, $a0, 0
	addi.d	$a1, $a1, 1
	addi.d	$a2, $a2, -1
...
# %bb.136:
	move	$a1, $zero
	b	.LBB21_146
.LBB21_137:                             # %vector.main.loop.iter.check528
	ori	$a1, $zero, 16
	bgeu	$s1, $a1, .LBB21_139
# %bb.138:
	move	$a1, $zero
	b	.LBB21_143
.LBB21_139:                             # %vector.ph529
	andi	$a2, $s1, 12
	pcalau12i	$a1, %pc_hi20(.LCPI21_1)
	xvld	$xr0, $a1, %pc_lo12(.LCPI21_1)
...
.LBB21_140:                             # %vector.body532
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB21_140
# %bb.141:                              # %middle.block538
	beq	$a1, $s1, .LBB21_148
# %bb.142:                              # %vec.epilog.iter.check542
	beqz	$a2, .LBB21_146
.LBB21_143:                             # %vec.epilog.ph544
	...
	alsl.d	$a3, $a3, $a0, 2
	.p2align	4, , 16
.LBB21_144:                             # %vec.epilog.vector.body550
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a3, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB21_144
# %bb.145:                              # %vec.epilog.middle.block555
	beq	$a1, $s1, .LBB21_148
.LBB21_146:                             # %vec.epilog.scalar.ph541.preheader
	alsl.d	$a0, $a1, $a0, 2
	sub.d	$a2, $s1, $a1
	.p2align	4, , 16
.LBB21_147:                             # %vec.epilog.scalar.ph541
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a1, $a0, 0
	addi.d	$a1, $a1, 1
	addi.d	$a2, $a2, -1
