...
.Ltmp7:                                 # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp8:                                 # EH_LABEL
# %bb.5:                                # %_ZNK23btGImpactShapeInterface20getPrimitiveTriangleEiR19btPrimitiveTriangle.exit
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.d	$a0, $sp, 104
	ld.d	$a1, $s0, 0
	ldx.w	$a3, $a0, $s4
...
.Ltmp18:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp19:                                # EH_LABEL
.LBB4_19:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit19
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB4_20:
...
.Ltmp21:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp22:                                # EH_LABEL
.LBB7_3:                                # %_ZN20btAlignedObjectArrayIP16btCollisionShapeED2Ev.exit
	ld.d	$a0, $fp, 208
	beqz	$a0, .LBB7_6
# %bb.4:                                # %_ZN20btAlignedObjectArrayIP16btCollisionShapeED2Ev.exit
	ld.b	$a1, $fp, 216
	andi	$a1, $a1, 1
	beqz	$a1, .LBB7_6
# %bb.5:
.Ltmp26:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp27:                                # EH_LABEL
.LBB7_6:                                # %_ZN20btAlignedObjectArrayI11btTransformED2Ev.exit
	pcalau12i	$a0, %pc_hi20(_ZTV23btGImpactShapeInterface+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV23btGImpactShapeInterface+16)
	ld.d	$a0, $fp, 104
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB7_9
# %bb.7:                                # %_ZN20btAlignedObjectArrayI11btTransformED2Ev.exit
	ld.b	$a1, $fp, 112
	andi	$a1, $a1, 1
	beqz	$a1, .LBB7_9
# %bb.8:
...
.Ltmp24:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp25:                                # EH_LABEL
.LBB7_16:                               # %_ZN20btAlignedObjectArrayI11btTransformED2Ev.exit10
.Ltmp29:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN23btGImpactShapeInterfaceD2Ev)
	jirl	$ra, $ra, 0
.Ltmp30:                                # EH_LABEL
.LBB7_17:                               # %common.resume
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB7_18:
...
.Ltmp62:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp63:                                # EH_LABEL
.LBB57_19:                              # %_ZN20btAlignedObjectArrayIP22btGImpactMeshShapePartED2Ev.exit15
.Ltmp64:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN23btGImpactShapeInterfaceD2Ev)
	jirl	$ra, $ra, 0
.Ltmp65:                                # EH_LABEL
.LBB57_20:                              # %common.resume
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB57_21:
...
.Ltmp76:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp77:                                # EH_LABEL
.LBB80_3:                               # %_ZN21btGImpactQuantizedBvhD2Ev.exit
	move	$a0, $fp
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
...
.Ltmp81:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Lfunc_end80:
	.size	_ZN23btGImpactShapeInterfaceD2Ev, .Lfunc_end80-_ZN23btGImpactShapeInterfaceD2Ev
	.cfi_endproc
...
.Lcst_begin8:
	...
	.uleb128 .Lfunc_end80-.Ltmp80           #   Call between .Ltmp80 and .Lfunc_end80
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end8:
	.byte	1                               # >> Action Record 1 <<
...
# %bb.0:
	ud	0
.Lfunc_end81:
	.size	_ZN23btGImpactShapeInterfaceD0Ev, .Lfunc_end81-_ZN23btGImpactShapeInterfaceD0Ev
                                        # -- End function
...
.LBB82_2:
	...
	ld.w	$a5, $a1, 4
	ld.w	$a1, $a1, 8
.LBB82_3:                               # %_ZNK22btGImpactMeshShapePart23TrimeshPrimitiveManager11get_indicesEiRiS1_S1_.exit
	ld.w	$a4, $a0, 64
	ld.w	$a7, $a0, 60
	ld.d	$a3, $a0, 48
	fld.s	$fa0, $a0, 24
...
.LBB82_5:
	...
	fld.s	$fa1, $a0, 32
	fmul.s	$fa0, $fa0, $fa1
.LBB82_6:                               # %_ZNK22btGImpactMeshShapePart23TrimeshPrimitiveManager10get_vertexEiR9btVector3.exit8
	ld.d	$a1, $a2, 0
	fst.s	$fa0, $a2, 104
	fld.s	$fa0, $a0, 8
	ld.d	$a1, $a1, 80
	...
	jr	$a1
.Lfunc_end82:
	.size	_ZNK22btGImpactMeshShapePart23TrimeshPrimitiveManager19get_bullet_triangleEiR17btTriangleShapeEx, .Lfunc_end82-_ZNK22btGImpactMeshShapePart23TrimeshPrimitiveManager19get_bullet_triangleEiR17btTriangleShapeEx
	.cfi_endproc
                                        # -- End function
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV22btGImpactCompoundShape
	...
	.addrsig_sym _ZTV18btGImpactMeshShape
	...
	.addrsig_sym _ZTV23btGImpactShapeInterface
