...
.Ltmp3:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp4:                                 # EH_LABEL
.LBB0_5:                                # %_ZN20btAlignedObjectArrayIP20btCollisionAlgorithmED2Ev.exit
.Ltmp5:                                 # EH_LABEL
	move	$a0, $fp
...
.LBB1_24:
	...
	st.d	$s6, $s0, 200
	beq	$s2, $s3, .LBB1_26
.LBB1_25:                               # %.lr.ph.splitthread-pre-split
	ld.d	$a0, $s4, 88
	addi.d	$s3, $s3, 8
	addi.d	$s5, $s5, 88
	bnez	$a0, .LBB1_23
...
.LBB4_6:                                # %_ZN28btCompoundCollisionAlgorithm21removeChildAlgorithmsEv.exit
	ld.d	$a0, $fp, 32
	beqz	$a0, .LBB4_9
# %bb.7:                                # %_ZN28btCompoundCollisionAlgorithm21removeChildAlgorithmsEv.exit
	ld.b	$a1, $fp, 40
	andi	$a1, $a1, 1
	beqz	$a1, .LBB4_9
# %bb.8:
.Ltmp15:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp16:                                # EH_LABEL
.LBB4_9:                                # %_ZN20btAlignedObjectArrayIP20btCollisionAlgorithmED2Ev.exit
	move	$a0, $fp
	ld.d	$s1, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
...
.Ltmp13:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp14:                                # EH_LABEL
.LBB4_14:                               # %_ZN20btAlignedObjectArrayIP20btCollisionAlgorithmED2Ev.exit9
.Ltmp18:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN30btActivatingCollisionAlgorithmD2Ev)
	jirl	$ra, $ra, 0
...
# %bb.8:                                # %.lr.ph152
	...
	b	.LBB6_11
	.p2align	4, , 16
.LBB6_9:                                # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE5clearEv.exit
...
.Ltmp26:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp27:                                # EH_LABEL
# %bb.18:                               # %_ZN16btManifoldResult20refreshContactPointsEv.exit
                                        #   in Loop: Header=BB6_16 Depth=2
	ld.w	$a1, $sp, 84
	st.d	$zero, $s1, 8
	b	.LBB6_15
...
.Ltmp30:                                # EH_LABEL
	b	.LBB6_9
.LBB6_22:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
	beqz	$s0, .LBB6_25
# %bb.23:
	fld.s	$fa2, $s4, 8
...
# %bb.29:                               # %.lr.ph159
	...
	b	.LBB6_32
	.p2align	4, , 16
.LBB6_30:                               # %_Z20TestAabbAgainstAabb2RK9btVector3S1_S1_S1_.exit.thread
...
# %bb.40:                               #   in Loop: Header=BB6_32 Depth=1
	...
	beqz	$a0, .LBB6_30
	b	.LBB6_31
.LBB6_41:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit115
...
.LBB6_43:
.Ltmp37:                                # EH_LABEL
.LBB6_44:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit111
	move	$fp, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
...
.Ltmp32:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp33:                                # EH_LABEL
.LBB6_50:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit111
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_51:
...
.Ltmp50:                                # EH_LABEL
	.p2align	4, , 16
.LBB7_4:                                # %_Z9IntersectRK12btDbvtAabbMmS1_.exit.thread
...
# %bb.21:                               # %middle.block139
                                        #   in Loop: Header=BB7_5 Depth=1
	beq	$a0, $a1, .LBB7_24
.LBB7_22:                               # %scalar.ph129.preheader
                                        #   in Loop: Header=BB7_5 Depth=1
	sub.d	$a1, $a1, $a0
	alsl.d	$a2, $a0, $s1, 3
	alsl.d	$a0, $a0, $s2, 3
	.p2align	4, , 16
.LBB7_23:                               # %scalar.ph129
                                        #   Parent Loop BB7_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a2, 0
	st.d	$a3, $a0, 0
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB7_23
.LBB7_24:                               # %_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE4copyEiiPS2_.exit.i.i30
                                        #   in Loop: Header=BB7_5 Depth=1
.Ltmp43:                                # EH_LABEL
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp44:                                # EH_LABEL
.LBB7_25:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE10deallocateEv.exit.i.i33
                                        #   in Loop: Header=BB7_5 Depth=1
	ld.d	$a0, $s0, 40
	addi.w	$a1, $s4, 0
	stx.d	$a0, $s2, $s3
...
.LBB7_33:                               # %scalar.ph
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB7_33
.LBB7_34:                               # %_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE4copyEiiPS2_.exit.thread.i.i64
                                        #   in Loop: Header=BB7_5 Depth=1
.Ltmp47:                                # EH_LABEL
	move	$s1, $s2
	move	$a0, $s2
...
.Ltmp48:                                # EH_LABEL
	move	$s2, $s3
	b	.LBB7_36
.LBB7_35:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE10deallocateEv.exit.i.i33._ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit70_crit_edge
                                        #   in Loop: Header=BB7_5 Depth=1
	move	$s7, $s6
.LBB7_36:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit70
                                        #   in Loop: Header=BB7_5 Depth=1
	ld.d	$a0, $s0, 48
	slli.d	$a1, $s7, 3
	stx.d	$a0, $s2, $a1
	...
	move	$s8, $s4
	b	.LBB7_4
.LBB7_37:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeED2Ev.exit
	move	$a0, $s1
	fld.d	$fs5, $sp, 8                    # 8-byte Folded Reload
	fld.d	$fs4, $sp, 16                   # 8-byte Folded Reload
	fld.d	$fs3, $sp, 24                   # 8-byte Folded Reload
...
.Ltmp52:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp53:                                # EH_LABEL
# %bb.39:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeED2Ev.exit75
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB7_40:
...
.LBB8_13:
	...
	vst	$vr2, $a0, 104
	vst	$vr3, $a0, 120
.LBB8_14:                               # %_Z20TestAabbAgainstAabb2RK9btVector3S1_S1_S1_.exit.thread
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV28btCompoundCollisionAlgorithm
	...
	.addrsig_sym _ZTV22btCompoundLeafCallback
