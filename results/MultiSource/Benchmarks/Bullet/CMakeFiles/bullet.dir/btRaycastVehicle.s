...
# %bb.37:                               # %vec.epilog.middle.block
	beq	$a0, $a2, .LBB25_40
.LBB25_38:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $a2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB25_39:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB25_39
.LBB25_40:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i
	ld.bu	$a0, $fp, 96
	beqz	$a0, .LBB25_42
.LBB25_41:
	move	$a0, $a1
...
# %bb.47:                               # %iter.check316
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB25_60
# %bb.48:                               # %vector.main.loop.iter.check318
	ori	$a0, $zero, 16
	bgeu	$a2, $a0, .LBB25_53
# %bb.49:
	move	$a0, $zero
	b	.LBB25_57
.LBB25_50:                              # %..lr.ph.i181_crit_edge
	ld.d	$s1, $fp, 120
	slli.d	$s0, $s2, 2
	b	.LBB25_65
.LBB25_51:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i191
	beqz	$a1, .LBB25_64
...
.LBB25_54:                              # %vector.body322
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB25_54
# %bb.55:                               # %middle.block327
	beq	$a0, $a2, .LBB25_62
# %bb.56:                               # %vec.epilog.iter.check331
	beqz	$a3, .LBB25_60
.LBB25_57:                              # %vec.epilog.ph333
	move	$a5, $a0
	bstrpick.d	$a0, $a2, 30, 2
	slli.d	$a0, $a0, 2
	sub.d	$a3, $a5, $a0
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB25_58:                              # %vec.epilog.vector.body336
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB25_58
# %bb.59:                               # %vec.epilog.middle.block340
	beq	$a0, $a2, .LBB25_62
.LBB25_60:                              # %vec.epilog.scalar.ph330.preheader
	sub.d	$a2, $a2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB25_61:                              # %vec.epilog.scalar.ph330
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB25_61
.LBB25_62:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i200
	ld.bu	$a0, $fp, 128
	beqz	$a0, .LBB25_64
.LBB25_63:
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB25_64:                              # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i194
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 128
	st.d	$s1, $fp, 120
	st.w	$s2, $fp, 112
...
# %bb.67:                               # %iter.check347
	...
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB25_77
# %bb.68:                               # %vector.main.loop.iter.check349
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB25_70
# %bb.69:
	move	$a3, $zero
	b	.LBB25_74
.LBB25_70:                              # %vector.ph350
	andi	$a4, $a0, 12
...
.LBB25_71:                              # %vector.body353
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB25_71
# %bb.72:                               # %middle.block356
	beq	$a3, $a0, .LBB25_79
# %bb.73:                               # %vec.epilog.iter.check360
	beqz	$a4, .LBB25_77
.LBB25_74:                              # %vec.epilog.ph362
	move	$a6, $a3
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB25_75:                              # %vec.epilog.vector.body365
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB25_75
# %bb.76:                               # %vec.epilog.middle.block368
	beq	$a3, $a0, .LBB25_79
.LBB25_77:                              # %vec.epilog.scalar.ph359.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a1, $a3, $a1, 2
	sub.d	$a3, $a0, $a3
	.p2align	4, , 16
.LBB25_78:                              # %vec.epilog.scalar.ph359
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a1, 0
	st.w	$zero, $a2, 0
	addi.d	$a2, $a2, 4
...
.LBB25_79:                              # %.lr.ph256
	...
	b	.LBB25_81
	.p2align	4, , 16
.LBB25_80:                              #   in Loop: Header=BB25_81 Depth=1
	addi.d	$s3, $s3, 1
	addi.d	$s2, $s2, 4
	addi.d	$s1, $s1, 16
	addi.d	$s0, $s0, 288
...
.LBB25_85:                              # %.critedge
	...
	stx.w	$zero, $a1, $s1
	st.w	$s4, $s6, 284
.LBB25_86:                              #   in Loop: Header=BB25_87 Depth=1
	ld.w	$a1, $fp, 196
	addi.d	$s3, $s3, 1
	addi.d	$s2, $s2, 16
	addi.d	$s1, $s1, 4
...
# %bb.88:                               #   in Loop: Header=BB25_87 Depth=1
	...
	bcnez	$fcc0, .LBB25_90
# %bb.89:                               #   in Loop: Header=BB25_87 Depth=1
	fmul.s	$fa0, $fs0, $fa0
	b	.LBB25_91
	.p2align	4, , 16
.LBB25_90:                              #   in Loop: Header=BB25_87 Depth=1
	fld.s	$fa0, $s6, 256
	fcmp.ceq.s	$fcc0, $fa0, $fs1
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 168
	...
	fcmp.clt.s	$fcc0, $fa0, $fa1
	fsel	$fa0, $fa0, $fa1, $fcc0
.LBB25_91:                              #   in Loop: Header=BB25_87 Depth=1
	ld.d	$a2, $fp, 88
	stx.w	$zero, $a2, $s1
	add.d	$a1, $a0, $s0
	st.w	$s4, $a1, 284
	...
	bcnez	$fcc0, .LBB25_86
# %bb.92:                               #   in Loop: Header=BB25_87 Depth=1
	fld.s	$fa2, $a1, 284
	fsqrt.s	$fa0, $fa0
	fdiv.s	$fa0, $fa1, $fa0
	fmul.s	$fa0, $fa0, $fa2
...
.LBB25_96:                              # =>This Inner Loop Header: Depth=1
	...
	bcnez	$fcc0, .LBB25_95
# %bb.97:                               #   in Loop: Header=BB25_96 Depth=1
	fld.s	$fa1, $a3, 0
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB25_95
# %bb.98:                               #   in Loop: Header=BB25_96 Depth=1
	fld.s	$fa2, $a2, 0
	fmul.s	$fa1, $fa1, $fa2
	fst.s	$fa1, $a2, 0
	fld.s	$fa1, $a3, 0
...
# %bb.103:                              #   in Loop: Header=BB25_102 Depth=1
	...
	pcaddu18i	$ra, %call36(_ZN11btRigidBody12applyImpulseERK9btVector3S2_)
	jirl	$ra, $ra, 0
.LBB25_104:                             #   in Loop: Header=BB25_102 Depth=1
	ld.d	$a0, $fp, 120
	fldx.s	$fa0, $a0, $s1
	fcmp.ceq.s	$fcc0, $fa0, $fs1
