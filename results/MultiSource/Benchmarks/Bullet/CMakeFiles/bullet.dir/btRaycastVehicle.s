...
.Ltmp0:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp1:                                 # EH_LABEL
.LBB0_3:                                # %_ZN20btAlignedObjectArrayIP17btTypedConstraintED2Ev.exit
	move	$a0, $fp
...
.Ltmp6:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp7:                                 # EH_LABEL
.LBB4_3:                                # %_ZN20btAlignedObjectArrayI11btWheelInfoED2Ev.exit
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB4_6
# %bb.4:                                # %_ZN20btAlignedObjectArrayI11btWheelInfoED2Ev.exit
	ld.b	$a1, $fp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB4_6
# %bb.5:
.Ltmp11:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp12:                                # EH_LABEL
.LBB4_6:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.d	$a0, $fp, 88
	beqz	$a0, .LBB4_9
# %bb.7:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.b	$a1, $fp, 96
	andi	$a1, $a1, 1
	beqz	$a1, .LBB4_9
# %bb.8:
.Ltmp16:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp17:                                # EH_LABEL
.LBB4_9:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit19
	ld.d	$a0, $fp, 56
	beqz	$a0, .LBB4_12
# %bb.10:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit19
	ld.b	$a1, $fp, 64
	andi	$a1, $a1, 1
	beqz	$a1, .LBB4_12
# %bb.11:
.Ltmp21:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp22:                                # EH_LABEL
.LBB4_12:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB4_15
...
# %bb.14:
	...
	jr	$t8
.LBB4_15:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit26
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 32
...
.Ltmp9:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp10:                                # EH_LABEL
.LBB4_22:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit30
	ld.d	$a0, $fp, 88
	beqz	$a0, .LBB4_25
# %bb.23:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit30
	ld.b	$a1, $fp, 96
	andi	$a1, $a1, 1
	beqz	$a1, .LBB4_25
# %bb.24:
.Ltmp14:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
.LBB4_25:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit34
	ld.d	$a0, $fp, 56
	beqz	$a0, .LBB4_28
# %bb.26:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit34
	ld.b	$a1, $fp, 64
	andi	$a1, $a1, 1
	beqz	$a1, .LBB4_28
# %bb.27:
.Ltmp19:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp20:                                # EH_LABEL
.LBB4_28:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit38
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB4_31
# %bb.29:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit38
	ld.b	$a1, $fp, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB4_31
# %bb.30:
.Ltmp24:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp25:                                # EH_LABEL
.LBB4_31:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit42
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB4_32:
...
.LBB6_6:                                # =>This Inner Loop Header: Depth=1
	...
	addi.d	$s6, $s6, 288
	bne	$s7, $s6, .LBB6_6
.LBB6_7:                                # %_ZNK20btAlignedObjectArrayI11btWheelInfoE4copyEiiPS0_.exit.i.i
	ld.d	$a0, $fp, 208
	beqz	$a0, .LBB6_10
...
# %bb.9:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB6_10:                               # %_ZN20btAlignedObjectArrayI11btWheelInfoE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	ld.w	$a1, $fp, 196
	st.b	$a0, $fp, 216
	st.d	$s0, $fp, 208
...
.LBB7_3:
	...
	fmadd.s	$fa0, $fa0, $fa3, $fa2
	fmadd.s	$fa2, $fa4, $fa6, $ft7
	fmadd.s	$fa0, $fa4, $fa5, $fa0
	fmul.s	$fa4, $fa7, $ft6
	fmul.s	$fa1, $fa7, $fa1
	fmadd.s	$fa4, $ft0, $ft2, $fa4
	fmadd.s	$fa1, $ft0, $fa3, $fa1
	fmadd.s	$fa3, $ft1, $fa6, $fa4
	...
	st.d	$a0, $a1, 60
	fmul.s	$fa1, $ft3, $ft6
	fmadd.s	$fa1, $ft4, $ft2, $fa1
	fmadd.s	$fa1, $ft5, $fa6, $fa1
	movfr2gr.s	$a0, $fa1
	bstrpick.d	$a0, $a0, 31, 0
...
# %bb.14:                               #   in Loop: Header=BB13_13 Depth=1
	...
	b	.LBB13_12
.LBB13_15:                              # %_ZN16btRaycastVehicle16updateSuspensionEf.exit
	blez	$a0, .LBB13_18
# %bb.16:                               # %.lr.ph112
	move	$s0, $zero
	move	$s1, $zero
...
.LBB23_5:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 16
	bne	$a1, $a0, .LBB23_5
.LBB23_6:                               # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB23_9
...
# %bb.8:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB23_9:                               # %_ZN20btAlignedObjectArrayI9btVector3E10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 32
	st.d	$s0, $fp, 24
	st.w	$s2, $fp, 16
.LBB23_10:                              # %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit
	ld.w	$a0, $fp, 44
	st.w	$s2, $fp, 12
	bge	$a0, $s2, .LBB23_19
# %bb.11:
...
.LBB23_14:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 16
	bne	$a1, $a0, .LBB23_14
.LBB23_15:                              # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i157
	ld.d	$a0, $fp, 56
	beqz	$a0, .LBB23_18
...
# %bb.17:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB23_18:                              # %_ZN20btAlignedObjectArrayI9btVector3E10deallocateEv.exit.i.i160
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 64
	st.d	$s0, $fp, 56
	st.w	$s2, $fp, 48
.LBB23_19:                              # %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit166
	ld.w	$s3, $fp, 76
	st.w	$s2, $fp, 44
	blt	$s3, $s2, .LBB23_22
...
# %bb.0:
	ret
.Lfunc_end27:
	.size	_ZN16btCollisionWorld17RayResultCallbackD2Ev, .Lfunc_end27-_ZN16btCollisionWorld17RayResultCallbackD2Ev
                                        # -- End function
...
# %bb.0:
	ret
.Lfunc_end28:
	.size	_ZN18btVehicleRaycasterD2Ev, .Lfunc_end28-_ZN18btVehicleRaycasterD2Ev
                                        # -- End function
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end29:
	.size	_ZN25btDefaultVehicleRaycasterD0Ev, .Lfunc_end29-_ZN25btDefaultVehicleRaycasterD0Ev
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	jr	$a1
.Lfunc_end30:
	.size	_ZN16btRaycastVehicle12updateActionEP16btCollisionWorldf, .Lfunc_end30-_ZN16btRaycastVehicle12updateActionEP16btCollisionWorldf
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end31:
	.size	_ZN16btRaycastVehicle19setCoordinateSystemEiii, .Lfunc_end31-_ZN16btRaycastVehicle19setCoordinateSystemEiii
                                        # -- End function
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end32:
	.size	_ZN16btCollisionWorld24ClosestRayResultCallbackD0Ev, .Lfunc_end32-_ZN16btCollisionWorld24ClosestRayResultCallbackD0Ev
	.cfi_endproc
                                        # -- End function
...
.LBB33_2:
	...
	ret
.Lfunc_end33:
	.size	_ZNK16btCollisionWorld17RayResultCallback14needsCollisionEP17btBroadphaseProxy, .Lfunc_end33-_ZNK16btCollisionWorld17RayResultCallback14needsCollisionEP17btBroadphaseProxy
                                        # -- End function
...
.LBB34_3:
	...
	ret
.Lfunc_end34:
	.size	_ZN16btCollisionWorld24ClosestRayResultCallback15addSingleResultERNS_14LocalRayResultEb, .Lfunc_end34-_ZN16btCollisionWorld24ClosestRayResultCallback15addSingleResultERNS_14LocalRayResultEb
	.cfi_endproc
                                        # -- End function
	.section	.text.startup,"ax",@progbits
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_btRaycastVehicle.cpp
...
# %bb.0:
	...
	ret
.Lfunc_end35:
	.size	_GLOBAL__sub_I_btRaycastVehicle.cpp, .Lfunc_end35-_GLOBAL__sub_I_btRaycastVehicle.cpp
	.cfi_endproc
                                        # -- End function
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV16btRaycastVehicle
	...
	.addrsig_sym _ZTV11btRigidBody
	.addrsig_sym _ZTVN16btCollisionWorld24ClosestRayResultCallbackE
