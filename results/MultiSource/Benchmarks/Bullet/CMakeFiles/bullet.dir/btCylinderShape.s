...
.LBB9_11:                               # %vector.body
	...
	vfcmp.cune.s	$vr9, $vr5, $vr3
	vilvl.w	$vr10, $vr9, $vr9
	vextrins.w	$vr7, $vr8, 16
	vfcmp.clt.s	$vr7, $vr7, $vr3
	vbitsel.v	$vr7, $vr1, $vr2, $vr7
	vfsqrt.s	$vr5, $vr5
	vfdiv.s	$vr5, $vr0, $vr5
	vfmul.s	$vr4, $vr4, $vr5
	vfmul.s	$vr5, $vr6, $vr5
	vilvl.w	$vr5, $vr3, $vr5
	vand.v	$vr5, $vr10, $vr5
	vbitsel.v	$vr4, $vr0, $vr4, $vr9
	vshuf4i.w	$vr6, $vr7, 16
	vslli.d	$vr6, $vr6, 32
	vilvl.w	$vr4, $vr3, $vr4
	vor.v	$vr4, $vr6, $vr4
	vpackev.d	$vr6, $vr5, $vr4
	vst	$vr6, $a5, -16
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV15btCylinderShape
	.addrsig_sym _ZTV16btCylinderShapeX
	.addrsig_sym _ZTV16btCylinderShapeZ
