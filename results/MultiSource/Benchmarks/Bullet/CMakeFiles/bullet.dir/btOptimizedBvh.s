...
.LBB6_25:                               # %_Z8btSetMinIfEvRT_RKS0_.exit.i
                                        #   in Loop: Header=BB6_3 Depth=1
	vfcmp.clt.s	$vr7, $vr4, $vr12
	fcmp.clt.s	$fcc0, $fa5, $fs0
	fsel	$fa6, $fs0, $fa5, $fcc0
	vreplvei.w	$vr8, $vr4, 0
	fcmp.clt.s	$fcc0, $fs1, $ft0
	fsel	$ft0, $fs1, $ft0, $fcc0
	vreplvei.w	$vr9, $vr4, 1
	fcmp.clt.s	$fcc0, $fs1, $ft1
	fsel	$ft1, $fs1, $ft1, $fcc0
	fcmp.clt.s	$fcc0, $fs1, $fa5
	fsel	$fa5, $fs1, $fa5, $fcc0
	...
	fsel	$ft2, $fa5, $fa3, $fcc0
	fcmp.clt.s	$fcc0, $fa1, $fa6
	fsel	$ft3, $fa6, $fa1, $fcc0
	...
	fsub.s	$ft1, $ft3, $fa5
	fmul.s	$ft1, $ft1, $fa6
	vbitsel.v	$vr4, $vr12, $vr4, $vr7
	vfcmp.clt.s	$vr7, $vr2, $vr4
	vbitsel.v	$vr2, $vr4, $vr2, $vr7
	fld.s	$fa4, $s2, 8
...
.Lcst_end2:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZZN14btOptimizedBvh5buildEP23btStridingMeshInterfacebRK9btVector3S4_EN29QuantizedNodeTriangleCallback28internalProcessTriangleIndexEPS2_ii
...
.LBB11_11:                              # %_ZN20btAlignedObjectArrayI18btQuantizedBvhNodeE9push_backERKS0_.exit
	...
	ori	$a5, $a2, 2923
	vreplgr2vr.w	$vr0, $a5
	vfcmp.clt.s	$vr1, $vr0, $vr9
	lu12i.w	$a2, 382432
	ori	$a4, $a2, 2923
	vreplgr2vr.w	$vr2, $a4
	vfcmp.clt.s	$vr3, $vr9, $vr2
	vbitsel.v	$vr0, $vr0, $vr9, $vr1
	vfcmp.clt.s	$vr1, $vr0, $vr8
	vbitsel.v	$vr0, $vr0, $vr8, $vr1
	vfcmp.clt.s	$vr1, $vr0, $vr6
	vbitsel.v	$vr1, $vr0, $vr6, $vr1
	vreplvei.w	$vr4, $vr1, 1
	lu12i.w	$a2, 239665
	ori	$a2, $a2, 623
	movgr2fr.w	$fa5, $a2
	vbitsel.v	$vr0, $vr2, $vr9, $vr3
	vfcmp.clt.s	$vr2, $vr8, $vr0
	vbitsel.v	$vr0, $vr0, $vr8, $vr2
	vfcmp.clt.s	$vr2, $vr6, $vr0
	...
	ori	$a3, $a3, 1
	movgr2fr.w	$fa1, $a5
	fcmp.clt.s	$fcc2, $fa1, $fs7
	fsel	$fa1, $fa1, $fs7, $fcc2
	fcmp.clt.s	$fcc2, $fa1, $fs6
	fsel	$fa1, $fa1, $fs6, $fcc2
	fcmp.clt.s	$fcc2, $fa1, $fs5
	fsel	$fa1, $fa1, $fs5, $fcc2
	movgr2fr.w	$fa2, $a4
	fcmp.clt.s	$fcc2, $fs7, $fa2
	fsel	$fa2, $fa2, $fs7, $fcc2
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV14btOptimizedBvh
	.addrsig_sym _ZTI14btOptimizedBvh
	.addrsig_sym _ZTVN10__cxxabiv120__si_class_type_infoE
	.addrsig_sym _ZTS14btOptimizedBvh
	.addrsig_sym _ZTI14btQuantizedBvh
	.addrsig_sym _ZTVZN14btOptimizedBvh5buildEP23btStridingMeshInterfacebRK9btVector3S4_E29QuantizedNodeTriangleCallback
	...
	.addrsig_sym _ZTVZN14btOptimizedBvh5buildEP23btStridingMeshInterfacebRK9btVector3S4_E20NodeTriangleCallback
