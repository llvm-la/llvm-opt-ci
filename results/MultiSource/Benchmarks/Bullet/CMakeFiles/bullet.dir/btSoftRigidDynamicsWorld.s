...
.Ltmp3:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp4:                                 # EH_LABEL
.LBB0_10:                               # %_ZN19btSoftBodyWorldInfoD2Ev.exit
	ld.d	$a0, $fp, 392
	beqz	$a0, .LBB0_13
# %bb.11:                               # %_ZN19btSoftBodyWorldInfoD2Ev.exit
	ld.b	$a1, $fp, 400
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_13
# %bb.12:
.Ltmp5:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp6:                                 # EH_LABEL
.LBB0_13:                               # %_ZN20btAlignedObjectArrayIP10btSoftBodyED2Ev.exit
.Ltmp7:                                 # EH_LABEL
	move	$a0, $fp
...
.LBB1_10:                               # %scalar.ph
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB1_10
.LBB1_11:                               # %_ZNK20btAlignedObjectArrayIPN11btSparseSdfILi3EE4CellEE4copyEiiPS3_.exit.thread.i.i
	ld.bu	$a1, $fp, 24
	bnez	$a1, .LBB1_16
	b	.LBB1_17
...
.Ltmp10:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp11:                                # EH_LABEL
.LBB3_3:                                # %_ZN19btSoftBodyWorldInfoD2Ev.exit
	ld.d	$a0, $fp, 392
	beqz	$a0, .LBB3_6
# %bb.4:                                # %_ZN19btSoftBodyWorldInfoD2Ev.exit
	ld.b	$a1, $fp, 400
	andi	$a1, $a1, 1
	beqz	$a1, .LBB3_6
# %bb.5:
.Ltmp15:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp16:                                # EH_LABEL
.LBB3_6:                                # %_ZN20btAlignedObjectArrayIP10btSoftBodyED2Ev.exit
	move	$a0, $fp
...
.Ltmp13:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp14:                                # EH_LABEL
.LBB3_11:                               # %_ZN20btAlignedObjectArrayIP10btSoftBodyED2Ev.exit8
.Ltmp18:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN23btDiscreteDynamicsWorldD2Ev)
	jirl	$ra, $ra, 0
...
.Lcst_begin4:
	...
	.uleb128 .Lfunc_end7-.Ltmp37            #   Call between .Ltmp37 and .Lfunc_end7
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end4:
	.byte	1                               # >> Action Record 1 <<
...
.Lcst_begin5:
	...
	.uleb128 .Lfunc_end8-.Ltmp43            #   Call between .Ltmp43 and .Lfunc_end8
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end5:
	.byte	1                               # >> Action Record 1 <<
...
.LBB9_10:                               # %scalar.ph
	...
	addi.d	$a6, $a6, 8
	bnez	$a7, .LBB9_10
.LBB9_11:                               # %_ZNK20btAlignedObjectArrayIP10btSoftBodyE4copyEiiPS1_.exit.thread.i.i
	ld.bu	$a6, $a0, 400
	bnez	$a6, .LBB9_15
	b	.LBB9_16
.LBB9_12:
	...
	ld.d	$a4, $a0, 392
	bgtz	$a5, .LBB9_4
.LBB9_13:                               # %_ZNK20btAlignedObjectArrayIP10btSoftBodyE4copyEiiPS1_.exit.i.i
	move	$a3, $s3
	move	$a2, $s2
	move	$a1, $s1
	beqz	$a4, .LBB9_16
...
.LBB9_15:
	...
	move	$a0, $s4
	ld.w	$a5, $s4, 380
.LBB9_16:                               # %_ZN20btAlignedObjectArrayIP10btSoftBodyE10deallocateEv.exit.i.i
	ori	$a4, $zero, 1
	st.b	$a4, $a0, 400
	st.d	$fp, $a0, 392
	st.w	$s0, $a0, 384
.LBB9_17:                               # %_ZN20btAlignedObjectArrayIP10btSoftBodyE9push_backERKS1_.exit
	ld.d	$a4, $a0, 392
	slli.d	$a6, $a5, 3
	stx.d	$a1, $a4, $a6
	addi.d	$a4, $a5, 1
...
# %bb.3:                                #   in Loop: Header=BB10_2 Depth=1
	...
	addi.w	$a5, $a5, 1
	bnez	$a6, .LBB10_2
.LBB10_4:                               # %_ZN20btAlignedObjectArrayIP10btSoftBodyE6removeERKS1_.exit
	pcaddu18i	$t8, %call36(_ZN16btCollisionWorld21removeCollisionObjectEP17btCollisionObject)
	jr	$t8
.LBB10_5:                               # %_ZNK20btAlignedObjectArrayIP10btSoftBodyE16findLinearSearchERKS1_.exit.i
	bge	$a5, $a2, .LBB10_4
# %bb.6:
	addi.w	$a2, $a2, -1
	slli.d	$a5, $a2, 3
...
# %bb.5:                                #   in Loop: Header=BB11_4 Depth=1
	...
	addi.w	$a5, $a5, 1
	bnez	$a6, .LBB11_4
.LBB11_6:                               # %_ZN24btSoftRigidDynamicsWorld14removeSoftBodyEP10btSoftBody.exit
	pcaddu18i	$t8, %call36(_ZN16btCollisionWorld21removeCollisionObjectEP17btCollisionObject)
	jr	$t8
.LBB11_7:
	pcaddu18i	$t8, %call36(_ZN23btDiscreteDynamicsWorld21removeCollisionObjectEP17btCollisionObject)
	jr	$t8
.LBB11_8:                               # %_ZNK20btAlignedObjectArrayIP10btSoftBodyE16findLinearSearchERKS1_.exit.i.i
	bge	$a5, $a2, .LBB11_6
# %bb.9:
	addi.w	$a2, $a2, -1
	slli.d	$a5, $a2, 3
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV24btSoftRigidDynamicsWorld
