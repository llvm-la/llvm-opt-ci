...
# %bb.36:                               #   in Loop: Header=BB2_34 Depth=2
	...
	fmov.s	$fa7, $ft0
	b	.LBB2_33
.LBB2_37:                               # %iter.check181
	ori	$a1, $zero, 5
	ori	$a3, $zero, 1
	bltu	$s0, $a1, .LBB2_47
# %bb.38:                               # %vector.main.loop.iter.check183
	addi.d	$a1, $s0, -1
	ori	$a2, $zero, 17
...
# %bb.42:                               # %middle.block190
	beq	$a2, $a1, .LBB2_49
# %bb.43:                               # %vec.epilog.iter.check194
	beqz	$a3, .LBB2_50
.LBB2_44:                               # %vec.epilog.ph196
	...
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB2_45:                               # %vec.epilog.vector.body201
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a2, $a2, 4
	addi.d	$a5, $a5, 16
	bnez	$a2, .LBB2_45
# %bb.46:                               # %vec.epilog.middle.block205
	beq	$a4, $a1, .LBB2_49
.LBB2_47:                               # %.lr.ph139.split.preheader
	sub.d	$a1, $s0, $a3
	.p2align	4, , 16
.LBB2_48:                               # %.lr.ph139.split
                                        # =>This Inner Loop Header: Depth=1
	st.w	$fp, $a0, 0
	addi.w	$a1, $a1, -1
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB2_48
.LBB2_49:                               # %._crit_edge140
