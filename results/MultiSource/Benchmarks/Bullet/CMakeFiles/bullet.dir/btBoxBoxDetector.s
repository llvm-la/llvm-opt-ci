...
# %bb.38:
	move	$a1, $a0
	b	.LBB2_48
.LBB2_39:                               # %vector.main.loop.iter.check180
	addi.d	$a1, $s0, -1
	ori	$a3, $zero, 17
...
.LBB2_41:                               # %vector.ph182
	...
	srli.d	$a6, $a2, 4
	ori	$a3, $zero, 1
	bstrins.d	$a3, $a6, 31, 4
	xvreplgr2vr.w	$xr0, $fp
	addi.d	$a6, $s1, 36
	move	$a7, $a4
	.p2align	4, , 16
.LBB2_42:                               # %vector.body185
                                        # =>This Inner Loop Header: Depth=1
	xvst	$xr0, $a6, -32
	xvst	$xr0, $a6, 0
	addi.d	$a7, $a7, -16
...
# %bb.43:                               # %middle.block188
	beq	$a4, $a2, .LBB2_50
# %bb.44:                               # %vec.epilog.iter.check195
	beqz	$a5, .LBB2_48
.LBB2_45:                               # %vec.epilog.ph197
	bstrpick.d	$a1, $a2, 31, 2
	slli.d	$a5, $a1, 2
	alsl.d	$a1, $a1, $a0, 4
	srli.d	$a0, $a2, 2
	ori	$a3, $zero, 1
	bstrins.d	$a3, $a0, 31, 2
	vreplgr2vr.w	$vr0, $fp
	sub.d	$a0, $a4, $a5
	alsl.d	$a4, $a4, $s1, 2
	addi.d	$a4, $a4, 4
	.p2align	4, , 16
.LBB2_46:                               # %vec.epilog.vector.body202
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	addi.d	$a0, $a0, 4
	addi.d	$a4, $a4, 16
	bnez	$a0, .LBB2_46
# %bb.47:                               # %vec.epilog.middle.block206
	beq	$a5, $a2, .LBB2_50
.LBB2_48:                               # %.lr.ph139.split.preheader
	sub.d	$a0, $s0, $a3
	.p2align	4, , 16
.LBB2_49:                               # %.lr.ph139.split
                                        # =>This Inner Loop Header: Depth=1
	st.w	$fp, $a1, 0
	addi.w	$a0, $a0, -1
	addi.d	$a1, $a1, 4
	bnez	$a0, .LBB2_49
.LBB2_50:                               # %._crit_edge140
...
.Lfunc_end3:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZL18intersectRectQuad2PfS_S_
...
# %bb.0:
	...
	fst.d	$fs5, $sp, 240                  # 8-byte Folded Spill
	fst.d	$fs6, $sp, 232                  # 8-byte Folded Spill
	fst.d	$fs7, $sp, 224                  # 8-byte Folded Spill
	.cfi_offset 1, -8
	.cfi_offset 22, -16
	.cfi_offset 23, -24
	.cfi_offset 24, -32
	...
	jirl	$ra, $ra, 0
	fld.d	$fs7, $sp, 224                  # 8-byte Folded Reload
	fld.d	$fs6, $sp, 232                  # 8-byte Folded Reload
	fld.d	$fs5, $sp, 240                  # 8-byte Folded Reload
...
_ZN16btBoxBoxDetectorC1EP10btBoxShapeS1_ = _ZN16btBoxBoxDetectorC2EP10btBoxShapeS1_
	...
	.addrsig_sym _ZTV16btBoxBoxDetector
