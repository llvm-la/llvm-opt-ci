...
# %bb.4:                                #   in Loop: Header=BB5_3 Depth=1
	...
	fsel	$fa7, $fs0, $fa7, $fcc0
	fcmp.clt.s	$fcc0, $ft0, $fs0
	fsel	$ft0, $fs0, $ft0, $fcc0
	fcmp.clt.s	$fcc0, $fs1, $ft4
	fsel	$ft1, $fs1, $ft4, $fcc0
	ldx.w	$a1, $a0, $s1
	fcmp.clt.s	$fcc0, $fs1, $ft2
	fsel	$ft2, $fs1, $ft2, $fcc0
	fcmp.clt.s	$fcc0, $fs1, $ft3
	slti	$a3, $a1, 0
	sub.d	$a1, $zero, $a1
	maskeqz	$a1, $a1, $a3
	masknez	$a3, $s2, $a3
...
# %bb.5:                                #   in Loop: Header=BB5_3 Depth=1
	...
	fcmp.clt.s	$fcc0, $ft8, $fa7
	fsel	$fa7, $fa7, $ft8, $fcc0
	fcmp.clt.s	$fcc0, $ft7, $ft0
	fsel	$ft0, $ft0, $ft7, $fcc0
	fcmp.clt.s	$fcc0, $ft1, $ft6
	fsel	$ft1, $ft1, $ft6, $fcc0
	fcmp.clt.s	$fcc0, $ft2, $ft3
	fsel	$ft2, $ft2, $ft3, $fcc0
	fcmp.clt.s	$fcc0, $ft4, $ft5
...
.LBB5_6:                                #   in Loop: Header=BB5_3 Depth=1
	...
	fcmp.clt.s	$fcc1, $ft5, $ft0
	fcmp.clt.s	$fcc2, $ft6, $fa6
	fcmp.clt.s	$fcc3, $ft4, $fa7
	movcf2gr	$a1, $fcc2
	vinsgr2vr.w	$vr15, $a1, 0
	movcf2gr	$a1, $fcc3
	vinsgr2vr.w	$vr15, $a1, 1
	movcf2gr	$a1, $fcc1
	vinsgr2vr.w	$vr15, $a1, 2
	movcf2gr	$a1, $fcc0
	vinsgr2vr.w	$vr15, $a1, 3
	vslli.w	$vr15, $vr15, 31
	vsrai.w	$vr15, $vr15, 31
	vextrins.w	$vr14, $vr12, 16
	vextrins.w	$vr14, $vr13, 32
	vshuf4i.w	$vr13, $vr14, 36
...
.Ltmp11:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp12:                                # EH_LABEL
.LBB6_20:                               # %_ZN20btAlignedObjectArrayI12GIM_BVH_DATAED2Ev.exit17
	move	$a0, $fp
...
.Lfunc_end9:
	...
	.p2align	4, 0x0                          # -- Begin function _ZN21btGImpactQuantizedBvh14find_collisionEPS_RK11btTransformS0_S3_R9btPairSet
.LCPI10_0:
...
# %bb.2:
	...
	fmadd.s	$ft8, $fa5, $ft3, $ft4
	fmul.s	$ft4, $fa6, $ft2
	fmadd.s	$ft4, $fa1, $ft1, $ft4
	fmadd.s	$ft9, $fa3, $ft3, $ft4
	fmul.s	$ft2, $fa4, $ft2
	fld.s	$ft4, $a3, 16
	fmadd.s	$ft1, $fa0, $ft1, $ft2
	fmadd.s	$ft10, $ft0, $ft3, $ft1
	fld.s	$ft3, $a3, 0
	fmul.s	$ft1, $fa7, $ft4
	fld.s	$ft7, $a3, 32
	fld.s	$ft11, $a3, 20
	...
	fmadd.s	$ft6, $ft7, $fa5, $ft1
	fmul.s	$ft1, $fa7, $ft11
	fmadd.s	$ft1, $ft12, $fa2, $ft1
	fld.s	$ft13, $a3, 36
	fld.s	$ft14, $a3, 24
	fld.s	$ft15, $a3, 8
	fld.s	$fs0, $a3, 40
	fmadd.s	$fs1, $ft13, $fa5, $ft1
	fmul.s	$ft1, $fa7, $ft14
	fmadd.s	$ft1, $ft15, $fa2, $ft1
	fmadd.s	$fs2, $fs0, $fa5, $ft1
	fmul.s	$ft1, $fa6, $ft4
	fmadd.s	$ft1, $ft3, $fa1, $ft1
	fmadd.s	$ft5, $ft7, $fa3, $ft1
	fmul.s	$ft1, $fa6, $ft11
	fmadd.s	$ft1, $ft12, $fa1, $ft1
	fmadd.s	$ft1, $ft13, $fa3, $ft1
	fmul.s	$ft2, $fa6, $ft14
	fmadd.s	$ft2, $ft15, $fa1, $ft2
	fmadd.s	$ft2, $fs0, $fa3, $ft2
	fmul.s	$ft4, $fa4, $ft4
	fmadd.s	$ft3, $ft3, $fa0, $ft4
	fmadd.s	$ft3, $ft7, $ft0, $ft3
	fmul.s	$ft4, $fa4, $ft11
	fmadd.s	$ft4, $ft12, $fa0, $ft4
	fmadd.s	$ft4, $ft13, $ft0, $ft4
	fmul.s	$ft7, $fa4, $ft14
	fmadd.s	$ft7, $ft15, $fa0, $ft7
	fld.s	$ft11, $a3, 52
	fld.s	$ft12, $a3, 48
	fld.s	$ft13, $a3, 56
	fmadd.s	$ft7, $fs0, $ft0, $ft7
	fmul.s	$fa7, $fa7, $ft11
	fmadd.s	$fa2, $fa2, $ft12, $fa7
	fmadd.s	$fa2, $fa5, $ft13, $fa2
	fadd.s	$fa2, $ft8, $fa2
	fmul.s	$fa5, $fa6, $ft11
	fmadd.s	$fa1, $fa1, $ft12, $fa5
	fmadd.s	$fa1, $fa3, $ft13, $fa1
	fadd.s	$fa1, $ft9, $fa1
	fmul.s	$fa3, $fa4, $ft11
	fmadd.s	$fa0, $fa0, $ft12, $fa3
...
.Lfunc_end10:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZL41_find_quantized_collision_pairs_recursiveP21btGImpactQuantizedBvhS0_P9btPairSetRK26BT_BOX_BOX_TRANSFORM_CACHEiib
