...
.Ltmp3:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp4:                                 # EH_LABEL
.LBB0_5:                                # %_ZN20btAlignedObjectArrayIP17btTypedConstraintED2Ev.exit
.Ltmp5:                                 # EH_LABEL
	move	$a0, $fp
...
.Ltmp11:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp12:                                # EH_LABEL
.LBB3_5:                                # %_ZN20btAlignedObjectArrayIP17btTypedConstraintED2Ev.exit
.Ltmp13:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN17btCollisionObjectD2Ev)
	jirl	$ra, $ra, 0
...
.LBB4_3:
	...
	vand.v	$vr1, $vr1, $vr2
	fst.s	$fa0, $a0, 428
	vstelm.w	$vr1, $a0, 432, 0
	vstelm.w	$vr1, $a0, 436, 1
	st.w	$zero, $a0, 440
	ret
.Lfunc_end4:
...
.LBB20_15:                              # %scalar.ph
	...
	addi.d	$a4, $a4, 8
	bnez	$a5, .LBB20_15
.LBB20_16:                              # %_ZNK20btAlignedObjectArrayIP17btTypedConstraintE4copyEiiPS1_.exit.thread.i.i
	ld.bu	$a4, $a0, 544
	bnez	$a4, .LBB20_20
	b	.LBB20_21
.LBB20_17:
	...
	ld.d	$a2, $a0, 536
	bgtz	$a3, .LBB20_9
.LBB20_18:                              # %_ZNK20btAlignedObjectArrayIP17btTypedConstraintE4copyEiiPS1_.exit.i.i
	move	$a1, $s1
	beqz	$a2, .LBB20_21
...
.LBB20_20:
	...
	move	$a0, $s2
	ld.w	$a3, $s2, 524
.LBB20_21:                              # %_ZN20btAlignedObjectArrayIP17btTypedConstraintE10deallocateEv.exit.i.i
	ori	$a2, $zero, 1
	st.b	$a2, $a0, 544
	st.d	$fp, $a0, 536
	st.w	$s0, $a0, 528
.LBB20_22:                              # %_ZN20btAlignedObjectArrayIP17btTypedConstraintE9push_backERKS1_.exit
	ld.d	$a2, $a0, 536
	slli.d	$a4, $a3, 3
	stx.d	$a1, $a2, $a4
	addi.d	$a1, $a3, 1
...
.LBB21_6:                               # %_ZN20btAlignedObjectArrayIP17btTypedConstraintE6removeERKS1_.exit
	st.b	$a1, $a0, 272
	ret
.LBB21_7:                               # %_ZNK20btAlignedObjectArrayIP17btTypedConstraintE16findLinearSearchERKS1_.exit.i
	ori	$a1, $zero, 1
	bge	$a5, $a3, .LBB21_6
# %bb.8:
	addi.d	$a1, $a3, -1
...
.Ltmp16:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp17:                                # EH_LABEL
.LBB22_3:                               # %_ZN20btAlignedObjectArrayIP17btTypedConstraintED2Ev.exit
	move	$a0, $fp
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
...
.Lcst_begin2:
	...
	.uleb128 .Lfunc_end22-.Ltmp20           #   Call between .Ltmp20 and .Lfunc_end22
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end2:
	.byte	1                               # >> Action Record 1 <<
...
.Ltmp22:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp23:                                # EH_LABEL
.LBB23_3:                               # %_ZN20btAlignedObjectArrayIP17btTypedConstraintED2Ev.exit.i
.Ltmp28:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN17btCollisionObjectD2Ev)
	jirl	$ra, $ra, 0
...
.Lcst_begin3:
	...
	.uleb128 .Lfunc_end23-.Ltmp32           #   Call between .Ltmp32 and .Lfunc_end23
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end3:
	.byte	1                               # >> Action Record 1 <<
