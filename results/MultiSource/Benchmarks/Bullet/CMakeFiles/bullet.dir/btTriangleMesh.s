...
.LBB2_23:
	...
	ld.d	$a0, $fp, 184
	bgtz	$a2, .LBB2_5
.LBB2_24:                               # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.i.i
	beqz	$a0, .LBB2_28
.LBB2_25:                               # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.thread.i.i
	ld.bu	$a2, $fp, 192
	beqz	$a2, .LBB2_27
# %bb.26:
	move	$s2, $a1
...
.LBB2_27:
	ld.w	$a2, $fp, 172
.LBB2_28:                               # %_ZN20btAlignedObjectArrayIjE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 192
	st.d	$s0, $fp, 184
	st.w	$s1, $fp, 176
.LBB2_29:                               # %_ZN20btAlignedObjectArrayIjE9push_backERKj.exit
	ld.d	$a0, $fp, 184
	slli.d	$a2, $a2, 2
	stx.w	$a1, $a0, $a2
	ld.w	$a1, $fp, 172
...
.LBB2_30:
	...
	ld.d	$a0, $fp, 216
	bgtz	$a2, .LBB2_16
.LBB2_31:                               # %_ZNK20btAlignedObjectArrayItE4copyEiiPt.exit.i.i
	move	$a1, $s2
	beqz	$a0, .LBB2_41
...
# %bb.36:                               # %vec.epilog.iter.check
	bnez	$a4, .LBB2_20
.LBB2_37:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a4, $a2, $a3
	alsl.d	$a5, $a3, $a0, 1
	alsl.d	$a3, $a3, $s0, 1
	.p2align	4, , 16
.LBB2_38:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a6, $a5, 0
	st.h	$a6, $a3, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a3, $a3, 2
	bnez	$a4, .LBB2_38
.LBB2_39:                               # %_ZNK20btAlignedObjectArrayItE4copyEiiPt.exit.thread.i.i
	ld.bu	$a3, $fp, 224
	beqz	$a3, .LBB2_41
.LBB2_40:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	...
	move	$a1, $s2
	ld.w	$a2, $fp, 204
.LBB2_41:                               # %_ZN20btAlignedObjectArrayItE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 224
	st.d	$s0, $fp, 216
	st.w	$s1, $fp, 208
.LBB2_42:                               # %_ZN20btAlignedObjectArrayItE9push_backERKt.exit
	ld.d	$a0, $fp, 216
	slli.d	$a3, $a2, 1
	stx.h	$a1, $a0, $a3
	addi.d	$a1, $a2, 1
...
.LBB3_26:                               # %scalar.ph
	...
	addi.d	$a1, $a1, 4
	bnez	$a3, .LBB3_26
.LBB3_27:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i
	ld.bu	$a1, $fp, 160
	bnez	$a1, .LBB3_33
	b	.LBB3_34
.LBB3_28:
...
.LBB3_30:
	...
	ld.d	$a0, $fp, 152
	bgtz	$a2, .LBB3_20
.LBB3_31:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
	beqz	$a0, .LBB3_34
...
.LBB3_33:
	...
	jirl	$ra, $ra, 0
	ld.w	$a2, $fp, 140
.LBB3_34:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s1, $fp, 152
	st.w	$s2, $fp, 144
.LBB3_35:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit
	ld.d	$a1, $fp, 152
	slli.d	$a0, $a2, 2
	fstx.s	$fs0, $a1, $a0
	fld.s	$fs0, $s0, 4
...
# %bb.43:                               # %middle.block160
	beq	$a0, $s2, .LBB3_46
.LBB3_44:                               # %scalar.ph150.preheader
	sub.d	$a2, $s2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB3_45:                               # %scalar.ph150
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB3_45
.LBB3_46:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i66
	ld.bu	$a0, $fp, 160
	bnez	$a0, .LBB3_52
	b	.LBB3_53
.LBB3_47:
...
.LBB3_49:
	move	$s1, $zero
	bgtz	$s2, .LBB3_39
.LBB3_50:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i55
	beqz	$a1, .LBB3_53
# %bb.51:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i55
	ld.b	$a0, $fp, 160
	andi	$a0, $a0, 1
	beqz	$a0, .LBB3_53
.LBB3_52:
	...
	jirl	$ra, $ra, 0
	ld.w	$s2, $fp, 140
.LBB3_53:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i58
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s1, $fp, 152
	st.w	$s3, $fp, 144
.LBB3_54:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit70
	move	$a0, $s2
.LBB3_55:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit70
	slli.d	$a1, $a0, 2
	fstx.s	$fs0, $s1, $a1
	fld.s	$fs0, $s0, 8
	addi.w	$a0, $a0, 1
...
.LBB3_62:                               # %vector.body171
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB3_62
# %bb.63:                               # %middle.block176
	beq	$a0, $s3, .LBB3_66
.LBB3_64:                               # %scalar.ph166.preheader
	sub.d	$a1, $s3, $a0
	alsl.d	$a2, $a0, $s1, 2
	alsl.d	$a0, $a0, $s0, 2
	.p2align	4, , 16
.LBB3_65:                               # %scalar.ph166
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB3_65
.LBB3_66:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i87
	ld.bu	$a0, $fp, 160
	bnez	$a0, .LBB3_72
	b	.LBB3_73
.LBB3_67:
...
.LBB3_69:
	move	$s0, $zero
	bgtz	$s3, .LBB3_59
.LBB3_70:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i76
	beqz	$s1, .LBB3_73
# %bb.71:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i76
	ld.b	$a0, $fp, 160
	andi	$a0, $a0, 1
	beqz	$a0, .LBB3_73
.LBB3_72:
	...
	jirl	$ra, $ra, 0
	ld.w	$s3, $fp, 140
.LBB3_73:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i79
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s0, $fp, 152
	st.w	$s2, $fp, 144
.LBB3_74:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit91
	move	$a0, $s3
.LBB3_75:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit91
	ld.d	$a1, $fp, 40
	slli.d	$a2, $a0, 2
	ld.w	$a3, $a1, 20
	fstx.s	$fs0, $s0, $a2
...
.LBB3_78:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 16
	bne	$a1, $a0, .LBB3_78
.LBB3_79:                               # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB3_82
...
# %bb.81:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB3_82:                               # %_ZN20btAlignedObjectArrayI9btVector3E10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	ld.w	$a1, $fp, 108
	st.b	$a0, $fp, 128
	st.d	$s1, $fp, 120
	st.w	$s2, $fp, 112
.LBB3_83:                               # %_ZN20btAlignedObjectArrayI9btVector3E9push_backERKS0_.exit
	ld.d	$a0, $fp, 120
	vld	$vr0, $s0, 0
	slli.d	$a1, $a1, 4
	vstx	$vr0, $a0, $a1
