...
.Ltmp5:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp6:                                 # EH_LABEL
.LBB0_14:                               # %_ZN20btAlignedObjectArrayItED2Ev.exit
	ld.d	$a0, $fp, 184
	beqz	$a0, .LBB0_17
# %bb.15:                               # %_ZN20btAlignedObjectArrayItED2Ev.exit
	ld.b	$a1, $fp, 192
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_17
# %bb.16:
.Ltmp7:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp8:                                 # EH_LABEL
.LBB0_17:                               # %_ZN20btAlignedObjectArrayIjED2Ev.exit
	ld.d	$a0, $fp, 152
	beqz	$a0, .LBB0_20
# %bb.18:                               # %_ZN20btAlignedObjectArrayIjED2Ev.exit
	ld.b	$a1, $fp, 160
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_20
# %bb.19:
.Ltmp9:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp10:                                # EH_LABEL
.LBB0_20:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB0_23
# %bb.21:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.b	$a1, $fp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_23
# %bb.22:
.Ltmp11:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp12:                                # EH_LABEL
.LBB0_23:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit
.Ltmp13:                                # EH_LABEL
	move	$a0, $fp
...
# %bb.6:                                # %iter.check51
	...
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB2_29
# %bb.7:                                # %vector.main.loop.iter.check38
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_22
# %bb.8:
	move	$a3, $zero
...
.LBB2_17:
	...
	ld.d	$a0, $fp, 184
	bgtz	$a2, .LBB2_5
.LBB2_18:                               # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.i.i
	bnez	$a0, .LBB2_31
	b	.LBB2_34
.LBB2_19:
	move	$s0, $zero
	ld.d	$a0, $fp, 216
	bgtz	$a2, .LBB2_13
.LBB2_20:                               # %_ZNK20btAlignedObjectArrayItE4copyEiiPt.exit.i.i
	move	$a1, $s2
	beqz	$a0, .LBB2_47
...
.LBB2_23:                               # %vector.body43
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_23
# %bb.24:                               # %middle.block48
	beq	$a3, $a2, .LBB2_31
# %bb.25:                               # %vec.epilog.iter.check53
	beqz	$a4, .LBB2_29
.LBB2_26:                               # %vec.epilog.ph55
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $s0, 2
	.p2align	4, , 16
.LBB2_27:                               # %vec.epilog.vector.body58
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a6, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB2_27
# %bb.28:                               # %vec.epilog.middle.block62
	beq	$a3, $a2, .LBB2_31
.LBB2_29:                               # %vec.epilog.scalar.ph52.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a4, $a3, $a0, 2
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB2_30:                               # %vec.epilog.scalar.ph52
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a4, 0
	st.w	$a5, $a3, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a3, $a3, 4
	bnez	$a2, .LBB2_30
.LBB2_31:                               # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.thread.i.i
	ld.bu	$a2, $fp, 192
	beqz	$a2, .LBB2_33
# %bb.32:
	move	$s2, $a1
...
.LBB2_33:
	ld.w	$a2, $fp, 172
.LBB2_34:                               # %_ZN20btAlignedObjectArrayIjE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 192
	st.d	$s0, $fp, 184
	st.w	$s1, $fp, 176
.LBB2_35:                               # %_ZN20btAlignedObjectArrayIjE9push_backERKj.exit
	ld.d	$a0, $fp, 184
	slli.d	$a2, $a2, 2
	stx.w	$a1, $a0, $a2
	ld.w	$a1, $fp, 172
...
# %bb.42:                               # %vec.epilog.middle.block
	beq	$a3, $a2, .LBB2_45
.LBB2_43:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a4, $a2, $a3
	alsl.d	$a5, $a3, $a0, 1
	alsl.d	$a3, $a3, $s0, 1
	.p2align	4, , 16
.LBB2_44:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a6, $a5, 0
	st.h	$a6, $a3, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a3, $a3, 2
	bnez	$a4, .LBB2_44
.LBB2_45:                               # %_ZNK20btAlignedObjectArrayItE4copyEiiPt.exit.thread.i.i
	ld.bu	$a3, $fp, 224
	beqz	$a3, .LBB2_47
.LBB2_46:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	...
	move	$a1, $s2
	ld.w	$a2, $fp, 204
.LBB2_47:                               # %_ZN20btAlignedObjectArrayItE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 224
	st.d	$s0, $fp, 216
	st.w	$s1, $fp, 208
.LBB2_48:                               # %_ZN20btAlignedObjectArrayItE9push_backERKt.exit
	ld.d	$a0, $fp, 216
	slli.d	$a3, $a2, 1
	stx.h	$a1, $a0, $a3
	addi.d	$a1, $a2, 1
...
.LBB3_26:
	...
	ld.d	$a0, $fp, 152
	bgtz	$a2, .LBB3_20
.LBB3_27:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
	beqz	$a0, .LBB3_48
...
.LBB3_31:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 16
	bne	$a1, $a0, .LBB3_31
.LBB3_32:                               # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB3_35
...
# %bb.34:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB3_35:                               # %_ZN20btAlignedObjectArrayI9btVector3E10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	ld.w	$a1, $fp, 108
	st.b	$a0, $fp, 128
	st.d	$s1, $fp, 120
	st.w	$s2, $fp, 112
.LBB3_36:                               # %_ZN20btAlignedObjectArrayI9btVector3E9push_backERKS0_.exit
	ld.d	$a0, $fp, 120
	vld	$vr0, $s0, 0
	slli.d	$a1, $a1, 4
	vstx	$vr0, $a0, $a1
...
.LBB3_45:                               # %vec.epilog.scalar.ph
	...
	addi.d	$a1, $a1, 4
	bnez	$a3, .LBB3_45
.LBB3_46:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i
	ld.bu	$a1, $fp, 160
	beqz	$a1, .LBB3_48
.LBB3_47:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	ld.w	$a2, $fp, 140
.LBB3_48:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s1, $fp, 152
	st.w	$s2, $fp, 144
.LBB3_49:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit
	ld.d	$a1, $fp, 152
	slli.d	$a0, $a2, 2
	fstx.s	$fs0, $a1, $a0
	fld.s	$fs0, $s0, 4
...
# %bb.54:                               # %iter.check171
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB3_69
# %bb.55:                               # %vector.main.loop.iter.check158
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB3_62
# %bb.56:
	move	$a0, $zero
...
.LBB3_59:
	move	$s1, $zero
	bgtz	$s2, .LBB3_53
.LBB3_60:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i55
	beqz	$a1, .LBB3_73
# %bb.61:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i55
	ld.b	$a0, $fp, 160
	andi	$a0, $a0, 1
	bnez	$a0, .LBB3_72
	b	.LBB3_73
.LBB3_62:                               # %vector.ph160
	andi	$a2, $s2, 12
...
.LBB3_63:                               # %vector.body163
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB3_63
# %bb.64:                               # %middle.block168
	beq	$a0, $s2, .LBB3_71
# %bb.65:                               # %vec.epilog.iter.check173
	beqz	$a2, .LBB3_69
.LBB3_66:                               # %vec.epilog.ph175
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s1, 2
	.p2align	4, , 16
.LBB3_67:                               # %vec.epilog.vector.body178
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB3_67
# %bb.68:                               # %vec.epilog.middle.block182
	beq	$a0, $s2, .LBB3_71
.LBB3_69:                               # %vec.epilog.scalar.ph172.preheader
	sub.d	$a2, $s2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB3_70:                               # %vec.epilog.scalar.ph172
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB3_70
.LBB3_71:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i66
	ld.bu	$a0, $fp, 160
	beqz	$a0, .LBB3_73
.LBB3_72:
	move	$a0, $a1
	...
	jirl	$ra, $ra, 0
	ld.w	$s2, $fp, 140
.LBB3_73:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i58
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s1, $fp, 152
	st.w	$s3, $fp, 144
.LBB3_74:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit70
	move	$a0, $s2
.LBB3_75:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit70
	slli.d	$a1, $a0, 2
	fstx.s	$fs0, $s1, $a1
	fld.s	$fs0, $s0, 8
	addi.w	$a0, $a0, 1
...
# %bb.80:                               # %iter.check202
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB3_95
# %bb.81:                               # %vector.main.loop.iter.check189
	ori	$a0, $zero, 16
	bgeu	$s3, $a0, .LBB3_88
# %bb.82:
	move	$a0, $zero
...
.LBB3_85:
	move	$s0, $zero
	bgtz	$s3, .LBB3_79
.LBB3_86:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i76
	beqz	$s1, .LBB3_99
# %bb.87:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i76
	ld.b	$a0, $fp, 160
	andi	$a0, $a0, 1
	bnez	$a0, .LBB3_98
	b	.LBB3_99
.LBB3_88:                               # %vector.ph191
	andi	$a1, $s3, 12
...
.LBB3_89:                               # %vector.body194
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB3_89
# %bb.90:                               # %middle.block199
	beq	$a0, $s3, .LBB3_97
# %bb.91:                               # %vec.epilog.iter.check204
	beqz	$a1, .LBB3_95
.LBB3_92:                               # %vec.epilog.ph206
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB3_93:                               # %vec.epilog.vector.body209
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	addi.d	$a1, $a1, 4
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB3_93
# %bb.94:                               # %vec.epilog.middle.block213
	beq	$a0, $s3, .LBB3_97
.LBB3_95:                               # %vec.epilog.scalar.ph203.preheader
	sub.d	$a1, $s3, $a0
	alsl.d	$a2, $a0, $s1, 2
	alsl.d	$a0, $a0, $s0, 2
	.p2align	4, , 16
.LBB3_96:                               # %vec.epilog.scalar.ph203
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB3_96
.LBB3_97:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i87
	ld.bu	$a0, $fp, 160
	beqz	$a0, .LBB3_99
.LBB3_98:
	move	$a0, $s1
	...
	jirl	$ra, $ra, 0
	ld.w	$s3, $fp, 140
.LBB3_99:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i79
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s0, $fp, 152
	st.w	$s2, $fp, 144
.LBB3_100:                              # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit91
	move	$a0, $s3
.LBB3_101:                              # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit91
	ld.d	$a1, $fp, 40
	slli.d	$a2, $a0, 2
	ld.w	$a3, $a1, 20
	fstx.s	$fs0, $s0, $a2
...
.Ltmp16:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp17:                                # EH_LABEL
.LBB6_3:                                # %_ZN20btAlignedObjectArrayItED2Ev.exit
	ld.d	$a0, $fp, 184
	beqz	$a0, .LBB6_6
# %bb.4:                                # %_ZN20btAlignedObjectArrayItED2Ev.exit
	ld.b	$a1, $fp, 192
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_6
# %bb.5:
.Ltmp21:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp22:                                # EH_LABEL
.LBB6_6:                                # %_ZN20btAlignedObjectArrayIjED2Ev.exit
	ld.d	$a0, $fp, 152
	beqz	$a0, .LBB6_9
# %bb.7:                                # %_ZN20btAlignedObjectArrayIjED2Ev.exit
	ld.b	$a1, $fp, 160
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_9
# %bb.8:
.Ltmp26:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp27:                                # EH_LABEL
.LBB6_9:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB6_12
# %bb.10:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.b	$a1, $fp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_12
# %bb.11:
.Ltmp31:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp32:                                # EH_LABEL
.LBB6_12:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit
	move	$a0, $fp
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
...
.Ltmp19:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp20:                                # EH_LABEL
.LBB6_19:                               # %_ZN20btAlignedObjectArrayIjED2Ev.exit22
	ld.d	$a0, $fp, 152
	beqz	$a0, .LBB6_22
# %bb.20:                               # %_ZN20btAlignedObjectArrayIjED2Ev.exit22
	ld.b	$a1, $fp, 160
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_22
# %bb.21:
.Ltmp24:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp25:                                # EH_LABEL
.LBB6_22:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit26
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB6_25
# %bb.23:                               # %_ZN20btAlignedObjectArrayIfED2Ev.exit26
	ld.b	$a1, $fp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_25
# %bb.24:
.Ltmp29:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp30:                                # EH_LABEL
.LBB6_25:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit30
.Ltmp34:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN26btTriangleIndexVertexArrayD2Ev)
	jirl	$ra, $ra, 0
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV14btTriangleMesh
