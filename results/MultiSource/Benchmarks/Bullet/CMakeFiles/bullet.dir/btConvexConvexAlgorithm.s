...
.LBB8_45:
	...
	st.d	$zero, $sp, 104
	movgr2fr.w	$fa5, $zero
.LBB8_46:                               # %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit.i
	fadd.s	$fa2, $fa2, $ft1
	fadd.s	$fa3, $fa3, $ft2
	fadd.s	$fa4, $fa4, $ft3
	fmul.s	$ft0, $fa6, $ft0
...
.LBB8_49:
	...
	ld.w	$a1, $a0, 728
	beqz	$a1, .LBB8_51
# %bb.50:                               # %_ZN16btManifoldResult20refreshContactPointsEv.exit.sink.split
	ld.d	$a1, $a0, 712
	ld.d	$a2, $fp, 144
	xor	$a1, $a1, $a2
	sltui	$a1, $a1, 1
	...
	jirl	$ra, $ra, 0
.LBB8_51:                               # %_ZN16btManifoldResult20refreshContactPointsEv.exit
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTVN23btConvexConvexAlgorithm10CreateFuncE
	.addrsig_sym _ZTV23btConvexConvexAlgorithm
	...
	.addrsig_sym _ZTV24btPerturbedContactResult
