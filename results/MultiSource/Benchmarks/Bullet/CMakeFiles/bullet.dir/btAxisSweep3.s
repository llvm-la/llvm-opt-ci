...
# %bb.0:
	...
	addi.d	$a2, $a0, %pc_lo12(_ZTV15btNullPairCache+16)
	ld.d	$a0, $a1, 24
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB32_3
# %bb.1:
...
# %bb.2:
	pcaddu18i	$t8, %call36(_Z21btAlignedFreeInternalPv)
	jr	$t8
.LBB32_3:                               # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit
	ret
.Lfunc_end32:
...
.Ltmp18:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp19:                                # EH_LABEL
.LBB33_3:                               # %_ZN15btNullPairCacheD2Ev.exit
	move	$a0, $fp
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV12btAxisSweep3
	.addrsig_sym _ZTV17bt32BitAxisSweep3
	...
	.addrsig_sym _ZTV20btAxisSweep3InternalItE
	.addrsig_sym _ZTV15btNullPairCache
	...
	.addrsig_sym _ZTV20btAxisSweep3InternalIjE
