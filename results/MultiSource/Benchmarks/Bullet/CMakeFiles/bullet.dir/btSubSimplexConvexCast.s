...
# %bb.0:
	...
	fsub.s	$fa0, $fa0, $fa2
	fst.s	$fa3, $sp, 116                  # 4-byte Folded Spill
	fsub.s	$fa1, $fa1, $fa3
	fld.s	$fa2, $s3, 56
	fld.s	$fa6, $s4, 56
	fld.s	$fa3, $s1, 48
	...
	fld.s	$fa5, $s1, 56
	fld.s	$ft1, $s2, 56
	fst.s	$fa6, $sp, 112                  # 4-byte Folded Spill
	fsub.s	$fa2, $fa2, $fa6
	fst.s	$fa7, $sp, 108                  # 4-byte Folded Spill
	fsub.s	$fa3, $fa3, $fa7
	fst.s	$ft0, $sp, 104                  # 4-byte Folded Spill
	fsub.s	$fa4, $fa4, $ft0
	fst.s	$ft1, $sp, 100                  # 4-byte Folded Spill
	fsub.s	$fa5, $fa5, $ft1
	fld.s	$fa6, $s4, 0
	fld.s	$fa7, $s4, 4
	fld.s	$ft0, $s4, 8
	...
	fneg.s	$fa1, $fs1
	fneg.s	$fa2, $fs0
	fst.s	$ft1, $sp, 84                   # 4-byte Folded Spill
	fmul.s	$fa3, $ft1, $fa1
	fst.s	$fa6, $sp, 96                   # 4-byte Folded Spill
	fmadd.s	$fa3, $fa6, $fa0, $fa3
	fst.s	$ft4, $sp, 132                  # 4-byte Folded Spill
	fmadd.s	$fa3, $ft4, $fa2, $fa3
	fst.s	$ft2, $sp, 80                   # 4-byte Folded Spill
	fmul.s	$fa4, $ft2, $fa1
	fst.s	$fa7, $sp, 92                   # 4-byte Folded Spill
	fmadd.s	$fa4, $fa7, $fa0, $fa4
	fst.s	$ft5, $sp, 72                   # 4-byte Folded Spill
	fmadd.s	$fa4, $ft5, $fa2, $fa4
	fst.s	$ft3, $sp, 76                   # 4-byte Folded Spill
	fmul.s	$fa1, $ft3, $fa1
	fst.s	$ft0, $sp, 88                   # 4-byte Folded Spill
	fmadd.s	$fa0, $ft0, $fa0, $fa1
	fst.s	$ft6, $sp, 68                   # 4-byte Folded Spill
...
.LBB1_2:                                # =>This Inner Loop Header: Depth=1
	...
	fneg.s	$fa1, $fa1
	fneg.s	$fa2, $fa2
	fld.s	$fs4, $sp, 84                   # 4-byte Folded Reload
	fmul.s	$fa3, $fs4, $fa1
	fld.s	$fs6, $sp, 96                   # 4-byte Folded Reload
	fmadd.s	$fa3, $fs6, $fa0, $fa3
	fld.s	$fa4, $sp, 132                  # 4-byte Folded Reload
	fmadd.s	$fa3, $fa4, $fa2, $fa3
	fld.s	$fs2, $sp, 80                   # 4-byte Folded Reload
	fmul.s	$fa4, $fs2, $fa1
	...
	fld.s	$fs5, $sp, 68                   # 4-byte Folded Reload
	...
	fmul.s	$fa3, $fs7, $fa1
	fmadd.s	$fa3, $fs6, $fa0, $fa3
	fmadd.s	$fa3, $fs0, $fa2, $fa3
	fld.s	$fa4, $sp, 120                  # 4-byte Folded Reload
	fadd.s	$fa3, $fa4, $fa3
	fmul.s	$fa4, $fs2, $fa1
	fmadd.s	$fa4, $fs4, $fa0, $fa4
	...
	fmadd.s	$fa3, $fa4, $fa2, $fa3
	fld.s	$fs4, $sp, 48                   # 4-byte Folded Reload
	fmul.s	$fa4, $fs4, $fa0
	fld.s	$fs1, $sp, 60                   # 4-byte Folded Reload
	fmadd.s	$fa4, $fs1, $fa1, $fa4
	fld.s	$fs7, $sp, 40                   # 4-byte Folded Reload
	fmadd.s	$fa4, $fs7, $fa2, $fa4
	fld.s	$fs5, $sp, 44                   # 4-byte Folded Reload
	fmul.s	$fa0, $fs5, $fa0
	fld.s	$fs2, $sp, 56                   # 4-byte Folded Reload
	fmadd.s	$fa0, $fs2, $fa1, $fa0
	fld.s	$fs6, $sp, 36                   # 4-byte Folded Reload
...
# %bb.5:                                #   in Loop: Header=BB1_2 Depth=1
	...
	fst.s	$fa4, $sp, 120                  # 4-byte Folded Spill
	fmul.s	$fa4, $fs0, $fa6
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV22btSubsimplexConvexCast
