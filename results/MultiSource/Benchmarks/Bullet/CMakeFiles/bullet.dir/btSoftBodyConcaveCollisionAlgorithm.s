...
.Ltmp19:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp20:                                # EH_LABEL
.LBB6_3:                                # %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEED2Ev.exit
	ld.d	$a0, $fp, 80
	beqz	$a0, .LBB6_6
# %bb.4:                                # %_ZN20btAlignedObjectArrayI9btHashKeyI10btTriIndexEED2Ev.exit
	ld.b	$a1, $fp, 88
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_6
# %bb.5:
.Ltmp24:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp25:                                # EH_LABEL
.LBB6_6:                                # %_ZN20btAlignedObjectArrayI10btTriIndexED2Ev.exit
	ld.d	$a0, $fp, 48
	beqz	$a0, .LBB6_9
# %bb.7:                                # %_ZN20btAlignedObjectArrayI10btTriIndexED2Ev.exit
	ld.b	$a1, $fp, 56
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_9
# %bb.8:
.Ltmp29:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp30:                                # EH_LABEL
.LBB6_9:                                # %_ZN20btAlignedObjectArrayIiED2Ev.exit
	ld.d	$a0, $fp, 16
	beqz	$a0, .LBB6_12
# %bb.10:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit
	ld.b	$a1, $fp, 24
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_12
# %bb.11:
...
.Ltmp22:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp23:                                # EH_LABEL
.LBB6_18:                               # %_ZN20btAlignedObjectArrayI10btTriIndexED2Ev.exit19
	ld.d	$a0, $fp, 48
	beqz	$a0, .LBB6_21
# %bb.19:                               # %_ZN20btAlignedObjectArrayI10btTriIndexED2Ev.exit19
	ld.b	$a1, $fp, 56
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_21
# %bb.20:
.Ltmp27:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp28:                                # EH_LABEL
.LBB6_21:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit23
	ld.d	$a0, $fp, 16
	beqz	$a0, .LBB6_24
# %bb.22:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit23
	ld.b	$a1, $fp, 24
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_24
# %bb.23:
.Ltmp32:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp33:                                # EH_LABEL
.LBB6_24:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit27
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_25:
...
.Lcst_begin9:
	...
	.uleb128 .Lfunc_end18-.Ltmp85           #   Call between .Ltmp85 and .Lfunc_end18
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end9:
	.byte	1                               # >> Action Record 1 <<
...
.Lcst_begin10:
	...
	.uleb128 .Lfunc_end23-.Ltmp91           #   Call between .Ltmp91 and .Lfunc_end23
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end10:
	.byte	1                               # >> Action Record 1 <<
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV35btSoftBodyConcaveCollisionAlgorithm
	.addrsig_sym _ZTV26btSoftBodyTriangleCallback
	...
	.addrsig_sym _ZTVZN35btSoftBodyConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResultE31LocalTriangleSphereCastCallback
	...
	.addrsig_sym _ZTV15btTriangleShape
