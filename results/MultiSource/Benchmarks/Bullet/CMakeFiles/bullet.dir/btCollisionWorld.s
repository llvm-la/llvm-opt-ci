...
.Ltmp3:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp4:                                 # EH_LABEL
.LBB0_5:                                # %_ZN20btAlignedObjectArrayIP17btCollisionObjectED2Ev.exit
	move	$a0, $s0
...
# %bb.10:
	...
	jr	$t8
.LBB2_11:                               # %_ZN20btAlignedObjectArrayIP17btCollisionObjectED2Ev.exit13
	ld.d	$s3, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
...
.Ltmp13:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp14:                                # EH_LABEL
.LBB2_15:                               # %_ZN20btAlignedObjectArrayIP17btCollisionObjectED2Ev.exit
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB2_16:
...
.LBB4_10:                               # %scalar.ph
	...
	addi.d	$a1, $a1, 8
	bnez	$a2, .LBB4_10
.LBB4_11:                               # %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.thread.i.i
	ld.bu	$a1, $s2, 32
	bnez	$a1, .LBB4_15
	b	.LBB4_16
.LBB4_12:
	...
	ld.d	$a0, $s2, 24
	bgtz	$a4, .LBB4_4
.LBB4_13:                               # %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i
	beqz	$a0, .LBB4_16
...
.LBB4_15:
	...
	jirl	$ra, $ra, 0
	ld.w	$a4, $s2, 12
.LBB4_16:                               # %_ZN20btAlignedObjectArrayIP17btCollisionObjectE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $s2, 32
	st.d	$s3, $s2, 24
	st.w	$s4, $s2, 16
.LBB4_17:                               # %_ZN20btAlignedObjectArrayIP17btCollisionObjectE9push_backERKS1_.exit
	ld.d	$a0, $s2, 24
	slli.d	$a1, $a4, 3
	stx.d	$fp, $a0, $a1
	addi.d	$a0, $a4, 1
...
.LBB7_14:
.Ltmp37:                                # EH_LABEL
.LBB7_15:                               # %_ZN14CProfileSampleD2Ev.exit14
	move	$fp, $a0
.LBB7_16:                               # %_ZN14CProfileSampleD2Ev.exit14
.Ltmp50:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZN15CProfileManager12Stop_ProfileEv)
	jirl	$ra, $ra, 0
.Ltmp51:                                # EH_LABEL
...
# %bb.9:
	...
	fmadd.s	$ft3, $fa7, $ft5, $ft0
	fmul.s	$ft0, $fa6, $ft4
	fmadd.s	$ft0, $fa5, $fa3, $ft0
	fmadd.s	$ft0, $fa4, $ft5, $ft0
	fmul.s	$ft4, $fa1, $ft4
	fmadd.s	$fa3, $fa0, $fa3, $ft4
	ori	$a1, $zero, 21
	fmadd.s	$fa3, $fa2, $ft5, $fa3
	bne	$a0, $a1, .LBB9_18
# %bb.10:
	fld.s	$ft4, $s3, 52
	fld.s	$ft5, $s3, 48
	...
	fld.s	$ft7, $s4, 56
	fmul.s	$ft8, $fa1, $ft4
	fmadd.s	$ft8, $fa0, $ft5, $ft8
	fmadd.s	$ft8, $fa2, $ft6, $ft8
	fadd.s	$ft8, $fa3, $ft8
	fld.s	$ft9, $s4, 52
	movfr2gr.s	$a0, $ft8
	fld.s	$ft8, $s4, 48
	...
	fmul.s	$ft10, $ft2, $ft9
	fmul.s	$ft2, $ft2, $ft4
	fmadd.s	$ft10, $ft1, $ft8, $ft10
	fmadd.s	$ft1, $ft1, $ft5, $ft2
	fmadd.s	$ft2, $fa7, $ft7, $ft10
	fmadd.s	$fa7, $fa7, $ft6, $ft1
	fadd.s	$ft1, $ft3, $ft2
	fadd.s	$fa7, $ft3, $fa7
	fmul.s	$ft2, $fa6, $ft9
	fmul.s	$fa6, $fa6, $ft4
	fmadd.s	$ft2, $fa5, $ft8, $ft2
	fmadd.s	$fa5, $fa5, $ft5, $fa6
	fmadd.s	$fa6, $fa4, $ft7, $ft2
	fmadd.s	$fa4, $fa4, $ft6, $fa5
	fadd.s	$fa5, $ft0, $fa6
	fadd.s	$fa4, $ft0, $fa4
...
# %bb.20:                               # %_Z8btSetMinIfEvRT_RKS0_.exit.i
	...
	bceqz	$fcc0, .LBB9_33
.LBB9_21:                               # %_Z8btSetMinIfEvRT_RKS0_.exit5.i
	fld.s	$fa2, $sp, 40
	fld.s	$fa3, $sp, 80
	fcmp.cule.s	$fcc0, $fa3, $fa2
	bceqz	$fcc0, .LBB9_34
.LBB9_22:                               # %_Z8btSetMinIfEvRT_RKS0_.exit6.i
	fld.s	$fa3, $sp, 44
	fld.s	$fa4, $sp, 84
...
.LBB9_23:
	fst.s	$fa3, $sp, 84
.LBB9_24:                               # %_ZN9btVector36setMinERKS_.exit
	vld	$vr4, $sp, 464
	vst	$vr4, $sp, 16
	fld.s	$fa4, $sp, 16
	fcmp.cule.s	$fcc0, $fa0, $fa4
...
# %bb.25:                               # %_Z8btSetMaxIfEvRT_RKS0_.exit.i
	...
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bceqz	$fcc0, .LBB9_36
.LBB9_26:                               # %_Z8btSetMaxIfEvRT_RKS0_.exit5.i
	fld.s	$fa0, $sp, 24
	fcmp.cule.s	$fcc0, $fa2, $fa0
	bceqz	$fcc0, .LBB9_37
.LBB9_27:                               # %_Z8btSetMaxIfEvRT_RKS0_.exit6.i
	fld.s	$fa0, $sp, 28
	fcmp.cule.s	$fcc0, $fa3, $fa0
	bcnez	$fcc0, .LBB9_29
.LBB9_28:
	fst.s	$fa3, $sp, 28
.LBB9_29:                               # %_ZN9btVector36setMaxERKS_.exit
	ld.d	$a0, $s1, 0
	ld.d	$a4, $a0, 96
.Ltmp58:                                # EH_LABEL
	addi.d	$a1, $sp, 104
...
# %bb.20:
	fst.s	$fa3, $sp, 64
	fmov.s	$fa5, $fa3
.LBB11_21:                              # %_Z8btSetMinIfEvRT_RKS0_.exit.i
...
# %bb.22:
	fst.s	$fa4, $sp, 68
	fmov.s	$fa6, $fa4
.LBB11_23:                              # %_Z8btSetMinIfEvRT_RKS0_.exit5.i
...
.Ltmp95:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp96:                                # EH_LABEL
.LBB11_35:                              # %_ZN14CProfileSampleD2Ev.exit
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB11_36:
...
.Lcst_begin6:
	...
	.uleb128 .Lfunc_end11-.Ltmp96           #   Call between .Ltmp96 and .Lfunc_end11
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end6:
	.byte	1                               # >> Action Record 1 <<
...
.Ltmp140:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Lfunc_end13:
	.size	_ZNK16btCollisionWorld15convexSweepTestEPK13btConvexShapeRK11btTransformS5_RNS_20ConvexResultCallbackEf, .Lfunc_end13-_ZNK16btCollisionWorld15convexSweepTestEPK13btConvexShapeRK11btTransformS5_RNS_20ConvexResultCallbackEf
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table13:
...
.Lcst_begin7:
	...
	.uleb128 .Lfunc_end13-.Ltmp139          #   Call between .Ltmp139 and .Lfunc_end13
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end7:
	.byte	1                               # >> Action Record 1 <<
...
# %bb.0:
	ret
.Lfunc_end14:
	.size	_ZN23btBroadphaseRayCallbackD2Ev, .Lfunc_end14-_ZN23btBroadphaseRayCallbackD2Ev
                                        # -- End function
...
.Lcst_begin8:
	...
	.uleb128 .Lfunc_end20-.Ltmp142          #   Call between .Ltmp142 and .Lfunc_end20
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end8:
	.p2align	2, 0x0
...
.Lcst_begin10:
	...
	.uleb128 .Lfunc_end24-.Ltmp148          #   Call between .Ltmp148 and .Lfunc_end24
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end10:
	.p2align	2, 0x0
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV16btCollisionWorld
	.addrsig_sym _ZTI16btCollisionWorld
	.addrsig_sym _ZTVN10__cxxabiv117__class_type_infoE
	.addrsig_sym _ZTS16btCollisionWorld
	.addrsig_sym _ZTV13btSphereShape
	.addrsig_sym _ZTVN12btConvexCast10CastResultE
	.addrsig_sym _ZTIN12btConvexCast10CastResultE
	.addrsig_sym _ZTSN12btConvexCast10CastResultE
	.addrsig_sym _ZTVZN16btCollisionWorld13rayTestSingleERK11btTransformS2_P17btCollisionObjectPK16btCollisionShapeS2_RNS_17RayResultCallbackEE29BridgeTriangleRaycastCallback
	...
	.addrsig_sym _ZTVZN16btCollisionWorld13rayTestSingleERK11btTransformS2_P17btCollisionObjectPK16btCollisionShapeS2_RNS_17RayResultCallbackEE29BridgeTriangleRaycastCallback_0
	...
	.addrsig_sym _ZTV30btGjkEpaPenetrationDepthSolver
	.addrsig_sym _ZTVZN16btCollisionWorld17objectQuerySingleEPK13btConvexShapeRK11btTransformS5_P17btCollisionObjectPK16btCollisionShapeS5_RNS_20ConvexResultCallbackEfE32BridgeTriangleConvexcastCallback
	...
	.addrsig_sym _ZTVZN16btCollisionWorld17objectQuerySingleEPK13btConvexShapeRK11btTransformS5_P17btCollisionObjectPK16btCollisionShapeS5_RNS_20ConvexResultCallbackEfE32BridgeTriangleConvexcastCallback_0
	...
	.addrsig_sym _ZTV19btSingleRayCallback
	...
	.addrsig_sym _ZTV21btSingleSweepCallback
