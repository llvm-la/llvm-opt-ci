...
.Ltmp7:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp8:                                 # EH_LABEL
.LBB0_12:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit
	ld.d	$a0, $fp, 72
	beqz	$a0, .LBB0_15
# %bb.13:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit
	ld.b	$a1, $fp, 80
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_15
# %bb.14:
.Ltmp9:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp10:                                # EH_LABEL
.LBB0_15:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit14
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB0_18
# %bb.16:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit14
	ld.b	$a1, $fp, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_18
# %bb.17:
.Ltmp11:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp12:                                # EH_LABEL
.LBB0_18:                               # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit
	move	$a0, $s0
...
# %bb.18:                               # %vec.epilog.middle.block
	beq	$a2, $a1, .LBB1_21
.LBB1_19:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s0, 2
	.p2align	4, , 16
.LBB1_20:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB1_20
.LBB1_21:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.thread.i.i
	ld.bu	$a1, $fp, 80
	beqz	$a1, .LBB1_23
.LBB1_22:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
...
# %bb.29:                               # %iter.check88
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB1_43
# %bb.30:                               # %vector.main.loop.iter.check75
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB1_36
# %bb.31:
	move	$a2, $zero
	b	.LBB1_40
.LBB1_32:                               # %..lr.ph.i24_crit_edge
	ld.d	$s1, $fp, 104
	b	.LBB1_48
.LBB1_33:
	move	$s1, $zero
	...
	ld.d	$a0, $fp, 104
	bgtz	$a1, .LBB1_28
.LBB1_34:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i34
	beqz	$a0, .LBB1_47
# %bb.35:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i34
	ld.b	$a1, $fp, 112
	andi	$a1, $a1, 1
	bnez	$a1, .LBB1_46
	b	.LBB1_47
...
# %bb.38:                               # %middle.block85
	beq	$a2, $a1, .LBB1_45
# %bb.39:                               # %vec.epilog.iter.check90
	beqz	$a3, .LBB1_43
.LBB1_40:                               # %vec.epilog.ph92
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB1_41:                               # %vec.epilog.vector.body95
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_41
# %bb.42:                               # %vec.epilog.middle.block99
	beq	$a2, $a1, .LBB1_45
.LBB1_43:                               # %vec.epilog.scalar.ph89.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB1_44:                               # %vec.epilog.scalar.ph89
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB1_44
.LBB1_45:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.thread.i.i43
	ld.bu	$a1, $fp, 112
	beqz	$a1, .LBB1_47
.LBB1_46:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB1_47:                               # %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i37
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 112
	st.d	$s1, $fp, 104
	st.w	$s3, $fp, 96
.LBB1_48:                               # %.lr.ph.i24
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB1_49:                               # %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit47
	st.w	$s3, $fp, 92
	blez	$s3, .LBB1_51
# %bb.50:                               # %.lr.ph52
	ld.d	$a0, $fp, 72
...
.Ltmp14:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
.LBB3_3:                                # %_ZN20btAlignedObjectArrayIiED2Ev.exit
	ld.d	$a0, $fp, 72
	beqz	$a0, .LBB3_6
# %bb.4:                                # %_ZN20btAlignedObjectArrayIiED2Ev.exit
	ld.b	$a1, $fp, 80
	andi	$a1, $a1, 1
	beqz	$a1, .LBB3_6
# %bb.5:
.Ltmp19:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp20:                                # EH_LABEL
.LBB3_6:                                # %_ZN20btAlignedObjectArrayIiED2Ev.exit10
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB3_9
# %bb.7:                                # %_ZN20btAlignedObjectArrayIiED2Ev.exit10
	ld.b	$a1, $fp, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB3_9
# %bb.8:
	...
	jr	$t8
.LBB3_9:                                # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 32
...
.Ltmp17:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp18:                                # EH_LABEL
.LBB3_14:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit17
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB3_17
# %bb.15:                               # %_ZN20btAlignedObjectArrayIiED2Ev.exit17
	ld.b	$a1, $fp, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB3_17
# %bb.16:
.Ltmp22:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp23:                                # EH_LABEL
.LBB3_17:                               # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit21
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB3_18:
...
# %bb.2:                                # %.lr.ph
	...
	b	.LBB8_4
	.p2align	4, , 16
.LBB8_3:                                # %_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.thread
...
# %bb.1:                                # %.lr.ph.i
	...
	b	.LBB9_3
	.p2align	4, , 16
.LBB9_2:                                # %_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.thread.i
...
.LBB9_11:                               # =>This Inner Loop Header: Depth=1
	...
	st.d	$a2, $a4, 24
	bne	$a1, $a0, .LBB9_11
.LBB9_12:                               # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i
	ld.d	$a0, $s0, 24
	beqz	$a0, .LBB9_15
...
# %bb.14:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB9_15:                               # %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i
	ori	$a1, $zero, 1
	ld.w	$a0, $s0, 12
	st.b	$a1, $s0, 32
	st.d	$s2, $s0, 24
	st.w	$s7, $s0, 16
.LBB9_16:                               # %_ZN20btAlignedObjectArrayI16btBroadphasePairE6expandERKS0_.exit
	addi.d	$a0, $a0, 1
	ld.d	$a1, $s0, 24
	st.w	$a0, $s0, 12
	slli.d	$s2, $s6, 5
...
.LBB9_20:
	...
	stx.w	$a4, $a5, $a0
	stx.w	$s6, $a3, $a2
.LBB9_21:                               # %_ZN28btHashedOverlappingPairCache16internalFindPairEP17btBroadphaseProxyS1_i.exit
	move	$a0, $s2
...
# %bb.1:                                # %.lr.ph.i
	...
	b	.LBB10_3
	.p2align	4, , 16
.LBB10_2:                               # %_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.thread.i
...
# %bb.4:                                # %_ZN28btHashedOverlappingPairCache10equalsPairERK16btBroadphasePairii.exit.i
	...
	ld.w	$a7, $a7, 24
	bne	$a7, $a1, .LBB10_2
# %bb.5:                                # %_ZN28btHashedOverlappingPairCache16internalFindPairEP17btBroadphaseProxyS1_i.exit
	ld.d	$a1, $a0, 0
	ld.d	$a4, $a1, 64
	move	$s1, $a0
	move	$a1, $s2
...
.LBB10_20:
	...
	stx.w	$a5, $a6, $a3
	stx.w	$s2, $a1, $a4
.LBB10_21:                              # %_ZN28btHashedOverlappingPairCache16internalFindPairEP17btBroadphaseProxyS1_i.exit.thread.sink.split
	ld.w	$a1, $a2, 12
	addi.d	$a1, $a1, -1
	st.w	$a1, $a2, 12
.LBB10_22:                              # %_ZN28btHashedOverlappingPairCache16internalFindPairEP17btBroadphaseProxyS1_i.exit.thread
	ld.d	$s7, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
	...
	ret
.Lfunc_end10:
	.size	_ZN28btHashedOverlappingPairCache21removeOverlappingPairEP17btBroadphaseProxyS1_P12btDispatcher, .Lfunc_end10-_ZN28btHashedOverlappingPairCache21removeOverlappingPairEP17btBroadphaseProxyS1_P12btDispatcher
	.cfi_endproc
                                        # -- End function
...
.LBB11_5:                               # %._crit_edge
	...
	ret
.Lfunc_end11:
	.size	_ZN28btHashedOverlappingPairCache26processAllOverlappingPairsEP17btOverlapCallbackP12btDispatcher, .Lfunc_end11-_ZN28btHashedOverlappingPairCache26processAllOverlappingPairsEP17btOverlapCallbackP12btDispatcher
	.cfi_endproc
                                        # -- End function
...
.LBB12_11:                              #   in Loop: Header=BB12_4 Depth=1
	move	$s2, $zero
	bgtz	$s8, .LBB12_9
.LBB12_12:                              # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i
                                        #   in Loop: Header=BB12_4 Depth=1
	beqz	$s1, .LBB12_14
.LBB12_13:                              # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i.thread
                                        #   in Loop: Header=BB12_4 Depth=1
.Ltmp30:                                # EH_LABEL
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp31:                                # EH_LABEL
.LBB12_14:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i
                                        #   in Loop: Header=BB12_4 Depth=1
	st.b	$s4, $sp, 32
	st.d	$s2, $sp, 24
	st.w	$s6, $sp, 16
	move	$s1, $s2
	b	.LBB12_3
.LBB12_15:                              # %.preheader25
	bltz	$a0, .LBB12_19
# %bb.16:                               # %.lr.ph33.preheader
	move	$s2, $zero
	addi.d	$s1, $s1, 8
	.p2align	4, , 16
.LBB12_17:                              # %.lr.ph33
...
# %bb.25:                               # %._ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit_crit_edge
	ld.w	$s3, $sp, 12
.LBB12_26:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit
	blez	$s3, .LBB12_30
...
# %bb.32:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB12_33:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit24
	...
	addi.d	$sp, $sp, 128
	ret
.LBB12_34:                              # %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp
.Ltmp38:                                # EH_LABEL
	b	.LBB12_38
.LBB12_35:                              # %.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp32:                                # EH_LABEL
	b	.LBB12_38
.LBB12_36:                              # %.loopexit.split-lp.loopexit
.Ltmp35:                                # EH_LABEL
	b	.LBB12_38
.LBB12_37:                              # %.loopexit
.Ltmp41:                                # EH_LABEL
.LBB12_38:                              # %.loopexit.split-lp
	move	$fp, $a0
	ld.d	$a0, $sp, 24
	beqz	$a0, .LBB12_41
# %bb.39:                               # %.loopexit.split-lp
	ld.b	$a1, $sp, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB12_41
# %bb.40:
.Ltmp42:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp43:                                # EH_LABEL
.LBB12_41:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB12_42:
.Ltmp44:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Lfunc_end12:
	.size	_ZN28btHashedOverlappingPairCache20sortOverlappingPairsEP12btDispatcher, .Lfunc_end12-_ZN28btHashedOverlappingPairCache20sortOverlappingPairsEP12btDispatcher
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table12:
...
.LBB13_11:                              # %.thread
	...
	ret
.Lfunc_end13:
	.size	_ZN28btSortedOverlappingPairCache21removeOverlappingPairEP17btBroadphaseProxyS1_P12btDispatcher, .Lfunc_end13-_ZN28btSortedOverlappingPairCache21removeOverlappingPairEP17btBroadphaseProxyS1_P12btDispatcher
	.cfi_endproc
                                        # -- End function
...
.LBB14_12:                              # =>This Inner Loop Header: Depth=1
	...
	st.d	$a2, $a4, 24
	bne	$a1, $a0, .LBB14_12
.LBB14_13:                              # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i
	ld.d	$a0, $s1, 24
	beqz	$a0, .LBB14_16
...
# %bb.15:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB14_16:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i
	ori	$a1, $zero, 1
	ld.w	$a0, $s1, 12
	st.b	$a1, $s1, 32
	st.d	$s2, $s1, 24
	st.w	$s4, $s1, 16
.LBB14_17:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE6expandERKS0_.exit
	addi.d	$a0, $a0, 1
	ld.d	$a1, $s1, 24
	st.w	$a0, $s1, 12
	slli.d	$a2, $s3, 5
...
# %bb.18:
	...
	jirl	$ra, $a3, 0
	move	$a0, $s1
.LBB14_19:                              # %_ZNK28btSortedOverlappingPairCache24needsBroadphaseCollisionEP17btBroadphaseProxyS1_.exit.thread
	ld.d	$s4, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s3, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
	...
	ret
.Lfunc_end14:
	.size	_ZN28btSortedOverlappingPairCache18addOverlappingPairEP17btBroadphaseProxyS1_, .Lfunc_end14-_ZN28btSortedOverlappingPairCache18addOverlappingPairEP17btBroadphaseProxyS1_
	.cfi_endproc
                                        # -- End function
...
.LBB15_10:
	move	$a0, $zero
.LBB15_11:                              # %_ZNK28btSortedOverlappingPairCache24needsBroadphaseCollisionEP17btBroadphaseProxyS1_.exit.thread
	...
	ret
.Lfunc_end15:
	.size	_ZN28btSortedOverlappingPairCache8findPairEP17btBroadphaseProxyS1_, .Lfunc_end15-_ZN28btSortedOverlappingPairCache8findPairEP17btBroadphaseProxyS1_
	.cfi_endproc
                                        # -- End function
...
.LBB16_5:                               # %._crit_edge
	...
	ret
.Lfunc_end16:
	.size	_ZN28btSortedOverlappingPairCache26processAllOverlappingPairsEP17btOverlapCallbackP12btDispatcher, .Lfunc_end16-_ZN28btSortedOverlappingPairCache26processAllOverlappingPairsEP17btOverlapCallbackP12btDispatcher
	.cfi_endproc
                                        # -- End function
...
.LBB17_3:                               # =>This Inner Loop Header: Depth=1
	...
	st.d	$a2, $a4, 24
	bne	$a1, $a0, .LBB17_3
.LBB17_4:                               # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB17_7
# %bb.5:                                # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i
	ld.b	$a1, $fp, 32
...
.Ltmp50:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp51:                                # EH_LABEL
.LBB17_11:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB17_12:
.Ltmp52:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Lfunc_end17:
	.size	_ZN28btSortedOverlappingPairCacheC2Ev, .Lfunc_end17-_ZN28btSortedOverlappingPairCacheC2Ev
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table17:
...
.Lcst_begin4:
	...
	.uleb128 .Lfunc_end17-.Ltmp51           #   Call between .Ltmp51 and .Lfunc_end17
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end4:
	.byte	1                               # >> Action Record 1 <<
...
# %bb.0:
	move	$a1, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV28btSortedOverlappingPairCache+16)
	addi.d	$a2, $a0, %pc_lo12(_ZTV28btSortedOverlappingPairCache+16)
	ld.d	$a0, $a1, 24
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB18_3
# %bb.1:
...
# %bb.2:
	pcaddu18i	$t8, %call36(_Z21btAlignedFreeInternalPv)
	jr	$t8
.LBB18_3:                               # %_ZN20btAlignedObjectArrayI16btBroadphasePairED2Ev.exit
	ret
.Lfunc_end18:
	.size	_ZN28btSortedOverlappingPairCacheD2Ev, .Lfunc_end18-_ZN28btSortedOverlappingPairCacheD2Ev
	.cfi_endproc
                                        # -- End function
...
.Ltmp53:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp54:                                # EH_LABEL
.LBB19_3:                               # %_ZN28btSortedOverlappingPairCacheD2Ev.exit
	move	$a0, $fp
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
...
.Ltmp55:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Lfunc_end19:
	.size	_ZN28btSortedOverlappingPairCacheD0Ev, .Lfunc_end19-_ZN28btSortedOverlappingPairCacheD0Ev
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table19:
...
.Lcst_begin5:
	...
	.uleb128 .Lfunc_end19-.Ltmp54           #   Call between .Ltmp54 and .Lfunc_end19
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end5:
	.p2align	2, 0x0
...
.LBB20_2:
	ret
.Lfunc_end20:
	.size	_ZN28btSortedOverlappingPairCache20cleanOverlappingPairER16btBroadphasePairP12btDispatcher, .Lfunc_end20-_ZN28btSortedOverlappingPairCache20cleanOverlappingPairER16btBroadphasePairP12btDispatcher
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end21:
	.size	_ZN28btSortedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcher, .Lfunc_end21-_ZN28btSortedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcher
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end22:
	.size	_ZN28btSortedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcher, .Lfunc_end22-_ZN28btSortedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcher
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	ret
.Lfunc_end23:
	.size	_ZN17btOverlapCallbackD2Ev, .Lfunc_end23-_ZN17btOverlapCallbackD2Ev
                                        # -- End function
	.text
...
# %bb.0:
	ret
.Lfunc_end24:
	.size	_ZN28btSortedOverlappingPairCache20sortOverlappingPairsEP12btDispatcher, .Lfunc_end24-_ZN28btSortedOverlappingPairCache20sortOverlappingPairsEP12btDispatcher
                                        # -- End function
...
.LBB25_4:
	...
	jr	$t8
.LBB25_5:                               # %_ZNK28btHashedOverlappingPairCache24needsBroadphaseCollisionEP17btBroadphaseProxyS1_.exit.thread
	move	$a0, $zero
	ld.d	$s1, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	...
	ret
.Lfunc_end25:
	.size	_ZN28btHashedOverlappingPairCache18addOverlappingPairEP17btBroadphaseProxyS1_, .Lfunc_end25-_ZN28btHashedOverlappingPairCache18addOverlappingPairEP17btBroadphaseProxyS1_
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end26:
	.size	_ZN28btHashedOverlappingPairCache26getOverlappingPairArrayPtrEv, .Lfunc_end26-_ZN28btHashedOverlappingPairCache26getOverlappingPairArrayPtrEv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end27:
	.size	_ZNK28btHashedOverlappingPairCache26getOverlappingPairArrayPtrEv, .Lfunc_end27-_ZNK28btHashedOverlappingPairCache26getOverlappingPairArrayPtrEv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end28:
	.size	_ZN28btHashedOverlappingPairCache23getOverlappingPairArrayEv, .Lfunc_end28-_ZN28btHashedOverlappingPairCache23getOverlappingPairArrayEv
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end29:
	.size	_ZNK28btHashedOverlappingPairCache22getNumOverlappingPairsEv, .Lfunc_end29-_ZNK28btHashedOverlappingPairCache22getNumOverlappingPairsEv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end30:
	.size	_ZN28btHashedOverlappingPairCache24setOverlapFilterCallbackEP23btOverlapFilterCallback, .Lfunc_end30-_ZN28btHashedOverlappingPairCache24setOverlapFilterCallbackEP23btOverlapFilterCallback
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end31:
	.size	_ZN28btHashedOverlappingPairCache18hasDeferredRemovalEv, .Lfunc_end31-_ZN28btHashedOverlappingPairCache18hasDeferredRemovalEv
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end32:
	.size	_ZN28btHashedOverlappingPairCache28setInternalGhostPairCallbackEP25btOverlappingPairCallback, .Lfunc_end32-_ZN28btHashedOverlappingPairCache28setInternalGhostPairCallbackEP25btOverlappingPairCallback
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end33:
	.size	_ZN28btSortedOverlappingPairCache26getOverlappingPairArrayPtrEv, .Lfunc_end33-_ZN28btSortedOverlappingPairCache26getOverlappingPairArrayPtrEv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end34:
	.size	_ZNK28btSortedOverlappingPairCache26getOverlappingPairArrayPtrEv, .Lfunc_end34-_ZNK28btSortedOverlappingPairCache26getOverlappingPairArrayPtrEv
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end35:
	.size	_ZN28btSortedOverlappingPairCache23getOverlappingPairArrayEv, .Lfunc_end35-_ZN28btSortedOverlappingPairCache23getOverlappingPairArrayEv
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end36:
	.size	_ZNK28btSortedOverlappingPairCache22getNumOverlappingPairsEv, .Lfunc_end36-_ZNK28btSortedOverlappingPairCache22getNumOverlappingPairsEv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end37:
	.size	_ZN28btSortedOverlappingPairCache24setOverlapFilterCallbackEP23btOverlapFilterCallback, .Lfunc_end37-_ZN28btSortedOverlappingPairCache24setOverlapFilterCallbackEP23btOverlapFilterCallback
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end38:
	.size	_ZN28btSortedOverlappingPairCache18hasDeferredRemovalEv, .Lfunc_end38-_ZN28btSortedOverlappingPairCache18hasDeferredRemovalEv
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end39:
	.size	_ZN28btSortedOverlappingPairCache28setInternalGhostPairCallbackEP25btOverlappingPairCallback, .Lfunc_end39-_ZN28btSortedOverlappingPairCache28setInternalGhostPairCallbackEP25btOverlappingPairCallback
                                        # -- End function
	.text
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end40:
	.size	_ZZN28btHashedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallbackD0Ev, .Lfunc_end40-_ZZN28btHashedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallbackD0Ev
	.cfi_endproc
                                        # -- End function
...
.LBB41_3:
	...
	ret
.Lfunc_end41:
	.size	_ZZN28btHashedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallback14processOverlapER16btBroadphasePair, .Lfunc_end41-_ZZN28btHashedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallback14processOverlapER16btBroadphasePair
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end42:
	.size	_ZZN28btHashedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherEN18RemovePairCallbackD0Ev, .Lfunc_end42-_ZZN28btHashedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherEN18RemovePairCallbackD0Ev
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end43:
	.size	_ZZN28btHashedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherEN18RemovePairCallback14processOverlapER16btBroadphasePair, .Lfunc_end43-_ZZN28btHashedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherEN18RemovePairCallback14processOverlapER16btBroadphasePair
                                        # -- End function
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end44:
	.size	_ZZN28btSortedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallbackD0Ev, .Lfunc_end44-_ZZN28btSortedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallbackD0Ev
	.cfi_endproc
                                        # -- End function
...
.LBB45_3:
	...
	ret
.Lfunc_end45:
	.size	_ZZN28btSortedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallback14processOverlapER16btBroadphasePair, .Lfunc_end45-_ZZN28btSortedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherEN17CleanPairCallback14processOverlapER16btBroadphasePair
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end46:
	.size	_ZZN28btSortedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherEN18RemovePairCallbackD0Ev, .Lfunc_end46-_ZZN28btSortedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherEN18RemovePairCallbackD0Ev
	.cfi_endproc
                                        # -- End function
...
.LBB48_4:                               #   Parent Loop BB48_2 Depth=1
	...
	b	.LBB48_6
	.p2align	4, , 16
.LBB48_5:                               # %_ZN29btBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit.thread
...
.LBB48_6:                               #   Parent Loop BB48_2 Depth=1
	...
	move	$t2, $s2
	beqz	$t0, .LBB48_8
# %bb.7:                                #   in Loop: Header=BB48_6 Depth=3
	ld.w	$t2, $t0, 24
.LBB48_8:                               #   in Loop: Header=BB48_6 Depth=3
	move	$t4, $s2
	beqz	$a0, .LBB48_10
# %bb.9:                                #   in Loop: Header=BB48_6 Depth=3
	ld.w	$t4, $a0, 24
.LBB48_10:                              #   in Loop: Header=BB48_6 Depth=3
	ld.d	$t1, $a5, -8
	move	$t3, $s2
	beqz	$t1, .LBB48_12
# %bb.11:                               #   in Loop: Header=BB48_6 Depth=3
	ld.w	$t3, $t1, 24
.LBB48_12:                              #   in Loop: Header=BB48_6 Depth=3
	move	$t5, $s2
	beqz	$a1, .LBB48_14
# %bb.13:                               #   in Loop: Header=BB48_6 Depth=3
	ld.w	$t5, $a1, 24
.LBB48_14:                              #   in Loop: Header=BB48_6 Depth=3
	blt	$t4, $t2, .LBB48_5
# %bb.15:                               #   in Loop: Header=BB48_6 Depth=3
	bne	$t0, $a0, .LBB48_19
# %bb.16:                               #   in Loop: Header=BB48_6 Depth=3
	blt	$t5, $t3, .LBB48_19
# %bb.17:                               #   in Loop: Header=BB48_6 Depth=3
	bne	$t1, $a1, .LBB48_21
# %bb.18:                               #   in Loop: Header=BB48_6 Depth=3
	ld.d	$t2, $a5, 0
	bltu	$a4, $t2, .LBB48_5
	b	.LBB48_21
	.p2align	4, , 16
.LBB48_19:                              # %_ZN29btBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit
                                        #   in Loop: Header=BB48_6 Depth=3
	bne	$t0, $a0, .LBB48_21
# %bb.20:                               # %_ZN29btBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit
	...
	blt	$t5, $t3, .LBB48_5
	.p2align	4, , 16
.LBB48_21:                              # %.critedge.preheader
                                        #   in Loop: Header=BB48_4 Depth=2
	slli.d	$t2, $a3, 5
	move	$t3, $a3
	b	.LBB48_23
	.p2align	4, , 16
.LBB48_22:                              # %_ZN29btBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit38.thread
...
# %bb.24:                               #   in Loop: Header=BB48_23 Depth=3
	ld.w	$t6, $a0, 24
.LBB48_25:                              #   in Loop: Header=BB48_23 Depth=3
	ldx.d	$t4, $a6, $t2
	move	$t8, $s2
	beqz	$t4, .LBB48_27
# %bb.26:                               #   in Loop: Header=BB48_23 Depth=3
	ld.w	$t8, $t4, 24
.LBB48_27:                              #   in Loop: Header=BB48_23 Depth=3
	move	$t7, $s2
	beqz	$a1, .LBB48_29
...
.LBB48_29:                              #   in Loop: Header=BB48_23 Depth=3
	...
	move	$s3, $s2
	beqz	$s4, .LBB48_31
# %bb.30:                               #   in Loop: Header=BB48_23 Depth=3
	ld.w	$s3, $s4, 24
.LBB48_31:                              #   in Loop: Header=BB48_23 Depth=3
	blt	$t8, $t6, .LBB48_22
# %bb.32:                               #   in Loop: Header=BB48_23 Depth=3
	bne	$a0, $t4, .LBB48_36
# %bb.33:                               #   in Loop: Header=BB48_23 Depth=3
	blt	$s3, $t7, .LBB48_36
# %bb.34:                               #   in Loop: Header=BB48_23 Depth=3
	bne	$a1, $s4, .LBB48_38
# %bb.35:                               #   in Loop: Header=BB48_23 Depth=3
	ld.d	$t4, $t5, 16
	bltu	$t4, $a4, .LBB48_22
	b	.LBB48_38
	.p2align	4, , 16
.LBB48_36:                              # %_ZN29btBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit38
                                        #   in Loop: Header=BB48_23 Depth=3
	bne	$a0, $t4, .LBB48_38
# %bb.37:                               # %_ZN29btBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit38
	...
	blt	$s3, $t7, .LBB48_22
	.p2align	4, , 16
.LBB48_38:                              # %_ZN29btBroadphasePairSortPredicateclERK16btBroadphasePairS2_.exit38.thread43
                                        #   in Loop: Header=BB48_4 Depth=2
	blt	$t3, $a7, .LBB48_3
# %bb.39:                               #   in Loop: Header=BB48_4 Depth=2
	xvld	$xr0, $t5, 0
	vld	$vr1, $a5, 0
	xvst	$xr0, $a5, -16
	ld.d	$a5, $s1, 16
...
.LBB48_42:
	...
	ret
.Lfunc_end48:
	.size	_ZN20btAlignedObjectArrayI16btBroadphasePairE17quickSortInternalI29btBroadphasePairSortPredicateEEvT_ii, .Lfunc_end48-_ZN20btAlignedObjectArrayI16btBroadphasePairE17quickSortInternalI29btBroadphasePairSortPredicateEEvT_ii
	.cfi_endproc
                                        # -- End function
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV28btHashedOverlappingPairCache
	.addrsig_sym _ZTV28btSortedOverlappingPairCache
	...
	.addrsig_sym _ZTVZN28btHashedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherE17CleanPairCallback
	...
	.addrsig_sym _ZTVZN28btHashedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherE18RemovePairCallback
	...
	.addrsig_sym _ZTVZN28btSortedOverlappingPairCache19cleanProxyFromPairsEP17btBroadphaseProxyP12btDispatcherE17CleanPairCallback
	...
	.addrsig_sym _ZTVZN28btSortedOverlappingPairCache37removeOverlappingPairsContainingProxyEP17btBroadphaseProxyP12btDispatcherE18RemovePairCallback
