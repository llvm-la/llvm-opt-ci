...
.Ltmp8:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp9:                                 # EH_LABEL
.LBB0_13:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
.Ltmp10:                                # EH_LABEL
	move	$a0, $fp
...
.Ltmp13:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp14:                                # EH_LABEL
.LBB4_3:                                # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
	move	$a0, $fp
...
.Ltmp19:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp20:                                # EH_LABEL
.LBB5_3:                                # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit.i
.Ltmp25:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN12btDispatcherD2Ev)
	jirl	$ra, $ra, 0
.Ltmp26:                                # EH_LABEL
# %bb.4:                                # %_ZN21btCollisionDispatcherD2Ev.exit
	move	$a0, $fp
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
...
.LBB6_13:                               # %scalar.ph
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB6_13
.LBB6_14:                               # %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.thread.i.i
	ld.bu	$a3, $fp, 40
	bnez	$a3, .LBB6_18
	b	.LBB6_19
.LBB6_15:
	...
	ld.d	$a1, $fp, 32
	bgtz	$a2, .LBB6_7
.LBB6_16:                               # %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i
	move	$a0, $s2
	beqz	$a1, .LBB6_19
...
.LBB6_18:
	...
	move	$a0, $s2
	ld.w	$a2, $fp, 20
.LBB6_19:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i
	ori	$a1, $zero, 1
	st.b	$a1, $fp, 40
	st.d	$s0, $fp, 32
	st.w	$s1, $fp, 24
.LBB6_20:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE9push_backERKS1_.exit
	ld.d	$a1, $fp, 32
	slli.d	$a3, $a2, 3
	stx.d	$a0, $a1, $a3
	addi.d	$a1, $a2, 1
...
# %bb.2:                                # %_ZN15btPoolAllocator10freeMemoryEPv.exit
	...
	addi.d	$sp, $sp, 32
	ret
.LBB8_3:                                # %_ZN15btPoolAllocator8validPtrEPv.exit
	move	$a0, $fp
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
...
# %bb.5:
	...
	move	$a1, $a2
	jr	$a3
.LBB11_6:                               # %_ZN17btCollisionObject16checkCollideWithEPS_.exit
	ret
.Lfunc_end11:
...
# %bb.0:
	ret
.Lfunc_end13:
	.size	_ZN17btOverlapCallbackD2Ev, .Lfunc_end13-_ZN17btOverlapCallbackD2Ev
                                        # -- End function
	.text
...
.LBB14_2:
	...
	jr	$t8
.Lfunc_end14:
	.size	_ZN21btCollisionDispatcher26allocateCollisionAlgorithmEi, .Lfunc_end14-_ZN21btCollisionDispatcher26allocateCollisionAlgorithmEi
	.cfi_endproc
                                        # -- End function
...
# %bb.3:                                # %_ZN15btPoolAllocator10freeMemoryEPv.exit
	...
	st.w	$a1, $a0, 8
	ret
.LBB15_4:                               # %_ZN15btPoolAllocator8validPtrEPv.exit
	move	$a0, $a1
	pcaddu18i	$t8, %call36(_Z21btAlignedFreeInternalPv)
	jr	$t8
.Lfunc_end15:
	.size	_ZN21btCollisionDispatcher22freeCollisionAlgorithmEPv, .Lfunc_end15-_ZN21btCollisionDispatcher22freeCollisionAlgorithmEPv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end16:
	.size	_ZNK21btCollisionDispatcher15getNumManifoldsEv, .Lfunc_end16-_ZNK21btCollisionDispatcher15getNumManifoldsEv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end17:
	.size	_ZN21btCollisionDispatcher26getManifoldByIndexInternalEi, .Lfunc_end17-_ZN21btCollisionDispatcher26getManifoldByIndexInternalEi
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end18:
	.size	_ZN21btCollisionDispatcher26getInternalManifoldPointerEv, .Lfunc_end18-_ZN21btCollisionDispatcher26getInternalManifoldPointerEv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end19:
	.size	_ZN23btCollisionPairCallbackD0Ev, .Lfunc_end19-_ZN23btCollisionPairCallbackD0Ev
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	ret
.Lfunc_end20:
	.size	_ZN23btCollisionPairCallback14processOverlapER16btBroadphasePair, .Lfunc_end20-_ZN23btCollisionPairCallback14processOverlapER16btBroadphasePair
	.cfi_endproc
                                        # -- End function
