...
# %bb.22:
	...
	fmadd.s	$ft2, $ft5, $ft0, $ft2
	fmul.s	$ft4, $ft3, $ft6
	fmadd.s	$ft4, $ft7, $ft1, $ft4
	fld.s	$ft5, $a0, 316
	fld.s	$ft6, $a0, 304
	fld.s	$ft7, $a0, 288
	fld.s	$ft8, $a0, 320
	fmadd.s	$ft4, $ft5, $ft0, $ft4
	fmul.s	$ft5, $ft3, $ft6
	fmadd.s	$ft5, $ft7, $ft1, $ft5
	fmadd.s	$ft5, $ft8, $ft0, $ft5
	fmul.s	$ft4, $ft3, $ft4
	fmadd.s	$ft2, $ft1, $ft2, $ft4
	fmadd.s	$ft4, $ft0, $ft5, $ft2
	fmul.s	$ft1, $ft1, $ft4
	fmul.s	$ft2, $ft3, $ft4
	fmul.s	$ft0, $ft0, $ft4
.LBB10_23:
	...
	fmadd.s	$ft5, $fa5, $fa5, $ft3
	fcmp.cule.s	$fcc0, $ft5, $fa6
	fmov.s	$ft3, $fa7
	fmov.s	$ft4, $fa7
	move	$a1, $s1
	bcnez	$fcc0, .LBB10_25
# %bb.24:
	...
	fld.s	$ft8, $a0, 300
	fld.s	$ft9, $a0, 284
	fmadd.s	$ft4, $ft6, $ft3, $ft4
	fmadd.s	$ft4, $ft7, $fa7, $ft4
	fmul.s	$ft6, $ft5, $ft8
	...
	fld.s	$ft9, $a0, 288
	fld.s	$ft10, $a0, 320
	fmadd.s	$ft6, $ft7, $fa7, $ft6
	fmul.s	$ft7, $ft5, $ft8
	fmadd.s	$ft7, $ft9, $ft3, $ft7
	fmadd.s	$ft7, $ft10, $fa7, $ft7
	fmul.s	$ft6, $ft5, $ft6
	fmadd.s	$ft4, $ft3, $ft4, $ft6
	fmadd.s	$ft4, $fa7, $ft7, $ft4
	fmul.s	$ft3, $ft3, $ft4
	fmul.s	$ft5, $ft5, $ft4
	fmul.s	$ft4, $fa7, $ft4
	fadd.s	$fa7, $ft1, $ft3
...
# %bb.27:
	...
	fadd.s	$fa2, $fa3, $ft0
	fmul.s	$ft2, $fa4, $fa4
	fmadd.s	$ft2, $fa5, $fa5, $ft2
	fmadd.s	$ft2, $fa2, $fa2, $ft2
	fsqrt.s	$ft2, $ft2
...
.LBB10_30:
	...
	fmul.s	$fa1, $fa3, $fa5
	fmul.s	$fa3, $ft2, $fa4
	fmadd.s	$fa3, $fa7, $fa0, $fa3
	fmadd.s	$fa3, $ft6, $fa1, $fa3
	fmul.s	$fa5, $ft1, $fa4
	fmadd.s	$fa5, $fa6, $fa0, $fa5
	fmadd.s	$fa5, $ft4, $fa1, $fa5
	fmul.s	$fa6, $fa4, $ft3
	fmadd.s	$fa6, $ft0, $fa0, $fa6
	fld.s	$fa7, $a1, 0
	fmadd.s	$fa6, $ft5, $fa1, $fa6
	fmul.s	$ft0, $fa2, $fs1
	fld.s	$ft1, $a1, 4
	fadd.s	$fa7, $ft0, $fa7
	fld.s	$ft2, $a1, 8
...
# %bb.0:
	...
	fneg.s	$fa4, $fs1
	fneg.s	$fa2, $fa1
	fmadd.s	$fa5, $fs1, $fa2, $fa0
	fmadd.s	$fa0, $fs2, $fa1, $fs1
	fneg.s	$fa3, $fs6
	fmadd.s	$fa6, $fs6, $fa2, $fa0
	fmul.s	$fa0, $fs6, $fa1
	...
	fmadd.s	$fa3, $fa5, $fs1, $fa3
	fmul.s	$ft0, $fs2, $ft0
	fmadd.s	$fa4, $ft1, $fa4, $ft0
	fmadd.s	$fa4, $fa5, $fa7, $fa4
	fmadd.s	$fa5, $fa6, $fs6, $fa4
	fmul.s	$fa4, $fa3, $fa1
	fadd.s	$fa4, $fa0, $fa4
	fmadd.s	$fa4, $fa5, $fa1, $fa4
	lu12i.w	$a0, -264193
...
.LBB19_4:                               # %_Z15shortestArcQuatRK9btVector3S1_.exit
	...
	fmul.s	$fa5, $fs6, $fs3
	fmul.s	$fa6, $fs2, $fa0
	fmadd.s	$fa3, $fs0, $fs1, $fa3
	fmadd.s	$fa4, $fs0, $fs6, $fa4
	fmadd.s	$fa5, $fs0, $fs2, $fa5
	fmadd.s	$fa6, $fs0, $fs5, $fa6
	fmadd.s	$fa2, $fa2, $fs5, $fa3
	fmadd.s	$fa0, $fa0, $fs1, $fa4
	fmadd.s	$fa3, $fs4, $fs5, $fa5
	fmadd.s	$fa1, $fa1, $fs6, $fa6
	fmadd.s	$fa2, $fs4, $fs6, $fa2
	fmadd.s	$fa4, $fa7, $fs5, $fa0
	fst.s	$fa7, $sp, 28                   # 4-byte Folded Spill
	fmadd.s	$fa3, $fa7, $fs1, $fa3
	fmadd.s	$fs7, $fs3, $fs1, $fa1
	fmul.s	$fa0, $fs7, $fs7
	fmadd.s	$fa0, $fa4, $fa4, $fa0
	fmadd.s	$fa0, $fa2, $fa2, $fa0
...
# %bb.5:                                # %_Z15shortestArcQuatRK9btVector3S1_.exit
	...
	bcnez	$fcc0, .LBB19_16
# %bb.6:
	fst.s	$fa4, $sp, 16                   # 4-byte Folded Spill
	fst.s	$fa3, $sp, 20                   # 4-byte Folded Spill
...
.LBB19_26:
	...
	fmadd.s	$fa3, $fs3, $fs2, $fa3
	fmadd.s	$fa0, $fs4, $fs7, $fa0
	fmadd.s	$fa3, $fa4, $fs6, $fa3
	fmadd.s	$fa0, $fa1, $fs2, $fa0
	fmul.s	$fa5, $fs3, $fa5
	fmul.s	$fa6, $fs4, $fs1
	fmadd.s	$fa5, $fs0, $fs1, $fa5
	fmadd.s	$fa6, $fs0, $fs2, $fa6
	fmadd.s	$fa4, $fa4, $fs2, $fa5
	fmadd.s	$fa5, $fa7, $fs6, $fa6
	fmadd.s	$fa1, $fa1, $fs7, $fa4
	fmadd.s	$fa2, $fa2, $fs7, $fa5
...
_ZN21btConeTwistConstraintC1ER11btRigidBodyRK11btTransform = _ZN21btConeTwistConstraintC2ER11btRigidBodyRK11btTransform
	...
	.addrsig_sym _ZTV21btConeTwistConstraint
