...
.Ltmp20:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp21:                                # EH_LABEL
.LBB5_3:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB5_6
# %bb.4:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit
	ld.b	$a1, $fp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB5_6
# %bb.5:
.Ltmp25:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp26:                                # EH_LABEL
.LBB5_6:                                # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit
	move	$a0, $fp
...
.Ltmp23:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp24:                                # EH_LABEL
.LBB5_11:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit10
.Ltmp28:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN13btConvexShapeD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp31:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp32:                                # EH_LABEL
.LBB6_3:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit.i
	ld.d	$a0, $fp, 120
	beqz	$a0, .LBB6_6
# %bb.4:                                # %_ZN20btAlignedObjectArrayIfED2Ev.exit.i
	ld.b	$a1, $fp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB6_6
# %bb.5:
.Ltmp36:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
.LBB6_6:                                # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit.i
.Ltmp42:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN13btConvexShapeD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
.LBB6_12:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit10.i
.Ltmp39:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN13btConvexShapeD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp45:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp46:                                # EH_LABEL
# %bb.16:                               # %_ZN13btConvexShapedlEPv.exit
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_17:
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV18btMultiSphereShape
