...
.LBB1_3:
	...
	addi.d	$s6, $a0, %pc_lo12(.L__const.load_mats.mats3)
	...
	addi.d	$s6, $a0, %pc_lo12(.L__const.load_mats.mats9)
	move	$a0, $s7
	move	$a1, $s6
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
...
.LBB2_11:                               # %.lr.ph.3
	...
	addi.d	$s0, $s0, 8
	blt	$s1, $a0, .LBB2_11
.LBB2_12:                               # %._crit_edge.3
	ld.w	$a0, $fp, 16
	ld.d	$s2, $sp, 24                    # 8-byte Folded Reload
	blez	$a0, .LBB2_15
# %bb.13:                               # %.lr.ph.4.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
.LBB2_14:                               # %.lr.ph.4
	...
	addi.d	$s8, $s8, 8
	blt	$s0, $a0, .LBB2_14
.LBB2_15:                               # %._crit_edge.4
	ld.w	$a0, $fp, 20
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
	blez	$a0, .LBB2_18
# %bb.16:                               # %.lr.ph.5.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
.LBB2_17:                               # %.lr.ph.5
	...
	addi.d	$s7, $s7, 8
	blt	$s0, $a0, .LBB2_17
.LBB2_18:                               # %._crit_edge.5
	ld.w	$a0, $fp, 24
	blez	$a0, .LBB2_21
# %bb.19:                               # %.lr.ph.6.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
.LBB2_20:                               # %.lr.ph.6
	...
	addi.d	$s6, $s6, 8
	blt	$s0, $a0, .LBB2_20
.LBB2_21:                               # %._crit_edge.6
	ld.w	$a0, $fp, 28
	blez	$a0, .LBB2_24
# %bb.22:                               # %.lr.ph.7.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
.LBB2_23:                               # %.lr.ph.7
	...
	addi.d	$s5, $s5, 8
	blt	$s0, $a0, .LBB2_23
.LBB2_24:                               # %._crit_edge.7
	ld.w	$a0, $fp, 32
	ld.d	$s5, $sp, 8                     # 8-byte Folded Reload
	blez	$a0, .LBB2_27
# %bb.25:                               # %.lr.ph.8.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
.LBB2_26:                               # %.lr.ph.8
	...
	addi.d	$s5, $s5, 8
	blt	$s0, $a0, .LBB2_26
.LBB2_27:                               # %._crit_edge.8
	ld.w	$a0, $fp, 36
	blez	$a0, .LBB2_30
# %bb.28:                               # %.lr.ph.9.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
.LBB2_29:                               # %.lr.ph.9
	...
	addi.d	$s3, $s3, 8
	blt	$s0, $a0, .LBB2_29
.LBB2_30:                               # %._crit_edge.9
	ld.w	$a0, $fp, 40
	blez	$a0, .LBB2_33
# %bb.31:                               # %.lr.ph.10.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
.LBB2_32:                               # %.lr.ph.10
	...
	addi.d	$s2, $s2, 8
	blt	$s0, $a0, .LBB2_32
.LBB2_33:                               # %._crit_edge.10
	ld.w	$a0, $fp, 44
	blez	$a0, .LBB2_36
# %bb.34:                               # %.lr.ph.11.preheader
	move	$s0, $zero
	lu52i.d	$a0, $s4, 1053
	movgr2fr.d	$fs0, $a0
	.p2align	4, , 16
