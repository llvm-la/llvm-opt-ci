...
# %bb.34:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_13
.LBB0_35:                               # %.split.split.us
	fcmp.cor.d	$fcc0, $fs0, $fs0
	bcnez	$fcc0, .LBB0_5
# %bb.36:                               # %.split.split.us.split.us.preheader
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs4
	pcaddu18i	$ra, %call36(cexp)
	jirl	$ra, $ra, 0
