...
.LBB2_3:
	...
	addi.d	$s5, $a0, %pc_lo12(.L__const.load_mats.mats3)
	...
	addi.d	$s5, $a0, %pc_lo12(.L__const.load_mats.mats9)
	move	$a0, $s7
	move	$a1, $s5
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
