...
# %bb.33:                               # %iter.check71
	...
	ld.d	$a2, $a2, 120
	bltu	$a1, $s6, .LBB0_36
# %bb.34:                               # %vector.memcheck47
                                        #   in Loop: Header=BB0_32 Depth=1
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB0_39
# %bb.35:                               # %vector.memcheck47
                                        #   in Loop: Header=BB0_32 Depth=1
	addi.d	$a3, $a0, 4
	bgeu	$a2, $a3, .LBB0_39
.LBB0_36:                               #   in Loop: Header=BB0_32 Depth=1
	move	$a3, $zero
	move	$a4, $zero
.LBB0_37:                               # %vec.epilog.scalar.ph72.preheader
                                        #   in Loop: Header=BB0_32 Depth=1
	sub.d	$a1, $a1, $a3
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB0_38:                               # %vec.epilog.scalar.ph72
	...
	bnez	$a1, .LBB0_38
	b	.LBB0_31
.LBB0_39:                               # %vector.main.loop.iter.check54
                                        #   in Loop: Header=BB0_32 Depth=1
	bgeu	$a1, $s7, .LBB0_41
...
# %bb.43:                               # %middle.block66
	...
	st.w	$a4, $a0, 0
	beq	$a3, $a1, .LBB0_31
# %bb.44:                               # %vec.epilog.iter.check73
                                        #   in Loop: Header=BB0_32 Depth=1
	beqz	$a5, .LBB0_37
.LBB0_45:                               # %vec.epilog.ph75
                                        #   in Loop: Header=BB0_32 Depth=1
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_46:                               # %vec.epilog.vector.body78
                                        #   Parent Loop BB0_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $a5, 0
	vadd.w	$vr0, $vr1, $vr0
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_46
# %bb.47:                               # %vec.epilog.middle.block83
                                        #   in Loop: Header=BB0_32 Depth=1
...
# %bb.49:                               # %iter.check111
	...
	ori	$a3, $zero, 4
	bltu	$a1, $a3, .LBB0_52
# %bb.50:                               # %vector.memcheck87
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB0_64
# %bb.51:                               # %vector.memcheck87
	addi.d	$a3, $a0, 4
	bgeu	$a2, $a3, .LBB0_64
.LBB0_52:
	move	$a3, $zero
	move	$a4, $zero
.LBB0_53:                               # %vec.epilog.scalar.ph112.preheader
	sub.d	$a1, $a1, $a3
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB0_54:                               # %vec.epilog.scalar.ph112
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	add.d	$a4, $a3, $a4
	st.w	$a4, $a0, 0
...
# %bb.63:
	...
	move	$a4, $zero
	b	.LBB0_70
.LBB0_64:                               # %vector.main.loop.iter.check94
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_73
# %bb.65:
	move	$a3, $zero
...
# %bb.75:                               # %middle.block106
	...
	st.w	$a4, $a0, 0
	beq	$a3, $a1, .LBB0_55
# %bb.76:                               # %vec.epilog.iter.check113
	beqz	$a5, .LBB0_53
.LBB0_77:                               # %vec.epilog.ph115
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_78:                               # %vec.epilog.vector.body118
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vadd.w	$vr1, $vr0, $vr1
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_78
# %bb.79:                               # %vec.epilog.middle.block123
