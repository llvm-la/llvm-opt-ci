...
# %bb.9:                                # %._crit_edge.us.us.us.i
	...
	addi.w	$s6, $s6, 1
	bne	$s6, $s8, .LBB0_7
# %bb.10:                               # %._crit_edge48.split.us.us.us.i
...
.Lfunc_end0:
	.size	initAtomHaloExchange, .Lfunc_end0-initAtomHaloExchange
                                        # -- End function
	.p2align	2                               # -- Begin function loadAtomsBuffer
...
.Lfunc_end1:
	.size	loadAtomsBuffer, .Lfunc_end1-loadAtomsBuffer
                                        # -- End function
	.p2align	2                               # -- Begin function unloadAtomsBuffer
...
.Lfunc_end2:
	.size	unloadAtomsBuffer, .Lfunc_end2-unloadAtomsBuffer
                                        # -- End function
	.p2align	2                               # -- Begin function destroyAtomsExchange
...
.LBB4_11:                               #   in Loop: Header=BB4_2 Depth=1
	...
	move	$s6, $s0
	bge	$s6, $s3, .LBB4_18
.LBB4_12:                               # %.preheader50.lr.ph.i
                                        #   in Loop: Header=BB4_2 Depth=1
	bge	$s0, $s1, .LBB4_18
# %bb.13:                               # %.preheader50.us.us.i.preheader
                                        #   in Loop: Header=BB4_2 Depth=1
	move	$s2, $zero
	st.d	$s6, $sp, 88                    # 8-byte Folded Spill
	.p2align	4, , 16
.LBB4_14:                               # %.preheader.us.us.us.i
...
.LBB4_15:                               #   Parent Loop BB4_2 Depth=1
	...
	addi.d	$s8, $s8, 4
	bne	$s1, $s7, .LBB4_15
# %bb.16:                               # %._crit_edge.us.us.us.i
                                        #   in Loop: Header=BB4_14 Depth=2
	addi.w	$s6, $s6, 1
	bne	$s6, $s3, .LBB4_14
# %bb.17:                               # %._crit_edge55.split.us.us.us.i
                                        #   in Loop: Header=BB4_14 Depth=2
	addi.w	$s5, $s5, 1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 88                    # 8-byte Folded Reload
	bne	$s5, $a0, .LBB4_14
.LBB4_18:                               # %mkForceSendCellList.exit
                                        #   in Loop: Header=BB4_2 Depth=1
	...
	bltu	$a2, $a3, .LBB4_26
# %bb.19:                               # %mkForceSendCellList.exit
                                        #   in Loop: Header=BB4_2 Depth=1
	ld.w	$s4, $fp, 0
	slli.d	$a2, $a3, 2
...
.LBB4_26:                               #   in Loop: Header=BB4_2 Depth=1
	...
	move	$s0, $a1
	bge	$s5, $s2, .LBB4_1
.LBB4_27:                               # %.preheader50.lr.ph.i56
                                        #   in Loop: Header=BB4_2 Depth=1
	bge	$s0, $s1, .LBB4_1
# %bb.28:                               # %.preheader50.us.us.i64.preheader
                                        #   in Loop: Header=BB4_2 Depth=1
	move	$s8, $zero
	st.d	$s5, $sp, 88                    # 8-byte Folded Spill
	.p2align	4, , 16
.LBB4_29:                               # %.preheader.us.us.us.i67
                                        #   Parent Loop BB4_2 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_30 Depth 3
	alsl.d	$s7, $s8, $s3, 2
...
.LBB4_30:                               #   Parent Loop BB4_2 Depth=1
	...
	addi.d	$s7, $s7, 4
	bne	$s1, $s6, .LBB4_30
# %bb.31:                               # %._crit_edge.us.us.us.i75
                                        #   in Loop: Header=BB4_29 Depth=2
	addi.w	$s5, $s5, 1
	bne	$s5, $s2, .LBB4_29
# %bb.32:                               # %._crit_edge55.split.us.us.us.i77
                                        #   in Loop: Header=BB4_29 Depth=2
	addi.w	$s4, $s4, 1
...
.LJTI4_0:
	...
	.word	.LBB4_5-.LJTI4_0
.LJTI4_1:
	.word	.LBB4_20-.LJTI4_1
	.word	.LBB4_23-.LJTI4_1
	.word	.LBB4_22-.LJTI4_1
	.word	.LBB4_25-.LJTI4_1
	.word	.LBB4_21-.LJTI4_1
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function loadForceBuffer
...
.Lfunc_end5:
	.size	loadForceBuffer, .Lfunc_end5-loadForceBuffer
                                        # -- End function
	.p2align	2                               # -- Begin function unloadForceBuffer
...
.LBB6_10:                               # %scalar.ph
	...
	blt	$t2, $t3, .LBB6_10
	b	.LBB6_2
.LBB6_11:                               # %._crit_edge31
	ret
.Lfunc_end6:
	.size	unloadForceBuffer, .Lfunc_end6-unloadForceBuffer
                                        # -- End function
	.p2align	2                               # -- Begin function destroyForceExchange
...
.Lfunc_end10:
	.size	sortAtomsInCell, .Lfunc_end10-sortAtomsInCell
                                        # -- End function
	.p2align	2                               # -- Begin function sortAtomsById
