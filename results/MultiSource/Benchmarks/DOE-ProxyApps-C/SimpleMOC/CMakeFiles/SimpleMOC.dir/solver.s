...
# %bb.68:                               # %middle.block702
	beq	$a1, $t7, .LBB0_75
# %bb.69:                               # %vec.epilog.iter.check706
	beqz	$a2, .LBB0_73
.LBB0_70:                               # %vec.epilog.ph708
	...
	alsl.d	$t1, $t1, $s0, 2
	.p2align	4, , 16
.LBB0_71:                               # %vec.epilog.vector.body713
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr3, $t1, 0
	vfmul.s	$vr3, $vr0, $vr3
	vst	$vr3, $a5, 0
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_71
# %bb.72:                               # %vec.epilog.middle.block717
	beq	$a1, $t7, .LBB0_75
...
.LBB0_74:                               # %.lr.ph351
	...
	addi.d	$a5, $a5, 4
	bnez	$a1, .LBB0_74
.LBB0_75:                               # %iter.check729
	ori	$a1, $zero, 4
	bltu	$a7, $a1, .LBB0_78
# %bb.76:                               # %vector.memcheck720
	alsl.d	$a1, $t7, $fp, 2
	bgeu	$s4, $a1, .LBB0_127
# %bb.77:                               # %vector.memcheck720
	alsl.d	$a1, $t7, $s4, 2
	bgeu	$fp, $a1, .LBB0_127
.LBB0_78:
	move	$a1, $zero
...
.LBB0_101:                              # %._crit_edge364
	...
	addi.d	$sp, $sp, 128
	ret
.LBB0_102:                              # %vector.memcheck759
	sub.d	$a5, $a3, $t6
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_83
# %bb.103:                              # %vector.memcheck759
	sub.d	$a5, $a3, $t0
	bltu	$a5, $a2, .LBB0_83
# %bb.104:                              # %vector.memcheck759
	sub.d	$a2, $a3, $t8
	ori	$a5, $zero, 64
	bltu	$a2, $a5, .LBB0_83
# %bb.105:                              # %vector.main.loop.iter.check770
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_181
# %bb.106:
	move	$a1, $zero
	b	.LBB0_185
.LBB0_107:                              # %vector.memcheck801
	sub.d	$a5, $a4, $t3
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_87
# %bb.108:                              # %vector.memcheck801
	sub.d	$a5, $a4, $t4
	bltu	$a5, $a2, .LBB0_87
# %bb.109:                              # %vector.memcheck801
	sub.d	$a5, $a4, $t0
	ori	$a2, $zero, 64
	bltu	$a5, $a2, .LBB0_87
# %bb.110:                              # %vector.memcheck801
	sub.d	$a5, $a4, $t5
	bltu	$a5, $a2, .LBB0_87
# %bb.111:                              # %vector.main.loop.iter.check814
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_209
# %bb.112:
	move	$a1, $zero
	b	.LBB0_213
.LBB0_113:                              # %vector.memcheck852
	sub.d	$a5, $s2, $a6
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_91
# %bb.114:                              # %vector.memcheck852
	sub.d	$a5, $s2, $t2
	bltu	$a5, $a2, .LBB0_91
# %bb.115:                              # %vector.main.loop.iter.check861
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_188
# %bb.116:
	move	$a1, $zero
	b	.LBB0_192
.LBB0_117:                              # %vector.memcheck893
	sub.d	$a5, $s3, $a0
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_95
# %bb.118:                              # %vector.memcheck893
	sub.d	$a5, $s3, $t0
	bltu	$a5, $a2, .LBB0_95
# %bb.119:                              # %vector.main.loop.iter.check902
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_195
# %bb.120:
	move	$a1, $zero
	b	.LBB0_199
.LBB0_121:                              # %vector.memcheck930
	sub.d	$a5, $a0, $a3
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_99
# %bb.122:                              # %vector.memcheck930
	sub.d	$a5, $a0, $a4
	bltu	$a5, $a2, .LBB0_99
# %bb.123:                              # %vector.memcheck930
	sub.d	$a5, $a0, $s2
	ori	$a2, $zero, 64
	bltu	$a5, $a2, .LBB0_99
# %bb.124:                              # %vector.memcheck930
	sub.d	$a5, $a0, $s3
	bltu	$a5, $a2, .LBB0_99
# %bb.125:                              # %vector.main.loop.iter.check943
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_216
# %bb.126:
	move	$a1, $zero
	b	.LBB0_220
.LBB0_127:                              # %vector.main.loop.iter.check731
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_174
# %bb.128:
	move	$a1, $zero
...
.LBB0_175:                              # %vector.body735
	...
	addi.d	$t1, $t1, 64
	bnez	$s0, .LBB0_175
# %bb.176:                              # %middle.block742
	beq	$a1, $t7, .LBB0_81
# %bb.177:                              # %vec.epilog.iter.check746
	beqz	$a2, .LBB0_79
.LBB0_178:                              # %vec.epilog.ph748
	move	$t1, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	sub.d	$a2, $t1, $a1
	...
	alsl.d	$t1, $t1, $fp, 2
	.p2align	4, , 16
.LBB0_179:                              # %vec.epilog.vector.body751
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t1, 0
	vld	$vr3, $a5, 0
	vfadd.s	$vr0, $vr0, $vr3
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_179
# %bb.180:                              # %vec.epilog.middle.block756
	beq	$a1, $t7, .LBB0_81
	b	.LBB0_79
.LBB0_181:                              # %vector.ph771
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	addi.d	$a5, $a3, 32
...
.LBB0_182:                              # %vector.body774
	...
	addi.d	$s0, $s0, 64
	bnez	$s1, .LBB0_182
# %bb.183:                              # %middle.block783
	beq	$a1, $t7, .LBB0_85
# %bb.184:                              # %vec.epilog.iter.check787
	beqz	$a2, .LBB0_83
.LBB0_185:                              # %vec.epilog.ph789
	...
	alsl.d	$s0, $s0, $t6, 2
	.p2align	4, , 16
.LBB0_186:                              # %vec.epilog.vector.body792
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $s0, 0
	vld	$vr3, $fp, 0
	vld	$vr4, $t1, 0
	...
	addi.d	$s0, $s0, 16
	bnez	$a2, .LBB0_186
# %bb.187:                              # %vec.epilog.middle.block798
	bne	$a1, $t7, .LBB0_83
	b	.LBB0_85
.LBB0_188:                              # %vector.ph862
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	xvreplve0.w	$xr0, $xr2
...
.LBB0_189:                              # %vector.body867
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB0_189
# %bb.190:                              # %middle.block874
	beq	$a1, $t7, .LBB0_93
# %bb.191:                              # %vec.epilog.iter.check878
	beqz	$a2, .LBB0_91
.LBB0_192:                              # %vec.epilog.ph880
	move	$t3, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	...
	alsl.d	$t3, $t3, $a6, 2
	.p2align	4, , 16
.LBB0_193:                              # %vec.epilog.vector.body885
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t3, 0
	vld	$vr3, $t1, 0
	vfmul.s	$vr1, $vr0, $vr1
	...
	addi.d	$t3, $t3, 16
	bnez	$a2, .LBB0_193
# %bb.194:                              # %vec.epilog.middle.block890
	bne	$a1, $t7, .LBB0_91
	b	.LBB0_93
.LBB0_195:                              # %vector.ph903
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	addi.d	$a5, $s3, 32
...
.LBB0_196:                              # %vector.body906
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB0_196
# %bb.197:                              # %middle.block913
	beq	$a1, $t7, .LBB0_97
# %bb.198:                              # %vec.epilog.iter.check917
	beqz	$a2, .LBB0_95
.LBB0_199:                              # %vec.epilog.ph919
	move	$t1, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	sub.d	$a2, $t1, $a1
	...
	vldi	$vr0, -1424
	.p2align	4, , 16
.LBB0_200:                              # %vec.epilog.vector.body922
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vld	$vr2, $t1, 0
	vfsub.s	$vr1, $vr0, $vr1
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_200
# %bb.201:                              # %vec.epilog.middle.block927
	bne	$a1, $t7, .LBB0_95
	b	.LBB0_97
...
.LBB0_210:                              # %vector.body820
	...
	addi.d	$fp, $fp, 64
	bnez	$s0, .LBB0_210
# %bb.211:                              # %middle.block831
	beq	$a1, $t7, .LBB0_89
# %bb.212:                              # %vec.epilog.iter.check835
	beqz	$a2, .LBB0_87
.LBB0_213:                              # %vec.epilog.ph837
	move	$fp, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	...
	alsl.d	$fp, $fp, $t3, 2
	.p2align	4, , 16
.LBB0_214:                              # %vec.epilog.vector.body842
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr3, $t8, 0
	vld	$vr4, $t6, 0
	vld	$vr5, $fp, 0
	...
	addi.d	$fp, $fp, 16
	bnez	$a2, .LBB0_214
# %bb.215:                              # %vec.epilog.middle.block849
	bne	$a1, $t7, .LBB0_87
	b	.LBB0_89
.LBB0_216:                              # %vector.ph944
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	addi.d	$a5, $a3, 32
...
.LBB0_217:                              # %vector.body947
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB0_217
# %bb.218:                              # %middle.block958
	beq	$a1, $t7, .LBB0_101
# %bb.219:                              # %vec.epilog.iter.check962
	beqz	$a2, .LBB0_99
.LBB0_220:                              # %vec.epilog.ph964
	move	$t1, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	sub.d	$a2, $t1, $a1
	...
	alsl.d	$t1, $t1, $a3, 2
	.p2align	4, , 16
.LBB0_221:                              # %vec.epilog.vector.body967
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t1, 0
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_221
# %bb.222:                              # %vec.epilog.middle.block974
	bne	$a1, $t7, .LBB0_99
	b	.LBB0_101
.Lfunc_end0:
