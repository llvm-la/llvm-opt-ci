...
.LBB0_38:                               # %scalar.ph
	...
	fldx.d	$ft11, $s2, $a6
	fld.d	$ft12, $t0, 8
                                        # kill: def $f10_64 killed $f10_64 killed $vr10
	fadd.d	$ft10, $ft10, $ft11
	fadd.d	$ft10, $ft10, $ft12
	fadd.d	$ft10, $ft10, $ft2
	fmov.d	$ft2, $ft1
                                        # kill: def $f16_64 killed $f16_64 killed $vr16
	...
	fld.d	$ft13, $t0, 8
	fadd.d	$ft10, $ft10, $ft1
	fadd.d	$ft10, $ft10, $ft8
	fmov.d	$ft8, $ft9
                                        # kill: def $f11_64 killed $f11_64 killed $vr11
	...
	fadd.d	$ft9, $ft9, $ft3
	fmov.d	$ft3, $ft0
                                        # kill: def $f15_64 killed $f15_64 killed $vr15
                                        # kill: def $f7_64 killed $f7_64 killed $vr7
	fldx.d	$ft0, $s3, $a6
	...
	fadd.d	$ft12, $ft9, $ft7
	fmov.d	$ft7, $ft6
                                        # kill: def $f13_64 killed $f13_64 killed $vr13
	fldx.d	$ft9, $s1, $a6
	fadd.d	$ft6, $ft11, $fa7
	fadd.d	$ft6, $ft6, $fa6
	fadd.d	$ft11, $ft6, $ft5
	...
	fadd.d	$ft11, $ft11, $ft5
	fadd.d	$ft11, $ft11, $ft4
	fadd.d	$ft10, $ft10, $ft12
	fadd.d	$ft10, $ft10, $ft11
...
# %bb.48:                               # %vector.ph
	...
	vextrins.d	$vr17, $vr8, 16
	vextrins.d	$vr21, $vr11, 16
	vextrins.d	$vr16, $vr1, 16
	vextrins.d	$vr22, $vr0, 16
	vextrins.d	$vr18, $vr9, 16
...
.LBB0_49:                               # %vector.body
	...
	vpackod.d	$vr14, $vr8, $vr23
	vshuf4i.d	$vr8, $vr18, 9
...
# %bb.51:                               #   in Loop: Header=BB0_35 Depth=3
	...
	vreplvei.d	$vr9, $vr18, 1
	vreplvei.d	$vr10, $vr18, 0
