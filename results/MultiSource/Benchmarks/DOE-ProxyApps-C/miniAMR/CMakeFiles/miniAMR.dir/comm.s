...
# %bb.2:
	...
	ld.w	$s3, $a0, %pc_lo12(x_block_size)
	addi.w	$a0, $s3, 1
	beqz	$a7, .LBB2_15
# %bb.3:
...
# %bb.19:                               # %.lr.ph1169.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_25
# %bb.20:                               # %vector.memcheck1548
                                        #   in Loop: Header=BB2_18 Depth=1
	addi.d	$a2, $t5, 8
	ld.d	$a4, $sp, 32                    # 8-byte Folded Reload
	add.d	$a4, $t4, $a4
	bgeu	$a2, $a4, .LBB2_22
# %bb.21:                               # %vector.memcheck1548
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	add.d	$a2, $t5, $a2
	add.d	$a4, $t4, $s0
	addi.d	$a4, $a4, 8
	bltu	$a4, $a2, .LBB2_25
.LBB2_22:                               # %vector.body1561.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
...
.LBB2_23:                               # %vector.body1561
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_23
# %bb.24:                               # %middle.block1567
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	beq	$t2, $a2, .LBB2_27
	.p2align	4, , 16
.LBB2_25:                               # %.lr.ph1169.preheader1573
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $t4, $s0
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t5, 4
...
.LBB2_31:                               # %.lr.ph1174
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_37
# %bb.32:                               # %vector.memcheck1527
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$t6, $t5, $s4
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	add.d	$a2, $t4, $a2
	bgeu	$t6, $a2, .LBB2_34
# %bb.33:                               # %vector.memcheck1527
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t5, $a2
	addi.d	$a4, $t4, 8
	bltu	$a4, $a2, .LBB2_37
.LBB2_34:                               # %vector.body1540.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	ld.d	$t7, $sp, 40                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_35:                               # %vector.body1540
                                        #   Parent Loop BB2_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr3, $xr2, 4
	...
	addi.d	$t6, $t6, 32
	bnez	$t7, .LBB2_35
# %bb.36:                               # %middle.block1545
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	beq	$t2, $a2, .LBB2_39
	.p2align	4, , 16
.LBB2_37:                               # %scalar.ph1535.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $t5, $s0
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t4, 4
...
# %bb.49:                               # %vector.memcheck1505
	...
	add.d	$t5, $t4, $s4
	bgeu	$a2, $a4, .LBB2_51
# %bb.50:                               # %vector.memcheck1505
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	add.d	$a2, $a6, $a2
	bltu	$t5, $a2, .LBB2_54
.LBB2_51:                               # %vector.body1518.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_52:                               # %vector.body1518
                                        #   Parent Loop BB2_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr3, $t5, 0
	xvfmul.d	$xr3, $xr3, $xr1
	...
	addi.d	$t5, $t5, 32
	bnez	$a1, .LBB2_52
# %bb.53:                               # %middle.block1524
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	beq	$t2, $a2, .LBB2_56
	.p2align	4, , 16
.LBB2_54:                               # %.lr.ph1188.preheader1572
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $t4, $s0
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $a6, 4
...
# %bb.61:                               # %vector.memcheck1484
	...
	add.d	$a4, $a6, $a4
	bgeu	$a2, $a4, .LBB2_63
# %bb.62:                               # %vector.memcheck1484
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $a0, $a2
	addi.d	$a4, $a6, 8
	bltu	$a4, $a2, .LBB2_66
.LBB2_63:                               # %vector.body1497.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	add.d	$t3, $a0, $s4
...
.LBB2_64:                               # %vector.body1497
	...
	addi.d	$t3, $t3, 32
	bnez	$t4, .LBB2_64
# %bb.65:                               # %middle.block1502
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	beq	$t2, $a2, .LBB2_17
	.p2align	4, , 16
.LBB2_66:                               # %scalar.ph1492.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a0, $a0, $s0
	alsl.d	$a0, $a1, $a0, 3
	alsl.d	$a2, $a1, $a6, 4
...
# %bb.86:                               # %.lr.ph1138.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_92
# %bb.87:                               # %vector.memcheck1462
                                        #   in Loop: Header=BB2_85 Depth=1
	addi.d	$a2, $t6, 8
	ld.d	$a4, $sp, 32                    # 8-byte Folded Reload
	add.d	$a4, $a6, $a4
	bgeu	$a2, $a4, .LBB2_89
# %bb.88:                               # %vector.memcheck1462
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	add.d	$a2, $t6, $a2
	add.d	$a4, $a6, $s2
	addi.d	$a4, $a4, 8
	bltu	$a4, $a2, .LBB2_92
.LBB2_89:                               # %vector.body1475.preheader
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	add.d	$a1, $a6, $s6
...
.LBB2_90:                               # %vector.body1475
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_90
# %bb.91:                               # %middle.block1481
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	beq	$s0, $a2, .LBB2_94
	.p2align	4, , 16
.LBB2_92:                               # %.lr.ph1138.preheader1576
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$a2, $a6, $s2
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t6, 4
...
.LBB2_98:                               # %.lr.ph1143
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_104
# %bb.99:                               # %vector.memcheck1441
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$t7, $t6, $s6
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	add.d	$a2, $t5, $a2
	bgeu	$t7, $a2, .LBB2_101
# %bb.100:                              # %vector.memcheck1441
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t6, $a2
	addi.d	$a4, $t5, 8
	bltu	$a4, $a2, .LBB2_104
.LBB2_101:                              # %vector.body1454.preheader
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	ld.d	$t8, $sp, 40                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_102:                              # %vector.body1454
                                        #   Parent Loop BB2_85 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr3, $xr2, 4
	xvpickve2gr.d	$a1, $xr3, 0
	...
	addi.d	$t7, $t7, 32
	bnez	$t8, .LBB2_102
# %bb.103:                              # %middle.block1459
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	beq	$s0, $a2, .LBB2_106
	.p2align	4, , 16
.LBB2_104:                              # %scalar.ph1449.preheader
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$a2, $t6, $s2
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t5, 4
...
.LBB2_119:                              # %vector.body1433
	...
	addi.d	$t6, $t6, 32
	bnez	$a1, .LBB2_119
# %bb.120:                              # %middle.block1438
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	beq	$s0, $a2, .LBB2_123
	.p2align	4, , 16
.LBB2_121:                              # %.lr.ph1157.preheader1575
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$a2, $t5, $s2
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $a7, 4
