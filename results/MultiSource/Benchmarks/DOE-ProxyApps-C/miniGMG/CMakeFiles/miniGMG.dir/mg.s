...
# %bb.72:                               #   in Loop: Header=BB4_29 Depth=3
	ld.w	$t1, $s4, 1580
	bge	$t0, $t1, .LBB4_74
.LBB4_73:                               # %._crit_edge.i.us.us.us.1913
                                        #   in Loop: Header=BB4_29 Depth=3
	ld.w	$t0, $s4, 1548
	...
	mul.d	$a4, $a4, $t0
	add.d	$s8, $a4, $t1
.LBB4_74:                               # %calculate_neighboring_subdomain_rank.exit.us.us.us.1915
                                        #   in Loop: Header=BB4_29 Depth=3
	st.w	$s8, $t5, -36
	st.w	$s6, $t5, -32
	ld.d	$s8, $sp, 472                   # 8-byte Folded Reload
...
# %bb.75:                               #   in Loop: Header=BB4_29 Depth=3
	...
	b	.LBB4_87
	.p2align	4, , 16
.LBB4_76:                               # %calculate_neighboring_subdomain_rank.exit.us.us.us.1915.thread
                                        #   in Loop: Header=BB4_29 Depth=3
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	st.w	$a4, $t5, -36
...
# %bb.106:                              #   in Loop: Header=BB4_29 Depth=3
	ld.w	$a4, $s4, 1580
	bge	$t0, $a4, .LBB4_108
.LBB4_107:                              # %._crit_edge.i.us.us.us.2935
                                        #   in Loop: Header=BB4_29 Depth=3
	ld.w	$a4, $s4, 1548
	...
	mul.d	$a4, $t1, $a4
	add.d	$s6, $a4, $t0
.LBB4_108:                              # %calculate_neighboring_subdomain_rank.exit.us.us.us.2938
                                        #   in Loop: Header=BB4_29 Depth=3
	st.w	$s6, $t5, -12
	st.w	$s5, $t5, -8
	beqz	$a1, .LBB4_112
# %bb.109:                              #   in Loop: Header=BB4_29 Depth=3
	...
	b	.LBB4_123
	.p2align	4, , 16
.LBB4_110:                              # %calculate_neighboring_subdomain_rank.exit.us.us.us.2938.thread
                                        #   in Loop: Header=BB4_29 Depth=3
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	st.w	$a4, $t5, -12
...
# %bb.137:                              # %.preheader627.lr.ph
	...
	b	.LBB4_139
	.p2align	4, , 16
.LBB4_138:                              # %.split810.us.sink.split
...
.LBB4_139:                              # %.preheader627
                                        ...
                                        #           Child Loop BB4_153 Depth 5
	addi.d	$a0, $s4, 1432
	alsl.d	$s5, $s1, $a0, 3
	ld.d	$a0, $sp, 280                   # 8-byte Folded Reload
	bnez	$a0, .LBB4_138
# %bb.140:                              # %.split777.us.us.us.preheader
                                        #   in Loop: Header=BB4_139 Depth=1
	move	$a1, $zero
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 288                   # 8-byte Folded Spill
	...
	bgtz	$a0, .LBB4_144
	.p2align	4, , 16
.LBB4_141:                              #   in Loop: Header=BB4_139 Depth=1
	move	$a0, $zero
.LBB4_142:                              # %.split787.us.us.split.us.us
                                        #   in Loop: Header=BB4_139 Depth=1
	st.w	$a0, $s4, 1524
	st.w	$a0, $s4, 1528
	...
	st.w	$a0, $s4, 1532
	beqz	$a1, .LBB4_184
# %bb.143:                              #   in Loop: Header=BB4_139 Depth=1
	ori	$a1, $zero, 88
	mul.d	$a0, $a0, $a1
	...
	ld.d	$a0, $sp, 384                   # 8-byte Folded Reload
	blez	$a0, .LBB4_141
.LBB4_144:                              # %.split777.us.us.split.us.us.split.us
                                        #   in Loop: Header=BB4_139 Depth=1
	ld.w	$a2, $s4, 1584
	ld.w	$a3, $s4, 1596
	move	$a4, $zero
	...
	b	.LBB4_146
	.p2align	4, , 16
.LBB4_145:                              # %._crit_edge731.split.us.split.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_146 Depth=2
	ld.d	$a4, $sp, 328                   # 8-byte Folded Reload
	addi.d	$a4, $a4, 1
	ori	$a1, $zero, 26
	beq	$a4, $a1, .LBB4_142
.LBB4_146:                              # %.preheader626.lr.ph.us.us.us.us.us
	...
	b	.LBB4_148
	.p2align	4, , 16
.LBB4_147:                              # %._crit_edge699.split.us.us.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_148 Depth=3
	...
	beq	$a6, $a1, .LBB4_145
.LBB4_148:                              # %.preheader626.us.us.us.us.us.us.us
                                        #   Parent Loop BB4_139 Depth=1
	...
	b	.LBB4_150
	.p2align	4, , 16
.LBB4_149:                              # %._crit_edge677.us.us.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_150 Depth=4
	...
	ld.d	$a1, $sp, 376                   # 8-byte Folded Reload
	beq	$t2, $a1, .LBB4_147
.LBB4_150:                              # %.preheader.us.us.us.us.us.us.us.us
                                        #   Parent Loop BB4_139 Depth=1
                                        #     Parent Loop BB4_146 Depth=2
                                        #       Parent Loop BB4_148 Depth=3
	...
	b	.LBB4_153
	.p2align	4, , 16
.LBB4_151:                              #   in Loop: Header=BB4_153 Depth=5
	addi.w	$a0, $a0, 1
.LBB4_152:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$t8, $t8, 1
	addi.w	$a6, $a6, 1
	addi.d	$t3, $t3, -1
	addi.w	$ra, $ra, 1
	beqz	$t3, .LBB4_149
.LBB4_153:                              #   Parent Loop BB4_139 Depth=1
                                        #     Parent Loop BB4_146 Depth=2
                                        #       Parent Loop BB4_148 Depth=3
                                        #         Parent Loop BB4_150 Depth=4
                                        # =>        This Inner Loop Header: Depth=5
	beqz	$a2, .LBB4_156
# %bb.154:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$t2, $s4, 1560
	ld.d	$a4, $sp, 496                   # 8-byte Folded Reload
	mul.d	$t2, $t2, $a4
	add.w	$t2, $a6, $t2
	addi.w	$t4, $zero, -1
	bltz	$t2, .LBB4_163
# %bb.155:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$t5, $s4, 1572
	bge	$t2, $t5, .LBB4_163
.LBB4_156:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$t2, $s4, 1588
	beqz	$t2, .LBB4_159
# %bb.157:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$t2, $s4, 1564
	ld.d	$a4, $sp, 464                   # 8-byte Folded Reload
	mul.d	$t2, $t2, $a4
	add.w	$t2, $a1, $t2
	addi.w	$t4, $zero, -1
	bltz	$t2, .LBB4_163
# %bb.158:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$t5, $s4, 1576
	bge	$t2, $t5, .LBB4_163
.LBB4_159:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$t4, $s4, 1592
	ld.w	$t2, $s4, 1568
	beqz	$t4, .LBB4_162
# %bb.160:                              #   in Loop: Header=BB4_153 Depth=5
	ld.d	$a4, $sp, 424                   # 8-byte Folded Reload
	mul.d	$t4, $t2, $a4
	add.w	$t5, $t4, $t7
	addi.w	$t4, $zero, -1
	bltz	$t5, .LBB4_163
# %bb.161:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$a4, $s4, 1580
	bge	$t5, $a4, .LBB4_163
.LBB4_162:                              # %._crit_edge.i619.us.us.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_153 Depth=5
	ld.w	$a4, $s4, 1560
	srli.d	$t4, $a6, 31
	ld.w	$t5, $s4, 1548
	...
	add.w	$t4, $a5, $a4
	.p2align	4, , 16
.LBB4_163:                              # %calculate_neighboring_subdomain_rank.exit621.us.us.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_153 Depth=5
	bne	$t4, $a3, .LBB4_152
# %bb.164:                              #   in Loop: Header=BB4_153 Depth=5
	ld.w	$a4, $s4, 1560
	ld.w	$a5, $s4, 1564
	add.w	$t2, $a6, $a4
	ld.w	$t4, $s4, 1568
	...
	add.w	$t2, $a4, $t2
	beq	$t1, $t4, .LBB4_181
# %bb.165:                              #   in Loop: Header=BB4_153 Depth=5
	beqz	$t1, .LBB4_168
# %bb.166:                              #   in Loop: Header=BB4_153 Depth=5
	ori	$a4, $zero, 1
	bne	$t1, $a4, .LBB4_169
# %bb.167:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a4, $a4, $a5
	...
	bne	$a7, $t4, .LBB4_170
	b	.LBB4_182
.LBB4_168:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a5, $a4, $a5
	...
	add.d	$a4, $a4, $s1
	ld.w	$s0, $a4, 44
.LBB4_169:                              #   in Loop: Header=BB4_153 Depth=5
	beq	$a7, $t4, .LBB4_182
.LBB4_170:                              #   in Loop: Header=BB4_153 Depth=5
	beqz	$a7, .LBB4_173
# %bb.171:                              #   in Loop: Header=BB4_153 Depth=5
	ori	$a4, $zero, 1
	bne	$a7, $a4, .LBB4_174
# %bb.172:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a4, $a4, $a5
	...
	bne	$t0, $t4, .LBB4_175
	b	.LBB4_183
.LBB4_173:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a5, $a4, $a5
...
.LBB4_174:                              #   in Loop: Header=BB4_153 Depth=5
	beq	$t0, $t4, .LBB4_183
.LBB4_175:                              #   in Loop: Header=BB4_153 Depth=5
	beqz	$t0, .LBB4_178
# %bb.176:                              #   in Loop: Header=BB4_153 Depth=5
	ori	$a4, $zero, 1
	bne	$t0, $a4, .LBB4_179
# %bb.177:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a4, $a4, $a5
	...
	beqz	$a4, .LBB4_151
	b	.LBB4_180
.LBB4_178:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a5, $a4, $a5
	...
	ld.w	$a4, $a4, 44
	st.d	$a4, $sp, 488                   # 8-byte Folded Spill
.LBB4_179:                              #   in Loop: Header=BB4_153 Depth=5
	ld.d	$a4, $sp, 472                   # 8-byte Folded Reload
	beqz	$a4, .LBB4_151
.LBB4_180:                              #   in Loop: Header=BB4_153 Depth=5
	ld.d	$a4, $s5, 0
	ori	$a5, $zero, 88
	mul.d	$a5, $a0, $a5
	add.d	$a4, $a4, $a5
	...
	st.w	$a5, $a4, 8
	b	.LBB4_151
.LBB4_181:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a5, $a4, $a5
	...
	move	$s7, $fp
	bne	$a7, $t4, .LBB4_170
.LBB4_182:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a5, $a4, $a5
	...
	move	$s6, $s3
	bne	$t0, $t4, .LBB4_175
.LBB4_183:                              #   in Loop: Header=BB4_153 Depth=5
	addi.d	$a4, $s4, 1776
	ld.d	$a4, $a4, 0
	slli.d	$a5, $ra, 8
	add.d	$a5, $a4, $a5
	...
	b	.LBB4_180
	.p2align	4, , 16
.LBB4_184:                              #   in Loop: Header=BB4_139 Depth=1
	ld.d	$s1, $sp, 272                   # 8-byte Folded Reload
	ld.w	$a0, $s4, 1604
	addi.d	$s1, $s1, 1
	blt	$s1, $a0, .LBB4_139
.LBB4_185:                              # %._crit_edge862
	ld.w	$a0, $s4, 1596
