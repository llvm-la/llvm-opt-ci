...
# %bb.13:                               # %.preheader210.us.us.preheader
	...
	add.d	$s4, $a1, $t8
	st.d	$s4, $sp, 720                   # 8-byte Folded Spill
	add.d	$a1, $a1, $a2
	...
	st.d	$s3, $sp, 632                   # 8-byte Folded Spill
	add.d	$a0, $s3, $fp
...
.LBB3_15:                               # %.preheader210.us.us
	...
	st.d	$s4, $sp, 608                   # 8-byte Folded Spill
	...
	st.d	$a5, $sp, 872                   # 8-byte Folded Spill
	st.d	$a6, $sp, 552                   # 8-byte Folded Spill
	move	$a0, $a6
	st.d	$t8, $sp, 544                   # 8-byte Folded Spill
	move	$a6, $t8
...
# %bb.26:                               # %._crit_edge
                                        #   in Loop: Header=BB8_3 Depth=1
	blez	$t1, .LBB8_48
# %bb.27:                               # %.preheader199.us.us.preheader
                                        #   in Loop: Header=BB8_3 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 48
	move	$s7, $zero
	...
	b	.LBB8_29
	.p2align	4, , 16
.LBB8_28:                               # %._crit_edge212.split.us.us.us
...
.LBB8_30:                               # %.preheader196.us.us.us
                                        ...
                                        #         Child Loop BB8_33 Depth 4
	bgeu	$t1, $a5, .LBB8_35
# %bb.31:                               #   in Loop: Header=BB8_30 Depth=3
	move	$s3, $zero
.LBB8_32:                               # %scalar.ph373.preheader
...
.LBB8_33:                               # %scalar.ph373
	...
	addi.w	$t0, $t0, 1
	bnez	$s3, .LBB8_33
.LBB8_34:                               # %._crit_edge210.us.us.us
                                        #   in Loop: Header=BB8_30 Depth=3
	addi.w	$s4, $s4, 1
	add.w	$s8, $s8, $a7
	add.d	$s7, $s7, $t5
...
.LBB8_35:                               # %vector.scevcheck320
	...
	move	$s3, $zero
	blt	$a2, $a1, .LBB8_32
# %bb.36:                               # %vector.scevcheck320
                                        #   in Loop: Header=BB8_30 Depth=3
	add.w	$a6, $a4, $t0
	add.w	$a2, $a6, $t8
	blt	$a2, $a6, .LBB8_32
# %bb.37:                               # %vector.scevcheck320
                                        #   in Loop: Header=BB8_30 Depth=3
	ori	$a2, $t6, 1
	add.w	$a2, $a2, $t0
	add.w	$s0, $a2, $t8
	blt	$s0, $a2, .LBB8_32
# %bb.38:                               # %vector.scevcheck320
                                        #   in Loop: Header=BB8_30 Depth=3
	mul.d	$s0, $a7, $s4
	add.w	$s0, $a0, $s0
	addi.d	$s5, $t1, -1
...
.LBB8_46:                               # %vector.body382
	...
	addi.w	$s3, $s3, 2
	bnez	$a2, .LBB8_46
# %bb.47:                               # %middle.block387
                                        #   in Loop: Header=BB8_30 Depth=3
	move	$s3, $t3
	bne	$t3, $t1, .LBB8_32
	b	.LBB8_34
	.p2align	4, , 16
.LBB8_48:                               # %._crit_edge214
                                        #   in Loop: Header=BB8_3 Depth=1
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	blez	$a0, .LBB8_2
# %bb.49:                               # %._crit_edge214
...
# %bb.50:                               # %._crit_edge214
                                        #   in Loop: Header=BB8_3 Depth=1
	blez	$t1, .LBB8_2
# %bb.51:                               # %.preheader198.us.us.preheader
                                        #   in Loop: Header=BB8_3 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 56
	move	$s0, $zero
	...
	b	.LBB8_53
	.p2align	4, , 16
.LBB8_52:                               # %._crit_edge222.split.us.us.us
...
# %bb.55:                               #   in Loop: Header=BB8_54 Depth=3
	move	$s3, $zero
.LBB8_56:                               # %scalar.ph.preheader
                                        #   in Loop: Header=BB8_54 Depth=3
	add.d	$a1, $t0, $s3
	slli.w	$a2, $a1, 1
	add.w	$s6, $a6, $s3
	sub.d	$s3, $t1, $s3
...
.LBB8_57:                               # %scalar.ph
	...
	addi.w	$s6, $s6, 1
	bnez	$s3, .LBB8_57
.LBB8_58:                               # %._crit_edge220.us.us.us
                                        #   in Loop: Header=BB8_54 Depth=3
	addi.w	$s4, $s4, 1
	add.w	$a6, $a6, $a7
	add.d	$t0, $t0, $t5
...
# %bb.16:                               # %middle.block
	...
	move	$s6, $s7
	beq	$s4, $a0, .LBB12_10
.LBB12_17:                              # %.lr.ph.split.us84.us.us.preheader174
                                        #   in Loop: Header=BB12_11 Depth=3
	move	$s8, $s6
	.p2align	4, , 16
...
# %bb.23:                               # %middle.block153
	...
	move	$s6, $s7
	beq	$s4, $a0, .LBB12_10
.LBB12_24:                              # %.lr.ph.split.us.us.us.us.preheader175
                                        #   in Loop: Header=BB12_11 Depth=3
	add.w	$s5, $ra, $s6
	sub.d	$s6, $t4, $s6
	.p2align	4, , 16
...
# %bb.32:                               # %middle.block167
	...
	beq	$s4, $a0, .LBB12_27
	.p2align	4, , 16
.LBB12_33:                              # %scalar.ph159.preheader
                                        #   in Loop: Header=BB12_28 Depth=3
	add.w	$a1, $a7, $s6
	sub.d	$s6, $t4, $s6
	.p2align	4, , 16
.LBB12_34:                              # %scalar.ph159
                                        #   Parent Loop BB12_3 Depth=1
                                        #     Parent Loop BB12_8 Depth=2
                                        #       Parent Loop BB12_28 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
