...
.LBB3_6:                                # %.preheader242
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr24, $sp, 464                 # 16-byte Folded Spill
	vst	$vr23, $sp, 352                 # 16-byte Folded Spill
	...
	fmov.d	$ft15, $fa4
	fst.d	$fa4, $sp, 480                  # 8-byte Folded Spill
	...
	fmadd.d	$fa2, $fs1, $fs3, $fa2
	fld.d	$fa4, $sp, 1064                 # 8-byte Folded Reload
	fmul.d	$fa4, $fa4, $fs3
	fadd.d	$ft13, $fa2, $fa4
	...
	fst.d	$fa2, $sp, 1080                 # 8-byte Folded Spill
	...
	fst.d	$fa7, $sp, 160                  # 8-byte Folded Spill
...
# %bb.7:                                #   in Loop: Header=BB3_6 Depth=2
	...
	fld.d	$ft12, $sp, 296                 # 8-byte Folded Reload
	fmadd.d	$fa1, $ft12, $ft4, $fa1
	fld.d	$fa2, $sp, 184                  # 8-byte Folded Reload
	fmul.d	$fa2, $fa2, $fs3
	fadd.d	$fa1, $fa1, $fa2
	fld.d	$fs5, $sp, 288                  # 8-byte Folded Reload
	fmadd.d	$fa2, $fs5, $ft11, $fs3
	fld.d	$fs6, $sp, 280                  # 8-byte Folded Reload
	fmadd.d	$fa2, $fs6, $ft10, $fa2
	fld.d	$fs7, $sp, 272                  # 8-byte Folded Reload
	...
	fld.d	$fa6, $sp, 216                  # 8-byte Folded Reload
	fmul.d	$fa6, $fa6, $fs3
	fadd.d	$fa5, $fa5, $fa6
	...
	fld.d	$fa7, $sp, 224                  # 8-byte Folded Reload
	fmul.d	$fa7, $fa7, $fs3
	fadd.d	$fa6, $fa6, $fa7
	...
	fld.d	$ft1, $sp, 240                  # 8-byte Folded Reload
	fmul.d	$ft1, $ft1, $fs3
	fadd.d	$ft0, $ft0, $ft1
...
# %bb.8:                                # %.lr.ph.i216.preheader
	...
	fst.d	$ft2, $sp, 96                   # 8-byte Folded Spill
	...
	fst.d	$ft14, $sp, 192                 # 8-byte Folded Spill
	fmadd.d	$fa1, $ft10, $ft14, $fa1
	fst.d	$ft13, $sp, 200                 # 8-byte Folded Spill
	fmadd.d	$fa1, $ft9, $ft13, $fa1
	fst.d	$ft12, $sp, 208                 # 8-byte Folded Spill
	fmadd.d	$fa1, $ft8, $ft12, $fa1
	fst.d	$ft2, $sp, 216                  # 8-byte Folded Spill
	fmadd.d	$fa1, $ft7, $ft2, $fa1
	vori.b	$vr20, $vr11, 0
	fst.d	$fa5, $sp, 224                  # 8-byte Folded Spill
	fmadd.d	$fa1, $ft3, $fa5, $fa1
	fst.d	$fa4, $sp, 232                  # 8-byte Folded Spill
...
.LBB3_10:                               #   in Loop: Header=BB3_6 Depth=2
	...
	fmul.d	$fa1, $fs0, $fa7
	fld.d	$ft14, $sp, 176                 # 8-byte Folded Reload
	...
	fld.d	$fs4, $sp, 1120                 # 8-byte Folded Reload
	fmul.d	$fa1, $fs0, $fs4
	fld.d	$ft1, $sp, 424                  # 8-byte Folded Reload
	fadd.d	$ft1, $ft1, $fa1
	fld.d	$ft13, $sp, 1104                # 8-byte Folded Reload
	fmul.d	$fa1, $fs0, $ft13
	fld.d	$ft0, $sp, 432                  # 8-byte Folded Reload
	fadd.d	$ft0, $ft0, $fa1
	...
	fst.d	$ft1, $sp, 424                  # 8-byte Folded Spill
	bcnez	$fcc0, .LBB3_19
# %bb.11:                               #   in Loop: Header=BB3_6 Depth=2
	fst.d	$ft15, $sp, 144                 # 8-byte Folded Spill
	movgr2fr.d	$fa0, $zero
...
# %bb.13:                               # %.lr.ph.i231.preheader
                                        #   in Loop: Header=BB3_6 Depth=2
	fst.d	$ft14, $sp, 176                 # 8-byte Folded Spill
	fmul.d	$fa1, $fa0, $fa7
	fadd.d	$fs0, $ft11, $fa1
	fmul.d	$fa1, $fa0, $fa6
	fadd.d	$fa2, $ft10, $fa1
...
.LBB3_14:                               # %call.sqrt1004
                                        #   in Loop: Header=BB3_6 Depth=2
	fmov.d	$fa0, $fs2
	vst	$vr20, $sp, 352                 # 16-byte Folded Spill
	fst.d	$ft4, $sp, 144                  # 8-byte Folded Spill
	fst.d	$ft5, $sp, 80                   # 8-byte Folded Spill
	fst.d	$ft6, $sp, 72                   # 8-byte Folded Spill
	fst.d	$ft7, $sp, 64                   # 8-byte Folded Spill
	fst.d	$ft8, $sp, 56                   # 8-byte Folded Spill
	fst.d	$ft9, $sp, 48                   # 8-byte Folded Spill
	fst.d	$ft10, $sp, 24                  # 8-byte Folded Spill
	...
	fld.d	$ft10, $sp, 24                  # 8-byte Folded Reload
	fld.d	$ft9, $sp, 48                   # 8-byte Folded Reload
	fld.d	$ft8, $sp, 56                   # 8-byte Folded Reload
	fld.d	$ft7, $sp, 64                   # 8-byte Folded Reload
	fld.d	$ft6, $sp, 72                   # 8-byte Folded Reload
	fld.d	$ft5, $sp, 80                   # 8-byte Folded Reload
	fld.d	$ft4, $sp, 144                  # 8-byte Folded Reload
	vld	$vr20, $sp, 352                 # 16-byte Folded Reload
	b	.LBB3_10
	.p2align	4, , 16
...
# %bb.23:                               # %.loopexit.loopexit
	...
	move	$a1, $s0
	fmov.d	$fa0, $fs6
	vld	$vr1, $sp, 464                  # 16-byte Folded Reload
                                        # kill: def $f1_64 killed $f1_64 killed $vr1
	pcaddu18i	$ra, %call36(add_grids)
	jirl	$ra, $ra, 0
	ld.w	$a4, $sp, 1140
