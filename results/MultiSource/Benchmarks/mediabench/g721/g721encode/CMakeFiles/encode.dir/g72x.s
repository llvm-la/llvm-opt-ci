...
# %bb.30:                               # %.split.preheader
	...
	vadd.h	$vr0, $vr0, $vr1
	vstelm.h	$vr0, $a7, 24, 0
	ld.d	$a0, $a7, 36
	vstelm.h	$vr0, $a7, 26, 1
	vstelm.h	$vr0, $a7, 28, 2
	vstelm.h	$vr0, $a7, 30, 3
	st.d	$a0, $a7, 38
	st.h	$a6, $a7, 46
	move	$a0, $t3
	beqz	$t3, .LBB7_60
.LBB7_31:                               # %.lr.ph.i.preheader
	ori	$a0, $zero, 1
	bne	$t3, $a0, .LBB7_33
...
.LBB7_72:
	...
	ori	$a0, $a0, 3104
	b	.LBB7_122
.LBB7_73:                               # %.lr.ph.i177.3
	ori	$a0, $zero, 8
	bge	$a5, $a0, .LBB7_75
# %bb.74:
	lu12i.w	$a0, 48
	b	.LBB7_117
.LBB7_75:                               # %.lr.ph.i177.4
	ori	$a0, $zero, 16
	bge	$a5, $a0, .LBB7_80
# %bb.76:
	lu12i.w	$a0, 64
...
.LBB7_77:
	lu12i.w	$a0, 16
	b	.LBB7_121
.LBB7_78:                               # %.lr.ph.i183.3
	addi.w	$a0, $zero, -8
	bge	$a0, $a5, .LBB7_82
# %bb.79:
	lu12i.w	$a0, 48
	b	.LBB7_121
.LBB7_80:                               # %.lr.ph.i177.5
	ori	$a0, $zero, 32
	bge	$a5, $a0, .LBB7_84
# %bb.81:
	lu12i.w	$a0, 80
	b	.LBB7_117
.LBB7_82:                               # %.lr.ph.i183.4
	addi.w	$a0, $zero, -16
	bge	$a0, $a5, .LBB7_86
# %bb.83:
	lu12i.w	$a0, 64
	b	.LBB7_121
.LBB7_84:                               # %.lr.ph.i177.6
	ori	$a0, $zero, 64
	bge	$a5, $a0, .LBB7_88
# %bb.85:
	lu12i.w	$a0, 96
	b	.LBB7_117
.LBB7_86:                               # %.lr.ph.i183.5
	addi.w	$a0, $zero, -32
	bge	$a0, $a5, .LBB7_90
# %bb.87:
	lu12i.w	$a0, 80
	b	.LBB7_121
.LBB7_88:                               # %.lr.ph.i177.7
	ori	$a0, $zero, 128
	bge	$a5, $a0, .LBB7_92
# %bb.89:
	lu12i.w	$a0, 112
	b	.LBB7_117
.LBB7_90:                               # %.lr.ph.i183.6
	addi.w	$a0, $zero, -64
	bge	$a0, $a5, .LBB7_94
# %bb.91:
	lu12i.w	$a0, 96
	b	.LBB7_121
.LBB7_92:                               # %.lr.ph.i177.8
	ori	$a0, $zero, 256
	bge	$a5, $a0, .LBB7_96
# %bb.93:
	lu12i.w	$a0, 128
	b	.LBB7_117
.LBB7_94:                               # %.lr.ph.i183.7
	addi.w	$a0, $zero, -128
	bge	$a0, $a5, .LBB7_98
# %bb.95:
	lu12i.w	$a0, 112
	b	.LBB7_121
.LBB7_96:                               # %.lr.ph.i177.9
	ori	$a0, $zero, 512
	bge	$a5, $a0, .LBB7_100
# %bb.97:
	lu12i.w	$a0, 144
	b	.LBB7_117
.LBB7_98:                               # %.lr.ph.i183.8
	addi.w	$a0, $zero, -256
	bge	$a0, $a5, .LBB7_102
# %bb.99:
	lu12i.w	$a0, 128
	b	.LBB7_121
.LBB7_100:                              # %.lr.ph.i177.10
	ori	$a0, $zero, 1024
	bge	$a5, $a0, .LBB7_104
# %bb.101:
	lu12i.w	$a0, 160
	b	.LBB7_117
.LBB7_102:                              # %.lr.ph.i183.9
	addi.w	$a0, $zero, -512
	bge	$a0, $a5, .LBB7_106
# %bb.103:
	lu12i.w	$a0, 144
	b	.LBB7_121
.LBB7_104:                              # %.lr.ph.i177.11
	ori	$a0, $zero, 2048
	bge	$a5, $a0, .LBB7_108
# %bb.105:
	lu12i.w	$a0, 176
	b	.LBB7_117
.LBB7_106:                              # %.lr.ph.i183.10
	addi.w	$a0, $zero, -1024
	bge	$a0, $a5, .LBB7_110
# %bb.107:
	lu12i.w	$a0, 160
	b	.LBB7_121
.LBB7_108:                              # %.lr.ph.i177.12
	lu12i.w	$a0, 1
	bge	$a5, $a0, .LBB7_112
# %bb.109:
	lu12i.w	$a0, 192
	b	.LBB7_117
.LBB7_110:                              # %.lr.ph.i183.11
	addi.w	$a0, $zero, -2048
	bge	$a0, $a5, .LBB7_114
# %bb.111:
	lu12i.w	$a0, 176
	b	.LBB7_121
.LBB7_112:                              # %.lr.ph.i177.13
	lu12i.w	$a0, 2
	bge	$a5, $a0, .LBB7_116
# %bb.113:
	lu12i.w	$a0, 208
	b	.LBB7_117
.LBB7_114:                              # %.lr.ph.i183.12
	lu12i.w	$a0, -1
	bge	$a0, $a5, .LBB7_118
# %bb.115:
	lu12i.w	$a0, 192
	b	.LBB7_121
.LBB7_116:                              # %.lr.ph.i177.14
	lu12i.w	$a0, 4
	slt	$a0, $a5, $a0
	lu12i.w	$a4, 240
	masknez	$a4, $a4, $a0
...
.LBB7_117:                              # %quan.exit182
	...
	add.d	$a0, $a4, $a0
	b	.LBB7_122
.LBB7_118:                              # %.lr.ph.i183.13
	lu12i.w	$a0, -2
	bge	$a0, $a5, .LBB7_120
# %bb.119:
	lu12i.w	$a0, 208
	b	.LBB7_121
.LBB7_120:                              # %.lr.ph.i183.14
	lu12i.w	$a0, -4
	slt	$a0, $a0, $a5
	lu12i.w	$a4, 240
	masknez	$a4, $a4, $a0
