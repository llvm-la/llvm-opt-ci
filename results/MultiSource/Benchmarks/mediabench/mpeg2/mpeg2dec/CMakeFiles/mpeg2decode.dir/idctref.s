...
.LBB1_1:                                # %.preheader41
	...
	fmadd.d	$ft1, $ft2, $fa4, $ft1
	fmadd.d	$ft1, $ft5, $fa5, $ft1
	fmadd.d	$ft1, $ft6, $fa6, $ft1
	fmadd.d	$ft1, $ft7, $fa7, $ft1
	fst.d	$ft1, $a6, 40
	fmadd.d	$ft1, $ft8, $fa0, $ft0
	fmadd.d	$ft1, $ft9, $fa1, $ft1
	fmadd.d	$ft1, $ft10, $fa2, $ft1
	fmadd.d	$ft1, $ft11, $fa3, $ft1
	fmadd.d	$ft1, $ft12, $fa4, $ft1
	fmadd.d	$ft1, $ft13, $fa5, $ft1
	fmadd.d	$ft1, $ft14, $fa6, $ft1
	fmadd.d	$ft1, $ft15, $fa7, $ft1
	fst.d	$ft1, $a6, 48
	fmadd.d	$fa0, $fs0, $fa0, $ft0
	fmadd.d	$fa0, $fs1, $fa1, $fa0
	fmadd.d	$fa0, $fs2, $fa2, $fa0
	fmadd.d	$fa0, $fs3, $fa3, $fa0
	fmadd.d	$fa0, $fs4, $fa4, $fa0
	fmadd.d	$fa0, $fs5, $fa5, $fa0
	fmadd.d	$fa0, $fs6, $fa6, $fa0
	fmadd.d	$fa0, $fs7, $fa7, $fa0
	fst.d	$fa0, $a6, 56
	addi.d	$a2, $a2, 64
	addi.d	$a3, $a3, 16
	bne	$a2, $a5, .LBB1_1
...
.LBB1_3:                                # %vector.body
	...
	vftintrz.w.d	$vr11, $vr10, $vr10
	vrepli.w	$vr10, -256
	vmax.w	$vr12, $vr11, $vr10
	vrepli.w	$vr11, 255
