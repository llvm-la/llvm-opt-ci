...
# %bb.0:
	...
	pcalau12i	$s5, %pc_hi20(Quiet_Flag)
	st.w	$zero, $s5, %pc_lo12(Quiet_Flag)
...
.LBB0_2:                                #   in Loop: Header=BB0_6 Depth=1
	...
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(User_Data_Flag)
...
.LBB0_11:                               #   in Loop: Header=BB0_6 Depth=1
	...
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(Main_Bitstream_Flag)
	beqz	$s1, .LBB0_30
...
.LBB0_13:                               #   in Loop: Header=BB0_6 Depth=1
	...
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(Reference_IDCT_Flag)
	b	.LBB0_5
...
.LBB0_15:                               #   in Loop: Header=BB0_6 Depth=1
	ori	$a0, $zero, 1
	st.w	$a0, $s5, %pc_lo12(Quiet_Flag)
	b	.LBB0_5
.LBB0_16:                               #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(Ersatz_Flag)
	bnez	$s1, .LBB0_122
...
.LBB0_18:                               #   in Loop: Header=BB0_6 Depth=1
	...
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(Big_Picture_Flag)
	b	.LBB0_5
...
.LBB0_21:                               #   in Loop: Header=BB0_6 Depth=1
	ori	$a0, $zero, 1
	st.w	$a0, $s4, %pc_lo12(Two_Streams)
	bnez	$s1, .LBB0_124
...
.LBB0_25:                               #   in Loop: Header=BB0_6 Depth=1
	...
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(Frame_Store_Flag)
	b	.LBB0_5
.LBB0_26:                               #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(Spatial_Flag)
	bnez	$s1, .LBB0_123
...
.LBB0_52:
	...
	jirl	$ra, $ra, 0
.LBB0_53:                               # %Initialize_Decoder.exit.preheader
	...
	pcalau12i	$a0, %pc_hi20(auxframe)
	addi.d	$a0, $a0, %pc_lo12(auxframe)
	...
	.p2align	4, , 16
.LBB0_54:                               # %Initialize_Decoder.exit
...
.LBB0_67:                               #   in Loop: Header=BB0_54 Depth=1
	...
	st.w	$a1, $a2, %pc_lo12(mb_height)
	slli.d	$a2, $a0, 4
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	ld.w	$a3, $a3, %pc_lo12(chroma_format)
	ld.d	$a4, $sp, 72                    # 8-byte Folded Reload
	st.w	$a2, $a4, %pc_lo12(Coded_Picture_Width)
	slli.d	$a1, $a1, 4
	ld.d	$a4, $sp, 64                    # 8-byte Folded Reload
	st.w	$a1, $a4, %pc_lo12(Coded_Picture_Height)
	addi.d	$a4, $a3, -1
	sltui	$a4, $a4, 1
	addi.d	$a5, $a3, -3
	sltui	$a5, $a5, 1
	...
	st.w	$a0, $a4, %pc_lo12(Chroma_Height)
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	st.w	$a3, $a0, %pc_lo12(block_count)
	mul.w	$s0, $a1, $a2
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.70:                               #   in Loop: Header=BB0_54 Depth=1
	ld.w	$a0, $s6, %pc_lo12(Ersatz_Flag)
...
# %bb.73:                               #   in Loop: Header=BB0_54 Depth=1
	...
	ld.w	$a0, $s6, %pc_lo12(lower_layer_prediction_horizontal_size)
	pcalau12i	$s0, %pc_hi20(lower_layer_prediction_vertical_size)
	ld.w	$a1, $s0, %pc_lo12(lower_layer_prediction_vertical_size)
	mul.w	$a0, $a1, $a0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	st.d	$a0, $a1, 0
	beqz	$a0, .LBB0_118
# %bb.74:                               #   in Loop: Header=BB0_54 Depth=1
	ld.w	$a0, $s6, %pc_lo12(lower_layer_prediction_horizontal_size)
	ld.w	$a1, $s0, %pc_lo12(lower_layer_prediction_vertical_size)
	mul.w	$a0, $a1, $a0
	pcaddu18i	$ra, %call36(malloc)
...
.LBB0_75:                               #   in Loop: Header=BB0_54 Depth=1
	...
	ld.w	$a0, $a0, %pc_lo12(Chroma_Height)
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(Chroma_Width)
	mul.w	$s0, $a1, $a0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.81:                               #   in Loop: Header=BB0_54 Depth=1
	...
	st.d	$a0, $a1, 8
	beqz	$a0, .LBB0_118
# %bb.82:                               #   in Loop: Header=BB0_54 Depth=1
	ld.w	$a0, $s6, %pc_lo12(lower_layer_prediction_horizontal_size)
	ld.w	$a1, $s0, %pc_lo12(lower_layer_prediction_vertical_size)
	mul.w	$a0, $a1, $a0
	bstrpick.d	$a1, $a0, 62, 61
...
.LBB0_83:                               #   in Loop: Header=BB0_54 Depth=1
	...
	st.d	$a0, $s8, 16
	beqz	$a0, .LBB0_114
# %bb.84:                               #   in Loop: Header=BB0_54 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 192                   # 8-byte Folded Reload
...
# %bb.87:                               #   in Loop: Header=BB0_54 Depth=1
	...
	st.d	$a0, $s1, 16
	beqz	$a0, .LBB0_117
.LBB0_88:                               #   in Loop: Header=BB0_54 Depth=1
	ldptr.w	$a0, $s3, 3148
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB0_93
# %bb.89:                               #   in Loop: Header=BB0_54 Depth=1
	ld.d	$s1, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a0, $s1, %pc_lo12(lower_layer_prediction_horizontal_size)
	pcalau12i	$s0, %pc_hi20(lower_layer_prediction_vertical_size)
	ld.w	$a1, $s0, %pc_lo12(lower_layer_prediction_vertical_size)
	mul.w	$a0, $a1, $a0
	bstrpick.d	$a1, $a0, 62, 61
	...
	st.d	$a0, $a1, 16
	beqz	$a0, .LBB0_118
# %bb.90:                               #   in Loop: Header=BB0_54 Depth=1
	ld.w	$a0, $s1, %pc_lo12(lower_layer_prediction_horizontal_size)
	ld.w	$a1, $s0, %pc_lo12(lower_layer_prediction_vertical_size)
	mul.w	$a0, $a1, $a0
	bstrpick.d	$a1, $a0, 62, 61
...
# %bb.91:                               #   in Loop: Header=BB0_54 Depth=1
	...
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB0_93
# %bb.92:                               #   in Loop: Header=BB0_54 Depth=1
	ld.w	$a0, $s0, %pc_lo12(lower_layer_prediction_vertical_size)
	pcalau12i	$a1, %pc_hi20(vertical_subsampling_factor_n)
	ld.w	$a1, $a1, %pc_lo12(vertical_subsampling_factor_n)
	pcalau12i	$a2, %pc_hi20(vertical_subsampling_factor_m)
	ld.w	$a2, $a2, %pc_lo12(vertical_subsampling_factor_m)
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a3, $a3, %pc_lo12(lower_layer_prediction_horizontal_size)
	mul.w	$a0, $a1, $a0
	div.w	$a0, $a0, $a2
	mul.w	$a0, $a0, $a3
	slli.d	$a0, $a0, 1
	...
	beqz	$a0, .LBB0_121
.LBB0_93:                               # %Initialize_Sequence.exit.i.i
                                        #   in Loop: Header=BB0_54 Depth=1
	move	$a0, $fp
	move	$a1, $zero
	pcaddu18i	$ra, %call36(Decode_Picture)
	jirl	$ra, $ra, 0
	pcalau12i	$s6, %pc_hi20(Second_Field)
	ld.w	$a0, $s6, %pc_lo12(Second_Field)
	sltui	$s0, $a0, 1
	add.w	$fp, $fp, $s0
	.p2align	4, , 16
.LBB0_94:                               #   Parent Loop BB0_54 Depth=1
...
.LBB0_103:                              #   in Loop: Header=BB0_54 Depth=1
	...
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB0_105
# %bb.104:                              #   in Loop: Header=BB0_54 Depth=1
...
.LBB0_105:                              #   in Loop: Header=BB0_54 Depth=1
	...
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB0_107
# %bb.106:                              #   in Loop: Header=BB0_54 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 8
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_107:                              #   in Loop: Header=BB0_54 Depth=1
	ld.d	$a0, $s1, 16
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	...
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB0_54
# %bb.108:                              #   in Loop: Header=BB0_54 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	...
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB0_54
# %bb.109:                              #   in Loop: Header=BB0_54 Depth=1
	pcalau12i	$a0, %pc_hi20(lltmp)
	ld.d	$a0, $a0, %pc_lo12(lltmp)
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_54
.LBB0_110:                              #   in Loop: Header=BB0_54 Depth=1
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a3, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str.20)
	...
	jirl	$ra, $ra, 0
	b	.LBB0_57
.LBB0_111:                              # %Decode_Bitstream.exit
	ld.w	$a0, $s3, 0
