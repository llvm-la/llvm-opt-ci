...
.LBB5_29:                               # %vector.body
	...
	vseqi.h	$vr16, $vr14, 0
	vextrins.h	$vr16, $vr16, 65
	vslli.d	$vr16, $vr16, 48
	vsrai.d	$vr16, $vr16, 48
	vseqi.h	$vr17, $vr15, 0
	vextrins.h	$vr17, $vr17, 65
	...
	vslti.w	$vr24, $vr23, 0
	vilvl.w	$vr23, $vr24, $vr23
	vslti.w	$vr24, $vr22, 0
	vilvl.w	$vr22, $vr24, $vr22
...
.LBB9_77:                               # %vector.body
	...
	vseqi.h	$vr4, $vr4, 0
	vxori.b	$vr4, $vr4, 255
	vextrins.h	$vr4, $vr4, 65
	vand.v	$vr4, $vr4, $vr1
	vseqi.h	$vr5, $vr5, 0
	vxori.b	$vr5, $vr5, 255
	vextrins.h	$vr5, $vr5, 65
	vand.v	$vr5, $vr5, $vr1
	vadd.d	$vr2, $vr2, $vr4
	vadd.d	$vr3, $vr3, $vr5
	addi.d	$fp, $fp, -4
...
.LBB10_77:                              # %vector.body
	...
	vsle.wu	$vr16, $vr17, $vr14
	vilvl.w	$vr2, $vr16, $vr16
	vsle.wu	$vr15, $vr17, $vr13
	vilvl.w	$vr0, $vr15, $vr15
	vslt.wu	$vr5, $vr1, $vr14
	vslt.wu	$vr8, $vr1, $vr13
	vand.v	$vr18, $vr16, $vr5
	vilvl.w	$vr5, $vr18, $vr18
	vand.v	$vr8, $vr15, $vr8
	...
	vsub.w	$vr21, $vr14, $vr17
	vsub.w	$vr23, $vr13, $vr17
	vslli.w	$vr21, $vr21, 1
	vslli.w	$vr23, $vr23, 1
	vslti.w	$vr24, $vr21, 0
	vilvl.w	$vr21, $vr24, $vr21
	vslti.w	$vr24, $vr23, 0
	vilvl.w	$vr23, $vr24, $vr23
	...
	vilvl.w	$vr2, $vr24, $vr24
	vsle.wu	$vr23, $vr3, $vr20
	vilvl.w	$vr0, $vr23, $vr23
	vslt.wu	$vr5, $vr4, $vr21
	vslt.wu	$vr8, $vr4, $vr20
	vand.v	$vr26, $vr24, $vr5
	vilvl.w	$vr5, $vr26, $vr26
	vand.v	$vr25, $vr23, $vr8
	vilvl.w	$vr8, $vr25, $vr25
	vsub.w	$vr19, $vr21, $vr4
	vsub.w	$vr27, $vr20, $vr4
	vmul.w	$vr19, $vr19, $vr11
	...
	vslti.w	$vr30, $vr28, 0
	vilvl.w	$vr28, $vr30, $vr28
	vslti.w	$vr30, $vr29, 0
	vilvl.w	$vr29, $vr30, $vr29
	vmul.d	$vr28, $vr28, $vr28
	vmul.d	$vr30, $vr29, $vr29
	vand.v	$vr5, $vr5, $vr19
	vbitsel.v	$vr2, $vr28, $vr5, $vr2
	vst	$vr2, $sp, 96                   # 16-byte Folded Spill
	ld.h	$a1, $s5, -2
	ld.h	$a2, $s5, 0
	vand.v	$vr2, $vr8, $vr27
	vbitsel.v	$vr8, $vr30, $vr2, $vr0
	vinsgr2vr.h	$vr0, $a1, 0
	vinsgr2vr.h	$vr2, $a2, 0
	vilvl.b	$vr0, $vr10, $vr0
	...
	vsle.wu	$vr31, $vr6, $vr28
	vilvl.w	$vr0, $vr31, $vr31
	vsle.wu	$vr30, $vr6, $vr27
	vslt.wu	$vr2, $vr7, $vr28
	vslt.wu	$vr19, $vr7, $vr27
	vand.v	$vr5, $vr31, $vr2
	vilvl.w	$vr22, $vr5, $vr5
	vand.v	$vr2, $vr30, $vr19
	vsub.w	$vr19, $vr28, $vr6
	vslt.w	$vr29, $vr28, $vr6
	vilvl.w	$vr19, $vr29, $vr19
	vsub.w	$vr29, $vr28, $vr7
	vilvl.w	$vr29, $vr10, $vr29
	vmul.d	$vr29, $vr29, $vr29
	vand.v	$vr22, $vr22, $vr29
	vilvl.w	$vr29, $vr2, $vr2
	vmul.d	$vr19, $vr19, $vr19
	vbitsel.v	$vr0, $vr19, $vr22, $vr0
	vsub.w	$vr19, $vr27, $vr6
	vslt.w	$vr22, $vr27, $vr6
	vilvl.w	$vr19, $vr22, $vr19
	vsub.w	$vr22, $vr27, $vr7
	vilvl.w	$vr22, $vr10, $vr22
	vmul.d	$vr22, $vr22, $vr22
	vand.v	$vr22, $vr29, $vr22
	vilvl.w	$vr29, $vr30, $vr30
	vmul.d	$vr19, $vr19, $vr19
	vbitsel.v	$vr19, $vr19, $vr22, $vr29
	vld	$vr29, $sp, 80                  # 16-byte Folded Reload
	vslt.wu	$vr22, $vr29, $vr14
	vor.v	$vr18, $vr18, $vr22
	vand.v	$vr16, $vr16, $vr18
	vilvl.w	$vr16, $vr16, $vr16
	vpickve2gr.d	$a1, $vr16, 0
	vpickve2gr.d	$a2, $vr16, 1
	vslt.wu	$vr16, $vr29, $vr13
	vld	$vr18, $sp, 144                 # 16-byte Folded Reload
	vor.v	$vr16, $vr18, $vr16
	vand.v	$vr15, $vr15, $vr16
	vilvl.w	$vr15, $vr15, $vr15
	...
	vslli.w	$vr2, $vr2, 31
	vsrai.w	$vr2, $vr2, 31
	vbitsel.v	$vr2, $vr7, $vr6, $vr2
	vadd.d	$vr5, $vr8, $vr19
	vsub.w	$vr8, $vr28, $vr2
	vslt.w	$vr2, $vr28, $vr2
	vinsgr2vr.w	$vr13, $a3, 0
	vinsgr2vr.w	$vr13, $a4, 1
	vslli.w	$vr13, $vr13, 31
	vsrai.w	$vr13, $vr13, 31
	vbitsel.v	$vr13, $vr7, $vr6, $vr13
	vilvl.w	$vr2, $vr2, $vr8
	vsub.w	$vr8, $vr27, $vr13
	vslt.w	$vr13, $vr27, $vr13
	vilvl.w	$vr8, $vr13, $vr8
	vmadd.d	$vr16, $vr2, $vr2
	vmadd.d	$vr14, $vr8, $vr8
	vst	$vr0, $s3, -16
	vst	$vr5, $s3, 0
	vmin.d	$vr9, $vr16, $vr9
