...
# %bb.1:                                # %.lr.ph
	...
	xvst	$xr11, $sp, 96                  # 32-byte Folded Spill
	b	.LBB1_4
	.p2align	4, , 16
.LBB1_2:                                #   in Loop: Header=BB1_4 Depth=1
	...
	move	$a0, $s0
	jirl	$ra, $a1, 0
	xvld	$xr11, $sp, 96                  # 32-byte Folded Reload
...
.LBB1_15:                               # %vector.body111
	...
	xvori.b	$xr6, $xr7, 0
	xvmadd.w	$xr6, $xr1, $xr2
	vld	$vr1, $s5, 48
	vext2xv.wu.hu	$xr2, $xr5
	xvori.b	$xr5, $xr7, 0
	xvmadd.w	$xr5, $xr2, $xr3
	xvld	$xr2, $a1, %pc_lo12(.LCPI1_6)
	vext2xv.wu.hu	$xr1, $xr1
	xvori.b	$xr3, $xr7, 0
	xvmadd.w	$xr3, $xr1, $xr4
	vext2xv.wu.hu	$xr0, $xr0
	xvori.b	$xr1, $xr7, 0
...
.LBB1_19:                               # %.preheader
	...
	xvldrepl.d	$xr8, $a4, 0
	xvori.b	$xr9, $xr10, 0
	xvinsve0.d	$xr9, $xr1, 1
	xvinsve0.d	$xr9, $xr4, 2
	xvinsve0.d	$xr9, $xr5, 3
	xvori.b	$xr1, $xr10, 0
	xvinsve0.d	$xr1, $xr3, 1
	xvinsve0.d	$xr1, $xr6, 2
	xvinsve0.d	$xr1, $xr7, 3
	fst.d	$fs0, $sp, 184
	fst.d	$fs1, $sp, 176
	fst.d	$fs2, $sp, 168
	fst.d	$fa2, $sp, 160
	...
	xvld	$xr0, $sp, 192
	xvld	$xr2, $sp, 160
	xvfmul.d	$xr1, $xr8, $xr1
	xvfmul.d	$xr3, $xr8, $xr9
	xvfmul.d	$xr0, $xr3, $xr0
	xvfmul.d	$xr1, $xr1, $xr2
	xvfmul.d	$xr1, $xr1, $xr11
...
.Lfunc_end1:
	.size	start_pass_fdctmgr, .Lfunc_end1-start_pass_fdctmgr
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function forward_DCT
.LCPI2_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
	.dword	2                               # 0x2
...
.LBB2_2:                                # %.preheader
	...
	xvxor.v	$xr6, $xr2, $xr11
	xvand.v	$xr5, $xr6, $xr5
	xvslli.w	$xr5, $xr5, 16
	xvsrai.w	$xr5, $xr5, 16
	xvld	$xr10, $sp, 48                  # 32-byte Folded Reload
	xvbitsel.v	$xr6, $xr10, $xr1, $xr5
	xvdiv.w	$xr4, $xr4, $xr6
	xvsub.w	$xr0, $xr3, $xr0
	xvsle.w	$xr3, $xr1, $xr0
	xvand.v	$xr6, $xr2, $xr3
	xvbitsel.v	$xr1, $xr10, $xr1, $xr6
	xvdiv.w	$xr0, $xr0, $xr1
	xvand.v	$xr0, $xr3, $xr0
	xvneg.w	$xr0, $xr0
	xvld	$xr9, $sp, 80                   # 32-byte Folded Reload
	xvbitsel.v	$xr1, $xr9, $xr4, $xr5
	...
	xvadd.w	$xr5, $xr1, $xr4
	xvsle.w	$xr6, $xr2, $xr5
	xvxor.v	$xr7, $xr3, $xr11
	xvand.v	$xr6, $xr7, $xr6
	xvslli.w	$xr6, $xr6, 16
	xvsrai.w	$xr6, $xr6, 16
	xvbitsel.v	$xr7, $xr10, $xr2, $xr6
	xvdiv.w	$xr5, $xr5, $xr7
	xvsub.w	$xr1, $xr4, $xr1
	xvsle.w	$xr4, $xr2, $xr1
	xvand.v	$xr7, $xr3, $xr4
	xvbitsel.v	$xr2, $xr10, $xr2, $xr7
	xvdiv.w	$xr1, $xr1, $xr2
	xvand.v	$xr1, $xr4, $xr1
	xvneg.w	$xr1, $xr1
	xvbitsel.v	$xr2, $xr9, $xr5, $xr6
