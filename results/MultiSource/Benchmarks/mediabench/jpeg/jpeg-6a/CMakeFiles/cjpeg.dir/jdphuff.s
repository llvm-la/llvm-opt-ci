...
.LBB1_20:
	...
	b	.LBB1_23
.LBB1_21:                               # %.lr.ph141.split.us
	ld.w	$a2, $fp, 508
	ld.w	$a1, $fp, 512
	bge	$a1, $a2, .LBB1_38
# %bb.22:                               # %._crit_edge142.thread
	ld.w	$a1, $fp, 516
	sltui	$a1, $a1, 1
...
.LBB1_24:                               # %.lr.ph145
	...
	addi.d	$s3, $s1, 36
	beqz	$s2, .LBB1_30
# %bb.25:                               # %.lr.ph145.split.preheader
	move	$s2, $zero
	addi.d	$s4, $fp, 256
	ori	$s5, $zero, 424
	ori	$s6, $zero, 3
...
# %bb.29:                               #   in Loop: Header=BB1_28 Depth=1
	...
	bnez	$a1, .LBB1_27
	b	.LBB1_26
.LBB1_30:                               # %.lr.ph145.split.us.preheader
	move	$s2, $zero
	addi.d	$s4, $fp, 224
	ori	$s5, $zero, 424
	ori	$s6, $zero, 3
	...
	b	.LBB1_34
	.p2align	4, , 16
.LBB1_31:                               #   in Loop: Header=BB1_34 Depth=1
	ld.d	$a0, $fp, 0
	st.w	$s8, $a0, 44
	ld.d	$a1, $fp, 0
	ld.d	$a1, $a1, 0
...
.LBB1_37:                               # %._crit_edge146
	...
	addi.d	$sp, $sp, 112
	ret
.LBB1_38:                               # %.lr.ph141.split.us.split.preheader
	st.d	$s2, $sp, 16                    # 8-byte Folded Spill
	move	$s4, $zero
	ori	$s5, $zero, 111
	addi.w	$s0, $zero, -1
	b	.LBB1_41
	.p2align	4, , 16
.LBB1_39:                               # %._crit_edge.us.loopexit
                                        #   in Loop: Header=BB1_41 Depth=1
	ld.w	$a0, $fp, 416
.LBB1_40:                               # %._crit_edge.us
                                        #   in Loop: Header=BB1_41 Depth=1
	addi.d	$s4, $s4, 1
	bge	$s4, $a0, .LBB1_18
.LBB1_41:                               # %.lr.ph141.split.us.split
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB1_44 Depth 2
	ld.w	$s6, $fp, 508
	blt	$a1, $s6, .LBB1_40
# %bb.42:                               # %.lr.ph.us.preheader
                                        #   in Loop: Header=BB1_41 Depth=1
	slli.d	$a0, $s4, 3
	addi.d	$a1, $fp, 424
	ldx.d	$a0, $a1, $a0
