...
# %bb.64:                               #   in Loop: Header=BB4_63 Depth=3
	...
	b	.LBB4_67
	.p2align	4, , 16
.LBB4_65:                               #   in Loop: Header=BB4_63 Depth=3
	ld.d	$a1, $s1, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB4_232
# %bb.66:                               #   in Loop: Header=BB4_63 Depth=3
	ld.d	$s4, $s1, 0
	ld.d	$s5, $s1, 8
	ld.b	$s7, $s4, 0
	addi.d	$a1, $s5, -1
	bnez	$a1, .LBB4_61
.LBB4_67:                               #   in Loop: Header=BB4_63 Depth=3
	ld.d	$a1, $s1, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB4_232
# %bb.68:                               #   in Loop: Header=BB4_63 Depth=3
	ld.d	$a0, $s1, 0
	ld.d	$a1, $s1, 8
	b	.LBB4_62
	.p2align	4, , 16
.LBB4_69:                               #   in Loop: Header=BB4_71 Depth=3
	ld.d	$s4, $s1, 0
	ld.d	$s5, $s1, 8
.LBB4_70:                               #   in Loop: Header=BB4_71 Depth=3
	ld.bu	$a0, $s4, 0
...
.LBB4_71:                               # %.split.us.i
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	bnez	$s5, .LBB4_70
# %bb.72:                               #   in Loop: Header=BB4_71 Depth=3
	ld.d	$a1, $s1, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB4_69
