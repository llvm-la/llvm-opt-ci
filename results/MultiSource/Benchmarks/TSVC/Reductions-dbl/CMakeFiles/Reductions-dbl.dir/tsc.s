...
.LBB8_2:                                # %.lr.ph
	...
	vld	$vr7, $fp, 208
	vld	$vr8, $fp, 240
	vpackev.d	$vr9, $vr5, $vr4
	vpackev.d	$vr10, $vr6, $vr3
	vfadd.d	$vr10, $vr10, $vr11
	vfadd.d	$vr9, $vr9, $vr11
	vpackod.d	$vr3, $vr6, $vr3
	vpackod.d	$vr4, $vr5, $vr4
	vfadd.d	$vr4, $vr9, $vr4
	vfadd.d	$vr3, $vr10, $vr3
	vpackev.d	$vr5, $vr8, $vr7
	vpackev.d	$vr6, $vr2, $vr1
	vfadd.d	$vr3, $vr3, $vr6
	vfadd.d	$vr4, $vr4, $vr5
	vpackod.d	$vr1, $vr2, $vr1
	vpackod.d	$vr2, $vr8, $vr7
	vfadd.d	$vr2, $vr4, $vr2
	vld	$vr4, $fp, 0
	vld	$vr5, $fp, 32
	vfadd.d	$vr1, $vr3, $vr1
	vld	$vr3, $fp, 16
	vld	$vr6, $fp, 48
	vpackev.d	$vr7, $vr5, $vr4
	vfadd.d	$vr7, $vr7, $vr11
	vpackod.d	$vr4, $vr5, $vr4
	vfadd.d	$vr4, $vr7, $vr4
	vpackev.d	$vr5, $vr6, $vr3
	vfadd.d	$vr4, $vr4, $vr5
	vpackod.d	$vr3, $vr6, $vr3
	vfadd.d	$vr3, $vr4, $vr3
...
.Lfunc_end11:
	...
	.p2align	3, 0x0                          # -- Begin function s315
.LCPI12_0:
