...
.LBB8_2:                                # %.lr.ph
	...
	vori.b	$vr8, $vr10, 0
	vshuf.w	$vr8, $vr4, $vr3
	vpackev.w	$vr9, $vr5, $vr2
	vpermi.w	$vr8, $vr9, 228
	vori.b	$vr9, $vr10, 0
	vshuf.w	$vr9, $vr7, $vr6
	vbsrl.v	$vr10, $vr1, 12
	vbsll.v	$vr11, $vr0, 4
	vor.v	$vr10, $vr11, $vr10
	vpermi.w	$vr9, $vr10, 228
	vldi	$vr10, -3200
	vextrins.w	$vr10, $vr1, 0
	vextrins.w	$vr10, $vr1, 33
	vextrins.w	$vr10, $vr1, 50
	vld	$vr1, $sp, 64                   # 16-byte Folded Reload
	vfadd.s	$vr1, $vr9, $vr1
	vld	$vr9, $sp, 48                   # 16-byte Folded Reload
	vfadd.s	$vr8, $vr8, $vr9
	vpackod.w	$vr9, $vr5, $vr2
	vilvl.w	$vr11, $vr4, $vr3
	vpermi.w	$vr11, $vr9, 228
	vldi	$vr9, -3200
	vextrins.w	$vr9, $vr0, 17
	vextrins.w	$vr9, $vr6, 33
	vextrins.w	$vr9, $vr7, 49
	vfadd.s	$vr8, $vr11, $vr8
	vfadd.s	$vr1, $vr9, $vr1
	vilvh.w	$vr9, $vr5, $vr2
	vpackev.w	$vr11, $vr4, $vr3
	vpermi.w	$vr11, $vr9, 228
	vldi	$vr9, -3200
	vextrins.w	$vr9, $vr0, 18
	vextrins.w	$vr9, $vr6, 34
	vextrins.w	$vr9, $vr7, 50
	vfadd.s	$vr8, $vr11, $vr8
	vfadd.s	$vr1, $vr9, $vr1
	vld	$vr9, $sp, 32                   # 16-byte Folded Reload
	vshuf.w	$vr9, $vr5, $vr2
	vpackod.w	$vr2, $vr4, $vr3
	vpermi.w	$vr2, $vr9, 228
	vldi	$vr3, -3200
	vextrins.w	$vr3, $vr0, 19
	vextrins.w	$vr3, $vr6, 35
	vextrins.w	$vr3, $vr7, 51
	vfadd.s	$vr0, $vr2, $vr8
	vfadd.s	$vr1, $vr3, $vr1
	vld	$vr2, $sp, 16                   # 16-byte Folded Reload
	vfadd.s	$vr2, $vr10, $vr2
