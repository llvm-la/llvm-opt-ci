...
.Lfunc_end10:
	...
	.p2align	4, 0x0                          # -- Begin function mem_mono_copy_mono
.LCPI11_0:
	.byte	0                               # 0x0
	.byte	4                               # 0x4
	.byte	8                               # 0x8
...
# %bb.21:                               # %.lr.ph286
	...
	bstrpick.d	$a1, $s0, 29, 4
	slli.d	$s2, $a1, 4
	slli.d	$a1, $a1, 7
	sub.w	$a1, $s1, $a1
	st.d	$a1, $sp, 40                    # 8-byte Folded Spill
	st.d	$s0, $sp, 80                    # 8-byte Folded Spill
	bstrpick.d	$a1, $s0, 29, 2
	slli.d	$s7, $a1, 2
	slli.d	$a1, $a1, 5
	sub.w	$a1, $s1, $a1
...
.LBB11_38:                              # %vector.memcheck504
	...
	and	$a4, $a5, $a4
	bnez	$a4, .LBB11_30
# %bb.39:                               # %vector.memcheck504
                                        #   in Loop: Header=BB11_23 Depth=1
	bltz	$a3, .LBB11_30
# %bb.40:                               # %vector.main.loop.iter.check517
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a4, $sp, 128                   # 8-byte Folded Reload
	ori	$a5, $zero, 120
	bgeu	$a4, $a5, .LBB11_46
# %bb.41:                               #   in Loop: Header=BB11_23 Depth=1
	move	$t2, $zero
	b	.LBB11_55
.LBB11_42:                              # %vector.ph466
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$a5, $zero
	add.d	$a7, $t8, $s2
	add.d	$a4, $s4, $s2
	.p2align	4, , 16
.LBB11_43:                              # %vector.body471
                                        #   Parent Loop BB11_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $s4, $a5
	vld	$vr2, $t2, 1
	...
	addi.d	$a5, $a5, 16
	bne	$s2, $a5, .LBB11_43
# %bb.44:                               # %middle.block478
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a5, $sp, 80                    # 8-byte Folded Reload
	bne	$s2, $a5, .LBB11_50
# %bb.45:                               #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a5, $sp, 40                    # 8-byte Folded Reload
	b	.LBB11_32
.LBB11_46:                              # %vector.ph519
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$a5, $zero
	add.d	$a7, $t8, $ra
	add.d	$a4, $s4, $ra
	.p2align	4, , 16
.LBB11_47:                              # %vector.body526
                                        #   Parent Loop BB11_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $s4, $a5
	vld	$vr2, $t2, 1
	...
	addi.d	$a5, $a5, 16
	bne	$ra, $a5, .LBB11_47
# %bb.48:                               # %middle.block533
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a5, $sp, 72                    # 8-byte Folded Reload
	bne	$ra, $a5, .LBB11_54
# %bb.49:                               #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a5, $sp, 48                    # 8-byte Folded Reload
	b	.LBB11_32
.LBB11_50:                              # %vec.epilog.iter.check485
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$t2, $s2
	ld.d	$a5, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a6, $sp, 24                    # 8-byte Folded Reload
	beqz	$a6, .LBB11_27
.LBB11_51:                              # %vec.epilog.ph487
                                        #   in Loop: Header=BB11_23 Depth=1
	add.d	$a7, $t8, $s7
	add.d	$a4, $s4, $s7
	.p2align	4, , 16
.LBB11_52:                              # %vec.epilog.vector.body492
                                        #   Parent Loop BB11_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a5, $s4, $t2
	ld.w	$a5, $a5, 1
	...
	vreplgr2vr.w	$vr4, $a5
	vandn.v	$vr3, $vr4, $vr3
	vld	$vr4, $t6, %pc_lo12(.LCPI11_0)
	vxor.v	$vr2, $vr0, $vr2
	add.d	$a5, $s6, $t2
	vor.v	$vr2, $vr3, $vr2
	vshuf.b	$vr2, $vr0, $vr2, $vr4
	addi.d	$t2, $t2, 4
	vstelm.w	$vr2, $a5, 0, 0
	bne	$s7, $t2, .LBB11_52
# %bb.53:                               # %vec.epilog.middle.block499
                                        #   in Loop: Header=BB11_23 Depth=1
...
.LBB11_56:                              # %vec.epilog.vector.body549
	...
	vxor.v	$vr2, $vr0, $vr2
	ldx.w	$a5, $s6, $t2
	vld	$vr3, $t6, %pc_lo12(.LCPI11_0)
	add.d	$t8, $s6, $t2
	vor.v	$vr2, $vr2, $vr1
	vinsgr2vr.w	$vr4, $a5, 0
	vshuf.b	$vr2, $vr0, $vr2, $vr3
	vand.v	$vr2, $vr4, $vr2
	addi.d	$t2, $t2, 4
	vstelm.w	$vr2, $t8, 0, 0
	bne	$s8, $t2, .LBB11_56
...
# %bb.81:                               #   in Loop: Header=BB11_62 Depth=1
	move	$t7, $zero
	b	.LBB11_88
.LBB11_82:                              # %vector.main.loop.iter.check401
                                        #   in Loop: Header=BB11_62 Depth=1
	ori	$a4, $zero, 120
	bgeu	$a7, $a4, .LBB11_91
# %bb.83:                               #   in Loop: Header=BB11_62 Depth=1
	move	$t7, $zero
	b	.LBB11_96
.LBB11_84:                              # %vector.ph
                                        #   in Loop: Header=BB11_62 Depth=1
...
.LBB11_85:                              # %vector.body
	...
	vandn.v	$vr9, $vr13, $vr9
	vandn.v	$vr12, $vr13, $vr12
	vandn.v	$vr10, $vr13, $vr10
...
.LBB11_88:                              # %vec.epilog.ph
	...
	addi.d	$t8, $t7, 1
	.p2align	4, , 16
.LBB11_89:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB11_62 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t2, -1
...
.LBB11_97:                              # %vec.epilog.vector.body442
	...
	vadd.w	$vr5, $vr5, $vr6
	ld.w	$t7, $t8, 0
	vld	$vr6, $t6, %pc_lo12(.LCPI11_0)
	vxor.v	$vr5, $vr5, $vr1
	vor.v	$vr5, $vr5, $vr2
	vinsgr2vr.w	$vr7, $t7, 0
	vshuf.b	$vr5, $vr0, $vr5, $vr6
	vand.v	$vr5, $vr7, $vr5
	vstelm.w	$vr5, $t8, 0, 0
	addi.d	$a4, $a4, 4
	addi.d	$t2, $t2, 4
...
.LBB11_111:                             # %.lr.ph244.split.split
	bgeu	$s2, $s6, .LBB11_115
# %bb.112:                              # %.lr.ph244.split.split.split.us
	ld.d	$t2, $sp, 120                   # 8-byte Folded Reload
	bgeu	$t2, $a6, .LBB11_118
