...
.LBB11_26:                              #   in Loop: Header=BB11_23 Depth=1
	move	$a6, $t2
	move	$t1, $t4
.LBB11_27:                              # %.lr.ph.split.us.preheader476
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$s4, $s5
	move	$a7, $t1
	.p2align	4, , 16
...
.LBB11_31:                              #   in Loop: Header=BB11_23 Depth=1
	move	$a6, $t2
	move	$t1, $t4
.LBB11_32:                              # %.lr.ph.split.preheader477
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$s4, $s5
	move	$a7, $t1
	.p2align	4, , 16
...
.LBB11_39:                              # %vector.body425
	...
	addi.d	$a6, $a6, 32
	bne	$ra, $a6, .LBB11_39
# %bb.40:                               # %middle.block432
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a6, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a7, $sp, 56                    # 8-byte Folded Reload
	bne	$ra, $a7, .LBB11_27
	b	.LBB11_34
.LBB11_41:                              # %vector.memcheck437
                                        #   in Loop: Header=BB11_23 Depth=1
	addi.d	$a6, $s5, 1
...
.LBB11_58:                              #   in Loop: Header=BB11_50 Depth=1
	...
	move	$ra, $t2
	move	$s5, $s7
.LBB11_59:                              # %.lr.ph.split.us.us.preheader484
                                        #   in Loop: Header=BB11_50 Depth=1
	move	$s7, $s5
	.p2align	4, , 16
...
.LBB11_61:                              # %.lr.ph.split.us253.preheader
                                        #   in Loop: Header=BB11_50 Depth=1
	bltu	$a7, $a5, .LBB11_64
# %bb.62:                               # %vector.memcheck374
                                        #   in Loop: Header=BB11_50 Depth=1
	add.d	$a5, $s7, $fp
	bgeu	$s6, $a5, .LBB11_73
# %bb.63:                               # %vector.memcheck374
                                        #   in Loop: Header=BB11_50 Depth=1
	add.d	$a5, $s5, $fp
	bgeu	$s7, $a5, .LBB11_73
.LBB11_64:                              #   in Loop: Header=BB11_50 Depth=1
	...
	move	$ra, $t2
	move	$s5, $s7
.LBB11_65:                              # %.lr.ph.split.us253.preheader485
                                        #   in Loop: Header=BB11_50 Depth=1
	move	$s7, $s5
	.p2align	4, , 16
...
.LBB11_71:                              # %vector.body
	...
	vpickve2gr.b	$t1, $vr4, 13
	vinsgr2vr.w	$vr7, $t1, 1
	vpickve2gr.b	$t1, $vr4, 14
	vinsgr2vr.w	$vr7, $t1, 2
	vpickve2gr.b	$t1, $vr4, 15
	vinsgr2vr.w	$vr7, $t1, 3
	vpickve2gr.b	$t1, $vr4, 8
	vinsgr2vr.w	$vr8, $t1, 0
	vpickve2gr.b	$t1, $vr4, 9
	vinsgr2vr.w	$vr8, $t1, 1
	vpickve2gr.b	$t1, $vr4, 10
	vinsgr2vr.w	$vr8, $t1, 2
	vpickve2gr.b	$t1, $vr4, 11
	vinsgr2vr.w	$vr8, $t1, 3
	xvpermi.q	$xr8, $xr7, 2
	vpickve2gr.b	$t1, $vr4, 4
	vinsgr2vr.w	$vr7, $t1, 0
	vpickve2gr.b	$t1, $vr4, 5
	vinsgr2vr.w	$vr7, $t1, 1
	vpickve2gr.b	$t1, $vr4, 6
	vinsgr2vr.w	$vr7, $t1, 2
	vpickve2gr.b	$t1, $vr4, 7
	vinsgr2vr.w	$vr7, $t1, 3
