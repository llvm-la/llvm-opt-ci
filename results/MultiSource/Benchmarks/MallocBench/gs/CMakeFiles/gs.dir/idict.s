...
.LBB2_25:
	move	$s3, $a0
	b	.LBB2_28
.LBB2_26:                               # %.loopexit.sink.split.loopexit
	add.d	$fp, $s2, $s4
.LBB2_27:                               # %.loopexit.sink.split
	addi.d	$a0, $fp, -16
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	st.d	$a0, $a1, 0
	ori	$s3, $zero, 1
...
.LBB7_23:
	...
	pcaddu18i	$ra, %call36(alloc_free)
	jirl	$ra, $ra, 0
.LBB7_24:                               # %dict_create.exit.thread
	move	$a0, $s1
