...
# %bb.90:                               # %vector.memcheck
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB1_79
# %bb.91:                               # %vector.main.loop.iter.check326
	ori	$a2, $zero, 16
	bgeu	$s6, $a2, .LBB1_123
# %bb.92:
	move	$a2, $zero
...
# %bb.100:                              # %.lr.ph236
	...
	move	$a5, $t3
	bgeu	$a3, $a4, .LBB1_116
.LBB1_101:                              # %scalar.ph356.preheader
	slli.d	$a3, $a0, 1
	alsl.d	$a0, $a5, $s3, 3
	add.d	$a2, $a2, $a3
	add.d	$a2, $a2, $a5
...
# %bb.104:
	...
	b	.LBB1_106
	.p2align	4, , 16
.LBB1_105:                              #   in Loop: Header=BB1_106 Depth=1
	addi.d	$s0, $s0, -1
	addi.d	$fp, $fp, 8
	beqz	$s0, .LBB1_109
.LBB1_106:                              # %.lr.ph238
...
# %bb.107:                              #   in Loop: Header=BB1_106 Depth=1
	...
	st.d	$zero, $fp, 0
	b	.LBB1_105
.LBB1_108:                              # %._crit_edge239
	beqz	$s3, .LBB1_110
.LBB1_109:                              # %._crit_edge239.thread
	move	$a0, $s3
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_110:
...
.LBB1_116:                              # %vector.scevcheck351
	...
	move	$a5, $t3
	blt	$a7, $a4, .LBB1_101
# %bb.117:                              # %vector.scevcheck351
	srli.d	$a6, $a6, 32
	move	$a5, $t3
	bnez	$a6, .LBB1_101
# %bb.118:                              # %vector.memcheck352
	alsl.d	$a5, $t3, $s3, 3
	add.d	$a6, $s0, $a4
	sub.d	$a6, $a6, $t3
	alsl.d	$a6, $a6, $a1, 3
	bgeu	$a5, $a6, .LBB1_120
# %bb.119:                              # %vector.memcheck352
	alsl.d	$a6, $s0, $s3, 3
	alsl.d	$a7, $a4, $a1, 3
	move	$a5, $t3
	bltu	$a7, $a6, .LBB1_101
.LBB1_120:                              # %vector.ph358
	slli.d	$a7, $t3, 3
	move	$a6, $a3
...
.LBB1_121:                              # %vector.body361
	...
	addi.w	$a4, $a4, 8
	bnez	$t0, .LBB1_121
# %bb.122:                              # %middle.block367
	bne	$a3, $a6, .LBB1_101
	b	.LBB1_103
.LBB1_123:                              # %vector.ph327
	andi	$a3, $s6, 12
...
.LBB1_124:                              # %vector.body330
	...
	addi.w	$a5, $a5, 16
	bnez	$a6, .LBB1_124
# %bb.125:                              # %middle.block335
	beq	$a2, $s6, .LBB1_82
# %bb.126:                              # %vec.epilog.iter.check339
	beqz	$a3, .LBB1_80
.LBB1_127:                              # %vec.epilog.ph341
	move	$a5, $a2
	...
	add.w	$a5, $a1, $a5
	.p2align	4, , 16
.LBB1_128:                              # %vec.epilog.vector.body344
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	slli.d	$a6, $a5, 2
	vstx	$vr0, $s3, $a6
	...
	addi.w	$a5, $a5, 4
	bnez	$a3, .LBB1_128
# %bb.129:                              # %vec.epilog.middle.block348
	bne	$a2, $s6, .LBB1_80
	b	.LBB1_82
.Lfunc_end1:
...
.LBB5_30:                               # %._crit_edge129
	...
	pcaddu18i	$ra, %call36(set_pair1)
	jirl	$ra, $ra, 0
.LBB5_31:                               #   in Loop: Header=BB5_15 Depth=2
	bltu	$s8, $s1, .LBB5_44
# %bb.32:                               #   in Loop: Header=BB5_15 Depth=2
	slli.d	$a0, $s1, 2
...
.LBB5_33:                               #   in Loop: Header=BB5_15 Depth=2
	...
	ori	$a1, $zero, 33
	blt	$s6, $a1, .LBB5_35
# %bb.34:                               #   in Loop: Header=BB5_15 Depth=2
	addi.d	$a0, $s6, -1
	srli.d	$a0, $a0, 3
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	and	$a0, $a0, $a1
	addi.d	$a0, $a0, 8
.LBB5_35:                               #   in Loop: Header=BB5_15 Depth=2
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s6
	...
	jirl	$ra, $ra, 0
	beqz	$s6, .LBB5_37
# %bb.36:                               #   in Loop: Header=BB5_15 Depth=2
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB5_37:                               # %.thread118
...
.LBB5_38:                               #   in Loop: Header=BB5_15 Depth=2
	...
	b	.LBB5_41
	.p2align	4, , 16
.LBB5_39:                               #   in Loop: Header=BB5_15 Depth=2
	ld.d	$a0, $fp, 0
	ld.d	$a1, $fp, 8
	ld.d	$a2, $fp, 16
	ori	$a3, $zero, 1
	...
	jirl	$ra, $ra, 0
	b	.LBB5_41
.LBB5_40:                               #   in Loop: Header=BB5_15 Depth=2
	ld.d	$a0, $fp, 0
	ld.d	$a1, $fp, 8
...
.LBB5_41:                               # %.thread
	...
	sub.d	$s6, $a1, $a2
	stx.w	$s6, $a3, $s4
.LBB5_42:                               #   in Loop: Header=BB5_15 Depth=2
	pcaddu18i	$ra, %call36(setdown_cube)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s7, 32
	beqz	$a0, .LBB5_13
# %bb.43:                               #   in Loop: Header=BB5_15 Depth=2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB5_13
.LBB5_44:                               #   in Loop: Header=BB5_15 Depth=2
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	slli.d	$a1, $s3, 2
	stx.w	$s6, $a0, $a1
	bgtz	$s1, .LBB5_42
	b	.LBB5_14
.LBB5_45:                               # %._crit_edge157.loopexit
	ld.d	$s2, $fp, 48
	ld.d	$s3, $s2, 8
	ld.d	$s5, $sp, 16                    # 8-byte Folded Reload
.LBB5_46:                               # %._crit_edge157
	beqz	$s3, .LBB5_48
# %bb.47:
	move	$a0, $s3
	pcaddu18i	$ra, %call36(free)
...
# %bb.33:
	move	$a3, $zero
.LBB11_34:                              # %vec.epilog.scalar.ph82.preheader
	sub.d	$a4, $s0, $a3
	alsl.d	$a0, $a3, $a0, 2
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a5, $a3, $s5, 2
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB11_35:                              # %vec.epilog.scalar.ph82
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a1, 0
	st.w	$a3, $a5, 0
	ld.w	$a3, $a2, 0
...
.LBB11_50:
	...
	addi.d	$sp, $sp, 128
	ret
.LBB11_51:                              # %vector.memcheck55
	sub.d	$a5, $a0, $s5
	ori	$a4, $zero, 64
	move	$a3, $zero
	bltu	$a5, $a4, .LBB11_34
# %bb.52:                               # %vector.memcheck55
	sub.d	$a5, $s5, $a1
	bltu	$a5, $a4, .LBB11_34
# %bb.53:                               # %vector.memcheck55
	sub.d	$a5, $a2, $s5
	ori	$a4, $zero, 64
	bltu	$a5, $a4, .LBB11_34
# %bb.54:                               # %vector.memcheck55
	sub.d	$a5, $a0, $a1
	bltu	$a5, $a4, .LBB11_34
# %bb.55:                               # %vector.memcheck55
	sub.d	$a4, $a0, $a2
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB11_34
# %bb.56:                               # %vector.main.loop.iter.check68
	ori	$a3, $zero, 16
	bgeu	$s0, $a3, .LBB11_58
# %bb.57:
	move	$a3, $zero
	b	.LBB11_62
.LBB11_58:                              # %vector.ph69
	andi	$a4, $s0, 12
...
.LBB11_59:                              # %vector.body72
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB11_59
# %bb.60:                               # %middle.block79
	beq	$a3, $s0, .LBB11_36
# %bb.61:                               # %vec.epilog.iter.check83
	beqz	$a4, .LBB11_34
.LBB11_62:                              # %vec.epilog.ph85
	move	$t0, $a3
	...
	alsl.d	$t0, $t0, $a1, 2
	.p2align	4, , 16
.LBB11_63:                              # %vec.epilog.vector.body88
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	vld	$vr0, $a6, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB11_63
# %bb.64:                               # %vec.epilog.middle.block93
	bne	$a3, $s0, .LBB11_34
	b	.LBB11_36
.Lfunc_end11:
