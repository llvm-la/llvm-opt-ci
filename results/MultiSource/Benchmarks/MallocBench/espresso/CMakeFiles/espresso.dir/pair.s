...
.LBB1_67:                               # %vector.body308
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_67
# %bb.68:                               # %middle.block311
	beq	$a0, $a1, .LBB1_71
.LBB1_69:                               # %.lr.ph222.preheader347
	slli.d	$a3, $a0, 2
	alsl.d	$a2, $a2, $a3, 2
	add.d	$a2, $s3, $a2
	ori	$a3, $zero, 4
...
.LBB1_73:
	move	$a2, $zero
.LBB1_74:                               # %scalar.ph314.preheader
	slli.d	$a3, $a2, 2
	alsl.d	$a3, $s0, $a3, 2
	add.d	$a0, $a0, $a3
	add.w	$a1, $a1, $a2
...
.LBB1_86:                               # %vector.body319
	...
	addi.d	$a3, $a3, 32
	bnez	$a5, .LBB1_86
# %bb.87:                               # %middle.block324
	bne	$a2, $s7, .LBB1_74
	b	.LBB1_76
.LBB1_88:
	move	$a1, $a0
.LBB1_89:                               # %.preheader210
	move	$s8, $s1
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
...
# %bb.95:                               # %.lr.ph236
	...
	move	$a5, $t3
	bgeu	$a3, $a4, .LBB1_111
.LBB1_96:                               # %scalar.ph332.preheader
	slli.d	$a3, $a0, 1
	alsl.d	$a0, $a5, $s2, 3
	add.d	$a2, $a2, $a3
	add.d	$a2, $a2, $a5
...
# %bb.102:                              #   in Loop: Header=BB1_101 Depth=1
	...
	st.d	$zero, $fp, 0
	b	.LBB1_100
.LBB1_103:                              # %._crit_edge239
	beqz	$s2, .LBB1_105
.LBB1_104:                              # %._crit_edge239.thread
	move	$a0, $s2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_105:
...
.LBB1_111:                              # %vector.scevcheck327
	...
	move	$a5, $t3
	blt	$a7, $a4, .LBB1_96
# %bb.112:                              # %vector.scevcheck327
	srli.d	$a6, $a6, 32
	move	$a5, $t3
	bnez	$a6, .LBB1_96
# %bb.113:                              # %vector.memcheck328
	alsl.d	$a5, $t3, $s2, 3
	add.d	$a6, $s0, $a4
	sub.d	$a6, $a6, $t3
	alsl.d	$a6, $a6, $a1, 3
	bgeu	$a5, $a6, .LBB1_115
# %bb.114:                              # %vector.memcheck328
	alsl.d	$a6, $s0, $s2, 3
	alsl.d	$a7, $a4, $a1, 3
	move	$a5, $t3
	bltu	$a7, $a6, .LBB1_96
.LBB1_115:                              # %vector.ph334
	slli.d	$a7, $t3, 3
	move	$a6, $a3
...
.LBB5_25:                               # %._crit_edge129
	...
	pcaddu18i	$ra, %call36(set_pair1)
	jirl	$ra, $ra, 0
.LBB5_26:                               #   in Loop: Header=BB5_16 Depth=2
	bltu	$s4, $s1, .LBB5_39
# %bb.27:                               #   in Loop: Header=BB5_16 Depth=2
	slli.d	$a0, $s1, 2
	...
	add.d	$a0, $a1, $a0
	jr	$a0
.LBB5_28:                               #   in Loop: Header=BB5_16 Depth=2
	ld.w	$a1, $s7, 0
	ori	$a0, $zero, 8
	ori	$a2, $zero, 33
	blt	$a1, $a2, .LBB5_30
# %bb.29:                               #   in Loop: Header=BB5_16 Depth=2
	addi.d	$a0, $a1, -1
	srli.d	$a0, $a0, 3
...
.LBB5_32:                               # %.thread118
	...
	b	.LBB5_15
	.p2align	4, , 16
.LBB5_33:                               #   in Loop: Header=BB5_16 Depth=2
	ld.d	$a0, $fp, 0
	ld.d	$a1, $fp, 8
	ld.d	$a2, $fp, 16
	pcaddu18i	$ra, %call36(espresso)
...
.LBB5_34:                               #   in Loop: Header=BB5_16 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB5_36
.LBB5_35:                               #   in Loop: Header=BB5_16 Depth=2
	ld.d	$a0, $fp, 0
	ld.d	$a1, $fp, 8
...
.LBB5_36:                               # %.thread
	...
	slli.d	$a0, $s3, 2
	stx.w	$s6, $a3, $a0
.LBB5_37:                               #   in Loop: Header=BB5_16 Depth=2
	pcaddu18i	$ra, %call36(setdown_cube)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s7, 32
	beqz	$a0, .LBB5_14
...
.LBB5_39:                               #   in Loop: Header=BB5_16 Depth=2
	...
	bgtz	$s1, .LBB5_37
	b	.LBB5_15
.LBB5_40:                               # %._crit_edge157.loopexit
	ld.d	$s2, $fp, 48
	ld.d	$s3, $s2, 8
...
# %bb.27:
	move	$a4, $zero
.LBB11_28:                              # %scalar.ph56.preheader
	sub.d	$a1, $a1, $a4
	alsl.d	$a0, $a4, $a0, 2
	alsl.d	$a3, $a4, $a3, 2
	alsl.d	$a5, $a4, $s5, 2
...
.LBB11_42:
	...
	addi.d	$sp, $sp, 128
	ret
.LBB11_43:                              # %vector.memcheck47
	sub.d	$a6, $a0, $s5
	ori	$a5, $zero, 32
	move	$a4, $zero
	bltu	$a6, $a5, .LBB11_28
# %bb.44:                               # %vector.memcheck47
	sub.d	$a6, $s5, $a2
	bltu	$a6, $a5, .LBB11_28
# %bb.45:                               # %vector.memcheck47
	sub.d	$a6, $a3, $s5
	ori	$a5, $zero, 32
	bltu	$a6, $a5, .LBB11_28
# %bb.46:                               # %vector.memcheck47
	sub.d	$a6, $a0, $a2
	bltu	$a6, $a5, .LBB11_28
# %bb.47:                               # %vector.memcheck47
	sub.d	$a5, $a0, $a3
	ori	$a6, $zero, 32
	bltu	$a5, $a6, .LBB11_28
# %bb.48:                               # %vector.ph58
