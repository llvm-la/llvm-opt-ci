...
# %bb.35:                               # %.lr.ph106.i
                                        #   in Loop: Header=BB0_33 Depth=2
	blez	$a0, .LBB0_46
# %bb.36:                               # %.lr.ph106.split.us.i.preheader
                                        #   in Loop: Header=BB0_33 Depth=2
	move	$a1, $zero
	alsl.d	$a2, $s5, $a2, 2
	b	.LBB0_39
	.p2align	4, , 16
.LBB0_37:                               # %._crit_edge100.split.us.us.i
                                        #   in Loop: Header=BB0_39 Depth=3
	add.w	$a1, $a1, $a0
.LBB0_38:                               #   in Loop: Header=BB0_39 Depth=3
	addi.w	$a5, $a3, 1
	bge	$a3, $a4, .LBB0_31
.LBB0_39:                               # %.lr.ph106.split.us.i
                                        #   Parent Loop BB0_14 Depth=1
	...
	and	$a7, $a5, $a7
	beqz	$a7, .LBB0_38
# %bb.40:                               # %.preheader88.us.i
                                        #   in Loop: Header=BB0_39 Depth=3
	bge	$a1, $s8, .LBB0_37
# %bb.41:                               # %.preheader.lr.ph.us.i
                                        #   in Loop: Header=BB0_39 Depth=3
	ld.d	$a4, $s3, 24
	alsl.d	$a4, $a6, $a4, 2
	add.d	$a6, $fp, $a1
...
.LBB0_43:                               #   Parent Loop BB0_14 Depth=1
	...
	addi.d	$t0, $t0, 1
	bnez	$t1, .LBB0_43
# %bb.44:                               # %._crit_edge98.us.us.i
                                        #   in Loop: Header=BB0_42 Depth=4
	add.w	$a7, $a7, $s2
	add.d	$a6, $a6, $s2
	blt	$a7, $s8, .LBB0_42
# %bb.45:                               # %._crit_edge100.split.us.us.loopexit.i
                                        #   in Loop: Header=BB0_39 Depth=3
	ld.w	$a4, $a2, 0
	b	.LBB0_37
.LBB0_46:                               # %.lr.ph106.split.i
                                        #   in Loop: Header=BB0_33 Depth=2
	srai.d	$a1, $a5, 5
	alsl.d	$a1, $a1, $s4, 2
	ld.w	$a1, $a1, 4
...
.LBB7_3:                                # %.split.preheader
	...
	b	.LBB7_6
	.p2align	4, , 16
.LBB7_4:                                # %._crit_edge102
                                        #   in Loop: Header=BB7_6 Depth=1
	andi	$a0, $s2, 1
	bnez	$a0, .LBB7_13
.LBB7_5:                                # %.splitthread-pre-split
                                        #   in Loop: Header=BB7_6 Depth=1
	ld.d	$s6, $fp, 16
	ori	$s2, $zero, 1
	move	$s7, $s8
	beqz	$s6, .LBB7_13
.LBB7_6:                                # %.lr.ph101.outer
                                        # =>This Loop Header: Depth=1
...
.LBB10_7:                               #   Parent Loop BB10_2 Depth=1
	...
	addi.d	$t1, $t1, 1
	bltu	$t1, $s6, .LBB10_13
# %bb.8:                                # %vector.memcheck103
                                        #   in Loop: Header=BB10_7 Depth=2
	alsl.d	$t4, $t3, $a2, 2
	alsl.d	$t6, $t2, $a7, 2
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_10
# %bb.9:                                # %vector.memcheck103
                                        #   in Loop: Header=BB10_7 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_13
.LBB10_10:                              # %vector.ph117
                                        #   in Loop: Header=BB10_7 Depth=2
	move	$t3, $t1
...
.LBB10_11:                              # %vector.body120
	...
	addi.d	$t5, $t5, -16
	bnez	$t6, .LBB10_11
# %bb.12:                               # %middle.block128
                                        #   in Loop: Header=BB10_7 Depth=2
	move	$t2, $t4
	beq	$t1, $t3, .LBB10_6
	.p2align	4, , 16
.LBB10_13:                              # %scalar.ph115.preheader
                                        #   in Loop: Header=BB10_7 Depth=2
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a3, 2
	alsl.d	$t2, $t2, $a2, 2
	.p2align	4, , 16
.LBB10_14:                              # %scalar.ph115
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t2, 0
...
.LBB10_24:                              # %vector.body92
	...
	addi.d	$t5, $t5, -16
	bnez	$t6, .LBB10_24
# %bb.25:                               # %middle.block100
                                        #   in Loop: Header=BB10_20 Depth=2
	move	$t2, $t4
	beq	$t1, $t3, .LBB10_19
	.p2align	4, , 16
.LBB10_26:                              # %scalar.ph87.preheader
                                        #   in Loop: Header=BB10_20 Depth=2
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a3, 2
	alsl.d	$t2, $t2, $a2, 2
	.p2align	4, , 16
.LBB10_27:                              # %scalar.ph87
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t2, 0
	...
	b	.LBB10_19
	.p2align	4, , 16
.LBB10_28:                              # %uncof_output.exit35.loopexit
                                        #   in Loop: Header=BB10_2 Depth=1
	ld.w	$a3, $s4, 124
	slli.d	$a1, $a3, 2
	ldx.w	$a0, $a0, $a1
	add.w	$a6, $a0, $s2
.LBB10_29:                              # %uncof_output.exit35
                                        #   in Loop: Header=BB10_2 Depth=1
	ld.d	$a0, $s3, 8
	beqz	$a0, .LBB10_41
