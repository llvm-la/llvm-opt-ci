...
# %bb.32:                               #   in Loop: Header=BB4_30 Depth=2
	...
	sub.w	$a7, $zero, $a6
	.p2align	4, , 16
.LBB4_33:                               #   Parent Loop BB4_27 Depth=1
...
# %bb.34:                               #   in Loop: Header=BB4_33 Depth=3
	...
	blt	$a1, $a6, .LBB4_33
	b	.LBB4_28
.LBB4_35:                               # %rm2_contain.exit
	ld.d	$a3, $s2, 0
	st.d	$zero, $a0, 0
	move	$a1, $s2
	beqz	$a3, .LBB4_47
# %bb.36:                               # %.preheader.i33.preheader
	ori	$a2, $zero, 1
	move	$a4, $s2
	move	$a1, $s2
	b	.LBB4_39
	.p2align	4, , 16
.LBB4_37:                               # %.critedge.i38
                                        #   in Loop: Header=BB4_39 Depth=1
	addi.d	$a5, $a1, 8
	st.d	$a3, $a1, 0
	move	$a1, $a5
.LBB4_38:                               # %.loopexit.i39
                                        #   in Loop: Header=BB4_39 Depth=1
	ld.d	$a3, $a4, 0
	beqz	$a3, .LBB4_47
.LBB4_39:                               # %.preheader.i33
                                        # =>This Loop Header: Depth=1
...
# %bb.44:                               #   in Loop: Header=BB4_42 Depth=2
	...
	sub.w	$t0, $zero, $a7
	.p2align	4, , 16
.LBB4_45:                               #   Parent Loop BB4_39 Depth=1
...
# %bb.9:                                #   in Loop: Header=BB5_8 Depth=1
	...
	addi.w	$s2, $s2, 1
	bnez	$a0, .LBB5_8
.LBB5_10:                               # %._crit_edge.loopexit.i8
