...
# %bb.27:                               # %.lr.ph164.preheader
	...
	b	.LBB3_29
	.p2align	4, , 16
.LBB3_28:                               # %map_symbolic_cover.exit127
...
.LBB3_31:                               # %.lr.ph.i
	...
	alsl.d	$s6, $a0, $s6, 2
	bltu	$s6, $s8, .LBB3_31
# %bb.32:                               # %map_symbolic_cover.exit.loopexit
                                        #   in Loop: Header=BB3_29 Depth=1
	ld.d	$s5, $s3, 0
.LBB3_33:                               # %map_symbolic_cover.exit
                                        #   in Loop: Header=BB3_29 Depth=1
	ld.d	$s8, $fp, 8
	ld.w	$a0, $s8, 12
	ld.w	$a1, $s8, 0
...
.LBB3_35:                               # %.lr.ph.i121
	...
	alsl.d	$s6, $a0, $s6, 2
	bltu	$s6, $s2, .LBB3_35
# %bb.36:                               # %map_symbolic_cover.exit123.loopexit
                                        #   in Loop: Header=BB3_29 Depth=1
	ld.d	$s5, $s3, 0
.LBB3_37:                               # %map_symbolic_cover.exit123
                                        #   in Loop: Header=BB3_29 Depth=1
	ld.d	$s2, $fp, 16
	ld.w	$a0, $s2, 12
	ld.w	$a1, $s2, 0
...
.LBB3_44:
	...
	addi.d	$sp, $sp, 144
	ret
.LBB3_45:                               # %vector.main.loop.iter.check
	ori	$a5, $zero, 16
	bgeu	$a3, $a5, .LBB3_47
# %bb.46:
	move	$a6, $zero
...
.LBB7_27:                               #   Parent Loop BB7_18 Depth=1
	...
	alsl.d	$a0, $a4, $a0, 2
	bltu	$a0, $a1, .LBB7_27
# %bb.28:                               # %._crit_edge234.loopexit
                                        #   in Loop: Header=BB7_18 Depth=1
	ld.w	$s2, $s7, 12
.LBB7_29:                               # %._crit_edge234
                                        #   in Loop: Header=BB7_18 Depth=1
	move	$a0, $s4
	move	$a1, $s7
	pcaddu18i	$ra, %call36(sf_append)
...
.LBB7_45:                               #   in Loop: Header=BB7_46 Depth=3
	...
	alsl.d	$s8, $a0, $s8, 2
	bgeu	$s8, $s2, .LBB7_50
.LBB7_46:                               #   Parent Loop BB7_41 Depth=1
...
# %bb.49:                               #   in Loop: Header=BB7_46 Depth=3
	...
	b	.LBB7_45
	.p2align	4, , 16
.LBB7_50:                               # %._crit_edge251.us
                                        #   in Loop: Header=BB7_43 Depth=2
	ld.w	$s8, $s7, 12
	blez	$s8, .LBB7_42
# %bb.51:                               #   in Loop: Header=BB7_43 Depth=2
	ld.d	$fp, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a1, $fp, 0
	move	$a0, $zero
	pcaddu18i	$ra, %call36(sf_new)
...
.LBB7_53:                               #   Parent Loop BB7_41 Depth=1
	...
	alsl.d	$a0, $a4, $a0, 2
	bltu	$a0, $a1, .LBB7_53
# %bb.54:                               # %._crit_edge256.us.loopexit
                                        #   in Loop: Header=BB7_43 Depth=2
	ld.w	$s2, $s7, 12
.LBB7_55:                               # %._crit_edge256.us
                                        #   in Loop: Header=BB7_43 Depth=2
	...
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	beqz	$a0, .LBB7_57
# %bb.56:                               #   in Loop: Header=BB7_43 Depth=2
	...
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
.LBB7_57:                               #   in Loop: Header=BB7_43 Depth=2
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
	addi.w	$s6, $s6, 1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	bne	$s6, $a0, .LBB7_43
	b	.LBB7_40
.LBB7_58:                               # %._crit_edge264
