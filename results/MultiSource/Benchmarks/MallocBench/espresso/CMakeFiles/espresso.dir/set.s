...
.LBB23_26:                              # %intcpy.exit28
	...
	addi.d	$sp, $sp, 80
	ret
.LBB23_27:                              # %vector.main.loop.iter.check53
	ori	$a2, $zero, 16
	bgeu	$s2, $a2, .LBB23_29
# %bb.28:
	move	$a2, $zero
	b	.LBB23_33
.LBB23_29:                              # %vector.ph54
	slli.d	$a5, $s3, 2
...
.Lfunc_end30:
	...
	.p2align	5, 0x0                          # -- Begin function sf_print
.LCPI31_0:
	.byte	15                              # 0xf
	.byte	14                              # 0xe
	.byte	13                              # 0xd
