...
.LBB11_2:                               # %vec.epilog.scalar.ph.preheader
	move	$a4, $a5
.LBB11_3:                               # %vec.epilog.scalar.ph.preheader
	addi.d	$a3, $a4, 1
	alsl.d	$a0, $a4, $a0, 2
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
...
.LBB12_2:                               # %vec.epilog.scalar.ph.preheader
	move	$a4, $a5
.LBB12_3:                               # %vec.epilog.scalar.ph.preheader
	addi.d	$a3, $a4, 1
	alsl.d	$a0, $a4, $a0, 2
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
...
.LBB23_26:                              # %intcpy.exit28
	...
	addi.d	$sp, $sp, 80
	ret
.LBB23_27:                              # %vector.main.loop.iter.check50
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB23_29
# %bb.28:
	move	$a3, $zero
	b	.LBB23_33
.LBB23_29:                              # %vector.ph52
	slli.d	$a7, $s3, 2
...
.LBB23_30:                              # %vector.body55
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB23_30
# %bb.31:                               # %middle.block62
	beq	$a3, $s2, .LBB23_26
# %bb.32:                               # %vec.epilog.iter.check68
	andi	$a6, $s2, 12
	beqz	$a6, .LBB23_24
.LBB23_33:                              # %vec.epilog.ph70
	move	$a6, $a3
	...
	add.d	$a0, $a0, $a6
	.p2align	4, , 16
.LBB23_34:                              # %vec.epilog.vector.body73
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a0, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a0, $a0, 16
	bnez	$a5, .LBB23_34
# %bb.35:                               # %vec.epilog.middle.block79
	bne	$a3, $s2, .LBB23_24
	b	.LBB23_26
.Lfunc_end23:
...
# %bb.13:                               #   in Loop: Header=BB31_7 Depth=2
	...
	b	.LBB31_23
	.p2align	4, , 16
.LBB31_14:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB31_7 Depth=2
	slt	$a2, $s1, $a4
	masknez	$a3, $s1, $a2
	maskeqz	$a2, $a4, $a2
...
.LBB31_16:                              # %vec.epilog.ph
	...
	maskeqz	$a5, $a5, $t2
	or	$a5, $a5, $t3
	bstrpick.d	$a5, $a5, 30, 4
	slli.d	$a5, $a5, 4
	sub.d	$a5, $t0, $a5
	.p2align	4, , 16
.LBB31_17:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB31_4 Depth=1
                                        #     Parent Loop BB31_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a7, 0
...
.LBB31_19:                              # %vector.ph
	...
	maskeqz	$t4, $a5, $t4
	or	$t4, $t4, $t5
	bstrpick.d	$t4, $t4, 30, 5
	slli.d	$t4, $t4, 5
	.p2align	4, , 16
.LBB31_20:                              # %vector.body
                                        #   Parent Loop BB31_4 Depth=1
                                        #     Parent Loop BB31_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $t3, 0
...
.LBB31_23:                              # %.preheader.i
	...
	addi.d	$a2, $a2, 1
	blt	$s1, $a4, .LBB31_23
.LBB31_24:                              # %.loopexit.loopexit
                                        #   in Loop: Header=BB31_7 Depth=2
	addi.d	$a3, $a2, -1
	bge	$a3, $s7, .LBB31_2
# %bb.25:                               #   in Loop: Header=BB31_7 Depth=2
	move	$a3, $zero
	b	.LBB31_6
.LBB31_26:                              # %._crit_edge
...
# %bb.9:                                #   in Loop: Header=BB37_3 Depth=1
	...
	b	.LBB37_19
	.p2align	4, , 16
.LBB37_10:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB37_3 Depth=1
	slt	$t6, $a5, $t8
	masknez	$t7, $a5, $t6
	maskeqz	$t6, $t8, $t6
...
.LBB46_16:                              # =>This Loop Header: Depth=1
	...
	bstrpick.d	$a7, $a3, 31, 5
	slli.d	$a7, $a7, 2
	bstrpick.d	$a7, $a7, 60, 2
	alsl.d	$a7, $a7, $s0, 2
	ld.w	$t0, $a7, 4
	sll.w	$a7, $a5, $a3
	and	$t0, $t0, $a7
...
# %bb.1:
	ld.d	$s6, $s0, 32
	st.d	$s6, $s4, %pc_lo12(set_family_garbage)
	b	.LBB47_3
.LBB47_2:
	ori	$a0, $zero, 40
	pcaddu18i	$ra, %call36(malloc)
...
.LBB47_16:                              # %sf_free.exit
	st.d	$s6, $fp, 32
	st.d	$fp, $s4, %pc_lo12(set_family_garbage)
	move	$a0, $s0
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 40                    # 8-byte Folded Reload
