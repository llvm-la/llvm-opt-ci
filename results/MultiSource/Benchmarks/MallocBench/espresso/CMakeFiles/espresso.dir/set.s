...
.LBB23_17:
	move	$a3, $zero
	move	$a2, $a4
.LBB23_18:                              # %.lr.ph.i22.preheader56
	sub.d	$a0, $s2, $a3
	.p2align	4, , 16
.LBB23_19:                              # %.lr.ph.i22
                                        # =>This Inner Loop Header: Depth=1
...
.LBB31_16:                              # %vector.ph
	...
	maskeqz	$t4, $a5, $t4
	or	$t4, $t4, $t5
	bstrpick.d	$t4, $t4, 30, 4
	slli.d	$t4, $t4, 4
	.p2align	4, , 16
.LBB31_17:                              # %vector.body
                                        #   Parent Loop BB31_4 Depth=1
                                        #     Parent Loop BB31_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t3, 0
...
.LBB31_20:                              # %vec.epilog.ph
	...
	maskeqz	$a5, $a5, $t2
	or	$a5, $a5, $t3
	bstrpick.d	$a5, $a5, 30, 2
	slli.d	$a5, $a5, 2
	sub.d	$a5, $t0, $a5
	.p2align	4, , 16
.LBB31_21:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB31_4 Depth=1
                                        #     Parent Loop BB31_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t0, $a7, 0
...
.LBB37_12:                              # %vector.ph
	...
	maskeqz	$s6, $fp, $s6
	or	$s6, $s6, $s7
	bstrpick.d	$s6, $s6, 30, 4
	slli.d	$s6, $s6, 4
	.p2align	4, , 16
.LBB37_13:                              # %vector.body
...
# %bb.15:                               # %vec.epilog.iter.check
                                        #   in Loop: Header=BB37_3 Depth=1
	beqz	$s3, .LBB37_19
.LBB37_16:                              # %vec.epilog.ph
                                        #   in Loop: Header=BB37_3 Depth=1
	bstrpick.d	$t6, $s0, 30, 2
	slli.d	$s3, $t6, 2
	alsl.d	$t6, $t6, $s1, 2
	sub.d	$t7, $t8, $s3
	add.d	$t8, $s2, $s1
	...
	maskeqz	$fp, $fp, $s4
	or	$fp, $fp, $s5
	bstrpick.d	$fp, $fp, 30, 2
	slli.d	$fp, $fp, 2
	sub.d	$fp, $s2, $fp
	.p2align	4, , 16
.LBB37_17:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB37_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$s2, $s1, 0
