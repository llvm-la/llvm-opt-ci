...
# %bb.11:                               # %vector.ph
	...
	b	.LBB5_13
	.p2align	4, , 16
.LBB5_12:                               # %pred.store.continue157
...
# %bb.14:                               # %pred.store.if
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, -12, 0
	vpickve2gr.h	$t0, $vr2, 1
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_22
.LBB5_15:                               # %pred.store.continue145
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.h	$t0, $vr2, 2
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_23
.LBB5_16:                               # %pred.store.if146
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, -4, 2
	vpickve2gr.h	$t0, $vr2, 3
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_24
.LBB5_17:                               # %pred.store.continue149
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.h	$t0, $vr2, 4
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_25
.LBB5_18:                               # %pred.store.if150
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, 4, 4
	vpickve2gr.h	$t0, $vr2, 5
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_26
.LBB5_19:                               # %pred.store.continue153
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.h	$t0, $vr2, 6
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_27
.LBB5_20:                               # %pred.store.if154
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, 12, 6
...
.LBB5_21:                               # %pred.store.continue
	...
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_15
.LBB5_22:                               # %pred.store.if144
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, -8, 1
	vpickve2gr.h	$t0, $vr2, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_16
.LBB5_23:                               # %pred.store.continue147
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.h	$t0, $vr2, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_17
.LBB5_24:                               # %pred.store.if148
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, 0, 3
	vpickve2gr.h	$t0, $vr2, 4
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_18
.LBB5_25:                               # %pred.store.continue151
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.h	$t0, $vr2, 5
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_19
.LBB5_26:                               # %pred.store.if152
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, 8, 5
	vpickve2gr.h	$t0, $vr2, 6
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_20
.LBB5_27:                               # %pred.store.continue155
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.h	$t0, $vr2, 7
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_12
.LBB5_28:                               # %pred.store.if156
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr3, $a6, 16, 7
	b	.LBB5_12
...
.LBB5_33:                               # =>This Loop Header: Depth=1
	...
	ldx.d	$t6, $a1, $a7
	blt	$t5, $t7, .LBB5_40
# %bb.34:                               # %.lr.ph90.preheader
                                        #   in Loop: Header=BB5_33 Depth=1
	move	$s3, $zero
	sub.d	$t8, $zero, $t5
.LBB5_35:                               # %.lr.ph90.outer
...
# %bb.49:                               #   in Loop: Header=BB5_33 Depth=1
	move	$a7, $zero
	b	.LBB5_54
.LBB5_50:                               # %vector.ph185
                                        #   in Loop: Header=BB5_33 Depth=1
	andi	$s5, $t8, 12
	bstrpick.d	$t0, $t8, 32, 4
	slli.d	$a7, $t0, 4
	alsl.d	$t7, $t0, $s3, 4
	addi.d	$s6, $s4, 32
	addi.d	$t0, $s1, 32
