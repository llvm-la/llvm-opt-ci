...
# %bb.11:                               # %vector.ph
	...
	b	.LBB5_13
	.p2align	4, , 16
.LBB5_12:                               # %pred.store.continue149
...
.LBB5_17:                               # %pred.store.continue
	...
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_15
.LBB5_18:                               # %pred.store.if144
                                        #   in Loop: Header=BB5_13 Depth=1
	vstelm.w	$vr3, $a6, 0, 1
	vpickve2gr.w	$t0, $vr2, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_16
.LBB5_19:                               # %pred.store.continue147
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.w	$t0, $vr2, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_12
.LBB5_20:                               # %pred.store.if148
                                        #   in Loop: Header=BB5_13 Depth=1
	vstelm.w	$vr3, $a6, 8, 3
	b	.LBB5_12
...
.LBB5_25:                               # =>This Loop Header: Depth=1
	...
	ldx.d	$t5, $a1, $t5
	blt	$t4, $t6, .LBB5_32
# %bb.26:                               # %.lr.ph90.preheader
                                        #   in Loop: Header=BB5_25 Depth=1
	move	$t8, $zero
	sub.d	$t7, $zero, $t4
.LBB5_27:                               # %.lr.ph90.outer
...
.LBB5_31:                               # %._crit_edge
	...
	andi	$a7, $t8, 1
	bnez	$a7, .LBB5_24
.LBB5_32:                               # %._crit_edge.thread
                                        #   in Loop: Header=BB5_25 Depth=1
	alsl.d	$a7, $a0, $a3, 2
	ld.w	$s4, $a7, 0
	blt	$t4, $s4, .LBB5_24
# %bb.33:                               # %.lr.ph94.preheader
                                        #   in Loop: Header=BB5_25 Depth=1
	sub.d	$t8, $t4, $s4
	addi.w	$t6, $t8, 0
	bgeu	$t6, $t2, .LBB5_37
...
.LBB5_41:                               # %vector.body179
	...
	addi.d	$s4, $s4, 32
	bnez	$s7, .LBB5_41
# %bb.42:                               # %middle.block190
                                        #   in Loop: Header=BB5_25 Depth=1
	beq	$t7, $t8, .LBB5_24
	b	.LBB5_35
.LBB5_43:                               # %._crit_edge98
