...
# %bb.10:
	...
	st.d	$s0, $s3, 32
	st.d	$zero, $s0, 40
.LBB5_11:                               # %._crit_edge.thread
	addi.d	$a0, $a1, 1
.LBB5_12:                               # %._crit_edge.thread
	st.w	$a0, $s3, 48
	ld.d	$a0, $s3, 16
	slli.d	$a1, $s2, 3
	ldx.d	$s1, $a0, $a1
...
# %bb.18:
	...
	st.d	$s1, $s3, 56
	st.d	$zero, $s1, 40
.LBB5_19:                               # %._crit_edge278.thread
	addi.d	$a0, $a1, 1
.LBB5_20:                               # %._crit_edge278.thread
	st.w	$a0, $s3, 72
.LBB5_21:                               # %._crit_edge278.thread
	ori	$a0, $zero, 48
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $s0, 24
...
# %bb.31:
	...
	st.d	$a0, $s1, 16
	st.d	$zero, $a0, 16
.LBB5_32:                               # %._crit_edge288.thread
	addi.d	$a1, $a2, 1
	b	.LBB5_54
.LBB5_33:                               # %.preheader268
	bge	$a1, $s2, .LBB5_41
	.p2align	4, , 16
.LBB5_34:                               # %.lr.ph282
                                        # =>This Inner Loop Header: Depth=1
...
.LBB5_53:
	...
	st.w	$fp, $a0, 0
	addi.d	$a1, $a1, 1
.LBB5_54:                               # %._crit_edge288.thread
	st.w	$a1, $s1, 4
.LBB5_55:                               # %._crit_edge288.thread
