...
.LBB8_14:                               # %vector.body166
	...
	addi.d	$a5, $a5, -32
	bnez	$a6, .LBB8_14
# %bb.15:                               # %middle.block174
                                        #   in Loop: Header=BB8_10 Depth=1
	beq	$a0, $a2, .LBB8_18
.LBB8_16:                               # %scalar.ph161.preheader
                                        #   in Loop: Header=BB8_10 Depth=1
	addi.d	$a0, $a1, 1
	alsl.d	$a2, $a1, $s6, 2
	alsl.d	$a3, $a1, $s3, 2
...
# %bb.23:                               # %middle.block153
	...
	beq	$a0, $a2, .LBB8_26
	.p2align	4, , 16
.LBB8_24:                               # %scalar.ph140.preheader
                                        #   in Loop: Header=BB8_10 Depth=1
	addi.d	$a0, $a1, 1
	slli.d	$a2, $a1, 2
	alsl.d	$a1, $a1, $s6, 2
...
.LBB8_29:                               # %vector.body117
	...
	addi.d	$a5, $a5, -32
	bnez	$a6, .LBB8_29
# %bb.30:                               # %middle.block125
                                        #   in Loop: Header=BB8_10 Depth=1
	beq	$a0, $a2, .LBB8_33
.LBB8_31:                               # %scalar.ph112.preheader
                                        #   in Loop: Header=BB8_10 Depth=1
	addi.d	$a0, $a1, 1
	alsl.d	$a2, $a1, $s6, 2
	alsl.d	$a3, $a1, $s3, 2
