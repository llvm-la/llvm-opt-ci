...
.LBB3_18:                               #   in Loop: Header=BB3_15 Depth=1
	move	$a0, $a6
.LBB3_19:                               # %scalar.ph126.preheader
                                        #   in Loop: Header=BB3_15 Depth=1
	addi.d	$a1, $a0, 1
	alsl.d	$a2, $a0, $s2, 2
	alsl.d	$a3, $a0, $s6, 2
...
# %bb.28:                               # %middle.block
	bne	$a0, $a2, .LBB3_5
	b	.LBB3_7
.LBB3_29:                               # %vector.memcheck98
	sub.d	$a2, $s4, $s6
	ori	$a1, $zero, 32
	bltu	$a2, $a1, .LBB3_8
# %bb.30:                               # %vector.memcheck98
	sub.d	$a2, $s1, $s6
	bltu	$a2, $a1, .LBB3_8
# %bb.31:                               # %vector.ph105
	move	$a2, $a0
...
.LBB3_38:
	move	$a1, $a3
.LBB3_39:                               # %scalar.ph149.preheader
	addi.d	$a0, $a1, 1
	alsl.d	$a2, $a1, $s2, 2
	alsl.d	$a3, $a1, $s1, 2
	alsl.d	$a1, $a1, $s4, 2
...
.LBB3_44:
	...
	addi.d	$sp, $sp, 112
	ret
.LBB3_45:                               # %vector.memcheck144
	sub.d	$a2, $s4, $s2
	ori	$a1, $zero, 32
	bltu	$a2, $a1, .LBB3_38
# %bb.46:                               # %vector.memcheck144
	sub.d	$a2, $s1, $s2
	bltu	$a2, $a1, .LBB3_38
# %bb.47:                               # %vector.ph151
	move	$a2, $a0
