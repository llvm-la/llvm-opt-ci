...
.LBB7_29:                               # %._crit_edge147.split.us
                                        #   in Loop: Header=BB7_16 Depth=1
...
# %bb.6:                                # %.lr.ph78
	...
	alsl.d	$s6, $a3, $s4, 2
	bge	$a1, $a0, .LBB9_21
# %bb.7:                                # %.lr.ph78.split.preheader
	move	$s7, $zero
	ori	$s8, $zero, 2
.LBB9_8:                                # %.lr.ph78.split
                                        # =>This Loop Header: Depth=1
...
# %bb.14:                               #   in Loop: Header=BB9_8 Depth=1
	...
	alsl.d	$s4, $a1, $s4, 2
	bltu	$s4, $s6, .LBB9_8
# %bb.15:                               # %._crit_edge79.loopexit
	ld.w	$a1, $s5, 8
.LBB9_16:                               # %._crit_edge79
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 16                    # 8-byte Folded Reload
.LBB9_17:                               # %._crit_edge79
	move	$a0, $s3
...
# %bb.20:
	...
	jr	$t8
.LBB9_21:                               # %.lr.ph78.split.us.preheader
	slli.d	$a0, $a2, 2
	ori	$a2, $zero, 500
	.p2align	4, , 16
...
# %bb.14:                               # %middle.block105
	...
	beq	$t1, $t3, .LBB10_17
	.p2align	4, , 16
.LBB10_15:                              # %scalar.ph92.preheader
                                        #   in Loop: Header=BB10_9 Depth=1
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a0, 2
	alsl.d	$t2, $t2, $s0, 2
	.p2align	4, , 16
.LBB10_16:                              # %scalar.ph92
                                        #   Parent Loop BB10_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t4, $t2, 0
	ld.w	$t5, $t3, 0
