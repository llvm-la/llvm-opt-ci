...
.LBB6_13:                               #   in Loop: Header=BB6_8 Depth=1
	move	$a1, $a5
.LBB6_14:                               # %scalar.ph186.preheader
                                        #   in Loop: Header=BB6_8 Depth=1
	addi.d	$a2, $a1, 1
	alsl.d	$a3, $a1, $s0, 2
	alsl.d	$a0, $a1, $a0, 2
	.p2align	4, , 16
.LBB6_15:                               # %scalar.ph186
                                        #   Parent Loop BB6_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a1, $a0, 0
	st.w	$a1, $a3, 0
...
.LBB6_24:                               # %.lr.ph
	...
	addi.d	$a2, $a2, 1
	bltu	$a2, $s4, .LBB6_30
# %bb.25:                               # %vector.memcheck157
                                        #   in Loop: Header=BB6_24 Depth=2
	alsl.d	$a5, $a4, $s0, 2
	alsl.d	$a6, $a3, $a1, 2
	addi.d	$a7, $a6, 4
	bgeu	$a5, $a7, .LBB6_27
# %bb.26:                               # %vector.memcheck157
                                        #   in Loop: Header=BB6_24 Depth=2
	alsl.d	$a5, $a3, $s6, 2
	alsl.d	$a4, $a4, $a1, 2
	bltu	$a4, $a5, .LBB6_30
.LBB6_27:                               # %vector.ph171
                                        #   in Loop: Header=BB6_24 Depth=2
	move	$a4, $a2
...
.LBB6_28:                               # %vector.body174
	...
	addi.d	$a3, $a3, -32
	bnez	$a7, .LBB6_28
# %bb.29:                               # %middle.block182
                                        #   in Loop: Header=BB6_24 Depth=2
	move	$a3, $a5
	beq	$a2, $a4, .LBB6_23
	.p2align	4, , 16
.LBB6_30:                               # %scalar.ph169.preheader
                                        #   in Loop: Header=BB6_24 Depth=2
	addi.d	$a2, $a3, 1
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB6_31:                               # %scalar.ph169
                                        #   Parent Loop BB6_8 Depth=1
                                        #     Parent Loop BB6_24 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a4, $a3, 0
...
.Lfunc_end6:
	.size	taut_special_cases, .Lfunc_end6-taut_special_cases
                                        # -- End function
	.p2align	2                               # -- Begin function ftautology
