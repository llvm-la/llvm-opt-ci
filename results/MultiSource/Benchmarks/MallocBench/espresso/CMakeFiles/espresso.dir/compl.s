...
.LBB0_29:
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_30:                               # %compl_special_cases.exit.thread
	ld.bu	$a0, $s4, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_32
# %bb.31:
...
.LBB0_39:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_30
.LBB0_40:                               # %compl_special_cases.exit
	ld.w	$a1, $s2, 0
	ori	$s0, $zero, 8
	ori	$s5, $zero, 33
	lu12i.w	$s3, 131071
...
.LBB1_26:
	...
	st.d	$a0, $fp, 0
	beqz	$a1, .LBB1_28
.LBB1_27:                               # %simp_comp_special_cases.exit.thread.sink.split.sink.split
	move	$a0, $a1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_28:                               # %simp_comp_special_cases.exit.thread.sink.split
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_29:                               # %simp_comp_special_cases.exit.thread
	ld.bu	$a0, $s5, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB1_31
# %bb.30:
...
.LBB1_39:                               # %.lr.ph53
	...
	addi.d	$a7, $a7, 1
	bltu	$a7, $a5, .LBB1_45
# %bb.40:                               # %vector.memcheck85
                                        #   in Loop: Header=BB1_39 Depth=1
	alsl.d	$t2, $t1, $a1, 2
	alsl.d	$t4, $t0, $a3, 2
	alsl.d	$t3, $t0, $a1, 2
	bgeu	$t2, $t4, .LBB1_42
# %bb.41:                               # %vector.memcheck85
                                        #   in Loop: Header=BB1_39 Depth=1
	addi.d	$t2, $t3, 4
	alsl.d	$t1, $t1, $s2, 2
	bltu	$t1, $t2, .LBB1_45
...
# %bb.49:
	...
	jirl	$ra, $ra, 0
	b	.LBB1_60
.LBB1_50:                               # %simp_comp_special_cases.exit
	ld.w	$a1, $s4, 0
	ori	$s3, $zero, 8
	ori	$s7, $zero, 33
	lu12i.w	$s6, 131071
...
.LBB2_26:
	...
	move	$s1, $a0
	beqz	$a1, .LBB2_28
.LBB2_27:                               # %simplify_special_cases.exit.thread.sink.split.sink.split
	move	$a0, $a1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB2_28:                               # %simplify_special_cases.exit.thread.sink.split
	move	$a0, $fp
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB2_29:                               # %simplify_special_cases.exit.thread
	ld.bu	$a0, $s4, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB2_31
# %bb.30:
...
.LBB2_39:                               # %.lr.ph43
	...
	addi.d	$a6, $a6, 1
	bltu	$a6, $a4, .LBB2_45
# %bb.40:                               # %vector.memcheck77
                                        #   in Loop: Header=BB2_39 Depth=1
	alsl.d	$t1, $t0, $a0, 2
	alsl.d	$t3, $a7, $a2, 2
	alsl.d	$t2, $a7, $a0, 2
	bgeu	$t1, $t3, .LBB2_42
# %bb.41:                               # %vector.memcheck77
                                        #   in Loop: Header=BB2_39 Depth=1
	addi.d	$t1, $t2, 4
	alsl.d	$t0, $t0, $s0, 2
	bltu	$t0, $t1, .LBB2_45
...
.LBB2_43:                               # %vector.body94
	...
	addi.d	$t2, $t2, -32
	bnez	$t3, .LBB2_43
# %bb.44:                               # %middle.block102
                                        #   in Loop: Header=BB2_39 Depth=1
	move	$a7, $t1
	beq	$a6, $t0, .LBB2_38
	.p2align	4, , 16
.LBB2_45:                               # %scalar.ph89.preheader
                                        #   in Loop: Header=BB2_39 Depth=1
	addi.d	$a6, $a7, 1
	alsl.d	$t0, $a7, $a0, 2
	alsl.d	$a7, $a7, $s0, 2
...
.LBB2_49:
	move	$fp, $s0
	b	.LBB2_28
.LBB2_50:                               # %simplify_special_cases.exit
	ld.w	$a1, $s2, 0
	ori	$s1, $zero, 8
	ori	$s5, $zero, 33
	lu12i.w	$s3, 131071
...
.Lfunc_end2:
	.size	simplify, .Lfunc_end2-simplify
                                        # -- End function
	.p2align	2                               # -- Begin function compl_cube
...
.Lfunc_end3:
	.size	compl_cube, .Lfunc_end3-compl_cube
                                        # -- End function
	.p2align	2                               # -- Begin function compl_merge
...
.LBB4_16:                               # %.lr.ph167
	...
	addi.d	$a7, $a7, 1
	bltu	$a7, $a5, .LBB4_22
# %bb.17:                               # %vector.memcheck214
                                        #   in Loop: Header=BB4_16 Depth=1
	alsl.d	$t2, $t1, $a1, 2
	alsl.d	$t4, $t0, $a3, 2
	alsl.d	$t3, $t0, $a1, 2
	bgeu	$t2, $t4, .LBB4_19
# %bb.18:                               # %vector.memcheck214
                                        #   in Loop: Header=BB4_16 Depth=1
	addi.d	$t2, $t3, 4
	alsl.d	$t1, $t1, $s2, 2
	bltu	$t1, $t2, .LBB4_22
.LBB4_19:                               # %vector.ph228
                                        #   in Loop: Header=BB4_16 Depth=1
	move	$t1, $a7
	bstrins.d	$t1, $zero, 2, 0
	sub.d	$t2, $t0, $t1
...
.LBB4_20:                               # %vector.body231
	...
	addi.d	$t3, $t3, -32
	bnez	$t4, .LBB4_20
# %bb.21:                               # %middle.block239
                                        #   in Loop: Header=BB4_16 Depth=1
	move	$t0, $t2
	beq	$a7, $t1, .LBB4_15
	.p2align	4, , 16
.LBB4_22:                               # %scalar.ph226.preheader
                                        #   in Loop: Header=BB4_16 Depth=1
	addi.d	$a7, $t0, 1
	alsl.d	$t1, $t0, $s2, 2
	alsl.d	$t0, $t0, $a1, 2
	.p2align	4, , 16
.LBB4_23:                               # %scalar.ph226
                                        #   Parent Loop BB4_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t2, $t0, 0
	ld.w	$t3, $t1, 0
...
# %bb.31:                               # %vector.memcheck242
	...
	alsl.d	$a4, $a0, $s7, 2
	bgeu	$a5, $a6, .LBB4_33
# %bb.32:                               # %vector.memcheck242
                                        #   in Loop: Header=BB4_27 Depth=1
	addi.d	$a5, $a4, 4
	alsl.d	$a2, $a2, $s5, 2
	bltu	$a2, $a5, .LBB4_36
.LBB4_33:                               # %vector.ph256
                                        #   in Loop: Header=BB4_27 Depth=1
	move	$a2, $a1
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a0, $a0, $a2
...
.LBB4_34:                               # %vector.body259
	...
	addi.d	$a4, $a4, -32
	bnez	$a5, .LBB4_34
# %bb.35:                               # %middle.block267
                                        #   in Loop: Header=BB4_27 Depth=1
	beq	$a1, $a2, .LBB4_38
	.p2align	4, , 16
.LBB4_36:                               # %scalar.ph254.preheader
                                        #   in Loop: Header=BB4_27 Depth=1
	addi.d	$a1, $a0, 1
	alsl.d	$a2, $a0, $s5, 2
	alsl.d	$a0, $a0, $s7, 2
	.p2align	4, , 16
.LBB4_37:                               # %scalar.ph254
                                        #   Parent Loop BB4_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a0, 0
	ld.w	$a4, $a2, 0
...
# %bb.56:                               # %vector.memcheck270
	...
	alsl.d	$a4, $a1, $s4, 2
	bgeu	$a3, $a5, .LBB4_58
# %bb.57:                               # %vector.memcheck270
                                        #   in Loop: Header=BB4_47 Depth=1
	addi.d	$a3, $a4, 4
	alsl.d	$a2, $a2, $s7, 2
	bltu	$a2, $a3, .LBB4_61
.LBB4_58:                               # %vector.ph284
                                        #   in Loop: Header=BB4_47 Depth=1
	move	$a2, $a0
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a3, $a1, $a2
...
.LBB4_59:                               # %vector.body287
	...
	addi.d	$a4, $a4, -32
	bnez	$a5, .LBB4_59
# %bb.60:                               # %middle.block295
                                        #   in Loop: Header=BB4_47 Depth=1
	move	$a1, $a3
	beq	$a0, $a2, .LBB4_46
	.p2align	4, , 16
.LBB4_61:                               # %scalar.ph282.preheader
                                        #   in Loop: Header=BB4_47 Depth=1
	addi.d	$a0, $a1, 1
	alsl.d	$a2, $a1, $s7, 2
	alsl.d	$a1, $a1, $s4, 2
	.p2align	4, , 16
.LBB4_62:                               # %scalar.ph282
                                        #   Parent Loop BB4_47 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a1, 0
	ld.w	$a4, $a2, 0
...
# %bb.75:                               # %vector.memcheck298
	...
	alsl.d	$a4, $a1, $s4, 2
	bgeu	$a3, $a5, .LBB4_77
# %bb.76:                               # %vector.memcheck298
                                        #   in Loop: Header=BB4_66 Depth=1
	addi.d	$a3, $a4, 4
	alsl.d	$a2, $a2, $s5, 2
	bltu	$a2, $a3, .LBB4_80
.LBB4_77:                               # %vector.ph312
                                        #   in Loop: Header=BB4_66 Depth=1
	move	$a2, $a0
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a3, $a1, $a2
...
.LBB4_78:                               # %vector.body315
	...
	addi.d	$a4, $a4, -32
	bnez	$a5, .LBB4_78
# %bb.79:                               # %middle.block323
                                        #   in Loop: Header=BB4_66 Depth=1
	move	$a1, $a3
	beq	$a0, $a2, .LBB4_65
	.p2align	4, , 16
.LBB4_80:                               # %scalar.ph310.preheader
                                        #   in Loop: Header=BB4_66 Depth=1
	addi.d	$a0, $a1, 1
	alsl.d	$a2, $a1, $s5, 2
	alsl.d	$a1, $a1, $s4, 2
	.p2align	4, , 16
.LBB4_81:                               # %scalar.ph310
                                        #   Parent Loop BB4_66 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a1, 0
	ld.w	$a4, $a2, 0
...
.LBB4_90:                               #   in Loop: Header=BB4_85 Depth=1
	move	$a5, $t1
.LBB4_91:                               # %scalar.ph329.preheader
                                        #   in Loop: Header=BB4_85 Depth=1
	addi.d	$a6, $a5, 1
	alsl.d	$a7, $a5, $a0, 2
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB4_92:                               # %scalar.ph329
                                        #   Parent Loop BB4_85 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t0, $a5, 0
	st.w	$t0, $a7, 0
...
.LBB4_103:                              #   in Loop: Header=BB4_97 Depth=1
	move	$a5, $t1
.LBB4_104:                              # %scalar.ph347.preheader
                                        #   in Loop: Header=BB4_97 Depth=1
	addi.d	$a6, $a5, 1
	alsl.d	$a7, $a5, $a0, 2
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB4_105:                              # %scalar.ph347
                                        #   Parent Loop BB4_97 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t0, $a5, 0
	st.w	$t0, $a7, 0
...
.Lfunc_end4:
	.size	compl_merge, .Lfunc_end4-compl_merge
                                        # -- End function
	.p2align	2                               # -- Begin function compl_lift_onset
...
.LBB5_12:                               # %.loopexit106
	...
	ori	$a3, $zero, 8
	bltu	$a0, $a3, .LBB5_18
# %bb.13:                               # %vector.memcheck61
                                        #   in Loop: Header=BB5_4 Depth=1
	alsl.d	$a3, $a2, $s2, 2
	alsl.d	$a4, $a1, $s4, 2
	addi.d	$a5, $a4, 4
	bgeu	$a3, $a5, .LBB5_15
# %bb.14:                               # %vector.memcheck61
                                        #   in Loop: Header=BB5_4 Depth=1
	addi.d	$a3, $s2, 4
	alsl.d	$a3, $a1, $a3, 2
	alsl.d	$a2, $a2, $s4, 2
...
.LBB5_16:                               # %vector.body73
	...
	addi.d	$a4, $a4, -32
	bnez	$a5, .LBB5_16
# %bb.17:                               # %middle.block81
                                        #   in Loop: Header=BB5_4 Depth=1
	move	$a1, $a3
	beq	$a0, $a2, .LBB5_20
	.p2align	4, , 16
.LBB5_18:                               # %scalar.ph68.preheader
                                        #   in Loop: Header=BB5_4 Depth=1
	addi.d	$a0, $a1, 1
	alsl.d	$a2, $a1, $s2, 2
	alsl.d	$a1, $a1, $s4, 2
