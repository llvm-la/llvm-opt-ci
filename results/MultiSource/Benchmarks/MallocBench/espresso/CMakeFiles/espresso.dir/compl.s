...
.LBB0_23:
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_24:                               # %compl_special_cases.exit.thread
	ld.bu	$a0, $s4, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_26
# %bb.25:
...
.LBB0_33:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_24
.LBB0_34:                               # %compl_special_cases.exit
	ld.w	$a1, $s2, 0
	ori	$s0, $zero, 8
	ori	$s5, $zero, 33
	lu12i.w	$s3, 131071
...
.LBB1_20:
	...
	st.d	$a0, $fp, 0
	beqz	$a1, .LBB1_22
.LBB1_21:                               # %simp_comp_special_cases.exit.thread.sink.split.sink.split
	move	$a0, $a1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_22:                               # %simp_comp_special_cases.exit.thread.sink.split
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_23:                               # %simp_comp_special_cases.exit.thread
	ld.bu	$a0, $s5, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB1_25
# %bb.24:
...
# %bb.37:
	...
	jirl	$ra, $ra, 0
	b	.LBB1_48
.LBB1_38:                               # %simp_comp_special_cases.exit
	ld.w	$a1, $s4, 0
	ori	$s3, $zero, 8
	ori	$s7, $zero, 33
	lu12i.w	$s6, 131071
...
.LBB2_20:
	...
	move	$s0, $a0
	beqz	$a1, .LBB2_22
.LBB2_21:                               # %simplify_special_cases.exit.thread.sink.split.sink.split
	move	$a0, $a1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB2_22:                               # %simplify_special_cases.exit.thread.sink.split
	move	$a0, $fp
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB2_23:                               # %simplify_special_cases.exit.thread
	ld.bu	$a0, $s4, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB2_25
# %bb.24:
...
# %bb.37:
	...
	bnez	$a1, .LBB2_21
	b	.LBB2_22
.LBB2_38:                               # %simplify_special_cases.exit
	ld.w	$a1, $s2, 0
	ori	$s0, $zero, 8
	ori	$s5, $zero, 33
	lu12i.w	$s3, 131071
