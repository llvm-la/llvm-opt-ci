...
.LBB0_29:                               # %._crit_edge
	...
	jirl	$ra, $ra, 0
.LBB0_30:                               # %.preheader185._crit_edge
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s0, 0
	...
	pcaddu18i	$ra, %call36(exit)
	jirl	$ra, $ra, 0
.LBB0_31:                               # %.preheader184._crit_edge
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s7, 0
	...
	pcaddu18i	$ra, %call36(exit)
	jirl	$ra, $ra, 0
.LBB0_32:                               # %.preheader186._crit_edge
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s0, 0
...
.LBB0_140:                              # %.loopexit
	...
	beqz	$a0, .LBB0_147
	b	.LBB0_137
.LBB0_141:                              # %.preheader182
	pcalau12i	$a0, %got_pc_hi20(cube)
	ld.d	$fp, $a0, %got_pc_lo12(cube)
	ld.w	$a0, $fp, 8
	blez	$a0, .LBB0_146
# %bb.142:                              # %.lr.ph223.preheader
	move	$s0, $zero
	.p2align	4, , 16
.LBB0_143:                              # %.lr.ph223
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.8:                                #   in Loop: Header=BB6_7 Depth=1
	...
	addi.d	$s1, $s1, 1
	bnez	$a1, .LBB6_7
.LBB6_9:                                # %delete_arg.exit81.thread
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s5, -32
...
.LBB6_24:                               # %.lr.ph.i77
	...
	addi.d	$a1, $a1, 8
	bnez	$a2, .LBB6_24
.LBB6_25:                               # %delete_arg.exit81
	ld.d	$a1, $s6, 0
	beqz	$a1, .LBB6_9
# %bb.26:                               # %delete_arg.exit81..loopexit149_crit_edge
	addi.w	$s6, $a0, -3
	ori	$a0, $zero, 3
	blt	$s3, $a0, .LBB6_51
.LBB6_27:                               # %.lr.ph170.preheader
...
# %bb.33:                               #   in Loop: Header=BB6_32 Depth=1
	...
	addi.d	$s5, $s5, 16
	bnez	$a0, .LBB6_32
.LBB6_34:                               # %delete_arg.exit95.thread
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s2, 0
...
.LBB6_42:                               # %.lr.ph.i84
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB6_42
.LBB6_43:                               # %delete_arg.exit88
	addi.w	$s3, $a0, -2
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	st.w	$s3, $a0, 0
	bge	$s0, $s3, .LBB6_50
# %bb.44:                               # %.lr.ph.preheader.i89
...
.LBB6_49:                               # %.lr.ph.i91
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB6_49
.LBB6_50:                               # %delete_arg.exit95
	ld.d	$a0, $s5, -8
	beqz	$a0, .LBB6_34
.LBB6_51:                               # %.loopexit147
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB6_106
# %bb.52:                               # %.lr.ph179.preheader
	addi.d	$s4, $fp, 40
	addi.d	$a0, $fp, 8
	st.d	$a0, $sp, 40                    # 8-byte Folded Spill
	ori	$s6, $zero, 1
...
# %bb.58:                               # %.lr.ph176
	...
	addi.d	$s0, $s5, 16
	.p2align	4, , 16
.LBB6_59:                               #   Parent Loop BB6_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s1
	pcaddu18i	$ra, %call36(strcmp)
	jirl	$ra, $ra, 0
...
# %bb.60:                               #   in Loop: Header=BB6_59 Depth=2
	...
	bnez	$a1, .LBB6_59
	b	.LBB6_54
.LBB6_61:                               #   in Loop: Header=BB6_56 Depth=1
	addi.w	$a0, $s3, -1
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	st.w	$a0, $a1, 0
	bge	$s6, $a0, .LBB6_53
# %bb.62:                               # %.lr.ph.i98.preheader
                                        #   in Loop: Header=BB6_56 Depth=1
	add.d	$a2, $fp, $a0
	move	$a1, $s6
	ori	$a3, $zero, 8
...
.LBB6_64:                               # %vector.body327
	...
	addi.d	$a5, $a5, 64
	bnez	$a4, .LBB6_64
# %bb.65:                               # %middle.block332
                                        #   in Loop: Header=BB6_56 Depth=1
	beq	$a2, $a3, .LBB6_53
.LBB6_66:                               # %.lr.ph.i98.preheader386
                                        #   in Loop: Header=BB6_56 Depth=1
...
.LBB6_79:                               # %.lr.ph.i.i
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB6_79
.LBB6_80:                               # %check_arg.exit
	pcalau12i	$a0, %pc_hi20(input_type)
	ori	$a1, $zero, 7
	st.w	$a1, $a0, %pc_lo12(input_type)
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB6_106
.LBB6_81:                               # %.lr.ph.preheader.i110
	addi.d	$s6, $s3, -1
	bstrpick.d	$s5, $s6, 31, 0
	addi.d	$s4, $s5, -1
	addi.d	$s2, $fp, 48
...
.LBB6_82:                               # %.lr.ph.i112
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB6_85
# %bb.83:                               #   in Loop: Header=BB6_82 Depth=1
	addi.d	$s0, $s0, 1
	addi.d	$s4, $s4, -1
	addi.d	$s2, $s2, 8
	addi.w	$s7, $s7, 1
	bne	$s3, $s0, .LBB6_82
# %bb.84:                               # %check_arg.exit122.thread
	ori	$a0, $zero, 2
	bge	$s3, $a0, .LBB6_93
	b	.LBB6_106
.LBB6_85:
...
.LBB6_91:                               # %.lr.ph.i.i118
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB6_91
.LBB6_92:                               # %check_arg.exit122
	pcalau12i	$a0, %pc_hi20(input_type)
	ori	$a1, $zero, 5
	st.w	$a1, $a0, %pc_lo12(input_type)
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB6_106
.LBB6_93:                               # %.lr.ph.preheader.i124
	addi.d	$a4, $s3, -1
...
.LBB6_101:                              # %vector.body372
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB6_101
# %bb.102:                              # %middle.block377
	beq	$a4, $a3, .LBB6_105
.LBB6_103:                              # %.lr.ph.i.i132.preheader
	alsl.d	$a1, $a0, $fp, 3
	addi.d	$a1, $a1, 8
	sub.d	$a0, $a5, $a0
.LBB6_104:                              # %.lr.ph.i.i132
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	st.d	$a2, $a1, -8
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB6_104
.LBB6_105:                              # %check_arg.exit136
	pcalau12i	$a0, %pc_hi20(input_type)
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(input_type)
.LBB6_106:                              # %check_arg.exit136.thread
	move	$a0, $zero
