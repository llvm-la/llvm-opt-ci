...
# %bb.3:                                # %.lr.ph84
	...
	alsl.d	$a3, $a5, $fp, 2
	bge	$a6, $a7, .LBB0_20
# %bb.4:                                # %.lr.ph84.split.us.preheader
	ld.d	$t0, $s5, 72
...
# %bb.19:                               # %._crit_edge.us
	...
	move	$a0, $t7
	b	.LBB0_5
.LBB0_20:                               # %.lr.ph84.split
	addi.w	$a6, $zero, -1
	beq	$a5, $a6, .LBB0_24
# %bb.21:                               # %.lr.ph84.split.split
	ori	$a6, $zero, 1
	bge	$a6, $a5, .LBB0_33
# %bb.22:                               # %.lr.ph84.split.split.split.us.preheader
	slli.d	$a5, $a5, 2
	lu12i.w	$a6, 349525
	ori	$a6, $a6, 1365
	b	.LBB0_28
...
.LBB0_23:                               #   in Loop: Header=BB0_24 Depth=1
	...
	addi.d	$a1, $a1, 8
	beqz	$a4, .LBB0_38
.LBB0_24:                               # %.lr.ph84.split.split.us
...
# %bb.25:                               #   in Loop: Header=BB0_24 Depth=1
	...
	move	$a0, $a2
	b	.LBB0_23
.LBB0_26:                               # %..loopexit71_crit_edge.us103
                                        #   in Loop: Header=BB0_28 Depth=1
	addi.d	$a7, $a0, 8
	st.d	$a4, $a0, 0
	move	$a0, $a7
	.p2align	4, , 16
.LBB0_27:                               # %.loopexit72.us101
                                        #   in Loop: Header=BB0_28 Depth=1
	ld.d	$a4, $a1, 0
	addi.d	$a1, $a1, 8
	beqz	$a4, .LBB0_38
.LBB0_28:                               # %.lr.ph84.split.split.split.us
                                        # =>This Loop Header: Depth=1
...
# %bb.29:                               #   in Loop: Header=BB0_28 Depth=1
	...
	addi.w	$a7, $a7, 0
	bnez	$a7, .LBB0_27
# %bb.30:                               # %.preheader.us99.preheader
                                        #   in Loop: Header=BB0_28 Depth=1
	ori	$a7, $zero, 4
	.p2align	4, , 16
.LBB0_31:                               # %.preheader.us99
...
.LBB0_34:                               #   in Loop: Header=BB0_35 Depth=1
	...
	addi.d	$a1, $a1, 8
	beqz	$a4, .LBB0_38
.LBB0_35:                               # %.lr.ph84.split.split.split
                                        # =>This Inner Loop Header: Depth=1
	beq	$a4, $fp, .LBB0_34
