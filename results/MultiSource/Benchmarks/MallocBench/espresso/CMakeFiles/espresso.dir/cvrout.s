...
.LBB8_10:                               # %.lr.ph56
	...
	addi.w	$a2, $s6, 1
	blt	$s6, $a1, .LBB8_10
# %bb.11:                               # %._crit_edge57.loopexit
                                        #   in Loop: Header=BB8_9 Depth=1
	ld.w	$a1, $s2, 4
	b	.LBB8_8
.LBB8_12:                               # %._crit_edge60
	ld.w	$a0, $s2, 124
	addi.w	$a1, $zero, -1
	beq	$a0, $a1, .LBB8_19
# %bb.13:
...
# %bb.27:                               #   in Loop: Header=BB17_26 Depth=2
	...
	st.w	$s7, $fp, 0
	bge	$s5, $a0, .LBB17_33
# %bb.28:                               # %.lr.ph147.preheader
                                        #   in Loop: Header=BB17_26 Depth=2
	ori	$s4, $zero, 1
	move	$s7, $s5
	b	.LBB17_30
	.p2align	4, , 16
.LBB17_29:                              #   in Loop: Header=BB17_30 Depth=3
	ld.w	$a0, $s3, 12
	addi.w	$s7, $s7, 1
	bge	$s7, $a0, .LBB17_32
.LBB17_30:                              # %.lr.ph147
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB17_29
# %bb.31:                               #   in Loop: Header=BB17_30 Depth=3
	ld.w	$a0, $s3, 0
	ld.d	$a1, $s3, 24
	mul.w	$a0, $a0, $s7
	slli.d	$a0, $a0, 2
