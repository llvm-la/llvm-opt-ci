...
.Lfunc_end2:
	...
	.p2align	5, 0x0                          # -- Begin function printSoln
.LCPI3_0:
	.byte	0                               # 0x0
	.byte	0                               # 0x0
	.byte	0                               # 0x0
...
.LBB3_21:                               # %.preheader
	...
	b	.LBB3_24
	.p2align	4, , 16
.LBB3_22:                               #   in Loop: Header=BB3_24 Depth=1
	ld.w	$a2, $s4, 0
	move	$a0, $s1
	move	$a1, $s6
...
# %bb.31:                               #   in Loop: Header=BB15_29 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB15_28
.LBB15_32:                              # %._crit_edge.i159
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB15_33:                              # %freeEas.exit
	bnez	$s6, .LBB15_78
.LBB15_34:                              # %freeSolns.exit
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s3
...
# %bb.79:                               #   in Loop: Header=BB15_78 Depth=1
	...
	st.h	$a1, $a0, 0
	beqz	$a2, .LBB15_83
.LBB15_80:                              #   in Loop: Header=BB15_78 Depth=1
	ld.d	$a0, $s2, 16
	beqz	$a0, .LBB15_84
.LBB15_81:                              #   in Loop: Header=BB15_78 Depth=1
	ld.h	$a1, $a0, 0
	addi.d	$a1, $a1, -1
	slli.d	$a2, $a1, 48
	st.h	$a1, $a0, 0
	bnez	$a2, .LBB15_84
# %bb.82:                               #   in Loop: Header=BB15_78 Depth=1
	pcaddu18i	$ra, %call36(pfree)
	jirl	$ra, $ra, 0
	b	.LBB15_84
	.p2align	4, , 16
.LBB15_83:                              #   in Loop: Header=BB15_78 Depth=1
	pcaddu18i	$ra, %call36(pfree)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s2, 16
	bnez	$a0, .LBB15_81
	.p2align	4, , 16
.LBB15_84:                              #   in Loop: Header=BB15_78 Depth=1
	ld.d	$a0, $s2, 24
	beqz	$a0, .LBB15_77
# %bb.85:                               #   in Loop: Header=BB15_78 Depth=1
	ld.h	$a1, $a0, 0
	addi.d	$a1, $a1, -1
	slli.d	$a2, $a1, 48
	st.h	$a1, $a0, 0
	bnez	$a2, .LBB15_77
# %bb.86:                               #   in Loop: Header=BB15_78 Depth=1
	pcaddu18i	$ra, %call36(pfree)
	jirl	$ra, $ra, 0
	b	.LBB15_77
.LBB15_87:
...
.LBB15_88:
	...
	ld.d	$s5, $a0, %got_pc_lo12(verbose)
	ld.w	$a0, $s5, 0
	ori	$a1, $zero, 2
	st.d	$s8, $sp, 104                   # 8-byte Folded Spill
...
.LBB15_93:
	...
	jirl	$ra, $ra, 0
	beqz	$s4, .LBB15_8
# %bb.94:                               # %.lr.ph269.lr.ph.outer.preheader
	move	$s6, $zero
	st.d	$zero, $sp, 120                 # 8-byte Folded Spill
	ori	$a0, $zero, 1
.LBB15_95:                              # %.lr.ph269.lr.ph.outer
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB15_97
	.p2align	4, , 16
.LBB15_96:                              # %.critedge.backedge
                                        #   in Loop: Header=BB15_97 Depth=2
	addi.w	$s4, $s4, -1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$s4, .LBB15_148
.LBB15_97:                              # %.lr.ph269.lr.ph
                                        #   Parent Loop BB15_95 Depth=1
...
.LBB15_100:                             #   in Loop: Header=BB15_98 Depth=3
	...
	move	$s7, $a0
	blt	$a1, $a0, .LBB15_102
# %bb.101:                              #   in Loop: Header=BB15_98 Depth=3
...
# %bb.103:                              #   in Loop: Header=BB15_98 Depth=3
	bltz	$s7, .LBB15_108
# %bb.104:                              #   in Loop: Header=BB15_98 Depth=3
	ld.d	$a1, $sp, 176
	addi.d	$a0, $sp, 160
	pcaddu18i	$ra, %call36(psetq)
	jirl	$ra, $ra, 0
	beqz	$s7, .LBB15_109
# %bb.105:                              #   in Loop: Header=BB15_98 Depth=3
	addi.d	$a0, $sp, 160
	addi.d	$a1, $sp, 232
	move	$a2, $s1
	move	$a3, $s3
	...
	beqz	$a1, .LBB15_126
# %bb.106:                              #   in Loop: Header=BB15_98 Depth=3
	...
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB15_126
# %bb.107:                              #   in Loop: Header=BB15_98 Depth=3
	pcalau12i	$a0, %pc_hi20(.L.str.15)
	addi.d	$a1, $a0, %pc_lo12(.L.str.15)
	b	.LBB15_125
	.p2align	4, , 16
.LBB15_108:                             #   in Loop: Header=BB15_98 Depth=3
	addi.w	$s4, $s4, -1
	bnez	$s4, .LBB15_98
	b	.LBB15_148
	.p2align	4, , 16
.LBB15_109:                             #   in Loop: Header=BB15_98 Depth=3
	ld.d	$s7, $sp, 232
	beqz	$s7, .LBB15_111
# %bb.110:                              #   in Loop: Header=BB15_98 Depth=3
	ld.h	$a0, $s7, 0
	addi.d	$a0, $a0, 1
	st.h	$a0, $s7, 0
.LBB15_111:                             #   in Loop: Header=BB15_98 Depth=3
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	bnez	$a0, .LBB15_115
# %bb.112:                              # %.lr.ph.i.preheader
...
# %bb.114:                              #   in Loop: Header=BB15_113 Depth=4
	ld.d	$s8, $s8, 0
	bnez	$s8, .LBB15_113
.LBB15_115:                             #   in Loop: Header=BB15_98 Depth=3
	move	$s8, $zero
.LBB15_116:                             # %._crit_edge.i
                                        #   in Loop: Header=BB15_98 Depth=3
	beqz	$s7, .LBB15_119
# %bb.117:                              #   in Loop: Header=BB15_98 Depth=3
	ld.h	$a0, $s7, 0
	addi.d	$a0, $a0, -1
	slli.d	$a1, $a0, 48
	st.h	$a0, $s7, 0
	bnez	$a1, .LBB15_119
# %bb.118:                              #   in Loop: Header=BB15_98 Depth=3
	move	$a0, $s7
	pcaddu18i	$ra, %call36(pfree)
	jirl	$ra, $ra, 0
.LBB15_119:                             # %findSoln.exit
                                        #   in Loop: Header=BB15_98 Depth=3
	beqz	$s8, .LBB15_144
# %bb.120:                              #   in Loop: Header=BB15_98 Depth=3
	ld.w	$a0, $s5, 0
	ori	$a1, $zero, 4
	blt	$a0, $a1, .LBB15_122
# %bb.121:                              #   in Loop: Header=BB15_98 Depth=3
	pcalau12i	$a0, %got_pc_hi20(stdout)
	...
	jirl	$ra, $ra, 0
.LBB15_122:                             #   in Loop: Header=BB15_98 Depth=3
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	addi.d	$a0, $sp, 232
	pcaddu18i	$ra, %call36(psetq)
	...
	beqz	$a1, .LBB15_126
# %bb.123:                              #   in Loop: Header=BB15_98 Depth=3
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a1, $a0, 0
	ori	$a0, $zero, 35
	...
	ori	$a1, $zero, 2
	bge	$a1, $a0, .LBB15_126
# %bb.124:                              #   in Loop: Header=BB15_98 Depth=3
	pcalau12i	$a0, %pc_hi20(.L.str.13)
	addi.d	$a1, $a0, %pc_lo12(.L.str.13)
.LBB15_125:                             # %.thread164.sink.split
                                        #   in Loop: Header=BB15_98 Depth=3
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$a0, $a0, %got_pc_lo12(stdout)
	ld.d	$a0, $a0, 0
...
.LBB15_126:                             # %.thread164.preheader
	...
	b	.LBB15_128
	.p2align	4, , 16
.LBB15_127:                             #   in Loop: Header=BB15_128 Depth=4
	addi.w	$s8, $s8, 1
	addi.d	$s7, $s7, -8
	addi.d	$s5, $s5, -1
	beq	$s2, $s8, .LBB15_136
.LBB15_128:                             # %.thread164
	...
	ldx.bu	$a0, $s1, $s5
	beqz	$a0, .LBB15_127
# %bb.129:                              #   in Loop: Header=BB15_128 Depth=4
	ld.d	$a6, $s7, 0
	beqz	$a6, .LBB15_131
# %bb.130:                              #   in Loop: Header=BB15_128 Depth=4
	addi.d	$a0, $sp, 160
	addi.d	$a1, $sp, 232
	move	$a2, $s1
	move	$a3, $s3
	...
	b	.LBB15_127
	.p2align	4, , 16
.LBB15_131:                             #   in Loop: Header=BB15_98 Depth=3
	ld.d	$s5, $sp, 96                    # 8-byte Folded Reload
	ld.w	$a0, $s5, 0
	ori	$a1, $zero, 4
	blt	$a0, $a1, .LBB15_133
# %bb.132:                              #   in Loop: Header=BB15_98 Depth=3
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$a0, $a0, %got_pc_lo12(stdout)
	ld.d	$a0, $a0, 0
	ld.d	$a5, $sp, 160
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s5, 0
.LBB15_133:                             #   in Loop: Header=BB15_98 Depth=3
	ld.d	$s8, $sp, 104                   # 8-byte Folded Reload
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB15_135
# %bb.134:                              #   in Loop: Header=BB15_98 Depth=3
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$a0, $a0, %got_pc_lo12(stdout)
	ld.d	$a1, $a0, 0
	ori	$a0, $zero, 10
	pcaddu18i	$ra, %call36(putc)
	jirl	$ra, $ra, 0
.LBB15_135:                             #   in Loop: Header=BB15_98 Depth=3
	ld.d	$a4, $sp, 160
	ld.d	$a5, $sp, 232
	move	$a0, $fp
	move	$a1, $s3
	...
	b	.LBB15_148
	.p2align	4, , 16
.LBB15_136:                             #   in Loop: Header=BB15_97 Depth=2
	...
	ld.d	$s8, $sp, 104                   # 8-byte Folded Reload
	beqz	$a0, .LBB15_141
# %bb.137:                              #   in Loop: Header=BB15_97 Depth=2
	ori	$a1, $zero, 2
	beq	$a0, $a1, .LBB15_140
# %bb.138:                              #   in Loop: Header=BB15_97 Depth=2
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB15_143
# %bb.139:                              #   in Loop: Header=BB15_97 Depth=2
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a1, $a0, 0
	ori	$a0, $zero, 47
	...
	b	.LBB15_96
	.p2align	4, , 16
.LBB15_140:                             #   in Loop: Header=BB15_97 Depth=2
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a1, $a0, 0
	ori	$a0, $zero, 10
	pcaddu18i	$ra, %call36(putc)
	jirl	$ra, $ra, 0
.LBB15_141:                             #   in Loop: Header=BB15_97 Depth=2
	ld.d	$a0, $sp, 160
	ld.d	$a1, $sp, 152
	pcaddu18i	$ra, %call36(pcmp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB15_96
.LBB15_142:                             #   in Loop: Header=BB15_97 Depth=2
	ld.d	$a0, $sp, 160
	ld.d	$a1, $sp, 152
	pcaddu18i	$ra, %call36(padd)
	jirl	$ra, $ra, 0
	...
	b	.LBB15_150
	.p2align	4, , 16
.LBB15_143:                             #   in Loop: Header=BB15_97 Depth=2
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a1, $a0, 0
	ori	$a0, $zero, 10
	...
	bnez	$a0, .LBB15_142
	b	.LBB15_96
.LBB15_144:                             #   in Loop: Header=BB15_95 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB15_147
# %bb.145:                              #   in Loop: Header=BB15_95 Depth=1
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a1, $a0, 0
	ori	$a0, $zero, 46
	...
	ori	$a1, $zero, 4
	blt	$a0, $a1, .LBB15_147
# %bb.146:                              #   in Loop: Header=BB15_95 Depth=1
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$a0, $a0, %got_pc_lo12(stdout)
	ld.d	$a0, $a0, 0
	ld.d	$a5, $sp, 160
