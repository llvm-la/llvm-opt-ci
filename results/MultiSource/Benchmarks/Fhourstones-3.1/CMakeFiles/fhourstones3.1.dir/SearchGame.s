...
# %bb.64:                               # %middle.block
                                        #   in Loop: Header=BB19_56 Depth=1
	beq	$a5, $a6, .LBB19_67
.LBB19_65:                              # %.lr.ph167.preheader249
                                        #   in Loop: Header=BB19_56 Depth=1
	alsl.d	$a5, $a4, $t5, 2
	.p2align	4, , 16
.LBB19_66:                              # %.lr.ph167
...
.LBB20_6:                               # %islegalhaswon.exit.thread14
	...
	and	$a0, $a4, $a3
	beqz	$a0, .LBB20_17
.LBB20_7:                               # %islegalhaswon.exit.thread14.1
	ld.b	$a0, $a2, 2
	ori	$a4, $zero, 1
	sll.d	$a0, $a4, $a0
	or	$a5, $a0, $a1
	and	$a0, $a5, $a3
	beqz	$a0, .LBB20_21
.LBB20_8:                               # %islegalhaswon.exit.thread14.2
	ld.b	$a0, $a2, 3
	sll.d	$a0, $a4, $a0
	or	$a4, $a0, $a1
	and	$a0, $a4, $a3
	beqz	$a0, .LBB20_25
.LBB20_9:                               # %islegalhaswon.exit.thread14.3
	ld.b	$a0, $a2, 4
	ori	$a4, $zero, 1
	sll.d	$a0, $a4, $a0
	or	$a5, $a0, $a1
	and	$a0, $a5, $a3
	beqz	$a0, .LBB20_29
.LBB20_10:                              # %islegalhaswon.exit.thread14.4
	ld.b	$a0, $a2, 5
	sll.d	$a0, $a4, $a0
	or	$a4, $a0, $a1
	and	$a0, $a4, $a3
	beqz	$a0, .LBB20_33
.LBB20_11:                              # %islegalhaswon.exit.thread14.5
	ld.b	$a0, $a2, 6
	ori	$a2, $zero, 1
	sll.d	$a0, $a2, $a0
	or	$a1, $a0, $a1
	and	$a0, $a1, $a3
	beqz	$a0, .LBB20_37
.LBB20_12:                              # %islegalhaswon.exit.thread14.6
