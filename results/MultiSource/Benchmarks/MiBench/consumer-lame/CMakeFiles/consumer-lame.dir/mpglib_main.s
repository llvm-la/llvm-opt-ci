...
# %bb.21:                               #   in Loop: Header=BB3_15 Depth=1
	move	$s5, $zero
	b	.LBB3_28
.LBB3_22:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB3_15 Depth=1
	bgeu	$a1, $t7, .LBB3_33
# %bb.23:                               #   in Loop: Header=BB3_15 Depth=1
	move	$s5, $zero
	b	.LBB3_37
.LBB3_24:                               # %vector.body86.preheader
                                        #   in Loop: Header=BB3_15 Depth=1
	move	$s2, $t6
	move	$s3, $t3
	move	$s4, $t0
	.p2align	4, , 16
.LBB3_25:                               # %vector.body86
	...
	addi.d	$s2, $s2, 64
	bnez	$s4, .LBB3_25
# %bb.26:                               # %middle.block91
                                        #   in Loop: Header=BB3_15 Depth=1
	beq	$t0, $a5, .LBB3_14
# %bb.27:                               # %vec.epilog.iter.check96
                                        #   in Loop: Header=BB3_15 Depth=1
	move	$s5, $t0
	move	$s4, $t0
	beqz	$a7, .LBB3_31
.LBB3_28:                               # %vec.epilog.ph98
                                        #   in Loop: Header=BB3_15 Depth=1
	add.d	$s2, $t4, $s5
	alsl.d	$s3, $s5, $fp, 1
	alsl.d	$s4, $s5, $t8, 1
	.p2align	4, , 16
.LBB3_29:                               # %vec.epilog.vector.body101
                                        #   Parent Loop BB3_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
...
# %bb.30:                               # %vec.epilog.middle.block105
	...
	move	$s4, $t1
	beq	$t1, $a5, .LBB3_14
.LBB3_31:                               # %.lr.ph.split.us42.preheader
                                        #   in Loop: Header=BB3_15 Depth=1
	alsl.d	$s2, $s4, $fp, 1
	mul.d	$s3, $a3, $s4
	sub.d	$s4, $a5, $s4
	.p2align	4, , 16
.LBB3_32:                               # %.lr.ph.split.us42
                                        #   Parent Loop BB3_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.h	$s5, $t8, $s3
	st.h	$s5, $s2, 0
	...
	bnez	$s4, .LBB3_32
	b	.LBB3_14
.LBB3_33:                               # %vector.body.preheader
                                        #   in Loop: Header=BB3_15 Depth=1
	pcalau12i	$s2, %pc_hi20(out+32)
	addi.d	$s2, $s2, %pc_lo12(out+32)
	move	$s3, $t5
	move	$s4, $t0
	.p2align	4, , 16
.LBB3_34:                               # %vector.body
...
# %bb.16:                               #   in Loop: Header=BB4_8 Depth=1
	move	$s4, $zero
	b	.LBB4_30
.LBB4_17:                               # %vector.body62.preheader
                                        #   in Loop: Header=BB4_8 Depth=1
	move	$t8, $t5
	move	$s2, $t2
	move	$s3, $a7
	.p2align	4, , 16
.LBB4_18:                               # %vector.body62
...
# %bb.19:                               # %middle.block67
                                        #   in Loop: Header=BB4_8 Depth=1
	beq	$a7, $a1, .LBB4_7
# %bb.20:                               # %vec.epilog.iter.check72
                                        #   in Loop: Header=BB4_8 Depth=1
	move	$s4, $a7
	move	$s3, $a7
	beqz	$a6, .LBB4_24
.LBB4_21:                               # %vec.epilog.ph74
                                        #   in Loop: Header=BB4_8 Depth=1
	add.d	$t8, $t3, $s4
	alsl.d	$s2, $s4, $fp, 1
	alsl.d	$s3, $s4, $t7, 1
	.p2align	4, , 16
.LBB4_22:                               # %vec.epilog.vector.body77
                                        #   Parent Loop BB4_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s3, 0
	vst	$vr0, $s2, 0
	...
	addi.d	$s3, $s3, 16
	bnez	$t8, .LBB4_22
# %bb.23:                               # %vec.epilog.middle.block81
                                        #   in Loop: Header=BB4_8 Depth=1
	move	$s3, $t0
	beq	$t0, $a1, .LBB4_7
.LBB4_24:                               # %.lr.ph.split.us30.preheader
                                        #   in Loop: Header=BB4_8 Depth=1
	alsl.d	$t8, $s3, $fp, 1
	mul.d	$s2, $a3, $s3
	sub.d	$s3, $a1, $s3
	.p2align	4, , 16
.LBB4_25:                               # %.lr.ph.split.us30
                                        #   Parent Loop BB4_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.h	$s4, $t7, $s2
	st.h	$s4, $t8, 0
