...
# %bb.10:
	...
	move	$a5, $zero
	b	.LBB8_17
.LBB8_11:                               # %vector.main.loop.iter.check296
...
.LBB8_27:
	move	$t6, $zero
	b	.LBB8_67
.LBB8_28:                               # %vector.main.loop.iter.check182
	ori	$t0, $zero, 16
	bgeu	$t1, $t0, .LBB8_30
# %bb.29:
	move	$t4, $zero
...
# %bb.32:                               # %middle.block194
	...
	beq	$t4, $t1, .LBB8_39
# %bb.33:                               # %vec.epilog.iter.check202
	beqz	$t5, .LBB8_128
.LBB8_34:                               # %vec.epilog.ph204
	...
	sub.d	$t3, $t4, $t5
	.p2align	4, , 16
.LBB8_35:                               # %vec.epilog.vector.body209
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t3, $t3, 4
	addi.d	$t0, $t0, 16
	bnez	$t3, .LBB8_35
# %bb.36:                               # %vec.epilog.middle.block214
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t0, $vr0, 0
	beq	$t5, $t1, .LBB8_39
.LBB8_37:                               # %vec.epilog.scalar.ph201.preheader
	alsl.d	$t2, $t2, $a0, 2
	sub.d	$t3, $t1, $t5
	.p2align	4, , 16
.LBB8_38:                               # %vec.epilog.scalar.ph201
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $t2, 0
	slt	$t5, $t0, $t4
	masknez	$t0, $t0, $t5
	...
	addi.d	$t2, $t2, 4
	bnez	$t3, .LBB8_38
.LBB8_39:                               # %._crit_edge.1
	add.w	$a7, $a7, $t1
	ld.w	$t1, $a6, 8
	blez	$t1, .LBB8_26
.LBB8_40:                               # %iter.check238
	ori	$t2, $zero, 4
	bgeu	$t1, $t2, .LBB8_42
# %bb.41:
	move	$t2, $zero
	...
	move	$t3, $a7
	b	.LBB8_51
.LBB8_42:                               # %vector.main.loop.iter.check220
	ori	$t2, $zero, 16
	bgeu	$t1, $t2, .LBB8_44
# %bb.43:
	move	$t4, $zero
...
# %bb.46:                               # %middle.block232
	...
	beq	$t4, $t1, .LBB8_53
# %bb.47:                               # %vec.epilog.iter.check240
	beqz	$t5, .LBB8_129
.LBB8_48:                               # %vec.epilog.ph242
	...
	sub.d	$t4, $t4, $t5
	.p2align	4, , 16
.LBB8_49:                               # %vec.epilog.vector.body247
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t2, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t4, $t4, 4
	addi.d	$t2, $t2, 16
	bnez	$t4, .LBB8_49
# %bb.50:                               # %vec.epilog.middle.block252
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t2, $vr0, 0
	beq	$t5, $t1, .LBB8_53
.LBB8_51:                               # %vec.epilog.scalar.ph239.preheader
	alsl.d	$t3, $t3, $a0, 2
	sub.d	$t4, $t1, $t5
	.p2align	4, , 16
.LBB8_52:                               # %vec.epilog.scalar.ph239
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $t3, 0
	slt	$t6, $t2, $t5
	masknez	$t2, $t2, $t6
	...
	addi.d	$t3, $t3, 4
	bnez	$t4, .LBB8_52
.LBB8_53:                               # %._crit_edge.2
	add.w	$a7, $a7, $t1
	ld.w	$a6, $a6, 12
	blez	$a6, .LBB8_27
.LBB8_54:                               # %iter.check276
	ori	$t1, $zero, 4
	bgeu	$a6, $t1, .LBB8_56
# %bb.55:
	move	$t6, $zero
	...
	move	$t1, $a7
	b	.LBB8_65
.LBB8_56:                               # %vector.main.loop.iter.check258
	ori	$t1, $zero, 16
	bgeu	$a6, $t1, .LBB8_58
# %bb.57:
	move	$t3, $zero
...
# %bb.60:                               # %middle.block270
	...
	beq	$t3, $a6, .LBB8_67
# %bb.61:                               # %vec.epilog.iter.check278
	beqz	$t4, .LBB8_130
.LBB8_62:                               # %vec.epilog.ph280
	...
	sub.d	$t3, $t3, $t4
	.p2align	4, , 16
.LBB8_63:                               # %vec.epilog.vector.body285
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t3, $t3, 4
	addi.d	$a7, $a7, 16
	bnez	$t3, .LBB8_63
# %bb.64:                               # %vec.epilog.middle.block290
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t6, $vr0, 0
	beq	$t4, $a6, .LBB8_67
.LBB8_65:                               # %vec.epilog.scalar.ph277.preheader
	alsl.d	$a0, $t1, $a0, 2
	sub.d	$a6, $a6, $t4
	.p2align	4, , 16
.LBB8_66:                               # %vec.epilog.scalar.ph277
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $a0, 0
	slt	$t1, $t6, $a7
	masknez	$t3, $t6, $t1
...
# %bb.70:                               # %middle.block306
	...
	vpickve2gr.w	$a5, $vr0, 0
	beq	$t3, $t2, .LBB8_77
# %bb.71:                               # %vec.epilog.iter.check313
	beqz	$t4, .LBB8_75
.LBB8_72:                               # %vec.epilog.ph315
	move	$t4, $t2
	...
	sub.d	$t4, $t4, $t2
	.p2align	4, , 16
.LBB8_73:                               # %vec.epilog.vector.body320
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $a5, -44
	ld.w	$t6, $a5, -32
	ld.w	$t7, $a5, -20
	...
	addi.d	$a5, $a5, 48
	bnez	$t4, .LBB8_73
# %bb.74:                               # %vec.epilog.middle.block324
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
...
# %bb.82:
	...
	move	$t4, $a7
	b	.LBB8_108
.LBB8_83:                               # %vector.main.loop.iter.check365
...
# %bb.84:
	...
	move	$t2, $zero
	b	.LBB8_91
.LBB8_85:                               # %vector.main.loop.iter.check330
...
# %bb.89:                               # %middle.block375
	...
	vpickve2gr.w	$t2, $vr0, 0
	beq	$t5, $t7, .LBB8_96
# %bb.90:                               # %vec.epilog.iter.check383
	beqz	$t8, .LBB8_131
.LBB8_91:                               # %vec.epilog.ph385
	bstrpick.d	$t6, $t5, 32, 2
	slli.d	$t8, $t6, 2
	alsl.d	$t6, $t6, $a7, 2
	vreplgr2vr.w	$vr0, $t2
	sub.d	$t2, $t7, $t8
	...
	addi.d	$t7, $t7, 132
	.p2align	4, , 16
.LBB8_92:                               # %vec.epilog.vector.body390
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$fp, $t7, -44
	ld.w	$s0, $t7, -32
	ld.w	$s1, $t7, -20
	...
	addi.d	$t7, $t7, 48
	bnez	$t2, .LBB8_92
# %bb.93:                               # %vec.epilog.middle.block394
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
...
.LBB8_95:                               # %.preheader.2
	...
	addi.d	$t5, $t5, 12
	bnez	$t6, .LBB8_95
.LBB8_96:                               # %._crit_edge108.2
	add.w	$a7, $a7, $t4
	ld.wu	$t4, $a6, 28
	ori	$a6, $zero, 1
	bltu	$t4, $t3, .LBB8_112
.LBB8_97:                               # %iter.check416
	mul.d	$t1, $t4, $t1
	srli.d	$t1, $t1, 33
	addi.d	$t4, $t1, -1
	ori	$t3, $zero, 3
...
# %bb.98:
	...
	move	$t4, $a7
	b	.LBB8_120
.LBB8_99:                               # %vector.main.loop.iter.check400
...
# %bb.103:                              # %middle.block340
	...
	vpickve2gr.w	$t0, $vr0, 0
	beq	$t3, $t5, .LBB8_110
# %bb.104:                              # %vec.epilog.iter.check348
	beqz	$t6, .LBB8_132
.LBB8_105:                              # %vec.epilog.ph350
	bstrpick.d	$t4, $t3, 32, 2
	slli.d	$t6, $t4, 2
	alsl.d	$t4, $t4, $a7, 2
	vreplgr2vr.w	$vr0, $t0
	sub.d	$t0, $t5, $t6
	...
	addi.d	$t5, $t5, 132
	.p2align	4, , 16
.LBB8_106:                              # %vec.epilog.vector.body355
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t7, $t5, -44
	ld.w	$t8, $t5, -32
	ld.w	$fp, $t5, -20
	...
	addi.d	$t5, $t5, 48
	bnez	$t0, .LBB8_106
# %bb.107:                              # %vec.epilog.middle.block359
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t0, $vr0, 0
	beq	$t3, $t6, .LBB8_110
.LBB8_108:                              # %.preheader.1.preheader
	slli.d	$t3, $t4, 3
	alsl.d	$t3, $t4, $t3, 2
	add.d	$t3, $t3, $a0
	addi.d	$t3, $t3, 96
...
# %bb.115:                              # %middle.block410
	...
	vpickve2gr.w	$t6, $vr0, 0
	beq	$t3, $t5, .LBB8_122
# %bb.116:                              # %vec.epilog.iter.check418
	beqz	$t7, .LBB8_133
.LBB8_117:                              # %vec.epilog.ph420
	bstrpick.d	$t4, $t3, 32, 2
	slli.d	$t7, $t4, 2
	alsl.d	$t4, $t4, $a7, 2
	vreplgr2vr.w	$vr0, $t6
	...
	addi.d	$a7, $a7, 132
	.p2align	4, , 16
.LBB8_118:                              # %vec.epilog.vector.body425
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $a7, -44
	ld.w	$t8, $a7, -32
	ld.w	$fp, $a7, -20
	...
	addi.d	$a7, $a7, 48
	bnez	$t6, .LBB8_118
# %bb.119:                              # %vec.epilog.middle.block429
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t6, $vr0, 0
	beq	$t3, $t7, .LBB8_122
.LBB8_120:                              # %.preheader.3.preheader
	slli.d	$a7, $t4, 3
	alsl.d	$a7, $t4, $a7, 2
	add.d	$a0, $a7, $a0
	addi.d	$a0, $a0, 96
