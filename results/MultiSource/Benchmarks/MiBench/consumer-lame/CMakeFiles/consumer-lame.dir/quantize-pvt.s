...
# %bb.38:                               # %middle.block219
	...
	beq	$t3, $a6, .LBB8_41
.LBB8_39:                               # %scalar.ph207.preheader
	alsl.d	$a0, $t4, $a0, 2
	sub.d	$a6, $a6, $t3
	.p2align	4, , 16
.LBB8_40:                               # %scalar.ph207
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a0, 0
	slt	$t3, $t1, $t0
	masknez	$t1, $t1, $t3
...
# %bb.44:                               # %middle.block235
	...
	vpickve2gr.w	$a5, $vr0, 0
	beq	$t3, $t2, .LBB8_47
.LBB8_45:                               # %.preheader.preheader296
	slli.d	$t3, $t2, 3
	alsl.d	$t3, $t2, $t3, 2
	add.d	$t3, $t3, $a0
	addi.d	$t3, $t3, 96
...
.LBB12_1:                               # =>This Inner Loop Header: Depth=1
	...
	vfmul.d	$vr1, $vr0, $vr1
	vfmul.d	$vr2, $vr0, $vr2
	vftintrz.w.d	$vr3, $vr2, $vr2
	vpickve2gr.w	$a5, $vr3, 0
	slli.d	$a5, $a5, 3
	fldx.d	$fa4, $a3, $a5
	vftintrz.w.d	$vr5, $vr1, $vr1
	...
	slli.d	$a5, $a5, 3
	fldx.d	$fa5, $a3, $a5
	vftintrz.w.d	$vr1, $vr1, $vr2
	vst	$vr1, $a1, 0
	vextrins.d	$vr8, $vr7, 16
	vextrins.d	$vr6, $vr5, 16
	vfadd.d	$vr1, $vr4, $vr6
	vfadd.d	$vr2, $vr3, $vr8
	vftintrz.w.d	$vr1, $vr2, $vr1
	vst	$vr1, $a1, 16
	addi.w	$a2, $a2, -1
	addi.d	$a0, $a0, 64
	addi.d	$a1, $a1, 32
