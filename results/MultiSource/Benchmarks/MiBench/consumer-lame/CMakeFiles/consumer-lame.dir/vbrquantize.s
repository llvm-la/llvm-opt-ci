...
# %bb.0:                                # %.preheader.peel.next66
	...
	fld.d	$ft15, $a0, 136
	fld.d	$ft1, $a0, 144
	fst.d	$ft1, $sp, 200                  # 8-byte Folded Spill
	fld.d	$ft0, $a0, 152
	fst.d	$ft0, $sp, 192                  # 8-byte Folded Spill
	fld.d	$fa7, $a0, 160
	fst.d	$fa7, $sp, 184                  # 8-byte Folded Spill
	fld.d	$fa6, $a0, 168
	...
	movgr2fr.w	$fa0, $a3
	ffint.d.w	$ft9, $fa0
	vbitrevi.d	$vr2, $vr21, 63
	vbitrevi.d	$vr3, $vr20, 63
	vreplvei.d	$vr0, $vr17, 0
	vldi	$vr1, -920
	vfmadd.d	$vr24, $vr3, $vr0, $vr1
	vfmadd.d	$vr25, $vr2, $vr0, $vr1
	vbitrevi.d	$vr2, $vr19, 63
	vbitrevi.d	$vr3, $vr18, 63
	vfmadd.d	$vr26, $vr3, $vr0, $vr1
	vfmadd.d	$vr28, $vr2, $vr0, $vr1
	vbitrevi.d	$vr2, $vr16, 63
	vbitrevi.d	$vr3, $vr15, 63
	vfmadd.d	$vr29, $vr3, $vr0, $vr1
	vfmadd.d	$vr31, $vr2, $vr0, $vr1
	vbitrevi.d	$vr2, $vr14, 63
	vbitrevi.d	$vr3, $vr11, 63
	vfmadd.d	$vr3, $vr3, $vr0, $vr1
	vst	$vr3, $sp, 224                  # 16-byte Folded Spill
	vfmadd.d	$vr2, $vr2, $vr0, $vr1
	fneg.d	$fa1, $ft14
	vldi	$vr0, -920
	fmadd.d	$fa1, $fa1, $ft9, $fa0
	...
	fadd.d	$fa2, $fa0, $ft15
	fadd.d	$fa1, $fa0, $ft14
	vreplvei.d	$vr31, $vr11, 1
	fadd.d	$fs7, $fa0, $fs7
	vreplvei.d	$vr11, $vr11, 0
	fadd.d	$ft3, $fa0, $ft3
	vreplvei.d	$vr29, $vr14, 1
	fadd.d	$fs5, $fa0, $fs5
	...
	fadd.d	$ft11, $fa0, $ft11
	vreplvei.d	$vr23, $vr20, 1
	fadd.d	$ft15, $fa0, $ft15
	vreplvei.d	$vr20, $vr20, 0
	fadd.d	$ft12, $fa0, $ft12
	vreplvei.d	$vr22, $vr21, 1
	...
	fcmp.clt.d	$fcc0, $fa0, $ft11
	fsel	$fa0, $fa0, $ft11, $fcc0
