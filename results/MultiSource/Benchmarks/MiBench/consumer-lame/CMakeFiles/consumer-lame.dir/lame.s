...
.LBB2_19:                               # %vector.body200
	...
	addi.d	$a3, $a3, 64
	bnez	$a5, .LBB2_19
# %bb.20:                               # %middle.block205
                                        #   in Loop: Header=BB2_15 Depth=1
	beq	$a2, $a1, .LBB2_23
.LBB2_21:                               # %scalar.ph195.preheader
                                        #   in Loop: Header=BB2_15 Depth=1
	addi.d	$a3, $sp, 192
	alsl.d	$a3, $a2, $a3, 3
	lu12i.w	$a4, 4
...
# %bb.37:                               #   in Loop: Header=BB2_36 Depth=1
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_38:                               # %vector.body224.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	move	$t0, $a4
	move	$t1, $a5
	.p2align	4, , 16
...
# %bb.49:                               #   in Loop: Header=BB2_48 Depth=1
	...
	b	.LBB2_53
	.p2align	4, , 16
.LBB2_50:                               # %vector.body213.preheader
                                        #   in Loop: Header=BB2_48 Depth=1
	move	$t3, $a4
	move	$t4, $a2
	move	$t5, $a7
	.p2align	4, , 16
.LBB2_51:                               # %vector.body213
...
# %bb.29:                               # %.preheader.us.preheader
	...
	b	.LBB5_31
	.p2align	4, , 16
.LBB5_30:                               # %._crit_edge87.us
                                        #   in Loop: Header=BB5_31 Depth=2
	addi.d	$a2, $a2, 1
	add.d	$s4, $s4, $fp
	add.d	$t1, $t1, $fp
	beq	$a2, $a1, .LBB5_17
.LBB5_31:                               # %iter.check146
                                        #   Parent Loop BB5_18 Depth=1
...
# %bb.32:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_42
	.p2align	4, , 16
.LBB5_33:                               # %vector.main.loop.iter.check133
                                        #   in Loop: Header=BB5_31 Depth=2
	bgeu	$a0, $t5, .LBB5_35
# %bb.34:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_39
	.p2align	4, , 16
.LBB5_35:                               # %vector.body138.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s4
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_36:                               # %vector.body138
                                        #   Parent Loop BB5_18 Depth=1
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_36
# %bb.37:                               # %middle.block143
                                        #   in Loop: Header=BB5_31 Depth=2
	beq	$a6, $a0, .LBB5_30
# %bb.38:                               # %vec.epilog.iter.check148
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t4, $a6
	move	$t3, $a6
	beqz	$a5, .LBB5_42
.LBB5_39:                               # %vec.epilog.ph150
                                        #   in Loop: Header=BB5_31 Depth=2
	add.d	$t2, $t0, $t4
	alsl.d	$t3, $t4, $s4, 1
	alsl.d	$t4, $t4, $a3, 1
	.p2align	4, , 16
.LBB5_40:                               # %vec.epilog.vector.body153
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $s4, $t4
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB5_40
# %bb.41:                               # %vec.epilog.middle.block157
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t3, $a7
	beq	$a7, $a0, .LBB5_30
.LBB5_42:                               # %vec.epilog.scalar.ph147.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	slli.d	$t2, $t3, 1
	sub.d	$t3, $a0, $t3
	.p2align	4, , 16
.LBB5_43:                               # %vec.epilog.scalar.ph147
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.h	$t4, $t1, $t2
...
# %bb.23:                               # %iter.check195
	...
	ori	$a1, $zero, 8
	bltu	$s0, $a1, .LBB6_26
# %bb.24:                               # %vector.memcheck180
                                        #   in Loop: Header=BB6_22 Depth=1
	alsl.d	$a3, $a0, $ra, 1
	alsl.d	$a4, $a6, $s3, 2
	bgeu	$a3, $a4, .LBB6_48
# %bb.25:                               # %vector.memcheck180
                                        #   in Loop: Header=BB6_22 Depth=1
	add.d	$a3, $a0, $a6
	alsl.d	$a3, $a3, $ra, 1
	add.d	$a3, $a3, $fp
...
.LBB6_26:                               #   in Loop: Header=BB6_22 Depth=1
	move	$a3, $zero
.LBB6_27:                               # %vec.epilog.scalar.ph196.preheader
                                        #   in Loop: Header=BB6_22 Depth=1
	alsl.d	$a1, $a3, $s3, 2
	addi.d	$a4, $a1, 2
	add.d	$a1, $a3, $a0
	...
	sub.d	$a1, $a6, $a3
	.p2align	4, , 16
.LBB6_28:                               # %vec.epilog.scalar.ph196
...
# %bb.32:                               #   in Loop: Header=BB6_22 Depth=1
	ld.d	$s0, $sp, 160                   # 8-byte Folded Reload
	blez	$a0, .LBB6_21
# %bb.33:                               # %.preheader117.us.preheader
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a3, $zero
	slli.d	$a4, $a2, 1
	sub.d	$a5, $zero, $a4
...
.LBB6_47:                               # %vec.epilog.scalar.ph
	...
	bnez	$t5, .LBB6_47
	b	.LBB6_34
.LBB6_48:                               # %vector.main.loop.iter.check184
                                        #   in Loop: Header=BB6_22 Depth=1
	ori	$a1, $zero, 16
...
.LBB6_50:                               # %vec.epilog.ph199
	...
	alsl.d	$a5, $a1, $ra, 1
	.p2align	4, , 16
.LBB6_51:                               # %vec.epilog.vector.body202
                                        #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB6_51
# %bb.52:                               # %vec.epilog.middle.block207
                                        #   in Loop: Header=BB6_22 Depth=1
...
# %bb.55:                               # %middle.block192
	...
	ld.d	$a3, $sp, 160                   # 8-byte Folded Reload
	beq	$a3, $a6, .LBB6_29
# %bb.56:                               # %vec.epilog.iter.check197
                                        #   in Loop: Header=BB6_22 Depth=1
...
.LBB6_58:                               # %.thread
	move	$a0, $a1
	b	.LBB6_71
.LBB6_59:                               # %vector.main.loop.iter.check211
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB6_64
# %bb.60:
	move	$a1, $zero
.LBB6_61:                               # %vec.epilog.ph228
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s4, 1
	.p2align	4, , 16
.LBB6_62:                               # %vec.epilog.vector.body234
                                        # =>This Inner Loop Header: Depth=1
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB6_62
# %bb.63:                               # %vec.epilog.middle.block239
	bne	$a1, $s2, .LBB6_68
	b	.LBB6_70
.LBB6_64:                               # %vector.ph213
	st.d	$s8, $sp, 24                    # 8-byte Folded Spill
	st.d	$s7, $sp, 40                    # 8-byte Folded Spill
	st.d	$s6, $sp, 32                    # 8-byte Folded Spill
...
.LBB6_65:                               # %vector.body216
	...
	addi.d	$a3, $a3, 32
	bnez	$a5, .LBB6_65
# %bb.66:                               # %middle.block221
	ld.d	$s6, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	beq	$a1, $s2, .LBB6_70
# %bb.67:                               # %vec.epilog.iter.check226
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
	bnez	$a2, .LBB6_61
.LBB6_68:                               # %.lr.ph136.preheader
	alsl.d	$a2, $a1, $s3, 2
	addi.d	$a2, $a2, 2
	alsl.d	$a3, $a1, $a0, 1
	alsl.d	$a4, $a1, $s4, 1
