...
# %bb.34:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_39
	.p2align	4, , 16
.LBB5_35:                               # %vector.body137.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s4
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_36:                               # %vector.body137
                                        #   Parent Loop BB5_18 Depth=1
...
# %bb.37:                               # %middle.block142
                                        #   in Loop: Header=BB5_31 Depth=2
	beq	$a6, $a0, .LBB5_30
# %bb.38:                               # %vec.epilog.iter.check146
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t4, $a6
	move	$t3, $a6
	beqz	$a5, .LBB5_42
.LBB5_39:                               # %vec.epilog.ph148
                                        #   in Loop: Header=BB5_31 Depth=2
	add.d	$t2, $t0, $t4
	alsl.d	$t3, $t4, $s4, 1
	alsl.d	$t4, $t4, $a3, 1
	.p2align	4, , 16
.LBB5_40:                               # %vec.epilog.vector.body151
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $s4, $t4
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB5_40
# %bb.41:                               # %vec.epilog.middle.block155
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t3, $a7
	beq	$a7, $a0, .LBB5_30
.LBB5_42:                               # %vec.epilog.scalar.ph145.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	slli.d	$t2, $t3, 1
	sub.d	$t3, $a0, $t3
	.p2align	4, , 16
.LBB5_43:                               # %vec.epilog.scalar.ph145
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.h	$t4, $t1, $t2
...
.LBB6_25:                               #   in Loop: Header=BB6_21 Depth=1
	move	$a3, $zero
.LBB6_26:                               # %vec.epilog.scalar.ph194.preheader
                                        #   in Loop: Header=BB6_21 Depth=1
	alsl.d	$a1, $a3, $s3, 2
	addi.d	$a4, $a1, 2
	add.d	$a1, $a3, $a0
	...
	sub.d	$a1, $a6, $a3
	.p2align	4, , 16
.LBB6_27:                               # %vec.epilog.scalar.ph194
...
# %bb.31:                               #   in Loop: Header=BB6_21 Depth=1
	blez	$a0, .LBB6_20
# %bb.32:                               # %.preheader114.us.preheader
                                        #   in Loop: Header=BB6_21 Depth=1
	move	$a3, $zero
	slli.d	$a4, $a2, 1
	sub.d	$a5, $zero, $a4
...
.LBB6_46:                               # %vec.epilog.scalar.ph
	...
	bnez	$t5, .LBB6_46
	b	.LBB6_33
.LBB6_47:                               # %vector.main.loop.iter.check184
                                        #   in Loop: Header=BB6_21 Depth=1
	ori	$a1, $zero, 16
...
.LBB6_49:                               # %vec.epilog.ph197
	...
	alsl.d	$a5, $a1, $ra, 1
	.p2align	4, , 16
.LBB6_50:                               # %vec.epilog.vector.body200
                                        #   Parent Loop BB6_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB6_50
# %bb.51:                               # %vec.epilog.middle.block205
                                        #   in Loop: Header=BB6_21 Depth=1
...
# %bb.54:                               # %middle.block191
	...
	ld.d	$a3, $sp, 160                   # 8-byte Folded Reload
	beq	$a3, $a6, .LBB6_28
# %bb.55:                               # %vec.epilog.iter.check195
                                        #   in Loop: Header=BB6_21 Depth=1
...
.LBB6_57:                               # %.critedge
	move	$a0, $a1
	b	.LBB6_70
.LBB6_58:                               # %vector.main.loop.iter.check212
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB6_63
# %bb.59:
	move	$a1, $zero
.LBB6_60:                               # %vec.epilog.ph227
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s4, 1
	.p2align	4, , 16
.LBB6_61:                               # %vec.epilog.vector.body233
                                        # =>This Inner Loop Header: Depth=1
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB6_61
# %bb.62:                               # %vec.epilog.middle.block238
	bne	$a1, $s2, .LBB6_67
	b	.LBB6_69
.LBB6_63:                               # %vector.ph213
	st.d	$s8, $sp, 24                    # 8-byte Folded Spill
	st.d	$s7, $sp, 40                    # 8-byte Folded Spill
	st.d	$s6, $sp, 32                    # 8-byte Folded Spill
