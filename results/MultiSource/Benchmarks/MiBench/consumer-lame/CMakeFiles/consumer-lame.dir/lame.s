...
# %bb.37:                               # %vec.epilog.middle.block
	...
	b	.LBB5_42
	.p2align	4, , 16
.LBB5_38:                               # %vector.body130.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s4
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_39:                               # %vector.body130
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t4, $t2, $a3
...
.LBB6_54:                               # %vector.body198
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB6_54
# %bb.55:                               # %middle.block203
	beq	$a1, $s2, .LBB6_58
.LBB6_56:                               # %.lr.ph136.preheader207
	alsl.d	$a2, $a1, $s3, 2
	addi.d	$a2, $a2, 2
	alsl.d	$a3, $a1, $a0, 1
	alsl.d	$a4, $a1, $s4, 1
