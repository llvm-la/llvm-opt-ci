...
# %bb.48:                               # %middle.block212
	...
	beq	$a5, $a2, .LBB1_55
# %bb.49:                               # %vec.epilog.iter.check220
	beqz	$a6, .LBB1_175
.LBB1_50:                               # %vec.epilog.ph222
	...
	addi.d	$a4, $a4, 20
	.p2align	4, , 16
.LBB1_51:                               # %vec.epilog.vector.body225
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a5, $a4, -16
	ld.h	$t0, $a4, -8
	ld.h	$t1, $a4, 0
	...
	addi.d	$a4, $a4, 32
	bnez	$a7, .LBB1_51
# %bb.52:                               # %vec.epilog.middle.block233
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
...
# %bb.69:                               #   in Loop: Header=BB1_59 Depth=1
	...
	b	.LBB1_79
	.p2align	4, , 16
.LBB1_70:                               # %vector.main.loop.iter.check239
                                        #   in Loop: Header=BB1_59 Depth=1
	ori	$a1, $zero, 16
	bgeu	$a0, $a1, .LBB1_72
...
# %bb.74:                               # %middle.block265
	...
	beq	$a3, $a0, .LBB1_58
# %bb.75:                               # %vec.epilog.iter.check273
                                        #   in Loop: Header=BB1_59 Depth=1
	beqz	$a4, .LBB1_81
.LBB1_76:                               # %vec.epilog.ph275
                                        #   in Loop: Header=BB1_59 Depth=1
	...
	addi.d	$a2, $a2, 20
	.p2align	4, , 16
.LBB1_77:                               # %vec.epilog.vector.body278
                                        #   Parent Loop BB1_59 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$a3, $a2, -16
	ld.h	$a6, $a2, -8
	...
	addi.d	$a2, $a2, 32
	bnez	$a5, .LBB1_77
# %bb.78:                               # %vec.epilog.middle.block286
                                        #   in Loop: Header=BB1_59 Depth=1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
...
# %bb.101:                              #   in Loop: Header=BB1_91 Depth=2
	...
	b	.LBB1_111
	.p2align	4, , 16
.LBB1_102:                              # %vector.main.loop.iter.check292
                                        #   in Loop: Header=BB1_91 Depth=2
	ori	$a1, $zero, 16
	bgeu	$a0, $a1, .LBB1_104
...
# %bb.106:                              # %middle.block318
	...
	xvpickve2gr.d	$a5, $xr0, 0
	beq	$a3, $a0, .LBB1_90
# %bb.107:                              # %vec.epilog.iter.check326
                                        #   in Loop: Header=BB1_91 Depth=2
	beqz	$a4, .LBB1_113
.LBB1_108:                              # %vec.epilog.ph328
                                        #   in Loop: Header=BB1_91 Depth=2
	bstrpick.d	$a1, $a0, 31, 2
	slli.d	$a4, $a1, 2
	slli.d	$a1, $a1, 5
	...
	addi.d	$a2, $a2, 20
	.p2align	4, , 16
.LBB1_109:                              # %vec.epilog.vector.body331
                                        #   Parent Loop BB1_87 Depth=1
                                        #     Parent Loop BB1_91 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$a3, $a2, -16
	...
	addi.d	$a2, $a2, 32
	bnez	$a5, .LBB1_109
# %bb.110:                              # %vec.epilog.middle.block339
                                        #   in Loop: Header=BB1_91 Depth=2
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
