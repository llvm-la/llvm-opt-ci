...
.LBB3_24:                               # %vector.body273
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB3_24
# %bb.25:                               # %middle.block282
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$t4, $vr0, 0
	beq	$t2, $t3, .LBB3_28
.LBB3_26:                               # %scalar.ph268.preheader
	addi.d	$t1, $t1, -4
	.p2align	4, , 16
.LBB3_27:                               # %scalar.ph268
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t2, $t1, 4
	ldx.bu	$t2, $t0, $t2
	addi.d	$t3, $t1, 4
...
.LBB3_31:                               # %vector.body293
	...
	addi.d	$a5, $a5, 32
	bnez	$t2, .LBB3_31
# %bb.32:                               # %middle.block302
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a4, $t1, .LBB3_35
.LBB3_33:                               # %scalar.ph288.preheader
	addi.d	$a4, $t0, -4
	.p2align	4, , 16
.LBB3_34:                               # %scalar.ph288
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a4, 4
	ldx.bu	$t0, $a6, $t0
	addi.d	$t1, $a4, 4
...
# %bb.53:
	...
	move	$t3, $a0
	b	.LBB3_78
.LBB3_54:                               # %vector.main.loop.iter.check157
	ori	$t3, $zero, 120
	bgeu	$t2, $t3, .LBB3_57
# %bb.55:
	move	$t8, $a2
...
.LBB3_58:                               # %vector.body165
	...
	xvpickve2gr.d	$s1, $xr18, 1
	xvpickve2gr.d	$s2, $xr17, 2
	st.d	$s2, $sp, 88                    # 8-byte Folded Spill
	xvpickve2gr.d	$s3, $xr17, 3
	ldx.b	$a5, $s4, $a1
	ldx.b	$a4, $s4, $s5
	ldx.b	$a3, $s4, $s6
	ldx.b	$a2, $s4, $s7
...
.LBB3_61:
	alsl.d	$a6, $a5, $a0, 3
	b	.LBB3_13
.LBB3_62:                               # %vec.epilog.iter.check214
	ld.d	$t8, $sp, 80                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
...
.LBB3_64:                               # %vec.epilog.ph216
	...
	vrepli.w	$vr5, 15
	.p2align	4, , 16
.LBB3_65:                               # %vec.epilog.vector.body223
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, -16
	ld.w	$a3, $a0, -8
	ld.w	$a4, $a0, 0
	...
	addi.d	$a0, $a0, 32
	bnez	$t2, .LBB3_65
# %bb.66:                               # %vec.epilog.middle.block242
...
.LBB3_77:
	...
	ld.d	$s3, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
.LBB3_78:                               # %vec.epilog.scalar.ph213.preheader
	ori	$a0, $zero, 14
	ori	$a3, $zero, 15
	b	.LBB3_80
	.p2align	4, , 16
.LBB3_79:                               #   in Loop: Header=BB3_80 Depth=1
	...
	add.d	$t4, $t4, $a4
	bgeu	$t3, $a1, .LBB3_67
.LBB3_80:                               # %vec.epilog.scalar.ph213
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t6, $t3, 0
	beqz	$t6, .LBB3_82
