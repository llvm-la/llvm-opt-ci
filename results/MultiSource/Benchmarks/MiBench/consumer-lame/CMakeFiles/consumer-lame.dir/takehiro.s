...
.LBB1_32:                               # %scalar.ph204
	...
	move	$a0, $t1
	bltu	$t1, $a4, .LBB1_32
.LBB1_33:                               # %count_bit_noESC2.exit69
	addi.w	$a0, $a6, 0
	slt	$a1, $a0, $a3
	masknez	$a4, $a5, $a1
	maskeqz	$a1, $t0, $a1
...
# %bb.48:
	ori	$a4, $zero, 24
	b	.LBB1_50
.LBB1_49:                               # %._crit_edge.loopexit.split.loop.exit
	sub.w	$a4, $a3, $a5
.LBB1_50:                               # %._crit_edge
	ori	$a7, $zero, 24
	mul.d	$a5, $a4, $a7
...
.LBB1_62:                               #   in Loop: Header=BB1_52 Depth=1
	...
	ld.w	$t7, $a0, 20
	beqz	$t7, .LBB1_51
.LBB1_63:                               #   in Loop: Header=BB1_52 Depth=1
	addi.d	$a6, $a6, 1
	slt	$t8, $t2, $t7
	maskeqz	$fp, $a5, $t8
	add.d	$t4, $t4, $fp
...
.LBB1_73:                               # %scalar.ph
	...
	move	$a0, $a7
	bltu	$a7, $a4, .LBB1_73
.LBB1_74:                               # %count_bit_noESC2.exit72
	addi.w	$a0, $a6, 0
	slt	$a1, $a0, $a3
	ori	$a4, $zero, 13
	masknez	$a4, $a4, $a1
...
.LBB3_24:                               # %vector.body271
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB3_24
# %bb.25:                               # %middle.block280
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$t4, $vr0, 0
	beq	$t2, $t3, .LBB3_28
.LBB3_26:                               # %scalar.ph266.preheader
	addi.d	$t1, $t1, -4
	.p2align	4, , 16
.LBB3_27:                               # %scalar.ph266
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t2, $t1, 4
	ldx.bu	$t2, $t0, $t2
	addi.d	$t3, $t1, 4
...
.LBB3_31:                               # %vector.body291
	...
	addi.d	$a5, $a5, 32
	bnez	$t2, .LBB3_31
# %bb.32:                               # %middle.block300
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a4, $t1, .LBB3_35
.LBB3_33:                               # %scalar.ph286.preheader
	addi.d	$a4, $t0, -4
	.p2align	4, , 16
.LBB3_34:                               # %scalar.ph286
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a4, 4
	ldx.bu	$t0, $a6, $t0
	addi.d	$t1, $a4, 4
	...
	move	$a4, $t1
	bltu	$t1, $a1, .LBB3_34
.LBB3_35:                               # %count_bit_noESC2.exit70
	addi.w	$a1, $a5, 0
	slt	$a4, $a1, $a0
	masknez	$a3, $a3, $a4
	maskeqz	$a4, $a7, $a4
...
# %bb.50:
	ori	$fp, $zero, 24
	b	.LBB3_52
.LBB3_51:                               # %.lr.ph.i75.loopexit.split.loop.exit
	sub.w	$fp, $t8, $a7
.LBB3_52:                               # %iter.check213
	ori	$t3, $zero, 24
	mul.d	$a6, $fp, $t3
	ldx.w	$s0, $a5, $a6
	mul.d	$a7, $t8, $t3
...
# %bb.53:
	...
	move	$t2, $a0
	b	.LBB3_68
.LBB3_54:                               # %vector.main.loop.iter.check155
	ori	$a5, $zero, 120
	bgeu	$t2, $a5, .LBB3_57
# %bb.55:
	move	$t7, $a2
...
.LBB3_58:                               # %vector.body164
	...
	vinsgr2vr.b	$vr11, $a6, 3
	vinsgr2vr.b	$vr11, $a7, 4
	vinsgr2vr.b	$vr11, $t0, 5
	vinsgr2vr.b	$vr11, $t6, 6
	vinsgr2vr.b	$vr11, $s2, 7
	...
	vinsgr2vr.b	$vr11, $a7, 4
	vinsgr2vr.b	$vr11, $t0, 5
	vinsgr2vr.b	$vr11, $t3, 6
	vinsgr2vr.b	$vr11, $a5, 7
	vpickve2gr.b	$a2, $vr13, 0
	xvreplgr2vr.b	$xr14, $a2
	xvpermi.q	$xr14, $xr2, 18
	xvori.b	$xr12, $xr2, 0
...
# %bb.60:
	...
	ld.d	$fp, $sp, 48                    # 8-byte Folded Reload
	b	.LBB3_65
.LBB3_61:                               # %vec.epilog.iter.check215
	ld.d	$t7, $sp, 72                    # 8-byte Folded Reload
	ld.d	$t8, $sp, 56                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 32                    # 8-byte Folded Reload
	...
	beqz	$a2, .LBB3_68
.LBB3_62:                               # %vec.epilog.ph217
	bstrpick.d	$a2, $s1, 61, 2
	slli.d	$t5, $a2, 2
	slli.d	$a2, $a2, 5
	vrepli.b	$vr0, 0
	add.d	$t2, $a0, $a2
	...
	vrepli.w	$vr5, 15
	.p2align	4, , 16
.LBB3_63:                               # %vec.epilog.vector.body224
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, -16
	ld.w	$a3, $a0, -8
	ld.w	$a4, $a0, 0
	...
	addi.d	$a0, $a0, 32
	bnez	$a5, .LBB3_63
# %bb.64:                               # %vec.epilog.middle.block242
...
.LBB3_67:
	...
	addi.w	$a0, $a3, 0
	ret
.LBB3_68:                               # %vec.epilog.scalar.ph214.preheader
	ori	$a0, $zero, 14
	ori	$a3, $zero, 15
	b	.LBB3_70
	.p2align	4, , 16
.LBB3_69:                               #   in Loop: Header=BB3_70 Depth=1
	...
	add.d	$a5, $a5, $a4
	bgeu	$t2, $a1, .LBB3_65
.LBB3_70:                               # %vec.epilog.scalar.ph214
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $t2, 0
	beqz	$t5, .LBB3_72
# %bb.71:                               #   in Loop: Header=BB3_70 Depth=1
	...
	b	.LBB3_69
	.p2align	4, , 16
.LBB3_72:                               #   in Loop: Header=BB3_70 Depth=1
	move	$t5, $zero
	ld.w	$t6, $t2, 4
	beqz	$t6, .LBB3_69
.LBB3_73:                               #   in Loop: Header=BB3_70 Depth=1
	addi.d	$t3, $t3, 1
	slt	$a2, $a0, $t6
	maskeqz	$a4, $s0, $a2
	add.d	$t4, $t4, $a4
...
.LBB3_76:                               # %vector.body253
	...
	addi.d	$a5, $a5, 32
	bnez	$t0, .LBB3_76
# %bb.77:                               # %middle.block261
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a4, $a7, .LBB3_80
.LBB3_78:                               # %scalar.ph.preheader
	addi.d	$a4, $a6, -4
	.p2align	4, , 16
.LBB3_79:                               # %scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	...
	move	$a4, $a7
	bltu	$a7, $a1, .LBB3_79
.LBB3_80:                               # %count_bit_noESC2.exit73
	addi.w	$a1, $a5, 0
	slt	$a3, $a1, $a0
	ori	$a4, $zero, 13
	masknez	$a4, $a4, $a3
