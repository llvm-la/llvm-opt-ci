...
.LBB0_9:                                # %vector.ph
	...
	vld	$vr0, $a1, %pc_lo12(.LCPI0_5)
	pcalau12i	$a1, %pc_hi20(.LCPI0_6)
	vld	$vr1, $a1, %pc_lo12(.LCPI0_6)
	pcalau12i	$a1, %pc_hi20(.LCPI0_7)
	vld	$vr2, $a1, %pc_lo12(.LCPI0_7)
	pcalau12i	$a1, %pc_hi20(.LCPI0_8)
	vld	$vr3, $a1, %pc_lo12(.LCPI0_8)
	vst	$vr0, $a0, 48
	vst	$vr1, $a0, 64
	vst	$vr2, $a0, 80
...
.LBB0_47:                               # %vector.body1480
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_47
# %bb.48:                               # %middle.block1485
                                        #   in Loop: Header=BB0_42 Depth=1
	beq	$a7, $t0, .LBB0_41
.LBB0_49:                               # %scalar.ph1478.preheader
                                        #   in Loop: Header=BB0_42 Depth=1
	slli.d	$a6, $a4, 3
	sub.d	$a4, $a5, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB0_50:                               # %scalar.ph1478
                                        #   Parent Loop BB0_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa3, $s8, $a6
	fmul.d	$fa3, $fa2, $fa3
...
.LBB0_63:                               # %vector.body1493
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_63
# %bb.64:                               # %middle.block1499
                                        #   in Loop: Header=BB0_58 Depth=1
	beq	$a7, $t0, .LBB0_57
.LBB0_65:                               # %scalar.ph1486.preheader
                                        #   in Loop: Header=BB0_58 Depth=1
	slli.d	$a6, $a4, 3
	sub.d	$a4, $a5, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB0_66:                               # %scalar.ph1486
                                        #   Parent Loop BB0_58 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa2, $s7, $a6
	fmul.d	$fa2, $fa2, $fa1
...
.LBB0_76:                               # %vector.body1572
	...
	vstx	$vr1, $a1, $a6
	bnez	$a0, .LBB0_76
# %bb.77:                               # %vector.body1559.preheader
                                        #   in Loop: Header=BB0_72 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_78:                               # %vector.body1559
                                        #   Parent Loop BB0_72 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	vldx	$vr1, $a2, $a7
	...
	vstx	$vr1, $a2, $a3
	bne	$a1, $a0, .LBB0_78
# %bb.79:                               # %vector.body1546.preheader
                                        #   in Loop: Header=BB0_72 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_80:                               # %vector.body1546
                                        #   Parent Loop BB0_72 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	vld	$vr1, $a2, 2032
	...
	vstx	$vr1, $a2, $a3
	bne	$a1, $a0, .LBB0_80
# %bb.81:                               # %vector.body1533.preheader
                                        #   in Loop: Header=BB0_72 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_82:                               # %vector.body1533
                                        #   Parent Loop BB0_72 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	vld	$vr1, $a2, 1008
...
.LBB0_119:                              # %.split1989
	...
	fmul.s	$fa1, $fa1, $fa6
	fneg.s	$fa2, $fs4
	fmadd.s	$fa2, $fa2, $fa7, $fa1
	fneg.s	$fa3, $fs2
	fmadd.s	$fa7, $fa3, $fs3, $fa1
	fmul.s	$fa5, $fa5, $fa0
	fmov.s	$fs1, $fa0
	fmov.s	$fs3, $fa2
