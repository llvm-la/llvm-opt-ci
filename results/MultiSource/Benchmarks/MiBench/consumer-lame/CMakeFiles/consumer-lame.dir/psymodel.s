...
.LBB0_45:                               # %vector.body1480
	...
	addi.d	$a6, $a6, 64
	bnez	$t1, .LBB0_45
# %bb.46:                               # %middle.block1485
                                        #   in Loop: Header=BB0_40 Depth=1
	beq	$a7, $t0, .LBB0_39
.LBB0_47:                               # %scalar.ph1478.preheader
                                        #   in Loop: Header=BB0_40 Depth=1
	slli.d	$a6, $a4, 3
	sub.d	$a4, $a5, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB0_48:                               # %scalar.ph1478
                                        #   Parent Loop BB0_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa3, $fp, $a6
	fmul.d	$fa3, $fa2, $fa3
...
.LBB0_61:                               # %vector.body1493
	...
	addi.d	$a6, $a6, 64
	bnez	$t1, .LBB0_61
# %bb.62:                               # %middle.block1499
                                        #   in Loop: Header=BB0_56 Depth=1
	beq	$a7, $t0, .LBB0_55
.LBB0_63:                               # %scalar.ph1486.preheader
                                        #   in Loop: Header=BB0_56 Depth=1
	slli.d	$a6, $a4, 3
	sub.d	$a4, $a5, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB0_64:                               # %scalar.ph1486
                                        #   Parent Loop BB0_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa2, $s8, $a6
	fmul.d	$fa2, $fa2, $fa1
...
.LBB0_71:                               #   in Loop: Header=BB0_69 Depth=1
	...
	ori	$a5, $zero, 4064
	bne	$t1, $a0, .LBB0_80
# %bb.72:                               # %vector.body1572.preheader
...
.LBB0_73:                               # %vector.body1572
	...
	xvstx	$xr1, $a1, $a5
	bnez	$a0, .LBB0_73
# %bb.74:                               # %vector.body1559.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_75:                               # %vector.body1559
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $fp, $a1
	xvldx	$xr1, $a2, $a6
	...
	xvstx	$xr1, $a2, $a3
	bne	$a1, $a0, .LBB0_75
# %bb.76:                               # %vector.body1546.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_77:                               # %vector.body1546
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $fp, $a1
	xvld	$xr1, $a2, 2016
	...
	xvstx	$xr1, $a2, $a3
	bne	$a1, $a0, .LBB0_77
# %bb.78:                               # %vector.body1533.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_79:                               # %vector.body1533
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $fp, $a1
	xvld	$xr1, $a2, 992
