...
.Lfunc_end0:
	.size	ReadHyphTable, .Lfunc_end0-ReadHyphTable
                                        # -- End function
	.p2align	2                               # -- Begin function TrieRead
...
# %bb.13:                               # %.lr.ph169.preheader
	...
	addi.d	$s4, $a0, %pc_lo12(tex_codes)
	pcalau12i	$a0, %pc_hi20(.L.str.27)
	addi.d	$s8, $a0, %pc_lo12(.L.str.27)
...
# %bb.25:                               #   in Loop: Header=BB1_20 Depth=3
	...
	ld.bu	$a0, $s1, 0
	b	.LBB1_20
.LBB1_26:                               # %.lr.ph.preheader.preheader
                                        #   in Loop: Header=BB1_20 Depth=3
	addi.d	$s3, $s4, 24
...
# %bb.23:                               # %.preheader342
	...
	addi.w	$a2, $zero, -1
	.p2align	4, , 16
.LBB2_24:                               #   Parent Loop BB2_7 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a1, $s5, 0
	move	$s0, $a3
	ldx.bu	$a0, $fp, $a1
...
.LBB2_42:                               #   in Loop: Header=BB2_36 Depth=2
	addi.d	$a0, $sp, 96
.LBB2_43:                               # %._crit_edge366
                                        #   in Loop: Header=BB2_36 Depth=2
	st.b	$zero, $a0, 0
	ld.bu	$a0, $sp, 96
	ori	$s7, $zero, 1
	beqz	$a0, .LBB2_48
# %bb.44:                               # %.lr.ph372.preheader
                                        #   in Loop: Header=BB2_36 Depth=2
	addi.d	$a1, $sp, 97
	move	$a2, $s1
	b	.LBB2_46
...
# %bb.49:                               #   in Loop: Header=BB2_48 Depth=3
	...
	ldx.h	$a1, $a0, $a1
	beqz	$a1, .LBB2_35
# %bb.50:                               #   in Loop: Header=BB2_48 Depth=3
	bltz	$a1, .LBB2_52
...
# %bb.76:                               #   in Loop: Header=BB2_75 Depth=4
	beqz	$a1, .LBB2_78
# %bb.77:                               #   in Loop: Header=BB2_75 Depth=4
	addi.d	$a3, $s0, 1
	addi.d	$a0, $a0, 1
	move	$a1, $a2
	bnez	$a2, .LBB2_75
...
# %bb.84:                               #   in Loop: Header=BB2_81 Depth=2
	...
	st.d	$a2, $a1, 0
	b	.LBB2_86
.LBB2_85:                               #   in Loop: Header=BB2_81 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	...
	jirl	$ra, $ra, 0
.LBB2_86:                               #   in Loop: Header=BB2_81 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s8, 0
	beqz	$a1, .LBB2_88
# %bb.87:                               #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a2, $a1, 0
...
.LBB2_88:                               # %.thread504
	...
	st.d	$s4, $s8, 0
.LBB2_89:                               #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a1, $s4, 16
	...
	st.d	$a1, $a0, 16
	st.d	$a0, $a1, 24
.LBB2_90:                               #   in Loop: Header=BB2_81 Depth=2
	ld.bu	$a0, $s6, 1
	slli.d	$a1, $a0, 3
	ldx.d	$s4, $fp, $a1
	st.w	$a0, $s0, 0
	beqz	$s4, .LBB2_92
# %bb.91:                               #   in Loop: Header=BB2_81 Depth=2
	st.d	$s4, $s8, 0
	ld.d	$a1, $s4, 0
	alsl.d	$a0, $a0, $fp, 3
	st.d	$a1, $a0, 0
	b	.LBB2_93
.LBB2_92:                               #   in Loop: Header=BB2_81 Depth=2
	pcalau12i	$a1, %got_pc_hi20(no_fpos)
	ld.d	$a1, $a1, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a1, 0
	pcaddu18i	$ra, %call36(GetMemory)
	...
	move	$s4, $a0
	st.d	$a0, $s8, 0
.LBB2_93:                               #   in Loop: Header=BB2_81 Depth=2
	ori	$a0, $zero, 1
	st.b	$a0, $s4, 32
	st.d	$s4, $s4, 24
	st.d	$s4, $s4, 16
	...
	st.w	$a2, $s0, 0
	beqz	$a0, .LBB2_95
# %bb.94:                               #   in Loop: Header=BB2_81 Depth=2
	st.d	$a0, $s8, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $fp, 3
	st.d	$a1, $a2, 0
	b	.LBB2_96
.LBB2_95:                               #   in Loop: Header=BB2_81 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	pcaddu18i	$ra, %call36(GetMemory)
	jirl	$ra, $ra, 0
.LBB2_96:                               #   in Loop: Header=BB2_81 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s8, 0
	beqz	$a1, .LBB2_99
# %bb.97:                               #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a2, $a1, 0
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a2, $a3, 0
...
.LBB2_99:                               # %.thread336
	...
	st.d	$s4, $s8, 0
	move	$a1, $a0
.LBB2_100:                              #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a2, $s4, 16
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a0, $s4, 16
	...
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
.LBB2_101:                              #   in Loop: Header=BB2_81 Depth=2
	ld.bu	$a2, $s6, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $fp, $a0
	st.w	$a2, $s0, 0
	beqz	$a0, .LBB2_103
# %bb.102:                              #   in Loop: Header=BB2_81 Depth=2
	st.d	$a0, $s8, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $fp, 3
	st.d	$a1, $a2, 0
	b	.LBB2_104
.LBB2_103:                              #   in Loop: Header=BB2_81 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	pcaddu18i	$ra, %call36(GetMemory)
	jirl	$ra, $ra, 0
.LBB2_104:                              #   in Loop: Header=BB2_81 Depth=2
	ori	$s6, $zero, 2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	...
	st.d	$a0, $s8, 0
	beqz	$a0, .LBB2_107
# %bb.105:                              #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a1, $s3, 0
	beqz	$a1, .LBB2_107
# %bb.106:                              #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a2, $a0, 16
	ld.d	$a3, $a1, 16
	st.d	$a2, $fp, 0
	st.d	$a3, $a0, 16
...
.LBB2_110:                              #   in Loop: Header=BB2_7 Depth=1
	...
	jirl	$ra, $ra, 0
	move	$a4, $s3
.LBB2_111:                              #   in Loop: Header=BB2_7 Depth=1
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
...
# %bb.116:                              #   in Loop: Header=BB2_7 Depth=1
	...
	st.d	$a1, $a0, 0
	b	.LBB2_118
.LBB2_117:                              #   in Loop: Header=BB2_7 Depth=1
	pcalau12i	$a1, %got_pc_hi20(no_fpos)
	ld.d	$a1, $a1, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a1, 0
	move	$s4, $a4
...
.LBB2_121:                              #   in Loop: Header=BB2_7 Depth=1
	...
	st.d	$a1, $s6, 0
	beqz	$a1, .LBB2_124
# %bb.122:                              #   in Loop: Header=BB2_7 Depth=1
	ld.d	$a2, $a1, 0
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a2, $a3, 0
...
.LBB2_128:                              #   in Loop: Header=BB2_7 Depth=1
	...
	pcaddu18i	$ra, %call36(GetMemory)
	jirl	$ra, $ra, 0
.LBB2_129:                              #   in Loop: Header=BB2_7 Depth=1
	addi.d	$a2, $s2, 32
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
...
# %bb.130:                              #   in Loop: Header=BB2_7 Depth=1
	ld.d	$a1, $s3, 0
	beqz	$a1, .LBB2_132
# %bb.131:                              #   in Loop: Header=BB2_7 Depth=1
	ld.d	$a2, $a0, 16
	ld.d	$a3, $a1, 16
	st.d	$a2, $fp, 0
	st.d	$a3, $a0, 16
	...
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
.LBB2_132:                              #   in Loop: Header=BB2_7 Depth=1
	st.b	$zero, $s5, 0
	move	$a0, $s2
	pcaddu18i	$ra, %call36(FontWordSize)
	jirl	$ra, $ra, 0
...
.Lfunc_end2:
	.size	Hyphenate, .Lfunc_end2-Hyphenate
                                        # -- End function
	.p2align	2                               # -- Begin function TrieInsert
...
.Lfunc_end3:
	.size	TrieInsert, .Lfunc_end3-TrieInsert
                                        # -- End function
	.p2align	2                               # -- Begin function CompressTrie
