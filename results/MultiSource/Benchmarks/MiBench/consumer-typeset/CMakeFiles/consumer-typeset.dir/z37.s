...
.LBB1_45:                               #   in Loop: Header=BB1_40 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_37
# %bb.46:                               #   in Loop: Header=BB1_40 Depth=1
	move	$a0, $s4
	move	$a1, $s3
	pcaddu18i	$ra, %call36(strcmp)
	jirl	$ra, $ra, 0
...
.LBB1_69:                               # =>This Loop Header: Depth=1
	...
	ld.d	$s3, $s3, 8
	beq	$s3, $s1, .LBB1_73
# %bb.70:                               # %.preheader441.preheader
                                        #   in Loop: Header=BB1_69 Depth=1
	move	$s0, $s3
	.p2align	4, , 16
.LBB1_71:                               # %.preheader441
...
.LBB1_88:                               # =>This Loop Header: Depth=1
	...
	ld.d	$fp, $fp, 8
	beq	$fp, $s0, .LBB1_98
# %bb.89:                               # %.preheader438.preheader
                                        #   in Loop: Header=BB1_88 Depth=1
	move	$s2, $fp
	.p2align	4, , 16
.LBB1_90:                               # %.preheader438
...
.LBB1_102:                              # =>This Loop Header: Depth=1
	...
	ld.d	$fp, $fp, 24
	beq	$fp, $s1, .LBB1_169
# %bb.103:                              # %.preheader521.i.preheader
                                        #   in Loop: Header=BB1_102 Depth=1
	move	$a0, $fp
	.p2align	4, , 16
.LBB1_104:                              # %.preheader521.i
...
.LBB1_284:                              #   in Loop: Header=BB1_250 Depth=1
	...
	b	.LBB1_249
.LBB1_285:                              #   in Loop: Header=BB1_287 Depth=2
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	ld.w	$a1, $sp, 416
	...
	jirl	$ra, $ra, 0
.LBB1_286:                              # %.backedge.i
                                        #   in Loop: Header=BB1_287 Depth=2
	addi.d	$a0, $sp, 932
	ori	$a1, $zero, 512
	move	$a2, $s6
	pcaddu18i	$ra, %call36(fgets)
	...
	addi.d	$a1, $sp, 932
	bne	$a0, $a1, .LBB1_317
.LBB1_287:                              #   Parent Loop BB1_250 Depth=1
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB1_317
# %bb.288:                              #   in Loop: Header=BB1_287 Depth=2
	ld.w	$a0, $sp, 416
	addi.w	$s4, $a0, 1
	st.w	$s4, $sp, 416
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_315
# %bb.289:                              #   in Loop: Header=BB1_287 Depth=2
	...
	ori	$a1, $zero, 3
	beq	$a0, $a1, .LBB1_291
# %bb.290:                              #   in Loop: Header=BB1_287 Depth=2
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	move	$a5, $a0
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_291:                              #   in Loop: Header=BB1_287 Depth=2
	fld.s	$fa0, $sp, 1676
	ftintrz.w.s	$fa0, $fa0
	movfr2gr.s	$s0, $fa0
	beqz	$s0, .LBB1_286
# %bb.292:                              #   in Loop: Header=BB1_287 Depth=2
	ld.bu	$a0, $s2, 60
	andi	$a1, $a0, 127
	addi.d	$a0, $sp, 1880
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_286
# %bb.293:                              #   in Loop: Header=BB1_287 Depth=2
	move	$s4, $a0
	ld.bu	$a0, $s2, 60
	andi	$a1, $a0, 127
	addi.d	$a0, $sp, 1780
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_286
# %bb.294:                              #   in Loop: Header=BB1_287 Depth=2
	beq	$s4, $s7, .LBB1_297
# %bb.295:                              #   in Loop: Header=BB1_287 Depth=2
	slli.d	$a1, $s4, 1
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	ldx.hu	$a1, $a2, $a1
	bnez	$a1, .LBB1_285
# %bb.296:                              #   in Loop: Header=BB1_287 Depth=2
...
.LBB1_299:                              #   in Loop: Header=BB1_287 Depth=2
	ori	$s4, $zero, 1
	ori	$a2, $zero, 2
	blt	$fp, $a2, .LBB1_303
# %bb.300:                              # %.lr.ph583.preheader.i
                                        #   in Loop: Header=BB1_287 Depth=2
	addi.d	$a2, $fp, -1
	ori	$s4, $zero, 1
...
.LBB1_301:                              # %.lr.ph583.i
                                        ...
                                        #     Parent Loop BB1_287 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$a4, $a3, 0
	beq	$a4, $s0, .LBB1_303
# %bb.302:                              #   in Loop: Header=BB1_301 Depth=3
	addi.w	$s4, $s4, 1
	addi.d	$a2, $a2, -1
	addi.d	$a3, $a3, 2
	bnez	$a2, .LBB1_301
	b	.LBB1_304
.LBB1_303:                              # %._crit_edge584.i
                                        #   in Loop: Header=BB1_287 Depth=2
	bne	$s4, $fp, .LBB1_307
.LBB1_304:                              # %._crit_edge584.thread.i
                                        #   in Loop: Header=BB1_287 Depth=2
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	ld.w	$a0, $sp, 1680
	bne	$fp, $a0, .LBB1_306
# %bb.305:                              #   in Loop: Header=BB1_287 Depth=2
	move	$s4, $a5
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	...
	jirl	$ra, $ra, 0
	ld.hu	$a1, $s4, 0
.LBB1_306:                              #   in Loop: Header=BB1_287 Depth=2
	slli.d	$a0, $fp, 1
	move	$s4, $fp
	addi.w	$fp, $fp, 1
...
.LBB1_307:                              #   in Loop: Header=BB1_287 Depth=2
...
.LBB1_309:                              # %.lr.ph593.i
	...
	ld.bu	$a3, $a3, -1
	bgeu	$a3, $a0, .LBB1_311
# %bb.310:                              #   in Loop: Header=BB1_309 Depth=3
	ldx.b	$a4, $a7, $a2
	addi.d	$a5, $a2, -1
	stx.b	$a3, $a6, $a2
	...
	blt	$a1, $a5, .LBB1_309
	b	.LBB1_314
.LBB1_311:                              #   in Loop: Header=BB1_287 Depth=2
	addi.d	$a1, $a2, -1
	bstrpick.d	$a1, $a1, 31, 0
	ldx.bu	$a1, $a6, $a1
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	bne	$a1, $a0, .LBB1_313
# %bb.312:                              #   in Loop: Header=BB1_287 Depth=2
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	ld.w	$a1, $sp, 416
...
.LBB1_315:                              # %.outer.i
	...
	beq	$a0, $a1, .LBB1_287
	b	.LBB1_318
.LBB1_316:                              #   in Loop: Header=BB1_250 Depth=1
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	move	$a5, $a0
	...
	jirl	$ra, $ra, 0
	b	.LBB1_248
.LBB1_317:                              #   in Loop: Header=BB1_250 Depth=1
	ld.d	$s0, $sp, 192                   # 8-byte Folded Reload
.LBB1_318:                              # %.critedge11.i
                                        #   in Loop: Header=BB1_250 Depth=1
	st.h	$fp, $s0, 0
	ld.d	$s7, $sp, 296                   # 8-byte Folded Reload
...
# %bb.331:                              # %.lr.ph624.i.preheader
	...
	b	.LBB1_334
.LBB1_332:                              #   in Loop: Header=BB1_334 Depth=1
	addi.d	$a4, $sp, 412
	addi.d	$a7, $sp, 416
	st.d	$s4, $sp, 0
	move	$a0, $s2
	...
	pcaddu18i	$ra, %call36(ReadCharMetrics)
	jirl	$ra, $ra, 0
.LBB1_333:                              #   in Loop: Header=BB1_334 Depth=1
	addi.d	$a0, $sp, 932
	ori	$a1, $zero, 512
	move	$a2, $s4
	pcaddu18i	$ra, %call36(fgets)
...
.LBB1_334:                              # %.lr.ph624.i
                                        ...
                                        #       Child Loop BB1_353 Depth 3
                                        #         Child Loop BB1_356 Depth 4
	ld.w	$a0, $sp, 416
	addi.d	$a0, $a0, 1
	st.w	$a0, $sp, 416
	addi.d	$a0, $sp, 932
	...
	ori	$a1, $zero, 83
	bne	$a0, $a1, .LBB1_333
# %bb.335:                              #   in Loop: Header=BB1_334 Depth=1
	ld.d	$a0, $sp, 420
	ld.d	$a1, $sp, 428
	ld.d	$a2, $sp, 434
	...
	or	$a0, $a0, $a2
	beqz	$a0, .LBB1_332
# %bb.336:                              #   in Loop: Header=BB1_334 Depth=1
	ld.d	$a0, $sp, 420
	ld.d	$a1, $sp, 428
	ld.d	$a2, $sp, 433
	...
	or	$a0, $a0, $a2
	bnez	$a0, .LBB1_333
# %bb.337:                              #   in Loop: Header=BB1_334 Depth=1
	addi.d	$a0, $sp, 1880
	ori	$a1, $zero, 512
	b	.LBB1_339
.LBB1_338:                              #   in Loop: Header=BB1_339 Depth=2
	slli.d	$a0, $s4, 2
	alsl.d	$a0, $s4, $a0, 1
	ld.d	$a1, $sp, 368                   # 8-byte Folded Reload
	stx.b	$zero, $a1, $a0
...
.LBB1_339:                              #   Parent Loop BB1_334 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_344 Depth 3
                                        #       Child Loop BB1_353 Depth 3
                                        #         Child Loop BB1_356 Depth 4
...
# %bb.340:                              # %.lr.ph90.i.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_364
# %bb.341:                              #   in Loop: Header=BB1_339 Depth=2
	ld.w	$a0, $sp, 416
	addi.w	$s4, $a0, 1
	st.w	$s4, $sp, 416
	addi.d	$a0, $sp, 1880
	...
	ori	$a1, $zero, 2
	beq	$a0, $a1, .LBB1_343
# %bb.342:                              #   in Loop: Header=BB1_339 Depth=2
	move	$a0, $s5
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	move	$a5, $a0
...
.LBB1_343:                              # %.preheader759
	...
	beqz	$a0, .LBB1_347
	.p2align	4, , 16
.LBB1_344:                              #   Parent Loop BB1_334 Depth=1
                                        #     Parent Loop BB1_339 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	beq	$a0, $s1, .LBB1_347
# %bb.345:                              #   in Loop: Header=BB1_344 Depth=3
	beq	$a0, $s8, .LBB1_348
# %bb.346:                              #   in Loop: Header=BB1_344 Depth=3
	addi.d	$s6, $s6, 1
	addi.d	$a0, $sp, 1880
	ldx.bu	$a0, $s6, $a0
	bnez	$a0, .LBB1_344
.LBB1_347:                              #   in Loop: Header=BB1_339 Depth=2
	move	$a0, $s5
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	ld.w	$a6, $sp, 416
...
.LBB1_348:                              # %.loopexit79.i.i
	...
	move	$s4, $a0
	bnez	$a0, .LBB1_350
# %bb.349:                              #   in Loop: Header=BB1_339 Depth=2
	move	$a0, $s5
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	ld.w	$a6, $sp, 416
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_350:                              #   in Loop: Header=BB1_339 Depth=2
	ld.w	$a0, $sp, 1676
	slli.d	$a1, $s4, 1
	ld.d	$a2, $sp, 336                   # 8-byte Folded Reload
	stx.h	$s0, $a2, $a1
	blez	$a0, .LBB1_362
# %bb.351:                              # %.lr.ph.i.preheader.i
                                        #   in Loop: Header=BB1_339 Depth=2
	move	$s4, $zero
	b	.LBB1_353
	.p2align	4, , 16
.LBB1_352:                              #   in Loop: Header=BB1_353 Depth=3
	ld.bu	$a0, $s2, 60
	andi	$a1, $a0, 127
	addi.d	$a0, $sp, 1680
	pcaddu18i	$ra, %call36(MapCharEncoding)
...
# %bb.354:                              #   in Loop: Header=BB1_353 Depth=3
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_355:                              #   in Loop: Header=BB1_353 Depth=3
	srai.d	$s6, $s6, 32
	.p2align	4, , 16
.LBB1_356:                              #   Parent Loop BB1_334 Depth=1
                                        #     Parent Loop BB1_339 Depth=2
                                        #       Parent Loop BB1_353 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ldx.bu	$a0, $s7, $s6
	addi.d	$s6, $s6, 1
	beqz	$a0, .LBB1_359
# %bb.357:                              #   in Loop: Header=BB1_356 Depth=4
	beq	$a0, $s8, .LBB1_360
# %bb.358:                              #   in Loop: Header=BB1_356 Depth=4
	bne	$a0, $s1, .LBB1_356
.LBB1_359:                              #   in Loop: Header=BB1_353 Depth=3
	move	$a0, $s5
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	ld.w	$a6, $sp, 416
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_360:                              # %.loopexit.i.i
                                        #   in Loop: Header=BB1_353 Depth=3
	ori	$a0, $zero, 256
	blt	$s0, $a0, .LBB1_352
# %bb.361:                              #   in Loop: Header=BB1_353 Depth=3
	move	$a0, $s5
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	ld.w	$a6, $sp, 416
	...
	jirl	$ra, $ra, 0
	b	.LBB1_352
.LBB1_362:                              # %._crit_edge.i.i
                                        #   in Loop: Header=BB1_339 Depth=2
	addi.w	$s4, $s0, 0
	ori	$a0, $zero, 256
	blt	$s4, $a0, .LBB1_338
# %bb.363:                              #   in Loop: Header=BB1_339 Depth=2
	move	$a0, $s5
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
	ld.w	$a6, $sp, 416
	...
	jirl	$ra, $ra, 0
	b	.LBB1_338
.LBB1_364:                              # %.critedge.i.i
                                        #   in Loop: Header=BB1_334 Depth=1
	addi.d	$a0, $sp, 1880
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(StringBeginsWith)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB1_333
.LBB1_365:                              # %.loopexit80.i.i
                                        #   in Loop: Header=BB1_334 Depth=1
	move	$a0, $s5
	pcaddu18i	$ra, %call36(FileName)
	jirl	$ra, $ra, 0
...
# %bb.40:                               #   in Loop: Header=BB16_39 Depth=3
	...
	b	.LBB16_13
	.p2align	4, , 16
.LBB16_41:                              #   in Loop: Header=BB16_14 Depth=2
	move	$a0, $s2
	.p2align	4, , 16
.LBB16_42:                              # %.preheader
                                        #   Parent Loop BB16_7 Depth=1
