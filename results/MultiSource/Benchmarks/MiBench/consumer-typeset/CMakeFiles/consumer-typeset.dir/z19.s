...
# %bb.393:
	ld.d	$a4, $sp, 280                   # 8-byte Folded Reload
	b	.LBB2_395
.LBB2_394:                              #   in Loop: Header=BB2_395 Depth=1
	ld.bu	$a1, $a0, 32
	addi.d	$a2, $a1, -11
	sltui	$a2, $a2, 2
	addi.d	$a3, $a0, 33
...
# %bb.396:                              #   in Loop: Header=BB2_395 Depth=1
	...
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
.LBB2_397:                              #   in Loop: Header=BB2_395 Depth=1
	ld.d	$a1, $a0, 8
	st.d	$a0, $s5, 0
	beq	$a1, $a0, .LBB2_394
# %bb.398:                              #   in Loop: Header=BB2_395 Depth=1
	st.d	$a1, $s1, 0
	ld.d	$a0, $a0, 0
	st.d	$a0, $a1, 0
	ld.d	$a1, $s5, 0
...
# %bb.413:
	ld.d	$a4, $sp, 280                   # 8-byte Folded Reload
	b	.LBB2_415
.LBB2_414:                              #   in Loop: Header=BB2_415 Depth=1
	ld.bu	$a1, $a0, 32
	addi.d	$a2, $a1, -11
	sltui	$a2, $a2, 2
	addi.d	$a3, $a0, 33
...
# %bb.423:                              #   in Loop: Header=BB2_422 Depth=1
	...
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
.LBB2_424:                              #   in Loop: Header=BB2_422 Depth=1
	ld.d	$a1, $a0, 8
	st.d	$a0, $s5, 0
	beq	$a1, $a0, .LBB2_421
# %bb.425:                              #   in Loop: Header=BB2_422 Depth=1
	st.d	$a1, $s1, 0
	ld.d	$a0, $a0, 0
	st.d	$a0, $a1, 0
	ld.d	$a1, $s5, 0
...
.LBB2_435:                              #   in Loop: Header=BB2_433 Depth=1
	...
	st.d	$a0, $s5, 0
	beq	$a1, $a0, .LBB2_432
# %bb.436:                              #   in Loop: Header=BB2_433 Depth=1
	st.d	$a1, $s1, 0
	ld.d	$a0, $a0, 0
	st.d	$a0, $a1, 0
	ld.d	$a1, $s5, 0
...
# %bb.441:                              #   in Loop: Header=BB2_440 Depth=1
	...
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
.LBB2_442:                              #   in Loop: Header=BB2_440 Depth=1
	ld.d	$a1, $a0, 8
	st.d	$a0, $s5, 0
	beq	$a1, $a0, .LBB2_439
# %bb.443:                              #   in Loop: Header=BB2_440 Depth=1
	st.d	$a1, $s1, 0
	ld.d	$a0, $a0, 0
	st.d	$a0, $a1, 0
	ld.d	$a1, $s5, 0
...
# %bb.451:
	ld.d	$a4, $sp, 280                   # 8-byte Folded Reload
	b	.LBB2_453
.LBB2_452:                              #   in Loop: Header=BB2_453 Depth=1
	ld.bu	$a1, $a0, 32
	addi.d	$a2, $a1, -11
	sltui	$a2, $a2, 2
	addi.d	$a3, $a0, 33
...
.LBB2_453:                              # %.lr.ph1235
	...
	st.d	$a0, $a5, 0
	beq	$a1, $a0, .LBB2_455
# %bb.454:                              #   in Loop: Header=BB2_453 Depth=1
	ld.d	$a2, $a0, 16
	st.d	$a1, $s1, 0
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
.LBB2_455:                              #   in Loop: Header=BB2_453 Depth=1
	ld.d	$a1, $a0, 8
	st.d	$a0, $s5, 0
	beq	$a1, $a0, .LBB2_452
# %bb.456:                              #   in Loop: Header=BB2_453 Depth=1
	st.d	$a1, $s1, 0
	ld.d	$a0, $a0, 0
	st.d	$a0, $a1, 0
	ld.d	$a1, $s5, 0
	...
	st.d	$a1, $a1, 8
	b	.LBB2_452
.LBB2_457:                              # %.preheader1050
	ld.d	$a0, $s0, 8
	beq	$a0, $s0, .LBB2_464
# %bb.458:
	ld.d	$a4, $sp, 280                   # 8-byte Folded Reload
	b	.LBB2_460
.LBB2_459:                              #   in Loop: Header=BB2_460 Depth=1
	ld.bu	$a1, $a0, 32
	addi.d	$a2, $a1, -11
	sltui	$a2, $a2, 2
	addi.d	$a3, $a0, 33
...
.LBB2_460:                              # %.lr.ph1237
	...
	st.d	$a0, $a5, 0
	beq	$a1, $a0, .LBB2_462
# %bb.461:                              #   in Loop: Header=BB2_460 Depth=1
	ld.d	$a2, $a0, 16
	st.d	$a1, $s1, 0
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
.LBB2_462:                              #   in Loop: Header=BB2_460 Depth=1
	ld.d	$a1, $a0, 8
	st.d	$a0, $s5, 0
	beq	$a1, $a0, .LBB2_459
# %bb.463:                              #   in Loop: Header=BB2_460 Depth=1
	st.d	$a1, $s1, 0
	ld.d	$a0, $a0, 0
	st.d	$a0, $a1, 0
	ld.d	$a1, $s5, 0
...
.LJTI2_0:
	...
	.word	.LBB2_98-.LJTI2_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function InterposeScale
...
.Lfunc_end3:
	.size	InterposeScale, .Lfunc_end3-InterposeScale
                                        # -- End function
	.p2align	2                               # -- Begin function InterposeWideOrHigh
