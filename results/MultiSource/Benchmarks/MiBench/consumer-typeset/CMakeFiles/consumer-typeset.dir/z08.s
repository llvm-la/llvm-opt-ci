...
# %bb.0:
	...
	ld.w	$a0, $s8, %pc_lo12(Manifest.depth)
	ld.d	$a1, $sp, 944
...
.LBB1_311:                              #   in Loop: Header=BB1_298 Depth=1
	...
	bne	$a2, $a0, .LBB1_308
	b	.LBB1_309
.LBB1_312:                              #   in Loop: Header=BB1_298 Depth=1
	pcaddu18i	$ra, %call36(DisposeObject)
	jirl	$ra, $ra, 0
	ori	$a5, $zero, 17
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	b	.LBB1_297
.LBB1_313:                              # %._crit_edge2516
...
.LBB1_328:                              # %.loopexit2469
	...
	beq	$s0, $a0, .LBB1_346
# %bb.329:                              # %.preheader2468.preheader
	ori	$a6, $zero, 17
	pcalau12i	$a1, %got_pc_hi20(xx_link)
	ld.d	$s2, $a1, %got_pc_lo12(xx_link)
	pcalau12i	$a1, %got_pc_hi20(xx_tmp)
	...
	b	.LBB1_332
	.p2align	4, , 16
.LBB1_330:                              #   in Loop: Header=BB1_332 Depth=1
	st.d	$fp, $sp, 816
	move	$s1, $s0
.LBB1_331:                              #   in Loop: Header=BB1_332 Depth=1
	ld.d	$s0, $s1, 8
	beq	$s0, $a0, .LBB1_346
.LBB1_332:                              # %.preheader2468
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB1_333 Depth 2
	move	$fp, $s0
	.p2align	4, , 16
.LBB1_333:                              #   Parent Loop BB1_332 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$fp, $fp, 16
	ld.bu	$a1, $fp, 32
	beqz	$a1, .LBB1_333
# %bb.334:                              #   in Loop: Header=BB1_332 Depth=1
	bne	$a1, $a6, .LBB1_330
# %bb.335:                              #   in Loop: Header=BB1_332 Depth=1
	ld.d	$s5, $fp, 8
	st.d	$fp, $sp, 816
	beq	$s5, $fp, .LBB1_340
# %bb.336:                              #   in Loop: Header=BB1_332 Depth=1
	ld.bu	$a1, $s5, 32
	beqz	$a1, .LBB1_338
# %bb.337:                              #   in Loop: Header=BB1_332 Depth=1
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
...
.LBB1_338:                              #   in Loop: Header=BB1_332 Depth=1
	st.d	$s5, $s8, 0
	st.d	$fp, $s4, 0
	ld.d	$a2, $fp, 0
	...
	st.d	$s0, $s4, 0
	beqz	$s0, .LBB1_340
# %bb.339:                              #   in Loop: Header=BB1_332 Depth=1
	ld.d	$a2, $s0, 0
	st.d	$a2, $a1, 0
	ld.d	$a2, $s5, 0
	st.d	$a2, $s0, 0
	...
	ld.d	$a2, $s8, 0
	st.d	$a2, $a1, 8
.LBB1_340:                              #   in Loop: Header=BB1_332 Depth=1
	ld.d	$a1, $fp, 24
	ld.d	$a2, $a1, 24
	st.d	$a1, $s2, 0
	beq	$a2, $a1, .LBB1_345
# %bb.341:                              #   in Loop: Header=BB1_332 Depth=1
	ld.d	$a3, $a1, 16
	st.d	$a2, $s8, 0
	st.d	$a3, $a2, 16
	st.d	$a2, $a3, 24
	...
	st.d	$a1, $s4, 0
	beq	$a3, $a1, .LBB1_343
.LBB1_342:                              #   in Loop: Header=BB1_332 Depth=1
	st.d	$a3, $s8, 0
	ld.d	$a1, $a1, 0
	st.d	$a1, $a3, 0
	ld.d	$a2, $s4, 0
	...
	ld.d	$a1, $s2, 0
	st.d	$a2, $a2, 8
.LBB1_343:                              #   in Loop: Header=BB1_332 Depth=1
	ld.bu	$a2, $a1, 32
	addi.d	$a3, $a2, -11
	sltui	$a3, $a3, 2
	addi.d	$a4, $a1, 33
	...
	ld.d	$a2, $a1, 24
	bne	$a2, $a1, .LBB1_331
# %bb.344:                              #   in Loop: Header=BB1_332 Depth=1
	move	$a0, $a1
	pcaddu18i	$ra, %call36(DisposeObject)
	jirl	$ra, $ra, 0
	ori	$a6, $zero, 17
...
# %bb.349:
	beq	$s1, $a0, .LBB1_360
# %bb.350:                              # %.preheader2467.preheader
	ori	$s3, $zero, 1
	move	$s0, $s1
.LBB1_351:                              # %.preheader2467
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB1_352 Depth 2
                                        #     Child Loop BB1_354 Depth 2
	move	$a1, $s2
	.p2align	4, , 16
.LBB1_352:                              #   Parent Loop BB1_351 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $a1, 16
	ld.bu	$a2, $a1, 32
	beqz	$a2, .LBB1_352
# %bb.353:                              # %.preheader2466.preheader
                                        #   in Loop: Header=BB1_351 Depth=1
	move	$a3, $s0
	.p2align	4, , 16
.LBB1_354:                              # %.preheader2466
                                        #   Parent Loop BB1_351 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a3, 16
	ld.bu	$a4, $a3, 32
	beqz	$a4, .LBB1_354
# %bb.355:                              #   in Loop: Header=BB1_351 Depth=1
	addi.d	$a5, $a2, -11
	addi.d	$a6, $a4, -11
	or	$a5, $a6, $a5
	andi	$a5, $a5, 255
	bltu	$s3, $a5, .LBB1_357
# %bb.356:                              #   in Loop: Header=BB1_351 Depth=1
	addi.d	$a0, $a1, 64
	addi.d	$a1, $a3, 64
	...
	beqz	$a1, .LBB1_358
	b	.LBB1_361
.LBB1_357:                              #   in Loop: Header=BB1_351 Depth=1
	bne	$a2, $a4, .LBB1_361
.LBB1_358:                              #   in Loop: Header=BB1_351 Depth=1
	ld.d	$s2, $s2, 8
	ld.d	$s0, $s0, 8
	ld.d	$a1, $sp, 272                   # 8-byte Folded Reload
	beq	$s2, $a1, .LBB1_361
# %bb.359:                              #   in Loop: Header=BB1_351 Depth=1
	bne	$s0, $a0, .LBB1_351
	b	.LBB1_361
.LBB1_360:
	move	$s0, $s1
.LBB1_361:                              # %._crit_edge2526
	ori	$a1, $zero, 74
	beq	$fp, $a1, .LBB1_398
# %bb.362:                              # %._crit_edge2526
	ori	$a1, $zero, 73
	ld.d	$s3, $sp, 128                   # 8-byte Folded Reload
	bne	$fp, $a1, .LBB1_765
# %bb.363:
...
.LBB1_643:                              #   in Loop: Header=BB1_596 Depth=1
	beqz	$s1, .LBB1_646
# %bb.644:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $s1, 8
	beq	$a0, $s1, .LBB1_647
# %bb.645:                              #   in Loop: Header=BB1_596 Depth=1
	bnez	$s5, .LBB1_648
	b	.LBB1_657
	.p2align	4, , 16
...
.LBB1_647:                              #   in Loop: Header=BB1_596 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$s5, .LBB1_657
.LBB1_648:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $s5, 8
	beq	$a0, $s5, .LBB1_657
# %bb.649:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a2, $sp, 208                   # 8-byte Folded Reload
	st.d	$s3, $sp, 160                   # 8-byte Folded Spill
	beqz	$a2, .LBB1_658
.LBB1_650:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $a2, 8
	bne	$a0, $a2, .LBB1_652
# %bb.651:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a2, $a0, %pc_lo12(.L.str)
	...
	jirl	$ra, $ra, 0
	ld.d	$a2, $sp, 208                   # 8-byte Folded Reload
.LBB1_652:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $s1, 0
	.p2align	4, , 16
.LBB1_653:                              #   Parent Loop BB1_596 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $a0, 16
	ld.bu	$a1, $a0, 32
	beqz	$a1, .LBB1_653
# %bb.654:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a1, $a2, 0
	.p2align	4, , 16
.LBB1_655:                              #   Parent Loop BB1_596 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $a1, 16
	ld.bu	$a2, $a1, 32
	beqz	$a2, .LBB1_655
# %bb.656:                              #   in Loop: Header=BB1_596 Depth=1
	xor	$a0, $a0, $a1
	sltui	$a0, $a0, 1
	st.d	$a0, $sp, 152                   # 8-byte Folded Spill
	b	.LBB1_659
...
.LBB1_659:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$s2, $s5, 8
	ld.d	$s6, $s1, 8
	xor	$a0, $s2, $s5
	sltu	$s3, $zero, $a0
	beq	$s2, $s5, .LBB1_676
# %bb.660:                              #   in Loop: Header=BB1_596 Depth=1
	beq	$s6, $s1, .LBB1_676
	.p2align	4, , 16
.LBB1_661:                              # %.preheader2462
                                        #   Parent Loop BB1_596 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_662 Depth 3
                                        #       Child Loop BB1_664 Depth 3
	move	$s3, $s2
	.p2align	4, , 16
.LBB1_662:                              #   Parent Loop BB1_596 Depth=1
                                        #     Parent Loop BB1_661 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$s3, $s3, 16
	ld.bu	$a0, $s3, 32
	beqz	$a0, .LBB1_662
# %bb.663:                              # %.preheader2461.preheader
                                        #   in Loop: Header=BB1_661 Depth=2
	move	$fp, $s6
	.p2align	4, , 16
.LBB1_664:                              # %.preheader2461
                                        #   Parent Loop BB1_596 Depth=1
                                        #     Parent Loop BB1_661 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$fp, $fp, 16
	ld.bu	$a0, $fp, 32
	beqz	$a0, .LBB1_664
# %bb.665:                              #   in Loop: Header=BB1_661 Depth=2
	bne	$s3, $fp, .LBB1_667
# %bb.666:                              #   in Loop: Header=BB1_661 Depth=2
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a2, $a0, %pc_lo12(.L.str)
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_667:                              #   in Loop: Header=BB1_661 Depth=2
	...
	st.d	$fp, $a0, 0
	beq	$a2, $fp, .LBB1_672
# %bb.668:                              #   in Loop: Header=BB1_661 Depth=2
	pcalau12i	$a3, %got_pc_hi20(zz_res)
	ld.d	$a3, $a3, %got_pc_lo12(zz_res)
	ld.d	$a4, $fp, 16
	st.d	$a2, $a3, 0
	...
	st.d	$fp, $s7, 0
	beq	$a3, $fp, .LBB1_673
.LBB1_669:                              #   in Loop: Header=BB1_661 Depth=2
	pcalau12i	$a2, %got_pc_hi20(zz_res)
	ld.d	$a2, $a2, %got_pc_lo12(zz_res)
	st.d	$a3, $a2, 0
	ld.d	$a4, $fp, 0
	...
	st.d	$a3, $s7, 0
	beqz	$a3, .LBB1_674
# %bb.670:                              #   in Loop: Header=BB1_661 Depth=2
	beqz	$a1, .LBB1_674
# %bb.671:                              #   in Loop: Header=BB1_661 Depth=2
	ld.d	$a4, $a3, 0
	pcalau12i	$a5, %got_pc_hi20(zz_tmp)
	ld.d	$a5, $a5, %got_pc_lo12(zz_tmp)
	st.d	$a4, $a5, 0
...
.LBB1_673:                              # %.thread2984
	...
	ld.d	$a1, $a1, %got_pc_lo12(zz_res)
	st.d	$s3, $a1, 0
.LBB1_674:                              #   in Loop: Header=BB1_661 Depth=2
	ld.d	$a0, $a0, 0
	ld.bu	$a1, $a0, 32
	addi.d	$a2, $a1, -11
	sltui	$a2, $a2, 2
	...
	sltu	$s3, $zero, $a0
	beq	$s2, $s5, .LBB1_676
# %bb.675:                              #   in Loop: Header=BB1_661 Depth=2
	bne	$s6, $s1, .LBB1_661
.LBB1_676:                              # %.critedge.i
                                        #   in Loop: Header=BB1_596 Depth=1
	beq	$s6, $s1, .LBB1_682
...
# %bb.678:                              #   in Loop: Header=BB1_596 Depth=1
	ld.bu	$a0, $s6, 32
	beqz	$a0, .LBB1_680
# %bb.679:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a2, $a0, %pc_lo12(.L.str)
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_680:                              #   in Loop: Header=BB1_596 Depth=1
	pcalau12i	$a0, %got_pc_hi20(zz_res)
	ld.d	$a0, $a0, %got_pc_lo12(zz_res)
	st.d	$s6, $a0, 0
	st.d	$s1, $s7, 0
	...
	st.d	$a2, $s7, 0
	beqz	$a2, .LBB1_682
# %bb.681:                              #   in Loop: Header=BB1_596 Depth=1
	...
	ld.d	$a0, $a0, 0
	st.d	$a0, $a1, 8
.LBB1_682:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(DisposeObject)
	jirl	$ra, $ra, 0
...
# %bb.683:                              #   in Loop: Header=BB1_596 Depth=1
	ld.bu	$a0, $s2, 32
	beqz	$a0, .LBB1_685
# %bb.684:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a2, $a0, %pc_lo12(.L.str)
	...
	jirl	$ra, $ra, 0
	ld.d	$a2, $sp, 208                   # 8-byte Folded Reload
.LBB1_685:                              #   in Loop: Header=BB1_596 Depth=1
	pcalau12i	$a0, %got_pc_hi20(zz_res)
	ld.d	$a0, $a0, %got_pc_lo12(zz_res)
	st.d	$s2, $a0, 0
	st.d	$s5, $s7, 0
	beqz	$s5, .LBB1_687
# %bb.686:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a1, $s5, 0
	pcalau12i	$a2, %got_pc_hi20(zz_tmp)
	ld.d	$a2, $a2, %got_pc_lo12(zz_tmp)
	st.d	$a1, $a2, 0
	...
	st.d	$a1, $a2, 8
	ld.d	$a2, $sp, 208                   # 8-byte Folded Reload
.LBB1_687:                              #   in Loop: Header=BB1_596 Depth=1
	st.d	$s2, $a0, 0
	st.d	$a2, $s7, 0
	beqz	$a2, .LBB1_595
# %bb.688:                              #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a1, $a2, 0
	move	$a3, $a2
	pcalau12i	$a2, %got_pc_hi20(zz_tmp)
	ld.d	$a2, $a2, %got_pc_lo12(zz_tmp)
