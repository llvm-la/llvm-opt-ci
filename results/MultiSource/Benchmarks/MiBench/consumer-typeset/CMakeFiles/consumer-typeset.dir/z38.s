...
# %bb.39:                               #   in Loop: Header=BB0_21 Depth=1
	...
	move	$a2, $fp
	.p2align	4, , 16
.LBB0_40:                               #   Parent Loop BB0_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$a3, $a1, $s0
	move	$a0, $a2
	add.w	$a2, $a2, $a3
...
.LBB6_46:                               #   in Loop: Header=BB6_13 Depth=1
	...
	jirl	$ra, $ra, 0
	move	$a3, $fp
.LBB6_47:                               #   in Loop: Header=BB6_13 Depth=1
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$s3, $fp, 0
	beqz	$a0, .LBB6_49
# %bb.48:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a1, $s3, 16
	ld.d	$a2, $a0, 16
	st.d	$a1, $s8, 0
	st.d	$a2, $s3, 16
	...
	st.d	$a1, $a0, 16
	st.d	$a0, $a1, 24
.LBB6_49:                               #   in Loop: Header=BB6_13 Depth=1
	ld.bu	$a2, $s2, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s5, $a0
	st.w	$a2, $s6, 0
	beqz	$a0, .LBB6_51
# %bb.50:                               #   in Loop: Header=BB6_13 Depth=1
	st.d	$a0, $fp, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $s5, 3
	st.d	$a1, $a2, 0
	b	.LBB6_52
.LBB6_51:                               #   in Loop: Header=BB6_13 Depth=1
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	pcaddu18i	$ra, %call36(GetMemory)
	jirl	$ra, $ra, 0
.LBB6_52:                               #   in Loop: Header=BB6_13 Depth=1
	lu12i.w	$s2, 131072
	...
	st.d	$s7, $fp, 0
	beqz	$a0, .LBB6_54
# %bb.53:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a1, $s7, 16
	ld.d	$a2, $a0, 16
	st.d	$a1, $s8, 0
	st.d	$a2, $s7, 16
	...
	st.d	$a1, $a0, 16
	st.d	$a0, $a1, 24
.LBB6_54:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
...
.LBB6_56:                               #   in Loop: Header=BB6_13 Depth=1
	...
	st.d	$s3, $a2, 0
	beqz	$s3, .LBB6_58
# %bb.57:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a4, $s3, 0
	pcalau12i	$a5, %got_pc_hi20(zz_tmp)
	ld.d	$a5, $a5, %got_pc_lo12(zz_tmp)
	st.d	$a4, $a5, 0
...
# %bb.59:                               #   in Loop: Header=BB6_13 Depth=1
	beqz	$a0, .LBB6_10
# %bb.60:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a1, $s5, 16
	pcalau12i	$a2, %got_pc_hi20(zz_tmp)
	ld.d	$a2, $a2, %got_pc_lo12(zz_tmp)
	ld.d	$a3, $a0, 16
...
# %bb.63:                               #   in Loop: Header=BB6_13 Depth=1
	...
	st.d	$a1, $a0, 0
	b	.LBB6_65
.LBB6_64:                               #   in Loop: Header=BB6_13 Depth=1
	pcalau12i	$a1, %got_pc_hi20(no_fpos)
	ld.d	$a1, $a1, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a1, 0
	move	$fp, $a3
...
# %bb.66:                               #   in Loop: Header=BB6_13 Depth=1
	...
	st.d	$a2, $a1, 0
	b	.LBB6_68
.LBB6_67:                               #   in Loop: Header=BB6_13 Depth=1
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	...
	move	$a3, $fp
	ld.d	$fp, $sp, 96                    # 8-byte Folded Reload
.LBB6_68:                               #   in Loop: Header=BB6_13 Depth=1
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$s3, $s0, 0
	beqz	$a0, .LBB6_70
# %bb.69:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a1, $s3, 16
	ld.d	$a2, $a0, 16
	st.d	$a1, $s2, 0
	st.d	$a2, $s3, 16
	...
	st.d	$a1, $a0, 16
	st.d	$a0, $a1, 24
.LBB6_70:                               #   in Loop: Header=BB6_13 Depth=1
	ld.bu	$a2, $s5, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s7, $a0
	st.w	$a2, $s6, 0
	beqz	$a0, .LBB6_72
# %bb.71:                               #   in Loop: Header=BB6_13 Depth=1
	st.d	$a0, $s0, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $s7, 3
	st.d	$a1, $a2, 0
	b	.LBB6_73
.LBB6_72:                               #   in Loop: Header=BB6_13 Depth=1
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	pcaddu18i	$ra, %call36(GetMemory)
	jirl	$ra, $ra, 0
.LBB6_73:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$s6, $sp, 32                    # 8-byte Folded Reload
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	...
	st.d	$a3, $s0, 0
	beqz	$a3, .LBB6_76
# %bb.74:                               #   in Loop: Header=BB6_13 Depth=1
	beqz	$a0, .LBB6_76
# %bb.75:                               #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a1, $a3, 16
	ld.d	$a2, $a0, 16
	st.d	$a1, $s2, 0
	st.d	$a2, $a3, 16
	...
	st.d	$a1, $a0, 16
	st.d	$a0, $a1, 24
.LBB6_76:                               #   in Loop: Header=BB6_13 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(DoAddGap)
	jirl	$ra, $ra, 0
	ld.b	$a0, $s4, 0
...
.LBB6_112:                              # %.thread314
	...
	ld.d	$a0, $a0, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a0, 0
.LBB6_113:                              # %.loopexit.sink.split
	st.d	$a5, $a1, 0
.LBB6_114:                              # %.loopexit.sink.split
	pcalau12i	$a0, %got_pc_hi20(zz_hold)
	ld.d	$a0, $a0, %got_pc_lo12(zz_hold)
	ld.bu	$a1, $s0, 32
	st.d	$s0, $a0, 0
