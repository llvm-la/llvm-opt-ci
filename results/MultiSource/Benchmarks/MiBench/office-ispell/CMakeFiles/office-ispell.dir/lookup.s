...
# %bb.0:
	...
	pcalau12i	$s5, %pc_hi20(inited)
	ld.bu	$a0, $s5, %pc_lo12(inited)
	beqz	$a0, .LBB0_2
# %bb.1:
	move	$a0, $zero
	b	.LBB0_104
...
.LBB0_13:
	...
	ld.w	$a0, $fp, 24
	st.d	$s1, $s2, 0
	pcalau12i	$a1, %got_pc_hi20(numsflags)
	ld.d	$s6, $a1, %got_pc_lo12(numsflags)
	ld.w	$a1, $fp, 28
	st.w	$a0, $s6, 0
	pcalau12i	$a2, %got_pc_hi20(numpflags)
	ld.d	$a2, $a2, %got_pc_lo12(numpflags)
...
.LBB0_90:                               # %vector.body
	...
	vseqi.d	$vr4, $vr4, -1
	vandn.v	$vr4, $vr4, $vr6
	vpackev.d	$vr5, $vr3, $vr4
	vst	$vr5, $a6, -32
	vpackod.d	$vr3, $vr3, $vr4
	vst	$vr3, $a6, -8
	addi.d	$a7, $a7, -2
	addi.d	$a6, $a6, 48
	bnez	$a7, .LBB0_90
...
.L.str.11:
	.asciz	"/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c"
	.size	.L.str.11, 137
