...
.LBB2_100:                              # %vec.epilog.ph
	...
	add.d	$a7, $s1, $a4
	add.d	$a4, $s6, $a4
.LBB2_101:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a7, 0
...
.LBB2_144:                              # %vec.epilog.ph262
	...
	add.d	$a4, $s6, $a4
	.p2align	4, , 16
.LBB2_145:                              # %vec.epilog.vector.body265
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a7, 0
	addi.d	$a6, $a6, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a6, .LBB2_145
# %bb.146:                              # %vec.epilog.middle.block271
	bne	$a3, $a5, .LBB2_149
	b	.LBB2_150
.LBB2_147:
	move	$a3, $s6
...
.LBB2_149:                              # %.lr.ph8.i162
	...
	move	$a2, $a4
	bne	$a4, $a0, .LBB2_149
.LBB2_150:                              # %._crit_edge9.i142.loopexit
	move	$s2, $a1
	move	$a3, $a0
.LBB2_151:                              # %._crit_edge9.i142
...
.LBB2_154:                              # %.lr.ph18.i149
	...
	addi.d	$a0, $a0, 1
	bnez	$a2, .LBB2_154
.LBB2_155:                              # %.loopexit.i155.preheader
	add.d	$a0, $fp, $a1
	.p2align	4, , 16
.LBB2_156:                              # %.loopexit.i155
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $s2, 1
...
.LBB2_165:                              # %vector.body247
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB2_165
# %bb.166:                              # %middle.block254
	beq	$a3, $a4, .LBB2_150
# %bb.167:                              # %vec.epilog.iter.check260
	beqz	$a5, .LBB2_149
	b	.LBB2_144
.Lfunc_end2:
...
# %bb.30:
	move	$a2, $zero
.LBB10_31:                              # %vec.epilog.ph311
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	add.d	$a1, $s4, $a2
	.p2align	4, , 16
.LBB10_32:                              # %vec.epilog.vector.body314
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	srli.d	$a3, $a2, 56
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB10_32
# %bb.33:                               # %vec.epilog.middle.block318
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	bne	$a2, $a0, .LBB10_43
	b	.LBB10_51
.LBB10_34:                              # %vector.main.loop.iter.check269
	ori	$a0, $zero, 16
	bgeu	$s1, $a0, .LBB10_45
# %bb.35:
	move	$a2, $zero
.LBB10_36:                              # %vec.epilog.ph285
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	add.d	$a1, $s4, $a2
	.p2align	4, , 16
.LBB10_37:                              # %vec.epilog.vector.body288
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	srli.d	$a3, $a2, 56
	bstrpick.d	$a4, $a2, 55, 48
...
# %bb.38:                               # %vec.epilog.middle.block292
	...
	bne	$a2, $a0, .LBB10_49
	b	.LBB10_51
.LBB10_39:                              # %vector.body300.preheader
	addi.d	$a0, $sp, 208
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_40:                              # %vector.body300
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a0, 0
	vilvh.b	$vr1, $vr8, $vr0
	vilvh.h	$vr2, $vr8, $vr1
	...
	addi.d	$a0, $a0, 16
	bnez	$a1, .LBB10_40
# %bb.41:                               # %middle.block304
	addi.d	$s4, $sp, 208
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB10_51
# %bb.42:                               # %vec.epilog.iter.check309
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	move	$a2, $a1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	bnez	$a0, .LBB10_31
...
.LBB10_44:                              # %.lr.ph168
	...
	bnez	$a1, .LBB10_44
	b	.LBB10_51
.LBB10_45:                              # %vector.body274.preheader
	addi.d	$a0, $sp, 208
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_46:                              # %vector.body274
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a0, 0
	vilvh.b	$vr1, $vr8, $vr0
	vilvh.h	$vr2, $vr8, $vr1
	...
	addi.d	$a0, $a0, 16
	bnez	$a1, .LBB10_46
# %bb.47:                               # %middle.block278
	addi.d	$s4, $sp, 208
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB10_51
# %bb.48:                               # %vec.epilog.iter.check283
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	move	$a2, $a1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	bnez	$a0, .LBB10_36
...
# %bb.53:                               # %iter.check252
	...
	ori	$a3, $zero, 7
	bltu	$a2, $a3, .LBB10_70
# %bb.54:                               # %vector.main.loop.iter.check238
...
.LBB10_56:                              # %vec.epilog.ph256
	...
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_57:                              # %vec.epilog.vector.body259
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	srli.d	$a3, $a2, 56
	bstrpick.d	$a4, $a2, 55, 48
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB10_57
# %bb.58:                               # %vec.epilog.middle.block264
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
...
# %bb.65:                               # %vec.epilog.middle.block
	...
	bne	$a2, $a3, .LBB10_76
	b	.LBB10_78
.LBB10_66:                              # %vector.body243.preheader
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_67:                              # %vector.body243
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a0, 0
	vilvh.b	$vr1, $vr8, $vr0
	vilvh.h	$vr2, $vr8, $vr1
