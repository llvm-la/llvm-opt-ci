...
.LBB2_96:                               # %._crit_edge.i
	...
	jirl	$ra, $ra, 0
	bgeu	$s4, $a0, .LBB2_112
# %bb.97:                               # %.lr.ph8.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	sub.d	$a1, $a0, $s4
	ori	$a3, $zero, 32
	bltu	$a1, $a3, .LBB2_119
# %bb.98:                               # %.lr.ph8.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	sub.d	$a2, $s1, $s4
	bltu	$a2, $a3, .LBB2_119
# %bb.99:                               # %vector.ph
...
.LBB2_119:                              #   in Loop: Header=BB2_4 Depth=1
	move	$a1, $s4
.LBB2_120:                              # %.lr.ph8.i.preheader250
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$a2, $s1
.LBB2_121:                              # %.lr.ph8.i
                                        #   Parent Loop BB2_4 Depth=1
	...
	move	$a2, $s1
	bne	$a4, $a0, .LBB2_121
.LBB2_122:                              # %._crit_edge9.loopexit.i
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$a2, $a0
.LBB2_123:                              # %._crit_edge9.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$s1, $s6, 0
	ld.bu	$a1, $a2, 0
	beqz	$a1, .LBB2_127
...
# %bb.135:                              # %.lr.ph.preheader.i136
	...
	add.d	$fp, $fp, $s0
	move	$s2, $s5
.LBB2_136:                              # %._crit_edge.i139
	ld.d	$s0, $s6, 0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(skipoverword)
	jirl	$ra, $ra, 0
	bgeu	$s4, $a0, .LBB2_143
# %bb.137:                              # %.lr.ph8.i160.preheader
	sub.d	$a1, $a0, $s4
	ori	$a2, $zero, 32
	bltu	$a1, $a2, .LBB2_144
# %bb.138:                              # %.lr.ph8.i160.preheader
	sub.d	$a3, $s2, $s4
	bltu	$a3, $a2, .LBB2_144
# %bb.139:                              # %vector.ph232
	move	$a2, $a1
...
.LBB2_144:
	move	$a1, $s4
.LBB2_145:                              # %.lr.ph8.i160.preheader248
	move	$a2, $s2
	.p2align	4, , 16
.LBB2_146:                              # %.lr.ph8.i160
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a3, $a1, 0
	addi.d	$a4, $a1, 1
	addi.d	$s2, $a2, 1
	...
	move	$a2, $s2
	bne	$a4, $a0, .LBB2_146
.LBB2_147:                              # %._crit_edge9.loopexit.i164
	move	$a3, $a0
.LBB2_148:                              # %._crit_edge9.i142
	st.d	$s2, $s6, 0
	ld.bu	$a2, $a3, 0
	sub.d	$a1, $s0, $s5
	beqz	$a2, .LBB2_152
...
.LBB2_151:                              # %.lr.ph18.i149
	...
	addi.d	$a0, $a0, 1
	bnez	$a2, .LBB2_151
.LBB2_152:                              # %.loopexit.i155.preheader
	add.d	$a0, $fp, $a1
	.p2align	4, , 16
.LBB2_153:                              # %.loopexit.i155
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $s2, 1
