...
.LBB2_119:                              # %.lr.ph8.i
	...
	move	$a2, $a4
	bne	$a4, $a0, .LBB2_119
.LBB2_120:                              # %._crit_edge9.i.loopexit
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$s5, $a1
	move	$a2, $a0
.LBB2_121:                              # %._crit_edge9.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$s5, $s6, 0
	ld.bu	$a1, $a2, 0
	beqz	$a1, .LBB2_125
...
# %bb.133:                              # %.lr.ph.preheader.i136
	...
	add.d	$fp, $fp, $s0
	move	$s2, $s1
.LBB2_134:                              # %._crit_edge.i139
	ld.d	$s0, $s6, 0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(skipoverword)
	jirl	$ra, $ra, 0
	bgeu	$s4, $a0, .LBB2_140
# %bb.135:                              # %.lr.ph8.i162.preheader
	sub.d	$a3, $a0, $s4
	ori	$a1, $zero, 64
	bltu	$a3, $a1, .LBB2_141
...
.LBB2_142:                              # %.lr.ph8.i162
	...
	move	$a2, $a4
	bne	$a4, $a0, .LBB2_142
.LBB2_143:                              # %._crit_edge9.i142.loopexit
	move	$s2, $a1
	move	$a3, $a0
.LBB2_144:                              # %._crit_edge9.i142
	st.d	$s2, $s6, 0
	ld.bu	$a2, $a3, 0
	sub.d	$a1, $s0, $s1
	beqz	$a2, .LBB2_148
...
.LBB2_147:                              # %.lr.ph18.i149
	...
	addi.d	$a0, $a0, 1
	bnez	$a2, .LBB2_147
.LBB2_148:                              # %.loopexit.i155.preheader
	add.d	$a0, $fp, $a1
	.p2align	4, , 16
.LBB2_149:                              # %.loopexit.i155
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $s2, 1
