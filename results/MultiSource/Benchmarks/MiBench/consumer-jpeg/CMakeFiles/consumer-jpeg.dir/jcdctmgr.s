...
# %bb.1:                                # %.lr.ph
	...
	fld.d	$ft0, $a0, %pc_lo12(.LCPI1_0)
	pcalau12i	$a0, %pc_hi20(.LCPI1_1)
	vld	$vr9, $a0, %pc_lo12(.LCPI1_1)
	vldi	$vr10, -992
	pcalau12i	$a0, %pc_hi20(.LCPI1_2)
	fld.d	$ft3, $a0, %pc_lo12(.LCPI1_2)
	pcalau12i	$a0, %pc_hi20(.LCPI1_3)
	vld	$vr12, $a0, %pc_lo12(.LCPI1_3)
	ori	$s2, $zero, 64
	vrepli.b	$vr13, 0
	ori	$a0, $zero, 1024
...
.LBB1_12:                               # %vector.body
	...
	ld.d	$a1, $s4, 16
	vilvl.h	$vr0, $vr13, $vr0
	vslli.w	$vr0, $vr0, 3
	vst	$vr0, $a0, 0
	vinsgr2vr.d	$vr0, $a1, 0
	ld.d	$a1, $s4, 24
	vilvl.h	$vr1, $vr13, $vr1
	vslli.w	$vr1, $vr1, 3
	vst	$vr1, $a0, 16
...
# %bb.14:                               #   in Loop: Header=BB1_4 Depth=1
	...
	vld	$vr8, $sp, 96                   # 16-byte Folded Reload
	st.d	$a0, $s6, 0
.LBB1_15:                               # %vector.ph110
                                        #   in Loop: Header=BB1_4 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB1_16:                               # %vector.body111
                                        #   Parent Loop BB1_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.d	$a2, $s4, $a1
	vinsgr2vr.d	$vr0, $a2, 0
	vilvl.h	$vr0, $vr13, $vr0
	vilvl.w	$vr1, $vr13, $vr0
