...
# %bb.23:                               #   in Loop: Header=BB1_21 Depth=2
	...
	bnez	$a5, .LBB1_21
	b	.LBB1_18
.LBB1_24:                               # %.preheader103.preheader
	ori	$a0, $zero, 2089
	add.d	$a0, $sp, $a0
	.p2align	4, , 16
.LBB1_25:                               # %.preheader103
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, -1
	addi.d	$a0, $a0, -1
	beqz	$a1, .LBB1_25
...
# %bb.44:                               # %dump_buffer.exit.i106.i
	...
	and	$a0, $s3, $s7
	bne	$a0, $s7, .LBB6_40
.LBB6_45:                               #   in Loop: Header=BB6_41 Depth=3
	ld.d	$a0, $sp, 128
	addi.d	$a1, $a0, 1
	st.d	$a1, $sp, 128
	st.b	$zero, $a0, 0
...
# %bb.46:                               #   in Loop: Header=BB6_41 Depth=3
	...
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB6_108
# %bb.47:                               # %dump_buffer.exit39.i104.i
                                        #   in Loop: Header=BB6_41 Depth=3
	ld.d	$a0, $fp, 0
	ld.d	$s6, $fp, 8
	st.d	$a0, $sp, 128
...
# %bb.50:                               #   in Loop: Header=BB6_49 Depth=3
	...
	st.w	$a3, $a1, 40
	jirl	$ra, $a2, 0
.LBB6_51:                               #   in Loop: Header=BB6_49 Depth=3
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	sll.d	$a0, $a0, $s5
	andn	$a0, $s0, $a0
	add.w	$s1, $s1, $s5
	...
	bge	$s1, $a0, .LBB6_54
	b	.LBB6_48
.LBB6_52:                               # %dump_buffer.exit39.i91.i
	...
	st.d	$s6, $sp, 136
	.p2align	4, , 16
.LBB6_53:                               #   in Loop: Header=BB6_54 Depth=4
	slli.d	$s3, $s3, 8
	addi.w	$s1, $s5, -8
	bgeu	$s8, $s5, .LBB6_48
.LBB6_54:                               # %.lr.ph.i87.i
	...
	st.d	$s6, $sp, 136
	beqz	$s6, .LBB6_56
# %bb.55:                               #   in Loop: Header=BB6_54 Depth=4
	and	$a0, $s3, $s7
	bne	$a0, $s7, .LBB6_53
	b	.LBB6_58
	.p2align	4, , 16
.LBB6_56:                               #   in Loop: Header=BB6_54 Depth=4
	ld.d	$a0, $sp, 176
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB6_108
# %bb.57:                               # %dump_buffer.exit.i93.i
                                        #   in Loop: Header=BB6_54 Depth=4
	ld.d	$a0, $s0, 0
	ld.d	$s6, $s0, 8
	st.d	$a0, $sp, 128
	...
	and	$a0, $s3, $s7
	bne	$a0, $s7, .LBB6_53
.LBB6_58:                               #   in Loop: Header=BB6_54 Depth=4
	ld.d	$a0, $sp, 128
	addi.d	$a1, $a0, 1
	st.d	$a1, $sp, 128
	st.b	$zero, $a0, 0
	...
	st.d	$s6, $sp, 136
	bnez	$s6, .LBB6_53
# %bb.59:                               #   in Loop: Header=BB6_54 Depth=4
	ld.d	$a0, $sp, 176
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB6_52
	b	.LBB6_108
.LBB6_60:                               # %dump_buffer.exit39.i117.i
...
# %bb.63:                               #   in Loop: Header=BB6_62 Depth=3
	...
	b	.LBB6_66
	.p2align	4, , 16
.LBB6_64:                               #   in Loop: Header=BB6_62 Depth=3
	ld.d	$a0, $sp, 176
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB6_108
# %bb.65:                               # %dump_buffer.exit.i119.i
                                        #   in Loop: Header=BB6_62 Depth=3
	ld.d	$a0, $s0, 0
	ld.d	$s6, $s0, 8
	st.d	$a0, $sp, 128
...
.LBB6_66:                               #   in Loop: Header=BB6_62 Depth=3
	...
	st.d	$s6, $sp, 136
	bnez	$s6, .LBB6_61
# %bb.67:                               #   in Loop: Header=BB6_62 Depth=3
	ld.d	$a0, $sp, 176
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
