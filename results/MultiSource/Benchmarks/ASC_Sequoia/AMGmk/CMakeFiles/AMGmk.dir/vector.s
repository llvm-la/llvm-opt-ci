...
# %bb.10:                               # %._crit_edge.us
	...
	bne	$s4, $s1, .LBB6_8
	b	.LBB6_13
.LBB6_11:                               # %.preheader.split.preheader
	pcalau12i	$a0, %pc_hi20(.L.str.6)
	addi.d	$s0, $a0, %pc_lo12(.L.str.6)
	move	$s2, $zero
	.p2align	4, , 16
.LBB6_12:                               # %.preheader.split
                                        # =>This Inner Loop Header: Depth=1
	move	$a0, $fp
	move	$a1, $s0
	move	$a2, $s2
