...
# %bb.23:                               # %iter.check55
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB8_33
# %bb.24:                               # %vector.main.loop.iter.check57
	ori	$a2, $zero, 16
	bgeu	$s1, $a2, .LBB8_26
# %bb.25:
	move	$a2, $zero
...
.LBB8_27:                               # %vector.body61
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB8_27
# %bb.28:                               # %middle.block66
	beq	$a2, $s1, .LBB8_35
# %bb.29:                               # %vec.epilog.iter.check70
	beqz	$a3, .LBB8_33
.LBB8_30:                               # %vec.epilog.ph72
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB8_31:                               # %vec.epilog.vector.body75
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB8_31
# %bb.32:                               # %vec.epilog.middle.block79
	beq	$a2, $s1, .LBB8_35
...
# %bb.22:                               # %iter.check436
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB9_35
# %bb.23:                               # %vector.main.loop.iter.check438
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB9_28
# %bb.24:
	move	$a1, $zero
...
.LBB9_29:                               # %vector.body442
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB9_29
# %bb.30:                               # %middle.block447
	beq	$a1, $s2, .LBB9_37
# %bb.31:                               # %vec.epilog.iter.check451
	beqz	$a2, .LBB9_35
.LBB9_32:                               # %vec.epilog.ph453
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s0, 2
	.p2align	4, , 16
.LBB9_33:                               # %vec.epilog.vector.body456
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB9_33
# %bb.34:                               # %vec.epilog.middle.block460
	beq	$a1, $s2, .LBB9_37
...
# %bb.42:                               #   in Loop: Header=BB9_41 Depth=1
	...
	b	.LBB9_52
	.p2align	4, , 16
.LBB9_43:                               # %vector.main.loop.iter.check468
...
# %bb.47:                               # %middle.block481
	...
	sltu	$t4, $zero, $t4
	beq	$a3, $s2, .LBB9_54
# %bb.48:                               # %vec.epilog.iter.check488
                                        #   in Loop: Header=BB9_41 Depth=1
	move	$t5, $a3
	move	$t6, $a3
	beqz	$a2, .LBB9_52
.LBB9_49:                               # %vec.epilog.ph490
                                        #   in Loop: Header=BB9_41 Depth=1
	vreplgr2vr.w	$vr2, $t2
	vreplgr2vr.w	$vr1, $t4
	add.d	$t4, $a6, $t5
	alsl.d	$t5, $t5, $s0, 2
	.p2align	4, , 16
.LBB9_50:                               # %vec.epilog.vector.body497
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t5, 0
	vseq.w	$vr3, $vr3, $vr2
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB9_50
# %bb.51:                               # %vec.epilog.middle.block502
                                        #   in Loop: Header=BB9_41 Depth=1
	vslli.w	$vr1, $vr1, 31
	vmskltz.w	$vr1, $vr1
	vpickve2gr.hu	$t4, $vr1, 0
	...
	move	$t6, $a4
	beq	$a4, $s2, .LBB9_54
.LBB9_52:                               # %vec.epilog.scalar.ph487.preheader
                                        #   in Loop: Header=BB9_41 Depth=1
	alsl.d	$t5, $t6, $s0, 2
	sub.d	$t6, $s2, $t6
	.p2align	4, , 16
.LBB9_53:                               # %vec.epilog.scalar.ph487
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t5, 0
	xor	$t7, $t7, $t2
...
# %bb.73:                               #   in Loop: Header=BB9_72 Depth=2
	slli.d	$a7, $a7, 2
	ldx.w	$a7, $fp, $a7
.LBB9_74:                               #   in Loop: Header=BB9_72 Depth=2
	ori	$t0, $zero, 1
	bge	$a5, $a4, .LBB9_71
# %bb.75:                               # %.lr.ph234
                                        #   in Loop: Header=BB9_72 Depth=2
...
# %bb.84:                               #   in Loop: Header=BB9_83 Depth=2
	slli.d	$a7, $a7, 2
	ldx.w	$a7, $fp, $a7
.LBB9_85:                               #   in Loop: Header=BB9_83 Depth=2
	ori	$t0, $zero, 1
	bge	$a5, $a4, .LBB9_82
# %bb.86:                               # %.lr.ph234.us
                                        #   in Loop: Header=BB9_83 Depth=2
...
.LBB9_88:                               # %.lr.ph244.us
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	beqz	$t1, .LBB9_90
# %bb.89:                               #   in Loop: Header=BB9_88 Depth=3
	ld.w	$t3, $t2, 0
	addi.d	$t1, $t1, -1
	addi.w	$t0, $t0, -1
	addi.d	$t2, $t2, 4
...
# %bb.99:                               # %.lr.ph282
	...
	b	.LBB9_101
	.p2align	4, , 16
.LBB9_100:                              # %._crit_edge278
                                        #   in Loop: Header=BB9_101 Depth=1
	stx.w	$a4, $a1, $t0
	beq	$a2, $ra, .LBB9_122
.LBB9_101:                              # =>This Loop Header: Depth=1
	...
	ldx.w	$t2, $s7, $t0
	bge	$t1, $t2, .LBB9_107
# %bb.102:                              # %.lr.ph262.preheader
                                        #   in Loop: Header=BB9_101 Depth=1
	sub.d	$t5, $t2, $t1
	addi.w	$a4, $a4, 0
	bltu	$t5, $a6, .LBB9_104
# %bb.103:                              # %vector.memcheck507
                                        #   in Loop: Header=BB9_101 Depth=1
	alsl.d	$t4, $a4, $a0, 2
	alsl.d	$t6, $t1, $s8, 2
	sub.d	$t4, $t4, $t6
...
.LBB9_106:                              # %.lr.ph262
	...
	addi.d	$t7, $t7, 4
	bnez	$t6, .LBB9_106
.LBB9_107:                              # %._crit_edge263
                                        #   in Loop: Header=BB9_101 Depth=1
	ldx.w	$t3, $s5, $t3
	ldx.w	$t5, $s5, $t0
	bge	$t3, $t5, .LBB9_100
# %bb.108:                              # %.lr.ph277.preheader
                                        #   in Loop: Header=BB9_101 Depth=1
	alsl.d	$t4, $a2, $s5, 2
	b	.LBB9_110
	.p2align	4, , 16
.LBB9_109:                              # %._crit_edge269
...
# %bb.111:                              #   in Loop: Header=BB9_110 Depth=2
	slli.d	$t7, $t6, 2
	ldx.w	$t7, $fp, $t7
.LBB9_112:                              #   in Loop: Header=BB9_110 Depth=2
	bge	$t1, $t2, .LBB9_109
# %bb.113:                              # %.lr.ph268
                                        #   in Loop: Header=BB9_110 Depth=2
	alsl.d	$s2, $t1, $s8, 2
...
.LBB9_114:                              # %.lr.ph268.split
	...
	ldx.w	$s4, $s0, $s4
	beq	$t7, $s4, .LBB9_118
# %bb.115:                              #   in Loop: Header=BB9_114 Depth=3
	addi.d	$t8, $t8, 1
	addi.d	$s2, $s2, 4
	bne	$t2, $t8, .LBB9_114
	b	.LBB9_109
	.p2align	4, , 16
.LBB9_116:                              # %.lr.ph268.split.us
                                        #   Parent Loop BB9_101 Depth=1
                                        #     Parent Loop BB9_110 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$s4, $s2, 0
...
.LBB9_120:                              # %vector.body514
	...
	addi.d	$t8, $t8, 64
	bnez	$s2, .LBB9_120
# %bb.121:                              # %middle.block520
                                        #   in Loop: Header=BB9_101 Depth=1
	beq	$t5, $t6, .LBB9_107
	b	.LBB9_105
.LBB9_122:                              # %._crit_edge283
	beqz	$s1, .LBB9_124
# %bb.123:
	move	$a0, $s1
	pcaddu18i	$ra, %call36(hypre_Free)
