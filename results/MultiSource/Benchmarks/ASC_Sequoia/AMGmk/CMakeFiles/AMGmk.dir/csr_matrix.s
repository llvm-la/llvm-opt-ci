...
.LBB5_10:                               # %.lr.ph54
	...
	addi.d	$s3, $s3, 4
	bnez	$s6, .LBB5_10
# %bb.11:                               # %._crit_edge55.loopexit
	addi.d	$s5, $s5, 1
.LBB5_12:                               # %._crit_edge55
	ld.w	$a0, $sp, 20
	slli.d	$a0, $a0, 2
	ldx.w	$a0, $s0, $a0
	blez	$a0, .LBB5_15
...
# %bb.23:                               # %iter.check67
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB8_33
# %bb.24:                               # %vector.main.loop.iter.check54
	ori	$a2, $zero, 16
	bgeu	$s1, $a2, .LBB8_26
# %bb.25:
	move	$a2, $zero
...
# %bb.6:                                #   in Loop: Header=BB9_5 Depth=1
	...
	b	.LBB9_16
	.p2align	4, , 16
.LBB9_7:                                # %vector.main.loop.iter.check422
...
# %bb.11:                               # %middle.block434
	...
	sltu	$t3, $zero, $t3
	beq	$a2, $s2, .LBB9_18
# %bb.12:                               # %vec.epilog.iter.check439
                                        #   in Loop: Header=BB9_5 Depth=1
	move	$t4, $a2
	move	$t5, $a2
	beqz	$a1, .LBB9_16
.LBB9_13:                               # %vec.epilog.ph441
                                        #   in Loop: Header=BB9_5 Depth=1
	vreplgr2vr.w	$vr2, $t2
	vreplgr2vr.w	$vr1, $t3
	add.d	$t3, $a5, $t4
	alsl.d	$t4, $t4, $s0, 2
	.p2align	4, , 16
.LBB9_14:                               # %vec.epilog.vector.body448
                                        #   Parent Loop BB9_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t4, 0
	vseq.w	$vr3, $vr3, $vr2
	...
	addi.d	$t4, $t4, 16
	bnez	$t3, .LBB9_14
# %bb.15:                               # %vec.epilog.middle.block453
                                        #   in Loop: Header=BB9_5 Depth=1
	vslli.w	$vr1, $vr1, 31
	vmskltz.w	$vr1, $vr1
	vpickve2gr.hu	$t3, $vr1, 0
	...
	move	$t5, $a3
	beq	$a3, $s2, .LBB9_18
.LBB9_16:                               # %vec.epilog.scalar.ph438.preheader
                                        #   in Loop: Header=BB9_5 Depth=1
	alsl.d	$t4, $t5, $s0, 2
	sub.d	$t5, $s2, $t5
	.p2align	4, , 16
.LBB9_17:                               # %vec.epilog.scalar.ph438
                                        #   Parent Loop BB9_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t4, 0
	xor	$t6, $t6, $t2
...
# %bb.22:                               # %iter.check472
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB9_35
# %bb.23:                               # %vector.main.loop.iter.check459
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB9_28
# %bb.24:
	move	$a1, $zero
...
.LBB9_29:                               # %vector.body464
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB9_29
# %bb.30:                               # %middle.block469
	beq	$a1, $s2, .LBB9_37
# %bb.31:                               # %vec.epilog.iter.check474
	beqz	$a2, .LBB9_35
.LBB9_32:                               # %vec.epilog.ph476
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s0, 2
	.p2align	4, , 16
.LBB9_33:                               # %vec.epilog.vector.body479
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB9_33
# %bb.34:                               # %vec.epilog.middle.block483
	beq	$a1, $s2, .LBB9_37
...
# %bb.42:                               #   in Loop: Header=BB9_41 Depth=1
	...
	b	.LBB9_52
	.p2align	4, , 16
.LBB9_43:                               # %vector.main.loop.iter.check487
...
# %bb.47:                               # %middle.block501
	...
	sltu	$t4, $zero, $t4
	beq	$a3, $s2, .LBB9_54
# %bb.48:                               # %vec.epilog.iter.check509
                                        #   in Loop: Header=BB9_41 Depth=1
	move	$t5, $a3
	move	$t6, $a3
	beqz	$a2, .LBB9_52
.LBB9_49:                               # %vec.epilog.ph511
                                        #   in Loop: Header=BB9_41 Depth=1
	vreplgr2vr.w	$vr2, $t2
	vreplgr2vr.w	$vr1, $t4
	add.d	$t4, $a6, $t5
	alsl.d	$t5, $t5, $s0, 2
	.p2align	4, , 16
.LBB9_50:                               # %vec.epilog.vector.body518
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t5, 0
	vseq.w	$vr3, $vr3, $vr2
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB9_50
# %bb.51:                               # %vec.epilog.middle.block523
                                        #   in Loop: Header=BB9_41 Depth=1
	vslli.w	$vr1, $vr1, 31
	vmskltz.w	$vr1, $vr1
	vpickve2gr.hu	$t4, $vr1, 0
	...
	move	$t6, $a4
	beq	$a4, $s2, .LBB9_54
.LBB9_52:                               # %vec.epilog.scalar.ph508.preheader
                                        #   in Loop: Header=BB9_41 Depth=1
	alsl.d	$t5, $t6, $s0, 2
	sub.d	$t6, $s2, $t6
	.p2align	4, , 16
.LBB9_53:                               # %vec.epilog.scalar.ph508
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t5, 0
	xor	$t7, $t7, $t2
...
# %bb.55:                               #   in Loop: Header=BB9_41 Depth=1
	...
	stx.w	$t2, $a0, $t3
	b	.LBB9_40
.LBB9_56:                               # %vector.main.loop.iter.check
	ori	$a0, $zero, 16
	bgeu	$s4, $a0, .LBB9_58
# %bb.57:
	move	$a0, $zero
...
.LBB9_62:                               # %vec.epilog.ph
	...
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB9_63:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a2, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a1, $a1, 4
...
# %bb.64:                               # %vec.epilog.middle.block
	beq	$a0, $s4, .LBB9_67
.LBB9_65:                               # %.lr.ph220.split.preheader
	alsl.d	$a1, $a0, $s1, 2
	sub.d	$a0, $s4, $a0
	.p2align	4, , 16
.LBB9_66:                               # %.lr.ph220.split
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s3, $a1, 0
	addi.w	$s3, $s3, 1
	addi.d	$a0, $a0, -1
...
.LBB9_67:                               # %.preheader.thread
	...
	ld.d	$t8, $sp, 32                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
.LBB9_68:                               # %.lr.ph228.split.preheader
	move	$a1, $zero
	.p2align	4, , 16
.LBB9_69:                               # %.lr.ph228.split
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a2, $s1, $a1
	ldx.w	$a3, $fp, $a1
	slli.d	$a2, $a2, 2
...
.LBB9_77:                               # %.loopexit
	...
	add.w	$s4, $t0, $s4
	beq	$a1, $a3, .LBB9_72
.LBB9_78:                               # %.lr.ph252.split
                                        #   Parent Loop BB9_73 Depth=1
...
# %bb.83:                               # %.lr.ph404
	...
	addi.w	$t2, $zero, -1
	.p2align	4, , 16
.LBB9_84:                               #   Parent Loop BB9_73 Depth=1
...
# %bb.90:                               #   in Loop: Header=BB9_89 Depth=2
	slli.d	$a7, $t0, 2
	ldx.w	$t0, $fp, $a7
.LBB9_91:                               #   in Loop: Header=BB9_89 Depth=2
	ori	$a7, $zero, 1
	bge	$a5, $a4, .LBB9_88
# %bb.92:                               # %.lr.ph234.us
                                        #   in Loop: Header=BB9_89 Depth=2
...
# %bb.94:                               # %.lr.ph407
	...
	addi.w	$t2, $zero, -1
	.p2align	4, , 16
.LBB9_95:                               #   Parent Loop BB9_73 Depth=1
                                        #     Parent Loop BB9_89 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t3, 0
	beq	$t0, $t4, .LBB9_86
# %bb.96:                               # %.lr.ph244.us
                                        #   in Loop: Header=BB9_95 Depth=3
	addi.w	$t2, $t2, -1
	addi.d	$t1, $t1, -1
	addi.d	$t3, $t3, 4
	bnez	$t1, .LBB9_95
...
# %bb.103:
	...
	jirl	$ra, $ra, 0
	st.d	$a0, $s2, 16
.LBB9_104:                              # %hypre_CSRMatrixInitialize.exit
	ld.d	$a1, $s3, 0
	st.w	$zero, $a1, 0
...
# %bb.105:                              # %.lr.ph282
	...
	b	.LBB9_107
	.p2align	4, , 16
.LBB9_106:                              # %._crit_edge278
                                        #   in Loop: Header=BB9_107 Depth=1
	stx.w	$t3, $a1, $t0
	beq	$a2, $a7, .LBB9_135
.LBB9_107:                              # =>This Loop Header: Depth=1
	...
	ldx.w	$t2, $s7, $t0
	bge	$t1, $t2, .LBB9_114
# %bb.108:                              # %iter.check546
                                        #   in Loop: Header=BB9_107 Depth=1
	sub.d	$t5, $t2, $t1
	addi.w	$t7, $t3, 0
	bltu	$t5, $a5, .LBB9_110
# %bb.109:                              # %vector.memcheck528
                                        #   in Loop: Header=BB9_107 Depth=1
	alsl.d	$a3, $t7, $a0, 2
	alsl.d	$a4, $t1, $s8, 2
	sub.d	$a3, $a3, $a4
	bgeu	$a3, $a6, .LBB9_126
.LBB9_110:                              #   in Loop: Header=BB9_107 Depth=1
	move	$t6, $t1
	move	$t3, $t7
.LBB9_111:                              # %.lr.ph262.preheader
                                        #   in Loop: Header=BB9_107 Depth=1
	alsl.d	$a3, $t6, $s8, 2
	sub.d	$a4, $t2, $t6
	alsl.d	$a7, $t3, $a0, 2
...
.LBB9_112:                              # %.lr.ph262
	...
	addi.d	$a7, $a7, 4
	bnez	$a4, .LBB9_112
.LBB9_113:                              # %._crit_edge263.loopexit
                                        #   in Loop: Header=BB9_107 Depth=1
	ld.d	$a7, $sp, 32                    # 8-byte Folded Reload
.LBB9_114:                              # %._crit_edge263
                                        #   in Loop: Header=BB9_107 Depth=1
	ldx.w	$t4, $s5, $t4
	ldx.w	$t6, $s5, $t0
	bge	$t4, $t6, .LBB9_106
# %bb.115:                              # %.lr.ph277.preheader
                                        #   in Loop: Header=BB9_107 Depth=1
	alsl.d	$t5, $a2, $s5, 2
	b	.LBB9_117
	.p2align	4, , 16
.LBB9_116:                              # %._crit_edge269
...
.LBB9_121:                              # %.lr.ph268.split
	...
	ldx.w	$a4, $s0, $a4
	beq	$t8, $a4, .LBB9_125
# %bb.122:                              #   in Loop: Header=BB9_121 Depth=3
	addi.d	$s3, $s3, 1
	addi.d	$a3, $a3, 4
	bne	$t2, $s3, .LBB9_121
	b	.LBB9_116
	.p2align	4, , 16
.LBB9_123:                              # %.lr.ph268.split.us
                                        #   Parent Loop BB9_107 Depth=1
                                        #     Parent Loop BB9_117 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a4, $a3, 0
	beq	$t8, $a4, .LBB9_125
# %bb.124:                              #   in Loop: Header=BB9_123 Depth=3
	addi.d	$s3, $s3, 1
	addi.d	$a3, $a3, 4
	bne	$t2, $s3, .LBB9_123
	b	.LBB9_116
...
.LBB9_125:                              # %.thread206
	...
	blt	$t4, $t6, .LBB9_117
	b	.LBB9_106
.LBB9_126:                              # %vector.main.loop.iter.check531
                                        #   in Loop: Header=BB9_107 Depth=1
	slli.d	$s3, $t7, 2
	slli.d	$t8, $t1, 2
	bgeu	$t5, $s4, .LBB9_128
# %bb.127:                              #   in Loop: Header=BB9_107 Depth=1
	move	$a7, $zero
	b	.LBB9_132
.LBB9_128:                              # %vector.ph533
                                        #   in Loop: Header=BB9_107 Depth=1
	andi	$ra, $t5, 12
	move	$a7, $t5
...
.LBB9_129:                              # %vector.body536
	...
	addi.d	$a4, $a4, 64
	bnez	$s4, .LBB9_129
# %bb.130:                              # %middle.block541
                                        #   in Loop: Header=BB9_107 Depth=1
	ori	$s4, $zero, 16
	beq	$t5, $a7, .LBB9_113
# %bb.131:                              # %vec.epilog.iter.check548
                                        #   in Loop: Header=BB9_107 Depth=1
	beqz	$ra, .LBB9_111
.LBB9_132:                              # %vec.epilog.ph550
                                        #   in Loop: Header=BB9_107 Depth=1
	move	$ra, $t5
	bstrins.d	$ra, $zero, 1, 0
	add.d	$t6, $ra, $t1
	add.d	$t3, $ra, $t7
	alsl.d	$a3, $a7, $s3, 2
	add.d	$a3, $a0, $a3
	...
	sub.d	$a7, $a7, $ra
	.p2align	4, , 16
.LBB9_133:                              # %vec.epilog.vector.body553
                                        #   Parent Loop BB9_107 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a7, .LBB9_133
# %bb.134:                              # %vec.epilog.middle.block557
                                        #   in Loop: Header=BB9_107 Depth=1
	bne	$t5, $ra, .LBB9_111
	b	.LBB9_113
.LBB9_135:                              # %._crit_edge283
	beqz	$s1, .LBB9_137
# %bb.136:
	move	$a0, $s1
	pcaddu18i	$ra, %call36(hypre_Free)
