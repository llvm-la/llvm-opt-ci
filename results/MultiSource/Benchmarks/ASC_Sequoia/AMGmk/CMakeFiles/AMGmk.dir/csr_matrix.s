...
# %bb.9:                                # %middle.block421
	...
	move	$t1, $a1
	beq	$a1, $s2, .LBB9_12
.LBB9_10:                               # %scalar.ph409.preheader
                                        #   in Loop: Header=BB9_5 Depth=1
	alsl.d	$t0, $t1, $s0, 2
	sub.d	$t1, $s2, $t1
	.p2align	4, , 16
.LBB9_11:                               # %scalar.ph409
                                        #   Parent Loop BB9_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t2, $t0, 0
	xor	$t2, $t2, $a6
...
.LBB9_18:                               # %vector.body429
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB9_18
# %bb.19:                               # %middle.block434
	beq	$a1, $s2, .LBB9_22
.LBB9_20:                               # %.lr.ph.preheader487
	alsl.d	$a2, $a1, $a0, 2
	alsl.d	$a3, $a1, $s0, 2
	sub.d	$a1, $s2, $a1
	.p2align	4, , 16
...
# %bb.30:                               # %middle.block451
	...
	move	$t2, $a2
	beq	$a2, $s2, .LBB9_33
.LBB9_31:                               # %scalar.ph437.preheader
                                        #   in Loop: Header=BB9_26 Depth=1
	alsl.d	$t1, $t2, $s0, 2
	sub.d	$t2, $s2, $t2
	.p2align	4, , 16
.LBB9_32:                               # %scalar.ph437
                                        #   Parent Loop BB9_26 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t3, $t1, 0
	xor	$t3, $t3, $a6
...
# %bb.40:                               # %middle.block
	beq	$a3, $s4, .LBB9_43
.LBB9_41:                               # %.lr.ph220.split.preheader491
	alsl.d	$a1, $a3, $s1, 2
	sub.d	$a2, $s4, $a3
	.p2align	4, , 16
...
# %bb.59:                               # %.lr.ph404
	...
	addi.w	$t2, $zero, -1
	.p2align	4, , 16
.LBB9_60:                               #   Parent Loop BB9_49 Depth=1
...
# %bb.70:                               # %.lr.ph407
	...
	addi.w	$t2, $zero, -1
	.p2align	4, , 16
.LBB9_71:                               #   Parent Loop BB9_49 Depth=1
