...
.LBB3_36:                               #   in Loop: Header=BB3_34 Depth=1
	move	$t0, $zero
	move	$t1, $zero
.LBB3_37:                               # %.lr.ph91.i.preheader154
                                        #   in Loop: Header=BB3_34 Depth=1
	addi.w	$t1, $t1, 1
	.p2align	4, , 16
.LBB3_38:                               # %.lr.ph91.i
	...
	b	.LBB3_33
	.p2align	4, , 16
.LBB3_39:                               # %vector.body75.preheader
                                        #   in Loop: Header=BB3_34 Depth=1
	move	$t0, $s2
	move	$t1, $a3
	.p2align	4, , 16
.LBB3_40:                               # %vector.body75
                                        #   Parent Loop BB3_34 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $t0, 0
	xvld	$xr1, $t0, 32
...
.LBB3_54:                               # %vector.body138
	...
	addi.d	$a2, $a2, 64
	bnez	$a1, .LBB3_54
# %bb.55:                               # %middle.block144
                                        #   in Loop: Header=BB3_50 Depth=2
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	beq	$s0, $a2, .LBB3_64
.LBB3_56:                               # %.lr.ph.split.i.i.preheader152
                                        #   in Loop: Header=BB3_50 Depth=2
	alsl.d	$a2, $a1, $s5, 3
	.p2align	4, , 16
...
# %bb.61:                               # %middle.block128
	...
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	beq	$s0, $a2, .LBB3_64
.LBB3_62:                               # %.lr.ph.split.us.i.i.preheader151
                                        #   in Loop: Header=BB3_50 Depth=2
	alsl.d	$a2, $a1, $s5, 3
	.p2align	4, , 16
...
.LBB3_70:                               # %vector.body106
	...
	addi.d	$a4, $a4, 64
	bnez	$a2, .LBB3_70
# %bb.71:                               # %middle.block112
                                        #   in Loop: Header=BB3_50 Depth=2
	beq	$s8, $a3, .LBB3_48
.LBB3_72:                               # %.lr.ph.split.i41.i.preheader149
                                        #   in Loop: Header=BB3_50 Depth=2
	alsl.d	$a2, $a0, $s5, 3
	.p2align	4, , 16
...
# %bb.77:                               # %middle.block96
                                        #   in Loop: Header=BB3_50 Depth=2
	beq	$s8, $a3, .LBB3_48
.LBB3_78:                               # %.lr.ph.split.us.i45.i.preheader148
                                        #   in Loop: Header=BB3_50 Depth=2
	alsl.d	$a2, $a0, $s5, 3
	.p2align	4, , 16
...
# %bb.24:                               # %scalar.ph143
	...
	or	$a5, $a6, $a5
	beqz	$a5, .LBB10_21
# %bb.25:                               # %vector.body139.preheader
                                        #   in Loop: Header=BB10_22 Depth=2
	ori	$a6, $zero, 100
	move	$a7, $a1
	.p2align	4, , 16
.LBB10_26:                              # %vector.body139
                                        #   Parent Loop BB10_18 Depth=1
                                        #     Parent Loop BB10_22 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t0, $a7, 0
...
# %bb.76:                               # %middle.block106
	...
	sltu	$a1, $zero, $a1
	beq	$a0, $a2, .LBB15_79
.LBB15_77:                              # %.lr.ph.split.i.preheader208
                                        #   in Loop: Header=BB15_25 Depth=2
	sub.d	$a2, $a2, $a0
...
# %bb.87:                               # %middle.block
	...
	sltu	$a1, $zero, $a1
	beq	$a0, $a2, .LBB15_90
.LBB15_88:                              # %.lr.ph.split.us.i.preheader209
                                        #   in Loop: Header=BB15_5 Depth=1
	sub.d	$a2, $a3, $a0
	pcalau12i	$a3, %pc_hi20(tot_out_error)
	addi.d	$a3, $a3, %pc_lo12(tot_out_error)
