...
# %bb.0:
	...
	xvinsve0.d	$xr9, $xr13, 1
	xvpickve.d	$xr13, $xr5, 2
	xvinsve0.d	$xr9, $xr13, 3
	xvinsgr2vr.d	$xr12, $a1, 1
	xvinsve0.d	$xr9, $xr12, 2
	xvpermi.d	$xr12, $xr12, 100
	xvslt.du	$xr10, $xr10, $xr12
	...
	vinsgr2vr.h	$vr12, $a7, 4
	xvpickve2gr.d	$a7, $xr9, 1
	vinsgr2vr.h	$vr12, $a7, 5
	xvpickve2gr.d	$a7, $xr9, 2
	vinsgr2vr.h	$vr12, $a7, 6
	xvpickve2gr.d	$a7, $xr9, 3
	vinsgr2vr.h	$vr12, $a7, 7
	sltu	$a7, $fp, $a1
	sltu	$a4, $t8, $a4
	sltu	$t0, $s1, $a1
