...
# %bb.0:
	...
	xvld	$xr12, $a3, %pc_lo12(.LCPI0_2)
	xvadd.d	$xr11, $xr11, $xr7
	xvadd.d	$xr13, $xr13, $xr7
	add.d	$a3, $a6, $s0
	...
	sltu	$a3, $fp, $t0
	and	$a2, $a2, $a3
	xvslt.du	$xr3, $xr1, $xr3
	xvslt.du	$xr2, $xr2, $xr4
	xvand.v	$xr2, $xr2, $xr3
	xvmskltz.d	$xr2, $xr2
...
.LBB0_30:                               # %vector.body814
	...
	ori	$a5, $t2, 4068
	xvstx	$xr15, $a1, $a5
	xvreplgr2vr.d	$xr15, $t1
	xvfcmp.clt.d	$xr16, $xr14, $xr15
	xvfcmp.clt.d	$xr15, $xr13, $xr15
	xvpickev.w	$xr15, $xr15, $xr16
	xvpermi.d	$xr15, $xr15, 216
	xvpickev.h	$xr16, $xr15, $xr15
	xvpermi.d	$xr16, $xr16, 216
	xvreplgr2vr.d	$xr17, $ra
	xvfcmp.clt.d	$xr14, $xr17, $xr14
	xvfcmp.clt.d	$xr13, $xr17, $xr13
	xvpickev.w	$xr13, $xr13, $xr14
	xvpermi.d	$xr13, $xr13, 216
	xvpickev.h	$xr13, $xr13, $xr13
	xvpermi.d	$xr13, $xr13, 216
	...
	andi	$a6, $a6, 1
	xvbitsel.v	$xr14, $xr16, $xr14, $xr15
	bnez	$a6, .LBB0_38
...
.LBB0_33:                               # %pred.store.continue827
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB0_41
.LBB0_34:                               # %pred.store.continue829
                                        #   in Loop: Header=BB0_30 Depth=3
	vpickve2gr.h	$a5, $vr13, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB0_42
.LBB0_35:                               # %pred.store.continue831
                                        #   in Loop: Header=BB0_30 Depth=3
	vpickve2gr.h	$a5, $vr13, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB0_43
.LBB0_36:                               # %pred.store.continue833
                                        #   in Loop: Header=BB0_30 Depth=3
	vpickve2gr.h	$a5, $vr13, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB0_44
.LBB0_37:                               # %pred.store.continue835
                                        #   in Loop: Header=BB0_30 Depth=3
	...
	b	.LBB0_45
	.p2align	4, , 16
.LBB0_38:                               # %pred.store.if
                                        #   in Loop: Header=BB0_30 Depth=3
	add.d	$a5, $a1, $a5
	xvstelm.w	$xr14, $a5, 0, 0
	vpickve2gr.h	$a5, $vr13, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB0_32
