...
.LBB2_14:                               # %vector.body733
	...
	addi.d	$t8, $t8, -32
	bnez	$fp, .LBB2_14
# %bb.15:                               # %middle.block739
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_18
.LBB2_16:                               # %scalar.ph728.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t5, $s3, 2
	.p2align	4, , 16
.LBB2_17:                               # %scalar.ph728
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
.LBB2_28:                               # %vector.body719
	...
	addi.d	$t7, $t7, -32
	bnez	$t8, .LBB2_28
# %bb.29:                               # %middle.block725
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t5, $t6, .LBB2_32
.LBB2_30:                               # %scalar.ph714.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t5, $t2, $s3, 2
	.p2align	4, , 16
.LBB2_31:                               # %scalar.ph714
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t5, -4
	addi.d	$t7, $t5, -4
...
.LBB2_42:                               # %vector.body705
	...
	addi.d	$t8, $t8, -32
	bnez	$fp, .LBB2_42
# %bb.43:                               # %middle.block711
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_46
.LBB2_44:                               # %scalar.ph700.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t5, $a5, 2
	.p2align	4, , 16
.LBB2_45:                               # %scalar.ph700
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
.LBB2_56:                               # %vector.body691
	...
	addi.d	$t7, $t7, -32
	bnez	$t8, .LBB2_56
# %bb.57:                               # %middle.block697
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t5, $t6, .LBB2_60
.LBB2_58:                               # %scalar.ph686.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t5, $t2, $a5, 2
	.p2align	4, , 16
.LBB2_59:                               # %scalar.ph686
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t5, -4
	addi.d	$t7, $t5, -4
...
# %bb.115:                              #   in Loop: Header=BB2_113 Depth=3
	...
	b	.LBB2_120
	.p2align	4, , 16
.LBB2_116:                              # %vector.ph745
                                        #   in Loop: Header=BB2_113 Depth=3
	move	$t2, $ra
	move	$a4, $t7
	.p2align	4, , 16
.LBB2_117:                              # %vector.body748
                                        #   Parent Loop BB2_94 Depth=1
                                        #     Parent Loop BB2_111 Depth=2
...
.LBB2_137:
	...
	ld.d	$t6, $sp, 56                    # 8-byte Folded Reload
	ld.d	$t7, $sp, 40                    # 8-byte Folded Reload
.LBB2_138:                              # %._crit_edge269.thread587
	ori	$a1, $zero, 2
	blt	$s5, $a1, .LBB2_183
# %bb.139:                              # %._crit_edge269.thread587
	blt	$s0, $a1, .LBB2_183
# %bb.140:                              # %.lr.ph268.split.us.2
	blez	$s2, .LBB2_172
# %bb.141:                              # %.lr.ph260.us.us.2.preheader
	move	$a1, $zero
	mul.d	$a2, $t6, $t7
	b	.LBB2_143
	.p2align	4, , 16
.LBB2_142:                              # %._crit_edge261.split.us.us.us.2
                                        #   in Loop: Header=BB2_143 Depth=1
	addi.w	$a1, $a1, 1
	bge	$a1, $t7, .LBB2_183
.LBB2_143:                              # %.lr.ph260.us.us.2
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB2_145
	.p2align	4, , 16
.LBB2_144:                              # %._crit_edge254.us.us.us.2
                                        #   in Loop: Header=BB2_145 Depth=2
	addi.w	$a3, $a3, 1
	add.w	$a4, $a4, $t7
	bge	$a3, $t6, .LBB2_142
.LBB2_145:                              # %.lr.ph253.us.us.us.2
...
.LBB2_151:                              # %.lr.ph268.1
	blt	$s5, $a1, .LBB2_183
.LBB2_152:                              # %.lr.ph268.split.us.1
	ori	$a1, $zero, 2
	blt	$s0, $a1, .LBB2_164
# %bb.153:                              # %.lr.ph260.us.us.1.preheader
	move	$a1, $zero
	move	$a2, $zero
	mul.d	$a3, $t6, $t7
	b	.LBB2_155
	.p2align	4, , 16
.LBB2_154:                              # %._crit_edge261.split.us.us.us.1
                                        #   in Loop: Header=BB2_155 Depth=1
	addi.w	$a2, $a2, 1
	add.w	$a1, $a1, $a3
	bge	$a2, $s2, .LBB2_138
.LBB2_155:                              # %.lr.ph260.us.us.1
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB2_157
	.p2align	4, , 16
.LBB2_156:                              # %._crit_edge254.us.us.us.1
                                        #   in Loop: Header=BB2_157 Depth=2
	addi.w	$a4, $a4, 1
	addi.w	$a5, $a5, 1
	bge	$a4, $t7, .LBB2_154
.LBB2_157:                              # %.lr.ph253.us.us.us.1
	...
	b	.LBB2_159
	.p2align	4, , 16
.LBB2_158:                              # %._crit_edge524
                                        #   in Loop: Header=BB2_159 Depth=3
	sltu	$t0, $zero, $t1
	masknez	$t2, $s7, $t0
	maskeqz	$t3, $a7, $t0
	or	$s7, $t3, $t2
	...
	add.w	$a7, $a7, $t7
	beqz	$a6, .LBB2_156
.LBB2_159:                              #   Parent Loop BB2_155 Depth=1
...
# %bb.160:                              #   in Loop: Header=BB2_159 Depth=3
	addi.w	$t0, $a0, 0
	bne	$t1, $t0, .LBB2_158
# %bb.161:                              #   in Loop: Header=BB2_159 Depth=3
	alsl.d	$t0, $a7, $s1, 2
	st.w	$zero, $t0, 0
	addi.w	$t0, $s7, 0
	slli.d	$t0, $t0, 2
	...
	bnez	$a6, .LBB2_159
	b	.LBB2_156
.LBB2_162:                              # %.lr.ph260.us.preheader
	ori	$a0, $zero, 1
	bne	$s2, $a0, .LBB2_174
# %bb.163:
	move	$a0, $zero
	b	.LBB2_177
.LBB2_164:                              # %.lr.ph260.us.1.preheader
	move	$a1, $zero
	...
	b	.LBB2_166
	.p2align	4, , 16
.LBB2_165:                              # %._crit_edge261.split.us272.1
                                        #   in Loop: Header=BB2_166 Depth=1
	addi.w	$a1, $a1, 1
	bge	$a1, $s2, .LBB2_138
.LBB2_166:                              # %.lr.ph260.us.1
                                        # =>This Loop Header: Depth=1
...
# %bb.167:                              #   in Loop: Header=BB2_166 Depth=1
	...
	b	.LBB2_171
	.p2align	4, , 16
.LBB2_168:                              # %vector.body778.preheader
                                        #   in Loop: Header=BB2_166 Depth=1
	move	$a4, $a2
	.p2align	4, , 16
.LBB2_169:                              # %vector.body778
                                        #   Parent Loop BB2_166 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, -2
	bnez	$a4, .LBB2_169
# %bb.170:                              # %middle.block781
                                        #   in Loop: Header=BB2_166 Depth=1
	move	$a4, $a2
	beq	$t7, $a2, .LBB2_165
	.p2align	4, , 16
.LBB2_171:                              # %scalar.ph773
                                        #   Parent Loop BB2_166 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, 1
	blt	$a4, $t7, .LBB2_171
...
# %bb.173:
	move	$a0, $zero
	b	.LBB2_182
.LBB2_174:                              # %vector.ph764
	bstrpick.d	$a0, $s2, 30, 1
	slli.w	$a0, $a0, 1
	move	$a2, $a0
	.p2align	4, , 16
.LBB2_175:                              # %vector.body767
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, -2
	bnez	$a2, .LBB2_175
# %bb.176:                              # %middle.block770
	beq	$s2, $a0, .LBB2_178
	.p2align	4, , 16
.LBB2_177:                              # %._crit_edge261.split.us272
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a0, $a0, 1
	blt	$a0, $s2, .LBB2_177
.LBB2_178:
...
.LBB2_179:                              # %vector.ph787
	...
	move	$a2, $a0
	.p2align	4, , 16
.LBB2_180:                              # %vector.body790
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, -2
	bnez	$a2, .LBB2_180
# %bb.181:                              # %middle.block793
	beq	$a1, $a0, .LBB2_183
	.p2align	4, , 16
...
.LBB2_186:
	move	$a1, $zero
	b	.LBB2_198
.LBB2_187:                              # %vector.main.loop.iter.check798
	ori	$a0, $zero, 16
	bgeu	$a4, $a0, .LBB2_189
# %bb.188:
	move	$a0, $zero
...
# %bb.191:                              # %middle.block809
	...
	beq	$a0, $a4, .LBB2_198
# %bb.192:                              # %vec.epilog.iter.check814
	beqz	$a2, .LBB2_196
.LBB2_193:                              # %vec.epilog.ph816
	move	$a2, $a0
	...
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB2_194:                              # %vec.epilog.vector.body819
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a2, 0
	vseqi.w	$vr1, $vr1, 0
	vadd.w	$vr0, $vr0, $vr1
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB2_194
# %bb.195:                              # %vec.epilog.middle.block824
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a1, $vr0, 0
	beq	$a0, $a4, .LBB2_198
.LBB2_196:                              # %.lr.ph283.preheader
	alsl.d	$a2, $a0, $s1, 2
	sub.d	$a0, $a4, $a0
	.p2align	4, , 16
.LBB2_197:                              # %.lr.ph283
...
.LBB2_198:                              # %._crit_edge284
	...
	blez	$s2, .LBB2_209
# %bb.199:                              # %._crit_edge284
	ori	$a0, $zero, 2
	blt	$s0, $a0, .LBB2_209
# %bb.200:                              # %._crit_edge284
	blt	$s5, $a0, .LBB2_209
# %bb.201:                              # %.preheader201.us.us.preheader
	move	$a0, $zero
	move	$a1, $zero
	move	$a7, $zero
	...
	b	.LBB2_203
	.p2align	4, , 16
.LBB2_202:                              # %._crit_edge296.split.us.us.us
                                        #   in Loop: Header=BB2_203 Depth=1
	addi.d	$a0, $a0, 1
	add.w	$a7, $a6, $a5
	beq	$a0, $s2, .LBB2_209
.LBB2_203:                              # %.preheader201.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB2_205
	.p2align	4, , 16
.LBB2_204:                              # %._crit_edge290.us.us.us
                                        #   in Loop: Header=BB2_205 Depth=2
	addi.d	$a3, $a3, 1
	add.w	$a7, $a6, $a5
	beq	$a3, $t7, .LBB2_202
.LBB2_205:                              # %.preheader.us.us.us
