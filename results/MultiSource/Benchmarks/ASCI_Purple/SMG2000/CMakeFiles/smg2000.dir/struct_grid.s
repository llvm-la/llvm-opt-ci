...
.LBB8_13:                               # %.lr.ph131
	...
	ori	$a3, $zero, 10
	bgeu	$a1, $a3, .LBB8_20
.LBB8_14:                               # %scalar.ph189.preheader
	alsl.d	$a1, $s2, $a0, 2
	addi.d	$a2, $s2, 1
	ori	$a3, $zero, 3
	.p2align	4, , 16
.LBB8_15:                               # %scalar.ph189
...
.LBB8_23:                               # %vector.body194
	...
	addi.d	$a4, $a4, 8
	bnez	$a5, .LBB8_23
# %bb.24:                               # %middle.block197
	move	$s2, $a3
	bne	$a1, $a2, .LBB8_14
	b	.LBB8_16
.LBB8_25:                               # %vector.ph202
...
.LBB8_26:                               # %vector.body205
	...
	addi.d	$a3, $a3, 192
	bnez	$a4, .LBB8_26
# %bb.27:                               # %middle.block210
	vadd.w	$vr0, $vr1, $vr0
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a1, .LBB8_30
.LBB8_28:                               # %scalar.ph200.preheader
	sub.d	$a1, $a1, $a2
	slli.d	$a4, $a2, 4
	alsl.d	$a2, $a2, $a4, 3
	add.d	$a0, $a2, $a0
...
.LBB8_42:                               # %vector.body219
	...
	addi.d	$a3, $a3, 192
	bnez	$a4, .LBB8_42
# %bb.43:                               # %middle.block224
	vadd.w	$vr0, $vr1, $vr0
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a0, .LBB8_46
.LBB8_44:                               # %scalar.ph214.preheader
	sub.d	$a0, $a0, $a2
	slli.d	$a4, $a2, 4
	alsl.d	$a2, $a2, $a4, 3
	add.d	$a1, $a2, $a1
