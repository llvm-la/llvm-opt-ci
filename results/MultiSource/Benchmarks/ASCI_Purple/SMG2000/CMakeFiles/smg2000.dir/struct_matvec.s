...
# %bb.2:                                # %.lr.ph3870
	...
	xvst	$xr3, $sp, 784                  # 32-byte Folded Spill
	b	.LBB2_4
	.p2align	4, , 16
...
.LBB2_7:                                #   in Loop: Header=BB2_4 Depth=1
	...
	sub.w	$t4, $a1, $t2
	addi.d	$t6, $t4, 1
	xvld	$xr1, $sp, 816                  # 32-byte Folded Reload
...
.LBB2_103:                              #   in Loop: Header=BB2_87 Depth=4
	...
	slli.d	$a7, $a0, 2
	add.d	$s2, $a1, $a7
	st.d	$ra, $sp, 704                   # 8-byte Folded Spill
	bltz	$a2, .LBB2_105
...
.LBB2_129:                              #   in Loop: Header=BB2_87 Depth=4
	...
	slt	$a1, $a0, $t6
	masknez	$a0, $a0, $a1
	st.d	$t6, $sp, 640                   # 8-byte Folded Spill
	maskeqz	$a1, $t6, $a1
	or	$a0, $a1, $a0
	blez	$a0, .LBB2_86
...
# %bb.133:                              # %.preheader3278.us.us.us.us.us.preheader
	...
	sub.d	$t5, $s2, $t5
	st.d	$t5, $sp, 728                   # 8-byte Folded Spill
	sub.d	$a3, $a3, $t4
...
.LBB2_188:                              # %scalar.ph5112.preheader
	...
	move	$s2, $zero
	move	$t1, $zero
	ld.d	$t2, $sp, 816                   # 8-byte Folded Reload
	alsl.d	$s7, $t0, $t2, 3
	alsl.d	$s8, $a4, $fp, 3
	alsl.d	$ra, $a4, $s1, 3
	alsl.d	$t2, $a5, $t7, 3
...
# %bb.244:                              #   in Loop: Header=BB2_87 Depth=4
	ld.w	$a7, $t6, 8
	mul.d	$a7, $a7, $s7
	st.d	$a7, $sp, 704                   # 8-byte Folded Spill
	b	.LBB2_246
...
# %bb.250:                              #   in Loop: Header=BB2_87 Depth=4
	ld.w	$a7, $s5, 8
	mul.d	$a7, $a7, $s7
	st.d	$a7, $sp, 672                   # 8-byte Folded Spill
	b	.LBB2_252
...
# %bb.258:                              #   in Loop: Header=BB2_87 Depth=4
	...
	sub.d	$t5, $t5, $ra
	mulw.d.w	$t5, $t5, $fp
	st.d	$t5, $sp, 568                   # 8-byte Folded Spill
	b	.LBB2_260
...
.LBB2_260:                              #   in Loop: Header=BB2_87 Depth=4
	...
	slli.d	$fp, $fp, 2
	ldx.w	$fp, $ra, $fp
	st.d	$fp, $sp, 680                   # 8-byte Folded Spill
	slli.d	$a3, $a3, 2
	ldx.w	$a3, $ra, $a3
...
# %bb.365:                              # %.preheader3277.us.us.us.us.us.preheader
	...
	and	$t8, $t8, $fp
	sub.d	$fp, $s0, $t7
	st.d	$fp, $sp, 712                   # 8-byte Folded Spill
	sub.d	$fp, $s1, $t7
	...
	addi.d	$a3, $a3, 8
	alsl.d	$a7, $a7, $a3, 3
	st.d	$a7, $sp, 680                   # 8-byte Folded Spill
	ld.d	$t0, $sp, 616                   # 8-byte Folded Reload
	alsl.d	$a7, $t0, $s7, 3
	st.d	$a7, $sp, 744                   # 8-byte Folded Spill
	alsl.d	$a7, $t0, $a3, 3
	st.d	$a7, $sp, 672                   # 8-byte Folded Spill
