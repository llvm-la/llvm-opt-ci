...
.LBB14_34:                              # =>This Loop Header: Depth=1
	...
	stx.w	$a0, $s5, $t5
	bge	$t3, $t4, .LBB14_33
# %bb.35:                               # %.lr.ph281.preheader
                                        #   in Loop: Header=BB14_34 Depth=1
	sub.d	$t5, $t4, $t3
	addi.w	$a0, $a0, 0
	bgeu	$t5, $t0, .LBB14_38
.LBB14_36:                              # %.lr.ph281.preheader565
                                        #   in Loop: Header=BB14_34 Depth=1
	alsl.d	$t5, $a0, $s1, 2
	alsl.d	$t6, $a0, $s3, 3
	alsl.d	$t7, $t3, $a3, 2
...
# %bb.58:                               # %.lr.ph302
	...
	move	$a1, $s7
	bgeu	$a3, $a7, .LBB14_71
.LBB14_59:                              # %scalar.ph523.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
# %bb.70:
	move	$a2, $zero
	b	.LBB14_80
.LBB14_71:                              # %vector.memcheck518
	alsl.d	$a1, $s7, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 32
	move	$a1, $s7
	bltu	$a7, $t0, .LBB14_59
# %bb.72:                               # %vector.memcheck518
	alsl.d	$a1, $s7, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 64
	move	$a1, $s7
...
.LBB14_74:                              # %vector.body528
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_74
# %bb.75:                               # %middle.block536
	bne	$a3, $a7, .LBB14_59
	b	.LBB14_61
.LBB14_76:                              # %vector.ph545
	andi	$a3, $a1, 12
	move	$a2, $a1
