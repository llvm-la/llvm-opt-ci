...
# %bb.45:                               # %.lr.ph302
	...
	move	$a1, $s7
	bgeu	$a3, $a7, .LBB14_70
.LBB14_46:                              # %scalar.ph520.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
.LBB14_57:                              # %vector.body541
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB14_57
# %bb.58:                               # %middle.block546
	beq	$s6, $a1, .LBB14_61
.LBB14_59:                              # %scalar.ph536.preheader
	sub.d	$a2, $a2, $a1
	alsl.d	$a3, $a1, $s5, 2
	alsl.d	$a0, $a1, $a0, 2
	.p2align	4, , 16
.LBB14_60:                              # %scalar.ph536
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a3, 0
	add.d	$a1, $a1, $s7
	st.w	$a1, $a0, 0
...
.LBB14_69:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit175
	...
	addi.d	$sp, $sp, 160
	ret
.LBB14_70:                              # %vector.memcheck515
	alsl.d	$a1, $s7, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 8
	move	$a1, $s7
	bltu	$a7, $t0, .LBB14_46
# %bb.71:                               # %vector.memcheck515
	alsl.d	$a1, $s7, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 16
	move	$a1, $s7
...
# %bb.79:                               # %.lr.ph281.preheader
	...
	addi.w	$a0, $a0, 0
	bgeu	$t1, $a4, .LBB14_82
.LBB14_80:                              # %.lr.ph281.preheader550
                                        #   in Loop: Header=BB14_78 Depth=1
	alsl.d	$t1, $a0, $s1, 2
	alsl.d	$t2, $a0, $s3, 3
	alsl.d	$t3, $a7, $a2, 2
...
# %bb.81:                               #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $zero
	b	.LBB15_92
.LBB15_82:                              # %vector.body501.preheader
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	addi.d	$a1, $s0, 16
	move	$a2, $s6
...
.LBB15_83:                              # %vector.body501
	...
	addi.d	$a0, $a0, 32
	bnez	$a2, .LBB15_83
# %bb.84:                               # %middle.block506
                                        #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $s6
	beq	$s5, $s6, .LBB15_87
.LBB15_85:                              # %.lr.ph.i187.preheader528
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
.LBB15_90:                              # %vector.body516
	...
	addi.d	$a0, $a0, 32
	bnez	$a2, .LBB15_90
# %bb.91:                               # %middle.block523
                                        #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $s6
	beq	$s5, $s6, .LBB15_94
.LBB15_92:                              # %.lr.ph.i205.preheader529
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
# %bb.138:                              # %vector.memcheck477
                                        #   in Loop: Header=BB15_67 Depth=1
	alsl.d	$a3, $a1, $s0, 3
	bgeu	$a0, $a3, .LBB15_153
# %bb.139:                              # %vector.memcheck477
                                        #   in Loop: Header=BB15_67 Depth=1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB15_147:                             # %vector.body467
	...
	addi.d	$a0, $a0, 32
	bnez	$a2, .LBB15_147
# %bb.148:                              # %middle.block474
                                        #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $s6
	beq	$s5, $s6, .LBB15_151
.LBB15_149:                             # %.lr.ph.i260.preheader527
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s1, 3
...
.LBB15_154:                             # %vector.body486
	...
	addi.d	$a3, $a3, 32
	bnez	$a5, .LBB15_154
# %bb.155:                              # %middle.block493
                                        #   in Loop: Header=BB15_67 Depth=1
	beq	$a1, $a2, .LBB15_143
	b	.LBB15_141
.LBB15_156:                             # %call.sqrt698
                                        #   in Loop: Header=BB15_67 Depth=1
	fmov.d	$fa0, $fs1
...
# %bb.160:
	...
	b	.LBB15_175
.LBB15_161:                             # %vector.memcheck442
	sub.d	$a5, $s8, $a0
	ori	$a4, $zero, 32
	move	$a2, $zero
	bltu	$a5, $a4, .LBB15_47
# %bb.162:                              # %vector.memcheck442
	sub.d	$a5, $s8, $s1
	bltu	$a5, $a4, .LBB15_47
# %bb.163:                              # %vector.ph449
	bstrpick.d	$a2, $a3, 30, 2
...
.Ltmp984:                               # EH_LABEL
	b	.LBB15_200
.LBB15_193:                             # %.loopexit.split-lp353
.Ltmp978:                               # EH_LABEL
	b	.LBB15_200
.LBB15_194:
.Ltmp990:                               # EH_LABEL
...
.Ltmp987:                               # EH_LABEL
	b	.LBB15_200
.LBB15_198:                             # %.loopexit351
.Ltmp950:                               # EH_LABEL
	b	.LBB15_200
.LBB15_199:                             # %.loopexit352
.Ltmp963:                               # EH_LABEL
.LBB15_200:
	move	$s2, $a0
	bnez	$s1, .LBB15_204
...
# %bb.81:                               #   in Loop: Header=BB16_67 Depth=1
	move	$a2, $zero
	b	.LBB16_92
.LBB16_82:                              # %vector.body501.preheader
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	addi.d	$a1, $s0, 16
	move	$a2, $s6
...
# %bb.84:                               # %middle.block506
	...
	move	$a2, $s6
	beq	$s5, $s6, .LBB16_87
.LBB16_85:                              # %.lr.ph.i187.preheader528
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
# %bb.91:                               # %middle.block523
	...
	move	$a2, $s6
	beq	$s5, $s6, .LBB16_94
.LBB16_92:                              # %.lr.ph.i205.preheader529
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
# %bb.148:                              # %middle.block474
	...
	move	$a2, $s6
	beq	$s5, $s6, .LBB16_151
.LBB16_149:                             # %.lr.ph.i260.preheader527
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s1, 3
...
.Ltmp1087:                              # EH_LABEL
	b	.LBB16_200
.LBB16_193:                             # %.loopexit.split-lp353
.Ltmp1081:                              # EH_LABEL
	b	.LBB16_200
.LBB16_194:
.Ltmp1093:                              # EH_LABEL
...
.Ltmp1090:                              # EH_LABEL
	b	.LBB16_200
.LBB16_198:                             # %.loopexit351
.Ltmp1053:                              # EH_LABEL
	b	.LBB16_200
.LBB16_199:                             # %.loopexit352
.Ltmp1066:                              # EH_LABEL
.LBB16_200:
	move	$s2, $a0
	bnez	$s1, .LBB16_204
