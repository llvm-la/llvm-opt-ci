...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %.lr.ph.i166.preheader369
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB5_74:                               # %.lr.ph.i209
	...
	b	.LBB5_64
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck341
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $s3
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.76:                               # %vector.memcheck341
                                        #   in Loop: Header=BB5_65 Depth=1
	ld.d	$a6, $sp, 328                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.77:                               # %vector.memcheck341
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.78:                               # %vector.memcheck341
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
...
.LBB5_80:                               # %vector.body354
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB5_80
# %bb.81:                               # %middle.block365
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_67
	b	.LBB5_69
	.p2align	4, , 16
.LBB5_82:                               # %vector.memcheck322
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
# %bb.83:                               # %vector.memcheck322
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
...
.LBB5_85:                               # %vector.body331
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_85
# %bb.86:                               # %middle.block338
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_70
	b	.LBB5_72
	.p2align	4, , 16
.LBB5_87:                               # %vector.memcheck303
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
# %bb.88:                               # %vector.memcheck303
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $s3
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
