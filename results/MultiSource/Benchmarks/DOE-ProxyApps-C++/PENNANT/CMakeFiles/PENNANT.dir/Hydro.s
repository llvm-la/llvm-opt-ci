...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %.lr.ph.i166.preheader347
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB5_67:                               # %.lr.ph.i209
	...
	b	.LBB5_57
	.p2align	4, , 16
.LBB5_68:                               # %vector.memcheck319
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $s8
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.69:                               # %vector.memcheck319
                                        #   in Loop: Header=BB5_58 Depth=1
	ld.d	$a6, $sp, 264                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.70:                               # %vector.memcheck319
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
...
.LBB5_73:                               # %vector.body332
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB5_73
# %bb.74:                               # %middle.block343
                                        #   in Loop: Header=BB5_58 Depth=1
	bne	$a0, $a7, .LBB5_60
	b	.LBB5_62
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck300
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_63
# %bb.76:                               # %vector.memcheck300
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_63
