...
.LBB6_104:                              # %vector.body449
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_104
# %bb.105:                              # %middle.block454
	beq	$a0, $a3, .LBB6_108
.LBB6_106:                              # %scalar.ph444.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a4, $a3, $s3, 3
	sub.d	$a0, $a3, $a0
	.p2align	4, , 16
.LBB6_107:                              # %scalar.ph444
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	slli.d	$a3, $a3, 3
	fldx.d	$fa0, $s1, $a3
...
.LBB6_146:                              # %vector.body462
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_146
# %bb.147:                              # %middle.block467
	beq	$a0, $a3, .LBB6_150
.LBB6_148:                              # %scalar.ph457.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a4, $a3, $s5, 3
	sub.d	$a0, $a3, $a0
	.p2align	4, , 16
.LBB6_149:                              # %scalar.ph457
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	slli.d	$a3, $a3, 3
	fldx.d	$fa0, $s1, $a3
