...
# %bb.146:                              # %middle.block1396
	...
	beq	$a2, $a4, .LBB5_152
# %bb.147:                              # %vec.epilog.iter.check1403
	beqz	$a6, .LBB5_151
.LBB5_148:                              # %vec.epilog.ph1405
	bstrpick.d	$a1, $a2, 62, 2
	slli.d	$a6, $a1, 2
	alsl.d	$a1, $a1, $a3, 4
	vrepli.b	$vr0, 0
	...
	alsl.d	$a3, $a4, $a3, 2
	.p2align	4, , 16
.LBB5_149:                              # %vec.epilog.vector.body1408
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a5, $a5, 4
	addi.d	$a3, $a3, 16
	bnez	$a5, .LBB5_149
# %bb.150:                              # %vec.epilog.middle.block1414
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
...
.LBB5_155:
	move	$a4, $zero
	b	.LBB5_166
.LBB5_156:                              # %vector.main.loop.iter.check1419
	srli.d	$a2, $a1, 2
	ori	$a4, $zero, 60
	addi.d	$a2, $a2, 1
	bgeu	$a1, $a4, .LBB5_158
...
# %bb.160:                              # %middle.block1432
	...
	beq	$a2, $a5, .LBB5_166
# %bb.161:                              # %vec.epilog.iter.check1439
	beqz	$a6, .LBB5_165
.LBB5_162:                              # %vec.epilog.ph1441
	bstrpick.d	$a1, $a2, 62, 2
	slli.d	$a6, $a1, 2
	alsl.d	$a1, $a1, $a3, 4
	vrepli.b	$vr0, 0
	...
	alsl.d	$a3, $a5, $a3, 2
	.p2align	4, , 16
.LBB5_163:                              # %vec.epilog.vector.body1444
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a4, $a4, 4
	addi.d	$a3, $a3, 16
	bnez	$a4, .LBB5_163
# %bb.164:                              # %vec.epilog.middle.block1450
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
...
# %bb.190:                              # %.preheader1064
	...
	ld.w	$a0, $a0, 0
	blez	$a0, .LBB5_249
# %bb.191:                              # %iter.check1469
	ld.d	$a1, $s7, 104
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a0, $a3, .LBB5_247
# %bb.192:                              # %iter.check1469
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	sub.d	$a3, $a3, $a1
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB5_247
# %bb.193:                              # %vector.main.loop.iter.check1456
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB5_240
# %bb.194:
	move	$a2, $zero
...
.LBB5_241:                              # %vector.body1461
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB5_241
# %bb.242:                              # %middle.block1466
	beq	$a2, $a0, .LBB5_249
# %bb.243:                              # %vec.epilog.iter.check1471
	beqz	$a3, .LBB5_247
.LBB5_244:                              # %vec.epilog.ph1473
	move	$a5, $a2
	...
	vrepli.w	$vr0, 3
	.p2align	4, , 16
.LBB5_245:                              # %vec.epilog.vector.body1476
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vmul.w	$vr1, $vr1, $vr0
	vst	$vr1, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB5_245
# %bb.246:                              # %vec.epilog.middle.block1480
	beq	$a2, $a0, .LBB5_249
.LBB5_247:                              # %vec.epilog.scalar.ph1470.preheader
	alsl.d	$a1, $a2, $a1, 2
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	alsl.d	$a3, $a2, $a3, 2
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB5_248:                              # %vec.epilog.scalar.ph1470
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a1, 0
	alsl.d	$a2, $a2, $a2, 1
	st.w	$a2, $a3, 0
...
# %bb.311:                              # %.preheader1049
	...
	ld.w	$a7, $a1, 0
	blez	$a7, .LBB5_325
# %bb.312:                              # %iter.check1498
	ld.d	$a1, $s7, 128
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a7, $a3, .LBB5_323
# %bb.313:                              # %iter.check1498
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	sub.d	$a3, $a3, $a1
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB5_323
# %bb.314:                              # %vector.main.loop.iter.check1485
	ori	$a2, $zero, 16
	bgeu	$a7, $a2, .LBB5_316
# %bb.315:
	move	$a2, $zero
	b	.LBB5_320
.LBB5_316:                              # %vector.ph1487
	andi	$a3, $a7, 12
...
.LBB5_317:                              # %vector.body1490
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB5_317
# %bb.318:                              # %middle.block1495
	beq	$a2, $a7, .LBB5_325
# %bb.319:                              # %vec.epilog.iter.check1500
	beqz	$a3, .LBB5_323
.LBB5_320:                              # %vec.epilog.ph1502
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB5_321:                              # %vec.epilog.vector.body1505
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vslli.w	$vr0, $vr0, 2
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB5_321
# %bb.322:                              # %vec.epilog.middle.block1509
	beq	$a2, $a7, .LBB5_325
.LBB5_323:                              # %vec.epilog.scalar.ph1499.preheader
	alsl.d	$a1, $a2, $a1, 2
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	alsl.d	$a3, $a2, $a3, 2
	sub.d	$a4, $a7, $a2
	.p2align	4, , 16
.LBB5_324:                              # %vec.epilog.scalar.ph1499
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a1, 0
	slli.d	$a2, $a2, 2
	st.w	$a2, $a3, 0
...
# %bb.410:
	...
	move	$a0, $s3
	b	.LBB5_420
.LBB5_411:                              # %vector.main.loop.iter.check1515
	srli.d	$a1, $a0, 2
	ori	$a2, $zero, 60
	addi.d	$a1, $a1, 1
	bgeu	$a0, $a2, .LBB5_413
...
# %bb.415:                              # %middle.block1528
	...
	beq	$a1, $a2, .LBB5_421
# %bb.416:                              # %vec.epilog.iter.check1536
	beqz	$a4, .LBB5_420
.LBB5_417:                              # %vec.epilog.ph1538
	...
	alsl.d	$a2, $a2, $s3, 2
	.p2align	4, , 16
.LBB5_418:                              # %vec.epilog.vector.body1541
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a2, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a3, $a3, 4
	addi.d	$a2, $a2, 16
	bnez	$a3, .LBB5_418
# %bb.419:                              # %vec.epilog.middle.block1547
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
