...
# %bb.0:
	...
	st.w	$a1, $a0, 4
	st.w	$zero, $a0, 8
	pcalau12i	$s0, %pc_hi20(do_crux_timing)
	bnez	$a1, .LBB0_2
# %bb.1:
	beqz	$a3, .LBB0_5
.LBB0_2:
	ori	$a0, $zero, 1
	st.b	$a0, $s0, %pc_lo12(do_crux_timing)
...
.LBB0_5:
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $fp, 0
	pcalau12i	$a2, %pc_hi20(crux_data)
	st.d	$a0, $a2, %pc_lo12(crux_data)
	blez	$a1, .LBB0_8
...
.LBB0_8:                                # %._crit_edge
	...
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.bu	$a1, $s0, %pc_lo12(do_crux_timing)
