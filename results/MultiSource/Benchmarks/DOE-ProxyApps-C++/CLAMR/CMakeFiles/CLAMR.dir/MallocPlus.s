...
# %bb.14:                               #   in Loop: Header=BB6_10 Depth=1
	...
	maskeqz	$a0, $s8, $a0
	or	$a0, $a0, $a1
.LBB6_15:                               # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS5_EPSt18_Rb_tree_node_baseRS2_.exit.thread.i.i
                                        #   in Loop: Header=BB6_10 Depth=1
	move	$a1, $s8
	pcaddu18i	$ra, %call36(_ZSt28_Rb_tree_rebalance_for_erasePSt18_Rb_tree_node_baseRS_)
	jirl	$ra, $ra, 0
...
# %bb.13:                               #   in Loop: Header=BB8_9 Depth=1
	...
	maskeqz	$a0, $s4, $a0
	or	$a0, $a0, $a1
.LBB8_14:                               # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS5_EPSt18_Rb_tree_node_baseRS2_.exit.thread.i.i
                                        #   in Loop: Header=BB8_9 Depth=1
	move	$a1, $s4
	pcaddu18i	$ra, %call36(_ZSt28_Rb_tree_rebalance_for_erasePSt18_Rb_tree_node_baseRS_)
	jirl	$ra, $ra, 0
...
# %bb.59:                               #   in Loop: Header=BB15_9 Depth=1
	...
	move	$s5, $s3
	beqz	$a0, .LBB15_64
# %bb.60:                               # %.lr.ph.i.i.i.i.preheader
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$a1, $s3
	.p2align	4, , 16
.LBB15_61:                              # %.lr.ph.i.i.i.i
                                        #   Parent Loop BB15_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 32
	sltu	$a2, $a2, $s7
	...
	or	$a1, $a1, $a3
	bnez	$a0, .LBB15_61
# %bb.62:                               # %_ZNSt3mapIPvP24malloc_plus_memory_entrySt4lessIS0_ESaISt4pairIKS0_S2_EEE11lower_boundERS6_.exit.i
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$s5, $s3
	beq	$a1, $s3, .LBB15_64
...
.Ltmp93:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp94:                                # EH_LABEL
# %bb.75:                               # %_ZNSt3mapIPvP24malloc_plus_memory_entrySt4lessIS0_ESaISt4pairIKS0_S2_EEED2Ev.exit
...
.Ltmp89:                                # EH_LABEL
	b	.LBB15_90
.LBB15_83:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_Auto_nodeD2Ev.exit.i144
.Ltmp86:                                # EH_LABEL
	b	.LBB15_88
.LBB15_84:
.Ltmp83:                                # EH_LABEL
