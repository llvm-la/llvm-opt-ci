...
# %bb.130:                              # %vector.scevcheck
	...
	move	$t3, $a7
	bnez	$t4, .LBB16_28
# %bb.131:                              # %vector.main.loop.iter.check626
	ori	$a7, $zero, 16
	bgeu	$a0, $a7, .LBB16_141
# %bb.132:
	move	$a7, $zero
	move	$t2, $zero
	move	$t3, $zero
...
# %bb.135:                              # %middle.block
	beq	$a2, $a5, .LBB16_20
# %bb.136:                              # %vec.epilog.iter.check
	beqz	$a6, .LBB16_18
.LBB16_137:                             # %vec.epilog.ph
	move	$t2, $a5
	...
	vrepli.w	$vr0, -98
	.p2align	4, , 16
.LBB16_138:                             # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $t2, 0
	vst	$vr0, $t1, 0
	vst	$vr0, $t0, 0
...
# %bb.143:                              # %middle.block649
	...
	beq	$a0, $a7, .LBB16_30
# %bb.144:                              # %vec.epilog.iter.check659
	beqz	$t4, .LBB16_28
.LBB16_145:                             # %vec.epilog.ph661
	move	$t4, $a7
	...
	vrepli.b	$vr6, -1
	.p2align	4, , 16
.LBB16_146:                             # %vec.epilog.vector.body674
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr7, $t3, 0
	vld	$vr8, $t2, 0
	vsub.w	$vr7, $vr4, $vr7
	...
	addi.d	$t3, $t3, 16
	bnez	$t0, .LBB16_146
# %bb.147:                              # %vec.epilog.middle.block684
	vbsrl.v	$vr4, $vr3, 8
	vmin.w	$vr3, $vr4, $vr3
	vbsrl.v	$vr4, $vr3, 4
	vmin.w	$vr3, $vr4, $vr3
...
.LBB16_153:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB16_154:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit463
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end16:
...
.LBB18_36:                              #   in Loop: Header=BB18_37 Depth=2
	...
	addi.w	$t7, $t7, 1
	bgeu	$t8, $a1, .LBB18_66
.LBB18_37:                              #   Parent Loop BB18_34 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$s1, $s2, $t6
	ldx.w	$t8, $a2, $t6
	stx.w	$s1, $s4, $t6
...
.LBB18_69:                              # %.critedge
	...
	maskeqz	$a0, $a7, $a0
	or	$s5, $a0, $a1
.LBB18_70:                              # %_ZNSt6vectorIiSaIiEE5clearEv.exit
	ld.d	$a1, $fp, 1176
	sub.d	$s4, $s5, $s2
	srai.d	$a0, $s4, 2
	addi.w	$s8, $zero, -1
...
# %bb.73:                               # %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i472
	sltu	$a2, $s1, $a0
	masknez	$a3, $s1, $a2
	maskeqz	$a2, $a0, $a2
	or	$a2, $a2, $a3
...
# %bb.74:                               # %.noexc481
	...
	stx.w	$zero, $a0, $s4
	beqz	$a1, .LBB18_76
# %bb.75:                               # %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i29.i474
	addi.d	$a0, $s5, 4
	slli.d	$a2, $a1, 2
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB18_76:                              # %_ZSt27__uninitialized_default_n_aIPimiET_S1_T0_RSaIT1_E.exit32.i476
	blez	$s4, .LBB18_78
# %bb.77:
	move	$a0, $s6
	move	$a1, $s2
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB18_78:                              # %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit.i477
	beqz	$s2, .LBB18_80
# %bb.79:
	sub.d	$a1, $s7, $s2
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB18_80:                              # %_ZZNSt6vectorIiSaIiEE17_M_default_appendEmEN6_GuardD2Ev.exit.i479
	alsl.d	$s5, $s1, $s5, 2
...
.LBB18_83:
	...
	addi.d	$s5, $s5, 4
	beqz	$s1, .LBB18_85
# %bb.84:                               # %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i468
	slli.d	$a2, $s1, 2
	move	$a0, $s5
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
	alsl.d	$s5, $s1, $s5, 2
.LBB18_85:                              # %_ZNSt6vectorIiSaIiEE6resizeEm.exit427
	ld.d	$s4, $s3, 0
	ld.d	$a0, $s3, 8
...
.LBB18_96:                              #   in Loop: Header=BB18_89 Depth=1
	...
	add.w	$t7, $t8, $t7
	blt	$t6, $t7, .LBB18_87
# %bb.97:                               #   in Loop: Header=BB18_89 Depth=1
	ldx.w	$t7, $t3, $a4
.LBB18_98:                              #   in Loop: Header=BB18_89 Depth=1
	...
	bge	$t6, $t7, .LBB18_88
	b	.LBB18_87
.LBB18_99:                              #   in Loop: Header=BB18_89 Depth=1
	bne	$t8, $t4, .LBB18_102
# %bb.100:                              #   in Loop: Header=BB18_89 Depth=1
	andi	$t8, $t7, 1
	bnez	$t8, .LBB18_102
# %bb.101:                              #   in Loop: Header=BB18_89 Depth=1
	ldx.w	$t6, $t2, $a4
	b	.LBB18_104
.LBB18_102:                             #   in Loop: Header=BB18_89 Depth=1
	or	$t6, $t7, $t6
	andi	$t6, $t6, 1
	bnez	$t6, .LBB18_88
# %bb.103:                              #   in Loop: Header=BB18_89 Depth=1
	ldx.w	$t6, $a7, $a4
.LBB18_104:                             #   in Loop: Header=BB18_89 Depth=1
	slli.d	$t6, $t6, 2
	ldx.w	$t7, $s4, $t6
	ldx.w	$t8, $t0, $t6
	ldx.w	$t6, $t0, $a4
	...
	add.w	$t7, $t8, $t7
	blt	$t6, $t7, .LBB18_87
# %bb.105:                              #   in Loop: Header=BB18_89 Depth=1
	ldx.w	$t7, $t1, $a4
	b	.LBB18_98
.LBB18_106:                             # %.lr.ph680
	st.d	$s4, $s3, 0
	...
	b	.LBB18_109
	.p2align	4, , 16
.LBB18_107:                             # %.sink.split748
                                        #   in Loop: Header=BB18_109 Depth=1
	stx.w	$zero, $s4, $t2
.LBB18_108:                             #   in Loop: Header=BB18_109 Depth=1
	bstrpick.d	$t5, $t4, 31, 0
	addi.d	$t2, $t2, 4
	addi.w	$t4, $t4, 1
	bgeu	$t5, $s6, .LBB18_125
.LBB18_109:                             # =>This Inner Loop Header: Depth=1
	ldx.w	$t5, $s2, $t2
	stx.w	$t5, $s4, $t2
	bltu	$t5, $a1, .LBB18_108
# %bb.110:                              #   in Loop: Header=BB18_109 Depth=1
	ldx.w	$t5, $a3, $t2
	ldx.w	$t6, $a4, $t2
	and	$t8, $t5, $a2
	and	$s3, $t6, $a2
	bne	$t8, $t3, .LBB18_112
# %bb.111:                              #   in Loop: Header=BB18_109 Depth=1
	move	$s1, $t0
	move	$t7, $a7
	beq	$s3, $t3, .LBB18_117
.LBB18_112:                             #   in Loop: Header=BB18_109 Depth=1
	andi	$t7, $t5, 1
	bnez	$t7, .LBB18_114
# %bb.113:                              #   in Loop: Header=BB18_109 Depth=1
	move	$s1, $t0
	move	$t7, $a6
	beq	$s3, $t3, .LBB18_117
.LBB18_114:                             #   in Loop: Header=BB18_109 Depth=1
	bne	$t8, $t3, .LBB18_116
# %bb.115:                              #   in Loop: Header=BB18_109 Depth=1
	andi	$t8, $t6, 1
	move	$s1, $a5
	move	$t7, $a7
	beqz	$t8, .LBB18_117
.LBB18_116:                             #   in Loop: Header=BB18_109 Depth=1
	or	$t5, $t6, $t5
	andi	$t5, $t5, 1
	move	$s1, $a5
	move	$t7, $a6
	bnez	$t5, .LBB18_124
	.p2align	4, , 16
.LBB18_117:                             #   in Loop: Header=BB18_109 Depth=1
	ldx.w	$t8, $s1, $t2
	slli.d	$t5, $t8, 2
	ldx.w	$t5, $t7, $t5
	bltz	$t5, .LBB18_107
# %bb.118:                              #   in Loop: Header=BB18_109 Depth=1
	ldx.w	$t6, $t7, $t2
	bstrpick.d	$t5, $t5, 31, 0
	slli.d	$t7, $t8, 2
	ldx.w	$t8, $s2, $t7
	bne	$t8, $s8, .LBB18_107
.LBB18_119:                             #   in Loop: Header=BB18_109 Depth=1
	ldx.w	$t8, $t1, $t7
	ldx.w	$t7, $t1, $t2
	bne	$t8, $t7, .LBB18_107
# %bb.120:                              #   in Loop: Header=BB18_109 Depth=1
	slli.d	$t6, $t6, 2
	ldx.w	$t8, $s2, $t6
	bne	$t8, $s8, .LBB18_107
# %bb.121:                              #   in Loop: Header=BB18_109 Depth=1
	ldx.w	$t6, $t1, $t6
	bne	$t6, $t7, .LBB18_107
# %bb.122:                              #   in Loop: Header=BB18_109 Depth=1
	slli.d	$t5, $t5, 2
	ldx.w	$t6, $s2, $t5
	bne	$t6, $s8, .LBB18_107
# %bb.123:                              #   in Loop: Header=BB18_109 Depth=1
	ldx.w	$t5, $t1, $t5
	beq	$t5, $t7, .LBB18_108
	b	.LBB18_107
.LBB18_124:                             #   in Loop: Header=BB18_109 Depth=1
	move	$t5, $zero
	move	$t6, $zero
	move	$t8, $zero
	slli.d	$t7, $t8, 2
...
.LBB18_125:                             # %.lr.ph682
	...
	move	$t1, $zero
	b	.LBB18_129
.LBB18_126:                             #   in Loop: Header=BB18_129 Depth=1
	move	$t2, $a3
.LBB18_127:                             # %.sink.split749
                                        #   in Loop: Header=BB18_129 Depth=1
	ldx.w	$t2, $t2, $t1
	slli.d	$t2, $t2, 2
	ldx.w	$t2, $s4, $t2
	stx.w	$t2, $s4, $t1
.LBB18_128:                             #   in Loop: Header=BB18_129 Depth=1
	bstrpick.d	$t2, $a6, 31, 0
	addi.d	$t1, $t1, 4
	addi.w	$a6, $a6, 1
	bgeu	$t2, $s6, .LBB18_134
.LBB18_129:                             # =>This Inner Loop Header: Depth=1
	ldx.w	$t2, $a1, $t1
	bgez	$t2, .LBB18_128
# %bb.130:                              #   in Loop: Header=BB18_129 Depth=1
	addi.d	$t2, $t2, 4
	bltu	$a7, $t2, .LBB18_128
# %bb.131:                              #   in Loop: Header=BB18_129 Depth=1
	slli.d	$t2, $t2, 2
	ldx.w	$t2, $t0, $t2
	add.d	$t3, $t0, $t2
	move	$t2, $a5
	jr	$t3
.LBB18_132:                             #   in Loop: Header=BB18_129 Depth=1
	move	$t2, $a2
	b	.LBB18_127
.LBB18_133:                             #   in Loop: Header=BB18_129 Depth=1
	move	$t2, $a4
	b	.LBB18_127
.LBB18_134:                             # %._crit_edge683
	bne	$a0, $s4, .LBB18_137
# %bb.135:
	move	$s3, $zero
	move	$a0, $zero
	b	.LBB18_142
.LBB18_136:                             # %._crit_edge683.thread
	st.d	$s4, $s3, 0
	st.d	$a0, $s3, 8
	st.d	$a3, $s3, 16
	beq	$a0, $s4, .LBB18_162
...
# %bb.138:                              # %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i432
.Ltmp147:                               # EH_LABEL
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_Znwm)
	jirl	$ra, $ra, 0
...
# %bb.140:
	...
	pcaddu18i	$ra, %call36(memmove)
	jirl	$ra, $ra, 0
.LBB18_141:                             # %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit436
	add.d	$a0, $s3, $s5
	beqz	$s6, .LBB18_156
.LBB18_142:                             # %.lr.ph.i438
	move	$a2, $zero
	move	$a1, $zero
	move	$a3, $zero
	ld.d	$a4, $fp, 1360
...
.LBB18_143:                             #   in Loop: Header=BB18_145 Depth=1
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB18_144:                             # %.thread.i443
                                        #   in Loop: Header=BB18_145 Depth=1
	bstrpick.d	$t2, $t1, 31, 0
	addi.d	$a2, $a2, 4
	addi.w	$t1, $t1, 1
	bgeu	$t2, $s6, .LBB18_155
...
# %bb.148:                              #   in Loop: Header=BB18_145 Depth=1
	...
	b	.LBB18_144
	.p2align	4, , 16
.LBB18_149:                             #   in Loop: Header=BB18_145 Depth=1
	ldx.w	$t4, $a4, $a2
	ldx.w	$t2, $a5, $a2
	ldx.w	$t3, $a6, $a2
	bne	$t4, $a7, .LBB18_151
# %bb.150:                              #   in Loop: Header=BB18_145 Depth=1
	or	$t2, $t2, $t3
	b	.LBB18_154
...
.LBB18_157:
	...
	ld.w	$a0, $s0, 0
	sltu	$a2, $zero, $a1
.LBB18_158:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit455
	sltu	$a3, $zero, $a0
	ld.d	$a0, $sp, 40
	ld.d	$a1, $sp, 48
	or	$a2, $a3, $a2
...
# %bb.160:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB18_161:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit457
	add.w	$a0, $s1, $s6
...
# %bb.174:
	...
	jirl	$ra, $ra, 0
	move	$a0, $fp
.LBB18_175:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit461
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end18:
	...
	.p2align	2, 0x0
.LJTI18_0:
	.word	.LBB18_132-.LJTI18_0
	.word	.LBB18_126-.LJTI18_0
...
# %bb.217:                              #   in Loop: Header=BB19_215 Depth=1
	st.w	$t1, $a2, 0
.LBB19_218:                             #   in Loop: Header=BB19_215 Depth=1
	ld.w	$t3, $a5, 0
	beq	$t3, $a6, .LBB19_214
# %bb.219:                              #   in Loop: Header=BB19_215 Depth=1
	ld.wu	$t3, $a3, 0
	and	$t3, $t3, $a7
	addi.w	$t3, $t3, 0
	bne	$t3, $a6, .LBB19_214
...
# %bb.224:                              # %middle.block
	beq	$a0, $a2, .LBB19_189
# %bb.225:                              # %vec.epilog.iter.check
	beqz	$a3, .LBB19_11
.LBB19_226:                             # %vec.epilog.ph
	move	$a4, $a2
	...
	alsl.d	$a4, $a4, $a1, 2
	.p2align	4, , 16
.LBB19_227:                             # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB19_227
# %bb.228:                              # %vec.epilog.middle.block
	bne	$a0, $a2, .LBB19_11
	b	.LBB19_189
.LBB19_229:                             # %vector.ph611
	andi	$a6, $a1, 12
...
.LBB19_230:                             # %vector.body614
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB19_230
# %bb.231:                              # %middle.block617
	beq	$a5, $a1, .LBB19_153
# %bb.232:                              # %vec.epilog.iter.check621
	beqz	$a6, .LBB19_151
.LBB19_233:                             # %vec.epilog.ph623
	move	$t2, $a5
	...
	vrepli.b	$vr0, -1
	.p2align	4, , 16
.LBB19_234:                             # %vec.epilog.vector.body626
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $t2, 0
	vst	$vr0, $t1, 0
	vst	$vr0, $t0, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB19_234
# %bb.235:                              # %vec.epilog.middle.block629
	bne	$a5, $a1, .LBB19_151
	b	.LBB19_153
.LBB19_236:
	pcalau12i	$a0, %pc_hi20(_ZGVZN4Mesh10rezone_allEiiSt6vectorIiSaIiEEiR10MallocPlusE13celltype_save)
