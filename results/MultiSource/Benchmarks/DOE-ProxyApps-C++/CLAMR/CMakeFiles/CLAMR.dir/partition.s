...
.LBB0_204:                              # %_ZNSt7__cxx114listIiSaIiEE6uniqueEv.exit
	...
	vinsgr2vr.d	$vr0, $a1, 0
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	fld.d	$fa1, $a1, %pc_lo12(_ZZN4Mesh17partition_measureEvE13offtile_ratio)
	vffint.d.lu	$vr0, $vr0
	vreplvei.d	$vr0, $vr0, 0
	fmul.d	$fa0, $fa0, $fs0
	fadd.d	$fa0, $fa1, $fa0
...
# %bb.9:
	move	$a2, $zero
.LBB4_10:                               # %scalar.ph1061.preheader
	move	$a3, $a2
	.p2align	4, , 16
.LBB4_11:                               # %scalar.ph1061
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a2, $a2, 2
	stx.w	$a3, $a1, $a2
	addi.w	$a3, $a3, 1
...
# %bb.53:
	...
	move	$a3, $zero
	move	$a4, $zero
.LBB4_54:                               # %scalar.ph832.preheader
	addi.w	$a5, $a2, 1
	.p2align	4, , 16
.LBB4_55:                               # %scalar.ph832
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a2, $a2, 2
	ldx.w	$a6, $a0, $a2
	slt	$a7, $a3, $a6
...
# %bb.57:
	move	$a2, $zero
.LBB4_58:                               # %scalar.ph860.preheader
	addi.w	$a3, $a2, 1
	.p2align	4, , 16
.LBB4_59:                               # %scalar.ph860
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a2, $a2, 2
	ldx.w	$a4, $a0, $a2
	movgr2fr.w	$fa2, $a4
...
# %bb.68:
	move	$a4, $zero
.LBB4_69:                               # %scalar.ph959.preheader
	addi.w	$a5, $a4, 1
	vldi	$vr4, -928
	.p2align	4, , 16
.LBB4_70:                               # %scalar.ph959
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a4, $a4, 3
	fldx.d	$fa5, $a1, $a4
	fldx.d	$fa6, $a0, $a4
...
# %bb.98:
	move	$a1, $zero
.LBB4_99:                               # %scalar.ph986.preheader
	addi.w	$a2, $a1, 1
	.p2align	4, , 16
.LBB4_100:                              # %scalar.ph986
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a1, $a1, 2
	ldx.w	$a3, $s1, $a1
	stx.w	$a3, $a0, $a1
...
.LBB4_104:                              # %vector.scevcheck1060
	...
	move	$a2, $zero
	beq	$a4, $a5, .LBB4_10
# %bb.105:                              # %vector.scevcheck1060
	srli.d	$a3, $a3, 32
	bnez	$a3, .LBB4_10
# %bb.106:                              # %vector.ph1063
...
.LBB4_107:                              # %vector.body1066
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB4_107
# %bb.108:                              # %middle.block1069
	bne	$a0, $a2, .LBB4_10
	b	.LBB4_12
.LBB4_109:                              # %vector.scevcheck938
	addi.d	$a5, $s7, -1
	...
	move	$a4, $zero
	beq	$a6, $a7, .LBB4_69
# %bb.110:                              # %vector.scevcheck938
	srli.d	$a5, $a5, 32
	bnez	$a5, .LBB4_69
# %bb.111:                              # %vector.memcheck939
	sub.d	$a4, $s5, $s3
	sub.d	$a5, $s3, $a0
	sub.d	$a6, $s3, $a1
	sub.d	$a7, $a2, $s3
...
# %bb.120:                              # %middle.block846
	...
	bne	$s5, $a2, .LBB4_54
	b	.LBB4_56
.LBB4_121:                              # %vector.scevcheck852
	bstrpick.d	$a3, $s3, 31, 0
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	move	$a2, $zero
	beq	$a3, $a4, .LBB4_58
# %bb.122:                              # %vector.scevcheck852
	srli.d	$a3, $s3, 32
	bnez	$a3, .LBB4_58
...
# %bb.143:                              # %_ZNSt6vectorIdSaIdEEC2EmRKS0_.exit
	...
	addi.w	$a1, $s0, 0
	blez	$a1, .LBB4_180
.LBB4_144:                              # %.lr.ph521.preheader
	bstrpick.d	$a1, $s0, 30, 0
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a1, $a3, .LBB4_149
# %bb.145:                              # %.lr.ph521.preheader
	sub.d	$a3, $a0, $s2
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB4_149
# %bb.146:                              # %vector.ph1004
...
.LBB4_147:                              # %vector.body1007
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB4_147
# %bb.148:                              # %middle.block1012
	beq	$a1, $a2, .LBB4_151
.LBB4_149:                              # %.lr.ph521.preheader1087
	alsl.d	$a3, $a2, $s2, 3
	alsl.d	$a4, $a2, $a0, 3
	sub.d	$a2, $a1, $a2
	.p2align	4, , 16
...
.LBB4_156:                              # %vector.body1022
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_156
# %bb.157:                              # %middle.block1027
	beq	$a1, $a3, .LBB4_160
.LBB4_158:                              # %scalar.ph1017.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_159:                              # %scalar.ph1017
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_165:                              # %vector.body1037
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_165
# %bb.166:                              # %middle.block1042
	beq	$a1, $a3, .LBB4_169
.LBB4_167:                              # %scalar.ph1032.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_168:                              # %scalar.ph1032
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_174:                              # %vector.body1052
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_174
# %bb.175:                              # %middle.block1057
	beq	$a1, $a3, .LBB4_178
.LBB4_176:                              # %scalar.ph1047.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_177:                              # %scalar.ph1047
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
# %bb.194:                              # %_ZNSt6vectorIdSaIdEEC2EmRKS0_.exit232
	...
	addi.w	$a1, $s5, 0
	blez	$a1, .LBB4_231
.LBB4_195:                              # %.lr.ph496.preheader
	bstrpick.d	$a1, $s5, 30, 0
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a1, $a3, .LBB4_200
# %bb.196:                              # %.lr.ph496.preheader
	sub.d	$a3, $a0, $s6
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB4_200
# %bb.197:                              # %vector.ph882
...
.LBB4_198:                              # %vector.body885
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB4_198
# %bb.199:                              # %middle.block890
	beq	$a1, $a2, .LBB4_202
.LBB4_200:                              # %.lr.ph496.preheader1090
	alsl.d	$a3, $a2, $s6, 3
	alsl.d	$a4, $a2, $a0, 3
	sub.d	$a2, $a1, $a2
	.p2align	4, , 16
...
.LBB4_207:                              # %vector.body900
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_207
# %bb.208:                              # %middle.block905
	beq	$a1, $a3, .LBB4_211
.LBB4_209:                              # %scalar.ph895.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_210:                              # %scalar.ph895
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_216:                              # %vector.body915
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_216
# %bb.217:                              # %middle.block920
	beq	$a1, $a3, .LBB4_220
.LBB4_218:                              # %scalar.ph910.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_219:                              # %scalar.ph910
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_225:                              # %vector.body930
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_225
# %bb.226:                              # %middle.block935
	beq	$a1, $a3, .LBB4_229
.LBB4_227:                              # %scalar.ph925.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_228:                              # %scalar.ph925
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_233:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit.sink.split
	...
	jirl	$ra, $ra, 0
	b	.LBB4_83
.LBB4_234:                              # %vector.scevcheck983
	bstrpick.d	$a2, $s2, 31, 0
	addi.w	$a3, $zero, -1
	lu32i.d	$a3, 0
	move	$a1, $zero
	beq	$a2, $a3, .LBB4_99
# %bb.235:                              # %vector.scevcheck983
	srli.d	$a2, $s2, 32
	bnez	$a2, .LBB4_99
# %bb.236:                              # %vector.scevcheck983
	sub.d	$a2, $a0, $s1
	ori	$a3, $zero, 32
	bltu	$a2, $a3, .LBB4_99
# %bb.237:                              # %vector.ph988
...
.Ltmp156:                               # EH_LABEL
	b	.LBB4_259
.LBB4_252:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit206.thread817
.Ltmp135:                               # EH_LABEL
.LBB4_253:                              # %.sink.split
	move	$fp, $a0
	b	.LBB4_261
...
.LBB4_266:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit250.thread
	...
	st.d	$zero, $sp, 32                  # 8-byte Folded Spill
	b	.LBB4_271
.LBB4_267:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit206.thread806
.Ltmp159:                               # EH_LABEL
