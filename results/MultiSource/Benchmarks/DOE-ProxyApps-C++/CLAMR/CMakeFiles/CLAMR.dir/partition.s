...
# %bb.9:
	move	$a2, $zero
.LBB4_10:                               # %vec.epilog.scalar.ph1139.preheader
	move	$a3, $a2
	.p2align	4, , 16
.LBB4_11:                               # %vec.epilog.scalar.ph1139
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a2, $a2, 2
	stx.w	$a3, $a1, $a2
	addi.w	$a3, $a3, 1
...
# %bb.74:
	move	$a4, $zero
.LBB4_75:                               # %scalar.ph1003.preheader
	addi.w	$a5, $a4, 1
	vldi	$vr4, -928
	.p2align	4, , 16
.LBB4_76:                               # %scalar.ph1003
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a4, $a4, 3
	fldx.d	$fa5, $a1, $a4
	fldx.d	$fa6, $a0, $a4
...
# %bb.104:
	move	$a1, $zero
.LBB4_105:                              # %vec.epilog.scalar.ph1047.preheader
	addi.w	$a2, $a1, 1
	.p2align	4, , 16
.LBB4_106:                              # %vec.epilog.scalar.ph1047
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a1, $a1, 2
	ldx.w	$a3, $s1, $a1
	stx.w	$a3, $a0, $a1
...
.LBB4_110:                              # %vector.scevcheck1122
	...
	move	$a2, $zero
	beq	$a4, $a5, .LBB4_10
# %bb.111:                              # %vector.scevcheck1122
	srli.d	$a3, $a3, 32
	bnez	$a3, .LBB4_10
# %bb.112:                              # %vector.main.loop.iter.check1128
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB4_243
# %bb.113:
	move	$a2, $zero
	b	.LBB4_247
.LBB4_114:                              # %vector.scevcheck982
	addi.d	$a5, $s7, -1
	...
	move	$a4, $zero
	beq	$a6, $a7, .LBB4_75
# %bb.115:                              # %vector.scevcheck982
	srli.d	$a5, $a5, 32
	bnez	$a5, .LBB4_75
# %bb.116:                              # %vector.memcheck983
	sub.d	$a4, $s4, $s3
	sub.d	$a5, $s3, $a0
	sub.d	$a6, $s3, $a1
	sub.d	$a7, $a2, $s3
	...
	move	$a4, $zero
	bnez	$a5, .LBB4_75
# %bb.117:                              # %vector.memcheck983
	sub.d	$a5, $s4, $a3
	ori	$a6, $zero, 32
	bltu	$a5, $a6, .LBB4_75
# %bb.118:                              # %vector.ph1005
...
# %bb.122:                              # %vector.scevcheck
	...
	move	$a4, $a2
	bnez	$a5, .LBB4_60
# %bb.123:                              # %vector.main.loop.iter.check856
	ori	$a2, $zero, 16
	bgeu	$s5, $a2, .LBB4_251
# %bb.124:
	move	$a2, $zero
	...
	move	$a4, $zero
	b	.LBB4_255
.LBB4_125:                              # %vector.scevcheck897
	bstrpick.d	$a3, $s1, 31, 0
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	move	$a2, $zero
	beq	$a3, $a4, .LBB4_64
# %bb.126:                              # %vector.scevcheck897
	srli.d	$a3, $s1, 32
	bnez	$a3, .LBB4_64
...
# %bb.147:                              # %_ZNSt6vectorIdSaIdEEC2EmRKS0_.exit
	...
	addi.w	$a1, $s0, 0
	blez	$a1, .LBB4_184
.LBB4_148:                              # %.lr.ph533.preheader
	bstrpick.d	$a1, $s0, 30, 0
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB4_153
# %bb.149:                              # %.lr.ph533.preheader
	sub.d	$a3, $a0, $s2
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB4_153
# %bb.150:                              # %vector.ph1066
...
.LBB4_151:                              # %vector.body1069
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_151
# %bb.152:                              # %middle.block1074
	beq	$a1, $a2, .LBB4_155
.LBB4_153:                              # %.lr.ph533.preheader1171
	alsl.d	$a3, $a2, $s2, 3
	alsl.d	$a4, $a2, $a0, 3
	sub.d	$a2, $a1, $a2
	.p2align	4, , 16
...
.LBB4_160:                              # %vector.body1084
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB4_160
# %bb.161:                              # %middle.block1089
	beq	$a1, $a3, .LBB4_164
.LBB4_162:                              # %scalar.ph1079.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_163:                              # %scalar.ph1079
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_169:                              # %vector.body1099
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB4_169
# %bb.170:                              # %middle.block1104
	beq	$a1, $a3, .LBB4_173
.LBB4_171:                              # %scalar.ph1094.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_172:                              # %scalar.ph1094
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_178:                              # %vector.body1114
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_178
# %bb.179:                              # %middle.block1119
	beq	$a1, $a4, .LBB4_182
.LBB4_180:                              # %scalar.ph1109.preheader
	alsl.d	$a1, $a4, $a3, 3
	alsl.d	$a3, $a4, $a0, 3
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
.LBB4_181:                              # %scalar.ph1109
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, 0
	fst.d	$fa0, $a3, 0
	addi.d	$a1, $a1, 8
...
# %bb.198:                              # %_ZNSt6vectorIdSaIdEEC2EmRKS0_.exit232
	...
	addi.w	$a1, $s4, 0
	blez	$a1, .LBB4_235
.LBB4_199:                              # %.lr.ph508.preheader
	bstrpick.d	$a1, $s4, 30, 0
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB4_204
# %bb.200:                              # %.lr.ph508.preheader
	sub.d	$a3, $a0, $s6
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB4_204
# %bb.201:                              # %vector.ph926
...
.LBB4_202:                              # %vector.body929
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_202
# %bb.203:                              # %middle.block934
	beq	$a1, $a2, .LBB4_206
.LBB4_204:                              # %.lr.ph508.preheader1174
	alsl.d	$a3, $a2, $s6, 3
	alsl.d	$a4, $a2, $a0, 3
	sub.d	$a2, $a1, $a2
	.p2align	4, , 16
...
.LBB4_211:                              # %vector.body944
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB4_211
# %bb.212:                              # %middle.block949
	beq	$a1, $a3, .LBB4_215
.LBB4_213:                              # %scalar.ph939.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_214:                              # %scalar.ph939
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_220:                              # %vector.body959
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB4_220
# %bb.221:                              # %middle.block964
	beq	$a1, $a3, .LBB4_224
.LBB4_222:                              # %scalar.ph954.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_223:                              # %scalar.ph954
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_229:                              # %vector.body974
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_229
# %bb.230:                              # %middle.block979
	beq	$a1, $a4, .LBB4_233
.LBB4_231:                              # %scalar.ph969.preheader
	alsl.d	$a1, $a4, $a3, 3
	alsl.d	$a3, $a4, $a0, 3
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
.LBB4_232:                              # %scalar.ph969
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, 0
	fst.d	$fa0, $a3, 0
	addi.d	$a1, $a1, 8
...
.LBB4_237:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit.sink.split
	...
	jirl	$ra, $ra, 0
	b	.LBB4_89
.LBB4_238:                              # %vector.scevcheck1027
	bstrpick.d	$a2, $s2, 31, 0
	addi.w	$a3, $zero, -1
	lu32i.d	$a3, 0
	move	$a1, $zero
	beq	$a2, $a3, .LBB4_105
# %bb.239:                              # %vector.scevcheck1027
	srli.d	$a2, $s2, 32
	bnez	$a2, .LBB4_105
# %bb.240:                              # %vector.scevcheck1027
	sub.d	$a2, $a0, $s1
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB4_105
# %bb.241:                              # %vector.main.loop.iter.check1035
	ori	$a1, $zero, 16
	bgeu	$s0, $a1, .LBB4_258
# %bb.242:
	move	$a1, $zero
	b	.LBB4_262
.LBB4_243:                              # %vector.ph1129
	andi	$a3, $a0, 12
...
.LBB4_244:                              # %vector.body1132
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_244
# %bb.245:                              # %middle.block1135
	beq	$a0, $a2, .LBB4_12
# %bb.246:                              # %vec.epilog.iter.check1140
	beqz	$a3, .LBB4_10
.LBB4_247:                              # %vec.epilog.ph1142
	move	$a4, $a2
	...
	alsl.d	$a4, $a4, $a1, 2
	.p2align	4, , 16
.LBB4_248:                              # %vec.epilog.vector.body1147
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB4_248
# %bb.249:                              # %vec.epilog.middle.block1152
	bne	$a0, $a2, .LBB4_10
	b	.LBB4_12
.LBB4_250:
	move	$a3, $a2
...
# %bb.253:                              # %middle.block869
	...
	beq	$s5, $a2, .LBB4_62
# %bb.254:                              # %vec.epilog.iter.check875
	beqz	$a5, .LBB4_60
.LBB4_255:                              # %vec.epilog.ph877
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB4_256:                              # %vec.epilog.vector.body884
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a5, 0
	vld	$vr3, $a4, 0
	vmax.w	$vr1, $vr2, $vr1
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_256
# %bb.257:                              # %vec.epilog.middle.block891
	vbsrl.v	$vr2, $vr1, 8
	vmax.w	$vr1, $vr2, $vr1
	vbsrl.v	$vr2, $vr1, 4
	vmax.w	$vr1, $vr2, $vr1
...
.LBB4_259:                              # %vector.body1039
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_259
# %bb.260:                              # %middle.block1044
	beq	$s0, $a1, .LBB4_107
# %bb.261:                              # %vec.epilog.iter.check1048
	beqz	$a2, .LBB4_105
.LBB4_262:                              # %vec.epilog.ph1050
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s1, 2
	.p2align	4, , 16
.LBB4_263:                              # %vec.epilog.vector.body1053
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB4_263
# %bb.264:                              # %vec.epilog.middle.block1057
	bne	$s0, $a1, .LBB4_105
	b	.LBB4_107
.LBB4_265:                              # %.invoke
.Ltmp131:                               # EH_LABEL
...
.Ltmp156:                               # EH_LABEL
	b	.LBB4_283
.LBB4_276:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit206.thread829
.Ltmp135:                               # EH_LABEL
.LBB4_277:                              # %.sink.split
	move	$fp, $a0
	b	.LBB4_285
...
.LBB4_290:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit250.thread
	...
	st.d	$zero, $sp, 40                  # 8-byte Folded Spill
	b	.LBB4_295
.LBB4_291:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit206.thread818
.Ltmp159:                               # EH_LABEL
	move	$s5, $fp
...
.LBB6_25:                               # %vec.epilog.ph209
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_26:                               # %vec.epilog.vector.body214
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	addi.d	$a5, $a5, 16
...
.LBB6_40:                               # %vec.epilog.ph175
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB6_41:                               # %vec.epilog.vector.body180
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	addi.d	$a4, $a4, 16
...
.LBB6_63:                               # %vec.epilog.ph141
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB6_64:                               # %vec.epilog.vector.body146
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	addi.d	$a4, $a4, 16
