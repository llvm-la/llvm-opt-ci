...
.LBB16_2:
	...
	ld.w	$a0, $sp, 836
	ld.w	$a1, $sp, 832
	fld.d	$ft15, $sp, 112                 # 8-byte Folded Reload
	bge	$a0, $a1, .LBB16_112
# %bb.3:                                # %.lr.ph
	move	$t4, $s6
	move	$t2, $s3
...
.LBB16_18:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$fa7, $fs7, $fa7
	fsub.d	$fs3, $ft10, $fa7
	fst.d	$ft12, $sp, 592                 # 8-byte Folded Spill
	fmul.d	$fa7, $ft12, $fa3
	fdiv.d	$ft12, $fa7, $fs4
...
# %bb.19:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$ft14, $sp, 744                 # 8-byte Folded Reload
	...
	fadd.d	$ft3, $fs3, $ft7
	fmul.d	$ft3, $ft3, $fs2
	fst.d	$ft3, $sp, 440                  # 8-byte Folded Spill
	fmul.d	$ft3, $ft7, $ft7
	fdiv.d	$ft3, $ft3, $ft12
	...
	fadd.d	$ft3, $fa3, $ft3
	fmul.d	$fa3, $ft3, $fs2
	fst.d	$ft7, $sp, 264                  # 8-byte Folded Spill
	fmul.d	$ft0, $ft0, $ft7
	fst.d	$ft12, $sp, 728                 # 8-byte Folded Spill
	fdiv.d	$ft0, $ft0, $ft12
	fadd.d	$ft0, $fa0, $ft0
	fmul.d	$fa0, $ft0, $fs2
...
.LBB16_20:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fld.d	$fs2, $sp, 688                  # 8-byte Folded Reload
	fst.d	$fs2, $sp, 728                  # 8-byte Folded Spill
...
.LBB16_21:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$ft8, $ft8, $ft0
	fmul.d	$ft11, $ft8, $ft3
	fld.d	$ft8, $sp, 712                  # 8-byte Folded Reload
	fmul.d	$ft8, $ft8, $ft10
	...
	fmul.d	$ft9, $fs6, $ft9
	fst.d	$ft13, $sp, 528                 # 8-byte Folded Spill
...
# %bb.22:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$fs1, $sp, 752                  # 8-byte Folded Reload
	fmul.d	$ft9, $fs0, $fs1
	fadd.d	$ft4, $ft4, $ft9
	fdiv.d	$ft4, $ft4, $fs5
	...
	fst.d	$ft4, $sp, 272                  # 8-byte Folded Spill
	fmul.d	$fa5, $ft4, $fa5
	fst.d	$fa4, $sp, 720                  # 8-byte Folded Spill
	fdiv.d	$fa5, $fa5, $fa4
	fadd.d	$fa5, $ft10, $fa5
	fmul.d	$fa5, $fa5, $ft14
	fst.d	$fa5, $sp, 432                  # 8-byte Folded Spill
	b	.LBB16_24
	.p2align	4, , 16
.LBB16_23:                              #   in Loop: Header=BB16_6 Depth=1
	fst.d	$ft11, $sp, 424                 # 8-byte Folded Spill
...
.LBB16_24:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$ft8, $fs1, $fs1
	fdiv.d	$ft8, $ft8, $fs6
	fst.d	$fs6, $sp, 600                  # 8-byte Folded Spill
	fmul.d	$ft12, $fs6, $fs6
	...
	fst.d	$fa7, $sp, 616                  # 8-byte Folded Spill
	fst.d	$ft11, $sp, 576                 # 8-byte Folded Spill
	bge	$s0, $a6, .LBB16_26
# %bb.25:                               #   in Loop: Header=BB16_6 Depth=1
	fst.d	$fs1, $sp, 784                  # 8-byte Folded Spill
	...
	fld.d	$fa4, $sp, 648                  # 8-byte Folded Reload
	fmul.d	$ft7, $fa4, $ft15
	fdiv.d	$ft7, $ft7, $fs1
	fmul.d	$fa4, $fs0, $fa4
	fadd.d	$fa4, $ft6, $fa4
...
# %bb.28:                               #   in Loop: Header=BB16_6 Depth=1
	...
	fadd.d	$ft1, $ft5, $ft1
	fdiv.d	$ft1, $ft1, $fs6
	fld.d	$ft8, $sp, 672                  # 8-byte Folded Reload
	fmul.d	$ft2, $fa4, $ft8
	fdiv.d	$ft3, $fs0, $fa4
	...
	fld.d	$fa0, $sp, 576                  # 8-byte Folded Reload
	fmul.d	$fa7, $fa0, $ft5
	fsub.d	$fa7, $ft2, $fa7
	vori.b	$vr10, $vr12, 0
...
.LBB16_48:                              #   in Loop: Header=BB16_6 Depth=1
	fst.d	$ft0, $sp, 744                  # 8-byte Folded Spill
	fsqrt.d	$fa0, $ft5
	fcmp.cor.d	$fcc0, $fa0, $fa0
...
.LBB16_66:                              # %.split1385
	...
	fmul.d	$fa0, $fa0, $ft14
	fmul.d	$fa0, $ft15, $fa0
	fst.d	$fs2, $sp, 776                  # 8-byte Folded Spill
	fdiv.d	$fa0, $fa0, $fs2
	fsub.d	$fa1, $ft6, $fa0
	fmul.d	$fa0, $fa0, $fa1
	fmul.d	$fa1, $fa2, $fa2
...
.LBB16_72:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fld.d	$fa4, $sp, 560                  # 8-byte Folded Reload
	ld.w	$a1, $fp, 0
	slli.d	$a0, $a5, 2
	ldx.w	$a2, $s4, $a0
...
.LBB16_96:                              # %call.sqrt
	...
	fmov.d	$fs1, $ft10
	fst.d	$ft11, $sp, 40                  # 8-byte Folded Spill
	fmov.d	$fs6, $ft12
	fst.d	$ft1, $sp, 88                   # 8-byte Folded Spill
	fst.d	$ft2, $sp, 80                   # 8-byte Folded Spill
	fst.d	$ft4, $sp, 72                   # 8-byte Folded Spill
	...
	fld.d	$ft4, $sp, 72                   # 8-byte Folded Reload
	fld.d	$ft2, $sp, 80                   # 8-byte Folded Reload
	fld.d	$ft1, $sp, 88                   # 8-byte Folded Reload
	fld.d	$fa6, $sp, 232                  # 8-byte Folded Reload
	fmov.d	$ft12, $fs6
...
.LBB16_97:                              # %call.sqrt1374
	...
	fmov.d	$fs1, $ft10
	fmov.d	$fs7, $ft11
	fst.d	$ft12, $sp, 280                 # 8-byte Folded Spill
	fst.d	$ft1, $sp, 88                   # 8-byte Folded Spill
	fst.d	$ft2, $sp, 80                   # 8-byte Folded Spill
	fst.d	$ft3, $sp, 296                  # 8-byte Folded Spill
	fst.d	$ft4, $sp, 72                   # 8-byte Folded Spill
	st.d	$a5, $sp, 48                    # 8-byte Folded Spill
	fst.d	$ft5, $sp, 24                   # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrt)
	...
	ld.d	$a5, $sp, 48                    # 8-byte Folded Reload
	fld.d	$ft4, $sp, 72                   # 8-byte Folded Reload
	fld.d	$ft3, $sp, 296                  # 8-byte Folded Reload
	fld.d	$ft2, $sp, 80                   # 8-byte Folded Reload
	fld.d	$ft1, $sp, 88                   # 8-byte Folded Reload
	fld.d	$fa6, $sp, 232                  # 8-byte Folded Reload
...
.LBB16_100:                             # %call.sqrt1386
	...
	fmov.d	$fs2, $ft11
	fmov.d	$fs3, $ft12
	fst.d	$fa7, $sp, 664                  # 8-byte Folded Spill
	fst.d	$ft1, $sp, 88                   # 8-byte Folded Spill
	fst.d	$ft2, $sp, 80                   # 8-byte Folded Spill
	fmov.d	$fs4, $ft3
	fst.d	$ft4, $sp, 72                   # 8-byte Folded Spill
...
.LBB16_102:                             # %call.sqrt1394
	...
	fst.d	$ft3, $sp, 296                  # 8-byte Folded Spill
	fst.d	$ft4, $sp, 72                   # 8-byte Folded Spill
	fst.d	$ft0, $sp, 792                  # 8-byte Folded Spill
	fst.d	$ft5, $sp, 720                  # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fld.d	$ft5, $sp, 720                  # 8-byte Folded Reload
	fld.d	$ft0, $sp, 792                  # 8-byte Folded Reload
	fld.d	$ft4, $sp, 72                   # 8-byte Folded Reload
	fld.d	$ft3, $sp, 296                  # 8-byte Folded Reload
	fld.d	$ft2, $sp, 80                   # 8-byte Folded Reload
	fld.d	$ft1, $sp, 88                   # 8-byte Folded Reload
...
.LBB16_105:                             # %call.sqrt1376
	...
	fld.d	$ft11, $sp, 40                  # 8-byte Folded Reload
	fmov.d	$ft10, $fs2
	fld.d	$ft0, $sp, 744                  # 8-byte Folded Reload
	ld.d	$a3, $sp, 640                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 32                    # 8-byte Folded Reload
	ld.d	$t3, $sp, 264                   # 8-byte Folded Reload
	fld.d	$ft9, $sp, 656                  # 8-byte Folded Reload
...
.LBB17_64:                              #   in Loop: Header=BB17_55 Depth=1
	...
	ldx.w	$t0, $s3, $t1
	ldx.w	$t8, $s7, $t1
	st.d	$t2, $sp, 616                   # 8-byte Folded Spill
	bge	$s5, $t0, .LBB17_66
...
.LBB17_114:                             #   in Loop: Header=BB17_55 Depth=1
	...
	fmov.d	$fa4, $fs4
	fmov.d	$fa0, $fs6
	fst.d	$fs6, $sp, 792                  # 8-byte Folded Spill
	bltz	$a4, .LBB17_116
...
# %bb.161:                              #   in Loop: Header=BB17_55 Depth=1
	fld.d	$ft15, $sp, 624                 # 8-byte Folded Reload
...
.LBB17_162:                             # %call.sqrt
	...
	fst.d	$ft8, $sp, 32                   # 8-byte Folded Spill
	...
	fld.d	$ft8, $sp, 32                   # 8-byte Folded Reload
...
.LBB17_170:                             # %call.sqrt1339
	...
	fmov.d	$fa0, $fa1
	st.d	$a1, $sp, 520                   # 8-byte Folded Spill
	fst.d	$ft4, $sp, 16                   # 8-byte Folded Spill
	fst.d	$ft7, $sp, 88                   # 8-byte Folded Spill
	fst.d	$ft8, $sp, 32                   # 8-byte Folded Spill
	fst.d	$ft9, $sp, 80                   # 8-byte Folded Spill
	fst.d	$ft10, $sp, 40                  # 8-byte Folded Spill
	...
	vldi	$vr14, -912
	vldi	$vr13, -928
	fld.d	$ft4, $sp, 16                   # 8-byte Folded Reload
	ld.d	$t2, $sp, 616                   # 8-byte Folded Reload
	ld.d	$t1, $sp, 600                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 608                   # 8-byte Folded Reload
	ld.d	$a7, $sp, 280                   # 8-byte Folded Reload
