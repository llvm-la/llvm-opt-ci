...
.LBB16_18:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$ft1, $ft13, $fs0
	fdiv.d	$fa7, $ft3, $fs0
	fcmp.clt.d	$fcc0, $fa7, $ft8
	fsel	$ft11, $ft8, $fa7, $fcc0
	fmul.d	$ft7, $ft1, $ft11
	fmul.d	$fa7, $ft12, $ft3
	fdiv.d	$ft2, $fs0, $ft3
	fcmp.clt.d	$fcc0, $ft2, $ft8
	fsel	$ft4, $ft8, $ft2, $fcc0
	fmul.d	$fa7, $fa7, $ft4
	fsub.d	$fa7, $ft7, $fa7
	fdiv.d	$ft2, $fa1, $fa2
	fcmp.clt.d	$fcc0, $ft2, $ft14
	fsel	$ft2, $ft14, $ft2, $fcc0
	fmul.d	$ft2, $fa2, $ft2
	fdiv.d	$ft5, $fa2, $fa1
	fcmp.clt.d	$fcc0, $ft5, $ft14
	fsel	$ft5, $ft14, $ft5, $fcc0
	fmul.d	$fa1, $fa1, $ft5
	fadd.d	$ft5, $ft2, $fa1
	fdiv.d	$fa1, $fa7, $ft5
	fmul.d	$fa1, $fs2, $fa1
	...
	fst.d	$fs6, $sp, 280                  # 8-byte Folded Spill
	bge	$s0, $a0, .LBB16_20
# %bb.19:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$ft14, $sp, 752                 # 8-byte Folded Reload
	...
	fmul.d	$ft0, $ft0, $ft7
	fst.d	$ft12, $sp, 736                 # 8-byte Folded Spill
	fdiv.d	$ft0, $ft0, $ft12
	fadd.d	$ft0, $fa0, $ft0
	fmul.d	$fa0, $ft0, $fs1
...
.LBB16_21:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$ft8, $ft8, $ft0
	fmul.d	$ft11, $ft8, $ft3
	fld.d	$ft8, $sp, 720                  # 8-byte Folded Reload
	fmul.d	$ft8, $ft8, $ft10
...
# %bb.22:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$fs5, $sp, 760                  # 8-byte Folded Reload
	fmul.d	$ft9, $fs0, $fs5
	fadd.d	$ft4, $ft4, $ft9
	fdiv.d	$ft4, $ft4, $fs1
	...
	fmul.d	$fa5, $ft4, $fa5
	fst.d	$ft9, $sp, 728                  # 8-byte Folded Spill
	fdiv.d	$fa5, $fa5, $ft9
	fadd.d	$fa5, $ft10, $fa5
	fmul.d	$fa5, $fa5, $ft14
...
.LBB16_23:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fst.d	$fa5, $sp, 728                  # 8-byte Folded Spill
	fst.d	$fa5, $sp, 288                  # 8-byte Folded Spill
.LBB16_24:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fdiv.d	$ft8, $ft8, $fs5
	fst.d	$fs5, $sp, 592                  # 8-byte Folded Spill
	fmul.d	$ft12, $fs5, $fs5
	...
	fmul.d	$ft8, $fa0, $ft4
	vldi	$vr0, -912
	fst.d	$ft13, $sp, 600                 # 8-byte Folded Spill
	...
	fdiv.d	$fa7, $fa7, $fs6
	fst.d	$fs6, $sp, 552                  # 8-byte Folded Spill
	fmul.d	$ft9, $fs6, $fs6
	fmul.d	$ft9, $ft9, $fa1
	fadd.d	$fs6, $fa7, $ft9
	fadd.d	$fa7, $fs0, $ft4
	...
	fst.d	$fa7, $sp, 344                  # 8-byte Folded Spill
...
# %bb.25:                               #   in Loop: Header=BB16_6 Depth=1
	...
	fdiv.d	$ft11, $ft5, $fa2
	fcmp.clt.d	$fcc0, $ft11, $ft14
	fsel	$ft11, $ft14, $ft11, $fcc0
	fmul.d	$ft11, $fa2, $ft11
	fdiv.d	$ft13, $fa2, $ft5
	fcmp.clt.d	$fcc0, $ft13, $ft14
	fsel	$ft13, $ft14, $ft13, $fcc0
	fmul.d	$ft5, $ft5, $ft13
	...
	fadd.d	$fa4, $ft7, $fa4
	fdiv.d	$fa4, $fa4, $fa7
	fld.d	$ft7, $sp, 720                  # 8-byte Folded Reload
	fmul.d	$ft7, $ft7, $ft9
	fmul.d	$ft6, $ft4, $ft6
	fmul.d	$ft6, $ft12, $ft6
	fsub.d	$ft6, $ft7, $ft6
...
.LBB16_27:                              #   in Loop: Header=BB16_6 Depth=1
	slli.d	$a6, $a5, 3
	ld.d	$a7, $sp, 704                   # 8-byte Folded Reload
	fldx.d	$fa4, $a7, $a6
	slli.d	$a6, $t8, 3
	fldx.d	$fs5, $s8, $a6
	fldx.d	$ft6, $t6, $a6
...
# %bb.28:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$ft9, $sp, 672                  # 8-byte Folded Reload
	fmul.d	$ft1, $fs0, $ft9
	fadd.d	$ft1, $ft5, $ft1
	fdiv.d	$ft1, $ft1, $fs6
	...
	fmul.d	$ft2, $fa4, $ft6
	fdiv.d	$ft3, $fs0, $fa4
	fcmp.clt.d	$fcc0, $ft3, $ft8
	fsel	$ft3, $ft8, $ft3, $fcc0
	fmul.d	$ft2, $ft3, $ft2
	fdiv.d	$ft5, $fa4, $fs0
	fcmp.clt.d	$fcc0, $ft5, $ft8
	fsel	$ft5, $ft8, $ft5, $fcc0
	...
	fmul.d	$ft2, $ft4, $ft2
	fdiv.d	$ft4, $ft4, $fa2
	fcmp.clt.d	$fcc0, $ft4, $ft14
	fsel	$ft4, $ft14, $ft4, $fcc0
	fmul.d	$fa2, $fa2, $ft4
	fadd.d	$fa2, $ft2, $fa2
	fdiv.d	$fa7, $fa7, $fa2
	fmul.d	$fa7, $fs2, $fa7
...
.LBB16_32:                              #   in Loop: Header=BB16_6 Depth=1
	...
	st.d	$s1, $sp, 584                   # 8-byte Folded Spill
	ldx.w	$s5, $t2, $a2
	ldx.w	$a5, $t4, $a4
...
.LBB16_33:                              # %.split
	...
	fmul.d	$fa1, $fa1, $fa3
	fmul.d	$fa0, $fa0, $ft14
	fcmp.clt.d	$fcc0, $fa4, $ft8
	fsel	$fa3, $ft8, $fa4, $fcc0
...
.LBB16_41:                              #   in Loop: Header=BB16_6 Depth=1
	fst.d	$fa5, $sp, 608                  # 8-byte Folded Spill
	ld.w	$s5, $s7, 0
	fmul.d	$fa0, $fa3, $ft2
...
.LBB16_42:                              # %.split1373
	...
	fmul.d	$fa3, $fa3, $fa4
	fmul.d	$fa0, $fa0, $ft14
	fcmp.clt.d	$fcc0, $fa1, $ft8
	fsel	$fa1, $ft8, $fa1, $fcc0
...
# %bb.43:                               #   in Loop: Header=BB16_6 Depth=1
	...
	fld.d	$ft5, $sp, 648                  # 8-byte Folded Reload
	fld.d	$fs2, $sp, 616                  # 8-byte Folded Reload
	bge	$a0, $a1, .LBB16_46
...
# %bb.58:                               #   in Loop: Header=BB16_6 Depth=1
	...
	fld.d	$fs2, $sp, 664                  # 8-byte Folded Reload
	bge	$a0, $a1, .LBB16_61
...
.LBB16_64:                              #   in Loop: Header=BB16_6 Depth=1
	...
	slli.d	$a0, $s3, 2
	ldx.w	$a2, $s4, $a0
	fld.d	$fa5, $sp, 592                  # 8-byte Folded Reload
	bge	$a1, $a2, .LBB16_66
...
.LBB16_73:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fld.d	$fa4, $sp, 568                  # 8-byte Folded Reload
	ld.w	$a1, $fp, 0
	slli.d	$a0, $a5, 2
	ldx.w	$a2, $s4, $a0
	bge	$a1, $a2, .LBB16_75
...
.LBB16_97:                              # %call.sqrt
	...
	fmov.d	$fs5, $ft10
	fst.d	$ft11, $sp, 56                  # 8-byte Folded Spill
	fst.d	$ft12, $sp, 40                  # 8-byte Folded Spill
	...
	fld.d	$fa7, $sp, 680                  # 8-byte Folded Reload
	fld.d	$ft12, $sp, 40                  # 8-byte Folded Reload
	fld.d	$ft11, $sp, 56                  # 8-byte Folded Reload
	fmov.d	$ft10, $fs5
...
.LBB16_98:                              # %call.sqrt1374
	...
	fmov.d	$fs1, $fa6
	st.d	$t8, $sp, 24                    # 8-byte Folded Spill
	fst.d	$ft10, $sp, 280                 # 8-byte Folded Spill
	fst.d	$ft11, $sp, 56                  # 8-byte Folded Spill
	fst.d	$ft12, $sp, 40                  # 8-byte Folded Spill
	fst.d	$ft0, $sp, 104                  # 8-byte Folded Spill
	fst.d	$ft1, $sp, 88                   # 8-byte Folded Spill
	...
	fld.d	$ft12, $sp, 40                  # 8-byte Folded Reload
	fld.d	$ft11, $sp, 56                  # 8-byte Folded Reload
	fld.d	$ft10, $sp, 280                 # 8-byte Folded Reload
	ld.d	$a3, $sp, 640                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 24                    # 8-byte Folded Reload
	fmov.d	$fa6, $fs1
...
.LBB16_101:                             # %call.sqrt1386
	...
	move	$s6, $t3
	fmov.d	$fs1, $fa6
	fst.d	$fs2, $sp, 664                  # 8-byte Folded Spill
	fmov.d	$fs2, $ft10
	fmov.d	$fs3, $ft11
	fmov.d	$fs4, $ft12
	fst.d	$ft0, $sp, 104                  # 8-byte Folded Spill
...
.LBB16_103:                             # %call.sqrt1394
	...
	fst.d	$ft3, $sp, 312                  # 8-byte Folded Spill
	fst.d	$ft4, $sp, 72                   # 8-byte Folded Spill
	fst.d	$ft5, $sp, 648                  # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fld.d	$ft5, $sp, 648                  # 8-byte Folded Reload
	fld.d	$ft4, $sp, 72                   # 8-byte Folded Reload
...
.LBB17_117:                             #   in Loop: Header=BB17_55 Depth=1
	...
	ldx.w	$a4, $t1, $s1
	bltz	$a4, .LBB17_119
# %bb.118:                              #   in Loop: Header=BB17_55 Depth=1
	slli.d	$a3, $a4, 3
	fldx.d	$fa0, $a7, $a3
	fldx.d	$fa2, $t0, $a3
	fldx.d	$fa1, $a6, $a3
...
.LBB17_122:                             #   in Loop: Header=BB17_55 Depth=1
	...
	slt	$s2, $s5, $a0
	bltz	$a3, .LBB17_124
# %bb.123:                              #   in Loop: Header=BB17_55 Depth=1
	slli.d	$a0, $a3, 3
	fldx.d	$fa0, $a7, $a0
	fldx.d	$fs0, $t0, $a0
	fldx.d	$fa1, $a6, $a0
...
.LBB17_124:                             #   in Loop: Header=BB17_55 Depth=1
	...
	fst.d	$fa0, $sp, 656                  # 8-byte Folded Spill
	fst.d	$fs0, $sp, 616                  # 8-byte Folded Spill
.LBB17_125:                             #   in Loop: Header=BB17_55 Depth=1
	fst.d	$fa2, $sp, 728                  # 8-byte Folded Spill
...
# %bb.127:                              #   in Loop: Header=BB17_55 Depth=1
	...
	ldx.w	$a4, $s3, $a0
	bge	$a3, $a4, .LBB17_129
# %bb.128:                              #   in Loop: Header=BB17_55 Depth=1
	ldx.w	$a0, $t5, $a0
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $a1, $a0
...
.LBB17_132:                             #   in Loop: Header=BB17_55 Depth=1
	...
	bge	$a3, $a4, .LBB17_134
# %bb.133:                              #   in Loop: Header=BB17_55 Depth=1
	ldx.w	$a0, $t5, $a0
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $a1, $a0
	fldx.d	$fa1, $t3, $a0
	...
	fmul.d	$fa0, $fa0, $ft5
	fst.d	$fa0, $sp, 704                  # 8-byte Folded Spill
.LBB17_134:                             #   in Loop: Header=BB17_55 Depth=1
	ld.w	$s0, $s7, 0
	fld.d	$fa0, $sp, 792                  # 8-byte Folded Reload
	fmul.d	$fs2, $fa3, $fa0
	fsqrt.d	$fa0, $fs2
...
# %bb.136:                              #   in Loop: Header=BB17_55 Depth=1
	...
	ldx.w	$a4, $s3, $a0
	bge	$a3, $a4, .LBB17_138
# %bb.137:                              #   in Loop: Header=BB17_55 Depth=1
	ldx.w	$a0, $t5, $a0
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $a1, $a0
...
.LBB17_140:                             # %.split1358
	...
	fmul.d	$fa0, $fa0, $ft5
	fst.d	$fa0, $sp, 688                  # 8-byte Folded Spill
.LBB17_141:                             #   in Loop: Header=BB17_55 Depth=1
...
# %bb.143:                              #   in Loop: Header=BB17_55 Depth=1
	...
	ldx.w	$a4, $s3, $a0
	bge	$a3, $a4, .LBB17_146
# %bb.144:                              #   in Loop: Header=BB17_55 Depth=1
	ldx.w	$a0, $t5, $a0
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $t3, $a0
...
.LBB17_148:                             # %.split1362
	...
	fmul.d	$fa0, $fa0, $ft5
	fst.d	$fa0, $sp, 696                  # 8-byte Folded Spill
.LBB17_149:                             #   in Loop: Header=BB17_55 Depth=1
	fsqrt.d	$fa0, $fs1
	fcmp.cor.d	$fcc0, $fa0, $fa0
...
.LBB17_150:                             # %.split1364
	...
	fmul.d	$fs2, $fa2, $fa0
	bge	$s5, $a0, .LBB17_156
# %bb.151:                              #   in Loop: Header=BB17_55 Depth=1
	ld.d	$a0, $sp, 448                   # 8-byte Folded Reload
	slli.d	$a0, $a0, 2
	ldx.w	$a3, $s3, $a0
	ld.d	$a0, $sp, 440                   # 8-byte Folded Reload
	...
	ldx.w	$a4, $s3, $a0
	bge	$a3, $a4, .LBB17_153
# %bb.152:                              #   in Loop: Header=BB17_55 Depth=1
	ldx.w	$a0, $t5, $a0
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $t3, $a0
...
# %bb.161:                              #   in Loop: Header=BB17_55 Depth=1
	...
	fadd.d	$fa6, $fa6, $fa7
	fmul.d	$fa6, $fa6, $ft5
.LBB17_162:                             #   in Loop: Header=BB17_55 Depth=1
	...
	fadd.d	$ft0, $ft1, $ft0
	bge	$s5, $a0, .LBB17_54
# %bb.163:                              #   in Loop: Header=BB17_55 Depth=1
...
.LBB17_179:                             # %call.sqrt1367
	...
	move	$a1, $s0
	b	.LBB17_155
.LBB17_180:                             # %._crit_edge1186.._crit_edge1190_crit_edge
