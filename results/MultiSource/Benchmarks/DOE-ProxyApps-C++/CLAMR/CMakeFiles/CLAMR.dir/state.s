...
# %bb.2:
	move	$a5, $zero
	move	$a6, $zero
.LBB6_3:                                # %vec.epilog.scalar.ph.preheader
	addi.w	$a7, $a5, 1
	.p2align	4, , 16
.LBB6_4:                                # %vec.epilog.scalar.ph
...
# %bb.81:                               # %vector.scevcheck
	...
	move	$a6, $a5
	bnez	$a7, .LBB6_3
# %bb.82:                               # %vector.main.loop.iter.check
	ori	$a5, $zero, 16
	bgeu	$s3, $a5, .LBB6_93
# %bb.83:
	move	$a5, $zero
...
# %bb.89:                               # %vector.memcheck
	...
	move	$a2, $t1
	bltu	$a3, $a0, .LBB6_33
# %bb.90:                               # %vector.main.loop.iter.check571
	ori	$a0, $zero, 16
	bgeu	$a1, $a0, .LBB6_97
# %bb.91:
	move	$a0, $zero
...
.LBB6_94:                               # %vector.body
	...
	ldx.w	$s2, $a3, $a6
	vinsgr2vr.w	$vr10, $s7, 2
	ldx.w	$s7, $a3, $t3
	vinsgr2vr.w	$vr10, $s8, 3
	ldx.w	$s8, $a3, $t4
	vinsgr2vr.w	$vr11, $s1, 0
	vinsgr2vr.w	$vr11, $s2, 1
	vinsgr2vr.w	$vr11, $s7, 2
	vinsgr2vr.w	$vr11, $s8, 3
	ldx.w	$s1, $a3, $t7
	ldx.w	$s2, $a3, $t8
	ldx.w	$s7, $a3, $fp
	ldx.w	$s8, $a3, $s0
	...
	ldx.w	$s8, $a3, $t6
	vinsgr2vr.w	$vr13, $s1, 0
	vinsgr2vr.w	$vr13, $s2, 1
	vinsgr2vr.w	$vr13, $s7, 2
	vinsgr2vr.w	$vr13, $s8, 3
	ldx.w	$s1, $a4, $s3
	ldx.w	$s2, $a4, $s4
	ldx.w	$s3, $a4, $s5
	ldx.w	$s4, $a4, $s6
	vinsgr2vr.w	$vr14, $s1, 0
	vinsgr2vr.w	$vr14, $s2, 1
	vinsgr2vr.w	$vr14, $s3, 2
	vinsgr2vr.w	$vr14, $s4, 3
	ldx.w	$t5, $a4, $t5
	ldx.w	$a6, $a4, $a6
	ldx.w	$t3, $a4, $t3
	ldx.w	$t4, $a4, $t4
	...
	xvld	$xr3, $t1, 0
	xvpermi.q	$xr4, $xr5, 2
	xvseq.w	$xr2, $xr18, $xr2
	xvsub.w	$xr0, $xr0, $xr2
	xvseq.w	$xr2, $xr3, $xr4
	xvsub.w	$xr1, $xr1, $xr2
	xvpermi.q	$xr6, $xr7, 2
	xvpermi.q	$xr8, $xr9, 2
	xvseq.w	$xr2, $xr18, $xr6
	xvseq.w	$xr3, $xr3, $xr8
	xvsub.w	$xr0, $xr0, $xr2
	xvsub.w	$xr1, $xr1, $xr3
	xvld	$xr2, $ra, -32
	...
	xvseq.w	$xr4, $xr2, $xr10
	xvsub.w	$xr0, $xr0, $xr4
	xvseq.w	$xr4, $xr3, $xr12
	xvsub.w	$xr1, $xr1, $xr4
	xvpermi.q	$xr14, $xr15, 2
	xvpermi.q	$xr16, $xr17, 2
	xvseq.w	$xr2, $xr2, $xr14
	xvseq.w	$xr3, $xr3, $xr16
	xvsub.w	$xr0, $xr0, $xr2
	xvsub.w	$xr1, $xr1, $xr3
	addi.d	$a0, $a0, -16
	addi.d	$ra, $ra, 64
...
.LBB6_98:                               # %vector.body576
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_98
# %bb.99:                               # %middle.block579
	beq	$a1, $a0, .LBB6_35
# %bb.100:                              # %vec.epilog.iter.check584
	beqz	$a3, .LBB6_33
.LBB6_101:                              # %vec.epilog.ph586
	move	$a3, $a1
	...
	vrepli.b	$vr0, -1
	.p2align	4, , 16
.LBB6_102:                              # %vec.epilog.vector.body589
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB6_102
# %bb.103:                              # %vec.epilog.middle.block592
	bne	$a1, $a3, .LBB6_33
	b	.LBB6_35
.LBB6_104:                              # %vec.epilog.iter.check
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s1, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
...
# %bb.105:
	...
	ld.d	$s7, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s8, $sp, 40                    # 8-byte Folded Reload
.LBB6_106:                              # %vec.epilog.ph
	move	$a0, $a5
	bstrpick.d	$a5, $s3, 32, 2
	slli.d	$a5, $a5, 2
	vrepli.b	$vr0, 0
	...
	alsl.d	$t1, $a0, $s8, 2
	.p2align	4, , 16
.LBB6_107:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $t1, 0
	vext2xv.d.w	$xr1, $xr1
	...
	addi.d	$t1, $t1, 16
	bnez	$a6, .LBB6_107
# %bb.108:                              # %vec.epilog.middle.block
...
# %bb.24:                               # %middle.block
	bne	$a0, $a4, .LBB12_3
	b	.LBB12_5
.LBB12_25:                              # %vector.ph107
	bstrpick.d	$a2, $a1, 30, 3
	slli.d	$a2, $a2, 3
	addi.d	$a3, $s1, 16
	move	$a4, $a2
	.p2align	4, , 16
.LBB12_26:                              # %vector.body110
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, -16
	vld	$vr1, $a3, 0
	vext2xv.d.w	$xr0, $xr0
...
# %bb.27:                               # %middle.block114
	beq	$a2, $a1, .LBB12_30
.LBB12_28:                              # %scalar.ph105.preheader
	alsl.d	$a3, $a2, $s1, 2
	sub.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB12_29:                              # %scalar.ph105
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a3, 0
	slli.d	$a2, $a2, 3
	fstx.d	$fs0, $a0, $a2
...
# %bb.3:                                # %.lr.ph
	...
	vldi	$vr22, -928
	fmul.d	$fs7, $ft15, $ft14
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a3, $a2, %pc_lo12(_ZZN5State22calc_finite_differenceEdE5H_new)
	ld.d	$a2, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a4, $a2, %pc_lo12(_ZZN5State22calc_finite_differenceEdE5U_new)
...
.LBB16_11:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fst.d	$fa1, $sp, 760                  # 8-byte Folded Spill
	fmov.d	$fa5, $fa1
...
.LBB16_18:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fsel	$ft11, $ft6, $fa7, $fcc0
	fmul.d	$ft7, $ft1, $ft11
	fmul.d	$fa7, $ft12, $ft3
	fdiv.d	$ft2, $fs0, $ft3
	fcmp.clt.d	$fcc0, $ft2, $ft6
	fsel	$ft4, $ft6, $ft2, $fcc0
	fmul.d	$fa7, $fa7, $ft4
	fsub.d	$fa7, $ft7, $fa7
	vori.b	$vr10, $vr2, 0
	vextrins.d	$vr10, $vr1, 16
	vextrins.d	$vr1, $vr2, 16
	vfdiv.d	$vr10, $vr10, $vr1
	vfcmp.clt.d	$vr14, $vr10, $vr22
	vbitsel.v	$vr10, $vr22, $vr10, $vr14
	...
	fmul.d	$fa7, $fs7, $fa7
	fsub.d	$fs3, $ft10, $fa7
	fst.d	$ft12, $sp, 584                 # 8-byte Folded Spill
	fmul.d	$fa7, $ft12, $fa3
	fdiv.d	$ft12, $fa7, $fs4
	...
	fdiv.d	$ft12, $ft12, $ft6
	fmul.d	$ft12, $fs7, $ft12
...
# %bb.19:                               #   in Loop: Header=BB16_6 Depth=1
	...
	fadd.d	$ft3, $fs3, $ft7
	fmul.d	$ft3, $ft3, $fs2
	fst.d	$ft3, $sp, 432                  # 8-byte Folded Spill
	fmul.d	$ft3, $ft7, $ft7
	fdiv.d	$ft3, $ft3, $ft12
	...
	fadd.d	$ft3, $fa3, $ft3
	fmul.d	$fa3, $ft3, $fs2
	fst.d	$ft7, $sp, 272                  # 8-byte Folded Spill
	fmul.d	$ft0, $ft0, $ft7
	fst.d	$ft12, $sp, 720                 # 8-byte Folded Spill
	fdiv.d	$ft0, $ft0, $ft12
	fadd.d	$ft0, $fa0, $ft0
	fmul.d	$fa0, $ft0, $fs2
...
.LBB16_21:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fdiv.d	$ft3, $fs0, $ft0
	vldi	$vr20, -912
	fcmp.clt.d	$fcc0, $ft3, $ft12
	fsel	$ft3, $ft12, $ft3, $fcc0
	fmul.d	$ft9, $ft5, $ft3
	fdiv.d	$ft5, $ft0, $fs0
	fcmp.clt.d	$fcc0, $ft5, $ft12
	fsel	$ft10, $ft12, $ft5, $fcc0
	fmul.d	$ft5, $ft1, $ft10
	fsub.d	$ft9, $ft9, $ft5
	fdiv.d	$ft1, $fa2, $ft6
	fcmp.clt.d	$fcc0, $ft1, $ft14
	fsel	$ft1, $ft14, $ft1, $fcc0
	fmul.d	$ft1, $ft6, $ft1
	fdiv.d	$ft6, $ft6, $fa2
	fcmp.clt.d	$fcc0, $ft6, $ft14
	fsel	$ft6, $ft14, $ft6, $fcc0
	fmul.d	$ft6, $fa2, $ft6
	fadd.d	$ft1, $ft1, $ft6
	fdiv.d	$ft6, $ft9, $ft1
	fmul.d	$ft6, $fs7, $ft6
	...
	fmul.d	$ft8, $fs7, $ft8
	fsub.d	$fs6, $ft9, $ft8
	fst.d	$ft11, $sp, 576                 # 8-byte Folded Spill
	fmul.d	$ft8, $ft11, $ft7
	fdiv.d	$ft8, $ft8, $fs3
	fmul.d	$ft9, $ft7, $fs0
	...
	fmul.d	$ft8, $ft8, $ft0
	fmul.d	$ft11, $ft8, $ft3
	fld.d	$ft8, $sp, 800                  # 8-byte Folded Reload
	fmul.d	$ft8, $ft8, $ft10
	fsub.d	$ft10, $ft11, $ft8
	fdiv.d	$ft10, $ft10, $ft1
	fmul.d	$ft10, $fs7, $ft10
	fsub.d	$ft9, $ft9, $ft10
	fmul.d	$ft10, $fs6, $fs6
	...
	fmul.d	$ft9, $fs6, $ft9
	fst.d	$ft13, $sp, 520                 # 8-byte Folded Spill
...
# %bb.22:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$fs1, $sp, 744                  # 8-byte Folded Reload
	fmul.d	$ft9, $fs0, $fs1
	fadd.d	$ft4, $ft4, $ft9
	fdiv.d	$ft4, $ft4, $fs5
	...
	fst.d	$ft4, $sp, 280                  # 8-byte Folded Spill
	fmul.d	$fa5, $ft4, $fa5
	fst.d	$fa4, $sp, 712                  # 8-byte Folded Spill
	fdiv.d	$fa5, $fa5, $fa4
	fadd.d	$fa5, $ft10, $fa5
	fmul.d	$fa5, $fa5, $ft14
...
.LBB16_23:                              #   in Loop: Header=BB16_6 Depth=1
	fst.d	$ft11, $sp, 416                 # 8-byte Folded Spill
	fst.d	$ft10, $sp, 424                 # 8-byte Folded Spill
	fst.d	$fs6, $sp, 408                  # 8-byte Folded Spill
	fst.d	$fs2, $sp, 712                  # 8-byte Folded Spill
...
.LBB16_24:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$ft5, $ft4, $ft4
	fmul.d	$ft0, $fa5, $fa5
	fld.d	$ft13, $sp, 824                 # 8-byte Folded Reload
	fmul.d	$ft7, $ft13, $ft4
	fmul.d	$ft1, $fs6, $fa5
	fadd.d	$ft1, $ft1, $ft7
	fadd.d	$ft3, $fa5, $ft4
	...
	fmul.d	$ft1, $fa0, $fa5
	fdiv.d	$ft8, $ft4, $fa5
	fcmp.clt.d	$fcc0, $ft8, $ft12
	fsel	$ft9, $ft12, $ft8, $fcc0
	fmul.d	$ft8, $ft1, $ft9
	fmul.d	$ft10, $fs1, $ft4
	fdiv.d	$ft11, $fa5, $ft4
	fcmp.clt.d	$fcc0, $ft11, $ft12
	fsel	$ft11, $ft12, $ft11, $fcc0
	fmul.d	$ft10, $ft10, $ft11
	fsub.d	$ft8, $ft8, $ft10
	fdiv.d	$ft10, $ft5, $ft0
	fcmp.clt.d	$fcc0, $ft10, $ft14
	fsel	$ft10, $ft14, $ft10, $fcc0
	fmul.d	$ft10, $ft0, $ft10
	fdiv.d	$ft12, $ft0, $ft5
	fcmp.clt.d	$fcc0, $ft12, $ft14
	fsel	$ft12, $ft14, $ft12, $fcc0
	...
	fst.d	$ft10, $sp, 360                 # 8-byte Folded Spill
	fst.d	$fa4, $sp, 352                  # 8-byte Folded Spill
	fst.d	$fs5, $sp, 312                  # 8-byte Folded Spill
	fst.d	$fa7, $sp, 608                  # 8-byte Folded Spill
	fst.d	$ft11, $sp, 568                 # 8-byte Folded Spill
	bge	$s0, $a6, .LBB16_26
# %bb.25:                               #   in Loop: Header=BB16_6 Depth=1
	fst.d	$fs1, $sp, 776                  # 8-byte Folded Spill
	fld.d	$fs1, $sp, 784                  # 8-byte Folded Reload
	fmul.d	$ft9, $fs0, $fs1
	fadd.d	$ft7, $ft7, $ft9
	fdiv.d	$ft7, $ft7, $fa4
	fdiv.d	$ft9, $ft4, $fs0
	fcmp.clt.d	$fcc0, $ft9, $fa0
	fsel	$ft9, $fa0, $ft9, $fcc0
	fmov.d	$fs5, $ft10
	...
	fmov.d	$fa7, $fa4
	fdiv.d	$ft12, $fs0, $ft4
	fcmp.clt.d	$fcc0, $ft12, $fa0
	fsel	$ft12, $fa0, $ft12, $fcc0
	fmul.d	$ft11, $ft12, $ft11
	fsub.d	$ft10, $ft10, $ft11
	vori.b	$vr19, $vr2, 0
	vextrins.d	$vr19, $vr13, 16
	vextrins.d	$vr13, $vr2, 16
	vfdiv.d	$vr19, $vr19, $vr13
	vfcmp.clt.d	$vr21, $vr19, $vr22
	vbitsel.v	$vr19, $vr22, $vr19, $vr21
	fld.d	$ft13, $sp, 808                 # 8-byte Folded Reload
	vfmul.d	$vr13, $vr13, $vr19
	vreplvei.d	$vr19, $vr13, 0
	vreplvei.d	$vr13, $vr13, 1
	fadd.d	$ft5, $ft5, $ft11
	fdiv.d	$ft10, $ft10, $ft5
	fmul.d	$ft10, $fs7, $ft10
	fsub.d	$ft10, $ft7, $ft10
	...
	fmov.d	$fa6, $ft10
	fmul.d	$fs1, $fa4, $ft14
	fst.d	$fa7, $sp, 328                  # 8-byte Folded Spill
	fmul.d	$fa4, $fa7, $fa7
	fdiv.d	$fa4, $fa4, $ft10
...
.LBB16_26:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmov.d	$fa6, $fs2
	fst.d	$fs2, $sp, 328                  # 8-byte Folded Spill
.LBB16_27:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$ft4, $fa4, $fa4
	fmul.d	$ft7, $fs6, $fa5
	fld.d	$ft5, $sp, 824                  # 8-byte Folded Reload
	fmul.d	$ft5, $ft5, $fa4
	fadd.d	$ft7, $ft7, $ft5
	fadd.d	$ft8, $fa5, $fa4
	fdiv.d	$ft7, $ft7, $ft8
	fmul.d	$ft9, $fa3, $fa4
	fdiv.d	$ft10, $fa5, $fa4
	fcmp.clt.d	$fcc0, $ft10, $fa0
	fsel	$ft10, $fa0, $ft10, $fcc0
	fmul.d	$ft9, $ft9, $ft10
	fdiv.d	$ft11, $fa4, $fa5
	fcmp.clt.d	$fcc0, $ft11, $fa0
	fsel	$ft11, $fa0, $ft11, $fcc0
	fmul.d	$ft1, $ft1, $ft11
	fsub.d	$ft1, $ft9, $ft1
	fdiv.d	$ft9, $ft0, $ft4
	fcmp.clt.d	$fcc0, $ft9, $ft14
	fsel	$ft9, $ft14, $ft9, $fcc0
	fmul.d	$ft9, $ft4, $ft9
	fdiv.d	$ft12, $ft4, $ft0
	fcmp.clt.d	$fcc0, $ft12, $ft14
	fsel	$ft12, $ft14, $ft12, $fcc0
	...
	fmul.d	$ft2, $fa3, $fa3
	fdiv.d	$ft2, $ft2, $fs6
	fst.d	$fs6, $sp, 616                  # 8-byte Folded Spill
	fmul.d	$ft6, $fs6, $fs6
	fmul.d	$ft6, $ft6, $fa1
	fadd.d	$ft2, $ft6, $ft2
	fmul.d	$ft6, $fa3, $fa5
...
# %bb.28:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$ft9, $sp, 648                  # 8-byte Folded Reload
	fmul.d	$ft1, $fs0, $ft9
	fadd.d	$ft1, $ft5, $ft1
	fdiv.d	$ft1, $ft1, $fs6
	fld.d	$ft8, $sp, 664                  # 8-byte Folded Reload
	fmul.d	$ft2, $fa4, $ft8
	fdiv.d	$ft3, $fs0, $fa4
	fcmp.clt.d	$fcc0, $ft3, $ft6
	fsel	$ft3, $ft6, $ft3, $fcc0
	fmul.d	$ft2, $ft3, $ft2
	fdiv.d	$ft5, $fa4, $fs0
	...
	fsub.d	$fa7, $ft2, $fa7
	vori.b	$vr10, $vr12, 0
	vextrins.d	$vr10, $vr2, 16
	vextrins.d	$vr2, $vr12, 16
	vfdiv.d	$vr10, $vr10, $vr2
	vfcmp.clt.d	$vr12, $vr10, $vr22
	vbitsel.v	$vr10, $vr22, $vr10, $vr12
	vfmul.d	$vr2, $vr2, $vr10
	vreplvei.d	$vr10, $vr2, 0
...
.LBB16_32:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fldx.d	$fa0, $t7, $a0
	fst.d	$fa0, $sp, 656                  # 8-byte Folded Spill
	fld.d	$fs5, $sp, 304                  # 8-byte Folded Reload
	fmul.d	$ft5, $fs5, $ft2
	fsqrt.d	$fa0, $ft5
	fcmp.cor.d	$fcc0, $fa0, $fa0
	st.d	$s6, $sp, 640                   # 8-byte Folded Spill
	fst.d	$fa6, $sp, 240                  # 8-byte Folded Spill
	bceqz	$fcc0, .LBB16_96
.LBB16_33:                              # %.split
	...
	fdiv.d	$fa2, $fa2, $fs5
	fabs.d	$fa2, $fa2
	fst.d	$fa2, $sp, 304                  # 8-byte Folded Spill
	fadd.d	$fa0, $fa2, $fa0
	fsub.d	$fa2, $fa5, $fs4
	fsub.d	$fa3, $fs4, $fs7
	fsub.d	$fs1, $fa1, $fa5
	...
	fmul.d	$fa1, $fa1, $fa3
	fmul.d	$fa0, $fa0, $ft14
	fcmp.clt.d	$fcc0, $fa4, $ft6
	fsel	$fa3, $ft6, $fa4, $fcc0
...
.LBB16_42:                              # %.split1373
	...
	fmul.d	$fs4, $fa2, $ft14
	fld.d	$fa2, $sp, 296                  # 8-byte Folded Reload
	fdiv.d	$fa2, $fa2, $fa3
	fabs.d	$fs1, $fa2
	fadd.d	$fa0, $fs1, $fa0
	fsub.d	$fa2, $fs3, $fa5
...
.LBB16_48:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmov.d	$fa1, $ft5
	fld.d	$ft5, $sp, 576                  # 8-byte Folded Reload
	fld.d	$ft3, $sp, 656                  # 8-byte Folded Reload
	bceqz	$fcc0, .LBB16_98
.LBB16_49:                              # %.split1377
                                        #   in Loop: Header=BB16_6 Depth=1
...
# %bb.57:                               #   in Loop: Header=BB16_6 Depth=1
	...
	ldx.w	$a0, $s4, $a0
	ldx.w	$a1, $s4, $s5
	ld.d	$s6, $sp, 640                   # 8-byte Folded Reload
...
.LBB16_65:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fsqrt.d	$fa0, $fa0
	fcmp.cor.d	$fcc0, $fa0, $fa0
	fst.d	$fs2, $sp, 752                  # 8-byte Folded Spill
...
.LBB16_72:                              #   in Loop: Header=BB16_6 Depth=1
	...
	slli.d	$a0, $a5, 2
	ldx.w	$a2, $s4, $a0
	fst.d	$fs2, $sp, 760                  # 8-byte Folded Spill
	bge	$a1, $a2, .LBB16_74
...
.LBB16_96:                              # %call.sqrt
	...
	fmov.d	$fs1, $ft10
	fst.d	$ft11, $sp, 24                  # 8-byte Folded Spill
	fmov.d	$fs6, $ft12
	...
	fst.d	$ft0, $sp, 608                  # 8-byte Folded Spill
	fst.d	$ft5, $sp, 16                   # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fld.d	$ft5, $sp, 16                   # 8-byte Folded Reload
...
.LBB16_97:                              # %call.sqrt1374
	...
	fmov.d	$fs1, $ft10
	fmov.d	$fs7, $ft11
	fst.d	$ft12, $sp, 288                 # 8-byte Folded Spill
	fst.d	$fa7, $sp, 104                  # 8-byte Folded Spill
	fst.d	$ft1, $sp, 72                   # 8-byte Folded Spill
	fst.d	$ft2, $sp, 64                   # 8-byte Folded Spill
	fld.d	$fa1, $sp, 800                  # 8-byte Folded Reload
	...
	fld.d	$fa7, $sp, 104                  # 8-byte Folded Reload
	fld.d	$fa6, $sp, 240                  # 8-byte Folded Reload
	fld.d	$ft12, $sp, 288                 # 8-byte Folded Reload
	ld.d	$a4, $sp, 624                   # 8-byte Folded Reload
	fmov.d	$ft11, $fs7
	fmov.d	$ft10, $fs1
	ld.d	$a3, $sp, 632                   # 8-byte Folded Reload
...
.LBB16_98:                              # %call.sqrt1378
	...
	st.d	$t6, $sp, 80                    # 8-byte Folded Spill
	st.d	$t7, $sp, 56                    # 8-byte Folded Spill
	st.d	$t5, $sp, 520                   # 8-byte Folded Spill
	st.d	$t1, $sp, 184                   # 8-byte Folded Spill
	st.d	$t3, $sp, 272                   # 8-byte Folded Spill
	st.d	$t8, $sp, 32                    # 8-byte Folded Spill
...
.LBB16_102:                             # %call.sqrt1394
	...
	fst.d	$ft5, $sp, 712                  # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fld.d	$ft5, $sp, 712                  # 8-byte Folded Reload
	fld.d	$ft0, $sp, 784                  # 8-byte Folded Reload
	fld.d	$ft4, $sp, 88                   # 8-byte Folded Reload
	fld.d	$ft2, $sp, 64                   # 8-byte Folded Reload
	fmov.d	$ft1, $fs7
	fld.d	$ft3, $sp, 656                  # 8-byte Folded Reload
...
.LBB16_105:                             # %call.sqrt1376
	...
	ld.d	$a4, $sp, 624                   # 8-byte Folded Reload
	fmov.d	$ft11, $fs2
	fld.d	$ft0, $sp, 736                  # 8-byte Folded Reload
	fld.d	$ft10, $sp, 40                  # 8-byte Folded Reload
	ld.d	$a3, $sp, 632                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 32                    # 8-byte Folded Reload
	ld.d	$t3, $sp, 272                   # 8-byte Folded Reload
...
.LBB16_107:                             # %call.sqrt1384
	...
	fld.d	$ft10, $sp, 40                  # 8-byte Folded Reload
	fmov.d	$fa3, $fs2
	fld.d	$fs2, $sp, 752                  # 8-byte Folded Reload
	move	$t8, $s5
	move	$t3, $s6
	fld.d	$ft9, $sp, 648                  # 8-byte Folded Reload
	move	$t1, $s2
...
.LBB16_108:                             # %call.sqrt1388
	...
	fld.d	$ft0, $sp, 592                  # 8-byte Folded Reload
	fld.d	$fa3, $sp, 208                  # 8-byte Folded Reload
	fld.d	$fs2, $sp, 760                  # 8-byte Folded Reload
	move	$t3, $s7
	fld.d	$ft9, $sp, 648                  # 8-byte Folded Reload
	move	$t1, $s6
	move	$t5, $s5
...
# %bb.26:                               #   in Loop: Header=BB17_25 Depth=1
	...
	fsel	$fa5, $fa3, $fa5, $fcc0
	fmul.d	$fa5, $fa4, $fa5
	fdiv.d	$fa6, $fa4, $fa7
	fcmp.clt.d	$fcc0, $fa6, $fa3
	fsel	$fa6, $fa3, $fa6, $fcc0
	fmul.d	$fa6, $fa7, $fa6
	fmul.d	$ft0, $fa4, $fa4
	fmul.d	$ft1, $fa7, $fa7
	fdiv.d	$ft2, $ft1, $ft0
	fcmp.clt.d	$fcc0, $ft2, $fa1
	fsel	$ft2, $fa1, $ft2, $fcc0
	fmul.d	$ft2, $ft0, $ft2
	fdiv.d	$ft0, $ft0, $ft1
...
.LBB17_27:                              # %._crit_edge
	...
	beqz	$a0, .LBB17_186
.LBB17_28:
	st.d	$s1, $sp, 792                   # 8-byte Folded Spill
...
.LBB17_72:                              #   in Loop: Header=BB17_55 Depth=1
	st.d	$s4, $sp, 576                   # 8-byte Folded Spill
...
.LBB17_77:                              #   in Loop: Header=BB17_55 Depth=1
	...
	fldx.d	$ft10, $t4, $t2
	fst.d	$fa4, $sp, 568                  # 8-byte Folded Spill
	fst.d	$ft9, $sp, 328                  # 8-byte Folded Spill
	bge	$a0, $t3, .LBB17_79
...
.LBB17_104:                             #   in Loop: Header=BB17_55 Depth=1
	...
	fst.d	$fs5, $sp, 552                  # 8-byte Folded Spill
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
...
.LBB17_124:                             # %.split1352
	...
	fmul.d	$fa0, $fa0, $ft5
	fmul.d	$fa0, $ft3, $fa0
	fst.d	$fs0, $sp, 680                  # 8-byte Folded Spill
	fdiv.d	$fa0, $fa0, $fs0
	fsub.d	$fa1, $ft6, $fa0
	fmul.d	$fa0, $fa0, $fa1
	fmul.d	$fa1, $fa2, $fa2
...
.LBB17_147:                             # %.split1364
	...
	fmul.d	$fs1, $fa2, $fa0
	bge	$s5, $a0, .LBB17_153
# %bb.148:                              #   in Loop: Header=BB17_55 Depth=1
	slli.d	$a0, $t8, 2
	ldx.w	$a3, $s3, $a0
	ld.d	$a0, $sp, 456                   # 8-byte Folded Reload
	slli.d	$a0, $a0, 2
...
# %bb.149:                              #   in Loop: Header=BB17_55 Depth=1
	...
	b	.LBB17_151
	.p2align	4, , 16
.LBB17_150:                             #   in Loop: Header=BB17_55 Depth=1
...
.LBB17_153:                             #   in Loop: Header=BB17_55 Depth=1
	...
	fadd.d	$fa1, $fa1, $fa0
	fdiv.d	$fa0, $fa6, $fa5
	fld.d	$ft14, $sp, 528                 # 8-byte Folded Reload
	fld.d	$fs0, $sp, 520                  # 8-byte Folded Reload
	fld.d	$fs2, $sp, 536                  # 8-byte Folded Reload
	bge	$s5, $a0, .LBB17_155
# %bb.154:                              #   in Loop: Header=BB17_55 Depth=1
	fadd.d	$fa3, $ft7, $ft12
	fmul.d	$ft7, $fa3, $ft5
...
# %bb.156:                              #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa6, $sp, 648                  # 8-byte Folded Reload
	fadd.d	$fa5, $ft8, $fa6
	fmul.d	$ft8, $fa5, $ft5
	fmul.d	$fa5, $fa6, $fa6
	fdiv.d	$fa5, $fa5, $ft13
...
# %bb.160:                              #   in Loop: Header=BB17_55 Depth=1
	fld.d	$ft15, $sp, 616                 # 8-byte Folded Reload
	fadd.d	$ft1, $ft13, $ft15
	fmul.d	$ft13, $ft1, $ft5
	fld.d	$ft2, $sp, 656                  # 8-byte Folded Reload
	fdiv.d	$ft1, $fs6, $ft2
	fadd.d	$fa7, $fa7, $ft1
	fmul.d	$fa7, $fa7, $ft5
	fmul.d	$ft1, $ft15, $ft15
	fdiv.d	$ft1, $ft1, $ft2
	fmul.d	$ft2, $ft2, $ft2
	fmul.d	$fa2, $ft2, $fa2
	fadd.d	$fa2, $fa2, $ft1
...
.LBB17_161:                             # %call.sqrt
	...
	fmov.d	$fs7, $ft4
	fst.d	$ft7, $sp, 88                   # 8-byte Folded Spill
	fst.d	$ft8, $sp, 24                   # 8-byte Folded Spill
	fst.d	$ft9, $sp, 80                   # 8-byte Folded Spill
	fst.d	$ft10, $sp, 32                  # 8-byte Folded Spill
	fst.d	$ft11, $sp, 160                 # 8-byte Folded Spill
	fst.d	$fa5, $sp, 72                   # 8-byte Folded Spill
	fst.d	$fa6, $sp, 152                  # 8-byte Folded Spill
	...
	fst.d	$ft12, $sp, 120                 # 8-byte Folded Spill
	fst.d	$ft13, $sp, 112                 # 8-byte Folded Spill
	fst.d	$ft14, $sp, 104                 # 8-byte Folded Spill
	fst.d	$ft15, $sp, 96                  # 8-byte Folded Spill
	...
	fld.d	$ft15, $sp, 96                  # 8-byte Folded Reload
	fld.d	$ft14, $sp, 104                 # 8-byte Folded Reload
	fld.d	$ft13, $sp, 112                 # 8-byte Folded Reload
	fld.d	$ft12, $sp, 120                 # 8-byte Folded Reload
	fld.d	$ft2, $sp, 128                  # 8-byte Folded Reload
	fld.d	$ft1, $sp, 136                  # 8-byte Folded Reload
	fld.d	$ft0, $sp, 144                  # 8-byte Folded Reload
	fld.d	$fa7, $sp, 64                   # 8-byte Folded Reload
	fld.d	$fa6, $sp, 152                  # 8-byte Folded Reload
	fld.d	$fa5, $sp, 72                   # 8-byte Folded Reload
	fld.d	$ft11, $sp, 160                 # 8-byte Folded Reload
	fld.d	$ft10, $sp, 32                  # 8-byte Folded Reload
	fld.d	$ft9, $sp, 80                   # 8-byte Folded Reload
...
.LBB17_165:                             # %call.sqrt1353
	...
	st.d	$t6, $sp, 40                    # 8-byte Folded Spill
	st.d	$t4, $sp, 56                    # 8-byte Folded Spill
	fst.d	$fa3, $sp, 536                  # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
...
.LBB17_176:                             # %call.sqrt1367
	...
	move	$a1, $s0
	b	.LBB17_152
.LBB17_177:                             # %._crit_edge1186.._crit_edge1190_crit_edge
