...
# %bb.1:
	addi.w	$a6, $zero, -1
	beq	$t0, $a6, .LBB7_7
# %bb.2:                                # %.lr.ph.preheader.preheader
	ori	$a2, $zero, 1
	ori	$t0, $zero, 1001
	.p2align	4, , 16
...
# %bb.23:
	addi.w	$a2, $zero, -1
	beq	$a3, $a2, .LBB33_75
# %bb.24:                               # %.lr.ph447.preheader.preheader
	ori	$a0, $zero, 1
	ori	$a3, $zero, 1001
	.p2align	4, , 16
.LBB33_25:                              # %.lr.ph447.preheader
                                        # =>This Inner Loop Header: Depth=1
	mul.d	$a4, $a0, $a0
	add.d	$a4, $s1, $a4
...
# %bb.36:
	addi.w	$a2, $zero, -1
	beq	$a3, $a2, .LBB33_75
# %bb.37:                               # %.lr.ph407.preheader.preheader
	ori	$a0, $zero, 1
	ori	$a3, $zero, 1001
	move	$a4, $s6
	.p2align	4, , 16
.LBB33_38:                              # %.lr.ph407.preheader
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a5, $s1, $a4
...
# %bb.42:
	addi.w	$a2, $zero, -1
	beq	$a3, $a2, .LBB33_75
# %bb.43:                               # %.lr.ph475.preheader.preheader
	ori	$a0, $zero, 1
	ori	$a3, $zero, 1001
	.p2align	4, , 16
.LBB33_44:                              # %.lr.ph475.preheader
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a4, $s1, 1
	bstrpick.d	$a4, $a4, 31, 0
	mod.du	$s1, $a4, $s0
