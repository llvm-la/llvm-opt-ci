...
# %bb.2:                                # %.preheader.lr.ph.split.us
	addi.w	$a5, $t3, -10
	pcalau12i	$a3, %got_pc_hi20(HVAR_WINDOW)
	ld.d	$a3, $a3, %got_pc_lo12(HVAR_WINDOW)
	ld.w	$a6, $a3, 0
	slli.d	$a3, $a6, 1
	addi.d	$a3, $a3, 1
	movgr2fr.w	$fa0, $a3
...
# %bb.24:                               # %vec.epilog.middle.block
	...
	move	$fp, $t1
	beq	$a3, $t0, .LBB1_14
.LBB1_25:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB1_15 Depth=1
	alsl.d	$t8, $fp, $a0, 2
	sub.d	$fp, $a2, $fp
	.p2align	4, , 16
.LBB1_26:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB1_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$ft2, $t8, 0
	fdiv.s	$ft2, $ft2, $fa0
	...
	bnez	$fp, .LBB1_26
	b	.LBB1_14
.LBB1_27:                               # %iter.check147.preheader
	move	$a4, $zero
	andi	$a5, $a3, 12
	move	$a6, $a3
	bstrins.d	$a6, $zero, 3, 0
	...
	b	.LBB1_29
	.p2align	4, , 16
.LBB1_28:                               # %._crit_edge58.split.us.split.us.split.us.us.us.us.us
...
.LBB1_29:                               # %iter.check147
	...
	ori	$fp, $zero, 10
	bltu	$a3, $t6, .LBB1_39
# %bb.30:                               # %vector.main.loop.iter.check132
                                        #   in Loop: Header=BB1_29 Depth=1
	bgeu	$a3, $t7, .LBB1_32
# %bb.31:                               #   in Loop: Header=BB1_29 Depth=1
	...
	b	.LBB1_36
	.p2align	4, , 16
.LBB1_32:                               # %vector.body139.preheader
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$t8, $a6
	move	$fp, $t2
	.p2align	4, , 16
.LBB1_33:                               # %vector.body139
	...
	addi.d	$fp, $fp, 64
	bnez	$t8, .LBB1_33
# %bb.34:                               # %middle.block144
                                        #   in Loop: Header=BB1_29 Depth=1
	beq	$a3, $a6, .LBB1_28
# %bb.35:                               # %vec.epilog.iter.check149
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$s0, $a6
	move	$fp, $a7
	beqz	$a5, .LBB1_39
.LBB1_36:                               # %vec.epilog.ph151
                                        #   in Loop: Header=BB1_29 Depth=1
	alsl.d	$t8, $s0, $t4, 2
	add.d	$fp, $t5, $s0
	.p2align	4, , 16
.LBB1_37:                               # %vec.epilog.vector.body156
                                        #   Parent Loop BB1_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t8, 0
	vfdiv.s	$vr3, $vr3, $vr2
	...
	addi.d	$t8, $t8, 16
	bnez	$fp, .LBB1_37
# %bb.38:                               # %vec.epilog.middle.block160
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$fp, $t1
	beq	$a3, $t0, .LBB1_28
.LBB1_39:                               # %vec.epilog.scalar.ph148.preheader
                                        #   in Loop: Header=BB1_29 Depth=1
	alsl.d	$t8, $fp, $a0, 2
	sub.d	$fp, $a2, $fp
	.p2align	4, , 16
.LBB1_40:                               # %vec.epilog.scalar.ph148
                                        #   Parent Loop BB1_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa3, $t8, 0
	fdiv.s	$fa3, $fa3, $fa0
...
# %bb.3:
	...
	beqz	$a2, .LBB6_10
# %bb.4:
	pcalau12i	$s3, %pc_hi20(WriteConnectedComponentsToPGM.index)
	ld.w	$a3, $s3, %pc_lo12(WriteConnectedComponentsToPGM.index)
	ori	$a4, $zero, 99
	blt	$a4, $a3, .LBB6_10
# %bb.5:
	mul.w	$a2, $a2, $a1
...
.LBB6_11:
	...
	move	$s1, $a0
	addi.d	$a0, $a3, 1
	st.w	$a0, $s3, %pc_lo12(WriteConnectedComponentsToPGM.index)
