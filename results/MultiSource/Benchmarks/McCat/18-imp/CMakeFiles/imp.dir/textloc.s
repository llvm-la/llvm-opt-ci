...
.LBB1_26:                               # %vec.epilog.scalar.ph
	...
	bnez	$t8, .LBB1_26
	b	.LBB1_14
.LBB1_27:                               # %iter.check136.preheader
	move	$a3, $zero
	andi	$a4, $a2, 12
	move	$a5, $a2
	bstrins.d	$a5, $zero, 3, 0
...
.LBB1_29:                               # %iter.check136
	...
	ori	$t8, $zero, 10
	bltu	$a2, $t5, .LBB1_39
# %bb.30:                               # %vector.main.loop.iter.check138
                                        #   in Loop: Header=BB1_29 Depth=1
	bgeu	$a2, $t6, .LBB1_32
# %bb.31:                               #   in Loop: Header=BB1_29 Depth=1
	...
	b	.LBB1_36
	.p2align	4, , 16
.LBB1_32:                               # %vector.body144.preheader
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$t7, $a5
	move	$t8, $t1
	.p2align	4, , 16
.LBB1_33:                               # %vector.body144
	...
	addi.d	$t8, $t8, 64
	bnez	$t7, .LBB1_33
# %bb.34:                               # %middle.block149
                                        #   in Loop: Header=BB1_29 Depth=1
	beq	$a2, $a5, .LBB1_28
# %bb.35:                               # %vec.epilog.iter.check153
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$fp, $a5
	move	$t8, $a6
	beqz	$a4, .LBB1_39
.LBB1_36:                               # %vec.epilog.ph155
                                        #   in Loop: Header=BB1_29 Depth=1
	alsl.d	$t7, $fp, $t3, 2
	add.d	$t8, $t4, $fp
	.p2align	4, , 16
.LBB1_37:                               # %vec.epilog.vector.body160
                                        #   Parent Loop BB1_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t7, 0
	vfdiv.s	$vr3, $vr3, $vr2
	...
	addi.d	$t7, $t7, 16
	bnez	$t8, .LBB1_37
# %bb.38:                               # %vec.epilog.middle.block165
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$t8, $t0
	beq	$a2, $a7, .LBB1_28
.LBB1_39:                               # %vec.epilog.scalar.ph152.preheader
                                        #   in Loop: Header=BB1_29 Depth=1
	alsl.d	$t7, $t8, $a0, 2
	sub.d	$t8, $a1, $t8
	.p2align	4, , 16
.LBB1_40:                               # %vec.epilog.scalar.ph152
                                        #   Parent Loop BB1_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa3, $t7, 0
	fdiv.s	$fa3, $fa3, $fa0
