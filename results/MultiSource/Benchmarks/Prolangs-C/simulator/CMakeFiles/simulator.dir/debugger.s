...
# %bb.28:                               #   in Loop: Header=BB18_27 Depth=3
	...
	addi.d	$s8, $s8, 1
	bnez	$a0, .LBB18_27
.LBB18_29:                              # %IS_PREFIX_TO.exit42.thread.sink.split
                                        #   in Loop: Header=BB18_19 Depth=2
	ld.w	$a0, $s4, 16
	add.d	$a1, $s6, $s7
	addi.d	$a2, $sp, 156
	...
	jirl	$ra, $ra, 0
.LBB18_30:                              # %IS_PREFIX_TO.exit42.thread
                                        #   in Loop: Header=BB18_19 Depth=2
	ld.w	$a0, $sp, 156
	bltu	$s1, $s0, .LBB18_32
# %bb.31:                               # %IS_PREFIX_TO.exit42.thread
                                        #   in Loop: Header=BB18_19 Depth=2
	addi.d	$s0, $s0, 1
	beqz	$a0, .LBB18_19
.LBB18_32:                              # %.critedge
