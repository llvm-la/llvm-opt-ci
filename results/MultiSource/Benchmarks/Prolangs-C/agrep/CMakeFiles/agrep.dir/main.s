...
# %bb.0:
	...
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %pc_hi20(PAT_FILE)
	ld.w	$a1, $a1, %pc_lo12(PAT_FILE)
	addi.w	$a2, $a0, 0
	bnez	$a1, .LBB3_2
# %bb.1:
	bge	$s0, $a2, .LBB3_54
.LBB3_2:
	pcalau12i	$a1, %pc_hi20(SIMPLEPATTERN)
	ori	$a3, $zero, 1
	st.w	$a3, $a1, %pc_lo12(SIMPLEPATTERN)
	blez	$a2, .LBB3_9
# %bb.3:                                # %.lr.ph
...
.LBB3_7:                                # %.sink.split
                                        #   in Loop: Header=BB3_5 Depth=1
	move	$a4, $zero
	st.w	$zero, $a1, %pc_lo12(SIMPLEPATTERN)
...
.LBB3_16:                               # %.thread
	...
	st.w	$a3, $a1, %pc_lo12(SIMPLEPATTERN)
.LBB3_17:                               # %.thread82
	pcalau12i	$a1, %pc_hi20(NOUPPER)
	ld.w	$a1, $a1, %pc_lo12(NOUPPER)
	sltu	$a1, $zero, $a1
	sltu	$a3, $zero, $s0
	and	$a1, $a3, $a1
	bnez	$a1, .LBB3_30
# %bb.18:                               # %.thread82
	pcalau12i	$a1, %pc_hi20(JUMP)
	ld.w	$a1, $a1, %pc_lo12(JUMP)
	ori	$a3, $zero, 1
	beq	$a1, $a3, .LBB3_30
# %bb.19:                               # %.thread82
...
# %bb.23:
	blez	$s0, .LBB3_25
# %bb.24:
	pcalau12i	$a1, %pc_hi20(WORDBOUND)
	ld.w	$a1, $a1, %pc_lo12(WORDBOUND)
	bnez	$a1, .LBB3_30
.LBB3_25:
	pcalau12i	$a1, %pc_hi20(WHOLELINE)
	ld.w	$a1, $a1, %pc_lo12(WHOLELINE)
	slt	$a3, $zero, $s0
	sltu	$a1, $zero, $a1
	and	$a1, $a3, $a1
	bnez	$a1, .LBB3_30
# %bb.26:
	pcalau12i	$a1, %pc_hi20(SILENT)
	ld.w	$a1, $a1, %pc_lo12(SILENT)
	bnez	$a1, .LBB3_30
# %bb.27:
	pcalau12i	$a1, %pc_hi20(SGREP)
	ori	$a3, $zero, 1
	st.w	$a3, $a1, %pc_lo12(SGREP)
	ori	$a4, $zero, 16
	pcalau12i	$a1, %pc_hi20(DNA)
	addi.d	$a1, $a1, %pc_lo12(DNA)
	blt	$a2, $a4, .LBB3_31
# %bb.28:                               # %.thread84
	st.w	$a3, $a1, 0
	b	.LBB3_32
...
# %bb.40:                               # %.lr.ph63
	...
	bnez	$a6, .LBB3_38
	b	.LBB3_37
.LBB3_41:                               # %vector.main.loop.iter.check
	ori	$a3, $zero, 16
	vrepli.b	$vr0, 116
	vrepli.b	$vr1, 97
	vrepli.b	$vr2, 99
...
.LBB3_45:                               # %vector.body
	...
	vslli.b	$vr3, $vr5, 7
	vmskltz.b	$vr3, $vr3
	vpickve2gr.hu	$a7, $vr3, 0
	beqz	$a7, .LBB3_44
# %bb.46:                               #   in Loop: Header=BB3_45 Depth=1
	st.w	$zero, $a1, 0
	b	.LBB3_44
.LBB3_47:                               # %middle.block
	beq	$a2, $a3, .LBB3_30
# %bb.48:                               # %vec.epilog.iter.check
	beqz	$a4, .LBB3_36
.LBB3_49:                               # %vec.epilog.ph
	move	$a4, $a3
...
# %bb.52:                               #   in Loop: Header=BB3_51 Depth=1
	st.w	$zero, $a1, 0
	b	.LBB3_50
.LBB3_53:                               # %vec.epilog.middle.block
	beq	$a2, $a3, .LBB3_30
	b	.LBB3_36
.LBB3_54:
	pcalau12i	$a0, %got_pc_hi20(stderr)
...
# %bb.58:                               #   in Loop: Header=BB7_36 Depth=2
	...
	b	.LBB7_65
	.p2align	4, , 16
.LBB7_59:                               # %vector.main.loop.iter.check723
                                        #   in Loop: Header=BB7_36 Depth=2
	ori	$t4, $zero, 10
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB7_66
...
# %bb.68:                               # %middle.block732
	...
	ld.d	$t5, $sp, 208                   # 8-byte Folded Reload
	beq	$a2, $a1, .LBB7_75
# %bb.69:                               # %vec.epilog.iter.check736
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	move	$a3, $a2
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB7_73
.LBB7_70:                               # %vec.epilog.ph738
                                        #   in Loop: Header=BB7_36 Depth=2
	vreplgr2vr.w	$vr0, $a0
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a3
	...
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB7_71:                               # %vec.epilog.vector.body743
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB7_71
# %bb.72:                               # %vec.epilog.middle.block746
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	move	$a2, $a3
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	beq	$a3, $a1, .LBB7_75
.LBB7_73:                               # %vec.epilog.scalar.ph735.preheader
                                        #   in Loop: Header=BB7_36 Depth=2
	lu12i.w	$a1, 141
	ori	$a1, $a1, 936
	add.d	$a1, $sp, $a1
	...
	sub.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB7_74:                               # %vec.epilog.scalar.ph735
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a0, $a1, 0
...
# %bb.101:                              #   in Loop: Header=BB7_36 Depth=2
	...
	b	.LBB7_34
	.p2align	4, , 16
.LBB7_102:                              # %vector.main.loop.iter.check695
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$s1, $sp, 216                   # 8-byte Folded Reload
...
# %bb.107:                              #   in Loop: Header=BB7_36 Depth=2
	...
	or	$a0, $a1, $a0
	b	.LBB7_34
.LBB7_108:                              # %vector.body699.preheader
                                        #   in Loop: Header=BB7_36 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 992
	add.d	$a0, $sp, $a0
...
.LBB7_109:                              # %vector.body699
	...
	addi.d	$a0, $a0, 64
	bnez	$a1, .LBB7_109
# %bb.110:                              # %middle.block702
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	vld	$vr0, $sp, 64                   # 16-byte Folded Reload
	beq	$a1, $a0, .LBB7_117
# %bb.111:                              # %vec.epilog.iter.check706
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	move	$a2, $a1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB7_115
.LBB7_112:                              # %vec.epilog.ph708
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	lu12i.w	$a1, 141
	...
	alsl.d	$a1, $a2, $a1, 2
	.p2align	4, , 16
.LBB7_113:                              # %vec.epilog.vector.body713
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB7_113
# %bb.114:                              # %vec.epilog.middle.block716
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	beq	$a2, $a0, .LBB7_117
.LBB7_115:                              # %vec.epilog.scalar.ph705.preheader
                                        #   in Loop: Header=BB7_36 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 960
	add.d	$a0, $sp, $a0
	...
	sub.d	$a1, $a2, $a1
	.p2align	4, , 16
.LBB7_116:                              # %vec.epilog.scalar.ph705
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a3, $a0, 0
