...
# %bb.59:                               # %vec.epilog.middle.block
	...
	vpickve2gr.w	$t0, $vr0, 0
	beq	$t2, $a6, .LBB0_62
.LBB0_60:                               # %vec.epilog.scalar.ph.preheader
	alsl.d	$t1, $a7, $a2, 2
	sub.d	$a6, $a6, $a7
	addi.d	$a6, $a6, 1
	.p2align	4, , 16
.LBB0_61:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $t1, 0
	or	$t0, $a7, $t0
	addi.d	$a6, $a6, -1
...
.LBB0_62:                               # %._crit_edge243
	...
	st.w	$a3, $s3, 0
	blt	$a0, $a4, .LBB0_86
# %bb.63:                               # %.preheader204.us.preheader
	...
	b	.LBB0_65
	.p2align	4, , 16
.LBB0_64:                               # %._crit_edge252.us
                                        #   in Loop: Header=BB0_65 Depth=1
	addi.d	$a6, $a6, 1
	beq	$a6, $t2, .LBB0_86
.LBB0_65:                               # %.preheader204.us
	...
	alsl.d	$t3, $a6, $a5, 2
	beqz	$t4, .LBB0_77
# %bb.66:                               # %.preheader202.us.us.preheader
                                        #   in Loop: Header=BB0_65 Depth=1
	ori	$t4, $zero, 1
	move	$t5, $a3
	b	.LBB0_68
...
# %bb.72:                               #   in Loop: Header=BB0_70 Depth=3
	bltu	$a6, $t8, .LBB0_69
# %bb.73:                               #   in Loop: Header=BB0_70 Depth=3
	ld.bu	$t8, $t7, 0
	bltu	$t8, $a6, .LBB0_69
.LBB0_74:                               # %.loopexit203.split.us.us.us.sink.split
	...
	or	$t7, $t8, $t7
	st.w	$t7, $t3, 0
.LBB0_75:                               # %.loopexit203.split.us.us.us
                                        #   in Loop: Header=BB0_68 Depth=2
	ld.w	$t6, $t6, 0
	bne	$t6, $t0, .LBB0_67
# %bb.76:                               #   in Loop: Header=BB0_68 Depth=2
	ld.w	$t6, $t3, 0
	slli.d	$t7, $t4, 2
	ldx.w	$t7, $a1, $t7
	xor	$t6, $t7, $t6
	...
	b	.LBB0_67
	.p2align	4, , 16
.LBB0_77:                               # %.preheader202.us257.preheader
                                        #   in Loop: Header=BB0_65 Depth=1
	ori	$t4, $zero, 1
	move	$t5, $a2
	b	.LBB0_79
