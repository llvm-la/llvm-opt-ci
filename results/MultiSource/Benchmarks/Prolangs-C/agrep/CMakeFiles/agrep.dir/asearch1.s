...
# %bb.30:                               # %.lr.ph229
	...
	ori	$a6, $zero, 7
	bgeu	$a5, $a6, .LBB0_40
.LBB0_31:                               # %scalar.ph418.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	sub.w	$a4, $a7, $a4
	sub.w	$a3, $a7, $a3
	sub.w	$a2, $a7, $a2
...
.LBB0_54:                               # %vector.body407
	...
	addi.d	$a1, $a1, 32
	bnez	$a3, .LBB0_54
# %bb.55:                               # %middle.block410
                                        #   in Loop: Header=BB0_29 Depth=2
	ld.d	$a3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 192                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB0_58
.LBB0_56:                               # %scalar.ph400.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	addi.d	$a1, $a3, -1
	alsl.d	$a2, $a3, $s3, 2
	alsl.d	$a3, $a3, $s8, 2
	.p2align	4, , 16
.LBB0_57:                               # %scalar.ph400
                                        #   Parent Loop BB0_25 Depth=1
                                        #     Parent Loop BB0_29 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a0, $a2, 0
	...
	addi.d	$a3, $a3, 4
	bltu	$a1, $s1, .LBB0_57
.LBB0_58:                               # %._crit_edge235.loopexit
                                        #   in Loop: Header=BB0_29 Depth=2
	ld.d	$a0, $sp, 320                   # 8-byte Folded Reload
	ld.wu	$fp, $a0, 0
	srli.d	$a0, $fp, 1
	and	$s5, $a0, $s0
.LBB0_59:                               # %._crit_edge235
                                        #   in Loop: Header=BB0_29 Depth=2
...
# %bb.60:                               # %.lr.ph239
	...
	ori	$a6, $zero, 7
	bgeu	$a5, $a6, .LBB0_97
.LBB0_61:                               # %scalar.ph378.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	sub.w	$a4, $a7, $a4
	sub.w	$a3, $a7, $a3
	sub.w	$a2, $a7, $a2
...
# %bb.65:                               # %.lr.ph243
	...
	ori	$a6, $zero, 7
	bgeu	$a5, $a6, .LBB0_74
.LBB0_66:                               # %scalar.ph352.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	sub.w	$a4, $a7, $a4
	sub.w	$a3, $a7, $a3
	sub.w	$a2, $a7, $a2
...
.LBB0_88:                               # %vector.body341
	...
	addi.d	$a1, $a1, 32
	bnez	$a3, .LBB0_88
# %bb.89:                               # %middle.block344
                                        #   in Loop: Header=BB0_29 Depth=2
	ld.d	$a3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 192                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB0_92
.LBB0_90:                               # %scalar.ph334.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	addi.d	$a1, $a3, -1
	alsl.d	$a2, $a3, $s3, 2
	alsl.d	$a3, $a3, $s8, 2
	.p2align	4, , 16
.LBB0_91:                               # %scalar.ph334
                                        #   Parent Loop BB0_25 Depth=1
                                        #     Parent Loop BB0_29 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a0, $a2, 0
...
# %bb.94:                               # %.lr.ph253
	...
	ori	$a6, $zero, 7
	bgeu	$a5, $a6, .LBB0_104
.LBB0_95:                               # %scalar.ph313.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	sub.w	$a4, $a7, $a4
	sub.w	$a3, $a7, $a3
	sub.w	$a2, $a7, $a2
...
# %bb.112:                              #   in Loop: Header=BB0_25 Depth=1
	...
	lu12i.w	$s6, 12
	b	.LBB0_24
.LBB0_113:                              # %.loopexit212.sink.split
