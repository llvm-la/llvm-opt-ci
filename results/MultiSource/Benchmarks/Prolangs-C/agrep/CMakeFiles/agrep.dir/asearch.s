...
# %bb.36:                               #   in Loop: Header=BB0_25 Depth=2
	...
	b	.LBB0_46
	.p2align	4, , 16
.LBB0_37:                               # %vector.main.loop.iter.check299
                                        #   in Loop: Header=BB0_25 Depth=2
	ori	$a1, $zero, 16
	bgeu	$t5, $a1, .LBB0_39
...
.LBB0_40:                               # %vector.body306
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB0_40
# %bb.41:                               # %middle.block309
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	beq	$a1, $t6, .LBB0_48
# %bb.42:                               # %vec.epilog.iter.check314
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	move	$a3, $a2
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB0_46
.LBB0_43:                               # %vec.epilog.ph316
                                        #   in Loop: Header=BB0_25 Depth=2
	vreplgr2vr.w	$vr0, $a0
	...
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body321
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_25 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block324
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	move	$a2, $a1
	beq	$a1, $t6, .LBB0_48
.LBB0_46:                               # %vec.epilog.scalar.ph313.preheader
                                        #   in Loop: Header=BB0_25 Depth=2
	lu12i.w	$a1, 24
	ori	$a1, $a1, 184
	add.d	$a1, $sp, $a1
	...
	sub.d	$a2, $t6, $a2
	.p2align	4, , 16
.LBB0_47:                               # %vec.epilog.scalar.ph313
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_25 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a0, $a1, 0
...
# %bb.63:                               #   in Loop: Header=BB0_25 Depth=2
	...
	b	.LBB0_73
	.p2align	4, , 16
.LBB0_64:                               # %vector.main.loop.iter.check270
                                        #   in Loop: Header=BB0_25 Depth=2
	ori	$a1, $zero, 16
	bgeu	$t5, $a1, .LBB0_66
...
.LBB0_67:                               # %vector.body277
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB0_67
# %bb.68:                               # %middle.block280
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	beq	$a1, $t6, .LBB0_75
# %bb.69:                               # %vec.epilog.iter.check285
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	move	$a3, $a2
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB0_73
.LBB0_70:                               # %vec.epilog.ph287
                                        #   in Loop: Header=BB0_25 Depth=2
	vreplgr2vr.w	$vr0, $a0
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	add.d	$a1, $a1, $a3
	...
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB0_71:                               # %vec.epilog.vector.body292
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_25 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB0_71
# %bb.72:                               # %vec.epilog.middle.block295
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	move	$a2, $a1
	beq	$a1, $t6, .LBB0_75
.LBB0_73:                               # %vec.epilog.scalar.ph284.preheader
                                        #   in Loop: Header=BB0_25 Depth=2
	lu12i.w	$a1, 24
	ori	$a1, $a1, 224
	add.d	$a1, $sp, $a1
	...
	sub.d	$a2, $t6, $a2
	.p2align	4, , 16
.LBB0_74:                               # %vec.epilog.scalar.ph284
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_25 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a0, $a1, 0
...
# %bb.44:                               # %vec.epilog.ph494
	...
	move	$a2, $ra
	.p2align	4, , 16
.LBB1_45:                               # %vec.epilog.vector.body499
                                        #   Parent Loop BB1_18 Depth=1
	...
	addi.d	$a1, $a1, 16
	bnez	$a2, .LBB1_45
# %bb.46:                               # %vec.epilog.middle.block502
                                        #   in Loop: Header=BB1_32 Depth=2
	move	$a2, $ra
	beq	$ra, $t5, .LBB1_49
.LBB1_47:                               # %vec.epilog.scalar.ph491.preheader
                                        #   in Loop: Header=BB1_32 Depth=2
	lu12i.w	$a1, 24
	ori	$a1, $a1, 208
	add.d	$a1, $sp, $a1
	...
	sub.d	$a2, $t5, $a2
	.p2align	4, , 16
.LBB1_48:                               # %vec.epilog.scalar.ph491
                                        #   Parent Loop BB1_18 Depth=1
                                        #     Parent Loop BB1_32 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a0, $a1, 0
...
# %bb.67:                               # %vec.epilog.ph465
	...
	move	$a2, $ra
	.p2align	4, , 16
.LBB1_68:                               # %vec.epilog.vector.body470
                                        #   Parent Loop BB1_18 Depth=1
                                        #     Parent Loop BB1_32 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a2, .LBB1_68
# %bb.69:                               # %vec.epilog.middle.block473
                                        #   in Loop: Header=BB1_32 Depth=2
	move	$a2, $ra
	beq	$ra, $t5, .LBB1_72
.LBB1_70:                               # %vec.epilog.scalar.ph462.preheader
                                        #   in Loop: Header=BB1_32 Depth=2
	lu12i.w	$a1, 24
	ori	$a1, $a1, 244
	add.d	$a1, $sp, $a1
	...
	sub.d	$a2, $t5, $a2
	.p2align	4, , 16
.LBB1_71:                               # %vec.epilog.scalar.ph462
                                        #   Parent Loop BB1_18 Depth=1
                                        #     Parent Loop BB1_32 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a0, $a1, 0
