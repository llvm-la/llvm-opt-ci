...
# %bb.24:                               #   in Loop: Header=BB7_23 Depth=2
	...
	bltu	$a4, $a7, .LBB7_23
	b	.LBB7_20
.LBB7_25:                               # %._crit_edge75
	beqz	$s1, .LBB7_27
.LBB7_26:                               # %._crit_edge75.thread
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	alsl.d	$a0, $a0, $s0, 1
...
# %bb.39:                               #   in Loop: Header=BB8_38 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB8_37
.LBB8_40:                               # %._crit_edge92
	beqz	$s2, .LBB8_42
.LBB8_41:                               # %._crit_edge92.thread
	move	$a0, $s2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB8_42:
...
# %bb.1:                                # %.lr.ph128.preheader
	...
	b	.LBB9_4
	.p2align	4, , 16
.LBB9_2:                                # %._crit_edge125
                                        #   in Loop: Header=BB9_4 Depth=1
	slli.d	$a1, $s6, 1
	ld.d	$a2, $sp, 8                     # 8-byte Folded Reload
	stx.h	$a2, $a0, $a1
.LBB9_3:                                # %._crit_edge120.thread
                                        #   in Loop: Header=BB9_4 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
...
# %bb.15:                               # %.lr.ph
	...
	b	.LBB9_10
	.p2align	4, , 16
.LBB9_16:                               # %._crit_edge109.loopexit
                                        #   in Loop: Header=BB9_8 Depth=2
	move	$s3, $a5
...
.LBB9_17:                               #   in Loop: Header=BB9_8 Depth=2
	...
	ldx.bu	$a0, $a0, $a3
	bnez	$a0, .LBB9_25
.LBB9_18:                               #   in Loop: Header=BB9_8 Depth=2
...
# %bb.29:                               #   in Loop: Header=BB9_28 Depth=3
	...
	ld.w	$a2, $a2, 0
	blt	$a0, $a2, .LBB9_6
# %bb.30:                               #   in Loop: Header=BB9_28 Depth=3
...
.LBB9_32:                               #   Parent Loop BB9_4 Depth=1
	...
	beq	$a7, $a6, .LBB9_27
# %bb.33:                               #   in Loop: Header=BB9_32 Depth=4
	ext.w.h	$a6, $a6
	slt	$a6, $a6, $a3
	addi.w	$a7, $a5, 1
	addi.w	$a5, $a5, -1
...
# %bb.53:                               #   in Loop: Header=BB9_52 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB9_51
.LBB9_54:                               # %._crit_edge134
	beqz	$s2, .LBB9_56
.LBB9_55:                               # %._crit_edge134.thread
	move	$a0, $s2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB9_56:
...
.LBB11_3:                               # =>This Loop Header: Depth=1
	...
	ld.w	$a2, $a6, %pc_lo12(tokensetsize)
	slli.d	$a4, $a0, 3
...
# %bb.20:                               # %vec.epilog.middle.block
	...
	bne	$t7, $s5, .LBB11_11
	b	.LBB11_6
.LBB11_21:                              # %.lr.ph48.preheader
	move	$fp, $zero
	ld.d	$s2, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 8                     # 8-byte Folded Reload
	b	.LBB11_23
	.p2align	4, , 16
.LBB11_22:                              # %._crit_edge46
...
.LBB15_17:                              #   Parent Loop BB15_14 Depth=1
	...
	bgez	$a4, .LBB15_17
	b	.LBB15_13
.LBB15_18:                              # %._crit_edge60
	beqz	$s2, .LBB15_20
# %bb.19:                               # %.thread84
	move	$a0, $s2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB15_20:                              # %._crit_edge67
	beqz	$s3, .LBB15_22
# %bb.21:
	move	$a0, $s3
	pcaddu18i	$ra, %call36(free)
...
# %bb.0:
	...
	move	$ra, $a0
	pcalau12i	$a0, %pc_hi20(VERTICES)
	ld.d	$a3, $a0, %pc_lo12(VERTICES)
	addi.w	$a5, $a1, 1
	st.w	$a5, $a2, %pc_lo12(top)
	pcalau12i	$a0, %pc_hi20(INDEX)
	ld.d	$s2, $a0, %pc_lo12(INDEX)
	slli.d	$a0, $a5, 1
...
# %bb.2:                                # %.lr.ph41
	...
	addi.d	$s3, $a0, 2
	blez	$a3, .LBB16_43
# %bb.3:                                # %.lr.ph41.split.us.preheader
	add.d	$a0, $a1, $s5
	...
	b	.LBB16_5
	.p2align	4, , 16
.LBB16_4:                               # %..loopexit36_crit_edge.us
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.h	$s0, $s3, 0
	addi.d	$s3, $s3, 2
	bltz	$s0, .LBB16_24
.LBB16_5:                               # %.lr.ph41.split.us
                                        # =>This Loop Header: Depth=1
...
.LBB16_13:                              # %vec.epilog.scalar.ph
	...
	b	.LBB16_4
	.p2align	4, , 16
.LBB16_14:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB16_5 Depth=1
	ori	$a1, $zero, 60
	bgeu	$s1, $a1, .LBB16_16
...
.LBB16_20:                              # %vec.epilog.ph
	...
	alsl.d	$a4, $a5, $s7, 2
	.p2align	4, , 16
.LBB16_21:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB16_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vld	$vr1, $a4, 0
...
# %bb.27:                               # %.lr.ph.us45.preheader
	...
	b	.LBB16_29
	.p2align	4, , 16
.LBB16_28:                              # %..loopexit_crit_edge.us
...
.LBB16_29:                              # %iter.check111
	...
	alsl.d	$s0, $s1, $s5, 2
	bltu	$a1, $t5, .LBB16_33
# %bb.30:                               # %vector.memcheck92
                                        #   in Loop: Header=BB16_29 Depth=1
	ld.d	$t8, $sp, 120                   # 8-byte Folded Reload
	sub.d	$t8, $s1, $t8
	bstrpick.d	$t8, $t8, 61, 4
	slli.d	$t8, $t8, 4
	beqz	$t8, .LBB16_33
# %bb.31:                               # %vector.main.loop.iter.check95
                                        #   in Loop: Header=BB16_29 Depth=1
	bgeu	$a1, $t6, .LBB16_35
...
.LBB16_33:                              #   in Loop: Header=BB16_29 Depth=1
	...
	move	$t8, $s0
	.p2align	4, , 16
.LBB16_34:                              # %vec.epilog.scalar.ph112
...
# %bb.37:                               # %middle.block107
	...
	ld.d	$ra, $sp, 136                   # 8-byte Folded Reload
	beq	$a2, $a4, .LBB16_28
# %bb.38:                               # %vec.epilog.iter.check113
                                        #   in Loop: Header=BB16_29 Depth=1
	move	$s6, $a4
	move	$s3, $a6
	beqz	$a3, .LBB16_34
.LBB16_39:                              # %vec.epilog.ph115
                                        #   in Loop: Header=BB16_29 Depth=1
	add.d	$t8, $s0, $t0
	add.d	$s0, $t4, $s6
	slli.d	$fp, $s6, 2
	...
	alsl.d	$s3, $s6, $s7, 2
	.p2align	4, , 16
.LBB16_40:                              # %vec.epilog.vector.body118
                                        #   Parent Loop BB16_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s3, 0
	vst	$vr0, $s1, 0
	...
	addi.d	$s3, $s3, 16
	bnez	$s0, .LBB16_40
# %bb.41:                               # %vec.epilog.middle.block124
                                        #   in Loop: Header=BB16_29 Depth=1
	move	$s3, $t1
	bne	$a2, $a7, .LBB16_34
	b	.LBB16_28
.LBB16_42:                              # %.loopexit35.loopexit
	ld.d	$a4, $sp, 80                    # 8-byte Folded Reload
	b	.LBB16_51
.LBB16_43:                              # %.lr.ph41.split.preheader
	move	$a0, $a5
	b	.LBB16_45
	.p2align	4, , 16
.LBB16_44:                              # %.loopexit36
