...
.LBB3_47:                               # %vec.epilog.vector.body71
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB3_47
# %bb.48:                               # %vec.epilog.middle.block77
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a4, $a7, .LBB3_14
	b	.LBB3_16
...
.LBB10_35:                              # %.loopexit
	...
	addi.d	$sp, $sp, 96
	ret
.LBB10_36:                              # %vector.main.loop.iter.check122
	srli.d	$a3, $a2, 1
	ori	$a6, $zero, 30
	addi.d	$a4, $a3, 1
	bgeu	$a2, $a6, .LBB10_46
...
.LBB10_38:                              # %vec.epilog.ph143
	...
	alsl.d	$a6, $a6, $s1, 1
	.p2align	4, , 16
.LBB10_39:                              # %vec.epilog.vector.body146
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $t0, 0
	addi.d	$a5, $a5, 8
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB10_39
# %bb.40:                               # %vec.epilog.middle.block152
	bne	$a4, $a7, .LBB10_24
	b	.LBB10_25
...
.LBB10_47:                              # %vector.body127
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB10_47
# %bb.48:                               # %middle.block134
	beq	$a4, $a6, .LBB10_25
# %bb.49:                               # %vec.epilog.iter.check141
	beqz	$a7, .LBB10_24
	b	.LBB10_38
