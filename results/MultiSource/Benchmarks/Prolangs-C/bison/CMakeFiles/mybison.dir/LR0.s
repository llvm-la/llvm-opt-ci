...
.LBB3_43:                               # %save_shifts.exit
	...
	b	.LBB3_3
.LBB3_44:                               # %vector.main.loop.iter.check49
                                        #   in Loop: Header=BB3_4 Depth=1
	srli.d	$a3, $a2, 1
	addi.d	$a4, $a3, 1
	ori	$a3, $zero, 30
...
.LBB3_46:                               # %vec.epilog.ph71
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB3_47:                               # %vec.epilog.vector.body74
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB3_47
# %bb.48:                               # %vec.epilog.middle.block80
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a4, $a7, .LBB3_14
	b	.LBB3_16
...
.LBB3_55:                               # %vector.body54
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB3_55
# %bb.56:                               # %middle.block63
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a4, $a6, .LBB3_16
# %bb.57:                               # %vec.epilog.iter.check69
                                        #   in Loop: Header=BB3_4 Depth=1
	beqz	$a7, .LBB3_14
	b	.LBB3_46
.LBB3_58:                               # %vector.ph
...
.LBB10_35:                              # %.loopexit
	...
	addi.d	$sp, $sp, 96
	ret
.LBB10_36:                              # %vector.main.loop.iter.check124
	srli.d	$a3, $a2, 1
	ori	$a6, $zero, 30
	addi.d	$a4, $a3, 1
	bgeu	$a2, $a6, .LBB10_46
...
.LBB10_38:                              # %vec.epilog.ph147
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB10_39:                              # %vec.epilog.vector.body150
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a5, 0
	addi.d	$a5, $a5, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB10_39
# %bb.40:                               # %vec.epilog.middle.block156
	bne	$a4, $a7, .LBB10_24
	b	.LBB10_25
.LBB10_41:                              # %vector.main.loop.iter.check
	srli.d	$a3, $a2, 1
	ori	$a6, $zero, 30
	addi.d	$a4, $a3, 1
	bgeu	$a2, $a6, .LBB10_50
...
.LBB10_43:                              # %vec.epilog.ph
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB10_44:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a5, 0
	addi.d	$a5, $a5, 16
...
.LBB10_47:                              # %vector.body129
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB10_47
# %bb.48:                               # %middle.block138
	beq	$a4, $a6, .LBB10_25
# %bb.49:                               # %vec.epilog.iter.check145
	beqz	$a7, .LBB10_24
	b	.LBB10_38
