...
.LBB3_43:                               # %save_shifts.exit
	...
	b	.LBB3_3
.LBB3_44:                               # %vector.main.loop.iter.check48
                                        #   in Loop: Header=BB3_4 Depth=1
	srli.d	$a3, $a2, 1
	addi.d	$a4, $a3, 1
	ori	$a3, $zero, 62
...
.LBB3_49:                               # %vector.body53
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB3_49
# %bb.50:                               # %middle.block60
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a4, $a6, .LBB3_16
# %bb.51:                               # %vec.epilog.iter.check66
                                        #   in Loop: Header=BB3_4 Depth=1
	beqz	$a7, .LBB3_14
.LBB3_52:                               # %vec.epilog.ph68
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a7, $a4
	...
	alsl.d	$a6, $a6, $a1, 1
	.p2align	4, , 16
.LBB3_53:                               # %vec.epilog.vector.body71
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a6, 0
	vst	$vr0, $t0, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB3_53
# %bb.54:                               # %vec.epilog.middle.block77
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a4, $a7, .LBB3_14
	b	.LBB3_16
.LBB3_55:                               # %vector.ph
...
.LBB9_42:
	...
	st.d	$a0, $a1, 0
	b	.LBB9_5
.LBB9_43:                               # %vector.main.loop.iter.check143
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB9_48
# %bb.44:
	move	$a3, $zero
.LBB9_45:                               # %vec.epilog.ph161
	...
	add.d	$a6, $a6, $fp
	addi.d	$a6, $a6, -4
.LBB9_46:                               # %vec.epilog.vector.body164
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a3, 0
	addi.d	$a5, $a5, 8
	...
	addi.d	$a6, $a6, -16
	bnez	$a5, .LBB9_46
# %bb.47:                               # %vec.epilog.middle.block170
	bne	$a4, $a1, .LBB9_18
	b	.LBB9_20
.LBB9_48:                               # %vector.ph145
	andi	$a4, $a1, 8
...
.LBB9_49:                               # %vector.body148
	...
	addi.d	$a6, $a6, -32
	bnez	$a7, .LBB9_49
# %bb.50:                               # %middle.block153
	beq	$a3, $a1, .LBB9_20
# %bb.51:                               # %vec.epilog.iter.check159
	bnez	$a4, .LBB9_45
	b	.LBB9_18
.Lfunc_end9:
...
.LBB10_6:                               # %vec.epilog.ph
	...
	alsl.d	$a4, $a4, $s1, 1
	.p2align	4, , 16
.LBB10_7:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vext2xv.w.h	$xr1, $xr1
	xvadd.w	$xr0, $xr0, $xr1
...
.LBB10_41:                              # %.loopexit
	...
	addi.d	$sp, $sp, 96
	ret
.LBB10_42:                              # %vector.main.loop.iter.check139
	srli.d	$a3, $a2, 1
	ori	$a6, $zero, 62
	addi.d	$a4, $a3, 1
	bgeu	$a2, $a6, .LBB10_46
# %bb.43:
	move	$a6, $zero
	b	.LBB10_50
.LBB10_44:                              # %vector.main.loop.iter.check102
	srli.d	$a3, $a2, 1
	ori	$a6, $zero, 62
	addi.d	$a4, $a3, 1
	bgeu	$a2, $a6, .LBB10_53
...
# %bb.48:                               # %middle.block151
	beq	$a4, $a6, .LBB10_31
# %bb.49:                               # %vec.epilog.iter.check157
	beqz	$a7, .LBB10_30
.LBB10_50:                              # %vec.epilog.ph159
	move	$a7, $a4
	bstrins.d	$a7, $zero, 2, 0
	alsl.d	$a2, $a7, $s1, 1
	alsl.d	$a3, $a7, $a5, 1
	...
	alsl.d	$a6, $a6, $s1, 1
	.p2align	4, , 16
.LBB10_51:                              # %vec.epilog.vector.body162
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $t0, 0
	addi.d	$a5, $a5, 8
...
.LBB10_54:                              # %vector.body107
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB10_54
# %bb.55:                               # %middle.block114
	beq	$a4, $a6, .LBB10_40
# %bb.56:                               # %vec.epilog.iter.check120
	beqz	$a7, .LBB10_39
.LBB10_57:                              # %vec.epilog.ph122
	move	$a7, $a4
	bstrins.d	$a7, $zero, 2, 0
	alsl.d	$a2, $a7, $s3, 1
	alsl.d	$a3, $a7, $a5, 1
	...
	alsl.d	$a6, $a6, $s3, 1
	.p2align	4, , 16
.LBB10_58:                              # %vec.epilog.vector.body125
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $t0, 0
	addi.d	$a5, $a5, 8
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB10_58
# %bb.59:                               # %vec.epilog.middle.block131
	bne	$a4, $a7, .LBB10_39
	b	.LBB10_40
.Lfunc_end10:
...
.LBB11_7:                               # %._crit_edge
	...
	addi.d	$sp, $sp, 48
	ret
.LBB11_8:                               # %vector.main.loop.iter.check
	srli.d	$a3, $a2, 1
	ori	$a6, $zero, 62
	addi.d	$a4, $a3, 1
	bgeu	$a2, $a6, .LBB11_10
