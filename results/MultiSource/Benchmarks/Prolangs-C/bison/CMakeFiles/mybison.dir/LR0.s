...
.LBB3_53:                               # %vec.epilog.vector.body71
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_53
# %bb.54:                               # %vec.epilog.middle.block79
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a6, .LBB3_16
	b	.LBB3_14
.LBB3_55:                               # %vector.ph
...
# %bb.40:
	move	$a5, $zero
	b	.LBB10_47
.LBB10_41:                              # %vector.main.loop.iter.check104
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 62
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_52
...
.LBB10_53:                              # %vector.body108
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB10_53
# %bb.54:                               # %middle.block115
	beq	$a3, $a5, .LBB10_60
# %bb.55:                               # %vec.epilog.iter.check119
	beqz	$a4, .LBB10_64
.LBB10_56:                              # %vec.epilog.ph121
	move	$a6, $a3
	bstrins.d	$a6, $zero, 2, 0
	alsl.d	$a4, $a6, $s3, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_57:                              # %vec.epilog.vector.body124
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_57
# %bb.58:                               # %vec.epilog.middle.block132
	beq	$a3, $a6, .LBB10_60
	.p2align	4, , 16
.LBB10_59:                              # %.lr.ph.i
                                        # =>This Inner Loop Header: Depth=1
