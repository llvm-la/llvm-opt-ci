...
.LBB6_35:                               # %.loopexit
	...
	addi.d	$sp, $sp, 80
	ret
.LBB6_36:                               # %vector.ph107
	srli.d	$a2, $a2, 2
	addi.d	$a6, $a2, 1
	bstrpick.d	$a2, $a6, 62, 3
	slli.d	$a7, $a2, 3
	slli.d	$a3, $a2, 5
	add.d	$a2, $a0, $a3
	add.d	$a3, $a5, $a3
...
.LBB10_24:
	move	$a2, $s2
	move	$a3, $a4
.LBB10_25:                              # %.lr.ph226.preheader394
	alsl.d	$a0, $a0, $s2, 2
	.p2align	4, , 16
.LBB10_26:                              # %.lr.ph226
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.46:                               # %.lr.ph247.preheader
	...
	move	$s0, $a7
	bnez	$t8, .LBB10_50
# %bb.47:                               # %vector.body354.preheader
                                        #   in Loop: Header=BB10_36 Depth=1
	addi.d	$fp, $a4, 16
	addi.d	$s0, $a7, 16
	move	$s1, $t4
	.p2align	4, , 16
.LBB10_48:                              # %vector.body354
                                        #   Parent Loop BB10_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $fp, -16
	vld	$vr1, $fp, 0
