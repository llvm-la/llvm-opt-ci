...
# %bb.2:
	...
	move	$s1, $zero
	b	.LBB12_12
.LBB12_3:                               # %vector.main.loop.iter.check
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB12_5
# %bb.4:
	move	$a2, $zero
...
# %bb.11:                               # %vec.epilog.middle.block
	...
	beq	$a2, $a0, .LBB12_14
.LBB12_12:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $a1, 1
	.p2align	4, , 16
.LBB12_13:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a2, $a1, 0
	sltu	$a2, $zero, $a2
	add.d	$s1, $s1, $a2
...
# %bb.30:                               #   in Loop: Header=BB12_25 Depth=1
	...
	b	.LBB12_40
	.p2align	4, , 16
.LBB12_31:                              # %vector.main.loop.iter.check51
                                        #   in Loop: Header=BB12_25 Depth=1
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB12_33
...
# %bb.35:                               # %middle.block63
	...
	beq	$a2, $a0, .LBB12_42
# %bb.36:                               # %vec.epilog.iter.check70
                                        #   in Loop: Header=BB12_25 Depth=1
	beqz	$a3, .LBB12_40
.LBB12_37:                              # %vec.epilog.ph72
                                        #   in Loop: Header=BB12_25 Depth=1
	move	$a4, $a2
	bstrpick.d	$a2, $a0, 30, 2
	slli.d	$a2, $a2, 2
	...
	alsl.d	$a4, $a4, $a1, 1
	.p2align	4, , 16
.LBB12_38:                              # %vec.epilog.vector.body75
                                        #   Parent Loop BB12_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	...
	addi.d	$a4, $a4, 8
	bnez	$a3, .LBB12_38
# %bb.39:                               # %vec.epilog.middle.block80
                                        #   in Loop: Header=BB12_25 Depth=1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$s6, $vr0, 0
	beq	$a2, $a0, .LBB12_42
.LBB12_40:                              # %vec.epilog.scalar.ph69.preheader
                                        #   in Loop: Header=BB12_25 Depth=1
	sub.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $a1, 1
	.p2align	4, , 16
.LBB12_41:                              # %vec.epilog.scalar.ph69
                                        #   Parent Loop BB12_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a2, $a1, 0
	sltu	$a2, $zero, $a2
	...
	addi.d	$a1, $a1, 2
	bnez	$a0, .LBB12_41
.LBB12_42:                              # %._crit_edge.i18
                                        #   in Loop: Header=BB12_25 Depth=1
	addi.w	$a0, $s6, 0
	beqz	$a0, .LBB12_24
# %bb.43:                               #   in Loop: Header=BB12_25 Depth=1
	move	$s5, $s3
	move	$s0, $s4
	move	$s4, $s2
	slli.w	$s2, $s6, 1
...
.LBB12_45:                              #   in Loop: Header=BB12_46 Depth=2
	...
	addi.d	$a2, $a2, 2
	beq	$a1, $a4, .LBB12_23
.LBB12_46:                              #   Parent Loop BB12_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a5, $a2, 0
	beqz	$a5, .LBB12_45
...
# %bb.34:
	move	$a2, $zero
	b	.LBB21_109
.LBB21_35:                              # %vector.main.loop.iter.check300
	ori	$a2, $zero, 16
	bgeu	$s1, $a2, .LBB21_73
# %bb.36:
	move	$a2, $zero
.LBB21_37:                              # %vec.epilog.ph348
	move	$a4, $a2
	...
	b	.LBB21_39
	.p2align	4, , 16
.LBB21_38:                              # %pred.store.continue369
                                        #   in Loop: Header=BB21_39 Depth=1
	addi.d	$a4, $a4, 8
	addi.d	$a3, $a3, 16
	beqz	$a4, .LBB21_72
.LBB21_39:                              # %vec.epilog.vector.body351
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vseq.h	$vr1, $vr1, $vr0
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_47
# %bb.40:                               # %pred.store.if354
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, -8
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_48
.LBB21_41:                              # %pred.store.continue357
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_49
.LBB21_42:                              # %pred.store.if358
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, -4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_50
.LBB21_43:                              # %pred.store.continue361
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_51
.LBB21_44:                              # %pred.store.if362
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_52
.LBB21_45:                              # %pred.store.continue365
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_53
.LBB21_46:                              # %pred.store.if366
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, 4
	...
	b	.LBB21_54
	.p2align	4, , 16
.LBB21_47:                              # %pred.store.continue355
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_41
.LBB21_48:                              # %pred.store.if356
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_42
.LBB21_49:                              # %pred.store.continue359
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_43
.LBB21_50:                              # %pred.store.if360
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, -2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_44
.LBB21_51:                              # %pred.store.continue363
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_45
.LBB21_52:                              # %pred.store.if364
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_46
.LBB21_53:                              # %pred.store.continue367
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_38
.LBB21_54:                              # %pred.store.if368
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_38
...
# %bb.57:                               # %.lr.ph150.us.preheader
	...
	ld.d	$a7, $a3, %pc_lo12(actrow)
	andi	$t0, $s0, 12
	bstrpick.d	$a4, $s0, 30, 4
	slli.d	$t1, $a4, 4
	bstrpick.d	$t2, $s0, 30, 2
	slli.d	$t2, $t2, 2
	addi.d	$t3, $a7, 16
	sub.d	$t4, $zero, $t2
	ori	$t5, $zero, 4
...
# %bb.60:                               #   in Loop: Header=BB21_59 Depth=1
	...
	b	.LBB21_70
	.p2align	4, , 16
.LBB21_61:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB21_59 Depth=1
	bgeu	$s1, $t6, .LBB21_63
# %bb.62:                               #   in Loop: Header=BB21_59 Depth=1
	move	$fp, $zero
	move	$t8, $zero
	b	.LBB21_67
	.p2align	4, , 16
...
# %bb.65:                               # %middle.block
	...
	beq	$t1, $s0, .LBB21_58
# %bb.66:                               # %vec.epilog.iter.check
                                        #   in Loop: Header=BB21_59 Depth=1
	move	$fp, $t1
	move	$s2, $t1
	beqz	$t0, .LBB21_70
.LBB21_67:                              # %vec.epilog.ph
                                        #   in Loop: Header=BB21_59 Depth=1
	vori.b	$vr2, $vr0, 0
	...
	alsl.d	$fp, $fp, $a7, 1
	.p2align	4, , 16
.LBB21_68:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB21_59 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s2, $fp, 0
...
# %bb.69:                               # %vec.epilog.middle.block
	...
	move	$s2, $t2
	beq	$t2, $s0, .LBB21_58
.LBB21_70:                              # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB21_59 Depth=1
	alsl.d	$fp, $s2, $a7, 1
	sub.d	$s2, $s0, $s2
	.p2align	4, , 16
.LBB21_71:                              # %vec.epilog.scalar.ph
                                        #   Parent Loop BB21_59 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$s3, $fp, 0
	xor	$s3, $s3, $t7
	...
	bnez	$s2, .LBB21_71
	b	.LBB21_58
.LBB21_72:                              # %vec.epilog.middle.block371
	beq	$a2, $s0, .LBB21_117
	b	.LBB21_109
.LBB21_73:                              # %vector.ph302
	andi	$a3, $s0, 8
	...
	b	.LBB21_75
	.p2align	4, , 16
.LBB21_74:                              # %pred.store.continue339
                                        #   in Loop: Header=BB21_75 Depth=1
	addi.d	$a5, $a5, -16
	addi.d	$a4, $a4, 32
	beqz	$a5, .LBB21_107
.LBB21_75:                              # %vector.body305
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr1, $a4, -16
	xvseq.h	$xr1, $xr1, $xr0
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_91
# %bb.76:                               # %pred.store.if308
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -16
	vpickve2gr.b	$a6, $vr1, 1
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_92
.LBB21_77:                              # %pred.store.continue311
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_93
.LBB21_78:                              # %pred.store.if312
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -12
	vpickve2gr.b	$a6, $vr1, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_94
.LBB21_79:                              # %pred.store.continue315
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 4
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_95
.LBB21_80:                              # %pred.store.if316
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -8
	vpickve2gr.b	$a6, $vr1, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_96
.LBB21_81:                              # %pred.store.continue319
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_97
.LBB21_82:                              # %pred.store.if320
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -4
	vpickve2gr.b	$a6, $vr1, 7
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_98
.LBB21_83:                              # %pred.store.continue323
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 8
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_99
.LBB21_84:                              # %pred.store.if324
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 0
	vpickve2gr.b	$a6, $vr1, 9
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_100
.LBB21_85:                              # %pred.store.continue327
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_101
.LBB21_86:                              # %pred.store.if328
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 4
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_102
.LBB21_87:                              # %pred.store.continue331
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_103
.LBB21_88:                              # %pred.store.if332
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 8
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_104
.LBB21_89:                              # %pred.store.continue335
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_105
.LBB21_90:                              # %pred.store.if336
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 12
	...
	b	.LBB21_106
	.p2align	4, , 16
.LBB21_91:                              # %pred.store.continue309
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 1
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_77
.LBB21_92:                              # %pred.store.if310
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -14
	vpickve2gr.b	$a6, $vr1, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_78
.LBB21_93:                              # %pred.store.continue313
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_79
.LBB21_94:                              # %pred.store.if314
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -10
	vpickve2gr.b	$a6, $vr1, 4
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_80
.LBB21_95:                              # %pred.store.continue317
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_81
.LBB21_96:                              # %pred.store.if318
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -6
	vpickve2gr.b	$a6, $vr1, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_82
.LBB21_97:                              # %pred.store.continue321
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 7
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_83
.LBB21_98:                              # %pred.store.if322
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, -2
	vpickve2gr.b	$a6, $vr1, 8
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_84
.LBB21_99:                              # %pred.store.continue325
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 9
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_85
.LBB21_100:                             # %pred.store.if326
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 2
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_86
.LBB21_101:                             # %pred.store.continue329
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_87
.LBB21_102:                             # %pred.store.if330
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 6
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_88
.LBB21_103:                             # %pred.store.continue333
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_89
.LBB21_104:                             # %pred.store.if334
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 10
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_90
.LBB21_105:                             # %pred.store.continue337
                                        #   in Loop: Header=BB21_75 Depth=1
	vpickve2gr.b	$a6, $vr1, 15
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_74
.LBB21_106:                             # %pred.store.if338
                                        #   in Loop: Header=BB21_75 Depth=1
	st.h	$zero, $a4, 14
	b	.LBB21_74
.LBB21_107:                             # %middle.block341
	beq	$a2, $s0, .LBB21_117
# %bb.108:                              # %vec.epilog.iter.check346
	bnez	$a3, .LBB21_37
.LBB21_109:                             # %vec.epilog.scalar.ph345.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	lu12i.w	$a3, 8
	b	.LBB21_111
...
.LBB21_110:                             #   in Loop: Header=BB21_111 Depth=1
	...
	addi.d	$a1, $a1, 2
	beqz	$a2, .LBB21_117
.LBB21_111:                             # %vec.epilog.scalar.ph345
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a4, $a1, 0
	bne	$a4, $a3, .LBB21_110
# %bb.112:                              #   in Loop: Header=BB21_111 Depth=1
	st.h	$zero, $a1, 0
	b	.LBB21_110
.LBB21_113:                             # %._crit_edge157
	beqz	$a6, .LBB21_31
# %bb.114:                              # %iter.check267
	ld.d	$a1, $a3, %pc_lo12(actrow)
	ori	$a2, $zero, 8
	bgeu	$s1, $a2, .LBB21_118
# %bb.115:
	move	$a2, $zero
	b	.LBB21_176
.LBB21_116:
...
.LBB21_117:                             # %.loopexit
	...
	addi.d	$sp, $sp, 48
	ret
.LBB21_118:                             # %vector.main.loop.iter.check223
	ori	$a2, $zero, 16
	xvreplgr2vr.w	$xr0, $a0
	bgeu	$s1, $a2, .LBB21_139
# %bb.119:
	move	$a2, $zero
.LBB21_120:                             # %vec.epilog.ph271
	move	$a4, $a2
	bstrpick.d	$a2, $s0, 30, 3
	slli.d	$a2, $a2, 3
	alsl.d	$a3, $a4, $a1, 1
	...
	b	.LBB21_122
	.p2align	4, , 16
.LBB21_121:                             # %pred.store.continue294
                                        #   in Loop: Header=BB21_122 Depth=1
	addi.d	$a4, $a4, 8
	addi.d	$a3, $a3, 16
	beqz	$a4, .LBB21_138
.LBB21_122:                             # %vec.epilog.vector.body276
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vext2xv.w.h	$xr1, $xr1
	xvseq.w	$xr1, $xr0, $xr1
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_130
# %bb.123:                              # %pred.store.if279
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, -8
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_131
.LBB21_124:                             # %pred.store.continue282
                                        #   in Loop: Header=BB21_122 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_132
.LBB21_125:                             # %pred.store.if283
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, -4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_133
.LBB21_126:                             # %pred.store.continue286
                                        #   in Loop: Header=BB21_122 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_134
.LBB21_127:                             # %pred.store.if287
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_135
.LBB21_128:                             # %pred.store.continue290
                                        #   in Loop: Header=BB21_122 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_136
.LBB21_129:                             # %pred.store.if291
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, 4
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	...
	b	.LBB21_137
	.p2align	4, , 16
.LBB21_130:                             # %pred.store.continue280
                                        #   in Loop: Header=BB21_122 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_124
.LBB21_131:                             # %pred.store.if281
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_125
.LBB21_132:                             # %pred.store.continue284
                                        #   in Loop: Header=BB21_122 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_126
.LBB21_133:                             # %pred.store.if285
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, -2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_127
.LBB21_134:                             # %pred.store.continue288
                                        #   in Loop: Header=BB21_122 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_128
.LBB21_135:                             # %pred.store.if289
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_129
.LBB21_136:                             # %pred.store.continue292
                                        #   in Loop: Header=BB21_122 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_121
.LBB21_137:                             # %pred.store.if293
                                        #   in Loop: Header=BB21_122 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_121
.LBB21_138:                             # %vec.epilog.middle.block296
	beq	$a2, $s0, .LBB21_174
	b	.LBB21_176
.LBB21_139:                             # %vector.ph225
	andi	$a3, $s0, 8
	slli.d	$a2, $a4, 4
	addi.d	$a4, $a1, 16
	move	$a5, $a2
	b	.LBB21_141
	.p2align	4, , 16
.LBB21_140:                             # %pred.store.continue262
                                        #   in Loop: Header=BB21_141 Depth=1
	addi.d	$a5, $a5, -16
	addi.d	$a4, $a4, 32
	beqz	$a5, .LBB21_173
.LBB21_141:                             # %vector.body230
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr1, $a4, -16
	xvpermi.q	$xr2, $xr1, 1
	vext2xv.w.h	$xr2, $xr2
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_157
# %bb.142:                              # %pred.store.if
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -16
	vpickve2gr.b	$a6, $vr1, 1
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_158
.LBB21_143:                             # %pred.store.continue234
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_159
.LBB21_144:                             # %pred.store.if235
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -12
	vpickve2gr.b	$a6, $vr1, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_160
.LBB21_145:                             # %pred.store.continue238
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 4
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_161
.LBB21_146:                             # %pred.store.if239
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -8
	vpickve2gr.b	$a6, $vr1, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_162
.LBB21_147:                             # %pred.store.continue242
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_163
.LBB21_148:                             # %pred.store.if243
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -4
	vpickve2gr.b	$a6, $vr1, 7
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_164
.LBB21_149:                             # %pred.store.continue246
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 8
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_165
.LBB21_150:                             # %pred.store.if247
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 0
	vpickve2gr.b	$a6, $vr1, 9
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_166
.LBB21_151:                             # %pred.store.continue250
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_167
.LBB21_152:                             # %pred.store.if251
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 4
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_168
.LBB21_153:                             # %pred.store.continue254
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_169
.LBB21_154:                             # %pred.store.if255
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 8
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_170
.LBB21_155:                             # %pred.store.continue258
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_171
.LBB21_156:                             # %pred.store.if259
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 12
	vpickve2gr.b	$a6, $vr1, 15
	andi	$a6, $a6, 1
	...
	b	.LBB21_172
	.p2align	4, , 16
.LBB21_157:                             # %pred.store.continue
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 1
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_143
.LBB21_158:                             # %pred.store.if233
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -14
	vpickve2gr.b	$a6, $vr1, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_144
.LBB21_159:                             # %pred.store.continue236
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_145
.LBB21_160:                             # %pred.store.if237
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -10
	vpickve2gr.b	$a6, $vr1, 4
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_146
.LBB21_161:                             # %pred.store.continue240
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_147
.LBB21_162:                             # %pred.store.if241
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -6
	vpickve2gr.b	$a6, $vr1, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_148
.LBB21_163:                             # %pred.store.continue244
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 7
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_149
.LBB21_164:                             # %pred.store.if245
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, -2
	vpickve2gr.b	$a6, $vr1, 8
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_150
.LBB21_165:                             # %pred.store.continue248
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 9
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_151
.LBB21_166:                             # %pred.store.if249
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 2
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_152
.LBB21_167:                             # %pred.store.continue252
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_153
.LBB21_168:                             # %pred.store.if253
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 6
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_154
.LBB21_169:                             # %pred.store.continue256
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_155
.LBB21_170:                             # %pred.store.if257
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 10
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_156
.LBB21_171:                             # %pred.store.continue260
                                        #   in Loop: Header=BB21_141 Depth=1
	vpickve2gr.b	$a6, $vr1, 15
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_140
.LBB21_172:                             # %pred.store.if261
                                        #   in Loop: Header=BB21_141 Depth=1
	st.h	$zero, $a4, 14
	b	.LBB21_140
.LBB21_173:                             # %middle.block264
	bne	$a2, $s0, .LBB21_175
.LBB21_174:                             # %._crit_edge163
	sub.d	$a0, $zero, $a0
	b	.LBB21_31
.LBB21_175:                             # %vec.epilog.iter.check269
	bnez	$a3, .LBB21_120
.LBB21_176:                             # %vec.epilog.scalar.ph268.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s1, $a2
	addi.w	$a3, $a0, 0
	b	.LBB21_178
	.p2align	4, , 16
.LBB21_177:                             #   in Loop: Header=BB21_178 Depth=1
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 2
	beqz	$a2, .LBB21_174
.LBB21_178:                             # %vec.epilog.scalar.ph268
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a4, $a1, 0
	bne	$a3, $a4, .LBB21_177
# %bb.179:                              #   in Loop: Header=BB21_178 Depth=1
	st.h	$zero, $a1, 0
	b	.LBB21_177
.Lfunc_end21:
...
# %bb.2:
	...
	move	$s4, $zero
	b	.LBB22_12
.LBB22_3:                               # %vector.main.loop.iter.check
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB22_5
# %bb.4:
	move	$a2, $zero
...
.LBB22_9:                               # %vec.epilog.ph
	...
	vrepli.w	$vr1, 1
	.p2align	4, , 16
.LBB22_10:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a4, 0
	vinsgr2vr.d	$vr2, $a5, 0
	vseqi.h	$vr2, $vr2, 0
...
# %bb.11:                               # %vec.epilog.middle.block
	...
	beq	$a2, $a0, .LBB22_14
.LBB22_12:                              # %vec.epilog.scalar.ph.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB22_13:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a2, $a1, 0
	sltu	$a2, $zero, $a2
	add.d	$s4, $s4, $a2
...
# %bb.2:
	...
	move	$a4, $s2
	b	.LBB24_12
.LBB24_3:                               # %vector.main.loop.iter.check
	ori	$a4, $zero, 16
	bgeu	$s1, $a4, .LBB24_5
# %bb.4:
	move	$a5, $zero
...
# %bb.11:                               # %vec.epilog.middle.block
	...
	vpickve2gr.d	$s4, $vr0, 0
	beq	$s1, $a6, .LBB24_14
.LBB24_12:                              # %vec.epilog.scalar.ph.preheader
	alsl.d	$a3, $a4, $a3, 1
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB24_13:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a4, $a3, 0
	xor	$a4, $a1, $a4
	sltu	$a4, $zero, $a4
