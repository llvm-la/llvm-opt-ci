...
# %bb.46:                               # %.preheader253
	...
	bgtz	$a2, .LBB0_48
	b	.LBB0_54
.LBB0_47:                               # %..preheader253_crit_edge
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $s1, %pc_lo12(C)
	ld.w	$a2, $a0, 0
	blez	$a2, .LBB0_54
.LBB0_48:                               # %.lr.ph305.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$a1, $zero
	addi.d	$a3, $a2, 1
	bstrpick.d	$a3, $a3, 31, 0
...
.LBB0_75:                               # %._crit_edge341
	...
	ld.d	$s0, $a0, %got_pc_lo12(maxterm)
	st.w	$s1, $s0, 0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
