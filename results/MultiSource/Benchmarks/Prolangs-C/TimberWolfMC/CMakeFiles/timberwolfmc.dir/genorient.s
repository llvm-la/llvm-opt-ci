...
.LBB0_12:                               #   in Loop: Header=BB0_4 Depth=1
	fst.d	$fa0, $s5, 8
	vstelm.d	$vr3, $s5, 16, 0
	b	.LBB0_17
.LBB0_13:                               #   in Loop: Header=BB0_4 Depth=1
	fst.d	$fa1, $s5, 8
	fld.d	$fa1, $s0, 8
	fst.d	$fa1, $s5, 16
	vstelm.d	$vr3, $s5, 24, 0
	b	.LBB0_19
...
.LBB0_43:                               #   in Loop: Header=BB0_34 Depth=2
	vst	$vr3, $s5, 8
.LBB0_44:                               # %.sink.split1068
                                        #   in Loop: Header=BB0_34 Depth=2
	fld.d	$fa1, $s0, 16
	fld.d	$fa0, $s0, 8
.LBB0_45:                               # %.sink.split1068
                                        #   in Loop: Header=BB0_34 Depth=2
	fst.d	$fa1, $s5, 24
.LBB0_46:                               # %.sink.split1068
                                        #   in Loop: Header=BB0_34 Depth=2
	fst.d	$fa0, $s5, 32
...
# %bb.153:                              # %.lr.ph981
	...
	addi.d	$s0, $a0, 16
	beqz	$a1, .LBB0_158
# %bb.154:                              # %.lr.ph981.split.us.preheader
                                        #   in Loop: Header=BB0_150 Depth=2
...
# %bb.157:                              #   in Loop: Header=BB0_156 Depth=3
	...
	st.w	$a0, $s0, 8
	b	.LBB0_155
.LBB0_158:                              # %.lr.ph981.split.preheader
                                        #   in Loop: Header=BB0_150 Depth=2
	ld.d	$s4, $sp, 136                   # 8-byte Folded Reload
	b	.LBB0_161
	.p2align	4, , 16
...
# %bb.164:                              #   in Loop: Header=BB0_161 Depth=3
	beq	$fp, $s3, .LBB0_159
# %bb.165:                              #   in Loop: Header=BB0_161 Depth=3
	ori	$a1, $zero, 4
	beq	$fp, $a1, .LBB0_159
	b	.LBB0_160
.LBB0_166:                              # %._crit_edge988
	pcaddu18i	$ra, %call36(delHtab)
	jirl	$ra, $ra, 0
	pcalau12i	$a0, %got_pc_hi20(numnets)
	ld.d	$fp, $a0, %got_pc_lo12(numnets)
	ld.w	$a0, $fp, 0
	blez	$a0, .LBB0_172
# %bb.167:                              # %.lr.ph998
