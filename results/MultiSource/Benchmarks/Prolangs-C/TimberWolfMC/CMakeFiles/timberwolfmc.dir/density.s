...
.LBB0_92:                               # %vector.body527
	...
	vpickve2gr.w	$s5, $vr10, 2
	vinsgr2vr.d	$vr5, $s5, 0
	vpickve2gr.w	$s5, $vr10, 3
	vinsgr2vr.d	$vr5, $s5, 1
	xvpermi.q	$xr5, $xr5, 2
	vpickve2gr.w	$s5, $vr10, 0
	vinsgr2vr.d	$vr11, $s5, 0
	vpickve2gr.w	$s5, $vr10, 1
...
# %bb.103:                              #   in Loop: Header=BB0_84 Depth=2
	...
	alsl.d	$s8, $s8, $t8, 3
	.p2align	4, , 16
.LBB0_104:                              #   Parent Loop BB0_80 Depth=1
                                        #     Parent Loop BB0_84 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$s7, $s8, 0
	ld.w	$a0, $s7, 0
...
# %bb.109:                              #   in Loop: Header=BB0_84 Depth=2
	...
	alsl.d	$s2, $s2, $t8, 3
	.p2align	4, , 16
.LBB0_110:                              #   Parent Loop BB0_80 Depth=1
                                        #     Parent Loop BB0_84 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$s1, $s2, 0
	ld.w	$a0, $s1, 0
	addi.d	$s2, $s1, 32
	bne	$a0, $fp, .LBB0_110
# %bb.111:                              #   in Loop: Header=BB0_84 Depth=2
	ld.w	$a0, $s1, 24
	bge	$s0, $a0, .LBB0_82
...
.LBB0_125:                              #   in Loop: Header=BB0_121 Depth=2
	move	$s1, $zero
	b	.LBB0_139
.LBB0_126:                              # %vector.main.loop.iter.check549
                                        #   in Loop: Header=BB0_121 Depth=2
	bgeu	$t8, $t0, .LBB0_128
...
# %bb.131:                              #   in Loop: Header=BB0_121 Depth=2
	ori	$t0, $zero, 16
	b	.LBB0_139
.LBB0_132:                              # %vec.epilog.iter.check566
                                        #   in Loop: Header=BB0_121 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	beqz	$a0, .LBB0_150
# %bb.133:                              #   in Loop: Header=BB0_121 Depth=2
	ori	$t0, $zero, 16
.LBB0_134:                              # %vec.epilog.ph568
                                        #   in Loop: Header=BB0_121 Depth=2
	...
	sub.d	$fp, $fp, $s2
	.p2align	4, , 16
.LBB0_135:                              # %vec.epilog.vector.body571
                                        #   Parent Loop BB0_117 Depth=1
                                        #     Parent Loop BB0_121 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr3, $s1, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$fp, .LBB0_135
# %bb.136:                              # %vec.epilog.middle.block577
                                        #   in Loop: Header=BB0_121 Depth=2
	vhaddw.d.w	$vr2, $vr2, $vr2
	vhaddw.q.d	$vr2, $vr2, $vr2
	vpickve2gr.d	$s1, $vr2, 0
	beq	$s2, $t8, .LBB0_139
.LBB0_137:                              # %.lr.ph385.preheader
                                        #   in Loop: Header=BB0_121 Depth=2
	addi.d	$a0, $t8, 1
	bstrpick.d	$a0, $a0, 31, 0
	alsl.d	$fp, $s0, $t7, 2
...
.LBB0_139:                              # %._crit_edge386
	...
	sub.w	$t8, $s1, $fp
	blez	$s6, .LBB0_145
# %bb.140:                              #   in Loop: Header=BB0_121 Depth=2
	add.d	$s1, $t5, $s5
	alsl.d	$s6, $s6, $t6, 3
	.p2align	4, , 16
.LBB0_141:                              #   Parent Loop BB0_117 Depth=1
                                        #     Parent Loop BB0_121 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$s5, $s6, 0
	ld.w	$a0, $s5, 0
	addi.d	$s6, $s5, 32
	bne	$a0, $s4, .LBB0_141
# %bb.142:                              #   in Loop: Header=BB0_121 Depth=2
	ld.w	$a0, $s5, 24
	bge	$t8, $a0, .LBB0_144
# %bb.143:                              #   in Loop: Header=BB0_121 Depth=2
	st.w	$t8, $s5, 24
	st.w	$s3, $s5, 4
.LBB0_144:                              #   in Loop: Header=BB0_121 Depth=2
	ld.w	$a0, $s1, 12
	st.w	$a2, $s5, 8
	st.w	$a0, $s5, 12
	ld.d	$a0, $s1, 4
...
.LBB0_145:                              #   in Loop: Header=BB0_121 Depth=2
	blez	$s0, .LBB0_120
# %bb.146:                              #   in Loop: Header=BB0_121 Depth=2
	add.d	$s1, $t5, $s2
	sub.d	$s2, $fp, $s3
	alsl.d	$s0, $s0, $t6, 3
	.p2align	4, , 16
.LBB0_147:                              #   Parent Loop BB0_117 Depth=1
                                        #     Parent Loop BB0_121 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$fp, $s0, 0
	ld.w	$a0, $fp, 0
	addi.d	$s0, $fp, 32
	bne	$a0, $t7, .LBB0_147
# %bb.148:                              #   in Loop: Header=BB0_121 Depth=2
	ld.w	$a0, $fp, 24
	bge	$t8, $a0, .LBB0_119
