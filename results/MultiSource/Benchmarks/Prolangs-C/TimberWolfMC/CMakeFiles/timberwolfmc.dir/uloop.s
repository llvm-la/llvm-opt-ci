...
# %bb.24:                               #   in Loop: Header=BB0_13 Depth=1
	...
	ld.d	$ra, $a0, %got_pc_lo12(gridGiven)
	ld.w	$a0, $ra, 0
	beqz	$a0, .LBB0_49
# %bb.25:                               #   in Loop: Header=BB0_13 Depth=1
	...
	addi.d	$a3, $a3, %pc_lo12(newxx)
	vstelm.w	$vr0, $a3, 0, 2
	pcalau12i	$a3, %pc_hi20(newyy)
	addi.d	$a3, $a3, %pc_lo12(newyy)
	vstelm.w	$vr0, $a3, 0, 3
...
# %bb.74:                               #   in Loop: Header=BB0_13 Depth=1
	...
	ld.w	$a3, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(gridX)
	ld.d	$a4, $a0, %got_pc_lo12(gridX)
	pcalau12i	$a0, %got_pc_hi20(gOffsetY)
	ld.d	$a0, $a0, %got_pc_lo12(gOffsetY)
	ld.w	$a5, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(gridY)
	ld.d	$a6, $a0, %got_pc_lo12(gridY)
	ld.w	$a7, $s5, 16
	ld.w	$t0, $s5, 12
	ld.w	$a0, $a1, 12
	ld.w	$a1, $a1, 8
	...
	vbitsel.v	$vr0, $vr0, $vr3, $vr1
	pcalau12i	$a2, %pc_hi20(newxx)
	addi.d	$a2, $a2, %pc_lo12(newxx)
	vstelm.w	$vr0, $a2, 0, 2
	pcalau12i	$a2, %pc_hi20(newyy)
	addi.d	$a2, $a2, %pc_lo12(newyy)
	vstelm.w	$vr0, $a2, 0, 3
...
# %bb.22:                               #   in Loop: Header=BB3_21 Depth=1
	...
	b	.LBB3_32
	.p2align	4, , 16
.LBB3_23:                               # %vector.main.loop.iter.check141
                                        #   in Loop: Header=BB3_21 Depth=1
	bgeu	$a5, $fp, .LBB3_25
# %bb.24:                               #   in Loop: Header=BB3_21 Depth=1
	...
	b	.LBB3_29
	.p2align	4, , 16
.LBB3_25:                               # %vector.ph143
                                        #   in Loop: Header=BB3_21 Depth=1
	add.d	$s0, $s2, $t0
	add.d	$s3, $s1, $t4
	move	$s4, $t0
	.p2align	4, , 16
.LBB3_26:                               # %vector.body146
	...
	addi.d	$s3, $s3, 32
	bnez	$s4, .LBB3_26
# %bb.27:                               # %middle.block152
                                        #   in Loop: Header=BB3_21 Depth=1
	beq	$a6, $t0, .LBB3_20
# %bb.28:                               # %vec.epilog.iter.check158
                                        #   in Loop: Header=BB3_21 Depth=1
	move	$s4, $t0
	move	$s3, $t1
	beqz	$a7, .LBB3_32
.LBB3_29:                               # %vec.epilog.ph160
                                        #   in Loop: Header=BB3_21 Depth=1
	add.d	$s0, $s2, $t2
	add.d	$s2, $t5, $s4
	add.d	$s1, $s1, $t6
	add.d	$s1, $s1, $s4
	.p2align	4, , 16
.LBB3_30:                               # %vec.epilog.vector.body163
                                        #   Parent Loop BB3_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s3, $s1, 0
	...
	addi.d	$s1, $s1, 8
	bnez	$s2, .LBB3_30
# %bb.31:                               # %vec.epilog.middle.block168
                                        #   in Loop: Header=BB3_21 Depth=1
	move	$s3, $t3
	beq	$a6, $t2, .LBB3_20
.LBB3_32:                               # %vec.epilog.scalar.ph157.preheader
                                        #   in Loop: Header=BB3_21 Depth=1
	sub.d	$s1, $a0, $s3
	addi.d	$s0, $s0, 1
	.p2align	4, , 16
.LBB3_33:                               # %vec.epilog.scalar.ph157
                                        #   Parent Loop BB3_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$s2, $s0, 0
	addi.d	$s2, $s2, 1
...
# %bb.22:                               #   in Loop: Header=BB4_21 Depth=1
	...
	b	.LBB4_32
	.p2align	4, , 16
.LBB4_23:                               # %vector.main.loop.iter.check136
                                        #   in Loop: Header=BB4_21 Depth=1
	bgeu	$a5, $fp, .LBB4_25
# %bb.24:                               #   in Loop: Header=BB4_21 Depth=1
	...
	b	.LBB4_29
	.p2align	4, , 16
.LBB4_25:                               # %vector.ph138
                                        #   in Loop: Header=BB4_21 Depth=1
	add.d	$s0, $s2, $t0
	add.d	$s3, $s1, $t4
	move	$s4, $t0
	.p2align	4, , 16
.LBB4_26:                               # %vector.body141
	...
	addi.d	$s3, $s3, 32
	bnez	$s4, .LBB4_26
# %bb.27:                               # %middle.block147
                                        #   in Loop: Header=BB4_21 Depth=1
	beq	$a6, $t0, .LBB4_20
# %bb.28:                               # %vec.epilog.iter.check153
                                        #   in Loop: Header=BB4_21 Depth=1
	move	$s4, $t0
	move	$s3, $t1
	beqz	$a7, .LBB4_32
.LBB4_29:                               # %vec.epilog.ph155
                                        #   in Loop: Header=BB4_21 Depth=1
	add.d	$s0, $s2, $t2
	add.d	$s2, $t5, $s4
	add.d	$s1, $s1, $t6
	add.d	$s1, $s1, $s4
	.p2align	4, , 16
.LBB4_30:                               # %vec.epilog.vector.body158
                                        #   Parent Loop BB4_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s3, $s1, 0
	vinsgr2vr.d	$vr0, $s3, 0
	...
	addi.d	$s1, $s1, 8
	bnez	$s2, .LBB4_30
# %bb.31:                               # %vec.epilog.middle.block163
                                        #   in Loop: Header=BB4_21 Depth=1
	move	$s3, $t3
	beq	$a6, $t2, .LBB4_20
.LBB4_32:                               # %vec.epilog.scalar.ph152.preheader
                                        #   in Loop: Header=BB4_21 Depth=1
	sub.d	$s1, $a0, $s3
	addi.d	$s0, $s0, 1
	.p2align	4, , 16
.LBB4_33:                               # %vec.epilog.scalar.ph152
                                        #   Parent Loop BB4_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$s2, $s0, 0
	addi.d	$s2, $s2, 1
