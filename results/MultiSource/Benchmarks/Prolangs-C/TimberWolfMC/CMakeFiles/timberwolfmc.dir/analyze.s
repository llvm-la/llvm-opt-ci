...
# %bb.46:                               #   in Loop: Header=BB3_3 Depth=1
	move	$a7, $zero
	b	.LBB3_51
.LBB3_47:                               # %vector.ph157
                                        #   in Loop: Header=BB3_3 Depth=1
	andi	$t0, $a6, 48
	bstrpick.d	$a2, $a6, 31, 6
	slli.d	$a7, $a2, 6
	add.d	$a2, $s1, $a7
	add.d	$a3, $a5, $a7
	sub.d	$a4, $a0, $a7
...
.LBB3_48:                               # %vector.body160
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB3_48
# %bb.49:                               # %middle.block169
                                        #   in Loop: Header=BB3_3 Depth=1
	beq	$a7, $a6, .LBB3_12
# %bb.50:                               # %vec.epilog.iter.check176
                                        #   in Loop: Header=BB3_3 Depth=1
	beqz	$t0, .LBB3_11
.LBB3_51:                               # %vec.epilog.ph178
                                        #   in Loop: Header=BB3_3 Depth=1
	...
	add.d	$a1, $s0, $a1
	.p2align	4, , 16
.LBB3_52:                               # %vec.epilog.vector.body181
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vld	$vr1, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB3_52
# %bb.53:                               # %vec.epilog.middle.block188
                                        #   in Loop: Header=BB3_3 Depth=1
	bne	$t0, $a6, .LBB3_11
	b	.LBB3_12
.LBB3_54:
