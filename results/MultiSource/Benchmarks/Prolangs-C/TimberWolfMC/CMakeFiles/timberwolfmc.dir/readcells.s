...
# %bb.50:                               #   in Loop: Header=BB0_4 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_2
# %bb.51:                               # %.peel.next1227.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s5, $zero, 1
	.p2align	4, , 16
.LBB0_52:                               # %.peel.next1227
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
# %bb.104:                              #   in Loop: Header=BB0_4 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_2
# %bb.105:                              # %.peel.next1206.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s5, $zero, 1
	.p2align	4, , 16
.LBB0_106:                              # %.peel.next1206
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
# %bb.140:                              #   in Loop: Header=BB0_4 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_2
# %bb.141:                              # %.peel.next1165.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s5, $zero, 1
	.p2align	4, , 16
.LBB0_142:                              # %.peel.next1165
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
.LBB0_171:                              # %scalar.ph
	...
	addi.d	$a2, $a2, 44
	bnez	$a1, .LBB0_171
.LBB0_172:                              # %.preheader946
                                        #   in Loop: Header=BB0_4 Depth=1
	blez	$a0, .LBB0_111
# %bb.173:                              # %.lr.ph995.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$s5, $zero
	.p2align	4, , 16
.LBB0_174:                              # %.lr.ph995
...
# %bb.179:                              # %.lr.ph988
	...
	addi.d	$a2, $a0, 1
	.p2align	4, , 16
.LBB0_180:                              #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$s0, $a1, -4
	ld.w	$a0, $sp, 1404
	st.w	$a0, $a1, 0
