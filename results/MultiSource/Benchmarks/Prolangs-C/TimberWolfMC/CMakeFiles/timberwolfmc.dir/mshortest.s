...
.LBB0_48:                               # %vector.memcheck804
	...
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
	bgeu	$a6, $t0, .LBB0_50
# %bb.49:                               # %vector.memcheck804
                                        #   in Loop: Header=BB0_30 Depth=1
	addi.d	$a6, $a7, 2
	bltu	$a5, $a6, .LBB0_53
.LBB0_50:                               # %vector.ph816
                                        #   in Loop: Header=BB0_30 Depth=1
...
.LBB0_51:                               # %vector.body819
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB0_51
# %bb.52:                               # %middle.block824
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a6, $a4, .LBB0_55
.LBB0_53:                               # %scalar.ph814.preheader
                                        #   in Loop: Header=BB0_30 Depth=1
	slli.d	$a4, $a4, 1
	slli.d	$a5, $fp, 1
	sub.d	$a4, $a4, $a5
...
.LBB0_122:                              #   in Loop: Header=BB0_80 Depth=3
	move	$a4, $s7
.LBB0_123:                              # %.lr.ph516.preheader845
                                        #   in Loop: Header=BB0_80 Depth=3
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a2, $s3, 1
...
.LBB0_131:                              # %vector.memcheck755
	...
	ld.d	$s7, $sp, 200                   # 8-byte Folded Reload
	bgeu	$a7, $t1, .LBB0_133
# %bb.132:                              # %vector.memcheck755
                                        #   in Loop: Header=BB0_80 Depth=3
	addi.d	$a7, $t0, 2
	bltu	$a6, $a7, .LBB0_136
.LBB0_133:                              # %vector.ph767
                                        #   in Loop: Header=BB0_80 Depth=3
...
.LBB0_134:                              # %vector.body770
	...
	addi.d	$t0, $t0, -16
	bnez	$t1, .LBB0_134
# %bb.135:                              # %middle.block775
                                        #   in Loop: Header=BB0_80 Depth=3
	beq	$a7, $a4, .LBB0_138
	.p2align	4, , 16
.LBB0_136:                              # %scalar.ph765.preheader
                                        #   in Loop: Header=BB0_80 Depth=3
	slli.d	$a4, $a4, 1
	slli.d	$a6, $a5, 1
	sub.d	$a4, $a4, $a6
...
.LBB0_164:                              #   in Loop: Header=BB0_59 Depth=2
	...
	ld.d	$a7, $sp, 200                   # 8-byte Folded Reload
	blt	$a7, $a1, .LBB0_172
.LBB0_165:                              # %.lr.ph543.preheader
                                        #   in Loop: Header=BB0_59 Depth=2
	bstrpick.d	$a1, $s7, 31, 0
	ori	$a2, $zero, 9
	bltu	$a7, $a2, .LBB0_168
# %bb.166:                              # %vector.memcheck729
                                        #   in Loop: Header=BB0_59 Depth=2
	alsl.d	$a3, $a1, $a0, 1
	addi.d	$a2, $a3, 2
	bgeu	$a2, $s6, .LBB0_186
# %bb.167:                              # %vector.memcheck729
                                        #   in Loop: Header=BB0_59 Depth=2
	addi.d	$a4, $a7, -2
	bstrpick.d	$a4, $a4, 31, 0
	slli.d	$a5, $a4, 1
...
.LBB0_168:                              #   in Loop: Header=BB0_59 Depth=2
	move	$a3, $a7
	move	$a4, $s7
.LBB0_169:                              # %.lr.ph543.preheader846
                                        #   in Loop: Header=BB0_59 Depth=2
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a3, $s3, 1
...
.LBB0_170:                              # %.lr.ph543
	...
	addi.d	$a2, $a2, -2
	bnez	$a3, .LBB0_170
.LBB0_171:                              # %._crit_edge544.loopexit
                                        #   in Loop: Header=BB0_59 Depth=2
	move	$s7, $a1
...
.LBB0_207:                              # %vector.body832
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB0_207
# %bb.208:                              # %middle.block837
                                        #   in Loop: Header=BB0_203 Depth=1
	beq	$a4, $a5, .LBB0_202
.LBB0_209:                              # %.lr.ph572.preheader843
                                        #   in Loop: Header=BB0_203 Depth=1
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a0, $a3, $a0, 1
	sub.d	$a2, $a2, $a3
