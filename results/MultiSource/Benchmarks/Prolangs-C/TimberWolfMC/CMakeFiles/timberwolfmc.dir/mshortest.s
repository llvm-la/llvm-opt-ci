...
# %bb.47:                               # %vector.memcheck865
	...
	addi.d	$a7, $a0, 2
	bgeu	$a6, $t0, .LBB0_49
# %bb.48:                               # %vector.memcheck865
                                        #   in Loop: Header=BB0_30 Depth=1
	addi.d	$a6, $t1, 2
	bltu	$a7, $a6, .LBB0_58
.LBB0_49:                               # %vector.main.loop.iter.check876
                                        #   in Loop: Header=BB0_30 Depth=1
	ori	$a6, $zero, 16
	bgeu	$s0, $a6, .LBB0_51
...
.LBB0_52:                               # %vector.body881
	...
	addi.d	$t1, $t1, -32
	bnez	$t2, .LBB0_52
# %bb.53:                               # %middle.block886
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a6, $a5, .LBB0_60
# %bb.54:                               # %vec.epilog.iter.check891
                                        #   in Loop: Header=BB0_30 Depth=1
	beqz	$t0, .LBB0_58
.LBB0_55:                               # %vec.epilog.ph893
                                        #   in Loop: Header=BB0_30 Depth=1
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB0_56:                               # %vec.epilog.vector.body896
                                        #   Parent Loop BB0_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vshuf4i.d	$vr0, $vr0, 1
	...
	addi.d	$t1, $t1, -16
	bnez	$a6, .LBB0_56
# %bb.57:                               # %vec.epilog.middle.block901
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a7, $a5, .LBB0_60
.LBB0_58:                               # %vec.epilog.scalar.ph890.preheader
                                        #   in Loop: Header=BB0_30 Depth=1
	slli.d	$a5, $fp, 1
	sub.d	$a4, $a4, $a5
	add.d	$a1, $a1, $a4
	...
	sub.d	$a3, $a3, $fp
	.p2align	4, , 16
.LBB0_59:                               # %vec.epilog.scalar.ph890
                                        #   Parent Loop BB0_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$a4, $a0, 0
	st.h	$a4, $a1, 0
...
.LBB0_129:                              # %vector.memcheck782
	...
	ld.d	$s7, $sp, 200                   # 8-byte Folded Reload
	bgeu	$t1, $t3, .LBB0_131
# %bb.130:                              # %vector.memcheck782
                                        #   in Loop: Header=BB0_78 Depth=3
	addi.d	$t1, $t2, 2
	bltu	$t0, $t1, .LBB0_145
.LBB0_131:                              # %vector.main.loop.iter.check793
                                        #   in Loop: Header=BB0_78 Depth=3
	ori	$a6, $zero, 16
	bgeu	$a7, $a6, .LBB0_141
# %bb.132:                              #   in Loop: Header=BB0_78 Depth=3
	move	$a7, $zero
.LBB0_133:                              # %vec.epilog.ph810
                                        #   in Loop: Header=BB0_78 Depth=3
	...
	sub.d	$a7, $a7, $t0
	.p2align	4, , 16
.LBB0_134:                              # %vec.epilog.vector.body813
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        #       Parent Loop BB0_78 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$t2, $t2, -16
	bnez	$a7, .LBB0_134
# %bb.135:                              # %vec.epilog.middle.block818
                                        #   in Loop: Header=BB0_78 Depth=3
	bne	$t0, $a5, .LBB0_145
	b	.LBB0_147
.LBB0_136:                              # %vector.main.loop.iter.check833
                                        #   in Loop: Header=BB0_78 Depth=3
...
.LBB0_138:                              # %vec.epilog.ph852
	...
	add.d	$a6, $t1, $a6
	.p2align	4, , 16
.LBB0_139:                              # %vec.epilog.vector.body855
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        #       Parent Loop BB0_78 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a6, $a6, -16
	bnez	$a4, .LBB0_139
# %bb.140:                              # %vec.epilog.middle.block860
                                        #   in Loop: Header=BB0_78 Depth=3
	bne	$a2, $t0, .LBB0_121
	b	.LBB0_123
.LBB0_141:                              # %vector.ph795
                                        #   in Loop: Header=BB0_78 Depth=3
	andi	$t1, $a5, 8
	bstrpick.d	$a6, $a5, 31, 4
	slli.d	$a7, $a6, 4
...
.LBB0_142:                              # %vector.body798
	...
	addi.d	$t2, $t2, -32
	bnez	$t3, .LBB0_142
# %bb.143:                              # %middle.block803
                                        #   in Loop: Header=BB0_78 Depth=3
	beq	$a7, $a5, .LBB0_147
# %bb.144:                              # %vec.epilog.iter.check808
                                        #   in Loop: Header=BB0_78 Depth=3
	bnez	$t1, .LBB0_133
	.p2align	4, , 16
.LBB0_145:                              # %vec.epilog.scalar.ph807.preheader
                                        #   in Loop: Header=BB0_78 Depth=3
	slli.d	$a5, $a6, 1
	sub.d	$a4, $a4, $a5
	add.d	$a1, $a1, $a4
	...
	sub.d	$a3, $a3, $a6
	.p2align	4, , 16
.LBB0_146:                              # %vec.epilog.scalar.ph807
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        #       Parent Loop BB0_78 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB0_152:                              # %vector.body838
	...
	addi.d	$t5, $t5, -32
	bnez	$t4, .LBB0_152
# %bb.153:                              # %middle.block843
                                        #   in Loop: Header=BB0_78 Depth=3
	beq	$a2, $t1, .LBB0_123
# %bb.154:                              # %vec.epilog.iter.check850
                                        #   in Loop: Header=BB0_78 Depth=3
	beqz	$t3, .LBB0_121
	b	.LBB0_138
	.p2align	4, , 16
...
.LBB0_203:                              # %vec.epilog.ph769
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB0_204:                              # %vec.epilog.vector.body772
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t0, 0
	...
	addi.d	$t0, $t0, -16
	bnez	$a6, .LBB0_204
# %bb.205:                              # %vec.epilog.middle.block777
                                        #   in Loop: Header=BB0_64 Depth=2
	bne	$a7, $a2, .LBB0_185
	b	.LBB0_187
.LBB0_206:                              # %vector.ph
...
.LBB0_217:                              # %vector.body755
	...
	addi.d	$t1, $t1, -32
	bnez	$t2, .LBB0_217
# %bb.218:                              # %middle.block760
                                        #   in Loop: Header=BB0_64 Depth=2
	ld.d	$s8, $sp, 160                   # 8-byte Folded Reload
	beq	$a6, $a2, .LBB0_187
# %bb.219:                              # %vec.epilog.iter.check767
                                        #   in Loop: Header=BB0_64 Depth=2
	beqz	$t0, .LBB0_185
	b	.LBB0_203
...
# %bb.236:                              #   in Loop: Header=BB0_235 Depth=1
	...
	st.w	$a2, $a3, 8
	bltz	$a5, .LBB0_234
# %bb.237:                              # %iter.check918
                                        #   in Loop: Header=BB0_235 Depth=1
	addi.d	$a2, $a5, 2
	bstrpick.d	$a2, $a2, 31, 0
	ori	$a4, $zero, 1
	bltu	$a5, $s3, .LBB0_247
# %bb.238:                              # %vector.main.loop.iter.check905
                                        #   in Loop: Header=BB0_235 Depth=1
	addi.d	$a3, $a2, -1
	bgeu	$a5, $s4, .LBB0_243
# %bb.239:                              #   in Loop: Header=BB0_235 Depth=1
	move	$a5, $zero
.LBB0_240:                              # %vec.epilog.ph922
                                        #   in Loop: Header=BB0_235 Depth=1
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB0_241:                              # %vec.epilog.vector.body925
	...
	addi.d	$t0, $t0, 32
	bnez	$a5, .LBB0_241
# %bb.242:                              # %vec.epilog.middle.block929
                                        #   in Loop: Header=BB0_235 Depth=1
	beq	$a3, $a6, .LBB0_234
	b	.LBB0_247
.LBB0_243:                              # %vector.ph907
                                        #   in Loop: Header=BB0_235 Depth=1
	andi	$a6, $a3, 8
	move	$a5, $a3
...
.LBB0_244:                              # %vector.body910
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB0_244
# %bb.245:                              # %middle.block915
                                        #   in Loop: Header=BB0_235 Depth=1
	beq	$a3, $a5, .LBB0_234
# %bb.246:                              # %vec.epilog.iter.check920
                                        #   in Loop: Header=BB0_235 Depth=1
	bnez	$a6, .LBB0_240
	.p2align	4, , 16
