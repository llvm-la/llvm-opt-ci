...
.LBB0_24:                               # %vector.body198
	...
	addi.d	$t0, $t0, 160
	bnez	$t1, .LBB0_24
# %bb.25:                               # %middle.block205
	beq	$a5, $a6, .LBB0_33
.LBB0_26:                               # %scalar.ph189.preheader
	sub.d	$a4, $a4, $a2
	slli.d	$a5, $a2, 4
	alsl.d	$a5, $a2, $a5, 2
	add.d	$a3, $a5, $a3
...
.LBB0_33:
	...
	b	.LBB0_36
.LBB0_34:                               # %scalar.ph174.preheader
	sub.d	$a4, $a4, $a2
	slli.d	$a5, $a2, 4
	alsl.d	$a5, $a2, $a5, 2
	add.d	$a3, $a5, $a3
...
.LBB1_24:                               # %vector.body200
	...
	addi.d	$a6, $a6, 160
	bnez	$a7, .LBB1_24
# %bb.25:                               # %middle.block207
	beq	$a4, $a5, .LBB1_33
.LBB1_26:                               # %scalar.ph191.preheader
	sub.d	$a3, $a3, $a1
	slli.d	$a4, $a1, 4
	alsl.d	$a4, $a1, $a4, 2
	add.d	$a2, $a4, $a2
...
.LBB1_33:
	...
	xvpickve.d	$xr2, $xr8, 3
	b	.LBB1_36
.LBB1_34:                               # %scalar.ph176.preheader
	sub.d	$a3, $a3, $a1
	slli.d	$a4, $a1, 4
	alsl.d	$a4, $a1, $a4, 2
	add.d	$a2, $a4, $a2
