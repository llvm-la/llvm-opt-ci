...
.LBB1_28:                               # %.lr.ph.i
	...
	addi.d	$a7, $a7, -2
	bltu	$s2, $a6, .LBB1_28
.LBB1_29:                               # %.loopexit60.i.loopexit
                                        #   in Loop: Header=BB1_5 Depth=1
	ld.hu	$a7, $a5, 0
	ld.hu	$t0, $a2, 0
.LBB1_30:                               # %.loopexit60.i
                                        #   in Loop: Header=BB1_5 Depth=1
	add.d	$a4, $a7, $t0
	addi.d	$a4, $a4, -1
	st.h	$a4, $a2, 0
...
.LBB1_38:                               # %.lr.ph71.i
	...
	addi.d	$a6, $a6, 2
	blt	$a4, $a7, .LBB1_38
# %bb.39:                               # %.loopexit60.i42.loopexit
                                        #   in Loop: Header=BB1_5 Depth=1
	ld.hu	$t0, $a2, 0
	bstrpick.d	$a7, $a7, 15, 0
.LBB1_40:                               # %.loopexit60.i42
                                        #   in Loop: Header=BB1_5 Depth=1
	add.d	$a4, $a7, $t0
	addi.d	$a4, $a4, -1
	st.h	$a4, $a2, 0
	...
	b	.LBB1_2
	.p2align	4, , 16
.LBB1_41:                               # %.loopexit.i55
                                        #   in Loop: Header=BB1_42 Depth=2
	ext.w.h	$a3, $a4
	bge	$a2, $a3, .LBB1_2
.LBB1_42:                               # %.preheader.i45
                                        #   Parent Loop BB1_5 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_44 Depth 3
	move	$a5, $a2
...
# %bb.24:                               # %middle.block
	beq	$t0, $t1, .LBB2_32
	b	.LBB2_7
.LBB2_25:                               # %vector.memcheck125
	addi.d	$a7, $a0, 2
	alsl.d	$t0, $a6, $a5, 1
	addi.d	$t0, $t0, 2
	bgeu	$a7, $t0, .LBB2_27
# %bb.26:                               # %vector.memcheck125
	alsl.d	$t1, $a6, $a0, 1
	addi.d	$t2, $a5, 4
	move	$t0, $a6
	bltu	$t2, $t1, .LBB2_30
.LBB2_27:                               # %vector.ph135
	addi.d	$t1, $a6, -1
	slli.d	$t3, $a6, 1
	move	$t2, $t1
...
.LBB2_28:                               # %vector.body138
	...
	addi.d	$t3, $t3, -16
	bnez	$t4, .LBB2_28
# %bb.29:                               # %middle.block143
	beq	$t1, $t2, .LBB2_32
.LBB2_30:                               # %.lr.ph79.preheader148
	alsl.d	$a0, $a3, $a0, 1
	sub.d	$a3, $a6, $a3
	slli.d	$a6, $t0, 1
	.p2align	4, , 16
