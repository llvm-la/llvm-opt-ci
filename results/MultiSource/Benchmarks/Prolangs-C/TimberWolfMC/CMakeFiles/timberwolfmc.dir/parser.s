...
.LBB0_112:                              # %.lr.ph659
	...
	addi.d	$s2, $s2, 8
	blt	$s0, $a0, .LBB0_112
.LBB0_113:                              # %._crit_edge660
	slli.d	$a0, $a1, 3
	addi.d	$a0, $a0, 8
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.w	$a1, $fp, 0
	pcalau12i	$a2, %pc_hi20(padspace)
	st.d	$a0, $a2, %pc_lo12(padspace)
	blez	$a1, .LBB0_115
# %bb.114:                              # %.lr.ph665.preheader
	addi.d	$a0, $a0, 8
	slli.d	$a2, $a1, 3
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_115:                              # %._crit_edge666
	ori	$a0, $zero, 1
	ori	$a1, $zero, 16
