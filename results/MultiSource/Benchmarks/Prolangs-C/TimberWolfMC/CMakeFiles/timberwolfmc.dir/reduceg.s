...
# %bb.51:                               #   in Loop: Header=BB0_40 Depth=2
	...
	b	.LBB0_38
.LBB0_52:                               # %vec.epilog.iter.check1133
                                        #   in Loop: Header=BB0_40 Depth=2
	ld.d	$fp, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 80                    # 8-byte Folded Reload
...
.LBB0_53:                               # %vec.epilog.ph1135
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB0_54:                               # %vec.epilog.vector.body1138
                                        #   Parent Loop BB0_36 Depth=1
                                        #     Parent Loop BB0_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr1, $a5, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_54
# %bb.55:                               # %vec.epilog.middle.block1143
                                        #   in Loop: Header=BB0_40 Depth=2
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a4, $s2, .LBB0_38
.LBB0_56:                               # %vec.epilog.scalar.ph1132.preheader
                                        #   in Loop: Header=BB0_40 Depth=2
	addi.d	$a3, $s2, 1
	bstrpick.d	$a3, $a3, 31, 0
	alsl.d	$a1, $a2, $a1, 2
	sub.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB0_57:                               # %vec.epilog.scalar.ph1132
                                        #   Parent Loop BB0_36 Depth=1
                                        #     Parent Loop BB0_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a3, $a1, 0
