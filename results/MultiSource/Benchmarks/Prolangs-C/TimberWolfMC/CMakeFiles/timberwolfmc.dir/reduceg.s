...
# %bb.41:                               # %middle.block1116
	...
	vpickve2gr.d	$a4, $vr0, 0
	beq	$a3, $s2, .LBB0_31
.LBB0_42:                               # %scalar.ph1103.preheader
                                        #   in Loop: Header=BB0_33 Depth=2
	addi.d	$a3, $s2, 1
	bstrpick.d	$a3, $a3, 31, 0
	alsl.d	$a1, $a2, $a1, 2
...
# %bb.191:                              #   in Loop: Header=BB0_190 Depth=4
	...
	bge	$t5, $a4, .LBB0_190
	b	.LBB0_169
.LBB0_192:                              #   in Loop: Header=BB0_170 Depth=3
	ld.w	$t5, $s6, 4
	mul.d	$t5, $t5, $a7
	add.d	$s4, $t4, $t5
	ld.w	$s5, $s4, 4
...
# %bb.233:                              #   in Loop: Header=BB0_232 Depth=4
	...
	bge	$t5, $a4, .LBB0_232
	b	.LBB0_211
.LBB0_234:                              #   in Loop: Header=BB0_212 Depth=3
	ld.w	$t5, $s6, 4
	mul.d	$s4, $t5, $a7
	ldx.w	$s5, $t4, $s4
	ld.w	$t5, $s6, 0
