...
.LBB0_196:                              # %vector.body
                                        ...
                                        # =>        This Inner Loop Header: Depth=5
	xvldx	$xr0, $t1, $s1
	xvstelm.w	$xr0, $s0, -64, 0
	xvstelm.w	$xr0, $s0, -48, 1
	xvstelm.w	$xr0, $s0, -32, 2
	xvstelm.w	$xr0, $s0, -16, 3
	xvstelm.w	$xr0, $s0, 0, 4
	xvstelm.w	$xr0, $s0, 16, 5
	xvstelm.w	$xr0, $s0, 32, 6
	xvstelm.w	$xr0, $s0, 48, 7
	st.w	$fp, $s0, -60
	st.w	$fp, $s0, -44
	st.w	$fp, $s0, -28
	st.w	$fp, $s0, -12
