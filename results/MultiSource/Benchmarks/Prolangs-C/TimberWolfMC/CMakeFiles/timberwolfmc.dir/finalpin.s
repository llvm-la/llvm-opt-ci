...
.LBB0_29:                               #   in Loop: Header=BB0_16 Depth=2
	...
	ld.d	$s4, $a0, %got_pc_lo12(pinSpacing)
	ld.w	$a0, $s4, 0
	div.w	$a1, $s0, $a0
	mul.d	$a2, $a1, $a0
	sub.w	$a2, $s0, $a2
	...
	maskeqz	$a0, $a3, $a0
	or	$a0, $a0, $a1
	pcalau12i	$s3, %pc_hi20(nPinLocs)
	st.w	$a0, $s3, %pc_lo12(nPinLocs)
	slli.d	$a0, $a0, 4
	addi.d	$a0, $a0, 16
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$s3, $sp, 112                   # 8-byte Folded Spill
	ld.w	$s5, $s3, %pc_lo12(nPinLocs)
	move	$s3, $a0
...
.LBB0_35:                               # %vector.body1446
	...
	vstelm.w	$vr4, $t0, -12, 0
	vstelm.w	$vr4, $t0, 4, 1
	vstelm.w	$vr4, $t0, 20, 2
	vstelm.w	$vr4, $t0, 36, 3
	vaddi.wu	$vr1, $vr1, 4
	addi.d	$t1, $t1, -4
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB0_35
...
.LBB0_44:                               # %vector.body1429
	...
	vreplgr2vr.w	$vr6, $t2
	vbitsel.v	$vr4, $vr5, $vr4, $vr6
	vstelm.w	$vr4, $t0, -16, 0
	vstelm.w	$vr4, $t0, 0, 1
	vstelm.w	$vr4, $t0, 16, 2
	vstelm.w	$vr4, $t0, 32, 3
	vaddi.wu	$vr1, $vr1, 4
	addi.d	$t1, $t1, -4
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB0_44
...
.LBB0_106:                              #   in Loop: Header=BB0_16 Depth=2
	st.w	$a3, $a4, 0
	ld.d	$t2, $sp, 112                   # 8-byte Folded Reload
	ld.w	$a3, $t2, %pc_lo12(nPinLocs)
	alsl.d	$a3, $a3, $a1, 4
	st.w	$s7, $a3, 4
	beq	$a2, $s7, .LBB0_122
# %bb.107:                              # %.lr.ph821.preheader
                                        #   in Loop: Header=BB0_16 Depth=2
	ld.w	$a7, $t2, %pc_lo12(nPinLocs)
	addi.d	$a3, $a2, -2
	sltu	$a4, $a2, $a3
	masknez	$a3, $a3, $a4
	ori	$a4, $zero, 3
...
.LBB0_130:                              # %.peel.next
	...
	ori	$a0, $zero, 3
	bne	$s1, $a0, .LBB0_132
# %bb.131:                              #   in Loop: Header=BB0_125 Depth=3
	ld.d	$s3, $sp, 128                   # 8-byte Folded Reload
	b	.LBB0_136
.LBB0_132:                              # %.peel.next.split
                                        #   in Loop: Header=BB0_125 Depth=3
	ori	$s6, $zero, 2
	move	$s1, $s2
	ld.d	$s3, $sp, 128                   # 8-byte Folded Reload
...
.LBB0_136:                              # %._crit_edge832.loopexit.peel.begin
                                        #   in Loop: Header=BB0_125 Depth=3
	bne	$s6, $s0, .LBB0_138
# %bb.137:                              #   in Loop: Header=BB0_125 Depth=3
	ld.w	$a0, $fp, 4
	pcaddu18i	$ra, %call36(findLoc)
	jirl	$ra, $ra, 0
	move	$s8, $a0
...
.LBB0_145:                              # %._crit_edge844
	...
	ld.w	$s3, $sp, 136
	ld.w	$a0, $t2, %pc_lo12(nPinLocs)
	add.w	$s0, $s3, $fp
	bge	$a0, $s0, .LBB0_147
# %bb.146:                              #   in Loop: Header=BB0_16 Depth=2
	sub.w	$s3, $a0, $fp
	pcalau12i	$a0, %got_pc_hi20(fpo)
	ld.d	$fp, $a0, %got_pc_lo12(fpo)
	ld.d	$a3, $fp, 0
	...
	pcaddu18i	$ra, %call36(fprintf)
	jirl	$ra, $ra, 0
.LBB0_147:                              #   in Loop: Header=BB0_16 Depth=2
	ori	$s4, $zero, 8
	blez	$s3, .LBB0_150
...
.LBB0_177:                              #   in Loop: Header=BB0_169 Depth=4
	move	$t6, $s0
.LBB0_178:                              # %.lr.ph885.preheader1466
                                        #   in Loop: Header=BB0_169 Depth=4
	slli.d	$t7, $t7, 2
	alsl.d	$t8, $t6, $a7, 4
	.p2align	4, , 16
...
.LBB0_191:                              #   in Loop: Header=BB0_169 Depth=4
	move	$fp, $t7
	move	$t6, $s1
.LBB0_192:                              # %.lr.ph881.preheader1467
                                        #   in Loop: Header=BB0_169 Depth=4
	slli.d	$t7, $fp, 2
	alsl.d	$t8, $t6, $a7, 4
	.p2align	4, , 16
...
.LBB0_242:                              # %.loopexit720
	...
	bgtz	$a2, .LBB0_210
	b	.LBB0_244
.LBB0_243:                              #   in Loop: Header=BB0_16 Depth=2
	addi.d	$fp, $sp, 136
	ori	$s0, $zero, 2
	ori	$s2, $zero, 44
	.p2align	4, , 16
...
# %bb.266:                              #   in Loop: Header=BB0_265 Depth=3
	...
	b	.LBB0_264
	.p2align	4, , 16
.LBB0_267:                              #   in Loop: Header=BB0_16 Depth=2
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
	addi.d	$s3, $t3, 1
	b	.LBB0_14
.LBB0_268:                              # %vector.ph1409
                                        #   in Loop: Header=BB0_16 Depth=2
	move	$a5, $a4
	bstrins.d	$a5, $zero, 1, 0
	sub.d	$a3, $a6, $a5
...
.LBB0_269:                              # %vector.body1412
	...
	addi.d	$a7, $a7, 16
	bnez	$t0, .LBB0_269
# %bb.270:                              # %middle.block1416
                                        #   in Loop: Header=BB0_16 Depth=2
	beq	$a4, $a5, .LBB0_84
.LBB0_271:                              # %.lr.ph812.preheader1481
                                        #   in Loop: Header=BB0_16 Depth=2
	alsl.d	$a0, $a3, $a0, 4
	addi.d	$a0, $a0, -16
	sub.d	$a1, $a1, $a2
