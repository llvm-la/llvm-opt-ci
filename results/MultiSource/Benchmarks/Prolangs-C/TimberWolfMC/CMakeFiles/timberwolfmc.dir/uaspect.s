...
.LBB0_20:                               # %.lr.ph761
	...
	ld.d	$a0, $a0, 0
	bnez	$a0, .LBB0_20
.LBB0_21:                               # %.preheader745
	st.d	$s1, $sp, 40                    # 8-byte Folded Spill
	ld.w	$a0, $fp, 128
	blez	$a0, .LBB0_28
# %bb.22:                               # %.lr.ph764.preheader
	ori	$a2, $zero, 8
	ori	$a1, $zero, 1
	bltu	$a0, $a2, .LBB0_26
# %bb.23:                               # %vector.ph
...
# %bb.82:                               # %.lr.ph788
	...
	move	$s7, $zero
	beqz	$a3, .LBB0_87
# %bb.83:                               # %.lr.ph788.split.us.preheader
                                        #   in Loop: Header=BB0_71 Depth=1
	or	$s8, $a0, $a2
	b	.LBB0_85
	.p2align	4, , 16
...
# %bb.86:                               #   in Loop: Header=BB0_85 Depth=2
	...
	st.w	$a0, $s4, 0
	b	.LBB0_84
.LBB0_87:                               # %.lr.ph788.split.preheader
                                        #   in Loop: Header=BB0_71 Depth=1
	or	$s8, $a1, $a2
	b	.LBB0_90
	.p2align	4, , 16
...
# %bb.109:                              # %.lr.ph797
                                        #   in Loop: Header=BB0_98 Depth=1
	beqz	$a2, .LBB0_114
# %bb.110:                              # %.lr.ph797.split.us.preheader
                                        #   in Loop: Header=BB0_98 Depth=1
	addi.d	$a1, $a1, -2
	sltui	$a1, $a1, 1
...
# %bb.113:                              #   in Loop: Header=BB0_112 Depth=2
	...
	st.w	$a0, $s2, 0
	b	.LBB0_111
.LBB0_114:                              # %.lr.ph797.split
                                        #   in Loop: Header=BB0_98 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	bnez	$a0, .LBB0_119
# %bb.115:                              # %.lr.ph797.split.split.us.preheader
                                        #   in Loop: Header=BB0_98 Depth=1
	ori	$s8, $zero, 1
	b	.LBB0_117
	.p2align	4, , 16
.LBB0_116:                              #   in Loop: Header=BB0_117 Depth=2
	...
	addi.w	$s8, $s8, 1
	bge	$s8, $a0, .LBB0_97
.LBB0_117:                              # %.lr.ph797.split.split.us
                                        #   Parent Loop BB0_98 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s7, $s7, 0
	ld.d	$s4, $s4, 0
...
# %bb.118:                              #   in Loop: Header=BB0_117 Depth=2
	...
	st.w	$a0, $s1, 0
	b	.LBB0_116
.LBB0_119:                              # %.lr.ph797.split.split.preheader
                                        #   in Loop: Header=BB0_98 Depth=1
	addi.d	$a0, $a1, -2
	sltui	$a0, $a0, 1
	or	$s3, $s3, $a0
...
# %bb.131:                              # %.lr.ph809
	...
	andi	$a1, $s0, 6
	beqz	$a2, .LBB0_136
# %bb.132:                              # %.lr.ph809.split.us.preheader
                                        #   in Loop: Header=BB0_129 Depth=1
	move	$s3, $zero
	addi.d	$a1, $a1, -2
	sltui	$a1, $a1, 1
...
# %bb.135:                              #   in Loop: Header=BB0_134 Depth=2
	...
	st.w	$a0, $s2, 0
	b	.LBB0_133
.LBB0_136:                              # %.lr.ph809.split
                                        #   in Loop: Header=BB0_129 Depth=1
	ld.d	$a2, $sp, 136                   # 8-byte Folded Reload
	bnez	$a2, .LBB0_141
# %bb.137:                              # %.lr.ph809.split.split.us.preheader
                                        #   in Loop: Header=BB0_129 Depth=1
	move	$s3, $zero
	addi.d	$s1, $a0, 16
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
...
.LBB0_138:                              #   in Loop: Header=BB0_139 Depth=2
	...
	addi.d	$s1, $s1, 16
	bge	$s3, $a0, .LBB0_128
.LBB0_139:                              # %.lr.ph809.split.split.us
                                        #   Parent Loop BB0_129 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s8, -4
	st.d	$a0, $s1, 0
...
# %bb.140:                              #   in Loop: Header=BB0_139 Depth=2
	...
	st.w	$a0, $s1, 0
	b	.LBB0_138
.LBB0_141:                              # %.lr.ph809.split.split.preheader
                                        #   in Loop: Header=BB0_129 Depth=1
	move	$s8, $zero
	addi.d	$a1, $a1, -2
	sltui	$a1, $a1, 1
	...
	b	.LBB0_144
	.p2align	4, , 16
.LBB0_142:                              #   in Loop: Header=BB0_144 Depth=2
	ld.w	$a0, $s1, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s1, 0
...
.LBB0_154:                              #   in Loop: Header=BB0_152 Depth=1
	...
	st.w	$a0, $s3, 0
	bnez	$s4, .LBB0_151
.LBB0_155:                              #   in Loop: Header=BB0_152 Depth=1
	ld.w	$a0, $s2, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s2, 0
	b	.LBB0_151
