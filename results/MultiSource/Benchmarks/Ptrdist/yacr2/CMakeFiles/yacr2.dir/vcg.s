...
.LBB7_6:                                # %.preheader63
	beqz	$a0, .LBB7_16
# %bb.7:                                # %.lr.ph71.preheader.preheader
	move	$s2, $zero
	ori	$s4, $zero, 2
	.p2align	4, , 16
.LBB7_8:                                # %.lr.ph71.preheader
                                        # =>This Loop Header: Depth=1
...
.LBB11_7:                               # %vector.body198
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB11_7
# %bb.8:                                # %middle.block201
                                        #   in Loop: Header=BB11_3 Depth=1
	beq	$a4, $a6, .LBB11_11
.LBB11_9:                               # %scalar.ph193.preheader
                                        #   in Loop: Header=BB11_3 Depth=1
	sub.d	$a4, $a4, $a6
	slli.d	$a6, $a6, 5
	add.d	$a5, $a5, $a6
...
.LBB11_38:                              # %.lr.ph116
	...
	ld.d	$a2, $a2, 32
	.p2align	4, , 16
.LBB11_39:                              #   Parent Loop BB11_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a2, 0
	beq	$a3, $s1, .LBB11_42
...
.LBB11_41:                              # %.loopexit86
	...
	b	.LBB11_45
	.p2align	4, , 16
.LBB11_42:                              #   in Loop: Header=BB11_32 Depth=1
	st.d	$zero, $a2, 24
	ld.d	$a1, $s0, 0
	beqz	$a1, .LBB11_45
.LBB11_43:                              # %.lr.ph.i79.preheader
                                        #   in Loop: Header=BB11_32 Depth=1
	addi.d	$a1, $a0, 112
	ori	$a2, $zero, 1
	.p2align	4, , 16
...
# %bb.46:                               # %.lr.ph119
	...
	ori	$a2, $zero, 1
	.p2align	4, , 16
.LBB11_47:                              #   Parent Loop BB11_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a1, 0
	bgeu	$a3, $s6, .LBB11_49
...
.LBB11_55:                              # %.lr.ph125
	...
	ld.d	$a1, $a1, 32
	.p2align	4, , 16
.LBB11_56:                              #   Parent Loop BB11_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a1, 0
	beq	$a2, $s1, .LBB11_58
# %bb.57:                               #   in Loop: Header=BB11_56 Depth=2
	...
	bnez	$a0, .LBB11_56
	b	.LBB11_31
.LBB11_58:                              #   in Loop: Header=BB11_32 Depth=1
	ori	$a0, $zero, 1
	st.d	$a0, $a1, 24
	b	.LBB11_31
.LBB11_59:
	move	$fp, $zero
.LBB11_60:                              # %._crit_edge129
...
# %bb.10:                               # %.lr.ph
	...
	ld.d	$t1, $t1, 0
	b	.LBB12_15
.LBB12_11:                              #   in Loop: Header=BB12_15 Depth=3
	beqz	$t3, .LBB12_29
.LBB12_12:                              #   in Loop: Header=BB12_15 Depth=3
	ori	$t2, $zero, 5
.LBB12_13:                              #   in Loop: Header=BB12_15 Depth=3
	sltu	$t3, $t2, $a7
	masknez	$a7, $a7, $t3
	maskeqz	$t2, $t2, $t3
	or	$a7, $t2, $a7
...
# %bb.19:                               #   in Loop: Header=BB12_15 Depth=3
	...
	bnez	$t3, .LBB12_13
	b	.LBB12_12
.LBB12_20:                              #   in Loop: Header=BB12_15 Depth=3
	bne	$t2, $a0, .LBB12_23
# %bb.21:                               #   in Loop: Header=BB12_15 Depth=3
	ld.d	$t2, $a4, 0
	beqz	$t2, .LBB12_28
# %bb.22:                               #   in Loop: Header=BB12_15 Depth=3
	ld.d	$t3, $a5, 0
	ori	$t2, $zero, 6
	bnez	$t3, .LBB12_13
	b	.LBB12_12
...
# %bb.24:                               #   in Loop: Header=BB12_15 Depth=3
	ori	$t2, $zero, 3
	beqz	$t4, .LBB12_31
# %bb.25:                               #   in Loop: Header=BB12_15 Depth=3
	addi.d	$t3, $t3, 8
	ldx.d	$t4, $a1, $t3
	ldx.d	$t3, $a2, $t3
	beqz	$t4, .LBB12_32
.LBB12_26:                              #   in Loop: Header=BB12_15 Depth=3
	beqz	$t3, .LBB12_33
# %bb.27:                               #   in Loop: Header=BB12_15 Depth=3
	addi.d	$t2, $t2, 3
	b	.LBB12_13
.LBB12_28:                              #   in Loop: Header=BB12_15 Depth=3
	ld.d	$t2, $a5, 0
	bnez	$t2, .LBB12_12
.LBB12_29:                              #   in Loop: Header=BB12_15 Depth=3
	ori	$t2, $zero, 3
	b	.LBB12_13
.LBB12_30:                              #   in Loop: Header=BB12_15 Depth=3
	beqz	$t4, .LBB12_34
.LBB12_31:                              #   in Loop: Header=BB12_15 Depth=3
	ori	$t2, $zero, 2
	addi.d	$t3, $t3, 8
	ldx.d	$t4, $a1, $t3
	ldx.d	$t3, $a2, $t3
	bnez	$t4, .LBB12_26
.LBB12_32:                              #   in Loop: Header=BB12_15 Depth=3
	beqz	$t3, .LBB12_13
.LBB12_33:                              #   in Loop: Header=BB12_15 Depth=3
	addi.d	$t2, $t2, 2
	b	.LBB12_13
...
# %bb.37:                               # %.lr.ph122
	...
	ld.d	$a2, $a2, 32
	.p2align	4, , 16
.LBB12_38:                              #   Parent Loop BB12_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a2, 0
	beq	$a3, $a1, .LBB12_2
...
# %bb.11:                               #   in Loop: Header=BB17_5 Depth=1
	beqz	$a0, .LBB17_14
# %bb.12:                               # %.lr.ph.i.i35.preheader
                                        #   in Loop: Header=BB17_5 Depth=1
	ori	$a0, $zero, 1
	move	$a1, $s7
	.p2align	4, , 16
.LBB17_13:                              # %.lr.ph.i.i35
                                        #   Parent Loop BB17_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a1, -32
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bgeu	$a2, $a0, .LBB17_13
.LBB17_14:                              # %ExistPathAboveVCG.exit38
                                        #   in Loop: Header=BB17_5 Depth=1
	move	$a0, $s2
	move	$a1, $s1
	pcaddu18i	$ra, %call36(DFSAboveVCG)
...
.LBB17_15:                              #   in Loop: Header=BB17_5 Depth=1
	beqz	$a0, .LBB17_18
# %bb.16:                               # %.lr.ph.i.i40.preheader
                                        #   in Loop: Header=BB17_5 Depth=1
	ori	$a0, $zero, 1
	move	$a1, $s7
	.p2align	4, , 16
.LBB17_17:                              # %.lr.ph.i.i40
                                        #   Parent Loop BB17_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a1, -32
	vst	$vr0, $a1, 0
...
# %bb.19:                               #   in Loop: Header=BB17_5 Depth=1
	...
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	beqz	$a0, .LBB17_22
# %bb.20:                               # %.lr.ph.i.i45.preheader
                                        #   in Loop: Header=BB17_5 Depth=1
	ori	$a0, $zero, 1
	move	$a1, $s7
	.p2align	4, , 16
.LBB17_21:                              # %.lr.ph.i.i45
                                        #   Parent Loop BB17_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a1, -32
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bgeu	$a2, $a0, .LBB17_21
.LBB17_22:                              # %ExistPathAboveVCG.exit48
                                        #   in Loop: Header=BB17_5 Depth=1
	move	$a0, $s2
	move	$a1, $s1
	pcaddu18i	$ra, %call36(DFSAboveVCG)
