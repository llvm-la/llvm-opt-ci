...
.Lfunc_end7:
	.size	bc_compare, .Lfunc_end7-bc_compare
                                        # -- End function
	.p2align	2                               # -- Begin function _do_compare
...
.Lfunc_end11:
	.size	bc_add, .Lfunc_end11-bc_add
                                        # -- End function
	.p2align	2                               # -- Begin function _do_add
...
.Lfunc_end12:
	.size	_do_add, .Lfunc_end12-_do_add
                                        # -- End function
	.p2align	2                               # -- Begin function _do_sub
...
.LBB15_8:                               # %vector.body
	...
	vslli.d	$vr4, $vr4, 56
	vsrai.d	$vr4, $vr4, 56
	vinsgr2vr.h	$vr6, $a0, 0
	ld.h	$a0, $s8, 0
	vshuf.b	$vr3, $vr0, $vr5, $vr3
	vslli.d	$vr3, $vr3, 56
	vsrai.d	$vr3, $vr3, 56
	vinsgr2vr.h	$vr5, $a0, 0
	vextrins.b	$vr6, $vr6, 129
	vslli.d	$vr6, $vr6, 56
	vsrai.d	$vr6, $vr6, 56
	vextrins.b	$vr5, $vr5, 129
	vslli.d	$vr5, $vr5, 56
	vsrai.d	$vr5, $vr5, 56
	vmadd.d	$vr1, $vr6, $vr4
	vmadd.d	$vr2, $vr5, $vr3
...
# %bb.53:
	move	$a0, $zero
	b	.LBB15_58
.LBB15_54:                              # %vector.ph226
	andi	$a6, $a2, 24
	bstrpick.d	$a0, $a2, 30, 5
	slli.d	$a0, $a0, 5
	add.d	$a3, $a1, $a0
	add.d	$a4, $s2, $a0
	sub.d	$a5, $a2, $a0
...
.LBB15_55:                              # %vector.body229
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB15_55
# %bb.56:                               # %middle.block235
	beq	$a0, $a2, .LBB15_44
# %bb.57:                               # %vec.epilog.iter.check
	beqz	$a6, .LBB15_42
.LBB15_58:                              # %vec.epilog.ph
	...
	add.d	$a0, $a1, $a0
	.p2align	4, , 16
.LBB15_59:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $a0, 0
	st.d	$a1, $t0, 0
	addi.d	$a7, $a7, 8
...
# %bb.0:
	...
	pcalau12i	$s3, %pc_hi20(_zero_)
	ld.d	$a4, $s3, %pc_lo12(_zero_)
	move	$s0, $a0
	addi.w	$a0, $zero, -1
	beq	$a1, $a4, .LBB16_89
# %bb.1:
...
.LBB21_20:
	ld.w	$a0, $a7, 12
	pcalau12i	$s5, %pc_hi20(_one_)
	ld.d	$a1, $s5, %pc_lo12(_one_)
	addi.d	$a0, $a0, 1
	st.w	$a0, $a7, 12
	st.d	$a7, $sp, 120
	addi.d	$a2, $sp, 120
...
.LBB21_95:                              #   in Loop: Header=BB21_81 Depth=1
	...
	ori	$a0, $zero, 4
	bltu	$s5, $a0, .LBB21_98
.LBB21_96:                              # %vector.memcheck353
                                        #   in Loop: Header=BB21_81 Depth=1
	bgeu	$a4, $s2, .LBB21_110
# %bb.97:                               # %vector.memcheck353
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a0, $s5, -1
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a1, $t2, $a0
	...
	nor	$a0, $a0, $zero
	add.d	$a0, $a0, $s2
	bgeu	$a0, $a1, .LBB21_110
.LBB21_98:                              #   in Loop: Header=BB21_81 Depth=1
	move	$a2, $s5
	move	$a0, $a4
	move	$a3, $s2
.LBB21_99:                              # %vec.epilog.scalar.ph382.preheader
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $a2, 1
	addi.d	$a2, $a3, -1
	.p2align	4, , 16
.LBB21_100:                             # %vec.epilog.scalar.ph382
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a2, 0
	st.b	$a3, $a0, 0
...
.LBB21_109:                             # %out_long.exit141
	...
	b	.LBB21_80
	.p2align	4, , 16
.LBB21_110:                             # %vector.main.loop.iter.check364
                                        #   in Loop: Header=BB21_81 Depth=1
	bstrpick.d	$a1, $s5, 31, 0
	ori	$a0, $zero, 16
	bgeu	$s5, $a0, .LBB21_112
# %bb.111:                              #   in Loop: Header=BB21_81 Depth=1
	move	$a5, $zero
	b	.LBB21_116
.LBB21_112:                             # %vector.ph366
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a6, $a1, 12
...
.LBB21_113:                             # %vector.body369
	...
	addi.d	$t0, $t0, 16
	bnez	$t1, .LBB21_113
# %bb.114:                              # %middle.block376
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a5, $a1, .LBB21_101
# %bb.115:                              # %vec.epilog.iter.check383
                                        #   in Loop: Header=BB21_81 Depth=1
	beqz	$a6, .LBB21_99
.LBB21_116:                             # %vec.epilog.ph385
                                        #   in Loop: Header=BB21_81 Depth=1
	...
	addi.d	$a5, $a5, 16
	.p2align	4, , 16
.LBB21_117:                             # %vec.epilog.vector.body388
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t0, $a7, 0
	...
	addi.d	$a5, $a5, 4
	bnez	$a4, .LBB21_117
# %bb.118:                              # %vec.epilog.middle.block395
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a6, $a1, .LBB21_99
	b	.LBB21_101
.LBB21_119:                             # %vector.main.loop.iter.check
	ori	$a0, $zero, 16
	bstrpick.d	$a1, $s0, 31, 0
	bgeu	$s0, $a0, .LBB21_133
# %bb.120:
	move	$a5, $zero
	b	.LBB21_137
.LBB21_121:                             # %vector.main.loop.iter.check317
	ori	$a0, $zero, 16
	bstrpick.d	$a1, $s0, 31, 0
	bgeu	$s0, $a0, .LBB21_140
# %bb.122:
	move	$a5, $zero
	b	.LBB21_144
.LBB21_123:
...
.LBB21_124:
	...
	b	.LBB21_126
	.p2align	4, , 16
.LBB21_125:                             # %out_long.exit
                                        #   in Loop: Header=BB21_126 Depth=1
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$s5, $fp
	ld.d	$t2, $sp, 88                    # 8-byte Folded Reload
	beqz	$fp, .LBB21_131
.LBB21_126:                             # %.preheader.split
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB21_127 Depth 2
                                        #     Child Loop BB21_130 Depth 2
	ld.d	$fp, $s5, 8
	ld.d	$s7, $s5, 0
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.w	$s0, $a0, 4
	...
	bge	$s1, $s0, .LBB21_128
	.p2align	4, , 16
.LBB21_127:                             # %.lr.ph.i100
                                        #   Parent Loop BB21_126 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ori	$a0, $zero, 48
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	jirl	$ra, $a1, 0
	addi.w	$s0, $s0, -1
	blt	$s1, $s0, .LBB21_127
.LBB21_128:                             # %.preheader.i
                                        #   in Loop: Header=BB21_126 Depth=1
	blez	$s1, .LBB21_125
# %bb.129:                              # %.lr.ph15.preheader.i
                                        #   in Loop: Header=BB21_126 Depth=1
...
.LBB21_137:                             # %vec.epilog.ph
	...
	addi.d	$a5, $a5, 16
	.p2align	4, , 16
.LBB21_138:                             # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a7, 0
	vinsgr2vr.w	$vr0, $t0, 0
	vshuf4i.b	$vr0, $vr0, 27
...
.LBB21_141:                             # %vector.body322
	...
	addi.d	$t0, $t0, 16
	bnez	$t1, .LBB21_141
# %bb.142:                              # %middle.block329
	beq	$a5, $a1, .LBB21_46
# %bb.143:                              # %vec.epilog.iter.check336
	beqz	$a6, .LBB21_44
.LBB21_144:                             # %vec.epilog.ph338
	bstrpick.d	$a0, $a1, 31, 2
	slli.d	$a6, $a0, 2
	sub.d	$a2, $s0, $a6
	alsl.d	$a0, $a0, $a4, 2
	...
	addi.d	$a5, $a5, 16
	.p2align	4, , 16
.LBB21_145:                             # %vec.epilog.vector.body341
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a7, 0
	vinsgr2vr.w	$vr0, $t0, 0
	vshuf4i.b	$vr0, $vr0, 27
	...
	addi.d	$a5, $a5, 4
	bnez	$a4, .LBB21_145
# %bb.146:                              # %vec.epilog.middle.block348
	bne	$a6, $a1, .LBB21_44
	b	.LBB21_46
.Lfunc_end21:
