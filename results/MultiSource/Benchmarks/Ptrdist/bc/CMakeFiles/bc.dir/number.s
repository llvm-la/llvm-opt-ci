...
.LBB15_8:                               # %vector.body
	...
	ld.w	$a5, $s7, 0
	xvshuf.b	$xr4, $xr0, $xr4, $xr5
	xvslli.d	$xr4, $xr4, 56
	xvsrai.d	$xr4, $xr4, 56
	vinsgr2vr.w	$vr7, $a5, 0
	xvpermi.d	$xr6, $xr6, 68
	xvshuf.b	$xr6, $xr0, $xr6, $xr5
	xvslli.d	$xr6, $xr6, 56
	xvsrai.d	$xr6, $xr6, 56
	xvpermi.d	$xr7, $xr7, 68
	xvshuf.b	$xr5, $xr0, $xr7, $xr5
	xvslli.d	$xr5, $xr5, 56
	xvsrai.d	$xr5, $xr5, 56
	xvmadd.d	$xr1, $xr6, $xr3
	xvmadd.d	$xr2, $xr5, $xr4
	addi.d	$s5, $s5, -8
	addi.d	$s8, $s8, -8
	addi.d	$s7, $s7, 8
	bnez	$s8, .LBB15_8
...
.LBB21_112:                             # %vec.epilog.ph389
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_113:                             # %vec.epilog.vector.body393
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a6, 0
	vshuf4i.w	$vr0, $vr0, 27
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_113
# %bb.114:                              # %vec.epilog.middle.block401
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a4, $a1, .LBB21_99
	b	.LBB21_101
.LBB21_115:                             # %vector.ph373
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a3, $a1, 16
...
.LBB21_116:                             # %vector.body376
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB21_116
# %bb.117:                              # %middle.block383
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a2, $a1, .LBB21_101
# %bb.118:                              # %vec.epilog.iter.check387
                                        #   in Loop: Header=BB21_81 Depth=1
	bnez	$a3, .LBB21_112
...
.LBB21_127:                             # %vec.epilog.ph337
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_128:                             # %vec.epilog.vector.body341
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vshuf4i.w	$vr0, $vr0, 27
	vshuf4i.b	$vr0, $vr0, 27
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_128
# %bb.129:                              # %vec.epilog.middle.block349
	bne	$a4, $a1, .LBB21_44
	b	.LBB21_46
.LBB21_130:
	ld.d	$s8, $sp, 168                   # 8-byte Folded Reload
...
# %bb.147:                              # %middle.block331
	beq	$a2, $a1, .LBB21_46
# %bb.148:                              # %vec.epilog.iter.check335
	bnez	$a3, .LBB21_127
# %bb.149:
	sub.d	$fp, $fp, $a2
	add.d	$a0, $a0, $a2
