...
# %bb.0:
	...
	pcalau12i	$a0, %got_pc_hi20(v_count)
	ld.d	$s3, $a0, %got_pc_lo12(v_count)
	ld.w	$s2, $s3, 0
	pcalau12i	$a0, %got_pc_hi20(variables)
	ld.d	$s4, $a0, %got_pc_lo12(variables)
	ld.d	$fp, $s4, 0
	pcalau12i	$a0, %got_pc_hi20(v_names)
	ld.d	$s5, $a0, %got_pc_lo12(v_names)
	ld.d	$s0, $s5, 0
	addi.w	$a0, $s2, 32
	st.w	$a0, $s3, 0
	slli.d	$a0, $a0, 3
...
# %bb.0:
	...
	pcalau12i	$a0, %got_pc_hi20(a_count)
	ld.d	$s1, $a0, %got_pc_lo12(a_count)
	ld.w	$s2, $s1, 0
	pcalau12i	$a0, %got_pc_hi20(arrays)
	ld.d	$s3, $a0, %got_pc_lo12(arrays)
	ld.d	$fp, $s3, 0
	pcalau12i	$a0, %got_pc_hi20(a_names)
	ld.d	$s4, $a0, %got_pc_lo12(a_names)
	ld.d	$s0, $s4, 0
	addi.w	$a0, $s2, 32
	st.w	$a0, $s1, 0
	slli.d	$a0, $a0, 3
...
# %bb.9:
	...
	b	.LBB12_12
	.p2align	4, , 16
.LBB12_10:                              # %.loopexit71.loopexit84
...
# %bb.13:                               # %.preheader70.preheader
	...
	st.d	$a0, $fp, 120
	b	.LBB12_11
.LBB12_14:                              # %.preheader73.._crit_edge_crit_edge
	ld.d	$fp, $s0, 0
.LBB12_15:                              # %._crit_edge
	ori	$s0, $zero, 2
	bltu	$s4, $s0, .LBB12_22
# %bb.16:                               # %.lr.ph81.preheader
	ori	$s4, $zero, 3
	b	.LBB12_19
	.p2align	4, , 16
.LBB12_17:                              # %.preheader68
...
# %bb.14:                               #   in Loop: Header=BB24_5 Depth=1
	...
	b	.LBB24_19
.LBB24_15:                              #   in Loop: Header=BB24_5 Depth=1
	sub.w	$s0, $zero, $s0
