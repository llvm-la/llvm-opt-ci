...
# %bb.1:
	addi.w	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, %pc_lo12(cpwCand)
	slli.d	$a0, $a1, 3
	pcalau12i	$a1, %pc_hi20(apwCand)
	addi.d	$s0, $a1, %pc_lo12(apwCand)
	ldx.d	$a0, $s0, $a0
	bnez	$a0, .LBB5_4
# %bb.2:
	ori	$a0, $zero, 32
...
.LBB6_8:                                # %.preheader
	...
	ld.bu	$a2, $sp, 57
	ld.w	$a3, $a0, 100
	pcalau12i	$s2, %pc_hi20(cpwCand)
	ld.wu	$a1, $s2, %pc_lo12(cpwCand)
	vadd.w	$vr0, $vr1, $vr0
	add.d	$a2, $a3, $a2
	st.w	$a2, $a0, 100
	srli.d	$a2, $a1, 3
...
# %bb.9:
	addi.w	$a0, $a1, 0
	addi.d	$a1, $a1, 1
	st.w	$a1, $s2, %pc_lo12(cpwCand)
	slli.d	$a0, $a0, 3
	pcalau12i	$a1, %pc_hi20(apwCand)
	addi.d	$s3, $a1, %pc_lo12(apwCand)
	ldx.d	$a0, $s3, $a0
	bnez	$a0, .LBB6_12
# %bb.10:
	ori	$a0, $zero, 32
...
# %bb.0:
	...
	ld.w	$a1, $a0, %pc_lo12(DumpWords.X)
	addi.d	$a1, $a1, 1
	andi	$a1, $a1, 1023
	st.w	$a1, $a0, %pc_lo12(DumpWords.X)
	beqz	$a1, .LBB9_2
# %bb.1:
	ret
.LBB9_2:                                # %.preheader
...
# %bb.2:                                # %.preheader
	...
	addi.d	$s5, $a2, %pc_lo12(apwCand)
	alsl.d	$s0, $a3, $s5, 3
	bgeu	$a1, $s0, .LBB10_22
# %bb.3:                                # %.lr.ph.lr.ph
	pcalau12i	$a2, %pc_hi20(aqMainSign)
	addi.d	$s6, $a2, %pc_lo12(aqMainSign)
	pcalau12i	$t6, %pc_hi20(cpwLast)
...
.LBB10_14:                              #   in Loop: Header=BB10_7 Depth=1
	ld.w	$a4, $t6, %pc_lo12(cpwLast)
	st.d	$s2, $sp, 80
	st.d	$a3, $sp, 72
	addi.d	$a3, $a4, 1
	ld.w	$a5, $s8, 24
	ld.w	$a6, $t4, %pc_lo12(cchPhraseLength)
	st.w	$a3, $t6, %pc_lo12(cpwLast)
	slli.d	$a3, $a4, 3
	stx.d	$s8, $t3, $a3
	sub.d	$a3, $a6, $a5
...
# %bb.15:                               #   in Loop: Header=BB10_7 Depth=1
	ld.w	$a3, $t5, %pc_lo12(DumpWords.X)
	addi.d	$s0, $a2, 8
	addi.d	$a2, $a3, 1
	andi	$a2, $a2, 1023
