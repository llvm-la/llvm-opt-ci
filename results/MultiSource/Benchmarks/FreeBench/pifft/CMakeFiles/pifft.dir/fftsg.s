...
# %bb.42:                               # %.lr.ph267
	...
	move	$a5, $t7
	.p2align	4, , 16
.LBB12_43:                              #   Parent Loop BB12_28 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $a5, -8
	fld.d	$fa1, $a5, 0
	fsub.d	$fa0, $fa0, $fa1
...
# %bb.46:                               #   in Loop: Header=BB12_28 Depth=1
	move	$a2, $zero
.LBB12_47:                              # %.lr.ph271.preheader421
                                        #   in Loop: Header=BB12_28 Depth=1
	slli.d	$a4, $a2, 3
	alsl.d	$a3, $a2, $s0, 3
	sub.d	$a4, $s0, $a4
...
# %bb.51:                               # %vector.memcheck374
	...
	and	$a6, $t2, $a6
	bnez	$a6, .LBB12_57
# %bb.52:                               # %vector.memcheck374
                                        #   in Loop: Header=BB12_28 Depth=1
	sltu	$a6, $a3, $t1
	sltu	$a7, $a7, $a4
	and	$a6, $a6, $a7
	bnez	$a6, .LBB12_57
# %bb.53:                               # %vector.memcheck374
                                        #   in Loop: Header=BB12_28 Depth=1
	sltu	$a3, $a3, $a5
	sltu	$a4, $t0, $a4
	and	$a3, $a3, $a4
...
.LBB12_57:                              #   in Loop: Header=BB12_28 Depth=1
	ori	$t1, $zero, 4
	b	.LBB12_47
.LBB12_58:                              # %._crit_edge276.loopexit
	ld.d	$s6, $sp, 16                    # 8-byte Folded Reload
.LBB12_59:                              # %._crit_edge276
	fld.d	$fa0, $s0, 0
	slli.d	$a0, $s4, 3
	fstx.d	$fa0, $fp, $a0
	fld.d	$fa0, $s0, 16
...
.LBB13_13:                              # %.lr.ph
	...
	bnez	$a2, .LBB13_13
	b	.LBB13_15
.LBB13_14:                              # %makect.exit.thread.._crit_edge_crit_edge
	addi.w	$s3, $t4, 0
.LBB13_15:                              # %._crit_edge
	slli.d	$a1, $s3, 3
	fldx.d	$fa0, $fp, $a1
...
.LBB13_35:                              #   in Loop: Header=BB13_30 Depth=1
	...
	b	.LBB13_42
	.p2align	4, , 16
.LBB13_36:                              #   in Loop: Header=BB13_30 Depth=1
	move	$s8, $t4
	move	$s7, $t8
	move	$a0, $s5
	move	$a1, $s0
...
# %bb.43:                               # %.lr.ph243
	...
	move	$a6, $s4
	.p2align	4, , 16
.LBB13_44:                              #   Parent Loop BB13_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $a6, -8
	fld.d	$fa1, $a6, 0
	fneg.d	$fa0, $fa0
...
# %bb.46:                               # %.lr.ph247.preheader
	...
	ori	$a5, $zero, 14
	bgeu	$a4, $a5, .LBB13_49
.LBB13_47:                              # %.lr.ph247.preheader402
                                        #   in Loop: Header=BB13_30 Depth=1
	slli.d	$a5, $a3, 3
	alsl.d	$a4, $a3, $s0, 3
	sub.d	$a5, $s0, $a5
...
.LBB13_57:                              #   in Loop: Header=BB13_30 Depth=1
	ori	$t3, $zero, 4
	b	.LBB13_47
.LBB13_58:                              # %.preheader.._crit_edge252_crit_edge
	fld.d	$fa0, $s0, 0
	ori	$s3, $zero, 2
	b	.LBB13_61
.LBB13_59:                              # %._crit_edge244.thread
	slli.w	$s3, $s3, 1
.LBB13_60:                              # %._crit_edge252.loopexit
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $s0, $a0
	fst.d	$fa0, $s0, 0
.LBB13_61:                              # %._crit_edge252
	slli.d	$a0, $s3, 3
	fstx.d	$fa0, $fp, $a0
.LBB13_62:
	st.d	$zero, $fp, 0
