...
# %bb.39:
	move	$a5, $a3
	b	.LBB2_49
.LBB2_40:                               # %vector.main.loop.iter.check
	ori	$a5, $zero, 15
	addi.w	$a4, $a3, 1
	bgeu	$a3, $a5, .LBB2_42
# %bb.41:
...
.LBB2_46:                               # %vec.epilog.ph
	...
	vrepli.w	$vr1, 10
	.p2align	4, , 16
.LBB2_47:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, 4
	vmul.w	$vr0, $vr0, $vr1
	bnez	$a2, .LBB2_47
...
# %bb.54:
	move	$a2, $a3
	b	.LBB2_64
.LBB2_55:                               # %vector.main.loop.iter.check181
...
.LBB2_58:                               # %vector.body186
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_58
# %bb.59:                               # %middle.block189
	beq	$a1, $a4, .LBB2_66
# %bb.60:                               # %vec.epilog.iter.check194
	beqz	$a5, .LBB2_64
.LBB2_61:                               # %vec.epilog.ph196
	bstrpick.d	$a2, $a1, 32, 2
	slli.d	$a5, $a2, 2
	alsl.d	$a2, $a2, $a3, 2
	alsl.d	$a3, $a4, $fp, 2
	alsl.d	$a0, $a0, $a3, 2
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB2_62:                               # %vec.epilog.vector.body199
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, 16
	bnez	$a3, .LBB2_62
# %bb.63:                               # %vec.epilog.middle.block202
	beq	$a1, $a5, .LBB2_66
.LBB2_64:                               # %.lr.ph121.preheader205
	alsl.d	$a0, $a2, $fp, 2
	sub.d	$a1, $s0, $a2
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
...
.LBB8_15:                               # %.lr.ph56.i
	...
	addi.d	$a4, $a4, -4
	blt	$a5, $t0, .LBB8_15
.LBB8_16:                               # %._crit_edge57.i
	ld.w	$a1, $a2, 12
	sub.d	$a0, $a1, $a0
	movgr2fr.w	$fa0, $a0
	ffint.d.w	$fa0, $fa0
	fst.d	$fa0, $s4, 16
.LBB8_17:                               # %mp_mul_i2d.exit
	movgr2fr.w	$fa0, $s6
	ld.w	$a0, $a2, 4
	ffint.d.w	$fa0, $fa0
	addi.d	$a2, $s4, 8
...
# %bb.21:                               # %.lr.ph.preheader.i101
	...
	jirl	$ra, $ra, 0
	ld.d	$t1, $sp, 96                    # 8-byte Folded Reload
.LBB8_22:                               # %._crit_edge.i89
	ori	$a0, $zero, 2
	blt	$s7, $a0, .LBB8_28
# %bb.23:
	bne	$s7, $a0, .LBB8_25
# %bb.24:                               # %.._crit_edge57_crit_edge.i100
	move	$a0, $zero
	addi.w	$a1, $t1, 0
	b	.LBB8_27
.LBB8_25:                               # %.lr.ph56.preheader.i91
	move	$a0, $zero
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a2, $a1, 1
...
# %bb.38:
	move	$a0, $zero
	b	.LBB8_41
.LBB8_39:                               # %.lr.ph56.preheader.i114
	move	$a0, $zero
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a1, $a1, 1
...
.LBB8_40:                               # %.lr.ph56.i116
	...
	addi.d	$a4, $a4, -4
	blt	$a5, $a2, .LBB8_40
.LBB8_41:                               # %._crit_edge57.i122
	ld.w	$a1, $s0, 12
	sub.d	$a0, $a1, $a0
	movgr2fr.w	$fa0, $a0
	ffint.d.w	$fa0, $fa0
	fst.d	$fa0, $fp, 16
.LBB8_42:                               # %mp_mul_i2d.exit130
...
# %bb.49:                               # %.lr.ph.preheader.i154
	...
	ld.d	$t2, $sp, 96                    # 8-byte Folded Reload
	ld.d	$t1, $sp, 80                    # 8-byte Folded Reload
.LBB8_50:                               # %._crit_edge.i139
	ori	$a0, $zero, 2
	blt	$s6, $a0, .LBB8_56
# %bb.51:
	bne	$s6, $a0, .LBB8_53
# %bb.52:                               # %.._crit_edge57_crit_edge.i152
	move	$a0, $zero
	addi.w	$a1, $t2, 0
	b	.LBB8_55
.LBB8_53:                               # %.lr.ph56.preheader.i141
	move	$a0, $zero
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a2, $a1, 1
...
.LBB11_10:                              # %._crit_edge.i
	srai.d	$a0, $s0, 1
	sub.w	$s0, $s3, $a6
	ori	$a1, $zero, 2
	bstrpick.d	$t1, $s2, 31, 31
	blt	$s6, $a1, .LBB11_16
# %bb.11:
	bne	$s6, $a1, .LBB11_13
# %bb.12:
...
.LBB11_14:                              # %.lr.ph56.i
	...
	addi.d	$a5, $a5, -4
	blt	$a6, $a3, .LBB11_14
.LBB11_15:                              # %._crit_edge57.i
	ld.w	$a2, $s8, 12
	sub.d	$a1, $a2, $a1
	movgr2fr.w	$fa0, $a1
	ffint.d.w	$fa0, $fa0
	fst.d	$fa0, $s1, 16
.LBB11_16:                              # %mp_mul_i2d.exit
...
# %bb.22:
	bne	$fp, $a2, .LBB11_24
# %bb.23:                               # %.._crit_edge57_crit_edge.i79
	move	$a2, $zero
	addi.w	$a3, $t3, 0
	b	.LBB11_26
.LBB11_24:                              # %.lr.ph56.preheader.i70
	move	$a2, $zero
...
# %bb.14:                               # %middle.block
	beq	$a1, $a5, .LBB36_17
.LBB36_15:                              # %.lr.ph.i.i.preheader213
	alsl.d	$a1, $a0, $s4, 3
	addi.d	$a1, $a1, 8
	.p2align	4, , 16
.LBB36_16:                              # %.lr.ph.i.i
...
# %bb.22:
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_26
# %bb.23:                               # %.lr.ph44.preheader.i
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_24:                              # %.lr.ph44.i108
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s7, $s7, -1
	slli.d	$a1, $s7, 2
	ldx.w	$a1, $s0, $a1
...
# %bb.32:                               # %middle.block202
	beq	$a1, $a5, .LBB36_36
.LBB36_33:                              # %.lr.ph.i.i115.preheader
	alsl.d	$a1, $a0, $s4, 3
	addi.d	$a1, $a1, 8
	.p2align	4, , 16
.LBB36_34:                              # %.lr.ph.i.i115
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, 0
	fld.d	$fa1, $a1, -8
	fneg.d	$fa2, $fa0
	...
	bltu	$a0, $s3, .LBB36_34
	b	.LBB36_36
.LBB36_35:                              # %.._crit_edge_crit_edge.i.i111
	addi.d	$a2, $s4, 8
.LBB36_36:                              # %mp_squh_use_in1fft.exit118
...
# %bb.40:
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_44
# %bb.41:                               # %.lr.ph44.preheader.i125
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_42:                              # %.lr.ph44.i126
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s7, $s7, -1
	slli.d	$a1, $s7, 2
	ldx.w	$a1, $s6, $a1
