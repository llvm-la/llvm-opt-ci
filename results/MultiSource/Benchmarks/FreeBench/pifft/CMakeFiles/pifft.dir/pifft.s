...
.LBB2_48:                               # %vector.body176
	...
	addi.d	$a0, $a0, 32
	bnez	$a4, .LBB2_48
# %bb.49:                               # %middle.block179
	beq	$a2, $a3, .LBB2_52
.LBB2_50:                               # %.lr.ph121.preheader182
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
...
# %bb.18:
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_22
# %bb.19:                               # %.lr.ph44.preheader.i
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_20:                              # %.lr.ph44.i108
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s0, $a1
...
.LBB36_24:                              # %mp_round.exit110
	...
	vst	$vr0, $s4, 8
	bge	$a0, $s3, .LBB36_27
# %bb.25:                               # %.lr.ph.preheader.i.i114
	addi.d	$a1, $s4, 32
	addi.d	$a2, $s4, 8
	.p2align	4, , 16
.LBB36_26:                              # %.lr.ph.i.i115
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, 0
	fld.d	$fa1, $a1, -8
	fneg.d	$fa2, $fa0
	...
	bltu	$a0, $s3, .LBB36_26
	b	.LBB36_28
.LBB36_27:                              # %.._crit_edge_crit_edge.i.i111
	addi.d	$a2, $s4, 8
.LBB36_28:                              # %mp_squh_use_in1fft.exit118
	alsl.d	$a0, $s3, $s4, 3
	fld.d	$fa0, $a0, 8
	fmul.d	$fa0, $fa0, $fa0
	fst.d	$fa0, $a0, 8
...
# %bb.32:
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_36
# %bb.33:                               # %.lr.ph44.preheader.i125
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_34:                              # %.lr.ph44.i126
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s6, $a1
