...
# %bb.52:                               # %iter.check181
	...
	ori	$a2, $zero, 3
	bltu	$a3, $a2, .LBB2_62
# %bb.53:                               # %vector.main.loop.iter.check183
...
# %bb.57:                               # %middle.block190
	beq	$a2, $a3, .LBB2_64
# %bb.58:                               # %vec.epilog.iter.check194
	beqz	$a4, .LBB2_68
.LBB2_59:                               # %vec.epilog.ph196
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB2_60:                               # %vec.epilog.vector.body199
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, 16
