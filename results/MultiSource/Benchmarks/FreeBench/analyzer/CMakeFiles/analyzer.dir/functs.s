...
# %bb.38:
	move	$a1, $zero
	b	.LBB4_42
.LBB4_39:                               # %vector.ph289
	bstrpick.d	$a1, $s4, 30, 1
	slli.d	$a1, $a1, 1
	addi.d	$a2, $s5, 96
	move	$a3, $a1
	.p2align	4, , 16
.LBB4_40:                               # %vector.body292
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, -56
	ld.d	$a5, $a2, 0
	ld.d	$a6, $a2, -48
	...
	addi.d	$a2, $a2, 112
	bnez	$a3, .LBB4_40
# %bb.41:                               # %middle.block295
	beq	$a1, $s4, .LBB4_44
.LBB4_42:                               # %.lr.ph198.preheader361
	ori	$a2, $zero, 56
	mul.d	$a2, $a1, $a2
	add.d	$a2, $a2, $s5
	addi.d	$a2, $a2, 40
...
.LBB4_47:                               # %vector.body303
	...
	addi.d	$a1, $a1, 224
	bnez	$a4, .LBB4_47
# %bb.48:                               # %middle.block308
	vmax.du	$vr0, $vr0, $vr1
	vbsrl.v	$vr1, $vr0, 8
	vmax.du	$vr0, $vr1, $vr0
	vpickve2gr.d	$a1, $vr0, 0
	beq	$a3, $a2, .LBB4_78
.LBB4_49:                               # %.lr.ph202.preheader357
	ori	$a4, $zero, 56
	mul.d	$a4, $a3, $a4
	add.d	$a4, $a4, $s5
	addi.d	$a4, $a4, 40
...
.LBB4_50:                               # %.lr.ph202
	...
	bnez	$a2, .LBB4_50
	b	.LBB4_78
.LBB4_51:                               # %vector.ph315
	bstrpick.d	$a0, $s4, 30, 1
	slli.d	$a0, $a0, 1
	addi.d	$a1, $s5, 80
	move	$a2, $a0
	.p2align	4, , 16
.LBB4_52:                               # %vector.body318
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, -48
	ld.d	$a4, $a1, 8
	ld.d	$a5, $a1, -56
	...
	addi.d	$a1, $a1, 112
	bnez	$a2, .LBB4_52
# %bb.53:                               # %middle.block321
	beq	$a0, $s4, .LBB4_56
.LBB4_54:                               # %.lr.ph206.preheader356
	sub.d	$a1, $s4, $a0
	ori	$a2, $zero, 56
	mul.d	$a0, $a0, $a2
	add.d	$a0, $a0, $s5
...
.LBB4_67:                               # %vector.body329
	...
	addi.d	$a2, $a2, 112
	bnez	$a3, .LBB4_67
# %bb.68:                               # %middle.block332
	beq	$a1, $s4, .LBB4_71
.LBB4_69:                               # %.lr.ph214.preheader355
	ori	$a2, $zero, 56
	mul.d	$a2, $a1, $a2
	add.d	$a2, $a2, $s5
	addi.d	$a2, $a2, 40
...
.LBB4_74:                               # %vector.body342
	...
	addi.d	$a1, $a1, 224
	bnez	$a4, .LBB4_74
# %bb.75:                               # %middle.block347
	vmax.du	$vr0, $vr0, $vr1
	vbsrl.v	$vr1, $vr0, 8
	vmax.du	$vr0, $vr1, $vr0
	vpickve2gr.d	$a1, $vr0, 0
	beq	$a3, $a2, .LBB4_78
.LBB4_76:                               # %.lr.ph219.preheader353
	ori	$a4, $zero, 56
	mul.d	$a4, $a3, $a4
	add.d	$a4, $a4, $s5
	addi.d	$a4, $a4, 40
