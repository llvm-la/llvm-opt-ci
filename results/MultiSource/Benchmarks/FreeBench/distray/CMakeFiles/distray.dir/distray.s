...
# %bb.5:                                # %.lr.ph
	...
	vldi	$vr2, -912
	fsel	$fs7, $fa2, $fa6, $fcc0
	movgr2fr.d	$fs4, $zero
	fsel	$fa2, $fs4, $ft0, $fcc0
	vst	$vr9, $sp, 48                   # 16-byte Folded Spill
	fsel	$fa6, $ft1, $fa7, $fcc0
	fsel	$fs1, $fa3, $fa4, $fcc0
	fsel	$fs2, $fs4, $fa5, $fcc0
	fmul.d	$fa3, $fs1, $fs1
	fmul.d	$fa4, $fa2, $fa2
	fmadd.d	$fa4, $fs2, $fs2, $fa4
	fmadd.d	$fa3, $fa6, $fa6, $fa3
	fmadd.d	$fa4, $fs7, $fs7, $fa4
	fadd.d	$fa3, $fa3, $fs4
	fsqrt.d	$fa3, $fa3
	fsqrt.d	$fa4, $fa4
	fdiv.d	$fa3, $fa1, $fa3
...
# %bb.27:                               # %.lr.ph93
	...
	vldi	$vr3, -912
	fsel	$fs0, $fa3, $fa7, $fcc0
	movgr2fr.d	$fs1, $zero
	fsel	$fa1, $fs1, $fa1, $fcc0
	fsel	$fa7, $fa0, $ft0, $fcc0
	fsel	$fs2, $fa4, $fa5, $fcc0
	fsel	$fs3, $fs1, $fa6, $fcc0
	fmul.d	$fa0, $fs2, $fs2
	fmul.d	$fa3, $fa1, $fa1
	fmadd.d	$fa3, $fs3, $fs3, $fa3
	fmadd.d	$fa0, $fa7, $fa7, $fa0
	fmadd.d	$fa3, $fs0, $fs0, $fa3
	fadd.d	$fa0, $fa0, $fs1
	fsqrt.d	$fa0, $fa0
	fsqrt.d	$fa3, $fa3
	fdiv.d	$fs5, $fa2, $fa0
