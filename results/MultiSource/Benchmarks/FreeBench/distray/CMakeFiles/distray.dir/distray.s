...
# %bb.9:                                # %.lr.ph.i
	...
	fmadd.d	$fa1, $fa1, $fs4, $fa2
	fmadd.d	$fa0, $fa4, $fa0, $fa5
	fmadd.d	$ft4, $fa6, $fs4, $fa0
	fabs.d	$fa0, $fa1
	fneg.d	$fa2, $fs5
	fmul.d	$fa3, $ft4, $fa1
	fmul.d	$fa4, $fa1, $fa2
	...
	fmul.d	$fa6, $fa1, $fa6
	fmul.d	$fa7, $fa4, $fa2
	fmadd.d	$fa7, $fa3, $ft4, $fa7
	fmul.d	$ft0, $ft4, $ft4
	fmadd.d	$ft0, $fs5, $fs5, $ft0
	fmadd.d	$ft0, $fa1, $fa1, $ft0
	fsqrt.d	$ft0, $ft0
	fcmp.clt.d	$fcc0, $fs2, $fa0
	vld	$vr9, $sp, 80                   # 16-byte Folded Reload
	fsel	$fa0, $ft1, $fa6, $fcc0
	fsel	$fs6, $ft1, $fa5, $fcc0
	fmul.d	$fa5, $fa0, $fa0
	fmadd.d	$fa5, $fs6, $fs6, $fa5
	fsel	$fs0, $ft4, $fa3, $fcc0
	fsel	$fa3, $ft2, $fa7, $fcc0
	fsel	$fa6, $fa2, $fa4, $fcc0
	fmul.d	$fa2, $fa6, $fa6
	fmadd.d	$fa2, $fs0, $fs0, $fa2
	fmadd.d	$fa4, $fa3, $fa3, $fa5
	fadd.d	$fa2, $fa2, $ft1
	fsqrt.d	$fa2, $fa2
	fsqrt.d	$fa4, $fa4
	fdiv.d	$fa2, $ft0, $fa2
	...
	vst	$vr12, $sp, 176                 # 16-byte Folded Spill
...
.LBB1_6:                                # %DistribVector.exit
	...
	fmul.d	$fa5, $fa5, $fa2
	fmul.d	$fa6, $fs5, $fa3
	fld.d	$fa7, $sp, 120                  # 8-byte Folded Reload
	fmul.d	$fa7, $fa7, $fa3
	fmul.d	$fa2, $fs3, $fa2
	fmul.d	$fa3, $fs2, $fa3
	fadd.d	$fa5, $fa5, $fa7
...
.LBB1_24:
	...
	fst.d	$fa2, $sp, 272
	fmadd.d	$fa0, $fa4, $fs1, $fa1
	fst.d	$fa0, $sp, 280
	fmadd.d	$fa1, $fa4, $fs3, $fa3
	ori	$a0, $zero, 4
	fst.d	$fa1, $sp, 288
	bltu	$s0, $a0, .LBB1_29
# %bb.25:
...
.LBB2_5:
	...
	fmul.d	$fa1, $fa0, $fa6
	fmadd.d	$fa1, $fs7, $fs4, $fa1
	vreplvei.d	$vr3, $vr11, 1
...
.LBB2_13:                               # %.split147
	...
	fcmp.cule.d	$fcc0, $fs7, $fa5
	bcnez	$fcc0, .LBB2_16
# %bb.14:
	fcmp.clt.d	$fcc0, $fs0, $fa4
	bcnez	$fcc0, .LBB2_31
# %bb.15:
	fcmp.cule.d	$fcc0, $fs0, $fs7
	bceqz	$fcc0, .LBB2_31
.LBB2_16:
	fmov.d	$fs7, $fs0
.LBB2_17:
...
.LBB2_23:
	...
	fsub.d	$fs0, $fa3, $ft1
	fmul.d	$fa1, $fs5, $fa6
	fmadd.d	$fa1, $fs2, $fs4, $fa1
	fmadd.d	$fa1, $fs0, $fs1, $fa1
	fld.d	$fa2, $fp, 264
	fmul.d	$fs3, $fa1, $fs6
	fneg.d	$fa1, $fs2
	fmul.d	$fa1, $fs2, $fa1
...
.LBB2_34:                               # %call.sqrt148
	...
	fst.d	$fa4, $sp, 8                    # 8-byte Folded Spill
	...
	fld.d	$fa4, $sp, 8                    # 8-byte Folded Reload
