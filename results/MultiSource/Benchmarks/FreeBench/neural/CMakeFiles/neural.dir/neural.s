...
# %bb.36:                               #   in Loop: Header=BB0_35 Depth=2
	...
	b	.LBB0_40
	.p2align	4, , 16
.LBB0_37:                               # %vector.body121.preheader
                                        #   in Loop: Header=BB0_35 Depth=2
	addi.d	$t5, $t4, 16
	move	$t6, $t2
	move	$t7, $a4
...
# %bb.43:                               #   in Loop: Header=BB0_35 Depth=2
	...
	b	.LBB0_47
	.p2align	4, , 16
.LBB0_44:                               # %vector.body103.preheader
                                        #   in Loop: Header=BB0_35 Depth=2
	addi.d	$t6, $t4, 16
	move	$t7, $t2
	move	$t8, $a4
...
# %bb.46:                               # %middle.block111
	...
	move	$t8, $a4
	beq	$a4, $a2, .LBB0_34
.LBB0_47:                               # %.lr.ph.i18.us.us.i.preheader181
                                        #   in Loop: Header=BB0_35 Depth=2
	sub.d	$t7, $a2, $t8
	alsl.d	$t4, $t8, $t4, 2
	alsl.d	$t8, $t8, $t1, 2
...
.LBB0_48:                               # %.lr.ph.i18.us.us.i
	...
	bnez	$t7, .LBB0_48
	b	.LBB0_34
.LBB0_49:                               # %.lr.ph36.split.preheader.i
	ori	$a1, $zero, 8
	slli.d	$a4, $a0, 1
	bgeu	$a0, $a1, .LBB0_51
# %bb.50:
...
# %bb.53:                               # %middle.block
	...
	beq	$a0, $a2, .LBB0_56
.LBB0_54:                               # %.lr.ph36.split.i.preheader
	addi.d	$a3, $a3, -2
	.p2align	4, , 16
.LBB0_55:                               # %.lr.ph36.split.i
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, 1
	slt	$a4, $a2, $a0
	maskeqz	$a4, $a3, $a4
...
.LBB0_83:                               # %vector.body140
	...
	vst	$vr2, $a6, -16
	vst	$vr3, $a6, 0
	vfcmp.cne.s	$vr2, $vr2, $vr7
	vfcmp.cne.s	$vr3, $vr3, $vr7
	vor.v	$vr0, $vr0, $vr2
	vor.v	$vr1, $vr1, $vr3
	addi.d	$a7, $a7, -8
	addi.d	$a6, $a6, 32
...
# %bb.84:                               # %middle.block149
	...
	maskeqz	$s4, $s4, $a4
	beq	$a3, $a0, .LBB0_87
.LBB0_85:                               # %scalar.ph135.preheader
                                        #   in Loop: Header=BB0_76 Depth=2
	sub.d	$a4, $a0, $a3
	alsl.d	$a5, $a3, $fp, 2
	alsl.d	$a2, $a3, $a2, 2
