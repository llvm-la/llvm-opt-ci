...
# %bb.149:                              # %vector.memcheck1196
	...
	ori	$a6, $zero, 64
	bltu	$a4, $a6, .LBB3_176
# %bb.150:                              # %vector.main.loop.iter.check1202
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_169
# %bb.151:
	move	$a4, $zero
...
.LBB3_170:                              # %vector.body1208
	...
	addi.d	$a6, $a6, 64
	bnez	$t0, .LBB3_170
# %bb.171:                              # %middle.block1213
	beq	$a3, $a4, .LBB3_178
# %bb.172:                              # %vec.epilog.iter.check1217
	beqz	$a5, .LBB3_318
.LBB3_173:                              # %vec.epilog.ph1219
	move	$a6, $a3
	...
	vreplgr2vr.w	$vr2, $s3
	.p2align	4, , 16
.LBB3_174:                              # %vec.epilog.vector.body1224
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t3, $t0
	vstx	$vr1, $a7, $t0
...
# %bb.175:                              # %vec.epilog.middle.block1229
	beq	$a3, $a6, .LBB3_178
.LBB3_176:                              # %vec.epilog.scalar.ph1216.preheader
	slli.d	$a3, $a5, 2
	addi.d	$a4, $t3, -4
	sub.d	$a2, $a2, $a5
	movgr2fr.w	$fa0, $s3
	.p2align	4, , 16
.LBB3_177:                              # %vec.epilog.scalar.ph1216
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a4, $a3
	stx.w	$zero, $a1, $a3
...
.LBB3_187:                              # %iter.check1242
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_190
# %bb.188:                              # %vector.memcheck1233
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_201
# %bb.189:                              # %vector.memcheck1233
                                        #   in Loop: Header=BB3_183 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_201
...
# %bb.200:                              #   in Loop: Header=BB3_195 Depth=2
	...
	stx.w	$t7, $s2, $a3
	b	.LBB3_194
.LBB3_201:                              # %vector.main.loop.iter.check1244
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_203
# %bb.202:                              #   in Loop: Header=BB3_183 Depth=1
	move	$a4, $zero
	b	.LBB3_207
.LBB3_203:                              # %vector.body1248.preheader
                                        #   in Loop: Header=BB3_183 Depth=1
	addi.d	$a0, $t2, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_204:                              # %vector.body1248
                                        #   Parent Loop BB3_183 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
...
# %bb.205:                              # %middle.block1257
	...
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_192
# %bb.206:                              # %vec.epilog.iter.check1261
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a4, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	beqz	$a0, .LBB3_210
.LBB3_207:                              # %vec.epilog.ph1263
                                        #   in Loop: Header=BB3_183 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB3_208:                              # %vec.epilog.vector.body1267
                                        #   Parent Loop BB3_183 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_208
# %bb.209:                              # %vec.epilog.middle.block1276
                                        #   in Loop: Header=BB3_183 Depth=1
...
.LBB3_216:                              # %vector.body1294
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_216
# %bb.217:                              # %middle.block1301
	beq	$a2, $a4, .LBB3_220
.LBB3_218:                              # %scalar.ph1285.preheader
	sub.w	$a2, $s6, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_223:                              # %vector.body1313
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_223
# %bb.224:                              # %middle.block1320
	beq	$a3, $a4, .LBB3_227
.LBB3_225:                              # %scalar.ph1304.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_226:                              # %scalar.ph1304
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.250:
	move	$a5, $zero
	b	.LBB3_260
.LBB3_251:                              # %vector.main.loop.iter.check1343
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_253
# %bb.252:
	move	$a5, $zero
	b	.LBB3_257
.LBB3_253:                              # %vector.ph1344
	andi	$a7, $a6, 12
...
.LBB3_254:                              # %vector.body1347
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_254
# %bb.255:                              # %middle.block1353
	beq	$a4, $a5, .LBB3_262
# %bb.256:                              # %vec.epilog.iter.check1357
	beqz	$a7, .LBB3_260
.LBB3_257:                              # %vec.epilog.ph1359
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_258:                              # %vec.epilog.vector.body1364
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_258
# %bb.259:                              # %vec.epilog.middle.block1369
	beq	$a4, $a5, .LBB3_262
.LBB3_260:                              # %vec.epilog.scalar.ph1356.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_261:                              # %vec.epilog.scalar.ph1356
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_280:                              # %.lr.ph19.i
	...
	addi.d	$t8, $t8, -1
	bnez	$t7, .LBB3_280
.LBB3_281:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_264 Depth=1
	add.d	$a7, $s7, $a7
	add.d	$a7, $t6, $a7
	move	$s3, $fp
...
.LBB3_287:                              # %._crit_edge30.i
	...
	addi.w	$t8, $t8, 0
	beq	$t2, $t8, .LBB3_289
# %bb.288:                              #   in Loop: Header=BB3_264 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a1, 0
.LBB3_289:                              #   in Loop: Header=BB3_264 Depth=1
	blez	$t1, .LBB3_294
# %bb.290:                              #   in Loop: Header=BB3_264 Depth=1
	blez	$t2, .LBB3_294
# %bb.291:                              #   in Loop: Header=BB3_264 Depth=1
	...
	b	.LBB3_293
	.p2align	4, , 16
.LBB3_292:                              #   in Loop: Header=BB3_264 Depth=1
	addi.d	$t0, $s7, -1
	move	$t3, $s8
	nor	$t6, $t0, $zero
	add.w	$t7, $s7, $t6
...
.LBB3_296:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_296
.LBB3_297:                              # %.preheader.i
	ld.d	$s7, $sp, 96                    # 8-byte Folded Reload
	blez	$s7, .LBB3_300
# %bb.298:                              # %.lr.ph52.preheader.i
...
# %bb.232:
	move	$a4, $zero
	b	.LBB6_242
.LBB6_233:                              # %vector.main.loop.iter.check1224
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_235
# %bb.234:
	move	$a4, $zero
	b	.LBB6_239
.LBB6_235:                              # %vector.ph1225
	andi	$a6, $a5, 12
	bstrpick.d	$a4, $a5, 31, 4
	slli.d	$a4, $a4, 4
...
.LBB6_236:                              # %vector.body1228
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_236
# %bb.237:                              # %middle.block1234
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1238
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1240
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1245
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1250
	beq	$a3, $a4, .LBB6_244
.LBB6_242:                              # %vec.epilog.scalar.ph1237.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_243:                              # %vec.epilog.scalar.ph1237
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
