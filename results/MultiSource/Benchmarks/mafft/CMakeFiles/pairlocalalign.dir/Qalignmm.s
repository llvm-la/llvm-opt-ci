...
.LBB3_24:
	...
	addi.w	$a0, $zero, -1
	xvld	$xr17, $sp, 368                 # 32-byte Folded Reload
	fcvt.d.s	$fa0, $ft9
	st.d	$a0, $sp, 168                   # 8-byte Folded Spill
	move	$ra, $s1
	blt	$s1, $a0, .LBB3_29
...
.LBB3_34:                               # %._crit_edge576
	...
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ld.d	$t5, $a0, %pc_lo12(Q__align.w2)
...
# %bb.124:                              # %.lr.ph586
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB3_155
.LBB3_125:                              # %scalar.ph1138.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_126:                              # %scalar.ph1138
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a2, 0
...
# %bb.128:                              # %.lr.ph589
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB3_161
.LBB3_129:                              # %scalar.ph1173.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a5, $a4, $t4, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB3_130:                              # %scalar.ph1173
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a5, 0
...
.LBB3_135:                              # %vector.body1097
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_135
# %bb.136:                              # %middle.block1101
	beq	$a2, $a4, .LBB3_140
.LBB3_137:                              # %scalar.ph1090.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t4, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_138:                              # %scalar.ph1090
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB3_143:                              # %vector.body1111
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_143
# %bb.144:                              # %middle.block1117
	beq	$a3, $a5, .LBB3_147
.LBB3_145:                              # %scalar.ph1104.preheader
	mul.d	$a3, $a0, $a4
	alsl.d	$a1, $a4, $a1, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_146:                              # %scalar.ph1104
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a1, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB3_148:                              # %iter.check1209
	...
	ori	$a4, $zero, 1
	bltu	$a3, $a5, .LBB3_176
# %bb.149:                              # %vector.memcheck1190
	sub.d	$a5, $a0, $t4
	addi.d	$a5, $a5, 4
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB3_176
# %bb.150:                              # %vector.main.loop.iter.check1193
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_169
# %bb.151:
	move	$a5, $zero
...
.LBB3_155:                              # %vector.memcheck1120
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_125
# %bb.156:                              # %vector.memcheck1120
	addi.d	$t0, $a1, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a1, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_125
# %bb.157:                              # %vector.memcheck1120
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB3_159:                              # %vector.body1143
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB3_159
# %bb.160:                              # %middle.block1152
	bne	$a6, $t1, .LBB3_125
	b	.LBB3_127
.LBB3_161:                              # %vector.memcheck1155
	addi.d	$a6, $t4, 4
	alsl.d	$t0, $a3, $t4, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.162:                              # %vector.memcheck1155
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.163:                              # %vector.memcheck1155
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_169:                              # %vector.ph1195
	...
	move	$a4, $a3
	bstrins.d	$a4, $t0, 3, 0
	xvreplve0.w	$xr0, $xr17
	addi.d	$t0, $a1, 36
	xvrepli.b	$xr1, 0
	xvreplgr2vr.w	$xr2, $s3
	move	$t1, $a5
	.p2align	4, , 16
.LBB3_170:                              # %vector.body1200
                                        # =>This Inner Loop Header: Depth=1
	add.d	$t2, $t0, $a7
	add.d	$t3, $t4, $a7
	xvldx	$xr3, $t4, $a7
	...
	addi.d	$a7, $a7, 64
	bnez	$t1, .LBB3_170
# %bb.171:                              # %middle.block1205
	beq	$a3, $a5, .LBB3_178
# %bb.172:                              # %vec.epilog.iter.check1211
	beqz	$a6, .LBB3_176
.LBB3_173:                              # %vec.epilog.ph1213
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	bstrins.d	$a4, $a7, 1, 0
	vreplvei.w	$vr0, $vr17, 0
	addi.d	$a7, $a1, 4
	slli.d	$t0, $a5, 2
	sub.d	$a5, $a5, $a6
	vrepli.b	$vr1, 0
	vreplgr2vr.w	$vr2, $s3
	.p2align	4, , 16
.LBB3_174:                              # %vec.epilog.vector.body1218
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t4, $t0
	vstx	$vr1, $a7, $t0
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_174
# %bb.175:                              # %vec.epilog.middle.block1222
	beq	$a3, $a6, .LBB3_178
.LBB3_176:                              # %vec.epilog.scalar.ph1210.preheader
	slli.d	$a3, $a4, 2
	addi.d	$a5, $t4, -4
	sub.d	$a2, $a2, $a4
	movgr2fr.w	$fa0, $s3
	.p2align	4, , 16
.LBB3_177:                              # %vec.epilog.scalar.ph1210
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a5, $a3
	stx.w	$zero, $a1, $a3
	fmadd.s	$fa1, $ft9, $fa0, $fa1
	fstx.s	$fa1, $a0, $a3
	addi.d	$a2, $a2, -1
	addi.d	$a3, $a3, 4
	bnez	$a2, .LBB3_177
...
# %bb.181:                              # %.lr.ph630
	ld.d	$a1, $sp, 352                   # 8-byte Folded Reload
	ld.d	$t3, $a1, %pc_lo12(Q__align.initverticalw)
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Q__align.cpmx1)
...
.LBB3_187:                              # %iter.check1253
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_190
# %bb.188:                              # %vector.memcheck1225
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_201
# %bb.189:                              # %vector.memcheck1225
                                        #   in Loop: Header=BB3_183 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_201
...
# %bb.200:                              #   in Loop: Header=BB3_195 Depth=2
	...
	stx.w	$t7, $fp, $a3
	b	.LBB3_194
.LBB3_201:                              # %vector.main.loop.iter.check1233
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_203
...
.LBB3_204:                              # %vector.body1238
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB3_204
# %bb.205:                              # %middle.block1247
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 128                   # 8-byte Folded Reload
	beq	$a3, $a4, .LBB3_192
# %bb.206:                              # %vec.epilog.iter.check1255
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a5, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a4, $sp, 32                    # 8-byte Folded Reload
	beqz	$a4, .LBB3_191
.LBB3_207:                              # %vec.epilog.ph1257
                                        #   in Loop: Header=BB3_183 Depth=1
	...
	alsl.d	$a2, $a5, $a2, 2
	.p2align	4, , 16
.LBB3_208:                              # %vec.epilog.vector.body1260
                                        #   Parent Loop BB3_183 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a4, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a3, .LBB3_208
# %bb.209:                              # %vec.epilog.middle.block1267
                                        #   in Loop: Header=BB3_183 Depth=1
...
.LBB3_210:
	...
	bnez	$a1, .LBB3_226
	b	.LBB3_212
.LBB3_211:                              # %._crit_edge631.loopexit
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.w	$a1, $a0, 0
	move	$t4, $t2
...
.LBB3_215:                              # %vector.body1281
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_215
# %bb.216:                              # %middle.block1287
	beq	$a2, $a4, .LBB3_219
.LBB3_217:                              # %scalar.ph1272.preheader
	sub.w	$a2, $s6, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t4, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_222:                              # %vector.body1299
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_222
# %bb.223:                              # %middle.block1305
	beq	$a3, $a4, .LBB3_226
.LBB3_224:                              # %scalar.ph1290.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_225:                              # %scalar.ph1290
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.230:                              # %.lr.ph.i538
	...
	b	.LBB3_232
	.p2align	4, , 16
.LBB3_231:                              #   in Loop: Header=BB3_232 Depth=1
	addi.d	$a4, $a4, -1
	addi.d	$a5, $a5, -1
	addi.d	$s3, $s3, 4
	beqz	$a4, .LBB3_234
...
.LBB3_243:                              # %vector.body1313
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_243
# %bb.244:                              # %middle.block1320
	beq	$a1, $a3, .LBB3_247
.LBB3_245:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $ra, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a0, $a3, 1
	.p2align	4, , 16
.LBB3_246:                              # %.lr.ph10.i
	...
	addi.d	$a0, $a0, 1
	bnez	$a1, .LBB3_246
.LBB3_247:                              # %.preheader1.i
	ld.d	$a0, $sp, 576
	st.d	$a0, $sp, 440                   # 8-byte Folded Spill
	bltz	$a2, .LBB3_261
# %bb.248:                              # %iter.check1339
	ld.d	$a3, $ra, 0
	ld.d	$a0, $sp, 448                   # 8-byte Folded Reload
	addi.d	$a6, $a0, 1
...
# %bb.249:
	move	$a5, $zero
	b	.LBB3_259
.LBB3_250:                              # %vector.main.loop.iter.check1325
	ori	$a0, $zero, 16
	bgeu	$a4, $a0, .LBB3_252
# %bb.251:
	move	$a5, $zero
	b	.LBB3_256
.LBB3_252:                              # %vector.ph1327
	andi	$a7, $a6, 12
...
.LBB3_253:                              # %vector.body1330
	...
	addi.d	$t0, $t0, 64
	bnez	$a0, .LBB3_253
# %bb.254:                              # %middle.block1336
	beq	$a4, $a5, .LBB3_261
# %bb.255:                              # %vec.epilog.iter.check1341
	beqz	$a7, .LBB3_259
.LBB3_256:                              # %vec.epilog.ph1343
	move	$a1, $a5
	...
	alsl.d	$a6, $a1, $a3, 2
	.p2align	4, , 16
.LBB3_257:                              # %vec.epilog.vector.body1348
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a0, .LBB3_257
# %bb.258:                              # %vec.epilog.middle.block1353
	beq	$a4, $a5, .LBB3_261
.LBB3_259:                              # %vec.epilog.scalar.ph1340.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a0, $a4, $a5
	.p2align	4, , 16
.LBB3_260:                              # %vec.epilog.scalar.ph1340
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, -1
...
# %bb.264:                              #   in Loop: Header=BB3_263 Depth=1
	beqz	$t4, .LBB3_278
# %bb.265:                              #   in Loop: Header=BB3_263 Depth=1
	sub.d	$t1, $s7, $t4
	move	$t4, $a4
	nor	$t8, $t1, $zero
	add.w	$s8, $s7, $t8
	beqz	$s8, .LBB3_271
.LBB3_266:                              # %iter.check1420
                                        #   in Loop: Header=BB3_263 Depth=1
	ori	$a0, $zero, 16
	bltu	$s8, $a0, .LBB3_276
# %bb.267:                              # %iter.check1420
                                        #   in Loop: Header=BB3_263 Depth=1
	sub.d	$a0, $s5, $s3
	bltu	$a0, $a1, .LBB3_276
# %bb.268:                              # %vector.main.loop.iter.check1404
                                        #   in Loop: Header=BB3_263 Depth=1
	bstrpick.d	$s2, $s8, 31, 0
	bgeu	$s8, $a1, .LBB3_279
# %bb.269:                              #   in Loop: Header=BB3_263 Depth=1
	move	$a1, $zero
	b	.LBB3_283
	.p2align	4, , 16
.LBB3_270:                              #   in Loop: Header=BB3_263 Depth=1
	addi.d	$t1, $s7, -1
	nor	$t8, $t1, $zero
	add.w	$s8, $s7, $t8
	bnez	$s8, .LBB3_266
	.p2align	4, , 16
.LBB3_271:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_263 Depth=1
	beq	$t4, $a4, .LBB3_288
.LBB3_272:                              # %iter.check1379
                                        #   in Loop: Header=BB3_263 Depth=1
	addi.w	$a0, $zero, -5
	nor	$s1, $t4, $zero
	bltu	$a0, $t4, .LBB3_277
# %bb.273:                              # %iter.check1379
                                        #   in Loop: Header=BB3_263 Depth=1
	sub.d	$a0, $s5, $s3
	ori	$a1, $zero, 16
	bltu	$a0, $a1, .LBB3_277
# %bb.274:                              # %vector.main.loop.iter.check1362
                                        #   in Loop: Header=BB3_263 Depth=1
	addi.w	$a0, $zero, -17
	bgeu	$a0, $t4, .LBB3_289
# %bb.275:                              #   in Loop: Header=BB3_263 Depth=1
	move	$s2, $zero
	b	.LBB3_293
	.p2align	4, , 16
.LBB3_276:                              #   in Loop: Header=BB3_263 Depth=1
	move	$fp, $s8
	move	$s0, $s3
	move	$s1, $s5
	b	.LBB3_286
	.p2align	4, , 16
.LBB3_277:                              #   in Loop: Header=BB3_263 Depth=1
	move	$s0, $s1
	move	$t8, $s3
	move	$fp, $s5
	b	.LBB3_296
	.p2align	4, , 16
.LBB3_278:                              #   in Loop: Header=BB3_263 Depth=1
	addi.d	$t1, $s7, -1
	move	$t4, $a4
	nor	$t8, $t1, $zero
	add.w	$s8, $s7, $t8
...
.LBB3_279:                              # %vector.ph1406
	...
	move	$ra, $a1
	.p2align	4, , 16
.LBB3_280:                              # %vector.body1409
                                        #   Parent Loop BB3_263 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvst	$xr4, $a4, 0
	xvst	$xr4, $a4, -32
	xvst	$xr5, $a0, 0
	...
	addi.d	$a0, $a0, -64
	bnez	$ra, .LBB3_280
# %bb.281:                              # %middle.block1414
                                        #   in Loop: Header=BB3_263 Depth=1
	ld.d	$a4, $sp, 168                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 432                   # 8-byte Folded Reload
	beq	$a1, $s2, .LBB3_287
# %bb.282:                              # %vec.epilog.iter.check1422
                                        #   in Loop: Header=BB3_263 Depth=1
	beqz	$a7, .LBB3_286
.LBB3_283:                              # %vec.epilog.ph1424
                                        #   in Loop: Header=BB3_263 Depth=1
	...
	addi.d	$a4, $a1, -16
	.p2align	4, , 16
.LBB3_284:                              # %vec.epilog.vector.body1427
                                        #   Parent Loop BB3_263 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $a0, 0
	vst	$vr2, $a4, 0
	...
	addi.d	$a4, $a4, -16
	bnez	$s8, .LBB3_284
# %bb.285:                              # %vec.epilog.middle.block1432
                                        #   in Loop: Header=BB3_263 Depth=1
	ld.d	$a4, $sp, 168                   # 8-byte Folded Reload
	beq	$a7, $s2, .LBB3_287
	.p2align	4, , 16
.LBB3_286:                              # %.lr.ph19.i
	...
	addi.d	$s0, $s0, -1
	bnez	$fp, .LBB3_286
.LBB3_287:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_263 Depth=1
	add.d	$a0, $s7, $t7
	add.d	$t7, $t8, $a0
	move	$s5, $s1
	move	$s3, $s0
	bne	$t4, $a4, .LBB3_272
.LBB3_288:                              #   in Loop: Header=BB3_263 Depth=1
	move	$fp, $s5
	move	$t8, $s3
	ld.d	$a0, $sp, 464                   # 8-byte Folded Reload
	bne	$t2, $a0, .LBB3_299
	b	.LBB3_301
.LBB3_289:                              # %vector.ph1364
                                        #   in Loop: Header=BB3_263 Depth=1
	andi	$s7, $s1, 12
...
# %bb.291:                              # %middle.block1373
	...
	beq	$s2, $s1, .LBB3_298
# %bb.292:                              # %vec.epilog.iter.check1381
                                        #   in Loop: Header=BB3_263 Depth=1
	beqz	$s7, .LBB3_296
.LBB3_293:                              # %vec.epilog.ph1383
                                        #   in Loop: Header=BB3_263 Depth=1
	...
	addi.d	$s2, $a0, -4
	.p2align	4, , 16
.LBB3_294:                              # %vec.epilog.vector.body1386
                                        #   Parent Loop BB3_263 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a5, $t7, 0
	st.w	$a6, $s2, 0
	...
	addi.d	$s2, $s2, -4
	bnez	$a7, .LBB3_294
# %bb.295:                              # %vec.epilog.middle.block1392
                                        #   in Loop: Header=BB3_263 Depth=1
...
.LBB3_299:                              # %._crit_edge30.i
	...
	addi.w	$a0, $a0, 0
	beq	$t3, $a0, .LBB3_301
# %bb.300:                              #   in Loop: Header=BB3_263 Depth=1
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(impmtx)
	ldx.d	$a0, $a0, $t5
	fldx.s	$fa6, $a0, $t6
	...
	fadd.s	$fa6, $fa6, $fa7
	fst.s	$fa6, $a0, 0
.LBB3_301:                              #   in Loop: Header=BB3_263 Depth=1
	ori	$a1, $zero, 64
	blez	$t2, .LBB3_305
# %bb.302:                              #   in Loop: Header=BB3_263 Depth=1
	blez	$t3, .LBB3_305
# %bb.303:                              #   in Loop: Header=BB3_263 Depth=1
	add.d	$t0, $t4, $t0
	addi.d	$s5, $fp, -1
	st.b	$a2, $fp, -1
	addi.d	$s3, $t8, -1
...
.LBB3_307:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_307
.LBB3_308:                              # %.preheader.i
	ld.d	$s7, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 208                   # 8-byte Folded Reload
	blez	$s7, .LBB3_311
# %bb.309:                              # %.lr.ph52.preheader.i
	move	$fp, $s5
	move	$s0, $s7
	.p2align	4, , 16
.LBB3_310:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB3_310
.LBB3_311:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 424                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
.LBB3_323:                              # %vector.body1065
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_323
# %bb.324:                              # %middle.block1073
	beq	$a0, $a5, .LBB3_122
# %bb.325:                              # %vec.epilog.iter.check
	beqz	$a6, .LBB3_121
.LBB3_326:                              # %vec.epilog.ph
	...
	alsl.d	$a4, $a5, $a4, 2
	.p2align	4, , 16
.LBB3_327:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vld	$vr1, $t0, 0
	vfadd.s	$vr0, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a7, .LBB3_327
# %bb.328:                              # %vec.epilog.middle.block
	bne	$a0, $a6, .LBB3_121
	b	.LBB3_122
.LBB3_329:
	ld.d	$s2, $sp, 152                   # 8-byte Folded Reload
...
# %bb.48:                               # %iter.check89
	...
	ori	$a3, $zero, 64
	bltu	$a0, $a3, .LBB5_51
# %bb.49:                               # %vector.main.loop.iter.check73
                                        #   in Loop: Header=BB5_35 Depth=1
...
# %bb.54:                               # %middle.block42
	...
	beq	$t8, $t7, .LBB5_61
# %bb.55:                               # %vec.epilog.iter.check50
                                        #   in Loop: Header=BB5_35 Depth=1
	beqz	$s8, .LBB5_59
.LBB5_56:                               # %vec.epilog.ph52
                                        #   in Loop: Header=BB5_35 Depth=1
	...
	addi.d	$t8, $a0, -4
	.p2align	4, , 16
.LBB5_57:                               # %vec.epilog.vector.body55
                                        #   Parent Loop BB5_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a4, $t3, 0
	st.w	$a5, $t8, 0
	...
	addi.d	$t8, $t8, -4
	bnez	$a3, .LBB5_57
# %bb.58:                               # %vec.epilog.middle.block61
                                        #   in Loop: Header=BB5_35 Depth=1
	vhaddw.d.w	$vr6, $vr6, $vr6
	vhaddw.q.d	$vr6, $vr6, $vr6
...
.LBB5_63:                               # %vector.body78
	...
	addi.d	$a0, $a0, -64
	bnez	$a6, .LBB5_63
# %bb.64:                               # %middle.block83
                                        #   in Loop: Header=BB5_35 Depth=1
	beq	$t1, $t8, .LBB5_70
# %bb.65:                               # %vec.epilog.iter.check91
                                        #   in Loop: Header=BB5_35 Depth=1
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	beqz	$a0, .LBB5_69
.LBB5_66:                               # %vec.epilog.ph93
                                        #   in Loop: Header=BB5_35 Depth=1
	...
	addi.d	$a6, $a6, -16
	.p2align	4, , 16
.LBB5_67:                               # %vec.epilog.vector.body96
                                        #   Parent Loop BB5_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $a0, 0
	vst	$vr2, $a6, 0
	...
	addi.d	$a6, $a6, -16
	bnez	$ra, .LBB5_67
# %bb.68:                               # %vec.epilog.middle.block101
                                        #   in Loop: Header=BB5_35 Depth=1
	beq	$a3, $t8, .LBB5_70
	.p2align	4, , 16
.LBB5_69:                               # %.lr.ph19
...
.LBB6_8:
	...
	blez	$a0, .LBB6_11
# %bb.9:                                # %.lr.ph
	ld.d	$a0, $fp, %pc_lo12(Q__align_gapmap.mseq)
...
.LBB6_24:
	...
	addi.w	$a0, $zero, -1
	xvld	$xr17, $sp, 304                 # 32-byte Folded Reload
	fcvt.d.s	$fa0, $ft9
...
.LBB6_34:                               # %._crit_edge572
	...
	st.d	$a0, $sp, 280                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	ld.d	$t6, $a0, %pc_lo12(Q__align_gapmap.w1)
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
...
# %bb.121:                              # %.lr.ph582
	...
	ori	$a7, $zero, 1
	bgeu	$t0, $t1, .LBB6_151
.LBB6_122:                              # %scalar.ph1084.preheader
	alsl.d	$a5, $a7, $a5, 2
	alsl.d	$a4, $a7, $a4, 2
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB6_123:                              # %scalar.ph1084
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.125:                              # %.lr.ph585
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB6_157
.LBB6_126:                              # %scalar.ph1119.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a7, $a6, $t6, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_127:                              # %scalar.ph1119
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a7, 0
...
.LBB6_155:                              # %vector.body1089
	...
	addi.d	$t2, $t2, 32
	bnez	$t4, .LBB6_155
# %bb.156:                              # %middle.block1098
	ld.d	$t4, $sp, 368                   # 8-byte Folded Reload
	bne	$t0, $t3, .LBB6_122
	b	.LBB6_124
.LBB6_157:                              # %vector.memcheck1101
	addi.d	$t0, $t6, 4
	alsl.d	$t2, $a5, $t6, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
...
.LBB6_161:                              # %vector.body1124
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB6_161
# %bb.162:                              # %middle.block1133
	bne	$a7, $t2, .LBB6_126
	b	.LBB6_128
.LBB6_163:                              # %vector.ph1140
	move	$t1, $zero
	andi	$t0, $a5, 12
	move	$a7, $a5
...
# %bb.176:                              # %.lr.ph626
	...
	ld.d	$t5, $s8, %pc_lo12(Q__align_gapmap.initverticalw)
...
.LBB6_198:                              # %vector.body1171
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_198
# %bb.199:                              # %middle.block1177
	beq	$a2, $a4, .LBB6_202
.LBB6_200:                              # %scalar.ph1162.preheader
	ld.d	$a2, $sp, 344                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t6, 2
...
.LBB6_205:                              # %vector.body1189
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_205
# %bb.206:                              # %middle.block1195
	beq	$a3, $a4, .LBB6_209
.LBB6_207:                              # %scalar.ph1180.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_208:                              # %scalar.ph1180
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
# %bb.232:
	move	$a4, $zero
	b	.LBB6_242
.LBB6_233:                              # %vector.main.loop.iter.check1215
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_235
# %bb.234:
	move	$a4, $zero
	b	.LBB6_239
.LBB6_235:                              # %vector.ph1217
	andi	$a6, $a5, 12
	bstrpick.d	$a4, $a5, 31, 4
...
.LBB6_236:                              # %vector.body1220
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_236
# %bb.237:                              # %middle.block1226
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1231
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1233
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1238
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1243
	beq	$a3, $a4, .LBB6_244
.LBB6_242:                              # %vec.epilog.scalar.ph1230.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_243:                              # %vec.epilog.scalar.ph1230
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.255:                              #   in Loop: Header=BB6_253 Depth=1
	...
	b	.LBB6_258
	.p2align	4, , 16
.LBB6_256:                              #   in Loop: Header=BB6_253 Depth=1
	addi.w	$t2, $s7, -1
	nor	$t7, $t2, $zero
	add.w	$t8, $s7, $t7
	bnez	$t8, .LBB6_260
	b	.LBB6_265
	.p2align	4, , 16
.LBB6_257:                              #   in Loop: Header=BB6_253 Depth=1
	addi.w	$t2, $s7, -1
.LBB6_258:                              #   in Loop: Header=BB6_253 Depth=1
	...
	b	.LBB6_265
	.p2align	4, , 16
.LBB6_259:                              # %._crit_edge29.i
                                        #   in Loop: Header=BB6_260 Depth=2
	addi.d	$t8, $t8, -1
	ld.d	$s6, $sp, 448                   # 8-byte Folded Reload
	ld.d	$s8, $sp, 440                   # 8-byte Folded Reload
	beqz	$t8, .LBB6_264
.LBB6_260:                              # %.preheader3.i
...
.LBB6_263:                              # %.lr.ph28.i
	...
	b	.LBB6_259
	.p2align	4, , 16
.LBB6_264:                              # %._crit_edge32.loopexit.i
                                        #   in Loop: Header=BB6_253 Depth=1
	add.d	$a4, $s7, $a4
	add.d	$a4, $t7, $a4
.LBB6_265:                              # %._crit_edge32.i
                                        #   in Loop: Header=BB6_253 Depth=1
	add.w	$t1, $t6, $t1
	ld.d	$s7, $sp, 152                   # 8-byte Folded Reload
	ld.d	$t7, $sp, 296                   # 8-byte Folded Reload
	beq	$t6, $t7, .LBB6_272
# %bb.266:                              # %.preheader1.preheader.i
                                        #   in Loop: Header=BB6_253 Depth=1
	nor	$t6, $t6, $zero
	b	.LBB6_268
	.p2align	4, , 16
.LBB6_267:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB6_268 Depth=2
	addi.d	$t6, $t6, -1
	addi.d	$a4, $a4, 1
	beqz	$t6, .LBB6_272
.LBB6_268:                              # %.preheader1.i
                                        #   Parent Loop BB6_253 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB6_269 Depth 3
                                        #       Child Loop BB6_271 Depth 3
...
.LBB6_271:                              # %.lr.ph37.i
	...
	b	.LBB6_267
	.p2align	4, , 16
.LBB6_272:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB6_253 Depth=1
	beq	$t3, $a1, .LBB6_275
# %bb.273:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB6_253 Depth=1
	addi.w	$t6, $a0, 0
	beq	$t4, $t6, .LBB6_275
# %bb.274:                              #   in Loop: Header=BB6_253 Depth=1
	slli.d	$t6, $t3, 2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a3, 0
.LBB6_275:                              #   in Loop: Header=BB6_253 Depth=1
	blez	$t3, .LBB6_284
# %bb.276:                              #   in Loop: Header=BB6_253 Depth=1
	blez	$t4, .LBB6_284
# %bb.277:                              # %.preheader5.i
                                        #   in Loop: Header=BB6_253 Depth=1
	blez	$s6, .LBB6_280
# %bb.278:                              # %.lr.ph44.i
	...
	move	$t5, $a6
	.p2align	4, , 16
.LBB6_279:                              #   Parent Loop BB6_253 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $t3, 0
	ld.d	$t7, $t4, 0
	ldx.b	$t6, $t6, $t2
...
# %bb.281:                              # %.lr.ph46.i
	...
	move	$t5, $a7
	.p2align	4, , 16
.LBB6_282:                              #   Parent Loop BB6_253 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $s7, 0
	ld.d	$t7, $t4, 0
	ldx.b	$t6, $t6, $t1
