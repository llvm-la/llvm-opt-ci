...
.LBB3_24:
	...
	addi.w	$s8, $zero, -1
	xvld	$xr18, $sp, 368                 # 32-byte Folded Reload
	fcvt.d.s	$fa0, $ft10
	move	$ra, $s1
	blt	$s1, $s8, .LBB3_29
# %bb.25:                               # %.lr.ph571
...
.LBB3_75:                               # %vector.body
	...
	xvld	$xr11, $t4, 0
	xvpermi.q	$xr7, $xr9, 2
	xvfsub.d	$xr8, $xr3, $xr6
	xvfsub.d	$xr9, $xr3, $xr7
	...
	xvfsub.d	$xr13, $xr9, $xr11
	xvfmul.d	$xr12, $xr12, $xr1
	xvfmul.d	$xr13, $xr13, $xr1
	xvfmul.d	$xr12, $xr12, $xr4
	xvfmul.d	$xr13, $xr13, $xr4
	xvld	$xr14, $t6, 0
	xvfcvt.s.d	$xr12, $xr12, $xr13
	xvperm.w	$xr12, $xr12, $xr2
	xvst	$xr12, $t5, 0
	...
	xvfsub.d	$xr13, $xr3, $xr12
	xvfsub.d	$xr15, $xr13, $xr10
	...
	xvfsub.d	$xr16, $xr3, $xr14
	xvfsub.d	$xr17, $xr16, $xr11
	xvfmul.d	$xr15, $xr15, $xr1
	xvfmul.d	$xr17, $xr17, $xr1
	xvfmul.d	$xr15, $xr15, $xr4
	xvfmul.d	$xr17, $xr17, $xr4
	xvfcvt.s.d	$xr15, $xr15, $xr17
	xvperm.w	$xr15, $xr15, $xr2
	xvst	$xr15, $t7, 0
	xvfadd.d	$xr8, $xr8, $xr12
	xvfadd.d	$xr9, $xr9, $xr14
	xvfsub.d	$xr8, $xr8, $xr10
	xvfsub.d	$xr9, $xr9, $xr11
	xvfmul.d	$xr8, $xr8, $xr4
	xvfmul.d	$xr9, $xr9, $xr4
	xvfmul.d	$xr8, $xr8, $xr1
	xvfmul.d	$xr9, $xr9, $xr1
	xvfcvt.s.d	$xr8, $xr8, $xr9
	xvperm.w	$xr8, $xr8, $xr2
	xvst	$xr8, $t8, 0
	xvfadd.d	$xr6, $xr13, $xr6
	xvfadd.d	$xr7, $xr16, $xr7
	xvfsub.d	$xr6, $xr6, $xr10
	xvfsub.d	$xr7, $xr7, $xr11
	...
	xvperm.w	$xr6, $xr6, $xr2
	xvst	$xr6, $fp, 0
	xvfsub.s	$xr6, $xr5, $xr8
	xvst	$xr6, $s1, 0
	addi.d	$s2, $s2, -8
	addi.d	$s1, $s1, 32
	addi.d	$s0, $s0, 32
...
# %bb.142:                              # %vector.ph1109
	...
	move	$a4, $a3
	bstrins.d	$a4, $a6, 2, 0
	pcalau12i	$a6, %pc_hi20(.LCPI3_2)
	xvld	$xr0, $a6, %pc_lo12(.LCPI3_2)
...
# %bb.171:                              # %middle.block1217
	beq	$a3, $a4, .LBB3_178
# %bb.172:                              # %vec.epilog.iter.check1221
	beqz	$a5, .LBB3_319
.LBB3_173:                              # %vec.epilog.ph1223
	move	$a6, $a3
	...
	vreplgr2vr.w	$vr2, $s3
	.p2align	4, , 16
.LBB3_174:                              # %vec.epilog.vector.body1228
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t3, $t0
	vstx	$vr1, $a7, $t0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB3_174
# %bb.175:                              # %vec.epilog.middle.block1233
	beq	$a3, $a6, .LBB3_178
...
.LBB3_187:                              # %iter.check1246
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_190
# %bb.188:                              # %vector.memcheck1237
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_201
# %bb.189:                              # %vector.memcheck1237
                                        #   in Loop: Header=BB3_183 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_201
...
# %bb.200:                              #   in Loop: Header=BB3_195 Depth=2
	...
	stx.w	$t7, $fp, $a3
	b	.LBB3_194
.LBB3_201:                              # %vector.main.loop.iter.check1248
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_203
# %bb.202:                              #   in Loop: Header=BB3_183 Depth=1
	move	$a4, $zero
	b	.LBB3_207
.LBB3_203:                              # %vector.body1252.preheader
                                        #   in Loop: Header=BB3_183 Depth=1
	addi.d	$a0, $t2, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 136                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_204:                              # %vector.body1252
                                        #   Parent Loop BB3_183 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
...
.LBB3_208:                              # %vec.epilog.vector.body1271
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_208
# %bb.209:                              # %vec.epilog.middle.block1280
                                        #   in Loop: Header=BB3_183 Depth=1
...
# %bb.215:                              # %vector.ph1291
	...
	pcalau12i	$a5, %pc_hi20(.LCPI3_1)
	xvld	$xr3, $a5, %pc_lo12(.LCPI3_1)
	xvreplgr2vr.d	$xr4, $s6
	addi.d	$a5, $t3, 4
	xvldi	$xr5, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB3_216:                              # %vector.body1298
                                        # =>This Inner Loop Header: Depth=1
	xvsub.d	$xr6, $xr4, $xr1
	xvsub.d	$xr7, $xr4, $xr2
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_216
# %bb.217:                              # %middle.block1305
	beq	$a2, $a4, .LBB3_220
.LBB3_218:                              # %scalar.ph1289.preheader
	sub.w	$a2, $s6, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_223:                              # %vector.body1317
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_223
# %bb.224:                              # %middle.block1324
	beq	$a3, $a4, .LBB3_227
.LBB3_225:                              # %scalar.ph1308.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_226:                              # %scalar.ph1308
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.250:
	move	$a5, $zero
	b	.LBB3_260
.LBB3_251:                              # %vector.main.loop.iter.check1347
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_253
# %bb.252:
	move	$a5, $zero
	b	.LBB3_257
.LBB3_253:                              # %vector.ph1348
	andi	$a7, $a6, 12
	bstrpick.d	$a5, $a6, 31, 4
	slli.d	$a5, $a5, 4
	pcalau12i	$t0, %pc_hi20(.LCPI3_7)
	xvld	$xr0, $t0, %pc_lo12(.LCPI3_7)
	addi.d	$t0, $a3, 32
	xvrepli.b	$xr1, -1
	xvrepli.w	$xr2, -9
	move	$t1, $a5
	.p2align	4, , 16
.LBB3_254:                              # %vector.body1351
                                        # =>This Inner Loop Header: Depth=1
	xvxor.v	$xr3, $xr0, $xr1
	xvsub.w	$xr4, $xr2, $xr0
	xvst	$xr3, $t0, -32
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_254
# %bb.255:                              # %middle.block1357
	beq	$a4, $a5, .LBB3_262
# %bb.256:                              # %vec.epilog.iter.check1361
	beqz	$a7, .LBB3_260
.LBB3_257:                              # %vec.epilog.ph1363
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_258:                              # %vec.epilog.vector.body1368
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_258
# %bb.259:                              # %vec.epilog.middle.block1373
	beq	$a4, $a5, .LBB3_262
.LBB3_260:                              # %vec.epilog.scalar.ph1360.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_261:                              # %vec.epilog.scalar.ph1360
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_279:                              #   in Loop: Header=BB3_264 Depth=1
	move	$t8, $s5
	move	$fp, $s3
.LBB3_280:                              # %.lr.ph19.i.preheader1424
                                        #   in Loop: Header=BB3_264 Depth=1
	move	$s0, $t8
	move	$s1, $fp
	.p2align	4, , 16
...
.LBB6_24:
	...
	addi.w	$a0, $zero, -1
	xvld	$xr18, $sp, 304                 # 32-byte Folded Reload
	fcvt.d.s	$fa0, $ft10
...
# %bb.138:                              # %vector.ph1052
	...
	xvld	$xr0, $t0, %pc_lo12(.LCPI6_2)
	pcalau12i	$t0, %pc_hi20(.LCPI6_1)
	xvld	$xr1, $t0, %pc_lo12(.LCPI6_1)
	xvreplgr2vr.w	$xr2, $a2
	addi.d	$t0, $a3, 4
	xvldi	$xr3, -800
	move	$t1, $a7
...
.LBB6_198:                              # %vector.body1179
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_198
# %bb.199:                              # %middle.block1186
	beq	$a2, $a4, .LBB6_202
.LBB6_200:                              # %scalar.ph1170.preheader
	ld.d	$a2, $sp, 344                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t5, 2
...
.LBB6_205:                              # %vector.body1198
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_205
# %bb.206:                              # %middle.block1205
	beq	$a3, $a4, .LBB6_209
.LBB6_207:                              # %scalar.ph1189.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_208:                              # %scalar.ph1189
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
# %bb.232:
	move	$a4, $zero
	b	.LBB6_242
.LBB6_233:                              # %vector.main.loop.iter.check1228
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_235
# %bb.234:
	move	$a4, $zero
	b	.LBB6_239
.LBB6_235:                              # %vector.ph1229
	andi	$a6, $a5, 12
	bstrpick.d	$a4, $a5, 31, 4
	slli.d	$a4, $a4, 4
	pcalau12i	$a7, %pc_hi20(.LCPI6_7)
	xvld	$xr0, $a7, %pc_lo12(.LCPI6_7)
	addi.d	$a7, $a2, 32
	xvrepli.b	$xr1, -1
	xvrepli.w	$xr2, -9
	move	$t0, $a4
	.p2align	4, , 16
.LBB6_236:                              # %vector.body1232
                                        # =>This Inner Loop Header: Depth=1
	xvxor.v	$xr3, $xr0, $xr1
	xvsub.w	$xr4, $xr2, $xr0
	xvst	$xr3, $a7, -32
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_236
# %bb.237:                              # %middle.block1238
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1242
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1244
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1249
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1254
	beq	$a3, $a4, .LBB6_244
.LBB6_242:                              # %vec.epilog.scalar.ph1241.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_243:                              # %vec.epilog.scalar.ph1241
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
