...
# %bb.128:                              # %.lr.ph589
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB3_161
.LBB3_129:                              # %scalar.ph1178.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a5, $a4, $t4, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB3_130:                              # %scalar.ph1178
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a5, 0
...
.LBB3_148:                              # %iter.check1216
	...
	ori	$a4, $zero, 1
	bltu	$a3, $a5, .LBB3_176
# %bb.149:                              # %vector.memcheck1196
	sub.d	$a5, $a0, $t4
	addi.d	$a5, $a5, 4
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB3_176
# %bb.150:                              # %vector.main.loop.iter.check1199
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_169
# %bb.151:
	move	$a5, $zero
...
.LBB3_159:                              # %vector.body1147
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB3_159
# %bb.160:                              # %middle.block1157
	bne	$a6, $t1, .LBB3_125
	b	.LBB3_127
.LBB3_161:                              # %vector.memcheck1160
	addi.d	$a6, $t4, 4
	alsl.d	$t0, $a3, $t4, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.162:                              # %vector.memcheck1160
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.163:                              # %vector.memcheck1160
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_170:                              # %vector.body1206
	...
	addi.d	$a7, $a7, 64
	bnez	$t1, .LBB3_170
# %bb.171:                              # %middle.block1212
	beq	$a3, $a5, .LBB3_178
# %bb.172:                              # %vec.epilog.iter.check1218
	beqz	$a6, .LBB3_176
.LBB3_173:                              # %vec.epilog.ph1220
	move	$a6, $a3
	...
	vreplgr2vr.w	$vr2, $s3
	.p2align	4, , 16
.LBB3_174:                              # %vec.epilog.vector.body1225
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t4, $t0
	vstx	$vr1, $a7, $t0
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_174
# %bb.175:                              # %vec.epilog.middle.block1229
	beq	$a3, $a6, .LBB3_178
.LBB3_176:                              # %vec.epilog.scalar.ph1217.preheader
	slli.d	$a3, $a4, 2
	addi.d	$a5, $t4, -4
	sub.d	$a2, $a2, $a4
	movgr2fr.w	$fa0, $s3
	.p2align	4, , 16
.LBB3_177:                              # %vec.epilog.scalar.ph1217
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a5, $a3
	stx.w	$zero, $a1, $a3
...
.LBB3_187:                              # %iter.check1263
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_190
# %bb.188:                              # %vector.memcheck1232
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_201
# %bb.189:                              # %vector.memcheck1232
                                        #   in Loop: Header=BB3_183 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_201
...
# %bb.200:                              #   in Loop: Header=BB3_195 Depth=2
	...
	stx.w	$t7, $fp, $a3
	b	.LBB3_194
.LBB3_201:                              # %vector.main.loop.iter.check1240
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_203
...
.LBB3_204:                              # %vector.body1246
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB3_204
# %bb.205:                              # %middle.block1257
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 128                   # 8-byte Folded Reload
	beq	$a3, $a4, .LBB3_192
# %bb.206:                              # %vec.epilog.iter.check1265
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a4, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a5, $sp, 32                    # 8-byte Folded Reload
	beqz	$a5, .LBB3_191
.LBB3_207:                              # %vec.epilog.ph1267
                                        #   in Loop: Header=BB3_183 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB3_208:                              # %vec.epilog.vector.body1271
                                        #   Parent Loop BB3_183 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_208
# %bb.209:                              # %vec.epilog.middle.block1278
                                        #   in Loop: Header=BB3_183 Depth=1
...
.LBB3_215:                              # %vector.body1292
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_215
# %bb.216:                              # %middle.block1299
	beq	$a2, $a4, .LBB3_219
.LBB3_217:                              # %scalar.ph1283.preheader
	sub.w	$a2, $s6, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t4, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_222:                              # %vector.body1311
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_222
# %bb.223:                              # %middle.block1318
	beq	$a3, $a4, .LBB3_226
.LBB3_224:                              # %scalar.ph1302.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_225:                              # %scalar.ph1302
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.249:
	move	$a5, $zero
	b	.LBB3_259
.LBB3_250:                              # %vector.main.loop.iter.check1338
	ori	$a0, $zero, 16
	bgeu	$a4, $a0, .LBB3_252
# %bb.251:
	move	$a5, $zero
	b	.LBB3_256
.LBB3_252:                              # %vector.ph1340
	andi	$a7, $a6, 12
...
.LBB3_253:                              # %vector.body1343
	...
	addi.d	$t0, $t0, 64
	bnez	$a0, .LBB3_253
# %bb.254:                              # %middle.block1349
	beq	$a4, $a5, .LBB3_261
# %bb.255:                              # %vec.epilog.iter.check1354
	beqz	$a7, .LBB3_259
.LBB3_256:                              # %vec.epilog.ph1356
	move	$a1, $a5
	...
	alsl.d	$a6, $a1, $a3, 2
	.p2align	4, , 16
.LBB3_257:                              # %vec.epilog.vector.body1361
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a0, .LBB3_257
# %bb.258:                              # %vec.epilog.middle.block1366
	beq	$a4, $a5, .LBB3_261
.LBB3_259:                              # %vec.epilog.scalar.ph1353.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a0, $a4, $a5
	.p2align	4, , 16
.LBB3_260:                              # %vec.epilog.scalar.ph1353
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, -1
...
# %bb.265:                              #   in Loop: Header=BB3_263 Depth=1
	...
	add.w	$s8, $s7, $t8
	beqz	$s8, .LBB3_271
.LBB3_266:                              # %iter.check1440
                                        #   in Loop: Header=BB3_263 Depth=1
	ori	$a0, $zero, 16
	bltu	$s8, $a0, .LBB3_276
# %bb.267:                              # %iter.check1440
                                        #   in Loop: Header=BB3_263 Depth=1
	sub.d	$a0, $s5, $s3
	bltu	$a0, $a1, .LBB3_276
# %bb.268:                              # %vector.main.loop.iter.check1421
                                        #   in Loop: Header=BB3_263 Depth=1
...
.LBB3_271:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_263 Depth=1
	beq	$t4, $a4, .LBB3_288
.LBB3_272:                              # %iter.check1395
                                        #   in Loop: Header=BB3_263 Depth=1
	addi.w	$a0, $zero, -5
	nor	$s1, $t4, $zero
	bltu	$a0, $t4, .LBB3_277
# %bb.273:                              # %iter.check1395
                                        #   in Loop: Header=BB3_263 Depth=1
	sub.d	$a0, $s5, $s3
	ori	$a1, $zero, 16
	bltu	$a0, $a1, .LBB3_277
# %bb.274:                              # %vector.main.loop.iter.check1375
                                        #   in Loop: Header=BB3_263 Depth=1
	addi.w	$a0, $zero, -17
	bgeu	$a0, $t4, .LBB3_289
...
.LBB3_280:                              # %vector.body1427
	...
	addi.d	$a0, $a0, -64
	bnez	$ra, .LBB3_280
# %bb.281:                              # %middle.block1434
                                        #   in Loop: Header=BB3_263 Depth=1
	ld.d	$a4, $sp, 168                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 432                   # 8-byte Folded Reload
	beq	$a1, $s2, .LBB3_287
# %bb.282:                              # %vec.epilog.iter.check1442
                                        #   in Loop: Header=BB3_263 Depth=1
	beqz	$a7, .LBB3_286
.LBB3_283:                              # %vec.epilog.ph1444
                                        #   in Loop: Header=BB3_263 Depth=1
	...
	addi.d	$a4, $a1, -16
	.p2align	4, , 16
.LBB3_284:                              # %vec.epilog.vector.body1448
                                        #   Parent Loop BB3_263 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $a0, 0
	vst	$vr2, $a4, 0
	...
	addi.d	$a4, $a4, -16
	bnez	$s8, .LBB3_284
# %bb.285:                              # %vec.epilog.middle.block1453
                                        #   in Loop: Header=BB3_263 Depth=1
	ld.d	$a4, $sp, 168                   # 8-byte Folded Reload
	beq	$a7, $s2, .LBB3_287
	.p2align	4, , 16
...
# %bb.291:                              # %middle.block1389
	...
	beq	$s2, $s1, .LBB3_298
# %bb.292:                              # %vec.epilog.iter.check1397
                                        #   in Loop: Header=BB3_263 Depth=1
	beqz	$s7, .LBB3_296
.LBB3_293:                              # %vec.epilog.ph1399
                                        #   in Loop: Header=BB3_263 Depth=1
	...
	addi.d	$s2, $a0, -4
	.p2align	4, , 16
.LBB3_294:                              # %vec.epilog.vector.body1403
                                        #   Parent Loop BB3_263 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a5, $t7, 0
	st.w	$a6, $s2, 0
	...
	addi.d	$s2, $s2, -4
	bnez	$a7, .LBB3_294
# %bb.295:                              # %vec.epilog.middle.block1409
                                        #   in Loop: Header=BB3_263 Depth=1
...
# %bb.125:                              # %.lr.ph585
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB6_157
.LBB6_126:                              # %scalar.ph1121.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a7, $a6, $t6, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_127:                              # %scalar.ph1121
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a7, 0
...
.LBB6_155:                              # %vector.body1090
	...
	addi.d	$t2, $t2, 32
	bnez	$t4, .LBB6_155
# %bb.156:                              # %middle.block1100
	ld.d	$t4, $sp, 368                   # 8-byte Folded Reload
	bne	$t0, $t3, .LBB6_122
	b	.LBB6_124
.LBB6_157:                              # %vector.memcheck1103
	addi.d	$t0, $t6, 4
	alsl.d	$t2, $a5, $t6, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_126
# %bb.158:                              # %vector.memcheck1103
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_126
# %bb.159:                              # %vector.memcheck1103
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB6_161:                              # %vector.body1126
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB6_161
# %bb.162:                              # %middle.block1136
	bne	$a7, $t2, .LBB6_126
	b	.LBB6_128
.LBB6_163:                              # %vector.ph1143
	move	$t1, $zero
	andi	$t0, $a5, 12
	move	$a7, $a5
...
.LBB6_198:                              # %vector.body1175
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_198
# %bb.199:                              # %middle.block1182
	beq	$a2, $a4, .LBB6_202
.LBB6_200:                              # %scalar.ph1166.preheader
	ld.d	$a2, $sp, 344                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t6, 2
...
.LBB6_205:                              # %vector.body1194
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_205
# %bb.206:                              # %middle.block1201
	beq	$a3, $a4, .LBB6_209
.LBB6_207:                              # %scalar.ph1185.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_208:                              # %scalar.ph1185
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
# %bb.232:
	move	$a4, $zero
	b	.LBB6_242
.LBB6_233:                              # %vector.main.loop.iter.check1221
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_235
# %bb.234:
	move	$a4, $zero
	b	.LBB6_239
.LBB6_235:                              # %vector.ph1223
	andi	$a6, $a5, 12
	bstrpick.d	$a4, $a5, 31, 4
...
.LBB6_236:                              # %vector.body1226
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_236
# %bb.237:                              # %middle.block1232
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1237
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1239
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1244
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1249
	beq	$a3, $a4, .LBB6_244
.LBB6_242:                              # %vec.epilog.scalar.ph1236.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_243:                              # %vec.epilog.scalar.ph1236
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
