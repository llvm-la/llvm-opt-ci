...
# %bb.265:                              #   in Loop: Header=BB3_263 Depth=1
	...
	add.w	$t7, $s7, $t6
	beqz	$t7, .LBB3_272
.LBB3_266:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_263 Depth=1
	bltu	$t7, $a5, .LBB3_278
# %bb.267:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_263 Depth=1
	sub.d	$t8, $s3, $s5
	bltu	$t8, $a5, .LBB3_278
# %bb.268:                              # %vector.ph1398
                                        #   in Loop: Header=BB3_263 Depth=1
...
.LBB3_269:                              # %vector.body1402
	...
	addi.d	$s3, $s3, -64
	bnez	$s5, .LBB3_269
# %bb.270:                              # %middle.block1409
                                        #   in Loop: Header=BB3_263 Depth=1
	move	$s2, $a0
	bne	$s1, $s0, .LBB3_279
	b	.LBB3_280
	.p2align	4, , 16
.LBB3_271:                              #   in Loop: Header=BB3_263 Depth=1
	addi.d	$t0, $s7, -1
	nor	$t6, $t0, $zero
	add.w	$t7, $s7, $t6
	bnez	$t7, .LBB3_266
	.p2align	4, , 16
.LBB3_272:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_263 Depth=1
	beq	$t3, $s8, .LBB3_281
.LBB3_273:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_263 Depth=1
	addi.w	$t6, $zero, -17
	nor	$fp, $t3, $zero
	bltu	$t6, $t3, .LBB3_282
# %bb.274:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_263 Depth=1
	sub.d	$t6, $s3, $s5
	bltu	$t6, $a4, .LBB3_282
# %bb.275:                              # %vector.ph1375
                                        #   in Loop: Header=BB3_263 Depth=1
...
.LBB3_279:                              # %.lr.ph19.i
	...
	addi.d	$t8, $t8, -1
	bnez	$t7, .LBB3_279
.LBB3_280:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_263 Depth=1
	add.d	$a7, $s7, $a7
	add.d	$a7, $t6, $a7
	move	$s3, $fp
	move	$s5, $t8
	bne	$t3, $s8, .LBB3_273
.LBB3_281:                              #   in Loop: Header=BB3_263 Depth=1
	move	$t7, $s3
	move	$t6, $s5
	bne	$t1, $ra, .LBB3_286
	b	.LBB3_288
	.p2align	4, , 16
.LBB3_282:                              #   in Loop: Header=BB3_263 Depth=1
	move	$t8, $fp
	move	$t6, $s5
	move	$t7, $s3
.LBB3_283:                              # %.lr.ph29.i.preheader
                                        #   in Loop: Header=BB3_263 Depth=1
	add.d	$a7, $a7, $t8
	.p2align	4, , 16
.LBB3_284:                              # %.lr.ph29.i
	...
	addi.d	$t6, $t6, -1
	bnez	$t8, .LBB3_284
.LBB3_285:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_263 Depth=1
	beq	$t1, $ra, .LBB3_288
.LBB3_286:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_263 Depth=1
	ld.d	$t8, $sp, 456                   # 8-byte Folded Reload
	addi.w	$t8, $t8, 0
	beq	$t2, $t8, .LBB3_288
# %bb.287:                              #   in Loop: Header=BB3_263 Depth=1
...
.LBB3_288:                              #   in Loop: Header=BB3_263 Depth=1
	blez	$t1, .LBB3_293
# %bb.289:                              #   in Loop: Header=BB3_263 Depth=1
	blez	$t2, .LBB3_293
# %bb.290:                              #   in Loop: Header=BB3_263 Depth=1
	add.d	$a6, $t3, $a6
	addi.d	$s3, $t7, -1
	st.b	$a2, $t7, -1
	addi.d	$s5, $t6, -1
	...
	b	.LBB3_292
	.p2align	4, , 16
.LBB3_291:                              #   in Loop: Header=BB3_263 Depth=1
	addi.d	$t0, $s7, -1
	move	$t3, $s8
	nor	$t6, $t0, $zero
	add.w	$t7, $s7, $t6
...
.LBB3_311:                              # %vector.body1065
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_311
# %bb.312:                              # %middle.block1074
	beq	$a0, $a5, .LBB3_122
# %bb.313:                              # %vec.epilog.iter.check
	beqz	$a6, .LBB3_121
.LBB3_314:                              # %vec.epilog.ph
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_315:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vld	$vr1, $a7, 0
	vfadd.s	$vr0, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB3_315
# %bb.316:                              # %vec.epilog.middle.block
	bne	$a0, $a6, .LBB3_121
	b	.LBB3_122
.LBB3_317:
	ld.d	$s2, $sp, 160                   # 8-byte Folded Reload
