...
.LBB2_50:                               # %vector.body945
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_50
# %bb.51:                               # %middle.block951
	beq	$a2, $a4, .LBB2_54
.LBB2_52:                               # %scalar.ph938.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_53:                               # %scalar.ph938
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
# %bb.91:                               #   in Loop: Header=BB2_90 Depth=3
	...
	fmadd.s	$fa7, $ft0, $ft1, $fa7
	b	.LBB2_89
.LBB2_92:                               # %vector.memcheck954
	sub.d	$a5, $t3, $s8
	addi.d	$a5, $a5, 4
	ori	$a6, $zero, 64
	ld.d	$s3, $sp, 32                    # 8-byte Folded Reload
	bltu	$a5, $a6, .LBB2_104
# %bb.93:                               # %vector.main.loop.iter.check957
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB2_97
# %bb.94:
	move	$a5, $zero
...
.LBB2_98:                               # %vector.body964
	...
	addi.d	$a7, $a7, 64
	bnez	$t1, .LBB2_98
# %bb.99:                               # %middle.block969
	beq	$a3, $a5, .LBB2_106
# %bb.100:                              # %vec.epilog.iter.check975
	beqz	$a6, .LBB2_104
.LBB2_101:                              # %vec.epilog.ph977
	move	$a6, $a3
	...
	vreplgr2vr.w	$vr2, $a2
	.p2align	4, , 16
.LBB2_102:                              # %vec.epilog.vector.body982
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $s8, $t0
	vstx	$vr1, $a7, $t0
	vfadd.s	$vr3, $vr3, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB2_102
# %bb.103:                              # %vec.epilog.middle.block986
	beq	$a3, $a6, .LBB2_106
.LBB2_104:                              # %vec.epilog.scalar.ph974.preheader
	slli.d	$a3, $a4, 2
	addi.d	$a5, $s8, -4
	sub.d	$a1, $a1, $a4
	movgr2fr.w	$fa0, $zero
	movgr2fr.w	$fa1, $a2
	.p2align	4, , 16
.LBB2_105:                              # %vec.epilog.scalar.ph974
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa2, $a5, $a3
	stx.w	$zero, $a0, $a3
	fadd.s	$fa2, $fa2, $fa0
...
# %bb.112:                              # %iter.check1017
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB2_115
# %bb.113:                              # %vector.memcheck989
                                        #   in Loop: Header=BB2_111 Depth=1
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$s1, $a0, .LBB2_157
# %bb.114:                              # %vector.memcheck989
                                        #   in Loop: Header=BB2_111 Depth=1
	add.d	$a0, $s1, $a1
	bgeu	$a2, $a0, .LBB2_157
...
# %bb.156:                              #   in Loop: Header=BB2_120 Depth=2
	...
	st.w	$a0, $t3, 0
	b	.LBB2_119
.LBB2_157:                              # %vector.main.loop.iter.check997
                                        #   in Loop: Header=BB2_111 Depth=1
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB2_159
...
.LBB2_160:                              # %vector.body1002
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB2_160
# %bb.161:                              # %middle.block1011
                                        #   in Loop: Header=BB2_111 Depth=1
	ld.d	$a4, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a5, $sp, 200                   # 8-byte Folded Reload
	beq	$a4, $a5, .LBB2_117
# %bb.162:                              # %vec.epilog.iter.check1019
                                        #   in Loop: Header=BB2_111 Depth=1
	ld.d	$a6, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a5, $sp, 128                   # 8-byte Folded Reload
	beqz	$a5, .LBB2_116
.LBB2_163:                              # %vec.epilog.ph1021
                                        #   in Loop: Header=BB2_111 Depth=1
	...
	alsl.d	$a2, $a6, $a2, 2
	.p2align	4, , 16
.LBB2_164:                              # %vec.epilog.vector.body1024
                                        #   Parent Loop BB2_111 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a5, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB2_164
# %bb.165:                              # %vec.epilog.middle.block1031
                                        #   in Loop: Header=BB2_111 Depth=1
...
.LBB2_171:                              # %vector.body1045
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_171
# %bb.172:                              # %middle.block1051
	beq	$a2, $a4, .LBB2_175
.LBB2_173:                              # %scalar.ph1036.preheader
	sub.w	$a2, $s1, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s8, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_178:                              # %vector.body1063
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_178
# %bb.179:                              # %middle.block1069
	beq	$a3, $a4, .LBB2_182
.LBB2_180:                              # %scalar.ph1054.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_181:                              # %scalar.ph1054
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.226:
	move	$a5, $zero
	b	.LBB2_295
.LBB2_227:                              # %vector.main.loop.iter.check1219
	ori	$a0, $zero, 16
	bgeu	$a3, $a0, .LBB2_231
# %bb.228:
	move	$a4, $zero
	b	.LBB2_235
.LBB2_229:                              # %vector.main.loop.iter.check1089
	ori	$a0, $zero, 16
	bgeu	$a4, $a0, .LBB2_288
# %bb.230:
	move	$a5, $zero
	b	.LBB2_292
.LBB2_231:                              # %vector.ph1221
	andi	$a0, $a5, 12
...
.LBB2_232:                              # %vector.body1224
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_232
# %bb.233:                              # %middle.block1230
	beq	$a3, $a4, .LBB2_240
# %bb.234:                              # %vec.epilog.iter.check1235
	beqz	$a0, .LBB2_238
.LBB2_235:                              # %vec.epilog.ph1237
	move	$a6, $a4
	...
	alsl.d	$a5, $a6, $a2, 2
	.p2align	4, , 16
.LBB2_236:                              # %vec.epilog.vector.body1243
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a0, .LBB2_236
# %bb.237:                              # %vec.epilog.middle.block1248
	beq	$a3, $a4, .LBB2_240
.LBB2_238:                              # %vec.epilog.scalar.ph1234.preheader
	alsl.d	$a0, $a4, $a2, 2
	nor	$a2, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_239:                              # %vec.epilog.scalar.ph1234
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a2, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a3, $a3, -1
...
.LBB2_246:                              # %._crit_edge20.i611
	...
	beq	$t2, $a0, .LBB2_278
.LBB2_247:                              # %iter.check1277
                                        #   in Loop: Header=BB2_242 Depth=1
	addi.w	$t4, $zero, -5
	nor	$t7, $t2, $zero
	bltu	$t4, $t2, .LBB2_251
# %bb.248:                              # %iter.check1277
                                        #   in Loop: Header=BB2_242 Depth=1
	sub.d	$t4, $s8, $s2
	bltu	$t4, $a3, .LBB2_251
# %bb.249:                              # %vector.main.loop.iter.check1257
                                        #   in Loop: Header=BB2_242 Depth=1
	addi.w	$t4, $zero, -17
	bgeu	$t4, $t2, .LBB2_259
...
.LBB2_253:                              #   in Loop: Header=BB2_242 Depth=1
	...
	add.w	$fp, $s7, $t4
	beqz	$fp, .LBB2_246
.LBB2_254:                              # %iter.check1318
                                        #   in Loop: Header=BB2_242 Depth=1
	bltu	$fp, $a3, .LBB2_258
# %bb.255:                              # %iter.check1318
                                        #   in Loop: Header=BB2_242 Depth=1
	sub.d	$t5, $s8, $s2
	bltu	$t5, $s5, .LBB2_258
# %bb.256:                              # %vector.main.loop.iter.check1302
                                        #   in Loop: Header=BB2_242 Depth=1
...
# %bb.261:                              # %middle.block1269
	...
	beq	$t8, $t7, .LBB2_268
# %bb.262:                              # %vec.epilog.iter.check1279
                                        #   in Loop: Header=BB2_242 Depth=1
	beqz	$fp, .LBB2_266
.LBB2_263:                              # %vec.epilog.ph1281
                                        #   in Loop: Header=BB2_242 Depth=1
	...
	addi.d	$t8, $t8, -4
	.p2align	4, , 16
.LBB2_264:                              # %vec.epilog.vector.body1284
                                        #   Parent Loop BB2_242 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a4, $s0, 0
	st.w	$a5, $t8, 0
	...
	addi.d	$t8, $t8, -4
	bnez	$t3, .LBB2_264
# %bb.265:                              # %vec.epilog.middle.block1290
                                        #   in Loop: Header=BB2_242 Depth=1
...
.LBB2_270:                              # %vector.body1307
	...
	addi.d	$ra, $ra, -64
	bnez	$s6, .LBB2_270
# %bb.271:                              # %middle.block1312
                                        #   in Loop: Header=BB2_242 Depth=1
	ld.d	$s6, $sp, 400                   # 8-byte Folded Reload
	move	$ra, $a6
	ori	$s5, $zero, 64
	beq	$s0, $t8, .LBB2_277
# %bb.272:                              # %vec.epilog.iter.check1320
                                        #   in Loop: Header=BB2_242 Depth=1
	beqz	$s3, .LBB2_276
.LBB2_273:                              # %vec.epilog.ph1322
                                        #   in Loop: Header=BB2_242 Depth=1
	...
	addi.d	$s0, $s0, -16
	.p2align	4, , 16
.LBB2_274:                              # %vec.epilog.vector.body1325
                                        #   Parent Loop BB2_242 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $s5, 0
	vst	$vr2, $s0, 0
	...
	addi.d	$s0, $s0, -16
	bnez	$fp, .LBB2_274
# %bb.275:                              # %vec.epilog.middle.block1330
                                        #   in Loop: Header=BB2_242 Depth=1
	ori	$s5, $zero, 64
	beq	$s3, $t8, .LBB2_277
	.p2align	4, , 16
...
.LBB2_289:                              # %vector.body1094
	...
	addi.d	$a7, $a7, 64
	bnez	$a2, .LBB2_289
# %bb.290:                              # %middle.block1100
	beq	$a4, $a5, .LBB2_297
# %bb.291:                              # %vec.epilog.iter.check1105
	beqz	$a0, .LBB2_295
.LBB2_292:                              # %vec.epilog.ph1107
	move	$a2, $a5
	pcalau12i	$a0, %pc_hi20(.LCPI2_7)
	vld	$vr0, $a0, %pc_lo12(.LCPI2_7)
	...
	alsl.d	$a2, $a2, $a3, 2
	.p2align	4, , 16
.LBB2_293:                              # %vec.epilog.vector.body1112
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a2, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a2, $a2, 16
	bnez	$a0, .LBB2_293
# %bb.294:                              # %vec.epilog.middle.block1117
	beq	$a4, $a5, .LBB2_297
.LBB2_295:                              # %vec.epilog.scalar.ph1104.preheader
	alsl.d	$a0, $a5, $a3, 2
	nor	$a2, $a5, $zero
	sub.d	$a3, $a4, $a5
	.p2align	4, , 16
.LBB2_296:                              # %vec.epilog.scalar.ph1104
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a2, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a3, $a3, -1
...
.LBB2_303:                              # %._crit_edge20.i
	...
	beq	$t5, $a1, .LBB2_335
.LBB2_304:                              # %iter.check1143
                                        #   in Loop: Header=BB2_299 Depth=1
	addi.w	$a0, $zero, -5
	nor	$s5, $t5, $zero
	bltu	$a0, $t5, .LBB2_308
# %bb.305:                              # %iter.check1143
                                        #   in Loop: Header=BB2_299 Depth=1
	sub.d	$a0, $s8, $s2
	ori	$a5, $zero, 16
	bltu	$a0, $a5, .LBB2_308
# %bb.306:                              # %vector.main.loop.iter.check1126
                                        #   in Loop: Header=BB2_299 Depth=1
	addi.w	$a0, $zero, -17
	bgeu	$a0, $t5, .LBB2_316
...
.LBB2_310:                              #   in Loop: Header=BB2_299 Depth=1
	...
	add.w	$t0, $s7, $fp
	beqz	$t0, .LBB2_303
.LBB2_311:                              # %iter.check1184
                                        #   in Loop: Header=BB2_299 Depth=1
	ori	$a0, $zero, 16
	bltu	$t0, $a0, .LBB2_315
# %bb.312:                              # %iter.check1184
                                        #   in Loop: Header=BB2_299 Depth=1
	sub.d	$a0, $s8, $s2
	ori	$a5, $zero, 64
	bltu	$a0, $a5, .LBB2_315
# %bb.313:                              # %vector.main.loop.iter.check1168
                                        #   in Loop: Header=BB2_299 Depth=1
...
# %bb.318:                              # %middle.block1137
	...
	beq	$s7, $s5, .LBB2_325
# %bb.319:                              # %vec.epilog.iter.check1145
                                        #   in Loop: Header=BB2_299 Depth=1
	beqz	$t0, .LBB2_323
.LBB2_320:                              # %vec.epilog.ph1147
                                        #   in Loop: Header=BB2_299 Depth=1
	...
	addi.d	$t8, $a1, -4
	.p2align	4, , 16
.LBB2_321:                              # %vec.epilog.vector.body1150
                                        #   Parent Loop BB2_299 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a6, $t0, 0
	st.w	$a7, $t8, 0
	...
	addi.d	$t8, $t8, -4
	bnez	$a5, .LBB2_321
# %bb.322:                              # %vec.epilog.middle.block1156
                                        #   in Loop: Header=BB2_299 Depth=1
	vhaddw.d.w	$vr6, $vr6, $vr6
	vhaddw.q.d	$vr6, $vr6, $vr6
...
.LBB2_327:                              # %vector.body1173
	...
	addi.d	$a1, $a1, -64
	bnez	$a0, .LBB2_327
# %bb.328:                              # %middle.block1178
                                        #   in Loop: Header=BB2_299 Depth=1
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 352                   # 8-byte Folded Reload
	beq	$s6, $ra, .LBB2_334
# %bb.329:                              # %vec.epilog.iter.check1186
                                        #   in Loop: Header=BB2_299 Depth=1
	beqz	$a5, .LBB2_333
.LBB2_330:                              # %vec.epilog.ph1188
                                        #   in Loop: Header=BB2_299 Depth=1
	...
	addi.d	$a0, $a0, -16
	.p2align	4, , 16
.LBB2_331:                              # %vec.epilog.vector.body1191
                                        #   Parent Loop BB2_299 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $a1, 0
	vst	$vr2, $a0, 0
	...
	addi.d	$a0, $a0, -16
	bnez	$t0, .LBB2_331
# %bb.332:                              # %vec.epilog.middle.block1196
                                        #   in Loop: Header=BB2_299 Depth=1
	ld.d	$a1, $sp, 352                   # 8-byte Folded Reload
	beq	$a5, $ra, .LBB2_334
	.p2align	4, , 16
