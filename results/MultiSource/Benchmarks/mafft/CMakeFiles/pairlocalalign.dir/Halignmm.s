...
.LBB2_7:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, %pc_lo12(H__align.ogcp2)
	move	$a0, $s6
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s0, %pc_lo12(H__align.fgcp1)
...
.LBB2_24:
	...
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
	ld.d	$s5, $a0, %pc_lo12(H__align.cpmx1)
	ld.d	$a0, $sp, 312                   # 8-byte Folded Reload
	ld.d	$s0, $a0, %pc_lo12(H__align.floatwork)
	ld.d	$a0, $sp, 304                   # 8-byte Folded Reload
...
# %bb.58:                               # %vector.memcheck958
	...
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB2_102
# %bb.59:                               # %vector.main.loop.iter.check961
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB2_95
# %bb.60:
	move	$a5, $zero
...
.LBB2_96:                               # %vector.body968
	...
	addi.d	$a7, $a7, 64
	bnez	$t1, .LBB2_96
# %bb.97:                               # %middle.block974
	beq	$a3, $a5, .LBB2_104
# %bb.98:                               # %vec.epilog.iter.check980
	beqz	$a6, .LBB2_102
.LBB2_99:                               # %vec.epilog.ph982
	move	$a6, $a3
	...
	vreplgr2vr.w	$vr2, $a2
	.p2align	4, , 16
.LBB2_100:                              # %vec.epilog.vector.body987
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $s1, $t0
	vstx	$vr1, $a7, $t0
	vfadd.s	$vr3, $vr3, $vr1
...
# %bb.101:                              # %vec.epilog.middle.block991
	beq	$a3, $a6, .LBB2_104
.LBB2_102:                              # %vec.epilog.scalar.ph979.preheader
	slli.d	$a3, $a4, 2
	addi.d	$a5, $s1, -4
	sub.d	$a1, $a1, $a4
	movgr2fr.w	$fa0, $zero
	movgr2fr.w	$fa1, $a2
	.p2align	4, , 16
.LBB2_103:                              # %vec.epilog.scalar.ph979
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa2, $a5, $a3
	stx.w	$zero, $a0, $a3
	fadd.s	$fa2, $fa2, $fa0
...
# %bb.107:                              # %.lr.ph705
	...
	ld.d	$s0, $a0, %pc_lo12(H__align.ijp)
	pcalau12i	$a0, %pc_hi20(H__align.mp)
	ld.d	$a0, $a0, %pc_lo12(H__align.mp)
	st.d	$a0, $sp, 248                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	...
	st.d	$a0, $sp, 232                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	ld.d	$s3, $a0, %pc_lo12(H__align.diaf2)
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(H__align.gapf1)
...
# %bb.110:                              # %iter.check1025
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB2_113
# %bb.111:                              # %vector.memcheck994
                                        #   in Loop: Header=BB2_109 Depth=1
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$s4, $a0, .LBB2_155
# %bb.112:                              # %vector.memcheck994
                                        #   in Loop: Header=BB2_109 Depth=1
	add.d	$a0, $s4, $a1
	bgeu	$a2, $a0, .LBB2_155
...
# %bb.154:                              #   in Loop: Header=BB2_118 Depth=2
	...
	st.w	$a0, $t3, 0
	b	.LBB2_117
.LBB2_155:                              # %vector.main.loop.iter.check1002
                                        #   in Loop: Header=BB2_109 Depth=1
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB2_157
...
# %bb.159:                              # %middle.block1019
	...
	beq	$a4, $a5, .LBB2_115
# %bb.160:                              # %vec.epilog.iter.check1027
                                        #   in Loop: Header=BB2_109 Depth=1
	ld.d	$a5, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a6, $sp, 136                   # 8-byte Folded Reload
	beqz	$a6, .LBB2_114
.LBB2_161:                              # %vec.epilog.ph1029
                                        #   in Loop: Header=BB2_109 Depth=1
	...
	add.d	$a5, $a6, $a5
	.p2align	4, , 16
.LBB2_162:                              # %vec.epilog.vector.body1033
                                        #   Parent Loop BB2_109 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a4, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB2_162
# %bb.163:                              # %vec.epilog.middle.block1040
                                        #   in Loop: Header=BB2_109 Depth=1
...
.LBB2_164:
	...
	beqz	$a0, .LBB2_166
	b	.LBB2_180
.LBB2_165:                              # %._crit_edge706.loopexit
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	move	$s1, $a1
	ld.d	$s0, $sp, 104                   # 8-byte Folded Reload
...
.LBB2_169:                              # %vector.body1054
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_169
# %bb.170:                              # %middle.block1061
	beq	$a2, $a4, .LBB2_173
.LBB2_171:                              # %scalar.ph1045.preheader
	sub.w	$a2, $s7, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s1, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_176:                              # %vector.body1073
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_176
# %bb.177:                              # %middle.block1080
	beq	$a3, $a4, .LBB2_180
.LBB2_178:                              # %scalar.ph1064.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_179:                              # %scalar.ph1064
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.183:                              # %.lr.ph.i639
	...
	b	.LBB2_185
	.p2align	4, , 16
.LBB2_184:                              #   in Loop: Header=BB2_185 Depth=1
	addi.d	$a4, $a4, -1
	addi.d	$a5, $a5, -1
	addi.d	$fp, $fp, 4
	beqz	$a4, .LBB2_193
...
# %bb.189:                              # %.lr.ph.i586
	...
	b	.LBB2_191
	.p2align	4, , 16
.LBB2_190:                              #   in Loop: Header=BB2_191 Depth=1
	addi.d	$a4, $a4, -1
	addi.d	$a5, $a5, -1
	addi.d	$fp, $fp, 4
	beqz	$a4, .LBB2_201
.LBB2_191:                              # =>This Inner Loop Header: Depth=1
	...
	fcmp.cult.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB2_190
# %bb.192:                              #   in Loop: Header=BB2_191 Depth=1
	ldx.d	$a6, $ra, $a2
	stx.w	$a5, $a6, $a3
	fmov.s	$fa0, $fa1
	b	.LBB2_190
.LBB2_193:                              # %.preheader2.i591
	blez	$a1, .LBB2_198
# %bb.194:                              # %.lr.ph7.i633
	slli.d	$a2, $s6, 32
	srai.d	$a2, $a2, 29
...
# %bb.197:                              #   in Loop: Header=BB2_196 Depth=1
	...
	fmov.s	$fa0, $fa1
	b	.LBB2_195
.LBB2_198:                              # %.loopexit.i592
	ld.d	$a2, $sp, 416                   # 8-byte Folded Reload
	bltz	$a2, .LBB2_214
# %bb.199:                              # %.lr.ph10.preheader.i594
	addi.d	$a3, $s6, 1
...
.LBB2_210:                              # %vector.body1181
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_210
# %bb.211:                              # %middle.block1189
	beq	$a2, $a3, .LBB2_214
.LBB2_212:                              # %.lr.ph10.i596.preheader
	alsl.d	$a4, $a3, $s3, 3
	sub.d	$a2, $a2, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB2_213:                              # %.lr.ph10.i596
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a4, 0
	st.w	$a3, $a5, 0
	addi.d	$a4, $a4, 8
	...
	addi.d	$a3, $a3, 1
	bnez	$a2, .LBB2_213
.LBB2_214:                              # %.preheader1.i600
	bltz	$a1, .LBB2_238
# %bb.215:                              # %iter.check1208
	ld.d	$a2, $s3, 0
	addi.d	$a5, $s4, 1
...
.LBB2_218:                              # %vector.body1088
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_218
# %bb.219:                              # %middle.block1095
	beq	$a2, $a3, .LBB2_222
.LBB2_220:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $ra, 3
	sub.d	$a2, $a2, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB2_221:                              # %.lr.ph10.i
	...
	addi.d	$a3, $a3, 1
	bnez	$a2, .LBB2_221
.LBB2_222:                              # %.preheader1.i
	ld.d	$a2, $sp, 544
	bltz	$a1, .LBB2_283
# %bb.223:                              # %iter.check1114
	ld.d	$a3, $ra, 0
	addi.d	$a6, $s4, 1
...
# %bb.224:
	move	$a5, $zero
	b	.LBB2_281
.LBB2_225:                              # %vector.main.loop.iter.check1194
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB2_229
# %bb.226:
	move	$a4, $zero
	b	.LBB2_233
.LBB2_227:                              # %vector.main.loop.iter.check1100
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB2_274
# %bb.228:
	move	$a5, $zero
	b	.LBB2_278
.LBB2_229:                              # %vector.ph1196
	andi	$a6, $a5, 12
...
.LBB2_230:                              # %vector.body1199
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB2_230
# %bb.231:                              # %middle.block1205
	beq	$a3, $a4, .LBB2_238
# %bb.232:                              # %vec.epilog.iter.check1210
	beqz	$a6, .LBB2_236
.LBB2_233:                              # %vec.epilog.ph1212
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_234:                              # %vec.epilog.vector.body1218
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB2_234
# %bb.235:                              # %vec.epilog.middle.block1223
	beq	$a3, $a4, .LBB2_238
.LBB2_236:                              # %vec.epilog.scalar.ph1209.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_237:                              # %vec.epilog.scalar.ph1209
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.242:                              #   in Loop: Header=BB2_240 Depth=1
	...
	b	.LBB2_255
	.p2align	4, , 16
.LBB2_243:                              #   in Loop: Header=BB2_240 Depth=1
	addi.d	$a6, $s6, -1
	nor	$t2, $a6, $zero
	add.w	$t3, $s6, $t2
	bnez	$t3, .LBB2_256
	.p2align	4, , 16
.LBB2_244:                              # %._crit_edge20.i611
                                        #   in Loop: Header=BB2_240 Depth=1
	beq	$t1, $a0, .LBB2_264
.LBB2_245:                              # %.lr.ph29.preheader.i613
                                        #   in Loop: Header=BB2_240 Depth=1
	addi.w	$t2, $zero, -17
	nor	$t5, $t1, $zero
	bltu	$t2, $t1, .LBB2_250
# %bb.246:                              # %.lr.ph29.preheader.i613
                                        #   in Loop: Header=BB2_240 Depth=1
	sub.d	$t2, $s8, $s1
	bltu	$t2, $a3, .LBB2_250
# %bb.247:                              # %vector.ph1232
                                        #   in Loop: Header=BB2_240 Depth=1
	...
	xvori.b	$xr6, $xr0, 0
	.p2align	4, , 16
.LBB2_248:                              # %vector.body1236
                                        #   Parent Loop BB2_240 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $a5, -8
	vst	$vr2, $t7, -8
	xvaddi.wu	$xr5, $xr5, 1
...
# %bb.249:                              # %middle.block1245
	...
	b	.LBB2_253
	.p2align	4, , 16
.LBB2_250:                              #   in Loop: Header=BB2_240 Depth=1
	move	$t4, $t5
	move	$t2, $s1
	move	$t3, $s8
.LBB2_251:                              # %.lr.ph29.i614.preheader
                                        #   in Loop: Header=BB2_240 Depth=1
	add.d	$a5, $a5, $t4
	.p2align	4, , 16
.LBB2_252:                              # %.lr.ph29.i614
                                        #   Parent Loop BB2_240 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a2, $t3, -1
	addi.d	$t3, $t3, -1
	...
	addi.d	$t2, $t2, -1
	bnez	$t4, .LBB2_252
.LBB2_253:                              # %._crit_edge30.i615
                                        #   in Loop: Header=BB2_240 Depth=1
	bgtz	$a7, .LBB2_265
	b	.LBB2_268
	.p2align	4, , 16
.LBB2_254:                              #   in Loop: Header=BB2_240 Depth=1
	addi.d	$a6, $s6, -1
.LBB2_255:                              #   in Loop: Header=BB2_240 Depth=1
	move	$t1, $a0
	nor	$t2, $a6, $zero
	add.w	$t3, $s6, $t2
	beqz	$t3, .LBB2_244
.LBB2_256:                              # %.lr.ph19.i609.preheader
                                        #   in Loop: Header=BB2_240 Depth=1
	bltu	$t3, $a4, .LBB2_261
# %bb.257:                              # %.lr.ph19.i609.preheader
                                        #   in Loop: Header=BB2_240 Depth=1
	sub.d	$t4, $s8, $s1
	bltu	$t4, $a4, .LBB2_261
# %bb.258:                              # %vector.ph1258
                                        #   in Loop: Header=BB2_240 Depth=1
...
.LBB2_259:                              # %vector.body1262
	...
	addi.d	$fp, $fp, -64
	bnez	$s0, .LBB2_259
# %bb.260:                              # %middle.block1269
                                        #   in Loop: Header=BB2_240 Depth=1
	bne	$t7, $t6, .LBB2_262
	b	.LBB2_263
	.p2align	4, , 16
.LBB2_261:                              #   in Loop: Header=BB2_240 Depth=1
	move	$t4, $s1
	move	$t5, $s8
	.p2align	4, , 16
.LBB2_262:                              # %.lr.ph19.i609
                                        #   Parent Loop BB2_240 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a1, $t5, -1
	addi.d	$t5, $t5, -1
	...
	addi.d	$t4, $t4, -1
	bnez	$t3, .LBB2_262
.LBB2_263:                              # %._crit_edge20.loopexit.i610
                                        #   in Loop: Header=BB2_240 Depth=1
	add.d	$a5, $s6, $a5
	add.d	$a5, $t2, $a5
	move	$s8, $t5
	move	$s1, $t4
	bne	$t1, $a0, .LBB2_245
.LBB2_264:                              #   in Loop: Header=BB2_240 Depth=1
	move	$t3, $s8
	move	$t2, $s1
	blez	$a7, .LBB2_268
.LBB2_265:                              # %._crit_edge30.i615
                                        #   in Loop: Header=BB2_240 Depth=1
	blez	$t0, .LBB2_268
# %bb.266:                              #   in Loop: Header=BB2_240 Depth=1
	add.d	$s4, $t1, $s4
	addi.d	$s8, $t3, -1
	st.b	$a1, $t3, -1
	addi.d	$s1, $t2, -1
...
.LBB2_268:
	...
	ld.d	$s5, $sp, 96                    # 8-byte Folded Reload
	blez	$s5, .LBB2_271
.LBB2_269:                              # %.lr.ph50.preheader.i627
	ld.d	$fp, $sp, 120                   # 8-byte Folded Reload
	move	$s0, $s5
	.p2align	4, , 16
.LBB2_270:                              # %.lr.ph50.i629
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_270
.LBB2_271:                              # %.preheader.i620
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 384                   # 8-byte Folded Reload
	blez	$s2, .LBB2_322
# %bb.272:                              # %.lr.ph52.preheader.i621
	move	$fp, $s3
	move	$s0, $s2
	.p2align	4, , 16
.LBB2_273:                              # %.lr.ph52.i623
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s7, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s1
...
.LBB2_275:                              # %vector.body1105
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB2_275
# %bb.276:                              # %middle.block1111
	beq	$a4, $a5, .LBB2_283
# %bb.277:                              # %vec.epilog.iter.check1116
	beqz	$a7, .LBB2_281
.LBB2_278:                              # %vec.epilog.ph1118
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_279:                              # %vec.epilog.vector.body1123
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB2_279
# %bb.280:                              # %vec.epilog.middle.block1128
	beq	$a4, $a5, .LBB2_283
.LBB2_281:                              # %vec.epilog.scalar.ph1115.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_282:                              # %vec.epilog.scalar.ph1115
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.287:                              #   in Loop: Header=BB2_285 Depth=1
	...
	b	.LBB2_300
	.p2align	4, , 16
.LBB2_288:                              #   in Loop: Header=BB2_285 Depth=1
	addi.d	$t1, $s6, -1
	nor	$t7, $t1, $zero
	add.w	$t8, $s6, $t7
	bnez	$t8, .LBB2_301
	.p2align	4, , 16
.LBB2_289:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_285 Depth=1
	beq	$t4, $a1, .LBB2_309
.LBB2_290:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_285 Depth=1
	addi.w	$t7, $zero, -17
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB2_295
# %bb.291:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_285 Depth=1
	sub.d	$t7, $s8, $s1
	bltu	$t7, $a5, .LBB2_295
# %bb.292:                              # %vector.ph1137
                                        #   in Loop: Header=BB2_285 Depth=1
	...
	xvori.b	$xr6, $xr0, 0
	.p2align	4, , 16
.LBB2_293:                              # %vector.body1141
                                        #   Parent Loop BB2_285 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $t0, -8
	vst	$vr2, $s1, -8
	xvaddi.wu	$xr5, $xr5, 1
...
# %bb.294:                              # %middle.block1149
	...
	b	.LBB2_298
	.p2align	4, , 16
.LBB2_295:                              #   in Loop: Header=BB2_285 Depth=1
	move	$fp, $s0
	move	$t7, $s1
	move	$t8, $s8
...
.LBB2_299:                              #   in Loop: Header=BB2_285 Depth=1
	addi.d	$t1, $s6, -1
.LBB2_300:                              #   in Loop: Header=BB2_285 Depth=1
	move	$t4, $a1
	nor	$t7, $t1, $zero
	add.w	$t8, $s6, $t7
	beqz	$t8, .LBB2_289
.LBB2_301:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_285 Depth=1
	bltu	$t8, $a6, .LBB2_306
# %bb.302:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_285 Depth=1
	sub.d	$fp, $s8, $s1
	bltu	$fp, $a6, .LBB2_306
# %bb.303:                              # %vector.ph1160
                                        #   in Loop: Header=BB2_285 Depth=1
	bstrpick.d	$s3, $t8, 31, 0
	bstrpick.d	$fp, $s3, 31, 6
	slli.d	$s5, $fp, 6
	sub.d	$t8, $t8, $s5
	sub.d	$fp, $s1, $s5
	sub.d	$s0, $s8, $s5
...
.LBB2_307:                              # %.lr.ph19.i
	...
	addi.d	$fp, $fp, -1
	bnez	$t8, .LBB2_307
.LBB2_308:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB2_285 Depth=1
	add.d	$t0, $s6, $t0
	add.d	$t0, $t7, $t0
	move	$s8, $s0
...
# %bb.311:                              #   in Loop: Header=BB2_285 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a2, 0
.LBB2_312:                              #   in Loop: Header=BB2_285 Depth=1
	blez	$t2, .LBB2_316
# %bb.313:                              #   in Loop: Header=BB2_285 Depth=1
	blez	$t3, .LBB2_316
# %bb.314:                              #   in Loop: Header=BB2_285 Depth=1
	add.d	$a7, $t4, $a7
	addi.d	$s8, $t8, -1
	st.b	$a3, $t8, -1
	addi.d	$s1, $t7, -1
...
.LBB2_318:                              # %.lr.ph50.i
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_318
.LBB2_319:                              # %.preheader.i585
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 384                   # 8-byte Folded Reload
	blez	$s2, .LBB2_322
# %bb.320:                              # %.lr.ph52.preheader.i
	move	$fp, $s3
	move	$s0, $s2
	.p2align	4, , 16
.LBB2_321:                              # %.lr.ph52.i
	...
	addi.d	$s7, $s7, 8
	bnez	$s0, .LBB2_321
.LBB2_322:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
	...
	blt	$a2, $a3, .LBB2_324
# %bb.323:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	blt	$a3, $a0, .LBB2_325
.LBB2_324:
...
# %bb.340:                              # %middle.block
	beq	$a0, $a5, .LBB2_36
# %bb.341:                              # %vec.epilog.iter.check
	beqz	$a6, .LBB2_35
.LBB2_342:                              # %vec.epilog.ph
	bstrpick.d	$a3, $s7, 31, 2
	slli.d	$a6, $a3, 2
	alsl.d	$a1, $a3, $a4, 4
	andi	$a2, $s7, 3
	alsl.d	$a3, $a3, $s1, 4
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB2_343:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vld	$vr1, $a7, 0
	vfadd.s	$vr0, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB2_343
# %bb.344:                              # %vec.epilog.middle.block
	bne	$a0, $a6, .LBB2_35
	b	.LBB2_36
.Lfunc_end2:
