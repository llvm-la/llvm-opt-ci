...
.LBB2_263:                              # %.lr.ph19.i609
	...
	addi.d	$t4, $t4, -1
	bnez	$t3, .LBB2_263
.LBB2_264:                              # %._crit_edge20.loopexit.i610
                                        #   in Loop: Header=BB2_241 Depth=1
	add.d	$a5, $s6, $a5
	add.d	$a5, $t2, $a5
	move	$s8, $t5
...
.LBB2_265:                              #   in Loop: Header=BB2_241 Depth=1
	...
	move	$t2, $s1
	blez	$a7, .LBB2_269
.LBB2_266:                              # %._crit_edge30.i615
                                        #   in Loop: Header=BB2_241 Depth=1
	blez	$t0, .LBB2_269
# %bb.267:                              #   in Loop: Header=BB2_241 Depth=1
	add.d	$s4, $t1, $s4
	addi.d	$s8, $t3, -1
	st.b	$a1, $t3, -1
	addi.d	$s1, $t2, -1
...
.LBB2_269:
	...
	ld.d	$s6, $sp, 112                   # 8-byte Folded Reload
	blez	$s5, .LBB2_272
.LBB2_270:                              # %.lr.ph50.preheader.i627
	move	$fp, $s6
	move	$s0, $s5
	.p2align	4, , 16
.LBB2_271:                              # %.lr.ph50.i629
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_271
.LBB2_272:                              # %.preheader.i620
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 384                   # 8-byte Folded Reload
	blez	$s2, .LBB2_323
# %bb.273:                              # %.lr.ph52.preheader.i621
	move	$fp, $s3
	move	$s0, $s2
	.p2align	4, , 16
.LBB2_274:                              # %.lr.ph52.i623
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s7, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s1
...
.LBB2_276:                              # %vector.body1109
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB2_276
# %bb.277:                              # %middle.block1115
	beq	$a4, $a5, .LBB2_284
# %bb.278:                              # %vec.epilog.iter.check1119
	beqz	$a7, .LBB2_282
.LBB2_279:                              # %vec.epilog.ph1121
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_280:                              # %vec.epilog.vector.body1126
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB2_280
# %bb.281:                              # %vec.epilog.middle.block1131
	beq	$a4, $a5, .LBB2_284
.LBB2_282:                              # %vec.epilog.scalar.ph1118.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_283:                              # %vec.epilog.scalar.ph1118
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.287:                              #   in Loop: Header=BB2_286 Depth=1
	beqz	$t4, .LBB2_300
# %bb.288:                              #   in Loop: Header=BB2_286 Depth=1
	sub.d	$t1, $s6, $t4
	b	.LBB2_301
	.p2align	4, , 16
.LBB2_289:                              #   in Loop: Header=BB2_286 Depth=1
	addi.d	$t1, $s6, -1
	nor	$t7, $t1, $zero
	add.w	$t8, $s6, $t7
	bnez	$t8, .LBB2_302
	.p2align	4, , 16
.LBB2_290:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_286 Depth=1
	beq	$t4, $a1, .LBB2_310
.LBB2_291:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_286 Depth=1
	addi.w	$t7, $zero, -17
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB2_296
# %bb.292:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_286 Depth=1
	sub.d	$t7, $s8, $s1
	bltu	$t7, $a5, .LBB2_296
# %bb.293:                              # %vector.ph1140
                                        #   in Loop: Header=BB2_286 Depth=1
...
.LBB2_299:                              # %._crit_edge30.i
	...
	b	.LBB2_313
	.p2align	4, , 16
.LBB2_300:                              #   in Loop: Header=BB2_286 Depth=1
	addi.d	$t1, $s6, -1
.LBB2_301:                              #   in Loop: Header=BB2_286 Depth=1
	...
	add.w	$t8, $s6, $t7
	beqz	$t8, .LBB2_290
.LBB2_302:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_286 Depth=1
	bltu	$t8, $a6, .LBB2_307
# %bb.303:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_286 Depth=1
	sub.d	$fp, $s8, $s1
	bltu	$fp, $a6, .LBB2_307
# %bb.304:                              # %vector.ph1163
                                        #   in Loop: Header=BB2_286 Depth=1
...
.LBB2_308:                              # %.lr.ph19.i
	...
	addi.d	$fp, $fp, -1
	bnez	$t8, .LBB2_308
.LBB2_309:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB2_286 Depth=1
	add.d	$t0, $s6, $t0
	add.d	$t0, $t7, $t0
	move	$s8, $s0
...
.LBB2_311:                              # %._crit_edge30.i
	...
	addi.w	$fp, $s4, 0
	beq	$t3, $fp, .LBB2_313
# %bb.312:                              #   in Loop: Header=BB2_286 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a2, 0
.LBB2_313:                              #   in Loop: Header=BB2_286 Depth=1
	blez	$t2, .LBB2_317
# %bb.314:                              #   in Loop: Header=BB2_286 Depth=1
	blez	$t3, .LBB2_317
# %bb.315:                              #   in Loop: Header=BB2_286 Depth=1
	add.d	$a7, $t4, $a7
	addi.d	$s8, $t8, -1
	st.b	$a3, $t8, -1
	addi.d	$s1, $t7, -1
...
.LBB2_319:                              # %.lr.ph50.i
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_319
.LBB2_320:                              # %.preheader.i585
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 384                   # 8-byte Folded Reload
	blez	$s2, .LBB2_323
# %bb.321:                              # %.lr.ph52.preheader.i
	move	$fp, $s3
	move	$s0, $s2
	.p2align	4, , 16
.LBB2_322:                              # %.lr.ph52.i
	...
	addi.d	$s7, $s7, 8
	bnez	$s0, .LBB2_322
.LBB2_323:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
	...
	blt	$a2, $a3, .LBB2_325
# %bb.324:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	blt	$a3, $a0, .LBB2_326
.LBB2_325:
...
# %bb.333:                              # %.lr.ph724
	...
	.p2align	4, , 16
.LBB2_334:                              # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	st.d	$zero, $fp, 0
