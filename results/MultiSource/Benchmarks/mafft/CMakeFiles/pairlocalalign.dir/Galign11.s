...
.LBB0_4:
	...
	ld.w	$s8, $s5, %pc_lo12(G__align11.orlgth1)
	...
	pcalau12i	$s5, %pc_hi20(G__align11.mseq)
...
.LBB0_6:
	...
	pcalau12i	$s3, %pc_hi20(G__align11.intwork)
	blez	$s8, .LBB0_9
# %bb.7:
	blez	$s7, .LBB0_9
# %bb.8:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s5, %pc_lo12(G__align11.mseq)
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s3, %pc_lo12(G__align11.intwork)
	pcaddu18i	$ra, %call36(FreeIntMtx)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.w	$s8, $a0, %pc_lo12(G__align11.orlgth1)
...
.LBB0_9:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, %pc_lo12(G__align11.mseq)
	slt	$a0, $s1, $s3
	masknez	$a1, $s1, $a0
	...
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	st.w	$s8, $a0, %pc_lo12(G__align11.orlgth1)
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
...
# %bb.39:                               # %iter.check305
	...
	ori	$t1, $zero, 1
	bltu	$a2, $t2, .LBB0_51
# %bb.40:                               # %vector.main.loop.iter.check290
	ori	$t1, $zero, 16
	bgeu	$a2, $t1, .LBB0_44
# %bb.41:
	move	$t2, $zero
...
.LBB0_45:                               # %vector.body297
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB0_45
# %bb.46:                               # %middle.block302
	beq	$a2, $t2, .LBB0_53
# %bb.47:                               # %vec.epilog.iter.check307
	beqz	$t3, .LBB0_51
.LBB0_48:                               # %vec.epilog.ph309
	move	$t3, $a2
	bstrins.d	$t3, $zero, 1, 0
	ori	$t4, $zero, 1
	move	$t1, $a2
	...
	sub.d	$t2, $t2, $t3
	.p2align	4, , 16
.LBB0_49:                               # %vec.epilog.vector.body314
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t4, 0
	vfadd.s	$vr2, $vr2, $vr1
	vst	$vr2, $t4, 0
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB0_49
# %bb.50:                               # %vec.epilog.middle.block318
	beq	$a2, $t3, .LBB0_53
.LBB0_51:                               # %.lr.ph197.preheader
	alsl.d	$a2, $t1, $a4, 2
	sub.d	$t0, $t0, $t1
	.p2align	4, , 16
.LBB0_52:                               # %.lr.ph197
...
# %bb.54:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$a2, $t5, .LBB0_64
# %bb.55:                               # %vector.main.loop.iter.check322
	ori	$a2, $zero, 16
	bgeu	$t3, $a2, .LBB0_57
# %bb.56:
	move	$a2, $zero
	b	.LBB0_61
.LBB0_57:                               # %vector.ph324
	move	$a3, $s1
	andi	$t5, $t3, 12
	move	$a2, $t3
...
.LBB0_58:                               # %vector.body327
	...
	addi.d	$t8, $t8, 64
	bnez	$s1, .LBB0_58
# %bb.59:                               # %middle.block332
	move	$s1, $a3
	beq	$t3, $a2, .LBB0_66
# %bb.60:                               # %vec.epilog.iter.check337
	beqz	$t5, .LBB0_64
.LBB0_61:                               # %vec.epilog.ph339
	move	$t5, $t3
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_62:                               # %vec.epilog.vector.body342
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t6, 0
	vst	$vr2, $t7, 0
	vst	$vr1, $t8, 0
	...
	addi.d	$t8, $t8, 16
	bnez	$a2, .LBB0_62
# %bb.63:                               # %vec.epilog.middle.block346
	beq	$t3, $t5, .LBB0_66
.LBB0_64:                               # %vec.epilog.scalar.ph336.preheader
	alsl.d	$a2, $t4, $a4, 2
	addi.d	$a2, $a2, -4
	alsl.d	$t0, $t4, $t0, 2
	alsl.d	$t1, $t4, $t1, 2
	sub.d	$t2, $t2, $t4
	.p2align	4, , 16
.LBB0_65:                               # %vec.epilog.scalar.ph336
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a2, 0
	fst.s	$fa1, $t0, 0
	st.w	$zero, $t1, 0
...
# %bb.68:                               # %.lr.ph222
	...
	b	.LBB0_71
	.p2align	4, , 16
.LBB0_69:                               # %match_calc.exit190.thread
                                        #   in Loop: Header=BB0_71 Depth=1
	fldx.s	$fa2, $a1, $a4
	fst.s	$fa2, $t4, 0
.LBB0_70:                               # %._crit_edge213
                                        #   in Loop: Header=BB0_71 Depth=1
	fldx.s	$fa2, $t4, $a6
	addi.d	$t3, $t3, 1
	fstx.s	$fa2, $a7, $a4
...
.LBB0_86:                               # %vector.body353
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_86
# %bb.87:                               # %middle.block358
	beq	$a1, $a2, .LBB0_90
.LBB0_88:                               # %.lr.ph.i191.preheader
	alsl.d	$a3, $a2, $s2, 3
	sub.d	$a1, $a1, $a2
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
...
# %bb.92:
	move	$a3, $zero
	b	.LBB0_102
.LBB0_93:                               # %vector.main.loop.iter.check362
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_95
# %bb.94:
	move	$a3, $zero
	b	.LBB0_99
.LBB0_95:                               # %vector.ph364
	andi	$a5, $a4, 12
...
.LBB0_96:                               # %vector.body367
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_96
# %bb.97:                               # %middle.block373
	beq	$a2, $a3, .LBB0_104
# %bb.98:                               # %vec.epilog.iter.check378
	beqz	$a5, .LBB0_102
.LBB0_99:                               # %vec.epilog.ph380
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.vector.body385
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_100
# %bb.101:                              # %vec.epilog.middle.block390
	beq	$a2, $a3, .LBB0_104
.LBB0_102:                              # %vec.epilog.scalar.ph377.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_103:                              # %vec.epilog.scalar.ph377
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB0_112:                              # %.lr.ph9.i
	...
	st.b	$a4, $t3, -1
	bnez	$t2, .LBB0_112
# %bb.113:                              # %._crit_edge10.loopexit.i
                                        #   in Loop: Header=BB0_106 Depth=1
	add.d	$a3, $s3, $a3
	add.d	$a3, $t1, $a3
.LBB0_114:                              # %._crit_edge10.i
                                        #   in Loop: Header=BB0_106 Depth=1
	add.w	$a0, $t0, $a0
	beq	$t0, $a2, .LBB0_117
# %bb.115:                              # %.lr.ph14.preheader.i
                                        #   in Loop: Header=BB0_106 Depth=1
	nor	$t0, $t0, $zero
	.p2align	4, , 16
.LBB0_116:                              # %.lr.ph14.i
	...
	addi.d	$a3, $a3, 1
	bnez	$t0, .LBB0_116
.LBB0_117:                              # %._crit_edge15.i
                                        #   in Loop: Header=BB0_106 Depth=1
	blez	$a6, .LBB0_120
# %bb.118:                              # %._crit_edge15.i
                                        #   in Loop: Header=BB0_106 Depth=1
	blez	$a7, .LBB0_120
...
# %bb.30:                               # %iter.check236
	...
	ori	$t2, $zero, 1
	bltu	$t1, $t3, .LBB1_42
# %bb.31:                               # %vector.main.loop.iter.check221
	ori	$t2, $zero, 16
	bgeu	$t1, $t2, .LBB1_35
# %bb.32:
	move	$t3, $zero
...
.LBB1_36:                               # %vector.body228
	...
	addi.d	$t5, $t5, 64
	bnez	$t6, .LBB1_36
# %bb.37:                               # %middle.block233
	beq	$t1, $t3, .LBB1_44
# %bb.38:                               # %vec.epilog.iter.check238
	beqz	$t4, .LBB1_42
.LBB1_39:                               # %vec.epilog.ph240
	move	$t4, $t1
	bstrins.d	$t4, $zero, 1, 0
	ori	$t5, $zero, 1
	move	$t2, $t1
	...
	sub.d	$t3, $t3, $t4
	.p2align	4, , 16
.LBB1_40:                               # %vec.epilog.vector.body245
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t5, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t5, 0
	...
	addi.d	$t5, $t5, 16
	bnez	$t3, .LBB1_40
# %bb.41:                               # %vec.epilog.middle.block249
	beq	$t1, $t4, .LBB1_44
.LBB1_42:                               # %.lr.ph163.preheader
	alsl.d	$t1, $t2, $a0, 2
	sub.d	$t0, $t0, $t2
	.p2align	4, , 16
.LBB1_43:                               # %.lr.ph163
...
# %bb.45:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB1_55
# %bb.46:                               # %vector.main.loop.iter.check253
	ori	$t3, $zero, 16
	bgeu	$t2, $t3, .LBB1_48
# %bb.47:
	move	$t4, $zero
	b	.LBB1_52
.LBB1_48:                               # %vector.ph255
	andi	$t5, $t2, 12
	move	$t4, $t2
...
.LBB1_49:                               # %vector.body258
	...
	addi.d	$t7, $t7, 64
	bnez	$t8, .LBB1_49
# %bb.50:                               # %middle.block263
	beq	$t2, $t4, .LBB1_57
# %bb.51:                               # %vec.epilog.iter.check268
	beqz	$t5, .LBB1_55
.LBB1_52:                               # %vec.epilog.ph270
	move	$t5, $t2
	bstrins.d	$t5, $zero, 1, 0
	ori	$t6, $zero, 1
	move	$t3, $t2
	...
	sub.d	$t4, $t4, $t5
	.p2align	4, , 16
.LBB1_53:                               # %vec.epilog.vector.body273
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t6, 0
	vst	$vr0, $t7, 0
	addi.d	$t6, $t6, 16
	...
	addi.d	$t7, $t7, 16
	bnez	$t4, .LBB1_53
# %bb.54:                               # %vec.epilog.middle.block277
	beq	$t2, $t5, .LBB1_57
.LBB1_55:                               # %vec.epilog.scalar.ph267.preheader
	alsl.d	$t2, $t3, $a0, 2
	addi.d	$t2, $t2, -4
	alsl.d	$t0, $t3, $t0, 2
	sub.d	$t1, $t1, $t3
	.p2align	4, , 16
.LBB1_56:                               # %vec.epilog.scalar.ph267
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $t2, 0
	fst.s	$fa0, $t0, 0
	addi.d	$t2, $t2, 4
...
# %bb.59:                               # %.lr.ph182
	...
	b	.LBB1_62
	.p2align	4, , 16
.LBB1_60:                               # %match_calc_mtx.exit157.thread
                                        #   in Loop: Header=BB1_62 Depth=1
	fld.s	$fa3, $t4, 0
	fst.s	$fa3, $a0, 0
.LBB1_61:                               # %._crit_edge175
                                        #   in Loop: Header=BB1_62 Depth=1
	fldx.s	$fa3, $a0, $a6
	slli.d	$a4, $t2, 2
	addi.d	$t2, $t2, 1
...
.LBB1_64:                               # %.lr.ph.i152
	...
	move	$t5, $t8
	bnez	$t6, .LBB1_64
# %bb.65:                               # %match_calc_mtx.exit157
                                        #   in Loop: Header=BB1_62 Depth=1
	fld.s	$fa3, $t4, 0
	fst.s	$fa3, $a0, 0
	blez	$s1, .LBB1_61
# %bb.66:                               # %.lr.ph174.preheader
                                        #   in Loop: Header=BB1_62 Depth=1
	fld.s	$fa3, $t3, 0
	addi.d	$a4, $a0, 4
	move	$t4, $t1
