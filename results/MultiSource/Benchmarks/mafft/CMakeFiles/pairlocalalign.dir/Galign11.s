...
.LBB0_34:                               # %vector.body286
	...
	addi.d	$t3, $t3, 32
	bnez	$t4, .LBB0_34
# %bb.35:                               # %middle.block291
	beq	$t0, $t2, .LBB0_39
.LBB0_36:                               # %.lr.ph197.preheader334
	alsl.d	$t0, $t1, $a4, 2
	sub.d	$a2, $a2, $t1
	.p2align	4, , 16
.LBB0_37:                               # %.lr.ph197
...
.LBB0_42:                               # %vector.body299
	...
	addi.d	$t7, $t7, 32
	bnez	$t8, .LBB0_42
# %bb.43:                               # %middle.block304
	beq	$t3, $t4, .LBB0_47
.LBB0_44:                               # %scalar.ph294.preheader
	alsl.d	$t3, $t2, $a4, 2
	addi.d	$t3, $t3, -4
	alsl.d	$a2, $t2, $a2, 2
	alsl.d	$t0, $t2, $t0, 2
...
# %bb.49:                               # %.lr.ph222
	...
	b	.LBB0_52
	.p2align	4, , 16
.LBB0_50:                               # %match_calc.exit190.thread
                                        #   in Loop: Header=BB0_52 Depth=1
	fldx.s	$fa2, $a1, $a4
	fst.s	$fa2, $t4, 0
.LBB0_51:                               # %._crit_edge213
                                        #   in Loop: Header=BB0_52 Depth=1
	fldx.s	$fa2, $t4, $a6
	addi.d	$t3, $t3, 1
	fstx.s	$fa2, $a7, $a4
...
.LBB0_54:                               # %.lr.ph.i185
	...
	move	$t6, $s1
	bnez	$t7, .LBB0_54
# %bb.55:                               # %match_calc.exit190
                                        #   in Loop: Header=BB0_52 Depth=1
	fldx.s	$fa2, $a1, $a4
	fst.s	$fa2, $t4, 0
	blez	$s4, .LBB0_51
# %bb.56:                               # %.lr.ph212.preheader
                                        #   in Loop: Header=BB0_52 Depth=1
	slli.d	$a2, $t3, 3
	ldx.d	$a2, $s6, $a2
	move	$t6, $zero
...
.LBB0_67:                               # %vector.body312
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_67
# %bb.68:                               # %middle.block317
	beq	$a1, $a2, .LBB0_71
.LBB0_69:                               # %.lr.ph.i191.preheader
	alsl.d	$a3, $a2, $s6, 3
	sub.d	$a1, $a1, $a2
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
...
.LBB0_75:                               # %vector.body325
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_75
# %bb.76:                               # %middle.block331
	beq	$a2, $a3, .LBB0_79
.LBB0_77:                               # %scalar.ph320.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_78:                               # %scalar.ph320
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB0_91:                               # %.lr.ph14.i
	...
	addi.d	$a3, $a3, 1
	bnez	$t0, .LBB0_91
.LBB0_92:                               # %._crit_edge15.i
                                        #   in Loop: Header=BB0_81 Depth=1
	blez	$a6, .LBB0_95
# %bb.93:                               # %._crit_edge15.i
                                        #   in Loop: Header=BB0_81 Depth=1
	blez	$a7, .LBB0_95
...
.LBB1_25:                               # %vector.body217
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB1_25
# %bb.26:                               # %middle.block222
	beq	$t1, $t3, .LBB1_30
.LBB1_27:                               # %.lr.ph163.preheader238
	alsl.d	$t1, $t2, $a0, 2
	sub.d	$t0, $t0, $t2
	.p2align	4, , 16
.LBB1_28:                               # %.lr.ph163
...
.LBB1_33:                               # %vector.body230
	...
	addi.d	$t6, $t6, 32
	bnez	$t7, .LBB1_33
# %bb.34:                               # %middle.block235
	beq	$t3, $t4, .LBB1_38
.LBB1_35:                               # %scalar.ph225.preheader
	alsl.d	$t3, $t2, $a0, 2
	addi.d	$t3, $t3, -4
	alsl.d	$t0, $t2, $t0, 2
	sub.d	$t1, $t1, $t2
	.p2align	4, , 16
.LBB1_36:                               # %scalar.ph225
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $t3, 0
	fst.s	$fa0, $t0, 0
	addi.d	$t3, $t3, 4
