...
# %bb.39:                               # %iter.check290
	...
	ori	$t2, $zero, 1
	bltu	$a2, $t1, .LBB0_51
# %bb.40:                               # %vector.main.loop.iter.check292
	ori	$t1, $zero, 16
	bgeu	$a2, $t1, .LBB0_44
# %bb.41:
	move	$t1, $zero
...
.LBB0_49:                               # %vec.epilog.vector.body314
	...
	addi.d	$t4, $t4, 16
	bnez	$t1, .LBB0_49
# %bb.50:                               # %vec.epilog.middle.block319
	beq	$a2, $t3, .LBB0_53
...
# %bb.54:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB0_64
# %bb.55:                               # %vector.main.loop.iter.check327
	ori	$a2, $zero, 16
	bgeu	$t3, $a2, .LBB0_57
# %bb.56:
	move	$t4, $zero
	b	.LBB0_61
.LBB0_57:                               # %vector.ph328
	andi	$a2, $t3, 12
	move	$t4, $t3
...
.LBB0_58:                               # %vector.body331
	...
	addi.d	$t7, $t7, 64
	bnez	$t8, .LBB0_58
# %bb.59:                               # %middle.block336
	beq	$t3, $t4, .LBB0_66
# %bb.60:                               # %vec.epilog.iter.check340
	beqz	$a2, .LBB0_127
.LBB0_61:                               # %vec.epilog.ph342
	move	$t5, $t3
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_62:                               # %vec.epilog.vector.body345
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t6, 0
	vst	$vr2, $t7, 0
	vst	$vr1, $t8, 0
	...
	addi.d	$t8, $t8, 16
	bnez	$t4, .LBB0_62
# %bb.63:                               # %vec.epilog.middle.block350
	beq	$t3, $t5, .LBB0_66
.LBB0_64:                               # %vec.epilog.scalar.ph339.preheader
	alsl.d	$t3, $a2, $a4, 2
	addi.d	$t3, $t3, -4
	alsl.d	$t0, $a2, $t0, 2
	alsl.d	$t1, $a2, $t1, 2
	sub.d	$a2, $t2, $a2
	.p2align	4, , 16
.LBB0_65:                               # %vec.epilog.scalar.ph339
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $t3, 0
	fst.s	$fa1, $t0, 0
	st.w	$zero, $t1, 0
...
# %bb.92:
	move	$a3, $zero
	b	.LBB0_102
.LBB0_93:                               # %vector.main.loop.iter.check371
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_95
# %bb.94:
	move	$a3, $zero
	b	.LBB0_99
.LBB0_95:                               # %vector.ph372
	andi	$a5, $a4, 12
...
.LBB0_99:                               # %vec.epilog.ph387
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.vector.body392
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_100
# %bb.101:                              # %vec.epilog.middle.block397
	beq	$a2, $a3, .LBB0_104
.LBB0_102:                              # %vec.epilog.scalar.ph384.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_103:                              # %vec.epilog.scalar.ph384
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
# %bb.30:                               # %iter.check221
	...
	ori	$t3, $zero, 1
	bltu	$t1, $t2, .LBB1_42
# %bb.31:                               # %vector.main.loop.iter.check223
	ori	$t2, $zero, 16
	bgeu	$t1, $t2, .LBB1_35
# %bb.32:
	move	$t2, $zero
...
.LBB1_40:                               # %vec.epilog.vector.body245
	...
	addi.d	$t5, $t5, 16
	bnez	$t2, .LBB1_40
# %bb.41:                               # %vec.epilog.middle.block250
	beq	$t1, $t4, .LBB1_44
...
# %bb.45:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB1_55
# %bb.46:                               # %vector.main.loop.iter.check258
	ori	$t3, $zero, 16
	bgeu	$t2, $t3, .LBB1_48
# %bb.47:
	move	$t4, $zero
	b	.LBB1_52
.LBB1_48:                               # %vector.ph259
	andi	$t3, $t2, 12
	move	$t4, $t2
	bstrins.d	$t4, $zero, 3, 0
	addi.d	$t5, $a0, 32
...
.LBB1_49:                               # %vector.body262
	...
	addi.d	$t6, $t6, 64
	bnez	$t7, .LBB1_49
# %bb.50:                               # %middle.block267
	beq	$t2, $t4, .LBB1_57
# %bb.51:                               # %vec.epilog.iter.check271
	beqz	$t3, .LBB1_75
.LBB1_52:                               # %vec.epilog.ph273
	move	$t5, $t2
	bstrins.d	$t5, $zero, 1, 0
	ori	$t6, $zero, 1
	move	$t3, $t2
	...
	sub.d	$t4, $t4, $t5
	.p2align	4, , 16
.LBB1_53:                               # %vec.epilog.vector.body276
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t6, 0
	vst	$vr0, $t7, 0
	addi.d	$t6, $t6, 16
	...
	addi.d	$t7, $t7, 16
	bnez	$t4, .LBB1_53
# %bb.54:                               # %vec.epilog.middle.block281
	beq	$t2, $t5, .LBB1_57
.LBB1_55:                               # %vec.epilog.scalar.ph270.preheader
	alsl.d	$t2, $t3, $a0, 2
	addi.d	$t2, $t2, -4
	alsl.d	$t0, $t3, $t0, 2
	sub.d	$t1, $t1, $t3
	.p2align	4, , 16
.LBB1_56:                               # %vec.epilog.scalar.ph270
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $t2, 0
	fst.s	$fa0, $t0, 0
	addi.d	$t2, $t2, 4
