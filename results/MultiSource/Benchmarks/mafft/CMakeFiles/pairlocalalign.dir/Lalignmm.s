...
.LBB0_57:                               # %vector.body372
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB0_57
# %bb.58:                               # %middle.block377
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB0_61
.LBB0_59:                               # %.lr.ph29.i.preheader549
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s3, 2
	.p2align	4, , 16
...
.LBB0_61:                               # %.lr.ph31.i
	...
	bge	$t5, $a3, .LBB0_176
.LBB0_62:                               # %scalar.ph392.preheader
	sub.d	$a1, $a0, $a2
...
.LBB0_90:                               # %scalar.ph418.preheader
	ld.d	$t8, $sp, 304                   # 8-byte Folded Reload
	ld.d	$t7, $sp, 176                   # 8-byte Folded Reload
.LBB0_91:                               # %scalar.ph418.preheader
	alsl.d	$a1, $a0, $s4, 2
	sub.d	$a3, $t4, $a0
	alsl.d	$a0, $a0, $s7, 2
	addi.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB0_92:                               # %scalar.ph418
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a0, 0
	fld.s	$fa2, $a1, 0
...
# %bb.94:
	move	$a3, $zero
.LBB0_95:                               # %scalar.ph447.preheader
	alsl.d	$a4, $a3, $s3, 2
	sub.d	$a5, $t7, $a3
	alsl.d	$a3, $a3, $t1, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_96:                               # %scalar.ph447
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.100:
	move	$a3, $zero
.LBB0_101:                              # %scalar.ph476.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a4, $t7, $a3
	alsl.d	$a3, $a3, $t1, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_102:                              # %scalar.ph476
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a2, 0
...
.LBB0_104:
	move	$a0, $t7
.LBB0_105:                              # %scalar.ph506.preheader
	addi.d	$a1, $a0, 1
...
# %bb.144:                              # %.preheader2.i
	...
	sub.d	$a7, $a6, $a5
	bltu	$a7, $a4, .LBB0_148
# %bb.145:                              # %vector.body533.preheader
                                        #   in Loop: Header=BB0_143 Depth=1
	addi.d	$a7, $a6, 16
	addi.d	$t0, $a5, 16
	move	$t1, $a2
	.p2align	4, , 16
.LBB0_146:                              # %vector.body533
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB0_146
# %bb.147:                              # %middle.block538
                                        #   in Loop: Header=BB0_143 Depth=1
	move	$t0, $a2
	beq	$t4, $a2, .LBB0_142
.LBB0_148:                              # %scalar.ph526.preheader
                                        #   in Loop: Header=BB0_143 Depth=1
	sub.d	$a7, $t4, $t0
	alsl.d	$a6, $t0, $a6, 2
	alsl.d	$a5, $t0, $a5, 2
	.p2align	4, , 16
.LBB0_149:                              # %scalar.ph526
                                        #   Parent Loop BB0_143 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa1, $a5, 0
	fdiv.s	$fa1, $fa1, $fa3
...
.LBB0_174:                              # %vector.body353
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_174
# %bb.175:                              # %middle.block362
	addi.d	$a4, $a0, -1
	bne	$a4, $a3, .LBB0_50
	b	.LBB0_52
.LBB0_176:                              # %vector.memcheck380
	alsl.d	$a3, $a0, $t1, 2
	addi.d	$a1, $a1, -4
	sltu	$a1, $a7, $a1
	sltu	$a4, $s3, $a3
...
.LBB0_179:                              # %vector.body397
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_179
# %bb.180:                              # %middle.block404
	addi.d	$a3, $a0, -1
	bne	$a3, $a1, .LBB0_62
	b	.LBB0_64
.LBB0_181:                              # %vector.memcheck407
	slli.d	$a0, $a1, 2
	move	$t4, $a1
	alsl.d	$a1, $a1, $s4, 2
	addi.d	$a3, $a0, 4
...
.LBB0_184:                              # %vector.body423
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_184
# %bb.185:                              # %middle.block432
	bne	$a0, $t4, .LBB0_91
	b	.LBB0_93
.LBB0_186:                              # %vector.memcheck435
	addi.d	$a4, $s6, 4
	add.d	$a3, $t2, $a4
	sltu	$a3, $s3, $a3
	sltu	$a5, $a0, $a1
...
.LBB0_189:                              # %vector.body452
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_189
# %bb.190:                              # %middle.block461
	bne	$a3, $t7, .LBB0_95
	b	.LBB0_97
.LBB0_191:                              # %vector.memcheck464
	alsl.d	$a4, $t7, $a2, 2
	addi.d	$a5, $s6, 4
	add.d	$a3, $t2, $a5
	sltu	$a3, $a2, $a3
...
.LBB0_194:                              # %vector.body481
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_194
# %bb.195:                              # %middle.block490
	bne	$a3, $t7, .LBB0_101
	b	.LBB0_103
.LBB0_196:                              # %vector.memcheck493
	sub.d	$a5, $a5, $t3
	nor	$a5, $a5, $zero
...
.LBB1_57:                               # %vector.body376
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB1_57
# %bb.58:                               # %middle.block381
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB1_61
.LBB1_59:                               # %.lr.ph29.i.preheader553
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s6, 2
	.p2align	4, , 16
...
.LBB1_61:                               # %.lr.ph31.i
	...
	addi.d	$a7, $t1, 4
	bge	$t5, $a3, .LBB1_176
.LBB1_62:                               # %scalar.ph396.preheader
	sub.d	$a1, $a0, $a2
...
# %bb.89:
	...
	ld.d	$a7, $sp, 312                   # 8-byte Folded Reload
.LBB1_90:                               # %scalar.ph422.preheader
	ld.d	$a4, $sp, 360                   # 8-byte Folded Reload
	ld.d	$t7, $sp, 176                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 400                   # 8-byte Folded Reload
.LBB1_91:                               # %scalar.ph422.preheader
	alsl.d	$a1, $a0, $s4, 2
	sub.d	$a3, $t3, $a0
	alsl.d	$a0, $a0, $s7, 2
	addi.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB1_92:                               # %scalar.ph422
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a0, 0
	fld.s	$fa2, $a1, 0
...
# %bb.94:
	move	$a3, $zero
.LBB1_95:                               # %scalar.ph451.preheader
	alsl.d	$a4, $a3, $s3, 2
	sub.d	$a5, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB1_96:                               # %scalar.ph451
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.100:
	move	$a3, $zero
.LBB1_101:                              # %scalar.ph480.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a4, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB1_102:                              # %scalar.ph480
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a2, 0
...
.LBB1_104:
	move	$a0, $t7
.LBB1_105:                              # %scalar.ph510.preheader
	addi.d	$a1, $a0, 1
...
# %bb.144:                              # %.preheader2.i
	...
	sub.d	$a7, $a6, $a5
	bltu	$a7, $a4, .LBB1_148
# %bb.145:                              # %vector.body537.preheader
                                        #   in Loop: Header=BB1_143 Depth=1
	addi.d	$a7, $a6, 16
	addi.d	$t0, $a5, 16
	move	$t1, $a2
	.p2align	4, , 16
.LBB1_146:                              # %vector.body537
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB1_146
# %bb.147:                              # %middle.block542
                                        #   in Loop: Header=BB1_143 Depth=1
	move	$t0, $a2
	beq	$t3, $a2, .LBB1_142
.LBB1_148:                              # %scalar.ph530.preheader
                                        #   in Loop: Header=BB1_143 Depth=1
	sub.d	$a7, $t3, $t0
	alsl.d	$a6, $t0, $a6, 2
	alsl.d	$a5, $t0, $a5, 2
	.p2align	4, , 16
.LBB1_149:                              # %scalar.ph530
                                        #   Parent Loop BB1_143 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa1, $a5, 0
	fdiv.s	$fa1, $fa1, $fa3
...
.LBB1_174:                              # %vector.body357
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_174
# %bb.175:                              # %middle.block366
	addi.d	$a4, $a0, -1
	bne	$a4, $a3, .LBB1_50
	b	.LBB1_52
.LBB1_176:                              # %vector.memcheck384
	alsl.d	$a3, $a0, $t1, 2
	addi.d	$a1, $a1, -4
	sltu	$a1, $a7, $a1
	sltu	$a4, $s6, $a3
...
.LBB1_179:                              # %vector.body401
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_179
# %bb.180:                              # %middle.block408
	addi.d	$a3, $a0, -1
	bne	$a3, $a1, .LBB1_62
	b	.LBB1_64
.LBB1_181:                              # %vector.memcheck411
	slli.d	$a0, $a1, 2
	move	$t3, $a1
	alsl.d	$a1, $a1, $s4, 2
	addi.d	$a3, $a0, 4
...
.LBB1_184:                              # %vector.body427
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_184
# %bb.185:                              # %middle.block436
	move	$a4, $a5
	bne	$a0, $t3, .LBB1_91
	b	.LBB1_93
.LBB1_186:                              # %vector.memcheck439
	addi.d	$a4, $t8, 4
	add.d	$a3, $t1, $a4
	sltu	$a3, $s3, $a3
	sltu	$a5, $a0, $a1
