...
.LBB0_223:                              # %vector.body453
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_223
# %bb.224:                              # %middle.block460
	addi.d	$a3, $a0, -1
	beq	$a3, $a1, .LBB0_93
# %bb.225:                              # %vec.epilog.iter.check464
	beqz	$a2, .LBB0_253
.LBB0_226:                              # %vec.epilog.ph466
	addi.d	$a2, $a0, -1
	move	$a3, $a2
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_227:                              # %vec.epilog.vector.body469
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a4, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a5, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a1, .LBB0_227
# %bb.228:                              # %vec.epilog.middle.block476
	addi.d	$a1, $a0, -1
	bne	$a1, $a3, .LBB0_91
	b	.LBB0_93
...
.LBB0_230:                              # %vector.body500
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_230
# %bb.231:                              # %middle.block509
	beq	$a0, $ra, .LBB0_112
# %bb.232:                              # %vec.epilog.iter.check513
	move	$a5, $ra
	beqz	$a1, .LBB0_110
.LBB0_233:                              # %vec.epilog.ph515
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s3, 2
	.p2align	4, , 16
.LBB0_234:                              # %vec.epilog.vector.body518
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a1, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB0_234
# %bb.235:                              # %vec.epilog.middle.block525
	bne	$a0, $a5, .LBB0_110
	b	.LBB0_112
.LBB0_236:                              # %vector.ph546
	andi	$a4, $t7, 12
...
.LBB0_237:                              # %vector.body549
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_237
# %bb.238:                              # %middle.block558
	move	$a7, $s8
	beq	$a3, $t7, .LBB0_116
# %bb.239:                              # %vec.epilog.iter.check562
	beqz	$a4, .LBB0_114
.LBB0_240:                              # %vec.epilog.ph564
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $a7, 2
	.p2align	4, , 16
.LBB0_241:                              # %vec.epilog.vector.body567
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_241
# %bb.242:                              # %vec.epilog.middle.block574
	bne	$a3, $t7, .LBB0_114
	b	.LBB0_116
.LBB0_243:                              # %vector.ph595
	andi	$a4, $t7, 12
	bstrpick.d	$a3, $t7, 30, 4
	xvldrepl.w	$xr0, $a0, 0
	slli.d	$a3, $a3, 4
...
.LBB0_244:                              # %vector.body598
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_244
# %bb.245:                              # %middle.block607
	move	$a7, $s8
	beq	$a3, $t7, .LBB0_122
# %bb.246:                              # %vec.epilog.iter.check611
	beqz	$a4, .LBB0_120
.LBB0_247:                              # %vec.epilog.ph613
	move	$a6, $a3
	bstrpick.d	$a3, $t7, 30, 2
	slli.d	$a3, $a3, 2
	vldrepl.w	$vr0, $a0, 0
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB0_248:                              # %vec.epilog.vector.body616
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_248
# %bb.249:                              # %vec.epilog.middle.block623
	bne	$a3, $t7, .LBB0_120
	b	.LBB0_122
.LBB0_250:
	addi.d	$a3, $a4, 1
