	...
	.p2align	5, 0x0                          # -- Begin function Lalignmm_hmout
.LCPI0_0:
	.word	0                               # 0x0
	.word	1                               # 0x1
	.word	4                               # 0x4
...
# %bb.79:                               # %vector.memcheck347
	...
	and	$a3, $a3, $a4
	bnez	$a3, .LBB0_50
# %bb.80:                               # %vector.main.loop.iter.check364
	ori	$a2, $zero, 17
	bge	$t6, $a2, .LBB0_216
# %bb.81:
	move	$a3, $zero
	b	.LBB0_220
.LBB0_82:                               # %vector.ph406
	addi.d	$a4, $a0, -1
	andi	$a3, $a4, 12
...
.LBB0_87:                               # %vec.epilog.vector.body423
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB0_87
# %bb.88:                               # %vec.epilog.middle.block428
	addi.d	$a4, $a0, -1
	beq	$a4, $a5, .LBB0_91
...
.LBB0_90:                               # %.lr.ph29.i
	...
	addi.d	$a3, $a3, 4
	bnez	$a4, .LBB0_90
.LBB0_91:                               # %iter.check447
	ori	$a2, $zero, 1
	ori	$a3, $zero, 5
	addi.d	$t2, $t1, 4
	bge	$t6, $a3, .LBB0_186
.LBB0_92:                               # %vec.epilog.scalar.ph463.preheader
	sub.d	$a1, $a0, $a2
	...
	addi.d	$a2, $a2, -4
	.p2align	4, , 16
.LBB0_93:                               # %vec.epilog.scalar.ph463
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $s5, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB0_110:                              # %vec.epilog.scalar.ph512.preheader
	...
	ld.d	$fp, $sp, 408                   # 8-byte Folded Reload
	move	$a7, $s8
.LBB0_111:                              # %vec.epilog.scalar.ph512.preheader
	alsl.d	$a1, $a0, $s3, 2
	sub.d	$a3, $a5, $a0
	alsl.d	$a0, $a0, $s6, 2
	addi.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB0_112:                              # %vec.epilog.scalar.ph512
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a0, 0
	fld.s	$fa2, $a1, 0
...
# %bb.114:
	move	$a3, $zero
.LBB0_115:                              # %vec.epilog.scalar.ph561.preheader
	alsl.d	$a4, $a3, $a7, 2
	sub.d	$a5, $t7, $a3
	alsl.d	$a3, $a3, $s7, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_116:                              # %vec.epilog.scalar.ph561
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.120:
	move	$a3, $zero
.LBB0_121:                              # %vec.epilog.scalar.ph610.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a4, $t7, $a3
	alsl.d	$a3, $a3, $s7, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_122:                              # %vec.epilog.scalar.ph610
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a2, 0
...
.LBB0_125:                              # %scalar.ph639.preheader
	addi.d	$a1, $a0, 1
...
.LBB0_163:                              # %iter.check663
	...
	move	$t4, $zero
	bltu	$ra, $a6, .LBB0_174
# %bb.164:                              # %iter.check663
                                        #   in Loop: Header=BB0_163 Depth=1
	sub.d	$t3, $t2, $t1
	bltu	$t3, $a7, .LBB0_174
# %bb.165:                              # %vector.main.loop.iter.check665
                                        #   in Loop: Header=BB0_163 Depth=1
	bgeu	$ra, $t0, .LBB0_167
# %bb.166:                              #   in Loop: Header=BB0_163 Depth=1
	...
	b	.LBB0_171
	.p2align	4, , 16
.LBB0_167:                              # %vector.body671.preheader
                                        #   in Loop: Header=BB0_163 Depth=1
	addi.d	$t3, $t2, 32
	addi.d	$t4, $t1, 32
	move	$t5, $a3
	.p2align	4, , 16
.LBB0_168:                              # %vector.body671
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB0_168
# %bb.169:                              # %middle.block676
                                        #   in Loop: Header=BB0_163 Depth=1
	beq	$ra, $a3, .LBB0_162
# %bb.170:                              # %vec.epilog.iter.check680
                                        #   in Loop: Header=BB0_163 Depth=1
	move	$t5, $a3
	move	$t4, $a3
	beqz	$a2, .LBB0_174
.LBB0_171:                              # %vec.epilog.ph682
                                        #   in Loop: Header=BB0_163 Depth=1
	add.d	$t3, $a5, $t5
	alsl.d	$t4, $t5, $t2, 2
	alsl.d	$t5, $t5, $t1, 2
	.p2align	4, , 16
.LBB0_172:                              # %vec.epilog.vector.body687
                                        #   Parent Loop BB0_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $t5, 0
	vfdiv.s	$vr2, $vr2, $vr1
	...
	addi.d	$t5, $t5, 16
	bnez	$t3, .LBB0_172
# %bb.173:                              # %vec.epilog.middle.block691
                                        #   in Loop: Header=BB0_163 Depth=1
	move	$t4, $a4
	beq	$ra, $a4, .LBB0_162
.LBB0_174:                              # %vec.epilog.scalar.ph679.preheader
                                        #   in Loop: Header=BB0_163 Depth=1
	sub.d	$t3, $ra, $t4
	alsl.d	$t2, $t4, $t2, 2
	alsl.d	$t1, $t4, $t1, 2
	.p2align	4, , 16
.LBB0_175:                              # %vec.epilog.scalar.ph679
                                        #   Parent Loop BB0_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa2, $t1, 0
	fdiv.s	$fa2, $fa2, $fa4
...
# %bb.187:                              # %vector.memcheck432
	...
	and	$a1, $a1, $a3
	bnez	$a1, .LBB0_92
# %bb.188:                              # %vector.main.loop.iter.check449
	ori	$a1, $zero, 17
	bge	$t6, $a1, .LBB0_223
# %bb.189:
	move	$a1, $zero
	b	.LBB0_227
.LBB0_190:                              # %vector.memcheck480
	slli.d	$a0, $a5, 2
	alsl.d	$a1, $a5, $s3, 2
	addi.d	$a3, $a0, 4
	add.d	$a0, $a4, $a3
...
# %bb.191:                              # %vector.memcheck480
	...
	move	$a7, $s8
	bnez	$a1, .LBB0_111
# %bb.192:                              # %vector.main.loop.iter.check496
	ori	$a0, $zero, 16
	bgeu	$t5, $a0, .LBB0_230
# %bb.193:
	move	$a0, $zero
	b	.LBB0_234
.LBB0_194:                              # %vector.memcheck528
	addi.d	$a4, $fp, 4
	add.d	$a3, $t1, $a4
	sltu	$a3, $a7, $a3
	sltu	$a5, $a0, $a1
...
# %bb.195:                              # %vector.memcheck528
	...
	and	$a4, $a4, $a5
	bnez	$a4, .LBB0_115
# %bb.196:                              # %vector.main.loop.iter.check545
	ori	$a3, $zero, 17
	ld.d	$a4, $sp, 424                   # 8-byte Folded Reload
	bgeu	$a4, $a3, .LBB0_237
# %bb.197:
...
# %bb.199:                              # %vector.memcheck577
	...
	and	$a4, $a5, $a4
	bnez	$a4, .LBB0_121
# %bb.200:                              # %vector.main.loop.iter.check594
	ori	$a3, $zero, 17
	ld.d	$a4, $sp, 424                   # 8-byte Folded Reload
	bgeu	$a4, $a3, .LBB0_244
# %bb.201:
...
.LBB0_217:                              # %vector.body368
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_217
# %bb.218:                              # %middle.block377
	addi.d	$a4, $a0, -1
	beq	$a4, $a3, .LBB0_52
# %bb.219:                              # %vec.epilog.iter.check381
	beqz	$a2, .LBB0_253
.LBB0_220:                              # %vec.epilog.ph383
	addi.d	$a2, $a0, -1
	move	$a4, $a2
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB0_221:                              # %vec.epilog.vector.body386
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
...
.LBB0_224:                              # %vector.body453
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_224
# %bb.225:                              # %middle.block460
	addi.d	$a3, $a0, -1
	beq	$a3, $a1, .LBB0_94
# %bb.226:                              # %vec.epilog.iter.check464
	beqz	$a2, .LBB0_254
.LBB0_227:                              # %vec.epilog.ph466
	addi.d	$a2, $a0, -1
	move	$a3, $a2
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_228:                              # %vec.epilog.vector.body469
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a4, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a5, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a1, .LBB0_228
# %bb.229:                              # %vec.epilog.middle.block476
	addi.d	$a1, $a0, -1
	bne	$a1, $a3, .LBB0_92
	b	.LBB0_94
.LBB0_230:                              # %vector.ph497
	andi	$a1, $a5, 12
...
.LBB0_231:                              # %vector.body500
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_231
# %bb.232:                              # %middle.block509
	beq	$a0, $ra, .LBB0_113
# %bb.233:                              # %vec.epilog.iter.check513
	move	$a5, $ra
	beqz	$a1, .LBB0_111
.LBB0_234:                              # %vec.epilog.ph515
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s3, 2
	.p2align	4, , 16
.LBB0_235:                              # %vec.epilog.vector.body518
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a1, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
...
.LBB0_238:                              # %vector.body549
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_238
# %bb.239:                              # %middle.block558
	move	$a7, $s8
	beq	$a3, $t7, .LBB0_117
# %bb.240:                              # %vec.epilog.iter.check562
	beqz	$a4, .LBB0_115
.LBB0_241:                              # %vec.epilog.ph564
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $a7, 2
	.p2align	4, , 16
.LBB0_242:                              # %vec.epilog.vector.body567
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_242
# %bb.243:                              # %vec.epilog.middle.block574
	bne	$a3, $t7, .LBB0_115
	b	.LBB0_117
.LBB0_244:                              # %vector.ph595
	andi	$a4, $t7, 12
	bstrpick.d	$a3, $t7, 30, 4
	xvldrepl.w	$xr0, $a0, 0
	slli.d	$a3, $a3, 4
...
.LBB0_245:                              # %vector.body598
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_245
# %bb.246:                              # %middle.block607
	move	$a7, $s8
	beq	$a3, $t7, .LBB0_123
# %bb.247:                              # %vec.epilog.iter.check611
	beqz	$a4, .LBB0_121
.LBB0_248:                              # %vec.epilog.ph613
	move	$a6, $a3
	bstrpick.d	$a3, $t7, 30, 2
	slli.d	$a3, $a3, 2
	vldrepl.w	$vr0, $a0, 0
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB0_249:                              # %vec.epilog.vector.body616
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_249
# %bb.250:                              # %vec.epilog.middle.block623
	bne	$a3, $t7, .LBB0_121
	b	.LBB0_123
.LBB0_251:
	addi.d	$a3, $a4, 1
...
.Lfunc_end0:
	.size	Lalignmm_hmout, .Lfunc_end0-Lalignmm_hmout
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function Lalign2m2m_hmout
.LCPI1_0:
	.word	0                               # 0x0
	.word	1                               # 0x1
	.word	4                               # 0x4
