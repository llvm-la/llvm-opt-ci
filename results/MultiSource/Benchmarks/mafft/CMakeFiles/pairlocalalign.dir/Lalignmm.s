...
# %bb.58:                               # %middle.block379
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB0_61
.LBB0_59:                               # %.lr.ph29.i.preheader553
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s3, 2
	.p2align	4, , 16
...
# %bb.94:
	move	$a3, $zero
.LBB0_95:                               # %scalar.ph450.preheader
	alsl.d	$a4, $a3, $s3, 2
	sub.d	$a5, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_96:                               # %scalar.ph450
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.100:
	move	$a3, $zero
.LBB0_101:                              # %scalar.ph479.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a4, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_102:                              # %scalar.ph479
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a2, 0
...
.LBB0_104:
	move	$a0, $t7
.LBB0_105:                              # %scalar.ph509.preheader
	addi.d	$a1, $a0, 1
...
# %bb.147:                              # %middle.block542
	...
	move	$t0, $a2
	beq	$t4, $a2, .LBB0_142
.LBB0_148:                              # %scalar.ph530.preheader
                                        #   in Loop: Header=BB0_143 Depth=1
	sub.d	$a7, $t4, $t0
	alsl.d	$a6, $t0, $a6, 2
	alsl.d	$a5, $t0, $a5, 2
	.p2align	4, , 16
.LBB0_149:                              # %scalar.ph530
                                        #   Parent Loop BB0_143 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa1, $a5, 0
	fdiv.s	$fa1, $fa1, $fa3
...
.LBB0_189:                              # %vector.body455
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_189
# %bb.190:                              # %middle.block464
	bne	$a3, $t7, .LBB0_95
	b	.LBB0_97
.LBB0_191:                              # %vector.memcheck467
	alsl.d	$a4, $t7, $a2, 2
	addi.d	$a5, $s6, 4
	add.d	$a3, $t1, $a5
	sltu	$a3, $a2, $a3
...
.LBB0_194:                              # %vector.body484
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_194
# %bb.195:                              # %middle.block493
	bne	$a3, $t7, .LBB0_101
	b	.LBB0_103
.LBB0_196:                              # %vector.memcheck496
	sub.d	$a5, $a5, $t2
	nor	$a5, $a5, $zero
...
# %bb.58:                               # %middle.block383
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB1_61
.LBB1_59:                               # %.lr.ph29.i.preheader557
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s6, 2
	.p2align	4, , 16
...
# %bb.94:
	move	$a3, $zero
.LBB1_95:                               # %scalar.ph454.preheader
	alsl.d	$a4, $a3, $s3, 2
	sub.d	$a5, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB1_96:                               # %scalar.ph454
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.100:
	move	$a3, $zero
.LBB1_101:                              # %scalar.ph483.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a4, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB1_102:                              # %scalar.ph483
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a2, 0
...
.LBB1_104:
	move	$a0, $t7
.LBB1_105:                              # %scalar.ph513.preheader
	addi.d	$a1, $a0, 1
	ld.d	$a4, $sp, 432                   # 8-byte Folded Reload
	alsl.d	$a4, $a0, $a4, 2
	alsl.d	$a5, $a0, $t6, 2
...
# %bb.144:                              # %.preheader2.i
	...
	sub.d	$a7, $a6, $a5
	bltu	$a7, $a4, .LBB1_148
# %bb.145:                              # %vector.body541.preheader
                                        #   in Loop: Header=BB1_143 Depth=1
	addi.d	$a7, $a6, 16
	addi.d	$t0, $a5, 16
	move	$t1, $a2
	.p2align	4, , 16
.LBB1_146:                              # %vector.body541
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB1_146
# %bb.147:                              # %middle.block546
                                        #   in Loop: Header=BB1_143 Depth=1
	move	$t0, $a2
	beq	$t3, $a2, .LBB1_142
.LBB1_148:                              # %scalar.ph534.preheader
                                        #   in Loop: Header=BB1_143 Depth=1
	sub.d	$a7, $t3, $t0
	alsl.d	$a6, $t0, $a6, 2
	alsl.d	$a5, $t0, $a5, 2
	.p2align	4, , 16
.LBB1_149:                              # %scalar.ph534
                                        #   Parent Loop BB1_143 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa1, $a5, 0
	fdiv.s	$fa1, $fa1, $fa3
...
.LBB1_189:                              # %vector.body459
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_189
# %bb.190:                              # %middle.block468
	bne	$a3, $t7, .LBB1_95
	b	.LBB1_97
.LBB1_191:                              # %vector.memcheck471
	alsl.d	$a4, $t7, $a2, 2
	addi.d	$a5, $t8, 4
	add.d	$a3, $t1, $a5
	sltu	$a3, $a2, $a3
...
.LBB1_194:                              # %vector.body488
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_194
# %bb.195:                              # %middle.block497
	bne	$a3, $t7, .LBB1_101
	b	.LBB1_103
.LBB1_196:                              # %vector.memcheck500
	sub.d	$a5, $a5, $t2
	nor	$a5, $a5, $zero
	bstrpick.d	$a5, $a5, 31, 0
	slli.d	$a5, $a5, 2
