...
.LBB0_216:                              # %vector.body366
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_216
# %bb.217:                              # %middle.block376
	addi.d	$a5, $a0, -1
	beq	$a5, $a3, .LBB0_52
# %bb.218:                              # %vec.epilog.iter.check382
	beqz	$a4, .LBB0_50
.LBB0_219:                              # %vec.epilog.ph384
	addi.d	$a2, $a0, -1
	move	$a4, $a2
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB0_220:                              # %vec.epilog.vector.body387
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a3, .LBB0_220
# %bb.221:                              # %vec.epilog.middle.block394
	addi.d	$a3, $a0, -1
	bne	$a3, $a4, .LBB0_50
	b	.LBB0_52
.LBB0_222:                              # %vector.ph446
	addi.d	$a2, $a0, -1
	andi	$a3, $a2, 12
	move	$a1, $a2
	bstrins.d	$a1, $zero, 3, 0
...
.LBB0_223:                              # %vector.body449
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_223
# %bb.224:                              # %middle.block457
	addi.d	$a4, $a0, -1
	beq	$a4, $a1, .LBB0_94
# %bb.225:                              # %vec.epilog.iter.check463
	beqz	$a3, .LBB0_92
.LBB0_226:                              # %vec.epilog.ph465
	addi.d	$a2, $a0, -1
	move	$a3, $a2
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_227:                              # %vec.epilog.vector.body468
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a4, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a5, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a1, .LBB0_227
# %bb.228:                              # %vec.epilog.middle.block474
	addi.d	$a1, $a0, -1
	bne	$a1, $a3, .LBB0_92
	b	.LBB0_94
.LBB0_229:                              # %vector.ph492
	andi	$a1, $t4, 12
	bstrpick.d	$a0, $t4, 30, 4
	xvldrepl.w	$xr0, $a2, 0
	slli.d	$a0, $a0, 4
	addi.d	$a3, $s7, 36
	addi.d	$a4, $s4, 32
...
.LBB0_230:                              # %vector.body495
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_230
# %bb.231:                              # %middle.block504
	beq	$a0, $t4, .LBB0_113
# %bb.232:                              # %vec.epilog.iter.check509
	beqz	$a1, .LBB0_111
.LBB0_233:                              # %vec.epilog.ph511
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s4, 2
	.p2align	4, , 16
.LBB0_234:                              # %vec.epilog.vector.body514
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a1, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB0_234
# %bb.235:                              # %vec.epilog.middle.block521
	bne	$a0, $t4, .LBB0_111
	b	.LBB0_113
.LBB0_236:                              # %vector.ph540
	andi	$a4, $s2, 12
...
.LBB0_237:                              # %vector.body543
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_237
# %bb.238:                              # %middle.block552
	move	$s3, $s0
	beq	$a3, $s2, .LBB0_117
# %bb.239:                              # %vec.epilog.iter.check557
	beqz	$a4, .LBB0_115
.LBB0_240:                              # %vec.epilog.ph559
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $s3, 2
	.p2align	4, , 16
.LBB0_241:                              # %vec.epilog.vector.body562
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_241
# %bb.242:                              # %vec.epilog.middle.block569
	bne	$a3, $s2, .LBB0_115
	b	.LBB0_117
.LBB0_243:                              # %vector.ph588
	andi	$a4, $s2, 12
	bstrpick.d	$a3, $s2, 30, 4
	xvldrepl.w	$xr0, $a0, 0
	slli.d	$a3, $a3, 4
...
.LBB0_244:                              # %vector.body591
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_244
# %bb.245:                              # %middle.block600
	move	$s3, $s0
	beq	$a3, $s2, .LBB0_123
# %bb.246:                              # %vec.epilog.iter.check605
	beqz	$a4, .LBB0_121
.LBB0_247:                              # %vec.epilog.ph607
	move	$a6, $a3
	bstrpick.d	$a3, $s2, 30, 2
	slli.d	$a3, $a3, 2
	vldrepl.w	$vr0, $a0, 0
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB0_248:                              # %vec.epilog.vector.body610
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_248
# %bb.249:                              # %vec.epilog.middle.block617
	bne	$a3, $s2, .LBB0_121
	b	.LBB0_123
.LBB0_250:
