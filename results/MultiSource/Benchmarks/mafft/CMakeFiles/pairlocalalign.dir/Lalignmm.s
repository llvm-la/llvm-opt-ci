...
# %bb.55:                               # %iter.check414
	...
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB0_89
# %bb.56:                               # %vector.main.loop.iter.check400
	ori	$a3, $zero, 17
	bge	$t6, $a3, .LBB0_82
# %bb.57:
	move	$a4, $zero
...
.LBB0_83:                               # %vector.body405
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB0_83
# %bb.84:                               # %middle.block410
	addi.d	$a6, $a0, -1
	beq	$a6, $a4, .LBB0_91
# %bb.85:                               # %vec.epilog.iter.check416
	beqz	$a5, .LBB0_89
.LBB0_86:                               # %vec.epilog.ph418
	addi.d	$a3, $a0, -1
	move	$a5, $a3
	...
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB0_87:                               # %vec.epilog.vector.body421
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a7, 0
	addi.d	$a6, $a6, 16
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB0_87
# %bb.88:                               # %vec.epilog.middle.block425
	addi.d	$a4, $a0, -1
	beq	$a4, $a5, .LBB0_91
...
.LBB0_91:                               # %iter.check458
	...
	bge	$t6, $a3, .LBB0_185
.LBB0_92:                               # %vec.epilog.scalar.ph459.preheader
	sub.d	$a1, $a0, $a2
	...
	addi.d	$a2, $a2, -4
	.p2align	4, , 16
.LBB0_93:                               # %vec.epilog.scalar.ph459
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $s5, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB0_110:                              # %vec.epilog.scalar.ph505.preheader
	alsl.d	$a1, $a0, $s4, 2
	sub.d	$a3, $a5, $a0
	alsl.d	$a0, $a0, $a6, 2
	addi.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB0_111:                              # %vec.epilog.scalar.ph505
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a0, 0
	fld.s	$fa2, $a1, 0
...
# %bb.113:
	move	$a3, $zero
.LBB0_114:                              # %vec.epilog.scalar.ph553.preheader
	alsl.d	$a4, $a3, $a7, 2
	sub.d	$a5, $t7, $a3
	alsl.d	$a3, $a3, $t1, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_115:                              # %vec.epilog.scalar.ph553
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.119:
	move	$a3, $zero
.LBB0_120:                              # %vec.epilog.scalar.ph601.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a4, $t7, $a3
	alsl.d	$a3, $a3, $t1, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_121:                              # %vec.epilog.scalar.ph601
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a2, 0
...
.LBB0_124:                              # %scalar.ph630.preheader
	addi.d	$a1, $a0, 1
...
.LBB0_162:                              # %iter.check667
	...
	move	$t4, $zero
	bltu	$ra, $a6, .LBB0_173
# %bb.163:                              # %iter.check667
                                        #   in Loop: Header=BB0_162 Depth=1
	sub.d	$t3, $t2, $t1
	bltu	$t3, $a7, .LBB0_173
# %bb.164:                              # %vector.main.loop.iter.check652
                                        #   in Loop: Header=BB0_162 Depth=1
	bgeu	$ra, $t0, .LBB0_166
# %bb.165:                              #   in Loop: Header=BB0_162 Depth=1
	...
	b	.LBB0_170
	.p2align	4, , 16
.LBB0_166:                              # %vector.body659.preheader
                                        #   in Loop: Header=BB0_162 Depth=1
	addi.d	$t3, $t2, 32
	addi.d	$t4, $t1, 32
	move	$t5, $a3
	.p2align	4, , 16
.LBB0_167:                              # %vector.body659
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB0_167
# %bb.168:                              # %middle.block664
                                        #   in Loop: Header=BB0_162 Depth=1
	beq	$ra, $a3, .LBB0_161
# %bb.169:                              # %vec.epilog.iter.check669
                                        #   in Loop: Header=BB0_162 Depth=1
	move	$t5, $a3
	move	$t4, $a3
	beqz	$a2, .LBB0_173
.LBB0_170:                              # %vec.epilog.ph671
                                        #   in Loop: Header=BB0_162 Depth=1
	add.d	$t3, $a5, $t5
	alsl.d	$t4, $t5, $t2, 2
	alsl.d	$t5, $t5, $t1, 2
	.p2align	4, , 16
.LBB0_171:                              # %vec.epilog.vector.body676
                                        #   Parent Loop BB0_162 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $t5, 0
	vfdiv.s	$vr2, $vr2, $vr1
	...
	addi.d	$t5, $t5, 16
	bnez	$t3, .LBB0_171
# %bb.172:                              # %vec.epilog.middle.block680
                                        #   in Loop: Header=BB0_162 Depth=1
	move	$t4, $a4
	beq	$ra, $a4, .LBB0_161
.LBB0_173:                              # %vec.epilog.scalar.ph668.preheader
                                        #   in Loop: Header=BB0_162 Depth=1
	sub.d	$t3, $ra, $t4
	alsl.d	$t2, $t4, $t2, 2
	alsl.d	$t1, $t4, $t1, 2
	.p2align	4, , 16
.LBB0_174:                              # %vec.epilog.scalar.ph668
                                        #   Parent Loop BB0_162 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa2, $t1, 0
	fdiv.s	$fa2, $fa2, $fa4
...
.LBB0_185:                              # %vector.memcheck428
	...
	and	$a1, $a1, $a4
	bnez	$a1, .LBB0_92
# %bb.186:                              # %vector.memcheck428
	addi.d	$a1, $t8, 8
	sltu	$a1, $a5, $a1
	sltu	$a3, $s5, $a3
	and	$a1, $a1, $a3
	bnez	$a1, .LBB0_92
# %bb.187:                              # %vector.main.loop.iter.check442
	ori	$a1, $zero, 17
	bge	$t6, $a1, .LBB0_222
# %bb.188:
	move	$a1, $zero
	b	.LBB0_226
.LBB0_189:                              # %vector.memcheck474
	slli.d	$a0, $a5, 2
	alsl.d	$a1, $a5, $s4, 2
	addi.d	$a3, $a0, 4
	add.d	$a0, $a4, $a3
...
# %bb.194:                              # %vector.memcheck521
	...
	and	$a4, $a4, $a5
	bnez	$a4, .LBB0_114
# %bb.195:                              # %vector.main.loop.iter.check535
	ori	$a3, $zero, 17
	ld.d	$a4, $sp, 416                   # 8-byte Folded Reload
	bgeu	$a4, $a3, .LBB0_236
# %bb.196:
...
# %bb.198:                              # %vector.memcheck569
	...
	and	$a4, $a5, $a4
	bnez	$a4, .LBB0_120
# %bb.199:                              # %vector.main.loop.iter.check583
	ori	$a3, $zero, 17
	ld.d	$a4, $sp, 416                   # 8-byte Folded Reload
	bgeu	$a4, $a3, .LBB0_243
# %bb.200:
...
.LBB0_216:                              # %vector.body366
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_216
# %bb.217:                              # %middle.block375
	addi.d	$a5, $a0, -1
	beq	$a5, $a3, .LBB0_52
# %bb.218:                              # %vec.epilog.iter.check381
	beqz	$a4, .LBB0_50
.LBB0_219:                              # %vec.epilog.ph383
	addi.d	$a2, $a0, -1
	move	$a4, $a2
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB0_220:                              # %vec.epilog.vector.body386
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a3, .LBB0_220
# %bb.221:                              # %vec.epilog.middle.block393
	addi.d	$a3, $a0, -1
	bne	$a3, $a4, .LBB0_50
	b	.LBB0_52
.LBB0_222:                              # %vector.ph444
	addi.d	$a2, $a0, -1
	andi	$a3, $a2, 12
	move	$a1, $a2
	bstrins.d	$a1, $zero, 3, 0
...
.LBB0_223:                              # %vector.body447
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_223
# %bb.224:                              # %middle.block454
	addi.d	$a4, $a0, -1
	beq	$a4, $a1, .LBB0_94
# %bb.225:                              # %vec.epilog.iter.check460
	beqz	$a3, .LBB0_92
.LBB0_226:                              # %vec.epilog.ph462
	addi.d	$a2, $a0, -1
	move	$a3, $a2
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_227:                              # %vec.epilog.vector.body465
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a4, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a5, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a1, .LBB0_227
# %bb.228:                              # %vec.epilog.middle.block471
	addi.d	$a1, $a0, -1
	bne	$a1, $a3, .LBB0_92
	b	.LBB0_94
.LBB0_229:                              # %vector.ph489
	andi	$a1, $a5, 12
...
.LBB0_230:                              # %vector.body492
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_230
# %bb.231:                              # %middle.block501
	beq	$a0, $s2, .LBB0_112
# %bb.232:                              # %vec.epilog.iter.check506
	move	$a5, $s2
	beqz	$a1, .LBB0_110
.LBB0_233:                              # %vec.epilog.ph508
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s4, 2
	.p2align	4, , 16
.LBB0_234:                              # %vec.epilog.vector.body511
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a1, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB0_234
# %bb.235:                              # %vec.epilog.middle.block518
	bne	$a0, $a5, .LBB0_110
	b	.LBB0_112
.LBB0_236:                              # %vector.ph537
	andi	$a4, $t7, 12
...
.LBB0_237:                              # %vector.body540
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_237
# %bb.238:                              # %middle.block549
	move	$a7, $s3
	beq	$a3, $t7, .LBB0_116
# %bb.239:                              # %vec.epilog.iter.check554
	beqz	$a4, .LBB0_114
.LBB0_240:                              # %vec.epilog.ph556
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $a7, 2
	.p2align	4, , 16
.LBB0_241:                              # %vec.epilog.vector.body559
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_241
# %bb.242:                              # %vec.epilog.middle.block566
	bne	$a3, $t7, .LBB0_114
	b	.LBB0_116
.LBB0_243:                              # %vector.ph585
	andi	$a4, $t7, 12
	bstrpick.d	$a3, $t7, 30, 4
	xvldrepl.w	$xr0, $a0, 0
	slli.d	$a3, $a3, 4
...
.LBB0_244:                              # %vector.body588
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_244
# %bb.245:                              # %middle.block597
	move	$a7, $s3
	beq	$a3, $t7, .LBB0_122
# %bb.246:                              # %vec.epilog.iter.check602
	beqz	$a4, .LBB0_120
.LBB0_247:                              # %vec.epilog.ph604
	move	$a6, $a3
	bstrpick.d	$a3, $t7, 30, 2
	slli.d	$a3, $a3, 2
	vldrepl.w	$vr0, $a0, 0
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB0_248:                              # %vec.epilog.vector.body607
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_248
# %bb.249:                              # %vec.epilog.middle.block614
	bne	$a3, $t7, .LBB0_120
	b	.LBB0_122
.LBB0_250:
...
# %bb.55:                               # %iter.check418
	...
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB1_89
# %bb.56:                               # %vector.main.loop.iter.check404
	ori	$a3, $zero, 17
	bge	$t7, $a3, .LBB1_82
# %bb.57:
	move	$a4, $zero
...
.LBB1_83:                               # %vector.body409
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB1_83
# %bb.84:                               # %middle.block414
	addi.d	$a6, $a0, -1
	beq	$a6, $a4, .LBB1_91
# %bb.85:                               # %vec.epilog.iter.check420
	beqz	$a5, .LBB1_89
.LBB1_86:                               # %vec.epilog.ph422
	addi.d	$a3, $a0, -1
	move	$a5, $a3
	bstrins.d	$a5, $zero, 1, 0
	ori	$a6, $zero, 1
	...
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB1_87:                               # %vec.epilog.vector.body425
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a7, 0
	addi.d	$a6, $a6, 16
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB1_87
# %bb.88:                               # %vec.epilog.middle.block429
	addi.d	$a4, $a0, -1
	beq	$a4, $a5, .LBB1_91
...
.LBB1_90:                               # %.lr.ph29.i
	...
	addi.d	$a3, $a3, 4
	bnez	$a4, .LBB1_90
.LBB1_91:                               # %iter.check462
	ori	$a2, $zero, 1
	ori	$a3, $zero, 5
	addi.d	$a5, $t2, 4
	st.d	$a5, $sp, 256                   # 8-byte Folded Spill
	bge	$t7, $a3, .LBB1_186
.LBB1_92:                               # %vec.epilog.scalar.ph463.preheader
	sub.d	$a1, $a0, $a2
	...
	addi.d	$a2, $a2, -4
	.p2align	4, , 16
.LBB1_93:                               # %vec.epilog.scalar.ph463
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $s5, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB1_110:                              # %vec.epilog.scalar.ph509.preheader
	ld.d	$t7, $sp, 176                   # 8-byte Folded Reload
	move	$a7, $s3
.LBB1_111:                              # %vec.epilog.scalar.ph509.preheader
	alsl.d	$a1, $a0, $s4, 2
	sub.d	$a3, $a5, $a0
	alsl.d	$a0, $a0, $s7, 2
	addi.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB1_112:                              # %vec.epilog.scalar.ph509
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a0, 0
	fld.s	$fa2, $a1, 0
...
# %bb.114:
	move	$a3, $zero
.LBB1_115:                              # %vec.epilog.scalar.ph557.preheader
	alsl.d	$a4, $a3, $a7, 2
	sub.d	$a5, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB1_116:                              # %vec.epilog.scalar.ph557
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
# %bb.120:
	move	$a3, $zero
.LBB1_121:                              # %vec.epilog.scalar.ph605.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a4, $t7, $a3
	alsl.d	$a3, $a3, $s8, 2
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB1_122:                              # %vec.epilog.scalar.ph605
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a2, 0
...
.LBB1_125:                              # %scalar.ph634.preheader
	addi.d	$a1, $a0, 1
...
# %bb.166:                              #   in Loop: Header=BB1_163 Depth=1
	...
	b	.LBB1_171
	.p2align	4, , 16
.LBB1_167:                              # %vector.body663.preheader
                                        #   in Loop: Header=BB1_163 Depth=1
	addi.d	$t3, $t2, 32
	addi.d	$t4, $t1, 32
	move	$t5, $a3
	.p2align	4, , 16
.LBB1_168:                              # %vector.body663
...
# %bb.170:                              # %vec.epilog.iter.check673
	...
	move	$t4, $a3
	beqz	$a2, .LBB1_174
.LBB1_171:                              # %vec.epilog.ph675
                                        #   in Loop: Header=BB1_163 Depth=1
	add.d	$t3, $a5, $t5
	alsl.d	$t4, $t5, $t2, 2
	alsl.d	$t5, $t5, $t1, 2
	.p2align	4, , 16
.LBB1_172:                              # %vec.epilog.vector.body680
                                        #   Parent Loop BB1_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $t5, 0
	vfdiv.s	$vr2, $vr2, $vr1
...
# %bb.173:                              # %vec.epilog.middle.block684
	...
	move	$t4, $a4
	beq	$ra, $a4, .LBB1_162
.LBB1_174:                              # %vec.epilog.scalar.ph672.preheader
                                        #   in Loop: Header=BB1_163 Depth=1
	sub.d	$t3, $ra, $t4
	alsl.d	$t2, $t4, $t2, 2
	alsl.d	$t1, $t4, $t1, 2
	.p2align	4, , 16
.LBB1_175:                              # %vec.epilog.scalar.ph672
                                        #   Parent Loop BB1_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa2, $t1, 0
	fdiv.s	$fa2, $fa2, $fa4
...
.LBB1_186:                              # %vector.memcheck432
	...
	and	$a1, $a1, $a4
	bnez	$a1, .LBB1_92
# %bb.187:                              # %vector.memcheck432
	addi.d	$a1, $s7, 8
	sltu	$a1, $a5, $a1
	sltu	$a3, $s5, $a3
	and	$a1, $a1, $a3
	bnez	$a1, .LBB1_92
# %bb.188:                              # %vector.main.loop.iter.check446
	ori	$a1, $zero, 17
	bge	$t7, $a1, .LBB1_223
# %bb.189:
	move	$a1, $zero
	b	.LBB1_227
.LBB1_190:                              # %vector.memcheck478
	slli.d	$a0, $a5, 2
	alsl.d	$a1, $a5, $s4, 2
	addi.d	$a3, $a0, 4
	add.d	$a0, $a4, $a3
...
# %bb.191:                              # %vector.memcheck478
	...
	move	$a7, $s3
	bnez	$a1, .LBB1_111
# %bb.192:                              # %vector.main.loop.iter.check491
	ori	$a0, $zero, 16
	bgeu	$t5, $a0, .LBB1_230
# %bb.193:
	move	$a0, $zero
	b	.LBB1_234
.LBB1_194:                              # %vector.memcheck525
	addi.d	$a4, $s6, 4
	add.d	$a3, $t1, $a4
	sltu	$a3, $a7, $a3
	sltu	$a5, $a0, $a1
...
# %bb.195:                              # %vector.memcheck525
	...
	and	$a4, $a4, $a5
	bnez	$a4, .LBB1_115
# %bb.196:                              # %vector.main.loop.iter.check539
	ori	$a3, $zero, 17
	ld.d	$a4, $sp, 424                   # 8-byte Folded Reload
	bgeu	$a4, $a3, .LBB1_237
# %bb.197:
...
# %bb.199:                              # %vector.memcheck573
	...
	and	$a4, $a5, $a4
	bnez	$a4, .LBB1_121
# %bb.200:                              # %vector.main.loop.iter.check587
	ori	$a3, $zero, 17
	ld.d	$a4, $sp, 424                   # 8-byte Folded Reload
	bgeu	$a4, $a3, .LBB1_244
# %bb.201:
...
.LBB1_221:                              # %vec.epilog.vector.body390
	...
	addi.d	$a6, $a6, 16
	bnez	$a3, .LBB1_221
# %bb.222:                              # %vec.epilog.middle.block397
	addi.d	$a3, $a0, -1
	bne	$a3, $a4, .LBB1_50
	b	.LBB1_52
.LBB1_223:                              # %vector.ph448
	addi.d	$a2, $a0, -1
	andi	$a3, $a2, 12
	move	$a1, $a2
	bstrins.d	$a1, $zero, 3, 0
...
.LBB1_224:                              # %vector.body451
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_224
# %bb.225:                              # %middle.block458
	addi.d	$a4, $a0, -1
	beq	$a4, $a1, .LBB1_94
# %bb.226:                              # %vec.epilog.iter.check464
	beqz	$a3, .LBB1_92
.LBB1_227:                              # %vec.epilog.ph466
	addi.d	$a2, $a0, -1
	move	$a3, $a2
	bstrins.d	$a3, $zero, 1, 0
	ori	$a4, $zero, 1
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB1_228:                              # %vec.epilog.vector.body469
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a4, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a5, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a1, .LBB1_228
# %bb.229:                              # %vec.epilog.middle.block475
	addi.d	$a1, $a0, -1
	bne	$a1, $a3, .LBB1_92
	b	.LBB1_94
.LBB1_230:                              # %vector.ph493
	andi	$a1, $a5, 12
	bstrpick.d	$a0, $a5, 30, 4
	xvldrepl.w	$xr0, $a2, 0
	slli.d	$a0, $a0, 4
...
.LBB1_231:                              # %vector.body496
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_231
# %bb.232:                              # %middle.block505
	beq	$a0, $s2, .LBB1_113
# %bb.233:                              # %vec.epilog.iter.check510
	move	$a5, $s2
	beqz	$a1, .LBB1_111
.LBB1_234:                              # %vec.epilog.ph512
	move	$a4, $a0
	bstrpick.d	$a0, $a5, 30, 2
	slli.d	$a0, $a0, 2
	vldrepl.w	$vr0, $a2, 0
	...
	alsl.d	$a4, $a4, $s4, 2
	.p2align	4, , 16
.LBB1_235:                              # %vec.epilog.vector.body515
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a1, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB1_235
# %bb.236:                              # %vec.epilog.middle.block522
	bne	$a0, $a5, .LBB1_111
	b	.LBB1_113
.LBB1_237:                              # %vector.ph541
	andi	$a4, $t7, 12
	bstrpick.d	$a3, $t7, 30, 4
	xvldrepl.w	$xr0, $a0, 0
	slli.d	$a3, $a3, 4
...
.LBB1_238:                              # %vector.body544
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_238
# %bb.239:                              # %middle.block553
	move	$a7, $s3
	beq	$a3, $t7, .LBB1_117
# %bb.240:                              # %vec.epilog.iter.check558
	beqz	$a4, .LBB1_115
.LBB1_241:                              # %vec.epilog.ph560
	move	$a6, $a3
	bstrpick.d	$a3, $t7, 30, 2
	slli.d	$a3, $a3, 2
	vldrepl.w	$vr0, $a0, 0
	...
	alsl.d	$a6, $a6, $a7, 2
	.p2align	4, , 16
.LBB1_242:                              # %vec.epilog.vector.body563
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB1_242
# %bb.243:                              # %vec.epilog.middle.block570
	bne	$a3, $t7, .LBB1_115
	b	.LBB1_117
.LBB1_244:                              # %vector.ph589
	andi	$a4, $t7, 12
	bstrpick.d	$a3, $t7, 30, 4
	xvldrepl.w	$xr0, $a0, 0
	slli.d	$a3, $a3, 4
...
.LBB1_245:                              # %vector.body592
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_245
# %bb.246:                              # %middle.block601
	move	$a7, $s3
	beq	$a3, $t7, .LBB1_123
# %bb.247:                              # %vec.epilog.iter.check606
	beqz	$a4, .LBB1_121
.LBB1_248:                              # %vec.epilog.ph608
	move	$a6, $a3
	bstrpick.d	$a3, $t7, 30, 2
	slli.d	$a3, $a3, 2
	vldrepl.w	$vr0, $a0, 0
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB1_249:                              # %vec.epilog.vector.body611
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB1_249
# %bb.250:                              # %vec.epilog.middle.block618
	bne	$a3, $t7, .LBB1_121
	b	.LBB1_123
.LBB1_251:
	pcalau12i	$a0, %got_pc_hi20(stderr)
