...
# %bb.104:
	move	$a3, $zero
	b	.LBB1_114
.LBB1_105:                              # %vector.main.loop.iter.check705
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB1_107
# %bb.106:
	move	$a3, $zero
	b	.LBB1_111
.LBB1_107:                              # %vector.ph706
	andi	$a4, $t1, 12
...
.LBB1_108:                              # %vector.body709
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB1_108
# %bb.109:                              # %middle.block712
	beq	$a1, $a3, .LBB1_116
# %bb.110:                              # %vec.epilog.iter.check716
	beqz	$a4, .LBB1_114
.LBB1_111:                              # %vec.epilog.ph718
	move	$a7, $a3
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB1_112:                              # %vec.epilog.vector.body721
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB1_112
# %bb.113:                              # %vec.epilog.middle.block724
	beq	$a1, $a3, .LBB1_116
.LBB1_114:                              # %vec.epilog.scalar.ph715.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB1_115:                              # %vec.epilog.scalar.ph715
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a0, 0
	st.w	$zero, $a2, 0
	addi.d	$a2, $a2, 4
...
.LBB1_146:                              # %vector.body732
	...
	addi.d	$a2, $a2, 32
	bnez	$a4, .LBB1_146
# %bb.147:                              # %middle.block737
	beq	$a0, $t1, .LBB1_150
.LBB1_148:                              # %scalar.ph727.preheader
	alsl.d	$a2, $t1, $a3, 3
	sub.d	$a0, $a0, $t1
	addi.d	$a5, $t1, 1
	.p2align	4, , 16
.LBB1_149:                              # %scalar.ph727
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	st.w	$a5, $a4, 0
	addi.d	$a2, $a2, 8
...
# %bb.152:
	move	$a2, $zero
	b	.LBB1_162
.LBB1_153:                              # %vector.main.loop.iter.check745
	ori	$a2, $zero, 16
	bgeu	$a7, $a2, .LBB1_155
# %bb.154:
	move	$a2, $zero
	b	.LBB1_159
.LBB1_155:                              # %vector.ph746
	andi	$a4, $t0, 12
...
.LBB1_156:                              # %vector.body749
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_156
# %bb.157:                              # %middle.block755
	beq	$a7, $a2, .LBB1_164
# %bb.158:                              # %vec.epilog.iter.check759
	beqz	$a4, .LBB1_162
.LBB1_159:                              # %vec.epilog.ph761
	move	$a5, $a2
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB1_160:                              # %vec.epilog.vector.body764
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB1_160
# %bb.161:                              # %vec.epilog.middle.block769
	beq	$a7, $a2, .LBB1_164
.LBB1_162:                              # %vec.epilog.scalar.ph758.preheader
	nor	$a4, $a2, $zero
	alsl.d	$a0, $a2, $a0, 2
	sub.d	$a2, $a7, $a2
	.p2align	4, , 16
.LBB1_163:                              # %vec.epilog.scalar.ph758
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a4, $a4, -1
	addi.d	$a2, $a2, -1
