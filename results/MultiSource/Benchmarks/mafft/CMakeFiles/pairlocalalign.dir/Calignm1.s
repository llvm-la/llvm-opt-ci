...
.LBB1_4:                                # %._crit_edge
	...
	addi.w	$s6, $fp, 0
	addi.w	$a1, $s2, 0
	pcalau12i	$s7, %pc_hi20(Calignm1.v)
	pcalau12i	$s3, %pc_hi20(Calignm1.g)
...
.LBB1_19:                               # %.thread370
	...
	jirl	$ra, $ra, 0
	st.d	$a0, $s7, %pc_lo12(Calignm1.v)
	ori	$a1, $zero, 3
	ori	$a2, $zero, 3
	move	$a0, $s6
	pcaddu18i	$ra, %call36(AllocateFloatCub)
	jirl	$ra, $ra, 0
	st.d	$a0, $s3, %pc_lo12(Calignm1.g)
	addi.w	$s7, $s0, 3
	move	$a0, $s7
...
.LBB1_27:                               # %._crit_edge397
	...
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	st.w	$s0, $a0, %pc_lo12(Calignm1.orlgth)
...
# %bb.33:
	...
	ld.w	$s0, $a1, %pc_lo12(Calignm1.orlgth)
	ld.w	$a1, $s3, 0
	ld.w	$s1, $s5, %pc_lo12(Calignm1.orlgth1)
.LBB1_34:
	slt	$a2, $s0, $a0
...
.LBB1_39:                               #   Parent Loop BB1_38 Depth=1
	...
	fld.s	$fs5, $t5, 312
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $fa3, $fs4
	fld.s	$fs6, $t5, 416
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $fa4, $fs4
	fld.s	$fs5, $t5, 520
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $fa5, $fs4
	fld.s	$fs6, $t5, 624
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $fa6, $fs4
	fld.s	$fs5, $t5, 728
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $fa7, $fs4
	fld.s	$fs6, $t5, 832
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft0, $fs4
	fld.s	$fs5, $t5, 936
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft1, $fs4
	fld.s	$fs6, $t5, 1040
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft2, $fs4
	fld.s	$fs5, $t5, 1144
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft3, $fs4
	fld.s	$fs6, $t5, 1248
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft4, $fs4
	fld.s	$fs5, $t5, 1352
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft5, $fs4
	fld.s	$fs6, $t5, 1456
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft6, $fs4
	fld.s	$fs5, $t5, 1560
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft7, $fs4
	fld.s	$fs6, $t5, 1664
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft8, $fs4
	fld.s	$fs5, $t5, 1768
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft9, $fs4
	fld.s	$fs6, $t5, 1872
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft10, $fs4
	fld.s	$fs5, $t5, 1976
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft11, $fs4
	fldx.s	$fs6, $t5, $a3
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft12, $fs4
	fldx.s	$fs5, $t5, $a4
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft13, $fs4
	fldx.s	$fs6, $t5, $a5
	ffint.s.w	$fs5, $fs5
	fmadd.s	$fs4, $fs5, $ft14, $fs4
	fldx.s	$fs5, $t5, $a6
	ffint.s.w	$fs6, $fs6
	fmadd.s	$fs4, $fs6, $ft15, $fs4
	fldx.s	$fs6, $t5, $a7
	ffint.s.w	$fs5, $fs5
	fldx.s	$fs7, $t5, $t0
...
.LBB1_42:                               #   Parent Loop BB1_38 Depth=1
	...
	ld.b	$t7, $t6, 0
	slli.d	$t7, $t7, 2
	pcalau12i	$t8, %got_pc_hi20(amino_n)
	ld.d	$t8, $t8, %got_pc_lo12(amino_n)
	ldx.w	$t7, $t8, $t7
	slli.d	$t7, $t7, 2
	fldx.s	$fa1, $t7, $t1
	fst.s	$fa1, $t4, 0
...
# %bb.75:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB1_65 Depth=1
	beq	$a3, $t2, .LBB1_64
.LBB1_76:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB1_65 Depth=1
	alsl.d	$t1, $t2, $t1, 2
	alsl.d	$t0, $t2, $t0, 2
	.p2align	4, , 16
.LBB1_77:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB1_65 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$zero, $t0, 0
	st.w	$zero, $t1, 0
...
# %bb.87:                               #   in Loop: Header=BB1_85 Depth=2
	...
	fstx.s	$fa2, $t5, $t4
	b	.LBB1_84
.LBB1_88:                               # %.preheader375
	bltz	$s0, .LBB1_96
# %bb.89:                               # %.preheader374.lr.ph
	move	$a0, $zero
	move	$a1, $zero
	...
	b	.LBB1_91
	.p2align	4, , 16
.LBB1_90:                               # %._crit_edge444
                                        #   in Loop: Header=BB1_91 Depth=1
	addi.d	$a1, $a1, 1
	addi.d	$a6, $a6, 1
	addi.d	$a0, $a0, 4
	beq	$a1, $a3, .LBB1_96
.LBB1_91:                               # %.preheader374
                                        # =>This Loop Header: Depth=1
...
# %bb.104:
	move	$a3, $zero
	b	.LBB1_114
.LBB1_105:                              # %vector.main.loop.iter.check701
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB1_107
# %bb.106:
	move	$a3, $zero
	b	.LBB1_111
.LBB1_107:                              # %vector.ph703
	andi	$a4, $t1, 12
...
.LBB1_108:                              # %vector.body706
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB1_108
# %bb.109:                              # %middle.block709
	beq	$a1, $a3, .LBB1_116
# %bb.110:                              # %vec.epilog.iter.check714
	beqz	$a4, .LBB1_114
.LBB1_111:                              # %vec.epilog.ph716
	move	$a7, $a3
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB1_112:                              # %vec.epilog.vector.body719
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB1_112
# %bb.113:                              # %vec.epilog.middle.block722
	beq	$a1, $a3, .LBB1_116
.LBB1_114:                              # %vec.epilog.scalar.ph713.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB1_115:                              # %vec.epilog.scalar.ph713
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a0, 0
	st.w	$zero, $a2, 0
	addi.d	$a2, $a2, 4
...
# %bb.117:                              # %.lr.ph470
	...
	blez	$a0, .LBB1_139
# %bb.118:                              # %.lr.ph464.preheader
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a1, $a0, %pc_lo12(Calignm1.m)
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$t5, $a0, %pc_lo12(Calignm1.mp)
	ld.d	$a0, $t8, %pc_lo12(Calignm1.gl)
...
.LBB1_119:                              # %._crit_edge465
	...
	beq	$ra, $a0, .LBB1_139
.LBB1_120:                              # =>This Loop Header: Depth=1
...
.LBB1_123:                              #   in Loop: Header=BB1_120 Depth=1
	...
	fst.s	$fa2, $a0, 4
	st.w	$zero, $t5, 4
.LBB1_124:                              #   in Loop: Header=BB1_120 Depth=1
	fld.s	$fa3, $a1, 0
	fld.s	$fa4, $a7, 0
	fld.s	$fa5, $a4, 0
	fadd.s	$fa0, $fa0, $fa1
...
# %bb.125:                              #   in Loop: Header=BB1_120 Depth=1
	...
	st.w	$a0, $t0, 4
	fmov.s	$fa1, $fa3
.LBB1_126:                              #   in Loop: Header=BB1_120 Depth=1
	ld.w	$a0, $t5, 4
	fld.s	$fa3, $a2, 0
	sub.w	$a0, $ra, $a0
	slli.d	$a3, $a0, 2
...
.LBB1_130:                              #   in Loop: Header=BB1_131 Depth=2
	...
	addi.d	$t0, $t0, -1
	beqz	$t1, .LBB1_119
.LBB1_131:                              #   Parent Loop BB1_120 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.s	$fa1, $t2, $s8
	fld.s	$fa3, $t3, 8
	ori	$t6, $zero, 2496
...
.LBB1_146:                              # %vector.body730
	...
	addi.d	$a2, $a2, 32
	bnez	$a4, .LBB1_146
# %bb.147:                              # %middle.block735
	beq	$a0, $t1, .LBB1_150
.LBB1_148:                              # %scalar.ph725.preheader
	alsl.d	$a2, $t1, $a3, 3
	sub.d	$a0, $a0, $t1
	addi.d	$a5, $t1, 1
	.p2align	4, , 16
.LBB1_149:                              # %scalar.ph725
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	st.w	$a5, $a4, 0
	addi.d	$a2, $a2, 8
...
# %bb.152:
	move	$a2, $zero
	b	.LBB1_162
.LBB1_153:                              # %vector.main.loop.iter.check740
	ori	$a2, $zero, 16
	bgeu	$a7, $a2, .LBB1_155
# %bb.154:
	move	$a2, $zero
	b	.LBB1_159
.LBB1_155:                              # %vector.ph742
	andi	$a4, $t0, 12
...
.LBB1_156:                              # %vector.body745
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_156
# %bb.157:                              # %middle.block751
	beq	$a7, $a2, .LBB1_164
# %bb.158:                              # %vec.epilog.iter.check756
	beqz	$a4, .LBB1_162
.LBB1_159:                              # %vec.epilog.ph758
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB1_160:                              # %vec.epilog.vector.body761
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB1_160
# %bb.161:                              # %vec.epilog.middle.block766
	beq	$a7, $a2, .LBB1_164
.LBB1_162:                              # %vec.epilog.scalar.ph755.preheader
	nor	$a4, $a2, $zero
	alsl.d	$a0, $a2, $a0, 2
	sub.d	$a2, $a7, $a2
	.p2align	4, , 16
.LBB1_163:                              # %vec.epilog.scalar.ph755
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a4, $a4, -1
	addi.d	$a2, $a2, -1
