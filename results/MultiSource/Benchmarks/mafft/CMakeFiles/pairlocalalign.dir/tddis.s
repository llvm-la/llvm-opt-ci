...
# %bb.13:                               # %vec.epilog.middle.block
	beq	$a3, $s1, .LBB22_16
.LBB22_14:                              # %vec.epilog.scalar.ph.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a3, $s1, $a3
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB22_15:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a2, 0
	addi.d	$a3, $a3, -1
	addi.d	$a2, $a2, 4
	bnez	$a3, .LBB22_15
.LBB22_16:                              # %.preheader83
	ld.w	$a3, $a0, 0
	bltz	$a3, .LBB22_19
# %bb.17:                               # %.lr.ph86
	ld.d	$a2, $s6, %pc_lo12(nodeFromABranch.table)
...
.LBB22_30:                              # %.lr.ph94
	...
	addi.d	$a3, $a3, 4
	bgez	$a5, .LBB22_30
.LBB22_31:                              # %.preheader80
	ld.w	$a4, $a1, 0
	bltz	$a4, .LBB22_34
# %bb.32:                               # %.lr.ph96.preheader
	addi.d	$a3, $a1, 4
	bstrpick.d	$a4, $a4, 31, 0
	.p2align	4, , 16
.LBB22_33:                              # %.lr.ph96
