...
# %bb.233:
	move	$a5, $zero
	b	.LBB4_261
.LBB4_234:                              # %vector.main.loop.iter.check1398
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_254
# %bb.235:
	move	$a5, $zero
...
# %bb.251:
	move	$a4, $zero
	b	.LBB4_310
.LBB4_252:                              # %vector.main.loop.iter.check1348
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_303
# %bb.253:
	move	$a4, $zero
	b	.LBB4_307
.LBB4_254:                              # %vector.ph1399
	andi	$a7, $a6, 12
...
.LBB4_255:                              # %vector.body1402
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_255
# %bb.256:                              # %middle.block1408
	beq	$a4, $a5, .LBB4_263
# %bb.257:                              # %vec.epilog.iter.check1412
	beqz	$a7, .LBB4_261
.LBB4_258:                              # %vec.epilog.ph1414
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_259:                              # %vec.epilog.vector.body1420
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_259
# %bb.260:                              # %vec.epilog.middle.block1425
	beq	$a4, $a5, .LBB4_263
.LBB4_261:                              # %vec.epilog.scalar.ph1411.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_262:                              # %vec.epilog.scalar.ph1411
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_304:                              # %vector.body1352
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_304
# %bb.305:                              # %middle.block1358
	beq	$a3, $a4, .LBB4_312
# %bb.306:                              # %vec.epilog.iter.check1362
	beqz	$a6, .LBB4_310
.LBB4_307:                              # %vec.epilog.ph1364
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_308:                              # %vec.epilog.vector.body1369
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_308
# %bb.309:                              # %vec.epilog.middle.block1374
	beq	$a3, $a4, .LBB4_312
.LBB4_310:                              # %vec.epilog.scalar.ph1361.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_311:                              # %vec.epilog.scalar.ph1361
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
