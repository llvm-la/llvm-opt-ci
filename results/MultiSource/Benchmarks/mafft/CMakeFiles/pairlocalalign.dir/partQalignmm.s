...
.LBB4_42:                               # %._crit_edge655
	...
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$s8, $a0, %pc_lo12(partQ__align.intwork)
	ori	$a7, $zero, 1
...
.LBB4_78:                               # %vector.body1268
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB4_78
# %bb.79:                               # %middle.block1273
	beq	$a5, $a7, .LBB4_82
.LBB4_80:                               # %scalar.ph1261.preheader
	slli.d	$a5, $a6, 2
	addi.d	$a7, $t6, -4
	sub.d	$a4, $a4, $a6
	movgr2fr.w	$fa0, $a0
	.p2align	4, , 16
.LBB4_81:                               # %scalar.ph1261
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a7, $a5
	stx.w	$zero, $a3, $a5
...
.LBB4_172:                              # %vector.body1285
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_172
# %bb.173:                              # %middle.block1291
	beq	$a2, $a4, .LBB4_176
.LBB4_174:                              # %scalar.ph1276.preheader
...
.LBB4_179:                              # %vector.body1299
	...
	addi.w	$a6, $a6, 2
	bnez	$a7, .LBB4_179
# %bb.180:                              # %middle.block1302
	beq	$a3, $a4, .LBB4_183
.LBB4_181:                              # %scalar.ph1294.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_182:                              # %scalar.ph1294
                                        # =>This Inner Loop Header: Depth=1
...
.LBB4_183:                              # %.loopexit
	...
	ld.d	$s7, $t7, %pc_lo12(partQ__align.mseq2)
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
...
.LBB4_213:                              # %vector.body1355
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_213
# %bb.214:                              # %middle.block1361
	beq	$a4, $a5, .LBB4_217
.LBB4_215:                              # %scalar.ph1350.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_216:                              # %scalar.ph1350
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_267:                              # %vector.memcheck1189
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_53
# %bb.268:                              # %vector.memcheck1189
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_53
# %bb.269:                              # %vector.memcheck1189
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB4_271:                              # %vector.body1212
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB4_271
# %bb.272:                              # %middle.block1221
	bne	$a7, $t2, .LBB4_53
	b	.LBB4_55
.LBB4_273:                              # %vector.memcheck1224
	addi.d	$t0, $t6, 4
	alsl.d	$t2, $a5, $t6, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_57
# %bb.274:                              # %vector.memcheck1224
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_57
# %bb.275:                              # %vector.memcheck1224
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB4_277:                              # %vector.body1247
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB4_277
# %bb.278:                              # %middle.block1256
	bne	$a7, $t2, .LBB4_57
	b	.LBB4_59
.LBB4_279:
	movgr2fr.w	$fa0, $zero
	b	.LBB4_152
.LBB4_280:                              # %vector.ph1307
...
.LBB4_289:                              # %vector.body1325
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_289
# %bb.290:                              # %middle.block1331
	beq	$a3, $a4, .LBB4_293
.LBB4_291:                              # %scalar.ph1320.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_292:                              # %scalar.ph1320
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
