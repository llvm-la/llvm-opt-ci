...
.LBB4_2:
	...
	pcalau12i	$s8, %pc_hi20(partQ__align.mseq)
...
# %bb.6:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s8, %pc_lo12(partQ__align.mseq)
...
.LBB4_7:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s8, %pc_lo12(partQ__align.mseq)
	move	$a0, $s6
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
...
.LBB4_42:                               # %._crit_edge655
	xvst	$xr17, $sp, 240                 # 32-byte Folded Spill
	...
	ld.d	$s5, $sp, 552
	ld.d	$a0, $sp, 344                   # 8-byte Folded Reload
	ld.d	$s1, $a0, %pc_lo12(partQ__align.w1)
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(partQ__align.w2)
	st.d	$a0, $sp, 400                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	...
	ld.d	$a0, $sp, 376                   # 8-byte Folded Reload
	ld.d	$s4, $a0, %pc_lo12(partQ__align.cpmx2)
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
...
# %bb.52:                               # %.lr.ph665
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB4_151
.LBB4_53:                               # %scalar.ph1207.preheader
	alsl.d	$a4, $a6, $a4, 2
	ld.d	$a7, $sp, 408                   # 8-byte Folded Reload
	alsl.d	$a7, $a6, $a7, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_54:                               # %scalar.ph1207
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a7, 0
...
# %bb.56:                               # %.lr.ph668
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB4_157
.LBB4_57:                               # %scalar.ph1242.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a7, $a6, $t7, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_58:                               # %scalar.ph1242
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a7, 0
...
.LBB4_151:                              # %vector.memcheck1189
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_53
# %bb.152:                              # %vector.memcheck1189
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_53
# %bb.153:                              # %vector.memcheck1189
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB4_155:                              # %vector.body1212
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB4_155
# %bb.156:                              # %middle.block1221
	bne	$a7, $t2, .LBB4_53
	b	.LBB4_55
.LBB4_157:                              # %vector.memcheck1224
	addi.d	$t0, $t7, 4
	alsl.d	$t2, $a5, $t7, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_57
# %bb.158:                              # %vector.memcheck1224
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_57
# %bb.159:                              # %vector.memcheck1224
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB4_161:                              # %vector.body1247
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB4_161
# %bb.162:                              # %middle.block1256
	bne	$a7, $t2, .LBB4_57
	b	.LBB4_59
.LBB4_163:                              # %vector.ph1264
	move	$t1, $zero
	andi	$t0, $a5, 12
	move	$a7, $a5
...
.LBB4_194:                              # %vector.body1295
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_194
# %bb.195:                              # %middle.block1301
	beq	$a2, $a4, .LBB4_198
.LBB4_196:                              # %scalar.ph1286.preheader
...
.LBB4_201:                              # %vector.body1313
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_201
# %bb.202:                              # %middle.block1319
	beq	$a3, $a4, .LBB4_205
.LBB4_203:                              # %scalar.ph1304.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_204:                              # %scalar.ph1304
                                        # =>This Inner Loop Header: Depth=1
...
.LBB4_205:                              # %.loopexit
	...
	ld.d	$s7, $t8, %pc_lo12(partQ__align.mseq2)
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(partQ__align.ijp)
	st.d	$a0, $sp, 408                   # 8-byte Folded Spill
	ld.d	$a0, $s2, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
# %bb.233:
	move	$a5, $zero
	b	.LBB4_261
.LBB4_234:                              # %vector.main.loop.iter.check1388
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_254
# %bb.235:
	move	$a5, $zero
...
# %bb.251:
	move	$a4, $zero
	b	.LBB4_309
.LBB4_252:                              # %vector.main.loop.iter.check1339
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_302
# %bb.253:
	move	$a4, $zero
	b	.LBB4_306
.LBB4_254:                              # %vector.ph1390
	andi	$a7, $a6, 12
...
.LBB4_255:                              # %vector.body1393
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_255
# %bb.256:                              # %middle.block1399
	beq	$a4, $a5, .LBB4_263
# %bb.257:                              # %vec.epilog.iter.check1404
	beqz	$a7, .LBB4_261
.LBB4_258:                              # %vec.epilog.ph1406
	move	$a7, $a5
	...
	alsl.d	$a7, $a7, $a3, 2
	.p2align	4, , 16
.LBB4_259:                              # %vec.epilog.vector.body1412
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_259
# %bb.260:                              # %vec.epilog.middle.block1417
	beq	$a4, $a5, .LBB4_263
.LBB4_261:                              # %vec.epilog.scalar.ph1403.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_262:                              # %vec.epilog.scalar.ph1403
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_303:                              # %vector.body1344
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_303
# %bb.304:                              # %middle.block1350
	beq	$a3, $a4, .LBB4_311
# %bb.305:                              # %vec.epilog.iter.check1355
	beqz	$a6, .LBB4_309
.LBB4_306:                              # %vec.epilog.ph1357
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB4_307:                              # %vec.epilog.vector.body1362
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_307
# %bb.308:                              # %vec.epilog.middle.block1367
	beq	$a3, $a4, .LBB4_311
.LBB4_309:                              # %vec.epilog.scalar.ph1354.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_310:                              # %vec.epilog.scalar.ph1354
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB4_352:                              # %.preheader
	blez	$s6, .LBB4_355
# %bb.353:                              # %.lr.ph723
	ld.d	$fp, $s1, %pc_lo12(partQ__align.mseq2)
	.p2align	4, , 16
