...
.LBB4_194:                              # %vector.body1299
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_194
# %bb.195:                              # %middle.block1306
	beq	$a2, $a4, .LBB4_198
.LBB4_196:                              # %scalar.ph1290.preheader
...
.LBB4_201:                              # %vector.body1318
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_201
# %bb.202:                              # %middle.block1325
	beq	$a3, $a4, .LBB4_205
.LBB4_203:                              # %scalar.ph1309.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_204:                              # %scalar.ph1309
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.233:
	move	$a5, $zero
	b	.LBB4_261
.LBB4_234:                              # %vector.main.loop.iter.check1394
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_254
# %bb.235:
	move	$a5, $zero
...
# %bb.251:
	move	$a4, $zero
	b	.LBB4_309
.LBB4_252:                              # %vector.main.loop.iter.check1345
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_302
# %bb.253:
	move	$a4, $zero
	b	.LBB4_306
.LBB4_254:                              # %vector.ph1396
	andi	$a7, $a6, 12
...
.LBB4_255:                              # %vector.body1399
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_255
# %bb.256:                              # %middle.block1405
	beq	$a4, $a5, .LBB4_263
# %bb.257:                              # %vec.epilog.iter.check1410
	beqz	$a7, .LBB4_261
.LBB4_258:                              # %vec.epilog.ph1412
	move	$a7, $a5
	...
	alsl.d	$a7, $a7, $a3, 2
	.p2align	4, , 16
.LBB4_259:                              # %vec.epilog.vector.body1418
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_259
# %bb.260:                              # %vec.epilog.middle.block1423
	beq	$a4, $a5, .LBB4_263
.LBB4_261:                              # %vec.epilog.scalar.ph1409.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_262:                              # %vec.epilog.scalar.ph1409
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_303:                              # %vector.body1350
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_303
# %bb.304:                              # %middle.block1356
	beq	$a3, $a4, .LBB4_311
# %bb.305:                              # %vec.epilog.iter.check1361
	beqz	$a6, .LBB4_309
.LBB4_306:                              # %vec.epilog.ph1363
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB4_307:                              # %vec.epilog.vector.body1368
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_307
# %bb.308:                              # %vec.epilog.middle.block1373
	beq	$a3, $a4, .LBB4_311
.LBB4_309:                              # %vec.epilog.scalar.ph1360.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_310:                              # %vec.epilog.scalar.ph1360
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
