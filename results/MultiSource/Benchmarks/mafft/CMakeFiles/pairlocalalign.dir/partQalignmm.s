...
# %bb.56:                               # %.lr.ph668
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB4_157
.LBB4_57:                               # %scalar.ph1244.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a7, $a6, $t7, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_58:                               # %scalar.ph1244
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a7, 0
...
.LBB4_155:                              # %vector.body1213
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB4_155
# %bb.156:                              # %middle.block1223
	bne	$a7, $t2, .LBB4_53
	b	.LBB4_55
.LBB4_157:                              # %vector.memcheck1226
	addi.d	$t0, $t7, 4
	alsl.d	$t2, $a5, $t7, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_57
# %bb.158:                              # %vector.memcheck1226
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB4_57
# %bb.159:                              # %vector.memcheck1226
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB4_161:                              # %vector.body1249
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB4_161
# %bb.162:                              # %middle.block1259
	bne	$a7, $t2, .LBB4_57
	b	.LBB4_59
.LBB4_163:                              # %vector.ph1267
	move	$t1, $zero
	andi	$t0, $a5, 12
	move	$a7, $a5
...
.LBB4_164:                              # %vector.body1272
	...
	addi.d	$t1, $t1, 64
	bnez	$t3, .LBB4_164
# %bb.165:                              # %middle.block1278
	bne	$a5, $a7, .LBB4_167
# %bb.166:
	st.d	$zero, $sp, 360                 # 8-byte Folded Spill
	ld.d	$t4, $sp, 96                    # 8-byte Folded Reload
	b	.LBB4_174
.LBB4_167:                              # %vec.epilog.iter.check
	ld.d	$t4, $sp, 96                    # 8-byte Folded Reload
	beqz	$t0, .LBB4_171
.LBB4_168:                              # %vec.epilog.ph
	move	$t0, $a5
	...
	vreplgr2vr.w	$vr2, $a0
	.p2align	4, , 16
.LBB4_169:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t7, $t2
	vstx	$vr1, $t1, $t2
...
.LBB4_195:                              # %vector.body1299
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_195
# %bb.196:                              # %middle.block1306
	beq	$a2, $a4, .LBB4_199
.LBB4_197:                              # %scalar.ph1290.preheader
...
.LBB4_202:                              # %vector.body1318
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_202
# %bb.203:                              # %middle.block1325
	beq	$a3, $a4, .LBB4_206
.LBB4_204:                              # %scalar.ph1309.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_205:                              # %scalar.ph1309
                                        # =>This Inner Loop Header: Depth=1
...
.LBB4_206:                              # %.loopexit
	...
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s8, $a0, %pc_lo12(partQ__align.ijp)
	ld.d	$a0, $s2, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	ld.d	$a1, $s5, 0
...
# %bb.234:
	move	$a5, $zero
	b	.LBB4_262
.LBB4_235:                              # %vector.main.loop.iter.check1394
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_255
# %bb.236:
	move	$a5, $zero
...
# %bb.252:
	move	$a4, $zero
	b	.LBB4_310
.LBB4_253:                              # %vector.main.loop.iter.check1345
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_303
# %bb.254:
	move	$a4, $zero
	b	.LBB4_307
.LBB4_255:                              # %vector.ph1396
	andi	$a7, $a6, 12
...
.LBB4_256:                              # %vector.body1399
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_256
# %bb.257:                              # %middle.block1405
	beq	$a4, $a5, .LBB4_264
# %bb.258:                              # %vec.epilog.iter.check1410
	beqz	$a7, .LBB4_262
.LBB4_259:                              # %vec.epilog.ph1412
	move	$a7, $a5
	...
	alsl.d	$a7, $a7, $a3, 2
	.p2align	4, , 16
.LBB4_260:                              # %vec.epilog.vector.body1418
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_260
# %bb.261:                              # %vec.epilog.middle.block1423
	beq	$a4, $a5, .LBB4_264
.LBB4_262:                              # %vec.epilog.scalar.ph1409.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_263:                              # %vec.epilog.scalar.ph1409
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_304:                              # %vector.body1350
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_304
# %bb.305:                              # %middle.block1356
	beq	$a3, $a4, .LBB4_312
# %bb.306:                              # %vec.epilog.iter.check1361
	beqz	$a6, .LBB4_310
.LBB4_307:                              # %vec.epilog.ph1363
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB4_308:                              # %vec.epilog.vector.body1368
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_308
# %bb.309:                              # %vec.epilog.middle.block1373
	beq	$a3, $a4, .LBB4_312
.LBB4_310:                              # %vec.epilog.scalar.ph1360.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_311:                              # %vec.epilog.scalar.ph1360
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
