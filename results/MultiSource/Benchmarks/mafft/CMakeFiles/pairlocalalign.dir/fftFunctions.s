...
.LBB12_31:                              # %._crit_edge169
	...
	ori	$a4, $a3, 2680
	add.d	$a2, $a1, $a4
	ld.d	$a3, $s7, %pc_lo12(blockAlign.track)
	add.d	$a5, $a0, $a4
	lu12i.w	$t4, 24
	ori	$a7, $t4, 1695
	ori	$a6, $zero, 1
...
.Lfunc_end12:
	...
	.p2align	4, 0x0                          # -- Begin function blockAlign2
.LCPI13_0:
	.word	0                               # 0x0
	.word	1                               # 0x1
	.word	2                               # 0x2
...
.LBB13_42:                              # %.preheader.preheader
	...
	fld.d	$fa3, $a2, %pc_lo12(blockAlign2.maxj)
	addi.w	$a3, $zero, -1
	ori	$a4, $zero, 1
	movgr2fr.d	$fa0, $zero
	ori	$a5, $zero, 3
...
.LBB13_43:                              # %._crit_edge193
	...
	fst.d	$fa3, $a2, %pc_lo12(blockAlign2.maxj)
...
# %bb.54:                               #   in Loop: Header=BB13_49 Depth=2
	...
	fmov.d	$fa4, $fa0
	b	.LBB13_58
.LBB13_55:                              # %vector.ph316
                                        #   in Loop: Header=BB13_49 Depth=2
	bstrpick.d	$t8, $t6, 31, 2
	slli.d	$s4, $t8, 2
	pcalau12i	$s5, %pc_hi20(.LCPI13_0)
	vld	$vr8, $s5, %pc_lo12(.LCPI13_0)
	bstrpick.d	$t8, $s3, 31, 2
	slli.d	$t8, $t8, 2
	xvreplve0.d	$xr9, $xr3
	move	$s6, $t1
	xvori.b	$xr7, $xr2, 0
...
.LBB13_56:                              # %vector.body319
	...
	addi.d	$s8, $zero, -1
	maskeqz	$s8, $s8, $s7
	vreplgr2vr.w	$vr11, $s8
	vbitsel.v	$vr6, $vr12, $vr6, $vr11
	xvpickve.d	$xr13, $xr7, 3
	xvpickve.d	$xr14, $xr10, 3
	movgr2cf	$fcc0, $s7
	fsel	$ft5, $ft6, $ft5, $fcc0
	xvpickve.d	$xr14, $xr7, 2
	xvpickve.d	$xr15, $xr10, 2
	fsel	$ft6, $ft7, $ft6, $fcc0
	vextrins.d	$vr14, $vr13, 16
	xvpickve.d	$xr13, $xr7, 1
	...
	xvpermi.q	$xr7, $xr14, 2
	vbitsel.v	$vr5, $vr12, $vr5, $vr11
	vbitsel.v	$vr4, $vr8, $vr4, $vr11
	vaddi.wu	$vr8, $vr8, 4
	addi.d	$s4, $s4, -4
	addi.d	$s6, $s6, 32
	bnez	$s4, .LBB13_56
# %bb.57:                               # %middle.block324
                                        #   in Loop: Header=BB13_49 Depth=2
	vld	$vr8, $s5, %pc_lo12(.LCPI13_0)
	vslli.w	$vr9, $vr6, 31
	vsrai.w	$vr9, $vr9, 31
	...
	bstrpick.d	$s4, $s4, 31, 0
	vreplve.w	$vr7, $vr4, $s4
	fsel	$fa4, $fa0, $fa6, $fcc0
	movfr2gr.s	$s4, $fa7
	vbsrl.v	$vr6, $vr5, 8
	vor.v	$vr5, $vr6, $vr5
	vbsrl.v	$vr6, $vr5, 4
	...
	maskeqz	$s4, $s4, $s5
	beq	$t8, $s3, .LBB13_60
.LBB13_58:                              # %.lr.ph168.split.preheader333
                                        #   in Loop: Header=BB13_49 Depth=2
	alsl.d	$s5, $t8, $t1, 3
	sub.d	$s3, $s3, $t8
	.p2align	4, , 16
.LBB13_59:                              # %.lr.ph168.split
                                        #   Parent Loop BB13_45 Depth=1
                                        #     Parent Loop BB13_49 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fld.d	$fa5, $s5, 0
...
# %bb.62:                               #   in Loop: Header=BB13_49 Depth=2
	...
	b	.LBB13_48
	.p2align	4, , 16
.LBB13_63:                              # %.lr.ph171.split.preheader
                                        #   in Loop: Header=BB13_49 Depth=2
	move	$t8, $zero
	move	$t7, $zero
	movgr2fr.d	$fa3, $zero
...
.LBB14_34:                              # %._crit_edge165
	...
	ld.d	$a5, $a4, %pc_lo12(blockAlign3.track)
	lu12i.w	$a4, 24
	ori	$t0, $a4, 1695
	ori	$a7, $zero, 1
