...
# %bb.141:                              # %vector.memcheck742
	...
	and	$s1, $s4, $s1
	bnez	$s1, .LBB1_155
# %bb.142:                              # %vector.main.loop.iter.check756
                                        #   in Loop: Header=BB1_126 Depth=1
...
.LBB1_149:                              # %vector.body760
	...
	addi.d	$s1, $s1, 64
	bnez	$s4, .LBB1_149
# %bb.150:                              # %middle.block769
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	beq	$a1, $t2, .LBB1_125
# %bb.151:                              # %vec.epilog.iter.check773
                                        #   in Loop: Header=BB1_126 Depth=1
	move	$s1, $t2
	move	$a1, $t2
	ld.d	$t4, $sp, 56                    # 8-byte Folded Reload
	beqz	$t4, .LBB1_155
.LBB1_152:                              # %vec.epilog.ph775
                                        #   in Loop: Header=BB1_126 Depth=1
	vldrepl.w	$vr2, $a0, 0
	...
	alsl.d	$s1, $s1, $s3, 2
	.p2align	4, , 16
.LBB1_153:                              # %vec.epilog.vector.body778
                                        #   Parent Loop BB1_126 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $s1, 0
	vld	$vr4, $a1, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$a0, .LBB1_153
# %bb.154:                              # %vec.epilog.middle.block785
                                        #   in Loop: Header=BB1_126 Depth=1
	move	$a1, $t3
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	beq	$a0, $t3, .LBB1_125
...
# %bb.159:                              # %middle.block723
	...
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	beq	$a1, $t2, .LBB1_125
# %bb.160:                              # %vec.epilog.iter.check727
                                        #   in Loop: Header=BB1_126 Depth=1
	move	$s1, $t2
	move	$a1, $t2
	ld.d	$t4, $sp, 56                    # 8-byte Folded Reload
	beqz	$t4, .LBB1_138
.LBB1_161:                              # %vec.epilog.ph729
                                        #   in Loop: Header=BB1_126 Depth=1
	vldrepl.w	$vr2, $a0, 0
	ld.d	$a0, $sp, 320                   # 8-byte Folded Reload
	add.d	$a0, $a0, $s1
	...
	alsl.d	$s1, $s1, $s3, 2
	.p2align	4, , 16
.LBB1_162:                              # %vec.epilog.vector.body732
                                        #   Parent Loop BB1_126 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $s1, 0
	vld	$vr4, $a1, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$a0, .LBB1_162
# %bb.163:                              # %vec.epilog.middle.block739
                                        #   in Loop: Header=BB1_126 Depth=1
	move	$a1, $t3
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	beq	$a0, $t3, .LBB1_125
