...
.LBB3_2:
	...
	ld.w	$s1, $s7, %pc_lo12(A__align.orlgth2)
...
.LBB3_8:
	...
	st.w	$s1, $s7, %pc_lo12(A__align.orlgth2)
...
.LBB3_74:                               # %iter.check746
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB3_132
.LBB3_75:                               # %vec.epilog.scalar.ph762.preheader
	alsl.d	$a4, $a5, $s5, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a1, $a5, $a1, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB3_76:                               # %vec.epilog.scalar.ph762
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
# %bb.97:                               #   in Loop: Header=BB3_92 Depth=2
	...
	st.w	$s6, $a7, 0
	b	.LBB3_91
.LBB3_98:                               # %vector.main.loop.iter.check790
                                        #   in Loop: Header=BB3_83 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB3_100
# %bb.99:                               #   in Loop: Header=BB3_83 Depth=1
	move	$a5, $zero
	b	.LBB3_104
.LBB3_100:                              # %vector.body794.preheader
                                        #   in Loop: Header=BB3_83 Depth=1
	addi.d	$a1, $s3, 32
	addi.d	$a2, $a3, 32
	ld.d	$a4, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_101:                              # %vector.body794
                                        #   Parent Loop BB3_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a2, -32
	xvld	$xr1, $a2, 0
	...
	addi.d	$a2, $a2, 64
	bnez	$a4, .LBB3_101
# %bb.102:                              # %middle.block803
                                        #   in Loop: Header=BB3_83 Depth=1
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB3_89
# %bb.103:                              # %vec.epilog.iter.check807
                                        #   in Loop: Header=BB3_83 Depth=1
	ld.d	$a5, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB3_107
.LBB3_104:                              # %vec.epilog.ph809
                                        #   in Loop: Header=BB3_83 Depth=1
	...
	add.d	$a5, $a6, $a5
	.p2align	4, , 16
.LBB3_105:                              # %vec.epilog.vector.body813
                                        #   Parent Loop BB3_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vld	$vr1, $a4, 0
...
.LBB3_113:                              # %vector.body840
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_113
# %bb.114:                              # %middle.block847
	beq	$a2, $a4, .LBB3_117
.LBB3_115:                              # %scalar.ph831.preheader
	sub.w	$a2, $t3, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_120:                              # %vector.body859
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_120
# %bb.121:                              # %middle.block866
	beq	$a3, $a4, .LBB3_124
.LBB3_122:                              # %scalar.ph850.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_123:                              # %scalar.ph850
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_132:                              # %vector.memcheck731
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB3_75
# %bb.133:                              # %vector.memcheck731
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB3_75
# %bb.134:                              # %vector.main.loop.iter.check748
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_228
# %bb.135:
	move	$a6, $zero
...
# %bb.151:
	move	$a5, $zero
	b	.LBB3_178
.LBB3_152:                              # %vector.main.loop.iter.check889
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_171
# %bb.153:
	move	$a5, $zero
...
# %bb.165:                              # %vector.memcheck680
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB3_64
# %bb.166:                              # %vector.main.loop.iter.check697
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_250
# %bb.167:
	move	$a5, $zero
...
.LBB3_172:                              # %vector.body893
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_172
# %bb.173:                              # %middle.block899
	beq	$a4, $a5, .LBB3_180
# %bb.174:                              # %vec.epilog.iter.check903
	beqz	$a7, .LBB3_178
.LBB3_175:                              # %vec.epilog.ph905
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_176:                              # %vec.epilog.vector.body910
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_176
# %bb.177:                              # %vec.epilog.middle.block915
	beq	$a4, $a5, .LBB3_180
.LBB3_178:                              # %vec.epilog.scalar.ph902.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_179:                              # %vec.epilog.scalar.ph902
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_199:                              # %._crit_edge20.loopexit.i
	...
	move	$s5, $fp
	bne	$t4, $a2, .LBB3_192
.LBB3_200:                              #   in Loop: Header=BB3_182 Depth=1
	move	$t8, $s3
	move	$t7, $s5
	bne	$t2, $ra, .LBB3_205
	b	.LBB3_207
...
.LBB3_205:                              # %._crit_edge30.i
	...
	addi.w	$fp, $a0, 0
	beq	$t3, $fp, .LBB3_207
# %bb.206:                              #   in Loop: Header=BB3_182 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a1, 0
.LBB3_207:                              #   in Loop: Header=BB3_182 Depth=1
	blez	$t2, .LBB3_212
# %bb.208:                              #   in Loop: Header=BB3_182 Depth=1
	blez	$t3, .LBB3_212
# %bb.209:                              #   in Loop: Header=BB3_182 Depth=1
	...
	b	.LBB3_211
	.p2align	4, , 16
.LBB3_210:                              #   in Loop: Header=BB3_182 Depth=1
	addi.d	$t1, $s7, -1
	move	$t4, $a2
	nor	$t7, $t1, $zero
	add.w	$t8, $s7, $t7
...
.LBB6_215:                              # %vec.epilog.vector.body696
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB6_215
# %bb.216:                              # %vec.epilog.middle.block703
	bne	$a4, $a7, .LBB6_71
	b	.LBB6_73
.LBB6_217:
	pcalau12i	$a0, %got_pc_hi20(stderr)
...
.LBB6_226:                              # %vector.body629
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_226
# %bb.227:                              # %middle.block638
	beq	$a3, $a5, .LBB6_70
# %bb.228:                              # %vec.epilog.iter.check642
	beqz	$a4, .LBB6_234
.LBB6_229:                              # %vec.epilog.ph644
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	vldrepl.w	$vr0, $a0, 0
	ori	$a7, $zero, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_230:                              # %vec.epilog.vector.body647
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
