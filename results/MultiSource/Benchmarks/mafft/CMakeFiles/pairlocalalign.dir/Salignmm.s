...
.LBB3_73:                               # %iter.check746
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB3_131
.LBB3_74:                               # %vec.epilog.scalar.ph762.preheader
	alsl.d	$a4, $a5, $s5, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a1, $a5, $a1, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB3_75:                               # %vec.epilog.scalar.ph762
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
# %bb.83:                               # %iter.check788
	...
	ori	$a2, $zero, 3
	bltu	$a1, $a2, .LBB3_86
# %bb.84:                               # %vector.memcheck779
                                        #   in Loop: Header=BB3_82 Depth=1
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	add.d	$a1, $a3, $a2
	bgeu	$s3, $a1, .LBB3_97
# %bb.85:                               # %vector.memcheck779
                                        #   in Loop: Header=BB3_82 Depth=1
	add.d	$a1, $s3, $a2
	bgeu	$a3, $a1, .LBB3_97
...
# %bb.96:                               #   in Loop: Header=BB3_91 Depth=2
	...
	st.w	$s4, $a7, 0
	b	.LBB3_90
.LBB3_97:                               # %vector.main.loop.iter.check790
                                        #   in Loop: Header=BB3_82 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB3_99
# %bb.98:                               #   in Loop: Header=BB3_82 Depth=1
	move	$a5, $zero
	b	.LBB3_103
.LBB3_99:                               # %vector.body794.preheader
                                        #   in Loop: Header=BB3_82 Depth=1
	addi.d	$a1, $s3, 32
	addi.d	$a2, $a3, 32
	ld.d	$a4, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_100:                              # %vector.body794
                                        #   Parent Loop BB3_82 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a2, -32
	xvld	$xr1, $a2, 0
	...
	addi.d	$a2, $a2, 64
	bnez	$a4, .LBB3_100
# %bb.101:                              # %middle.block803
                                        #   in Loop: Header=BB3_82 Depth=1
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB3_88
# %bb.102:                              # %vec.epilog.iter.check807
                                        #   in Loop: Header=BB3_82 Depth=1
	ld.d	$a5, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB3_106
.LBB3_103:                              # %vec.epilog.ph809
                                        #   in Loop: Header=BB3_82 Depth=1
	...
	add.d	$a5, $a6, $a5
	.p2align	4, , 16
.LBB3_104:                              # %vec.epilog.vector.body813
                                        #   Parent Loop BB3_82 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vld	$vr1, $a4, 0
...
.LBB3_112:                              # %vector.body840
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_112
# %bb.113:                              # %middle.block847
	beq	$a2, $a4, .LBB3_116
.LBB3_114:                              # %scalar.ph831.preheader
	sub.w	$a2, $t3, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_119:                              # %vector.body859
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_119
# %bb.120:                              # %middle.block866
	beq	$a3, $a4, .LBB3_123
.LBB3_121:                              # %scalar.ph850.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_122:                              # %scalar.ph850
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_131:                              # %vector.memcheck731
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB3_74
# %bb.132:                              # %vector.memcheck731
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB3_74
# %bb.133:                              # %vector.main.loop.iter.check748
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_228
# %bb.134:
	move	$a6, $zero
...
# %bb.150:
	move	$a5, $zero
	b	.LBB3_177
.LBB3_151:                              # %vector.main.loop.iter.check889
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_170
# %bb.152:
	move	$a5, $zero
...
# %bb.164:                              # %vector.memcheck680
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB3_63
# %bb.165:                              # %vector.main.loop.iter.check697
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_250
# %bb.166:
	move	$a5, $zero
...
.LBB3_171:                              # %vector.body893
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_171
# %bb.172:                              # %middle.block899
	beq	$a4, $a5, .LBB3_179
# %bb.173:                              # %vec.epilog.iter.check903
	beqz	$a7, .LBB3_177
.LBB3_174:                              # %vec.epilog.ph905
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_175:                              # %vec.epilog.vector.body910
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_175
# %bb.176:                              # %vec.epilog.middle.block915
	beq	$a4, $a5, .LBB3_179
.LBB3_177:                              # %vec.epilog.scalar.ph902.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_178:                              # %vec.epilog.scalar.ph902
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_196:                              #   in Loop: Header=BB3_181 Depth=1
	move	$fp, $s5
	move	$s0, $s3
.LBB3_197:                              # %.lr.ph19.i.preheader964
                                        #   in Loop: Header=BB3_181 Depth=1
	move	$s1, $fp
	move	$s2, $s0
	.p2align	4, , 16
...
.LBB3_229:                              # %vector.body752
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB3_229
# %bb.230:                              # %middle.block759
	beq	$a4, $a6, .LBB3_76
# %bb.231:                              # %vec.epilog.iter.check763
	beqz	$a5, .LBB3_257
.LBB3_232:                              # %vec.epilog.ph765
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB3_233:                              # %vec.epilog.vector.body768
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB3_233
# %bb.234:                              # %vec.epilog.middle.block775
	bne	$a4, $a7, .LBB3_74
	b	.LBB3_76
.LBB3_235:
...
# %bb.245:                              # %middle.block659
	beq	$a3, $a5, .LBB3_61
# %bb.246:                              # %vec.epilog.iter.check663
	beqz	$a4, .LBB3_259
.LBB3_247:                              # %vec.epilog.ph665
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_248:                              # %vec.epilog.vector.body668
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_248
# %bb.249:                              # %vec.epilog.middle.block676
	bne	$a3, $a6, .LBB3_59
	b	.LBB3_61
.LBB3_250:                              # %vector.ph698
	andi	$a4, $a3, 12
	move	$a5, $a3
	xvldrepl.w	$xr0, $a0, 0
	bstrins.d	$a5, $zero, 3, 0
...
.LBB3_251:                              # %vector.body701
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_251
# %bb.252:                              # %middle.block710
	beq	$a3, $a5, .LBB3_73
# %bb.253:                              # %vec.epilog.iter.check714
	beqz	$a4, .LBB3_260
.LBB3_254:                              # %vec.epilog.ph716
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_255:                              # %vec.epilog.vector.body719
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_255
# %bb.256:                              # %vec.epilog.middle.block727
	bne	$a3, $a6, .LBB3_63
	b	.LBB3_73
.LBB3_257:
	addi.d	$a5, $a6, 1
...
.LBB6_97:                               # %vector.body716
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_97
# %bb.98:                               # %middle.block723
	beq	$a2, $a4, .LBB6_101
.LBB6_99:                               # %scalar.ph707.preheader
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
...
.LBB6_104:                              # %vector.body735
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_104
# %bb.105:                              # %middle.block742
	beq	$a3, $a4, .LBB6_108
.LBB6_106:                              # %scalar.ph726.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_107:                              # %scalar.ph726
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_116:                              # %vector.memcheck659
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB6_71
# %bb.117:                              # %vector.memcheck659
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB6_71
# %bb.118:                              # %vector.main.loop.iter.check676
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB6_211
# %bb.119:
	move	$a6, $zero
...
# %bb.127:
	move	$a3, $zero
	b	.LBB6_131
.LBB6_128:                              # %vector.ph747
	pcalau12i	$a4, %pc_hi20(.LCPI6_6)
	vld	$vr0, $a4, %pc_lo12(.LCPI6_6)
	bstrpick.d	$a3, $a3, 31, 2
	slli.d	$a3, $a3, 2
	addi.d	$a4, $s2, 16
	move	$a5, $a3
	.p2align	4, , 16
.LBB6_129:                              # %vector.body750
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, -16
	vld	$vr2, $a4, 0
	vshuf4i.w	$vr3, $vr0, 8
...
# %bb.135:
	move	$a5, $zero
	b	.LBB6_160
.LBB6_136:                              # %vector.main.loop.iter.check765
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB6_153
# %bb.137:
	move	$a5, $zero
...
.LBB6_152:
	...
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	b	.LBB6_76
.LBB6_153:                              # %vector.ph766
	andi	$a7, $a6, 12
	bstrpick.d	$a5, $a6, 31, 4
	slli.d	$a5, $a5, 4
	pcalau12i	$t0, %pc_hi20(.LCPI6_7)
	xvld	$xr0, $t0, %pc_lo12(.LCPI6_7)
	addi.d	$t0, $a3, 32
	xvrepli.b	$xr1, -1
	xvrepli.w	$xr2, -9
	move	$t1, $a5
	.p2align	4, , 16
.LBB6_154:                              # %vector.body769
                                        # =>This Inner Loop Header: Depth=1
	xvxor.v	$xr3, $xr0, $xr1
	xvsub.w	$xr4, $xr2, $xr0
	xvst	$xr3, $t0, -32
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB6_154
# %bb.155:                              # %middle.block775
	beq	$a4, $a5, .LBB6_162
# %bb.156:                              # %vec.epilog.iter.check779
	beqz	$a7, .LBB6_160
.LBB6_157:                              # %vec.epilog.ph781
	move	$a7, $a5
	pcalau12i	$a5, %pc_hi20(.LCPI6_8)
	vld	$vr0, $a5, %pc_lo12(.LCPI6_8)
	bstrpick.d	$a5, $a6, 31, 2
	slli.d	$a5, $a5, 2
	vreplgr2vr.w	$vr1, $a7
	vor.v	$vr0, $vr1, $vr0
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_158:                              # %vec.epilog.vector.body786
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB6_158
# %bb.159:                              # %vec.epilog.middle.block791
	beq	$a4, $a5, .LBB6_162
.LBB6_160:                              # %vec.epilog.scalar.ph778.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_161:                              # %vec.epilog.scalar.ph778
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB6_179:                              #   in Loop: Header=BB6_164 Depth=1
	move	$t8, $s3
	move	$fp, $s5
.LBB6_180:                              # %.lr.ph19.i.preheader838
                                        #   in Loop: Header=BB6_164 Depth=1
	move	$s0, $t8
	move	$s1, $fp
	.p2align	4, , 16
...
.LBB6_212:                              # %vector.body680
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB6_212
# %bb.213:                              # %middle.block687
	beq	$a4, $a6, .LBB6_73
# %bb.214:                              # %vec.epilog.iter.check691
	beqz	$a5, .LBB6_233
.LBB6_215:                              # %vec.epilog.ph693
	move	$a7, $a4
	bstrins.d	$a7, $zero, 1, 0
	ori	$t0, $zero, 1
	move	$a5, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB6_216:                              # %vec.epilog.vector.body696
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB6_216
# %bb.217:                              # %vec.epilog.middle.block703
	bne	$a4, $a7, .LBB6_71
	b	.LBB6_73
.LBB6_218:
	pcalau12i	$a0, %got_pc_hi20(stderr)
...
# %bb.228:                              # %middle.block638
	beq	$a3, $a5, .LBB6_70
# %bb.229:                              # %vec.epilog.iter.check642
	beqz	$a4, .LBB6_235
.LBB6_230:                              # %vec.epilog.ph644
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_231:                              # %vec.epilog.vector.body647
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB6_231
# %bb.232:                              # %vec.epilog.middle.block655
	bne	$a3, $a6, .LBB6_60
	b	.LBB6_70
.LBB6_233:
	addi.d	$a5, $a6, 1
