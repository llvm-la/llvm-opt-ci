...
# %bb.182:                              #   in Loop: Header=BB3_180 Depth=1
	...
	add.w	$ra, $s7, $fp
	beqz	$ra, .LBB3_188
.LBB3_183:                              # %iter.check983
                                        #   in Loop: Header=BB3_180 Depth=1
	ori	$a0, $zero, 16
	bltu	$ra, $a0, .LBB3_193
# %bb.184:                              # %iter.check983
                                        #   in Loop: Header=BB3_180 Depth=1
	sub.d	$a0, $s5, $s3
	ori	$a2, $zero, 64
	bltu	$a0, $a2, .LBB3_193
# %bb.185:                              # %vector.main.loop.iter.check964
                                        #   in Loop: Header=BB3_180 Depth=1
	bstrpick.d	$s8, $ra, 31, 0
	bgeu	$ra, $a2, .LBB3_196
# %bb.186:                              #   in Loop: Header=BB3_180 Depth=1
	move	$a2, $zero
	b	.LBB3_200
	.p2align	4, , 16
.LBB3_187:                              #   in Loop: Header=BB3_180 Depth=1
	...
	bnez	$ra, .LBB3_183
	.p2align	4, , 16
.LBB3_188:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_180 Depth=1
	beq	$t5, $a2, .LBB3_205
.LBB3_189:                              # %iter.check938
                                        #   in Loop: Header=BB3_180 Depth=1
	addi.w	$a0, $zero, -5
	nor	$s2, $t5, $zero
	bltu	$a0, $t5, .LBB3_194
# %bb.190:                              # %iter.check938
                                        #   in Loop: Header=BB3_180 Depth=1
	sub.d	$a0, $s5, $s3
	ori	$a5, $zero, 16
	bltu	$a0, $a5, .LBB3_194
# %bb.191:                              # %vector.main.loop.iter.check918
                                        #   in Loop: Header=BB3_180 Depth=1
	addi.w	$a0, $zero, -17
	bgeu	$a0, $t5, .LBB3_206
...
.LBB3_197:                              # %vector.body970
	...
	addi.d	$a1, $a1, -64
	bnez	$t0, .LBB3_197
# %bb.198:                              # %middle.block977
                                        #   in Loop: Header=BB3_180 Depth=1
	ld.d	$a1, $sp, 304                   # 8-byte Folded Reload
	beq	$a2, $s8, .LBB3_204
# %bb.199:                              # %vec.epilog.iter.check985
                                        #   in Loop: Header=BB3_180 Depth=1
	beqz	$a5, .LBB3_203
.LBB3_200:                              # %vec.epilog.ph987
                                        #   in Loop: Header=BB3_180 Depth=1
	...
	addi.d	$a1, $a1, -16
	.p2align	4, , 16
.LBB3_201:                              # %vec.epilog.vector.body991
                                        #   Parent Loop BB3_180 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $a0, 0
	vst	$vr2, $a1, 0
	...
	addi.d	$a1, $a1, -16
	bnez	$ra, .LBB3_201
# %bb.202:                              # %vec.epilog.middle.block996
                                        #   in Loop: Header=BB3_180 Depth=1
	ld.d	$a1, $sp, 304                   # 8-byte Folded Reload
	beq	$a5, $s8, .LBB3_204
	.p2align	4, , 16
.LBB3_203:                              # %.lr.ph19.i
	...
	addi.d	$s1, $s1, -1
	bnez	$s0, .LBB3_203
.LBB3_204:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_180 Depth=1
	add.d	$a0, $s7, $t8
	add.d	$t8, $fp, $a0
	move	$s5, $s2
...
# %bb.208:                              # %middle.block932
	...
	beq	$s7, $s2, .LBB3_215
# %bb.209:                              # %vec.epilog.iter.check940
                                        #   in Loop: Header=BB3_180 Depth=1
	beqz	$s8, .LBB3_213
.LBB3_210:                              # %vec.epilog.ph942
                                        #   in Loop: Header=BB3_180 Depth=1
	...
	addi.d	$s3, $a0, -4
	.p2align	4, , 16
.LBB3_211:                              # %vec.epilog.vector.body946
                                        #   Parent Loop BB3_180 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a6, $t8, 0
	st.w	$a7, $s3, 0
	...
	addi.d	$s3, $s3, -4
	bnez	$a5, .LBB3_211
# %bb.212:                              # %vec.epilog.middle.block952
                                        #   in Loop: Header=BB3_180 Depth=1
...
.LBB3_216:                              # %._crit_edge30.i
	...
	addi.w	$a0, $a0, 0
	beq	$t4, $a0, .LBB3_218
# %bb.217:                              #   in Loop: Header=BB3_180 Depth=1
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(impmtx)
	ldx.d	$a0, $a0, $t6
	fldx.s	$fa6, $a0, $t7
	...
	fadd.s	$fa6, $fa6, $fa7
	fst.s	$fa6, $a0, 0
.LBB3_218:                              #   in Loop: Header=BB3_180 Depth=1
	ld.d	$s2, $sp, 336                   # 8-byte Folded Reload
	blez	$t3, .LBB3_222
# %bb.219:                              #   in Loop: Header=BB3_180 Depth=1
	blez	$t4, .LBB3_222
# %bb.220:                              #   in Loop: Header=BB3_180 Depth=1
	add.d	$t1, $t5, $t1
	addi.d	$s5, $s0, -1
	st.b	$a3, $s0, -1
	addi.d	$s3, $fp, -1
...
.LBB3_224:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_224
.LBB3_225:                              # %.preheader.i
	ld.d	$s1, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 152                   # 8-byte Folded Reload
	blez	$s1, .LBB3_228
# %bb.226:                              # %.lr.ph52.preheader.i
	move	$fp, $s7
	move	$s0, $s1
	.p2align	4, , 16
.LBB3_227:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB3_227
.LBB3_228:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
...
.LBB3_239:                              # %vector.body748
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB3_239
# %bb.240:                              # %middle.block756
	ld.d	$t3, $sp, 128                   # 8-byte Folded Reload
	beq	$a4, $a6, .LBB3_76
# %bb.241:                              # %vec.epilog.iter.check762
	beqz	$a7, .LBB3_74
.LBB3_242:                              # %vec.epilog.ph764
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB3_243:                              # %vec.epilog.vector.body767
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB3_243
# %bb.244:                              # %vec.epilog.middle.block773
	bne	$a4, $a7, .LBB3_74
	b	.LBB3_76
.LBB3_245:
...
.LBB3_247:                              # %vector.body571
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_247
# %bb.248:                              # %middle.block580
	beq	$a0, $a5, .LBB3_48
# %bb.249:                              # %vec.epilog.iter.check
	beqz	$a6, .LBB3_46
.LBB3_250:                              # %vec.epilog.ph
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_251:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vld	$vr1, $a7, 0
	vfadd.s	$vr0, $vr0, $vr1
...
.LBB3_254:                              # %vector.body648
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_254
# %bb.255:                              # %middle.block658
	beq	$a3, $a5, .LBB3_61
# %bb.256:                              # %vec.epilog.iter.check664
	beqz	$a6, .LBB3_59
.LBB3_257:                              # %vec.epilog.ph666
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_258:                              # %vec.epilog.vector.body669
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_258
# %bb.259:                              # %vec.epilog.middle.block676
	bne	$a3, $a6, .LBB3_59
	b	.LBB3_61
.LBB3_260:                              # %vector.ph695
	andi	$a6, $a3, 12
	move	$a5, $a3
	bstrins.d	$a5, $zero, 3, 0
	xvldrepl.w	$xr0, $a0, 0
...
.LBB3_261:                              # %vector.body698
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_261
# %bb.262:                              # %middle.block708
	beq	$a3, $a5, .LBB3_73
# %bb.263:                              # %vec.epilog.iter.check714
	beqz	$a6, .LBB3_63
.LBB3_264:                              # %vec.epilog.ph716
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	vldrepl.w	$vr0, $a0, 0
	ori	$a7, $zero, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_265:                              # %vec.epilog.vector.body719
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_265
# %bb.266:                              # %vec.epilog.middle.block726
	bne	$a3, $a6, .LBB3_63
	b	.LBB3_73
.Lfunc_end3:
