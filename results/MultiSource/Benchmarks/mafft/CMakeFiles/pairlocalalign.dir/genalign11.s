...
.LBB0_2:
	...
	pcalau12i	$s4, %pc_hi20(genL__align11.mp)
...
# %bb.6:
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s4, %pc_lo12(genL__align11.mp)
...
.LBB0_7:
	...
	jirl	$ra, $ra, 0
	st.d	$a0, $fp, %pc_lo12(genL__align11.mp)
	move	$a0, $s5
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
...
# %bb.22:                               # %iter.check
	...
	ld.d	$a5, $s4, %pc_lo12(genL__align11.mp)
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
...
# %bb.27:                               # %.lr.ph313
	...
	ld.d	$t0, $s4, %pc_lo12(genL__align11.mp)
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
...
.LBB0_65:                               # %vector.body406
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB0_65
# %bb.66:                               # %middle.block409
	beq	$a3, $a4, .LBB0_73
# %bb.67:                               # %vec.epilog.iter.check414
	beqz	$a6, .LBB0_71
.LBB0_68:                               # %vec.epilog.ph416
	move	$a7, $a4
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_69:                               # %vec.epilog.vector.body421
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB0_69
# %bb.70:                               # %vec.epilog.middle.block424
	beq	$a3, $a4, .LBB0_73
.LBB0_71:                               # %vec.epilog.scalar.ph413.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	.p2align	4, , 16
.LBB0_72:                               # %vec.epilog.scalar.ph413
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s1, $a1, 0
	st.w	$s1, $a2, 0
	addi.d	$a3, $a3, -1
...
.LBB0_76:                               # %.lr.ph9.i
	...
	st.b	$a1, $a6, -1
	bnez	$a7, .LBB0_76
# %bb.77:                               # %._crit_edge10.loopexit.i
                                        #   in Loop: Header=BB0_75 Depth=1
	add.d	$a2, $a2, $a5
	add.d	$a2, $a2, $s8
.LBB0_78:                               # %._crit_edge10.i
                                        #   in Loop: Header=BB0_75 Depth=1
	nor	$a5, $a3, $zero
	add.w	$a5, $s6, $a5
	beqz	$a5, .LBB0_80
...
.LBB0_79:                               # %.lr.ph14.i
	...
	addi.d	$a2, $a2, 1
	bnez	$a5, .LBB0_79
.LBB0_80:                               # %._crit_edge15.i
                                        #   in Loop: Header=BB0_75 Depth=1
	addi.w	$a5, $s8, 0
	blez	$a5, .LBB0_85
# %bb.81:                               # %._crit_edge15.i
                                        #   in Loop: Header=BB0_75 Depth=1
	blez	$s6, .LBB0_85
