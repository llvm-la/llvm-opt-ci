...
.LBB0_77:                               # %vector.body353
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_77
# %bb.78:                               # %middle.block359
	beq	$a2, $a3, .LBB0_81
.LBB0_79:                               # %scalar.ph348.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_80:                               # %scalar.ph348
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
