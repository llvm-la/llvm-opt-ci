...
# %bb.37:
	move	$a3, $zero
.LBB0_38:                               # %scalar.ph346.preheader
	alsl.d	$a4, $a3, $s7, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a2, $a3, $a2, 2
