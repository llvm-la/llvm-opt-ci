...
# %bb.4:                                # %middle.block
	...
	addi.w	$s8, $s0, 0
	pcalau12i	$s7, %pc_hi20(suboptalign11.w1)
...
# %bb.8:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s7, %pc_lo12(suboptalign11.w1)
...
.LBB0_9:
	...
	jirl	$ra, $ra, 0
	st.d	$a0, $s7, %pc_lo12(suboptalign11.w1)
	move	$a0, $s0
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
...
.LBB0_17:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	ld.d	$s2, $s7, %pc_lo12(suboptalign11.w1)
	ld.d	$a0, $sp, 232                   # 8-byte Folded Reload
...
.LBB0_69:                               # %vector.body636
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB0_69
# %bb.70:                               # %middle.block639
	beq	$a2, $a4, .LBB0_73
.LBB0_71:                               # %scalar.ph631.preheader
	alsl.d	$a3, $a4, $a3, 2
	alsl.d	$a1, $a4, $a1, 2
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB0_72:                               # %scalar.ph631
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	st.w	$a0, $a3, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB0_72
.LBB0_73:                               # %.preheader380.thread
	bltz	$t0, .LBB0_76
# %bb.74:                               # %.preheader379.preheader
...
.LBB0_75:                               # %.preheader379
	...
	addi.d	$s1, $s1, 8
	bnez	$s2, .LBB0_75
.LBB0_76:                               # %.preheader378
	lu12i.w	$s2, 1220
	blez	$fp, .LBB0_113
# %bb.77:                               # %.lr.ph474.preheader
...
.LBB0_86:                               # %.loopexit
	...
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB0_87:                               # %gentracking.exit.thread
                                        #   in Loop: Header=BB0_88 Depth=1
...
# %bb.89:                               #   in Loop: Header=BB0_88 Depth=1
	...
	st.d	$a1, $sp, 224                   # 8-byte Folded Spill
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s3, $a1, %pc_lo12(suboptalign11.ijpi)
...
# %bb.105:                              #   in Loop: Header=BB0_95 Depth=2
	...
	bge	$a0, $a6, .LBB0_95
	b	.LBB0_107
.LBB0_106:                              # %._crit_edge13.i.._crit_edge24.i_crit_edge
                                        #   in Loop: Header=BB0_88 Depth=1
	ld.w	$t3, $t8, %pc_lo12(localstop)
.LBB0_107:                              # %._crit_edge24.i
                                        #   in Loop: Header=BB0_88 Depth=1
	addi.d	$a6, $a5, 1
	sltui	$a6, $a6, 1
	masknez	$a5, $a5, $a6
...
.Lfunc_end0:
	.size	suboptalign11, .Lfunc_end0-suboptalign11
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function compshuryo
