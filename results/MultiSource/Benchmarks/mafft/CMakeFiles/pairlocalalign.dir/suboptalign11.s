...
# %bb.4:                                # %middle.block
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	pcalau12i	$s5, %pc_hi20(suboptalign11.orlgth1)
	ld.w	$a0, $s5, %pc_lo12(suboptalign11.orlgth1)
...
.LBB0_6:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s5, %pc_lo12(suboptalign11.orlgth1)
	ld.w	$a0, $s6, %pc_lo12(suboptalign11.orlgth2)
...
.LBB0_9:
	...
	st.w	$s3, $s5, %pc_lo12(suboptalign11.orlgth1)
...
.LBB0_28:                               # %.lr.ph446
	...
	ld.d	$t1, $t8, %pc_lo12(suboptalign11.shuryo)
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
...
# %bb.68:                               # %iter.check651
	...
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB0_84
# %bb.69:                               # %vector.main.loop.iter.check640
	ori	$a4, $zero, 16
	bgeu	$a2, $a4, .LBB0_77
# %bb.70:
	move	$a4, $zero
...
.LBB0_78:                               # %vector.body645
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB0_78
# %bb.79:                               # %middle.block648
	beq	$a2, $a4, .LBB0_86
# %bb.80:                               # %vec.epilog.iter.check653
	beqz	$a5, .LBB0_84
.LBB0_81:                               # %vec.epilog.ph655
	move	$a7, $a4
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_82:                               # %vec.epilog.vector.body660
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB0_82
# %bb.83:                               # %vec.epilog.middle.block663
	beq	$a2, $a4, .LBB0_86
.LBB0_84:                               # %vec.epilog.scalar.ph652.preheader
	alsl.d	$a3, $a4, $a3, 2
	alsl.d	$a1, $a4, $a1, 2
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB0_85:                               # %vec.epilog.scalar.ph652
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	st.w	$a0, $a3, 0
	addi.d	$a3, $a3, 4
