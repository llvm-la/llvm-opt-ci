...
# %bb.55:                               # %.lr.ph478
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB4_209
.LBB4_56:                               # %scalar.ph733.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
...
# %bb.59:                               # %.lr.ph481
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB4_214
.LBB4_60:                               # %scalar.ph762.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB4_61:                               # %scalar.ph762
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a4, 0
...
.LBB4_77:                               # %.lr.ph485
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a7, .LBB4_81
.LBB4_78:                               # %scalar.ph791.preheader
	alsl.d	$a5, $a4, $s6, 2
	addi.d	$a5, $a5, -4
	alsl.d	$a1, $a4, $a1, 2
	alsl.d	$a2, $a4, $a2, 2
...
.LBB4_108:                              # %vector.body815
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_108
# %bb.109:                              # %middle.block821
	beq	$a2, $a4, .LBB4_112
.LBB4_110:                              # %scalar.ph806.preheader
	sub.w	$a2, $t3, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_115:                              # %vector.body829
	...
	addi.w	$a5, $a5, 2
	bnez	$a6, .LBB4_115
# %bb.116:                              # %middle.block832
	beq	$a2, $a3, .LBB4_119
.LBB4_117:                              # %scalar.ph824.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_118:                              # %scalar.ph824
                                        # =>This Inner Loop Header: Depth=1
...
.LBB4_149:                              # %vector.body885
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_149
# %bb.150:                              # %middle.block891
	beq	$a4, $a5, .LBB4_153
.LBB4_151:                              # %scalar.ph880.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_152:                              # %scalar.ph880
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_212:                              # %vector.body738
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB4_212
# %bb.213:                              # %middle.block747
	bne	$a4, $a5, .LBB4_56
	b	.LBB4_58
.LBB4_214:                              # %vector.memcheck750
	addi.d	$a5, $s6, 4
	alsl.d	$a6, $a1, $s6, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
...
.LBB4_217:                              # %vector.body767
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB4_217
# %bb.218:                              # %middle.block776
	bne	$a4, $a5, .LBB4_60
	b	.LBB4_77
.LBB4_219:                              # %vector.ph837
...
.LBB4_228:                              # %vector.body855
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_228
# %bb.229:                              # %middle.block861
	beq	$a3, $a4, .LBB4_232
.LBB4_230:                              # %scalar.ph850.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_231:                              # %scalar.ph850
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
