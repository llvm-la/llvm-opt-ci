...
.LBB4_47:                               # %._crit_edge469
	...
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
	ld.d	$s4, $a1, %pc_lo12(partA__align.cpmx1)
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	ld.d	$s8, $a1, %pc_lo12(partA__align.floatwork)
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
...
# %bb.61:                               # %iter.check796
	...
	ori	$a4, $zero, 1
	bgeu	$a3, $a5, .LBB4_172
.LBB4_62:                               # %vec.epilog.scalar.ph797.preheader
	alsl.d	$a2, $a4, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a3, $a4, $t4, 2
	sub.d	$a1, $a1, $a4
	.p2align	4, , 16
.LBB4_63:                               # %vec.epilog.scalar.ph797
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
.LBB4_79:                               # %iter.check844
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB4_83
.LBB4_80:                               # %vec.epilog.scalar.ph845.preheader
	alsl.d	$a4, $a5, $t4, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a1, $a5, $a1, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB4_81:                               # %vec.epilog.scalar.ph845
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB4_83:                               # %vector.memcheck813
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_80
# %bb.84:                               # %vector.memcheck813
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_80
# %bb.85:                               # %vector.main.loop.iter.check827
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_234
# %bb.86:
	move	$a6, $zero
...
.LBB4_109:                              # %vector.body869
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_109
# %bb.110:                              # %middle.block876
	beq	$a2, $a4, .LBB4_113
.LBB4_111:                              # %scalar.ph860.preheader
	sub.w	$a2, $t5, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t4, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_116:                              # %vector.body888
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_116
# %bb.117:                              # %middle.block895
	beq	$a2, $a3, .LBB4_120
.LBB4_118:                              # %scalar.ph879.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_119:                              # %scalar.ph879
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.148:
	move	$a5, $zero
	b	.LBB4_193
.LBB4_149:                              # %vector.main.loop.iter.check964
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_186
# %bb.150:
	move	$a5, $zero
...
# %bb.173:                              # %vector.memcheck763
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB4_62
# %bb.174:                              # %vector.main.loop.iter.check777
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_303
# %bb.175:
	move	$a5, $zero
	b	.LBB4_307
.LBB4_176:                              # %vector.ph900
...
# %bb.183:
	move	$a4, $zero
	b	.LBB4_248
.LBB4_184:                              # %vector.main.loop.iter.check915
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_241
# %bb.185:
	move	$a4, $zero
	b	.LBB4_245
.LBB4_186:                              # %vector.ph966
	andi	$a7, $a6, 12
...
.LBB4_187:                              # %vector.body969
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_187
# %bb.188:                              # %middle.block975
	beq	$a4, $a5, .LBB4_195
# %bb.189:                              # %vec.epilog.iter.check980
	beqz	$a7, .LBB4_193
.LBB4_190:                              # %vec.epilog.ph982
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_191:                              # %vec.epilog.vector.body988
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_191
# %bb.192:                              # %vec.epilog.middle.block993
	beq	$a4, $a5, .LBB4_195
.LBB4_193:                              # %vec.epilog.scalar.ph979.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_194:                              # %vec.epilog.scalar.ph979
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_235:                              # %vector.body832
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB4_235
# %bb.236:                              # %middle.block840
	beq	$a4, $a6, .LBB4_82
# %bb.237:                              # %vec.epilog.iter.check846
	beqz	$a7, .LBB4_80
.LBB4_238:                              # %vec.epilog.ph848
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB4_239:                              # %vec.epilog.vector.body851
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_239
# %bb.240:                              # %vec.epilog.middle.block857
	bne	$a4, $a7, .LBB4_80
	b	.LBB4_82
.LBB4_241:                              # %vector.ph917
	andi	$a6, $a5, 12
...
.LBB4_242:                              # %vector.body920
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_242
# %bb.243:                              # %middle.block926
	beq	$a3, $a4, .LBB4_250
# %bb.244:                              # %vec.epilog.iter.check931
	beqz	$a6, .LBB4_248
.LBB4_245:                              # %vec.epilog.ph933
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_246:                              # %vec.epilog.vector.body938
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_246
# %bb.247:                              # %vec.epilog.middle.block943
	beq	$a3, $a4, .LBB4_250
.LBB4_248:                              # %vec.epilog.scalar.ph930.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_249:                              # %vec.epilog.scalar.ph930
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB4_304:                              # %vector.body782
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_304
# %bb.305:                              # %middle.block792
	beq	$a3, $a5, .LBB4_79
# %bb.306:                              # %vec.epilog.iter.check798
	beqz	$a6, .LBB4_62
.LBB4_307:                              # %vec.epilog.ph800
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	vldrepl.w	$vr0, $a0, 0
	ori	$a7, $zero, 1
...
.LBB4_308:                              # %vec.epilog.vector.body803
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB4_308
# %bb.309:                              # %vec.epilog.middle.block810
	bne	$a3, $a6, .LBB4_62
	b	.LBB4_79
.Lfunc_end4:
