...
.LBB4_83:                               # %vector.memcheck814
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_80
# %bb.84:                               # %vector.memcheck814
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_80
# %bb.85:                               # %vector.main.loop.iter.check831
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_234
# %bb.86:
	move	$a6, $zero
...
.LBB4_109:                              # %vector.body871
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_109
# %bb.110:                              # %middle.block878
	beq	$a2, $a4, .LBB4_113
.LBB4_111:                              # %scalar.ph862.preheader
	sub.w	$a2, $t4, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_116:                              # %vector.body890
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_116
# %bb.117:                              # %middle.block897
	beq	$a2, $a3, .LBB4_120
.LBB4_118:                              # %scalar.ph881.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_119:                              # %scalar.ph881
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.148:
	move	$a5, $zero
	b	.LBB4_193
.LBB4_149:                              # %vector.main.loop.iter.check970
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_186
# %bb.150:
	move	$a5, $zero
...
# %bb.183:
	move	$a4, $zero
	b	.LBB4_248
.LBB4_184:                              # %vector.main.loop.iter.check920
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_241
# %bb.185:
	move	$a4, $zero
	b	.LBB4_245
.LBB4_186:                              # %vector.ph971
	andi	$a7, $a6, 12
...
.LBB4_187:                              # %vector.body974
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_187
# %bb.188:                              # %middle.block980
	beq	$a4, $a5, .LBB4_195
# %bb.189:                              # %vec.epilog.iter.check984
	beqz	$a7, .LBB4_193
.LBB4_190:                              # %vec.epilog.ph986
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_191:                              # %vec.epilog.vector.body992
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_191
# %bb.192:                              # %vec.epilog.middle.block997
	beq	$a4, $a5, .LBB4_195
.LBB4_193:                              # %vec.epilog.scalar.ph983.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_194:                              # %vec.epilog.scalar.ph983
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_239:                              # %vec.epilog.vector.body851
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_239
# %bb.240:                              # %vec.epilog.middle.block858
	bne	$a4, $a7, .LBB4_80
	b	.LBB4_82
.LBB4_241:                              # %vector.ph921
	andi	$a6, $a5, 12
...
.LBB4_242:                              # %vector.body924
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_242
# %bb.243:                              # %middle.block930
	beq	$a3, $a4, .LBB4_250
# %bb.244:                              # %vec.epilog.iter.check934
	beqz	$a6, .LBB4_248
.LBB4_245:                              # %vec.epilog.ph936
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_246:                              # %vec.epilog.vector.body941
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_246
# %bb.247:                              # %vec.epilog.middle.block946
	beq	$a3, $a4, .LBB4_250
.LBB4_248:                              # %vec.epilog.scalar.ph933.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_249:                              # %vec.epilog.scalar.ph933
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.305:                              # %middle.block793
	beq	$a3, $a5, .LBB4_79
# %bb.306:                              # %vec.epilog.iter.check797
	beqz	$a4, .LBB4_312
.LBB4_307:                              # %vec.epilog.ph799
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	vldrepl.w	$vr0, $a0, 0
	ori	$a7, $zero, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_308:                              # %vec.epilog.vector.body802
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
