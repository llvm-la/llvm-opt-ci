...
.LBB4_7:
	...
	st.w	$s4, $s5, %pc_lo12(partA__align.orlgth1)
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
...
.LBB4_29:
	...
	ld.d	$a1, $s4, %pc_lo12(partA__align.cpmx1)
	ffint.s.w	$fs0, $fs0
...
.LBB4_45:                               # %._crit_edge469
	...
	ld.d	$s7, $s4, %pc_lo12(partA__align.cpmx1)
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
...
# %bb.55:                               # %iter.check
	...
	ori	$a4, $zero, 1
	bgeu	$a3, $a5, .LBB4_166
.LBB4_56:                               # %vec.epilog.scalar.ph.preheader
	alsl.d	$a2, $a4, $a2, 2
	addi.d	$a2, $a2, -4
...
# %bb.59:                               # %iter.check793
	...
	ori	$a4, $zero, 1
	bgeu	$a3, $a5, .LBB4_170
.LBB4_60:                               # %vec.epilog.scalar.ph794.preheader
	alsl.d	$a2, $a4, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a3, $a4, $s6, 2
	sub.d	$a1, $a1, $a4
	.p2align	4, , 16
.LBB4_61:                               # %vec.epilog.scalar.ph794
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
.LBB4_77:                               # %iter.check840
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB4_81
.LBB4_78:                               # %vec.epilog.scalar.ph841.preheader
	alsl.d	$a4, $a5, $s6, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a1, $a5, $a1, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB4_79:                               # %vec.epilog.scalar.ph841
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB4_81:                               # %vector.memcheck810
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_78
# %bb.82:                               # %vector.memcheck810
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_78
# %bb.83:                               # %vector.main.loop.iter.check824
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_232
# %bb.84:
	move	$a6, $zero
...
.LBB4_89:                               # %._crit_edge502
	...
	ld.d	$a0, $sp, 232                   # 8-byte Folded Reload
	beq	$s7, $a0, .LBB4_103
.LBB4_90:                               # =>This Loop Header: Depth=1
...
# %bb.91:                               # %.lr.ph.i342
	...
	.p2align	4, , 16
.LBB4_92:                               #   Parent Loop BB4_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a5, $a2, 0
	add.w	$a5, $a5, $s5
	slli.d	$a5, $a5, 2
	...
	addi.d	$a2, $a2, 4
	bnez	$a4, .LBB4_92
.LBB4_93:                               # %part_imp_match_out_vead_gapmap.exit347
                                        #   in Loop: Header=BB4_90 Depth=1
	ld.d	$a1, $sp, 272                   # 8-byte Folded Reload
	fldx.s	$fa0, $a1, $a0
	fst.s	$fa0, $s3, 0
...
# %bb.99:                               #   in Loop: Header=BB4_96 Depth=2
	...
	st.w	$t3, $a3, 0
	fmov.s	$fs0, $fa6
.LBB4_100:                              #   in Loop: Header=BB4_96 Depth=2
	fadd.s	$fa6, $fa1, $fa3
...
.LBB4_102:
	...
	bnez	$s2, .LBB4_118
	b	.LBB4_104
.LBB4_103:                              # %._crit_edge511.loopexit
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	ld.w	$s2, $a0, 0
	move	$s6, $s3
	ld.d	$t6, $sp, 48                    # 8-byte Folded Reload
...
.LBB4_107:                              # %vector.body865
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_107
# %bb.108:                              # %middle.block871
	beq	$a2, $a4, .LBB4_111
.LBB4_109:                              # %scalar.ph856.preheader
	sub.w	$a2, $t4, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_114:                              # %vector.body883
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_114
# %bb.115:                              # %middle.block889
	beq	$a2, $a3, .LBB4_118
.LBB4_116:                              # %scalar.ph874.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_117:                              # %scalar.ph874
                                        # =>This Inner Loop Header: Depth=1
...
.LBB4_140:                              # %vector.body945
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_140
# %bb.141:                              # %middle.block953
	beq	$a4, $a5, .LBB4_144
.LBB4_142:                              # %.lr.ph17.i.preheader
	alsl.d	$a6, $a5, $ra, 3
	sub.d	$a4, $a4, $a5
	addi.d	$a5, $a5, 1
	.p2align	4, , 16
.LBB4_143:                              # %.lr.ph17.i
	...
	addi.d	$a5, $a5, 1
	bnez	$a4, .LBB4_143
.LBB4_144:                              # %.preheader8.i
	bltz	$a3, .LBB4_193
# %bb.145:                              # %iter.check972
	ld.d	$a3, $ra, 0
	addi.d	$a6, $a0, 1
...
# %bb.146:
	move	$a5, $zero
	b	.LBB4_191
.LBB4_147:                              # %vector.main.loop.iter.check958
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_184
# %bb.148:
	move	$a5, $zero
	b	.LBB4_188
.LBB4_149:                              # %.preheader9.i353
	blez	$a3, .LBB4_154
# %bb.150:                              # %.lr.ph14.i433
	slli.d	$a2, $s8, 32
	srai.d	$a4, $a2, 29
...
# %bb.153:                              #   in Loop: Header=BB4_152 Depth=1
	...
	fmov.s	$fa0, $fa1
	b	.LBB4_151
.LBB4_154:                              # %.loopexit.i355
	ld.d	$s6, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 280                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 272                   # 8-byte Folded Reload
	bltz	$a2, .LBB4_179
# %bb.155:                              # %.lr.ph17.preheader.i357
	addi.d	$a4, $s8, 1
...
.LBB4_161:                              # %vector.body684
	...
	addi.d	$a4, $a4, 32
	bnez	$a6, .LBB4_161
# %bb.162:                              # %middle.block689
	beq	$a1, $a3, .LBB4_45
	b	.LBB4_43
.LBB4_163:                              # %vector.ph645
	slli.d	$a4, $s1, 3
...
.LBB4_164:                              # %vector.body648
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_164
# %bb.165:                              # %middle.block653
	beq	$a2, $fp, .LBB4_22
	b	.LBB4_20
.LBB4_166:                              # %vector.memcheck722
...
# %bb.171:                              # %vector.memcheck761
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB4_60
# %bb.172:                              # %vector.main.loop.iter.check775
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_301
# %bb.173:
	move	$a5, $zero
	b	.LBB4_305
.LBB4_174:                              # %vector.ph894
...
.LBB4_175:                              # %vector.body897
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_175
# %bb.176:                              # %middle.block904
	beq	$a2, $a4, .LBB4_179
.LBB4_177:                              # %.lr.ph17.i359.preheader
	alsl.d	$a5, $a4, $s5, 3
	sub.d	$a2, $a2, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB4_178:                              # %.lr.ph17.i359
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a6, $a5, 0
	st.w	$a4, $a6, 0
	addi.d	$a5, $a5, 8
	...
	addi.d	$a4, $a4, 1
	bnez	$a2, .LBB4_178
.LBB4_179:                              # %.preheader8.i363
	bltz	$a3, .LBB4_248
# %bb.180:                              # %iter.check923
	ld.d	$a2, $s5, 0
	addi.d	$a5, $a0, 1
...
# %bb.181:
	move	$a4, $zero
	b	.LBB4_246
.LBB4_182:                              # %vector.main.loop.iter.check909
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_239
# %bb.183:
	move	$a4, $zero
	b	.LBB4_243
.LBB4_184:                              # %vector.ph960
	andi	$a7, $a6, 12
...
.LBB4_185:                              # %vector.body963
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_185
# %bb.186:                              # %middle.block969
	beq	$a4, $a5, .LBB4_193
# %bb.187:                              # %vec.epilog.iter.check974
	beqz	$a7, .LBB4_191
.LBB4_188:                              # %vec.epilog.ph976
	move	$a7, $a5
	...
	alsl.d	$a7, $a7, $a3, 2
	.p2align	4, , 16
.LBB4_189:                              # %vec.epilog.vector.body982
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_189
# %bb.190:                              # %vec.epilog.middle.block987
	beq	$a4, $a5, .LBB4_193
.LBB4_191:                              # %vec.epilog.scalar.ph973.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_192:                              # %vec.epilog.scalar.ph973
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.203:                              #   in Loop: Header=BB4_202 Depth=1
	beqz	$t7, .LBB4_206
# %bb.204:                              #   in Loop: Header=BB4_202 Depth=1
	sub.w	$t3, $s8, $t7
	b	.LBB4_207
	.p2align	4, , 16
.LBB4_205:                              #   in Loop: Header=BB4_202 Depth=1
	addi.w	$t3, $s8, -1
	nor	$t8, $t3, $zero
	add.w	$s0, $s8, $t8
	bnez	$s0, .LBB4_209
	b	.LBB4_214
	.p2align	4, , 16
.LBB4_206:                              #   in Loop: Header=BB4_202 Depth=1
	addi.w	$t3, $s8, -1
.LBB4_207:                              #   in Loop: Header=BB4_202 Depth=1
	move	$t7, $t0
	nor	$t8, $t3, $zero
	add.w	$s0, $s8, $t8
	bnez	$s0, .LBB4_209
	b	.LBB4_214
	.p2align	4, , 16
.LBB4_208:                              # %._crit_edge29.i
                                        #   in Loop: Header=BB4_209 Depth=2
	addi.d	$s0, $s0, -1
	ld.d	$s4, $sp, 280                   # 8-byte Folded Reload
	beqz	$s0, .LBB4_213
.LBB4_209:                              # %.preheader3.i
...
.LBB4_212:                              # %.lr.ph28.i
	...
	b	.LBB4_208
	.p2align	4, , 16
.LBB4_213:                              # %._crit_edge32.loopexit.i
                                        #   in Loop: Header=BB4_202 Depth=1
	add.d	$a2, $s8, $a4
	add.d	$a4, $t8, $a2
	ld.d	$s6, $sp, 168                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 264                   # 8-byte Folded Reload
.LBB4_214:                              # %._crit_edge32.i
                                        #   in Loop: Header=BB4_202 Depth=1
	add.w	$t2, $t7, $t2
	beq	$t7, $t0, .LBB4_221
# %bb.215:                              # %.preheader1.preheader.i
                                        #   in Loop: Header=BB4_202 Depth=1
	nor	$t7, $t7, $zero
	b	.LBB4_217
	.p2align	4, , 16
.LBB4_216:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB4_217 Depth=2
	addi.d	$t7, $t7, -1
	addi.d	$a4, $a4, 1
	beqz	$t7, .LBB4_221
.LBB4_217:                              # %.preheader1.i
                                        #   Parent Loop BB4_202 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_218 Depth 3
                                        #       Child Loop BB4_220 Depth 3
...
.LBB4_220:                              # %.lr.ph37.i
	...
	b	.LBB4_216
	.p2align	4, , 16
.LBB4_221:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB4_202 Depth=1
	ld.d	$a2, $sp, 272                   # 8-byte Folded Reload
	beq	$t4, $a2, .LBB4_224
# %bb.222:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB4_202 Depth=1
	addi.w	$a2, $a0, 0
	beq	$t5, $a2, .LBB4_224
# %bb.223:                              #   in Loop: Header=BB4_202 Depth=1
	slli.d	$a2, $t4, 2
	ld.d	$a5, $sp, 184                   # 8-byte Folded Reload
	ldx.w	$a2, $a5, $a2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a3, 0
.LBB4_224:                              #   in Loop: Header=BB4_202 Depth=1
	ld.d	$s4, $sp, 280                   # 8-byte Folded Reload
	blez	$t4, .LBB4_284
# %bb.225:                              #   in Loop: Header=BB4_202 Depth=1
	blez	$t5, .LBB4_284
# %bb.226:                              # %.preheader5.i
                                        #   in Loop: Header=BB4_202 Depth=1
	blez	$s1, .LBB4_229
# %bb.227:                              # %.lr.ph44.i
	...
	move	$t6, $a6
	.p2align	4, , 16
.LBB4_228:                              #   Parent Loop BB4_202 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $t4, 0
	ld.d	$a5, $t5, 0
	ldx.b	$a2, $a2, $t3
...
# %bb.230:                              # %.lr.ph46.i
	...
	move	$t6, $a7
	.p2align	4, , 16
.LBB4_231:                              #   Parent Loop BB4_202 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $t4, 0
	ld.d	$a5, $t5, 0
	ldx.b	$a2, $a2, $t2
...
.LBB4_233:                              # %vector.body829
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB4_233
# %bb.234:                              # %middle.block836
	beq	$a4, $a6, .LBB4_80
# %bb.235:                              # %vec.epilog.iter.check842
	beqz	$a7, .LBB4_78
.LBB4_236:                              # %vec.epilog.ph844
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB4_237:                              # %vec.epilog.vector.body847
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_237
# %bb.238:                              # %vec.epilog.middle.block853
	bne	$a4, $a7, .LBB4_78
	b	.LBB4_80
.LBB4_239:                              # %vector.ph911
	andi	$a6, $a5, 12
...
.LBB4_240:                              # %vector.body914
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_240
# %bb.241:                              # %middle.block920
	beq	$a3, $a4, .LBB4_248
# %bb.242:                              # %vec.epilog.iter.check925
	beqz	$a6, .LBB4_246
.LBB4_243:                              # %vec.epilog.ph927
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB4_244:                              # %vec.epilog.vector.body932
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_244
# %bb.245:                              # %vec.epilog.middle.block937
	beq	$a3, $a4, .LBB4_248
.LBB4_246:                              # %vec.epilog.scalar.ph924.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_247:                              # %vec.epilog.scalar.ph924
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.259:                              #   in Loop: Header=BB4_257 Depth=1
	...
	b	.LBB4_262
	.p2align	4, , 16
.LBB4_260:                              #   in Loop: Header=BB4_257 Depth=1
	addi.w	$a7, $s8, -1
	nor	$t3, $a7, $zero
	add.w	$t4, $s8, $t3
	bnez	$t4, .LBB4_264
	b	.LBB4_269
	.p2align	4, , 16
.LBB4_261:                              #   in Loop: Header=BB4_257 Depth=1
	addi.w	$a7, $s8, -1
.LBB4_262:                              #   in Loop: Header=BB4_257 Depth=1
	move	$t2, $a5
	nor	$t3, $a7, $zero
	add.w	$t4, $s8, $t3
	bnez	$t4, .LBB4_264
	b	.LBB4_269
	.p2align	4, , 16
.LBB4_263:                              # %._crit_edge29.i384
                                        #   in Loop: Header=BB4_264 Depth=2
	addi.d	$t4, $t4, -1
	beqz	$t4, .LBB4_268
.LBB4_264:                              # %.preheader3.i381
...
.LBB4_265:                              # %.lr.ph26.i419
	...
	addi.d	$t5, $t5, 8
	bnez	$t7, .LBB4_265
.LBB4_266:                              # %.preheader2.i383
                                        #   in Loop: Header=BB4_264 Depth=2
	move	$t5, $s7
	move	$t6, $a4
	blez	$fp, .LBB4_263
	.p2align	4, , 16
.LBB4_267:                              # %.lr.ph28.i415
                                        #   Parent Loop BB4_257 Depth=1
                                        #     Parent Loop BB4_264 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t7, $t5, 0
	...
	b	.LBB4_263
	.p2align	4, , 16
.LBB4_268:                              # %._crit_edge32.loopexit.i386
                                        #   in Loop: Header=BB4_257 Depth=1
	add.d	$a3, $s8, $a3
	add.d	$a3, $t3, $a3
.LBB4_269:                              # %._crit_edge32.i387
                                        #   in Loop: Header=BB4_257 Depth=1
	add.w	$a0, $t2, $a0
	beq	$t2, $a5, .LBB4_276
# %bb.270:                              # %.preheader1.preheader.i388
                                        #   in Loop: Header=BB4_257 Depth=1
	nor	$t2, $t2, $zero
	b	.LBB4_272
	.p2align	4, , 16
.LBB4_271:                              # %._crit_edge38.i392
                                        #   in Loop: Header=BB4_272 Depth=2
	addi.d	$t2, $t2, -1
	addi.d	$a3, $a3, 1
	beqz	$t2, .LBB4_276
.LBB4_272:                              # %.preheader1.i389
                                        #   Parent Loop BB4_257 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_273 Depth 3
                                        #       Child Loop BB4_275 Depth 3
...
.LBB4_275:                              # %.lr.ph37.i407
	...
	b	.LBB4_271
	.p2align	4, , 16
.LBB4_276:                              # %._crit_edge41.i394
                                        #   in Loop: Header=BB4_257 Depth=1
	blez	$t0, .LBB4_284
# %bb.277:                              # %._crit_edge41.i394
                                        #   in Loop: Header=BB4_257 Depth=1
	blez	$t1, .LBB4_284
# %bb.278:                              # %.preheader5.i396
                                        #   in Loop: Header=BB4_257 Depth=1
	blez	$s1, .LBB4_281
# %bb.279:                              # %.lr.ph44.i403
                                        #   in Loop: Header=BB4_257 Depth=1
	...
	move	$t2, $a2
	.p2align	4, , 16
.LBB4_280:                              #   Parent Loop BB4_257 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a7
...
# %bb.282:                              # %.lr.ph46.i399
	...
	move	$t2, $a4
	.p2align	4, , 16
.LBB4_283:                              #   Parent Loop BB4_257 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a0
	...
	bnez	$t2, .LBB4_283
	b	.LBB4_256
.LBB4_284:                              # %Atracking_localhom.exit
	ld.d	$a0, $s3, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	blt	$a2, $a3, .LBB4_293
# %bb.285:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	bge	$a3, $a0, .LBB4_293
# %bb.286:
	blez	$s1, .LBB4_289
...
.LBB4_302:                              # %vector.body780
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_302
# %bb.303:                              # %middle.block789
	beq	$a3, $a5, .LBB4_77
# %bb.304:                              # %vec.epilog.iter.check795
	beqz	$a6, .LBB4_60
.LBB4_305:                              # %vec.epilog.ph797
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_306:                              # %vec.epilog.vector.body800
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB4_306
# %bb.307:                              # %vec.epilog.middle.block807
	bne	$a3, $a6, .LBB4_60
	b	.LBB4_77
.Lfunc_end4:
