...
.LBB4_46:                               # %._crit_edge469
	...
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
	ld.d	$s5, $a1, %pc_lo12(partA__align.cpmx1)
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
...
# %bb.60:                               # %iter.check778
	...
	ori	$a4, $zero, 1
	bgeu	$a3, $a5, .LBB4_171
.LBB4_61:                               # %vec.epilog.scalar.ph796.preheader
	alsl.d	$a2, $a4, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a3, $a4, $t3, 2
	sub.d	$a1, $a1, $a4
	.p2align	4, , 16
.LBB4_62:                               # %vec.epilog.scalar.ph796
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
.LBB4_82:                               # %vector.memcheck814
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_79
# %bb.83:                               # %vector.memcheck814
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_79
# %bb.84:                               # %vector.main.loop.iter.check831
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_233
# %bb.85:
	move	$a6, $zero
...
# %bb.107:                              # %vector.ph864
	...
	pcalau12i	$a5, %pc_hi20(.LCPI4_1)
	xvld	$xr3, $a5, %pc_lo12(.LCPI4_1)
	xvreplgr2vr.d	$xr4, $t4
	addi.d	$a5, $t3, 4
	xvldi	$xr5, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB4_108:                              # %vector.body871
                                        # =>This Inner Loop Header: Depth=1
	xvsub.d	$xr6, $xr4, $xr1
	xvsub.d	$xr7, $xr4, $xr2
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_108
# %bb.109:                              # %middle.block878
	beq	$a2, $a4, .LBB4_112
.LBB4_110:                              # %scalar.ph862.preheader
	sub.w	$a2, $t4, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
# %bb.114:                              # %vector.ph883
	...
	vld	$vr3, $a4, %pc_lo12(.LCPI4_5)
	xvreplve0.d	$xr4, $xr1
	addi.d	$a4, $s4, 4
	xvldi	$xr5, -800
	move	$a5, $a3
	.p2align	4, , 16
.LBB4_115:                              # %vector.body890
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_115
# %bb.116:                              # %middle.block897
	beq	$a2, $a3, .LBB4_119
.LBB4_117:                              # %scalar.ph881.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_118:                              # %scalar.ph881
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.147:
	move	$a5, $zero
	b	.LBB4_192
.LBB4_148:                              # %vector.main.loop.iter.check970
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_185
# %bb.149:
	move	$a5, $zero
...
# %bb.172:                              # %vector.memcheck763
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB4_61
# %bb.173:                              # %vector.main.loop.iter.check780
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_302
# %bb.174:
	move	$a5, $zero
	b	.LBB4_306
.LBB4_175:                              # %vector.ph902
...
# %bb.182:
	move	$a4, $zero
	b	.LBB4_247
.LBB4_183:                              # %vector.main.loop.iter.check920
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_240
# %bb.184:
	move	$a4, $zero
	b	.LBB4_244
.LBB4_185:                              # %vector.ph971
	andi	$a7, $a6, 12
	bstrpick.d	$a5, $a6, 31, 4
	slli.d	$a5, $a5, 4
	pcalau12i	$t0, %pc_hi20(.LCPI4_7)
	xvld	$xr0, $t0, %pc_lo12(.LCPI4_7)
	addi.d	$t0, $a3, 32
	xvrepli.b	$xr1, -1
	xvrepli.w	$xr2, -9
	move	$t1, $a5
	.p2align	4, , 16
.LBB4_186:                              # %vector.body974
                                        # =>This Inner Loop Header: Depth=1
	xvxor.v	$xr3, $xr0, $xr1
	xvsub.w	$xr4, $xr2, $xr0
	xvst	$xr3, $t0, -32
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_186
# %bb.187:                              # %middle.block980
	beq	$a4, $a5, .LBB4_194
# %bb.188:                              # %vec.epilog.iter.check984
	beqz	$a7, .LBB4_192
.LBB4_189:                              # %vec.epilog.ph986
	move	$a7, $a5
...
.LBB4_190:                              # %vec.epilog.vector.body992
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_190
# %bb.191:                              # %vec.epilog.middle.block997
	beq	$a4, $a5, .LBB4_194
.LBB4_192:                              # %vec.epilog.scalar.ph983.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_193:                              # %vec.epilog.scalar.ph983
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_238:                              # %vec.epilog.vector.body851
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_238
# %bb.239:                              # %vec.epilog.middle.block858
	bne	$a4, $a7, .LBB4_79
	b	.LBB4_81
.LBB4_240:                              # %vector.ph921
	andi	$a6, $a5, 12
...
.LBB4_241:                              # %vector.body924
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_241
# %bb.242:                              # %middle.block930
	beq	$a3, $a4, .LBB4_249
# %bb.243:                              # %vec.epilog.iter.check934
	beqz	$a6, .LBB4_247
.LBB4_244:                              # %vec.epilog.ph936
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_245:                              # %vec.epilog.vector.body941
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_245
# %bb.246:                              # %vec.epilog.middle.block946
	beq	$a3, $a4, .LBB4_249
.LBB4_247:                              # %vec.epilog.scalar.ph933.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_248:                              # %vec.epilog.scalar.ph933
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB4_303:                              # %vector.body784
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_303
# %bb.304:                              # %middle.block793
	beq	$a3, $a5, .LBB4_78
# %bb.305:                              # %vec.epilog.iter.check797
	beqz	$a4, .LBB4_311
.LBB4_306:                              # %vec.epilog.ph799
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_307:                              # %vec.epilog.vector.body802
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
