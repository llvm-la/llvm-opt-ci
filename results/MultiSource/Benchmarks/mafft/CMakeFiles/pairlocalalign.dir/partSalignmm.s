...
# %bb.60:                               # %iter.check793
	...
	ori	$a4, $zero, 1
	bgeu	$a3, $a5, .LBB4_171
.LBB4_61:                               # %vec.epilog.scalar.ph794.preheader
	alsl.d	$a2, $a4, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a3, $a4, $t4, 2
	sub.d	$a1, $a1, $a4
	.p2align	4, , 16
.LBB4_62:                               # %vec.epilog.scalar.ph794
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
.LBB4_78:                               # %iter.check840
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB4_82
.LBB4_79:                               # %vec.epilog.scalar.ph841.preheader
	alsl.d	$a4, $a5, $t4, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a1, $a5, $a1, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB4_80:                               # %vec.epilog.scalar.ph841
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB4_82:                               # %vector.memcheck810
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_79
# %bb.83:                               # %vector.memcheck810
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_79
# %bb.84:                               # %vector.main.loop.iter.check824
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_233
# %bb.85:
	move	$a6, $zero
...
.LBB4_108:                              # %vector.body865
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_108
# %bb.109:                              # %middle.block871
	beq	$a2, $a4, .LBB4_112
.LBB4_110:                              # %scalar.ph856.preheader
	sub.w	$a2, $t5, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t4, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_115:                              # %vector.body883
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_115
# %bb.116:                              # %middle.block889
	beq	$a2, $a3, .LBB4_119
.LBB4_117:                              # %scalar.ph874.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_118:                              # %scalar.ph874
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.147:
	move	$a5, $zero
	b	.LBB4_192
.LBB4_148:                              # %vector.main.loop.iter.check958
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_185
# %bb.149:
	move	$a5, $zero
...
# %bb.172:                              # %vector.memcheck761
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB4_61
# %bb.173:                              # %vector.main.loop.iter.check775
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_302
# %bb.174:
	move	$a5, $zero
	b	.LBB4_306
.LBB4_175:                              # %vector.ph894
...
# %bb.182:
	move	$a4, $zero
	b	.LBB4_247
.LBB4_183:                              # %vector.main.loop.iter.check909
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_240
# %bb.184:
	move	$a4, $zero
	b	.LBB4_244
.LBB4_185:                              # %vector.ph960
	andi	$a7, $a6, 12
...
.LBB4_186:                              # %vector.body963
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_186
# %bb.187:                              # %middle.block969
	beq	$a4, $a5, .LBB4_194
# %bb.188:                              # %vec.epilog.iter.check974
	beqz	$a7, .LBB4_192
.LBB4_189:                              # %vec.epilog.ph976
	move	$a7, $a5
	...
	alsl.d	$a7, $a7, $a3, 2
	.p2align	4, , 16
.LBB4_190:                              # %vec.epilog.vector.body982
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_190
# %bb.191:                              # %vec.epilog.middle.block987
	beq	$a4, $a5, .LBB4_194
.LBB4_192:                              # %vec.epilog.scalar.ph973.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_193:                              # %vec.epilog.scalar.ph973
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_234:                              # %vector.body829
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB4_234
# %bb.235:                              # %middle.block836
	beq	$a4, $a6, .LBB4_81
# %bb.236:                              # %vec.epilog.iter.check842
	beqz	$a7, .LBB4_79
.LBB4_237:                              # %vec.epilog.ph844
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB4_238:                              # %vec.epilog.vector.body847
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_238
# %bb.239:                              # %vec.epilog.middle.block853
	bne	$a4, $a7, .LBB4_79
	b	.LBB4_81
.LBB4_240:                              # %vector.ph911
	andi	$a6, $a5, 12
...
.LBB4_241:                              # %vector.body914
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_241
# %bb.242:                              # %middle.block920
	beq	$a3, $a4, .LBB4_249
# %bb.243:                              # %vec.epilog.iter.check925
	beqz	$a6, .LBB4_247
.LBB4_244:                              # %vec.epilog.ph927
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a2, 2
	.p2align	4, , 16
.LBB4_245:                              # %vec.epilog.vector.body932
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_245
# %bb.246:                              # %vec.epilog.middle.block937
	beq	$a3, $a4, .LBB4_249
.LBB4_247:                              # %vec.epilog.scalar.ph924.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_248:                              # %vec.epilog.scalar.ph924
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB4_303:                              # %vector.body780
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_303
# %bb.304:                              # %middle.block789
	beq	$a3, $a5, .LBB4_78
# %bb.305:                              # %vec.epilog.iter.check795
	beqz	$a6, .LBB4_61
.LBB4_306:                              # %vec.epilog.ph797
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_307:                              # %vec.epilog.vector.body800
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB4_307
# %bb.308:                              # %vec.epilog.middle.block807
	bne	$a3, $a6, .LBB4_61
	b	.LBB4_78
.Lfunc_end4:
