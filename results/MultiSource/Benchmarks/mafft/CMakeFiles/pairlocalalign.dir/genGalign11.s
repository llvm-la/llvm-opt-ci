...
# %bb.0:
	...
	pcalau12i	$s4, %pc_hi20(genG__align11.orlgth1)
	ld.w	$a1, $s4, %pc_lo12(genG__align11.orlgth1)
	fld.s	$fs1, $a0, 0
...
# %bb.3:
	blez	$s3, .LBB0_121
.LBB0_4:
	ld.w	$s7, $s4, %pc_lo12(genG__align11.orlgth1)
...
.LBB0_9:
	...
	st.w	$s7, $s4, %pc_lo12(genG__align11.orlgth1)
...
.LBB0_17:
	...
	st.d	$s7, $a0, %pc_lo12(genG__align11.ijpi)
...
# %bb.39:                               # %iter.check395
	...
	ori	$t0, $zero, 1
	bltu	$a3, $t1, .LBB0_51
# %bb.40:                               # %vector.main.loop.iter.check380
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_44
# %bb.41:
	move	$t1, $zero
...
.LBB0_49:                               # %vec.epilog.vector.body404
	...
	addi.d	$t3, $t3, 16
	bnez	$t1, .LBB0_49
# %bb.50:                               # %vec.epilog.middle.block408
	beq	$a3, $t2, .LBB0_53
...
.LBB0_53:                               # %iter.check430
	...
	ori	$t3, $zero, 1
	bgeu	$t4, $t5, .LBB0_86
.LBB0_54:                               # %vec.epilog.scalar.ph431.preheader
	alsl.d	$t4, $t3, $a4, 2
	addi.d	$t4, $t4, -4
	alsl.d	$a2, $t3, $a2, 2
	alsl.d	$a3, $t3, $a3, 2
	...
	sub.d	$t2, $t2, $t3
	.p2align	4, , 16
.LBB0_55:                               # %vec.epilog.scalar.ph431
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $t4, 0
	fst.s	$fa1, $a2, 0
	st.w	$zero, $a3, 0
...
# %bb.83:                               # %iter.check458
	...
	ori	$a7, $zero, 64
	bltu	$a6, $a7, .LBB0_99
# %bb.84:                               # %vector.main.loop.iter.check447
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB0_92
# %bb.85:
	move	$a4, $zero
...
# %bb.89:                               # %vector.memcheck
	sub.d	$t6, $t1, $a3
	bltu	$t6, $t5, .LBB0_54
# %bb.90:                               # %vector.main.loop.iter.check417
	ori	$t3, $zero, 16
	bgeu	$t4, $t3, .LBB0_114
# %bb.91:
	move	$t5, $zero
	b	.LBB0_118
.LBB0_92:                               # %vector.ph449
	andi	$a6, $a5, 12
...
.LBB0_93:                               # %vector.body452
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB0_93
# %bb.94:                               # %middle.block455
	beq	$a3, $a4, .LBB0_101
# %bb.95:                               # %vec.epilog.iter.check460
	beqz	$a6, .LBB0_99
.LBB0_96:                               # %vec.epilog.ph462
	move	$a7, $a4
	...
	vrepli.b	$vr0, -1
	.p2align	4, , 16
.LBB0_97:                               # %vec.epilog.vector.body465
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB0_97
# %bb.98:                               # %vec.epilog.middle.block468
	beq	$a3, $a4, .LBB0_101
.LBB0_99:                               # %vec.epilog.scalar.ph459.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.scalar.ph459
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	st.w	$a4, $a2, 0
	addi.d	$a3, $a3, -1
...
.LBB0_115:                              # %vector.body422
	...
	addi.d	$s4, $s4, 64
	bnez	$s5, .LBB0_115
# %bb.116:                              # %middle.block427
	beq	$t4, $t5, .LBB0_56
# %bb.117:                              # %vec.epilog.iter.check432
	beqz	$t6, .LBB0_54
.LBB0_118:                              # %vec.epilog.ph434
	move	$t6, $t4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_119:                              # %vec.epilog.vector.body437
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t7, 0
	vst	$vr2, $t8, 0
	vst	$vr1, $s1, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$t5, .LBB0_119
# %bb.120:                              # %vec.epilog.middle.block441
	bne	$t4, $t6, .LBB0_54
	b	.LBB0_56
.LBB0_121:
