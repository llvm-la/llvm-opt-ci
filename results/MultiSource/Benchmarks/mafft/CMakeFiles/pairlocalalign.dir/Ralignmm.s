...
.LBB2_55:                               # %vector.body841
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_55
# %bb.56:                               # %middle.block848
	beq	$a2, $a4, .LBB2_59
.LBB2_57:                               # %scalar.ph834.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t7, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_58:                               # %scalar.ph834
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB2_65:                               # %iter.check871
	...
	ori	$a3, $zero, 1
	bltu	$a2, $a4, .LBB2_86
# %bb.66:                               # %vector.memcheck851
	sub.d	$a4, $t2, $t0
	addi.d	$a4, $a4, 4
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB2_86
# %bb.67:                               # %vector.main.loop.iter.check854
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_71
# %bb.68:
	move	$a4, $zero
...
# %bb.81:                               # %vec.epilog.middle.block
	bne	$a0, $a6, .LBB2_38
	b	.LBB2_39
.LBB2_82:                               # %vec.epilog.iter.check873
	move	$t0, $s7
	beqz	$a5, .LBB2_86
.LBB2_83:                               # %vec.epilog.ph875
	move	$a5, $a2
	...
	vreplgr2vr.w	$vr2, $t3
	.p2align	4, , 16
.LBB2_84:                               # %vec.epilog.vector.body880
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t0, $a7
	vstx	$vr1, $a6, $a7
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB2_84
# %bb.85:                               # %vec.epilog.middle.block884
	beq	$a2, $a5, .LBB2_88
.LBB2_86:                               # %vec.epilog.scalar.ph872.preheader
	slli.d	$a2, $a3, 2
	addi.d	$a4, $t0, -4
	sub.d	$a1, $a1, $a3
	movgr2fr.w	$fa0, $t3
	.p2align	4, , 16
.LBB2_87:                               # %vec.epilog.scalar.ph872
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a4, $a2
	stx.w	$zero, $a0, $a2
...
# %bb.95:                               # %iter.check918
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB2_98
# %bb.96:                               # %vector.memcheck887
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$s4, $a0, .LBB2_122
# %bb.97:                               # %vector.memcheck887
                                        #   in Loop: Header=BB2_94 Depth=1
	add.d	$a0, $s4, $a1
	bgeu	$a2, $a0, .LBB2_122
...
# %bb.121:                              #   in Loop: Header=BB2_113 Depth=2
	...
	fstx.s	$fa1, $fp, $a4
	b	.LBB2_112
.LBB2_122:                              # %vector.main.loop.iter.check895
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB2_124
...
.LBB2_125:                              # %vector.body901
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB2_125
# %bb.126:                              # %middle.block912
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 200                   # 8-byte Folded Reload
	beq	$a3, $a4, .LBB2_100
# %bb.127:                              # %vec.epilog.iter.check920
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a4, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a5, $sp, 136                   # 8-byte Folded Reload
	beqz	$a5, .LBB2_99
.LBB2_128:                              # %vec.epilog.ph922
                                        #   in Loop: Header=BB2_94 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB2_129:                              # %vec.epilog.vector.body926
                                        #   Parent Loop BB2_94 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
...
.LBB2_136:                              # %vector.body947
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_136
# %bb.137:                              # %middle.block954
	beq	$a2, $a4, .LBB2_140
.LBB2_138:                              # %scalar.ph938.preheader
	sub.w	$a2, $t5, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t0, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_143:                              # %vector.body966
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_143
# %bb.144:                              # %middle.block973
	beq	$a3, $a4, .LBB2_147
.LBB2_145:                              # %scalar.ph957.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_146:                              # %scalar.ph957
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.191:
	move	$a5, $zero
	b	.LBB2_259
.LBB2_192:                              # %vector.main.loop.iter.check1131
	ori	$a0, $zero, 16
	bgeu	$a3, $a0, .LBB2_196
# %bb.193:
	move	$a4, $zero
	b	.LBB2_200
.LBB2_194:                              # %vector.main.loop.iter.check993
	ori	$a0, $zero, 16
	bgeu	$a4, $a0, .LBB2_252
# %bb.195:
	move	$a5, $zero
	b	.LBB2_256
.LBB2_196:                              # %vector.ph1133
	andi	$a0, $a5, 12
...
.LBB2_197:                              # %vector.body1136
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_197
# %bb.198:                              # %middle.block1142
	beq	$a3, $a4, .LBB2_205
# %bb.199:                              # %vec.epilog.iter.check1147
	beqz	$a0, .LBB2_203
.LBB2_200:                              # %vec.epilog.ph1149
	move	$a6, $a4
	...
	alsl.d	$a5, $a6, $a2, 2
	.p2align	4, , 16
.LBB2_201:                              # %vec.epilog.vector.body1155
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a0, .LBB2_201
# %bb.202:                              # %vec.epilog.middle.block1160
	beq	$a3, $a4, .LBB2_205
.LBB2_203:                              # %vec.epilog.scalar.ph1146.preheader
	alsl.d	$a0, $a4, $a2, 2
	nor	$a2, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_204:                              # %vec.epilog.scalar.ph1146
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a2, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a3, $a3, -1
...
# %bb.209:                              #   in Loop: Header=BB2_207 Depth=1
	...
	add.w	$fp, $s7, $t4
	beqz	$fp, .LBB2_215
.LBB2_210:                              # %iter.check1237
                                        #   in Loop: Header=BB2_207 Depth=1
	bltu	$fp, $a3, .LBB2_220
# %bb.211:                              # %iter.check1237
                                        #   in Loop: Header=BB2_207 Depth=1
	sub.d	$t5, $s8, $s4
	bltu	$t5, $s2, .LBB2_220
# %bb.212:                              # %vector.main.loop.iter.check1218
                                        #   in Loop: Header=BB2_207 Depth=1
...
.LBB2_215:                              # %._crit_edge20.i540
                                        #   in Loop: Header=BB2_207 Depth=1
	beq	$t2, $a0, .LBB2_232
.LBB2_216:                              # %iter.check1192
                                        #   in Loop: Header=BB2_207 Depth=1
	addi.w	$t4, $zero, -5
	nor	$t7, $t2, $zero
	bltu	$t4, $t2, .LBB2_221
# %bb.217:                              # %iter.check1192
                                        #   in Loop: Header=BB2_207 Depth=1
	sub.d	$t4, $s8, $s4
	bltu	$t4, $a3, .LBB2_221
# %bb.218:                              # %vector.main.loop.iter.check1169
                                        #   in Loop: Header=BB2_207 Depth=1
	addi.w	$t4, $zero, -17
	bgeu	$t4, $t2, .LBB2_233
...
.LBB2_224:                              # %vector.body1224
	...
	addi.d	$ra, $ra, -64
	bnez	$s6, .LBB2_224
# %bb.225:                              # %middle.block1231
                                        #   in Loop: Header=BB2_207 Depth=1
	ld.d	$s6, $sp, 432                   # 8-byte Folded Reload
	move	$ra, $a6
	ori	$s2, $zero, 64
	beq	$s0, $t8, .LBB2_231
# %bb.226:                              # %vec.epilog.iter.check1239
                                        #   in Loop: Header=BB2_207 Depth=1
	beqz	$s1, .LBB2_230
.LBB2_227:                              # %vec.epilog.ph1241
                                        #   in Loop: Header=BB2_207 Depth=1
	...
	addi.d	$s0, $s0, -16
	.p2align	4, , 16
.LBB2_228:                              # %vec.epilog.vector.body1245
                                        #   Parent Loop BB2_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $s2, 0
	vst	$vr2, $s0, 0
	...
	addi.d	$s0, $s0, -16
	bnez	$fp, .LBB2_228
# %bb.229:                              # %vec.epilog.middle.block1250
                                        #   in Loop: Header=BB2_207 Depth=1
	ori	$s2, $zero, 64
	beq	$s1, $t8, .LBB2_231
	.p2align	4, , 16
...
# %bb.235:                              # %middle.block1184
	...
	beq	$t8, $t7, .LBB2_242
# %bb.236:                              # %vec.epilog.iter.check1194
                                        #   in Loop: Header=BB2_207 Depth=1
	beqz	$fp, .LBB2_240
.LBB2_237:                              # %vec.epilog.ph1196
                                        #   in Loop: Header=BB2_207 Depth=1
	...
	addi.d	$t8, $t8, -4
	.p2align	4, , 16
.LBB2_238:                              # %vec.epilog.vector.body1200
                                        #   Parent Loop BB2_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a4, $s0, 0
	st.w	$a5, $t8, 0
	...
	addi.d	$t8, $t8, -4
	bnez	$t3, .LBB2_238
# %bb.239:                              # %vec.epilog.middle.block1206
                                        #   in Loop: Header=BB2_207 Depth=1
...
.LBB2_253:                              # %vector.body998
	...
	addi.d	$a7, $a7, 64
	bnez	$a2, .LBB2_253
# %bb.254:                              # %middle.block1004
	beq	$a4, $a5, .LBB2_261
# %bb.255:                              # %vec.epilog.iter.check1009
	beqz	$a0, .LBB2_259
.LBB2_256:                              # %vec.epilog.ph1011
	move	$a2, $a5
	pcalau12i	$a0, %pc_hi20(.LCPI2_7)
	vld	$vr0, $a0, %pc_lo12(.LCPI2_7)
	...
	alsl.d	$a2, $a2, $a3, 2
	.p2align	4, , 16
.LBB2_257:                              # %vec.epilog.vector.body1016
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a2, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a2, $a2, 16
	bnez	$a0, .LBB2_257
# %bb.258:                              # %vec.epilog.middle.block1021
	beq	$a4, $a5, .LBB2_261
.LBB2_259:                              # %vec.epilog.scalar.ph1008.preheader
	alsl.d	$a0, $a5, $a3, 2
	nor	$a2, $a5, $zero
	sub.d	$a3, $a4, $a5
	.p2align	4, , 16
.LBB2_260:                              # %vec.epilog.scalar.ph1008
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a2, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a3, $a3, -1
...
# %bb.265:                              #   in Loop: Header=BB2_263 Depth=1
	...
	add.w	$t0, $s7, $fp
	beqz	$t0, .LBB2_271
.LBB2_266:                              # %iter.check1095
                                        #   in Loop: Header=BB2_263 Depth=1
	ori	$a0, $zero, 16
	bltu	$t0, $a0, .LBB2_276
# %bb.267:                              # %iter.check1095
                                        #   in Loop: Header=BB2_263 Depth=1
	sub.d	$a0, $s8, $s4
	ori	$a5, $zero, 64
	bltu	$a0, $a5, .LBB2_276
# %bb.268:                              # %vector.main.loop.iter.check1076
                                        #   in Loop: Header=BB2_263 Depth=1
...
.LBB2_271:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_263 Depth=1
	beq	$t5, $a1, .LBB2_288
.LBB2_272:                              # %iter.check1050
                                        #   in Loop: Header=BB2_263 Depth=1
	addi.w	$a0, $zero, -5
	nor	$s2, $t5, $zero
	bltu	$a0, $t5, .LBB2_277
# %bb.273:                              # %iter.check1050
                                        #   in Loop: Header=BB2_263 Depth=1
	sub.d	$a0, $s8, $s4
	ori	$a5, $zero, 16
	bltu	$a0, $a5, .LBB2_277
# %bb.274:                              # %vector.main.loop.iter.check1030
                                        #   in Loop: Header=BB2_263 Depth=1
	addi.w	$a0, $zero, -17
	bgeu	$a0, $t5, .LBB2_289
...
.LBB2_280:                              # %vector.body1082
	...
	addi.d	$a1, $a1, -64
	bnez	$a0, .LBB2_280
# %bb.281:                              # %middle.block1089
                                        #   in Loop: Header=BB2_263 Depth=1
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 416                   # 8-byte Folded Reload
	beq	$s6, $ra, .LBB2_287
# %bb.282:                              # %vec.epilog.iter.check1097
                                        #   in Loop: Header=BB2_263 Depth=1
	beqz	$a5, .LBB2_286
.LBB2_283:                              # %vec.epilog.ph1099
                                        #   in Loop: Header=BB2_263 Depth=1
	...
	addi.d	$a0, $a0, -16
	.p2align	4, , 16
.LBB2_284:                              # %vec.epilog.vector.body1103
                                        #   Parent Loop BB2_263 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $a1, 0
	vst	$vr2, $a0, 0
	...
	addi.d	$a0, $a0, -16
	bnez	$t0, .LBB2_284
# %bb.285:                              # %vec.epilog.middle.block1108
                                        #   in Loop: Header=BB2_263 Depth=1
	ld.d	$a1, $sp, 416                   # 8-byte Folded Reload
	beq	$a5, $ra, .LBB2_287
	.p2align	4, , 16
...
# %bb.291:                              # %middle.block1044
	...
	beq	$s7, $s2, .LBB2_298
# %bb.292:                              # %vec.epilog.iter.check1052
                                        #   in Loop: Header=BB2_263 Depth=1
	beqz	$t0, .LBB2_296
.LBB2_293:                              # %vec.epilog.ph1054
                                        #   in Loop: Header=BB2_263 Depth=1
	...
	addi.d	$t8, $a1, -4
	.p2align	4, , 16
.LBB2_294:                              # %vec.epilog.vector.body1058
                                        #   Parent Loop BB2_263 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a6, $t0, 0
	st.w	$a7, $t8, 0
	...
	addi.d	$t8, $t8, -4
	bnez	$a5, .LBB2_294
# %bb.295:                              # %vec.epilog.middle.block1064
                                        #   in Loop: Header=BB2_263 Depth=1
	vhaddw.d.w	$vr6, $vr6, $vr6
	vhaddw.q.d	$vr6, $vr6, $vr6
