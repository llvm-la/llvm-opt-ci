...
# %bb.82:
	...
	move	$a6, $s3
	b	.LBB2_90
.LBB2_83:                               # %vec.epilog.iter.check873
	move	$a6, $s3
	beqz	$a5, .LBB2_87
.LBB2_84:                               # %vec.epilog.ph875
	move	$a5, $a2
	...
	vreplgr2vr.w	$vr2, $s4
	.p2align	4, , 16
.LBB2_85:                               # %vec.epilog.vector.body880
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t5, $a7
	vstx	$vr1, $a6, $a7
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB2_85
# %bb.86:                               # %vec.epilog.middle.block884
	move	$a6, $s3
	beq	$a2, $a5, .LBB2_89
...
# %bb.191:
	move	$a5, $zero
	b	.LBB2_248
.LBB2_192:                              # %vector.main.loop.iter.check1087
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB2_196
# %bb.193:
	move	$a4, $zero
...
.LBB2_197:                              # %vector.body1092
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB2_197
# %bb.198:                              # %middle.block1098
	beq	$a3, $a4, .LBB2_205
# %bb.199:                              # %vec.epilog.iter.check1103
	beqz	$a6, .LBB2_203
.LBB2_200:                              # %vec.epilog.ph1105
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_201:                              # %vec.epilog.vector.body1111
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB2_201
# %bb.202:                              # %vec.epilog.middle.block1116
	beq	$a3, $a4, .LBB2_205
.LBB2_203:                              # %vec.epilog.scalar.ph1102.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_204:                              # %vec.epilog.scalar.ph1102
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB2_242:                              # %vector.body998
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB2_242
# %bb.243:                              # %middle.block1004
	beq	$a4, $a5, .LBB2_250
# %bb.244:                              # %vec.epilog.iter.check1009
	beqz	$a7, .LBB2_248
.LBB2_245:                              # %vec.epilog.ph1011
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_246:                              # %vec.epilog.vector.body1016
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB2_246
# %bb.247:                              # %vec.epilog.middle.block1021
	beq	$a4, $a5, .LBB2_250
.LBB2_248:                              # %vec.epilog.scalar.ph1008.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_249:                              # %vec.epilog.scalar.ph1008
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
