...
.LBB2_4:
	...
	pcalau12i	$s8, %pc_hi20(R__align.fgcp2)
	blez	$s2, .LBB2_7
# %bb.5:
...
# %bb.6:
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s8, %pc_lo12(R__align.fgcp2)
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
...
.LBB2_25:
	...
	ld.d	$a0, $sp, 472                   # 8-byte Folded Reload
	ld.d	$s4, $a0, %pc_lo12(R__align.w1)
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(R__align.w2)
	st.d	$a0, $sp, 472                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
	...
	ld.d	$a1, $sp, 376                   # 8-byte Folded Reload
	ld.d	$s6, $a1, %pc_lo12(R__align.intwork)
	ori	$a7, $zero, 1
	st.d	$a0, $sp, 416                   # 8-byte Folded Spill
	move	$a1, $s7
	move	$a2, $fp
...
.LBB2_76:                               # %vector.memcheck851
	...
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB2_87
# %bb.77:                               # %vector.main.loop.iter.check854
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_79
# %bb.78:
	move	$a4, $zero
	b	.LBB2_83
.LBB2_79:                               # %vector.ph856
	move	$a6, $zero
	andi	$a5, $a2, 12
	move	$a4, $a2
	...
	addi.d	$a7, $a0, 36
	xvrepli.b	$xr1, 0
	xvreplgr2vr.w	$xr2, $t4
	move	$t0, $a4
	ld.d	$t8, $sp, 80                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_80:                               # %vector.body861
                                        # =>This Inner Loop Header: Depth=1
	add.d	$t1, $a7, $a6
	add.d	$t2, $t8, $a6
	xvldx	$xr3, $t8, $a6
	...
	addi.d	$a6, $a6, 64
	bnez	$t0, .LBB2_80
# %bb.81:                               # %middle.block867
	move	$t2, $t6
	beq	$a2, $a4, .LBB2_86
# %bb.82:                               # %vec.epilog.iter.check873
	beqz	$a5, .LBB2_87
...
.LBB2_86:
	...
	ld.d	$t1, $sp, 80                    # 8-byte Folded Reload
	b	.LBB2_90
.LBB2_87:                               # %vec.epilog.scalar.ph872.preheader
	slli.d	$a2, $a3, 2
	ld.d	$t1, $sp, 80                    # 8-byte Folded Reload
	addi.d	$a4, $t1, -4
	sub.d	$a1, $a1, $a3
	movgr2fr.w	$fa0, $t4
	.p2align	4, , 16
.LBB2_88:                               # %vec.epilog.scalar.ph872
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a4, $a2
	stx.w	$zero, $a0, $a2
...
.LBB2_147:                              # %.loopexit
	...
	ld.d	$s6, $a0, %pc_lo12(R__align.mseq1)
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s3, $a0, %pc_lo12(R__align.mseq2)
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s5, $a0, %pc_lo12(R__align.ijp)
	ld.d	$a0, $t0, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
.LBB2_211:                              # %._crit_edge20.i540
	...
	beq	$t2, $a0, .LBB2_243
.LBB2_212:                              # %iter.check1192
                                        #   in Loop: Header=BB2_207 Depth=1
	addi.w	$t4, $zero, -5
	nor	$t7, $t2, $zero
	bltu	$t4, $t2, .LBB2_216
# %bb.213:                              # %iter.check1192
                                        #   in Loop: Header=BB2_207 Depth=1
	sub.d	$t4, $s8, $s4
	bltu	$t4, $a3, .LBB2_216
# %bb.214:                              # %vector.main.loop.iter.check1169
                                        #   in Loop: Header=BB2_207 Depth=1
	addi.w	$t4, $zero, -17
	bgeu	$t4, $t2, .LBB2_224
# %bb.215:                              #   in Loop: Header=BB2_207 Depth=1
	...
	b	.LBB2_228
	.p2align	4, , 16
.LBB2_216:                              #   in Loop: Header=BB2_207 Depth=1
	move	$t6, $t7
	move	$t4, $s4
	move	$t5, $s8
	b	.LBB2_231
...
.LBB2_218:                              #   in Loop: Header=BB2_207 Depth=1
	...
	add.w	$fp, $s7, $t4
	beqz	$fp, .LBB2_211
.LBB2_219:                              # %iter.check1237
                                        #   in Loop: Header=BB2_207 Depth=1
	bltu	$fp, $a3, .LBB2_223
# %bb.220:                              # %iter.check1237
                                        #   in Loop: Header=BB2_207 Depth=1
	sub.d	$t5, $s8, $s4
	bltu	$t5, $s2, .LBB2_223
# %bb.221:                              # %vector.main.loop.iter.check1218
                                        #   in Loop: Header=BB2_207 Depth=1
	bstrpick.d	$t8, $fp, 31, 0
	bgeu	$fp, $s2, .LBB2_234
# %bb.222:                              #   in Loop: Header=BB2_207 Depth=1
	move	$s0, $zero
	b	.LBB2_238
	.p2align	4, , 16
.LBB2_223:                              #   in Loop: Header=BB2_207 Depth=1
	move	$t5, $fp
	move	$t6, $s4
	move	$t7, $s8
	b	.LBB2_241
.LBB2_224:                              # %vector.ph1171
                                        #   in Loop: Header=BB2_207 Depth=1
	andi	$fp, $t7, 12
...
# %bb.226:                              # %middle.block1184
	...
	beq	$t8, $t7, .LBB2_233
# %bb.227:                              # %vec.epilog.iter.check1194
                                        #   in Loop: Header=BB2_207 Depth=1
	beqz	$fp, .LBB2_231
.LBB2_228:                              # %vec.epilog.ph1196
                                        #   in Loop: Header=BB2_207 Depth=1
	...
	addi.d	$t8, $t8, -4
	.p2align	4, , 16
.LBB2_229:                              # %vec.epilog.vector.body1200
                                        #   Parent Loop BB2_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a4, $s0, 0
	st.w	$a5, $t8, 0
	...
	addi.d	$t8, $t8, -4
	bnez	$t3, .LBB2_229
# %bb.230:                              # %vec.epilog.middle.block1206
                                        #   in Loop: Header=BB2_207 Depth=1
	vhaddw.d.w	$vr6, $vr6, $vr6
	vhaddw.q.d	$vr6, $vr6, $vr6
	vpickve2gr.d	$t3, $vr6, 0
	beq	$fp, $t7, .LBB2_233
.LBB2_231:                              # %.lr.ph29.i543.preheader
                                        #   in Loop: Header=BB2_207 Depth=1
	add.d	$t3, $t3, $t6
	.p2align	4, , 16
.LBB2_232:                              # %.lr.ph29.i543
                                        #   Parent Loop BB2_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a2, $t5, -1
	addi.d	$t5, $t5, -1
	...
	addi.d	$t4, $t4, -1
	bnez	$t6, .LBB2_232
.LBB2_233:                              # %._crit_edge30.i544
                                        #   in Loop: Header=BB2_207 Depth=1
	bgtz	$t0, .LBB2_244
	b	.LBB2_247
.LBB2_234:                              # %vector.ph1220
                                        #   in Loop: Header=BB2_207 Depth=1
	move	$a6, $ra
	andi	$s1, $t8, 48
...
.LBB2_235:                              # %vector.body1224
	...
	addi.d	$ra, $ra, -64
	bnez	$s5, .LBB2_235
# %bb.236:                              # %middle.block1231
                                        #   in Loop: Header=BB2_207 Depth=1
	ld.d	$s5, $sp, 432                   # 8-byte Folded Reload
	move	$ra, $a6
	ori	$s2, $zero, 64
	beq	$s0, $t8, .LBB2_242
# %bb.237:                              # %vec.epilog.iter.check1239
                                        #   in Loop: Header=BB2_207 Depth=1
	beqz	$s1, .LBB2_241
.LBB2_238:                              # %vec.epilog.ph1241
                                        #   in Loop: Header=BB2_207 Depth=1
	...
	addi.d	$s0, $s0, -16
	.p2align	4, , 16
.LBB2_239:                              # %vec.epilog.vector.body1245
                                        #   Parent Loop BB2_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $s2, 0
	vst	$vr2, $s0, 0
	...
	addi.d	$s0, $s0, -16
	bnez	$fp, .LBB2_239
# %bb.240:                              # %vec.epilog.middle.block1250
                                        #   in Loop: Header=BB2_207 Depth=1
	ori	$s2, $zero, 64
	beq	$s1, $t8, .LBB2_242
	.p2align	4, , 16
.LBB2_241:                              # %.lr.ph19.i538
                                        #   Parent Loop BB2_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a1, $t7, -1
	addi.d	$t7, $t7, -1
	...
	addi.d	$t6, $t6, -1
	bnez	$t5, .LBB2_241
.LBB2_242:                              # %._crit_edge20.loopexit.i539
                                        #   in Loop: Header=BB2_207 Depth=1
	add.d	$t3, $s7, $t3
	add.d	$t3, $t4, $t3
	move	$s8, $t7
	move	$s4, $t6
	bne	$t2, $a0, .LBB2_212
.LBB2_243:                              #   in Loop: Header=BB2_207 Depth=1
	move	$t5, $s8
	move	$t4, $s4
	blez	$t0, .LBB2_247
.LBB2_244:                              # %._crit_edge30.i544
                                        #   in Loop: Header=BB2_207 Depth=1
	blez	$t1, .LBB2_247
# %bb.245:                              #   in Loop: Header=BB2_207 Depth=1
	add.d	$ra, $t2, $ra
	addi.d	$s8, $t5, -1
	st.b	$a1, $t5, -1
	addi.d	$s4, $t4, -1
...
.LBB2_247:
	...
	ld.d	$s7, $sp, 112                   # 8-byte Folded Reload
	blez	$s5, .LBB2_250
.LBB2_248:                              # %.lr.ph50.preheader.i556
	move	$fp, $s7
	move	$s0, $s5
	.p2align	4, , 16
.LBB2_249:                              # %.lr.ph50.i558
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s6, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB2_249
.LBB2_250:                              # %.preheader.i549
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	blez	$s1, .LBB2_313
# %bb.251:                              # %.lr.ph52.preheader.i550
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB2_252:                              # %.lr.ph52.i552
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s3, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s4
...
.LBB2_254:                              # %vector.body998
	...
	addi.d	$a7, $a7, 64
	bnez	$a2, .LBB2_254
# %bb.255:                              # %middle.block1004
	beq	$a4, $a5, .LBB2_262
# %bb.256:                              # %vec.epilog.iter.check1009
	beqz	$a0, .LBB2_260
.LBB2_257:                              # %vec.epilog.ph1011
	move	$a2, $a5
	pcalau12i	$a0, %pc_hi20(.LCPI2_7)
	vld	$vr0, $a0, %pc_lo12(.LCPI2_7)
	...
	alsl.d	$a2, $a2, $a3, 2
	.p2align	4, , 16
.LBB2_258:                              # %vec.epilog.vector.body1016
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a2, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a2, $a2, 16
	bnez	$a0, .LBB2_258
# %bb.259:                              # %vec.epilog.middle.block1021
	beq	$a4, $a5, .LBB2_262
.LBB2_260:                              # %vec.epilog.scalar.ph1008.preheader
	alsl.d	$a0, $a5, $a3, 2
	nor	$a2, $a5, $zero
	sub.d	$a3, $a4, $a5
	.p2align	4, , 16
.LBB2_261:                              # %vec.epilog.scalar.ph1008
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a2, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a3, $a3, -1
...
# %bb.265:                              #   in Loop: Header=BB2_264 Depth=1
	beqz	$t5, .LBB2_274
# %bb.266:                              #   in Loop: Header=BB2_264 Depth=1
	sub.d	$t2, $s7, $t5
	b	.LBB2_275
	.p2align	4, , 16
.LBB2_267:                              #   in Loop: Header=BB2_264 Depth=1
	addi.d	$t2, $s7, -1
	nor	$fp, $t2, $zero
	add.w	$t0, $s7, $fp
	bnez	$t0, .LBB2_276
	.p2align	4, , 16
.LBB2_268:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_264 Depth=1
	beq	$t5, $a1, .LBB2_300
.LBB2_269:                              # %iter.check1050
                                        #   in Loop: Header=BB2_264 Depth=1
	addi.w	$a0, $zero, -5
	nor	$s2, $t5, $zero
	bltu	$a0, $t5, .LBB2_273
# %bb.270:                              # %iter.check1050
                                        #   in Loop: Header=BB2_264 Depth=1
	sub.d	$a0, $s8, $s4
	ori	$a5, $zero, 16
	bltu	$a0, $a5, .LBB2_273
# %bb.271:                              # %vector.main.loop.iter.check1030
                                        #   in Loop: Header=BB2_264 Depth=1
	addi.w	$a0, $zero, -17
	bgeu	$a0, $t5, .LBB2_281
# %bb.272:                              #   in Loop: Header=BB2_264 Depth=1
	...
	b	.LBB2_285
	.p2align	4, , 16
.LBB2_273:                              #   in Loop: Header=BB2_264 Depth=1
	move	$s1, $s2
	move	$fp, $s4
	move	$s0, $s8
	b	.LBB2_288
...
.LBB2_275:                              #   in Loop: Header=BB2_264 Depth=1
	...
	add.w	$t0, $s7, $fp
	beqz	$t0, .LBB2_268
.LBB2_276:                              # %iter.check1095
                                        #   in Loop: Header=BB2_264 Depth=1
	ori	$a0, $zero, 16
	bltu	$t0, $a0, .LBB2_280
# %bb.277:                              # %iter.check1095
                                        #   in Loop: Header=BB2_264 Depth=1
	sub.d	$a0, $s8, $s4
	ori	$a5, $zero, 64
	bltu	$a0, $a5, .LBB2_280
# %bb.278:                              # %vector.main.loop.iter.check1076
                                        #   in Loop: Header=BB2_264 Depth=1
	bstrpick.d	$ra, $t0, 31, 0
	bgeu	$t0, $a5, .LBB2_291
# %bb.279:                              #   in Loop: Header=BB2_264 Depth=1
	move	$s5, $zero
	b	.LBB2_295
	.p2align	4, , 16
...
.LBB2_281:                              # %vector.ph1032
	...
	xvori.b	$xr7, $xr1, 0
	.p2align	4, , 16
.LBB2_282:                              # %vector.body1036
                                        #   Parent Loop BB2_264 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr2, $a0, -8
	vst	$vr3, $a5, -8
	xvaddi.wu	$xr6, $xr6, 1
...
# %bb.283:                              # %middle.block1044
	...
	beq	$s7, $s2, .LBB2_290
# %bb.284:                              # %vec.epilog.iter.check1052
                                        #   in Loop: Header=BB2_264 Depth=1
	beqz	$t0, .LBB2_288
.LBB2_285:                              # %vec.epilog.ph1054
                                        #   in Loop: Header=BB2_264 Depth=1
	...
	addi.d	$t8, $a1, -4
	.p2align	4, , 16
.LBB2_286:                              # %vec.epilog.vector.body1058
                                        #   Parent Loop BB2_264 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a6, $t0, 0
	st.w	$a7, $t8, 0
	...
	addi.d	$t8, $t8, -4
	bnez	$a5, .LBB2_286
# %bb.287:                              # %vec.epilog.middle.block1064
                                        #   in Loop: Header=BB2_264 Depth=1
	vhaddw.d.w	$vr6, $vr6, $vr6
	vhaddw.q.d	$vr6, $vr6, $vr6
...
.LBB2_289:                              # %.lr.ph29.i
	...
	addi.d	$fp, $fp, -1
	bnez	$s1, .LBB2_289
.LBB2_290:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_264 Depth=1
	ld.d	$a0, $sp, 464                   # 8-byte Folded Reload
	bne	$t3, $a0, .LBB2_301
	b	.LBB2_303
.LBB2_291:                              # %vector.ph1078
                                        #   in Loop: Header=BB2_264 Depth=1
	andi	$a5, $ra, 48
...
.LBB2_292:                              # %vector.body1082
	...
	addi.d	$a1, $a1, -64
	bnez	$a0, .LBB2_292
# %bb.293:                              # %middle.block1089
                                        #   in Loop: Header=BB2_264 Depth=1
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 416                   # 8-byte Folded Reload
	beq	$s5, $ra, .LBB2_299
# %bb.294:                              # %vec.epilog.iter.check1097
                                        #   in Loop: Header=BB2_264 Depth=1
	beqz	$a5, .LBB2_298
.LBB2_295:                              # %vec.epilog.ph1099
                                        #   in Loop: Header=BB2_264 Depth=1
	...
	addi.d	$a0, $a0, -16
	.p2align	4, , 16
.LBB2_296:                              # %vec.epilog.vector.body1103
                                        #   Parent Loop BB2_264 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $a1, 0
	vst	$vr2, $a0, 0
	...
	addi.d	$a0, $a0, -16
	bnez	$t0, .LBB2_296
# %bb.297:                              # %vec.epilog.middle.block1108
                                        #   in Loop: Header=BB2_264 Depth=1
	ld.d	$a1, $sp, 416                   # 8-byte Folded Reload
	beq	$a5, $ra, .LBB2_299
	.p2align	4, , 16
...
# %bb.302:                              #   in Loop: Header=BB2_264 Depth=1
	...
	fadd.s	$fa6, $fa6, $fa7
	fst.s	$fa6, $a0, 0
.LBB2_303:                              #   in Loop: Header=BB2_264 Depth=1
	blez	$t3, .LBB2_307
# %bb.304:                              #   in Loop: Header=BB2_264 Depth=1
	blez	$t4, .LBB2_307
# %bb.305:                              #   in Loop: Header=BB2_264 Depth=1
	add.d	$t1, $t5, $t1
	addi.d	$s8, $s0, -1
	st.b	$a3, $s0, -1
	addi.d	$s4, $fp, -1
