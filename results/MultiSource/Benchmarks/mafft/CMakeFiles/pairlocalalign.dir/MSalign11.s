...
# %bb.86:
	move	$a3, $zero
	b	.LBB2_96
.LBB2_87:                               # %vector.main.loop.iter.check482
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_89
# %bb.88:
	move	$a3, $zero
	b	.LBB2_93
.LBB2_89:                               # %vector.ph483
	andi	$a5, $a4, 12
...
.LBB2_90:                               # %vector.body486
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_90
# %bb.91:                               # %middle.block492
	beq	$a2, $a3, .LBB2_98
# %bb.92:                               # %vec.epilog.iter.check496
	beqz	$a5, .LBB2_96
.LBB2_93:                               # %vec.epilog.ph498
	move	$a5, $a3
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_94:                               # %vec.epilog.vector.body501
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_94
# %bb.95:                               # %vec.epilog.middle.block506
	beq	$a2, $a3, .LBB2_98
.LBB2_96:                               # %vec.epilog.scalar.ph495.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB2_97:                               # %vec.epilog.scalar.ph495
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
