...
.Lfunc_end0:
	...
	.p2align	2                               # -- Begin function extendmseq
...
# %bb.0:
	...
	pcalau12i	$a0, %got_pc_hi20(penalty)
	ld.d	$a0, $a0, %got_pc_lo12(penalty)
	pcalau12i	$s5, %pc_hi20(MSalign11.orlgth1)
	ld.w	$s8, $s5, %pc_lo12(MSalign11.orlgth1)
	fld.s	$fs0, $a0, 0
...
.LBB2_8:
	...
	st.w	$s8, $s5, %pc_lo12(MSalign11.orlgth1)
...
# %bb.56:                               #   in Loop: Header=BB2_53 Depth=2
	...
	st.w	$t4, $a3, 0
	fmov.s	$fs0, $fa2
.LBB2_57:                               #   in Loop: Header=BB2_53 Depth=2
...
.LBB2_59:                               #   in Loop: Header=BB2_53 Depth=2
	...
	fst.s	$fa1, $a2, 0
	bge	$t0, $s3, .LBB2_52
# %bb.60:                               #   in Loop: Header=BB2_53 Depth=2
	fld.s	$fa2, $a1, 0
	fld.s	$fa1, $a7, 0
	fcmp.cule.s	$fcc0, $fa1, $fa2
	bcnez	$fcc0, .LBB2_62
# %bb.61:                               #   in Loop: Header=BB2_53 Depth=2
	fst.s	$fa1, $a1, 0
	fld.s	$fa1, $a7, 0
.LBB2_62:                               #   in Loop: Header=BB2_53 Depth=2
	fld.s	$fa2, $t2, 0
	fcmp.cule.s	$fcc0, $fa1, $fa2
	bcnez	$fcc0, .LBB2_52
# %bb.63:                               #   in Loop: Header=BB2_53 Depth=2
	fst.s	$fa1, $t2, 0
	b	.LBB2_52
.LBB2_64:
	move	$s1, $zero
...
.LBB2_69:                               # =>This Inner Loop Header: Depth=1
	...
	addi.w	$a0, $a0, 1
	bnez	$a1, .LBB2_69
.LBB2_70:                               # %.preheader323
	blez	$t6, .LBB2_73
# %bb.71:                               # %.lr.ph376.preheader
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
...
.LBB2_80:                               # %vector.body470
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB2_80
# %bb.81:                               # %middle.block475
	beq	$a1, $a2, .LBB2_84
.LBB2_82:                               # %.lr.ph.i322.preheader
	alsl.d	$a3, $a2, $s5, 3
	sub.d	$a1, $a1, $a2
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
...
# %bb.86:
	move	$a3, $zero
	b	.LBB2_96
.LBB2_87:                               # %vector.main.loop.iter.check479
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_89
# %bb.88:
	move	$a3, $zero
	b	.LBB2_93
.LBB2_89:                               # %vector.ph481
	andi	$a5, $a4, 12
...
.LBB2_90:                               # %vector.body484
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_90
# %bb.91:                               # %middle.block490
	beq	$a2, $a3, .LBB2_98
# %bb.92:                               # %vec.epilog.iter.check495
	beqz	$a5, .LBB2_96
.LBB2_93:                               # %vec.epilog.ph497
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB2_94:                               # %vec.epilog.vector.body500
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_94
# %bb.95:                               # %vec.epilog.middle.block505
	beq	$a2, $a3, .LBB2_98
.LBB2_96:                               # %vec.epilog.scalar.ph494.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB2_97:                               # %vec.epilog.scalar.ph494
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
# %bb.102:                              #   in Loop: Header=BB2_100 Depth=1
	...
	b	.LBB2_105
	.p2align	4, , 16
.LBB2_103:                              #   in Loop: Header=BB2_100 Depth=1
	addi.w	$a5, $s2, -1
	nor	$t1, $a5, $zero
	add.w	$t2, $s2, $t1
	bnez	$t2, .LBB2_106
	b	.LBB2_108
	.p2align	4, , 16
.LBB2_104:                              #   in Loop: Header=BB2_100 Depth=1
	addi.w	$a5, $s2, -1
.LBB2_105:                              #   in Loop: Header=BB2_100 Depth=1
	move	$t0, $a2
	nor	$t1, $a5, $zero
	add.w	$t2, $s2, $t1
	beqz	$t2, .LBB2_108
...
.LBB2_106:                              # %.lr.ph9.i
	...
	st.b	$a4, $t3, -1
	bnez	$t2, .LBB2_106
# %bb.107:                              # %._crit_edge10.loopexit.i
                                        #   in Loop: Header=BB2_100 Depth=1
	add.d	$a3, $s2, $a3
	add.d	$a3, $t1, $a3
.LBB2_108:                              # %._crit_edge10.i
                                        #   in Loop: Header=BB2_100 Depth=1
	add.w	$a0, $t0, $a0
	beq	$t0, $a2, .LBB2_111
# %bb.109:                              # %.lr.ph14.preheader.i
                                        #   in Loop: Header=BB2_100 Depth=1
	nor	$t0, $t0, $zero
	.p2align	4, , 16
.LBB2_110:                              # %.lr.ph14.i
	...
	addi.d	$a3, $a3, 1
	bnez	$t0, .LBB2_110
.LBB2_111:                              # %._crit_edge15.i
                                        #   in Loop: Header=BB2_100 Depth=1
	blez	$a6, .LBB2_114
# %bb.112:                              # %._crit_edge15.i
                                        #   in Loop: Header=BB2_100 Depth=1
	blez	$a7, .LBB2_114
