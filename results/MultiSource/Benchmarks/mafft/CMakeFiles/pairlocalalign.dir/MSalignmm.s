...
.LBB1_43:                               # %.lr.ph12.i
	...
	addi.d	$a4, $a4, 4
	bnez	$a2, .LBB1_43
.LBB1_44:                               # %iter.check444
	addi.d	$a2, $t8, 4
	ori	$a3, $zero, 1
	ori	$a4, $zero, 5
	addi.d	$s1, $t5, 4
	bge	$s0, $a4, .LBB1_62
.LBB1_45:                               # %vec.epilog.scalar.ph445.preheader
	sub.d	$a1, $a0, $a3
	...
	addi.d	$a3, $a3, -4
	.p2align	4, , 16
.LBB1_46:                               # %vec.epilog.scalar.ph445
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fld.s	$fa1, $a2, 0
	fadd.s	$fa0, $fa0, $fa1
...
# %bb.59:                               # %vector.memcheck365
	...
	and	$a2, $a2, $a3
	bnez	$a2, .LBB1_42
# %bb.60:                               # %vector.main.loop.iter.check379
	ori	$a2, $zero, 17
	bge	$s0, $a2, .LBB1_268
# %bb.61:
	move	$a2, $zero
	b	.LBB1_272
.LBB1_62:                               # %vector.memcheck414
	alsl.d	$a4, $a0, $t5, 2
	alsl.d	$a5, $a0, $t4, 2
	addi.d	$a5, $a5, -4
	sltu	$a5, $s1, $a5
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB1_45
# %bb.63:                               # %vector.memcheck414
	addi.d	$a5, $t8, 8
	sltu	$a5, $s1, $a5
	sltu	$a4, $a2, $a4
	and	$a4, $a5, $a4
	bnez	$a4, .LBB1_45
# %bb.64:                               # %vector.main.loop.iter.check428
	ori	$a3, $zero, 17
	bge	$s0, $a3, .LBB1_275
# %bb.65:
	move	$a4, $zero
...
# %bb.71:                               # %vector.memcheck316
	...
	and	$a2, $a2, $a3
	bnez	$a2, .LBB1_38
# %bb.72:                               # %vector.main.loop.iter.check330
	ori	$a1, $zero, 17
	addi.d	$a2, $a0, -1
	bge	$fp, $a1, .LBB1_311
# %bb.73:
...
# %bb.80:
	move	$a3, $zero
	b	.LBB1_90
.LBB1_81:                               # %vector.main.loop.iter.check475
	ori	$a3, $zero, 14
	bgeu	$t1, $a3, .LBB1_83
# %bb.82:
	move	$a3, $zero
	b	.LBB1_87
.LBB1_83:                               # %vector.ph477
	andi	$a4, $a2, 12
...
.LBB1_84:                               # %vector.body480
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_84
# %bb.85:                               # %middle.block486
	beq	$a3, $a2, .LBB1_92
# %bb.86:                               # %vec.epilog.iter.check491
	beqz	$a4, .LBB1_90
.LBB1_87:                               # %vec.epilog.ph493
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB1_88:                               # %vec.epilog.vector.body498
                                        # =>This Inner Loop Header: Depth=1
	vxori.b	$vr1, $vr0, 255
	vst	$vr1, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB1_88
# %bb.89:                               # %vec.epilog.middle.block503
	beq	$a3, $a2, .LBB1_92
.LBB1_90:                               # %vec.epilog.scalar.ph490.preheader
	alsl.d	$a0, $a3, $a0, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_91:                               # %vec.epilog.scalar.ph490
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $a2, -1
...
# %bb.98:                               # %iter.check569
	...
	sub.d	$t3, $s7, $s0
	bltu	$t3, $a6, .LBB1_107
# %bb.99:                               # %vector.main.loop.iter.check553
                                        #   in Loop: Header=BB1_94 Depth=1
...
.LBB1_102:                              # %._crit_edge126.i.i
                                        #   in Loop: Header=BB1_94 Depth=1
	beq	$t0, $a1, .LBB1_119
.LBB1_103:                              # %iter.check528
                                        #   in Loop: Header=BB1_94 Depth=1
	addi.w	$t2, $zero, -5
	nor	$t5, $t0, $zero
	bltu	$t2, $t0, .LBB1_108
# %bb.104:                              # %iter.check528
                                        #   in Loop: Header=BB1_94 Depth=1
	sub.d	$t2, $s7, $s0
	bltu	$t2, $a3, .LBB1_108
# %bb.105:                              # %vector.main.loop.iter.check512
                                        #   in Loop: Header=BB1_94 Depth=1
	addi.w	$t2, $zero, -17
	bgeu	$t2, $t0, .LBB1_120
...
.LBB1_111:                              # %vector.body558
	...
	addi.d	$s3, $s3, -64
	bnez	$s4, .LBB1_111
# %bb.112:                              # %middle.block563
                                        #   in Loop: Header=BB1_94 Depth=1
	ld.d	$s3, $sp, 240                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 304                   # 8-byte Folded Reload
	move	$s4, $ra
	beq	$t8, $t6, .LBB1_118
# %bb.113:                              # %vec.epilog.iter.check571
                                        #   in Loop: Header=BB1_94 Depth=1
	beqz	$s1, .LBB1_117
.LBB1_114:                              # %vec.epilog.ph573
                                        #   in Loop: Header=BB1_94 Depth=1
	...
	addi.d	$t8, $t8, -16
	.p2align	4, , 16
.LBB1_115:                              # %vec.epilog.vector.body576
                                        #   Parent Loop BB1_94 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr3, $s2, 0
	vst	$vr2, $t8, 0
	...
	addi.d	$t8, $t8, -16
	bnez	$t7, .LBB1_115
# %bb.116:                              # %vec.epilog.middle.block581
                                        #   in Loop: Header=BB1_94 Depth=1
	ld.d	$s2, $sp, 304                   # 8-byte Folded Reload
	beq	$s1, $t6, .LBB1_118
	.p2align	4, , 16
...
# %bb.122:                              # %middle.block522
	...
	beq	$t6, $t5, .LBB1_129
# %bb.123:                              # %vec.epilog.iter.check530
                                        #   in Loop: Header=BB1_94 Depth=1
	beqz	$t7, .LBB1_127
.LBB1_124:                              # %vec.epilog.ph532
                                        #   in Loop: Header=BB1_94 Depth=1
	...
	addi.d	$t6, $t6, -4
	.p2align	4, , 16
.LBB1_125:                              # %vec.epilog.vector.body535
                                        #   Parent Loop BB1_94 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a4, $t8, 0
	st.w	$a5, $t6, 0
	...
	addi.d	$t6, $t6, -4
	bnez	$t1, .LBB1_125
# %bb.126:                              # %vec.epilog.middle.block541
                                        #   in Loop: Header=BB1_94 Depth=1
...
.LBB1_145:                              # %.lr.ph30
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB1_145
.LBB1_146:                              # %iter.check148
	ori	$a3, $zero, 1
	ori	$a4, $zero, 5
	addi.d	$s1, $s8, 4
	bge	$fp, $a4, .LBB1_210
.LBB1_147:                              # %vec.epilog.scalar.ph149.preheader
	ori	$a0, $zero, 2
	slt	$a1, $a0, $fp
	masknez	$a0, $a0, $a1
	maskeqz	$a1, $fp, $a1
	...
	sub.d	$a3, $a4, $a3
	.p2align	4, , 16
.LBB1_148:                              # %vec.epilog.scalar.ph149
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $s6, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB1_164:                              # %vec.epilog.scalar.ph195.preheader
	move	$t8, $s7
.LBB1_165:                              # %vec.epilog.scalar.ph195.preheader
	slli.d	$a4, $a2, 2
	alsl.d	$a3, $a2, $s4, 2
	sub.d	$a1, $a1, $a2
	alsl.d	$a2, $a7, $a4, 2
	...
	addi.d	$a2, $a2, 4
	.p2align	4, , 16
.LBB1_166:                              # %vec.epilog.scalar.ph195
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
# %bb.168:
	move	$a3, $zero
.LBB1_169:                              # %vec.epilog.scalar.ph243.preheader
	slli.d	$a5, $a3, 2
	alsl.d	$a4, $a3, $t8, 2
	sub.d	$a2, $a2, $a3
	alsl.d	$a3, $t1, $a5, 2
	...
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB1_170:                              # %vec.epilog.scalar.ph243
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a3, 0
	fld.s	$fa2, $a4, 0
...
.LBB1_172:
	move	$a0, $s0
.LBB1_173:                              # %scalar.ph272.preheader
	addi.d	$a3, $a0, 1
...
.LBB1_210:                              # %vector.memcheck118
	...
	and	$a2, $a2, $a4
	bnez	$a2, .LBB1_147
# %bb.211:                              # %vector.memcheck118
	addi.d	$a2, $t2, 8
	sltu	$a2, $s1, $a2
	sltu	$a1, $s6, $a1
	and	$a1, $a2, $a1
	bnez	$a1, .LBB1_147
# %bb.212:                              # %vector.main.loop.iter.check132
	ori	$a1, $zero, 17
	bge	$fp, $a1, .LBB1_289
# %bb.213:
	move	$a1, $zero
	b	.LBB1_293
.LBB1_214:                              # %vector.memcheck164
	alsl.d	$a3, $a1, $s4, 2
	ld.d	$a7, $sp, 280                   # 8-byte Folded Reload
	add.d	$a2, $a7, $a1
	slli.d	$a2, $a2, 2
...
# %bb.215:                              # %vector.memcheck164
	...
	move	$t8, $s7
	bnez	$a3, .LBB1_165
# %bb.216:                              # %vector.main.loop.iter.check177
	ori	$a2, $zero, 16
	bgeu	$s1, $a2, .LBB1_296
# %bb.217:
	move	$a2, $zero
	b	.LBB1_300
.LBB1_218:                              # %vector.memcheck211
	alsl.d	$a4, $a2, $t8, 2
	add.d	$a3, $t1, $s0
	alsl.d	$a3, $a3, $t6, 2
	addi.d	$a3, $a3, 4
...
# %bb.219:                              # %vector.memcheck211
	...
	and	$a4, $a6, $a4
	bnez	$a4, .LBB1_169
# %bb.220:                              # %vector.main.loop.iter.check225
	ori	$a3, $zero, 16
	bge	$s0, $a3, .LBB1_303
# %bb.221:
	move	$a3, $zero
	b	.LBB1_307
.LBB1_222:                              # %vector.memcheck259
...
.LBB1_253:                              # %vector.body295
	...
	addi.d	$a2, $a2, 64
	bnez	$a4, .LBB1_253
# %bb.254:                              # %middle.block300
	beq	$a1, $s2, .LBB1_257
.LBB1_255:                              # %scalar.ph290.preheader
	alsl.d	$a2, $a1, $fp, 3
	sub.d	$a1, $s2, $a1
	.p2align	4, , 16
.LBB1_256:                              # %scalar.ph290
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	add.d	$a4, $a4, $a0
	st.d	$a4, $a2, 0
...
.LBB1_261:                              # %vector.body308
	...
	addi.d	$a2, $a2, 64
	bnez	$a5, .LBB1_261
# %bb.262:                              # %middle.block313
	beq	$a1, $s4, .LBB1_265
.LBB1_263:                              # %scalar.ph303.preheader
	alsl.d	$a2, $a1, $s6, 3
	sub.d	$a1, $s4, $a1
	.p2align	4, , 16
.LBB1_264:                              # %scalar.ph303
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a2, 0
	add.d	$a5, $a5, $a0
	st.d	$a5, $a2, 0
...
.LBB1_265:                              # %._crit_edge108
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_266:                              # %common.ret.sink.split
	move	$a0, $fp
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s6
...
.LBB1_269:                              # %vector.body384
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_269
# %bb.270:                              # %middle.block393
	beq	$a1, $a2, .LBB1_44
# %bb.271:                              # %vec.epilog.iter.check399
	beqz	$a3, .LBB1_42
.LBB1_272:                              # %vec.epilog.ph401
	move	$a3, $a1
	bstrins.d	$a3, $zero, 1, 0
	ori	$a4, $zero, 1
	move	$s1, $a1
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_273:                              # %vec.epilog.vector.body404
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a5, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a5, $a5, 16
	bnez	$a2, .LBB1_273
# %bb.274:                              # %vec.epilog.middle.block411
	bne	$a1, $a3, .LBB1_42
	b	.LBB1_44
.LBB1_275:                              # %vector.ph430
	andi	$a5, $a1, 12
	move	$a4, $a1
...
.LBB1_276:                              # %vector.body433
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB1_276
# %bb.277:                              # %middle.block440
	beq	$a1, $a4, .LBB1_47
# %bb.278:                              # %vec.epilog.iter.check446
	beqz	$a5, .LBB1_45
.LBB1_279:                              # %vec.epilog.ph448
	move	$a5, $a1
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB1_280:                              # %vec.epilog.vector.body451
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a6, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a7, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB1_280
# %bb.281:                              # %vec.epilog.middle.block457
	bne	$a1, $a5, .LBB1_45
	b	.LBB1_47
.LBB1_282:                              # %vector.ph85
	andi	$a5, $a0, 12
	move	$a4, $a0
	bstrins.d	$a4, $zero, 3, 0
	ori	$a6, $zero, 1
...
.LBB1_283:                              # %vector.body88
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB1_283
# %bb.284:                              # %middle.block97
	beq	$a0, $a4, .LBB1_146
# %bb.285:                              # %vec.epilog.iter.check103
	beqz	$a5, .LBB1_144
.LBB1_286:                              # %vec.epilog.ph105
	move	$a5, $a0
	bstrins.d	$a5, $zero, 1, 0
	ori	$a6, $zero, 1
	move	$a3, $a0
	...
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB1_287:                              # %vec.epilog.vector.body108
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB1_287
# %bb.288:                              # %vec.epilog.middle.block115
	bne	$a0, $a5, .LBB1_144
	b	.LBB1_146
.LBB1_289:                              # %vector.ph134
	andi	$a2, $a0, 12
	move	$a1, $a0
...
.LBB1_290:                              # %vector.body137
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_290
# %bb.291:                              # %middle.block144
	beq	$a0, $a1, .LBB1_149
# %bb.292:                              # %vec.epilog.iter.check150
	beqz	$a2, .LBB1_147
.LBB1_293:                              # %vec.epilog.ph152
	move	$a2, $a0
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB1_294:                              # %vec.epilog.vector.body155
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a4, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a5, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a1, .LBB1_294
# %bb.295:                              # %vec.epilog.middle.block161
	bne	$a0, $a2, .LBB1_147
	b	.LBB1_149
.LBB1_296:                              # %vector.ph179
	andi	$a3, $a1, 12
...
.LBB1_297:                              # %vector.body182
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_297
# %bb.298:                              # %middle.block191
	beq	$a2, $a1, .LBB1_167
# %bb.299:                              # %vec.epilog.iter.check196
	beqz	$a3, .LBB1_165
.LBB1_300:                              # %vec.epilog.ph198
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $s4, 2
	.p2align	4, , 16
.LBB1_301:                              # %vec.epilog.vector.body201
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vld	$vr2, $a5, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB1_301
# %bb.302:                              # %vec.epilog.middle.block208
	bne	$a2, $a1, .LBB1_165
	b	.LBB1_167
.LBB1_303:                              # %vector.ph227
	andi	$a4, $a2, 12
...
.LBB1_304:                              # %vector.body230
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_304
# %bb.305:                              # %middle.block239
	beq	$a3, $a2, .LBB1_171
# %bb.306:                              # %vec.epilog.iter.check244
	beqz	$a4, .LBB1_169
.LBB1_307:                              # %vec.epilog.ph246
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $t8, 2
	.p2align	4, , 16
.LBB1_308:                              # %vec.epilog.vector.body249
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB1_308
# %bb.309:                              # %vec.epilog.middle.block256
	bne	$a3, $a2, .LBB1_169
	b	.LBB1_171
.LBB1_310:
	move	$s0, $zero
...
.LBB1_312:                              # %vector.body335
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_312
# %bb.313:                              # %middle.block344
	beq	$a2, $a3, .LBB1_40
# %bb.314:                              # %vec.epilog.iter.check350
	beqz	$a4, .LBB1_38
.LBB1_315:                              # %vec.epilog.ph352
	move	$a4, $a2
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB1_316:                              # %vec.epilog.vector.body355
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a3, .LBB1_316
# %bb.317:                              # %vec.epilog.middle.block362
	bne	$a2, $a4, .LBB1_38
	b	.LBB1_40
.Lfunc_end1:
