...
# %bb.58:
	move	$a2, $zero
	b	.LBB0_62
.LBB0_59:                               # %vector.ph290
	bstrpick.d	$a2, $a2, 31, 3
	slli.d	$a2, $a2, 3
	addi.d	$a3, $t5, 32
	move	$a4, $a2
	.p2align	4, , 16
.LBB0_60:                               # %vector.body293
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a3, -32
	ld.d	$a6, $a3, -24
	ld.d	$a7, $a3, -16
...
# %bb.66:
	move	$a3, $zero
	b	.LBB0_76
.LBB0_67:                               # %vector.main.loop.iter.check302
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_69
# %bb.68:
	move	$a3, $zero
	b	.LBB0_73
.LBB0_69:                               # %vector.ph304
	andi	$a5, $a4, 12
...
.LBB0_70:                               # %vector.body307
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_70
# %bb.71:                               # %middle.block310
	beq	$a2, $a3, .LBB0_78
# %bb.72:                               # %vec.epilog.iter.check315
	beqz	$a5, .LBB0_76
.LBB0_73:                               # %vec.epilog.ph317
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB0_74:                               # %vec.epilog.vector.body322
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_74
# %bb.75:                               # %vec.epilog.middle.block325
	beq	$a2, $a3, .LBB0_78
.LBB0_76:                               # %vec.epilog.scalar.ph314.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB0_77:                               # %vec.epilog.scalar.ph314
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s7, $a1, 0
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 4
