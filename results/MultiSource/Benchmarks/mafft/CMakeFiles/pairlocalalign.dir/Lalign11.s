...
.LBB0_2:
	...
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	pcalau12i	$s1, %pc_hi20(L__align11.orlgth2)
	ld.w	$s8, $s1, %pc_lo12(L__align11.orlgth2)
	...
	pcalau12i	$s3, %pc_hi20(L__align11.mseq)
...
# %bb.3:
	blt	$s8, $s2, .LBB0_5
# %bb.4:                                # %._crit_edge242
	ld.d	$a0, $s3, %pc_lo12(L__align11.mseq)
	move	$s6, $a1
	b	.LBB0_10
.LBB0_5:
...
.LBB0_9:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s3, %pc_lo12(L__align11.mseq)
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	st.w	$s7, $a1, %pc_lo12(L__align11.orlgth1)
	st.w	$s8, $s1, %pc_lo12(L__align11.orlgth2)
.LBB0_10:
	ld.d	$a1, $a0, 0
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
...
# %bb.34:                               # %vec.epilog.middle.block
	beq	$a4, $t3, .LBB0_37
.LBB0_35:                               # %vec.epilog.scalar.ph.preheader
	alsl.d	$a4, $t1, $t0, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a5, $t1, $a5, 2
	alsl.d	$a6, $t1, $a6, 2
...
.LBB0_43:                               # %.lr.ph.i186
	...
	move	$t4, $t8
	bnez	$t6, .LBB0_43
.LBB0_44:                               # %match_calc.exit191
                                        #   in Loop: Header=BB0_41 Depth=1
	slli.d	$s5, $t2, 2
	fldx.s	$fa3, $a1, $s5
	fst.s	$fa3, $a2, 0
	bnez	$a5, .LBB0_40
# %bb.45:                               # %.lr.ph209.preheader
                                        #   in Loop: Header=BB0_41 Depth=1
	slli.d	$t0, $t2, 3
...
.LBB0_56:
	...
	ld.d	$s3, $a0, %pc_lo12(L__align11.mseq1)
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s2, $a0, %pc_lo12(L__align11.mseq2)
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	move	$s6, $a0
...
# %bb.58:
	move	$a2, $zero
	b	.LBB0_62
.LBB0_59:                               # %vector.ph289
	bstrpick.d	$a2, $a2, 31, 3
	slli.d	$a2, $a2, 3
	addi.d	$a3, $t5, 32
	move	$a4, $a2
	.p2align	4, , 16
.LBB0_60:                               # %vector.body292
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a3, -32
	ld.d	$a6, $a3, -24
	ld.d	$a7, $a3, -16
...
# %bb.66:
	move	$a3, $zero
	b	.LBB0_76
.LBB0_67:                               # %vector.main.loop.iter.check305
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_69
# %bb.68:
	move	$a3, $zero
	b	.LBB0_73
.LBB0_69:                               # %vector.ph306
	andi	$a5, $a4, 12
...
.LBB0_70:                               # %vector.body309
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_70
# %bb.71:                               # %middle.block312
	beq	$a2, $a3, .LBB0_78
# %bb.72:                               # %vec.epilog.iter.check316
	beqz	$a5, .LBB0_76
.LBB0_73:                               # %vec.epilog.ph318
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB0_74:                               # %vec.epilog.vector.body323
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_74
# %bb.75:                               # %vec.epilog.middle.block326
	beq	$a2, $a3, .LBB0_78
.LBB0_76:                               # %vec.epilog.scalar.ph315.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB0_77:                               # %vec.epilog.scalar.ph315
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s7, $a1, 0
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 4
...
.LBB0_86:                               # %.lr.ph9.i
	...
	st.b	$a3, $t0, -1
	bnez	$a7, .LBB0_86
# %bb.87:                               # %._crit_edge10.loopexit.i
                                        #   in Loop: Header=BB0_80 Depth=1
	add.d	$a2, $s1, $a2
	add.d	$a2, $a6, $a2
.LBB0_88:                               # %._crit_edge10.i
                                        #   in Loop: Header=BB0_80 Depth=1
	add.w	$a6, $a5, $s8
	beq	$a5, $a1, .LBB0_91
# %bb.89:                               # %.lr.ph14.preheader.i
                                        #   in Loop: Header=BB0_80 Depth=1
	nor	$a5, $a5, $zero
	.p2align	4, , 16
.LBB0_90:                               # %.lr.ph14.i
