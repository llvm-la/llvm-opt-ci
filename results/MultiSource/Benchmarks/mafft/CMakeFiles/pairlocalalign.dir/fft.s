...
.LBB0_29:                               # %make_sintbl.exit
	...
	st.w	$zero, $s1, 0
	bltu	$s3, $a0, .LBB0_34
# %bb.30:                               # %.preheader.i113.preheader
	move	$a1, $zero
	ori	$a0, $zero, 1
	.p2align	4, , 16
.LBB0_31:                               # %.preheader.i113
...
# %bb.40:                               # %.lr.ph127
	...
	b	.LBB0_49
	.p2align	4, , 16
.LBB0_41:                               # %.loopexit117.us
                                        #   in Loop: Header=BB0_42 Depth=1
	move	$a2, $a3
	bge	$a3, $s3, .LBB0_55
.LBB0_42:                               # %.lr.ph127.split.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB0_45 Depth 2
                                        #       Child Loop BB0_47 Depth 3
	slli.w	$a3, $a2, 1
	blez	$a2, .LBB0_41
# %bb.43:                               # %.lr.ph125.us.preheader
                                        #   in Loop: Header=BB0_42 Depth=1
	move	$a4, $zero
	move	$a5, $zero
	move	$a6, $zero
