...
# %bb.104:                              # %.lr.ph434
	...
	addi.d	$a5, $s3, 1
	bgeu	$a1, $a3, .LBB0_128
.LBB0_105:                              # %scalar.ph674.preheader
	sub.d	$a1, $s3, $a5
	add.w	$a1, $a1, $s6
	alsl.d	$a3, $a5, $a2, 3
	sub.d	$a4, $s8, $a5
	.p2align	4, , 16
.LBB0_106:                              # %scalar.ph674
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a5, $a1, 4
	fldx.d	$fa0, $a0, $a5
	fst.d	$fa0, $a3, 0
...
.LBB0_123:                              # %vector.body699
	...
	xvaddi.du	$xr0, $xr0, 8
	bne	$a6, $a5, .LBB0_123
# %bb.124:                              # %middle.block705
	ori	$s0, $zero, 1
	beq	$a4, $s8, .LBB0_136
.LBB0_125:                              # %scalar.ph694.preheader
	slli.d	$a5, $a4, 3
	slli.d	$a6, $a4, 5
	alsl.d	$a6, $a4, $a6, 4
	add.d	$a3, $a3, $a6
...
.LBB0_140:                              # %vector.body713
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_140
# %bb.141:                              # %middle.block717
	ld.d	$s4, $sp, 104                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB0_144
.LBB0_142:                              # %scalar.ph708.preheader
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a3, $a0, $a1
	.p2align	4, , 16
.LBB0_143:                              # %scalar.ph708
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	st.w	$a1, $a4, 40
	addi.d	$a1, $a1, 1
...
.LBB0_147:                              # %vector.body725
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_147
# %bb.148:                              # %middle.block730
	ld.d	$s4, $sp, 104                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB0_151
.LBB0_149:                              # %scalar.ph720.preheader
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a0, $a0, $a1
	.p2align	4, , 16
.LBB0_150:                              # %scalar.ph720
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	st.w	$a1, $a3, 40
	addi.d	$a1, $a1, 1
...
.LJTI0_0:
	...
	.word	.LBB0_181-.LJTI0_0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function mymergesort
...
# %bb.6:                                # %.lr.ph
	...
	ld.d	$a3, $a0, %pc_lo12(mymergesort.work)
	sub.d	$a1, $s3, $s0
	addi.d	$a1, $a1, 1
	ori	$a2, $zero, 8
	bltu	$a1, $a2, .LBB1_8
...
.LBB3_240:                              # %.lr.ph588
	...
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a2, $a2, %pc_lo12(Falign_noudp.cut2)
	ld.d	$a5, $a4, 0
	st.w	$zero, $a0, 0
	st.w	$zero, $a2, 0
	ld.w	$a3, $a5, 8
...
# %bb.146:                              # %.lr.ph502
	...
	addi.d	$a5, $s4, 1
	bgeu	$a1, $a3, .LBB4_258
.LBB4_147:                              # %scalar.ph809.preheader
	sub.d	$a1, $s4, $a5
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	add.w	$a1, $a1, $a3
	alsl.d	$a3, $a5, $a2, 3
...
.LBB4_157:                              # %vector.body834
	...
	xvaddi.du	$xr0, $xr0, 8
	bne	$a6, $a5, .LBB4_157
# %bb.158:                              # %middle.block840
	ori	$s6, $zero, 1
	beq	$a4, $s3, .LBB4_163
.LBB4_159:                              # %scalar.ph829.preheader
	slli.d	$a5, $a4, 3
	slli.d	$a6, $a4, 5
	alsl.d	$a6, $a4, $a6, 4
	add.d	$a3, $a3, $a6
...
.LBB4_169:                              # %vector.body848
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_169
# %bb.170:                              # %middle.block852
	ld.d	$s4, $sp, 240                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB4_173
.LBB4_171:                              # %scalar.ph843.preheader
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a3, $a0, $a1
	.p2align	4, , 16
.LBB4_172:                              # %scalar.ph843
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	st.w	$a1, $a4, 40
	addi.d	$a1, $a1, 1
...
.LBB4_173:                              # %.lr.ph520
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $a1, %pc_lo12(Falign_udpari_long.sortedseg2)
	ori	$a1, $zero, 8
	bgeu	$s3, $a1, .LBB4_175
# %bb.174:
	move	$a1, $zero
	b	.LBB4_178
.LBB4_175:                              # %vector.ph857
	move	$a3, $zero
	bstrpick.d	$a1, $a0, 30, 3
	slli.d	$a1, $a1, 3
	addi.d	$a4, $a2, 32
...
.LBB4_176:                              # %vector.body860
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_176
# %bb.177:                              # %middle.block865
	ld.d	$s4, $sp, 240                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB4_180
.LBB4_178:                              # %scalar.ph855.preheader
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a0, $a0, $a1
	.p2align	4, , 16
.LBB4_179:                              # %scalar.ph855
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	st.w	$a1, $a3, 40
	addi.d	$a1, $a1, 1
...
# %bb.213:                              # %.lr.ph541
	...
	b	.LBB4_215
	.p2align	4, , 16
.LBB4_214:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $s7, %pc_lo12(Falign_udpari_long.sgap1)
...
# %bb.219:                              # %.lr.ph545
	...
	b	.LBB4_221
	.p2align	4, , 16
.LBB4_220:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Falign_udpari_long.egap1)
...
# %bb.222:                              # %.lr.ph548
	...
	.p2align	4, , 16
.LBB4_223:                              #   Parent Loop BB4_209 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s4, 0
	ld.w	$a2, $s7, 0
	ld.w	$a3, $s8, 0
	...
	addi.d	$fp, $fp, 8
	bnez	$s5, .LBB4_223
.LBB4_224:                              # %._crit_edge549
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	ld.d	$s4, $sp, 240                   # 8-byte Folded Reload
	beqz	$a0, .LBB4_227
# %bb.225:                              # %._crit_edge549
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	beqz	$a0, .LBB4_227
# %bb.226:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a1, $a0, %pc_lo12(Falign_udpari_long.tmpres1)
	move	$a0, $s4
	pcaddu18i	$ra, %call36(commongappick)
	jirl	$ra, $ra, 0
.LBB4_227:                              #   in Loop: Header=BB4_209 Depth=1
	move	$s8, $s2
	ld.d	$s5, $sp, 232                   # 8-byte Folded Reload
	blez	$s5, .LBB4_232
# %bb.228:                              # %.lr.ph552.preheader
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
...
# %bb.231:                              #   in Loop: Header=BB4_230 Depth=2
	...
	b	.LBB4_229
	.p2align	4, , 16
.LBB4_232:                              # %._crit_edge553
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	ld.d	$s2, $sp, 272                   # 8-byte Folded Reload
	beqz	$a0, .LBB4_235
# %bb.233:                              # %._crit_edge553
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	beqz	$a0, .LBB4_235
# %bb.234:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a1, $s2, %pc_lo12(Falign_udpari_long.tmpres2)
	move	$a0, $s5
	pcaddu18i	$ra, %call36(commongappick)
	jirl	$ra, $ra, 0
.LBB4_235:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	...
	bnez	$a0, .LBB4_269
# %bb.236:                              #   in Loop: Header=BB4_209 Depth=1
	pcalau12i	$a0, %got_pc_hi20(alg)
	ld.d	$a0, $a0, %got_pc_lo12(alg)
	ld.bu	$a1, $a0, 0
	ori	$a0, $zero, 77
	bne	$a1, $a0, .LBB4_246
# %bb.237:                              #   in Loop: Header=BB4_209 Depth=1
	...
	jirl	$ra, $ra, 0
	fadd.s	$fs0, $fs0, $fa0
.LBB4_238:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $s1, %pc_lo12(Falign_udpari_long.tmpres1)
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	...
	add.w	$s1, $a2, $a0
	blt	$fp, $s1, .LBB4_247
# %bb.239:                              #   in Loop: Header=BB4_209 Depth=1
	blez	$s4, .LBB4_242
.LBB4_240:                              # %.lr.ph556
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	...
	ld.d	$s3, $sp, 256                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_241:                              #   Parent Loop BB4_209 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $fp, 0
	ld.d	$a1, $s2, 0
	pcaddu18i	$ra, %call36(strcat)
...
# %bb.243:                              # %.lr.ph558
	...
	ld.d	$s3, $sp, 168                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_244:                              #   Parent Loop BB4_209 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $fp, 0
	ld.d	$a1, $s2, 0
	pcaddu18i	$ra, %call36(strcat)
...
.LBB4_245:                              # %.loopexit
	...
	blt	$s8, $a0, .LBB4_209
	b	.LBB4_249
.LBB4_246:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ext.w.b	$a2, $a1
	pcalau12i	$a1, %pc_hi20(.L.str.7)
	...
	jirl	$ra, $ra, 0
	b	.LBB4_238
.LBB4_247:                              #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	addi.w	$a3, $a1, 0
...
# %bb.259:                              # %vector.scevcheck
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB4_147
# %bb.260:                              # %vector.memcheck799
	alsl.d	$a4, $s4, $a2, 3
	addi.d	$a4, $a4, 8
	alsl.d	$a6, $a3, $a0, 4
	addi.d	$a6, $a6, 8
	bgeu	$a4, $a6, .LBB4_262
# %bb.261:                              # %vector.memcheck799
	alsl.d	$a4, $s3, $a2, 3
	add.d	$a3, $s4, $a3
	sub.d	$a3, $a3, $s3
	alsl.d	$a3, $a3, $a0, 4
