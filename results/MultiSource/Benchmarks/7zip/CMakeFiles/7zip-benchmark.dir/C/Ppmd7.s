...
# %bb.18:
	...
	ldx.bu	$t3, $a6, $a5
	bne	$t0, $t3, .LBB7_20
# %bb.19:                               # %.ShrinkUnits.exit_crit_edge
	ld.d	$a6, $a0, 64
	b	.LBB7_28
.LBB7_20:
	addi.d	$a5, $a0, 276
...
.LBB11_23:                              # %.lr.ph
	...
	b	.LBB11_26
	.p2align	4, , 16
.LBB11_24:                              #   in Loop: Header=BB11_26 Depth=1
	alsl.w	$a5, $a3, $a3, 3
	addi.w	$a4, $a4, 0
	sltu	$a5, $a4, $a5
	xori	$a5, $a5, 5
...
# %bb.27:                               #   in Loop: Header=BB11_26 Depth=1
	ld.wu	$a0, $s5, 0
	beqz	$a0, .LBB11_33
# %bb.28:                               # %AllocUnits.exit207.thread
                                        #   in Loop: Header=BB11_26 Depth=1
	ldx.w	$a1, $a2, $a0
	add.d	$a0, $a2, $a0
	st.w	$a1, $s5, 0
...
.LBB11_29:                              #   in Loop: Header=BB11_26 Depth=1
	andi	$a0, $s0, 1
	bnez	$a0, .LBB11_46
# %bb.30:                               #   in Loop: Header=BB11_26 Depth=1
	srli.d	$s4, $s0, 1
	addi.d	$a0, $s4, -1
...
# %bb.32:                               # %AllocUnits.exit.thread
	...
	st.w	$a3, $a1, 0
	b	.LBB11_43
.LBB11_33:                              #   in Loop: Header=BB11_26 Depth=1
	ld.bu	$a1, $fp, 108
	ld.d	$a2, $fp, 80
	ld.d	$a0, $fp, 72
	slli.d	$a3, $a1, 3
	...
	sub.w	$a2, $a2, $a0
	bgeu	$a2, $a1, .LBB11_35
# %bb.34:                               #   in Loop: Header=BB11_26 Depth=1
	move	$a0, $fp
	move	$a1, $zero
	move	$s4, $t0
	...
	addi.d	$a7, $fp, 146
	b	.LBB11_36
.LBB11_35:                              #   in Loop: Header=BB11_26 Depth=1
	add.d	$a1, $a0, $a1
	st.d	$a1, $fp, 72
.LBB11_36:                              # %AllocUnits.exit207
                                        #   in Loop: Header=BB11_26 Depth=1
	beqz	$a0, .LBB11_49
.LBB11_37:                              #   in Loop: Header=BB11_26 Depth=1
	ld.h	$a1, $s2, 6
	st.h	$a1, $a0, 4
	ld.w	$a1, $s2, 2
	st.w	$a1, $a0, 0
	...
	add.w	$a0, $a1, $a0
	b	.LBB11_47
.LBB11_38:                              #   in Loop: Header=BB11_26 Depth=1
	addi.d	$a0, $fp, 108
	ldx.bu	$a2, $a0, $a1
	ld.d	$a3, $fp, 80
	ld.d	$a0, $fp, 72
	...
	sub.w	$a3, $a3, $a0
	bgeu	$a3, $a2, .LBB11_40
# %bb.39:                               #   in Loop: Header=BB11_26 Depth=1
	move	$a0, $fp
	...
	addi.d	$a7, $fp, 146
	b	.LBB11_41
.LBB11_40:                              #   in Loop: Header=BB11_26 Depth=1
	add.d	$a1, $a0, $a2
	st.d	$a1, $fp, 72
.LBB11_41:                              # %AllocUnits.exit
                                        #   in Loop: Header=BB11_26 Depth=1
	beqz	$a0, .LBB11_49
# %bb.42:                               # %AllocUnits.exit._crit_edge
                                        #   in Loop: Header=BB11_26 Depth=1
	ld.d	$a2, $fp, 64
.LBB11_43:                              #   in Loop: Header=BB11_26 Depth=1
	ld.wu	$a1, $s2, 4
	move	$a3, $a1
	move	$a4, $a0
	.p2align	4, , 16
.LBB11_44:                              #   Parent Loop BB11_26 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	add.d	$a6, $a2, $a3
	st.w	$a5, $a4, 0
	...
	addi.d	$a3, $a3, 12
	bnez	$s4, .LBB11_44
# %bb.45:                               #   in Loop: Header=BB11_26 Depth=1
	slli.d	$a3, $s7, 2
	ldx.w	$a4, $s5, $a3
	stx.w	$a4, $a2, $a1
	stx.w	$a1, $s5, $a3
...
.LBB11_46:                              # %.critedge
	...
	and	$a0, $a3, $a0
	alsl.d	$a0, $a0, $a1, 1
.LBB11_47:                              #   in Loop: Header=BB11_26 Depth=1
	ld.d	$a1, $fp, 16
	ld.bu	$a3, $a1, 1
	...
	mul.d	$a5, $a3, $t3
	bgeu	$a4, $a5, .LBB11_24
# %bb.48:                               #   in Loop: Header=BB11_26 Depth=1
	addi.w	$a4, $a4, 0
	addi.w	$a5, $a3, 0
	sltu	$a5, $a5, $a4
	slli.w	$a3, $a3, 2
...
.LBB12_20:
	...
	b	.LBB12_23
	.p2align	4, , 16
.LBB12_21:                              #   in Loop: Header=BB12_23 Depth=1
	addi.d	$a0, $a0, -12
	st.d	$a0, $fp, 80
...
.LBB13_20:
	...
	add.d	$a4, $a0, $a7
	bne	$a6, $t1, .LBB13_25
# %bb.21:                               # %.SplitBlock.exit_crit_edge
	add.d	$a3, $a7, $a3
	b	.LBB13_26
.LBB13_22:                              # %._crit_edge113.i
	ld.w	$t4, $a6, 4
	bne	$t4, $a3, .LBB13_27
.LBB13_23:                              # %GlueFreeBlocks.exit
	slli.d	$a3, $a1, 2
	ldx.wu	$a3, $a2, $a3
	beqz	$a3, .LBB13_1
# %bb.24:
...
.LBB13_27:                              # %.lr.ph124.i
	...
	b	.LBB13_29
	.p2align	4, , 16
.LBB13_28:                              # %._crit_edge118._crit_edge.i
