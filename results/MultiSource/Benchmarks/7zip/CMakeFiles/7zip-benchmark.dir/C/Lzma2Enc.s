...
# %bb.3:                                # %vector.body.interim.1
	...
	vld	$vr1, $a1, %pc_lo12(.LCPI5_5)
	vld	$vr2, $a0, %pc_lo12(.LCPI5_4)
	vslt.wu	$vr1, $vr0, $vr1
	vslt.wu	$vr2, $vr0, $vr2
	vpickev.h	$vr1, $vr2, $vr1
	vmskltz.h	$vr2, $vr1
...
# %bb.5:                                # %vector.body.interim.3
	...
	pcalau12i	$a1, %pc_hi20(.LCPI5_9)
	vld	$vr1, $a1, %pc_lo12(.LCPI5_9)
	vld	$vr2, $a0, %pc_lo12(.LCPI5_8)
	vslt.wu	$vr1, $vr0, $vr1
	vslt.wu	$vr0, $vr0, $vr2
	...
	ori	$a0, $zero, 32
	beqz	$a1, .LBB5_7
.LBB5_6:                                # %vector.early.exit
	pcalau12i	$a1, %pc_hi20(.LCPI5_10)
	vld	$vr0, $a1, %pc_lo12(.LCPI5_10)
	vslli.h	$vr1, $vr1, 15
	vsrai.h	$vr1, $vr1, 15
	vand.v	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 8
...
.Lfunc_end6:
	.size	Lzma2Enc_Encode, .Lfunc_end6-Lzma2Enc_Encode
                                        # -- End function
	.p2align	2                               # -- Begin function MtCallbackImp_Code
...
.Lfunc_end7:
	.size	MtCallbackImp_Code, .Lfunc_end7-MtCallbackImp_Code
                                        # -- End function
	.p2align	2                               # -- Begin function Lzma2EncInt_EncodeSubblock
