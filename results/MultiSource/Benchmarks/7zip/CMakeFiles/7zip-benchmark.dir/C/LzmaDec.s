...
.LBB2_36:                               # %vector.body330
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB2_36
# %bb.37:                               # %vec.epilog.vector.body343
                                        #   in Loop: Header=BB2_17 Depth=1
	slli.d	$a2, $a2, 1
	xvstx	$xr0, $a0, $a2
	alsl.d	$a0, $a1, $a0, 1
...
# %bb.51:                               #   in Loop: Header=BB2_17 Depth=1
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB2_73
.LBB2_52:                               #   in Loop: Header=BB2_17 Depth=1
	st.d	$s6, $s0, 32
	move	$a0, $s0
	move	$a1, $s5
	move	$a2, $s6
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB2_70
# %bb.53:                               #   in Loop: Header=BB2_17 Depth=1
	ld.d	$a0, $s0, 32
	sub.d	$a0, $a0, $s6
	ld.d	$a2, $s1, 0
	sub.d	$a1, $s7, $s3
...
# %bb.55:                               #   in Loop: Header=BB2_17 Depth=1
	bltu	$s8, $s5, .LBB2_13
.LBB2_56:                               #   in Loop: Header=BB2_17 Depth=1
	move	$a0, $s0
	move	$a1, $s4
	move	$a2, $s2
	pcaddu18i	$ra, %call36(LzmaDec_TryDummy)
...
# %bb.58:                               #   in Loop: Header=BB2_17 Depth=1
	...
	beq	$a0, $a1, .LBB2_14
	b	.LBB2_73
.LBB2_59:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB2_17 Depth=1
	bgeu	$a1, $a2, .LBB2_61
...
# %bb.63:                               # %middle.block
                                        #   in Loop: Header=BB2_17 Depth=1
	bne	$a1, $s7, .LBB2_65
# %bb.64:                               #   in Loop: Header=BB2_17 Depth=1
	addi.d	$a1, $a3, -113
	sltui	$a1, $a1, 19
	b	.LBB2_46
.LBB2_65:                               # %vec.epilog.iter.check
                                        #   in Loop: Header=BB2_17 Depth=1
	beqz	$a2, .LBB2_44
.LBB2_66:                               # %vec.epilog.ph
                                        #   in Loop: Header=BB2_17 Depth=1
	move	$a5, $s7
	move	$s7, $a1
	...
	add.d	$a5, $s4, $a5
	.p2align	4, , 16
.LBB2_67:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB2_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	st.w	$a6, $a3, 0
...
# %bb.68:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB2_17 Depth=1
	bne	$a1, $s7, .LBB2_44
# %bb.69:                               #   in Loop: Header=BB2_17 Depth=1
	sltui	$a1, $a2, 19
	b	.LBB2_46
.LBB2_70:
	ori	$a0, $zero, 1
...
.Lfunc_end2:
	.size	LzmaDec_DecodeToDic, .Lfunc_end2-LzmaDec_DecodeToDic
                                        # -- End function
	.p2align	2                               # -- Begin function LzmaDec_TryDummy
...
.Lfunc_end3:
	.size	LzmaDec_TryDummy, .Lfunc_end3-LzmaDec_TryDummy
                                        # -- End function
	.p2align	2                               # -- Begin function LzmaDec_DecodeReal2
...
# %bb.110:                              #   in Loop: Header=BB4_4 Depth=2
	move	$t5, $zero
	b	.LBB4_129
.LBB4_111:                              #   in Loop: Header=BB4_4 Depth=2
	sub.w	$a6, $a6, $a4
	sub.w	$s3, $s3, $a4
	srli.d	$a4, $a1, 5
	sub.d	$a1, $a1, $a4
	...
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	b	.LBB4_140
.LBB4_112:                              #   in Loop: Header=BB4_4 Depth=2
	sub.w	$a1, $a1, $a6
	sub.w	$s3, $s3, $a6
	srli.d	$a6, $t2, 5
	sub.d	$a6, $t2, $a6
	...
	st.h	$a6, $a3, 0
	bnez	$t2, .LBB4_114
# %bb.113:                              #   in Loop: Header=BB4_4 Depth=2
	ld.bu	$a3, $t1, 0
	slli.d	$a1, $a1, 8
	slli.w	$a6, $s3, 8
	addi.d	$t1, $t1, 1
...
# %bb.131:                              # %vec.epilog.middle.block
                                        #   in Loop: Header=BB4_4 Depth=2
	beq	$s1, $t7, .LBB4_134
.LBB4_132:                              # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$a3, $a3, $s1
	.p2align	4, , 16
.LBB4_133:                              # %vec.epilog.scalar.ph
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.b	$t5, $a6, $a1
	...
	addi.d	$a6, $a6, 1
	bne	$a6, $a3, .LBB4_133
.LBB4_134:                              # %.loopexit1142.loopexit1156.i
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$t4, $s1, $t4
.LBB4_135:                              # %.loopexit1142.i
                                        #   in Loop: Header=BB4_4 Depth=2
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
