...
.Lfunc_end13:
	.size	Bt3Zip_MatchFinder_GetMatches, .Lfunc_end13-Bt3Zip_MatchFinder_GetMatches
                                        # -- End function
	.p2align	2                               # -- Begin function MatchFinder_CheckLimits
...
# %bb.14:                               # %.thread.i
	...
	sub.w	$t6, $a5, $t7
	bltu	$t6, $t0, .LBB15_5
.LBB15_15:                              # %Hc_GetMatchesSpec.exit
	ld.w	$a2, $a0, 24
	sub.d	$a1, $t2, $a1
	srli.d	$fp, $a1, 2
	addi.d	$a1, $a2, 1
	...
	st.w	$a1, $a0, 8
	bne	$a1, $a3, .LBB15_17
.LBB15_16:                              # %MatchFinder_MovePos.exit.sink.split
	pcaddu18i	$ra, %call36(MatchFinder_CheckLimits)
	jirl	$ra, $ra, 0
.LBB15_17:                              # %MatchFinder_MovePos.exit
	addi.w	$a0, $fp, 0
...
.LBB16_15:                              #   in Loop: Header=BB16_8 Depth=2
	...
	bltu	$t4, $a7, .LBB16_8
	.p2align	4, , 16
.LBB16_16:                              # %._crit_edge.i
                                        #   in Loop: Header=BB16_3 Depth=1
	move	$a1, $zero
	st.w	$zero, $a3, 0
	b	.LBB16_18
	.p2align	4, , 16
.LBB16_17:                              # %.preheader.i.preheader._crit_edge
                                        #   in Loop: Header=BB16_3 Depth=1
	ld.w	$a1, $t4, 0
	st.w	$a1, $a3, 0
	ld.w	$a1, $t4, 4
...
.Lfunc_end18:
	.size	MatchFinder_CreateVTable, .Lfunc_end18-MatchFinder_CreateVTable
                                        # -- End function
	.p2align	2                               # -- Begin function Hc4_MatchFinder_GetMatches
...
# %bb.28:                               # %.thread.i
	...
	sub.w	$t6, $t0, $t7
	bltu	$t6, $t3, .LBB19_19
.LBB19_29:                              # %Hc_GetMatchesSpec.exit
	ld.w	$a2, $a0, 24
	sub.d	$a1, $a6, $a1
	srli.d	$fp, $a1, 2
	addi.d	$a1, $a2, 1
.LBB19_30:                              # %Hc_GetMatchesSpec.exit
	...
	st.w	$a1, $a0, 8
	bne	$a1, $a3, .LBB19_32
.LBB19_31:                              # %MatchFinder_MovePos.exit.sink.split
	pcaddu18i	$ra, %call36(MatchFinder_CheckLimits)
	jirl	$ra, $ra, 0
.LBB19_32:                              # %MatchFinder_MovePos.exit
	addi.w	$a0, $fp, 0
	ld.d	$s3, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
...
.Lfunc_end19:
	.size	Hc4_MatchFinder_GetMatches, .Lfunc_end19-Hc4_MatchFinder_GetMatches
                                        # -- End function
	.p2align	2                               # -- Begin function Hc4_MatchFinder_Skip
...
.Lfunc_end20:
	.size	Hc4_MatchFinder_Skip, .Lfunc_end20-Hc4_MatchFinder_Skip
                                        # -- End function
	.p2align	2                               # -- Begin function Bt2_MatchFinder_GetMatches
...
.Lfunc_end21:
	.size	Bt2_MatchFinder_GetMatches, .Lfunc_end21-Bt2_MatchFinder_GetMatches
                                        # -- End function
	.p2align	2                               # -- Begin function Bt2_MatchFinder_Skip
...
.LBB22_14:                              #   in Loop: Header=BB22_8 Depth=2
	...
	addi.w	$t0, $t0, -1
	beqz	$t0, .LBB22_16
.LBB22_15:                              #   in Loop: Header=BB22_8 Depth=2
	ld.w	$t1, $t4, 0
	sub.w	$t4, $a4, $t1
	bltu	$t4, $a7, .LBB22_8
	.p2align	4, , 16
.LBB22_16:                              # %._crit_edge.i
                                        #   in Loop: Header=BB22_3 Depth=1
	move	$a2, $zero
	st.w	$zero, $a3, 0
	b	.LBB22_18
	.p2align	4, , 16
.LBB22_17:                              # %.preheader.i.preheader._crit_edge
                                        #   in Loop: Header=BB22_3 Depth=1
	ld.w	$a2, $t4, 0
	st.w	$a2, $a3, 0
	ld.w	$a2, $t4, 4
...
.Lfunc_end22:
	.size	Bt2_MatchFinder_Skip, .Lfunc_end22-Bt2_MatchFinder_Skip
                                        # -- End function
	.p2align	2                               # -- Begin function Bt3_MatchFinder_GetMatches
...
# %bb.34:                               #   in Loop: Header=BB23_28 Depth=1
	move	$s3, $a3
	.p2align	4, , 16
.LBB23_35:                              # %.loopexit.i83
                                        #   in Loop: Header=BB23_28 Depth=1
	bgeu	$a6, $s3, .LBB23_38
.LBB23_36:                              #   in Loop: Header=BB23_28 Depth=1
	st.w	$s3, $t2, 0
	addi.d	$fp, $fp, -1
	addi.d	$a6, $t2, 8
	st.w	$fp, $t2, 4
...
.LBB23_39:                              #   in Loop: Header=BB23_28 Depth=1
	...
	ldx.bu	$fp, $a4, $fp
	bgeu	$s1, $fp, .LBB23_26
# %bb.40:                               #   in Loop: Header=BB23_28 Depth=1
	st.w	$a5, $t1, 0
	addi.d	$t1, $s0, 4
	move	$t8, $s2
	move	$s0, $t1
...
.LBB23_41:                              #   in Loop: Header=BB23_28 Depth=1
	...
	bltu	$a6, $s3, .LBB23_36
	b	.LBB23_38
.LBB23_42:                              # %._crit_edge.i77
	move	$a3, $zero
	st.w	$zero, $t1, 0
	move	$a6, $t2
.LBB23_43:                              # %GetMatchesSpec1.exit
	st.w	$a3, $t0, 0
	ld.w	$a3, $a0, 24
	sub.d	$a1, $a6, $a1
	srli.d	$fp, $a1, 2
...
.LBB23_45:
	...
	ld.w	$a3, $s0, 4
	b	.LBB23_43
.LBB23_46:                              # %.preheader.i.preheader._crit_edge
	ld.w	$a3, $t6, 0
	st.w	$a3, $a6, 0
	ld.w	$a3, $t6, 4
.LBB23_47:                              # %SkipMatchesSpec.exit
	st.w	$a3, $a1, 0
	ld.w	$a1, $a0, 24
	addi.d	$a1, $a1, 1
	ld.w	$a3, $a0, 8
...
.Lfunc_end23:
	.size	Bt3_MatchFinder_GetMatches, .Lfunc_end23-Bt3_MatchFinder_GetMatches
                                        # -- End function
	.p2align	2                               # -- Begin function Bt3_MatchFinder_Skip
...
.LBB24_10:                              # %.lr.ph
	...
	bne	$t7, $t8, .LBB24_12
# %bb.11:                               # %.preheader.i
                                        #   in Loop: Header=BB24_10 Depth=3
	addi.w	$t5, $t5, 1
	bne	$a1, $t5, .LBB24_10
	b	.LBB24_17
	.p2align	4, , 16
...
.LBB24_14:                              #   in Loop: Header=BB24_8 Depth=2
	...
	addi.w	$t0, $t0, -1
	beqz	$t0, .LBB24_16
.LBB24_15:                              #   in Loop: Header=BB24_8 Depth=2
	ld.w	$t1, $t4, 0
	sub.w	$t4, $a5, $t1
	bltu	$t4, $a7, .LBB24_8
	.p2align	4, , 16
.LBB24_16:                              # %._crit_edge.i
                                        #   in Loop: Header=BB24_3 Depth=1
	move	$a1, $zero
	st.w	$zero, $a3, 0
	b	.LBB24_18
	.p2align	4, , 16
.LBB24_17:                              # %.preheader.i.preheader._crit_edge
                                        #   in Loop: Header=BB24_3 Depth=1
	ld.w	$a1, $t4, 0
	st.w	$a1, $a3, 0
	ld.w	$a1, $t4, 4
...
.Lfunc_end24:
	.size	Bt3_MatchFinder_Skip, .Lfunc_end24-Bt3_MatchFinder_Skip
                                        # -- End function
	.p2align	2                               # -- Begin function Bt4_MatchFinder_GetMatches
...
# %bb.35:                               #   in Loop: Header=BB25_33 Depth=1
	...
	move	$s3, $s4
	bne	$s5, $s6, .LBB25_40
# %bb.36:                               # %.preheader.i117.preheader
...
.LBB25_37:                              # %.lr.ph212
	...
	ldx.bu	$s3, $a4, $s3
	bne	$s4, $s3, .LBB25_48
# %bb.38:                               # %.preheader.i117
                                        #   in Loop: Header=BB25_37 Depth=2
	addi.w	$s2, $s2, 1
	bne	$a2, $s2, .LBB25_37
# %bb.39:                               #   in Loop: Header=BB25_33 Depth=1
	move	$s3, $a2
	.p2align	4, , 16
.LBB25_40:                              # %.loopexit.i115
                                        #   in Loop: Header=BB25_33 Depth=1
	bgeu	$t1, $s3, .LBB25_43
.LBB25_41:                              #   in Loop: Header=BB25_33 Depth=1
	st.w	$s3, $t0, 0
	addi.d	$fp, $fp, -1
	addi.d	$t1, $t0, 8
	st.w	$fp, $t0, 4
...
# %bb.42:                               #   in Loop: Header=BB25_33 Depth=1
	move	$t0, $t1
	move	$t1, $s3
.LBB25_43:                              #   in Loop: Header=BB25_33 Depth=1
	move	$s2, $s3
.LBB25_44:                              #   in Loop: Header=BB25_33 Depth=1
	bstrpick.d	$fp, $s2, 31, 0
	ldx.bu	$s1, $s1, $fp
	ldx.bu	$fp, $a4, $fp
	bgeu	$s1, $fp, .LBB25_46
# %bb.45:                               #   in Loop: Header=BB25_33 Depth=1
	st.w	$a5, $a7, 0
	addi.d	$a7, $s0, 4
	move	$t8, $s2
	move	$s0, $a7
	...
	b	.LBB25_49
	.p2align	4, , 16
.LBB25_46:                              #   in Loop: Header=BB25_33 Depth=1
	st.w	$a5, $a6, 0
	move	$a6, $s0
	move	$t7, $s2
	addi.w	$t6, $t6, -1
	beqz	$t6, .LBB25_49
.LBB25_47:                              #   in Loop: Header=BB25_33 Depth=1
	ld.w	$a5, $s0, 0
	sub.w	$fp, $t2, $a5
	bltu	$fp, $t5, .LBB25_33
	b	.LBB25_49
...
.LBB25_50:                              # %GetMatchesSpec1.exit
	...
	addi.d	$a1, $a2, 1
	b	.LBB25_53
.LBB25_51:                              # %.preheader.i.preheader._crit_edge
	ld.w	$a2, $t6, 0
	st.w	$a2, $a6, 0
	ld.w	$a2, $t6, 4
...
.Lfunc_end25:
	.size	Bt4_MatchFinder_GetMatches, .Lfunc_end25-Bt4_MatchFinder_GetMatches
                                        # -- End function
	.p2align	2                               # -- Begin function Bt4_MatchFinder_Skip
...
.LBB26_12:                              # %.loopexit.i
                                        #   in Loop: Header=BB26_8 Depth=2
	bgeu	$t7, $t8, .LBB26_14
# %bb.13:                               #   in Loop: Header=BB26_8 Depth=2
	st.w	$t1, $a3, 0
	addi.d	$a3, $t4, 4
	move	$t3, $t5
	move	$t4, $a3
...
.LBB26_14:                              #   in Loop: Header=BB26_8 Depth=2
	...
	addi.w	$t0, $t0, -1
	beqz	$t0, .LBB26_16
.LBB26_15:                              #   in Loop: Header=BB26_8 Depth=2
	ld.w	$t1, $t4, 0
	sub.w	$t4, $a4, $t1
	bltu	$t4, $a7, .LBB26_8
	.p2align	4, , 16
.LBB26_16:                              # %._crit_edge.i
	...
	b	.LBB26_18
	.p2align	4, , 16
.LBB26_17:                              # %.preheader.i.preheader._crit_edge
                                        #   in Loop: Header=BB26_3 Depth=1
	ld.w	$a1, $t4, 0
	st.w	$a1, $a3, 0
	ld.w	$a1, $t4, 4
