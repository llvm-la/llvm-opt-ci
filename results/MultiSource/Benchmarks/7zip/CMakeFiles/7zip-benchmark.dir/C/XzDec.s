...
# %bb.6:                                #   in Loop: Header=BB12_5 Depth=2
	...
	addi.w	$t1, $s8, 1
	bltz	$t0, .LBB12_5
# %bb.7:                                # %.split.loop.exit18.i118
                                        #   in Loop: Header=BB12_4 Depth=1
	beqz	$a3, .LBB12_9
# %bb.8:                                # %.split.loop.exit18.i118
                                        #   in Loop: Header=BB12_4 Depth=1
	andi	$a4, $t0, 255
	beqz	$a4, .LBB12_32
...
# %bb.11:                               #   in Loop: Header=BB12_10 Depth=2
	...
	addi.d	$a5, $a5, 1
	bltz	$a3, .LBB12_10
# %bb.12:                               # %.split.loop.exit18.i125
                                        #   in Loop: Header=BB12_4 Depth=1
	beq	$a4, $s7, .LBB12_14
# %bb.13:                               # %.split.loop.exit18.i125
                                        #   in Loop: Header=BB12_4 Depth=1
	andi	$a1, $a3, 255
	beqz	$a1, .LBB12_32
...
# %bb.22:                               #   in Loop: Header=BB12_21 Depth=1
	...
	addi.w	$a1, $a1, 1
	bltz	$a7, .LBB12_21
# %bb.23:                               # %.split.loop.exit18.i
	ori	$a5, $zero, 7
	beq	$a4, $a5, .LBB12_25
# %bb.24:                               # %.split.loop.exit18.i
	andi	$a4, $a7, 255
	beqz	$a4, .LBB12_32
.LBB12_25:
	beqz	$a3, .LBB12_32
...
# %bb.29:                               #   in Loop: Header=BB12_28 Depth=1
	...
	addi.w	$a1, $a1, 1
	bltz	$a7, .LBB12_28
# %bb.30:                               # %.split.loop.exit18.i111
	ori	$a4, $zero, 7
	beq	$a3, $a4, .LBB12_3
# %bb.31:                               # %.split.loop.exit18.i111
	andi	$a3, $a7, 255
	bnez	$a3, .LBB12_3
.LBB12_32:                              # %.critedge
