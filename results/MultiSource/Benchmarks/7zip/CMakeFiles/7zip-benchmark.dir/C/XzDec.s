...
.Lfunc_end4:
	.size	BraState_SetFromMethod, .Lfunc_end4-BraState_SetFromMethod
                                        # -- End function
	.p2align	2                               # -- Begin function BraState_Code
...
.LBB7_5:                                # =>This Inner Loop Header: Depth=1
	bge	$s1, $a2, .LBB7_7
# %bb.6:                                # %.lr.ph.splitthread-pre-split
...
.LBB9_7:
	ori	$a0, $zero, 2
.LBB9_8:                                # %Lzma2State_SetFromMethod.exit
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 32
...
.LBB10_14:                              #   in Loop: Header=BB10_5 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB10_4
.LBB10_15:                              # %.lr.ph.peel.next.preheader
                                        #   in Loop: Header=BB10_5 Depth=1
	move	$s2, $zero
	ori	$s1, $zero, 1
	addi.d	$fp, $s5, 184
...
# %bb.7:                                #   in Loop: Header=BB12_6 Depth=2
	...
	bne	$t1, $t0, .LBB12_6
	b	.LBB12_37
.LBB12_8:                               # %.split.loop.exit18.i118
                                        #   in Loop: Header=BB12_4 Depth=1
	beqz	$a7, .LBB12_10
# %bb.9:                                # %.split.loop.exit18.i118
                                        #   in Loop: Header=BB12_4 Depth=1
	andi	$a5, $t2, 255
	beqz	$a5, .LBB12_36
...
# %bb.13:                               #   in Loop: Header=BB12_12 Depth=2
	...
	bne	$a4, $a1, .LBB12_12
	b	.LBB12_37
.LBB12_14:                              # %.split.loop.exit18.i125
                                        #   in Loop: Header=BB12_4 Depth=1
	beqz	$a1, .LBB12_16
# %bb.15:                               # %.split.loop.exit18.i125
                                        #   in Loop: Header=BB12_4 Depth=1
	andi	$a0, $a6, 255
	beqz	$a0, .LBB12_36
...
# %bb.25:                               #   in Loop: Header=BB12_24 Depth=1
	...
	bne	$a6, $a4, .LBB12_24
	b	.LBB12_36
.LBB12_26:                              # %.split.loop.exit18.i
	beqz	$a4, .LBB12_28
# %bb.27:                               # %.split.loop.exit18.i
	andi	$a4, $a7, 255
	beqz	$a4, .LBB12_36
.LBB12_28:
	beqz	$a3, .LBB12_36
...
# %bb.33:                               #   in Loop: Header=BB12_32 Depth=1
	...
	bne	$a6, $a3, .LBB12_32
	b	.LBB12_36
.LBB12_34:                              # %.split.loop.exit18.i111
	beqz	$a3, .LBB12_3
# %bb.35:                               # %.split.loop.exit18.i111
	andi	$a3, $a7, 255
	bnez	$a3, .LBB12_3
.LBB12_36:
	ori	$a0, $zero, 16
...
# %bb.7:                                # %.lr.ph.split.i.preheader
	...
	b	.LBB13_11
	.p2align	4, , 16
.LBB13_8:                               # %.lr.ph.splitthread-pre-split.i
...
# %bb.17:                               # %.peel.next.preheader
	...
	b	.LBB13_21
	.p2align	4, , 16
.LBB13_18:                              #   in Loop: Header=BB13_21 Depth=1
	ld.d	$a0, $fp, 0
	ld.d	$a2, $a0, 0
	ori	$a1, $zero, 168
	jirl	$ra, $a2, 0
...
.LBB15_5:                               # =>This Inner Loop Header: Depth=1
	bge	$s1, $a2, .LBB15_7
# %bb.6:                                # %.lr.ph.splitthread-pre-split.i
...
# %bb.50:                               #   in Loop: Header=BB16_3 Depth=1
	...
	beqz	$a0, .LBB16_18
	b	.LBB16_59
.LBB16_51:                              #   in Loop: Header=BB16_3 Depth=1
	addi.d	$a0, $a0, 1
	st.d	$a0, $s1, 0
	ld.d	$a0, $s4, 64
	addi.d	$s5, $s5, 1
...
.Lfunc_end17:
	.size	XzUnpacker_IsStreamWasFinished, .Lfunc_end17-XzUnpacker_IsStreamWasFinished
                                        # -- End function
	.p2align	2                               # -- Begin function Lzma2State_Free
...
.Lfunc_end18:
	.size	Lzma2State_Free, .Lfunc_end18-Lzma2State_Free
                                        # -- End function
	.p2align	2                               # -- Begin function Lzma2State_SetProps
...
.Lfunc_end19:
	.size	Lzma2State_SetProps, .Lfunc_end19-Lzma2State_SetProps
                                        # -- End function
	.p2align	2                               # -- Begin function Lzma2State_Init
...
.Lfunc_end20:
	.size	Lzma2State_Init, .Lfunc_end20-Lzma2State_Init
                                        # -- End function
	.p2align	2                               # -- Begin function Lzma2State_Code
