...
.Lttbase0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchiveL13SetMethodPropERNS_14COneMethodInfoEjRKN8NWindows4NCOM12CPropVariantE
...
.Lttbase2:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchiveL15FindPropIdExactERK11CStringBaseIwE
...
.Lfunc_end4:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchiveL15ConvertPropertyE14tagPROPVARIANTtRN8NWindows4NCOM12CPropVariantE
...
.Ltmp322:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp323:                               # EH_LABEL
# %bb.66:                               # %_ZNK11CStringBaseIwE3MidEi.exit164
.Ltmp325:                               # EH_LABEL
	addi.d	$a0, $sp, 40
	addi.d	$a2, $sp, 60
	move	$a1, $fp
...
# %bb.68:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB14_69:                              # %_ZN11CStringBaseIwED2Ev.exit165
	bnez	$s1, .LBB14_99
# %bb.70:
	ld.w	$a1, $sp, 60
.Ltmp328:                               # EH_LABEL
...
.Ltmp355:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp356:                               # EH_LABEL
# %bb.75:                               # %_ZNK11CStringBaseIwE3MidEi.exit149
	ld.w	$a2, $s0, 88
.Ltmp358:                               # EH_LABEL
	addi.d	$a0, $sp, 64
	move	$a1, $fp
...
# %bb.83:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB14_84:                              # %_ZN11CStringBaseIwED2Ev.exit162
	bnez	$s1, .LBB14_89
	b	.LBB14_108
.LBB14_85:
	ori	$a0, $zero, 72
...
# %bb.92:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB14_93:                              # %_ZN11CStringBaseIwED2Ev.exit170
	move	$a0, $s1
...
# %bb.143:
	ld.d	$a0, $sp, 136
	bnez	$a0, .LBB14_148
.LBB14_144:                             # %_ZN11CStringBaseIwED2Ev.exit171
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB14_145:
...
.Lttbase6:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchiveL15FindPropIdStartERK11CStringBaseIwE
...
.LBB19_18:                              # %vec.epilog.scalar.ph
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB19_18
.LBB19_19:                              # %._crit_edge.thread.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s2
	move	$a2, $s3
