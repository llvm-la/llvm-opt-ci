...
# %bb.12:                               # %middle.block
	add.d	$a1, $a4, $a1
	beq	$a3, $a2, .LBB19_19
.LBB19_13:                              # %.lr.ph.split.preheader328
...
.LBB19_98:                              # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
	...
	addi.d	$sp, $sp, 208
	ret
.LBB19_99:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit._crit_edge.loopexit324
...
.LBB48_9:
	move	$a2, $zero
.LBB48_10:                              # %vec.epilog.scalar.ph.preheader
	slli.d	$a3, $a2, 2
	.p2align	4, , 16
.LBB48_11:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a4, $a1, $a3
	stx.w	$a4, $a0, $a3
	addi.d	$a2, $a2, 1
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTIPKc
	.addrsig_sym _ZTVN8NArchive4NTar8CHandlerE
	...
	.addrsig_sym _ZTV27CLimitedSequentialOutStream
	.addrsig_sym _ZTV12CBufInStream
	.addrsig_sym IID_IOutArchive
	.addrsig_sym _ZTV13CObjectVectorIN8NArchive4NTar7CItemExEE
