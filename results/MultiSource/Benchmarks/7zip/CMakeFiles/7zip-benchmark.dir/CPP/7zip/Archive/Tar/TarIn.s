...
# %bb.52:                               # %iter.check396
	...
	sub.d	$a3, $s0, $a0
	bltu	$a3, $s7, .LBB0_180
# %bb.53:                               # %vector.main.loop.iter.check383
                                        #   in Loop: Header=BB0_2 Depth=1
	bgeu	$a1, $s7, .LBB0_176
# %bb.54:                               #   in Loop: Header=BB0_2 Depth=1
	move	$a2, $zero
.LBB0_55:                               # %vec.epilog.ph400
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_56:                               # %vec.epilog.vector.body403
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_56
# %bb.57:                               # %vec.epilog.middle.block407
                                        #   in Loop: Header=BB0_2 Depth=1
	bne	$a2, $a1, .LBB0_180
	b	.LBB0_182
...
# %bb.86:                               # %iter.check427
	...
	sub.d	$a3, $s0, $a0
	bltu	$a3, $s7, .LBB0_189
# %bb.87:                               # %vector.main.loop.iter.check414
                                        #   in Loop: Header=BB0_2 Depth=1
	bgeu	$a1, $s7, .LBB0_185
# %bb.88:                               #   in Loop: Header=BB0_2 Depth=1
	move	$a2, $zero
.LBB0_89:                               # %vec.epilog.ph431
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_90:                               # %vec.epilog.vector.body434
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_90
# %bb.91:                               # %vec.epilog.middle.block438
                                        #   in Loop: Header=BB0_2 Depth=1
	bne	$a2, $a1, .LBB0_189
	b	.LBB0_191
...
# %bb.96:                               # %iter.check458
	...
	sub.d	$a3, $s0, $a0
	bltu	$a3, $s7, .LBB0_199
# %bb.97:                               # %vector.main.loop.iter.check445
                                        #   in Loop: Header=BB0_2 Depth=1
	bgeu	$a1, $s7, .LBB0_195
# %bb.98:                               #   in Loop: Header=BB0_2 Depth=1
	move	$a2, $zero
.LBB0_99:                               # %vec.epilog.ph462
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.vector.body465
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_100
# %bb.101:                              # %vec.epilog.middle.block469
                                        #   in Loop: Header=BB0_2 Depth=1
	bne	$a2, $a1, .LBB0_199
	b	.LBB0_201
...
# %bb.155:                              #   in Loop: Header=BB0_2 Depth=1
	st.d	$zero, $s8, 16
.LBB0_156:                              # %vector.body473.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a0, $zero
...
.LBB0_177:                              # %vector.body388
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_177
# %bb.178:                              # %middle.block393
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_182
# %bb.179:                              # %vec.epilog.iter.check398
                                        #   in Loop: Header=BB0_2 Depth=1
	bnez	$a3, .LBB0_55
.LBB0_180:                              # %vec.epilog.scalar.ph397.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_181:                              # %vec.epilog.scalar.ph397
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB0_186:                              # %vector.body419
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_186
# %bb.187:                              # %middle.block424
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_191
# %bb.188:                              # %vec.epilog.iter.check429
                                        #   in Loop: Header=BB0_2 Depth=1
	bnez	$a3, .LBB0_89
.LBB0_189:                              # %vec.epilog.scalar.ph428.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_190:                              # %vec.epilog.scalar.ph428
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB0_196:                              # %vector.body450
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_196
# %bb.197:                              # %middle.block455
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_201
# %bb.198:                              # %vec.epilog.iter.check460
                                        #   in Loop: Header=BB0_2 Depth=1
	bnez	$a3, .LBB0_99
.LBB0_199:                              # %vec.epilog.scalar.ph459.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_200:                              # %vec.epilog.scalar.ph459
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
# %bb.212:                              # %.preheader.i.i115
	ld.d	$a0, $s5, 0
	blez	$a1, .LBB0_223
# %bb.213:                              # %iter.check497
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_228
# %bb.214:                              # %iter.check497
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_228
# %bb.215:                              # %vector.main.loop.iter.check484
	bgeu	$a1, $a3, .LBB0_224
# %bb.216:
	move	$a2, $zero
.LBB0_217:                              # %vec.epilog.ph501
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_218:                              # %vec.epilog.vector.body504
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_218
# %bb.219:                              # %vec.epilog.middle.block508
	bne	$a2, $a1, .LBB0_228
	b	.LBB0_230
.LBB0_220:
	ext.w.b	$a2, $a1
...
.LBB0_225:                              # %vector.body489
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_225
# %bb.226:                              # %middle.block494
	beq	$a2, $a1, .LBB0_230
# %bb.227:                              # %vec.epilog.iter.check499
	bnez	$a3, .LBB0_217
.LBB0_228:                              # %vec.epilog.scalar.ph498.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_229:                              # %vec.epilog.scalar.ph498
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.246:                              # %.preheader.i.i131
	...
	ld.d	$a0, $a0, 0
	blez	$a1, .LBB0_254
# %bb.247:                              # %iter.check528
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_259
# %bb.248:                              # %iter.check528
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_259
# %bb.249:                              # %vector.main.loop.iter.check515
	bgeu	$a1, $a3, .LBB0_255
# %bb.250:
	move	$a2, $zero
.LBB0_251:                              # %vec.epilog.ph532
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_252:                              # %vec.epilog.vector.body535
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_252
# %bb.253:                              # %vec.epilog.middle.block539
	bne	$a2, $a1, .LBB0_259
	b	.LBB0_261
.LBB0_254:                              # %._crit_edge.i.i133
	bnez	$a0, .LBB0_261
	b	.LBB0_262
.LBB0_255:                              # %vector.ph517
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s0, 16
...
.LBB0_256:                              # %vector.body520
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_256
# %bb.257:                              # %middle.block525
	beq	$a2, $a1, .LBB0_261
# %bb.258:                              # %vec.epilog.iter.check530
	bnez	$a3, .LBB0_251
.LBB0_259:                              # %vec.epilog.scalar.ph529.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_260:                              # %vec.epilog.scalar.ph529
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.Lfunc_end1:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchive4NTarL10ReadStringEPKciR11CStringBaseIcE
...
.Lfunc_end2:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchive4NTarL15OctalToNumber32EPKciRj
