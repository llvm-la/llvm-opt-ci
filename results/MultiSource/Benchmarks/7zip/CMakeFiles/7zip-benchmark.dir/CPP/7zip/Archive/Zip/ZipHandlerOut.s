...
.LBB2_11:                               #   in Loop: Header=BB2_2 Depth=1
	move	$s1, $s0
.LBB2_12:                               # %_ZNK8NArchive4NZip10CLocalItem14IsAesEncryptedEv.exit
...
.Ltmp15:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp16:                                # EH_LABEL
# %bb.26:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit313
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$s0, .LBB2_74
...
.LBB2_39:                               #   in Loop: Header=BB2_2 Depth=1
	...
	move	$s6, $s0
	.p2align	4, , 16
.LBB2_40:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
...
.Ltmp27:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp28:                                # EH_LABEL
# %bb.44:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit314
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$s0, .LBB2_59
...
.Ltmp36:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
# %bb.55:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit317
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$s0, .LBB2_59
...
# %bb.73:                               #   in Loop: Header=BB2_2 Depth=1
	move	$s4, $a0
	beqz	$a0, .LBB2_106
.LBB2_74:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit323
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s0, $zero
...
# %bb.76:                               #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_77:                               # %_ZN11CStringBaseIwED2Ev.exit324
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$s0, .LBB2_83
# %bb.78:                               # %_ZN11CStringBaseIwED2Ev.exit324._crit_edge
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.w	$a0, $sp, 232
...
.Ltmp95:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp96:                                # EH_LABEL
# %bb.89:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit327
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$s0, .LBB2_100
...
.LBB2_96:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i.i
	...
	ld.d	$a1, $sp, 152
	.p2align	4, , 16
.LBB2_97:                               #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a2, $a1, 0
	addi.d	$a1, $a1, 1
	addi.d	$a3, $a0, 1
...
.Ltmp68:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp69:                                # EH_LABEL
# %bb.110:                              #   in Loop: Header=BB2_2 Depth=1
.Ltmp71:                                # EH_LABEL
	addi.d	$a0, $sp, 296
	addi.d	$a1, $sp, 240
...
# %bb.128:                              # %.lr.ph
	...
	move	$a1, $zero
	move	$a3, $a0
.LBB2_129:                              #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a2, 0
	ori	$a5, $zero, 127
	bltu	$a5, $a4, .LBB2_133
...
.Ltmp86:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp87:                                # EH_LABEL
# %bb.134:                              #   in Loop: Header=BB2_2 Depth=1
	beqz	$a0, .LBB2_137
...
.Ltmp106:                               # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp107:                               # EH_LABEL
.LBB2_142:                              # %_ZN9CMyComPtrI22IArchiveUpdateCallbackEC2EPS0_.exit
	ld.d	$a0, $fp, 0
	ld.d	$a3, $a0, 0
.Ltmp109:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp110:                               # EH_LABEL
# %bb.143:                              # %_ZNK9CMyComPtrI22IArchiveUpdateCallbackE14QueryInterfaceI23ICryptoGetTextPassword2EEiRK4GUIDPPT_.exit
	ld.d	$a0, $fp, 0
	ld.d	$a1, $a0, 16
.Ltmp115:                               # EH_LABEL
	move	$a0, $fp
...
.Ltmp147:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp148:                               # EH_LABEL
# %bb.166:                              # %_ZN13CRecordVectorIhE3AddEh.exit369
	ld.d	$a0, $sp, 136
	ld.w	$a1, $sp, 132
	stx.b	$zero, $a0, $a1
	ld.w	$a0, $sp, 132
...
# %bb.191:                              # %.noexc346
	st.w	$zero, $a0, 0
.LBB2_192:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i342
	move	$a1, $zero
	sltui	$a2, $s2, 1
	masknez	$a3, $s2, $a2
	maskeqz	$a2, $s4, $a2
...
# %bb.197:                              #   in Loop: Header=BB2_196 Depth=1
	...
	bnez	$a1, .LBB2_196
	b	.LBB2_199
.LBB2_198:                              # %_ZN8NArchive4NZipL13IsAsciiStringERK11CStringBaseIwE.exit
	beqz	$a0, .LBB2_200
.LBB2_199:                              # %_ZN11CStringBaseIwED2Ev.exit347.thread399
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.b	$s0, $sp, 224
.LBB2_200:                              # %_ZN11CStringBaseIwED2Ev.exit347.thread
	andi	$a0, $s0, 1
	beqz	$a0, .LBB2_202
# %bb.201:                              # %_ZN11CStringBaseIwED2Ev.exit347.thread
	ld.w	$a0, $sp, 216
	ori	$a1, $zero, 99
	bltu	$a1, $a0, .LBB2_209
.LBB2_202:
...
# %bb.203:                              # %.noexc354
	...
	st.w	$s0, $sp, 252
	.p2align	4, , 16
.LBB2_204:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i350
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s3, 0
	addi.d	$s3, $s3, 4
	addi.d	$a2, $a0, 4
...
# %bb.206:
	...
	addi.w	$s4, $a0, 1
	bne	$s4, $s0, .LBB2_213
# %bb.207:                              # %._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i
	ld.d	$s3, $sp, 208
	b	.LBB2_258
.LBB2_208:                              # %_ZN11CStringBaseIwED2Ev.exit347
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_209:
	move	$s0, $zero
...
# %bb.232:                              # %.noexc377
	move	$s2, $a0
	blez	$s5, .LBB2_234
# %bb.233:                              # %._crit_edge.thread.i.i375
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 160
...
.LBB2_235:
	...
	ori	$a0, $zero, 4
	st.w	$a0, $sp, 164
.LBB2_236:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i371.preheader
	slt	$a0, $s4, $s1
	...
	or	$a0, $a0, $a1
	.p2align	4, , 16
.LBB2_237:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i371
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $s2, 4
	...
	move	$s2, $a2
	bnez	$a1, .LBB2_237
# %bb.238:                              # %_ZN11CStringBaseIwEaSEPKw.exit378
	ld.w	$a0, $sp, 168
	ori	$a1, $zero, 3
	st.w	$a1, $sp, 160
.LBB2_239:
...
# %bb.253:                              # %vec.epilog.middle.block
	beq	$a2, $a1, .LBB2_256
.LBB2_254:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s3, $a2
	add.d	$a2, $a0, $a2
.LBB2_255:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB2_255
.LBB2_256:                              # %._crit_edge.thread.i.i359
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a1, $sp, 216
.LBB2_257:
...
# %bb.261:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_262:                              # %_ZN11CStringBaseIcED2Ev.exit362
	ld.d	$a0, $sp, 240
	beqz	$a0, .LBB2_264
# %bb.263:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_264:                              # %_ZN11CStringBaseIwED2Ev.exit363
	ori	$s0, $zero, 1
	b	.LBB2_150
.LBB2_265:
.Ltmp79:                                # EH_LABEL
...
.Ltmp135:                               # EH_LABEL
	move	$s0, $a1
	move	$s1, $a0
.LBB2_280:                              # %_ZN11CStringBaseIcED2Ev.exit364
	ld.d	$a0, $sp, 240
	beqz	$a0, .LBB2_299
# %bb.281:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB2_316:
	...
	jirl	$ra, $ra, 0
.LBB2_317:                              # %_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit340
	ld.d	$a0, $sp, 232
	beqz	$a0, .LBB2_336
# %bb.318:
	ld.d	$a1, $a0, 0
