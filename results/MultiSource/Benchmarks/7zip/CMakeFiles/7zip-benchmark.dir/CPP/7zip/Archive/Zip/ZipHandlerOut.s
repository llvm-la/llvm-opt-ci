...
.LBB2_221:                              # %vec.epilog.ph
	...
	add.d	$a4, $s3, $a5
	add.d	$a5, $a0, $a5
.LBB2_222:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB2_222
# %bb.223:                              # %vec.epilog.middle.block
	bne	$a2, $a1, .LBB2_255
	b	.LBB2_257
.LBB2_224:
	ori	$a2, $zero, 6
...
# %bb.236:                              # %.noexc376
	move	$s2, $a0
	blez	$s5, .LBB2_238
# %bb.237:                              # %._crit_edge.thread.i.i374
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 160
...
.LBB2_239:
	...
	ori	$a0, $zero, 4
	st.w	$a0, $sp, 164
.LBB2_240:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i370.preheader
	slt	$a0, $s4, $s1
	...
	or	$a0, $a0, $a1
	.p2align	4, , 16
.LBB2_241:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i370
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $s2, 4
	...
	move	$s2, $a2
	bnez	$a1, .LBB2_241
# %bb.242:                              # %_ZN11CStringBaseIwEaSEPKw.exit377
	ld.w	$a0, $sp, 168
	ori	$a1, $zero, 3
	st.w	$a1, $sp, 160
.LBB2_243:
...
.Ltmp356:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp357:                               # EH_LABEL
# %bb.25:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i393
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$s7, $a0
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB10_64:                              #   in Loop: Header=BB10_2 Depth=1
	move	$a1, $zero
.LBB10_65:                              # %scalar.ph690.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	addi.d	$a2, $s5, 4
	sub.d	$a3, $a0, $a1
	slli.d	$a1, $a1, 2
	.p2align	4, , 16
.LBB10_66:                              # %scalar.ph690
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a4, $a2, $a1
	stx.w	$a4, $s7, $a1
...
.LBB10_142:                             #   in Loop: Header=BB10_2 Depth=1
	move	$a1, $zero
.LBB10_143:                             # %scalar.ph675.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	sub.d	$a2, $a0, $a1
	slli.d	$a1, $a1, 2
	.p2align	4, , 16
.LBB10_144:                             # %scalar.ph675
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a3, $s8, $a1
	ld.w	$a3, $a3, 12
...
.LBB10_159:                             #   in Loop: Header=BB10_2 Depth=1
	move	$a3, $zero
.LBB10_160:                             # %scalar.ph705.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	addi.d	$a2, $a2, 12
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB10_161:                             # %scalar.ph705
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
...
.LBB10_166:                             #   in Loop: Header=BB10_2 Depth=1
	move	$a1, $zero
.LBB10_167:                             # %scalar.ph720.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	addi.d	$a2, $s5, 4
	sub.d	$a3, $a0, $a1
	slli.d	$a1, $a1, 2
	.p2align	4, , 16
.LBB10_168:                             # %scalar.ph720
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a4, $a2, $a1
	stx.w	$a4, $s7, $a1
...
.LBB10_178:                             #   in Loop: Header=BB10_2 Depth=1
	move	$a3, $zero
.LBB10_179:                             # %scalar.ph735.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	addi.d	$a2, $a2, 16
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB10_180:                             # %scalar.ph735
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
...
.LBB10_191:                             #   in Loop: Header=BB10_2 Depth=1
	move	$a3, $zero
.LBB10_192:                             # %scalar.ph750.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	addi.d	$a2, $a2, 8
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB10_193:                             # %scalar.ph750
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
...
.LBB10_223:                             #   in Loop: Header=BB10_2 Depth=1
	move	$a3, $zero
.LBB10_224:                             # %scalar.ph765.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	addi.d	$a2, $a2, 8
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB10_225:                             # %scalar.ph765
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
