...
.LBB0_10:                               #   Parent Loop BB0_3 Depth=1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB0_10
.LBB0_11:                               # %_ZL18GetCorrectFileNameRK11CStringBaseIwE.exit
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.d	$s3, $s7, 0
	ld.w	$s6, $s7, 12
	st.w	$zero, $s7, 8
...
# %bb.25:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_26:                               # %_ZN11CStringBaseIwED2Ev.exit11
	move	$a0, $fp
...
# %bb.2:
	...
	st.w	$s2, $fp, 12
	.p2align	4, , 16
.LBB4_3:                                # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s0, 0
	addi.d	$s0, $s0, 4
	addi.d	$a2, $a0, 4
