...
# %bb.2:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_3:                               # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	ld.b	$a1, $s0, 1
...
# %bb.4:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_5:                               # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit36
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	ld.hu	$s2, $s0, 2
...
# %bb.6:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_7:                               # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit.i
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	srli.d	$a1, $s2, 8
...
# %bb.8:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_9:                               # %_ZN8NArchive4NZip11COutArchive11WriteUInt16Et.exit
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	ld.hu	$s2, $s0, 4
...
# %bb.10:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_11:                              # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit.i37
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	srli.d	$a1, $s2, 8
...
# %bb.12:
	...
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB12_13:                              # %_ZN8NArchive4NZip11COutArchive11WriteUInt16Et.exit39
	ld.d	$a0, $fp, 64
	ld.w	$a1, $s0, 8
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 64
...
# %bb.14:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_15:                              # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit.i40
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	srli.d	$a1, $s2, 8
...
# %bb.16:
	...
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB12_17:                              # %_ZN8NArchive4NZip11COutArchive11WriteUInt16Et.exit42
	ld.d	$a2, $fp, 64
	ld.w	$a1, $s0, 60
	maskeqz	$a0, $s2, $s3
	addi.d	$a2, $a2, 1
...
.LBB12_25:                              # %scalar.ph
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB12_25
.LBB12_26:                              # %_ZNK8NArchive4NZip11CExtraBlock7GetSizeEv.exit
	ld.w	$s2, $fp, 76
	add.d	$a0, $a4, $a0
...
# %bb.28:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_29:                              # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit.i43
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	srli.d	$a1, $s2, 8
...
# %bb.30:
	...
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB12_31:                              # %_ZN8NArchive4NZip11COutArchive11WriteUInt16Et.exit45
	ld.d	$a0, $fp, 64
	ld.wu	$s4, $s0, 40
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 64
...
# %bb.32:                               # %.lr.ph.i.i.preheader
	...
	b	.LBB12_34
	.p2align	4, , 16
.LBB12_33:                              # %_ZN10COutBuffer9WriteByteEh.exit.i.i
...
# %bb.35:                               #   in Loop: Header=BB12_34 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB12_33
.LBB12_36:                              # %_ZN8NArchive4NZip11COutArchive10WriteBytesEPKvj.exit.loopexit
	ld.d	$a0, $fp, 64
.LBB12_37:                              # %_ZN8NArchive4NZip11COutArchive10WriteBytesEPKvj.exit
	addi.d	$s2, $s0, 48
	add.d	$a0, $a0, $s4
	st.d	$a0, $fp, 64
	beqz	$s3, .LBB12_47
...
# %bb.39:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_40:                              # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit.i46
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	ld.d	$a1, $fp, 8
...
# %bb.41:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_42:                              # %_ZN8NArchive4NZip11COutArchive11WriteUInt16Et.exit48
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	ld.d	$a1, $fp, 8
...
# %bb.43:
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 16
.LBB12_44:                              # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit.i49
	ld.d	$a1, $fp, 64
	addi.d	$a1, $a1, 1
	st.d	$a1, $fp, 64
	ld.d	$a1, $fp, 8
...
# %bb.45:
	...
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB12_46:                              # %_ZN8NArchive4NZip11COutArchive11WriteUInt16Et.exit51
	ld.d	$a0, $fp, 64
	ld.d	$a1, $s0, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 64
...
.LBB12_53:                              # %vector.body97
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB12_53
# %bb.54:                               # %middle.block104
	vadd.d	$vr0, $vr1, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a0, .LBB12_57
.LBB12_55:                              # %scalar.ph92.preheader
	sub.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $a1, 3
	.p2align	4, , 16
.LBB12_56:                              # %scalar.ph92
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	ld.d	$a2, $a2, 16
	add.d	$a2, $a3, $a2
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB12_56
.LBB12_57:                              # %_ZNK8NArchive4NZip11CExtraBlock7GetSizeEv.exit59
	ld.w	$a0, $fp, 76
	add.w	$s2, $s3, $a3
	bltu	$s2, $a0, .LBB12_61
.LBB12_58:                              # %._crit_edge
	...
	jirl	$ra, $a4, 0
	bnez	$a0, .LBB12_63
# %bb.59:                               # %_ZN8NArchive4NZip11COutArchive6SeekToEy.exit62
	ld.d	$s5, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 40                    # 8-byte Folded Reload
	...
	ret
	.p2align	4, , 16
.LBB12_60:                              # %_ZN8NArchive4NZip11COutArchive9WriteByteEh.exit60
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV16COffsetOutStream
