...
.Ltmp331:                               # EH_LABEL
	...
	move	$a0, $s2
	b	.LBB12_471
.LBB12_460:                             # %.loopexit.split-lp.i.i
.Ltmp369:                               # EH_LABEL
	b	.LBB12_521
.LBB12_461:
.Ltmp323:                               # EH_LABEL
.LBB12_462:
	...
	move	$fp, $a0
	bnez	$a1, .LBB12_465
# %bb.463:                              # %_ZN11CStringBaseIwED2Ev.exit299.i.i
	ld.d	$a0, $sp, 616
	bnez	$a0, .LBB12_466
.LBB12_464:                             # %_ZN11CStringBaseIwED2Ev.exit300.i.i
	ld.d	$a0, $sp, 696
	bnez	$a0, .LBB12_468
	b	.LBB12_539
.LBB12_465:
...
.Ltmp303:                               # EH_LABEL
	...
	ori	$a1, $zero, 128
	move	$a0, $s8
.LBB12_471:                             # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit327.i.i
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	b	.LBB12_540
.LBB12_472:
...
.Ltmp377:                               # EH_LABEL
	b	.LBB12_537
.LBB12_488:                             # %_ZN9CMyComPtrI9IInStreamED2Ev.exit322.i.loopexit.split-lp.i
.Ltmp308:                               # EH_LABEL
	b	.LBB12_537
.LBB12_489:
.Ltmp174:                               # EH_LABEL
...
.LBB12_502:
	...
	jirl	$ra, $ra, 0
	b	.LBB12_546
.LBB12_503:                             # %_ZN9CMyComPtrI9IInStreamED2Ev.exit322.thread388.i.i
.Ltmp374:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB12_540
.LBB12_504:
...
.Ltmp500:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB12_536:                             # %_ZN9CMyComPtrI9IInStreamED2Ev.exit322.i.loopexit.i
.Ltmp311:                               # EH_LABEL
...
.Ltmp441:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp442:                               # EH_LABEL
.LBB12_540:                             # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit327.i.i
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp444:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp445:                               # EH_LABEL
.LBB12_541:                             # %_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit329.i.i
	addi.d	$a0, $sp, 712
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB12_566
...
# %bb.547:
	ld.d	$a0, $sp, 520
	bnez	$a0, .LBB12_581
.LBB12_548:                             # %_ZN11CStringBaseIwED2Ev.exit396
	addi.d	$a0, $sp, 536
	pcaddu18i	$ra, %call36(_ZN12CArchiveLinkD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Ltmp253:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB12_553:                             # %.loopexit.split-lp.i
.Ltmp247:                               # EH_LABEL
	b	.LBB12_555
.LBB12_554:                             # %.loopexit.i
.Ltmp244:                               # EH_LABEL
.LBB12_555:
	move	$fp, $a0
	ld.d	$a0, $sp, 304                   # 8-byte Folded Reload
...
.LBB12_575:
.Ltmp221:                               # EH_LABEL
.LBB12_576:                             # %_ZN11CStringBaseIwED2Ev.exit394
	move	$fp, $a0
	b	.LBB12_579
.LBB12_577:
.Ltmp228:                               # EH_LABEL
...
# %bb.578:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_579:                             # %_ZN11CStringBaseIwED2Ev.exit394
	addi.d	$a0, $sp, 360
