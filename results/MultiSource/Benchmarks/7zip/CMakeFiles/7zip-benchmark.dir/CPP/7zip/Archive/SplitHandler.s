...
.Ltmp230:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp231:                               # EH_LABEL
# %bb.14:                               # %_ZplIwE11CStringBaseIT_ES1_RKS2_.exit97
                                        #   in Loop: Header=BB6_4 Depth=1
	ld.d	$s1, $sp, 56
	st.w	$zero, $sp, 64
	st.w	$zero, $s1, 0
...
# %bb.16:                               # %.noexc104
	...
	move	$s2, $a0
	blez	$s7, .LBB6_18
# %bb.17:                               # %._crit_edge.thread.i.i102
                                        #   in Loop: Header=BB6_4 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_19:                               #   in Loop: Header=BB6_4 Depth=1
	...
	move	$s1, $s2
	ori	$s2, $zero, 90
.LBB6_20:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i98
                                        #   in Loop: Header=BB6_4 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
...
.Ltmp191:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp192:                               # EH_LABEL
# %bb.33:                               # %_ZplIwE11CStringBaseIT_ES1_RKS2_.exit142
                                        #   in Loop: Header=BB6_31 Depth=1
	ld.d	$s1, $sp, 56
	st.w	$zero, $sp, 64
	st.w	$zero, $s1, 0
...
# %bb.35:                               # %.noexc149
	...
	move	$s2, $a0
	blez	$fp, .LBB6_37
# %bb.36:                               # %._crit_edge.thread.i.i147
                                        #   in Loop: Header=BB6_31 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_38:                               #   in Loop: Header=BB6_31 Depth=1
	...
	st.w	$s8, $sp, 68
	move	$s1, $s2
.LBB6_39:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i143
                                        #   in Loop: Header=BB6_31 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.42:                               #   in Loop: Header=BB6_31 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_43:                               # %_ZN11CStringBaseIwED2Ev.exit151
                                        #   in Loop: Header=BB6_31 Depth=1
	beqz	$s3, .LBB6_58
...
.Ltmp200:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp201:                               # EH_LABEL
# %bb.47:                               # %_ZplIwE11CStringBaseIT_ES1_RKS2_.exit175
	ld.d	$s2, $sp, 56
	st.w	$zero, $sp, 64
	st.w	$zero, $s2, 0
	ld.w	$a0, $sp, 48
...
# %bb.50:                               # %.noexc182
	move	$s1, $a0
	blez	$s5, .LBB6_69
# %bb.51:                               # %._crit_edge.thread.i.i180
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 64
...
.Ltmp248:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp249:                               # EH_LABEL
# %bb.67:                               # %_ZplIwE11CStringBaseIT_ES1_RKS2_.exit112
	ld.d	$s2, $sp, 56
	st.w	$zero, $sp, 64
	st.w	$zero, $s2, 0
	ld.w	$a0, $sp, 48
...
.LBB6_70:
	...
	stx.w	$zero, $s1, $a0
	st.w	$fp, $sp, 68
.LBB6_71:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i176
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.74:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_75:                               # %_ZN11CStringBaseIwED2Ev.exit184
	ori	$a0, $zero, 2
	bltu	$s3, $a0, .LBB6_124
# %bb.76:                               # %.lr.ph276
	...
	b	.LBB6_78
	.p2align	4, , 16
.LBB6_77:                               # %_ZN11CStringBaseIwED2Ev.exit198
...
.Ltmp209:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp210:                               # EH_LABEL
# %bb.80:                               # %_ZplIwE11CStringBaseIT_ES1_RKS2_.exit189
                                        #   in Loop: Header=BB6_78 Depth=1
	ld.d	$s1, $sp, 56
	st.w	$zero, $sp, 64
	st.w	$zero, $s1, 0
...
# %bb.82:                               # %.noexc196
	...
	move	$s2, $a0
	blez	$s6, .LBB6_84
# %bb.83:                               # %._crit_edge.thread.i.i194
                                        #   in Loop: Header=BB6_78 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_85:                               #   in Loop: Header=BB6_78 Depth=1
	...
	st.w	$s5, $sp, 68
	move	$s1, $s2
.LBB6_86:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i190
                                        #   in Loop: Header=BB6_78 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.91:                               # %.noexc164
	move	$s2, $a0
	blez	$s5, .LBB6_96
# %bb.92:                               # %._crit_edge.thread.i.i162
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 64
...
# %bb.94:                               # %.noexc119
	move	$s1, $a0
	blez	$s4, .LBB6_103
# %bb.95:                               # %._crit_edge.thread.i.i117
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 64
...
.LBB6_97:
	...
	stx.w	$zero, $s2, $a0
	st.w	$s4, $sp, 68
.LBB6_98:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i158
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
...
.LBB6_104:
	...
	stx.w	$zero, $s1, $a0
	st.w	$s3, $sp, 68
.LBB6_105:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i113
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.108:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_109:                              # %_ZN11CStringBaseIwED2Ev.exit121
	ori	$a0, $zero, 2
	bltu	$fp, $a0, .LBB6_124
# %bb.110:                              # %.lr.ph282
	bstrpick.d	$a0, $s5, 31, 0
	...
	b	.LBB6_112
	.p2align	4, , 16
.LBB6_111:                              # %_ZN11CStringBaseIwED2Ev.exit135
...
.Ltmp257:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp258:                               # EH_LABEL
# %bb.114:                              # %_ZplIwE11CStringBaseIT_ES1_RKS2_.exit126
                                        #   in Loop: Header=BB6_112 Depth=1
	ld.d	$s1, $sp, 56
	st.w	$zero, $sp, 64
	st.w	$zero, $s1, 0
...
# %bb.116:                              # %.noexc133
	...
	move	$s2, $a0
	blez	$s5, .LBB6_118
# %bb.117:                              # %._crit_edge.thread.i.i131
                                        #   in Loop: Header=BB6_112 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_119:                              #   in Loop: Header=BB6_112 Depth=1
	...
	st.w	$s4, $sp, 68
	move	$s1, $s2
.LBB6_120:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i127
                                        #   in Loop: Header=BB6_112 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.128:                              # %.noexc207
	move	$s2, $a0
	blez	$s4, .LBB6_130
# %bb.129:                              # %._crit_edge.thread.i.i205
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s0, 24
...
.LBB6_131:
	...
	stx.w	$zero, $s2, $a0
	st.w	$fp, $s0, 28
.LBB6_132:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i201
	ld.d	$a0, $sp, 56
	.p2align	4, , 16
...
# %bb.134:                              # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
	ld.w	$a0, $sp, 64
	st.w	$a0, $s0, 24
.LBB6_135:                              # %_ZN11CStringBaseIwEaSERKS0_.exit208
	ld.w	$fp, $s0, 8
...
# %bb.138:                              # %.noexc215
	...
	st.w	$zero, $a0, 0
	st.w	$s2, $s5, 12
.LBB6_139:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i209
	ld.d	$a1, $s0, 0
	.p2align	4, , 16
.LBB6_140:                              # =>This Inner Loop Header: Depth=1
	...
	move	$a0, $a3
	bnez	$a2, .LBB6_140
# %bb.141:                              # %_ZN11CStringBaseIwEC2ERKS0_.exit.i213
	st.w	$fp, $s5, 8
.Ltmp274:                               # EH_LABEL
	move	$a0, $s5
	move	$a1, $s1
	...
	jirl	$ra, $ra, 0
.Ltmp275:                               # EH_LABEL
# %bb.142:                              # %_ZplIwE11CStringBaseIT_ERKS2_S4_.exit218
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB6_144
# %bb.143:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_144:                              # %_ZN11CStringBaseIwED2Ev.exit219
...
.Ltmp220:                               # EH_LABEL
	move	$fp, $a0
.LBB6_154:                              # %_ZN11CStringBaseIwED2Ev.exit170
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 56
...
# %bb.180:                              # %.body216
	ld.d	$a0, $sp, 56
	bnez	$a0, .LBB6_183
.LBB6_181:                              # %_ZN11CStringBaseIwED2Ev.exit220
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_182:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit26
	...
	move	$a3, $a0
	beq	$a5, $a6, .LBB14_49
.LBB14_32:                              # %_ZeqRK4GUIDS1_.exit26.thread
...
# %bb.48:
	addi.d	$a3, $a0, 8
.LBB14_49:                              # %_ZeqRK4GUIDS1_.exit44.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB14_50:                              # %_ZeqRK4GUIDS1_.exit44.thread
	move	$a0, $a3
	ret
.Lfunc_end14:
...
.LBB25_18:                              # %vec.epilog.scalar.ph
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB25_18
.LBB25_19:                              # %._crit_edge.thread.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s2
	move	$a2, $s3
...
.Lttbase11:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchive6NSplitL9CreateArcEv
...
.Lcst_end17:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_SplitHandler.cpp
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTVN8NArchive6NSplit8CHandlerE
	...
	.addrsig_sym _ZTV12CMultiStream
	.addrsig_sym _ZTV13CObjectVectorIN12CMultiStream14CSubStreamInfoEE
	...
	.addrsig_sym _ZTV13CObjectVectorI9CMyComPtrI9IInStreamEE
