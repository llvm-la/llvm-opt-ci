...
# %bb.9:                                # %iter.check
	...
	bltu	$a3, $a6, .LBB0_12
# %bb.10:                               # %vector.memcheck78
	addi.d	$a7, $a0, 1416
	add.d	$a6, $a0, $a4
	addi.d	$a6, $a6, 1546
	addi.d	$t0, $a0, 1546
	bgeu	$a7, $a6, .LBB0_28
# %bb.11:                               # %vector.memcheck78
	alsl.d	$a6, $a4, $a0, 1
	addi.d	$a6, $a6, 1416
	bgeu	$t0, $a6, .LBB0_28
.LBB0_12:
...
# %bb.17:                               # %iter.check143
	bstrpick.d	$a4, $a5, 31, 0
	bltu	$a3, $a6, .LBB0_20
# %bb.18:                               # %vector.memcheck118
	addi.d	$a6, $a0, 1620
	add.d	$a7, $a0, $a4
	addi.d	$t0, $a7, 1750
	addi.d	$a7, $a0, 1750
	bgeu	$a6, $t0, .LBB0_30
# %bb.19:                               # %vector.memcheck118
	alsl.d	$t0, $a4, $a0, 1
	addi.d	$t0, $t0, 1620
	bgeu	$a7, $t0, .LBB0_30
.LBB0_20:
	move	$a3, $zero
.LBB0_21:                               # %vec.epilog.scalar.ph144.preheader
	slli.d	$a2, $a3, 1
	addi.d	$a2, $a2, 1620
	sub.d	$a5, $a5, $a3
	.p2align	4, , 16
.LBB0_22:                               # %vec.epilog.scalar.ph144
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$a5, $a0, $a2
	add.d	$a6, $a0, $a3
	st.b	$a3, $a6, 1750
...
# %bb.29:
	move	$a6, $zero
	b	.LBB0_36
.LBB0_30:                               # %vector.main.loop.iter.check126
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_39
# %bb.31:
	move	$a3, $zero
...
.LBB0_40:                               # %vector.body133
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_40
# %bb.41:                               # %middle.block140
	beq	$a3, $a4, .LBB0_24
# %bb.42:                               # %vec.epilog.iter.check145
	beqz	$t0, .LBB0_21
.LBB0_43:                               # %vec.epilog.ph147
	move	$a7, $a3
	...
	addi.d	$a7, $a7, 1620
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body158
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr3, $vr0, $vr1
	vpickev.h	$vr3, $vr3, $vr3
	vstelm.d	$vr3, $a7, 0, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$a2, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block165
	beq	$a3, $a4, .LBB0_24
	b	.LBB0_21
.Lfunc_end0:
...
.LBB1_68:                               # %vec.epilog.ph
	...
	add.d	$a4, $a4, $a6
	.p2align	4, , 16
.LBB1_69:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB1_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a7, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB1_69
# %bb.70:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB1_24 Depth=1
	beq	$a3, $t2, .LBB1_72
	.p2align	4, , 16
.LBB1_71:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB1_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a1, 0
	addi.d	$a1, $a1, 1
...
.LBB1_75:
	ori	$a0, $zero, 1
	b	.LBB1_78
.LBB1_76:                               # %_ZN12CLzOutWindow9CopyBlockEjj.exit.thread94
	sub.d	$a0, $s3, $s8
	st.w	$a0, $fp, 168
	st.w	$s7, $fp, 172
.LBB1_77:                               # %.loopexit98
	ld.bu	$a0, $fp, 156
.LBB1_78:                               # %_ZN12CLzOutWindow9CopyBlockEjj.exit.thread91
...
.LBB2_41:
	move	$a4, $a3
.LBB2_42:                               # %vec.epilog.scalar.ph133.preheader
	addi.d	$a1, $a4, 1
	alsl.d	$a2, $a4, $fp, 1
	addi.d	$a2, $a2, 8
	.p2align	4, , 16
.LBB2_43:                               # %vec.epilog.scalar.ph133
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a2, 0
...
.LBB2_44:                               # %.loopexit
	...
	addi.d	$sp, $sp, 48
	ret
.LBB2_45:                               # %vector.main.loop.iter.check115
	ori	$a4, $zero, 15
	addi.d	$a1, $a3, 1
	bgeu	$a3, $a4, .LBB2_50
# %bb.46:
	move	$a5, $zero
.LBB2_47:                               # %vec.epilog.ph136
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_48:                               # %vec.epilog.vector.body139
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, -16
	bnez	$a7, .LBB2_48
# %bb.49:                               # %vec.epilog.middle.block147
	bne	$a1, $a6, .LBB2_42
	b	.LBB2_44
.LBB2_50:                               # %vector.ph117
	andi	$a6, $a1, 8
...
.LBB2_51:                               # %vector.body120
	...
	addi.d	$a7, $a7, -32
	bnez	$t1, .LBB2_51
# %bb.52:                               # %middle.block128
	beq	$a1, $a5, .LBB2_44
# %bb.53:                               # %vec.epilog.iter.check134
	beqz	$a6, .LBB2_42
	b	.LBB2_47
.Lfunc_end2:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit26
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB12_48
.LBB12_32:                              # %_ZeqRK4GUIDS1_.exit26.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit44
	...
	ori	$a5, $zero, 16
	bne	$a1, $a4, .LBB12_49
.LBB12_48:                              # %_ZeqRK4GUIDS1_.exit44.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB12_49:                              # %_ZeqRK4GUIDS1_.exit44.thread
	move	$a0, $a3
	ret
.Lfunc_end12:
