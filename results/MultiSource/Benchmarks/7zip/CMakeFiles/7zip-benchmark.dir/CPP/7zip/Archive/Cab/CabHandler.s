...
# %bb.50:                               # %iter.check192
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB4_75
# %bb.51:                               # %vector.main.loop.iter.check179
                                        #   in Loop: Header=BB4_23 Depth=1
	ori	$a0, $zero, 64
	bgeu	$s8, $a0, .LBB4_68
...
.LBB4_69:                               # %vector.body184
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB4_69
# %bb.70:                               # %middle.block189
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_77
# %bb.71:                               # %vec.epilog.iter.check194
                                        #   in Loop: Header=BB4_23 Depth=1
	beqz	$a1, .LBB4_75
.LBB4_72:                               # %vec.epilog.ph196
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a3, $a0
	bstrpick.d	$a0, $s8, 30, 4
	slli.d	$a0, $a0, 4
	...
	add.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB4_73:                               # %vec.epilog.vector.body199
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vst	$vr0, $a2, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB4_73
# %bb.74:                               # %vec.epilog.middle.block203
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_77
