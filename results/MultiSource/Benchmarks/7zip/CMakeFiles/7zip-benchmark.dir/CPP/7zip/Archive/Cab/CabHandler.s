...
# %bb.53:                               # %iter.check192
	...
	ori	$a2, $zero, 32
	bltu	$a1, $a2, .LBB4_75
# %bb.54:                               # %vector.main.loop.iter.check179
                                        #   in Loop: Header=BB4_23 Depth=1
	ori	$a0, $zero, 32
	bgeu	$s8, $a0, .LBB4_71
# %bb.55:                               #   in Loop: Header=BB4_23 Depth=1
	move	$a0, $zero
.LBB4_56:                               # %vec.epilog.ph196
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a3, $a0
	bstrpick.d	$a0, $s8, 30, 4
	slli.d	$a0, $a0, 4
	...
	add.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB4_57:                               # %vec.epilog.vector.body199
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vst	$vr0, $a2, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB4_57
# %bb.58:                               # %vec.epilog.middle.block203
                                        #   in Loop: Header=BB4_23 Depth=1
	bne	$a0, $s8, .LBB4_75
	b	.LBB4_77
.LBB4_59:                               # %vector.ph157
                                        #   in Loop: Header=BB4_23 Depth=1
	andi	$a1, $s8, 16
...
.LBB4_60:                               # %vector.body160
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB4_60
# %bb.61:                               # %middle.block165
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_65
# %bb.62:                               # %vec.epilog.iter.check
                                        #   in Loop: Header=BB4_23 Depth=1
	bnez	$a1, .LBB4_46
.LBB4_63:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB4_23 Depth=1
	sub.d	$a1, $s8, $a0
	add.d	$a2, $s5, $a0
	add.d	$a0, $s0, $a0
	.p2align	4, , 16
.LBB4_64:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a0, 0
	st.b	$a3, $a2, 0
	...
	addi.d	$a0, $a0, 1
	bnez	$a1, .LBB4_64
.LBB4_65:                               # %._crit_edge.thread.i.i.i60
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a0, $s0
...
# %bb.69:                               #   in Loop: Header=BB4_23 Depth=1
	beqz	$s2, .LBB4_22
# %bb.70:                               #   in Loop: Header=BB4_23 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB4_22
.LBB4_71:                               # %vector.ph181
                                        #   in Loop: Header=BB4_23 Depth=1
	andi	$a1, $s8, 16
	bstrpick.d	$a0, $s8, 30, 5
	slli.d	$a0, $a0, 5
...
.LBB4_72:                               # %vector.body184
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB4_72
# %bb.73:                               # %middle.block189
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_77
# %bb.74:                               # %vec.epilog.iter.check194
                                        #   in Loop: Header=BB4_23 Depth=1
	bnez	$a1, .LBB4_56
.LBB4_75:                               # %vec.epilog.scalar.ph193.preheader
                                        #   in Loop: Header=BB4_23 Depth=1
	sub.d	$a1, $s8, $a0
	add.d	$a2, $s5, $a0
	add.d	$a0, $s0, $a0
	.p2align	4, , 16
.LBB4_76:                               # %vec.epilog.scalar.ph193
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a0, 0
	st.b	$a3, $a2, 0
...
.Ltmp154:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp155:                               # EH_LABEL
.LBB7_84:                               # %_ZN9CMyComPtrI9IInStreamED2Ev.exit129
	ld.d	$a0, $sp, 240
	beqz	$a0, .LBB7_86
# %bb.85:
	ld.d	$a1, $a0, 0
...
.Ltmp148:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp149:                               # EH_LABEL
.LBB7_97:                               # %_ZN9CMyComPtrI26IArchiveOpenVolumeCallbackED2Ev.exit132
	addi.d	$a0, $sp, 248
...
.Ltmp187:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp188:                               # EH_LABEL
.LBB14_50:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit74
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB14_51:
...
# %bb.158:                              #   in Loop: Header=BB20_150 Depth=2
	...
	ld.w	$a1, $a1, 12
	blt	$a0, $a1, .LBB20_150
.LBB20_159:                             # %.thread668.thread
                                        #   in Loop: Header=BB20_32 Depth=1
	ld.d	$a0, $s4, 96
	ld.d	$a1, $s4, 104
	bne	$a0, $a1, .LBB20_194
.LBB20_160:                             # %.thread668.thread.thread
                                        #   in Loop: Header=BB20_32 Depth=1
	move	$fp, $zero
...
.LBB20_192:                             #   in Loop: Header=BB20_32 Depth=1
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB20_200
.LBB20_193:                             # %.thread668.thread748.sink.split.loopexit
                                        #   in Loop: Header=BB20_32 Depth=1
	ld.d	$s1, $sp, 136                   # 8-byte Folded Reload
.LBB20_194:                             # %.thread668.thread748
                                        #   in Loop: Header=BB20_32 Depth=1
	addi.d	$a0, $sp, 264
	ori	$a2, $zero, 1024
	move	$a1, $zero
...
.Ltmp274:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB20_268:                             # %.loopexit.split-lp760
.Ltmp285:                               # EH_LABEL
	b	.LBB20_279
.LBB20_269:
.Ltmp330:                               # EH_LABEL
...
# %bb.282:                              # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit591
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	beqz	$a0, .LBB20_284
# %bb.283:                              # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit591.thread708
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp389:                               # EH_LABEL
	jirl	$ra, $a1, 0
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit23
	...
	ld.bu	$a4, $a5, 15
	bne	$a1, $a4, .LBB22_33
.LBB22_32:                              # %_ZeqRK4GUIDS1_.exit23.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB22_33:                              # %_ZeqRK4GUIDS1_.exit23.thread
	move	$a0, $a3
	ret
.Lfunc_end22:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit32
	...
	ori	$a2, $zero, 8
	beq	$a4, $a0, .LBB43_65
.LBB43_32:                              # %_ZeqRK4GUIDS1_.exit32.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit50
	...
	ori	$a2, $zero, 16
	beq	$a4, $a0, .LBB43_65
.LBB43_48:                              # %_ZeqRK4GUIDS1_.exit50.thread
...
# %bb.63:                               # %_ZeqRK4GUIDS1_.exit68
	...
	ori	$a2, $zero, 24
	beq	$a3, $a0, .LBB43_65
.LBB43_64:                              # %_ZeqRK4GUIDS1_.exit68.thread
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTVN8NArchive4NCab8CHandlerE
	...
	.addrsig_sym _ZTVN8NArchive4NCab16CFolderOutStreamE
	...
	.addrsig_sym _ZTV13CObjectVectorIN8NArchive4NCab7CFolderEE
	...
	.addrsig_sym _ZTV13CObjectVectorIN8NArchive4NCab5CItemEE
	...
	.addrsig_sym _ZTVN8NArchive4NCab17CCabBlockInStreamE
	...
	.addrsig_sym _ZTVN9NCompress8NQuantum8CDecoderE
	.addrsig_sym _ZTV13CObjectVectorIN8NArchive4NCab11CDatabaseExEE
