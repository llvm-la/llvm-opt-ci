...
.LBB11_56:                              # %vector.body408
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB11_56
# %bb.57:                               # %middle.block413
                                        #   in Loop: Header=BB11_44 Depth=2
	beq	$a2, $a1, .LBB11_64
# %bb.58:                               # %vec.epilog.iter.check417
                                        #   in Loop: Header=BB11_44 Depth=2
	beqz	$a3, .LBB11_62
.LBB11_59:                              # %vec.epilog.ph419
                                        #   in Loop: Header=BB11_44 Depth=2
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB11_60:                              # %vec.epilog.vector.body422
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_44 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a5, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_60
# %bb.61:                               # %vec.epilog.middle.block426
                                        #   in Loop: Header=BB11_44 Depth=2
	beq	$a2, $a1, .LBB11_64
...
.LBB11_81:                              # %vector.body376
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB11_81
# %bb.82:                               # %middle.block381
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_89
# %bb.83:                               # %vec.epilog.iter.check385
                                        #   in Loop: Header=BB11_41 Depth=1
	beqz	$a3, .LBB11_87
.LBB11_84:                              # %vec.epilog.ph387
                                        #   in Loop: Header=BB11_41 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a4, $s5, $a5
	add.d	$a5, $a0, $a5
.LBB11_85:                              # %vec.epilog.vector.body390
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_85
# %bb.86:                               # %vec.epilog.middle.block394
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_89
...
.LBB11_106:                             # %vector.body344
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB11_106
# %bb.107:                              # %middle.block349
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_114
# %bb.108:                              # %vec.epilog.iter.check353
                                        #   in Loop: Header=BB11_41 Depth=1
	beqz	$a3, .LBB11_112
.LBB11_109:                             # %vec.epilog.ph355
                                        #   in Loop: Header=BB11_41 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a4, $s6, $a5
	add.d	$a5, $a0, $a5
.LBB11_110:                             # %vec.epilog.vector.body358
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_110
# %bb.111:                              # %vec.epilog.middle.block362
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_114
...
.LBB11_153:                             # %vector.body312
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_153
# %bb.154:                              # %middle.block317
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_161
# %bb.155:                              # %vec.epilog.iter.check321
                                        #   in Loop: Header=BB11_142 Depth=2
	beqz	$a2, .LBB11_159
.LBB11_156:                             # %vec.epilog.ph323
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a4, $a1
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB11_157:                             # %vec.epilog.vector.body326
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_142 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB11_157
# %bb.158:                              # %vec.epilog.middle.block330
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_161
...
.LBB11_173:                             # %vector.body280
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_173
# %bb.174:                              # %middle.block285
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_139
# %bb.175:                              # %vec.epilog.iter.check289
                                        #   in Loop: Header=BB11_142 Depth=2
	beqz	$a2, .LBB11_179
.LBB11_176:                             # %vec.epilog.ph291
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a4, $a1
	bstrpick.d	$a1, $s7, 30, 4
	slli.d	$a1, $a1, 4
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB11_177:                             # %vec.epilog.vector.body294
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_142 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB11_177
# %bb.178:                              # %vec.epilog.middle.block298
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_139
...
.LBB13_41:                              #   in Loop: Header=BB13_11 Depth=1
	ori	$s7, $zero, 4
	b	.LBB13_53
.LBB13_42:                              # %._crit_edge.i.i43
                                        #   in Loop: Header=BB13_11 Depth=1
	ori	$s7, $zero, 4
	bnez	$a0, .LBB13_52
	b	.LBB13_53
.LBB13_43:                              # %vector.ph57
                                        #   in Loop: Header=BB13_11 Depth=1
	andi	$a3, $a1, 48
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
