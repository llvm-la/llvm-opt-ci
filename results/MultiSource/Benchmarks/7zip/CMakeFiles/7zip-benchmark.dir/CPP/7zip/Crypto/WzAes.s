...
.LBB0_2:
	...
	ld.d	$s3, $a0, 56
	bne	$s3, $a2, .LBB0_4
# %bb.3:                                # %._ZN7CBufferIhE11SetCapacityEm.exit_crit_edge
	ld.d	$s0, $fp, 64
	b	.LBB0_10
.LBB0_4:
	beqz	$a2, .LBB0_11
...
.LBB1_2:
	...
	ld.d	$s3, $a0, 48
	bne	$s3, $a2, .LBB1_4
# %bb.3:                                # %._ZN7CBufferIhE11SetCapacityEm.exit_crit_edge.i
	ld.d	$s0, $fp, 56
	b	.LBB1_10
.LBB1_4:
	beqz	$a2, .LBB1_11
...
# %bb.0:
	...
	lu12i.w	$a3, -524176
	bne	$a2, $a4, .LBB6_2
# %bb.1:                                # %_ZN7NCrypto6NWzAes10CBaseCoder10SetKeyModeEj.exit
	ori	$a2, $zero, 3
	st.w	$a2, $a0, 24
	ld.bu	$a1, $a1, 0
	addi.d	$a4, $a1, -1
...
# %bb.0:
	...
	lu12i.w	$a3, -524176
	bne	$a2, $a4, .LBB7_2
# %bb.1:                                # %_ZN7NCrypto6NWzAes10CBaseCoder10SetKeyModeEj.exit.i
	ori	$a2, $zero, 3
	st.w	$a2, $a0, -568
	ld.bu	$a1, $a1, 0
	addi.d	$a4, $a1, -1
...
.LBB12_7:
	move	$a3, $a4
	move	$s2, $a1
.LBB12_8:                               # %.preheader48.preheader74
	ori	$a1, $zero, 1
	.p2align	4, , 16
.LBB12_9:                               # %.preheader48
                                        # =>This Inner Loop Header: Depth=1
...
.LBB13_6:
	...
	move	$s5, $s0
	move	$s3, $a1
.LBB13_7:                               # %.preheader48.i.preheader24
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB13_8:                               # %.preheader48.i
                                        # =>This Inner Loop Header: Depth=1
	move	$a6, $a3
	bstrpick.d	$a3, $a3, 31, 0
	ldx.b	$a7, $s2, $a3
...
# %bb.2:
	...
	move	$s3, $s4
	b	.LBB14_11
.LBB14_3:                               # %.preheader48.i.preheader
	addi.d	$a5, $s1, -1
	ori	$a1, $zero, 15
	sub.d	$a4, $a1, $a3
...
.LBB14_7:
	move	$a2, $a3
	move	$s3, $s4
.LBB14_8:                               # %.preheader48.i.preheader24
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB14_9:                               # %.preheader48.i
                                        # =>This Inner Loop Header: Depth=1
	move	$a5, $a2
...
# %bb.15:                               # %_ZeqRK4GUIDS1_.exit
	...
	ld.bu	$a3, $a3, 15
	beq	$a5, $a3, .LBB15_32
.LBB15_16:                              # %_ZeqRK4GUIDS1_.exit.thread
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit23
	...
	ld.bu	$a4, $a5, 15
	bne	$a1, $a4, .LBB15_33
.LBB15_32:                              # %_ZeqRK4GUIDS1_.exit23.thread.sink.split
	addi.d	$sp, $sp, -16
	...
	addi.d	$sp, $sp, 16
.LBB15_33:                              # %_ZeqRK4GUIDS1_.exit23.thread
	move	$a0, $a3
	ret
.Lfunc_end15:
...
# %bb.15:                               # %_ZeqRK4GUIDS1_.exit
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB28_48
.LBB28_16:                              # %_ZeqRK4GUIDS1_.exit.thread
	pcalau12i	$a3, %got_pc_hi20(IID_ICryptoSetPassword)
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit26
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB28_48
.LBB28_32:                              # %_ZeqRK4GUIDS1_.exit26.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit44
	...
	ori	$a5, $zero, 592
	bne	$a1, $a4, .LBB28_49
.LBB28_48:                              # %_ZeqRK4GUIDS1_.exit44.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB28_49:                              # %_ZeqRK4GUIDS1_.exit44.thread
	move	$a0, $a3
	ret
.Lfunc_end28:
