...
.LBB9_36:                               #   in Loop: Header=BB9_18 Depth=1
	...
	b	.LBB9_38
	.p2align	4, , 16
.LBB9_37:                               # %_ZN12CLzOutWindow7PutByteEh.exit70
                                        #   in Loop: Header=BB9_38 Depth=2
	addi.w	$a0, $s0, -1
	move	$s0, $a0
	beqz	$a0, .LBB9_92
.LBB9_38:                               # %.preheader101
                                        #   Parent Loop BB9_18 Depth=1
...
# %bb.41:                               #   in Loop: Header=BB9_38 Depth=2
	...
	b	.LBB9_37
	.p2align	4, , 16
.LBB9_42:                               #   in Loop: Header=BB9_38 Depth=2
	ori	$a1, $zero, 256
	beq	$a0, $a1, .LBB9_90
# %bb.43:                               #   in Loop: Header=BB9_38 Depth=2
	ori	$a1, $zero, 285
	bltu	$a1, $a0, .LBB9_93
# %bb.44:                               #   in Loop: Header=BB9_38 Depth=2
	ld.bu	$a1, $s1, 1410
	addi.w	$a2, $a0, -257
	...
	ori	$a1, $zero, 8
	bgeu	$a0, $a1, .LBB9_62
# %bb.45:                               # %._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i
                                        #   in Loop: Header=BB9_38 Depth=2
	ld.w	$s1, $fp, 164
.LBB9_46:                               # %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit
	...
	ldptr.w	$a1, $fp, 3452
	bgeu	$a0, $a1, .LBB9_93
# %bb.47:                               #   in Loop: Header=BB9_38 Depth=2
	...
	ori	$a0, $zero, 8
	bgeu	$a1, $a0, .LBB9_68
# %bb.48:                               # %._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i72
                                        #   in Loop: Header=BB9_38 Depth=2
	ld.w	$a0, $fp, 164
.LBB9_49:                               # %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit83
                                        #   in Loop: Header=BB9_38 Depth=2
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	sll.w	$a2, $a2, $s5
	andn	$a2, $a0, $a2
	...
	add.w	$a0, $a1, $a0
	bltu	$s7, $a1, .LBB9_53
# %bb.50:                               #   in Loop: Header=BB9_38 Depth=2
	ld.bu	$a2, $fp, 96
	beqz	$a2, .LBB9_93
# %bb.51:                               #   in Loop: Header=BB9_38 Depth=2
	ld.w	$a2, $fp, 68
	bgeu	$s7, $a2, .LBB9_93
# %bb.52:                               #   in Loop: Header=BB9_38 Depth=2
	add.w	$a0, $a2, $a0
.LBB9_53:                               #   in Loop: Header=BB9_38 Depth=2
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	sll.w	$a2, $a2, $s2
	andn	$a2, $s1, $a2
	...
	sub.w	$a2, $a3, $a1
	bgeu	$s1, $a2, .LBB9_71
# %bb.54:                               #   in Loop: Header=BB9_38 Depth=2
	ld.w	$a2, $fp, 68
	sub.w	$a2, $a2, $a0
	bgeu	$s1, $a2, .LBB9_71
# %bb.55:                               # %iter.check
...
# %bb.63:                               #   in Loop: Header=BB9_62 Depth=3
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB9_59
# %bb.64:                               # %_ZN9CInBuffer8ReadByteERh.exit.i.i
                                        #   in Loop: Header=BB9_62 Depth=3
	ld.w	$a0, $fp, 160
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 160
	...
	b	.LBB9_61
	.p2align	4, , 16
.LBB9_65:                               # %._crit_edge.i.i.i80
                                        #   in Loop: Header=BB9_68 Depth=3
	ld.d	$a0, $s3, 0
.LBB9_66:                               # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i82
                                        #   in Loop: Header=BB9_68 Depth=3
	addi.d	$a1, $a0, 1
	st.d	$a1, $s3, 0
	ld.bu	$a1, $a0, 0
.LBB9_67:                               #   in Loop: Header=BB9_68 Depth=3
	ld.w	$a2, $fp, 104
	ld.w	$a0, $fp, 164
	sub.d	$a3, $s4, $a2
	ld.w	$a4, $fp, 108
...
# %bb.69:                               #   in Loop: Header=BB9_68 Depth=3
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB9_65
# %bb.70:                               # %_ZN9CInBuffer8ReadByteERh.exit.i.i78
                                        #   in Loop: Header=BB9_68 Depth=3
	ld.w	$a0, $fp, 160
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 160
...
.LBB9_80:                               # %vec.epilog.ph
	...
	add.d	$a4, $a4, $a6
	.p2align	4, , 16
.LBB9_81:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB9_18 Depth=1
                                        #     Parent Loop BB9_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a6, $a4, 0
...
.LBB9_84:                               # %.loopexit
	...
	sub.w	$a0, $s0, $s1
	bltu	$s0, $s6, .LBB9_91
# %bb.85:                               #   in Loop: Header=BB9_38 Depth=2
	addi.d	$s1, $fp, 2047
	addi.d	$s5, $fp, 104
	ori	$s2, $zero, 4
	move	$s0, $a0
...
.LBB9_89:                               # %.backedge
	...
	bnez	$s0, .LBB9_18
	b	.LBB9_93
.LBB9_90:                               #   in Loop: Header=BB9_18 Depth=1
	ori	$a0, $zero, 3468
	ori	$a1, $zero, 1
	stx.b	$a1, $fp, $a0
	b	.LBB9_89
.LBB9_91:                               #   in Loop: Header=BB9_18 Depth=1
	sub.d	$a1, $s6, $s1
	stptr.w	$a1, $fp, 3460
	stptr.w	$s7, $fp, 3464
	move	$s0, $a0
...
.LBB9_92:
	move	$s6, $zero
.LBB9_93:                               # %_ZN12CLzOutWindow9CopyBlockEjj.exit.thread91
	move	$a0, $s6
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 40                    # 8-byte Folded Reload
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit32
	...
	ori	$a2, $zero, 8
	beq	$a4, $a0, .LBB26_65
.LBB26_32:                              # %_ZeqRK4GUIDS1_.exit32.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit50
	...
	ori	$a2, $zero, 16
	beq	$a4, $a0, .LBB26_65
.LBB26_48:                              # %_ZeqRK4GUIDS1_.exit50.thread
...
# %bb.63:                               # %_ZeqRK4GUIDS1_.exit68
	...
	ori	$a2, $zero, 24
	beq	$a3, $a0, .LBB26_65
.LBB26_64:                              # %_ZeqRK4GUIDS1_.exit68.thread
