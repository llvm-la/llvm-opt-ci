...
# %bb.32:                               #   in Loop: Header=BB5_24 Depth=1
	...
	b	.LBB5_35
.LBB5_33:                               #   in Loop: Header=BB5_35 Depth=2
	addi.w	$s8, $s8, 1
	move	$s4, $s7
.LBB5_34:                               # %_ZN9NCompress11NRangeCoder11CBitEncoderILi5EE6EncodeEPNS0_8CEncoderEj.exit297
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bltu	$a0, $s8, .LBB5_78
.LBB5_35:                               #   Parent Loop BB5_24 Depth=1
...
.Ltmp50:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp51:                                # EH_LABEL
.LBB5_37:                               # %_ZN10COutBuffer9WriteByteEh.exit290
                                        #   in Loop: Header=BB5_35 Depth=2
	andi	$a0, $s7, 254
	ori	$a1, $zero, 232
	beq	$a0, $a1, .LBB5_40
...
# %bb.39:                               # %_ZN9NCompress5NBcj23IsJEhh.exit
	...
	addi.w	$a1, $zero, -112
	bge	$a0, $a1, .LBB5_33
.LBB5_40:                               # %_ZN9NCompress5NBcj23IsJEhh.exit.thread
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a0, $fp, 16
	add.d	$a1, $s1, $a0
	ld.bu	$a4, $a1, 4
	...
	add.w	$s0, $a0, $s2
	beqz	$a3, .LBB5_46
# %bb.41:                               #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a0, $sp, 112
	add.d	$s1, $a0, $s1
	bgeu	$s3, $s1, .LBB5_56
# %bb.42:                               # %.lr.ph409.preheader
                                        #   in Loop: Header=BB5_35 Depth=2
...
# %bb.44:                               #   in Loop: Header=BB5_43 Depth=3
	bnez	$a0, .LBB5_48
# %bb.45:                               # %_ZN9CMyComPtrI25ICompressGetSubStreamSizeE7ReleaseEv.exit
	...
	bltu	$s3, $s1, .LBB5_43
	b	.LBB5_54
.LBB5_46:                               #   in Loop: Header=BB5_35 Depth=2
	addi.d	$a0, $s7, -232
	sltui	$s2, $a0, 1
	andi	$a0, $s4, 255
	addi.d	$a1, $s7, -233
	...
	beqz	$a1, .LBB5_74
.LBB5_47:                               #   in Loop: Header=BB5_35 Depth=2
	bstrpick.d	$a1, $s0, 31, 0
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	bltu	$a1, $a2, .LBB5_60
	b	.LBB5_75
.LBB5_48:                               #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB5_50
# %bb.49:                               #   in Loop: Header=BB5_35 Depth=2
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB5_98
.LBB5_50:                               #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB5_53
# %bb.51:                               #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp56:                                # EH_LABEL
	jirl	$ra, $a1, 0
...
# %bb.52:                               # %.noexc291
                                        #   in Loop: Header=BB5_35 Depth=2
	st.d	$zero, $sp, 120
.LBB5_53:                               # %_ZN9CMyComPtrI25ICompressGetSubStreamSizeE7ReleaseEv.exit.thread
                                        #   in Loop: Header=BB5_35 Depth=2
	move	$s5, $zero
...
# %bb.57:                               # %.thread317
	...
	bltu	$a1, $a3, .LBB5_60
	b	.LBB5_75
.LBB5_58:                               #   in Loop: Header=BB5_35 Depth=2
	add.d	$a0, $s2, $s1
	addi.d	$a1, $a0, 5
	addi.d	$a0, $s7, -232
	sltui	$s2, $a0, 1
	...
	or	$a0, $a0, $a2
	bgeu	$a1, $s3, .LBB5_75
# %bb.59:                               #   in Loop: Header=BB5_35 Depth=2
	bltu	$a1, $s5, .LBB5_75
.LBB5_60:                               #   in Loop: Header=BB5_35 Depth=2
	move	$s4, $a4
	slli.d	$a1, $a0, 2
	ld.wu	$a0, $fp, 208
	addi.d	$a6, $fp, 272
	...
	stx.w	$a2, $a6, $a1
	bnez	$a3, .LBB5_62
# %bb.61:                               #   in Loop: Header=BB5_35 Depth=2
	slli.d	$a0, $a0, 8
	st.w	$a0, $fp, 208
.Ltmp61:                                # EH_LABEL
	addi.d	$a0, $fp, 192
	...
	jirl	$ra, $ra, 0
.Ltmp62:                                # EH_LABEL
.LBB5_62:                               # %_ZN9NCompress11NRangeCoder11CBitEncoderILi5EE6EncodeEPNS0_8CEncoderEj.exit293
                                        #   in Loop: Header=BB5_35 Depth=2
	addi.d	$a0, $fp, 136
	masknez	$a0, $a0, $s2
	addi.d	$a1, $fp, 80
	...
	ld.w	$a1, $s7, 12
	bne	$a0, $a1, .LBB5_65
# %bb.63:                               #   in Loop: Header=BB5_35 Depth=2
.Ltmp64:                                # EH_LABEL
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.Ltmp65:                                # EH_LABEL
# %bb.64:                               # %._ZN10COutBuffer9WriteByteEh.exit295_crit_edge
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.w	$a0, $s7, 8
.LBB5_65:                               # %_ZN10COutBuffer9WriteByteEh.exit295
                                        #   in Loop: Header=BB5_35 Depth=2
	srli.d	$a1, $s0, 16
	ld.d	$a2, $s7, 0
	addi.d	$a3, $a0, 1
	...
	ld.w	$a1, $s7, 12
	bne	$a0, $a1, .LBB5_68
# %bb.66:                               #   in Loop: Header=BB5_35 Depth=2
.Ltmp66:                                # EH_LABEL
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.Ltmp67:                                # EH_LABEL
# %bb.67:                               # %._ZN10COutBuffer9WriteByteEh.exit295.1_crit_edge
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.w	$a0, $s7, 8
.LBB5_68:                               # %_ZN10COutBuffer9WriteByteEh.exit295.1
                                        #   in Loop: Header=BB5_35 Depth=2
	srli.d	$a1, $s0, 8
	ld.d	$a2, $s7, 0
	addi.d	$a3, $a0, 1
	...
	ld.w	$a1, $s7, 12
	bne	$a0, $a1, .LBB5_71
# %bb.69:                               #   in Loop: Header=BB5_35 Depth=2
.Ltmp68:                                # EH_LABEL
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.Ltmp69:                                # EH_LABEL
# %bb.70:                               # %._ZN10COutBuffer9WriteByteEh.exit295.2_crit_edge
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.w	$a0, $s7, 8
.LBB5_71:                               # %_ZN10COutBuffer9WriteByteEh.exit295.2
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a1, $s7, 0
	addi.d	$a2, $a0, 1
	st.w	$a2, $s7, 8
	...
	addi.w	$s8, $s8, 5
	bne	$a0, $a1, .LBB5_34
# %bb.72:                               #   in Loop: Header=BB5_35 Depth=2
.Ltmp70:                                # EH_LABEL
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.Ltmp71:                                # EH_LABEL
	b	.LBB5_34
.LBB5_73:                               #   in Loop: Header=BB5_35 Depth=2
	addi.d	$a0, $s7, -232
	sltui	$s2, $a0, 1
	andi	$a0, $s4, 255
	addi.d	$a1, $s7, -233
	...
	ld.d	$a5, $sp, 64                    # 8-byte Folded Reload
	bnez	$a1, .LBB5_47
.LBB5_74:                               #   in Loop: Header=BB5_35 Depth=2
	addi.d	$a1, $a4, -255
	addi.w	$a2, $zero, -254
	bltu	$a1, $a2, .LBB5_60
.LBB5_75:                               #   in Loop: Header=BB5_35 Depth=2
	slli.d	$a1, $a0, 2
	ld.wu	$a0, $fp, 208
	addi.d	$a4, $fp, 272
	ldx.w	$a2, $a4, $a1
	...
	stx.w	$a2, $a4, $a1
	bnez	$a3, .LBB5_77
# %bb.76:                               #   in Loop: Header=BB5_35 Depth=2
	slli.d	$a0, $a0, 8
	st.w	$a0, $fp, 208
.Ltmp59:                                # EH_LABEL
	addi.d	$a0, $fp, 192
...
.LBB5_77:                               #   in Loop: Header=BB5_35 Depth=2
	...
	move	$s8, $a5
	b	.LBB5_34
.LBB5_78:                               #   in Loop: Header=BB5_24 Depth=1
	ld.d	$a0, $sp, 112
	bstrpick.d	$s1, $s8, 31, 0
	add.d	$a0, $a0, $s1
	st.d	$a0, $sp, 112
...
.Ltmp73:                                # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp74:                                # EH_LABEL
# %bb.80:                               #   in Loop: Header=BB5_24 Depth=1
	bnez	$a0, .LBB5_98
.LBB5_81:                               #   in Loop: Header=BB5_24 Depth=1
	move	$s0, $zero
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	add.d	$a0, $s8, $a0
...
# %bb.86:                               # %.lr.ph426
	...
	addi.w	$s7, $zero, -112
	b	.LBB5_88
.LBB5_87:                               # %_ZN9NCompress11NRangeCoder11CBitEncoderILi5EE6EncodeEPNS0_8CEncoderEj.exit
...
.Ltmp76:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp77:                                # EH_LABEL
.LBB5_90:                               # %_ZN10COutBuffer9WriteByteEh.exit
                                        #   in Loop: Header=BB5_88 Depth=1
	beq	$s4, $s2, .LBB5_94
# %bb.91:                               # %_ZN10COutBuffer9WriteByteEh.exit
                                        #   in Loop: Header=BB5_88 Depth=1
	beq	$s4, $s5, .LBB5_95
...
.LBB5_94:                               #   in Loop: Header=BB5_88 Depth=1
	ori	$s8, $zero, 256
.LBB5_95:                               #   in Loop: Header=BB5_88 Depth=1
	slli.d	$a1, $s8, 2
	ld.wu	$a0, $fp, 208
	addi.d	$a4, $fp, 272
	ldx.w	$a2, $a4, $a1
...
# %bb.105:                              # %.noexc1.i
	st.d	$zero, $fp, 104
	move	$a0, $s0
.LBB5_106:                              # %_ZN10COutBuffer13ReleaseStreamEv.exit2.i.i
	ld.d	$a1, $fp, 160
	beqz	$a1, .LBB5_109
# %bb.107:
	ld.d	$a0, $a1, 0
...
# %bb.108:                              # %.noexc2.i
	st.d	$zero, $fp, 160
	move	$a0, $s0
.LBB5_109:                              # %_ZN10COutBuffer13ReleaseStreamEv.exit4.i.i
	ld.d	$a1, $fp, 240
	beqz	$a1, .LBB5_12
# %bb.110:
	ld.d	$a0, $a1, 0
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit23
	...
	ld.bu	$a4, $a5, 15
	bne	$a1, $a4, .LBB21_33
.LBB21_32:                              # %_ZeqRK4GUIDS1_.exit23.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB21_33:                              # %_ZeqRK4GUIDS1_.exit23.thread
	move	$a0, $a3
	ret
.Lfunc_end21:
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTVN9NCompress5NBcj28CEncoderE
	...
	.addrsig_sym _ZTVN9NCompress5NBcj28CDecoderE
