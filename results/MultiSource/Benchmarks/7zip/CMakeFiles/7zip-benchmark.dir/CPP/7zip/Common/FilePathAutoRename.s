...
.LBB0_10:
	srli.d	$s5, $a2, 2
.LBB0_11:                               # %_ZNK11CStringBaseIwE11ReverseFindEw.exit47
	st.d	$zero, $sp, 48
.Ltmp0:                                 # EH_LABEL
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(_Znam)
...
.Ltmp14:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
# %bb.24:                               # %_ZNK11CStringBaseIwE3MidEi.exit
	ld.w	$a0, $sp, 16
	st.w	$zero, $sp, 32
	addi.w	$s2, $a0, 1
	ori	$a1, $zero, 4
...
# %bb.26:
	...
	st.w	$s2, $sp, 36
	move	$s0, $s1
.LBB0_27:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i50
	ld.d	$a0, $sp, 8
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.34:
	...
	st.w	$s2, $sp, 52
	move	$s1, $s0
.LBB0_35:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i61
	ld.d	$a0, $fp, 0
	.p2align	4, , 16
...
# %bb.37:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
	ld.w	$a0, $fp, 8
	st.w	$a0, $sp, 48
.LBB0_38:                               # %_ZN11CStringBaseIwEaSERKS0_.exit68
.Ltmp20:                                # EH_LABEL
	addi.d	$a0, $sp, 40
	ori	$a1, $zero, 95
...
# %bb.44:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_45:                               # %_ZN11CStringBaseIwED2Ev.exit69
	ld.d	$a0, $sp, 40
	beqz	$a0, .LBB0_47
# %bb.46:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_47:                               # %_ZN11CStringBaseIwED2Ev.exit70
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB0_49
# %bb.48:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_49:                               # %_ZN11CStringBaseIwED2Ev.exit71
	xori	$a0, $fp, 1
...
# %bb.53:
	ld.d	$a0, $sp, 24
	bnez	$a0, .LBB0_66
.LBB0_54:                               # %_ZN11CStringBaseIwED2Ev.exit72
	ld.d	$a0, $sp, 40
	bnez	$a0, .LBB0_67
.LBB0_55:                               # %_ZN11CStringBaseIwED2Ev.exit73
	ld.d	$a0, $sp, 56
	bnez	$a0, .LBB0_68
.LBB0_56:                               # %_ZN11CStringBaseIwED2Ev.exit74
	move	$a0, $fp
...
.Lfunc_end1:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL12MakeAutoNameRK11CStringBaseIwES2_jRS0_
