...
.Ltmp18:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp19:                                # EH_LABEL
# %bb.22:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit151
                                        #   in Loop: Header=BB2_5 Depth=1
	beqz	$s7, .LBB2_59
...
.Ltmp27:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp28:                                # EH_LABEL
# %bb.33:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit153
                                        #   in Loop: Header=BB2_5 Depth=1
	beqz	$s7, .LBB2_59
...
.Ltmp39:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp40:                                # EH_LABEL
# %bb.44:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit154
                                        #   in Loop: Header=BB2_5 Depth=1
	beqz	$s7, .LBB2_59
...
.Ltmp63:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp64:                                # EH_LABEL
# %bb.49:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit160
                                        #   in Loop: Header=BB2_5 Depth=1
	beqz	$s7, .LBB2_59
...
.Ltmp78:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp79:                                # EH_LABEL
# %bb.64:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit163
                                        #   in Loop: Header=BB2_5 Depth=1
	beqz	$s8, .LBB2_77
...
# %bb.72:                               #   in Loop: Header=BB2_5 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_73:                               # %_ZN11CStringBaseIcED2Ev.exit1.i
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a0, $sp, 176
	beqz	$a0, .LBB2_75
...
# %bb.97:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_98:                               # %_ZN11CStringBaseIcED2Ev.exit1.i.us
	ld.d	$a0, $sp, 176
	beqz	$a0, .LBB2_100
# %bb.99:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp53:                                # EH_LABEL
	move	$fp, $a1
	move	$s0, $a0
.LBB2_112:                              # %_ZN11CStringBaseIcED2Ev.exit157
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB2_115
# %bb.113:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp50:                                # EH_LABEL
	move	$fp, $a1
	move	$s0, $a0
.LBB2_115:                              # %_ZN11CStringBaseIwED2Ev.exit158
	ld.d	$a0, $sp, 72
	beqz	$a0, .LBB2_124
# %bb.116:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp62:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_126:                              # %.split254.us
.Ltmp97:                                # EH_LABEL
	b	.LBB2_152
.LBB2_127:                              # %.thread.i.split.us
.Ltmp94:                                # EH_LABEL
	b	.LBB2_150
.LBB2_128:                              # %.split.us
.Ltmp91:                                # EH_LABEL
...
# %bb.0:
	...
	st.w	$s2, $fp, 12
	.p2align	4, , 16
.LBB3_1:                                # %_ZN11CStringBaseIwE11SetCapacityEi.exit
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s0, 0
	addi.d	$s0, $s0, 4
	addi.d	$a2, $a0, 4
...
.Lfunc_end5:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchive4NTarL13GetPropStringEP22IArchiveUpdateCallbackjjR11CStringBaseIcE
...
# %bb.9:
	...
	addi.w	$s1, $a0, 1
	bne	$s1, $s2, .LBB6_12
# %bb.10:                               # %._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i
	ld.d	$s0, $fp, 0
	b	.LBB6_31
.LBB6_11:
	lu12i.w	$a0, -524176
...
# %bb.26:                               # %vec.epilog.middle.block
	beq	$a2, $a1, .LBB6_29
.LBB6_27:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB6_28:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.33:                               # %_Z12MyStringCopyIcEPT_S1_PKS0_.exit.i
	ld.w	$a0, $sp, 32
	st.w	$a0, $fp, 8
.LBB6_34:                               # %_ZN11CStringBaseIcEaSERKS0_.exit
	ld.d	$a0, $sp, 24
	beqz	$a0, .LBB6_36
# %bb.35:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp116:                               # EH_LABEL
	move	$fp, $a0
.LBB6_44:                               # %_ZN11CStringBaseIcED2Ev.exit24
	ld.d	$a0, $sp, 8
	beqz	$a0, .LBB6_50
# %bb.45:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp120:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp121:                               # EH_LABEL
# %bb.51:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit26
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_52:
...
# %bb.8:                                #   in Loop: Header=BB12_4 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_9:                               # %_ZN11CStringBaseIcED2Ev.exit1.i
                                        #   in Loop: Header=BB12_4 Depth=1
	ld.d	$a0, $s2, 24
	beqz	$a0, .LBB12_2
...
# %bb.8:                                # %.noexc
	...
	st.w	$s4, $fp, 52
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
.LBB13_9:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i9
	ld.d	$a0, $s0, 40
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.14:                               # %.noexc18
	...
	st.b	$zero, $a0, 0
	st.w	$s4, $fp, 68
.LBB13_15:                              # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i14
	ld.d	$a1, $s0, 56
	.p2align	4, , 16
...
.Ltmp137:                               # EH_LABEL
	move	$s0, $a0
	bnez	$s2, .LBB13_21
# %bb.19:                               # %_ZN11CStringBaseIcED2Ev.exit
	bnez	$s1, .LBB13_23
.LBB13_20:                              # %_ZN11CStringBaseIcED2Ev.exit20
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB13_21:
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTIPKc
	.addrsig_sym _ZTV13CObjectVectorIN8NArchive4NTar11CUpdateItemEE
