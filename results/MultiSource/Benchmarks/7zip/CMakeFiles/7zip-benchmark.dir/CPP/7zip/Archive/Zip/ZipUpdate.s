...
.LBB17_119:                             #   in Loop: Header=BB17_103 Depth=1
	ori	$fp, $zero, 1
	bnez	$a0, .LBB17_131
# %bb.120:                              #   in Loop: Header=BB17_103 Depth=1
...
# %bb.139:                              # %.critedge464.i
	...
	bne	$a1, $fp, .LBB17_138
	b	.LBB17_160
.LBB17_140:                             #   in Loop: Header=BB17_103 Depth=1
	ldx.d	$s0, $a0, $a1
...
.Ltmp306:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp307:                               # EH_LABEL
# %bb.141:                              #   in Loop: Header=BB17_103 Depth=1
	st.d	$a0, $sp, 360
	st.b	$zero, $a0, 0
	vld	$vr0, $sp, 192                  # 16-byte Folded Reload
	addi.d	$a0, $sp, 384
...
# %bb.146:                              #   in Loop: Header=BB17_103 Depth=1
	...
	ori	$s7, $a0, 1
	b	.LBB17_188
.LBB17_147:                             #   in Loop: Header=BB17_103 Depth=1
	ld.d	$s0, $sp, 320
	st.b	$zero, $s2, 400
	beqz	$s0, .LBB17_149
...
.Ltmp276:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp277:                               # EH_LABEL
.LBB17_151:                             #   in Loop: Header=BB17_103 Depth=1
	ld.d	$a0, $sp, 320
	st.d	$s0, $s2, 184
	beqz	$a0, .LBB17_154
# %bb.152:                              #   in Loop: Header=BB17_103 Depth=1
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp278:                               # EH_LABEL
	jirl	$ra, $a1, 0
...
# %bb.153:                              # %.noexc506.i
                                        #   in Loop: Header=BB17_103 Depth=1
	st.d	$zero, $sp, 320
.LBB17_154:                             # %_ZN9CMyComPtrI19ISequentialInStreamE7ReleaseEv.exit.i
                                        #   in Loop: Header=BB17_103 Depth=1
	ld.d	$a0, $s2, 168
.Ltmp280:                               # EH_LABEL
...
.Ltmp282:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp283:                               # EH_LABEL
# %bb.156:                              # %_ZN19CMtCompressProgress6ReinitEv.exit.i
                                        #   in Loop: Header=BB17_103 Depth=1
	addi.d	$a0, $s2, 16
.Ltmp284:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp285:                               # EH_LABEL
# %bb.157:                              # %_ZN8NWindows16NSynchronization10CBaseEvent3SetEv.exit.i
                                        #   in Loop: Header=BB17_103 Depth=1
	st.w	$s1, $s2, 404
.Ltmp286:                               # EH_LABEL
	addi.d	$a0, $sp, 768
...
.Ltmp441:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp442:                               # EH_LABEL
.LBB17_297:                             # %_ZN9CMyComPtrI10IOutStreamED2Ev.exit71
	addi.w	$a0, $s6, 0
...
.Ltmp408:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp409:                               # EH_LABEL
# %bb.304:                              #   in Loop: Header=BB17_303 Depth=1
	ld.w	$a0, $sp, 852
	addi.d	$s0, $s0, 1
	addi.d	$fp, $fp, 8
	blt	$s0, $a0, .LBB17_303
.LBB17_305:                             # %._crit_edge.i543.i
...
# %bb.315:
	...
	jirl	$ra, $ra, 0
	b	.LBB17_285
.LBB17_316:                             # %.thread578.i.loopexit1122
	move	$s6, $s7
	b	.LBB17_301
.LBB17_317:
.Ltmp349:                               # EH_LABEL
...
.Ltmp393:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp394:                               # EH_LABEL
.LBB17_417:                             # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit553.i
	addi.d	$a0, $sp, 960
...
.Ltmp399:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp400:                               # EH_LABEL
.LBB17_448:                             # %_ZN9CMyComPtrI10IOutStreamED2Ev.exit73
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB17_449:
