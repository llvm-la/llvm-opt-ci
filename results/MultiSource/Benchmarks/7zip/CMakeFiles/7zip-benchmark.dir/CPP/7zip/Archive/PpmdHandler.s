...
# %bb.35:                               # %vec.epilog.middle.block
	beq	$a1, $s3, .LBB7_38
.LBB7_36:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $s3, $a1
	add.d	$a3, $s2, $a1
	add.d	$a1, $a0, $a1
	.p2align	4, , 16
.LBB7_37:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a1, 0
	st.b	$a4, $a3, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a1, $a1, 1
	bnez	$a2, .LBB7_37
.LBB7_38:                               # %._crit_edge.thread.i.i.i37
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $sp, 16
.LBB7_39:
...
.Ltmp57:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp58:                                # EH_LABEL
# %bb.63:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit51
	addi.w	$s1, $fp, 0
	move	$a0, $s0
...
.Lfunc_end12:
	.size	_ZN8NArchive5NPpmd13CRangeDecoderC2Ev, .Lfunc_end12-_ZN8NArchive5NPpmd13CRangeDecoderC2Ev
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchive5NPpmdL18Range_GetThresholdEPvj
...
.Lfunc_end13:
	.size	_ZN8NArchive5NPpmdL18Range_GetThresholdEPvj, .Lfunc_end13-_ZN8NArchive5NPpmdL18Range_GetThresholdEPvj
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchive5NPpmdL12Range_DecodeEPvjj
...
.Lfunc_end14:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchive5NPpmdL15Range_DecodeBitEPvj
...
.LBB15_11:                              #   in Loop: Header=BB15_13 Depth=1
	...
	ld.w	$a2, $fp, 24
	ld.w	$a1, $fp, 32
.LBB15_12:                              # %_ZN14CByteInBufWrap8ReadByteEv.exit.i.i12
...
.LBB15_18:
	ori	$a0, $zero, 1
.LBB15_19:                              # %_ZN8NArchive5NPpmdL12Range_DecodeEPvjj.exit
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 32
...
# %bb.25:
	...
	ori	$s5, $zero, 1
	bne	$a0, $a1, .LBB16_56
# %bb.26:                               # %._ZNK8NArchive5NPpmd5CItem11IsSupportedEv.exit.thread_crit_edge
	ld.w	$a2, $s2, 60
	b	.LBB16_31
.LBB16_27:
	ori	$s4, $s1, 14
...
.LBB16_30:                              # %_ZNK8NArchive5NPpmd5CItem11IsSupportedEv.exit
	...
	ori	$s5, $zero, 1
	bltu	$s5, $a2, .LBB16_56
.LBB16_31:                              # %_ZNK8NArchive5NPpmd5CItem11IsSupportedEv.exit.thread
	ld.w	$a1, $s2, 48
.Ltmp118:                               # EH_LABEL
	addi.d	$a0, $sp, 16
...
# %bb.42:                               #   in Loop: Header=BB16_40 Depth=2
	bltz	$s1, .LBB16_49
# %bb.43:                               #   in Loop: Header=BB16_40 Depth=2
	stx.b	$s1, $fp, $s8
	addi.d	$s8, $s8, 1
	bne	$s8, $s3, .LBB16_40
	b	.LBB16_48
.LBB16_44:                              # %.preheader188
                                        #   Parent Loop BB16_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
.Ltmp126:                               # EH_LABEL
	move	$a0, $s5
	...
	jirl	$ra, $ra, 0
.Ltmp127:                               # EH_LABEL
# %bb.45:                               #   in Loop: Header=BB16_44 Depth=2
	move	$s1, $a0
	lu12i.w	$a0, 6
	ori	$a0, $a0, 2128
	add.d	$a0, $sp, $a0
	ld.bu	$a0, $a0, 0
	bnez	$a0, .LBB16_49
# %bb.46:                               #   in Loop: Header=BB16_44 Depth=2
	bltz	$s1, .LBB16_49
# %bb.47:                               #   in Loop: Header=BB16_44 Depth=2
	stx.b	$s1, $fp, $s8
	addi.d	$s8, $s8, 1
	bne	$s8, $s3, .LBB16_44
...
# %bb.53:
	...
	sltu	$a0, $zero, $a0
	slli.d	$s5, $a0, 1
.LBB16_54:                              # %.threadthread-pre-split
	lu12i.w	$a0, 6
	ori	$a0, $a0, 2132
	add.d	$a0, $sp, $a0
	ld.w	$s4, $a0, 0
.LBB16_55:                              # %.thread
	bnez	$s4, .LBB16_61
.LBB16_56:                              # %_ZNK8NArchive5NPpmd5CItem11IsSupportedEv.exit.thread163
	lu12i.w	$a0, 6
	ori	$a0, $a0, 2136
	add.d	$a0, $sp, $a0
	ld.d	$a0, $a0, 0
...
# %bb.58:                               # %.noexc146
	...
	add.d	$a0, $sp, $a0
	st.d	$zero, $a0, 0
.LBB16_59:                              # %_ZN9CMyComPtrI20ISequentialOutStreamE7ReleaseEv.exit
	ld.d	$a0, $s0, 0
	ld.d	$a2, $a0, 72
.Ltmp137:                               # EH_LABEL
	move	$a0, $s0
...
.Ltmp152:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp153:                               # EH_LABEL
.LBB16_62:                              # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
.Ltmp155:                               # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(MidFree)
	jirl	$ra, $ra, 0
.Ltmp156:                               # EH_LABEL
.LBB16_63:                              # %_ZN8NArchive5NPpmd4CBufD2Ev.exit
.Ltmp158:                               # EH_LABEL
	lu12i.w	$a0, 6
	ori	$a0, $a0, 2072
	add.d	$a0, $sp, $a0
...
.Ltmp163:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB16_85:                              # %.loopexit.split-lp
.Ltmp128:                               # EH_LABEL
	b	.LBB16_87
.LBB16_86:                              # %.loopexit187
.Ltmp131:                               # EH_LABEL
.LBB16_87:
	move	$s0, $a0
	addi.d	$a0, $sp, 16
...
.Ltmp140:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp141:                               # EH_LABEL
.LBB16_89:                              # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit149
.Ltmp143:                               # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(MidFree)
	jirl	$ra, $ra, 0
.Ltmp144:                               # EH_LABEL
.LBB16_90:                              # %_ZN8NArchive5NPpmd4CBufD2Ev.exit150
.Ltmp146:                               # EH_LABEL
	lu12i.w	$a0, 6
	ori	$a0, $a0, 2072
	add.d	$a0, $sp, $a0
...
.Ltmp149:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp150:                               # EH_LABEL
.LBB16_98:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit154
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB16_99:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit26
	...
	move	$a3, $a0
	beq	$a5, $a6, .LBB22_49
.LBB22_32:                              # %_ZeqRK4GUIDS1_.exit26.thread
...
# %bb.48:
	addi.d	$a3, $a0, 8
.LBB22_49:                              # %_ZeqRK4GUIDS1_.exit44.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB22_50:                              # %_ZeqRK4GUIDS1_.exit44.thread
	move	$a0, $a3
	ret
.Lfunc_end22:
...
.Lfunc_end33:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchive5NPpmdL10SzBigAllocEPvm
...
.Lfunc_end34:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchive5NPpmdL9SzBigFreeEPvS1_
...
.Lfunc_end36:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NArchive5NPpmdL9CreateArcEv
...
.Lcst_end9:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_PpmdHandler.cpp
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTIPKc
	.addrsig_sym _ZTVN8NArchive5NPpmd8CHandlerE
