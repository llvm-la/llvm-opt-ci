...
.Lttbase0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL11SplitStringRK11CStringBaseIwER13CObjectVectorIS0_E
...
# %bb.1:                                # %.lr.ph
	...
	b	.LBB11_3
	.p2align	4, , 16
.LBB11_2:                               # %_ZN11CStringBaseIwED2Ev.exit31
...
# %bb.21:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB11_22:                              # %_ZN11CStringBaseIwED2Ev.exit32
	move	$s0, $zero
.LBB11_23:                              # %.loopexit34
	move	$a0, $s0
	...
	addi.d	$sp, $sp, 112
	ret
.LBB11_24:                              # %.loopexit.split-lp.loopexit.split-lp
.Ltmp90:                                # EH_LABEL
	b	.LBB11_27
.LBB11_25:                              # %.loopexit.split-lp.loopexit
.Ltmp93:                                # EH_LABEL
	b	.LBB11_27
.LBB11_26:                              # %.loopexit
.Ltmp85:                                # EH_LABEL
.LBB11_27:                              # %.loopexit.split-lp
	ld.d	$a1, $sp, 8
	beqz	$a1, .LBB11_29
# %bb.28:
	move	$fp, $a0
...
.LBB12_9:
	move	$a2, $zero
.LBB12_10:                              # %vec.epilog.scalar.ph.preheader
	slli.d	$a3, $a2, 2
	.p2align	4, , 16
