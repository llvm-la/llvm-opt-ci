...
.Lttbase2:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL17EnumerateDirItemsRKN9NWildcard11CCensorNodeEiiRK11CStringBaseIwERK13CObjectVectorIS4_ER9CDirItemsbP20IEnumDirItemCallbackRS8_R13CRecordVectorIjE
...
# %bb.41:                               # %.noexc.i
	...
	st.w	$zero, $a0, 0
	st.w	$s0, $s3, 12
.LBB12_42:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i277
                                        #   in Loop: Header=BB12_16 Depth=1
	ld.d	$a1, $sp, 144
	.p2align	4, , 16
...
# %bb.46:                               # %.noexc.i297
	...
	st.w	$zero, $a0, 0
	st.w	$s5, $s4, 12
.LBB12_47:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i298
                                        #   in Loop: Header=BB12_16 Depth=1
	ld.d	$a1, $sp, 312
	ori	$s5, $zero, 1
	.p2align	4, , 16
...
# %bb.60:                               # %.noexc.i287
	...
	st.w	$zero, $a0, 0
	st.w	$s0, $s3, 12
.LBB12_61:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i288
                                        #   in Loop: Header=BB12_16 Depth=1
	ld.d	$a1, $sp, 144
	.p2align	4, , 16
...
# %bb.79:                               # %.noexc.i308
	...
	st.w	$zero, $a0, 0
	st.w	$s0, $s4, 12
.LBB12_80:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i309
                                        #   in Loop: Header=BB12_16 Depth=1
	ld.d	$a1, $s3, 0
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
	.p2align	4, , 16
...
.Ltmp185:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp186:                               # EH_LABEL
# %bb.83:                               # %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit317
                                        #   in Loop: Header=BB12_16 Depth=1
	ld.w	$a0, $sp, 252
	ld.d	$a1, $sp, 256
	slli.d	$a2, $a0, 3
...
.Ltmp194:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp195:                               # EH_LABEL
# %bb.86:                               # %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit318
                                        #   in Loop: Header=BB12_16 Depth=1
	sltu	$s0, $zero, $s3
	masknez	$a0, $s6, $s0
	maskeqz	$a1, $s3, $s0
...
.LBB12_91:
	...
	st.w	$zero, $a0, 0
	st.w	$s0, $sp, 196
.LBB12_92:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i366
	ld.d	$a1, $s2, 0
	.p2align	4, , 16
.LBB12_93:                              # =>This Inner Loop Header: Depth=1
	...
	move	$a0, $a3
	bnez	$a2, .LBB12_93
# %bb.94:                               # %_ZN11CStringBaseIwEC2ERKS0_.exit.i370
	st.w	$fp, $sp, 192
.Ltmp235:                               # EH_LABEL
	addi.d	$a0, $sp, 184
	ori	$a1, $zero, 42
...
# %bb.97:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_98:                              # %_ZN11CStringBaseIwED2Ev.exit372
	move	$s1, $zero
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	addi.d	$a0, $a0, 96
	st.d	$a0, $sp, 64                    # 8-byte Folded Spill
...
# %bb.119:                              # %.noexc.i377
	...
	st.w	$zero, $a0, 0
	st.w	$s5, $s3, 12
.LBB12_120:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i378
                                        #   in Loop: Header=BB12_100 Depth=1
	ld.d	$a1, $s2, 0
	.p2align	4, , 16
...
.Ltmp253:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp254:                               # EH_LABEL
# %bb.123:                              # %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit386
                                        #   in Loop: Header=BB12_100 Depth=1
	ld.w	$a0, $s8, 12
	ld.d	$a1, $s8, 16
	slli.d	$a2, $a0, 3
...
.LBB12_125:                             #   in Loop: Header=BB12_100 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_126:                             # %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit420
                                        #   in Loop: Header=BB12_100 Depth=1
	beqz	$s4, .LBB12_99
# %bb.127:                              # %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit420
                                        #   in Loop: Header=BB12_100 Depth=1
	ori	$a0, $zero, 16
	beq	$s4, $a0, .LBB12_99
	b	.LBB12_165
...
# %bb.129:                              # %.noexc.i391
	...
	st.w	$zero, $a0, 0
	st.w	$s5, $s3, 12
.LBB12_130:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i392
                                        #   in Loop: Header=BB12_100 Depth=1
	ld.d	$a1, $sp, 224
	.p2align	4, , 16
...
.Ltmp279:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp280:                               # EH_LABEL
# %bb.137:                              # %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit405
                                        #   in Loop: Header=BB12_100 Depth=1
	addi.d	$a0, $sp, 144
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp305:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp306:                               # EH_LABEL
# %bb.140:                              # %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit418
                                        #   in Loop: Header=BB12_100 Depth=1
	addi.d	$a0, $sp, 240
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
.LBB12_159:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i409
                                        #   in Loop: Header=BB12_100 Depth=1
	ld.d	$a1, $sp, 224
	.p2align	4, , 16
...
.Ltmp299:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp300:                               # EH_LABEL
# %bb.162:                              # %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit417
                                        #   in Loop: Header=BB12_100 Depth=1
	ld.w	$a0, $sp, 252
	ld.d	$a1, $sp, 256
	slli.d	$a2, $a0, 3
...
# %bb.164:                              #   in Loop: Header=BB12_100 Depth=1
	...
	or	$s3, $a0, $a1
	b	.LBB12_139
.LBB12_165:                             # %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit420
	ori	$a0, $zero, 14
	bne	$s4, $a0, .LBB12_167
# %bb.166:                              # %.loopexit.loopexit765
	move	$s3, $zero
.LBB12_167:                             # %.loopexit
	ld.d	$a0, $sp, 312
	beqz	$a0, .LBB12_169
# %bb.168:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_169:                             # %_ZN11CStringBaseIwED2Ev.exit.i423
.Ltmp308:                               # EH_LABEL
	addi.d	$a0, $sp, 272
	pcaddu18i	$ra, %call36(_ZN8NWindows5NFile5NFind9CFindFile5CloseEv)
	jirl	$ra, $ra, 0
...
# %bb.183:                              # %.noexc329
	...
	st.w	$zero, $a0, 0
	st.w	$s5, $sp, 156
.LBB12_184:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i323
                                        #   in Loop: Header=BB12_178 Depth=1
	ld.d	$a2, $s2, 0
	addi.d	$a1, $s3, 8
	.p2align	4, , 16
.LBB12_185:                             #   Parent Loop BB12_178 Depth=1
	...
	move	$a0, $a4
	bnez	$a3, .LBB12_185
# %bb.186:                              # %_ZN11CStringBaseIwEC2ERKS0_.exit.i327
                                        #   in Loop: Header=BB12_178 Depth=1
	st.w	$s0, $sp, 152
.Ltmp200:                               # EH_LABEL
	addi.d	$a0, $sp, 144
	...
	jirl	$ra, $ra, 0
.Ltmp201:                               # EH_LABEL
# %bb.187:                              # %_ZplIwE11CStringBaseIT_ERKS2_S4_.exit332
                                        #   in Loop: Header=BB12_178 Depth=1
	st.d	$zero, $sp, 320
.Ltmp203:                               # EH_LABEL
	ori	$a0, $zero, 16
...
.Ltmp222:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp223:                               # EH_LABEL
# %bb.203:                              # %_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit359
                                        #   in Loop: Header=BB12_178 Depth=1
	addi.d	$a0, $sp, 240
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
# %bb.205:                              # %.noexc.i349
	...
	st.w	$zero, $a0, 0
	st.w	$s1, $s3, 12
.LBB12_206:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i350
                                        #   in Loop: Header=BB12_178 Depth=1
	ld.d	$a1, $sp, 144
	.p2align	4, , 16
...
.Ltmp232:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp233:                               # EH_LABEL
# %bb.209:                              # %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit358
                                        #   in Loop: Header=BB12_178 Depth=1
	ld.w	$a0, $s8, 12
	ld.d	$a1, $s8, 16
	slli.d	$a2, $a0, 3
...
.LBB12_211:                             #   in Loop: Header=BB12_178 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_212:                             # %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit361
                                        #   in Loop: Header=BB12_178 Depth=1
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB12_214
# %bb.213:                              #   in Loop: Header=BB12_178 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_214:                             # %_ZN11CStringBaseIwED2Ev.exit362
                                        #   in Loop: Header=BB12_178 Depth=1
	beq	$s0, $s4, .LBB12_177
# %bb.215:                              # %_ZN11CStringBaseIwED2Ev.exit362
                                        #   in Loop: Header=BB12_178 Depth=1
	beqz	$s0, .LBB12_177
	b	.LBB12_223
...
# %bb.217:                              # %.noexc.i337
	...
	st.w	$zero, $a0, 0
	st.w	$s1, $s3, 12
.LBB12_218:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i338
                                        #   in Loop: Header=BB12_178 Depth=1
	ld.d	$a1, $sp, 144
	.p2align	4, , 16
...
.Ltmp217:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp218:                               # EH_LABEL
# %bb.221:                              # %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit346
                                        #   in Loop: Header=BB12_178 Depth=1
	ld.w	$a0, $s8, 12
	ld.d	$a1, $s8, 16
	slli.d	$a2, $a0, 3
...
# %bb.273:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_274:                             # %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit364
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB12_276
.LBB12_275:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
# %bb.286:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_287:                             # %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit422
	addi.d	$a0, $sp, 272
	pcaddu18i	$ra, %call36(_ZN8NWindows5NFile5NFind12CEnumeratorWD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Lfunc_end15:
	.size	__clang_call_terminate, .Lfunc_end15-__clang_call_terminate
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL22EnumerateDirItems_SpecRKN9NWildcard11CCensorNodeEiiRK11CStringBaseIwES6_RK13CObjectVectorIS4_ER9CDirItemsbP20IEnumDirItemCallbackRS8_R13CRecordVectorIjE
...
# %bb.16:                               # %vec.epilog.middle.block
	beq	$a1, $s0, .LBB21_19
.LBB21_17:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $s0, $a1
	alsl.d	$a3, $a1, $fp, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB21_18:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB21_18
.LBB21_19:                              # %._crit_edge.thread.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s2
	move	$a2, $s3
...
# %bb.16:                               # %vec.epilog.middle.block
	beq	$a1, $s1, .LBB22_19
.LBB22_17:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $s1, $a1
	alsl.d	$a3, $a1, $s0, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB22_18:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB22_18
.LBB22_19:                              # %._crit_edge.thread.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s3
	ld.w	$s1, $s3, 8
...
.LBB23_9:
	move	$a2, $zero
.LBB23_10:                              # %vec.epilog.scalar.ph.preheader
	slli.d	$a3, $a2, 2
	.p2align	4, , 16
.LBB23_11:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a4, $a1, $a3
	stx.w	$a4, $a0, $a3
	addi.d	$a2, $a2, 1
