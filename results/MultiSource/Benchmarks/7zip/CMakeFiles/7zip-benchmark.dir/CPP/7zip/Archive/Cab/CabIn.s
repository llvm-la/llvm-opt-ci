...
# %bb.34:                               # %iter.check66
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB5_45
# %bb.35:                               # %vector.main.loop.iter.check53
	bgeu	$a1, $a3, .LBB5_41
# %bb.36:
	move	$a2, $zero
.LBB5_37:                               # %vec.epilog.ph70
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB5_38:                               # %vec.epilog.vector.body73
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB5_38
# %bb.39:                               # %vec.epilog.middle.block77
	bne	$a2, $a1, .LBB5_45
	b	.LBB5_47
.LBB5_40:                               # %._crit_edge.i.i14
	bnez	$a0, .LBB5_47
	b	.LBB5_48
.LBB5_41:                               # %vector.ph55
	andi	$a3, $a1, 16
...
.LBB5_42:                               # %vector.body58
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB5_42
# %bb.43:                               # %middle.block63
	beq	$a2, $a1, .LBB5_47
# %bb.44:                               # %vec.epilog.iter.check68
	bnez	$a3, .LBB5_37
.LBB5_45:                               # %vec.epilog.scalar.ph67.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB5_46:                               # %vec.epilog.scalar.ph67
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
