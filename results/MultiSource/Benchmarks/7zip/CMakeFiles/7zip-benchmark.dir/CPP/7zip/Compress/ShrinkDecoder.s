...
.LBB0_170:                              # %pred.store.if389
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_125
.LBB0_171:                              # %pred.store.if391
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 0
	vpickve2gr.h	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_126
.LBB0_172:                              # %pred.store.if393
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 1
	vpickve2gr.h	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_127
.LBB0_173:                              # %pred.store.if395
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 2
	vpickve2gr.h	$a0, $vr0, 4
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_128
.LBB0_174:                              # %pred.store.if397
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 3
	vpickve2gr.h	$a0, $vr0, 5
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_129
.LBB0_175:                              # %pred.store.if399
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 4
	vpickve2gr.h	$a0, $vr0, 6
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_130
.LBB0_176:                              # %pred.store.if401
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 5
	vpickve2gr.h	$a0, $vr0, 7
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_131
	b	.LBB0_132
.LBB0_177:                              # %pred.store.if389.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 7
	vpickve2gr.h	$a0, $vr0, 1
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_134
.LBB0_178:                              # %pred.store.if391.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 8
	vpickve2gr.h	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_135
.LBB0_179:                              # %pred.store.if393.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 9
	vpickve2gr.h	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_136
.LBB0_180:                              # %pred.store.if395.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 10
	vpickve2gr.h	$a0, $vr0, 4
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_137
.LBB0_181:                              # %pred.store.if397.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 11
	vpickve2gr.h	$a0, $vr0, 5
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_138
.LBB0_182:                              # %pred.store.if399.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 12
	vpickve2gr.h	$a0, $vr0, 6
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_139
.LBB0_183:                              # %pred.store.if401.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 13
	vpickve2gr.h	$a0, $vr0, 7
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_140
	b	.LBB0_141
.LBB0_184:                              # %pred.store.if389.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 15
	vpickve2gr.h	$a0, $vr0, 1
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_143
.LBB0_185:                              # %pred.store.if391.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 16
	vpickve2gr.h	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_144
.LBB0_186:                              # %pred.store.if393.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 17
	vpickve2gr.h	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_145
.LBB0_187:                              # %pred.store.if395.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 18
	vpickve2gr.h	$a0, $vr0, 4
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_146
.LBB0_188:                              # %pred.store.if397.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 19
	vpickve2gr.h	$a0, $vr0, 5
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_147
.LBB0_189:                              # %pred.store.if399.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 20
	vpickve2gr.h	$a0, $vr0, 6
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_148
.LBB0_190:                              # %pred.store.if401.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 21
	vpickve2gr.h	$a0, $vr0, 7
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_149
.LBB0_191:                              # %pred.store.if403.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s8, $a4, 22
	ld.bu	$a0, $a3, 24
	bnez	$a0, .LBB0_150
