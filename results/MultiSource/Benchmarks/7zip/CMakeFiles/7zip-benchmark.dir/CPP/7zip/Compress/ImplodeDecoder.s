...
# %bb.51:                               # %.noexc84
                                        #   in Loop: Header=BB6_49 Depth=2
	bnez	$a0, .LBB6_46
# %bb.52:                               # %_ZN9CInBuffer8ReadByteERh.exit.i.i
                                        #   in Loop: Header=BB6_49 Depth=2
	ld.w	$a0, $fp, 136
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 136
	...
	b	.LBB6_48
	.p2align	4, , 16
.LBB6_53:                               # %._crit_edge.i.i.i93
                                        #   in Loop: Header=BB6_56 Depth=2
	ld.d	$a0, $s1, 0
.LBB6_54:                               # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i95
                                        #   in Loop: Header=BB6_56 Depth=2
	addi.d	$a1, $a0, 1
	st.d	$a1, $s1, 0
	ld.bu	$a0, $a0, 0
...
# %bb.58:                               # %.noexc96
                                        #   in Loop: Header=BB6_56 Depth=2
	bnez	$a0, .LBB6_53
# %bb.59:                               # %_ZN9CInBuffer8ReadByteERh.exit.i.i91
                                        #   in Loop: Header=BB6_56 Depth=2
	ld.w	$a0, $fp, 136
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 136
	ori	$a0, $zero, 255
	b	.LBB6_55
.LBB6_60:                               # %._crit_edge.i.i.i106
                                        #   in Loop: Header=BB6_63 Depth=2
	ld.d	$a0, $s1, 0
.LBB6_61:                               # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i108
                                        #   in Loop: Header=BB6_63 Depth=2
	addi.d	$a1, $a0, 1
	st.d	$a1, $s1, 0
	ld.bu	$a2, $a0, 0
...
# %bb.65:                               # %.noexc109
                                        #   in Loop: Header=BB6_63 Depth=2
	bnez	$a0, .LBB6_60
# %bb.66:                               # %_ZN9CInBuffer8ReadByteERh.exit.i.i104
                                        #   in Loop: Header=BB6_63 Depth=2
	ld.w	$a0, $fp, 136
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 136
...
.Ltmp39:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp40:                                # EH_LABEL
# %bb.69:                               #   in Loop: Header=BB6_15 Depth=1
	move	$s7, $a0
	ori	$a0, $zero, 256
	bltu	$s7, $a0, .LBB6_72
	b	.LBB6_97
...
.LBB6_71:                               # %.loopexit151
	...
	st.w	$a0, $fp, 140
.LBB6_72:                               #   in Loop: Header=BB6_15 Depth=1
	ld.wu	$a0, $fp, 32
	ld.d	$a1, $fp, 24
	addi.d	$a2, $a0, 1
	st.w	$a2, $fp, 32
	...
	ori	$s0, $zero, 1
	bne	$a0, $a1, .LBB6_14
# %bb.73:                               #   in Loop: Header=BB6_15 Depth=1
.Ltmp42:                                # EH_LABEL
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.Ltmp43:                                # EH_LABEL
	b	.LBB6_14
.LBB6_74:                               # %._crit_edge.i.i.i122
                                        #   in Loop: Header=BB6_77 Depth=2
	ld.d	$a0, $s1, 0
.LBB6_75:                               # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i124
                                        #   in Loop: Header=BB6_77 Depth=2
	addi.d	$a1, $a0, 1
	st.d	$a1, $s1, 0
	ld.bu	$a0, $a0, 0
...
# %bb.79:                               # %.noexc125
                                        #   in Loop: Header=BB6_77 Depth=2
	bnez	$a0, .LBB6_74
# %bb.80:                               # %_ZN9CInBuffer8ReadByteERh.exit.i.i120
                                        #   in Loop: Header=BB6_77 Depth=2
	ld.w	$a0, $fp, 136
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 136
...
# %bb.82:                               #   in Loop: Header=BB6_15 Depth=1
	ld.w	$a2, $fp, 44
	bgeu	$s0, $a2, .LBB6_13
# %bb.83:                               #   in Loop: Header=BB6_15 Depth=1
	add.w	$a0, $a2, $a0
	ld.w	$a2, $fp, 36
	sub.w	$a2, $a2, $a1
	bltu	$s6, $a2, .LBB6_41
...
.LBB6_85:                               # %.noexc113
	...
	addi.w	$a0, $s2, 1
	beqz	$s0, .LBB6_13
.LBB6_86:                               #   Parent Loop BB6_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a1, $fp, 44
	xor	$a1, $a0, $a1
	sltui	$a1, $a1, 1
...
.LBB6_96:                               # %vec.epilog.scalar.ph
	...
	bnez	$a0, .LBB6_96
	b	.LBB6_13
.LBB6_97:                               # %_ZN9NCompress8NImplode8NDecoder6CCoder10ReadTablesEv.exit.thread130
	ori	$s6, $zero, 1
.LBB6_98:                               # %_ZN9NCompress8NImplode8NDecoder6CCoder10ReadTablesEv.exit.thread
	ld.d	$a0, $fp, 48
	beqz	$a0, .LBB6_101
# %bb.99:
	ld.d	$a1, $a0, 0
...
# %bb.100:                              # %.noexc.i
	st.d	$zero, $fp, 48
.LBB6_101:                              # %_ZN10COutBuffer13ReleaseStreamEv.exit.i.i
	ld.d	$a0, $fp, 112
	beqz	$a0, .LBB6_104
# %bb.102:
	ld.d	$a1, $a0, 0
...
.Ltmp70:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_114:                              # %.loopexit.split-lp153
.Ltmp65:                                # EH_LABEL
	b	.LBB6_121
.LBB6_115:                              # %.loopexit140
.Ltmp62:                                # EH_LABEL
	b	.LBB6_121
.LBB6_116:                              # %.loopexit.split-lp.loopexit.split-lp
.Ltmp56:                                # EH_LABEL
	b	.LBB6_121
.LBB6_117:                              # %.loopexit147
.Ltmp38:                                # EH_LABEL
	b	.LBB6_121
.LBB6_118:                              # %.loopexit.split-lp.loopexit
.Ltmp59:                                # EH_LABEL
	b	.LBB6_121
.LBB6_119:
.Ltmp47:                                # EH_LABEL
	b	.LBB6_121
.LBB6_120:                              # %.loopexit152
.Ltmp35:                                # EH_LABEL
.LBB6_121:                              # %.loopexit.split-lp
	move	$fp, $a0
	addi.d	$a0, $sp, 24
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTVN9NCompress8NImplode8NDecoder6CCoderE
