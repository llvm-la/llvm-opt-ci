...
# %bb.30:
	...
	ld.bu	$a3, $a0, 14
	bne	$a2, $a3, .LBB50_32
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit82
	ld.bu	$a2, $s1, 15
	ld.bu	$a3, $a0, 15
	move	$a0, $fp
	beq	$a2, $a3, .LBB50_90
.LBB50_32:                              # %_ZeqRK4GUIDS1_.exit82.thread
...
# %bb.48:
	addi.d	$a0, $fp, 8
	b	.LBB50_90
.LBB50_49:                              # %_ZeqRK4GUIDS1_.exit100.thread
...
# %bb.65:
	addi.d	$a0, $fp, 16
	b	.LBB50_90
.LBB50_66:                              # %_ZeqRK4GUIDS1_.exit118.thread
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV12CFilterCoder
	.addrsig_sym _ZTIi
