...
# %bb.51:                               # %vector.ph
	...
	vld	$vr2, $a0, %pc_lo12(.LCPI21_1)
	pcalau12i	$a0, %pc_hi20(.LCPI21_2)
	vld	$vr3, $a0, %pc_lo12(.LCPI21_2)
	pcalau12i	$a0, %pc_hi20(.LCPI21_3)
	vld	$vr4, $a0, %pc_lo12(.LCPI21_3)
	vsle.du	$vr2, $vr2, $vr1
...
.LBB21_105:                             #   in Loop: Header=BB21_98 Depth=1
	beqz	$s6, .LBB21_115
# %bb.106:                              #   in Loop: Header=BB21_98 Depth=1
	ld.bu	$a1, $sp, 392
	slli.d	$a2, $a1, 2
...
.LBB21_109:                             # %vector.body435
	...
	addi.w	$a4, $a4, 8
	bnez	$a5, .LBB21_109
# %bb.110:                              # %middle.block436
                                        #   in Loop: Header=BB21_98 Depth=1
	addi.w	$a3, $a3, 0
	beq	$s6, $a3, .LBB21_114
# %bb.111:                              #   in Loop: Header=BB21_98 Depth=1
	st.d	$s3, $sp, 112                   # 8-byte Folded Spill
	move	$s6, $a2
.LBB21_112:                             # %scalar.ph.preheader
                                        #   in Loop: Header=BB21_98 Depth=1
...
.LBB21_113:                             # %scalar.ph
	...
	stx.w	$a1, $a3, $a2
	bnez	$s6, .LBB21_113
.LBB21_114:                             #   in Loop: Header=BB21_98 Depth=1
	move	$fp, $zero
	b	.LBB21_116
.LBB21_115:                             #   in Loop: Header=BB21_98 Depth=1
	ld.d	$s3, $sp, 112                   # 8-byte Folded Reload
.LBB21_116:                             # %.loopexit
                                        #   in Loop: Header=BB21_98 Depth=1
...
# %bb.118:                              #   in Loop: Header=BB21_98 Depth=1
	slli.d	$a1, $a0, 2
	ld.d	$a3, $sp, 80                    # 8-byte Folded Reload
	ldx.w	$a2, $a3, $a1
	addi.d	$a2, $a2, 1
...
.LBB21_121:                             # %pred.store.if
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_53
.LBB21_122:                             # %pred.store.if418
	ori	$a0, $zero, 1
	st.b	$a0, $sp, 135
	vpickve2gr.h	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_54
.LBB21_123:                             # %pred.store.if420
	ori	$a0, $zero, 2
	st.b	$a0, $sp, 136
	vpickve2gr.h	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_55
.LBB21_124:                             # %pred.store.if422
	ori	$a0, $zero, 3
	st.b	$a0, $sp, 137
	vpickve2gr.h	$a0, $vr0, 4
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_56
.LBB21_125:                             # %pred.store.if424
	ori	$a0, $zero, 4
	st.b	$a0, $sp, 138
	vpickve2gr.h	$a0, $vr0, 5
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_57
.LBB21_126:                             # %pred.store.if426
	ori	$a0, $zero, 5
	st.b	$a0, $sp, 139
	vpickve2gr.h	$a0, $vr0, 6
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_58
.LBB21_127:                             # %pred.store.if428
	ori	$a0, $zero, 6
	st.b	$a0, $sp, 140
	vpickve2gr.h	$a0, $vr0, 7
	andi	$a0, $a0, 1
