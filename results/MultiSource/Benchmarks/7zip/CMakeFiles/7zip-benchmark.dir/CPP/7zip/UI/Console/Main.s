...
# %bb.62:                               # %iter.check685
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB0_72
# %bb.63:                               # %vector.main.loop.iter.check672
                                        #   in Loop: Header=BB0_55 Depth=2
	ori	$a0, $zero, 16
	bgeu	$s6, $a0, .LBB0_65
...
.LBB0_66:                               # %vector.body677
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB0_66
# %bb.67:                               # %middle.block682
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a0, $s6, .LBB0_74
# %bb.68:                               # %vec.epilog.iter.check687
                                        #   in Loop: Header=BB0_55 Depth=2
	beqz	$a1, .LBB0_72
.LBB0_69:                               # %vec.epilog.ph689
                                        #   in Loop: Header=BB0_55 Depth=2
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s2, 2
	.p2align	4, , 16
.LBB0_70:                               # %vec.epilog.vector.body692
                                        #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB0_70
# %bb.71:                               # %vec.epilog.middle.block696
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a0, $s6, .LBB0_74
.LBB0_72:                               # %vec.epilog.scalar.ph686.preheader
                                        #   in Loop: Header=BB0_55 Depth=2
	sub.d	$a1, $s6, $a0
	alsl.d	$a2, $a0, $s3, 2
	alsl.d	$a0, $a0, $s2, 2
	.p2align	4, , 16
.LBB0_73:                               # %vec.epilog.scalar.ph686
                                        #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a3, $a0, 0
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB0_73
.LBB0_74:                               # %._crit_edge.thread.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=2
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp82:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp83:                                # EH_LABEL
# %bb.81:                               #   in Loop: Header=BB0_55 Depth=2
.Ltmp84:                                # EH_LABEL
	addi.d	$a0, $sp, 136
	ori	$a1, $zero, 41
...
# %bb.84:                               #   in Loop: Header=BB0_55 Depth=2
	...
	addi.w	$s8, $a0, 1
	beq	$s8, $fp, .LBB0_53
# %bb.85:                               #   in Loop: Header=BB0_55 Depth=2
	slti	$a0, $a0, -1
	slli.d	$a1, $s8, 2
	masknez	$a1, $a1, $a0
	addi.w	$a2, $zero, -1
...
# %bb.99:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a1, $s3, .LBB0_102
.LBB0_100:                              # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB0_55 Depth=2
	sub.d	$a2, $s3, $a1
	alsl.d	$a3, $a1, $s2, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB0_101:                              # %vec.epilog.scalar.ph
                                        #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a4, $a1, 0
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB0_101
.LBB0_102:                              # %._crit_edge.thread.i.i.i347
                                        #   in Loop: Header=BB0_55 Depth=2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $sp, 144
.LBB0_103:                              #   in Loop: Header=BB0_55 Depth=2
	st.d	$s2, $sp, 136
	slli.d	$a0, $s3, 2
	stx.w	$zero, $s2, $a0
	st.w	$s8, $sp, 148
...
# %bb.108:                              # %.noexc336
	...
	slli.d	$a0, $fp, 31
	bgez	$a0, .LBB0_107
.LBB0_109:                              # %_ZL11PrintStringR13CStdOutStreamRK11CStringBaseIwEi.exit337
                                        #   in Loop: Header=BB0_39 Depth=1
.Ltmp94:                                # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.1)
...
# %bb.111:                              # %.lr.ph477
	...
	move	$fp, $zero
	.p2align	4, , 16
.LBB0_112:                              #   Parent Loop BB0_39 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s1, 88
	ldx.b	$a0, $a0, $fp
	andi	$s2, $a0, 255
...
.Ltmp104:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp105:                               # EH_LABEL
# %bb.119:                              #   in Loop: Header=BB0_39 Depth=1
	ld.d	$a0, $sp, 136
	ld.d	$fp, $sp, 64                    # 8-byte Folded Reload
	beqz	$a0, .LBB0_38
# %bb.120:                              #   in Loop: Header=BB0_39 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_38
.LBB0_121:
...
.Ltmp35:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp36:                                # EH_LABEL
# %bb.122:                              # %_ZNK11CStringBaseIwE13CompareNoCaseEPKw.exit
	move	$a4, $a0
	ld.d	$a0, $s0, 8
	ld.w	$a1, $sp, 1084
	ld.w	$a2, $sp, 1088
...
.Ltmp291:                               # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp292:                               # EH_LABEL
# %bb.132:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackEC2EPS0_.exit
	ld.b	$a0, $sp, 592
	ld.d	$s4, $s1, 24
	st.d	$s0, $s1, 72
	st.b	$a0, $s1, 20
...
# %bb.155:                              # %.noexc598
	move	$s1, $a0
	blez	$s3, .LBB0_162
# %bb.156:                              # %._crit_edge.thread.i.i596
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 960
...
.LBB0_163:
	...
	ori	$a0, $zero, 10
	st.w	$a0, $sp, 964
.LBB0_164:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i592
...
# %bb.168:
	...
	st.w	$s4, $sp, 436
	move	$s2, $s1
.LBB0_169:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i396
	ld.d	$s4, $sp, 600
	move	$a0, $zero
	addi.d	$s1, $sp, 744
	.p2align	4, , 16
...
# %bb.174:
	...
	st.w	$fp, $sp, 228
	move	$a0, $s2
.LBB0_175:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i405.preheader
	addi.d	$a1, $sp, 240
	addi.d	$s2, $sp, 272
	.p2align	4, , 16
.LBB0_176:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i405
...
# %bb.194:                              # %.lr.ph486
	...
	b	.LBB0_196
	.p2align	4, , 16
.LBB0_195:                              # %_ZN11CStringBaseIwED2Ev.exit422
...
.Ltmp178:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp179:                               # EH_LABEL
# %bb.200:                              # %_ZN8NWindows6NError16MyFormatMessageWEj.exit
                                        #   in Loop: Header=BB0_196 Depth=1
	ld.d	$a1, $sp, 384
.Ltmp181:                               # EH_LABEL
	move	$a0, $s0
	...
	jirl	$ra, $ra, 0
.Ltmp182:                               # EH_LABEL
# %bb.201:                              #   in Loop: Header=BB0_196 Depth=1
.Ltmp183:                               # EH_LABEL
	move	$a1, $s4
	pcaddu18i	$ra, %call36(_ZN13CStdOutStreamlsEPFRS_S0_E)
	jirl	$ra, $ra, 0
.Ltmp184:                               # EH_LABEL
# %bb.202:                              #   in Loop: Header=BB0_196 Depth=1
	ld.d	$a0, $sp, 384
	beqz	$a0, .LBB0_195
# %bb.203:                              #   in Loop: Header=BB0_196 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_195
.LBB0_204:                              # %._crit_edge487
.Ltmp186:                               # EH_LABEL
...
# %bb.220:                              # %.lr.ph489
	...
	b	.LBB0_222
	.p2align	4, , 16
.LBB0_221:                              # %_ZN11CStringBaseIwED2Ev.exit435
...
.Ltmp247:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp248:                               # EH_LABEL
# %bb.226:                              # %_ZN8NWindows6NError16MyFormatMessageWEj.exit434
                                        #   in Loop: Header=BB0_222 Depth=1
	ld.d	$a1, $sp, 384
.Ltmp250:                               # EH_LABEL
	move	$a0, $s0
...
# %bb.242:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_243:                              # %_ZN11CStringBaseIwED2Ev.exit.i437
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB0_245
# %bb.244:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_245:                              # %_ZN11CStringBaseIwED2Ev.exit1.i
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB0_247
# %bb.246:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
# %bb.248:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_314
.LBB0_249:                              # %.lr.ph483.split.preheader
	move	$fp, $zero
	move	$s2, $zero
	b	.LBB0_252
.LBB0_250:                              # %_ZN11CStringBaseIwED2Ev.exit417
...
# %bb.264:
	...
	st.w	$s6, $sp, 436
	move	$s3, $s4
.LBB0_265:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i364
	move	$a0, $zero
	.p2align	4, , 16
...
# %bb.272:                              # %.noexc379
	move	$s3, $a0
	blez	$s4, .LBB0_274
# %bb.273:                              # %._crit_edge.thread.i.i377
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 160
...
.LBB0_275:
	...
	stx.w	$zero, $s3, $a0
	st.w	$fp, $sp, 164
.LBB0_276:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373
	ld.d	$a0, $sp, 624
	addi.d	$s2, $sp, 168
	.p2align	4, , 16
...
# %bb.283:                              # %.noexc383
	...
	addi.d	$s3, $s3, 8
	bne	$fp, $s3, .LBB0_282
.LBB0_284:                              # %_ZN13CObjectVectorI9CPropertyEaSERKS1_.exit
	ori	$a0, $zero, 0
	lu32i.d	$a0, 4
	st.d	$a0, $sp, 392
.Ltmp318:                               # EH_LABEL
...
# %bb.310:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_311:                              # %_ZN11CStringBaseIwED2Ev.exit442
	addi.d	$a0, $sp, 136
...
.LBB0_315:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit
	addi.d	$a0, $sp, 472
...
# %bb.342:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_343:                              # %_ZN11CStringBaseIwED2Ev.exit387
	addi.d	$a0, $sp, 136
	pcaddu18i	$ra, %call36(_ZN15CExtractOptionsD2Ev)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 424
...
# %bb.375:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_376:                              # %_ZN11CStringBaseIwED2Ev.exit427
.Ltmp222:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.23)
	addi.d	$a1, $a0, %pc_lo12(.L.str.23)
	addi.d	$a0, $sp, 384
...
.LBB0_439:
.Ltmp407:                               # EH_LABEL
.LBB0_440:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit449
	move	$s0, $a0
	b	.LBB0_470
.LBB0_441:
.Ltmp118:                               # EH_LABEL
...
.LBB0_452:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_453:                              # %_ZN20COpenCallbackConsoleD2Ev.exit441
	ld.d	$s8, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_468
.LBB0_454:
.Ltmp106:                               # EH_LABEL
...
.LBB0_457:
	...
	jirl	$ra, $ra, 0
.LBB0_458:                              # %.loopexit.split-lp465
.Ltmp96:                                # EH_LABEL
	b	.LBB0_465
.LBB0_459:                              # %.loopexit.split-lp470
.Ltmp74:                                # EH_LABEL
	b	.LBB0_462
.LBB0_460:                              # %.loopexit464
.Ltmp93:                                # EH_LABEL
	b	.LBB0_465
.LBB0_461:                              # %.loopexit469
.Ltmp71:                                # EH_LABEL
.LBB0_462:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackED2Ev.exit393
	move	$s0, $a0
	b	.LBB0_468
.LBB0_463:
.Ltmp88:                                # EH_LABEL
...
# %bb.467:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_468:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackED2Ev.exit393
	addi.d	$a0, $sp, 440
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB0_469:
...
.Ltmp402:                               # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp403:                               # EH_LABEL
.LBB0_470:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit449
	addi.d	$a0, $sp, 472
	pcaddu18i	$ra, %call36(_ZN18NCommandLineParser7CParserD1Ev)
	jirl	$ra, $ra, 0
.LBB0_471:
...
.Lttbase0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL20ShowCopyrightAndHelpR13CStdOutStreamb
...
# %bb.15:                               # %vec.epilog.middle.block
	beq	$a1, $s3, .LBB5_18
.LBB5_16:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $s3, $a1
	alsl.d	$a3, $a1, $s2, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB5_17:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
...
.Lttbase2:
	...
	.p2align	2                               # -- Begin function _ZL16PrintHelpAndExitR13CStdOutStream
...
.Lfunc_end52:
	...
	.cfi_endproc
                                        # -- End function
	.section	.text.unlikely.,"ax",@progbits
	.p2align	2                               # -- Begin function _ZL28ShowMessageAndThrowExceptionR13CStdOutStreamPKcN9NExitCode5EEnumE
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV13CObjectVectorI9CPropertyE
	.addrsig_sym _ZTI13CObjectVectorI9CPropertyE
	.addrsig_sym _ZTS13CObjectVectorI9CPropertyE
	.addrsig_sym _ZTV13CObjectVectorI21CUpdateArchiveCommandE
	...
	.addrsig_sym _ZTV13CObjectVectorI10CArcInfoExE
	...
	.addrsig_sym _ZTV13CObjectVectorI11CArcExtInfoE
	.addrsig_sym _ZTI13CObjectVectorI11CArcExtInfoE
	.addrsig_sym _ZTS13CObjectVectorI11CArcExtInfoE
	.addrsig_sym _ZTV23CExtractCallbackConsole
	.addrsig_sym _ZTV20COpenCallbackConsole
	.addrsig_sym _ZTV22CUpdateCallbackConsole
