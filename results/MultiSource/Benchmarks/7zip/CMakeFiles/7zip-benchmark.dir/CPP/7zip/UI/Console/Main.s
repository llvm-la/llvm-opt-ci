...
.LBB0_64:                               # %vector.body669
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB0_64
# %bb.65:                               # %middle.block674
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a0, $s7, .LBB0_68
.LBB0_66:                               # %scalar.ph664.preheader
                                        #   in Loop: Header=BB0_55 Depth=2
	sub.d	$a1, $s7, $a0
	alsl.d	$a2, $a0, $s3, 2
	alsl.d	$a0, $a0, $s2, 2
	.p2align	4, , 16
.LBB0_67:                               # %scalar.ph664
                                        #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a3, $a0, 0
...
.LBB0_88:                               # %scalar.ph
	...
	bnez	$a2, .LBB0_88
	b	.LBB0_90
.LBB0_89:                               # %._crit_edge.i.i.i346
                                        #   in Loop: Header=BB0_55 Depth=2
	beqz	$a0, .LBB0_91
.LBB0_90:                               # %._crit_edge.thread.i.i.i347
                                        #   in Loop: Header=BB0_55 Depth=2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $sp, 144
.LBB0_91:                               #   in Loop: Header=BB0_55 Depth=2
	st.d	$s2, $sp, 136
	slli.d	$a0, $s3, 2
	stx.w	$zero, $s2, $a0
	st.w	$s6, $sp, 148
...
# %bb.96:                               # %.noexc336
	...
	slli.d	$a0, $fp, 31
	bgez	$a0, .LBB0_95
.LBB0_97:                               # %_ZL11PrintStringR13CStdOutStreamRK11CStringBaseIwEi.exit337
                                        #   in Loop: Header=BB0_39 Depth=1
.Ltmp94:                                # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.1)
...
.Ltmp99:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp100:                               # EH_LABEL
# %bb.104:                              #   in Loop: Header=BB0_100 Depth=2
.Ltmp101:                               # EH_LABEL
	ori	$a1, $zero, 32
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN13CStdOutStreamlsEc)
...
.Ltmp35:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp36:                                # EH_LABEL
# %bb.110:                              # %_ZNK11CStringBaseIwE13CompareNoCaseEPKw.exit
	move	$a4, $a0
	ld.d	$a0, $s0, 8
	ld.w	$a1, $sp, 1084
	ld.w	$a2, $sp, 1088
...
.Ltmp291:                               # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp292:                               # EH_LABEL
# %bb.120:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackEC2EPS0_.exit
	ld.b	$a0, $sp, 592
	ld.d	$s4, $s1, 24
	st.d	$s0, $s1, 72
	st.b	$a0, $s1, 20
...
# %bb.143:                              # %.noexc598
	move	$s1, $a0
	blez	$s3, .LBB0_150
# %bb.144:                              # %._crit_edge.thread.i.i596
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 960
...
.LBB0_151:
	...
	ori	$a0, $zero, 10
	st.w	$a0, $sp, 964
.LBB0_152:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i592
...
# %bb.156:
	...
	st.w	$s4, $sp, 436
	move	$s2, $s1
.LBB0_157:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i396
	ld.d	$s4, $sp, 600
	move	$a0, $zero
	addi.d	$s1, $sp, 744
	.p2align	4, , 16
...
# %bb.162:
	...
	st.w	$fp, $sp, 228
	move	$a0, $s2
.LBB0_163:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i405.preheader
	addi.d	$a1, $sp, 240
	addi.d	$s2, $sp, 272
	.p2align	4, , 16
.LBB0_164:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i405
...
# %bb.182:                              # %.lr.ph486
	...
	b	.LBB0_184
	.p2align	4, , 16
.LBB0_183:                              # %_ZN11CStringBaseIwED2Ev.exit422
...
.Ltmp178:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp179:                               # EH_LABEL
# %bb.188:                              # %_ZN8NWindows6NError16MyFormatMessageWEj.exit
                                        #   in Loop: Header=BB0_184 Depth=1
	ld.d	$a1, $sp, 384
.Ltmp181:                               # EH_LABEL
	move	$a0, $s0
...
# %bb.208:                              # %.lr.ph489
	...
	b	.LBB0_210
	.p2align	4, , 16
.LBB0_209:                              # %_ZN11CStringBaseIwED2Ev.exit435
...
.Ltmp247:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp248:                               # EH_LABEL
# %bb.214:                              # %_ZN8NWindows6NError16MyFormatMessageWEj.exit434
                                        #   in Loop: Header=BB0_210 Depth=1
	ld.d	$a1, $sp, 384
.Ltmp250:                               # EH_LABEL
	move	$a0, $s0
	...
	jirl	$ra, $ra, 0
.Ltmp251:                               # EH_LABEL
# %bb.215:                              #   in Loop: Header=BB0_210 Depth=1
.Ltmp252:                               # EH_LABEL
	move	$a1, $s3
	pcaddu18i	$ra, %call36(_ZN13CStdOutStreamlsEPFRS_S0_E)
	jirl	$ra, $ra, 0
...
# %bb.216:                              #   in Loop: Header=BB0_210 Depth=1
	ld.d	$a0, $sp, 384
	beqz	$a0, .LBB0_209
# %bb.217:                              #   in Loop: Header=BB0_210 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_209
.LBB0_218:                              # %._crit_edge490
.Ltmp255:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.19)
	addi.d	$a1, $a0, %pc_lo12(.L.str.19)
	move	$a0, $s0
...
# %bb.230:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_231:                              # %_ZN11CStringBaseIwED2Ev.exit.i437
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB0_233
# %bb.232:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_233:                              # %_ZN11CStringBaseIwED2Ev.exit1.i
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB0_235
# %bb.234:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
# %bb.236:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_302
.LBB0_237:                              # %.lr.ph483.split.preheader
	move	$fp, $zero
	move	$s2, $zero
	b	.LBB0_240
.LBB0_238:                              # %_ZN11CStringBaseIwED2Ev.exit417
...
# %bb.243:                              #   in Loop: Header=BB0_240 Depth=1
	ld.d	$a0, $sp, 384
	beqz	$a0, .LBB0_238
# %bb.244:                              #   in Loop: Header=BB0_240 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_238
.LBB0_245:
...
# %bb.252:
	...
	st.w	$s6, $sp, 436
	move	$s3, $s4
.LBB0_253:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i364
	move	$a0, $zero
	ld.d	$s6, $sp, 56                    # 8-byte Folded Reload
	.p2align	4, , 16
...
# %bb.260:                              # %.noexc379
	move	$s3, $a0
	blez	$s4, .LBB0_262
# %bb.261:                              # %._crit_edge.thread.i.i377
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 160
...
.LBB0_263:
	...
	stx.w	$zero, $s3, $a0
	st.w	$fp, $sp, 164
.LBB0_264:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373
	ld.d	$a0, $sp, 624
	addi.d	$s2, $sp, 168
	.p2align	4, , 16
...
# %bb.271:                              # %.noexc383
	...
	addi.d	$s3, $s3, 8
	bne	$fp, $s3, .LBB0_270
.LBB0_272:                              # %_ZN13CObjectVectorI9CPropertyEaSERKS1_.exit
	ori	$a0, $zero, 0
	lu32i.d	$a0, 4
	st.d	$a0, $sp, 392
.Ltmp318:                               # EH_LABEL
...
# %bb.298:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_299:                              # %_ZN11CStringBaseIwED2Ev.exit442
	addi.d	$a0, $sp, 136
...
.LBB0_303:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit
	addi.d	$a0, $sp, 472
...
# %bb.330:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_331:                              # %_ZN11CStringBaseIwED2Ev.exit387
	addi.d	$a0, $sp, 136
	pcaddu18i	$ra, %call36(_ZN15CExtractOptionsD2Ev)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 424
...
# %bb.363:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_364:                              # %_ZN11CStringBaseIwED2Ev.exit427
.Ltmp222:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.23)
	addi.d	$a1, $a0, %pc_lo12(.L.str.23)
	addi.d	$a0, $sp, 384
...
.LBB0_427:
.Ltmp407:                               # EH_LABEL
.LBB0_428:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit449
	move	$s0, $a0
	b	.LBB0_458
.LBB0_429:
.Ltmp118:                               # EH_LABEL
...
.LBB0_440:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_441:                              # %_ZN20COpenCallbackConsoleD2Ev.exit441
	ld.d	$s6, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_456
.LBB0_442:
.Ltmp106:                               # EH_LABEL
...
.LBB0_445:
	...
	jirl	$ra, $ra, 0
.LBB0_446:                              # %.loopexit.split-lp465
.Ltmp96:                                # EH_LABEL
	b	.LBB0_453
.LBB0_447:                              # %.loopexit.split-lp470
.Ltmp74:                                # EH_LABEL
	b	.LBB0_450
.LBB0_448:                              # %.loopexit464
.Ltmp93:                                # EH_LABEL
	b	.LBB0_453
.LBB0_449:                              # %.loopexit469
.Ltmp71:                                # EH_LABEL
.LBB0_450:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackED2Ev.exit393
	move	$s0, $a0
	b	.LBB0_456
.LBB0_451:
.Ltmp88:                                # EH_LABEL
...
# %bb.455:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_456:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackED2Ev.exit393
	addi.d	$a0, $sp, 440
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB0_457:
...
.Ltmp402:                               # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp403:                               # EH_LABEL
.LBB0_458:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit449
	addi.d	$a0, $sp, 472
	pcaddu18i	$ra, %call36(_ZN18NCommandLineParser7CParserD1Ev)
	jirl	$ra, $ra, 0
.LBB0_459:
