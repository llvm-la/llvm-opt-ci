...
# %bb.10:                               #   in Loop: Header=BB0_9 Depth=1
	...
	addi.d	$a2, $a2, 1
	bnez	$a4, .LBB0_9
.LBB0_11:                               # %_ZeqIhEbRK7CBufferIT_ES4_.exit
	ret
.LBB0_12:
	move	$a0, $zero
	ret
...
.LBB2_14:                               # %.lr.ph.split.us
	...
	b	.LBB2_16
	.p2align	4, , 16
.LBB2_15:                               # %.critedge.us.us
                                        #   in Loop: Header=BB2_16 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$a2, $a2, 8
	beq	$a0, $s2, .LBB2_37
.LBB2_16:                               # %.lr.ph.split.us.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s3, $a2, 0
	ld.w	$a4, $s3, 4
	bnez	$a4, .LBB2_15
...
# %bb.21:                               #   in Loop: Header=BB2_20 Depth=1
	ld.w	$a6, $s3, 0
	bne	$a3, $a6, .LBB2_19
# %bb.22:                               # %.preheader.i.us
                                        #   in Loop: Header=BB2_20 Depth=1
	ld.d	$a6, $s3, 32
	bne	$a4, $a6, .LBB2_19
# %bb.23:                               # %.preheader.i.i.us
                                        #   in Loop: Header=BB2_20 Depth=1
	ld.d	$a6, $s3, 40
	move	$a7, $a5
	move	$t0, $a4
...
.LBB14_8:
	move	$a3, $zero
.LBB14_9:                               # %vec.epilog.scalar.ph.preheader
	add.d	$t2, $a3, $a0
	addi.d	$t2, $t2, 72
	add.d	$t0, $t0, $t1
	sub.d	$a3, $t0, $a3
	.p2align	4, , 16
.LBB14_10:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ldx.b	$t0, $a1, $a2
	addi.d	$a2, $a2, 1
	st.b	$t0, $t2, 0
	...
	addi.d	$t2, $t2, 1
	bnez	$a3, .LBB14_10
# %bb.11:                               # %.preheader.loopexit.loopexit
	bstrpick.d	$a2, $a2, 31, 0
	b	.LBB14_13
.LBB14_12:
	ori	$a2, $zero, 2
...
.LBB14_16:
	move	$a3, $zero
	move	$t0, $a2
.LBB14_17:                              # %vec.epilog.scalar.ph78.preheader
	srli.d	$a2, $a5, 6
	add.d	$a1, $a1, $t0
	add.d	$a0, $a3, $a0
	addi.d	$a0, $a0, 144
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB14_18:                              # %vec.epilog.scalar.ph78
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a3, $a1, 0
	st.b	$a3, $a0, 0
	addi.d	$a1, $a1, 1
...
.LBB14_20:
	move	$a0, $a3
	ret
.LBB14_21:                              # %vector.main.loop.iter.check
	bgeu	$t2, $a3, .LBB14_25
# %bb.22:
	move	$a3, $zero
	b	.LBB14_27
.LBB14_23:                              # %vector.main.loop.iter.check67
	bgeu	$a7, $a3, .LBB14_30
# %bb.24:
	move	$a3, $zero
	b	.LBB14_32
...
.LBB14_27:                              # %vec.epilog.ph
	...
	addi.d	$t5, $t5, 72
	.p2align	4, , 16
.LBB14_28:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t6, $t3, 0
	st.w	$t6, $t5, 0
	addi.d	$t3, $t3, 4
...
# %bb.29:                               # %vec.epilog.middle.block
	beq	$a3, $t2, .LBB14_13
	b	.LBB14_9
.LBB14_30:                              # %vector.ph69
	vldx	$vr0, $a1, $a2
	andi	$a3, $a7, 16
	vst	$vr0, $a0, 144
	beq	$a3, $a7, .LBB14_19
# %bb.31:                               # %vec.epilog.iter.check79
	andi	$t0, $a7, 12
	beqz	$t0, .LBB14_35
.LBB14_32:                              # %vec.epilog.ph81
	move	$t2, $a3
	andi	$a3, $a7, 28
	add.d	$t0, $a2, $a3
	add.d	$a2, $a2, $t2
	...
	addi.d	$t2, $t2, 144
	.p2align	4, , 16
.LBB14_33:                              # %vec.epilog.vector.body84
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t3, $a2, 0
	st.w	$t3, $t2, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$t2, $t2, 4
	bnez	$t1, .LBB14_33
# %bb.34:                               # %vec.epilog.middle.block88
	bne	$a3, $a7, .LBB14_17
	b	.LBB14_19
.LBB14_35:
	add.d	$t0, $a2, $a3
...
.LBB15_8:
	move	$a3, $zero
.LBB15_9:                               # %vec.epilog.scalar.ph.preheader
	add.d	$t0, $t0, $t1
	sub.d	$t0, $t0, $a3
	add.d	$a3, $a3, $a0
	addi.d	$a3, $a3, -104
	.p2align	4, , 16
.LBB15_10:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ldx.b	$t1, $a1, $a2
	addi.d	$a2, $a2, 1
	st.b	$t1, $a3, 0
	...
	addi.d	$a3, $a3, 1
	bnez	$t0, .LBB15_10
# %bb.11:                               # %.preheader.loopexit.i.loopexit
	bstrpick.d	$a2, $a2, 31, 0
	b	.LBB15_13
.LBB15_12:
	ori	$a2, $zero, 2
.LBB15_13:                              # %.preheader.i
	addi.w	$a3, $a7, 0
	beqz	$a3, .LBB15_19
# %bb.14:                               # %iter.check24
	ori	$a7, $zero, 4
	bltu	$a3, $a7, .LBB15_16
# %bb.15:                               # %vector.memcheck11
	add.d	$a7, $a2, $a1
	sub.d	$a7, $a0, $a7
	addi.d	$t0, $a7, -32
	ori	$a7, $zero, 16
...
.LBB15_16:
	move	$a7, $zero
	move	$t0, $a2
.LBB15_17:                              # %vec.epilog.scalar.ph25.preheader
	srli.d	$a2, $a5, 6
	add.d	$a1, $a1, $t0
	andi	$a2, $a2, 1
	add.d	$a2, $a6, $a2
	...
	addi.d	$a0, $a0, -32
	.p2align	4, , 16
.LBB15_18:                              # %vec.epilog.scalar.ph25
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a3, $a1, 0
	st.b	$a3, $a0, 0
	addi.d	$a1, $a1, 1
...
.LBB15_20:                              # %_ZN7NCrypto7NSevenZ8CDecoder21SetDecoderProperties2EPKhj.exit
	move	$a0, $a3
	ret
.LBB15_21:                              # %vector.main.loop.iter.check
	bgeu	$t2, $a3, .LBB15_25
# %bb.22:
	move	$a3, $zero
	b	.LBB15_27
.LBB15_23:                              # %vector.main.loop.iter.check14
	bgeu	$a3, $a7, .LBB15_30
# %bb.24:
	move	$a7, $zero
	b	.LBB15_32
...
.LBB15_27:                              # %vec.epilog.ph
	...
	addi.d	$t5, $t5, -104
	.p2align	4, , 16
.LBB15_28:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t6, $t3, 0
	st.w	$t6, $t5, 0
	addi.d	$t3, $t3, 4
...
# %bb.29:                               # %vec.epilog.middle.block
	beq	$a3, $t2, .LBB15_13
	b	.LBB15_9
.LBB15_30:                              # %vector.ph16
	vldx	$vr0, $a1, $a2
	andi	$a7, $a3, 16
	vst	$vr0, $a0, -32
	beq	$a7, $a3, .LBB15_19
# %bb.31:                               # %vec.epilog.iter.check26
	andi	$t0, $a3, 12
	beqz	$t0, .LBB15_35
.LBB15_32:                              # %vec.epilog.ph28
	move	$t2, $a7
	andi	$a7, $a3, 28
	add.d	$t0, $a2, $a7
	add.d	$a2, $a2, $t2
	...
	addi.d	$t2, $t2, -32
	.p2align	4, , 16
.LBB15_33:                              # %vec.epilog.vector.body31
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t3, $a2, 0
	st.w	$t3, $t2, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$t2, $t2, 4
	bnez	$t1, .LBB15_33
# %bb.34:                               # %vec.epilog.middle.block35
	bne	$a7, $a3, .LBB15_17
	b	.LBB15_19
.LBB15_35:
	add.d	$t0, $a2, $a7
...
.Ltmp23:                                # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp24:                                # EH_LABEL
# %bb.2:                                # %_ZNK9CMyComPtrI15ICompressFilterE14QueryInterfaceI17ICryptoPropertiesEEiRK4GUIDPPT_.exit
	bnez	$a0, .LBB18_6
# %bb.3:
	ld.d	$a0, $sp, 8
	ld.d	$a1, $a0, 0
...
.Ltmp32:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp33:                                # EH_LABEL
.LBB18_17:                              # %_ZN9CMyComPtrI17ICryptoPropertiesED2Ev.exit30
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB18_18:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit29
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB21_64
.LBB21_32:                              # %_ZeqRK4GUIDS1_.exit29.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit47
	...
	ori	$a5, $zero, 176
	beq	$a6, $a3, .LBB21_64
.LBB21_48:                              # %_ZeqRK4GUIDS1_.exit47.thread
...
# %bb.62:
	...
	ld.bu	$a6, $a5, 14
	bne	$a4, $a6, .LBB21_65
# %bb.63:                               # %_ZeqRK4GUIDS1_.exit65
	ld.bu	$a1, $a1, 15
	ld.bu	$a4, $a5, 15
	ori	$a5, $zero, 184
	bne	$a1, $a4, .LBB21_65
.LBB21_64:                              # %_ZeqRK4GUIDS1_.exit65.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB21_65:                              # %_ZeqRK4GUIDS1_.exit65.thread
	move	$a0, $a3
	ret
.Lfunc_end21:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit26
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB45_48
.LBB45_32:                              # %_ZeqRK4GUIDS1_.exit26.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit44
	...
	ori	$a5, $zero, 176
	bne	$a1, $a4, .LBB45_49
.LBB45_48:                              # %_ZeqRK4GUIDS1_.exit44.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB45_49:                              # %_ZeqRK4GUIDS1_.exit44.thread
	move	$a0, $a3
	ret
.Lfunc_end45:
...
.Lfunc_end64:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_7zAes.cpp
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTVN7NCrypto7NSevenZ10CBaseCoderE
	...
	.addrsig_sym _ZTV13CObjectVectorIN7NCrypto7NSevenZ8CKeyInfoEE
