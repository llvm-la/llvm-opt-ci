...
# %bb.31:                               # %vector.memcheck53
	...
	add.d	$a2, $a2, $s2
	bgeu	$a1, $a2, .LBB13_37
# %bb.32:                               # %vector.memcheck53
	alsl.d	$a2, $s2, $a1, 1
	bgeu	$s1, $a2, .LBB13_37
.LBB13_33:
	move	$a2, $zero
.LBB13_34:                              # %.lr.ph35.preheader70
	alsl.d	$a3, $a2, $a1, 2
	sub.d	$a2, $s3, $a2
	.p2align	4, , 16
.LBB13_35:                              # %.lr.ph35
...
.LBB19_31:                              #   in Loop: Header=BB19_3 Depth=1
	...
	bnez	$a0, .LBB19_24
	b	.LBB19_25
.LBB19_32:                              # %._crit_edge125.loopexit
	addi.w	$s2, $s6, -1
	b	.LBB19_34
.LBB19_33:
	move	$s4, $zero
	addi.w	$s2, $zero, -1
.LBB19_34:                              # %._crit_edge125
	addi.d	$s1, $fp, 32
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector5ClearEv)
	jirl	$ra, $ra, 0
...
# %bb.153:                              # %.lr.ph363
	...
	.p2align	4, , 16
.LBB34_154:                             # %scalar.ph490
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a4, $a2, $a3
	addi.w	$a3, $a3, 1
	add.w	$a1, $a1, $a4
	bne	$a0, $a3, .LBB34_154
# %bb.155:                              # %.preheader.loopexit.loopexit
	sltui	$s1, $a1, 1
	bnez	$a5, .LBB34_157
	b	.LBB34_164
.LBB34_156:
...
.LBB34_157:                             # %.lr.ph368
	...
	b	.LBB34_160
	.p2align	4, , 16
.LBB34_158:                             # %_ZN13CRecordVectorIbE3AddEb.exit294
                                        #   in Loop: Header=BB34_160 Depth=1
	ld.d	$a0, $fp, 464
	ld.w	$a1, $fp, 460
	andi	$a2, $s5, 1
	stx.b	$a2, $a0, $a1
	addi.d	$a0, $a1, 1
	st.w	$a0, $fp, 460
.LBB34_159:                             #   in Loop: Header=BB34_160 Depth=1
	addi.w	$s3, $s3, 1
	beq	$s6, $s3, .LBB34_164
.LBB34_160:                             # =>This Inner Loop Header: Depth=1
	...
	st.b	$a1, $a0, 32
	beqz	$a3, .LBB34_162
# %bb.161:                              #   in Loop: Header=BB34_160 Depth=1
	ld.d	$a1, $sp, 216
	ldx.b	$a1, $a1, $s4
	ld.d	$a2, $sp, 184
	xori	$a1, $a1, 1
	...
	b	.LBB34_163
	.p2align	4, , 16
.LBB34_162:                             #   in Loop: Header=BB34_160 Depth=1
	ld.d	$a1, $sp, 280
	st.b	$zero, $a0, 33
	ld.d	$a2, $sp, 344
	slli.d	$a3, $s2, 2
	...
	st.b	$a2, $a0, 34
	bnez	$s1, .LBB34_159
.LBB34_163:                             #   in Loop: Header=BB34_160 Depth=1
.Ltmp273:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
...
.Ltmp279:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp280:                               # EH_LABEL
# %bb.167:                              # %_ZN13CObjectVectorI7CBufferIhEED2Ev.exit
	addi.d	$a0, $sp, 360
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $s1
...
.LBB34_172:
	pcaddu18i	$ra, %call36(_ZN8NArchive3N7zL14ThrowExceptionEv)
	jirl	$ra, $ra, 0
.LBB34_173:                             # %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit._crit_edge.i
	ori	$a0, $zero, 4
	pcaddu18i	$ra, %call36(__cxa_allocate_exception)
	jirl	$ra, $ra, 0
	ori	$a1, $zero, 1
...
.Ltmp245:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB34_197
.LBB34_188:                             # %.loopexit.split-lp332
.Ltmp193:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB34_220
.LBB34_189:
...
.Ltmp150:                               # EH_LABEL
	b	.LBB34_222
.LBB34_203:                             # %.loopexit.split-lp339
.Ltmp153:                               # EH_LABEL
	b	.LBB34_222
.LBB34_204:                             # %.loopexit
.Ltmp242:                               # EH_LABEL
	b	.LBB34_218
.LBB34_205:                             # %.loopexit.split-lp.loopexit
.Ltmp235:                               # EH_LABEL
	b	.LBB34_218
.LBB34_206:
.Ltmp260:                               # EH_LABEL
.LBB34_207:
	...
	jirl	$ra, $ra, 0
	b	.LBB34_219
.LBB34_208:                             # %.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp228:                               # EH_LABEL
	b	.LBB34_218
.LBB34_209:                             # %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp214:                               # EH_LABEL
	b	.LBB34_218
.LBB34_210:                             # %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp221:                               # EH_LABEL
	b	.LBB34_218
.LBB34_211:
.Ltmp202:                               # EH_LABEL
...
.Ltmp199:                               # EH_LABEL
	b	.LBB34_218
.LBB34_213:                             # %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp266:                               # EH_LABEL
	b	.LBB34_218
.LBB34_214:
.Ltmp181:                               # EH_LABEL
	move	$fp, $a0
.LBB34_215:                             # %_ZN8NArchive3N7z9CFileItemD2Ev.exit217
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB34_223
.LBB34_216:                             # %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp
.Ltmp272:                               # EH_LABEL
	b	.LBB34_218
.LBB34_217:
.Ltmp205:                               # EH_LABEL
.LBB34_218:                             # %.loopexit.split-lp
	move	$fp, $a0
.LBB34_219:                             # %.loopexit.split-lp
	addi.d	$a0, $sp, 168
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 200
