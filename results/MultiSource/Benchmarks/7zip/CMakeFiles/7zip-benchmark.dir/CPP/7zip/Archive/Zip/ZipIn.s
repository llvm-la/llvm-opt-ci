...
.Ltmp181:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp182:                               # EH_LABEL
# %bb.60:                               # %_ZN8NArchive4NZip11CExtraBlockD2Ev.exit.i156
                                        #   in Loop: Header=BB28_27 Depth=1
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp184:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp185:                               # EH_LABEL
# %bb.61:                               # %_ZN8NArchive4NZip11CExtraBlockD2Ev.exit.i.i157
                                        #   in Loop: Header=BB28_27 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
# %bb.62:                               #   in Loop: Header=BB28_27 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB28_63:                              # %_ZN8NArchive4NZip5CItemD2Ev.exit158
                                        #   in Loop: Header=BB28_27 Depth=1
	beqz	$s2, .LBB28_104
...
# %bb.93:                               # %.noexc152
                                        #   in Loop: Header=BB28_27 Depth=1
	bnez	$a0, .LBB28_108
# %bb.94:                               # %_ZN8NArchive4NZip10CInArchive20ReadBytesAndTestSizeEPvj.exit.i151
                                        #   in Loop: Header=BB28_27 Depth=1
	ld.w	$a0, $sp, 292
	ori	$a1, $zero, 1
	addi.d	$s5, $sp, 216
