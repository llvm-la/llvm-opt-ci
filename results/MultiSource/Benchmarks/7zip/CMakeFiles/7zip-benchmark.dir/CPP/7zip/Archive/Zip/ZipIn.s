...
# %bb.34:                               # %._crit_edge32.i.i.peel
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a0, $s6, 0
.LBB16_35:                              # %.noexc64.peel.thread151.thread
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_49:                              # %._crit_edge32.i.i
	...
	ld.d	$a0, $s6, 0
.LBB16_50:                              # %.noexc64.thread155.thread
                                        #   in Loop: Header=BB16_52 Depth=2
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_74:                              # %_ZN8NArchive4NZip10CInArchive4SkipEy.exit
	...
	addi.d	$sp, $sp, 224
	ret
.LBB16_75:                              # %.loopexit120.invoke.loopexit225.split.loop.exit237
	sltu	$a0, $zero, $a0
	ori	$a1, $zero, 6
	maskeqz	$fp, $a1, $a0
	b	.LBB16_79
...
# %bb.18:                               # %_ZN8NArchive4NZip11CExtraBlockaSERKS1_.exit
	...
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 176
.LBB18_19:                              # %_ZN8NArchive4NZipL12FlagsAreSameERNS0_5CItemES2_.exit.thread36
	ld.d	$a0, $sp, 176
	addi.d	$fp, $sp, 128
	st.d	$s4, $sp, 160
	beqz	$a0, .LBB18_21
...
# %bb.11:                               # %.lr.ph
	...
	ld.d	$s7, $a1, %got_pc_lo12(_ZN8NArchive4NZip10NSignature16kEndOfCentralDirE)
	ori	$a4, $zero, 20
	pcalau12i	$a1, %got_pc_hi20(_ZN8NArchive4NZip10NSignature28kZip64EndOfCentralDirLocatorE)
	ld.d	$s6, $a1, %got_pc_lo12(_ZN8NArchive4NZip10NSignature28kZip64EndOfCentralDirLocatorE)
	b	.LBB24_14
.LBB24_12:                              # %.thread
...
.LBB28_58:                              #   in Loop: Header=BB28_27 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB28_59:                              # %_ZN7CBufferIhED2Ev.exit.i154
                                        #   in Loop: Header=BB28_27 Depth=1
	st.d	$s7, $sp, 216
.Ltmp181:                               # EH_LABEL
	move	$a0, $s5
	...
	jirl	$ra, $ra, 0
.Ltmp182:                               # EH_LABEL
# %bb.60:                               # %_ZN8NArchive4NZip11CExtraBlockD2Ev.exit.i155
                                        #   in Loop: Header=BB28_27 Depth=1
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp184:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp185:                               # EH_LABEL
# %bb.61:                               # %_ZN8NArchive4NZip11CExtraBlockD2Ev.exit.i.i156
                                        #   in Loop: Header=BB28_27 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
# %bb.62:                               #   in Loop: Header=BB28_27 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB28_63:                              # %_ZN8NArchive4NZip5CItemD2Ev.exit157
                                        #   in Loop: Header=BB28_27 Depth=1
	beqz	$s2, .LBB28_104
...
# %bb.93:                               # %.noexc151
                                        #   in Loop: Header=BB28_27 Depth=1
	bnez	$a0, .LBB28_108
# %bb.94:                               # %_ZN8NArchive4NZip10CInArchive20ReadBytesAndTestSizeEPvj.exit.i150
                                        #   in Loop: Header=BB28_27 Depth=1
	ld.w	$a0, $sp, 292
	ori	$a1, $zero, 1
	addi.d	$s5, $sp, 216
