...
.LBB4_44:                               # %vector.body96
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB4_44
# %bb.45:                               # %middle.block101
	beq	$a2, $a1, .LBB4_52
# %bb.46:                               # %vec.epilog.iter.check105
	beqz	$a3, .LBB4_50
.LBB4_47:                               # %vec.epilog.ph107
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_48:                               # %vec.epilog.vector.body110
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_48
# %bb.49:                               # %vec.epilog.middle.block114
	beq	$a2, $a1, .LBB4_52
...
.LBB7_34:                               # %vector.body96
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB7_34
# %bb.35:                               # %middle.block101
	beq	$a2, $a1, .LBB7_42
# %bb.36:                               # %vec.epilog.iter.check105
	beqz	$a3, .LBB7_40
.LBB7_37:                               # %vec.epilog.ph107
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_38:                               # %vec.epilog.vector.body110
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_38
# %bb.39:                               # %vec.epilog.middle.block114
	beq	$a2, $a1, .LBB7_42
...
# %bb.53:
	move	$a2, $zero
	b	.LBB7_59
.LBB7_54:                               # %._crit_edge.i.i34
	bnez	$a0, .LBB7_64
	b	.LBB7_65
.LBB7_55:                               # %vector.ph125
	andi	$a3, $a1, 48
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a4, $s1, 32
...
.LBB7_56:                               # %vector.body128
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB7_56
# %bb.57:                               # %middle.block133
	beq	$a2, $a1, .LBB7_64
# %bb.58:                               # %vec.epilog.iter.check137
	beqz	$a3, .LBB7_62
.LBB7_59:                               # %vec.epilog.ph139
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_60:                               # %vec.epilog.vector.body142
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_60
# %bb.61:                               # %vec.epilog.middle.block146
	beq	$a2, $a1, .LBB7_64
...
# %bb.75:
	move	$a2, $zero
	b	.LBB7_81
.LBB7_76:                               # %._crit_edge.i.i53
	bnez	$a0, .LBB7_86
	b	.LBB7_87
.LBB7_77:                               # %vector.ph157
	andi	$a3, $a1, 48
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a4, $s1, 32
...
.LBB7_78:                               # %vector.body160
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB7_78
# %bb.79:                               # %middle.block165
	beq	$a2, $a1, .LBB7_86
# %bb.80:                               # %vec.epilog.iter.check169
	beqz	$a3, .LBB7_84
.LBB7_81:                               # %vec.epilog.ph171
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_82:                               # %vec.epilog.vector.body174
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_82
# %bb.83:                               # %vec.epilog.middle.block178
	beq	$a2, $a1, .LBB7_86
