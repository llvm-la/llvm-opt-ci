...
.Lfunc_end2:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchive4NTarL16MakeOctalString8EPcj
...
# %bb.39:                               # %iter.check102
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB4_50
# %bb.40:                               # %vector.main.loop.iter.check89
	bgeu	$a1, $a3, .LBB4_46
# %bb.41:
	move	$a2, $zero
.LBB4_42:                               # %vec.epilog.ph106
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_43:                               # %vec.epilog.vector.body109
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_43
# %bb.44:                               # %vec.epilog.middle.block113
	bne	$a2, $a1, .LBB4_50
	b	.LBB4_52
...
.LBB4_47:                               # %vector.body94
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_47
# %bb.48:                               # %middle.block99
	beq	$a2, $a1, .LBB4_52
# %bb.49:                               # %vec.epilog.iter.check104
	bnez	$a3, .LBB4_42
.LBB4_50:                               # %vec.epilog.scalar.ph103.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
.LBB4_51:                               # %vec.epilog.scalar.ph103
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB7_32:                               # %vec.epilog.ph106
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_33:                               # %vec.epilog.vector.body109
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.39:                               # %vec.epilog.iter.check104
	bnez	$a3, .LBB7_32
.LBB7_40:                               # %vec.epilog.scalar.ph103.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_41:                               # %vec.epilog.scalar.ph103
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB7_54:                               # %vec.epilog.ph137
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_55:                               # %vec.epilog.vector.body140
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.61:                               # %vec.epilog.iter.check135
	bnez	$a3, .LBB7_54
.LBB7_62:                               # %vec.epilog.scalar.ph134.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_63:                               # %vec.epilog.scalar.ph134
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB7_76:                               # %vec.epilog.ph168
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_77:                               # %vec.epilog.vector.body171
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.83:                               # %vec.epilog.iter.check166
	bnez	$a3, .LBB7_76
.LBB7_84:                               # %vec.epilog.scalar.ph165.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_85:                               # %vec.epilog.scalar.ph165
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.Lfunc_end9:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NArchive4NTarL15MakeOctalStringEy
