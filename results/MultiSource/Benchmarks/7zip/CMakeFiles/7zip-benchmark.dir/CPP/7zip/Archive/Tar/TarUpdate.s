...
# %bb.53:                               # %iter.check483
	...
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB0_77
# %bb.54:                               # %vector.main.loop.iter.check485
                                        #   in Loop: Header=BB0_23 Depth=1
	ori	$a2, $zero, 32
	bgeu	$a1, $a2, .LBB0_73
# %bb.55:                               #   in Loop: Header=BB0_23 Depth=1
	move	$a2, $zero
.LBB0_56:                               # %vec.epilog.ph500
                                        #   in Loop: Header=BB0_23 Depth=1
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_57:                               # %vec.epilog.vector.body503
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_57
# %bb.58:                               # %vec.epilog.middle.block507
                                        #   in Loop: Header=BB0_23 Depth=1
	bne	$a2, $a1, .LBB0_77
	b	.LBB0_79
...
.LBB0_74:                               # %vector.body489
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_74
# %bb.75:                               # %middle.block494
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
# %bb.76:                               # %vec.epilog.iter.check498
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a3, .LBB0_56
.LBB0_77:                               # %vec.epilog.scalar.ph497.preheader
                                        #   in Loop: Header=BB0_23 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s7, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_78:                               # %vec.epilog.scalar.ph497
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB1_32:                               # %vec.epilog.ph107
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_33:                               # %vec.epilog.vector.body110
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.39:                               # %vec.epilog.iter.check105
	bnez	$a3, .LBB1_32
.LBB1_40:                               # %vec.epilog.scalar.ph104.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB1_41:                               # %vec.epilog.scalar.ph104
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB1_54:                               # %vec.epilog.ph139
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_55:                               # %vec.epilog.vector.body142
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.61:                               # %vec.epilog.iter.check137
	bnez	$a3, .LBB1_54
.LBB1_62:                               # %vec.epilog.scalar.ph136.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB1_63:                               # %vec.epilog.scalar.ph136
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB1_76:                               # %vec.epilog.ph171
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_77:                               # %vec.epilog.vector.body174
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.83:                               # %vec.epilog.iter.check169
	bnez	$a3, .LBB1_76
.LBB1_84:                               # %vec.epilog.scalar.ph168.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB1_85:                               # %vec.epilog.scalar.ph168
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
