...
# %bb.53:                               # %iter.check495
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB0_77
# %bb.54:                               # %vector.main.loop.iter.check482
                                        #   in Loop: Header=BB0_23 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_70
...
.LBB0_62:                               #   in Loop: Header=BB0_23 Depth=1
	...
	bnez	$a0, .LBB0_125
	b	.LBB0_126
.LBB0_63:                               #   in Loop: Header=BB0_23 Depth=1
	ld.bu	$a0, $s1, 74
	bnez	$a0, .LBB0_46
...
# %bb.68:                               #   in Loop: Header=BB0_23 Depth=1
	...
	bnez	$a0, .LBB0_58
	b	.LBB0_46
.LBB0_69:                               # %._crit_edge.i.i241
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_79
	b	.LBB0_80
.LBB0_70:                               # %vector.ph484
                                        #   in Loop: Header=BB0_23 Depth=1
	andi	$a3, $a1, 48
...
.LBB0_71:                               # %vector.body487
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_71
# %bb.72:                               # %middle.block492
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
# %bb.73:                               # %vec.epilog.iter.check497
                                        #   in Loop: Header=BB0_23 Depth=1
	beqz	$a3, .LBB0_77
.LBB0_74:                               # %vec.epilog.ph499
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_75:                               # %vec.epilog.vector.body502
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_75
# %bb.76:                               # %vec.epilog.middle.block506
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
.LBB0_77:                               # %vec.epilog.scalar.ph496.preheader
                                        #   in Loop: Header=BB0_23 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s7, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_78:                               # %vec.epilog.scalar.ph496
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
# %bb.101:                              # %vec.epilog.middle.block
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_104
.LBB0_102:                              # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB0_23 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s7, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_103:                              # %vec.epilog.scalar.ph
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB0_103
.LBB0_104:                              # %._crit_edge.thread.i.i262
                                        #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a1, $sp, 216
.LBB0_105:                              #   in Loop: Header=BB0_23 Depth=1
	st.d	$s7, $sp, 208
	stx.b	$zero, $s7, $a1
	st.w	$s8, $sp, 220
.LBB0_106:                              # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i254
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $s5, 0
	.p2align	4, , 16
.LBB0_107:                              #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $s7, 1
	...
	move	$s7, $a2
	bnez	$a1, .LBB0_107
# %bb.108:                              # %_Z12MyStringCopyIcEPT_S1_PKS0_.exit.i258
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.w	$a0, $s1, 64
	st.w	$a0, $sp, 216
.LBB0_109:                              # %_ZN11CStringBaseIcEaSERKS0_.exit272
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.bu	$a0, $s1, 74
	beqz	$a0, .LBB0_111
# %bb.110:                              #   in Loop: Header=BB0_23 Depth=1
	move	$a0, $zero
	ori	$a1, $zero, 53
	b	.LBB0_112
	.p2align	4, , 16
...
.LBB0_113:                              #   in Loop: Header=BB0_23 Depth=1
	...
	st.d	$a0, $sp, 144
	beqz	$a1, .LBB0_119
# %bb.114:                              #   in Loop: Header=BB0_23 Depth=1
.Ltmp61:                                # EH_LABEL
	addi.d	$a0, $sp, 240
	addi.d	$a1, $sp, 128
	pcaddu18i	$ra, %call36(_ZN8NArchive4NTar11COutArchive11WriteHeaderERKNS0_5CItemE)
...
.Ltmp58:                                # EH_LABEL
	...
	jirl	$ra, $a4, 0
.Ltmp59:                                # EH_LABEL
# %bb.120:                              #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_124
...
.Ltmp67:                                # EH_LABEL
	...
	jirl	$ra, $a6, 0
.Ltmp68:                                # EH_LABEL
# %bb.123:                              #   in Loop: Header=BB0_23 Depth=1
	beqz	$a0, .LBB0_134
	.p2align	4, , 16
...
.LBB0_126:                              # %_ZN11CStringBaseIcED2Ev.exit.i
	...
	ld.d	$a0, $sp, 192
	beqz	$a0, .LBB0_128
# %bb.127:                              #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_128:                              # %_ZN11CStringBaseIcED2Ev.exit1.i
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $sp, 176
	beqz	$a0, .LBB0_130
# %bb.129:                              #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_130:                              # %_ZN11CStringBaseIcED2Ev.exit2.i
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB0_132
# %bb.131:                              #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_132:                              # %_ZN8NArchive4NTar5CItemD2Ev.exit
                                        #   in Loop: Header=BB0_23 Depth=1
	beqz	$s1, .LBB0_141
# %bb.133:                              #   in Loop: Header=BB0_23 Depth=1
	ld.w	$a0, $s3, 12
	addi.d	$s6, $s6, 1
	blt	$s6, $a0, .LBB0_23
	b	.LBB0_140
.LBB0_134:                              #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 32
	bne	$a0, $s1, .LBB0_138
# %bb.135:                              #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a1, $s5, 16
.Ltmp70:                                # EH_LABEL
	addi.d	$a0, $sp, 240
	pcaddu18i	$ra, %call36(_ZN8NArchive4NTar11COutArchive16FillDataResidualEy)
...
.Ltmp109:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp110:                               # EH_LABEL
# %bb.143:                              # %_ZN9CMyComPtrI26CLimitedSequentialInStreamED2Ev.exit
	ld.d	$a0, $s0, 0
	ld.d	$a1, $a0, 16
.Ltmp112:                               # EH_LABEL
	move	$a0, $s0
	jirl	$ra, $a1, 0
.Ltmp113:                               # EH_LABEL
# %bb.144:                              # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp115:                               # EH_LABEL
...
.Ltmp116:                               # EH_LABEL
	move	$a0, $fp
.LBB0_145:                              # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit
	ld.d	$a1, $sp, 240
	beqz	$a1, .LBB0_147
# %bb.146:
	ld.d	$a2, $a1, 0
...
.LBB0_160:
.Ltmp23:                                # EH_LABEL
.LBB0_161:                              # %_ZN9CMyComPtrI26CLimitedSequentialInStreamED2Ev.exit279
	move	$s2, $a0
	b	.LBB0_193
.LBB0_162:
.Ltmp20:                                # EH_LABEL
...
.LBB0_164:
.Ltmp14:                                # EH_LABEL
.LBB0_165:                              # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit281
	move	$s2, $a0
	b	.LBB0_194
.LBB0_166:
.Ltmp11:                                # EH_LABEL
...
.LBB0_178:
.Ltmp2:                                 # EH_LABEL
.LBB0_179:                              # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit283
	move	$s2, $a0
	b	.LBB0_195
.LBB0_180:
.Ltmp57:                                # EH_LABEL
...
.Ltmp42:                                # EH_LABEL
	move	$s2, $a0
.LBB0_187:                              # %_ZN11CStringBaseIcED2Ev.exit8.i
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB0_192
# %bb.188:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp97:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp98:                                # EH_LABEL
.LBB0_193:                              # %_ZN9CMyComPtrI26CLimitedSequentialInStreamED2Ev.exit279
	ld.d	$a0, $s0, 0
	ld.d	$a1, $a0, 16
.Ltmp100:                               # EH_LABEL
	move	$a0, $s0
	jirl	$ra, $a1, 0
.Ltmp101:                               # EH_LABEL
.LBB0_194:                              # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit281
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp103:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp104:                               # EH_LABEL
.LBB0_195:                              # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit283
	ld.d	$a0, $sp, 240
	beqz	$a0, .LBB0_197
# %bb.196:
	ld.d	$a1, $a0, 0
...
.Ltmp106:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp107:                               # EH_LABEL
.LBB0_197:                              # %_ZN8NArchive4NTar11COutArchiveD2Ev.exit286
	move	$a0, $s2
...
# %bb.29:                               # %iter.check102
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB1_40
# %bb.30:                               # %vector.main.loop.iter.check89
	bgeu	$a1, $a3, .LBB1_33
# %bb.31:
	move	$a2, $zero
	b	.LBB1_37
.LBB1_32:                               # %._crit_edge.i.i15
	bnez	$a0, .LBB1_42
	b	.LBB1_43
.LBB1_33:                               # %vector.ph91
	andi	$a3, $a1, 48
...
.LBB1_34:                               # %vector.body94
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_34
# %bb.35:                               # %middle.block99
	beq	$a2, $a1, .LBB1_42
# %bb.36:                               # %vec.epilog.iter.check104
	beqz	$a3, .LBB1_40
.LBB1_37:                               # %vec.epilog.ph106
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_38:                               # %vec.epilog.vector.body109
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_38
# %bb.39:                               # %vec.epilog.middle.block113
	beq	$a2, $a1, .LBB1_42
.LBB1_40:                               # %vec.epilog.scalar.ph103.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB1_41:                               # %vec.epilog.scalar.ph103
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.51:                               # %iter.check133
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB1_62
# %bb.52:                               # %vector.main.loop.iter.check120
	bgeu	$a1, $a3, .LBB1_55
# %bb.53:
	move	$a2, $zero
	b	.LBB1_59
.LBB1_54:                               # %._crit_edge.i.i34
	bnez	$a0, .LBB1_64
	b	.LBB1_65
.LBB1_55:                               # %vector.ph122
	andi	$a3, $a1, 48
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a4, $s1, 32
...
.LBB1_56:                               # %vector.body125
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_56
# %bb.57:                               # %middle.block130
	beq	$a2, $a1, .LBB1_64
# %bb.58:                               # %vec.epilog.iter.check135
	beqz	$a3, .LBB1_62
.LBB1_59:                               # %vec.epilog.ph137
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_60:                               # %vec.epilog.vector.body140
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_60
# %bb.61:                               # %vec.epilog.middle.block144
	beq	$a2, $a1, .LBB1_64
.LBB1_62:                               # %vec.epilog.scalar.ph134.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB1_63:                               # %vec.epilog.scalar.ph134
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.73:                               # %iter.check164
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB1_84
# %bb.74:                               # %vector.main.loop.iter.check151
	bgeu	$a1, $a3, .LBB1_77
# %bb.75:
	move	$a2, $zero
	b	.LBB1_81
.LBB1_76:                               # %._crit_edge.i.i53
	bnez	$a0, .LBB1_86
	b	.LBB1_87
.LBB1_77:                               # %vector.ph153
	andi	$a3, $a1, 48
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a4, $s1, 32
...
.LBB1_78:                               # %vector.body156
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_78
# %bb.79:                               # %middle.block161
	beq	$a2, $a1, .LBB1_86
# %bb.80:                               # %vec.epilog.iter.check166
	beqz	$a3, .LBB1_84
.LBB1_81:                               # %vec.epilog.ph168
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_82:                               # %vec.epilog.vector.body171
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_82
# %bb.83:                               # %vec.epilog.middle.block175
	beq	$a2, $a1, .LBB1_86
.LBB1_84:                               # %vec.epilog.scalar.ph165.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB1_85:                               # %vec.epilog.scalar.ph165
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
