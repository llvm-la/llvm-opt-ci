...
.LBB0_56:                               # %vec.epilog.ph499
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_57:                               # %vec.epilog.vector.body502
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_57
# %bb.58:                               # %vec.epilog.middle.block506
                                        #   in Loop: Header=BB0_23 Depth=1
	bne	$a2, $a1, .LBB0_77
	b	.LBB0_79
...
.LBB0_74:                               # %vector.body487
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_74
# %bb.75:                               # %middle.block492
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
# %bb.76:                               # %vec.epilog.iter.check497
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a3, .LBB0_56
...
.LBB1_32:                               # %vec.epilog.ph106
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_33:                               # %vec.epilog.vector.body109
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_33
# %bb.34:                               # %vec.epilog.middle.block113
	bne	$a2, $a1, .LBB1_40
	b	.LBB1_42
...
# %bb.38:                               # %middle.block99
	beq	$a2, $a1, .LBB1_42
# %bb.39:                               # %vec.epilog.iter.check104
	bnez	$a3, .LBB1_32
...
.LBB1_54:                               # %vec.epilog.ph137
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_55:                               # %vec.epilog.vector.body140
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_55
# %bb.56:                               # %vec.epilog.middle.block144
	bne	$a2, $a1, .LBB1_62
	b	.LBB1_64
.LBB1_57:                               # %._crit_edge.i.i34
	bnez	$a0, .LBB1_64
	b	.LBB1_65
.LBB1_58:                               # %vector.ph122
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
...
.LBB1_59:                               # %vector.body125
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_59
# %bb.60:                               # %middle.block130
	beq	$a2, $a1, .LBB1_64
# %bb.61:                               # %vec.epilog.iter.check135
	bnez	$a3, .LBB1_54
...
.LBB1_76:                               # %vec.epilog.ph168
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_77:                               # %vec.epilog.vector.body171
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_77
# %bb.78:                               # %vec.epilog.middle.block175
	bne	$a2, $a1, .LBB1_84
	b	.LBB1_86
.LBB1_79:                               # %._crit_edge.i.i53
	bnez	$a0, .LBB1_86
	b	.LBB1_87
.LBB1_80:                               # %vector.ph153
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
...
.LBB1_81:                               # %vector.body156
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_81
# %bb.82:                               # %middle.block161
	beq	$a2, $a1, .LBB1_86
# %bb.83:                               # %vec.epilog.iter.check166
	bnez	$a3, .LBB1_76
