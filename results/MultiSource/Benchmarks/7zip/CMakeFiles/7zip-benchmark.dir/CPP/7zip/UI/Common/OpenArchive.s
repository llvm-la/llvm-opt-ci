...
# %bb.220:                              # %.thread493
	ld.d	$a0, $sp, 440
	st.w	$s1, $a0, 0
.LBB6_221:                              # %_ZN7CBufferIhED2Ev.exit359
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
...
.Ltmp189:                               # EH_LABEL
	...
	move	$s1, $a0
	bnez	$a1, .LBB6_247
# %bb.245:                              # %_ZN11CStringBaseIwED2Ev.exit423
	ld.d	$a0, $sp, 360
	bnez	$a0, .LBB6_258
.LBB6_246:                              # %_ZN11CStringBaseIwED2Ev.exit424
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_260
	b	.LBB6_278
.LBB6_247:
...
.LBB6_252:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_253:                              # %_ZN7CBufferIhED2Ev.exit341
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_283
...
# %bb.255:
	...
	jirl	$ra, $ra, 0
	b	.LBB6_278
.LBB6_256:                              # %.loopexit.split-lp572.loopexit.split-lp
.Ltmp78:                                # EH_LABEL
	b	.LBB6_282
.LBB6_257:
.Ltmp186:                               # EH_LABEL
...
.Ltmp168:                               # EH_LABEL
	b	.LBB6_277
.LBB6_275:                              # %.loopexit.split-lp572.loopexit
.Ltmp69:                                # EH_LABEL
	b	.LBB6_282
.LBB6_276:
.Ltmp171:                               # EH_LABEL
...
.Ltmp139:                               # EH_LABEL
	b	.LBB6_282
.LBB6_281:                              # %.loopexit571
.Ltmp64:                                # EH_LABEL
.LBB6_282:                              # %_ZN7CBufferIhED2Ev.exit360
	move	$s1, $a0
.LBB6_283:                              # %_ZN7CBufferIhED2Ev.exit360
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB6_284:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_285:                              # %_ZN11CStringBaseIwED2Ev.exit448
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_287
# %bb.286:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_287:                              # %_ZN11CStringBaseIwED2Ev.exit449
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
