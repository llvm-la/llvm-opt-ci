...
.LBB2_26:
	...
	stx.w	$zero, $s3, $a0
	st.w	$s6, $fp, 12
.LBB2_27:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i39
	ld.d	$a0, $s5, 0
	.p2align	4, , 16
...
# %bb.36:                               # %.noexc392
	...
	move	$s1, $a0
	blez	$s0, .LBB6_45
# %bb.37:                               # %._crit_edge.thread.i.i390
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp151:                               # EH_LABEL
	b	.LBB6_30
.LBB6_43:                               # %.thread519.fold.split
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s1, $zero
	move	$s7, $a0
	b	.LBB6_85
.LBB6_44:                               # %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit384
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s1, $zero
...
.LBB6_46:                               #   in Loop: Header=BB6_22 Depth=1
	...
	move	$s2, $s1
	.p2align	4, , 16
.LBB6_47:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i386
...
# %bb.59:                               #   in Loop: Header=BB6_22 Depth=1
	move	$s2, $zero
.LBB6_60:                               # %_ZNK10CArcInfoEx13FindExtensionERK11CStringBaseIwE.exit431
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$s3, $sp, 96                    # 8-byte Folded Reload
	b	.LBB6_70
...
# %bb.67:                               # %.noexc418
	...
	move	$s1, $a0
	blez	$s0, .LBB6_87
# %bb.68:                               # %._crit_edge.thread.i.i416
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_69:                               #   in Loop: Header=BB6_22 Depth=1
	move	$s2, $zero
.LBB6_70:                               # %_ZNK10CArcInfoEx13FindExtensionERK11CStringBaseIwE.exit431
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $s1, 56
	slli.d	$a1, $s2, 3
	ldx.d	$a2, $a0, $a1
...
# %bb.74:                               # %.noexc439
	...
	move	$s1, $a0
	blez	$s0, .LBB6_78
# %bb.75:                               # %._crit_edge.thread.i.i437
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	...
	ld.w	$a0, $a1, 32
	b	.LBB6_79
.LBB6_76:                               # %._ZN11CStringBaseIwEaSERKS0_.exit440_crit_edge
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	bnez	$a0, .LBB6_83
	b	.LBB6_84
.LBB6_77:                               # %._ZN11CStringBaseIwEaSERKS0_.exit419_crit_edge
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	bnez	$a0, .LBB6_92
	b	.LBB6_93
...
.LBB6_79:                               #   in Loop: Header=BB6_22 Depth=1
	...
	st.w	$s3, $a1, 36
	move	$s2, $s1
.LBB6_80:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i432
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	move	$a1, $zero
	ld.d	$s3, $sp, 96                    # 8-byte Folded Reload
...
.LBB6_81:                               #   Parent Loop BB6_22 Depth=1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB6_81
# %bb.82:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i436
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.w	$a1, $sp, 112
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
	st.w	$a1, $s2, 32
...
.LBB6_83:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_84:                               # %_ZN11CStringBaseIwED2Ev.exit422
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s7, $zero
	move	$s1, $zero
.LBB6_85:                               # %.thread519
...
.LBB6_88:                               #   in Loop: Header=BB6_22 Depth=1
	...
	st.w	$s3, $a1, 36
	move	$s2, $s1
.LBB6_89:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i412
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	move	$a1, $zero
	ld.d	$s3, $sp, 96                    # 8-byte Folded Reload
...
.LBB6_92:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_93:                               # %_ZN11CStringBaseIwED2Ev.exit420
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 360
	beqz	$a0, .LBB6_95
...
.LBB6_96:
	ori	$s8, $zero, 1
.LBB6_97:                               # %_ZN11CStringBaseIwED2Ev.exit446
	addi.d	$a0, $sp, 424
...
# %bb.98:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_99:                               # %_ZN11CStringBaseIwED2Ev.exit447
	addi.w	$a0, $s8, 0
...
.Ltmp65:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp66:                                # EH_LABEL
# %bb.103:                              # %_ZN13CRecordVectorIiE3AddEi.exit329
                                        #   in Loop: Header=BB6_104 Depth=1
	ld.w	$a0, $sp, 436
	ld.d	$a1, $sp, 440
	slli.d	$a0, $a0, 2
...
.Ltmp79:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp80:                                # EH_LABEL
# %bb.126:                              # %_ZN7CBufferIhE11SetCapacityEm.exit348
	move	$s5, $a0
	ld.d	$a0, $s3, 0
	ld.d	$a4, $a0, 48
.Ltmp82:                                # EH_LABEL
...
# %bb.127:
	move	$s8, $a0
	beqz	$a0, .LBB6_134
# %bb.128:                              # %_ZN7CBufferIhED2Ev.exit359.thread
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_97
...
.Ltmp88:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp89:                                # EH_LABEL
# %bb.149:                              # %_ZNK11CStringBaseIwE13CompareNoCaseEPKw.exit356
...
# %bb.153:
	move	$s1, $zero
	b	.LBB6_191
.LBB6_154:                              # %_ZN7CBufferIhED2Ev.exit359.thread738
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$s7, $zero
...
.Ltmp111:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp112:                               # EH_LABEL
# %bb.186:                              # %_ZN13CRecordVectorIiE3AddEi.exit338
...
.LBB6_190:                              # %_ZN7CBufferIhED2Ev.exit
	slti	$s1, $s6, 256
.LBB6_191:                              # %_ZN7CBufferIhED2Ev.exit339
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 392
...
# %bb.196:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_197:                              # %_ZN11CStringBaseIwED2Ev.exit366
.Ltmp123:                               # EH_LABEL
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
...
# %bb.200:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_201:                              # %_ZN11CStringBaseIwED2Ev.exit374
	ld.w	$a1, $sp, 436
	blez	$a1, .LBB6_19
# %bb.202:                              # %.lr.ph620
	ld.d	$a2, $sp, 440
...
.LBB6_208:                              # %scalar.ph
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB6_208
.LBB6_209:                              # %._crit_edge621
	addi.w	$a0, $a4, 0
	bltz	$a0, .LBB6_19
# %bb.210:                              # %._crit_edge621
	addi.w	$a1, $a3, 0
	bge	$a0, $a1, .LBB6_19
# %bb.211:
	ld.d	$a2, $sp, 440
...
# %bb.214:                              # %.thread493
	ld.d	$a0, $sp, 440
	st.w	$s1, $a0, 0
.LBB6_215:                              # %_ZN7CBufferIhED2Ev.exit359
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
...
.Ltmp189:                               # EH_LABEL
	...
	move	$s1, $a0
	bnez	$a1, .LBB6_241
# %bb.239:                              # %_ZN11CStringBaseIwED2Ev.exit423
	ld.d	$a0, $sp, 360
	bnez	$a0, .LBB6_252
.LBB6_240:                              # %_ZN11CStringBaseIwED2Ev.exit424
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_254
	b	.LBB6_272
.LBB6_241:
...
.LBB6_246:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_247:                              # %_ZN7CBufferIhED2Ev.exit341
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_277
...
# %bb.249:
	...
	jirl	$ra, $ra, 0
	b	.LBB6_272
.LBB6_250:                              # %.loopexit.split-lp572.loopexit.split-lp
.Ltmp78:                                # EH_LABEL
	b	.LBB6_276
.LBB6_251:
.Ltmp186:                               # EH_LABEL
...
.Ltmp168:                               # EH_LABEL
	b	.LBB6_271
.LBB6_269:                              # %.loopexit.split-lp572.loopexit
.Ltmp69:                                # EH_LABEL
	b	.LBB6_276
.LBB6_270:
.Ltmp171:                               # EH_LABEL
...
.Ltmp139:                               # EH_LABEL
	b	.LBB6_276
.LBB6_275:                              # %.loopexit571
.Ltmp64:                                # EH_LABEL
.LBB6_276:                              # %_ZN7CBufferIhED2Ev.exit360
	move	$s1, $a0
.LBB6_277:                              # %_ZN7CBufferIhED2Ev.exit360
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB6_278:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_279:                              # %_ZN11CStringBaseIwED2Ev.exit448
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_281
# %bb.280:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_281:                              # %_ZN11CStringBaseIwED2Ev.exit449
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV16CStdInFileStream
	...
	.addrsig_sym _ZTV16COpenCallbackImp
