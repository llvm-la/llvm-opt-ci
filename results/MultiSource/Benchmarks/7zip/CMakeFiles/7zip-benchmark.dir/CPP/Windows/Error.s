...
# %bb.19:
	...
	move	$s0, $s4
	.p2align	4, , 16
.LBB0_20:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i
...
# %bb.26:
	move	$s0, $s1
	b	.LBB0_33
.LBB0_27:                               # %._ZN11CStringBaseIwEaSERKS0_.exit_crit_edge
	ld.d	$a0, $sp, 8
	bnez	$a0, .LBB0_36
	b	.LBB0_37
.LBB0_28:
...
# %bb.42:
	...
	move	$s0, $s3
	.p2align	4, , 16
.LBB0_43:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i14
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a0, $s4, 0
	addi.d	$s4, $s4, 1
	addi.d	$a1, $s0, 1
...
# %bb.47:
	ld.d	$a0, $sp, 264
	bnez	$a0, .LBB0_52
.LBB0_48:                               # %_ZN11CStringBaseIcED2Ev.exit39
	move	$a0, $fp
...
# %bb.15:                               # %vec.epilog.iter.check
	bnez	$a2, .LBB1_8
.LBB1_16:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $s4, $a1
	add.d	$a3, $s3, $a1
	add.d	$a1, $a0, $a1
	.p2align	4, , 16
