...
# %bb.17:
	...
	move	$a1, $s0
	.p2align	4, , 16
.LBB3_18:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i
...
.LBB3_53:                               # %.thread91
	...
	addi.w	$s3, $a0, 1
	bne	$s3, $s4, .LBB3_55
# %bb.54:                               # %._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i
	ld.d	$s2, $fp, 16
	b	.LBB3_75
.LBB3_55:
	move	$a0, $s3
...
# %bb.58:                               # %iter.check122
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB3_71
# %bb.59:                               # %vector.main.loop.iter.check109
	bgeu	$a1, $a3, .LBB3_67
# %bb.60:
	move	$a2, $zero
.LBB3_61:                               # %vec.epilog.ph126
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB3_62:                               # %vec.epilog.vector.body129
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB3_65:
	...
	bnez	$a0, .LBB3_50
	b	.LBB3_51
.LBB3_66:                               # %._crit_edge.i.i
	bnez	$a0, .LBB3_73
	b	.LBB3_74
.LBB3_67:                               # %vector.ph111
	andi	$a3, $a1, 16
...
.LBB3_68:                               # %vector.body114
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_68
# %bb.69:                               # %middle.block119
	beq	$a2, $a1, .LBB3_73
# %bb.70:                               # %vec.epilog.iter.check124
	bnez	$a3, .LBB3_61
.LBB3_71:                               # %vec.epilog.scalar.ph123.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s2, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB3_72:                               # %vec.epilog.scalar.ph123
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB3_74:
	...
	st.w	$s3, $fp, 28
	.p2align	4, , 16
.LBB3_75:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i57
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a0, $s0, 0
	addi.d	$s0, $s0, 1
	addi.d	$a1, $s2, 1
...
.Ltmp14:                                # EH_LABEL
	move	$fp, $a0
.LBB3_83:                               # %_ZN11CStringBaseIcED2Ev.exit54
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_84:
...
.LBB3_85:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_86:                               # %_ZN11CStringBaseIwED2Ev.exit55
	move	$a0, $fp
...
# %bb.0:
	...
	st.w	$s5, $sp, 28
	.p2align	4, , 16
.LBB4_1:                                # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s3, 0
	addi.d	$s3, $s3, 4
	addi.d	$a2, $a0, 4
...
.Ltmp23:                                # EH_LABEL
	...
	move	$fp, $a0
	bnez	$a1, .LBB4_12
# %bb.10:                               # %_ZN11CStringBaseIcED2Ev.exit10
	ld.d	$a0, $sp, 16
	bnez	$a0, .LBB4_14
.LBB4_11:                               # %_ZN11CStringBaseIwED2Ev.exit11
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB4_12:
