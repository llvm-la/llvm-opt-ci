...
.LBB0_18:                               # %vec.epilog.ph378
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_19:                               # %vec.epilog.vector.body381
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_19
# %bb.20:                               # %vec.epilog.middle.block385
	bne	$a2, $a1, .LBB0_52
	b	.LBB0_54
.LBB0_21:                               # %.preheader
	ld.bu	$a1, $a3, 0
...
# %bb.33:                               # %iter.check281
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_108
# %bb.34:                               # %vector.main.loop.iter.check268
	bgeu	$a1, $a3, .LBB0_104
# %bb.35:
	move	$a2, $zero
.LBB0_36:                               # %vec.epilog.ph285
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s3, $a5
	add.d	$a5, $a0, $a5
.LBB0_37:                               # %vec.epilog.vector.body288
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_37
# %bb.38:                               # %vec.epilog.middle.block292
	bne	$a2, $a1, .LBB0_108
	b	.LBB0_110
.LBB0_39:
	ori	$a0, $zero, 2
...
.LBB0_49:                               # %vector.body366
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_49
# %bb.50:                               # %middle.block371
	beq	$a2, $a1, .LBB0_54
# %bb.51:                               # %vec.epilog.iter.check376
	bnez	$a3, .LBB0_18
.LBB0_52:                               # %vec.epilog.scalar.ph375.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s2, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_53:                               # %vec.epilog.scalar.ph375
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.65:                               # %iter.check405
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_86
# %bb.66:                               # %vector.main.loop.iter.check392
	bgeu	$a1, $a3, .LBB0_82
# %bb.67:
	move	$a2, $zero
.LBB0_68:                               # %vec.epilog.ph409
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_69:                               # %vec.epilog.vector.body412
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_69
# %bb.70:                               # %vec.epilog.middle.block416
	bne	$a2, $a1, .LBB0_86
	b	.LBB0_88
.LBB0_71:
	ori	$a0, $zero, 2
...
# %bb.74:                               # %iter.check436
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_97
# %bb.75:                               # %vector.main.loop.iter.check423
	bgeu	$a1, $a3, .LBB0_93
# %bb.76:
	move	$a2, $zero
.LBB0_77:                               # %vec.epilog.ph440
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_78:                               # %vec.epilog.vector.body443
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_78
# %bb.79:                               # %vec.epilog.middle.block447
	bne	$a2, $a1, .LBB0_97
	b	.LBB0_99
...
# %bb.85:                               # %vec.epilog.iter.check407
	bnez	$a3, .LBB0_68
.LBB0_86:                               # %vec.epilog.scalar.ph406.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $fp, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_87:                               # %vec.epilog.scalar.ph406
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_94:                               # %vector.body428
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_94
# %bb.95:                               # %middle.block433
	beq	$a2, $a1, .LBB0_99
# %bb.96:                               # %vec.epilog.iter.check438
	bnez	$a3, .LBB0_77
.LBB0_97:                               # %vec.epilog.scalar.ph437.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $fp, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_98:                               # %vec.epilog.scalar.ph437
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_105:                              # %vector.body273
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_105
# %bb.106:                              # %middle.block278
	beq	$a2, $a1, .LBB0_110
# %bb.107:                              # %vec.epilog.iter.check283
	bnez	$a3, .LBB0_36
.LBB0_108:                              # %vec.epilog.scalar.ph282.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s3, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_109:                              # %vec.epilog.scalar.ph282
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.127:                              # %.preheader.i.i104
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_165
# %bb.128:                              # %iter.check343
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_176
# %bb.129:                              # %iter.check343
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_176
# %bb.130:                              # %vector.main.loop.iter.check330
	bgeu	$a1, $a3, .LBB0_172
# %bb.131:
	move	$a2, $zero
.LBB0_132:                              # %vec.epilog.ph347
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_133:                              # %vec.epilog.vector.body350
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_133
# %bb.134:                              # %vec.epilog.middle.block354
	bne	$a2, $a1, .LBB0_176
	b	.LBB0_178
.LBB0_135:
.Ltmp6:                                 # EH_LABEL
...
# %bb.137:                              # %.preheader.i.i123
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_145
# %bb.138:                              # %iter.check312
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_185
# %bb.139:                              # %iter.check312
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_185
# %bb.140:                              # %vector.main.loop.iter.check299
	bgeu	$a1, $a3, .LBB0_181
# %bb.141:
	move	$a2, $zero
.LBB0_142:                              # %vec.epilog.ph316
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_143:                              # %vec.epilog.vector.body319
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_143
# %bb.144:                              # %vec.epilog.middle.block323
	bne	$a2, $a1, .LBB0_185
	b	.LBB0_187
...
# %bb.157:                              # %.preheader.i.i166
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_165
# %bb.158:                              # %iter.check250
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_170
# %bb.159:                              # %iter.check250
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_170
# %bb.160:                              # %vector.main.loop.iter.check237
	bgeu	$a1, $a3, .LBB0_166
# %bb.161:
	move	$a2, $zero
.LBB0_162:                              # %vec.epilog.ph254
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_163:                              # %vec.epilog.vector.body257
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_163
# %bb.164:                              # %vec.epilog.middle.block261
	bne	$a2, $a1, .LBB0_170
	b	.LBB0_178
.LBB0_165:                              # %._crit_edge.i.i106
	bnez	$a0, .LBB0_178
	b	.LBB0_179
.LBB0_166:                              # %vector.ph239
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s0, 16
...
.LBB0_167:                              # %vector.body242
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_167
# %bb.168:                              # %middle.block247
	beq	$a2, $a1, .LBB0_178
# %bb.169:                              # %vec.epilog.iter.check252
	bnez	$a3, .LBB0_162
.LBB0_170:                              # %vec.epilog.scalar.ph251.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_171:                              # %vec.epilog.scalar.ph251
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_173:                              # %vector.body335
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_173
# %bb.174:                              # %middle.block340
	beq	$a2, $a1, .LBB0_178
# %bb.175:                              # %vec.epilog.iter.check345
	bnez	$a3, .LBB0_132
.LBB0_176:                              # %vec.epilog.scalar.ph344.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_177:                              # %vec.epilog.scalar.ph344
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_182:                              # %vector.body304
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_182
# %bb.183:                              # %middle.block309
	beq	$a2, $a1, .LBB0_187
# %bb.184:                              # %vec.epilog.iter.check314
	bnez	$a3, .LBB0_142
