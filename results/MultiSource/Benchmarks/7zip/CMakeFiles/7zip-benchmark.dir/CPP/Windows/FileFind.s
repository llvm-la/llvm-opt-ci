...
# %bb.15:                               # %iter.check374
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_46
# %bb.16:                               # %vector.main.loop.iter.check361
	bgeu	$a1, $a3, .LBB0_39
# %bb.17:
	move	$a2, $zero
	b	.LBB0_43
...
# %bb.30:                               # %iter.check281
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_105
# %bb.31:                               # %vector.main.loop.iter.check268
	bgeu	$a1, $a3, .LBB0_98
# %bb.32:
	move	$a2, $zero
	b	.LBB0_102
...
.LBB0_40:                               # %vector.body366
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_40
# %bb.41:                               # %middle.block371
	beq	$a2, $a1, .LBB0_48
# %bb.42:                               # %vec.epilog.iter.check376
	beqz	$a3, .LBB0_46
.LBB0_43:                               # %vec.epilog.ph378
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body381
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block385
	beq	$a2, $a1, .LBB0_48
.LBB0_46:                               # %vec.epilog.scalar.ph375.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s2, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_47:                               # %vec.epilog.scalar.ph375
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.59:                               # %iter.check405
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_77
# %bb.60:                               # %vector.main.loop.iter.check392
	bgeu	$a1, $a3, .LBB0_70
# %bb.61:
	move	$a2, $zero
	b	.LBB0_74
...
# %bb.65:                               # %iter.check436
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_91
# %bb.66:                               # %vector.main.loop.iter.check423
	bgeu	$a1, $a3, .LBB0_84
# %bb.67:
	move	$a2, $zero
	b	.LBB0_88
...
.LBB0_71:                               # %vector.body397
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_71
# %bb.72:                               # %middle.block402
	beq	$a2, $a1, .LBB0_79
# %bb.73:                               # %vec.epilog.iter.check407
	beqz	$a3, .LBB0_77
.LBB0_74:                               # %vec.epilog.ph409
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_75:                               # %vec.epilog.vector.body412
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_75
# %bb.76:                               # %vec.epilog.middle.block416
	beq	$a2, $a1, .LBB0_79
.LBB0_77:                               # %vec.epilog.scalar.ph406.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $fp, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_78:                               # %vec.epilog.scalar.ph406
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_85:                               # %vector.body428
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_85
# %bb.86:                               # %middle.block433
	beq	$a2, $a1, .LBB0_93
# %bb.87:                               # %vec.epilog.iter.check438
	beqz	$a3, .LBB0_91
.LBB0_88:                               # %vec.epilog.ph440
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_89:                               # %vec.epilog.vector.body443
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_89
# %bb.90:                               # %vec.epilog.middle.block447
	beq	$a2, $a1, .LBB0_93
.LBB0_91:                               # %vec.epilog.scalar.ph437.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $fp, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_92:                               # %vec.epilog.scalar.ph437
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_99:                               # %vector.body273
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_99
# %bb.100:                              # %middle.block278
	beq	$a2, $a1, .LBB0_107
# %bb.101:                              # %vec.epilog.iter.check283
	beqz	$a3, .LBB0_105
.LBB0_102:                              # %vec.epilog.ph285
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s3, $a5
	add.d	$a5, $a0, $a5
.LBB0_103:                              # %vec.epilog.vector.body288
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_103
# %bb.104:                              # %vec.epilog.middle.block292
	beq	$a2, $a1, .LBB0_107
.LBB0_105:                              # %vec.epilog.scalar.ph282.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s3, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_106:                              # %vec.epilog.scalar.ph282
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.124:                              # %.preheader.i.i104
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_156
# %bb.125:                              # %iter.check343
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_173
# %bb.126:                              # %iter.check343
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_173
# %bb.127:                              # %vector.main.loop.iter.check330
	bgeu	$a1, $a3, .LBB0_166
# %bb.128:
	move	$a2, $zero
	b	.LBB0_170
...
# %bb.131:                              # %.preheader.i.i123
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_136
# %bb.132:                              # %iter.check312
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_185
# %bb.133:                              # %iter.check312
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_185
# %bb.134:                              # %vector.main.loop.iter.check299
	bgeu	$a1, $a3, .LBB0_178
# %bb.135:
	move	$a2, $zero
	b	.LBB0_182
...
# %bb.151:                              # %.preheader.i.i166
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_156
# %bb.152:                              # %iter.check250
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_164
# %bb.153:                              # %iter.check250
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_164
# %bb.154:                              # %vector.main.loop.iter.check237
	bgeu	$a1, $a3, .LBB0_157
# %bb.155:
	move	$a2, $zero
	b	.LBB0_161
...
.LBB0_158:                              # %vector.body242
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_158
# %bb.159:                              # %middle.block247
	beq	$a2, $a1, .LBB0_175
# %bb.160:                              # %vec.epilog.iter.check252
	beqz	$a3, .LBB0_164
.LBB0_161:                              # %vec.epilog.ph254
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_162:                              # %vec.epilog.vector.body257
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_162
# %bb.163:                              # %vec.epilog.middle.block261
	beq	$a2, $a1, .LBB0_175
.LBB0_164:                              # %vec.epilog.scalar.ph251.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_165:                              # %vec.epilog.scalar.ph251
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_167:                              # %vector.body335
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_167
# %bb.168:                              # %middle.block340
	beq	$a2, $a1, .LBB0_175
# %bb.169:                              # %vec.epilog.iter.check345
	beqz	$a3, .LBB0_173
.LBB0_170:                              # %vec.epilog.ph347
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_171:                              # %vec.epilog.vector.body350
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_171
# %bb.172:                              # %vec.epilog.middle.block354
	beq	$a2, $a1, .LBB0_175
.LBB0_173:                              # %vec.epilog.scalar.ph344.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_174:                              # %vec.epilog.scalar.ph344
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB0_179:                              # %vector.body304
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_179
# %bb.180:                              # %middle.block309
	beq	$a2, $a1, .LBB0_187
# %bb.181:                              # %vec.epilog.iter.check314
	beqz	$a3, .LBB0_185
.LBB0_182:                              # %vec.epilog.ph316
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_183:                              # %vec.epilog.vector.body319
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_183
# %bb.184:                              # %vec.epilog.middle.block323
	beq	$a2, $a1, .LBB0_187
.LBB0_185:                              # %vec.epilog.scalar.ph313.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_186:                              # %vec.epilog.scalar.ph313
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.Lfunc_end6:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NWindows5NFile5NFindL16originalFilenameERK11CStringBaseIwERS2_IcE
...
.Lfunc_end7:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZL14filter_patternPKcS0_i
...
.Lfunc_end8:
	.size	_ZL14filter_patternPKcS0_i, .Lfunc_end8-_ZL14filter_patternPKcS0_i
                                        # -- End function
	.p2align	2                               # -- Begin function _ZN8NWindows5NFile5NFindL16fillin_CFileInfoERNS1_9CFileInfoEPKcS5_
...
.Lcst_end7:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZN8NWindows5NFile5NFindL16fillin_CFileInfoERNS1_9CFileInfoEPKc
...
.Lcst_end8:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL21my_windows_split_pathRK11CStringBaseIwERS0_S3_
...
.LBB35_9:
	move	$a2, $zero
.LBB35_10:                              # %vec.epilog.scalar.ph.preheader
	slli.d	$a3, $a2, 2
	.p2align	4, , 16
.LBB35_11:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a4, $a1, $a3
	stx.w	$a4, $a0, $a3
	addi.d	$a2, $a2, 1
