...
# %bb.15:                               # %vec.epilog.middle.block
	beq	$a1, $s3, .LBB23_18
.LBB23_16:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $s3, $a1
	alsl.d	$a3, $a1, $s2, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB23_17:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB23_17
.LBB23_18:                              # %._crit_edge.thread.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $fp, 8
.LBB23_19:
...
# %bb.16:                               # %vec.epilog.middle.block
	beq	$a1, $s0, .LBB24_19
.LBB24_17:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $s0, $a1
	alsl.d	$a3, $a1, $fp, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB24_18:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB24_18
.LBB24_19:                              # %._crit_edge.thread.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s2
	move	$a2, $s3
...
.Lcst_end18:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_FileDir.cpp
