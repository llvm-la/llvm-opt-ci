...
# %bb.7:
	move	$s3, $s4
	b	.LBB2_26
.LBB2_8:                                # %_ZNK11CStringBaseIwE11ReverseFindEw.exit.thread
	beq	$s0, $s2, .LBB2_18
# %bb.9:
	ld.d	$s4, $s2, 0
	st.w	$zero, $s2, 8
...
.LBB3_9:
	move	$a2, $zero
.LBB3_10:                               # %vec.epilog.scalar.ph.preheader
	slli.d	$a3, $a2, 2
	.p2align	4, , 16
.LBB3_11:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a4, $a1, $a3
	stx.w	$a4, $a0, $a3
	addi.d	$a2, $a2, 1
...
# %bb.16:
	move	$s4, $s2
.LBB3_17:                               # %_ZN11CStringBaseIwEC2ERKS0_.exit
	st.w	$s4, $fp, 8
