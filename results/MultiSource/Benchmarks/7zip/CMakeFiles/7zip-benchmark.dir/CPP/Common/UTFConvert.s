...
.Lfunc_end0:
	...
	.p2align	4, 0x0                          # -- Begin function _Z20ConvertUnicodeToUTF8RK11CStringBaseIwERS_IcE
.LCPI1_0:
...
.LBB1_53:                               # %vector.body67
	...
	vandi.b	$vr3, $vr3, 63
	vbitseti.b	$vr3, $vr3, 7
	add.d	$t5, $a0, $t5
	vstelm.w	$vr3, $t5, 0, 0
	beq	$t6, $t4, .LBB1_40
# %bb.54:                               #   in Loop: Header=BB1_41 Depth=1
	sub.d	$t4, $t4, $t6
.LBB1_55:                               # %.split.i.preheader
                                        #   in Loop: Header=BB1_41 Depth=1
	slli.d	$t5, $t4, 2
	alsl.d	$t5, $t4, $t5, 1
	addi.d	$t5, $t5, -6
...
.LBB1_57:
	move	$a1, $zero
	b	.LBB1_73
.LBB1_58:                               # %.lr.ph.i9.split.us.preheader
	move	$t0, $zero
	move	$a1, $zero
	ori	$a2, $zero, 128
	ori	$a3, $zero, 27
...
# %bb.64:                               #   in Loop: Header=BB1_60 Depth=1
	...
	add.w	$a7, $a7, $s2
	bltu	$a7, $a5, .LBB1_72
# %bb.65:                               # %.thread114.i25.us
                                        #   in Loop: Header=BB1_60 Depth=1
	addi.d	$a7, $t0, 2
	ori	$t0, $zero, 2
	b	.LBB1_71
	.p2align	4, , 16
.LBB1_66:                               #   in Loop: Header=BB1_60 Depth=1
	bnez	$t2, .LBB1_68
# %bb.67:                               #   in Loop: Header=BB1_60 Depth=1
	move	$t0, $zero
	b	.LBB1_71
...
# %bb.69:                               #   in Loop: Header=BB1_60 Depth=1
	...
	ori	$t0, $zero, 2
	beqz	$t2, .LBB1_71
# %bb.70:                               #   in Loop: Header=BB1_60 Depth=1
	bstrpick.d	$t0, $t1, 31, 26
	sltui	$t0, $t0, 1
	sub.d	$t0, $a6, $t0
	.p2align	4, , 16
.LBB1_71:                               # %.split.us.preheader.i.us
                                        #   in Loop: Header=BB1_60 Depth=1
	add.d	$a1, $a1, $t0
	addi.d	$a1, $a1, 2
	move	$t0, $a7
...
.LBB1_72:
	move	$s0, $zero
.LBB1_73:                               # %_ZL13Utf16_To_Utf8PcPmPKwm.exit26
	stx.b	$zero, $a0, $a1
	ld.d	$s1, $fp, 0
	move	$a0, $s1
