...
# %bb.7:
	move	$s3, $s4
	b	.LBB4_14
.LBB4_8:                                # %._ZN11CStringBaseIwEaSERKS0_.exit_crit_edge
	ld.d	$a0, $sp, 8
	bnez	$a0, .LBB4_17
	b	.LBB4_18
.LBB4_9:
...
.LBB4_15:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB4_15
# %bb.16:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
	ld.w	$a1, $sp, 16
	st.w	$a1, $s2, 8
	beqz	$a0, .LBB4_18
.LBB4_17:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_18:                               # %_ZN11CStringBaseIwED2Ev.exit
	ld.w	$a0, $s0, 8
	sub.w	$a3, $a0, $s1
	addi.d	$a0, $sp, 8
	addi.d	$s2, $sp, 8
...
# %bb.20:
	move	$s0, $s1
	b	.LBB4_27
.LBB4_21:                               # %_ZN11CStringBaseIwED2Ev.exit._ZN11CStringBaseIwEaSERKS0_.exit23_crit_edge
	ld.d	$a0, $sp, 8
	bnez	$a0, .LBB4_30
	b	.LBB4_31
.LBB4_22:
...
.LBB4_26:
	...
	stx.w	$zero, $s0, $a0
	st.w	$s2, $fp, 12
.LBB4_27:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i15
	ld.d	$a0, $sp, 8
	move	$a1, $zero
	.p2align	4, , 16
.LBB4_28:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB4_28
# %bb.29:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i19
	ld.w	$a1, $sp, 16
	st.w	$a1, $fp, 8
	beqz	$a0, .LBB4_31
.LBB4_30:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_31:                               # %_ZN11CStringBaseIwED2Ev.exit24
...
.Lfunc_end7:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZL16EnhancedMaskTestPKwS0_
...
# %bb.6:                                # %_ZNK9NWildcard11CCensorNode9CheckPathERK11CStringBaseIwEbRb.exit
	...
	ld.bu	$a0, $sp, 39
	beqz	$s2, .LBB35_2
# %bb.7:                                # %_ZNK9NWildcard11CCensorNode9CheckPathERK11CStringBaseIwEbRb.exit
                                        #   in Loop: Header=BB35_3 Depth=1
	bnez	$a0, .LBB35_2
.LBB35_8:
	move	$s5, $zero
...
.LBB44_9:
	move	$a2, $zero
.LBB44_10:                              # %vec.epilog.scalar.ph.preheader
	slli.d	$a3, $a2, 2
	.p2align	4, , 16
.LBB44_11:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a4, $a1, $a3
	stx.w	$a4, $a0, $a3
	addi.d	$a2, $a2, 1
...
.Lcst_end27:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_Wildcard.cpp
