...
.Lcst_end0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL11RemoveQuoteR11CStringBaseIwE
...
# %bb.21:                               # %vec.epilog.middle.block
	beq	$a2, $a1, .LBB1_24
.LBB1_22:                               # %vec.epilog.scalar.ph.preheader
	sub.d	$a3, $a1, $a2
	slli.d	$a2, $a2, 2
	.p2align	4, , 16
.LBB1_23:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s0, $a2
	ld.w	$a4, $a4, 4
	stx.w	$a4, $fp, $a2
...
.LBB1_31:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i8.preheader
	move	$a1, $zero
	.p2align	4, , 16
.LBB1_32:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i8
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a2, $fp, $a1
	stx.w	$a2, $s1, $a1
	addi.d	$a1, $a1, 4
...
# %bb.33:                               # %_ZN11CStringBaseIwED2Ev.exit
	...
	jr	$t8
.LBB1_34:                               # %_ZN11CStringBaseIwED2Ev.exit10
.Ltmp67:                                # EH_LABEL
	move	$s0, $a0
	move	$s1, $fp
	move	$a0, $s1
