...
.LBB0_7:                                # %.critedge
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_8:                                # %_ZN11CStringBaseIwED2Ev.exit21.thread
	st.d	$zero, $fp, 8
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
...
.Ltmp5:                                 # EH_LABEL
	...
	move	$fp, $a0
	beqz	$s1, .LBB0_16
.LBB0_15:                               # %_ZN11CStringBaseIwED2Ev.exit22.sink.split
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_16:                               # %_ZN11CStringBaseIwED2Ev.exit22
	move	$a0, $fp
...
.LBB2_7:                                # %.critedge
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_8:                                # %_ZN11CStringBaseIcED2Ev.exit24.thread
	st.d	$zero, $fp, 8
	ori	$a0, $zero, 4
	ori	$s1, $zero, 4
	pcaddu18i	$ra, %call36(_Znam)
...
.Ltmp11:                                # EH_LABEL
	...
	move	$fp, $a0
	beqz	$s1, .LBB2_16
.LBB2_15:                               # %_ZN11CStringBaseIcED2Ev.exit25.sink.split
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_16:                               # %_ZN11CStringBaseIcED2Ev.exit25
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end2:
