...
# %bb.13:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_14:                               # %_ZN11CStringBaseIwED2Ev.exit5
	move	$a0, $fp
...
.LBB3_1:                                # =>This Inner Loop Header: Depth=1
	...
	jirl	$ra, $ra, 0
	beq	$a0, $s2, .LBB3_5
# %bb.2:                                # %_ZN12CStdInStream7GetCharEv.exit
                                        #   in Loop: Header=BB3_1 Depth=1
	andi	$a1, $a0, 255
	beq	$a1, $s3, .LBB3_7
# %bb.3:                                # %_ZN12CStdInStream7GetCharEv.exit
                                        #   in Loop: Header=BB3_1 Depth=1
	beqz	$a1, .LBB3_8
...
# %bb.0:
	...
	beq	$a0, $s1, .LBB6_2
	.p2align	4, , 16
.LBB6_1:                                # %_ZN12CStdInStream7GetCharEv.exit
                                        # =>This Inner Loop Header: Depth=1
	ext.w.b	$a1, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN11CStringBaseIcEpLEc)
...
.Lfunc_end7:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_StdInStream.cpp
