...
# %bb.10:                               # %.preheader24.us.i.preheader.preheader
	...
	xvadd.d	$xr12, $xr7, $xr2
	xvadd.d	$xr13, $xr8, $xr2
	xvadd.d	$xr14, $xr10, $xr2
	xvadd.d	$xr15, $xr9, $xr2
	addi.d	$a0, $t7, 120
	...
	xvpermi.d	$xr16, $xr1, 68
	xvpermi.d	$xr17, $xr0, 68
	...
	st.d	$t7, $sp, 768                   # 8-byte Folded Spill
...
.LBB4_13:                               # %.preheader24.us.i
	...
	xvori.b	$xr2, $xr0, 0
	xvshuf.d	$xr2, $xr16, $xr1
	xvreplgr2vr.d	$xr1, $t1
	xvslt.du	$xr3, $xr1, $xr12
	xvslt.du	$xr4, $xr1, $xr13
	xvpickev.w	$xr3, $xr4, $xr3
	xvpermi.d	$xr3, $xr3, 216
	xvslt.du	$xr2, $xr1, $xr2
	...
	xvshuf.d	$xr0, $xr17, $xr3
	xvreplgr2vr.d	$xr3, $a1
	xvslt.du	$xr4, $xr7, $xr3
	xvslt.du	$xr5, $xr8, $xr3
	xvpickev.w	$xr4, $xr5, $xr4
	xvpermi.d	$xr4, $xr4, 216
	xvslt.du	$xr0, $xr0, $xr3
	xvslt.du	$xr5, $xr6, $xr3
	xvpickev.w	$xr0, $xr5, $xr0
	...
	xvpermi.d	$xr0, $xr0, 216
	vand.v	$vr0, $vr2, $vr0
	xvslt.du	$xr2, $xr1, $xr15
	xvslt.du	$xr1, $xr1, $xr14
	xvpickev.w	$xr1, $xr1, $xr2
	xvpermi.d	$xr1, $xr1, 216
	xvpickev.h	$xr1, $xr1, $xr1
	xvpermi.d	$xr1, $xr1, 216
	xvslt.du	$xr2, $xr9, $xr3
	xvslt.du	$xr3, $xr10, $xr3
...
# %bb.14:                               # %.preheader24.us.i
	...
	sltu	$a6, $t7, $a1
	and	$a6, $a0, $a6
	ld.d	$s6, $sp, 848                   # 8-byte Folded Reload
...
# %bb.23:                               #   in Loop: Header=BB4_13 Depth=2
	...
	xvld	$xr12, $sp, 192                 # 32-byte Folded Reload
