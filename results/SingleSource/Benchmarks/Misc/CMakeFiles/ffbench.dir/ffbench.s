...
.LBB0_5:                                # %vector.body
	...
	b	.LBB0_2
	.p2align	4, , 16
.LBB0_6:                                # %vector.body152.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	ori	$a5, $zero, 256
	xvori.b	$xr3, $xr0, 0
	b	.LBB0_8
	.p2align	4, , 16
.LBB0_7:                                # %pred.store.continue169
                                        #   in Loop: Header=BB0_8 Depth=2
	addi.d	$a5, $a5, -8
	xvaddi.du	$xr3, $xr3, 8
	beqz	$a5, .LBB0_2
.LBB0_8:                                # %vector.body152
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvand.v	$xr4, $xr3, $xr2
	xvseqi.d	$xr5, $xr4, 8
...
# %bb.9:                                # %pred.store.continue
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB0_18
.LBB0_10:                               # %pred.store.continue157
                                        #   in Loop: Header=BB0_8 Depth=2
	xvpickve2gr.d	$a6, $xr5, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB0_19
.LBB0_11:                               # %pred.store.continue159
                                        #   in Loop: Header=BB0_8 Depth=2
	xvpickve2gr.d	$a6, $xr5, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB0_13
.LBB0_12:                               # %pred.store.if160
                                        #   in Loop: Header=BB0_8 Depth=2
	xvpickve2gr.d	$a6, $xr4, 3
	add.d	$a6, $a4, $a6
	st.d	$a2, $a6, 8
.LBB0_13:                               # %pred.store.continue161
                                        #   in Loop: Header=BB0_8 Depth=2
	xvaddi.du	$xr4, $xr3, 4
	xvand.v	$xr5, $xr4, $xr2
	xvseqi.d	$xr5, $xr5, 8
	...
	xvslli.d	$xr4, $xr4, 4
	bnez	$a6, .LBB0_20
# %bb.14:                               # %pred.store.continue163
                                        #   in Loop: Header=BB0_8 Depth=2
	xvpickve2gr.d	$a6, $xr5, 1
	andi	$a6, $a6, 1
	bnez	$a6, .LBB0_21
.LBB0_15:                               # %pred.store.continue165
                                        #   in Loop: Header=BB0_8 Depth=2
	xvpickve2gr.d	$a6, $xr5, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB0_22
.LBB0_16:                               # %pred.store.continue167
                                        #   in Loop: Header=BB0_8 Depth=2
	xvpickve2gr.d	$a6, $xr5, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB0_7
...
.LBB0_22:                               # %pred.store.if166
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB0_7
.LBB0_23:                               # %pred.store.if168
                                        #   in Loop: Header=BB0_8 Depth=2
	xvpickve2gr.d	$a6, $xr4, 3
	add.d	$a6, $a4, $a6
	st.d	$a2, $a6, 8
	b	.LBB0_7
.LBB0_24:                               # %.preheader96.preheader
	ori	$s1, $zero, 63
	addi.w	$s0, $zero, -1
	.p2align	4, , 16
.LBB0_25:                               # %.preheader96
