...
# %bb.97:                               # %middle.block995
	...
	beq	$a2, $a3, .LBB5_100
.LBB5_98:                               # %.lr.ph.i.i150.preheader1128
                                        #   in Loop: Header=BB5_93 Depth=1
	addi.d	$a1, $a1, -8
	.p2align	4, , 16
...
# %bb.141:                              # %.lr.ph.i.i191.preheader
	...
	ld.d	$a2, $sp, 136                   # 8-byte Folded Reload
	bnez	$a2, .LBB5_145
# %bb.142:                              # %vector.body1006.preheader
                                        #   in Loop: Header=BB5_140 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	addi.d	$a1, $s1, 32
	ld.d	$a2, $sp, 8                     # 8-byte Folded Reload
	.p2align	4, , 16
.LBB5_143:                              # %vector.body1006
...
# %bb.164:                              # %.lr.ph.i.i247.preheader
	...
	move	$a0, $s3
	bnez	$s8, .LBB5_168
# %bb.165:                              # %vector.body1026.preheader
                                        #   in Loop: Header=BB5_163 Depth=1
	addi.d	$a0, $s1, -32
	addi.d	$a1, $s3, -32
	move	$a2, $s7
	.p2align	4, , 16
.LBB5_166:                              # %vector.body1026
	...
	addi.d	$a0, $a0, -32
	bnez	$a2, .LBB5_166
# %bb.167:                              # %middle.block1036
                                        #   in Loop: Header=BB5_163 Depth=1
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	beq	$a2, $s7, .LBB5_170
.LBB5_168:                              # %.lr.ph.i.i247.preheader1120
                                        #   in Loop: Header=BB5_163 Depth=1
	addi.d	$a1, $a1, -8
	.p2align	4, , 16
...
# %bb.195:                              # %.lr.ph.i.i289.preheader
	...
	ld.d	$a2, $sp, 136                   # 8-byte Folded Reload
	bnez	$a2, .LBB5_199
# %bb.196:                              # %vector.body1047.preheader
                                        #   in Loop: Header=BB5_194 Depth=1
	move	$a0, $s4
	addi.d	$a1, $s5, 32
	addi.d	$a2, $s1, 32
	.p2align	4, , 16
.LBB5_197:                              # %vector.body1047
...
# %bb.253:                              # %.lr.ph.i.i332.preheader
	...
	move	$a0, $s4
	bnez	$s8, .LBB5_257
# %bb.254:                              # %vector.body1067.preheader
                                        #   in Loop: Header=BB5_252 Depth=1
	addi.d	$a0, $s1, -32
	addi.d	$a1, $s4, -32
	move	$a2, $s7
	.p2align	4, , 16
.LBB5_255:                              # %vector.body1067
	...
	addi.d	$a0, $a0, -32
	bnez	$a2, .LBB5_255
# %bb.256:                              # %middle.block1077
                                        #   in Loop: Header=BB5_252 Depth=1
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	beq	$a2, $s7, .LBB5_259
.LBB5_257:                              # %.lr.ph.i.i332.preheader1111
                                        #   in Loop: Header=BB5_252 Depth=1
	addi.d	$a1, $a1, -8
	.p2align	4, , 16
...
# %bb.284:                              # %.lr.ph.i.i375.preheader
	...
	ld.d	$a2, $sp, 136                   # 8-byte Folded Reload
	bnez	$a2, .LBB5_288
# %bb.285:                              # %vector.body1088.preheader
                                        #   in Loop: Header=BB5_283 Depth=1
	move	$a0, $s3
	addi.d	$a1, $s5, 32
	addi.d	$a2, $s1, 32
	.p2align	4, , 16
.LBB5_286:                              # %vector.body1088
