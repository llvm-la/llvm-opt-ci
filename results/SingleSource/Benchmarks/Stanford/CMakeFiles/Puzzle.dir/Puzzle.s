...
# %bb.6:                                # %pred.store.continue
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_14
.LBB3_7:                                # %pred.store.continue35
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr0, 2
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_15
.LBB3_8:                                # %pred.store.continue37
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr0, 3
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_16
.LBB3_9:                                # %pred.store.continue39
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr0, 4
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_17
.LBB3_10:                               # %pred.store.continue41
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr0, 5
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_18
.LBB3_11:                               # %pred.store.continue43
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr0, 6
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_19
.LBB3_12:                               # %pred.store.continue45
                                        #   in Loop: Header=BB3_5 Depth=1
...
.LBB3_13:                               # %pred.store.if
	...
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_7
.LBB3_14:                               # %pred.store.if34
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, -12
	vpickve2gr.h	$t3, $vr0, 2
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_8
.LBB3_15:                               # %pred.store.if36
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, -8
	vpickve2gr.h	$t3, $vr0, 3
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_9
.LBB3_16:                               # %pred.store.if38
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, -4
	vpickve2gr.h	$t3, $vr0, 4
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_10
.LBB3_17:                               # %pred.store.if40
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 0
	vpickve2gr.h	$t3, $vr0, 5
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_11
.LBB3_18:                               # %pred.store.if42
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 4
	vpickve2gr.h	$t3, $vr0, 6
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_12
.LBB3_19:                               # %pred.store.if44
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 8
	vpickve2gr.h	$t3, $vr0, 7
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_4
.LBB3_20:                               # %pred.store.if46
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 12
	b	.LBB3_4
...
# %bb.6:                                # %pred.store.continue
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr0, 1
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_14
.LBB4_7:                                # %pred.store.continue13
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr0, 2
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_15
.LBB4_8:                                # %pred.store.continue15
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr0, 3
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_16
.LBB4_9:                                # %pred.store.continue17
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr0, 4
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_17
.LBB4_10:                               # %pred.store.continue19
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr0, 5
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_18
.LBB4_11:                               # %pred.store.continue21
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr0, 6
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_19
.LBB4_12:                               # %pred.store.continue23
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr0, 7
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_4
	b	.LBB4_20
	.p2align	4, , 16
.LBB4_13:                               # %pred.store.if
	...
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_7
.LBB4_14:                               # %pred.store.if12
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, -12
	vpickve2gr.h	$t2, $vr0, 2
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_8
.LBB4_15:                               # %pred.store.if14
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, -8
	vpickve2gr.h	$t2, $vr0, 3
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_9
.LBB4_16:                               # %pred.store.if16
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, -4
	vpickve2gr.h	$t2, $vr0, 4
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_10
.LBB4_17:                               # %pred.store.if18
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 0
	vpickve2gr.h	$t2, $vr0, 5
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_11
.LBB4_18:                               # %pred.store.if20
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 4
	vpickve2gr.h	$t2, $vr0, 6
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_12
.LBB4_19:                               # %pred.store.if22
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 8
	vpickve2gr.h	$t2, $vr0, 7
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_4
.LBB4_20:                               # %pred.store.if24
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 12
	b	.LBB4_4
...
.LBB5_11:                               # %vector.ph58
	...
	b	.LBB5_13
	.p2align	4, , 16
.LBB5_12:                               # %pred.store.continue79
                                        #   in Loop: Header=BB5_13 Depth=2
	addi.d	$a4, $a4, 32
	beq	$a5, $a4, .LBB5_29
.LBB5_13:                               # %vector.body61
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_21
# %bb.14:                               # %pred.store.continue65
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 1
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_22
.LBB5_15:                               # %pred.store.continue67
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_23
.LBB5_16:                               # %pred.store.continue69
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_24
.LBB5_17:                               # %pred.store.continue71
                                        #   in Loop: Header=BB5_13 Depth=2
...
.LBB5_24:                               # %pred.store.if70
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_18
.LBB5_25:                               # %pred.store.if72
                                        #   in Loop: Header=BB5_13 Depth=2
	stx.w	$fp, $s2, $a4
	vpickve2gr.h	$a6, $vr0, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_19
.LBB5_26:                               # %pred.store.if74
                                        #   in Loop: Header=BB5_13 Depth=2
	add.d	$a6, $s2, $a4
	st.w	$fp, $a6, 4
	vpickve2gr.h	$a6, $vr0, 6
...
.LBB5_27:                               # %pred.store.if76
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_12
.LBB5_28:                               # %pred.store.if78
                                        #   in Loop: Header=BB5_13 Depth=2
	add.d	$a6, $s2, $a4
	st.w	$fp, $a6, 12
	b	.LBB5_12
.LBB5_29:                               # %middle.block81
                                        #   in Loop: Header=BB5_3 Depth=1
	bne	$a3, $a2, .LBB5_40
	.p2align	4, , 16
.LBB5_30:                               # %._crit_edge.i
                                        #   in Loop: Header=BB5_3 Depth=1
	alsl.d	$a0, $a0, $s6, 2
	addi.d	$a1, $a1, -1
	st.w	$a1, $a0, 0
...
# %bb.47:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_55
.LBB5_48:                               # %pred.store.continue43
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_56
.LBB5_49:                               # %pred.store.continue45
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 3
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_57
.LBB5_50:                               # %pred.store.continue47
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 4
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_58
.LBB5_51:                               # %pred.store.continue49
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_59
.LBB5_52:                               # %pred.store.continue51
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_60
.LBB5_53:                               # %pred.store.continue53
                                        #   in Loop: Header=BB5_46 Depth=2
...
.LBB5_57:                               # %pred.store.if46
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_51
.LBB5_58:                               # %pred.store.if48
                                        #   in Loop: Header=BB5_46 Depth=2
	stx.w	$zero, $s2, $a2
	vpickve2gr.h	$a4, $vr0, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_52
.LBB5_59:                               # %pred.store.if50
                                        #   in Loop: Header=BB5_46 Depth=2
	add.d	$a4, $s2, $a2
	st.w	$zero, $a4, 4
	vpickve2gr.h	$a4, $vr0, 6
...
.LBB6_30:
	...
	jr	$t8
.LBB6_31:                               # %.lr.ph.i171.preheader
	beqz	$a1, .LBB6_33
# %bb.32:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 292
.LBB6_33:                               # %.lr.ph.i171.1
	beqz	$a2, .LBB6_35
# %bb.34:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 296
.LBB6_35:                               # %.lr.ph.i171.2
	beqz	$a3, .LBB6_37
# %bb.36:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 300
.LBB6_37:                               # %.lr.ph.i171.3
	beqz	$a4, .LBB6_39
# %bb.38:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 304
.LBB6_39:                               # %.lr.ph.i171.4
	beqz	$a5, .LBB6_41
# %bb.40:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 308
.LBB6_41:                               # %.lr.ph.i171.5
	beqz	$a6, .LBB6_43
# %bb.42:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 312
.LBB6_43:                               # %.lr.ph.i171.6
	beqz	$a7, .LBB6_45
# %bb.44:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 316
.LBB6_45:                               # %.lr.ph.i171.7
	beqz	$t0, .LBB6_47
# %bb.46:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 320
.LBB6_47:                               # %.lr.ph.i171.8
	beqz	$t1, .LBB6_49
# %bb.48:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 324
.LBB6_49:                               # %.lr.ph.i171.9
	beqz	$t2, .LBB6_51
# %bb.50:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 328
.LBB6_51:                               # %.lr.ph.i171.10
	beqz	$t3, .LBB6_53
# %bb.52:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 332
.LBB6_53:                               # %.lr.ph.i171.11
	beqz	$t4, .LBB6_55
# %bb.54:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 336
.LBB6_55:                               # %._crit_edge.i
	ori	$a1, $zero, 12
