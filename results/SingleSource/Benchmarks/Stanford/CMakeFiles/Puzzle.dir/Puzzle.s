...
# %bb.6:                                # %pred.store.continue
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_15
.LBB3_7:                                # %pred.store.continue36
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.w	$t3, $vr0, 2
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_16
.LBB3_8:                                # %pred.store.continue38
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.w	$t3, $vr0, 3
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_10
.LBB3_9:                                # %pred.store.if39
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, -4
.LBB3_10:                               # %pred.store.continue40
                                        #   in Loop: Header=BB3_5 Depth=1
	vld	$vr0, $a7, 0
	vseqi.w	$vr0, $vr0, 0
	vxori.b	$vr0, $vr0, 255
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_17
# %bb.11:                               # %pred.store.continue42
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.w	$t3, $vr0, 1
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_18
.LBB3_12:                               # %pred.store.continue44
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.w	$t3, $vr0, 2
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_19
.LBB3_13:                               # %pred.store.continue46
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.w	$t3, $vr0, 3
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_4
...
.LBB3_14:                               # %pred.store.if
	...
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_7
.LBB3_15:                               # %pred.store.if35
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, -12
	vpickve2gr.w	$t3, $vr0, 2
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_8
.LBB3_16:                               # %pred.store.if37
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, -8
	vpickve2gr.w	$t3, $vr0, 3
	andi	$t3, $t3, 1
	...
	b	.LBB3_10
	.p2align	4, , 16
.LBB3_17:                               # %pred.store.if41
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 0
	vpickve2gr.w	$t3, $vr0, 1
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_12
.LBB3_18:                               # %pred.store.if43
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 4
	vpickve2gr.w	$t3, $vr0, 2
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_13
.LBB3_19:                               # %pred.store.if45
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 8
	vpickve2gr.w	$t3, $vr0, 3
	andi	$t3, $t3, 1
	beqz	$t3, .LBB3_4
.LBB3_20:                               # %pred.store.if47
                                        #   in Loop: Header=BB3_5 Depth=1
	st.w	$t1, $t0, 12
	b	.LBB3_4
...
# %bb.6:                                # %pred.store.continue
	...
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_15
.LBB4_7:                                # %pred.store.continue14
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.w	$t2, $vr0, 2
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_16
.LBB4_8:                                # %pred.store.continue16
                                        #   in Loop: Header=BB4_5 Depth=1
...
.LBB4_10:                               # %pred.store.continue18
	...
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_17
# %bb.11:                               # %pred.store.continue20
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.w	$t2, $vr0, 1
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_18
.LBB4_12:                               # %pred.store.continue22
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.w	$t2, $vr0, 2
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_19
.LBB4_13:                               # %pred.store.continue24
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.w	$t2, $vr0, 3
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_4
...
.LBB4_14:                               # %pred.store.if
	...
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_7
.LBB4_15:                               # %pred.store.if13
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, -12
	vpickve2gr.w	$t2, $vr0, 2
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_8
.LBB4_16:                               # %pred.store.if15
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, -8
	vpickve2gr.w	$t2, $vr0, 3
	andi	$t2, $t2, 1
	...
	b	.LBB4_10
	.p2align	4, , 16
.LBB4_17:                               # %pred.store.if19
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 0
	vpickve2gr.w	$t2, $vr0, 1
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_12
.LBB4_18:                               # %pred.store.if21
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 4
	vpickve2gr.w	$t2, $vr0, 2
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_13
.LBB4_19:                               # %pred.store.if23
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 8
	vpickve2gr.w	$t2, $vr0, 3
	andi	$t2, $t2, 1
	beqz	$t2, .LBB4_4
.LBB4_20:                               # %pred.store.if25
                                        #   in Loop: Header=BB4_5 Depth=1
	st.w	$zero, $t0, 12
	b	.LBB4_4
...
# %bb.47:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_56
.LBB5_48:                               # %pred.store.continue44
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr0, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_57
.LBB5_49:                               # %pred.store.continue46
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr0, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_51
.LBB5_50:                               # %pred.store.if47
                                        #   in Loop: Header=BB5_46 Depth=2
	add.d	$a4, $s2, $a2
	st.w	$zero, $a4, -4
.LBB5_51:                               # %pred.store.continue48
                                        #   in Loop: Header=BB5_46 Depth=2
	add.d	$a4, $s4, $a2
	vld	$vr0, $a4, 16
	vseqi.w	$vr0, $vr0, 0
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_58
# %bb.52:                               # %pred.store.continue50
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr0, 1
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_59
.LBB5_53:                               # %pred.store.continue52
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr0, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_60
.LBB5_54:                               # %pred.store.continue54
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr0, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_45
...
.LBB5_57:                               # %pred.store.if45
	...
	b	.LBB5_51
	.p2align	4, , 16
.LBB5_58:                               # %pred.store.if49
                                        #   in Loop: Header=BB5_46 Depth=2
	stx.w	$zero, $s2, $a2
	vpickve2gr.w	$a4, $vr0, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_53
.LBB5_59:                               # %pred.store.if51
                                        #   in Loop: Header=BB5_46 Depth=2
	add.d	$a4, $s2, $a2
	st.w	$zero, $a4, 4
	vpickve2gr.w	$a4, $vr0, 2
