...
.LBB8_14:                               # %.loopexit
	...
	addi.d	$s7, $s7, 4
	bge	$s6, $a1, .LBB8_10
.LBB8_15:                               #   Parent Loop BB8_11 Depth=1
...
.LBB8_20:                               #   in Loop: Header=BB8_21 Depth=3
	...
	addi.d	$s2, $s2, 1
	beq	$s7, $s1, .LBB8_13
.LBB8_21:                               #   Parent Loop BB8_11 Depth=1
...
# %bb.24:                               #   in Loop: Header=BB8_21 Depth=3
	beq	$a1, $s3, .LBB8_20
.LBB8_25:                               #   in Loop: Header=BB8_21 Depth=3
	beqz	$a3, .LBB8_20
# %bb.26:                               #   in Loop: Header=BB8_21 Depth=3
	beqz	$a1, .LBB8_20
# %bb.27:                               #   in Loop: Header=BB8_21 Depth=3
	ori	$a4, $zero, 2
	beq	$s8, $a4, .LBB8_30
# %bb.28:                               #   in Loop: Header=BB8_21 Depth=3
	ori	$a4, $zero, 4
	bne	$s8, $a4, .LBB8_31
# %bb.29:                               #   in Loop: Header=BB8_21 Depth=3
	mod.w	$a4, $a3, $a1
	bnez	$a4, .LBB8_20
.LBB8_30:                               #   in Loop: Header=BB8_21 Depth=3
	slt	$a4, $a1, $a3
	masknez	$a5, $a1, $a4
	maskeqz	$a4, $a3, $a4
	slt	$a6, $a3, $a1
	...
	or	$a1, $a3, $a1
	move	$a3, $a4
.LBB8_31:                               #   in Loop: Header=BB8_21 Depth=3
	...
	ori	$a5, $zero, 3
	bltu	$a5, $a4, .LBB8_36
# %bb.32:                               #   in Loop: Header=BB8_21 Depth=3
	slli.d	$a4, $a4, 2
	...
	add.d	$a4, $a5, $a4
	jr	$a4
.LBB8_33:                               #   in Loop: Header=BB8_21 Depth=3
	add.d	$a3, $a1, $a3
	b	.LBB8_19
.LBB8_34:                               #   in Loop: Header=BB8_21 Depth=3
	div.w	$a3, $a3, $a1
	b	.LBB8_19
.LBB8_35:                               #   in Loop: Header=BB8_21 Depth=3
	sub.d	$a3, $a3, $a1
	b	.LBB8_19
...
.LBB10_3:
	...
	ldx.w	$a1, $a1, $a2
	pcalau12i	$fp, %pc_hi20(listLength)
	st.w	$a0, $fp, %pc_lo12(listLength)
	pcalau12i	$a2, %pc_hi20(goal)
	st.w	$a1, $a2, %pc_lo12(goal)
	slli.w	$a0, $a0, 1
	ori	$a1, $zero, 4
	pcaddu18i	$ra, %call36(calloc)
	jirl	$ra, $ra, 0
...
# %bb.4:                                # %newWorkList.exit
	move	$s2, $a0
	ld.w	$a0, $fp, %pc_lo12(listLength)
	pcalau12i	$a1, %pc_hi20(workList)
	st.d	$s2, $a1, %pc_lo12(workList)
	ori	$a1, $zero, 12
	pcaddu18i	$ra, %call36(calloc)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB10_22
# %bb.5:                                # %newCombList.exit
	move	$s1, $a0
	ld.w	$a0, $fp, %pc_lo12(listLength)
	pcalau12i	$a1, %pc_hi20(combList)
	st.d	$s1, $a1, %pc_lo12(combList)
	ori	$a1, $zero, 12
	pcaddu18i	$ra, %call36(calloc)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB10_22
...
.LBB10_13:                              # %.lr.ph.i12
	...
	addi.d	$a1, $a1, 12
	bnez	$a2, .LBB10_13
.LBB10_14:                              # %.lr.ph.i18.preheader
	ori	$a1, $zero, 1
	bne	$fp, $a1, .LBB10_16
# %bb.15:
	move	$a0, $zero
	b	.LBB10_19
.LBB10_16:                              # %vector.ph28
	slli.d	$a0, $a0, 1
	addi.d	$a1, $s0, 20
	move	$a2, $a0
	.p2align	4, , 16
.LBB10_17:                              # %vector.body31
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a1, -12
	st.w	$zero, $a1, 0
	addi.d	$a2, $a2, -2
	addi.d	$a1, $a1, 24
	bnez	$a2, .LBB10_17
# %bb.18:                               # %middle.block34
	beq	$a0, $fp, .LBB10_21
.LBB10_19:                              # %.lr.ph.i18.preheader37
	sub.d	$a1, $fp, $a0
	slli.d	$a2, $a0, 3
	alsl.d	$a0, $a0, $a2, 2
	add.d	$a0, $a0, $s0
