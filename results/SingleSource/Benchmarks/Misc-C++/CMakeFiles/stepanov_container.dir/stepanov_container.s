...
.LBB5_28:                               # %_ZSt6uniqueISt15_Deque_iteratorIdRdPdEET_S4_S4_.exit
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB5_34
# %bb.29:
	addi.d	$a2, $fp, 8
	bgeu	$a1, $a2, .LBB5_33
# %bb.30:                               # %.lr.ph.i.i.i17.preheader
	addi.d	$a1, $a1, -8
	.p2align	4, , 16
.LBB5_31:                               # %.lr.ph.i.i.i17
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a1, 8
	addi.d	$s0, $a1, 8
	ori	$a1, $zero, 512
...
.LBB5_35:                               #   in Loop: Header=BB5_37 Depth=1
	addi.d	$a2, $a2, 8
	beq	$a2, $a5, .LBB5_41
.LBB5_36:                               # %_ZNSt15_Deque_iteratorIdRdPdEppEv.exit2.i.i
                                        #   in Loop: Header=BB5_37 Depth=1
	fst.d	$fa1, $a2, 0
	fmov.d	$fa0, $fa1
	.p2align	4, , 16
.LBB5_37:                               # %_ZNSt15_Deque_iteratorIdRdPdEppEv.exit.i.i
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a4, $a4, 8
	bne	$a4, $a7, .LBB5_39
# %bb.38:                               #   in Loop: Header=BB5_37 Depth=1
	...
	addi.d	$a6, $a6, 8
	addi.d	$a7, $a4, 512
.LBB5_39:                               # %_ZNSt15_Deque_iteratorIdRdPdEppEv.exit1.i.i
                                        #   in Loop: Header=BB5_37 Depth=1
	beq	$a4, $a0, .LBB5_28
...
# %bb.36:                               # %.noexc70
	...
	addi.w	$s2, $s2, -1
	bltu	$s3, $s2, .LBB14_35
.LBB14_37:                              # %_Z3runPFvPdS_iES_S_i.exit71.thread87
	sub.d	$a1, $s1, $fp
	move	$a0, $fp
...
.LBB19_13:                              #   in Loop: Header=BB19_3 Depth=1
	...
	fst.d	$fa1, $a0, 0
	.p2align	4, , 16
.LBB19_14:                              # %_ZSt22__move_median_to_firstIPdN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_.exit.i.preheader
                                        #   in Loop: Header=BB19_3 Depth=1
	addi.d	$s0, $s0, -1
	move	$a0, $a1
	move	$s7, $s2
	.p2align	4, , 16
.LBB19_15:                              # %_ZSt22__move_median_to_firstIPdN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_.exit.i
...
# %bb.19:                               #   in Loop: Header=BB19_15 Depth=2
	bgeu	$s1, $a0, .LBB19_21
# %bb.20:                               #   in Loop: Header=BB19_15 Depth=2
	fst.d	$fa2, $s1, 0
	fst.d	$fa1, $a0, 0
	b	.LBB19_15
	.p2align	4, , 16
.LBB19_21:                              # %_ZSt27__unguarded_partition_pivotIPdN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_T0_.exit
                                        #   in Loop: Header=BB19_3 Depth=1
	move	$a0, $s1
	move	$a2, $s0
	move	$a3, $zero
...
.LBB19_25:                              #   in Loop: Header=BB19_27 Depth=1
	move	$a3, $zero
.LBB19_26:                              # %_ZSt10__pop_heapIPdN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_RT0_.exit.i.i
...
# %bb.32:                               # %.thread.i.i.i
	...
	b	.LBB19_34
	.p2align	4, , 16
.LBB19_33:                              #   in Loop: Header=BB19_27 Depth=1
	beqz	$a3, .LBB19_25
	.p2align	4, , 16
.LBB19_34:                              # %.lr.ph.i.i.i.i.i
                                        #   Parent Loop BB19_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a4, $a3, -1
	srli.d	$a4, $a4, 1
...
# %bb.35:                               #   in Loop: Header=BB19_34 Depth=2
	...
	bnez	$a4, .LBB19_34
	b	.LBB19_25
.LBB19_36:                              # %_ZSt14__partial_sortIPdN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_T0_.exit
...
.LBB22_13:                              #   in Loop: Header=BB22_3 Depth=1
	...
	fst.d	$fa1, $a2, 0
	.p2align	4, , 16
.LBB22_14:                              # %_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEEvT_S9_S9_S9_T0_.exit.i.preheader
                                        #   in Loop: Header=BB22_3 Depth=1
	addi.d	$s0, $s0, -1
	move	$s5, $s2
	.p2align	4, , 16
.LBB22_15:                              # %_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEEvT_S9_S9_S9_T0_.exit.i
...
# %bb.19:                               #   in Loop: Header=BB22_15 Depth=2
	bgeu	$s6, $a0, .LBB22_21
# %bb.20:                               #   in Loop: Header=BB22_15 Depth=2
	fst.d	$fa2, $s6, 0
	fst.d	$fa1, $a0, 0
	b	.LBB22_15
	.p2align	4, , 16
.LBB22_21:                              # %_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEET_S9_S9_T0_.exit
                                        #   in Loop: Header=BB22_3 Depth=1
	move	$a0, $s1
	move	$a2, $s0
	move	$a3, $zero
...
.LBB22_25:                              # %.lr.ph.preheader.i.i
	...
	b	.LBB22_28
	.p2align	4, , 16
.LBB22_26:                              #   in Loop: Header=BB22_28 Depth=1
	move	$a3, $zero
.LBB22_27:                              # %_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEEvT_S9_S9_RT0_.exit.i.i
...
# %bb.36:                               #   in Loop: Header=BB22_35 Depth=2
	...
	bnez	$a4, .LBB22_35
	b	.LBB22_26
.LBB22_37:                              # %_ZSt14__partial_sortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEEvT_S9_S9_T0_.exit
...
.Lfunc_end40:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_stepanov_container.cpp
