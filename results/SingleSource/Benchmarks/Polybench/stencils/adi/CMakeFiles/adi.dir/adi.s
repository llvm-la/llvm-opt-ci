...
# %bb.25:                               # %.lver.check48
	...
	add.d	$t3, $s2, $t5
	bgeu	$t3, $t2, .LBB7_28
# %bb.26:                               # %.ph49.lver.orig.preheader
                                        #   in Loop: Header=BB7_24 Depth=2
	ori	$t5, $a0, 208
	.p2align	4, , 16
.LBB7_27:                               # %.ph49.lver.orig
                                        #   Parent Loop BB7_13 Depth=1
...
# %bb.34:                               # %kernel_adi.exit
	...
	xvld	$xr3, $a0, %pc_lo12(.LCPI7_7)
	pcalau12i	$a0, %pc_hi20(.LCPI7_8)
	xvld	$xr4, $a0, %pc_lo12(.LCPI7_8)
	ori	$a0, $s5, 3712
	stx.b	$zero, $s6, $a0
	addi.d	$s0, $s6, 7
	pcalau12i	$a0, %got_pc_hi20(stderr)
