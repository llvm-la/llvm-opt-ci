...
.LBB8_12:                               # %vector.body
	...
	vsrli.w	$vr10, $vr10, 5
	vmsub.w	$vr9, $vr10, $vr3
	vmuh.wu	$vr10, $vr8, $vr1
	vsrli.w	$vr10, $vr10, 5
	vmsub.w	$vr8, $vr10, $vr3
	vilvl.w	$vr9, $vr0, $vr9
	vffint.d.lu	$vr9, $vr9
	vilvl.w	$vr8, $vr0, $vr8
	vffint.d.lu	$vr8, $vr8
...
.LBB8_16:                               # %vector.body48
	...
	vaddi.du	$vr10, $vr8, 3
	vmul.d	$vr9, $vr9, $vr7
	vmul.d	$vr10, $vr10, $vr7
	vshuf4i.w	$vr9, $vr9, 8
	vshuf4i.w	$vr10, $vr10, 8
	vmuh.wu	$vr11, $vr9, $vr3
	vsrli.w	$vr11, $vr11, 4
	vmsub.w	$vr9, $vr11, $vr4
	vmuh.wu	$vr11, $vr10, $vr3
	vsrli.w	$vr11, $vr11, 4
	vmsub.w	$vr10, $vr11, $vr4
	vilvl.w	$vr9, $vr0, $vr9
	vffint.d.lu	$vr9, $vr9
	vilvl.w	$vr10, $vr0, $vr10
	vffint.d.lu	$vr10, $vr10
	vfdiv.d	$vr9, $vr9, $vr5
	vfdiv.d	$vr10, $vr10, $vr5
	add.d	$t3, $t0, $t2
	vstx	$vr9, $t0, $t2
	vst	$vr10, $t3, 16
	addi.d	$t2, $t2, 32
