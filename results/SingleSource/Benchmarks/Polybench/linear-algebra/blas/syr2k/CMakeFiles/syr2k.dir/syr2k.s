...
.LBB7_14:                               # %vector.body
                                        #   Parent Loop BB7_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vmul.d	$vr12, $vr11, $vr10
	vshuf4i.w	$vr12, $vr12, 8
	vaddi.wu	$vr13, $vr12, 1
	vmuh.wu	$vr14, $vr13, $vr1
	vsrli.w	$vr14, $vr14, 7
	vmsub.w	$vr13, $vr14, $vr5
	vilvl.w	$vr13, $vr2, $vr13
	vffint.d.lu	$vr13, $vr13
	vfdiv.d	$vr13, $vr13, $vr6
	add.d	$t6, $t4, $a0
	vstx	$vr13, $t6, $a1
	vaddi.wu	$vr12, $vr12, 2
	vmuh.wu	$vr13, $vr12, $vr7
	vsrli.w	$vr13, $vr13, 6
	vmsub.w	$vr12, $vr13, $vr8
	vilvl.w	$vr12, $vr2, $vr12
	vffint.d.lu	$vr12, $vr12
	vfdiv.d	$vr12, $vr12, $vr9
	add.d	$t6, $t5, $a0
	vstx	$vr12, $t6, $a1
	addi.d	$a0, $a0, 16
	vaddi.du	$vr11, $vr11, 2
	bnez	$a0, .LBB7_14
	b	.LBB7_9
...
.LBB7_21:                               # %vector.body102
	...
	vaddi.wu	$vr9, $vr9, 3
	vaddi.wu	$vr8, $vr8, 3
	vmuh.wu	$vr10, $vr9, $vr1
	vsrli.w	$vr10, $vr10, 7
	vmsub.w	$vr9, $vr10, $vr4
	vmuh.wu	$vr10, $vr8, $vr1
	vsrli.w	$vr10, $vr10, 7
...
.LBB7_27:                               # %vector.body140
	...
	addi.d	$t7, $t7, 32
	bnez	$a5, .LBB7_27
# %bb.28:                               # %middle.block145
                                        #   in Loop: Header=BB7_24 Depth=1
	beq	$t0, $a0, .LBB7_31
.LBB7_29:                               # %scalar.ph135.preheader
                                        #   in Loop: Header=BB7_24 Depth=1
	alsl.d	$a5, $a0, $t6, 3
	.p2align	4, , 16
.LBB7_30:                               # %scalar.ph135
                                        #   Parent Loop BB7_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa3, $a5, 0
...
.LBB7_36:                               # %vector.body127
	...
	addi.d	$s0, $s0, 16
	bnez	$s2, .LBB7_36
# %bb.37:                               # %middle.block134
                                        #   in Loop: Header=BB7_33 Depth=2
	move	$s1, $s6
	beq	$t0, $s6, .LBB7_32
.LBB7_38:                               # %scalar.ph125.preheader
                                        #   in Loop: Header=BB7_33 Depth=2
	mul.d	$s0, $s1, $a1
	slli.d	$s1, $s1, 3
	.p2align	4, , 16
.LBB7_39:                               # %scalar.ph125
                                        #   Parent Loop BB7_24 Depth=1
                                        #     Parent Loop BB7_33 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa3, $fp, $s0
...
.LBB7_45:                               # %vector.body191
	...
	addi.d	$t5, $t5, 32
	bnez	$t1, .LBB7_45
# %bb.46:                               # %middle.block196
                                        #   in Loop: Header=BB7_42 Depth=1
	beq	$t0, $a0, .LBB7_49
.LBB7_47:                               # %scalar.ph186.preheader
                                        #   in Loop: Header=BB7_42 Depth=1
	alsl.d	$t1, $a0, $s0, 3
	.p2align	4, , 16
.LBB7_48:                               # %scalar.ph186
                                        #   Parent Loop BB7_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa3, $t1, 0
	fld.d	$fa4, $a4, %pc_lo12(.LCPI7_3)
...
# %bb.55:                               # %middle.block183
	...
	move	$t7, $s6
	beq	$t0, $s6, .LBB7_50
.LBB7_56:                               # %scalar.ph170.preheader
                                        #   in Loop: Header=BB7_51 Depth=2
	mul.d	$t5, $t7, $a1
	slli.d	$t7, $t7, 3
	.p2align	4, , 16
.LBB7_57:                               # %scalar.ph170
                                        #   Parent Loop BB7_42 Depth=1
                                        #     Parent Loop BB7_51 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa3, $s1, $t5
