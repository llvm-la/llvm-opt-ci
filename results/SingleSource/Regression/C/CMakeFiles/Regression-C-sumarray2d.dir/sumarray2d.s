...
# %bb.7:                                # %pred.store.continue
	...
	add.d	$a7, $a2, $a5
	bnez	$t0, .LBB1_11
.LBB1_8:                                # %pred.store.continue32
                                        #   in Loop: Header=BB1_6 Depth=2
	vpickve2gr.w	$t0, $vr5, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB1_12
.LBB1_9:                                # %pred.store.continue34
                                        #   in Loop: Header=BB1_6 Depth=2
...
.LBB1_12:                               # %pred.store.if33
	...
	andi	$t0, $t0, 1
	beqz	$t0, .LBB1_5
.LBB1_13:                               # %pred.store.if35
                                        #   in Loop: Header=BB1_6 Depth=2
	st.w	$a6, $a7, 12
	b	.LBB1_5
.LBB1_14:                               # %.preheader.us.i.preheader
	move	$a3, $zero
	ori	$a0, $zero, 100
	addi.d	$a1, $sp, 216
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB1_15:                               # %.preheader.us.i
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a1, 160
	vld	$vr2, $a1, 128
	vld	$vr3, $a1, 96
