...
# %bb.16:                               # %._crit_edge.us118
	...
	blt	$a4, $a5, .LBB0_14
	b	.LBB0_20
.LBB0_17:                               # %.lr.ph115.split.preheader
	slli.d	$a6, $a6, 2
	.p2align	4, , 16
.LBB0_18:                               # %.lr.ph115.split
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a1, 0
	add.d	$t0, $a7, $a6
	vldx	$vr0, $a7, $a6
	...
	blt	$a4, $a5, .LBB0_18
	b	.LBB0_20
.LBB0_19:                               # %.critedge.loopexit.split.loop.exit187
	move	$a4, $a6
	addi.w	$a5, $a3, -15
	addi.w	$a6, $a4, 0
	blt	$a6, $a5, .LBB0_12
...
# %bb.25:                               # %._crit_edge.us127
	...
	blt	$a7, $a3, .LBB0_23
	b	.LBB0_34
.LBB0_26:                               # %.lr.ph124.split.preheader
	nor	$a1, $a4, $zero
	add.w	$a1, $a3, $a1
	ori	$a2, $zero, 7
	bltu	$a1, $a2, .LBB0_31
# %bb.27:                               # %.lr.ph124.split.preheader
	sub.d	$a2, $a0, $a5
	ori	$a4, $zero, 32
	bltu	$a2, $a4, .LBB0_31
# %bb.28:                               # %vector.ph
...
.LBB0_31:
	move	$a1, $a6
.LBB0_32:                               # %.lr.ph124.split.preheader204
	alsl.d	$a0, $a1, $a0, 2
	alsl.d	$a2, $a1, $a5, 2
	.p2align	4, , 16
.LBB0_33:                               # %.lr.ph124.split
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a0, $a0, 4
