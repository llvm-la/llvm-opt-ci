...
# %bb.0:                                # %vector.ph
	...
	fst.d	$fs0, $sp, 1232                 # 8-byte Folded Spill
	fst.d	$fs1, $sp, 1224                 # 8-byte Folded Spill
	fst.d	$fs2, $sp, 1216                 # 8-byte Folded Spill
	fst.d	$fs3, $sp, 1208                 # 8-byte Folded Spill
	fst.d	$fs4, $sp, 1200                 # 8-byte Folded Spill
	fst.d	$fs5, $sp, 1192                 # 8-byte Folded Spill
	fst.d	$fs6, $sp, 1184                 # 8-byte Folded Spill
	fst.d	$fs7, $sp, 1176                 # 8-byte Folded Spill
	...
	xvst	$xr6, $sp, 1136                 # 32-byte Folded Spill
	...
	xvfcmp.cult.s	$xr25, $xr4, $xr3
	xvfcmp.clt.s	$xr27, $xr3, $xr4
	xvfcmp.cult.s	$xr28, $xr3, $xr4
	xvfcmp.ceq.s	$xr3, $xr4, $xr0
	xvst	$xr3, $sp, 1104                 # 32-byte Folded Spill
	xvfcmp.cune.s	$xr3, $xr4, $xr0
	xvst	$xr3, $sp, 1072                 # 32-byte Folded Spill
	xvfcmp.clt.s	$xr3, $xr4, $xr0
	xvst	$xr3, $sp, 1040                 # 32-byte Folded Spill
	xvfcmp.cult.s	$xr3, $xr4, $xr0
	xvst	$xr3, $sp, 1008                 # 32-byte Folded Spill
	xvfcmp.clt.s	$xr3, $xr0, $xr4
	xvst	$xr3, $sp, 976                  # 32-byte Folded Spill
	...
	xvbitsel.v	$xr17, $xr1, $xr2, $xr25
	xvbitsel.v	$xr18, $xr2, $xr1, $xr27
	xvbitsel.v	$xr20, $xr1, $xr2, $xr28
	xvld	$xr22, $sp, 1104                # 32-byte Folded Reload
	xvbitsel.v	$xr22, $xr2, $xr1, $xr22
	xvld	$xr24, $sp, 1072                # 32-byte Folded Reload
	xvbitsel.v	$xr24, $xr2, $xr1, $xr24
	xvld	$xr25, $sp, 1040                # 32-byte Folded Reload
	xvbitsel.v	$xr25, $xr2, $xr1, $xr25
	xvld	$xr27, $sp, 1008                # 32-byte Folded Reload
	xvbitsel.v	$xr27, $xr1, $xr2, $xr27
	xvld	$xr28, $sp, 976                 # 32-byte Folded Reload
	...
	xvst	$xr31, $sp, 1008                # 32-byte Folded Spill
	xvld	$xr31, $sp, 912                 # 32-byte Folded Reload
	xvbitsel.v	$xr31, $xr2, $xr1, $xr31
	xvst	$xr31, $sp, 976                 # 32-byte Folded Spill
	xvld	$xr31, $sp, 880                 # 32-byte Folded Reload
	xvbitsel.v	$xr31, $xr2, $xr1, $xr31
	xvst	$xr31, $sp, 944                 # 32-byte Folded Spill
	...
	xvst	$xr11, $sp, 784                 # 32-byte Folded Spill
	xvbitsel.v	$xr8, $xr2, $xr1, $xr8
	xvst	$xr8, $sp, 816                  # 32-byte Folded Spill
	xvbitsel.v	$xr6, $xr1, $xr2, $xr6
	xvst	$xr6, $sp, 848                  # 32-byte Folded Spill
	xvbitsel.v	$xr3, $xr2, $xr1, $xr3
	xvst	$xr3, $sp, 880                  # 32-byte Folded Spill
	xvbitsel.v	$xr2, $xr1, $xr2, $xr0
	ld.w	$a1, $a0, 192
	ld.w	$a2, $a0, 384
	ld.w	$a3, $a0, 576
	ld.w	$a4, $a0, 768
	...
	xvinsgr2vr.w	$xr0, $a6, 6
	xvinsgr2vr.w	$xr0, $a7, 7
	xvld	$xr1, $sp, 1008                 # 32-byte Folded Reload
	xvseq.w	$xr0, $xr1, $xr0
	...
	xvinsgr2vr.w	$xr0, $a6, 6
	xvinsgr2vr.w	$xr0, $a7, 7
	xvld	$xr1, $sp, 944                  # 32-byte Folded Reload
	xvseq.w	$xr0, $xr1, $xr0
	xvst	$xr0, $sp, 944                  # 32-byte Folded Spill
	ld.w	$a1, $a0, 276
	ld.w	$a2, $a0, 468
	...
	ld.w	$a6, $a0, 1332
	ld.w	$a7, $a0, 1524
	xvinsgr2vr.w	$xr20, $a1, 1
	xvinsgr2vr.w	$xr20, $a2, 2
	xvinsgr2vr.w	$xr20, $a3, 3
	xvinsgr2vr.w	$xr20, $a4, 4
	xvinsgr2vr.w	$xr20, $a5, 5
	xvinsgr2vr.w	$xr20, $a6, 6
	xvinsgr2vr.w	$xr20, $a7, 7
	xvld	$xr0, $sp, 848                  # 32-byte Folded Reload
	xvseq.w	$xr5, $xr0, $xr20
	ld.w	$a1, $a0, 376
	ld.w	$a2, $a0, 568
	ld.w	$a3, $a0, 760
	ld.w	$a4, $a0, 952
	...
	xvseq.w	$xr21, $xr2, $xr20
	xvld	$xr0, $sp, 912                  # 32-byte Folded Reload
	xvxori.b	$xr20, $xr0, 255
	xvori.b	$xr2, $xr6, 0
	xvorn.v	$xr23, $xr20, $xr6
	xvst	$xr29, $sp, 912                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr29
	xvst	$xr8, $sp, 880                  # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr8
	xvori.b	$xr0, $xr9, 0
	xvori.b	$xr29, $xr10, 0
	xvori.b	$xr6, $xr31, 0
	xvld	$xr8, $sp, 624                  # 32-byte Folded Reload
	xvld	$xr10, $sp, 688                 # 32-byte Folded Reload
	xvld	$xr9, $sp, 752                  # 32-byte Folded Reload
	xvorn.v	$xr23, $xr23, $xr9
	xvorn.v	$xr23, $xr23, $xr10
	xvorn.v	$xr23, $xr23, $xr8
	xvld	$xr31, $sp, 1136                # 32-byte Folded Reload
	xvorn.v	$xr23, $xr23, $xr31
	xvst	$xr6, $sp, 848                  # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr6
	xvst	$xr26, $sp, 816                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr26
	xvori.b	$xr26, $xr17, 0
	xvst	$xr19, $sp, 784                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr19
	xvori.b	$xr19, $xr5, 0
	xvst	$xr18, $sp, 720                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr18
	xvori.b	$xr18, $xr4, 0
	xvst	$xr29, $sp, 656                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr29
	xvst	$xr0, $sp, 304                  # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr0
	xvst	$xr7, $sp, 272                  # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr7
	xvori.b	$xr7, $xr14, 0
	...
	xvorn.v	$xr23, $xr23, $xr0
	xvld	$xr6, $sp, 496                  # 32-byte Folded Reload
	xvld	$xr0, $sp, 976                  # 32-byte Folded Reload
	xvorn.v	$xr23, $xr23, $xr0
	xvld	$xr17, $sp, 528                 # 32-byte Folded Reload
	...
	xvst	$xr13, $sp, 208                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr13
	xvld	$xr13, $sp, 400                 # 32-byte Folded Reload
	xvst	$xr12, $sp, 80                  # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr12
	xvori.b	$xr12, $xr27, 0
	xvorn.v	$xr23, $xr23, $xr27
	xvori.b	$xr27, $xr22, 0
	xvorn.v	$xr23, $xr23, $xr22
	xvld	$xr22, $sp, 560                 # 32-byte Folded Reload
	xvst	$xr11, $sp, 112                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr11
	xvori.b	$xr11, $xr28, 0
	xvorn.v	$xr23, $xr23, $xr28
	xvld	$xr28, $sp, 336                 # 32-byte Folded Reload
	xvst	$xr15, $sp, 176                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr15
	xvld	$xr29, $sp, 368                 # 32-byte Folded Reload
	xvst	$xr16, $sp, 144                 # 32-byte Folded Spill
	xvorn.v	$xr23, $xr23, $xr16
	xvori.b	$xr5, $xr24, 0
	xvld	$xr4, $sp, 592                  # 32-byte Folded Reload
	xvorn.v	$xr23, $xr23, $xr29
	xvorn.v	$xr23, $xr23, $xr13
	xvorn.v	$xr23, $xr23, $xr7
	xvorn.v	$xr23, $xr23, $xr14
	xvorn.v	$xr23, $xr23, $xr6
	xvorn.v	$xr23, $xr23, $xr17
	xvorn.v	$xr23, $xr23, $xr22
	xvorn.v	$xr23, $xr23, $xr28
	xvorn.v	$xr23, $xr23, $xr4
	xvorn.v	$xr23, $xr23, $xr24
	xvorn.v	$xr23, $xr23, $xr30
	xvorn.v	$xr23, $xr23, $xr3
	xvorn.v	$xr23, $xr23, $xr25
	xvorn.v	$xr23, $xr23, $xr1
	xvorn.v	$xr23, $xr23, $xr18
	xvorn.v	$xr23, $xr23, $xr19
	xvorn.v	$xr23, $xr23, $xr26
	xvorn.v	$xr24, $xr23, $xr21
	xvslli.w	$xr21, $xr24, 31
	xvmskltz.w	$xr21, $xr21
	xvpickve2gr.wu	$a0, $xr21, 0
	xvpickve2gr.wu	$a1, $xr21, 4
	bstrins.d	$a0, $a1, 7, 4
	bnez	$a0, .LBB6_2
# %bb.1:                                # %middle.block
	move	$a0, $zero
...
.LBB6_2:                                # %vector.early.exit.check
	xvpickev.h	$xr21, $xr24, $xr24
	xvpermi.d	$xr21, $xr21, 216
	xvpickev.h	$xr20, $xr20, $xr20
	pcalau12i	$a0, %pc_hi20(.LCPI6_0)
	vld	$vr23, $a0, %pc_lo12(.LCPI6_0)
	xvpermi.d	$xr20, $xr20, 216
	vslli.h	$vr21, $vr21, 15
	vsrai.h	$vr21, $vr21, 15
	vand.v	$vr21, $vr21, $vr23
	vbsrl.v	$vr23, $vr21, 8
	vmax.hu	$vr21, $vr23, $vr21
	vbsrl.v	$vr23, $vr21, 4
	vmax.hu	$vr21, $vr23, $vr21
	vbsrl.v	$vr23, $vr21, 2
	vmax.hu	$vr21, $vr23, $vr21
	vpickve2gr.h	$a0, $vr21, 0
	bstrpick.d	$a0, $a0, 15, 0
	ori	$a1, $zero, 8
	sub.d	$a0, $a1, $a0
	vreplve.h	$vr20, $vr20, $a0
	movfr2gr.s	$a1, $ft12
	srai.w	$a1, $a1, 16
	andi	$a1, $a1, 1
	bnez	$a1, .LBB6_49
# %bb.3:                                # %vector.early.exit.check.0
	xvxori.b	$xr20, $xr2, 255
	xvpickev.h	$xr20, $xr20, $xr20
	xvpermi.d	$xr20, $xr20, 216
	vreplve.h	$vr20, $vr20, $a0
	movfr2gr.s	$a1, $ft12
