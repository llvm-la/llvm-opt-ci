...
# %bb.3:                                # %vector.ph11
	...
	st.w	$a3, $a1, 248
	st.w	$a4, $a1, 252
	xvxor.v	$xr13, $xr11, $xr8
	xvxor.v	$xr14, $xr12, $xr8
	xvld	$xr15, $a1, 64
	xvld	$xr16, $a1, 96
	xvst	$xr13, $a1, 256
	xvst	$xr14, $a1, 288
	xvxor.v	$xr13, $xr15, $xr8
	xvxor.v	$xr14, $xr16, $xr8
	xvld	$xr17, $a1, 128
	xvld	$xr18, $a1, 160
	xvst	$xr13, $a1, 320
	xvst	$xr14, $a1, 352
	xvxor.v	$xr13, $xr17, $xr8
	xvxor.v	$xr14, $xr18, $xr8
	xvld	$xr19, $a1, 192
	xvld	$xr20, $a1, 224
	xvst	$xr13, $a1, 384
	xvst	$xr14, $a1, 416
	xvxor.v	$xr13, $xr19, $xr8
	xvxor.v	$xr14, $xr20, $xr8
	xvld	$xr21, $a1, 0
	xvst	$xr13, $a1, 448
	xvst	$xr14, $a1, 480
	xvld	$xr13, $a1, 32
	xvxor.v	$xr14, $xr21, $xr9
	xvst	$xr14, $a1, 512
	xvld	$xr14, $a1, 64
	xvld	$xr21, $a1, 96
	xvxor.v	$xr13, $xr13, $xr9
	xvst	$xr13, $a1, 544
	xvxor.v	$xr13, $xr14, $xr9
	xvxor.v	$xr14, $xr21, $xr9
	xvld	$xr21, $a1, 128
	xvst	$xr13, $a1, 576
	xvst	$xr14, $a1, 608
	...
	xvst	$xr13, $a1, 704
	xvst	$xr14, $a1, 736
	xvxor.v	$xr11, $xr11, $xr10
	xvxor.v	$xr12, $xr12, $xr10
	xvst	$xr11, $a1, 768
	xvst	$xr12, $a1, 800
	xvxor.v	$xr11, $xr15, $xr10
	xvxor.v	$xr12, $xr16, $xr10
	xvst	$xr11, $a1, 832
	xvst	$xr12, $a1, 864
	xvxor.v	$xr11, $xr17, $xr10
	xvxor.v	$xr12, $xr18, $xr10
	xvst	$xr11, $a1, 896
	xvst	$xr12, $a1, 928
	xvxor.v	$xr11, $xr19, $xr10
	xvxor.v	$xr12, $xr20, $xr10
	xvst	$xr11, $a1, 960
	xvst	$xr12, $a1, 992
	b	.LBB0_1
.LBB0_4:
