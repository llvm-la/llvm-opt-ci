...
.LBB0_4:                                # %vector.body
	...
	xvpermi.q	$xr8, $xr9, 2
	ori	$a3, $t3, 393
	xvreplgr2vr.w	$xr9, $a3
	xvxor.v	$xr8, $xr8, $xr9
	xvstelm.w	$xr8, $a6, 4, 0
	xvstelm.w	$xr8, $a6, 12, 1
	xvstelm.w	$xr8, $a6, 20, 2
	xvstelm.w	$xr8, $a6, 28, 3
	xvstelm.w	$xr8, $a6, 36, 4
	xvstelm.w	$xr8, $a6, 44, 5
	xvstelm.w	$xr8, $a6, 52, 6
	addi.d	$ra, $ra, 64
	xvstelm.w	$xr8, $a6, 60, 7
	bne	$ra, $s6, .LBB0_4
	b	.LBB0_1
.LBB0_5:
