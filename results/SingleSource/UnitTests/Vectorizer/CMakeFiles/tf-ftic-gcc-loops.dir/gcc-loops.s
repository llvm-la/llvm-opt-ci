...
# %bb.1:                                # %vector.ph
	...
	pcalau12i	$a3, %pc_hi20(b+16)
	addi.d	$a3, $a3, %pc_lo12(b+16)
...
# %bb.4:                                # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB4_13
.LBB4_5:                                # %pred.store.continue27
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpickve2gr.d	$a4, $xr4, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB4_14
.LBB4_6:                                # %pred.store.continue29
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpickve2gr.d	$a4, $xr4, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB4_8
.LBB4_7:                                # %pred.store.if30
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$a4, $a2, -4
	addi.d	$a4, $a4, 5
	st.w	$a4, $a1, -4
.LBB4_8:                                # %pred.store.continue31
                                        #   in Loop: Header=BB4_3 Depth=1
	xvor.v	$xr3, $xr3, $xr0
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB4_15
# %bb.9:                                # %pred.store.continue33
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpickve2gr.d	$a4, $xr3, 1
	andi	$a4, $a4, 1
	bnez	$a4, .LBB4_16
.LBB4_10:                               # %pred.store.continue35
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpickve2gr.d	$a4, $xr3, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB4_17
.LBB4_11:                               # %pred.store.continue37
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpickve2gr.d	$a4, $xr3, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB4_2
...
# %bb.1:                                # %vector.ph
	...
	slli.d	$a1, $a1, 3
	addi.d	$a3, $a0, -1
	pcalau12i	$a0, %pc_hi20(c+20)
	addi.d	$a0, $a0, %pc_lo12(c+20)
	pcalau12i	$a2, %pc_hi20(a+16)
	addi.d	$a2, $a2, %pc_lo12(a+16)
	xvreplgr2vr.d	$xr2, $a3
...
.LBB5_8:                                # %pred.store.continue12
                                        #   in Loop: Header=BB5_3 Depth=1
	xvsle.du	$xr4, $xr0, $xr2
	xvpickve2gr.d	$a4, $xr4, 0
	andi	$a4, $a4, 1
	xvaddi.du	$xr3, $xr0, 1
	bnez	$a4, .LBB5_15
# %bb.9:                                # %pred.store.continue14
                                        #   in Loop: Header=BB5_3 Depth=1
	xvpickve2gr.d	$a4, $xr4, 1
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_16
...
# %bb.1:                                # %.lr.ph.preheader
	...
	xvld	$xr2, $a4, %pc_lo12(.LCPI17_0)
	pcalau12i	$a4, %pc_hi20(.LCPI17_1)
	xvld	$xr3, $a4, %pc_lo12(.LCPI17_1)
	alsl.d	$a1, $a1, $a0, 2
	addi.d	$a1, $a1, -16
	xvrepli.b	$xr4, 0
	b	.LBB17_3
	.p2align	4, , 16
.LBB17_2:                               # %pred.load.continue25
...
# %bb.4:                                # %pred.load.continue
	...
	andi	$a6, $a5, 1
	bnez	$a6, .LBB17_13
.LBB17_5:                               # %pred.load.continue13
                                        #   in Loop: Header=BB17_3 Depth=1
	xvpickve2gr.d	$a6, $xr6, 2
	andi	$a7, $a6, 1
	bnez	$a7, .LBB17_14
.LBB17_6:                               # %pred.load.continue15
                                        #   in Loop: Header=BB17_3 Depth=1
	xvpickve2gr.d	$a7, $xr6, 3
	andi	$t0, $a7, 1
	beqz	$t0, .LBB17_8
.LBB17_7:                               # %pred.load.if16
                                        #   in Loop: Header=BB17_3 Depth=1
	ld.w	$t0, $a1, 0
...
.LBB17_8:                               # %pred.load.continue17
                                        #   in Loop: Header=BB17_3 Depth=1
	xvor.v	$xr5, $xr5, $xr2
	xvsle.du	$xr5, $xr5, $xr1
	xvpickve2gr.d	$t0, $xr5, 0
	andi	$t1, $t0, 1
	bnez	$t1, .LBB17_15
# %bb.9:                                # %pred.load.continue19
                                        #   in Loop: Header=BB17_3 Depth=1
	xvpickve2gr.d	$t1, $xr5, 1
	andi	$t2, $t1, 1
	bnez	$t2, .LBB17_16
...
# %bb.151:                              # %vector.ph
	...
	xvld	$xr1, $a3, %pc_lo12(.LCPI24_1)
	pcalau12i	$a3, %pc_hi20(.LCPI24_2)
	xvld	$xr2, $a3, %pc_lo12(.LCPI24_2)
	xvreplgr2vr.d	$xr3, $a2
	addi.d	$a2, $fp, 16
	xvrepli.b	$xr4, 0
	b	.LBB24_153
	.p2align	4, , 16
.LBB24_152:                             # %pred.load.continue640
...
# %bb.154:                              # %pred.load.if
	...
	andi	$a5, $a4, 1
	bnez	$a5, .LBB24_158
.LBB24_155:                             # %pred.load.continue628
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$a5, $xr6, 2
	andi	$a6, $a5, 1
	beqz	$a6, .LBB24_159
.LBB24_156:                             # %pred.load.if629
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a6, $a2, -8
	...
	b	.LBB24_161
	.p2align	4, , 16
.LBB24_157:                             # %pred.load.continue
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$a4, $xr6, 1
	andi	$a5, $a4, 1
	beqz	$a5, .LBB24_155
.LBB24_158:                             # %pred.load.if627
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a5, $a2, -12
	...
	andi	$a6, $a5, 1
	bnez	$a6, .LBB24_156
.LBB24_159:                             # %pred.load.continue630
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$a6, $xr6, 3
	andi	$a7, $a6, 1
	beqz	$a7, .LBB24_161
.LBB24_160:                             # %pred.load.if631
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a7, $a2, -4
	xvinsgr2vr.w	$xr4, $a7, 3
.LBB24_161:                             # %pred.load.continue632
                                        #   in Loop: Header=BB24_153 Depth=1
	xvor.v	$xr5, $xr5, $xr1
	xvsle.du	$xr5, $xr5, $xr3
	xvpickve2gr.d	$a7, $xr5, 0
	andi	$t0, $a7, 1
	beqz	$t0, .LBB24_165
# %bb.162:                              # %pred.load.if633
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t0, $a2, 0
	...
	andi	$t1, $t0, 1
	bnez	$t1, .LBB24_166
.LBB24_163:                             # %pred.load.continue636
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$t1, $xr5, 2
	andi	$t2, $t1, 1
	beqz	$t2, .LBB24_167
.LBB24_164:                             # %pred.load.if637
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t2, $a2, 8
	...
	b	.LBB24_168
	.p2align	4, , 16
.LBB24_165:                             # %pred.load.continue634
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$t0, $xr5, 1
	andi	$t1, $t0, 1
	beqz	$t1, .LBB24_163
.LBB24_166:                             # %pred.load.if635
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t1, $a2, 4
	...
	andi	$t2, $t1, 1
	bnez	$t2, .LBB24_164
.LBB24_167:                             # %pred.load.continue638
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$t2, $xr5, 3
	andi	$t3, $t2, 1
	beqz	$t3, .LBB24_152
.LBB24_168:                             # %pred.load.if639
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t3, $a2, 12
