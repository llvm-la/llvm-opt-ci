...
.LBB15_5:                               # %vector.ph
	...
	vld	$vr1, $a2, %pc_lo12(.LCPI15_0)
	pcalau12i	$a2, %pc_hi20(.LCPI15_1)
	vld	$vr2, $a2, %pc_lo12(.LCPI15_1)
	addi.d	$a2, $a3, 8
	vrepli.w	$vr4, 11
	vrepli.w	$vr5, 22
	vrepli.w	$vr6, 33
