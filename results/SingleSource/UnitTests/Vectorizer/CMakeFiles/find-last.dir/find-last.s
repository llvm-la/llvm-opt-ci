...
# %bb.51:                               #   in Loop: Header=BB3_46 Depth=1
	move	$a0, $zero
.LBB3_52:                               # %vec.epilog.ph489
                                        #   in Loop: Header=BB3_46 Depth=1
	move	$a1, $s7
	bstrins.d	$a1, $zero, 2, 0
	bstrpick.d	$a4, $s7, 62, 3
	sub.d	$a1, $a0, $a1
	alsl.d	$a2, $a0, $s4, 1
	alsl.d	$a3, $a0, $s3, 1
	slli.d	$a0, $a4, 3
	...
	vldi	$vr1, -2688
	.p2align	4, , 16
.LBB3_53:                               # %vec.epilog.vector.body492
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB3_53
# %bb.54:                               # %vec.epilog.middle.block495
                                        #   in Loop: Header=BB3_46 Depth=1
	bne	$s7, $a0, .LBB3_57
	b	.LBB3_59
	.p2align	4, , 16
.LBB3_55:                               # %vector.ph482
                                        #   in Loop: Header=BB3_46 Depth=1
	...
	xvst	$xr0, $s4, 0
	beq	$s7, $a0, .LBB3_59
# %bb.56:                               # %vec.epilog.iter.check488
                                        #   in Loop: Header=BB3_46 Depth=1
	andi	$a1, $s7, 8
	bnez	$a1, .LBB3_52
	.p2align	4, , 16
...
.Ltmp683:                               # EH_LABEL
	move	$s1, $a0
	b	.LBB3_134
.LBB3_131:                              # %.loopexit.split-lp287
.Ltmp749:                               # EH_LABEL
.LBB3_132:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit215
	move	$s1, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_133:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit218
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_134:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit221
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.LBB43_10:                              # %vec.epilog.ph
	...
	or	$a5, $a3, $a5
	bstrpick.d	$a3, $a0, 14, 3
	pcalau12i	$a6, %pc_hi20(.LCPI43_1)
	vld	$vr1, $a6, %pc_lo12(.LCPI43_1)
	slli.d	$a3, $a3, 3
	vreplgr2vr.h	$vr0, $a5
	vreplgr2vr.h	$vr2, $a7
	vor.v	$vr1, $vr2, $vr1
...
.LBB79_10:                              # %vec.epilog.ph
	...
	pcalau12i	$t2, %pc_hi20(.LCPI79_1)
	vld	$vr1, $t2, %pc_lo12(.LCPI79_1)
	vreplgr2vr.h	$vr2, $a3
	move	$a3, $a4
	bstrins.d	$a3, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
...
.LBB91_8:                               # %vec.epilog.ph
	...
	move	$t0, $a3
	bstrins.d	$t0, $zero, 2, 0
	pcalau12i	$t2, %pc_hi20(.LCPI91_1)
	vld	$vr1, $t2, %pc_lo12(.LCPI91_1)
	vreplgr2vr.h	$vr2, $a4
	move	$a4, $a3
	bstrins.d	$a4, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
...
.LBB103_9:                              # %vec.epilog.ph
	...
	move	$t0, $a3
	bstrins.d	$t0, $zero, 2, 0
	pcalau12i	$t2, %pc_hi20(.LCPI103_1)
	vld	$vr1, $t2, %pc_lo12(.LCPI103_1)
	vreplgr2vr.h	$vr2, $a4
	move	$a4, $a3
	bstrins.d	$a4, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
...
.LBB115_9:                              # %vec.epilog.ph
	...
	move	$t0, $a3
	bstrins.d	$t0, $zero, 2, 0
	pcalau12i	$t2, %pc_hi20(.LCPI115_1)
	vld	$vr1, $t2, %pc_lo12(.LCPI115_1)
	vreplgr2vr.h	$vr2, $a4
	move	$a4, $a3
	bstrins.d	$a4, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
