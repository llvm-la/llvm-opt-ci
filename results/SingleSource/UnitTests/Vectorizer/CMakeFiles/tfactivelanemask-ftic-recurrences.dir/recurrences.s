...
# %bb.4:                                # %pred.load.continue
	...
	andi	$t0, $t0, 1
	bnez	$t0, .LBB4_17
.LBB4_5:                                # %pred.load.continue10
                                        #   in Loop: Header=BB4_3 Depth=1
	vpickve2gr.w	$t1, $vr9, 2
	andi	$t1, $t1, 1
	bnez	$t1, .LBB4_18
.LBB4_6:                                # %pred.load.continue12
                                        #   in Loop: Header=BB4_3 Depth=1
	vpickve2gr.w	$t2, $vr9, 3
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_19
.LBB4_7:                                # %pred.load.continue14
                                        #   in Loop: Header=BB4_3 Depth=1
	add.d	$t3, $a0, $a3
                                        # implicit-def: $xr9
	bnez	$a7, .LBB4_20
.LBB4_8:                                # %pred.load.continue16
                                        #   in Loop: Header=BB4_3 Depth=1
	bnez	$t0, .LBB4_21
.LBB4_9:                                # %pred.load.continue18
                                        #   in Loop: Header=BB4_3 Depth=1
	bnez	$t1, .LBB4_22
.LBB4_10:                               # %pred.load.continue20
                                        #   in Loop: Header=BB4_3 Depth=1
	beqz	$t2, .LBB4_12
.LBB4_11:                               # %pred.load.if21
                                        #   in Loop: Header=BB4_3 Depth=1
	ldptr.d	$t4, $t3, 3200
	xvinsgr2vr.d	$xr9, $t4, 3
.LBB4_12:                               # %pred.load.continue22
                                        #   in Loop: Header=BB4_3 Depth=1
...
# %bb.13:                               # %pred.store.continue
                                        #   in Loop: Header=BB4_3 Depth=1
	bnez	$t0, .LBB4_24
.LBB4_14:                               # %pred.store.continue24
                                        #   in Loop: Header=BB4_3 Depth=1
	bnez	$t1, .LBB4_25
.LBB4_15:                               # %pred.store.continue26
                                        #   in Loop: Header=BB4_3 Depth=1
	beqz	$t2, .LBB4_2
	b	.LBB4_26
	.p2align	4, , 16
.LBB4_16:                               # %pred.load.if
                                        #   in Loop: Header=BB4_3 Depth=1
...
.LBB11_18:                              # %pred.store.continue26
	...
	bnez	$a7, .LBB11_34
.LBB11_19:                              # %pred.store.continue28
                                        #   in Loop: Header=BB11_7 Depth=1
	xvpickve2gr.w	$a7, $xr3, 3
	bnez	$t0, .LBB11_35
.LBB11_20:                              # %pred.store.continue30
                                        #   in Loop: Header=BB11_7 Depth=1
	xvpickve2gr.w	$t0, $xr3, 4
	bnez	$t1, .LBB11_36
.LBB11_21:                              # %pred.store.continue32
                                        #   in Loop: Header=BB11_7 Depth=1
	xvpickve2gr.w	$t1, $xr3, 5
	bnez	$t2, .LBB11_37
.LBB11_22:                              # %pred.store.continue34
                                        #   in Loop: Header=BB11_7 Depth=1
	xvpickve2gr.w	$t2, $xr3, 6
	beqz	$t3, .LBB11_6
	b	.LBB11_38
	.p2align	4, , 16
.LBB11_23:                              # %pred.load.if
                                        #   in Loop: Header=BB11_7 Depth=1
	ld.w	$a5, $a3, -16
...
.LBB15_7:                               # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	xvreplgr2vr.d	$xr3, $a0
	xvsadd.du	$xr7, $xr3, $xr0
	xvslt.du	$xr7, $xr7, $xr2
	xvsadd.du	$xr3, $xr3, $xr1
	xvslt.du	$xr3, $xr3, $xr2
	xvpickev.w	$xr3, $xr3, $xr7
	xvpermi.d	$xr3, $xr3, 216
	xvpickev.h	$xr3, $xr3, $xr3
	xvpermi.d	$xr7, $xr3, 216
...
# %bb.8:                                # %pred.load.continue
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB15_25
.LBB15_9:                               # %pred.load.continue11
                                        #   in Loop: Header=BB15_7 Depth=1
	vpickve2gr.h	$a6, $vr7, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB15_26
.LBB15_10:                              # %pred.load.continue13
                                        #   in Loop: Header=BB15_7 Depth=1
	vpickve2gr.h	$a7, $vr7, 3
	andi	$a7, $a7, 1
	bnez	$a7, .LBB15_27
.LBB15_11:                              # %pred.load.continue15
                                        #   in Loop: Header=BB15_7 Depth=1
	vpickve2gr.h	$t0, $vr7, 4
	andi	$t0, $t0, 1
	bnez	$t0, .LBB15_28
.LBB15_12:                              # %pred.load.continue17
                                        #   in Loop: Header=BB15_7 Depth=1
	vpickve2gr.h	$t1, $vr7, 5
	andi	$t1, $t1, 1
	bnez	$t1, .LBB15_29
.LBB15_13:                              # %pred.load.continue19
                                        #   in Loop: Header=BB15_7 Depth=1
	vpickve2gr.h	$t2, $vr7, 6
	andi	$t2, $t2, 1
	bnez	$t2, .LBB15_30
.LBB15_14:                              # %pred.load.continue21
                                        #   in Loop: Header=BB15_7 Depth=1
	vpickve2gr.h	$t3, $vr7, 7
	andi	$t3, $t3, 1
	beqz	$t3, .LBB15_16
.LBB15_15:                              # %pred.load.if22
                                        #   in Loop: Header=BB15_7 Depth=1
	ld.w	$t4, $a3, 12
	xvinsgr2vr.w	$xr3, $t4, 7
.LBB15_16:                              # %pred.load.continue23
                                        #   in Loop: Header=BB15_7 Depth=1
...
# %bb.17:                               # %pred.store.continue
                                        #   in Loop: Header=BB15_7 Depth=1
	bnez	$a5, .LBB15_32
.LBB15_18:                              # %pred.store.continue25
                                        #   in Loop: Header=BB15_7 Depth=1
	bnez	$a6, .LBB15_33
.LBB15_19:                              # %pred.store.continue27
                                        #   in Loop: Header=BB15_7 Depth=1
	bnez	$a7, .LBB15_34
.LBB15_20:                              # %pred.store.continue29
                                        #   in Loop: Header=BB15_7 Depth=1
	bnez	$t0, .LBB15_35
.LBB15_21:                              # %pred.store.continue31
                                        #   in Loop: Header=BB15_7 Depth=1
	bnez	$t1, .LBB15_36
.LBB15_22:                              # %pred.store.continue33
                                        #   in Loop: Header=BB15_7 Depth=1
	bnez	$t2, .LBB15_37
.LBB15_23:                              # %pred.store.continue35
                                        #   in Loop: Header=BB15_7 Depth=1
	beqz	$t3, .LBB15_6
	b	.LBB15_38
	.p2align	4, , 16
.LBB15_24:                              # %pred.load.if
                                        #   in Loop: Header=BB15_7 Depth=1
	ld.w	$a5, $a3, -16
	vinsgr2vr.w	$vr3, $a5, 0
	vpickve2gr.h	$a5, $vr7, 1
