...
.Lfunc_end0:
	...
	.p2align	4, 0x0                          # -- Begin function _Z9example2aii
.LCPI1_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
.LCPI1_1:
...
# %bb.1:                                # %.lr.ph.preheader
	addi.d	$a4, $a0, 3
	pcalau12i	$a2, %pc_hi20(b+8)
	addi.d	$a2, $a2, %pc_lo12(b+8)
	move	$a3, $zero
...
.Lfunc_end1:
	.size	_Z9example2aii, .Lfunc_end1-_Z9example2aii
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function _Z9example2bii
.LCPI2_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
.LCPI2_1:
...
# %bb.1:                                # %.lr.ph.preheader
	...
	addi.d	$a4, $a5, 3
	pcalau12i	$a0, %pc_hi20(a+8)
	addi.d	$a0, $a0, %pc_lo12(a+8)
	pcalau12i	$a1, %pc_hi20(b+8)
	addi.d	$a1, $a1, %pc_lo12(b+8)
	pcalau12i	$a2, %pc_hi20(c+8)
	addi.d	$a2, $a2, %pc_lo12(c+8)
	move	$a3, $zero
...
.Lfunc_end3:
	.size	_Z8example3iPiS_, .Lfunc_end3-_Z8example3iPiS_
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function _Z9example4aiPiS_
.LCPI4_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
.LCPI4_1:
...
.LBB4_5:                                # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB4_8
# %bb.6:                                # %pred.store.continue16
                                        #   in Loop: Header=BB4_3 Depth=1
	vpickve2gr.w	$a4, $vr3, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB4_9
.LBB4_7:                                # %pred.store.continue18
                                        #   in Loop: Header=BB4_3 Depth=1
...
.Lfunc_end4:
	.size	_Z9example4aiPiS_, .Lfunc_end4-_Z9example4aiPiS_
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function _Z9example4biPiS_
.LCPI5_0:
	.dword	2                               # 0x2
	.dword	3                               # 0x3
.LCPI5_1:
...
# %bb.1:                                # %.lr.ph.preheader
	...
	addi.d	$a3, $a0, 3
	pcalau12i	$a1, %pc_hi20(c+24)
	addi.d	$a1, $a1, %pc_lo12(c+24)
	pcalau12i	$a2, %pc_hi20(a+8)
	addi.d	$a2, $a2, %pc_lo12(a+8)
...
.Lfunc_end5:
	.size	_Z9example4biPiS_, .Lfunc_end5-_Z9example4biPiS_
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function _Z9example4ciPiS_
.LCPI6_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
.LCPI6_1:
...
# %bb.1:                                # %.lr.ph.preheader
	addi.d	$a4, $a0, 3
	pcalau12i	$a1, %pc_hi20(a+8)
	addi.d	$a1, $a1, %pc_lo12(a+8)
	pcalau12i	$a2, %pc_hi20(b+8)
	addi.d	$a2, $a2, %pc_lo12(b+8)
	move	$a3, $zero
	bstrpick.d	$a4, $a4, 31, 2
	pcalau12i	$a5, %pc_hi20(.LCPI6_0)
	vld	$vr0, $a5, %pc_lo12(.LCPI6_0)
...
.Lfunc_end6:
	.size	_Z9example4ciPiS_, .Lfunc_end6-_Z9example4ciPiS_
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function _Z8example5iP1A
.LCPI7_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
.LCPI7_1:
...
# %bb.1:                                # %.lr.ph.preheader
	...
	vld	$vr1, $a5, %pc_lo12(.LCPI17_1)
	addi.d	$a4, $a4, -8
	vrepli.b	$vr5, 0
	vreplgr2vr.d	$vr2, $a1
	b	.LBB17_3
	.p2align	4, , 16
.LBB17_2:                               # %pred.load.continue15
...
.LBB17_9:                               # %pred.load.if12
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB17_2
.LBB17_10:                              # %pred.load.if14
                                        #   in Loop: Header=BB17_3 Depth=1
	ld.w	$a1, $a4, -8
	vinsgr2vr.w	$vr5, $a1, 3
	b	.LBB17_2
.LBB17_11:                              # %._crit_edge.loopexit
	vslli.w	$vr0, $vr4, 31
	vsrai.w	$vr0, $vr0, 31
...
.LBB20_1:                               # %vector.body
	...
	add.d	$a7, $a5, $a0
	vldx	$vr4, $a7, $a2
	vfcmp.clt.s	$vr1, $vr1, $vr2
	vfcmp.clt.s	$vr2, $vr3, $vr4
	vand.v	$vr1, $vr1, $vr2
	vand.v	$vr1, $vr1, $vr0
	add.d	$a7, $a6, $a0
	addi.d	$a0, $a0, 16
...
# %bb.151:                              # %.lr.ph.i391.preheader
	...
	addi.d	$a3, $a1, 1
	addi.d	$a1, $a1, 4
	bstrpick.d	$a1, $a1, 62, 2
	slli.d	$a1, $a1, 2
	pcalau12i	$a2, %pc_hi20(.LCPI24_1)
	vld	$vr0, $a2, %pc_lo12(.LCPI24_1)
	pcalau12i	$a2, %pc_hi20(.LCPI24_2)
	vld	$vr1, $a2, %pc_lo12(.LCPI24_2)
	addi.d	$a2, $fp, 8
	vrepli.b	$vr5, 0
	vreplgr2vr.d	$vr2, $a3
	b	.LBB24_153
	.p2align	4, , 16
.LBB24_152:                             # %pred.load.continue626
...
# %bb.156:                              # %pred.load.if621
	...
	andi	$a3, $a3, 1
	bnez	$a3, .LBB24_159
.LBB24_157:                             # %pred.load.continue624
                                        #   in Loop: Header=BB24_153 Depth=1
	...
	b	.LBB24_160
	.p2align	4, , 16
.LBB24_158:                             # %pred.load.continue622
                                        #   in Loop: Header=BB24_153 Depth=1
	vpickve2gr.w	$a3, $vr4, 2
	andi	$a3, $a3, 1
	beqz	$a3, .LBB24_157
.LBB24_159:                             # %pred.load.if623
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a3, $a2, 0
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB24_152
.LBB24_160:                             # %pred.load.if625
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a3, $a2, 4
	vinsgr2vr.w	$vr5, $a3, 3
	b	.LBB24_152
.LBB24_161:                             # %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEEiET0_T_S8_S7_.exit.loopexit
	vslli.w	$vr0, $vr4, 31
	vsrai.w	$vr0, $vr0, 31
	vbitsel.v	$vr0, $vr3, $vr5, $vr0
	vhaddw.d.w	$vr0, $vr0, $vr0
...
.LBB24_162:                             # %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEEiET0_T_S8_S7_.exit
.Ltmp32:                                # EH_LABEL
	addi.w	$a1, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
# %bb.164:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit394.preheader
	beq	$s0, $fp, .LBB24_169
# %bb.165:                              # %.lr.ph.preheader
	sub.d	$a0, $s0, $fp
	srai.d	$s2, $a0, 2
	ori	$s3, $zero, 1
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
...
.Ltmp36:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
# %bb.167:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit398
...
.Ltmp38:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp39:                                # EH_LABEL
# %bb.168:                              # %_ZNSolsEj.exit
                                        #   in Loop: Header=BB24_166 Depth=1
	bstrpick.d	$s4, $s3, 31, 0
	addi.w	$s3, $s3, 1
	bltu	$s4, $s2, .LBB24_166
.LBB24_169:                             # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit394._crit_edge
.Ltmp41:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
	...
	jirl	$ra, $ra, 0
.Ltmp42:                                # EH_LABEL
# %bb.170:                              # %_ZNSt6vectorIjSaIjEED2Ev.exit
	sub.d	$a1, $s5, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
