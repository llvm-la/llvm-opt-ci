...
# %bb.21:
	bne	$s3, $a0, .LBB1_91
# %bb.22:                               # %vector.body402.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	xvreplgr2vr.w	$xr0, $s7
...
.LBB1_23:                               # %vector.body402
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_23
# %bb.24:                               # %vec.epilog.vector.body411
	ori	$a0, $zero, 3968
	xvstx	$xr1, $fp, $a0
	xvstx	$xr0, $s0, $a0
	ld.d	$a0, $s2, 16
...
# %bb.28:
	...
	bne	$s3, $a0, .LBB1_96
# %bb.29:                               # %vector.body418.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_30:                               # %vector.body418
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_30
# %bb.31:                               # %vec.epilog.vector.body427
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s7, $fp, 3992
...
# %bb.35:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB1_101
# %bb.36:                               # %vector.body434.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_37:                               # %vector.body434
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_37
# %bb.38:                               # %vec.epilog.vector.body443
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	st.w	$s7, $fp, 0
...
# %bb.42:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB1_106
# %bb.43:                               # %vector.body450.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_44:                               # %vector.body450
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_44
# %bb.45:                               # %vec.epilog.vector.body459
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s7, $fp, 3996
...
# %bb.49:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB1_111
# %bb.50:                               # %vector.body466.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_51:                               # %vector.body466
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_51
# %bb.52:                               # %vec.epilog.vector.body475
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s7, $fp, 3996
...
.LBB1_63:                               # %vector.body481
	...
	addi.d	$a2, $a2, 32
	bnez	$a1, .LBB1_63
# %bb.64:                               # %middle.block484
                                        #   in Loop: Header=BB1_58 Depth=1
	beq	$s8, $a0, .LBB1_67
.LBB1_65:                               # %.preheader.preheader493
                                        #   in Loop: Header=BB1_58 Depth=1
	alsl.d	$a1, $a0, $s3, 2
	alsl.d	$a2, $a0, $s4, 2
	.p2align	4, , 16
...
.Ltmp507:                               # EH_LABEL
	...
	jirl	$ra, $a4, 0
.Ltmp508:                               # EH_LABEL
# %bb.69:                               #   in Loop: Header=BB1_58 Depth=1
	move	$s5, $a0
	ld.d	$a0, $s1, 16
	st.d	$s3, $sp, 64
	st.d	$s4, $sp, 56
	st.w	$s8, $sp, 52
	beqz	$a0, .LBB1_76
# %bb.70:                               #   in Loop: Header=BB1_58 Depth=1
	ld.d	$a4, $s1, 24
.Ltmp510:                               # EH_LABEL
	addi.d	$a1, $sp, 64
	addi.d	$a2, $sp, 56
...
# %bb.71:                               #   in Loop: Header=BB1_58 Depth=1
	bne	$s5, $a0, .LBB1_78
# %bb.72:                               # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit212
                                        #   in Loop: Header=BB1_58 Depth=1
	move	$a0, $s4
	...
	ori	$a0, $zero, 17
	bne	$s8, $a0, .LBB1_58
# %bb.73:                               # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit195
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Ltmp513:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp514:                               # EH_LABEL
# %bb.79:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit205
...
.Ltmp509:                               # EH_LABEL
	b	.LBB1_140
.LBB1_135:                              # %.loopexit286
.Ltmp512:                               # EH_LABEL
	b	.LBB1_140
.LBB1_136:                              # %.loopexit.split-lp
.Ltmp524:                               # EH_LABEL
	b	.LBB1_140
.LBB1_137:                              # %.loopexit297
.Ltmp458:                               # EH_LABEL
	move	$s1, $a0
	b	.LBB1_142
.LBB1_138:                              # %.loopexit.split-lp298
.Ltmp455:                               # EH_LABEL
	move	$s1, $a0
	b	.LBB1_142
.LBB1_139:                              # %.loopexit.split-lp287
.Ltmp521:                               # EH_LABEL
.LBB1_140:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit215
	move	$s1, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB1_141:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit218
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB1_142:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit221
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
# %bb.15:
	bne	$s3, $a0, .LBB2_85
# %bb.16:                               # %vector.body390.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	xvreplgr2vr.w	$xr0, $s6
...
.LBB2_17:                               # %vector.body390
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_17
# %bb.18:                               # %vec.epilog.vector.body399
	ori	$a0, $zero, 3968
	xvstx	$xr1, $fp, $a0
	xvstx	$xr0, $s0, $a0
	ld.d	$a0, $s2, 16
...
# %bb.22:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_90
# %bb.23:                               # %vector.body406.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_24:                               # %vector.body406
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_24
# %bb.25:                               # %vec.epilog.vector.body415
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s6, $fp, 3992
...
# %bb.29:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_95
# %bb.30:                               # %vector.body422.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_31:                               # %vector.body422
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_31
# %bb.32:                               # %vec.epilog.vector.body431
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	st.w	$s6, $fp, 0
...
# %bb.36:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_100
# %bb.37:                               # %vector.body438.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_38:                               # %vector.body438
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_38
# %bb.39:                               # %vec.epilog.vector.body447
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s6, $fp, 3996
...
# %bb.43:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_105
# %bb.44:                               # %vector.body454.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_45:                               # %vector.body454
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_45
# %bb.46:                               # %vec.epilog.vector.body463
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s6, $fp, 3996
...
.LBB2_57:                               # %vector.body469
	...
	addi.d	$a2, $a2, 32
	bnez	$a1, .LBB2_57
# %bb.58:                               # %middle.block472
                                        #   in Loop: Header=BB2_52 Depth=1
	beq	$s7, $a0, .LBB2_61
.LBB2_59:                               # %.preheader.preheader481
                                        #   in Loop: Header=BB2_52 Depth=1
	alsl.d	$a1, $a0, $s3, 2
	alsl.d	$a2, $a0, $s4, 2
	.p2align	4, , 16
...
.Ltmp618:                               # EH_LABEL
	...
	jirl	$ra, $a4, 0
.Ltmp619:                               # EH_LABEL
# %bb.63:                               #   in Loop: Header=BB2_52 Depth=1
	move	$s5, $a0
	ld.d	$a0, $s1, 16
	st.d	$s3, $sp, 64
	st.d	$s4, $sp, 56
...
# %bb.65:                               #   in Loop: Header=BB2_52 Depth=1
	bne	$s5, $a0, .LBB2_72
# %bb.66:                               # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit207
                                        #   in Loop: Header=BB2_52 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	...
	ori	$a0, $zero, 17
	bne	$s7, $a0, .LBB2_52
# %bb.67:                               # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit190
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Ltmp624:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp625:                               # EH_LABEL
# %bb.73:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit200
...
.Ltmp620:                               # EH_LABEL
	b	.LBB2_132
.LBB2_129:                              # %.loopexit279
.Ltmp623:                               # EH_LABEL
	b	.LBB2_132
.LBB2_130:                              # %.loopexit.split-lp
.Ltmp635:                               # EH_LABEL
	b	.LBB2_132
.LBB2_131:                              # %.loopexit.split-lp280
.Ltmp632:                               # EH_LABEL
.LBB2_132:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit210
	move	$s1, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_133:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit213
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_134:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit216
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
# %bb.44:
	...
	bne	$s3, $a0, .LBB3_108
# %bb.45:                               # %.preheader285.preheader
	ori	$s7, $zero, 1
	lu12i.w	$s1, 8
	lu12i.w	$a0, 524279
	ori	$s8, $a0, 4095
	bstrins.d	$s8, $s8, 62, 32
	lu12i.w	$s2, -524280
	bstrins.d	$s2, $s2, 62, 32
	.p2align	4, , 16
.LBB3_46:                               # %.preheader285
                                        # =>This Loop Header: Depth=1
...
# %bb.49:                               #   in Loop: Header=BB3_46 Depth=1
	...
	b	.LBB3_57
	.p2align	4, , 16
.LBB3_50:                               # %vector.main.loop.iter.check480
                                        #   in Loop: Header=BB3_46 Depth=1
	ori	$a0, $zero, 16
	bgeu	$s7, $a0, .LBB3_52
# %bb.51:                               #   in Loop: Header=BB3_46 Depth=1
	...
	b	.LBB3_54
	.p2align	4, , 16
.LBB3_52:                               # %vector.ph482
                                        #   in Loop: Header=BB3_46 Depth=1
	bstrpick.d	$a0, $s7, 62, 4
	slli.d	$a0, $a0, 4
	xvreplgr2vr.h	$xr0, $s6
	xvst	$xr0, $s3, 0
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	xvst	$xr0, $s4, 0
	beq	$s7, $a0, .LBB3_59
# %bb.53:                               # %vec.epilog.iter.check488
                                        #   in Loop: Header=BB3_46 Depth=1
	andi	$a1, $s7, 12
	beqz	$a1, .LBB3_57
.LBB3_54:                               # %vec.epilog.ph489
                                        #   in Loop: Header=BB3_46 Depth=1
	move	$a1, $s7
	bstrins.d	$a1, $zero, 1, 0
	bstrpick.d	$a4, $s7, 62, 2
	sub.d	$a1, $a0, $a1
	alsl.d	$a2, $a0, $s4, 1
	alsl.d	$a3, $a0, $s3, 1
	slli.d	$a0, $a4, 2
	.p2align	4, , 16
.LBB3_55:                               # %vec.epilog.vector.body492
	...
	addi.d	$a3, $a3, 8
	bnez	$a1, .LBB3_55
# %bb.56:                               # %vec.epilog.middle.block495
                                        #   in Loop: Header=BB3_46 Depth=1
	beq	$s7, $a0, .LBB3_59
.LBB3_57:                               # %.preheader.preheader
                                        #   in Loop: Header=BB3_46 Depth=1
	alsl.d	$a1, $a0, $s3, 1
	alsl.d	$a2, $a0, $s4, 1
	.p2align	4, , 16
...
.LBB3_59:                               # %.loopexit498
	...
	st.h	$s7, $sp, 70
	beqz	$a0, .LBB3_66
# %bb.60:                               #   in Loop: Header=BB3_46 Depth=1
	ld.d	$a4, $s5, 24
.Ltmp735:                               # EH_LABEL
	addi.d	$a1, $sp, 80
	addi.d	$a2, $sp, 72
	...
	jirl	$ra, $a4, 0
.Ltmp736:                               # EH_LABEL
# %bb.61:                               #   in Loop: Header=BB3_46 Depth=1
	move	$s5, $a0
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 16
	st.d	$s3, $sp, 80
	...
	st.h	$s7, $sp, 70
	beqz	$a1, .LBB3_68
# %bb.62:                               #   in Loop: Header=BB3_46 Depth=1
	ld.d	$a4, $a0, 24
.Ltmp738:                               # EH_LABEL
	addi.d	$a1, $sp, 80
	addi.d	$a2, $sp, 72
...
# %bb.63:                               #   in Loop: Header=BB3_46 Depth=1
	bne	$s5, $a0, .LBB3_70
# %bb.64:                               # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit212
                                        #   in Loop: Header=BB3_46 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	...
	ori	$a0, $zero, 17
	bne	$s7, $a0, .LBB3_46
# %bb.65:                               # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit195
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp741:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp742:                               # EH_LABEL
# %bb.71:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit205
	bstrpick.d	$a1, $s7, 31, 0
.Ltmp743:                               # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cerr)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cerr)
...
.Ltmp737:                               # EH_LABEL
	b	.LBB3_133
.LBB3_127:                              # %.loopexit286
.Ltmp740:                               # EH_LABEL
	b	.LBB3_133
.LBB3_128:                              # %.loopexit.split-lp
.Ltmp752:                               # EH_LABEL
	b	.LBB3_133
.LBB3_129:                              # %.loopexit297
.Ltmp686:                               # EH_LABEL
	b	.LBB3_131
.LBB3_130:                              # %.loopexit.split-lp298
.Ltmp683:                               # EH_LABEL
.LBB3_131:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit221
	move	$s1, $a0
	b	.LBB3_135
.LBB3_132:                              # %.loopexit.split-lp287
.Ltmp749:                               # EH_LABEL
.LBB3_133:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit215
	move	$s1, $a0
	ld.d	$fp, $sp, 8                     # 8-byte Folded Reload
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_134:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit218
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_135:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit221
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.LBB59_5:                               # %vector.body
	...
	vshuf4i.d	$vr3, $vr0, 1
	vshuf4i.h	$vr3, $vr3, 27
	vmskltz.h	$vr4, $vr3
	vpickve2gr.hu	$t1, $vr4, 0
	sltui	$t1, $t1, 1
	maskeqz	$t1, $a0, $t1
	vreplgr2vr.h	$vr4, $t1
...
.LBB67_5:                               # %vector.body
	...
	vreplgr2vr.b	$vr4, $t1
	vbitsel.v	$vr0, $vr3, $vr0, $vr4
	xvreplgr2vr.h	$xr3, $t1
	xvbitsel.v	$xr1, $xr2, $xr1, $xr3
	xvsubi.hu	$xr2, $xr2, 16
	addi.d	$t0, $t0, -16
	addi.d	$a6, $a6, -32
	addi.d	$a7, $a7, -32
	bnez	$t0, .LBB67_5
...
.LBB67_8:                               # %.lr.ph.i.i.i
	...
	addi.d	$a1, $a1, -2
	bltu	$a3, $a7, .LBB67_8
.LBB67_9:                               # %"_ZSt10__invoke_rIsRZ4mainE4$_19JPsS2_sEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ext.w.h	$a0, $a5
	ret
.Lfunc_end67:
...
.LBB71_10:                              # %vec.epilog.ph
	...
	pcalau12i	$t1, %pc_hi20(.LCPI71_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI71_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $a7
	vadd.w	$vr1, $vr2, $vr1
...
.LBB75_10:                              # %vec.epilog.ph
	...
	move	$t0, $a4
	bstrins.d	$t0, $zero, 1, 0
	pcalau12i	$t1, %pc_hi20(.LCPI75_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI75_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $a7
	vadd.w	$vr1, $vr2, $vr1
...
.LBB83_8:                               # %vec.epilog.ph
	...
	move	$a7, $a4
	bstrins.d	$a7, $zero, 1, 0
	pcalau12i	$t1, %pc_hi20(.LCPI83_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI83_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $t0
	vadd.w	$vr1, $vr2, $vr1
...
.LBB87_8:                               # %vec.epilog.ph
	...
	move	$a7, $a4
	bstrins.d	$a7, $zero, 1, 0
	pcalau12i	$t1, %pc_hi20(.LCPI87_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI87_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $t0
	vadd.w	$vr1, $vr2, $vr1
...
.LBB95_9:                               # %vec.epilog.ph
	...
	move	$t0, $a4
	bstrins.d	$t0, $zero, 1, 0
	pcalau12i	$t1, %pc_hi20(.LCPI95_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI95_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $a7
	vadd.w	$vr1, $vr2, $vr1
...
.LBB99_9:                               # %vec.epilog.ph
	...
	move	$t0, $a4
	bstrins.d	$t0, $zero, 1, 0
	pcalau12i	$t1, %pc_hi20(.LCPI99_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI99_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $a7
	vadd.w	$vr1, $vr2, $vr1
...
.LBB107_8:                              # %vec.epilog.ph
	...
	move	$t0, $a4
	bstrins.d	$t0, $zero, 1, 0
	pcalau12i	$t1, %pc_hi20(.LCPI107_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI107_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $a7
	vadd.w	$vr1, $vr2, $vr1
...
.LBB111_8:                              # %vec.epilog.ph
	...
	move	$t0, $a4
	bstrins.d	$t0, $zero, 1, 0
	pcalau12i	$t1, %pc_hi20(.LCPI111_1)
	vld	$vr1, $t1, %pc_lo12(.LCPI111_1)
	vreplgr2vr.w	$vr2, $a3
	ori	$a3, $a4, 3
	vreplgr2vr.w	$vr0, $a7
	vadd.w	$vr1, $vr2, $vr1
...
.LBB115_8:                              # %vec.epilog.ph
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB115_9:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t2, $t0, 0
	ld.d	$t3, $t1, 0
	vinsgr2vr.d	$vr2, $t2, 0
...
# %bb.10:                               # %vec.epilog.middle.block
	...
	or	$t0, $a5, $a6
	beq	$a3, $a7, .LBB115_13
.LBB115_11:                             # %.lr.ph.i.i.i.preheader
	alsl.d	$a2, $a4, $a2, 1
	alsl.d	$a1, $a4, $a1, 1
	.p2align	4, , 16
.LBB115_12:                             # %.lr.ph.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a1, 0
	ld.h	$a5, $a2, 0
	slt	$a3, $a5, $a3
	...
	addi.d	$a1, $a1, 2
	bne	$a0, $a4, .LBB115_12
.LBB115_13:                             # %"_ZSt10__invoke_rIsRZ4mainE4$_35JPsS2_sEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ext.w.h	$a0, $t0
	ret
.Lfunc_end115:
...
.LBB119_5:                              # %vector.body
	...
	bnez	$t0, .LBB119_5
# %bb.6:                                # %middle.block
	pcalau12i	$a6, %pc_hi20(.LCPI119_1)
	vld	$vr2, $a6, %pc_lo12(.LCPI119_1)
	vslli.b	$vr3, $vr0, 7
	vsrai.b	$vr3, $vr3, 7
	vand.v	$vr2, $vr3, $vr2
	vbsrl.v	$vr3, $vr2, 8
	...
	or	$a5, $a6, $a5
	beq	$a4, $a3, .LBB119_9
.LBB119_7:                              # %.lr.ph.i.i.i.preheader
	alsl.d	$a2, $a0, $a2, 1
	alsl.d	$a1, $a0, $a1, 1
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB119_8:                              # %.lr.ph.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a4, $a1, 0
	ld.h	$a6, $a2, 0
	move	$a7, $a0
	...
	addi.d	$a1, $a1, -2
	bltu	$a3, $a7, .LBB119_8
.LBB119_9:                              # %"_ZSt10__invoke_rIsRZ4mainE4$_37JPsS2_sEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ext.w.h	$a0, $a5
	ret
.Lfunc_end119:
...
.LBB123_5:                              # %vector.body
	...
	bnez	$t0, .LBB123_5
# %bb.6:                                # %middle.block
	pcalau12i	$a6, %pc_hi20(.LCPI123_1)
	vld	$vr2, $a6, %pc_lo12(.LCPI123_1)
	vslli.h	$vr3, $vr0, 15
	vsrai.h	$vr3, $vr3, 15
	vand.v	$vr2, $vr3, $vr2
	vbsrl.v	$vr3, $vr2, 8
	...
	or	$a0, $a6, $a0
	beq	$a5, $a4, .LBB123_9
.LBB123_7:                              # %.lr.ph.i.i.i.preheader
	addi.d	$a4, $a1, 1
	alsl.d	$a2, $a1, $a2, 2
	alsl.d	$a3, $a1, $a3, 2
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB123_8:                              # %.lr.ph.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a6, $a3, 0
	ld.w	$a7, $a2, 0
	slt	$a6, $a7, $a6
	...
	addi.d	$a3, $a3, -4
	bltu	$a5, $a4, .LBB123_8
.LBB123_9:                              # %"_ZSt10__invoke_rIiRZ4mainE4$_39JPiS2_iEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ret
.Lfunc_end123:
...
.LBB127_4:                              # %vector.ph
	...
	move	$t0, $a5
	.p2align	4, , 16
.LBB127_5:                              # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr3, $a7, 0
	xvld	$xr4, $a6, 0
	xvfcmp.cule.s	$xr3, $xr3, $xr4
	xvpickev.h	$xr3, $xr3, $xr3
	xvpermi.d	$xr3, $xr3, 216
	vshuf4i.d	$vr3, $vr0, 1
	vshuf4i.h	$vr3, $vr3, 27
	...
	bnez	$t0, .LBB127_5
# %bb.6:                                # %middle.block
	pcalau12i	$a6, %pc_hi20(.LCPI127_1)
	vld	$vr2, $a6, %pc_lo12(.LCPI127_1)
	vslli.h	$vr3, $vr0, 15
	vsrai.h	$vr3, $vr3, 15
	vand.v	$vr2, $vr3, $vr2
	vbsrl.v	$vr3, $vr2, 8
	...
	or	$a0, $a6, $a0
	beq	$a5, $a4, .LBB127_9
.LBB127_7:                              # %.lr.ph.i.i.i.preheader
	addi.d	$a4, $a1, 1
	alsl.d	$a2, $a1, $a2, 2
	alsl.d	$a3, $a1, $a3, 2
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB127_8:                              # %.lr.ph.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fld.s	$fa1, $a2, 0
	fcmp.clt.s	$fcc0, $fa1, $fa0
	...
	addi.d	$a3, $a3, -4
	bltu	$a5, $a4, .LBB127_8
.LBB127_9:                              # %"_ZSt10__invoke_rIiRZ4mainE4$_39JPfS2_iEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ret
.Lfunc_end127:
