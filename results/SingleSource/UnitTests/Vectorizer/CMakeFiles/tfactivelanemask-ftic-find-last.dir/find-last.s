...
# %bb.63:                               # %pred.store.continue
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB3_71
.LBB3_64:                               # %pred.store.continue427
                                        #   in Loop: Header=BB3_62 Depth=2
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB3_72
.LBB3_65:                               # %pred.store.continue429
                                        #   in Loop: Header=BB3_62 Depth=2
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB3_73
.LBB3_66:                               # %pred.store.continue431
                                        #   in Loop: Header=BB3_62 Depth=2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB3_74
.LBB3_67:                               # %pred.store.continue433
                                        #   in Loop: Header=BB3_62 Depth=2
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB3_75
.LBB3_68:                               # %pred.store.continue435
                                        #   in Loop: Header=BB3_62 Depth=2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB3_76
.LBB3_69:                               # %pred.store.continue437
                                        #   in Loop: Header=BB3_62 Depth=2
