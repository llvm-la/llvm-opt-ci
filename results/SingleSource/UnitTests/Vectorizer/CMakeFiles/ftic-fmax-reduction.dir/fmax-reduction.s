...
.Ltmp251:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp252:                               # EH_LABEL
.LBB1_41:                               # %vector.body1231.preheader
	vreplgr2vr.w	$vr0, $s6
	ori	$s3, $s2, 16
	.p2align	4, , 16
.LBB1_42:                               # %vector.body1231
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $fp, $s5
	vstx	$vr0, $a0, $s2
	addi.d	$s5, $s5, 32
...
.Ltmp278:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp279:                               # EH_LABEL
.LBB1_54:                               # %vector.body1237.preheader
	lu12i.w	$a0, -1
	vldi	$vr0, -3456
	.p2align	4, , 16
.LBB1_55:                               # %vector.body1237
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $fp, $a0
	vstx	$vr0, $a1, $s2
	addi.d	$a0, $a0, 32
