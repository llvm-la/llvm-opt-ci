...
# %bb.0:
	blez	$a0, .LBB5_3
# %bb.1:                                # %.lr.ph.preheader
	pcalau12i	$a1, %pc_hi20(c+12)
	addi.d	$a1, $a1, %pc_lo12(c+12)
	pcalau12i	$a2, %pc_hi20(b+4)
	addi.d	$a2, $a2, %pc_lo12(b+4)
	pcalau12i	$a3, %pc_hi20(a)
	addi.d	$a3, $a3, %pc_lo12(a)
	.p2align	4, , 16
.LBB5_2:                                # %.lr.ph
...
.LBB24_152:                             # %.lr.ph.i391
	...
	move	$a0, $a3
	bne	$a3, $s2, .LBB24_152
.LBB24_153:                             # %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEEiET0_T_S8_S7_.exit
.Ltmp32:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
# %bb.155:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit394.preheader
	beq	$s0, $fp, .LBB24_160
...
.Ltmp36:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
# %bb.158:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit398
...
.Ltmp38:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp39:                                # EH_LABEL
# %bb.159:                              # %_ZNSolsEj.exit
                                        #   in Loop: Header=BB24_157 Depth=1
	bstrpick.d	$s4, $s3, 31, 0
	addi.w	$s3, $s3, 1
	bltu	$s4, $s2, .LBB24_157
.LBB24_160:                             # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit394._crit_edge
.Ltmp41:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
	...
	jirl	$ra, $ra, 0
.Ltmp42:                                # EH_LABEL
# %bb.161:                              # %_ZNSt6vectorIjSaIjEED2Ev.exit
	sub.d	$a1, $s5, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
