...
# %bb.1:                                # %vector.ph
	...
	vld	$vr5, $a2, %pc_lo12(.LCPI12_0)
	pcalau12i	$a2, %pc_hi20(.LCPI12_1)
	vld	$vr1, $a2, %pc_lo12(.LCPI12_1)
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a4, 8
	vrepli.b	$vr6, 0
	b	.LBB12_3
...
# %bb.1:                                # %vector.ph
	...
	vld	$vr5, $a2, %pc_lo12(.LCPI17_0)
	pcalau12i	$a2, %pc_hi20(.LCPI17_1)
	vld	$vr1, $a2, %pc_lo12(.LCPI17_1)
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a4, 8
	vrepli.b	$vr6, 0
	b	.LBB17_3
...
# %bb.1:                                # %vector.ph
	...
	vld	$vr10, $a2, %pc_lo12(.LCPI22_0)
	pcalau12i	$a2, %pc_hi20(.LCPI22_1)
	vld	$vr9, $a2, %pc_lo12(.LCPI22_1)
	pcalau12i	$a2, %pc_hi20(.LCPI22_2)
	vld	$vr8, $a2, %pc_lo12(.LCPI22_2)
	pcalau12i	$a2, %pc_hi20(.LCPI22_3)
	vld	$vr1, $a2, %pc_lo12(.LCPI22_3)
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a4, 8
	vrepli.b	$vr7, 0
	b	.LBB22_3
...
.LBB22_7:                               # %pred.load.continue7
	...
	andi	$a3, $a3, 1
	bnez	$a3, .LBB22_16
# %bb.8:                                # %pred.load.continue9
                                        #   in Loop: Header=BB22_3 Depth=1
	vreplvei.w	$vr9, $vr9, 2
	vpickve2gr.h	$a3, $vr9, 6
	andi	$a3, $a3, 1
	bnez	$a3, .LBB22_17
.LBB22_9:                               # %pred.load.continue11
                                        #   in Loop: Header=BB22_3 Depth=1
	vsle.du	$vr9, $vr5, $vr0
	vpickve2gr.h	$a3, $vr9, 0
	andi	$a3, $a3, 1
	bnez	$a3, .LBB22_18
.LBB22_10:                              # %pred.load.continue13
                                        #   in Loop: Header=BB22_3 Depth=1
	vreplvei.w	$vr9, $vr9, 2
	vpickve2gr.h	$a3, $vr9, 2
	andi	$a3, $a3, 1
	beqz	$a3, .LBB22_12
.LBB22_11:                              # %pred.load.if14
                                        #   in Loop: Header=BB22_3 Depth=1
	ld.h	$a3, $a2, 2
	ld.h	$a4, $a1, 2
	vinsgr2vr.h	$vr7, $a3, 5
	vinsgr2vr.h	$vr8, $a4, 5
.LBB22_12:                              # %pred.load.continue15
                                        #   in Loop: Header=BB22_3 Depth=1
	vsle.du	$vr9, $vr4, $vr0
	vreplvei.w	$vr10, $vr9, 0
	vpickve2gr.h	$a3, $vr10, 4
...
# %bb.1:                                # %vector.ph
	...
	vld	$vr5, $a2, %pc_lo12(.LCPI26_0)
	pcalau12i	$a2, %pc_hi20(.LCPI26_1)
	vld	$vr1, $a2, %pc_lo12(.LCPI26_1)
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a4, 8
	vrepli.b	$vr6, 0
	b	.LBB26_3
...
# %bb.1:                                # %vector.ph
	...
	vld	$vr5, $a2, %pc_lo12(.LCPI30_0)
	pcalau12i	$a2, %pc_hi20(.LCPI30_1)
	vld	$vr1, $a2, %pc_lo12(.LCPI30_1)
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a4, 8
	vrepli.b	$vr6, 0
	b	.LBB30_3
...
# %bb.1:                                # %vector.ph
	...
	vld	$vr10, $a2, %pc_lo12(.LCPI34_0)
	pcalau12i	$a2, %pc_hi20(.LCPI34_1)
	vld	$vr9, $a2, %pc_lo12(.LCPI34_1)
	pcalau12i	$a2, %pc_hi20(.LCPI34_2)
	vld	$vr8, $a2, %pc_lo12(.LCPI34_2)
	pcalau12i	$a2, %pc_hi20(.LCPI34_3)
	vld	$vr1, $a2, %pc_lo12(.LCPI34_3)
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a4, 8
	vrepli.b	$vr7, 0
	b	.LBB34_3
...
# %bb.8:                                # %pred.load.continue9
	...
	andi	$a3, $a3, 1
	bnez	$a3, .LBB34_17
.LBB34_9:                               # %pred.load.continue11
                                        #   in Loop: Header=BB34_3 Depth=1
	vsle.du	$vr9, $vr5, $vr0
	vpickve2gr.h	$a3, $vr9, 0
	andi	$a3, $a3, 1
	bnez	$a3, .LBB34_18
.LBB34_10:                              # %pred.load.continue13
                                        #   in Loop: Header=BB34_3 Depth=1
	vreplvei.w	$vr9, $vr9, 2
	vpickve2gr.h	$a3, $vr9, 2
	andi	$a3, $a3, 1
	beqz	$a3, .LBB34_12
.LBB34_11:                              # %pred.load.if14
                                        #   in Loop: Header=BB34_3 Depth=1
	ld.h	$a3, $a2, 2
	ld.h	$a4, $a1, 2
	vinsgr2vr.h	$vr7, $a3, 5
	vinsgr2vr.h	$vr8, $a4, 5
.LBB34_12:                              # %pred.load.continue15
                                        #   in Loop: Header=BB34_3 Depth=1
	vsle.du	$vr9, $vr4, $vr0
	vreplvei.w	$vr10, $vr9, 0
	vpickve2gr.h	$a3, $vr10, 4
...
.LBB48_9:                               # %pred.load.if8
	...
	vori.b	$vr8, $vr6, 0
	vinsgr2vr.h	$vr8, $a4, 2
	vextrins.h	$vr8, $vr6, 51
	vori.b	$vr9, $vr5, 0
	vinsgr2vr.h	$vr9, $a5, 2
	vextrins.h	$vr9, $vr5, 51
	vori.b	$vr6, $vr8, 0
	vori.b	$vr5, $vr9, 0
	vpickve2gr.w	$a4, $vr7, 2
	andi	$a4, $a4, 1
...
# %bb.8:                                # %pred.load.continue9
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB60_17
.LBB60_9:                               # %pred.load.continue11
                                        #   in Loop: Header=BB60_3 Depth=1
	vsle.du	$vr10, $vr2, $vr0
	vpickve2gr.h	$a4, $vr10, 0
	andi	$a4, $a4, 1
	bnez	$a4, .LBB60_18
.LBB60_10:                              # %pred.load.continue13
                                        #   in Loop: Header=BB60_3 Depth=1
	vreplvei.w	$vr11, $vr10, 2
	vpickve2gr.h	$a4, $vr11, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB60_12
.LBB60_11:                              # %pred.load.if14
                                        #   in Loop: Header=BB60_3 Depth=1
	ld.h	$a4, $a3, 2
	ld.h	$a5, $a2, 2
	vinsgr2vr.h	$vr7, $a4, 5
	vinsgr2vr.h	$vr8, $a5, 5
.LBB60_12:                              # %pred.load.continue15
                                        #   in Loop: Header=BB60_3 Depth=1
	vsle.du	$vr11, $vr1, $vr0
...
.LBB60_19:                              # %"_ZSt10__invoke_rItRZ4mainE4$_15JPtS2_jEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit.loopexit"
	vpickev.w	$vr0, $vr9, $vr6
	vpickev.w	$vr1, $vr11, $vr10
