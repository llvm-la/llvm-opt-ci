...
# %bb.21:
	...
	xvreplgr2vr.w	$xr1, $s5
	bne	$s3, $a0, .LBB1_67
# %bb.22:                               # %vector.body252.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_23:                               # %vector.body252
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $fp, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr1, $a3, $a2
	bnez	$a0, .LBB1_23
# %bb.24:                               # %vec.epilog.vector.body261
	ori	$a0, $zero, 3968
	xvstx	$xr0, $fp, $a0
	xvstx	$xr1, $s0, $a0
	ld.d	$a0, $s2, 16
...
# %bb.28:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB1_72
# %bb.29:                               # %vector.body268.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_30:                               # %vector.body268
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_30
# %bb.31:                               # %vec.epilog.vector.body277
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s5, $fp, 3992
...
# %bb.35:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB1_77
# %bb.36:                               # %vector.body284.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_37:                               # %vector.body284
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_37
# %bb.38:                               # %vec.epilog.vector.body293
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	st.w	$s5, $fp, 0
...
# %bb.42:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB1_82
# %bb.43:                               # %vector.body300.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_44:                               # %vector.body300
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_44
# %bb.45:                               # %vec.epilog.vector.body309
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s5, $fp, 3996
...
# %bb.49:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB1_87
# %bb.50:                               # %vector.body316.preheader
	ori	$a0, $s4, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB1_51:                               # %vector.body316
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB1_51
# %bb.52:                               # %vec.epilog.vector.body325
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s5, $fp, 3996
...
# %bb.15:
	...
	xvreplgr2vr.w	$xr1, $s4
	bne	$s3, $a0, .LBB2_61
# %bb.16:                               # %vector.body245.preheader
	ori	$a0, $s5, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_17:                               # %vector.body245
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $fp, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr1, $a3, $a2
	bnez	$a0, .LBB2_17
# %bb.18:                               # %vec.epilog.vector.body254
	ori	$a0, $zero, 3968
	xvstx	$xr0, $fp, $a0
	xvstx	$xr1, $s0, $a0
	ld.d	$a0, $s2, 16
...
# %bb.22:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_66
# %bb.23:                               # %vector.body261.preheader
	ori	$a0, $s5, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_24:                               # %vector.body261
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_24
# %bb.25:                               # %vec.epilog.vector.body270
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s4, $fp, 3992
...
# %bb.29:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_71
# %bb.30:                               # %vector.body277.preheader
	ori	$a0, $s5, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_31:                               # %vector.body277
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_31
# %bb.32:                               # %vec.epilog.vector.body286
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	st.w	$s4, $fp, 0
...
# %bb.36:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_76
# %bb.37:                               # %vector.body293.preheader
	ori	$a0, $s5, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_38:                               # %vector.body293
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_38
# %bb.39:                               # %vec.epilog.vector.body302
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s4, $fp, 3996
...
# %bb.43:
	xvld	$xr0, $sp, 16                   # 32-byte Folded Reload
	bne	$s3, $a0, .LBB2_81
# %bb.44:                               # %vector.body309.preheader
	ori	$a0, $s5, 128
	ori	$a1, $zero, 3968
	ori	$a2, $zero, 4000
	.p2align	4, , 16
.LBB2_45:                               # %vector.body309
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	xvstx	$xr0, $a3, $a1
	xvstx	$xr0, $a3, $a2
	...
	xvstx	$xr0, $a3, $a2
	bnez	$a0, .LBB2_45
# %bb.46:                               # %vec.epilog.vector.body318
	ori	$a0, $zero, 3968
	xvstx	$xr0, $s0, $a0
	xvstx	$xr0, $fp, $a0
	stptr.w	$s4, $fp, 3996
