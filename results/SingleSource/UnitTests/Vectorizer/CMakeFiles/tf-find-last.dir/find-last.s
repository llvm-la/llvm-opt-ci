...
.Lttbase0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL19checkVectorFunctionIiiEvSt8functionIFT_PT0_S3_S1_EES5_PKc
...
# %bb.66:                               #   in Loop: Header=BB1_58 Depth=1
	bne	$s5, $a0, .LBB1_73
# %bb.67:                               # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit212
                                        #   in Loop: Header=BB1_58 Depth=1
	move	$a0, $s4
	...
	ori	$a0, $zero, 17
	bne	$s8, $a0, .LBB1_58
# %bb.68:                               # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit195
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Ltmp513:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp514:                               # EH_LABEL
# %bb.74:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit205
...
.Ltmp509:                               # EH_LABEL
	b	.LBB1_135
.LBB1_130:                              # %.loopexit286
.Ltmp512:                               # EH_LABEL
	b	.LBB1_135
.LBB1_131:                              # %.loopexit.split-lp
.Ltmp524:                               # EH_LABEL
	b	.LBB1_135
.LBB1_132:                              # %.loopexit297
.Ltmp458:                               # EH_LABEL
	move	$s1, $a0
	b	.LBB1_137
.LBB1_133:                              # %.loopexit.split-lp298
.Ltmp455:                               # EH_LABEL
	move	$s1, $a0
	b	.LBB1_137
.LBB1_134:                              # %.loopexit.split-lp287
.Ltmp521:                               # EH_LABEL
.LBB1_135:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit215
	move	$s1, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB1_136:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit218
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB1_137:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit221
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Lcst_end1:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL19checkVectorFunctionIifEvSt8functionIFT_PT0_S3_S1_EES5_PKc
...
# %bb.60:                               #   in Loop: Header=BB2_52 Depth=1
	bne	$s5, $a0, .LBB2_67
# %bb.61:                               # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit207
                                        #   in Loop: Header=BB2_52 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	...
	ori	$a0, $zero, 17
	bne	$s7, $a0, .LBB2_52
# %bb.62:                               # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit190
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Ltmp624:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp625:                               # EH_LABEL
# %bb.68:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit200
...
.Ltmp620:                               # EH_LABEL
	b	.LBB2_127
.LBB2_124:                              # %.loopexit279
.Ltmp623:                               # EH_LABEL
	b	.LBB2_127
.LBB2_125:                              # %.loopexit.split-lp
.Ltmp635:                               # EH_LABEL
	b	.LBB2_127
.LBB2_126:                              # %.loopexit.split-lp280
.Ltmp632:                               # EH_LABEL
.LBB2_127:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit210
	move	$s1, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_128:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit213
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_129:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit216
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Lcst_end2:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL19checkVectorFunctionIssEvSt8functionIFT_PT0_S3_S1_EES5_PKc
...
# %bb.21:
	bne	$s3, $a0, .LBB3_86
# %bb.22:                               # %.preheader295.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_23:                               # %.preheader295
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s7, $fp, $a0
	stx.h	$s6, $s0, $a0
	addi.d	$a0, $a0, 2
...
# %bb.28:
	bne	$s3, $a0, .LBB3_91
# %bb.29:                               # %.preheader294.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_30:                               # %.preheader294
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s7, $s0, $a0
	stx.h	$s7, $fp, $a0
	addi.d	$a0, $a0, 2
...
# %bb.35:
	bne	$s3, $a0, .LBB3_96
# %bb.36:                               # %.preheader293.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_37:                               # %.preheader293
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s7, $s0, $a0
	stx.h	$s7, $fp, $a0
	addi.d	$a0, $a0, 2
...
# %bb.42:
	bne	$s3, $a0, .LBB3_101
# %bb.43:                               # %.preheader292.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_44:                               # %.preheader292
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s7, $s0, $a0
	stx.h	$s7, $fp, $a0
	addi.d	$a0, $a0, 2
...
# %bb.49:
	bne	$s3, $a0, .LBB3_106
# %bb.50:                               # %.preheader291.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_51:                               # %.preheader291
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s7, $s0, $a0
	stx.h	$s7, $fp, $a0
	addi.d	$a0, $a0, 2
...
.Ltmp735:                               # EH_LABEL
	...
	jirl	$ra, $a4, 0
.Ltmp736:                               # EH_LABEL
# %bb.64:                               #   in Loop: Header=BB3_58 Depth=1
	move	$s5, $a0
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a1, $a0, 16
	st.d	$s3, $sp, 32
...
# %bb.66:                               #   in Loop: Header=BB3_58 Depth=1
	bne	$s5, $a0, .LBB3_73
# %bb.67:                               # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit212
                                        #   in Loop: Header=BB3_58 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	...
	ori	$a0, $zero, 17
	bne	$s8, $a0, .LBB3_58
# %bb.68:                               # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit195
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Ltmp737:                               # EH_LABEL
	b	.LBB3_135
.LBB3_130:                              # %.loopexit286
.Ltmp740:                               # EH_LABEL
	b	.LBB3_135
.LBB3_131:                              # %.loopexit.split-lp
.Ltmp752:                               # EH_LABEL
	b	.LBB3_135
.LBB3_132:                              # %.loopexit297
.Ltmp686:                               # EH_LABEL
	move	$s1, $a0
	b	.LBB3_137
.LBB3_133:                              # %.loopexit.split-lp298
.Ltmp683:                               # EH_LABEL
	move	$s1, $a0
	b	.LBB3_137
.LBB3_134:                              # %.loopexit.split-lp287
.Ltmp749:                               # EH_LABEL
.LBB3_135:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit215
	move	$s1, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_136:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit218
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_137:                              # %_ZNSt10unique_ptrIA_sSt14default_deleteIS0_EED2Ev.exit221
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Lfunc_end10:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZL9init_dataIfEvRKSt10unique_ptrIA_T_St14default_deleteIS2_EEj
...
.LBB11_5:                               #   Parent Loop BB11_1 Depth=1
	...
	add.d	$t8, $a1, $t6
	ld.d	$s0, $t8, 8
	bstrpick.d	$s1, $s0, 30, 1
	ldptr.d	$t8, $t8, 3176
	slli.d	$s1, $s1, 1
	bstrins.d	$t7, $s1, 30, 0
	srli.d	$t7, $t7, 1
	xor	$t7, $t7, $t8
	andi	$t8, $s0, 1
	sub.d	$t8, $zero, $t8
...
.LBB11_7:                               # %vector.body
	...
	vand.v	$vr14, $vr13, $vr3
	vseqi.d	$vr14, $vr14, 0
	vandn.v	$vr14, $vr14, $vr4
	vxor.v	$vr12, $vr12, $vr14
	addi.d	$t6, $t6, 16
	vstx	$vr12, $t7, $t1
	vori.b	$vr12, $vr13, 0
