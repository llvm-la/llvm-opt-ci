...
.LBB3_7:                                # %pred.store.continue
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_14
# %bb.8:                                # %pred.store.continue35
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 2
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_15
.LBB3_9:                                # %pred.store.continue37
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 3
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_16
.LBB3_10:                               # %pred.store.continue39
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 4
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_17
.LBB3_11:                               # %pred.store.continue41
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 5
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_18
.LBB3_12:                               # %pred.store.continue43
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 6
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_19
.LBB3_13:                               # %pred.store.continue45
                                        #   in Loop: Header=BB3_5 Depth=1
...
.LBB5_13:                               # %vector.body61
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_15
# %bb.14:                               # %pred.store.if64
                                        #   in Loop: Header=BB5_13 Depth=2
	add.d	$a6, $s2, $a4
	st.w	$fp, $a6, -16
.LBB5_15:                               # %pred.store.continue65
                                        #   in Loop: Header=BB5_13 Depth=2
	xvxor.v	$xr0, $xr0, $xr3
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_22
# %bb.16:                               # %pred.store.continue67
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_23
.LBB5_17:                               # %pred.store.continue69
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_24
.LBB5_18:                               # %pred.store.continue71
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 4
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_25
.LBB5_19:                               # %pred.store.continue73
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_26
.LBB5_20:                               # %pred.store.continue75
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_27
.LBB5_21:                               # %pred.store.continue77
                                        #   in Loop: Header=BB5_13 Depth=2
...
.LBB5_48:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_55
# %bb.49:                               # %pred.store.continue43
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_56
.LBB5_50:                               # %pred.store.continue45
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 3
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_57
.LBB5_51:                               # %pred.store.continue47
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 4
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_58
.LBB5_52:                               # %pred.store.continue49
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_59
.LBB5_53:                               # %pred.store.continue51
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.h	$a4, $vr0, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_60
.LBB5_54:                               # %pred.store.continue53
                                        #   in Loop: Header=BB5_46 Depth=2
