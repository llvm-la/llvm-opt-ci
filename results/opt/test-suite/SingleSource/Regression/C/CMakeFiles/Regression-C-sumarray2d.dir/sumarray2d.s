...
.LBB1_9:                                # %pred.store.continue
	...
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_11
# %bb.10:                               # %pred.store.if31
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -6
	st.w	$t7, $t6, -12
.LBB1_11:                               # %pred.store.continue32
                                        #   in Loop: Header=BB1_7 Depth=2
	xvxor.v	$xr7, $xr7, $xr3
	xvpermi.q	$xr8, $xr7, 1
	...
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_13
# %bb.12:                               # %pred.store.if33
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -5
	st.w	$t7, $t6, -8
.LBB1_13:                               # %pred.store.continue34
                                        #   in Loop: Header=BB1_7 Depth=2
	xvpermi.q	$xr7, $xr7, 1
	...
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_15
# %bb.14:                               # %pred.store.if35
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -4
	st.w	$t7, $t6, -4
.LBB1_15:                               # %pred.store.continue36
                                        #   in Loop: Header=BB1_7 Depth=2
	xvseq.d	$xr8, $xr6, $xr4
	xvxor.v	$xr7, $xr8, $xr3
	...
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_17
# %bb.16:                               # %pred.store.if37
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -3
	stx.w	$t7, $a2, $t4
.LBB1_17:                               # %pred.store.continue38
                                        #   in Loop: Header=BB1_7 Depth=2
	vxor.v	$vr8, $vr8, $vr2
	vshuf4i.w	$vr8, $vr8, 8
	xvpermi.q	$xr8, $xr8, 2
	...
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_19
# %bb.18:                               # %pred.store.if39
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -2
	st.w	$t7, $t6, 4
.LBB1_19:                               # %pred.store.continue40
                                        #   in Loop: Header=BB1_7 Depth=2
	xvpermi.q	$xr8, $xr7, 1
	vshuf4i.w	$vr8, $vr8, 128
	xvpermi.q	$xr8, $xr8, 2
	...
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_21
# %bb.20:                               # %pred.store.if41
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -1
	st.w	$t7, $t6, 8
.LBB1_21:                               # %pred.store.continue42
                                        #   in Loop: Header=BB1_7 Depth=2
	xvpermi.q	$xr7, $xr7, 1
	vshuf4i.w	$vr7, $vr7, 128
	xvpermi.q	$xr7, $xr7, 2
