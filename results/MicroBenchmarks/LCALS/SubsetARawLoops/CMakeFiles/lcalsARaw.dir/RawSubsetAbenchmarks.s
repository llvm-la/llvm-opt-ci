...
.Lcst_end0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL20BM_PRESSURE_CALC_RAWRN9benchmark5StateE
...
# %bb.6:                                #   in Loop: Header=BB1_5 Depth=1
	...
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_7:                                # %vector.body110.preheader
                                        #   in Loop: Header=BB1_5 Depth=1
	move	$a7, $a5
	move	$t0, $a4
	move	$t1, $a2
	.p2align	4, , 16
.LBB1_8:                                # %vector.body110
...
# %bb.9:                                # %middle.block115
	...
	move	$t1, $a2
	beq	$a0, $a2, .LBB1_12
.LBB1_10:                               # %scalar.ph103.preheader
                                        #   in Loop: Header=BB1_5 Depth=1
	alsl.d	$a7, $t1, $s1, 3
	alsl.d	$t0, $t1, $s2, 3
	sub.d	$t1, $a0, $t1
	.p2align	4, , 16
.LBB1_11:                               # %scalar.ph103
                                        #   Parent Loop BB1_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa6, $a7, 0
	fadd.d	$fa6, $fa6, $fa4
...
.LBB1_14:                               # %vector.body.preheader
	...
	b	.LBB1_16
	.p2align	4, , 16
.LBB1_15:                               # %pred.store.continue101
...
.LBB1_20:                               # %middle.block
	...
	move	$t3, $a3
	beq	$a0, $a3, .LBB1_4
.LBB1_21:                               # %..preheader_crit_edge.us.us.preheader118
                                        #   in Loop: Header=BB1_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
.LBB1_23:                               #   in Loop: Header=BB1_24 Depth=2
	...
	addi.d	$t2, $t2, 8
	beqz	$t3, .LBB1_4
.LBB1_24:                               # %..preheader_crit_edge.us.us
                                        #   Parent Loop BB1_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa6, $a7, 0
	fld.d	$fa7, $t0, 0
...
# %bb.6:                                #   in Loop: Header=BB3_4 Depth=1
	...
	b	.LBB3_10
	.p2align	4, , 16
.LBB3_7:                                # %vector.body327.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
...
# %bb.21:                               #   in Loop: Header=BB3_4 Depth=1
	...
	b	.LBB3_25
	.p2align	4, , 16
.LBB3_22:                               # %vector.body301.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a0, $t1
	move	$a1, $t3
	move	$a2, $t5
...
# %bb.18:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_19:                               # %_ZN7ADomainD2Ev.exit201
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end5:
...
.Lcst_end8:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZL10BM_FIR_RAWRN9benchmark5StateE
...
.Lfunc_end12:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_RawSubsetAbenchmarks.cxx
