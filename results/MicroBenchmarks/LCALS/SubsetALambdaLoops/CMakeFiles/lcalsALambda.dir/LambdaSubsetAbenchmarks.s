...
# %bb.6:                                #   in Loop: Header=BB1_5 Depth=1
	...
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_7:                                # %vector.body96.preheader
                                        #   in Loop: Header=BB1_5 Depth=1
	move	$a7, $a5
	move	$t0, $a4
	move	$t1, $a2
	.p2align	4, , 16
.LBB1_8:                                # %vector.body96
...
# %bb.19:                               # %pred.store.if86
	...
	b	.LBB1_15
	.p2align	4, , 16
.LBB1_20:                               # %middle.block
                                        #   in Loop: Header=BB1_5 Depth=1
	move	$t3, $a3
	beq	$a0, $a3, .LBB1_4
.LBB1_21:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us.preheader104"
                                        #   in Loop: Header=BB1_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
.LBB1_22:                               #   in Loop: Header=BB1_24 Depth=2
	...
	fsel	$fa6, $fa6, $ft4, $fcc0
	fst.d	$fa6, $t1, 0
.LBB1_23:                               # %"_Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us.us"
	...
	addi.d	$t2, $t2, 8
	beqz	$t3, .LBB1_4
.LBB1_24:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us"
                                        #   Parent Loop BB1_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa6, $a7, 0
	fld.d	$fa7, $t0, 0
...
# %bb.6:                                #   in Loop: Header=BB3_4 Depth=1
	...
	b	.LBB3_10
	.p2align	4, , 16
.LBB3_7:                                # %vector.body289.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
...
.LBB3_8:                                # %vector.body289
	...
	vfadd.d	$vr2, $vr2, $vr4
	vfadd.d	$vr3, $vr3, $vr5
	vfmul.d	$vr4, $vr6, $vr10
	vfmul.d	$vr5, $vr7, $vr10
	vld	$vr6, $a2, -16
	vld	$vr7, $a2, 0
...
# %bb.21:                               #   in Loop: Header=BB3_4 Depth=1
	...
	b	.LBB3_25
	.p2align	4, , 16
.LBB3_22:                               # %vector.body263.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a0, $t2
	move	$a1, $t4
	move	$a2, $t6
...
# %bb.24:                               # %middle.block272
	...
	move	$a6, $a0
	beq	$s7, $a0, .LBB3_27
.LBB3_25:                               # %"_Z6forallIZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEE3$_1Ev9simd_execiiT_.exit.preheader307"
                                        #   in Loop: Header=BB3_4 Depth=1
	alsl.d	$a0, $a6, $t7, 3
	alsl.d	$a1, $a6, $t0, 3
	alsl.d	$a2, $a6, $t8, 3
...
.LBB3_30:                               # %vector.body
	...
	vfcmp.cule.d	$vr2, $vr8, $vr2
	vand.v	$vr0, $vr2, $vr0
	vfcmp.cule.d	$vr2, $vr8, $vr3
	vand.v	$vr1, $vr2, $vr1
	vfcmp.clt.d	$vr2, $vr0, $vr9
	vfcmp.clt.d	$vr3, $vr1, $vr9
	vbitsel.v	$vr0, $vr0, $vr9, $vr2
	vbitsel.v	$vr1, $vr1, $vr9, $vr3
	vst	$vr0, $a1, -16
	vst	$vr1, $a1, 0
	addi.d	$a2, $a2, -4
	addi.d	$a1, $a1, 32
...
# %bb.31:                               # %middle.block
	...
	move	$a2, $a0
	beq	$s7, $a0, .LBB3_34
.LBB3_32:                               # %"_ZZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEENK3$_3clEi.exit.preheader306"
                                        #   in Loop: Header=BB3_4 Depth=1
	alsl.d	$a0, $a2, $t2, 3
	alsl.d	$a1, $a2, $ra, 3
	sub.d	$a2, $s7, $a2
...
.LBB5_8:                                # %.lr.ph.preheader
	...
	vand.v	$vr0, $vr0, $vr6
	vslt.du	$vr2, $vr15, $vr23
	vslt.du	$vr3, $vr21, $vr22
	vpickev.w	$vr2, $vr2, $vr3
	vslt.du	$vr3, $vr7, $vr11
