...
.Lfunc_end19:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZL13BM_PIC_1D_RAWRN9benchmark5StateE
...
.LBB21_61:                              # %._crit_edge.us213
	...
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	bgeu	$a1, $s0, .LBB21_78
.LBB21_62:                              # %scalar.ph351.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
...
.LBB21_64:                              # %._crit_edge.us213.1
	...
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	bgeu	$a1, $s0, .LBB21_83
.LBB21_65:                              # %scalar.ph318.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a2, $a0, $t0, 3
...
.LBB21_67:                              # %._crit_edge.us213.2
	...
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	bgeu	$a1, $s0, .LBB21_88
.LBB21_68:                              # %scalar.ph285.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a2, $a0, $t0, 3
...
.LBB21_73:                              # %vector.memcheck366
	...
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	bnez	$a1, .LBB21_59
# %bb.74:                               # %vector.memcheck366
                                        #   in Loop: Header=BB21_4 Depth=1
	sub.d	$a1, $t0, $a7
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB21_59
# %bb.75:                               # %vector.body389.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a4, 8
	addi.d	$a2, $a5, 8
...
.LBB21_78:                              # %vector.memcheck333
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB21_62
# %bb.79:                               # %vector.memcheck333
                                        #   in Loop: Header=BB21_4 Depth=1
	sub.d	$a1, $t0, $a7
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB21_62
# %bb.80:                               # %vector.body356.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a4, 8
	addi.d	$a2, $a5, 8
...
.LBB21_83:                              # %vector.memcheck300
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB21_65
# %bb.84:                               # %vector.memcheck300
                                        #   in Loop: Header=BB21_4 Depth=1
	sub.d	$a1, $t0, $a7
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB21_65
# %bb.85:                               # %vector.body323.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a4, 8
	addi.d	$a2, $a5, 8
...
.LBB21_88:                              # %vector.memcheck267
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB21_68
# %bb.89:                               # %vector.memcheck267
                                        #   in Loop: Header=BB21_4 Depth=1
	sub.d	$a1, $t0, $a7
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB21_68
# %bb.90:                               # %vector.body290.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a4, 8
	addi.d	$a2, $a5, 8
