...
.LBB13_59:                              # %scalar.ph387.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ori	$s0, $zero, 2
.LBB13_60:                              # %scalar.ph387.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	alsl.d	$a0, $a1, $a3, 3
	alsl.d	$a2, $a1, $a4, 3
	alsl.d	$a3, $a1, $a5, 3
...
.LBB13_62:                              # %._crit_edge.us213
	...
	ori	$a2, $zero, 4
	bgeu	$a0, $a2, .LBB13_79
.LBB13_63:                              # %scalar.ph353.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	sub.d	$a0, $a0, $a1
	alsl.d	$a2, $a1, $t0, 3
...
.LBB13_65:                              # %._crit_edge.us213.1
	...
	ori	$a2, $zero, 4
	bgeu	$a0, $a2, .LBB13_84
.LBB13_66:                              # %scalar.ph319.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	sub.d	$a0, $a0, $a1
	alsl.d	$a2, $a1, $t0, 3
...
.LBB13_68:                              # %._crit_edge.us213.2
	...
	ori	$a2, $zero, 4
	bgeu	$a0, $a2, .LBB13_89
.LBB13_69:                              # %scalar.ph285.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	sub.d	$a0, $a0, $a1
	alsl.d	$a2, $a1, $t0, 3
...
# %bb.75:                               # %vector.memcheck369
	...
	ori	$a2, $zero, 32
	bltu	$a0, $a2, .LBB13_60
# %bb.76:                               # %vector.body392.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a4, 8
	addi.d	$a2, $a5, 8
...
.LBB13_79:                              # %vector.memcheck335
	...
	andi	$a0, $a0, 255
	bnez	$a0, .LBB13_63
# %bb.80:                               # %vector.memcheck335
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a0, $t0, $a7
	ori	$a2, $zero, 32
	bltu	$a0, $a2, .LBB13_63
# %bb.81:                               # %vector.body358.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a4, 8
	addi.d	$a2, $a5, 8
...
.LBB13_84:                              # %vector.memcheck301
	...
	andi	$a0, $a0, 255
	bnez	$a0, .LBB13_66
# %bb.85:                               # %vector.memcheck301
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a0, $t0, $a7
	ori	$a2, $zero, 32
	bltu	$a0, $a2, .LBB13_66
# %bb.86:                               # %vector.body324.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a4, 8
	addi.d	$a2, $a5, 8
...
.Ltmp295:                               # EH_LABEL
	...
	move	$s0, $a0
	beq	$a1, $s3, .LBB20_187
# %bb.186:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i6.i136
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB20_187:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit8.i137
	bnez	$s2, .LBB20_209
	b	.LBB20_210
.LBB20_188:
.Ltmp279:                               # EH_LABEL
...
.Ltmp12:                                # EH_LABEL
	...
	move	$s0, $a0
	beq	$a1, $s3, .LBB20_208
.LBB20_207:                             # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i6.i
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB20_208:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit8.i
	beqz	$s5, .LBB20_210
.LBB20_209:                             # %common.resume.sink.split
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB20_210:                             # %common.resume
	move	$a0, $s0
