...
.LBB58_8:
	...
	ret
.LBB58_9:                               # %vector.ph
	pcalau12i	$a4, %pc_hi20(.LCPI58_0)
	xvld	$xr0, $a4, %pc_lo12(.LCPI58_0)
	move	$a5, $zero
	bstrpick.d	$a4, $a3, 30, 5
	slli.d	$a4, $a4, 5
	.p2align	4, , 16
.LBB58_10:                              # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	xvldx	$xr1, $a0, $a5
...
# %bb.13:
	...
	move	$a0, $a4
	ret
.LBB58_14:                              # %vector.early.exit
	pcalau12i	$a0, %pc_hi20(.LCPI58_1)
	xvld	$xr0, $a0, %pc_lo12(.LCPI58_1)
	xvslli.b	$xr1, $xr1, 7
	xvsrai.b	$xr1, $xr1, 7
	xvand.v	$xr0, $xr1, $xr0
	xvpermi.q	$xr1, $xr0, 1
...
.LBB59_9:                               # %vector.body
	...
	bstrins.d	$t2, $t3, 3, 3
	vpickve2gr.b	$t3, $vr0, 4
	bstrins.d	$t2, $t3, 4, 4
	vpickve2gr.b	$t3, $vr0, 5
	bstrins.d	$t2, $t3, 5, 5
