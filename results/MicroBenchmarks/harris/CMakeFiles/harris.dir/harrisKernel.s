...
# %bb.25:                               #   in Loop: Header=BB0_22 Depth=1
	...
	b	.LBB0_30
	.p2align	4, , 16
.LBB0_26:                               # %vector.body521.preheader
                                        #   in Loop: Header=BB0_22 Depth=1
	move	$a5, $s3
	move	$t1, $s2
	move	$t4, $a0
	.p2align	4, , 16
.LBB0_27:                               # %vector.body521
...
# %bb.38:                               #   in Loop: Header=BB0_37 Depth=1
	...
	b	.LBB0_48
	.p2align	4, , 16
.LBB0_39:                               # %vector.main.loop.iter.check540
                                        #   in Loop: Header=BB0_37 Depth=1
...
# %bb.40:                               #   in Loop: Header=BB0_37 Depth=1
	...
	b	.LBB0_45
	.p2align	4, , 16
.LBB0_41:                               # %vector.body545.preheader
                                        #   in Loop: Header=BB0_37 Depth=1
	move	$a5, $s5
	move	$t1, $s4
	move	$t4, $s3
...
.LBB0_42:                               # %vector.body545
	...
	addi.d	$a5, $a5, 64
	bnez	$s1, .LBB0_42
# %bb.43:                               # %middle.block552
                                        #   in Loop: Header=BB0_37 Depth=1
	beq	$t6, $t2, .LBB0_36
# %bb.44:                               # %vec.epilog.iter.check557
                                        #   in Loop: Header=BB0_37 Depth=1
	move	$s1, $t6
	move	$t1, $t6
	beqz	$a2, .LBB0_48
.LBB0_45:                               # %vec.epilog.ph559
	...
	alsl.d	$s1, $s1, $ra, 2
	.p2align	4, , 16
.LBB0_46:                               # %vec.epilog.vector.body562
                                        #   Parent Loop BB0_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s1, 0
	vld	$vr1, $t4, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$a5, .LBB0_46
# %bb.47:                               # %vec.epilog.middle.block567
                                        #   in Loop: Header=BB0_37 Depth=1
	move	$t1, $s2
	beq	$s2, $t2, .LBB0_36
.LBB0_48:                               # %vec.epilog.scalar.ph556.preheader
                                        #   in Loop: Header=BB0_37 Depth=1
	slli.d	$a5, $t1, 2
	sub.d	$t1, $t2, $t1
	.p2align	4, , 16
.LBB0_49:                               # %vec.epilog.scalar.ph556
                                        #   Parent Loop BB0_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.s	$fa0, $ra, $a5
	fldx.s	$fa1, $s0, $a5
...
# %bb.53:                               #   in Loop: Header=BB0_52 Depth=1
	...
	b	.LBB0_63
	.p2align	4, , 16
.LBB0_54:                               # %vector.main.loop.iter.check574
                                        #   in Loop: Header=BB0_52 Depth=1
	bgeu	$s3, $s0, .LBB0_56
# %bb.55:                               #   in Loop: Header=BB0_52 Depth=1
	...
	b	.LBB0_60
	.p2align	4, , 16
.LBB0_56:                               # %vector.body579.preheader
                                        #   in Loop: Header=BB0_52 Depth=1
	move	$a0, $fp
	move	$t1, $t7
	move	$s2, $t5
	.p2align	4, , 16
.LBB0_57:                               # %vector.body579
	...
	addi.d	$a0, $a0, 64
	bnez	$s2, .LBB0_57
# %bb.58:                               # %middle.block584
                                        #   in Loop: Header=BB0_52 Depth=1
	beq	$t5, $t2, .LBB0_51
# %bb.59:                               # %vec.epilog.iter.check589
                                        #   in Loop: Header=BB0_52 Depth=1
	move	$s2, $t5
	move	$t1, $t5
	beqz	$a2, .LBB0_63
.LBB0_60:                               # %vec.epilog.ph591
                                        #   in Loop: Header=BB0_52 Depth=1
	add.d	$a0, $t8, $s2
	alsl.d	$t1, $s2, $s1, 2
	alsl.d	$s2, $s2, $a4, 2
	.p2align	4, , 16
.LBB0_61:                               # %vec.epilog.vector.body594
                                        #   Parent Loop BB0_52 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s2, 0
	vfmul.s	$vr0, $vr0, $vr0
	...
	addi.d	$s2, $s2, 16
	bnez	$a0, .LBB0_61
# %bb.62:                               # %vec.epilog.middle.block598
                                        #   in Loop: Header=BB0_52 Depth=1
	move	$t1, $t6
	beq	$t6, $t2, .LBB0_51
.LBB0_63:                               # %vec.epilog.scalar.ph588.preheader
                                        #   in Loop: Header=BB0_52 Depth=1
	slli.d	$a0, $t1, 2
	sub.d	$t1, $t2, $t1
	.p2align	4, , 16
.LBB0_64:                               # %vec.epilog.scalar.ph588
                                        #   Parent Loop BB0_52 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.s	$fa0, $a4, $a0
	fmul.s	$fa0, $fa0, $fa0
...
# %bb.70:                               #   in Loop: Header=BB0_69 Depth=1
	...
	b	.LBB0_74
	.p2align	4, , 16
.LBB0_71:                               # %vector.body613.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$s6, $a7
	move	$s7, $s3
	move	$ra, $s4
	.p2align	4, , 16
.LBB0_72:                               # %vector.body613
	...
	addi.d	$s6, $s6, 32
	bnez	$s7, .LBB0_72
# %bb.73:                               # %middle.block624
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$s7, $s3
	beq	$s3, $a1, .LBB0_68
.LBB0_74:                               # %scalar.ph608.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	slli.d	$s6, $s7, 2
	sub.d	$s7, $a1, $s7
	.p2align	4, , 16
.LBB0_75:                               # %scalar.ph608
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$ra, $t0, $s6
	fldx.s	$fa2, $ra, $t6
...
# %bb.80:                               #   in Loop: Header=BB0_79 Depth=1
	...
	b	.LBB0_84
	.p2align	4, , 16
.LBB0_81:                               # %vector.body638.preheader
                                        #   in Loop: Header=BB0_79 Depth=1
	move	$s4, $s6
	move	$s3, $s5
	move	$t2, $s7
	.p2align	4, , 16
.LBB0_82:                               # %vector.body638
	...
	addi.d	$s4, $s4, 32
	bnez	$s3, .LBB0_82
# %bb.83:                               # %middle.block650
                                        #   in Loop: Header=BB0_79 Depth=1
	move	$t2, $s5
	beq	$s5, $a1, .LBB0_78
.LBB0_84:                               # %scalar.ph633.preheader
                                        #   in Loop: Header=BB0_79 Depth=1
	sub.d	$s3, $a1, $t2
	slli.d	$t2, $t2, 2
	.p2align	4, , 16
.LBB0_85:                               # %scalar.ph633
                                        #   Parent Loop BB0_79 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$s4, $s8, $t2
	fldx.s	$fa0, $s8, $t2
...
# %bb.89:                               #   in Loop: Header=BB0_88 Depth=1
	...
	b	.LBB0_93
	.p2align	4, , 16
.LBB0_90:                               # %vector.body664.preheader
                                        #   in Loop: Header=BB0_88 Depth=1
	move	$s6, $s4
	move	$s8, $s3
	move	$s7, $t2
	.p2align	4, , 16
.LBB0_91:                               # %vector.body664
	...
	addi.d	$s6, $s6, 32
	bnez	$s8, .LBB0_91
# %bb.92:                               # %middle.block676
                                        #   in Loop: Header=BB0_88 Depth=1
	move	$s7, $s3
	beq	$s3, $a1, .LBB0_87
.LBB0_93:                               # %scalar.ph659.preheader
                                        #   in Loop: Header=BB0_88 Depth=1
	sub.d	$s6, $a1, $s7
	slli.d	$s7, $s7, 2
	.p2align	4, , 16
.LBB0_94:                               # %scalar.ph659
                                        #   Parent Loop BB0_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$s8, $a6, $s7
	fldx.s	$fa0, $a6, $s7
...
# %bb.98:                               #   in Loop: Header=BB0_97 Depth=1
	...
	b	.LBB0_108
	.p2align	4, , 16
.LBB0_99:                               # %vector.main.loop.iter.check685
                                        #   in Loop: Header=BB0_97 Depth=1
	bgeu	$a1, $s3, .LBB0_101
# %bb.100:                              #   in Loop: Header=BB0_97 Depth=1
	...
	b	.LBB0_105
	.p2align	4, , 16
.LBB0_101:                              # %vector.body690.preheader
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$t2, $s0
	move	$s7, $fp
	move	$s8, $t8
...
.LBB0_102:                              # %vector.body690
	...
	addi.d	$t2, $t2, 64
	bnez	$ra, .LBB0_102
# %bb.103:                              # %middle.block697
                                        #   in Loop: Header=BB0_97 Depth=1
	beq	$t6, $a1, .LBB0_96
# %bb.104:                              # %vec.epilog.iter.check702
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$ra, $t6
	move	$s7, $t6
	beqz	$a6, .LBB0_108
.LBB0_105:                              # %vec.epilog.ph704
                                        #   in Loop: Header=BB0_97 Depth=1
	add.d	$t2, $s1, $ra
	alsl.d	$s7, $ra, $s6, 2
	alsl.d	$s8, $ra, $s5, 2
	alsl.d	$ra, $ra, $s4, 2
	.p2align	4, , 16
.LBB0_106:                              # %vec.epilog.vector.body707
                                        #   Parent Loop BB0_97 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $ra, 0
	vld	$vr1, $s8, 0
	...
	addi.d	$ra, $ra, 16
	bnez	$t2, .LBB0_106
# %bb.107:                              # %vec.epilog.middle.block712
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$s7, $t7
	beq	$t7, $a1, .LBB0_96
.LBB0_108:                              # %vec.epilog.scalar.ph701.preheader
                                        #   in Loop: Header=BB0_97 Depth=1
	slli.d	$t2, $s7, 2
	sub.d	$s7, $a1, $s7
	.p2align	4, , 16
.LBB0_109:                              # %vec.epilog.scalar.ph701
                                        #   Parent Loop BB0_97 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.s	$fa0, $s4, $t2
	fldx.s	$fa1, $s5, $t2
...
# %bb.113:                              #   in Loop: Header=BB0_112 Depth=1
	...
	b	.LBB0_123
	.p2align	4, , 16
.LBB0_114:                              # %vector.main.loop.iter.check723
                                        #   in Loop: Header=BB0_112 Depth=1
	bgeu	$a1, $s4, .LBB0_116
# %bb.115:                              #   in Loop: Header=BB0_112 Depth=1
	...
	b	.LBB0_120
	.p2align	4, , 16
.LBB0_116:                              # %vector.body728.preheader
                                        #   in Loop: Header=BB0_112 Depth=1
	move	$t2, $s2
	move	$s6, $s1
	move	$s7, $s0
...
.LBB0_117:                              # %vector.body728
	...
	addi.d	$t2, $t2, 64
	bnez	$ra, .LBB0_117
# %bb.118:                              # %middle.block737
                                        #   in Loop: Header=BB0_112 Depth=1
	beq	$t7, $a1, .LBB0_111
# %bb.119:                              # %vec.epilog.iter.check742
                                        #   in Loop: Header=BB0_112 Depth=1
	move	$ra, $t7
	move	$s6, $t7
	beqz	$a6, .LBB0_123
.LBB0_120:                              # %vec.epilog.ph744
                                        #   in Loop: Header=BB0_112 Depth=1
	add.d	$t2, $s3, $ra
	alsl.d	$s6, $ra, $s5, 2
	alsl.d	$s7, $ra, $a5, 2
	...
	alsl.d	$ra, $ra, $t3, 2
	.p2align	4, , 16
.LBB0_121:                              # %vec.epilog.vector.body747
                                        #   Parent Loop BB0_112 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $ra, 0
	vld	$vr1, $s7, 0
	...
	addi.d	$ra, $ra, 16
	bnez	$t2, .LBB0_121
# %bb.122:                              # %vec.epilog.middle.block753
                                        #   in Loop: Header=BB0_112 Depth=1
	move	$s6, $t8
	beq	$t8, $a1, .LBB0_111
.LBB0_123:                              # %vec.epilog.scalar.ph741.preheader
                                        #   in Loop: Header=BB0_112 Depth=1
	slli.d	$t2, $s6, 2
	sub.d	$s6, $a1, $s6
	.p2align	4, , 16
.LBB0_124:                              # %vec.epilog.scalar.ph741
                                        #   Parent Loop BB0_112 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.s	$fa0, $t3, $t2
	fldx.s	$fa1, $a5, $t2
...
# %bb.128:                              #   in Loop: Header=BB0_127 Depth=1
	...
	b	.LBB0_138
	.p2align	4, , 16
.LBB0_129:                              # %vector.main.loop.iter.check762
                                        #   in Loop: Header=BB0_127 Depth=1
	bgeu	$a1, $fp, .LBB0_131
# %bb.130:                              #   in Loop: Header=BB0_127 Depth=1
	...
	b	.LBB0_135
	.p2align	4, , 16
.LBB0_131:                              # %vector.body767.preheader
                                        #   in Loop: Header=BB0_127 Depth=1
	move	$a5, $t6
	move	$s0, $t5
	move	$s1, $t4
...
.LBB0_132:                              # %vector.body767
	...
	addi.d	$a5, $a5, 64
	bnez	$s2, .LBB0_132
# %bb.133:                              # %middle.block774
                                        #   in Loop: Header=BB0_127 Depth=1
	beq	$t0, $a1, .LBB0_126
# %bb.134:                              # %vec.epilog.iter.check779
                                        #   in Loop: Header=BB0_127 Depth=1
	move	$s2, $t0
	move	$s0, $t0
	beqz	$a6, .LBB0_138
.LBB0_135:                              # %vec.epilog.ph781
                                        #   in Loop: Header=BB0_127 Depth=1
	add.d	$a5, $t7, $s2
	alsl.d	$s0, $s2, $a3, 2
	alsl.d	$s1, $s2, $a2, 2
	alsl.d	$s2, $s2, $a4, 2
	.p2align	4, , 16
.LBB0_136:                              # %vec.epilog.vector.body784
                                        #   Parent Loop BB0_127 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $s1, 0
	vld	$vr3, $s2, 0
	...
	addi.d	$s2, $s2, 16
	bnez	$a5, .LBB0_136
# %bb.137:                              # %vec.epilog.middle.block789
                                        #   in Loop: Header=BB0_127 Depth=1
	move	$s0, $t3
	beq	$t3, $a1, .LBB0_126
.LBB0_138:                              # %vec.epilog.scalar.ph778.preheader
                                        #   in Loop: Header=BB0_127 Depth=1
	slli.d	$a5, $s0, 2
	sub.d	$s0, $a1, $s0
	.p2align	4, , 16
.LBB0_139:                              # %vec.epilog.scalar.ph778
                                        #   Parent Loop BB0_127 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.s	$fa2, $a2, $a5
	fldx.s	$fa3, $a4, $a5
