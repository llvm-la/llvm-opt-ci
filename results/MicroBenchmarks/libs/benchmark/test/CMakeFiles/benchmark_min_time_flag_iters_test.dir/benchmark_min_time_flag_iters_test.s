...
# %bb.7:
	...
	lu52i.d	$a0, $a0, 2047
	bgeu	$s1, $a0, .LBB1_18
# %bb.8:                                # %_ZNSt15__new_allocatorIlE8allocateEmPKv.exit.i.i.i.i
.Ltmp3:                                 # EH_LABEL
	move	$a0, $s1
...
.LBB1_11:                               # %.thread
	move	$s0, $zero
	move	$s4, $s1
.LBB1_12:                               # %_ZNSt6vectorIlSaIlEEC2ERKS1_.exit
	beq	$s0, $s4, .LBB1_20
# %bb.13:
	ld.d	$a0, $s0, 0
	ori	$a1, $zero, 4
	bne	$a0, $a1, .LBB1_20
# %bb.14:                               # %_ZNSt6vectorIlSaIlEED2Ev.exit
	move	$a0, $fp
...
# %bb.15:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB1_16:                               # %_ZNSt6vectorIlSaIlEED2Ev.exit.i
...
.Ltmp8:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp9:                                 # EH_LABEL
# %bb.17:                               # %_ZN12_GLOBAL__N_112TestReporterD2Ev.exit
	addi.d	$a0, $sp, 40
...
.Ltmp2:                                 # EH_LABEL
	...
	move	$fp, $a0
	beq	$a2, $s1, .LBB1_28
# %bb.26:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i22
	ld.d	$a0, $sp, 24
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.Ltmp7:                                 # EH_LABEL
	move	$fp, $a0
.LBB1_28:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit24
	addi.d	$a0, $sp, 40
	pcaddu18i	$ra, %call36(_ZN12_GLOBAL__N_112TestReporterD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Lcst_begin2:
	...
	.uleb128 .Lfunc_end7-.Ltmp15            #   Call between .Ltmp15 and .Lfunc_end7
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end2:
	.byte	1                               # >> Action Record 1 <<
...
.Ltmp21:                                # EH_LABEL
	...
	move	$s0, $a0
	bne	$a2, $s1, .LBB10_8
# %bb.6:                                # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit8.i
	bnez	$s2, .LBB10_9
.LBB10_7:
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB10_8:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i6.i
	ld.d	$a0, $sp, 24
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.Lcst_begin3:
	...
	.uleb128 .Lfunc_end10-.Ltmp20           #   Call between .Ltmp20 and .Lfunc_end10
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end3:
	.p2align	2, 0x0
