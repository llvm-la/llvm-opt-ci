...
# %bb.13:                               # %.preheader.us.preheader
	...
	b	.LBB0_15
	.p2align	4, , 16
.LBB0_14:                               # %_ZNSt3mapIiiSt4lessIiESaISt4pairIKiiEEE4findERS3_.exit.us
...
# %bb.30:                               # %_ZN9benchmark5State3endEv.exit
	...
	addi.d	$s2, $s2, -1
	bnez	$s2, .LBB0_22
.LBB0_31:                               # %_ZN9benchmark5State3endEv.exit._crit_edge
.Ltmp30:                                # EH_LABEL
	move	$a0, $s0
...
# %bb.37:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i35
	...
	jirl	$ra, $ra, 0
.LBB0_38:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i36
	ld.d	$a1, $sp, 72
.Ltmp39:                                # EH_LABEL
	addi.d	$a0, $sp, 56
	pcaddu18i	$ra, %call36(_ZNSt8_Rb_treeIiSt4pairIKiiESt10_Select1stIS2_ESt4lessIiESaIS2_EE8_M_eraseEPSt13_Rb_tree_nodeIS2_E)
...
# %bb.19:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i21
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB1_20:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit23
...
.Ltmp50:                                # EH_LABEL
	move	$s0, $a0
.LBB2_11:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit6
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN10MapFixtureD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $s0
...
# %bb.24:                               # %._crit_edge.i28
	move	$a0, $fp
	bge	$s0, $a2, .LBB14_33
.LBB14_25:                              # %._crit_edge.thread.i36
	bne	$fp, $a1, .LBB14_32
	b	.LBB14_7
.LBB14_26:
	move	$a1, $a0
...
# %bb.30:                               # %._crit_edge.i47
	move	$a0, $fp
	bge	$s0, $a2, .LBB14_33
.LBB14_31:                              # %._crit_edge.thread.i55
	ld.d	$a0, $a1, 24
	beq	$fp, $a0, .LBB14_35
.LBB14_32:
	move	$a0, $fp
...
.LBB14_33:
	slt	$a2, $a2, $s0
.LBB14_34:                              # %_ZNSt8_Rb_treeIiSt4pairIKiiESt10_Select1stIS2_ESt4lessIiESaIS2_EE24_M_get_insert_unique_posERS1_.exit
	maskeqz	$a1, $fp, $a2
	masknez	$a0, $a0, $a2
	b	.LBB14_36
.LBB14_35:
	move	$a0, $zero
	move	$a1, $fp
.LBB14_36:                              # %_ZNSt8_Rb_treeIiSt4pairIKiiESt10_Select1stIS2_ESt4lessIiESaIS2_EE24_M_get_insert_unique_posERS1_.exit
...
# %bb.8:                                # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB16_10
.LBB16_9:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i
	sub.d	$a0, $s6, $fp
	slt	$a1, $s5, $a0
	maskeqz	$a0, $a0, $a1
	masknez	$a1, $s5, $a1
...
# %bb.8:                                # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i
	...
	move	$a3, $s1
	bnez	$a0, .LBB17_10
.LBB17_9:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i.i.i
	sub.d	$a0, $s3, $s4
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
...
# %bb.9:
	move	$fp, $zero
	b	.LBB18_28
.LBB18_10:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit28
	sub.d	$a0, $s5, $s6
	bgez	$a0, .LBB18_21
	b	.LBB18_15
.LBB18_11:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit28.thread78
	sub.d	$a0, $s5, $s6
	bltz	$a0, .LBB18_15
.LBB18_12:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i39
	move	$a0, $s3
	move	$a1, $s4
	move	$a2, $s2
	pcaddu18i	$ra, %call36(memcmp)
...
# %bb.17:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i30
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB18_19
.LBB18_18:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i33
	sub.d	$a0, $s3, $s5
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
	...
	masknez	$a1, $a1, $a2
	or	$a0, $a0, $a1
.LBB18_19:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit37
	addi.w	$a0, $a0, 0
	bgez	$a0, .LBB18_27
# %bb.20:
	ld.d	$a0, $s2, 24
	...
	or	$a1, $a0, $fp
	b	.LBB18_28
.LBB18_21:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i42
	sub.d	$a0, $s6, $s5
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
...
# %bb.24:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i48
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB18_26
.LBB18_25:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i51
	sub.d	$a0, $s5, $s3
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
	...
	masknez	$a1, $a1, $a2
	or	$a0, $a0, $a1
.LBB18_26:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit55
	addi.w	$a0, $a0, 0
	bltz	$a0, .LBB18_31
.LBB18_27:
	move	$a0, $s1
...
# %bb.1:                                # %.lr.ph
	...
	b	.LBB20_4
	.p2align	4, , 16
.LBB20_2:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i
...
# %bb.10:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i6
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB20_12
.LBB20_11:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i9
	sub.d	$a0, $s1, $s5
	slt	$a1, $s4, $a0
	maskeqz	$a0, $a0, $a1
	masknez	$a1, $s4, $a1
	...
	masknez	$a1, $a1, $a2
	or	$a0, $a0, $a1
.LBB20_12:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit13
	addi.w	$a0, $a0, 0
	slti	$a1, $a0, 0
	srai.d	$a0, $a0, 63
	and	$fp, $a0, $fp
