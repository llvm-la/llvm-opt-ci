...
# %bb.0:
	ret
.Lfunc_end5:
	.size	_ZN9benchmark7Fixture5SetUpERKNS_5StateE, .Lfunc_end5-_ZN9benchmark7Fixture5SetUpERKNS_5StateE
                                        # -- End function
...
# %bb.0:
	...
	jr	$t8
.Lfunc_end9:
	.size	_ZN23MyFixture_Bar_BenchmarkD0Ev, .Lfunc_end9-_ZN23MyFixture_Bar_BenchmarkD0Ev
                                        # -- End function
...
# %bb.2:                                # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
	...
	jirl	$ra, $ra, 0
.LBB10_3:                               # %_ZN9MyFixtureIiEC2Ev.exit
	st.w	$zero, $fp, 304
...
# %bb.13:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4.i.i
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB10_14:                              # %common.resume
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end10:
	.size	_ZN23MyFixture_Foo_BenchmarkC2Ev, .Lfunc_end10-_ZN23MyFixture_Foo_BenchmarkC2Ev
	.cfi_endproc
...
# %bb.2:                                # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_3:                               # %_ZN9MyFixtureIdEC2Ev.exit
	st.d	$zero, $fp, 304
...
# %bb.6:                                # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_7:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
	ld.d	$s1, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 64                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 72                    # 8-byte Folded Reload
...
.Ltmp14:                                # EH_LABEL
	move	$s0, $a0
.LBB11_11:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit6
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN9benchmark9BenchmarkD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $s0
...
# %bb.13:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4.i.i
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_14:                              # %common.resume
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end11:
	.size	_ZN23MyFixture_Bar_BenchmarkC2Ev, .Lfunc_end11-_ZN23MyFixture_Bar_BenchmarkC2Ev
	.cfi_endproc
...
.Lcst_end1:
	...
	.p2align	2                               # -- Begin function _GLOBAL__sub_I_templated_fixture_test.cc
...
DW.ref.__gxx_personality_v0:
	...
	.addrsig_sym _ZTV23MyFixture_Foo_Benchmark
	...
	.addrsig_sym _ZTV23MyFixture_Bar_Benchmark
