...
# %bb.18:                               # %.noexc61
	...
	st.d	$a0, $sp, 8
	st.d	$a1, $sp, 24
.LBB5_19:                               # %._crit_edge.i.i58
	beqz	$s1, .LBB5_23
# %bb.20:                               # %._crit_edge.i.i58
	ori	$a1, $zero, 1
	bne	$s1, $a1, .LBB5_22
# %bb.21:
	ld.b	$a1, $s0, 0
...
# %bb.24:
	ld.d	$a0, $sp, 8
	beq	$a0, $s2, .LBB5_26
# %bb.25:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i63
	ld.d	$a1, $sp, 24
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB5_26:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit65
.Ltmp8:                                 # EH_LABEL
	addi.d	$a0, $sp, 40
	addi.d	$a1, $sp, 8
...
.Ltmp29:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp30:                                # EH_LABEL
# %bb.39:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit78
.Ltmp31:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cerr)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cerr)
	move	$a1, $fp
...
# %bb.42:                               # %_ZNSolsEl.exit84
	...
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB5_76
# %bb.43:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i103
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB5_56
# %bb.44:
	ld.bu	$a0, $s0, 67
...
.Ltmp48:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp49:                                # EH_LABEL
# %bb.50:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit88
.Ltmp50:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cerr)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cerr)
	move	$a1, $fp
...
# %bb.53:                               # %_ZNSolsEl.exit94
	...
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB5_78
# %bb.54:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i114
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB5_60
# %bb.55:
	ld.bu	$a0, $s0, 67
...
.Ltmp39:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp40:                                # EH_LABEL
.LBB5_58:                               # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i105
.Ltmp41:                                # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp58:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp59:                                # EH_LABEL
.LBB5_62:                               # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i116
.Ltmp60:                                # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.LBB5_65:                               # %_ZNSolsEPFRSoS_E.exit
	...
	st.d	$a1, $sp, 64
	beq	$a0, $a2, .LBB5_67
# %bb.66:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i
	ld.d	$a1, $sp, 152
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.Ltmp7:                                 # EH_LABEL
	...
	move	$fp, $a0
	beq	$a2, $s2, .LBB5_90
# %bb.82:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i74
	ld.d	$a0, $sp, 24
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.10:
	...
	ld.d	$a0, $sp, 16
	beq	$a0, $s1, .LBB14_12
# %bb.11:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i9
	ld.d	$a1, $sp, 32
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
# %bb.14:
	...
	ld.d	$a0, $sp, 16
	beq	$a0, $s1, .LBB14_16
# %bb.15:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i14
	ld.d	$a1, $sp, 32
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
# %bb.18:
	...
	ld.d	$a0, $sp, 16
	beq	$a0, $s1, .LBB14_20
# %bb.19:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i19
	ld.d	$a1, $sp, 32
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
