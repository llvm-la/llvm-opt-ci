...
# %bb.55:                               # %middle.block
	...
	beq	$a3, $a2, .LBB22_47
# %bb.56:                               #   in Loop: Header=BB22_48 Depth=1
	slli.d	$a3, $a2, 5
	alsl.d	$a2, $a2, $a3, 4
	add.d	$a0, $a0, $a2
	.p2align	4, , 16
...
# %bb.137:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB22_138:                             # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i
.Ltmp151:                               # EH_LABEL
	lu12i.w	$a0, 1
	ori	$a0, $a0, 1520
	add.d	$a0, $sp, $a0
...
# %bb.29:                               # %middle.block
                                        #   in Loop: Header=BB39_7 Depth=1
	beq	$a2, $a3, .LBB39_33
# %bb.30:                               #   in Loop: Header=BB39_7 Depth=1
	add.d	$a3, $a3, $s8
.LBB39_31:                              # %.lr.ph.preheader145
                                        #   in Loop: Header=BB39_7 Depth=1
	addi.d	$a2, $fp, 8
	alsl.d	$a2, $a3, $a2, 3
	nor	$a3, $a3, $zero
...
.LBB39_34:                              # %.lr.ph119
	...
	blt	$s8, $a0, .LBB39_7
	b	.LBB39_36
.LBB39_35:                              #   in Loop: Header=BB39_7 Depth=1
	ld.d	$a0, $s7, 0
...
.LBB39_41:                              # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit85
	...
	pcalau12i	$a1, %pc_hi20(.L.str.60)
	addi.d	$a1, $a1, %pc_lo12(.L.str.60)
.LBB39_42:                              # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit85
	pcaddu18i	$ra, %call36(bcmp)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB39_70
...
# %bb.44:                               # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread108
	ori	$a1, $zero, 4
	beq	$a2, $a1, .LBB39_47
# %bb.45:                               # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread108
	ori	$a1, $zero, 7
	bne	$a2, $a1, .LBB39_70
...
.LBB39_47:                              # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit82.1
	...
	addi.d	$a1, $a1, %pc_lo12(.L.str.24)
	b	.LBB39_49
.LBB39_48:                              # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit85.1
	ld.d	$a0, $a0, 0
	pcalau12i	$a1, %pc_hi20(.L.str.60)
	addi.d	$a1, $a1, %pc_lo12(.L.str.60)
.LBB39_49:                              # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit82.1
	pcaddu18i	$ra, %call36(bcmp)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB39_70
...
# %bb.51:                               # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread108.1
	ori	$a0, $zero, 1
	beq	$a2, $a0, .LBB39_57
# %bb.52:                               # %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread108.1
	ori	$a0, $zero, 2
	bne	$a2, $a0, .LBB39_70
# %bb.53:                               # %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit6.i
	ld.d	$a1, $a1, 0
	ld.hu	$a3, $a1, 0
	lu12i.w	$a2, 7
	ori	$a4, $a2, 877
	beq	$a3, $a4, .LBB39_58
# %bb.54:                               # %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit8.i
	ld.hu	$a0, $a1, 0
	ori	$a3, $a2, 885
	beq	$a0, $a3, .LBB39_69
# %bb.55:                               # %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit10.i
	ld.hu	$a0, $a1, 0
	ori	$a1, $a2, 878
	bne	$a0, $a1, .LBB39_70
# %bb.56:
	move	$a0, $zero
	b	.LBB39_58
.LBB39_57:                              # %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.i
	ld.d	$a0, $a1, 0
	ld.bu	$a1, $a0, 0
	ori	$a2, $zero, 115
	ori	$a0, $zero, 3
	bne	$a1, $a2, .LBB39_70
.LBB39_58:                              # %.sink.split.i
	pcalau12i	$a1, %pc_hi20(_ZN9benchmark12_GLOBAL__N_117default_time_unitE)
	st.w	$a0, $a1, %pc_lo12(_ZN9benchmark12_GLOBAL__N_117default_time_unitE)
.LBB39_59:                              # %_ZN9benchmark8internal26SetDefaultTimeUnitFromFlagERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit
...
# %bb.62:
	ld.d	$a0, $sp, 40
	beq	$a0, $s1, .LBB39_64
# %bb.63:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
	ld.d	$a1, $sp, 56
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_64:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
	ld.d	$a0, $sp, 72
	beq	$a0, $s0, .LBB39_66
# %bb.65:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i92
	ld.d	$a1, $sp, 88
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.Ltmp275:                               # EH_LABEL
	...
	move	$fp, $a0
	bne	$a2, $s1, .LBB39_74
# %bb.72:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit97
	ld.d	$a0, $sp, 72
	bne	$a0, $s0, .LBB39_75
.LBB39_73:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit100
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB39_74:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i95
	ld.d	$a0, $sp, 56
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	...
	ld.d	$a0, $sp, 72
	beq	$a0, $s0, .LBB39_73
.LBB39_75:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i98
	ld.d	$a1, $sp, 88
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
