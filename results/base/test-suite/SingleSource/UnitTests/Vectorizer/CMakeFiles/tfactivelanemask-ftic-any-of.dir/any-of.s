...
# %bb.21:
	bne	$s3, $a0, .LBB3_67
# %bb.22:                               # %.preheader230.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_23:                               # %.preheader230
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s5, $fp, $a0
	stx.h	$s4, $s0, $a0
	addi.d	$a0, $a0, 2
...
# %bb.28:
	bne	$s3, $a0, .LBB3_72
# %bb.29:                               # %.preheader229.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_30:                               # %.preheader229
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s5, $s0, $a0
	stx.h	$s5, $fp, $a0
	addi.d	$a0, $a0, 2
...
# %bb.35:
	bne	$s3, $a0, .LBB3_77
# %bb.36:                               # %.preheader228.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_37:                               # %.preheader228
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s5, $s0, $a0
	stx.h	$s5, $fp, $a0
	addi.d	$a0, $a0, 2
...
# %bb.42:
	bne	$s3, $a0, .LBB3_82
# %bb.43:                               # %.preheader227.preheader
	move	$a0, $zero
	ori	$a1, $zero, 2000
	.p2align	4, , 16
.LBB3_44:                               # %.preheader227
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$s5, $s0, $a0
	stx.h	$s5, $fp, $a0
	addi.d	$a0, $a0, 2
...
.LBB9_7:                                # %pred.load.continue12
	...
	andi	$t1, $t1, 1
	beqz	$t1, .LBB9_9
.LBB9_8:                                # %pred.load.if13
                                        #   in Loop: Header=BB9_3 Depth=1
	xvpickve2gr.d	$t2, $xr9, 3
	slli.d	$t2, $t2, 3
	ldx.d	$t2, $a0, $t2
	xvinsgr2vr.d	$xr7, $t2, 3
.LBB9_9:                                # %pred.load.continue14
                                        #   in Loop: Header=BB9_3 Depth=1
...
# %bb.10:                               # %pred.load.if15
	...
	bnez	$a7, .LBB9_16
.LBB9_11:                               # %pred.load.continue18
                                        #   in Loop: Header=BB9_3 Depth=1
	beqz	$t0, .LBB9_17
.LBB9_12:                               # %pred.load.if19
                                        #   in Loop: Header=BB9_3 Depth=1
	ldptr.d	$t4, $t2, 3192
...
.LBB12_3:                               # %vector.body
	...
	xvsadd.du	$xr3, $xr4, $xr1
	xvslt.du	$xr7, $xr3, $xr2
...
.LBB22_5:                               # %pred.load.continue
                                        #   in Loop: Header=BB22_3 Depth=1
	xvsadd.du	$xr10, $xr6, $xr0
	xvsadd.du	$xr11, $xr6, $xr1
	xvsadd.du	$xr12, $xr6, $xr2
