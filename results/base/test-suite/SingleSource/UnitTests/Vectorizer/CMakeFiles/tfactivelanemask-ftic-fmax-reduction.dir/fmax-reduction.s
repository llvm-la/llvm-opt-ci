...
.LBB1_11:                               # %pred.load.continue
	...
	andi	$a3, $a3, 1
	bnez	$a3, .LBB1_23
# %bb.12:                               # %pred.load.continue1211
                                        #   in Loop: Header=BB1_9 Depth=3
	vpickve2gr.w	$a4, $vr6, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_24
.LBB1_13:                               # %pred.load.continue1213
                                        #   in Loop: Header=BB1_9 Depth=3
	vpickve2gr.w	$a5, $vr6, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB1_25
.LBB1_14:                               # %pred.load.continue1215
                                        #   in Loop: Header=BB1_9 Depth=3
	vpickve2gr.w	$a6, $vr6, 0
	andi	$a6, $a6, 1
                                        # implicit-def: $xr5
	bnez	$a6, .LBB1_26
.LBB1_15:                               # %pred.load.continue1217
                                        #   in Loop: Header=BB1_9 Depth=3
	bnez	$a3, .LBB1_27
.LBB1_16:                               # %pred.load.continue1219
                                        #   in Loop: Header=BB1_9 Depth=3
	bnez	$a4, .LBB1_28
.LBB1_17:                               # %pred.load.continue1221
                                        #   in Loop: Header=BB1_9 Depth=3
	beqz	$a5, .LBB1_19
.LBB1_18:                               # %pred.load.if1222
                                        #   in Loop: Header=BB1_9 Depth=3
	ld.d	$a7, $a2, 0
	xvinsgr2vr.d	$xr5, $a7, 3
.LBB1_19:                               # %pred.load.continue1223
                                        #   in Loop: Header=BB1_9 Depth=3
...
# %bb.20:                               # %pred.store.continue
                                        #   in Loop: Header=BB1_9 Depth=3
	bnez	$a3, .LBB1_30
.LBB1_21:                               # %pred.store.continue1225
                                        #   in Loop: Header=BB1_9 Depth=3
	bnez	$a4, .LBB1_31
.LBB1_22:                               # %pred.store.continue1227
                                        #   in Loop: Header=BB1_9 Depth=3
	beqz	$a5, .LBB1_8
	b	.LBB1_32
	.p2align	4, , 16
...
.LBB1_38:                               #   in Loop: Header=BB1_4 Depth=1
	...
	xvst	$xr12, $sp, 128                 # 32-byte Folded Spill
	...
	xvld	$xr12, $sp, 128                 # 32-byte Folded Reload
...
.LBB1_91:                               # %_ZNSt14_Function_baseD2Ev.exit283
	...
	b	.LBB1_93
	.p2align	4, , 16
.LBB1_92:                               # %pred.store.continue1274
...
# %bb.94:                               # %pred.store.if1259
	...
	fdiv.s	$fa4, $fa3, $fa4
	fst.s	$fa4, $a1, -12
.LBB1_95:                               # %pred.store.continue1260
                                        #   in Loop: Header=BB1_93 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_102
# %bb.96:                               # %pred.store.continue1262
                                        #   in Loop: Header=BB1_93 Depth=1
	vpickve2gr.h	$a4, $vr4, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_103
.LBB1_97:                               # %pred.store.continue1264
                                        #   in Loop: Header=BB1_93 Depth=1
	vpickve2gr.h	$a4, $vr4, 3
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_104
.LBB1_98:                               # %pred.store.continue1266
                                        #   in Loop: Header=BB1_93 Depth=1
	vpickve2gr.h	$a4, $vr4, 4
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_105
.LBB1_99:                               # %pred.store.continue1268
                                        #   in Loop: Header=BB1_93 Depth=1
	vpickve2gr.h	$a4, $vr4, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_106
.LBB1_100:                              # %pred.store.continue1270
                                        #   in Loop: Header=BB1_93 Depth=1
	vpickve2gr.h	$a4, $vr4, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_107
.LBB1_101:                              # %pred.store.continue1272
                                        #   in Loop: Header=BB1_93 Depth=1
