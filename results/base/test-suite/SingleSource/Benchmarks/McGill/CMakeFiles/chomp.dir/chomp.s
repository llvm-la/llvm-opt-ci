...
# %bb.16:
	move	$a5, $a1
	b	.LBB13_26
.LBB13_17:                              # %vector.main.loop.iter.check31
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB13_19
# %bb.18:
	move	$a4, $zero
	b	.LBB13_23
.LBB13_19:                              # %vector.ph32
	andi	$a5, $a3, 12
	move	$a4, $a3
...
.LBB14_11:                              #   in Loop: Header=BB14_8 Depth=2
	...
	b	.LBB14_23
	.p2align	4, , 16
.LBB14_12:                              # %vector.main.loop.iter.check140
                                        #   in Loop: Header=BB14_8 Depth=2
	ori	$a2, $zero, 16
	bgeu	$s8, $a2, .LBB14_14
...
.LBB14_15:                              # %vector.body146
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB14_15
# %bb.16:                               # %middle.block149
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a2, $a0, .LBB14_23
# %bb.17:                               # %vec.epilog.iter.check153
                                        #   in Loop: Header=BB14_8 Depth=2
	beqz	$a3, .LBB14_21
.LBB14_18:                              # %vec.epilog.ph155
                                        #   in Loop: Header=BB14_8 Depth=2
	move	$a4, $a2
	...
	alsl.d	$a4, $a4, $s3, 2
	.p2align	4, , 16
.LBB14_19:                              # %vec.epilog.vector.body160
                                        #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB14_19
# %bb.20:                               # %vec.epilog.middle.block163
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a2, $a0, .LBB14_23
.LBB14_21:                              # %vec.epilog.scalar.ph152.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
	sub.d	$a3, $a0, $a2
	alsl.d	$a2, $a2, $s3, 2
	.p2align	4, , 16
.LBB14_22:                              # %vec.epilog.scalar.ph152
                                        #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a1, $a2, 0
...
# %bb.39:                               # %middle.block
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a1, $s2, .LBB14_42
.LBB14_40:                              # %.lr.ph.i42.preheader168
                                        #   in Loop: Header=BB14_8 Depth=2
	addi.d	$a1, $s1, -4
	alsl.d	$a1, $a0, $a1, 2
	alsl.d	$a2, $a0, $s3, 2
...
.LBB14_41:                              # %.lr.ph.i42
	...
	addi.d	$a2, $a2, -4
	bnez	$a0, .LBB14_41
.LBB14_42:                              # %melt_data.exit.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
	addi.d	$s4, $s2, 1
	addi.d	$a1, $s7, -4
	move	$a0, $s4
...
.LBB14_43:                              # %melt_data.exit
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	beq	$a0, $fp, .LBB14_6
# %bb.44:                               #   in Loop: Header=BB14_43 Depth=3
	ldx.w	$a2, $s3, $a1
	ldx.w	$a3, $s1, $a1
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, -4
...
.LBB14_48:                              # %.preheader
	...
	move	$a3, $s4
	.p2align	4, , 16
.LBB14_49:                              #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        #       Parent Loop BB14_48 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	beq	$a3, $fp, .LBB14_53
# %bb.50:                               #   in Loop: Header=BB14_49 Depth=4
	ld.w	$a5, $a2, 0
	ld.w	$a6, $a4, 0
	addi.d	$a3, $a3, -1
	addi.d	$a4, $a4, -4
...
# %bb.51:                               # %equal_data.exit.i
	...
	blez	$a3, .LBB14_53
# %bb.52:                               #   in Loop: Header=BB14_48 Depth=3
	addi.d	$a1, $a1, 24
	b	.LBB14_48
.LBB14_53:                              # %get_value.exit
	...
	st.w	$a0, $a1, 0
.LBB14_54:                              #   in Loop: Header=BB14_8 Depth=2
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	ld.w	$a1, $a1, 0
	or	$a0, $a1, $a0
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
	bnez	$a0, .LBB14_7
# %bb.55:                               #   in Loop: Header=BB14_8 Depth=2
...
# %bb.56:                               # %.lr.ph.i49
	...
	slli.d	$a1, $a1, 2
	addi.d	$a2, $a2, -4
.LBB14_57:                              #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB14_58 Depth 4
	ld.d	$a4, $a3, 0
...
.LBB14_58:                              #   Parent Loop BB14_4 Depth=1
                                        ...
                                        # =>      This Inner Loop Header: Depth=4
	beq	$a5, $fp, .LBB14_62
# %bb.59:                               #   in Loop: Header=BB14_58 Depth=4
	ld.w	$a7, $a4, 0
	ld.w	$t0, $a6, 0
	addi.d	$a5, $a5, -1
	addi.d	$a6, $a6, -4
...
# %bb.26:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB15_2 Depth=1
	beq	$a1, $a0, .LBB15_2
.LBB15_27:                              # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB15_2 Depth=1
	sub.d	$a0, $a0, $a1
	slli.d	$a1, $a1, 2
	.p2align	4, , 16
.LBB15_28:                              # %vec.epilog.scalar.ph
                                        #   Parent Loop BB15_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.w	$s1, $s0, $a1
	addi.d	$a0, $a0, -1
...
.LBB16_7:                               #   in Loop: Header=BB16_4 Depth=2
	...
	b	.LBB16_20
	.p2align	4, , 16
.LBB16_8:                               # %vector.main.loop.iter.check110
                                        #   in Loop: Header=BB16_4 Depth=2
...
.LBB16_11:                              # %vector.body116
	...
	addi.d	$a4, $a4, 64
	bnez	$a2, .LBB16_11
# %bb.12:                               # %middle.block119
                                        #   in Loop: Header=BB16_4 Depth=2
	move	$a2, $a7
	beq	$s0, $a1, .LBB16_20
# %bb.13:                               # %vec.epilog.iter.check123
                                        #   in Loop: Header=BB16_4 Depth=2
	beqz	$a3, .LBB16_17
.LBB16_14:                              # %vec.epilog.ph125
                                        #   in Loop: Header=BB16_4 Depth=2
	...
	.p2align	4, , 16
.LBB16_15:                              # %vec.epilog.vector.body130
                                        #   Parent Loop BB16_3 Depth=1
                                        #     Parent Loop BB16_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr1, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB16_15
# %bb.16:                               # %vec.epilog.middle.block133
                                        #   in Loop: Header=BB16_4 Depth=2
	move	$a2, $a7
	beq	$s0, $a1, .LBB16_20
.LBB16_17:                              # %vec.epilog.scalar.ph122.preheader
                                        #   in Loop: Header=BB16_4 Depth=2
	alsl.d	$a2, $a1, $a0, 2
	.p2align	4, , 16
.LBB16_18:                              # %vec.epilog.scalar.ph122
                                        #   Parent Loop BB16_3 Depth=1
                                        #     Parent Loop BB16_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$s5, $a2, 0
...
# %bb.36:                               # %middle.block
	...
	beq	$s6, $s3, .LBB16_39
.LBB16_37:                              # %.lr.ph.i28.preheader136
                                        #   in Loop: Header=BB16_4 Depth=2
	addi.d	$a2, $fp, -4
	alsl.d	$a2, $a1, $a2, 2
	alsl.d	$a3, $a1, $a0, 2
...
.LBB16_38:                              # %.lr.ph.i28
	...
	addi.d	$a3, $a3, -4
	bnez	$a1, .LBB16_38
.LBB16_39:                              # %melt_data.exit.loopexit.preheader
                                        #   in Loop: Header=BB16_4 Depth=2
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	move	$a1, $s7
	.p2align	4, , 16
.LBB16_40:                              # %melt_data.exit.loopexit
                                        #   Parent Loop BB16_3 Depth=1
                                        #     Parent Loop BB16_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	beq	$a1, $s1, .LBB16_45
...
# %bb.42:                               # %equal_data.exit
                                        #   in Loop: Header=BB16_4 Depth=2
	blez	$a1, .LBB16_45
# %bb.43:                               #   in Loop: Header=BB16_4 Depth=2
	move	$s2, $a0
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
.LBB16_46:                              # %._crit_edge
	...
	addi.w	$s8, $s8, 1
	bne	$s8, $s5, .LBB16_3
# %bb.47:                               # %._crit_edge46.loopexit47
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $a0, 8
	b	.LBB16_49
.LBB16_48:
	move	$fp, $zero
.LBB16_49:                              # %._crit_edge46
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
# %bb.12:                               # %vec.epilog.middle.block
	beq	$a0, $s5, .LBB21_15
.LBB21_13:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a1, $s5, $a0
	alsl.d	$a0, $a0, $s0, 2
	.p2align	4, , 16
.LBB21_14:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s2, $a0, 0
	addi.d	$a1, $a1, -1
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB21_14
.LBB21_15:                              # %.lr.ph.preheader
	ori	$s6, $zero, 1
...
.LBB21_27:                              # %.preheader
	...
	move	$a6, $a1
	.p2align	4, , 16
.LBB21_28:                              #   Parent Loop BB21_16 Depth=1
                                        #     Parent Loop BB21_25 Depth=2
...
# %bb.30:                               # %equal_data.exit.i.i
	...
	blez	$a6, .LBB21_24
# %bb.31:                               #   in Loop: Header=BB21_27 Depth=3
	addi.d	$a4, $a4, 24
	b	.LBB21_27
	.p2align	4, , 16
.LBB21_32:                              # %.critedge.i
...
.LBB21_34:                              # %get_good_move.exit
                                        #   in Loop: Header=BB21_16 Depth=1
	beqz	$s3, .LBB21_38
# %bb.35:                               # %.preheader37.preheader
                                        #   in Loop: Header=BB21_16 Depth=1
	move	$a0, $zero
	addi.d	$a3, $zero, -1
	.p2align	4, , 16
.LBB21_36:                              # %.preheader37
                                        #   Parent Loop BB21_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $s3, $a0
	ldx.w	$a1, $s0, $a0
	...
	addi.d	$a0, $a0, 4
	beq	$a2, $a1, .LBB21_36
# %bb.37:                               # %get_good_move.exit.thread
                                        #   in Loop: Header=BB21_16 Depth=1
	move	$a0, $s1
	move	$a1, $s2
	pcaddu18i	$ra, %call36(printf)
