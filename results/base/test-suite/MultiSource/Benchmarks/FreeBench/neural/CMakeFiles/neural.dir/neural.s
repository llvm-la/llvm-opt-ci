...
# %bb.46:                               # %middle.block137
	...
	move	$t8, $a5
	beq	$a5, $a4, .LBB0_34
.LBB0_47:                               # %.lr.ph.i18.us.us.i.preheader232
                                        #   in Loop: Header=BB0_35 Depth=2
	sub.d	$t7, $a4, $t8
	alsl.d	$t4, $t8, $t4, 2
	alsl.d	$t8, $t8, $t1, 2
...
# %bb.93:                               # %middle.block179
	...
	maskeqz	$a4, $s6, $a4
	beq	$a3, $a0, .LBB0_100
# %bb.94:                               # %vec.epilog.iter.check184
                                        #   in Loop: Header=BB0_83 Depth=2
	beqz	$a5, .LBB0_98
.LBB0_95:                               # %vec.epilog.ph186
                                        #   in Loop: Header=BB0_83 Depth=2
	move	$a7, $a3
	xor	$a3, $a4, $s6
	sltu	$a4, $zero, $a3
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_96:                               # %vec.epilog.vector.body191
                                        #   Parent Loop BB0_79 Depth=1
                                        #     Parent Loop BB0_83 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr1, $a7, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB0_96
# %bb.97:                               # %vec.epilog.middle.block197
                                        #   in Loop: Header=BB0_83 Depth=2
	vslli.w	$vr0, $vr0, 31
	vmskltz.w	$vr0, $vr0
	vpickve2gr.hu	$a4, $vr0, 0
