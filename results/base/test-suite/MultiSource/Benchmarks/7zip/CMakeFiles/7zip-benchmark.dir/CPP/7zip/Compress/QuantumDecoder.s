...
# %bb.17:                               # %iter.check129
	bstrpick.d	$a4, $a5, 31, 0
	bltu	$a3, $a6, .LBB0_20
# %bb.18:                               # %vector.memcheck120
	addi.d	$a6, $a0, 1620
	add.d	$a7, $a0, $a4
	addi.d	$t0, $a7, 1750
	addi.d	$a7, $a0, 1750
	bgeu	$a6, $t0, .LBB0_30
# %bb.19:                               # %vector.memcheck120
	alsl.d	$t0, $a4, $a0, 1
	addi.d	$t0, $t0, 1620
	bgeu	$a7, $t0, .LBB0_30
.LBB0_20:
	move	$a3, $zero
.LBB0_21:                               # %vec.epilog.scalar.ph147.preheader
	slli.d	$a2, $a3, 1
	addi.d	$a2, $a2, 1620
	sub.d	$a5, $a5, $a3
	.p2align	4, , 16
.LBB0_22:                               # %vec.epilog.scalar.ph147
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$a5, $a0, $a2
	add.d	$a6, $a0, $a3
	st.b	$a3, $a6, 1750
...
# %bb.29:
	move	$a6, $zero
	b	.LBB0_36
.LBB0_30:                               # %vector.main.loop.iter.check131
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_39
# %bb.31:
	move	$a3, $zero
...
.LBB0_40:                               # %vector.body137
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_40
# %bb.41:                               # %middle.block144
	beq	$a3, $a4, .LBB0_24
# %bb.42:                               # %vec.epilog.iter.check148
	beqz	$t0, .LBB0_21
.LBB0_43:                               # %vec.epilog.ph150
	move	$a7, $a3
	...
	addi.d	$a7, $a7, 1620
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body161
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr3, $vr0, $vr1
	vpickev.h	$vr3, $vr3, $vr3
	vstelm.d	$vr3, $a7, 0, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$a2, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block168
	beq	$a3, $a4, .LBB0_24
	b	.LBB0_21
.Lfunc_end0:
...
.LBB2_42:
	move	$a5, $a3
.LBB2_43:                               # %vec.epilog.scalar.ph133.preheader
	addi.d	$a1, $a5, 1
	alsl.d	$a2, $a5, $fp, 1
	addi.d	$a2, $a2, 8
	.p2align	4, , 16
.LBB2_44:                               # %vec.epilog.scalar.ph133
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a2, 0
...
.LBB2_45:                               # %.loopexit
	...
	addi.d	$sp, $sp, 48
	ret
.LBB2_46:                               # %vector.main.loop.iter.check118
	ori	$a4, $zero, 15
	addi.d	$a1, $a3, 1
	bgeu	$a3, $a4, .LBB2_51
# %bb.47:
	move	$a4, $zero
.LBB2_48:                               # %vec.epilog.ph136
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_49:                               # %vec.epilog.vector.body139
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, -16
	bnez	$a7, .LBB2_49
# %bb.50:                               # %vec.epilog.middle.block148
	bne	$a1, $a6, .LBB2_43
	b	.LBB2_45
.LBB2_51:                               # %vector.ph119
	andi	$a5, $a1, 8
...
.LBB2_52:                               # %vector.body122
	...
	addi.d	$a6, $a6, -32
	bnez	$t0, .LBB2_52
# %bb.53:                               # %middle.block130
	beq	$a1, $a4, .LBB2_45
# %bb.54:                               # %vec.epilog.iter.check134
	bnez	$a5, .LBB2_48
# %bb.55:
	sub.d	$a5, $a3, $a4
	b	.LBB2_43
