...
.LBB29_51:                              # %vec.epilog.ph652
	...
	add.d	$t7, $a7, $t7
	.p2align	4, , 16
.LBB29_52:                              # %vec.epilog.vector.body655
                                        #   Parent Loop BB29_40 Depth=1
                                        #     Parent Loop BB29_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t7, 0
	...
	addi.d	$t7, $t7, -16
	bnez	$a6, .LBB29_52
# %bb.53:                               # %vec.epilog.middle.block661
                                        #   in Loop: Header=BB29_41 Depth=2
	bne	$ra, $t6, .LBB29_59
	b	.LBB29_61
...
.LBB29_55:                              # %vector.body641
	...
	addi.d	$a6, $a6, -32
	bnez	$t6, .LBB29_55
# %bb.56:                               # %middle.block646
                                        #   in Loop: Header=BB29_41 Depth=2
	beq	$ra, $t7, .LBB29_61
# %bb.57:                               # %vec.epilog.iter.check650
                                        #   in Loop: Header=BB29_41 Depth=2
	bnez	$s4, .LBB29_51
...
.LBB29_65:                              # %._crit_edge
	...
	ori	$a6, $zero, 254
	bltu	$s4, $a6, .LBB29_67
# %bb.66:                               #   in Loop: Header=BB29_40 Depth=1
	addi.w	$t6, $a0, 1
...
.LBB29_96:                              #   in Loop: Header=BB29_86 Depth=2
	...
	blt	$t6, $s8, .LBB29_95
	.p2align	4, , 16
.LBB29_97:                              # %vector.main.loop.iter.check796
                                        #   in Loop: Header=BB29_86 Depth=2
...
.LBB29_100:                             # %vector.body804
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB29_100
# %bb.101:                              # %middle.block809
                                        #   in Loop: Header=BB29_86 Depth=2
	beq	$s0, $t8, .LBB29_85
# %bb.102:                              # %vec.epilog.iter.check813
                                        #   in Loop: Header=BB29_86 Depth=2
	move	$t0, $s0
	move	$t1, $s0
	beqz	$ra, .LBB29_106
.LBB29_103:                             # %vec.epilog.ph815
                                        #   in Loop: Header=BB29_86 Depth=2
	xvld	$xr2, $a7, %pc_lo12(.LCPI29_7)
	xvreplgr2vr.d	$xr3, $t0
	xvor.v	$xr2, $xr3, $xr2
	.p2align	4, , 16
.LBB29_104:                             # %vec.epilog.vector.body825
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_86 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvslt.d	$xr3, $xr2, $xr0
...
# %bb.105:                              # %vec.epilog.middle.block830
	...
	beq	$t3, $t8, .LBB29_85
	.p2align	4, , 16
.LBB29_106:                             # %vec.epilog.scalar.ph812
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_86 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	slt	$a7, $t1, $a4
...
# %bb.118:                              #   in Loop: Header=BB29_117 Depth=4
	...
	b	.LBB29_122
	.p2align	4, , 16
.LBB29_119:                             # %vector.body779.preheader
...
# %bb.121:                              # %middle.block786
	...
	addi.d	$t7, $sp, 312
	beq	$a4, $a7, .LBB29_124
.LBB29_122:                             # %scalar.ph774.preheader
                                        #   in Loop: Header=BB29_117 Depth=4
	alsl.d	$t5, $t4, $t7, 2
	.p2align	4, , 16
.LBB29_123:                             # %scalar.ph774
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_109 Depth=2
                                        #       Parent Loop BB29_110 Depth=3
                                        #         Parent Loop BB29_117 Depth=4
...
# %bb.132:                              #   in Loop: Header=BB29_131 Depth=3
	...
	b	.LBB29_152
	.p2align	4, , 16
.LBB29_133:                             # %vector.body753.preheader
                                        #   in Loop: Header=BB29_131 Depth=3
	...
	b	.LBB29_135
	.p2align	4, , 16
.LBB29_134:                             # %pred.store.continue769
                                        #   in Loop: Header=BB29_135 Depth=4
	addi.d	$a0, $a0, -8
	addi.d	$a1, $a1, 32
	beqz	$a0, .LBB29_151
.LBB29_135:                             # %vector.body753
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_109 Depth=2
...
# %bb.136:                              # %pred.store.if
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_144
.LBB29_137:                             # %pred.store.continue757
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_145
.LBB29_138:                             # %pred.store.if758
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 8
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_146
.LBB29_139:                             # %pred.store.continue761
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 4
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_147
.LBB29_140:                             # %pred.store.if762
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 16
	xvpickve2gr.w	$a2, $xr0, 5
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_148
.LBB29_141:                             # %pred.store.continue765
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 6
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_149
.LBB29_142:                             # %pred.store.if766
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 24
...
.LBB29_143:                             # %pred.store.continue
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_137
.LBB29_144:                             # %pred.store.if756
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_138
.LBB29_145:                             # %pred.store.continue759
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_139
.LBB29_146:                             # %pred.store.if760
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 12
	xvpickve2gr.w	$a2, $xr0, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_140
.LBB29_147:                             # %pred.store.continue763
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_141
.LBB29_148:                             # %pred.store.if764
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 20
	xvpickve2gr.w	$a2, $xr0, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_142
.LBB29_149:                             # %pred.store.continue767
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_134
.LBB29_150:                             # %pred.store.if768
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 28
	b	.LBB29_134
	.p2align	4, , 16
.LBB29_151:                             # %middle.block771
                                        #   in Loop: Header=BB29_131 Depth=3
	ld.d	$a0, $sp, 280                   # 8-byte Folded Reload
	move	$a1, $a0
	beq	$a0, $a3, .LBB29_130
...
# %bb.157:                              #   in Loop: Header=BB29_74 Depth=1
	...
	b	.LBB29_167
	.p2align	4, , 16
.LBB29_158:                             # %vector.main.loop.iter.check725
                                        #   in Loop: Header=BB29_74 Depth=1
	addi.d	$t7, $sp, 512
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 160                   # 8-byte Folded Reload
...
.LBB29_161:                             # %vector.body729
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB29_161
# %bb.162:                              # %middle.block732
                                        #   in Loop: Header=BB29_74 Depth=1
	ld.d	$t8, $sp, 288                   # 8-byte Folded Reload
	addi.d	$a3, $sp, 312
	beq	$a0, $s0, .LBB29_168
# %bb.163:                              # %vec.epilog.iter.check736
                                        #   in Loop: Header=BB29_74 Depth=1
	beqz	$a1, .LBB29_167
.LBB29_164:                             # %vec.epilog.ph738
                                        #   in Loop: Header=BB29_74 Depth=1
	move	$a2, $a0
	...
	add.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB29_165:                             # %vec.epilog.vector.body741
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a2, 0
	vaddi.bu	$vr0, $vr0, 16
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB29_165
# %bb.166:                              # %vec.epilog.middle.block746
                                        #   in Loop: Header=BB29_74 Depth=1
	addi.d	$a3, $sp, 312
	beq	$a0, $s0, .LBB29_168
	.p2align	4, , 16
.LBB29_167:                             # %vec.epilog.scalar.ph735
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.b	$a0, $a0, $a3
	addi.d	$a0, $a0, 1
...
# %bb.185:                              #   in Loop: Header=BB29_184 Depth=4
	...
	b	.LBB29_183
	.p2align	4, , 16
.LBB29_186:                             # %vector.main.loop.iter.check691
                                        #   in Loop: Header=BB29_170 Depth=2
	ori	$a3, $zero, 32
	bgeu	$a2, $a3, .LBB29_192
# %bb.187:                              #   in Loop: Header=BB29_170 Depth=2
	move	$a4, $zero
.LBB29_188:                             # %vec.epilog.ph707
                                        #   in Loop: Header=BB29_170 Depth=2
	...
	add.d	$a4, $t5, $a4
	.p2align	4, , 16
.LBB29_189:                             # %vec.epilog.vector.body710
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_170 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, -16
	bnez	$a6, .LBB29_189
# %bb.190:                              # %vec.epilog.middle.block717
                                        #   in Loop: Header=BB29_170 Depth=2
	addi.d	$a4, $sp, 312
	beq	$a5, $a2, .LBB29_169
	.p2align	4, , 16
...
.LBB29_193:                             # %vector.body695
	...
	addi.d	$a5, $a5, -32
	bnez	$a6, .LBB29_193
# %bb.194:                              # %middle.block701
                                        #   in Loop: Header=BB29_170 Depth=2
	beq	$a4, $a2, .LBB29_169
# %bb.195:                              # %vec.epilog.iter.check705
                                        #   in Loop: Header=BB29_170 Depth=2
	bnez	$a3, .LBB29_188
...
# %bb.215:                              #   in Loop: Header=BB29_214 Depth=5
	...
	b	.LBB29_213
	.p2align	4, , 16
.LBB29_216:                             # %.preheader613.preheader
                                        #   in Loop: Header=BB29_207 Depth=4
	ori	$t0, $zero, 1
	ori	$a7, $zero, 1
	b	.LBB29_218
