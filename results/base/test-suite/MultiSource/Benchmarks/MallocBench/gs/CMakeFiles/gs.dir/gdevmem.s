...
.LBB11_37:                              # %vector.body425
	...
	addi.d	$a6, $a6, 32
	bne	$ra, $a6, .LBB11_37
# %bb.38:                               # %middle.block432
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a6, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 48                    # 8-byte Folded Reload
	bne	$ra, $s3, .LBB11_27
	b	.LBB11_32
.LBB11_39:                              # %vector.memcheck437
                                        #   in Loop: Header=BB11_23 Depth=1
	addi.d	$a6, $s5, 1
...
.LBB11_51:                              # %.lr.ph.us
	...
	move	$fp, $s3
	b	.LBB11_53
.LBB11_52:                              #   in Loop: Header=BB11_48 Depth=1
	ld.bu	$a5, $t1, 0
	srl.w	$a5, $a5, $s0
	move	$s7, $t1
.LBB11_53:                              # %.lr.ph.us
	...
	ori	$a5, $zero, 248
	beqz	$t3, .LBB11_59
# %bb.54:                               # %.lr.ph.split.us.us.preheader
                                        #   in Loop: Header=BB11_48 Depth=1
	bltu	$a7, $a5, .LBB11_57
...
.LBB11_58:                              # %.lr.ph.split.us.us
	...
	blt	$a1, $s7, .LBB11_58
	b	.LBB11_64
.LBB11_59:                              # %.lr.ph.split.us253.preheader
                                        #   in Loop: Header=BB11_48 Depth=1
	bltu	$a7, $a5, .LBB11_62
# %bb.60:                               # %vector.memcheck374
                                        #   in Loop: Header=BB11_48 Depth=1
	add.d	$a5, $s7, $fp
	bgeu	$s6, $a5, .LBB11_70
# %bb.61:                               # %vector.memcheck374
                                        #   in Loop: Header=BB11_48 Depth=1
	add.d	$a5, $s5, $fp
	bgeu	$s7, $a5, .LBB11_70
...
.LBB11_63:                              # %.lr.ph.split.us253
	...
	addi.d	$a5, $a5, 1
	blt	$a1, $ra, .LBB11_63
.LBB11_64:                              # %._crit_edge.us
                                        #   in Loop: Header=BB11_48 Depth=1
	blez	$s6, .LBB11_47
# %bb.65:                               #   in Loop: Header=BB11_48 Depth=1
	ld.bu	$fp, $s5, 0
	sll.w	$s7, $fp, $s1
	bge	$s0, $s6, .LBB11_46
# %bb.66:                               #   in Loop: Header=BB11_48 Depth=1
	ld.bu	$fp, $s5, 1
	srl.w	$fp, $fp, $s0
	add.d	$s7, $fp, $s7
	b	.LBB11_46
...
.LBB11_73:
	move	$a5, $zero
.LBB11_74:                              # %mem_copy_mono_recover.exit.thread
	move	$a0, $a5
.LBB11_75:                              # %mem_copy_mono_recover.exit.thread
	ld.d	$s8, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 112                   # 8-byte Folded Reload
	...
	addi.d	$sp, $sp, 176
	ret
.LBB11_76:                              # %.lr.ph244.split
	blez	$t2, .LBB11_85
# %bb.77:                               # %.lr.ph244.split.split.us.preheader
	alsl.d	$a1, $s3, $a5, 3
	addi.d	$a1, $a1, 8
	b	.LBB11_79
.LBB11_78:                              #   in Loop: Header=BB11_79 Depth=1
	...
	addi.d	$a1, $a1, 8
	blez	$a7, .LBB11_74
.LBB11_79:                              # %.lr.ph244.split.split.us
                                        # =>This Inner Loop Header: Depth=1
	bgeu	$s2, $s4, .LBB11_82
...
# %bb.81:                               #   in Loop: Header=BB11_79 Depth=1
	...
	add.d	$t6, $t7, $t6
	b	.LBB11_83
.LBB11_82:                              #   in Loop: Header=BB11_79 Depth=1
	ld.bu	$a5, $t1, 0
	srl.w	$t6, $a5, $s0
	move	$a5, $t1
.LBB11_83:                              #   in Loop: Header=BB11_79 Depth=1
	ld.b	$t7, $s5, 0
	xor	$t6, $t6, $a2
	or	$t8, $a4, $t6
	and	$t7, $t8, $t7
...
# %bb.84:                               #   in Loop: Header=BB11_79 Depth=1
	...
	add.d	$t6, $a5, $t6
	b	.LBB11_78
.LBB11_85:                              # %.lr.ph244.split.split
	bgeu	$s2, $s4, .LBB11_89
# %bb.86:                               # %.lr.ph244.split.split.split.us
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	bgeu	$t2, $a6, .LBB11_92
# %bb.87:                               # %.lr.ph244.split.split.split.us.split.us.preheader
	alsl.d	$a5, $s3, $a5, 3
	addi.d	$a6, $a5, 8
	add.d	$a1, $s7, $a1
	addi.d	$a1, $a1, 1
.LBB11_88:                              # %.lr.ph244.split.split.split.us.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a5, $a1, -1
	ld.bu	$t1, $a1, 0
	sll.w	$a5, $a5, $s1
	...
	bnez	$a7, .LBB11_88
	b	.LBB11_74
.LBB11_89:                              # %.lr.ph244.split.split.split
	alsl.d	$a1, $s3, $a5, 3
	addi.d	$a1, $a1, 8
	beqz	$t3, .LBB11_91
.LBB11_90:                              # %.lr.ph244.split.split.split.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a5, $t1, 0
	ld.b	$a6, $s5, 0
	srl.w	$a5, $a5, $s0
	...
	bnez	$a7, .LBB11_90
	b	.LBB11_74
.LBB11_91:                              # %.lr.ph244.split.split.split.split
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a5, $t1, 0
	ld.b	$a6, $s5, 0
	srl.w	$a5, $a5, $s0
	...
	bnez	$a7, .LBB11_91
	b	.LBB11_74
.LBB11_92:                              # %.lr.ph244.split.split.split.us.split
	alsl.d	$a1, $s3, $a5, 3
	addi.d	$a1, $a1, 8
	beqz	$t3, .LBB11_94
.LBB11_93:                              # %.lr.ph244.split.split.split.us.split.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a5, $t1, 0
	ld.b	$a6, $s5, 0
	sll.w	$a5, $a5, $s1
	...
	bnez	$a7, .LBB11_93
	b	.LBB11_74
.LBB11_94:                              # %.lr.ph244.split.split.split.us.split.split
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a5, $t1, 0
	ld.b	$a6, $s5, 0
	sll.w	$a5, $a5, $s1
