...
# %bb.13:                               # %pred.store.continue
	...
	andi	$a1, $a1, 1
	bnez	$a1, .LBB7_63
.LBB7_14:                               # %pred.store.continue188
	xvpickve2gr.d	$a1, $xr0, 2
	andi	$a1, $a1, 1
	bnez	$a1, .LBB7_64
.LBB7_15:                               # %pred.store.continue190
	xvpickve2gr.d	$a1, $xr0, 3
	andi	$a1, $a1, 1
	beqz	$a1, .LBB7_17
.LBB7_16:                               # %pred.store.if191
	ori	$a1, $zero, 3
	st.w	$a1, $a0, 16
.LBB7_17:                               # %pred.store.continue192
	pcalau12i	$a1, %pc_hi20(.LCPI7_0)
...
.LBB7_30:
	move	$a5, $zero
	move	$a4, $a3
.LBB7_31:                               # %.lr.ph.i49.preheader353
	vld	$vr0, $a6, %pc_lo12(.LCPI7_2)
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB7_32:                               # %.lr.ph.i49
...
.LBB7_35:                               # %vector.body214
	...
	addi.d	$a7, $a7, 2
	bnez	$t1, .LBB7_35
# %bb.36:                               # %middle.block221
	bne	$a0, $a5, .LBB7_38
	b	.LBB7_40
.LBB7_37:
	move	$a5, $zero
	move	$a3, $a4
.LBB7_38:                               # %.lr.ph.i53.preheader351
	vld	$vr0, $a6, %pc_lo12(.LCPI7_3)
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB7_39:                               # %.lr.ph.i53
...
.LBB7_42:                               # %vector.body230
	...
	addi.d	$a7, $a7, 2
	bnez	$t1, .LBB7_42
# %bb.43:                               # %middle.block237
	bne	$a0, $a5, .LBB7_45
	b	.LBB7_47
.LBB7_44:
	move	$a5, $zero
	move	$a4, $a3
.LBB7_45:                               # %.lr.ph.i60.preheader348
	vld	$vr0, $a6, %pc_lo12(.LCPI7_4)
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB7_46:                               # %.lr.ph.i60
...
.LBB7_51:                               # %vector.body245
	...
	addi.d	$a6, $a6, 2
	bnez	$t0, .LBB7_51
# %bb.52:                               # %middle.block252
	beq	$a5, $s0, .LBB7_55
# %bb.53:                               # %.lr.ph.i.i65.preheader362
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB7_54:                               # %.lr.ph.i.i65
                                        # =>This Inner Loop Header: Depth=1
...
.LBB7_62:                               # %pred.store.if
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB7_14
.LBB7_63:                               # %pred.store.if187
	ori	$a1, $zero, 1
	st.w	$a1, $a0, 8
	xvpickve2gr.d	$a1, $xr0, 2
	andi	$a1, $a1, 1
	beqz	$a1, .LBB7_15
.LBB7_64:                               # %pred.store.if189
	ori	$a1, $zero, 2
	st.w	$a1, $a0, 12
	xvpickve2gr.d	$a1, $xr0, 3
	andi	$a1, $a1, 1
...
.LBB7_75:
	move	$a2, $zero
	move	$a1, $a3
.LBB7_76:                               # %.lr.ph.i79.preheader346
	vld	$vr0, $a4, %pc_lo12(.LCPI7_8)
	ori	$a0, $zero, 1
	.p2align	4, , 16
.LBB7_77:                               # %.lr.ph.i79
