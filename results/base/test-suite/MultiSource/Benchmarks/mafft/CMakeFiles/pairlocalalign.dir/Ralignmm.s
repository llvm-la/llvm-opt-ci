...
.LBB2_227:                              # %.lr.ph19.i538
	...
	addi.d	$t4, $t4, -1
	bnez	$t3, .LBB2_227
.LBB2_228:                              # %._crit_edge20.loopexit.i539
                                        #   in Loop: Header=BB2_205 Depth=1
	add.d	$a5, $s7, $a5
	add.d	$a5, $t2, $a5
	move	$s8, $t5
...
.LBB2_229:                              #   in Loop: Header=BB2_205 Depth=1
	...
	move	$t2, $s5
	blez	$a7, .LBB2_233
.LBB2_230:                              # %._crit_edge30.i544
                                        #   in Loop: Header=BB2_205 Depth=1
	blez	$t0, .LBB2_233
# %bb.231:                              #   in Loop: Header=BB2_205 Depth=1
	add.d	$s6, $t1, $s6
	addi.d	$s8, $t3, -1
	st.b	$a1, $t3, -1
	addi.d	$s5, $t2, -1
...
.LBB2_233:
	...
	ld.d	$s6, $sp, 120                   # 8-byte Folded Reload
	blez	$s6, .LBB2_236
.LBB2_234:                              # %.lr.ph50.preheader.i556
	ld.d	$fp, $sp, 112                   # 8-byte Folded Reload
	move	$s0, $s6
	.p2align	4, , 16
.LBB2_235:                              # %.lr.ph50.i558
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s3, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s3, $s3, 8
	bnez	$s0, .LBB2_235
.LBB2_236:                              # %.preheader.i549
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 128                   # 8-byte Folded Reload
	blez	$s1, .LBB2_287
# %bb.237:                              # %.lr.ph52.preheader.i550
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB2_238:                              # %.lr.ph52.i552
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s4, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s5
...
.LBB2_240:                              # %vector.body1002
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB2_240
# %bb.241:                              # %middle.block1008
	beq	$a4, $a5, .LBB2_248
# %bb.242:                              # %vec.epilog.iter.check1012
	beqz	$a7, .LBB2_246
.LBB2_243:                              # %vec.epilog.ph1014
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_244:                              # %vec.epilog.vector.body1019
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB2_244
# %bb.245:                              # %vec.epilog.middle.block1024
	beq	$a4, $a5, .LBB2_248
.LBB2_246:                              # %vec.epilog.scalar.ph1011.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_247:                              # %vec.epilog.scalar.ph1011
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB2_250:                              # %.lr.ph41.i
	...
	ldx.w	$t4, $t1, $t6
	bltz	$t4, .LBB2_253
# %bb.251:                              #   in Loop: Header=BB2_250 Depth=1
	beqz	$t4, .LBB2_264
# %bb.252:                              #   in Loop: Header=BB2_250 Depth=1
	sub.d	$t1, $s7, $t4
	b	.LBB2_265
	.p2align	4, , 16
.LBB2_253:                              #   in Loop: Header=BB2_250 Depth=1
	addi.d	$t1, $s7, -1
	nor	$t7, $t1, $zero
	add.w	$t8, $s7, $t7
	bnez	$t8, .LBB2_266
	.p2align	4, , 16
.LBB2_254:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_250 Depth=1
	beq	$t4, $a1, .LBB2_274
.LBB2_255:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_250 Depth=1
	addi.w	$t7, $zero, -17
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB2_260
# %bb.256:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_250 Depth=1
	sub.d	$t7, $s8, $s5
	bltu	$t7, $a5, .LBB2_260
# %bb.257:                              # %vector.ph1033
                                        #   in Loop: Header=BB2_250 Depth=1
...
.LBB2_262:                              # %.lr.ph29.i
	...
	addi.d	$t7, $t7, -1
	bnez	$fp, .LBB2_262
.LBB2_263:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_250 Depth=1
	ld.d	$fp, $sp, 472                   # 8-byte Folded Reload
	bne	$t2, $fp, .LBB2_275
	b	.LBB2_277
	.p2align	4, , 16
.LBB2_264:                              #   in Loop: Header=BB2_250 Depth=1
	addi.d	$t1, $s7, -1
.LBB2_265:                              #   in Loop: Header=BB2_250 Depth=1
	move	$t4, $a1
	nor	$t7, $t1, $zero
	add.w	$t8, $s7, $t7
	beqz	$t8, .LBB2_254
.LBB2_266:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_250 Depth=1
	bltu	$t8, $a6, .LBB2_271
...
.LBB2_272:                              # %.lr.ph19.i
	...
	addi.d	$fp, $fp, -1
	bnez	$t8, .LBB2_272
.LBB2_273:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB2_250 Depth=1
	add.d	$t0, $s7, $t0
	add.d	$t0, $t7, $t0
	move	$s8, $s0
...
.LBB2_274:                              #   in Loop: Header=BB2_250 Depth=1
	...
	ld.d	$fp, $sp, 472                   # 8-byte Folded Reload
	beq	$t2, $fp, .LBB2_277
.LBB2_275:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_250 Depth=1
	addi.w	$fp, $s6, 0
	beq	$t3, $fp, .LBB2_277
# %bb.276:                              #   in Loop: Header=BB2_250 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a2, 0
.LBB2_277:                              #   in Loop: Header=BB2_250 Depth=1
	blez	$t2, .LBB2_281
# %bb.278:                              #   in Loop: Header=BB2_250 Depth=1
	blez	$t3, .LBB2_281
# %bb.279:                              #   in Loop: Header=BB2_250 Depth=1
	add.d	$a7, $t4, $a7
	addi.d	$s8, $t8, -1
	st.b	$a3, $t8, -1
	addi.d	$s5, $t7, -1
...
.LBB2_283:                              # %.lr.ph50.i
	...
	addi.d	$s3, $s3, 8
	bnez	$s0, .LBB2_283
.LBB2_284:                              # %.preheader.i
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 128                   # 8-byte Folded Reload
	blez	$s1, .LBB2_287
# %bb.285:                              # %.lr.ph52.preheader.i
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB2_286:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB2_286
.LBB2_287:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 432                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 424                   # 8-byte Folded Reload
	...
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	blt	$a2, $a3, .LBB2_289
# %bb.288:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	blt	$a3, $a0, .LBB2_290
.LBB2_289:
