...
.LBB6_7:                                # %pred.load.continue12
	...
	andi	$t1, $t1, 1
	beqz	$t1, .LBB6_9
.LBB6_8:                                # %pred.load.if13
                                        #   in Loop: Header=BB6_3 Depth=1
	xvpickve2gr.d	$t2, $xr9, 3
	slli.d	$t2, $t2, 3
	ldx.d	$t2, $a0, $t2
	xvinsgr2vr.d	$xr7, $t2, 3
.LBB6_9:                                # %pred.load.continue14
                                        #   in Loop: Header=BB6_3 Depth=1
	...
	add.d	$t2, $a0, $a3
                                        # implicit-def: $xr9
	beqz	$t3, .LBB6_15
# %bb.10:                               # %pred.load.if15
                                        #   in Loop: Header=BB6_3 Depth=1
	ldptr.d	$t4, $t2, 3176
	vinsgr2vr.d	$vr9, $t4, 0
	bnez	$a7, .LBB6_16
.LBB6_11:                               # %pred.load.continue18
                                        #   in Loop: Header=BB6_3 Depth=1
	beqz	$t0, .LBB6_17
.LBB6_12:                               # %pred.load.if19
                                        #   in Loop: Header=BB6_3 Depth=1
	ldptr.d	$t4, $t2, 3192
...
.LBB9_3:                                # %vector.body
	...
	xvsadd.du	$xr6, $xr4, $xr1
	xvslt.du	$xr6, $xr6, $xr3
	xvpermi.q	$xr7, $xr6, 1
	vpickev.w	$vr6, $vr7, $vr6
	xvsadd.du	$xr4, $xr4, $xr2
	xvslt.du	$xr4, $xr4, $xr3
	xvpermi.q	$xr7, $xr4, 1
	vpickev.w	$vr4, $vr7, $vr4
	xvpermi.q	$xr4, $xr6, 2
	xvpermi.d	$xr6, $xr4, 78
	xvpickev.h	$xr7, $xr6, $xr4
...
.LBB11_6:                               # %vector.body5
	...
	xvsadd.du	$xr3, $xr3, $xr8
	xvslt.du	$xr6, $xr3, $xr9
...
.LBB11_16:                              # %pred.load.continue22
	...
	xvand.v	$xr6, $xr3, $xr11
	xvor.v	$xr4, $xr6, $xr4
	xvsrli.d	$xr4, $xr4, 1
	xvxor.v	$xr4, $xr4, $xr5
	xvand.v	$xr5, $xr3, $xr12
	xvseqi.d	$xr5, $xr5, 0
	xvandn.v	$xr5, $xr5, $xr13
	xvxor.v	$xr4, $xr4, $xr5
	bnez	$a6, .LBB11_26
...
.LBB11_35:                              #   in Loop: Header=BB11_1 Depth=1
	...
	xvst	$xr13, $sp, 48                  # 32-byte Folded Spill
...
.LBB19_3:                               # %vector.body
	...
	vpickve2gr.h	$a4, $vr9, 0
	vinsgr2vr.h	$vr6, $a4, 4
	vpickve2gr.h	$a4, $vr9, 2
	vinsgr2vr.h	$vr6, $a4, 5
	vpickve2gr.h	$a4, $vr9, 4
	vinsgr2vr.h	$vr6, $a4, 6
	vpickve2gr.h	$a4, $vr9, 6
	...
	xvpermi.q	$xr10, $xr9, 1
	vpickev.w	$vr9, $vr10, $vr9
	xvsadd.du	$xr8, $xr8, $xr4
	xvslt.du	$xr8, $xr8, $xr5
...
.LBB43_12:                              # %pred.load.continue21
                                        #   in Loop: Header=BB43_3 Depth=1
	vpickve2gr.b	$t6, $vr9, 9
	andi	$t7, $t6, 1
	bnez	$t7, .LBB43_28
.LBB43_13:                              # %pred.load.continue23
                                        #   in Loop: Header=BB43_3 Depth=1
	vpickve2gr.b	$t7, $vr9, 10
	andi	$t8, $t7, 1
	bnez	$t8, .LBB43_29
.LBB43_14:                              # %pred.load.continue25
                                        #   in Loop: Header=BB43_3 Depth=1
	vpickve2gr.b	$t8, $vr9, 11
	andi	$fp, $t8, 1
	bnez	$fp, .LBB43_30
