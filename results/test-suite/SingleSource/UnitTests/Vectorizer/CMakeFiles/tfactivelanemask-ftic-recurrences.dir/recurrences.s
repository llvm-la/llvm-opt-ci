...
.LBB4_7:                                # %pred.load.continue12
	...
	andi	$t1, $t1, 1
	beqz	$t1, .LBB4_9
.LBB4_8:                                # %pred.load.if13
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpickve2gr.d	$t2, $xr9, 3
	slli.d	$t2, $t2, 3
	ldx.d	$t2, $a0, $t2
	xvinsgr2vr.d	$xr7, $t2, 3
.LBB4_9:                                # %pred.load.continue14
                                        #   in Loop: Header=BB4_3 Depth=1
...
# %bb.10:                               # %pred.load.if15
	...
	bnez	$a7, .LBB4_16
.LBB4_11:                               # %pred.load.continue18
                                        #   in Loop: Header=BB4_3 Depth=1
	beqz	$t0, .LBB4_17
.LBB4_12:                               # %pred.load.if19
                                        #   in Loop: Header=BB4_3 Depth=1
	ldptr.d	$t4, $t2, 3192
	...
	b	.LBB4_19
	.p2align	4, , 16
.LBB4_13:                               # %pred.load.continue10
                                        #   in Loop: Header=BB4_3 Depth=1
	vpickve2gr.w	$t0, $vr10, 2
	andi	$t0, $t0, 1
	beqz	$t0, .LBB4_7
.LBB4_14:                               # %pred.load.if11
                                        #   in Loop: Header=BB4_3 Depth=1
	...
	b	.LBB4_8
	.p2align	4, , 16
.LBB4_15:                               # %pred.load.continue16
                                        #   in Loop: Header=BB4_3 Depth=1
	beqz	$a7, .LBB4_11
.LBB4_16:                               # %pred.load.if17
                                        #   in Loop: Header=BB4_3 Depth=1
	ldptr.d	$t4, $t2, 3184
	xvinsgr2vr.d	$xr9, $t4, 1
	bnez	$t0, .LBB4_12
.LBB4_17:                               # %pred.load.continue20
                                        #   in Loop: Header=BB4_3 Depth=1
	beqz	$t1, .LBB4_19
.LBB4_18:                               # %pred.load.if21
                                        #   in Loop: Header=BB4_3 Depth=1
	ldptr.d	$t4, $t2, 3200
	xvinsgr2vr.d	$xr9, $t4, 3
.LBB4_19:                               # %pred.load.continue22
                                        #   in Loop: Header=BB4_3 Depth=1
...
# %bb.20:                               # %pred.store.if
	...
	bnez	$a7, .LBB4_24
.LBB4_21:                               # %pred.store.continue24
                                        #   in Loop: Header=BB4_3 Depth=1
	beqz	$t0, .LBB4_25
.LBB4_22:                               # %pred.store.if25
                                        #   in Loop: Header=BB4_3 Depth=1
	xvstelm.d	$xr8, $t2, 16, 2
	beqz	$t1, .LBB4_2
	b	.LBB4_26
	.p2align	4, , 16
.LBB4_23:                               # %pred.store.continue
                                        #   in Loop: Header=BB4_3 Depth=1
	beqz	$a7, .LBB4_21
...
.LBB15_17:                              # %pred.load.continue23
	...
	xvpickve2gr.w	$t3, $xr9, 3
	vinsgr2vr.w	$vr6, $t3, 0
	xvpickve2gr.w	$t3, $xr9, 4
	vinsgr2vr.w	$vr6, $t3, 1
	xvpickve2gr.w	$t3, $xr9, 5
	vinsgr2vr.w	$vr6, $t3, 2
	xvpickve2gr.w	$t3, $xr9, 6
	vinsgr2vr.w	$vr6, $t3, 3
	xvpermi.q	$xr4, $xr6, 2
	xvadd.w	$xr6, $xr9, $xr8
