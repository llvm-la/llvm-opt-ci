...
.LBB2_7:                                # %pred.store.continue10
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB2_9
# %bb.8:                                # %pred.store.if11
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.w	$a4, $a3, -8
	ld.w	$a5, $a1, -8
	and	$a4, $a5, $a4
	st.w	$a4, $a2, -8
.LBB2_9:                                # %pred.store.continue12
                                        #   in Loop: Header=BB2_3 Depth=1
	xvpermi.q	$xr3, $xr3, 1
	vshuf4i.w	$vr3, $vr3, 128
	xvpermi.d	$xr4, $xr3, 78
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB2_11
# %bb.10:                               # %pred.store.if13
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.w	$a4, $a3, -4
	ld.w	$a5, $a1, -4
	and	$a4, $a5, $a4
	st.w	$a4, $a2, -4
.LBB2_11:                               # %pred.store.continue14
                                        #   in Loop: Header=BB2_3 Depth=1
	xvsle.du	$xr3, $xr0, $xr2
	xvpermi.d	$xr4, $xr3, 64
	xvpermi.d	$xr5, $xr4, 78
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB2_13
# %bb.12:                               # %pred.store.if15
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.w	$a4, $a3, 0
	ld.w	$a5, $a1, 0
	and	$a4, $a5, $a4
	st.w	$a4, $a2, 0
.LBB2_13:                               # %pred.store.continue16
                                        #   in Loop: Header=BB2_3 Depth=1
	vshuf4i.w	$vr4, $vr3, 8
	xvpermi.q	$xr4, $xr4, 2
	xvpermi.d	$xr5, $xr4, 78
...
.LBB2_15:                               # %pred.store.continue18
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB2_17
# %bb.16:                               # %pred.store.if19
                                        #   in Loop: Header=BB2_3 Depth=1
	ld.w	$a4, $a3, 8
	ld.w	$a5, $a1, 8
	and	$a4, $a5, $a4
	st.w	$a4, $a2, 8
.LBB2_17:                               # %pred.store.continue20
                                        #   in Loop: Header=BB2_3 Depth=1
	xvpermi.q	$xr3, $xr3, 1
	vshuf4i.w	$vr3, $vr3, 128
	xvpermi.q	$xr3, $xr3, 2
...
.LBB4_5:                                # %pred.store.continue
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB4_7
# %bb.6:                                # %pred.store.if26
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$a4, $a2, -12
	addi.d	$a4, $a4, 5
	st.w	$a4, $a1, -12
.LBB4_7:                                # %pred.store.continue27
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpermi.q	$xr5, $xr4, 1
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB4_9
# %bb.8:                                # %pred.store.if28
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$a4, $a2, -8
	addi.d	$a4, $a4, 5
	st.w	$a4, $a1, -8
.LBB4_9:                                # %pred.store.continue29
                                        #   in Loop: Header=BB4_3 Depth=1
	xvpermi.q	$xr4, $xr4, 1
	vshuf4i.w	$vr4, $vr4, 128
	xvpermi.d	$xr5, $xr4, 78
...
# %bb.10:                               # %pred.store.if11
	...
	add.d	$a4, $a5, $a4
	st.w	$a4, $a2, -4
.LBB5_11:                               # %pred.store.continue12
                                        #   in Loop: Header=BB5_3 Depth=1
	xvsle.du	$xr4, $xr0, $xr2
	xvpermi.d	$xr3, $xr4, 64
...
.LBB7_9:                                # %pred.store.continue8
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB7_11
# %bb.10:                               # %pred.store.if9
                                        #   in Loop: Header=BB7_3 Depth=1
	st.w	$a1, $a0, -4
.LBB7_11:                               # %pred.store.continue10
                                        #   in Loop: Header=BB7_3 Depth=1
	xvsle.du	$xr3, $xr0, $xr2
	xvpermi.d	$xr4, $xr3, 64
	xvpermi.d	$xr5, $xr4, 78
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB7_13
# %bb.12:                               # %pred.store.if11
                                        #   in Loop: Header=BB7_3 Depth=1
	st.w	$a1, $a0, 0
.LBB7_13:                               # %pred.store.continue12
                                        #   in Loop: Header=BB7_3 Depth=1
	vshuf4i.w	$vr4, $vr3, 8
	xvpermi.q	$xr4, $xr4, 2
	xvpermi.d	$xr5, $xr4, 78
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB7_15
# %bb.14:                               # %pred.store.if13
                                        #   in Loop: Header=BB7_3 Depth=1
	st.w	$a1, $a0, 4
.LBB7_15:                               # %pred.store.continue14
                                        #   in Loop: Header=BB7_3 Depth=1
	xvpermi.q	$xr4, $xr3, 1
	vshuf4i.w	$vr4, $vr4, 128
	xvpermi.q	$xr4, $xr4, 2
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB7_17
# %bb.16:                               # %pred.store.if15
                                        #   in Loop: Header=BB7_3 Depth=1
	st.w	$a1, $a0, 8
.LBB7_17:                               # %pred.store.continue16
                                        #   in Loop: Header=BB7_3 Depth=1
	xvpermi.q	$xr3, $xr3, 1
	vshuf4i.w	$vr3, $vr3, 128
	xvpermi.q	$xr3, $xr3, 2
...
.LBB17_11:                              # %pred.load.continue17
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB17_13
# %bb.12:                               # %pred.load.if18
                                        #   in Loop: Header=BB17_3 Depth=1
	ld.w	$a4, $a1, -4
	xvinsgr2vr.w	$xr5, $a4, 4
.LBB17_13:                              # %pred.load.continue19
                                        #   in Loop: Header=BB17_3 Depth=1
	vshuf4i.w	$vr7, $vr6, 8
	xvpermi.q	$xr7, $xr7, 2
	xvpermi.d	$xr8, $xr7, 78
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB17_15
# %bb.14:                               # %pred.load.if20
                                        #   in Loop: Header=BB17_3 Depth=1
	ld.w	$a4, $a1, -8
	xvinsgr2vr.w	$xr5, $a4, 5
.LBB17_15:                              # %pred.load.continue21
                                        #   in Loop: Header=BB17_3 Depth=1
	xvpermi.q	$xr7, $xr6, 1
	vshuf4i.w	$vr7, $vr7, 128
	xvpermi.q	$xr7, $xr7, 2
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB17_17
# %bb.16:                               # %pred.load.if22
                                        #   in Loop: Header=BB17_3 Depth=1
	ld.w	$a4, $a1, -12
	xvinsgr2vr.w	$xr5, $a4, 6
.LBB17_17:                              # %pred.load.continue23
                                        #   in Loop: Header=BB17_3 Depth=1
	xvpermi.q	$xr7, $xr6, 1
	vshuf4i.w	$vr7, $vr7, 128
	xvpermi.q	$xr7, $xr7, 2
...
# %bb.151:                              # %vector.ph
	...
	xvld	$xr0, $a3, %pc_lo12(.LCPI24_1)
	pcalau12i	$a3, %pc_hi20(.LCPI24_2)
	xvld	$xr1, $a3, %pc_lo12(.LCPI24_2)
...
.LBB24_163:                             # %pred.load.continue634
                                        #   in Loop: Header=BB24_153 Depth=1
	vshuf4i.w	$vr7, $vr6, 8
	xvpermi.q	$xr7, $xr7, 2
	xvpermi.d	$xr8, $xr7, 78
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB24_165
# %bb.164:                              # %pred.load.if635
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a3, $a2, 4
	xvinsgr2vr.w	$xr5, $a3, 5
.LBB24_165:                             # %pred.load.continue636
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpermi.q	$xr7, $xr6, 1
	vshuf4i.w	$vr7, $vr7, 128
	xvpermi.q	$xr7, $xr7, 2
