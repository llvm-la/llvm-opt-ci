...
# %bb.0:
	...
	fst.d	$fs0, $sp, 1184                 # 8-byte Folded Spill
	fst.d	$fs1, $sp, 1176                 # 8-byte Folded Spill
	fst.d	$fs2, $sp, 1168                 # 8-byte Folded Spill
	fst.d	$fs3, $sp, 1160                 # 8-byte Folded Spill
	.cfi_offset 1, -8
	.cfi_offset 22, -16
	.cfi_offset 23, -24
	.cfi_offset 24, -32
...
.LBB1_67:                               # %_ZNSt14_Function_baseD2Ev.exit283
	...
	b	.LBB1_69
	.p2align	4, , 16
.LBB1_68:                               # %pred.store.continue1244
...
# %bb.70:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_78
.LBB1_71:                               # %pred.store.continue1232
                                        #   in Loop: Header=BB1_69 Depth=1
	vpickve2gr.h	$a4, $vr4, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_79
.LBB1_72:                               # %pred.store.continue1234
                                        #   in Loop: Header=BB1_69 Depth=1
	vpickve2gr.h	$a4, $vr4, 3
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_80
.LBB1_73:                               # %pred.store.continue1236
                                        #   in Loop: Header=BB1_69 Depth=1
	vpickve2gr.h	$a4, $vr4, 4
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_81
.LBB1_74:                               # %pred.store.continue1238
                                        #   in Loop: Header=BB1_69 Depth=1
	vpickve2gr.h	$a4, $vr4, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_82
.LBB1_75:                               # %pred.store.continue1240
                                        #   in Loop: Header=BB1_69 Depth=1
	vpickve2gr.h	$a4, $vr4, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB1_83
.LBB1_76:                               # %pred.store.continue1242
                                        #   in Loop: Header=BB1_69 Depth=1
...
# %bb.126:                              # %.preheader704
	...
	b	.LBB1_128
	.p2align	4, , 16
.LBB1_127:                              # %_ZNSt14_Function_baseD2Ev.exit375
...
.Ltmp420:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp421:                               # EH_LABEL
.LBB1_141:                              # %_ZNSt14_Function_baseD2Ev.exit373
                                        #   in Loop: Header=BB1_128 Depth=2
	ld.d	$a3, $sp, 680
	beqz	$a3, .LBB1_127
...
# %bb.147:                              # %.preheader696
	...
	b	.LBB1_149
	.p2align	4, , 16
.LBB1_148:                              # %_ZNSt14_Function_baseD2Ev.exit414
...
# %bb.154:                              #   in Loop: Header=BB1_149 Depth=2
	...
	ld.d	$a0, $sp, 616
	vst	$vr0, $sp, 584
.LBB1_155:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit391
                                        #   in Loop: Header=BB1_149 Depth=2
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	st.d	$a1, $sp, 1152
	st.w	$s5, $sp, 1148
	beqz	$a0, .LBB1_256
# %bb.156:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit.i393
                                        #   in Loop: Header=BB1_149 Depth=2
	ld.d	$a3, $sp, 624
.Ltmp438:                               # EH_LABEL
	addi.d	$a0, $sp, 600
...
# %bb.157:                              # %.noexc400
	...
	st.w	$s5, $sp, 1148
	beqz	$a0, .LBB1_256
# %bb.158:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit9.i395
                                        #   in Loop: Header=BB1_149 Depth=2
	fmov.s	$fs1, $fa0
	ld.d	$a3, $sp, 592
.Ltmp440:                               # EH_LABEL
...
# %bb.159:                              # %.noexc402
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB1_271
# %bb.160:                              # %_ZL5checkIfEvSt8functionIFT_PS1_jEES4_PfjPKc.exit410
                                        #   in Loop: Header=BB1_149 Depth=2
	ld.d	$a3, $sp, 584
	beqz	$a3, .LBB1_162
...
.Ltmp457:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp458:                               # EH_LABEL
.LBB1_162:                              # %_ZNSt14_Function_baseD2Ev.exit412
                                        #   in Loop: Header=BB1_149 Depth=2
	ld.d	$a3, $sp, 616
	beqz	$a3, .LBB1_148
...
# %bb.170:                              #   in Loop: Header=BB1_166 Depth=1
	vld	$vr0, $s1, 16
	vst	$vr0, $sp, 552
.LBB1_171:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit424
                                        #   in Loop: Header=BB1_166 Depth=1
	ld.d	$a3, $s0, 16
	xvld	$xr0, $sp, 208                  # 32-byte Folded Reload
	xvst	$xr0, $sp, 504
...
# %bb.173:                              #   in Loop: Header=BB1_166 Depth=1
	vld	$vr0, $s0, 16
	vst	$vr0, $sp, 520
.LBB1_174:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit430
                                        #   in Loop: Header=BB1_166 Depth=1
.Ltmp475:                               # EH_LABEL
	addi.d	$a0, $sp, 536
	addi.d	$a1, $sp, 504
...
.Ltmp484:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp485:                               # EH_LABEL
.LBB1_177:                              # %_ZNSt14_Function_baseD2Ev.exit432
                                        #   in Loop: Header=BB1_166 Depth=1
	ld.d	$a3, $sp, 552
	beqz	$a3, .LBB1_179
...
.Ltmp487:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp488:                               # EH_LABEL
.LBB1_179:                              # %_ZNSt14_Function_baseD2Ev.exit434.preheader
                                        #   in Loop: Header=BB1_166 Depth=1
	ori	$fp, $zero, 1
	st.d	$s6, $sp, 176                   # 8-byte Folded Spill
	b	.LBB1_181
	.p2align	4, , 16
.LBB1_180:                              # %_ZNSt14_Function_baseD2Ev.exit473
                                        #   in Loop: Header=BB1_181 Depth=2
	addi.d	$fp, $fp, 1
	addi.d	$s6, $s6, 4
	beq	$fp, $s5, .LBB1_165
.LBB1_181:                              # %_ZNSt14_Function_baseD2Ev.exit434
                                        #   Parent Loop BB1_166 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a0, $s4, $fp
	bltu	$s7, $a0, .LBB1_183
...
# %bb.188:                              #   in Loop: Header=BB1_181 Depth=2
	...
	ld.d	$a0, $sp, 488
	vst	$vr0, $sp, 456
.LBB1_189:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit450
                                        #   in Loop: Header=BB1_181 Depth=2
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	st.d	$a1, $sp, 1152
	st.w	$s3, $sp, 1148
	beqz	$a0, .LBB1_258
# %bb.190:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit.i452
                                        #   in Loop: Header=BB1_181 Depth=2
	ld.d	$a3, $sp, 496
.Ltmp502:                               # EH_LABEL
	addi.d	$a0, $sp, 472
...
# %bb.191:                              # %.noexc459
	...
	st.w	$s3, $sp, 1148
	beqz	$a0, .LBB1_258
# %bb.192:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit9.i454
                                        #   in Loop: Header=BB1_181 Depth=2
	fmov.s	$fs1, $fa0
	ld.d	$a3, $sp, 464
.Ltmp504:                               # EH_LABEL
...
# %bb.193:                              # %.noexc461
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB1_278
# %bb.194:                              # %_ZL5checkIfEvSt8functionIFT_PS1_jEES4_PfjPKc.exit469
                                        #   in Loop: Header=BB1_181 Depth=2
	ld.d	$a3, $sp, 456
	beqz	$a3, .LBB1_196
...
.Ltmp521:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp522:                               # EH_LABEL
.LBB1_196:                              # %_ZNSt14_Function_baseD2Ev.exit471
                                        #   in Loop: Header=BB1_181 Depth=2
	ld.d	$a3, $sp, 488
	beqz	$a3, .LBB1_180
...
# %bb.204:                              #   in Loop: Header=BB1_200 Depth=1
	vld	$vr0, $s1, 16
	vst	$vr0, $sp, 424
.LBB1_205:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit483
                                        #   in Loop: Header=BB1_200 Depth=1
	ld.d	$a3, $s0, 16
	xvld	$xr0, $sp, 208                  # 32-byte Folded Reload
	xvst	$xr0, $sp, 376
...
# %bb.207:                              #   in Loop: Header=BB1_200 Depth=1
	vld	$vr0, $s0, 16
	vst	$vr0, $sp, 392
.LBB1_208:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit489
                                        #   in Loop: Header=BB1_200 Depth=1
.Ltmp539:                               # EH_LABEL
	addi.d	$a0, $sp, 408
	addi.d	$a1, $sp, 376
...
.Ltmp548:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp549:                               # EH_LABEL
.LBB1_211:                              # %_ZNSt14_Function_baseD2Ev.exit491
                                        #   in Loop: Header=BB1_200 Depth=1
	ld.d	$a3, $sp, 424
	beqz	$a3, .LBB1_213
...
.Ltmp551:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp552:                               # EH_LABEL
.LBB1_213:                              # %_ZNSt14_Function_baseD2Ev.exit493.preheader
                                        #   in Loop: Header=BB1_200 Depth=1
	ori	$fp, $zero, 1
	move	$s4, $s3
	b	.LBB1_215
	.p2align	4, , 16
.LBB1_214:                              # %_ZNSt14_Function_baseD2Ev.exit532
                                        #   in Loop: Header=BB1_215 Depth=2
	addi.d	$fp, $fp, 1
	addi.d	$s4, $s4, 4
	beq	$fp, $s5, .LBB1_199
.LBB1_215:                              # %_ZNSt14_Function_baseD2Ev.exit493
                                        #   Parent Loop BB1_200 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a0, $s7, $fp
	bltu	$s8, $a0, .LBB1_217
...
# %bb.222:                              #   in Loop: Header=BB1_215 Depth=2
	...
	ld.d	$a0, $sp, 360
	vst	$vr0, $sp, 328
.LBB1_223:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit509
                                        #   in Loop: Header=BB1_215 Depth=2
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	st.d	$a1, $sp, 1152
	st.w	$s6, $sp, 1148
	beqz	$a0, .LBB1_260
# %bb.224:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit.i511
                                        #   in Loop: Header=BB1_215 Depth=2
	ld.d	$a3, $sp, 368
.Ltmp566:                               # EH_LABEL
	addi.d	$a0, $sp, 344
...
# %bb.225:                              # %.noexc518
	...
	st.w	$s6, $sp, 1148
	beqz	$a0, .LBB1_260
# %bb.226:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit9.i513
                                        #   in Loop: Header=BB1_215 Depth=2
	fmov.s	$fs1, $fa0
	ld.d	$a3, $sp, 336
.Ltmp568:                               # EH_LABEL
...
# %bb.227:                              # %.noexc520
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB1_285
# %bb.228:                              # %_ZL5checkIfEvSt8functionIFT_PS1_jEES4_PfjPKc.exit528
                                        #   in Loop: Header=BB1_215 Depth=2
	ld.d	$a3, $sp, 328
	beqz	$a3, .LBB1_230
...
.Ltmp585:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp586:                               # EH_LABEL
.LBB1_230:                              # %_ZNSt14_Function_baseD2Ev.exit530
                                        #   in Loop: Header=BB1_215 Depth=2
	ld.d	$a3, $sp, 360
	beqz	$a3, .LBB1_214
...
# %bb.236:                              # %.preheader
	...
	b	.LBB1_238
	.p2align	4, , 16
.LBB1_237:                              # %_ZNSt14_Function_baseD2Ev.exit572
...
# %bb.243:                              #   in Loop: Header=BB1_238 Depth=2
	...
	ld.d	$a0, $sp, 296
	vst	$vr0, $sp, 264
.LBB1_244:                              # %_ZNSt8functionIFfPfjEEC2ERKS2_.exit549
                                        #   in Loop: Header=BB1_238 Depth=2
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	st.d	$a1, $sp, 1152
	st.w	$s7, $sp, 1148
	beqz	$a0, .LBB1_262
# %bb.245:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit.i551
                                        #   in Loop: Header=BB1_238 Depth=2
	ld.d	$a3, $sp, 304
.Ltmp603:                               # EH_LABEL
	addi.d	$a0, $sp, 280
...
# %bb.246:                              # %.noexc558
	...
	st.w	$s7, $sp, 1148
	beqz	$a0, .LBB1_262
# %bb.247:                              # %_ZNKSt8functionIFfPfjEEclES0_j.exit9.i553
                                        #   in Loop: Header=BB1_238 Depth=2
	fmov.s	$fs1, $fa0
	ld.d	$a3, $sp, 272
.Ltmp605:                               # EH_LABEL
...
# %bb.248:                              # %.noexc560
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB1_292
# %bb.249:                              # %_ZL5checkIfEvSt8functionIFT_PS1_jEES4_PfjPKc.exit568
                                        #   in Loop: Header=BB1_238 Depth=2
	ld.d	$a3, $sp, 264
	beqz	$a3, .LBB1_251
...
.Ltmp622:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp623:                               # EH_LABEL
.LBB1_251:                              # %_ZNSt14_Function_baseD2Ev.exit570
                                        #   in Loop: Header=BB1_238 Depth=2
	ld.d	$a3, $sp, 296
	beqz	$a3, .LBB1_237
...
.LBB1_253:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit
	...
	jirl	$ra, $ra, 0
	fld.d	$fs3, $sp, 1160                 # 8-byte Folded Reload
	fld.d	$fs2, $sp, 1168                 # 8-byte Folded Reload
	fld.d	$fs1, $sp, 1176                 # 8-byte Folded Reload
	fld.d	$fs0, $sp, 1184                 # 8-byte Folded Reload
...
.Ltmp607:                               # EH_LABEL
	b	.LBB1_473
.LBB1_468:                              # %.loopexit682
.Ltmp570:                               # EH_LABEL
	b	.LBB1_480
.LBB1_469:                              # %.loopexit689
.Ltmp506:                               # EH_LABEL
	b	.LBB1_487
.LBB1_470:                              # %.loopexit697
.Ltmp442:                               # EH_LABEL
	b	.LBB1_494
.LBB1_471:                              # %.loopexit705
.Ltmp405:                               # EH_LABEL
	b	.LBB1_501
...
.Ltmp670:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp671:                               # EH_LABEL
.LBB1_505:                              # %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EED2Ev.exit579
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $s0
