...
# %bb.1:                                # %vector.ph
	...
	xvld	$xr2, $a2, %pc_lo12(.LCPI22_0)
	pcalau12i	$a2, %pc_hi20(.LCPI22_1)
	xvld	$xr3, $a2, %pc_lo12(.LCPI22_1)
	pcalau12i	$a2, %pc_hi20(.LCPI22_2)
	xvld	$xr4, $a2, %pc_lo12(.LCPI22_2)
	pcalau12i	$a2, %pc_hi20(.LCPI22_3)
	xvld	$xr5, $a2, %pc_lo12(.LCPI22_3)
	addi.d	$a1, $a1, 16
	addi.d	$a2, $a3, 16
	vrepli.b	$vr6, 0
	b	.LBB22_3
...
# %bb.1:                                # %vector.ph
	...
	xvld	$xr2, $a2, %pc_lo12(.LCPI34_0)
	pcalau12i	$a2, %pc_hi20(.LCPI34_1)
	xvld	$xr3, $a2, %pc_lo12(.LCPI34_1)
	pcalau12i	$a2, %pc_hi20(.LCPI34_2)
	xvld	$xr4, $a2, %pc_lo12(.LCPI34_2)
	pcalau12i	$a2, %pc_hi20(.LCPI34_3)
	xvld	$xr5, $a2, %pc_lo12(.LCPI34_3)
	addi.d	$a1, $a1, 16
	addi.d	$a2, $a3, 16
	vrepli.b	$vr6, 0
	b	.LBB34_3
...
# %bb.1:                                # %.lr.ph.i.i.i
	...
	xvld	$xr2, $a4, %pc_lo12(.LCPI60_0)
	pcalau12i	$a4, %pc_hi20(.LCPI60_1)
	xvld	$xr3, $a4, %pc_lo12(.LCPI60_1)
	pcalau12i	$a4, %pc_hi20(.LCPI60_2)
	xvld	$xr4, $a4, %pc_lo12(.LCPI60_2)
	pcalau12i	$a4, %pc_hi20(.LCPI60_3)
	xvld	$xr5, $a4, %pc_lo12(.LCPI60_3)
	addi.d	$a2, $a2, 16
	addi.d	$a3, $a3, 16
	vrepli.b	$vr6, 0
	b	.LBB60_3
...
.LBB60_2:                               # %pred.load.continue35
	...
	vinsgr2vr.b	$vr7, $s2, 4
	vpickve2gr.h	$s2, $vr6, 5
	vinsgr2vr.b	$vr7, $s2, 5
	vpickve2gr.h	$s2, $vr6, 6
	vinsgr2vr.b	$vr7, $s2, 6
	vpickve2gr.h	$s2, $vr6, 7
	vinsgr2vr.b	$vr7, $s2, 7
	xvpermi.d	$xr6, $xr6, 14
	vpickve2gr.h	$s2, $vr6, 0
	vinsgr2vr.b	$vr7, $s2, 8
	vpickve2gr.h	$s2, $vr6, 1
	vinsgr2vr.b	$vr7, $s2, 9
	vpickve2gr.h	$s2, $vr6, 2
	vinsgr2vr.b	$vr7, $s2, 10
	vpickve2gr.h	$s2, $vr6, 3
	vinsgr2vr.b	$vr7, $s2, 11
	vpickve2gr.h	$s2, $vr6, 4
	vinsgr2vr.b	$vr7, $s2, 12
	vpickve2gr.h	$s2, $vr6, 5
	vinsgr2vr.b	$vr7, $s2, 13
	vpickve2gr.h	$s2, $vr6, 6
	vinsgr2vr.b	$vr7, $s2, 14
	vpickve2gr.h	$s2, $vr6, 7
	vinsgr2vr.b	$vr7, $s2, 15
	vor.v	$vr6, $vr1, $vr7
	xvaddi.du	$xr5, $xr5, 16
	xvaddi.du	$xr4, $xr4, 16
	xvaddi.du	$xr3, $xr3, 16
