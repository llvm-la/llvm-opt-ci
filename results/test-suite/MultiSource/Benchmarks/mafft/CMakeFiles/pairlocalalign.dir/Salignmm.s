...
.LBB3_197:                              # %.lr.ph19.i
	...
	addi.d	$fp, $fp, -1
	bnez	$t8, .LBB3_197
.LBB3_198:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_181 Depth=1
	add.d	$t0, $s7, $t0
	add.d	$t0, $t7, $t0
	move	$s3, $s0
...
.LBB3_204:                              # %._crit_edge30.i
	...
	addi.w	$fp, $a0, 0
	beq	$t3, $fp, .LBB3_206
# %bb.205:                              #   in Loop: Header=BB3_181 Depth=1
...
.LBB3_213:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_213
.LBB3_214:                              # %.preheader.i
	ld.d	$s1, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 144                   # 8-byte Folded Reload
	blez	$s1, .LBB3_217
# %bb.215:                              # %.lr.ph52.preheader.i
	move	$fp, $s7
	move	$s0, $s1
	.p2align	4, , 16
.LBB3_216:                              # %.lr.ph52.i
...
.LBB3_228:                              # %vector.body752
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB3_228
# %bb.229:                              # %middle.block759
	beq	$a4, $a6, .LBB3_76
# %bb.230:                              # %vec.epilog.iter.check763
	beqz	$a5, .LBB3_256
.LBB3_231:                              # %vec.epilog.ph765
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB3_232:                              # %vec.epilog.vector.body768
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB3_232
# %bb.233:                              # %vec.epilog.middle.block775
	bne	$a4, $a7, .LBB3_74
	b	.LBB3_76
.LBB3_234:
...
.LBB3_243:                              # %vector.body650
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_243
# %bb.244:                              # %middle.block659
	beq	$a3, $a5, .LBB3_61
# %bb.245:                              # %vec.epilog.iter.check663
	beqz	$a4, .LBB3_258
.LBB3_246:                              # %vec.epilog.ph665
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_247:                              # %vec.epilog.vector.body668
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_247
# %bb.248:                              # %vec.epilog.middle.block676
	bne	$a3, $a6, .LBB3_59
	b	.LBB3_61
.LBB3_249:                              # %vector.ph698
	andi	$a4, $a3, 12
	move	$a5, $a3
	xvldrepl.w	$xr0, $a0, 0
	bstrins.d	$a5, $zero, 3, 0
...
.LBB3_250:                              # %vector.body701
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_250
# %bb.251:                              # %middle.block710
	beq	$a3, $a5, .LBB3_73
# %bb.252:                              # %vec.epilog.iter.check714
	beqz	$a4, .LBB3_259
.LBB3_253:                              # %vec.epilog.ph716
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	vldrepl.w	$vr0, $a0, 0
	ori	$a7, $zero, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_254:                              # %vec.epilog.vector.body719
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_254
# %bb.255:                              # %vec.epilog.middle.block727
	bne	$a3, $a6, .LBB3_63
	b	.LBB3_73
.LBB3_256:
	addi.d	$a5, $a6, 1
