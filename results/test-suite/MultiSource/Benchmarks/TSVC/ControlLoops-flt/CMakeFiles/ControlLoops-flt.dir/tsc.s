...
.LBB5_139:                              # %vector.body3598
	...
	addi.w	$a3, $a3, 2
	bnez	$a4, .LBB5_139
# %bb.140:                              # %vector.body3603.preheader
	lu12i.w	$a2, 62
	ori	$a2, $a2, 2100
	add.d	$a2, $a0, $a2
	ori	$a3, $zero, 2
	ori	$a4, $a1, 3328
.LBB5_141:                              # %vector.body3603
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a5, $a3, 31, 0
	addi.d	$a6, $a3, -1
	bstrpick.d	$a6, $a6, 31, 0
	...
	addi.w	$a3, $a3, 2
	bnez	$a4, .LBB5_141
# %bb.142:                              # %vector.body3608.preheader
	lu12i.w	$a2, 93
	ori	$a2, $a2, 3156
	add.d	$a2, $a0, $a2
	ori	$a3, $zero, 2
	ori	$a4, $a1, 3328
.LBB5_143:                              # %vector.body3608
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a5, $a3, 31, 0
	addi.d	$a6, $a3, -1
	bstrpick.d	$a6, $a6, 31, 0
	...
	addi.w	$a3, $a3, 2
	bnez	$a4, .LBB5_143
# %bb.144:                              # %vector.body3613.preheader
	lu12i.w	$a2, 125
	ori	$a2, $a2, 132
	add.d	$a2, $a0, $a2
	ori	$a3, $zero, 2
	ori	$a1, $a1, 3328
.LBB5_145:                              # %vector.body3613
                                        # =>This Inner Loop Header: Depth=1
...
.LBB10_7:                               # %pred.store.continue
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_14
# %bb.8:                                # %pred.store.continue22
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_15
.LBB10_9:                               # %pred.store.continue24
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_16
.LBB10_10:                              # %pred.store.continue26
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_17
.LBB10_11:                              # %pred.store.continue28
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 5
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_18
.LBB10_12:                              # %pred.store.continue30
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_19
.LBB10_13:                              # %pred.store.continue32
                                        #   in Loop: Header=BB10_5 Depth=2
