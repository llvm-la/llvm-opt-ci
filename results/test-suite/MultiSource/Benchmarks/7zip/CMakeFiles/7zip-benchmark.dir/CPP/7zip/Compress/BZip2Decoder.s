...
.LBB21_106:                             #   in Loop: Header=BB21_99 Depth=1
	beqz	$s6, .LBB21_116
# %bb.107:                              #   in Loop: Header=BB21_99 Depth=1
	ld.bu	$a1, $sp, 392
	slli.d	$a2, $a1, 2
...
# %bb.119:                              #   in Loop: Header=BB21_99 Depth=1
	slli.d	$a1, $a0, 2
	ld.d	$a3, $sp, 80                    # 8-byte Folded Reload
	ldx.w	$a2, $a3, $a1
	addi.d	$a2, $a2, 1
...
.LBB21_122:                             # %pred.store.if
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_53
.LBB21_123:                             # %pred.store.if418
	ori	$a0, $zero, 1
	st.b	$a0, $sp, 135
	xvpickve2gr.d	$a0, $xr1, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_54
.LBB21_124:                             # %pred.store.if420
	ori	$a0, $zero, 2
	st.b	$a0, $sp, 136
	xvpickve2gr.d	$a0, $xr1, 3
	andi	$a0, $a0, 1
