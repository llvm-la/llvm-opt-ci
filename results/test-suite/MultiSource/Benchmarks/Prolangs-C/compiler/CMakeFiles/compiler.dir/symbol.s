...
.LBB6_7:                                # %pred.store.continue
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_14
# %bb.8:                                # %pred.store.continue6
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 2
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_15
.LBB6_9:                                # %pred.store.continue8
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 3
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_16
.LBB6_10:                               # %pred.store.continue10
                                        #   in Loop: Header=BB6_5 Depth=1
...
.LBB6_11:                               # %pred.store.continue12
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_18
.LBB6_12:                               # %pred.store.continue14
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 6
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_19
.LBB6_13:                               # %pred.store.continue16
                                        #   in Loop: Header=BB6_5 Depth=1
	...
	b	.LBB6_20
	.p2align	4, , 16
.LBB6_14:                               # %pred.store.if5
                                        #   in Loop: Header=BB6_5 Depth=1
	st.w	$a5, $a4, 64
	vpickve2gr.h	$a7, $vr1, 2
	andi	$a7, $a7, 1
	beqz	$a7, .LBB6_9
.LBB6_15:                               # %pred.store.if7
                                        #   in Loop: Header=BB6_5 Depth=1
	st.w	$a5, $a4, 32
	vpickve2gr.h	$a7, $vr1, 3
	andi	$a7, $a7, 1
	beqz	$a7, .LBB6_10
.LBB6_16:                               # %pred.store.if9
                                        #   in Loop: Header=BB6_5 Depth=1
	st.w	$a5, $a4, 0
	vpickve2gr.h	$a7, $vr1, 4
	andi	$a7, $a7, 1
	beqz	$a7, .LBB6_11
.LBB6_17:                               # %pred.store.if11
                                        #   in Loop: Header=BB6_5 Depth=1
	st.w	$a5, $a4, -32
	vpickve2gr.h	$a7, $vr1, 5
	andi	$a7, $a7, 1
	beqz	$a7, .LBB6_12
.LBB6_18:                               # %pred.store.if13
                                        #   in Loop: Header=BB6_5 Depth=1
	st.w	$a5, $a4, -64
	vpickve2gr.h	$a7, $vr1, 6
	andi	$a7, $a7, 1
	beqz	$a7, .LBB6_13
.LBB6_19:                               # %pred.store.if15
                                        #   in Loop: Header=BB6_5 Depth=1
	st.w	$a5, $a4, -96
	vpickve2gr.h	$a7, $vr1, 7
	andi	$a7, $a7, 1
	beqz	$a7, .LBB6_4
.LBB6_20:                               # %pred.store.if17
                                        #   in Loop: Header=BB6_5 Depth=1
	st.w	$a5, $a4, -128
	b	.LBB6_4
