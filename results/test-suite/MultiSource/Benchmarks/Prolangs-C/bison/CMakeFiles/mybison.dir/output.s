...
.LBB21_37:                              # %vec.epilog.ph324
	...
	b	.LBB21_39
	.p2align	4, , 16
.LBB21_38:                              # %pred.store.continue345
                                        #   in Loop: Header=BB21_39 Depth=1
	addi.d	$a3, $a3, 8
	addi.d	$a4, $a4, 16
	beqz	$a3, .LBB21_66
.LBB21_39:                              # %vec.epilog.vector.body327
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, -8
	vseq.h	$vr1, $vr1, $vr0
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_47
# %bb.40:                               # %pred.store.if330
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -8
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_48
.LBB21_41:                              # %pred.store.continue333
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_49
.LBB21_42:                              # %pred.store.if334
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_50
.LBB21_43:                              # %pred.store.continue337
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_51
.LBB21_44:                              # %pred.store.if338
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 0
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_52
.LBB21_45:                              # %pred.store.continue341
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_53
.LBB21_46:                              # %pred.store.if342
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 4
	...
	b	.LBB21_54
	.p2align	4, , 16
.LBB21_47:                              # %pred.store.continue331
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_41
.LBB21_48:                              # %pred.store.if332
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -6
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_42
.LBB21_49:                              # %pred.store.continue335
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_43
.LBB21_50:                              # %pred.store.if336
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_44
.LBB21_51:                              # %pred.store.continue339
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_45
.LBB21_52:                              # %pred.store.if340
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_46
.LBB21_53:                              # %pred.store.continue343
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_38
.LBB21_54:                              # %pred.store.if344
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 6
	b	.LBB21_38
...
.LBB21_65:                              # %scalar.ph
	...
	bnez	$t5, .LBB21_65
	b	.LBB21_58
.LBB21_66:                              # %vec.epilog.middle.block347
	beq	$a2, $s0, .LBB21_111
	b	.LBB21_103
...
# %bb.70:                               # %pred.store.if285
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -16
.LBB21_71:                              # %pred.store.continue286
                                        #   in Loop: Header=BB21_69 Depth=1
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_86
# %bb.72:                               # %pred.store.if287
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -14
	vpickve2gr.b	$a6, $vr1, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_87
.LBB21_73:                              # %pred.store.continue290
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_88
.LBB21_74:                              # %pred.store.if291
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -10
	vpickve2gr.b	$a6, $vr1, 4
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_89
.LBB21_75:                              # %pred.store.continue294
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_90
.LBB21_76:                              # %pred.store.if295
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -6
	vpickve2gr.b	$a6, $vr1, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_91
.LBB21_77:                              # %pred.store.continue298
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 7
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_92
.LBB21_78:                              # %pred.store.if299
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -2
	vpickve2gr.b	$a6, $vr1, 8
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_93
.LBB21_79:                              # %pred.store.continue302
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 9
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_94
.LBB21_80:                              # %pred.store.if303
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, 2
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_95
.LBB21_81:                              # %pred.store.continue306
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_96
.LBB21_82:                              # %pred.store.if307
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, 6
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_97
.LBB21_83:                              # %pred.store.continue310
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_98
.LBB21_84:                              # %pred.store.if311
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, 10
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_99
.LBB21_85:                              # %pred.store.continue314
                                        #   in Loop: Header=BB21_69 Depth=1
	...
	b	.LBB21_100
	.p2align	4, , 16
.LBB21_86:                              # %pred.store.continue288
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_73
.LBB21_87:                              # %pred.store.if289
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -12
	vpickve2gr.b	$a6, $vr1, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_74
.LBB21_88:                              # %pred.store.continue292
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 4
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_75
.LBB21_89:                              # %pred.store.if293
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -8
	vpickve2gr.b	$a6, $vr1, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_76
.LBB21_90:                              # %pred.store.continue296
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_77
.LBB21_91:                              # %pred.store.if297
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, -4
	vpickve2gr.b	$a6, $vr1, 7
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_78
.LBB21_92:                              # %pred.store.continue300
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 8
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_79
.LBB21_93:                              # %pred.store.if301
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, 0
	vpickve2gr.b	$a6, $vr1, 9
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_80
.LBB21_94:                              # %pred.store.continue304
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_81
.LBB21_95:                              # %pred.store.if305
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, 4
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_82
.LBB21_96:                              # %pred.store.continue308
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_83
.LBB21_97:                              # %pred.store.if309
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, 8
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_84
.LBB21_98:                              # %pred.store.continue312
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_85
.LBB21_99:                              # %pred.store.if313
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a4, 12
	vpickve2gr.b	$a6, $vr1, 15
	andi	$a6, $a6, 1
...
.LBB21_101:                             # %middle.block318
	beq	$a2, $s0, .LBB21_111
# %bb.102:                              # %vec.epilog.iter.check322
	bnez	$a3, .LBB21_37
...
.LBB21_118:                             # %pred.store.continue
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_135
# %bb.119:                              # %pred.store.if223
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, -14
	vpickve2gr.b	$a6, $vr2, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_136
.LBB21_120:                             # %pred.store.continue226
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr2, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_137
.LBB21_121:                             # %pred.store.if227
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, -10
	vpickve2gr.b	$a6, $vr2, 4
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_138
.LBB21_122:                             # %pred.store.continue230
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr2, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_139
.LBB21_123:                             # %pred.store.if231
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, -6
	vpickve2gr.b	$a6, $vr2, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_140
.LBB21_124:                             # %pred.store.continue234
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr2, 7
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_126
.LBB21_125:                             # %pred.store.if235
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, -2
.LBB21_126:                             # %pred.store.continue236
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpermi.q	$xr1, $xr1, 1
	vpickve2gr.h	$a6, $vr1, 4
	ext.w.h	$a6, $a6
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_128
# %bb.127:                              # %pred.store.if237
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, 0
.LBB21_128:                             # %pred.store.continue238
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpermi.d	$xr2, $xr1, 78
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_141
# %bb.129:                              # %pred.store.if239
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, 2
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_142
.LBB21_130:                             # %pred.store.continue242
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_143
.LBB21_131:                             # %pred.store.if243
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, 6
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_144
.LBB21_132:                             # %pred.store.continue246
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_145
.LBB21_133:                             # %pred.store.if247
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, 10
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_146
.LBB21_134:                             # %pred.store.continue250
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr1, 15
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_115
	b	.LBB21_147
	.p2align	4, , 16
.LBB21_135:                             # %pred.store.continue224
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr2, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_120
.LBB21_136:                             # %pred.store.if225
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, -12
	vpickve2gr.b	$a6, $vr2, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_121
.LBB21_137:                             # %pred.store.continue228
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr2, 4
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_122
.LBB21_138:                             # %pred.store.if229
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, -8
	vpickve2gr.b	$a6, $vr2, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_123
.LBB21_139:                             # %pred.store.continue232
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr2, 6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_124
.LBB21_140:                             # %pred.store.if233
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, -4
	vpickve2gr.b	$a6, $vr2, 7
	andi	$a6, $a6, 1
	...
	b	.LBB21_126
	.p2align	4, , 16
.LBB21_141:                             # %pred.store.continue240
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr1, 10
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_130
.LBB21_142:                             # %pred.store.if241
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, 4
	vpickve2gr.b	$a6, $vr1, 11
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_131
.LBB21_143:                             # %pred.store.continue244
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr1, 12
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_132
.LBB21_144:                             # %pred.store.if245
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, 8
	vpickve2gr.b	$a6, $vr1, 13
	andi	$a6, $a6, 1
	bnez	$a6, .LBB21_133
.LBB21_145:                             # %pred.store.continue248
                                        #   in Loop: Header=BB21_116 Depth=1
	vpickve2gr.b	$a6, $vr1, 14
	andi	$a6, $a6, 1
	beqz	$a6, .LBB21_134
.LBB21_146:                             # %pred.store.if249
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a4, 12
	vpickve2gr.b	$a6, $vr1, 15
	andi	$a6, $a6, 1
