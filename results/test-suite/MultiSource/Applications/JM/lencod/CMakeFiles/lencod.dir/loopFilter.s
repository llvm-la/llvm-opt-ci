...
.LBB3_32:                               #   in Loop: Header=BB3_7 Depth=1
	...
	addi.d	$a0, $a0, 1
	beqz	$t5, .LBB3_34
# %bb.33:                               #   in Loop: Header=BB3_7 Depth=1
	sub.w	$a1, $zero, $t3
	srli.d	$a6, $a0, 1
	slli.d	$a2, $a2, 1
	sub.d	$a2, $a5, $a2
...
.LBB3_34:                               #   in Loop: Header=BB3_7 Depth=1
	...
	beqz	$a1, .LBB3_47
# %bb.35:                               #   in Loop: Header=BB3_7 Depth=1
	sub.w	$a1, $zero, $t3
	srli.d	$a0, $a0, 1
	slli.d	$a2, $a3, 1
	sub.d	$a2, $a4, $a2
	...
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	b	.LBB3_6
.LBB3_36:                               #   in Loop: Header=BB3_7 Depth=1
	add.d	$a6, $t2, $a2
	alsl.d	$a6, $a3, $a6, 1
	addi.d	$a6, $a6, 2
	srli.d	$t8, $a6, 2
