...
.LBB6_32:                               # %vector.ph698
	...
	vldrepl.w	$vr8, $s8, -32
	vldrepl.w	$vr9, $s8, -36
	vldrepl.w	$vr10, $s8, -40
	vldrepl.w	$vr11, $s8, -44
	vldrepl.w	$vr12, $s8, -48
	vldrepl.w	$vr13, $s8, -52
	vldrepl.w	$vr14, $s8, -56
	vldrepl.w	$vr15, $s8, -60
...
.LBB6_33:                               # %vector.body701
	...
	add.d	$a6, $a6, $a3
	vldx	$vr17, $a6, $a3
	vfmul.s	$vr18, $vr13, $vr18
	vfadd.s	$vr16, $vr16, $vr18
	add.d	$a6, $a6, $a3
	vfmul.s	$vr17, $vr12, $vr17
	vldx	$vr18, $a6, $a3
	vfadd.s	$vr16, $vr16, $vr17
	add.d	$a6, $a6, $a3
	vldx	$vr17, $a6, $a3
	vfmul.s	$vr18, $vr11, $vr18
	vfadd.s	$vr16, $vr16, $vr18
	add.d	$a6, $a6, $a3
	vfmul.s	$vr17, $vr10, $vr17
	vldx	$vr18, $a6, $a3
	vfadd.s	$vr16, $vr16, $vr17
	add.d	$a6, $a6, $a3
	vldx	$vr17, $a6, $a3
	vfmul.s	$vr18, $vr9, $vr18
	vfadd.s	$vr16, $vr16, $vr18
	add.d	$a6, $a6, $a3
	vfmul.s	$vr17, $vr8, $vr17
	vldx	$vr18, $a6, $a3
	vfadd.s	$vr16, $vr16, $vr17
	add.d	$a6, $a6, $a3
	vldx	$vr17, $a6, $a3
	vfmul.s	$vr18, $vr7, $vr18
	vfadd.s	$vr16, $vr16, $vr18
	add.d	$a6, $a6, $a3
	vfmul.s	$vr17, $vr6, $vr17
	vldx	$vr18, $a6, $a3
	vfadd.s	$vr16, $vr16, $vr17
	add.d	$a6, $a6, $a3
	vldx	$vr17, $a6, $a3
	vfmul.s	$vr18, $vr5, $vr18
	vfadd.s	$vr16, $vr16, $vr18
	add.d	$a6, $a6, $a3
	vfmul.s	$vr17, $vr4, $vr17
	vldx	$vr18, $a6, $a3
	vfadd.s	$vr16, $vr16, $vr17
	add.d	$a6, $a6, $a3
	vldx	$vr17, $a6, $a3
	vfmul.s	$vr18, $vr3, $vr18
	vfadd.s	$vr16, $vr16, $vr18
	add.d	$a6, $a6, $a3
	vfmul.s	$vr17, $vr2, $vr17
	vldx	$vr18, $a6, $a3
	add.d	$a6, $a6, $a3
	vldx	$vr19, $a6, $a3
	vfadd.s	$vr16, $vr16, $vr17
...
.LBB6_78:                               # %vector.body547
	...
	vfadd.s	$vr8, $vr9, $vr8
	vldx	$vr9, $fp, $a0
	vfmul.s	$vr10, $vr6, $vr10
	vfadd.s	$vr8, $vr8, $vr10
	vldx	$vr10, $s0, $a0
	vfmul.s	$vr9, $vr5, $vr9
	vfadd.s	$vr8, $vr8, $vr9
	vldx	$vr9, $s1, $a0
	vfmul.s	$vr10, $vr4, $vr10
	vfadd.s	$vr8, $vr8, $vr10
	vldx	$vr10, $s2, $a0
	vfmul.s	$vr9, $vr3, $vr9
	vfadd.s	$vr8, $vr8, $vr9
	vldx	$vr9, $s3, $a0
	vfmul.s	$vr10, $vr2, $vr10
	vldx	$vr11, $s4, $a0
	vfadd.s	$vr8, $vr8, $vr10
	vfmul.s	$vr9, $vr1, $vr9
	vfadd.s	$vr8, $vr8, $vr9
	vfmul.s	$vr9, $vr0, $vr11
	vfadd.s	$vr8, $vr8, $vr9
	vstx	$vr8, $a4, $a0
	addi.d	$a0, $a0, 16
	bne	$a1, $a0, .LBB6_78
