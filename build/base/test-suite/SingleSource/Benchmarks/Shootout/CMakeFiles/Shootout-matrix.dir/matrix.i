# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Shootout/matrix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Shootout/matrix.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Shootout/matrix.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Shootout/matrix.c" 2
...
int main(int argc, char *argv[]) {
    ...
    int **m1 = mkmatrix(10, 10);
    int **m2 = mkmatrix(10, 10);
    int **mm = mkmatrix(10, 10);

    for (i=0; i<n; i++) {
 mm = mmult(10, 10, m1, m2, mm);
    }
