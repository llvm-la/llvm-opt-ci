# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/evalloop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/evalloop.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/evalloop.c"
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/evalloop.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/evalloop.c" 2
...
void eval(int *p) {
  ...
  while (1) {
    switch(*p++) {
      L0: opcode = 0; case 0: { return; }
      L1: opcode = 1; case 1: { execute (opcode); goto *dispatch[*p++]; }
      L2: opcode = 2; case 2: { execute (opcode); goto *dispatch[*p++]; }
      L3: opcode = 3; case 3: { execute (opcode); goto *dispatch[*p++]; }
      L4: opcode = 4; case 4: { execute (opcode); goto *dispatch[*p++]; }
      L5: opcode = 5; case 5: { execute (opcode); goto *dispatch[*p++]; }
      L6: opcode = 6; case 6: { execute (opcode); goto *dispatch[*p++]; }
      L7: opcode = 7; case 7: { execute (opcode); goto *dispatch[*p++]; }
      L8: opcode = 8; case 8: { execute (opcode); goto *dispatch[*p++]; }
      L9: opcode = 9; case 9: { execute (opcode); goto *dispatch[*p++]; }
      L10: opcode = 10; case 10: { execute (opcode); goto *dispatch[*p++]; }
      L11: opcode = 11; case 11: { execute (opcode); goto *dispatch[*p++]; }
      L12: opcode = 12; case 12: { execute (opcode); goto *dispatch[*p++]; }
      L13: opcode = 13; case 13: { execute (opcode); goto *dispatch[*p++]; }
      L14: opcode = 14; case 14: { execute (opcode); goto *dispatch[*p++]; }
      L15: opcode = 15; case 15: { execute (opcode); goto *dispatch[*p++]; }
      L16: opcode = 16; case 16: { execute (opcode); goto *dispatch[*p++]; }
      L17: opcode = 17; case 17: { execute (opcode); goto *dispatch[*p++]; }
      L18: opcode = 18; case 18: { execute (opcode); goto *dispatch[*p++]; }
      L19: opcode = 19; case 19: { execute (opcode); goto *dispatch[*p++]; }
      L20: opcode = 20; case 20: { execute (opcode); goto *dispatch[*p++]; }
      L21: opcode = 21; case 21: { execute (opcode); goto *dispatch[*p++]; }
      L22: opcode = 22; case 22: { execute (opcode); goto *dispatch[*p++]; }
      L23: opcode = 23; case 23: { execute (opcode); goto *dispatch[*p++]; }
      L24: opcode = 24; case 24: { execute (opcode); goto *dispatch[*p++]; }
      L25: opcode = 25; case 25: { execute (opcode); goto *dispatch[*p++]; }
      L26: opcode = 26; case 26: { execute (opcode); goto *dispatch[*p++]; }
      L27: opcode = 27; case 27: { execute (opcode); goto *dispatch[*p++]; }
      L28: opcode = 28; case 28: { execute (opcode); goto *dispatch[*p++]; }
      L29: opcode = 29; case 29: { execute (opcode); goto *dispatch[*p++]; }
      L30: opcode = 30; case 30: { execute (opcode); goto *dispatch[*p++]; }
      L31: opcode = 31; case 31: { execute (opcode); goto *dispatch[*p++]; }
    }
  }
}
