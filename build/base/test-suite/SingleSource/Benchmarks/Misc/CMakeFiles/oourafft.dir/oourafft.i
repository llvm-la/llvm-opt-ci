# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c"
int main()
{
  int i, j;
  int *ip;
  ...
  ip = memalign(16, sqrt(1024)*sizeof(int));
  w = memalign(16, 2*1024*5/4*sizeof(double));
  ...
  ref = memalign(16, 2*1024*sizeof(double));
  cmp = memalign(16, 2*1024*sizeof(double));
  src = memalign(16, 2*1024*sizeof(double));
  ...
  putdata(0, 2*1024 - 1, ref);
  cdft(2*1024, 1, ref, ip, w);
  cdft(2*1024, -1, ref, ip, w);
  err_val = errorcheck(0, 2*1024 - 1, 1.0/1024, ref);
  ...
  memset(ref, 0, 2*1024*sizeof(double));
  putdata(0, 1024 -1, ref);
  cdft(2*1024, 1, ref, ip, w);
  for (j=0; j<1024; ++j)
    ref[2*j+1] = -ref[2*j+1];


  memset(src, 0, 2*1024*sizeof(double));
  putdata(0, 1024 -1, src);

  t_start = get_time();
  for (i=0; i<150000; ++i) {
    int k;

    memcpy(cmp, src, 2*1024*sizeof(double));
    cdft(2*1024, 1, cmp, ip, w);
...
void putdata(int nini, int nend, double *a)
{
  ...
  for (j = nini; j <= nend; j++)
    a[j] = ((*(&seed) = (*(&seed) * 7141 + 54773) % 259200) * (1.0 / 259200.0));
}
...
double errorcheck(int nini, int nend, double scale, double *a)
{
  ...
  for (j = nini; j <= nend; j++) {
    e = ((*(&seed) = (*(&seed) * 7141 + 54773) % 259200) * (1.0 / 259200.0)) - a[j] * scale;
    err = ((err) > (fabs(e)) ? (err) : (fabs(e)));
  }
  return err;
}
# 160 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c"
...
# 161 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/oourafft.c" 2
