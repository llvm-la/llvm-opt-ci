# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/exptree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/exptree.c" 2
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/exptree.c"
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/exptree.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/exptree.c" 2
...

{
    ...
    {
 case 1: return comb->operand1 + comb->operand2;
 case 2: return comb->operand1 - comb->operand2;
 case 3: return comb->operand1 * comb->operand2;
 case 4: return comb->operand1 / comb->operand2;
...

{
    ...
    < abs( best - goal ) )
 {
  ...
  stopSearch = 1;
    ...
    {
 int working1, working2;

 int temp;


 for( currOp = 1; currOp <= 4; currOp++ )
 {
