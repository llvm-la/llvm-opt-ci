# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvpermi_q.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 401 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvpermi_q.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvpermi_q.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvpermi_q.c" 2
...
main ()
{
  ...
  __m256i_result = (__m256i){0x7fff7fff7fff0000, 0x7fe37fe3001d001d,
                             0x7fff7fff7fff0000, 0x7fe37fe3001d001d};
  __m256i_out = ((__m256i)__builtin_lasx_xvpermi_q((v32i8)((__m256)v4u64_op0), (v32i8)((__m256)v4u64_op1), (0x22)));
  check_lasx_out(&__m256i_result, &__m256i_out, sizeof(__m256i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvpermi_q.c", 26);
  ...
  __m256i_result = (__m256i){0x00ff00ff00ff00ff, 0x00ff00ff00ff00ff,
                             0xffff0000ffff0000, 0xffffffffffffffff};
  __m256i_out = ((__m256i)__builtin_lasx_xvpermi_q((v32i8)((__m256)v4u64_op0), (v32i8)((__m256)v4u64_op1), (0x2)));
  check_lasx_out(&__m256i_result, &__m256i_out, sizeof(__m256i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvpermi_q.c", 35);
  ...
  __m256i_result = (__m256i){0x00000000000001fe, 0x0000000000000000,
                             0x000000000019001c, 0x0000000000000000};
  __m256i_out = ((__m256i)__builtin_lasx_xvpermi_q((v32i8)((__m256)v4u64_op0), (v32i8)((__m256)v4u64_op1), (0x31)));
  check_lasx_out(&__m256i_result, &__m256i_out, sizeof(__m256i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvpermi_q.c", 44);
