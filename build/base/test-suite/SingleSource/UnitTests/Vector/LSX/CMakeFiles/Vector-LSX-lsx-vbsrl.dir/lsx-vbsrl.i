# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c" 2
...
main ()
{
  ...
  __m128i_out = ((__m128i)__builtin_lsx_vbsrl_v((v16i8)((__m128)v2u64_op0), (0x2)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c", 22);

  v2u64_op0 = (v2u64){0x000000003fffffff, 0x000000003fffffff};
  __m128i_result = (__m128i){0x003fffffff000000, 0x0000000000000000};
  __m128i_out = ((__m128i)__builtin_lsx_vbsrl_v((v16i8)((__m128)v2u64_op0), (0x5)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c", 27);

  v2u64_op0 = (v2u64){0x0000000100010001, 0x0005fe0300010101};
  __m128i_result = (__m128i){0xfe03000101010000, 0x0000000000000005};
  __m128i_out = ((__m128i)__builtin_lsx_vbsrl_v((v16i8)((__m128)v2u64_op0), (0x6)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c", 32);

  v2u64_op0 = (v2u64){0x0000000000000000, 0x0000000000000000};
  __m128i_result = (__m128i){0x0000000000000000, 0x0000000000000000};
  __m128i_out = ((__m128i)__builtin_lsx_vbsrl_v((v16i8)((__m128)v2u64_op0), (0x13)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c", 37);

  v2u64_op0 = (v2u64){0xf9796558e39953fd, 0xd3259a2984048c23};
  __m128i_result = (__m128i){0x0000000000d3259a, 0x0000000000000000};
  __m128i_out = ((__m128i)__builtin_lsx_vbsrl_v((v16i8)((__m128)v2u64_op0), (0xd)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vbsrl.c", 42);
