# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c" 2
...
main ()
{
  ...
  __m128i_out = ((__m128i)__builtin_lsx_vxori_b((v16u8)((__m128)v2u64_op0), (0x4)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c", 22);

  v2u64_op0 = (v2u64){0x0000000001000100, 0x0000000001000100};
  __m128i_result = (__m128i){0x5a5a5a5a5b5a5b5a, 0x5a5a5a5a5b5a5b5a};
  __m128i_out = ((__m128i)__builtin_lsx_vxori_b((v16u8)((__m128)v2u64_op0), (0x5a)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c", 27);

  v2u64_op0 = (v2u64){0x0000000000000000, 0x0000000000000000};
  __m128i_result = (__m128i){0xe3e3e3e3e3e3e3e3, 0xe3e3e3e3e3e3e3e3};
  __m128i_out = ((__m128i)__builtin_lsx_vxori_b((v16u8)((__m128)v2u64_op0), (0xe3)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c", 32);

  v2u64_op0 = (v2u64){0x0020002000200020, 0x0000000000000000};
  __m128i_result = (__m128i){0x9aba9aba9aba9aba, 0x9a9a9a9a9a9a9a9a};
  __m128i_out = ((__m128i)__builtin_lsx_vxori_b((v16u8)((__m128)v2u64_op0), (0x9a)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c", 37);

  v2u64_op0 = (v2u64){0x0000000000000000, 0x0000000000000000};
  __m128i_result = (__m128i){0x9090909090909090, 0x9090909090909090};
  __m128i_out = ((__m128i)__builtin_lsx_vxori_b((v16u8)((__m128)v2u64_op0), (0x90)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c", 42);

  v2u64_op0 = (v2u64){0x0000000077af9450, 0x00000000b81c8382};
  __m128i_result = (__m128i){0xf1f1f1f1865e65a1, 0xf1f1f1f149ed7273};
  __m128i_out = ((__m128i)__builtin_lsx_vxori_b((v16u8)((__m128)v2u64_op0), (0xf1)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vxori.c", 47);
