# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/multiplies.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/multiplies.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/helpers.h" 1
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/helpers.h" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/multiplies.c" 2


double TheArray[100000] __attribute__((aligned));
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/multiplies.c"
int main(int argc, char **Argv) {
  unsigned i, j;
  for (i = 0; i < 100000; ++i)
    TheArray[i] = i*12.345;

  { v16i8 V = (v16i8)((v4i32){0,0,0,0}); v16i8 *AP = (v16i8*)TheArray; IV vu; for (j = 0; j < 1000; ++j) for (i = 0; i != sizeof(TheArray)/sizeof(v16i8); ++i) V *= AP[i]; vu.V = (v4i32)V; printIV(&vu); };
  { v8i16 V = (v8i16)((v4i32){0,0,0,0}); v8i16 *AP = (v8i16*)TheArray; IV vu; for (j = 0; j < 1000; ++j) for (i = 0; i != sizeof(TheArray)/sizeof(v8i16); ++i) V *= AP[i]; vu.V = (v4i32)V; printIV(&vu); };
  { v4i32 V = (v4i32)((v4i32){0,0,0,0}); v4i32 *AP = (v4i32*)TheArray; IV vu; for (j = 0; j < 1000; ++j) for (i = 0; i != sizeof(TheArray)/sizeof(v4i32); ++i) V *= AP[i]; vu.V = (v4i32)V; printIV(&vu); };
  { v2i64 V = (v2i64)((v4i32){0,0,0,0}); v2i64 *AP = (v2i64*)TheArray; IV vu; for (j = 0; j < 1000; ++j) for (i = 0; i != sizeof(TheArray)/sizeof(v2i64); ++i) V *= AP[i]; vu.V = (v4i32)V; printIV(&vu); };
