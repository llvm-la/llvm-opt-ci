# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/rem.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/rem.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/rem.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/rem.c" 2
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/rem.c"
...
# 94 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/rem.c"
int main(int argc, char **argv) {
# 103 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/rem.c"
    unsigned idx = 0;
    for (; idx < 100; ++idx) {
        ...
        if (!(((x_s) != (y_s)) || (((x_s) % (m)) == ((y_s) % (m))))) { printf("Test #%u, failed in iteration #: %u\n", 1, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((x_s) != (y_u)) || (((x_s) % (m)) == ((y_u) % (m))))) { printf("Test #%u, failed in iteration #: %u\n", 2, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((x_u) != (y_s)) || (((x_u) % (m)) == ((y_s) % (m))))) { printf("Test #%u, failed in iteration #: %u\n", 3, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((x_u) != (y_u)) || (((x_u) % (m)) == ((y_u) % (m))))) { printf("Test #%u, failed in iteration #: %u\n", 4, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };

        if (!(((((x_u)%(m)) + ((y_u)%(m))) < ((x_u)%(m))) || ((((x_u)) + ((y_u))) < ((x_u))) || (((((x_u) % (m)) + ((y_u) % (m))) % m) == (((x_u) + (y_u)) % (m))))) { printf("Test #%u, failed in iteration #: %u\n", 5, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };

        if (!(((((y_u)) + ((z_u))) < ((y_u))) || ((((x_u)) - ((z_u))) > ((x_u))) || ((((x_u) % (m)) == (((y_u) + (z_u)) % (m))) % m) == ((((x_u) - (z_u)) % (m)) == ((y_u) % (m))))) { printf("Test #%u, failed in iteration #: %u\n", 6, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };

        if (!(((((y_u) * (m)) / (m)) != (y_u)) || ((((x_u)) + ((y_u)*(m))) < ((x_u))) || (((x_u) % (m)) == (((x_u) + ((y_u)*(m))) % (m))))) { printf("Test #%u, failed in iteration #: %u\n", 7, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };

        if (!((gcd((z_s),(m)) != 1) || ((z_s) == 0) || (gcd((x_s),(z_s)) != (z_s)) || ((gcd((y_s),(z_s)) != (z_s))) || (((x_s) % (m)) == ((y_s) % (m))) == (((((x_s) / (z_s)) % m) == (((y_s) / (z_s))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 8, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!((gcd((z_u),(m)) != 1) || ((z_u) == 0) || (gcd((x_s),(z_u)) != (z_u)) || ((gcd((y_s),(z_u)) != (z_u))) || (((x_s) % (m)) == ((y_s) % (m))) == (((((x_s) / (z_u)) % m) == (((y_s) / (z_u))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 9, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!((gcd((z_s),(m)) != 1) || ((z_s) == 0) || (gcd((x_s),(z_s)) != (z_s)) || ((gcd((y_u),(z_s)) != (z_s))) || (((x_s) % (m)) == ((y_u) % (m))) == (((((x_s) / (z_s)) % m) == (((y_u) / (z_s))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 10, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!((gcd((z_u),(m)) != 1) || ((z_u) == 0) || (gcd((x_s),(z_u)) != (z_u)) || ((gcd((y_u),(z_u)) != (z_u))) || (((x_s) % (m)) == ((y_u) % (m))) == (((((x_s) / (z_u)) % m) == (((y_u) / (z_u))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 11, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!((gcd((z_s),(m)) != 1) || ((z_s) == 0) || (gcd((x_u),(z_s)) != (z_s)) || ((gcd((y_s),(z_s)) != (z_s))) || (((x_u) % (m)) == ((y_s) % (m))) == (((((x_u) / (z_s)) % m) == (((y_s) / (z_s))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 12, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!((gcd((z_u),(m)) != 1) || ((z_u) == 0) || (gcd((x_u),(z_u)) != (z_u)) || ((gcd((y_s),(z_u)) != (z_u))) || (((x_u) % (m)) == ((y_s) % (m))) == (((((x_u) / (z_u)) % m) == (((y_s) / (z_u))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 13, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!((gcd((z_s),(m)) != 1) || ((z_s) == 0) || (gcd((x_u),(z_s)) != (z_s)) || ((gcd((y_u),(z_s)) != (z_s))) || (((x_u) % (m)) == ((y_u) % (m))) == (((((x_u) / (z_s)) % m) == (((y_u) / (z_s))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 14, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!((gcd((z_u),(m)) != 1) || ((z_u) == 0) || (gcd((x_u),(z_u)) != (z_u)) || ((gcd((y_u),(z_u)) != (z_u))) || (((x_u) % (m)) == ((y_u) % (m))) == (((((x_u) / (z_u)) % m) == (((y_u) / (z_u))) % m)))) { printf("Test #%u, failed in iteration #: %u\n", 15, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };

        if (!(((z_s) == 0) || (gcd((x_s),(z_s)) != (z_s)) || (gcd((y_s),(z_s)) != (z_s)) || (gcd((m),(z_s)) != (z_s)) || (((x_s)%(m)) == ((y_s)%(m))) == ((((x_s)/(z_s)) % ((m)/(z_s))) == (((y_s)/(z_s)) % ((m)/(z_s)))))) { printf("Test #%u, failed in iteration #: %u\n", 16, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_u) == 0) || (gcd((x_s),(z_u)) != (z_u)) || (gcd((y_s),(z_u)) != (z_u)) || (gcd((m),(z_u)) != (z_u)) || (((x_s)%(m)) == ((y_s)%(m))) == ((((x_s)/(z_u)) % ((m)/(z_u))) == (((y_s)/(z_u)) % ((m)/(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 17, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_s) == 0) || (gcd((x_s),(z_s)) != (z_s)) || (gcd((y_u),(z_s)) != (z_s)) || (gcd((m),(z_s)) != (z_s)) || (((x_s)%(m)) == ((y_u)%(m))) == ((((x_s)/(z_s)) % ((m)/(z_s))) == (((y_u)/(z_s)) % ((m)/(z_s)))))) { printf("Test #%u, failed in iteration #: %u\n", 18, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_u) == 0) || (gcd((x_s),(z_u)) != (z_u)) || (gcd((y_u),(z_u)) != (z_u)) || (gcd((m),(z_u)) != (z_u)) || (((x_s)%(m)) == ((y_u)%(m))) == ((((x_s)/(z_u)) % ((m)/(z_u))) == (((y_u)/(z_u)) % ((m)/(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 19, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_s) == 0) || (gcd((x_u),(z_s)) != (z_s)) || (gcd((y_s),(z_s)) != (z_s)) || (gcd((m),(z_s)) != (z_s)) || (((x_u)%(m)) == ((y_s)%(m))) == ((((x_u)/(z_s)) % ((m)/(z_s))) == (((y_s)/(z_s)) % ((m)/(z_s)))))) { printf("Test #%u, failed in iteration #: %u\n", 20, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_u) == 0) || (gcd((x_u),(z_u)) != (z_u)) || (gcd((y_s),(z_u)) != (z_u)) || (gcd((m),(z_u)) != (z_u)) || (((x_u)%(m)) == ((y_s)%(m))) == ((((x_u)/(z_u)) % ((m)/(z_u))) == (((y_s)/(z_u)) % ((m)/(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 21, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_s) == 0) || (gcd((x_u),(z_s)) != (z_s)) || (gcd((y_u),(z_s)) != (z_s)) || (gcd((m),(z_s)) != (z_s)) || (((x_u)%(m)) == ((y_u)%(m))) == ((((x_u)/(z_s)) % ((m)/(z_s))) == (((y_u)/(z_s)) % ((m)/(z_s)))))) { printf("Test #%u, failed in iteration #: %u\n", 22, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_u) == 0) || (gcd((x_u),(z_u)) != (z_u)) || (gcd((y_u),(z_u)) != (z_u)) || (gcd((m),(z_u)) != (z_u)) || (((x_u)%(m)) == ((y_u)%(m))) == ((((x_u)/(z_u)) % ((m)/(z_u))) == (((y_u)/(z_u)) % ((m)/(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 23, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };

        if (!(((z_u) == 0) || (gcd((m),(z_u)) != (z_u)) || ((((x_s)%(m)) == ((y_s)%(m))) == (((x_s)%(z_u)) == ((y_s)%(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 25, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_u) == 0) || (gcd((m),(z_u)) != (z_u)) || ((((x_s)%(m)) == ((y_u)%(m))) == (((x_s)%(z_u)) == ((y_u)%(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 27, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_u) == 0) || (gcd((m),(z_u)) != (z_u)) || ((((x_u)%(m)) == ((y_s)%(m))) == (((x_u)%(z_u)) == ((y_s)%(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 29, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
        if (!(((z_u) == 0) || (gcd((m),(z_u)) != (z_u)) || ((((x_u)%(m)) == ((y_u)%(m))) == (((x_u)%(z_u)) == ((y_u)%(z_u)))))) { printf("Test #%u, failed in iteration #: %u\n", 31, idx); printf("Failing test vector:\n"); printf("m=%u, x_u=%u, y_u=%u, z_u=%u, x_s=%d, y_s=%d, z_s=%d\n", m, x_u, y_u, z_u, x_s, y_s, z_s); return 1; };
    }
    printf("\n *** REM test done! ***\n");
    return 0;
}
