# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.le.data32.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.le.data32.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.le.data32.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.le.data32.c" 2
...
static __attribute__((noinline)) uint16_t crc_loop(uint16_t crc_initval, uint32_t data) {
  ...
  { for (size_t i = 0; i < (sizeof(data) * 8); ++i) { uint16_t xor_crc_data = crc ^ data; uint16_t crc_lshr = crc >> 1; crc = (xor_crc_data & 1) ? (crc_lshr ^ -24575) : crc_lshr; data >>= 1; } };
  return crc;
}
