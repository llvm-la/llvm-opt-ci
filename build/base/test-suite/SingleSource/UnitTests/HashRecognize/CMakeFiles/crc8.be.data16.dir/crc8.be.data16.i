# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc8.be.data16.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc8.be.data16.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc8.be.data16.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc8.be.data16.c" 2



static __attribute__((noinline)) uint8_t crc_loop(uint8_t crc_initval, uint16_t data) {
  uint8_t crc = crc_initval;


  { for (size_t i = 0; i < (sizeof(data) * 8); ++i) { uint8_t xor_crc_data = crc ^ data; uint8_t crc_shl = crc << 1; crc = (xor_crc_data & (1 << ((sizeof(uint8_t) * 8) - 1))) ? (crc_shl ^ 0x1D) : crc_shl; data <<= 1; } };
  return crc;
}
