...
.Ltmp251:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp252:                               # EH_LABEL
.LBB1_41:                               # %vector.body1232.preheader
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	vreplgr2vr.w	$vr0, $a0
	ori	$fp, $s2, 16
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB1_42:                               # %vector.body1232
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $a1, $s3
	vstx	$vr0, $a0, $s2
	addi.d	$s3, $s3, 32
...
.Ltmp278:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp279:                               # EH_LABEL
.LBB1_54:                               # %vector.body1238.preheader
	lu12i.w	$a0, -1
	vldi	$vr0, -3456
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB1_55:                               # %vector.body1238
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a2, $a0
	vstx	$vr0, $a1, $s2
	addi.d	$a0, $a0, 32
