# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2003-05-26-Shorts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2003-05-26-Shorts.c" 2
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2003-05-26-Shorts.c"
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2003-05-26-Shorts.c" 2
...
main(int argc, char** argv)
{
  ...
  unsigned int uiprod = (ui+1u) * (ui+1u)
    - (unsigned int ) (ui << 2) - (unsigned int ) 1u;
  unsigned short usprod = (us+1u) * (us+1u)
    - (unsigned short) (us << 2) - (unsigned short) 1u;
  unsigned char ubprod = (ub+1u) * (ub+1u)
