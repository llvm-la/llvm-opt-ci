# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2003-07-10-SignConversions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2003-07-10-SignConversions.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2003-07-10-SignConversions.c" 2
...
int main()
{
  ...
  unsigned short us = (unsigned short) SC80;
  unsigned short us2 = (unsigned short) UC80;
           short s = ( short) SC80;
           short s2 = ( short) UC80;
  ...
  unsigned char uc = (unsigned char ) SC80;
  unsigned char uc2 = (unsigned char ) UC80;
  signed char sc = (signed char ) SC80;
  signed char sc2 = (signed char ) UC80;
