# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/PR491.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/PR491.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/PR491.c" 2
...
int test(int r) {
    ...
    u.l = 0; u.c[0] = 0x80;
    r &= ((u.l == 128) ? 1 : assert_fail("u.l == 128",22));
    u.l = 0; u.c[sizeof(long)-1] = 0x80;
    r &= ((u.l < 0) ? 1 : assert_fail("u.l < 0",24));
    return r;
}
