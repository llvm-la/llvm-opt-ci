# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/920501-8.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/920501-8.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/920501-8.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/920501-8.c" 2
...
va (int a, double b, int c, ...)
{
  ...
  f = __builtin_va_arg(ap, int);
  g = __builtin_va_arg(ap, int);
  h = __builtin_va_arg(ap, int);
  i = __builtin_va_arg(ap, int);
  j = __builtin_va_arg(ap, int);
  k = __builtin_va_arg(ap, int);
  l = __builtin_va_arg(ap, int);
  m = __builtin_va_arg(ap, int);
