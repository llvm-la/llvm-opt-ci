# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c" 2
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c" 1
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c"
  case 0: vfprintf (stdout, "hello", ap); if (vfprintf (stdout, "hello", ap2) != 5) abort (); break;;
  case 1: vfprintf (stdout, "hello\n", ap); if (vfprintf (stdout, "hello\n", ap2) != 6) abort (); break;;
  case 2: vfprintf (stdout, "a", ap); if (vfprintf (stdout, "a", ap2) != 1) abort (); break;;
  case 3: vfprintf (stdout, "", ap); if (vfprintf (stdout, "", ap2) != 0) abort (); break;;
  case 4: vfprintf (stdout, "%s", ap); if (vfprintf (stdout, "%s", ap2) != 5) abort (); break;;
  case 5: vfprintf (stdout, "%s", ap); if (vfprintf (stdout, "%s", ap2) != 6) abort (); break;;
  case 6: vfprintf (stdout, "%s", ap); if (vfprintf (stdout, "%s", ap2) != 1) abort (); break;;
  case 7: vfprintf (stdout, "%s", ap); if (vfprintf (stdout, "%s", ap2) != 0) abort (); break;;
  case 8: vfprintf (stdout, "%c", ap); if (vfprintf (stdout, "%c", ap2) != 1) abort (); break;;
  case 9: vfprintf (stdout, "%s\n", ap); if (vfprintf (stdout, "%s\n", ap2) != 7) abort (); break;;
  case 10: vfprintf (stdout, "%d\n", ap); if (vfprintf (stdout, "%d\n", ap2) != 2) abort (); break;;
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c" 2
...
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c"
  ...
  inner (9, "hello\n");;
  inner (10, 0);;
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/vfprintf-1.c" 2
