# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/AnisotropicDiffusion/anisotropicDiffusionKernel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/AnisotropicDiffusion/anisotropicDiffusionKernel.c" 2
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/AnisotropicDiffusion/diffusion.h" 1
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/AnisotropicDiffusion/anisotropicDiffusionKernel.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/AnisotropicDiffusion/anisotropicDiffusionKernel.c" 2



void anisotropicDiffusionKernel(int height, int width,
                                int inputImage[512][512],
  ...
  for (k = 0; k < no_iteration; k++) {
    for (i = 2; i < height - 2; i++) {
      for (j = 2; j < width - 2; j++) {
        ...
        ne = exp(-(grad_final * grad_final) / 0.5 *
                 0.5) *
        ...
        gradient_y = inputImage[i + 1][j - 1] - inputImage[i - 1][j - 1];
        grad_final = gradient_x + gradient_y;
        nw = exp(-(grad_final * grad_final) / 0.5 *
                 0.5) *
             (inputImage[i][j - 1] - inputImage[i][j]);
        ...
        grad_final = gradient_x + gradient_y;
        nn = exp(-(grad_final * grad_final) / 0.5 *
                 0.5) *
        ...
        grad_final = gradient_x + gradient_y;
        ns = exp(-(grad_final * grad_final) / 0.5 *
                 0.5) *
             (inputImage[i + 1][j] - inputImage[i][j]);

        outputImage[i][j] = inputImage[i][j] + (1.0 / 8) * (ne + nw + nn + ns);
      }
    }
  }
}
