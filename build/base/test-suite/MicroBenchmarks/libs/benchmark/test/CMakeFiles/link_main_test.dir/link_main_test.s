...
.Lfunc_end1:
	...
	.p2align	5                               # -- Begin function _GLOBAL__sub_I_link_main_test.cc
...
# %bb.2:                                # %_ZNKSt14default_deleteIN9benchmark9BenchmarkEEclEPS1_.exit.i.i
	...
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
.LBB2_3:                                # %_ZNSt10unique_ptrIN9benchmark9BenchmarkESt14default_deleteIS1_EED2Ev.exit.i
	ld.d	$a0, $sp, 16
	st.d	$zero, $sp, 24
	beqz	$a0, .LBB2_5
# %bb.4:                                # %_ZNKSt14default_deleteIN9benchmark8internal17FunctionBenchmarkEEclEPS2_.exit.i.i
	...
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
.LBB2_5:                                # %__cxx_global_var_init.1.exit
...
# %bb.7:                                # %_ZNSt10unique_ptrIN9benchmark9BenchmarkESt14default_deleteIS1_EED2Ev.exit4.i
	...
	st.d	$zero, $sp, 24
	bnez	$a0, .LBB2_10
.LBB2_8:                                # %_ZNSt10unique_ptrIN9benchmark8internal17FunctionBenchmarkESt14default_deleteIS2_EED2Ev.exit7.i
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB2_9:                                # %_ZNKSt14default_deleteIN9benchmark9BenchmarkEEclEPS1_.exit.i3.i
	ld.d	$a0, $a1, 0
	ld.d	$a2, $a0, 8
	move	$a0, $a1
	jirl	$ra, $a2, 0
	...
	st.d	$zero, $sp, 24
	beqz	$a0, .LBB2_8
.LBB2_10:                               # %_ZNKSt14default_deleteIN9benchmark8internal17FunctionBenchmarkEEclEPS2_.exit.i6.i
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
	move	$a0, $fp
	...
	jirl	$ra, $ra, 0
.Lfunc_end2:
	.size	_GLOBAL__sub_I_link_main_test.cc, .Lfunc_end2-_GLOBAL__sub_I_link_main_test.cc
	.cfi_endproc
