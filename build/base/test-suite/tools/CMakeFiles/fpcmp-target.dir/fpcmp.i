# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c"
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/build/build-llvm/lib/clang/22/include/stdbool.h" 1 3
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c" 2

const char *g_program;



static _Bool isSignedChar(char C) {
  return (C == '+' || C == '-');
}

static _Bool isExponentChar(char C) {
  switch (C) {
  case 'D':
  case 'd':
  case 'e':
...
static _Bool isDigitChar(char C) {
  switch (C) {
...
static _Bool isPossibleStartOfNumber(char C) {
...
static _Bool skip_whitespace(const char **FP, const char *FEnd) {
  _Bool skipped_some = 0;
  while (*FP < FEnd && ((*__ctype_b_loc ())[(int) (((unsigned char)**FP))] & (unsigned short int) _ISspace)) {
    skipped_some = 1;
    ++*FP;
  }
  return skipped_some;
...
static _Bool CompareNumbers(const char *F1P, const char *F2P, const char *F1End,
...
static _Bool contains_non_printable_characters(const char *data) {
  size_t len = strlen(data);
  for (size_t i = 0; i < len; ++i)
    if (!((*__ctype_b_loc ())[(int) ((data[i]))] & (unsigned short int) _ISprint) && !((*__ctype_b_loc ())[(int) ((data[i]))] & (unsigned short int) _ISspace))
      return 1;
  return 0;
}
...
int diff_file(const char *path_a, const char *path_b, _Bool parse_fp,
              double absolute_tolerance, double relative_tolerance,
              _Bool ignore_whitespace) {
  ...
  while (1) {
    ...
    if (!F1NumEnd || !F2NumEnd) {
      ...
      if (*F1P != *F2P)
        break;
# 341 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/fpcmp.c"
      ++F1P, ++F2P;
      continue;
    }
  ...
  _Bool F1AtEnd = F1P >= File1End;
  _Bool F2AtEnd = F2P >= File2End;
  if (!F1AtEnd && !F2AtEnd) {
    fprintf(stderr,
