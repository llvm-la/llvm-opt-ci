# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/trim.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/trim.c" 2
char rcsid_trim[] = "$Id$";
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/trim.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/trim.c" 2
...
extern void doGram();
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/trim.c" 2
...
# 246 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/trim.c"
}
...
trim(t) Item_Set t;
{
 ...
 ((void) 0);
 if (debugTrim) printf("Begin Trim\n");
 if (debugTrim) dumpItem_Set(t);
 ...
 for (m = 0; m < last; m++) {
  ...
  for (j = allpairs[i ][ 0].nextchain; j; j = allpairs[i ][ j].nextchain) {
   ...
   if (!LESSCOST(t->virgin[i].delta, tmp)) {
    ...
    if (debugTrim) printf("Trimmed Chain (%d,%d)\n", i,j);
    goto outer;
   }
