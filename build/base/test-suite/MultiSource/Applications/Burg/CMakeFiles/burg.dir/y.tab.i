# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/y.tab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/y.tab.c" 2
...
# 336 "y.tab.c"
    ...
    if (yystack.s_base == ((void*)0) && yygrowstack(&yystack)) goto yyoverflow;
...
yyinrecovery:
    if (yyerrflag < 3)
    {
        ...
        for (;;)
        {
            if ((yyn = yysindex[*yystack.s_mark]) && (yyn += 256) >= 0 &&
                    yyn <= 262 && yycheck[yyn] == 256)
            {
