# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/main.c" 2
char rcsid_main[] = "$Id$";
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/main.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/main.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/main.c" 2
...
extern void doGram();
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/main.c" 2
...
main(argc, argv) int argc; char **argv;
{
 ...
 if (inFileName) {
  if(freopen(inFileName, "r", stdin)==((void*)0)) {
 ...
 if (outFileName) {
  if ((outfile = fopen(outFileName, "w")) == ((void*)0)) {
 ...
 if (debugTables) foreachList((ListFn) dumpOperator_l, operators);
 if (debugTables) printf("---final set of states ---\n");
 if (debugTables) dumpMapping(globalMap);
