# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c" 2
char rcsid_plank[] = "$Id$";
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c" 2
...
extern void doGram();
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c" 2
...
static int stateCompare (Item_Set *, Item_Set *);
static int ruleCompare (RuleAST *, RuleAST *);
...
renumber()
{
 ...
 for (i = 0; i < max_ruleAST; i++) {
  ...
  sortedRules[i]->rule->lhs->sampleRule = sortedRules[i]->rule;
  base_counter++;
 }
}
...
outPlank(p) Plank p;
{
 ...
 for (i = 0; i < globalMap->count; i++) {
  ...
  for (f = p->fields; f; f = f->next) {
   StateMap sm = (StateMap) f->x;
   fprintf(outfile, "%4d,", sm->value[i] == -1 ? 0 : sm->value[i]);
  }
...
doPlankLabelMacrosSafely(op) Operator op;
{
 ...
 case 2:
  ...
  if (!im0 && !im1) {
   ...
   ((void) 0);
   ((void) 0);
# 810 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/plank.c"
   if (speedflag) {
