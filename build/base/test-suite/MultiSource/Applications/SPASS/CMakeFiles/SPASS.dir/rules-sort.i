# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c" 2
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
...
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.h"
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.h"
...
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.h" 2
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.h" 2
...
LIST inf_BackwardEmptySortPlusPlus(CLAUSE, st_INDEX, SORTTHEORY, FLAGSTORE,
       PRECEDENCE);
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c" 2
...

{
  ...
  LITERAL NextLit;
  CLAUSE Clause;
# 123 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  Result = list_Nil();
...
static CLAUSE inf_BuildConstraintHyperResolvent(CLAUSE Clause, LIST Lits,
      ...
      FLAGSTORE Flags,
      PRECEDENCE Precedence)
# 163 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
 ...
 { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c",258); };
...
# 346 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
...
LIST inf_BackwardSortResolution(CLAUSE GivenClause, st_INDEX Index,
    ...
    FLAGSTORE Flags, PRECEDENCE Precedence)
# 417 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST result;
  int i, ls;
# 430 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  result = list_Nil();
...
LIST inf_ForwardSortResolution(CLAUSE GivenClause, st_INDEX Index,
          SORTTHEORY SortTheory, BOOL Precheck,
          FLAGSTORE Flags, PRECEDENCE Precedence)
# 536 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST Result, TLits, RestLits;
  int i, j, lc;
  BOOL Hit;
  TERM TAtom;
# 551 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  Result = list_Nil();
 ...
 == term_FirstArgument(TAtom))
  ...
  if (!Precheck ||
      inf_SubsortPrecheck(GivenClause, TLits, ((void*)0), Index, SortTheory)) {
...
LIST inf_BackwardEmptySort(CLAUSE GivenClause, st_INDEX Index,
      SORTTHEORY SortTheory, BOOL Precheck,
      FLAGSTORE Flags, PRECEDENCE Precedence)
# 606 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST result;
  int i, ls;
# 619 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  result = list_Nil();
...
LIST inf_ForwardEmptySort(CLAUSE GivenClause, st_INDEX Index,
     ...
     PRECEDENCE Precedence)
# 736 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST Result, TLits, RestLits;
  int i, j, lc, ls;
  BOOL Hit;
  TERM TAtom;
  SYMBOL Var;
# 752 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  Result = list_Nil();
  lc = clause_LastConstraintLitIndex(GivenClause);
  Hit = FALSE;
...
# 817 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST result, unifiers, atomScan, litScan;
# 828 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  result = list_Nil();
...
# 879 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
...

{
  ...
  LITERAL nextLit;
  CLAUSE nextClause;
# 908 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  ...
  for ( ; !list_Empty(candidates); candidates = list_Pop(candidates)) {
    if (!term_IsAtom(list_Car(candidates))) {
...

{
  for ( ; !list_Empty(Literals); Literals = list_Cdr(Literals)) {
    ...
    list_Rplaca(Literals, clause_GetLiteral(actClause, i));
  }
}
...
static LIST inf_ApplyWeakening(CLAUSE Clause, LIST TLits, LIST Partners,
          ...
          PRECEDENCE Precedence)
# 1050 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST scan, parents;
  LIST constraint, antecedent, succedent;
  LIST parentClauses, parentLits;
  int i, bound, depth;
  TERM tSubterm;
  CLAUSE newClause;
# 1067 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
...
static LIST inf_InternWeakening(CLAUSE Clause, LIST TLits, LIST Unifiers,
    ...
    PRECEDENCE Precedence)
# 1221 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  ...
  LIST scan;
# 1236 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  putchar('\n'); clause_Print(Clause);
  fputs("\nT_k = ", stdout);
...
LIST inf_ForwardWeakening(CLAUSE GivenClause, st_INDEX Index,
     ...
     PRECEDENCE Precedence)
# 1362 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST result;
  int i, lc;
  BOOL hit;
# 1375 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  result = list_Nil();
  lc = clause_LastConstraintLitIndex(GivenClause);
  hit = FALSE;
 ...
 result =
   list_Nconc(inf_InternWeakening(GivenClause, tLits, unifiers, ((void*)0),
...

{
  LIST result;
  int i, ls;
# 1456 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  result = list_Nil();
  ls = clause_LastSuccedentLitIndex(GivenClause);
...
LIST inf_ForwardEmptySortPlusPlus(CLAUSE GivenClause, st_INDEX Index,
      SORTTHEORY SortTheory, FLAGSTORE Flags,
      PRECEDENCE Precedence)
# 1551 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
{
  LIST result;
  int i, lc;
  BOOL hit;
# 1565 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  result = list_Nil();
  lc = clause_LastConstraintLitIndex(GivenClause);
  hit = FALSE;
 ...
 if (!list_Empty(unifiers)) {
   ...
   for (j = lc; j > i; j--) {
     ...
     actAtom = clause_GetLiteralAtom(GivenClause, j);
     if (term_FirstArgument(actAtom) == var) {
       tLits = list_Cons((POINTER)j, tLits);
...

{
  LIST result;
  int i, ls;
# 1663 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
  result = list_Nil();
  ls = clause_LastSuccedentLitIndex(GivenClause);
