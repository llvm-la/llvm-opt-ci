# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c" 2
...
const NAT clause_WEIGHTUNDEFINED = (2147483647 *2U +1U);
...

{
  ...
  int Bottom;
  NAT Number;
# 111 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 147 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  LITERAL Result;
# 166 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 187 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  LITERAL Result;
# 206 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Result = (LITERAL)memory_Malloc(sizeof(LITERAL_NODE));
...
# 229 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
# 239 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 254 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{

  TERM Atom;
# 267 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...

{
  ...
  TERM Atom;
# 295 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Atom = clause_LiteralAtom(Lit);
...
int clause_ContainsFolAtom(CLAUSE Clause, BOOL *Prop, BOOL *Grd, BOOL *Monadic,
      BOOL *NonMonadic)
# 509 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int i,Result,Arity;
  BOOL Ground;
...
# 752 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int i, n;
  NAT Weight;
  LITERAL Lit;
...

{
  int i,n;
  NAT Depth,Help;
# 787 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Depth = 0;
  n = clause_Length(Clause);
...

{
  int i,n;
  NAT Size;
# 838 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Size = 0;
  n = clause_Length(Clause);
...

{
  ...
  NAT Weight, Help;
  LITERAL Lit;
# 868 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Weight = 0;
  n = clause_Length(Clause);
...

{
  LIST Scan;
  NAT Weight;
# 905 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 939 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int weight;
  LIST Scan;
  ...
  for (Scan=Clauses; !list_Empty(Scan); Scan=list_Cdr(Scan)) {
    ...
    if (weight < 20)
      ...
      clause_SORT[20] = list_Cons(list_Car(Scan),clause_SORT[20]);
  }
  Scan = list_NumberSort(clause_SORT[20],
    (NAT (*)(POINTER)) clause_Weight);
  clause_SORT[20] = list_Nil();
  for (weight = 20 -1; weight >= 0; weight--) {
...

{
  ...
  LITERAL Result;
# 983 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Result = (LITERAL)memory_Malloc(sizeof(LITERAL_NODE));
  ...
  Result->owningClause = (POINTER)((void*)0);
...

{
  ...
  int Bottom;
  SYMBOL MaxSym,Help;
# 1061 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Bottom = stack_Bottom();
...
{
  int i,n;
# 1221 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
  int i,n;
# 1267 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  n = clause_Length(Clause);
...
{
  int i, li;
# 1294 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 1441 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  NAT *Scan;
# 1453 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 1477 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  NAT Stack, Size;
# 1488 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Size = 0;
  Stack = stack_Bottom();
  do {
    if (VarMap!=((void*)0) && symbol_IsVariable(term_TopSymbol(Term)))
...
# 1527 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  NAT *Map, MapSize, BestSize, Size;
  LIST Best, Scan;
# 1539 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
# 1594 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
# 1631 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
# 1652 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  term_PrintPrefix(clause_LiteralSignedAtom(Literal));
  fflush(stdout);
}
...

{
  ...
  LIST Result;
  int i;
# 1697 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  Result = list_Nil();
...
void clause_ReplaceLiteralSubSet(CLAUSE Clause, int StartIndex,
     ...
     FLAGSTORE FlagStore, PRECEDENCE Precedence)
# 1721 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{

  int i;
  LIST Scan;
# 1749 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
# 1772 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
static __inline__ void clause_FixLiteralSubsetOrder(CLAUSE Clause,
          ...
          FLAGSTORE FlagStore,
          PRECEDENCE Precedence)
# 1790 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{

  LIST literals;
# 1805 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
# 1834 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 2224 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int firstlitleft, lastlitleft;
  int firstlitright, lastlitright;
  int i, j;
...
# 2282 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
...
# 2382 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  CLAUSE Result;
  int i, c, a, s;
...
CLAUSE clause_CreateCrude(LIST Constraint, LIST Antecedent, LIST Succedent,
     BOOL Con)
# 2447 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  CLAUSE Result;
  int i,c,a,s;
...
CLAUSE clause_CreateUnnormalized(LIST Constraint, LIST Antecedent,
     LIST Succedent)
# 2507 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  CLAUSE Result;
  int i,c,a,s;
...
CLAUSE clause_CreateFromLiterals(LIST LitList, BOOL Sorts, BOOL Conclause,
     ...
     PRECEDENCE Precedence)
# 2578 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  CLAUSE Result;
...

{
  ...
  TERM ActAtom;
  int i,k,NewConLits;
# 2643 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
 ...
 clause_SetLiteral(Clause,k,Help);
  ...
  clause_ReInit(Clause, Flags, Precedence);
# 2673 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
}
...
{
  int i, n;
# 2695 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  n = clause_Length(Clause);
...
# 2720 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  if (Clause->splitfield != ((void*)0)) {
...
{
  int i, litnum;
# 2753 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
  int i, length;
# 2781 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  length = clause_Length(Clause);
  ...
  list_Delete(clause_ParentClauses(Clause));
  list_Delete(clause_ParentLiterals(Clause));
# 2806 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  if (Clause->splitfield != ((void*)0)) {
    memory_Free(Clause->splitfield,
  sizeof(SPLITFIELDENTRY) * Clause->splitfield_length);
  }
...
# 2835 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...

{
  ...
  TERM Atom,Copy;
  int i,length;
# 2878 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  length = clause_Length(Clause);
...
{
# 2911 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 3075 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int i, lc, la, length, shift;
  LITERAL *Literals;
# 3089 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
void clause_DeleteLiteral(CLAUSE Clause, int Indice, FLAGSTORE Flags,
     PRECEDENCE Precedence)
# 3137 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
...
void clause_DeleteLiterals(CLAUSE Clause, LIST Indices, FLAGSTORE Flags,
      PRECEDENCE Precedence)
# 3154 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  LITERAL *NewLits;
  int i, j, nc, na, ns, lc, la, olength, nlength;
# 3179 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  nc = 0;
  na = 0;
  ns = 0;
  lc = clause_LastConstraintLitIndex(Clause);
...
{
# 3238 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  return (clause_NumOfSuccLits(Clause) <= 1);
}
...
{
  int i,n;
# 3260 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...

{
  int i,c;
  LIST CVars, LitVars;
# 3290 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  CVars = list_Nil();
...
{
  int i,negs;
# 3340 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...

{
  int i,length;
  LITERAL Lit;
# 3369 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
  LITERAL Lit;
# 3405 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...

{
  LITERAL Lit;
  int i;
# 3439 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
  int i,nc;
# 3476 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...

{
  ...
  int i,l;
  BOOL result = FALSE;
# 3506 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  l = clause_Length(Clause);
...

{
  ...
  LITERAL Lit;
  int i,c,a,s;
# 3560 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
# 3584 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
{
  int i,c,a,s;
# 3666 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  c = clause_NumOfConsLits(Clause);
  a = clause_NumOfAnteLits(Clause);
  s = clause_NumOfSuccLits(Clause);
...

{
  if (string_Equal(RuleName, "App")) return CLAUSE_DELETION;
    ...
    { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c",3811); };
...

{
  ...
  default:
    { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c",3859); };
...
{
  int c,a,s;
# 3896 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
  c = clause_NumOfConsLits(Clause);
  a = clause_NumOfAnteLits(Clause);
  s = clause_NumOfSuccLits(Clause);
...
void clause_SetSpecialFlags(CLAUSE Clause, BOOL SortDecreasing, FLAGSTORE Flags,
       PRECEDENCE Precedence)
# 4050 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  if (SortDecreasing &&
...
# 4072 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  NAT i;
# 4085 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...
BOOL clause_IsPartOfDefinition(CLAUSE Clause, TERM Predicate, int *Index,
          LIST Pair)
# 4182 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  NAT predindex, i;
  BOOL ok;
...
void clause_FPrintCnfDFG(FILE* File, BOOL OnlyProductive, LIST Axioms,
    ...
    PRECEDENCE Precedence)
# 4343 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  LIST scan;
  CLAUSE Clause;
...
void clause_FPrintCnfFormulasDFGProblem(FILE* File, BOOL OnlyProductive,
     ...
     LIST Conjectures, FLAGSTORE Flags,
     PRECEDENCE Precedence)
# 4439 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  LIST scan;
  CLAUSE Clause;
...
# 4545 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int n,j;
  LITERAL Lit;
  TERM Atom;
...
# 4617 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int n,j;
  LITERAL Lit;
  TERM Atom;
...
# 4690 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  int n,j;
  LITERAL Lit;
  TERM Atom;
...

{
  ...
  if (!clause_IsClause(Clause, Flags, Precedence)) {
    { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c",4774); };
  ...
  if ((clause_Weight(Clause) != clause_Weight(Copy)) ||
    ...
    { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c",4783); };
...
# 4802 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
{
  LIST Scan1,Scan2;
  int length;
  int ParentNum;
...
{
# 4866 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
...

{
  ...
  if (!clause_Exists(Clause))
    ...
    fprintf(File, "[%d:", clause_SplitLevel(Clause));
# 4904 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/clause.c"
    clause_FPrintOrigin(File, Clause);
