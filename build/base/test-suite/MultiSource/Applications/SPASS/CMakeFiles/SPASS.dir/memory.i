# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c" 2

unsigned int memory_PAGESIZE;
long memory_MAXMEM;
static int memory__EOF = (-1);
unsigned long memory_NEWBYTES;
unsigned long memory_FREEDBYTES;

const unsigned int memory_ALIGN = sizeof(POINTER);
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
unsigned int memory_MARKSIZE = 0;
unsigned int memory_OFFSET = 0;


const unsigned int memory_MAGICMALLOC = 1;
const unsigned int memory_MAGICFREE = 2;



static MEMORY_RESOURCE memory_PAGES[1024/1 + 1];



MEMORY_RESOURCE * memory_ARRAY[1024];




MEMORY_BIGBLOCKHEADER memory_BIGBLOCKS = ((void*)0);
# 110 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
void memory_Init(long Maxmem)
# 123 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
{
  int i;
  int extra;
  ...
  memory_PAGESIZE = (8 * 1024);
# 175 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
  ...
  while (memory_PAGESIZE < (2*(1024 + memory_MARKSIZE) + extra)) {

    memory_PAGESIZE += (8 * 1024)/2;
  }
  ...
  for (i=1; i<1024; i++) {
    ...
    memory_ARRAY[i] = &memory_PAGES[(i-1)/1];
...
# 240 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
{
...
# 594 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
POINTER memory_Malloc(unsigned int Bytes)
# 605 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
{
  char *NewMemory;

  MEMORY_RESOURCE *Resource;
# 650 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
  if (Bytes >= 1024) {
    unsigned int RealBigBlockSize;
# 669 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
 ...
 memory_MAXMEM -= RealBigBlockSize;
    ...
    if (NewMemory != ((void*)0)) {
      ...
      MEMORY_BIGBLOCKHEADER NewBigBlock;



      NewBigBlock = (MEMORY_BIGBLOCKHEADER) NewMemory;
      NewBigBlock->next = memory_BIGBLOCKS;
      NewBigBlock->previous = ((void*)0);





      if (memory_BIGBLOCKS != ((void*)0)) {
...
# 745 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
...
# 794 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
    }
    else {
...
# 832 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
      }
      else {
...
# 901 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
 Resource->next = NewMemory + Resource->total_size;
      }
    }
  }
# 917 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
  return NewMemory;
}
# 950 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
POINTER memory_Calloc(unsigned int Elements, unsigned int Bytes)
# 959 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
{
  char * mem;
...
{
  int i;
# 1007 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
  for (i = 1; i < 1024; i++) {
 ...
 thispage = nextpage;
  ...
  thisblock = nextblock) {
    ...
    memory_BIGBLOCKS = ((void*)0);
  }
}
# 1055 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
void memory_Print(void)
# 1066 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
{
...
# 1084 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
{
  ...
  fprintf(File,"### Memory demanded:  %lu KBytes\n",
   memory_NEWBYTES/1024);
  fprintf(File,"### Memory freed:     %lu KBytes\n",
   memory_FREEDBYTES/1024);
...

{
  ...
  POINTER ActPage;
  POINTER ActNext;
  POINTER ActEndOfPage;

  unsigned int BlockSize;
# 1163 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
  if (Size >= 1024) {
 ...
 puts("   No request so far");
  ...
  { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c",1192); };
  misc_ErrorReport("\n In memory_PrintAllocatedBlocks:");
...
# 1247 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
    }
  }
...

{
  ...
  POINTER ActFree;
# 1275 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
  if (Size >= 1024) {
    ...
    if (*((int *)ActFree) == (-1)) {
      ...
      fputs("\n\n   Free: ", stdout);
      while (*((int *)ActFree) != (-1)) {
# 1341 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
...
{
# 1390 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
}
...

{
 ...
 { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c",1443); };
...
# 1494 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
}
...

{
  ...
  if (memory_UsedBytes() != 0L) {
    ...
    for (Size = 1; Size < 1024; Size++) {
      ...
      if (*((int *)ActPage) != (-1)) {
# 1580 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
      }
    }
# 1593 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/memory.c"
  }
