# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c" 2
...
int st_STACKPOINTER;
int st_STACKSAVE;
# 78 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
st_INDEX st_IndexCreate(void)
...
# 107 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
# 167 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
# 201 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
# 232 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...

{
  ...
  for (EmptyVariant = ((void*)0), *BestNonVariant = ((void*)0);
       list_Exist(Subnodes);
...
# 278 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
# 359 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
# 387 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
static st_INDEX st_EntryDeleteHelp(const CONTEXT Context, st_INDEX StIndex, POINTER Pointer,
       BOOL* Found)
# 397 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
{
 ...
 list_Rplaca(Subnodes, st_EntryDeleteHelp(Context,
       ...
       Found));
 if (*Found) {
   if (list_DeleteFromList(&(StIndex->subnodes), ((void*)0)))
...

{
  ...
  for (Found = FALSE, Subnodes = StIndex->subnodes;
    ...
    if (subst_Variation(Context, CurrentNode->subst)) {
      ...
      if (Found) {
 StIndex->subnodes = list_PointerDeleteElement(StIndex->subnodes, ((void*)0));
...
# 542 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
# 930 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...

{
  if (st_CURRENT_RETRIEVAL != st_NOP) {
    ...
    default:
      { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c",1217); };
...

{
  SYMBOL FirstDomain;
  POINTER Result;
# 1253 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
  cont_Check();
...

{
  SYMBOL FirstDomain;
  POINTER Result;
# 1310 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
  cont_Check();
...

{
  SYMBOL FirstDomain;
  POINTER Result;
# 1367 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
  cont_Check();
...

{
  SYMBOL FirstDomain;
  POINTER Result;
# 1426 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
  cont_Check();
...

{
  SYMBOL FirstDomain;
  POINTER Result;
# 1483 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
  cont_Check();
...
{
  LIST Result;
# 1541 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
 ...
 NewResult = st_TraverseForExistInstancePreTest(st_INDEX_CONTEXT);
      ...
      default:
 { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c",1577); };
 misc_ErrorReport("\n In st_NextCandidate: Unknown retrieval type.\n");
 { fputs("\n Please report this error via email to spass@mpi-sb.mpg.de including\n the SPASS version, input problem, options, operating system.\n",stderr); misc_DumpCore(); };
      }
    else {
      { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c",1582); };
...
# 1608 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...

{
  ...
  if (st_IsLeaf(St)) {
    ...
    if (Print)
      for (Scan = St->entries; Scan != ((void*)0); Scan = list_Cdr(Scan)) {
 putchar(' ');
 Print(list_Car(Scan));
      }
    else
    ...
    for (Scan = St->subnodes; Scan != ((void*)0); Scan = list_Cdr(Scan))
...

{
  ...
  if (st_IsLeaf(StIndex)) {
    ...
    if (Print)
      for (Scan = StIndex->entries; Scan != ((void*)0); Scan = list_Cdr(Scan)) {
 putchar(' ');
 Print(list_Car(Scan));
      }
    else
    ...
    for (Scan = StIndex->subnodes; Scan != ((void*)0); Scan = list_Cdr(Scan))
