# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c" 2
# 63 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
...

{
  LIST Scan1,Scan2;
  BOOL Found;
# 92 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
...

{
  ...
  for (i = 1; i < symbol_ACTINDEX; i++) {
    Result->basesorttable[i] = (NODE)((void*)0);
...

{
  if (Theory != (SORTTHEORY)((void*)0)) {
    ...
    for (i=1;i<symbol_ACTINDEX;i++)
      if (Theory->basesorttable[i] != (NODE)((void*)0))
...

{
  ...
  term_RplacSupertermList(Term, list_List(Atom));
...

{
  ...
  Theory->suborigcls = list_PointerDeleteElement(Theory->suborigcls,((void*)0));
  for (Scan=Theory->termorigcls;!list_Empty(Scan);Scan=list_Cdr(Scan)) {
    Tuple = list_Car(Scan);
    if ((CLAUSE)list_First(Tuple) == Origin) {
      list_Rplaca(Scan,((void*)0));
  ...
  Theory->termorigcls = list_PointerDeleteElement(Theory->termorigcls,((void*)0));
}
...
{
# 943 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
...
{
# 962 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
  return (list_List(sort_TheoryNode(Theory, Symbol)));
}


static void sort_EvalSubsortNoResidues(SORTTHEORY Theory, LIST Nodes)
# 975 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
{
  NODE Node,Head;
...
# 1048 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
{
  NODE Node,Head;
  LIST Scan;
  SLINK Link;
...
# 1078 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
{
  NODE Node,Head;
  LIST Scan,Help;
  SLINK Link;
...

{
  ...
  NODE Node;
  SORT Top;
# 1133 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
  sort_TheoryIncrementMark(Theory);
...

{
  ...
  for (scan=subst;!subst_Empty(scan);scan=subst_Next(scan)) {
    ...
    if ((Cond = sort_TheoryIsSubsortOfNoResidues(Theory,sort_PairSort(Pair),varsort)) == ((void*)0)) {
...
static SOJU sort_ComputeSortInternNoResidues(SORTTHEORY Theory, TERM Term,
          ...
          FLAGSTORE Flags,
          PRECEDENCE Precedence)
# 1452 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
{
  SORT Sort;
...
# 1505 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
{
  int SubtermStack;
  SOJU SortPair;

  SortPair = (SOJU)((void*)0);
...
# 1542 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
...
# 1657 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
  Result = list_Nil();
...

{
  ...
  LITERAL LitK;
  int i,length,j,lc,pli;
# 1724 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
  Result = list_Nil();
  length = clause_Length(Clause);
 ...
 NewConstraint = sort_ApproxPseudoLinear(NewConstraint,
    ...
    Flags, Precedence);
      ...
      clause_SetFlag(NewClause,WORKEDOFF);
      clause_SetFromClauseDeletion(NewClause);
      clause_SetParentClauses(NewClause, list_List(Clause));
      clause_AddParentLiteral(NewClause, pli);
...
{
  return (SORTTHEORY)((void*)0);
}

STR sort_AnalyzeSortStructure(LIST Clauses, FLAGSTORE Flags,
         PRECEDENCE Precedence)
# 1887 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
{
  SORTTHEORY Theory;
  LIST Scan;
  CLAUSE Clause,Copy;
