# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c" 2
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c"
...
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.h"
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.h" 2
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.h" 2
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c" 2
...
# 74 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c"
{
  SPLIT ActBacktrackSplit;
  LIST RecoverList, Scan;
  int Backtracklevel;

  ActBacktrackSplit = (SPLIT)((void*)0);
  ...
  *SplitClause = ((void*)0);
  ...
  while (!prfs_SplitStackEmpty(PS) && (prfs_ValidLevel(PS) > Backtracklevel)) {
    ...
    if (prfs_SplitFatherClause(ActBacktrackSplit) != (CLAUSE)((void*)0)) {
      RecoverList = list_Cons(prfs_SplitFatherClause(ActBacktrackSplit),
         RecoverList);
      prfs_SplitSetFatherClause(ActBacktrackSplit, ((void*)0));
    }
...
# 143 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c"
 *SplitClause = list_Car(Scan);
      ...
      clause_AddParentLiteral((CLAUSE) list_Car(Scan), 0);
    }
# 161 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c"
...
static LIST split_DeleteClausesDependingOnLevelFromList(PROOFSEARCH Search,
       LIST ClauseList,
       int Level, LIST* New)
# 195 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c"
{
  LIST Scan;
  CLAUSE Clause;
  SPLIT Reinsert;
 ...
 *New = list_Nconc(prfs_SplitDeletedClauses(Reinsert), *New);
 prfs_SplitSetDeletedClauses(Reinsert, list_Nil());
  ...
  return list_PointerDeleteElement(ClauseList, ((void*)0));
}
...
static LIST split_DeleteClausesDependingOnLevelFromSet(PROOFSEARCH PS,
             LIST ClauseList,
             int SplitLevel)
# 229 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/rules-split.c"
{
...

{
  ...
  for (Scan1=prfs_SplitStack(Search);!list_Empty(Scan1);Scan1=list_Cdr(Scan1)) {
    ...
    for (Scan2 = ClauseList; !list_Empty(Scan2); Scan2 = list_Cdr(Scan2)) {
      ...
      if (!prfs_IsClauseValid(Clause,Level)) {
 prfs_InsertDocProofClause(Search,Clause);
 list_Rplaca(Scan2, ((void*)0));
      }
    }
    prfs_SplitSetDeletedClauses(list_Car(Scan1),list_PointerDeleteElement(ClauseList, ((void*)0)));
  }
}
...

{
 ...
 prfs_SplitSetFatherClause(Split,((void*)0));
      }
 ...
 prfs_SplitSetDeletedClauses(ScanSplit, list_Nil());
...

{
  ...
  Clauses = list_PointerDeleteElement(Clauses,((void*)0));
