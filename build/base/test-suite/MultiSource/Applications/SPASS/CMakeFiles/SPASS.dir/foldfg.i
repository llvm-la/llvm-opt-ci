# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c" 2
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/flags.h" 2
...
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c" 2
...
LIST fol_SYMBOLS;
# 76 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
void fol_Init(BOOL All, PRECEDENCE Precedence)
# 88 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
  if (All) {

    fol_ALL = symbol_CreateJunctor("forall", 2, 0, Precedence);
    fol_EXIST = symbol_CreateJunctor("exists", 2, 0, Precedence);
    fol_AND = symbol_CreateJunctor("and", symbol_ArbitraryArity(),
     0, Precedence);
    fol_OR = symbol_CreateJunctor("or", symbol_ArbitraryArity(),
     0, Precedence);
    fol_NOT = symbol_CreateJunctor("not", 1, 0, Precedence);
    fol_IMPLIES = symbol_CreateJunctor("implies", 2, 0, Precedence);
    fol_IMPLIED = symbol_CreateJunctor("implied", 2, 0, Precedence);
    fol_EQUIV = symbol_CreateJunctor("equiv", 2, 0, Precedence);
    fol_VARLIST = symbol_CreateJunctor("", symbol_ArbitraryArity(),
     0, Precedence);
    fol_EQUALITY = symbol_CreatePredicate("equal", 2, 0, Precedence);
    fol_TRUE = symbol_CreatePredicate("true", 0, 0, Precedence);
    fol_FALSE = symbol_CreatePredicate("false", 0, 0, Precedence);
...
{
# 155 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
...
# 169 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
...
# 239 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
  SYMBOL Top;
  LIST Scan1;
# 251 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
...
# 294 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
...
# 310 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
...

{
  ...
  SYMBOL Top;
  BOOL Hit;
# 362 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  Stack = stack_Bottom();
...
# 405 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
  LIST Variables,Scan;
  int Stack;
  SYMBOL Top;
  NAT BoundMark,FreeMark;
# 419 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  term_StartBinding();
 ...
 if (symbol_Equal(Top,fol_Varlist())) {
   for (Scan=term_ArgumentList(Term);!list_Empty(Scan);Scan=list_Cdr(Scan))
     if (!term_VarIsMarked(term_TopSymbol(list_Car(Scan)), FreeMark))
       term_CreateBinding(term_TopSymbol(list_Car(Scan)), 0);
   stack_RplacTop(list_Cdr(stack_Top()));
 }
 else
   stack_Push(term_ArgumentList(Term));
...

{
  ...
  case flag_TDFG2OTTEROPTIONSOFF:
    ...
    break;
  default:
    { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c",575); };
...

{
  ...
  Symbols = term_ComputeSize(ToMatch);
...

{
  ...
  Symbols = term_ComputeSize(MatchedBy);
  term_InstallSize(Formula);
...

{
  ...
  LIST Scan;
# 1189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
...
{
  LIST Scan;
# 1221 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  if (fol_IsQuantifier(term_TopSymbol(Term))) {
    for (Scan=term_ArgumentList(term_FirstArgument(Term)); !list_Empty(Scan); Scan=list_Cdr(Scan))
      if (symbol_Equal(term_TopSymbol(list_Car(Scan)), Symbol))
 return;
...
# 1350 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
}
...
{
  LIST Scan;
# 1468 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  if (fol_IsQuantifier(term_TopSymbol(Term))) {
    for ( Scan = fol_QuantifierVariables(Term); !list_Empty(Scan); Scan = list_Cdr(Scan))
...
{
  TERM SuperTerm;
# 1497 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  if (SubTerm == Term)
    return 1;
 ...
 return fol_TermPolarity(SuperTerm, Term);
    ...
    { fflush(stdout); fprintf(stderr,"\n\tError in file %s at line %d\n","/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c",1527); };
...

{
  TERM SubTerm;
  LIST Scan;
# 1674 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
...

{
  ...
  for (Scan=fol_QuantifierVariables(Quant);!list_Empty(Scan);Scan=list_Cdr(Scan))
    if (symbol_Equal(term_TopSymbol(list_Car(Scan)), Var)) {
      ...
      list_Rplaca(Scan, (POINTER)((void*)0));
    }
  term_RplacArgumentList(term_FirstArgument(Quant),
    list_PointerDeleteElement(fol_QuantifierVariables(Quant),(POINTER)((void*)0)));
...
# 1821 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
...
# 1892 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
  BOOL Hit;
  LIST Scan;
...
{
  BOOL Hit;
# 2052 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  term_StartBinding();
...
{
  BOOL Hit;
# 2113 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  term_StartBinding();
...

{
  NAT Depth,Help;
  LIST Scan;
# 2140 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  Depth = 0;
...
# 2236 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
  int Stack;
  SYMBOL FormulaTop, InstanceTop;
  NAT ActMark;
  TERM ActFormula, ActInstance;
# 2251 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  term_StartBinding();
 ...
 if (!symbol_IsJunctor(FormulaTop) && !symbol_IsJunctor(InstanceTop) &&
   ...
   symbol_ContextSetValue(FormulaTop, InstanceTop);
 else {
...
# 2339 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
{
  int Stack;
  SYMBOL TermTop, InstanceTop;
  NAT ActMark;
  TERM ActTerm, ActInstance;
# 2353 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
  Stack = stack_Bottom();
  ActMark = term_OldMark();
  ActTerm = Term;
  ActInstance = Instance;
 ...
 if (!symbol_IsJunctor(TermTop) && !symbol_IsJunctor(InstanceTop) &&
   ...
   symbol_ContextSetValue(TermTop, InstanceTop);
