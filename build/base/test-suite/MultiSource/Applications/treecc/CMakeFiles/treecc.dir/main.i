# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/main.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/main.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/main.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen.h" 1
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen.h"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/main.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/main.c" 2
...
int main(int argc, char *argv[])
{
 ...
 char *opt;
 char *outputFile = ((void*)0);
 char *headerFile = ((void*)0);
 char *extension = "c";
 char *outputDir = ((void*)0);
 int forceCreate = 0;
 TreeCCInput input;
 ...
 TreeCCOpen(&input, progname, ((void*)0), ((void*)0));
...
static void Usage(char *progname)
{
 fprintf(stderr, "TREECC " "0.2.8" " - Tree Compiler-Compiler\n");
...
static void Version(void)
{
 printf("TREECC " "0.2.8" " - Tree Compiler-Compiler\n");
...
static int ExtraOptions(TreeCCContext *context, char **options, int num)
{
 ...
 while(num-- > 0)
 {
  ...
  if(TreeCCOptionProcess(context, name, value) != 0)
  {
