# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/errors.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/errors.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/errors.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/errors.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/errors.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/errors.c" 2





FILE *TreeCCErrorFile = ((void*)0);
...
void TreeCCError(TreeCCInput *input, const char *format, ...)
{
 ...
 ReportError((input ? input->filename : 0),
    (input ? input->linenum : 0), format, va);
 __builtin_va_end(va);
 if(input)
 {
  input->errors = 1;
...
{
 va_list va; __builtin_va_start(va, format);
 ReportError(filename, linenum, format, va);
 __builtin_va_end(va);
 if(input)
 {
  input->errors = 1;
