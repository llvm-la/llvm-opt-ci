# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c" 2
...
void TreeCCIncludeSkeleton(TreeCCContext *context, TreeCCStream *stream,
         const char *skeleton);
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c" 2
            ...
            long linenum)
{
 ...
 hash = (TreeCCHashString(name) & (512 - 1));
...
TreeCCOperation *TreeCCOperationFind(TreeCCContext *context, char *name)
{
 unsigned int hash = (TreeCCHashString(name) & (512 - 1));
        ...
        TreeCCTrigger *nextTrigger)
{
 ...
 while(nextParam != 0 && (nextParam->flags & 1) == 0)
 {
...
static void OperationTest(TreeCCContext *context, TreeCCOperation *oper)
{
 ...
 TreeCCNodeClearMarking(context, 0xFF00);
 ...
 if(oper->numTriggers == 1)
 {
  ...
  while(operCase != 0)
  {
   ...
   if(trigger != 0)
   {
    if((trigger->node->flags & (0x100 << (0))) != 0)
    {
...
static int CaseCompare(const void *e1, const void *e2)
{
 ...
 while(trigger1 != 0 && trigger2 != 0)
 {
  if(trigger1->node != trigger2->node)
  {
   ...
   {
    ancestor1 = ancestor1->parent;
    ancestor1->flags |= (0x100 << (0));
   }
   ancestor2 = trigger2->node;
   while(ancestor2->parent != 0)
   {
    if((ancestor2->parent->flags & (0x100 << (0))) != 0)
    {
     break;
    }
    ancestor2 = ancestor2->parent;
...
# 762 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/oper.c"
