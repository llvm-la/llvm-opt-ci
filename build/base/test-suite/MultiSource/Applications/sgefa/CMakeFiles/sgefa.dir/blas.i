# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c" 2
...
float *sx;
int n, incx;
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  float smax = 0.0e0;
  int i, istmp = 0;
...
float *sx, *sy, sa;
int n, incx, incy;
# 87 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  register int i;
...
float *sx, *sy, sa;
int n, incx, incy;
# 130 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  register i;
...
float *sx, *sy;
int n, incx, incy;
# 171 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  register int i;
...
float *sx, *sy;
int n, incx, incy;
# 214 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  register i;
  float stemp = 0.0e0;
...
float *sx;
int n, incx;
# 262 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  register int i;
  int phase = 3;
...
START:
  if( ((*sx)>0.0?(*sx):-(*sx)) > cutlo ) {
    for( ; i<n; i++, sx+=incx ) {
      if( ((*sx)>0.0?(*sx):-(*sx)) > hitst ) goto GOT_LARGE;
      sum += (*sx) * (*sx);
    }
    sum = sqrt( sum );
    return( sum );
...
# 358 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
...
int n, incx;
float sa, *sx;
# 424 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  int i;
...
int n, itype;
float *v, *x, *y;
# 459 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/blas.c"
{
  register int i;
