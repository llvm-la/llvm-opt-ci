# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/decode/EndianPortable.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/decode/EndianPortable.c" 2
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/decode/EndianPortable.c"
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/decode/EndianPortable.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/decode/EndianPortable.h"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/decode/EndianPortable.h" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/decode/EndianPortable.c" 2
...
uint16_t Swap16NtoB(uint16_t inUInt16)
{
    ...
    return (((inUInt16 << 8) | ((inUInt16 >> 8) & 0x00ff)));
...
uint32_t Swap32NtoB(uint32_t inUInt32)
{
    ...
    return (((inUInt32 << 24) | ((inUInt32 << 8) & 0x00ff0000) | ((inUInt32 >> 8) & 0x0000ff00) | ((inUInt32 >> 24) & 0x000000ff)));
...
uint64_t Swap64BtoN(uint64_t inUInt64)
{
    ...
    return ((((int64_t)inUInt64 << 56) | (((int64_t)inUInt64 << 40) & 0x00ff000000000000LL) | (((int64_t)inUInt64 << 24) & 0x0000ff0000000000LL) | (((int64_t)inUInt64 << 8) & 0x000000ff00000000LL) | (((int64_t)inUInt64 >> 8) & 0x00000000ff000000LL) | (((int64_t)inUInt64 >> 24) & 0x0000000000ff0000LL) | (((int64_t)inUInt64 >> 40) & 0x000000000000ff00LL) | (((int64_t)inUInt64 >> 56) & 0x00000000000000ffLL)));
...
float SwapFloat32BtoN(float in)
{
 ...
 x.f = in;
 x.i = (((x.i << 24) | ((x.i << 8) & 0x00ff0000) | ((x.i >> 8) & 0x0000ff00) | ((x.i >> 24) & 0x000000ff)));
 return x.f;
...
double SwapFloat64BtoN(double in)
{
 ...
 x.f = in;
 x.i = ((((int64_t)x.i << 56) | (((int64_t)x.i << 40) & 0x00ff000000000000LL) | (((int64_t)x.i << 24) & 0x0000ff0000000000LL) | (((int64_t)x.i << 8) & 0x000000ff00000000LL) | (((int64_t)x.i >> 8) & 0x00000000ff000000LL) | (((int64_t)x.i >> 24) & 0x0000000000ff0000LL) | (((int64_t)x.i >> 40) & 0x000000000000ff00LL) | (((int64_t)x.i >> 56) & 0x00000000000000ffLL)));
 return x.f;
...
void Swap16(uint16_t * inUInt16)
{
 *inUInt16 = (((*inUInt16 << 8) | ((*inUInt16 >> 8) & 0x00ff)));
}
...
void Swap32(uint32_t * inUInt32)
{
 *inUInt32 = (((*inUInt32 << 24) | ((*inUInt32 << 8) & 0x00ff0000) | ((*inUInt32 >> 8) & 0x0000ff00) | ((*inUInt32 >> 24) & 0x000000ff)));
}
