# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/matrix_enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/matrix_enc.c" 2
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/matrix_enc.c"
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/matrix_enc.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/matrix_enc.c" 2
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/matrix_enc.c"
void mix16( int16_t * in, uint32_t stride, int32_t * u, int32_t * v, int32_t numSamples, int32_t mixbits, int32_t mixres )
{
 int16_t * ip = in;
 int32_t j;
...
void mix20( uint8_t * in, uint32_t stride, int32_t * u, int32_t * v, int32_t numSamples, int32_t mixbits, int32_t mixres )
{
 ...
 if ( mixres != 0 )
 {
  ...
  for ( j = 0; j < numSamples; j++ )
  {
   l = (int32_t)( ((uint32_t)ip[2] << 16) | ((uint32_t)ip[1] << 8) | (uint32_t)ip[0] );
   l = (l << 8) >> 12;
   ip += 3;

   r = (int32_t)( ((uint32_t)ip[2] << 16) | ((uint32_t)ip[1] << 8) | (uint32_t)ip[0] );
   r = (r << 8) >> 12;
   ip += (stride - 1) * 3;
...
void copy20ToPredictor( uint8_t * in, uint32_t stride, int32_t * out, int32_t numSamples )
{
 ...
 for ( j = 0; j < numSamples; j++ )
 {
  ...
  val = (int32_t)( ((uint32_t)ip[2] << 16) | ((uint32_t)ip[1] << 8) | (uint32_t)ip[0] );
  out[j] = (val << 8) >> 12;
  ip += stride * 3;
 }
}
