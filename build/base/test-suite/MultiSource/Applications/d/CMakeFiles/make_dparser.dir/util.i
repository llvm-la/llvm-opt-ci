# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/d/util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/d/util.c" 2
...
void d_version(char *);
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/d/util.c" 2
...
vec_add_internal(void *v, void *elem) {
  ...
  if (!av->n) {
    ...
    av->v = (void**)malloc((1 << 3) * sizeof(void *));
 ...
 *ss++ = *s; break;
 ...
 if (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISprint)) {
   ...
   *ss++ = '\\';
   *ss++ = 'x';
   *ss++ = ((((*s)>>4) > 9) ? (((*s)>>4) - 10 + 'A') : (((*s)>>4) + '0'));
   *ss++ = ((((*s)&15) > 9) ? (((*s)&15) - 10 + 'A') : (((*s)&15) + '0'));
 }
 break;
    }
  }
