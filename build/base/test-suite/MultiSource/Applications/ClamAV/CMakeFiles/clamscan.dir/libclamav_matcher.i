# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher.c" 2


static cli_file_t targettab[7] = { 0, CL_TYPE_MSEXE, CL_TYPE_MSOLE2, CL_TYPE_HTML, CL_TYPE_MAIL, CL_TYPE_GRAPHICS, CL_TYPE_ELF };
...
int cli_scanbuff(const unsigned char *buffer, uint32_t length, const char **virname, const struct cl_engine *engine, cli_file_t ftype)
{
 ...
 struct cli_matcher *groot, *troot = ((void*)0);
 ...
 if((ret = cli_ac_initdata(&mdata, troot->ac_partsigs, 8)))
     return ret;

 if(troot->ac_only || (ret = cli_bm_scanbuff(buffer, length, virname, troot, 0, ftype, -1)) != 1)
     ret = cli_ac_scanbuff(buffer, length, virname, troot, &mdata, 0, 0, ftype, -1, ((void*)0));
 ...
 if(ret == 1)
    ...
    if((ret = cli_ac_initdata(&mdata, groot->ac_partsigs, 8)))
 return ret;

    if(groot->ac_only || (ret = cli_bm_scanbuff(buffer, length, virname, groot, 0, ftype, -1)) != 1)
 ret = cli_ac_scanbuff(buffer, length, virname, groot, &mdata, 0, 0, ftype, -1, ((void*)0));
...
off_t cli_caloff(const char *offstr, struct cli_target_info *info, int fd, cli_file_t ftype, int *ret, unsigned int *maxshift)
{
 int (*einfo)(int, struct cli_exe_info *) = ((void*)0);
 unsigned int n, val;
 const char *pt;
 off_t pos, offset;
 ...
 *maxshift = atoi(++pt);
    ...
    if(((*__ctype_b_loc ())[(int) ((offstr[0]))] & (unsigned short int) _ISdigit)) {
 return atoi(offstr);
...
int cli_scandesc(int desc, cli_ctx *ctx, uint8_t otfrec, cli_file_t ftype, uint8_t ftonly, struct cli_matched_type **ftoffset)
{
 ...
 int ret = 0, type = 0, i, bytes;
 uint32_t buffersize, length, maxpatlen, shift = 0, offset = 0;
 struct cli_ac_data gdata, tdata;
 cli_md5_ctx md5ctx;
 unsigned char digest[16];
 struct cli_md5_node *md5_node;
 struct cli_matcher *groot = ((void*)0), *troot = ((void*)0);
 ...
 if(troot)
     maxpatlen = (((troot->maxpatlen)>(groot->maxpatlen))?(troot->maxpatlen):(groot->maxpatlen));
 else
     maxpatlen = groot->maxpatlen;
    }


    buffersize = maxpatlen + 131072;
    if(!(buffer = (unsigned char *) cli_calloc(buffersize, sizeof(unsigned char)))) {
 cli_dbgmsg("cli_scandesc(): unable to cli_calloc(%u)\n", buffersize);
 return -114;
    }

    if(!ftonly && (ret = cli_ac_initdata(&gdata, groot->ac_partsigs, 8)))
 return ret;

    if(troot) {
 if((ret = cli_ac_initdata(&tdata, troot->ac_partsigs, 8)))
     return ret;
    }
 ...
 cli_md5_init(&md5ctx);
    ...
    buff = buffer;
    buff += maxpatlen;
    endbl = buff + 131072 - maxpatlen;



    upt = buff;
    while((bytes = cli_readn(desc, buff + shift, 131072 - shift)) > 0) {

 if(ctx->scanned)
     *ctx->scanned += bytes / 4096;
 ...
 if(troot) {
     if(troot->ac_only || (ret = cli_bm_scanbuff(upt, length, ctx->virname, troot, offset, ftype, desc)) != 1)
 ...
 if(!ftonly) {
     if(groot->ac_only || (ret = cli_bm_scanbuff(upt, length, ctx->virname, groot, offset, ftype, desc)) != 1)
