# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c" 2
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_cab.c"
struct cab_hdr {
    uint32_t signature;
    uint32_t res1;
    uint32_t cbCabinet;
...
static int cab_chkname(const char *name)
{
 size_t i, len = strlen(name);
    ...
    for(i = 0; i < len; i++) {
 if(strchr("%/*?|\\\"+=<>;:\t ", name[i]) || !(((name[i]) & ~0x7f) == 0)) {
...
int cab_open(int fd, off_t offset, struct cab_archive *cab)
{
 ...
 struct cab_file *file, *lfile = ((void*)0);
 struct cab_folder *folder, *lfolder = ((void*)0);
 struct cab_hdr hdr;
 ...
 cab->reshdr = (hdr_opt.cbCFHeader);
 resfold = hdr_opt.cbCFFolder;
 cab->resdata = hdr_opt.cbCFData;

 if(cab->reshdr) {
     if(lseek(fd, cab->reshdr, 1) == -1) {
 ...
 folder->offset = (off_t) (folder_hdr.coffCabStart) + offset;
 if(folder->offset > rsize)
     bscore++;
 folder->nblocks = (folder_hdr.cCFData);
 folder->cmethod = (folder_hdr.typeCompress);
 ...
 file->cab = cab;
 file->fd = fd;
 file->length = (file_hdr.cbFile);
 file->offset = (file_hdr.uoffFolderStart);
 file->attribs = (file_hdr.attribs);
 fidx = (file_hdr.iFolder);
...
static int cab_read_block(int fd, struct cab_state *state, uint16_t resdata)
{
 ...
 return -123;
    ...
    if(resdata && lseek(fd, (off_t) resdata, 1) == -1) {
 cli_dbgmsg("cab_read_block: lseek failed\n");
 return -123;
    }

    state->blklen = (block_hdr.cbData);
    if(state->blklen > (32768 + 6144)) {
 cli_dbgmsg("cab_read_block: block size > CAB_INPUTMAX\n");
 return -124;
    }

    state->outlen = (block_hdr.cbUncomp);

    if(state->outlen > 32768) {
...
static int cab_read(struct cab_file *file, unsigned char *buffer, int bytes)
{
 ...
 if(left) {
  ...
  return -1;
     ...
     if((file->folder->cmethod & 0x000f) == 0x0002)
  *file->state->end++ = 0xff;

     if(file->state->blknum >= file->folder->nblocks) {
  if((file->folder->cmethod & 0x000f) == 0x0003) {
      lzx_set_output_length(file->state->stream, (off_t) ((file->state->blknum - 1) * 32768 + file->state->outlen));
  }
     } else {
  if(file->state->outlen != 32768) {
...
int cab_extract(struct cab_file *file, const char *name)
{
 ...
 return -111;
    ...
    if(lseek(file->fd, file->folder->offset, 0) == -1) {
 ...
 return -123;
    ...
    file->ofd = open(name, 01|0100|01000|0, (0400|0200|0100));
    if(file->ofd == -1) {
 ...
 case 0x0001:
  ...
  if(ret < 0) {
   ...
   return -109;
                    ...
                    lseek(file->fd, file->folder->offset, 0);
  }
     }
