...
# %bb.575:                              # %middle.block3983
	...
	beq	$a0, $s2, .LBB0_578
.LBB0_576:                              # %.lr.ph3472.preheader4012
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a2
...
# %bb.633:
	...
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	bne	$a0, $a2, .LBB0_764
# %bb.634:                              # %.preheader3343
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 72                    # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_650
# %bb.635:                              # %.lr.ph3443.preheader
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	addi.d	$a0, $a0, 8
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	ori	$s3, $zero, 12
...
# %bb.723:                              # %middle.block3970
	...
	vpickve2gr.w	$s5, $vr0, 0
	beq	$a2, $a1, .LBB0_726
.LBB0_724:                              # %.lr.ph3463.preheader4016
	slli.d	$a3, $a2, 5
	alsl.d	$a3, $a2, $a3, 2
...
# %bb.730:
	...
	b	.LBB0_202
.LBB0_731:                              # %._crit_edge3464._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_732:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.838:                              # %middle.block
	beq	$a2, $a3, .LBB0_841
.LBB0_839:                              # %.lr.ph3447.preheader4021
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_854:
	move	$s0, $s5
.LBB0_855:                              # %.thread3309.sink.split
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_612
...
.LBB0_914:
	move	$a1, $zero
.LBB0_915:                              # %scalar.ph3944.preheader
	slli.d	$a2, $a1, 1
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $a1, 3
	slli.d	$a1, $a1, 2
