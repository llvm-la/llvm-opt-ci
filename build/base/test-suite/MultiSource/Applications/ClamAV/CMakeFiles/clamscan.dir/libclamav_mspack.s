...
.LBB7_235:                              # %vector.body4174
	...
	addi.d	$a4, $a4, 32
	bnez	$t1, .LBB7_235
# %bb.236:                              # %middle.block4181
                                        #   in Loop: Header=BB7_67 Depth=3
	bne	$a7, $a5, .LBB7_253
	b	.LBB7_255
.LBB7_237:                              # %iter.check4191
                                        #   in Loop: Header=BB7_67 Depth=3
	bstrpick.d	$a5, $a5, 31, 0
	sub.d	$a2, $a1, $a5
	ori	$a6, $zero, 6
	bltu	$a7, $a6, .LBB7_241
# %bb.238:                              # %iter.check4191
                                        #   in Loop: Header=BB7_67 Depth=3
	ori	$a6, $zero, 32
	bltu	$a3, $a6, .LBB7_241
# %bb.239:                              # %vector.main.loop.iter.check4193
                                        #   in Loop: Header=BB7_67 Depth=3
	sub.d	$a3, $zero, $a5
	ori	$a5, $zero, 30
	bgeu	$a7, $a5, .LBB7_243
...
.LBB7_244:                              # %vector.body4197
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB7_244
# %bb.245:                              # %middle.block4204
                                        #   in Loop: Header=BB7_67 Depth=3
	beq	$a6, $a0, .LBB7_271
# %bb.246:                              # %vec.epilog.iter.check4208
                                        #   in Loop: Header=BB7_67 Depth=3
	beqz	$a5, .LBB7_273
.LBB7_247:                              # %vec.epilog.ph4210
                                        #   in Loop: Header=BB7_67 Depth=3
	...
	add.d	$a4, $a6, $a4
.LBB7_248:                              # %vec.epilog.vector.body4214
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_67 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a4, $a4, 8
	bnez	$t0, .LBB7_248
# %bb.249:                              # %vec.epilog.middle.block4220
                                        #   in Loop: Header=BB7_67 Depth=3
	beq	$a7, $a0, .LBB7_271
...
.LBB7_252:                              #   in Loop: Header=BB7_67 Depth=3
	move	$a6, $a5
.LBB7_253:                              # %.lr.ph3013.preheader4239
                                        #   in Loop: Header=BB7_67 Depth=3
	addi.d	$a4, $a6, 1
.LBB7_254:                              # %.lr.ph3013
                                        #   Parent Loop BB7_11 Depth=1
...
.LBB7_256:                              # %.loopexit1337
                                        #   in Loop: Header=BB7_67 Depth=3
	blez	$a2, .LBB7_271
# %bb.257:                              # %iter.check4128
                                        #   in Loop: Header=BB7_67 Depth=3
	ori	$a4, $zero, 8
	bltu	$a2, $a4, .LBB7_261
# %bb.258:                              # %iter.check4128
                                        #   in Loop: Header=BB7_67 Depth=3
	sub.d	$a4, $a1, $a3
	ori	$a5, $zero, 32
	bltu	$a4, $a5, .LBB7_261
# %bb.259:                              # %vector.main.loop.iter.check4130
                                        #   in Loop: Header=BB7_67 Depth=3
	bgeu	$a2, $a5, .LBB7_262
...
.LBB7_263:                              # %vector.body4134
	...
	addi.d	$a6, $a6, 32
	bnez	$t0, .LBB7_263
# %bb.264:                              # %middle.block4141
                                        #   in Loop: Header=BB7_67 Depth=3
	beq	$a7, $a2, .LBB7_271
# %bb.265:                              # %vec.epilog.iter.check4145
                                        #   in Loop: Header=BB7_67 Depth=3
	beqz	$a4, .LBB7_274
.LBB7_266:                              # %vec.epilog.ph4147
                                        #   in Loop: Header=BB7_67 Depth=3
	...
	add.d	$a3, $a3, $a7
	add.d	$a1, $a1, $a7
.LBB7_267:                              # %vec.epilog.vector.body4151
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_67 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a1, $a1, 8
	bnez	$t1, .LBB7_267
# %bb.268:                              # %vec.epilog.middle.block4157
                                        #   in Loop: Header=BB7_67 Depth=3
	beq	$t0, $a2, .LBB7_271
...
.LBB7_439:                              # %vector.body4066
	...
	addi.d	$a4, $a4, 32
	bnez	$t1, .LBB7_439
# %bb.440:                              # %middle.block4073
                                        #   in Loop: Header=BB7_307 Depth=3
	bne	$a7, $a5, .LBB7_457
	b	.LBB7_459
.LBB7_441:                              # %iter.check4083
                                        #   in Loop: Header=BB7_307 Depth=3
	bstrpick.d	$a5, $a5, 31, 0
	sub.d	$a2, $a1, $a5
	ori	$a6, $zero, 6
	bltu	$s4, $a6, .LBB7_445
# %bb.442:                              # %iter.check4083
                                        #   in Loop: Header=BB7_307 Depth=3
	ori	$a6, $zero, 32
	bltu	$a3, $a6, .LBB7_445
# %bb.443:                              # %vector.main.loop.iter.check4085
                                        #   in Loop: Header=BB7_307 Depth=3
	sub.d	$a3, $zero, $a5
	ori	$a5, $zero, 30
	bgeu	$s4, $a5, .LBB7_447
...
.LBB7_448:                              # %vector.body4089
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB7_448
# %bb.449:                              # %middle.block4096
                                        #   in Loop: Header=BB7_307 Depth=3
	beq	$a6, $a0, .LBB7_475
# %bb.450:                              # %vec.epilog.iter.check4100
                                        #   in Loop: Header=BB7_307 Depth=3
	beqz	$a5, .LBB7_477
.LBB7_451:                              # %vec.epilog.ph4102
                                        #   in Loop: Header=BB7_307 Depth=3
	bstrpick.d	$t0, $a0, 15, 3
	slli.d	$a7, $t0, 3
	sub.d	$a5, $a0, $a7
	...
	ld.d	$a6, $sp, 120                   # 8-byte Folded Reload
	add.d	$a4, $a6, $a4
.LBB7_452:                              # %vec.epilog.vector.body4106
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_307 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a4, $a4, 8
	bnez	$t0, .LBB7_452
# %bb.453:                              # %vec.epilog.middle.block4112
                                        #   in Loop: Header=BB7_307 Depth=3
	beq	$a7, $a0, .LBB7_475
...
.LBB7_456:                              #   in Loop: Header=BB7_307 Depth=3
	move	$a6, $a5
.LBB7_457:                              # %.lr.ph3078.preheader4237
                                        #   in Loop: Header=BB7_307 Depth=3
	addi.d	$a4, $a6, 1
.LBB7_458:                              # %.lr.ph3078
                                        #   Parent Loop BB7_11 Depth=1
...
.LBB10_107:                             # %.loopexit303
	...
	maskeqz	$a4, $a5, $a4
	or	$a1, $a4, $a1
.LBB10_108:                             #   Parent Loop BB10_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a3, $a3, -1
	...
	stx.b	$a1, $s2, $a5
	bnez	$a3, .LBB10_108
# %bb.109:                              # %.loopexit.loopexit503
                                        #   in Loop: Header=BB10_17 Depth=1
	sll.w	$s6, $s0, $a2
	sub.w	$a1, $a0, $a2
	b	.LBB10_114
.LBB10_110:                             #   in Loop: Header=BB10_17 Depth=1
	move	$a2, $a4
	b	.LBB10_112
...
.LBB14_8:                               # %vector.body
	...
	vsub.h	$vr2, $vr2, $vr1
	vavg.hu	$vr2, $vr2, $vr0
	vstelm.h	$vr2, $a5, -16, 0
	vstelm.h	$vr2, $a5, -12, 1
	vstelm.h	$vr2, $a5, -8, 2
	vstelm.h	$vr2, $a5, -4, 3
	vstelm.h	$vr2, $a5, 0, 4
	vstelm.h	$vr2, $a5, 4, 5
	vstelm.h	$vr2, $a5, 8, 6
	vstelm.h	$vr2, $a5, 12, 7
	addi.d	$a6, $a6, -8
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB14_8
# %bb.9:                                # %middle.block
