# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/regex_list.h"
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/phishcheck.h"
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/regex_list.h" 2
struct node_stack {
...
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2
...
# 63 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c" 2


enum token_op_t {OP_CHAR,OP_STDCLASS,OP_CUSTOMCLASS,OP_DOT,OP_LEAF,OP_ROOT,OP_PARCLOSE};
typedef unsigned char* char_bitmap_p;
# 76 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
struct tree_node {
...
static const unsigned char char_class_bitmap[sizeof(std_class)/sizeof(std_class[0])][32] = {
...
# 216 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
...
static inline size_t get_char_at_pos_with_skip(const struct pre_fixup_info* info, const char* buffer, size_t pos)
{
 ...
 pos += info->host_start;
 while(str[realpos] && !((*__ctype_b_loc ())[(int) ((str[realpos]))] & (unsigned short int) _ISalnum)) realpos++;
...
# 256 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
int regex_list_match(struct regex_matcher* matcher,char* real_url,const char* display_url,const struct pre_fixup_info* pre_fixup,int hostOnly,const char** info,int is_whitelist)
{
 (void)(0);
 (void)(0);
 ...
 (void)(0);
 {
  ...
  if(hostOnly) {
   if((rc = cli_ac_initdata(&mdata, 0, 8)))
    return rc;
   rc = 0;

   for(i = 0; i < matcher->root_hosts_cnt; i++) {

    rc = cli_ac_scanbuff((unsigned char*)buffer,buffer_len,info, &matcher->root_hosts[i] ,&mdata,0,0,0,-1,((void*)0));
  ...
  if(!rc)
   rc = match_node(hostOnly ? matcher->root_regex_hostonly : matcher->root_regex,(unsigned char*)buffer,buffer_len,info) == 0 ? 1 : 0;
  free(buffer);
  if(!rc)
...
static struct tree_node* stack_pop(struct node_stack* stack)
{
 ...
 return stack->cnt ? stack->data[--stack->cnt] : ((void*)0);
}
...
static int functionality_level_check(char* line)
{
 ...
 if(!ptmax)
  ...
  for(j=0;j+ptmin+1 < ptmax;j++)
   if(!((*__ctype_b_loc ())[(int) ((ptmin[j]))] & (unsigned short int) _ISdigit))
    return 0;
  for(j=0;j<strlen(ptmax);j++)
   if(!((*__ctype_b_loc ())[(int) ((ptmax[j]))] & (unsigned short int) _ISdigit))
    return 0;
  ptmax[-1]='\0';
  min = atoi(ptmin);
  if(strlen(ptmax)==0)
...
# 565 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
...
{
 return node->op==OP_CUSTOMCLASS ? (node->u.children[1] ? node->u.children+1 : ((void*)0)) :node->u.children;
}
...
static const unsigned char* getNextToken(const unsigned char* pat,struct token_t* token)
{
 ...
 switch(*pat) {
  case '\\':
   ...
   token->u.c = *(++pat);
   if(((*__ctype_b_loc ())[(int) ((token->u.c))] & (unsigned short int) _ISlower)) {
...
static const unsigned char* find_regex_start(const unsigned char* pat)
{
 ...
 const unsigned char* last=((void*)0);
 const unsigned char* tmp=((void*)0);
 const unsigned char** altpositions = cli_malloc(10*sizeof(*altpositions));
 size_t altpositions_capacity = 10;
 size_t altpositions_cnt = 0;
 char lasttype = -1;
 if(!altpositions)
  return ((void*)0);
 (void)(0);
# 890 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_list.c"
 do {
  tmp = pat;
...
static struct tree_node* tree_root_alloc(void)
{
 struct tree_node* root=tree_node_alloc(((void*)0),1);
 if(root) {
  root->op=OP_ROOT;
  root->c=0;
  root->next=((void*)0);
...
{
 (void)(0);
 return (!matcher->list_inited || matcher->list_inited!=-1);
}
...
static int add_pattern(struct regex_matcher* matcher,const unsigned char* pat,const char* info, int hostonly)
{
 ...
 for(;node->op!=OP_LEAF;){
  ...
  switch(token.type) {
   ...
   case TOKEN_PAR_OPEN:
    stack_push(&matcher->node_stack_alt,((void*)0));
    stack_push(&matcher->node_stack,node);
    break;
   ...
   case TOKEN_DONE: {
       ...
       if(token.type==TOKEN_REGEX) {
        ...
        if(!preg)
         return -114;
        rc = cli_regcomp(preg,(const char*)token.u.start,0001|(bol?0:00001));
        leaf->preg=preg;
        if(rc)
         return rc;
 ...
 for(;;) {
  ...
  switch(node->op) {
   ...
   case OP_LEAF:
   {
    ...
    if(leaf->preg) {
     rc = !cli_regexec(leaf->preg,(const char*)c,0,((void*)0),0);
    }
    else {
     (void)(0);
     rc = 1;
  ...
  if(rc) {
   ...
   if(left<=right) {
    ...
    if(node->alternatives) {
     ...
     struct tree_node* rewrite_next = ((void*)0);
...
static void destroy_tree_internal(struct regex_matcher* matcher,struct tree_node* node)
{
 ...
 if(node->op==OP_LEAF) {
  ...
  stack_push_once(&matcher->node_stack,(struct tree_node*)node->u.leaf);
 ...
 if(node->alternatives) {
  ...
  struct tree_node* p;
  (void)(0);
  p = children[0]->op==OP_LEAF ? ((void*)0) : children[0]->next;
  for(i=0;i<node->alternatives;i++)
   destroy_tree_internal(matcher,children[i]);
  if(p && p!=node)
   destroy_tree_internal(matcher,p);
 }
 else {
  if(children) {
   if(children[0])
 ...
 if(node->op!=OP_LEAF && node->next && !node->listend)
  destroy_tree_internal(matcher,node->next);
 if(node->u.children)
  stack_push_once(&matcher->node_stack,(struct tree_node*)node->u.children);
 if(node->op==OP_CUSTOMCLASS && node->u.children[0]) {
  free(node->u.children[0]);
  node->u.children[0]=((void*)0);
 }
 stack_push_once(&matcher->node_stack,node);
}
