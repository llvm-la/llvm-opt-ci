# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2
# 107 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c"
...
# 108 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2
...
# 111 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2
...
# 113 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2
...
# 114 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2
...
# 115 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2
...
# 116 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/unsp.h" 1
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/unsp.h"
struct UNSP {
  char *src_curr;
  char *src_end;
  uint32_t bitmap;
...
# 118 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unsp.c" 2
...
uint32_t very_real_unpack(uint16_t *table, uint32_t tablesz, uint32_t tre, uint32_t allocsz, uint32_t firstbyte, char *src, uint32_t ssize, char *dst, uint32_t dsize) {
 ...
 damian=0;
      ...
      if (previous_bit) {
 if (!(dsize > 0 && 1 > 0 && 1 <= dsize && &dst[unpacked_so_far - backbytes] >= dst && &dst[unpacked_so_far - backbytes] + 1 <= dst + dsize && &dst[unpacked_so_far - backbytes] + 1 > dst)) return 1;
 ssize = (ssize&0xffffff00) | (uint8_t)dst[unpacked_so_far - backbytes];
 ...
 bielle = get_100_bits_from_table(&table[tpos+0x736], &read_struct);
      ...
      if (!(dsize > 0 && 1 > 0 && 1 <= dsize && &dst[unpacked_so_far] >= dst && &dst[unpacked_so_far] + 1 <= dst + dsize && &dst[unpacked_so_far] + 1 > dst)) return 1;
 ...
 tpos = ((int32_t)backsize>=4)?3:backsize;
 tpos<<=6;
 ...
 backbytes = temp+1;
      ...
      if (!(dsize > 0 && backsize > 0 && backsize <= dsize && &dst[unpacked_so_far] >= dst && &dst[unpacked_so_far] + backsize <= dst + dsize && &dst[unpacked_so_far] + backsize > dst) ||
   !(dsize > 0 && backsize > 0 && backsize <= dsize && &dst[unpacked_so_far - backbytes] >= dst && &dst[unpacked_so_far - backbytes] + backsize <= dst + dsize && &dst[unpacked_so_far - backbytes] + backsize > dst)
   ) {
...
int getbit_from_table(uint16_t *intable, struct UNSP *read_struct) {
  ...
  uint32_t nval;
  if (!(read_struct->tablesz > 0 && sizeof(uint16_t) > 0 && sizeof(uint16_t) <= read_struct->tablesz && (char *)intable >= (char *)read_struct->table && (char *)intable + sizeof(uint16_t) <= (char *)read_struct->table + read_struct->tablesz && (char *)intable + sizeof(uint16_t) > (char *)read_struct->table)) {
    read_struct->error = 1;
    return 0xff;
  }
