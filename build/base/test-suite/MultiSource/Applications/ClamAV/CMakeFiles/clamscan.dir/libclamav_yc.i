# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c" 2
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c"
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/yc.h" 1
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/yc.h"
int yc_decrypt(char *, unsigned int, struct cli_exe_section *, unsigned int, uint32_t, int);
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c" 2
...
{
# 64 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c"
  unsigned char al;
      ...
      for(j=0;j<0x30;j++)
 {
  ...
  ;
     ...
     case '\xC0':
       j++;
       if(decryptor_offset[j]=='\xC0')
  {
    j++;
    al = ( al << (decryptor_offset[j] % (sizeof(al)<<3) )) | (al >> ( (sizeof(al)<<3) - (decryptor_offset[j] % (sizeof(al)<<3 )) ) );
  }
       else
  {
    j++;
    al = ( al >> (decryptor_offset[j] % (sizeof(al)<<3) )) | (al << ( (sizeof(al)<<3) - (decryptor_offset[j] % (sizeof(al)<<3 )) ) );
     ...
     case '\xD2':
       j++;
       if(decryptor_offset[j]=='\xC8')
  {
    j++;
    al = ( al >> (cl % (sizeof(al)<<3) )) | (al << ( (sizeof(al)<<3) - (cl % (sizeof(al)<<3 )) ) );
  }
       else
  {
    j++;
...
int yc_decrypt(char *fbuf, unsigned int filesize, struct cli_exe_section *sections, unsigned int sectcount, uint32_t peoffset, int desc)
{
  ...
  char *sname = (char *)pe + (pe->SizeOfOptionalHeader) + 0x18;
# 183 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c"
...
# 200 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_yc.c"
