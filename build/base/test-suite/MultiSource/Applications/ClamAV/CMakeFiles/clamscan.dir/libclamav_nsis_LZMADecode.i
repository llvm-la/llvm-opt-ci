# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c" 2
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c"
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/LZMADecode.h"
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/others.h" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/others.h" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/clamav.h"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/clamav.h" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/LZMADecode.h" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c" 2
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c"
enum {
           LZMA_C_INIT = 0,
           LZMA_C_GETDICT,
           LZMA_C_BLOCK,
...
# 135 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c"
...
int lzmaDecode(lzma_stream *s)
{
  ...
  lzma_stream _s = *s;
# 202 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_LZMADecode.c"
  if (_s.len == -1)
    return 1;
  ...
  case LZMA_C_INIT:
    {
      lzByte firstByte;
      unsigned int newDynamicDataSize;
      unsigned int numProbs;
      int lp;
      int pb;

      if (!_s.avail_in) { goto saveStateAndReturn; };;

      firstByte = (_s.avail_in--, *_s.next_in++);
      ...
      _s.posStateMask = (1 << (pb)) - 1;
      _s.literalPosMask = (1 << (lp)) - 1;

      numProbs = (((((((((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (12 << 4)) + (4 << 6)) + (1 << (14 >> 1)) - 14) + (1 << 4)) + (((((0 + 1) + 1) + ((1 << 4) << 3)) + ((1 << 4) << 3)) + (1 << 8))) + (((((0 + 1) + 1) + ((1 << 4) << 3)) + ((1 << 4) << 3)) + (1 << 8))) + (768 << (_s.lc + pb));
      newDynamicDataSize = numProbs * sizeof(unsigned short);

      if (newDynamicDataSize != _s.dynamicDataSize)
      {
        if ((*(unsigned short **) &_s.dynamicData))
          free((*(unsigned short **) &_s.dynamicData));
        (*(unsigned short **) &_s.dynamicData) = cli_malloc(newDynamicDataSize);
        if (!(*(unsigned short **) &_s.dynamicData))
          return -1;
        _s.dynamicDataSize = newDynamicDataSize;
      }

      while (numProbs--)
        (*(unsigned short **) &_s.dynamicData)[numProbs] = (1 << 11) >> 1;

      for (_s.temp1 = 0, (*(unsigned int*) &_s.temp3) = 0; _s.temp1 < 4; _s.temp1++)
      {
        case LZMA_C_GETDICT: if (!_s.avail_in) { _s.mode = LZMA_C_GETDICT; { goto saveStateAndReturn; }; };
        (*(unsigned int*) &_s.temp3) |= (_s.avail_in--, *_s.next_in++) << (_s.temp1 * 8);
      }

      if ((*(unsigned int*) &_s.temp3) != _s.dictionarySize)
      {
        _s.dictionarySize = (*(unsigned int*) &_s.temp3);
        if (_s.dictionary)
          free(_s.dictionary);
        _s.dictionary = cli_malloc(_s.dictionarySize);
        if (!_s.dictionary)
          return -1;
      }

      _s.dictionary[_s.dictionarySize - 1] = 0;

      _s.temp1 = 5;
      while (_s.temp1--)
      {
        case LZMA_C_RDI: if (!_s.avail_in) { _s.mode = LZMA_C_RDI; { goto saveStateAndReturn; }; };
        _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++);
      }
    }
  case LZMA_C_BLOCK:
    _s.posState = (int)(_s.totalOut & _s.posStateMask);
    _s.prob = (*(unsigned short **) &_s.dynamicData) + 0 + (_s.state << 4) + _s.posState; _s.last = LZMA_C_TYPE; goto _LZMA_C_RDBD; case LZMA_C_TYPE:;
    if (_s.temp3 == 0)
    {
      _s.probs = (*(unsigned short **) &_s.dynamicData) + (((((((((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (12 << 4)) + (4 << 6)) + (1 << (14 >> 1)) - 14) + (1 << 4)) + (((((0 + 1) + 1) + ((1 << 4) << 3)) + ((1 << 4) << 3)) + (1 << 8))) + (((((0 + 1) + 1) + ((1 << 4) << 3)) + ((1 << 4) << 3)) + (1 << 8))) + (768 *
        (((_s.totalOut & _s.literalPosMask) << _s.lc) + (_s.previousByte >> (8 - _s.lc))));

      if (_s.state < 4) _s.state = 0;
      else if (_s.state < 10) _s.state -= 3;
      else _s.state -= 6;
      if (_s.isPreviousMatch)
      {
        unsigned int pos = _s.dictionaryPos - _s.rep0;
        if (pos >= _s.dictionarySize)
          pos += _s.dictionarySize;
        _s.matchByte = _s.dictionary[pos];
        {
          _s.temp2 = 1;
          do
          {
            _s.temp1 = (_s.matchByte >> 7) & 1;
            _s.matchByte <<= 1;
            {
              _s.prob = _s.probs + ((1 + _s.temp1) << 8) + _s.temp2;
              { unsigned int bound = (_s.range >> 11) * *_s.prob; if (_s.code < bound) { _s.temp3 = 0; _s.range = bound; *_s.prob += ((1 << 11) - *_s.prob) >> 5; _s.temp2 <<= 1; } else { _s.temp3 = 1; _s.range -= bound; _s.code -= bound; *_s.prob -= (*_s.prob) >> 5; _s.temp2 = (_s.temp2 + _s.temp2) + 1; } if (_s.range < ((unsigned int)1 << 24)) { case LZMA_C_LITDM1: if (!_s.avail_in) { _s.mode = LZMA_C_LITDM1; { goto saveStateAndReturn; }; }; _s.range <<= 8; _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++); } }
            }
            if (_s.temp1 != _s.temp3)
            {
              while (_s.temp2 < 0x100)
              {
                _s.prob = _s.probs + _s.temp2;
                { unsigned int bound = (_s.range >> 11) * *_s.prob; if (_s.code < bound) { ;; _s.range = bound; *_s.prob += ((1 << 11) - *_s.prob) >> 5; _s.temp2 <<= 1; } else { ;; _s.range -= bound; _s.code -= bound; *_s.prob -= (*_s.prob) >> 5; _s.temp2 = (_s.temp2 + _s.temp2) + 1; } if (_s.range < ((unsigned int)1 << 24)) { case LZMA_C_LITDM2: if (!_s.avail_in) { _s.mode = LZMA_C_LITDM2; { goto saveStateAndReturn; }; }; _s.range <<= 8; _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++); } }
              }
              break;
            }
          }
          while (_s.temp2 < 0x100);
          _s.previousByte = _s.temp2;
        }
        _s.isPreviousMatch = 0;
      }
      else
      {
        _s.temp2 = 1;
        ...
        {
          _s.prob = _s.probs + _s.temp2;
          { unsigned int bound = (_s.range >> 11) * *_s.prob; if (_s.code < bound) { ;; _s.range = bound; *_s.prob += ((1 << 11) - *_s.prob) >> 5; _s.temp2 <<= 1; } else { ;; _s.range -= bound; _s.code -= bound; *_s.prob -= (*_s.prob) >> 5; _s.temp2 = (_s.temp2 + _s.temp2) + 1; } if (_s.range < ((unsigned int)1 << 24)) { case LZMA_C_LITD: if (!_s.avail_in) { _s.mode = LZMA_C_LITD; { goto saveStateAndReturn; }; }; _s.range <<= 8; _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++); } }
        }
        while (_s.temp2 < 0x100);
        _s.previousByte = _s.temp2;
      }
      case LZMA_C_OUTPUT_1: if (!_s.avail_out) { _s.mode = LZMA_C_OUTPUT_1; { goto saveStateAndReturn; }; };
      { _s.totalOut++; { *_s.next_out = _s.previousByte; _s.next_out++; _s.avail_out--; } };
      _s.dictionary[_s.dictionaryPos] = _s.previousByte;
      _s.dictionaryPos = (_s.dictionaryPos + 1) % _s.dictionarySize;
    }

    else
    {
      _s.isPreviousMatch = 1;
      _s.prob = (*(unsigned short **) &_s.dynamicData) + (0 + (12 << 4)) + _s.state; _s.last = LZMA_C_ISREP; goto _LZMA_C_RDBD; case LZMA_C_ISREP:;
      if (_s.temp3 == 1)
      {
        _s.prob = (*(unsigned short **) &_s.dynamicData) + ((0 + (12 << 4)) + 12) + _s.state; _s.last = LZMA_C_ISREPG0; goto _LZMA_C_RDBD; case LZMA_C_ISREPG0:;
        if (_s.temp3 == 0)
        {
          _s.prob = (*(unsigned short **) &_s.dynamicData) + (((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (_s.state << 4) + _s.posState; _s.last = LZMA_C_ISREP0LONG; goto _LZMA_C_RDBD; case LZMA_C_ISREP0LONG:;
          if (_s.temp3 == 0)
          {
            unsigned int pos;
            if (_s.totalOut == 0)
              return -1;
            _s.state = _s.state < 7 ? 9 : 11;
            case LZMA_C_OUTPUT_2: if (!_s.avail_out) { _s.mode = LZMA_C_OUTPUT_2; { goto saveStateAndReturn; }; };
            pos = _s.dictionaryPos - _s.rep0;
            if (pos >= _s.dictionarySize)
              pos += _s.dictionarySize;
            _s.previousByte = _s.dictionary[pos];
            _s.dictionary[_s.dictionaryPos] = _s.previousByte;
            _s.dictionaryPos = (_s.dictionaryPos + 1) % _s.dictionarySize;
            { _s.totalOut++; { *_s.next_out = _s.previousByte; _s.next_out++; _s.avail_out--; } };
            _s.mode = LZMA_C_BLOCK;
            break;
          }
        }
        else
        {
          ...
          _s.prob = (*(unsigned short **) &_s.dynamicData) + (((0 + (12 << 4)) + 12) + 12) + _s.state; _s.last = LZMA_C_ISREPG1; goto _LZMA_C_RDBD; case LZMA_C_ISREPG1:;
          if (_s.temp3 == 0)
          {
            distance = _s.rep1;
          }
          ...
          {
            _s.prob = (*(unsigned short **) &_s.dynamicData) + ((((0 + (12 << 4)) + 12) + 12) + 12) + _s.state; _s.last = LZMA_C_ISREPG2; goto _LZMA_C_RDBD; case LZMA_C_ISREPG2:;
            if (_s.temp3 == 0)
              distance = _s.rep2;
            else
            {
        ...
        _s.probs = (*(unsigned short **) &_s.dynamicData) + ((((((((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (12 << 4)) + (4 << 6)) + (1 << (14 >> 1)) - 14) + (1 << 4)) + (((((0 + 1) + 1) + ((1 << 4) << 3)) + ((1 << 4) << 3)) + (1 << 8))); _s.last2 = LZMA_C_LEND_C1; goto _LZMA_C_LEND; case LZMA_C_LEND_C1:;
        _s.state = _s.state < 7 ? 8 : 11;
      }
      else
      {
        _s.rep3 = _s.rep2;
        _s.rep2 = _s.rep1;
        _s.rep1 = _s.rep0;
        _s.state = _s.state < 7 ? 7 : 10;
        _s.probs = (*(unsigned short **) &_s.dynamicData) + (((((((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (12 << 4)) + (4 << 6)) + (1 << (14 >> 1)) - 14) + (1 << 4)); _s.last2 = LZMA_C_LEND_C2; goto _LZMA_C_LEND; case LZMA_C_LEND_C2:;
        _s.probs = (*(unsigned short **) &_s.dynamicData) + ((((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (12 << 4)) + ((_s.len < 4 ? _s.len : 4 - 1) << 6); _s.temp3 = 6; _s.last3 = LZMA_C_BTD_C1; goto _LZMA_C_BTD; case LZMA_C_BTD_C1:;
        ...
        if (_s.temp2 >= 4)
        {
          int numDirectBits = ((_s.temp2 >> 1) - 1);
          _s.rep0 = ((2 | ((unsigned int)_s.temp2 & 1)) << numDirectBits);
          if (_s.temp2 < 14)
          {
            _s.probs = (*(unsigned short **) &_s.dynamicData) + (((((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (12 << 4)) + (4 << 6)) + _s.rep0 - _s.temp2 - 1;
            _s.temp3 = numDirectBits;
          }
          else
          {
            int numTotalBits = numDirectBits - 4;
            _s.temp2 = 0;
            for (_s.temp1 = numTotalBits; _s.temp1 > 0; _s.temp1--)
            {
              ...
              if (_s.range < ((unsigned int)1 << 24)) { case LZMA_C_NORM: if (!_s.avail_in) { _s.mode = LZMA_C_NORM; { goto saveStateAndReturn; }; }; _s.range <<= 8; _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++); }
            }
            _s.rep0 += _s.temp2 << 4;
            _s.probs = (*(unsigned short **) &_s.dynamicData) + ((((((((0 + (12 << 4)) + 12) + 12) + 12) + 12) + (12 << 4)) + (4 << 6)) + (1 << (14 >> 1)) - 14);
            _s.temp3 = 4;
          }
          _s.mi = 1;
          _s.temp2 = 0;
          for(_s.temp1 = 0; _s.temp1 < _s.temp3; _s.temp1++)
          {
            _s.prob = _s.probs + _s.mi;
            { unsigned int bound = (_s.range >> 11) * *_s.prob; if (_s.code < bound) { ;; _s.range = bound; *_s.prob += ((1 << 11) - *_s.prob) >> 5; _s.mi <<= 1; } else { _s.temp2 |= (1 << _s.temp1); _s.range -= bound; _s.code -= bound; *_s.prob -= (*_s.prob) >> 5; _s.mi = (_s.mi + _s.mi) + 1; } if (_s.range < ((unsigned int)1 << 24)) { case LZMA_C_RDRBTD: if (!_s.avail_in) { _s.mode = LZMA_C_RDRBTD; { goto saveStateAndReturn; }; }; _s.range <<= 8; _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++); } };
          }
          _s.rep0 += _s.temp2;
        }
        else
      ...
      if (_s.rep0 == (unsigned int)(0))
      {
        _s.len = -1;
        { goto saveStateAndReturn; };
      }
      if (_s.rep0 > _s.totalOut)
      {
        return -1;
      }
      _s.len += 2;
      ...
      {
        unsigned int pos;
        case LZMA_C_OUTPUT_3: if (!_s.avail_out) { _s.mode = LZMA_C_OUTPUT_3; { goto saveStateAndReturn; }; };
        pos = _s.dictionaryPos - _s.rep0;
        if (pos >= _s.dictionarySize)
          pos += _s.dictionarySize;
        _s.previousByte = _s.dictionary[pos];
        _s.dictionary[_s.dictionaryPos] = _s.previousByte;
        _s.dictionaryPos = (_s.dictionaryPos + 1) % _s.dictionarySize;
        { *_s.next_out = _s.previousByte; _s.next_out++; _s.avail_out--; };
        _s.len--;
      }
      while(_s.len > 0);
    }
  ...
  _LZMA_C_RDBD:
    {
      unsigned int bound = (_s.range >> 11) * *_s.prob;
      if (_s.code < bound)
      {
        _s.range = bound;
        *_s.prob += ((1 << 11) - *_s.prob) >> 5;
        _s.temp3 = 0;
      }
      else
      {
      ...
      if (_s.range < ((unsigned int)1 << 24)) { case LZMA_C_RDBD_IN: if (!_s.avail_in) { _s.mode = LZMA_C_RDBD_IN; { goto saveStateAndReturn; }; }; _s.range <<= 8; _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++); };
    }
    _s.mode = _s.last;
    break;
  case LZMA_C_LEND:
  _LZMA_C_LEND:
      _s.prob = _s.probs + 0; _s.last = LZMA_C_LEND1; goto _LZMA_C_RDBD; case LZMA_C_LEND1:;
      if (_s.temp3 == 0)
      {
        _s.len = 0;
        _s.probs += ((0 + 1) + 1) + (_s.posState << 3);
        _s.temp3 = 3;
      }
      else {
        _s.prob = _s.probs + (0 + 1); _s.last = LZMA_C_LEND2; goto _LZMA_C_RDBD; case LZMA_C_LEND2:;
        if (_s.temp3 == 0)
        {
          _s.len = (1 << 3);
          _s.probs += + (((0 + 1) + 1) + ((1 << 4) << 3)) + (_s.posState << 3);
          _s.temp3 = 3;
        }
        else
        {
          _s.len = (1 << 3) + (1 << 3);
          _s.probs += ((((0 + 1) + 1) + ((1 << 4) << 3)) + ((1 << 4) << 3));
          _s.temp3 = 8;
        }
      }

      _s.last3 = LZMA_C_LEND_RES;
  case LZMA_C_BTD:
  _LZMA_C_BTD:
    _s.mi = 1;
    for(_s.temp1 = _s.temp3; _s.temp1 > 0; _s.temp1--)
    {
      _s.prob = _s.probs + _s.mi;
      { unsigned int bound = (_s.range >> 11) * *_s.prob; if (_s.code < bound) { ;; _s.range = bound; *_s.prob += ((1 << 11) - *_s.prob) >> 5; _s.mi <<= 1; } else { ;; _s.range -= bound; _s.code -= bound; *_s.prob -= (*_s.prob) >> 5; _s.mi = (_s.mi + _s.mi) + 1; } if (_s.range < ((unsigned int)1 << 24)) { case LZMA_C_BTD_LOOP: if (!_s.avail_in) { _s.mode = LZMA_C_BTD_LOOP; { goto saveStateAndReturn; }; }; _s.range <<= 8; _s.code = (_s.code << 8) | (_s.avail_in--, *_s.next_in++); } }
    }
    _s.temp2 = _s.mi - (1 << _s.temp3);
    _s.mode = _s.last3;
    break;
...
void lzmaShutdown(lzma_stream *s) {
  lzma_stream _s = *s;
  if ((*(unsigned short **) &_s.dynamicData)) free((*(unsigned short **) &_s.dynamicData));
  if (_s.dictionary) free(_s.dictionary);
  (*(unsigned short **) &_s.dynamicData) = ((void*)0);
  _s.dictionary = ((void*)0);
  *s = _s;
}
