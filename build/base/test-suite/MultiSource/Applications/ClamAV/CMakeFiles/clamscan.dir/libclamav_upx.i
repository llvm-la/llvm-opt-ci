# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c"
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
...
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/others.h"
...
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/upx.h" 1
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/upx.h"
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c" 2
# 97 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c"
static char *checkpe(char *dst, uint32_t dsize, char *pehdr, uint32_t *valign, unsigned int *sectcnt)
{
  char *sections;
  if (!(dsize > 0 && 0xf8 > 0 && 0xf8 <= dsize && pehdr >= dst && pehdr + 0xf8 <= dst + dsize && pehdr + 0xf8 > dst)) return ((void*)0);

  if (cli_readint32(pehdr) != 0x4550 ) return ((void*)0);

  if (!(*valign=cli_readint32(pehdr+0x38))) return ((void*)0);

  sections = pehdr+0xf8;
  if (!(*sectcnt = (unsigned char)pehdr[6] + (unsigned char)pehdr[7]*256)) return ((void*)0);

  if (!(dsize > 0 && *sectcnt*0x28 > 0 && *sectcnt*0x28 <= dsize && sections >= dst && sections + *sectcnt*0x28 <= dst + dsize && sections + *sectcnt*0x28 > dst)) return ((void*)0);
...
{
  char *imports, *sections, *pehdr=((void*)0), *newbuf;
 ...
 break;
  ...
  if (valign && (ssize > 0 && 4 > 0 && 4 <= ssize && src + ep - upx1 + valign >= src && src + ep - upx1 + valign + 4 <= src + ssize && src + ep - upx1 + valign + 4 > src)) {
    ...
    if (realstuffsz >= *dsize ) {
      ...
      pehdr = imports;
      while ((*dsize > 0 && 8 > 0 && 8 <= *dsize && pehdr >= dst && pehdr + 8 <= dst + *dsize && pehdr + 8 > dst) && cli_readint32(pehdr)) {
 pehdr+=8;
 while((*dsize > 0 && 2 > 0 && 2 <= *dsize && pehdr >= dst && pehdr + 2 <= dst + *dsize && pehdr + 2 > dst) && *pehdr) {
   pehdr++;
   while ((*dsize > 0 && 2 > 0 && 2 <= *dsize && pehdr >= dst && pehdr + 2 <= dst + *dsize && pehdr + 2 > dst) && *pehdr)
     pehdr++;
   pehdr++;
 ...
 pehdr++;
      ...
      pehdr+=4;
      if (!(sections=checkpe(dst, *dsize, pehdr, &valign, &sectcnt))) pehdr=((void*)0);
    }
  }
 ...
 break;
    ...
    if (!(realstuffsz = pehdr-dst)) pehdr=((void*)0);
  }

  if (!pehdr) {
    uint32_t rebsz = (((0x1000))?(((dend)/(0x1000)+((dend)%(0x1000)!=0))*(0x1000)):(dend));
    ...
    memcpy(newbuf, "", 0xd0);
    memcpy(newbuf+0xd0, "", 0x120);
  ...
  foffset = (((valign))?(((foffset+0x28*sectcnt)/(valign)+((foffset+0x28*sectcnt)%(valign)!=0))*(valign)):(foffset+0x28*sectcnt));

  for (upd = 0; upd <sectcnt ; upd++) {
    uint32_t vsize=(((valign))?((((uint32_t)cli_readint32(sections+8))/(valign)+(((uint32_t)cli_readint32(sections+8))%(valign)!=0))*(valign)):((uint32_t)cli_readint32(sections+8)));
    uint32_t urva=(((valign))?((((uint32_t)cli_readint32(sections+12))/(valign))*(valign)):((uint32_t)cli_readint32(sections+12)));


    if (!(realstuffsz > 0 && vsize > 0 && vsize <= realstuffsz && urva >= upx0 && urva + vsize <= upx0 + realstuffsz && urva + vsize > upx0)) {
...
static int doubleebx(char *src, uint32_t *myebx, uint32_t *scur, uint32_t ssize)
{
  ...
  *myebx*=2;
  if ( !(oldebx & 0x7fffffff)) {
    if (! (ssize > 0 && 4 > 0 && 4 <= ssize && src+*scur >= src && src+*scur + 4 <= src + ssize && src+*scur + 4 > src))
      return -1;
...
int upx_inflate2b(char *src, uint32_t ssize, char *dst, uint32_t *dsize, uint32_t upx0, uint32_t upx1, uint32_t ep)
{
 ...
 backsize = backsize*2 + oob;
    ...
    if (!(*dsize > 0 && backsize > 0 && backsize <= *dsize && dst+dcur+unp_offset >= dst && dst+dcur+unp_offset + backsize <= dst + *dsize && dst+dcur+unp_offset + backsize > dst) || !(*dsize > 0 && backsize > 0 && backsize <= *dsize && dst+dcur >= dst && dst+dcur + backsize <= dst + *dsize && dst+dcur + backsize > dst) || unp_offset >=0)
      return -1;
