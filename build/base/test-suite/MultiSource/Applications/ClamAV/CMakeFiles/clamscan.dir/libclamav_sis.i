# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c" 2
...
# 73 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_sis.c"
...
{
 const char *typedir = ((void*)0);
 char *sname = ((void*)0), *dname = ((void*)0), *subdir, *fname, *buff;
 int desc, i;
 uint8_t get_dname = 1;
 ...
 if(compressed) {
  ...
  return -123;
     ...
     if(uncompress((Bytef *) buff, &osize , (Bytef *) mfile + fileoff, csize) != 0) {
 ...
 if((desc = open(fname, 0100|01|01000|0, 0400|0200)) == -1) {
...
int cli_scansis(int desc, cli_ctx *ctx)
{
 ...
 return 0;
    ...
    if(length <= 134217728) {
 mfile = (char *) mmap(((void*)0), length, 0x1, 0x02, desc, 0);
 if(mfile == ((void *) -1)) {
 ...
 return 0;
    ...
    if((file_hdr.uid3) != 0x10000419) {
 cli_dbgmsg("SIS: Not a SIS file\n");
 munmap(mfile, length);
 return 0;
    }

    switch((file_hdr.uid2)) {
 case 0x1000006d:
 ...
 default:
    ...
    nlangs = (file_hdr.nlangs);
    cli_dbgmsg("SIS: Number of languages: %d\n", nlangs);

    if(nlangs && nlangs < 100) {

 if((file_hdr.plangs) >= length || (file_hdr.plangs) + nlangs * 2 >= (uint32_t) sb.st_size) {
 ...
 memcpy(langrecs, mfile + (file_hdr.plangs), nlangs * 2);
 ...
 for(i = 0; i < nlangs; i++) {
     strncat(langs, langcodes[(langrecs[i]) % 98], 2);
     if(i != nlangs - 1)
  strncat(langs, " ", 1);
 }
 ...
 return 0;
    ...
    if((frecord = (file_hdr.pfiles)) >= length) {
