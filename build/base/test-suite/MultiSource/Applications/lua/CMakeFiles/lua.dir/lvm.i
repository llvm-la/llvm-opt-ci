# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
__attribute__((visibility("hidden"))) extern const char *luaF_getlocalname (const Proto *func, int local_number,
                                         int pc);
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c" 2
...
static void callTMres (lua_State *L, StkId res, const TValue *f,
  ...
  { const TValue *o2=(f); TValue *o1=(L->top); o1->value = o2->value; o1->tt=o2->tt; ((void)0); };
  { const TValue *o2=(p1); TValue *o1=(L->top+1); o1->value = o2->value; o1->tt=o2->tt; ((void)0); };
  { const TValue *o2=(p2); TValue *o1=(L->top+2); o1->value = o2->value; o1->tt=o2->tt; ((void)0); };
...
static void callTM (lua_State *L, const TValue *f, const TValue *p1,
  ...
  { const TValue *o2=(p1); TValue *o1=(L->top+1); o1->value = o2->value; o1->tt=o2->tt; ((void)0); };
  { const TValue *o2=(p2); TValue *o1=(L->top+2); o1->value = o2->value; o1->tt=o2->tt; ((void)0); };
  { const TValue *o2=(p3); TValue *o1=(L->top+3); o1->value = o2->value; o1->tt=o2->tt; ((void)0); };
...
int luaV_equalval (lua_State *L, const TValue *t1, const TValue *t2) {
  ...
  switch (((t1)->tt)) {
    case 0: return 1;
    case 3: return ((((t1)->value.n))==(((t2)->value.n)));
    case 1: return ((t1)->value.b) == ((t2)->value.b);
    case 2: return ((t1)->value.p) == ((t2)->value.p);
    case 7: {
      if ((&(&(t1)->value.gc->u)->uv) == (&(&(t2)->value.gc->u)->uv)) return 1;
      tm = get_compTM(L, (&(&(t1)->value.gc->u)->uv)->metatable, (&(&(t2)->value.gc->u)->uv)->metatable,
                         TM_EQ);
      break;
    }
    case 5: {
      if ((&(t1)->value.gc->h) == (&(t2)->value.gc->h)) return 1;
...
static void Arith (lua_State *L, StkId ra, const TValue *rb,
  ...
  if ((b = luaV_tonumber(rb, &tempb)) != ((void*)0) &&
    ...
    switch (op) {
      case TM_ADD: { TValue *i_o=(ra); i_o->value.n=(((nb)+(nc))); i_o->tt=3; }; break;
      case TM_SUB: { TValue *i_o=(ra); i_o->value.n=(((nb)-(nc))); i_o->tt=3; }; break;
      case TM_MUL: { TValue *i_o=(ra); i_o->value.n=(((nb)*(nc))); i_o->tt=3; }; break;
      case TM_DIV: { TValue *i_o=(ra); i_o->value.n=(((nb)/(nc))); i_o->tt=3; }; break;
      case TM_MOD: { TValue *i_o=(ra); i_o->value.n=(((nb) - floor((nb)/(nc))*(nc))); i_o->tt=3; }; break;
      case TM_POW: { TValue *i_o=(ra); i_o->value.n=((pow(nb,nc))); i_o->tt=3; }; break;
      case TM_UNM: { TValue *i_o=(ra); i_o->value.n=((-(nb))); i_o->tt=3; }; break;
...
# 373 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/lvm.c"
  ...
  for (;;) {
    ...
    switch ((((OpCode)(((i)>>0) & ((~((~(Instruction)0)<<6))<<0))))) {
      ...
      case OP_LOADBOOL: {
        ...
        if ((((int)(((i)>>((0 + 6) + 8)) & ((~((~(Instruction)0)<<9))<<0))))) pc++;
        continue;
      }
      case OP_LOADNIL: {
      ...
      case OP_TFORLOOP: {
        ...
        if (!(((cb)->tt) == 0)) {
          { const TValue *o2=(cb); TValue *o1=(cb-1); o1->value = o2->value; o1->tt=o2->tt; ((void)0); };
          {(pc) += (((((int)(((*pc)>>((0 + 6) + 8)) & ((~((~(Instruction)0)<<(9 + 9)))<<0))))-(((1<<(9 + 9))-1)>>1))); {((void) 0); ((void) 0);};};
        }
        pc++;
        continue;
