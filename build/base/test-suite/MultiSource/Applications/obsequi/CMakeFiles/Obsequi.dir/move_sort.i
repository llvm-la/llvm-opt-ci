# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c"
extern void
sort_moves(Move movelist[256], s32bit start, s32bit num_moves)
{
  Move bucket[128][256];
  s32bit buck_val[128];
  s32bit buck_size[128];
  ...
  for(i = start; i < num_moves; i++){
    ...
    if(j == num_buckets){
      if(j == 128) ((_fatal_error_aux("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c", 34, ((1) ? (1) : 256), "Not enough buckets.\n" )));
