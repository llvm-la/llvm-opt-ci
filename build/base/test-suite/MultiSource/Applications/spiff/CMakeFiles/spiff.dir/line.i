# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/line.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/line.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/line.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/line.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/line.c" 2
...
extern int _K_atm;
extern int _K_btm;
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/line.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/line.c" 2
...
int _L_aclindex[10000];
int _L_bclindex[10000];

int _L_atlindex[10000];
int _L_btlindex[10000];
...
int L_init_file(int fnumber, char *fname)
{
 ...
 if ((fp = fopen(fname,"r")) == (FILE*) ((void*)0))
 {
 ...
 (fnumber?(_L_brlm=(0)):(_L_arlm=(0)));




 while (fgets(buf,1024 +1,fp) != (char *) ((void*)0))
 {
  tmplen = strlen(buf);
  if (tmplen <= 0)
  {
 ...
 "didn't find a newline at end of line %d in file %s, added one\n",
  ...
  _L_setrline(fnumber,(fnumber?_L_brlm:_L_arlm),buf);

  if ((fnumber?_L_brlm:_L_arlm) >= 10000 -1)
  {
   (void) sprintf(Z_err_buf,
 ...
 (fnumber?(_L_bclm=(0)):(_L_aclm=(0)));
 (fnumber?(_L_btlm=(0)):(_L_atlm=(0)));
