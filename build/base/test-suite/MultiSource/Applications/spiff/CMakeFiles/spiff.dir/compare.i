# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
...
extern int _K_atm;
extern int _K_btm;
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.h" 1
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
...
extern int X_com();
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c" 2
...
int a,b,flags;
{
 ...
 atmp = (0?(_K_bto[a]):(_K_ato[a]));
 btmp = (1?(_K_bto[b]):(_K_ato[b]));
 if(flags & 002)
 {
  return(_X_strcmp((atmp->text),(btmp->text),flags));
 }
 else
 {
...
static int _X_cmptokens(K_token p1,K_token p2,int flags)
{
 ...
 {
  case 1:
   return(_X_strcmp((p1->text),(p2->text),flags));
  case 2:
   return(_X_floatdiff((p1->flo_num),
        (p2->flo_num),
        T_picktol((p1->tolerance),
           (p2->tolerance))));
  default:
...
# 135 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/compare.c"
 for(tol_tmp=the_tol; !(((tol_tmp) == ((T_tol) 0))) ;tol_tmp=(tol_tmp->next))
 {
  if ((2 == (tol_tmp->tol_type)) ||




   ((0 == (tol_tmp->tol_type))
       && !((0 == (tol_tmp->flo_tol)->exponent) && (!strcmp((tol_tmp->flo_tol)->mantissa,"0")))
       && (R_getexp(p1) <
     R_getexp((tol_tmp->flo_tol))-1)
       && (R_getexp(p2) <
     R_getexp((tol_tmp->flo_tol))-1)))
  {
    return(0);
 ...
 for(tol_tmp=the_tol; !(((tol_tmp) == ((T_tol) 0))) ;tol_tmp=(tol_tmp->next))
 {
  float_tmp = (tol_tmp->flo_tol);

  if ((tol_tmp->tol_type) == 0)
  {

  }
  else if ((tol_tmp->tol_type) == 1)
  {
