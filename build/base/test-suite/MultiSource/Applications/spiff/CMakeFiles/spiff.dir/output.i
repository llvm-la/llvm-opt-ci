# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c"
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
...
extern int _K_atm;
extern int _K_btm;
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c" 2
...
_O_st_init()
{
 ...
 if (((void*)0) == (_O_st_tmp = (char*) getenv("TERM")))
 {
...
# 94 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c"
 _O_need_init = 0;
}
...
int numb, flags,filenum;
{
 ...
 {
# 194 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c"
  if (numb < 0)
   return(0);
  ...
  return((filenum?(_L_btlindex[numb]): (_L_atlindex[numb]))+1);
 }
}
...
int file,index,flags;
{
 ...
 if (flags & 010)
 {
  tmp = (file?(_K_bto[index]):(_K_ato[index]));
  text = _O_convert((tmp->text));
  (void) sprintf(buf,"%s -- line %d, character %d\n",
    ...
    (file?(_L_btlindex[(tmp->linenum)]): (_L_atlindex[(tmp->linenum)]))+1,
    (tmp->pos)+1);
  return(buf);
 }
 else
 {
  return((file?(_L_bl[_L_bclindex[_L_btlindex[index]]]): (_L_al[_L_aclindex[_L_atlindex[index]]])));
 }
}
...
int start,end,file;
{
 ...
 for (cnt=start;cnt <= end; cnt++)
 {
  nexttoken = (file?(_K_bto[cnt]):(_K_ato[cnt]));
  nextline = (nexttoken->linenum);
  if (lastline != nextline)
  {
   int lastone,lastchar;
   K_token lasttok;
   char linetext[1024 +1];
...
# 302 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/output.c"
   (void) strcpy(linetext,(file?(_L_bl[_L_bclindex[_L_btlindex[nextline]]]): (_L_al[_L_aclindex[_L_atlindex[nextline]]])));
   _O_pchars(linetext,0,(nexttoken->pos));
   _O_start_standout();




   for ( lastone=cnt,lasttok = (file?(_K_bto[lastone]):(_K_ato[lastone]));
         (lastone<=end)&&(nextline == (lasttok->linenum));
    lastone++,lasttok = (file?(_K_bto[lastone]):(_K_ato[lastone])))
   {
   }
   lastone--;
   lasttok = (file?(_K_bto[lastone]):(_K_ato[lastone]));
   lastchar = (lasttok->pos)
     + strlen((lasttok->text));
   _O_pchars(linetext,(nexttoken->pos),lastchar);
   _O_end_standout();
...
int flags;
{
 ...
 int t_beg1, t_beg2, t_end1, t_end2;
 ...
 while (ahead != ((E_edit) 0)) {
  ...
  ((ahead)->line1 = ((((ahead)->line1))-1));
  ((ahead)->line2 = ((((ahead)->line2))-1));
...
skipit:;
  ...
  else
  {
   ...
   if ( t_beg1 >= 0)
    first1 = ((0?(_K_bto[t_beg1]):(_K_ato[t_beg1]))->linenum);
   else
    first1 = t_beg1;

   if ( t_end1 >= 0)
    last1 = ((0?(_K_bto[t_end1]):(_K_ato[t_end1]))->linenum);
   else
    last1 = t_end1;

   if ( t_beg2 >= 0)
    first2 = ((1?(_K_bto[t_beg2]):(_K_ato[t_beg2]))->linenum);
   else
    first2 = t_beg2;

   if ( t_end2 >= 0)
    last2 = ((1?(_K_bto[t_end2]):(_K_ato[t_end2]))->linenum);
   else
    last2 = t_end2;
