# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c"
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.h" 1
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.h"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c" 2
...
# 136 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c"
int intrapred( struct img_par *img,
               int ioff,
               int joff,
               int img_block_x,
               int img_block_y)
{
  ...
  case 0:
    ...
    for(j=0;j<4;j++)
      for(i=0;i<4;i++)
        img->mpr[j+joff][i+ioff]=imgY[pix_b.pos_y][pix_b.pos_x+i];
    break;
  ...
  case 1:
    ...
    for(j=0;j<4;j++)
      for(i=0;i<4;i++)
        img->mpr[j+joff][i+ioff]=imgY[pix_a[j].pos_y][pix_a[j].pos_x];
    break;
  ...
  case 4:
    ...
    img->mpr[jpos3][ipos0] = (imgpel) (((PredPel[12]) + 2*(PredPel[11]) + (PredPel[10]) + 2) >> 2);
    img->mpr[jpos2][ipos0] =
    img->mpr[jpos3][ipos1] = (imgpel) (((PredPel[11]) + 2*(PredPel[10]) + (PredPel[9]) + 2) >> 2);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos3][ipos2] = (imgpel) (((PredPel[10]) + 2*(PredPel[9]) + (PredPel[0]) + 2) >> 2);
    img->mpr[jpos0][ipos0] =
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos3][ipos3] = (imgpel) (((PredPel[9]) + 2*(PredPel[0]) + (PredPel[1]) + 2) >> 2);
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos2][ipos3] = (imgpel) (((PredPel[0]) + 2*(PredPel[1]) + (PredPel[2]) + 2) >> 2);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos1][ipos3] = (imgpel) (((PredPel[1]) + 2*(PredPel[2]) + (PredPel[3]) + 2) >> 2);
    img->mpr[jpos0][ipos3] = (imgpel) (((PredPel[2]) + 2*(PredPel[3]) + (PredPel[4]) + 2) >> 2);
    break;
  ...
  case 3:
    ...
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos1][ipos0] = (imgpel) (((PredPel[2]) + (PredPel[4]) + 2*((PredPel[3])) + 2) >> 2);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos2][ipos0] = (imgpel) (((PredPel[3]) + (PredPel[5]) + 2*((PredPel[4])) + 2) >> 2);
    img->mpr[jpos0][ipos3] =
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos3][ipos0] = (imgpel) (((PredPel[4]) + (PredPel[6]) + 2*((PredPel[5])) + 2) >> 2);
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos3][ipos1] = (imgpel) (((PredPel[5]) + (PredPel[7]) + 2*((PredPel[6])) + 2) >> 2);
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos3][ipos2] = (imgpel) (((PredPel[6]) + (PredPel[8]) + 2*((PredPel[7])) + 2) >> 2);
    img->mpr[jpos3][ipos3] = (imgpel) (((PredPel[7]) + 3*((PredPel[8])) + 2) >> 2);
    break;
  ...
  case 5:
    ...
    img->mpr[jpos0][ipos0] =
    img->mpr[jpos2][ipos1] = (imgpel) (((PredPel[0]) + (PredPel[1]) + 1) >> 1);
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos2][ipos2] = (imgpel) (((PredPel[1]) + (PredPel[2]) + 1) >> 1);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos2][ipos3] = (imgpel) (((PredPel[2]) + (PredPel[3]) + 1) >> 1);
    img->mpr[jpos0][ipos3] = (imgpel) (((PredPel[3]) + (PredPel[4]) + 1) >> 1);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos3][ipos1] = (imgpel) (((PredPel[9]) + 2*(PredPel[0]) + (PredPel[1]) + 2) >> 2);
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos3][ipos2] = (imgpel) (((PredPel[0]) + 2*(PredPel[1]) + (PredPel[2]) + 2) >> 2);
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos3][ipos3] = (imgpel) (((PredPel[1]) + 2*(PredPel[2]) + (PredPel[3]) + 2) >> 2);
    img->mpr[jpos1][ipos3] = (imgpel) (((PredPel[2]) + 2*(PredPel[3]) + (PredPel[4]) + 2) >> 2);
    img->mpr[jpos2][ipos0] = (imgpel) (((PredPel[0]) + 2*(PredPel[9]) + (PredPel[10]) + 2) >> 2);
    img->mpr[jpos3][ipos0] = (imgpel) (((PredPel[9]) + 2*(PredPel[10]) + (PredPel[11]) + 2) >> 2);
    break;
  ...
  case 7:
    ...
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos2][ipos1] = (imgpel) (((PredPel[3]) + (PredPel[4]) + 1) >> 1);
    img->mpr[jpos0][ipos3] =
    img->mpr[jpos2][ipos2] = (imgpel) (((PredPel[4]) + (PredPel[5]) + 1) >> 1);
    img->mpr[jpos2][ipos3] = (imgpel) (((PredPel[5]) + (PredPel[6]) + 1) >> 1);
    img->mpr[jpos1][ipos0] = (imgpel) (((PredPel[1]) + 2*(PredPel[2]) + (PredPel[3]) + 2) >> 2);
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos3][ipos0] = (imgpel) (((PredPel[2]) + 2*(PredPel[3]) + (PredPel[4]) + 2) >> 2);
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos3][ipos1] = (imgpel) (((PredPel[3]) + 2*(PredPel[4]) + (PredPel[5]) + 2) >> 2);
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos3][ipos2] = (imgpel) (((PredPel[4]) + 2*(PredPel[5]) + (PredPel[6]) + 2) >> 2);
    img->mpr[jpos3][ipos3] = (imgpel) (((PredPel[5]) + 2*(PredPel[6]) + (PredPel[7]) + 2) >> 2);
    break;
  ...
  case 8:
    ...
    img->mpr[jpos0][ipos0] = (imgpel) (((PredPel[9]) + (PredPel[10]) + 1) >> 1);
    img->mpr[jpos0][ipos1] = (imgpel) (((PredPel[9]) + 2*(PredPel[10]) + (PredPel[11]) + 2) >> 2);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos1][ipos0] = (imgpel) (((PredPel[10]) + (PredPel[11]) + 1) >> 1);
    img->mpr[jpos0][ipos3] =
    img->mpr[jpos1][ipos1] = (imgpel) (((PredPel[10]) + 2*(PredPel[11]) + (PredPel[12]) + 2) >> 2);
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos2][ipos0] = (imgpel) (((PredPel[11]) + (PredPel[12]) + 1) >> 1);
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos2][ipos1] = (imgpel) (((PredPel[11]) + 2*(PredPel[12]) + (PredPel[12]) + 2) >> 2);
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos3][ipos1] =
    img->mpr[jpos3][ipos0] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos3][ipos2] =
    img->mpr[jpos3][ipos3] = (imgpel) (PredPel[12]);
    break;
  ...
  case 6:
    ...
    img->mpr[jpos0][ipos0] =
    img->mpr[jpos1][ipos2] = (imgpel) (((PredPel[0]) + (PredPel[9]) + 1) >> 1);
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos1][ipos3] = (imgpel) (((PredPel[9]) + 2*(PredPel[0]) + (PredPel[1]) + 2) >> 2);
    img->mpr[jpos0][ipos2] = (imgpel) (((PredPel[0]) + 2*(PredPel[1]) + (PredPel[2]) + 2) >> 2);
    img->mpr[jpos0][ipos3] = (imgpel) (((PredPel[1]) + 2*(PredPel[2]) + (PredPel[3]) + 2) >> 2);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos2][ipos2] = (imgpel) (((PredPel[9]) + (PredPel[10]) + 1) >> 1);
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos2][ipos3] = (imgpel) (((PredPel[0]) + 2*(PredPel[9]) + (PredPel[10]) + 2) >> 2);
    img->mpr[jpos2][ipos0] =
    img->mpr[jpos3][ipos2] = (imgpel) (((PredPel[10]) + (PredPel[11]) + 1) >> 1);
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos3][ipos3] = (imgpel) (((PredPel[9]) + 2*(PredPel[10]) + (PredPel[11]) + 2) >> 2);
    img->mpr[jpos3][ipos0] = (imgpel) (((PredPel[11]) + (PredPel[12]) + 1) >> 1);
    img->mpr[jpos3][ipos1] = (imgpel) (((PredPel[10]) + 2*(PredPel[11]) + (PredPel[12]) + 2) >> 2);
    break;
...
# 444 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c"
int intrapred_luma_16x16(struct img_par *img,
                         int predmode)
{
  int s0=0,s1,s2;
  ...
  case 0:
    ...
    for(j=0;j<16;j++)
      for(i=0;i<16;i++)
        img->mpr[j][i]=imgY[up.pos_y][up.pos_x+i];
    break;
  ...
  case 1:
    ...
    for(j=0;j<16;j++)
      for(i=0;i<16;i++)
        img->mpr[j][i]=imgY[left[j+1].pos_y][left[j+1].pos_x];
    break;
  ...
  case 2:
    ...
    {
      if (up_avail)
        s1 += imgY[up.pos_y][up.pos_x+i];
      if (left_avail)
        s2 += imgY[left[i+1].pos_y][left[i+1].pos_x];
    }
            ...
            int chroma)
{
  ...
  if (!lossless_qpprime)
  {
    ...
    for (j=0;j<4;j++)
    {
      memcpy(&m5[0],&img->cof[i0][j0][j][0], 4 * sizeof(int));
    ...
    for (i=0;i<4;i++)
    {
      ...
      img->m7[0][i] = iClip1(max_imgpel_value, rshift_rnd_sf((m6[0] + m6[3] + ((long)img->mpr[ joff][ipos] << 6)), 6));
      img->m7[1][i] = iClip1(max_imgpel_value, rshift_rnd_sf((m6[1] + m6[2] + ((long)img->mpr[1 + joff][ipos] << 6)), 6));
      img->m7[2][i] = iClip1(max_imgpel_value, rshift_rnd_sf((m6[1] - m6[2] + ((long)img->mpr[2 + joff][ipos] << 6)), 6));
      img->m7[3][i] = iClip1(max_imgpel_value, rshift_rnd_sf((m6[0] - m6[3] + ((long)img->mpr[3 + joff][ipos] << 6)), 6));
    }
  }
  else
  {
...
# 836 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c"
void AssignQuantParam(pic_parameter_set_rbsp_t* pps, seq_parameter_set_rbsp_t* sps)
{
  int i;
  ...
  else
  {
    if(sps->seq_scaling_matrix_present_flag)
    {
      for(i=0; i<8; i++)
      {
        ...
        {
          if(!sps->seq_scaling_list_present_flag[i] || sps->UseDefaultScalingMatrix8x8Flag[i-6])
...
# 930 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c"
               ...
               int j0)
{
  ...
  for (i=0;i<4;i++)
  {
    ...
    {
      ilev=(iabs(predicted_block[i][j]) * quant_coef[qp_rem_sp][i][j] + qp_const2) >> q_bits_sp;
      ilev= isignab(ilev,predicted_block[i][j])+ img->cof[i0][j0][j][i];
      img->cof[i0][j0][j][i] = isignab(iabs(ilev) * dequant_coef[qp_rem_sp][i][j] << qp_per_sp ,ilev) ;
    }
    else
    {
  ...
  for (i=0;i<4;i++)
  {
    ...
    {
      j1=3-j;
      img->m7[j][i] =iClip1(img->max_imgpel_value,rshift_rnd_sf((m6[j]+m6[j1]),6));
      img->m7[j1][i]=iClip1(img->max_imgpel_value,rshift_rnd_sf((m6[j]-m6[j1]),6));
    }
  }
}
# 1134 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/block.c"
void copyblock_sp(struct img_par *img,int block_x,int block_y)
{
...
void itrans_sp_chroma(struct img_par *img,int ll)
{
  ...
  for (j=0;j< 4; j++)
  {
    ...
    if (img->sp_switch || img->type==SI_SLICE)
    {
      ...
      ilev = (iabs(predicted_chroma_block[n1*4 +i][n2*4 +j]) * quant_coef[qp_rem_sp][i][j] + qp_const2) >> q_bits_sp;

      ilev = isignab(ilev,predicted_chroma_block[n1*4 +i][n2*4 +j]) + img->cof[n1+ll][4+n2][j][i];
    ...
    else
    {
      ...
      ilev=((img->cof[n1+ll][4+n2][j][i]*dequant_coef[qp_rem][i][j]*A[i][j]<< qp_per) >>6)+predicted_chroma_block[n1*4 +i][n2*4 +j] ;
