# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c" 2
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c"
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/biaridecod.h" 1
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/biaridecod.h"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/ctx_tables.h" 1
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/ctx_tables.h"
static const int INIT_MB_TYPE_I[1][3][11][2] =
{

  {
    { { 20, -15} , { 2, 54} , { 3, 74} , {0,64} , { -28, 127} , { -23, 104} , { -6, 53} , { -1, 54} , { 7, 51} , {0,64} , {0,64} },
...
static const int INIT_MB_TYPE_P[3][3][11][2] =
{
  ...
  {
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
  { { 23, 33} , { 23, 2} , { 21, 0} , {0,64} , { 1, 9} , { 0, 49} , { -37, 118} , { 5, 57} , { -13, 78} , { -11, 65} , { 1, 62} },
  { { 26, 67} , { 16, 90} , { 9, 104} , {0,64} , { -46, 127} , { -20, 104} , { 1, 67} , { 18, 64} , { 9, 43} , { 29, 0} , {0,64} }
  },

  {
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 22, 25} , { 34, 0} , { 16, 0} , {0,64} , { -2, 9} , { 4, 41} , { -29, 118} , { 2, 65} , { -6, 71} , { -13, 79} , { 5, 52} },
    { { 57, 2} , { 41, 36} , { 26, 69} , {0,64} , { -45, 127} , { -15, 101} , { -4, 76} , { 26, 34} , { 19, 22} , { 40, 0} , {0,64} }
  },

  {
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 29, 16} , { 25, 0} , { 14, 0} , {0,64} , { -10, 51} , { -3, 62} , { -27, 99} , { 26, 16} , { -4, 85} , { -24, 102} , { 5, 57} },
  { { 54, 0} , { 37, 42} , { 12, 97} , {0,64} , { -32, 127} , { -22, 117} , { -2, 74} , { 20, 40} , { 20, 10} , { 29, 0} , {0,64} }
  }
};
...
static const int INIT_B8_TYPE_P[3][2][9][2] =
{
  ...
  {
    { {0,64} , { 12, 49} , {0,64} , { -4, 73} , { 17, 50} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { -6, 86} , { -17, 95} , { -6, 61} , { 9, 45} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} }
  },

  {
    { {0,64} , { 9, 50} , {0,64} , { -3, 70} , { 10, 54} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 6, 69} , { -13, 90} , { 0, 52} , { 8, 43} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} }
  },

  {
    { {0,64} , { 6, 57} , {0,64} , { -17, 73} , { 14, 57} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { -6, 93} , { -14, 88} , { -6, 44} , { 4, 55} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} }
  }
};
...
static const int INIT_MV_RES_P[3][2][10][2] =
{
  ...
  {
    { { -3, 69} , {0,64} , { -6, 81} , { -11, 96} , {0,64} , { 0, 58} , {0,64} , { -3, 76} , { -10, 94} , {0,64} },
    { { 6, 55} , { 7, 67} , { -5, 86} , { 2, 88} , {0,64} , { 5, 54} , { 4, 69} , { -3, 81} , { 0, 88} , {0,64} }
  },

  {
    { { -2, 69} , {0,64} , { -5, 82} , { -10, 96} , {0,64} , { 1, 56} , {0,64} , { -3, 74} , { -6, 85} , {0,64} },
    { { 2, 59} , { 2, 75} , { -3, 87} , { -3, 100} , {0,64} , { 0, 59} , { -3, 81} , { -7, 86} , { -5, 95} , {0,64} }
  },

  {
    { { -11, 89} , {0,64} , { -15, 103} , { -21, 116} , {0,64} , { 1, 63} , {0,64} , { -5, 85} , { -13, 106} , {0,64} },
    { { 19, 57} , { 20, 58} , { 4, 84} , { 6, 96} , {0,64} , { 5, 63} , { 6, 75} , { -3, 90} , { -1, 101} , {0,64} }
  }
};
...
static const int INIT_MB_AFF_P[3][1][4][2] =
{
  ...
  {
    { { 13, 15} , { 7, 51} , { 2, 80} , {0,64} }
  },

  {
    { { 7, 34} , { -9, 88} , { -20, 127} , {0,64} }
  }
};
...
static const int INIT_MAP_I[1][8][15][2] =
{

  {
    ...
    { {0,64} , { 1, 50} , { 7, 52} , { 10, 35} , { 0, 44} , { 11, 38} , { 1, 45} , { 0, 46} , { 5, 44} , { 31, 17} , { 1, 51} , { 7, 50} , { 28, 19} , { 16, 33} , { 14, 62} },
    ...
    { { -8, 102} , { -15, 100} , { 0, 95} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { -4, 75} , { 2, 72} , { -11, 75} , { -3, 71} , { 15, 46} , { -13, 69} , { 0, 62} , { 0, 65} , { 21, 37} , { -15, 72} , { 9, 57} , { 16, 54} , { 0, 62} , { 12, 72} }
  }
};
static const int INIT_MAP_P[3][8][15][2] =
{

  {
    ...
    { {0,64} , { 11, 35} , { 4, 64} , { 1, 61} , { 11, 35} , { 18, 25} , { 12, 24} , { 13, 29} , { 13, 36} , { -10, 93} , { -7, 73} , { -2, 73} , { 13, 46} , { 9, 49} , { -7, 100} },
    ...
    { { 3, 64} , { 1, 61} , { 9, 63} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 7, 50} , { 16, 39} , { 5, 44} , { 4, 52} , { 11, 48} , { -5, 60} , { -1, 59} , { 0, 59} , { 22, 33} , { 5, 44} , { 14, 43} , { -1, 78} , { 0, 60} , { 9, 69} }
  },

  {
    { { -13, 103} , { -13, 91} , { -9, 89} , { -14, 92} , { -8, 76} , { -12, 87} , { -23, 110} , { -24, 105} , { -10, 78} , { -20, 112} , { -17, 99} , { -78, 127} , { -70, 127} , { -50, 127} , { -46, 127} },
    { {0,64} , { -4, 66} , { -5, 78} , { -4, 71} , { -8, 72} , { 2, 59} , { -1, 55} , { -7, 70} , { -6, 75} , { -8, 89} , { -34, 119} , { -3, 75} , { 32, 20} , { 30, 22} , { -44, 127} },
    ...
    { { -4, 71} , { 0, 58} , { 7, 61} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 9, 41} , { 18, 25} , { 9, 32} , { 5, 43} , { 9, 47} , { 0, 44} , { 0, 51} , { 2, 46} , { 19, 38} , { -4, 66} , { 15, 38} , { 12, 42} , { 9, 34} , { 0, 89} }
  },

  {
    { { -4, 86} , { -12, 88} , { -5, 82} , { -3, 72} , { -4, 67} , { -8, 72} , { -16, 89} , { -9, 69} , { -1, 59} , { 5, 66} , { 4, 57} , { -4, 71} , { -2, 71} , { 2, 58} , { -1, 74} },
    { {0,64} , { -4, 44} , { -1, 69} , { 0, 62} , { -7, 51} , { -4, 47} , { -6, 42} , { -3, 41} , { -6, 53} , { 8, 76} , { -9, 78} , { -11, 83} , { 9, 52} , { 0, 67} , { -5, 90} },
    ...
    { { 3, 65} , { -7, 69} , { 8, 77} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { -10, 66} , { 3, 62} , { -3, 68} , { -20, 81} , { 0, 30} , { 1, 7} , { -3, 23} , { -21, 74} , { 16, 66} , { -23, 124} , { 17, 37} , { 44, -18} , { 50, -34} , { -22, 127} }
  }
};
...
static const int INIT_LAST_I[1][8][15][2] =
{

  {
    ...
    { {0,64} , { 12, 38} , { 11, 45} , { 15, 39} , { 11, 42} , { 13, 44} , { 16, 45} , { 12, 41} , { 10, 49} , { 30, 34} , { 18, 42} , { 10, 55} , { 17, 51} , { 17, 46} , { 0, 89} },
    { { 23, -13} , { 26, -13} , { 40, -15} , { 49, -14} , { 44, 3} , { 45, 6} , { 44, 34} , { 33, 54} , { 19, 82} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 26, -19} , { 22, -17} , { 26, -17} , { 30, -25} , { 28, -20} , { 33, -23} , { 37, -27} , { 33, -23} , { 40, -28} , { 38, -17} , { 33, -11} , { 40, -15} , { 41, -6} , { 38, 1} , { 41, 17} },
    { { 30, -6} , { 27, 3} , { 26, 22} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 37, -16} , { 35, -4} , { 38, -8} , { 38, -3} , { 37, 3} , { 38, 5} , { 42, 0} , { 35, 16} , { 39, 22} , { 14, 48} , { 27, 37} , { 21, 60} , { 12, 68} , { 2, 97} }
  }
};
static const int INIT_LAST_P[3][8][15][2] =
{

  {
    ...
    { {0,64} , { 6, 51} , { 6, 57} , { 7, 53} , { 6, 52} , { 6, 55} , { 11, 45} , { 14, 36} , { 8, 53} , { -1, 82} , { 7, 55} , { -3, 78} , { 15, 46} , { 22, 31} , { -1, 84} },
    { { 9, -2} , { 26, -9} , { 33, -9} , { 39, -7} , { 41, -2} , { 45, 3} , { 49, 9} , { 45, 27} , { 36, 59} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 25, 7} , { 30, -7} , { 28, 3} , { 28, 4} , { 32, 0} , { 34, -1} , { 30, 6} , { 30, 6} , { 32, 9} , { 31, 19} , { 26, 27} , { 26, 30} , { 37, 20} , { 28, 34} , { 17, 70} },
    { { 1, 67} , { 5, 59} , { 9, 67} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 16, 30} , { 18, 32} , { 18, 35} , { 22, 29} , { 24, 31} , { 23, 38} , { 18, 43} , { 20, 41} , { 11, 63} , { 9, 59} , { 9, 64} , { -1, 94} , { -2, 89} , { -9, 108} }
  },

  {
    { { 4, 45} , { 10, 28} , { 10, 31} , { 33, -11} , { 52, -43} , { 18, 15} , { 28, 0} , { 35, -22} , { 38, -25} , { 34, 0} , { 39, -18} , { 32, -12} , { 102, -94} , { 0, 0} , { 56, -15} },
    { {0,64} , { 33, -4} , { 29, 10} , { 37, -5} , { 51, -29} , { 39, -9} , { 52, -34} , { 69, -58} , { 67, -63} , { 44, -5} , { 32, 7} , { 55, -29} , { 32, 1} , { 0, 0} , { 27, 36} },
    { { 17, -10} , { 32, -13} , { 42, -9} , { 49, -5} , { 53, 0} , { 64, 3} , { 68, 10} , { 66, 27} , { 47, 57} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 33, -25} , { 34, -30} , { 36, -28} , { 38, -28} , { 38, -27} , { 34, -18} , { 35, -16} , { 34, -14} , { 32, -8} , { 37, -6} , { 35, 0} , { 30, 10} , { 28, 18} , { 26, 25} , { 29, 41} },
    { { 0, 75} , { 2, 72} , { 8, 77} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 14, 35} , { 18, 31} , { 17, 35} , { 21, 30} , { 17, 45} , { 20, 42} , { 18, 45} , { 27, 26} , { 16, 54} , { 7, 66} , { 16, 56} , { 11, 73} , { 10, 67} , { -10, 116} }
  },

  {
    { { 4, 39} , { 0, 42} , { 7, 34} , { 11, 29} , { 8, 31} , { 6, 37} , { 7, 42} , { 3, 40} , { 8, 33} , { 13, 43} , { 13, 36} , { 4, 47} , { 3, 55} , { 2, 58} , { 6, 60} },
    { {0,64} , { 8, 44} , { 11, 44} , { 14, 42} , { 7, 48} , { 4, 56} , { 4, 52} , { 13, 37} , { 9, 49} , { 19, 58} , { 10, 48} , { 12, 45} , { 0, 69} , { 20, 33} , { 8, 63} },
    { { 9, -2} , { 30, -10} , { 31, -4} , { 33, -1} , { 33, 7} , { 31, 12} , { 37, 23} , { 31, 38} , { 20, 64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 35, -18} , { 33, -25} , { 28, -3} , { 24, 10} , { 27, 0} , { 34, -14} , { 52, -44} , { 39, -24} , { 19, 17} , { 31, 25} , { 36, 29} , { 24, 33} , { 34, 15} , { 30, 20} , { 22, 73} },
    { { 20, 34} , { 19, 31} , { 27, 44} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 19, 16} , { 15, 36} , { 15, 36} , { 21, 28} , { 25, 21} , { 30, 20} , { 31, 12} , { 27, 16} , { 24, 42} , { 0, 93} , { 14, 56} , { 15, 57} , { 26, 38} , { -24, 127} }
  }
};
...
static const int INIT_FLD_MAP_I[1][8][15][2] =
{

  {
    ...
    { {0,64} , { 10, 44} , { -7, 62} , { 15, 36} , { 14, 40} , { 16, 27} , { 12, 29} , { 1, 44} , { 20, 36} , { 18, 32} , { 5, 42} , { 1, 48} , { 10, 62} , { 17, 46} , { 9, 64} },
    ...
    { { -7, 99} , { -14, 95} , { 2, 95} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 0, 76} , { -5, 74} , { 0, 70} , { -11, 75} , { 1, 68} , { 0, 65} , { -14, 73} , { 3, 62} , { 4, 62} , { -1, 68} , { -13, 75} , { 11, 55} , { 5, 64} , { 12, 70} }
  }
};
static const int INIT_FLD_MAP_P[3][8][15][2] =
{

  {
    ...
    { {0,64} , { -9, 93} , { -22, 94} , { -5, 86} , { 9, 67} , { -4, 80} , { -10, 85} , { -1, 70} , { 7, 60} , { 9, 58} , { 5, 61} , { 12, 50} , { 15, 50} , { 18, 49} , { 17, 54} },
    { { -5, 85} , { -6, 81} , { -10, 77} , { -7, 81} , { -17, 80} , { -18, 73} , { -4, 74} , { -10, 83} , { -9, 71} , { -9, 67} , { -1, 61} , { -8, 66} , { -14, 66} , { 0, 59} , { 2, 59} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 10, 41} , { 7, 46} , { -1, 51} , { 7, 49} , { 8, 52} , { 9, 41} , { 6, 47} , { 2, 55} , { 13, 41} , { 10, 44} , { 6, 50} , { 5, 53} , { 13, 49} , { 4, 63} , { 6, 64} },
    { { -2, 69} , { -2, 59} , { 6, 70} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 10, 44} , { 9, 31} , { 12, 43} , { 3, 53} , { 14, 34} , { 10, 38} , { -3, 52} , { 13, 40} , { 17, 32} , { 7, 44} , { 7, 38} , { 13, 50} , { 10, 57} , { 26, 43} }
  },

  {
    { { -21, 126} , { -23, 124} , { -20, 110} , { -26, 126} , { -25, 124} , { -17, 105} , { -27, 121} , { -27, 117} , { -17, 102} , { -26, 117} , { -27, 116} , { -33, 122} , { -10, 95} , { -14, 100} , { -8, 95} },
    { {0,64} , { -17, 111} , { -28, 114} , { -6, 89} , { -2, 80} , { -4, 82} , { -9, 85} , { -8, 81} , { -1, 72} , { 5, 64} , { 1, 67} , { 9, 56} , { 0, 69} , { 1, 69} , { 7, 69} },
    ...
    { { -1, 70} , { -9, 72} , { 14, 60} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 16, 37} , { 0, 47} , { 18, 35} , { 11, 37} , { 12, 41} , { 10, 41} , { 2, 48} , { 12, 41} , { 13, 41} , { 0, 59} , { 3, 50} , { 19, 40} , { 3, 66} , { 18, 50} }
  },

  {
    { { -22, 127} , { -25, 127} , { -25, 120} , { -27, 127} , { -19, 114} , { -23, 117} , { -25, 118} , { -26, 117} , { -24, 113} , { -28, 118} , { -31, 120} , { -37, 124} , { -10, 94} , { -15, 102} , { -10, 99} },
    { {0,64} , { -13, 106} , { -50, 127} , { -5, 92} , { 17, 57} , { -5, 86} , { -13, 94} , { -12, 91} , { -2, 77} , { 0, 71} , { -1, 73} , { 4, 64} , { -7, 81} , { 5, 64} , { 15, 57} },
    { { -3, 78} , { -8, 74} , { -9, 72} , { -10, 72} , { -18, 75} , { -12, 71} , { -11, 63} , { -5, 70} , { -17, 75} , { -14, 72} , { -16, 67} , { -8, 53} , { -14, 59} , { -9, 52} , { -11, 68} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 1, 67} , { 0, 68} , { -10, 67} , { 1, 68} , { 0, 77} , { 2, 64} , { 0, 68} , { -5, 78} , { 7, 55} , { 5, 59} , { 2, 65} , { 14, 54} , { 15, 44} , { 5, 60} , { 2, 70} },
    { { -2, 76} , { -18, 86} , { 12, 70} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 5, 64} , { -12, 70} , { 11, 55} , { 5, 56} , { 0, 69} , { 2, 65} , { -6, 74} , { 5, 54} , { 7, 54} , { -6, 76} , { -11, 82} , { -2, 77} , { -2, 77} , { 25, 42} }
  }
};
...
static const int INIT_FLD_LAST_I[1][8][15][2] =
{

  {
    ...
    { {0,64} , { 24, 17} , { 21, 21} , { 25, 22} , { 31, 27} , { 22, 29} , { 19, 35} , { 14, 50} , { 10, 57} , { 7, 63} , { -2, 77} , { -4, 82} , { -3, 94} , { 9, 69} , { -12, 109} },
    { { 21, -10} , { 24, -11} , { 28, -8} , { 28, -1} , { 29, 3} , { 29, 9} , { 35, 20} , { 29, 36} , { 14, 67} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 36, -35} , { 36, -34} , { 32, -26} , { 37, -30} , { 44, -32} , { 34, -18} , { 34, -15} , { 40, -15} , { 33, -7} , { 35, -5} , { 33, 0} , { 38, 2} , { 33, 13} , { 23, 35} , { 13, 58} },
    { { 29, -3} , { 26, 0} , { 22, 30} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 31, -7} , { 35, -15} , { 34, -3} , { 34, 3} , { 36, -1} , { 34, 5} , { 32, 11} , { 35, 5} , { 34, 12} , { 39, 11} , { 30, 29} , { 34, 26} , { 29, 39} , { 19, 66} }
  }
};
static const int INIT_FLD_LAST_P[3][8][15][2] =
{

  {
    ...
    { {0,64} , { 45, -24} , { 53, -45} , { 48, -26} , { 65, -43} , { 43, -19} , { 39, -10} , { 30, 9} , { 18, 26} , { 20, 27} , { 0, 57} , { -14, 82} , { -5, 75} , { -19, 97} , { -35, 125} },
    { { 21, -13} , { 33, -14} , { 39, -7} , { 46, -2} , { 51, 2} , { 60, 6} , { 61, 17} , { 55, 34} , { 42, 62} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 27, 0} , { 28, 0} , { 31, -4} , { 27, 6} , { 34, 8} , { 30, 10} , { 24, 22} , { 33, 19} , { 22, 32} , { 26, 31} , { 21, 41} , { 26, 44} , { 23, 47} , { 16, 65} , { 14, 71} },
    { { 8, 60} , { 6, 63} , { 17, 65} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 21, 24} , { 23, 20} , { 26, 23} , { 27, 32} , { 28, 23} , { 28, 24} , { 23, 40} , { 24, 32} , { 28, 29} , { 23, 42} , { 19, 57} , { 22, 53} , { 22, 61} , { 11, 86} }
  },

  {
    { { 19, -6} , { 18, -6} , { 14, 0} , { 26, -12} , { 31, -16} , { 33, -25} , { 33, -22} , { 37, -28} , { 39, -30} , { 42, -30} , { 47, -42} , { 45, -36} , { 49, -34} , { 41, -17} , { 32, 9} },
    { {0,64} , { 69, -71} , { 63, -63} , { 66, -64} , { 77, -74} , { 54, -39} , { 52, -35} , { 41, -10} , { 36, 0} , { 40, -1} , { 30, 14} , { 28, 26} , { 23, 37} , { 12, 55} , { 11, 65} },
    { { 17, -10} , { 32, -13} , { 42, -9} , { 49, -5} , { 53, 0} , { 64, 3} , { 68, 10} , { 66, 27} , { 47, 57} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 37, -33} , { 39, -36} , { 40, -37} , { 38, -30} , { 46, -33} , { 42, -30} , { 40, -24} , { 49, -29} , { 38, -12} , { 40, -10} , { 38, -3} , { 46, -5} , { 31, 20} , { 29, 30} , { 25, 44} },
    { { 12, 48} , { 11, 49} , { 26, 45} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 22, 22} , { 23, 22} , { 27, 21} , { 33, 20} , { 26, 28} , { 30, 24} , { 27, 34} , { 18, 42} , { 25, 39} , { 18, 50} , { 12, 70} , { 21, 54} , { 14, 71} , { 11, 83} }
  },

  {
    { { 17, -13} , { 16, -9} , { 17, -12} , { 27, -21} , { 37, -30} , { 41, -40} , { 42, -41} , { 48, -47} , { 39, -32} , { 46, -40} , { 52, -51} , { 46, -41} , { 52, -39} , { 43, -19} , { 32, 11} },
    { {0,64} , { 61, -55} , { 56, -46} , { 62, -50} , { 81, -67} , { 45, -20} , { 35, -2} , { 28, 15} , { 34, 1} , { 39, 1} , { 30, 17} , { 20, 38} , { 18, 45} , { 15, 54} , { 0, 79} },
    { { 9, -2} , { 30, -10} , { 31, -4} , { 33, -1} , { 33, 7} , { 31, 12} , { 37, 23} , { 31, 38} , { 20, 64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },

    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { { 36, -16} , { 37, -14} , { 37, -17} , { 32, 1} , { 34, 15} , { 29, 15} , { 24, 25} , { 34, 22} , { 31, 16} , { 35, 18} , { 31, 28} , { 33, 41} , { 36, 28} , { 27, 47} , { 21, 62} },
    { { 18, 31} , { 19, 26} , { 36, 24} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} , {0,64} },
    { {0,64} , { 24, 23} , { 27, 16} , { 24, 30} , { 31, 29} , { 22, 41} , { 22, 42} , { 16, 60} , { 15, 52} , { 14, 60} , { 3, 78} , { -16, 123} , { 21, 53} , { 22, 56} , { 25, 61} }
  }
};
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c" 2
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/context_ini.c"
void
init_contexts (struct img_par* img)
{
  ...
  { for (i=0; i<3; i++) for (j=0; j<11; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(mc->mb_type_contexts[i][j]), &(INIT_MB_TYPE_I[img->model_number][i][j][0])); else biari_init_context (img, &(mc->mb_type_contexts[i][j]), &(INIT_MB_TYPE_P[img->model_number][i][j][0])); } };
  { for (i=0; i<2; i++) for (j=0; j<9; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(mc->b8_type_contexts[i][j]), &(INIT_B8_TYPE_I[img->model_number][i][j][0])); else biari_init_context (img, &(mc->b8_type_contexts[i][j]), &(INIT_B8_TYPE_P[img->model_number][i][j][0])); } };
  { for (i=0; i<2; i++) for (j=0; j<10; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(mc->mv_res_contexts[i][j]), &(INIT_MV_RES_I[img->model_number][i][j][0])); else biari_init_context (img, &(mc->mv_res_contexts[i][j]), &(INIT_MV_RES_P[img->model_number][i][j][0])); } };
  { for (i=0; i<2; i++) for (j=0; j<6; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(mc->ref_no_contexts[i][j]), &(INIT_REF_NO_I[img->model_number][i][j][0])); else biari_init_context (img, &(mc->ref_no_contexts[i][j]), &(INIT_REF_NO_P[img->model_number][i][j][0])); } };
  { for (j=0; j<4; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(mc->delta_qp_contexts[j]), &(INIT_DELTA_QP_I[img->model_number][0][j][0])); else biari_init_context (img, &(mc->delta_qp_contexts[j]), &(INIT_DELTA_QP_P[img->model_number][0][j][0])); } };
  { for (j=0; j<4; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(mc->mb_aff_contexts[j]), &(INIT_MB_AFF_I[img->model_number][0][j][0])); else biari_init_context (img, &(mc->mb_aff_contexts[j]), &(INIT_MB_AFF_P[img->model_number][0][j][0])); } };
  { for (j=0; j<3; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(mc->transform_size_contexts[j]), &(INIT_TRANSFORM_SIZE_I[img->model_number][0][j][0])); else biari_init_context (img, &(mc->transform_size_contexts[j]), &(INIT_TRANSFORM_SIZE_P[img->model_number][0][j][0])); } };



  { for (j=0; j<2; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->ipr_contexts[j]), &(INIT_IPR_I[img->model_number][0][j][0])); else biari_init_context (img, &(tc->ipr_contexts[j]), &(INIT_IPR_P[img->model_number][0][j][0])); } };
  { for (j=0; j<4; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->cipr_contexts[j]), &(INIT_CIPR_I[img->model_number][0][j][0])); else biari_init_context (img, &(tc->cipr_contexts[j]), &(INIT_CIPR_P[img->model_number][0][j][0])); } };
  { for (i=0; i<3; i++) for (j=0; j<4; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->cbp_contexts[i][j]), &(INIT_CBP_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->cbp_contexts[i][j]), &(INIT_CBP_P[img->model_number][i][j][0])); } };
  { for (i=0; i<8; i++) for (j=0; j<4; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->bcbp_contexts[i][j]), &(INIT_BCBP_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->bcbp_contexts[i][j]), &(INIT_BCBP_P[img->model_number][i][j][0])); } };
  { for (i=0; i<8; i++) for (j=0; j<15; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->map_contexts[i][j]), &(INIT_MAP_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->map_contexts[i][j]), &(INIT_MAP_P[img->model_number][i][j][0])); } };
  { for (i=0; i<8; i++) for (j=0; j<15; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->last_contexts[i][j]), &(INIT_LAST_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->last_contexts[i][j]), &(INIT_LAST_P[img->model_number][i][j][0])); } };
  { for (i=0; i<8; i++) for (j=0; j<5; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->one_contexts[i][j]), &(INIT_ONE_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->one_contexts[i][j]), &(INIT_ONE_P[img->model_number][i][j][0])); } };
  { for (i=0; i<8; i++) for (j=0; j<5; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->abs_contexts[i][j]), &(INIT_ABS_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->abs_contexts[i][j]), &(INIT_ABS_P[img->model_number][i][j][0])); } };
  { for (i=0; i<8; i++) for (j=0; j<15; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->fld_map_contexts[i][j]), &(INIT_FLD_MAP_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->fld_map_contexts[i][j]), &(INIT_FLD_MAP_P[img->model_number][i][j][0])); } };
  { for (i=0; i<8; i++) for (j=0; j<15; j++) { if ((img->type==I_SLICE)||(img->type==SI_SLICE)) biari_init_context (img, &(tc->fld_last_contexts[i][j]), &(INIT_FLD_LAST_I[img->model_number][i][j][0])); else biari_init_context (img, &(tc->fld_last_contexts[i][j]), &(INIT_FLD_LAST_P[img->model_number][i][j][0])); } };
}
