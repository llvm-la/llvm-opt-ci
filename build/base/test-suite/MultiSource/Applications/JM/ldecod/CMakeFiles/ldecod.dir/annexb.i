# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.h"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.h" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c" 2
...
int NALUCount=0;
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
int GetAnnexbNALU (NALU_t *nalu)
{
  ...
  if ((Buf = (unsigned char*)calloc (nalu->max_size , sizeof(char))) == ((void*)0)) no_mem_exit("GetAnnexbNALU: Buf");
...
# 136 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
      free(Buf);
      return pos-1;
    }
    Buf[pos++] = fgetc (bits);
  ...
  if (0 != fseek (bits, rewind, 1))
  {
    snprintf (errortext, 300, "GetAnnexbNALU: Cannot fseek %d in the bit stream file", rewind);
    free(Buf);
    error(errortext, 600);
  }
  ...
  nalu->nal_reference_idc = (nalu->buf[0]>>5) & 3;
  nalu->nal_unit_type = (nalu->buf[0]) & 0x1f;
# 189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
  free(Buf);

  return (pos+rewind);
}
# 205 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
void OpenBitstreamFile (char *fn)
{
  if (((void*)0) == (bits=fopen(fn, "rb")))
  {
    snprintf (errortext, 300, "Cannot open Annex B ByteStream file '%s'", input->infile);
    error(errortext,500);
  }
}
# 221 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
void CloseBitstreamFile()
{
  fclose (bits);
}
# 243 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
static int FindStartCode (unsigned char *Buf, int zeros_in_startcode)
{
  int info;
  int i;
...
void CheckZeroByteNonVCL(NALU_t *nalu, int * ret)
{
  ...
  if(nalu->nal_unit_type==9 || nalu->nal_unit_type==7 ||
     nalu->nal_unit_type==8 || nalu->nal_unit_type==6 ||
