# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c"
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
void no_mem_exit(char *where);
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
extern int SubPelBlockSearchBiPred (imgpel* orig_pic, short ref, int list, int pic_pix_x, int pic_pix_y,
                              ...
                              short* mv_x1, short* mv_y1, short* mv_x2, short* mv_y2,
                              int search_pos2, int search_pos4, int min_mcost, int* lambda_factor);
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c" 2
...
static int **search_setup_done;
static int **search_center_x;
static int **search_center_y;
static int **pos_00;
static distpel *****BlockSAD;
...
extern void SetMotionVectorPredictor (short pmv[2], signed char **refPic,
                                      ...
                                      int blockshape_y);
# 70 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c"
void
InitializeFastFullIntegerSearch ()
{
  ...
  if ((BlockSAD = (distpel*****)malloc (2 * sizeof(distpel****))) == ((void*)0))
    no_mem_exit ("InitializeFastFullIntegerSearch: BlockSAD");

  for (list=0; list<2;list++)
  {
    if ((BlockSAD[list] = (distpel****)malloc ((img->max_num_references) * sizeof(distpel***))) == ((void*)0))
      no_mem_exit ("InitializeFastFullIntegerSearch: BlockSAD");
    for (i = 0; i < img->max_num_references; i++)
    {
      if ((BlockSAD[list][i] = (distpel***)malloc (8 * sizeof(distpel**))) == ((void*)0))
        no_mem_exit ("InitializeFastFullIntegerSearch: BlockSAD");
      for (j = 1; j < 8; j++)
      {
        if ((BlockSAD[list][i][j] = (distpel**)malloc (16 * sizeof(distpel*))) == ((void*)0))
          no_mem_exit ("InitializeFastFullIntegerSearch: BlockSAD");
        for (k = 0; k < 16; k++)
        {
          if ((BlockSAD[list][i][j][k] = (distpel*)malloc (max_pos * sizeof(distpel))) == ((void*)0))
            no_mem_exit ("InitializeFastFullIntegerSearch: BlockSAD");
        }
      }
    }
  ...
  if ((search_setup_done = (int**)malloc (2*sizeof(int*)))==((void*)0))
    no_mem_exit ("InitializeFastFullIntegerSearch: search_setup_done");
  if ((search_center_x = (int**)malloc (2*sizeof(int*)))==((void*)0))
    no_mem_exit ("InitializeFastFullIntegerSearch: search_center_x");
  if ((search_center_y = (int**)malloc (2*sizeof(int*)))==((void*)0))
    no_mem_exit ("InitializeFastFullIntegerSearch: search_center_y");
  if ((pos_00 = (int**)malloc (2*sizeof(int*)))==((void*)0))
    no_mem_exit ("InitializeFastFullIntegerSearch: pos_00");
  if ((max_search_range = (int**)malloc (2*sizeof(int*)))==((void*)0))
    no_mem_exit ("InitializeFastFullIntegerSearch: max_search_range");

  for (list=0; list<2; list++)
  {
    if ((search_setup_done[list] = (int*)malloc ((img->max_num_references)*sizeof(int)))==((void*)0))
      no_mem_exit ("InitializeFastFullIntegerSearch: search_setup_done");
    if ((search_center_x[list] = (int*)malloc ((img->max_num_references)*sizeof(int)))==((void*)0))
      no_mem_exit ("InitializeFastFullIntegerSearch: search_center_x");
    if ((search_center_y[list] = (int*)malloc ((img->max_num_references)*sizeof(int)))==((void*)0))
      no_mem_exit ("InitializeFastFullIntegerSearch: search_center_y");
    if ((pos_00[list] = (int*)malloc ((img->max_num_references)*sizeof(int)))==((void*)0))
      no_mem_exit ("InitializeFastFullIntegerSearch: pos_00");
    if ((max_search_range[list] = (int*)malloc ((img->max_num_references)*sizeof(int)))==((void*)0))
      no_mem_exit ("InitializeFastFullIntegerSearch: max_search_range");
  }
...
# 196 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c"
void
...
SetupLargerBlocks (int list, int refindex, int max_pos)
{
  ...
  _bj = _bi + 4;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=1; _bi+=1; _bj+=1;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=1; _bi+=1; _bj+=1;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=1; _bi+=1; _bj+=1;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=5; _bi+=5; _bj+=5;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=1; _bi+=1; _bj+=1;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=1; _bi+=1; _bj+=1;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=1; _bi+=1; _bj+=1;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];;


  _bo = BlockSAD[list][refindex][5];
  _bi = BlockSAD[list][refindex][7];
  _bj = _bi + 1;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=2; _bi+=2; _bj+=2;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=2; _bi+=2; _bj+=2;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=2; _bi+=2; _bj+=2;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=2; _bi+=2; _bj+=2;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=2; _bi+=2; _bj+=2;;
  ...
  _bj = _bi + 1;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=2; _bi+=2; _bj+=2;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=6; _bi+=6; _bj+=6;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=2; _bi+=2; _bj+=2;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];;
  ...
  _bi = BlockSAD[list][refindex][4];
  _bj = _bi + 2;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];; _bo+=8; _bi+=8; _bj+=8;;
  _o=*_bo; _i=*_bi; _j=*_bj; for(pos=0;pos<max_pos;pos++) _o[pos] = _i[pos] + _j[pos];;
...
# 490 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c"
void SetupFastFullPelSearch (short ref, int list)
{
  short pmv[2];
  ...
  {
    memcpy(srcptr, &imgY_org[y][img->opix_x], 16 * sizeof(imgpel));
    srcptr += 16;
  }
  if ( ChromaMEEnable)
  {
      ...
      if (ChromaMEEnable)
      {
        for (k = 0; k < 2; k ++)
        {
          ...
          for (blky = 0; blky < 4; blky++)
          {
            ...
            for (y = 0; y < img->mb_cr_size_y; y+=4)
            {
              for (x = 0; x < img->mb_cr_size_x; x += 4)
              {
...
# 829 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_fullfast.c"
int
FastFullPelBlockMotionSearch (imgpel* orig_pic,
                              short ref,
                              int list,
                              int pic_pix_x,
                              int pic_pix_y,
                              ...
                              int lambda_factor)
{
  ...
  block_index = (pic_pix_y-img->opix_y)+((pic_pix_x-img->opix_x)>>2);
  ...
  if (!input->rdopt)
  {
    mcost = block_sad[pos_00[list][ref]] + ((((lambda_factor)*(mvbits[0 -pred_mv_x]+mvbits[0 -pred_mv_y]))>>16));
  ...
  for (pos=0; pos<max_pos; pos++, block_sad++)
  {
    ...
    if (*block_sad < min_mcost)
    {
      ...
      mcost = *block_sad;
      mcost += ((((lambda_factor)*(mvbits[cand_x-pred_mv_x]+mvbits[cand_y-pred_mv_y]))>>16));
