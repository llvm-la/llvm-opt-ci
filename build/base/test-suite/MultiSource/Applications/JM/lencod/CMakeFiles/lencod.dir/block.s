...
.LBB4_73:                               #   in Loop: Header=BB4_75 Depth=1
	beqz	$t6, .LBB4_88
.LBB4_74:                               # %.backedge1189.backedge
                                        #   in Loop: Header=BB4_75 Depth=1
	addi.d	$t6, $t6, -1
	addi.d	$t3, $t3, 2
.LBB4_75:                               # %.backedge1189
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $t3, -1
	ld.bu	$a5, $t3, 0
	alsl.d	$a2, $a2, $a0, 4
...
.LBB4_177:                              #   in Loop: Header=BB4_175 Depth=1
	move	$s0, $zero
.LBB4_178:                              # %scalar.ph1274.preheader
                                        #   in Loop: Header=BB4_175 Depth=1
	add.d	$a2, $a2, $s0
	slli.d	$t8, $s0, 2
	slli.d	$fp, $s0, 1
...
# %bb.182:                              # %vector.memcheck
	...
	add.d	$t8, $fp, $t8
	bltu	$t8, $t6, .LBB4_177
# %bb.183:                              # %vector.body1279.preheader
                                        #   in Loop: Header=BB4_175 Depth=1
	move	$t8, $a2
	move	$fp, $a4
	move	$s0, $a5
...
# %bb.207:                              #   in Loop: Header=BB4_205 Depth=1
	move	$t8, $zero
.LBB4_208:                              # %scalar.ph1258.preheader
                                        #   in Loop: Header=BB4_205 Depth=1
	add.d	$t6, $t6, $t8
	alsl.d	$t7, $t8, $a3, 2
	sub.d	$t8, $a0, $t8
	.p2align	4, , 16
.LBB4_209:                              # %scalar.ph1258
...
# %bb.211:                              # %vector.scevcheck
                                        #   in Loop: Header=BB4_205 Depth=1
	bnez	$t5, .LBB4_208
# %bb.212:                              # %vector.body1263.preheader
                                        #   in Loop: Header=BB4_205 Depth=1
	move	$t7, $t6
	move	$t8, $t1
	move	$fp, $t0
	.p2align	4, , 16
.LBB4_213:                              # %vector.body1263
                                        #   Parent Loop BB4_205 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t8, -16
	vld	$vr1, $t8, 0
