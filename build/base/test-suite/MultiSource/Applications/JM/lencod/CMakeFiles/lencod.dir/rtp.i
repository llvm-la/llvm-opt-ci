# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c" 2
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c" 2
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
...
FILE *f;
# 76 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
...

{
  ...
  temp16 = __bswap_16 ((unsigned short)p->seq);
  memcpy (&p->packet[2], &temp16, 2);


  temp32 = __bswap_32 (p->timestamp);
  memcpy (&p->packet[4], &temp32, 4);

  temp32 = __bswap_32 (p->ssrc);
  memcpy (&p->packet[8], &temp32, 4);
...
# 148 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
...
# 190 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
int WriteRTPNALU (NALU_t *n)
{
  RTPpacket_t *p;
  ...
  if ((p = (RTPpacket_t *) malloc (sizeof (RTPpacket_t))) == ((void*)0))
    no_mem_exit ("RTPWriteNALU-1");
  if ((p->packet = malloc ((65536 - 28))) == ((void*)0))
    no_mem_exit ("RTPWriteNALU-2");
  if ((p->payload = malloc ((65536 - 28))) == ((void*)0))
...
# 261 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
void RTPUpdateTimestamp (int tr)
{
  int delta;
  static int oldtr = -1;
...
# 284 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
  delta = tr - oldtr;

  if (delta < -10)
    delta+=256;

  CurrentRTPTimestamp += delta * 1000;
  oldtr = tr;
}
# 308 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
void OpenRTPFile (char *Filename)
{
  if ((f = fopen (Filename, "wb")) == ((void*)0))
  {
    printf ("Fatal: cannot open bitstream file '%s', exit (-1)\n", Filename);
    exit (-1);
  }
}
# 329 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rtp.c"
void CloseRTPFile ()
{
  fclose(f);
}
