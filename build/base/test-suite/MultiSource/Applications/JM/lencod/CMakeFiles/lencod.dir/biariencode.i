# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.h" 1
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.h"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c" 2

int binCount = 0;
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
int pic_bin_count;
...
# 74 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
EncodingEnvironmentPtr arienco_create_encoding_environment(void)
{
  EncodingEnvironmentPtr eep;

  if ( (eep = (EncodingEnvironmentPtr) calloc(1,sizeof(EncodingEnvironment))) == ((void*)0))
    no_mem_exit("arienco_create_encoding_environment: eep");

  return eep;
}
# 92 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
void arienco_delete_encoding_environment(EncodingEnvironmentPtr eep)
{
  if (eep == ((void*)0))
  {
    snprintf(errortext, 300, "Error freeing eep (NULL pointer)");
    error (errortext, 200);
  }
  else
    free(eep);
}
# 111 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
...
{
   return (8 * (*(eep->Ecodestrm_len)) + (eep->Ebits_to_follow) + 8 - (eep->Ebits_to_go));
}
# 148 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
void arienco_done_encoding(EncodingEnvironmentPtr eep)
{
  { { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= ((unsigned char) (((eep->Elow) >> (10 -1)) & 1)); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; }; while ((eep->Ebits_to_follow) > 0) { (eep->Ebits_to_follow)--; { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= (!((unsigned char) (((eep->Elow) >> (10 -1)) & 1))); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; }; } };
  { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= ((unsigned char) ((eep->Elow) >> (10 -2))&1); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; };
  { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= ((unsigned char) 1); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; };

  stats->bit_use_stuffingBits[img->type]+=(8-(eep->Ebits_to_go));

  while ((eep->Ebits_to_go) != 8)
    { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= (0); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; };

  pic_bin_count += eep->E*8 + eep->C;
}

extern int cabac_encoding;
# 171 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
void biari_encode_symbol(EncodingEnvironmentPtr eep, signed short symbol, BiContextTypePtr bi_ct )
{
  ...
  if (symbol != bi_ct->MPS)
  {
    ...
    if (!bi_ct->state)
      bi_ct->MPS = (unsigned char) (bi_ct->MPS ^ 0x01);
    bi_ct->state = AC_next_state_LPS_64[bi_ct->state];
  }
  else
    bi_ct->state = AC_next_state_MPS_64[bi_ct->state];
  ...
  while (range < (1 << (10 -2)))
  {
    if (low >= (1 << (10 -1)))
    {
      { { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= (1); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; }; while ((eep->Ebits_to_follow) > 0) { (eep->Ebits_to_follow)--; { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= (!(1)); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; }; } };
      low -= (1 << (10 -1));
    }
    else if (low < (1 << (10 -2)))
    {
      { { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= (0); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; }; while ((eep->Ebits_to_follow) > 0) { (eep->Ebits_to_follow)--; { (eep->Ebuffer) <<= 1; (eep->Ebuffer) |= (!(0)); if (--(eep->Ebits_to_go) == 0) { (eep->Ecodestrm)[(*(eep->Ecodestrm_len))++] = (eep->Ebuffer); (eep->Ebits_to_go) = 8; while (eep->C > 7) { eep->C-=8; eep->E++; } }; }; } };
    }
    else
    {
      (eep->Ebits_to_follow)++;
...
# 234 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
void biari_encode_symbol_eq_prob(EncodingEnvironmentPtr eep, signed short symbol)
{
  register unsigned int low = ((eep->Elow)<<1);
...
# 322 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/biariencode.c"
