# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c" 2
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c" 2
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
void decode_one_b8block (int decoder, int mbmode, int b8block, int b8mode, int b8ref)
{
  int i,j,block_y,block_x,bx,by;
  int ref_inx = ((img->number - start_frame_no_in_this_IGOP)-1)%img->num_ref_frames;
    ...
    if ((b8mode>=1 && b8mode<=7) || (mbmode==0 && (img->type==P_SLICE || (img->type==B_SLICE && img->nal_reference_idc>0))))
    {
      ...
      for (bx=bx0; bx<bx1; bx++)
      {
        ...
        if (img->type == B_SLICE && enc_picture != enc_frame_picture)
          ref_inx = ((img->number - start_frame_no_in_this_IGOP)-b8ref-2)%img->num_ref_frames;
...
# 140 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
void decode_one_mb (int decoder, Macroblock* currMB)
{
  decode_one_b8block (decoder, currMB->mb_type, 0, currMB->b8mode[0], enc_picture->ref_idx[LIST_0][img->block_y+0][img->block_x+0]);
  decode_one_b8block (decoder, currMB->mb_type, 1, currMB->b8mode[1], enc_picture->ref_idx[LIST_0][img->block_y+0][img->block_x+2]);
  decode_one_b8block (decoder, currMB->mb_type, 2, currMB->b8mode[2], enc_picture->ref_idx[LIST_0][img->block_y+2][img->block_x+0]);
  decode_one_b8block (decoder, currMB->mb_type, 3, currMB->b8mode[3], enc_picture->ref_idx[LIST_0][img->block_y+2][img->block_x+2]);
}
# 171 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
...
# 199 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
...
# 353 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
void UpdateDecoders()
{
  int k;
  for (k=0; k<input->NoOfDecoders; k++)
  {
    Build_Status_Map(decs->status_map);
    Error_Concealment(decs->decY_best[k], decs->status_map, decs->decref[k]);


    DecOneForthPix(decs->decY_best[k], decs->decref[k]);
  }
}
# 378 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
void DecOneForthPix(imgpel **dY, imgpel ***dref)
{
  int j, ref=(img->number - start_frame_no_in_this_IGOP)%img->buf_cycle;
...
void compute_residue_b8block (int b8block, int i16mode)
{
  int i,j;
...
# 441 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
void Build_Status_Map(byte **s_map)
{
  ...
  for (i=0 ; i<ii; i++)
  {
    if (!input->slice_mode || img->mb_data[mb].slice_nr != slice)
    {
      packet_lost=0;
      if ((double)rand()/(double)2147483647*100 < input->LossRateC) packet_lost += 3;
      if ((double)rand()/(double)2147483647*100 < input->LossRateB) packet_lost += 2;
      if ((double)rand()/(double)2147483647*100 < input->LossRateA) packet_lost = 1;
      slice++;
    }
    if (!packet_lost)
    {
...
# 486 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
void Error_Concealment(imgpel **inY, byte **s_map, imgpel ***refY)
{
...
# 506 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/decoder.c"
void Conceal_Error(imgpel **inY, int mb_y, int mb_x, imgpel ***refY, byte **s_map)
{
  int i,j,block_x, block_y;
  int ref_inx = ((img->number - start_frame_no_in_this_IGOP)-1)%img->num_ref_frames;
  int pos_y = mb_y*16, pos_x = mb_x*16;
  int mv[2][4][4];
  int resY[16][16];
  int copy = (decs->dec_mb_mode[mb_y][mb_x]==0 && (img->type==P_SLICE || (img->type==B_SLICE && img->nal_reference_idc>0)));
  int inter = (((decs->dec_mb_mode[mb_y][mb_x]>=1 && decs->dec_mb_mode[mb_y][mb_x]<=3) || decs->dec_mb_mode[mb_y][mb_x]==8) && (img->type==P_SLICE || (img->type==B_SLICE && img->nal_reference_idc>0)));
  ...
  case 5:
    ...
    for (block_y=0; block_y<4; block_y++)
      for (block_x=0; block_x<4; block_x++)
        for (i=0;i<2;i++)
          mv[i][block_y][block_x]=tmp_mv[mb_y*4 +block_y][mb_x*4 +block_x+4][i];
    ...
    if (img->type!=I_SLICE)
    {
      ...
      {
        for (block_y = mb_y*4 ; block_y < (mb_y*4 + 4) ; block_y++)
          for (block_x = mb_x*4 ; block_x < (mb_x*4 + 4) ; block_x++)
          {
            Get_Reference_Block(refY[ref_inx],
                                block_y, block_x,
                                mv[0][block_y - mb_y*4][block_x - mb_x*4],
                                mv[1][block_y - mb_y*4][block_x - mb_x*4],
                                decs->RefBlock);
            for (j=0;j<4;j++)
              for (i=0;i<4;i++)
              {
                inY[block_y*4 + j][block_x*4 + i] = decs->RefBlock[j][i];
              }
          }
      }
      else
