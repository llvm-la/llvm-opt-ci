# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c" 2
...
void rc_alloc( rc_quadratic **prc )
{
  ...
  lprc->TargetField = 0;
  lprc->LowerBound = 0;
  lprc->UpperBound1 = 2147483647;
  lprc->UpperBound2 = 2147483647;
  lprc->Wp = 0.0;
  lprc->Wb = 0.0;
...
# 137 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void rc_free(rc_quadratic **prc)
{
  if (((void*)0)!=(*prc)->BUPFMAD)
  {
    free ((*prc)->BUPFMAD);
    (*prc)->BUPFMAD = ((void*)0);
  }
  if (((void*)0)!=(*prc)->BUCFMAD)
  {
    free ((*prc)->BUCFMAD);
    (*prc)->BUCFMAD = ((void*)0);
  }
  if (((void*)0)!=(*prc)->FCBUCFMAD)
  {
    free ((*prc)->FCBUCFMAD);
    (*prc)->FCBUCFMAD = ((void*)0);
  }
  if (((void*)0)!=(*prc)->FCBUPFMAD)
  {
    free ((*prc)->FCBUPFMAD);
    (*prc)->FCBUPFMAD = ((void*)0);
  }
  if (((void*)0)!=(*prc))
  {
    free ((*prc));
...
# 174 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void rc_init_seq(rc_quadratic *prc)
{
  double L1,L2,L3,bpp;
  int qp, i;
...
# 308 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void rc_init_GOP(rc_quadratic *prc, int np, int nb)
{
  ...
  case RC_MODE_3:
    {
      int sum = 0, tmp, level, levels = 0, num_frames[5];
      float numer, denom;
      int gop = input->successive_Bframe + 1;
      memset( num_frames, 0, 5 * sizeof(int) );
      ...
      if ( input->successive_Bframe )
      {
        ...
        else if ( input->HierarchicalCoding == 2 )
        {
...
# 503 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void rc_init_pict(rc_quadratic *prc, int fieldpic,int topfield,int targetcomputation, float mult)
{
  int tmp_T;
  ...
  {
    if ( (img->type == P_SLICE || input->RCUpdateMode == RC_MODE_1) && ((img->number - start_frame_no_in_this_IGOP)) )
    {
      ...
      if(input->successive_Bframe>0)
      {
        ...
        prc->TargetBufferLevel += (prc->AveWp * (input->successive_Bframe + 1)*prc->bit_rate /(prc->frame_rate*(prc->AveWp+prc->AveWb*input->successive_Bframe))-prc->bit_rate/prc->frame_rate);
    ...
    if( (img->type==P_SLICE || input->RCUpdateMode == RC_MODE_1 || input->RCUpdateMode == RC_MODE_3 ) && ((img->number - start_frame_no_in_this_IGOP)) )
    {
        ...
        if(generic_RC->NumberofCodedPFrame>0)
        {
          if (input->RCUpdateMode == RC_MODE_3)
          {
            ...
            case B_SLICE:
              ...
              break;
            case I_SLICE:
              prc->Target = (int) floor( (float)prc->Target / (input->RCIoverPRatio * 4.0) + 0.5F);
              break;
            case P_SLICE:
            default:
              break;
  ...
  if( ( img->type==P_SLICE || input->RCUpdateMode == RC_MODE_1 ) && img->BasicUnit < img->FrameSizeInMbs && generic_RC->FieldControl == 1 && ((img->number - start_frame_no_in_this_IGOP)) )
  {
...
# 742 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void rc_update_pict(rc_quadratic *prc, int nbits)
{
...
# 809 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void rc_update_pict_frame(rc_quadratic *prc, int nbits)
{
  ...
  case RC_MODE_2:
  default:
    complexity = updateComplexity( prc, (Boolean) (img->type == P_SLICE && ((img->number - start_frame_no_in_this_IGOP))), nbits );
    if ( img->type == P_SLICE && ((img->number - start_frame_no_in_this_IGOP)) )
    {
    ...
    break;
  case RC_MODE_1:
    complexity = updateComplexity( prc, (Boolean) ((img->number - start_frame_no_in_this_IGOP)), nbits );
    if ( ((img->number - start_frame_no_in_this_IGOP)) )
    {
      if( generic_RC->NoGranularFieldRC == 0 || generic_RC->FieldControl == 0 )
        updatePparams( prc, complexity );
      else
  ...
  case RC_MODE_3:
    complexity = updateComplexity( prc, (Boolean) (img->type == P_SLICE && ((img->number - start_frame_no_in_this_IGOP))), nbits );
    if (img->type == I_SLICE && (img->number - start_frame_no_in_this_IGOP))
      generic_RC->NIslice--;
...
# 872 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void updateRCModel (rc_quadratic *prc)
{
  int n_windowSize;
  int i;
  ...
  static Boolean m_rgRejected[21];
  static double error [21];
  ...
  if( (img->type == P_SLICE || input->RCUpdateMode == RC_MODE_1) && ((img->number - start_frame_no_in_this_IGOP)) )
  {
    ...
    prc->Pm_rgQp[0] = QP2Qstep(prc->m_Qc);
    ...
    n_windowSize = (prc->CurrentFrameMAD>prc->PreviousFrameMAD)
      ? (int)(prc->PreviousFrameMAD/prc->CurrentFrameMAD * (21 -1) )
      : (int)(prc->CurrentFrameMAD/prc->PreviousFrameMAD *(21 -1));
    n_windowSize=iClip3(1, m_Nc, n_windowSize);
    n_windowSize=imin(n_windowSize,prc->m_windowSize+1);
    n_windowSize=imin(n_windowSize,(21 -1));
    ...
    if( MADModelFlag )
      updateMADModel(prc);
    else if( (img->type == P_SLICE || input->RCUpdateMode == RC_MODE_1) && ((img->number - start_frame_no_in_this_IGOP)) )
      prc->PPictureMAD[0]=prc->CurrentFrameMAD;
  }
}
# 1000 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void RCModelEstimator (rc_quadratic *prc, int n_windowSize, Boolean *m_rgRejected)
{
...
# 1073 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void updateMADModel (rc_quadratic *prc)
{
  int n_windowSize;
  int i;
  double std = 0.0, threshold;
  int m_Nc = generic_RC->NumberofCodedPFrame;
  static Boolean PictureRejected[21];
  static double error [21];
  ...
  if(generic_RC->NumberofCodedPFrame>0)
  {
    ...
    n_windowSize = (prc->CurrentFrameMAD > prc->PreviousFrameMAD)
      ? (int) ((float)(21 -1) * prc->PreviousFrameMAD / prc->CurrentFrameMAD)
      : (int) ((float)(21 -1) * prc->CurrentFrameMAD / prc->PreviousFrameMAD);
...
# 1164 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
void MADModelEstimator (rc_quadratic *prc, int n_windowSize, Boolean *PictureRejected)
{
  int n_realSize = n_windowSize;
  int i;
...
# 1238 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
int updateQPRC0(rc_quadratic *prc, int topfield)
{
  int m_Bits;
  int BFrameNumber;
  ...
  if(img->BasicUnit==img->FrameSizeInMbs )
  {
    ...
    if((topfield) || (generic_RC->FieldControl==0))
    {
      ...
      else if(img->type == B_SLICE)
      {
        if(input->successive_Bframe==1)
        {
          ...
          prc->m_Qc = iClip3(prc->RC_MIN_QUANT, prc->RC_MAX_QUANT, prc->m_Qc);
        }
        else
        {
      ...
      else if( img->type == P_SLICE && generic_RC->NumberofPPicture == 0 && ((img->number - start_frame_no_in_this_IGOP)) )
      {
        prc->m_Qc=prc->MyInitialQp;
      ...
      else
      {
        ...
        else
        {
          ...
          prc->m_Qc = iClip3(prc->RC_MIN_QUANT, prc->RC_MAX_QUANT, prc->m_Qc);
          prc->m_Qc = iClip3(m_Qp-DuantQp, m_Qp+DuantQp, prc->m_Qc);
        }
    ...
    {
      if( img->type==P_SLICE && generic_RC->NoGranularFieldRC == 0 && ((img->number - start_frame_no_in_this_IGOP)) )
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if( prc->NumberofBasicUnit == 0 && img->type == P_SLICE && ((img->number - start_frame_no_in_this_IGOP)) )
...
# 1489 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
int updateQPRC1(rc_quadratic *prc, int topfield)
{
  int m_Bits;
  int SumofBasicUnit;
  ...
  if(img->BasicUnit == img->FrameSizeInMbs)
  {
    ...
    if((topfield) || (generic_RC->FieldControl==0))
    {
      ...
      else if( generic_RC->NumberofPPicture == 0 && ((img->number - start_frame_no_in_this_IGOP)) )
      {
        prc->m_Qc=prc->MyInitialQp;
    ...
    {
      if( generic_RC->NoGranularFieldRC == 0 && ((img->number - start_frame_no_in_this_IGOP)) )
        updateBottomField( prc );
      return prc->m_Qc;
    }
  }
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            prc->Pm_Qp=prc->m_Qc;
            prc->NumberofBasicUnit--;
            if((prc->NumberofBasicUnit==0) && ((img->number - start_frame_no_in_this_IGOP)) )
              updateLastBU( prc, topfield );
...
# 1640 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
int updateQPRC2(rc_quadratic *prc, int topfield)
{
  int m_Bits;
  int SumofBasicUnit;
...
# 1853 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/rc_quadratic.c"
int updateQPRC3(rc_quadratic *prc, int topfield)
{
  int m_Bits;
  int SumofBasicUnit;
    ...
    if((topfield) || (generic_RC->FieldControl==0))
    {
      ...
      else
      {
        ...
        if ( img->type == B_SLICE )
        {
          ...
          prc->m_Qc = iClip3(prevqp - (input->HierarchicalCoding ? 0 : 5), prevqp + 5, prc->m_Qc);
          prc->m_Qc = iClip3(prc->RC_MIN_QUANT, prc->RC_MAX_QUANT, prc->m_Qc);
        }
        return prc->m_Qc;
      }
...
int updateNegativeTarget( rc_quadratic *prc, int topfield, int m_Qp )
{
  ...
  if(prc->GOPOverdue==TRUE)
    ...
    prc->m_Qc=m_Qp+prc->DDquant;

  prc->m_Qc = imin(prc->m_Qc, prc->RC_MAX_QUANT);
...
void updateModelQPBU( rc_quadratic *prc, int topfield, int m_Qp )
{
  ...
  dtmp = prc->CurrentFrameMAD * prc->CurrentFrameMAD * prc->m_X1 * prc->m_X1 + 4 * prc->m_X2 * prc->CurrentFrameMAD * m_Bits;

  if ((prc->m_X2 == 0.0) || (dtmp < 0) || ((sqrt (dtmp) - prc->m_X1 * prc->CurrentFrameMAD) <= 0.0))
  ...
  prc->m_Qc = imin(m_Qp+prc->DDquant, prc->m_Qc);
  ...
  prc->m_Qc = iClip3(m_Qp-prc->DDquant, prc->RC_MAX_QUANT, prc->m_Qc);
  if(input->basicunit>=prc->MBPerRow)
