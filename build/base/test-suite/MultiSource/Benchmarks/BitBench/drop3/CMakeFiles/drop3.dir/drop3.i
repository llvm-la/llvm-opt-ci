# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c" 2
...
int drop_0xx(unsigned char *in, unsigned char *out, size_t size) {
  int left = size;
  unsigned short ibuf = 0;
  unsigned short obuf = 0;
  unsigned char res;
  int outoff = 0;
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/drop3/drop3.c"
  for (;;) {
    { if ((left -= 3) < 0) break; if (0 < 3) ibuf |= *in++ << (8 - 0); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
    { if ((left -= 3) < 0) break; if (5 < 3) ibuf |= *in++ << (8 - 5); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
    { if ((left -= 3) < 0) break; if (2 < 3) ibuf |= *in++ << (8 - 2); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
    { if ((left -= 3) < 0) break; if (7 < 3) ibuf |= *in++ << (8 - 7); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
    { if ((left -= 3) < 0) break; if (4 < 3) ibuf |= *in++ << (8 - 4); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
    { if ((left -= 3) < 0) break; if (1 < 3) ibuf |= *in++ << (8 - 1); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
    { if ((left -= 3) < 0) break; if (6 < 3) ibuf |= *in++ << (8 - 6); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
    { if ((left -= 3) < 0) break; if (3 < 3) ibuf |= *in++ << (8 - 3); if ((res = (ibuf >> (16-3))) >= 4) { obuf = (obuf << 3) | res; outoff += 3; if ((outoff & 7) < 3) *out++ = (obuf >> (outoff & 7)); } ibuf <<= 3; }
      }
...
{
  return fread(buffer, 1, 4000000, in);
}
...
int main(int argc, char *argv[])
{
  ...
  inbuf = malloc(4000000);
  outbuf = malloc(4000000);
