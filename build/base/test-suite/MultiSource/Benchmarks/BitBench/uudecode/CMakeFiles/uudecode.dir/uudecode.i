# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c" 2
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c"
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c" 2
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c" 2
...
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c" 2
...
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uudecode/uudecode.c" 2



int skip_to_newline(char* input, int offset) {
  while(input[offset] != 10)
    {offset++;}
  return ++offset;
}
...
int decode(char* input, int offset, char* output) {
  ...
  while (input[offset] != 32) {
   ...
   decode_char (input[offset+3]);
    ...
    offset = skip_to_newline(input, offset);
  }
  offset = skip_to_newline(input, offset);
...
int do_decode(char* input, char* output, char* outfilename) {
  ...
  if (sscanf (input, "begin %o %s \n", &mode, outfilename)==2){
    ...
    return decode(input, namelen+12, output);
  }
  exit(1);
}
...
{
  return fread(buffer, 1, 10000000, in);
}
...
int main(int argc, char *argv[])
{
  ...
  inbuf = malloc(10000000);
  outbuf = malloc(10000000);
