# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.c" 2
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.c"
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.h" 1
# 89 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.h"
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Globals.h" 1
# 67 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Globals.h"
# 1 "/usr/include/assert.h" 1 3 4
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Globals.h" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Globals.h" 2
...
# 70 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Globals.h" 2
...
# 71 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Globals.h" 2
# 82 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Globals.h"
typedef struct {
   double x, y;
} TVector;
# 90 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.h" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.h" 1
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.h"
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/build/build-llvm/lib/clang/22/include/stdbool.h" 1 3
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.h" 2
# 70 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.h"
typedef struct {
   TVector min, max;
} TBounds;
...
extern _Bool Bounds_IsOverlappingBounds(TBounds* b, TBounds* tst);
extern double Bounds_WidthAxis(TBounds* b, unsigned int axis);
extern double Bounds_CenterAxis(TBounds* b, unsigned int axis);
# 91 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.h" 2
...
void KDTree_QueryCircleInterior_Float(TKDTree* t,
                                 ...
                                 double circ_radius, int ncells,
                                 float *x, float *dx, float *y, float *dy);
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/KDTree.c" 2
                        ...
                        unsigned int cut_direction, int k, int num, int* idx)
{
   ...
   for (left = 0, right = num - 1; (right - left) > 1;) {
      ...
      while (1) {
         ...
         if(j < i)
            break;
         {int h; h = idx[i]; idx[i] = idx[j]; idx[j] = h; };
      }
      idx[left] = idx[j];
      idx[j] = a;
      if(j >= k)
   ...
   if(((right - left) ==1) &&
      (Bounds_CenterAxis(&(t->elements[idx[right]]), cut_direction) <
       Bounds_CenterAxis(&(t->elements[idx[left]]), cut_direction)))
      {int h; h = idx[right]; idx[right] = idx[left]; idx[left] = h; };
}
...
void KDTree_Initialize(TKDTree* t)
{
   ...
   t->elements_num = 0;
   t->elements_allocated = ((long)1024);
   t->elements = ((TBounds*)(malloc(t->elements_allocated * sizeof(TBounds))));
   ((void) (0));

   t->tree_built = 0;
   t->tree_size = 0;
   t->tree_safety_boxes = ((void*)0);
   t->tree_link = ((void*)0);
}
...
void KDTree_Destroy(TKDTree* t)
{
   ...
   { if (t->elements) free(t->elements); };
   t->elements = ((void*)0);

   t->tree_built = 0;
   t->tree_size = 0;
   { if (t->tree_safety_boxes) free(t->tree_safety_boxes); };
   t->tree_safety_boxes = ((void*)0);
   { if (t->tree_link) free(t->tree_link); };
   t->tree_link = ((void*)0);
}
...
void KDTree_AddElement(TKDTree* t, TBounds* add)
{
   ...
   if(t->elements_num == t->elements_allocated) {
      t->elements_allocated += ((long)1024);
      t->elements = ((TBounds*)(realloc((void*)t->elements, t->elements_allocated * sizeof(TBounds))));
      ((void) (0));
   }
...
void KDTree_CreateTree(TKDTree* t)
{
   ...
   if(t->elements_num > 0) {
      ...
      t->tree_safety_boxes = ((TBounds*)(malloc(t->tree_size * sizeof(TBounds))));
      t->tree_link = ((int*)(malloc(t->tree_size * sizeof(int))));

      next_node = 0;
      stack_ptr = 0;
      stack = ((int*)(malloc(3 * t->tree_size * sizeof(int))));
      idx = ((int*)(malloc(t->elements_num * sizeof(int))));
      ...
      stack[stack_ptr++] = 0;
      stack[stack_ptr++] = 0;
      stack[stack_ptr++] = t->elements_num - 1;
                              ...
                              TBounds* box)
{
   ...
   *result_num = 0;
   ...
   stack_ptr = 0;
   stack = ((int*)(malloc(t->tree_size * sizeof(int))));
                                 ...
                                 double *x, double *dx, double *y, double *dy)
{
   ...
   *result_num = 0;
   ...
   for (int i=0; i<nez; ++i){
      ...
      horizontal_half=0;
      vertical_half=0;
      if (x[ii]+0.5*dx[ii] > 0.0) horizontal_half = 1;
      if (y[ii]+0.5*dy[ii] > 0.0) vertical_half = 1;


      if (horizontal_half == 1 && vertical_half == 1) {
         weight[*result_num] = (circ_radius - rad1)/(rad3-rad1);
      } else if (horizontal_half == 0 && vertical_half == 1) {
         weight[*result_num] = (circ_radius - rad2)/(rad4-rad2);
      } else if (horizontal_half == 0 && vertical_half == 0) {
         weight[*result_num] = (circ_radius - rad3)/(rad1-rad3);
      } else if (horizontal_half == 1 && vertical_half == 0) {
