...
.LBB5_176:                              # %vector.body1456
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB5_176
# %bb.177:                              # %middle.block1461
	beq	$a2, $a0, .LBB5_180
.LBB5_178:                              # %scalar.ph1451.preheader
	alsl.d	$a1, $a2, $a1, 2
	ld.d	$a3, $sp, 216                   # 8-byte Folded Reload
	alsl.d	$a3, $a2, $a3, 2
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB5_179:                              # %scalar.ph1451
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a1, 0
	alsl.d	$a2, $a2, $a2, 1
	st.w	$a2, $a3, 0
...
# %bb.212:                              # %_ZNSolsEPFRSoS_E.exit388
	...
	addi.d	$s5, $s5, 4
	blt	$s1, $a0, .LBB5_204
# %bb.213:                              # %.preheader1093
	ld.d	$s3, $sp, 232                   # 8-byte Folded Reload
	blez	$a0, .LBB5_226
# %bb.214:                              # %.preheader1092.preheader
	move	$s0, $zero
...
.LBB5_246:                              # %vector.body1471
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB5_246
# %bb.247:                              # %middle.block1476
	beq	$a2, $a6, .LBB5_250
.LBB5_248:                              # %scalar.ph1466.preheader
	alsl.d	$a1, $a2, $a1, 2
	ld.d	$a3, $sp, 216                   # 8-byte Folded Reload
	alsl.d	$a3, $a2, $a3, 2
	sub.d	$a4, $a6, $a2
	.p2align	4, , 16
.LBB5_249:                              # %scalar.ph1466
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a1, 0
	slli.d	$a2, $a2, 2
	st.w	$a2, $a3, 0
...
# %bb.282:                              # %_ZNSolsEPFRSoS_E.exit428
	...
	addi.d	$s4, $s4, 4
	blt	$s1, $a0, .LBB5_274
# %bb.283:                              # %.preheader1078
	blez	$a0, .LBB5_297
# %bb.284:                              # %.preheader1077.preheader
	move	$s0, $zero
...
.LBB5_328:                              # %_ZNSt6vectorIiSaIiEE17_M_realloc_appendIJiEEEvDpOT_.exit.i.i
	...
	ld.d	$s4, $sp, 280                   # 8-byte Folded Reload
	b	.LBB5_320
.LBB5_329:                              # %._crit_edge1183.loopexit
	ld.d	$s6, $sp, 208                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 168                   # 8-byte Folded Reload
	b	.LBB5_331
.LBB5_330:
...
# %bb.375:                              # %_ZNSolsEPFRSoS_E.exit489
	...
	addi.d	$s6, $s6, 4
	blt	$fp, $a0, .LBB5_367
# %bb.376:                              # %.preheader1060
	blez	$a0, .LBB5_401
# %bb.377:                              # %.lr.ph1190.preheader
	move	$fp, $zero
	addi.d	$s1, $sp, 336
	ori	$s4, $zero, 10
...
# %bb.429:                              # %_ZNSolsEPFRSoS_E.exit302
	...
	addi.d	$s4, $s4, 16
	blt	$s2, $a0, .LBB5_421
# %bb.430:                              # %.preheader1114
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
	blez	$a0, .LBB5_99
# %bb.431:                              # %.lr.ph1146.preheader
	move	$s1, $zero
	addi.d	$s2, $a1, 8
	addi.d	$s3, $sp, 336
	ori	$s4, $zero, 12
...
# %bb.440:                              # %_ZNSolsEPFRSoS_E.exit307
	...
	addi.d	$s2, $s2, 16
	blt	$s1, $a0, .LBB5_432
# %bb.441:                              # %.preheader1107
	ld.d	$s4, $sp, 280                   # 8-byte Folded Reload
	blez	$a0, .LBB5_99
# %bb.442:                              # %.lr.ph1148.preheader
	move	$s1, $zero
	addi.d	$s2, $sp, 336
	ori	$s3, $zero, 12
	movgr2fr.d	$fs0, $zero
...
.Ltmp472:                               # EH_LABEL
	...
	ld.d	$s2, $sp, 216                   # 8-byte Folded Reload
	b	.LBB5_577
.LBB5_535:                              # %.loopexit.split-lp1110
.Ltmp597:                               # EH_LABEL
	b	.LBB5_564
.LBB5_536:
.Ltmp337:                               # EH_LABEL
...
.Ltmp606:                               # EH_LABEL
	...
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
	b	.LBB5_591
.LBB5_540:                              # %.loopexit.split-lp1116
.Ltmp600:                               # EH_LABEL
	b	.LBB5_564
.LBB5_541:
.Ltmp618:                               # EH_LABEL
.LBB5_542:
	...
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB5_543:                              # %.loopexit.split-lp1062
.Ltmp546:                               # EH_LABEL
	b	.LBB5_567
.LBB5_544:                              # %.loopexit.split-lp1081
.Ltmp564:                               # EH_LABEL
	b	.LBB5_562
.LBB5_545:                              # %.loopexit.split-lp1096
.Ltmp579:                               # EH_LABEL
	b	.LBB5_559
.LBB5_546:
.Ltmp552:                               # EH_LABEL
...
.Ltmp585:                               # EH_LABEL
	b	.LBB5_571
.LBB5_549:                              # %.loopexit.split-lp1121
.Ltmp603:                               # EH_LABEL
	b	.LBB5_564
.LBB5_550:                              # %.loopexit.split-lp1067
.Ltmp549:                               # EH_LABEL
	b	.LBB5_567
.LBB5_551:                              # %.loopexit.split-lp1086
.Ltmp567:                               # EH_LABEL
	b	.LBB5_569
.LBB5_552:                              # %.loopexit.split-lp1101
.Ltmp582:                               # EH_LABEL
	b	.LBB5_571
.LBB5_553:                              # %.loopexit
.Ltmp536:                               # EH_LABEL
	b	.LBB5_567
.LBB5_554:                              # %.loopexit1109
.Ltmp324:                               # EH_LABEL
	move	$s1, $a0
	ld.d	$fp, $sp, 128                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 160                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
	b	.LBB5_591
.LBB5_555:                              # %.loopexit1080
.Ltmp457:                               # EH_LABEL
	b	.LBB5_562
.LBB5_556:                              # %.loopexit1095
.Ltmp397:                               # EH_LABEL
	b	.LBB5_559
.LBB5_557:                              # %.loopexit1115
.Ltmp313:                               # EH_LABEL
	b	.LBB5_564
.LBB5_558:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit541.thread
.Ltmp388:                               # EH_LABEL
.LBB5_559:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit541.thread1364
	move	$s1, $a0
	ld.d	$s5, $sp, 104                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 128                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 160                   # 8-byte Folded Reload
	...
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	b	.LBB5_601
.LBB5_560:                              # %.loopexit1061
.Ltmp524:                               # EH_LABEL
	b	.LBB5_567
.LBB5_561:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit535.thread
.Ltmp448:                               # EH_LABEL
.LBB5_562:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit535.thread1354
	move	$s1, $a0
	ld.d	$s5, $sp, 104                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 128                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 160                   # 8-byte Folded Reload
...
.Ltmp469:                               # EH_LABEL
	...
	ld.d	$s2, $sp, 216                   # 8-byte Folded Reload
	b	.LBB5_577
.LBB5_576:                              # %.loopexit.split-lp1072
.Ltmp555:                               # EH_LABEL
	move	$s1, $a0
	move	$s0, $s8
...
.LBB5_596:
	...
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
	beqz	$a2, .LBB5_584
.LBB5_597:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit535.thread1354
...
.LBB5_600:
	...
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	beqz	$a0, .LBB5_587
.LBB5_601:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit541.thread1364
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB6_104:                              # %vector.body466
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_104
# %bb.105:                              # %middle.block469
	beq	$a0, $a3, .LBB6_108
.LBB6_106:                              # %scalar.ph461.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a4, $a3, $s3, 3
	sub.d	$a0, $a3, $a0
	.p2align	4, , 16
.LBB6_107:                              # %scalar.ph461
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	slli.d	$a3, $a3, 3
	fldx.d	$fa0, $s1, $a3
...
.LBB6_146:                              # %vector.body477
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_146
# %bb.147:                              # %middle.block480
	beq	$a0, $a3, .LBB6_150
.LBB6_148:                              # %scalar.ph472.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a4, $a3, $s5, 3
	sub.d	$a0, $a3, $a0
	.p2align	4, , 16
.LBB6_149:                              # %scalar.ph472
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	slli.d	$a3, $a3, 3
	fldx.d	$fa0, $s1, $a3
...
.Ltmp788:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB6_248
.LBB6_233:                              # %.thread372.loopexit.split-lp
.Ltmp761:                               # EH_LABEL
	b	.LBB6_237
.LBB6_234:                              # %.loopexit.split-lp
.Ltmp773:                               # EH_LABEL
	b	.LBB6_241
.LBB6_235:                              # %.loopexit.split-lp394
.Ltmp785:                               # EH_LABEL
	b	.LBB6_246
.LBB6_236:                              # %.thread372.loopexit
.Ltmp753:                               # EH_LABEL
.LBB6_237:                              # %.thread372
	move	$fp, $a0
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
