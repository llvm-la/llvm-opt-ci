# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/verify.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/verify.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/verify.c" 2





int verify(F, Fold, Dold)
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/verify.c"
int PLA_verify(PLA1, PLA2)
pPLA PLA1, PLA2;
{



    if (PLA1->label != ((void*)0) && PLA1->label[0] != ((void*)0) &&
    PLA2->label != ((void*)0) && PLA2->label[0] != ((void*)0)) {
...
# 77 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/verify.c"
PLA_permute(PLA1, PLA2)
pPLA PLA1, PLA2;
{
 ...
 label[i] = ((void*)0);
    ...
    if ((PLA1->label)) { (void) free((char *) (PLA1->label)); (PLA1->label) = 0; };
    PLA1->label = label;

    if ((permute)) { (void) free((char *) (permute)); (permute) = 0; };
}
