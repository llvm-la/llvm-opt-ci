# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/irred.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/irred.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/irred.c" 2

static void fcube_is_covered();
static void ftautology();
static int ftaut_special_cases();
...
# 79 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/irred.c"
void
irred_split_cover(F, D, E, Rt, Rp)
pset_family F, D;
pset_family *E, *Rt, *Rp;
{
 ...
 if (debug & 0x4000) {
  ...
  R->count - ((*Rp)->count +(*Rt)->count), util_print_time(util_cpu_time()));
    ...
    if ((ED[0])) { (void) free((char *) (ED[0])); (ED[0]) = 0; }; if ((ED)) { (void) free((char *) (ED)); (ED) = 0; };;
...
pset_family D, E, Rp;
{
 ...
 i++;
    ...
    if ((list[0])) { (void) free((char *) (list[0])); (list[0]) = 0; }; if ((list)) { (void) free((char *) (list)); (list) = 0; };;
 ...
 *Tsave++ = ((void*)0);
 ...
 if (cubelist_partition(T, &A, &B, debug & 0x0200) == 0) {
     ...
     if ((T[0])) { (void) free((char *) (T[0])); (T[0]) = 0; }; if ((T)) { (void) free((char *) (T)); (T) = 0; };;
     if (tautology(A)) {
  if ((B[0])) { (void) free((char *) (B[0])); (B[0]) = 0; }; if ((B)) { (void) free((char *) (B)); (B) = 0; };;
  return 1;
     } else {
  return tautology(B);
     }
