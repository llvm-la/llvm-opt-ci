# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c" 2
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c"
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c" 2
...
# 234 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c"
...
register pset a;
{
 ...
 if (x = ~ (x & x >> 1) & cube.inmask) {
     if ((dist = (bit_count[x & 255] + bit_count[(x >> 8) & 255] + bit_count[(x >> 16) & 255] + bit_count[(x >> 24) & 255])) > 1)
  return -1;
     active = (last-1)*(32/2) + bit_index(x) / 2;
 }
...
# 395 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c"
int descend(a, b)
pset *a, *b;
{
...
{
    if (a == (pset) ((void*)0))
 return (b == (pset) ((void*)0)) ? 0 : 1;
    else if (b == (pset) ((void*)0))
 return -1;
