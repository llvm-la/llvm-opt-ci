# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c" 2
   ...
   precision d;
{
  ...
  res = 0.0;
   ...
   (void) ((k)!=((precision) 0)&&--(*(prefc *)(k))==0&&pfree(k));
   (void) ((d)!=((precision) 0)&&--(*(prefc *)(d))==0&&pfree(d));
   if (debug > 1) {
...
# 111 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c"
   ...
   char *argv[];
{
   ...
   int ch;
   precision n = ((precision) 0), f = ((precision) 0);
   unsigned aborts = 3;
   unsigned *p;

   progName = *argv;

   while ((ch = getopt(argc, argv, "a:k:i:dv")) != (-1)) switch (ch) {
   case 'a':
      aborts = atoi(optarg);
      break;
   case 'k':
...
usage: fprintf(stderr,
  ...
  fprintf(stdout, "k = %u\n", k);
   ...
   if (f != ((precision) 0)) {
      ...
      fputp(stdout, f);
      fputs(" * ", stdout);
      pdivmod(n, f, &n, ((precision *) 0));
      fputp(stdout, n);
      putc('\n', stdout);
   }

   (void) ((f)!=((precision) 0)&&--(*(prefc *)(f))==0&&pfree(f));
   (void) ((n)!=((precision) 0)&&--(*(prefc *)(n))==0&&pfree(n));
