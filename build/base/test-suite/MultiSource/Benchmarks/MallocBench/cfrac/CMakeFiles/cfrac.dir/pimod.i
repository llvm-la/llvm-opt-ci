# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pimod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pimod.c" 2
...
extern int pfree();
extern void pnorm();
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pimod.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pimod.c" 2
   ...
   int v;
{
   ...
   register digit r = 0, d;
   register int res = 0;

   (void) ((u) != ((precision) 0) && (* (prefc *) (u))++, (u));
   if (v < 0) d = (digit) -v; else d = (digit) v;
   if (d >= 65536) {
      errorp(4, "pimod", "divisor too big for single digit");
      goto done;
   }
   if (d == 0) {
      errorp(4, "pimod", "divide by zero");
      goto done;
   }
