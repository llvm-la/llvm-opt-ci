# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsmatrix.c" 2




           gs_matrix gs_identity_matrix =
 { (float)(1),0L, (float)(0),0L, (float)(0),0L, (float)(1),0L, (float)(0),0L, (float)(0),0L };
...
{ float theta = ang * (3.14159265358979323846 / 180.0);
 *pmat = gs_identity_matrix;
...
{ float xx1 = pm1->xx, yy1 = pm1->yy;
 ...
 if ( !!(((*(long *)(&((pm1)->xy)) | *(long *)(&((pm1)->yx))) << 1) == 0) )
...
gs_matrix_invert(register gs_matrix *pm, register gs_matrix *pmr)
{
 ...
 if ( !!(((*(long *)(&((pm)->xy)) | *(long *)(&((pm)->yx))) << 1) == 0) )
    { if ( ((*(long *)(&(pm->xx)) << 1) == 0) || ((*(long *)(&(pm->yy)) << 1) == 0) )
   return (-23);
...
gs_point_transform_inverse(floatp x, floatp y, register gs_matrix *pmat,
  register gs_point *ppt)
{ if ( !!(((*(long *)(&((pmat)->xy)) | *(long *)(&((pmat)->yx))) << 1) == 0) )
...
{ ppt->x = ((fixed)((x * pmat->xx)*(float)(1<<12))) + pmat->tx_fixed;
 ppt->y = ((fixed)((y * pmat->yy)*(float)(1<<12))) + pmat->ty_fixed;
 if ( !((*(long *)(&(pmat->yx)) << 1) == 0) )
  ppt->x += ((fixed)((y * pmat->yx)*(float)(1<<12)));
 if ( !((*(long *)(&(pmat->xy)) << 1) == 0) )
  ppt->y += ((fixed)((x * pmat->xy)*(float)(1<<12)));
 return 0;
}
...
{ ppt->x = ((fixed)((dx * pmat->xx)*(float)(1<<12)));
 ppt->y = ((fixed)((dy * pmat->yy)*(float)(1<<12)));
 if ( !((*(long *)(&(pmat->yx)) << 1) == 0) )
  ppt->x += ((fixed)((dy * pmat->yx)*(float)(1<<12)));
 if ( !((*(long *)(&(pmat->xy)) << 1) == 0) )
  ppt->y += ((fixed)((dx * pmat->xy)*(float)(1<<12)));
 return 0;
}
