# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdict.c" 2
...
{ if ( !(((&*op)->type_attrs & 0xfc) == ((2) << 2)) ) return (-20);
 if ( !!(~((&*dict_access_ref(&*op))->type_attrs) & (0x200)) ) return (-7);
 ((op)->value.intval = (dict_maxlength(op)), ((op)->type_attrs = (5) << 2));
 return 0;
}
...
{ uint new_size;
 int code;
 ref *op1 = op - 1;
 if ( !(((&*op1)->type_attrs & 0xfc) == ((2) << 2)) ) return (-20);
 if ( !!(~((&*dict_access_ref(&*op1))->type_attrs) & (0x100)) ) return (-7);
 if ( !(((&*op)->type_attrs & 0xfc) == ((5) << 2)) ) return (-20);
 if ( op->value.intval < 0 || op->value.intval > dict_max_size )
  return (-15);
...
{ int code;
 if ( op < osp_nargs[(2) - 1] ) return (-17);
 if ( (((op - 1)->type_attrs & 0xff) >> 2) == 8 ) return (-20);
 if ( !!(~((&*dict_access_ref(&*dsp))->type_attrs) & (0x100)) ) return (-7);
...
{ ref *pvalue;
 ...
 if ( (((op)->type_attrs & 0xff) >> 2) == 8 ) return (-20);
...
{ ref *op1 = op - 1;
 ...
 ((op1)->value.index = (((((op)->type_attrs & 0xff) >> 2) == 8 ? 0 : dict_lookup(op1,op1,op,&pvalue) > 0 ? 1 : 0)), ((op1)->type_attrs = (1) << 2));
...
{ ref *pdref = dsp;
 ...
 while ( 1 )
    { if ( !!(~((&*dict_access_ref(&*pdref))->type_attrs) & (0x200)) ) return (-7);
  if ( dict_lookup(pdref,pdref,op,&pvalue) > 0 ) break;
  if ( --pdref < dstack )
     { ((op)->value.index = (0), ((op)->type_attrs = (1) << 2));
   return 0;
     }
...
{ ref *op1 = op - 1;
 if ( !(((&*op1)->type_attrs & 0xfc) == ((2) << 2)) ) return (-20);
 if ( !!(~((&*dict_access_ref(&*op1))->type_attrs) & (0x200)) ) return (-7);
 if ( !!(~((&*dict_access_ref(&*op))->type_attrs) & (0x100)) ) return (-7);
...
{ if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
 ((op)->value.intval = (dsp - dstack + 1), ((op)->type_attrs = (5) << 2));
 return 0;
}
