# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/state.h" 1
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/state.h"
...
extern gs_state *igs;
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zdevice.c" 2
...
{ gx_device *dev = gs_currentdevice(igs);
 ...
 ((op)->value.pdevice = (dev), ((op)->type_attrs = (15) << 2));
 return 0;
}
...
{ char *dname;
 int code;
 if ( !(((&*op)->type_attrs & 0xfc) == ((15) << 2)) ) return (-20);
...
{ int code = write_matrix(op);
 ...
 int width, height;
 if ( code < 0 ) return code;
 if ( !(((&op[-1])->type_attrs & 0xfc) == ((15) << 2)) ) return (-20);
 gs_deviceparams(op[-1].value.pdevice, &imat, &width, &height);

 pmat = op->value.refs;
 ((pmat+0)->value.realval = (imat.xx), ((pmat+0)->type_attrs = (11) << 2)); ((pmat+1)->value.realval = (imat.xy), ((pmat+1)->type_attrs = (11) << 2));
 ((pmat+2)->value.realval = (imat.yx), ((pmat+2)->type_attrs = (11) << 2)); ((pmat+3)->value.realval = (imat.yy), ((pmat+3)->type_attrs = (11) << 2));
 ((pmat+4)->value.realval = (imat.tx), ((pmat+4)->type_attrs = (11) << 2)); ((pmat+5)->value.realval = (imat.ty), ((pmat+5)->type_attrs = (11) << 2));
 if ( (osp = op += (2)) > ostop ) return (osp -= (2), (-16));
 ((op - 3)->value.intval = (0), ((op - 3)->type_attrs = (6) << 2));
 ((op - 1)->value.intval = (width), ((op - 1)->type_attrs = (5) << 2));
 ((op)->value.intval = (height), ((op)->type_attrs = (5) << 2));
 return 0;
}
...
{ gs_matrix imat;
 gx_device *new_dev;
 int code;
 if ( !(((&op[-3])->type_attrs & 0xfc) == ((15) << 2)) ) return (-20);
 if ( !(((&op[-1])->type_attrs & 0xfc) == ((5) << 2)) ) return (-20);
 if ( !(((&*op)->type_attrs & 0xfc) == ((5) << 2)) ) return (-20);
 if ( (ulong)(op[-1].value.intval) > (2147483647 *2U +1U) >> 1 ||
  (ulong)(op->value.intval) > (2147483647 *2U +1U) >> 1
    ) return (-15);
 ...
 code = gs_makedevice(&new_dev, op[-3].value.pdevice, &imat,
        ...
        alloc);
 if ( code == 0 )
    { ((op - 3)->value.pdevice = (new_dev), ((op - 3)->type_attrs = (15) << 2));
  (osp -= (3));
    }
 return code;
}
...
{ gs_matrix imat;
 ...
 int num_colors;
 int code;
 if ( !(((&op[-2])->type_attrs & 0xfc) == ((5) << 2)) ) return (-20);
 if ( !(((&op[-1])->type_attrs & 0xfc) == ((5) << 2)) ) return (-20);
 if ( (((op)->type_attrs & 0xff) >> 2) == 8 )
    { num_colors = -24;
    }
 else
 ...
 if ( (ulong)(op[-2].value.intval) > (2147483647 *2U +1U) >> 1 ||
  (ulong)(op[-1].value.intval) > (2147483647 *2U +1U) >> 1 ||
  num_colors > 256
    ) return (-15);
 if ( (code = read_matrix(op - 3, &imat)) < 0 ) return code;
  ...
  for ( i = 0; i < num_colors; i++, pc++, p += 3 )
     { if ( !(((&*pc)->type_attrs & 0xfc) == ((14) << 2)) ) return (-20);
