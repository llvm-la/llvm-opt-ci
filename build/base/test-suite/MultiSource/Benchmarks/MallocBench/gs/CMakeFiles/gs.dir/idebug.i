# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idebug.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idebug.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idebug.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idebug.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idebug.c" 2


void debug_print_string(byte *,ushort);
...
{ unsigned size = pref->size;
 ...
 switch ( (((pref)->type_attrs & 0xff) >> 2) )
    {
 case 0:
   printf("array(%u)0x%lx", size, (ulong)pref->value.refs); break;
 case 1: printf("boolean %x", pref->value.index); break;
 case 15:
 ...
 case 3: printf("file 0x%lx", (ulong)pref->value.pfile); break;
 case 5: printf("int %ld", pref->value.intval); break;
 case 6: printf("mark"); break;
 case 7:
...
{ ref *p = from;
 if ( from < to ) printf("%s:\n", msg);
 while ( p < to )
    { unsigned type = (((p)->type_attrs & 0xff) >> 2), attrs = p->type_attrs;
  unsigned btype = ((((p)->type_attrs & 0xff) >> 2) >= 16 ? 9 : (((p)->type_attrs & 0xff) >> 2));
  static char *ts[] = { "arry","bool","dict","file","font","int ","mark","name","null","oper", "pary","real","save","str ","colr","devc" };
  static char *as = "xe......wr?????s";
  char *ap = as;
  ...
  switch ( btype )
     {
  case 11: printf("  =  %g", p->value.realval); break;
  case 5: printf("  =  %ld", p->value.intval); break;
  default: ;
     }
  printf("\n");
  p++;
