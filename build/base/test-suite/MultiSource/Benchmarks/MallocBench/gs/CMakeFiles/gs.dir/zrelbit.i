# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c" 2
...
{ register ref *op1 = op - 1;
 ...
 switch ( (((op)->type_attrs & 0xff) >> 2) ) { case 13: case 0: case 10: if ( !!(~((&*op)->type_attrs) & (0x200)) ) return (-7); break; case 2: if ( !!(~((&*dict_access_ref(&*op))->type_attrs) & (0x200)) ) return (-7); };
 switch ( (((op1)->type_attrs & 0xff) >> 2) ) { case 13: case 0: case 10: if ( !!(~((&*op1)->type_attrs) & (0x200)) ) return (-7); break; case 2: if ( !!(~((&*dict_access_ref(&*op1))->type_attrs) & (0x200)) ) return (-7); };
 ((op1)->value.index = ((obj_eq(op1, op) ? 1 : 0)), ((op1)->type_attrs = (1) << 2));
 (osp -= (1));
 return 0;
}
...
{ int code = obj_compare(op, 4+2);
 ...
 ((op - 1)->value.index = (code), ((op - 1)->type_attrs = (1) << 2));
 (osp -= (1));
 return 0;
}
...
{ if ( !(((&op[-1])->type_attrs & 0xfc) == (((((op)->type_attrs & 0xff) >> 2)) << 2)) ) return (-20);
 switch ( (((op)->type_attrs & 0xff) >> 2) )
    {
 case 1: op[-1].value.index &= op->value.index; break;
 case 5: op[-1].value.intval &= op->value.intval; break;
 default: return (-20);
    }
 (osp -= (1));
 return 0;
...
{ switch ( (((op)->type_attrs & 0xff) >> 2) )
    {
 case 1: op->value.index = !op->value.index; break;
 case 5: op->value.intval = ~op->value.intval; break;
 default: return (-20);
    }
 return 0;
}
...
# 219 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zrelbit.c"
int
obj_compare(register ref *op, int mask)
{
 ...
 case 5:
  ...
  case 5:
   if ( (op-1)->value.intval > op->value.intval )
    mask >>= 2;
   else if ( (op-1)->value.intval == op->value.intval )
    mask >>= 1;
   return (mask & 1);
  case 11:
   real1 = (op-1)->value.intval;
 ...
 case 11:
  ...
  break;
 case 13:
  if ( !!(~((&*(op-1))->type_attrs) & (0x200)) ) return (-7);
  if ( !(((&*op)->type_attrs & 0xfc) == ((13) << 2)) ) return (-20); if ( !!(~((&*op)->type_attrs) & (0x200)) ) return (-7);
  mask >>= (bytes_compare((op-1)->value.bytes, (op-1)->size,
