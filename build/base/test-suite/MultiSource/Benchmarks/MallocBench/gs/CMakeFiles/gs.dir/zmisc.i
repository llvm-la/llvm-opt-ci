# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c"
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/string_.h"
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/string_.h" 2
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmisc.c" 2
...
extern char *ref_to_string(ref *,char *);
 ...
 *++bsp = *op;
 ...
 while ( bsp > op )
   ...
   bsp->size--;
   switch ( (((tp)->type_attrs & 0xff) >> 2) )
    {
   case 7:
     if ( !(~((tp)->type_attrs) & (1)) )
      { ref *pvalue;
    if ( dict_lookup(dstack, dsp, tp, &pvalue) > 0 &&
         ((((pvalue)->type_attrs & 0xff) >> 2) >= 16 ? 9 : (((pvalue)->type_attrs & 0xff) >> 2)) == 9 && !(~((pvalue)->type_attrs) & (1))
       )
     (*(tp)=(*pvalue));
      }
     break;
   case 0:
     if ( !!(~((tp)->type_attrs) & (0x100)) ) break;
   case 10:
     if ( !(~((tp)->type_attrs) & (1)) && bsp < ostop )
      {
    ((tp)->type_attrs &= ~(0x100));
    *++bsp = *tp;
      }
...
{ long date_time[2];
 ...
 ((op)->value.realval = (date_time[0] * 1440.0 + date_time[1] / 60000.0), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ char *str, *value;
 int code;
 if ( !(((&*op)->type_attrs & 0xfc) == ((13) << 2)) ) return (-20); if ( !!(~((&*op)->type_attrs) & (0x200)) ) return (-7);
 str = ref_to_string(op, "getenv name");
 if ( str == 0 ) return (-25);
 value = getenv(str);
 alloc_free(str, op->size + 1, 1, "getenv name");
 if ( value == 0 )
    { ((op)->value.index = (0), ((op)->type_attrs = (1) << 2));
  return 0;
    }
 code = string_to_ref(value, op, "getenv value");
 if ( code < 0 ) return code;
 if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
 ((op)->value.index = (1), ((op)->type_attrs = (1) << 2));
 return 0;
}
...
{ if ( !(((&op[-1])->type_attrs & 0xfc) == ((13) << 2)) ) return (-20); if ( !!(~((&op[-1])->type_attrs) & (0x200)) ) return (-7);
 if ( !(((&*op)->type_attrs & 0xfc) == ((1) << 2)) ) return (-20);
 ...
 return 0;
        ...
        int type1crypt(ref *,int (*)(byte *,byte *,uint,ushort *));
...
{ return type1crypt(op, gs_type1_decrypt);
        ...
        int
type1crypt(register ref *op, int (*proc)(byte *,byte *,uint,ushort *))
{ crypt_state state;
...
{ long date_time[2];
 gs_get_clock(date_time);
 if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
 ((op)->value.intval = (date_time[0] * 86400000L + date_time[1]), ((op)->type_attrs = (5) << 2));
 return 0;
}
