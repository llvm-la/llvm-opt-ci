# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2
...
extern gs_state *igs;
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmatrix.c" 2


        int common_transform(ref *,int (*)(gs_state *,floatp,floatp,gs_point *),int (*)(floatp,floatp,gs_matrix *,gs_point *));
...
{ extern gs_matrix gs_identity_matrix;
 ...
 int i;
 for ( i = 0; i < 6; i++, mp++ )
  ((mp)->value.realval = (mp->value.realval), ((mp)->type_attrs = (11) << 2));
}
...
common_transform(register ref *op,
  ...
  int (*matproc)(floatp,floatp,gs_matrix *,gs_point *))
{ float opxy[2];
 gs_point pt;
 int code;
 ...
 switch ( (((op)->type_attrs & 0xff) >> 2) )
    {
 case 11: opxy[1] = op->value.realval; break;
 case 5: opxy[1] = op->value.intval; break;
 case 0: case 10:
    { gs_matrix mat;
  gs_matrix *pmat = &mat;
 ...
 switch ( (((op - 1)->type_attrs & 0xff) >> 2) )
    {
 case 11: opxy[0] = (op - 1)->value.realval; break;
 case 5: opxy[0] = (op - 1)->value.intval; break;
 default: return (-20);
    }
 if ( (code = (*ptproc)(igs, opxy[0], opxy[1], &pt)) < 0 )
  return code;
out: ((op - 1)->value.realval = (pt.x), ((op - 1)->type_attrs = (11) << 2));
