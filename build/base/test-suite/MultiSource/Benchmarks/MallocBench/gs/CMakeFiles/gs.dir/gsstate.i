# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gzht.h" 1
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gzht.h"
typedef struct halftone_s {
 ...
 int width;
 int height;
 struct ht_bit_s *order;
 int order_size;
} halftone;
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gzht.h"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gzline.h" 1
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gzline.h"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsstate.c" 2


unsigned gs_state_sizeof = sizeof(gs_state);


        int alloc_state_contents(gs_state *,proc_alloc_t);
        void free_state_contents(gs_state *);
...
{ gs_state *pnew = (gs_state *)(*pgs->memory_procs.alloc)(1, sizeof(gs_state), "gs_gsave");
 if ( pnew == 0 ) return (-25);
 *pnew = *pgs;
 if ( alloc_state_contents(pgs, pgs->memory_procs.alloc) < 0 ) return (-25);


 *pgs->path = *pnew->path;
 *pgs->clip_path = *pnew->clip_path;
 *pgs->line_params = *pnew->line_params;
 *pgs->halftone = *pnew->halftone;
 *pgs->color = *pnew->color;
 *pgs->dev_color = *pnew->dev_color;
 *pgs->device = *pnew->device;
...
{ char *elt;
 ...
 if ( (elt = (*palloc)(1, sizeof(gx_path), cname)) == 0 ) return -1; pgs->path = (gx_path *)elt;
 if ( (elt = (*palloc)(1, sizeof(gx_path), cname)) == 0 ) return -1; pgs->clip_path = (gx_path *)elt;
 if ( (elt = (*palloc)(1, sizeof(line_params), cname)) == 0 ) return -1; pgs->line_params = (line_params *)elt;
 if ( (elt = (*palloc)(1, sizeof(halftone), cname)) == 0 ) return -1; pgs->halftone = (halftone *)elt;
 if ( (elt = (*palloc)(1, sizeof(gs_color), cname)) == 0 ) return -1; pgs->color = (gs_color *)elt;
 if ( (elt = (*palloc)(1, sizeof(gx_device_color), cname)) == 0 ) return -1; pgs->dev_color = (gx_device_color *)elt;
 if ( (elt = (*palloc)(1, sizeof(device), cname)) == 0 ) return -1; pgs->device = (device *)elt;
...
{ proc_free_t pfree = pgs->memory_procs.free;
 ...
 if ( !pgs->device_is_shared )
  (*pfree)((char *)pgs->device, 1, sizeof(device), cname);
 (*pfree)((char *)pgs->dev_color, 1, sizeof(gx_device_color), cname);
 (*pfree)((char *)pgs->color, 1, sizeof(gs_color), cname);
 (*pfree)((char *)pgs->halftone, 1, sizeof(halftone), cname);
 (*pfree)((char *)pgs->line_params, 1, sizeof(line_params), cname);
 (*pfree)((char *)pgs->clip_path, 1, sizeof(gx_path), cname);
 (*pfree)((char *)pgs->path, 1, sizeof(gx_path), cname);
