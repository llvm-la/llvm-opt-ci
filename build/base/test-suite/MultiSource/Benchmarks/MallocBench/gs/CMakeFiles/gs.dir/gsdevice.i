# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c"
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/math_.h" 1
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/math_.h"
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/math_.h" 2
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gsdevice.c" 2
...
extern gx_device *gx_device_list[];
        ...
        int null_fill_rectangle(struct gx_device_s *,int x,int y,int width,int height,gx_color_index color);
        int null_tile_rectangle(struct gx_device_s *,gx_bitmap *tile,int x,int y,int width,int height,gx_color_index color0,gx_color_index color1);
        int null_copy_mono(struct gx_device_s *,unsigned char *data,int data_x,int raster,int x,int y,int width,int height,gx_color_index color0,gx_color_index color1);
        int null_copy_color(struct gx_device_s *,unsigned char *data,int data_x,int raster,int x,int y,int width,int height);
        int null_draw_line(struct gx_device_s *,int x0,int y0,int x1,int y1,gx_color_index color);
        int null_fill_trapezoid(struct gx_device_s *,int x0,int y0,int width0,int x1,int y1,int width1,gx_color_index color);
        int null_tile_trapezoid(struct gx_device_s *,gx_bitmap *tile,int x0,int y0,int width0,int x1,int y1,int width1,gx_color_index color0,gx_color_index color1);
...
{ int count;
 if ( !gs_device_is_memory(dev) ) return (-21);
...
{ register gx_device *new_dev;
 ...
 if ( new_dev == 0 ) return (-25);
 if ( width <= 0 || height <= 0 ) return (-15);
 ...
 *new_dev = *old_dev;
 ...
 if ( bitmap_size > (2147483647 *2U +1U) )
  return (-13);
...
{ return (gx_color_index)((((r) > (g) ? (r) : (g))) > (b) ? (((r) > (g) ? (r) : (g))) : (b));
}
int
