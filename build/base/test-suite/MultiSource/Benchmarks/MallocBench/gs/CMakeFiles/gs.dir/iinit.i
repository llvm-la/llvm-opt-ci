# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c" 2
...
{ ref nref;
 ...
 if ( dict_put(&(dstack[0]), &nref, pref) )
  ( fprintf(stderr, "%s(%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iinit.c", 43), fprintf(stderr, "dict_put failed!\n")), exit(1);
}
...
{ ref oper;
 (((&oper)->value.opproc = (proc), ((&oper)->type_attrs = ((9) << 2) + (1))), (&oper)->size = (*nstr - '0'));
 interp_fix_op(&oper);
...
obj_init()
{
 ...
 ref vmark, vnull;
 ((&vmark)->value.intval = (0), ((&vmark)->type_attrs = (6) << 2));
 ((&vnull)->value.intval = (0), ((&vnull)->type_attrs = (8) << 2));


 dict_create(401, &(dstack[0]));
 dstack[1] = dstack[0];
...
op_init()
{
 ...
 { extern void zarith_op_init(); zarith_op_init(); };
 { extern void zarray_op_init(); zarray_op_init(); };
 { extern void zcontrol_op_init(); zcontrol_op_init(); };
 { extern void zdict_op_init(); zdict_op_init(); };
 { extern void zfile_op_init(); zfile_op_init(); };
 { extern void zgeneric_op_init(); zgeneric_op_init(); };
 { extern void zmath_op_init(); zmath_op_init(); };
 { extern void zmisc_op_init(); zmisc_op_init(); };
 { extern void zpacked_op_init(); zpacked_op_init(); };
 { extern void zrelbit_op_init(); zrelbit_op_init(); };
 { extern void zstack_op_init(); zstack_op_init(); };
 { extern void zstring_op_init(); zstring_op_init(); };
 { extern void ztype_op_init(); ztype_op_init(); };
 { extern void zvmem_op_init(); zvmem_op_init(); };

 { extern void zchar_op_init(); zchar_op_init(); };
 { extern void zcolor_op_init(); zcolor_op_init(); };
 { extern void zdevice_op_init(); zdevice_op_init(); };
 { extern void zfont_op_init(); zfont_op_init(); };
 { extern void zgstate_op_init(); zgstate_op_init(); };
 { extern void zht_op_init(); zht_op_init(); };
 { extern void zmatrix_op_init(); zmatrix_op_init(); };
 { extern void zpaint_op_init(); zpaint_op_init(); };
 { extern void zpath_op_init(); zpath_op_init(); };
 { extern void zpath2_op_init(); zpath2_op_init(); };
}
