# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstack.c" 2
...
{ ref *opn;
 ...
 if ( (ulong)op->value.intval >= op - osbot ) return (-15);
...
{ ref *op1 = op - 1;
 ...
 if ( count == 0 ) { (osp -= (2)); return 0; }
 mod = op->value.intval % count;
 (osp -= (2));
 op -= 2;
 if ( mod < 0 )
  mod += count;
 else if ( mod == 0 ) return 0;
...
{ if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
 ((op)->value.intval = (op - osbot), ((op)->type_attrs = (5) << 2));
 return 0;
}
...
{ register ref *mp = op;
 while ( mp >= osbot )
    { if ( (((mp)->type_attrs & 0xff) >> 2) == 6 )
     { if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
   ((op)->value.intval = (op - mp - 1), ((op)->type_attrs = (5) << 2));
   return 0;
     }
  mp--;
    }
