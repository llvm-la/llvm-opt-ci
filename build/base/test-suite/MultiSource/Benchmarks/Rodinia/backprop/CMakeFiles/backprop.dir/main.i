# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/backprop.h" 1
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/../Common/glibc_compat_rand.h" 1
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/../Common/glibc_compat_rand.h"
int glibc_compat_rand(void);
void glibc_compat_srand(unsigned int seed);
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/main.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/main.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/main.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/main.c" 2
...
int main() {
  ...
  float *input_weights =
      malloc(sizeof(float) * (1 + 50000) * (1 + 16));
  float *input_prev_weights =
      malloc(sizeof(float) * (1 + 50000) * (1 + 16));
  float *hidden_weights =
      malloc(sizeof(float) * (1 + 16) * (1 + 1));
  float *hidden_prev_weights =
      malloc(sizeof(float) * (1 + 16) * (1 + 1));
  float *input_units = malloc(sizeof(float) * (50000 + 1));
  float *hidden_units = malloc(sizeof(float) * (16 + 1));
  float *hidden_delta = malloc(sizeof(float) * (16 + 1));
  float *output_units = malloc(sizeof(float) * (1 + 1));
  float *output_delta = malloc(sizeof(float) * (1 + 1));
  float *target = malloc(sizeof(float) * (1 + 1));


  int i, j;
  for (i = 0; i <= 50000; i++) {
    for (j = 0; j <= 16; j++) {
      input_weights[i * (1 + 16) + j] =
          (float)glibc_compat_rand() / 2147483647;
    }
  }

  for (i = 0; i <= 16; i++) {
    for (j = 0; j <= 1; j++) {
      hidden_weights[i * (1 + 1) + j] =
          (float)glibc_compat_rand() / 2147483647;
    }
  }
  ...
  for (i = 0; i <= 50000; i++) {
    for (j = 0; j <= 16; j++) {
      input_prev_weights[i * (1 + 16) + j] = 0.0;
    }
  }

  for (i = 0; i <= 16; i++) {
    for (j = 0; j <= 1; j++) {
      hidden_prev_weights[i * (1 + 1) + j] = 0.0;
    }
  }
  ...
  for (int i = 0; i <= 50000; i++) {
    input_units[i] = (float)glibc_compat_rand() / 2147483647;
  }
  ...
  error = bpnn_train_kernel(
      50000, 16, 1, input_units, hidden_units,
      output_units, hidden_delta, output_delta, target, input_weights,
      hidden_weights, input_prev_weights, hidden_prev_weights, 100);

  bpnn_dump(50000, 16, 1, input_weights, hidden_weights,
            error);
