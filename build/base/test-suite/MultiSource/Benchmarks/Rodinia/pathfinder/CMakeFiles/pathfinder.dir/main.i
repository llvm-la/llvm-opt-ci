# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/../Common/glibc_compat_rand.h" 1
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/../Common/glibc_compat_rand.h"
int glibc_compat_rand(void);
void glibc_compat_srand(unsigned int seed);
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/pathfinder.h" 1
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/main.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/main.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/main.c" 2
...
int main() {
  ...
  int *data = (int *)malloc(sizeof(int) * 100000 * 500);
  int *result = (int *)malloc(sizeof(int) * 500);
  int *src = (int *)malloc(sizeof(int) * 500);

  initialize(100000, 500, result, data);

  pathFinderKernel(100000, 500, data, result, src);

  printResult(500, result);

  return 0;
}

void initialize(int rows, int cols, int *result, int *data) {
  glibc_compat_srand(9);
