# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/main.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/main.c"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/main.c" 2
double pyramid[][3] =
{
  { 1.00,-0.67, 0.67},
  {-1.00,-0.67, 0.67},
...
MakeSphere( ObjPtr o,int sli, int pol, double r)
{
  ...
  dfi = 2*3.14159265359/sli;
  dtheta = 2*3.14159265359/pol;
  for(fi=-3.14159265359;fi<3.14159265359 +0.000001;fi=fi+dfi){
    for(theta=-3.14159265359;theta<3.14159265359 +0.000001;theta=theta+dtheta){
...
{
  int i = 0;
  ObjPtr o = ((void*)0), tmp = ((void*)0), ttmp = ((void*)0);
  o = Oalloc("TestObject");
