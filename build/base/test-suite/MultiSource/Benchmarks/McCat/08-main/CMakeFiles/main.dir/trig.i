# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/trig.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/trig.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/trig.c"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/08-main/trig.c" 2
void
...
HPoint
MultMatrixHPoint(Matrix *mat,HPoint P)
{
  HPoint Res;
...
RotateMatrix( double rx, double ry, double rz)
{
  ...
  cosrx = cos((3.14159265359/180*rx));
  sinrx = sin((3.14159265359/180*rx));
  cosry = cos((3.14159265359/180*ry));
  sinry = sin((3.14159265359/180*ry));
  cosrz = cos((3.14159265359/180*rz));
  sinrz = sin((3.14159265359/180*rz));
