# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/MM.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/MM.c" 2
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/MM.c"
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/MM.c" 2
...
Matrix MakeMatrix(int i)
{
  ...
  for (j=0;j<51;j++)
    for (k=j;k<51;k++)
      ...
      else M[j][k] = M[k][j] = 4.0/(5.0*sqrt(2.0*3.14159265358979323846))*
...
Matrix newMatrix(void)
{
  ...
  M = (Matrix)malloc(sizeof(double *)*51);
  for (i=0;i<51;i++)
    M[i] = (double *)malloc(sizeof(double)*51);
