# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/Jacobi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/Jacobi.c" 2
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/Jacobi.c"
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/QRfact.h"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/QRfact.h" 2
...
int sign(double a);
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/Jacobi.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/Jacobi.c" 2
...
Matrix Jacobi(Matrix A,int bw)
{
      ...
      for (j=0;j<51 -i;j++)
 {
   ...
   ApplyGivens(A,s,c,j+i-1,j+i,j,(j+2*i<51)?j+2*i:51 -1);
   ...
   while (m<51 -i)
     {
       ...
       ApplyGivens(A,s,c,m+i-1,m+i,m-1,(m+2*i<51)?m+2*i:51 -1);
