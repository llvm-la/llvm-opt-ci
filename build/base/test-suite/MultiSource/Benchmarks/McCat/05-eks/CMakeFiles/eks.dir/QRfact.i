# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/QRfact.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/QRfact.c" 2
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/QRfact.c"
...
int sign(double a);
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/QRfact.c" 2
  ...
  while (notdone)
    {
      ...
      for (i=0;i<51 -1;i++)
 if (fabs(A[i+1][i])<(fabs(A[i][i])+fabs(A[i+1][i+1]))*1.0e-10)
   A[i+1][i]=A[i][i+1]=0.0;
