# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.h" 1
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c" 2
...
# 79 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c"
{
  int i;
  int a;
  double q,iq;
  ...
  for(i=0; i<n; i++) {
    ...
    if (q != 0.0) {
      ...
      q = (c[i] - x) - beta[i]/q;
# 106 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c"
    }
    else {
      q = (c[i] - x) - fabs(b[i])/2.2204460492503131e-16;
    }

    if (q < 0)
      a = a + 1;
  }
# 157 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c"
  return a;
}
...
void dbisect(double c[], double b[], double beta[],
      ...
      double x[])
# 223 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/04-bisect/dbisect.c"
{
  int i;
  double h,xmin,xmax;
  beta[0] = b[0] = 0.0;
  ...
  *eps2 = 2.2204460492503131e-16 * (xmin + xmax > 0 ? xmax : -xmin);
  if (eps1 <= 0)
    eps1 = *eps2;
 ...
 x0 = x[k];
      ...
      x1 = (xu + x0)/2;
      while ( x0-xu > 2*2.2204460492503131e-16*(fabs(xu)+fabs(x0))+eps1 ) {
 *z = *z + 1;
