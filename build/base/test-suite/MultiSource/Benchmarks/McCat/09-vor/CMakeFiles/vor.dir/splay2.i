# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c" 2
...
# 63 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c"
...
void *CHsplay(CHsplay_node **root, key key)
{
  ...
  while (temp->father != ((void*)0)) {
      if (temp->father->father==((void*)0)) {
   temp=CHrotate(temp); }
...
void CHdelete(CHsplay_node **root, key key) {
  ...
  if (*root != ((void*)0)) {
    ...
    if ((tmp1 == ((void*)0)) && (tmp2 == ((void*)0)))
      (*root)=((void*)0);
    else if ((tmp1 == ((void*)0)) && (tmp2 != ((void*)0))) {
      (*root)=tmp2;
      (*root)->father=((void*)0); }
    else if ((tmp1 != ((void*)0)) && (tmp2 == ((void*)0))) {
      (*root)=tmp1;
