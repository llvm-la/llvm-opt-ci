# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/struktur.h" 1
...
typedef struct DCEL_segment {
  struct point v1,v2;
  struct DCEL_segment *p1,*p2;
  struct DCEL_segment *q1,*q2;
} DCEL_segment;
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/headers.h" 1
...
int visible(int direction,point p1,point p2,point p3);
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c" 2

splay_node *Splaytree;
CHsplay_node *CHSplaytree;
CHpoints *S;
int default_radius;
int CHno=0;
Knode *K;
...
point compute_v(CHpoints *P) {
# 92 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/vor.c"
  point An,Bn,Cn,Dn;
  point n;
  double c;
...
void draw_sec(CHpoints *p) {
  ...
  if (angle(p1,p2,p3)<0) {
    c.x=(midpoint(p1->node,p3->node)).x;
    c.y=(midpoint(p1->node,p3->node)).y;
...
void alg2() {
 ...
 draw_sec(p);
      ...
      c.y= (int)dc.y;
      add_point(c);
      add_edge(Kcount-1,p->v);
      add_edge(Kcount-1,q->v);
      q->v=Kcount-1;
      q->next=next(p);
      next(q)->prev=q;
