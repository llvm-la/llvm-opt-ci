# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay.c" 2

splay_node *find(splay_node *root, long key)
{
  if ((root->element.key < key) && (root->right != ((void*)0)))
    return find(root->right,key);
  else if ((root->element.key > key) && (root->left != ((void*)0)))
...
void *insert(splay_node **root, point p)
{
 ...
 temp->left = (*root)->left;
 if (temp->left != ((void*)0)) temp->left->father = temp;
 temp->right = (*root);
 (*root)->left = ((void*)0);
      }
      else
 {
   ...
   if (temp->right != ((void*)0)) temp->right->father = temp;
   temp->left = (*root);
   (*root)->right = ((void*)0);
 }
      (*root)->father = temp;
