# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c" 2
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c"
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c" 2
...
extern void ConvertToFloat(ImgP);
extern void HorzVariance(ImgP, int);
extern CompP BuildConnectedComponents(ImgP, int);
extern void PrintConnectedComponents(CompP);
extern void WriteConnectedComponentsToPGM(CompP, ImgP);
extern void FreeConnectedComponents(CompP);
extern void EliminateLargeSpreadComponents(CompI, ImgP);
extern void MergeRowComponents(CompI, ImgP);
extern void PairComponents(CompI, ImgP);
extern void ComputeBoundingBoxes(CompP, ImgP);
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c" 2
...
# 86 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c"
...
void ParseInputFile(char *file)
{
  ...
  ParmT parms[] = {
    {"image", 1, &IMAGE},
    {"sigma", 2, &SIGMA},
    {"var_thresh", 0, &VAR_THRESHOLD},
    {"vspread_thresh", 2, &VSPREAD_THRESHOLD},
    {"same_row_thresh", 0, &SAME_ROW_THRESHOLD},
    {"same_row_v", 0, &SAME_ROW_V},
    {"same_row_h", 0, &SAME_ROW_H},
    {"max_char_size", 0, &MAX_CHAR_SIZE},
    {"min_char_size", 0, &MIN_CHAR_SIZE},
    {"kill_small", 0, &KILL_SMALL_COMP},
    {"small_thresh", 0, &SMALL_THRESHOLD},
    {"hvar_window", 0, &HVAR_WINDOW},
    {"", 0, ((void*)0)}
  };
  char read_parm[25];
  char read_val[80];
  ...
  while ((fgets(s, 80, fp) != ((void*)0)) && (s[0] != '\n'))
    {
      p = 0;
      strcpy(read_parm, strtok(s, " \t"));
      strcpy(read_val, strtok(((void*)0), " \t"));

      while((parms[p].var != ((void*)0)) && strcmp(read_parm, parms[p].parm))
 p++;

      if (parms[p].var == ((void*)0))
 continue;
 ...
 case 2:
   *(double *)(parms[p].var) = strtod(read_val, ((void*)0));
   break;
...
int main(int argc, char *argv[])
{
  ...
  int var_threshold;
  CompP comp;
# 188 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c"
...
# 238 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c"
...
# 263 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c"
...
# 282 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/main.c"
