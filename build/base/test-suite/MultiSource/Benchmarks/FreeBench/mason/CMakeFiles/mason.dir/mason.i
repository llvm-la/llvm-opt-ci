# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c" 2
...
# 160 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c"
...
static int mu(p_type p,int maxdep,int dep,int last) {
  ...
  int win;
  if( dep == maxdep - 4 ) {
    if(( 0x2 & near[p.b]) == 0) return 0;
    if(( 0x8 & near[p.d]) == 0) return 0;
    if(( 0x10 & near[p.bi]) == 0) return 0;
    if(( 0x20 & near[p.ar]) == 0) return 0;
    if(( 0x1 & near[p.a]) == 0) return 0;
    if(( 0x4 & near[p.c]) == 0) return 0;
    if(( 0x40 & near[p.g1]) == 0) return 0;
    if(( 0x40 & near[p.g2]) == 0) return 0;
    if(( 0x40 & near[p.g3]) == 0) return 0;
  }
...
# 283 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c"
  fp=fopen(argv[1],"r");
  if (fp==((void*)0)) {
