# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/analyzer/types.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/analyzer/types.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/analyzer/types.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/analyzer/types.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/analyzer/types.c" 2
...
void hard_raw_mod(uint32 address, int w_epoch, int w_place, uint32 w_issue, int r_epoch, int r_place, uint32 r_issue)
{
  ...
  if (hr_empty) {
    ...
    hard_raw_list->next=((void*)0);
    hard_raw_list->prev=((void*)0);
...
void def_list_mod(uint32 address, int epoch, int place_in_epoch)
{
  ...
  if (def_table[place]==((void*)0)) {
    ...
    for (counter=def_table[place];counter!=((void*)0);counter=(def_list_t *)counter->next) {
      temp=counter;
      if (address==counter->address) {
 counter->epoch=epoch;
...
void conflict_list(uint32 address)
{
  static conf_list_t *next=((void*)0);
  conf_list_t *temp=((void*)0);
  conf_list_t *counter;
  int make_new=1;
  ...
  for (counter=list;counter!=((void*)0);counter=(conf_list_t *)counter->next) {
    temp=counter;
    if (address==counter->address) {
      counter->accesser++;
      make_new=0;
