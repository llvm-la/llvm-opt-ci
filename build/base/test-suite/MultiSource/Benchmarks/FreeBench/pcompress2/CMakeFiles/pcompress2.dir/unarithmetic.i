# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c"
int char_to_index[256];
unsigned char index_to_char[(256 +1)+1];

int freq[(256 +1)+1];
int cum_freq[(256 +1)+1];
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c"
typedef long code_value;
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c"
int buffer;
int bits_to_go;
int garbage_bits;
...
unsigned int do_deari(unsigned int insize)
{
  ...
  for (;;) {
    ...
    if (symbol==(256 +1)) break;
    ch = index_to_char[symbol];
    deari[deari_pos++]=(unsigned char)ch;
    update_model(symbol);
  }
...
{ long range;
    ...
    for (;;) {
        if (high<(2*((((long)1<<16)-1)/4+1))) {

        }
        else if (low>=(2*((((long)1<<16)-1)/4+1))) {
            value -= (2*((((long)1<<16)-1)/4+1));
            low -= (2*((((long)1<<16)-1)/4+1));
            high -= (2*((((long)1<<16)-1)/4+1));
        }
        else if (low>=((((long)1<<16)-1)/4+1)
              && high<(3*((((long)1<<16)-1)/4+1))) {
            value -= ((((long)1<<16)-1)/4+1);
            low -= ((((long)1<<16)-1)/4+1);
            high -= ((((long)1<<16)-1)/4+1);
        }
        else break;
        low = 2*low;
        high = 2*high+1;
