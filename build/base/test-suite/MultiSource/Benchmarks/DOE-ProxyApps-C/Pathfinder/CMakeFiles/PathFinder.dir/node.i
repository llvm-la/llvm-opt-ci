# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c" 2
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c"
...
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c" 2
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/bitfield.h"
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/build/build-llvm/lib/clang/22/include/stdbool.h" 1 3
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/bitfield.h" 2
...
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c" 2
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c"
Node *Node_new(int id, int nodeCount)
{
...
void Node_delete(Node *trash)
{
    ...
    if ( trash->interiorNodes )
        NodeList_clear( trash->interiorNodes, 1 );
...
Node *Node_duplicate(Node *from, int newIndex)
{
    ...
    copy->id = from->id;
    copy->nodeCount = newIndex;
    copy->label = from->label;
    copy->labelIdx = from->labelIdx;
    copy->type = from->type;
    copy->container = ((void*)0);
    copy->interiorNodes = ((void*)0);
    copy->edges = ((void*)0);
...
{
    EdgeList *end = ((void*)0);
    EdgeList *newEdge = ((void*)0);

    if ( !this || !node )
        return(0);


    for ( end = this->edges; end != ((void*)0); end = end->nextEdge )
    ...
    newEdge->nextEdge = this->edges;
    this->edges = newEdge;
    ++this->edgeCount;
    return(1);
}
# 189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c"
NodeList * NodeList_new()
{
...
_Bool NodeList_insertFront(NodeList *this, Node *newFront)
{
    ...
    oldFront->nextNode = this->nextNode;
...
_Bool NodeList_insertBack(NodeList *this, Node *newBack)
{
    ...
    for ( end = this; end->nextNode != ((void*)0); end = end->nextNode )
    { }
    ...
    end->nextNode = newElement;

    return(1);
}
# 294 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/node.c"
EdgeList *EdgeList_new()
{
    EdgeList *newNode = malloc( sizeof( struct EdgeListStruct ));
    if ( newNode )
    {
        newNode->targetNodeId = -1;
        newNode->targetNode = ((void*)0);
        newNode->nextEdge = ((void*)0);
    }
    return(newNode);
}
...
_Bool EdgeList_insertNodeId(EdgeList *this, int targetNodeId)
{
    ...
    for ( end = this; end->nextEdge != ((void*)0); end = end->nextEdge )
    { }
