# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c" 2
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c"
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.h"
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.h" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c"
SearchDiagram *SearchDiagram_findNode ( SearchDiagram *diagram, Node *node )
{
    int idx;
    ...
    for ( idx = 0; diagram[idx].node != ((void*)0); ++idx )
    {
...
# 75 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c"
SearchDiagram *SearchDiagram_build( NodeList *nodeTree, int nodeCount )
{
    SearchDiagram *diagram = ((void*)0);
    NodeList *outerNodes = ((void*)0);
    Node *node = ((void*)0);
    NodeList *innerNodes = ((void*)0);
# 93 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c"
    int outerIdx = 0;
    int innerIdx = nodeCount-1;
    ...
    diagram[nodeCount].node = ((void*)0);
    diagram[nodeCount].edgeReferenceArray = ((void*)0);


    for ( outerNodes = nodeTree; outerNodes != ((void*)0); outerNodes = outerNodes->nextNode )
    {
        ...
        if ( edgeCount > 0 )
        {
            ...
            diagram[outerIdx].edgeReferenceArray[edgeCount].edgeTarget = ((void*)0);
            diagram[outerIdx].edgeReferenceArray[edgeCount].targetNodeEdges = ((void*)0);
        }
        else
            diagram[outerIdx].edgeReferenceArray = ((void*)0);
        ...
        for ( innerNodes = node->interiorNodes; innerNodes != ((void*)0); innerNodes = innerNodes->nextNode )
        {
            ...
            if ( node->edgeCount > 0 )
            {
                ...
                diagram[innerIdx].edgeReferenceArray[edgeCount].edgeTarget = ((void*)0);
                diagram[innerIdx].edgeReferenceArray[edgeCount].targetNodeEdges = ((void*)0);
            }
            else
                diagram[innerIdx].edgeReferenceArray = ((void*)0);
...
# 229 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchDiagram.c"
    ...
    for ( i = 0; edges[i].edgeTarget != ((void*)0); ++i )
    {
        if ( edges[i].edgeTarget->label )
        {

            if ( strcmp( edges[i].edgeTarget->label, labels[0] ) == 0 )
