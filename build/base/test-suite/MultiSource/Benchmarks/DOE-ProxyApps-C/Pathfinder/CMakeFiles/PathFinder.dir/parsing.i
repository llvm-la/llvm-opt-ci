# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c" 2
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.h"
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.h" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/build/build-llvm/lib/clang/22/include/stdbool.h" 1 3
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.h" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/bitfield.h"
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/bitfield.h" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/bitfield.h" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c" 2
...
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c" 2
# 65 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
void buildEntranceList( Node *outerNode, IntVector *nodeData )
{
    int i;
    int entranceCount;
    ...
    entranceCount = nodeData->vector[1];
    if ( entranceCount == 0 )
        return;
...
Node *buildNodeFromData( IntVector *nodeData )
{
    ...
    if ( nodeData == ((void*)0) || nodeData->size == 0 )
        return( ((void*)0) );

    Node *node = Node_new( nodeData->vector[0], -1 );
    if ( !node )
        return( ((void*)0) );
...
# 152 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
void resolveNodeEdges( Graph *graph, Node* sourceNode, _Bool outerNode )
{
    EdgeList *edges;
    Node *node;
    ...
    for ( edges = sourceNode->edges; edges != ((void*)0); edges = edges->nextEdge )
    {
        if ( outerNode )
        {

            node = Graph_findNode( graph, edges->targetNodeId, 1 );
            if ( node )
            {
                okSoFar = 1;
        ...
        else
        {
            ...
            node = Graph_findNode( graph, edges->targetNodeId, 0 );
            if ( node )
                edges->targetNode = node;
            else
            {
...
{
    FILE *inFile;
    IntVector *fileData = ((void*)0);
    CharVector *fileString = ((void*)0);
    Node *newNode = ((void*)0);
    Node *outerNode = ((void*)0);
    Node *findNode = ((void*)0);
    int temp, count;
    NodeList *outerNodeList = ((void*)0);
    NodeList *innerNodeList = ((void*)0);
    Graph *newGraph = ((void*)0);
    int funcCount = 50;
    int blockCount = 0;
    _Bool systemCallSection = 0;
    int i;
    ...
    fileString = CharVector_new( 1024 );
    ...
    while ( !feof( inFile ) )
    {
        ...
        if ( ((*__ctype_b_loc ())[(int) (((int)fileString->string[0]))] & (unsigned short int) _ISdigit) )
            temp = atoi( fileString->string );
        else
            temp = -1;
        outerNode = Graph_findNode( newGraph, temp, 0 );
    ...
    if ( newGraph->systemCallMap == ((void*)0) )
    {
    ...
    if ( systemCallSection )
    {
        while ( !feof( inFile ) )
        {
            ...
            if ( temp >= 0 )
            {
                ...
                {
                    ++i;
                    findNode = Graph_findNode( newGraph, temp, 1 );
    ...
    for ( outerNodeList = newGraph->outerNodes;
          outerNodeList != ((void*)0);
          outerNodeList = outerNodeList->nextNode )
    {
        resolveNodeEdges( newGraph, outerNodeList->node, 1 );
        for ( innerNodeList = outerNodeList->node->interiorNodes;
              innerNodeList != ((void*)0);
              innerNodeList = innerNodeList->nextNode )
        {
            resolveNodeEdges( newGraph, innerNodeList->node, 0 );
        }
    }
# 472 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
...
# 489 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
char **parseSignature( char *data )
{
    int i = 0;
    int labelCount = 0;
    ...
    if ( labels )
    {
        ...
        labels[labelCount] = ((void*)0);
    }
# 538 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
    return labels;
}
# 554 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/parsing.c"
_Bool parseConfigFile( char *configFileName, Configuration *config )
{
    char data[1000];
    FILE *configFile = ((void*)0);
    int fileNum = -1;
    int sigNum = -1;
    int i = 0;
    ...
    {
        fgets ( data, 1000, configFile );
        if ( feof( configFile ) || ( strncmp ( "file ", data, 5 ) != 0 ) )
        {
    ...
    {
        fgets ( data, 1000, configFile );
        if ( feof( configFile ) || ( strncmp ( "signature ", data, 10 ) != 0 ) )
        {
    ...
    config->signatures[sigNum] = ((void*)0);
