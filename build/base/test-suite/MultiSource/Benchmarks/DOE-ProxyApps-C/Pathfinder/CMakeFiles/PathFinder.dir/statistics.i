# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.c" 2
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.c"
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.h"
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.h" 2
...
void testStats();
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.c" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/statistics.c" 2
...
_Bool HistogramElement_updateList(HistogramElement **head, int length)
{
    HistogramElement **prev = ((void*)0);
    HistogramElement *current = ((void*)0);
    HistogramElement *new = ((void*)0);
    _Bool histogramInsert = 0;
...
Stats *Stats_new()
{
    ...
    if ( new )
    {
        new->pathLengths = IntVector_new(16);
        new->averageLength = 0.0;
        new->standardDeviation = 0.0;
        new->minLength = 2147483647;
        new->maxLength = 0;
        new->histogram = ((void*)0);
        if ( new->pathLengths )
            return(new);
        else
        {
