# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c" 2
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c"
...
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c" 2
...
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c" 2
...
# 124 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c"
static char *findNextNumber(char *input)
{
    if ( ((*__ctype_b_loc ())[(int) (((int)input[0]))] & (unsigned short int) _ISdigit) )
    {

        ++input;
        while ( ((*__ctype_b_loc ())[(int) (((int)input[0]))] & (unsigned short int) _ISdigit) && *input != '\0' )
            ++input;
        if ( input[0] == '\0' )
            return( ((void*)0) );
        else
    ...
    else
    {
        ...
        do {
            if ( input[0] == '\0' )
                return(((void*)0));
            ++input;
        } while ( !((*__ctype_b_loc ())[(int) (((int)input[0]))] & (unsigned short int) _ISdigit) );
        return(input);
    }
}
...
int IntVector_createFromString(IntVector *vector, char *inputString)
{
    ...
    if ( !((*__ctype_b_loc ())[(int) (((int)inputString[0]))] & (unsigned short int) _ISdigit))
    {
...
# 293 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c"
NodePtrVec *NodePtrVec_new( int initialSize )
{
...
_Bool NodePtrVec_findReverse( NodePtrVec *vector, Node *node )
{
    ...
    if ( !vector || !vector->vector || !node ) return 0;
...
# 453 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c"
void NodePtrVec_appendVectors ( NodePtrVec *first, NodePtrVec *second, _Bool keepFirst )
{
    int i;
...
# 479 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c"
NodeVecVec *NodeVecVec_new( int initialSize )
{
...
_Bool NodeVecVec_insert( NodeVecVec *vector, NodePtrVec *path )
{
    int current;
    int max;
    NodePtrVec *copy = NodePtrVec_copy(path,0);


    if ( !vector || !path || !copy ) return 0;
