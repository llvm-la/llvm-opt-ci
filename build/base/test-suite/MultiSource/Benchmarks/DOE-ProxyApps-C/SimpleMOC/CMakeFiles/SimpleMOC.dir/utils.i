# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/utils.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/utils.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/utils.c" 2


float urand(void)
{
 return (float)glibc_compat_rand() / (float)2147483647;
}
...
float nrand(float mean, float sigma)
{
 ...
 float x = sqrt( -2 * log(rand1) ) * cos( 2 * 3.14159265358979323846 * rand2);
...
double get_time(void)
{
# 91 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/utils.c"
 time_t time;
 time = clock();
