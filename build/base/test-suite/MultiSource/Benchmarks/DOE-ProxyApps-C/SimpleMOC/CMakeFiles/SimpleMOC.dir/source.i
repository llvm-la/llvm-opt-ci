# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/source.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/source.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/source.c" 2
 ...
 *nbytes += n_xs_regions * sizeof(float **);
 ...
 float ** s_matrix_ptrs = (float **) malloc( n_xs_regions * I.n_egroups
   * sizeof(float *));
 *nbytes += n_xs_regions * sizeof(float **);
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/source.c"
...
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/source.c"
 ...
 *nbytes += I.n_source_regions_per_node * I.fai * I.n_egroups
 ...
 for( long i = 0; i < I.n_source_regions_per_node; i++)
  for( int k = 0; k < I.n_egroups; k++)
   sigT[i][k] = urand();
# 185 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/source.c"
 for( long i = 0; i < I.n_source_regions_per_node; i++ )
 {
  long idx;
  if( i == 0 )
   ...
   idx = glibc_compat_rand() % n_xs_regions;
