# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/XSBench/Materials.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/XSBench/Materials.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/XSBench/Materials.c" 2
...
# 98 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/XSBench/Materials.c"
 return mats;
}
...
# 120 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/XSBench/Materials.c"
 return concs;
}
...
double ** load_concs_v( int * num_nucs )
{
 ...
 for( int i = 0; i < 12; i++ )
  for( int j = 0; j < num_nucs[i]; j++ )
   concs[i][j] = rn_v();
# 142 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/XSBench/Materials.c"
 return concs;
}
...
int pick_mat( unsigned long * seed )
{
# 156 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/XSBench/Materials.c"
 double dist[12];
 dist[0] = 0.140;
 dist[1] = 0.052;
 dist[2] = 0.275;
