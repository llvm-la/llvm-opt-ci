# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2





# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/defines.h" 1
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/box.h" 1
...
typedef struct {
  ...
  int ghosts;
  int pencil,plane,volume;
  int numGrids;
  int boundaryCondition[27];



  double ** __restrict__ grids;
  uint64_t * __restrict__ RedBlack_64bMask;
  double * __restrict__ RedBlack_FP[2];
  uint8_t * __restrict__ RedBlack_4bMask;
} box_type;
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/mg.h" 1
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/mg.h"
typedef struct {




  int isFace,isEdge,isCorner;
  struct {int i, j, k;}dim;
  struct {int box, i, j, k, pencil, plane;double * __restrict__ ptr;}read,write;
...
typedef struct {
  ...
  int bufferCopy_Pack_Start, bufferCopy_Pack_End;
  int bufferCopy_Local_Start, bufferCopy_Local_End;
  int bufferCopy_Unpack_Start,bufferCopy_Unpack_End;


  struct {int i, j, k;}dim;
  struct {int i, j, k;}ranks_in;
  struct {int i, j, k;}subdomains_per_rank_in;
  struct {int i, j, k;}subdomains_in;
  struct {int i, j, k;}boundary_condition;
  int rank;
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/operators.h" 1
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/timer.h" 1
...
uint64_t CycleTime();
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c" 2
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
static inline void __axpy(double * z, double alpha, double * x, double beta, double * y, int n){
  int nn;
  for(nn=0;nn<n;nn++){
...
void TelescopingCABiCGStab(domain_type * domain, int level, int e_id, int R_id, double a, double b, double desired_reduction_in_norm){
  ...
  double temp2[4*4 +1];
  double temp3[4*4 +1];
  double Tp[4*4 +1][4*4 +1];
  double Tpp[4*4 +1][4*4 +1];
  double aj[4*4 +1];
  double cj[4*4 +1];
  double ej[4*4 +1];
  double Tpaj[4*4 +1];
  double Tpcj[4*4 +1];
  double Tppaj[4*4 +1];
  double G[4*4 +1][4*4 +1];
  double g[4*4 +1];
  double Gg[(4*4 +1)*(4*4 +2)];
  int PRrt[4*4 +2];
  ...
  residual(domain,level,12,e_id,R_id,a,b);
  scale_grid(domain,level,13,1.0,12);
  scale_grid(domain,level,14,1.0,12);
  double norm_of_rt = norm(domain,level,12);



  if(norm_of_rt == 0.0){BiCGStabConverged=1;}
  delta = dot(domain,level,13,12);
  if(delta==0.0){BiCGStabConverged=1;}
  ...
  while( (m<mMax) && (!BiCGStabFailed) && (!BiCGStabConverged) ){
    ...
    for(i=0;i<4*__ca_krylov_s+1;i++)for(j=0;j<4*__ca_krylov_s+1;j++) Tp[i][j]=0;
    for(i=0;i<4*__ca_krylov_s+1;i++)for(j=0;j<4*__ca_krylov_s+1;j++)Tpp[i][j]=0;
    for(i= 0;i<2*__ca_krylov_s ;i++){ Tp[i+1][i]=1;}
    ...
    for(i=0;i<4*__ca_krylov_s+1;i++){PRrt[ i] = 15 +i;}
                                     PRrt[4*__ca_krylov_s+1] = 12;
    int *P = PRrt+ 0;
    int *R = PRrt+2*__ca_krylov_s+1;



    scale_grid(domain,level,P[0],1.0,14);
    for(n=1;n<2*__ca_krylov_s+1;n++){

      mul_grids(domain,level,10,1.0,4,P[n-1]);
      apply_op(domain,level,P[n],10,a,b);



    }
    scale_grid(domain,level,R[0],1.0,13);
    for(n=1;n<2*__ca_krylov_s;n++){

      mul_grids(domain,level,10,1.0,4,R[n-1]);
      apply_op(domain,level,R[n],10,a,b);
    ...
    domain->CAKrylov_formations_of_G++;
    matmul_grids(domain,level,Gg,PRrt,PRrt,4*__ca_krylov_s+1,4*__ca_krylov_s+2,1);
    for(i=0,k=0;i<4*__ca_krylov_s+1;i++){
    for(j=0 ;j<4*__ca_krylov_s+1;j++){G[i][j] = Gg[k++];}
                                         g[i] = Gg[k++];
    }

    for(i=0;i<4*__ca_krylov_s+1;i++)aj[i]=0.0;aj[ 0]=1.0;
    for(i=0;i<4*__ca_krylov_s+1;i++)cj[i]=0.0;cj[2*__ca_krylov_s+1]=1.0;
    for(i=0;i<4*__ca_krylov_s+1;i++)ej[i]=0.0;

    for(n=0;n<__ca_krylov_s;n++){
      domain->Krylov_iterations++;
      {int r,c;double sum;for(r=0;r<(4*__ca_krylov_s+1);r++){sum=0.0;for(c=0;c<(4*__ca_krylov_s+1);c++){sum+=(Tp)[r][c]*(aj)[c];}(Tpaj)[r]=(1.0)*sum+(0.0)*(Tpaj)[r];}};
      {int r,c;double sum;for(r=0;r<(4*__ca_krylov_s+1);r++){sum=0.0;for(c=0;c<(4*__ca_krylov_s+1);c++){sum+=(Tp)[r][c]*(cj)[c];}(Tpcj)[r]=(1.0)*sum+(0.0)*(Tpcj)[r];}};
      {int r,c;double sum;for(r=0;r<(4*__ca_krylov_s+1);r++){sum=0.0;for(c=0;c<(4*__ca_krylov_s+1);c++){sum+=(Tpp)[r][c]*(aj)[c];}(Tppaj)[r]=(1.0)*sum+(0.0)*(Tppaj)[r];}};
                       g_dot_Tpaj = __dot(g,Tpaj,4*__ca_krylov_s+1);
      if(g_dot_Tpaj == 0.0){
      ...
      if(__builtin_isinf_sign (alpha)){



        BiCGStabFailed=1;break;
      }
# 189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
      __axpy(temp1, 1.0, Tpcj,-alpha,Tppaj,4*__ca_krylov_s+1);
      {int r,c;double sum;for(r=0;r<(4*__ca_krylov_s+1);r++){sum=0.0;for(c=0;c<(4*__ca_krylov_s+1);c++){sum+=(G)[r][c]*(temp1)[c];}(temp2)[r]=(1.0)*sum+(0.0)*(temp2)[r];}};
      __axpy(temp3, 1.0, cj,-alpha, Tpaj,4*__ca_krylov_s+1);
             omega_numerator = __dot(temp3,temp2,4*__ca_krylov_s+1);
           omega_denominator = __dot(temp1,temp2,4*__ca_krylov_s+1);
      ...
      __axpy( ej,1.0,ej, alpha, aj,4*__ca_krylov_s+1);


      __axpy(temp1, 1.0, cj,-alpha, Tpaj,4*__ca_krylov_s+1);
      {int r,c;double sum;for(r=0;r<(4*__ca_krylov_s+1);r++){sum=0.0;for(c=0;c<(4*__ca_krylov_s+1);c++){sum+=(G)[r][c]*(temp1)[c];}(temp2)[r]=(1.0)*sum+(0.0)*(temp2)[r];}};
                                 L2_norm_of_s = __dot(temp1,temp2,4*__ca_krylov_s+1);
      if(L2_norm_of_s<0)L2_norm_of_s=0;else L2_norm_of_s=sqrt(L2_norm_of_s);



      if(L2_norm_of_s < desired_reduction_in_norm*L2_norm_of_rt){BiCGStabConverged=1;break;}
      ...
      __axpy( ej,1.0,ej, omega, cj,4*__ca_krylov_s+1);
      __axpy( ej,1.0,ej,-omega*alpha, Tpaj,4*__ca_krylov_s+1);
      __axpy( cj,1.0,cj, -omega, Tpcj,4*__ca_krylov_s+1);
      __axpy( cj,1.0,cj, -alpha, Tpaj,4*__ca_krylov_s+1);
      __axpy( cj,1.0,cj, omega*alpha,Tppaj,4*__ca_krylov_s+1);



      {int r,c;double sum;for(r=0;r<(4*__ca_krylov_s+1);r++){sum=0.0;for(c=0;c<(4*__ca_krylov_s+1);c++){sum+=(G)[r][c]*(cj)[c];}(temp1)[r]=(1.0)*sum+(0.0)*(temp1)[r];}};
                                       cj_dot_Gcj = __dot(cj,temp1,4*__ca_krylov_s+1);
      L2_norm_of_residual = 0.0;if(cj_dot_Gcj>0)L2_norm_of_residual=sqrt(cj_dot_Gcj);



      if(L2_norm_of_residual < desired_reduction_in_norm*L2_norm_of_rt){BiCGStabConverged=1;break;}


      delta_next = __dot( g,cj,4*__ca_krylov_s+1);
# 253 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
      if(__builtin_isinf_sign (delta_next)){BiCGStabFailed =1;break;}
      if(delta_next ==0.0){BiCGStabFailed =1;break;}
      if(omega ==0.0){BiCGStabFailed =1;break;}
      ...
      if(__builtin_isinf_sign (beta) ){BiCGStabFailed =1;break;}
      if(beta == 0.0){BiCGStabFailed =1;break;}
      __axpy( aj,1.0,cj, beta, aj,4*__ca_krylov_s+1);
      __axpy( aj,1.0,aj, -omega*beta, Tpaj,4*__ca_krylov_s+1);
      delta = delta_next;

    }


    for(i=0;i<4*__ca_krylov_s+1;i++){add_grids(domain,level,e_id,1.0,e_id,ej[i],PRrt[i]);}
    if(!BiCGStabFailed && !BiCGStabConverged){
                                     add_grids(domain,level, 14,0.0, 14,aj[0],PRrt[0]);
    for(i=1;i<4*__ca_krylov_s+1;i++){add_grids(domain,level, 14,1.0, 14,aj[i],PRrt[i]);}
                                     add_grids(domain,level, 13,0.0, 13,cj[0],PRrt[0]);
    for(i=1;i<4*__ca_krylov_s+1;i++){add_grids(domain,level, 13,1.0, 13,cj[i],PRrt[i]);}
    }
    m+=__ca_krylov_s;
    __ca_krylov_s*=2;if(__ca_krylov_s>4)__ca_krylov_s=4;
  }


  mul_grids(domain,level,e_id,1.0,4,e_id);
...
# 421 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
      __axpy(temp1, 1.0, Tpcj,-alpha,Tppaj,4*__ca_krylov_s+1);
      {int r,c;double sum;for(r=0;r<(4*__ca_krylov_s+1);r++){sum=0.0;for(c=0;c<(4*__ca_krylov_s+1);c++){sum+=(G)[r][c]*(temp1)[c];}(temp2)[r]=(1.0)*sum+(0.0)*(temp2)[r];}};
      __axpy(temp3, 1.0, cj,-alpha, Tpaj,4*__ca_krylov_s+1);
             omega_numerator = __dot(temp3,temp2,4*__ca_krylov_s+1);
      ...
      delta_next = __dot( g,cj,4*__ca_krylov_s+1);
# 485 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
      if(__builtin_isinf_sign (delta_next)){BiCGStabFailed =1;break;}
      if(delta_next ==0.0){BiCGStabFailed =1;break;}
      if(omega ==0.0){BiCGStabFailed =1;break;}
      beta = (delta_next/delta)*(alpha/omega);
...
void BiCGStab(domain_type * domain, int level, int x_id, int R_id, double a, double b, double desired_reduction_in_norm){
  ...
  int BiCGStabFailed = 0;
  int BiCGStabConverged = 0;
  residual(domain,level,12,x_id,R_id,a,b);
  scale_grid(domain,level,13,1.0,12);
  scale_grid(domain,level,14,1.0,12);
  double r_dot_r0 = dot(domain,level,13,12);
  double norm_of_r0 = norm(domain,level,13);
  ...
  while( (j<jMax) && (!BiCGStabFailed) && (!BiCGStabConverged) ){
    ...
    mul_grids(domain,level,10,1.0,4,14);
    apply_op(domain,level,16,10,a,b);



    double Ap_dot_r0 = dot(domain,level,16,12);
    if(Ap_dot_r0 == 0.0){BiCGStabFailed=1;break;}
    double alpha = r_dot_r0 / Ap_dot_r0;
    if(__builtin_isinf_sign (alpha)){BiCGStabFailed=1;break;}
    add_grids(domain,level,x_id,1.0,x_id, alpha,14 );
    add_grids(domain,level,15 ,1.0,13 ,-alpha,16);
    double norm_of_s = norm(domain,level,15);
    if(norm_of_s == 0.0){BiCGStabConverged=1;break;}
    if(norm_of_s < desired_reduction_in_norm*norm_of_r0){BiCGStabConverged=1;break;}

    mul_grids(domain,level,10,1.0,4,15);
    apply_op(domain,level,17,10,a,b);



    double As_dot_As = dot(domain,level,17,17);
    double As_dot_s = dot(domain,level,17, 15);
    if(As_dot_As == 0.0){BiCGStabConverged=1;break;}
    double omega = As_dot_s / As_dot_As;
    if(omega == 0.0){BiCGStabFailed=1;break;}
    if(__builtin_isinf_sign (omega)){BiCGStabFailed=1;break;}
    add_grids(domain,level, x_id, 1.0,x_id, omega,15 );
    add_grids(domain,level,13 , 1.0,15 ,-omega,17 );
    double norm_of_r = norm(domain,level,13);
    ...
    double r_dot_r0_new = dot(domain,level,13,12);
    if(r_dot_r0_new == 0.0){BiCGStabFailed=1;break;}
    double beta = (r_dot_r0_new/r_dot_r0) * (alpha/omega);
    if(__builtin_isinf_sign (beta)){BiCGStabFailed=1;break;}
    add_grids(domain,level,10,1.0,14,-omega,16 );
    add_grids(domain,level,14 ,1.0,13, beta,10);
    r_dot_r0 = r_dot_r0_new;
  }

    mul_grids(domain,level,x_id,1.0,4,x_id);
...
void CACG(domain_type * domain, int level, int e_id, int R_id, double a, double b, double desired_reduction_in_norm){
  ...
  double ej[2*4 +1];
  double Tpaj[2*4 +1];
  double Tp[2*4 +1][2*4 +1];
  double G[2*4 +1][2*4 +1];
  double Gbuf[(2*4 +1)*(2*4 +1)];
  int PR[2*4 +1];
  int *P = PR+ 0;
  int *R = PR+4 +1;
  ...
  scale_grid(domain,level,13,1.0,12);
  scale_grid(domain,level,14,1.0,12);
  double norm_of_r0 = norm(domain,level,12);
  if(norm_of_r0 == 0.0){CGConverged=1;}

  delta = dot(domain,level,13,12);
  if(delta==0.0){CGConverged=1;}
  L2_norm_of_r0 = sqrt(delta);




  for(i=0;i<2*4 +1;i++)for(j=0;j<2*4 +1;j++) Tp[i][j]=0;
  for(i= 0;i< 4 ;i++){ Tp[i+1][i]=1;}
  for(i=4 +1;i<2*4 ;i++){ Tp[i+1][i]=1;}

  for(i=0;i<2*4 +1;i++){PR[i] = 15 +i;}
  ...
  while( (m<mMax) && (!CGFailed) && (!CGConverged) ){
    ...
    scale_grid(domain,level,P[0],1.0,14);
    for(n=1;n<4 +1;n++){
      apply_op(domain,level,P[n],P[n-1],a,b);
    }
    scale_grid(domain,level,R[0],1.0,13);
    for(n=1;n<4;n++){
      apply_op(domain,level,R[n],R[n-1],a,b);
    }



    domain->CAKrylov_formations_of_G++;
    matmul_grids(domain,level,Gbuf,PR,PR,2*4 +1,2*4 +1,1);
    for(i=0,k=0;i<2*4 +1;i++){
    for(j=0 ;j<2*4 +1;j++){G[i][j] = Gbuf[k++];}
    }


    for(i=0;i<2*4 +1;i++)aj[i]=0.0;aj[ 0]=1.0;
    for(i=0;i<2*4 +1;i++)cj[i]=0.0;cj[4 +1]=1.0;
    for(i=0;i<2*4 +1;i++)ej[i]=0.0;

    for(n=0;n<4;n++){
      domain->Krylov_iterations++;
      {int r,c;double sum;for(r=0;r<(2*4 +1);r++){sum=0.0;for(c=0;c<(2*4 +1);c++){sum+=(Tp)[r][c]*(aj)[c];}(Tpaj)[r]=(1.0)*sum+(0.0)*(Tpaj)[r];}};
      {int r,c;double sum;for(r=0;r<(2*4 +1);r++){sum=0.0;for(c=0;c<(2*4 +1);c++){sum+=(G)[r][c]*(Tpaj)[c];}(temp1)[r]=(1.0)*sum+(0.0)*(temp1)[r];}};
      {int r,c;double sum;for(r=0;r<(2*4 +1);r++){sum=0.0;for(c=0;c<(2*4 +1);c++){sum+=(G)[r][c]*(cj)[c];}(temp2)[r]=(1.0)*sum+(0.0)*(temp2)[r];}};
           aj_dot_GTpaj = __dot(aj,temp1,2*4 +1);
             cj_dot_Gcj = __dot(cj,temp2,2*4 +1);

      if(aj_dot_GTpaj == 0.0){
        CGFailed=1;break;
      }
      alpha = cj_dot_Gcj / aj_dot_GTpaj;
      if(__builtin_isinf_sign (alpha)){
        CGFailed=1;break;
      }
      __axpy( ej,1.0,ej, alpha, aj,2*4 +1);
      __axpy( cj,1.0,cj, -alpha, Tpaj,2*4 +1);
      {int r,c;double sum;for(r=0;r<(2*4 +1);r++){sum=0.0;for(c=0;c<(2*4 +1);c++){sum+=(G)[r][c]*(cj)[c];}(temp2)[r]=(1.0)*sum+(0.0)*(temp2)[r];}};
         cj_dot_Gcj_new = __dot(cj,temp2,2*4 +1);

      L2_norm_of_residual = 0.0;if(cj_dot_Gcj_new>0)L2_norm_of_residual=sqrt(cj_dot_Gcj_new);
      if(L2_norm_of_residual < desired_reduction_in_norm*L2_norm_of_r0){CGConverged=1;break;}
      if(cj_dot_Gcj_new == 0.0){
        CGFailed=1;break;
      }
      beta = cj_dot_Gcj_new / cj_dot_Gcj;
      if(__builtin_isinf_sign (beta)){CGFailed=1;break;}
      if(beta == 0.0){CGFailed=1;break;}
      __axpy( aj,1.0,cj, beta, aj,2*4 +1);

    }


    for(i=0;i<2*4 +1;i++){add_grids(domain,level,e_id,1.0,e_id,ej[i],PR[i]);}
    if(!CGFailed && !CGConverged){
                                     add_grids(domain,level, 14,0.0, 14,aj[0],PR[0]);
    for(i=1;i<2*4 +1;i++){add_grids(domain,level, 14,1.0, 14,aj[i],PR[i]);}
                                     add_grids(domain,level, 13,0.0, 13,cj[0],PR[0]);
    for(i=1;i<2*4 +1;i++){add_grids(domain,level, 13,1.0, 13,cj[i],PR[i]);}
    }
                              m+=4;
...
void CG(domain_type * domain, int level, int x_id, int R_id, double a, double b, double desired_reduction_in_norm){
  ...
  double norm_of_r0 = norm(domain,level,13);
  if(norm_of_r0 == 0.0){CGConverged=1;}
  double r_dot_r = dot(domain,level,13,13);
  while( (j<jMax) && (!CGFailed) && (!CGConverged) ){
    j++;domain->Krylov_iterations++;
    apply_op(domain,level,16,14,a,b);
    double Ap_dot_p = dot(domain,level,16,14);
    if(Ap_dot_p == 0.0){CGFailed=1;break;}
    double alpha = r_dot_r / Ap_dot_p;
    if(__builtin_isinf_sign (alpha)){CGFailed=1;break;}
    add_grids(domain,level,x_id,1.0,x_id, alpha,14 );
    add_grids(domain,level,13 ,1.0,13 ,-alpha,16);
    double norm_of_r = norm(domain,level,13);
    if(norm_of_r == 0.0){CGConverged=1;break;}
    if(norm_of_r < desired_reduction_in_norm*norm_of_r0){CGConverged=1;break;}
    double r_dot_r_new = dot(domain,level,13,13);
    if(r_dot_r_new == 0.0){CGFailed=1;break;}
    double beta = (r_dot_r_new/r_dot_r);
    if(__builtin_isinf_sign (beta)){CGFailed=1;break;}
    add_grids(domain,level,14,1.0,13,beta,14 );
    r_dot_r = r_dot_r_new;
  }
}
...
# 765 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
    int s,numSmoothsBottom=48;
    for(s=0;s<numSmoothsBottom;s+=4)smooth(domain,level,e_id,R_id,a,b);

}

int IterativeSolver_NumGrids(){
# 781 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniGMG/solver.c"
  return(0);
}
