# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/init.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/init.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/init.c" 2
...
int * generate_n_poles( Input input )
{
 ...
 for( int i = 0; i < total_resonances; i++ )
  R[glibc_compat_rand() % input.n_nuclides]++;
...
Pole ** generate_poles( Input input, int * n_poles )
{
 ...
 for( int i = 0; i < input.n_nuclides; i++ )
  ...
  {
   R[i][j].MP_EA = f*((double) glibc_compat_rand() / 2147483647 + (double) glibc_compat_rand() / 2147483647 * (__extension__ 1.0iF));
   R[i][j].MP_RT = f*(double) glibc_compat_rand() / 2147483647 + (double) glibc_compat_rand() / 2147483647 * (__extension__ 1.0iF);
   R[i][j].MP_RA = f*(double) glibc_compat_rand() / 2147483647 + (double) glibc_compat_rand() / 2147483647 * (__extension__ 1.0iF);
   R[i][j].MP_RF = f*(double) glibc_compat_rand() / 2147483647 + (double) glibc_compat_rand() / 2147483647 * (__extension__ 1.0iF);
   R[i][j].l_value = glibc_compat_rand() % input.numL;
  }
...
Window ** generate_window_params( Input input, int * n_windows, int * n_poles )
{
 ...
 for( int i = 0; i < input.n_nuclides; i++ )
 {
  ...
  {
   R[i][j].T = (double) glibc_compat_rand() / 2147483647;
   R[i][j].A = (double) glibc_compat_rand() / 2147483647;
   R[i][j].F = (double) glibc_compat_rand() / 2147483647;
   R[i][j].start = ctr;
...
double ** generate_pseudo_K0RS( Input input )
{
 ...
 for( int i = 0; i < input.n_nuclides; i++)
  for( int j = 0; j < input.numL; j++ )
   R[i][j] = (double) glibc_compat_rand() / 2147483647;
