# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/material.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/material.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/material.c" 2
...
# 106 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/material.c"
 return mats;
}
...
double ** load_concs( int * num_nucs )
{
 ...
 for( int i = 0; i < 12; i++ )
  for( int j = 0; j < num_nucs[i]; j++ )
   concs[i][j] = (double) glibc_compat_rand() / (double) 2147483647;
# 128 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/material.c"
 return concs;
}
...
int pick_mat( unsigned long * seed )
{
# 142 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/RSBench/material.c"
 double dist[12];
 dist[0] = 0.140;
 dist[1] = 0.052;
 dist[2] = 0.275;
