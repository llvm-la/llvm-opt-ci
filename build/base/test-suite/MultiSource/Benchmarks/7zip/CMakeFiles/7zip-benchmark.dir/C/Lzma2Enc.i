# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.c" 2
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.c"
typedef struct
{
  CLzmaEncHandle enc;
  UInt64 srcPos;
...
static SRes Lzma2EncInt_Init(CLzma2EncInt *p, const CLzma2EncProps *props)
{
  Byte propsEncoded[5];
  SizeT propsSize = 5;
  { int __result__ = (LzmaEnc_SetProps(p->enc, &props->lzmaProps)); if (__result__ != 0) return __result__; };
  { int __result__ = (LzmaEnc_WriteProperties(p->enc, propsEncoded, &propsSize)); if (__result__ != 0) return __result__; };
  p->srcPos = 0;
    ...
    size_t *packSizeRes, ISeqOutStream *outStream)
{
  ...
  *packSizeRes = 0;
  ...
  res = LzmaEnc_CodeOneMemBlock(p->enc, p->needInitState,
      outBuf + lzHeaderSize, &packSize, (1 << 16), &unpackSize);
  ...
  if (useCopyBlock)
  {
    ...
    while (unpackSize > 0)
    {
      ...
      if (packSizeLimit - destPos < u + 3)
        return 7;
      outBuf[destPos++] = (Byte)(p->srcPos == 0 ? 1 : 2);
  ...
  }
  {
    ...
    outBuf[destPos++] = (Byte)((1 << 7) | (mode << 5) | ((u >> 16) & 0x1F));
  ...
  ISeqOutStream *outStream, ISeqInStream *inStream, ICompressProgress *progress)
{
  ...
  {
    mainEncoder->outBuf = (Byte *)(mainEncoder->alloc)->Alloc((mainEncoder->alloc), ((1 << 16) + 16));
    if (mainEncoder->outBuf == 0)
      return 2;
  }
  { int __result__ = (Lzma2EncInt_Init(p, &mainEncoder->props)); if (__result__ != 0) return __result__; };
  { int __result__ = (LzmaEnc_PrepareForLzma2(p->enc, inStream, (1 << 21), mainEncoder->alloc, mainEncoder->allocBig)); if (__result__ != 0) return __result__; };
  ...
  SRes res = 0;
  {
    ...
    *destSize = 0;
    ...
    if (srcSize != 0)
    {
      ...
      { int __result__ = (LzmaEnc_MemPrepare(p->enc, src, srcSize, (1 << 21), mainEncoder->alloc, mainEncoder->allocBig)); if (__result__ != 0) return __result__; };
      ...
      while (p->srcPos < srcSize)
      {
        ...
        *destSize += packSize;
        ...
        if (MtProgress_Set(&mainEncoder->mtCoder.mtProgress, index, p->srcPos, *destSize) != 0)
        {
          res = 10;
          break;
        }
...
void Lzma2Enc_Destroy(CLzma2EncHandle pp)
{
  ...
  (p->alloc)->Free((p->alloc), p->outBuf);
  (p->alloc)->Free((p->alloc), pp);
}
