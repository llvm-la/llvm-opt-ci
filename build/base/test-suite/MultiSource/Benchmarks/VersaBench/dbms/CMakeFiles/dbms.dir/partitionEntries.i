# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c" 2
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c"
...
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c" 2
...
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c" 2
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c" 2
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c" 2
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c" 2
...
void partitionEntries( IndexEntry *I,
                       Int fan,
                       IndexEntry **A,
                       IndexEntry **B )
{
    ...
    ((void) (0));
    ((void) (0));
# 100 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c"
    *A = I;
    *B = I->next;
    ...
    for ( entry1 = I; entry1 != ((void*)0); entry1 = entry1->next ) {
        for ( entry2 = entry1->next; entry2 != ((void*)0); entry2 = entry2->next ) {
            IndexKey tempKey;
            Float tempVolume;
...
# 137 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c"
    currentEntry = I;
    ...
    sizeOfGroupA = 1;
    sizeOfGroupB = 1;
# 201 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c"
    tempA = *A;
    tempB = *B;
    while ( I != ((void*)0) ) {
        ...
        if ( sizeOfGroupA < fan && sizeOfGroupB < fan ) {
            ...
            errorMessage( "too many entries to partition", 0 );
            errorMessage( name, 1 );
