# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c" 2
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c"
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c" 2
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c" 2
...
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c" 2
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c" 2
               ...
               FILE **metricsFile )
{
    ...
    ((void) (0));
    ((void) (0));
# 85 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/openFiles.c"
    inputFileName = ((void*)0);
    outputFileName = ((void*)0);
    metricsFileName = ((void*)0);
    if ( argc > 1 ) {
        Int i;
            ...
            if ( strlen( argv[ i ] ) == 2 && argv[ i ][ 0 ] == '-' ) {
                if ( argv[ i ][ 1 ] == 'i' ) {
                    if ( i + 1 < argc ) {
                        ...
                        errorMessage( "missing argument for -i", 0 );
                        errorMessage( name, 1 );
                    ...
                    if ( i + 1 < argc ) {
                        ...
                        errorMessage( "missing argument for -o", 0 );
                        errorMessage( name, 1 );
                    ...
                    if ( i + 1 < argc ) {
                        ...
                        errorMessage( "missing argument for -m", 0 );
                        errorMessage( name, 1 );
                ...
                errorMessage( "incorrect format - unknown option", 0 );
                errorMessage( name, 1 );
    ...
    if ( inputFileName == ((void*)0) ) {
        *inputFile = stdin;
    }
    else {
        *inputFile = fopen( inputFileName, "r" );
        if ( *inputFile == ((void*)0) ) {
            errorMessage( "error opening input file", 0 );
            errorMessage( name, 1 );
    ...
    if ( outputFileName == ((void*)0) ) {
        ...
        *outputFile = fopen( outputFileName, "w" );
        if ( *outputFile == ((void*)0) ) {
            errorMessage( "error opening output file", 0 );
            errorMessage( name, 1 );
    ...
    if ( metricsFileName == ((void*)0) ) {
        *metricsFile = stderr;
    }
    else {
        *metricsFile = fopen( metricsFileName, "w" );
        if ( *metricsFile == ((void*)0) ) {
            errorMessage( "error opening metrics file", 0 );
            errorMessage( name, 1 );
