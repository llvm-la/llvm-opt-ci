# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c"
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2
...
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c" 2

Int getInsertCommand( FILE *file,
                      DataObject **dataObject )
{
    ...
    ((void) (0));
    ((void) (0));
# 91 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c"
    ...
    if ( returnCode == 0 ) {
        ...
        errorMessage( "unknown data object type", 0 );
        errorMessage( name, 1 );
        return ( 1 );
    }
    else if ( returnCode == 3) {
        errorMessage( "improper format - type must be an integer", 0 );
        errorMessage( name, 1 );
        return ( 1 );
    }
...
# 154 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c"
    for ( i = 0; i < 8; i++ ) {
        Float temp;
        ...
        if ( returnCode == 0 ) {
            ...
            errorMessage( "improper format - early EOI", 0 );
            errorMessage( name, 1 );
            (*dataObject)->attributes[ i ].value.key = -3.40282347e38;
            return ( 2 );
        }
        else if ( returnCode == 2 ) {
...
# 184 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getInsertCommand.c"
    for ( i = 8; i < numberOfAttributes; i++ ) {
        Char *temp;
        ...
        if ( returnCode == 0 ) {
            ...
            errorMessage( "improper format - early EOI", 0 );
            errorMessage( name, 1 );
            (*dataObject)->attributes[ i ].value.nonKey = ((void*)0);
            return ( 2 );
        }
        else if ( returnCode == 1 ) {
            errorMessage( "allocation failure for non-key attribute", 0 );
            errorMessage( name, 1 );
            (*dataObject)->attributes[ i ].value.nonKey = ((void*)0);
            return ( 4 );
        }
