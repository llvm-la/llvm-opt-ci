# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c" 2
...
void updateMetricsData( Metrics *metrics )
{
    Time temp;
    ...
    ((void) (0));
    ((void) (0));
# 65 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c"
...
# 92 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/updateMetricsData.c"
    temp = getTime() - commandMetric->lastTimeMark;

    if ( temp < 0 ) {
        errorMessage( "lastTimeMark doesn't seem to be set", 0 );
        errorMessage( name, 1 );
        flushErrorMessage();
    }
    else {
