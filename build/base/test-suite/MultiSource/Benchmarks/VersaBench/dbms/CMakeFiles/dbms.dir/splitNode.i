# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c" 2
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c"
...
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c" 2
...
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c" 2
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c" 2
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c" 2
...
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c" 2
...
Int splitNode( IndexNode *nodeToSplit,
               IndexEntry *entry,
               Int fan,
               IndexEntry **splitEntry )
{
    IndexEntry *listOfEntries;
    IndexNode *splitNode;
    ...
    ((void) (0));
    ((void) (0));
# 82 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.c"
    *splitEntry = createIndexEntry();
    if ( *splitEntry == ((void*)0) ) {
        errorMessage( "allocation failure - split entry", 0 );
        errorMessage( name, 1 );
        return ( 1 );
    }
    else {
        ...
        if ( splitNode == ((void*)0) ) {
            ...
            errorMessage( "allocation failure - sibling node", 0 );
            errorMessage( name, 1 );
            return ( 1 );
        }
    }
    ...
    nodeToSplit->entries = ((void*)0);
    splitNode->entries = ((void*)0);




    partitionEntries( listOfEntries,
                      fan,
                      &(nodeToSplit->entries),
                      &(splitNode->entries) );
