# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c" 2
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c"
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c" 2
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c"
void keyUnion( IndexKey *A,
               IndexKey *B,
               IndexKey *U )
{
    ...
    U->lower.T = ( (A->lower.T) < (B->lower.T) ? (A->lower.T) : (B->lower.T) );
    U->lower.X = ( (A->lower.X) < (B->lower.X) ? (A->lower.X) : (B->lower.X) );
    U->lower.Y = ( (A->lower.Y) < (B->lower.Y) ? (A->lower.Y) : (B->lower.Y) );
    U->lower.Z = ( (A->lower.Z) < (B->lower.Z) ? (A->lower.Z) : (B->lower.Z) );
    U->upper.T = ( (A->upper.T) > (B->upper.T) ? (A->upper.T) : (B->upper.T) );
    U->upper.X = ( (A->upper.X) > (B->upper.X) ? (A->upper.X) : (B->upper.X) );
    U->upper.Y = ( (A->upper.Y) > (B->upper.Y) ? (A->upper.Y) : (B->upper.Y) );
    U->upper.Z = ( (A->upper.Z) > (B->upper.Z) ? (A->upper.Z) : (B->upper.Z) );

    return;
}
# 110 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/keyUnion.c"
void keysUnion( IndexEntry *I,
                IndexKey *U )
{
    ...
    *U = I->key;
    for ( I = I->next; I != ((void*)0); I = I->next ) {
