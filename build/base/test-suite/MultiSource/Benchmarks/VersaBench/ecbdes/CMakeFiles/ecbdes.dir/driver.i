# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c" 2
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c"
...
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c" 2
...
# 192 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/des.h"
char *crypt();
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/ecbdes/driver.c" 2
...
static unsigned char key_data[34][8]={
...
static unsigned char plain_data[34][8]={
 {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
 {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF},
...
static unsigned char cipher_data[34][8]={
...
void driver(int size)
{
 int k,j;
 des_cblock out[34];
 des_key_schedule ks[34];


 for(k=0;k<34;k++)
 {
  if ((des_key_sched((des_cblock *) key_data[k],ks[k])) != 0) {
   printf("Key %d error!\n", k);
   exit(-1);
  }
 ...
 for (j=0;j<1000000;j++){
  for (k=0; k<size; k++){
   des_ecb_encrypt((des_cblock *)plain_data[k],(des_cblock *)out[k],ks[k],1);
  }
 }


 if (memcmp(cipher_data[0],out[0],8*size) != 0)
   {
