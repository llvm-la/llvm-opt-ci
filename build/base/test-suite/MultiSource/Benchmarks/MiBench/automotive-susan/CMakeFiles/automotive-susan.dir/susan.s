...
.LBB18_64:                              # %vector.body249
	...
	addi.d	$a4, $a4, 32
	bne	$a2, $a3, .LBB18_64
# %bb.65:                               # %middle.block254
	beq	$a2, $s3, .LBB18_137
.LBB18_66:                              # %.lr.ph39.i.preheader
	alsl.d	$a3, $a2, $s0, 2
	.p2align	4, , 16
.LBB18_67:                              # %.lr.ph39.i
                                        # =>This Inner Loop Header: Depth=1
...
.LBB18_72:                              # %.lr.ph.i99
	...
	addi.d	$a1, $a1, 4
	bnez	$a3, .LBB18_72
.LBB18_73:                              # %.lr.ph39.preheader.i107
	ori	$a3, $zero, 8
	sub.w	$a1, $a2, $a0
	bltu	$s5, $a3, .LBB18_76
...
.LBB18_76:
	move	$a2, $zero
.LBB18_77:                              # %.lr.ph39.i109.preheader
	alsl.d	$a3, $a2, $s0, 2
	.p2align	4, , 16
.LBB18_78:                              # %.lr.ph39.i109
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	sub.d	$a4, $a4, $a0
	slli.d	$a5, $a4, 8
...
.LBB18_80:                              # %.lr.ph.i114
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beqz	$a0, .LBB18_88
# %bb.81:                               # %.lr.ph.split.us.i.preheader
	addi.d	$a0, $s7, -2
	addi.d	$a1, $sp, 80
	lu12i.w	$a2, 15
	ori	$a2, $a2, 4095
...
.LBB18_85:                              # %vector.body209
	...
	addi.d	$a4, $a4, 32
	bne	$a2, $a3, .LBB18_85
# %bb.86:                               # %middle.block214
	beq	$a2, $s5, .LBB18_137
	b	.LBB18_77
.LBB18_87:
	move	$a1, $s4
	b	.LBB18_139
.LBB18_88:                              # %.lr.ph.split.i.preheader
	addi.d	$a0, $sp, 80
	ori	$a1, $zero, 7
	.p2align	4, , 16
.LBB18_89:                              # %.lr.ph.split.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, 4
	ld.w	$a3, $a0, 0
	ld.w	$a4, $a0, 32
...
.LBB18_90:                              # %vector.ph262
	...
	b	.LBB18_92
	.p2align	4, , 16
.LBB18_91:                              # %pred.store.continue299
                                        #   in Loop: Header=BB18_92 Depth=1
	addi.d	$a5, $a5, -16
	addi.d	$a6, $a6, 16
	beqz	$a5, .LBB18_124
.LBB18_92:                              # %vector.body267
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.93:                               # %pred.store.if
	...
	vpickve2gr.d	$a7, $vr11, 0
	stx.b	$zero, $s2, $a7
.LBB18_94:                              # %pred.store.continue
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 1
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_96
# %bb.95:                               # %pred.store.if270
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 1
	stx.b	$zero, $s2, $a7
.LBB18_96:                              # %pred.store.continue271
                                        #   in Loop: Header=BB18_92 Depth=1
	vsub.d	$vr10, $vr10, $vr0
...
# %bb.97:                               # %pred.store.if272
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_111
.LBB18_98:                              # %pred.store.continue275
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 4
	andi	$a7, $a7, 1
	vadd.d	$vr11, $vr10, $vr7
	beqz	$a7, .LBB18_112
.LBB18_99:                              # %pred.store.if276
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 0
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_113
.LBB18_100:                             # %pred.store.continue279
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 6
	andi	$a7, $a7, 1
	vadd.d	$vr11, $vr10, $vr6
	beqz	$a7, .LBB18_114
.LBB18_101:                             # %pred.store.if280
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 0
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_115
.LBB18_102:                             # %pred.store.continue283
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 8
	andi	$a7, $a7, 1
	vadd.d	$vr11, $vr10, $vr5
	beqz	$a7, .LBB18_116
.LBB18_103:                             # %pred.store.if284
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 0
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_117
.LBB18_104:                             # %pred.store.continue287
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 10
	andi	$a7, $a7, 1
	vadd.d	$vr11, $vr10, $vr4
	beqz	$a7, .LBB18_118
.LBB18_105:                             # %pred.store.if288
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 0
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_119
.LBB18_106:                             # %pred.store.continue291
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 12
	andi	$a7, $a7, 1
	vadd.d	$vr11, $vr10, $vr3
	beqz	$a7, .LBB18_120
.LBB18_107:                             # %pred.store.if292
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 0
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_121
.LBB18_108:                             # %pred.store.continue295
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 14
	andi	$a7, $a7, 1
	vadd.d	$vr10, $vr10, $vr2
	beqz	$a7, .LBB18_122
.LBB18_109:                             # %pred.store.if296
                                        #   in Loop: Header=BB18_92 Depth=1
	...
	b	.LBB18_123
	.p2align	4, , 16
.LBB18_110:                             # %pred.store.continue273
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 3
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_98
.LBB18_111:                             # %pred.store.if274
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr9, 4
	...
	vadd.d	$vr11, $vr10, $vr7
	bnez	$a7, .LBB18_99
.LBB18_112:                             # %pred.store.continue277
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 5
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_100
.LBB18_113:                             # %pred.store.if278
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr9, 6
	...
	vadd.d	$vr11, $vr10, $vr6
	bnez	$a7, .LBB18_101
.LBB18_114:                             # %pred.store.continue281
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 7
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_102
.LBB18_115:                             # %pred.store.if282
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr9, 8
	...
	vadd.d	$vr11, $vr10, $vr5
	bnez	$a7, .LBB18_103
.LBB18_116:                             # %pred.store.continue285
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 9
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_104
.LBB18_117:                             # %pred.store.if286
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr9, 10
	...
	vadd.d	$vr11, $vr10, $vr4
	bnez	$a7, .LBB18_105
.LBB18_118:                             # %pred.store.continue289
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 11
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_106
.LBB18_119:                             # %pred.store.if290
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr9, 12
	...
	vadd.d	$vr11, $vr10, $vr3
	bnez	$a7, .LBB18_107
.LBB18_120:                             # %pred.store.continue293
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 13
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_108
.LBB18_121:                             # %pred.store.if294
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr9, 14
	...
	vadd.d	$vr10, $vr10, $vr2
	bnez	$a7, .LBB18_109
.LBB18_122:                             # %pred.store.continue297
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.b	$a7, $vr9, 15
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_91
.LBB18_123:                             # %pred.store.if298
                                        #   in Loop: Header=BB18_92 Depth=1
	vpickve2gr.d	$a7, $vr10, 1
	stx.b	$zero, $s2, $a7
	b	.LBB18_91
.LBB18_124:                             # %middle.block301
	beq	$a3, $s3, .LBB18_137
# %bb.125:                              # %vec.epilog.iter.check
	beqz	$a4, .LBB18_138
.LBB18_126:                             # %vec.epilog.ph
	...
	b	.LBB18_128
	.p2align	4, , 16
.LBB18_127:                             # %pred.store.continue319
                                        #   in Loop: Header=BB18_128 Depth=1
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, 4
	beqz	$a3, .LBB18_136
.LBB18_128:                             # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vreplgr2vr.d	$vr3, $a0
	vadd.d	$vr5, $vr3, $vr1
	...
	vsub.d	$vr5, $vr5, $vr0
	beqz	$a4, .LBB18_130
# %bb.129:                              # %pred.store.if312
                                        #   in Loop: Header=BB18_128 Depth=1
	vpickve2gr.d	$a4, $vr5, 0
	stx.b	$zero, $s2, $a4
.LBB18_130:                             # %pred.store.continue313
                                        #   in Loop: Header=BB18_128 Depth=1
	vilvl.b	$vr4, $vr4, $vr4
	vilvl.h	$vr4, $vr4, $vr4
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_132
# %bb.131:                              # %pred.store.if314
                                        #   in Loop: Header=BB18_128 Depth=1
	vpickve2gr.d	$a4, $vr5, 1
	stx.b	$zero, $s2, $a4
.LBB18_132:                             # %pred.store.continue315
                                        #   in Loop: Header=BB18_128 Depth=1
	vsub.d	$vr3, $vr3, $vr0
...
# %bb.133:                              # %pred.store.if316
	...
	b	.LBB18_135
	.p2align	4, , 16
.LBB18_134:                             # %pred.store.continue317
                                        #   in Loop: Header=BB18_128 Depth=1
	vpickve2gr.w	$a4, $vr4, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_127
.LBB18_135:                             # %pred.store.if318
                                        #   in Loop: Header=BB18_128 Depth=1
	vpickve2gr.d	$a4, $vr3, 1
	stx.b	$zero, $s2, $a4
	b	.LBB18_127
.LBB18_136:                             # %vec.epilog.middle.block
	bne	$a2, $s3, .LBB18_139
.LBB18_137:                             # %int_to_uchar.exit
	ld.d	$a0, $fp, 16
	move	$a1, $s2
	move	$a2, $s7
	move	$a3, $s1
...
.LBB18_138:
	add.d	$a1, $s4, $a3
	move	$a2, $a3
.LBB18_139:                             # %vec.epilog.scalar.ph.preheader
	sub.d	$a0, $a1, $s4
	sub.d	$a2, $s3, $a2
	ori	$a3, $zero, 7
	b	.LBB18_141
	.p2align	4, , 16
.LBB18_140:                             #   in Loop: Header=BB18_141 Depth=1
	addi.d	$a1, $a1, 1
	addi.w	$a2, $a2, -1
	addi.d	$a0, $a0, 1
	beqz	$a2, .LBB18_137
.LBB18_141:                             # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a4, $a1, 0
	bltu	$a3, $a4, .LBB18_140
