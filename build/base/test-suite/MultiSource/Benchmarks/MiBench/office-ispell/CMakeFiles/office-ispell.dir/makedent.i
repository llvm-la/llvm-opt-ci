# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c" 2

static char Rcs_Id[] =
 "$Id$";
# 71 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
...
# 72 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c" 2
...
# 73 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c" 2
...
extern char * tgoto ();
extern char * tputs ();
# 74 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c" 2
...
# 75 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c" 2
 ...
 *p = 0;
    ...
    if (strtoichar (ibuf, lbuf, 100 * sizeof (ichar_t), 1)
      || ichartostr (lbuf, ibuf, lbuflen, 1))
 {
 (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", lbuf, 158, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c");
 return (-1);
 }
 ...
 if (!(hashheader.wordchars[(*ip)]))
     ...
     if (!(hashheader.boundarychars[(*ip)])
       || ip == ibuf || ip[1] == 0)
  {
  ...
  return -1;
    ...
    if (len > 100 - 1)
 {
 (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", lbuf, 188, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c");
 return (-1);
 }
...
# 387 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
int combinecaps (hdrp, newp)
   ...
   tdent;
    ...
    if ((oldp->mask[(32 / 32) - 1] & (((long) 3 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4))))
      == (((long) 1 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4))))
 {
...
static void forcevheader (hdrp, oldp, newp)
    ...
    if ((hdrp->mask[(32 / 32) - 1] & (((long) 3 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4)))) == ((long) 1 << (((32) - 6) + 2))
      && ((oldp->mask[(32 / 32) - 1] ^ newp->mask[(32 / 32) - 1]) & ((long) 1 << (((32) - 6) + 1))) == 0)
 return;
    else if ((hdrp->mask[(32 / 32) - 1] & (((long) 3 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4))))
      != (((long) 1 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4))))
 ...
 *oldp = *newp;
 ...
 if (((newp->mask[(32 / 32) - 1]) & ((long) 3 << (((32) - 6) + 2))) == ((long) 3 << (((32) - 6) + 2))
   && (hdrp->mask[(32 / 32) - 1] & (((long) 3 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4))))
     != (((long) 1 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4))))
     (void) addvheader (hdrp);
...
static int acoversb (enta, entb)
 ...
 if (((enta->mask[(32 / 32) - 1] ^ entb->mask[(32 / 32) - 1]) & ((long) 1 << (((32) - 6) + 1))) != 0
   && (enta->mask[(32 / 32) - 1] & ((long) 1 << (((32) - 6) + 1))) == 0)
     return 0;
 }
    else
 {
...
# 567 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
    if (((enta->mask[(32 / 32) - 1] ^ entb->mask[(32 / 32) - 1]) & ((long) 3 << (((32) - 6) + 2))) == 0)
 {
 if (((enta->mask[(32 / 32) - 1]) & ((long) 3 << (((32) - 6) + 2))) != ((long) 3 << (((32) - 6) + 2))
 ...
 return 1;
    else if (((enta->mask[(32 / 32) - 1]) & ((long) 3 << (((32) - 6) + 2))) == ((long) 0 << (((32) - 6) + 2))
      && ((entb->mask[(32 / 32) - 1]) & ((long) 3 << (((32) - 6) + 2))) == ((long) 2 << (((32) - 6) + 2)))
 return 1;
    else
 return 0;
...
static int issubset (ent1, ent2)
    ...
    {
# 651 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
    if (((ent1->mask[(32 / 32) - 1] & ent2->mask[(32 / 32) - 1])
      ^ ent1->mask[(32 / 32) - 1]) & ~(((long) 1 << (((32) - 6) + 0)) | ((long) 1 << (((32) - 6) + 1)) | ((long) 3 << (((32) - 6) + 2)) | ((long) 1 << (((32) - 6) + 4))))
 return 0;
    else
 return 1;
...
static void combineaffixes (ent1, ent2)
    ...
    register struct dent * ent2;
    {
# 677 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
...
void toutent (toutfile, hent, onlykeep)
 ...
 (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", cent->word, 700, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c");
    for ( ; ; )
 {
 if (!onlykeep || (cent->mask[(32 / 32) - 1] & ((long) 1 << (((32) - 6) + 1))))
  ...
  case ((long) 0 << (((32) - 6) + 2)):
      ...
      break;
  case ((long) 1 << (((32) - 6) + 2)):
      if ((cent->mask[(32 / 32) - 1] & ((long) 1 << (((32) - 6) + 4))) == 0
        || cent != hent)
   {
   upcase (wbuf);
   toutword (toutfile, ichartosstr (wbuf, 1), cent);
...
# 774 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
int stringcharlen (bufp, canonical)
    ...
    int dupwanted;
# 797 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
    lowstringno = 0;
...
# 895 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
...
ichar_t * strtosichar (in, canonical)
 ...
 (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", in, 944, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c");
    return out;
    }
...
char * ichartosstr (in, canonical)
 ...
 (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", out, 958, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c");
    return out;
    }
...
# 1048 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
