# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c" 2

static char Rcs_Id[] =
    "$Id$";
# 76 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c"
...
# 77 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c" 2
...
# 78 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c" 2
...
# 79 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c" 2
...
extern char * tgoto ();
extern char * tputs ();
# 80 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c" 2
...
int good (w, ignoreflagbits, allhits, pfxopts, sfxopts)
    ...
    int pfxopts;
    int sfxopts;
# 109 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c"
    {
 ...
 *q++ = (hashheader.upperconv[(*p++)]);
 ...
 if (compoundflag == 2
   && ((pfxopts | sfxopts) & (1 << 1)) != 0
   && hashheader.compoundbit >= 0
   && ((dp->mask)[0] & ((long) 1 << (hashheader.compoundbit))) == 0)
     numhits = 0;
 }
    if (numhits && !allhits)
 return 1;
# 167 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c"
...
int cap_ok (word, hit, len)
 ...
 if (dentcap != thiscap)
     {
     if (dentcap == ((long) 0 << (((32) - 6) + 2)) && thiscap == ((long) 2 << (((32) - 6) + 2))
...
void flagpr (word, preflag, prestrip, preadd, sufflag, sufadd)
 ...
 {
 while (--prestrip >= 0)
     (void) fputs (printichar ((int) (hashheader.lowerconv[(*word++)])), stdout);
 }
