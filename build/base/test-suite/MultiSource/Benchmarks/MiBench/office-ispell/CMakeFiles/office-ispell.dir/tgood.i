# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c" 2

static char Rcs_Id[] =
    "$Id$";
# 79 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c"
...
# 80 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c" 2
...
# 81 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c" 2
...
# 82 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c" 2
...
extern char * tgoto ();
extern char * tputs ();
# 83 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c" 2
...
void chk_aff (word, ucword, len, ignoreflagbits, allhits, pfxopts, sfxopts)
 ...
 ind = &ind->pu.fp[*cp++];
    ...
    if (numhits && !allhits && !cflag && !ignoreflagbits)
 return;
    chk_suf (word, ucword, len, sfxopts, (struct flagent *) ((void*)0),
      ignoreflagbits, allhits);
    }
...
static void pfx_list_chk (word, ucword, len, optflags, sfxopts, ind,
 ...
 if (compoundflag == 2
   && ((flent->flagflags ^ optflags) & (1 << 1)) != 0)
     continue;
 ...
 if (tlen > 0
   && (flent->affl == 0
     || strncmp ((char *) (flent->affix), (char *) (ucword), (flent->affl)) == 0)
  ...
  tlen += flent->stripl;
  if (cflag)
      flagpr (tword, ((flent->flagbit) + 'A'), flent->stripl,
        flent->affl, -1, 0);
   ...
   (void) ins_root_cap (tword2, word,
     ...
     dent, flent, (struct flagent *) ((void*)0));
   }
      }
  else if ((dent = lookup (tword, 1)) != ((void*)0)
    && ((dent->mask)[0] & ((long) 1 << (flent->flagbit))))
      {
      if (numhits < 10)
   {
  ...
  if (flent->flagflags & (1 << 0))
      chk_suf (word, tword, tlen, sfxopts | (1 << 0),
...
static void suf_list_chk (word, ucword, len, ind, optflags, pfxent,
 ...
 if (tlen > 0
   && (flent->affl == 0
     || strcmp ((char *) (flent->affix), (char *) (ucword + tlen)) == 0)
   && tlen + flent->stripl >= flent->numconds)
     {
  ...
  *cp = '\0';
  ...
  if (cflag)
      {
      if (optflags & (1 << 0))
   flagpr (tword, ((pfxent->flagbit) + 'A'),
     pfxent->stripl, pfxent->affl,
     ((flent->flagbit) + 'A'), flent->affl);
      else
   flagpr (tword, -1, 0, 0,
     ((flent->flagbit) + 'A'), flent->affl);
      }
   ...
   (void) ins_root_cap (tword2, word,
    ...
    && ((dent->mask)[0] & ((long) 1 << (flent->flagbit)))
    && ((optflags & (1 << 0)) == 0
      || ((dent->mask)[0] & ((long) 1 << (pfxent->flagbit)))))
      {
      if (numhits < 10)
   {
   hits[numhits].dictent = dent;
...
# 531 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c"
    if (flent->affl)
 {
 ...
 (void) printf (" %s%s", ichartosstr (tword, 1), extra);
    if (flent->flagflags & (1 << 0))
 return tlen
   + expand_suf (croot, tword, mask, (1 << 0), option, extra);
    else
 return tlen;
    }
