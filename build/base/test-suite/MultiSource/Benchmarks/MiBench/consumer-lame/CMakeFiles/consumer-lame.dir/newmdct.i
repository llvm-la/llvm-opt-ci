# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/newmdct.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/newmdct.c" 2
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/newmdct.c"
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/newmdct.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/newmdct.c" 2
...
# 146 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/newmdct.c"
...
# 234 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/newmdct.c"
...
void mdct_init48(void)
{
 ...
 do {
     ...
     for (k = 0; k < 36 / 4; k++) {
  *cos_l0++ = sq *
      cos((3.14159265358979323846 / (4 * 36)) * (2 * m + 1) * (4 * k + 2 + 36));
     }
     for (k = 0; k < 36 / 4; k++) {
  *cos_l0++ = sq *
      cos((3.14159265358979323846 / (4 * 36)) * (2 * m + 1) * (4 * k + 2 + 36 * 3));
     }
 } while (--j >= 0);
 ...
 do {
     m = d9[j];
     *cos_l0++ = sq *
  cos((3.14159265358979323846 / (4 * 36)) * (2 * m + 1) * (2 + 36));
     *cos_l0++ = sq *
  cos((3.14159265358979323846 / (4 * 36)) * (2 * m + 1) * (4 * 2 + 2 + 36));
 } while (--j >= 0);
    }
 ...
 for (m = 0; m < 12 / 2; m++) {
     cos_s[m][i] = w2 *
  cos((3.14159265358979323846 / (4 * 12)) * (2 * m + 1) * (4 * i + 2 + 12));
     cos_s[m][i + 12 / 4] = w2 *
  cos((3.14159265358979323846 / (4 * 12)) * (2 * m + 1) * (4 * i + 2 + 12 * 3));
 }
    }
}
