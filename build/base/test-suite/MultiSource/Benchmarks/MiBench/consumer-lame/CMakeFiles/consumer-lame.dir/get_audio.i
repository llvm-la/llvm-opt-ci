# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c" 2
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
...
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
int lame_readframe(lame_global_flags *gfp,short int Buffer[2][1152])
{
  ...
  if (iread==0) gfp->totalframes = ((gfp->totalframes) < (gfp->frameNum+2) ? (gfp->totalframes) : (gfp->frameNum+2));
  if (gfp->frameNum > (gfp->totalframes-1)) gfp->totalframes = gfp->frameNum;
  return iread;
}
# 87 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
int get_audio(lame_global_flags *gfp,short buffer[2][1152],int stereo)
{
  ...
  if (num_samples!=0xFFFFFFFF) num_samples_read += samples_read;
  return(samples_read);

}
# 143 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
int GetSndBitrate(void)
{
...
# 194 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
  if (out==-1) return 0;
  else return out;
...
# 461 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
...
int default_channels)
{
  ...
  if (!strcmp(inPath, "-")) {
# 520 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
    musicin = stdin;
  } else {
...
# 585 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
int read_samples_pcm(lame_global_flags *gfp,short sample_buffer[2304], int frame_size,int samples_to_read)
{
    int samples_read;
    int rcode;
...
# 638 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
...
# 661 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
static void
...
# 681 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
static int
parse_wave_header(FILE *sf)
{
 ...
 for (loop_sanity = 0; loop_sanity < 20; ++loop_sanity) {
  ...
  if (type == 0x666d7420) {
   ...
   subSize = Read32Bits(sf);
   if (fskip(sf, (long) subSize, 1) != 0 ) return 0;
  }
 }
...
# 762 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
static void
...
# 805 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
static int
...
# 899 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
void parse_file_header(lame_global_flags *gfp,FILE *sf)
{
 u_int type = 0;
 type = Read32BitsHighLow(sf);
