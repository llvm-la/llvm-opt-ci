# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c" 2
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c"
...
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c" 2
...
# 70 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c" 2
...
# 71 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c" 2
...
# 72 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c" 2
# 101 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c"
defdouble
ConvertFromIeeeSingle(char* bytes)
{
 ...
 if (bits & (-9223372036854775807L -1L))
  return -f;
 else
  return f;
}
...
# 211 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c"
defdouble
...
# 353 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/ieeefloat.c"
...
ConvertToIeeeExtended(defdouble num, char *bytes)
{
 ...
 if (num == 0) {
  ...
  if ((expon > 16384) || !(fMant < 1)) {
   ...
   expon |= sign;
   fMant = ldexp(fMant, 32); fsMant = floor(fMant); hiMant = ((unsigned long)(((long)((fsMant) - 2147483648.0)) + 2147483647L + 1));
   fMant = ldexp(fMant - fsMant, 32); fsMant = floor(fMant); loMant = ((unsigned long)(((long)((fsMant) - 2147483648.0)) + 2147483647L + 1));
  }
 }
