# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c" 2
...
static OBJECT env_cache;
static int cache_count;
static int stat_writes;
static int stat_write_hits;
static int stat_reads;
static int stat_read_hits;

static OBJECT tab[211];
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c"
void EnvInit(void)
{ int i;
                              ;
  stat_reads = 0;
...
# 93 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c"
unsigned EnvWriteRetrieve(OBJECT env, FILE_NUM fnum, int *offset, int *lnum)
{ unsigned int pos; OBJECT link, y, z;
                                                                            ;
                                           ;
  stat_writes++;
  { pos = ( (unsigned int) env + fnum ) % 211; };
  if( tab[pos] != ( (OBJECT) ((void*)0) ) )
  {
    for( link = (tab[pos])->os1.olist[0].osucc; link != tab[pos]; link = (link)->os1.olist[0].osucc )
    { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      ...
      if( ((y)->os1.ou1.ofpos).ofile_num == fnum && z == env && !(y)->os1.ou2.os23.osized )
      { ( xx_link = ((y)->os1.olist[1].opred), ( zz_hold = (xx_link), (zz_hold)->os1.olist[1 - (1)].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1 - (1)].osucc, (zz_res)->os1.olist[1 - (1)].opred = (zz_hold)->os1.olist[1 - (1)].opred, ((zz_hold)->os1.olist[1 - (1)].opred)->os1.olist[1 - (1)].osucc = zz_res, (zz_hold)->os1.olist[1 - (1)].opred = (zz_hold)->os1.olist[1 - (1)].osucc = zz_hold, zz_res ) ), ( zz_res = (xx_link), zz_hold = ((env_cache)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1 - (1)].opred, (zz_hold)->os1.olist[1 - (1)].opred = (zz_res)->os1.olist[1 - (1)].opred, ((zz_res)->os1.olist[1 - (1)].opred)->os1.olist[1 - (1)].osucc = zz_hold, (zz_res)->os1.olist[1 - (1)].opred = zz_tmp, (zz_tmp)->os1.olist[1 - (1)].osucc = zz_res ) ) );
 *offset = (y)->os1.ou3.os31.oback[1];
 *lnum = ((y)->os1.ou1.ofpos).oline_num;
 stat_write_hits++;
...
# 129 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c"
...
{ unsigned int pos; OBJECT loser, x;
  ...
  if( cache_count >= 180 )
  {
    for( loser = ((env_cache)->os1.olist[0].osucc)->os1.olist[1].opred; (loser)->os1.ou1.os11.otype == 0; loser = (loser)->os1.olist[1].opred );
    { xx_link = ((loser)->os1.olist[1].osucc); ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; };
    { xx_link = ((loser)->os1.olist[1].osucc); xx_tmp = ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; if( (xx_tmp)->os1.olist[1].osucc == xx_tmp ) DisposeObject(xx_tmp); };
    cache_count--;
  }


  { pos = ( (unsigned int) env + fnum ) % 211; };
  if( tab[pos] == ( (OBJECT) ((void*)0) ) ) { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; tab[pos] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; x = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  ((x)->os1.ou1.ofpos).ofile_num = fnum;
  (x)->os1.ou3.os31.oback[1] = offset;
  ((x)->os1.ou1.ofpos).oline_num = lnum;
  (x)->os1.ou2.os23.osized = 0;
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((tab[pos])), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((env_cache)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
...
# 169 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c"
unsigned EnvReadRetrieve(FILE_NUM fnum, int offset, OBJECT *env)
{ int pos; OBJECT link, y, z;
  ...
  if( tab[pos] != ( (OBJECT) ((void*)0) ) )
  {
    ...
    { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      for( z = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
      if( ((y)->os1.ou1.ofpos).ofile_num == fnum && (y)->os1.ou3.os31.oback[1] == offset && (y)->os1.ou2.os23.osized )
      { ( xx_link = ((y)->os1.olist[1].opred), ( zz_hold = (xx_link), (zz_hold)->os1.olist[1 - (1)].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1 - (1)].osucc, (zz_res)->os1.olist[1 - (1)].opred = (zz_hold)->os1.olist[1 - (1)].opred, ((zz_hold)->os1.olist[1 - (1)].opred)->os1.olist[1 - (1)].osucc = zz_res, (zz_hold)->os1.olist[1 - (1)].opred = (zz_hold)->os1.olist[1 - (1)].osucc = zz_hold, zz_res ) ), ( zz_res = (xx_link), zz_hold = ((env_cache)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1 - (1)].opred, (zz_hold)->os1.olist[1 - (1)].opred = (zz_res)->os1.olist[1 - (1)].opred, ((zz_res)->os1.olist[1 - (1)].opred)->os1.olist[1 - (1)].osucc = zz_hold, (zz_res)->os1.olist[1 - (1)].opred = zz_tmp, (zz_tmp)->os1.olist[1 - (1)].osucc = zz_res ) ) );
 for( *env = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (*env)->os1.ou1.os11.otype == 0; *env = (*env)->os1.olist[1].opred );
 stat_read_hits++;
                                                                       ;
   return 1;
      }
...
# 203 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z47.c"
