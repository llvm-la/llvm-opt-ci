# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c" 2
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c"
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c" 2
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c"
LINE *ReadLines(FILE *fp, FULL_CHAR *fname, FULL_CHAR *first_line, int *len)
{
  ...
  if( first_line != (FULL_CHAR *) ( (FILE *) ((void*)0) ) )
  {
    *lp = malloc((strlen((char *)(first_line)) + 1) * sizeof(char));
    strcpy((char *)((char *) *lp),(char *)(first_line));
    lp++;
  }
  ...
  *lp++ = bp;
  while( (ch = getc(fp)) != (-1) )
  {
                                               ...
                                               ;
    { if( !((int) buff >= (int) lines_top || (int) buff_top <= (int) lines) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ReadLines: lines and buff overlap!"); };
...
# 163 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c"
...
# 180 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c"
static int pstrcmp(const void *a, const void *b)
{
  return strcmp (*(char **)a, *(char **)b);
}

static int pstrcollcmp(const void *a, const void *b)
{
  return strcollcmp (*(char **)a, *(char**)b);
}
# 199 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c"
void SortLines(LINE *lines, int lines_len)
{
  qsort(lines, lines_len, sizeof(LINE), (UseCollate ? pstrcollcmp : pstrcmp));
}
# 213 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z45.c"
void SortFile(FULL_CHAR *infile, FULL_CHAR *outfile)
{
  ...
  in_fp = fopen( (char *) infile, "r");
  if( in_fp == (FILE *) ((void*)0) )
    Error(45, 5, "cannot open index file %s for reading",
     1, no_fpos, outfile);


  out_fp = fopen( (char *) outfile, "w");
  if( out_fp == (FILE *) ((void*)0) )
    Error(45, 6, "cannot open index file %s for writing",
     1, no_fpos, outfile);


  lines = ReadLines(in_fp, infile, (FULL_CHAR *) ((void*)0), &lines_len);
