# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c" 2

static FILE_NUM last_write_fnum = 0;
static FILE *last_write_fp = ( (FILE *) ((void*)0) );
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
...
{ OBJECT t, res;
  ...
  { ;
    Error(41, 2, "syntax error in database file", 1, &(res)->os1.ou1.ofpos);
  }
  LexPop();
                                                              ;
                                             ;
...
{ OBJECT tmp;
  ...
  if( tmp != ( (OBJECT) ((void*)0) ) )
  { ( xx_tmp = ( zz_hold = ((x)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((tmp)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) );
    DisposeObject(x);
  }
}
# 103 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
static void OptimizeParameterList(OBJECT x, OBJECT env)
{ OBJECT y, z, link, t, tlink;
  { if( !((x)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "OptimizeParameterList: type(x) != CLOSURE!"); };
  if( env == ( (OBJECT) ((void*)0) ) ) return;
  ...
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os1.ou1.os11.otype == 10 )
    { for( z = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
      if( (z)->os1.ou1.os11.otype == 2 )
      {
 Optimize(z, env);
      }
      else if( (z)->os1.ou1.os11.otype == 17 )
      { for( tlink = (z)->os1.olist[0].osucc; tlink != z; tlink = (tlink)->os1.olist[0].osucc )
        { for( t = ((tlink)->os1.olist[0].osucc)->os1.olist[1].opred; (t)->os1.ou1.os11.otype == 0; t = (t)->os1.olist[1].opred );
...
# 138 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
static void WriteObject(OBJECT x, int outer_prec, int *linecount, FILE_NUM fnum);

static unsigned need_lvis(OBJECT sym)
{ return !(sym)->os1.ou2.os26.ovisible &&
  (sym)->os6.oenclosing != StartSym &&
  ((sym)->os6.oenclosing)->os1.ou1.os11.otype == 143;
}

static void WriteClosure(OBJECT x, int *linecount, FILE_NUM fnum, OBJECT env)
{ OBJECT y, link, z, sym;
  unsigned npar_written, name_printed;
                                                                        ;

  sym = (x)->os2.oactual;

  if( (sym)->os6.ouse_invocation != ( (OBJECT) ((void*)0) ) )
  { fputs( (char *) (( (FULL_CHAR *) ("@LUse") )), (last_write_fp) );
    fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
    fputs( (char *) (SymName(sym)), (last_write_fp) );
  }
  else
  { npar_written = 0; name_printed = 0;
    OptimizeParameterList(x, env);
    for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
    { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      if( (y)->os1.ou1.os11.otype == 10 ) switch( ((y)->os2.oactual)->os1.ou1.os11.otype )
      {
        case 144:

   { if( !((y)->os1.olist[0].osucc != y) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject/CLOSURE: LPAR!"); };
   for( z = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
   WriteObject(z, (int) (sym)->os1.ou2.os21.oprecedence, linecount, fnum);
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   break;
   ...
   { if( !((y)->os1.olist[0].osucc != y) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject/CLOSURE: NPAR!"); };
   for( z = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
   if( !name_printed )
   { if( need_lvis(sym) )
     { fputs( (char *) (( (FULL_CHAR *) ("@@V") )), (last_write_fp) );
       fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
     }
     fputs( (char *) (SymName(sym)), (last_write_fp) );
     name_printed = 1;
   }
   fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
   *linecount += 1;
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );

   if( ((y)->os2.oactual)->os6.onpar_code != ' ' )
   { fputs( (char *) (( (FULL_CHAR *) ("\\") )), (last_write_fp) );
     fprintf(last_write_fp, "%c", (char) ((y)->os2.oactual)->os6.onpar_code);
   }
   else
   { fputs( (char *) (SymName((y)->os2.oactual)), (last_write_fp) );
   }

   fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
   WriteObject(z, 0, linecount, fnum);
   fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
   npar_written = 1;
   break;
   ...
   { if( !((y)->os1.olist[0].osucc != y) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject/CLOSURE: RPAR!"); };
   for( z = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
   if( !name_printed )
   { if( need_lvis(sym) )
     { fputs( (char *) (( (FULL_CHAR *) ("@@V") )), (last_write_fp) );
   ...
   if( (sym)->os6.ofilter != ( (OBJECT) ((void*)0) ) && (z)->os1.ou1.os11.otype == 57 )
   {

                      ;
     { if( !((z)->os1.ou1.os11.otype == 57) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteClosure:  filter!"); };
     WriteObject(z, 0, linecount, fnum);
   }
   else if( (sym)->os1.ou2.os26.ohas_body )
   {
     fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
     fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
     WriteObject(z, 0, linecount, fnum);
   ...
   else WriteObject(z, (int) (sym)->os1.ou2.os21.oprecedence, linecount, fnum);
   break;


        default:

   { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"WriteClosure:", Image(((y)->os2.oactual)->os1.ou1.os11.otype)); };
   break;
...
# 276 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
static void WriteObject(OBJECT x, int outer_prec, int *linecount, FILE_NUM fnum)
{ OBJECT link, y, z, gap_obj, sym, env; FULL_CHAR *name; int offset, lnum;
  int prec, i, last_prec; unsigned braces_needed;
                                                                       ;
  switch( (x)->os1.ou1.os11.otype )
  {
    ...
    case 11:
      ...
      if( strlen((char *)((x)->os1.ostring)) == 0 && outer_prec > 7 )
      { fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
 fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
      }
      else fputs( (char *) ((x)->os1.ostring), (last_write_fp) );
      break;


    case 12:

      fputs( (char *) (StringQuotedWord(x)), (last_write_fp) );
      break;


    case 19: prec = 5; goto ETC;
    case 18: prec = 6; goto ETC;
    case 17: prec = 7; goto ETC;

      ETC:
      if( prec < outer_prec ) fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
      last_prec = prec;
      for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
      { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 if( (y)->os1.ou1.os11.otype == 1 )
 { if( (y)->os1.olist[0].osucc == y )
   { { if( !((x)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject: Down(y) == y!"); };
     for( i = 1; i <= (y)->os1.ou2.os21.ovspace; i++ )
       fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
     *linecount += (y)->os1.ou2.os21.ovspace;
     for( i = 1; i <= (y)->os1.ou2.os21.ohspace; i++ )
       fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
     last_prec = ((y)->os1.ou2.os21.ovspace + (y)->os1.ou2.os21.ohspace == 0) ? 103 : 7;
   }
   else
   { for( gap_obj = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (gap_obj)->os1.ou1.os11.otype == 0; gap_obj = (gap_obj)->os1.olist[1].opred );
     if( (x)->os1.ou1.os11.otype==17 )
       fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
     else
     { fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
       *linecount += 1;
     }
     fputs( (char *) (EchoCatOp((x)->os1.ou1.os11.otype, ((y)->os5.ogap).omark, ((y)->os5.ogap).ojoin)), (last_write_fp) );

     if( !(((gap_obj)->os1.ou1.os11.otype) == 11 || ((gap_obj)->os1.ou1.os11.otype) == 12) || strlen((char *)((gap_obj)->os1.ostring)) != 0 )
  WriteObject(gap_obj, 105, linecount, fnum);
     fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
     last_prec = prec;
   }
 }
 ...
 { if( (x)->os1.ou1.os11.otype == 17 )
   { OBJECT next_gap; int next_prec;
     if( (link)->os1.olist[0].osucc != x )
     { for( next_gap = ((link)->os1.olist[0].osucc)->os1.olist[1].opred; (next_gap)->os1.ou1.os11.otype == 0; next_gap = (next_gap)->os1.olist[1].opred );
       { if( !((next_gap)->os1.ou1.os11.otype == 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject: next_gap!"); };
       next_prec = ((next_gap)->os1.ou2.os21.ovspace + (next_gap)->os1.ou2.os21.ohspace == 0)
    ? 103 : 7;
     }
     else next_prec = prec;
     WriteObject(y, ((last_prec) < (next_prec) ? (next_prec) : (last_prec)), linecount, fnum);
   }
 ...
 fputs( (char *) (( (FULL_CHAR *) ("@@C") )), (last_write_fp) );
 fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
 *linecount += 1;
      }
 ...
 fputs( (char *) (( (FULL_CHAR *) ("@@D") )), (last_write_fp) );
 ...
 *linecount += 1;
 ...
 if( (x)->os1.olist[0].osucc == (x)->os1.olist[0].opred )
        {

   for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
   { if( !((y)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject: ENV/CLOSURE!"); };
   fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("@@A") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   WriteObject(y, 0, linecount, fnum);
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
   ...
   *linecount += 1;
   ...
   { if( !((env)->os1.ou1.os11.otype == 82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject: ENV/ENV!"); };
   fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("@@B") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   WriteObject(env, 0, linecount, fnum);
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
   *linecount += 1;
   for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
   { if( !((y)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject: ENV/ENV+CLOSURE!"); };
   fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
   WriteObject(y, 0, linecount, fnum);
   fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
   ...
   *linecount += 1;
    ...
    case 2:
      ...
      sym = (x)->os2.oactual; env = ( (OBJECT) ((void*)0) );
      if( (x)->os1.olist[0].opred != x )
      { for( y = ((x)->os1.olist[0].opred)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 if( (y)->os1.ou1.os11.otype == 82 ) env = y;
      }

      braces_needed = env != ( (OBJECT) ((void*)0) ) ||
 ((sym)->os1.ou2.os21.oprecedence <= outer_prec && ((sym)->os1.ou2.os26.ohas_lpar || (sym)->os1.ou2.os26.ohas_rpar)) ||
 outer_prec >= 103;


      if( env != ( (OBJECT) ((void*)0) ) )
      { fputs( (char *) (( (FULL_CHAR *) ("@@E") )), (last_write_fp) );
 fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
 fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
       fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
 *linecount += 1;
 ...
 *linecount += 1;
      ...
      if( braces_needed ) fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
      ...
      if( braces_needed ) fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
# 467 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
      break;
    ...
    case 7:
      ...
      for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      { if( !((y)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject/CROSS: type(y) != CLOSURE!"); };
      if( 100 <= outer_prec ) fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
      if( need_lvis((y)->os2.oactual) )
      { fputs( (char *) (( (FULL_CHAR *) ("@@V") )), (last_write_fp) );
        fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
      }
      fputs( (char *) (SymName((y)->os2.oactual)), (last_write_fp) );
      fputs( (char *) ((x)->os1.ou1.os11.otype == 6 ? ( (FULL_CHAR *) ("&&") ) : ( (FULL_CHAR *) ("&&&") )), (last_write_fp) );
      for( y = ((x)->os1.olist[0].opred)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      WriteObject(y, 105, linecount, fnum);
      if( 100 <= outer_prec ) fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
      break;


    case 5: name = ( (FULL_CHAR *) ("@Null") ); goto SETC;
    case 4: name = ( (FULL_CHAR *) ("@PageLabel") ); goto SETC;
    case 20: name = ( (FULL_CHAR *) ("@BeginHeaderComponent") ); goto SETC;
    case 21: name = ( (FULL_CHAR *) ("@EndHeaderComponent") ); goto SETC;
    case 22: name = ( (FULL_CHAR *) ("@SetHeaderComponent") ); goto SETC;
    case 23: name = ( (FULL_CHAR *) ("@ClearHeaderComponent") ); goto SETC;
    case 24: name = ( (FULL_CHAR *) ("@OneCol") ); goto SETC;
    case 25: name = ( (FULL_CHAR *) ("@OneRow") ); goto SETC;
    case 26: name = ( (FULL_CHAR *) ("@Wide") ); goto SETC;
    case 27: name = ( (FULL_CHAR *) ("@High") ); goto SETC;
    case 28: name = ( (FULL_CHAR *) ("@HShift") ); goto SETC;
    case 29: name = ( (FULL_CHAR *) ("@VShift") ); goto SETC;
    case 30: name = ( (FULL_CHAR *) ("@HScale") ); goto SETC;
    case 31: name = ( (FULL_CHAR *) ("@VScale") ); goto SETC;
    case 32: name = ( (FULL_CHAR *) ("@HCover") ); goto SETC;
    case 33: name = ( (FULL_CHAR *) ("@VCover") ); goto SETC;
    case 34: name = ( (FULL_CHAR *) ("@Scale") ); goto SETC;
    case 35: name = ( (FULL_CHAR *) ("@KernShrink") ); goto SETC;
    case 36: name = ( (FULL_CHAR *) ("@HContract") ); goto SETC;
    case 37: name = ( (FULL_CHAR *) ("@VContract") ); goto SETC;
    case 38: name = ( (FULL_CHAR *) ("@HLimited") ); goto SETC;
    case 39: name = ( (FULL_CHAR *) ("@VLimited") ); goto SETC;
    case 40: name = ( (FULL_CHAR *) ("@HExpand") ); goto SETC;
    case 41: name = ( (FULL_CHAR *) ("@VExpand") ); goto SETC;
    case 44: name = ( (FULL_CHAR *) ("@StartHVSpan") ); goto SETC;
    case 42: name = ( (FULL_CHAR *) ("@StartHSpan") ); goto SETC;
    case 43: name = ( (FULL_CHAR *) ("@StartVSpan") ); goto SETC;
    case 45: name = ( (FULL_CHAR *) ("@HSpan") ); goto SETC;
    case 46: name = ( (FULL_CHAR *) ("@VSpan") ); goto SETC;
    case 47: name = ( (FULL_CHAR *) ("@PAdjust") ); goto SETC;
    case 48: name = ( (FULL_CHAR *) ("@HAdjust") ); goto SETC;
    case 49: name = ( (FULL_CHAR *) ("@VAdjust") ); goto SETC;
    case 50: name = ( (FULL_CHAR *) ("@Rotate") ); goto SETC;
    case 51: name = ( (FULL_CHAR *) ("@Background") ); goto SETC;
    case 52: name = ( (FULL_CHAR *) ("@Case") ); goto SETC;
    case 55: name = ( (FULL_CHAR *) ("@Yield") ); goto SETC;
    case 56: name = ( (FULL_CHAR *) ("@BackEnd") ); goto SETC;
    case 58: name = ( (FULL_CHAR *) ("@Char") ); goto SETC;
    case 59: name = ( (FULL_CHAR *) ("@Font") ); goto SETC;
    case 60: name = ( (FULL_CHAR *) ("@Space") ); goto SETC;
    case 61: name = ( (FULL_CHAR *) ("@YUnit") ); goto SETC;
    case 62: name = ( (FULL_CHAR *) ("@ZUnit") ); goto SETC;
    case 63: name = ( (FULL_CHAR *) ("@Break") ); goto SETC;
    case 64: name = ( (FULL_CHAR *) ("@Underline") ); goto SETC;
    case 65: name = ( (FULL_CHAR *) ("@SetColour") ); goto SETC;
    case 66: name = ( (FULL_CHAR *) ("@Outline") ); goto SETC;
    case 67: name = ( (FULL_CHAR *) ("@Language") ); goto SETC;
    case 68: name = ( (FULL_CHAR *) ("@CurrLang") ); goto SETC;
    case 69: name = ( (FULL_CHAR *) ("@CurrFamily") ); goto SETC;
    case 70: name = ( (FULL_CHAR *) ("@CurrFace") ); goto SETC;
    case 71: name = ( (FULL_CHAR *) ("@CurrYUnit") ); goto SETC;
    case 72: name = ( (FULL_CHAR *) ("@CurrZUnit") ); goto SETC;
    case 73: name = ( (FULL_CHAR *) ("@Common") ); goto SETC;
    case 74: name = ( (FULL_CHAR *) ("@Rump") ); goto SETC;
    case 75: name = ( (FULL_CHAR *) ("@Meld") ); goto SETC;
    case 76: name = ( (FULL_CHAR *) ("@Insert") ); goto SETC;
    case 77: name = ( (FULL_CHAR *) ("@OneOf") ); goto SETC;
    case 78: name = ( (FULL_CHAR *) ("@Next") ); goto SETC;
    case 79: name = ( (FULL_CHAR *) ("@Plus") ); goto SETC;
    case 80: name = ( (FULL_CHAR *) ("@Minus") ); goto SETC;
    case 92: name = ( (FULL_CHAR *) ("@Open") ); goto SETC;
    case 93: name = ( (FULL_CHAR *) ("@Tagged") ); goto SETC;
    case 94: name = ( (FULL_CHAR *) ("@IncludeGraphic") ); goto SETC;
    case 95: name = ( (FULL_CHAR *) ("@SysIncludeGraphic") ); goto SETC;
    case 96: name = ( (FULL_CHAR *) ("@PlainGraphic") ); goto SETC;
    case 97: name = ( (FULL_CHAR *) ("@Graphic") ); goto SETC;
    case 98: name = ( (FULL_CHAR *) ("@LinkSource") ); goto SETC;
    case 99: name = ( (FULL_CHAR *) ("@LinkDest") ); goto SETC;
      ...
      if( (x)->os1.olist[0].osucc != (x)->os1.olist[0].opred )
      { for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 WriteObject(y, 100, linecount, fnum);
 fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
      }


      fputs( (char *) (name), (last_write_fp) );


      if( (x)->os1.olist[0].opred != x )
      { for( y = ((x)->os1.olist[0].opred)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
 if( (x)->os1.ou1.os11.otype == 92 )
 { fputs( (char *) (( (FULL_CHAR *) ("{") )), (last_write_fp) );
   WriteObject(y, 0, linecount, fnum);
   fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
 }
 else WriteObject(y, 100, linecount, fnum);
      }
      if( 100 <= outer_prec ) fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
      break;
    ...
    case 53:
      ...
      fputs( (char *) ((x)->os1.ou1.os11.otype == 53 ? ( (FULL_CHAR *) ("@Verbatim") ) : ( (FULL_CHAR *) ("@RawVerbatim") )), (last_write_fp) );
      fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
      fputs( (char *) (( (FULL_CHAR *) ("@Begin") )), (last_write_fp) );
      fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
      for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      if( (y)->os1.ou1.os11.otype == 11 )
      {
 fputs( (char *) ((y)->os1.ostring), (last_write_fp) );
        fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
      }
      else
      {
 { if( !((y)->os1.ou1.os11.otype == 19) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject/VERBATIM!"); };
 ...
 { for( z = (link)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
   ...
   { if( !((z)->os1.ou1.os11.otype == 11) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "WriteObject/VERBATIM/WORD!"); };
   fputs( (char *) ((z)->os1.ostring), (last_write_fp) );
   fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
   *linecount += 1;
 }
      }
      fputs( (char *) (( (FULL_CHAR *) ("@End") )), (last_write_fp) );
      fputs( (char *) (( (FULL_CHAR *) (" ") )), (last_write_fp) );
      fputs( (char *) ((x)->os1.ou1.os11.otype == 53 ? ( (FULL_CHAR *) ("@Verbatim") ) : ( (FULL_CHAR *) ("@RawVerbatim") )), (last_write_fp) );
      break;
    ...
    default:
      ...
      { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"WriteObject:", Image((x)->os1.ou1.os11.otype)); };
      break;

  }
                                           ;
}
# 640 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
void AppendToFile(OBJECT x, FILE_NUM fnum, int *pos, int *lnum)
{ FULL_CHAR buff[512], *str; int linecount;
                                                                           ;


  if( last_write_fnum != fnum )
  { if( last_write_fnum != 0 ) fclose(last_write_fp);
    str = FileName(fnum);
    if( strlen((char *)(str)) + strlen((char *)(( (FULL_CHAR *) ("x") ))) >= 512 )
      Error(41, 3, "file name %s%s is too long",
 1, PosOfFile(fnum), str, ( (FULL_CHAR *) ("x") ));
    strcpy((char *)(buff),(char *)(str)); strcat((char *)(buff),(char *)(( (FULL_CHAR *) ("x") )));
    last_write_fp = fopen( (char *) (buff), (FileTestUpdated(fnum) ? "a" : "w") );

    if( last_write_fp == ( (FILE *) ((void*)0) ) )
      Error(41, 4, "cannot append to database file %s", 1, no_fpos, buff);
    last_write_fnum = fnum;
    (void) fseek(last_write_fp, 0L, 2);
  }
  ...
  *lnum = linecount + 1;
  WriteObject(x, 0, &linecount, fnum);
  fputs( (char *) (( (FULL_CHAR *) ("}") )), (last_write_fp) );
  fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
  fputs( (char *) (( (FULL_CHAR *) ("\n") )), (last_write_fp) );
...
# 682 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z41.c"
void CloseFiles(void)
{ FILE_NUM fnum; FULL_CHAR oldname[512], newname[512];
  FILE *fp;
                                          ;
                                ;
  ...
  for( fnum=FirstFile(0); fnum != 0; fnum = NextFile(fnum) )
  { strcpy((char *)(oldname),(char *)(FileName(fnum)));
    strcat((char *)(oldname),(char *)(( (FULL_CHAR *) (".ld") )));
                                         ;
    remove((char *)(oldname));
  }
  ...
  for( fnum=FirstFile(3); fnum != 0; fnum = NextFile(fnum) )
  { if( FileTestUpdated(fnum) )
    {

      strcpy((char *)(oldname),(char *)(FileName(fnum)));
      strcpy((char *)(newname),(char *)(oldname));
      strcat((char *)(newname),(char *)(( (FULL_CHAR *) ("x") )));
      ...
      if( (fp = fopen( (char *) (oldname), ("r") )) != ((void*)0) )
      { fclose(fp);
 remove((char *)(oldname));
      }
                                                        ;
      if( rename((char *)(newname),(char *)(oldname)) != 0 )
 Error(41, 5, "rename(%s, %s) failed", 0, no_fpos,newname,oldname);
    }
  }
                                         ;
                                           ;
