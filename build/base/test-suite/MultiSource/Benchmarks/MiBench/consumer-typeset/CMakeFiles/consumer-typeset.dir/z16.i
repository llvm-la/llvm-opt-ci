# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c" 2
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
...
{ FULL_LENGTH len, res;
  ...
  switch( (((x)->os2.ou4.osave_style).osu1.oline_gap).ounits )
  {
    case 1: len = (((x)->os2.ou4.osave_style).osu1.oline_gap).owidth;
   break;

    case 5: len = (((y)->os1.ou3.os31.oback[dim] + (y)->os1.ou3.os31.ofwd[dim]) * (((x)->os2.ou4.osave_style).osu1.oline_gap).owidth) / 4096;
   break;

    default: { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FindShift: units"); };
   break;
  }


  switch( (((x)->os2.ou4.osave_style).osu2.ospace_gap).owidth )
  {
    case 158: res = len - (y)->os1.ou3.os31.oback[dim];
   break;
   ...
   break;
    ...
    default: { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FindShift: type"); };
   break;
  }
...
# 103 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
void SetNeighbours(OBJECT link, unsigned ratm, OBJECT *pg, OBJECT *pdef,
OBJECT *sg, OBJECT *sdef, int *side)
{ OBJECT plink, slink;


  *pg = ( (OBJECT) ((void*)0) );
  for( plink = (link)->os1.olist[0].opred; (plink)->os1.ou1.os11.otype == 0; plink = (plink)->os1.olist[0].opred )
  { for( *pdef = (plink)->os1.olist[1].opred; (*pdef)->os1.ou1.os11.otype == 0; *pdef = (*pdef)->os1.olist[1].opred );
    if( (*pdef)->os1.ou1.os11.otype == 9 ? SplitIsDefinite(*pdef) : (((*pdef)->os1.ou1.os11.otype) >= 9 && ((*pdef)->os1.ou1.os11.otype) <= 99) )
    { for( *pg = ((link)->os1.olist[0].opred)->os1.olist[1].opred; (*pg)->os1.ou1.os11.otype == 0; *pg = (*pg)->os1.olist[1].opred );
      while( (((*pg)->os1.ou1.os11.otype) >= 119 && ((*pg)->os1.ou1.os11.otype) <= 138) )
      { link = (link)->os1.olist[0].opred;
 for( *pg = ((link)->os1.olist[0].opred)->os1.olist[1].opred; (*pg)->os1.ou1.os11.otype == 0; *pg = (*pg)->os1.olist[1].opred );
      }
      { if( !((*pg)->os1.ou1.os11.otype == 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetNeighbours: type(*pg)!"); };
      break;
    }
  }
  ...
  *sg = ( (OBJECT) ((void*)0) );
  for( slink = (link)->os1.olist[0].osucc; (slink)->os1.ou1.os11.otype == 0; slink = (slink)->os1.olist[0].osucc )
  { for( *sdef = (slink)->os1.olist[1].opred; (*sdef)->os1.ou1.os11.otype == 0; *sdef = (*sdef)->os1.olist[1].opred );
    if( (*sdef)->os1.ou1.os11.otype == 9 ? SplitIsDefinite(*sdef) : (((*sdef)->os1.ou1.os11.otype) >= 9 && ((*sdef)->os1.ou1.os11.otype) <= 99) )
    { for( *sg = ((slink)->os1.olist[0].opred)->os1.olist[1].opred; (*sg)->os1.ou1.os11.otype == 0; *sg = (*sg)->os1.olist[1].opred );
      while( (((*sg)->os1.ou1.os11.otype) >= 119 && ((*sg)->os1.ou1.os11.otype) <= 138) )
      { slink = (slink)->os1.olist[0].opred;
 for( *sg = ((slink)->os1.olist[0].opred)->os1.olist[1].opred; (*sg)->os1.ou1.os11.otype == 0; *sg = (*sg)->os1.olist[1].opred );
      }
      { if( !((*sg)->os1.ou1.os11.otype == 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetNeighbours: type(*sg)!"); };
      break;
    }
  }

  *side = ratm ? 151 : *pg == ( (OBJECT) ((void*)0) ) || ((*pg)->os5.ogap).omark ? 152 : 153;



                                                        ;
}
# 155 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
static void CatAdjustSize(OBJECT x, FULL_LENGTH *b, FULL_LENGTH *f, unsigned ratm,
OBJECT y, int dim)
{ OBJECT link;
  ...
  if( dim==0 && (y)->os1.ou1.os11.otype==17 && ((y)->os2.ou4.osave_style).osu2.oss2.odisplay_style == 7 )
  { (x)->os1.ou3.os31.oback[dim] = *b; (x)->os1.ou3.os31.ofwd[dim] = *f;
    *b = (y)->os1.ou3.os31.oback[dim]; *f = (y)->os1.ou3.os31.ofwd[dim];
                                                                               ;
    return;
  }
  ...
  { ; }
# 191 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
  if( (((x)->os1.ou1.os11.otype) >= 2 && ((x)->os1.ou1.os11.otype) <= 8) )
  {
    beffect = pg == ( (OBJECT) ((void*)0) ) ? *b :
      MinGap((prec_def)->os1.ou3.os31.ofwd[dim], *b, *f, &(pg)->os5.ogap);

    feffect = sg == ( (OBJECT) ((void*)0) ) ? *f :
      MinGap(*f, (sd)->os1.ou3.os31.oback[dim], (sd)->os1.ou3.os31.ofwd[dim], &(sg)->os5.ogap);

    seffect = pg == ( (OBJECT) ((void*)0) ) ? sg == ( (OBJECT) ((void*)0) ) ? 0 : (sd)->os1.ou3.os31.oback[dim] :
  ...
  {
    beffect = pg == ( (OBJECT) ((void*)0) ) ? *b - (x)->os1.ou3.os31.oback[dim] :
      MinGap((prec_def)->os1.ou3.os31.ofwd[dim], *b, *f, &(pg)->os5.ogap) -
      MinGap((prec_def)->os1.ou3.os31.ofwd[dim], (x)->os1.ou3.os31.oback[dim], (x)->os1.ou3.os31.ofwd[dim], &(pg)->os5.ogap);

    feffect = sg == ( (OBJECT) ((void*)0) ) ? *f - (x)->os1.ou3.os31.ofwd[dim] :
      MinGap(*f, (sd)->os1.ou3.os31.oback[dim], (sd)->os1.ou3.os31.ofwd[dim], &(sg)->os5.ogap) -
  ...
  switch( side )
  {
    case 151: bb = (y)->os1.ou3.os31.oback[dim] + beffect + feffect - seffect;
  ff = (y)->os1.ou3.os31.ofwd[dim];
  break;

    case 152: bb = (y)->os1.ou3.os31.oback[dim] + beffect - seffect;
  ff = (y)->os1.ou3.os31.ofwd[dim] + feffect;
  break;

    case 153: bb = (y)->os1.ou3.os31.oback[dim];
  ff = (y)->os1.ou3.os31.ofwd[dim] + beffect + feffect - seffect;
  break;
  }
  *b = bb; *f = ff;
                                                                                  ;
}
# 251 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
void AdjustSize(OBJECT x, FULL_LENGTH b, FULL_LENGTH f, int dim)
{ OBJECT y, link, tlink, lp, rp, z, index;
  unsigned ratm; FULL_LENGTH tb, tf, cby, cfy, rby, rfy;
  ...
  while( b != (x)->os1.ou3.os31.oback[dim] || f != (x)->os1.ou3.os31.ofwd[dim] || (((x)->os1.ou1.os11.otype) >= 2 && ((x)->os1.ou1.os11.otype) <= 8) )
  { { if( !((x)->os1.olist[1].osucc != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AdjustSize: Up(x) == x!"); };
    if( b < 0 || f < 0 )
      Error(16, 5, "cannot recover from earlier errors", 1, &(x)->os1.ou1.ofpos);


    if( (x)->os1.ou1.os11.otype == 16 || (x)->os1.ou1.os11.otype == 15 )
    { { if( !(((x)->os1.ou1.os11.otype==16) == (dim==0)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AdjustSize: COL_THR!"); };
      (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
      for( link = (x)->os1.olist[1].osucc; link != x; link = (link)->os1.olist[1].osucc )
      { for( y = (link)->os1.olist[0].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[0].opred );
 { if( !((y)->os1.ou1.os11.otype == 9) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AdjustSize: type(y) != SPLIT!"); } ;
 AdjustSize(y, b, f, dim);
    ...
    { for( y = (tlink)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      if( (y)->os1.ou1.os11.otype == 1 && ((y)->os5.ogap).omark ) ratm = 1;
    }
    y = tlink;
 ...
 else
 {
   ...
   (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
   if( lp == y && rp == y && !(y)->os1.ou2.os23.oblocked )
   {
   ...
   else
   {
     ...
     { for( z = (link)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
       ...
       if( (z)->os1.ou1.os11.otype == 1 || (((z)->os1.ou1.os11.otype) >= 119 && ((z)->os1.ou1.os11.otype) <= 138) ) continue;
                                 ...
                                 ;
                                                                                ;
       tb = ((tb) < ((z)->os1.ou3.os31.oback[dim]) ? ((z)->os1.ou3.os31.oback[dim]) : (tb));
       tf = ((tf) < ((z)->os1.ou3.os31.ofwd[dim]) ? ((z)->os1.ou3.os31.ofwd[dim]) : (tf));
     }
     b = 0; f = ((tb + tf) < ((y)->os1.ou3.os31.ofwd[dim]) ? ((y)->os1.ou3.os31.ofwd[dim]) : (tb + tf));


                                    ;
   }
   if( (y)->os1.ou3.os31.oback[dim] == b && (y)->os1.ou3.os31.ofwd[dim] == f )
   {
                                                                       ;
     return;
   }
                                                      ...
                                                      ;
                                                                  ;
   (y)->os1.ou3.os31.oback[dim] = b; (y)->os1.ou3.os31.ofwd[dim] = f;
   if( (y)->os1.olist[1].osucc == y )
   {
                                                             ;
     return;
   }
   for( index = ((y)->os1.olist[1].osucc)->os1.olist[0].opred; (index)->os1.ou1.os11.otype == 0; index = (index)->os1.olist[0].opred );
   if( (index)->os1.ou1.os11.otype != 122 )
   {
                                                                        ;
     return;
   }
   { if( !((index)->os2.oactual!=( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AdjustSize: actual(index)==nilobj!"); };
   { if( !(((index)->os2.oactual)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AdjustSize: index non-C!"); };
   if( ((index)->os2.oactual)->os2.oactual != GalleySym &&
       ((index)->os2.oactual)->os2.oactual != ForceGalleySym )
   {
                                                                        ;
     return;
   }
 ...
 (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
 if( (dim==0) == ((y)->os1.ou1.os11.otype==30) )
 { ;
   return;
 }
 break;
 ...
 (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
 if( (dim==0) == ((y)->os1.ou1.os11.otype==32) )
 { ;
   return;
 }
 break;
 ...
 (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
 if( dim == 0 )
 { b *= ((y)->os2.ou4.oconstraint).obc / 128;
   f *= ((y)->os2.ou4.oconstraint).obc / 128;
 }
 else
 { b *= ((y)->os2.ou4.oconstraint).ofc / 128;
   f *= ((y)->os2.ou4.oconstraint).ofc / 128;
 }
 break;
 ...
 (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
 RotateSize(&cby, &cfy, &rby, &rfy, x, ((y)->os2.ou4.oconstraint).osparec);
 if( cby != (y)->os1.ou3.os31.oback[0] || cfy != (y)->os1.ou3.os31.ofwd[0] )
   AdjustSize(y, cby, cfy, 0);
 if( rby != (y)->os1.ou3.os31.oback[1] || rfy != (y)->os1.ou3.os31.ofwd[1] )
   AdjustSize(y, rby, rfy, 1);
                                                                ;
 return;
 ...
 { if( !(b <= ((y)->os2.ou4.oconstraint).obc && b + f <= ((y)->os2.ou4.oconstraint).obfc && f <= ((y)->os2.ou4.oconstraint).ofc) )
   { Error(16, 2, "size constraint %s,%s,%s broken by %s,%s",
       2, &(y)->os1.ou1.ofpos,
       EchoLength(((y)->os2.ou4.oconstraint).obc), EchoLength(((y)->os2.ou4.oconstraint).obfc),
       EchoLength(((y)->os2.ou4.oconstraint).ofc), EchoLength(b), EchoLength(f));
     (((y)->os2.ou4.oconstraint).obc = (8388607), ((y)->os2.ou4.oconstraint).obfc = (b+f), ((y)->os2.ou4.oconstraint).ofc = (8388607));
   }
   (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
   EnlargeToConstraint(&b, &f, &(y)->os2.ou4.oconstraint);
 }
 else
 ...
 {
# 502 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
   (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
 }
 else
 { (x)->os1.ou3.os31.oback[dim] = b;
 ...
 { tf = FindShift(y, x, dim);
   b = ((8388607) < (((0) < (b + tf) ? (b + tf) : (0))) ? (8388607) : (((0) < (b + tf) ? (b + tf) : (0))));
   f = ((8388607) < (((0) < (f - tf) ? (f - tf) : (0))) ? (8388607) : (((0) < (f - tf) ? (f - tf) : (0))));
 }
 break;
 ...
 { if( !(((y)->os1.ou1.os11.otype==16) == (dim==0)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AdjustSize: COL_THR!"); };
 (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
 b = ((b) < ((y)->os1.ou3.os31.oback[dim]) ? ((y)->os1.ou3.os31.oback[dim]) : (b));
 f = ((f) < ((y)->os1.ou3.os31.ofwd[dim]) ? ((y)->os1.ou3.os31.ofwd[dim]) : (f));
 break;
 ...
 Error(16, 4, "size adjustment of %s not implemented",
        2, &(y)->os1.ou1.ofpos, Image((y)->os1.ou1.os11.otype));
 break;
 ...
 { if( !((dim == 0) == ((y)->os1.ou1.os11.otype == 13)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AdjustSize: span"); };
 (x)->os1.ou3.os31.oback[dim] = b; (x)->os1.ou3.os31.ofwd[dim] = f;
 ...
 { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"AdjustSize:", Image((y)->os1.ou1.os11.otype)); };
 break;
