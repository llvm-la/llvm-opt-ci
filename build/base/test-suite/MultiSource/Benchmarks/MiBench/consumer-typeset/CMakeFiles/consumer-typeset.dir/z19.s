...
.LBB2_332:
	...
	ori	$a0, $zero, 3
	b	.LBB2_316
.LBB2_333:                              # %.preheader1058.preheader
	ori	$a0, $zero, 9
	ori	$a1, $zero, 90
	move	$a2, $s4
	b	.LBB2_335
	.p2align	4, , 16
.LBB2_334:                              # %.loopexit1055
                                        #   in Loop: Header=BB2_335 Depth=1
	addi.d	$a4, $a4, -9
	bgeu	$a1, $a4, .LBB2_358
.LBB2_335:                              # %.preheader1058
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB2_337 Depth 2
                                        #     Child Loop BB2_340 Depth 2
	ld.d	$a2, $a2, 8
	beq	$a2, $s4, .LBB2_359
# %bb.336:                              # %.preheader1056.preheader
                                        #   in Loop: Header=BB2_335 Depth=1
	move	$a3, $a2
	.p2align	4, , 16
.LBB2_337:                              # %.preheader1056
                                        #   Parent Loop BB2_335 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a3, 16
	ld.bu	$a4, $a3, 32
	beqz	$a4, .LBB2_337
# %bb.338:                              # %.preheader1056
                                        #   in Loop: Header=BB2_335 Depth=1
	bne	$a4, $a0, .LBB2_334
