# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c" 2


static int filter_count;
static OBJECT filter_active;
static OBJECT filter_in_filename;
static OBJECT filter_out_filename;
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
void FilterInit(void)
{ filter_count = 0;
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; filter_active = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  (FilterInSym)->os6.osym_body = MakeWord(11, ( (FULL_CHAR *) ("louti") ), no_fpos);
  (FilterOutSym)->os6.osym_body = MakeWord(11, ( (FULL_CHAR *) ("lout") ), no_fpos);
  (FilterErrSym)->os6.osym_body = MakeWord(11, ( (FULL_CHAR *) ("lout.err") ), no_fpos);
  filter_in_filename = (FilterInSym)->os6.osym_body;
  filter_out_filename = (FilterOutSym)->os6.osym_body;
}
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
OBJECT FilterCreate(unsigned use_begin, OBJECT act, FILE_POS *xfpos)
{ FULL_CHAR buff[2048]; FILE *fp; OBJECT x, res, junk;

                                     ;
  { ; { ; if( (zz_size=(zz_lengths[57])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 57; ; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  ( ((res)->os1.ou1.ofpos).ofile_num = (*xfpos).ofile_num, ((res)->os1.ou1.ofpos).oline_num = (*xfpos).oline_num, ((res)->os1.ou1.ofpos).ocol_num = (*xfpos).ocol_num );
  ++filter_count;
  sprintf( (char *) buff, "%s%d", ( (FULL_CHAR *) ("louti") ), filter_count);
  fp = fopen( (char *) (buff), ("w") );
  if( fp == ((void*)0) )
    Error(40, 1, "cannot open temporary filter file %s", 1, xfpos, buff);
  x = MakeWord(11, buff, xfpos);
  (x)->os1.ou2.os22.oword_colour = use_begin;
  (x)->os1.ou3.ofilter_actual = act;
  ...
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((filter_active)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  junk = LexScanVerbatim(fp, use_begin, xfpos, 0);
  fclose(fp);
  sprintf( (char *) buff, "%s%d", ( (FULL_CHAR *) ("lout") ), filter_count);
  x = MakeWord(11, buff, xfpos);
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((res)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  if( (act)->os1.ou2.os26.ohas_body ) PushScope(act, 0, 1);
  x = GetScopeSnapshot();
  if( (act)->os1.ou2.os26.ohas_body ) PopScope();
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((res)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
                                                                            ;
  return res;
}
# 107 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
void FilterSetFileNames(OBJECT x)
{ OBJECT y;
  { if( !((x)->os1.ou1.os11.otype == 57) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FilterSetFileNames: type(x)!"); };
  { if( !((x)->os1.olist[0].osucc != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FilterSetFileNames: x has no children!"); };
                                                                     ;
  for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
  { if( !((y)->os1.ou1.os11.otype == 11) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FilterSetFileNames: type(y)!"); };
  (FilterInSym)->os6.osym_body = y;
  for( y = (((x)->os1.olist[0].osucc)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
  { if( !((y)->os1.ou1.os11.otype == 11) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FilterSetFileNames: type(y) (2)!"); };
  (FilterOutSym)->os6.osym_body = y;
                                                 ;
}
# 130 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
OBJECT FilterExecute(OBJECT x, FULL_CHAR *command, OBJECT env)
{ int status; OBJECT t, res, scope_snapshot; char line[2048];
  FILE *err_fp; FILE_NUM filter_out_file;

  { if( !((x)->os1.ou1.os11.otype == 57) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FilterExecute: type(x)!"); };
  { if( !((env)->os1.ou1.os11.otype == 82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FilterExecute: type(env)!"); };

                             ;


  (FilterInSym)->os6.osym_body = filter_in_filename;

  if( SafeExecution )
  {

    Error(40, 2, "safe execution prohibiting command: %s", 2, &(x)->os1.ou1.ofpos,
      command);
  ...
  else
  {
    ...
    err_fp = fopen( (char *) (( (FULL_CHAR *) ("lout.err") )), ("r") );
    if( err_fp != ((void*)0) )
    { while( fgets(line, 2048, err_fp) != ((void*)0) )
      { if( line[strlen(line)-1] == '\n' )
   line[strlen(line)-1] = '\0';
        Error(40, 3, "%s", 2, &(x)->os1.ou1.ofpos, line);
      }
      fclose(err_fp);
      remove((char *)(( (FULL_CHAR *) ("lout.err") )));
    }
    if( status != 0 )
      Error(40, 4, "failure (non-zero status) of filter: %s",
        1, &(x)->os1.ou1.ofpos, command);
    ...
    for( scope_snapshot = ((x)->os1.olist[0].opred)->os1.olist[1].opred; (scope_snapshot)->os1.ou1.os11.otype == 0; scope_snapshot = (scope_snapshot)->os1.olist[1].opred );
    LoadScopeSnapshot(scope_snapshot);
                                                             ;
    filter_out_file =
      DefineFile(((FilterOutSym)->os6.osym_body)->os1.ostring, ( (FULL_CHAR *) ("") ), &(x)->os1.ou1.ofpos,
        10, 0);
    LexPush(filter_out_file, 0, 10, 1, 0);
    t = NewToken(104, &(x)->os1.ou1.ofpos, 0, 0, 1, FilterOutSym);
    res = Parse(&t, ( (OBJECT) ((void*)0) ), 0, 0);
    LexPop();
    ...
    remove((char *)(((FilterOutSym)->os6.osym_body)->os1.ostring));
    (FilterOutSym)->os6.osym_body = filter_out_filename;
  }

                                                               ;
  return res;
}
# 209 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
void FilterWrite(OBJECT x, FILE *fp, int *linecount)
{ FILE *in_fp; OBJECT y; int ch;
  { if( !((x)->os1.ou1.os11.otype == 57) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FilterWrite: type(x)!"); };
                                                                    ;
  for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
  in_fp = fopen( (char *) ((y)->os1.ostring), ("r") );
  if( in_fp == ((void*)0) )
    Error(40, 5, "cannot read filter temporary file %s",
      1, &(x)->os1.ou1.ofpos, (y)->os1.ostring);
  if( (y)->os1.ou2.os22.oword_colour )
  { fputs( (char *) (( (FULL_CHAR *) ("@Begin") )), (fp) );
    fputs( (char *) ("\n"), (fp) );
    *linecount += 1;
    ...
    fputs( (char *) (( (FULL_CHAR *) ("@End") )), (fp) );
    fputs( (char *) (" "), (fp) );
    fputs( (char *) (SymName((y)->os1.ou3.ofilter_actual)), (fp) );
  }
  else
  { fputs( (char *) (( (FULL_CHAR *) ("{") )), (fp) );
    fputs( (char *) ("\n"), (fp) );
    *linecount += 1;
    while( (ch = getc(in_fp)) != (-1) )
    { putc(ch, fp);
...
# 256 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z40.c"
void FilterScavenge(unsigned all)
{ OBJECT y, link, nextlink;
                         ;
                                                 ;
  for( link = (filter_active)->os1.olist[0].osucc; link != filter_active; link = nextlink )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    nextlink = (link)->os1.olist[0].osucc;
    if( all || (y)->os1.olist[1].osucc == (y)->os1.olist[1].opred )
    { ;
      remove((char *)((y)->os1.ostring));
