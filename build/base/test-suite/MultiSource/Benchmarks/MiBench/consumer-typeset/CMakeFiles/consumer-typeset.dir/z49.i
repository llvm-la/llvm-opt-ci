# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c" 2
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
unsigned Encapsulated;

typedef struct
{
  FONT_NUM gs_font;
  COLOUR_NUM gs_colour;
  unsigned gs_cpexists;
  FULL_LENGTH gs_currenty;
  short gs_xheight2;
} GRAPHICS_STATE;

static GRAPHICS_STATE gs_stack[50];
static int gs_stack_top;

static FONT_NUM currentfont;
static COLOUR_NUM currentcolour;
static short currentxheight2;
static unsigned cpexists;
static FULL_LENGTH currenty;

static int wordcount;
static int pagecount;
static unsigned prologue_done;
static OBJECT needs;
static OBJECT supplied;
static FILE *out_fp;
# 98 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
typedef struct
{ int linktab_size;
  int linktab_count;
  OBJECT linktab_item[1];
} *LINK_DEST_TABLE;
# 115 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
{ LINK_DEST_TABLE S; int i;
  ...
  if( S == (LINK_DEST_TABLE) ((void*)0) )
    Error(43, 1, "run out of memory enlarging link dest table", 1, no_fpos);
  (S)->linktab_size = newsize;
  (S)->linktab_count = 0;
  for( i = 0; i < newsize; i++ ) (S)->linktab_item[i] = ( (OBJECT) ((void*)0) );
  return S;
}
...
{ LINK_DEST_TABLE NewS; int i;
  ...
  for( i = 1; i <= (S)->linktab_size; i++ )
  { if( (S)->linktab_item[i] != ( (OBJECT) ((void*)0) ) )
      ltab_insert((S)->linktab_item[i], &NewS);
  }
  free(S);
  return NewS;
}
...
{ int pos; OBJECT z, link, y;
  if( (*S)->linktab_count == (*S)->linktab_size - 1 )
    *S = ltab_rehash(*S, 2*(*S)->linktab_size);
  { FULL_CHAR *p = (x)->os1.ostring; pos = *p++; while( *p ) pos += *p++; pos = pos % (*S)->linktab_size; };
  if( (*S)->linktab_item[pos] == ( (OBJECT) ((void*)0) ) ) { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; (*S)->linktab_item[pos] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  z = (*S)->linktab_item[pos];
  for( link = (z)->os1.olist[0].osucc; link != z; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (strcmp((char *)((x)->os1.ostring), (char *)((y)->os1.ostring))==0) )
    { Error(43, 2, "link name %s used twice (first at%s)",
 2, &(x)->os1.ou1.ofpos, (x)->os1.ostring, EchoFilePos(&(y)->os1.ou1.ofpos));
    }
  }
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = (((*S)->linktab_item[pos])), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
}

static OBJECT ltab_retrieve(FULL_CHAR *str, LINK_DEST_TABLE S)
{ OBJECT x, link, y; int pos;
  { FULL_CHAR *p = str; pos = *p++; while( *p ) pos += *p++; pos = pos % (S)->linktab_size; };
  x = (S)->linktab_item[pos];
  if( x == ( (OBJECT) ((void*)0) ) ) return ( (OBJECT) ((void*)0) );
  for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (strcmp((char *)(str), (char *)((y)->os1.ostring))==0) ) return y;
  }
  return ( (OBJECT) ((void*)0) );
}
# 198 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static LINK_DEST_TABLE link_dest_tab;
static OBJECT link_source_list;
# 226 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PS_PrintInitialize(FILE *fp)
{
  ...
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; needs = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; supplied = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
                                                  ;
  link_dest_tab = ltab_new(200);
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; link_source_list = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
}
# 252 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PS_PrintLength(FULL_CHAR *buff, int length, int length_dim)
{
  sprintf( (char *) buff, "%.3fc", (float) length/567);
}
# 272 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
  ...
  FULL_CHAR *font_name, FULL_CHAR *short_name)
{
  ...
  {
    MapEnsurePrinted((face)->os1.ou3.os32.ofont_mapping, font_curr_page);
    fprintf(out_fp, "/%s%s %s /%s LoutRecode\n",
      font_name, short_name,
      MapEncodingName((face)->os1.ou3.os32.ofont_mapping), font_name);
    fprintf(out_fp, "/%s { /%s%s LoutFont } def\n", short_name,
      font_name, short_name);
  }
  else fprintf(out_fp, "/%s { /%s LoutFont } def\n", short_name, font_name);
}
# 298 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PS_PrintPageResourceForFont(FULL_CHAR *font_name, unsigned first)
{
  fprintf(out_fp, "%s font %s\n", first ? "%%PageResources:" : "%%+",font_name);
}
# 312 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PS_PrintMapping(MAPPING m)
{ MAP_VEC map = MapTable[m]; int i;
  fprintf(out_fp, "%%%%BeginResource: encoding %s\n", (map->name)->os1.ostring);
  fprintf(out_fp, "/%s [\n", (map->name)->os1.ostring);
  for( i = 0; i < 256; i++ )
    fprintf(out_fp, "/%s%c", (map->vector[i])->os1.ostring, (i+1)%8 != 0 ? ' ' : '\n');
  fprintf(out_fp, "] def\n");
  fprintf(out_fp, "%%%%EndResource\n\n");
}
# 340 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static const char *MediaName(int h, int v)
{
    ...
    static const struct paper paper_map[] = {
       { "Letter", 612*20, 792*20 },
       { "Tabloid", 792*20, 1224*20 },
       { "Ledger", 1224*20, 792*20 },
       { "Legal", 612*20, 1008*20 },
       { "Statement", 396*20, 612*20 },
       { "Executive", 540*20, 720*20 },
       { "A3", 842*20, 1190*20 },
       { "A4", 595*20, 842*20 },
       { "A5", 420*20, 595*20 },
       { "B4", 729*20, 1032*20 },
       { "B5", 516*20, 729*20 },
       { "Folio", 612*20, 936*20 },
       { "Quarto", 610*20, 780*20 },
       { "10x14", 720*20, 1008*20 },
       { ((void*)0), 0, 0 }
    };
...
# 414 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
{ FILE_NUM fnum; FULL_CHAR *p;
  ...
  if( Encapsulated )
    ...
    fputs("%!PS-Adobe-3.0\n", out_fp);
  fprintf(out_fp, "%%%%Creator: %s\n", ( (FULL_CHAR *) ("Basser Lout Version 3.24 (October 2000)") ));
  fputs("%%%%CreationDate: Sometime Today\n", out_fp);
  fputs("%%DocumentData: Binary\n", out_fp);
  fputs("%%DocumentNeededResources: (atend)\n", out_fp);
  fputs("%%DocumentSuppliedResources: (atend)\n", out_fp);
  fprintf(out_fp, "%%%%DocumentMedia: %s %d %d 0 white ()\n", MediaName(h, v), h/20, v/20);
  ...
  fputs("/save_cp { currentpoint /cp_y exch def /cp_x exch def } def\n", out_fp);
  fputs("/restore_cp { cp_x cp_y moveto } def\n", out_fp);
  fputs("/outline { gsave 1 1 1 setrgbcolor dup show save_cp\n", out_fp);
  fputs("  grestore true charpath stroke restore_cp } bind def\n", out_fp);
  fputs("/m  { 3 1 roll moveto show } bind def\n", out_fp);
  fputs("/mo { 3 1 roll moveto outline } bind def\n", out_fp);
  fputs("/s  { exch currentpoint exch pop moveto show } bind def\n", out_fp);
  fputs("/so { exch currentpoint exch pop moveto outline } bind def\n", out_fp);
  fputs("/k  { exch neg 0 rmoveto show } bind def\n", out_fp);
  fputs("/ko { exch neg 0 rmoveto outline } bind def\n", out_fp);
  fputs("/r  { exch 0 rmoveto show } bind def\n", out_fp);
  fputs("/ro { exch 0 rmoveto outline } bind def\n", out_fp);
  fputs("/c  { gsave 3 1 roll rmoveto show grestore } bind def\n", out_fp);
  fputs("/co { gsave 3 1 roll rmoveto outline grestore } bind def\n", out_fp);
  fputs("/ul { gsave setlinewidth dup 3 1 roll\n", out_fp);
  fputs("      moveto lineto stroke grestore } bind def\n", out_fp);
  fprintf(out_fp, "/in { %d mul } def\n", 1440);
  fprintf(out_fp, "/cm { %d mul } def\n", 567);
  fprintf(out_fp, "/pt { %d mul } def\n", 20);
  fprintf(out_fp, "/em { %d mul } def\n", 120);
  fputs("/sp { louts mul } def\n", out_fp);
  fputs("/vs { loutv mul } def\n", out_fp);
  fputs("/ft { loutf mul } def\n", out_fp);
  fputs("/dg {           } def\n\n", out_fp);
  ...
  for( fnum = FirstFile(6); fnum != 0; fnum=NextFile(fnum) )
  { FULL_CHAR buff[512]; FILE *fp;
    if( (fp = OpenFile(fnum, 0, 0)) == ( (FILE *) ((void*)0) ) )
      Error(49, 3, "cannot open %s file %s", 2, PosOfFile(fnum),
 ( (FULL_CHAR *) ("@PrependGraphic") ), FileName(fnum));
    else if( fgets( (char *) (buff), (512), (fp) ) == ((void*)0) )
      Error(49, 4, "%s file %s is empty", 2, PosOfFile(fnum),
 ( (FULL_CHAR *) ("@PrependGraphic") ), FileName(fnum));
    else
    {
      if( StringBeginsWith(buff, ( (FULL_CHAR *) ("%%BeginResource:") )) )
      { OBJECT tmp;
 tmp = MakeWord(11, &buff[strlen("%%BeginResource:")], no_fpos);
 { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((supplied)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((tmp)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
      }
      else
 Error(49, 5, "%s file %s lacks PostScript BeginResource comment",
   2, PosOfFile(fnum), ( (FULL_CHAR *) ("@PrependGraphic") ), FileName(fnum));
      fputs( (char *) (buff), (out_fp) );
      fprintf(out_fp, "%% %s file %s\n", ( (FULL_CHAR *) ("@PrependGraphic") ), mybasename(FileName(fnum)));
 ...
 fputs( (char *) (buff), (out_fp) );
  ...
  fputs("/pdfmark where {pop} {userdict /pdfmark /cleartomark load put} ifelse\n", out_fp);
...
# 579 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PS_PrintAfterLastPage(void)
{ OBJECT x, link; unsigned first_need;
  if( prologue_done )
  {
    fprintf(out_fp, "\npgsave restore\nshowpage\n");
    fprintf(out_fp, "\n%%%%Trailer\n");
    ...
    for( link = (needs)->os1.olist[0].osucc; link != needs; link = (link)->os1.olist[0].osucc )
    { for( x = (link)->os1.olist[1].opred; (x)->os1.ou1.os11.otype == 0; x = (x)->os1.olist[1].opred );
      { if( !((((x)->os1.ou1.os11.otype) == 11 || ((x)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintAfterLast: needs!"); };
      fprintf(out_fp, "%s %s",
 first_need ? "%%DocumentNeededResources:" : "%%+", (x)->os1.ostring);
      first_need = 0;
    }
    ...
    fprintf(out_fp, "%%%%DocumentSuppliedResources: procset %s\n",
      "LoutStartUp");
    for( link = (supplied)->os1.olist[0].osucc; link != supplied; link = (link)->os1.olist[0].osucc )
    { for( x = (link)->os1.olist[1].opred; (x)->os1.ou1.os11.otype == 0; x = (x)->os1.olist[1].opred );
      fprintf(out_fp, "%%%%+ %s", (x)->os1.ostring);
    }
...
# 622 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 685 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PrintComposite(COMPOSITE *cp, unsigned outline, FILE *fp)
{ ;
...
# 706 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
{ FULL_CHAR *p, *q, *a, *b, *lig, *unacc;
  ...
  if( (x)->os1.ou2.os22.oword_font != currentfont )
  { currentfont = (x)->os1.ou2.os22.oword_font;
  ...
  if( (x)->os1.ou2.os22.oword_colour != currentcolour )
  { currentcolour = (x)->os1.ou2.os22.oword_colour;
    if( currentcolour > 0 )
  ...
  *q = '\0';
  ...
  cmp = finfo[(x)->os1.ou2.os22.oword_font].cmp_table;
  composite = finfo[(x)->os1.ou2.os22.oword_font].composite;
                                                             ;
  vpos = vpos - currentxheight2;
  if( cpexists && currenty == vpos )
  { { char buff[20]; register int i, y; if( hpos >= 0 ) y = hpos; else { y = -hpos; putc('-', out_fp); } i = 0; do { buff[i++] = ( (y % 10) + '0' ); } while( (y = (y / 10)) > 0 ); do { --i; putc(buff[i], out_fp); } while( i ); };
    command = (x)->os1.ou2.os22.oword_outline ? "so" : "s";
  }
  else
  { currenty = vpos;
    { char buff[20]; register int i, y; if( hpos >= 0 ) y = hpos; else { y = -hpos; putc('-', out_fp); } i = 0; do { buff[i++] = ( (y % 10) + '0' ); } while( (y = (y / 10)) > 0 ); do { --i; putc(buff[i], out_fp); } while( i ); };
    putc(' ', out_fp);
    { char buff[20]; register int i, y; if( currenty >= 0 ) y = currenty; else { y = -currenty; putc('-', out_fp); } i = 0; do { buff[i++] = ( (y % 10) + '0' ); } while( (y = (y / 10)) > 0 ); do { --i; putc(buff[i], out_fp); } while( i ); };
    command = (x)->os1.ou2.os22.oword_outline ? "mo" : "m";
    cpexists = 1;
  }
  ...
  if( composite[*p] )
  {
    fprintf(out_fp, ")%s ", command);
                                                           ...
                                                           ;
    PrintComposite(&cmp[composite[*p]], (x)->os1.ou2.os22.oword_outline, out_fp);
    { char buff[20]; register int i, y; if( finfo[(x)->os1.ou2.os22.oword_font].size_table[*p].right >= 0 ) y = finfo[(x)->os1.ou2.os22.oword_font].size_table[*p].right; else { y = -finfo[(x)->os1.ou2.os22.oword_font].size_table[*p].right; putc('-', out_fp); } i = 0; do { buff[i++] = ( (y % 10) + '0' ); } while( (y = (y / 10)) > 0 ); do { --i; putc(buff[i], out_fp); } while( i ); };
    putc('(', out_fp);
    command = (x)->os1.ou2.os22.oword_outline ? "ro" : "r";
  }
...
# 841 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PS_PrintPlainGraphic(OBJECT x, FULL_LENGTH xmk,
  FULL_LENGTH ymk, OBJECT z)
{
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PS_PrintPlainGraphic: this routine should never be called!"); };
}
# 857 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 891 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 908 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 924 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 946 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 973 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
# 994 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
{ OBJECT y, link;
  ...
  switch( (x)->os1.ou1.os11.otype )
  {
    ...
    case 12:
      ...
      fputs( (char *) ((x)->os1.ostring), (out_fp) );
      break;
    ...
    case 17:
      ...
      for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
      { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 if( (y)->os1.ou1.os11.otype == 1 )
 {
   if( (y)->os1.ou2.os21.ovspace > 0 ) fputs("\n", out_fp);
   else if( (y)->os1.ou2.os21.ohspace > 0 ) fputs(" ", out_fp);
 }
 else if( (((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) || (y)->os1.ou1.os11.otype == 17 )
   PS_PrintGraphicObject(y);
 else if( (y)->os1.ou1.os11.otype == 26 || (((y)->os1.ou1.os11.otype) >= 119 && ((y)->os1.ou1.os11.otype) <= 138) )
 {

 }
 else
 { Error(49, 8, "error in left parameter of %s",
     2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Graphic") ));
                                                        ;
                                  ;
 }
      }
    ...
    default:
      ...
      Error(49, 9, "error in left parameter of %s", 2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Graphic") ));
                                                           ;
                                     ;
      break;
...
# 1052 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
void PS_DefineGraphicNames(OBJECT x)
{ { if( !((x)->os1.ou1.os11.otype == 97) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintGraphic: type(x) != GRAPHIC!"); };
                                                           ;
                                                            ;


  if( ((x)->os2.ou4.osave_style).ofont != currentfont )
  { currentfont = ((x)->os2.ou4.osave_style).ofont;
    if( currentfont > 0 )
    { currentxheight2 = FontHalfXHeight(currentfont);
 ...
 FontName(currentfont));
  ...
  if( ((x)->os2.ou4.osave_style).ocolour != currentcolour )
  { currentcolour = ((x)->os2.ou4.osave_style).ocolour;
    if( currentcolour > 0 )
      fprintf(out_fp, "%s ", ColourCommand(currentcolour));
  }
  ...
  fprintf(out_fp, "%d %d %d %d %d %d %d LoutGraphic\n",
    ((x)->os1.ou3.os31.oback[0] + (x)->os1.ou3.os31.ofwd[0]), ((x)->os1.ou3.os31.oback[1] + (x)->os1.ou3.os31.ofwd[1]), (x)->os1.ou3.os31.oback[0], (x)->os1.ou3.os31.ofwd[1],
    currentfont <= 0 ? 12*20 : FontSize(currentfont, x),
    (((x)->os2.ou4.osave_style).osu1.oline_gap).owidth, (((x)->os2.ou4.osave_style).osu2.ospace_gap).owidth);
                                                    ;
}
# 1098 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
void PS_SaveTranslateDefineSave(OBJECT x, FULL_LENGTH xdist, FULL_LENGTH ydist)
{
  if( gs_stack_top >= 50 - 1 || ((x)->os2.ou4.osave_style).ofont != currentfont ||
      ((x)->os2.ou4.osave_style).ocolour!=currentcolour )
  {
...
# 1166 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static unsigned strip_out(FULL_CHAR *buff)
{ if( StringBeginsWith(buff, ( (FULL_CHAR *) ("%%EOF") )) ) return 1;
  if( StringBeginsWith(buff, ( (FULL_CHAR *) ("%%Trailer") )) ) return 1;
  return 0;
}

void PS_PrintGraphicInclude(OBJECT x, FULL_LENGTH colmark, FULL_LENGTH rowmark)
{ OBJECT y, full_name; FULL_CHAR buff[512];
  FILE *fp; int state; unsigned compressed;
                                             ;

  { if( !((x)->os1.ou1.os11.otype==94 || (x)->os1.ou1.os11.otype==95) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintGraphicInclude!"); };
  { if( !((x)->os1.ou2.os23.ocross_type) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintGraphicInclude: !incgraphic_ok(x)!"); };


  for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
  fp = OpenIncGraphicFile((y)->os1.ostring, (x)->os1.ou1.os11.otype, &full_name,&(y)->os1.ou1.ofpos,&compressed);
  { if( !(fp != ((void*)0)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintGraphicInclude: fp!"); };
  ...
  PS_CoordTranslate(colmark - (x)->os1.ou3.os31.oback[0], rowmark - (x)->os1.ou3.os31.ofwd[1]);
  PS_CoordScale( (float) 20, (float) 20 );
  PS_CoordTranslate(-(y)->os1.ou3.os31.oback[0], -(y)->os1.ou3.os31.oback[1]);
  fprintf(out_fp, "%%%%BeginDocument: %s\n", (full_name)->os1.ostring);



  state = (fgets( (char *) (buff), (512), (fp) ) == ((void*)0)) ? 2 : 0;
  while( state != 2 ) switch(state)
  {
    case 0:

      if( StringBeginsWith(buff, ( (FULL_CHAR *) ("%%DocumentNeededResources:") )) &&
   !StringContains(buff, ( (FULL_CHAR *) ("(atend)") )) )
      { y = MakeWord(11, &buff[strlen((char *)("%%DocumentNeededResources:"))],
       no_fpos);
        { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((needs)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((y)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
 state = (fgets( (char *) (buff), (512), (fp) )==((void*)0)) ? 2 : 1;
      }
      else
      { if( StringBeginsWith(buff, ( (FULL_CHAR *) ("%%LanguageLevel:") )) )
   Error(49, 10, "ignoring LanguageLevel comment in %s file %s",
     2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@IncludeGraphic") ), (full_name)->os1.ostring);
 if( StringBeginsWith(buff, ( (FULL_CHAR *) ("%%Extensions:") )) )
   Error(49, 11, "ignoring Extensions comment in %s file %s",
     2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@IncludeGraphic") ), (full_name)->os1.ostring);
 if( !strip_out(buff) ) fputs( (char *) (buff), (out_fp) );
 state = (fgets( (char *) (buff), (512), (fp) ) == ((void*)0)) ? 2 : 0;
      }
      break;
    ...
    case 1:
      ...
      if( StringBeginsWith(buff, ( (FULL_CHAR *) ("%%+") )) )
      { x = MakeWord(11, &buff[strlen((char *)(( (FULL_CHAR *) ("%%+") )))], no_fpos);
 { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((needs)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
 state = (fgets( (char *) (buff), (512), (fp) )==((void*)0)) ? 2 : 1;
      }
      else
 ...
 state = (fgets( (char *) (buff), (512), (fp) ) == ((void*)0)) ? 2 : 0;
  ...
  fclose(fp);
  if( compressed ) remove((char *)(( (FULL_CHAR *) ("lout.eps") )));
  fprintf(out_fp, "\n%%%%EndDocument\nEndEPSF\n");
  wordcount = 0;
                                                     ;
}
# 1273 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
{ static char buff[200];
  ...
  strcpy(buff, "LOUT");
  q = &buff[strlen(buff)];
  for( p = (name)->os1.ostring; *p != '\0'; p++ )
  {
    if( q >= &buff[199] )
      Error(49, 12, "tag %s is too long", 1, &(name)->os1.ou1.ofpos, (name)->os1.ostring);
...
# 1301 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
{ ;
  ...
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((link_source_list)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((name)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
                                            ;
}
# 1326 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
{ OBJECT prev;
  ...
  prev = ltab_retrieve((name)->os1.ostring, link_dest_tab);
  if( prev == ( (OBJECT) ((void*)0) ) )
  {
  ...
  else
  {
    ...
    Error(49, 13, "link destination %s ignored (there is already one at%s)",
      2, &(name)->os1.ou1.ofpos, (name)->os1.ostring, EchoFilePos(&(prev)->os1.ou1.ofpos));
  }
                                          ;
}
# 1358 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static void PS_LinkCheck()
{ OBJECT y, link;
                                  ;

  for( link=(link_source_list)->os1.olist[0].osucc; link!=link_source_list; link=(link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    { if( !((((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, " PS_LinkCheck: !is_word(type(y))!"); };
    if( ltab_retrieve((y)->os1.ostring, link_dest_tab) == ( (OBJECT) ((void*)0) ) )
      Error(49, 14, "link name %s has no destination point", 2, &(y)->os1.ou1.ofpos,
 (y)->os1.ostring);
  }

                                           ;
}
# 1382 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
static struct back_end_rec ps_back = {
  0,
  ( (FULL_CHAR *) ("PostScript") ),
  1,
  1,
  1,
  1,
