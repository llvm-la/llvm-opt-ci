# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c" 2
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c"
...
{ OBJECT y, link; FULL_LENGTH b, f, sb, sf; CONSTRAINT yc;
  ...
  sb = sf = 0;
  for( link = start; link != (stop)->os1.olist[0].osucc; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( !(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) continue;
    sb = ((sb) < ((y)->os1.ou3.os31.oback[0]) ? ((y)->os1.ou3.os31.oback[0]) : (sb));
    sf = ((sf) < ((y)->os1.ou3.os31.ofwd[0]) ? ((y)->os1.ou3.os31.ofwd[0]) : (sf));
  }
  if( sb <= (*c).obc )
  {
  ...
  ((yc).obc = ((((*c).obc) < ((*c).obfc-f) ? ((*c).obc) : ((*c).obfc-f))), (yc).obfc = ((*c).obfc), (yc).ofc = ((((*c).ofc) < ((*c).obfc-b) ? ((*c).ofc) : ((*c).obfc-b))));
  ...
  if( m != ( (OBJECT) ((void*)0) ) )
  {
                          ...
                          ;
    m = BreakObject(m, &yc);
    b = (m)->os1.ou3.os31.oback[0];
    f = (m)->os1.ou3.os31.ofwd[0];
    ((yc).obc = ((((yc).obc) < ((yc).obfc-f) ? ((yc).obc) : ((yc).obfc-f))), (yc).obfc = ((yc).obfc), (yc).ofc = ((((yc).ofc) < ((yc).obfc-b) ? ((yc).ofc) : ((yc).obfc-b))));
  }
  else b = f = 0;
  for( link = start; link != (stop)->os1.olist[0].osucc; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( !(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) || y == m ) continue;

                          ;
    y = BreakObject(y, &yc);
    b = ((b) < ((y)->os1.ou3.os31.oback[0]) ? ((y)->os1.ou3.os31.oback[0]) : (b));
    f = ((f) < ((y)->os1.ou3.os31.ofwd[0]) ? ((y)->os1.ou3.os31.ofwd[0]) : (f));
    ((yc).obc = ((((yc).obc) < ((yc).obfc-f) ? ((yc).obc) : ((yc).obfc-f))), (yc).obfc = ((yc).obfc), (yc).ofc = ((((yc).ofc) < ((yc).obfc-b) ? ((yc).ofc) : ((yc).obfc-b))));
  }
  ...
  { ;
    ...
    Error(13, 1, "failed to break column to fit into its available space",
      2, m != ( (OBJECT) ((void*)0) ) ? &(m)->os1.ou1.ofpos : (y != ( (OBJECT) ((void*)0) ) ? &(y)->os1.ou1.ofpos : no_fpos));
  }
  *res_back = b; *res_fwd = f;

                              ;
}
# 119 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c"
static OBJECT BreakVcat(OBJECT x, CONSTRAINT *c)
{ OBJECT y, link, start_group, m; FULL_LENGTH b, f, dble_fwd; CONSTRAINT tc;
  unsigned dble_found;
                                                          ;
  { if( !((x)->os1.olist[0].osucc != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakVcat: Down(x) == x!"); };
  ((tc).obc = (8388607), (tc).obfc = ((((*c).obfc) < ((*c).ofc) ? ((*c).obfc) : ((*c).ofc))), (tc).ofc = (8388607));

  dble_found = 0; dble_fwd = 0; start_group = ( (OBJECT) ((void*)0) );
  for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (((y)->os1.ou1.os11.otype) >= 119 && ((y)->os1.ou1.os11.otype) <= 138) ) continue;
    if( (y)->os1.ou1.os11.otype == 1 )
    { { if( !(start_group != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakVcat: start_group == nilobj!"); };
      if( !((y)->os5.ogap).ojoin )
      {

 if( !(b <= (tc).obc && b + f <= (tc).obfc && f <= (tc).ofc) )
 ...
 start_group = ( (OBJECT) ((void*)0) );
    ...
    else if( start_group == ( (OBJECT) ((void*)0) ) )
    {

      b = (y)->os1.ou3.os31.oback[0]; f = (y)->os1.ou3.os31.ofwd[0];
    ...
    else
    {
      ...
      b = ((b) < ((y)->os1.ou3.os31.oback[0]) ? ((y)->os1.ou3.os31.oback[0]) : (b)); f = ((f) < ((y)->os1.ou3.os31.ofwd[0]) ? ((y)->os1.ou3.os31.ofwd[0]) : (f));
      if( (y)->os1.ou3.os31.ofwd[0] > (m)->os1.ou3.os31.ofwd[0] ) m = y;
  ...
  { if( !(start_group != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakVcat: start_group == nilobj (2)!"); };

  if( dble_found )
  {

    if( !(b <= (tc).obc && b + f <= (tc).obfc && f <= (tc).ofc) )
      BreakJoinedGroup(start_group, (x)->os1.olist[0].opred, m, &tc, &b, &f);
    dble_fwd = ((dble_fwd) < (b + f) ? (b + f) : (dble_fwd));
                                                                             ;
    (x)->os1.ou3.os31.oback[0] = 0; (x)->os1.ou3.os31.ofwd[0] = ((8388607) < (dble_fwd) ? (8388607) : (dble_fwd));
  }
  else
  {
                              ...
                              ;
    BreakJoinedGroup(start_group, (x)->os1.olist[0].opred, m, c, &b, &f);
    (x)->os1.ou3.os31.oback[0] = b; (x)->os1.ou3.os31.ofwd[0] = f;
  }
...
# 220 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c"
static OBJECT BreakTable(OBJECT x, CONSTRAINT *c)
{ FULL_LENGTH bwidth, fwidth;
  int bcount, fcount;
  OBJECT mlink, my;
  unsigned ratm;
  int mside;
  ...
  OBJECT pg, prec_def;
  OBJECT sg, succ_def;
  FULL_LENGTH pd_extra,sd_extra;
  FULL_LENGTH av_colsize;

  FULL_LENGTH fwd_max, back_max;

  FULL_LENGTH col_size;
  FULL_LENGTH prev_col_size;
  FULL_LENGTH beffect, feffect;
  ...
  bcount = fcount = 0; bwidth = fwidth = 0; prev = ( (OBJECT) ((void*)0) );
  prev_col_size = 0;
  for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
  { if( !((y)->os1.ou1.os11.otype != 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: GAP_OBJ!"); };
  { if( !(!(((y)->os1.ou1.os11.otype) >= 119 && ((y)->os1.ou1.os11.otype) <= 138)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: index!"); };
  (y)->os1.ou3.os31.oback[1] = (((y)->os1.ou1.os11.otype) >= 2 && ((y)->os1.ou1.os11.otype) <= 8);
  if( !(y)->os1.ou3.os31.oback[1] ) prev = y, fcount = 1;

  for( link = ((x)->os1.olist[0].osucc)->os1.olist[0].osucc; link != x; link = ((link)->os1.olist[0].osucc)->os1.olist[0].osucc )
  {

    for( g = (link)->os1.olist[1].opred; (g)->os1.ou1.os11.otype == 0; g = (g)->os1.olist[1].opred );
    { if( !((g)->os1.ou1.os11.otype == 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: GAP_OBJ!"); };
    { if( !((link)->os1.olist[0].osucc != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: GAP_OBJ is last!"); };
    for( y = ((link)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );

    { if( !((y)->os1.ou1.os11.otype != 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: GAP_OBJ!"); };
    { if( !(!(((y)->os1.ou1.os11.otype) >= 119 && ((y)->os1.ou1.os11.otype) <= 138)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: index!"); };
    (y)->os1.ou3.os31.oback[1] = (((y)->os1.ou1.os11.otype) >= 2 && ((y)->os1.ou1.os11.otype) <= 8);
    if( !(y)->os1.ou3.os31.oback[1] )
    { if( prev == ( (OBJECT) ((void*)0) ) ) fcount = 1;
      else if( ((g)->os5.ogap).omark )
      { bcount += fcount;
 bwidth += fwidth + MinGap(0, 0, 0, &(g)->os5.ogap);
 fcount = 1; fwidth = 0;
      }
      else
      { fwidth += MinGap(0, 0, 0, &(g)->os5.ogap);
 fcount += 1;
      }
      prev = y;
    }
  ...
  if( !(bwidth <= (*c).obc && bwidth + fwidth <= (*c).obfc && fwidth <= (*c).ofc) )
  {
    ...
    for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
    { for( g = (link)->os1.olist[1].opred; (g)->os1.ou1.os11.otype == 0; g = (g)->os1.olist[1].opred );
      if( (g)->os1.ou1.os11.otype == 1 )
      { ( ((g)->os5.ogap).onobreak = ((g)->os5.ogap).onobreak, ((g)->os5.ogap).omark = ((g)->os5.ogap).omark, ((g)->os5.ogap).ojoin = ((g)->os5.ogap).ojoin, ((g)->os5.ogap).ounits = 1, ((g)->os5.ogap).omode = 1, ((g)->os5.ogap).owidth = 0 );
  ...
  while( bcount + fcount > 0 && (bwidth <= (*c).obc && bwidth + fwidth <= (*c).obfc && fwidth <= (*c).ofc) )
  {
                                                                          ;
                                                                          ;


    my = ( (OBJECT) ((void*)0) ); msize = ((x)->os1.ou3.os31.oback[0] + (x)->os1.ou3.os31.ofwd[0]);
    for( link = (x)->os1.olist[0].osucc; ; link = (link)->os1.olist[0].osucc )
    { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      { if( !((y)->os1.ou1.os11.otype != 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: type(y) == GAP_OBJ!"); };
      if( !(y)->os1.ou3.os31.oback[1] && (((y)->os1.ou3.os31.oback[0] + (y)->os1.ou3.os31.ofwd[0]) < msize || my == ( (OBJECT) ((void*)0) )) )
      { msize = ((y)->os1.ou3.os31.oback[0] + (y)->os1.ou3.os31.ofwd[0]);
 my = y; mlink = link;
 ratm = 0;
      }
      ...
      if( link == x ) break;
      for( g = (link)->os1.olist[1].opred; (g)->os1.ou1.os11.otype == 0; g = (g)->os1.olist[1].opred );
      { if( !((g)->os1.ou1.os11.otype == 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: type(g) != GAP_OBJ!"); };
      if( ((g)->os5.ogap).omark ) ratm = 1;
    }


    SetNeighbours(mlink, ratm, &pg, &prec_def, &sg, &succ_def, &mside);
                                                                ;
    pd_extra = pg == ( (OBJECT) ((void*)0) ) ? 0 :
      ExtraGap((prec_def)->os1.ou3.os31.oback[1] ? (prec_def)->os1.ou3.os31.ofwd[0] : 0, 0, &(pg)->os5.ogap, 151);
    sd_extra = sg == ( (OBJECT) ((void*)0) ) ? 0 :
      ExtraGap(0, (succ_def)->os1.ou3.os31.oback[1] ? (succ_def)->os1.ou3.os31.oback[0] : 0, &(sg)->os5.ogap, 153);

                                              ;


    av_colsize = ((*c).obfc - bwidth - fwidth) / (bcount + fcount);
                                                              ;
                                                                    ;
    switch( mside )
    {
 ...
 back_max = (((*c).obc) < (bwidth + av_colsize * bcount) ? ((*c).obc) : (bwidth + av_colsize * bcount));
 col_size = (back_max - bwidth) / bcount;
 if( col_size > prev_col_size && col_size - prev_col_size < 20 )
   col_size = prev_col_size;
 ((mc).obc = (((8388607) < (col_size + pd_extra) ? (8388607) : (col_size + pd_extra))), (mc).obfc = (((8388607) < (col_size + pd_extra + sd_extra) ? (8388607) : (col_size + pd_extra + sd_extra))), (mc).ofc = (((8388607) < (col_size + sd_extra) ? (8388607) : (col_size + sd_extra))));
 ...
 fwd_max = (((*c).ofc) < (fwidth + av_colsize * fcount) ? ((*c).ofc) : (fwidth + av_colsize * fcount));
 col_size = (fwd_max - fwidth) / fcount;
 if( col_size > prev_col_size && col_size - prev_col_size < 20 )
   col_size = prev_col_size;
 ((mc).obc = (((8388607) < (pd_extra + (my)->os1.ou3.os31.oback[0]) ? (8388607) : (pd_extra + (my)->os1.ou3.os31.oback[0]))), (mc).obfc = (((8388607) < (pd_extra + (my)->os1.ou3.os31.oback[0] + col_size + sd_extra) ? (8388607) : (pd_extra + (my)->os1.ou3.os31.oback[0] + col_size + sd_extra))), (mc).ofc = (((8388607) < (col_size + sd_extra) ? (8388607) : (col_size + sd_extra))));
 ...
 { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: mside"); };
 break;
    }
                                                          ;
    prev_col_size = col_size;
                          ...
                          ;
    my = BreakObject(my, &mc); (my)->os1.ou3.os31.oback[1] = 1;


    if( pg != ( (OBJECT) ((void*)0) ) )
    { tmp = (prec_def)->os1.ou3.os31.oback[1] ? (prec_def)->os1.ou3.os31.ofwd[0] : 0;
      beffect = MinGap(tmp, (my)->os1.ou3.os31.oback[0], (my)->os1.ou3.os31.ofwd[0], &(pg)->os5.ogap) -
         MinGap(tmp, 0, 0, &(pg)->os5.ogap);
    }
    else beffect = (my)->os1.ou3.os31.oback[0];

    if( sg != ( (OBJECT) ((void*)0) ) )
    { tmp = (succ_def)->os1.ou3.os31.oback[1] ? (succ_def)->os1.ou3.os31.oback[0] : 0;
      tmp2 = (succ_def)->os1.ou3.os31.oback[1] ? (succ_def)->os1.ou3.os31.ofwd[0] : 0;
      feffect = MinGap((my)->os1.ou3.os31.ofwd[0], tmp, tmp2, &(sg)->os5.ogap) -
         MinGap(0, tmp, tmp2, &(sg)->os5.ogap);
    }
    else feffect = (my)->os1.ou3.os31.ofwd[0];

    switch( mside )
    {
 case 151: bwidth += beffect + feffect;
   bcount--;
   break;

 case 152: bwidth += beffect; fwidth += feffect;
   fcount--;
   break;

 case 153: fwidth += beffect + feffect;
   fcount--;
   break;

 default: { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakTable: mside"); };
   break;
    }

  }

  (x)->os1.ou3.os31.oback[0] = bwidth;
  (x)->os1.ou3.os31.ofwd[0] = fwidth;
...
# 443 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c"
OBJECT BreakObject(OBJECT x, CONSTRAINT *c)
{ OBJECT link, y; CONSTRAINT yc; FULL_LENGTH f; unsigned junk;
  ...
  if( !((*c).obc>=0 && (*c).obfc>=0 && (*c).ofc>=0) )
  {
    Error(13, 11, "replacing with empty object: negative size constraint %s,%s,%s",
      2, &(x)->os1.ou1.ofpos, EchoLength((*c).obc), EchoLength((*c).obfc), EchoLength((*c).ofc));
  ...
  if( ((x)->os1.ou3.os31.oback[0] <= (*c).obc && (x)->os1.ou3.os31.oback[0] + (x)->os1.ou3.os31.ofwd[0] <= (*c).obfc && (x)->os1.ou3.os31.ofwd[0] <= (*c).ofc) )
  { ;
  ...
  switch( (x)->os1.ou1.os11.otype )
  {
    ...
    case 50:
      ...
      {
 for( x = ((x)->os1.olist[1].osucc)->os1.olist[0].opred; (x)->os1.ou1.os11.otype == 0; x = (x)->os1.olist[0].opred );
 Error(13, 3, "%s object scaled horizontally by factor %.2f (too wide)",
   2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Rotate") ), (float) ((x)->os2.ou4.oconstraint).obc / 128 );
      }
      else
      { Error(13, 4, "%s deleted (too wide; cannot break %s)",
   2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Rotate") ), ( (FULL_CHAR *) ("@Rotate") ));
        y = MakeWord(11, ( (FULL_CHAR *) ("") ), &(x)->os1.ou1.ofpos);
        (y)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.ofwd[0] = 0;
        ( xx_tmp = ( zz_hold = ((x)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((y)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) );
        DisposeObject(x);
    ...
    case 34:
      ...
      InvScaleConstraint(&yc, ((x)->os2.ou4.oconstraint).obc, c);
      for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      y = BreakObject(y, &yc);
      (x)->os1.ou3.os31.oback[0] = ((y)->os1.ou3.os31.oback[0] * ((x)->os2.ou4.oconstraint).obc) / 128;
      (x)->os1.ou3.os31.ofwd[0] = ((y)->os1.ou3.os31.ofwd[0] * ((x)->os2.ou4.oconstraint).obc) / 128;
      break;
    ...
    case 35:
      ...
      y = BreakObject(y, c);
      (x)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.oback[0];
      (x)->os1.ou3.os31.ofwd[0] = (y)->os1.ou3.os31.ofwd[0];
      break;
 ...
 (y)->os1.ou3.os31.oback[0] = (x)->os1.ou3.os31.oback[0];
 (y)->os1.ou3.os31.ofwd[0] = (x)->os1.ou3.os31.ofwd[0];
 (y)->os1.ou3.os31.oback[1] = (x)->os1.ou3.os31.oback[1];
 (y)->os1.ou3.os31.ofwd[1] = (x)->os1.ou3.os31.ofwd[1];


 ( (((y)->os2.ou4.osave_style).osu1.oline_gap).onobreak = 0, (((y)->os2.ou4.osave_style).osu1.oline_gap).omark = 0, (((y)->os2.ou4.osave_style).osu1.oline_gap).ojoin = 0, (((y)->os2.ou4.osave_style).osu1.oline_gap).ounits = 1, (((y)->os2.ou4.osave_style).osu1.oline_gap).omode = 3, (((y)->os2.ou4.osave_style).osu1.oline_gap).owidth = 1.1 * FontSize((x)->os1.ou2.os22.oword_font, x) );

 ( (((y)->os2.ou4.osave_style).osu2.ospace_gap).onobreak = 0, (((y)->os2.ou4.osave_style).osu2.ospace_gap).omark = 0, (((y)->os2.ou4.osave_style).osu2.ospace_gap).ojoin = 1, (((y)->os2.ou4.osave_style).osu2.ospace_gap).ounits = 1, (((y)->os2.ou4.osave_style).osu2.ospace_gap).omode = 1, (((y)->os2.ou4.osave_style).osu2.ospace_gap).owidth = 0 );

 ((y)->os2.ou4.osave_style).osu2.oss2.ohyph_style = 2;
 ((y)->os2.ou4.osave_style).osu2.oss2.ofill_style = 2;
 ((y)->os2.ou4.osave_style).osu2.oss2.odisplay_style = 4;
 ((y)->os2.ou4.osave_style).osu1.oss1.osmall_caps = 0;
 ((y)->os2.ou4.osave_style).ofont = (x)->os1.ou2.os22.oword_font;
 ((y)->os2.ou4.osave_style).ocolour = (x)->os1.ou2.os22.oword_colour;
 ((y)->os2.ou4.osave_style).ooutline = (x)->os1.ou2.os22.oword_outline;
 ((y)->os2.ou4.osave_style).olanguage = (x)->os1.ou2.os22.oword_language;
 ...
 Error(13, 5, "word %s scaled horizontally by factor %.2f (too wide)",
   2, &(x)->os1.ou1.ofpos, (tmp)->os1.ostring, (float) ((x)->os2.ou4.oconstraint).obc / 128);
      }
      else
      { Error(13, 6, "word %s deleted (too wide)", 2, &(x)->os1.ou1.ofpos, (x)->os1.ostring);
        y = MakeWord(11, ( (FULL_CHAR *) ("") ), &(x)->os1.ou1.ofpos);
        (y)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.ofwd[0] = 0;
        ( xx_tmp = ( zz_hold = ((x)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((y)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) );
        DisposeObject(x);
    ...
    case 26:
      ...
      MinConstraint(&(x)->os2.ou4.oconstraint, c);
      for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      y = BreakObject(y, &(x)->os2.ou4.oconstraint);
      (x)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.oback[0];
      (x)->os1.ou3.os31.ofwd[0] = (y)->os1.ou3.os31.ofwd[0];
      EnlargeToConstraint(&(x)->os1.ou3.os31.oback[0], &(x)->os1.ou3.os31.ofwd[0], &(x)->os2.ou4.oconstraint);
      break;
 ...
 Error(13, 7, "%s scaled horizontally by factor %.2f (too wide)",
   ...
   (float) ((x)->os2.ou4.oconstraint).obc / 128);
      }
      else
      { Error(13, 8, "%s deleted (too wide)", 2, &(x)->os1.ou1.ofpos,
   (x)->os1.ou1.os11.otype == 94 ? ( (FULL_CHAR *) ("@IncludeGraphic") ) : ( (FULL_CHAR *) ("@SysIncludeGraphic") ));
        y = MakeWord(11, ( (FULL_CHAR *) ("") ), &(x)->os1.ou1.ofpos);
        (y)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.ofwd[0] = 0;
        ( xx_tmp = ( zz_hold = ((x)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((y)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) );
    ...
    case 13:
      ...
      { if( !((x)->os1.olist[0].osucc == (x)->os1.olist[0].opred) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakObject: downs!"); };
      for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      y = BreakObject(y, c);
      (x)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.oback[0];
      (x)->os1.ou3.os31.ofwd[0] = (y)->os1.ou3.os31.ofwd[0];
    ...
    case 45:
    case 46:
# 658 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z13.c"
      for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      if( (y)->os1.ou1.os11.otype != 13 )
      {
        y = BreakObject(y, c);
        (x)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.oback[0];
        (x)->os1.ou3.os31.ofwd[0] = (y)->os1.ou3.os31.ofwd[0];
      ...
      else
      {
        ...
        (x)->os1.ou3.os31.ofwd[0] = (((*c).obfc) < ((*c).ofc) ? ((*c).obfc) : ((*c).ofc));
      }
      break;
    ...
    case 28:
      ...
      for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      f = FindShift(x, y, 0);
      ((yc).obc = ((((*c).obc) < ((*c).obfc) ? ((*c).obc) : ((*c).obfc)) - f), (yc).obfc = ((*c).obfc), (yc).ofc = ((((*c).ofc) < ((*c).obfc) ? ((*c).ofc) : ((*c).obfc)) + f));

      BreakObject(y, &yc);
      f = FindShift(x, y, 0);
      (x)->os1.ou3.os31.oback[0] = ((8388607) < (((0) < ((y)->os1.ou3.os31.oback[0] + f) ? ((y)->os1.ou3.os31.oback[0] + f) : (0))) ? (8388607) : (((0) < ((y)->os1.ou3.os31.oback[0] + f) ? ((y)->os1.ou3.os31.oback[0] + f) : (0))));
      (x)->os1.ou3.os31.ofwd[0] = ((8388607) < (((0) < ((y)->os1.ou3.os31.ofwd[0] - f) ? ((y)->os1.ou3.os31.ofwd[0] - f) : (0))) ? (8388607) : (((0) < ((y)->os1.ou3.os31.ofwd[0] - f) ? ((y)->os1.ou3.os31.ofwd[0] - f) : (0))));
      break;
    ...
    case 9:
      ...
      for( y = (( (0) == 0 ? (x)->os1.olist[0].osucc : (x)->os1.olist[0].opred ))->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      y = BreakObject(y, c);
      (x)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.oback[0];
      (x)->os1.ou3.os31.ofwd[0] = (y)->os1.ou3.os31.ofwd[0];
      break;
    ...
    case 17:
      ...
      if( (x)->os1.ou3.os31.oback[0] > 0 )
      { int sz; OBJECT rpos;

 sz = ((x)->os1.ou3.os31.oback[0] + (x)->os1.ou3.os31.ofwd[0]);
 (x)->os1.ou3.os31.ofwd[0] = ((8388607) < (sz) ? (8388607) : (sz));
 (x)->os1.ou3.os31.oback[0] = 0;
 rpos = x;
 for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
 { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
   if( (y)->os1.ou1.os11.otype == 1 && ((y)->os5.ogap).omark )
   { ((y)->os5.ogap).omark = 0;
     rpos = y;
   }
 }
 ...
 Error(13, 10, "column mark of paragraph moved left before breaking",
   2, &(rpos)->os1.ou1.ofpos);
      ...
      x = FillObject(x, c, ( (OBJECT) ((void*)0) ), 1, 1, 0, &junk);
      break;
    ...
    case 16:
      ...
      BreakJoinedGroup((x)->os1.olist[0].osucc, (x)->os1.olist[0].opred, ( (OBJECT) ((void*)0) ), c,
 &(x)->os1.ou3.os31.oback[0], &(x)->os1.ou3.os31.ofwd[0]);
      break;
    ...
    default:
      ...
      { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"BreakObject:", Image((x)->os1.ou1.os11.otype)); };
      break;

  }
  { if( !((x)->os1.ou3.os31.oback[0] >= 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakObject: back(x, COLM) < 0!"); };
  { if( !((x)->os1.ou3.os31.ofwd[0] >= 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "BreakObject: fwd(x, COLM) < 0!"); };
