# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z04.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z04.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z04.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z04.c" 2
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z04.c"
...
{ OBJECT res;
                                                     ;
  { ; { ; if( (zz_size=(zz_lengths[xtype])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = xtype; ; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( ((res)->os1.ou1.ofpos).ofile_num = (*xfpos).ofile_num, ((res)->os1.ou1.ofpos).oline_num = (*xfpos).oline_num, ((res)->os1.ou1.ofpos).ocol_num = (*xfpos).ocol_num );
  (res)->os1.ou2.os21.ovspace = xvspace; (res)->os1.ou2.os21.ohspace = xhspace;
  (res)->os1.ou2.os21.oprecedence = xprec; (res)->os2.oactual = xactual;
                                                           ;
  return res;
}
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z04.c"
OBJECT CopyTokenList(OBJECT x, FILE_POS *pos)
{ OBJECT y, z, res;
  res = ( (OBJECT) ((void*)0) ); y = x;
  if( x != ( (OBJECT) ((void*)0) ) ) do
  { if( (((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) )
    { z = MakeWord((y)->os1.ou1.os11.otype, (y)->os1.ostring, pos);
      (z)->os1.ou2.os21.ovspace = (y)->os1.ou2.os21.ovspace; (z)->os1.ou2.os21.ohspace = (y)->os1.ou2.os21.ohspace;
    }
    else z = NewToken((y)->os1.ou1.os11.otype, pos,(y)->os1.ou2.os21.ovspace,(y)->os1.ou2.os21.ohspace,(y)->os1.ou2.os21.oprecedence,(y)->os2.oactual);
    res = ( zz_res = (res), zz_hold = (z), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );
    y = (y)->os1.olist[1].osucc;
  } while( y != x );
  return res;
}
# 85 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z04.c"
FULL_CHAR *EchoCatOp(unsigned xtype, unsigned xmark, unsigned xjoin)
{ switch( xtype )
  {
    case 19: return (xmark ? xjoin ? ( (FULL_CHAR *) ("^/") ) : ( (FULL_CHAR *) ("^//") )
          : xjoin ? ( (FULL_CHAR *) ("/") ) : ( (FULL_CHAR *) ("//") ));

    case 18: return (xmark ? xjoin ? ( (FULL_CHAR *) ("^|") ) : ( (FULL_CHAR *) ("^||") )
          : xjoin ? ( (FULL_CHAR *) ("|") ) : ( (FULL_CHAR *) ("||") ));

    case 17: return (xmark ? xjoin ? ( (FULL_CHAR *) ("^&") ) : ( (FULL_CHAR *) ("??") )
          : xjoin ? ( (FULL_CHAR *) ("&") ) : ( (FULL_CHAR *) ("??") ) );

    default: { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "EchoCatOp"); };
  return ( (FULL_CHAR *) ("") );
