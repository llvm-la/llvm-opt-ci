# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z34.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z34.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z34.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z34.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z34.c" 2

typedef struct { double x, y; } rect_coord;
typedef struct { double angle, radius; } polar_coord;
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z34.c"
...
{ rect_coord ycorners[4], xcorner; polar_coord pol;
  ...
  ang = (double) theta * 2 * 3.14159265358979323846 / (double) (128 * 360);
                                              ;
                                                              ;
  ...
  ycorners[0].x = (float) (y)->os1.ou3.os31.ofwd[0];
  ycorners[0].y = (float) (y)->os1.ou3.os31.oback[1];
  ycorners[1].x = - (float) (y)->os1.ou3.os31.oback[0];
  ycorners[1].y = (float) (y)->os1.ou3.os31.oback[1];
  ycorners[2].x = - (float) (y)->os1.ou3.os31.oback[0];
  ycorners[2].y = - (float) (y)->os1.ou3.os31.ofwd[1];
  ycorners[3].x = (float) (y)->os1.ou3.os31.ofwd[0];
  ycorners[3].y = - (float) (y)->os1.ou3.os31.ofwd[1];


  maxx = maxy = (float) - 8388607;
  minx = miny = (float) 8388607;
  for( i = 0; i < 4; i++ )
  {
    if( ycorners[i].x == 0 && ycorners[i].y == 0 )
    { pol.radius = 0; pol.angle = 0; }
    else pol.angle = atan2(ycorners[i].y, ycorners[i].x), pol.radius = sqrt(ycorners[i].x*ycorners[i].x + ycorners[i].y*ycorners[i].y);
                                                       ;
                                                 ;
                                                  ...
                                                  ;
    pol.angle += ang;
    xcorner.x = pol.radius * cos(pol.angle), xcorner.y = pol.radius * sin(pol.angle);
                                                       ;


                                                                  ;
    maxx = ((maxx) < (xcorner.x) ? (xcorner.x) : (maxx)); minx = ((minx) < (xcorner.x) ? (minx) : (xcorner.x));
    maxy = ((maxy) < (xcorner.y) ? (xcorner.y) : (maxy)); miny = ((miny) < (xcorner.y) ? (miny) : (xcorner.y));
  }
