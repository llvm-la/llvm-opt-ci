# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c" 2
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
POINTER MemCheck = 0;
# 66 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
...
# 86 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
BACK_END BackEnd;
OBJECT CommandOptions;
unsigned UseCollate;
unsigned AllowCrossDb;
unsigned InMemoryDbIndexes;
unsigned Kern;
unsigned SafeExecution;
unsigned AltErrorFormat;
unsigned InitializeAll;

nl_catd MsgCat;

int TotalWordCount;
# 110 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
static OBJECT load(FULL_CHAR *xstr, unsigned xpre,
unsigned xleft, unsigned xright, unsigned xindef, unsigned char xprec)
{ OBJECT s;
  s = InsertSym(xstr, 143, no_fpos, xprec, xindef, 0, xpre,
 StartSym, ( (OBJECT) ((void*)0) ));
  if( xleft ) InsertSym( ( (FULL_CHAR *) ("pa") ), 144, no_fpos, 100,
    0, 0, 0, s, ( (OBJECT) ((void*)0) ));
  if( xright ) InsertSym( ( (FULL_CHAR *) ("pb") ), 146, no_fpos, 100,
    0, 0, 0, s, ( (OBJECT) ((void*)0) ));
  if( xleft && xright && xpre != 79 && xpre != 80 )
    (s)->os1.ou2.os26.oright_assoc = 1;
  return s;
}
# 134 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
static void PrintUsage(FILE *fp)
{
  fprintf(fp, "%s\n", "");
  fprintf(fp, "%s\n", "usage:  lout options files");
  fprintf(fp, "%s\n", "");
  fprintf(fp, "%s\n", "  -s              suppress access to cross reference database");
  fprintf(fp, "%s\n", "  -EPS            EPS (Encapsulated PostScript) output");
  fprintf(fp, "%s\n", "  -PDF or -Z      PDF (Adobe Portable Document Format) output");
  fprintf(fp, "%s\n", "  -p              plain text output instead of PostScript");
  fprintf(fp, "%s\n", "  -P              like -p but with form-feed char between pages");
  fprintf(fp, "%s\n", "  -S              safe execution (disable calls to system(3))");
  fprintf(fp, "%s\n", "  -U              unsafe execution (allow calls to system(3))");
  fprintf(fp, "%s\n", "  -l              ASCII collation order when sorting indexes etc.");
  fprintf(fp, "%s\n", "  -L              locale collation order when sorting indexes etc.");
  fprintf(fp, "%s\n", "  -o file         output to file instead of stdout");
  fprintf(fp, "%s\n", "  -e file         error messages to file instead of stderr");
  fprintf(fp, "%s\n", "  -a              alternative error format:  file:line:col ...");
  fprintf(fp, "%s\n", "  -w              print total number of words in output");
  fprintf(fp, "%s\n", "  -i file         like @SysInclude { file }; not recommended");
  fprintf(fp, "%s\n", "  -I directory    add directory to include file search path");
  fprintf(fp, "%s\n", "  -C directory    add directory to LCM file search path");
  fprintf(fp, "%s\n", "  -F directory    add directory to font metrics file search path");
  fprintf(fp, "%s\n", "  -H directory    add directory to hyphenation file search path");
  fprintf(fp, "%s\n", "  -D directory    add directory to database file search path");
  fprintf(fp, "%s\n", "  --option{value} set option e.g. --'@InitialFont{Times Base 10p}'");
  fprintf(fp, "%s\n", "  -c file         use file.li instead of lout.li for crossrefs");
  fprintf(fp, "%s\n", "  -M              save memory (don't read in database indexes)");
  ...
  fprintf(fp, "%s\n", "  -               a file name denoting standard input");
  fprintf(fp, "%s\n", "");

}
# 179 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
static FULL_CHAR *GetArg(char *argv[], int argc, int *i)
{ if( !(strcmp((char *)(( (FULL_CHAR *) (argv[*i]+2) )), (char *)(( (FULL_CHAR *) ("") )))==0) )
    return ( (FULL_CHAR *) (argv[*i]+2) );
  else if( *i < argc-1 && *argv[*i + 1] != '-' )
    return ( (FULL_CHAR *) (argv[(*i)++ +1]) );
  else
    return (FULL_CHAR *) ((void*)0);
}
# 198 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z01.c"
...
{ int i, len; FULL_CHAR *arg;
  ...
  FILE *out_fp;
  long MemCheckLong;
  FULL_CHAR oname[512], oval[512], buff[512], *p;
  int bp; OBJECT z;
  unsigned seen_wordcount;

  char catname[512], *loc;



  lib = ( (FULL_CHAR *) (getenv("LOUTLIB")) );
  if( lib == (FULL_CHAR *) ((void*)0) )
    lib = ( (FULL_CHAR *) ("lout.lib") );



  loc = setlocale(5, "");
  if( loc == (char *) ((void*)0) )
  { Error(1, 6, "unable to initialize locale", 2, no_fpos);
    loc = "C";
  }
 ...
 if( (outfile = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 7, "usage: -o <filename>", 1, no_fpos);
 if( StringEndsWith(outfile, ( (FULL_CHAR *) (".lt") )) )
   Error(1, 28, "-o: output file name %s ends with %s",
     1, no_fpos, outfile, ( (FULL_CHAR *) (".lt") ));
 break;
 ...
 if( (cross_db = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 8, "usage: -c <filename>", 1, no_fpos);
 break;
 ...
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 9, "usage: -e <filename>", 1, no_fpos);
 ErrorInit(arg);
 break;
 ...
 if( !(strcmp((char *)(( (FULL_CHAR *) (argv[i]+1) )), (char *)(( (FULL_CHAR *) ("EPS") )))==0) )
   Error(1, 10, "usage: -EPS", 1, no_fpos);
 Encapsulated = 1;
 break;
 ...
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 11, "usage: -D <directoryname>", 1, no_fpos);
 AddToPath(3, MakeWord(11, arg, no_fpos));
 AddToPath(4, MakeWord(11, arg, no_fpos));
 break;
 ...
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 12, "usage: -C <directoryname>", 1, no_fpos);
 AddToPath(7, MakeWord(11, arg, no_fpos));
 break;
 ...
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 13, "usage: -F <directoryname>", 1, no_fpos);
 AddToPath(5, MakeWord(11, arg, no_fpos));
 break;
 ...
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 14, "usage: -H <directoryname>", 1, no_fpos);
 AddToPath(6, MakeWord(11, arg, no_fpos));
 break;
 ...
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 15, "usage: -I <directoryname>", 1, no_fpos);
 AddToPath(1, MakeWord(11, arg, no_fpos));
 AddToPath(2, MakeWord(11, arg, no_fpos));
 break;
 ...
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 16, "usage: -i <filename>", 1, no_fpos);
 len = strlen((char *)(arg)) - strlen((char *)(( (FULL_CHAR *) (".lt") )));
 if( len >= 0 && (strcmp((char *)(&arg[len]), (char *)(( (FULL_CHAR *) (".lt") )))==0) )
   strcpy((char *)(&arg[len]),(char *)(( (FULL_CHAR *) ("") )));
                                                     ;
 DefineFile(arg, ( (FULL_CHAR *) ("") ), no_fpos, 0, 2);
 break;
 ...
 if( FirstFile(7) != 0 )
   Error(1, 17, "two -h options illegal", 1, no_fpos);
 if( (arg = GetArg(argv, argc, &i)) == ((void*)0) )
   Error(1, 18, "usage: -h <filename>", 1, no_fpos);
                                                     ;
 DefineFile(arg, ( (FULL_CHAR *) ("") ), no_fpos, 7, 1);
 DefineFile(arg, ( (FULL_CHAR *) (".lh") ), no_fpos, 8, 1);
 break;
 ...
 if( (strcmp((char *)(( (FULL_CHAR *) (argv[i]+1) )), (char *)(( (FULL_CHAR *) ("PDF") )))==0) )
 {
   BackEnd = PDF_BackEnd;
   break;
 }
 ...
 { float len1, len2; FULL_CHAR units1, units2;
   ...
   switch( units1 )
   {
     case 'c': PlainCharWidth = len1 * 567; break;
     case 'i': PlainCharWidth = len1 * 1440; break;
     case 'p': PlainCharWidth = len1 * 20; break;
     case 'm': PlainCharWidth = len1 * 120; break;
   ...
   switch( units2 )
   {
     case 'c': PlainCharHeight = len2 * 567; break;
     case 'i': PlainCharHeight = len2 * 1440; break;
     case 'p': PlainCharHeight = len2 * 20; break;
     case 'm': PlainCharHeight = len2 * 120; break;
 ...
 Error(1, 4, "%s - debug flags not implemented", 1, no_fpos, ( (FULL_CHAR *) (argv[i]) ));
 break;
 ...
 if( stdin_seen )
   Error(1, 23, "standard input specified twice", 1, no_fpos);
 stdin_seen = 1;
                                                     ;
 DefineFile(( (FULL_CHAR *) ("-") ), ( (FULL_CHAR *) ("") ), no_fpos, 0, 0);
 break;
 ...
 if( (y)->os1.olist[0].osucc == y )
   Error(1, 25, "error in command-line option %s", 1, no_fpos,
     argv[i]+2);
 break;
 ...
 PrintUsage(stderr);
 Error(1, 26, "unknown command line flag %s", 1, no_fpos, argv[i]);
 break;

    }
    else
    {
 arg = ( (FULL_CHAR *) (argv[i]) );
 len = strlen((char *)(arg)) - strlen((char *)(( (FULL_CHAR *) (".lt") )));
 if( len >= 0 && (strcmp((char *)(&arg[len]), (char *)(( (FULL_CHAR *) (".lt") )))==0) )
   strcpy((char *)(&arg[len]),(char *)(( (FULL_CHAR *) ("") )));
                                                     ;
 DefineFile(( (FULL_CHAR *) (argv[i]) ), ( (FULL_CHAR *) ("") ), no_fpos,
     0, 0);
 source_file_count++;
    }
  }
  ...
  {
    if (!setlocale (3, ""))
      Error(1, 30, "unable to initialize collation", 2, no_fpos);
  }
  ...
  if( (strcmp((char *)(outfile), (char *)(( (FULL_CHAR *) ("-") )))==0) )
  {
  ...
  { out_fp = fopen( (char *) (outfile), (BackEnd->code == 2 ? "w" : "w") );

    if( out_fp == ( (FILE *) ((void*)0) ) )
      Error(1, 27, "cannot open output file %s", 1, no_fpos, outfile);
  }
  ...
  AddToPath(5, MakeWordThree(lib, ( (FULL_CHAR *) ("/") ), ( (FULL_CHAR *) ("font") )));
  AddToPath(6, MakeWordThree(lib, ( (FULL_CHAR *) ("/") ), ( (FULL_CHAR *) ("hyph") )));
  AddToPath(7, MakeWordThree(lib, ( (FULL_CHAR *) ("/") ), ( (FULL_CHAR *) ("maps") )));
  AddToPath(4,MakeWordThree(lib,( (FULL_CHAR *) ("/") ), ( (FULL_CHAR *) ("data") )));
  AddToPath(3, MakeWordThree(lib, ( (FULL_CHAR *) ("/") ), ( (FULL_CHAR *) ("data") )));
  AddToPath(2,MakeWordThree(lib, ( (FULL_CHAR *) ("/") ), ( (FULL_CHAR *) ("include") )));
  AddToPath(1, MakeWordThree(lib, ( (FULL_CHAR *) ("/") ), ( (FULL_CHAR *) ("include") )));
  ...
  StartSym = ( (OBJECT) ((void*)0) );
  StartSym = load(( (FULL_CHAR *) ("\\Start") ), 0, 0, 0, 1, 0 );
  GalleySym = load(( (FULL_CHAR *) ("@Galley") ), 0, 0, 0, 1, 0 );
  ForceGalleySym= load(( (FULL_CHAR *) ("@ForceGalley") ), 0, 0, 0, 1, 0 );
  InputSym = load(( (FULL_CHAR *) ("@LInput") ), 0, 0, 0, 1, 0 );
  PrintSym = load(( (FULL_CHAR *) ("\\Print") ), 0, 0, 0, 1, 0 );
  FilterInSym = load(( (FULL_CHAR *) ("@FilterIn") ), 0, 0, 0, 0, 0 );
  FilterOutSym = load(( (FULL_CHAR *) ("@FilterOut") ), 0, 0, 0, 0, 0 );
  FilterErrSym = load(( (FULL_CHAR *) ("@FilterErr") ), 0, 0, 0, 0, 0 );
  OptGallSym = load(( (FULL_CHAR *) ("@OptGall") ), 0, 0, 1, 0, 100);
  VerbatimSym = load(( (FULL_CHAR *) ("@Verbatim") ),53,0, 1, 0, 100);
  RawVerbatimSym= load(( (FULL_CHAR *) ("@RawVerbatim") ),54,0,1,0,100);


  load(( (FULL_CHAR *) ("@Begin") ), 104, 0, 0, 0, 1 );
  load(( (FULL_CHAR *) ("@End") ), 105, 0, 0, 0, 2 );
  load(( (FULL_CHAR *) ("@LEnv") ), 82, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@@A") ), 83, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@@B") ), 84, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@@C") ), 85, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@@D") ), 86, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@@E") ), 87, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@LClos") ), 88, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@@V") ), 89, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@LUse") ), 90, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@LEO") ), 91, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("{") ), 102, 0, 0, 0, 3 );
  load(( (FULL_CHAR *) ("}") ), 103, 0, 0, 0, 4 );
  load(( (FULL_CHAR *) ("@Include") ), 112, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@SysInclude") ), 113, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@PrependGraphic") ), 114, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@SysPrependGraphic") ), 115, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@Database") ), 116, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@SysDatabase") ), 117, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@Use") ), 106, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@NotRevealed") ), 107, 0, 0, 0, 0 );
  load(( (FULL_CHAR *) ("@Case") ), 52, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Yield") ), 55, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@BackEnd") ), 56, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@Char") ), 58, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Font") ), 59, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Space") ), 60, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@YUnit") ), 61, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@ZUnit") ), 62, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Break") ), 63, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Underline") ), 64, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@SetColour") ), 65, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@SetColor") ), 65, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Outline") ), 66, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Language") ), 67, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@CurrLang") ), 68, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@CurrFamily") ), 69, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@CurrFace") ), 70, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@CurrYUnit") ), 71, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@CurrZUnit") ), 72, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@Common") ), 73, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Rump") ), 74, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Meld") ), 75, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Insert") ), 76, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@OneOf") ), 77, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Next") ), 78, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Plus") ), 79, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Minus") ), 80, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Open") ), 92, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Tagged") ), 93, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Wide") ), 26, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@High") ), 27, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HShift") ), 28, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@VShift") ), 29, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@BeginHeaderComponent") ), 20, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@EndHeaderComponent") ), 21, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@SetHeaderComponent") ), 22, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@ClearHeaderComponent") ), 23, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@OneCol") ), 24, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@OneRow") ), 25, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HScale") ), 30, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@VScale") ), 31, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HCover") ), 32, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@VCover") ), 33, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@KernShrink") ), 35, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Scale") ), 34, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HContract") ), 36, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@VContract") ), 37, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HLimited") ), 38, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@VLimited") ), 39, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HExpand") ), 40, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@VExpand") ), 41, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@StartHVSpan") ), 44, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@StartHSpan") ), 42, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@StartVSpan") ), 43, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HSpan") ), 45, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@VSpan") ), 46, 0, 0, 0, 100);
  load(( (FULL_CHAR *) ("@PAdjust") ), 47, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@HAdjust") ), 48, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@VAdjust") ), 49, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Rotate") ), 50, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Background") ), 51, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@IncludeGraphic") ), 94, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@SysIncludeGraphic") ), 95, 0, 1, 0, 100);
  load(( (FULL_CHAR *) ("@PlainGraphic") ), 96, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@Graphic") ), 97, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@LinkSource") ), 98, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("@LinkDest") ), 99, 1, 1, 0, 100);
  load(( (FULL_CHAR *) ("&&") ), 6, 1, 1, 0, 101);
  load(( (FULL_CHAR *) ("&&&") ), 7, 1, 1, 0, 101);
  load(( (FULL_CHAR *) ("@Null") ), 5, 0, 0, 1, 0 );
  load(( (FULL_CHAR *) ("@PageLabel") ), 4, 0, 1, 1, 100);



  s=load(( (FULL_CHAR *) ("//") ), 19, 1, 1, 0, 5); (s)->os1.ou2.os26.ohas_mark=0, (s)->os1.ou2.os26.ohas_join=0;
  s=load(( (FULL_CHAR *) ("^//") ), 19, 1, 1, 0, 5); (s)->os1.ou2.os26.ohas_mark=1, (s)->os1.ou2.os26.ohas_join=0;
  s=load(( (FULL_CHAR *) ("/") ), 19, 1, 1, 0, 5); (s)->os1.ou2.os26.ohas_mark=0, (s)->os1.ou2.os26.ohas_join=1;
  s=load(( (FULL_CHAR *) ("^/") ), 19, 1, 1, 0, 5); (s)->os1.ou2.os26.ohas_mark=1, (s)->os1.ou2.os26.ohas_join=1;
  s=load(( (FULL_CHAR *) ("||") ), 18, 1, 1, 0, 6); (s)->os1.ou2.os26.ohas_mark=0, (s)->os1.ou2.os26.ohas_join=0;
  s=load(( (FULL_CHAR *) ("^||") ), 18, 1, 1, 0, 6); (s)->os1.ou2.os26.ohas_mark=1, (s)->os1.ou2.os26.ohas_join=0;
  s=load(( (FULL_CHAR *) ("|") ), 18, 1, 1, 0, 6); (s)->os1.ou2.os26.ohas_mark=0, (s)->os1.ou2.os26.ohas_join=1;
  s=load(( (FULL_CHAR *) ("^|") ), 18, 1, 1, 0, 6); (s)->os1.ou2.os26.ohas_mark=1, (s)->os1.ou2.os26.ohas_join=1;
  s=load(( (FULL_CHAR *) ("&") ), 17, 1, 1, 0, 7); (s)->os1.ou2.os26.ohas_mark=0, (s)->os1.ou2.os26.ohas_join=1;
  s=load(( (FULL_CHAR *) ("^&") ), 17, 1, 1, 0, 7); (s)->os1.ou2.os26.ohas_mark=1, (s)->os1.ou2.os26.ohas_join=1;
  ...
  LexPush(FirstFile(0), 0, 0, 1, 0);


  InitParser(cross_db);
  t = NewToken(104, no_fpos, 0, 0, 1, StartSym);
  res = Parse(&t, StartSym, 1, 1);
                                                        ;
  ...
  if( seen_wordcount )
    Error(1, 29, "total of all words printed: %d", 2,no_fpos,TotalWordCount);
