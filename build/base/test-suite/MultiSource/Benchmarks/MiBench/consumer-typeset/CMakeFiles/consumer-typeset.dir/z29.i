# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c" 2
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c" 2
...
static OBJECT scope[300];
static unsigned npars_only[300];
static unsigned vis_only[300];
static unsigned body_ok[300];
static unsigned suppress_scope;
static unsigned suppress_visible;
static int scope_top;
static struct { OBJECT f1, f2; } symtab[1783];
# 83 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
void InitSym(void)
{ int i;
  scope_top = 0;
  suppress_scope = 0;
...
# 105 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
void PushScope(OBJECT x, unsigned npars, unsigned vis)
{ ;
  { if( !(suppress_scope == 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PushScope: suppress_scope!"); };
  if( scope_top >= 300 )
  {
    ...
    Error(29, 2, "scope depth limit exceeded", 0, &(x)->os1.ou1.ofpos);
  }
  scope[scope_top] = x;
...
void PopScope(void)
{ ;
  { if( !(scope_top > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PopScope: tried to pop empty scope stack"); };
  { if( !(suppress_scope == 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PopScope: suppress_scope!"); };
  scope_top--;
}
# 141 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
...
# 162 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
...
# 182 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
void SwitchScope(OBJECT sym)
{ int i;
  OBJECT new_scopes[300];
  if( sym == ( (OBJECT) ((void*)0) ) ) PushScope(StartSym, 0, 0);
  else
  { i = 0;
    while( sym != StartSym )
    { new_scopes[i++] = (sym)->os6.oenclosing;
      sym = (sym)->os6.oenclosing;
    }
    while( i > 0 ) PushScope(new_scopes[--i], 0, 0);
  }
}

void UnSwitchScope(OBJECT sym)
{ if( sym == ( (OBJECT) ((void*)0) ) ) PopScope();
  else
  { while( sym != StartSym )
    { PopScope();
      sym = (sym)->os6.oenclosing;
...
# 216 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
void BodyParAllowed(void)
{ ;
  body_ok[scope_top-1] = 1;
}

void BodyParNotAllowed(void)
{ ;
  body_ok[scope_top-1] = 0;
}
# 235 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
...
# 266 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
OBJECT GetScopeSnapshot()
{ OBJECT ss, x; int i;
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; ss = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  for( i = scope_top-1; scope[i] != StartSym; i-- )
  {
    { ; { ; if( (zz_size=(zz_lengths[149])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 149; ; x = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((ss)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((scope[i])), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    (x)->os1.ou2.os22.oword_font = npars_only[i];
    (x)->os1.ou2.os22.oword_colour = vis_only[i];
    (x)->os1.ou2.os22.oword_outline = body_ok[i];
  }
  (ss)->os1.ou2.os22.oword_language = suppress_visible;
  return ss;
}


void LoadScopeSnapshot(OBJECT ss)
{ OBJECT link, x, sym; unsigned tmp;
  { if( !((ss)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LoadScopeSnapshot: type(ss)!"); };
  PushScope(StartSym, 0, 0);
  for( link = (ss)->os1.olist[0].opred; link != ss; link = (link)->os1.olist[0].opred )
  { for( x = (link)->os1.olist[1].opred; (x)->os1.ou1.os11.otype == 0; x = (x)->os1.olist[1].opred );
    { if( !((x)->os1.ou1.os11.otype == 149) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LoadScopeSnapshot: type(x)!"); };
    for( sym = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (sym)->os1.ou1.os11.otype == 0; sym = (sym)->os1.olist[1].opred );
    PushScope(sym, (x)->os1.ou2.os22.oword_font, (x)->os1.ou2.os22.oword_colour);
    body_ok[scope_top-1] = (x)->os1.ou2.os22.oword_outline;
  }
  tmp = suppress_visible;
  suppress_visible = (ss)->os1.ou2.os22.oword_language;
  (ss)->os1.ou2.os22.oword_language = tmp;
...
# 324 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
OBJECT InsertSym(FULL_CHAR *str, unsigned char xtype, FILE_POS *xfpos,
unsigned char xprecedence, unsigned xindefinite, unsigned xrecursive,
unsigned xpredefined, OBJECT xenclosing, OBJECT xbody)
{ register int sum, rlen;
  ...
  OBJECT p, q, s, tmp, link, entry, plink; int len;
                                        ...
                                        ;
  if( !LexLegalName(str) )
    Error(29, 3, "invalid symbol name %s", 2, xfpos, str);

  { ; { ; if( (zz_size=(zz_lengths[xtype])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = xtype; ; s = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  ( ((s)->os1.ou1.ofpos).ofile_num = (*xfpos).ofile_num, ((s)->os1.ou1.ofpos).oline_num = (*xfpos).oline_num, ((s)->os1.ou1.ofpos).ocol_num = (*xfpos).ocol_num );
  (s)->os1.ou2.os26.ohas_body = 0;
  (s)->os6.ofilter = ( (OBJECT) ((void*)0) );
  (s)->os6.ouse_invocation = ( (OBJECT) ((void*)0) );
  (s)->os6.oimports = ( (OBJECT) ((void*)0) );
  (s)->os1.ou2.os26.oimports_encl = 0;
  (s)->os1.ou2.os26.oright_assoc = 1;
  (s)->os1.ou2.os21.oprecedence = xprecedence;
  (s)->os1.ou2.os26.oindefinite = xindefinite;
  (s)->os1.ou2.os26.orecursive = xrecursive;
  (s)->os6.opredefined = xpredefined;
  (s)->os6.oenclosing = xenclosing;
  (s)->os6.osym_body = xbody;
  (s)->os6.obase_uses = ( (OBJECT) ((void*)0) );
  (s)->os6.ouses = ( (OBJECT) ((void*)0) );
  (s)->os6.omarker = ( (OBJECT) ((void*)0) );
  (s)->os6.ocross_sym = ( (OBJECT) ((void*)0) );
  (s)->os1.ou2.os26.ois_extern_target = 0;
  (s)->os1.ou2.os26.ouses_extern_target= 0;
  (s)->os1.ou2.os26.ovisible = 0;
  (s)->os1.ou2.os26.ouses_galley = 0;
  (s)->os1.ou2.os26.ohoriz_galley = 1;
  (s)->os6.ohas_compulsory = 0;
  (s)->os6.ois_compulsory = 0;

  (s)->os6.ouses_count = 0;
  (s)->os1.ou2.os26.odirty = 0;
  if( (s)->os6.oenclosing != ( (OBJECT) ((void*)0) ) && ((s)->os6.oenclosing)->os1.ou1.os11.otype == 145 )
    (s)->os1.ou2.os26.odirty = ((s)->os6.oenclosing)->os1.ou2.os26.odirty = 1;

  (s)->os1.ou2.os26.ohas_par = 0;
  (s)->os1.ou2.os26.ohas_lpar = 0;
  (s)->os1.ou2.os26.ohas_rpar = 0;
  if( (((s)->os1.ou1.os11.otype) >= 144 && ((s)->os1.ou1.os11.otype) <= 146) ) ((s)->os6.oenclosing)->os1.ou2.os26.ohas_par = 1;
  if( (s)->os1.ou1.os11.otype == 144 ) ((s)->os6.oenclosing)->os1.ou2.os26.ohas_lpar = 1;
  if( (s)->os1.ou1.os11.otype == 146 ) ((s)->os6.oenclosing)->os1.ou2.os26.ohas_rpar = 1;


  if( (s)->os1.ou1.os11.otype == 145 )
  { if( ((s)->os6.oenclosing)->os1.olist[0].opred != (s)->os6.oenclosing )
    { for( tmp = (((s)->os6.oenclosing)->os1.olist[0].opred)->os1.olist[1].opred; (tmp)->os1.ou1.os11.otype == 0; tmp = (tmp)->os1.olist[1].opred );
      if( (tmp)->os1.ou1.os11.otype == 145 )
      { if( (tmp)->os6.onpar_code == 'z' || (tmp)->os6.onpar_code == ' ' )
   (s)->os6.onpar_code = ' ';
 else
   (s)->os6.onpar_code = (tmp)->os6.onpar_code+1;
      }
      else
 (s)->os6.onpar_code = 'a';
    }
    else (s)->os6.onpar_code = 'a';
  }

  (s)->os1.ou2.os26.ohas_target = 0;
  (s)->os1.ou2.os26.oforce_target = 0;
  if( !(strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("@Target") )))==0) ) (s)->os1.ou2.os26.ois_target = 0;
  else
  { (s)->os1.ou2.os26.ois_target = ((s)->os6.oenclosing)->os1.ou2.os26.ohas_target = 1;


    if( ((s)->os6.oenclosing)->os1.ou2.os26.ohas_key && xbody != ( (OBJECT) ((void*)0) ) && (((xbody)->os1.ou1.os11.otype) == 6 || ((xbody)->os1.ou1.os11.otype) == 7) )
    { if( (xbody)->os1.olist[0].opred != (xbody)->os1.olist[0].osucc )
      { OBJECT sym;
 for( sym = ((xbody)->os1.olist[0].osucc)->os1.olist[1].opred; (sym)->os1.ou1.os11.otype == 0; sym = (sym)->os1.olist[1].opred );
 if( (sym)->os1.ou1.os11.otype == 2 )
 { ((sym)->os2.oactual)->os1.ou2.os26.ois_extern_target = 1;
   ((sym)->os2.oactual)->os1.ou2.os26.ouses_extern_target = 1;
 }
      }
    }
  }

  (s)->os1.ou2.os26.ohas_tag = (s)->os1.ou2.os26.ois_tag = 0;
  (s)->os1.ou2.os26.ohas_key = (s)->os1.ou2.os26.ois_key = 0;
  (s)->os6.ohas_optimize = (s)->os6.ois_optimize = 0;
  (s)->os6.ohas_merge = (s)->os6.ois_merge = 0;
  (s)->os6.ohas_enclose = (s)->os6.ois_enclose = 0;
  if( (s)->os6.oenclosing != ( (OBJECT) ((void*)0) ) && ((s)->os6.oenclosing)->os1.ou1.os11.otype == 143 )
  {
    if( (strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("@Tag") )))==0) )
      (s)->os1.ou2.os26.ois_tag = ((s)->os6.oenclosing)->os1.ou2.os26.ohas_tag = ((s)->os6.oenclosing)->os1.ou2.os26.odirty = 1;

    if( (strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("@Optimize") )))==0) )
      (s)->os6.ois_optimize = ((s)->os6.oenclosing)->os6.ohas_optimize = 1;

    if( (strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("@Key") )))==0) )
    { (s)->os1.ou2.os26.ois_key = ((s)->os6.oenclosing)->os1.ou2.os26.ohas_key = ((s)->os6.oenclosing)->os1.ou2.os26.odirty = 1;


      for( link=((s)->os6.oenclosing)->os1.olist[0].osucc; link!=(s)->os6.oenclosing; link=(link)->os1.olist[0].osucc )
      { for( p = (link)->os1.olist[1].opred; (p)->os1.ou1.os11.otype == 0; p = (p)->os1.olist[1].opred );
 if( (p)->os1.ou2.os26.ois_target && (p)->os6.osym_body!=( (OBJECT) ((void*)0) ) && ((((p)->os6.osym_body)->os1.ou1.os11.otype) == 6 || (((p)->os6.osym_body)->os1.ou1.os11.otype) == 7) )
 { OBJECT sym;
   for( sym = (((p)->os6.osym_body)->os1.olist[0].osucc)->os1.olist[1].opred; (sym)->os1.ou1.os11.otype == 0; sym = (sym)->os1.olist[1].opred );
   if( (sym)->os1.ou1.os11.otype == 2 )
   { ((sym)->os2.oactual)->os1.ou2.os26.ois_extern_target = 1;
     ((sym)->os2.oactual)->os1.ou2.os26.ouses_extern_target = 1;
   }
    ...
    if( (strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("@Merge") )))==0) )
      (s)->os6.ois_merge = ((s)->os6.oenclosing)->os6.ohas_merge = 1;

    if( (strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("@Enclose") )))==0) )
      (s)->os6.ois_enclose = ((s)->os6.oenclosing)->os6.ohas_enclose = 1;
  }

  if( (strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("@Filter") )))==0) )
  { if( (s)->os1.ou1.os11.otype != 143 || (s)->os6.oenclosing == StartSym )
      Error(29, 4, "%s must be a local definition", 2, &(s)->os1.ou1.ofpos, str);
    else if( !((s)->os6.oenclosing)->os1.ou2.os26.ohas_rpar )
      Error(29, 14, "%s must lie within a symbol with a right parameter",
 2, &(s)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Filter") ));
    else
    { ((s)->os6.oenclosing)->os6.ofilter = s;
      ((s)->os6.oenclosing)->os1.ou2.os21.oprecedence = 104;
    }
  }

  if( (s)->os1.ou1.os11.otype == 146 && ((s)->os6.oenclosing)->os1.ou2.os26.ohas_body &&
    ((s)->os1.ou2.os26.ois_tag || (s)->os1.ou2.os26.ois_key || (s)->os6.ois_optimize) )
    Error(29, 5, "a body parameter may not be named %s", 2, &(s)->os1.ou1.ofpos, str);

  if( (s)->os1.ou1.os11.otype == 146 && ((s)->os6.oenclosing)->os1.ou2.os26.ohas_target &&
    ((s)->os1.ou2.os26.ois_tag || (s)->os1.ou2.os26.ois_key || (s)->os6.ois_optimize) )
    Error(29, 6, "the right parameter of a galley may not be called %s",
      2, &(s)->os1.ou1.ofpos, str);

  len = strlen((char *)(str));
  { rlen = len; x = str; sum = *x++; while( --rlen ) sum += *x++; sum %= 1783; };

                                                   ;
  entry = (OBJECT) &symtab[sum];
  for( plink = (entry)->os1.olist[0].osucc; plink != entry; plink = (plink)->os1.olist[0].osucc )
  { for( p = (plink)->os1.olist[1].opred; (p)->os1.ou1.os11.otype == 0; p = (p)->os1.olist[1].opred );
    if( (p)->os1.ou2.os22.oword_font == len && (strcmp((char *)(str), (char *)((p)->os1.ostring))==0) )
    { for( link = (p)->os1.olist[0].osucc; link != p; link = (link)->os1.olist[0].osucc )
      { for( q = (link)->os1.olist[1].opred; (q)->os1.ou1.os11.otype == 0; q = (q)->os1.olist[1].opred );
 if( (s)->os6.oenclosing == (q)->os6.oenclosing )
 { Error(29, 7, "symbol %s previously defined at%s",
     2, &(s)->os1.ou1.ofpos, str, EchoFilePos(&(q)->os1.ou1.ofpos) );
   if( AltErrorFormat )
   {
     Error(29, 13, "symbol %s previously defined here",
       2, &(q)->os1.ou1.ofpos, str);
   }
   break;
 }
      }
  ...
  { zz_size = sizeof(struct word_type) - 4 + ((len)+1)*sizeof(FULL_CHAR); { ; if( (zz_size=(( ((zz_size) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, xfpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, xfpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; ; (zz_hold)->os1.ou1.os11.orec_size = zz_size; (zz_hold)->os1.ou1.os11.otype = 11; p = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  (p)->os1.ou2.os22.oword_font = len;
  strcpy((char *)((p)->os1.ostring),(char *)(str));
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((entry)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((p)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };

 wrapup:
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((p)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((s)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  if( (s)->os6.oenclosing != ( (OBJECT) ((void*)0) ) ) { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = (((s)->os6.oenclosing)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((s)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };

                                    ;
  return s;
}
# 515 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
...
# 565 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
...
{ register int rlen, sum;
  ...
  for( plink = (entry)->os1.olist[0].osucc; plink != entry; plink = (plink)->os1.olist[0].osucc )
  { for( p = (plink)->os1.olist[1].opred; (p)->os1.ou1.os11.otype == 0; p = (p)->os1.olist[1].opred );
    if( rlen == (p)->os1.ou2.os22.oword_font )
    { x = str; y = (p)->os1.ostring;
      do; while( *x++ == *y++ && --rlen );
      if( rlen == 0 )
      {
                                          ;
 ...
 { s--;
   ...
   { for( q = (link)->os1.olist[1].opred; (q)->os1.ou1.os11.otype == 0; q = (q)->os1.olist[1].opred );
     ...
     if( (q)->os6.oenclosing == scope[s]
       && (!npars_only[s] || (q)->os1.ou1.os11.otype == 145)
       && (!vis_only[s] || (q)->os1.ou2.os26.ovisible || suppress_visible )
       && (body_ok[s] || (q)->os1.ou1.os11.otype!=146 || !((q)->os6.oenclosing)->os1.ou2.os26.ohas_body
    || suppress_visible )
       && (!suppress_scope || (strcmp((char *)((p)->os1.ostring), (char *)(( (FULL_CHAR *) ("@Include") )))==0) ||
         (strcmp((char *)((p)->os1.ostring), (char *)(( (FULL_CHAR *) ("@SysInclude") )))==0))
     )
     { ;
...
# 625 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
FULL_CHAR *SymName(OBJECT s)
{ OBJECT p;
  if( s == ( (OBJECT) ((void*)0) ) ) return ( (FULL_CHAR *) ("<nilobj>") );
  for( p = ((s)->os1.olist[1].osucc)->os1.olist[0].opred; (p)->os1.ou1.os11.otype == 0; p = (p)->os1.olist[0].opred );
  { if( !((((p)->os1.ou1.os11.otype) == 11 || ((p)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SymName: !is_word(type(p))!"); };
  return (p)->os1.ostring;
}
# 642 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
FULL_CHAR *FullSymName(OBJECT x, FULL_CHAR *str)
{ OBJECT stack[20]; int i;
  static FULL_CHAR buff[512], *sname;
  if( x == ( (OBJECT) ((void*)0) ) ) return ( (FULL_CHAR *) ("<nilobj>") );
  { if( !((x)->os6.oenclosing != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FullSymName: enclosing(x) == nilobj!"); };
  for( i = 0; (x)->os6.oenclosing != ( (OBJECT) ((void*)0) ) && i < 20; i++ )
  { stack[i] = x;
    x = (x)->os6.oenclosing;
  }
  strcpy((char *)(buff),(char *)(( (FULL_CHAR *) ("") )));
  for( i--; i > 0; i-- )
  { sname = SymName(stack[i]);
    if( strlen((char *)(sname))+strlen((char *)(str))+strlen((char *)(buff)) >= 512 )
      Error(29, 8, "full name of symbol is too long", 1, &(x)->os1.ou1.ofpos);
    strcat((char *)(buff),(char *)(sname));
    strcat((char *)(buff),(char *)(str));
  }
  sname = SymName(stack[0]);
  if( strlen((char *)(sname)) + strlen((char *)(buff)) >= 512 )
    Error(29, 9, "full name of symbol is too long", 1, &(x)->os1.ou1.ofpos);
  strcat((char *)(buff),(char *)(sname));
  return buff;
}
# 675 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
OBJECT ChildSym(OBJECT s, unsigned typ)
{ OBJECT link, y;
  for( link = (s)->os1.olist[0].osucc; link != s; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os1.ou1.os11.otype == typ && (y)->os6.oenclosing == s ) return y;
  }
  Error(29, 10, "symbol %s has missing %s", 1, &(s)->os1.ou1.ofpos,
    SymName(s), Image(typ));
  return ( (OBJECT) ((void*)0) );
}
# 695 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z29.c"
OBJECT ChildSymWithCode(OBJECT s, unsigned char code)
{ OBJECT link, y;
  for( link = ((s)->os2.oactual)->os1.olist[0].osucc; link != (s)->os2.oactual; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os1.ou1.os11.otype == 145 && (y)->os6.oenclosing == (s)->os2.oactual && (y)->os6.onpar_code == code )
      return y;
  }
  Error(29, 11, "symbol %s has erroneous code %c (database out of date?)",
    1, &(s)->os1.ou1.ofpos, SymName((s)->os2.oactual), (char) code);
  return ( (OBJECT) ((void*)0) );
}
