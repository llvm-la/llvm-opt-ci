# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c" 2
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
...
{ OBJECT link, y;
  ...
  {
                                                           ;
    { if( !(env != ( (OBJECT) ((void*)0) ) && (env)->os1.ou1.os11.otype == 82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SearchEnv: env!"); };
    ...
    { if( !((y)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SearchEnv: type(y) != CLOSURE!"); };
    if( (y)->os2.oactual == sym )
    { ;
      return y;
    }
    { if( !((y)->os1.olist[0].opred != y) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SearchEnv: LastDown(y) == y!"); };
    link = (env)->os1.olist[0].opred != (env)->os1.olist[0].osucc ? (env)->os1.olist[0].opred : (y)->os1.olist[0].opred;
    for( env = (link)->os1.olist[1].opred; (env)->os1.ou1.os11.otype == 0; env = (env)->os1.olist[1].opred );
  }
}
# 74 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
OBJECT SetEnv(OBJECT x, OBJECT y)
{ OBJECT res;
                                                        ;
                                  ;
  { if( !(x!=( (OBJECT) ((void*)0) ) && (x)->os1.ou1.os11.otype==2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetEnv: x==nilobj or not CLOSURE!"); };
  { if( !(y==( (OBJECT) ((void*)0) ) || (y)->os1.ou1.os11.otype==82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetEnv: y!=nilobj && type(y) != ENV!"); };
  ...
  if( y != ( (OBJECT) ((void*)0) ) ) { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((res)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((y)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
                                                         ;
  return res;
}
# 95 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
void AttachEnv(OBJECT env, OBJECT x)
{ ;
  { if( !(env != ( (OBJECT) ((void*)0) ) && (env)->os1.ou1.os11.otype == 82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AttachEnv: type(env) != ENV!"); };
  { if( !((x)->os1.ou1.os11.otype == 2 || (x)->os1.ou1.os11.otype == 81) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "AttachEnv: type(x)!"); };
...
# 112 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
OBJECT GetEnv(OBJECT x)
{ OBJECT env;
  { if( !((x)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "GetEnv: type(x) != CLOSURE!"); };
  { if( !((x)->os1.olist[0].opred != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "GetEnv: LastDown(x) == x!"); };
  for( env = ((x)->os1.olist[0].opred)->os1.olist[1].opred; (env)->os1.ou1.os11.otype == 0; env = (env)->os1.olist[1].opred );
  { if( !((env)->os1.ou1.os11.otype == 82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "GetEnv: type(env) != ENV!"); };
  return env;
}
# 130 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
OBJECT DetachEnv(OBJECT x)
{ OBJECT env;
                                                   ;
  { if( !((x)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DetachEnv: type(x) != CLOSURE!"); };
  { if( !((x)->os1.olist[0].opred != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DetachEnv: LastDown(x) == x!"); };
  for( env = ((x)->os1.olist[0].opred)->os1.olist[1].opred; (env)->os1.ou1.os11.otype == 0; env = (env)->os1.olist[1].opred );
  { xx_link = ((x)->os1.olist[0].opred); ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; };
  { if( !((env)->os1.ou1.os11.otype == 82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DetachEnv: type(env) != ENV!"); };
                                                             ;
  return env;
}
# 154 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
OBJECT ClosureExpand(OBJECT x, OBJECT env, unsigned crs_wanted,
OBJECT *crs, OBJECT *res_env)
{ OBJECT link, y, res, prnt_env, par, prnt;

                                                     ;
  { if( !((x)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ClosureExpand given non-CLOSURE!"); };
  { if( !(((x)->os2.oactual)->os6.opredefined == 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ClosureExpand given predefined!"); };


  if( ((x)->os2.oactual)->os1.ou2.os26.ohas_tag ) CrossAddTag(x);
  if( crs_wanted && ((x)->os2.oactual)->os1.ou2.os26.ohas_tag )
  { OBJECT tmp = CopyObject(x, no_fpos); AttachEnv(env, tmp);
    y = CrossMake((x)->os2.oactual, tmp, 131);
    { ; { ; if( (zz_size=(zz_lengths[131])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 131; ; tmp = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; (tmp)->os2.oactual = y; { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((tmp)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((y)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  ...
  res = *res_env = ( (OBJECT) ((void*)0) );
  if( ((((x)->os2.oactual)->os1.ou1.os11.otype) >= 144 && (((x)->os2.oactual)->os1.ou1.os11.otype) <= 146) )
  { prnt = SearchEnv(env, ((x)->os2.oactual)->os6.oenclosing);
    if( prnt != ( (OBJECT) ((void*)0) ) )
    {
      prnt_env = GetEnv(prnt);
      for( link = (prnt)->os1.olist[0].osucc; link != prnt; link = (link)->os1.olist[0].osucc )
      { for( par = (link)->os1.olist[1].opred; (par)->os1.ou1.os11.otype == 0; par = (par)->os1.olist[1].opred );
        if( (par)->os1.ou1.os11.otype == 10 && (par)->os2.oactual == (x)->os2.oactual )
        { { if( !((par)->os1.olist[0].osucc != par) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ExpandCLosure: Down(par)!"); };
   for( res = ((par)->os1.olist[0].osucc)->os1.olist[1].opred; (res)->os1.ou1.os11.otype == 0; res = (res)->os1.olist[1].opred );
   if( (((par)->os2.oactual)->os6.oenclosing)->os1.ou2.os26.odirty || ((par)->os2.oactual)->os6.ois_enclose )
   { ;
   ...
   if( ((x)->os2.oactual)->os1.ou1.os11.otype == 146 && (((x)->os2.oactual)->os6.oenclosing)->os1.ou2.os26.ohas_body )
   { ;
     *res_env = SetEnv(prnt, ( (OBJECT) ((void*)0) )); DisposeObject(x);
   }
   else if( ((x)->os2.oactual)->os1.ou1.os11.otype == 145 && ((x)->os2.oactual)->os1.ou2.os26.oimports_encl )
   { ;
     AttachEnv(env, x);
     *res_env = SetEnv(x, ( (OBJECT) ((void*)0) ));
   }
   else
   { AttachEnv(env, x);
                                                                ;
   ...
   break;
    ...
    else
    {
      ...
      if( ((x)->os2.oactual)->os6.osym_body == ( (OBJECT) ((void*)0) ) )
      {

                                                    ;
        Error(9, 2, "no value for parameter %s of symbol %s:", 2, &(x)->os1.ou1.ofpos,
   SymName((x)->os2.oactual), SymName(((x)->os2.oactual)->os6.oenclosing));
        Error(9, 1, "symbol with import list misused", 1, &(x)->os1.ou1.ofpos);
      }
    }
  }
  ...
  { if( ((x)->os2.oactual)->os6.osym_body == ( (OBJECT) ((void*)0) ) )
    ...
    else res = CopyObject(((x)->os2.oactual)->os6.osym_body, &(x)->os1.ou1.ofpos);
    ( xx_tmp = ( zz_hold = ((x)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((res)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) ); AttachEnv(env, x);
                                                               ;
    *res_env = SetEnv(x, ( (OBJECT) ((void*)0) ));
  }

  { if( !(*res_env!=( (OBJECT) ((void*)0) ) && (*res_env)->os1.ou1.os11.otype==82) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ClosureExpand: *res_env!"); };
                                                    ;
                                   ;
                                                            ;
  return res;
}
# 255 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z09.c"
OBJECT ParameterCheck(OBJECT x, OBJECT env)
{ OBJECT link, y, res, prnt_env, par, prnt;
                                                                           ;
  { if( !((x)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ParameterCheck given non-CLOSURE!"); };
  ...
  { for( par = (link)->os1.olist[1].opred; (par)->os1.ou1.os11.otype == 0; par = (par)->os1.olist[1].opred );
    if( (par)->os1.ou1.os11.otype == 10 && (par)->os2.oactual == (x)->os2.oactual )
    { { if( !((par)->os1.olist[0].osucc != par) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ParameterCheck: Down(par)!"); };
 for( y = ((par)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 res = (((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) ? CopyObject(y, no_fpos) : ( (OBJECT) ((void*)0) );
                                                                  ;
 return res;
    }
  }
  ...
  y = ((x)->os2.oactual)->os6.osym_body;
  if( y == ( (OBJECT) ((void*)0) ) )
  { res = ( (OBJECT) ((void*)0) );
  }
  else if( (((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) )
  { res = CopyObject(y, &(y)->os1.ou1.ofpos);
  }
  else if( (y)->os1.ou1.os11.otype == 2 && ((((y)->os2.oactual)->os1.ou1.os11.otype) >= 144 && (((y)->os2.oactual)->os1.ou1.os11.otype) <= 146) )
