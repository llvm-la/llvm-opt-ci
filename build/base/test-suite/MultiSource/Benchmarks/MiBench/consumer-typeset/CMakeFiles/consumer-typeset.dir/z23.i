# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c" 2
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
...
{ OBJECT y, link, prev, g;
  ...
  { adjustable_gaps = 0;
    ...
    while( link != x )
    { if ( ((g)->os5.ogap).omode == 6 || ((g)->os5.ogap).ounits == 3
        || ((g)->os5.ogap).ounits == 2 )
      { ;
 return 0;
      }
      mk += ActualGap((prev)->os1.ou3.os31.ofwd[dim], (y)->os1.ou3.os31.oback[dim], (y)->os1.ou3.os31.ofwd[dim], &(g)->os5.ogap,
  frame_size, mk);
      prev = y;
      adjustable_gaps++;
      { g = ( (OBJECT) ((void*)0) ); jn = 1; for( link = (link)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) g = y, jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y):(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) { ; { if( !(g != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NextDefiniteWithGap: g == nilobj!"); }; break; } } };
    }
    actual_size = mk + (prev)->os1.ou3.os31.ofwd[dim];
...
# 131 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
OBJECT FixAndPrintObject(OBJECT x, FULL_LENGTH xmk, FULL_LENGTH xb,
  FULL_LENGTH xf, int dim, unsigned suppress, FULL_LENGTH pg, int count,
...
{ OBJECT y, link, prev, g, z, face, thr, res, uplink;
  ...
  int i; float scale_factor; unsigned jn;
                                  ...
                                  ;
  res = x;
# 160 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
  switch( (x)->os1.ou1.os11.otype )
  {
    ...
    case 43:
      ...
      for( y=(( (dim) == 0 ? (x)->os1.olist[0].osucc : (x)->os1.olist[0].opred ))->os1.olist[1].opred, count=1; (y)->os1.ou1.os11.otype==0; y = (y)->os1.olist[1].opred, count++ );
      if( (y)->os1.ou1.os11.otype == 13 || (y)->os1.ou1.os11.otype == 14 )
      {
        for( z = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
 for( thr = (( (dim) == 0 ? (x)->os1.olist[1].osucc : (x)->os1.olist[1].opred ))->os1.olist[0].opred; (thr)->os1.ou1.os11.otype == 0; thr = (thr)->os1.olist[0].opred );
 (y)->os2.oux.osave_mark = xmk - (thr)->os1.ou3.os31.oback[dim] + (z)->os1.ou3.os31.oback[dim];



                                      ;
 if( ++(y)->os1.ou2.os22.oword_language == (y)->os1.ou2.os22.oword_font )
 {



                                                              ;
   yf = ((xmk + xf - (y)->os2.oux.osave_mark) < ((z)->os1.ou3.os31.ofwd[dim]) ? ((z)->os1.ou3.os31.ofwd[dim]) : (xmk + xf - (y)->os2.oux.osave_mark));
   yf = ((yf) < (((y)->os2.ou4.oconstraint).obfc - (z)->os1.ou3.os31.oback[dim]) ? (((y)->os2.ou4.oconstraint).obfc - (z)->os1.ou3.os31.oback[dim]) : (yf));
          z = FixAndPrintObject(z, (y)->os2.oux.osave_mark, (z)->os1.ou3.os31.oback[dim], yf, dim,
  0, pg, 1, &aback, &afwd);
   (y)->os1.ou2.os22.oword_language = 0;
 }
 *actual_back = (x)->os1.ou3.os31.oback[dim]; *actual_fwd = (x)->os1.ou3.os31.ofwd[dim];
      }
      else
      {
    ...
    case 46:
      ...
      if( (dim == 0) == ((x)->os1.ou1.os11.otype == 45) )
      {
        for( y=(( (dim) == 0 ? (x)->os1.olist[0].osucc : (x)->os1.olist[0].opred ))->os1.olist[1].opred, count=1; (y)->os1.ou1.os11.otype==0; y = (y)->os1.olist[1].opred, count++ );
 { if( !((y)->os1.ou1.os11.otype == 13 || (y)->os1.ou1.os11.otype == 14) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FAPO HSPAN/VSPAN!"); };
 ...
 (x)->os1.ou1.os11.oword_save_mark = xmk;


 if( (x)->os1.ostring[0] != '\0' )
 { face = finfo[(x)->os1.ou2.os22.oword_font].original_face;
   if( (face)->os1.ou2.os25.ofont_page < font_curr_page )
   { ;
     ...
     FontPageUsed(face);
      ...
      {
 if( (x)->os1.ostring[0] != '\0' )
 { BackEnd->PrintWord(x, (x)->os1.ou1.os11.oword_save_mark, pg - xmk);
    ...
    case 27:
      ...
      if( (dim == 0) == ((x)->os1.ou1.os11.otype == 26) )
      { yf = ((x)->os2.ou4.oconstraint).obfc - (y)->os1.ou3.os31.oback[dim];
        y = FixAndPrintObject(y, xmk, (y)->os1.ou3.os31.oback[dim], yf, dim, 0, pg,
       count, &aback, &afwd);
        *actual_back = xb; *actual_fwd = xf;
      }
      else
 ...
 f = FindShift(x, y, dim);
 *actual_back = ((8388607) < (((0) < (aback + f) ? (aback + f) : (0))) ? (8388607) : (((0) < (aback + f) ? (aback + f) : (0))));
 *actual_fwd = ((8388607) < (((0) < (afwd - f) ? (afwd - f) : (0))) ? (8388607) : (((0) < (afwd - f) ? (afwd - f) : (0))));
      }
      else
      { y = FixAndPrintObject(y, xmk, xb, xf, dim, suppress, pg, count,
       actual_back, actual_fwd);
    ...
    case 37:
      ...
      for( y=((x)->os1.olist[0].osucc)->os1.olist[1].opred, count=1; (y)->os1.ou1.os11.otype==0; y = (y)->os1.olist[1].opred, count++ );
      if( (dim == 0) == ((x)->os1.ou1.os11.otype == 36) )
      { y = FixAndPrintObject(y, xmk, (y)->os1.ou3.os31.oback[dim], (y)->os1.ou3.os31.ofwd[dim], dim,
   0, pg, count, &aback, &afwd);
        *actual_back = xb; *actual_fwd = xf;
      }
      else
      { y = FixAndPrintObject(y, xmk, xb, xf, dim, suppress, pg, count,
    ...
    case 41:
      ...
      for( y=((x)->os1.olist[0].osucc)->os1.olist[1].opred, count=1; (y)->os1.ou1.os11.otype==0; y = (y)->os1.olist[1].opred, count++ );
      if( (dim == 0) == ((x)->os1.ou1.os11.otype == 24 || (x)->os1.ou1.os11.otype == 40) )
      { y = FixAndPrintObject(y, xmk, xb, xf, dim, 0, pg, count,
       &aback, &afwd);
        *actual_back = xb; *actual_fwd = xf;
      }
      else
 ...
 if( dim == 0 )
   y = FixAndPrintObject(y, xmk, xb, xf, dim, 0, pg, count,
  &aback, &afwd);
 else if( (scale_factor = ScaleFactor(xb+xf, ((y)->os1.ou3.os31.oback[1] + (y)->os1.ou3.os31.ofwd[1]))) > 0 )
 { BackEnd->SaveGraphicState(y);
   BackEnd->CoordTranslate(0,
     pg - (xmk - xb + (FULL_LENGTH) ((y)->os1.ou3.os31.oback[1] * scale_factor)));
   BackEnd->CoordScale(1.0, scale_factor);
   y = FixAndPrintObject(y, 0, (y)->os1.ou3.os31.oback[1], (y)->os1.ou3.os31.ofwd[1], dim,
     0, 0, count, &aback, &afwd);
   BackEnd->RestoreGraphicState();
 }
 else if( !(((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) || (y)->os1.ostring[0] != '\0' )
   Error(23, 1, "object deleted (it cannot be scaled vertically)",
    ...
    case 30:
      ...
      if( BackEnd->scale_avail )
      { if( dim == 0 )
        { (x)->os2.oux.osave_mark = xmk;
   ((x)->os2.ou4.oconstraint).obc = xb;
   ((x)->os2.ou4.oconstraint).ofc = xf;
          if( (scale_factor = ScaleFactor(xb+xf, ((y)->os1.ou3.os31.oback[0] + (y)->os1.ou3.os31.ofwd[0]))) > 0 )
     y = FixAndPrintObject(y, 0, (y)->os1.ou3.os31.oback[0], (y)->os1.ou3.os31.ofwd[0], dim,
       0, pg, count, &aback, &afwd);
          else if( !(((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) || (y)->os1.ostring[0] != '\0' )
   ...
   ScaleFactor(((x)->os2.ou4.oconstraint).obc+((x)->os2.ou4.oconstraint).ofc,((y)->os1.ou3.os31.oback[0] + (y)->os1.ou3.os31.ofwd[0]))) > 0 )
        { BackEnd->SaveGraphicState(y);
   BackEnd->CoordTranslate((x)->os2.oux.osave_mark - ((x)->os2.ou4.oconstraint).obc
        + (FULL_LENGTH) ((y)->os1.ou3.os31.oback[0]*scale_factor), 0);
  ...
  &aback, &afwd);
   BackEnd->RestoreGraphicState();
    ...
    case 34:
      ...
      {
        if( dim == 0 )
        { { if( !(((x)->os2.ou4.oconstraint).obc > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FAPO: horizontal scale factor!"); };
   (x)->os2.oux.osave_mark = xmk;
   yb = xb * 128 / ((x)->os2.ou4.oconstraint).obc;
   yf = xf * 128 / ((x)->os2.ou4.oconstraint).obc;
          y = FixAndPrintObject(y, 0, yb, yf, dim, 0, pg, count,
  &aback, &afwd);
        }
        else
        { { if( !(((x)->os2.ou4.oconstraint).ofc > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FAPO: vertical scale factor!"); };
   yb = xb * 128 / ((x)->os2.ou4.oconstraint).ofc;
   yf = xf * 128 / ((x)->os2.ou4.oconstraint).ofc;
   BackEnd->SaveGraphicState(y);
   BackEnd->CoordTranslate((x)->os2.oux.osave_mark, pg - xmk);
   BackEnd->CoordScale( (float)((x)->os2.ou4.oconstraint).obc/128,
     (float)((x)->os2.ou4.oconstraint).ofc/128);
          y = FixAndPrintObject(y, 0, yb, yf, dim, 0, 0, count,
  &aback, &afwd);
   BackEnd->RestoreGraphicState();
        }
      }
      else if( ((x)->os2.ou4.oconstraint).obc == 128 && ((x)->os2.ou4.oconstraint).ofc == 128 )
      {
 y = FixAndPrintObject(y, xmk, xb, xf, dim, suppress, pg, count,
       &aback, &afwd);
      }
 ...
 *actual_back = (x)->os1.ou3.os31.oback[dim]; *actual_fwd = (x)->os1.ou3.os31.ofwd[dim];
    ...
    case 50:
      ...
      if( BackEnd->rotate_avail )
      {
        ...
        { CONSTRAINT colc, rowc, yc;
          (x)->os2.oux.osave_mark = xmk;
   ((colc).obc = ((x)->os1.ou3.os31.oback[0]), (colc).obfc = (8388607), (colc).ofc = ((x)->os1.ou3.os31.ofwd[0]));
   ((rowc).obc = ((x)->os1.ou3.os31.oback[1]), (rowc).obfc = (8388607), (rowc).ofc = ((x)->os1.ou3.os31.ofwd[1]));
   RotateConstraint(&yc, y, ((x)->os2.ou4.oconstraint).osparec, &colc, &rowc,0);
   y = FixAndPrintObject(y, 0, (yc).obc, (yc).ofc, 0, 0, pg,
  count, &aback, &afwd);
        }
        else
        { CONSTRAINT colc, rowc, yc;
   BackEnd->SaveGraphicState(y);
   BackEnd->CoordTranslate((x)->os2.oux.osave_mark, pg - xmk);
   BackEnd->CoordRotate(((x)->os2.ou4.oconstraint).osparec);
   ((colc).obc = ((x)->os1.ou3.os31.oback[0]), (colc).obfc = (8388607), (colc).ofc = ((x)->os1.ou3.os31.ofwd[0]));
   ((rowc).obc = ((x)->os1.ou3.os31.oback[1]), (rowc).obfc = (8388607), (rowc).ofc = ((x)->os1.ou3.os31.ofwd[1]));
   RotateConstraint(&yc, y, ((x)->os2.ou4.oconstraint).osparec, &colc, &rowc, 1);
   y = FixAndPrintObject(y, 0, (yc).obc, (yc).ofc, 1, 0, 0,
  count, &aback, &afwd);
   BackEnd->RestoreGraphicState();
        }
      }
      else if( ((x)->os2.ou4.oconstraint).osparec == 0 )
 ...
 if( dim == 0 )
 {
   (x)->os1.ou3.os31.oback[dim] = xb;
   (x)->os1.ou3.os31.ofwd[dim] = xf;
   (x)->os2.oux.osave_mark = xmk - (x)->os1.ou3.os31.oback[dim];
 ...
 { OBJECT tmp, pre, post;
          ...
          if( (tmp)->os1.ou1.os11.otype == 19 )
          { for( pre = ((tmp)->os1.olist[0].osucc)->os1.olist[1].opred; (pre)->os1.ou1.os11.otype == 0; pre = (pre)->os1.olist[1].opred );
            for( post = ((tmp)->os1.olist[0].opred)->os1.olist[1].opred; (post)->os1.ou1.os11.otype == 0; post = (post)->os1.olist[1].opred );
          }
          else pre = tmp, post = ( (OBJECT) ((void*)0) );
   (x)->os1.ou3.os31.oback[dim] = xb;
   (x)->os1.ou3.os31.ofwd[dim] = xf;
          BackEnd->PrintPlainGraphic(pre, (x)->os2.oux.osave_mark,
     pg - (xmk - (x)->os1.ou3.os31.oback[dim]), x);
          y = FixAndPrintObject(y, xmk, xb, xf, dim, suppress, pg, count,
  &aback, &afwd);
          if( post != ( (OBJECT) ((void*)0) ) )
     BackEnd->PrintPlainGraphic(post, (x)->os2.oux.osave_mark,
       pg - (xmk - (x)->os1.ou3.os31.oback[dim]), x);
 }
      }
      else
 ...
 if( dim == 0 )
 {
   ...
   if( ((x)->os2.ou4.osave_style).ofont > 0 )
   { face = finfo[((x)->os2.ou4.osave_style).ofont].original_face;
     if( (face)->os1.ou2.os25.ofont_page < font_curr_page ) FontPageUsed(face);
   }
   ...
   (x)->os1.ou3.os31.ofwd[dim] = xf;
                                                       ...
                                                       ;
   (x)->os2.oux.osave_mark = xmk - (x)->os1.ou3.os31.oback[0];
          y = FixAndPrintObject(y, xb, xb, xf, dim, 0, pg, count,
  &aback, &afwd);
 }
 else
 { OBJECT tmp, pre, post;
   ...
   BackEnd->SaveTranslateDefineSave(x, (x)->os2.oux.osave_mark,
     pg - (xmk + (x)->os1.ou3.os31.ofwd[1]));
          BackEnd->PrintGraphicObject(pre);
          BackEnd->RestoreGraphicState();
          y = FixAndPrintObject(y, xb, xb, xf, dim, 0, xb + xf,
  count, &aback, &afwd);
          if( post != ( (OBJECT) ((void*)0) ) ) BackEnd->PrintGraphicObject(post);
          BackEnd->RestoreGraphicState();
 }
      }
      else
 ...
 (x)->os2.oux.osave_mark = xmk;
      ...
      { for( z = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
 if( (x)->os1.ou1.os11.otype == 98 )
   BackEnd->LinkSource(z, (x)->os2.oux.osave_mark - (x)->os1.ou3.os31.oback[0],
     (pg - xmk) - xf, (x)->os2.oux.osave_mark + (x)->os1.ou3.os31.ofwd[0],
     (pg - xmk) + xb);
 else
   BackEnd->LinkDest(z, (x)->os2.oux.osave_mark - (x)->os1.ou3.os31.oback[0],
     (pg - xmk) - xf, (x)->os2.oux.osave_mark + (x)->os1.ou3.os31.ofwd[0],
     (pg - xmk) + xb);
      }
      y = FixAndPrintObject(y, xmk, xb, xf, dim, 0, pg, count,
 ...
 else if( (x)->os1.ou2.os23.ocross_type )
   BackEnd->PrintGraphicInclude(x, (x)->os2.oux.osave_mark, pg - xmk);
      }
      *actual_back = xb; *actual_fwd = xf;
      break;
    ...
    case 9:
      ...
      link = ( (dim) == 0 ? (x)->os1.olist[0].osucc : (x)->os1.olist[0].opred ); for( y=(link)->os1.olist[1].opred, count=1; (y)->os1.ou1.os11.otype==0; y = (y)->os1.olist[1].opred, count++ );
      y = FixAndPrintObject(y, xmk, (((y)->os1.ou3.os31.oback[dim]) < (xb) ? (xb) : ((y)->os1.ou3.os31.oback[dim])),
 (((y)->os1.ou3.os31.ofwd[dim]) < (xf) ? (xf) : ((y)->os1.ou3.os31.ofwd[dim])), dim, suppress, pg, count,
 actual_back, actual_fwd);
      break;
    ...
    case 18:
      ...
      if( ((x)->os1.ou1.os11.otype == 19) == (dim == 1) )
      {
 ...
 if( link != x )
 {
# 670 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
   { g = ( (OBJECT) ((void*)0) ); jn = 1; for( link = (link)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) g = y, jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y):(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) { ; { if( !(g != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NextDefiniteWithGap: g == nilobj!"); }; break; } } };
   if( link != x && ((g)->os5.ogap).omode == 6 &&
       ((g)->os5.ogap).ounits == 3 && ((g)->os5.ogap).owidth == 0 )
   {

                                                ;

     (prev)->os1.ou3.os31.ofwd[dim] += xb - (x)->os1.ou3.os31.oback[dim];
     (x)->os1.ou3.os31.oback[dim] = xb;
     ((g)->os5.ogap).omode = 1;
     ((g)->os5.ogap).ounits = 1;
   }
   { jn = 1; for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( prev = (link)->os1.olist[1].opred; (prev)->os1.ou1.os11.otype == 0; prev = (prev)->os1.olist[1].opred ); if( (prev)->os1.ou1.os11.otype == 1 ) jn = jn && ((prev)->os5.ogap).ojoin; else if( (prev)->os1.ou1.os11.otype==9 ? SplitIsDefinite(prev) : (((prev)->os1.ou1.os11.otype) >= 9 && ((prev)->os1.ou1.os11.otype) <= 99)) break; } };
# 698 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
   frame_size = (x)->os1.ou3.os31.oback[dim] + xf;
   back_edge = xmk - (x)->os1.ou3.os31.oback[dim];
   if( (x)->os1.ou2.os23.oadjust_cat && !suppress )
     inc = FindAdjustIncrement(x, frame_size, dim);
   else inc = 0;
   mk = back_edge + (prev)->os1.ou3.os31.oback[dim];
   ...
   {
     if( ((g)->os5.ogap).omode == 6 && ((g)->os5.ogap).ounits == 3 &&
  ((g)->os5.ogap).owidth==4096 )
     {



                                                                ;
       prev = FixAndPrintObject(prev, mk, (prev)->os1.ou3.os31.oback[dim],
  (((prev)->os1.ou3.os31.ofwd[dim]) < (xmk+xf-mk - ((y)->os1.ou3.os31.oback[dim] + (y)->os1.ou3.os31.ofwd[dim])) ? (xmk+xf-mk - ((y)->os1.ou3.os31.oback[dim] + (y)->os1.ou3.os31.ofwd[dim])) : ((prev)->os1.ou3.os31.ofwd[dim])),
  dim, 0, pg, count, &aback, &afwd);
     }
     else
     {
                                              ...
                                              ;
       prev = FixAndPrintObject(prev, mk, (prev)->os1.ou3.os31.oback[dim],
  (prev)->os1.ou3.os31.ofwd[dim] + inc, dim, 0, pg, count,&aback,&afwd);
     }
     mk += ActualGap(afwd, (y)->os1.ou3.os31.oback[dim], (y)->os1.ou3.os31.ofwd[dim], &(g)->os5.ogap,
      frame_size, mk - back_edge);
     prev = y;
     { g = ( (OBJECT) ((void*)0) ); jn = 1; for( link = (link)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) g = y, jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y):(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) { ; { if( !(g != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NextDefiniteWithGap: g == nilobj!"); }; break; } } };
   }
# 749 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
   if( suppress )
   {


                                  ;
     prev = FixAndPrintObject(prev, mk, (prev)->os1.ou3.os31.oback[dim], (prev)->os1.ou3.os31.ofwd[dim],
       dim, 0, pg, count, &aback, &afwd);
   }
   else
   {
                                        ...
                                        ;
     prev = FixAndPrintObject(prev, mk, (prev)->os1.ou3.os31.oback[dim],
       (((prev)->os1.ou3.os31.ofwd[dim]) < (xmk + xf - mk) ? (xmk + xf - mk) : ((prev)->os1.ou3.os31.ofwd[dim])),
       dim, 0, pg, count, &aback, &afwd);
   }
   *actual_back = (((x)->os1.ou3.os31.oback[dim]) < (xb) ? (xb) : ((x)->os1.ou3.os31.oback[dim]));
   *actual_fwd = mk + (prev)->os1.ou3.os31.ofwd[dim] - back_edge - *actual_back;
      ...
      { OBJECT start_group, zlink, m; unsigned dble_found;
 FULL_LENGTH b, f, dlen;
 start_group = ( (OBJECT) ((void*)0) ); dble_found = 0; dlen = 0;
                                       ;
 ...
 if( link != x )
 {
  ...
  0, pg, count, &aback, &afwd);
       b = (m)->os1.ou3.os31.oback[dim]; f = (m)->os1.ou3.os31.ofwd[dim];
       for( zlink = start_group; zlink != link; zlink=(zlink)->os1.olist[0].osucc )
       { for( z=(zlink)->os1.olist[1].opred, count=1; (z)->os1.ou1.os11.otype==0; z = (z)->os1.olist[1].opred, count++ );
  if( !(((z)->os1.ou1.os11.otype) >= 9 && ((z)->os1.ou1.os11.otype) <= 99) || z == m ) continue;
  z = FixAndPrintObject(z, xmk + b, b, xf - b, dim,
    1, pg, count, &aback, &afwd);
  b = ((b) < ((z)->os1.ou3.os31.oback[dim]) ? ((z)->os1.ou3.os31.oback[dim]) : (b)); f = ((f) < ((z)->os1.ou3.os31.ofwd[dim]) ? ((z)->os1.ou3.os31.ofwd[dim]) : (f));
       }
       dlen = ((dlen) < (b + f) ? (b + f) : (dlen));
       dble_found = 1;
       start_group = ( (OBJECT) ((void*)0) );
     ...
     else
     {
       ...
       if( (y)->os1.ou3.os31.ofwd[dim] > (m)->os1.ou3.os31.ofwd[dim] ) m = y;
   ...
   { if( !(start_group != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FAPO: final start_group!"); };
   ...
   if( dble_found || !jn )
   {
                                      ...
                                      ;
     m = FixAndPrintObject(m, xmk+b, b, xf - b, dim, 0, pg,
    count, &aback, &afwd);
     b = (m)->os1.ou3.os31.oback[dim]; f = (m)->os1.ou3.os31.ofwd[dim];
     for( zlink = start_group; zlink != x; zlink = (zlink)->os1.olist[0].osucc )
     { for( z=(zlink)->os1.olist[1].opred, count=1; (z)->os1.ou1.os11.otype==0; z = (z)->os1.olist[1].opred, count++ );
       if( !(((z)->os1.ou1.os11.otype) >= 9 && ((z)->os1.ou1.os11.otype) <= 99) || z == m ) continue;
       z = FixAndPrintObject(z, xmk+b, b, xf - b, dim, 1, pg,
      count, &aback, &afwd);
       b = ((b) < ((z)->os1.ou3.os31.oback[dim]) ? ((z)->os1.ou3.os31.oback[dim]) : (b)); f = ((f) < ((z)->os1.ou3.os31.ofwd[dim]) ? ((z)->os1.ou3.os31.ofwd[dim]) : (f));
     }
     dlen = ((dlen) < (b + f) ? (b + f) : (dlen));
   ...
   else
   {
                                    ...
                                    ;
     m = FixAndPrintObject(m, xmk, xb, xf, dim, 0, pg, count,
       &b, &f);
     for( zlink = start_group; zlink != x; zlink = (zlink)->os1.olist[0].osucc )
     { for( z=(zlink)->os1.olist[1].opred, count=1; (z)->os1.ou1.os11.otype==0; z = (z)->os1.olist[1].opred, count++ );
       if( !(((z)->os1.ou1.os11.otype) >= 9 && ((z)->os1.ou1.os11.otype) <= 99) || z == m ) continue;
       z = FixAndPrintObject(z, xmk, xb, xf, dim, 1, pg, count,
      &aback, &afwd);
       b = ((b) < (aback) ? (aback) : (b)); f = ((f) < (afwd) ? (afwd) : (f));
     }
    ...
    case 17:
      ...
      if( dim == 0 )
      { unsigned will_adjust, adjusting;
 FULL_LENGTH actual_size,
 adjust_indent, frame_size, back_edge, adjust_inc, inc, adjust_sofar;
 int adjustable_gaps, gaps_sofar;
 unsigned underlining; int underline_xstart;
 FONT_NUM underline_font; COLOUR_NUM underline_colour;
 OBJECT urec, last_bad_gap;
# 906 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
 { jn = 1; for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y) : (((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99)) break; } };
 if( link == x )
 {
   *actual_back = (x)->os1.ou3.os31.oback[dim]; *actual_fwd = (x)->os1.ou3.os31.ofwd[dim];
...
# 922 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
 last_bad_gap = ( (OBJECT) ((void*)0) );
 adjustable_gaps = 0;
 back_edge = xmk - xb;
 mk = back_edge + (y)->os1.ou3.os31.oback[dim];
 frame_size = xb + xf;
 prev = y;
 { g = ( (OBJECT) ((void*)0) ); jn = 1; for( link = (link)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) g = y, jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y):(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) { ; { if( !(g != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NextDefiniteWithGap: g == nilobj!"); }; break; } } };
 while( link != x )
 {
   (g)->os5.osave_actual_gap = ActualGap((prev)->os1.ou3.os31.ofwd[dim], (y)->os1.ou3.os31.oback[dim],
  (y)->os1.ou3.os31.ofwd[dim], &(g)->os5.ogap, frame_size, mk - back_edge);
   mk += (g)->os5.osave_actual_gap;
   if( ((g)->os5.ogap).omode == 6 || ((g)->os5.ogap).ounits == 3
           || ((g)->os5.ogap).ounits == 2 )
   { last_bad_gap = g;
     adjustable_gaps = 0;
   }
   else if( ((g)->os5.ogap).owidth > 0 ) adjustable_gaps++;
   prev = y;
   { g = ( (OBJECT) ((void*)0) ); jn = 1; for( link = (link)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) g = y, jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y):(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) { ; { if( !(g != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NextDefiniteWithGap: g == nilobj!"); }; break; } } };
 }
 actual_size = mk + (prev)->os1.ou3.os31.ofwd[dim] - back_edge;
# 956 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
 if( actual_size > frame_size && adjustable_gaps == 0 )
 {

   CONSTRAINT c;
   ((c).obc = (0), (c).obfc = (frame_size), (c).ofc = (frame_size));
   (x)->os1.ou3.os31.ofwd[dim] = actual_size;
   ...
   if( BackEnd->scale_avail && InsertScale(x, &c) )
   {
     ...
     OBJECT prnt;
     for( prnt = ((x)->os1.olist[1].osucc)->os1.olist[0].opred; (prnt)->os1.ou1.os11.otype == 0; prnt = (prnt)->os1.olist[0].opred );
     for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
     if( actual_size - frame_size < 1 * 20 )
     {


     }
     else if( (x)->os1.olist[0].osucc == (x)->os1.olist[0].opred && (((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) )
     {
       Error(23, 3, "word %s horizontally scaled by factor %.2f (too wide for %s paragraph)",
  2, &(y)->os1.ou1.ofpos, (y)->os1.ostring, (float) ((prnt)->os2.ou4.oconstraint).obc / 128,
  EchoLength(frame_size));
     }
     else
     {
       Error(23, 4, "%s object horizontally scaled by factor %.2f (too wide for %s paragraph)",
  2, &(x)->os1.ou1.ofpos, EchoLength(((x)->os1.ou3.os31.oback[0] + (x)->os1.ou3.os31.ofwd[0])),
  (float) ((prnt)->os2.ou4.oconstraint).obc / 128, EchoLength(frame_size));
     }
     prnt = FixAndPrintObject(prnt, xmk, (prnt)->os1.ou3.os31.oback[dim], (prnt)->os1.ou3.os31.ofwd[dim], dim,
       0, pg, count, &aback, &afwd);
   }
   else
   {

     if( ((x)->os1.ou3.os31.oback[0] + (x)->os1.ou3.os31.ofwd[0]) <= 0 )
       Error(23, 5, "oversize object has size 0 or less", 0, &(x)->os1.ou1.ofpos);
     for( y = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
     if( (x)->os1.olist[0].osucc == (x)->os1.olist[0].opred && (((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12) )
     { Error(23, 6, "word %s deleted (too wide for %s paragraph)",
  2, &(y)->os1.ou1.ofpos, (y)->os1.ostring, EchoLength(frame_size));
     }
     else
     { Error(23, 7, "%s object deleted (too wide for %s paragraph)",
  2, &(x)->os1.ou1.ofpos, EchoLength(((x)->os1.ou3.os31.oback[0] + (x)->os1.ou3.os31.ofwd[0])), EchoLength(frame_size));
     }


     while( (x)->os1.olist[0].osucc != x )
     ...
     y = MakeWord(11, ( (FULL_CHAR *) ("") ), &(x)->os1.ou1.ofpos);
     ...
     (y)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.ofwd[0] = 0;
     (y)->os1.ou3.os31.oback[1] = (y)->os1.ou3.os31.ofwd[1] = 0;
   }
        }
        else
        {
# 1046 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
   if( actual_size > frame_size )
   {
     { if( !(adjustable_gaps > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FAPO: adjustable_gaps!"); };
     (x)->os1.ou2.os23.oadjust_cat = 1;
     adjust_indent = 0;
   }
   else switch( ((x)->os2.ou4.osave_style).osu2.oss2.odisplay_style )
   {
     case 7: (x)->os1.ou2.os23.oadjust_cat = 1;
    adjust_indent = 0;
                                               ;
    break;

     case 5: (x)->os1.ou2.os23.oadjust_cat = 0;
    adjust_indent = (frame_size - actual_size)/2;
                                              ;
    break;

     case 6: (x)->os1.ou2.os23.oadjust_cat = 0;
   ...
   if( (x)->os1.ou2.os23.oadjust_cat && adjustable_gaps > 0 )
   { will_adjust = 1;
     adjust_inc = (frame_size - actual_size) / adjustable_gaps;
     inc = ((adjust_inc) < (0) ? (0) : (adjust_inc));
     gaps_sofar = 0;
     adjust_sofar = 0;
...
# 1099 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
   underlining = 0;
   adjusting = will_adjust && last_bad_gap == ( (OBJECT) ((void*)0) );
   { jn = 1; for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y) : (((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99)) break; } };
   prev = y;
   mk = xmk - (x)->os1.ou3.os31.oback[dim] + (y)->os1.ou3.os31.oback[dim] + adjust_indent;
   { g = ( (OBJECT) ((void*)0) ); jn = 1; for( link = (link)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) g = y, jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y):(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) { ; { if( !(g != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NextDefiniteWithGap: g == nilobj!"); }; break; } } };
   while( link != x )
   {

     if( (prev)->os1.ou2.os22.ounderline == 2 )
     {
       ...
       if( !underlining )
       {
         ...
         underlining = 1;
                                        ...
                                        ;
         underline_font = (((prev)->os1.ou1.os11.otype) == 11 || ((prev)->os1.ou1.os11.otype) == 12) ? (prev)->os1.ou2.os22.oword_font :
      ((x)->os2.ou4.osave_style).ofont;
  underline_colour = (((prev)->os1.ou1.os11.otype) == 11 || ((prev)->os1.ou1.os11.otype) == 12) ? (prev)->os1.ou2.os22.oword_colour :
      ((x)->os2.ou4.osave_style).ocolour;
         underline_xstart = mk - (prev)->os1.ou3.os31.oback[dim];
       }
       if( (g)->os1.ou2.os22.ounderline == 1 )
       {


                                        ;
         { ; { ; if( (zz_size=(zz_lengths[3])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 3; ; urec = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
         (urec)->os1.ou3.os31.oback[0] = underline_xstart;
         (urec)->os1.ou3.os31.ofwd[0] = mk + (prev)->os1.ou3.os31.ofwd[dim];
         (urec)->os1.ou3.os31.oback[1] = underline_font;
         (urec)->os1.ou3.os31.ofwd[1] = underline_colour;
         underlining = 0;
         { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = (((prev)->os1.olist[1].osucc)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((urec)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
       }
     }


     if( adjusting && ((g)->os5.ogap).owidth > 0 )
     { int tmp;
  ...
  (prev)->os1.ou3.os31.ofwd[dim] + inc, dim, 0, pg, count,&aback,&afwd);
       ...
       mk += (g)->os5.osave_actual_gap + (tmp - adjust_sofar);
       adjust_sofar = tmp;
     }
     else
     {
     ...
     { g = ( (OBJECT) ((void*)0) ); jn = 1; for( link = (link)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 1 ) g = y, jn = jn && ((y)->os5.ogap).ojoin; else if( (y)->os1.ou1.os11.otype==9 ? SplitIsDefinite(y):(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) ) { ; { if( !(g != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NextDefiniteWithGap: g == nilobj!"); }; break; } } };
                                                                   ...
                                                                   ;
                                                                        ;
   { if( !((prev)->os1.ou2.os22.ounderline == 1 || (prev)->os1.ou2.os22.ounderline == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FixAndPrint: underline(prev)!"); };
   ...
   prev = FixAndPrintObject(prev, mk, (prev)->os1.ou3.os31.oback[dim],
     frame_size - (mk - xmk) - (x)->os1.ou3.os31.oback[dim],
     dim, 0, pg, count, &aback, &afwd);

        }
      }
      else for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
      { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 if( !(((y)->os1.ou1.os11.otype) >= 9 && ((y)->os1.ou1.os11.otype) <= 99) )
 {
   if( (y)->os1.ou1.os11.otype == 3 )
   { BackEnd->PrintUnderline((y)->os1.ou3.os31.oback[1], (y)->os1.ou3.os31.ofwd[1], (y)->os1.ou3.os31.oback[0],
       (y)->os1.ou3.os31.ofwd[0], pg - xmk);
 ...
 y = FixAndPrintObject(y, xmk, xb, xf, dim, 0, pg, count,
    ...
    case 15:
      ...
      { if( !(((x)->os1.ou1.os11.otype == 16) == (dim == 0)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FixAndPrintObject: thr!"); };
      for( link = (x)->os1.olist[0].osucc, uplink = (x)->os1.olist[1].osucc, i = 1;
 link != x && uplink != x && i < count;
 link = (link)->os1.olist[0].osucc, uplink = (uplink)->os1.olist[1].osucc, i++ );
      { if( !(link != x && uplink != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FixAndPrintObject: link or uplink!"); };
      for( y=(link)->os1.olist[1].opred, count=1; (y)->os1.ou1.os11.otype==0; y = (y)->os1.olist[1].opred, count++ );



                                                                      ;
      ( xx_link = (uplink), ( zz_hold = (xx_link), (zz_hold)->os1.olist[1 - (0)].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1 - (0)].osucc, (zz_res)->os1.olist[1 - (0)].opred = (zz_hold)->os1.olist[1 - (0)].opred, ((zz_hold)->os1.olist[1 - (0)].opred)->os1.olist[1 - (0)].osucc = zz_res, (zz_hold)->os1.olist[1 - (0)].opred = (zz_hold)->os1.olist[1 - (0)].osucc = zz_hold, zz_res ) ), ( zz_res = (xx_link), zz_hold = ((link)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1 - (0)].opred, (zz_hold)->os1.olist[1 - (0)].opred = (zz_res)->os1.olist[1 - (0)].opred, ((zz_res)->os1.olist[1 - (0)].opred)->os1.olist[1 - (0)].osucc = zz_hold, (zz_res)->os1.olist[1 - (0)].opred = zz_tmp, (zz_tmp)->os1.olist[1 - (0)].osucc = zz_res ) ) ); { xx_link = (link); ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; };
      { if( !((y)->os1.ou1.os11.otype != 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FAPO: THR!"); };

      if( (x)->os1.ou2.os23.ocross_type != 2 )
      { (x)->os1.ou3.os31.oback[dim] = xb; (x)->os1.ou3.os31.ofwd[dim] = xf;
 (x)->os1.ou2.os23.ocross_type = 2;
      }

      y = FixAndPrintObject(y, xmk, (x)->os1.ou3.os31.oback[dim], (x)->os1.ou3.os31.ofwd[dim], dim,
 0, pg, count, &aback, &afwd);
      *actual_back = xb; *actual_fwd = xf;

      break;
# 1331 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z23.c"
    case 20:
    case 21:
    case 22:
    case 23:
      ...
      if( dim == 0 )
        Error(23, 8, "%s symbol ignored (out of place)", 2, &(x)->os1.ou1.ofpos,
   Image((x)->os1.ou1.os11.otype));
      break;


    default:

      { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"FixAndPrintObject:", Image((x)->os1.ou1.os11.otype)); };
      break;
