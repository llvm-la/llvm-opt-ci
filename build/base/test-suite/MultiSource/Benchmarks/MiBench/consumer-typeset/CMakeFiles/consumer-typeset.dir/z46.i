# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c" 2
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c"
unsigned FindOptimize(OBJECT x, OBJECT env)
{ OBJECT y, link, res;
  OBJECT bt[2], ft[2], ntarget, nenclose, crs;
                                                     ;
  { if( !((x)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FindOptimize: type(x) != CLOSURE!"); };
  { if( !(((x)->os2.oactual)->os1.ou2.os26.ohas_target) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FindOptimize: x has no target!"); };
  ...
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os1.ou1.os11.otype == 10 && ((y)->os2.oactual)->os6.ois_optimize )
    { { if( !((y)->os1.olist[0].osucc != y) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FindOptimize: Down(PAR)!"); };
      for( res = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (res)->os1.ou1.os11.otype == 0; res = (res)->os1.olist[1].opred );
      res = CopyObject(res, &(x)->os1.ou1.ofpos);
      break;
    }
  }
  ...
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os6.ois_optimize )
    { res = CopyObject((y)->os6.osym_body, &(x)->os1.ou1.ofpos);
      break;
    }
  }


  { if( !(res != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FindOptimize: res == nilobj!"); };


  bt[0] = ft[0] = bt[1] = ft[1] = ntarget = nenclose = crs = ( (OBJECT) ((void*)0) );
  res = Manifest(res, env, &(x)->os2.ou4.osave_style, bt, ft, &ntarget, &crs, 1, 0,
    &nenclose, 0);
  res = ReplaceWithTidy(res, 1);
  if( !(((res)->os1.ou1.os11.otype) == 11 || ((res)->os1.ou1.os11.otype) == 12) )
  { Error(46, 1, "unable to evaluate %s parameter, assuming value is No",
      2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Optimize") ));

                                        ;
    return 0;
  }
  else if( (strcmp((char *)((res)->os1.ostring), (char *)(( (FULL_CHAR *) ("Yes") )))==0) )
  { ;
    return 1;
  }
  else if( (strcmp((char *)((res)->os1.ostring), (char *)(( (FULL_CHAR *) ("No") )))==0) )
  { ;
    return 0;
  }
  else
...
# 113 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c"
void SetOptimize(OBJECT hd, STYLE *style)
{ FULL_CHAR buff[512], seq[512];
  OBJECT res, y, link, z; FILE_NUM dfnum; long dfpos, cont; int dlnum;
                                                                              ;


  strcpy((char *)(buff),(char *)(SymName((hd)->os2.oactual)));
  strcat((char *)(buff),(char *)(( (FULL_CHAR *) (".") )));
  strcat((char *)(buff),(char *)(StringInt(((hd)->os1.ou1.ofpos).oline_num)));
  if( DbRetrieve(OldCrossDb, 0, OptGallSym, buff, seq, &dfnum,
    &dfpos, &dlnum, &cont) )
  {
    SwitchScope(( (OBJECT) ((void*)0) ));
    res = ReadFromFile(dfnum, dfpos, dlnum);
    UnSwitchScope(( (OBJECT) ((void*)0) ));
    { if( !(res != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: res == nilobj!"); };
    { if( !((res)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: type(res) != CLOSURE!"); };
    { if( !((res)->os2.oactual == OptGallSym) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: actual(res) != Opt!"); };
    { if( !((res)->os1.olist[0].osucc != res) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: Down(res) == res!"); };
    for( y = ((res)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    { if( !((y)->os1.ou1.os11.otype == 10) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: type(y) != PAR!"); };
    for( y = ((y)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    { if( !((y)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: type(y) != ACAT!"); };
    y = ReplaceWithTidy(y, 0);
    (hd)->os1.ou2.os23.oopt_hyph = 0;
    { if( !((y)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: type(y) != ACAT (2)!"); };
    for( link = y; (link)->os1.olist[0].osucc != y; link = (link)->os1.olist[0].osucc )
    { for( z = ((link)->os1.olist[0].osucc)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
      if( (z)->os1.ou1.os11.otype == 1 )
 ...
 link = (link)->os1.olist[0].opred;
      ...
      else if( (((z)->os1.ou1.os11.otype) == 11 || ((z)->os1.ou1.os11.otype) == 12) )
      { if( (strcmp((char *)((z)->os1.ostring), (char *)(( (FULL_CHAR *) ("h") )))==0) )
 { (hd)->os1.ou2.os23.oopt_hyph = 1;
   { xx_link = ((link)->os1.olist[0].osucc); xx_tmp = ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; if( (xx_tmp)->os1.olist[1].osucc == xx_tmp ) DisposeObject(xx_tmp); };
   link = (link)->os1.olist[0].opred;
 }
 else
 { int num = 0;
   sscanf( (char *) (z)->os1.ostring, "%d", &num);
   { if( !(num > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: num <= 0!"); };
   (z)->os1.ou3.os31.oback[0] = num;
 }
      }
      else
      { { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SetOptimize: type(z)!"); };
      }
    }
    { xx_link = ((y)->os1.olist[1].osucc); ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; };
    DisposeObject(res);
    (hd)->os2a.oopt_counts = y;
  }
  else (hd)->os2a.oopt_counts = ( (OBJECT) ((void*)0) );
  ...
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; (hd)->os2a.oopt_components = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  (hd)->os1.ou2.os23.oopt_gazumped = 0;
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; (hd)->os2a.oopt_constraints = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  ( ( ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oline_gap).onobreak = ((*style).osu1.oline_gap).onobreak, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oline_gap).omark = ((*style).osu1.oline_gap).omark, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oline_gap).ojoin = ((*style).osu1.oline_gap).ojoin, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oline_gap).ounits = ((*style).osu1.oline_gap).ounits, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oline_gap).omode = ((*style).osu1.oline_gap).omode, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oline_gap).owidth = ((*style).osu1.oline_gap).owidth ), (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.oss2.ohyph_style = (*style).osu2.oss2.ohyph_style, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.oss2.ofill_style = (*style).osu2.oss2.ofill_style, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.oss2.odisplay_style = (*style).osu2.oss2.odisplay_style, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oss1.osmall_caps = (*style).osu1.oss1.osmall_caps, ( ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.ospace_gap).onobreak = ((*style).osu2.ospace_gap).onobreak, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.ospace_gap).omark = ((*style).osu2.ospace_gap).omark, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.ospace_gap).ojoin = ((*style).osu2.ospace_gap).ojoin, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.ospace_gap).ounits = ((*style).osu2.ospace_gap).ounits, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.ospace_gap).omode = ((*style).osu2.ospace_gap).omode, ((((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.ospace_gap).owidth = ((*style).osu2.ospace_gap).owidth ), (((hd)->os2a.oopt_components)->os2.ou4.osave_style).ofont = (*style).ofont, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).ocolour = (*style).ocolour, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).ooutline = (*style).ooutline, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).olanguage = (*style).olanguage, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).onobreaklast = (*style).onobreaklast, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).onobreakfirst = (*style).onobreakfirst, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oss1.ovadjust = (*style).osu1.oss1.ovadjust, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oss1.ohadjust = (*style).osu1.oss1.ohadjust, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oss1.opadjust = (*style).osu1.oss1.opadjust, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu1.oss1.ospace_style = (*style).osu1.oss1.ospace_style, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).oyunit = (*style).oyunit, (((hd)->os2a.oopt_components)->os2.ou4.osave_style).ozunit = (*style).ozunit );
  if( (hd)->os1.ou2.os23.ogall_dir == 1 )
    (((hd)->os2a.oopt_components)->os2.ou4.osave_style).osu2.oss2.ohyph_style = 1;

                                          ;
                                    ;
}
# 200 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c"
void GazumpOptimize(OBJECT hd, OBJECT dest)
{ OBJECT g, tmp, junk, prnt;


                     ;
  { if( !((hd)->os1.ou1.os11.otype == 8) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "GazumpOptimize: type(hd) != HEAD!"); };
  { if( !((hd)->os2a.oopt_components != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "GazumpOptimize: opt_c!"); };


  { ; { ; if( (zz_size=(zz_lengths[26])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 26; ; tmp = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  if( ((hd)->os1.ou2.os23.ogall_dir == 0 && (dest)->os1.ou2.os23.oexternal_hor) ||
      ((hd)->os1.ou2.os23.ogall_dir == 0 && (dest)->os1.ou2.os23.oexternal_hor) )
  { (((tmp)->os2.ou4.oconstraint).obc = (8388607), ((tmp)->os2.ou4.oconstraint).obfc = (8388607), ((tmp)->os2.ou4.oconstraint).ofc = (8388607));
  }
  else
  { for( prnt = ((dest)->os1.olist[1].osucc)->os1.olist[0].opred; (prnt)->os1.ou1.os11.otype == 0; prnt = (prnt)->os1.olist[0].opred );
    Constrained(prnt, &(tmp)->os2.ou4.oconstraint, (hd)->os1.ou2.os23.ogall_dir, &junk);
  }
  ...
  if( ((hd)->os2a.oopt_components)->os1.olist[0].opred != (hd)->os2a.oopt_components )
  { for( g = (((hd)->os2a.oopt_components)->os1.olist[0].opred)->os1.olist[1].opred; (g)->os1.ou1.os11.otype == 0; g = (g)->os1.olist[1].opred );
    { if( !((g)->os1.ou1.os11.otype == 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FlushGalley: type(g) != GAP_OBJ!"); };
# 236 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c"
    ( ((g)->os5.ogap).onobreak = 0, ((g)->os5.ogap).omark = 0, ((g)->os5.ogap).ojoin = 1, ((g)->os5.ogap).ounits = 3, ((g)->os5.ogap).omode = 6, ((g)->os5.ogap).owidth = 1 * 4096 );
    if( (g)->os1.olist[0].osucc != g ) { xx_link = ((g)->os1.olist[0].osucc); xx_tmp = ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; if( (xx_tmp)->os1.olist[1].osucc == xx_tmp ) DisposeObject(xx_tmp); };
    tmp = MakeWord(11, ( (FULL_CHAR *) ("1rt") ), &(g)->os1.ou1.ofpos);
    ...
    ( ((g)->os1.ou1.ofpos).ofile_num = ((tmp)->os1.ou1.ofpos).ofile_num, ((g)->os1.ou1.ofpos).oline_num = ((tmp)->os1.ou1.ofpos).oline_num, ((g)->os1.ou1.ofpos).ocol_num = ((tmp)->os1.ou1.ofpos).ocol_num );
    ( ((g)->os5.ogap).onobreak = 0, ((g)->os5.ogap).omark = 0, ((g)->os5.ogap).ojoin = 1, ((g)->os5.ogap).ounits = 1, ((g)->os5.ogap).omode = 1, ((g)->os5.ogap).owidth = 1 * 567 );
    tmp = MakeWord(11, ( (FULL_CHAR *) ("1c") ), &(g)->os1.ou1.ofpos);
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((g)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((tmp)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    ...
    (hd)->os1.ou2.os23.oopt_gazumped = 1;
  ...
  if( (hd)->os2a.oopt_counts != ( (OBJECT) ((void*)0) ) && ((hd)->os2a.oopt_counts)->os1.olist[0].osucc != (hd)->os2a.oopt_counts )
  { for( tmp = (((hd)->os2a.oopt_counts)->os1.olist[0].osucc)->os1.olist[1].opred; (tmp)->os1.ou1.os11.otype == 0; tmp = (tmp)->os1.olist[1].opred );
    (hd)->os2a.oopt_comps_permitted += (tmp)->os1.ou3.os31.oback[0] - 1;
    { xx_link = ((tmp)->os1.olist[1].osucc); xx_tmp = ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; if( (xx_tmp)->os1.olist[1].osucc == xx_tmp ) DisposeObject(xx_tmp); };
  }
  else (hd)->os2a.oopt_comps_permitted = 65535;
...
# 286 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z46.c"
void CalculateOptimize(OBJECT hd)
{ OBJECT z, y, ylink, og, og_par, para, link, wd, g, last;
  int count, compcount; FULL_CHAR buff[512];
  FILE_NUM fnum; int write_pos, write_lnum; unsigned hyph_used;
                                                              ;


  { if( !(((hd)->os2a.oopt_components)->os1.olist[0].opred != (hd)->os2a.oopt_components) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "CO!"); };
  for( last = (((hd)->os2a.oopt_components)->os1.olist[0].opred)->os1.olist[1].opred; (last)->os1.ou1.os11.otype == 0; last = (last)->os1.olist[1].opred );
  { if( !((last)->os1.ou1.os11.otype == 1) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "CalculateOptimize: type(last)!"); };
  ...
  { if( !((hd)->os2a.oopt_constraints != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "KillGalley: no opt_constraints!"); };
  { if( !(((hd)->os2a.oopt_constraints)->os1.olist[0].osucc != (hd)->os2a.oopt_constraints) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "KillGalleyo!"); };




  for( y = (((hd)->os2a.oopt_constraints)->os1.olist[0].opred)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
  EnterErrorBlock(0);
  (hd)->os2a.oopt_components = FillObject((hd)->os2a.oopt_components, &(y)->os2.ou4.oconstraint,
    (hd)->os2a.oopt_constraints, 0, 0, 1, &hyph_used);
  LeaveErrorBlock(0);
                                                                          ;
                                    ;


  if( ((hd)->os2a.oopt_components)->os1.ou1.os11.otype != 19 ||
      ((hd)->os2a.oopt_components)->os1.olist[0].osucc == ((hd)->os2a.oopt_components)->os1.olist[0].opred )
  {
                                                                   ;
    return;
  }
  ...
  { ; { ; if( (zz_size=(zz_lengths[2])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 2; ; og = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  (og)->os2.oactual = OptGallSym;
  ( ((og)->os1.ou1.ofpos).ofile_num = ((hd)->os1.ou1.ofpos).ofile_num, ((og)->os1.ou1.ofpos).oline_num = ((hd)->os1.ou1.ofpos).oline_num, ((og)->os1.ou1.ofpos).ocol_num = ((hd)->os1.ou1.ofpos).ocol_num );
  { ; { ; if( (zz_size=(zz_lengths[10])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 10; ; og_par = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  (og_par)->os2.oactual = ChildSym(OptGallSym, 146);
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((og)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((og_par)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; para = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((og_par)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((para)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };


  if( hyph_used )
  { wd = MakeWord(11, ( (FULL_CHAR *) ("h") ), &(hd)->os1.ou1.ofpos);
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((para)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((wd)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  }


  compcount = 0;
  for( link = ((hd)->os2a.oopt_components)->os1.olist[0].osucc; link != (hd)->os2a.oopt_components;
       link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os1.ou1.os11.otype != 17 ) continue;


    count = 0;
    for( ylink = (y)->os1.olist[0].osucc; ylink != y; ylink = (ylink)->os1.olist[0].osucc )
    { for( z = (ylink)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
      if( (z)->os1.ou1.os11.otype != 1 ) count++;
    }
    wd = MakeWord(11, StringInt(count), &(y)->os1.ou1.ofpos);


    if( (para)->os1.olist[0].osucc != para )
    { { ; { ; if( (zz_size=(zz_lengths[1])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 1; ; g = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
      ( ((g)->os5.ogap).onobreak = 0, ((g)->os5.ogap).omark = 0, ((g)->os5.ogap).ojoin = 1, ((g)->os5.ogap).ounits = 1, ((g)->os5.ogap).omode = 1, ((g)->os5.ogap).owidth = 1*120 );
      if( ++compcount % 20 == 0 )
      { (g)->os1.ou2.os21.ohspace = 0;
 (g)->os1.ou2.os21.ovspace = 1;
      }
      else
      { (g)->os1.ou2.os21.ohspace = 1;
        (g)->os1.ou2.os21.ovspace = 0;
      }
      { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((para)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((g)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    }
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((para)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((wd)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  ...
  DisposeObject((hd)->os2a.oopt_constraints);
  (hd)->os2a.oopt_constraints = ( (OBJECT) ((void*)0) );
  ...
  if( AllowCrossDb )
  {
    ...
    strcat((char *)(buff),(char *)(( (FULL_CHAR *) (".") )));
    strcat((char *)(buff),(char *)(StringInt(((hd)->os1.ou1.ofpos).oline_num)));
    fnum = DatabaseFileNum(&(hd)->os1.ou1.ofpos);
    AppendToFile(og, fnum, &write_pos, &write_lnum);
    DbInsert(NewCrossDb, 0, OptGallSym, buff, &(hd)->os1.ou1.ofpos,
      ( (FULL_CHAR *) ("0") ), fnum, write_pos, write_lnum, 0);
  }
                                                ;
}
