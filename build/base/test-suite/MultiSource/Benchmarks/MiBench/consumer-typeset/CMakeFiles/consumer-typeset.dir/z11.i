# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c" 2
# 97 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c"
static void changespace(STYLE *style, OBJECT x)
{ GAP res_gap; unsigned gap_inc;
  { if( !((((x)->os1.ou1.os11.otype) == 11 || ((x)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "changespace: type(x)!"); };
  if( ( ((x)->os1.ostring[0]) >= 'a' && ((x)->os1.ostring[0]) <= 'z' ) )
  {

    if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("lout") )))==0) )
 (*style).osu1.oss1.ospace_style = 0;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("compress") )))==0) )
 (*style).osu1.oss1.ospace_style = 1;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("separate") )))==0) )
 (*style).osu1.oss1.ospace_style = 2;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("troff") )))==0) )
 (*style).osu1.oss1.ospace_style = 3;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("tex") )))==0) )
 (*style).osu1.oss1.ospace_style = 4;
    else Error(11, 1, "unknown option to %s symbol (%s)",
    2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Space") ), (x)->os1.ostring);
  }
  else
  { GetGap(x, style, &res_gap, &gap_inc);
    if( gap_inc != 158 && (res_gap).ounits != ((*style).osu2.ospace_gap).ounits )
    { Error(11, 2, "spacing %s is not compatible with current spacing",
 2, &(x)->os1.ou1.ofpos, (x)->os1.ostring);
    }
    else
    { ((*style).osu2.ospace_gap).ounits = (res_gap).ounits;
      ((*style).osu2.ospace_gap).omode = (res_gap).omode;
      ((*style).osu2.ospace_gap).owidth = gap_inc == 158 ? (res_gap).owidth :
      gap_inc == 159 ? ((*style).osu2.ospace_gap).owidth + (res_gap).owidth :
      ((((*style).osu2.ospace_gap).owidth - (res_gap).owidth) < (0) ? (0) : (((*style).osu2.ospace_gap).owidth - (res_gap).owidth));
    }
  }
                                                              ;
}
...
{ OBJECT link, y;
  ...
  switch( (x)->os1.ou1.os11.otype )
  {
    ...
    case 11:
    case 12: if( !(strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("") )))==0) )
    changespace(style, x);
  break;


    case 17: for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    ...
    { if( !(strcmp((char *)((y)->os1.ostring), (char *)(( (FULL_CHAR *) ("") )))==0) )
        changespace(style, y);
    }
    else Error(11, 3, "invalid left parameter of %s",
    2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Space") ));
  }
  break;
...
# 176 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c"
static void changebreak(STYLE *style, OBJECT x)
{ GAP res_gap; unsigned gap_inc;
  if( ( ((x)->os1.ostring[0]) >= 'a' && ((x)->os1.ostring[0]) <= 'z' ) )
  {

    if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("hyphen") )))==0) )
 (*style).osu2.oss2.ohyph_style = 2;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("nohyphen") )))==0) )
 (*style).osu2.oss2.ohyph_style = 1;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("adjust") )))==0) )
 (*style).osu2.oss2.ofill_style = 2, (*style).osu2.oss2.odisplay_style = 1;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("outdent") )))==0) )
 (*style).osu2.oss2.ofill_style = 2, (*style).osu2.oss2.odisplay_style = 2;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("ragged") )))==0) )
 (*style).osu2.oss2.ofill_style = 2, (*style).osu2.oss2.odisplay_style = 4;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("cragged") )))==0) )
 (*style).osu2.oss2.ofill_style = 2, (*style).osu2.oss2.odisplay_style = 5;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("rragged") )))==0) )
 (*style).osu2.oss2.ofill_style = 2, (*style).osu2.oss2.odisplay_style = 6;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("oragged") )))==0) )
 (*style).osu2.oss2.ofill_style = 2, (*style).osu2.oss2.odisplay_style = 3;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("lines") )))==0) )
 (*style).osu2.oss2.ofill_style = 1, (*style).osu2.oss2.odisplay_style = 4;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("clines") )))==0) )
 (*style).osu2.oss2.ofill_style = 1, (*style).osu2.oss2.odisplay_style = 5;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("rlines") )))==0) )
 (*style).osu2.oss2.ofill_style = 1, (*style).osu2.oss2.odisplay_style = 6;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("unbreakablefirst") )))==0) )
 (*style).onobreaklast = 1;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("breakablefirst") )))==0) )
 (*style).onobreaklast = 0;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("unbreakablelast") )))==0) )
 (*style).onobreakfirst = 1;
    else if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("breakablelast") )))==0) )
 (*style).onobreakfirst = 0;
    else Error(11, 5, "unknown option to %s symbol (%s)",
    2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Break") ), (x)->os1.ostring);
  }
  else
  { GetGap(x, style, &res_gap, &gap_inc);
    if( gap_inc != 158 && (res_gap).ounits != ((*style).osu1.oline_gap).ounits )
      Error(11, 6, "line spacing %s is not compatible with current spacing",
        2, &(x)->os1.ou1.ofpos, (x)->os1.ostring);
    else
    { ((*style).osu1.oline_gap).ounits = (res_gap).ounits;
      ((*style).osu1.oline_gap).omode = (res_gap).omode;
      ((*style).osu1.oline_gap).owidth = gap_inc == 158 ? (res_gap).owidth :
 gap_inc == 159 ? ((*style).osu1.oline_gap).owidth + (res_gap).owidth :
 ((((*style).osu1.oline_gap).owidth - (res_gap).owidth) < (0) ? (0) : (((*style).osu1.oline_gap).owidth - (res_gap).owidth));
    }
  }
}
...
{ OBJECT link, y;
  ...
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    ...
    2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Break") ));
  }
  break;
...
# 272 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c"
void YUnitChange(STYLE *style, OBJECT x)
{ GAP res_gap; unsigned gap_inc;
  GetGap(x, style, &res_gap, &gap_inc);
  if( (res_gap).ounits != 1 )
    Error(11, 9, "this unit not allowed with %s symbol",
      2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@YUnit") ));
  else
  { if( gap_inc == 158 ) (*style).oyunit = (res_gap).owidth;
    else if( gap_inc == 159 ) (*style).oyunit += (res_gap).owidth;
    else (*style).oyunit = (((*style).oyunit - (res_gap).owidth) < (0) ? (0) : ((*style).oyunit - (res_gap).owidth));
  }
}
# 294 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z11.c"
void ZUnitChange(STYLE *style, OBJECT x)
{ GAP res_gap; unsigned gap_inc;
  GetGap(x, style, &res_gap, &gap_inc);
  if( (res_gap).ounits != 1 )
    Error(11, 10, "this unit not allowed with %s symbol",
      2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@ZUnit") ));
  else
  { if( gap_inc == 158 ) (*style).ozunit = (res_gap).owidth;
    else if( gap_inc == 159 ) (*style).ozunit += (res_gap).owidth;
    else (*style).ozunit = (((*style).ozunit - (res_gap).owidth) < (0) ? (0) : ((*style).ozunit - (res_gap).owidth));
  }
}
