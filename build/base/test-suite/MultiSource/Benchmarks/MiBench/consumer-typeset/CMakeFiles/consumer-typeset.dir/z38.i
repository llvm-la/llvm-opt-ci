# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c" 2
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
MAP_VEC MapTable[20];

static OBJECT notdef_word = ( (OBJECT) ((void*)0) );
static int maptop = 1;
# 78 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
static void NameInsert(FULL_CHAR *cname, int ccode, MAP_VEC map)
{ int pos;
  { FULL_CHAR *p = cname; for( pos = 2 * *p++; *p; pos += *p++); pos = pos % 353; };
  while( map->hash_table[pos] != (FULL_CHAR) '\0' )
    pos = (pos + 1) % 353;
  map->vector[ccode] = MakeWord(11, cname, no_fpos);
...
{ int pos; FULL_CHAR ch;
  ...
  {
    if( (strcmp((char *)((map->vector[ch])->os1.ostring), (char *)(cname))==0) )
      return ch;
    pos = (pos + 1) % 353;
  }
  return ch;
}
# 113 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
MAPPING MapLoad(OBJECT file_name, unsigned recoded)
{ FILE *fp; MAP_VEC map; MAPPING res;
  int i, m, curr_line_num, line_pos, prev_code, dc, oc, count;
  FULL_CHAR buff[512], cn[512], ch, mapname[512],
  mapval[512];
                                                                        ;


  if( (strcmp((char *)((file_name)->os1.ostring), (char *)(( (FULL_CHAR *) ("-") )))==0) )
  { ;
  ...
  {
    if( (strcmp((char *)((MapTable[res]->file_name)->os1.ostring), (char *)((file_name)->os1.ostring))==0) )
    { { zz_hold = (file_name); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
  ...
  if( notdef_word == ( (OBJECT) ((void*)0) ) )
    notdef_word = MakeWord(11, ( (FULL_CHAR *) (".notdef") ), no_fpos);


  if( maptop == 20 )
    Error(38, 1, "too many character mappings", 1, &(file_name)->os1.ou1.ofpos);
                                                                          ;
  MapTable[res = maptop++] = map = (MAP_VEC) malloc( sizeof(struct mapvec) );
  if( map == (MAP_VEC) ((void*)0) )
    Error(38, 2, "run out of memory when loading character mapping",
      1, &(file_name)->os1.ou1.ofpos);


  map->file_name = file_name;
                                                     ;
  map->fnum = DefineFile((file_name)->os1.ostring, ( (FULL_CHAR *) ("") ), &(file_name)->os1.ou1.ofpos,
    9, 7);
  fp = OpenFile(map->fnum, 0, 0);
  if( fp == ((void*)0) ) Error(38, 3, "cannot open character mapping file %s",
      1, PosOfFile(map->fnum), FileName(map->fnum));
  map->seen_recoded = recoded;
  map->last_page_printed = 0;
  strcpy((char *)(buff),(char *)(( (FULL_CHAR *) ("vec") )));
  strcat((char *)(buff),(char *)(StringInt(maptop)));
  map->name = MakeWord(11, buff, no_fpos);
  for( m = 0; m < 4; m++ )
  { for( i = 0; i < 256; i++ )
      map->map[m][i] = '\0';
  }
  ...
  for( i = 0; i < 256; i++ ) map->vector[i] = notdef_word;
  for( i = 0; i < 353; i++ ) map->hash_table[i] = 0;
 ...
 1, &(file_name)->os1.ou1.ofpos);
    if( dc < 1 && !(strcmp((char *)(cn), (char *)(( (FULL_CHAR *) ("-none-") )))==0) )
      Error(38, 6, "code %d too small (min is 1) in mapping file (line %d)",
 1, &(file_name)->os1.ou1.ofpos, dc, curr_line_num);
    if( dc < prev_code )
 ...
 1, &(file_name)->os1.ou1.ofpos, dc, 256, curr_line_num);
    prev_code = dc;


                                                       ;
    if( count >= 3 && !(strcmp((char *)(cn), (char *)(( (FULL_CHAR *) ("-none-") )))==0) )
    {
 ...
 NameInsert(cn, dc, map);
  ...
  while( fgets( (char *) buff, 512, fp) == (char *) buff )
  {
      ...
      mapname, mapval, &i) == 2 )
    {
                                                                         ;
      line_pos += i;
      if( (strcmp((char *)(mapname), (char *)(( (FULL_CHAR *) ("UC") )))==0) )
 m = 0;
      else if( (strcmp((char *)(mapname), (char *)(( (FULL_CHAR *) ("LC") )))==0) )
 m = 1;
      else if( (strcmp((char *)(mapname), (char *)(( (FULL_CHAR *) ("UA") )))==0) )
 m = 2;
      else if( (strcmp((char *)(mapname), (char *)(( (FULL_CHAR *) ("AC") )))==0) )
 m = 3;
      else
 Error(38, 10, "unknown mapping name %s in mapping file %s (line %d)",
   1, &(file_name)->os1.ou1.ofpos, mapname, FileName(map->fnum), curr_line_num);
      ch = NameRetrieve(mapval, map);
      if( ch == (FULL_CHAR) '\0' )
 Error(38, 11, "unknown character %s in mapping file %s (line %d)",
   1, &(file_name)->os1.ou1.ofpos, mapval, FileName(map->fnum), curr_line_num);
      map->map[m][dc] = ch;
    }
  }
  fclose(fp);
...
# 272 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
FULL_CHAR MapCharEncoding(FULL_CHAR *str, MAPPING m)
{ MAP_VEC map;
  map = MapTable[m];
  return (FULL_CHAR) NameRetrieve(str, map);
}
# 287 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
FULL_CHAR *MapEncodingName(MAPPING m)
{ { if( !(m < maptop) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "MapEncodingName: m out of range!"); };
  return (MapTable[m]->name)->os1.ostring;
}
# 303 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
void MapEnsurePrinted(MAPPING m, int curr_page)
{ MAP_VEC map = MapTable[m];
  { if( !(map->seen_recoded) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "MapEnsurePrinted: not seen_recoded!"); };
  if( map->last_page_printed < curr_page && map->last_page_printed != 1 )
  { map->last_page_printed = curr_page;
    BackEnd->PrintMapping(m);
  }
}
# 323 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
...
# 343 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
...
# 360 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
static OBJECT DoWord(FULL_CHAR *buff, FULL_CHAR *q, OBJECT x, FONT_NUM fnum)
{ OBJECT res;
  *q++ = '\0';
  res = MakeWord((x)->os1.ou1.os11.otype, buff, &(x)->os1.ou1.ofpos);
  (res)->os1.ou2.os22.oword_font = fnum;
  (res)->os1.ou2.os22.oword_colour = (x)->os1.ou2.os22.oword_colour;
  (res)->os1.ou2.os22.oword_outline = (x)->os1.ou2.os22.oword_outline;
  (res)->os1.ou2.os22.oword_language = (x)->os1.ou2.os22.oword_language;
  (res)->os1.ou2.os22.oword_hyph = (x)->os1.ou2.os22.oword_hyph;
  (res)->os1.ou2.os22.ounderline = 1;
  return res;
}
# 382 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
static OBJECT DoVShift(OBJECT x, FULL_LENGTH vshift, OBJECT chld)
{ OBJECT res;
  { ; { ; if( (zz_size=(zz_lengths[29])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 29; ; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  ...
  (((res)->os2.ou4.osave_style).osu2.ospace_gap).owidth = 160;
  (((res)->os2.ou4.osave_style).osu1.oline_gap).ounits = 1;
  (((res)->os2.ou4.osave_style).osu1.oline_gap).omode = 1;
  (((res)->os2.ou4.osave_style).osu1.oline_gap).owidth = vshift;
  (res)->os1.ou2.os22.ounderline = 1;
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((res)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((chld)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  return res;
}
# 403 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
static void DoAddGap(OBJECT new_acat)
{ OBJECT new_g;
  { ; { ; if( (zz_size=(zz_lengths[1])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 1; ; new_g = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  ( ((new_g)->os1.ou1.ofpos).ofile_num = ((new_acat)->os1.ou1.ofpos).ofile_num, ((new_g)->os1.ou1.ofpos).oline_num = ((new_acat)->os1.ou1.ofpos).oline_num, ((new_g)->os1.ou1.ofpos).ocol_num = ((new_acat)->os1.ou1.ofpos).ocol_num );
  (new_g)->os1.ou2.os21.ohspace = (new_g)->os1.ou2.os21.ovspace = 0;
  ( ((new_g)->os5.ogap).onobreak = 1, ((new_g)->os5.ogap).omark = 0, ((new_g)->os5.ogap).ojoin = 1, ((new_g)->os5.ogap).ounits = 1, ((new_g)->os5.ogap).omode = 1, ((new_g)->os5.ogap).owidth = 0*1440 );
  (new_g)->os1.ou2.os22.ounderline = 1;
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((new_acat)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((new_g)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
}
# 427 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
OBJECT MapSmallCaps(OBJECT x, STYLE *style)
{ MAPPING m; int i; OBJECT new_y, new_x, new_acat, tmp;
  FULL_CHAR buff[512], *uc, *p, *q;
  FONT_NUM small_font; FULL_LENGTH vshift; int state; STYLE new_style;
  static OBJECT font_change_word = ( (OBJECT) ((void*)0) );
  { if( !((((x)->os1.ou1.os11.otype) == 11 || ((x)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "MapSmallCaps: !is_word(type(x))"); };
                                                                  ;


  m = FontMapping((x)->os1.ou2.os25.ofont_num, &(x)->os1.ou1.ofpos);
  if( m == 0 )
  { ;
    return x;
  }
  { if( !(1 <= m && m < maptop) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "MapSmallCaps: mapping out of range!"); };
  uc = MapTable[m]->map[0];


  if( !(BackEnd->scale_avail) )
  {
    for( i = 0; (x)->os1.ostring[i] != '\0'; i++ )
      if( uc[(x)->os1.ostring[i]] != '\0' )
        (x)->os1.ostring[i] = uc[(x)->os1.ostring[i]];
                                                                           ;
    return x;
  }


  if( font_change_word == ( (OBJECT) ((void*)0) ) )
  { font_change_word = MakeWord(11, ( (FULL_CHAR *) ("0.7f") ), no_fpos);
  }

  state = 0; q = buff;
  for( p = (x)->os1.ostring; *p != '\0'; p++ )
  {
   ...
   ( ( ((new_style).osu1.oline_gap).onobreak = ((*style).osu1.oline_gap).onobreak, ((new_style).osu1.oline_gap).omark = ((*style).osu1.oline_gap).omark, ((new_style).osu1.oline_gap).ojoin = ((*style).osu1.oline_gap).ojoin, ((new_style).osu1.oline_gap).ounits = ((*style).osu1.oline_gap).ounits, ((new_style).osu1.oline_gap).omode = ((*style).osu1.oline_gap).omode, ((new_style).osu1.oline_gap).owidth = ((*style).osu1.oline_gap).owidth ), (new_style).osu2.oss2.ohyph_style = (*style).osu2.oss2.ohyph_style, (new_style).osu2.oss2.ofill_style = (*style).osu2.oss2.ofill_style, (new_style).osu2.oss2.odisplay_style = (*style).osu2.oss2.odisplay_style, (new_style).osu1.oss1.osmall_caps = (*style).osu1.oss1.osmall_caps, ( ((new_style).osu2.ospace_gap).onobreak = ((*style).osu2.ospace_gap).onobreak, ((new_style).osu2.ospace_gap).omark = ((*style).osu2.ospace_gap).omark, ((new_style).osu2.ospace_gap).ojoin = ((*style).osu2.ospace_gap).ojoin, ((new_style).osu2.ospace_gap).ounits = ((*style).osu2.ospace_gap).ounits, ((new_style).osu2.ospace_gap).omode = ((*style).osu2.ospace_gap).omode, ((new_style).osu2.ospace_gap).owidth = ((*style).osu2.ospace_gap).owidth ), (new_style).ofont = (*style).ofont, (new_style).ocolour = (*style).ocolour, (new_style).ooutline = (*style).ooutline, (new_style).olanguage = (*style).olanguage, (new_style).onobreaklast = (*style).onobreaklast, (new_style).onobreakfirst = (*style).onobreakfirst, (new_style).osu1.oss1.ovadjust = (*style).osu1.oss1.ovadjust, (new_style).osu1.oss1.ohadjust = (*style).osu1.oss1.ohadjust, (new_style).osu1.oss1.opadjust = (*style).osu1.oss1.opadjust, (new_style).osu1.oss1.ospace_style = (*style).osu1.oss1.ospace_style, (new_style).oyunit = (*style).oyunit, (new_style).ozunit = (*style).ozunit );
   FontChange(&new_style, font_change_word);
   small_font = (new_style).ofont;
   vshift = FontHalfXHeight((x)->os1.ou2.os22.oword_font) - FontHalfXHeight(small_font);
   ...
   new_y = DoWord(buff, q, x, (x)->os1.ou2.os22.oword_font);


   { ; { ; if( (zz_size=(zz_lengths[24])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 24; ; new_x = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
   ( ((new_x)->os1.ou1.ofpos).ofile_num = ((x)->os1.ou1.ofpos).ofile_num, ((new_x)->os1.ou1.ofpos).oline_num = ((x)->os1.ou1.ofpos).oline_num, ((new_x)->os1.ou1.ofpos).ocol_num = ((x)->os1.ou1.ofpos).ocol_num );
   { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; new_acat = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
   ( ((new_acat)->os1.ou1.ofpos).ofile_num = ((x)->os1.ou1.ofpos).ofile_num, ((new_acat)->os1.ou1.ofpos).oline_num = ((x)->os1.ou1.ofpos).oline_num, ((new_acat)->os1.ou1.ofpos).ocol_num = ((x)->os1.ou1.ofpos).ocol_num );
   { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((new_x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((new_acat)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
   { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((new_acat)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((new_y)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
   DoAddGap(new_acat);
  ...
  switch( state )
  {
    ...
    case 2:
      ...
      ( xx_tmp = ( zz_hold = ((x)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((new_x)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) );
...
# 650 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z38.c"
unsigned MapIsLowerCase(FULL_CHAR ch, MAPPING m)
{ unsigned res;
                                                 ;
  res = (MapTable[m]->map[0][ch] != '\0');
                                                          ;
  return res;
}
