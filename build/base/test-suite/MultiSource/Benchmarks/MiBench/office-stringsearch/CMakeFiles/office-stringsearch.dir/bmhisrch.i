# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-stringsearch/bmhisrch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-stringsearch/bmhisrch.c" 2
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-stringsearch/bmhisrch.c"
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-stringsearch/bmhisrch.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-stringsearch/bmhisrch.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-stringsearch/bmhisrch.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-stringsearch/bmhisrch.c" 2
...
void bmhi_init(const char *pattern)
{
      ...
      for (i=0; i < patlen; i++)
            pat[i] = (__extension__ ({ int __res; if (sizeof (pattern[i]) > 1) { if (__builtin_constant_p (pattern[i])) { int __c = (pattern[i]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (pattern[i]); } else __res = (*__ctype_toupper_loc ())[(int) (pattern[i])]; __res; }));
      ...
      for ( i = 0; i < patlen - 1; ++i )
      {
            ...
            skip[(__extension__ ({ int __res; if (sizeof (pat[i]) > 1) { if (__builtin_constant_p (pat[i])) { int __c = (pat[i]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (pat[i]); } else __res = (*__ctype_tolower_loc ())[(int) (pat[i])]; __res; }))] = patlen - i - 1;
      }
      lastpatchar = pat[patlen - 1];
      skip[ lastpatchar ] = 32767;
      skip[(__extension__ ({ int __res; if (sizeof (lastpatchar) > 1) { if (__builtin_constant_p (lastpatchar)) { int __c = (lastpatchar); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (lastpatchar); } else __res = (*__ctype_tolower_loc ())[(int) (lastpatchar)]; __res; }))] = 32767;
      skip2 = patlen;
      for (i = 0; i < patlen - 1; ++i)
      {
...
char *bmhi_search(const char *string, const int stringlen)
{
      ...
      for ( ;; )
      {
            ...
            j = patlen - 1;
            s = (char *)string + (i - j);
            while ( --j >= 0 && (__extension__ ({ int __res; if (sizeof (s[j]) > 1) { if (__builtin_constant_p (s[j])) { int __c = (s[j]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (s[j]); } else __res = (*__ctype_toupper_loc ())[(int) (s[j])]; __res; })) == pat[j] )
                  ;
            if ( j < 0 )
                  return s;
            if ( (i += skip2) >= 0 )
