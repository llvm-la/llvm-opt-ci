# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
...
# 129 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 ...
 for( i=0; i<clus1; i++ )
 {
  for( j=0; j<clus2; j++ )
  {
   ...
   while( tmpptr )
   {
    ...
    {
# 165 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
     while( *pt != 0 )
     {
    ...
    {
# 194 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
     while( *pt != 0 )
     {
      if( *pt++ != '-' ) tmpint++;
...
# 259 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
    tmpptr = tmpptr->next;
   }
  }
 }
# 285 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
}
# 440 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
...
# 527 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
}
...
# 551 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 if( outgap == 1 )
  ;
 else
 {
      ...
      int *gapmap1, int *gapmap2 )
{
 ...
 gt1bk = AllocateCharVec( lgth1+lgth2+1 );
 gt2bk = AllocateCharVec( lgth1+lgth2+1 );
# 664 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 if( outgap == 1 )
  ;
 else
 {
                        ...
                        int **ijp, int icyc, int jcyc )
{
 ...
 gt1bk = AllocateCharVec( lgth1+lgth2+1 );
 gt2bk = AllocateCharVec( lgth1+lgth2+1 );
# 776 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 if( outgap == 1 )
  ;
 else
 {
...

{
 ...
 float fgcp1va;
 float ogcp1va;
# 914 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 if( orlgth1 == 0 )
 {
...
# 999 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
  orlgth1 = ll1 - 100;
  orlgth2 = ll2 - 100;
 }
 ...
 ijp = commonIP;
# 1052 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 ...
 if( localhom )
  imp_match_out_vead_tate( initverticalw, 0, lgth1 );

 match_calc( currentw, cpmx1, cpmx2, 0, lgth2, floatwork, intwork, 1 );
 if( localhom )
  imp_match_out_vead( currentw, 0, lgth2 );
...
# 1153 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
  previousw = currentw;
...
# 1172 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
  if( localhom )
  {
...
# 1191 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
...
# 1282 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 if( localhom )
 {
...
# 1310 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 return( wm );
}
...
# 1448 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
  orlgth1 = ll1 - 100;
  orlgth2 = ll2 - 100;
 }
 ...
 match_calc( initverticalw, cpmx2, cpmx1, 0, lgth1, floatwork, intwork, 1 );
 if( localhom )
  imp_match_out_vead_tate_gapmap( initverticalw, gapmap2[0], lgth1, gapmap1 );


 match_calc( currentw, cpmx1, cpmx2, 0, lgth2, floatwork, intwork, 1 );
 if( localhom )
  imp_match_out_vead_gapmap( currentw, gapmap1[0], lgth2, gapmap2 );
 ...
 if( outgap ) lasti = lgth1+1; else lasti = lgth1;
# 1586 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
  previousw = currentw;
  ...
  match_calc( currentw, cpmx1, cpmx2, i, lgth2, floatwork, intwork, 0 );
# 1605 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
  if( localhom )
  {
...
# 1624 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
  currentw[0] = initverticalw[i];
...
# 1718 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 if( localhom )
 {
 ...
 for( i=0; i<icyc; i++ ) strcpy( seq1[i], mseq1[i] );
 for( j=0; j<jcyc; j++ ) strcpy( seq2[j], mseq2[j] );
# 1746 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Salignmm.c"
 return( wm );
}
...
float translate_and_Calign( char **mseq1, char **mseq2, double *effarr1, double *effarr2, int clus1, int clus2, int alloclen )
{
    ...
    float wm;
    char **result;
    char *seq = ((void*)0), **aseq = ((void*)0);
    double *effarr = ((void*)0);
    int nseq = 0;
 int resultlen;
