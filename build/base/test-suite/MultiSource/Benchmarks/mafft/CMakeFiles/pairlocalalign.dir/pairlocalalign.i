# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c" 2
...
# 91 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c"
 free( aln1 );
 free( aln2 );
...
{
 FILE *fp = ((void*)0);
 static char *ungap1 = ((void*)0);
 static char *ungap2 = ((void*)0);
 static char *ori1 = ((void*)0);
 static char *ori2 = ((void*)0);
...
static void pairalign( char name[50000][256], int nlen[50000], char **seq, char **aseq, char **mseq1, char **mseq2, double *effarr, int alloclen )
{
 int i, j, ilim;
 int clus1, clus2;
 int off1, off2;
 ...
 static double *effarr1 = ((void*)0);
 static double *effarr2 = ((void*)0);
 char *pt;
 char *hat2file = "hat2";
...
# 819 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c"
...
# 879 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c"
   if( use_fft )
   {
...

   {
    switch( alg )
    {
     ...
     case( 'A' ):
      ...
      off1 = off2 = 0;
      break;
# 913 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c"
     case( 'N' ):
      pscore = G__align11_noalign( amino_dis, penalty, penalty_ex, mseq1, mseq2, alloclen );
   ...
   if( alg == 't' || ( mseq1[0][0] != 0 && mseq2[0][0] != 0 ) )
   {
    distancemtx[i][j] = pscore;
# 964 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c"
 ...
 for( i=0; i<ilim; i++ )
 {
  for( j=i+1; j<njob; j++ )
  {
   ...
   if( distancemtx[i][j] == -9999 || (bunbo=( ((distancemtx[i][i])<(distancemtx[j][j]))?(distancemtx[i][i]):(distancemtx[j][j]) )) == 0.0 || bunbo < distancemtx[i][j] )
    distancemtx[i][j] = 2.0;
   else
...
{
 static int nlen[50000];
 static char name[50000][256], **seq;
 ...
 fclose( trap_g );
# 1242 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/pairlocalalign.c"
 fprintf( stdout, "%s (%s) Version " "6.624b" " alg=%c, model=%s\n", "<progname>", (dorp=='d')?"nuc":"aa", alg, modelname );
 return( 0 );
}
