...
.LBB2_200:                              # %.lr.ph19.i538
	...
	addi.d	$t4, $t4, -1
	bnez	$t3, .LBB2_200
.LBB2_201:                              # %._crit_edge20.loopexit.i539
                                        #   in Loop: Header=BB2_178 Depth=1
	add.d	$a5, $s7, $a5
	add.d	$a5, $t2, $a5
	move	$s8, $t5
	move	$s4, $t4
	bne	$t1, $a0, .LBB2_183
.LBB2_202:                              #   in Loop: Header=BB2_178 Depth=1
	move	$t3, $s8
	move	$t2, $s4
	blez	$a7, .LBB2_206
.LBB2_203:                              # %._crit_edge30.i544
                                        #   in Loop: Header=BB2_178 Depth=1
	blez	$t0, .LBB2_206
# %bb.204:                              #   in Loop: Header=BB2_178 Depth=1
	add.d	$s6, $t1, $s6
	addi.d	$s8, $t3, -1
	st.b	$a1, $t3, -1
	addi.d	$s4, $t2, -1
...
.LBB2_206:
	...
	ld.d	$s6, $sp, 104                   # 8-byte Folded Reload
	blez	$s6, .LBB2_209
.LBB2_207:                              # %.lr.ph50.preheader.i556
	ld.d	$fp, $sp, 120                   # 8-byte Folded Reload
	move	$s0, $s6
	.p2align	4, , 16
.LBB2_208:                              # %.lr.ph50.i558
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s5, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s5, $s5, 8
	bnez	$s0, .LBB2_208
.LBB2_209:                              # %.preheader.i549
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	blez	$s1, .LBB2_256
# %bb.210:                              # %.lr.ph52.preheader.i550
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB2_211:                              # %.lr.ph52.i552
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s3, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s4
...
.LBB2_213:                              # %vector.body936
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_213
# %bb.214:                              # %middle.block942
	beq	$a4, $a5, .LBB2_217
.LBB2_215:                              # %scalar.ph931.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_216:                              # %scalar.ph931
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB2_222:                              #   in Loop: Header=BB2_219 Depth=1
	...
	bnez	$t8, .LBB2_235
	.p2align	4, , 16
.LBB2_223:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_219 Depth=1
	beq	$t4, $a1, .LBB2_243
.LBB2_224:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_219 Depth=1
	addi.w	$t7, $zero, -9
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB2_229
# %bb.225:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_219 Depth=1
	sub.d	$t7, $s8, $s4
	bltu	$t7, $a5, .LBB2_229
# %bb.226:                              # %vector.ph951
...
# %bb.228:                              # %middle.block963
	...
	b	.LBB2_232
	.p2align	4, , 16
.LBB2_229:                              #   in Loop: Header=BB2_219 Depth=1
	move	$fp, $s0
	move	$t7, $s4
	move	$t8, $s8
.LBB2_230:                              # %.lr.ph29.i.preheader
                                        #   in Loop: Header=BB2_219 Depth=1
	add.d	$t0, $t0, $fp
	.p2align	4, , 16
.LBB2_231:                              # %.lr.ph29.i
	...
	addi.d	$t7, $t7, -1
	bnez	$fp, .LBB2_231
.LBB2_232:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_219 Depth=1
	ld.d	$fp, $sp, 424                   # 8-byte Folded Reload
	bne	$t2, $fp, .LBB2_244
	b	.LBB2_246
	.p2align	4, , 16
.LBB2_233:                              #   in Loop: Header=BB2_219 Depth=1
	addi.d	$t1, $s7, -1
.LBB2_234:                              #   in Loop: Header=BB2_219 Depth=1
	move	$t4, $a1
	nor	$t7, $t1, $zero
	add.w	$t8, $s7, $t7
	beqz	$t8, .LBB2_223
.LBB2_235:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_219 Depth=1
	bltu	$t8, $a6, .LBB2_240
# %bb.236:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_219 Depth=1
	sub.d	$fp, $s8, $s4
	bltu	$fp, $a6, .LBB2_240
# %bb.237:                              # %vector.ph974
...
.LBB2_238:                              # %vector.body978
	...
	addi.d	$s4, $s4, -16
	bnez	$ra, .LBB2_238
# %bb.239:                              # %middle.block985
                                        #   in Loop: Header=BB2_219 Depth=1
	ld.d	$ra, $sp, 416                   # 8-byte Folded Reload
	bne	$s2, $s1, .LBB2_241
	b	.LBB2_242
	.p2align	4, , 16
.LBB2_240:                              #   in Loop: Header=BB2_219 Depth=1
	move	$fp, $s4
	move	$s0, $s8
	.p2align	4, , 16
.LBB2_241:                              # %.lr.ph19.i
	...
	addi.d	$fp, $fp, -1
	bnez	$t8, .LBB2_241
.LBB2_242:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB2_219 Depth=1
	add.d	$t0, $s7, $t0
	add.d	$t0, $t7, $t0
	move	$s8, $s0
	...
	move	$s2, $a0
	bne	$t4, $a1, .LBB2_224
.LBB2_243:                              #   in Loop: Header=BB2_219 Depth=1
	move	$t8, $s8
	move	$t7, $s4
	ld.d	$fp, $sp, 424                   # 8-byte Folded Reload
	beq	$t2, $fp, .LBB2_246
.LBB2_244:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_219 Depth=1
	addi.w	$fp, $s6, 0
	beq	$t3, $fp, .LBB2_246
# %bb.245:                              #   in Loop: Header=BB2_219 Depth=1
	...
	fadd.s	$fa3, $fa3, $fa4
	fst.s	$fa3, $a2, 0
.LBB2_246:                              #   in Loop: Header=BB2_219 Depth=1
	blez	$t2, .LBB2_250
# %bb.247:                              #   in Loop: Header=BB2_219 Depth=1
	blez	$t3, .LBB2_250
# %bb.248:                              #   in Loop: Header=BB2_219 Depth=1
	add.d	$a7, $t4, $a7
	addi.d	$s8, $t8, -1
	st.b	$a3, $t8, -1
	addi.d	$s4, $t7, -1
...
.LBB2_252:                              # %.lr.ph50.i
	...
	addi.d	$s5, $s5, 8
	bnez	$s0, .LBB2_252
.LBB2_253:                              # %.preheader.i
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	blez	$s1, .LBB2_256
# %bb.254:                              # %.lr.ph52.preheader.i
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB2_255:                              # %.lr.ph52.i
...
.LBB2_256:                              # %Atracking_localhom.exit
	...
	blt	$a2, $a3, .LBB2_258
# %bb.257:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	blt	$a3, $a0, .LBB2_259
.LBB2_258:
