# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c" 2
...

{
 int i, j;
 int icount, jcount;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c"
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c"
}


float score_calc( char **seq, int s )
{
    int i, j, k, c;
...
# 123 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c"
...
void cpmx_calc_new_bk( char **seq, float **cpmx, double *eff, int lgth, int clus )
{
    int i, j, k;
    float feff;
...
void cpmx_calc_new( char **seq, float **cpmx, double *eff, int lgth, int clus )
{
 int i, j, k;
 float feff;
...
void MScpmx_calc_new( char **seq, float **cpmx, double *eff, int lgth, int clus )
{
 int i, j, k;
 float feff;
...
# 220 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c"
}

void cpmx_ribosum( char **seq, char **seqr, char *dir, float **cpmx, double *eff, int lgth, int clus )
{
 int i, j, k;
 float feff;
 float **cpmxptpt, *cpmxpt;
...
void mseqcat( char **seq1, char **seq2, double **eff, double *effarr1, double *effarr2, char name1[50000][256], char name2[50000][256], int clus1, int clus2 )
{
 int i, j;
    for( i=0; i<clus2; i++ )
        seq1[clus1+i] = seq2[i];
...
void strnbcat( char *s1, char *s2, int m )
{
 static char b[5000000];
...
int fastconjuction( int *memlist, char **seq, char **aseq, double *peff, double *eff, char name[50000][256], char aname[50000][256], char *d )
{
 int m, k, dln;
 char b[256];
 double total;
...
int conjuction( char **pair, int s, char **seq, char **aseq, double *peff, double *eff, char name[50000][256], char aname[50000][256], char *d )
{
 int m, k;
 char b[256];
 double total;
...
void nodeFromABranch( int nseq, int *result, int **pairwisenode, int ***topol, double **len, int step, int num )
{
 ...
 static int *outergroup2 = ((void*)0);
 static int *table = ((void*)0);
 if( outergroup2 == ((void*)0) )
 {
...
# 693 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c"
...
int msfastshrinklocalhom( int *mem1, int *mem2, LocalHom **localhom, LocalHom ***localhomshrink )
{
 ...
 for( intpt1=mem1, k1=0; *intpt1!=-1; intpt1++, k1++ )
 {
  for( intpt2=mem2, k2=0; *intpt2!=-1; intpt2++, k2++ )
  {
   m1 = ( ((*intpt1)<(*intpt2))?(*intpt1):(*intpt2) ); m2 = ( ((*intpt1)>(*intpt2))?(*intpt1):(*intpt2) );
   if( localhom[m1][m2].opt == -1 )
    localhomshrink[k1][k2] = ((void*)0);
   else
    localhomshrink[k1][k2] = localhom[m1]+m2;
