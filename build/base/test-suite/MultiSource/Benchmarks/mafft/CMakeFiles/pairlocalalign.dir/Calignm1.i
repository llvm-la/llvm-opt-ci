# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c" 2
...
char **Calignm1( float *wm, char **aseq, char *seq, double *effarr, int icyc, int ex )
{
 ...
 lgth = strlen( aseq[0] );
 lgth1 = strlen( seq );
# 109 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c"
 ...
 if( lgth > orlgth || lgth1 > orlgth1 )
 {
  ...
  ll1 = ( (((int)(1.1*lgth))>(orlgth))?((int)(1.1*lgth)):(orlgth) );
  ll2 = ( (((int)(1.1*lgth1))>(orlgth1))?((int)(1.1*lgth1)):(orlgth1) );
  ll1 = ( ((ll1)>(ll2))?(ll1):(ll2) );
  ...
  gl = AllocateFloatTri( ( ((ll1)>(ll2))?(ll1):(ll2) ) + 3 );
  gs = AllocateFloatTri( ( ((ll1)>(ll2))?(ll1):(ll2) ) + 3 );
 ...
 if( orlgth > commonAlloc1 || orlgth1 > commonAlloc2 )
 {
  ...
  ll1 = ( ((commonAlloc1)>(orlgth))?(commonAlloc1):(orlgth) );
  ll2 = ( ((commonAlloc2)>(orlgth1))?(commonAlloc2):(orlgth1) );
...
# 286 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c"
 for( i=0; i<lgth+1; i++ )
 {
  for( j=1; j<=i; j++ )
   gs[i][j+1] += gs[i][j];
...
# 338 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c"
 w = v;
...
# 491 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c"
 *wm = w[lgth][lgth1];
 return( nseq );
}
...
double Cscore_m_1( char **seq, int locnjob, int ex, double **eff )
{
 ...
 glen2 = AllocateIntVec( locnjob );
    score = 0.0;
    nglen = 0;
# 522 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c"
    for( k=0; k<len; k++ )
    {
...
# 580 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Calignm1.c"
        }
  score += tmpscore;
  score += pen;
