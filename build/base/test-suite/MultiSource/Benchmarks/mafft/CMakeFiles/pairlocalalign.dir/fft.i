# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fft.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fft.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fft.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mtxutl.h" 1
void MtxuntDouble( double **, int );
void MtxmltDouble( double **, double **, int );
...
short **AllocateShortMtx( int, int );
void FreeShortMtx( short ** );
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fft.c" 2
...
{
        static int last_n = 0;
        static int *bitrev = ((void*)0);
        static float *sintbl = ((void*)0);
        ...
        if (n != last_n || n == 0) {
                last_n = n;
# 73 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fft.c"
    sintbl = realloc(sintbl, (n + n4) * sizeof(float));
    bitrev = realloc(bitrev, n * sizeof(int));

                if (sintbl == ((void*)0) || bitrev == ((void*)0)) {
                        fprintf(stderr, "\n"); return 1;
                }
