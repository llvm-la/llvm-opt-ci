# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c" 2
...
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 ...
 for( pat1=pat1bk+1; pat1->len != 0; pat1++ )
 {
  for( pat2=pat2bk+1; pat2->len != 0; pat2++ )
  {
   if( pat1->len + offset1 == pat2->len + offset2 )
   {
    ...
    if( r ) fprintf( stderr, "y %d-%d, len=%d,%d, val = %f\n", (int)(pat1-pat1bk), (int)(pat2-pat2bk), pat1->len, pat2->len, val );
...
# 95 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
...
# 151 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
...
# 235 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 ...
 for( i=0; i<clus1; i++ )
 {
  for( j=0; j<clus2; j++ )
  {
   ...
   while( tmpptr )
   {
    ...
    {
# 271 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
     while( *pt != 0 )
     {
    ...
    {
# 300 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
     while( *pt != 0 )
     {
      if( *pt++ != '-' ) tmpint++;
...
# 365 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
    tmpptr = tmpptr->next;
   }
  }
 }
# 389 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
}
...
# 478 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
}
...
# 502 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 if( outgap == 1 )
  ;
 else
 {
                        ...
                        int **ijp, int icyc, int jcyc )
{
 ...
 gt1bk = AllocateCharVec( lgth1+lgth2+1 );
 gt2bk = AllocateCharVec( lgth1+lgth2+1 );
# 616 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 if( outgap == 1 )
  ;
 else
 {
...

{
 ...
 float ogcp1va;
 int maegap;
# 771 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 if( orlgth1 == 0 )
 {
...
# 884 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
  orlgth1 = ll1 - 100;
  orlgth2 = ll2 - 100;
 }
 ...
 ijp = commonIP;
# 937 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 ...
 if( sgap1 )
 {
  ...
  getdiaminofreq_part( diaf2, jcyc, seq2, eff2, lgth2, sgap1, egap2 );
 ...
 if( localhom )
  imp_match_out_vead_tateH( initverticalw, 0, lgth1 );

 match_calc( currentw, cpmx1, cpmx2, 0, lgth2, floatwork, intwork, 1 );
 if( localhom )
  imp_match_out_veadH( currentw, 0, lgth2 );
# 996 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 if( outgap == 1 )
 {
# 1006 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
  for( i=1; i<lgth1+1; i++ )
  {
...
# 1121 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
  previousw = currentw;
...
# 1140 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
  if( localhom )
  {
...
# 1159 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
...
# 1239 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
    wm -= g;
   }

   *ijppt = 0;
# 1251 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
...
# 1273 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
   }
   if( (g=mi+tmppenal) > wm )
   {
...
# 1300 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
...
# 1321 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
   }
...
# 1378 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Halignmm.c"
 if( localhom )
 {
