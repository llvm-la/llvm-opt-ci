# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c" 2
...
# 124 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
        ...
        Segment *seg )
{
 ...
 int pre1, pre2;
# 205 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
 len = ( ((strlen( seq1[0] ))<(strlen( seq2[0] )))?(strlen( seq1[0] )):(strlen( seq2[0] )) );
 maxlen = ( ((strlen( seq1[0] ))>(strlen( seq2[0] )))?(strlen( seq1[0] )):(strlen( seq2[0] )) ) + fftWinSize;
 if( alloclen < maxlen )
 {
  if( alloclen )
  {
 ...
 for( i=1; i<len-fftWinSize; i++ )
 {
  ...
  if( score > threshold )
  {
# 293 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
   if( !status )
   {
    status = 1;
    starttmp = i;
...
void blockAlign( int *cut1, int *cut2, double **ocrossscore, int *ncut )
{
 ...
 static int result1[100000], result2[100000];
 static int ocut1[100000], ocut2[100000];
 double maximum;
 static double max[100000], maxi;
 static double point[100000], pointi;
 static double **crossscore = ((void*)0);
 static int **track = ((void*)0);

 if( crossscore == ((void*)0) )
 {
  crossscore = AllocateDoubleMtx( 100000, 100000 );
  track = AllocateIntMtx( 100000, 100000 );
 }
# 384 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
 ...
 result1[100000 -1] = *ncut-1;
 result2[100000 -1] = *ncut-1;
...
# 534 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
 for( i=0; i<*ncut; i++ ) for( j=0; j<*ncut; j++ )
  crossscore[i][j] = ocrossscore[i][j];
 for( i=0; i<*ncut; i++ )
 {
...
# 607 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
 result1[100000 -1] = *ncut-1;
 result2[100000 -1] = *ncut-1;
...
# 696 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
 for( i=0; i<*ncut; i++ ) for( j=0; j<*ncut; j++ )
  crossscore[i][j] = ocrossscore[i][j];
 for( i=0; i<*ncut; i++ )
 {
...
# 751 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
   maximum = crossscore[i-1][j-1];
   track[i][j] = 0;
...
# 791 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
 result1[100000 -1] = *ncut-1;
 result2[100000 -1] = *ncut-1;
