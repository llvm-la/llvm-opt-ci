# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c" 2
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
static float **impmtx = ((void*)0);
...
void imp_match_init_strictQ( float *imp, int clus1, int clus2, int lgth1, int lgth2, char **seq1, char **seq2, double *eff1, double *eff2, LocalHom ***localhom, int forscore )
{
 ...
 double effijx;
 char *pt, *pt1, *pt2;
 static char *nocount1 = ((void*)0);
 static char *nocount2 = ((void*)0);
 LocalHom *tmpptr;
 ...
 if( impalloclen < lgth1 + 2 || impalloclen < lgth2 + 2 )
 {
  ...
  impalloclen = ( ((lgth1)>(lgth2))?(lgth1):(lgth2) ) + 2;
...
# 134 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 ...
 for( i=0; i<clus1; i++ )
 {
  for( j=0; j<clus2; j++ )
  {
   ...
   while( tmpptr )
   {
    ...
    {
# 170 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
     while( *pt != 0 )
     {
    ...
    {
# 199 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
     while( *pt != 0 )
     {
      if( *pt++ != '-' ) tmpint++;
...
# 264 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
    tmpptr = tmpptr->next;
   }
  }
 }
# 288 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
}
...
# 384 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
}
      ...
      int *gapmap1, int *gapmap2 )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 406 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
...
# 619 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
...
# 641 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
                        ...
                        int **ijp, int icyc, int jcyc )
{
 ...
 gt1bk = AllocateCharVec( lgth1+lgth2+1 );
 gt2bk = AllocateCharVec( lgth1+lgth2+1 );
# 756 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
...

{
 ...
 static float *w1, *w2;
 static float *match;
 static float *initverticalw;
 static float *lastverticalw;
 static char **mseq1;
 static char **mseq2;
 static char **mseq;
 static float *digf1;
...
# 932 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 if( orlgth1 == 0 )
 {
 ...
 if( lgth1 > orlgth1 || lgth2 > orlgth2 )
 {
  ...
  ll1 = ( (((int)(1.3*lgth1))>(orlgth1))?((int)(1.3*lgth1)):(orlgth1) ) + 100;
  ll2 = ( (((int)(1.3*lgth2))>(orlgth2))?((int)(1.3*lgth2)):(orlgth2) ) + 100;
  ...
  floatwork = AllocateFloatMtx( ( ((ll1)>(ll2))?(ll1):(ll2) )+2, 26 );
  intwork = AllocateIntMtx( ( ((ll1)>(ll2))?(ll1):(ll2) )+2, 27 );
# 1052 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
  orlgth1 = ll1 - 100;
  orlgth2 = ll2 - 100;
 }
 ...
 if( orlgth1 > commonAlloc1 || orlgth2 > commonAlloc2 )
 {
  ...
  ll1 = ( ((orlgth1)>(commonAlloc1))?(orlgth1):(commonAlloc1) );
  ll2 = ( ((orlgth2)>(commonAlloc2))?(orlgth2):(commonAlloc2) );
 ...
 ijp = commonIP;
# 1105 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
...
# 1167 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 currentw = w1;
 previousw = w2;
 ...
 if( localhom )
  imp_match_out_vead_tateQ( initverticalw, 0, lgth1 );
 ...
 if( localhom )
  imp_match_out_veadQ( currentw, 0, lgth2 );
# 1193 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 kyokaipenal = 0.0;
 if( outgap == 1 )
 {
  g = 0.0;
 ...
 {
  mp[j] = 0;
  m[j] = currentw[j-1] + 10000 * fpenalty;
 }
 if( lgth2 == 0 )
  lastverticalw[0] = 0.0;
 else
...
# 1283 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
  previousw = currentw;
  ...
  if( RNAscoremtx != 'r' )
   ...
   clearvec( currentw, lgth2 );
# 1305 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
  if( localhom )
  {
...
# 1324 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
...
# 1415 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
...
# 1443 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
   *curpt++ += wm;
   ijppt++;
   mjpt++;
   prept++;
...
# 1481 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 if( localhom )
 {
 ...
 if( alloclen < resultlen || resultlen > 5000000 )
 {
  fprintf( stderr, "alloclen=%d, resultlen=%d, N=%d\n", alloclen, resultlen, 5000000 );
...
# 1510 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 return( wm );
}
...

{
 ...
 float kyokaipenal;
 float fpenalty = (float)penalty;
# 1599 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 if( orlgth1 == 0 )
 {
  mseq1 = AllocateCharMtx( njob, 0 );
  mseq2 = AllocateCharMtx( njob, 0 );
 ...
 if( lgth1 > orlgth1 || lgth2 > orlgth2 )
 {
  ...
  floatwork = AllocateFloatMtx( ( ((ll1)>(ll2))?(ll1):(ll2) )+2, 26 );
  intwork = AllocateIntMtx( ( ((ll1)>(ll2))?(ll1):(ll2) )+2, 27 );
# 1719 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
  orlgth1 = ll1 - 100;
  orlgth2 = ll2 - 100;
 }
 ...
 ijp = commonIP;
# 1772 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 cpmx_calc_new( seq1, cpmx1, eff1, lgth1, icyc );
 cpmx_calc_new( seq2, cpmx2, eff2, lgth2, jcyc );
...
# 1833 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 currentw = w1;
 previousw = w2;
 ...
 if( RNAscoremtx != 'r' )
  ...
  clearvec( initverticalw, lgth1 );
 if( localhom )
  imp_match_out_vead_tateQ_gapmap( initverticalw, gapmap2[0], lgth1, gapmap1 );
 ...
 if( RNAscoremtx != 'r' )
  ...
  clearvec( currentw, lgth2 );
 if( localhom )
  imp_match_out_veadQ_gapmap( currentw, gapmap1[0], lgth2, gapmap2 );
# 1860 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 kyokaipenal = 0.0;
 if( outgap == 1 )
 {
  g = 0.0;
 ...
 if( outgap ) lasti = lgth1+1; else lasti = lgth1;
# 1950 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
  previousw = currentw;
  ...
  if( RNAscoremtx != 'r' )
   ...
   clearvec( currentw, lgth2 );
# 1972 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
  if( localhom )
  {
...
# 1991 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
  currentw[0] = initverticalw[i];
...
# 2082 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
   tmppenal = *gapz_n2_pt1 * fg_t_og_h_dg_n1_p_va;
...
# 2110 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
   *curpt++ += wm;
   ijppt++;
   mjpt++;
   prept++;
...
# 2148 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 if( localhom )
 {
 ...
 for( i=0; i<icyc; i++ ) strcpy( seq1[i], mseq1[i] );
 for( j=0; j<jcyc; j++ ) strcpy( seq2[j], mseq2[j] );
# 2177 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/Qalignmm.c"
 return( wm );
}
