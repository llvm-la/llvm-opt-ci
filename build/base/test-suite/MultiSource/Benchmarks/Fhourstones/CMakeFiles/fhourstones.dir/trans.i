# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Fhourstones/trans.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Fhourstones/trans.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Fhourstones/trans.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Fhourstones/trans.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Fhourstones/trans.c" 2
...
{
  play_init();
  ht = (unsigned int *)calloc(1050011, sizeof(unsigned int));
  he = (byte *)calloc(1050011, sizeof(byte));
  if (ht == 0 || he == 0) {
    printf("Failed to allocate %u bytes.\n",
      1050011 * (sizeof(unsigned int) + sizeof(byte)));
    exit(0);
  }
}
...
void htstat()
{
  ...
  if (total > 0) {
    ...
    printf("- %5.3f  < %5.3f  = %5.3f  > %5.3f  + %5.3f\n",
      typecnt[4+-2]/(double)total, typecnt[4+-1]/(double)total,
      typecnt[4+0]/(double)total, typecnt[4+1]/(double)total,
      typecnt[4+2]/(double)total);
  }
  for (i=0; i<32; i++) {
