# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c" 2
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c"
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c" 2
...
extern int optind;
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c" 2
...
int yyparse (void);
int yylex (void);
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c" 2
...
# 78 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c"
extern int yychar;
...
# 271 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/bc.c"
YYSTYPE yyv[150];
int yychar = -1;
int yynerrs = 0;
short yyerrflag = 0;
...
yyparse() {
 ...
 if( (yyn += yychar)<0 || yyn >= 706 ) goto yydefault;
 ...
 if( yyn == 0 ){
  ...
  case 2:
   ...
   while ( yyps >= yys ) {
      yyn = yypact[*yyps] + 256;
      if( yyn>= 0 && yyn < 706 && yychk[yyact[yyn]] == 256 ){
         yystate = yyact[yyn];
         goto yystack;
         }
      yyn = yypact[*yyps];
 ...
 yyabort:
  ...
  if( yyj>=706 || yychk[ yystate = yyact[yyj] ] != -yyn ) yystate = yyact[yypgo[yyn]];
  switch(yym){
...
case 48:
{
         ...
         sprintf (genstr, "F%d,%s.%s[", lookup(yypvt[-6].s_value,2),
           arg_str (yypvt[-4].a_value,1), arg_str (yypvt[-0].a_value,1));
         generate ((genstr));
...
{ yyval.a_value = yypvt[-1].a_value; } break;
case 55:
{ yyval.a_value = nextarg (((void*)0), lookup (yypvt[-0].s_value,0)); } break;
case 56:
{ yyval.a_value = nextarg (((void*)0), lookup (yypvt[-2].s_value,1)); } break;
case 57:
{ yyval.a_value = nextarg (yypvt[-2].a_value, lookup (yypvt[-0].s_value,0)); } break;
case 58:
{ yyval.a_value = nextarg (yypvt[-4].a_value, lookup (yypvt[-2].s_value,1)); } break;
case 59:
{ yyval.a_value = ((void*)0); } break;
case 61:
{
         if (yypvt[-0].i_value > 1) warn ("comparison in argument");
         yyval.a_value = nextarg (((void*)0),0);
       } break;
case 62:
{
         sprintf (genstr, "K%d:", -lookup (yypvt[-2].s_value,1));
         generate ((genstr));
         yyval.a_value = nextarg (((void*)0),1);
       } break;
case 63:
{
         if (yypvt[-0].i_value > 1) warn ("comparison in argument");
...
{
         yyval.i_value = 1;
         if (yypvt[-1].a_value != ((void*)0))
    {
      sprintf (genstr, "C%d,%s:",
        lookup (yypvt[-3].s_value,2),
        arg_str (yypvt[-1].a_value,0));
      free_args (yypvt[-1].a_value);
    }
         else
    {
      sprintf (genstr, "C%d:", lookup (yypvt[-3].s_value,2));
    }
         generate ((genstr));
       } break;
case 86:
...
case 92:
{ yyval.i_value = lookup(yypvt[-0].s_value,0); } break;
case 93:
{
         if (yypvt[-1].i_value > 1) warn("comparison in subscript");
         yyval.i_value = lookup(yypvt[-3].s_value,1);
       } break;
case 94:
{ yyval.i_value = 0; } break;
case 95:
