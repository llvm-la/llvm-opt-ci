# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/pcg_struct.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/pcg_struct.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/pcg_struct.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/pcg_struct.c" 2
...
hypre_StructKrylovCreateVector( void *vvector )
{
   ...
   new_vector = hypre_StructVectorCreate( ((vector) -> comm),
                                          ((vector) -> grid) );
...
hypre_StructKrylovCreateVectorArray(int n, void *vvector )
{
   ...
   new_vector = ( (hypre_StructVector* *)hypre_CAlloc((unsigned int)(n), (unsigned int)sizeof(hypre_StructVector*)) );
   for (i=0; i < n; i++)
   {
      HYPRE_StructVectorCreate(((vector) -> comm),
                                ((vector) -> grid),
...
hypre_StructKrylovCommInfo( void *A,
                      ...
                      int *num_procs )
{
   hypre_MPI_Comm comm = (((hypre_StructMatrix *) A) -> comm);
