# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/grow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/grow.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/grow.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/grow.c" 2
                        ...
                        int transpose )
{
   ...
   shift_box_array = hypre_BoxArrayCreate(((stencil) -> size));
   ...
   for (s = 0; s < ((stencil) -> size); s++)
   {
      if (transpose)
         ...
         {
            ((((shift_box) -> imin)[d])) =
               ((((box) -> imin)[d])) - (stencil_shape[s][d]);
            ((((shift_box) -> imax)[d])) =
               ((((box) -> imax)[d])) - (stencil_shape[s][d]);
         }
      else
         for (d = 0; d < 3; d++)
         {
      ...
      ( ( (((&((shift_box_array) -> boxes[(s)])) -> imin)[0]) = (((shift_box) -> imin)[0]), (((&((shift_box_array) -> boxes[(s)])) -> imin)[1]) = (((shift_box) -> imin)[1]), (((&((shift_box_array) -> boxes[(s)])) -> imin)[2]) = (((shift_box) -> imin)[2]) ), ( (((&((shift_box_array) -> boxes[(s)])) -> imax)[0]) = (((shift_box) -> imax)[0]), (((&((shift_box_array) -> boxes[(s)])) -> imax)[1]) = (((shift_box) -> imax)[1]), (((&((shift_box_array) -> boxes[(s)])) -> imax)[2]) = (((shift_box) -> imax)[2]) ) );
   }
                             ...
                             int transpose )
{
   ...
   grow_box_array_array =
      hypre_BoxArrayArrayCreate(((box_array) -> size));

   for (i = 0; i < ((box_array) -> size); i++)
      {
         hypre_BoxArrayDestroy(
            ((grow_box_array_array) -> box_arrays[(i)]));
         ((grow_box_array_array) -> box_arrays[(i)]) =
            hypre_GrowBoxByStencil(&((box_array) -> boxes[(i)]),
                                   stencil, transpose);
      }
