# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_relax.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_relax.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_relax.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_relax.c" 2
...
void *
hypre_SMGRelaxCreate( hypre_MPI_Comm comm )
{
   hypre_SMGRelaxData *relax_data;

   relax_data = ( (hypre_SMGRelaxData *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_SMGRelaxData)) );
   (relax_data -> setup_temp_vec) = 1;
   (relax_data -> setup_a_rem) = 1;
   (relax_data -> setup_a_sol) = 1;
   (relax_data -> comm) = comm;
   (relax_data -> base_box_array) = ((void*)0);
   ...
   (relax_data -> space_indices) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (1))) );
   (relax_data -> space_strides) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (1))) );
   (relax_data -> space_indices[0]) = 0;
   (relax_data -> space_strides[0]) = 1;
   (relax_data -> num_pre_spaces) = 0;
   (relax_data -> num_reg_spaces) = 1;
   (relax_data -> pre_space_ranks) = ((void*)0);
   (relax_data -> reg_space_ranks) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (1))) );
   (relax_data -> reg_space_ranks[0]) = 0;
   ( ((relax_data -> base_index)[0]) = 0, ((relax_data -> base_index)[1]) = 0, ((relax_data -> base_index)[2]) = 0 );
   ( ((relax_data -> base_stride)[0]) = 1, ((relax_data -> base_stride)[1]) = 1, ((relax_data -> base_stride)[2]) = 1 );
   (relax_data -> A) = ((void*)0);
   (relax_data -> b) = ((void*)0);
   (relax_data -> x) = ((void*)0);
   (relax_data -> temp_vec) = ((void*)0);
...
hypre_SMGRelaxDestroyARem( void *relax_vdata )
{
   ...
   if (relax_data -> A_rem)
   {
      ...
      ( hypre_Free((char *)relax_data -> residual_data), relax_data -> residual_data = ((void*)0) );
      hypre_StructMatrixDestroy(relax_data -> A_rem);
      (relax_data -> A_rem) = ((void*)0);
   }
   (relax_data -> setup_a_rem) = 1;
...
hypre_SMGRelaxDestroyASol( void *relax_vdata )
{
   ...
   if (relax_data -> A_sol)
   {
      ...
      ( hypre_Free((char *)relax_data -> solve_data), relax_data -> solve_data = ((void*)0) );
      hypre_StructMatrixDestroy(relax_data -> A_sol);
      (relax_data -> A_sol) = ((void*)0);
   }
   (relax_data -> setup_a_sol) = 1;
...
hypre_SMGRelaxDestroy( void *relax_vdata )
{
   ...
   if (relax_data)
   {
      ( hypre_Free((char *)relax_data -> space_indices), relax_data -> space_indices = ((void*)0) );
      ( hypre_Free((char *)relax_data -> space_strides), relax_data -> space_strides = ((void*)0) );
      ( hypre_Free((char *)relax_data -> pre_space_ranks), relax_data -> pre_space_ranks = ((void*)0) );
      ( hypre_Free((char *)relax_data -> reg_space_ranks), relax_data -> reg_space_ranks = ((void*)0) );
                ...
                hypre_StructVector *x )
{
   ...
   int ierr = 0;
# 258 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_relax.c"
...
# 380 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_relax.c"
   if ((stencil_dim - 1) <= (relax_data -> memory_use))
   {
      a_sol_test = 1;
   }
   ...
   if ((relax_data -> base_box_array) == ((void*)0))
   {
                            ...
                            hypre_StructVector *x )
{
   ...
   if ((relax_data -> temp_vec) == ((void*)0))
   {
      temp_vec = hypre_StructVectorCreate(((b) -> comm),
                                          ((b) -> grid));
      hypre_StructVectorSetNumGhost(temp_vec, ((b) -> num_ghost));
                         ...
                         hypre_StructVector *x )
{
   ...
   ( (base_index[0]) = ((relax_data -> base_index)[0]), (base_index[1]) = ((relax_data -> base_index)[1]), (base_index[2]) = ((relax_data -> base_index)[2]) );
   ( (base_stride[0]) = ((relax_data -> base_stride)[0]), (base_stride[1]) = ((relax_data -> base_stride)[1]), (base_stride[2]) = ((relax_data -> base_stride)[2]) );

   stencil_indices = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (stencil_size))) );
   num_stencil_indices = 0;
   for (i = 0; i < stencil_size; i++)
   {
      if ((stencil_shape[i][(stencil_dim - 1)]) != 0)
      {
   ...
   residual_data = ( (void * *)hypre_MAlloc((unsigned int)(sizeof(void *) * (num_spaces))) );

   for (i = 0; i < num_spaces; i++)
   {
      (base_index[(stencil_dim - 1)]) = space_indices[i];
      (base_stride[(stencil_dim - 1)]) = space_strides[i];
                         ...
                         hypre_StructVector *x )
{
   ...
   ((((A_sol) -> stencil)) -> dim) = stencil_dim - 1;
   ( hypre_Free((char *)stencil_indices), stencil_indices = ((void*)0) );


   solve_data = ( (void * *)hypre_MAlloc((unsigned int)(sizeof(void *) * (num_spaces))) );
                            ...
                            int num_spaces )
{
   ...
   ( hypre_Free((char *)relax_data -> pre_space_ranks), relax_data -> pre_space_ranks = ((void*)0) );
   ( hypre_Free((char *)relax_data -> reg_space_ranks), relax_data -> reg_space_ranks = ((void*)0) );
   (relax_data -> space_indices) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_spaces))) );
   (relax_data -> space_strides) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_spaces))) );
   (relax_data -> num_pre_spaces) = 0;
   (relax_data -> num_reg_spaces) = num_spaces;
   (relax_data -> pre_space_ranks) = ((void*)0);
   (relax_data -> reg_space_ranks) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_spaces))) );
                               ...
                               int num_pre_spaces )
{
   ...
   ( hypre_Free((char *)relax_data -> pre_space_ranks), relax_data -> pre_space_ranks = ((void*)0) );
   (relax_data -> pre_space_ranks) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_pre_spaces))) );
                               ...
                               int num_reg_spaces )
{
   ...
   ( hypre_Free((char *)relax_data -> reg_space_ranks), relax_data -> reg_space_ranks = ((void*)0) );
   (relax_data -> reg_space_ranks) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_reg_spaces))) );
                       ...
                       hypre_Index base_stride )
{
   ...
   for (d = 0; d < 3; d++)
   {
      ((relax_data -> base_index)[d]) =
         (base_index[d]);
      ((relax_data -> base_stride)[d]) =
         (base_stride[d]);
   }
                              ...
                              int num_pre_relax )
{
   ...
   (relax_data -> num_pre_relax) = (((num_pre_relax)<(1)) ? (1) : (num_pre_relax));
                                   ...
                                   hypre_StructStencil *diff_stencil )
{
   ...
   hypre_Index *stencil_shape = ((diff_stencil) -> shape);
   int stencil_size = ((diff_stencil) -> size);
   int stencil_dim = ((diff_stencil) -> dim);
