# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg.c" 2
...
void *
hypre_SMGCreate( hypre_MPI_Comm comm )
{
   hypre_SMGData *smg_data;

   smg_data = ( (hypre_SMGData *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_SMGData)) );
   ...
   (smg_data -> cdir) = 2;
   ( ((smg_data -> base_index)[0]) = 0, ((smg_data -> base_index)[1]) = 0, ((smg_data -> base_index)[2]) = 0 );
   ( ((smg_data -> base_stride)[0]) = 1, ((smg_data -> base_stride)[1]) = 1, ((smg_data -> base_stride)[2]) = 1 );
   (smg_data -> logging) = 0;
...
hypre_SMGDestroy( void *smg_vdata )
{
   ...
   if (smg_data)
   {
      ...
      {
         ( hypre_Free((char *)smg_data -> norms), smg_data -> norms = ((void*)0) );
         ( hypre_Free((char *)smg_data -> rel_norms), smg_data -> rel_norms = ((void*)0) );
      }
      ...
      if ((smg_data -> num_levels) > -1)
      {
         ...
         ( hypre_Free((char *)smg_data -> relax_data_l), smg_data -> relax_data_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> residual_data_l), smg_data -> residual_data_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> restrict_data_l), smg_data -> restrict_data_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> interp_data_l), smg_data -> interp_data_l = ((void*)0) );
         ...
         ( hypre_Free((char *)smg_data -> data), smg_data -> data = ((void*)0) );
         ( hypre_Free((char *)smg_data -> grid_l), smg_data -> grid_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> PT_grid_l), smg_data -> PT_grid_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> A_l), smg_data -> A_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> PT_l), smg_data -> PT_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> R_l), smg_data -> R_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> b_l), smg_data -> b_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> x_l), smg_data -> x_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> tb_l), smg_data -> tb_l = ((void*)0) );
         ( hypre_Free((char *)smg_data -> tx_l), smg_data -> tx_l = ((void*)0) );
      }

      hypre_FinalizeTiming(smg_data -> time_index);
      ( hypre_Free((char *)smg_data), smg_data = ((void*)0) );
   }
                         ...
                         int num_pre_relax )
{
   ...
   (smg_data -> num_pre_relax) = (((num_pre_relax)<(1)) ? (1) : (num_pre_relax));
                  ...
                  hypre_Index base_stride )
{
   ...
   for (d = 0; d < 3; d++)
   {
      ((smg_data -> base_index)[d]) =
         (base_index[d]);
      ((smg_data -> base_stride)[d]) =
         (base_stride[d]);
   }
...
# 413 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg.c" 2
