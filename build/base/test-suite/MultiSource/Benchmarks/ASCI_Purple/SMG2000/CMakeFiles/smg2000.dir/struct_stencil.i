# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_stencil.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_stencil.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_stencil.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_stencil.c" 2
                           ...
                           hypre_Index *shape )
{
   ...
   stencil = ( (hypre_StructStencil *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructStencil) * (1))) );
                                ...
                                hypre_Index stencil_element )
{
   ...
   {
      if (((stencil_shape[i][0]) == (stencil_element[0])) &&
          ((stencil_shape[i][1]) == (stencil_element[1])) &&
          ((stencil_shape[i][2]) == (stencil_element[2])) )
      {
         rank = i;
         break;
      }
...
# 129 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_stencil.c"
int
                               ...
                               int **symm_elements_ptr )
{
   ...
   symm_stencil_shape = ( (hypre_Index *)hypre_CAlloc((unsigned int)(2*stencil_size), (unsigned int)sizeof(hypre_Index)) );
   ...
   symm_elements = ( (int *)hypre_CAlloc((unsigned int)(2*stencil_size), (unsigned int)sizeof(int)) );
   ...
   for (i = 0; i < stencil_size; i++)
   {
      if (symm_elements[i] < 0)
      {
         ...
         {
            if ( ((symm_stencil_shape[j][0]) ==
                  -(symm_stencil_shape[i][0]) ) &&
                 ((symm_stencil_shape[j][1]) ==
                  -(symm_stencil_shape[i][1]) ) &&
                 ((symm_stencil_shape[j][2]) ==
                  -(symm_stencil_shape[i][2]) ) )
            {
         ...
         if (no_symmetric_stencil_element)
         {
            ...
            for (d = 0; d < 3; d++)
            {
               (symm_stencil_shape[symm_stencil_size][d]) =
                  -(symm_stencil_shape[i][d]);
            }
   ...
   symm_stencil = hypre_StructStencilCreate(((stencil) -> dim),
                                            symm_stencil_size,
                                            symm_stencil_shape);
