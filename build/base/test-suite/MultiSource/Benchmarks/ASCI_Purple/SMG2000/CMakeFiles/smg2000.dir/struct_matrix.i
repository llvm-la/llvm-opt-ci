# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c" 2
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c"
double *
...
hypre_StructMatrix *
hypre_StructMatrixCreate( hypre_MPI_Comm comm,
                          hypre_StructGrid *grid,
                          hypre_StructStencil *user_stencil )
{
   hypre_StructMatrix *matrix;
   ...
   matrix = ( (hypre_StructMatrix *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_StructMatrix)) );
...
hypre_StructMatrixInitializeShell( hypre_StructMatrix *matrix )
{
   ...
   grid = ((matrix) -> grid);
# 168 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c"
   ...
   for (i = 0; i < stencil_size; i++)
   {
      if (symm_elements[i] >= 0)
      {
         ...
         {
            extra_ghost[2*d] =
               (((extra_ghost[2*d])<(-(stencil_shape[i][d]))) ? (-(stencil_shape[i][d])) : (extra_ghost[2*d]));
            extra_ghost[2*d + 1] =
               (((extra_ghost[2*d + 1])<((stencil_shape[i][d]))) ? ((stencil_shape[i][d])) : (extra_ghost[2*d + 1]));
         }
      }
   }
      ...
      for (i = 0; i < ((data_space) -> size); i++)
         {
            ...
            data_indices[i] = ( (int *)hypre_CAlloc((unsigned int)(stencil_size), (unsigned int)sizeof(int)) );
            ...
            for (j = 0; j < stencil_size; j++)
            {
               if (symm_elements[j] >= 0)
               {
                  data_indices[i][j] = data_indices[i][symm_elements[j]] +
                     ((stencil_shape[j][0]) + ((stencil_shape[j][1]) + ((stencil_shape[j][2]) * (((0)<((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1))) ? ((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0)));
               }
            }
         }
...
# 338 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c"
   ...
   for (i = 0; i < ((data_boxes) -> size); i++)
      {
         ...
         if (datap)
         {
            ...
            { int hypre__i1start = (((start[0]) - ((((data_box) -> imin)[0]))) + (((start[1]) - ((((data_box) -> imin)[1]))) + (((start[2]) - ((((data_box) -> imin)[2]))) * (((0)<((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1))) ? ((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stride[0]));int hypre__sy1 = ((stride[1])*(((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stride[2])* (((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1))) ? ((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 357 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c" 2
...
hypre_StructMatrixInitialize( hypre_StructMatrix *matrix )
{
   ...
   data = ( (double *)hypre_CAlloc((unsigned int)((((matrix) -> data_size))), (unsigned int)sizeof(double)) );
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 539 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c" 2
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 552 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; datai = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; dvali = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                        {
                           datap[datai] = values[dvali];
                        }
...
hypre_StructMatrixAssemble( hypre_StructMatrix *matrix )
{
   ...
   if (!comm_pkg)
   {
      ...
      hypre_CreateCommInfoFromNumGhost(((matrix) -> grid),
                                       num_ghost,
                         ...
                         int all )
{
   ...
   int myid;
# 692 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c"
   hypre_MPI_Comm_rank(((matrix) -> comm), &myid);
                           ...
                           hypre_StructMatrix *to_matrix )
{
   ...
   hypre_CreateCommInfoFromGrids(((from_matrix) -> grid),
                                 ((to_matrix) -> grid),
                                 &send_boxes, &recv_boxes,
                                 &send_processes, &recv_processes);
   ...
   comm_pkg = hypre_CommPkgCreate(send_boxes, recv_boxes,
                                  unit_stride, unit_stride,
                                  ((from_matrix) -> data_space),
                                  ((to_matrix) -> data_space),
                                  send_processes, recv_processes,
                                  ((from_matrix) -> num_values),
                                  ((from_matrix) -> comm),
                                  ((((from_matrix) -> grid)) -> periodic));
...
hypre_StructMatrix *
hypre_StructMatrixRead( hypre_MPI_Comm comm,
                        char *filename,
                        int *num_ghost )
{
   FILE *file;
   ...
   int myid;
# 857 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_matrix.c"
   ...
   dim = ((grid) -> dim);
   fscanf(file, "%d\n", &stencil_size);
   stencil_shape = ( (hypre_Index *)hypre_CAlloc((unsigned int)(stencil_size), (unsigned int)sizeof(hypre_Index)) );
   for (i = 0; i < stencil_size; i++)
   {
      fscanf(file, "%d: %d %d %d\n", &idummy,
             &(stencil_shape[i][0]),
