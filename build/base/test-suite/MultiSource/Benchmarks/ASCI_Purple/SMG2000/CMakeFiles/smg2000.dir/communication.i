# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c" 2
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c" 2
# 63 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
  hypre_CommPkg *
                       ...
                       hypre_Index periodic )
{
   ...
   comm_pkg = ( (hypre_CommPkg *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_CommPkg)) );
   ...
   (comm_pkg -> send_types) = send_types;
   (comm_pkg -> copy_from_type) = copy_from_type;
   ...
   (comm_pkg -> recv_types) = recv_types;
   (comm_pkg -> copy_to_type) = copy_to_type;
   ...
   for (i = 0; i < ((send_boxes) -> size); i++)
      ( hypre_Free((char *)send_processes[i]), send_processes[i] = ((void*)0) );
   hypre_BoxArrayArrayDestroy(send_boxes);
   ( hypre_Free((char *)send_processes), send_processes = ((void*)0) );

   for (i = 0; i < ((recv_boxes) -> size); i++)
      ( hypre_Free((char *)recv_processes[i]), recv_processes[i] = ((void*)0) );
   hypre_BoxArrayArrayDestroy(recv_boxes);
   ( hypre_Free((char *)recv_processes), recv_processes = ((void*)0) );
   ...
   for (i = 0; i < (comm_pkg -> num_sends); i++)
      hypre_CommTypeDestroy((comm_pkg -> send_types[i]));
   ( hypre_Free((char *)(comm_pkg -> send_types)), (comm_pkg -> send_types) = ((void*)0) );
   for (i = 0; i < (comm_pkg -> num_recvs); i++)
      hypre_CommTypeDestroy((comm_pkg -> recv_types[i]));
   ( hypre_Free((char *)(comm_pkg -> recv_types)), (comm_pkg -> recv_types) = ((void*)0) );


   return comm_pkg;
}
# 170 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommPkgDestroy( hypre_CommPkg *comm_pkg )
{
   ...
   if (comm_pkg)
   {
# 190 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
      ...
      hypre_CommTypeDestroy((comm_pkg -> copy_from_type));
      hypre_CommTypeDestroy((comm_pkg -> copy_to_type));
...
# 444 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
                               ...
                               hypre_CommHandle **comm_handle_ptr )
{
   ...
   hypre_MPI_Comm comm = (comm_pkg -> comm);
   ...
   requests = ( (hypre_MPI_Request *)hypre_CAlloc((unsigned int)(num_requests), (unsigned int)sizeof(hypre_MPI_Request)) );
   status = ( (hypre_MPI_Status *)hypre_CAlloc((unsigned int)(num_requests), (unsigned int)sizeof(hypre_MPI_Status)) );
# 482 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
   j = 0;
   for(i = 0; i < num_recvs; i++)
   {
      hypre_MPI_Irecv((void *)recv_data, 1,
                (comm_pkg -> recv_mpi_types[i]),
                (comm_pkg -> recv_procs[i]),
                0, comm, &requests[j++]);
   }
   for(i = 0; i < num_sends; i++)
   {
      hypre_MPI_Isend((void *)send_data, 1,
                (comm_pkg -> send_mpi_types[i]),
                (comm_pkg -> send_procs[i]),
                0, comm, &requests[j++]);
   }
   ...
   comm_handle = ( (hypre_CommHandle *)hypre_MAlloc((unsigned int)(sizeof(hypre_CommHandle) * (1))) );
...
# 660 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_FinalizeCommunication( hypre_CommHandle *comm_handle )
{
   ...
   {
      hypre_MPI_Waitall((comm_handle -> num_requests),
                  (comm_handle -> requests),
                  (comm_handle -> status));
   }
...
# 704 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
                         ...
                         double *recv_data )
{
   ...
   {
      copy_from_entry = (copy_from_type -> comm_entries[i]);
      copy_to_entry = (copy_to_type -> comm_entries[i]);
...
# 795 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
hypre_CommType *
                      ...
                      int num_entries )
{
   ...
   comm_type = ( (hypre_CommType *)hypre_MAlloc((unsigned int)(sizeof(hypre_CommType) * (1))) );

   (comm_type -> comm_entries) = comm_entries;
   (comm_type -> num_entries) = num_entries;

   return comm_type;
}
# 824 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommTypeDestroy( hypre_CommType *comm_type )
{
   ...
   if (comm_type)
   {
      if ( (comm_type -> comm_entries) != ((void*)0) )
      {
         for (i = 0; i < (comm_type -> num_entries); i++)
         {
            comm_entry = (comm_type -> comm_entries[i]);
            hypre_CommTypeEntryDestroy(comm_entry);
         }
      }

      ( hypre_Free((char *)(comm_type -> comm_entries)), (comm_type -> comm_entries) = ((void*)0) );
      ( hypre_Free((char *)comm_type), comm_type = ((void*)0) );
   }

   return ierr;
}
# 871 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
hypre_CommTypeEntry *
                           ...
                           int data_box_offset )
{
   ...
   comm_entry = ( (hypre_CommTypeEntry *)hypre_MAlloc((unsigned int)(sizeof(hypre_CommTypeEntry) * (1))) );





   ( ((comm_entry -> imin)[0]) = (((box) -> imin)[0]), ((comm_entry -> imin)[1]) = (((box) -> imin)[1]), ((comm_entry -> imin)[2]) = (((box) -> imin)[2]) );

   ( ((comm_entry -> imax)[0]) = (((box) -> imax)[0]), ((comm_entry -> imax)[1]) = (((box) -> imax)[1]), ((comm_entry -> imax)[2]) = (((box) -> imax)[2]) );


   (comm_entry -> offset) =
      data_box_offset + (((((box) -> imin)[0]) - ((((data_box) -> imin)[0]))) + (((((box) -> imin)[1]) - ((((data_box) -> imin)[1]))) + (((((box) -> imin)[2]) - ((((data_box) -> imin)[2]))) * (((0)<((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1))) ? ((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0)));
...
# 961 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
   if(!dim)
      dim = 1;
...
# 984 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommTypeEntryDestroy( hypre_CommTypeEntry *comm_entry )
{
   ...
   if (comm_entry)
   {
      ( hypre_Free((char *)comm_entry), comm_entry = ((void*)0) );
   }

   return ierr;
}
# 1032 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
                         ...
                         hypre_CommType **copy_type_ptr)
{
   ...
   num_entries = ( (int *)hypre_CAlloc((unsigned int)(num_procs), (unsigned int)sizeof(int)) );

   num_comms = 0;
   for (i = 0; i < ((boxes) -> size); i++)
      {
         box_array = ((boxes) -> box_arrays[(i)]);
   ...
   comm_entries = ( (hypre_CommTypeEntry ** *)hypre_CAlloc((unsigned int)(num_procs), (unsigned int)sizeof(hypre_CommTypeEntry **)) );
   comm_processes = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_comms))) );
   ...
   for (i = 0; i < ((boxes) -> size); i++)
      {
         ...
         for (j = 0; j < ((box_array) -> size); j++)
            {
               ...
               if (((((0)<((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1))) ? ((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1)) : (0)) * (((0)<((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1))) ? ((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1)) : (0)) * (((0)<((((((box) -> imax)[2])) - ((((box) -> imin)[2])) + 1))) ? ((((((box) -> imax)[2])) - ((((box) -> imin)[2])) + 1)) : (0))) != 0)
               {
                  ...
                  if (comm_entries[p] == ((void*)0))
                  {
                     comm_entries[p] =
                        ( (hypre_CommTypeEntry * *)hypre_CAlloc((unsigned int)(num_entries[p]), (unsigned int)sizeof(hypre_CommTypeEntry *)) );
                     num_entries[p] = 0;
         ...
         data_box_offset += ((((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0)) * (((0)<((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1))) ? ((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1)) : (0)) * (((0)<((((((data_box) -> imax)[2])) - ((((data_box) -> imin)[2])) + 1))) ? ((((((data_box) -> imax)[2])) - ((((data_box) -> imin)[2])) + 1)) : (0))) * num_values;
      }
   ...
   comm_types = ( (hypre_CommType * *)hypre_MAlloc((unsigned int)(sizeof(hypre_CommType *) * (num_comms))) );
   ...
   if (comm_entries[my_proc] != ((void*)0))
   {
      p = my_proc;
   ...
   {
      copy_type = hypre_CommTypeCreate(((void*)0), 0);
   }
   ...
   ( hypre_Free((char *)comm_entries), comm_entries = ((void*)0) );
   ( hypre_Free((char *)num_entries), num_entries = ((void*)0) );
...
# 1208 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommTypeSort( hypre_CommType *comm_type,
                    hypre_Index periodic )
{
   hypre_CommTypeEntry **comm_entries = (comm_type -> comm_entries);
   ...
   for (i = (num_entries - 1); i > 0; i--)
   {
      ...
      {
         swap = 0;
         imin0 = (comm_entries[j] -> imin);
         imin1 = (comm_entries[j+1] -> imin);
   ...
   for (ii = 0; ii < (num_entries - 1); ii = jj)
   {
      ...
      imin0 = (comm_entries[ii] -> imin);
      for (jj = (ii + 1); jj < num_entries; jj++)
      {
         imin1 = (comm_entries[jj] -> imin);
         if ( ( hypre_IModPeriodX(imin0, periodic) !=
                hypre_IModPeriodX(imin1, periodic) ) ||
      ...
      for (i = (jj - 1); i > ii; i--)
      {
         ...
         {
            swap = 0;
            imax0 = (comm_entries[j] -> imax);
            imax1 = (comm_entries[j+1] -> imax);
...
# 1352 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommPkgCommit( hypre_CommPkg *comm_pkg )
{
   ...
   (comm_pkg -> send_mpi_types) =
      ( (hypre_MPI_Datatype *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Datatype) * ((comm_pkg -> num_sends)))) );
   hypre_CommTypeBuildMPI((comm_pkg -> num_sends),
                          (comm_pkg -> send_procs),
                          (comm_pkg -> send_types),
                          (comm_pkg -> send_mpi_types));


   (comm_pkg -> recv_mpi_types) =
      ( (hypre_MPI_Datatype *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Datatype) * ((comm_pkg -> num_recvs)))) );
   hypre_CommTypeBuildMPI((comm_pkg -> num_recvs),
                          (comm_pkg -> recv_procs),
                          (comm_pkg -> recv_types),
                          (comm_pkg -> recv_mpi_types));
...
# 1392 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommPkgUnCommit( hypre_CommPkg *comm_pkg )
{
   hypre_MPI_Datatype *types;
   int i;
   int ierr = 0;

   if (comm_pkg)
   {
      types = (comm_pkg -> send_mpi_types);
      if (types)
      {
         for (i = 0; i < (comm_pkg -> num_sends); i++)
            hypre_MPI_Type_free(&types[i]);
         ( hypre_Free((char *)types), types = ((void*)0) );
      }

      types = (comm_pkg -> recv_mpi_types);
      if (types)
      {
         for (i = 0; i < (comm_pkg -> num_recvs); i++)
            hypre_MPI_Type_free(&types[i]);
...
# 1443 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommTypeBuildMPI( int num_comms,
                        int *comm_procs,
                        hypre_CommType **comm_types,
                        hypre_MPI_Datatype *comm_mpi_types )
{
   hypre_CommType *comm_type;
   hypre_CommTypeEntry *comm_entry;
   int num_entries;
   int *comm_entry_blocklengths;
   hypre_MPI_Aint *comm_entry_displacements;
   hypre_MPI_Datatype *comm_entry_mpi_types;
   ...
   for (m = 0; m < num_comms; m++)
   {
      ...
      comm_entry_blocklengths = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_entries))) );
      comm_entry_displacements = ( (hypre_MPI_Aint *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Aint) * (num_entries))) );
      comm_entry_mpi_types = ( (hypre_MPI_Datatype *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Datatype) * (num_entries))) );
      ...
      for (i = 0; i < num_entries; i++)
      {
         ...
         comm_entry_displacements[i] =
            (comm_entry -> offset) * sizeof(double);
      ...
      hypre_MPI_Type_struct(num_entries, comm_entry_blocklengths,
                      comm_entry_displacements, comm_entry_mpi_types,
                      &comm_mpi_types[m]);
      hypre_MPI_Type_commit(&comm_mpi_types[m]);


      for (i = 0; i < num_entries; i++)
         hypre_MPI_Type_free(&comm_entry_mpi_types[i]);
      ( hypre_Free((char *)comm_entry_blocklengths), comm_entry_blocklengths = ((void*)0) );
      ( hypre_Free((char *)comm_entry_displacements), comm_entry_displacements = ((void*)0) );
      ( hypre_Free((char *)comm_entry_mpi_types), comm_entry_mpi_types = ((void*)0) );
   }

   return ierr;
}
# 1517 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
int
hypre_CommTypeEntryBuildMPI( hypre_CommTypeEntry *comm_entry,
                             hypre_MPI_Datatype *comm_entry_mpi_type )
{
   int dim = (comm_entry -> dim);
   int *length_array = (comm_entry -> length_array);
   int *stride_array = (comm_entry -> stride_array);

   hypre_MPI_Datatype *old_type;
   hypre_MPI_Datatype *new_type;
   hypre_MPI_Datatype *tmp_type;
   ...
   if (dim == 1)
   {
      hypre_MPI_Type_hvector(length_array[0], 1,
                       (hypre_MPI_Aint)(stride_array[0]*sizeof(double)),
                       0, comm_entry_mpi_type);
   }
   else
   {
      old_type = ( (hypre_MPI_Datatype *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_MPI_Datatype)) );
      new_type = ( (hypre_MPI_Datatype *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_MPI_Datatype)) );
      ...
      for (i = 1; i < (dim - 1); i++)
      {
         hypre_MPI_Type_hvector(length_array[i], 1,
                          (hypre_MPI_Aint)(stride_array[i]*sizeof(double)),
                          *old_type, new_type);

         hypre_MPI_Type_free(old_type);
         tmp_type = old_type;
         old_type = new_type;
         new_type = tmp_type;
      ...
      ( hypre_Free((char *)old_type), old_type = ((void*)0) );
      ( hypre_Free((char *)new_type), new_type = ((void*)0) );
   }
