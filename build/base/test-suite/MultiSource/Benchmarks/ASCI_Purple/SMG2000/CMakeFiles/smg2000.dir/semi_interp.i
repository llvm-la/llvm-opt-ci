# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_interp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_interp.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_interp.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_interp.c" 2
...
hypre_SemiInterpCreate( )
{
   ...
   interp_data = ( (hypre_SemiInterpData *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_SemiInterpData)) );
                       ...
                       hypre_Index stride )
{
   ...
   ( ((interp_data -> cindex)[0]) = (cindex[0]), ((interp_data -> cindex)[1]) = (cindex[1]), ((interp_data -> cindex)[2]) = (cindex[2]) );
   ( ((interp_data -> findex)[0]) = (findex[0]), ((interp_data -> findex)[1]) = (findex[1]), ((interp_data -> findex)[2]) = (findex[2]) );
   ( ((interp_data -> stride)[0]) = (stride[0]), ((interp_data -> stride)[1]) = (stride[1]), ((interp_data -> stride)[2]) = (stride[2]) );
   ...
   for (ci = 0; ci < ((cgrid_boxes) -> size); ci++)
      {
         ...
         e_dbox = &((((e) -> data_space)) -> boxes[(fi)]);
         xc_dbox = &((((xc) -> data_space)) -> boxes[(ci)]);

         ep = (((e) -> data) + ((e) -> data_indices)[fi]);
         xcp = (((xc) -> data) + ((xc) -> data_indices)[ci]);

         hypre_BoxGetSize(compute_box, loop_size);

         { int hypre__i1start = (((start[0]) - ((((e_dbox) -> imin)[0]))) + (((start[1]) - ((((e_dbox) -> imin)[1]))) + (((start[2]) - ((((e_dbox) -> imin)[2]))) * (((0)<((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1))) ? ((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((startc[0]) - ((((xc_dbox) -> imin)[0]))) + (((startc[1]) - ((((xc_dbox) -> imin)[1]))) + (((startc[2]) - ((((xc_dbox) -> imin)[2]))) * (((0)<((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1))) ? ((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1))) ? ((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stride[0]));int hypre__sy1 = ((stride[1])*(((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stride[2])* (((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1))) ? ((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stridec[0]));int hypre__sy2 = ((stridec[1])*(((0)<((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1))) ? ((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stridec[2])* (((0)<((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1))) ? ((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1))) ? ((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
 ...
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; ei = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; xci = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
   ...
   for (compute_i = 0; compute_i < 2; compute_i++)
   {
      ...
      for (fi = 0; fi < ((compute_box_aa) -> size); fi++)
         {
            compute_box_a = ((compute_box_aa) -> box_arrays[(fi)]);

            P_dbox = &((((P) -> data_space)) -> boxes[(fi)]);
            e_dbox = &((((e) -> data_space)) -> boxes[(fi)]);

            if (P_stored_as_transpose)
            {
               Pp0 = (((P) -> data) + ((P) -> data_indices)[fi][1]);
               Pp1 = (((P) -> data) + ((P) -> data_indices)[fi][0]) -
                  ((stencil_shape[0][0]) + ((stencil_shape[0][1]) + ((stencil_shape[0][2]) * (((0)<((((((P_dbox) -> imax)[1])) - ((((P_dbox) -> imin)[1])) + 1))) ? ((((((P_dbox) -> imax)[1])) - ((((P_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1))) ? ((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1)) : (0)));
            }
            else
            {
               Pp0 = (((P) -> data) + ((P) -> data_indices)[fi][0]);
               Pp1 = (((P) -> data) + ((P) -> data_indices)[fi][1]);
            }
            ep = (((e) -> data) + ((e) -> data_indices)[fi]);
            ep0 = ep + ((stencil_shape[0][0]) + ((stencil_shape[0][1]) + ((stencil_shape[0][2]) * (((0)<((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1))) ? ((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0)));
            ep1 = ep + ((stencil_shape[1][0]) + ((stencil_shape[1][1]) + ((stencil_shape[1][2]) * (((0)<((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1))) ? ((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0)));
            ...
            for (j = 0; j < ((compute_box_a) -> size); j++)
               {
                  ...
                  { int hypre__i1start = (((startc[0]) - ((((P_dbox) -> imin)[0]))) + (((startc[1]) - ((((P_dbox) -> imin)[1]))) + (((startc[2]) - ((((P_dbox) -> imin)[2]))) * (((0)<((((((P_dbox) -> imax)[1])) - ((((P_dbox) -> imin)[1])) + 1))) ? ((((((P_dbox) -> imax)[1])) - ((((P_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1))) ? ((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((start[0]) - ((((e_dbox) -> imin)[0]))) + (((start[1]) - ((((e_dbox) -> imin)[1]))) + (((start[2]) - ((((e_dbox) -> imin)[2]))) * (((0)<((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1))) ? ((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stridec[0]));int hypre__sy1 = ((stridec[1])*(((0)<((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1))) ? ((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stridec[2])* (((0)<((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1))) ? ((((((P_dbox) -> imax)[0])) - ((((P_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((P_dbox) -> imax)[1])) - ((((P_dbox) -> imin)[1])) + 1))) ? ((((((P_dbox) -> imax)[1])) - ((((P_dbox) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stride[0]));int hypre__sy2 = ((stride[1])*(((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stride[2])* (((0)<((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1))) ? ((((((e_dbox) -> imax)[0])) - ((((e_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1))) ? ((((((e_dbox) -> imax)[1])) - ((((e_dbox) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 292 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_interp.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; Pi = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; ei = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                     {
                        ep[ei] = (Pp0[Pi] * ep0[ei] +
                                   Pp1[Pi] * ep1[ei]);
                     }
                  Pi += hypre__sx1; ei += hypre__sx2; } Pi += hypre__sy1 - hypre__nx*hypre__sx1; ei += hypre__sy2 - hypre__nx*hypre__sx2; } Pi += hypre__sz1 - hypre__ny*hypre__sy1; ei += hypre__sz2 - hypre__ny*hypre__sy2; } }};
               }
         }
   }
   ...
   hypre_IncFLOPCount(3*((xc) -> global_size));
...
hypre_SemiInterpDestroy( void *interp_vdata )
{
   ...
   if (interp_data)
   {
      ...
      ( hypre_Free((char *)interp_data), interp_data = ((void*)0) );
   }
