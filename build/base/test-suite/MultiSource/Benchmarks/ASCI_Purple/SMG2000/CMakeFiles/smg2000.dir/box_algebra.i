# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_algebra.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_algebra.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_algebra.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_algebra.c" 2
                      ...
                      hypre_Box *ibox )
{
   ...
   {
      ((((ibox) -> imin)[d])) =
         (((((((box1) -> imin)[d])))<(((((box2) -> imin)[d])))) ? (((((box2) -> imin)[d]))) : (((((box1) -> imin)[d]))));
      ((((ibox) -> imax)[d])) =
         (((((((box1) -> imax)[d])))<(((((box2) -> imax)[d])))) ? (((((box1) -> imax)[d]))) : (((((box2) -> imax)[d]))));
   }
                     ...
                     hypre_BoxArray *box_array )
{
   ...
   for (d = 0; d < 3; d++)
   {
      ...
      if ( (((((box2) -> imin)[d])) > ((((rembox) -> imax)[d]))) ||
           (((((box2) -> imax)[d])) < ((((rembox) -> imin)[d]))) )
      {
         ( ( (((&((box_array) -> boxes[(0)])) -> imin)[0]) = (((box1) -> imin)[0]), (((&((box_array) -> boxes[(0)])) -> imin)[1]) = (((box1) -> imin)[1]), (((&((box_array) -> boxes[(0)])) -> imin)[2]) = (((box1) -> imin)[2]) ), ( (((&((box_array) -> boxes[(0)])) -> imax)[0]) = (((box1) -> imax)[0]), (((&((box_array) -> boxes[(0)])) -> imax)[1]) = (((box1) -> imax)[1]), (((&((box_array) -> boxes[(0)])) -> imax)[2]) = (((box1) -> imax)[2]) ) );
         size = 1;
         break;
      }
...
# 152 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_algebra.c"
int
hypre_UnionBoxes( hypre_BoxArray *boxes )
{
   ...
   i_tmp0 = 2 * ((boxes) -> size);
   block_index[0] = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (3 * i_tmp0))) );
   block_sz[0] = 0;
   for (d = 1; d < 3; d++)
   {
   ...
   for (bi = 0; bi < ((boxes) -> size); bi++)
      {
         box = &((boxes) -> boxes[(bi)]);

         for (d = 0; d < 3; d++)
         {
            iminmax[0] = ((((box) -> imin)[d]));
            iminmax[1] = ((((box) -> imax)[d])) + 1;
   ...
   block = ( (int *)hypre_CAlloc((unsigned int)(block_volume), (unsigned int)sizeof(int)) );
   ...
   for (bi = 0; bi < ((boxes) -> size); bi++)
      {
         ...
         for (d = 0; d < 3; d++)
         {
            ...
            while (((((box) -> imin)[d])) != block_index[d][j])
               j++;
            imin[d] = j;

            while (((((box) -> imax)[d])) + 1 != block_index[d][j])
               j++;
            imax[d] = j;
         }
...
# 293 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_algebra.c"
   for (d = 0; d < 3; d++)
   {
      switch(d)
      {
      ...
      for (j = 0; j < block_sz[1]; j++)
      {
         for (i = 0; i < block_sz[0]; i++)
         {
            if (block[index])
            {
               ...
               box = &((boxes) -> boxes[(size)]);
               ((((box) -> imin)[0])) = block_index[0][i];
               ((((box) -> imin)[1])) = block_index[1][j];
               ((((box) -> imin)[2])) = block_index[2][k];
               ((((box) -> imax)[0])) = block_index[0][i + ioff] - 1;
               ((((box) -> imax)[1])) = block_index[1][j + joff] - 1;
               ((((box) -> imax)[2])) = block_index[2][k + koff] - 1;
   ...
   ( hypre_Free((char *)block_index[0]), block_index[0] = ((void*)0) );
