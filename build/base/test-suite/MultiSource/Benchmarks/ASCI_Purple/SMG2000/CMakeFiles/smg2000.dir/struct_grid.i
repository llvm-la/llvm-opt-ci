# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_grid.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_grid.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_grid.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_grid.c" 2
...
int
hypre_StructGridCreate( hypre_MPI_Comm comm,
                        int dim,
                        hypre_StructGrid **grid_ptr)
{
   hypre_StructGrid *grid;

   grid = ( (hypre_StructGrid *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructGrid) * (1))) );
                         ...
                         hypre_Box *bounding_box )
{
   ...
   ids = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_local))) );
   for (i = 0; i < num_local; i++)
   {
      ilocal = first_local + i;
      ( ( (((&((boxes) -> boxes[(i)])) -> imin)[0]) = (((&((hood_boxes) -> boxes[(ilocal)])) -> imin)[0]), (((&((boxes) -> boxes[(i)])) -> imin)[1]) = (((&((hood_boxes) -> boxes[(ilocal)])) -> imin)[1]), (((&((boxes) -> boxes[(i)])) -> imin)[2]) = (((&((hood_boxes) -> boxes[(ilocal)])) -> imin)[2]) ), ( (((&((boxes) -> boxes[(i)])) -> imax)[0]) = (((&((hood_boxes) -> boxes[(ilocal)])) -> imax)[0]), (((&((boxes) -> boxes[(i)])) -> imax)[1]) = (((&((hood_boxes) -> boxes[(ilocal)])) -> imax)[1]), (((&((boxes) -> boxes[(i)])) -> imax)[2]) = (((&((hood_boxes) -> boxes[(ilocal)])) -> imax)[2]) ) );
...
# 214 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_grid.c"
int
hypre_StructGridAssemble( hypre_StructGrid *grid )
{
   ...
   if (((grid) -> neighbors) == ((void*)0))
   {
      hypre_MPI_Comm comm = ((grid) -> comm);
      int dim = ((grid) -> dim);
      int *ids;
      hypre_BoxNeighbors *neighbors;
      hypre_Box *bounding_box;
      ...
      all_ids = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (((all_boxes) -> size)))) );
      for (i = 0; i < ((all_boxes) -> size); i++)
         {
            all_ids[i] = i;
         }
      ...
      ids = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (((boxes) -> size)))) );
   ...
   hypre_BoxNeighborsAssemble(((grid) -> neighbors),
                              ((grid) -> max_distance), prune);
...
int
hypre_GatherAllBoxes(hypre_MPI_Comm comm,
                     hypre_BoxArray *boxes,
                     ...
                     int *first_local_ptr)
{
   ...
   recvcounts = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * ((num_all_procs)))) );
   displs = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_all_procs))) );
   hypre_MPI_Allgather(&sendcount, 1, 1,
                 recvcounts, 1, 1, comm);
   displs[0] = 0;
   ...
   sendbuf = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (sendcount))) );
   recvbuf = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * ((recvbuf_size)))) );
   ...
   hypre_MPI_Allgatherv(sendbuf, sendcount, 1,
                  recvbuf, recvcounts, displs, 1, comm);
# 405 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_grid.c"
   all_boxes_size = recvbuf_size / 7;
   all_boxes = hypre_BoxArrayCreate(all_boxes_size);
   all_procs = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (all_boxes_size))) );
   first_local = -1;
   i = 0;
   p = 0;
   ab = 0;
   ...
   while (i < recvbuf_size)
   {
      ...
      ( ( (((&((all_boxes) -> boxes[(ab)])) -> imin)[0]) = (((box) -> imin)[0]), (((&((all_boxes) -> boxes[(ab)])) -> imin)[1]) = (((box) -> imin)[1]), (((&((all_boxes) -> boxes[(ab)])) -> imin)[2]) = (((box) -> imin)[2]) ), ( (((&((all_boxes) -> boxes[(ab)])) -> imax)[0]) = (((box) -> imax)[0]), (((&((all_boxes) -> boxes[(ab)])) -> imax)[1]) = (((box) -> imax)[1]), (((&((all_boxes) -> boxes[(ab)])) -> imax)[2]) = (((box) -> imax)[2]) ) );
      ab++;
...
int
hypre_StructGridRead( hypre_MPI_Comm comm,
                      FILE *file,
                      hypre_StructGrid **grid_ptr )
{
   int ierr = 0;
                                  ...
                                  int *num_periodic_ptr )
{
   ...
   int px = (((grid) -> periodic)[0]);
   int py = (((grid) -> periodic)[1]);
   int pz = (((grid) -> periodic)[2]);
   ...
   if( !(i_periodic == 0 && j_periodic == 0 && k_periodic == 0) )
   {
      ...
      num_all = ((all_boxes) -> size);
      new_num_all = num_all * ((1+2*i_periodic) *
                               (1+2*j_periodic) *
                               (1+2*k_periodic));

      new_all_boxes = hypre_BoxArrayCreate(new_num_all);
      new_all_procs = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (new_num_all))) );
      ...
      while (i < num_all)
      {
         ...
         for (i = first_i; i < num_all; i++)
         {
            ...
            ( ( (((&((new_all_boxes) -> boxes[(inew)])) -> imin)[0]) = (((&((all_boxes) -> boxes[(i)])) -> imin)[0]), (((&((new_all_boxes) -> boxes[(inew)])) -> imin)[1]) = (((&((all_boxes) -> boxes[(i)])) -> imin)[1]), (((&((new_all_boxes) -> boxes[(inew)])) -> imin)[2]) = (((&((all_boxes) -> boxes[(i)])) -> imin)[2]) ), ( (((&((new_all_boxes) -> boxes[(inew)])) -> imax)[0]) = (((&((all_boxes) -> boxes[(i)])) -> imax)[0]), (((&((new_all_boxes) -> boxes[(inew)])) -> imax)[1]) = (((&((all_boxes) -> boxes[(i)])) -> imax)[1]), (((&((new_all_boxes) -> boxes[(inew)])) -> imax)[2]) = (((&((all_boxes) -> boxes[(i)])) -> imax)[2]) ) );
            ...
            for (jp = -j_periodic; jp <= j_periodic; jp++)
            {
               for (kp = -k_periodic; kp <= k_periodic; kp++)
               {
                  if( !(ip == 0 && jp == 0 && kp == 0) )
                  {
                     ...
                     {
                        box = &((new_all_boxes) -> boxes[(inew)]);
                        ( ( (((box) -> imin)[0]) = (((&((all_boxes) -> boxes[(i)])) -> imin)[0]), (((box) -> imin)[1]) = (((&((all_boxes) -> boxes[(i)])) -> imin)[1]), (((box) -> imin)[2]) = (((&((all_boxes) -> boxes[(i)])) -> imin)[2]) ), ( (((box) -> imax)[0]) = (((&((all_boxes) -> boxes[(i)])) -> imax)[0]), (((box) -> imax)[1]) = (((&((all_boxes) -> boxes[(i)])) -> imax)[1]), (((box) -> imax)[2]) = (((&((all_boxes) -> boxes[(i)])) -> imax)[2]) ) );
      ...
      ( hypre_Free((char *)all_procs), all_procs = ((void*)0) );
