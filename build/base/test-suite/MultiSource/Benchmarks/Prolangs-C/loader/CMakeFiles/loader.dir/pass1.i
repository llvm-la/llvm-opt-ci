# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
typedef int BOOLEAN;
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass1.c" 2
...
void PASS1(SYMBOL_TABLE *SYM_TAB,int *LOCATION,int *ERROR,FILE *INPUT)
{
 ...
 if (!INSERT_IN_SYM_TAB("_GLOBAL ",MODULE_NAME,*LOCATION,MODULE,
          SYM_TAB)) {
   int I;

   for (I=8 -1; ( (I<1) || (MODULE_NAME[I] == ' ')); I--);
   MODULE_NAME[I+1] = '\0';
   (void) printf(
  "ERROR: Multiply defined global %s. Program not loaded.\n",
   ...
   (*LOCATION) += TEMP_LOC;
   (*LOOK_UP_SYMBOL("_GLOBAL ",MODULE_NAME,SYM_TAB)).LENGTH =
     TEMP_LOC;
 }
      }
 ...
 (void) printf("ERROR: Illegal header record = %s\n",RECORD);
    ...
    case 'D':
      ...
      if (strlen(RECORD) > 71) LOCAL_ERROR = 1;
 else {
   int NEXT = 1;
   char TEMP_NAME[8 +1];
   int TEMP_LOC;
   ...
   while (NEXT + 14 <= strlen(RECORD)) {
     ...
     STR_TO_NUM(&(RECORD[NEXT+8]),6,16,&TEMP_LOC,
         &LOCAL_ERROR);
     if (!INSERT_IN_SYM_TAB("_GLOBAL ",TEMP_NAME
