# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
typedef int BOOLEAN;
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/stringI.h" 1
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/stringI.h"
extern void GET_LINE();
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/load.h" 1
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/loader/pass2.c" 2
...
void PASS2(MEM_SPACE MEMORY,SYMBOL_TABLE *SYM_TAB,int *LOCATION,int *ERROR,
           FILE *INPUT)
{
  char MODULE_NAME[8 +1];


  char *RECORD;
  int UNREL_LOCATION;

  int UNREL_TO_REL_SHIFT = 0;
  ...
  while (!feof(INPUT) && ((*LOCATION) <= 1048576)) {
    BOOLEAN LOCAL_ERROR;
 ...
 if (strlen(RECORD) != 9+LENGTH*2) LOCAL_ERROR = 1;
 ...
 (void) printf("ERROR: Illegal text record = %s\n",RECORD);
    ...
    case 'H':
      ...
      if (strlen(RECORD) != (13 + 8))
 LOCAL_ERROR = 1;
      else {
 int TEMP_LOC;

 (void) strncpy(MODULE_NAME,&(RECORD[1]),8);
 ...
 if ((*LOCATION) > 1048576)
   (void) printf("ERROR: Program does not fit in memory. Aborting.\n");
    ...
    case 'M':
      if (strlen(RECORD) < 9) LOCAL_ERROR = 1;
 ...
 if (strlen(RECORD) != 18) LOCAL_ERROR = 1;
   else {
     ...
     SYMBOL = LOOK_UP_SYMBOL("_GLOBAL ",&(RECORD[10]),SYM_TAB);
     if (SYMBOL == ((void*)0)) LOCAL_ERROR = 1;
 ...
 (void) printf("ERROR: Illegal text record = %s\n",RECORD);
    ...
    case 'R':
      ...
      if (strlen(RECORD) > 73) LOCAL_ERROR = 1;
 else {
   int NEXT = 1;
   char TEMP_NAME[8 +1];

   TEMP_NAME[8] = '\0';
   while (NEXT + 8 <= strlen(RECORD)) {
     (void) strncpy(TEMP_NAME,&(RECORD[NEXT]),8);
     if (LOOK_UP_SYMBOL("_GLOBAL ",TEMP_NAME, SYM_TAB) == ((void*)0)) {
       int I;

       (void) INSERT_IN_SYM_TAB("_GLOBAL ",TEMP_NAME,0,UNDEFINED,SYM_TAB);
       for (I=8 -1; ( (I<1) || (TEMP_NAME[I] == ' ')); I--);
       TEMP_NAME[I+1] = '\0';
       (void) printf(
   ...
   if (NEXT != strlen(RECORD)) LOCAL_ERROR = 1;
 }
