# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c"
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
...
typedef int BOOLEAN;
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/debugger.h" 1
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/debugger.h" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
...
extern void EXEC();
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/convert.h" 1
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/convert.h"
extern int eoln();
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/convert.h"
extern void NUM_TO_STR();
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/convert.h"
extern int GET_NUM();
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/convert.h"
extern void STR_TO_NUM();
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.h" 1
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.h"
extern int FORMAT2();
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.h"
extern int FORMAT3_4();
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/interupt.h" 1
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/interupt.h"
extern void SIGNAL_INTERUPT();
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct2.c" 2
     ...
     BOOLEAN PRINT_EFFECT;
{
 ...
 ( (REG2 >=0 ) && (REG2 < 10)) )) {
    ...
    if (REGISTER[REG1] >= 16777216 / 2) REG1_SIGN = -1;
    if (REGISTER[REG2] >= 16777216 / 2) REG2_SIGN = -1;

    if ((REG2_SIGN == 1) && (REG1_SIGN == 1)) {
      REGISTER[REG2] = REGISTER[REG2] + REGISTER[REG1];
      if (REGISTER[REG2] >= 16777216 / 2) OVERFLOW1 = 1;
    }
    if ((REG2_SIGN == -1) && (REG1_SIGN == 1)) {
      REGISTER[REG2] = REGISTER[REG2] + REGISTER[REG1];
      REGISTER[REG2] = REGISTER[REG2] -
 ((int) REGISTER[REG2] / 16777216) * 16777216;
    }
    if ((REG2_SIGN == 1) && (REG1_SIGN == -1)) {
      REGISTER[REG2] = REGISTER[REG2] + REGISTER[REG1];
      REGISTER[REG2] = REGISTER[REG2] -
...

{
  ...
  if (REGISTER[REG1] >= 16777216 / 2) REG1_VAL = REGISTER[REG1] - 16777216;
  else REG1_VAL = REGISTER[REG1];

  if (REGISTER[REG1] >= 16777216 / 2) REG2_VAL = REGISTER[REG2] - 16777216;
     ...
     BOOLEAN PRINT_EFFECT;
{
 ...
 ( (REG2 >=0 ) && (REG2 < 10)) )) {
    ...
    if ((REG2_SIGN == 1) && (REG1_SIGN == 1))
      REGISTER[REG2] = REGISTER[REG2] / REGISTER[REG1];
    if ((REG2_SIGN == -1) && (REG1_SIGN == 1))
      REGISTER[REG2] = 16777216 -
 ((16777216 - REGISTER[REG2]) / REGISTER[REG1]);
    if ((REG2_SIGN == 1) && (REG1_SIGN == -1))
      REGISTER[REG2] = 16777216 -
 (REGISTER[REG2] / (16777216 - REGISTER[REG1]));
    if ((REG2_SIGN == -1) && (REG1_SIGN == -1))
      REGISTER[REG2] = (16777216 - REGISTER[REG2]) /
 (16777216 - REGISTER[REG1]);
  }
     ...
     BOOLEAN PRINT_EFFECT;
{
 ...
 ( (REG2 >=0 ) && (REG2 < 10)) )) {
    ...
    if ((REG2_SIGN == 1) && (REG1_SIGN == 1)) {
      ...
      if (STORE_VALUE >= 16777216 / 2) OVERFLOW1 = 1;
      else REGISTER[REG2] = (int) STORE_VALUE;
    }
    if ((REG2_SIGN == -1) && (REG1_SIGN == 1)) {
      STORE_VALUE = 1.0 * (16777216 - REGISTER[REG2]) * REGISTER[REG1];
      STORE_VALUE = STORE_VALUE - ((int)(STORE_VALUE / 16777216)) * 16777216;
      if (STORE_VALUE >= 16777216 / 2) OVERFLOW1 = 1;
      else REGISTER[REG2] = 16777216 - (int) STORE_VALUE;
    }
    if ((REG2_SIGN == 1) && (REG1_SIGN == -1)) {
      STORE_VALUE = 1.0 * REGISTER[REG2] * (16777216 - REGISTER[REG1]);
      STORE_VALUE = STORE_VALUE - ((int)(STORE_VALUE / 16777216)) * 16777216;
      if (STORE_VALUE >= 16777216 / 2) OVERFLOW1 = 1;
      else REGISTER[REG2] = 16777216 - (int) STORE_VALUE;
    }
    if ((REG2_SIGN == -1) && (REG1_SIGN == -1)) {
      STORE_VALUE = 1.0 * (16777216 - REGISTER[REG2]) *
 (16777216 - REGISTER[REG1]);
      if (STORE_VALUE >= 16777216 / 2) OVERFLOW1 = 1;
      else REGISTER[REG2] = (int) STORE_VALUE;
    }
     ...
     BOOLEAN PRINT_EFFECT;
{
  ...
  FORMAT2(&REG1,&REG2);
  if (!( (REG1 >=0 ) && (REG1 < 10))) SIGNAL_INTERUPT(2,00);
  else {
    int LOOP;
    int REG_BITS[24];
    int SHIFTED_BITS[24];
    ...
    for (LOOP = 0; LOOP < 24; LOOP ++)
      SHIFTED_BITS[LOOP] = REG_BITS[MOD(LOOP+REG2+1,24)];

    REGISTER[REG1] = BITS_TO_BYTE(SHIFTED_BITS,24);
     ...
     BOOLEAN PRINT_EFFECT;
{
 ...
 ( (REG2 >=0 ) && (REG2 < 10)) )) {
    ...
    if ((REG2_SIGN == 1) && (REG1_SIGN == 1)) {
      REGISTER[REG2] = REGISTER[REG2] + (16777216 - REGISTER[REG1]);
      REGISTER[REG2] = REGISTER[REG2] -
 ((int) REGISTER[REG2] / 16777216) * 16777216;
    }
    if ((REG2_SIGN == -1) && (REG1_SIGN == 1)) {
     ...
     BOOLEAN PRINT_EFFECT;
{
  ...
  if (!( (REG1 >=0 ) && (REG1 < 10)))
    ...
    REGISTER[1] ++;
    REGISTER[1] = REGISTER[1] - ((int) REGISTER[1] / 16777216) * 16777216;

    if (REGISTER[1] == 16777216 / 2) {
      SIGNAL_INTERUPT(2,04);
      if (PRINT_EFFECT) (void) printf("X has overflowed.\n");
      return;
    }

    if (REGISTER[1] >= 16777216 / 2) X_VAL = REGISTER[1] - 16777216;
    else X_VAL = REGISTER[1];

    REG_VAL = REGISTER[REG1];

    if (REG_VAL >= 16777216 / 2) REG_VAL = REG_VAL - 16777216;

    if (X_VAL == REG_VAL) {
      SET_CC(0);
      if (PRINT_EFFECT)
 PRINT_CONSTANT("Set X to ",REGISTER[1]," and set CC to =.\n");
    }
    if (X_VAL < REG_VAL) {
      SET_CC(1);
      if (PRINT_EFFECT)
