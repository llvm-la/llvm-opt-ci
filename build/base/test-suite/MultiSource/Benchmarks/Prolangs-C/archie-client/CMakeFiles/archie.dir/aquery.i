# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
...
void stfree();
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c" 2
...
extern int pwarn;
extern char p_warn_string[];
# 75 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c"
...
VLINK archie_query(char *host,char *string,int max_hits,int offset,
 ...
 if (cmp_proc == ((void*)0)) cmp_proc = defcmplink;
 ...
 if((tmp = get_vdir(host,qstring,"",dir,32|64,((void*)0),((void*)0)))) {
 ...
 links = dir->links; dir->links = ((void*)0);
 ...
 for (p = links; p != ((void*)0); p = nextp) {
     nextp = p->next;
     if (p->replicas != ((void*)0)) {
  p->next = p->replicas;
  p->next->previous = p;
  for (r = p->replicas; r->next != ((void*)0); r = r->next)
                ;
  r->next = nextp;
  nextp->previous = r;
  p->replicas = ((void*)0);
 ...
 for (p = links; p != ((void*)0); p = nextp) {
     nextp = p->next;
     lowest = p;
     for (q = p->next; q != ((void*)0); q = q->next)
...
# 219 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c"
...
# 238 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/aquery.c"
