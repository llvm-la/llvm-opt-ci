# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/compiler/lexer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/compiler/lexer.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/compiler/lexer.c" 2
...
int lexan(void)
{
  ...
  while (1)
  {
    ...
    else if (((*__ctype_b_loc ())[(int) ((t))] & (unsigned short int) _ISdigit) || t == '.' )
      return (Number(t));

    else if ( ((*__ctype_b_loc ())[(int) ((t))] & (unsigned short int) _ISalpha) || t == '_')
...
int Indentifier(int t)
{
  ...
  if (((*__ctype_b_loc ())[(int) ((t))] & (unsigned short int) _ISalpha))
  {
    lexbuf[b] = t;
    ++b;
    t = getc(stdin);
  ...
  while (((*__ctype_b_loc ())[(int) ((t))] & (unsigned short int) _ISalpha) || ((*__ctype_b_loc ())[(int) ((t))] & (unsigned short int) _ISdigit) || t == '_')
  {
    lexbuf[b] = t;
    ++b;
    t = getc(stdin);
...
int Number(int t)
{
  ...
  if (((*__ctype_b_loc ())[(int) ((t))] & (unsigned short int) _ISdigit))
  {
    (void) ungetc(t, stdin);
  ...
  {
    t = getc(stdin);
    if ((t == '+') || (t == '-') || (((*__ctype_b_loc ())[(int) ((t))] & (unsigned short int) _ISdigit)))
    {
      (void) ungetc(t, stdin);
      scanf("%d", &Exponent);
      t = getc(stdin);
