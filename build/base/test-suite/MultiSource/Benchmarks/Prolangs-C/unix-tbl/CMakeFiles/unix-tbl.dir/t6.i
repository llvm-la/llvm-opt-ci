# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t6.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t6.c" 2
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t..c" 1
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t..c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t..c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t..c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t..c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t..c"
extern int nlin, ncol, iline, nclin, nslin;
extern int style[100][20];
extern int ctop[100][20];
extern char font[100][20][2];
extern char csize[100][20][4];
extern char vsize[100][20][4];
extern char cll[20][10];
extern int stynum[];
extern int F1, F2;
extern int lefline[100][20];
extern int fullbot[];
extern char *instead[];
extern int expflg;
extern int ctrflg;
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t6.c" 2
...
for(icol=0; icol <ncol; icol++)
   ...
   case 'n':
    if (table[ilin][icol].rcol!=0)
     ...
     if (real(s=table[ilin][icol].col) && !vspen(s))
      {
      if ((((int)s)>0 && ((int)s)<128) != text) continue;
      fprintf(tabout, ".nr %d ", 38);
      wide(s, font[stynum[vforml]][icol], csize[stynum[vforml]][icol]); fprintf(tabout, "\n");
      fprintf(tabout, ".if \\n(%d<\\n(%d .nr %d \\n(%d\n", 31, 38, 31, 38);
      }
 ...
 if (acase[icol])
  {
  fprintf(tabout, ".if \\n(%d>=\\n(%d .nr %d \\n(%du+2n\n",32,icol+80,icol+80,32);
  }
 if (doubled[icol])
  {
  fprintf(tabout, ".nr %d \\n(%d\n", icol+60, 31);
  fprintf(tabout, ".nr %d \\n(%d+\\n(%d\n",38,icol+60,32);
  fprintf(tabout, ".if \\n(%d>\\n(%d .nr %d \\n(%d\n",38,icol+80,icol+80,38);
  fprintf(tabout, ".if \\n(%d<\\n(%d .nr %d +(\\n(%d-\\n(%d)/2\n",38,icol+80,icol+60,icol+80,38);
  }
 if (cll[icol][0])
  {
 ...
 if (k=lspan(ilin, icol))
  ...
  fprintf(tabout, ".nr %d ", 38);
  wide(table[ilin][icol-k].col, font[stynum[ilin]][icol-k], csize[stynum[ilin]][icol-k]);
  for(ik=k; ik>=0; ik--)
   {
   fprintf(tabout, "-\\n(%d",80 +icol-ik);
