# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tu.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tu.c" 2
...
for(ln=oldpos=0; ln<lcount; ln++)
 ...
 if (lcount>1)
  ...
  switch(interv(i,cl))
   {
   case 1: exhl = ln==0 ? "1p" : "-1p"; break;
   case 2: exhl = ln==1 ? "1p" : "-1p"; break;
   case 3: exhl = "1p"; break;
   }
  if (exhl[0])
 ...
 if (lcount>1)
  ...
  switch(interv(i,cr+1))
   {
   case 1: exhr = ln==0 ? "-1p" : "+1p"; break;
   case 2: exhr = ln==1 ? "-1p" : "+1p"; break;
   case 3: exhr = "-1p"; break;
   }
  }
 else if (lcount==1)
  {
