# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tb.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tb.c" 2
...
spvecs[spcount++]= pp = calloc(2000 +200,1);
...
{
int *tp, *q;
if (tpcount<0 || thisvec+n > tpvecs[tpcount]+2000)
 {
 tpcount++;
 if (tpvecs[tpcount]==0)
  {
  tpvecs[tpcount] = calloc(2000,1);
  }
