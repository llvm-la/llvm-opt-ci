# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getpath.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getpath.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getpath.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getpath.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getpath.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getpath.c" 2
...
if (debug==YES) (void) printf("getpath: looking for '%s'\n", key);

 if(pathlength == 0) {
  if((file = fopen(pathfile, "r")) == ((void*)0)) {
 ...
 *path = '\0';
 ...
 if(c == '\t') {
  int tcost = -1;
  while(((c = getc(file)) != (-1)) && ((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISdigit)) {
   if(tcost < 0) tcost = 0;
   tcost *= 10;
   tcost += c - '0';
  }
