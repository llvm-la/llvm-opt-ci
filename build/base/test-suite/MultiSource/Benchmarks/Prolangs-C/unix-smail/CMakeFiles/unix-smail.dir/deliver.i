# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c" 2

extern int exitstat;
extern enum edebug debug;
extern char hostname[];
extern char hostdomain[];
extern enum ehandle handle;
extern enum erouting routing;
extern char *uuxargs;
extern int queuecost;
extern int maxnoqueue;
extern char *spoolfile;
extern FILE *spoolfp;
extern int spoolmaster;
extern char nows[];
...
int islocal();
int strcmpic();
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c"
             ...
             int costv[])
{
  ...
  *lend = *rend = *send = '\0';
  ...
  (void) sprintf(lcommand, "/bin/lmail");
  (void) sprintf(rcommand, "%s -a%s %s - %s!rmail","/usr/bin/uux",from,flags,hostv[i]);
# 165 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c"
  for (j = i; j < argc; j++) {
          int tmp1,tmp2;
   if ((formv[j] != form)
    || (strcmpic(hostv[i], hostv[j]) != 0)
    || ((tmp1 = (lend - lcommand)) > 128)
    || ((tmp2 = (rend - rcommand)) > 128)) {
    continue;
   }
   ...
   (void) sprintf(send, "%s %s %s -f %s ", "/bin/smail", ((debug == VERBOSE)?"-v":""), sflag, spoolfile);
   send += strlen(send);
   ...
   if (form == LOCAL) {
    (void) sprintf(lend, " '%s'",postmaster(userv[j]));
    (void) sprintf(send, " '%s'",postmaster(userv[j]));
   } else {
    (void) sprintf(lend, " '%s!%s'",hostv[i],userv[j]);
    (void) sprintf(send, " '%s!%s'",hostv[i],userv[j]);
   }

   (void) sprintf(rend, " '(%s)'",userv[j]);
   formv[j] = SENT;
  }
retry:
  ...
  if (debug!=NO) (void) printf("COMMAND: %s\n", command);
# 245 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c"
...
# 310 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c"
  {
   (void) sprintf(buf,
    "Received: by %s (%s)\n\tid AA%05d; %s\n",
     hostdomain, "smail2.5",
  ...
  while(fgets(buf, sizeof(buf), spoolfp) != ((void*)0)) {
   (void) fputs(buf, out);
  }
  ...
  if (debug != YES) {
   ...
   if(exitstat != 0) {
    ...
    && (form != LOCAL)) {
     ...
     if (debug!=NO) (void) printf("%s failed (%d)\ntrying %s\n",
    ...
    if((routing == REROUTE)
     ...
     (void) fseek(spoolfp, message, 0);
# 386 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c"
     {
...
# 411 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/deliver.c"
 (void) fclose(spoolfp);
 if(spoolmaster) {
...
void return_mail(char *from,char *fcommand)
{
 ...
 (void) sprintf(r, "%s %s", "/bin/smail", ((debug == VERBOSE)?"-v":""));
 r += strlen(r);

 if(islocal(from, domain, user)) {
  (void) sprintf(r, " '%s'",postmaster(user));
 } else {
  (void) sprintf(r, " '%s!%s'",domain,user);
 }
 ...
 (void) fflush(stderr);
 if((fp = fopen(stderrfile, "r")) != ((void*)0)) {
