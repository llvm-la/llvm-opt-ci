# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c" 2
...
int isuucp();
int getpath();
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
...
{ UUCP, UUCP, LOCAL },
{ ERROR, ERROR, ERROR }};
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
enum eform resolve(char *address,char *domain,char *user ,int *cost)
{
 ...
 char temp[512];
 int i;
# 78 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
 if ((routing == REROUTE) && (table[(int)UUCP][(int)handle] == UUCP)) {
...
if (debug==YES) (void) printf("resolve: parse address '%s' = '%s' @ '%s' (%s)\n",
 temp,user,domain,sform(form));
  ...
  if((table[(int)form][(int)handle] == ROUTE)
   ||((table[(int)form][(int)handle] == UUCP) && (routing != JUSTDOMAIN ))) {
   ...
   if(route(domain,user,look_smart,temp,cost) != 0) {
    continue;
...
if (debug==YES) (void) printf("resolve: parse route '%s' = '%s' @ '%s' (%s)\n",
 temp,user,domain,sform(form));

  } else if((getcost) && (table[(int)form][(int)handle] == UUCP)) {
   ...
   char junk[512];
   if(route(domain,user,0,junk,cost) != 0) {
    continue;
 ...
 if ((table[(int)form][(int)handle] == LOCAL) && (form != LOCAL )) {
 ...
 if ((form == ERROR) || (table[(int)form][(int)handle] == ROUTE )) {
  exitstat = 68;
  if (debug!=NO) (void) printf("resolve failed '%s' = '%s' @ '%s' (%s)\n",
   address, user, domain, sform(form));
  form = ERROR;
 } else {
  if (debug!=NO) (void) printf("resolve '%s' = '%s' @ '%s' (%s)\n",
   address, user, domain, sform(form));
 }
 return ( form );
}
# 183 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
int route(char *domain,char *user,int look_smart,char *result,int *cost)
{
 int uucpdom = 0;
 int domains, step;
 char *domainv[16];
 char temp[512], path[512];
...
# 206 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
 if((strcmpic(domain, hostname) == 0)
 || (strcmpic(domain, hostdomain) == 0)) {
  step = 0;
  *cost = 0;
  (void) strcpy(path, "%s");
if (debug==YES) (void) printf("route: '%s' is local\n", domain);
  goto route_complete;
 }
...
# 231 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
 for(step = 0; (step < domains); step++) {
  if((getpath(domainv[step]-1, path, cost) == 0)
  || (getpath(domainv[step] , path, cost) == 0))
   break;
 }
 ...
 if(step == domains) {
  ...
  if((uucpdom == 0) || (getpath(".UUCP", path, cost) != 0)) {
   ...
   if((look_smart == 0)
   || (getpath("smart-host", path, cost) != 0)) {




    if (debug==YES) (void) printf("route '%s' failed\n", domain);
    return( 68 );
   }
  }
 }
