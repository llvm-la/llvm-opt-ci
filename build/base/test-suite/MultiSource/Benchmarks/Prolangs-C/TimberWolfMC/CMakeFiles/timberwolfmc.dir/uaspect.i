# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uaspect.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uaspect.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uaspect.c" 2
...
Hdiv2 = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) / 2 ;
val = (double)(oright - oleft) / aspFactor ;
Wdiv2 = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) / 2 ;
...
for( termptr = atermptr ; termptr != (TERMBOXPTR) ((void*)0) ; termptr =
      termptr->nextterm ) {
    val = (double)(termptr->oxpos - oleft) / aspFactor ;
    x = axcenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2 ;
    val = (double)(termptr->oypos - obottom) * aspFactor ;
    y = aycenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2 ;
...
if( ( cost + newpenalty <= funccost + penalty ) ||
 ...
 T) > ( (double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) / (double)0x7fffffff ) ) ) {
...
# 117 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uaspect.c"
    for( tileptr1 = atileptr ; tileptr1 != (TILEBOXPTR) ((void*)0) ;
       tileptr1 = tileptr1->nexttile ){
 val = (double)(tileptr1->oleft - oleft) / aspFactor ;
 tileptr1->left = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2 ;
 val = (double)(tileptr1->oright - oleft) / aspFactor ;
 tileptr1->right = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2 ;
 val = (double)(tileptr1->obottom - obottom) * aspFactor ;
 tileptr1->bottom = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2 ;
 val = (double)(tileptr1->otop - obottom) * aspFactor ;
 tileptr1->top = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2 ;
    }

    for( termptr = atermptr ; termptr != (TERMBOXPTR) ((void*)0) ; termptr =
         termptr->nextterm ) {
 val = (double)(termptr->oxpos - oleft) / aspFactor ;
 termptr->xpos = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2 ;
 val = (double)(termptr->oypos - obottom) * aspFactor ;
 termptr->ypos = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2 ;
    }
    for( site = 1 ; site <= acellptr->numsites ; site++ ) {
 val = (double)(SLptr[ site ].oxpos - oleft) / aspFactor ;
 SLptr[site].xpos = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2 ;
 val = (double)(SLptr[ site ].oypos - obottom) * aspFactor ;
 SLptr[site].ypos = ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2 ;
   }
