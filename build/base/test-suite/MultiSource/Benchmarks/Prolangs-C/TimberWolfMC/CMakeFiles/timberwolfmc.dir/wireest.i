# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/wireest.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/wireest.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/wireest.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/wireest.c" 2
...
if( yy2 >= blockmy && yy1 <= blockmy ) {
    y = (blockt - blockb) / 2 ;
} else if( ( (yy1 - blockmy)>=0 ? (yy1 - blockmy) : -(yy1 - blockmy) ) <= ( (yy2 - blockmy)>=0 ? (yy2 - blockmy) : -(yy2 - blockmy) ) ) {
    y = blockt - yy1 ;
    if( y < 0 ) {
 y = 0 ;
    }
...
if( xx2 >= blockmx && xx1 <= blockmx ) {
    x = (blockr - blockl) / 2 ;
} else if( ( (xx1 - blockmx)>=0 ? (xx1 - blockmx) : -(xx1 - blockmx) ) <= ( (xx2 - blockmx)>=0 ? (xx2 - blockmx) : -(xx2 - blockmx) ) ) {
    x = blockr - xx1 ;
    if( x < 0 ) {
 x = 0 ;
    }
