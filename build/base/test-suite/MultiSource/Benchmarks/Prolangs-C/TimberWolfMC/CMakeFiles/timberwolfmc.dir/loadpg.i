# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadpg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadpg.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadpg.c" 2
...
for( i = 1 ; i <= totalnodes ; i++ ) {
 ...
 pnodeArray[savepnode].equiv->node = i ;
    ...
    gnodeArray[pnode]->next->next = (GNODEPTR) ((void*)0) ;
...
for( i = 1 ; i <= totalnodes ; i++ ) {
    ...
    for( ; gptr != (GNODEPTR) ((void*)0) ; gptr = (gptr ? gptr->next : gptr)) {
 pnode2 = gptr->node ;
 j = pnode2 - numnodes ;
...
count = 0 ;
for( gptr = gptr1 ; gptr != (GNODEPTR) ((void*)0) ; gptr = gptr->next ) {
    if( gptr->length >= 1000000000 ) {
 continue ;
    }
    count++ ;
