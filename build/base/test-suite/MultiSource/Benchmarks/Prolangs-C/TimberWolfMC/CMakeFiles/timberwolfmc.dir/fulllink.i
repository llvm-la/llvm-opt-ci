# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fulllink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fulllink.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fulllink.c" 2
...
Hlist->prev = (DLINK1PTR) ((void*)0) ;
Hlist->next->next = (DLINK1PTR) ((void*)0) ;
...
Vlist->prev = (DLINK1PTR) ((void*)0) ;
Vlist->next->next = (DLINK1PTR) ((void*)0) ;
...
Vroot = (TNODEPTR) ((void*)0) ;
Vptrs = (DLINK1PTR *) malloc( 100 * sizeof(DLINK1PTR) ) ;
count = 0 ;

last = -1000000 ;
for( vptr = Vlist ; vptr != (DLINK1PTR) ((void*)0) ; vptr = vptr->next ) {
    edge = vptr->edge ;
