# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadbins.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadbins.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadbins.c" 2
...
if( new ) {
    ...
    ptr = cellarray[ numcells + numpads + ++i ] = ( (CELLBOX *) malloc ( sizeof(CELLBOX) ) ) ;
    ...
    tptr = ptr->config[0] = ( (TILEBOX *) malloc ( sizeof(TILEBOX) ) ) ;
    tptr->termptr = (TERMBOXPTR) ((void*)0) ;
    tptr->nexttile = ( (TILEBOX *) malloc ( sizeof(TILEBOX) ) ) ;

    tptr->nexttile->nexttile = (TILEBOXPTR) ((void*)0) ;
    tptr->nexttile->termptr = (TERMBOXPTR) ((void*)0) ;

    for( j = 1 ; j < 8 ; j++ ) {
 ptr->config[ j ] = (TILEBOXPTR) ((void*)0) ;
    }
