# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/hash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/hash.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/hash.c" 2
...
for( i = 0 ; i < 1009 ; i++ ) {
    hptr = hashtab[i] ;
    if( hptr != (HASHPTR) ((void*)0) ) {
 zapptr = hptr ;
 while( hptr->hnext != (HASHPTR) ((void*)0) ) {
     hptr = hptr->hnext ;
     free( zapptr ) ;
     zapptr = hptr ;
 }
...
hsum %= 1009 ;
if( (hptr = hashtab[hsum]) == (HASHPTR) ((void*)0) ) {
    hptr = hashtab[hsum] = (HASHPTR) malloc( sizeof( HASHBOX ) ) ;
    hptr->hnext = (HASHPTR) ((void*)0) ;
    hptr->hnum = ++netctr ;
