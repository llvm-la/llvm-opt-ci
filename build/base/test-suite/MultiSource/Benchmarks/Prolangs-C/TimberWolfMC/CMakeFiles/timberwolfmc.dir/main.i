# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/main.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/main.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/main.c" 2
double spot_control ;
int spotPenalty ;
int spotXhash ;
int spotYhash ;
...
if( (fpo = fopen( filename , "w")) == (FILE *) ((void*)0) ) {
    printf("can't open %s\n", filename ) ;
    exit (0);
}
...
# 192 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/main.c"
    fprintf(fpo,"bdxlength:%d    bdylength:%d\n",bdxlength,bdylength);
    funccost = findcost() ;
    fprintf(fpo,"\n\n\n");
...
for( x = 0 ; x < numXspots ; x++ ) {
 ...
 spotPenalty += (int)(spot_control *
  ((double)(( (spots[x][y] - 1)>=0 ? (spots[x][y] - 1) : -(spots[x][y] - 1) ))) * ((double)(spotSize)));
    }
}
