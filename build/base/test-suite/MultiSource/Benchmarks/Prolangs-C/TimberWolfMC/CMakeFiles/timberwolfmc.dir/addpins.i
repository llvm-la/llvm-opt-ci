# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/addpins.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/addpins.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/addpins.c" 2
...
for( i = 1 + numnets ; i <= numnets + extraNets ; i++ ) {
    ...
    dimptr->netptr = (NETBOXPTR) ((void*)0) ;
    dimptr->nname = ((void*)0) ;
    dimptr->skip = 0 ;
    dimptr->flag = 0 ;
    dimptr->xmin = 0 ;
...
for( cell = 1 ; cell <= numcells ; cell++ ) {
    ...
    netptr->nextterm = (NETBOXPTR) ((void*)0) ;
    termarray[netptr->terminal]->net = numnets + cell ;
    termarray[netptr->terminal]->termptr = netptr ;
}
...
for( pin = 1 + maxterm ; pin <= maxterm + 2 * extraNets ; pin++ ) {
    termarray[pin] = (TERMNETSPTR) ((void*)0) ;
}
