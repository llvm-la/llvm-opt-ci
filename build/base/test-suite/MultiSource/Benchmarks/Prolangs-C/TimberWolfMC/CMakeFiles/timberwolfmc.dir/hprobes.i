# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/hprobes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/hprobes.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/hprobes.c" 2
...
downPtr = vFixedList ;
for( ; downPtr != (DLINK1PTR) ((void*)0) ; downPtr = downPtr->next ) {
    dedge = downPtr->edge ;
 ...
 for(; up2ptr != (DLINK1PTR) ((void*)0) ; up2ptr = up2ptr->next){
     uedge = up2ptr->edge ;
 ...
 up2ptr = (DLINK1PTR) ((void*)0) ;
    }
    if( edgeList[ edgeList[dedge].nextEdge ].UorR == -1 ) {
 up1ptr = Vptrs[ tprop( Vroot , dx ) ] ;
 for(; up1ptr != (DLINK1PTR) ((void*)0) ; up1ptr = up1ptr->next){
     uedge = up1ptr->edge ;
     if( edgeList[uedge].UorR < 0 ) {
  continue ;
     }
 ...
 up1ptr = (DLINK1PTR) ((void*)0) ;
    }
    if( up2ptr != (DLINK1PTR) ((void*)0) && up2ptr == up1ptr ) {
 check = 1 ;
