# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/perimeter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/perimeter.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/perimeter.c" 2
extern BUSTBOXPTR A ;
...
for( i = 1 ; i <= A[0].xc ; i++ ) {
    if( i == A[0].xc ) {
 sum += ( (A[1].xc - A[i].xc)>=0 ? (A[1].xc - A[i].xc) : -(A[1].xc - A[i].xc) ) + ( (A[1].yc - A[i].yc)>=0 ? (A[1].yc - A[i].yc) : -(A[1].yc - A[i].yc) ) ;
    } else {
 sum += ( (A[i + 1].xc - A[i].xc)>=0 ? (A[i + 1].xc - A[i].xc) : -(A[i + 1].xc - A[i].xc) ) + ( (A[i + 1].yc - A[i].yc)>=0 ? (A[i + 1].yc - A[i].yc) : -(A[i + 1].yc - A[i].yc) ) ;
    }
}
return( sum ) ;
}
