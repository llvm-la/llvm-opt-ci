# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/doborder.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/doborder.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/doborder.c" 2
...
extern FILE *fpdebug ;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/doborder.c" 2
extern int numberCells ;
...
for( cell = 1 ; cell <= numcells ; cell++ ) {
    ...
    for( ; tileptr != (TILEBOXPTR) ((void*)0) ; tileptr = tileptr->nexttile ) {
 ...
 for( ; tptr != (TILEBOXPTR) ((void*)0) ; tptr = tptr->nexttile ,
...
extraSpace = 0 ;
for( clptr = cellList[c]; clptr != (CLBOXPTR) ((void*)0); clptr = clptr->next){
