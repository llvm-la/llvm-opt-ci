# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/findside.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/findside.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/findside.c" 2
...
for( k = 1 ; k <= cellptr->numsides ; k++ ) {
 ...
 if( ( (x - pSideArray[k].position)>=0 ? (x - pSideArray[k].position) : -(x - pSideArray[k].position) ) < min ) {
     min = ( (x - pSideArray[k].position)>=0 ? (x - pSideArray[k].position) : -(x - pSideArray[k].position) ) ;
     kmin = k ;
 }
    } else {
 if( ( (y - pSideArray[k].position)>=0 ? (y - pSideArray[k].position) : -(y - pSideArray[k].position) ) < min ) {
     min = ( (y - pSideArray[k].position)>=0 ? (y - pSideArray[k].position) : -(y - pSideArray[k].position) ) ;
     kmin = k ;
 }
    }
}
