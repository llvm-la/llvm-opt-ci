# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/readpnode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/readpnode.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/readpnode.c" 2
int pnodeAlength ;
...
for( i = 1 ; i <= largestNet ; i++ ) {
 ...
 netRoutes[i].alternate[j]->pinList = (int *) ((void*)0) ;
 netRoutes[i].alternate[j]->chanList = (CHANBOXPTR) ((void*)0) ;
    }
}
...
for( i = 1 ; i <= numpins ; i++ ) {
    pnameArray[i] = (char *) ((void*)0) ;
}

nnameArray = (char **) malloc( (1 + net) * sizeof( char *) ) ;
for( i = 1 ; i <= net ; i++ ) {
    nnameArray[i] = (char *) ((void*)0) ;
}
 ...
 if( net > 0 ) {
  ...
  for( i = 1 ; i <= pnode ; i++ ) {
      pnodeArray[i].nodeList =
        ...
        pnode ) * sizeof(NNODE) ) ;
      pnodeArray[i].eptr = 0 ;
      pnodeArray[i].equiv = (LIST2PTR) ((void*)0) ;
  }
