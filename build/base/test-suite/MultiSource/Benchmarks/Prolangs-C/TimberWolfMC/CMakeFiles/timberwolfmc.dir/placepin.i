# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/placepin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/placepin.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/placepin.c" 2
...
CONTENTBOX *SCptr ;
UNCOMBOX *UCptr ;
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/placepin.c"
for( cell = 1 ; cell <= numcells ; cell++ ) {
 ...
 if( UCptr[i].sequence != 0 ) {
  ...
  j = (int)( (double)numsites *
       ( (double)((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) / (double)0x7fffffff) ) ;
  sum = 0 ;
  truth = 1 ;
  for( k = firstsite + j ; ; k++ ) {
      if( k > lastsite ) {
