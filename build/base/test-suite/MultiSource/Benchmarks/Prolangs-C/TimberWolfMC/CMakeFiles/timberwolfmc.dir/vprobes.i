# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/vprobes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/vprobes.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/vprobes.c" 2
...
ritePtr = hFixedList ;
for( ; ritePtr != (DLINK1PTR) ((void*)0) ; ritePtr = ritePtr->next ) {
    redge = ritePtr->edge ;
 ...
 for(; left1ptr != (DLINK1PTR)((void*)0); left1ptr = left1ptr->next){
     ledge = left1ptr->edge ;
 ...
 left1ptr = (DLINK1PTR) ((void*)0) ;
    }
    if( edgeList[ edgeList[redge].nextEdge ].UorR == -1 ) {
 left2ptr = Hptrs[ tprop( Hroot , ry ) ] ;
 for(; left2ptr != (DLINK1PTR) ((void*)0) ; left2ptr = left2ptr->next){
     ledge = left2ptr->edge ;
     if( edgeList[ledge].UorR > 0 ) {
  continue ;
     }
 ...
 left2ptr = (DLINK1PTR) ((void*)0) ;
    }
    if( left1ptr != (DLINK1PTR) ((void*)0) && left1ptr == left2ptr ) {
 check = 1 ;
 checkPtr = Hptrs[ tprop( Hroot , ry ) ] ;
 for(; checkPtr != (DLINK1PTR)((void*)0); checkPtr = checkPtr->next){
 ...
 continue ;
    ...
    if( left1ptr != (DLINK1PTR) ((void*)0) &&
     edgeList[ edgeList[left1ptr->edge].prevEdge ].UorR == -1 ) {
 ptr = Hptrs[ tprop( Hroot , l1y ) ] ;
 for( ptr = ptr->next; ptr != (DLINK1PTR) ((void*)0); ptr = ptr->next){
     if( edgeList[ptr->edge].loc > l1y ) {
  break ;
     }
 }
 if( ptr == (DLINK1PTR) ((void*)0) ) {
     ptr = hFixedEnd ;
 } else {
     ptr = ptr->prev ;
 }
 for( ; ptr != (DLINK1PTR) ((void*)0); ptr = ptr->prev){
     edge = ptr->edge ;
...
for( ; ptr != (DLINK1PTR) ((void*)0) ; ptr = ptr->next ) {
    edge = ptr->edge ;
    if( edgeList[edge].UorR > 0 ) {
 continue ;
    }
