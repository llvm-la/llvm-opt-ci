# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/selectpin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/selectpin.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/selectpin.c" 2
extern int flips ;
extern int flipp ;
extern int attp ;
...
do {
    i = (int) ( (double) acellptr->numUnComTerms * (
       (double)((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) / (double)0x7fffffff)) + 1;
...
do {
    sum = 0 ;
    site = (int)((double)ns * ((double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) / (double)0x7fffffff));
...
if( UCptr[i].groupflag == 1 && seq >= 2 ) {
    do {
 pin1 = (int)((double)seq * ((double)((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
         (double)0x7fffffff));
    } while( pin1 == seq ) ;
    do {
 pin2 = (int)((double)seq * ((double)((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
         (double)0x7fffffff));
