# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/nullable.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/nullable.c" 2
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/nullable.c"
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/nullable.c" 2
...
typedef
  ...
  shorts;
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/nullable.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/nullable.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/nullable.c" 2
...
void set_nullable(void)
{
  ...
  nullable = ((char *) mallocate((unsigned) ((nvars) * sizeof(char)))) - ntokens;

  squeue = ((short *) mallocate((unsigned) ((nvars) * sizeof(short))));
  s1 = s2 = squeue;

  rcount = ((short *) mallocate((unsigned) ((nrules + 1) * sizeof(short))));
  rsets = ((shorts * *) mallocate((unsigned) ((nvars) * sizeof(shorts *)))) - ntokens;
  relts = ((shorts *) mallocate((unsigned) ((nitems + nvars + 1) * sizeof(shorts))));
  p = relts;
      ...
      while (p)
 {
  ...
  {if (squeue) free(squeue);};
  {if (rcount) free(rcount);};
  {if (rsets + ntokens) free(rsets + ntokens);};
  {if (relts) free(relts);};
}

void free_nullable(void)
{
  {if (nullable + ntokens) free(nullable + ntokens);};
}
