# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c"
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
...
extern char *actfile;
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/symtab.h" 1
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/symtab.h"
typedef
  struct bucket
    {
      struct bucket *link;
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.h" 1
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c" 2
...
void reader(void)
{
  ...
  nitems = 0;
  rline_allocated = 10;
  rline = ((short *) mallocate((unsigned) ((rline_allocated) * sizeof(short))));
...
void read_declarations(void)
{
      ...
      if (c == '%')
 {
   ...
   switch (tok)
     ...
     case 9:
       parse_token_decl (1, 2);
       break;

     case 10:
       parse_token_decl (2, 1);
       break;
...
void parse_token_decl(int what_is,int what_is_not)
{
      ...
      if (token == 21)
 {
   ...
   typename = ((char *) mallocate((unsigned) ((k + 1) * sizeof(char))));
...
void parse_type_decl(void)
{
  ...
  k = strlen(token_buffer);
  name = ((char *) mallocate((unsigned) ((k + 1) * sizeof(char))));
...
# 789 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c"
void copy_guard(symbol_list *rule,int stack_offset)
{
  ...
  *cp++ = c;
  ...
  fprintf(stderr,"%s:%d:  warning:  $$ of '%s' has no declared type.\n",infile,lineno,rule->sym->tag);
   ...
   else if (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISdigit) || c == '-')
     {
       ungetc (c, finput);
...
# 1003 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c"
void copy_action(symbol_list *rule,int stack_offset)
{
  register int c;
  register int n;
...
# 1222 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c"
void readgram(void)
{
  register int t;
  register bucket *lhs;
      ...
      if (t == 1 || t == 5)
 {
  ...
  startval = lhs;
   ...
   p = ((symbol_list *) mallocate((unsigned) sizeof(symbol_list)));
   p->sym = lhs;
...
# 1332 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c"
        sdummy = gensym();
   ...
   crule1->next = p;
        ...
        p->sym = sdummy;
        crule1 = ((symbol_list *) mallocate((unsigned) sizeof(symbol_list)));
        p->next = crule1;
        crule1->next = crule;
...
void packsymbols(void)
{
  ...
  tags = ((char * *) mallocate((unsigned) ((nsyms + 1) * sizeof(char *))));
  tags[0] = "$";

  sprec = ((short *) mallocate((unsigned) ((nsyms) * sizeof(short))));
  sassoc = ((short *) mallocate((unsigned) ((nsyms) * sizeof(short))));
  ...
  if (translations)
    {
      ...
      token_translations = ((short *) mallocate((unsigned) ((max_user_token_number+1) * sizeof(short))));
...
void packgram(void)
{
  ...
  ritem = ((short *) mallocate((unsigned) ((nitems + 1) * sizeof(short))));
  rlhs = ((short *) mallocate((unsigned) ((nrules) * sizeof(short)))) - 1;
  rrhs = ((short *) mallocate((unsigned) ((nrules) * sizeof(short)))) - 1;
  rprec = ((short *) mallocate((unsigned) ((nrules) * sizeof(short)))) - 1;
  rassoc = ((short *) mallocate((unsigned) ((nrules) * sizeof(short)))) - 1;
