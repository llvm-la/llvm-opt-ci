# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c" 2
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c"
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c" 2
...
void allocate_itemsets(void)
{
  ...
  count = 0;
  symbol_count = ((short *) mallocate((unsigned) ((nsyms) * sizeof(short))));
      ...
      if (symbol > 0)
 {
  ...
  kernel_base = ((short * *) mallocate((unsigned) ((nsyms) * sizeof(short *))));
  kernel_items = ((short *) mallocate((unsigned) ((count) * sizeof(short))));
 ...
 max = symbol_count[i];
  ...
  kernel_end = ((short * *) mallocate((unsigned) ((nsyms) * sizeof(short *))));
}
...
void allocate_storage(void)
{
  ...
  shiftset = ((short *) mallocate((unsigned) ((nsyms) * sizeof(short))));
  redset = ((short *) mallocate((unsigned) ((nrules + 1) * sizeof(short))));
  state_table = ((core * *) mallocate((unsigned) ((1009) * sizeof(core *))));
}
...
{
  {if (shift_symbol) free(shift_symbol);};
  {if (redset) free(redset);};
  {if (shiftset) free(shiftset);};
  {if (kernel_base) free(kernel_base);};
  {if (kernel_end) free(kernel_end);};
  {if (kernel_items) free(kernel_items);};
...
# 200 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c"
void new_itemsets(void)
{
  register int i;
...
# 248 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c"
void append_states(void)
{
  register int i;
  register int j;
...
# 286 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c"
...
# 508 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/LR0.c"
void augment_automaton(void)
{
  register int i;
  register int k;
 ...
 {
   sp = ((shifts *) mallocate((unsigned) sizeof(shifts)));
   sp->next = first_shift;
   sp->nshifts = 1;
   sp->shifts[0] = nstates;
