# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c" 2
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c"
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c" 2
...
extern char *actfile;
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lex.c" 2
...
char token_buffer[1024 + 1];
bucket *symval;
int numval;

static int unlexed;
static bucket *unlexed_symval;
...
int lex(void)
{
  ...
  switch (c)
    ...
    case '.': case '_':
      p = token_buffer;
      while (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISalnum) || c == '_' || c == '.')
 {
   if (p < token_buffer + 1024)
     *p++ = c;
   c = getc(finput);
 }
 ...
 *p = 0;
      ...
      while (c != '>')
 {
   ...
   if (p >= token_buffer + 1024 - 1)
     fatals("type name too long (%d max)",1024 -1,0,0,0,0,0,0,0);
