# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c" 2
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c"
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c" 2
...
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/types.h" 1
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/types.h"
typedef
  struct shorts
    {
      struct shorts *next;
  ...
  shorts;
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c" 2
...
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c" 2
...
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c" 2
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c" 2
...
void set_state_table(void)
{
  ...
  state_table = ((core * *) mallocate((unsigned) ((nstates) * sizeof(core *))));
...
void set_accessing_symbol(void)
{
  ...
  accessing_symbol = ((short *) mallocate((unsigned) ((nstates) * sizeof(short))));
...
void set_shift_table(void)
{
  ...
  shift_table = ((shifts * *) mallocate((unsigned) ((nstates) * sizeof(shifts *))));
...
void set_reduction_table(void)
{
  ...
  reduction_table = ((reductions * *) mallocate((unsigned) ((nstates) * sizeof(reductions *))));
...
void initialize_LA(void)
{
  ...
  consistent = ((char *) mallocate((unsigned) ((nstates) * sizeof(char))));
  lookaheads = ((short *) mallocate((unsigned) ((nstates + 1) * sizeof(short))));
  ...
  for (i = 0; i < nstates; i++)
    {
      ...
      sp = shift_table[i];
      if (rp && (rp->nreds > 1
          || (sp && ! ((accessing_symbol[sp->shifts[0]]) >= ntokens))))
 count += rp->nreds;
      else
 consistent[i] = 1;
 ...
 for (j = 0; j < sp->nshifts; j++)
  ...
  LA = ((unsigned *) mallocate((unsigned) ((count * tokensetsize) * sizeof(unsigned))));
  LAruleno = ((short *) mallocate((unsigned) ((count) * sizeof(short))));
  lookback = ((shorts * *) mallocate((unsigned) ((count) * sizeof(shorts *))));
...
void set_goto_map(void)
{
  ...
  goto_map = ((short *) mallocate((unsigned) ((nvars + 1) * sizeof(short)))) - ntokens;
  temp_map = ((short *) mallocate((unsigned) ((nvars + 1) * sizeof(short)))) - ntokens;
      ...
      for (i = sp->nshifts - 1; i >= 0; i--)
 {
  ...
  from_state = ((short *) mallocate((unsigned) ((ngotos) * sizeof(short))));
  to_state = ((short *) mallocate((unsigned) ((ngotos) * sizeof(short))));
      ...
      for (i = sp->nshifts - 1; i >= 0; i--)
 {
  ...
  {if (temp_map + ntokens) free(temp_map + ntokens);};
}
...
void initialize_F(void)
{
  ...
  F = ((unsigned *) mallocate((unsigned) ((nwords) * sizeof(unsigned))));

  reads = ((short * *) mallocate((unsigned) ((ngotos) * sizeof(short *))));
  edge = ((short *) mallocate((unsigned) ((ngotos + 1) * sizeof(short))));
  nedges = 0;
      ...
      if (sp)
 {
  ...
  edge[nedges++] = map_goto(stateno, symbol);
   ...
   if (nedges)
     {
       reads[i] = rp = ((short *) mallocate((unsigned) ((nedges + 1) * sizeof(short))));
...
void build_relations(void)
{
  ...
  includes = ((short * *) mallocate((unsigned) ((ngotos) * sizeof(short *))));
  edge = ((short *) mallocate((unsigned) ((ngotos + 1) * sizeof(short))));
  states = ((short *) mallocate((unsigned) ((maxrhs + 1) * sizeof(short))));
      ...
      for (rulep = derives[symbol1]; *rulep > 0; rulep++)
 {
       ...
       if (rp>=ritem && ((*rp) >= ntokens))
  {
    ...
    if (nullable[*rp]) done = 0;
      ...
      if (nedges)
 {
   includes[i] = shortp = ((short *) mallocate((unsigned) ((nedges + 1) * sizeof(short))));
   for (j = 0; j < nedges; j++)
     shortp[j] = edge[j];
   shortp[nedges] = -1;
 }
...
void add_lookback_edge(int stateno,int ruleno,int gotono)
{
 ...
 i++;
  ...
  sp = ((shorts *) mallocate((unsigned) sizeof(shorts)));
  sp->next = lookback[i];
  sp->value = gotono;
  lookback[i] = sp;
}
...
short **transpose(short **R,int n)
{
  ...
  nedges = ((short *) mallocate((unsigned) ((n) * sizeof(short))));
      ...
      if (sp)
 {
  ...
  new_R = ((short * *) mallocate((unsigned) ((n) * sizeof(short *))));
  temp_R = ((short * *) mallocate((unsigned) ((n) * sizeof(short *))));
  ...
  for (i = 0; i < n; i++)
    {
      ...
      if (k > 0)
 {
   sp = ((short *) mallocate((unsigned) ((k + 1) * sizeof(short))));
   new_R[i] = sp;
   temp_R[i] = sp;
   sp[k] = -1;
 }
...
void compute_FOLLOWS(void)
{
  ...
  for (i = 0; i < ngotos; i++)
    {
      if (includes[i]) {if (includes[i]) free(includes[i]);};
    }
...
void digraph(short **relation)
{
  ...
  infinity = ngotos + 2;
  INDEX = ((short *) mallocate((unsigned) ((ngotos + 1) * sizeof(short))));
  VERTICES = ((short *) mallocate((unsigned) ((ngotos + 1) * sizeof(short))));
  top = 0;
