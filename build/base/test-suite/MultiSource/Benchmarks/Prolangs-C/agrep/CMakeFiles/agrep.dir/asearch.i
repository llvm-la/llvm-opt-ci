# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/asearch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/asearch.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/asearch.c" 2
...
void asearch0(unsigned char old_D_pat[], int text, register unsigned D)
{
  register unsigned i, c, r1, r2, CMask, r_NO_ERR, r_Init1, end, endpos;
  unsigned A[8 +2], B[8 +2];
  unsigned D_Mask;
  int D_length, FIRSTROUND, ResidueSize, lasti, l, k, j=0;
  int printout_end;
  unsigned char buffer[49152 +49152 +1];
  ...
  while ((l = fill_buf(text, buffer + 49152, 49152)) > 0)
  { i = 49152; end = 49152 + l ;
    if (FIRSTROUND) {
        i = 49152 - 1;
        FIRSTROUND = 0; }
...
void asearch(unsigned char old_D_pat[], int text, register unsigned D)
{
  register unsigned i, c, r1, r2, CMask, r_NO_ERR, r_Init1;
  register unsigned A0, B0, A1, B1, endpos;
  unsigned A2, B2, A3, B3, A4, B4;
  unsigned A[8 +1], B[8 +1];
  unsigned D_Mask;
  unsigned end;
  int D_length, FIRSTROUND, ResidueSize, lasti, l, k, j=0;
  int printout_end;
  unsigned char buffer[2*49152 +1];
