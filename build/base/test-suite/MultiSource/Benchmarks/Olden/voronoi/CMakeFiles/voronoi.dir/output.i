# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Olden/voronoi/output.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Olden/voronoi/output.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Olden/voronoi/output.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Olden/voronoi/output.c" 2
...
void plot_vedge(p1, p2)
     struct VEC2 p1, p2;
{
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Olden/voronoi/output.c"
  float p1x = p1.x;
  float p1y = p1.y;
  float p2x = p2.x;
  float p2y = p2.y;

  if (__builtin_isnan (p1x))
    p1x = copysign(p1x, 1.0);
  if (__builtin_isnan (p1y))
    p1y = copysign(p1y, 1.0);
  if (__builtin_isnan (p2x))
    p2x = copysign(p2x, 1.0);
  if (__builtin_isnan (p2y))
