# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c" 2
...
# 92 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
  if(Ersatz_Flag)
...
int framenum, MBAmax;
{
  ...
  for (;;)
  {
    ...
    if (MBA>=MBAmax)
      return(-1);
# 189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
    ld = &base;
  ...
  int *pdct_type;
{
  ...
  if (macroblock_type & 32)
  {
    ...
    {
      stwcode = Get_Bits(2);
# 308 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
...
# 333 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
    }
    else
    {
      motion_type = Get_Bits(2);
# 347 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
    }
  }
...
# 363 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
  if (picture_structure==3)
  {
  ...
  dmv = (motion_type==3);
# 385 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
  ...
  dct_type = (picture_structure==3)
             ...
             ? Get_Bits(1)
             : 0;
# 402 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
...
# 421 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
...
int dmvector[2];
{
  ...
  {
    quantizer_scale_code = Get_Bits(5);
# 1045 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
    if (ld->MPEG2_Flag)
      ld->quantizer_scale =
...
# 1118 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
     }
     else if (chroma_format==3)
     {

      coded_block_pattern = (coded_block_pattern<<6) | Get_Bits(6);
# 1132 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
    }
  }
  else
