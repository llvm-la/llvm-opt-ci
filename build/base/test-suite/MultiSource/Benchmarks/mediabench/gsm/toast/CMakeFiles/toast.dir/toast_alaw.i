# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_alaw.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_alaw.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_alaw.c" 2
...
int alaw_input (gsm_signal * buf)
{
 ...
 for (i = 0; i < 160 && (c = fgetc(in)) != (-1); i++) buf[i] = (a2s[ (unsigned char )(c) ]);
 if (c == (-1) && ferror(in)) return -1;
 return i;
}
...
int alaw_output (gsm_signal * buf)
{
 ...
 for (i = 0; i < 160; i++, buf++)
  if (fputc( (s2a[ ((unsigned short)(*buf)) >> 4 ]), out) == (-1)) return -1;
 return 0;
}
