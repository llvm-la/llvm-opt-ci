...
// Enum values for intrinsics.
    dx_all = 4133,                                    // llvm.dx.all (IntrinsicsDirectX.td:86)
    ...
    dx_ddx_coarse,                             // llvm.dx.ddx.coarse (IntrinsicsDirectX.td:173)
    dx_ddy_coarse,                             // llvm.dx.ddy.coarse (IntrinsicsDirectX.td:174)
    ...
    dx_firstbitlow,                            // llvm.dx.firstbitlow (IntrinsicsDirectX.td:177)
    dx_firstbitshigh,                          // llvm.dx.firstbitshigh (IntrinsicsDirectX.td:176)
    dx_firstbituhigh,                          // llvm.dx.firstbituhigh (IntrinsicsDirectX.td:175)
    ...
    dx_group_memory_barrier_with_group_sync,   // llvm.dx.group.memory.barrier.with.group.sync (IntrinsicsDirectX.td:179)
    ...
    dx_load_input,                             // llvm.dx.load.input (IntrinsicsDirectX.td:182)
    ...
    dx_store_output,                           // llvm.dx.store.output (IntrinsicsDirectX.td:188)
