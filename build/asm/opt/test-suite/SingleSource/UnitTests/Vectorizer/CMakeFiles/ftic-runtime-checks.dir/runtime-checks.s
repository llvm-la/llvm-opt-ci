...
.LBB71_12:                              # %vector.body
	...
	vinsgr2vr.b	$vr1, $t8, 6
	vinsgr2vr.b	$vr1, $fp, 7
	vinsgr2vr.b	$vr1, $s0, 8
	vinsgr2vr.b	$vr1, $s1, 9
	vinsgr2vr.b	$vr1, $s2, 10
	vinsgr2vr.b	$vr1, $s3, 11
	vinsgr2vr.b	$vr1, $s4, 12
	vinsgr2vr.b	$vr1, $s5, 13
	vinsgr2vr.b	$vr1, $s6, 14
	vinsgr2vr.b	$vr1, $s7, 15
	vaddi.bu	$vr0, $vr0, 10
	vaddi.bu	$vr1, $vr1, 10
	vstelm.b	$vr0, $t0, 30, 0
	vstelm.b	$vr0, $t0, 28, 1
	vstelm.b	$vr0, $t0, 26, 2
	vstelm.b	$vr0, $t0, 24, 3
	vstelm.b	$vr0, $t0, 22, 4
	vstelm.b	$vr0, $t0, 20, 5
	vstelm.b	$vr0, $t0, 18, 6
	vstelm.b	$vr0, $t0, 16, 7
	vstelm.b	$vr0, $t0, 14, 8
	vstelm.b	$vr0, $t0, 12, 9
	vstelm.b	$vr0, $t0, 10, 10
	vstelm.b	$vr0, $t0, 8, 11
	vstelm.b	$vr0, $t0, 6, 12
	vstelm.b	$vr0, $t0, 4, 13
	vstelm.b	$vr0, $t0, 2, 14
	vstelm.b	$vr0, $t0, 0, 15
	vstelm.b	$vr1, $t0, -2, 0
	vstelm.b	$vr1, $t0, -4, 1
	vstelm.b	$vr1, $t0, -6, 2
	vstelm.b	$vr1, $t0, -8, 3
	vstelm.b	$vr1, $t0, -10, 4
	vstelm.b	$vr1, $t0, -12, 5
	vstelm.b	$vr1, $t0, -14, 6
	vstelm.b	$vr1, $t0, -16, 7
	vstelm.b	$vr1, $t0, -18, 8
	vstelm.b	$vr1, $t0, -20, 9
	vstelm.b	$vr1, $t0, -22, 10
	vstelm.b	$vr1, $t0, -24, 11
	vstelm.b	$vr1, $t0, -26, 12
	vstelm.b	$vr1, $t0, -28, 13
	vstelm.b	$vr1, $t0, -30, 14
	vstelm.b	$vr1, $t0, -32, 15
	addi.d	$t1, $t1, -32
	addi.d	$a7, $a7, -64
	addi.d	$t0, $t0, -64
	bnez	$t1, .LBB71_12
