...
# %bb.21:
	bne	$s3, $a0, .LBB3_91
# %bb.22:                               # %vector.body404.preheader
	move	$a0, $zero
	vldi	$vr0, -2688
	ori	$a1, $zero, 1984
	vld	$vr1, $sp, 16                   # 16-byte Folded Reload
	.p2align	4, , 16
.LBB3_23:                               # %vector.body404
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a2, $fp, $a0
	vstx	$vr0, $fp, $a0
	vst	$vr0, $a2, 16
	...
	vst	$vr1, $a2, 16
	bne	$a0, $a1, .LBB3_23
# %bb.24:                               # %vec.epilog.vector.body412
	vldi	$vr0, -2688
	vst	$vr0, $fp, 1984
	vst	$vr1, $s0, 1984
	ld.d	$a0, $s2, 16
...
# %bb.28:
	bne	$s3, $a0, .LBB3_96
# %bb.29:                               # %vector.body421.preheader
	move	$a0, $zero
	vldi	$vr0, -2688
	ori	$a1, $zero, 1984
	.p2align	4, , 16
.LBB3_30:                               # %vector.body421
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a2, $s0, $a0
	vstx	$vr0, $s0, $a0
	vst	$vr0, $a2, 16
	...
	vst	$vr0, $a2, 16
	bne	$a0, $a1, .LBB3_30
# %bb.31:                               # %vec.epilog.vector.body429
	vldi	$vr0, -2688
	vst	$vr0, $s0, 1984
	vst	$vr0, $fp, 1984
	st.h	$s6, $fp, 1996
...
# %bb.35:
	bne	$s3, $a0, .LBB3_101
# %bb.36:                               # %vector.body438.preheader
	move	$a0, $zero
	vldi	$vr0, -2688
	ori	$a1, $zero, 1984
	.p2align	4, , 16
.LBB3_37:                               # %vector.body438
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a2, $s0, $a0
	vstx	$vr0, $s0, $a0
	vst	$vr0, $a2, 16
	...
	vst	$vr0, $a2, 16
	bne	$a0, $a1, .LBB3_37
# %bb.38:                               # %vec.epilog.vector.body446
	vldi	$vr0, -2688
	vst	$vr0, $s0, 1984
	vst	$vr0, $fp, 1984
	st.h	$s6, $fp, 0
...
# %bb.42:
	bne	$s3, $a0, .LBB3_106
# %bb.43:                               # %vector.body455.preheader
	move	$a0, $zero
	vldi	$vr0, -2688
	ori	$a1, $zero, 1984
	.p2align	4, , 16
.LBB3_44:                               # %vector.body455
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a2, $s0, $a0
	vstx	$vr0, $s0, $a0
	vst	$vr0, $a2, 16
	...
	vst	$vr0, $a2, 16
	bne	$a0, $a1, .LBB3_44
# %bb.45:                               # %vec.epilog.vector.body463
	vldi	$vr0, -2688
	vst	$vr0, $s0, 1984
	vst	$vr0, $fp, 1984
	st.h	$s6, $fp, 1998
...
# %bb.49:
	bne	$s3, $a0, .LBB3_111
# %bb.50:                               # %vector.body472.preheader
	move	$a0, $zero
	vldi	$vr0, -2688
	ori	$a1, $zero, 1984
	.p2align	4, , 16
.LBB3_51:                               # %vector.body472
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a2, $s0, $a0
	vstx	$vr0, $s0, $a0
	vst	$vr0, $a2, 16
	...
	vst	$vr0, $a2, 16
	bne	$a0, $a1, .LBB3_51
# %bb.52:                               # %vec.epilog.vector.body480
	vldi	$vr0, -2688
	vst	$vr0, $s0, 1984
	vst	$vr0, $fp, 1984
	st.h	$s6, $fp, 1998
...
.LBB3_63:                               # %vector.body486
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB3_63
# %bb.64:                               # %middle.block489
                                        #   in Loop: Header=BB3_58 Depth=1
	beq	$s7, $a0, .LBB3_67
.LBB3_65:                               # %.preheader.preheader498
                                        #   in Loop: Header=BB3_58 Depth=1
	alsl.d	$a1, $a0, $s3, 1
	alsl.d	$a2, $a0, $s4, 1
	.p2align	4, , 16
