...
.Ltmp8:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp9:                                 # EH_LABEL
# %bb.10:                               # %_ZNSt6vectorIPKcSaIS1_EED2Ev.exit
	sub.d	$a1, $s2, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB2_11:                               # %.noexc
	...
	jirl	$ra, $ra, 0
.LBB2_12:                               # %_ZNSt6vectorIPKcSaIS1_EED2Ev.exit23
.Ltmp10:                                # EH_LABEL
	move	$s0, $a0
	sub.d	$a1, $s2, $fp
	move	$a0, $fp
...
# %bb.12:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i9
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_13:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit11
	addi.d	$a0, $sp, 40
	...
	jirl	$ra, $ra, 0
.Lfunc_end3:
	.size	_ZN12_GLOBAL__N_112DoTestHelperEPiPPKcd, .Lfunc_end3-_ZN12_GLOBAL__N_112DoTestHelperEPiPPKcd
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table3:
...
# %bb.1:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_2:                                # %_ZNSt6vectorIdSaIdEED2Ev.exit
	pcalau12i	$a0, %got_pc_hi20(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a0, $a0, %got_pc_lo12(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a1, $fp, 56
	addi.d	$a0, $a0, 16
...
# %bb.4:
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB6_5:                                # %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i
	add.d	$s4, $s1, $s0
	beqz	$fp, .LBB6_7
# %bb.6:
	move	$a0, $fp
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB6_7:                                # %_ZNSt6vectorIdSaIdEE17_M_realloc_appendIJRKdEEEvDpOT_.exit.i
	addi.d	$a0, $s4, 8
	st.d	$s1, $s2, 96
	st.d	$a0, $s2, 104
	alsl.d	$a0, $s3, $s1, 3
	st.d	$a0, $s2, 112
.LBB6_8:                                # %_ZNSt6vectorIdSaIdEE9push_backERKd.exit
...
.LBB6_9:
	...
	jirl	$ra, $ra, 0
.Lfunc_end6:
	.size	_ZN12_GLOBAL__N_112TestReporter16ReportRunsConfigEdbl, .Lfunc_end6-_ZN12_GLOBAL__N_112TestReporter16ReportRunsConfigEdbl
	.cfi_endproc
                                        # -- End function
...
# %bb.1:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB9_2:                                # %_ZNSt6vectorIdSaIdEED2Ev.exit.i
	pcalau12i	$a0, %got_pc_hi20(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a0, $a0, %got_pc_lo12(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a1, $fp, 56
	addi.d	$a0, $a0, 16
...
.Lcst_begin4:
	...
	.uleb128 .Lfunc_end9-.Ltmp21            #   Call between .Ltmp21 and .Lfunc_end9
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end4:
	.byte	1                               # >> Action Record 1 <<
...
.LBB12_10:                              # %_ZNKSt14default_deleteIN9benchmark8internal17FunctionBenchmarkEEclEPS2_.exit.i6.i
	...
	jirl	$ra, $ra, 0
.Lfunc_end12:
	.size	_GLOBAL__sub_I_benchmark_min_time_flag_time_test.cc, .Lfunc_end12-_GLOBAL__sub_I_benchmark_min_time_flag_time_test.cc
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table12:
...
.Lcst_begin5:
	...
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp24-.Lfunc_begin5          # >> Call Site 3 <<
