...
# %bb.13:                               # %middle.block
	...
	move	$t3, $a2
	beq	$t6, $a2, .LBB20_16
.LBB20_14:                              # %"_Z6forallIZL16BM_PIC_1D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.preheader160"
                                        #   in Loop: Header=BB20_4 Depth=1
	alsl.d	$a4, $t3, $t7, 3
	alsl.d	$a5, $t3, $s0, 2
	alsl.d	$a6, $t3, $s7, 3
...
.LBB21_7:                               # %.preheader96.us
	...
	ori	$a1, $zero, 4
	bgeu	$a0, $a1, .LBB21_10
.LBB21_8:                               # %scalar.ph501.preheader
                                        #   in Loop: Header=BB21_7 Depth=2
...
.LBB21_32:                              # %.preheader95.us
	...
	ori	$a1, $zero, 4
	bgeu	$a0, $a1, .LBB21_35
.LBB21_33:                              # %scalar.ph388.preheader
                                        #   in Loop: Header=BB21_32 Depth=2
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	sub.d	$a4, $a0, $t3
	slli.d	$a5, $t3, 3
...
# %bb.58:                               #   in Loop: Header=BB21_4 Depth=1
	...
	ori	$fp, $zero, 16
.LBB21_59:                              # %scalar.ph281.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	alsl.d	$a1, $a0, $a3, 3
	alsl.d	$a2, $a0, $a4, 3
	alsl.d	$a3, $a0, $a5, 3
...
.LBB21_61:                              # %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_2Ev9simd_execiiT_.exit_crit_edge.us"
	...
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	bgeu	$a1, $t8, .LBB21_85
.LBB21_62:                              # %scalar.ph247.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
...
.LBB21_64:                              # %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_2Ev9simd_execiiT_.exit_crit_edge.us.1"
	...
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	bgeu	$a1, $t8, .LBB21_97
.LBB21_65:                              # %scalar.ph213.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a2, $a0, $t0, 3
