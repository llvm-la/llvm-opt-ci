...
.LBB0_52:                               # %vector.body650
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_52
# %bb.53:                               # %middle.block654
	beq	$a2, $t0, .LBB0_56
.LBB0_54:                               # %scalar.ph645.preheader
	slli.d	$a2, $a1, 2
	sub.d	$a2, $a2, $s5
	add.d	$a2, $s3, $a2
	sub.d	$a1, $s1, $a1
	addi.d	$a1, $a1, 1
	.p2align	4, , 16
.LBB0_55:                               # %scalar.ph645
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a2, 0
	addi.w	$a1, $a1, -1
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB0_55
.LBB0_56:                               # %._crit_edge504
	sub.d	$t3, $s3, $s5
	or	$t4, $a3, $a7
...
.LBB0_80:                               #   in Loop: Header=BB0_70 Depth=2
	move	$a1, $fp
	.p2align	4, , 16
.LBB0_81:                               #   Parent Loop BB0_66 Depth=1
