...
# %bb.38:                               #   in Loop: Header=BB0_29 Depth=2
	...
	ext.w.b	$t0, $t1
	bgez	$t0, .LBB0_31
.LBB0_39:                               # %.preheader1101.preheader
...
# %bb.88:                               #   in Loop: Header=BB0_29 Depth=2
	bgeu	$s1, $t0, .LBB0_139
# %bb.89:                               # %.lr.ph1256.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	sub.w	$a0, $a0, $t2
	bltu	$t2, $ra, .LBB0_94
# %bb.90:                               # %.lr.ph1256.preheader
                                        #   in Loop: Header=BB0_29 Depth=2
	addi.d	$t0, $t1, 31
	bltu	$t0, $ra, .LBB0_94
# %bb.91:                               # %vector.ph
...
.LBB0_139:
	move	$fp, $s0
.LBB0_140:                              # %.thread1057.sink.split
	ori	$s3, $zero, 1
	b	.LBB0_197
.LBB0_141:
	ori	$s3, $zero, 1
...
.LBB0_145:
	...
	ori	$a0, $zero, 1
	blez	$s5, .LBB0_198
# %bb.146:                              # %.preheader1097
	ori	$a0, $zero, 1
	ld.d	$t5, $sp, 240                   # 8-byte Folded Reload
	bne	$s5, $a0, .LBB0_152
.LBB0_147:                              # %._crit_edge1289
	beqz	$t6, .LBB0_162
# %bb.148:
	ori	$a1, $zero, 2
...
.LBB0_151:
	...
	b	.LBB0_205
.LBB0_152:                              # %.preheader1096.us.preheader
	addi.w	$a0, $s5, -1
...
.LBB0_163:                              # %.lr.ph1327
	...
	beqz	$a3, .LBB0_178
# %bb.164:                              # %.lr.ph1327.split.us.preheader
	move	$a5, $zero
	addi.d	$a3, $s8, 4
	add.d	$a4, $a3, $a6
	lu12i.w	$a6, -262399
	ori	$a6, $a6, 823
.LBB0_165:                              # %.lr.ph1327.split.us
                                        # =>This Loop Header: Depth=1
...
# %bb.196:
	move	$s3, $zero
.LBB0_197:                              # %.thread1057.sink.split
	move	$a0, $fp
...
.LBB0_198:                              # %.thread1057
	...
	addi.d	$sp, $sp, 400
	ret
.LBB0_199:                              # %.lr.ph1347.peel.next.preheader
	slt	$a0, $s2, $s5
	masknez	$a1, $s2, $a0
	maskeqz	$a0, $s5, $a0
	or	$a0, $a0, $a1
...
.LBB0_205:                              # %.thread1057.sink.split.sink.split
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_140
.Lfunc_end0:
