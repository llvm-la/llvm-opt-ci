...
.LBB1_101:                              #   in Loop: Header=BB1_76 Depth=1
	...
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	beq	$fp, $a0, .LBB1_117
# %bb.102:                              #   in Loop: Header=BB1_76 Depth=1
	addi.w	$s4, $s4, 0
	move	$a0, $fp
	move	$a1, $s5
	move	$a2, $s4
...
.LBB1_134:
	...
	addi.w	$a0, $zero, -123
	b	.LBB1_109
.LBB1_135:                              # %vector.main.loop.iter.check34
	ori	$a2, $zero, 31
	bgeu	$fp, $a2, .LBB1_137
# %bb.136:
	move	$a2, $zero
...
.LBB1_142:                              # %vec.epilog.vector.body50
	...
	addi.d	$a7, $a7, 8
	bnez	$a6, .LBB1_142
# %bb.143:                              # %vec.epilog.middle.block54
	bne	$a2, $t3, .LBB1_44
	b	.LBB1_46
.LBB1_144:
	ld.d	$a0, $a3, 0
