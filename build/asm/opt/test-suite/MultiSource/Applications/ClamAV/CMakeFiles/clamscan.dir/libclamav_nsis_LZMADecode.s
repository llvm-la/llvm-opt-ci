...
.LBB1_3:                                # %.preheader.outer501.outer
...
.LBB1_39:                               # %.loopexit2326
	...
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_3
.LBB1_40:                               # %.loopexit538.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_73
.LBB1_41:                               # %.loopexit544.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 160                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_87
.LBB1_42:                               # %.loopexit537.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_93
.LBB1_43:                               # %.loopexit1946
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a3, $sp, 200                   # 8-byte Folded Reload
	addi.w	$a3, $a3, 0
	sltui	$a3, $a3, 1
...
# %bb.56:                               #   in Loop: Header=BB1_3 Depth=2
	...
	ori	$a3, $zero, 19
	b	.LBB1_75
.LBB1_57:                               # %.loopexit4584
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a6, $sp, 168                   # 8-byte Folded Reload
	bnez	$s7, .LBB1_79
	b	.LBB1_157
.LBB1_58:                               # %.loopexit2195
                                        #   in Loop: Header=BB1_3 Depth=2
	ori	$a3, $zero, 18
...
.LBB1_73:                               # %.loopexit538
	...
	ld.d	$a6, $sp, 168                   # 8-byte Folded Reload
	b	.LBB1_80
.LBB1_74:                               #   in Loop: Header=BB1_3 Depth=2
	slli.w	$a3, $t8, 4
	alsl.d	$a3, $a3, $t2, 1
...
.LBB1_76:                               # %.loopexit543.loopexit
	...
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_83
.LBB1_77:                               #   in Loop: Header=BB1_3 Depth=2
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	beqz	$t5, .LBB1_149
# %bb.78:                               #   in Loop: Header=BB1_3 Depth=2
	slti	$a3, $t8, 7
	ori	$a4, $zero, 11
	masknez	$a4, $a4, $a3
	ori	$a5, $zero, 9
...
.LBB1_83:                               # %.loopexit543
	...
	addi.w	$a6, $a7, 0
	bgeu	$s8, $a6, .LBB1_85
# %bb.84:                               #   in Loop: Header=BB1_3 Depth=2
	st.d	$zero, $sp, 200                 # 8-byte Folded Spill
	ori	$a6, $zero, 2048
	sub.d	$a6, $a6, $a3
...
.LBB1_86:                               #   in Loop: Header=BB1_3 Depth=2
...
.LBB1_87:                               # %.loopexit544
	...
	ld.d	$t1, $sp, 208                   # 8-byte Folded Reload
	beqz	$t1, .LBB1_151
# %bb.88:                               #   in Loop: Header=BB1_3 Depth=2
	slli.d	$s5, $s5, 8
...
.LBB1_90:                               # %.loopexit536
                                        #   in Loop: Header=BB1_3 Depth=2
	beqz	$a5, .LBB1_155
# %bb.91:                               #   in Loop: Header=BB1_3 Depth=2
	ld.bu	$a3, $a6, 0
	slli.d	$a4, $a2, 3
...
.LBB1_93:                               # %.loopexit537
	...
	ld.d	$a5, $sp, 208                   # 8-byte Folded Reload
	beqz	$a5, .LBB1_152
# %bb.94:                               #   in Loop: Header=BB1_3 Depth=2
	ld.bu	$a3, $a6, 0
	slli.w	$a4, $s8, 8
	addi.w	$a5, $a5, -1
	st.d	$a5, $sp, 208                   # 8-byte Folded Spill
...
.LBB1_105:                              # %.loopexit497.loopexit
	...
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_115
.LBB1_106:                              # %.loopexit500.loopexit
                                        #   in Loop: Header=BB1_2 Depth=1
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_136
.LBB1_107:                              # %.loopexit498.loopexit
                                        #   in Loop: Header=BB1_2 Depth=1
	ld.d	$a4, $sp, 200                   # 8-byte Folded Reload
...
# %bb.123:                              #   in Loop: Header=BB1_2 Depth=1
	...
	add.w	$t5, $t5, $a7
	.p2align	4, , 16
.LBB1_124:                              #   Parent Loop BB1_2 Depth=1
...
.LBB1_145:
	...
	move	$a5, $zero
	ori	$a3, $zero, 13
.LBB1_146:                              # %.loopexit495
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
.LBB1_147:                              # %.loopexit495
	move	$s2, $zero
	st.w	$a3, $a0, 0
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	st.w	$a3, $a0, 4
