	...
	.p2align	4, 0x0                          # -- Begin function jpeg_add_quant_table
.LCPI0_0:
	.half	0                               # 0x0
	.half	4                               # 0x4
	.half	8                               # 0x8
...
.LBB0_6:                                # %vector.body
	...
	vmin.d	$vr8, $vr8, $vr4
	vmin.d	$vr9, $vr9, $vr4
	vslt.d	$vr11, $vr6, $vr11
	vslt.d	$vr10, $vr6, $vr10
	vori.b	$vr12, $vr5, 0
	vshuf.h	$vr12, $vr10, $vr11
	vori.b	$vr10, $vr5, 0
	vshuf.h	$vr10, $vr9, $vr8
	vbitsel.v	$vr8, $vr10, $vr7, $vr12
	add.d	$a3, $a0, $a1
	vstelm.d	$vr8, $a3, 0, 0
	addi.d	$a1, $a1, 8
	addi.d	$fp, $fp, 16
	bne	$a1, $a2, .LBB0_6
	b	.LBB0_9
.LBB0_7:                                # %vector.body40.preheader
...
.Lfunc_end0:
	.size	jpeg_add_quant_table, .Lfunc_end0-jpeg_add_quant_table
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function jpeg_set_linear_quality
.LCPI1_0:
	.half	0                               # 0x0
	.half	4                               # 0x4
	.half	8                               # 0x8
...
.LBB1_6:                                # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr5, $a1, 0
	vilvl.w	$vr6, $vr10, $vr5
	vilvh.w	$vr5, $vr10, $vr5
	vmul.d	$vr7, $vr0, $vr5
	vmul.d	$vr8, $vr0, $vr6
	vori.b	$vr9, $vr11, 0
	vmadd.d	$vr9, $vr0, $vr5
	...
	bne	$a2, $a3, .LBB1_6
	b	.LBB1_9
.LBB1_7:                                # %vector.body35.preheader
	pcalau12i	$a1, %pc_hi20(jpeg_set_linear_quality.std_luminance_quant_tbl)
	addi.d	$a1, $a1, %pc_lo12(jpeg_set_linear_quality.std_luminance_quant_tbl)
	move	$a2, $zero
	ori	$a3, $s4, 1803
...
.LBB1_8:                                # %vector.body35
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr4, $a1, 0
	vilvl.w	$vr5, $vr10, $vr4
	vilvh.w	$vr4, $vr10, $vr4
	vori.b	$vr6, $vr11, 0
	vmadd.d	$vr6, $vr0, $vr4
	vori.b	$vr4, $vr11, 0
	vmadd.d	$vr4, $vr0, $vr5
...
.LBB1_11:
	vreplgr2vr.d	$vr0, $s1
	beqz	$fp, .LBB1_16
.LBB1_12:                               # %vector.body43.preheader
...
.LBB1_15:
	...
	vreplgr2vr.d	$vr0, $s1
	bnez	$fp, .LBB1_12
.LBB1_16:                               # %vector.body51.preheader
	pcalau12i	$a1, %pc_hi20(jpeg_set_linear_quality.std_chrominance_quant_tbl)
	addi.d	$a1, $a1, %pc_lo12(jpeg_set_linear_quality.std_chrominance_quant_tbl)
	move	$a2, $zero
	ori	$a3, $s4, 1803
