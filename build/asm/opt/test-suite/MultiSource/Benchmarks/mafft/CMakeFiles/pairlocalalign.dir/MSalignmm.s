...
.LBB1_42:                               # %scalar.ph292.preheader
	sub.d	$a1, $a0, $a3
...
.LBB1_72:                               # %vector.body237
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_72
# %bb.73:                               # %middle.block247
	bne	$a2, $a3, .LBB1_34
	b	.LBB1_36
.LBB1_74:                               # %vector.ph310
	move	$t2, $a6
...
.LBB1_82:                               # %vector.body326
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_82
# %bb.83:                               # %middle.block332
	beq	$a3, $a2, .LBB1_86
.LBB1_84:                               # %scalar.ph321.preheader
	alsl.d	$a0, $a3, $a0, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_85:                               # %scalar.ph321
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $a2, -1
...
# %bb.90:                               #   in Loop: Header=BB1_88 Depth=1
	...
	add.w	$t1, $s3, $t0
	beqz	$t1, .LBB1_97
.LBB1_91:                               # %.lr.ph125.i.i.preheader
                                        #   in Loop: Header=BB1_88 Depth=1
	bltu	$t1, $a4, .LBB1_103
# %bb.92:                               # %.lr.ph125.i.i.preheader
                                        #   in Loop: Header=BB1_88 Depth=1
	sub.d	$t2, $s1, $s8
	bltu	$t2, $a4, .LBB1_103
# %bb.93:                               # %vector.ph362
...
.LBB1_96:                               #   in Loop: Header=BB1_88 Depth=1
	...
	bnez	$t1, .LBB1_91
	.p2align	4, , 16
.LBB1_97:                               # %._crit_edge126.i.i
                                        #   in Loop: Header=BB1_88 Depth=1
	beq	$a7, $a1, .LBB1_106
.LBB1_98:                               # %.lr.ph134.preheader.i.i
                                        #   in Loop: Header=BB1_88 Depth=1
	addi.w	$t0, $zero, -9
	nor	$t3, $a7, $zero
	bltu	$t0, $a7, .LBB1_107
# %bb.99:                               # %.lr.ph134.preheader.i.i
                                        #   in Loop: Header=BB1_88 Depth=1
	sub.d	$t0, $s1, $s8
	bltu	$t0, $a3, .LBB1_107
# %bb.100:                              # %vector.ph341
...
# %bb.102:                              # %middle.block351
	...
	b	.LBB1_110
	.p2align	4, , 16
.LBB1_103:                              #   in Loop: Header=BB1_88 Depth=1
	move	$t2, $s8
	move	$t3, $s1
	.p2align	4, , 16
...
.LBB1_105:                              # %._crit_edge126.loopexit.i.i
	...
	move	$s8, $t2
	bne	$a7, $a1, .LBB1_98
.LBB1_106:                              #   in Loop: Header=BB1_88 Depth=1
	move	$t1, $s1
	move	$t0, $s8
	bgtz	$s3, .LBB1_111
	b	.LBB1_115
	.p2align	4, , 16
.LBB1_107:                              #   in Loop: Header=BB1_88 Depth=1
	move	$t2, $t3
	move	$t0, $s8
	move	$t1, $s1
...
.LBB1_111:                              # %._crit_edge135.i.i
                                        #   in Loop: Header=BB1_88 Depth=1
	blez	$s7, .LBB1_115
# %bb.112:                              #   in Loop: Header=BB1_88 Depth=1
	add.w	$s7, $a7, $s7
	addi.d	$s1, $t1, -1
	st.b	$a0, $t1, -1
	addi.d	$s8, $t0, -1
	...
	b	.LBB1_114
	.p2align	4, , 16
.LBB1_113:                              #   in Loop: Header=BB1_88 Depth=1
	addi.w	$a5, $s3, -1
	move	$a7, $a1
	nor	$t0, $a5, $zero
	add.w	$t1, $s3, $t0
