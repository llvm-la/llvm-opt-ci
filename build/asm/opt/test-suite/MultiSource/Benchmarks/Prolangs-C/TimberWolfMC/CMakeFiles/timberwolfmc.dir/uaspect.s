...
.LBB0_109:                              #   in Loop: Header=BB0_110 Depth=2
	...
	addi.w	$s6, $s6, 1
	bge	$s6, $a0, .LBB0_92
.LBB0_110:                              # %.lr.ph797.split.split.us
                                        #   Parent Loop BB0_93 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s8, $s8, 0
	ld.d	$s4, $s4, 0
...
# %bb.124:                              # %.lr.ph809
	...
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB0_129
# %bb.125:                              # %.lr.ph809.split.us.preheader
                                        #   in Loop: Header=BB0_121 Depth=1
	move	$s3, $zero
	addi.d	$s1, $a0, 20
...
# %bb.128:                              #   in Loop: Header=BB0_127 Depth=2
	...
	st.w	$a0, $s2, 0
	b	.LBB0_126
.LBB0_129:                              # %.lr.ph809.split
                                        #   in Loop: Header=BB0_121 Depth=1
	bnez	$a5, .LBB0_134
# %bb.130:                              # %.lr.ph809.split.split.us.preheader
                                        #   in Loop: Header=BB0_121 Depth=1
	move	$s3, $zero
	addi.d	$s1, $a0, 16
	ld.d	$s6, $sp, 88                    # 8-byte Folded Reload
...
.LBB0_131:                              #   in Loop: Header=BB0_132 Depth=2
	...
	addi.d	$s1, $s1, 16
	bge	$s3, $a0, .LBB0_120
.LBB0_132:                              # %.lr.ph809.split.split.us
                                        #   Parent Loop BB0_121 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s6, -4
	st.d	$a0, $s1, 0
...
# %bb.133:                              #   in Loop: Header=BB0_132 Depth=2
	...
	st.w	$a0, $s1, 0
	b	.LBB0_131
.LBB0_134:                              # %.lr.ph809.split.split.preheader
                                        #   in Loop: Header=BB0_121 Depth=1
	move	$s6, $zero
	addi.d	$s1, $a0, 20
