...
# %bb.53:                               # %iter.check181
	...
	ori	$a2, $zero, 32
	bltu	$a1, $a2, .LBB4_75
# %bb.54:                               # %vector.main.loop.iter.check183
                                        #   in Loop: Header=BB4_23 Depth=1
	ori	$a0, $zero, 32
	bgeu	$s8, $a0, .LBB4_71
# %bb.55:                               #   in Loop: Header=BB4_23 Depth=1
	move	$a0, $zero
.LBB4_56:                               # %vec.epilog.ph198
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a3, $a0
	bstrpick.d	$a0, $s8, 30, 4
	slli.d	$a0, $a0, 4
	...
	add.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB4_57:                               # %vec.epilog.vector.body201
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vst	$vr0, $a2, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB4_57
# %bb.58:                               # %vec.epilog.middle.block205
                                        #   in Loop: Header=BB4_23 Depth=1
	bne	$a0, $s8, .LBB4_75
	b	.LBB4_77
.LBB4_59:                               # %vector.ph158
                                        #   in Loop: Header=BB4_23 Depth=1
	andi	$a1, $s8, 16
...
.LBB4_72:                               # %vector.body187
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB4_72
# %bb.73:                               # %middle.block192
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_77
# %bb.74:                               # %vec.epilog.iter.check196
                                        #   in Loop: Header=BB4_23 Depth=1
	bnez	$a1, .LBB4_56
.LBB4_75:                               # %vec.epilog.scalar.ph195.preheader
                                        #   in Loop: Header=BB4_23 Depth=1
	sub.d	$a1, $s8, $a0
	add.d	$a2, $s5, $a0
	add.d	$a0, $s0, $a0
	.p2align	4, , 16
.LBB4_76:                               # %vec.epilog.scalar.ph195
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a0, 0
	st.b	$a3, $a2, 0
