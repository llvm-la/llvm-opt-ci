...
.LBB0_24:                               # %._crit_edge.thread
	...
	or	$a1, $t3, $a1
	b	.LBB0_37
.LBB0_25:                               # %.lr.ph365.preheader
	move	$a6, $zero
	sll.w	$a7, $t0, $a4
	move	$s2, $s8
	st.w	$a7, $s8, 0
	bstrpick.d	$t6, $a3, 31, 0
	addi.d	$t1, $a5, 4
	alsl.d	$a7, $s1, $t1, 2
	alsl.d	$t1, $s4, $t1, 2
	addi.d	$t2, $t6, -1
...
.LBB0_37:
	...
	ori	$t0, $zero, 1
	bgeu	$a2, $a0, .LBB0_39
# %bb.38:                               # %SetGroupSize.exit.sink.split
	lu12i.w	$a2, -262144
	lu32i.d	$a2, 0
	or	$a1, $a1, $a2
	st.w	$a1, $s0, 0
...
.LBB1_9:                                # %.lr.ph213
	...
	addi.d	$a3, $a3, 4
	bnez	$a1, .LBB1_9
# %bb.10:                               # %._crit_edge214.loopexit
	bstrpick.d	$a1, $a0, 31, 0
	b	.LBB1_12
.LBB1_11:
	move	$a1, $zero
.LBB1_12:                               # %._crit_edge214
	ldx.bu	$a2, $s1, $a1
	ld.bu	$a3, $s1, 0
	slli.d	$a2, $a2, 10
	add.d	$a2, $s2, $a2
...
# %bb.21:                               #   in Loop: Header=BB1_18 Depth=1
	...
	st.w	$a7, $a6, 4
	b	.LBB1_16
.LBB1_22:                               # %.preheader204.preheader
	beqz	$fp, .LBB1_43
# %bb.23:                               # %.lr.ph228.us.preheader
	slli.d	$a0, $a0, 32
	ori	$a1, $zero, 0
	lu32i.d	$a1, -524288
	lu52i.d	$a1, $a1, 0
...
# %bb.36:                               #   in Loop: Header=BB1_28 Depth=2
	...
	stx.w	$a5, $s0, $a2
.LBB1_37:                               #   in Loop: Header=BB1_28 Depth=2
	add.w	$a2, $a3, $a0
...
# %bb.38:                               #   in Loop: Header=BB1_28 Depth=2
	...
	st.w	$a0, $a3, 4
	b	.LBB1_27
.LBB1_39:                               # %.lr.ph232.preheader
	move	$a3, $zero
	b	.LBB1_41
	.p2align	4, , 16
.LBB1_40:                               # %.lr.ph232._crit_edge
