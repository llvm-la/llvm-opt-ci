...
.LBB12_26:                              # %.lr.ph.i
	...
	addi.w	$s1, $s1, -1
	bnez	$s1, .LBB12_26
.LBB12_27:                              # %unary_bin_encode.exit
	move	$a0, $s0
	move	$a1, $zero
	move	$a2, $s3
	pcaddu18i	$ra, %call36(biari_encode_symbol)
...
# %bb.8:                                # %.lr.ph.5
	...
	alsl.d	$s0, $a0, $s0, 4
	bne	$s1, $a1, .LBB16_10
.LBB16_9:                               # %exp_golomb_encode_eq_prob.exit.sink.split
	move	$a0, $fp
	move	$a1, $zero
	move	$a2, $s0
	ld.d	$s3, $sp, 0                     # 8-byte Folded Reload
...
.LBB16_14:                              # %.lr.ph20.i
	...
	addi.w	$s1, $s1, -1
	bne	$s1, $s2, .LBB16_14
# %bb.15:                               # %exp_golomb_encode_eq_prob.exit
	ld.d	$s3, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
...
.LBB17_7:                               # %.lr.ph.i
	...
	bnez	$s4, .LBB17_7
	b	.LBB17_9
.LBB17_8:                               # %unary_bin_max_encode.exit.sink.split
	move	$a0, $s0
	move	$a1, $zero
	move	$a2, $s3
	pcaddu18i	$ra, %call36(biari_encode_symbol)
	jirl	$ra, $ra, 0
.LBB17_9:                               # %unary_bin_max_encode.exit
	ld.d	$a0, $s2, 0
	ori	$a1, $zero, 1
	st.w	$a1, $a0, 40
	move	$a0, $s0
...
.LBB21_4:
	...
	bgeu	$s6, $a2, .LBB21_6
	b	.LBB21_9
.LBB21_5:                               # %.switch.edge.thread133_crit_edge
	pcalau12i	$a0, %got_pc_hi20(img)
	ld.d	$a0, $a0, %got_pc_lo12(img)
	ld.d	$a0, $a0, 0
	move	$s8, $zero
	...
	st.d	$s8, $sp, 32                    # 8-byte Folded Spill
	bltu	$s6, $a2, .LBB21_9
.LBB21_6:                               # %switch.edge.thread133
	bnez	$s2, .LBB21_9
# %bb.7:                                # %switch.edge.thread133
	bnez	$s7, .LBB21_9
# %bb.8:
	move	$s8, $a4
	move	$fp, $a3
...
# %bb.0:                                # %.lr.ph
	...
	b	.LBB23_4
	.p2align	4, , 16
.LBB23_1:                               #   in Loop: Header=BB23_4 Depth=1
	sltui	$a0, $s5, 1
	addi.w	$a1, $s5, 1
	masknez	$s5, $a1, $a0
...
.LBB24_18:                              # %.lr.ph20.i
	...
	addi.w	$s1, $s1, -1
	bne	$s1, $s2, .LBB24_18
# %bb.19:                               # %exp_golomb_encode_eq_prob.exit
	ld.d	$s3, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
