...
.LBB3_8:                                # %scalar.ph172
	...
	addi.d	$s4, $s4, 2
	bnez	$s2, .LBB3_8
.LBB3_9:                                # %iter.check135
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s0, $a4, $s3, 1
	move	$t0, $s7
	bgeu	$a7, $s6, .LBB3_17
.LBB3_10:                               # %vec.epilog.scalar.ph151.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$t8, $t0, $t8, 1
	alsl.d	$s2, $t0, $ra, 1
	.p2align	4, , 16
.LBB3_11:                               # %vec.epilog.scalar.ph151
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$s3, $s2, 0
	ld.hu	$s4, $s0, 0
	...
	b	.LBB3_4
	.p2align	4, , 16
.LBB3_12:                               # %vector.memcheck168
                                        #   in Loop: Header=BB3_5 Depth=1
	sub.d	$t0, $t8, $ra
	move	$s2, $zero
	bltu	$t0, $s8, .LBB3_7
# %bb.13:                               # %vector.memcheck168
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$t0, $t6, $s3
	sub.d	$t0, $t8, $t0
	bltu	$t0, $s8, .LBB3_7
# %bb.14:                               # %vector.body177.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$t0, $a7, $s3, 1
	move	$s0, $ra
	move	$s2, $t8
...
.LBB3_15:                               # %vector.body177
	...
	addi.d	$s0, $s0, 16
	bnez	$s4, .LBB3_15
# %bb.16:                               # %middle.block182
                                        #   in Loop: Header=BB3_5 Depth=1
	move	$s2, $t7
	bne	$t7, $s7, .LBB3_7
	b	.LBB3_9
	.p2align	4, , 16
.LBB3_17:                               # %vector.memcheck119
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$s2, $t8, $t2
	add.d	$s4, $t8, $t3
	add.d	$t0, $ra, $t2
...
# %bb.18:                               # %vector.memcheck119
	...
	move	$t0, $s7
	bnez	$fp, .LBB3_10
# %bb.19:                               # %vector.main.loop.iter.check137
                                        #   in Loop: Header=BB3_5 Depth=1
	ori	$t0, $zero, 15
	bgeu	$a7, $t0, .LBB3_21
...
.LBB3_22:                               # %vector.body143
	...
	addi.d	$s3, $s3, 32
	bnez	$s2, .LBB3_22
# %bb.23:                               # %middle.block148
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.d	$t0, $sp, 48                    # 8-byte Folded Reload
	beq	$t5, $t0, .LBB3_4
# %bb.24:                               # %vec.epilog.iter.check152
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.d	$s2, $sp, 48                    # 8-byte Folded Reload
	ld.d	$t0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	beqz	$fp, .LBB3_10
.LBB3_25:                               # %vec.epilog.ph154
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.h	$t0, $s0, 0
	...
	alsl.d	$s3, $fp, $ra, 1
	.p2align	4, , 16
.LBB3_26:                               # %vec.epilog.vector.body159
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$fp, $s3, 0
	...
	addi.d	$s3, $s3, 8
	bnez	$t0, .LBB3_26
# %bb.27:                               # %vec.epilog.middle.block164
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.d	$t0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
	beq	$t5, $fp, .LBB3_4
	b	.LBB3_10
.LBB3_28:                               # %.lr.ph46.split
	bge	$a3, $a5, .LBB3_56
# %bb.29:                               # %.preheader.us48.preheader
	move	$a6, $zero
	ori	$t0, $zero, 1
	slt	$t2, $t0, $t1
	masknez	$t0, $t0, $t2
...
.LBB3_31:                               # %iter.check
	...
	move	$s7, $a3
	bgeu	$a7, $s2, .LBB3_34
.LBB3_32:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB3_31 Depth=1
	alsl.d	$s5, $s7, $s5, 1
	alsl.d	$s6, $s7, $s6, 1
	sub.d	$s7, $a5, $s7
	.p2align	4, , 16
.LBB3_33:                               # %vec.epilog.scalar.ph
...
# %bb.35:                               # %vector.memcheck
	...
	move	$s7, $a3
	bnez	$t5, .LBB3_32
# %bb.36:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB3_31 Depth=1
	bgeu	$a7, $s3, .LBB3_38
...
.LBB3_42:                               # %vec.epilog.ph
	...
	alsl.d	$ra, $t5, $s5, 1
	.p2align	4, , 16
.LBB3_43:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB3_31 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t5, $ra, 0
...
.LBB3_45:                               # %.lr.ph.us.preheader
	...
	b	.LBB3_47
	.p2align	4, , 16
.LBB3_46:                               # %..preheader_crit_edge.us
...
.LBB3_50:                               # %scalar.ph
	...
	b	.LBB3_46
	.p2align	4, , 16
.LBB3_51:                               # %vector.memcheck104
                                        #   in Loop: Header=BB3_47 Depth=1
	sub.d	$t8, $t5, $t4
	move	$t7, $zero
	bltu	$t8, $t3, .LBB3_49
# %bb.52:                               # %vector.memcheck104
                                        #   in Loop: Header=BB3_47 Depth=1
	add.d	$t8, $t0, $t6
	sub.d	$t8, $t5, $t8
	bltu	$t8, $t3, .LBB3_49
# %bb.53:                               # %vector.body111.preheader
                                        #   in Loop: Header=BB3_47 Depth=1
	alsl.d	$t7, $a7, $t6, 1
	move	$t8, $t4
	move	$fp, $t5
