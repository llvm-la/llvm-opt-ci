...
.LBB6_166:                              # %vector.body3791
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB6_166
# %bb.167:                              # %middle.block3796
                                        #   in Loop: Header=BB6_16 Depth=1
	bne	$a1, $a3, .LBB6_92
	b	.LBB6_94
.LBB6_168:                              #   in Loop: Header=BB6_16 Depth=1
	ld.d	$a3, $s5, 48
	st.w	$zero, $s5, 24
	beqz	$a3, .LBB6_170
# %bb.169:                              #   in Loop: Header=BB6_16 Depth=1
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	st.w	$a4, $a3, 72
...
.LBB6_298:                              # %.lr.ph2011
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$a2, .LBB6_380
# %bb.299:                              #   in Loop: Header=BB6_298 Depth=2
	ld.bu	$a5, $t2, 0
	sll.d	$a5, $a5, $a7
	add.d	$fp, $a5, $fp
	and	$a5, $t1, $fp
...
.LBB6_300:                              #   in Loop: Header=BB6_16 Depth=1
	...
	move	$a2, $s4
	move	$a4, $s1
.LBB6_301:                              # %._crit_edge2012.loopexit
                                        #   in Loop: Header=BB6_16 Depth=1
	move	$a7, $a5
	ld.bu	$t3, $t0, 0
	ld.hu	$t0, $t0, 2
...
.LBB6_383:                              # %.loopexit1268
	...
	b	.LBB6_391
.LBB6_384:                              # %.loopexit1268.loopexit2943
	move	$s4, $zero
	bstrpick.d	$a2, $t1, 31, 0
	alsl.w	$s1, $t1, $s1, 3
	add.d	$s8, $t2, $a2
	b	.LBB6_389
.LBB6_385:                              # %.loopexit1268.loopexit2944
	alsl.w	$s1, $s4, $s1, 3
	bstrpick.d	$a2, $s4, 31, 0
.LBB6_386:                              # %.loopexit1268
	...
	move	$s4, $zero
	b	.LBB6_391
.LBB6_387:                              # %.loopexit1268.loopexit2945
	move	$s4, $zero
...
.LBB6_407:
	...
	masknez	$a0, $a0, $a1
	or	$s3, $a4, $a0
.LBB6_408:                              # %inflateStateCheck.exit.thread
	move	$a0, $s3
...
.LBB6_409:
	...
	move	$s6, $a6
	b	.LBB6_391
.LBB6_410:                              # %..loopexit1268.loopexit4613_crit_edge
	add.d	$s8, $s8, $s0
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	st.d	$a2, $sp, 64                    # 8-byte Folded Spill
	move	$t3, $s7
...
.LBB6_412:
	move	$s0, $s8
	b	.LBB6_417
.LBB6_413:                              # %.loopexit1268.loopexit2948
	move	$s4, $zero
	bstrpick.d	$a3, $a2, 31, 0
	alsl.w	$s1, $a2, $a4, 3
	add.d	$s8, $s0, $a3
...
.LBB6_417:
	...
	move	$s8, $s0
	b	.LBB6_391
.LBB6_418:                              # %.loopexit1268.loopexit3806
	ori	$a2, $zero, 1
	b	.LBB6_383
.LBB6_419:
	move	$s1, $fp
