...
.LBB2_117:                              # %vector.body240
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_117
# %bb.118:                              # %middle.block244
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_121
.LBB2_119:                              # %scalar.ph235.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_120:                              # %scalar.ph235
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_144:                              # %vector.body288
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_144
# %bb.145:                              # %middle.block292
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_148
.LBB2_146:                              # %scalar.ph283.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_147:                              # %scalar.ph283
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_159:                              # %vector.body300
	...
	addi.d	$a7, $a7, 8
	bnez	$t0, .LBB2_159
# %bb.160:                              # %middle.block304
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a6, $a5, .LBB2_163
.LBB2_161:                              # %scalar.ph295.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_170:                              # %vector.body252
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_170
# %bb.171:                              # %middle.block256
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_201
.LBB2_172:                              # %scalar.ph247.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_173:                              # %scalar.ph247
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_185:                              # %vector.body276
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_185
# %bb.186:                              # %middle.block280
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_189
.LBB2_187:                              # %scalar.ph271.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_188:                              # %scalar.ph271
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_197:                              # %vector.body264
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_197
# %bb.198:                              # %middle.block268
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_201
.LBB2_199:                              # %scalar.ph259.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_200:                              # %scalar.ph259
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
