...
.LBB3_181:                              # %._crit_edge20.loopexit.i
	...
	move	$s5, $fp
	bne	$t4, $a2, .LBB3_174
.LBB3_182:                              #   in Loop: Header=BB3_164 Depth=1
	move	$t8, $s3
	move	$t7, $s5
	bne	$t2, $ra, .LBB3_187
	b	.LBB3_189
...
.LBB3_187:                              # %._crit_edge30.i
	...
	addi.w	$fp, $a0, 0
	beq	$t3, $fp, .LBB3_189
# %bb.188:                              #   in Loop: Header=BB3_164 Depth=1
...
.LBB3_199:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB3_199
.LBB3_200:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
...
# %bb.207:                              # %.lr.ph415
	...
	.p2align	4, , 16
.LBB3_208:                              # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 0
	ld.d	$a1, $fp, 0
	pcaddu18i	$ra, %call36(strcpy)
	jirl	$ra, $ra, 0
...
.LBB3_213:                              # %vector.body632
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB3_213
# %bb.214:                              # %middle.block642
	bne	$a4, $a5, .LBB3_64
	b	.LBB3_66
.LBB3_215:                              # %vector.memcheck645
	addi.d	$a5, $s5, 4
	alsl.d	$a6, $a1, $s5, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
...
.LBB6_37:                               # %._crit_edge341
	...
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
	ld.d	$fp, $a1, %pc_lo12(A__align_gapmap.cpmx1)
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
...
.LBB6_98:                               # %vector.body664
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_98
# %bb.99:                               # %middle.block671
	beq	$a2, $a4, .LBB6_102
.LBB6_100:                              # %scalar.ph655.preheader
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
...
.LBB6_105:                              # %vector.body679
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB6_105
# %bb.106:                              # %middle.block684
	beq	$a3, $a5, .LBB6_109
.LBB6_107:                              # %scalar.ph674.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_108:                              # %scalar.ph674
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_109:                              # %.loopexit
	...
	ld.d	$s6, $s8, %pc_lo12(A__align_gapmap.mseq1)
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$s4, $a0, %pc_lo12(A__align_gapmap.mseq2)
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(A__align_gapmap.ijp)
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	beqz	$a0, .LBB6_116
# %bb.110:
	ld.d	$a0, $s7, 0
...
.LBB6_120:                              # %vector.body644
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB6_120
# %bb.121:                              # %middle.block652
	bne	$a5, $a6, .LBB6_71
	b	.LBB6_73
.LBB6_122:                              # %.preheader2.i
	blez	$a2, .LBB6_127
# %bb.123:                              # %.lr.ph7.i
	slli.d	$a1, $s7, 32
	srai.d	$a1, $a1, 29
...
.LBB6_131:                              # %vector.body692
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB6_131
# %bb.132:                              # %middle.block699
	beq	$a1, $a3, .LBB6_135
.LBB6_133:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $s2, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
...
.LBB6_139:                              # %vector.body707
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB6_139
# %bb.140:                              # %middle.block713
	beq	$a4, $a5, .LBB6_143
.LBB6_141:                              # %scalar.ph702.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_142:                              # %scalar.ph702
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB6_145:                              # %.lr.ph41.i
	...
	ldx.w	$t4, $t1, $t5
	bltz	$t4, .LBB6_153
# %bb.146:                              #   in Loop: Header=BB6_145 Depth=1
	beqz	$t4, .LBB6_173
# %bb.147:                              #   in Loop: Header=BB6_145 Depth=1
	sub.d	$t1, $s7, $t4
	move	$t4, $a2
	nor	$t6, $t1, $zero
	add.w	$t7, $s7, $t6
	beqz	$t7, .LBB6_154
.LBB6_148:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB6_145 Depth=1
	bltu	$t7, $a6, .LBB6_160
# %bb.149:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB6_145 Depth=1
	sub.d	$t8, $s5, $s3
	bltu	$t8, $a6, .LBB6_160
# %bb.150:                              # %vector.ph742
	...
	move	$s5, $s1
	.p2align	4, , 16
.LBB6_151:                              # %vector.body746
                                        #   Parent Loop BB6_145 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr2, $s2, 0
	vst	$vr1, $s3, 0
	addi.d	$s5, $s5, -16
	...
	addi.d	$s3, $s3, -16
	bnez	$s5, .LBB6_151
# %bb.152:                              # %middle.block753
                                        #   in Loop: Header=BB6_145 Depth=1
	move	$s2, $a0
	bne	$s1, $s0, .LBB6_161
	b	.LBB6_162
	.p2align	4, , 16
.LBB6_153:                              #   in Loop: Header=BB6_145 Depth=1
	addi.d	$t1, $s7, -1
	nor	$t6, $t1, $zero
	add.w	$t7, $s7, $t6
	bnez	$t7, .LBB6_148
	.p2align	4, , 16
.LBB6_154:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB6_145 Depth=1
	beq	$t4, $a2, .LBB6_163
.LBB6_155:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB6_145 Depth=1
	addi.w	$t6, $zero, -9
	nor	$fp, $t4, $zero
	bltu	$t6, $t4, .LBB6_164
# %bb.156:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB6_145 Depth=1
	sub.d	$t6, $s5, $s3
	bltu	$t6, $a5, .LBB6_164
# %bb.157:                              # %vector.ph721
...
# %bb.159:                              # %middle.block731
	...
	b	.LBB6_167
	.p2align	4, , 16
.LBB6_160:                              #   in Loop: Header=BB6_145 Depth=1
	move	$t8, $s3
	move	$fp, $s5
	.p2align	4, , 16
.LBB6_161:                              # %.lr.ph19.i
...
.LBB6_162:                              # %._crit_edge20.loopexit.i
	...
	move	$s3, $t8
	bne	$t4, $a2, .LBB6_155
.LBB6_163:                              #   in Loop: Header=BB6_145 Depth=1
	move	$t7, $s5
	move	$t6, $s3
	bne	$t2, $ra, .LBB6_168
	b	.LBB6_170
	.p2align	4, , 16
.LBB6_164:                              #   in Loop: Header=BB6_145 Depth=1
	move	$t8, $fp
	move	$t6, $s3
	move	$t7, $s5
...
.LBB6_168:                              # %._crit_edge30.i
	...
	addi.w	$t8, $s8, 0
	beq	$t3, $t8, .LBB6_170
# %bb.169:                              #   in Loop: Header=BB6_145 Depth=1
	slli.d	$t8, $t2, 2
	...
	fadd.s	$fa3, $fa3, $fa4
	fst.s	$fa3, $a1, 0
.LBB6_170:                              #   in Loop: Header=BB6_145 Depth=1
	blez	$t2, .LBB6_175
# %bb.171:                              #   in Loop: Header=BB6_145 Depth=1
	blez	$t3, .LBB6_175
# %bb.172:                              #   in Loop: Header=BB6_145 Depth=1
	add.d	$a7, $t4, $a7
	addi.d	$s5, $t7, -1
	st.b	$a3, $t7, -1
	addi.d	$s3, $t6, -1
	...
	b	.LBB6_174
	.p2align	4, , 16
.LBB6_173:                              #   in Loop: Header=BB6_145 Depth=1
	addi.d	$t1, $s7, -1
	move	$t4, $a2
	nor	$t6, $t1, $zero
	add.w	$t7, $s7, $t6
...
.LBB6_181:                              # %Atracking_localhom_gapmap.exit
	...
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
.LBB6_182:
	ld.d	$a0, $s8, %pc_lo12(A__align_gapmap.mseq1)
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
...
# %bb.184:
	blez	$s0, .LBB6_187
.LBB6_185:                              # %.lr.ph394
	ld.d	$fp, $s8, %pc_lo12(A__align_gapmap.mseq1)
	.p2align	4, , 16
