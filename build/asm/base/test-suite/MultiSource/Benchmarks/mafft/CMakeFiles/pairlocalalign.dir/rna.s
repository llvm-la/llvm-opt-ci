...
# %bb.132:                              #   in Loop: Header=BB1_121 Depth=1
	move	$fp, $zero
.LBB1_133:                              # %.preheader.lr.ph.i308.us.us405.preheader774
                                        #   in Loop: Header=BB1_121 Depth=1
	alsl.d	$a0, $fp, $t8, 2
	alsl.d	$a1, $fp, $t7, 2
...
.LBB1_138:                              # %vector.body732
	...
	addi.d	$a1, $a1, 32
	bnez	$fp, .LBB1_138
# %bb.139:                              # %middle.block741
                                        #   in Loop: Header=BB1_121 Depth=1
	move	$fp, $t2
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	beq	$a0, $t2, .LBB1_120
	.p2align	4, , 16
.LBB1_140:                              # %singleribosumscore.exit.us.preheader776
                                        #   in Loop: Header=BB1_121 Depth=1
	alsl.d	$a0, $fp, $t8, 2
	alsl.d	$a1, $fp, $t7, 2
	ld.d	$t7, $sp, 264                   # 8-byte Folded Reload
...
.LBB1_155:                              # %.preheader318.us
	...
	alsl.d	$t5, $t3, $a4, 3
	bge	$t3, $t0, .LBB1_163
# %bb.156:                              # %.lr.ph424.split.us.split.us474.preheader
                                        #   in Loop: Header=BB1_155 Depth=2
	move	$t6, $zero
	b	.LBB1_158
	.p2align	4, , 16
...
# %bb.162:                              #   in Loop: Header=BB1_160 Depth=4
	...
	b	.LBB1_159
	.p2align	4, , 16
.LBB1_163:                              # %.lr.ph424.split.us464
                                        #   in Loop: Header=BB1_155 Depth=2
	bge	$t0, $t3, .LBB1_171
# %bb.164:                              # %.lr.ph424.split.split.us.us.preheader
                                        #   in Loop: Header=BB1_155 Depth=2
	move	$t6, $zero
	b	.LBB1_166
	.p2align	4, , 16
.LBB1_165:                              # %._crit_edge417.split.us.split.us441.us
                                        #   in Loop: Header=BB1_166 Depth=3
	addi.d	$t6, $t6, 1
	beq	$t6, $a1, .LBB1_154
.LBB1_166:                              # %.lr.ph424.split.split.us.us
                                        #   Parent Loop BB1_151 Depth=1
                                        #     Parent Loop BB1_155 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_168 Depth 4
...
# %bb.170:                              #   in Loop: Header=BB1_168 Depth=4
	...
	b	.LBB1_167
	.p2align	4, , 16
.LBB1_171:                              # %.lr.ph424.split.split.us471.preheader
                                        #   in Loop: Header=BB1_155 Depth=2
	move	$t3, $zero
	b	.LBB1_173
	.p2align	4, , 16
.LBB1_172:                              # %._crit_edge417.split.us.split.us.us
                                        #   in Loop: Header=BB1_173 Depth=3
	addi.d	$t3, $t3, 1
	beq	$t3, $a1, .LBB1_154
.LBB1_173:                              # %.lr.ph424.split.split.us471
                                        #   Parent Loop BB1_151 Depth=1
                                        #     Parent Loop BB1_155 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_174 Depth 4
