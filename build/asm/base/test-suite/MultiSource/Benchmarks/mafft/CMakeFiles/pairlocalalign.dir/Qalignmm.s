...
# %bb.128:                              # %.lr.ph589
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB3_221
.LBB3_129:                              # %scalar.ph1164.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a5, $a4, $t3, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB3_130:                              # %scalar.ph1164
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a5, 0
...
.LBB3_148:                              # %.lr.ph593
	...
	ori	$a4, $zero, 1
	bltu	$a3, $a5, .LBB3_153
# %bb.149:                              # %vector.memcheck1182
	sub.d	$a5, $a0, $t3
	addi.d	$a5, $a5, 4
	ori	$a6, $zero, 32
	bltu	$a5, $a6, .LBB3_153
# %bb.150:                              # %vector.ph1185
	move	$a6, $zero
	move	$a5, $a3
...
.LBB3_151:                              # %vector.body1190
	...
	addi.d	$a6, $a6, 32
	bnez	$t0, .LBB3_151
# %bb.152:                              # %middle.block1196
	beq	$a3, $a5, .LBB3_155
.LBB3_153:                              # %scalar.ph1183.preheader
	slli.d	$a3, $a4, 2
	addi.d	$a5, $t3, -4
	sub.d	$a2, $a2, $a4
	movgr2fr.w	$fa0, $s3
	.p2align	4, , 16
.LBB3_154:                              # %scalar.ph1183
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a5, $a3
	stx.w	$zero, $a1, $a3
...
.LBB3_166:                              # %.lr.ph.preheader.i531
	...
	ori	$a1, $zero, 7
	bltu	$a0, $a1, .LBB3_169
# %bb.167:                              # %vector.memcheck1199
                                        #   in Loop: Header=BB3_162 Depth=1
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a3, $a1
	bgeu	$t2, $a0, .LBB3_180
# %bb.168:                              # %vector.memcheck1199
                                        #   in Loop: Header=BB3_162 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a3, $a0, .LBB3_180
...
.LBB3_188:                              # %vector.body1236
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_188
# %bb.189:                              # %middle.block1243
	beq	$a2, $a4, .LBB3_192
.LBB3_190:                              # %scalar.ph1227.preheader
	sub.w	$a2, $s6, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_195:                              # %vector.body1251
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB3_195
# %bb.196:                              # %middle.block1256
	beq	$a3, $a5, .LBB3_199
.LBB3_197:                              # %scalar.ph1246.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_198:                              # %scalar.ph1246
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_219:                              # %vector.body1133
	...
	addi.d	$t0, $t0, 16
	bnez	$t2, .LBB3_219
# %bb.220:                              # %middle.block1143
	bne	$a6, $t1, .LBB3_125
	b	.LBB3_127
.LBB3_221:                              # %vector.memcheck1146
	addi.d	$a6, $t3, 4
	alsl.d	$t0, $a3, $t3, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.222:                              # %vector.memcheck1146
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.223:                              # %vector.memcheck1146
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_225:                              # %vector.body1169
	...
	addi.d	$a7, $a7, 16
	bnez	$t1, .LBB3_225
# %bb.226:                              # %middle.block1179
	bne	$a5, $t0, .LBB3_129
	b	.LBB3_131
.LBB3_227:                              # %vector.ph1261
...
.LBB3_236:                              # %vector.body1279
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_236
# %bb.237:                              # %middle.block1285
	beq	$a4, $a5, .LBB3_240
.LBB3_238:                              # %scalar.ph1274.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_239:                              # %scalar.ph1274
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_258:                              # %.lr.ph19.i
	...
	addi.d	$t8, $t8, -1
	bnez	$t7, .LBB3_258
.LBB3_259:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_242 Depth=1
	add.d	$a7, $s7, $a7
	add.d	$a7, $t6, $a7
	move	$s3, $fp
	move	$s5, $t8
	bne	$t3, $s8, .LBB3_252
.LBB3_260:                              #   in Loop: Header=BB3_242 Depth=1
	move	$t7, $s3
	move	$t6, $s5
	bne	$t1, $ra, .LBB3_265
	b	.LBB3_267
...
.LBB3_265:                              # %._crit_edge30.i
	...
	addi.w	$t8, $t8, 0
	beq	$t2, $t8, .LBB3_267
# %bb.266:                              #   in Loop: Header=BB3_242 Depth=1
	...
	fadd.s	$fa3, $fa3, $fa4
	fst.s	$fa3, $a1, 0
.LBB3_267:                              #   in Loop: Header=BB3_242 Depth=1
	blez	$t1, .LBB3_272
# %bb.268:                              #   in Loop: Header=BB3_242 Depth=1
	blez	$t2, .LBB3_272
# %bb.269:                              #   in Loop: Header=BB3_242 Depth=1
	...
	b	.LBB3_271
	.p2align	4, , 16
.LBB3_270:                              #   in Loop: Header=BB3_242 Depth=1
	addi.d	$t0, $s7, -1
	move	$t3, $s8
	nor	$t6, $t0, $zero
	add.w	$t7, $s7, $t6
...
.LBB3_274:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_274
.LBB3_275:                              # %.preheader.i
	ld.d	$s7, $sp, 64                    # 8-byte Folded Reload
	blez	$s7, .LBB3_278
# %bb.276:                              # %.lr.ph52.preheader.i
...
.LBB3_277:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB3_277
.LBB3_278:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
...
.LBB5_52:                               # %._crit_edge20.loopexit
	...
	move	$s1, $t4
	bne	$t1, $ra, .LBB5_34
.LBB5_53:                               #   in Loop: Header=BB5_29 Depth=1
	move	$t3, $s2
	move	$t2, $s1
	blez	$a7, .LBB5_61
.LBB5_54:                               # %._crit_edge30
                                        #   in Loop: Header=BB5_29 Depth=1
	blez	$t0, .LBB5_61
# %bb.55:                               #   in Loop: Header=BB5_29 Depth=1
	add.d	$s7, $t1, $s7
	addi.d	$s2, $t3, -1
	st.b	$a1, $t3, -1
	addi.d	$s1, $t2, -1
...
.LBB6_147:                              # %vector.body1147
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB6_147
# %bb.148:                              # %middle.block1153
	ld.d	$t4, $sp, 352                   # 8-byte Folded Reload
	beq	$a5, $a7, .LBB6_151
.LBB6_149:                              # %scalar.ph1140.preheader
	slli.d	$a5, $a6, 2
	addi.d	$a7, $t5, -4
	sub.d	$a4, $a4, $a6
	movgr2fr.w	$fa0, $a0
	.p2align	4, , 16
.LBB6_150:                              # %scalar.ph1140
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a7, $a5
	stx.w	$zero, $a3, $a5
	fmadd.s	$fa1, $ft10, $fa0, $fa1
...
.LBB6_178:                              # %vector.body1165
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_178
# %bb.179:                              # %middle.block1172
	beq	$a2, $a4, .LBB6_182
.LBB6_180:                              # %scalar.ph1156.preheader
...
.LBB6_185:                              # %vector.body1180
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB6_185
# %bb.186:                              # %middle.block1185
	beq	$a3, $a5, .LBB6_189
.LBB6_187:                              # %scalar.ph1175.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_188:                              # %scalar.ph1175
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_209:                              # %vector.body1090
	...
	addi.d	$t2, $t2, 16
	bnez	$t4, .LBB6_209
# %bb.210:                              # %middle.block1100
	ld.d	$t4, $sp, 352                   # 8-byte Folded Reload
	bne	$t0, $t3, .LBB6_122
	b	.LBB6_124
.LBB6_211:                              # %vector.memcheck1103
	addi.d	$t0, $t5, 4
	alsl.d	$t2, $a5, $t5, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_126
# %bb.212:                              # %vector.memcheck1103
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_126
# %bb.213:                              # %vector.memcheck1103
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB6_215:                              # %vector.body1126
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB6_215
# %bb.216:                              # %middle.block1136
	bne	$a7, $t2, .LBB6_126
	b	.LBB6_128
.LBB6_217:                              # %vector.ph1190
...
.LBB6_226:                              # %vector.body1208
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_226
# %bb.227:                              # %middle.block1214
	beq	$a3, $a4, .LBB6_230
.LBB6_228:                              # %scalar.ph1203.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_229:                              # %scalar.ph1203
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
