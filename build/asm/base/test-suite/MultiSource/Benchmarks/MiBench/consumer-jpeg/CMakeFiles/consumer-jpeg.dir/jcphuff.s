...
.LBB5_39:                               #   in Loop: Header=BB5_16 Depth=2
	beqz	$a0, .LBB5_41
# %bb.40:                               # %emit_bits.exit124.thread
                                        #   in Loop: Header=BB5_16 Depth=2
	st.w	$zero, $fp, 92
	ld.d	$s8, $sp, 80                    # 8-byte Folded Reload
	b	.LBB5_75
.LBB5_41:                               #   in Loop: Header=BB5_16 Depth=2
	...
	ori	$a3, $zero, 8
	blt	$a1, $a3, .LBB5_53
# %bb.42:                               # %.lr.ph.i117.preheader
                                        #   in Loop: Header=BB5_16 Depth=2
	add.d	$s6, $a2, $s7
	ld.d	$s8, $sp, 80                    # 8-byte Folded Reload
	b	.LBB5_45
.LBB5_43:                               # %dump_buffer.exit32.i121
                                        #   in Loop: Header=BB5_45 Depth=3
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	.p2align	4, , 16
.LBB5_44:                               #   in Loop: Header=BB5_45 Depth=3
	addi.w	$s6, $s6, -8
	slli.d	$s1, $s1, 8
	bge	$s3, $s6, .LBB5_54
.LBB5_45:                               # %.lr.ph.i117
...
# %bb.46:                               #   in Loop: Header=BB5_45 Depth=3
	...
	b	.LBB5_50
	.p2align	4, , 16
.LBB5_47:                               #   in Loop: Header=BB5_45 Depth=3
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_49
# %bb.48:                               #   in Loop: Header=BB5_45 Depth=3
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s4, $a1, 40
	jirl	$ra, $a2, 0
.LBB5_49:                               # %dump_buffer.exit.i123
                                        #   in Loop: Header=BB5_45 Depth=3
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	and	$a0, $s1, $s2
	bne	$a0, $s2, .LBB5_44
.LBB5_50:                               #   in Loop: Header=BB5_45 Depth=3
	ld.d	$a0, $fp, 32
	addi.d	$a1, $a0, 1
	st.d	$a1, $fp, 32
	st.b	$zero, $a0, 0
	...
	st.d	$a0, $fp, 40
	bnez	$a0, .LBB5_44
# %bb.51:                               #   in Loop: Header=BB5_45 Depth=3
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_43
# %bb.52:                               #   in Loop: Header=BB5_45 Depth=3
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s4, $a1, 40
...
.LBB5_53:                               #   in Loop: Header=BB5_16 Depth=2
	...
	ld.d	$s8, $sp, 80                    # 8-byte Folded Reload
	b	.LBB5_55
.LBB5_54:                               # %._crit_edge.i114.loopexit
                                        #   in Loop: Header=BB5_16 Depth=2
	ld.w	$a0, $fp, 24
	addi.d	$a1, $s6, -8
.LBB5_55:                               # %._crit_edge.i114
                                        #   in Loop: Header=BB5_16 Depth=2
	st.d	$s1, $fp, 48
	st.w	$a1, $fp, 56
	ld.w	$s1, $fp, 96
	st.w	$zero, $fp, 92
	beqz	$s1, .LBB5_75
.LBB5_56:                               # %emit_bits.exit124
                                        #   in Loop: Header=BB5_16 Depth=2
	bnez	$a0, .LBB5_75
# %bb.57:                               # %.preheader.i.i.preheader
                                        #   in Loop: Header=BB5_16 Depth=2
	ld.d	$s7, $fp, 104
	b	.LBB5_61
.LBB5_58:                               # %._crit_edge.i.loopexit
                                        #   in Loop: Header=BB5_61 Depth=3
	addi.d	$a0, $s8, -8
	ld.d	$s8, $sp, 80                    # 8-byte Folded Reload
.LBB5_59:                               # %._crit_edge.i
                                        #   in Loop: Header=BB5_61 Depth=3
	st.d	$s6, $fp, 48
	st.w	$a0, $fp, 56
...
# %bb.62:                               #   in Loop: Header=BB5_61 Depth=3
	...
	ori	$a1, $zero, 7
	blt	$a0, $a1, .LBB5_74
# %bb.63:                               # %.lr.ph.i.preheader
                                        #   in Loop: Header=BB5_61 Depth=3
	addi.d	$s8, $a0, 9
	b	.LBB5_66
.LBB5_64:                               # %dump_buffer.exit32.i
                                        #   in Loop: Header=BB5_66 Depth=4
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	.p2align	4, , 16
.LBB5_65:                               #   in Loop: Header=BB5_66 Depth=4
	addi.w	$s8, $s8, -8
	slli.d	$s6, $s6, 8
	bge	$s3, $s8, .LBB5_58
.LBB5_66:                               # %.lr.ph.i
	...
	st.d	$a0, $fp, 40
	beqz	$a0, .LBB5_68
# %bb.67:                               #   in Loop: Header=BB5_66 Depth=4
	and	$a0, $s6, $s2
	bne	$a0, $s2, .LBB5_65
	b	.LBB5_71
	.p2align	4, , 16
.LBB5_68:                               #   in Loop: Header=BB5_66 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_70
# %bb.69:                               #   in Loop: Header=BB5_66 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s4, $a1, 40
...
.LBB5_70:                               # %dump_buffer.exit.i
	...
	and	$a0, $s6, $s2
	bne	$a0, $s2, .LBB5_65
.LBB5_71:                               #   in Loop: Header=BB5_66 Depth=4
	ld.d	$a0, $fp, 32
	addi.d	$a1, $a0, 1
	st.d	$a1, $fp, 32
	st.b	$zero, $a0, 0
	...
	st.d	$a0, $fp, 40
	bnez	$a0, .LBB5_65
# %bb.72:                               #   in Loop: Header=BB5_66 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_64
# %bb.73:                               #   in Loop: Header=BB5_66 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s4, $a1, 40
...
.LBB5_76:                               # %emit_eobrun.exit
	...
	slli.d	$a0, $a0, 3
	bnez	$a1, .LBB5_14
# %bb.77:                               #   in Loop: Header=BB5_16 Depth=2
	addi.d	$a1, $fp, 120
	ldx.d	$a0, $a1, $a0
	ld.wu	$s6, $a0, 960
	ld.b	$s1, $a0, 1264
...
# %bb.79:                               # %emit_symbol.exit
	...
	bnez	$s5, .LBB5_91
	b	.LBB5_15
.LBB5_80:                               # %dump_buffer.exit32.i147
                                        #   in Loop: Header=BB5_82 Depth=3
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	.p2align	4, , 16
.LBB5_81:                               #   in Loop: Header=BB5_82 Depth=3
	slli.d	$s1, $s1, 8
	addi.w	$a0, $s4, -8
	bge	$s3, $s4, .LBB5_90
.LBB5_82:                               # %.lr.ph.i143
...
# %bb.83:                               #   in Loop: Header=BB5_82 Depth=3
	...
	b	.LBB5_87
	.p2align	4, , 16
.LBB5_84:                               #   in Loop: Header=BB5_82 Depth=3
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_86
# %bb.85:                               #   in Loop: Header=BB5_82 Depth=3
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s7, $a1, 40
	jirl	$ra, $a2, 0
.LBB5_86:                               # %dump_buffer.exit.i149
                                        #   in Loop: Header=BB5_82 Depth=3
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	and	$a0, $s1, $s2
...
.LBB5_87:                               #   in Loop: Header=BB5_82 Depth=3
	...
	st.d	$a0, $fp, 40
	bnez	$a0, .LBB5_81
# %bb.88:                               #   in Loop: Header=BB5_82 Depth=3
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
...
# %bb.89:                               #   in Loop: Header=BB5_82 Depth=3
	...
	jirl	$ra, $a2, 0
	b	.LBB5_80
.LBB5_90:                               # %._crit_edge.i140.loopexit
                                        #   in Loop: Header=BB5_16 Depth=2
	ld.w	$a1, $fp, 24
	sltui	$a1, $a1, 1
	st.d	$s1, $fp, 48
...
.LBB5_91:                               # %emit_symbol.exit
	...
	bnez	$a1, .LBB5_95
	b	.LBB5_15
.LBB5_92:                               # %._crit_edge.i152.loopexit
                                        #   in Loop: Header=BB5_95 Depth=3
	addi.d	$a0, $s6, -8
.LBB5_93:                               # %._crit_edge.i152
                                        #   in Loop: Header=BB5_95 Depth=3
	st.d	$s1, $fp, 48
	st.w	$a0, $fp, 56
.LBB5_94:                               # %emit_bits.exit162
                                        #   in Loop: Header=BB5_95 Depth=3
	addi.w	$s5, $s5, -1
	addi.d	$s8, $s8, 1
	beqz	$s5, .LBB5_15
.LBB5_95:                               # %.preheader.i101
                                        #   Parent Loop BB5_9 Depth=1
                                        #     Parent Loop BB5_16 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB5_100 Depth 4
	ld.w	$a0, $fp, 24
	bnez	$a0, .LBB5_94
# %bb.96:                               #   in Loop: Header=BB5_95 Depth=3
	ld.bu	$a1, $s8, 0
	ld.w	$a0, $fp, 56
	ld.d	$a2, $fp, 48
	andi	$a1, $a1, 1
	...
	ori	$a1, $zero, 7
	blt	$a0, $a1, .LBB5_108
# %bb.97:                               # %.lr.ph.i155.preheader
                                        #   in Loop: Header=BB5_95 Depth=3
	addi.d	$s6, $a0, 9
	ori	$s4, $zero, 22
	b	.LBB5_100
.LBB5_98:                               # %dump_buffer.exit32.i159
                                        #   in Loop: Header=BB5_100 Depth=4
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	.p2align	4, , 16
.LBB5_99:                               #   in Loop: Header=BB5_100 Depth=4
	addi.w	$s6, $s6, -8
	slli.d	$s1, $s1, 8
	bge	$s3, $s6, .LBB5_92
.LBB5_100:                              # %.lr.ph.i155
	...
	st.d	$a0, $fp, 40
	beqz	$a0, .LBB5_102
# %bb.101:                              #   in Loop: Header=BB5_100 Depth=4
	and	$a0, $s1, $s2
	bne	$a0, $s2, .LBB5_99
	b	.LBB5_105
	.p2align	4, , 16
.LBB5_102:                              #   in Loop: Header=BB5_100 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_104
# %bb.103:                              #   in Loop: Header=BB5_100 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s4, $a1, 40
	jirl	$ra, $a2, 0
.LBB5_104:                              # %dump_buffer.exit.i161
                                        #   in Loop: Header=BB5_100 Depth=4
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	and	$a0, $s1, $s2
	bne	$a0, $s2, .LBB5_99
.LBB5_105:                              #   in Loop: Header=BB5_100 Depth=4
	ld.d	$a0, $fp, 32
	addi.d	$a1, $a0, 1
	st.d	$a1, $fp, 32
	st.b	$zero, $a0, 0
	...
	st.d	$a0, $fp, 40
	bnez	$a0, .LBB5_99
# %bb.106:                              #   in Loop: Header=BB5_100 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_98
# %bb.107:                              #   in Loop: Header=BB5_100 Depth=4
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s4, $a1, 40
...
.LBB5_108:                              #   in Loop: Header=BB5_95 Depth=3
	addi.d	$a0, $a0, 1
	b	.LBB5_93
.LBB5_109:                              #   in Loop: Header=BB5_16 Depth=2
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	ori	$a3, $zero, 39
...
.LBB5_111:                              #   in Loop: Header=BB5_9 Depth=1
	...
	slli.d	$a1, $a1, 3
	beqz	$a2, .LBB5_113
# %bb.112:                              #   in Loop: Header=BB5_9 Depth=1
	addi.d	$a2, $fp, 152
	ldx.d	$a1, $a2, $a1
	slli.d	$a0, $a0, 3
	ldx.d	$a2, $a1, $a0
	...
	stx.d	$a2, $a1, $a0
	b	.LBB5_114
.LBB5_113:                              #   in Loop: Header=BB5_9 Depth=1
	addi.d	$a2, $fp, 120
	ldx.d	$a2, $a2, $a1
	slli.d	$a1, $a0, 2
	ldx.w	$a1, $a2, $a1
...
.LBB5_114:                              # %emit_symbol.exit104
	...
	jirl	$ra, $ra, 0
	beqz	$s1, .LBB5_134
# %bb.115:                              # %emit_symbol.exit104
                                        #   in Loop: Header=BB5_9 Depth=1
	ld.w	$a0, $fp, 24
	bnez	$a0, .LBB5_134
# %bb.116:                              # %.preheader.i106.preheader
                                        #   in Loop: Header=BB5_9 Depth=1
	move	$a0, $zero
	bnez	$a0, .LBB5_132
	.p2align	4, , 16
.LBB5_117:                              #   in Loop: Header=BB5_9 Depth=1
	ld.bu	$a1, $s8, 0
	ld.w	$a0, $fp, 56
	ld.d	$a2, $fp, 48
	andi	$a1, $a1, 1
	...
	ori	$a1, $zero, 7
	blt	$a0, $a1, .LBB5_129
# %bb.118:                              # %.lr.ph.i167.preheader
                                        #   in Loop: Header=BB5_9 Depth=1
	addi.d	$s6, $a0, 9
	b	.LBB5_121
.LBB5_119:                              # %dump_buffer.exit32.i171
...
# %bb.124:                              #   in Loop: Header=BB5_121 Depth=2
	...
	st.w	$s4, $a1, 40
	jirl	$ra, $a2, 0
.LBB5_125:                              # %dump_buffer.exit.i173
                                        #   in Loop: Header=BB5_121 Depth=2
	vld	$vr0, $s0, 0
	vst	$vr0, $fp, 32
	and	$a0, $s5, $s2
	bne	$a0, $s2, .LBB5_120
.LBB5_126:                              #   in Loop: Header=BB5_121 Depth=2
	ld.d	$a0, $fp, 32
	addi.d	$a1, $a0, 1
	st.d	$a1, $fp, 32
	st.b	$zero, $a0, 0
	...
	st.d	$a0, $fp, 40
	bnez	$a0, .LBB5_120
# %bb.127:                              #   in Loop: Header=BB5_121 Depth=2
	ld.d	$a0, $fp, 64
	ld.d	$s0, $a0, 32
	ld.d	$a1, $s0, 24
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB5_119
# %bb.128:                              #   in Loop: Header=BB5_121 Depth=2
	ld.d	$a0, $fp, 64
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	st.w	$s4, $a1, 40
...
.LBB5_129:                              #   in Loop: Header=BB5_9 Depth=1
	...
	b	.LBB5_131
	.p2align	4, , 16
.LBB5_130:                              # %._crit_edge.i164.loopexit
                                        #   in Loop: Header=BB5_9 Depth=1
	addi.d	$a0, $s6, -8
.LBB5_131:                              # %._crit_edge.i164
                                        #   in Loop: Header=BB5_9 Depth=1
	st.d	$s5, $fp, 48
	st.w	$a0, $fp, 56
.LBB5_132:                              # %emit_bits.exit174
                                        #   Parent Loop BB5_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s1, $s1, -1
	beqz	$s1, .LBB5_134
# %bb.133:                              # %.preheader.i106thread-pre-split
	...
	b	.LBB5_117
	.p2align	4, , 16
.LBB5_134:                              # %emit_buffered_bits.exit110
                                        #   in Loop: Header=BB5_9 Depth=1
	ld.d	$s8, $fp, 104
	move	$s5, $zero
	move	$s6, $zero
.LBB5_135:                              #   in Loop: Header=BB5_9 Depth=1
	ld.d	$a5, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a7, $sp, 40                    # 8-byte Folded Reload
	addi.d	$a5, $a5, 1
	addi.w	$a0, $a5, 0
	bne	$a7, $a0, .LBB5_9
.LBB5_136:                              # %._crit_edge204.loopexit
	slt	$a0, $zero, $s6
	ld.d	$s3, $sp, 8                     # 8-byte Folded Reload
	bnez	$a0, .LBB5_138
.LBB5_137:                              # %._crit_edge204
	beqz	$s5, .LBB5_141
.LBB5_138:
	ld.w	$a0, $fp, 92
	ld.w	$a1, $fp, 96
