...
.Lcst_end0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	5                               # -- Begin function _ZN12_GLOBAL__N_18BM_basicERN9benchmark5StateE
...
.Lcst_end1:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	5                               # -- Begin function _ZN12_GLOBAL__N_113BM_basic_slowERN9benchmark5StateE
...
.Lfunc_end3:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	5                               # -- Begin function _ZN12_GLOBAL__N_110CustomArgsEPN9benchmark9BenchmarkE
...
.Lcst_end2:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	5                               # -- Begin function _ZN12_GLOBAL__N_127BM_explicit_iteration_countERN9benchmark5StateE
...
# %bb.149:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_150:                             # %_ZNSt6vectorISt4pairIllESaIS1_EED2Ev.exit.i245
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB11_152
# %bb.151:                              # %_ZNKSt14default_deleteIN9benchmark9BenchmarkEEclEPS1_.exit.i.i247
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
.LBB11_152:                             # %_ZNSt10unique_ptrIN9benchmark9BenchmarkESt14default_deleteIS1_EED2Ev.exit.i248
	ld.d	$a0, $sp, 48
	st.d	$zero, $sp, 56
	beqz	$a0, .LBB11_154
# %bb.153:                              # %_ZNKSt14default_deleteIN9benchmark8internal17FunctionBenchmarkEEclEPS2_.exit.i.i250
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
...
.LBB11_158:                             # %_ZNSt14_Function_baseD2Ev.exit.i
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB11_160
# %bb.159:                              # %_ZNKSt14default_deleteIN9benchmark9BenchmarkEEclEPS1_.exit.i.i255
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
.LBB11_160:                             # %_ZNSt10unique_ptrIN9benchmark9BenchmarkESt14default_deleteIS1_EED2Ev.exit.i256
	ld.d	$a0, $sp, 48
	st.d	$zero, $sp, 56
	beqz	$a0, .LBB11_162
# %bb.161:                              # %_ZNKSt14default_deleteIN9benchmark8internal17FunctionBenchmarkEEclEPS2_.exit.i.i257
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
...
# %bb.164:
	...
	ld.d	$a0, $sp, 8
	beqz	$a0, .LBB11_166
# %bb.165:                              # %_ZNKSt14default_deleteIN9benchmark9BenchmarkEEclEPS1_.exit.i.i265
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
.LBB11_166:                             # %_ZNSt10unique_ptrIN9benchmark9BenchmarkESt14default_deleteIS1_EED2Ev.exit.i266
	ld.d	$a0, $sp, 56
	st.d	$zero, $sp, 8
	beqz	$a0, .LBB11_168
# %bb.167:                              # %_ZNKSt14default_deleteIN9benchmark8internal17FunctionBenchmarkEEclEPS2_.exit.i.i268
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
