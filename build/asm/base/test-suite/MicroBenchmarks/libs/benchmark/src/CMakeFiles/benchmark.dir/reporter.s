...
.LBB3_7:                                # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
	pcalau12i	$s0, %pc_hi20(_ZN9benchmark17BenchmarkReporter7Context15executable_nameE)
	ld.d	$a0, $s0, %pc_lo12(_ZN9benchmark17BenchmarkReporter7Context15executable_nameE)
	beqz	$a0, .LBB3_12
# %bb.8:
	...
	pcaddu18i	$ra, %call36(_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l)
	jirl	$ra, $ra, 0
	ld.d	$s1, $s0, %pc_lo12(_ZN9benchmark17BenchmarkReporter7Context15executable_nameE)
	beqz	$s1, .LBB3_10
# %bb.9:
	move	$a0, $s1
...
.Ltmp7:                                 # EH_LABEL
	...
	move	$fp, $a0
	beq	$a2, $s3, .LBB3_41
.LBB3_40:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i51
	ld.d	$a0, $sp, 40
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.L.str.20:
	.asciz	"***WARNING*** ASLR is enabled, the results may have unreproducible noise in them.\n"
	.size	.L.str.20, 83
