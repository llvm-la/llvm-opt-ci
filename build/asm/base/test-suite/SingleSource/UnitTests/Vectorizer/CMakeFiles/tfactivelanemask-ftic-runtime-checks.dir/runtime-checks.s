...
.LBB63_5:                               # %vector.ph
	...
	slli.d	$a5, $a4, 2
	addi.d	$a5, $a5, -4
	pcalau12i	$a6, %pc_hi20(.LCPI63_0)
	vld	$vr0, $a6, %pc_lo12(.LCPI63_0)
	pcalau12i	$a6, %pc_hi20(.LCPI63_1)
	vld	$vr1, $a6, %pc_lo12(.LCPI63_1)
	add.d	$a2, $a2, $a5
	add.d	$a3, $a3, $a5
	vreplgr2vr.d	$vr2, $a4
	b	.LBB63_7
...
.LBB67_5:                               # %vector.ph
	...
	slli.d	$a1, $a1, 1
	pcalau12i	$a5, %pc_hi20(.LCPI67_0)
	vld	$vr0, $a5, %pc_lo12(.LCPI67_0)
	alsl.d	$a2, $a4, $a2, 3
	alsl.d	$a3, $a4, $a3, 3
	vreplgr2vr.d	$vr1, $a4
	b	.LBB67_7
...
.LBB137_24:                             # %pred.load.continue39
                                        #   in Loop: Header=BB137_9 Depth=1
	vpickve2gr.b	$s0, $vr10, 14
	andi	$s0, $s0, 1
	bnez	$s0, .LBB137_71
.LBB137_25:                             # %pred.load.continue41
                                        #   in Loop: Header=BB137_9 Depth=1
	vpickve2gr.b	$s1, $vr10, 15
	andi	$s1, $s1, 1
	bnez	$s1, .LBB137_72
.LBB137_26:                             # %pred.load.continue43
                                        #   in Loop: Header=BB137_9 Depth=1
	vpickve2gr.b	$s2, $vr10, 0
	andi	$s2, $s2, 1
