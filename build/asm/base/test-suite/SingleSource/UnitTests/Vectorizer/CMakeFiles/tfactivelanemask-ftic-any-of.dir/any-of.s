...
.LBB12_5:                               # %pred.load.continue
                                        #   in Loop: Header=BB12_3 Depth=1
	vsadd.du	$vr9, $vr9, $vr0
	vshuf4i.w	$vr10, $vr8, 8
	vori.b	$vr11, $vr2, 0
	vshuf.w	$vr11, $vr8, $vr10
	vslt.du	$vr9, $vr9, $vr4
	vori.b	$vr8, $vr3, 0
	vshuf.w	$vr8, $vr9, $vr11
...
.LBB22_5:                               # %pred.load.continue
                                        #   in Loop: Header=BB22_3 Depth=1
	vsadd.du	$vr10, $vr8, $vr0
	vsadd.du	$vr11, $vr8, $vr1
	vsadd.du	$vr8, $vr8, $vr2
	vslt.du	$vr8, $vr8, $vr4
	vpickev.w	$vr8, $vr8, $vr9
	vslt.du	$vr9, $vr11, $vr4
...
# %bb.1:                                # %.lr.ph.preheader.i.i.i
	...
	vld	$vr1, $a1, %pc_lo12(.LCPI26_1)
	pcalau12i	$a1, %pc_hi20(.LCPI26_2)
	vld	$vr2, $a1, %pc_lo12(.LCPI26_2)
	pcalau12i	$a1, %pc_hi20(.LCPI26_3)
	vld	$vr3, $a1, %pc_lo12(.LCPI26_3)
	addi.d	$a1, $a4, 3
	bstrpick.d	$a1, $a1, 32, 2
	slli.d	$a1, $a1, 2
	addi.d	$a2, $a3, 8
...
# %bb.1:                                # %.lr.ph.preheader.i.i.i
	...
	vld	$vr0, $a1, %pc_lo12(.LCPI30_0)
	pcalau12i	$a1, %pc_hi20(.LCPI30_1)
	vld	$vr1, $a1, %pc_lo12(.LCPI30_1)
	pcalau12i	$a1, %pc_hi20(.LCPI30_2)
	vld	$vr2, $a1, %pc_lo12(.LCPI30_2)
	pcalau12i	$a1, %pc_hi20(.LCPI30_3)
	vld	$vr3, $a1, %pc_lo12(.LCPI30_3)
	addi.d	$a1, $a4, 3
	bstrpick.d	$a1, $a1, 32, 2
	slli.d	$a1, $a1, 2
	addi.d	$a2, $a3, 8
