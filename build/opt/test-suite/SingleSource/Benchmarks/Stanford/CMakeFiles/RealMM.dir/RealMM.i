# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/RealMM.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/RealMM.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/RealMM.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/RealMM.c" 2
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/RealMM.c"
struct node {
...
# 77 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/RealMM.c"
struct complex { double rp, ip; } ;





double value, fixed, floated;
...
double rma[40 +1][40 +1], rmb[40 +1][40 +1], rmr[40 +1][40 +1];
...
void rInitmatrix ( double m[40 +1][40 +1] ) {
 int temp, i, j;
 for ( i = 1; i <= 40; i++ )
     for ( j = 1; j <= 40; j++ ) {
      temp = Rand();
...
void rInnerproduct(double *result, double a[40 +1][40 +1], double b[40 +1][40 +1], int row, int column) {

 int i;
 *result = 0.0f;
 for (i = 1; i<=40; i++) *result = *result+a[row][i]*b[i][column];
}
