# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/FloatMM.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/FloatMM.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/FloatMM.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/FloatMM.c" 2
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/FloatMM.c"
struct node {
...
# 75 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Stanford/FloatMM.c"
...
void rInitmatrix ( float m[40 +1][40 +1] ) {
 int temp, i, j;
 for ( i = 1; i <= 40; i++ )
     for ( j = 1; j <= 40; j++ ) {
      temp = Rand();
...
void rInnerproduct(float *result, float a[40 +1][40 +1], float b[40 +1][40 +1], int row, int column) {
