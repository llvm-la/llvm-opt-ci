# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel.c" 2
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel.c"
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel.c" 2
...
void mandel() {
  ...
  for (x = 0; x < 5000; ++x) {
    for (y = 0; y < 5000; ++y) {
      double __complex__ c = (-2.0 +x*(- -2.0 - -2.0)/5000) + (-2.0 -y*(- -2.0 - -2.0)/5000) * 1.0iF;
      double __complex__ z = 0.0;

      for (n = 0; n < 10; ++n) {
        z = z * z + c;
        if (hypot(__real__ z, __imag__ z) >= 2)
          break;
      }
      emit(z);
    }
