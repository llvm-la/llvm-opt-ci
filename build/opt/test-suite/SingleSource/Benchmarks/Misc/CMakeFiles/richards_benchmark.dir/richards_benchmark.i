# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/richards_benchmark.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/richards_benchmark.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/richards_benchmark.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/richards_benchmark.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/richards_benchmark.c" 2
# 65 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/richards_benchmark.c"
struct packet
{
...
{
   if ( pkt!=0) append(pkt,
                      (struct packet *)(pkt->p_kind==1001 ? &v1 : &v2));
...
int main()
{
    ...
    createtask(1, 0, wkq, 0, idlefn, 1, 10000*1000);

    wkq = pkt(0, 0, 1001);
    wkq = pkt(wkq, 0, 1001);

    createtask(2, 1000, wkq, 3, workfn, 3, 0);

    wkq = pkt(0, 5, 1000);
    wkq = pkt(wkq, 5, 1000);
    wkq = pkt(wkq, 5, 1000);

    createtask(3, 2000, wkq, 3, handlerfn, 0, 0);

    wkq = pkt(0, 6, 1000);
    wkq = pkt(wkq, 6, 1000);
    wkq = pkt(wkq, 6, 1000);

    createtask(4, 3000, wkq, 3, handlerfn, 0, 0);

    wkq = 0;
    createtask(5, 4000, wkq, 2, devfn, 0, 0);
    createtask(6, 5000, wkq, 2, devfn, 0, 0);
    ...
    if (qpktcount == 23263894 && holdcount == 9305557) {
      printf("correct");
      retval = 0;
    } else {
      printf("incorrect");
