# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c" 2
# 130 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c"
...
# 131 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c" 2
...
# 132 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 133 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c" 2
...
# 134 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c" 2
# 157 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c"
...
int main()
{
 int i, j, k, l, m, npasses = 63, faedge;
 double *fdata;
 ...
 faedge = 256;
 fanum = faedge * faedge;
 fasize = ((fanum + 1) * 2 * sizeof(double));
 nsize[1] = nsize[2] = faedge;

 fdata = (double *) malloc(fasize);
 if (fdata == ((void*)0)) {
...

 {
    ...
    for (i = 1; i <= fanum; i += 2) {
       ...
       rmin = ((r)<=(rmin)?(r):(rmin));
       rmax = ((r)>(rmax)?(r):(rmax));
       imin = ((ij)<=(imin)?(ij):(imin));
       imax = ((ij)>(imax)?(ij):(imax));
    }
 ...
 for (i = 0; i < faedge; i++) {
    for (j = 0; j < faedge; j++) {
       k = (fdata[1 + (faedge * (i) + (j)) * 2] - mapbase) * mapscale;
...
# 360 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/ffbench.c"
 return 0;
}
