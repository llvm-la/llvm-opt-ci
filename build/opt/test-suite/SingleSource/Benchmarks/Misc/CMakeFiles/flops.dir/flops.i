# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c" 2
# 119 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
...
# 120 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c" 2
...
# 121 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c" 2
...
int main()
{
   ...
   loops = 15625;
# 209 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   ...
   dtime(TimeArray);
   dtime(TimeArray);
# 239 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   n = loops;
   sa = 0.0;
   ...
   m = n;
# 312 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   s = -five;
   sa = -one;
   ...
   printf("     2   %13.4lf  %10.4lf  %10.4lf\n",
          ...
          (T[6]-T[5])* 1e-30,
          T[8]* 1e-30);
# 371 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   ...
   printf("     3   %13.4lf  %10.4lf  %10.4lf\n",
          ...
          T[9]* 1e-30,
          T[11]* 1e-30);
# 412 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   A3 = -A3;
   A5 = -A5;
   x = piref / ( three * (double)m );
   s = 0.0;
   ...
   printf("     4   %13.4lf  %10.4lf  %10.4lf\n",
          ...
          T[12]* 1e-30 ,
          T[14]* 1e-30 );
# 457 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   x = piref / ( three * (double)m );
   s = 0.0;
   v = 0.0;
   ...
   printf("     5   %13.4lf  %10.4lf  %10.4lf\n",
          ...
          T[15]* 1e-30 ,
          T[17]* 1e-30 );
# 501 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   ...
   printf("     6   %13.4lf  %10.4lf  %10.4lf\n",
          ...
          T[18]* 1e-30 ,
          T[20]* 1e-30);
# 548 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   s = 0.0;
   w = one;
   ...
   printf("     7   %13.4lf  %10.4lf  %10.4lf\n",
          ...
          T[21]* 1e-30 ,
          T[23]* 1e-30 );
# 595 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
   x = piref / ( three * (double)m );
   s = 0.0;
   v = 0.0;
...
# 984 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c"
# 1 "/usr/include/loongarch64-linux-gnu/sys/time.h" 1 3 4
# 24 "/usr/include/loongarch64-linux-gnu/sys/time.h" 3 4
...
# 985 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/flops.c" 2
