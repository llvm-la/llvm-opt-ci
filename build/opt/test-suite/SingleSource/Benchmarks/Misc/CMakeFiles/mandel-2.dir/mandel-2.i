# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel-2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel-2.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel-2.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel-2.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Misc/mandel-2.c" 2

int max_i = 65536;

double sqr(double x) { return x*x; }

double cnorm2(_Complex double z) { return sqr(creal(z)) + sqr(cimag(z)); }

int loop(_Complex double c) {
    _Complex double z=c;
    int i=1;
...
int main() {
  int i, j;
    for (j = -39; j < 39; ++j) {
        for (i = -39; i < 39; ++i)
            printf(loop(j/40.0-0.5 + i/40.0*(__extension__ 1.0iF)) > max_i ? "*" : " ");
        printf("\n");
    }
    return 0;
}
