# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/partialsums.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/partialsums.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/partialsums.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/partialsums.c" 2
...
int main(int argc, char* argv[])
{
    ...
    printf("%.9f\t%s\n",twoThrd,"(2/3)^k"); printf("%.9f\t%s\n",sqrts,"k^-0.5");
    printf("%.9f\t%s\n",sum_vec(poly),"1/k(k+1)"); printf("%.9f\t%s\n",Flint,"Flint Hills");
    printf("%.9f\t%s\n",Cookson,"Cookson Hills"); printf("%.9f\t%s\n",sum_vec(Harmonic),"Harmonic");
    printf("%.9f\t%s\n",sum_vec(zeta),"Riemann Zeta"); printf("%.9f\t%s\n",sum_vec(alt),"Alternating Harmonic");
    printf("%.9f\t%s\n",sum_vec(Gregory),"Gregory");
