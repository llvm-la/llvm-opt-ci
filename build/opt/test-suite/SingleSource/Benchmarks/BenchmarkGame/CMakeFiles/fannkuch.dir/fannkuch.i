# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/fannkuch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/fannkuch.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/fannkuch.c"
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/fannkuch.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/fannkuch.c" 2
...
fannkuch( int n )
{
 ...
 if( ! (perm1[0]==0 || perm1[n1]==n1) ) {
  ...
  for( i=1, j=k-1 ; i<j ; ++i, --j ) {
      { int t_mp; t_mp=(perm[i]); (perm[i])=(perm[j]); (perm[j])=t_mp; }
  }
  ++flips;
