...
# %bb.43:                               # %vector.ph
	...
	vldrepl.w	$vr3, $a5, 104
	vldrepl.w	$vr4, $a5, 100
	vldrepl.w	$vr5, $a5, 96
	vldrepl.w	$vr6, $a5, 92
	vldrepl.w	$vr7, $a5, 88
	vldrepl.w	$vr8, $a5, 84
	vldrepl.w	$vr9, $a5, 80
	vldrepl.w	$vr10, $a5, 76
	vldrepl.w	$vr11, $a5, 72
	vldrepl.w	$vr12, $a5, 68
	vldrepl.w	$vr13, $a5, 64
	vldrepl.w	$vr14, $a5, 60
	vldrepl.w	$vr15, $a5, 56
	vldrepl.w	$vr16, $a5, 52
	vldrepl.w	$vr17, $a5, 48
	vldrepl.w	$vr18, $a5, 44
	vldrepl.w	$vr19, $a5, 40
	vldrepl.w	$vr20, $a5, 36
	vldrepl.w	$vr21, $a5, 32
	vldrepl.w	$vr22, $a5, 28
	vldrepl.w	$vr23, $a5, 24
	vldrepl.w	$vr24, $a5, 20
	vldrepl.w	$vr25, $a5, 16
	vldrepl.w	$vr26, $a5, 12
	vldrepl.w	$vr27, $a5, 8
	vldrepl.w	$vr28, $a5, 4
	vldrepl.w	$vr29, $a5, 0
	move	$a6, $zero
...
.LBB4_44:                               # %vector.body
	...
	vldx	$vr30, $t2, $a6
	vldx	$vr31, $t1, $a6
	vmul.w	$vr30, $vr30, $vr28
	vmadd.w	$vr30, $vr31, $vr29
	vldx	$vr31, $t3, $a6
	vldx	$vr0, $t4, $a6
	vldx	$vr1, $ra, $a6
	vldx	$vr2, $s2, $a6
	vmadd.w	$vr30, $vr31, $vr27
	vmadd.w	$vr30, $vr0, $vr26
	vmadd.w	$vr30, $vr1, $vr25
	...
	vldx	$vr31, $fp, $a6
	vmadd.w	$vr30, $vr0, $vr23
	vmadd.w	$vr30, $vr1, $vr22
	vmadd.w	$vr30, $vr2, $vr21
	vmadd.w	$vr30, $vr31, $vr20
	vldx	$vr0, $s4, $a6
	...
	vldx	$vr2, $fp, $a6
	vldx	$vr31, $s7, $a6
	vmadd.w	$vr30, $vr0, $vr19
	vmadd.w	$vr30, $vr1, $vr18
	vmadd.w	$vr30, $vr2, $vr17
	vmadd.w	$vr30, $vr31, $vr16
	vldx	$vr0, $a3, $a6
	ld.d	$fp, $sp, 456                   # 8-byte Folded Reload
	vldx	$vr1, $fp, $a6
	vldx	$vr2, $a4, $a6
	vldx	$vr31, $a2, $a6
	vmadd.w	$vr30, $vr0, $vr15
	vmadd.w	$vr30, $vr1, $vr14
	vmadd.w	$vr30, $vr2, $vr13
	vmadd.w	$vr30, $vr31, $vr12
	vldx	$vr0, $s0, $a6
	vldx	$vr1, $s1, $a6
	ld.d	$fp, $sp, 448                   # 8-byte Folded Reload
	vldx	$vr2, $fp, $a6
	vldx	$vr31, $a1, $a6
	vmadd.w	$vr30, $vr0, $vr11
	vmadd.w	$vr30, $vr1, $vr10
	vmadd.w	$vr30, $vr2, $vr9
	vmadd.w	$vr30, $vr31, $vr8
	vldx	$vr0, $a0, $a6
	vldx	$vr1, $s6, $a6
	vldx	$vr2, $a7, $a6
	vldx	$vr31, $t0, $a6
	vmadd.w	$vr30, $vr0, $vr7
	vmadd.w	$vr30, $vr1, $vr6
	vmadd.w	$vr30, $vr2, $vr5
	vmadd.w	$vr30, $vr31, $vr4
	vldx	$vr0, $t5, $a6
	vldx	$vr1, $t6, $a6
	vldx	$vr2, $t7, $a6
	vldx	$vr31, $t8, $a6
	...
	vmadd.w	$vr30, $vr1, $vr0
	vld	$vr0, $sp, 416                  # 16-byte Folded Reload
	vmadd.w	$vr30, $vr2, $vr0
