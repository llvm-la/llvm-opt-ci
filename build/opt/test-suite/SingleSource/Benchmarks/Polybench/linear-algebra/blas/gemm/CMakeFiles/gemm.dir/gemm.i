# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c"
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c" 2



# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.h" 1
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c" 2
...
void init_array(int ni, int nj, int nk,
  ...
  double C_StrictFP[ 1000 + 0][1100 + 0],
...
#pragma STDC FP_CONTRACT OFF
  int i, j, k;
# 129 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/blas/gemm/gemm.c"
  for (i = 0; i < ni; i++) {
    for (j = 0; j < nj; j++)
 C[i][j] *= beta;
    for (k = 0; k < nk; k++) {
...
check_FP(int ni, int nj,
         double A[ 1000 + 0][1100 + 0],
         double B[ 1000 + 0][1100 + 0]) {
  int i, j;
...
int main(int argc, char** argv)
{
  ...
  double (*C_StrictFP)[1000 + 0][1100 + 0]; C_StrictFP = (double(*)[1000 + 0][1100 + 0])polybench_alloc_data ((1000 + 0) * (1100 + 0), sizeof(double));;
  ...
  kernel_gemm_StrictFP(ni, nj, nk,
                       ...
                       *A,
                       *B);
  if (!check_FP(ni, nj, *C, *C_StrictFP))
    return 1;



  print_array(ni, nj, *C_StrictFP);



  free((void*)C);;

  free((void*)C_StrictFP);;
