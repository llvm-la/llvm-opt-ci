# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c"
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c" 2


# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.h" 1
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c" 2
...

{
  ...
  free(printmat);
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Polybench/medley/deriche/deriche.c"
}
...
static
void kernel_deriche_StrictFP(int w, int h, float alpha,
       float imgIn[ 4096 + 0][2160 + 0],
       float imgOut[ 4096 + 0][2160 + 0],
       float y1[ 4096 + 0][2160 + 0],
       float y2[ 4096 + 0][2160 + 0]) {
...
static inline int
check_FP(int n,
         float A[ 4096 + 0][2160 + 0],
         float B[ 4096 + 0][2160 + 0]) {
  int i, j;
...
int main(int argc, char** argv)
{
  ...
  float (*imgOut_StrictFP)[4096 + 0][2160 + 0]; imgOut_StrictFP = (float(*)[4096 + 0][2160 + 0])polybench_alloc_data ((4096 + 0) * (2160 + 0), sizeof(float));;
  ...
  kernel_deriche (w, h, alpha, *imgIn, *imgOut, *y1, *y2);
    ...
    init_array (w, h, &alpha, *imgIn, *imgOut_StrictFP);
    kernel_deriche_StrictFP (w, h, alpha, *imgIn, *imgOut_StrictFP, *y1, *y2);
    if (!check_FP(w, *imgOut, *imgOut_StrictFP))
      return 1;


    print_array(w, h, *imgOut_StrictFP);
