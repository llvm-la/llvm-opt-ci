# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c" 2
# 228 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
...
# 229 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c" 2
...
# 230 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c" 2
...
# 231 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 250 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c" 2
 float second()
     {
        float secs;
        clock_t Time;
        Time = clock();
        secs = (float)Time / (float)((__clock_t) 1000000);
        return secs ;
     }
...
int main ()
{
        ...
        fprintf (stderr,"Average                          %11.2f\n", 0.0);
# 557 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
        return 0;
}
...
void dgefa(float a[], int lda, int n, int ipvt[], int *info)
# 653 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
{
...
void dgesl(float a[],int lda,int n,int ipvt[],float b[],int job )
# 776 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
{
...
# 902 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
return;
}
...

{
        ...
        return(dtemp);
# 972 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
}
...

{
        ...
        for (i = 0; i < n; i++)
                dx[i] = da*dx[i];
# 1029 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
}
...
{
        float a,b,c,eps;
# 1114 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
        a = 4.0e0/3.0e0;
        eps = 0.0;
        while (eps == 0.0) {
                b = a - 1.0;
...
void dmxpy (int n1, float y[], int n2, int ldm, float x[], float m[])
# 1154 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/Linpack/linpack-pc.c"
{
        int j,i,jmin;
