# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/misr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/misr.c" 2
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/misr.c"
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/misr.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/misr.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/misr.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Benchmarks/McGill/misr.c"
int reg_len;
...
int main(int argc,char *argv[])
{
 ...
 {
  init(&cell_array);
  simulate(10000, &cell_array, prob, structure);
  for(i=0; i<num_times; i++)
  {
...
int simulate(int iterations, misr_type *present, double prob, char *structure)
{
 ...
 for(h=0; h<iterations; h++)
 {
  ...
  for (i=0; i<quot; i++)
  {
   ...
   for (j=0; j<31; j++)
   {
    ...
    temp->f_free = ((temp->next->f_free + randv) & 1);
    randprob = ((double)(lrand48() % 1000) / 1000);
    if (prob > randprob) randv ^= 1;
    temp->faulty = ((temp->next->faulty + randv) & 1);
    temp = temp->next;
    randv >>= 1;
   }
  }
  ...
  temp->f_free = ((savef_free + randv) & 1);
  randprob = ((double)(lrand48() % 10000) / 10000);
  if (prob > randprob) randv ^= 1;
  temp->faulty = ((savefaulty + randv) & 1);
 ...
 for (i=0; i<reg_len; i++)
 {
  if (temp->f_free != temp->faulty) different = 1;
  temp = temp->next;
 }
 return different;
