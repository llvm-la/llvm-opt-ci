# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/casts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/casts.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/casts.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/casts.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/Regression/C/casts.c" 2
...
main(int argc, char** argv)
{
  ...
  C = (char) (argc >= 2)? atoi(argv[1]) : 0x64;
  S = (short) (argc >= 3)? atoi(argv[2]) : -769;
  L = (int64_t) (argc >= 4)? atoi(argv[3]) : 0xa3a3a3a3a3a3LL;
  ...
  printf("long to uint64_t ul1 = %""l" "u""\t\t(0x%""l" "x"")\n", ul1, ul1);
  ...
  printf("float to uint64_t ul1 = %""l" "u""\t\t(0x%""l" "x"")\n", ul1, ul1);
  ...
  printf("double to int64_t l1 = %""l" "d""\t\t(0x%""l" "x"")\n", l1, l1);

  printf("double to ushort us1 = %u\t\t(0x%x)\n", us1, us1);
  printf("double to uint   ui1 = %u\t\t(0x%x)\n", ui1, ui1);
  printf("double to uint64_t ul1 = %""l" "u""\t\t(0x%""l" "x"")\n", ul1, ul1);

  for (i = 0; lls[i]; ++i) {
    printf("double <- int64_t %""l" "d"" = %f\n", lls[i], (double)lls[i]);
    printf("double <- uint64_t %""l" "u"" = %f\n",
