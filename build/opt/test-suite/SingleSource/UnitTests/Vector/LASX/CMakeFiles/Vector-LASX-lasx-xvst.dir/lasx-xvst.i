# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 401 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c" 2
...
main ()
{
  ...
  ((void)__builtin_lasx_xvst((v32i8)((__m256)v4u64_op0), (void *)((unsigned long *)&__m256i_result), (0x0)));
  check_lasx_out(&v4u64_op0, &__m256i_result, sizeof(__m256i_result), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c", 23);

  v4u64_op0 = (v4u64){0x0ad152a5ad72feeb, 0xa98d4f7a77c308ee,
                      0x58569d7be9179100, 0x042f0500cfea969a};
  __m256i_result = (__m256i){0x0, 0x0, 0x0, 0x0};
  __lasx_xvstx((__m256)v4u64_op0, (unsigned long *)&__m256i_result, 0x0);
  check_lasx_out(&v4u64_op0, &__m256i_result, sizeof(__m256i_result), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c", 29);

  v4u64_op0 = (v4u64){0x0ad152a5ad72feeb, 0xa98d4f7a77c308ee,
                      0x58569d7be9179100, 0x042f0500cfea969a};
  __m256i_result = (__m256i){0x8d, 0x0, 0x0, 0x0};
  __m256i_out = (__m256i){0x0, 0x0, 0x0, 0x0};
  ((void)__builtin_lasx_xvstelm_b((v32i8)((__m256)v4u64_op0), (void *)((unsigned long *)&__m256i_out), (0x0), (0xe)));
  check_lasx_out(&__m256i_result, &__m256i_out, sizeof(__m256i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c", 36);

  v4u64_op0 = (v4u64){0x0ad152a5ad72feeb, 0xa98d4f7a77c308ee,
                      0x58569d7be9179100, 0x042f0500cfea969a};
  __m256i_result = (__m256i){0x9100, 0x0, 0x0, 0x0};
  __m256i_out = (__m256i){0x0, 0x0, 0x0, 0x0};
  ((void)__builtin_lasx_xvstelm_h((v16i16)((__m256)v4u64_op0), (void *)((unsigned long *)&__m256i_out), (0x0), (0x8)));
  check_lasx_out(&__m256i_result, &__m256i_out, sizeof(__m256i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c", 43);

  v4u64_op0 = (v4u64){0x0ad152a5ad72feeb, 0xa98d4f7a77c308ee,
                      0x58569d7be9179100, 0x042f0500cfea969a};
  __m256i_result = (__m256i){0xe9179100, 0x0, 0x0, 0x0};
  __m256i_out = (__m256i){0x0, 0x0, 0x0, 0x0};
  ((void)__builtin_lasx_xvstelm_w((v8i32)((__m256)v4u64_op0), (void *)((unsigned long *)&__m256i_out), (0x0), (0x4)));
  check_lasx_out(&__m256i_result, &__m256i_out, sizeof(__m256i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c", 50);

  v4u64_op0 = (v4u64){0x0ad152a5ad72feeb, 0xa98d4f7a77c308ee,
                      0x58569d7be9179100, 0x042f0500cfea969a};
  __m256i_result = (__m256i){0x58569d7be9179100, 0x0, 0x0, 0x0};
  __m256i_out = (__m256i){0x0, 0x0, 0x0, 0x0};
  ((void)__builtin_lasx_xvstelm_d((v4i64)((__m256)v4u64_op0), (void *)((unsigned long *)&__m256i_out), (0x0), (0x2)));
  check_lasx_out(&__m256i_result, &__m256i_out, sizeof(__m256i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LASX/lasx-xvst.c", 57);
