# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c" 2
...
main ()
{
  ...
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c", 22);

  v4i32_op0 = (v4i32){0xfe02fe02, 0xfe02fe02, 0xfe02fe02, 0xfe02fe02};
  __m128i_result = (__m128i){0x0000000800000008, 0x0000000800000008};
  __m128i_out = __lsx_vfclass_s((__m128)v4i32_op0);
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c", 27);

  v4i32_op0 = (v4i32){0x10001000, 0x10001000, 0x7fff000c, 0x0000000c};
  __m128i_result = (__m128i){0x0000008000000080, 0x0000010000000002};
  __m128i_out = __lsx_vfclass_s((__m128)v4i32_op0);
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c", 32);

  v4i32_op0 = (v4i32){0x00000000, 0x00000000, 0x00000000, 0x00000000};
  __m128i_result = (__m128i){0x0000020000000200, 0x0000020000000200};
  __m128i_out = __lsx_vfclass_s((__m128)v4i32_op0);
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c", 37);

  v4i32_op0 = (v4i32){0x00000000, 0x00000000, 0x00000000, 0x00000000};
  __m128i_result = (__m128i){0x0000020000000200, 0x0000020000000200};
  __m128i_out = __lsx_vfclass_s((__m128)v4i32_op0);
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c", 42);

  v4i32_op0 = (v4i32){0x09080706, 0x0a090807, 0x0b0a0908, 0x0c0b0a09};
  __m128i_result = (__m128i){0x0000008000000080, 0x0000008000000080};
  __m128i_out = __lsx_vfclass_s((__m128)v4i32_op0);
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vfclass_s.c", 47);
