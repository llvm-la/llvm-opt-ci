# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c" 2
...
main ()
{
  ...
  ((void)__builtin_lsx_vst((v16i8)((__m128)v2u64_op0), (void *)((unsigned long *)&__m128i_result), (0x0)));
  check_lsx_out(&v2u64_op0, &__m128i_result, sizeof(__m128i_result), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c", 22);

  v2u64_op0 = (v2u64){0x3ab7a3fc47a5c31a, 0x1dcc4255c9d85c05};
  __m128i_result = (__m128i){0x0, 0x0};
  __lsx_vstx((__m128)v2u64_op0, (unsigned long *)&__m128i_result, 0x0);
  check_lsx_out(&v2u64_op0, &__m128i_result, sizeof(__m128i_result), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c", 27);

  v2u64_op0 = (v2u64){0x3ab7a3fc47a5c31a, 0x1dcc4255c9d85c05};
  __m128i_result = (__m128i){0x05, 0x0};
  __m128i_out = (__m128i){0x0, 0x0};
  ((void)__builtin_lsx_vstelm_b((v16i8)((__m128)v2u64_op0), (void *)((unsigned long *)&__m128i_out), (0x0), (0x8)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c", 33);

  v2u64_op0 = (v2u64){0x3ab7a3fc47a5c31a, 0x1dcc4255c9d85c05};
  __m128i_result = (__m128i){0x5c05, 0x0};
  __m128i_out = (__m128i){0x0, 0x0};
  ((void)__builtin_lsx_vstelm_h((v8i16)((__m128)v2u64_op0), (void *)((unsigned long *)&__m128i_out), (0x0), (0x4)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c", 39);

  v2u64_op0 = (v2u64){0x3ab7a3fc47a5c31a, 0x1dcc4255c9d85c05};
  __m128i_result = (__m128i){0xc9d85c05, 0x0};
  __m128i_out = (__m128i){0x0, 0x0};
  ((void)__builtin_lsx_vstelm_w((v4i32)((__m128)v2u64_op0), (void *)((unsigned long *)&__m128i_out), (0x0), (0x2)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c", 45);

  v2u64_op0 = (v2u64){0x3ab7a3fc47a5c31a, 0x1dcc4255c9d85c05};
  __m128i_result = (__m128i){0x1dcc4255c9d85c05, 0x0};
  __m128i_out = (__m128i){0x0, 0x0};
  ((void)__builtin_lsx_vstelm_d((v2i64)((__m128)v2u64_op0), (void *)((unsigned long *)&__m128i_out), (0x0), (0x1)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vst.c", 51);
