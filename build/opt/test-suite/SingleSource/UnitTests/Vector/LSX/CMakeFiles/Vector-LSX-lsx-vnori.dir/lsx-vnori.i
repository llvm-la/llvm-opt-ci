# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c" 2
...
main ()
{
  ...
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0x33)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 22);

  v2u64_op0 = (v2u64){0xffffffffffffffff, 0xffffffffffffffff};
  __m128i_result = (__m128i){0x0000000000000000, 0x0000000000000000};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0xa6)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 27);

  v2u64_op0 = (v2u64){0x3e035e51522f0799, 0x0000000000000000};
  __m128i_result = (__m128i){0x8090808280909002, 0x9292929292929292};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0x6d)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 32);

  v2u64_op0 = (v2u64){0x00201df000000000, 0x00000000000ffc2f};
  __m128i_result = (__m128i){0x3818200838383838, 0x3838383838300010};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0xc7)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 37);

  v2u64_op0 = (v2u64){0x2020202020207f7f, 0x2020202020202020};
  __m128i_result = (__m128i){0x5d5d5d5d5d5d0000, 0x5d5d5d5d5d5d5d5d};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0xa2)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 42);

  v2u64_op0 = (v2u64){0x0000000000000000, 0x0000000000000000};
  __m128i_result = (__m128i){0x8080808080808080, 0x8080808080808080};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0x7f)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 47);

  v2u64_op0 = (v2u64){0x8080808080808080, 0x8080808080808080};
  __m128i_result = (__m128i){0x1313131313131313, 0x1313131313131313};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0xec)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 52);

  v2u64_op0 = (v2u64){0x0000000000000000, 0x0000000000000000};
  __m128i_result = (__m128i){0x9d9d9d9d9d9d9d9d, 0x9d9d9d9d9d9d9d9d};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0x62)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 57);

  v2u64_op0 = (v2u64){0x00365c60317ff930, 0x00f525682ffd27f2};
  __m128i_result = (__m128i){0xe5c1a185c48004c5, 0xe500c085c000c005};
  __m128i_out = ((__m128i)__builtin_lsx_vnori_b((v16u8)((__m128)v2u64_op0), (0x1a)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vnori.c", 62);
