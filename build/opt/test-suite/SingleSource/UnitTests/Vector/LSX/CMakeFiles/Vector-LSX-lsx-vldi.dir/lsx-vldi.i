# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c" 2
...
main ()
{
  ...
  __m128i_out = ((__m128i)__builtin_lsx_vldi((1187)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 21);

  __m128i_result = (__m128i){0xfffffffffffffe15, 0xfffffffffffffe15};
  __m128i_out = ((__m128i)__builtin_lsx_vldi((3605)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 25);

  __m128i_result = (__m128i){0xecececececececec, 0xecececececececec};
  __m128i_out = ((__m128i)__builtin_lsx_vldi((1004)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 29);

  __m128i_result = (__m128i){0x00ffff00ff00ff00, 0x00ffff00ff00ff00};
  __m128i_out = ((__m128i)__builtin_lsx_vldi((-1686)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 33);

  __m128i_result = (__m128i){0x004d004d004d004d, 0x004d004d004d004d};
  __m128i_out = ((__m128i)__builtin_lsx_vldi((1101)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 37);

  __m128i_result = (__m128i){0x0a0000000a000000, 0x0a0000000a000000};
  __m128i_out = ((__m128i)__builtin_lsx_vldi((-3318)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 41);

  __m128i_result = (__m128i){0x00ffff00ff00ff00, 0x00ffff00ff00ff00};
  __m128i_out = ((__m128i)__builtin_lsx_vldi((-1686)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 45);

  __m128i_result = (__m128i){0x0a0000000a000000, 0x0a0000000a000000};
  __m128i_out = ((__m128i)__builtin_lsx_vldi((-3318)));
  check_lsx_out(&__m128i_result, &__m128i_out, sizeof(__m128i_out), "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/Vector/LSX/lsx-vldi.c", 49);
