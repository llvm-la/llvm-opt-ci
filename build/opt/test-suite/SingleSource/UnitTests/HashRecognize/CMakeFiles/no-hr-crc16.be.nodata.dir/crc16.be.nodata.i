# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.nodata.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.nodata.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.nodata.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.nodata.c" 2



static __attribute__((noinline)) uint16_t crc_loop(uint16_t crc_initval, unsigned data) {
  uint16_t crc = crc_initval;


  for (size_t i = 0; i < 16; ++i) {
    uint16_t crc_shl = crc << 1;
    crc = (crc & 0x8000) ? (crc_shl ^ 4129) : crc_shl;
  }
  return crc;
}
