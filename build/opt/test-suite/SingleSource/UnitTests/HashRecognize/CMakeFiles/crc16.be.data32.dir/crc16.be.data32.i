# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.data32.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.data32.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc_macros.h" 1
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc_macros.h" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc_macros.h" 2
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.data32.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc16.be.data32.c" 2



static __attribute__((noinline)) uint16_t crc_loop(uint16_t crc_initval, uint32_t data) {
  uint16_t crc = crc_initval;


  { for (size_t i = 0; i < (sizeof(data) * 8); ++i) { uint16_t xor_crc_data = crc ^ data; uint16_t crc_shl = crc << 1; crc = (xor_crc_data & (1 << ((sizeof(uint16_t) * 8) - 1))) ? (crc_shl ^ 4129) : crc_shl; data <<= 1; } };
  return crc;
}

int main() {
  { static const unsigned sample[] = {0, 1, 11, 16, 129, 142, 196, 255}; for (size_t i = 0; i < (sizeof(sample) / sizeof(sample[0])); ++i) printf("%u\n", (unsigned)crc_loop(sample[i], sample[(sizeof(sample) / sizeof(sample[0])) - 1 - i])); };
  return 0;
}
