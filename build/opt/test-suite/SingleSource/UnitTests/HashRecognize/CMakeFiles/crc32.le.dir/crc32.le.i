# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc32.le.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc32.le.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc32.le.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc32.le.c" 2
...
static __attribute__((noinline)) uint32_t crc_loop(uint32_t crc_initval, uint32_t data) {
  ...
  { for (size_t i = 0; i < (sizeof(data) * 8); ++i) { uint32_t xor_crc_data = crc ^ data; uint32_t crc_lshr = crc >> 1; crc = (xor_crc_data & 1) ? (crc_lshr ^ 33800) : crc_lshr; data >>= 1; } };
  return crc;
}
