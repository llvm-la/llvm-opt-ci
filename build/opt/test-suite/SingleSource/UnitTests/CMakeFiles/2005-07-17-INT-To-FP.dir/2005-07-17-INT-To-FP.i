# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2005-07-17-INT-To-FP.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2005-07-17-INT-To-FP.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/SingleSource/UnitTests/2005-07-17-INT-To-FP.c" 2
...
int main() {
  ...
  for (i = 0; i < 64; ++i) {
    printf("%d %f, %f, %f, %f\n", i,
           (double)(signed char)(i << 2),
           (double)(signed short)(i << 10),
           (double)(signed int)(i << 26),
           (double)(signed long long)((long long)i << 58ULL));

    printf("%d %f, %f, %f, %f\n", i,
           (double)(unsigned char)(i << 2),
           (double)(unsigned short)(i << 10),
           (double)(unsigned int)(i << 26),
           (double)(unsigned long long)((unsigned long long)i << 58ULL));
  }
