# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c"
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
extern __pid_t wait4 (__pid_t __pid, int *__stat_loc, int __options,
        struct rusage *__usage) __attribute__ ((__nothrow__));
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c" 2
...
# 100 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c"
...
# 140 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c"
}
...
# 255 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c"
static int monitor_child_process(double start_time) {
  ...
  } while (res < 0 && (*__errno_location ()) == 4);
  if (res < 0) {
    perror("waitpid");
...
# 401 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c"
  if (!g_summary_file) {
    if (g_posix_mode) {
...
# 632 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/tools/timeit.c"
  setpgid(0, 0);
  ...
  if (g_target_cpu_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_CPU", RLIMIT_CPU, g_target_cpu_limit);
  }
  if (g_target_stack_size_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_STACK", RLIMIT_STACK, g_target_stack_size_limit);
  }
  if (g_target_data_size_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_DATA", RLIMIT_DATA, g_target_data_size_limit);
  }
  ...
  if (g_target_rss_size_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_RSS", __RLIMIT_RSS, g_target_rss_size_limit);
  }

  if (g_target_file_size_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_FSIZE", RLIMIT_FSIZE, g_target_file_size_limit);
  }
  if (g_target_core_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_CORE", RLIMIT_CORE, g_target_core_limit);
  }
  if (g_target_file_count_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_NOFILE", RLIMIT_NOFILE, g_target_file_count_limit);
  }

  if (g_target_subprocess_count_limit != ~(rlim_t) 0) {
    set_resource_limit_actual("RLIMIT_NPROC", __RLIMIT_NPROC, g_target_subprocess_count_limit);
  }
...
static int execute(char * const argv[]) {
  ...
  signal(2, terminate_handler);
  signal(15, terminate_handler);
