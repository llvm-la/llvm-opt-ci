# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c" 2
...
extern int _K_atm;
extern int _K_btm;
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c" 2
...
extern int X_com();
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c"
E_edit
...
int comflags;
{
 ...
 E_edit *script;
 int *last_d;
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/miller.c"
 script = ((E_edit*) _Z_myalloc((max_obj+1) * sizeof (E_edit)));
 last_d = ((int*) _Z_myalloc((max_obj+1) * sizeof (int)));


 for (row=0;row < m && row < n && X_com(row,row,comflags) == 0; ++row)
  ;
 last_d[(max_obj/2)] = row;
 script[(max_obj/2)] = ((E_edit) 0);
 lower = (row == m) ? (max_obj/2)+1 : (max_obj/2) - 1;
 upper = (row == n) ? (max_obj/2)-1 : (max_obj/2) + 1;
 if (lower > upper)
 {
 ...
 for (d = 1; d <= max_d; ++d) {
  for (k = lower; k<= upper; k+= 2) {
   new = (((_E_struct*) _Z_myalloc((1) * sizeof (_E_struct))));

   if (k == (max_obj/2)-d || (k!= (max_obj/2)+d && last_d[k+1] >= last_d[k-1])) {
    row = last_d[k+1]+1;
    ((new)->link = (script[k+1]));
    ((new)->op = (2));
   } else {
