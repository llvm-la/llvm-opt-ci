# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c" 2
...
extern int R_getexp();
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c" 2
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/float.c"
int
...
int allflag;
{
 ...
 ((void)strcpy(res->mantissa,"0"));(res->exponent = 0);(res->man_sign = 0);
 return(res);
}
...
F_float p1,p2;
{
 ...
 static char man1[200],man2[200],diff[200];
 int exp1,exp2;
 ...
 (void) strcat(man1,(p1->mantissa));
 (void) strcat(man2,(p2->mantissa));
 ...
 {
  ((void)strcpy(result->mantissa,"0"));(result->exponent = 0);(result->man_sign = 0);
  return(result);
 }
 ...
 ((void)strcpy(result->mantissa,diffptr));
 (result->man_sign = 0);
 return(result);
}
...
{
 static char man1[200],man2[200];




 if (((0 == f1->exponent) && (!strcmp(f1->mantissa,"0"))))
 {
  if (((0 == f2->exponent) && (!strcmp(f2->mantissa,"0"))))
  {
   return(0);
  }
  else
 ...
 (void) strcpy(man1,(f1->mantissa));
 S_trimzeros(man1);

 (void) strcpy(man2,(f2->mantissa));
 S_trimzeros(man2);
...
F_float f1,f2;
{
 ...
 if (((0 == f1->exponent) && (!strcmp(f1->mantissa,"0"))) || ((0 == f2->exponent) && (!strcmp(f2->mantissa,"0"))))
 {
  ((void)strcpy(result->mantissa,"0"));(result->exponent = 0);(result->man_sign = 0);
  return(result);
 }
 ...
 end1 = (man1 + (strlen(man1)-1));
 end2 = (man2 + (strlen(man2)-1));
 ...
 end = (smallman + (strlen(smallman)-1));
 (void) strcpy(prod,"0");
 ...
 ((void)strcpy(result->mantissa,prod));
 (result->exponent = (((R_getexp(f1) + R_getexp(f2)) - len)+ strlen(prod)));

 if ((f1->man_sign) == (f2->man_sign))
 {
  (result->man_sign = 0);
 }
 else
...
F_float p1,p2;
{
 ...
 if( _F_xor((R_getexp(p1)<0),(R_getexp(p2)<0)))
 {
  digits = _F_ABSDIFF(R_getexp(p1),R_getexp(p2));
 }
 else
 {
  digits = ((( (R_getexp(p1)) < (0) )? (-(R_getexp(p1))):(R_getexp(p1))) + (( (R_getexp(p2)) < (0) )? (-(R_getexp(p2))):(R_getexp(p2))));
 }
 ...
 if (digits>0)
 {
  if (R_getexp(p1) < R_getexp(p2))
  {
   ...
   if (digits+strlen((p1->mantissa)) > (200 -1))
   {
    (void) sprintf(Z_err_buf,
  ...
  else
  {
   ...
   if (digits+strlen((p2->mantissa)) > (200 -1))
   {
    (void) sprintf(Z_err_buf,
       "numbers differ by too much in magnitude");
    Z_fatal(Z_err_buf);
 ...
 else
 {
  ...
  if ((( (strlen((p1->mantissa))) > (strlen((p2->mantissa))) )? (strlen((p1->mantissa))):(strlen((p2->mantissa)))) > (200 -2))
 ...
 len = (( (strlen(man1)) > (strlen(man2)) )? (strlen(man1)):(strlen(man2)));
