# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c" 2
...
extern int _K_atm;
extern int _K_btm;
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c" 2




T_tol _T_gtol = ((T_tol) 0);





static T_tol _T_tols[10];
...
T_initdefault()
{
 ...
 if (((_T_gtol) == ((T_tol) 0)))
 {
  _T_addtol(&_T_gtol,0,"1e-10");
  _T_addtol(&_T_gtol,1,"1e-10");
 }
 called_before = 1;
}
...
char *str;
{
 ...
 while ('\0' != *str)
 {
  ...
  {
   case 'a':
    _T_addtol(toladdr,0,str);
    break;
   case 'r':
    _T_addtol(toladdr,1,str);
    break;
   case 'i':
    _T_addtol(toladdr,2,(char*)0);
    break;
   case 'd':
...
# 238 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/tol.c"
T_tol
T_picktol(p1,p2)
T_tol p1, p2;
{
...
T_tol *to,from;
{
 ...
 else
 {
  ...
  for(last= *to;!(((last->next)) == ((T_tol) 0));last = (last->next))
  {
  }
...
char *str;
{
 ...
 if (((*listptr) == ((T_tol) 0)))
 {
  ...
  last = *listptr = ((_T_struct*) _Z_myalloc((1) * sizeof (_T_struct)));
 }
 else
 {
  ...
  for(last= *listptr;!(((last->next)) == ((T_tol) 0));last = (last->next))
  {
  }



  (last->next = ((_T_struct*) _Z_myalloc((1) * sizeof (_T_struct))));
 ...
 if (2 == type)
 {
  (last->flo_tol = ((F_float) 0));
 }
 else
 {
  (last->flo_tol = F_atof(str,0));




  if (((last->flo_tol)->man_sign))
  {
   (void) sprintf(Z_err_buf,
