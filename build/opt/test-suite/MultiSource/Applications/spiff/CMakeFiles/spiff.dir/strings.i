# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/strings.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/strings.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/strings.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/strings.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/strings.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/strings.c" 2
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/strings.c"
void
S_wordcpy(to,from)
char *to, *from;
{
 while ((*from != '\0') && ((*__ctype_b_loc ())[(int) ((*from))] & (unsigned short int) _ISprint) && (!((*__ctype_b_loc ())[(int) ((*from))] & (unsigned short int) _ISspace)))
 {
  *to++ = *from++;
 }
 *to = '\0';
...
char **theptr;
{
 while((**theptr != '\0') && ((*__ctype_b_loc ())[(int) ((**theptr))] & (unsigned short int) _ISprint) && (!((*__ctype_b_loc ())[(int) ((**theptr))] & (unsigned short int) _ISspace)))
 {
  (*theptr)++;
...
char **theptr;
{
 while((**theptr != '\0') && ((*__ctype_b_loc ())[(int) ((**theptr))] & (unsigned short int) _ISspace))
 {
  (*theptr)++;
...
int size;
{
 *to = ((char*) _Z_myalloc((size+1) * sizeof (char)));
}
