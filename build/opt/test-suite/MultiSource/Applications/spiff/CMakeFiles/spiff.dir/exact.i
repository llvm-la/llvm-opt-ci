# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/exact.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/exact.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/exact.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/exact.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/exact.c" 2
...
extern int X_com();
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/spiff/exact.c" 2
...
int comflags;
{
 int i = 0;
 int diffcnt = 0;
 int last = (( (size1) < (size2) )? (size1):(size2));
 int next_edit = 0;
 E_edit last_ptr = ((E_edit) 0);
 int start,tmp;
 E_edit *script;

 script = ((E_edit*) _Z_myalloc((max_d+1) * sizeof (E_edit)));
 ...
 do
 {
  ...
  {
   script[next_edit] = (((_E_struct*) _Z_myalloc((1) * sizeof (_E_struct))));
   ((script[next_edit])->link = (last_ptr));
   last_ptr = script[next_edit];

   ((script[next_edit])->op = (2));
   ((script[next_edit])->line1 = (tmp+1));

   ((script[next_edit])->line2 = (0));
  }
  ...
  for(tmp=start;tmp<i;tmp++,next_edit++)
  {
   ...
   ((script[next_edit])->op = (1));
   ((script[next_edit])->line1 = (i));
   ((script[next_edit])->line2 = (tmp+1));
  }
 } while (i<last);
