# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c"
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
extern char *argv0;
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c" 2
...
main(int argc, char *argv[])
{
  ...
  options.W = 12;
  options.X = 12;
  options.filterPct = 75;
  options.minScore_cutoff = 50;
  while (1) {
...
# 346 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c"
  return 0;
}
...
# 524 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c"
static void
...
read_line_buf(read_buf_p_t b, int fd)
{
  ...
  size_t cur = 0;
  b->lc = 0;
  if ((s = shuffle_line(b, &cur)) != ((void*)0))
    return s;
  do {
    if ((rc = read(fd, b->in + b->ic, 4096 - b->ic - 1)) == -1) {
      if ((*__errno_location ()) != 4)
 fatal("Could not read from %d: %s(%d)\n",
       fd, strerror((*__errno_location ())), (*__errno_location ()));
    } else
      b->ic += rc;
...
{
  b->line = xmalloc(4096 * sizeof(char));
  b->lmax = 4096;
  b->lc = 0;
  b->ic = 0;
}
...
init_seq(const char *fName, seq_p_t sp)
{
  ...
  if (fName != ((void*)0)) {
    ...
    if (sp->fd == -1)
     ...
     fName, strerror((*__errno_location ())), (*__errno_location ()));
  } else
    sp->fd = 0;
  sp->len = 0;
  sp->maxHead = 0;
...
get_next_seq(seq_p_t sp, unsigned int offset, int warnMultiSeq)
{
  ...
  while (sp->rb.lc > 0 && buf[0] != '>') {
    ...
    if (sp->len + sp->rb.lc + 1 > sp->max) {
      sp->max = ((sp->len + sp->rb.lc + 1 < sp->max + 0x40000) ? (sp->max + 0x40000) : (sp->len + sp->rb.lc + 1));
 ...
 sp->seq[sp->len++] = (__extension__ ({ int __res; if (sizeof (c) > 1) { if (__builtin_constant_p (c)) { int __c = (c); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (c); } else __res = (*__ctype_toupper_loc ())[(int) (c)]; __res; }));
      }
    }
    buf = read_line_buf(&sp->rb, sp->fd);
  }
  ...
  while (((*__ctype_b_loc ())[(int) ((*buf))] & (unsigned short int) _IScntrl) || ((*__ctype_b_loc ())[(int) ((*buf))] & (unsigned short int) _ISspace))
    buf -= 1;
