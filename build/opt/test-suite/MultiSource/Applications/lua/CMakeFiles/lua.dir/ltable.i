# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c" 2
# 75 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c"
...
static Node *hashnum (const Table *t, lua_Number n) {
  ...
  if (((n)==(0)))
    return (&(t)->node[0]);
  memcpy(a, &n, sizeof(a));
  for (i = 1; i < ((int)((sizeof(lua_Number)/sizeof(int)))); i++) a[0] += a[i];
...
# 189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c"
...
static int numusearray (const Table *t, int *nums) {
  ...
  int ause = 0;
  int i = 1;
  for (lg=0, ttlg=1; lg<=26; lg++, ttlg*=2) {
    int lc = 0;
    int lim = ttlg;
    if (lim > t->sizearray) {
      lim = t->sizearray;
...
static void resize (lua_State *L, Table *t, int nasize, int nhsize) {
  ...
  if (nold != (&dummynode_))
    ((((size_t)((0)+1)) <= ((size_t)(~(size_t)0)-2)/(sizeof(Node))) ? luaM_realloc_(L, ((nold)), ((1<<(oldhsize)))*(sizeof(Node)), (0)*(sizeof(Node))) : luaM_toobig(L));
}
...
# 358 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c"
...
# 399 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ltable.c"
static TValue *newkey (lua_State *L, Table *t, const TValue *key) {
  ...
  if (!((((&(mp)->i_val))->tt) == 0) || mp == (&dummynode_)) {
    ...
    if (othern != mp) {
      ...
      while (((othern)->i_key.nk.next) != mp) othern = ((othern)->i_key.nk.next);
...
const TValue *luaH_get (Table *t, const TValue *key) {
  switch (((key)->tt)) {
    ...
    case 4: return luaH_getstr(t, (&(key)->value.gc->ts));
    case 3: {
      int k;
      lua_Number n = ((key)->value.n);
      ((k)=(int)(n));
...
TValue *luaH_set (lua_State *L, Table *t, const TValue *key) {
  ...
  if (p != (&luaO_nilobject_))
    ...
    if ((((key)->tt) == 0)) luaG_runerror(L, "table index is nil");
