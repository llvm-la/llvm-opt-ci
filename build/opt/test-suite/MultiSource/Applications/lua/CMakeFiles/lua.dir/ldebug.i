# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.h"
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
__attribute__((visibility("hidden"))) extern const char *luaF_getlocalname (const Proto *func, int local_number,
                                         int pc);
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c" 2
...
static int currentpc (lua_State *L, CallInfo *ci) {
  if (!(((((ci)->func)->tt) == 6) && (!((&((ci)->func)->value.gc->cl))->c.isC))) return -1;
  if (ci == L->ci)
...
extern int lua_getinfo (lua_State *L, const char *what, lua_Debug *ar) {
  ...
  if (strchr(what, 'f')) {
    if (f == ((void*)0)) ((L->top)->tt=0);
    else { TValue *i_o=(L->top); i_o->value.gc=((GCObject *)((f))); i_o->tt=6; ((void)0); };
    {if ((char *)L->stack_last - (char *)L->top <= (1)*(int)sizeof(TValue)) luaD_growstack(L, 1); else ((void)0);; L->top++;};
  }
  if (strchr(what, 'L'))
...
# 276 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c"
...
static int checkArgMode (const Proto *pt, int r, enum OpArgMask mode) {
  switch (mode) {
    case OpArgN: if (!(r == 0)) return 0;; break;
    case OpArgU: break;
    case OpArgR: if (!((r) < (pt)->maxstacksize)) return 0;; break;
    case OpArgK:
  ...
  for (pc = 0; pc < lastpc; pc++) {
    ...
    switch ((((enum OpMode)(luaP_opmodes[op] & 3)))) {
      ...
      case iABx: {
        ...
        if ((((enum OpArgMask)((luaP_opmodes[op] >> 4) & 3))) == OpArgK) if (!(b < pt->sizek)) return 0;;
        break;
      }
      case iAsBx: {
        ...
        if ((((enum OpArgMask)((luaP_opmodes[op] >> 4) & 3))) == OpArgR) {
          ...
          if (dest > 0) {
            ...
            for (j = 0; j < dest; j++) {
              ...
              if (!((((OpCode)(((d)>>0) & ((~((~(Instruction)0)<<6))<<0)))) == OP_SETLIST && (((int)(((d)>>((0 + 6) + 8)) & ((~((~(Instruction)0)<<9))<<0)))) == 0)) break;
            }
    ...
    switch (op) {
      ...
      case OP_TFORLOOP: {
        if (!(c >= 1)) return 0;;
        if (!((a+2+c) < (pt)->maxstacksize)) return 0;;
        if (reg >= a+2) last = pc;
        break;
      }
      case OP_FORLOOP:
      ...
      case OP_RETURN: {
        b--;
        if (b > 0) if (!((a+b-1) < (pt)->maxstacksize)) return 0;;
        break;
      }
      case OP_SETLIST: {
        if (b > 0) if (!((a + b) < (pt)->maxstacksize)) return 0;;
        if (c == 0) {
          pc++;
      ...
      case OP_VARARG: {
        ...
        b--;
        if (b == (-1)) if (!(luaG_checkopenop((pt)->code[(pc)+1]))) return 0;;
        if (!((a+b-1) < (pt)->maxstacksize)) return 0;;
        break;
      }
      default: break;
...
# 484 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldebug.c"
...
void luaG_errormsg (lua_State *L) {
  if (L->errfunc != 0) {
    ...
    if (!(((errfunc)->tt) == 6)) luaD_throw(L, 5);
