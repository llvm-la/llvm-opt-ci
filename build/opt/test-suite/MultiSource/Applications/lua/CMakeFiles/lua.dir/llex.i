# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldo.h" 1
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldo.h"
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldo.h" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/ldo.h" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
__attribute__((visibility("hidden"))) extern Proto *luaY_parser (lua_State *L, ZIO *z, Mbuffer *buff,
                                            const char *name);
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c" 2
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c"
...
# 161 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/lua/llex.c"
...
static void read_long_string (LexState *ls, SemInfo *seminfo, int sep) {
  ...
  for (;;) {
    switch (ls->current) {
      ...
      default: {
        if (seminfo) (save(ls, ls->current), (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z))));
        else (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z)));
      }
    }
  } endloop:
  if (seminfo)
  ...
  for (;;) {
    switch (ls->current) {
      ...
      case '=': {
        (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z)));
        if (ls->current != '=') return '=';
        else { (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z))); return TK_EQ; }
      }
      case '<': {
        (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z)));
        if (ls->current != '=') return '<';
        else { (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z))); return TK_LE; }
      }
      case '>': {
        (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z)));
        if (ls->current != '=') return '>';
        else { (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z))); return TK_GE; }
      }
      case '~': {
        (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z)));
        if (ls->current != '=') return '~';
        else { (ls->current = (((ls->z)->n--)>0 ? ((int)(((unsigned char)((*(ls->z)->p++))))) : luaZ_fill(ls->z))); return TK_NE; }
      }
      case '"':
      case '\'': {
      ...
      case '.': {
        ...
        else if (!((*__ctype_b_loc ())[(int) ((ls->current))] & (unsigned short int) _ISdigit)) return '.';
        else {
