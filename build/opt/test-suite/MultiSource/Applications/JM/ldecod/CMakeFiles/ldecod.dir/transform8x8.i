# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c" 2
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c"
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.h" 1
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.h"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.h" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/image.h"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/image.h" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.h" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/mb_access.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/mb_access.h"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.h" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/elements.h" 1
# 103 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/elements.h"
extern int assignSE2partition[][20];
extern int PartitionMode;
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.h" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.h" 2


int **cofAC8x8_intra, ****cofAC8x8_iintra;
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c" 2
...
# 244 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c"
int intrapred8x8( struct img_par *img,
                  int b8)

{
  ...
  case 2:
    ...
    for(j = joff; j < joff + 2*4; j++)
      for(i = ioff; i < ioff + 2*4; i++)
  ...
  case 0:
    ...
    for (i=0; i < 2*4; i++)
    {
      ...
      img->mpr[jpos5][ipos] =
      img->mpr[jpos6][ipos] =
      img->mpr[jpos7][ipos] = (imgpel) (&(PredPel[1]))[i];
    }
    break;
  case 1:
    if (!block_available_left)
    ...
    for (j=0; j < 2*4; j++)
    {
      ...
      img->mpr[jpos][ipos5] =
      img->mpr[jpos][ipos6] =
      img->mpr[jpos][ipos7] = (imgpel) (&(PredPel[17]))[j];
    }
    break;
  ...
  case 3:
    ...
    img->mpr[jpos0][ipos0] = (imgpel) (((PredPel[1]) + (PredPel[3]) + 2*((PredPel[2])) + 2) >> 2);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos0][ipos1] = (imgpel) (((PredPel[2]) + (PredPel[4]) + 2*((PredPel[3])) + 2) >> 2);
    img->mpr[jpos2][ipos0] =
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos0][ipos2] = (imgpel) (((PredPel[3]) + (PredPel[5]) + 2*((PredPel[4])) + 2) >> 2);
    img->mpr[jpos3][ipos0] =
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos0][ipos3] = (imgpel) (((PredPel[4]) + (PredPel[6]) + 2*((PredPel[5])) + 2) >> 2);
    img->mpr[jpos4][ipos0] =
    img->mpr[jpos3][ipos1] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos0][ipos4] = (imgpel) (((PredPel[5]) + (PredPel[7]) + 2*((PredPel[6])) + 2) >> 2);
    img->mpr[jpos5][ipos0] =
    img->mpr[jpos4][ipos1] =
    img->mpr[jpos3][ipos2] =
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos1][ipos4] =
    img->mpr[jpos0][ipos5] = (imgpel) (((PredPel[6]) + (PredPel[8]) + 2*((PredPel[7])) + 2) >> 2);
    img->mpr[jpos6][ipos0] =
    img->mpr[jpos5][ipos1] =
    img->mpr[jpos4][ipos2] =
    img->mpr[jpos3][ipos3] =
    img->mpr[jpos2][ipos4] =
    img->mpr[jpos1][ipos5] =
    img->mpr[jpos0][ipos6] = (imgpel) (((PredPel[7]) + (PredPel[9]) + 2*((PredPel[8])) + 2) >> 2);
    img->mpr[jpos7][ipos0] =
    img->mpr[jpos6][ipos1] =
    img->mpr[jpos5][ipos2] =
    img->mpr[jpos4][ipos3] =
    ...
    img->mpr[jpos2][ipos5] =
    img->mpr[jpos1][ipos6] =
    img->mpr[jpos0][ipos7] = (imgpel) (((PredPel[8]) + (PredPel[10]) + 2*((PredPel[9])) + 2) >> 2);
    img->mpr[jpos7][ipos1] =
    img->mpr[jpos6][ipos2] =
    img->mpr[jpos5][ipos3] =
    img->mpr[jpos4][ipos4] =
    img->mpr[jpos3][ipos5] =
    img->mpr[jpos2][ipos6] =
    img->mpr[jpos1][ipos7] = (imgpel) (((PredPel[9]) + (PredPel[11]) + 2*((PredPel[10])) + 2) >> 2);
    img->mpr[jpos7][ipos2] =
    img->mpr[jpos6][ipos3] =
    img->mpr[jpos5][ipos4] =
    img->mpr[jpos4][ipos5] =
    img->mpr[jpos3][ipos6] =
    img->mpr[jpos2][ipos7] = (imgpel) (((PredPel[10]) + (PredPel[12]) + 2*((PredPel[11])) + 2) >> 2);
    img->mpr[jpos7][ipos3] =
    img->mpr[jpos6][ipos4] =
    img->mpr[jpos5][ipos5] =
    img->mpr[jpos4][ipos6] =
    img->mpr[jpos3][ipos7] = (imgpel) (((PredPel[11]) + (PredPel[13]) + 2*((PredPel[12])) + 2) >> 2);
    img->mpr[jpos7][ipos4] =
    img->mpr[jpos6][ipos5] =
    img->mpr[jpos5][ipos6] =
    img->mpr[jpos4][ipos7] = (imgpel) (((PredPel[12]) + (PredPel[14]) + 2*((PredPel[13])) + 2) >> 2);
    img->mpr[jpos7][ipos5] =
    img->mpr[jpos6][ipos6] =
    img->mpr[jpos5][ipos7] = (imgpel) (((PredPel[13]) + (PredPel[15]) + 2*((PredPel[14])) + 2) >> 2);
    img->mpr[jpos7][ipos6] =
    img->mpr[jpos6][ipos7] = (imgpel) (((PredPel[14]) + (PredPel[16]) + 2*((PredPel[15])) + 2) >> 2);
    img->mpr[jpos7][ipos7] = (imgpel) (((PredPel[15]) + 3*((PredPel[16])) + 2) >> 2);
    break;
  ...
  case 7:
    ...
    img->mpr[jpos0][ipos0] = (imgpel) (((PredPel[1]) + (PredPel[2]) + 1) >> 1);
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos2][ipos0] = (imgpel) (((PredPel[2]) + (PredPel[3]) + 1) >> 1);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos4][ipos0] = (imgpel) (((PredPel[3]) + (PredPel[4]) + 1) >> 1);
    img->mpr[jpos0][ipos3] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos4][ipos1] =
    img->mpr[jpos6][ipos0] = (imgpel) (((PredPel[4]) + (PredPel[5]) + 1) >> 1);
    img->mpr[jpos0][ipos4] =
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos4][ipos2] =
    img->mpr[jpos6][ipos1] = (imgpel) (((PredPel[5]) + (PredPel[6]) + 1) >> 1);
    img->mpr[jpos0][ipos5] =
    img->mpr[jpos2][ipos4] =
    img->mpr[jpos4][ipos3] =
    img->mpr[jpos6][ipos2] = (imgpel) (((PredPel[6]) + (PredPel[7]) + 1) >> 1);
    img->mpr[jpos0][ipos6] =
    img->mpr[jpos2][ipos5] =
    img->mpr[jpos4][ipos4] =
    img->mpr[jpos6][ipos3] = (imgpel) (((PredPel[7]) + (PredPel[8]) + 1) >> 1);
    img->mpr[jpos0][ipos7] =
    img->mpr[jpos2][ipos6] =
    img->mpr[jpos4][ipos5] =
    img->mpr[jpos6][ipos4] = (imgpel) (((PredPel[8]) + (PredPel[9]) + 1) >> 1);
    img->mpr[jpos2][ipos7] =
    img->mpr[jpos4][ipos6] =
    img->mpr[jpos6][ipos5] = (imgpel) (((PredPel[9]) + (PredPel[10]) + 1) >> 1);
    img->mpr[jpos4][ipos7] =
    img->mpr[jpos6][ipos6] = (imgpel) (((PredPel[10]) + (PredPel[11]) + 1) >> 1);
    img->mpr[jpos6][ipos7] = (imgpel) (((PredPel[11]) + (PredPel[12]) + 1) >> 1);
    img->mpr[jpos1][ipos0] = (imgpel) (((PredPel[1]) + (PredPel[3]) + 2*(PredPel[2]) + 2) >> 2);
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos3][ipos0] = (imgpel) (((PredPel[2]) + (PredPel[4]) + 2*(PredPel[3]) + 2) >> 2);
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos3][ipos1] =
    img->mpr[jpos5][ipos0] = (imgpel) (((PredPel[3]) + (PredPel[5]) + 2*(PredPel[4]) + 2) >> 2);
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos3][ipos2] =
    img->mpr[jpos5][ipos1] =
    img->mpr[jpos7][ipos0] = (imgpel) (((PredPel[4]) + (PredPel[6]) + 2*(PredPel[5]) + 2) >> 2);
    img->mpr[jpos1][ipos4] =
    img->mpr[jpos3][ipos3] =
    img->mpr[jpos5][ipos2] =
    img->mpr[jpos7][ipos1] = (imgpel) (((PredPel[5]) + (PredPel[7]) + 2*(PredPel[6]) + 2) >> 2);
    img->mpr[jpos1][ipos5] =
    img->mpr[jpos3][ipos4] =
    img->mpr[jpos5][ipos3] =
    img->mpr[jpos7][ipos2] = (imgpel) (((PredPel[6]) + (PredPel[8]) + 2*(PredPel[7]) + 2) >> 2);
    img->mpr[jpos1][ipos6] =
    img->mpr[jpos3][ipos5] =
    img->mpr[jpos5][ipos4] =
    img->mpr[jpos7][ipos3] = (imgpel) (((PredPel[7]) + (PredPel[9]) + 2*(PredPel[8]) + 2) >> 2);
    img->mpr[jpos1][ipos7] =
    img->mpr[jpos3][ipos6] =
    img->mpr[jpos5][ipos5] =
    img->mpr[jpos7][ipos4] = (imgpel) (((PredPel[8]) + (PredPel[10]) + 2*(PredPel[9]) + 2) >> 2);
    img->mpr[jpos3][ipos7] =
    img->mpr[jpos5][ipos6] =
    img->mpr[jpos7][ipos5] = (imgpel) (((PredPel[9]) + (PredPel[11]) + 2*(PredPel[10]) + 2) >> 2);
    img->mpr[jpos5][ipos7] =
    img->mpr[jpos7][ipos6] = (imgpel) (((PredPel[10]) + (PredPel[12]) + 2*(PredPel[11]) + 2) >> 2);
    img->mpr[jpos7][ipos7] = (imgpel) (((PredPel[11]) + (PredPel[13]) + 2*(PredPel[12]) + 2) >> 2);
    break;
  ...
  case 4:
    ...
    img->mpr[jpos7][ipos0] = (imgpel) (((PredPel[24]) + (PredPel[22]) + 2*((PredPel[23])) + 2) >> 2);
    img->mpr[jpos6][ipos0] =
    img->mpr[jpos7][ipos1] = (imgpel) (((PredPel[23]) + (PredPel[21]) + 2*((PredPel[22])) + 2) >> 2);
    img->mpr[jpos5][ipos0] =
    img->mpr[jpos6][ipos1] =
    img->mpr[jpos7][ipos2] = (imgpel) (((PredPel[22]) + (PredPel[20]) + 2*((PredPel[21])) + 2) >> 2);
    img->mpr[jpos4][ipos0] =
    img->mpr[jpos5][ipos1] =
    img->mpr[jpos6][ipos2] =
    img->mpr[jpos7][ipos3] = (imgpel) (((PredPel[21]) + (PredPel[19]) + 2*((PredPel[20])) + 2) >> 2);
    img->mpr[jpos3][ipos0] =
    img->mpr[jpos4][ipos1] =
    img->mpr[jpos5][ipos2] =
    img->mpr[jpos6][ipos3] =
    img->mpr[jpos7][ipos4] = (imgpel) (((PredPel[20]) + (PredPel[18]) + 2*((PredPel[19])) + 2) >> 2);
    img->mpr[jpos2][ipos0] =
    img->mpr[jpos3][ipos1] =
    img->mpr[jpos4][ipos2] =
    img->mpr[jpos5][ipos3] =
    img->mpr[jpos6][ipos4] =
    img->mpr[jpos7][ipos5] = (imgpel) (((PredPel[19]) + (PredPel[17]) + 2*((PredPel[18])) + 2) >> 2);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos3][ipos2] =
    img->mpr[jpos4][ipos3] =
    img->mpr[jpos5][ipos4] =
    img->mpr[jpos6][ipos5] =
    img->mpr[jpos7][ipos6] = (imgpel) (((PredPel[18]) + (PredPel[0]) + 2*((PredPel[17])) + 2) >> 2);
    img->mpr[jpos0][ipos0] =
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos3][ipos3] =
    ...
    img->mpr[jpos5][ipos5] =
    img->mpr[jpos6][ipos6] =
    img->mpr[jpos7][ipos7] = (imgpel) (((PredPel[17]) + (PredPel[1]) + 2*((PredPel[0])) + 2) >> 2);
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos3][ipos4] =
    img->mpr[jpos4][ipos5] =
    img->mpr[jpos5][ipos6] =
    img->mpr[jpos6][ipos7] = (imgpel) (((PredPel[0]) + (PredPel[2]) + 2*((PredPel[1])) + 2) >> 2);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos2][ipos4] =
    img->mpr[jpos3][ipos5] =
    img->mpr[jpos4][ipos6] =
    img->mpr[jpos5][ipos7] = (imgpel) (((PredPel[1]) + (PredPel[3]) + 2*((PredPel[2])) + 2) >> 2);
    img->mpr[jpos0][ipos3] =
    img->mpr[jpos1][ipos4] =
    img->mpr[jpos2][ipos5] =
    img->mpr[jpos3][ipos6] =
    img->mpr[jpos4][ipos7] = (imgpel) (((PredPel[2]) + (PredPel[4]) + 2*((PredPel[3])) + 2) >> 2);
    img->mpr[jpos0][ipos4] =
    img->mpr[jpos1][ipos5] =
    img->mpr[jpos2][ipos6] =
    img->mpr[jpos3][ipos7] = (imgpel) (((PredPel[3]) + (PredPel[5]) + 2*((PredPel[4])) + 2) >> 2);
    img->mpr[jpos0][ipos5] =
    img->mpr[jpos1][ipos6] =
    img->mpr[jpos2][ipos7] = (imgpel) (((PredPel[4]) + (PredPel[6]) + 2*((PredPel[5])) + 2) >> 2);
    img->mpr[jpos0][ipos6] =
    img->mpr[jpos1][ipos7] = (imgpel) (((PredPel[5]) + (PredPel[7]) + 2*((PredPel[6])) + 2) >> 2);
    img->mpr[jpos0][ipos7] = (imgpel) (((PredPel[6]) + (PredPel[8]) + 2*((PredPel[7])) + 2) >> 2);
    break;
  ...
  case 5:
    ...
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos4][ipos2] =
    img->mpr[jpos6][ipos3] = (imgpel) (((PredPel[0]) + (PredPel[1]) + 1) >> 1);
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos4][ipos3] =
    img->mpr[jpos6][ipos4] = (imgpel) (((PredPel[1]) + (PredPel[2]) + 1) >> 1);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos4][ipos4] =
    img->mpr[jpos6][ipos5] = (imgpel) (((PredPel[2]) + (PredPel[3]) + 1) >> 1);
    img->mpr[jpos0][ipos3] =
    img->mpr[jpos2][ipos4] =
    img->mpr[jpos4][ipos5] =
    img->mpr[jpos6][ipos6] = (imgpel) (((PredPel[3]) + (PredPel[4]) + 1) >> 1);
    img->mpr[jpos0][ipos4] =
    img->mpr[jpos2][ipos5] =
    img->mpr[jpos4][ipos6] =
    img->mpr[jpos6][ipos7] = (imgpel) (((PredPel[4]) + (PredPel[5]) + 1) >> 1);
    img->mpr[jpos0][ipos5] =
    img->mpr[jpos2][ipos6] =
    img->mpr[jpos4][ipos7] = (imgpel) (((PredPel[5]) + (PredPel[6]) + 1) >> 1);
    img->mpr[jpos0][ipos6] =
    img->mpr[jpos2][ipos7] = (imgpel) (((PredPel[6]) + (PredPel[7]) + 1) >> 1);
    img->mpr[jpos0][ipos7] = (imgpel) (((PredPel[7]) + (PredPel[8]) + 1) >> 1);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos3][ipos1] =
    img->mpr[jpos5][ipos2] =
    img->mpr[jpos7][ipos3] = (imgpel) (((PredPel[17]) + (PredPel[1]) + 2*(PredPel[0]) + 2) >> 2);
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos3][ipos2] =
    img->mpr[jpos5][ipos3] =
    img->mpr[jpos7][ipos4] = (imgpel) (((PredPel[0]) + (PredPel[2]) + 2*(PredPel[1]) + 2) >> 2);
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos3][ipos3] =
    img->mpr[jpos5][ipos4] =
    img->mpr[jpos7][ipos5] = (imgpel) (((PredPel[1]) + (PredPel[3]) + 2*(PredPel[2]) + 2) >> 2);
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos3][ipos4] =
    img->mpr[jpos5][ipos5] =
    img->mpr[jpos7][ipos6] = (imgpel) (((PredPel[2]) + (PredPel[4]) + 2*(PredPel[3]) + 2) >> 2);
    img->mpr[jpos1][ipos4] =
    img->mpr[jpos3][ipos5] =
    img->mpr[jpos5][ipos6] =
    img->mpr[jpos7][ipos7] = (imgpel) (((PredPel[3]) + (PredPel[5]) + 2*(PredPel[4]) + 2) >> 2);
    img->mpr[jpos1][ipos5] =
    img->mpr[jpos3][ipos6] =
    img->mpr[jpos5][ipos7] = (imgpel) (((PredPel[4]) + (PredPel[6]) + 2*(PredPel[5]) + 2) >> 2);
    img->mpr[jpos1][ipos6] =
    img->mpr[jpos3][ipos7] = (imgpel) (((PredPel[5]) + (PredPel[7]) + 2*(PredPel[6]) + 2) >> 2);
    img->mpr[jpos1][ipos7] = (imgpel) (((PredPel[6]) + (PredPel[8]) + 2*(PredPel[7]) + 2) >> 2);
    img->mpr[jpos2][ipos0] =
    img->mpr[jpos4][ipos1] =
    img->mpr[jpos6][ipos2] = (imgpel) (((PredPel[18]) + (PredPel[0]) + 2*(PredPel[17]) + 2) >> 2);
    img->mpr[jpos3][ipos0] =
    img->mpr[jpos5][ipos1] =
    img->mpr[jpos7][ipos2] = (imgpel) (((PredPel[19]) + (PredPel[17]) + 2*(PredPel[18]) + 2) >> 2);
    img->mpr[jpos4][ipos0] =
    img->mpr[jpos6][ipos1] = (imgpel) (((PredPel[20]) + (PredPel[18]) + 2*(PredPel[19]) + 2) >> 2);
    img->mpr[jpos5][ipos0] =
    img->mpr[jpos7][ipos1] = (imgpel) (((PredPel[21]) + (PredPel[19]) + 2*(PredPel[20]) + 2) >> 2);
    img->mpr[jpos6][ipos0] = (imgpel) (((PredPel[22]) + (PredPel[20]) + 2*(PredPel[21]) + 2) >> 2);
    img->mpr[jpos7][ipos0] = (imgpel) (((PredPel[23]) + (PredPel[21]) + 2*(PredPel[22]) + 2) >> 2);
    break;
  ...
  case 6:
    ...
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos2][ipos4] =
    img->mpr[jpos3][ipos6] = (imgpel) (((PredPel[17]) + (PredPel[0]) + 1) >> 1);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos3][ipos4] =
    img->mpr[jpos4][ipos6] = (imgpel) (((PredPel[18]) + (PredPel[17]) + 1) >> 1);
    img->mpr[jpos2][ipos0] =
    img->mpr[jpos3][ipos2] =
    img->mpr[jpos4][ipos4] =
    img->mpr[jpos5][ipos6] = (imgpel) (((PredPel[19]) + (PredPel[18]) + 1) >> 1);
    img->mpr[jpos3][ipos0] =
    img->mpr[jpos4][ipos2] =
    img->mpr[jpos5][ipos4] =
    img->mpr[jpos6][ipos6] = (imgpel) (((PredPel[20]) + (PredPel[19]) + 1) >> 1);
    img->mpr[jpos4][ipos0] =
    img->mpr[jpos5][ipos2] =
    img->mpr[jpos6][ipos4] =
    img->mpr[jpos7][ipos6] = (imgpel) (((PredPel[21]) + (PredPel[20]) + 1) >> 1);
    img->mpr[jpos5][ipos0] =
    img->mpr[jpos6][ipos2] =
    img->mpr[jpos7][ipos4] = (imgpel) (((PredPel[22]) + (PredPel[21]) + 1) >> 1);
    img->mpr[jpos6][ipos0] =
    img->mpr[jpos7][ipos2] = (imgpel) (((PredPel[23]) + (PredPel[22]) + 1) >> 1);
    img->mpr[jpos7][ipos0] = (imgpel) (((PredPel[24]) + (PredPel[23]) + 1) >> 1);
    img->mpr[jpos0][ipos1] =
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos2][ipos5] =
    img->mpr[jpos3][ipos7] = (imgpel) (((PredPel[17]) + (PredPel[1]) + 2*(PredPel[0]) + 2) >> 2);
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos3][ipos5] =
    img->mpr[jpos4][ipos7] = (imgpel) (((PredPel[0]) + (PredPel[18]) + 2*(PredPel[17]) + 2) >> 2);
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos3][ipos3] =
    img->mpr[jpos4][ipos5] =
    img->mpr[jpos5][ipos7] = (imgpel) (((PredPel[17]) + (PredPel[19]) + 2*(PredPel[18]) + 2) >> 2);
    img->mpr[jpos3][ipos1] =
    img->mpr[jpos4][ipos3] =
    img->mpr[jpos5][ipos5] =
    img->mpr[jpos6][ipos7] = (imgpel) (((PredPel[18]) + (PredPel[20]) + 2*(PredPel[19]) + 2) >> 2);
    img->mpr[jpos4][ipos1] =
    img->mpr[jpos5][ipos3] =
    img->mpr[jpos6][ipos5] =
    img->mpr[jpos7][ipos7] = (imgpel) (((PredPel[19]) + (PredPel[21]) + 2*(PredPel[20]) + 2) >> 2);
    img->mpr[jpos5][ipos1] =
    img->mpr[jpos6][ipos3] =
    img->mpr[jpos7][ipos5] = (imgpel) (((PredPel[20]) + (PredPel[22]) + 2*(PredPel[21]) + 2) >> 2);
    img->mpr[jpos6][ipos1] =
    img->mpr[jpos7][ipos3] = (imgpel) (((PredPel[21]) + (PredPel[23]) + 2*(PredPel[22]) + 2) >> 2);
    img->mpr[jpos7][ipos1] = (imgpel) (((PredPel[22]) + (PredPel[24]) + 2*(PredPel[23]) + 2) >> 2);
    img->mpr[jpos0][ipos2] =
    img->mpr[jpos1][ipos4] =
    img->mpr[jpos2][ipos6] = (imgpel) (((PredPel[0]) + (PredPel[2]) + 2*(PredPel[1]) + 2) >> 2);
    img->mpr[jpos0][ipos3] =
    img->mpr[jpos1][ipos5] =
    img->mpr[jpos2][ipos7] = (imgpel) (((PredPel[1]) + (PredPel[3]) + 2*(PredPel[2]) + 2) >> 2);
    img->mpr[jpos0][ipos4] =
    img->mpr[jpos1][ipos6] = (imgpel) (((PredPel[2]) + (PredPel[4]) + 2*(PredPel[3]) + 2) >> 2);
    img->mpr[jpos0][ipos5] =
    img->mpr[jpos1][ipos7] = (imgpel) (((PredPel[3]) + (PredPel[5]) + 2*(PredPel[4]) + 2) >> 2);
    img->mpr[jpos0][ipos6] = (imgpel) (((PredPel[4]) + (PredPel[6]) + 2*(PredPel[5]) + 2) >> 2);
    img->mpr[jpos0][ipos7] = (imgpel) (((PredPel[5]) + (PredPel[7]) + 2*(PredPel[6]) + 2) >> 2);
    break;
  ...
  case 8:
    ...
    img->mpr[jpos0][ipos0] = (imgpel) (((PredPel[17]) + (PredPel[18]) + 1) >> 1);
    img->mpr[jpos1][ipos0] =
    img->mpr[jpos0][ipos2] = (imgpel) (((PredPel[18]) + (PredPel[19]) + 1) >> 1);
    img->mpr[jpos2][ipos0] =
    img->mpr[jpos1][ipos2] =
    img->mpr[jpos0][ipos4] = (imgpel) (((PredPel[19]) + (PredPel[20]) + 1) >> 1);
    img->mpr[jpos3][ipos0] =
    img->mpr[jpos2][ipos2] =
    img->mpr[jpos1][ipos4] =
    img->mpr[jpos0][ipos6] = (imgpel) (((PredPel[20]) + (PredPel[21]) + 1) >> 1);
    img->mpr[jpos4][ipos0] =
    img->mpr[jpos3][ipos2] =
    img->mpr[jpos2][ipos4] =
    img->mpr[jpos1][ipos6] = (imgpel) (((PredPel[21]) + (PredPel[22]) + 1) >> 1);
    img->mpr[jpos5][ipos0] =
    img->mpr[jpos4][ipos2] =
    img->mpr[jpos3][ipos4] =
    img->mpr[jpos2][ipos6] = (imgpel) (((PredPel[22]) + (PredPel[23]) + 1) >> 1);
    img->mpr[jpos6][ipos0] =
    img->mpr[jpos5][ipos2] =
    img->mpr[jpos4][ipos4] =
    img->mpr[jpos3][ipos6] = (imgpel) (((PredPel[23]) + (PredPel[24]) + 1) >> 1);
    img->mpr[jpos4][ipos6] =
    img->mpr[jpos4][ipos7] =
    img->mpr[jpos5][ipos4] =
    img->mpr[jpos5][ipos5] =
    ...
    img->mpr[jpos7][ipos5] =
    img->mpr[jpos7][ipos6] =
    img->mpr[jpos7][ipos7] = (imgpel) (PredPel[24]);
    img->mpr[jpos6][ipos1] =
    img->mpr[jpos5][ipos3] =
    img->mpr[jpos4][ipos5] =
    img->mpr[jpos3][ipos7] = (imgpel) (((PredPel[23]) + 3*(PredPel[24]) + 2) >> 2);
    img->mpr[jpos5][ipos1] =
    img->mpr[jpos4][ipos3] =
    img->mpr[jpos3][ipos5] =
    img->mpr[jpos2][ipos7] = (imgpel) (((PredPel[24]) + (PredPel[22]) + 2*(PredPel[23]) + 2) >> 2);
    img->mpr[jpos4][ipos1] =
    img->mpr[jpos3][ipos3] =
    img->mpr[jpos2][ipos5] =
    img->mpr[jpos1][ipos7] = (imgpel) (((PredPel[23]) + (PredPel[21]) + 2*(PredPel[22]) + 2) >> 2);
    img->mpr[jpos3][ipos1] =
    img->mpr[jpos2][ipos3] =
    img->mpr[jpos1][ipos5] =
    img->mpr[jpos0][ipos7] = (imgpel) (((PredPel[22]) + (PredPel[20]) + 2*(PredPel[21]) + 2) >> 2);
    img->mpr[jpos2][ipos1] =
    img->mpr[jpos1][ipos3] =
    img->mpr[jpos0][ipos5] = (imgpel) (((PredPel[21]) + (PredPel[19]) + 2*(PredPel[20]) + 2) >> 2);
    img->mpr[jpos1][ipos1] =
    img->mpr[jpos0][ipos3] = (imgpel) (((PredPel[20]) + (PredPel[18]) + 2*(PredPel[19]) + 2) >> 2);
    img->mpr[jpos0][ipos1] = (imgpel) (((PredPel[19]) + (PredPel[17]) + 2*(PredPel[18]) + 2) >> 2);
    break;
...
# 873 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c"
void LowPassForIntra8x8Pred(imgpel *PredPel, int block_up_left, int block_up, int block_left)
{
  int i;
  imgpel LoopArray[25];
...
# 940 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/transform8x8.c"
void itrans8x8(struct img_par *img,
              int ioff,
              int joff)
{
  int i,j;
  ...
  else
  {
    ...
    for( j = joff; j < joff + 8; j++)
    {
      for( i = ioff; i < ioff + 8; i++)
        ...
        rshift_rnd_sf((img->m7[j][i]+((long)img->mpr[j][i] << 6)),6));
    }
  }
}
