# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c" 2
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c" 2
...
# 137 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_api.h" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
int ercConcealIntraFrame( frame *recfr, int picSizeX, int picSizeY, ercVariables_t *errorVar )
{
...
# 91 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
void ercPixConcealIMB(imgpel *currFrame, int row, int column, int predBlocks[], int frameWidth, int mbWidthInBlocks)
{
   imgpel *src[8]={((void*)0),((void*)0),((void*)0),((void*)0),((void*)0),((void*)0),((void*)0),((void*)0)};
   imgpel *currBlock = ((void*)0);
...
# 151 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
int ercCollect8PredBlocks( int predBlocks[], int currRow, int currColumn, int *condition,
                           int maxRow, int maxColumn, int step, byte fNoCornerNeigh )
{
  int srcCounter = 0;
...
# 260 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
int ercCollectColumnBlocks( int predBlocks[], int currRow, int currColumn, int *condition, int maxRow, int maxColumn, int step )
{
  int srcCounter = 0, threshold = 1;
...
# 304 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
static void concealBlocks( int lastColumn, int lastRow, int comp, frame *recfr, int picSizeX, int *condition )
{
  int row, column, srcCounter = 0, thr = 1,
      ...
      if ( condition[row*lastColumn+column] <= thr )
      {
        ...
        if ( lastCorruptedRow >= lastRow )
        {
          ...
          for ( currRow = firstCorruptedRow; currRow < lastRow; currRow += step )
          {
            ...
            if ( comp == 0 )
            {
              condition[ currRow*lastColumn+column] = 2;
              condition[ currRow*lastColumn+column + 1] = 2;
              condition[ currRow*lastColumn+column + lastColumn] = 2;
              condition[ currRow*lastColumn+column + lastColumn + 1] = 2;
            }
            else
            {
              condition[ currRow*lastColumn+column] = 2;
...
# 490 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_i.c"
static void pixMeanInterpolateBlock( imgpel *src[], imgpel *block, int blockSize, int frameWidth )
{
