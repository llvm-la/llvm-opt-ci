# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c" 2
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int init_top_bot_planes(imgpel **imgFrame, int rows, int columns, imgpel ***imgTopField, imgpel ***imgBotField)
{
  int i;

  if((*imgTopField = (imgpel**)calloc(rows/2, sizeof(imgpel*))) == ((void*)0))
    no_mem_exit("init_top_bot_planes: imgTopField");

  if((*imgBotField = (imgpel**)calloc(rows/2, sizeof(imgpel*))) == ((void*)0))
...
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
void free_top_bot_planes(imgpel **imgTopField, imgpel **imgBotField)
{
  free (imgTopField);
  free (imgBotField);
}
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem2Dpel(imgpel ***array2D, int rows, int columns)
{
  int i;

  if((*array2D = (imgpel**)calloc(rows, sizeof(imgpel*))) == ((void*)0))
    no_mem_exit("get_mem2Dpel: array2D");
  if(((*array2D)[0] = (imgpel* )calloc(rows*columns,sizeof(imgpel ))) == ((void*)0))
    no_mem_exit("get_mem2Dpel: array2D");
...
# 94 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem3Dpel(imgpel ****array3D, int frames, int rows, int columns)
{
  int j;

  if(((*array3D) = (imgpel***)calloc(frames,sizeof(imgpel**))) == ((void*)0))
...
# 116 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem4Dpel(imgpel *****array4D, int sub_x, int sub_y, int rows, int columns)
{
  int j;

  if(((*array4D) = (imgpel****)calloc(sub_x,sizeof(imgpel***))) == ((void*)0))
...
# 138 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem5Dpel(imgpel ******array5D, int dims, int sub_x, int sub_y, int rows, int columns)
{
  int j;

  if(((*array5D) = (imgpel*****)calloc(dims,sizeof(imgpel****))) == ((void*)0))
...
# 158 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 181 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 205 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 228 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 252 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem2D(byte ***array2D, int rows, int columns)
{
  int i;

  if((*array2D = (byte**)calloc(rows, sizeof(byte*))) == ((void*)0))
    no_mem_exit("get_mem2D: array2D");
  if(((*array2D)[0] = (byte* )calloc(columns*rows,sizeof(byte ))) == ((void*)0))
    no_mem_exit("get_mem2D: array2D");
...
# 276 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem2Dint(int ***array2D, int rows, int columns)
{
  int i;

  if((*array2D = (int**)calloc(rows, sizeof(int*))) == ((void*)0))
    no_mem_exit("get_mem2Dint: array2D");
  if(((*array2D)[0] = (int* )calloc(rows*columns,sizeof(int ))) == ((void*)0))
    no_mem_exit("get_mem2Dint: array2D");
...
# 300 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem2Dint64(int64 ***array2D, int rows, int columns)
{
  int i;

  if((*array2D = (int64**)calloc(rows, sizeof(int64*))) == ((void*)0))
    no_mem_exit("get_mem2Dint64: array2D");
  if(((*array2D)[0] = (int64* )calloc(rows*columns,sizeof(int64 ))) == ((void*)0))
    no_mem_exit("get_mem2Dint64: array2D");
...
# 324 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem3D(byte ****array3D, int frames, int rows, int columns)
{
  int j;

  if(((*array3D) = (byte***)calloc(frames,sizeof(byte**))) == ((void*)0))
...
# 346 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem3Dint(int ****array3D, int frames, int rows, int columns)
{
  int j;

  if(((*array3D) = (int***)calloc(frames,sizeof(int**))) == ((void*)0))
...
# 368 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem3Dint64(int64 ****array3D, int frames, int rows, int columns)
{
  int j;

  if(((*array3D) = (int64***)calloc(frames,sizeof(int64**))) == ((void*)0))
...
# 390 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem4Dint(int *****array4D, int idx, int frames, int rows, int columns )
{
  int j;

  if(((*array4D) = (int****)calloc(idx,sizeof(int***))) == ((void*)0))
...
# 412 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem5Dint(int ******array5D, int refs, int blocktype, int rows, int columns, int component)
{
  int j;

  if(((*array5D) = (int*****)calloc(refs,sizeof(int****))) == ((void*)0))
...
# 434 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 456 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 479 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 503 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 527 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 552 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 576 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 598 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 621 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
void no_mem_exit(char *where)
{
   snprintf(errortext, 300, "Could not allocate memory: %s",where);
   error (errortext, 100);
}
# 637 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem2Dshort(short ***array2D, int rows, int columns)
{
  int i;

  if((*array2D = (short**)calloc(rows, sizeof(short*))) == ((void*)0))
    no_mem_exit("get_mem2Dshort: array2D");
  if(((*array2D)[0] = (short* )calloc(rows*columns,sizeof(short ))) == ((void*)0))
    no_mem_exit("get_mem2Dshort: array2D");
...
# 661 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem3Dshort(short ****array3D, int frames, int rows, int columns)
{
  int j;

  if(((*array3D) = (short***)calloc(frames,sizeof(short**))) == ((void*)0))
...
# 683 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem4Dshort(short *****array4D, int idx, int frames, int rows, int columns )
{
  int j;

  if(((*array4D) = (short****)calloc(idx,sizeof(short**))) == ((void*)0))
...
# 705 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem5Dshort(short ******array5D, int refs, int blocktype, int rows, int columns, int component)
{
  int j;

  if(((*array5D) = (short*****)calloc(refs,sizeof(short****))) == ((void*)0))
...
# 728 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem6Dshort(short *******array6D, int list, int refs, int blocktype, int rows, int columns, int component)
{
  int j;

  if(((*array6D) = (short******)calloc(list,sizeof(short*****))) == ((void*)0))
...
# 749 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 772 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 796 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 818 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 841 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 867 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem2Ddouble(double ***array2D, int rows, int columns)
{
  int i;

  if((*array2D = (double**)calloc(rows, sizeof(double*))) == ((void*)0))
    no_mem_exit("get_mem2Ddouble: array2D");
  if(((*array2D)[0] = (double* )calloc(rows*columns,sizeof(double ))) == ((void*)0))
    no_mem_exit("get_mem2Ddouble: array2D");
...
# 892 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 918 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem3Ddb_offset(double ****array3D, int rows, int columns, int pels, int offset)
{
  int i,j;

  if(((*array3D) = (double***)calloc(rows,sizeof(double**))) == ((void*)0))
    no_mem_exit("get_mem3Ddb_offset: array3D");

  if(((*array3D)[0] = (double** )calloc(rows*columns,sizeof(double*))) == ((void*)0))
    no_mem_exit("get_mem3Ddb_offset: array3D");
  ...
  for (i = 0; i < rows; i++)
    for (j = -offset; j < columns - offset; j++)
      if(((*array3D)[i][j] = (double* )calloc(pels,sizeof(double))) == ((void*)0))
        no_mem_exit("get_mem3Ddb_offset: array3D");

  return rows*columns*pels*sizeof(double);
}
# 951 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
int get_mem3Dint_offset(int ****array3D, int rows, int columns, int pels, int offset)
{
  int i,j;

  if(((*array3D) = (int***)calloc(rows,sizeof(int**))) == ((void*)0))
    no_mem_exit("get_mem3Dint_offset: array3D");

  if(((*array3D)[0] = (int** )calloc(rows*columns,sizeof(int*))) == ((void*)0))
    no_mem_exit("get_mem3Dint_offset: array3D");
  ...
  for (i = 0; i < rows; i++)
    for (j = -offset; j < columns - offset; j++)
      if(((*array3D)[i][j] = (int* )calloc(pels,sizeof(int))) == ((void*)0))
        no_mem_exit("get_mem3Dint_offset: array3D");

  return rows*columns*pels*sizeof(int);
}
# 982 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 1008 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 1103 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
...
# 1128 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/memalloc.c"
