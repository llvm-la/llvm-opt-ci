# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.h" 1
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.h"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c" 2
...
void create_hierarchy()
{
  ...
  else
  {
    ...
    if (((void*)0) == (curGOPLevelfrm = (int*)malloc(GOPlevels * sizeof(int)))) no_mem_exit("create_hierarchy:curGOPLevelfrm");
    if (((void*)0) == (curGOPLeveldist= (int*)malloc(GOPlevels * sizeof(int)))) no_mem_exit("create_hierarchy:curGOPLeveldist");
...
# 121 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c"
void init_gop_structure()
{
  int max_gopsize = input->HierarchicalCoding != 3 ? input->successive_Bframe : input->jumpd;

  gop_structure = calloc(imax(10,max_gopsize), sizeof (GOP_DATA));
  if (((void*)0)==gop_structure)
    no_mem_exit("init_gop_structure: gop_structure");
}
# 137 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c"
void clear_gop_structure()
{
  if (gop_structure)
    free(gop_structure);
}
# 150 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c"
void interpret_gop_structure()
{
    ...
    for (i = 0; i < nLength ; i++)
    {
      ...
      if (slice_read == 0)
      {
        ...
        case 'i':
          ...
          break;
        default:
          snprintf(errortext, 300, "Slice Type invalid in ExplicitHierarchyFormat param. Please check configuration file.");
          error (errortext, 400);
          break;
        }
        slice_read = 1;
      ...
      else
      {
        ...
        if (order_read == 0)
        {
          if (((*__ctype_b_loc ())[(int) (((int)(*(input->ExplicitHierarchyFormat+i))))] & (unsigned short int) _ISdigit))
          {
            ...
            {
              snprintf(errortext, 300, "Invalid Frame Order value. Frame position needs to be in [0,%d] range.",input->jumpd-1);
              error (errortext, 400);
            }
            for (k=0;k<coded_frame;k++)
            {
              ...
              {
                snprintf(errortext, 300, "Frame Order value %d in frame %d already used for enhancement frame %d.",display_no,coded_frame,k);
                error (errortext, 400);
              }
            }
          }
          ...
          {
            snprintf(errortext, 300, "Slice Type needs to be followed by Display Order. Please check configuration file.");
            error (errortext, 400);
          }
        }
        else if (order_read == 1)
        {
          if (stored_read == 0 && !(((*__ctype_b_loc ())[(int) (((int)(*(input->ExplicitHierarchyFormat+i))))] & (unsigned short int) _ISdigit)))
          {
            switch (input->ExplicitHierarchyFormat[i])
            {
            case 'E':
            ...
            case 'r':
              ...
              break;
            default:
              snprintf(errortext, 300, "Reference_IDC invalid in ExplicitHierarchyFormat param. Please check configuration file.");
              error (errortext, 400);
              break;
            }
            stored_read = 1;
          ...
          else if (stored_read == 1 && qp_read == 0)
          {
            ...
            {
              snprintf(errortext, 300, "Reference_IDC needs to be followed by QP. Please check configuration file.");
              error (errortext, 400);
            }
          }
          else if (stored_read == 1 && qp_read == 1 && !(((*__ctype_b_loc ())[(int) (((int)(*(input->ExplicitHierarchyFormat+i))))] & (unsigned short int) _ISdigit)) && (i < nLength - 2))
          {
            stored_read =0;
            qp_read=0;
            order_read=0;
            ...
            {
              snprintf(errortext, 300, "Total number of frames in Enhancement GOP need to be fewer or equal to FrameSkip parameter.");
              error (errortext, 400);
            }
          }
        }
  ...
  {
    snprintf(errortext, 300, "ExplicitHierarchyFormat is empty. Please check configuration file.");
    error (errortext, 400);
  }

  input->successive_Bframe = coded_frame + 1;
}
# 297 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/explicit_gop.c"
void encode_enhancement_layer()
{
  int previous_ref_idc = 1;

  if ((input->successive_Bframe != 0) && ((img->number - start_frame_no_in_this_IGOP) > 0))
  {
    ...
    if (input->HierarchicalCoding)
    {
      for(img->b_frame_to_code=1; img->b_frame_to_code<=input->successive_Bframe; img->b_frame_to_code++)
      {
        ...
        if(input->intra_period && input->idr_enable)
          img->toppoc = 2*((((img->number - start_frame_no_in_this_IGOP)%input->intra_period)-1)*(input->jumpd+1) + (int)(img->b_interval * (double)(1 + gop_structure[img->b_frame_to_code - 1].display_no)));
        else
          img->toppoc = 2*(((img->number - start_frame_no_in_this_IGOP)-1)*(input->jumpd + 1) + (int)(img->b_interval * (double)(1 + gop_structure[img->b_frame_to_code -1].display_no)));

        if (img->b_frame_to_code == 1)
          img->delta_pic_order_cnt[0] = img->toppoc - 2*(start_tr_in_this_IGOP + ((img->number - start_frame_no_in_this_IGOP))*((input->jumpd+1)));
        else
          img->delta_pic_order_cnt[0] = img->toppoc - 2*(start_tr_in_this_IGOP + ((img->number - start_frame_no_in_this_IGOP)-1)*((input->jumpd+1)) + (int) (2.0 *img->b_interval * (double) (1+ gop_structure[img->b_frame_to_code - 2].display_no)));

        if ((input->PicInterlace==FRAME_CODING)&&(input->MbInterlace==FRAME_CODING))
          img->bottompoc = img->toppoc;
        else
    ...
    else
    {
      for(img->b_frame_to_code=1; img->b_frame_to_code<=input->successive_Bframe; img->b_frame_to_code++)
      {
        ...
        if(input->intra_period && input->idr_enable)
          img->toppoc = 2*((((img->number - start_frame_no_in_this_IGOP)% input->intra_period)-1)*(input->jumpd+1) + (int) (img->b_interval * (double)img->b_frame_to_code));
        else
          img->toppoc = 2*(((img->number - start_frame_no_in_this_IGOP)-1)*(input->jumpd+1) + (int) (img->b_interval * (double)img->b_frame_to_code));
...
void poc_based_ref_management(int current_pic_num)
{
  ...
  int min_poc=2147483647;
  DecRefPicMarking_t *tmp_drpm,*tmp_drpm2;

  if (img->dec_ref_pic_marking_buffer!=((void*)0))
    return;
  ...
  if (((void*)0)==(tmp_drpm=(DecRefPicMarking_t*)calloc (1,sizeof (DecRefPicMarking_t)))) no_mem_exit("poc_based_ref_management: tmp_drpm");
  tmp_drpm->Next=((void*)0);

  tmp_drpm->memory_management_control_operation = 0;

  if (((void*)0)==(tmp_drpm2=(DecRefPicMarking_t*)calloc (1,sizeof (DecRefPicMarking_t)))) no_mem_exit("poc_based_ref_management: tmp_drpm2");
