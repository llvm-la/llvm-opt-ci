# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
void no_mem_exit(char *where);
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.h"
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.h" 2
...
smpUMHEXBipredIntegerPelBlockMotionSearch (imgpel* cur_pic,
                                           ...
                                           int min_mcost,
                                           int lambda_factor);
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c" 2
...
const short block_type_shift_factor[8] = {0, 0, 1, 1, 2, 3, 3, 1};
...
# 101 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
void smpUMHEX_init()
{
...
{
  int memory_size = 0;
  if (((void*)0)==(smpUMHEX_flag_intra = calloc((img->width>>4)+1, sizeof(byte))))
...
# 151 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
int
smpUMHEXIntegerPelBlockMotionSearch (
                                     imgpel *orig_pic,
                                     short ref,
                                     ...
                                     int lambda_factor)
{
  ...
  if ((0 != pred_mv_x) || (0 != pred_mv_y))
  {
    cand_x = pic_pix_x;
    cand_y = pic_pix_y;
    if(iabs(cand_x - center_x) <= search_range && iabs(cand_y - center_y) <= search_range) { mcost = ((((lambda_factor)*(mvbits[((cand_x)<<(mvshift))-pred_x]+mvbits[((cand_y)<<(mvshift))-pred_y]))>>16)); mcost += computeUniPred[dist_method]( orig_pic, blocksize_y, blocksize_x, min_mcost - mcost, (cand_x + 20) << 2, (cand_y + 20) << 2); if (mcost < min_mcost) { best_x = cand_x; best_y = cand_y; min_mcost = mcost; } }
  }
...
# 496 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
  ...
  for (best_pos = 0, pos = start_me_refinement_hp; pos < max_pos2; pos++)
  {
    ...
    mcost = ((((lambda_factor)*(mvbits[cand_mv_x-pred_mv_x]+mvbits[cand_mv_y-pred_mv_y]))>>16));
  ...
  {
    cand_mv_x = *mv_x + spiral_search_x[pos];
    cand_mv_y = *mv_y + spiral_search_y[pos];
                                  ...
                                  int lambda_factor)
{
  ...
  int pic4_pix_x = ((pic_pix_x + 20)<<2);
  int pic4_pix_y = ((pic_pix_y + 20)<<2);
  short max_pos_x4 = (short) ((ref_picture->size_x - blocksize_x + 2*20)<<2);
  short max_pos_y4 = (short) ((ref_picture->size_y - blocksize_y + 2*20)<<2);
...
# 813 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
int
smpUMHEXBipredIntegerPelBlockMotionSearch (imgpel* cur_pic,
                                     short ref,
                                     int list,
                                     ...
                                     int lambda_factor)
{
  ...
  if (0 != pred_mv_x1 || 0 != pred_mv_y1 || 0 != pred_mv_x2 || 0 != pred_mv_y2)
  {
    cand_x = pic_pix_x;
    cand_y = pic_pix_y;
    if (iabs(cand_x - center2_x) <= search_range && iabs(cand_y - center2_y) <= search_range) { mcost = ((((lambda_factor)*(mvbits[((center1_x)<<(mvshift))-pred_x1]+mvbits[((center1_y)<<(mvshift))-pred_y1]))>>16)); mcost += ((((lambda_factor)*(mvbits[((cand_x)<<(mvshift))-pred_x2]+mvbits[((cand_y)<<(mvshift))-pred_y2]))>>16)); if (mcost < min_mcost) { mcost += computeBiPred(cur_pic, blocksize_y, blocksize_x, min_mcost - mcost, (center1_x << 2) + 80, (center1_y << 2) + 80, (cand_x << 2) + 80, (cand_y << 2) + 80); if (mcost < min_mcost) { best_x = cand_x; best_y = cand_y; min_mcost = mcost; } } };
  }
...
# 1123 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
...
# 1156 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
...
# 1189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhexsmp.c"
