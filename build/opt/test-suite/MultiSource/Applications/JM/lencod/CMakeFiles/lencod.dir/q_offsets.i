# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c" 2
...
void no_mem_exit(char *where);
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c" 2
...
{
  int max_qp_per_luma = (3 + 6*(input->BitDepthLuma) - 0)/6 + 1;
  int max_qp_per_cr = (3 + 6*(input->BitDepthChroma) - 0)/6 + 1;
...
# 187 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
int CheckOffsetParameterName (char *s, int *type)
{
  int i = 0;

  *type = 0;
  while ((OffsetType4x4[i] != ((void*)0)) && (i < 15))
  {
  ...
  i = 0;
  *type = 1;
  while ((OffsetType8x8[i] != ((void*)0)) && (i < 5))
  {
...
# 223 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
void ParseQOffsetMatrix (char *buf, int bufsize)
{
  ...
  for (i = 0; i < item; i += cnt)
  {
    ...
    if (!type)
    {
      ...
      offset4x4_check[MapIdx] = 1;
    }
    else
    {
      range = 64;
      OffsetList = OffsetList8x8input[MapIdx];
      offset8x8_check[MapIdx] = 1;
    }
    ...
    for (j = 0; j < range; j++)
    {
      ...
      OffsetList[j] = (short) IntContent;
    }
    cnt += j;
    printf (".");
  }
}
# 350 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
...
# 391 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
void InitOffsetParam ()
{
  int k;
...
# 431 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
void CalculateOffsetParam ()
{
  ...
  int max_qp_per_luma = qp_per_matrix[(51 + img->bitdepth_luma_qp_scale - 0)] + 1;
  int max_qp_per_cr = qp_per_matrix[(51 + img->bitdepth_chroma_qp_scale - 0)] + 1;
...
# 508 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
