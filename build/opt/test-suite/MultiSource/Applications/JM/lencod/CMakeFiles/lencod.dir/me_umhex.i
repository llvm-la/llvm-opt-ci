# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
void no_mem_exit(char *where);
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.h"
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.h" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c" 2
...
# 108 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
void UMHEX_DefineThresholdMB()
{
  int gb_qp_per = (input->qpN-0)/6;
  int gb_qp_rem = (input->qpN-0)%6;
  ...
  float scale_factor = (float)((1-input->UMHexScale*0.1)+input->UMHexScale*0.1*(img->width/176));
...
{
  int memory_size = 0;
  if (((void*)0)==(flag_intra = calloc ((img->width>>4)+1,sizeof(byte)))) no_mem_exit("UMHEX_get_mem: flag_intra");
  ...
  {
    memory_size += get_mem3Dint(&(fastme_l0_cost_bipred), 9, img->height/4, img->width/4);
    memory_size += get_mem3Dint(&(fastme_l1_cost_bipred), 9, img->height/4, img->width/4);
  }
...
void UMHEX_free_mem()
{
  ...
  if(input->BiPredMotionEstimation == 1)
  {
    free_mem3Dint(fastme_l0_cost_bipred, 9);
    free_mem3Dint(fastme_l1_cost_bipred, 9);
  }
}
# 228 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
int
UMHEXIntegerPelBlockMotionSearch (
                                  imgpel *orig_pic,
                                  short ref,
                                  ...
                                  )
{
  ...
  int temp_Big_Hexagon_x[16];
  int temp_Big_Hexagon_y[16];
  ...
  int *SAD_prediction = fastme_best_cost[blocktype-1];
  ...
  cand_x = center_x ;
  cand_y = center_y ;
  mcost = ((((lambda_factor)*(mvbits[((cand_x)<<(mvshift))-pred_x]+mvbits[((cand_y)<<(mvshift))-pred_y]))>>16));

  mcost += computeUniPred[dist_method](orig_pic, blocksize_y,blocksize_x, min_mcost - mcost,
    (cand_x << 2) + 80, (cand_y << 2) + 80);
  ...
  for (m = 0; m < 4; m++)
  {
    ...
    if(iabs(cand_x - center_x) <=search_range && iabs(cand_y - center_y)<= search_range) { if(!McostState[cand_y-center_y+search_range][cand_x-center_x+search_range]) { mcost = ((((lambda_factor)*(mvbits[((cand_x)<<(mvshift))-pred_x]+mvbits[((cand_y)<<(mvshift))-pred_y]))>>16)); if(mcost<min_mcost) { mcost += computeUniPred[dist_method](orig_pic, blocksize_y,blocksize_x, min_mcost - mcost, (cand_x << 2) + 80, (cand_y << 2) + 80); McostState[cand_y-center_y+search_range][cand_x-center_x+search_range] = 1; if (mcost < min_mcost) { best_x = cand_x; best_y = cand_y; min_mcost = mcost; } } } }
  }
  ...
  if ((min_mcost-pred_SAD)<pred_SAD*betaFourth_2) goto fourth_2_step; else if((min_mcost-pred_SAD)<pred_SAD*betaFourth_1) goto fourth_1_step;
...
int
UMHEXSubPelBlockMotionSearch (imgpel* orig_pic,
                             short ref,
                             int list,
                             int pic_pix_x,
                             int pic_pix_y,
                             ...
                             int lambda_factor)
{
  ...
  short max_pos_x4 = ((ref_picture->size_x - blocksize_x + 2*20)<<2);
  short max_pos_y4 = ((ref_picture->size_y - blocksize_y + 2*20)<<2);
  ...
  if( !start_me_refinement_hp )
  {
    cand_mv_x = *mv_x;
    cand_mv_y = *mv_y;
    mcost = ((((lambda_factor)*(mvbits[((cand_mv_x)<<(mv_shift))-pred_mv_x]+mvbits[((cand_mv_y)<<(mv_shift))-pred_mv_y]))>>16));
...
# 742 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
...
# 912 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
int
UMHEXBipredIntegerPelBlockMotionSearch (imgpel* cur_pic,
                          short ref,
                          int list,
                          int pic_pix_x,
                          int pic_pix_y,
...

{
  ...
  int blocksize_y = input->blc_size[blocktype][1];
  int blocksize_x = input->blc_size[blocktype][0];
  int pred_x1 = (pic_pix_x << 2) + pred_mv_x1;
  int pred_y1 = (pic_pix_y << 2) + pred_mv_y1;
  int pred_x2 = (pic_pix_x << 2) + pred_mv_x2;
  int pred_y2 = (pic_pix_y << 2) + pred_mv_y2;
  short center2_x = pic_pix_x + *mv_x;
  short center2_y = pic_pix_y + *mv_y;
  short center1_x = pic_pix_x + *s_mv_x;
  short center1_y = pic_pix_y + *s_mv_y;
  short mb_x = pic_pix_x - img->opix_x;
  short mb_y = pic_pix_y - img->opix_y;
  short block_x = (mb_x >> 2);
  short block_y = (mb_y >> 2);
  ...
  if (apply_weights)
  {
    ...
    computeBiPred = computeBiPredSAD2;
  }
  else
  {
    ...
    offsetBi = 0;
    computeBiPred = computeBiPredSAD1;
  }
  ...
  cand_x = center2_x ;
  cand_y = center2_y ;
  mcost = ((((lambda_factor)*(mvbits[((center1_x)<<(mvshift))-pred_x1]+mvbits[((center1_y)<<(mvshift))-pred_y1]))>>16));
  mcost += ((((lambda_factor)*(mvbits[((cand_x)<<(mvshift))-pred_x2]+mvbits[((cand_y)<<(mvshift))-pred_y2]))>>16));
  ...
  for (m = 0; m < 4; m++)
  {
    cand_x = iXMinNow + Diamond_x[m];
    cand_y = iYMinNow + Diamond_y[m];
    if(iabs(cand_x - center2_x) <=search_range && iabs(cand_y - center2_y)<= search_range){ if(!McostState[cand_y-center2_y+search_range][cand_x-center2_x+search_range]) { mcost = ((((lambda_factor)*(mvbits[((center1_x)<<(mvshift))-pred_x1]+mvbits[((center1_y)<<(mvshift))-pred_y1]))>>16)); mcost += ((((lambda_factor)*(mvbits[((cand_x)<<(mvshift))-pred_x2]+mvbits[((cand_y)<<(mvshift))-pred_y2]))>>16)); if(mcost<min_mcost) { mcost += computeBiPred(cur_pic, blocksize_y, blocksize_x, min_mcost - mcost, (center1_x << 2) + 80, (center1_y << 2) + 80, (cand_x << 2) + 80, (cand_y << 2) + 80); McostState[cand_y-center2_y+search_range][cand_x-center2_x+search_range] = 1; if (mcost < min_mcost) { best_x = cand_x; best_y = cand_y; min_mcost = mcost; } } } };
  }
...
# 1112 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
    if(list==0)
    {
      if (img->field_picture)
      {
    ...
    pred_SAD =imin(imin(SAD_a,SAD_b),SAD_c);
    ET_Thred = Big_Hexagon_Thd_MB[blocktype];
