# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c" 2
...
void no_mem_exit(char *where);
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c" 2
...
# 121 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
int CheckParameterName (char *s, int *type)
{
  int i = 0;

  *type = 0;
  while ((MatrixType4x4[i] != ((void*)0)) && (i<6))
  {
  ...
  i = 0;
  *type = 1;
  while ((MatrixType8x8[i] != ((void*)0)) && (i<2))
  {
...
# 157 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
void ParseMatrix (char *buf, int bufsize)
{
  ...
  for (i=0; i<item; i+=cnt)
  {
    ...
    {
      snprintf (errortext, 300, " Parsing error in config file: Parameter Name '%s' not recognized.", items[i+cnt]);
      error (errortext, 300);
    }
    cnt++;
    if (strcmp ("=", items[i+cnt]))
    {
      snprintf (errortext, 300, " Parsing error in config file: '=' expected as the second token in each item.");
      error (errortext, 300);
    }
    cnt++;
    ...
    if (!type)
    {
      ...
      matrix4x4_check[MapIdx] = 1;
    }
    else
    {
      range = 64;
      ScalingList = ScalingList8x8input[MapIdx];
      matrix8x8_check[MapIdx] = 1;
    }
    ...
    for(j=0; j<range; j++)
    {
      ...
      {
        snprintf (errortext, 300, " Parsing error: Expected numerical value for Parameter of %s, found '%s'.", items[i], items[i+cnt+j]);
        error (errortext, 300);
      }

      ScalingList[j] = (short)IntContent;
    }
    cnt+=j;
    printf (".");
  }
}
# 279 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
  ...
  for(i=0; i<6; i++)
  {
    if(input->ScalingListPresentFlag[i])
    {
      ...
      if(matrix4x4_check[i])
      {
        ...
        {
          if(ScalingList[cnt]<0 || ScalingList[cnt]>255)
          {
            fail=1;
            break;
          }
...
void allocate_QMatrix ()
{
  ...
  if ((qp_per_matrix = (int*)malloc((51 + 1 + bitdepth_qp_scale)*sizeof(int))) == ((void*)0))
    no_mem_exit("init_global_buffers: qp_per_matrix");
  if ((qp_rem_matrix = (int*)malloc((51 + 1 + bitdepth_qp_scale)*sizeof(int))) == ((void*)0))
    no_mem_exit("init_global_buffers: qp_per_matrix");

  for (i = 0; i < 51 + bitdepth_qp_scale + 1; i++)
  {
    qp_per_matrix[i] = i / 6;
    qp_rem_matrix[i] = i % 6;
  }
...
# 416 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
void Init_QMatrix (void)
{
  char *content;
...
# 454 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
void CalculateQuantParam(void)
{
  int i, j, k, temp;
  int present[6];
  ...
  if(!active_sps->seq_scaling_matrix_present_flag && !active_pps->pic_scaling_matrix_present_flag)
    no_q_matrix=TRUE;
  else
  {
...
# 589 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
