# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c"
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
extern byte *MBAmap;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
smpUMHEXBipredIntegerPelBlockMotionSearch (imgpel* cur_pic,
                                           ...
                                           int min_mcost,
                                           int lambda_factor);
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/JM/lencod/md_highfast.c" 2
...
void encode_one_macroblock_highfast ()
{
  ...
  double min_rate = 0, RDCost16 = 1.7976931348623157e+308;
...

    {
      ...
      if (!inter_skip)
      {
        ...
        if (img->yuv_format != YUV400 && max_index != 5)
        {
          ...
          {
            min_chroma_pred_mode = 0;
            max_chroma_pred_mode = 3;
          }
        }
        else
        {
          min_chroma_pred_mode = 0;
          max_chroma_pred_mode = 0;
        }
        ...
        for (currMB->c_ipred_mode=min_chroma_pred_mode; currMB->c_ipred_mode<=max_chroma_pred_mode; currMB->c_ipred_mode++)
        {
          ...
          if ( (img->yuv_format != YUV400) &&
            ( ((!intra || !input->IntraDisableInterOnly) && input->ChromaIntraDisable == 1 && currMB->c_ipred_mode!=0)
            || (currMB->c_ipred_mode == 2 && !mb_available_up)
            || (currMB->c_ipred_mode == 1 && !mb_available_left)
            || (currMB->c_ipred_mode == 3 && (!mb_available_left || !mb_available_up || !mb_available_up_left))))
            continue;
          ...
          for (ctr16x16=0, index=0; index < max_index; index++)
          {
            ...
            if (input->SkipIntraInInterSlices && !intra && mode >= 10
              && best_mode <=3 && currMB->cbp == 0)
              continue;

            if (bslice && active_pps->weighted_bipred_idc == 1 && mode < 8)
            {
        ...
        if(img->type!=I_SLICE && input->SelectiveIntraEnable && input->ProfileIDC < 100)
        {
  ...
  if (((cbp!=0 || best_mode==10) && (best_mode!=14) ))
    currMB->prev_cbp = 1;
  else if ((cbp==0 && !input->RCEnable) || (best_mode==14))
  {
    currMB->delta_qp = 0;
