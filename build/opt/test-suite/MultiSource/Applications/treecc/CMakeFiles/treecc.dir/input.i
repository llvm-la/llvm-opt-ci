# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/input.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/input.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/input.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/input.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/input.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/input.c" 2
...
# 71 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/input.c"
...
static void LiteralCode(TreeCCInput *input)
{
 ...
 for(;;)
 {
  ...
  else if(ch == '"' || ch == '\'')
  {
   ...
   while((ch = getc(input->stream)) != (-1) && ch != quotech)
   {
    if(ch == '\\')
    {
     input->buffer[len++] = (char)ch;
 ...
 for(;;)
 {
  ...
  else if(ch == '%')
  {
   ...
   else if((((ch) >= 'A' && (ch) <= 'Z') || ((ch) >= 'a' && (ch) <= 'z') || (ch) == '_'))
   {
    ...
    low = 0;
    high = (sizeof(KeywordTable) / sizeof(KeywordTable[0])) - 1;
    while(low <= high)
    {
     middle = ((low + high) / 2);
