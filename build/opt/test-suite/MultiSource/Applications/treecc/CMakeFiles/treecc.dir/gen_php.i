# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c" 2
...
void TreeCCIncludeSkeleton(TreeCCContext *context, TreeCCStream *stream,
         const char *skeleton);
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c" 2
         ...
         TreeCCNode *node, TreeCCNode *actualNode)
{
 ...
 while(virt != 0)
 {
  ...
  if(declareCase)
  {
   ...
   {
# 211 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
    TreeCCStreamPrint(stream, "    function %s(", virt->name);
   ...
   if(!abstractCase)
   {
    ...
    {
# 274 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
...
# 712 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
 if(context->reentrant)
 {
 ...
 while(stream != 0)
 {
  if(!(stream->isHeader))
  {
   TreeCCStreamPrint(stream,
     ...
     stream->embedName);
# 751 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
          ...
          TreeCCOperation *oper, int number)
{
 ...
 int num;
 int needComma;
# 843 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
 if(number != -1)
 {
...
# 871 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
  if(param->name)
  {
           ...
           TreeCCOperationCase *operCase, int number)
{
 ...
 while(param != 0)
 {
  ...
  if((param->flags & 1) != 0)
  {
      if((trigger->node->flags & 8) == 0 &&
         (trigger->node->flags & 16) == 0)
   {
...
# 1109 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
  if(param->name)
  {
   TreeCCStreamPrint(stream, "$%s", param->name);
  }
...
# 1230 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
  if(param->name)
  {
   TreeCCStreamPrint(stream, "$%s", param->name);
  }
...
# 1342 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/treecc/gen_php.c"
void TreeCCGeneratePHP(TreeCCContext *context)
{
