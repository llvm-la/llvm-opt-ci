...
# %bb.58:                               # %middle.block319
	...
	beq	$a4, $a5, .LBB13_61
.LBB13_59:                              # %scalar.ph307.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a3, $s3, $a3
	.p2align	4, , 16
.LBB13_60:                              # %scalar.ph307
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
.LBB13_74:                              # %vector.body301
	...
	addi.d	$a1, $a1, 32
	bnez	$a5, .LBB13_74
# %bb.75:                               # %middle.block304
	beq	$a3, $a4, .LBB13_78
.LBB13_76:                              # %scalar.ph296.preheader
	sub.d	$a1, $s3, $a2
	alsl.d	$a2, $a2, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_77:                              # %scalar.ph296
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
...
.LBB13_96:                              # %vector.body327
	...
	addi.d	$a1, $a1, 32
	bnez	$a5, .LBB13_96
# %bb.97:                               # %middle.block331
	beq	$a3, $a4, .LBB13_100
.LBB13_98:                              # %scalar.ph322.preheader
	sub.d	$a1, $s3, $a2
	alsl.d	$a2, $a2, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_99:                              # %scalar.ph322
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
