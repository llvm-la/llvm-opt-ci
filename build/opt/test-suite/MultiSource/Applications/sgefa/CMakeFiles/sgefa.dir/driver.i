# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c" 2
...
extern int sgesl();
extern int vexopy();
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c" 2
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c"
int matgen();
int matvec();
int get_space();
void exit();
...
main()
{
  ...
  while( !matgen( &a, &x, &b, &bt, &ipvt, ++test_case, 40 ) ) {


      if( a.rd > 1000 || a.cd > 1000 ) {
...
# 113 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c"
{
  register int i, j;
  int n;
  float *col, tl, tu;
 ...
 *col = ( i<j ? 0.0 : (float)(i-j+1) );
  ...
  case 13:
    ...
    for( j=0; j<n; j++ )
      for( i=0, col=a->pd[j]; i<n; i++, col++ ) {
 tu = (float)(j+1)/(float)( i>j ? i+1 : j+1 );
 *col = 1.0e38*tu/tl;
      }
    break;
  ...
  case 14:
    ...
    printf("Near Underflow.  Test case %d of size %d. SMALL = %e\n", test_case, n, 1.0/1.0e38 );
    tl = (float)(n*n);
    for( j=0; j<n; j++ )
      for( i=0, col=a->pd[j]; i<n; i++, col++ ) {
 tu = (float)( i>j ? i+1 : j+1 )/(float)(j+1);
 *col = tu*tl/1.0e38;
      }
    break;
...

{
  ...
  *ipvt = (int *)malloc( a->cd*sizeof( int ) );
  if( *x == ((void*)0) || *b == ((void*)0) || *bt == ((void*)0) || *ipvt == ((void*)0)) {
...
float *x, *b;
int job;
# 364 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/sgefa/driver.c"
{
  register int i, j;
  float *px, *pb, *col, *row;
