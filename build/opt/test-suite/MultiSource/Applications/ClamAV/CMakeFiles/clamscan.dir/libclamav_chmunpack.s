...
# %bb.108:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_109:                              # %.sink.split.i70
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
.LBB0_110:                              # %.sink.split.i70
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
.LBB0_111:                              # %.sink.split.i70
	ld.d	$s5, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s6, $sp, 136                   # 8-byte Folded Reload
	b	.LBB0_118
.LBB0_112:                              # %._crit_edge.thread.i
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	beqz	$s5, .LBB0_114
...
# %bb.126:                              #   in Loop: Header=BB0_125 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB0_124
.LBB0_127:                              # %free_file_list.exit77
	beqz	$s2, .LBB0_129
# %bb.128:
	move	$a0, $s2
	move	$a1, $s1
...
.LBB0_151:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_109
.LBB0_152:                              # %.thread.thread.i
	pcalau12i	$a0, %pc_hi20(.L.str.45)
	addi.d	$a0, $a0, %pc_lo12(.L.str.45)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_111
.LBB0_153:                              # %.thread.thread186.i
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	b	.LBB0_110
.Lfunc_end0:
