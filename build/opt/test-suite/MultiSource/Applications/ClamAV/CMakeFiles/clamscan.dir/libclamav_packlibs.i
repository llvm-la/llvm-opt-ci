# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c" 2
...
int cli_unfsg(char *source, char *dest, int ssize, int dsize, char **endsrc, char **enddst) {
 ...
 lostbit = 0;
      ...
      if (!(dsize > 0 && backsize > 0 && backsize <= dsize && cdst >= dest && cdst + backsize <= dest + dsize && cdst + backsize > dest) || !(dsize > 0 && backsize > 0 && backsize <= dsize && cdst-backbytes >= dest && cdst-backbytes + backsize <= dest + dsize && cdst-backbytes + backsize > dest))
 return -1;
      while(backsize--) {
 *cdst=*(cdst-backbytes);
 cdst++;
...
int unmew(char *source, char *dest, int ssize, int dsize, char **endsrc, char **enddst) {
 ...
 lostbit = 0;
      ...
      if (!(dsize > 0 && myecx_backsize > 0 && myecx_backsize <= dsize && cdst >= dest && cdst + myecx_backsize <= dest + dsize && cdst + myecx_backsize > dest) || !(dsize > 0 && myecx_backsize > 0 && myecx_backsize <= dsize && cdst-myeax_backbytes >= dest && cdst-myeax_backbytes + myecx_backsize <= dest + dsize && cdst-myeax_backbytes + myecx_backsize > dest))
      {
 cli_dbgmsg("MEW: rete: %d %d %d %d %d || %d %d %d %d %d\n", dest, dsize, cdst, myecx_backsize,
   (dsize > 0 && myecx_backsize > 0 && myecx_backsize <= dsize && cdst >= dest && cdst + myecx_backsize <= dest + dsize && cdst + myecx_backsize > dest),
   dest, dsize, cdst-myeax_backbytes, myecx_backsize,
         (dsize > 0 && myecx_backsize > 0 && myecx_backsize <= dsize && cdst-myeax_backbytes >= dest && cdst-myeax_backbytes + myecx_backsize <= dest + dsize && cdst-myeax_backbytes + myecx_backsize > dest) );
 return -1;
      }
