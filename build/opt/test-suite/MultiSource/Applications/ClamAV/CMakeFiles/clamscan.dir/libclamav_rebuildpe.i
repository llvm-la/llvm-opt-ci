# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c" 2
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c"
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/rebuildpe.h"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/rebuildpe.h" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/execs.h"
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/execs.h" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c" 2
...
# 119 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rebuildpe.c"
...
{
  uint32_t datasize=0, rawbase=(((0x200))?(((0x148+0x80+0x28*sects)/(0x200)+((0x148+0x80+0x28*sects)%(0x200)!=0))*(0x200)):(0x148+0x80+0x28*sects));
  char *pefile=((void*)0), *curpe;
  struct IMAGE_PE_HEADER *fakepe;
  int i, gotghost=(sections[0].rva > (((0x1000))?(((rawbase)/(0x1000)+((rawbase)%(0x1000)!=0))*(0x1000)):(rawbase)));

  if (gotghost) rawbase=(((0x200))?(((0x148+0x80+0x28*(sects+1))/(0x200)+((0x148+0x80+0x28*(sects+1))%(0x200)!=0))*(0x200)):(0x148+0x80+0x28*(sects+1)));

  if(sects+gotghost > 96)
    return 0;

  for (i=0; i < sects; i++)
    datasize+=(((0x200))?(((sections[i].rsz)/(0x200)+((sections[i].rsz)%(0x200)!=0))*(0x200)):(sections[i].rsz));

  if(datasize > 184549376)
    return 0;

  if((pefile = (char *) cli_calloc(rawbase+datasize, 1))) {
    memcpy(pefile, "", 0x148);

    datasize = (((0x1000))?(((rawbase)/(0x1000)+((rawbase)%(0x1000)!=0))*(0x1000)):(rawbase));

    fakepe = (struct IMAGE_PE_HEADER *)(pefile+0xd0);
    fakepe->NumberOfSections = (sects+gotghost);
    fakepe->AddressOfEntryPoint = (ep);
    fakepe->ImageBase = (base);
    fakepe->SizeOfHeaders = (rawbase);
    ...
    if (gotghost) {
      ...
      cli_writeint32(curpe+8, sections[0].rva-datasize);
      cli_writeint32(curpe+12, datasize);
      cli_writeint32(curpe+0x24, 0xffffffff);
      curpe+=40;
      datasize+=(((0x1000))?(((sections[0].rva-datasize)/(0x1000)+((sections[0].rva-datasize)%(0x1000)!=0))*(0x1000)):(sections[0].rva-datasize));
    }
    ...
    for (i=0; i < sects; i++) {
      ...
      rawbase+=(((0x200))?(((sections[i].rsz)/(0x200)+((sections[i].rsz)%(0x200)!=0))*(0x200)):(sections[i].rsz));
      curpe+=40;
      datasize+=(((0x1000))?(((sections[i].vsz)/(0x1000)+((sections[i].vsz)%(0x1000)!=0))*(0x1000)):(sections[i].vsz));
    }
    fakepe->SizeOfImage = (datasize);
  } else {
    return 0;
  }
