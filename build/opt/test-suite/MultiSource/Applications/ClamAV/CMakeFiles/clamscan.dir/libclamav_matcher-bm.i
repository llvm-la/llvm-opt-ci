# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c" 2
...
int cli_bm_addpatt(struct cli_matcher *root, struct cli_bm_patt *pattern)
{
 ...
 struct cli_bm_patt *prev, *next = ((void*)0);
 ...
 return -117;
    ...
    for(i = 0; i < pattern->length - 3 + 1; i++) {
 idx = (211 * pt[i] + 37 * pt[i + 1] + pt[i + 2]);
 if(!root->bm_suffix[idx]) {
  ...
  pt = pattern->pattern;
    ...
    for(i = 0; i <= 3 - 3; i++) {
 idx = (211 * pt[i] + 37 * pt[i + 1] + pt[i + 2]);
 root->bm_shift[idx] = (((root->bm_shift[idx])<(3 - 3 - i))?(root->bm_shift[idx]):(3 - 3 - i));
    }
...
int cli_bm_init(struct cli_matcher *root)
{
 uint16_t i, size = (211 * 255 + 37 * 255 + 255) + 1;
...
int cli_bm_scanbuff(const unsigned char *buffer, uint32_t length, const char **virname, const struct cli_matcher *root, uint32_t offset, cli_file_t ftype, int fd)
{
 ...
 return 0;
    ...
    for(i = 3 - 3; i < length - 3 + 1; ) {
 idx = (211 * buffer[i] + 37 * buffer[i + 1] + buffer[i + 2]);
 ...
 if(shift == 0) {
  ...
  idxchk = (((p->length)<(length - off))?(p->length):(length - off)) - 1;
  if(idxchk) {
  ...
  if(found && p->length + p->prefix_length == j) {
   ...
   off = offset + i - p->prefix_length - 3 + 3;
