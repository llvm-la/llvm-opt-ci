# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
unsigned char *wm_decrypt_macro(int fd, uint32_t offset, uint32_t len,
     unsigned char key);
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c" 2
...
static const struct rtf_state base_state = {
 0,0,0,PARSE_MAIN,0,0,"                              ",((void*)0),((void*)0),((void*)0),((void*)0)
};
...
static const unsigned char rtf_data_magic[] = {0x01, 0x05, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00};
...
static int rtf_object_process(struct rtf_state* state, const unsigned char* input,const size_t len)
{
 ...
 if(data->has_partial) {
  for(i=0;i<len && !((*__ctype_b_loc ())[(int) ((input[i]))] & (unsigned short int) _ISxdigit);i++)
   ;
  if(i<len) {
 ...
 for(;i<len;i++) {
  if(((*__ctype_b_loc ())[(int) ((input[i]))] & (unsigned short int) _ISxdigit)) {
    const unsigned char byte = hextable[ input[i++] ] << 4;
    while(i<len && !((*__ctype_b_loc ())[(int) ((input[i]))] & (unsigned short int) _ISxdigit))
     i++;
    if(i == len) {
     data->partial = byte;
     data->has_partial = 1;
...
{
 while(stack && stack->stack_cnt ) {
  pop_state(stack,state);
  if(state->cb_data && state->cb_end)
   state->cb_end(state,ctx);
 }
}
# 501 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_rtf.c"
int cli_scanrtf(int desc, cli_ctx *ctx)
{
 char* tempname;
 ...
 while(( bread = cli_readn(desc, buff, 8192) ) > 0) {
  ptr = buff;
  ptr_end = buff + bread;
  while(ptr < ptr_end) {
   switch(state.parse_state) {
    case PARSE_MAIN:
     switch(*ptr++) {
      case '{':
       if(( ret = push_state(&stack,&state) )) {
        ...
        if(state.cb_data && state.cb_end) state.cb_end(&state,ctx); tableDestroy(actiontable); cleanup_stack(&stack,&state,ctx); free(buff); if(!cli_leavetemps_flag) cli_rmdirs(tempname); free(tempname); free(stack.states);;
        return ret;
       }
       break;
      case '}':
     ...
     break;
    case PARSE_CONTROL_:
     if(((*__ctype_b_loc ())[(int) ((*ptr))] & (unsigned short int) _ISalpha)) {
    ...
    case PARSE_CONTROL_WORD:
     if(state.controlword_cnt == 32) {
     ...
     else if(((*__ctype_b_loc ())[(int) ((*ptr))] & (unsigned short int) _ISalpha))
      ...
      else if (((*__ctype_b_loc ())[(int) ((*ptr))] & (unsigned short int) _ISdigit)) {
    ...
    case PARSE_CONTROL_WORD_PARAM:
     if(((*__ctype_b_loc ())[(int) ((*ptr))] & (unsigned short int) _ISdigit)) {
