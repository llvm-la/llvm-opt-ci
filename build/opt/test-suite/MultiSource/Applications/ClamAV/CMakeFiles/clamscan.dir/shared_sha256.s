...
.LBB4_3:                                # =>This Inner Loop Header: Depth=1
	...
	rotri.w	$s4, $a3, 19
	xor	$t8, $t8, $s4
	bstrpick.d	$s4, $a3, 31, 10
	xor	$t8, $t8, $s4
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	rotri.w	$s4, $a2, 7
	rotri.w	$s8, $a2, 18
	xor	$s4, $s4, $s8
	bstrpick.d	$s8, $a2, 31, 3
	xor	$s4, $s4, $s8
	st.w	$a6, $a5, 40
	ld.w	$s8, $t6, 44
	add.d	$t0, $s4, $t2
	...
	rotri.w	$s6, $a6, 19
	xor	$t8, $t8, $s6
	bstrpick.d	$s6, $a6, 31, 10
	xor	$t8, $t8, $s6
	ld.d	$a7, $sp, 112                   # 8-byte Folded Reload
	rotri.w	$s6, $a7, 7
	rotri.w	$s8, $a7, 18
	xor	$s6, $s6, $s8
	bstrpick.d	$s8, $a7, 31, 3
	xor	$s6, $s6, $s8
	st.w	$t0, $a5, 44
	ld.w	$s8, $t6, 48
	add.d	$t2, $s6, $a2
	...
	rotri.w	$t8, $ra, 18
	xor	$t1, $t1, $t8
	bstrpick.d	$t8, $ra, 31, 3
	bstrpick.d	$t8, $t8, 60, 0
	xor	$t1, $t1, $t8
	st.w	$t2, $a5, 48
	ld.w	$t8, $t6, 52
	add.d	$t1, $a7, $t1
