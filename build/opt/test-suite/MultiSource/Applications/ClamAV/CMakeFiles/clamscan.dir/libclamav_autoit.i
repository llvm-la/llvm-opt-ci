# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c"
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c" 2
...
static int ea05(int desc, cli_ctx *ctx, char *tmpd) {
 ...
 continue;
      ...
      if(!(UNP.usize = ((*(uint32_t *)(buf+4) >> 24) | ((*(uint32_t *)(buf+4) & 0x00FF0000) >> 8) | ((*(uint32_t *)(buf+4) & 0x0000FF00) << 8) | (*(uint32_t *)(buf+4) << 24))))
 UNP.usize = UNP.csize;
 ...
 if (getbits(&UNP, 1)) {
  ...
  if((bs = getbits(&UNP, 8))==255) {
   ...
   if(!(UNP.usize > 0 && bs > 0 && bs <= UNP.usize && &UNP.outputbuf[UNP.cur_output] >= UNP.outputbuf && &UNP.outputbuf[UNP.cur_output] + bs <= UNP.outputbuf + UNP.usize && &UNP.outputbuf[UNP.cur_output] + bs > UNP.outputbuf) ||
      !(UNP.usize > 0 && bs > 0 && bs <= UNP.usize && &UNP.outputbuf[UNP.cur_output-bb] >= UNP.outputbuf && &UNP.outputbuf[UNP.cur_output-bb] + bs <= UNP.outputbuf + UNP.usize && &UNP.outputbuf[UNP.cur_output-bb] + bs > UNP.outputbuf)) {
     UNP.error = 1;
     break;
   }
   while(bs--) {
 ...
 cli_dbgmsg("autoit: decompression error - partial file may exist\n");
    ...
    tempfile[1023]='\0';
    if((i = open(tempfile, 02|0100|01000|0, (0400|0200|0100))) < 0) {
...
# 397 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c"
struct LAME {
  uint32_t c0;
  uint32_t c1;
  uint32_t grp1[17];
...
static double LAME_fpusht(struct LAME *l) {
  ...
  uint32_t rolled = (( l->grp1[l->c0] << (9 % (sizeof(l->grp1[l->c0])<<3) )) | (l->grp1[l->c0] >> ( (sizeof(l->grp1[l->c0])<<3) - (9 % (sizeof(l->grp1[l->c0])<<3 )) ) )) + (( l->grp1[l->c1] << (13 % (sizeof(l->grp1[l->c1])<<3) )) | (l->grp1[l->c1] >> ( (sizeof(l->grp1[l->c1])<<3) - (13 % (sizeof(l->grp1[l->c1])<<3 )) ) ));
...
static int ea06(int desc, cli_ctx *ctx, char *tmpd) {
 ...
 return 0;
    ...
    LAME_decrypt(buf,UNP.csize,0x2477 );
...
# 743 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_autoit.c"
