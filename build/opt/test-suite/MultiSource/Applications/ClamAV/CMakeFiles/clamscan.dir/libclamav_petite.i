# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c"
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
...
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/rebuildpe.h"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/rebuildpe.h" 2

int cli_rebuildpe(char *, struct cli_exe_section *, int, uint32_t, uint32_t, uint32_t, uint32_t, int);
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/petite.h" 1
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/petite.h"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/petite.h" 2
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c" 2
...
int petite_inflate2x_1to9(char *buf, uint32_t minrva, uint32_t bufsz, struct cli_exe_section *sections, unsigned int sectcount, uint32_t Imagebase, uint32_t pep, int desc, int version, uint32_t ResRva, uint32_t ResSize)
{
  ...
  struct cli_exe_section *usects = ((void*)0);
  void *tmpsct = ((void*)0);
# 97 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c"
  if ( version == 2 )
  ...
  while (1) {
    ...
    if ( ! (bufsz > 0 && 4 > 0 && 4 <= bufsz && packed >= buf && packed + 4 <= buf + bufsz && packed + 4 > buf)) {
      if (usects)
 free(usects);
      return 1;
    }
...
# 158 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_petite.c"
      if (enc_ep) {
 ...
 if ( version == 2 ) {
   ...
   while ( dummy && (bufsz > 0 && 4 > 0 && 4 <= bufsz && thunk >= buf && thunk + 4 <= buf + bufsz && thunk + 4 > buf) ) {
     uint32_t api;
     ...
     while ( (bufsz > 0 && 4 > 0 && 4 <= bufsz && imports >= buf && imports + 4 <= buf + bufsz && imports + 4 > buf)) {
       dummy = 0;
 ...
 if (usects[t].rsz != 0 && (bufsz > 0 && usects[t].rsz > 0 && usects[t].rsz <= bufsz && buf + usects[t].raw >= buf && buf + usects[t].raw + usects[t].rsz <= buf + bufsz && buf + usects[t].raw + usects[t].rsz > buf))
 ...
 return 1;
    ...
    if ( srva != size ) {
      ...
      if ( ! (bufsz > 0 && 8 > 0 && 8 <= bufsz && packed+4 >= buf && packed+4 + 8 <= buf + bufsz && packed+4 + 8 > buf) ) {
 if (usects)
   free(usects);
 return 1;
      }
      ...
      if ( !(bufsz > 0 && size*4 > 0 && size*4 <= bufsz && ssrc >= buf && ssrc + size*4 <= buf + bufsz && ssrc + size*4 > buf) || !(bufsz > 0 && size*4 > 0 && size*4 <= bufsz && ddst >= buf && ddst + size*4 <= buf + bufsz && ddst + size*4 > buf) ) {
 if (usects)
   free(usects);
 return 1;
      }
 ...
 goback = 8;
      ...
      if ( !(bufsz > 0 && 1 > 0 && 1 <= bufsz && ssrc >= buf && ssrc + 1 <= buf + bufsz && ssrc + 1 > buf) || !(bufsz > 0 && 1 > 0 && 1 <= bufsz && ddst >= buf && ddst + 1 <= buf + bufsz && ddst + 1 > buf)) {
 free(usects);
 return 1;
      }
 ...
 if (!oob) {
  ...
  break;
   ...
   backsize+=addsize;
   size-=backsize;
   if(!(bufsz > 0 && backsize > 0 && backsize <= bufsz && ddst >= buf && ddst + backsize <= buf + bufsz && ddst + backsize > buf) || !(bufsz > 0 && backsize > 0 && backsize <= bufsz && ddst+backbytes >= buf && ddst+backbytes + backsize <= buf + bufsz && ddst+backbytes + backsize > buf)) {
     free(usects);
     return 1;
   }
   while(backsize--) {
 ...
 if ( usects[j-1].rsz > grown &&
      (bufsz > 0 && 8 > 0 && 8 <= bufsz && ddst-grown+5+0x4f >= buf && ddst-grown+5+0x4f + 8 <= buf + bufsz && ddst-grown+5+0x4f + 8 > buf) &&
 ...
 if ( !strippetite &&
      ...
      (bufsz > 0 && 8 > 0 && 8 <= bufsz && ddst-grown+5+0x4f-skew >= buf && ddst-grown+5+0x4f-skew + 8 <= buf + bufsz && ddst-grown+5+0x4f-skew + 8 > buf) &&
 ...
 if (strippetite && (bufsz > 0 && 8 > 0 && 8 <= bufsz && ddst-grown+0x0f-8-reloc >= buf && ddst-grown+0x0f-8-reloc + 8 <= buf + bufsz && ddst-grown+0x0f-8-reloc + 8 > buf)) {
   ...
   if (test1 == test2 && (bufsz > 0 && 0x1c0-0x0f+4 > 0 && 0x1c0-0x0f+4 <= bufsz && ddst-grown+0x0f-reloc >= buf && ddst-grown+0x0f-reloc + 0x1c0-0x0f+4 <= buf + bufsz && ddst-grown+0x0f-reloc + 0x1c0-0x0f+4 > buf)) {
