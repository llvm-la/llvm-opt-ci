# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c"
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/aspack.h" 1
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/aspack.h"
int unaspack212(uint8_t *, unsigned int, struct cli_exe_section *, uint16_t, uint32_t, uint32_t, int);
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_aspack.c" 2
...
static uint8_t build_decrypt_array(struct ASPK *stream, uint8_t* array, uint8_t which) {
  ...
  while (counter >= 9) {
    ...
    if (counter >= 0x10) {
      ...
      endoff = d3[i+1] >> 0x10;
      if (endoff-old) {
 if (!(0x100 > 0 && endoff-old > 0 && endoff-old <= 0x100 && stream->dict_helper[which].ends+old >= stream->dict_helper[which].ends && stream->dict_helper[which].ends+old + endoff-old <= stream->dict_helper[which].ends + 0x100 && stream->dict_helper[which].ends+old + endoff-old > stream->dict_helper[which].ends)) return 0;
...
static int build_decrypt_dictionaries(struct ASPK *stream) {
 ...
 while (ret) {
  ...
  if (!build_decrypt_array(stream, &stream->array2[1], 0) || !build_decrypt_array(stream, &stream->array2[722], 1) || !build_decrypt_array(stream, &stream->array2[750], 2) ) return 0;
...
static int decrypt(struct ASPK *stream, uint8_t *stuff, uint32_t size, uint8_t *output) {
  ...
  while (counter < size) {
    ...
    if ((backbytes = (gen - 256) >> 3)>=58) return 0;
...
int unaspack212(uint8_t *image, unsigned int size, struct cli_exe_section *sections, uint16_t sectcount, uint32_t ep, uint32_t base, int f) {
  ...
  stream.dict_helper[0].starts = (uint32_t *)wrkbuf; stream.dict_helper[0].ends = &wrkbuf[721 * sizeof(uint32_t)]; stream.dict_helper[0].size = 721; wrkbuf = &wrkbuf[721 * sizeof(uint32_t) + 0x100];;
  stream.dict_helper[1].starts = (uint32_t *)wrkbuf; stream.dict_helper[1].ends = &wrkbuf[28 * sizeof(uint32_t)]; stream.dict_helper[1].size = 28; wrkbuf = &wrkbuf[28 * sizeof(uint32_t) + 0x100];;
  stream.dict_helper[2].starts = (uint32_t *)wrkbuf; stream.dict_helper[2].ends = &wrkbuf[8 * sizeof(uint32_t)]; stream.dict_helper[2].size = 8; wrkbuf = &wrkbuf[8 * sizeof(uint32_t) + 0x100];;
  stream.dict_helper[3].starts = (uint32_t *)wrkbuf; stream.dict_helper[3].ends = &wrkbuf[19 * sizeof(uint32_t)]; stream.dict_helper[3].size = 19; wrkbuf = &wrkbuf[19 * sizeof(uint32_t) + 0x100];;
  ...
  i=0;
  while ((size > 0 && 8 > 0 && 8 <= size && blocks >= image && blocks + 8 <= image + size && blocks + 8 > image) && (block_rva = cli_readint32(blocks)) && (block_size = cli_readint32(blocks+4)) && (size > 0 && block_size > 0 && block_size <= size && image+block_rva >= image && image+block_rva + block_size <= image + size && image+block_rva + block_size > image)) {
 ...
 if (curbyte == 0xe8 || curbyte == 0xe9) {
   ...
   if (*wrkbuf == image[ep+0x148]) {
     ...
     target = ( target << (0x18 % (sizeof(target)<<3) )) | (target >> ( (sizeof(target)<<3) - (0x18 % (sizeof(target)<<3 )) ) );
