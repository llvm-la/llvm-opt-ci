# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c" 2
# 104 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c"
...
# 148 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_unarj.c"
typedef struct arj_decode_tag {
 ...
 uint16_t left[2 * ((127*2 +1) + 256 + 2 - 3) - 1];
 uint16_t right[2 * ((127*2 +1) + 256 + 2 - 3) - 1];
 unsigned char c_len[((127*2 +1) + 256 + 2 - 3)];
 uint16_t c_table[4096];
 unsigned char pt_len[(16 + 3)];
...
static int init_getbits(arj_decode_t *decode_data)
{
 ...
 return fill_buf(decode_data, 2 * 8);
}
...
static void read_pt_len(arj_decode_t *decode_data, int nn, int nbit, int i_special)
{
 ...
 if (n == 0) {
  ...
  make_table(decode_data, nn, decode_data->pt_len, 8, decode_data->pt_table, 256);
 }
}
...
static int read_c_len(arj_decode_t *decode_data)
{
 ...
 n = arj_getbits(decode_data, 9);
 if (n == 0) {
  c = arj_getbits(decode_data, 9);
  for (i = 0; i < ((127*2 +1) + 256 + 2 - 3); i++) {
  ...
  while (i < n) {
   ...
   if (c <= 2) {
    if (c == 0) {
     ...
     c = arj_getbits(decode_data, 9) + 20;
    }
    while (--c >= 0) {
     if (i >= ((127*2 +1) + 256 + 2 - 3)) {
      cli_warnmsg("ERROR: bounds exceeded\n");
      return -124;
     }
     decode_data->c_len[i++] = 0;
  ...
  while (i < ((127*2 +1) + 256 + 2 - 3)) {
   decode_data->c_len[i++] = 0;
  }
  make_table(decode_data, ((127*2 +1) + 256 + 2 - 3), decode_data->c_len, 12, decode_data->c_table, 4096);
 }
 return 0;
}
...
static uint16_t decode_c(arj_decode_t *decode_data)
{
 ...
 if (decode_data->blocksize == 0) {
  ...
  read_pt_len(decode_data, (16 + 3), 5, 3);
  read_c_len(decode_data);
  read_pt_len(decode_data, (16 + 3), 5, -1);
 }
...
static int decode(int fd, arj_metadata_t *metadata)
{
 ...
 decode_data.text = (unsigned char *) cli_malloc(26624);
 if (!decode_data.text) {
  return -114;
 }
 decode_data.fd = fd;
 ...
 while (count < metadata->orig_size) {
  if ((chr = decode_c(&decode_data)) <= (127*2 +1)) {
   decode_data.text[out_ptr] = (unsigned char) chr;
   count++;
   if (++out_ptr >= 26624) {
    out_ptr = 0;
    write_text(metadata->ofd, decode_data.text, 26624);
   }
  } else {
   j = chr - ((127*2 +1) + 1 - 3);
   count += j;
   ...
   if (out_ptr > i && out_ptr < 26624 - 256 - 1) {
    while ((--j >= 0) && (i < 26624) && (out_ptr < 26624)) {
...
static uint16_t decode_ptr(arj_decode_t *decode_data)
{
 ...
 for (width = 9; width < 13; width++) {
  {if(decode_data->getlen<=0){decode_data->getbuf|=decode_data->bit_buf>>decode_data->getlen;fill_buf(decode_data,16 -decode_data->getlen);decode_data->getlen=16;} c=(decode_data->getbuf&0x8000)!=0;decode_data->getbuf<<=1;decode_data->getlen--;};
  if (c == 0) {
   break;
  }
  plus += pwr;
 ...
 if (width != 0) {
  {if(decode_data->getlen<width){decode_data->getbuf|=decode_data->bit_buf>>decode_data->getlen;fill_buf(decode_data,16 -decode_data->getlen);decode_data->getlen=16;} c=(uint16_t)decode_data->getbuf>>(16 -width);{decode_data->getbuf<<=width;decode_data->getlen-=width;}};
 }
 c += plus;
 return c;
}
...
static int decode_f(int fd, arj_metadata_t *metadata)
{
 ...
 while (count < metadata->orig_size) {
  ...
  if (chr == 0) {
   {if(dd->getlen<8){dd->getbuf|=dd->bit_buf>>dd->getlen;fill_buf(dd,16 -dd->getlen);dd->getlen=16;} chr=(uint16_t)dd->getbuf>>(16 -8);{dd->getbuf<<=8;dd->getlen-=8;}};
   decode_data.text[out_ptr] = (unsigned char) chr;
   count++;
   if (++out_ptr >= 26624) {
    out_ptr = 0;
...
static uint32_t arj_unstore(int ifd, int ofd, uint32_t len)
{
 ...
 while (rem > 0) {
  todo = (unsigned int) (((8192)<(rem))?(8192):(rem));
...
static int arj_read_main_header(int fd)
{
 ...
 if (main_hdr.first_hdr_size > 30) {
  if (lseek(fd, main_hdr.first_hdr_size - 30, 1) == -1) {
   return (0);
  }
 }
...
static int arj_read_file_header(int fd, arj_metadata_t *metadata)
{
 ...
 file_hdr.comp_size = (file_hdr.comp_size);
 file_hdr.orig_size = (file_hdr.orig_size);
 ...
 if (file_hdr.first_hdr_size > 30) {
  if (lseek(fd, file_hdr.first_hdr_size - 30, 1) == -1) {
   return -124;
  }
 }
 ...
 metadata->encrypted = ((file_hdr.flags & 0x01) != 0) ? (1) : (0);
 metadata->ofd = -1;
...
int cli_unarj_extract_file(int fd, const char *dirname, arj_metadata_t *metadata)
{
 ...
 if (metadata->encrypted) {
  ...
  offset = lseek(fd, 0, 1) + metadata->comp_size;
 ...
 cli_dbgmsg("Filename: %s\n", filename);
 metadata->ofd = open(filename, 02|0100|01000|0, 0600);
 if (metadata->ofd < 0) {
  return -115;
 }
