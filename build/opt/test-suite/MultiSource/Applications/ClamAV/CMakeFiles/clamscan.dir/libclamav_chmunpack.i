# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c" 2
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
...
# 167 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
...
static int itsf_read_header(int fd, itsf_header_t *itsf_hdr, unsigned char *m_area, off_t m_length)
{
 ...
 if (!chm_read_data(fd, (unsigned char *) itsf_hdr, 0, (0x60),
    m_area, m_length)) {
  return (0);
 }
# 296 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
 if (memcmp(itsf_hdr->signature, "ITSF", 4) != 0) {
  cli_dbgmsg("ITSF signature mismatch\n");
  return (0);
 }
 itsf_hdr->version = (itsf_hdr->version);
 itsf_hdr->header_len = (itsf_hdr->header_len);
 itsf_hdr->last_modified = (itsf_hdr->last_modified);
 itsf_hdr->lang_id = (itsf_hdr->lang_id);
 itsf_hdr->sec0_offset = (itsf_hdr->sec0_offset);
 itsf_hdr->sec0_len = (itsf_hdr->sec0_len);
 itsf_hdr->dir_offset = (itsf_hdr->dir_offset);
 itsf_hdr->dir_len = (itsf_hdr->dir_len);
 if (itsf_hdr->version > 2) {
  itsf_hdr->data_offset = (itsf_hdr->data_offset);
 }
 return (1);
}
    ...
    unsigned char *m_area, off_t m_length)
{
 ...
 if (!chm_read_data(fd, (unsigned char *) itsp_hdr, offset, (0x54),
    m_area, m_length)) {
  return (0);
 }
# 392 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
 if (memcmp(itsp_hdr->signature, "ITSP", 4) != 0) {
  cli_dbgmsg("ITSP signature mismatch\n");
  return (0);
 }

 itsp_hdr->version = (itsp_hdr->version);
 itsp_hdr->header_len = (itsp_hdr->header_len);
 itsp_hdr->block_len = (itsp_hdr->block_len);
 itsp_hdr->blockidx_intvl = (itsp_hdr->blockidx_intvl);
 itsp_hdr->index_depth = (itsp_hdr->index_depth);
 itsp_hdr->index_root = (itsp_hdr->index_root);
 itsp_hdr->index_head = (itsp_hdr->index_head);
 itsp_hdr->index_tail = (itsp_hdr->index_tail);
 itsp_hdr->num_blocks = (itsp_hdr->num_blocks);
 itsp_hdr->lang_id = (itsp_hdr->lang_id);

 if ((itsp_hdr->version != 1) || (itsp_hdr->header_len != (0x54))) {
...
# 567 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
 chunk_hdr->free_space = (chunk_hdr->free_space);
...
# 586 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
  chunk_hdr->block_next = (chunk_hdr->block_next);
  chunk_hdr->block_prev = (chunk_hdr->block_prev);
     ...
     unsigned char *m_area, off_t m_length)
{
 ...
 if (!chm_read_data(fd, (unsigned char *) lzx_control, offset, (0x18),
    m_area, m_length)) {
  goto abort;
 }
# 667 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
 lzx_control->length = (lzx_control->length);
 lzx_control->version = (lzx_control->version);
 lzx_control->reset_interval = (lzx_control->reset_interval);
 lzx_control->window_size = (lzx_control->window_size);
 lzx_control->cache_size = (lzx_control->cache_size);
 ...
 switch(lzx_control->version) {
  case 1:
   break;
  case 2:
   lzx_control->reset_interval *= (32768);
   lzx_control->window_size *= (32768);
   break;
  default:
      ...
      unsigned char *m_area, off_t m_length)
{
 ...
 if (!chm_read_data(fd, (unsigned char *) lzx_reset_table, offset, (0x24),
    m_area, m_length)) {
  goto abort;
 }
# 789 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
 lzx_reset_table->num_entries = (lzx_reset_table->num_entries);
 lzx_reset_table->entry_size = (lzx_reset_table->entry_size);
 lzx_reset_table->table_offset = (lzx_reset_table->table_offset);
 lzx_reset_table->uncom_len = (lzx_reset_table->uncom_len);
 lzx_reset_table->com_len = (lzx_reset_table->com_len);
 lzx_reset_table->frame_len = (lzx_reset_table->frame_len);

 if (lzx_reset_table->frame_len != (32768)) {
...
# 819 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_chmunpack.c"
static int chm_decompress_stream(int fd, const char *dirname, itsf_header_t *itsf_hdr,
    file_list_t *file_l, file_list_t *sys_file_l,
    unsigned char *m_area, off_t m_length)
{
 file_list_t *entry;
 lzx_content_t *lzx_content=((void*)0);
 lzx_reset_table_t *lzx_reset_table=((void*)0);
 lzx_control_t *lzx_control=((void*)0);
 int window_bits, count, length, tmpfd, ofd, retval=(0);
 uint64_t com_offset;
 struct lzx_stream * stream;
 unsigned char filename[1024];

 snprintf(filename, 1024, "%s/clamav-unchm.bin", dirname);
 tmpfd = open(filename, 01|0100|01000|0, (0400|0200|0100));
 if (tmpfd<0) {
 ...
 while (entry) {
  if (strcmp(entry->name, "::DataSpace/Storage/MSCompressed/ControlData") == 0) {
   lzx_control = read_sys_control(fd, itsf_hdr, entry, m_area, m_length);
  } else if (strcmp(entry->name, "::DataSpace/Storage/MSCompressed/Content") == 0) {
   lzx_content = read_sys_content(fd, itsf_hdr, entry);
  } else if (strcmp(entry->name, "::DataSpace/Storage/MSCompressed/Transform/{7FC28940-9D31-11D0-9B27-00A0C91E9C7C}/InstanceData/ResetTable") == 0) {
 ...
 if (lzx_control->reset_interval % (32768)) {
 ...
 stream = lzx_init(fd, tmpfd, window_bits,
   lzx_control->reset_interval / (32768),
   4096, length, ((void*)0), ((void*)0));
 lseek(fd, com_offset, 0);
 if (!stream) {
 ...
 while(entry) {
  ...
  if (lseek(tmpfd, entry->offset, 0) != (off_t)entry->offset) {
  ...
  ofd = open(filename, 01|0100|01000|0, (0400|0200|0100));
  if (ofd < 0) {
   entry = entry->next;
   continue;
  }
...
int chm_unpack(int fd, const char *dirname)
{
 ...
 sys_file_l->next = ((void*)0);
 sys_file_l->name = ((void*)0);


 if (fstat(fd, &statbuf) == 0) {
  if (statbuf.st_size < (0x60)) {
   goto abort;
  }
  m_length = statbuf.st_size;
  m_area = (unsigned char *) mmap(((void*)0), m_length, 0x1, 0x02, fd, 0);
  if (m_area == ((void *) -1)) {
   m_area = ((void*)0);
  }
 }
 ...
 offset = itsf_hdr.dir_offset+(0x54);
 ...
 if (itsf_hdr.version < 3) {
  itsf_hdr.data_offset = itsf_hdr.dir_offset + (0x54) + (itsp_hdr.block_len*itsp_hdr.num_blocks);
 }
