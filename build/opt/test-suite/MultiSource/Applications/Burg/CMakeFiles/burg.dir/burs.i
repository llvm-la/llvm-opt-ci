# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/burs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/burs.c" 2
char rcsid_burs[] = "$Id$";
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/Burg/burs.c" 2
...
build()
{
 ...
 if (debugTables) printf("---initial set of states ---\n");
 if (debugTables) dumpMapping(globalMap);
 if (debugTables) foreachList((ListFn) dumpItem_Set, globalQ->head);
