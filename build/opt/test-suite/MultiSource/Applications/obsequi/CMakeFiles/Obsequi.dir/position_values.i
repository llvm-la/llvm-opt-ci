# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/position_values.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/position_values.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/position_values.c" 2
...
set_position_value(s32bit player, s32bit row, s32bit col, s32bit value)
{
  ...
  num_cols = g_board_size[player^1];
...
# 92 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/position_values.c"
extern void
set_position_values()
{
  s32bit i, j, k, count;
...
# 116 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/position_values.c"
  for(i = 0; i < 2; i++){
    count = 127;
    for(j = 2; j < (g_board_size[i]+3)/2; j+=2){
      for(k = 1; k < (g_board_size[i^1]/2)+1; k+=2){
  ...
  for(i = 0; i < 2; i++){
    count = 90;
    for(j = 2; j < (g_board_size[i]+3)/2; j+=2){
      for(k = 1; k < (g_board_size[i^1]/2)+1; k++){
...
# 176 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/position_values.c"
}
