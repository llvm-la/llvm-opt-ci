# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/traits.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/traits.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/traits.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/traits.c" 2

static FILE *trait_file = ((void*)0);
...
tr_total_non_safe_moves(s32bit player)
{
  ...
  for(i = 0; i < num_rows; i++){
    ...
    count += (countbits16[mask1&0x0000FFFF] +countbits16[(mask1>>16)&0x0000FFFF]);
  }
...
tr_total_empty_squares()
{
  ...
  for(i = 0; i < num_rows; i++){
    ...
    count += (countbits16[mask&0x0000FFFF] +countbits16[(mask>>16)&0x0000FFFF]);
  }
...
write_node_info(u64bit num_nodes, s32bit winner)
{
  ...
  num = tr_total_non_safe_moves(winner^1);
  fprintf(trait_file, " %2d :", num);
  ...
  num = tr_non_safe_moves_a_little_touchy(winner^1);
  fprintf(trait_file, " %2d :", num);
  ...
  num = tr_non_safe_moves_no_touchy(winner^1);
  fprintf(trait_file, " %2d :", num);
