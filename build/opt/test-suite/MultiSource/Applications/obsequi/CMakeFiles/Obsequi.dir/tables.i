# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/tables.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/tables.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/tables.c" 2
...
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/tables.c"
...
init_lastbit()
{
  ...
  for(i = 1; i < 65536; i++){
    if(i&( 1 << (0) )) {lastbit16[i] = 0; continue;}
    if(i&( 1 << (1) )) {lastbit16[i] = 1; continue;}
    if(i&( 1 << (2) )) {lastbit16[i] = 2; continue;}
    if(i&( 1 << (3) )) {lastbit16[i] = 3; continue;}
    if(i&( 1 << (4) )) {lastbit16[i] = 4; continue;}
    if(i&( 1 << (5) )) {lastbit16[i] = 5; continue;}
    if(i&( 1 << (6) )) {lastbit16[i] = 6; continue;}
    if(i&( 1 << (7) )) {lastbit16[i] = 7; continue;}
    if(i&( 1 << (8) )) {lastbit16[i] = 8; continue;}
    if(i&( 1 << (9) )) {lastbit16[i] = 9; continue;}
    if(i&( 1 << (10) )) {lastbit16[i] = 10; continue;}
    if(i&( 1 << (11) )) {lastbit16[i] = 11; continue;}
    if(i&( 1 << (12) )) {lastbit16[i] = 12; continue;}
    if(i&( 1 << (13) )) {lastbit16[i] = 13; continue;}
    if(i&( 1 << (14) )) {lastbit16[i] = 14; continue;}
    if(i&( 1 << (15) )) {lastbit16[i] = 15; continue;}
  }

  lastbit16[0] = 100;
}
# 92 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/tables.c"
...
init_less_static_tables()
{
  ...
  for(i = 0; i < n_rows; i++){
    for(j = 0; j < n_cols; j++){
      ...
      if(j + 1 < n_cols){
        g_keyinfo[0][i+1][j+1].norm.bit1_index = (i*n_cols)+j;
        g_keyinfo[0][i+1][j+1].norm.bit2_index = (i*n_cols)+(j+1);
      }


      if(i + 1 < n_rows){
        g_keyinfo[1][j+1][i+1].norm.bit1_index = (i*n_cols)+j;
        g_keyinfo[1][j+1][i+1].norm.bit2_index = ((i+1)*n_cols)+j;
      }
    }
  }
