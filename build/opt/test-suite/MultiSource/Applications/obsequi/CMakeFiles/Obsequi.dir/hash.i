# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/hash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/hash.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/hash.c" 2
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/hash.c"
extern void
          ...
          u32bit nodes, s32bit depth, Move best, s32bit player)
{
  ...
  index = (g_norm_hashkey).code; if((g_trans_table[index].key[0] == (g_norm_hashkey).key[0] && g_trans_table[index].key[1] == (g_norm_hashkey).key[1] && g_trans_table[index].key[2] == (g_norm_hashkey).key[2] && g_trans_table[index].key[3] == (g_norm_hashkey).key[3]) || g_trans_table[index].nodes <= nodes){ g_trans_table[index].key[0] = (g_norm_hashkey).key[0], g_trans_table[index].key[1] = (g_norm_hashkey).key[1], g_trans_table[index].key[2] = (g_norm_hashkey).key[2], g_trans_table[index].key[3] = (g_norm_hashkey).key[3];; g_trans_table[index].nodes =nodes; g_trans_table[index].best_move =((best).mask_index-1)*g_board_size[(player)]+((best).array_index-1); g_trans_table[index].depth =depth; g_trans_table[index].whos_turn =player; g_trans_table[index].value =value; if (value>=beta) g_trans_table[index].type =0; else if(value>alpha) g_trans_table[index].type =1; else g_trans_table[index].type =2; return; };
  index = (g_flipV_hashkey).code; if((g_trans_table[index].key[0] == (g_flipV_hashkey).key[0] && g_trans_table[index].key[1] == (g_flipV_hashkey).key[1] && g_trans_table[index].key[2] == (g_flipV_hashkey).key[2] && g_trans_table[index].key[3] == (g_flipV_hashkey).key[3]) || g_trans_table[index].nodes <= nodes){ g_trans_table[index].key[0] = (g_flipV_hashkey).key[0], g_trans_table[index].key[1] = (g_flipV_hashkey).key[1], g_trans_table[index].key[2] = (g_flipV_hashkey).key[2], g_trans_table[index].key[3] = (g_flipV_hashkey).key[3];; g_trans_table[index].nodes =nodes; g_trans_table[index].best_move =((best).mask_index-1)*g_board_size[(player)]+((best).array_index-1); g_trans_table[index].depth =depth; g_trans_table[index].whos_turn =player; g_trans_table[index].value =value; if (value>=beta) g_trans_table[index].type =0; else if(value>alpha) g_trans_table[index].type =1; else g_trans_table[index].type =2; return; };
  index = (g_flipH_hashkey).code; if((g_trans_table[index].key[0] == (g_flipH_hashkey).key[0] && g_trans_table[index].key[1] == (g_flipH_hashkey).key[1] && g_trans_table[index].key[2] == (g_flipH_hashkey).key[2] && g_trans_table[index].key[3] == (g_flipH_hashkey).key[3]) || g_trans_table[index].nodes <= nodes){ g_trans_table[index].key[0] = (g_flipH_hashkey).key[0], g_trans_table[index].key[1] = (g_flipH_hashkey).key[1], g_trans_table[index].key[2] = (g_flipH_hashkey).key[2], g_trans_table[index].key[3] = (g_flipH_hashkey).key[3];; g_trans_table[index].nodes =nodes; g_trans_table[index].best_move =((best).mask_index-1)*g_board_size[(player)]+((best).array_index-1); g_trans_table[index].depth =depth; g_trans_table[index].whos_turn =player; g_trans_table[index].value =value; if (value>=beta) g_trans_table[index].type =0; else if(value>alpha) g_trans_table[index].type =1; else g_trans_table[index].type =2; return; };
  index = (g_flipVH_hashkey).code; if((g_trans_table[index].key[0] == (g_flipVH_hashkey).key[0] && g_trans_table[index].key[1] == (g_flipVH_hashkey).key[1] && g_trans_table[index].key[2] == (g_flipVH_hashkey).key[2] && g_trans_table[index].key[3] == (g_flipVH_hashkey).key[3]) || g_trans_table[index].nodes <= nodes){ g_trans_table[index].key[0] = (g_flipVH_hashkey).key[0], g_trans_table[index].key[1] = (g_flipVH_hashkey).key[1], g_trans_table[index].key[2] = (g_flipVH_hashkey).key[2], g_trans_table[index].key[3] = (g_flipVH_hashkey).key[3];; g_trans_table[index].nodes =nodes; g_trans_table[index].best_move =((best).mask_index-1)*g_board_size[(player)]+((best).array_index-1); g_trans_table[index].depth =depth; g_trans_table[index].whos_turn =player; g_trans_table[index].value =value; if (value>=beta) g_trans_table[index].type =0; else if(value>alpha) g_trans_table[index].type =1; else g_trans_table[index].type =2; return; };
}
# 97 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/hash.c"
extern s32bit
           ...
           s32bit depth_remaining, Move *force_first, s32bit player)
{
  ...
  index = (g_norm_hashkey).code; if((g_trans_table[index].key[0] == (g_norm_hashkey).key[0] && g_trans_table[index].key[1] == (g_norm_hashkey).key[1] && g_trans_table[index].key[2] == (g_norm_hashkey).key[2] && g_trans_table[index].key[3] == (g_norm_hashkey).key[3]) && g_trans_table[index].whos_turn == player ) { (*force_first).mask_index = ((g_trans_table[index].best_move)/g_board_size[(player)])+1; (*force_first).array_index = ((g_trans_table[index].best_move)%g_board_size[(player)])+1; if(g_trans_table[index].depth >= depth_remaining) { if(g_trans_table[index].type == 1) { *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].type == 0) { if(g_trans_table[index].value>=(*beta)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value>(*alpha)){ *alpha=g_trans_table[index].value; } return 0; } if(g_trans_table[index].type == 2) { if(g_trans_table[index].value<=(*alpha)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value<(*beta)){ *beta=g_trans_table[index].value; } return 0; } } };
  index = (g_flipV_hashkey).code; if((g_trans_table[index].key[0] == (g_flipV_hashkey).key[0] && g_trans_table[index].key[1] == (g_flipV_hashkey).key[1] && g_trans_table[index].key[2] == (g_flipV_hashkey).key[2] && g_trans_table[index].key[3] == (g_flipV_hashkey).key[3]) && g_trans_table[index].whos_turn == player ) { (*force_first).mask_index = ((g_trans_table[index].best_move)/g_board_size[(player)])+1; (*force_first).array_index = ((g_trans_table[index].best_move)%g_board_size[(player)])+1; if(g_trans_table[index].depth >= depth_remaining) { if(g_trans_table[index].type == 1) { *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].type == 0) { if(g_trans_table[index].value>=(*beta)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value>(*alpha)){ *alpha=g_trans_table[index].value; } return 0; } if(g_trans_table[index].type == 2) { if(g_trans_table[index].value<=(*alpha)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value<(*beta)){ *beta=g_trans_table[index].value; } return 0; } } };
  index = (g_flipH_hashkey).code; if((g_trans_table[index].key[0] == (g_flipH_hashkey).key[0] && g_trans_table[index].key[1] == (g_flipH_hashkey).key[1] && g_trans_table[index].key[2] == (g_flipH_hashkey).key[2] && g_trans_table[index].key[3] == (g_flipH_hashkey).key[3]) && g_trans_table[index].whos_turn == player ) { (*force_first).mask_index = ((g_trans_table[index].best_move)/g_board_size[(player)])+1; (*force_first).array_index = ((g_trans_table[index].best_move)%g_board_size[(player)])+1; if(g_trans_table[index].depth >= depth_remaining) { if(g_trans_table[index].type == 1) { *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].type == 0) { if(g_trans_table[index].value>=(*beta)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value>(*alpha)){ *alpha=g_trans_table[index].value; } return 0; } if(g_trans_table[index].type == 2) { if(g_trans_table[index].value<=(*alpha)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value<(*beta)){ *beta=g_trans_table[index].value; } return 0; } } };
  index = (g_flipVH_hashkey).code; if((g_trans_table[index].key[0] == (g_flipVH_hashkey).key[0] && g_trans_table[index].key[1] == (g_flipVH_hashkey).key[1] && g_trans_table[index].key[2] == (g_flipVH_hashkey).key[2] && g_trans_table[index].key[3] == (g_flipVH_hashkey).key[3]) && g_trans_table[index].whos_turn == player ) { (*force_first).mask_index = ((g_trans_table[index].best_move)/g_board_size[(player)])+1; (*force_first).array_index = ((g_trans_table[index].best_move)%g_board_size[(player)])+1; if(g_trans_table[index].depth >= depth_remaining) { if(g_trans_table[index].type == 1) { *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].type == 0) { if(g_trans_table[index].value>=(*beta)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value>(*alpha)){ *alpha=g_trans_table[index].value; } return 0; } if(g_trans_table[index].type == 2) { if(g_trans_table[index].value<=(*alpha)){ *value=g_trans_table[index].value; return 1; } if(g_trans_table[index].value<(*beta)){ *beta=g_trans_table[index].value; } return 0; } } };
