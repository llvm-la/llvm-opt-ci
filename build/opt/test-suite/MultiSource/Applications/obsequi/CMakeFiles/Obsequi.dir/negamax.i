# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h" 1
...
_fatal_error_aux(const char *file, const s32bit line,
     ...
     __attribute__ ((format (printf, 4, 5)));
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/structs.h" 1
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/structs.h"
typedef struct
{
  s32bit safe;
  s32bit real;
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/consts.h" 1
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h" 2
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h"
s32bit move_generator (Move movelist[256], s32bit player);

s32bit move_generator_stage1 (Move movelist[256], s32bit player);

s32bit move_generator_stage2 (Move movelist[256],
                               s32bit start, s32bit player);
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h"
...
void
score_and_get_first(Move movelist[256], s32bit num_moves,
...
void sort_moves(Move movelist[256], s32bit start, s32bit num_moves);
...
# 93 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h"
...
# 179 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h"
...
# 211 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/globals.h"
extern s32bit lastbit16[65536];
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/macros.h" 1
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/macros.h"
static inline u32bit
lastbit32(u32bit x)
{
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/macros.h"
  if(x&0x0000FFFF)
...
# 85 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/macros.h"
static inline s32bit
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c" 2
...
# 73 "/usr/include/loongarch64-linux-gnu/bits/time.h" 3 4
# 1 "/usr/include/loongarch64-linux-gnu/bits/timex.h" 1 3 4
# 26 "/usr/include/loongarch64-linux-gnu/bits/timex.h" 3 4
struct timex
{
# 58 "/usr/include/loongarch64-linux-gnu/bits/timex.h" 3 4
  unsigned int modes;
...
# 74 "/usr/include/loongarch64-linux-gnu/bits/time.h" 2 3 4
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
...
# 80 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
...
search_for_move(char dir, s32bit *row, s32bit *col, u64bit *nodes)
{
  ...
  if((__extension__ ({ int __res; if (sizeof (dir) > 1) { if (__builtin_constant_p (dir)) { int __c = (dir); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (dir); } else __res = (*__ctype_toupper_loc ())[(int) (dir)]; __res; })) == 'V') whos_turn = 1;
  else if((__extension__ ({ int __res; if (sizeof (dir) > 1) { if (__builtin_constant_p (dir)) { int __c = (dir); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (dir); } else __res = (*__ctype_toupper_loc ())[(int) (dir)]; __res; })) == 'H') whos_turn = 0;
  else { ((_fatal_error_aux("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c", 126, ((1) ? (1) : 256), "Invalid player.\n" ))); exit(1); }


  g_empty_squares = 0;
  for(i = 0; i < g_board_size[0]; i++)
    g_empty_squares += (countbits16[(~g_board[0][i+1])&0x0000FFFF] +countbits16[((~g_board[0][i+1])>>16)&0x0000FFFF]);
  ...
  if(num_moves == 0) ((_fatal_error_aux("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c", 160, ((1) ? (1) : 256), "No moves" )));
  ...
  for(d = 1; d < 50; d += 44){
    ...
    for(i = 0; i < num_moves; i++){
      ...
      g_norm_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit1_index%32) ); g_norm_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit2_index%32) ); g_norm_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.hash_code; g_flipV_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit1_index%32) ); g_flipV_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit2_index%32) ); g_flipV_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.hash_code; g_flipH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit1_index%32) ); g_flipH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit2_index%32) ); g_flipH_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.hash_code; g_flipVH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit1_index%32) ); g_flipVH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit2_index%32) ); g_flipVH_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.hash_code;;

      check_hash_code_sanity();

      value = -negamax(d-1, whos_turn^1, -beta, -alpha);
    ...
    if(value >= 5000){
      ...
      if(whos_turn == 0){
        ...
        *row = movelist[i].mask_index;
        ...
        ((_fatal_error_aux("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c", 239, ((1) ? (1) : 256), "oops." )));
      }
...
# 323 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
static s32bit
negamax(s32bit depth_remaining, s32bit whos_turn_t, s32bit alpha, s32bit beta)
{
  Move movelist[256], best;
  s32bit whos_turn = whos_turn_t & 1;
  s32bit opponent = whos_turn_t ^ 1;
  s32bit value;
...
# 413 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
    cut3++;
...
# 429 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
    cut4++;

    return -5000;
  }
# 450 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
  ...
  if(true_count == 0){
    ...
    stage = 1;
    if(true_count == 0) ((_fatal_error_aux("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c", 458, ((1) ? (1) : 256), "Should always have a move.\n" )));
  }
  ...
  while(state < 3){
    ...
    for(; i < num_moves; i++){
      ...
      value = -negamax(depth_remaining-1,whos_turn^1,
                       -beta, -alpha);
      ...
      toggle_move(movelist[i], whos_turn);
      g_norm_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit1_index%32) ); g_norm_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.bit2_index%32) ); g_norm_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].norm.hash_code; g_flipV_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit1_index%32) ); g_flipV_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.bit2_index%32) ); g_flipV_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipV.hash_code; g_flipH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit1_index%32) ); g_flipH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.bit2_index%32) ); g_flipH_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipH.hash_code; g_flipVH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit1_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit1_index%32) ); g_flipVH_hashkey.key[g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit2_index/32] ^= ( 1 << (g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.bit2_index%32) ); g_flipVH_hashkey.code ^= g_keyinfo[whos_turn][movelist[i].array_index][movelist[i].mask_index].flipVH.hash_code;;
# 535 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
      if(value >= beta){
        alpha = value;
        best = movelist[i];
