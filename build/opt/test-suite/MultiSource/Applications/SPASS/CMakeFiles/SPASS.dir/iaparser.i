# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/iaparser.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/iaparser.c" 2
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/iaparser.c"
   enum yytokentype {
     IA_AND = 258,
     IA_EQUAL = 259,
     IA_EQUIV = 260,
...
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/ia.h"
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/ia.h" 2
...
LIST ia_PROOFREQUEST;
FLAGSTORE ia_FLAGS;

void ia_error(const char*);
int ia_lex(void);
...
yybackup:
  ...
  if (ia_char <= 0)
    ...
    {
      yychar1 = ((unsigned)(ia_char) <= 271 ? yytranslate[ia_char] : 2);
  ...
  yyn += yychar1;
  if (yyn < 0 || 83 < yyn || yycheck[yyn] != yychar1)
    goto yydefault;
  yyn = yytable[yyn];
  if (yyn <= 0)
    {
...
# 1306 "iaparser.c"
  *++yyvsp = yyval;
  ...
  yystate = yypgoto[yyn - 23] + *yyssp;
  if (0 <= yystate && yystate <= 83 && yycheck[yystate] == *yyssp)
    yystate = yytable[yystate];
  else
    yystate = yydefgoto[yyn - 23];
...
yyerrlab:
      ...
      if (-29 < yyn && yyn < 83)
 {
   ...
   int yytype = ((unsigned)(ia_char) <= 271 ? yytranslate[ia_char] : 2);
   char *yymsg;
   int yyx, yycount;
       ...
       if (yycount < 5)
  {
   ...
   yycount++;
     ...
     ia_error ("parse error; also virtual memory exhausted");
 }
      else

 ia_error ("parse error");
    }
  goto yyerrlab1;
...
yyoverflowlab:
  ia_error ("parser stack overflow");
  yyresult = 2;
