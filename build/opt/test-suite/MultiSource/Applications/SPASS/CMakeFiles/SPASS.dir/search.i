# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c" 2
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c" 2
...
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c" 2
...

{
  ...
  if (S->father != (CLAUSE)((void*)0))
    clause_Delete(S->father);
  prfs_SplitFree(S);
}
# 102 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
# 177 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
{
  if ((prfs_DynamicSortTheory(Search) != (SORTTHEORY)((void*)0) ||
       prfs_ApproximatedDynamicSortTheory(Search) != (SORTTHEORY)((void*)0)) &&
 ...
 if (prfs_ApproximatedDynamicSortTheory(Search) != (SORTTHEORY)((void*)0)) {
...

{
  ...
  Search->astatic = (SORTTHEORY)((void*)0);
  Search->adynamic = (SORTTHEORY)((void*)0);
  Search->dynamic = (SORTTHEORY)((void*)0);
  Search->dplist = list_Nil();
...

{
  ...
  Result->astatic = (SORTTHEORY)((void*)0);
  Result->adynamic = (SORTTHEORY)((void*)0);
  Result->dynamic = (SORTTHEORY)((void*)0);
  ...
  Result->dpindex = (SHARED_INDEX)((void*)0);
...

{
  ...
  if (prfs_DocProofSharingIndex(Search) != ((void*)0) &&
      prfs_DocProofSharingIndex(SearchCopy) == ((void*)0))
...
{
# 463 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
# 480 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
{
# 494 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
{
# 520 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  if (prfs_DocProofSharingIndex(Search) == (SHARED_INDEX)((void*)0))
...
# 539 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
{
# 549 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
{
# 577 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
{
# 611 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  prfs_SetUsableClauses(Search,list_PointerDeleteElement(prfs_UsableClauses(Search),Clause));
...
# 635 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
{
  LIST scan, invalid;
  CLAUSE clause;
...
{
# 686 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  prfs_DeleteFromSortTheories(Search, Clause);
  clause_RemoveFlag(Clause,WORKEDOFF);
  prfs_SetWorkedOffClauses(Search,list_PointerDeleteElement(prfs_WorkedOffClauses(Search),Clause));
...
{
# 709 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  prfs_SetUsableClauses(Search,list_PointerDeleteElement(prfs_UsableClauses(Search),Clause));
...
{
# 730 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
{
# 752 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  prfs_DeleteFromSortTheories(Search, Clause);
  prfs_SetWorkedOffClauses(Search,list_PointerDeleteElement(prfs_WorkedOffClauses(Search),Clause));
  clause_DeleteFromSharing(Clause, prfs_WorkedOffSharingIndex(Search),
      prfs_Store(Search), prfs_Precedence(Search));
...
{
# 775 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  prfs_SetUsableClauses(Search,list_PointerDeleteElement(prfs_UsableClauses(Search),Clause));
  clause_DeleteFromSharing(Clause,prfs_UsableSharingIndex(Search),
      prfs_Store(Search), prfs_Precedence(Search));
}
...

{
  ...
  fputs("\n Father: ", stdout);
  if (prfs_SplitFatherClause(Split) != (CLAUSE)((void*)0))
...
{
  LIST Scan;
# 853 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
...
# 920 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
{
...
# 936 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  ...
  NewClause = clause_CreateBody(lengthNew);
  BlockedClause = clause_CreateBody(lengthBlocked);
...
# 1072 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  return NewClause;
}
...

{
  ...
  BOOL Change;
# 1098 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
  LitList = list_Nil();
...
# 1172 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
{
  CLAUSE Result;

  Result = (CLAUSE)((void*)0);
...
void prfs_InstallFiniteMonadicPredicates(PROOFSEARCH Search, LIST Clauses,
      LIST Predicates)
# 1202 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/search.c"
{
