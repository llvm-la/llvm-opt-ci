# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c" 2
...
const int symbol_MASK = 3;
const int symbol_TYPEMASK = 3;
const int symbol_STATMASK = 4;
const int symbol_TYPESTATMASK = 7;
...
SYMBOL symbol_CONTEXT[4000];

static unsigned long symbol_COUNT[4000];
# 96 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
int symbol_GetIncreasedOrderingCounter(void)
{
...
{
  SIGNATURE Entry;
# 150 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
  if ((int)symbol_ACTINDEX >= 4000 &&
...
# 203 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
{
  if (Arity == 0)
    return symbol_SignatureCreate(strcpy(memory_Malloc(64),
      String),
      0, Arity, Status, Precedence);
  else
    return symbol_SignatureCreate(strcpy(memory_Malloc(64),
      String),
      1, Arity, Status, Precedence);
}
...

{
  ...
  while (Result == (SYMBOL)((void*)0)) {
    ...
    if (symbol_Lookup(newname) == 0)
      Result = symbol_CreateFunction(newname, Arity, 0, Precedence);
  }
...
SYMBOL symbol_CreatePredicate(const char* String, int Arity, int Status,
         PRECEDENCE Precedence)
# 253 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
{
  return symbol_SignatureCreate(strcpy(memory_Malloc(64),
           String),
    2, Arity, Status, Precedence);
}
...

{
  ...
  while (Result == (SYMBOL)((void*)0)) {
    ...
    if (symbol_Lookup(newname) == 0)
      Result = symbol_CreatePredicate(newname, Arity, 0, Precedence);
  }
...
SYMBOL symbol_CreateJunctor(const char* String, int Arity, int Status,
       PRECEDENCE Precedence)
# 296 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
{
  return symbol_SignatureCreate(strcpy(memory_Malloc(64),
           String),
    3, Arity, Status, Precedence);
}
...
{
# 338 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
  if (!symbol_IsVariable(Symbol)) {
    ...
    Entry = symbol_Signature(Index);
    symbol_SetSignature(Index, ((void*)0));
...

{
  ...
  if (symbol_SignatureExists()) {
    ...
    for (Index = 1; Index < symbol_ACTINDEX; Index++) {
      S = symbol_Signature(Index);
      if (S != ((void*)0) && symbol_IsPredicate(symbol_GetSigSymbol(Index)))
 Result = list_Cons((POINTER)symbol_GetSigSymbol(Index), Result);
    }
  }
  return Result;
...

{
  ...
  if (symbol_SignatureExists()) {
    ...
    for (Index = 1; Index < symbol_ACTINDEX; Index++) {
      S = symbol_Signature(Index);
      if (S != ((void*)0) && symbol_IsFunction(symbol_GetSigSymbol(Index)))
 Result = list_Cons((POINTER)symbol_GetSigSymbol(Index), Result);
    }
  }
  return Result;
...

{
 ...
 symbol_FreeSignature(S);
    ...
    memory_Free(symbol_SIGNATURE, sizeof(SIGNATURE[4000]));
  }

  memory_Free(symbol_VARSTRING, 64);
...

{
  ...
  if (Signature)
    symbol_SIGNATURE = (SIGNATURE*)memory_Malloc(sizeof(SIGNATURE[4000]));
  ...
  symbol_ACTINDEX = 1;
  symbol_ORDERING = 1;
  symbol_VARSTRING = memory_Malloc(64);
...
# 556 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
...

{
  if (symbol_SignatureExists()) {
    ...
    for (Index = 1; Index < symbol_ACTINDEX; Index++) {
      S = symbol_Signature(Index);
      if (S != ((void*)0) && string_Equal(String, S->name))
 return S->info;
    }
  }
...
# 586 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
void symbol_LowerSignature(void)
...

{
 ...
 if ('A' <= String[0] && String[0] <= 'Z') {
   char* New;
   New = (char *)memory_Malloc(64);
   strcpy(&(New[2]),String);
   New[0] = New[1] = 's';

   Entry->name = New;
   memory_Free(String,64);
 }
      }
    }
  }
...
# 804 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
...
{
# 830 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
...
{
# 873 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/symbol.c"
  if (symbol_IsVariable(Symbol)) {
    SYMBOL NormSymbol;
