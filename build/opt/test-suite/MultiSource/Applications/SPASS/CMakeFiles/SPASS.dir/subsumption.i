# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c" 2
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.h"
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.h" 2
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.h" 2
...
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/sharing.h"
...
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c" 2

static NAT multvec_i[100];
static NAT multvec_j[100];
static NAT stamp;
...
# 409 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  TERM t1,t2;
  int j;
  BOOL found;
...
# 568 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  BOOL Result;
...

{
 ...
 multvec_j[j] = 0;
      ...
      for (Scan=NewBindings;!list_Empty(Scan);Scan=list_Cdr(Scan)) {
...
# 703 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  BOOL Result;
  ...
  if (clause_Length(C1) > clause_Length(C2) ||
      ...
      (clause_NumOfAnteLits(C2) + clause_NumOfConsLits(C2))) {
    return FALSE;
  }
...
# 1246 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  int a;
...
static BOOL subs_SubsumptionVecPossibleRes(CLAUSE c1, int vec,
        int beg, int end)
# 1594 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  int j,i;
...
# 1624 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  LIST TermIndexlist,VarSymbList,TermSymbList;
  int i;
...
# 1700 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  int a,top_index;
...
# 1747 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  int locvec;
  LITPTR litptr;
...
static BOOL subs_SubsumptionVecPossibleEqExcept(CLAUSE c1, int vec,
      CLAUSE c2, int i2)
# 1884 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
{
  int i,j,n;
  TERM lit1,lit2;
