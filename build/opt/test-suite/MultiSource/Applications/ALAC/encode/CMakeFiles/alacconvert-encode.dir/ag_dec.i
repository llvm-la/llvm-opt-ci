# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c"
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c" 2
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c"
void set_standard_ag_params(AGParamRecPtr params, uint32_t fullwidth, uint32_t sectorwidth)
{
 ...
 set_ag_params( params, 10, 40, 14, fullwidth, sectorwidth, 255 );
}
...
static inline uint32_t __attribute__((always_inline)) read32bit( uint8_t * buffer )
{
...
# 135 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/ALAC/encode/ag_dec.c"
...
static inline int32_t dyn_get_32bit( uint8_t * in, uint32_t * bitPos, int32_t m, int32_t k, int32_t maxbits )
{
 ...
 if(result >= 9)
 {
  result = getstreambits(in, tempbits+9, maxbits);
  tempbits += 9 + maxbits;
 }
 else
 {
...
int32_t dyn_decomp( AGParamRecPtr params, BitBuffer * bitstream, int32_t * pc, int32_t numSamples, int32_t maxSize, uint32_t * outNumBits )
{
 ...
 if (!((bitstream != ((void*)0)) && (pc != ((void*)0)) && (outNumBits != ((void*)0)))) { return kALAC_ParamError; };
 *outNumBits = 0;
 ...
 status = ALAC_noErr;
    ...
    while (c < numSamples)
    {
     ...
     if (!(bitPos < maxPos)) { status = kALAC_ParamError; goto Exit; };

        m = (mb)>>9;
        k = lg3a(m);

        k = ((k) < (kb_local) ? (k) : (kb_local));
        m = (1<<k)-1;
  ...
  n = dyn_get_32bit( in, &bitPos, m, k, maxSize );
        ...
        *outPtr++ = del;
        ...
        mb = pb_local*(n+zmode) + mb - ((pb_local*mb)>>9);
  ...
  if (n > 0xffff)
   mb = 0xffff;
        ...
        if (((mb << 2) < (1<<9)) && (c < numSamples))
        {
            ...
            if (!(c+n <= numSamples)) { status = kALAC_ParamError; goto Exit; };
 ...
 *outNumBits = (bitPos - startPos);
 ...
 if (!(bitstream->cur <= bitstream->end)) { status = kALAC_ParamError; };
