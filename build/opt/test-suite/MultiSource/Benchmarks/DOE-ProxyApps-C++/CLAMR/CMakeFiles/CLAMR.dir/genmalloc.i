# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c" 2
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c"
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c" 2
# 1 "/usr/include/loongarch64-linux-gnu/sys/queue.h" 1 3 4
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c" 2
...
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c" 2
...
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.h" 1
# 84 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.h"
...
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c" 2
...
struct slist_genmalloc_memory_head { struct genmalloc_memory_entry *slh_first; } genmalloc_memory_head = { ((void*)0) };
struct slist_genmalloc_memory_head *genmalloc_memory_headp;
struct genmalloc_memory_entry {
   void *mem_ptr;
   size_t mem_size;
   struct { struct genmalloc_memory_entry *sle_next; } genmalloc_memory_entries;
...
void *genvector_p(int inum, size_t elsize, const char *file, const int line)
{
   ...
   ( genmalloc_memory_add_p(out, mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 88) );
...
void genvectorfree_p(void *var, const char *file, const int line)
{
   ...
   ( genmalloc_memory_remove_p(var, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 98) );
}
...
void **genmatrix_p(int jnum, int inum, size_t elsize, const char *file, const int line)
{
   ...
   ( genmalloc_memory_add_p(out, mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 111) );

   mem_size = jnum*inum*elsize;
   out[0] = (void *)calloc((size_t)jnum*(size_t)inum, elsize);
   ( genmalloc_memory_add_p(out[0], mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 115) );
...
void genmatrixfree_p(void **var, const char *file, const int line)
{
   ...
   ( genmalloc_memory_remove_p(var[0], "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 129) );
   ( genmalloc_memory_remove_p(var, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 130) );
}
...
double ***gentrimatrix_double_p(int knum, int jnum, int inum, const char *file, const int line)
{
   ...
   ( genmalloc_memory_add_p(out, mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 161) );

   mem_size = knum*jnum*sizeof(void *);
   out[0] = (double **) malloc(mem_size);
   ( genmalloc_memory_add_p(out[0], mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 165) );

   size_t nelems = knum*jnum*inum;
   mem_size = nelems*elsize;
   out[0][0] = (void *)calloc(nelems, elsize);
   ( genmalloc_memory_add_p(out[0][0], mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 170) );
...
int ***gentrimatrix_int_p(int knum, int jnum, int inum, const char *file, const int line)
{
   ...
   ( genmalloc_memory_add_p(out, mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 200) );

   mem_size = knum*jnum*sizeof(void *);
   out[0] = (int **) malloc(mem_size);
   ( genmalloc_memory_add_p(out[0], mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 204) );

   size_t nelems = knum*jnum*inum;
   mem_size = nelems*elsize;
   out[0][0] = (void *)calloc(nelems, elsize);
   ( genmalloc_memory_add_p(out[0][0], mem_size, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 209) );
...
void gentrimatrixfree_p(void ***var, const char *file, const int line)
{
   ...
   ( genmalloc_memory_remove_p(var[0][0], "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 233) );
   ( genmalloc_memory_remove_p(var[0], "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 234) );
   ( genmalloc_memory_remove_p(var, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c", 235) );
}
...
void *genmalloc_memory_add_p(void *malloc_mem_ptr, size_t size, const char *file, const int line){
   ...
   if (((&genmalloc_memory_head)->slh_first == ((void*)0))) do { (&genmalloc_memory_head)->slh_first = ((void*)0); } while ( 0);
   ...
   if (0) printf("GENMALLOC_MEMORY_ADD: DEBUG -- malloc memory pointer is %p called from file %s line %d\n",malloc_mem_ptr,file,line);

   do { (genmalloc_memory_item)->genmalloc_memory_entries.sle_next = (&genmalloc_memory_head)->slh_first; (&genmalloc_memory_head)->slh_first = (genmalloc_memory_item); } while ( 0);
...
void genmalloc_memory_remove_p(void *malloc_mem_ptr, const char *file, const int line){
   ...
   for((genmalloc_memory_item) = (&genmalloc_memory_head)->slh_first; (genmalloc_memory_item); (genmalloc_memory_item) = (genmalloc_memory_item)->genmalloc_memory_entries.sle_next){
      if (genmalloc_memory_item->mem_ptr == malloc_mem_ptr) {
         if (0) printf("GENMALLOC_MEMORY_REMOVE: DEBUG -- freeing malloc memory pointer %p called from file %s line %d\n",malloc_mem_ptr,file,line);
         free(malloc_mem_ptr);
         do { if ((&genmalloc_memory_head)->slh_first == (genmalloc_memory_item)) { do { ((&genmalloc_memory_head))->slh_first = ((&genmalloc_memory_head))->slh_first->genmalloc_memory_entries.sle_next; } while ( 0); } else { struct genmalloc_memory_entry *curelm = (&genmalloc_memory_head)->slh_first; while(curelm->genmalloc_memory_entries.sle_next != (genmalloc_memory_item)) curelm = curelm->genmalloc_memory_entries.sle_next; curelm->genmalloc_memory_entries.sle_next = curelm->genmalloc_memory_entries.sle_next->genmalloc_memory_entries.sle_next; } } while ( 0);
...
void genmem_free_all_p(const char *file, const int line){
   ...
   while (!((&genmalloc_memory_head)->slh_first == ((void*)0))) {
      genmalloc_memory_item = ((&genmalloc_memory_head)->slh_first);
      if (0) printf("GENMEM_FREE_ALL: DEBUG -- freeing genmalloc memory %p called from file %s line %d\n",genmalloc_memory_item->mem_ptr,file,line);
      free(genmalloc_memory_item->mem_ptr);
      do { (&genmalloc_memory_head)->slh_first = (&genmalloc_memory_head)->slh_first->genmalloc_memory_entries.sle_next; } while ( 0);
      free(genmalloc_memory_item);
   }
}
