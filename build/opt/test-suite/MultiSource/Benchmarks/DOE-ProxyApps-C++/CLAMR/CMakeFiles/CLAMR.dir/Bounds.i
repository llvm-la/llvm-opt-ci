# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.c" 2
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.c"
...
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.h"
...
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.h" 2
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/Bounds.c" 2
...
void Bounds_Copy(TBounds* src, TBounds* dest) {
   ((void) (0));
   {memcpy((void*)dest, (void*)src, 1 * sizeof(TBounds)); };
}
...
void Bounds_AddBounds(TBounds* b, TBounds* add) {
   ((void) (0));
   b->min.x = ((b->min.x) < (add->min.x) ? (b->min.x) : (add->min.x));
   b->min.y = ((b->min.y) < (add->min.y) ? (b->min.y) : (add->min.y));
   b->max.x = ((b->max.x) > (add->max.x) ? (b->max.x) : (add->max.x));
   b->max.y = ((b->max.y) > (add->max.y) ? (b->max.y) : (add->max.y));
}
...
_Bool Bounds_IsOverlappingBounds(TBounds* b, TBounds* tst) {
   ((void) (0));
...
double Bounds_WidthAxis(TBounds* b, unsigned int axis)
{
   ...
   ((void) (0));
   if(axis == ((unsigned long)0))
      width = b->max.x - b->min.x;
   else if(axis == ((unsigned long)1))
