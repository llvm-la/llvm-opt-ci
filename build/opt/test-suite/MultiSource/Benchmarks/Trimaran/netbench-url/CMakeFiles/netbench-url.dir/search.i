# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c" 2
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c"
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c" 2
...
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c" 2
...
void db_init (char *);
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c" 2
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c" 2
...
{
  int i;
  int *returnval = (int *) malloc (sizeof(int) * 256);

  if (returnval == ((void*)0))
    _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 60, "Not enough virtual memory \n");
...
# 84 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c"
int
...
find_destination (char *packet, int packet_size)
{
      ...
      if ((boyer_moore (packet, packet_size, iterator->common_pattern, iterator->common_pattern_length, iterator->bm_table) != -1))
 {
  ...
  search_result = boyer_moore (packet, (packet_size > list->search_depth ? list->search_depth : packet_size), list->pattern, list->pattern_length, list->bm_table);
       ...
       if (search_result != -1)
  {
    ...
    if (list->type == log)
      fprintf (list->logto, "Source: %x Destination %x \n", (*(unsigned int *)&packet[12]), (*(unsigned int *)&packet[16]));
...
NewPatternNode (int chainno, nodetype type, char *pattern, int pattern_length, int search_depth)
{
  ...
  if ((returnval = (PatternNode *) malloc (sizeof (PatternNode))) == ((void*)0))
    _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 170, "Run out of virtual memory \n");

  returnval->chain_node_number = chainno;
  returnval->type = type;
  if ((returnval->pattern = (char *) malloc (pattern_length)) == ((void*)0))
    _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 175, "Not enough virtual memory \n");
...
NewStrTreeNode (int chainno, char *pattern, int pattern_length)
{
  ...
  if ((returnval = (StrTreeNode *) malloc (sizeof (StrTreeNode))) == ((void*)0))
    _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 190, "Run out of virtual memory \n");

  returnval->chain_node_number = chainno;
  if ((returnval->common_pattern = (char *) malloc (pattern_length)) == ((void*)0))
    _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 194, "Not enough virtual memory \n");
...
# 212 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c"
char *
find_lcs (char *largepattern, int largepatternsize, char *smallpattern, int smallpatternsize, int *lcssize)
{
  char *sub_pattern = ((void*)0);
  char *exchanger;
  int sub_pat_size = 0;
...
insert_rule (char *pattern, int pattern_length, int depth)
{
  ...
  StrTreeNode *found_largestcommon = ((void*)0);
...
db_init (char *file_name)
{
  ...
  if ((pattern_file = fopen (file_name, "r")) == ((void*)0))
    _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 360, "Can not open the input file\n");


  while (fgets (line, 2048, pattern_file) != ((void*)0))
    {
      int value;
 ...
 case '2':
   ...
   break;
 default:
   _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 379, "unrecognized input line start: %c \n", line[0]);
 }

      if ((pattern = (char *) malloc (pattern_length + 1)) == ((void*)0))
 _fatal("/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/netbench-url/search.c", __FUNCTION__, 383, "Not enough virtual memory \n");
