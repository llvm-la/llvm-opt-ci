# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c"
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.h" 1
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.h"
typedef struct
{
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c" 2
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c"
void md5_starts( md5_context *ctx )
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
...
void md5_process( md5_context *ctx, unsigned char data[64] )
{
    ...
    { (X[0]) = ( (unsigned long int) (data)[(0) ] ) | ( (unsigned long int) (data)[(0) + 1] << 8 ) | ( (unsigned long int) (data)[(0) + 2] << 16 ) | ( (unsigned long int) (data)[(0) + 3] << 24 ); };
    { (X[1]) = ( (unsigned long int) (data)[(4) ] ) | ( (unsigned long int) (data)[(4) + 1] << 8 ) | ( (unsigned long int) (data)[(4) + 2] << 16 ) | ( (unsigned long int) (data)[(4) + 3] << 24 ); };
    { (X[2]) = ( (unsigned long int) (data)[(8) ] ) | ( (unsigned long int) (data)[(8) + 1] << 8 ) | ( (unsigned long int) (data)[(8) + 2] << 16 ) | ( (unsigned long int) (data)[(8) + 3] << 24 ); };
    { (X[3]) = ( (unsigned long int) (data)[(12) ] ) | ( (unsigned long int) (data)[(12) + 1] << 8 ) | ( (unsigned long int) (data)[(12) + 2] << 16 ) | ( (unsigned long int) (data)[(12) + 3] << 24 ); };
    { (X[4]) = ( (unsigned long int) (data)[(16) ] ) | ( (unsigned long int) (data)[(16) + 1] << 8 ) | ( (unsigned long int) (data)[(16) + 2] << 16 ) | ( (unsigned long int) (data)[(16) + 3] << 24 ); };
    { (X[5]) = ( (unsigned long int) (data)[(20) ] ) | ( (unsigned long int) (data)[(20) + 1] << 8 ) | ( (unsigned long int) (data)[(20) + 2] << 16 ) | ( (unsigned long int) (data)[(20) + 3] << 24 ); };
    { (X[6]) = ( (unsigned long int) (data)[(24) ] ) | ( (unsigned long int) (data)[(24) + 1] << 8 ) | ( (unsigned long int) (data)[(24) + 2] << 16 ) | ( (unsigned long int) (data)[(24) + 3] << 24 ); };
    { (X[7]) = ( (unsigned long int) (data)[(28) ] ) | ( (unsigned long int) (data)[(28) + 1] << 8 ) | ( (unsigned long int) (data)[(28) + 2] << 16 ) | ( (unsigned long int) (data)[(28) + 3] << 24 ); };
    { (X[8]) = ( (unsigned long int) (data)[(32) ] ) | ( (unsigned long int) (data)[(32) + 1] << 8 ) | ( (unsigned long int) (data)[(32) + 2] << 16 ) | ( (unsigned long int) (data)[(32) + 3] << 24 ); };
    { (X[9]) = ( (unsigned long int) (data)[(36) ] ) | ( (unsigned long int) (data)[(36) + 1] << 8 ) | ( (unsigned long int) (data)[(36) + 2] << 16 ) | ( (unsigned long int) (data)[(36) + 3] << 24 ); };
    { (X[10]) = ( (unsigned long int) (data)[(40) ] ) | ( (unsigned long int) (data)[(40) + 1] << 8 ) | ( (unsigned long int) (data)[(40) + 2] << 16 ) | ( (unsigned long int) (data)[(40) + 3] << 24 ); };
    { (X[11]) = ( (unsigned long int) (data)[(44) ] ) | ( (unsigned long int) (data)[(44) + 1] << 8 ) | ( (unsigned long int) (data)[(44) + 2] << 16 ) | ( (unsigned long int) (data)[(44) + 3] << 24 ); };
    { (X[12]) = ( (unsigned long int) (data)[(48) ] ) | ( (unsigned long int) (data)[(48) + 1] << 8 ) | ( (unsigned long int) (data)[(48) + 2] << 16 ) | ( (unsigned long int) (data)[(48) + 3] << 24 ); };
    { (X[13]) = ( (unsigned long int) (data)[(52) ] ) | ( (unsigned long int) (data)[(52) + 1] << 8 ) | ( (unsigned long int) (data)[(52) + 2] << 16 ) | ( (unsigned long int) (data)[(52) + 3] << 24 ); };
    { (X[14]) = ( (unsigned long int) (data)[(56) ] ) | ( (unsigned long int) (data)[(56) + 1] << 8 ) | ( (unsigned long int) (data)[(56) + 2] << 16 ) | ( (unsigned long int) (data)[(56) + 3] << 24 ); };
    { (X[15]) = ( (unsigned long int) (data)[(60) ] ) | ( (unsigned long int) (data)[(60) + 1] << 8 ) | ( (unsigned long int) (data)[(60) + 2] << 16 ) | ( (unsigned long int) (data)[(60) + 3] << 24 ); };
# 80 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
...
void md5_finish( md5_context *ctx, unsigned char digest[16] )
{
    ...
    { (msglen)[(0) ] = (unsigned char) ( (low) ); (msglen)[(0) + 1] = (unsigned char) ( (low) >> 8 ); (msglen)[(0) + 2] = (unsigned char) ( (low) >> 16 ); (msglen)[(0) + 3] = (unsigned char) ( (low) >> 24 ); };
    { (msglen)[(4) ] = (unsigned char) ( (high) ); (msglen)[(4) + 1] = (unsigned char) ( (high) >> 8 ); (msglen)[(4) + 2] = (unsigned char) ( (high) >> 16 ); (msglen)[(4) + 3] = (unsigned char) ( (high) >> 24 ); };
    ...
    { (digest)[(0) ] = (unsigned char) ( (ctx->state[0]) ); (digest)[(0) + 1] = (unsigned char) ( (ctx->state[0]) >> 8 ); (digest)[(0) + 2] = (unsigned char) ( (ctx->state[0]) >> 16 ); (digest)[(0) + 3] = (unsigned char) ( (ctx->state[0]) >> 24 ); };
    { (digest)[(4) ] = (unsigned char) ( (ctx->state[1]) ); (digest)[(4) + 1] = (unsigned char) ( (ctx->state[1]) >> 8 ); (digest)[(4) + 2] = (unsigned char) ( (ctx->state[1]) >> 16 ); (digest)[(4) + 3] = (unsigned char) ( (ctx->state[1]) >> 24 ); };
    { (digest)[(8) ] = (unsigned char) ( (ctx->state[2]) ); (digest)[(8) + 1] = (unsigned char) ( (ctx->state[2]) >> 8 ); (digest)[(8) + 2] = (unsigned char) ( (ctx->state[2]) >> 16 ); (digest)[(8) + 3] = (unsigned char) ( (ctx->state[2]) >> 24 ); };
    { (digest)[(12) ] = (unsigned char) ( (ctx->state[3]) ); (digest)[(12) + 1] = (unsigned char) ( (ctx->state[3]) >> 8 ); (digest)[(12) + 2] = (unsigned char) ( (ctx->state[3]) >> 16 ); (digest)[(12) + 3] = (unsigned char) ( (ctx->state[3]) >> 24 ); };
}
...
# 248 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c" 2
...
# 249 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Trimaran/enc-md5/md5.c" 2
