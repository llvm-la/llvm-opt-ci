# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c"
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
...
typedef int BOOLEAN;
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
...
extern void EXEC();
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct.h" 1
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/instruct.h"
extern void ADD_P();
...
extern void WD_P();
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/format.c" 2
...
{
  (*REG1) = INT(MEMORY[REGISTER[8]+1]) / 16;
  (*REG2) = INT(MEMORY[REGISTER[8]+1]) - (*REG1) * 16;
  REGISTER[8] += 2;
}
...
int FORMAT3_4(int DEMAND,int BYTES)
{
  ...
  if (REGISTER[8]+2 >= 1048576) RANGE_ERROR = 1;
    else {
      BYTES_TO_BITS(INT(MEMORY[REGISTER[8]]),1,INSTR);
      BYTES_TO_BITS(INT(MEMORY[REGISTER[8]+1]),1,&(INSTR[8]));
      BYTES_TO_BITS(INT(MEMORY[REGISTER[8]+2]),1,&(INSTR[16]));


      if ((INSTR[11] == 1) && !((INSTR[6] == 0) && (INSTR[7] == 0)))
 if (REGISTER[8]+3 >= 1048576) RANGE_ERROR = 1;
 else {
   BYTES_TO_BITS(INT(MEMORY[REGISTER[8]+3]),1,&(INSTR[24]));
   FORMAT = 4;
 }
    }
  ...
  if ((INSTR[6] == 0) && (INSTR[7] == 0))
    ...
    if (INSTR[8] == 1) ADDRESS += REGISTER[1];
    if (INSTR[9] == 1) ADDRESS += REGISTER[3];
    if (INSTR[10] == 1) {
      if (ADDRESS >= 4096 / 2)
 ADDRESS = (ADDRESS - 4096) + REGISTER[8];
 else ADDRESS += REGISTER[8];
    }
  } else {
 ...
 return (0);
  ...
  if ((INSTR[6] == 1) && (INSTR[7] == 1)) {
    ...
    if (DEMAND == 1) {
      ...
      if ((ADDRESS < 0) || (ADDRESS+2 >= 1048576)) {
 SIGNAL_INTERUPT(2,00);
 return (0);
      }
 ...
 VALUE = VALUE * 256 + INT(MEMORY[ADDRESS + I]);
      ...
      if (VALUE >= (int) pow(2.0,24*1.0)) VALUE = 0;
      return VALUE;
    } else return ADDRESS;
  }
