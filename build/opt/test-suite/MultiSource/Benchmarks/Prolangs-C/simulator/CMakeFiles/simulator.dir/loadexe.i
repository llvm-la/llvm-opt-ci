# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
typedef int BOOLEAN;
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
extern void EXEC();
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/loadexe.c" 2
...
void LOAD(BOOLEAN DEBUG_MODE,int *ERROR,FILE *INPUT)
{
  ...
  if (feof(INPUT)) (*ERROR) = 1;
    ...
    if ((RECORD[0] != 'S') || (strlen(RECORD) != 14)) (*ERROR) = 1;
    else {

      if (DEBUG_MODE) {
 MAIN_ROUTINE[8] = '\0';
 (void) strncpy(MAIN_ROUTINE,&(RECORD[1]),8);
      }
      STR_TO_NUM(&(RECORD[8 +1]), 5, 16,
   &START_ADDRESS,ERROR);
    }
  }

  while (!feof(INPUT) && (LOCATION <= 1048576) && !(*ERROR)) {
 ...
 if (strlen(RECORD) != 9+LENGTH*2) (*ERROR) = 1;
    ...
    case 'M':
      ...
      if (strlen(RECORD) != (13 + 8)) (*ERROR) = 1;
      else if (DEBUG_MODE) {

 (void) strncpy(MODULE_NAME,&(RECORD[1]),8);
 STR_TO_NUM(&(RECORD[9]),6,16,&LOCATION,ERROR);
 (*ERROR) = !INSERT_IN_SYM_TAB("_GLOBAL ",MODULE_NAME,LOCATION,MODULE,
     &SYM_TAB);
 STR_TO_NUM(&(RECORD[15]),6,16,&LENGTH,ERROR);
 (*LOOK_UP_SYMBOL("_GLOBAL ",MODULE_NAME,&SYM_TAB)).LENGTH = LENGTH;
      }
    ...
    case 'G':
      ...
      if (strlen(RECORD) != (7 + 8)) (*ERROR) = 1;
      else if (DEBUG_MODE) {

 (void) strncpy(MODULE_NAME,&(RECORD[1]),8);
 STR_TO_NUM(&(RECORD[9]),6,16,&LOCATION,ERROR);
 (*ERROR) = !INSERT_IN_SYM_TAB("_GLOBAL ",MODULE_NAME,LOCATION,GLOBAL,
     &SYM_TAB);
      }
