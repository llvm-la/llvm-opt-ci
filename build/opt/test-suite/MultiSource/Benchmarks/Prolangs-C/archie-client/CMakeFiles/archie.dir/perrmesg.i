# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/perrmesg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/perrmesg.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/perrmesg.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/perrmesg.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/perrmesg.c" 2



int perrno = 0;
int pwarn = 0;
char p_err_string[100];
char p_warn_string[100];

char *p_err_text[256] = {
              "Success (prospero)",
              "Port unknown (dirsend)",
              "Can't open local UDP port (dirsend)",
              "Can't resolve hostname (dirsend)",
              "Unable to send entire message (dirsend)",
              "Timed out (dirsend)",
              "Recvfrom failed (dirsend)",
              "", "", "", "",
              "Sendto failed (reply)",
              "", "", "", "",
              "", "", "", "",
              "",
              "Link already exists (vl_insert)",
              "Link with same name already exists (vl_insert)",
              "", "",
              "Link already exists (ul_insert)",
              "Replacing existing link (ul_insert)",
              "Previous entry not found in dir->ulinks (ul_insert)",
              "", "", "", "",
              "", "", "", "",
              "", "", "", "",
              "",
              "Temporary not found (rd_vdir)",
              "Namespace not closed with object (rd_vdir)",
              "Alias for namespace not defined (rd_vdir)",
              "Specified namespace not found (rd_vdir)",
              "", "", "", "",
              "", "",
              "File access method not supported (pfs_access)",
              "", "", "",
              "Pointer to cached copy - delete on close (pmap_cache)",
              "Unable to retrieve file (pmap_cache)",
              "", "", "", "",
              "Directory already exists (mk_vdir)",
              "Link with same name already exists (mk_vdir)",
              "", "",
              "Not a virtual system (vfsetenv)",
              "Can't find directory (vfsetenv)",
              "", "", "", "",
              "Link already exists (add_vlink)",
              "Link with same name already exists (add_vlink)",
              "", "", "", "",
              "", "", "", "",
              "", "", "", "",
              "", "", "", "",
              ...
              "", "", "", "",
              "",
              "File not found (prospero)",
              "Directory not found (prospero)",
              "Symbolic links nested too deep (prospero)",
              "Environment not initialized - source vfsetup.source then run vfsetup",
              "Can't traverse an external file (prospero)",
              "Forwarding chain is too long (prospero)",
              "", "", "", "",
              "", "",
              "Authentication required (prospero server)",
              "Not authorized (prospero server)",
              "Not found (prospero server)",
              "Bad version number (prospero server)",
              "Not a directory (prospero server)",
              "Already exists (prospero server)",
              "Link with same name already exists (prospero server)",
              "", "",
              "Command not implemented on server (dirsrv)",
              "Bad format for response (dirsrv)",
              "Protocol error (prospero server)",
              "Unspecified server failure (prospero server)",
              "Generic Failure (prospero)"};

char *p_warn_text[256] = {
              "No warning",
              "You are using an old version of this program",
              "From server",
              "Unrecognized line in response from server",
              "", "", "", "", "", "", "", "", "", "", "", "", "",
  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
