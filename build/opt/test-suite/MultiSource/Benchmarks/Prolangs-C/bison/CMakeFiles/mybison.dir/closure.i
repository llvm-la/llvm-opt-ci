# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/closure.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/closure.c" 2
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/closure.c"
...
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/closure.c" 2
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/closure.c" 2
...
# 54 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/closure.c" 2
...
# 55 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/closure.c" 2
...
{
  itemset = ((short *) mallocate((unsigned) ((n) * sizeof(short))));

  rulesetsize = (((nrules + 1) + 31) / 32);
  ruleset = ((unsigned *) mallocate((unsigned) ((rulesetsize) * sizeof(unsigned))));
...
void set_fderives(void)
{
  ...
  fderives = ((unsigned *) mallocate((unsigned) ((nvars * rulesetsize) * sizeof(unsigned)))) - ntokens * rulesetsize;
...
void set_firsts(void)
{
  ...
  varsetsize = rowsize = (((nvars) + 31) / 32);

  firsts = ((unsigned *) mallocate((unsigned) ((nvars * rowsize) * sizeof(unsigned))));
...
{
  {if (itemset) free(itemset);};
  {if (ruleset) free(ruleset);};
  {if (fderives + ntokens * rulesetsize) free(fderives + ntokens * rulesetsize);};
}
