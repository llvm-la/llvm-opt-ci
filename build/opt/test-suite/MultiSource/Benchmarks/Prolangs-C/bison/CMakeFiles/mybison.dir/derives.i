# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c" 2
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c"
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c" 2
...
typedef
  ...
  shorts;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/derives.c" 2
...
void set_derives(void)
{
  ...
  dset = ((shorts * *) mallocate((unsigned) ((nvars) * sizeof(shorts *)))) - ntokens;
  delts = ((shorts *) mallocate((unsigned) ((nrules + 1) * sizeof(shorts))));
  ...
  derives = ((short * *) mallocate((unsigned) ((nvars) * sizeof(short *)))) - ntokens;
  q = ((short *) mallocate((unsigned) ((nvars + nrules) * sizeof(short))));
      ...
      while (p)
 {
  ...
  {if (dset + ntokens) free(dset + ntokens);};
  {if (delts) free(delts);};
}
...
{
  {if (derives[ntokens]) free(derives[ntokens]);};
  {if (derives + ntokens) free(derives + ntokens);};
}
