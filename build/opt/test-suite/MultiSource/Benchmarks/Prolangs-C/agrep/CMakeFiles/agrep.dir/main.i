# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/agrep.h" 1
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/agrep.h" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/agrep.h" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/re.h" 1
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/re.h"
typedef struct {
     char low_bd, hi_bd;
 } *Ch_Range;

typedef struct ch_set {
     Ch_Range elt;
     struct ch_set *rest;
 } *Ch_Set;
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/agrep.h" 2
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/checkfile.h" 1
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/main.c" 2


unsigned Mask[256];
unsigned Init1, NO_ERR_MASK, Init[8];
unsigned Bit[32 +1];
unsigned char buffer[49152 +1024 +1];
unsigned Next[66000], Next1[66000];
...
unsigned char **Textfiles;
unsigned char old_D_pat[16] = "\n";
unsigned char CurrentFileName[256];
unsigned char Progname[256];
unsigned char D_pattern[16] = "\n; ";
...
extern void sgrep(unsigned char *pat, int m, int fd, int D);
extern void preprocess(unsigned char *D_pattern, unsigned char *Pattern);
...
void r_output(unsigned char *buffer, int i, int end, int j);
void file_out(char *fname);
void usage(void);
void checksg(unsigned char *Pattern, int D);
void output(register unsigned char *buffer, int i1, int i2, int j);
...
int main(int argc, char *argv[])
{
  ...
  char c;
  int filetype;
  unsigned char Pattern[128], OldPattern[128];
  ...
  while(--argc > 0 && (*++argv)[0] == '-') {
   ...
   exit(2);
       ...
       case 'd' : DELIMITER = 1;
                  ...
                  if (argv[0][2] == '\0') {
                    ...
                    if ((D_length = strlen(argv[0]+2)) > 16) {
                      fprintf(stderr, "%s: delimiter pattern too long\n", Progname);
                      exit(2);
                    }
                    D_pattern[0] = '<';
   ...
   exit(2);
       ...
       case 'y' : NOPROMPT = 1;
    break;
       case 'I' : I = atoi(argv[0]+2);
           JUMP = 1;
                  break;
       case 'S' : S = atoi(argv[0]+2);
                  JUMP = 1;
                  break;
       case 'D' : DD = atoi(argv[0]+2);
                  JUMP = 1;
                  break;
       case 'G' : FILEOUT = 1;
    COUNT = 1;
    break;
       default : if (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISdigit)) {
      APPROX = 1;
                    D = atoi(argv[0]+1);
                    if (D > 8) {
  ...
  if (argc == 0)
    ...
    if (!(Textfiles = (unsigned char **)malloc(argc * sizeof(unsigned char *) ))) {
    ...
    while (argc--) {
      ...
      if ((filetype = check_file(*argv)) == -3) {
 if(filetype == -3) fprintf(stderr,"%s: %s: no such file or directory\n",Progname,*argv);
        argv++;
      } else {
        if (!(Textfiles[Numfiles] = (unsigned char *)malloc((strlen(*argv)+1)))) {
          fprintf(stderr, "%s: malloc failure (you probably don't have enough memory)\n", Progname);
          exit(2);
        }
 ...
 COUNT=1; D=1;
 while(D<M && D<=8 && num_of_matched == 0) {
...
void initial_value(void)
{
   ...
   FIRST_IN_RE = NOMATCH = FIRSTOUTPUT = 1;
   I = DD = S = 1;
   HEAD = TAIL = 1;
   D_length = 2;
   ...
   Bit[32] = 1;
   for (i = 32 - 1; i > 0 ; i--) Bit[i] = Bit[i+1] << 1;
...
void compute_next(int M, unsigned *Next, unsigned *Next1)
{
  ...
  if(M <= 15)
  {
    ...
    { n = i;
        ...
        for(j=M; j>=1; j--)
        {
           if(n & Bit[32]) Next[i] = Next[i] | V[j];
           n = (n>>1);
        }
    }
    return;
  }
  if(M > 30) fprintf(stderr, "%s: regular expression too long\n", Progname);
  MM = M;
  if(M & 1) M=M+1;
  k = exponen(M/2);
  pp = 2*k;
  ...
  { n = i;
        ...
        for(j=MM; j>mid ; j--)
        {
           if(n & Bit[32]) Next[i] = Next[i] | V[j-mid];
           n = (n>>1);
        }
        n=i-k;
        Next1[i-k] = 0;
        for(j = 0; j<mid; j++)
        {
           if(n & Bit[32]) Next1[i-k] = Next1[i-k] | V[MM-j];
           n = (n>>1);
        }
  }
  return;
...
void re1(int Text, int M, int D)
{
  ...
  register unsigned hh, LL=0, k;
  int FIRST_TIME=1, num_read , j=0, base;
  unsigned A[4 +1], B[4 +1];
  unsigned Next[66000], Next1[66000];
  unsigned char buffer[49152 +1024 +1];
  int FIRST_LOOP = 1;
  ...
  base = 32 - M;
  hh = M/2;
  for(i=32, j=0; j < hh ; i--, j++) LL = LL | Bit[i];
  ...
  if ( D == 0 )
  {
    while ((num_read = read(Text, buffer + 1024, 49152)) > 0)
    {
      i=1024; end = num_read + 1024;
      if((num_read < 49152) && buffer[end-1] != '\n') buffer[end] = '\n';
      if(FIRST_LOOP) {
        buffer[i-1] = '\n';
 i--;
        FIRST_LOOP = 0;
      ...
      while ( i < end )
      {
        ...
        { if(CMask != 0) {
              ...
              r1 = Init1 & r3;
              r2 = ((Next[r3>>hh] | Next1[r3&LL]) & CMask) | r1;
              if(TAIL) r2 = (Next[r2>>hh] | Next1[r2&LL]) | r2;
              if(( r2 & 1 ) ^ INVERSE) {
                   if(FILENAMEONLY) {
                          num_of_matched++;
                          printf("%s\n", CurrentFileName);
      ...
      strncpy(buffer, buffer+num_read, 1024);
    }
  return;
  }
  while ((num_read = read(Text, buffer + 1024, 49152)) > 0)
  {
    i=1024; end = 1024 + num_read;
    if((num_read < 49152) && buffer[end-1] != '\n') buffer[end] = '\n';
    if(FIRST_TIME) {
        buffer[i-1] = '\n';
 i--;
...
void re(int Text, int M, int D)
{
  ...
  if(FIRST_IN_RE) {
         ...
         FIRST_IN_RE = 0; }
  for(i=0; i< 256; i++) RMask[i] = Mask[i];
  r_NO_ERR = NO_ERR_MASK;
  Newline = '\n';
  lasti = 1024;
  Init0 = Init[0] = Bit[base];
  if(HEAD) Init0 = Init[0] = Init0 | Bit[base+1] ;
  for(i=1; i<= D; i++) Init[i] = Init[i-1] | Next[Init[i-1]];
  Init1 = Init0 | 1;
  r2 = r3 = Init0;
  ...
  i--;
      ...
      while (i < end)
      {
        ...
        if(c != Newline)
        {
              ...
              lasti = i - 1;
              r2 = Init0;
              r3 = (Next[r2] & CMask) | Init0;
        }
      }
      ResidueSize = 1024 + num_read - lasti;
      if(ResidueSize > 1024) {
           ResidueSize = 1024; }
      strncpy(buffer+1024 -ResidueSize, buffer+lasti, ResidueSize);
      lasti = 1024 - ResidueSize;
    }
  return;
  }
  while ((num_read = read(Text, buffer + 1024, 49152)) > 0)
...
void checksg(unsigned char *Pattern, int D)
{
  ...
  if (CONSTANT) SIMPLEPATTERN = 1;
  if (SIMPLEPATTERN == 0) return;
  if (NOUPPER && D) return;
  if (JUMP == 1) return;
  if (I == 0) return;
  if (LINENUM) return;
...
void output(register unsigned char *buffer, int i1, int i2, int j)
{
register unsigned char *bp, *outend;
 if(i1 > i2) return;
        num_of_matched++;
        if(COUNT) return;
        if(SILENT) return;
 if(OUTTAIL) {
    ...
    printf("\n");
        ...
        if(FNAME == 1) printf("%s: ", CurrentFileName);
