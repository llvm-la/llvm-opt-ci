# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/utilities.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/utilities.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/utilities.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/utilities.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/utilities.c" 2
...
Stack Push(Stack *s, Re_node v)
{
    ...
    if (s == ((void*)0) || node == ((void*)0)) return ((void*)0);
    node->next = *s;
    node->val = v;
    if (*s == ((void*)0)) node->size = 1;
...
Pset pset_union(Pset s1, Pset s2)
{
    ...
    hd = ((void*)0); curr = ((void*)0);
    while (s1 != ((void*)0)) {
 if (!occurs_in(s1->posnum, s2)) {
     new1 = (Pset) malloc(sizeof(*new1));
     if (new1 == ((void*)0)) return ((void*)0);
     new1->posnum = s1->posnum;
     if (hd == ((void*)0)) hd = new1;
...
int subset_pset(Pset s1, Pset s2)
{
    ...
    while (s1 != ((void*)0) && subs != 0) {
 subs = 0;
 while (s2 != ((void*)0) && subs != 1)
