# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/bitap.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/bitap.c" 2
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/bitap.c"
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/bitap.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/bitap.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/bitap.c" 2
...
extern void asearch(unsigned char old_D_pat[], int text, register unsigned D);
extern int fill_buf(int fd, unsigned char *buf, int record_size);
extern void output(register unsigned char *buffer, int i1, int i2, int j);
...
char buffer[49152 +49152 +49152];
  ...
  while ((num_read = fill_buf(fd, buffer + 49152, 49152)) > 0)
  {
    i=49152; end = 49152 + num_read;
    if(FIRSTROUND) { i = 49152 - 1 ;

   if(DELIMITER) {
    for(k=0; k<D_length; k++) {
     if(old_D_pat[k] != buffer[49152 +k]) break;
    }
    if(k>=D_length) j--;
   }
                      ...
                      FIRSTROUND = 0; }
    if(num_read < 49152) {
                      strncpy(buffer+49152 +num_read, old_D_pat, D_length);
                      end = end + D_length;
                      buffer[end] = '\0';
    }
    while (i < end)
    ...
    ResidueSize = num_read + 49152 - lasti;
    if(ResidueSize > 49152) {
            ResidueSize = 49152;
            TRUNCATE = 1;
    }
    strncpy(buffer+49152 -ResidueSize, buffer+lasti, ResidueSize);
    lasti = 49152 - ResidueSize;
    if(lasti < 0) {
       lasti = 1;
    }
  }
