# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c"
...
void mk_followpos_1(Re_node e, Pset_array fpos)
{
 ...
 case 2:
     ...
     while (pos != ((void*)0)) {
  i = pos->posnum;
  (*fpos)[i] = pset_union((e->firstposn), (*fpos)[i]);
  pos = pos->nextpos;
     }
     mk_followpos_1(((e->refs).child), fpos);
     break;
 case 5:
     pos = (((e->refs).children.l_child)->lastposn);
     while (pos != ((void*)0)) {
  i = pos->posnum;
  (*fpos)[i] = pset_union((((e->refs).children.r_child)->firstposn), (*fpos)[i]);
  pos = pos->nextpos;
     }
     mk_followpos_1(((e->refs).children.l_child), fpos);
     mk_followpos_1(((e->refs).children.r_child), fpos);
     break;
 case 4:
     mk_followpos_1(((e->refs).child), fpos);
     break;
...
Pset_array mk_followpos(Re_node tree, int npos)
{
    ...
    if (tree == ((void*)0) || npos < 0) return ((void*)0);
    fpos = (Pset_array) malloc((unsigned) (npos+1)*sizeof(Pset));
    if (fpos == ((void*)0)) return ((void*)0);
    for (i = 0; i <= npos; i++) (*fpos)[i] = ((void*)0);
    mk_followpos_1(tree, fpos);
    return fpos;
}
# 104 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c"
int init(char *s, int table[32][32])
{
    ...
    if ((e = parse(extend_re(s))) == ((void*)0)) return -1;
    if ((fpos = mk_followpos(e, pos_cnt)) == ((void*)0)) return -1;
...
# 140 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/follow.c"
    return (pos_cnt);
}
