# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/parse.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/parse.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/parse.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/parse.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/parse.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/parse.c"
Re_node mk_leaf(short opval, short type, char ch, Ch_Set cset)
{
    Re_node node; Re_Lit l;

    l = (Re_Lit) malloc(sizeof(*l));
    node = (Re_node) malloc(sizeof(*node));
    if (l == ((void*)0) || node == ((void*)0)) return ((void*)0);
    (l->l_type) = type;
    (l->pos) = pos_cnt++;
    if (type == 1) ((l->val).cset) = cset;
    else ((l->val).c) = ch;
    (node->op) = opval;
    ((node->refs).lit) = l;
    (node->nullable) = 0;
    (node->firstposn) = create_pos((l->pos));
    (node->lastposn) = (node->firstposn);
    return node;
}
...
Re_node parse_cset(char **s)
{
    ...
    if ((**s == '\0' || **s == ']')) return ((void*)0);
    curr_ptr = (Ch_Set) malloc(sizeof(*curr_ptr)); cs_ptr = curr_ptr;
    while (!(**s == '\0' || **s == ']')) {
        range = (Ch_Range)malloc(sizeof(*range));
 curr_ptr->elt = range;
 ch = *(*s)++;
 if (ch == '-') return ((void*)0);
 range->low_bd = ch;
 if (**s == '\0') return ((void*)0);
     ...
     (*s)++;
     if ((**s == '\0' || **s == '-' || **s == ']' || **s < ch)) return ((void*)0);
     else range->hi_bd = *(*s)++;
 }
 else range->hi_bd = ch;
 prev_ptr = curr_ptr;
 curr_ptr = (Ch_Set) malloc(sizeof(*curr_ptr));
 prev_ptr->rest = curr_ptr;
    };
    if (**s == ']') {
 prev_ptr->rest = ((void*)0);
 return mk_leaf(1, 1, '\0', cs_ptr);
    }
    else return ((void*)0);
}
...
Re_node parse_wildcard(void)
{
    ...
    r = (Ch_Range) malloc(sizeof(*r));
    r->low_bd = '\001';
    r->hi_bd = '\177';
    s = (Ch_Set) malloc(sizeof(*s));
    s->elt = r;
    s->rest = ((void*)0);
    return mk_leaf(1, 1, '\0', s);
}
...
{
    if (ch == '\0') return ((void*)0);
    else return mk_leaf(1, 0, ch, ((void*)0));
}
# 127 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/parse.c"
Tok_node get_token(char **s)
{
    Tok_node rn = ((void*)0);

    if (s == ((void*)0) || *s == ((void*)0)) return ((void*)0);
    rn = (Tok_node) malloc(sizeof(*rn));
    if (**s == '\0') (rn->type) = 0;
    else {
 switch (**s) {
     case '.':
  (rn->type) = 1;
  (rn->val) = parse_wildcard();
  if ((rn->val) == ((void*)0)) return ((void*)0);
  break;
     case '[':
  (*s)++;
  (rn->type) = 1;
...
Stack cat2(Stack *stk)
{
    ...
    if (stk == ((void*)0)) return ((void*)0);
    if (*stk == ((void*)0) || (*stk)->next == ((void*)0)) return *stk;
    r = (Re_node) malloc(sizeof(*r));
    if (r == ((void*)0)) return ((void*)0);
    (r->op) = 5;
    ((r->refs).children.r_child) = Pop(stk);
    ((r->refs).children.l_child) = Pop(stk);
    if (Push(stk, r) == ((void*)0)) return ((void*)0);
    (r->nullable) = (((r->refs).children.l_child)->nullable) && (((r->refs).children.r_child)->nullable);
    if ((((r->refs).children.l_child)->nullable))
 (r->firstposn) = pset_union((((r->refs).children.l_child)->firstposn), (((r->refs).children.r_child)->firstposn));
    else (r->firstposn) = (((r->refs).children.l_child)->firstposn);
    if ((((r->refs).children.r_child)->nullable))
 (r->lastposn) = pset_union((((r->refs).children.l_child)->lastposn), (((r->refs).children.r_child)->lastposn));
    else (r->lastposn) = (((r->refs).children.r_child)->lastposn);
    return *stk;
}
...
Stack wrap(Stack *s, short opv)
{
    ...
    (r->op) = opv;
    ((r->refs).child) = Pop(s);
    if (Push(s, r) == ((void*)0)) return ((void*)0);
    (r->nullable) = 1;
    (r->firstposn) = (((r->refs).child)->firstposn);
    (r->lastposn) = (((r->refs).child)->lastposn);
    return *s;
}
...
Stack mk_alt(Stack *s, Re_node r)
{
    ...
    if (s == ((void*)0) || *s == ((void*)0) || r == ((void*)0)) return ((void*)0);
    node = (Re_node) malloc(sizeof(*node));
    if (node == ((void*)0)) return ((void*)0);
    (node->op) = 3;
    ((node->refs).children.l_child) = Pop(s);
    ((node->refs).children.r_child) = r;
    if (Push(s, node) == ((void*)0)) return ((void*)0);
    (node->nullable) = (((node->refs).children.l_child)->nullable) || (((node->refs).children.r_child)->nullable);
    (node->firstposn) = pset_union((((node->refs).children.l_child)->firstposn), (((node->refs).children.r_child)->firstposn));
    (node->lastposn) = pset_union((((node->refs).children.l_child)->lastposn), (((node->refs).children.r_child)->lastposn));
    return *s;
}
...
Re_node parse_re(char **s, short end)
{
 ...
 if (next_token == ((void*)0)) return ((void*)0);
 switch ((next_token->type)) {
     case 7:
  --(*s);
     case 0:
  if (end == (next_token->type)) return Top(cat2(&stk));
  else return ((void*)0);
     case 6:
  re = parse_re(s, 7);
  if (Push(&stk, re) == ((void*)0)) return ((void*)0);
  if ((get_token(s)->type) != 7 || re == ((void*)0)) return ((void*)0);
  if (Size(stk) > 2) {
      temp = stk->next;
      stk->next = cat2(&temp);
      if (stk->next == ((void*)0)) return ((void*)0);
      else stk->size = stk->next->size + 1;
  }
  break;
     case 2:
  if (wrap(&stk, 2) == ((void*)0)) return ((void*)0);
  break;
     case 4:
  if (wrap(&stk, 4) == ((void*)0)) return ((void*)0);
         break;
     case 3:
  if (cat2(&stk) == ((void*)0)) return ((void*)0);
  re = parse_re(s, end);
         if (re == ((void*)0)) return ((void*)0);
  if (mk_alt(&stk, re) == ((void*)0)) return ((void*)0);
  break;
     case 1:
  if (Push(&stk, (next_token->val)) == ((void*)0)) return ((void*)0);
  if (Size(stk) > 2) {
      temp = stk->next;
      stk->next = cat2(&temp);
      if (stk->next == ((void*)0)) return ((void*)0);
...
Re_node parse(char *s)
{
    ...
    tree = parse_re(&s, '\0');
    if (tree == ((void*)0) || Push(&stk, tree) == ((void*)0)) return ((void*)0);
    temp = mk_leaf(0, 0, '\0', ((void*)0));
    if (temp == ((void*)0) || Push(&stk, temp) == ((void*)0)) return ((void*)0);
    final_pos = --pos_cnt;
    return Top(cat2(&stk));
}
