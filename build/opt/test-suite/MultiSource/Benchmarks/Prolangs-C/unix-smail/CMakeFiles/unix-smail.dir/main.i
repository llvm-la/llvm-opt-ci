# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c"
static char *sccsid="@(#)main.c	2.5 (smail) 9/15/87";
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c"
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c" 2

int unix_smail_getopt();

int exitstat = 0;

enum edebug debug = NO;
enum ehandle handle = ALL;
enum erouting routing = JUSTDOMAIN;

char hostname[512] = "";
char hostdomain[512] = "";
char hostuucp[512] = "";

char *pathfile = "/usr/lib/uucp/paths";
char *uuxargs = ((void*)0);
...
int build();
int deliver();
# 103 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/main.c"
int main(int argc,char *argv[])
{
 char *hostv[500];
 char *userv[500];
 int costv[500];
 enum eform formv[500];
 char *p;
 int c;
 int printaddr = 0;
 int nargc;
 ...
 while ((c = unix_smail_getopt(argc, argv, optstr)) != (-1)) {
  switch ( c ) {
  ...
  case 'm': if(((*__ctype_b_loc ())[(int) ((*optarg))] & (unsigned short int) _ISdigit)) {
      maxnoqueue = atoi(optarg);
     }
     break;
  case 'c': getcost = 1; break;
  case 'q': if(((*__ctype_b_loc ())[(int) ((*optarg))] & (unsigned short int) _ISdigit)) {
      queuecost = atoi(optarg);
     }
     break;
  default:
   { (void) fprintf(stderr, "valid flags are %s\n", optstr); exit(64); };
  }
 }
