# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c" 2
...
extern int fgetpwent_r (FILE *__restrict __stream,
   ...
   struct passwd **__restrict __result)
    __attribute__ ((__nonnull__ (1, 2, 3, 5)))
                                          ;
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/defs.h" 1
# 282 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/defs.h"
enum eform {
 ERROR,
 LOCAL,
 DOMAIN,
...
# 316 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/defs.h"
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 317 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/defs.h" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/sysexits.h" 1
# 318 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/defs.h" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c" 2
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c" 2

extern enum edebug debug;
extern char hostdomain[];
extern char hostname[];
extern char *aliasfile;
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
...
static node aliases = {"", 0, 0};
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
static int nargc = 0;
static char *nargv[500];
...
char **alias(int *pargc,char **argv)
{
 ...
 while((nargc < 500) && ((u = pop(addr)) != ((node *) 0))) {
...
# 169 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
  user = ((*ubuf != '\\') ? (ubuf) : (ubuf+1));

  (void) strcpy(u->string, user);
# 189 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
  if(((a = v_search(user)) != ((node *) 0))) {
   char dtmpb[512], utmpb[512], *ut;
   int user_inalias = 0;
   node *t = a;

   for(a = a->horz; a != ((node *) 0); a=a->horz) {
  ...
  if((home = tilde(user)) != ((void*)0)) {




   if((h_search(flist, home) != ((void*)0))) {
    continue;
   }
   add_horz(flist, home);
...
# 263 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
  {
   static char t_dom[512], t_unam[512];
   char *t_user = res_fname(user);
   if (t_user != ((void*)0)) {
    if(islocal(t_user, t_dom, t_unam) == 0) {

     add_horz(addr, t_user);
     continue;
    }
    if(strcmp(t_unam, user) != 0) {

     add_horz(addr, t_unam);
     continue;
    }
   }
  }
...
aliasing_complete:
  user = ((*u->string != '\\') ? (u->string) : (u->string+1));
  for(i=0; i < nargc; i++) {
...
node *v_search(char *user)
{
 ...
 for(a = head->vert; a != ((node *) 0); a = a->vert) {
...
{
 node *a;
 for(a = head->horz; a != ((node *) 0); a = a->horz) {
...
# 359 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
void load_alias(node *head,char *filename)
{
 FILE *fp;
 node *v, *h, *add_vert();
 char domain[512], user[512];
 char *p, *b, buf[512];

 if((fp = fopen(filename,"r")) == ((void*)0)) {
if (debug==YES) (void) printf("load_alias open('%s') failed\n", filename);
  return;
 }
...
if (debug==YES) (void) printf("load_alias '%s' includes file '%s'\n", filename, p);
   load_alias(head, p);
   continue;
  }
   ...
   *p++ = ('\0');
   ...
   if((h = add_vert(head, user)) == ((node *) 0)) {
if (debug==YES) (void) printf("load_alias for '%s' failed\n", b);
    return;
   }
  }
 ...
 for(v = head; v->vert != ((node *) 0); ) {
  if(v->vert->horz == ((node *) 0)) {
   v->vert = v->vert->vert;
  } else {
   v = v->vert;
  }
...
# 492 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/alias.c"
...
node *add_vert(node *head,char *str)
{
 ...
 if((new = (node *) malloc(sizeof(node))) != ((node *) 0)) {
  if((new->string = malloc((unsigned) strlen(str)+1)) == ((void*)0)) {
   free(new);
   new = ((node *) 0);
  } else {
