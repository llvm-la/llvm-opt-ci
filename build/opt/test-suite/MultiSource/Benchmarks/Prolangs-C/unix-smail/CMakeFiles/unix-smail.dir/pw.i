# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
extern int fgetpwent_r (FILE *__restrict __stream,
   ...
   struct passwd **__restrict __result)
    __attribute__ ((__nonnull__ (1, 2, 3, 5)))
                                          ;
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c" 2
...
char *pwfnam(char *user)
{
 ...
 for(f=pwhead; f != ((void*)0); f=f->vlink) {
...
char *fullname(char *gecos)
{
 ...
 if (((*__ctype_b_loc ())[(int) ((*(cend = fname)))] & (unsigned short int) _ISdigit)) {
  if ((cend = strchr(fname, '-')) != ((void*)0))
   cend++;
  else
...
pwlist *pwparse(void)
{
 ...
 unsigned int i;
 static int pw_eof = 0;
# 147 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/pw.c"
  pw_eof = 1;
  return(((pwlist *) 0));
...
if (debug==YES) (void) printf("res_fname: looking for '%s'\n", user);

 if(pathlength == 0) {
  if((file=fopen(fnlist, "r")) == ((void*)0)) {
   if (debug==YES) (void) printf( "can't access %s.\n", fnlist);
   pathlength = -1;
  } else {
 ...
 for( ;; ) {
  ...
  if (pos != 0)
   while( ( c=getc( file ) ) != (-1) && c != '\n' );
  for( flag = 0, s = path; flag == 0; s++ ) {
   if ( *s == '\0' ) {
    goto solved;
   }
   c = getc( file );
   flag = ( ((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISupper) ? c-'A'+'a' : c ) - ( ((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISupper) ? *s-'A'+'a' : *s );
  }
  if (lo >= middle)
   return(((void*)0));
 ...
 *path = '\0';
 if((path = malloc((unsigned) strlen(namebuf)+1)) == ((void*)0)) {
  return(((void*)0));
 }
