# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getopt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getopt.c" 2
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getopt.c"
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getopt.c" 2
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/getopt.c"
...
int unix_smail_getopt(int argc,char **argv,char *opts)
{
 ...
 if(sp == 1)
  if(unix_smail_optind >= argc ||
   ...
   return((-1));
  else if(strcmp(argv[unix_smail_optind], "--") == ((void*)0)) {
   unix_smail_optind++;
   return((-1));
  }
 unix_smail_optopt = c = argv[unix_smail_optind][sp];
 if(c == ':' || (cp=strchr(opts, c)) == ((void*)0)) {
  if(unix_smail_opterr){ extern int write(); char errbuf[2]; errbuf[0] = c; errbuf[1] = '\n'; (void) write(2, argv[0], (unsigned)strlen(argv[0])); (void) write(2, ": illegal option -- ", (unsigned)strlen(": illegal option -- ")); (void) write(2, errbuf, 2);};
 ...
 if(*++cp == ':') {
  if(argv[unix_smail_optind][sp+1] != '\0')
   ...
   if(unix_smail_opterr){ extern int write(); char errbuf[2]; errbuf[0] = c; errbuf[1] = '\n'; (void) write(2, argv[0], (unsigned)strlen(argv[0])); (void) write(2, ": option requires an argument -- ", (unsigned)strlen(": option requires an argument -- ")); (void) write(2, errbuf, 2);};
   sp = 1;
   return('?');
  } else
