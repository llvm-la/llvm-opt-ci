# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t7.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t7.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t7.c" 2
...
for(c=0; c<ncol; c++)
 ...
 switch(ct=ctype(vforml,c))
  ...
  case 'l':
  case 'r':
      if (((ct=='a'||ct=='n') && table[ldata][c].rcol)? rused[c]: (used[c]+lused[c]))
   fprintf(tabout, "\\n(%du ",c+80);
   continue;
  case 's':
   if (lspan(lform, c))
