# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t5.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t5.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t5.c" 2
...
for (nlin=nslin=0; gets1(cstore); nlin++)
 ...
 fullbot[nlin]=0;
 if (cstore[0] == '.' && !((*__ctype_b_loc ())[(int) ((cstore[1]))] & (unsigned short int) _ISdigit))
  {
  instead[nlin] = cstore;
  while (*cstore++);
  continue;
