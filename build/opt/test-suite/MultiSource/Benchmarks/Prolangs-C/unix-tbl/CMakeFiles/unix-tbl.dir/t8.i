# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t8.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t8.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t8.c" 2
...
for(c=0; c<ncol; c++)
 ...
 if (form != 's')
  ...
  ct = c+40;
  if (form=='a') ct = c+60;
  if (form=='n' && table[nl][c].rcol && lused[c]==0) ct= c+60;
  fprintf(tabout, "\\h'|\\n(%du'", ct);
  }
 s= table[nl][c].col;
 ...
 if (((ct=='a'||ct=='n') && table[nl][c].rcol) ? rused[c]: used[c])
  {
...
for(c=0; c<ncol; c++)
 ...
 if (s==0) continue;
 fprintf(tabout, ".sp |\\n(##u-1v\n");
 fprintf(tabout, ".nr %d ", 37);
 for(pl=stl; pl>=0 && !((*__ctype_b_loc ())[(int) ((ct=ctype(pl,c)))] & (unsigned short int) _ISalpha); pl=prev(pl))
  ;
 switch (ct)
  {
  case 'n':
  case 'c':
   fprintf(tabout, "(\\n(%du+\\n(%du-\\n(%c-u)/2u\n",c+40,c-1+ctspan(lin,c)+80, s);
   break;
  case 'l':
   fprintf(tabout, "\\n(%du\n",c+40);
   break;
