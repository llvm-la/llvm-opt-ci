# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tv.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tv.c" 2
...
for(ln=0; ln<lwid; ln++)
 ...
 switch(interh(end, c))
  {
  case 3: epb -= 1; break;
  case 2: epb += (ln==0 ? 1 : -1); break;
  case 1: epb += (ln==1 ? 1 : -1); break;
  }
 if (lwid==1)
 switch(interh(end,c))
  {
  case 3: epb -= 1; break;
  case 2: case 1: epb += 1; break;
  }
 if (start>0)
  {
  sl = start-1;
 ...
 if (lwid>1)
  switch(interh(start,c))
   {
   case 3: ept += 1; break;
   case 1: ept += (ln==0 ? 1 : -1); break;
   case 2: ept += (ln==1 ? 1 : -1); break;
   }
 else if (lwid==1)
  switch(interh(start,c))
   {
   case 3: ept += 1; break;
   case 1: case 2: ept -= 1; break;
   }
 if (exb)
