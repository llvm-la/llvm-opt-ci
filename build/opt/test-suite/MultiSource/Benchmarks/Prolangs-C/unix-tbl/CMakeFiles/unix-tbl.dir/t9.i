# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t9.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t9.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t9.c" 2
static useln;
...
void yetmore(void)
{
for(useln=0; useln<200 && table[useln]==0; useln++);
if (useln>=200)
...
if (prefix(".TE", dataln))
 return(0);
if (dataln[0] == '.' && !((*__ctype_b_loc ())[(int) ((dataln[1]))] & (unsigned short int) _ISdigit))
 {
 puts(dataln);
 return(1);
 }
