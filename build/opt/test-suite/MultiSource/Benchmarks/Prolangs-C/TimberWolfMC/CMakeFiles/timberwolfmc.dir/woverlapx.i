# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/woverlapx.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/woverlapx.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/woverlapx.c" 2
...
endx01 = cellptr1->xcenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2;

starty01 = cellptr1->ycenter - Hdiv2 ;

val = (double)(tileptr01->otop - obottom) * aspFactor ;
endy01 = cellptr1->ycenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2;
...
for( i = 0 ; i <= highBinX ; i++ ) {
 ...
 for( k = 1 ; k <= occuptr[0] ; k++ ) {
  ...
  for( tileptr1 = tileptr01->nexttile ;
      ...
      startx1 = cellptr1->xcenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2 ;

      val = (double)(tileptr1->oright - oleft)/ aspFactor;
      endx1 = cellptr1->xcenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Wdiv2 ;

      val = (double)(tileptr1->obottom - obottom) *
           aspFactor;
      starty1 = cellptr1->ycenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2 ;

      val = (double)(tileptr1->otop - obottom)* aspFactor;
      endy1 = cellptr1->ycenter + ( ( (val) - (int)(val) ) >= 0.5 ? ((int)(val) + 1) : ((int)(val)) ) - Hdiv2 ;
