# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fixpenal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fixpenal.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fixpenal.c" 2
...
while( problems ) {
 ...
 if( other > 0 ) {
     d1 = (int) sqrt((double)((( (cellarray[cell]->xcenter - bx)>=0 ? (cellarray[cell]->xcenter - bx) : -(cellarray[cell]->xcenter - bx) ) *
         ( (cellarray[cell]->xcenter - bx)>=0 ? (cellarray[cell]->xcenter - bx) : -(cellarray[cell]->xcenter - bx) )) +
        (( (cellarray[cell]->ycenter - by)>=0 ? (cellarray[cell]->ycenter - by) : -(cellarray[cell]->ycenter - by) ) *
         ( (cellarray[cell]->ycenter - by)>=0 ? (cellarray[cell]->ycenter - by) : -(cellarray[cell]->ycenter - by) )) ) ) ;
     d2 = (int) sqrt((double)((( (cellarray[other]->xcenter - bx)>=0 ? (cellarray[other]->xcenter - bx) : -(cellarray[other]->xcenter - bx) ) *
         ( (cellarray[other]->xcenter - bx)>=0 ? (cellarray[other]->xcenter - bx) : -(cellarray[other]->xcenter - bx) )) +
        (( (cellarray[other]->ycenter - by)>=0 ? (cellarray[other]->ycenter - by) : -(cellarray[other]->ycenter - by) ) *
         ( (cellarray[other]->ycenter - by)>=0 ? (cellarray[other]->ycenter - by) : -(cellarray[other]->ycenter - by) )) ) ) ;
     if( dx == 0 ) {
  dx = 1000000 ;
     }
