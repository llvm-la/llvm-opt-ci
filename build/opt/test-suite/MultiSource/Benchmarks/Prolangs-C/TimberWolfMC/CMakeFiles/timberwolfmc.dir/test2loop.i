# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/test2loop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/test2loop.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/test2loop.c" 2
...
while( attempts < trials ) {
    do {
 a = (int) ( (double) numcells * ( (double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
        (double) 0x7fffffff ) ) + 1 ;
    } while( a == numcells + 1 ) ;
 ...
 xb = (int)((double)(rr - ll + 1) * ((double)((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
     (double) 0x7fffffff ) ) + ll ;
 yb = (int)((double)(tt - bb + 1) * ((double)((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
