# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/findnodes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/findnodes.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/findnodes.c" 2
...
last = -100000 ;
for( hptr = Hlist ; hptr != (DLINK1PTR) ((void*)0) ; hptr = hptr->next ) {
    hedge = hptr->edge ;
 ...
 continue ;
    ...
    vrloc = -100000 ;
    for( ; vlptr != (DLINK1PTR) ((void*)0); vlptr = vlptr->next ){
 vledge = vlptr->edge ;
 ...
 for( ; vrptr != (DLINK1PTR) ((void*)0); vrptr = vrptr->next ) {
     vredge = vrptr->edge ;
  ...
  if( edgeList[vredge].fixed == 1 && vrend == hloc ) {
     ...
     for( ; htptr != (DLINK1PTR) ((void*)0) ; htptr = htptr->next ) {
  htedge = htptr->edge ;
...
HRlist = (DLINK2PTR) ((void*)0) ;
VRlist = (DLINK2PTR) ((void*)0) ;
...
HRlist->index = index ;
HRlist->next = (DLINK2PTR) ((void*)0) ;
HRlist->prev = (DLINK2PTR) ((void*)0) ;

tpop( &vRectRoot , &junkptr , &center , &index ) ;
VRlist = (DLINK2PTR) malloc( sizeof( DLINK2 ) ) ;
VRlist->index = index ;
VRlist->next = (DLINK2PTR) ((void*)0) ;
VRlist->prev = (DLINK2PTR) ((void*)0) ;
...
LEroot = (TNODEPTR) ((void*)0) ;
LEptrs = (DLINK2PTR *) malloc( 100 * sizeof(DLINK2PTR) ) ;
count = 0 ;

last = -1000000 ;
for( leptr = HRlist ; leptr != (DLINK2PTR) ((void*)0) ; leptr = leptr->next ){
    index = leptr->index ;
...
BEroot = (TNODEPTR) ((void*)0) ;
BEptrs = (DLINK2PTR *) malloc( 100 * sizeof(DLINK2PTR) ) ;
count = 0 ;

last = -1000000 ;
for( beptr = VRlist ; beptr != (DLINK2PTR) ((void*)0) ; beptr = beptr->next ){
    index = beptr->index ;
