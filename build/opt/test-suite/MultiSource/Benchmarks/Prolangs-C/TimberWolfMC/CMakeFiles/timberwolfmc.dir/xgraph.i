# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/xgraph.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/xgraph.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/xgraph.c" 2
...
for( i = 0 ; i <= numberCells + 1 ; i++ ) {
    xNodules[i].inList = (FLAREPTR) ((void*)0) ;
    xNodules[i].outList = (FLAREPTR) ((void*)0) ;
    xNodules[i].done = 0 ;
}
vptr = Vlist ;
vedge = vptr->edge ;
...
for( ; vptr->next != (DLINK1PTR) ((void*)0) ; vptr = vptr->next ) {
    vedge = vptr->edge ;
...
for( cell = 1 ; cell <= numberCells ; cell++ ) {
 ...
 for( ; ofptr != (FLAREPTR) ((void*)0) ; ofptr = ofptr->next ) {
     ...
     xNodeArray[inode]->channels = (int *) ((void*)0) ;
...
if( vChanBeginRoot != (TNODEPTR) ((void*)0) ) {
    for( ; ; ) {
...
if( vChanEndRoot != (TNODEPTR) ((void*)0) ) {
    for( ; ; ) {
