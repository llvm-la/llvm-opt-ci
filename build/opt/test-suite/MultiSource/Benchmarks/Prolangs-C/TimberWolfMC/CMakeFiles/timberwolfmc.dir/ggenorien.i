# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/ggenorien.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/ggenorien.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/ggenorien.c" 2
extern int ecount ;
...
for( cell = 1 ; cell <= numcells + numpads ; cell++ ) {
 ...
 if( ptr->config[orient] == (TILEBOXPTR) ((void*)0) ) {
     continue ;
 }
 cptr = ptr->config[orient]->termptr ;
 ptr->config[orient]->termptr = (TERMBOXPTR) ((void*)0) ;
 if( cptr != (TERMBOXPTR) ((void*)0) ) {
     koptr = cptr ;
     while( cptr->nextterm != (TERMBOXPTR) ((void*)0) ) {
  cptr = cptr->nextterm ;
  free( koptr ) ;
  koptr = cptr ;
     }
 ...
 tmptr->nextterm = (TERMBOXPTR) ((void*)0) ;
...
for( net = 1 ; net <= numnets ; net++ ) {
    for( netptr = netarray[ net ]->netptr ; netptr != (NETBOXPTR) ((void*)0) ;
...
for( cell = 1 ; cell <= numcells + numpads ; cell++ ) {
 ...
 for( ; term != (TERMBOXPTR) ((void*)0) ; term = term->nextterm ) {
