# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c" 2


# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/route.h" 1
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/route.h" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.h" 1
...
PLISTPTR pfind() ;
PLISTPTR tplist() ;
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c" 2
...
for( i = 1 ; i <= count + 1 ; i++ ) {
    ...
    for( ; gptr != (GNODEPTR) ((void*)0) ; gptr = gptr->next ) {
 node1 = gptr->node ;
...
if( indexRoot != (TNODEPTR) ((void*)0) ) {
    for( ; ; ) {
 tpop( &indexRoot , &tptr , &i , &j ) ;
 if( tptr == (TNODEPTR) ((void*)0) ) {
     break ;
 }
    }
}
...
LIST2PTR lptr ;
# 212 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
...
# 226 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
    tinsert( &netRoot , pathLength , pathIndex ) ;
    treeSize++ ;
    return ;
}

extraRoot = (TNODEPTR) ((void*)0) ;
...
# 265 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
for( j = 1 ; j <= dsptr ; j++ ) {
    dnode = dslist[j] ;
...
# 284 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
...
if( attachPt > 0 ) {
 ...
 gptr = gptr1 ;
 while( gptr != (GNODEPTR) ((void*)0) ) {
     if( gptr->node == node2 ) {
  gptr->cost = 1000000000 ;
  break ;
     }
     gptr = gptr->next ;
 }
...
for( extraS = 1 ; extraS <= EXTRASOURCES ; extraS++ ) {
 ...
 for( j = 1 ; j <= targetPtr ; j++ ) {
  ...
  for( ; pathExists == 0 && g1ptr != (GNODEPTR) ((void*)0) ;
      g1ptr = g1ptr->next ){
      node = g1ptr->node ;
      if( node != from ) {
   continue ;
...
for( l = 1 ; l <= s ; l++ ) {
    ...
    k = tempPL[j][0] ;
# 409 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
    for( i = 1 ; i < k ; i++ ) {
...
if( extraRoot != (TNODEPTR) ((void*)0) ) {
    for( ; ; ) {
 tpop( &extraRoot , &junkptr , &junk, &j ) ;
 if( junkptr == (TNODEPTR) ((void*)0) ) {
     break ;
 }
    }
}
...
# 532 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
