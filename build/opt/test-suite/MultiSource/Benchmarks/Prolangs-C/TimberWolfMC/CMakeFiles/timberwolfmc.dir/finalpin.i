# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/finalpin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/finalpin.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/finalpin.c" 2
int HorV ;
int nPinLocs ;
UNCOMBOX *UCptr ;
...
for( cell = 1 ; cell <= numcells ; cell++ ) {
 ...
 for( pin1 = 1 ; pin1 <= ptr->numUnComTerms ; pin1++ ) {
  ...
  if( UCptr[ pin1 ].sequence == 0 ) {
   ...
   if( ( (lArray[ 1 ].finalx - xprev)>=0 ? (lArray[ 1 ].finalx - xprev) : -(lArray[ 1 ].finalx - xprev) ) +
       ( (lArray[ 1 ].finaly - yprev)>=0 ? (lArray[ 1 ].finaly - yprev) : -(lArray[ 1 ].finaly - yprev) ) <
       ( (lArray[nPinLocs].finalx - xprev)>=0 ? (lArray[nPinLocs].finalx - xprev) : -(lArray[nPinLocs].finalx - xprev) ) +
       ( (lArray[nPinLocs].finaly - yprev)>=0 ? (lArray[nPinLocs].finaly - yprev) : -(lArray[nPinLocs].finaly - yprev) )){
...
# 271 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/finalpin.c"
 totalPin = endSeqs[0] ;
 ...
 if( begSeqs[0] > 0 && totalPin + begSeqs[0] <= nPinLocs ) {
     ...
     if( ( (lArray[ 1 ].finalx - xnext)>=0 ? (lArray[ 1 ].finalx - xnext) : -(lArray[ 1 ].finalx - xnext) ) +
  ( (lArray[ 1 ].finaly - ynext)>=0 ? (lArray[ 1 ].finaly - ynext) : -(lArray[ 1 ].finaly - ynext) ) <
  ( (lArray[ nPinLocs ].finalx - xnext)>=0 ? (lArray[ nPinLocs ].finalx - xnext) : -(lArray[ nPinLocs ].finalx - xnext) ) +
  ( (lArray[ nPinLocs ].finaly - ynext)>=0 ? (lArray[ nPinLocs ].finaly - ynext) : -(lArray[ nPinLocs ].finaly - ynext) )) {
...
# 433 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/finalpin.c"
 loFill = 0 ;
 for( i = 1 ; i <= nPinLocs ; i++ ) {
 ...
 while( hit == 1 ) {
  ...
  if( ( (conSeqs[i][1])>=0 ? (conSeqs[i][1]) : -(conSeqs[i][1]) ) <= loFill + 1 ) {
   ...
   for( j = 1 , k = conSeqs[i][0] ;
      ...
      conSeqs[i][1] = 0 ;
      hit = 1 ;
  } else if( ( (conSeqs[i][1])>=0 ? (conSeqs[i][1]) : -(conSeqs[i][1]) ) +
        conSeqs[i][0] >= hiFill ) {
...
# 516 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/finalpin.c"
 totLeft = 0 ;
 for( i = 1 ; i <= conSeqs[0][0] ; i++ ) {
     if( conSeqs[i][1] == 0 ) {
  continue ;
 ...
 while( totLeft > 0 ) {
  ...
  if( ( (conSeqs[i][1])>=0 ? (conSeqs[i][1]) : -(conSeqs[i][1]) ) < firstLoc ) {
      if( first != 0 ) {
   second = first ;
   secLoc = firstLoc ;
      }
      firstLoc = ( (conSeqs[i][1])>=0 ? (conSeqs[i][1]) : -(conSeqs[i][1]) ) ;
      first = i ;
  } else if( ( (conSeqs[i][1])>=0 ? (conSeqs[i][1]) : -(conSeqs[i][1]) ) < secLoc ) {
      secLoc = ( (conSeqs[i][1])>=0 ? (conSeqs[i][1]) : -(conSeqs[i][1]) ) ;
      second = i ;
  }
     }
...
# 636 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/finalpin.c"
 for( i = 1 ; i <= isoNum ; i++ ) {
