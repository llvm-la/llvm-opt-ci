# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uloop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uloop.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uloop.c" 2
extern char **spots ;
...
while( attempts < attmax ) {
    do {
 a = (int) ( (double) choose * ( (double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
        (double) 0x7fffffff ) ) + 1 ;
    } while( a == choose + 1 ) ;

    do {
 b = (int) ( (double) bigcell * ( (double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
        (double) 0x7fffffff ) ) + 1 ;
    } while( b == toobig ) ;
 ...
 if( acellptr->softflag != 0 &&
  (acellptr->aspUB > 0.01 + acellptr->aspLB)){
     ...
     newAspect = range * ((double)((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
...
if( ( (newxx + gridX - x)>=0 ? (newxx + gridX - x) : -(newxx + gridX - x) ) < ( (newxx - x)>=0 ? (newxx - x) : -(newxx - x) ) ) {
    newxx += gridX ;
}
newyy = ( (y - gOffsetY) / gridY ) * gridY + gOffsetY ;
if( ( (newyy + gridY - y)>=0 ? (newyy + gridY - y) : -(newyy + gridY - y) ) < ( (newyy - y)>=0 ? (newyy - y) : -(newyy - y) ) ) {
    newyy += gridY ;
}
return ;
}
...
for( ; ; ) {
    *x = (int) ( (double) xrange * ( (double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
    (double) 0x7fffffff ) ) + llspot ;
    *y = (int) ( (double) yrange * ( (double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) /
    (double) 0x7fffffff ) ) + bbspot ;
    if( spots[*x][*y] == 0 ) {
 break ;
    }
    if( *x >= lspot && *x <= rspot && *y >= bspot && *y <= tspot
  && ((( (*x - xspot)>=0 ? (*x - xspot) : -(*x - xspot) ) > 1) || (( (*y - yspot)>=0 ? (*y - yspot) : -(*y - yspot) ) > 1)) ) {
 break ;
    }
}
...
*x += (int)((double) spotSize * ((double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) / (double) 0x7fffffff));
*y += (int)((double) spotSize * ((double) ((randVar = randVar * 1103515245 + 12345) & 0x7fffffff) / (double) 0x7fffffff));
