# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makesite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makesite.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makesite.c" 2
typedef struct kbox {
    int cap ;
    int HV ;
    int sp ;
...
length = ( (yy2 - yy1)>=0 ? (yy2 - yy1) : -(yy2 - yy1) ) ;
...
if( flag ) {
 ...
 for( k = 1 ; k <= TotSites ; k++ ) {
     ...
     val1 = (k + 1) * siteSpace ;
     val2 = k * siteSpace ;
     kArray[ k ].y = ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) + yy1 ;
     kArray[ k ].sp = ( ( (val1) - (int)(val1) ) >= 0.5 ? ((int)(val1) + 1) : ((int)(val1)) ) - ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) ;
     kArray[ k ].HV = 1 ;
 }
    } else {
 for( k = 1 ; k <= TotSites ; k++ ) {
     ...
     val1 = (k + 1) * siteSpace ;
     val2 = k * siteSpace ;
     kArray[ k ].y = yy1 - ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) ;
     kArray[ k ].sp = ( ( (val1) - (int)(val1) ) >= 0.5 ? ((int)(val1) + 1) : ((int)(val1)) ) - ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) ;
     kArray[ k ].HV = 1 ;
 }
    }
}
# 116 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makesite.c"
return( TotSites ) ;
}
...
length = ( (xx2 - xx1)>=0 ? (xx2 - xx1) : -(xx2 - xx1) ) ;
aspect = cellarray[ cell ]->aspect ;
...
if( flag ) {
 ...
 for( k = 1 ; k <= TotSites ; k++ ) {
     ...
     val1 = (k + 1) * siteSpace ;
     val2 = k * siteSpace ;
     kArray[ k ].x = ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) + xx1 ;
     kArray[ k ].sp = ( ( (val1) - (int)(val1) ) >= 0.5 ? ((int)(val1) + 1) : ((int)(val1)) ) - ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) ;
     kArray[ k ].HV = 0 ;
 }
    } else {
 for( k = 1 ; k <= TotSites ; k++ ) {
     ...
     val1 = (k + 1) * siteSpace ;
     val2 = k * siteSpace ;
     kArray[ k ].x = xx1 - ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) ;
     kArray[ k ].sp = ( ( (val1) - (int)(val1) ) >= 0.5 ? ((int)(val1) + 1) : ((int)(val1)) ) - ( ( (val2) - (int)(val2) ) >= 0.5 ? ((int)(val2) + 1) : ((int)(val2)) ) ;
     kArray[ k ].HV = 0 ;
 }
    }
}
# 222 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makesite.c"
return( TotSites ) ;
}
