# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.c"
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.h" 2
...
PLISTPTR pfind() ;
PLISTPTR tplist() ;
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.c" 2
...
if( node->nsons == 0 ) {
    ...
    plptr = node->plist ;
    for( ; plptr != (PLISTPTR) ((void*)0); plptr = plptr->pnext ) {
...
v = root ;
if( v == (TNODEPTR) ((void*)0) ) {
    *node = (TNODEPTR) ((void*)0) ;
} else {
    while( v->son1 != (TNODEPTR) ((void*)0) ) {
 v = v->son1 ;
    }
    *node = v ;
    *value = v->value ;
...
v->son1 = r->son3 ;
v->son2 = r->son4 ;
v->son3 = (TNODEPTR) ((void*)0) ;
v->son4 = (TNODEPTR) ((void*)0) ;
v->father = r->father ;
v->nsons = 2 ;
r->nsons = 2 ;
r->son3 = (TNODEPTR) ((void*)0) ;
r->son4 = (TNODEPTR) ((void*)0) ;
v->son1->father = v ;
v->son2->father = v ;
...
if( r->father == (TNODEPTR) ((void*)0) ) {
    nr = (TNODEPTR) malloc( sizeof( TNODE ) ) ;
    nr->son1 = r ;
    nr->son2 = v ;
    nr->son3 = (TNODEPTR) ((void*)0) ;
    nr->son4 = (TNODEPTR) ((void*)0) ;
    nr->father = (TNODEPTR) ((void*)0) ;
    nr->nsons = 2 ;
    r->father = nr ;
    v->father = nr ;
    nr->Lval = r->Mval ;
...
if( *root == (TNODEPTR) ((void*)0) ) {
    makenode( &v , value , property ) ;
    v->father = (TNODEPTR) ((void*)0) ;
    *root = v ;
...
f = v->father ;
if( f != (TNODEPTR) ((void*)0) ) {
    if( f->son1 == v ) {
 f->Lval = value ;
    } else if( f->son2 == v ) {
 f->Mval = value ;
 if( f->son3 == (TNODEPTR) ((void*)0) ) {
     tpatch( f , value ) ;
 }
    } else {
 tpatch( f , value ) ;
...
if( *root == (TNODEPTR) ((void*)0) ) {
    ...
    if( plptr != (PLISTPTR) ((void*)0) ) {
 if( prevptr != (PLISTPTR) ((void*)0) ) {
     prevptr->pnext = plptr->pnext ;
     free( plptr ) ;
 } else if( plptr->pnext != (PLISTPTR) ((void*)0) ) {
     (*root)->plist = plptr->pnext ;
     free( plptr ) ;
 } else {
     free( plptr ) ;
     free( *root ) ;
     *root = (TNODEPTR) ((void*)0) ;
 }
    }
} else {
    l = tdsearch( value , *root ) ;
    if( l != (TNODEPTR) ((void*)0) ) {
 ...
 if( plptr != (PLISTPTR) ((void*)0) ) {
  ...
  if( f->nsons == 3 ) {
   ...
   free( (*root)->son1 ) ;
   free( (*root)->son2 ) ;
   (*root)->son1 = (TNODEPTR) ((void*)0) ;
   (*root)->son2 = (TNODEPTR) ((void*)0) ;
   (*root)->nsons = 0 ;
      } else {
   if( f->son1 == l ) {
       s = f->son2 ;
...
if( r == (TNODEPTR) ((void*)0) ) {
    return( (TNODEPTR) ((void*)0) ) ;
} else if( r->nsons == 0 ) {
    return( r ) ;
} else {
    if( value <= r->Lval ) {
...
{
*v = (TNODEPTR) malloc( sizeof( TNODE ) ) ;
(*v)->son1 = (TNODEPTR) ((void*)0) ;
(*v)->son2 = (TNODEPTR) ((void*)0) ;
(*v)->son3 = (TNODEPTR) ((void*)0) ;
(*v)->son4 = (TNODEPTR) ((void*)0) ;
(*v)->value = value ;
(*v)->nsons = 0 ;
...
*prevptr = (PLISTPTR) ((void*)0) ;
plptr = v->plist ;
while( plptr != (PLISTPTR) ((void*)0) ) {
