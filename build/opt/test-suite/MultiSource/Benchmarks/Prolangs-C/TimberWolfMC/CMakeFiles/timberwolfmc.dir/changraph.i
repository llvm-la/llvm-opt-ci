# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/changraph.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/changraph.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/changraph.c" 2
...
vChanBeginRoot = (TNODEPTR) ((void*)0) ;
vChanEndRoot = (TNODEPTR) ((void*)0) ;
hChanBeginRoot = (TNODEPTR) ((void*)0) ;
hChanEndRoot = (TNODEPTR) ((void*)0) ;
eNum = 0 ;
...
for( rec = 1 ; rec <= numRects ; rec++ ) {
    ...
    for( ; beptr != (DLINK2PTR) ((void*)0); beptr = beptr->next ){
 index = beptr->index ;
 b = rectArray[index].b ;
 if( b > finishLine ) {
     break ;
...
for( rec = 1 ; rec <= numRects ; rec++ ) {
    ...
    for( ; leptr != (DLINK2PTR) ((void*)0); leptr = leptr->next ){
 index = leptr->index ;
 l = rectArray[index].l ;
 if( l > finishLine ) {
     break ;
...
for( ; v1ptr != (DLINK1PTR) ((void*)0); v1ptr = v1ptr->next ) {
    edge1 = v1ptr->edge ;
...
for( ; v2ptr != (DLINK1PTR) ((void*)0); v2ptr = v2ptr->next ) {
    edge2 = v2ptr->edge ;
...
if( edgeList[edge1].fixed == 0 ) {
    ...
    vptr = vptr->next ;
    for( ; vptr != (DLINK1PTR) ((void*)0); vptr = vptr->next ) {
 if( edgeList[vptr->edge].loc > x ) {
     break ;
 }
    }
    for( vptr = vptr->prev; vptr != (DLINK1PTR) ((void*)0);
         vptr = vptr->prev ) {
 if( vptr == v2ptr ) {
     continue ;
 }
...
for( ; h1ptr != (DLINK1PTR) ((void*)0); h1ptr = h1ptr->next ) {
    edge1 = h1ptr->edge ;
...
for( ; h2ptr != (DLINK1PTR) ((void*)0); h2ptr = h2ptr->next ) {
    edge2 = h2ptr->edge ;
    if( edgeList[edge2].UorR > 0 ) {
 continue ;
    }
...
if( edgeList[edge1].fixed == 0 ) {
    ...
    hptr = hptr->next ;
    for( ; hptr != (DLINK1PTR) ((void*)0); hptr = hptr->next ) {
 if( edgeList[hptr->edge].loc > x ) {
     break ;
 }
    }
    for( hptr = hptr->prev; hptr != (DLINK1PTR) ((void*)0);
         hptr = hptr->prev ) {
 if( hptr == h2ptr ) {
     continue ;
 }
