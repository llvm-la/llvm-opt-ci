# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/parser.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/parser.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/parser.c" 2
int *fixLRBT ;
double *padspace ;
...
for( cell = 1 ; cell <= numcells + numpads + 4 ; cell++ ) {
    ...
    ptr = cellarray[ cell ] = ( (CELLBOX *) malloc ( sizeof(CELLBOX) ) ) ;
    ...
    for( i = 0 ; i < 8 ; i++ ) {
 ptr->config[ i ] = (TILEBOXPTR) ((void*)0) ;
 ptr->orientList[i] = 0 ;
    }
}
