# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/readgeo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/readgeo.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/readgeo.c" 2
...
rippleCount = 0 ;
cell = 0 ;
hFixedEdgeRoot = (TNODEPTR) ((void*)0) ;
vFixedEdgeRoot = (TNODEPTR) ((void*)0) ;
hEdgeRoot = (TNODEPTR) ((void*)0) ;
vEdgeRoot = (TNODEPTR) ((void*)0) ;
edgeList = (EDGEBOXPTR) malloc( 401 * sizeof( EDGEBOX ) ) ;
cellList = (CLBOXPTR *) malloc( 50 * sizeof(CLBOXPTR) ) ;
for( i = 1 ; i <= 49 ; i++ ) {
    cellList[i] = (CLBOXPTR) ((void*)0) ;
}

while( fscanf( fp , " %s " , input ) == 1 ) {
    if( strcmp( input , "cell") == 0 ) {
 clptr = (CLBOXPTR) ((void*)0) ;
 if( ++cell % 50 == 0 ) {
