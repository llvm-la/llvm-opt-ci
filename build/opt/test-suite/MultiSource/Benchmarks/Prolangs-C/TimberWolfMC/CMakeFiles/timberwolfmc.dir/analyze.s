...
.LBB0_27:                               # %.lr.ph165
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB0_27
.LBB0_28:                               # %._crit_edge166.loopexit
...
.LBB0_31:                               #   in Loop: Header=BB0_34 Depth=1
	st.w	$zero, $a2, 0
.LBB0_32:                               # %.loopexit136.sink.split
...
.LBB0_50:
	...
	move	$a1, $zero
	b	.LBB0_52
.LBB0_51:                               # %._crit_edge187.loopexit
	ld.w	$a1, $s0, 0
	slli.d	$a0, $a1, 2
	ldx.w	$a0, $s0, $a0
.LBB0_52:                               # %._crit_edge187
	st.w	$a0, $s0, 0
	ori	$a2, $zero, 4
	ori	$fp, $zero, 4
	move	$a0, $s0
...
.LBB0_60:                               # %.lr.ph193
	...
	addi.d	$a3, $a3, 8
	bnez	$a2, .LBB0_60
.LBB0_61:                               # %._crit_edge194.loopexit
...
# %bb.45:                               #   in Loop: Header=BB3_3 Depth=1
	...
	ld.d	$t3, $sp, 16                    # 8-byte Folded Reload
	b	.LBB3_2
.LBB3_46:                               # %vector.main.loop.iter.check158
                                        #   in Loop: Header=BB3_3 Depth=1
...
.LBB3_48:                               # %vec.epilog.ph177
	...
	add.d	$a1, $s0, $a1
	.p2align	4, , 16
.LBB3_49:                               # %vec.epilog.vector.body181
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$t0, .LBB3_49
# %bb.50:                               # %vec.epilog.middle.block188
                                        #   in Loop: Header=BB3_3 Depth=1
	bne	$a7, $a3, .LBB3_11
	b	.LBB3_12
.LBB3_51:                               # %vector.ph159
                                        #   in Loop: Header=BB3_3 Depth=1
	andi	$a4, $a3, 16
...
.LBB3_52:                               # %vector.body162
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB3_52
# %bb.53:                               # %middle.block171
                                        #   in Loop: Header=BB3_3 Depth=1
	beq	$a6, $a3, .LBB3_12
# %bb.54:                               # %vec.epilog.iter.check175
                                        #   in Loop: Header=BB3_3 Depth=1
	bnez	$a4, .LBB3_48
