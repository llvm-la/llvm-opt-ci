# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/procesnet.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/procesnet.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/procesnet.c" 2
...
PLISTPTR pfind() ;
PLISTPTR tplist() ;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/procesnet.c" 2
TNODEPTR netRoot ;
 ...
 if( firstNode == 0 ) {
  ...
  lastcptr = lastcptr->next =
   (CHANBOXPTR) malloc( sizeof( CHANBOX ) ) ;
     ...
     lastcptr->next = (CHANBOXPTR) ((void*)0) ;
 } else {
     if( firstNode > 1 ) {
  pin1 = netSegArray[i][1] ;
  pin2 = netSegArray[i][2] ;
