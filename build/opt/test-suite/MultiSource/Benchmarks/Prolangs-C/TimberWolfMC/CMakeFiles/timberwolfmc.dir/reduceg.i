# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/reduceg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/reduceg.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/geo.h" 1
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/geo.h" 2
...
PLISTPTR pfind() ;
PLISTPTR tplist() ;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/geo.h" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/reduceg.c" 2
...
for( i = 1 ; i <= numXnodes ; i++ ) {
    for( ptr = xNodeArray[i] ; ptr != (WCPTR) ((void*)0) ; ptr = ptr->next ){
 if( ptr->fixedWidth == 1 ) {
     continue ;
 }
...
for( i = 1 ; i <= numYnodes ; i++ ) {
    for( ptr = yNodeArray[i] ; ptr != (WCPTR) ((void*)0) ; ptr = ptr->next ){
 if( ptr->fixedWidth == 1 ) {
     continue ;
 }
 count = ptr->channels[0] ;
...
for( ; ; ) {
 ...
 if( vertical ) {
  ...
  if( ( (rectArray[i1].xc - guideline)>=0 ? (rectArray[i1].xc - guideline) : -(rectArray[i1].xc - guideline) ) < min ) {
      min = ( (rectArray[i1].xc - guideline)>=0 ? (rectArray[i1].xc - guideline) : -(rectArray[i1].xc - guideline) ) ;
      minc = c ;
  }
  if( ( (rectArray[i2].xc - guideline)>=0 ? (rectArray[i2].xc - guideline) : -(rectArray[i2].xc - guideline) ) < min ) {
      min = ( (rectArray[i2].xc - guideline)>=0 ? (rectArray[i2].xc - guideline) : -(rectArray[i2].xc - guideline) ) ;
      minc = c ;
  }
     }
 } else {
  ...
  i1 = eArray[ ptr->channels[c] ].index1 ;
  i2 = eArray[ ptr->channels[c] ].index2 ;
  if( ( (rectArray[i1].yc - guideline)>=0 ? (rectArray[i1].yc - guideline) : -(rectArray[i1].yc - guideline) ) < min ) {
      min = ( (rectArray[i1].yc - guideline)>=0 ? (rectArray[i1].yc - guideline) : -(rectArray[i1].yc - guideline) ) ;
      minc = c ;
  }
  if( ( (rectArray[i2].yc - guideline)>=0 ? (rectArray[i2].yc - guideline) : -(rectArray[i2].yc - guideline) ) < min ) {
      min = ( (rectArray[i2].yc - guideline)>=0 ? (rectArray[i2].yc - guideline) : -(rectArray[i2].yc - guideline) ) ;
      minc = c ;
  }
     }
 }
...
for( twoTimes = 1 ; twoTimes <= 2 ; twoTimes++ ) {
    for( i = 1 ; i <= numXnodes ; i++ ) {
 for( ptr = xNodeArray[i] ; ptr != (WCPTR) ((void*)0) ;
      ptr = ptr->next ){
     if( ptr->fixedWidth == 1 ) {
  continue ;
     }
  ...
  for( c = count - 1 ; c >= 1 ; c-- ) {
   ...
   break ;
    ...
    for( i = 1 ; i <= numYnodes ; i++ ) {
 for( ptr = yNodeArray[i] ; ptr != (WCPTR) ((void*)0) ;
         ptr = ptr->next ){
     if( ptr->fixedWidth == 1 ) {
  continue ;
     }
