# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/ygraph.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/ygraph.c" 2
...
extern FILE *fpdebug ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/ygraph.c" 2
...
for( i = 0 ; i <= numberCells + 1 ; i++ ) {
    yNodules[i].inList = (FLAREPTR) ((void*)0) ;
    yNodules[i].outList = (FLAREPTR) ((void*)0) ;
    yNodules[i].done = 0 ;
}
hptr = Hlist ;
hedge = hptr->edge ;
...
for( ; hptr->next != (DLINK1PTR) ((void*)0) ; hptr = hptr->next ) {
    hedge = hptr->edge ;
...
for( cell = 0 ; cell <= numberCells + 1 ; cell++ ) {
    fptr = yNodules[cell].inList ;
    for( ; fptr != (FLAREPTR) ((void*)0) ; fptr = fptr->next ) {
...
for( cell = 1 ; cell <= numberCells ; cell++ ) {
 ...
 for( ; ofptr != (FLAREPTR) ((void*)0) ; ofptr = ofptr->next ) {
     ...
     yNodeArray[inode]->channels = (int *) ((void*)0) ;
...
if( hChanBeginRoot != (TNODEPTR) ((void*)0) ) {
    for( ; ; ) {
...
if( hChanEndRoot != (TNODEPTR) ((void*)0) ) {
    for( ; ; ) {
