# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/rmain.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/rmain.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/rmain.c" 2
...
extern FILE *fpdebug ;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/rmain.c" 2
...
if( (fp = fopen ( filename , "r")) == (FILE *) ((void*)0) ) {
...
for( i = 1 ; i <= eNum ; i++ ) {
    if( eArray[i].root != (TNODEPTR) ((void*)0) ) {
 for( ; ; ) {
     tpop( &eArray[i].root , &tnode , &dummy1 , &dummy2 ) ;
     if( tnode == (TNODEPTR) ((void*)0) ) {
  break ;
     }
 }
    }
...
for( i = 1 ; i <= numXnodes ; i++ ) {
    wcptr = xNodeArray[i] ;
    while( wcptr != (WCPTR) ((void*)0) ) {
 if( wcptr->channels != (int *) ((void*)0) ) {
     free( wcptr->channels ) ;
 }
 wc2ptr = wcptr->next ;
 free( wcptr ) ;
...
for( qptr = pinlist ; qptr != (QUADPTR) ((void*)0) ; ) {
    tmpqptr = qptr->next ;
    free( qptr ) ;
    qptr = tmpqptr ;
}
