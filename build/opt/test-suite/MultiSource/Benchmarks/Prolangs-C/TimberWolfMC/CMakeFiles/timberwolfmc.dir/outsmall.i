# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/outsmall.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/outsmall.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/outsmall.c" 2
...
for( cell = 1 ; cell <= numcells + numpads ; cell++ ) {
 ...
 fprintf(fp," %d %d", xc + PtsOut[k].xc, yc + PtsOut[k].yc );
    ...
    for( ; termptr != (TERMBOXPTR) ((void*)0) ; termptr = termptr->nextterm ) {
 x = xc + termptr->xpos ;
 y = yc + termptr->ypos ;
