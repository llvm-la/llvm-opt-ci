# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/config3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/config3.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/config3.c" 2
...
for( pad = numcells + 1 ; pad <= numcells + numpads ; pad++ ) {
    if( cellarray[pad]->padside == 4 ) {
 cellarray[pad]->ycenter += b ;
    } else if( cellarray[pad]->padside == 2 ) {
 cellarray[pad]->ycenter -= t ;
    } else if( cellarray[pad]->padside == 1 ) {
 cellarray[pad]->xcenter += l ;
    } else if( cellarray[pad]->padside == 3 ) {
