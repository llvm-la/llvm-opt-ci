# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/assembler/record.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/assembler/record.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/assembler/record.c"
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/assembler/record.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/assembler/record.c" 2
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/assembler/record.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/assembler/record.c" 2




char RECORD[80 + 1];
char INIT_RECORD[80 + 1];
int NEXT_COL;
...
{
  if ((SIZE > 80) || (strlen(VAL) > SIZE) || IS_INITIALIZED)
...
void PRT_TEXT_RECORD(FILE *OUTPUT)
{
  if (!IS_INITIALIZED)
    ...
    if (strcmp(RECORD,INIT_RECORD)) {
      ...
      PRT_NUM((NEXT_COL/2),16,2,OUTPUT);
      (void) fprintf(OUTPUT,"%s\n",RECORD);
...
void ADD_TO_TEXT_RECORD(char *VAL,int PUT_AT,FILE *OUTPUT)
{
  ...
  if (!IS_INITIALIZED || (LEN > MAX_SIZE)) ERROR = 1;
    ...
    if (!ERROR && ((LOCATION + NEXT_COL/2) != PUT_AT) ) {
