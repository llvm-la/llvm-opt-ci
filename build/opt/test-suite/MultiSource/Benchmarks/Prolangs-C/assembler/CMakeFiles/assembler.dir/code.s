...
.LBB4_13:                               # %.lr.ph.i105
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_13
.LBB4_14:                               # %._crit_edge.i99
	addi.w	$a0, $s6, 0
	beqz	$a0, .LBB4_20
# %bb.15:                               # %.sink.split.i102
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
...
.LBB4_30:                               # %.lr.ph.i120
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_30
.LBB4_31:                               # %._crit_edge.i114
	addi.w	$a0, $s6, 0
	beqz	$a0, .LBB4_33
# %bb.32:                               # %.sink.split.i117
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_33:                               # %SET_BITS_TO.exit127
	ld.w	$a0, $s5, 24
	ori	$a1, $zero, 1
	beq	$a0, $a1, .LBB4_44
# %bb.34:
...
.LBB4_50:                               # %.lr.ph.i148
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_50
.LBB4_51:                               # %._crit_edge.i142
	beqz	$a2, .LBB4_53
# %bb.52:                               # %.sink.split.i145
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_53:                               # %SET_BITS_TO.exit155
	ld.w	$a0, $s5, 24
	beqz	$a0, .LBB4_60
# %bb.54:
	ld.d	$s5, $sp, 72
...
# %bb.56:
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_76
# %bb.57:                               # %.lr.ph.i200.peel
	ori	$a1, $zero, 49
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a1, $sp, 38
	beqz	$a0, .LBB4_77
# %bb.58:                               # %.lr.ph.i200.preheader
	addi.d	$a1, $sp, 37
	ori	$a2, $zero, 48
	.p2align	4, , 16
.LBB4_59:                               # %.lr.ph.i200
...
.LBB4_62:                               # %.lr.ph.i163
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_62
# %bb.63:                               # %._crit_edge.i157
	addi.w	$a0, $a3, 0
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB4_65
.LBB4_64:                               # %.sink.split.i160
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_65:                               # %SET_BITS_TO.exit170
	beqz	$s3, .LBB4_95
# %bb.66:                               # %.preheader.i171
	ld.b	$a0, $sp, 32
	ori	$a1, $zero, 2
	pcaddu18i	$ra, %call36(CHAR_TO_DIGIT)
	jirl	$ra, $ra, 0
...
.LBB4_67:
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_76
# %bb.68:                               # %.lr.ph.i215.peel
	ori	$a1, $zero, 49
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a1, $sp, 39
	beqz	$a0, .LBB4_77
# %bb.69:                               # %.lr.ph.i215.preheader
	addi.d	$a1, $sp, 38
	ori	$a2, $zero, 48
	.p2align	4, , 16
.LBB4_70:                               # %.lr.ph.i215
...
.LBB4_73:                               # %.lr.ph.i230
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_73
# %bb.74:                               # %._crit_edge.i224
	addi.w	$a0, $a3, 0
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB4_78
.LBB4_75:                               # %.sink.split.i227
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
	b	.LBB4_78
.LBB4_76:                               # %.sink.split.i197
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
	ld.d	$s5, $sp, 72
.LBB4_77:                               # %SET_BITS_TO.exit207
	addi.d	$a0, $s5, 1
	st.d	$a0, $sp, 72
.LBB4_78:                               # %SET_BITS_TO.exit237
	addi.w	$s5, $s1, 1
	addi.d	$a0, $sp, 72
	ori	$a1, $zero, 21
	addi.d	$a4, $sp, 28
...
# %bb.82:
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_96
# %bb.83:                               # %.lr.ph.i245.peel
	ori	$a2, $zero, 49
	bstrpick.d	$a1, $a0, 31, 1
	st.b	$a2, $sp, 40
	move	$a0, $s4
	beqz	$a1, .LBB4_86
# %bb.84:                               # %.lr.ph.i245.preheader
	addi.d	$a2, $sp, 39
	ori	$a3, $zero, 48
	.p2align	4, , 16
.LBB4_85:                               # %.lr.ph.i245
...
.LBB4_91:                               # %.lr.ph.i260
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_91
.LBB4_92:                               # %._crit_edge.i254
	beqz	$s3, .LBB4_94
# %bb.93:                               # %.sink.split.i257
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_94:                               # %SET_BITS_TO.exit267
	ld.b	$a0, $sp, 32
	ori	$a1, $zero, 2
	pcaddu18i	$ra, %call36(CHAR_TO_DIGIT)
	jirl	$ra, $ra, 0
...
.LBB4_108:                              # %.lr.ph.i284
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_108
.LBB4_109:                              # %._crit_edge.i278
	beqz	$s3, .LBB4_111
# %bb.110:                              # %.sink.split.i281
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_111:                              # %SET_BITS_TO.exit291
	ld.w	$a0, $sp, 28
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB4_122
# %bb.112:
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_121
# %bb.113:                              # %.lr.ph.i299.peel
	ori	$a1, $zero, 49
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a1, $sp, 42
	beqz	$a0, .LBB4_122
# %bb.114:                              # %.lr.ph.i299.preheader
	addi.d	$a1, $sp, 41
	ori	$a2, $zero, 48
	.p2align	4, , 16
.LBB4_115:                              # %.lr.ph.i299
...
# %bb.120:
	move	$a2, $a0
	b	.LBB4_130
.LBB4_121:                              # %.sink.split.i296
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_122:                              # %SET_BITS_TO.exit306
	ld.b	$a0, $sp, 32
	ori	$a1, $zero, 2
	pcaddu18i	$ra, %call36(CHAR_TO_DIGIT)
	jirl	$ra, $ra, 0
