# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c" 2
# 56 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c"
...
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c" 2
...
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c" 2
...
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c" 2
...
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/BitBench/uuencode/uuencode.c" 2
...
void encode_line(char* input, int offset, int octets, char* line){
  int loffs=0;
  line[loffs]=encode_char(octets);
  for (++loffs; octets > 0; offset += 3, octets -= 3) {
    char ch;
    if (octets >= 3) {
      ch = encode_char (input[offset] >> 2);
      line[loffs++] = ch;
      ch = encode_char ((input[offset] << 4) | (input[offset+1] >> 4));
      line[loffs++] = ch;
      ch = encode_char ((input[offset+1] << 2) | (input[offset+2] >> 6));
      line[loffs++] = ch;
      ch = encode_char (input[offset+2]);
      line[loffs++] = ch;
    } else {
...
void encode(char* input, int limit, char* output){
  ...
  while(offset<limit) {
    if ((limit - offset) >= 45) {
      encode_line(input, offset, 45, line);
      offset += 45;
    }
    else {
      encode_line(input, offset, limit-offset, line);
      offset = limit;
    }
    strcat(output,line);
...
int do_encode(char* input, char* output, int len, char* infilename) {
  int mode, namelen;
  strcpy(output, "begin 640 ");
  strcat(output,infilename);
  strcat(output, " \n");{
    namelen = strlen(infilename);
    encode(input, len, output+strlen(output));
...
{
  return fread(buffer, 1, 1000000, in);
}
