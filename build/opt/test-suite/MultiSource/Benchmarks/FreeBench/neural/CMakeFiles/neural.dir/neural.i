# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c" 2
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c" 2
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
int NNWIDTH;
int NNHEIGHT;
int NNTOT;
int NUMPATS;
...
typedef float real;
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
char *vnames;
int *stored;
real **Tmatrix;
...
# 101 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
int main (int c, char *v[])
{
  ...
  generateT(1);
# 188 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
  nmode=1;
  printf("Delta learning...\n");
  delta(0.5);
  printf("Store check...\n");
  storecheck();
# 247 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
  return 0;
}
...
static void checkham()
{
   ...
   for(vec=0; vec<NUMPATS; vec++) {
      for(comp=(vec+1); comp<NUMPATS; comp++) {
         if((hd=hamming(vectors[vec], vectors[comp], 1))<2)
                                                                      hamwarn++;
         else
                                                                     ;
         if((hd=hamming(vectors[vec], vectors[comp], -1))<2)
...
static int run (signed int *source, signed int *dest)
{
   ...
   while((!stable) && (max<500)) {
      ...
      if(hamming(tempvecB, tempvecA, 1)==0)
         stable=WTRUE;
      else {
         neuron=0;
...
static void storecheck ()
{
  ...
  for(vec=0; vec<NUMPATS; vec++) {
    if((hd=hamming(vectors[vec], newvectors[vec], 1))==0) {
      stored[vec]=1;
...
# 500 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
}
# 527 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
static void printT()
{
  int row, col;
...
# 583 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
  mysrand(seed);
...
# 673 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/neural/neural.c"
static int runcont (signed int source[], signed int dest[])
{
