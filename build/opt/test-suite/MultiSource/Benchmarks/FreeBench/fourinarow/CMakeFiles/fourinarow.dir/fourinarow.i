# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c" 2
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c" 2


typedef unsigned long long uint64;
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c"
uint64 C4VERT;
uint64 C4HORIZ;
uint64 C4UP_R;
uint64 C4UP_L;
...
uint64 C2UP_R;
uint64 C2UP_L;
# 71 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c"
int DEPTH=3;
...
int place_piece(int col, int player, char b[7][6 +1])
{
  if (col<0 || col>7 -1) {
...
int find_winner_p(char b[7][6 +1])
{
  unsigned int i,j;
  uint64 temp_board=0;
  uint64 one=1;
  ...
  for (j=0;j<6;j++)
    for (i=0;i<7;i++)
      if (b[i][j]==player) {
 temp_board = temp_board | one << (i+j*7);
      }
  ...
  for (i=0;i<6;i++) {
    for (j=0;j<7 -3;j++) {
      if ((temp_board&C4HORIZ<<(j+i*7))==C4HORIZ<<(j+i*7))
 return 1;
    }
  }
  for (i=0;i<6 -3;i++) {
    for (j=0;j<7 -3;j++) {
      if ((temp_board&C4UP_R<<(j+i*7))==C4UP_R<<(j+i*7))
 return 1;
    }
  }
  for (i=0;i<6 -3;i++) {
    for (j=0;j<7 -3;j++) {
      if ((temp_board&C4UP_L<<(j+i*7))==C4UP_L<<(j+i*7))
 return 1;
    }
  }
  return 0;
...
int find_winner_c(char b[7][6 +1])
{
  unsigned int i,j;
  uint64 temp_board=0;
  uint64 one=1;
...
int think(char b[7][6 +1], int who, int ab)
{
  uint64 b1=0,b2=0;
  uint64 one=1;
  int i,j;
 ...
 b2 = b2 | one << (i+j*7);
  ...
  if (ab==1) {
    if (who==2)
      minimax_comp_ab(1,b1,b2,&col,-100000,100000);
    if (who==1)
      minimax_player_ab(1,b1,b2,&col,-100000,100000);
  } else if (ab==2) {
    if (who==2)
      minimax_comp_ab2(1,b1,b2,&col,100000);
    if (who==1)
      minimax_player_ab2(1,b1,b2,&col,-100000);
  } else {
    if (who==2)
...
int minimax_comp_ab2(int depth, uint64 b1, uint64 b2, int *col, int beta)
{
  int i,max=-100000,max_col=0,tmp;
  uint64 tmp_b;
...
int minimax_player_ab2(int depth, uint64 b1, uint64 b2, int *col, int alpha)
{
  int i,min=100000,min_col=0,tmp;
  uint64 tmp_b;
...
# 642 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/fourinarow/fourinarow.c"
