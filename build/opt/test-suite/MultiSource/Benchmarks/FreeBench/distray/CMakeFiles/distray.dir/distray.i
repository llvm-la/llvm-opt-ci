# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c"
int DISTRIB;
...
# 97 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c"
...
# 152 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c"
...
static void ReflectVector( VECTOR *v2, VECTOR *v1, VECTOR *n )
{
    ...
    b = n->x*n->x + n->y*n->y + n->z*n->z;
    a = v1->x*n->x + v1->y*n->y + v1->z*n->z;
    a = -2.0 * a / b;
    v2->x = v1->x + a*n->x;
    v2->y = v1->y + a*n->y;
    v2->z = v1->z + a*n->z;
...
# 211 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c"
                      ...
                      VECTOR *Pnt, VECTOR *Norm, TEXTURE **txt )
{
    ...
    if( fabs(LinD->z) > (1e-5) ) {
        ...
        if( ( ttmp > (1e-5) ) && ( ttmp < (1e5) ) ) {
            t = ttmp;
            Pnt->x = LinP->x + LinD->x*t;
    ...
    for( objn = 0; objn < 4; objn++ ) {
        ...
        if( (A = C + B*B) > 0.0 ) {
            A = sqrt(A);
            if( (ttmp = B - A) < (1e-5) ) ttmp = B + A;
            if( ((1e-5)<ttmp) && ( (ttmp<t)||(t<0.0) ) ) {
         t = ttmp;
         Pnt->x = LinD->x*t;
         Pnt->y = LinD->y*t;
         Pnt->z = LinD->z*t;
...
# 274 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c"
            ...
            if(cosfi > 0.0) {
                ...
                if( usedist ) {
                    ...
                    for( i = 0; i < DISTRIB; i++ ) {
                        ...
                        if( ( t < (1e-5) ) || ( t > 1.0 ) ) shadowcount++;
                    }
                } else {
                    t = IntersectObjs( &Pnt, &LDir, &TmpPnt, &TmpNorm, &tmptxt );
                    if( ( t < (1e-5) ) || ( t > 1.0 ) ) shadowcount = DISTRIB;
                }
                if( shadowcount > 0 ) {
...
static void TraceScene(void)
{
  ...
  Scale.y = 1.0;
  for( sy = 0; sy < 480; sy++ ) {
    Scale.z = ((double)(480/2-sy))/(double)480;
    for( sx = 0; sx < 640; sx++ ) {
      Scale.x = ((double)(sx-640/2))/(double)640;
      ...
      for( i = 0; i < DISTRIB; i++ ) {
 DistribVector( &D, &LinD, 0.5/(double)640, 0.5/(double)480 );
 LinD2 = LinD; LinD2.x += D.x; LinD2.y += D.y; LinD2.z += D.z;
 TraceLine( &Camerapos, &LinD2, &Col, 6 );
 PixColor.x += Col.x;
 PixColor.y += Col.y;
 PixColor.z += Col.z;
      }
      ...
      memory[3*(sx+sy*640)]=(UBYTE)(PixColor.x*255.0);
      memory[3*(sx+sy*640)+1]=(UBYTE)(PixColor.y*255.0);
      memory[3*(sx+sy*640)+2]=(UBYTE)(PixColor.z*255.0);
    }
  }
}
# 411 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/distray/distray.c"
int main(int c, char *v[])
{
  ...
  fprintf( stdout, "%d %d", 640, 480 ); fputc( 10, stdout );
