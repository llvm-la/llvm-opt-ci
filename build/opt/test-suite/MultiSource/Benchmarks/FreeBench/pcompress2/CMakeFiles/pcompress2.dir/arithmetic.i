# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/arithmetic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/arithmetic.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/arithmetic.c" 2
...
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/arithmetic.c" 2
...
static int char_to_index[256];
static unsigned char index_to_char[(256 +1)+1];



static int freq[(256 +1)+1];
static int cum_freq[(256 +1)+1];
...
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/arithmetic.c"
...
unsigned int do_ari(unsigned int insize)
{
    ...
    for (;;) {
        int ch; int symbol;
        ch = rle[rle_pos++];
        if (rle_pos>insize) break;
        symbol = char_to_index[ch];
        encode_symbol(symbol,cum_freq);
        update_model(symbol);
    }
    encode_symbol((256 +1),cum_freq);
    done_encoding();
    done_outputing_bits();
    return ari_pos;
}
...
static void done_encoding( void )
{ bits_to_follow += 1;
    if (low<((((long)1<<16)-1)/4+1)) bit_plus_follow(0);
