# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/set.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/set.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/set.c" 2
static pset_family set_family_garbage = ((void*)0);
...
pset_family A;
{
    if ((A->data)) { (void) free((char *) (A->data)); (A->data) = 0; };
...
void sf_cleanup()
{
    ...
    for(p = set_family_garbage; p != (pset_family) ((void*)0); p = pnext) {
 pnext = p->next;
 if ((p)) { (void) free((char *) (p)); (p) = 0; };
    }
    set_family_garbage = (pset_family) ((void*)0);
}
...
# 667 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/set.c"
...
# 759 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/set.c"
...
# 789 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/set.c"
