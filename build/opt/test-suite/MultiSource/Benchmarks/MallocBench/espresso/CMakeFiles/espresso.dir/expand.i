# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c" 2
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c" 2
...
pset_family expand(F, R, nonsparse)
      pset_family F;
   pset_family R;
   int nonsparse;
{
 ...
 F = sf_inactive(F);
    ...
    if ((RAISE)) { (void) free((char *) (RAISE)); (RAISE) = 0; };
    if ((FREESET)) { (void) free((char *) (FREESET)); (FREESET) = 0; };
    if ((INIT_LOWER)) { (void) free((char *) (INIT_LOWER)); (INIT_LOWER) = 0; };
    if ((SUPER_CUBE)) { (void) free((char *) (SUPER_CUBE)); (SUPER_CUBE) = 0; };
    if ((OVEREXPANDED_CUBE)) { (void) free((char *) (OVEREXPANDED_CUBE)); (OVEREXPANDED_CUBE) = 0; };
    return F;
}
...
# 198 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
...
# 247 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
void essen_raising(BB, RAISE, FREESET)
register pset_family BB;
pset RAISE, FREESET;
{
...
# 276 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
...
# 326 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
...
# 363 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
void setup_BB_CC(BB, CC)
register pset_family BB, CC;
{
    register pset p, last;
...
# 392 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
void select_feasible(BB, CC, RAISE, FREESET, SUPER_CUBE, num_covered)
pset_family BB, CC;
pset RAISE, FREESET, SUPER_CUBE;
int *num_covered;
{
...
loop:
 ...
 printf("SELECT_FEASIBLE: started with %d pfcc, ended with %d fcc\n",
    ...
    if (numfeas == 0) {
 if ((feas)) { (void) free((char *) (feas)); (feas) = 0; };
 if ((feas_new_lower)) { (void) free((char *) (feas_new_lower)); (feas_new_lower) = 0; };
 sf_free(new_lower);
 return;
    }
...
# 507 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
int feasibly_covered(BB, c, RAISE, new_lower)
pset_family BB;
pset c, RAISE, new_lower;
{
...
# 546 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
...
# 568 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/expand.c"
 ...
 printf("MINCOV:    \tRAISE=%s FREESET=%s\n", pc1(RAISE), pc2(FREESET));
    ...
    sf_free(B);
    if ((xlower)) { (void) free((char *) (xlower)); (xlower) = 0; };
    return;

heuristic_mincov:
    sf_free(B);

    (RAISE[(((most_frequent( (pset_family) ((void*)0), FREESET)) >> 5) + 1)] |= 1 << ((most_frequent( (pset_family) ((void*)0), FREESET)) & (32 -1)));
    (void) set_diff(FREESET, FREESET, RAISE);
    essen_parts(BB, (pset_family) ((void*)0), RAISE, FREESET);
    return;
...
pset_family find_all_primes(BB, RAISE, FREESET)
pset_family BB;
register pset RAISE, FREESET;
{
...
pset_family F, R;
{
 ...
 if ((p[0] & (0x8000))) {
     ...
     (void) set_diff(FREESET, cube.fullset, RAISE);
     setup_BB_CC(R, (pset_family) ((void*)0));
     essen_parts(R, (pset_family) ((void*)0), RAISE, FREESET);
