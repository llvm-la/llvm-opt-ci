# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/equiv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/equiv.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/equiv.c" 2
...
pPLA PLA;
{
 ...
 sf_free(R[i]);
    ...
    if ((F)) { (void) free((char *) (F)); (F) = 0; };
    if ((R)) { (void) free((char *) (R)); (R) = 0; };
}
...
pset_family f1, f2;
{
 ...
 if (! cube_is_covered(f1list, p)) {
    ...
    if ((f1list[0])) { (void) free((char *) (f1list[0])); (f1list[0]) = 0; }; if ((f1list)) { (void) free((char *) (f1list)); (f1list) = 0; };;
 ...
 if (! cube_is_covered(f2list, p)) {
    ...
    if ((f2list[0])) { (void) free((char *) (f2list[0])); (f2list[0]) = 0; }; if ((f2list)) { (void) free((char *) (f2list)); (f2list) = 0; };;
