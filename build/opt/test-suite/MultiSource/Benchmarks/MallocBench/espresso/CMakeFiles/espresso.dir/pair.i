# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/pair.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/pair.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/pair.c" 2
...
int adjust_labels;
{
 ...
 new_part_size[new_num_binary_vars + pair->cnt + var] =
    ...
    setdown_cube();
    if ((cube.part_size)) { (void) free((char *) (cube.part_size)); (cube.part_size) = 0; };
 ...
 for(var = 0; var < old_num_binary_vars; var++) {
  ...
  oldlabel[2*var] = oldlabel[2*var+1] = (char *) ((void*)0);
  i++;
     }
 }
 ...
 for(i = old_mv_start; i < old_size; i++) {
     ...
     oldlabel[i] = (char *) ((void*)0);
 }

 for(i = 0; i < old_size; i++)
     if (oldlabel[i] != (char *) ((void*)0))
  if ((oldlabel[i])) { (void) free((char *) (oldlabel[i])); (oldlabel[i]) = 0; };
 if ((oldlabel)) { (void) free((char *) (oldlabel)); (oldlabel) = 0; };
    }


    for(var = 0; var < pair->cnt; var++)
 cube.sparse[cube.num_binary_vars + var] = 0;
    if ((paired)) { (void) free((char *) (paired)); (paired) = 0; };
}

pset_family pairvar(A, pair)
pset_family A;
ppair pair;
{
...
# 213 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/pair.c"
...
int strategy;
{
 ...
 (void) greedy_best_cost(cost_array, &(PLA->pair));
    ...
    for(i = 0; i < cube.num_binary_vars; i++)
 if ((cost_array[i])) { (void) free((char *) (cost_array[i])); (cost_array[i]) = 0; };
    if ((cost_array)) { (void) free((char *) (cost_array)); (cost_array) = 0; };
...
int strategy;
{
 ...
 for(var2 = var1+1; var2 < cube.num_binary_vars; var2++) {
  ...
  case 0:
      ...
      sf_free(T);
      if ((mask)) { (void) free((char *) (mask)); (mask) = 0; };
     }
...
ppair *pair_p;
{
 ...
 total_cost += maxcost;
    ...
    if ((cand)) { (void) free((char *) (cand)); (cand) = 0; };
    *pair_p = pair;
    return total_cost;
}
...
int **cost_array_local;
{
    ...
    pair_free(pair);
    if ((candidate)) { (void) free((char *) (candidate)); (candidate) = 0; };
    return best_pair;
}
...
# 458 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/pair.c"
...
ppair pair;
{
 ...
 best_pair = pair_save(pair, pair->cnt);
 best_phase = global_PLA->phase!=((void*)0)?set_copy(((unsigned int *) malloc(sizeof(unsigned int) * ((((32 * (global_PLA->phase[0] & 0x03ff))) <= 32 ? 2 : ((((((32 * (global_PLA->phase[0] & 0x03ff)))-1) >> 5) + 1) + 1))))), global_PLA->phase):((void*)0);
 if (best_F != ((void*)0)) sf_free(best_F);
 if (best_D != ((void*)0)) sf_free(best_D);
 if (best_R != ((void*)0)) sf_free(best_R);
 ...
 best_R = sf_save(global_PLA->R);
    ...
    global_PLA->D = Dsave;
    global_PLA->R = Rsave;
    global_PLA->pair = ((void*)0);
    global_PLA->phase = ((void*)0);
}
...
int (*action)();
{
 ...
 generate_all_pairs(recur_pair, n, recur_candidate, action);
    ...
    if ((recur_candidate)) { (void) free((char *) (recur_candidate)); (recur_candidate) = 0; };
}
...
register ppair pair;
{
    if ((pair->var1)) { (void) free((char *) (pair->var1)); (pair->var1) = 0; };
    if ((pair->var2)) { (void) free((char *) (pair->var2)); (pair->var2) = 0; };
    if ((pair)) { (void) free((char *) (pair)); (pair) = 0; };
}
