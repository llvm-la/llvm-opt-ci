# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/unate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/unate.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/unate.c" 2

static pset_family abs_covered();
static pset_family abs_covered_many();
static int abs_select_restricted();

pset_family map_cover_to_unate(T)
pset *T;
{
...
pset_family map_unate_to_cover(A)
pset_family A;
{
 ...
 pB += B->wsize;
    ...
    if ((unate)) { (void) free((char *) (unate)); (unate) = 0; };
    return B;
}
...
pset_family A;
{
 ...
 if ((restrict)) { (void) free((char *) (restrict)); (restrict) = 0; };
    }
...
# 293 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/unate.c"
...
int largest_only;
{
 ...
 for(pj=B->data,lastj=pj+B->count*B->wsize;pj<lastj;pj+=B->wsize) {
  ...
  if (++T->count >= T->capacity) {
      T = sf_contain(T);
      Tsave = (Tsave == ((void*)0)) ? T : sf_union(Tsave, T);
      T = sf_new(500, A->sf_size);
      pt = T->data;
  } else {
      pt += T->wsize;
