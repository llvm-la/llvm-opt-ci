# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/globals.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/globals.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/globals.c" 2
...
int echo_comments;
int echo_unknown_commands;
int force_irredundant;
int skip_make_sparse;
int kiss;
int pos;
int print_solution;
int recompute_onset;
int remove_essential;
int single_expand;
int summary;
int trace;
int unwrap_onset;
int use_random_order;
int use_super_gasp;
char *filename;
