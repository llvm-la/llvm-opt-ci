# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/reduce.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/reduce.c" 2
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/reduce.c"
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/reduce.c" 2

static int toggle = 1;
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/reduce.c"
pset_family reduce(F, D)
      pset_family F;
   pset_family D;
{
 ...
 if ((cunder)) { (void) free((char *) (cunder)); (cunder) = 0; };
    }
    if ((FD[0])) { (void) free((char *) (FD[0])); (FD[0]) = 0; }; if ((FD)) { (void) free((char *) (FD)); (FD) = 0; };;
...
pset sccc_merge(left, right, cl, cr)
      register pset left, right;
      register pset cl, cr;
{
    ...
    if ((right)) { (void) free((char *) (right)); (right) = 0; };
    if ((cl)) { (void) free((char *) (cl)); (cl) = 0; };
    if ((cr)) { (void) free((char *) (cr)); (cr) = 0; };
    return left;
}
# 154 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/reduce.c"
pset sccc_cube(result, p)
register pset result, p;
{
...
int sccc_special_cases(T, result)
      pset *T;
    pset *result;
{
 ...
 *result = set_copy(((unsigned int *) malloc(sizeof(unsigned int) * ((((32 * (cube.fullset[0] & 0x03ff))) <= 32 ? 2 : ((((((32 * (cube.fullset[0] & 0x03ff)))-1) >> 5) + 1) + 1))))), cube.fullset);
 ...
 if (full_row(p, cof)) {
    ...
    if (cdata.vars_unate == cdata.vars_active || T[3] == ((void*)0)) {
 *result = set_copy(((unsigned int *) malloc(sizeof(unsigned int) * ((((32 * (cube.fullset[0] & 0x03ff))) <= 32 ? 2 : ((((((32 * (cube.fullset[0] & 0x03ff)))-1) >> 5) + 1) + 1))))), cube.fullset);
 for(T1 = T+2; (p = *T1++) != ((void*)0); ) {
