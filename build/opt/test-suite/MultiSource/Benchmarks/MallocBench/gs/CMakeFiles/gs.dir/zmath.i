# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zmath.c" 2
...
{ float num;
 ...
 if ( num < 0.0 ) return (-15);
 ((op)->value.realval = (sqrt(num)), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ float num, result;
 ...
 ((op)->value.realval = (result), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ float args[2];
 ...
 ((op - 1)->value.realval = (result), ((op - 1)->type_attrs = (11) << 2));
 (osp -= (1));
 return 0;
}
...
{ float angle;
 ...
 if ( code < 0 ) return code;
 ((op)->value.realval = (cos(angle * degrees_to_radians)), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ float angle;
 int code = num_params(op, 1, &angle);
 if ( code < 0 ) return code;
 ((op)->value.realval = (sin(angle * degrees_to_radians)), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ float args[2];
 ...
 int code = num_params(op, 2, args);
 if ( code < 0 ) return code;
 if ( args[0] == 0.0 && args[1] == 0.0 ) return (-23);
...
{ float num;
 ...
 if ( code < 0 ) return code;
 if ( num <= 0.0 ) return (-15);
 ((op)->value.realval = (log(num)), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ float num;
 ...
 if ( code < 0 ) return code;
 if ( num <= 0.0 ) return (-15);
 ((op)->value.realval = (log10(num)), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ ulong value;
 ...
 value = (rand_state = rand_state * 0x41c64e6dL + 0x3039) << 21;
 value += (rand_state = rand_state * 0x41c64e6dL + 0x3039) << 10;
 value += (rand_state = rand_state * 0x41c64e6dL + 0x3039) >> 3;
 value &= 0x7fffffffL;
 if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
 ((op)->value.intval = (value), ((op)->type_attrs = (5) << 2));
 return 0;
}
...
{ if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
 ((op)->value.intval = (rand_state), ((op)->type_attrs = (5) << 2));
 return 0;
}
