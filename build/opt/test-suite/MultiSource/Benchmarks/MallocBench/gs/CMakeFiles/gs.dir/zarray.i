# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarray.c" 2





int make_array(register ref *,int,int,char *);


int
zarray(register ref *op)
{ int code = make_array(op, 0, (0x100 +0x200 +2), "array");
 if ( code < 0 ) return code;
    {
  ushort size = op->size;
  ref *abody = op->value.refs;
  while ( size-- ) abody++->type_attrs = (8 << 2);
    }
 return 0;
}
...
{ ref aref;
 ...
 aref = *op;
 if ( aref.size > ostop - op ) return (-15);
 memcpy((char *)op, (char *)aref.value.refs, aref.size * sizeof(ref));
 if ( (osp = op += (aref.size)) > ostop ) return (osp -= (aref.size), (-16));
 *op = aref;
 return 0;
}
...
{ uintptr_t size;
 if ( !(((&*op)->type_attrs & 0xfc) == ((0) << 2)) ) return (-20);
 if ( !!(~((&*op)->type_attrs) & (0x100)) ) return (-7);
 size = op->size;
 if ( size > op - osbot ) return (-17);
...
{ ref *abody;
 ...
 if ( op->value.intval < 0 ||
      op->value.intval > (2147483647 *2U +1U) / sizeof(ref) - 1
    )
  return (-15);
 size = op->value.intval;
 abody = (ref *)alloc(size, sizeof(ref), client_name);
 if ( abody == 0 ) return (-25);
 (((op)->value.refs = (abody), ((op)->type_attrs = ((type) << 2) + (attrs))), (op)->size = (size));
 return 0;
}
