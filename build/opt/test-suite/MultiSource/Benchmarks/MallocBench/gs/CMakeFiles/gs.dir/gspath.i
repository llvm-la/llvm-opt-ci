# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c" 2
...
{ gs_fixed_point pt;
 ...
 return gs_itransform(pgs, ((float)((pt.x)*(1.0/(1<<12)))), ((float)((pt.y)*(1.0/(1<<12)))), ppt);
}
...
{ gs_fixed_point cpt, dpt;
 ...
 return code;
        ...
        int arc_either(gs_state *,floatp,floatp,floatp,floatp,floatp,int);

        int arc_add(gs_state *,floatp,floatp,floatp,floatp,floatp,floatp,int);
...
{ fixed ang1 = ((fixed)((aang1)*(float)(1<<12))), ang2 = ((fixed)((aang2)*(float)(1<<12))), adiff;
 ...
 if ( ang1 != ang2 )
  ...
  ang2 %= ((fixed)(360)<<12);
  if ( clockwise )
     { if ( ang2 >= ang1 ) ang1 += ((fixed)(360)<<12);
     }
  else
     { if ( ang2 <= ang1 ) ang2 += ((fixed)(360)<<12);
     }
    }
 ang1r = ((float)((ang1)*(1.0/(1<<12)))) * (3.14159265358979323846 / 180.0);
 ...
 if ( adiff == 0 ) return 0;
    ...
    { float trad = tan(((float)((adiff)*(1.0/(1<<12)))) * ((3.14159265358979323846 / 180.0) / 2));
  float ang2r = ((float)((ang2)*(1.0/(1<<12)))) * (3.14159265358979323846 / 180.0);
...
{ float xt0, yt0, xt2, yt2;
 ...
 if ( (code = gs_currentpoint(pgs, &up0)) < 0 ) return code;
  ...
  float dx0 = up0.x - ax1, dy0 = up0.y - ay1;
