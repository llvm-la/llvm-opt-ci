# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxarith.h" 1
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c" 2


        int copy_path(gx_path *,gx_path *,int (*)(gx_path *,fixed,fixed,fixed,fixed,fixed,fixed));

        int flatten_curve(gx_path *,fixed,fixed,fixed,fixed,fixed,fixed);
  ...
  *pbox = ppath->bbox;
  ...
  while ( pseg )
   ...
   case s_curve:
    ...
    if ( (((curve_segment *)pseg)->p1).x < box.p.x ) box.p.x = (((curve_segment *)pseg)->p1).x; else if ( (((curve_segment *)pseg)->p1).x > box.q.x ) box.q.x = (((curve_segment *)pseg)->p1).x; if ( (((curve_segment *)pseg)->p1).y < box.p.y ) box.p.y = (((curve_segment *)pseg)->p1).y; else if ( (((curve_segment *)pseg)->p1).y > box.q.y ) box.q.y = (((curve_segment *)pseg)->p1).y;
    if ( (((curve_segment *)pseg)->p2).x < box.p.x ) box.p.x = (((curve_segment *)pseg)->p2).x; else if ( (((curve_segment *)pseg)->p2).x > box.q.x ) box.q.x = (((curve_segment *)pseg)->p2).x; if ( (((curve_segment *)pseg)->p2).y < box.p.y ) box.p.y = (((curve_segment *)pseg)->p2).y; else if ( (((curve_segment *)pseg)->p2).y > box.q.y ) box.q.y = (((curve_segment *)pseg)->p2).y;


   default:
    if ( (pseg->pt).x < box.p.x ) box.p.x = (pseg->pt).x; else if ( (pseg->pt).x > box.q.x ) box.q.x = (pseg->pt).x; if ( (pseg->pt).y < box.p.y ) box.p.y = (pseg->pt).y; else if ( (pseg->pt).y > box.q.y ) box.q.y = (pseg->pt).y;
      }
   pseg = pseg->next;
     }
...
{ segment *pseg;
 ...
 while ( pseg )
  ...
  case s_curve:
   ...
   pc->p1.x += dx, pc->p1.y += dy;
   pc->p2.x += dx, pc->p2.y += dy;
     }
  default:
...
gx_path_flatten(gx_path *ppath_old, gx_path *ppath, floatp flatness)
{
 ...
 float ff = flatness * ((float)((fixed)(1)<<12));
 scaled_flat = ff;
 scaled_flat_sq = ff * 0.45;
...
copy_path(gx_path *ppath_old, gx_path *ppath,
  int (*curve_proc)(gx_path *,fixed,fixed,fixed,fixed,fixed,fixed))
{ gx_path old;
 segment *pseg;
 int code;
...
# 300 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c"
        int
...
top:
    ...
    {
# 337 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxpath2.c"
  ...
  if ( (dx3 < 0 ? -dx3 : dx3) >= (dy3 < 0 ? -dy3 : dy3) )
   ...
   d = ((fixed)(t * t * scaled_flat_sq) + scaled_flat);
   ...
   if ( ((dist = (fixed)(t * (y1 - y0)) - x1 + x0) < 0 ?
    ...
    { fixed x01 = (((x0) +(x1)) >> (1)), y01 = (((y0) +(y1)) >> (1));
  fixed x12 = (((x1) +(x2)) >> (1)), y12 = (((y1) +(y2)) >> (1));
  fixed x02 = (((x01) +(x12)) >> (1)), y02 = (((y01) +(y12)) >> (1));
  int code;

  x2 = (((x2) +(x3)) >> (1)), y2 = (((y2) +(y3)) >> (1));
  x1 = (((x12) +(x2)) >> (1)), y1 = (((y12) +(y2)) >> (1));
  code = flatten_curve(
   ppath,
   x01, y01, x02, y02,
   (x0 = (((x02) +(x1)) >> (1))),
