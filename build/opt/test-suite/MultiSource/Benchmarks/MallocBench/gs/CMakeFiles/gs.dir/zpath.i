# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.h" 1
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.h"
extern int gs_newpath(gs_state *),
...
extern int gs_currentpoint(gs_state *,gs_point *),
  gs_pathbbox(gs_state *,gs_rect *),
...
void gs_path_enum_init(gs_path_enum *,gs_state *);
int gs_path_enum_next(gs_path_enum *,gs_point [3]);


extern int gs_clippath(gs_state *),
  gs_initclip(gs_state *),
  gs_clip(gs_state *),
  gs_eoclip(gs_state *);
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
...
extern gs_state *igs;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath.c" 2


        int common_to(ref *,int (*)(gs_state *,floatp,floatp));

        int common_arc(ref *,int (*)(gs_state *,floatp,floatp,floatp,floatp,floatp));

        int common_arct(ref *,float *);
        int common_curve(ref *,int (*)(gs_state *,floatp,floatp,floatp,floatp,floatp,floatp));



extern int num_params(ref *,int,float *);
...
{ gs_point pt;
 ...
 ((op - 1)->value.realval = (pt.x), ((op - 1)->type_attrs = (11) << 2));
 ((op)->value.realval = (pt.y), ((op)->type_attrs = (11) << 2));
 return 0;
}
...
{ return common_to(op, gs_rlineto);
        ...
        int
common_to(ref *op, int (*add_proc)(gs_state *,floatp,floatp))
{ float opxy[2];
 int code;
...
{ float tanxy[4];
 ...
 if ( code < 0 ) return code;
 ((op - 4)->value.realval = (tanxy[0]), ((op - 4)->type_attrs = (11) << 2));
 ((op - 3)->value.realval = (tanxy[1]), ((op - 3)->type_attrs = (11) << 2));
 ((op - 2)->value.realval = (tanxy[2]), ((op - 2)->type_attrs = (11) << 2));
 ((op - 1)->value.realval = (tanxy[3]), ((op - 1)->type_attrs = (11) << 2));
 (osp -= (1));
 return 0;
}
