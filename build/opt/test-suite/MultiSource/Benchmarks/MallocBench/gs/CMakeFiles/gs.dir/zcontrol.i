# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c" 2
...
extern ref *esp;
extern ref *estop;
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zcontrol.c" 2
...
{ if ( op < osp_nargs[(1) - 1] ) return (-17);
 if ( esp + (1) > estop ) return (-5);
 ++esp;
 (*(esp) = *(op));
 (osp -= (1));
 return 1;
...
int
zif(register ref *op)
{ if ( !(((&op[-1])->type_attrs & 0xfc) == ((1) << 2)) ) return (-20);
 if ( op[-1].value.index )
    { if ( esp + (1) > estop ) return (-5);
  ++esp;
  (*(esp) = *(op));
...
{ if ( !(((&op[-2])->type_attrs & 0xfc) == ((1) << 2)) ) return (-20);
 if ( esp + (1) > estop ) return (-5);
 ++esp;
 if ( op[-2].value.index )
    { ((esp)[0] = (op)[-1]);
 ...
 return 1;
        ...
        int
  for_int_continue(ref *),
  for_real_continue(ref *);
int
zfor(register ref *op)
{ int code = num_params(op - 1, 3, (float *)0);
 if ( code < 0 ) return code;
 if ( esp + (7) > estop ) return (-5);
 ...
 *++esp = *op;
 ...
 if ( code == 7 )
  return for_int_continue(op);
    ...
    { if ( code & 1 ) ((esp - 3)->value.realval = (esp[-3].value.intval), ((esp - 3)->type_attrs = (11) << 2));
  if ( code & 2 ) ((esp - 2)->value.realval = (esp[-2].value.intval), ((esp - 2)->type_attrs = (11) << 2));
  if ( code & 4 ) ((esp - 1)->value.realval = (esp[-1].value.intval), ((esp - 1)->type_attrs = (11) << 2));
 ...
 *op = esp[-3];
 ...
 proc = *esp;
 (++esp, (((esp)->value.opproc = (for_int_continue), ((esp)->type_attrs = ((9) << 2) + (1))), (esp)->size = (0)));
 *++esp = proc;
 return 1;
}
 ...
 *op = esp[-3];
 ...
 proc = *esp;
 (++esp, (((esp)->value.opproc = (for_real_continue), ((esp)->type_attrs = ((9) << 2) + (1))), (esp)->size = (0)));
 *++esp = proc;
 return 1;
}


        int repeat_continue(ref *);
int
zrepeat(register ref *op)
{ if ( !(((&op[-1])->type_attrs & 0xfc) == ((5) << 2)) ) return (-20);
 if ( op[-1].value.intval < 0 ) return (-15);
 if ( esp + (5) > estop ) return (-5);
...
{ ref proc;
 proc = *esp;
 if ( --(esp[-1].value.intval) >= 0 )
    { (++esp, (((esp)->value.opproc = (repeat_continue), ((esp)->type_attrs = ((9) << 2) + (1))), (esp)->size = (0)));
  *++esp = proc;
    }
 else
    { esp -= 3;
 ...
 return 1;
        ...
        int loop_continue(ref *);
int
zloop(register ref *op)
{ if ( op < osp_nargs[(1) - 1] ) return (-17);
 if ( esp + (4) > estop ) return (-5);
...
{ ref proc;
 proc = *esp;
 (++esp, (((esp)->value.opproc = (loop_continue), ((esp)->type_attrs = ((9) << 2) + (1))), (esp)->size = (0)));
 *++esp = proc;
 return 1;
}
...
{ ref *ep = esp;
 while ( ep >= estack )
    { if ( (((ep)->type_attrs & 0xff) >> 2) == 8 )
   switch ( (ep--)->value.index )
      {
   case 2: esp = ep; return 1;
   case 3: return (-8);
      }
  else
   ep--;
...
{ ref *ep = esp;
 while ( ep >= estack )
    { if ( (((ep)->type_attrs & 0xff) >> 2) == 8 && ep->value.index == 3 )
     { esp = ep - 1;
   if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
...
{ if ( op < osp_nargs[(1) - 1] ) return (-17);
 ...
 (++esp, ((esp)->value.index = (3), ((esp)->type_attrs = ((8) << 2) + (1))));
 ++esp; ((esp)->value.index = (0), ((esp)->type_attrs = (1) << 2));
 *++esp = *op;
 (osp -= (1));
 return 1;
}
...
{ if ( (osp = op += (1)) > ostop ) return (osp -= (1), (-16));
 ((op)->value.intval = (esp - estack + 1), ((op)->type_attrs = (5) << 2));
 return 0;
}


        int continue_execstack(ref *);
int
zexecstack(register ref *op)
{
 ...
 if ( !(((&*op)->type_attrs & 0xfc) == ((0) << 2)) ) return (-20); if ( !!(~((&*op)->type_attrs) & (0x100)) ) return (-7);
 if ( depth > op->size ) return (-15);
 if ( estack >= estop ) return (-5);
 op->size = depth;
 ((op)->type_attrs |= (0x8000));
 (++esp, (((esp)->value.opproc = (continue_execstack), ((esp)->type_attrs = ((9) << 2) + (1))), (esp)->size = (0)));
 return 1;
}
