# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/name.h" 1
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/name.h"
struct name_s {
 struct name_s *next;
 ushort index;
...
# 52 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/name.h"
extern int name_ref(byte *ptr,uint size,ref *pnref,int enterflag);
extern void name_string_ref(ref *pnref,ref *psref);
extern void name_enter(char *str,ref *pnref);


extern void name_index_ref(uint index,ref *pnref);
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/sstorei.h" 1
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/stream.h" 1
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/stream.h"
typedef struct stream_s stream;
typedef struct {
 int (*read)(stream *);
 int (*write)(stream *,byte);
...
struct stream_s {
 ...
 stream_procs procs;
 int num_format;
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/stream.h"
 FILE *file;
...
# 86 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/stream.h"
extern uint sgets(stream *,byte *,uint);
extern int sreadhex(stream *,byte *,uint,uint *,int *);
extern int sungetc(stream *,byte);
...
extern uint sputs(stream *,byte *,uint);
# 111 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/stream.h"
extern void sread_string(stream *,byte *,uint),
  swrite_string(stream *,byte *,uint);
extern void sread_file(stream *,FILE *,byte *,uint),
  swrite_file(stream *,FILE *,byte *,uint);
extern void sread_decrypt(stream *,stream *,byte *,uint,ushort);
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c" 2


        int interp(ref *pref);
        int interp_exit(ref *);
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c"
        ref ostack[10 +500 +10];
ref estack[150 + 1];
ref dstack[20];
ref *osp_nargs[6];
...
extern int zadd(ref *);
extern int zdup(ref *);
extern int zexch(ref *);
extern int zifelse(ref *);
extern int zle(ref *);
extern int zpop(ref *);
extern int zsub(ref *);
        op_proc_p special_ops[] = {
...
interp_init(int ndict)
{
 ...
 osbot = ostack + 10;
 osp = osbot - 1, ostop = osbot + (500 -1);
    { ref *op;
  for ( op = ostack; op < osbot; op++ )
   ((op)->value.index = (0), ((op)->type_attrs = ((-1) << 2) + (0)));
    }
    { int i;
  for ( i = 1; i < 6; i++ )
   osp_nargs[i] = osbot + i - 1;
    }
 esp = estack, estop = estack + 150;



 dsp = dstack + ndict - 1, dstop = dstack + (20 -1);
}
...
{ int i = ((int)tx_next_op - 16);
 op_proc_p proc = opref->value.opproc;
 while ( --i >= 0 && proc != special_ops[i] ) ;
 if ( i >= 0 ) ((opref)->value.opproc = (proc), ((opref)->type_attrs = ((16 + i) << 2) + (1)));
}
...
{ ref *epref = pref;
 ...
 esp++;
 ((esp)->value.opproc = (interp_exit), ((esp)->type_attrs = ((9) << 2) + (1)));
retry: code = interp(epref);
 ...
 if ( dict_lookup(dstack,dstack,&name_errordict,&perrordict) <= 0 ||
      dict_lookup(perrordict,perrordict,&name_ErrorNames,&pErrorNames) <= 0
    )
  return code;
 switch ( code )
    {
 ...
 if ( code > -2 || -code > pErrorNames->size )
  return code;
 if ( dict_lookup(perrordict,perrordict,&pErrorNames->value.refs[-code - 1],&epref) <= 0 )
  return code;
 erref = *epref;
 epref = &erref;
...
{ register ref *iref = pref;
 ...
 register ref *iosp = osp;
 register ref *iesp = esp;
 int code;
 ref token;
 ...
 if ( iesp >= estop ) { esp = iesp; error_object = *(pref); return (-5); };
 *++iesp = *pref;
 goto bot;
...
top:
# 231 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c"
sw:


 switch ( ((iref)->type_attrs & 0xff) )
    {

 case ((0) << 2): case (((0) << 2) + 1):
 case ((2) << 2): case (((2) << 2) + 1):
 case ((3) << 2): case (((3) << 2) + 1):
 case ((10) << 2): case (((10) << 2) + 1):
 case ((13) << 2): case (((13) << 2) + 1):
  { esp = iesp; error_object = *(iref); return (-7); };
 ...
 case ((9) << 2):
 case (((10) << 2) + 2):
 case ((11) << 2): case (((11) << 2) + 1):
 case ((12) << 2): case (((12) << 2) + 1):
 case (((13) << 2) + 2):
 case ((14) << 2): case (((14) << 2) + 1):
 case ((15) << 2): case (((15) << 2) + 1):
  break;

 case (((tx_op_add) << 2) + 1):
  if ( (code = zadd(iosp)) < 0 )
   { esp = iesp; error_object = *(iref); return code; };
  iosp--;
  if ( --icount > 0 ) { iref++; goto top; } else goto out;
 case (((tx_op_dup) << 2) + 1):
  if ( iosp < osp_nargs[1] )
   { esp = iesp; error_object = *(iref); return (-17); };
  iosp++;
  ((iosp)[0] = (iosp)[-1]);
  if ( --icount > 0 ) { iref++; goto top; } else goto out;
 case (((tx_op_exch) << 2) + 1):
  ...
  ((iosp)[-1] = (ptoken)[0]);
  if ( --icount > 0 ) { iref++; goto top; } else goto out;
 case (((tx_op_ifelse) << 2) + 1):
  if ( (((iosp - 2)->type_attrs & 0xff) >> 2) != 1 )
   { esp = iesp; error_object = *(iref); return (-20); };
  if ( iesp >= estop )
   { esp = iesp; error_object = *(iref); return (-5); };
  ( icount > 0 ? (iesp->value.refs = iref + 1, iesp->size = icount) : 0 );
  iosp -= 3;

     { ref *whichp =
     (iosp[1].value.index ? iosp + 2 : iosp + 3);
   switch( ((whichp)->type_attrs & 0xff) )
      {
   default:
    ((iesp)[1] = (whichp)[0]);
    iref = iesp + 1;
 ...
 case (((tx_op_le) << 2) + 1):
  ...
  if ( code < 0 )
   { esp = iesp; error_object = *(iref); return code; };
  iosp--;
  ((iosp)->value.index = (code), ((iosp)->type_attrs = (1) << 2));
  if ( --icount > 0 ) { iref++; goto top; } else goto out;
 case (((tx_op_pop) << 2) + 1):
  if ( iosp < osp_nargs[1] )
   { esp = iesp; error_object = *(iref); return (-17); };
 ...
 case (((9) << 2) + 1):
    { esp = iesp;
  osp = iosp;
# 345 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c"
  ...
  if ( code != 0 )
   ...
   case 1:
    ...
    if ( esp > iesp ) ( icount > 0 ? (iesp->value.refs = iref + 1, iesp->size = icount) : 0 );
 ...
 case (((7) << 2) + 1):
  ...
  if ( !((unsigned long)(pvalue) > 1) )
   ...
   if ( dict_lookup(dstack, dsp, iref, &pdvalue) <= 0 )
    { esp = iesp; error_object = *(iref); return (-21); };
   pvalue = pdvalue;
     }
  switch ( ((pvalue)->type_attrs & 0xff) )
     {
  case (((0) << 2) + 2 + 1):
  case (((10) << 2) + 2 + 1):
   ...
   if ( iesp >= estop )
    { esp = iesp; error_object = *(pvalue); return (-5); };
   ++iesp;
   (*(iesp) = *(pvalue));
  ...
  case (((9) << 2) + 1):
   ...
   if ( code != 0 )
    ...
    { esp = iesp; error_object = *(pvalue); return code; };
      }
   if ( --icount > 0 ) { iref++; goto top; } else goto out;
     }
  case (((0) << 2) + 2):
  ...
  case (((13) << 2) + 2):
   ...
   if ( iosp >= ostop )
    { esp = iesp; error_object = *(pvalue); return (-16); };
   ++iosp;
   (*(iosp) = *(pvalue));
   if ( --icount > 0 ) { iref++; goto top; } else goto out;
  default:
 ...
 case (((3) << 2) + 2 + 1):
  ...
  if ( code < 0 ) { esp = iesp; error_object = *(iref); return code; };
  osp = iosp;
 ...
 if ( iosp >= ostop ) { esp = iesp; error_object = *(iref); return (-16); };
 ++iosp;
 (*(iosp) = *(iref));
bot: if ( --icount > 0 ) { iref++; goto top; } else goto out;
out:
