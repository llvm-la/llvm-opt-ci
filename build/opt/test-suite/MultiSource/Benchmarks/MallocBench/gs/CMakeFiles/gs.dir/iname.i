# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c" 2
...
typedef name name_sub_table[(1 << 7)];
typedef struct {
 name *hash[256];
 name *table[1 << (16 - 7)];
 uint count;
...
{ register name **ppname;
 register name *pname;
 byte *cptr;
 ushort size = (ushort)isize;
 if ( size == 1 )
    { pname = ((the_nt)->table[(*ptr) >> 7] + ((*ptr) & ((1 << 7) - 1)));
  if ( pname->string_size != 0 )
     { ((pref)->value.pname = (pname), ((pref)->type_attrs = (7) << 2));
   return 0;
     }
  if ( enterflag < 0 ) return (-21);
  pname->index = *ptr;
    }
 else
    { ushort hash = (ushort)string_hash(ptr, size);
  ppname = the_nt->hash + (hash & (256 - 1));
  ...
  if ( enterflag < 0 ) return (-21);
  if ( !(the_nt->count & ((1 << 7) - 1)) )
     { int code = name_alloc_sub(the_nt);
   if ( code < 0 ) return code;
     }
  pname = ((the_nt)->table[(the_nt->count) >> 7] + ((the_nt->count) & ((1 << 7) - 1)));
...
void
name_string_ref(ref *pnref , ref *psref )
{ name *pname = pnref->value.pname;
 (((psref)->value.bytes = (pname->string_bytes), ((psref)->type_attrs = ((13) << 2) + (0x200 +2))), (psref)->size = (pname->string_size));
...
{ if ( name_ref((byte *)str, strlen(str), pref, 0) )
  ( fprintf(stderr, "%s(%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iname.c", 135), fprintf(stderr, "name_enter failed - %s", str)), exit(1);
}


void
name_index_ref(uint index, ref *pnref)
{ ((pnref)->value.pname = (((the_nt)->table[(index) >> 7] + ((index) & ((1 << 7) - 1)))), ((pnref)->type_attrs = (7) << 2));
}
