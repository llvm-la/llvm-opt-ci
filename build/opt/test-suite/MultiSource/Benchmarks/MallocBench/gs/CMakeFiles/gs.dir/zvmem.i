# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
extern gs_state *igs;
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zvmem.c" 2
...
{ int code = zgsave(op);
 ...
 ((op)->value.psave = (vmsave), ((op)->type_attrs = (12) << 2));
 return 0;
}


        int restore_check_stack(ref *,ref *,alloc_save *);
int
zrestore(register ref *op)
{ vm_save *vmsave;
 alloc_save *asave;
 int code;
 if ( !(((&*op)->type_attrs & 0xfc) == ((12) << 2)) ) return (-20);
...
{ ref *stkp;
 for ( stkp = bot; stkp < top; stkp++ )
    { char *ptr;
  switch ( (((stkp)->type_attrs & 0xff) >> 2) )
     {
  case 0:
  case 10: ptr = (char *)stkp->value.refs; break;
  case 2: ptr = (char *)stkp->value.pdict; break;
  case 4: ptr = (char *)stkp->value.pfont; break;

  case 7: ptr = (char *)stkp->value.pname; break;
  case 12: ptr = (char *)stkp->value.psave; break;
  case 13: ptr = (char *)stkp->value.bytes; break;
  case 14: ptr = (char *)stkp->value.pcolor; break;
  case 15: ptr = (char *)stkp->value.pdevice; break;
  default: continue;
     }
...
{ long used, total;
 ...
 ((op - 2)->value.intval = (alloc_save_level()), ((op - 2)->type_attrs = (5) << 2));
 ((op - 1)->value.intval = (used), ((op - 1)->type_attrs = (5) << 2));
 ((op)->value.intval = (total), ((op)->type_attrs = (5) << 2));
 return 0;
}
