# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zstring.c" 2
...
{ byte *sbody;
 ...
 if ( op->value.intval < 0 || (ulong)(op->value.intval) > (2147483647 *2U +1U) )
  return (-15);
 size = op->value.intval;
 sbody = (byte *)alloc(size, 1, "string");
 if ( sbody == 0 ) return (-25);
 (((op)->value.bytes = (sbody), ((op)->type_attrs = ((13) << 2) + ((0x100 +0x200 +2)))), (op)->size = (size));
 memset(sbody, 0, size);
 return 0;
}
...
{ ref *op1 = op - 1;
 uint size = op->size;
 if ( !(((&*op1)->type_attrs & 0xfc) == ((13) << 2)) ) return (-20); if ( !!(~((&*op1)->type_attrs) & (0x200)) ) return (-7);
...
{ stream st;
 ...
 switch ( code = scan_token(s, 1, &token) )
    {
 case 0:
    { uint pos = ((s)->cptr + 1 - (s)->cbuf + (s)->position);
  op->value.bytes += pos;
  op->size -= pos;
  ((op)->type_attrs |= (0x8000));
    }
