# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
extern ref *esp;
extern ref *estop;
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
extern int gs_clippath(gs_state *),
  ...
  gs_clip(gs_state *),
  gs_eoclip(gs_state *);
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
extern gs_state *igs;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zpath2.c" 2
...
{ gs_rect box;
 ...
 if ( (osp = op += (4)) > ostop ) return (osp -= (4), (-16));
 ((op - 3)->value.realval = (box.p.x), ((op - 3)->type_attrs = (11) << 2));
 ((op - 2)->value.realval = (box.p.y), ((op - 2)->type_attrs = (11) << 2));
 ((op - 1)->value.realval = (box.q.x), ((op - 1)->type_attrs = (11) << 2));
 ((op)->value.realval = (box.q.y), ((op)->type_attrs = (11) << 2));
 return 0;
}


        int path_continue(ref *);
int
zpathforall(register ref *op)
{ gs_path_enum *penum;
 if ( op < osp_nargs[(4) - 1] ) return (-17);
 if ( esp + (8) > estop ) return (-5);
 ...
 *++esp = *op;
 ++esp;
 ((esp)->value.bytes = ((byte *)penum), ((esp)->type_attrs = (5) << 2));
 (osp -= (4)); op -= 4;
 return path_continue(op);
}

        int pf_push(gs_point *,int,ref *);
        int
...
{ gs_path_enum *penum = (gs_path_enum *)esp->value.bytes;
 ...
 if ( code < 0 ) return code;
 (++esp, (((esp)->value.opproc = (path_continue), ((esp)->type_attrs = ((9) << 2) + (1))), (esp)->size = (0)));
 ++esp;
 return 1;
}
...
{ while ( n-- )
   { if ( (osp = op += (2)) > ostop ) return (osp -= (2), (-16));
     ((op - 1)->value.realval = (ppts->x), ((op - 1)->type_attrs = (11) << 2));
     ((op)->value.realval = (ppts->y), ((op)->type_attrs = (11) << 2));
     ppts++;
   }
 return 0;
}
