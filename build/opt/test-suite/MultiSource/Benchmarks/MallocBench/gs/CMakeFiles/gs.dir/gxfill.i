# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c" 2
...
typedef struct active_line_s {
 ...
 fixed y_fast_max;
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
 fixed x_current;
 fixed x_next;
 segment *pseg;
 int direction;
...
# 88 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
struct line_list_s {
 active_line *area;
 uint area_count;
 short tag;
...
typedef struct line_list_s line_list;
        ...
        int alloc_line_list(line_list *,int);
        void add_y_list(gx_path *,short,line_list *,gs_fixed_rect *);
        void add_y_line(segment *,segment *,int,line_list *);
        void fill_loop(gx_device_color *,int,line_list *,gs_fixed_rect *,gs_state *,fixed);

        void insert_x_new(active_line *,line_list *);
        void swap_group(active_line *);
        void ended_line(active_line *);
# 136 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
int
...
{ gx_path *cpath = pgs->clip_path;
 ...
 if ( !(code = alloc_line_list(&lst, max_active)) )
  ...
  if ( ibox.q.y <= cpath->cbox.q.y &&
   ...
   if ( cpath->bbox.p.x > ibox.p.x ) ibox.p.x = cpath->bbox.p.x;
   if ( cpath->bbox.p.y > ibox.p.y ) ibox.p.y = cpath->bbox.p.y;
   if ( cpath->bbox.q.x < ibox.q.x ) ibox.q.x = cpath->bbox.q.x;
   if ( cpath->bbox.q.y < ibox.q.y ) ibox.q.y = cpath->bbox.q.y;
...
# 201 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
 return code;
}
...
{ register segment *pseg = (segment *)ppath->first_subpath;
 ...
 while ( pseg )
  ...
  default:
     { fixed iy = pseg->pt.y;
   fixed py = prev->pt.y;
# 254 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
   dir = (prev->pt.x > xmax && pseg->pt.x > xmax ? 0 : (dy = iy - py) > 0 ? (iy <= ymin || py >= ymax ? 0 : 1) : dy < 0 ? (py <= ymin || iy >= ymax ? 0 : (-1)) : 0);
   if ( dir > prev_dir )
      { if ( prev_dir )
   ...
   if ( pseg == plast )
    ...
    if ( pseg->type != s_line_close )
     ...
     int cdir;
     py = psub->pt.y;
     cdir = (pseg->pt.x > xmax && psub->pt.x > xmax ? 0 : (dy = py - iy) > 0 ? (py <= ymin || iy >= ymax ? 0 : 1) : dy < 0 ? (iy <= ymin || py >= ymax ? 0 : (-1)) : 0);
     if ( cdir > dir && dir )
       add_y_line(prev, pseg, dir, ll);
...
{ gs_fixed_point this, prev;
 ...
 if ( (alp->direction = dir) > 0 )
    {
  y_start = prev.y;
  (alp)->y_fast_max = 0x7fffffffL / (((this).x > (prev).x ? (this).x - (prev).x : (prev).x - (this).x) | 1) + (prev).y, (alp)->start = prev, (alp)->end = this;
  alp->pseg = lp;
    }
 else
    {
  y_start = this.y;
  (alp)->y_fast_max = 0x7fffffffL / (((prev).x > (this).x ? (prev).x - (this).x : (this).x - (prev).x) | 1) + (this).y, (alp)->start = this, (alp)->end = prev;
  alp->pseg = prev_lp;
    }
  ...
  if ( yp == 0 )
   ...
   ll->y_list = alp;
     ...
     {
   while ( 0, (nyp = yp->next) != ((void*)0) && y_start > nyp->start.y )
    yp = nyp;
   alp->next = nyp;
   alp->prev = yp;
   yp->next = alp;
   if ( nyp ) nyp->prev = alp;
     ...
     {
   while ( 0, (nyp = yp->prev) != ((void*)0) && y_start < nyp->start.y )
    yp = nyp;
   alp->prev = nyp;
   alp->next = yp;
   yp->prev = alp;
...
{ double edy = (double)((endp)->end.y - (endp)->start.y);
 double ady = (double)((alp)->end.y - (alp)->start.y);
 ...
 return (fixed)((((double)endp->start.x * endp->end.y - (double)endp->start.y * endp->end.x) * ady - ((double)alp->start.x * alp->end.y - (double)alp->start.y * alp->end.x) * edy) / (((alp)->end.x - (alp)->start.x) * edy - ((endp)->end.x - (endp)->start.x) * ady));
# 376 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
}
...
{ active_line *yll = ll->y_list;
 ...
 while ( 1 )
  ...
  y1 = (yll != 0 ? yll->start.y : 0x7fffffffL);
  for ( alp = ll->x_head.next; alp != 0; alp = alp->next )
    if ( alp->end.y < y1 ) y1 = alp->end.y;
# 434 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
  end_count = 0;
  x = (~0x7fffffffL);
  alstop = ll->x_head.next;



  for ( alp = alstop; 0, alp != 0;
       endp = alp, alp = alp->next
      )
     {
   fixed nx = ((y1) == (alp)->end.y ? (alp)->end.x : ((y1) <= (alp)->y_fast_max ? ((y1) - (alp)->start.y) * ((alp)->end.x - (alp)->start.x) / ((alp)->end.y - (alp)->start.y) : (0, (fixed)((double)((y1) - (alp)->start.y) * ((alp)->end.x - (alp)->start.x) / ((alp)->end.y - (alp)->start.y)))) + (alp)->start.x);
   alp->x_next = nx;
   if ( nx < x )
      {
    y1 = find_cross_y(endp, alp);
    while ( 1 )
       { x = ((y1) == (endp)->end.y ? (endp)->end.x : ((y1) <= (endp)->y_fast_max ? ((y1) - (endp)->start.y) * ((endp)->end.x - (endp)->start.x) / ((endp)->end.y - (endp)->start.y) : (0, (fixed)((double)((y1) - (endp)->start.y) * ((endp)->end.x - (endp)->start.x) / ((endp)->end.y - (endp)->start.y)))) + (endp)->start.x);
     nx = ((y1) == (alp)->end.y ? (alp)->end.x : ((y1) <= (alp)->y_fast_max ? ((y1) - (alp)->start.y) * ((alp)->end.x - (alp)->start.x) / ((alp)->end.y - (alp)->start.y) : (0, (fixed)((double)((y1) - (alp)->start.y) * ((alp)->end.x - (alp)->start.x) / ((alp)->end.y - (alp)->start.y)))) + (alp)->start.x);
     if ( nx <= x ) break;
  ...
  for ( alp = ll->x_head.next; alp != alstop; alp = alp->next )
   alp->x_next = ((y1) == (alp)->end.y ? (alp)->end.x : ((y1) <= (alp)->y_fast_max ? ((y1) - (alp)->start.y) * ((alp)->end.x - (alp)->start.x) / ((alp)->end.y - (alp)->start.y) : (0, (fixed)((double)((y1) - (alp)->start.y) * ((alp)->end.x - (alp)->start.x) / ((alp)->end.y - (alp)->start.y)))) + (alp)->start.x);
# 492 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxfill.c"
     { active_line *alp = ll->x_head.next;
   fixed height = y1 - y;
   fixed xlbot, xltop;
   int inside[2];
   inside[0] = 0;
   ...
   while ( alp != 0 )
    ...
    0;
    0;
    if ( ((inside[0] & rule) && (inside[1] & pgs->clip_rule)) )
...
{ segment *pseg = alp->pseg;
 ...
 if ( alp->direction == 1 )
  ...
  if ( next == 0 || next->type == s_start )
   next = pseg;
    ...
    {
  next = (pseg->type == s_start ? pseg : pseg->prev);
    }
 npt.y = next->pt.y;
 ...
 if ( npt.y <= y )
  ...
  if ( nlp ) nlp->prev = alp->prev;
    ...
    { alp->pseg = next;
  npt.x = next->pt.x;
  (alp)->y_fast_max = 0x7fffffffL / (((npt).x > (alp->end).x ? (npt).x - (alp->end).x : (alp->end).x - (npt).x) | 1) + (alp->end).y, (alp)->start = alp->end, (alp)->end = npt;
  0;
    }
}
