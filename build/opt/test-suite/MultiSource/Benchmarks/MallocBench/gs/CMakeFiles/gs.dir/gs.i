# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.h"
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c" 2
...
char **gs_lib_paths;
        ...
        char *gs_lib_default_path = ".:./fonts";
...
{ int num_files;
 int code;
 int swproc(char,char *);
 void argproc(char *,int);
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c"
 gs_lib_env_path = 0;
...
{ switch ( sw )
 ...
 case 'q':
  ...
  quiet = 1;
  init1();
  ((&vnull)->value.intval = (0), ((&vnull)->type_attrs = (8) << 2));
 ...
 case 's':
  ...
  init1();
  if ( eqp == ((void*)0) )
     { ((&value)->value.intval = (0), ((&value)->type_attrs = (8) << 2));
     }
  else if ( eqp == arg )
   ...
   *eqp++ = 0;
   if ( sw == 'D' || sw == 'd' )
    ...
    if ( str == 0 )
       { ( fprintf(stderr, "%s(%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gs.c", 153), fprintf(stderr, "Out of memory!\n"));
     gs_exit(1);
       }
    strcpy(str, eqp);
    (((&value)->value.bytes = ((byte *)str), ((&value)->type_attrs = ((13) << 2) + (0x200 +2))), (&value)->size = (len));
 ...
 case 'h':
  ...
  code = scan_token(&astream, 0, &value);
  if ( code || ((((&value)->type_attrs & 0xff) >> 2) != 5 && (((&value)->type_attrs & 0xff) >> 2) != 11) )
...
{ ref stref;
 (((&stref)->value.bytes = ((byte *)str), ((&stref)->type_attrs = ((13) << 2) + (1 + 0x200 + 2))), (&stref)->size = (strlen(str)));
...
{ ref initial_file;
 ...
 if ( lib_file_open(file_name, strlen(file_name), &initial_file) < 0 )
    { ( fprintf(stderr, "Can't find file %s (from command line)\n", file_name));
  gs_exit(1);
    }
 if ( !quiet )
