# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c" 2
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c"
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c" 2
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c" 2
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c" 2
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zarith.c"
int
zadd(register ref *op)
{ switch ( (((op)->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: switch ( ((((op-1))->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: (op-1)->value.realval += op->value.realval; break; case 5: (((op-1))->value.realval = ((op-1)->value.intval + op->value.realval), (((op-1))->type_attrs = (11) << 2)); } break; case 5: switch ( ((((op-1))->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: (op-1)->value.realval += op->value.intval; break; case 5:
    { long int2 = op->value.intval;
  if ( (((op-1)->value.intval += int2) ^ int2) < 0 &&
       (((op-1)->value.intval - int2) ^ int2) >= 0
     )
     {
   (((op-1))->value.realval = ((float)(op-1)->value.intval - int2), (((op-1))->type_attrs = (11) << 2));
     }
    }
 } }
 (osp -= (1));
...
{ register ref *op1 = op - 1;
 ...
 default: return (-20);
 case 11:
  if ( op->value.realval == 0 ) return (-23);
  switch ( (((op1)->type_attrs & 0xff) >> 2) )
     {
  default: return (-20);
  case 11: op1->value.realval /= op->value.realval; break;
  case 5: ((op1)->value.realval = (op1->value.intval / op->value.realval), ((op1)->type_attrs = (11) << 2));
     }
  break;
 case 5:
  if ( op->value.intval == 0 ) return (-23);
  switch ( (((op1)->type_attrs & 0xff) >> 2) )
     {
  default: return (-20);
  case 11: op1->value.realval /= op->value.intval; break;
  case 5: ((op1)->value.realval = ((float)op1->value.intval / op->value.intval), ((op1)->type_attrs = (11) << 2));
     }
    }
 (osp -= (1));
 return 0;
...
{ switch ( (((op)->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: switch ( ((((op-1))->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: (op-1)->value.realval *= op->value.realval; break; case 5: (((op-1))->value.realval = ((op-1)->value.intval * op->value.realval), (((op-1))->type_attrs = (11) << 2)); } break; case 5: switch ( ((((op-1))->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: (op-1)->value.realval *= op->value.intval; break; case 5:
  ...
  if ( (abs1 > 0x7fff || abs2 > 0x7fff) &&
   ...
   (((op-1))->value.realval = (fprod), (((op-1))->type_attrs = (11) << 2));
  else
...
{ switch ( (((op)->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: switch ( ((((op-1))->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: (op-1)->value.realval -= op->value.realval; break; case 5: (((op-1))->value.realval = ((op-1)->value.intval - op->value.realval), (((op-1))->type_attrs = (11) << 2)); } break; case 5: switch ( ((((op-1))->type_attrs & 0xff) >> 2) ) { default: return (-20); case 11: (op-1)->value.realval -= op->value.intval; break; case 5:
  ...
  if ( (int1 ^ ((op-1)->value.intval = int1 - op->value.intval)) < 0 &&
     ...
     {
   (((op-1))->value.realval = ((float)int1 - op->value.intval), (((op-1))->type_attrs = (11) << 2));
     }
    }
 } }
 (osp -= (1));
...
{ switch ( (((op)->type_attrs & 0xff) >> 2) )
    {
 default: return (-20);
 case 11: op->value.realval = -op->value.realval; break;
 case 5:
  if ( op->value.intval == -0x80000000L )
   ((op)->value.realval = (-(float)-0x80000000L), ((op)->type_attrs = (11) << 2));
  else
...
{ switch ( (((op)->type_attrs & 0xff) >> 2) )
    {
 default: return (-20);
 case 11: op->value.realval = ceil(op->value.realval);
 case 5: ;
    }
 return 0;
}
...
{ switch ( (((op)->type_attrs & 0xff) >> 2) )
    {
 default: return (-20);
 case 11: op->value.realval = floor(op->value.realval);
 case 5: ;
    }
 return 0;
}
...
{ switch ( (((op)->type_attrs & 0xff) >> 2) )
    {
 default: return (-20);
 case 11: op->value.realval = floor(op->value.realval + 0.5);
 case 5: ;
    }
 return 0;
}
