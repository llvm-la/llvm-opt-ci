# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c" 2
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c"
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdefs.h" 1
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdefs.h"
extern void *malloc();
...
extern int free();
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdefs.h"
...
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdefs.h" 2
typedef uint8_t u8;
typedef uint16_t u16;
typedef uint32_t u32;
typedef u8 boolean;
# 65 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdefs.h"
typedef u32 accumulator;
...
# 130 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdefs.h"
extern precision palloc();
extern int pfree();
extern void pnorm();
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/precision.h"
...
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c" 2
   ...
   register precision u;
{
   ...
   if (uPtr == u->value && *uPtr == 0) u->sign = 0;

   u->size = (uPtr - u->value) + 1;
}
   ...
   register posit size;
{
   ...
   register cacheType *kludge;
# 103 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c"
      w = (precision) (char *) malloc((sizeof(precisionType) - sizeof(digitString)) + sizeof(digit) * size);
      if (w == ((precision) 0)) {
  w = errorp(1, "palloc", "out of memory");
  return w;
      }
   ...
   register precision u;
{
   ...
   size = u->alloc;
# 147 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c"
      free(u);
...
# 177 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c"
precision psetv(up, v)
   register precision *up, v;
{
   register precision u;
# 190 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pops.c"
   if (up == ((precision *) 0)) {
      errorp(4, "pset", "lvalue is pNull");
   }
   u = *up;
   ...
   *up = v;
   ...
   if (u != ((precision) 0)) {
      if (u->sign & ~1) {
  errorp(4, "pset", "invalid precision");
      }
   ...
   register precision u;
{
   ...
   if (u == ((precision) 0)) {
      errorp(4, "pparm", "undefined function argument");
   }
   if (u->sign & ~1) {
      errorp(4, "pparm", "invalid precision");
   }
