# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/atop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/atop.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/atop.c" 2
...
extern int pfree();
extern void pnorm();
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/atop.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcvt.h" 1
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/atop.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/atop.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/atop.c"
precision atop(chp)
   register char *chp;
{
   precision res = ((precision) 0);
   precision clump = ((precision) 0);
   int sign = 0;
   register int ch;
   ...
   if (chp != (char *) 0) {
      while (((*__ctype_b_loc ())[(int) ((*chp))] & (unsigned short int) _ISspace)) chp++;
      if (*chp == '-') {
  sign = 1;
  ++chp;
      } else if (*chp == '+') {
  ++chp;
      ...
      if (((*__ctype_b_loc ())[(int) ((ch = * (unsigned char *) chp))] & (unsigned short int) _ISdigit)) {
  psetq(&res, pzero);
  psetq(&clump, utop(1000000000));
  do {
     i = 9 -1;
     temp = ch - '0';
     do {
        if (!((*__ctype_b_loc ())[(int) ((ch = * (unsigned char *) ++chp))] & (unsigned short int) _ISdigit)) goto atoplast;
        temp = temp * 10 + (ch - '0');
     } while (--i > 0);
     psetq(&res, padd(pmul(res, clump), utop(temp)));
  } while (((*__ctype_b_loc ())[(int) ((ch = * (unsigned char *) ++chp))] & (unsigned short int) _ISdigit));
  goto atopdone;
atoplast:
  x = 10;
  while (i++ < 9 -1) {
  ...
  psetq(&res, padd(pmul(res, utop(x)), utop(temp)));
atopdone:
  if (sign) {
     psetq(&res, pneg(res));
  }
   ...
   (void) ((clump)!=((precision) 0)&&--(*(prefc *)(clump))==0&&pfree(clump));
   return presult(res);
}
