# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pidiv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pidiv.c" 2
...
extern int pfree();
extern void pnorm();
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pidiv.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pidiv.c" 2
   ...
   int v;
{
   ...
   if (d >= 65536) {
      q = pnew(errorp(4, "pidiv", "divisor too big for single digit"));
      goto done;
   }
   if (d == 0) {
      q = pnew(errorp(4, "pidiv", "divide by zero"));
      goto done;
   }
   m = u->size;
   q = palloc(m);
   if (q == ((precision) 0)) goto done;
   ...
   q->sign = (u->sign != (v < 0));
   if (q->size == 1 && *(q->value) == 0) q->sign = 0;
done:
