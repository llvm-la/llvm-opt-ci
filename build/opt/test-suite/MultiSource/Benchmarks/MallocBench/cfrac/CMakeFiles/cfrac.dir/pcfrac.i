# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c" 2
...
extern precision fgetp(FILE *stream);
extern int fputp(FILE *stream, precision);
extern int
   fprintp(FILE *stream, precision, int minWidth);
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pfactor.h" 1
typedef struct Pfs {
   struct Pfs *next;
   precision factor;
   unsigned count;
...
typedef precision (*pfunc)();
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pfactor.h"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c" 2
   ...
   unsigned size;
{
   ...
   unsigned msize = ((size + ((sizeof res[0]) << 3)-1) / ((sizeof res[0]) << 3)) * sizeof res[0];
   ...
   register solnvec e;
{
   ...
   fputs(prefix, stream);
   fputp(stream, ((p) != ((precision) 0) && (* (prefc *) (p))++, (p))); fputs(" = ", stream);
   if (*e & 1) putc('-', stream); else putc('+', stream);
   fputp(stream, ((t) != ((precision) 0) && (* (prefc *) (t))++, (t)));
  ...
  fprintf(stream, " %u^%u", *pm, (unsigned) *e);
   ...
   fputs(suffix, stream);
   fflush(stream);
   (void) ((p)!=((precision) 0)&&--(*(prefc *)(p))==0&&pfree(p)); (void) ((t)!=((precision) 0)&&--(*(prefc *)(t))==0&&pfree(t));
}
   ...
   SolnPtr bp;
{
   ...
   (void) ((n) != ((precision) 0) && (* (prefc *) (n))++, (n));
   if (bp != (SolnPtr) 0) {
      psetq(x, (pdivmod(pmul(bp->x, *x),n, ((precision *) 0), (precision *) -1)));
      psetq(t, (pdivmod(pmul(bp->t, *t),n, ((precision *) 0), (precision *) -1)));
      psetq(t, (pdivmod(pmul(bp->r, *t),n, ((precision *) 0), (precision *) -1)));
      e[0] += getBit(bp->e, 0);
   }
   e[0] &= 1;
   for (j = 1; j <= m; j++) {
      ...
      if (e[j] > 2) {
  psetq(t, (pdivmod(pmul(*t, ppowmod(utop(pm[j-1]), utop((unsigned) e[j]>>1), n)),n, ((precision *) 0), (precision *) -1)));

  e[j] &= 1;
      } else if (e[j] == 2) {
  psetq(t, (pdivmod(pmul(*t, utop(pm[j-1])),n, ((precision *) 0), (precision *) -1)));
  e[j] = 0;
      }
   }
   (void) ((n)!=((precision) 0)&&--(*(prefc *)(n))==0&&pfree(n));
}
   ...
   solnvec e;
{
   ...
   if (bp != (SolnPtr) 0) {
      ...
      combineSoln(&bp->x, &bp->r, e, pm, m, ((n) != ((precision) 0) && (* (prefc *) (n))++, (n)), (SolnPtr) 0);
      bp->e = newBitVector(e, m+1);
   }
...
{
   if (p != (SolnPtr) 0) {
      (void) ((p->x)!=((precision) 0)&&--(*(prefc *)(p->x))==0&&pfree(p->x));
      (void) ((p->t)!=((precision) 0)&&--(*(prefc *)(p->t))==0&&pfree(p->t));
      (void) ((p->r)!=((precision) 0)&&--(*(prefc *)(p->r))==0&&pfree(p->r));
...
SolnPtr findSoln(sp, t)
   ...
   precision t;
{
   (void) ((t) != ((precision) 0) && (* (prefc *) (t))++, (t));
   while (sp != (SolnPtr) 0) {
      if (pcmp((sp->t), (t)) == 0) break;
      sp = sp->next;
   }
   (void) ((t)!=((precision) 0)&&--(*(prefc *)(t))==0&&pfree(t));
   return sp;
}
   ...
   EasPtr eas;
{
   ...
   if (ep != (EasPtr) 0) {
      while (ep->pm != 0) {
  (void) ((ep->bound)!=((precision) 0)&&--(*(prefc *)(ep->bound))==0&&pfree(ep->bound));
  ep++;
      }
...
# 306 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
   ...
   unsigned *m, aborts;
{
   ...
   precision nk = pnew(pmul(((n) != ((precision) 0) && (* (prefc *) (n))++, (n)), utop(k)));
...
# 337 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
   res = (uvec) malloc(count * sizeof (unsigned));

   if (res == (uvec) 0) goto doneMk;

   pm = res;
   *pm++ = (unsigned) *primePtr++;
   count = 1;
   if (count != *m) do {
      if (picmp(ppowmod(nk, phalf(psub(utop((unsigned) *primePtr), pone)), utop((unsigned) *primePtr)), 1) <= 0) {
  *pm++ = *primePtr;
  count++;
  if (count == *m) break;
  if ((unsigned) *primePtr >= maxpm) break;
...
doneMk:
   (void) ((nk)!=((precision) 0)&&--(*(prefc *)(nk))==0&&pfree(nk));
   (void) ((n)!=((precision) 0)&&--(*(prefc *)(n))==0&&pfree(n));
   return res;
}
   ...
   unsigned k, *pm, m, aborts;
{
   ...
   dn = ptod(pmul(utop(k), ((n) != ((precision) 0) && (* (prefc *) (n))++, (n))));
   for (i = 1; i <= aborts; i++) {
      eas[i-1].pm = (unsigned *) 0;
      eas[i-1].bound = ((precision) 0);
      tia += ax;
...
foundpm:
  ...
  fflush(stdout);
      ...
      eas[i-1].pm = &pm[j];
      psetq(&eas[i-1].bound, bound);
   }
   eas[i-1].pm = (unsigned *) 0;
   eas[i-1].bound = ((precision) 0);

   (void) ((bound)!=((precision) 0)&&--(*(prefc *)(bound))==0&&pfree(bound));
   (void) ((n)!=((precision) 0)&&--(*(prefc *)(n))==0&&pfree(n));

   return eas;
}
# 433 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
   ...
   EasEntry *eas;
{
   ...
   if (eas != (EasEntry *) 0) {
      pp = eas->pm;
      psetq(&maxp, eas->bound);
   }

   memset((char *) e, '\0', m * sizeof e[0]);
...
gotSoln:
   psetq(f, t);
   (void) ((t)!=((precision) 0)&&--(*(prefc *)(t))==0&&pfree(t)); (void) ((maxp)!=((precision) 0)&&--(*(prefc *)(maxp))==0&&pfree(maxp));
   return res;
}
# 508 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
   ...
   unsigned *maxCount;
{
   ...
   precision t = ((precision) 0),
      r = ((precision) 0), twog = ((precision) 0), u = ((precision) 0), lastU = ((precision) 0),
      Qn = ((precision) 0), lastQn = ((precision) 0), An = ((precision) 0), lastAn = ((precision) 0),
      x = ((precision) 0), y = ((precision) 0), qn = ((precision) 0), rn = ((precision) 0);

   precision res = pnew(((n) != ((precision) 0) && (* (prefc *) (n))++, (n)));

   pm = pfactorbase(n, k, &m, aborts);
...
nomem:
  ...
  fprintf(stdout, "%u ", pm[j]);
   ...
   psetq(&t, pmul(utop(k), n));
   psetq(&r, psqrt(t));
   psetq(&twog, padd(r, r));
   psetq(&u, twog);
   psetq(&lastU, twog);
   psetq(&Qn, pone);
   psetq(&lastQn, psub(t, pmul(r, r)));
   psetq(&An, pone);
   psetq(&lastAn, r);
   psetq(&qn, pzero);
...
F2:
  ...
  psetq(&t, An);
  pdivmod(padd(pmul(qn, An), lastAn), n, ((precision *) 0), &An);
  psetq(&lastAn, t);

  psetq(&t, Qn);
  psetq(&Qn, padd(pmul(qn, psub(lastU, u)), lastQn));
  psetq(&lastQn, t);
  ...
  psetq(&u, psub(twog, rn));
  s = 1-s;

  e[0] = s;
  i = pfactorQ(&t, Qn, pm, &e[1], m, eas);
  if (i < -1) cfracNabort++;
  ...
  if (picmp(Qn, 1) == 0) {
     errorp(4, "pcfrac", "cycle encountered; pick bigger k");
     goto bail;
  }
      } while (i < 0);
  ...
  combineSoln(&x, &t, e, pm, m, n, (SolnPtr) 0);
  cfracPsolns++;
  if (verbose) putc('*', stderr);
  if (verbose > 2) printSoln(stdout, "Full:    ", "", pm, m, x, t, e);
      }
# 645 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
      h = m+1;
      do {
  --h;
  if (e[h]) {
  ...
  fflush(stdout);
   ...
   } while ((pcmp((x), (y)) == 0) || (pcmp((padd(x, y)), (n)) == 0));

   psetq(&res, pgcd(padd(x, y), n));




   if ((pcmp((res), (pone)) == 0) || (pcmp((res), (n)) == 0)) {
...
bail:
   ...
   (void) ((r)!=((precision) 0)&&--(*(prefc *)(r))==0&&pfree(r)); (void) ((twog)!=((precision) 0)&&--(*(prefc *)(twog))==0&&pfree(twog)); (void) ((u)!=((precision) 0)&&--(*(prefc *)(u))==0&&pfree(u)); (void) ((lastU)!=((precision) 0)&&--(*(prefc *)(lastU))==0&&pfree(lastU));
   (void) ((Qn)!=((precision) 0)&&--(*(prefc *)(Qn))==0&&pfree(Qn)); (void) ((lastQn)!=((precision) 0)&&--(*(prefc *)(lastQn))==0&&pfree(lastQn)); (void) ((An)!=((precision) 0)&&--(*(prefc *)(An))==0&&pfree(An)); (void) ((lastAn)!=((precision) 0)&&--(*(prefc *)(lastAn))==0&&pfree(lastAn));
   (void) ((x)!=((precision) 0)&&--(*(prefc *)(x))==0&&pfree(x)); (void) ((y)!=((precision) 0)&&--(*(prefc *)(y))==0&&pfree(y)); (void) ((qn)!=((precision) 0)&&--(*(prefc *)(qn))==0&&pfree(qn)); (void) ((rn)!=((precision) 0)&&--(*(prefc *)(rn))==0&&pfree(rn));
   (void) ((t)!=((precision) 0)&&--(*(prefc *)(t))==0&&pfree(t)); (void) ((n)!=((precision) 0)&&--(*(prefc *)(n))==0&&pfree(n));

   return presult(res);
}
# 722 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
