# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/ptoa.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/ptoa.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/ptoa.c" 2
...
extern int pfree();
extern void pnorm();
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/ptoa.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/ptoa.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/ptoa.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/ptoa.c"
char *ptoa(u)
   precision u;
{
   ...
   (void) ((u) != ((precision) 0) && (* (prefc *) (u))++, (u));
   r = ((precision) 0);
   v = ((precision) 0);
   pbase = ((precision) 0);

   consize = (unsigned int) u->size;
   if (consize > (int) ((unsigned int) ~0 >> 1) / 525) {
      consize = (consize / 109) * 525;
   } else {
      consize = (consize * 525) / 109;
   }

   consize += 9 + 2;
   d = (char *) (char *) malloc((unsigned int) consize);
   if (d == (char *) 0) return d;

   psetq(&v, pabs(u));
   psetq(&pbase, utop(1000000000));
   ...
   *--dPtr = '\0';
   ...
   do {
      ...
      j = 9;
      do {
  *--dPtr = ((temp % 10) < 10 ? (temp % 10) + '0' : (temp % 10) + 'a'-10);
  temp = temp / 10;
      } while (--j > 0);
   } while ((pcmpz(v) != 0));
   ...
   (void) ((pbase)!=((precision) 0)&&--(*(prefc *)(pbase))==0&&pfree(pbase));
   (void) ((v)!=((precision) 0)&&--(*(prefc *)(v))==0&&pfree(v));
   (void) ((r)!=((precision) 0)&&--(*(prefc *)(r))==0&&pfree(r));

   (void) ((u)!=((precision) 0)&&--(*(prefc *)(u))==0&&pfree(u));
   return d;
}
