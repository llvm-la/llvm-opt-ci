# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c" 2
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c"
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c" 2
...
extern int optind;
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c" 2
...
int yyparse (void);
int yylex (void);
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c" 2
...
clear_func (char func)
{
  ...
  for (indx = 0; indx < 16; indx++)
    {
      if (f->f_body[indx] != ((void*)0))
 {
   free(f->f_body[indx]);
   f->f_body[indx] = ((void*)0);
 }
    }
...
# 334 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c"
bc_var *
...
# 355 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c"
bc_num *
  ...
  if (ary_ptr == ((void*)0))
    {
      ...
      ary_ptr->a_value = ((void*)0);
      ary_ptr->a_next = ((void*)0);
      ary_ptr->a_param = 0;
    }
...
store_var (int var_name)
{
 ...
 case 1:
   if (temp < 2 && !toobig)
     ...
     if (temp > 99 || toobig)
       {
  o_base = 99;
  rt_warn ("obase too large, set to %d", 99);
       }
     else
       o_base = (int) temp;
   break;
 ...
 case 2:
   ...
   if (temp > 99 || toobig )
     {
       scale = 99;
       rt_warn ("scale too large, set to %d", 99);
     }
   else
     scale = (int) temp;
 }
   ...
   if (a_temp != ((void*)0))
     {
       ...
       if (!a_temp->a_param && a_temp->a_value != ((void*)0))
  {
...
void
process_params (program_counter * pc, int func)
{
  char ch;
  arg_list * params;
  char warned = 0;
