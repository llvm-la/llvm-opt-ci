# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c" 2
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c"
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c" 2
...
extern int optind;
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c" 2
...
int yyparse (void);
int yylex (void);
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c" 2
...
addbyte (int byte)
{
  ...
  seg = load_adr.pc_addr >> 10;
  offset = load_adr.pc_addr++ % 1024;
  ...
  if (functions[func].f_body[seg] == ((void*)0))
    functions[func].f_body[seg] = (char *)malloc(1024);
...
load_code (char * code)
{
 ...
 if (load_const)
  ...
  break;
       ...
       case ']':
  functions[load_adr.pc_func].f_defined = 1;
  load_adr = save_adr;
  break;
