# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c"
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS.h" 1
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS.h"
# 1 "/usr/include/assert.h" 1 3 4
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS.h" 2
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS.h"
typedef struct _Net {
    struct _Net * next;
    unsigned long net;
} Net;
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c" 2
...
ReadNetList(char *fname)
{
    ...
    { (inFile = fopen(fname, "r")); if (!(inFile != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c", "ReadData", 46); fprintf(stderr, "unable to open input file [%s]", inFile, 0, 0); fprintf(stderr, "\n"); exit(1); } };




    { (fgets(line, 1024, inFile)); if (!(sscanf(line, "%lu %lu", &numNets, &numModules) == 2)) { fprintf(stderr, "(%s:%s():%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c", "ReadData", 51); fprintf(stderr, "unable to parse header in file [%s]", inFile, 0, 0); fprintf(stderr, "\n"); exit(1); } };
 ...
 { (head = prev = (Module *)malloc(sizeof(Module))); if (!(prev != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c", "ReadData", 63); fprintf(stderr, "unable to allocate a module list node", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
 ...
 while ((tok = strtok(((void*)0), " \t\n")) != ((void*)0)) {
     { (node = (Module *)malloc(sizeof(Module))); if (!(node != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c", "ReadData", 70); fprintf(stderr, "unable to allocate a module list node", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
...
NetsToModules(void)
{
 ...
 for (modNode = nets[net]; modNode != ((void*)0); modNode = (*modNode).next) {
     { (netNode = (Net *)malloc(sizeof(Net))); if (!(netNode != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c", "NetsToModules", 96); fprintf(stderr, "unable to allocate net list node", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
...
InitLists(void)
{
 ...
 { (mr = (ModuleRec *)malloc(sizeof(ModuleRec))); if (!(mr != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c", "main", 145); fprintf(stderr, "unable to allocate ModuleRec", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
 ...
 { (mr = (ModuleRec *)malloc(sizeof(ModuleRec))); if (!(mr != ((void*)0))) { fprintf(stderr, "(%s:%s():%d): ", "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c", "main", 164); fprintf(stderr, "unable to allocate ModuleRec", 0, 0, 0); fprintf(stderr, "\n"); exit(1); } };
...
{
# 235 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/ks/KS-1.c"
    float I, E;
