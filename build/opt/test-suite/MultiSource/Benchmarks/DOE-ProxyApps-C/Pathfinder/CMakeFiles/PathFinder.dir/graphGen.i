# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.c" 2
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.c"
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/build/build-llvm/lib/clang/22/include/stdbool.h" 1 3
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.c" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.h"
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.h" 2
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.c" 2
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/graphGen.c"
static Node *getDuplicateNodeForGraph(Graph *graph, Node *from)
{
    Node *newNode = Graph_findNode(graph, from->id, 1);
    if ( newNode )
        return(newNode);


    newNode = Node_duplicate(from, graph->totalNodes++ );
    if ( newNode )
    {
        Graph_addOuterNode(graph,newNode);
...
Graph *buildGraphFromPaths(NodeVecVec **pathList, BuildType build)
{
    ...
    for ( i = 0; pathList[i] ; ++i )
    {
        for (j = 0; j < pathList[i]->contentSize; ++j)
        {
            ...
            for ( k = 1; k < pathList[i]->vector[j]->contentSize; ++k )
            {
...
{
    FILE *out = ((void*)0);
    NodeList *nodes = ((void*)0);
    EdgeList *edges = ((void*)0);
    int nodeCount = 0;
    ...
    for ( nodes = graph->outerNodes; nodes != ((void*)0); nodes = nodes->nextNode )
    {
        ...
        if ( nodes->node->edges )
        {
            ...
            for ( edges = nodes->node->edges; edges != ((void*)0); edges = edges->nextEdge )
            {
