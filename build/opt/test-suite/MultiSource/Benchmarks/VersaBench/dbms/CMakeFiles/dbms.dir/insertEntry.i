# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c"
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
...
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
...
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
...
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.h" 1
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/splitNode.h"
extern Int splitNode( IndexNode *nodeToSplit, IndexEntry *entry,
                      Int fan, IndexEntry **splitEntry );
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.h" 1
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.h"
extern Int insertEntry( IndexNode *node, IndexEntry *entry, Int level, Int fan,
                        IndexEntry **splitEntry );
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c" 2
...
Int insertEntry( IndexNode *node,
                 IndexEntry *entry,
                 Int level,
                 Int fan,
                 IndexEntry **splitEntry )
{
    ...
    if ( node->level > level ) {
        ...
        ((void) (0));
# 94 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c"
        chosen = chooseEntry( node, entry );
        if ( chosen == ((void*)0) ) {
            errorMessage( "can't choose entry on node", 0 );
            errorMessage( name, 1 );
            return ( 1 );
        }
        ...
        returnCode = insertEntry( chosen->child.node, entry, level, fan,
                                  splitEntry );
        if ( returnCode == 0 ) {
# 115 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c"
            keysUnion( (chosen->child.node)->entries, &chosen->key );

            if ( *splitEntry != ((void*)0) ) {
                IndexEntry *lastEntry = ((void*)0);
                IndexEntry *tempEntry = ((void*)0);
                ...
                lastEntry = tempEntry;
                while ( tempEntry != ((void*)0) ) {
                    numberOfEntries++;
                    lastEntry = tempEntry;
                    tempEntry = tempEntry->next;
                }
# 149 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c"
...
# 207 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insertEntry.c"
        if ( numberOfEntries < fan ) {
            ...
            *splitEntry = ((void*)0);
            ...
            if ( returnCode == 1 ) {
                if ( node->level == 0 ) {
                    errorMessage( "can't split LEAF node", 0 );
                    errorMessage( name, 1 );
                    return ( 3 );
                }
                else {
                    errorMessage( "can't split non-LEAF node", 0 );
                    errorMessage( name, 1 );
                    return ( 2 );
                }
            }
