# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c"
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
...
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
...
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c" 2
...
Char *getString( FILE *file )
{
    ...
    ((void) (0));
# 71 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c"
    nextChar = fgetc( file );
    while ( nextChar != (-1) &&
            nextChar != '\n' &&
            nextChar != '\r' &&
            ((*__ctype_b_loc ())[(int) ((nextChar))] & (unsigned short int) _ISspace) ) {
        nextChar = fgetc( file );
    }
...
# 94 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c"
    buffer[ 0 ] = nextChar;
    bufferLength = 1;

    nextChar = fgetc( file );
    while ( nextChar != (-1) && !((*__ctype_b_loc ())[(int) ((nextChar))] & (unsigned short int) _ISspace) ) {
        if ( bufferLength >= 1024 ) {
            errorMessage( "maximum buffer length exceeded", 0 );
            errorMessage( name, 1 );
            flushErrorMessage();
...
# 124 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/getString.c"
    if ( nextChar != (-1) ) {
        Int check;

        check = ungetc( nextChar, file );
        if ( check != nextChar || check == (-1) ) {
            errorMessage( "error pushing character back onto stream", 0 );
            errorMessage( name, 1 );
            flushErrorMessage();
