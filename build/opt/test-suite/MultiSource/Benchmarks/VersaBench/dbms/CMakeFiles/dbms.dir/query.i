# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
# 58 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c"
...
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
...
# 60 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
...
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
...
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
...
# 63 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
...
# 64 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
...
# 66 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c" 2
           ...
           void (*outputQuery)( DataObject *) )
{
    ...
    if ( checkValidity == 1 ) {
        if ( validIndexKey( searchKey ) == 0 ) {
            errorMessage( "invalid index key search values", 0 );
            errorMessage( name, 1 );
            return ( 1 );
        }
        else if ( validAttributes( searchNonKey ) == 0 ) {
            errorMessage( "invalid non-key search values", 0 );
            errorMessage( name, 1 );
            return ( 2 );
        }
    }
# 111 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c"
    if ( node->level > 0 ) {
        IndexEntry *entry;
        ...
        for ( entry = node->entries; entry != ((void*)0); entry = entry->next ) {
            if ( consistentKey( &entry->key, searchKey ) == 1 ) {
                query( entry->child.node, searchKey, searchNonKey, 0,
                       outputQuery );
            }
        }
    }
        ...
        IndexEntry *entry;
# 136 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c"
        for ( entry = node->entries; entry != ((void*)0); entry = entry->next ) {
            if ( consistentKey( &entry->key, searchKey ) == 1 ) {
                DataAttribute *temp;
                DataObject *object;
...
# 166 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/query.c"
                acceptanceFlag = 1;
                temp = searchNonKey;
