# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c" 2
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
...
# 44 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c" 2
...
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c" 2
...
# 46 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c" 2
...
# 47 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c" 2
...
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c" 2
...
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c" 2
...
void deleteEntry( IndexNode *node,
                  IndexKey *searchKey,
                  DataAttribute *searchNonKey,
                  Boolean *adjustmentFlag )
{
    ...
    *adjustmentFlag = 0;
# 82 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
    if ( node->level > 0 ) {
        IndexEntry *entry;
        ...
        entry = node->entries;
        while ( entry != ((void*)0) ) {
            if ( consistentKey( &entry->key, searchKey ) == 1 ) {
                Boolean tempAdjustFlag;


                deleteEntry( entry->child.node, searchKey, searchNonKey,
                             &tempAdjustFlag );
# 114 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
                if ( (entry->child.node)->entries == ((void*)0) ) {
                    ...
                    *adjustmentFlag = 1;
# 132 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
                    if ( prevEntry != ((void*)0) ) {
        ...
        IndexEntry *entry;
        IndexEntry *prevEntry;
# 178 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
        prevEntry = ((void*)0);
        entry = node->entries;
        while ( entry != ((void*)0) ) {
            if ( consistentKey( &entry->key, searchKey ) == 1 ) {
...
# 209 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
                acceptanceFlag = 1;
                temp = searchNonKey;
                while ( temp != ((void*)0) && acceptanceFlag == 1 ) {
...
# 228 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
                if ( acceptanceFlag == 0 ) {
                    ...
                    entry = nextEntry;
                    *adjustmentFlag = 1;
# 252 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/deleteEntry.c"
                    if ( prevEntry != ((void*)0) ) {
                        prevEntry->next = entry;
                    }
                    else {
