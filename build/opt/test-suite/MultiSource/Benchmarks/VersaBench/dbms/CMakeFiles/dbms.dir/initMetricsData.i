# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/initMetricsData.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/initMetricsData.c" 2
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/initMetricsData.c"
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/initMetricsData.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/initMetricsData.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/initMetricsData.c" 2
...
void initMetricsData( Metrics *metrics )
{
    Time temp;
    ...
    metrics->insertCommandMetric.lastTimeMark = -2147483647;
    metrics->insertCommandMetric.numOfCommands = 0;
    metrics->insertCommandMetric.sum = 0.0;
    metrics->insertCommandMetric.sumSquares = 0.0;
    metrics->insertCommandMetric.worst = -2147483647;
    metrics->insertCommandMetric.best = 2147483647;
    metrics->insertCommandMetric.avg = -3.40282347e38;
    metrics->insertCommandMetric.deviation = -3.40282347e38;

    metrics->queryCommandMetric.lastTimeMark = -2147483647;
    metrics->queryCommandMetric.numOfCommands = 0;
    metrics->queryCommandMetric.sum = 0.0;
    metrics->queryCommandMetric.sumSquares = 0.0;
    metrics->queryCommandMetric.worst = -2147483647;
    metrics->queryCommandMetric.best = 2147483647;
    metrics->queryCommandMetric.avg = -3.40282347e38;
    metrics->queryCommandMetric.deviation = -3.40282347e38;

    metrics->deleteCommandMetric.lastTimeMark = -2147483647;
    metrics->deleteCommandMetric.numOfCommands = 0;
    metrics->deleteCommandMetric.sum = 0.0;
    metrics->deleteCommandMetric.sumSquares = 0.0;
    metrics->deleteCommandMetric.worst = -2147483647;
    metrics->deleteCommandMetric.best = 2147483647;
    metrics->deleteCommandMetric.avg = -3.40282347e38;
    metrics->deleteCommandMetric.deviation = -3.40282347e38;
