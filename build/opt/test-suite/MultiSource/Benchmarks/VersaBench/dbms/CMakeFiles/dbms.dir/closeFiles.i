# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/closeFiles.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/closeFiles.c" 2
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/closeFiles.c"
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/closeFiles.c" 2
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/closeFiles.c" 2
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/closeFiles.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/closeFiles.c" 2

void closeFiles( FILE *inputFile,
                 FILE *outputFile,
                 FILE *metricFile )
{
    Int error;
    ...
    if ( error != 0 ) {
        errorMessage( "error closing input file", 0 );
        errorMessage( name, 1 );
    }

    error = fclose( outputFile );
    if ( error != 0 ) {
        errorMessage( "error closing output file", 0 );
        errorMessage( name, 1 );
    }

    error = fclose( metricFile );
    if ( error != 0 ) {
        errorMessage( "error closing metric file", 0 );
        errorMessage( name, 1 );
    }
