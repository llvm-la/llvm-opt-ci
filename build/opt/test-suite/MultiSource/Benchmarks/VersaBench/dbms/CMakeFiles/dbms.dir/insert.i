# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
# 75 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c"
...
# 76 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
...
# 77 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
...
# 78 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
...
# 79 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
...
# 80 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
...
# 81 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
...
# 82 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
...
# 83 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/insert.c" 2
            ...
            Int fan )
{
    ...
    if ( entry == ((void*)0) ) {
        errorMessage( "can't create entry for new data object", 0 );
        errorMessage( name, 1 );
        return ( 3 );
    }
    ...
    returnCode = insertEntry( *root, entry, 0, fan, &splitEntry );
    if ( returnCode == 0 ) {
        ...
        if ( splitEntry != ((void*)0) ) {
            ...
            if ( newRoot == ((void*)0) ) {
                errorMessage( "can't create new root node", 0 );
                errorMessage( name, 1 );
                return ( 3 );
            }

            newRoot->entries = createIndexEntry();
            if ( newRoot->entries == ((void*)0) ) {
                errorMessage( "can't create entry for old root", 0 );
                errorMessage( name, 1 );
                return ( 3 );
            }
