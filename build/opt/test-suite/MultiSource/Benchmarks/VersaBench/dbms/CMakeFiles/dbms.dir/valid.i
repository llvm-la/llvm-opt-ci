# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c" 2
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c" 2
...
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c" 2
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c"
Boolean validIndexKey( IndexKey *key )
{
    Boolean flag = 1;
    ...
    if ( key->lower.T >= key->upper.T ) {
        errorMessage( "Lower T > Upper T", 0 );
        errorMessage( name, 1 );
        flag = 0;
    }
    else if ( key->lower.X >= key->upper.X ) {
        errorMessage( "Lower X > Upper X", 0 );
        errorMessage( name, 1 );
        flag = 0;
    }
    else if ( key->lower.Y >= key->upper.Y ) {
        errorMessage( "Lower Y > Upper Y", 0 );
        errorMessage( name, 1 );
        flag = 0;
    }
    else if ( key->lower.Z >= key->upper.Z ) {
        errorMessage( "Lower Z > Upper Z", 0 );
        errorMessage( name, 1 );
        flag = 0;
    }
...
# 89 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/valid.c"
Boolean validAttributes( DataAttribute *attributes )
{
    DataAttribute *temp;
    ...
    for ( temp = attributes; temp != ((void*)0); temp = temp->next ) {



        if ( temp->code < 0 ||
             temp->code > 50 ) {
            errorMessage( "invalid attribute code", 0 );
            errorMessage( name, 1 );
            return ( 0 );
        }
        else {
            if ( temp->code >= 0 &&
                ...
                if ( temp->attribute.value.key < -3.40282347e38 ||
                     temp->attribute.value.key > 3.40282347e38 ) {
                    errorMessage( "key value out-of-range", 0 );
                    errorMessage( name, 1 );
                    return ( 0 );
                }
            }
                ...
                if ( temp->attribute.value.nonKey == ((void*)0) ) {
                    errorMessage( "non-key value set to NULL", 0 );
                    errorMessage( name, 1 );
                    return ( 0 );
                }
            }
