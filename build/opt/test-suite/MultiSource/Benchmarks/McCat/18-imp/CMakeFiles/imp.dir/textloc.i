# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c" 2
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
...
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c" 2
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/pgm.h" 1
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/pgm.h"
typedef struct
{
  char valid;
  char *filename;
...
typedef ImgT *ImgP;
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/pgm.h"
extern void PGM_InitImage(ImgP, char *);
extern void PGM_FreeImage(ImgP);
extern void PGM_PrintInfo(ImgP);
extern int PGM_LoadImage(ImgP);
extern int PGM_WriteBinary(ImgP);
extern int PGM_WriteImage(ImgP, char);
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.h" 1
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.h"
...
struct _CompT
{
  ...
  CompP prev;
    ...
    void ConvertToFloat(ImgP);
    void HorzVariance(ImgP, int);
    CompP BuildConnectedComponents(ImgP, int);
    void PrintConnectedComponents(CompP);
    void WriteConnectedComponentsToPGM(CompP, ImgP);
    void FreeConnectedComponents(CompP);
    void EliminateLargeSpreadComponents(CompI, ImgP);
    void MergeRowComponents(CompI, ImgP);
    void PairComponents(CompI, ImgP);
    void ComputeBoundingBoxes(CompP, ImgP);
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c" 2
...
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
...
# 106 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
CompP BuildConnectedComponents(ImgP img, int bg)
{
  int x, y, xm, ym;
  int idx, midx;
  CompP comp, cur_comp, last_comp = ((void*)0), merge_comp, mprev_comp;
  PixP pix;
 ...
 if (!img->lmap[midx])
   {
     ...
     comp->id = (last_comp == ((void*)0)) ? 1 : last_comp->id + 1;
     comp->n = 0;
     comp->avg_row = y;
     comp->x_max = x;
     comp->y_max = y;
...
# 242 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
void EliminateLargeSpreadComponents(CompI c, ImgP img)
{
  ...
  int idx;
  char kill_it;
# 266 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
  while (*ip != ((void*)0))
    {
      if (KILL_SMALL_COMP)
...
# 318 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
}
# 327 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
...
# 362 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
void WriteConnectedComponentsToPGM(CompP comp, ImgP img)
{
  ...
  if ((c == ((void*)0)) || (!img->valid) || (img->width == 0) || (img->height == 0))
    return;
...
# 449 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
...
# 507 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
...
# 528 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
void MergeToLeft(CompP comp, CompI head, ImgP img)
{
  ...
  int idx, last_comp = 0;
  CompP c = *head, p, pp;
# 550 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
  xl = comp->x_min;
  yl = comp->y_left;
# 561 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
 ...
 if ((img->lmap[idx]) && (img->lmap[idx] != comp->id) &&
     (img->lmap[idx] != last_comp))
   {
     ...
     p = pp = ((void*)0);
     c = *head;
     while ((c != ((void*)0)) && (c->id != img->lmap[idx]))
       {
  pp = p;
  p = c;
  c = c->prev;
  ...
  exit(1);
     ...
     if (comp->type == c->type)
       {
# 618 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
...
# 637 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
void PairComponents(CompI head, ImgP img)
{
  CompP c = *head, p = ((void*)0), o;
  int xm, ym, y, idx;
  int last_comp = 0;
                  ...
                  (img->lmap[idx] != last_comp))
                  {
                    ...
                    if (abs(ym) < MIN_CHAR_SIZE)
                    ...
                    else
                      {
                        ...
                        o = *head;
                        while ((o != ((void*)0)) && (o->id != img->lmap[idx]))
                          o = o->prev;
...
# 715 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
                       if (c->type == o->type)
                      discard = 1;
                        else
                          {
...
# 797 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
...
# 876 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/textloc.c"
