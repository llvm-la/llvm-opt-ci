# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/L_canny.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/L_canny.c" 2
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/L_canny.c"
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/L_canny.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/L_canny.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V.h" 1
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V.h"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V.h" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V.h" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V.h" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V.h" 2
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V_commands.h" 1
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V_commands.h"
...
# 350 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V_commands.h"
extern COMMAND *cmdtable;
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/V.h" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/18-imp/L_canny.c" 2
...
char *err;
{
  ...
  gr = (float *) calloc(nr*nc, 4);
  if (!gr) {
    sprintf(err, "Out of memory");
    return(1);
  }
  for (i=0; i<nr*nc; i++) gr[i] = ( sqrt(Iy[i]*Iy[i] + Ix[i]*Ix[i]) );
...
char *err;
{
  ...
  *tg = (short) (6*sigma);
  ...
  coeff_gauss = p = (float *)calloc(*tg, 4);
  if (!coeff_gauss) {
    sprintf(err,"Out of memory");
    return(1);
  }
...
char *err;
{
  ...
  *tg = (short) (8. * sqrt(2.)*sigma);
  if (*tg % 2 == 0) *tg += 1;

  coeff_dgauss = p = (float *)calloc(*tg, 4);
  if (!coeff_dgauss) {
    sprintf(err,"Out of memory");
    return(1);
  }
  ...
  for (i=-(*tg/2); i<=*tg/2; i++) {
    if ((i+(*tg/2)) == 0)
      *coeff_dgauss++ =
 (float)(1.0/(sigma*sqrt((double)(2.0*3.14159265358979323846))))*
   exp(-(double)((i+0.5)*(i+0.5))/(double)(2.0*sigma*sigma));
    else if ((i+(*tg/2)) == *tg-1)
      *coeff_dgauss++ =
 (float)-(1.0/(sigma*sqrt(2.0*3.14159265358979323846)))*
   exp(-(double)((i-0.5)*(i-0.5))/(double)(2.0*sigma*sigma));
    else *coeff_dgauss++ =
      (float)((exp(-(double)((i+0.5)*(i+0.5))/(double)(2.0*sigma*sigma))-
        exp(-(double)((i-0.5)*(i-0.5))/(double)(2.0*sigma*sigma)))/
       (sigma*sqrt((double) 2.0*3.14159265358979323846)));
  }
  coeff_dgauss = p;
  *mask = p;
...
int nr;
{
  ...
  maxima = (float *) calloc(nc*nr, 4);

  for (i=1;i<nr-2;i++)
    for (j=1;j<nc-2;j++) {
      if (( (Ix[((i)*nc)+j]<= 0.00000001) && (Ix[((i)*nc)+j]>= -0.00000001) )) {
 ampl1 = gr[((i)*nc)+j-1]; ampl2 = gr[((i)*nc)+j+1];
      } else {
 R = Iy[((i)*nc)+j] / Ix[((i)*nc)+j];
 if ((R >=0.) && (R < .4)) {
   ampl1 = gr[((i+1)*nc)+j+1] * R + (1.-R)* gr[((i+1)*nc)+j];
   ampl2 = gr[((i-1)*nc)+j-1] * R + (1.-R)* gr[((i-1)*nc)+j];
 }
 ...
 else
   {
     ...
     continue;
      ...
      if (( (gr[((i)*nc)+j] > (ampl1+0.00000001)) ) && ( (gr[((i)*nc)+j] > (ampl2+0.00000001)) ))
 maxima[((i)*nc)+j] = 255;
    }
