# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/01-qbsort/sort.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/01-qbsort/sort.c" 2
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/01-qbsort/sort.c"
...
# 28 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/01-qbsort/sort.c" 2
...
# 29 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/01-qbsort/sort.c" 2
...
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/01-qbsort/sort.c" 2
...
LinkList *QuickSort(LinkList *l, BOOL (*compare)(int, int))
{
  LinkList *p;
  LinkList *SortList;
  LinkList *InfList=((void*)0), *SupList=((void*)0);
  LinkList *NewElement;
  ...
  if (l==((void*)0)) return(((void*)0));
  else
    {
      ...
      *FirstElement=*l;
      ...
      for (p=l->next; p!=((void*)0); p=p->next)
 {
      ...
      if (SortList!=((void*)0))
 {
   ...
   for (p=SortList; p->next!=((void*)0); p=p->next)
                ;
   p->next=FirstElement;
 }
      else
