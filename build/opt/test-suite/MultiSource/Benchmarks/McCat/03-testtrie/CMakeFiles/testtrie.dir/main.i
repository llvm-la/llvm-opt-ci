# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c" 2
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c"
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c" 2
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/main.c" 2
...
void addfile(trie t, FILE *f)
{
  char c;
  int wstate=0;
  charsequence cs={((void*)0),0,0};

  while(!feof(f))
    {
      c=(__extension__ ({ int __res; if (sizeof (getc(f)) > 1) { if (__builtin_constant_p (getc(f))) { int __c = (getc(f)); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (getc(f)); } else __res = (*__ctype_tolower_loc ())[(int) (getc(f))]; __res; }));
      if(wstate)
 {
   if((c >= 'a' && c <= 'z'))
