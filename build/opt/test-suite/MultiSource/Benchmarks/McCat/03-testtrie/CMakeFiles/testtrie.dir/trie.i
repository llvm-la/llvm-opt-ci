# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c" 2
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c"
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.h" 1
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.h" 1
...
# 24 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c" 2
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/trie.c"
trie trie_init(void)
{
  trie t;

  if((t = calloc(1,(sizeof(struct trie_s)))) == ((void*)0))
    {
...
trie trie_insert(trie t, string s)
{
  ...
  if(s[0] == '\0')
    ...
    t->next[((__extension__ ({ int __res; if (sizeof (s[0]) > 1) { if (__builtin_constant_p (s[0])) { int __c = (s[0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (s[0]); } else __res = (*__ctype_tolower_loc ())[(int) (s[0])]; __res; }))-'a')] = trie_insert(t->next[((__extension__ ({ int __res; if (sizeof (s[0]) > 1) { if (__builtin_constant_p (s[0])) { int __c = (s[0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (s[0]); } else __res = (*__ctype_tolower_loc ())[(int) (s[0])]; __res; }))-'a')], s+1);
...
int trie_lookup(trie t, string s)
{
  ...
  if(s[0] == '\0')
    return (t->next[((__extension__ ({ int __res; if (sizeof (s[0]) > 1) { if (__builtin_constant_p (s[0])) { int __c = (s[0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (s[0]); } else __res = (*__ctype_tolower_loc ())[(int) (s[0])]; __res; }))-'a')])->number;
  else
    return (trie_lookup(t->next[((__extension__ ({ int __res; if (sizeof (s[0]) > 1) { if (__builtin_constant_p (s[0])) { int __c = (s[0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (s[0]); } else __res = (*__ctype_tolower_loc ())[(int) (s[0])]; __res; }))-'a')], s+1));
}


charsequence trie_scan_buffer={((void*)0),0,0};
...
void trie_scan(trie t,void f(int,char*))
{
 ...
 if(t->next[i]!=((void*)0))
   {
     charsequence_push(&trie_scan_buffer,(i+'a'));
