# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c" 2
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c"
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c" 2
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c" 2
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/McCat/03-testtrie/charsequence.c"
void charsequence_reset(charsequence *cs)
{
  if(cs->buf!=((void*)0))free(cs->buf);
  cs->buf=malloc(16);
  if(cs->buf==((void*)0))(fprintf(stderr,"OUT OF MEMORY"));
  cs->size=16;
  cs->pos=0;
}
...
char charsequence_pop(charsequence *cs)
{
  if(cs->pos==0)
    {
      (fprintf(stderr,"ATTEMPTED POP ON EMPTY SEQUENCE"));
    }
...
char *charsequence_val(charsequence *cs)
{
  ...
  if(ret==((void*)0))(fprintf(stderr,"OUT OF MEMORY"));
