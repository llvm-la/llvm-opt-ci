# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c" 2
...
hypre_StructVector *
hypre_StructVectorCreate( hypre_MPI_Comm comm,
                          hypre_StructGrid *grid )
{
   hypre_StructVector *vector;
   ...
   vector = ( (hypre_StructVector *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_StructVector)) );
...
hypre_StructVectorInitializeShell( hypre_StructVector *vector )
{
   ...
   if (((vector) -> data_indices) == ((void*)0))
   {
      ...
      data_indices = ( (int *)hypre_CAlloc((unsigned int)(((data_space) -> size)), (unsigned int)sizeof(int)) );
...
hypre_StructVectorInitialize( hypre_StructVector *vector )
{
   ...
   data = ( (double *)hypre_CAlloc((unsigned int)((((vector) -> data_size))), (unsigned int)sizeof(double)) );
                             ...
                             int add_to )
{
   ...
   boxes = ((((vector) -> grid)) -> boxes);

   for (i = 0; i < ((boxes) -> size); i++)
      {
         box = &((boxes) -> boxes[(i)]);

         if (((grid_index[0]) >= ((((box) -> imin)[0]))) &&
             ((grid_index[0]) <= ((((box) -> imax)[0]))) &&
             ((grid_index[1]) >= ((((box) -> imin)[1]))) &&
             ((grid_index[1]) <= ((((box) -> imax)[1]))) &&
             ((grid_index[2]) >= ((((box) -> imin)[2]))) &&
             ((grid_index[2]) <= ((((box) -> imax)[2]))) )
         {
            vecp = ((((vector) -> data) + ((vector) -> data_indices)[i]) + (((grid_index[0]) - ((((&((((vector) -> data_space)) -> boxes[(i)])) -> imin)[0]))) + (((grid_index[1]) - ((((&((((vector) -> data_space)) -> boxes[(i)])) -> imin)[1]))) + (((grid_index[2]) - ((((&((((vector) -> data_space)) -> boxes[(i)])) -> imin)[2]))) * (((0)<((((((&((((vector) -> data_space)) -> boxes[(i)])) -> imax)[1])) - ((((&((((vector) -> data_space)) -> boxes[(i)])) -> imin)[1])) + 1))) ? ((((((&((((vector) -> data_space)) -> boxes[(i)])) -> imax)[1])) - ((((&((((vector) -> data_space)) -> boxes[(i)])) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((&((((vector) -> data_space)) -> boxes[(i)])) -> imax)[0])) - ((((&((((vector) -> data_space)) -> boxes[(i)])) -> imin)[0])) + 1))) ? ((((((&((((vector) -> data_space)) -> boxes[(i)])) -> imax)[0])) - ((((&((((vector) -> data_space)) -> boxes[(i)])) -> imin)[0])) + 1)) : (0))));
            if (add_to)
            {
               *vecp += values;
            }
                                ...
                                int add_to )
{
   ...
   box_array = hypre_BoxArrayCreate(((grid_boxes) -> size));
   box = hypre_BoxCreate();
   for (i = 0; i < ((grid_boxes) -> size); i++)
      {
         grid_box = &((grid_boxes) -> boxes[(i)]);
         hypre_IntersectBoxes(value_box, grid_box, box);
         ( ( (((&((box_array) -> boxes[(i)])) -> imin)[0]) = (((box) -> imin)[0]), (((&((box_array) -> boxes[(i)])) -> imin)[1]) = (((box) -> imin)[1]), (((&((box_array) -> boxes[(i)])) -> imin)[2]) = (((box) -> imin)[2]) ), ( (((&((box_array) -> boxes[(i)])) -> imax)[0]) = (((box) -> imax)[0]), (((&((box_array) -> boxes[(i)])) -> imax)[1]) = (((box) -> imax)[1]), (((&((box_array) -> boxes[(i)])) -> imax)[2]) = (((box) -> imax)[2]) ) );
      }
      ...
      for (i = 0; i < ((box_array) -> size); i++)
         {
            ...
            if (box)
            {
               ...
               if (add_to)
               {
                  { int hypre__i1start = (((data_start[0]) - ((((data_box) -> imin)[0]))) + (((data_start[1]) - ((((data_box) -> imin)[1]))) + (((data_start[2]) - ((((data_box) -> imin)[2]))) * (((0)<((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1))) ? ((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((dval_start[0]) - ((((dval_box) -> imin)[0]))) + (((dval_start[1]) - ((((dval_box) -> imin)[1]))) + (((dval_start[2]) - ((((dval_box) -> imin)[2]))) * (((0)<((((((dval_box) -> imax)[1])) - ((((dval_box) -> imin)[1])) + 1))) ? ((((((dval_box) -> imax)[1])) - ((((dval_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((dval_box) -> imax)[0])) - ((((dval_box) -> imin)[0])) + 1))) ? ((((((dval_box) -> imax)[0])) - ((((dval_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((data_stride[0]));int hypre__sy1 = ((data_stride[1])*(((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((data_stride[2])* (((0)<((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1))) ? ((((((data_box) -> imax)[0])) - ((((data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1))) ? ((((((data_box) -> imax)[1])) - ((((data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((dval_stride[0]));int hypre__sy2 = ((dval_stride[1])*(((0)<((((((dval_box) -> imax)[0])) - ((((dval_box) -> imin)[0])) + 1))) ? ((((((dval_box) -> imax)[0])) - ((((dval_box) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((dval_stride[2])* (((0)<((((((dval_box) -> imax)[0])) - ((((dval_box) -> imin)[0])) + 1))) ? ((((((dval_box) -> imax)[0])) - ((((dval_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((dval_box) -> imax)[1])) - ((((dval_box) -> imin)[1])) + 1))) ? ((((((dval_box) -> imax)[1])) - ((((dval_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 345 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; datai = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; dvali = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                     {
                        datap[datai] = values[dvali];
                     }
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 485 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; datai = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; dvali = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                  {
                               ...
                               int *num_ghost )
{
   ...
   for (i = 0; i < 6; i++)
      ((vector) -> num_ghost)[i] = num_ghost[i];
   ...
   for (i = 0; i < ((boxes) -> size); i++)
      {
         ...
         v_data_box =
            &((((vector) -> data_space)) -> boxes[(i)]);
         vp = (((vector) -> data) + ((vector) -> data_indices)[i]);

         hypre_BoxGetSize(box, loop_size);

         { int hypre__i1start = (((start[0]) - ((((v_data_box) -> imin)[0]))) + (((start[1]) - ((((v_data_box) -> imin)[1]))) + (((start[2]) - ((((v_data_box) -> imin)[2]))) * (((0)<((((((v_data_box) -> imax)[1])) - ((((v_data_box) -> imin)[1])) + 1))) ? ((((((v_data_box) -> imax)[1])) - ((((v_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((v_data_box) -> imax)[0])) - ((((v_data_box) -> imin)[0])) + 1))) ? ((((((v_data_box) -> imax)[0])) - ((((v_data_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((unit_stride[0]));int hypre__sy1 = ((unit_stride[1])*(((0)<((((((v_data_box) -> imax)[0])) - ((((v_data_box) -> imin)[0])) + 1))) ? ((((((v_data_box) -> imax)[0])) - ((((v_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((unit_stride[2])* (((0)<((((((v_data_box) -> imax)[0])) - ((((v_data_box) -> imin)[0])) + 1))) ? ((((((v_data_box) -> imax)[0])) - ((((v_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((v_data_box) -> imax)[1])) - ((((v_data_box) -> imin)[1])) + 1))) ? ((((((v_data_box) -> imax)[1])) - ((((v_data_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 576 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; vi = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
            {
               vp[vi] = values;
            }
         vi += hypre__sx1; } vi += hypre__sy1 - hypre__nx*hypre__sx1; } vi += hypre__sz1 - hypre__ny*hypre__sy1; } }};
      }
   ...
   for (i = 0; i < ((boxes) -> size); i++)
      {
         ...
         for (j = 0; j < ((diff_boxes) -> size); j++)
            {
               diff_box = &((diff_boxes) -> boxes[(j)]);
               start = ((diff_box) -> imin);
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 639 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; vi = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                  {
                     vp[vi] = 0.0;
                  }
...
hypre_StructVectorClearAllValues( hypre_StructVector *vector )
{
   ...
   ( (imax[0]) = ((vector) -> data_size), (imax[1]) = 1, (imax[2]) = 1 );
   hypre_BoxSetExtents(box, imin, imax);
   data = ((vector) -> data);
   hypre_BoxGetSize(box, loop_size);

   { int hypre__i1start = (((imin[0]) - ((((box) -> imin)[0]))) + (((imin[1]) - ((((box) -> imin)[1]))) + (((imin[2]) - ((((box) -> imin)[2]))) * (((0)<((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1))) ? ((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1))) ? ((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((imin[0]));int hypre__sy1 = ((imin[1])*(((0)<((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1))) ? ((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((imin[2])* (((0)<((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1))) ? ((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1)) : (0))*(((0)<((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1))) ? ((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 685 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; datai = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
      {
         data[datai] = 0.0;
      }
   datai += hypre__sx1; } datai += hypre__sy1 - hypre__nx*hypre__sx1; } datai += hypre__sz1 - hypre__ny*hypre__sy1; } }};
                                     ...
                                     hypre_StructVector *to_vector )
{
   ...
   hypre_CreateCommInfoFromGrids(((from_vector) -> grid),
                                 ((to_vector) -> grid),
   ...
   comm_pkg = hypre_CommPkgCreate(send_boxes, recv_boxes,
                                  ...
                                  ((from_vector) -> data_space),
                                  ((to_vector) -> data_space),
                                  send_processes, recv_processes,
                                  num_values,
                                  ((from_vector) -> comm),
                                  ((((from_vector) -> grid)) -> periodic));
                         ...
                         int all )
{
   ...
   hypre_MPI_Comm_rank(((vector) -> comm), &myid );
...
hypre_StructVector *
hypre_StructVectorRead( hypre_MPI_Comm comm,
                        char *filename,
                        int *num_ghost )
{
   FILE *file;
   ...
   int myid;
# 868 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/struct_vector.c"
   hypre_MPI_Comm_rank(comm, &myid );

   sprintf(new_filename, "%s.%05d", filename, myid);

   if ((file = fopen(new_filename, "r")) == ((void*)0))
   {
      printf("Error: can't open output file %s\n", new_filename);
      exit(1);
   }
