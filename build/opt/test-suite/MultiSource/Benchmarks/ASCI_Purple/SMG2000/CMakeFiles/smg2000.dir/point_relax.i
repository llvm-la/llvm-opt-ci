# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c" 2
...
void *
hypre_PointRelaxCreate( hypre_MPI_Comm comm )
{
   ...
   relax_data = ( (hypre_PointRelaxData *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_PointRelaxData)) );
   ...
   (relax_data -> pointset_sizes) = ((void*)0);
   (relax_data -> pointset_ranks) = ((void*)0);
   (relax_data -> pointset_strides) = ((void*)0);
   (relax_data -> pointset_indices) = ((void*)0);
   (relax_data -> t) = ((void*)0);

   ( (stride[0]) = 1, (stride[1]) = 1, (stride[2]) = 1 );
   ( (indices[0][0]) = 0, (indices[0][1]) = 0, (indices[0][2]) = 0 );
...
hypre_PointRelaxDestroy( void *relax_vdata )
{
   ...
   if (relax_data)
   {
      ...
      {
         ( hypre_Free((char *)relax_data -> pointset_indices[i]), relax_data -> pointset_indices[i] = ((void*)0) );
         hypre_ComputePkgDestroy(relax_data -> compute_pkgs[i]);
      }
      ( hypre_Free((char *)relax_data -> pointset_sizes), relax_data -> pointset_sizes = ((void*)0) );
      ( hypre_Free((char *)relax_data -> pointset_ranks), relax_data -> pointset_ranks = ((void*)0) );
      ( hypre_Free((char *)relax_data -> pointset_strides), relax_data -> pointset_strides = ((void*)0) );
      ( hypre_Free((char *)relax_data -> pointset_indices), relax_data -> pointset_indices = ((void*)0) );
      hypre_StructMatrixDestroy(relax_data -> A);
      hypre_StructVectorDestroy(relax_data -> b);
      hypre_StructVectorDestroy(relax_data -> x);
      ( hypre_Free((char *)relax_data -> compute_pkgs), relax_data -> compute_pkgs = ((void*)0) );
      hypre_StructVectorDestroy(relax_data -> t);

      hypre_FinalizeTiming(relax_data -> time_index);
      ( hypre_Free((char *)relax_data), relax_data = ((void*)0) );
   }
                       ...
                       hypre_StructVector *x )
{
   ...
   if ((relax_data -> t) == ((void*)0))
   {
      t = hypre_StructVectorCreate(((b) -> comm),
                                   ((b) -> grid));
      hypre_StructVectorSetNumGhost(t, ((b) -> num_ghost));
   ...
   ( (diag_index[0]) = 0, (diag_index[1]) = 0, (diag_index[2]) = 0 );
   ...
   compute_pkgs = ( (hypre_ComputePkg * *)hypre_CAlloc((unsigned int)(num_pointsets), (unsigned int)sizeof(hypre_ComputePkg *)) );
   ...
   for (p = 0; p < num_pointsets; p++)
   {
      ...
      for (compute_i = 0; compute_i < 2; compute_i++)
      {
         ...
         box_aa_size = ((box_aa) -> size);
         new_box_aa = hypre_BoxArrayArrayCreate(box_aa_size);

         for (i = 0; i < box_aa_size; i++)
         {
            box_a = ((box_aa) -> box_arrays[(i)]);
            box_a_size = ((box_a) -> size);
            new_box_a = ((new_box_aa) -> box_arrays[(i)]);
   ...
   (relax_data -> flops) = scale * (((A) -> global_size) +
                                    ((x) -> global_size));
         ...
         for (i = 0; i < ((compute_box_aa) -> size); i++)
            {
               ...
               A_data_box =
                  &((((A) -> data_space)) -> boxes[(i)]);
               b_data_box =
                  &((((b) -> data_space)) -> boxes[(i)]);
               x_data_box =
                  &((((x) -> data_space)) -> boxes[(i)]);

               Ap = (((A) -> data) + ((A) -> data_indices)[i][diag_rank]);
               ...
               for (j = 0; j < ((compute_box_a) -> size); j++)
                  {
                     ...
                     { int hypre__i1start = (((start[0]) - ((((A_data_box) -> imin)[0]))) + (((start[1]) - ((((A_data_box) -> imin)[1]))) + (((start[2]) - ((((A_data_box) -> imin)[2]))) * (((0)<((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1))) ? ((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((start[0]) - ((((b_data_box) -> imin)[0]))) + (((start[1]) - ((((b_data_box) -> imin)[1]))) + (((start[2]) - ((((b_data_box) -> imin)[2]))) * (((0)<((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1))) ? ((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1))) ? ((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1)) : (0))); int hypre__i3start = (((start[0]) - ((((x_data_box) -> imin)[0]))) + (((start[1]) - ((((x_data_box) -> imin)[1]))) + (((start[2]) - ((((x_data_box) -> imin)[2]))) * (((0)<((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1))) ? ((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stride[0]));int hypre__sy1 = ((stride[1])*(((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stride[2])* (((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1))) ? ((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stride[0]));int hypre__sy2 = ((stride[1])*(((0)<((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1))) ? ((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stride[2])* (((0)<((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1))) ? ((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1))) ? ((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx3 = ((stride[0]));int hypre__sy3 = ((stride[1])*(((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz3 = ((stride[2])* (((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1))) ? ((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 460 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; Ai = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; bi = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; xi = hypre__i3start + loopi*hypre__sx3 + loopj*hypre__sy3 + loopk*hypre__sz3; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                        {
                           xp[xi] = bp[bi] / Ap[Ai];
                        }
                     Ai += hypre__sx1; bi += hypre__sx2; xi += hypre__sx3; } Ai += hypre__sy1 - hypre__nx*hypre__sx1; bi += hypre__sy2 - hypre__nx*hypre__sx2; xi += hypre__sy3 - hypre__nx*hypre__sx3; } Ai += hypre__sz1 - hypre__ny*hypre__sy1; bi += hypre__sz2 - hypre__ny*hypre__sy2; xi += hypre__sz3 - hypre__ny*hypre__sy3; } }};
                  }
            }
      }
         ...
         for (i = 0; i < ((compute_box_aa) -> size); i++)
            {
               ...
               x_data_box =
                  &((((x) -> data_space)) -> boxes[(i)]);
               t_data_box =
                  &((((t) -> data_space)) -> boxes[(i)]);

               bp = (((b) -> data) + ((b) -> data_indices)[i]);
               tp = (((t) -> data) + ((t) -> data_indices)[i]);
               ...
               for (j = 0; j < ((compute_box_a) -> size); j++)
                  {
                     ...
                     { int hypre__i1start = (((start[0]) - ((((b_data_box) -> imin)[0]))) + (((start[1]) - ((((b_data_box) -> imin)[1]))) + (((start[2]) - ((((b_data_box) -> imin)[2]))) * (((0)<((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1))) ? ((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1))) ? ((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((start[0]) - ((((t_data_box) -> imin)[0]))) + (((start[1]) - ((((t_data_box) -> imin)[1]))) + (((start[2]) - ((((t_data_box) -> imin)[2]))) * (((0)<((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1))) ? ((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stride[0]));int hypre__sy1 = ((stride[1])*(((0)<((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1))) ? ((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stride[2])* (((0)<((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1))) ? ((((((b_data_box) -> imax)[0])) - ((((b_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1))) ? ((((((b_data_box) -> imax)[1])) - ((((b_data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stride[0]));int hypre__sy2 = ((stride[1])*(((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stride[2])* (((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1))) ? ((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 538 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; bi = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; ti = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                        {
                           tp[ti] = bp[bi];
                        }
                     bi += hypre__sx1; ti += hypre__sx2; } bi += hypre__sy1 - hypre__nx*hypre__sx1; ti += hypre__sy2 - hypre__nx*hypre__sx2; } bi += hypre__sz1 - hypre__ny*hypre__sy1; ti += hypre__sz2 - hypre__ny*hypre__sy2; } }};
                     ...
                     for (si = 0; si < stencil_size; si++)
                     {
                        if (si != diag_rank)
                        {
                           ...
                           { int hypre__i1start = (((start[0]) - ((((A_data_box) -> imin)[0]))) + (((start[1]) - ((((A_data_box) -> imin)[1]))) + (((start[2]) - ((((A_data_box) -> imin)[2]))) * (((0)<((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1))) ? ((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((start[0]) - ((((x_data_box) -> imin)[0]))) + (((start[1]) - ((((x_data_box) -> imin)[1]))) + (((start[2]) - ((((x_data_box) -> imin)[2]))) * (((0)<((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1))) ? ((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0))); int hypre__i3start = (((start[0]) - ((((t_data_box) -> imin)[0]))) + (((start[1]) - ((((t_data_box) -> imin)[1]))) + (((start[2]) - ((((t_data_box) -> imin)[2]))) * (((0)<((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1))) ? ((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stride[0]));int hypre__sy1 = ((stride[1])*(((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stride[2])* (((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1))) ? ((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stride[0]));int hypre__sy2 = ((stride[1])*(((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stride[2])* (((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1))) ? ((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx3 = ((stride[0]));int hypre__sy3 = ((stride[1])*(((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz3 = ((stride[2])* (((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1))) ? ((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 559 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; Ai = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; xi = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; ti = hypre__i3start + loopi*hypre__sx3 + loopj*hypre__sy3 + loopk*hypre__sz3; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                              {
                                 tp[ti] -= Ap[Ai] * xp[xi];
                              }
                           Ai += hypre__sx1; xi += hypre__sx2; ti += hypre__sx3; } Ai += hypre__sy1 - hypre__nx*hypre__sx1; xi += hypre__sy2 - hypre__nx*hypre__sx2; ti += hypre__sy3 - hypre__nx*hypre__sx3; } Ai += hypre__sz1 - hypre__ny*hypre__sy1; xi += hypre__sz2 - hypre__ny*hypre__sy2; ti += hypre__sz3 - hypre__ny*hypre__sy3; } }};
                        }
                     }

                     Ap = (((A) -> data) + ((A) -> data_indices)[i][diag_rank]);

                     { int hypre__i1start = (((start[0]) - ((((A_data_box) -> imin)[0]))) + (((start[1]) - ((((A_data_box) -> imin)[1]))) + (((start[2]) - ((((A_data_box) -> imin)[2]))) * (((0)<((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1))) ? ((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((start[0]) - ((((t_data_box) -> imin)[0]))) + (((start[1]) - ((((t_data_box) -> imin)[1]))) + (((start[2]) - ((((t_data_box) -> imin)[2]))) * (((0)<((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1))) ? ((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stride[0]));int hypre__sy1 = ((stride[1])*(((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stride[2])* (((0)<((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1))) ? ((((((A_data_box) -> imax)[0])) - ((((A_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1))) ? ((((((A_data_box) -> imax)[1])) - ((((A_data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stride[0]));int hypre__sy2 = ((stride[1])*(((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stride[2])* (((0)<((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1))) ? ((((((t_data_box) -> imax)[0])) - ((((t_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1))) ? ((((((t_data_box) -> imax)[1])) - ((((t_data_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_smp_forloop.h" 1
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/hypre_box_smp_forloop.h" 2
# 574 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/point_relax.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; Ai = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; ti = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                        {
                           tp[ti] /= Ap[Ai];
                        }
                     Ai += hypre__sx1; ti += hypre__sx2; } Ai += hypre__sy1 - hypre__nx*hypre__sx1; ti += hypre__sy2 - hypre__nx*hypre__sx2; } Ai += hypre__sz1 - hypre__ny*hypre__sy1; ti += hypre__sz2 - hypre__ny*hypre__sy2; } }};
                  }
            }
      }
                                 ...
                                 int num_pointsets )
{
   ...
   (relax_data -> pointset_sizes) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_pointsets))) );
   (relax_data -> pointset_ranks) = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_pointsets))) );
   (relax_data -> pointset_strides) = ( (hypre_Index *)hypre_MAlloc((unsigned int)(sizeof(hypre_Index) * (num_pointsets))) );
   (relax_data -> pointset_indices) = ( (hypre_Index * *)hypre_MAlloc((unsigned int)(sizeof(hypre_Index *) * (num_pointsets))) );

   for (i = 0; i < num_pointsets; i++)
   {
      (relax_data -> pointset_sizes[i]) = 0;
      (relax_data -> pointset_ranks[i]) = i;
      (relax_data -> pointset_indices[i]) = ((void*)0);
   }
                             ...
                             hypre_Index *pointset_indices )
{
   ...
   ( hypre_Free((char *)relax_data -> pointset_indices[pointset]), relax_data -> pointset_indices[pointset] = ((void*)0) );


   (relax_data -> pointset_indices[pointset]) =
      ( (hypre_Index *)hypre_MAlloc((unsigned int)(sizeof(hypre_Index) * (pointset_size))) );

   (relax_data -> pointset_sizes[pointset]) = pointset_size;
   ( ((relax_data -> pointset_strides[pointset])[0]) = (pointset_stride[0]), ((relax_data -> pointset_strides[pointset])[1]) = (pointset_stride[1]), ((relax_data -> pointset_strides[pointset])[2]) = (pointset_stride[2]) );

   for (i = 0; i < pointset_size; i++)
   {
      ( ((relax_data -> pointset_indices[pointset][i])[0]) = (pointset_indices[i][0]), ((relax_data -> pointset_indices[pointset][i])[1]) = (pointset_indices[i][1]), ((relax_data -> pointset_indices[pointset][i])[2]) = (pointset_indices[i][2]) );
