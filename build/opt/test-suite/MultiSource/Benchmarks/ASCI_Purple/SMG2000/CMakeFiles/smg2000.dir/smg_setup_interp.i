# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup_interp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup_interp.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup_interp.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup_interp.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup_interp.c" 2
                         ...
                         int cdir )
{
   ...
   stencil_size = 2;
   stencil_dim = ((((A) -> stencil)) -> dim);
   stencil_shape = ( (hypre_Index *)hypre_CAlloc((unsigned int)(stencil_size), (unsigned int)sizeof(hypre_Index)) );
   for (i = 0; i < stencil_size; i++)
   {
      ( (stencil_shape[i][0]) = 0, (stencil_shape[i][1]) = 0, (stencil_shape[i][2]) = 0 );
   }
   (stencil_shape[0][cdir]) = -1;
   (stencil_shape[1][cdir]) = 1;
   stencil =
      hypre_StructStencilCreate(stencil_dim, stencil_size, stencil_shape);


   PT = hypre_StructMatrixCreate(((A) -> comm), cgrid, stencil);
...
# 78 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup_interp.c"
int
                        ...
                        hypre_Index stride )
{
   ...
   A_stencil = ((A) -> stencil);
   A_stencil_shape = ((A_stencil) -> shape);
   A_stencil_size = ((A_stencil) -> size);
   PT_stencil = ((PT) -> stencil);
   PT_stencil_shape = ((PT_stencil) -> shape);
   PT_stencil_size = ((PT_stencil) -> size);
   ...
   compute_pkg_stencil_shape =
      ( (hypre_Index *)hypre_CAlloc((unsigned int)(compute_pkg_stencil_size), (unsigned int)sizeof(hypre_Index)) );
   ...
   for (si = 0; si < PT_stencil_size; si++)
   {
      ...
      stencil_indices = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (A_stencil_size))) );
      num_stencil_indices = 0;
      for (sj = 0; sj < A_stencil_size; sj++)
      {
         if ((A_stencil_shape[sj][cdir]) !=
             (PT_stencil_shape[si][cdir]) )
         {
      ...
      ( hypre_Free((char *)stencil_indices), stencil_indices = ((void*)0) );
      ...
      ( (compute_pkg_stencil_shape[0][0]) = (PT_stencil_shape[si][0]), (compute_pkg_stencil_shape[0][1]) = (PT_stencil_shape[si][1]), (compute_pkg_stencil_shape[0][2]) = (PT_stencil_shape[si][2]) );
      ...
      for (compute_i = 0; compute_i < 2; compute_i++)
      {
         ...
         for (i = 0; i < ((compute_box_aa) -> size); i++)
            {
               compute_box_a =
                  ((compute_box_aa) -> box_arrays[(i)]);

               x_data_box =
                  &((((x) -> data_space)) -> boxes[(i)]);
               PT_data_box =
                  &((((PT) -> data_space)) -> boxes[(i)]);

               xp = (((x) -> data) + ((x) -> data_indices)[i]);
               PTp = (((PT) -> data) + ((PT) -> data_indices)[i][si]);
               ...
               for (j = 0; j < ((compute_box_a) -> size); j++)
                  {
                     ...
                     {
                        (start[d]) +=
                           (PT_stencil_shape[si][d]);
                     }

                     hypre_BoxGetStrideSize(compute_box, stride, loop_size);
                     { int hypre__i1start = (((start[0]) - ((((x_data_box) -> imin)[0]))) + (((start[1]) - ((((x_data_box) -> imin)[1]))) + (((start[2]) - ((((x_data_box) -> imin)[2]))) * (((0)<((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1))) ? ((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((startc[0]) - ((((PT_data_box) -> imin)[0]))) + (((startc[1]) - ((((PT_data_box) -> imin)[1]))) + (((startc[2]) - ((((PT_data_box) -> imin)[2]))) * (((0)<((((((PT_data_box) -> imax)[1])) - ((((PT_data_box) -> imin)[1])) + 1))) ? ((((((PT_data_box) -> imax)[1])) - ((((PT_data_box) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((PT_data_box) -> imax)[0])) - ((((PT_data_box) -> imin)[0])) + 1))) ? ((((((PT_data_box) -> imax)[0])) - ((((PT_data_box) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stride[0]));int hypre__sy1 = ((stride[1])*(((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stride[2])* (((0)<((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1))) ? ((((((x_data_box) -> imax)[0])) - ((((x_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1))) ? ((((((x_data_box) -> imax)[1])) - ((((x_data_box) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stridec[0]));int hypre__sy2 = ((stridec[1])*(((0)<((((((PT_data_box) -> imax)[0])) - ((((PT_data_box) -> imin)[0])) + 1))) ? ((((((PT_data_box) -> imax)[0])) - ((((PT_data_box) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stridec[2])* (((0)<((((((PT_data_box) -> imax)[0])) - ((((PT_data_box) -> imin)[0])) + 1))) ? ((((((PT_data_box) -> imax)[0])) - ((((PT_data_box) -> imin)[0])) + 1)) : (0))*(((0)<((((((PT_data_box) -> imax)[1])) - ((((PT_data_box) -> imin)[1])) + 1))) ? ((((((PT_data_box) -> imax)[1])) - ((((PT_data_box) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
