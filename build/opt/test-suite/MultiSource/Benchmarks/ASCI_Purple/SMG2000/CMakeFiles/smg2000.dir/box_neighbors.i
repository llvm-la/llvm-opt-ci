# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_neighbors.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_neighbors.c" 2
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_neighbors.c"
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_neighbors.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_neighbors.c"
int
                      ...
                      hypre_RankLink **rank_link_ptr)
{
   ...
   rank_link = ( (hypre_RankLink *)hypre_MAlloc((unsigned int)(sizeof(hypre_RankLink) * (1))) );
                          ...
                          hypre_BoxNeighbors **neighbors_ptr )
{
   ...
   neighbors = ( (hypre_BoxNeighbors *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_BoxNeighbors)) );
   ((neighbors) -> rank_links) =
      ( (hypre_RankLinkArray *)hypre_CAlloc((unsigned int)(num_local), (unsigned int)sizeof(hypre_RankLinkArray)) );
   ...
   ((neighbors) -> num_periodic) = num_periodic;

   *neighbors_ptr = neighbors;

   return 0;
}
# 112 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_neighbors.c"
int
                            ...
                            int prune )
{
            ...
            if (i != ilocal)
            {
               ...
               if (distance <= max_distance)
               {
                  ...
                  if (j < num_local)
                  {
                     ...
                     ((rank_link) -> next) =
                        (((neighbors) -> rank_links)[j][distance_index[0]+1][distance_index[1]+1][distance_index[2]+1]);



                     (((neighbors) -> rank_links)[j][distance_index[0]+1][distance_index[1]+1][distance_index[2]+1]) = rank_link;
   ...
   if (prune)
   {
      ...
      for (inew = 0; inew < num_boxes; inew++)
      {
         ...
         ( ( (((&((boxes) -> boxes[(inew)])) -> imin)[0]) = (((&((boxes) -> boxes[(i)])) -> imin)[0]), (((&((boxes) -> boxes[(inew)])) -> imin)[1]) = (((&((boxes) -> boxes[(i)])) -> imin)[1]), (((&((boxes) -> boxes[(inew)])) -> imin)[2]) = (((&((boxes) -> boxes[(i)])) -> imin)[2]) ), ( (((&((boxes) -> boxes[(inew)])) -> imax)[0]) = (((&((boxes) -> boxes[(i)])) -> imax)[0]), (((&((boxes) -> boxes[(inew)])) -> imax)[1]) = (((&((boxes) -> boxes[(i)])) -> imax)[1]), (((&((boxes) -> boxes[(inew)])) -> imax)[2]) = (((&((boxes) -> boxes[(i)])) -> imax)[2]) ) );
   ...
   ((neighbors) -> first_local) = first_local;
# 297 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_neighbors.c"
   return ierr;
}
      ...
      for (b = 0; b < ((neighbors) -> num_local); b++)
      {
         for (k = -1; k <= 1; k++)
         {
            for (j = -1; j <= 1; j++)
            {
               ...
               {
                  rank_link =
                     (((neighbors) -> rank_links)[b][i+1][j+1][k+1]);
                  while (rank_link)
                  {
