# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c" 2
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c" 2
# 27 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
int
...
{
   (cindex[0]) =
      ((findex[0]) - (index[0])) / (stride[0]);
   (cindex[1]) =
      ((findex[1]) - (index[1])) / (stride[1]);
   (cindex[2]) =
      ((findex[2]) - (index[2])) / (stride[2]);

   return 0;
}
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
int
...
{
   (findex[0]) =
      (cindex[0]) * (stride[0]) + (index[0]);
   (findex[1]) =
      (cindex[1]) * (stride[1]) + (index[1]);
   (findex[2]) =
      (cindex[2]) * (stride[2]) + (index[2]);

   return 0;
}
# 133 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
int
                     ...
                     hypre_StructGrid **cgrid_ptr )
{
   ...
   hypre_MPI_Status *send_status;
   int *send_buffer;
   int send_size;
   hypre_MPI_Request *recv_requests;
   hypre_MPI_Status *recv_status;
   int **recv_buffers;
   int *recv_sizes;
   int my_rank;
   ...
   comm = ((fgrid) -> comm);
   dim = ((fgrid) -> dim);
   neighbors = ((fgrid) -> neighbors);
   hood_boxes = hypre_BoxArrayDuplicate(((neighbors) -> boxes));
   num_hood = ((hood_boxes) -> size);

   iarray = ((neighbors) -> procs);
   hood_procs = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_hood))) );
   for (i = 0; i < num_hood; i++)
   {
      hood_procs[i] = iarray[i];
   }

   iarray = ((neighbors) -> ids);
   hood_ids = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_hood))) );
   for (i = 0; i < num_hood; i++)
   {
      hood_ids[i] = iarray[i];
   }
   ...
   num_periodic = ((neighbors) -> num_periodic);

   max_distance = ((fgrid) -> max_distance);
   bounding_box = hypre_BoxDuplicate(((fgrid) -> bounding_box));
   ( (periodic[0]) = (((fgrid) -> periodic)[0]), (periodic[1]) = (((fgrid) -> periodic)[1]), (periodic[2]) = (((fgrid) -> periodic)[2]) );

   hypre_MPI_Comm_rank(comm, &my_rank);
# 261 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
   hypre_ProjectBox(bounding_box, index, stride);hypre_StructMapFineToCoarse(((bounding_box) -> imin), index, stride, ((bounding_box) -> imin));hypre_StructMapFineToCoarse(((bounding_box) -> imax), index, stride, ((bounding_box) -> imax));
# 271 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
   ...
   for (i = 0; i < num_hood; i++)
   {
      if (hood_procs[i] != my_rank)
      {
         for (j = 0; j < num_local; j++)
         {
            ...
            local_box = &((hood_boxes) -> boxes[(ilocal)]);
            neighbor_box = &((hood_boxes) -> boxes[(i)]);


            ( ( (((local_cbox) -> imin)[0]) = (((local_box) -> imin)[0]), (((local_cbox) -> imin)[1]) = (((local_box) -> imin)[1]), (((local_cbox) -> imin)[2]) = (((local_box) -> imin)[2]) ), ( (((local_cbox) -> imax)[0]) = (((local_box) -> imax)[0]), (((local_cbox) -> imax)[1]) = (((local_box) -> imax)[1]), (((local_cbox) -> imax)[2]) = (((local_box) -> imax)[2]) ) );
            hypre_ProjectBox(local_cbox, index, stride);hypre_StructMapFineToCoarse(((local_cbox) -> imin), index, stride, ((local_cbox) -> imin));hypre_StructMapFineToCoarse(((local_cbox) -> imax), index, stride, ((local_cbox) -> imax));
            ( ( (((neighbor_cbox) -> imin)[0]) = (((neighbor_box) -> imin)[0]), (((neighbor_cbox) -> imin)[1]) = (((neighbor_box) -> imin)[1]), (((neighbor_cbox) -> imin)[2]) = (((neighbor_box) -> imin)[2]) ), ( (((neighbor_cbox) -> imax)[0]) = (((neighbor_box) -> imax)[0]), (((neighbor_cbox) -> imax)[1]) = (((neighbor_box) -> imax)[1]), (((neighbor_cbox) -> imax)[2]) = (((neighbor_box) -> imax)[2]) ) );
            hypre_ProjectBox(neighbor_cbox, index, stride);hypre_StructMapFineToCoarse(((neighbor_cbox) -> imin), index, stride, ((neighbor_cbox) -> imin));hypre_StructMapFineToCoarse(((neighbor_cbox) -> imax), index, stride, ((neighbor_cbox) -> imax));
# 342 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
            perimeter_count = 0;
            cperimeter_count = 1;
            ...
            if (cperimeter_count > perimeter_count)
            {
               if (num_recvs == 0)
               {
                  recv_procs = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_hood))) );
...
# 407 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
            perimeter_count = 0;
            cperimeter_count = 1;
            ...
            if (cperimeter_count > perimeter_count)
            {
               if (num_sends == 0)
               {
                  send_procs = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_hood))) );
   ...
   for (i = 0; i < num_hood; i++)
   {
      box = &((hood_boxes) -> boxes[(i)]);
      hypre_ProjectBox(box, index, stride);hypre_StructMapFineToCoarse(((box) -> imin), index, stride, ((box) -> imin));hypre_StructMapFineToCoarse(((box) -> imax), index, stride, ((box) -> imax));
   }
# 461 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/coarsen.c"
   if (num_recvs)
   {
      recv_requests = ( (hypre_MPI_Request *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Request) * (num_recvs))) );
      recv_status = ( (hypre_MPI_Status *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Status) * (num_recvs))) );

      recv_sizes = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (num_recvs))) );
      for (i = 0; i < num_recvs; i++)
      {
         hypre_MPI_Irecv(&recv_sizes[i], 1, 1,
   ...
   if (num_sends)
   {
      send_requests = ( (hypre_MPI_Request *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Request) * (num_sends))) );
      send_status = ( (hypre_MPI_Status *)hypre_MAlloc((unsigned int)(sizeof(hypre_MPI_Status) * (num_sends))) );

      send_size = 8 * ((hood_boxes) -> size);
      for (i = 0; i < num_sends; i++)
      {
         hypre_MPI_Isend(&send_size, 1, 1,
   ...
   if (num_recvs)
   {
      hypre_MPI_Waitall(num_recvs, recv_requests, recv_status);
   }


   if (num_sends)
   {
      hypre_MPI_Waitall(num_sends, send_requests, send_status);
   }
   ...
   if (num_recvs)
   {
      recv_buffers = ( (int * *)hypre_MAlloc((unsigned int)(sizeof(int *) * (num_recvs))) );
      for (i = 0; i < num_recvs; i++)
      {
         recv_buffers[i] = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * ((recv_sizes[i])))) );
         hypre_MPI_Irecv(recv_buffers[i], recv_sizes[i], 1,
                   recv_procs[i], 0, comm, &recv_requests[i]);
      }
   }
   ...
   if (num_sends)
   {
      ...
      send_buffer = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * ((send_size)))) );
      j = 0;
      for (i = 0; i < num_hood; i++)
      {
         ...
         for (d = 0; d < 3; d++)
         {
            send_buffer[j++] = ((((box) -> imin)[d]));
            send_buffer[j++] = ((((box) -> imax)[d]));
         }
      }

      for (i = 0; i < num_sends; i++)
      {
         hypre_MPI_Isend(send_buffer, send_size, 1,
                   send_procs[i], 0, comm, &send_requests[i]);
      }
   }
   ...
   if (num_recvs)
   {
      ...
      ( hypre_Free((char *)recv_requests), recv_requests = ((void*)0) );
      ( hypre_Free((char *)recv_status), recv_status = ((void*)0) );
   }
   ...
   if (num_sends)
   {
      ...
      ( hypre_Free((char *)send_requests), send_requests = ((void*)0) );
      ( hypre_Free((char *)send_status), send_status = ((void*)0) );
      ( hypre_Free((char *)send_buffer), send_buffer = ((void*)0) );
   }
   ...
   if (num_recvs)
   {
      ...
      new_hood_procs = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (alloc_size))) );
      new_hood_ids = ( (int *)hypre_MAlloc((unsigned int)(sizeof(int) * (alloc_size))) );

      box = hypre_BoxCreate();

      j = 0;
      jrecv = ( (int *)hypre_CAlloc((unsigned int)(num_recvs), (unsigned int)sizeof(int)) );
      new_num_hood = 0;
      while (1)
      {
         data_id = -2;
         ...
         if (data_id > -2)
         {
            if (new_num_hood == alloc_size)
            {
               alloc_size += num_hood;
               new_hood_procs =
                  ( (int *)hypre_ReAlloc((char *)new_hood_procs, (unsigned int)(sizeof(int) * (alloc_size))) );
               new_hood_ids =
                  ( (int *)hypre_ReAlloc((char *)new_hood_ids, (unsigned int)(sizeof(int) * (alloc_size))) );
            }
            ...
            if (data_id == -1)
            {
               ...
               hypre_AppendBox(&((hood_boxes) -> boxes[(j)]),
                               new_hood_boxes);
               if (j == first_local)
               {
            ...
            else
            {
               ...
               for (d = 0; d < 3; d++)
               {
                  (imin[d]) = recv_buffers[data_id][jj++];
                  (imax[d]) = recv_buffers[data_id][jj++];
               }
      ...
      for (i = 0; i < num_recvs; i++)
      {
         ( hypre_Free((char *)recv_buffers[i]), recv_buffers[i] = ((void*)0) );
      }
      ( hypre_Free((char *)recv_buffers), recv_buffers = ((void*)0) );
      ( hypre_Free((char *)recv_sizes), recv_sizes = ((void*)0) );

      hypre_BoxDestroy(box);
      ( hypre_Free((char *)jrecv), jrecv = ((void*)0) );

      hypre_BoxArrayDestroy(hood_boxes);
      ( hypre_Free((char *)hood_procs), hood_procs = ((void*)0) );
      ( hypre_Free((char *)hood_ids), hood_ids = ((void*)0) );
   ...
   if (prune)
   {
      ...
      {
         box = &((hood_boxes) -> boxes[(i)]);
         if ( ((((0)<((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1))) ? ((((((box) -> imax)[0])) - ((((box) -> imin)[0])) + 1)) : (0)) * (((0)<((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1))) ? ((((((box) -> imax)[1])) - ((((box) -> imin)[1])) + 1)) : (0)) * (((0)<((((((box) -> imax)[2])) - ((((box) -> imin)[2])) + 1))) ? ((((((box) -> imax)[2])) - ((((box) -> imin)[2])) + 1)) : (0))) )
         {
            ( ( (((&((hood_boxes) -> boxes[(j)])) -> imin)[0]) = (((box) -> imin)[0]), (((&((hood_boxes) -> boxes[(j)])) -> imin)[1]) = (((box) -> imin)[1]), (((&((hood_boxes) -> boxes[(j)])) -> imin)[2]) = (((box) -> imin)[2]) ), ( (((&((hood_boxes) -> boxes[(j)])) -> imax)[0]) = (((box) -> imax)[0]), (((&((hood_boxes) -> boxes[(j)])) -> imax)[1]) = (((box) -> imax)[1]), (((&((hood_boxes) -> boxes[(j)])) -> imax)[2]) = (((box) -> imax)[2]) ) );
