# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication_info.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication_info.c" 2
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication_info.c"
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication_info.c" 2
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication_info.c"
int
                                 ...
                                 int ***recv_procs_ptr )
{
   ...
   send_procs = ( (int * *)hypre_CAlloc((unsigned int)(((boxes) -> size)), (unsigned int)sizeof(int *)) );
   recv_procs = ( (int * *)hypre_CAlloc((unsigned int)(((boxes) -> size)), (unsigned int)sizeof(int *)) );

   stencil_shape = ((stencil) -> shape);

   neighbor_boxes = ((neighbors) -> boxes);
   neighbor_procs = ((neighbors) -> procs);

   box0 = hypre_BoxCreate();
   shift_box = hypre_BoxCreate();

   cbox_arrays =
      ( (hypre_BoxArray * *)hypre_CAlloc((unsigned int)(((neighbor_boxes) -> size)), (unsigned int)sizeof(hypre_BoxArray *)) );
   cbox_arrays_i =
      ( (int *)hypre_CAlloc((unsigned int)(((neighbor_boxes) -> size)), (unsigned int)sizeof(int)) );

   for (i = 0; i < ((boxes) -> size); i++)
      {
         box = &((boxes) -> boxes[(i)]);
         ( ( (((shift_box) -> imin)[0]) = (((box) -> imin)[0]), (((shift_box) -> imin)[1]) = (((box) -> imin)[1]), (((shift_box) -> imin)[2]) = (((box) -> imin)[2]) ), ( (((shift_box) -> imax)[0]) = (((box) -> imax)[0]), (((shift_box) -> imax)[1]) = (((box) -> imax)[1]), (((shift_box) -> imax)[2]) = (((box) -> imax)[2]) ) );
         ...
         for (s = 0; s < ((stencil) -> size); s++)
         {
            ...
            {
               ((((shift_box) -> imin)[d])) =
                  ((((box) -> imin)[d])) + (stencil_offset[d]);
               ((((shift_box) -> imax)[d])) =
                  ((((box) -> imax)[d])) + (stencil_offset[d]);
            }

            { int hypre__istart = 0; int hypre__jstart = 0; int hypre__kstart = 0; int hypre__istop = 0; int hypre__jstop = 0; int hypre__kstop = 0; hypre_RankLink *hypre__rank_link; int hypre__i, hypre__j, hypre__k; hypre__i = (stencil_offset[0]); if (hypre__i < 0) hypre__istart = -1; else if (hypre__i > 0) hypre__istop = 1; hypre__j = (stencil_offset[1]); if (hypre__j < 0) hypre__jstart = -1; else if (hypre__j > 0) hypre__jstop = 1; hypre__k = (stencil_offset[2]); if (hypre__k < 0) hypre__kstart = -1; else if (hypre__k > 0) hypre__kstop = 1; for (hypre__k = hypre__kstart; hypre__k <= hypre__kstop; hypre__k++) { for (hypre__j = hypre__jstart; hypre__j <= hypre__jstop; hypre__j++) { for (hypre__i = hypre__istart; hypre__i <= hypre__istop; hypre__i++) { hypre__rank_link = (((neighbors) -> rank_links)[i][hypre__i+1][hypre__j+1][hypre__k+1]); while (hypre__rank_link) { j = ((hypre__rank_link) -> rank);
               {
                  neighbor_box = &((neighbor_boxes) -> boxes[(j)]);

                  hypre_IntersectBoxes(shift_box, neighbor_box, box0);
                  if (((((0)<((((((box0) -> imax)[0])) - ((((box0) -> imin)[0])) + 1))) ? ((((((box0) -> imax)[0])) - ((((box0) -> imin)[0])) + 1)) : (0)) * (((0)<((((((box0) -> imax)[1])) - ((((box0) -> imin)[1])) + 1))) ? ((((((box0) -> imax)[1])) - ((((box0) -> imin)[1])) + 1)) : (0)) * (((0)<((((((box0) -> imax)[2])) - ((((box0) -> imin)[2])) + 1))) ? ((((((box0) -> imax)[2])) - ((((box0) -> imin)[2])) + 1)) : (0))))
                  {
                     if (cbox_arrays[j] == ((void*)0))
                     {
         ...
         for (m = 0; m < num_cbox_arrays; m++)
         {
            ...
            recv_box_array_size += ((cbox_arrays[j]) -> size);
         }


         recv_box_array = ((recv_boxes) -> box_arrays[(i)]);
         hypre_BoxArraySetSize(recv_box_array, recv_box_array_size);
         recv_procs[i] = ( (int *)hypre_CAlloc((unsigned int)(recv_box_array_size), (unsigned int)sizeof(int)) );
         n = 0;
         for (m = 0; m < num_cbox_arrays; m++)
         {
            j = cbox_arrays_i[m];
            for (k = 0; k < ((cbox_arrays[j]) -> size); k++)
               {
                  recv_procs[i][n] = neighbor_procs[j];
                  ( ( (((&((recv_box_array) -> boxes[(n)])) -> imin)[0]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imin)[0]), (((&((recv_box_array) -> boxes[(n)])) -> imin)[1]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imin)[1]), (((&((recv_box_array) -> boxes[(n)])) -> imin)[2]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imin)[2]) ), ( (((&((recv_box_array) -> boxes[(n)])) -> imax)[0]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imax)[0]), (((&((recv_box_array) -> boxes[(n)])) -> imax)[1]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imax)[1]), (((&((recv_box_array) -> boxes[(n)])) -> imax)[2]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imax)[2]) ) );

                  n++;
               }
            hypre_BoxArrayDestroy(cbox_arrays[j]);
            cbox_arrays[j] = ((void*)0);
         }
         ...
         for (m = 0; m < num_cbox_arrays; m++)
         {
            j = cbox_arrays_i[m];
            hypre_UnionBoxes(cbox_arrays[j]);
            send_box_array_size += ((cbox_arrays[j]) -> size);
         }


         send_box_array = ((send_boxes) -> box_arrays[(i)]);
         hypre_BoxArraySetSize(send_box_array, send_box_array_size);
         send_procs[i] = ( (int *)hypre_CAlloc((unsigned int)(send_box_array_size), (unsigned int)sizeof(int)) );
         n = 0;
         for (m = 0; m < num_cbox_arrays; m++)
         {
            j = cbox_arrays_i[m];
            for (k = 0; k < ((cbox_arrays[j]) -> size); k++)
               {
                  ...
                  ( ( (((&((send_box_array) -> boxes[(n)])) -> imin)[0]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imin)[0]), (((&((send_box_array) -> boxes[(n)])) -> imin)[1]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imin)[1]), (((&((send_box_array) -> boxes[(n)])) -> imin)[2]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imin)[2]) ), ( (((&((send_box_array) -> boxes[(n)])) -> imax)[0]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imax)[0]), (((&((send_box_array) -> boxes[(n)])) -> imax)[1]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imax)[1]), (((&((send_box_array) -> boxes[(n)])) -> imax)[2]) = (((&((cbox_arrays[j]) -> boxes[(k)])) -> imax)[2]) ) );
   ...
   ( hypre_Free((char *)cbox_arrays), cbox_arrays = ((void*)0) );
   ( hypre_Free((char *)cbox_arrays_i), cbox_arrays_i = ((void*)0) );
...
# 331 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication_info.c"
int
   ...
   for (i = 0; i < ((boxes) -> size); i++)
      {
         ...
         {
            ((((grow_box) -> imin)[d])) =
               ((((box) -> imin)[d])) - num_ghost[2*d];
            ((((grow_box) -> imax)[d])) =
               ((((box) -> imax)[d])) + num_ghost[2*d + 1];
         }

         for (j = 0; j < ((neighbor_boxes) -> size); j++)
            {
         ...
         for (j = 0; j < ((neighbor_boxes) -> size); j++)
            {
               if (ids[i] != neighbor_ids[j])
               {
                  ...
                  {
                     ((((grow_box) -> imin)[d])) =
                        ((((neighbor_box) -> imin)[d])) - num_ghost[2*d];
                     ((((grow_box) -> imax)[d])) =
                        ((((neighbor_box) -> imax)[d])) + num_ghost[2*d + 1];
                  }
...
# 577 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication_info.c"
int
                               ...
                               int ***recv_procs_ptr )
{
   ...
   for (r = 0; r < 2; r++)
   {
      ...
      local_boxes = ((local_grid) -> boxes);
      remote_boxes = ((remote_grid) -> boxes);
      hypre_GatherAllBoxes(((remote_grid) -> comm), remote_boxes,
                           &remote_all_boxes,
                           &remote_all_procs,
                           &remote_first_local);

      comm_boxes = hypre_BoxArrayArrayCreate(((local_boxes) -> size));
      comm_procs = ( (int * *)hypre_CAlloc((unsigned int)(((local_boxes) -> size)), (unsigned int)sizeof(int *)) );

      comm_box = hypre_BoxCreate();
      for (i = 0; i < ((local_boxes) -> size); i++)
         {
            local_box = &((local_boxes) -> boxes[(i)]);

            comm_box_array = ((comm_boxes) -> box_arrays[(i)]);
            comm_procs[i] =
               ( (int *)hypre_CAlloc((unsigned int)(((remote_all_boxes) -> size)), (unsigned int)sizeof(int)) );

            for (j = 0; j < ((remote_all_boxes) -> size); j++)
               {
                  remote_box = &((remote_all_boxes) -> boxes[(j)]);

                  hypre_IntersectBoxes(local_box, remote_box, comm_box);
                  if (((((0)<((((((comm_box) -> imax)[0])) - ((((comm_box) -> imin)[0])) + 1))) ? ((((((comm_box) -> imax)[0])) - ((((comm_box) -> imin)[0])) + 1)) : (0)) * (((0)<((((((comm_box) -> imax)[1])) - ((((comm_box) -> imin)[1])) + 1))) ? ((((((comm_box) -> imax)[1])) - ((((comm_box) -> imin)[1])) + 1)) : (0)) * (((0)<((((((comm_box) -> imax)[2])) - ((((comm_box) -> imin)[2])) + 1))) ? ((((((comm_box) -> imax)[2])) - ((((comm_box) -> imin)[2])) + 1)) : (0))))
                  {
                     k = ((comm_box_array) -> size);
            ...
            comm_procs[i] =
               ( (int *)hypre_ReAlloc((char *)comm_procs[i], (unsigned int)(sizeof(int) * (((comm_box_array) -> size)))) );

         }
      hypre_BoxDestroy(comm_box);

      hypre_BoxArrayDestroy(remote_all_boxes);
      ( hypre_Free((char *)remote_all_procs), remote_all_procs = ((void*)0) );
