# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_alloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_alloc.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_alloc.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box_alloc.c" 2
...
static union box_memory *s_free = ((void*)0);
static union box_memory *s_finalize = ((void*)0);
...
hypre_AllocateBoxBlock()
{
   ...
   ptr = ( (union box_memory *)hypre_MAlloc((unsigned int)(sizeof(union box_memory) * (s_at_a_time))) );
...
hypre_BoxFinalizeMemory()
{
   ...
   while (s_finalize)
   {
      ...
      ( hypre_Free((char *)byebye), byebye = ((void*)0) );
   }
   s_finalize = ((void*)0);
   s_free = ((void*)0);
