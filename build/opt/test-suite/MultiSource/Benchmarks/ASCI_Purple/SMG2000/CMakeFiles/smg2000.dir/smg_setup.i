# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c" 2
                ...
                hypre_StructVector *x )
{
   ...
   hypre_MPI_Comm comm = (smg_data -> comm);
   ...
   int ierr = 0;
# 95 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
   cdir = ((((A) -> stencil)) -> dim) - 1;
   (smg_data -> cdir) = cdir;
   ...
   max_levels = hypre_Log2((((0)<((((((cbox) -> imax)[cdir])) - ((((cbox) -> imin)[cdir])) + 1))) ? ((((((cbox) -> imax)[cdir])) - ((((cbox) -> imin)[cdir])) + 1)) : (0))) + 2;
   if ((smg_data -> max_levels) > 0)
   {
      max_levels = (((max_levels)<((smg_data -> max_levels))) ? (max_levels) : ((smg_data -> max_levels)));
   }
   (smg_data -> max_levels) = max_levels;

   grid_l = ( (hypre_StructGrid * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructGrid *) * (max_levels))) );
   PT_grid_l = ( (hypre_StructGrid * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructGrid *) * (max_levels))) );
   PT_grid_l[0] = ((void*)0);
   ...
   PT_l = ( (hypre_StructMatrix * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructMatrix *) * (num_levels - 1))) );
   R_l = ( (hypre_StructMatrix * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructMatrix *) * (num_levels - 1))) );
   b_l = ( (hypre_StructVector * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructVector *) * (num_levels))) );
   x_l = ( (hypre_StructVector * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructVector *) * (num_levels))) );
   tb_l = ( (hypre_StructVector * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructVector *) * (num_levels))) );
   tx_l = ( (hypre_StructVector * *)hypre_MAlloc((unsigned int)(sizeof(hypre_StructVector *) * (num_levels))) );
   r_l = tx_l;
   e_l = tx_l;
   ...
   for (l = 0; l < (num_levels - 1); l++)
   {
      ...
      hypre_StructVectorSetNumGhost(tb_l[l+1], ((b) -> num_ghost));
      hypre_StructVectorInitializeShell(tb_l[l+1]);

      tx_l[l+1] = hypre_StructVectorCreate(comm, grid_l[l+1]);
      hypre_StructVectorSetNumGhost(tx_l[l+1], ((x) -> num_ghost));
   ...
   data += ((tb_l[0]) -> data_size);

   hypre_StructVectorInitializeData(tx_l[0], data);
   hypre_StructVectorAssemble(tx_l[0]);
   data += ((tx_l[0]) -> data_size);

   for (l = 0; l < (num_levels - 1); l++)
   {
      hypre_StructMatrixInitializeData(PT_l[l], data);
      data += ((PT_l[l]) -> data_size);
# 257 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
   ...
   (smg_data -> r_l) = r_l;
   (smg_data -> e_l) = e_l;
# 297 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
   relax_data_l = ( (void * *)hypre_MAlloc((unsigned int)(sizeof(void *) * (num_levels))) );
   residual_data_l = ( (void * *)hypre_MAlloc((unsigned int)(sizeof(void *) * (num_levels))) );
   restrict_data_l = ( (void * *)hypre_MAlloc((unsigned int)(sizeof(void *) * (num_levels))) );
   interp_data_l = ( (void * *)hypre_MAlloc((unsigned int)(sizeof(void *) * (num_levels))) );


   b_data = ((b_l[0]) -> data);
   b_data_alloced = ((b_l[0]) -> data_alloced);
   x_data = ((x_l[0]) -> data);
   x_data_alloced = ((x_l[0]) -> data_alloced);
   hypre_StructVectorInitializeData(b_l[0], ((tb_l[0]) -> data));
   hypre_StructVectorInitializeData(x_l[0], ((tx_l[0]) -> data));
   hypre_StructVectorAssemble(b_l[0]);
   hypre_StructVectorAssemble(x_l[0]);

   for (l = 0; l < (num_levels - 1); l++)
   {
      { if (l > 0) ( (bindex[0]) = 0, (bindex[1]) = 0, (bindex[2]) = 0 ); else ( (bindex[0]) = (base_index[0]), (bindex[1]) = (base_index[1]), (bindex[2]) = (base_index[2]) );};
      { if (l > 0) ( (bstride[0]) = 1, (bstride[1]) = 1, (bstride[2]) = 1 ); else ( (bstride[0]) = (base_stride[0]), (bstride[1]) = (base_stride[1]), (bstride[2]) = (base_stride[2]) );};
      { { if (l > 0) ( (cindex[0]) = 0, (cindex[1]) = 0, (cindex[2]) = 0 ); else ( (cindex[0]) = (base_index[0]), (cindex[1]) = (base_index[1]), (cindex[2]) = (base_index[2]) );}; (cindex[cdir]) += 0;};
...
# 365 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
   ...
   ((b_l[0]) -> data_alloced) = b_data_alloced;
   hypre_StructVectorInitializeData(x_l[0], x_data);
   ((x_l[0]) -> data_alloced) = x_data_alloced;
   hypre_StructVectorAssemble(b_l[0]);
   hypre_StructVectorAssemble(x_l[0]);
   ...
   if ((smg_data -> logging) > 0)
   {
      ...
      (smg_data -> norms) = ( (double *)hypre_MAlloc((unsigned int)(sizeof(double) * (max_iter))) );
      (smg_data -> rel_norms) = ( (double *)hypre_MAlloc((unsigned int)(sizeof(double) * (max_iter))) );
   }
# 433 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
   return ierr;
}
