# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_restrict.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_restrict.c" 2
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_restrict.c"
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_restrict.c" 2
...
hypre_SemiRestrictCreate( )
{
   ...
   restrict_data = ( (hypre_SemiRestrictData *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_SemiRestrictData)) );
                         ...
                         hypre_Index stride )
{
   ...
   ( ((restrict_data -> cindex)[0]) = (cindex[0]), ((restrict_data -> cindex)[1]) = (cindex[1]), ((restrict_data -> cindex)[2]) = (cindex[2]) );
   ( ((restrict_data -> stride)[0]) = (stride[0]), ((restrict_data -> stride)[1]) = (stride[1]), ((restrict_data -> stride)[2]) = (stride[2]) );
      ...
      for (ci = 0; ci < ((cgrid_boxes) -> size); ci++)
         {
            ...
            r_dbox = &((((r) -> data_space)) -> boxes[(fi)]);
            rc_dbox = &((((rc) -> data_space)) -> boxes[(ci)]);

            if (R_stored_as_transpose)
            {
               Rp0 = (((R) -> data) + ((R) -> data_indices)[fi][1]) -
                  ((stencil_shape[1][0]) + ((stencil_shape[1][1]) + ((stencil_shape[1][2]) * (((0)<((((((R_dbox) -> imax)[1])) - ((((R_dbox) -> imin)[1])) + 1))) ? ((((((R_dbox) -> imax)[1])) - ((((R_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1))) ? ((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1)) : (0)));
               Rp1 = (((R) -> data) + ((R) -> data_indices)[fi][0]);
            }
            else
            {
               Rp0 = (((R) -> data) + ((R) -> data_indices)[fi][0]);
               Rp1 = (((R) -> data) + ((R) -> data_indices)[fi][1]);
            }
            rp = (((r) -> data) + ((r) -> data_indices)[fi]);
            rp0 = rp + ((stencil_shape[0][0]) + ((stencil_shape[0][1]) + ((stencil_shape[0][2]) * (((0)<((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1))) ? ((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1))) ? ((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1)) : (0)));
            rp1 = rp + ((stencil_shape[1][0]) + ((stencil_shape[1][1]) + ((stencil_shape[1][2]) * (((0)<((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1))) ? ((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1))) ? ((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1)) : (0)));
            rcp = (((rc) -> data) + ((rc) -> data_indices)[ci]);
            ...
            for (j = 0; j < ((compute_box_a) -> size); j++)
               {
                  ...
                  { int hypre__i1start = (((startc[0]) - ((((R_dbox) -> imin)[0]))) + (((startc[1]) - ((((R_dbox) -> imin)[1]))) + (((startc[2]) - ((((R_dbox) -> imin)[2]))) * (((0)<((((((R_dbox) -> imax)[1])) - ((((R_dbox) -> imin)[1])) + 1))) ? ((((((R_dbox) -> imax)[1])) - ((((R_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1))) ? ((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1)) : (0))); int hypre__i2start = (((start[0]) - ((((r_dbox) -> imin)[0]))) + (((start[1]) - ((((r_dbox) -> imin)[1]))) + (((start[2]) - ((((r_dbox) -> imin)[2]))) * (((0)<((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1))) ? ((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1))) ? ((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1)) : (0))); int hypre__i3start = (((startc[0]) - ((((rc_dbox) -> imin)[0]))) + (((startc[1]) - ((((rc_dbox) -> imin)[1]))) + (((startc[2]) - ((((rc_dbox) -> imin)[2]))) * (((0)<((((((rc_dbox) -> imax)[1])) - ((((rc_dbox) -> imin)[1])) + 1))) ? ((((((rc_dbox) -> imax)[1])) - ((((rc_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((rc_dbox) -> imax)[0])) - ((((rc_dbox) -> imin)[0])) + 1))) ? ((((((rc_dbox) -> imax)[0])) - ((((rc_dbox) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stridec[0]));int hypre__sy1 = ((stridec[1])*(((0)<((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1))) ? ((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stridec[2])* (((0)<((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1))) ? ((((((R_dbox) -> imax)[0])) - ((((R_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((R_dbox) -> imax)[1])) - ((((R_dbox) -> imin)[1])) + 1))) ? ((((((R_dbox) -> imax)[1])) - ((((R_dbox) -> imin)[1])) + 1)) : (0))); int hypre__sx2 = ((stride[0]));int hypre__sy2 = ((stride[1])*(((0)<((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1))) ? ((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz2 = ((stride[2])* (((0)<((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1))) ? ((((((r_dbox) -> imax)[0])) - ((((r_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1))) ? ((((((r_dbox) -> imax)[1])) - ((((r_dbox) -> imin)[1])) + 1)) : (0))); int hypre__sx3 = ((stridec[0]));int hypre__sy3 = ((stridec[1])*(((0)<((((((rc_dbox) -> imax)[0])) - ((((rc_dbox) -> imin)[0])) + 1))) ? ((((((rc_dbox) -> imax)[0])) - ((((rc_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz3 = ((stridec[2])* (((0)<((((((rc_dbox) -> imax)[0])) - ((((rc_dbox) -> imin)[0])) + 1))) ? ((((((rc_dbox) -> imax)[0])) - ((((rc_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((rc_dbox) -> imax)[1])) - ((((rc_dbox) -> imin)[1])) + 1))) ? ((((((rc_dbox) -> imax)[1])) - ((((rc_dbox) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
...
# 260 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/semi_restrict.c" 2
 for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) { loopi = 0;loopj = 0;loopk = 0;hypre__nx = hypre__mx;hypre__ny = hypre__my;hypre__nz = hypre__mz;if (hypre__num_blocks > 1){ if (hypre__dir == 0) { loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 1) { loopj = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__ny = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); } else if (hypre__dir == 2) { loopk = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nz = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0); }}; Ri = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1; ri = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2; rci = hypre__i3start + loopi*hypre__sx3 + loopj*hypre__sy3 + loopk*hypre__sz3; for (loopk = 0; loopk < hypre__nz; loopk++) { for (loopj = 0; loopj < hypre__ny; loopj++) { for (loopi = 0; loopi < hypre__nx; loopi++) {
                     {
                        rcp[rci] = rp[ri] + (Rp0[Ri] * rp0[ri] +
                                             Rp1[Ri] * rp1[ri]);
                     }
                  Ri += hypre__sx1; ri += hypre__sx2; rci += hypre__sx3; } Ri += hypre__sy1 - hypre__nx*hypre__sx1; ri += hypre__sy2 - hypre__nx*hypre__sx2; rci += hypre__sy3 - hypre__nx*hypre__sx3; } Ri += hypre__sz1 - hypre__ny*hypre__sy1; ri += hypre__sz2 - hypre__ny*hypre__sy2; rci += hypre__sz3 - hypre__ny*hypre__sy3; } }};
               }
         }
   }
   ...
   hypre_IncFLOPCount(4*((rc) -> global_size));
...
hypre_SemiRestrictDestroy( void *restrict_vdata )
{
   ...
   if (restrict_data)
   {
      ...
      ( hypre_Free((char *)restrict_data), restrict_data = ((void*)0) );
   }
