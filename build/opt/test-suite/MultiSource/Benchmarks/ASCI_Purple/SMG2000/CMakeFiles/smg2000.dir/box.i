# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box.c" 2
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box.c"
...
# 17 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/box.c" 2
...
hypre_BoxCreate( )
{
   ...
   box = ( (hypre_Box *)hypre_MAlloc((unsigned int)(sizeof(hypre_Box) * (1))) );
...
hypre_BoxArrayCreate( int size )
{
   ...
   box_array = ( (hypre_BoxArray *)hypre_MAlloc((unsigned int)(sizeof(hypre_BoxArray) * (1))) );

   ((box_array) -> boxes) = ( (hypre_Box *)hypre_CAlloc((unsigned int)(size), (unsigned int)sizeof(hypre_Box)) );
   ((box_array) -> size) = size;
                       ...
                       int size )
{
   ...
   if (size > alloc_size)
   {
      ...
      ((box_array) -> boxes) =
         ( (hypre_Box *)hypre_ReAlloc((char *)((box_array) -> boxes), (unsigned int)(sizeof(hypre_Box) * (alloc_size))) );
...
hypre_BoxArrayArrayCreate( int size )
{
   ...
   box_array_array = ( (hypre_BoxArrayArray *)hypre_CAlloc((unsigned int)(1), (unsigned int)sizeof(hypre_BoxArrayArray)) );

   ((box_array_array) -> box_arrays) =
      ( (hypre_BoxArray * *)hypre_CAlloc((unsigned int)(size), (unsigned int)sizeof(hypre_BoxArray *)) );
                 ...
                 int index )
{
   ...
   for (i = index; i < ((box_array) -> size) - 1; i++)
   {
      ( ( (((&((box_array) -> boxes[(i)])) -> imin)[0]) = (((&((box_array) -> boxes[(i+1)])) -> imin)[0]), (((&((box_array) -> boxes[(i)])) -> imin)[1]) = (((&((box_array) -> boxes[(i+1)])) -> imin)[1]), (((&((box_array) -> boxes[(i)])) -> imin)[2]) = (((&((box_array) -> boxes[(i+1)])) -> imin)[2]) ), ( (((&((box_array) -> boxes[(i)])) -> imax)[0]) = (((&((box_array) -> boxes[(i+1)])) -> imax)[0]), (((&((box_array) -> boxes[(i)])) -> imax)[1]) = (((&((box_array) -> boxes[(i+1)])) -> imax)[1]), (((&((box_array) -> boxes[(i)])) -> imax)[2]) = (((&((box_array) -> boxes[(i+1)])) -> imax)[2]) ) );
...
hypre_IModPeriodX( hypre_Index index,
                   hypre_Index periodic )
{
   return hypre_IModPeriod((index[0]), (periodic[0]));
}
...
hypre_IModPeriodY( hypre_Index index,
                   hypre_Index periodic )
{
   return hypre_IModPeriod((index[1]), (periodic[1]));
}
...
hypre_IModPeriodZ( hypre_Index index,
                   hypre_Index periodic )
{
   return hypre_IModPeriod((index[2]), (periodic[2]));
}
