# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c" 2

static char Rcs_Id[] =
    "$Id$";
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c"
...
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c" 2
...
# 70 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c" 2
...
# 71 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c" 2
...
# 72 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c" 2
...
extern char * tgoto ();
extern char * tputs ();
# 73 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c" 2
...
# 74 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c" 2
...
void treeinit (p, LibDict)
    ...
    FILE * secondf;
# 128 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c"
    if (p == ((void*)0))
 p = getenv ("WORDLIST");
 ...
 return;
    ...
    if (p == ((void*)0))
 {
# 165 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c"
 ...
 if (abspath)
  ...
  return;
    ...
    if (!lflag && !aflag
      && access (personaldict, 2) < 0 && (*__errno_location ()) != 2)
 {
 (void) fprintf (stderr, "Warning: Cannot update personal dictionary (%s)\r\n", personaldict);
...
void treeinsert (word, wordlen, keep)
 ...
 if (pershtab == ((void*)0))
     {
     (void) fprintf (stderr, "Ran out of space for personal dictionary\r\n");
     ...
     if (oldhtab == ((void*)0))
  exit (1);
     (void) fprintf (stderr, "Continuing anyway (with reduced performance).\r\n");
     cantexpand = 1;
     pershsize = oldhsize;
     pershtab = oldhtab;
     newwords = 1;
  ...
  if (dp->mask[(32 / 32) - 1] & ((long) 1 << (((32) - 6) + 0)))
      ...
      dp = dp->next;
# 377 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c"
      while (dp != ((void*)0))
   {
   if (isvariant)
       {
...
static struct dent * tinsert (proto)
 ...
 (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", proto->word, 449, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c");
...
void treeoutput ()
 ...
 for (cent = hashtbl, ehtab = hashtbl + hashsize;
  ...
  {
# 579 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c"
  if (((cent->mask[(32 / 32) - 1]) & ((long) 3 << (((32) - 6) + 2))) != ((long) 3 << (((32) - 6) + 2))
    && cent->word != ((void*)0))
...
void myfree (ptr)
    void * ptr;
    {
    if (hashstrings != ((void*)0) && (char *) ptr >= hashstrings
