# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c" 2

static char Rcs_Id[] =
    "$Id$";
# 130 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c"
...
# 131 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c" 2
...
# 132 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c" 2
...
# 133 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c" 2
...
extern char * tgoto ();
extern char * tputs ();
# 134 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c" 2
...
# 135 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c" 2
...
# 158 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c"
...
static char * skiptoword (bufp)
    ...
    while (*bufp
      && ((!((hashheader.stringstarts[(unsigned char) (*(bufp))]) && stringcharlen ((bufp), (0)) > 0) && !(hashheader.wordchars[(((ichar_t) (*bufp)))]))
 || (hashheader.boundarychars[(((ichar_t) (*bufp)))])
 || (tflag && (math_mode & 1)))
      )
 {
 ...
 if (tflag)
  ...
  if (math_mode < 0)
      {
      (void) fprintf (stderr,
       "****ERROR in parsing TeX math mode!\r\n");
      math_mode = 0;
      }
  }
     else
...
void checkline (ofile)
 ...
 if (*currentchar == hashheader.nrchars[2]
   && (strncmp (currentchar + 1, "if t", 4) == 0
     || strncmp (currentchar + 1, "if n", 4) == 0))
     {
     copyout (&currentchar,5);
     while (*currentchar
       && (((((ichar_t) (*currentchar))) > 0) && ((((ichar_t) (*currentchar))) < 0x80) && ((*__ctype_b_loc ())[(int) (((unsigned char) (((ichar_t) (*currentchar)))))] & (unsigned short int) _ISspace)))
 ...
 *p = 0;
 if (strtoichar (itoken, ctoken, 100 * sizeof (ichar_t), 0))
     (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", ctoken, 466, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c");
...
# 638 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c"
    if ((**bufp == hashheader.texchars[2] || **bufp == hashheader.texchars[6])
      && (*bufp)[1] == hashheader.texchars[11])
 {
 (*bufp)++;
 while (**bufp)
     {
     if (*(*bufp)++ == hashheader.texchars[11]
       && (**bufp == hashheader.texchars[3] || **bufp == hashheader.texchars[7]))
...
static int TeX_LR_check (begin_p, bufp)
 ...
 if (begin_p)
     ...
     if (math_mode < 0)
  {
  (void) fprintf (stderr, "***ERROR in LR to math-mode switch.\n");
  math_mode = 1;
  }
     }
 return 1;
...
static void TeX_skip_check (bufp)
 ...
 if (**bufp == 0)
    ...
    else if (TeX_strncmp(*bufp, "rule", 4) == 0
 ...
 *bufp += 5;
 ...
 {
# 871 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c"
...
# 893 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/defmt.c"
