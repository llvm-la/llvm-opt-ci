# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c" 2

static char Rcs_Id[] =
    "$Id$";
# 64 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c"
...
# 65 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c" 2
...
# 66 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c" 2
...
# 67 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c" 2
...
extern char * tgoto ();
extern char * tputs ();
# 68 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c" 2
...
# 69 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c" 2
...
int linit ()
 ...
 {
 if (hashsize < 0)
     (void) fprintf (stderr, "Trouble reading hash table %s\r\n", errhashname);
 else if (hashsize == 0)
     (void) fprintf (stderr, "Null hash table %s\r\n", errhashname);
 else
     (void) fprintf (stderr,
       "Truncated hash table %s:  got %d bytes, expected %d\r\n", errhashname, hashsize, (int) sizeof hashheader);
 ...
 {
 (void) fprintf (stderr,
   "Illegal format hash table %s - expected magic 0x%x, got 0x%x\r\n", errhashname, (unsigned int) 0x9602, (unsigned int) hashheader.magic);
 ...
 {
 (void) fprintf (stderr,
   "Illegal format hash table %s - expected magic2 0x%x, got 0x%x\r\n", errhashname, (unsigned int) 0x9602, (unsigned int) hashheader.magic2);

 return (-1);
 }
    else if (hashheader.compileoptions != (0x01 | 0x02 | 0x00)
      || hashheader.maxstringchars != 100
      || hashheader.maxstringcharlen != 10)
 {
 (void) fprintf (stderr,
 ...
 if (hashtbl == ((void*)0))
     {
     (void) fprintf (stderr, "Couldn't allocate space for hash table\r\n");
     return (-1);
     }
 ...
 if (read (hashfd, hashstrings, (unsigned) hashheader.lstringsize)
   != hashheader.lstringsize)
     {
     (void) fprintf (stderr, "Illegal format hash table\r\n");
     return (-1);
     }
 (void) lseek (hashfd,
 ...
 if (ind->numents == 0)
     ind->pu.ent = entry;
 ind->numents++;
# 293 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c"
 if (!viazero && ind->numents >= 4
   && strcmp ((char *) (entry->affix), (char *) (ind->pu.ent->affix)) != 0)
     ...
     ind->pu.fp =
       (struct flagptr *)
  calloc ((unsigned) (128 + hashheader.nstrchars),
    sizeof (struct flagptr));
     if (ind->pu.fp == ((void*)0))
  {
  (void) fprintf (stderr, "Couldn't allocate space for language tables\r\n");
  return (-1);
  }
     ind->numents = 0;
     }
 ...
 if (ind->numents == 0)
     ind->pu.ent = entry;
 ind->numents++;
# 356 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c"
 if (!viazero && ind->numents >= 4
   && strcmp ((char *) (entry->affix), (char *) (ind->pu.ent->affix)) != 0)
     {
     ...
     ind->pu.fp =
       (struct flagptr *) calloc (128 + hashheader.nstrchars,
         sizeof (struct flagptr));
     if (ind->pu.fp == ((void*)0))
  {
  (void) fprintf (stderr, "Couldn't allocate space for language tables\r\n");
...
# 465 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c"
struct dent * lookup (s, dotree)
 ...
 (void) fprintf (stderr, "\r\nWord '%s' too long at line %d of %s, truncated\r\n", schar, 475, "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/lookup.c");
