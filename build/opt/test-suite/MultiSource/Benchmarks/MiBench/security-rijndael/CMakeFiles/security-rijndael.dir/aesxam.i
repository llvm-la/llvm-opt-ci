# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c" 2
# 39 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c"
...
# 40 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c" 2
...
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c" 2
...
# 42 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c" 2
...
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aes.h" 1
# 152 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aes.h"
...
# 153 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aes.h" 2
# 225 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aes.h"
typedef unsigned char byte;
typedef uint32_t word;
typedef short aes_ret;
# 268 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aes.h"
enum aes_const { Nrow = 4,
                    Mcol = 8,
...
# 297 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aes.h"
typedef struct
{
    word Nkey;
    word Nrnd;
...
# 45 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c" 2
# 74 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/security-rijndael/aesxam.c"
...
{ FILE *fin = 0, *fout = 0;
    ...
    if(argc != 5 || ((__extension__ ({ int __res; if (sizeof (*argv[3]) > 1) { if (__builtin_constant_p (*argv[3])) { int __c = (*argv[3]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*argv[3]); } else __res = (*__ctype_toupper_loc ())[(int) (*argv[3])]; __res; })) != 'D' && (__extension__ ({ int __res; if (sizeof (*argv[3]) > 1) { if (__builtin_constant_p (*argv[3])) { int __c = (*argv[3]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*argv[3]); } else __res = (*__ctype_toupper_loc ())[(int) (*argv[3])]; __res; })) != 'E'))
    {
    ...
    while(i < 64 && *cp)
    {
        ch = (__extension__ ({ int __res; if (sizeof (*cp++) > 1) { if (__builtin_constant_p (*cp++)) { int __c = (*cp++); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*cp++); } else __res = (*__ctype_toupper_loc ())[(int) (*cp++)]; __res; }));
        if(ch >= '0' && ch <= '9')
            by = (by << 4) + ch - '0';
        else if(ch >= 'A' && ch <= 'F')
            by = (by << 4) + ch - 'A' + 10;
    ...
    if((__extension__ ({ int __res; if (sizeof (*argv[3]) > 1) { if (__builtin_constant_p (*argv[3])) { int __c = (*argv[3]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*argv[3]); } else __res = (*__ctype_toupper_loc ())[(int) (*argv[3])]; __res; })) == 'E')
    {
