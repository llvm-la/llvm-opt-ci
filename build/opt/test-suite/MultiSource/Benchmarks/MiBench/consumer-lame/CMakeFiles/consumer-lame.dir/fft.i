# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/fft.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/fft.c" 2
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/fft.c"
...
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/fft.c" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/fft.c" 2
...
void L3psycho_anal( lame_global_flags *gfp,
      ...
      FLOAT8 pe[2], FLOAT8 pe_MS[2],
                    int blocktype_d[2]);
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/fft.c" 2
...
# 176 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/fft.c"
void fft_short(
    FLOAT x_real[3][256], int chn, short *buffer[2])
{
    short i, j, b;
 ...
 if (chn < 2) {
  ...
  f0 = (window_s[i ] * (buffer[chn][i + k])); w = (window_s[0x7f - i] * (buffer[chn][i + k + 0x80])); f1 = f0 - w; f0 = f0 + w;
  f2 = (window_s[i + 0x40] * (buffer[chn][i + k + 0x40])); w = (window_s[0x3f - i] * (buffer[chn][i + k + 0xc0])); f3 = f2 - w; f2 = f2 + w;
  ...
  f0 = (window_s[i + 0x01] * (buffer[chn][i + k + 0x01])); w = (window_s[0x7e - i] * (buffer[chn][i + k + 0x81])); f1 = f0 - w; f0 = f0 + w;
  f2 = (window_s[i + 0x41] * (buffer[chn][i + k + 0x41])); w = (window_s[0x3e - i] * (buffer[chn][i + k + 0xc1])); f3 = f2 - w; f2 = f2 + w;
  ...
  f0 = (window_s[i ] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k] + buffer[1][i + k]))); w = (window_s[0x7f - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k + 0x80] + buffer[1][i + k + 0x80]))); f1 = f0 - w; f0 = f0 + w;
  f2 = (window_s[i + 0x40] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k + 0x40] + buffer[1][i + k + 0x40]))); w = (window_s[0x3f - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k + 0xc0] + buffer[1][i + k + 0xc0]))); f3 = f2 - w; f2 = f2 + w;
  ...
  f0 = (window_s[i + 0x01] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k + 0x01] + buffer[1][i + k + 0x01]))); w = (window_s[0x7e - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k + 0x81] + buffer[1][i + k + 0x81]))); f1 = f0 - w; f0 = f0 + w;
  f2 = (window_s[i + 0x41] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k + 0x41] + buffer[1][i + k + 0x41]))); w = (window_s[0x3e - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + k + 0xc1] + buffer[1][i + k + 0xc1]))); f3 = f2 - w; f2 = f2 + w;
...
void fft_long(
    FLOAT x[1024], int chn, short *buffer[2])
{
    short i,jj = 1024 / 8 - 1;
    x += 1024 / 2;
 ...
 do {
     ...
     i = rv_tbl[jj];
     f0 = (window[i ] * (buffer[chn][i])); w = (window[0x1ff - i] * (buffer[chn][i + 0x200])); f1 = f0 - w; f0 = f0 + w;
     f2 = (window[i + 0x100] * (buffer[chn][i + 0x100])); w = (window[0x0ff - i] * (buffer[chn][i + 0x300])); f3 = f2 - w; f2 = f2 + w;
     ...
     f0 = (window[i + 0x001] * (buffer[chn][i + 0x001])); w = (window[0x1fe - i] * (buffer[chn][i + 0x201])); f1 = f0 - w; f0 = f0 + w;
     f2 = (window[i + 0x101] * (buffer[chn][i + 0x101])); w = (window[0x0fe - i] * (buffer[chn][i + 0x301])); f3 = f2 - w; f2 = f2 + w;
 ...
 do {
     ...
     i = rv_tbl[jj];
     f0 = (window[i ] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i] + buffer[1][i]))); w = (window[0x1ff - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + 0x200] + buffer[1][i + 0x200]))); f1 = f0 - w; f0 = f0 + w;
     f2 = (window[i + 0x100] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + 0x100] + buffer[1][i + 0x100]))); w = (window[0x0ff - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + 0x300] + buffer[1][i + 0x300]))); f3 = f2 - w; f2 = f2 + w;
     ...
     f0 = (window[i + 0x001] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + 0x001] + buffer[1][i + 0x001]))); w = (window[0x1fe - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + 0x201] + buffer[1][i + 0x201]))); f1 = f0 - w; f0 = f0 + w;
     f2 = (window[i + 0x101] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + 0x101] + buffer[1][i + 0x101]))); w = (window[0x0fe - i] * (((FLOAT)(0.5*1.41421356237309504880))*(buffer[0][i + 0x301] + buffer[1][i + 0x301]))); f3 = f2 - w; f2 = f2 + w;
