# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/timestatus.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/timestatus.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/timestatus.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/timestatus.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/timestatus.c" 2
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/timestatus.c"
...
# 62 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/timestatus.c"
  current_time = clock();
  ...
  return (FLOAT)(current_time - initial_time) / ((__clock_t) 1000000);
}
...
void timestatus(int samp_rate,long frameNum,long totalframes,int framesize)
{
  ...
  fprintf(stderr,
    ...
    totalframes - 1,
    percent,
    (int)((long)(process_time.so_far+.5) / 3600), (int)((long)((process_time.so_far+.5) / 60) % 60), (int)((long)(process_time.so_far+.5) % 60),
    (int)((long)(process_time.estimated+.5) / 3600), (int)((long)((process_time.estimated+.5) / 60) % 60), (int)((long)(process_time.estimated+.5) % 60),
    (int)((long)(real_time.so_far+.5) / 3600), (int)((long)((real_time.so_far+.5) / 60) % 60), (int)((long)(real_time.so_far+.5) % 60),
 (int)((long)(real_time.estimated+.5) / 3600), (int)((long)((real_time.estimated+.5) / 60) % 60), (int)((long)(real_time.estimated+.5) % 60),
    process_time.speed,
    (int)((long)(real_time.eta+.5) / 3600), (int)((long)((real_time.eta+.5) / 60) % 60), (int)((long)(real_time.eta+.5) % 60)
  );
