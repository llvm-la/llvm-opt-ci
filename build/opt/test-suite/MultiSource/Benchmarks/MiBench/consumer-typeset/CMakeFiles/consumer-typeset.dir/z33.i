# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c" 2
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c" 2
# 50 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
typedef struct
{ int dbchecktab_size;
  int dbchecktab_count;
  OBJECT dbchecktab_item[1];
} *DBCHECK_TABLE;
# 67 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
...
{ DBCHECK_TABLE S; int i;
  ...
  if( S == (DBCHECK_TABLE) ((void*)0) )
    Error(33, 1, "run out of memory enlarging dbcheck table", 1, no_fpos);
  (S)->dbchecktab_size = newsize;
  (S)->dbchecktab_count = 0;
  for( i = 0; i < newsize; i++ ) (S)->dbchecktab_item[i] = ( (OBJECT) ((void*)0) );
  return S;
}
...
{ DBCHECK_TABLE NewS; int i; OBJECT link, z;
  ...
  for( i = 0; i < (S)->dbchecktab_size; i++ )
  { if( (S)->dbchecktab_item[i] != ( (OBJECT) ((void*)0) ) )
    { OBJECT ent = (S)->dbchecktab_item[i];
      { if( !((ent)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "dtab_rehash: ACAT!"); };
      for( link = (ent)->os1.olist[0].osucc; link != ent; link = (link)->os1.olist[0].osucc )
...
{ unsigned long pos; OBJECT z, link, y;
  if( (*S)->dbchecktab_count == (*S)->dbchecktab_size - 1 )
    *S = dtab_rehash(*S, 2*(*S)->dbchecktab_size);
  (*S)->dbchecktab_count++;
  { FULL_CHAR *p = (x)->os1.ostring; pos = (unsigned long) (x)->os1.ou3.ofilter_actual; while( *p ) pos += *p++; pos = pos % (*S)->dbchecktab_size; };
  if( (*S)->dbchecktab_item[pos] == ( (OBJECT) ((void*)0) ) ) { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; (*S)->dbchecktab_item[pos] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  z = (*S)->dbchecktab_item[pos];
  ...
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (x)->os1.ou3.ofilter_actual == (y)->os1.ou3.ofilter_actual && (strcmp((char *)((x)->os1.ostring), (char *)((y)->os1.ostring))==0) )
    { { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Dbcheck: entry inserted twice"); };
    }
  }
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = (((*S)->dbchecktab_item[pos])), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
}

static OBJECT dtab_retrieve(OBJECT sym, FULL_CHAR *tag, DBCHECK_TABLE S)
{ OBJECT x, link, y; unsigned long pos;
  { FULL_CHAR *p = tag; pos = (unsigned long) sym; while( *p ) pos += *p++; pos = pos % (S)->dbchecktab_size; };
  x = (S)->dbchecktab_item[pos];
  if( x == ( (OBJECT) ((void*)0) ) ) return ( (OBJECT) ((void*)0) );
  for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( sym == (y)->os1.ou3.ofilter_actual && (strcmp((char *)(tag), (char *)((y)->os1.ostring))==0) )
      return y;
  }
  return ( (OBJECT) ((void*)0) );
}
# 156 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
static DBCHECK_TABLE DbCheckTable;
static unsigned DbCheckTableInit = 0;
# 167 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
OBJECT OldCrossDb, NewCrossDb;
# 233 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
OBJECT DbCreate(OBJECT x)
{ OBJECT db = x;
                                             ;
  { if( !((((x)->os1.ou1.os11.otype) == 11 || ((x)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbCreate: !is_word(type(x))"); };
  (db)->os1.ou2.os24.oreading = 0; (db)->os1.ou3.odb_filep = ( (FILE *) ((void*)0) );
                                                          ;
  return db;
}
# 269 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
void DbInsert(OBJECT db, unsigned gall, OBJECT sym, FULL_CHAR *tag,
FILE_POS *tagfpos, FULL_CHAR *seq, FILE_NUM dfnum, long dfpos, int dlnum,
unsigned check)
{ int symnum; OBJECT chk;
  static int extra_seq = 0;
  FULL_CHAR buff[512];
  { if( !((((db)->os1.ou1.os11.otype) == 11 || ((db)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbInsert: db!"); };
  { if( !(tag[0] != '\0') ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbInsert: null tag!"); };
  { if( !(seq[0] != '\0') ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbInsert: null seq!"); };
                                        ;


                                                       ;
  { if( !(!(db)->os1.ou2.os24.oreading) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbInsert: insert into reading database"); };
  ...
  if( check )
  {
                                                                           ;
    if( !DbCheckTableInit )
    { DbCheckTable = dtab_new(107);
      DbCheckTableInit = 1;
    }
                                                      ;
    chk = dtab_retrieve(sym, tag, DbCheckTable);
    if( chk == ( (OBJECT) ((void*)0) ) )
    { chk = MakeWord(11, tag, tagfpos);
      (chk)->os1.ou3.ofilter_actual = sym;
      dtab_insert(chk, &DbCheckTable);
    }
    else
    { if( ((chk)->os1.ou1.ofpos).ofile_num > 0 )
        Error(33, 4, "cross reference %s&&%s used previously, at%s",
          2, tagfpos, SymName(sym), tag, EchoFilePos(&(chk)->os1.ou1.ofpos));
      else Error(33, 5, "cross reference %s&&%s used previously",
   2, tagfpos, SymName(sym), tag);
    }
  }


  if( (db)->os1.ou3.odb_filep == ( (FILE *) ((void*)0) ) )
  { if( strlen((char *)((db)->os1.ostring)) + strlen((char *)(( (FULL_CHAR *) (".lix") ))) >= 512 )
      Error(33, 2, "database file name %s%s is too long",
 1, no_fpos, (db)->os1.ostring, ( (FULL_CHAR *) (".lix") ));
    strcpy((char *)(buff),(char *)((db)->os1.ostring));
    strcat((char *)(buff),(char *)(( (FULL_CHAR *) (".lix") )));
    (db)->os1.ou3.odb_filep = fopen( (char *) (buff), ("w") );
    if( (db)->os1.ou3.odb_filep == ( (FILE *) ((void*)0) ) )
      Error(33, 3, "cannot write to database file %s", 1, &(db)->os1.ou1.ofpos, buff);
  }


  if( dfnum != 0 )
  { strcpy((char *)(buff),(char *)(FileName(dfnum)));
    strcpy((char *)(&buff[strlen((char *)(buff))-strlen((char *)(( (FULL_CHAR *) (".ld") )))]),(char *)(( (FULL_CHAR *) ("") )));
  }
  else strcpy((char *)(buff),(char *)(( (FULL_CHAR *) (".") )));
  { OBJECT link, yy; int count; count = 0; for( link = (db)->os1.olist[0].osucc; link != db; link = (link)->os1.olist[0].osucc ) { for( yy = (link)->os1.olist[1].opred; (yy)->os1.ou1.os11.otype == 0; yy = (yy)->os1.olist[1].opred ); { if( !((yy)->os1.ou1.os11.otype==140 || (yy)->os1.ou1.os11.otype==17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SymToNum: yy!"); }; if( (yy)->os1.ou1.os11.otype != 140 ) continue; if( (yy)->os7.osymb == sym ) break; if( (link)->os4.onumber > count ) count = (link)->os4.onumber; } if( link == db ) { if( (sym)->os6.ocross_sym == ( (OBJECT) ((void*)0) ) ) CrossInit(sym); { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((db)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = (((sym)->os6.ocross_sym)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); }; link = (db)->os1.olist[0].opred; (link)->os4.onumber = count + 1; (link)->os4.odb_targ = 0; } symnum = (link)->os4.onumber; if( gall ) (link)->os4.odb_targ = (sym)->os1.ou2.os26.ois_extern_target = (sym)->os1.ou2.os26.ouses_extern_target = 1; };



   ;
  fprintf((db)->os1.ou3.odb_filep, "%s%d&%s\t%s\t%s\t%ld\t%d\t%s\n", gall ? "0" : "",
...
# 349 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
void DbConvert(OBJECT db, unsigned full_name)
{ FULL_CHAR oldname[512 +10], newname[512];
  OBJECT link, y;
                                         ;
                                                               ;
  { if( !(!(db)->os1.ou2.os24.oreading) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbConvert: reading database"); };
  strcpy((char *)(newname),(char *)((db)->os1.ostring));
  strcat((char *)(newname),(char *)(( (FULL_CHAR *) (".li") )));
  strcpy((char *)(oldname),(char *)((db)->os1.ostring));
  strcat((char *)(oldname),(char *)(( (FULL_CHAR *) (".lix") )));
  if( (db)->os1.ou3.odb_filep != ( (FILE *) ((void*)0) ) )
  {
    fprintf((db)->os1.ou3.odb_filep, "00 %s %s\n", ( (FULL_CHAR *) ("Basser Lout Version 3.24 (October 2000)") ), "database index file");
    for( link = (db)->os1.olist[0].osucc; link != db; link = (link)->os1.olist[0].osucc )
    { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
      { if( !((y)->os1.ou1.os11.otype == 140 || (y)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbConvert: y!"); };
      if( (y)->os1.ou1.os11.otype != 140 ) continue;
      fprintf((db)->os1.ou3.odb_filep, "%s %d %s\n",
 (link)->os4.odb_targ ? "00target" : "00symbol",
 (link)->os4.onumber,
 full_name ? FullSymName((y)->os7.osymb, ( (FULL_CHAR *) (" ") )) : SymName((y)->os7.osymb));
    }
    fclose((db)->os1.ou3.odb_filep);
                                                                   ;
    SortFile(oldname, newname);
  }
  else remove((char *)(newname));
  remove((char *)(oldname));
  { xx_hold = (db); while( (xx_hold)->os1.olist[1].osucc != xx_hold ) { xx_link = ((xx_hold)->os1.olist[1].osucc); ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; }; while( (xx_hold)->os1.olist[0].osucc != xx_hold ) { xx_link = ((xx_hold)->os1.olist[0].osucc); ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; }; { zz_hold = (xx_hold); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; };
                                         ;
                                          ;
}
# 391 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
void DbClose(OBJECT db)
{ if( db != ( (OBJECT) ((void*)0) ) && !(db)->os1.ou2.os24.oin_memory && (db)->os1.ou3.odb_filep != ((void*)0) )
  { fclose((db)->os1.ou3.odb_filep);
     (db)->os1.ou3.odb_filep = ((void*)0);
  }
}
# 415 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
OBJECT DbLoad(OBJECT stem, int fpath, unsigned create, OBJECT symbs,
  unsigned in_mem)
{ FILE *fp; OBJECT db, t, res, tag, par, sym, link, y;
  int i, lnum, dlnum, num, count, leftp;
  FILE_NUM index_fnum, dfnum; long dfpos;
  unsigned gall; FULL_CHAR line[512], sym_name[512]; char *gotline;
                                      ;
                                                                               ;


                                                        ;
  index_fnum = DefineFile((stem)->os1.ostring, ( (FULL_CHAR *) (".li") ), &(stem)->os1.ou1.ofpos, 4,
   fpath);
  fp = OpenFile(index_fnum, create, 0);


  if( fp != ( (FILE *) ((void*)0) ) )
  { if( fgets( (char *) (line), (512), (fp) ) == ((void*)0) ||
        !StringBeginsWith(&line[3], ( (FULL_CHAR *) ("Basser Lout Version 3.24 (October 2000)") )) )
    {

      remove((char *)(FileName(index_fnum)));
      fp = ( (FILE *) ((void*)0) );
    }
  }

  if( fp == ( (FILE *) ((void*)0) ) && create )
  { db = ( (OBJECT) ((void*)0) );
                                                          ;
    ...
    dfnum = DefineFile((stem)->os1.ostring, ( (FULL_CHAR *) (".ld") ), &(stem)->os1.ou1.ofpos,
      3, fpath);
    dfpos = 0L; LexPush(dfnum, 0, 3, 1, 0);
    t = LexGetToken();
    dlnum = ((t)->os1.ou1.ofpos).oline_num;
    while( (t)->os1.ou1.os11.otype == 102 )
    { res = Parse(&t, StartSym, 0, 0);
      if( t != ( (OBJECT) ((void*)0) ) || (res)->os1.ou1.os11.otype != 2 )
 Error(33, 6, "syntax error in database file %s",
   1, &(res)->os1.ou1.ofpos, FileName(dfnum));
      { if( !(symbs != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbLoad: create && symbs == nilobj!"); };
      if( symbs != ( (OBJECT) ((void*)0) ) )
      { for( link = (symbs)->os1.olist[0].osucc; link != symbs; link = (link)->os1.olist[0].osucc )
 { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
   if( (y)->os1.ou1.os11.otype == 2 && (y)->os2.oactual == (res)->os2.oactual ) break;
 }
 if( link == symbs )
   Error(33, 7, "%s found in database but not declared in %s line",
     1, &(res)->os1.ou1.ofpos, SymName((res)->os2.oactual), ( (FULL_CHAR *) ("@Database") ));
      }
      for( tag = ( (OBJECT) ((void*)0) ), link = (res)->os1.olist[0].osucc; link != res; link = (link)->os1.olist[0].osucc )
      { for( par = (link)->os1.olist[1].opred; (par)->os1.ou1.os11.otype == 0; par = (par)->os1.olist[1].opred );
 if( (par)->os1.ou1.os11.otype == 10 && ((par)->os2.oactual)->os1.ou2.os26.ois_tag && (par)->os1.olist[0].osucc != par )
 { for( tag = ((par)->os1.olist[0].osucc)->os1.olist[1].opred; (tag)->os1.ou1.os11.otype == 0; tag = (tag)->os1.olist[1].opred );
   break;
 }
      }
      if( tag == ( (OBJECT) ((void*)0) ) )
 Error(33, 8, "database symbol %s has no tag",
   1, &(res)->os1.ou1.ofpos, SymName((res)->os2.oactual));
 ...
 Error(33, 9, "database symbol tag is not a simple word",
   1, &(res)->os1.ou1.ofpos);
      if( (strcmp((char *)((tag)->os1.ostring), (char *)(( (FULL_CHAR *) ("") )))==0) )
 Error(33, 10, "database symbol tag is an empty word", 1,&(res)->os1.ou1.ofpos);
      if( db == ( (OBJECT) ((void*)0) ) )
      { strcpy((char *)(line),(char *)(FileName(dfnum)));
 i = strlen((char *)(line)) - strlen((char *)(( (FULL_CHAR *) (".li") )));
 { if( !(i > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbLoad: FileName(dfnum) (1)!"); };
 strcpy((char *)(&line[i]),(char *)(( (FULL_CHAR *) ("") )));
 db = DbCreate(MakeWord(11, line, &(stem)->os1.ou1.ofpos));
      }
      DbInsert(db, 0, (res)->os2.oactual, (tag)->os1.ostring, &(tag)->os1.ou1.ofpos, ( (FULL_CHAR *) ("0") ),
 0, dfpos, dlnum, 1);
      DisposeObject(res); dfpos = LexNextTokenPos(); t = LexGetToken();
      dlnum = ((t)->os1.ou1.ofpos).oline_num;
    }
    if( (t)->os1.ou1.os11.otype != 105 )
      Error(33, 11, "%s or end of file expected here", 1, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("{") ));
    LexPop();
    if( db == ( (OBJECT) ((void*)0) ) )
    { strcpy((char *)(line),(char *)(FileName(dfnum)));
      i = strlen((char *)(line)) - strlen((char *)(( (FULL_CHAR *) (".li") )));
      { if( !(i > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbLoad: FileName(dfnum) (2)!"); };
      strcpy((char *)(&line[i]),(char *)(( (FULL_CHAR *) ("") )));
      db = DbCreate(MakeWord(11, line, &(stem)->os1.ou1.ofpos));
    }
    DbConvert(db, 0);
    if( (fp = OpenFile(index_fnum, 0, 0)) == ( (FILE *) ((void*)0) ) ||
        fgets( (char *) (line), (512), (fp) ) == ((void*)0) ||
        !StringBeginsWith(&line[3], ( (FULL_CHAR *) ("Basser Lout Version 3.24 (October 2000)") )) )
      Error(33, 12, "cannot open database file %s",
        1, &(db)->os1.ou1.ofpos, FileName(index_fnum));
  }


  strcpy((char *)(line),(char *)(FileName(index_fnum)));
  i = strlen((char *)(line)) - strlen((char *)(( (FULL_CHAR *) (".li") )));
  { if( !(i > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbLoad: FileName(index_fnum)!"); };
  strcpy((char *)(&line[i]),(char *)(( (FULL_CHAR *) ("") )));
  db = MakeWord(11, line, &(stem)->os1.ou1.ofpos);
  (db)->os1.ou2.os24.oreading = 1;
  (db)->os1.ou2.os24.oin_memory = in_mem;
  if( symbs != ( (OBJECT) ((void*)0) ) )
  { { if( !((symbs)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbLoad: type(symbs)!"); };
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((db)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((symbs)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  }
  if( fp == ( (FILE *) ((void*)0) ) )
  { ;
    (db)->os1.ou3.odb_filep = ( (FILE *) ((void*)0) );
    (db)->os1.ou3.odb_lines = (LINE *) ((void*)0);
                                         ;
    return db;
  }
  ...
  leftp = 0; lnum = 1;
  gotline = fgets( (char *) (line), (512), (fp) );
  while( gotline != ((void*)0) )
  {
    if( line[0] != '0' || line[1] != '0' ) break;
    lnum++;
    leftp = (int) ftell(fp);
    gall = StringBeginsWith(line, ( (FULL_CHAR *) ("00target ") ));
    ...
    if( symbs == ( (OBJECT) ((void*)0) ) )
    {
      ...
      while( line[i] != '\n' && line[i] != '\0' )
      { PushScope(sym, 0, 0); count++;
 sscanf( (char *) &line[i+1], "%s", sym_name);
 sym = SearchSym(sym_name, strlen((char *)(sym_name)));
 i += strlen((char *)(sym_name)) + 1;
      }
    ...
    else
    {
      ...
      for( link = (symbs)->os1.olist[0].osucc; link != symbs; link = (link)->os1.olist[0].osucc )
      { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 { if( !((y)->os1.ou1.os11.otype == 2) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbLoad: type(y) != CLOSURE!"); };
 if( (strcmp((char *)(sym_name), (char *)(SymName((y)->os2.oactual)))==0) )
 { sym = (y)->os2.oactual;
   break;
 }
      }
    }
    if( sym != ( (OBJECT) ((void*)0) ) && sym != StartSym )
    { if( (sym)->os6.ocross_sym == ( (OBJECT) ((void*)0) ) ) CrossInit(sym);
      { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((db)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = (((sym)->os6.ocross_sym)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
      link = (db)->os1.olist[0].opred;
      (link)->os4.onumber = num; (link)->os4.odb_targ = gall;
      if( gall ) (sym)->os1.ou2.os26.ois_extern_target = (sym)->os1.ou2.os26.ouses_extern_target = 1;
    }
    else
    { Error(33, 13, "undefined symbol in database file %s (line %d)",
 2, &(db)->os1.ou1.ofpos, FileName(index_fnum), lnum);
                                                                  ;
      fclose(fp);
      (db)->os1.ou2.os24.oin_memory = 0;
      (db)->os1.ou3.odb_filep = ( (FILE *) ((void*)0) );
                                           ;
      return db;
    }
  ...
  if( (db)->os1.ou2.os24.oin_memory )
  { int len;
    if( gotline == ((void*)0) )
      (db)->os1.ou3.odb_lines = 0;
    else
    {
      (db)->os1.ou3.odb_lines = ReadLines(fp, FileName(index_fnum), line, &len);
      (db)->os1.ou2.os24.oleft_pos = len;
      SortLines((db)->os1.ou3.odb_lines, (db)->os1.ou2.os24.oleft_pos);
    }
  }
  else
  { (db)->os1.ou3.odb_filep = fp;
    (db)->os1.ou2.os24.oleft_pos = leftp;
  }
...
# 625 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
static unsigned SearchFile(FILE *fp, int left, int right,
FULL_CHAR *str, FULL_CHAR *line)
{ int l, r, mid, mid_end; FULL_CHAR buff[512]; unsigned res;
                                          ;
                                                                       ;
  ...
  while( l <= r )
  {
    ...
    mid_end = (int) ftell(fp) - 1;
                                                                           ;
    { if( !(l <= mid) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SearchFile: l > mid!"); };
    { if( !(mid < mid_end) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SearchFile: mid >= mid_end!"); };
    { if( !(mid_end <= r) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SearchFile: mid_end > r!"); };


                                                                 ;
    if( ( UseCollate ? strcollcmp((char *)(str),(char *)(line)) <= 0 : strcmp((char *)(str),(char *)(line)) <= 0 ) ) r = mid - 1;
    else l = mid_end + 1;
  }
  ...
  { fseek(fp, (long) l, 0);
    ...
    res = (strcmp((char *)(str), (char *)(buff))==0);
  }
  else res = 0;
                                                       ;
                                           ;
...
# 684 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
static unsigned SearchLines(LINE *lines, int left, int right, FULL_CHAR *str,
  int *lnum)
{ int l, r, mid; FULL_CHAR buff[512];
  unsigned res;
                                                                          ;
  if( right < left )
  {
  ...
  while( l <= r )
  {
    ...
    mid = (l + r) / 2;
                 ...
                 ;
    if( ( UseCollate ? strcollcmp((char *)(str),(char *)((FULL_CHAR *) lines[mid])) <= 0 : strcmp((char *)(str),(char *)((FULL_CHAR *) lines[mid])) <= 0 ) ) r = mid - 1;
    else l = mid + 1;
  }
  sscanf( (char *) lines[l], "%[^\t]", buff);
  if( (strcmp((char *)(str), (char *)(buff))==0) )
  {
    res = 1;
    *lnum = l;
                                                                 ;
...
# 731 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
unsigned DbRetrieve(OBJECT db, unsigned gall, OBJECT sym, FULL_CHAR *tag,
  FULL_CHAR *seq, FILE_NUM *dfnum, long *dfpos, int *dlnum, long *cont)
{ int symnum, lnum; FULL_CHAR line[512], buff[512];
                                          ;

                   ;


  if( !(db)->os1.ou2.os24.oreading || (db)->os1.ou3.odb_filep == ( (FILE *) ((void*)0) ) )
  { ;
                                             ;
    return 0;
  }
  ...
  { OBJECT link, yy; int count; count = 0; for( link = (db)->os1.olist[0].osucc; link != db; link = (link)->os1.olist[0].osucc ) { for( yy = (link)->os1.olist[1].opred; (yy)->os1.ou1.os11.otype == 0; yy = (yy)->os1.olist[1].opred ); { if( !((yy)->os1.ou1.os11.otype==140 || (yy)->os1.ou1.os11.otype==17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SymToNum: yy!"); }; if( (yy)->os1.ou1.os11.otype != 140 ) continue; if( (yy)->os7.osymb == sym ) break; if( (link)->os4.onumber > count ) count = (link)->os4.onumber; } if( link == db ) { if( (sym)->os6.ocross_sym == ( (OBJECT) ((void*)0) ) ) CrossInit(sym); { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((db)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = (((sym)->os6.ocross_sym)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); }; link = (db)->os1.olist[0].opred; (link)->os4.onumber = count + 1; (link)->os4.odb_targ = 0; } symnum = (link)->os4.onumber; if( 0 ) (link)->os4.odb_targ = (sym)->os1.ou2.os26.ois_extern_target = (sym)->os1.ou2.os26.ouses_extern_target = 1; };
  sprintf( (char *) buff, "%s%d&%s", gall ? "0" : "", symnum, tag);

  if( (db)->os1.ou2.os24.oin_memory )
  {

    if( !SearchLines((db)->os1.ou3.odb_lines, 0, (db)->os1.ou2.os24.oleft_pos - 1, buff, &lnum) )
    { ;
                                               ;
      return 0;
    }
    sscanf( (char *) (db)->os1.ou3.odb_lines[lnum],
  ...
  else
  {
    ...
    fseek((db)->os1.ou3.odb_filep, 0L, 2);
    if( !SearchFile((db)->os1.ou3.odb_filep, (int) (db)->os1.ou2.os24.oleft_pos,
    (int) ftell((db)->os1.ou3.odb_filep) - 1, buff, line) )
    { ;
                                               ;
      return 0;
    }
    sscanf( (char *) line,
      "%*[^\t]\t%[^\t]\t%*[^\t]\t%ld\t%d\t%[^\n]", seq, dfpos, dlnum, buff);
    *cont = ftell((db)->os1.ou3.odb_filep);
  }


  if( (strcmp((char *)(buff), (char *)(( (FULL_CHAR *) (".") )))==0) )
  { strcpy((char *)(buff),(char *)((db)->os1.ostring));
  }
  *dfnum = FileNum(buff, ( (FULL_CHAR *) (".ld") ));
  if( *dfnum == 0 )
  { ;
    *dfnum = DefineFile(buff, ( (FULL_CHAR *) (".ld") ), &(db)->os1.ou1.ofpos,
      3, 0);
  }
...
# 805 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z33.c"
unsigned DbRetrieveNext(OBJECT db, unsigned *gall, OBJECT *sym, FULL_CHAR *tag,
  FULL_CHAR *seq, FILE_NUM *dfnum, long *dfpos, int *dlnum, long *cont)
{ FULL_CHAR line[512], *cline, fname[512]; int symnum;
                                              ;
                                                                 ;
  { if( !((db)->os1.ou2.os24.oreading) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DbRetrieveNext: not reading"); };
  ...
  if( (db)->os1.ou2.os24.oin_memory )
  {
    ...
    if( *cont >= (db)->os1.ou2.os24.oleft_pos )
    { ;
                                                   ;
      return 0;
    }
    cline = (FULL_CHAR *) (db)->os1.ou3.odb_lines[*cont];
    *gall = (cline[0] == '0' ? 1 : 0);
  ...
  else
  {
    ...
    fseek((db)->os1.ou3.odb_filep, *cont == 0L ? (long) (db)->os1.ou2.os24.oleft_pos : *cont, 0);
    if( fgets( (char *) (line), (512), ((db)->os1.ou3.odb_filep) ) == ((void*)0) )
    { ;
                                                   ;
      return 0;
    }
  ...
  if( (strcmp((char *)(fname), (char *)(( (FULL_CHAR *) (".") )))==0) )
  { strcpy((char *)(fname),(char *)((db)->os1.ostring));
  }
  *dfnum = FileNum(fname, ( (FULL_CHAR *) (".ld") ));
  if( *dfnum == 0 )
  { ;
    *dfnum = DefineFile(fname, ( (FULL_CHAR *) (".ld") ), &(db)->os1.ou1.ofpos,
      3, 0);
  }
  { OBJECT link, y; for( link = (db)->os1.olist[0].osucc; link != db; link = (link)->os1.olist[0].osucc ) { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred ); if( (y)->os1.ou1.os11.otype == 140 && (link)->os4.onumber == symnum ) break; } { if( !(link != db) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NumToSym: no sym"); }; { if( !((y)->os1.ou1.os11.otype == 140) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "NumToSym: y!"); }; *sym = (y)->os7.osymb; };
