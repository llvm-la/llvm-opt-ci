# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c" 2
# 43 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c"
void InsertUses(OBJECT x, OBJECT y)
{ OBJECT tmp;
                                                                ;
  if( (x)->os1.ou1.os11.otype == 143 && (y)->os1.ou1.os11.otype == 143 && !(y)->os6.opredefined )
  { { ; if( (zz_size=(( ((sizeof(struct uses_type)) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) tmp = GetMemory(zz_size, no_fpos); else { tmp = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (tmp)->os9.oitem = y;
    if( (x)->os6.obase_uses == ( (OBJECT) ((void*)0) ) ) (tmp)->os9.onext = tmp;
    else (tmp)->os9.onext = ((x)->os6.obase_uses)->os9.onext, ((x)->os6.obase_uses)->os9.onext = tmp;
    (x)->os6.obase_uses = tmp;
  }
  if( (((y)->os1.ou1.os11.otype) >= 144 && ((y)->os1.ou1.os11.otype) <= 146) )
  {
    (y)->os6.ouses_count += ((y)->os6.oenclosing == x ? 1 : 2);
    if( (y)->os1.ou2.os26.odirty || (y)->os6.ouses_count > 1 ) ((y)->os6.oenclosing)->os1.ou2.os26.odirty = 1;
  }
  else if( (y)->os6.osym_body == ( (OBJECT) ((void*)0) ) || (y)->os1.ou2.os26.odirty ) (x)->os1.ou2.os26.odirty = 1;


                                                              ;
}
# 74 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c"
static void GatherUses(OBJECT x, OBJECT sym)
{ OBJECT link, y, tmp;
  if( (x)->os6.obase_uses != ( (OBJECT) ((void*)0) ) )
  { link = ((x)->os6.obase_uses)->os9.onext;
    do
    { y = (link)->os9.oitem;
      if( (y)->os6.omarker != sym )
      { if( y != sym )
 { (y)->os6.omarker = sym;
   { ; if( (zz_size=(( ((sizeof(struct uses_type)) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) tmp = GetMemory(zz_size, no_fpos); else { tmp = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (tmp)->os9.oitem = y;
   if( (sym)->os6.ouses == ( (OBJECT) ((void*)0) ) ) (tmp)->os9.onext = tmp;
   else (tmp)->os9.onext = ((sym)->os6.ouses)->os9.onext, ((sym)->os6.ouses)->os9.onext = tmp;
   (sym)->os6.ouses = tmp;
   if( (y)->os1.ou2.os26.oindefinite ) (sym)->os1.ou2.os26.oindefinite = 1;
   if( (y)->os1.ou2.os26.ouses_extern_target ) (sym)->os1.ou2.os26.ouses_extern_target = 1;
   GatherUses(y, sym);
 }
 else (sym)->os1.ou2.os26.orecursive = 1;
      }
      link = (link)->os9.onext;
    } while( link != ((x)->os6.obase_uses)->os9.onext );
  }
}
...
{ OBJECT link, y;
  ...
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os1.ou1.os11.otype == 143 ) GatherUses(y, y);
    GatherAllUses(y);
  }
}
# 118 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c"
void FlattenUses(void)
{ GatherAllUses(StartSym);
}
# 131 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c"
unsigned SearchUses(OBJECT x, OBJECT y)
{ OBJECT p;
                                                                               ;
  if( x == y ) return 1;
  if( (x)->os6.ouses != ( (OBJECT) ((void*)0) ) )
  { p = ((x)->os6.ouses)->os9.onext;
    do
    { ;
      if( (p)->os9.oitem == y ) return 1;
      p = (p)->os9.onext;
    } while( p != ((x)->os6.ouses)->os9.onext );
  }
  return 0;
}
# 157 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z30.c"
OBJECT FirstExternTarget(OBJECT sym, OBJECT *cont)
{ OBJECT res;
                                                         ;
  res = ( (OBJECT) ((void*)0) ); *cont = ( (OBJECT) ((void*)0) );
  if( (sym)->os1.ou2.os26.ois_extern_target ) res = sym;
  else if( (sym)->os6.ouses != ( (OBJECT) ((void*)0) ) )
  { *cont = ((sym)->os6.ouses)->os9.onext;
    do
    { if( ((*cont)->os9.oitem)->os1.ou2.os26.ois_extern_target )
      { res = (*cont)->os9.oitem;
 break;
      }
      *cont = (*cont)->os9.onext;
    } while( *cont != ((sym)->os6.ouses)->os9.onext );
  }
                                                                ;
  return res;
}
