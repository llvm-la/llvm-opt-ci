# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z21.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z21.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z21.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z21.c" 2
# 61 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z21.c"
void SizeGalley(OBJECT hd, OBJECT env, unsigned rows, unsigned joined,
unsigned nonblock, unsigned trig, STYLE *style, CONSTRAINT *c, OBJECT target,
...
{ OBJECT y, link, z, crs, t, tlink, zlink, tmp, why;
  ...
  unsigned after_target;

  { if( !((hd)->os1.ou1.os11.otype == 8 && (hd)->os1.olist[0].osucc != hd) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley: precondition!"); };
  { if( !(!(hd)->os1.ou2.os23.osized) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley: already sized!"); };
  ...
  tmp2 = enclose;
  crs = ( (OBJECT) ((void*)0) );
  bt[0] = ft[0] = bt[1] = ft[1] = ( (OBJECT) ((void*)0) );
  ...
  if( AllowCrossDb && (y)->os1.ou1.os11.otype == 2 && ((y)->os2.oactual)->os6.ohas_optimize
      && FindOptimize(y, env) )
  {
    SetOptimize(hd, style);
                                        ...
                                        ;
  if( joined )
  { { ; { ; if( (zz_size=(zz_lengths[139])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 139; ; bt[0] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; { ; { ; if( (zz_size=(zz_lengths[139])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 139; ; ft[0] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
                                                           ;
    y = Manifest(y, env, style, bt, ft, &tmp1, &crs, 1, (hd)->os1.ou2.os23.omust_expand,
      &tmp2, 0);
    { if( !((bt[0])->os1.olist[0].osucc != bt[0] && (ft[0])->os1.olist[0].osucc != ft[0]) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley: threads!"); };

    for( tmp1 = ((bt[0])->os1.olist[0].osucc)->os1.olist[1].opred; (tmp1)->os1.ou1.os11.otype == 0; tmp1 = (tmp1)->os1.olist[1].opred ); for( tmp2 = ((ft[0])->os1.olist[0].osucc)->os1.olist[1].opred; (tmp2)->os1.ou1.os11.otype == 0; tmp2 = (tmp2)->os1.olist[1].opred );
    if( (bt[0])->os1.olist[0].osucc != (bt[0])->os1.olist[0].opred ||
   (ft[0])->os1.olist[0].osucc != (ft[0])->os1.olist[0].opred || tmp1 != tmp2 )
      Error(21, 1, "galley %s must have just one column mark",
 1, &(y)->os1.ou1.ofpos, SymName((hd)->os2.oactual) );
    DisposeObject(bt[0]); DisposeObject(ft[0]);
  }
  else
  { ;
    y = Manifest(y, env, style, bt, ft, &tmp1, &crs, 1, (hd)->os1.ou2.os23.omust_expand,
  ...
  DisposeObject(hold_env);
                                   ...
                                   ;
                                                       ...
                                                       ;
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; extras = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  ...
  {
    (((hd)->os2.ou4.oconstraint).obc = (*c).obc, ((hd)->os2.ou4.oconstraint).obfc = (*c).obfc, ((hd)->os2.ou4.oconstraint).ofc = (*c).ofc);
                                                      ;
    ...
    y = BreakObject(y, c);
                                          ...
                                          ;
    if( !((y)->os1.ou3.os31.oback[0] <= (*c).obc && (y)->os1.ou3.os31.oback[0] + (y)->os1.ou3.os31.ofwd[0] <= (*c).obfc && (y)->os1.ou3.os31.ofwd[0] <= (*c).ofc) )
      Error(21, 13, "%s,%s object too wide for available space",
        1, &(y)->os1.ou1.ofpos, EchoLength((y)->os1.ou3.os31.oback[0]), EchoLength((y)->os1.ou3.os31.ofwd[0]));
    (hd)->os1.ou3.os31.oback[0] = (y)->os1.ou3.os31.oback[0];
    (hd)->os1.ou3.os31.ofwd[0] = (y)->os1.ou3.os31.ofwd[0];
    { if( !(((hd)->os1.ou3.os31.oback[0] <= (*c).obc && (hd)->os1.ou3.os31.oback[0] + (hd)->os1.ou3.os31.ofwd[0] <= (*c).obfc && (hd)->os1.ou3.os31.ofwd[0] <= (*c).ofc)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley: BreakObject failed to fit!"); };
  ...
  else if( (hd)->os2a.oopt_components != ( (OBJECT) ((void*)0) ) && (hd)->os1.ou2.os23.oopt_hyph && (y)->os1.ou1.os11.otype == 17 )
  { ;
    y = Hyphenate(y);
  }


  (hd)->os1.ou2.os23.oblocked = 0;
  if( rows )
  {
                                                         ;
    for( link = hd; (link)->os1.olist[0].osucc != hd; link = (link)->os1.olist[0].osucc )
 ...
 case 17:
   ...
   if( (hd)->os1.ou2.os23.ogall_dir == 0 )
   { { OBJECT xxstart = (y)->os1.olist[0].osucc, xxstop = y, xxdest = (y)->os1.olist[1].osucc; if( xxstart != xxstop ) { { if( !((xxstart)->os1.ou1.os11.otype == 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "TransferLinks: start_link!"); }; ( zz_res = (xxstart), zz_hold = (xxstop), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xxstart), zz_hold = (xxdest), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); } };
     { xx_link = ((y)->os1.olist[1].osucc); xx_tmp = ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; if( (xx_tmp)->os1.olist[1].osucc == xx_tmp ) DisposeObject(xx_tmp); };
     link = (link)->os1.olist[0].opred;
   }
 ...
 case 9:
   ...
   { if( !((y)->os1.olist[1].osucc==(y)->os1.olist[1].opred) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley COL_THR: Up(y)!=LastUp(y)!"); };
   for( z = (( (1) == 0 ? (y)->os1.olist[0].osucc : (y)->os1.olist[0].opred ))->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
   if( (((z)->os1.ou1.os11.otype) >= 2 && ((z)->os1.ou1.os11.otype) <= 8) )
   {

                     ;
     (z)->os1.ou2.os23.oexternal_ver = 1;
   }
   else if( (z)->os1.ou1.os11.otype == 19 )
   { OBJECT hor, thor, clink, dlink;
     for( hor = (( (0) == 0 ? (y)->os1.olist[0].osucc : (y)->os1.olist[0].opred ))->os1.olist[1].opred; (hor)->os1.ou1.os11.otype == 0; hor = (hor)->os1.olist[1].opred );
     { if( !((hor)->os1.ou1.os11.otype == 16) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley: missing COL_THR!"); };
     for( thor = (( (0) == 0 ? (z)->os1.olist[1].osucc : (z)->os1.olist[1].opred ))->os1.olist[0].opred; (thor)->os1.ou1.os11.otype == 0; thor = (thor)->os1.olist[0].opred );
     { if( !(hor == thor) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley/SPLIT: hor != thor!"); };
     clink = ( (0) == 0 ? (y)->os1.olist[0].osucc : (y)->os1.olist[0].opred );
     dlink = ( (0) == 0 ? (z)->os1.olist[1].osucc : (z)->os1.olist[1].opred );
     for( tlink = (z)->os1.olist[0].opred; tlink != z; tlink = (tlink)->os1.olist[0].opred )
     { for( t = (tlink)->os1.olist[1].opred; (t)->os1.ou1.os11.otype == 0; t = (t)->os1.olist[1].opred );
       if( (t)->os1.ou1.os11.otype == 1 )
       { { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = (((link)->os1.olist[0].osucc)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
       }
       else
       { { ; { ; if( (zz_size=(zz_lengths[9])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 9; ; tmp = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  (tmp)->os1.ou3.os31.oback[0] = (hor)->os1.ou3.os31.oback[0];
  (tmp)->os1.ou3.os31.ofwd[0] = (hor)->os1.ou3.os31.ofwd[0];
  ...
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((tmp)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = (((clink)->os1.olist[1].osucc)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = (((dlink)->os1.olist[0].osucc)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((tmp)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
       }
     }
     { xx_link = (dlink); ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; };
     { if( !((y)->os1.olist[1].osucc==(y)->os1.olist[1].opred) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeGalley COL_THR: Up(y) != LastUp(y)!"); };
     { xx_link = ((y)->os1.olist[1].osucc); xx_tmp = ( zz_hold = (xx_link), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_hold = (xx_link), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); { zz_hold = (xx_link); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; if( (xx_tmp)->os1.olist[1].osucc == xx_tmp ) DisposeObject(xx_tmp); };
     link = (link)->os1.olist[0].opred;
   }
 ...
 case 8:
   ...
   if( (hd)->os1.ou2.os23.ogall_dir == 0 )
     (y)->os1.ou2.os23.oexternal_hor = 1;
   else
   {

                     ;
     (y)->os1.ou2.os23.oexternal_ver = 1;
   }
   break;
 ...
 default:
  ...
  for( link = (extras)->os1.olist[0].osucc; link != extras; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( (y)->os1.ou1.os11.otype == 136 )
    {

      CONSTRAINT zc; OBJECT t; FULL_LENGTH b, f;
      z = (y)->os2.oactual;
      { if( !((z)->os1.ou1.os11.otype == 34) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeObject: type(z) != SCALE!"); };
      { if( !(((z)->os2.ou4.oconstraint).obc == 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeObject: bc(constraint(z)) != 0"); };
      { if( !((z)->os1.olist[0].osucc != z) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeObject SCALE: Down(z) == z!"); };
      for( t = ((z)->os1.olist[0].osucc)->os1.olist[1].opred; (t)->os1.ou1.os11.otype == 0; t = (t)->os1.olist[1].opred );



      if( (hd)->os1.ou2.os23.ogall_dir == 0 )
      { Error(21, 2, "%s with unspecified scale factor in horizontal galley",
   1, &(z)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Scale") ));
      }

      Constrained(z, &zc, 0, &why);

                     ;
      if( !((zc).obc != 8388607 || (zc).obfc != 8388607 || (zc).ofc != 8388607) )
      { Error(21, 3, "replacing infinite scale factor (unconstrained width) by 1.0",
   2, &(z)->os1.ou1.ofpos);
 ((z)->os2.ou4.oconstraint).obc = ((z)->os2.ou4.oconstraint).ofc = 1 * 128;
      }
      else if( ((t)->os1.ou3.os31.oback[0] + (t)->os1.ou3.os31.ofwd[0]) == 0 )
      { Error(21, 4, "replacing infinite scale factor (zero width object) by 1.0",
   2, &(z)->os1.ou1.ofpos);
 ((z)->os2.ou4.oconstraint).obc = ((z)->os2.ou4.oconstraint).ofc = 1 * 128;
      }
      else if( (float) (zc).obfc / ((t)->os1.ou3.os31.oback[0] + (t)->os1.ou3.os31.ofwd[0]) > 100.0 )
      { Error(21, 5, "replacing very large scale factor (over 100) by 1.0",
   2, &(z)->os1.ou1.ofpos);
 ((z)->os2.ou4.oconstraint).obc = ((z)->os2.ou4.oconstraint).ofc = 1 * 128;
      }
      else if( (float) (zc).obfc / ((t)->os1.ou3.os31.oback[0] + (t)->os1.ou3.os31.ofwd[0]) < 0.01 )
      { if( (zc).obfc == 0 )
   ...
   Error(21, 7, "object deleted (scale factor is smaller than 0.01)",
     2, &(z)->os1.ou1.ofpos);
 ((z)->os2.ou4.oconstraint).obc = ((z)->os2.ou4.oconstraint).ofc = 1 * 128;
 tmp = MakeWord(11, ( (FULL_CHAR *) ("") ), &(t)->os1.ou1.ofpos);
 (tmp)->os1.ou3.os31.oback[0] = (tmp)->os1.ou3.os31.ofwd[0] = 0;
 (tmp)->os1.ou3.os31.oback[1] = (tmp)->os1.ou3.os31.ofwd[1] = 0;
 (tmp)->os1.ou2.os22.oword_font = (tmp)->os1.ou2.os22.oword_colour = (tmp)->os1.ou2.os22.oword_language = 0;
 (tmp)->os1.ou2.os22.oword_outline = 0;
 (tmp)->os1.ou2.os22.oword_hyph = 0;
 ( xx_tmp = ( zz_hold = ((t)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((tmp)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) );
 DisposeObject(t);
 t = tmp;
      }
      else ((z)->os2.ou4.oconstraint).obc = ((z)->os2.ou4.oconstraint).ofc = ((zc).obfc * 128)/((t)->os1.ou3.os31.oback[0] + (t)->os1.ou3.os31.ofwd[0]);


      b = ((t)->os1.ou3.os31.oback[0] * ((z)->os2.ou4.oconstraint).ofc) / 128;
      f = ((t)->os1.ou3.os31.ofwd[0] * ((z)->os2.ou4.oconstraint).ofc) / 128;
      ...
      { b = ((t)->os1.ou3.os31.oback[1] * ((z)->os2.ou4.oconstraint).ofc) / 128;
 f = ((t)->os1.ou3.os31.ofwd[1] * ((z)->os2.ou4.oconstraint).ofc) / 128;
 ...
 AdjustSize(z, b, f, 1);
  ...
  DisposeObject(extras);
                                                   ...
                                                   ;
                                   ;
  *recs = *inners = *dest_index = ( (OBJECT) ((void*)0) );
  after_target = 0;
  for( link = (hd)->os1.olist[0].osucc; link != hd; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );

    if( (y)->os1.ou1.os11.otype == 1 || (((y)->os1.ou1.os11.otype) >= 119 && ((y)->os1.ou1.os11.otype) <= 138) ) continue;
                                      ;
                                     ;
    { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; extras = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
    y = MinSize(y, 1, &extras);
    ...
    for( zlink = (extras)->os1.olist[0].osucc; zlink != extras; zlink = (zlink)->os1.olist[0].osucc )
    { for( z = (zlink)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
      (z)->os1.ou2.os23.oblocked = 0;
 ...
 case 121:
   ...
   (z)->os1.ou2.os23.otrigger_ext = (((z)->os2.oactual)->os2.oactual)->os1.ou2.os26.ouses_extern_target && trig;
   (z)->os1.ou2.os23.onon_blocking = nonblock;
   if( ((z)->os2.oactual)->os2.oactual == GalleySym || ((z)->os2.oactual)->os2.oactual == ForceGalleySym )
     *dest_index = z;
   if( ((z)->os2.oactual)->os2.oactual == GalleySym || ((z)->os2.oactual)->os2.oactual == ForceGalleySym
     || ((z)->os2.oactual)->os2.oactual == InputSym )
     after_target = 1;
   break;
 ...
 case 123:
   ...
   if( *recs == ( (OBJECT) ((void*)0) ) ) { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; *recs = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
   { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((*recs)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((z)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
   break;
 ...
 case 137:
   ...
   { OBJECT cover, prnt, chld; int dirn, thr_type, ok1, ok2, sf,subst, esubst;
     ...
     cover = (z)->os2.oactual;
     if( (cover)->os1.ou1.os11.otype == 32 )
     { dirn = 0;
       thr_type = 16;
       ok1 = 19;
       ok2 = 19;
     ...
     for( prnt = (( (dirn) == 0 ? (cover)->os1.olist[1].osucc : (cover)->os1.olist[1].opred ))->os1.olist[0].opred; (prnt)->os1.ou1.os11.otype == 0; prnt = (prnt)->os1.olist[0].opred );
     while( (prnt)->os1.ou1.os11.otype == 9 || (prnt)->os1.ou1.os11.otype == thr_type )
       for( prnt = (( (dirn) == 0 ? (prnt)->os1.olist[1].osucc : (prnt)->os1.olist[1].opred ))->os1.olist[0].opred; (prnt)->os1.ou1.os11.otype == 0; prnt = (prnt)->os1.olist[0].opred );
     for( chld = ((cover)->os1.olist[0].osucc)->os1.olist[1].opred; (chld)->os1.ou1.os11.otype == 0; chld = (chld)->os1.olist[1].opred );
     if( (prnt)->os1.ou1.os11.otype != ok1 && (prnt)->os1.ou1.os11.otype != ok2 )
     {
       Error(21, 8, "%s replaced by %s (mark not shared)",
  2, &(cover)->os1.ou1.ofpos, Image((cover)->os1.ou1.os11.otype), Image(subst));

                    ;
                                                          ;
                                           ;
       (cover)->os1.ou1.os11.otype = subst;
     }
     else if( (chld)->os1.ou3.os31.oback[dirn] == 0 && (chld)->os1.ou3.os31.ofwd[dirn] == 0 )
     {

       (cover)->os1.ou1.os11.otype = esubst;
     }
     else if( (chld)->os1.ou3.os31.oback[dirn] == 0 || (chld)->os1.ou3.os31.ofwd[dirn] == 0 )
  ...
  2, &(cover)->os1.ou1.ofpos, Image((cover)->os1.ou1.os11.otype), Image(subst));
     ...
     else if( ((prnt)->os1.ou3.os31.oback[dirn] + (prnt)->os1.ou3.os31.ofwd[dirn]) == 0 )
  ...
  2, &(cover)->os1.ou1.ofpos, Image((cover)->os1.ou1.os11.otype), Image(subst));
     ...
     else
     {
       ...
       sf1 = (float) (prnt)->os1.ou3.os31.oback[dirn] / (chld)->os1.ou3.os31.oback[dirn];
       sf2 = (float) (prnt)->os1.ou3.os31.ofwd[dirn] / (chld)->os1.ou3.os31.ofwd[dirn];
       sf = ((sf1) < (sf2) ? (sf2) : (sf1)) * 128;
       b = ((chld)->os1.ou3.os31.oback[dirn] * sf) / 128;
       f = ((chld)->os1.ou3.os31.ofwd[dirn] * sf) / 128;


       Constrained(cover, &c, dirn, &why);
       if( (b <= (c).obc && b + f <= (c).obfc && f <= (c).ofc) )
       {

  (cover)->os1.ou1.os11.otype = 34;
  if( dirn == 0 )
  { ((cover)->os2.ou4.oconstraint).obc = sf;
    ((cover)->os2.ou4.oconstraint).ofc = 128;
  }
  else
  { ((cover)->os2.ou4.oconstraint).obc = 128;
    ((cover)->os2.ou4.oconstraint).ofc = sf;
  }
 ...
 default:
   ...
   { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"SizeGalley:", Image((z)->os1.ou1.os11.otype)); };
   break;

      }
    }
    { OBJECT xxstart = (extras)->os1.olist[0].osucc, xxstop = extras, xxdest = link; if( xxstart != xxstop ) { { if( !((xxstart)->os1.ou1.os11.otype == 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "TransferLinks: start_link!"); }; ( zz_res = (xxstart), zz_hold = (xxstop), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xxstart), zz_hold = (xxdest), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); } };
    { if( !((extras)->os1.olist[0].osucc == extras && (extras)->os1.olist[1].osucc == extras) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "SizeG: extras!"); };
    { zz_hold = (extras); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
  }
  ...
  {
                                                                 ;
    { OBJECT xxstart = (crs)->os1.olist[0].osucc, xxstop = crs, xxdest = (hd)->os1.olist[0].osucc; if( xxstart != xxstop ) { { if( !((xxstart)->os1.ou1.os11.otype == 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "TransferLinks: start_link!"); }; ( zz_res = (xxstart), zz_hold = (xxstop), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xxstart), zz_hold = (xxdest), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); } };
    DisposeObject(crs);
  }


  if( target != ( (OBJECT) ((void*)0) ) && *dest_index == ( (OBJECT) ((void*)0) ) )
    Error(21, 12, "unexpected absence of %s from the body of %s",
      1, &(hd)->os1.ou1.ofpos, SymName(target), SymName((hd)->os2.oactual));


                                    ;
                                             ;
  (hd)->os1.ou2.os23.osized = 1;
