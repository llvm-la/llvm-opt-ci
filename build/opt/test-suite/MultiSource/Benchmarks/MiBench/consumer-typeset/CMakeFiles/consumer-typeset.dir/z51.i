# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c" 2
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
FULL_LENGTH PlainCharWidth, PlainCharHeight;
unsigned PlainFormFeed;
...
static int hsize;
static int vsize;
static FULL_CHAR *page;
static unsigned prologue_done;
# 65 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 82 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 109 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 127 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
static void Plain_PrintPageResourceForFont(FULL_CHAR *font_name, unsigned first)
{


}
# 142 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
static void Plain_PrintMapping(MAPPING m)
{


}
# 158 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
{ int i, j;
  ...
  hsize = ( ((h) - 1)/(PlainCharWidth) + 1 );
  vsize = ( ((v) - 1)/(PlainCharHeight) + 1 );
...
# 188 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
{ int new_hsize, new_vsize, i, j, jmax;
  ...
  new_hsize = ( ((h) - 1)/(PlainCharWidth) + 1 );
  new_vsize = ( ((v) - 1)/(PlainCharHeight) + 1 );
...
# 250 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
{ FULL_CHAR *p; int i, h, v;
  ...
  v = ((float) vpos / PlainCharHeight);
                                                                     ;
  if( h >= 0 && h + strlen((char *)((x)->os1.ostring)) < hsize && v >= 0 && v < vsize )
  {
    { if( !(h >= 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintWord:  h < 0!"); };
    { if( !(h < hsize) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintWord:  h >= hsize!"); };
    { if( !(v >= 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintWord:  v < 0!"); };
    { if( !(v < vsize) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PrintWord:  v >= vsize!"); };
    p = &page[v*hsize + h];
    ...
    Error(51, 1, "word %s deleted (internal error, off page at %d,%d)",
      2, &(x)->os1.ou1.ofpos, (x)->os1.ostring, h, v);
                                         ;
}
# 286 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
{ int i, len, starth, startv, stoph, stopv, h, v;
  ...
  if( (x)->os1.ou1.os11.otype != 11 && (x)->os1.ou1.os11.otype != 12 )
  {
    Error(51, 2, "left parameter of %s must be a simple word",
      2, &(x)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@PlainGraphic") ));
    return;
  }
  len = strlen((char *)((x)->os1.ostring));
  if( strlen((char *)((x)->os1.ostring)) == 0 )
  {
  ...
  stoph = (((float) xmk + ((z)->os1.ou3.os31.oback[0] + (z)->os1.ou3.os31.ofwd[0])) / PlainCharWidth) + 0.5;
  stopv = (((float) ymk - ((z)->os1.ou3.os31.oback[1] + (z)->os1.ou3.os31.ofwd[1])) / PlainCharHeight);
  SetLengthDim(0);
  ...
  { i = 0;
    for( v = startv-1; v >= stopv; v-- )
    {
      ...
      {
        if( i == len ) i = 0;
        page[v*hsize + h] = (x)->os1.ostring[i++];
      }
    }
  }
  else
...
# 345 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 366 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 404 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_CoordTranslate(FULL_LENGTH xdist, FULL_LENGTH ydist)
{ ;

  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_CoordTranslate: should never be called!"); };
                                                   ;
}
# 420 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
static void Plain_CoordRotate(FULL_LENGTH amount)
{ ;
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_CoordRotate: should never be called!"); };
                                                ;
}
# 435 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_CoordScale(float hfactor, float vfactor)
{
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_CoordScale: should never be called!"); };
}
# 450 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_SaveGraphicState(OBJECT x)
{ ;
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_SaveGraphicState: should never be called!"); };
                                                     ;
}
# 465 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_RestoreGraphicState(void)
{ ;
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_RestoreGraphicState: should never be called!"); };
                                                        ;
}
# 480 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_PrintGraphicObject(OBJECT x)
{

                                                         ;
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_PrintGraphicObject: should never be called!"); };
                                                      ;
}
# 497 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_DefineGraphicNames(OBJECT x)
{
                                                                 ;
                                                            ;
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_DefineGraphicNames: should never be called!"); };
                                                       ;
}
# 521 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_SaveTranslateDefineSave(OBJECT x, FULL_LENGTH xdist,
  FULL_LENGTH ydist)
{
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_SaveTranslateDefineSave: should never be called!"); };
}
# 536 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
void Plain_PrintGraphicInclude(OBJECT x, FULL_LENGTH colmark,
  FULL_LENGTH rowmark)
{
                                                ;
  { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Plain_PrintGraphicInclude: should never be called!"); };
                                                        ;
}
# 553 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 574 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 593 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
# 609 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
