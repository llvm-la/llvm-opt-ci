# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z32.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z32.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z32.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z32.c" 2
# 41 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z32.c"
OBJECT Next(OBJECT x, int inc, unsigned *done)
{ OBJECT y, link; int l, r, n, len;
  ...
  switch( (x)->os1.ou1.os11.otype )
  {
    ...
    case 12:
      ...
      for( r = len - 1; r >= 0 && !( ((x)->os1.ostring[r]) >= '0' && ((x)->os1.ostring[r]) <= '9' ); r--);
      if( r < 0 ) break;
      for( l = r-1; l >= 0 && ( ((x)->os1.ostring[l]) >= '0' && ((x)->os1.ostring[l]) <= '9' ); l-- );
      sscanf( (char *) &(x)->os1.ostring[l+1], "%d", &n);
      (x)->os1.ostring[l+1] = '\0';
      strcpy((char *)(buff),(char *)((x)->os1.ostring));
      strcat((char *)(buff),(char *)(StringInt(n+inc)));
      strcat((char *)(buff),(char *)(&(x)->os1.ostring[r+1]));
      if( strlen((char *)(buff)) >= 512 )
 Error(32, 1, "word %s is too long", 1, &(x)->os1.ou1.ofpos, buff);
      y = MakeWord((x)->os1.ou1.os11.otype, buff, &(x)->os1.ou1.ofpos);
      (y)->os1.ou2.os22.oword_font = (x)->os1.ou2.os22.oword_font;
      (y)->os1.ou2.os22.oword_colour = (x)->os1.ou2.os22.oword_colour;
      (y)->os1.ou2.os22.oword_outline = (x)->os1.ou2.os22.oword_outline;
      (y)->os1.ou2.os22.oword_language = (x)->os1.ou2.os22.oword_language;
      (y)->os1.ou2.os22.oword_hyph = (x)->os1.ou2.os22.oword_hyph;
      (y)->os1.ou2.os22.ounderline = (x)->os1.ou2.os22.ounderline;
      { xx_res = (y); xx_hold = (x); xx_tmp = ( zz_hold = (xx_hold), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ); ( zz_res = (xx_res), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); xx_tmp = ( zz_hold = (xx_hold), (zz_hold)->os1.olist[0].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[0].osucc, (zz_res)->os1.olist[0].opred = (zz_hold)->os1.olist[0].opred, ((zz_hold)->os1.olist[0].opred)->os1.olist[0].osucc = zz_res, (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = zz_hold, zz_res ) ); ( zz_res = (xx_res), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); { zz_hold = (xx_hold); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; }; x = y;
      *done = 1;
      break;
    ...
    case 17:
# 142 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z32.c"
    case 16:
    case 15:
    case 18:
    case 19:

      link = (x)->os1.olist[0].opred;
      while( link != x && !*done )
 ...
 y = Next(y, inc, done);
 if( !*done ) link = (link)->os1.olist[0].opred;
      }
      break;
    ...
    default:
      ...
      { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"Next:", Image((x)->os1.ou1.os11.otype)); };
      break;
