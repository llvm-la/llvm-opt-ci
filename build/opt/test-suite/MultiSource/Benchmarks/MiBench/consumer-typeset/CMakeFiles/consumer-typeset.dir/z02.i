# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c" 2
# 35 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
static unsigned char chtbl[256];
static FULL_CHAR *chpt;
static FULL_CHAR *frst;
static FULL_CHAR *limit;
static FULL_CHAR *buf;
static int blksize;
static FULL_CHAR last_char;
static FULL_CHAR *startline;
static FILE_NUM this_file;
static FILE *fp;
static FILE_POS file_pos;
static short ftype;
static OBJECT next_token;
static int offset;
static int first_line_num;
static unsigned same_file;
static FULL_CHAR *mem_block;

static int stack_free;
static struct {
  FULL_CHAR *chpt;
  FULL_CHAR *frst;
  FULL_CHAR *limit;
...
# 102 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
unsigned LexLegalName(FULL_CHAR *str)
{ int i; unsigned res;
                                             ;
  switch( chtbl[str[0]] )
  {
...
# 142 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
...
void LexInit(void)
{ initchtbl(1, ( (FULL_CHAR *) ("abcdefghijklmnopqrstuvwxyz") ));
  initchtbl(1, ( (FULL_CHAR *) ("ABCDEFGHIJKLMNOPQRSTUVWXYZ") ));
  initchtbl(1, ( (FULL_CHAR *) ("@") ));
  initchtbl(1, ( (FULL_CHAR *) ("_") ));
  initchtbl(1, ( (FULL_CHAR *) ("\300\301\302\303\304\305\306\307") ));
  initchtbl(1, ( (FULL_CHAR *) ("\310\311\312\313\314\315\316\317") ));
  initchtbl(1, ( (FULL_CHAR *) ("\320\321\322\323\324\325\326") ));
  initchtbl(1, ( (FULL_CHAR *) ("\330\331\332\333\334\335\336\337") ));
  initchtbl(1, ( (FULL_CHAR *) ("\340\341\342\343\344\345\346\347") ));
  initchtbl(1, ( (FULL_CHAR *) ("\350\351\352\353\354\355\356\357") ));
  initchtbl(1, ( (FULL_CHAR *) ("\360\361\362\363\364\365\366") ));
  initchtbl(1, ( (FULL_CHAR *) ("\370\371\372\373\374\375\376\377") ));
  initchtbl(2, ( (FULL_CHAR *) ("\"") ));
  initchtbl(3, ( (FULL_CHAR *) ("\\") ));
  initchtbl(4, ( (FULL_CHAR *) ("#") ));
  initchtbl(5, ( (FULL_CHAR *) (" ") ));
  initchtbl(6,( (FULL_CHAR *) ("\f") ));
  initchtbl(7, ( (FULL_CHAR *) ("\t") ));
  initchtbl(8, ( (FULL_CHAR *) ("\n") ));
  chtbl['\0'] = 9;
  stack_free = -1;
}
# 195 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
void LexPush(FILE_NUM x, int offs, int ftyp, int lnum, unsigned same)
{ int i;
 ...
 EchoFileSource(lex_stack[i].this_file));
  ...
  { lex_stack[stack_free].chpt = chpt;
    ...
    ( (lex_stack[stack_free].file_pos).ofile_num = (file_pos).ofile_num, (lex_stack[stack_free].file_pos).oline_num = (file_pos).oline_num, (lex_stack[stack_free].file_pos).ocol_num = (file_pos).ocol_num );
  }
  stack_free += 1;

                                                                              ;
  mem_block = (FULL_CHAR *) malloc((2048 +8192 +2)*sizeof(FULL_CHAR));
  if( mem_block == ((void*)0) )
    Error(2, 3, "run out of memory when opening file %s",
      1, PosOfFile(x), FullFileName(x));
  buf = chpt = &mem_block[2048];
  last_char = '\n';
  this_file = x; offset = offs;
  first_line_num = lnum; same_file = same;
  ftype = ftyp; next_token = ( (OBJECT) ((void*)0) );
  *chpt = '\0';
  if( same_file )
...
# 260 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
void LexPop(void)
{ ;
  { if( !(stack_free > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LexPop: stack_free <= 0!"); };
  stack_free--;
  if( same_file )
  { fseek(fp, lex_stack[stack_free].save_ftell, 0);
  }
  else
  { if( fp != ( (FILE *) ((void*)0) ) ) fclose(fp);
  }
  ...
  ( (file_pos).ofile_num = (lex_stack[stack_free].file_pos).ofile_num, (file_pos).oline_num = (lex_stack[stack_free].file_pos).oline_num, (file_pos).ocol_num = (lex_stack[stack_free].file_pos).ocol_num );
}
# 317 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
long LexNextTokenPos(void)
{ long res;
  if( next_token != ( (OBJECT) ((void*)0) ) )
    Error(2, 4, "illegal macro invocation in database",
      1, &(next_token)->os1.ou1.ofpos);
  res = ftell(fp) - (limit - chpt) - (buf - frst);
# 348 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
                                                         ;
  return res;
}
# 361 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
...
{ register FULL_CHAR *col;
 ...
 1, &file_pos);
    ...
    chpt = frst;
    blksize = fread( (char *) buf, sizeof(char), 8192, fp);
    if( blksize > 0 )
      last_char = *(buf + blksize - 1);
    if( blksize < 8192 && last_char != '\n' )
    {
      ...
      if( ftype == 3 )
      {
 (file_pos).oline_num = (file_pos).ocol_num = 0;
 Error(2, 25, "a database file must end with a newline; this one doesn't",
   1, &file_pos);
                                              ...
                                              ;
    frst = buf; limit = buf + blksize; *limit = '\n';
  }
...
# 426 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
OBJECT LexGetToken(void)
{
  ...
  if( next_token != ( (OBJECT) ((void*)0) ) )
  { next_token = ( zz_hold = (res = next_token), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) );
  ...
  res = ( (OBJECT) ((void*)0) ); p = chpt;
  vcount = hcount = 0;
  do switch( chtbl[*p++] )
  {
      case 3:

 if( ftype==3 && *p>='a' && *p<='z' && *(p+1) == '{' )
 { res = NewToken(102, &file_pos, 0, 0, (unsigned) *p, StartSym);
   p += 2;
 }
 else
 {
   (file_pos).ocol_num = (startpos = p-1) - startline;
 ...
 if( !same_file )
 {
   ...
   if( fp != ( (FILE *) ((void*)0) ) )
   { fclose(fp); fp = ( (FILE *) ((void*)0) );
     this_file = ftype == 0 ? NextFile(this_file) : 0;
   }


   while( this_file != 0 )
   { (file_pos).ofile_num = this_file;
     (file_pos).oline_num = 1;
     (file_pos).ocol_num = 0;
     fp = OpenFile(this_file, 0, 1);
     if( fp != ( (FILE *) ((void*)0) ) ) break;
     Error(2, 7, "cannot open file %s",
       2, &file_pos, FullFileName(this_file));
     this_file = ftype == 0 ? NextFile(this_file) : 0;
   }
 }
 ...
 { if( offset != 0 )
   { ;
     ...
     offset = 0L;
     (file_pos).oline_num = first_line_num;
   }
   frst = limit = chpt = buf;
   blksize = 0; last_char = '\n';
   srcnext();
 ...
 else switch( ftype )
 {
   ...
   case 3:
     ...
     res = NewToken(105, &file_pos, 0, 0, 2, StartSym);
     next_token = NewToken(111, &file_pos,0,0,0,( (OBJECT) ((void*)0) ));
     --p; startline = p;
     break;
   ...
   case 10:
     ...
     res = NewToken(105, &file_pos, 0, 0, 2, FilterOutSym);
   ...
   default:
     ...
     { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "unknown file type"); };
     break;
 ...
 MORE: if( res == ( (OBJECT) ((void*)0) ) )
 { { { zz_size = sizeof(struct word_type) - 4 + ((p-startpos)+1)*sizeof(FULL_CHAR); { ; if( (zz_size=(( ((zz_size) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, &file_pos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, &file_pos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; ; (zz_hold)->os1.ou1.os11.orec_size = zz_size; (zz_hold)->os1.ou1.os11.otype = 11; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( ((res)->os1.ou1.ofpos).ofile_num = (file_pos).ofile_num, ((res)->os1.ou1.ofpos).oline_num = (file_pos).oline_num, ((res)->os1.ou1.ofpos).ocol_num = (file_pos).ocol_num ); for( c = 0; c < p-startpos; c++ ) (res)->os1.ostring[c] = startpos[c]; (res)->os1.ostring[c] = '\0'; };
 }
 else if( (res)->os1.ou1.os11.otype == 142 )
 { if( (res)->os1.ou2.os26.orecursive )
   { Error(2, 8, "recursion in macro", 2, &file_pos);
     { { zz_size = sizeof(struct word_type) - 4 + ((p-startpos)+1)*sizeof(FULL_CHAR); { ; if( (zz_size=(( ((zz_size) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, &file_pos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, &file_pos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; ; (zz_hold)->os1.ou1.os11.orec_size = zz_size; (zz_hold)->os1.ou1.os11.otype = 11; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( ((res)->os1.ou1.ofpos).ofile_num = (file_pos).ofile_num, ((res)->os1.ou1.ofpos).oline_num = (file_pos).oline_num, ((res)->os1.ou1.ofpos).ocol_num = (file_pos).ocol_num ); for( c = 0; c < p-startpos; c++ ) (res)->os1.ostring[c] = startpos[c]; (res)->os1.ostring[c] = '\0'; };
   }
   else
   { res = CopyTokenList( (res)->os6.osym_body, &file_pos );
     if( res != ( (OBJECT) ((void*)0) ) ) next_token = ( zz_hold = (res), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) );
     else hcount = 0;
   }
 }
 else if( (res)->os6.opredefined == 0 )
 { res = NewToken(2, &file_pos, 0, 0, (res)->os1.ou2.os21.oprecedence, res);
 }
 else if( (res)->os6.opredefined == 112 || (res)->os6.opredefined == 113 )
 { OBJECT t, fname; FILE_NUM fnum; int len; unsigned scope_suppressed;
   chpt = p;
   t = LexGetToken();
   scope_suppressed = ((t)->os1.ou1.os11.otype==11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("{") )))==0));

   if( (t)->os1.ou1.os11.otype!=102 && !scope_suppressed )
   { Error(2, 9, "%s expected (after %s)",
       2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("{") ), SymName(res));
   ...
   { Error(2, 10, "name of include file expected here",
       2, &(fname)->os1.ou1.ofpos);
     { zz_hold = (fname); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
     res = ( (OBJECT) ((void*)0) );
     break;
   }
   len = strlen((char *)((fname)->os1.ostring)) - strlen((char *)(( (FULL_CHAR *) (".lt") )));
   if( len >= 0 && (strcmp((char *)(&(fname)->os1.ostring[len]), (char *)(( (FULL_CHAR *) (".lt") )))==0) )
     strcpy((char *)(&(fname)->os1.ostring[len]),(char *)(( (FULL_CHAR *) ("") )));
                                                          ;
   fnum = DefineFile((fname)->os1.ostring, ( (FULL_CHAR *) ("") ), &(fname)->os1.ou1.ofpos,
       1,
       (res)->os6.opredefined==112 ? 1 : 2);
   { zz_hold = (fname); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
   LexPush(fnum, 0, 1, 1, 0);
   res = LexGetToken();
   vcount++;
   p = chpt;
 }
 else if( (res)->os6.opredefined == 105 )
   res = NewToken((res)->os6.opredefined, &file_pos,0,0,(res)->os1.ou2.os21.oprecedence,( (OBJECT) ((void*)0) ));
 else
   res = NewToken((res)->os6.opredefined, &file_pos,0,0,(res)->os1.ou2.os21.oprecedence,res);
 break;


      case 2:

 (file_pos).ocol_num = (startpos = q = p) - 1 - startline;
 do switch( chtbl[*q++ = *p++] )
 {
   case 0:
   case 1:
   ...
   case 8:
   case 9: --p;
   Error(2, 11, "unterminated string", 2, &file_pos);
   { { zz_size = sizeof(struct word_type) - 4 + ((q-1-startpos)+1)*sizeof(FULL_CHAR); { ; if( (zz_size=(( ((zz_size) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, &file_pos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, &file_pos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; ; (zz_hold)->os1.ou1.os11.orec_size = zz_size; (zz_hold)->os1.ou1.os11.otype = 12; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( ((res)->os1.ou1.ofpos).ofile_num = (file_pos).ofile_num, ((res)->os1.ou1.ofpos).oline_num = (file_pos).oline_num, ((res)->os1.ou1.ofpos).ocol_num = (file_pos).ocol_num ); for( c = 0; c < q-1-startpos; c++ ) (res)->os1.ostring[c] = startpos[c]; (res)->os1.ostring[c] = '\0'; };
   break;

   case 2: { { zz_size = sizeof(struct word_type) - 4 + ((q-1-startpos)+1)*sizeof(FULL_CHAR); { ; if( (zz_size=(( ((zz_size) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, &file_pos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, &file_pos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; ; (zz_hold)->os1.ou1.os11.orec_size = zz_size; (zz_hold)->os1.ou1.os11.otype = 12; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( ((res)->os1.ou1.ofpos).ofile_num = (file_pos).ofile_num, ((res)->os1.ou1.ofpos).oline_num = (file_pos).oline_num, ((res)->os1.ou1.ofpos).ocol_num = (file_pos).ocol_num ); for( c = 0; c < q-1-startpos; c++ ) (res)->os1.ostring[c] = startpos[c]; (res)->os1.ostring[c] = '\0'; };
   break;

   case 3: q--;
   if( chtbl[*p] == 8 || chtbl[*p] == 9 )
   { Error(2, 12, "unterminated string", 2, &file_pos);
     { { zz_size = sizeof(struct word_type) - 4 + ((q-startpos)+1)*sizeof(FULL_CHAR); { ; if( (zz_size=(( ((zz_size) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, &file_pos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, &file_pos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; ; (zz_hold)->os1.ou1.os11.orec_size = zz_size; (zz_hold)->os1.ou1.os11.otype = 12; res = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( ((res)->os1.ou1.ofpos).ofile_num = (file_pos).ofile_num, ((res)->os1.ou1.ofpos).oline_num = (file_pos).oline_num, ((res)->os1.ou1.ofpos).ocol_num = (file_pos).ocol_num ); for( c = 0; c < q-startpos; c++ ) (res)->os1.ostring[c] = startpos[c]; (res)->os1.ostring[c] = '\0'; };
   }
   else if( ( (*p) >= '0' && (*p) <= '7' ) )
   { int count, ch;
     count = ch = 0;
 ...
 } while( res == ( (OBJECT) ((void*)0) ) );
 break;


      default:

 { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LexGetToken: bad chtbl[]"); };
 break;
  ...
  if( p - startline >= 2048 )
  { (file_pos).ocol_num = 1;
    Error(2, 15, "line is too long (or final newline missing)",1,&file_pos);
  }

  chpt = p;
  (res)->os1.ou2.os21.ovspace = vcount;
  (res)->os1.ou2.os21.ohspace = hcount;


                             ;
  return res;
}
# 777 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z02.c"
static OBJECT BuildLines(OBJECT current, FULL_CHAR *buff, int *bufftop)
{ OBJECT wd, res, gp, gpword; int c;


  { { zz_size = sizeof(struct word_type) - 4 + ((*bufftop)+1)*sizeof(FULL_CHAR); { ; if( (zz_size=(( ((zz_size) - 1)/(sizeof(ALIGN)) + 1 ))) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, &file_pos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, &file_pos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; ; (zz_hold)->os1.ou1.os11.orec_size = zz_size; (zz_hold)->os1.ou1.os11.otype = 11; wd = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( ((wd)->os1.ou1.ofpos).ofile_num = (file_pos).ofile_num, ((wd)->os1.ou1.ofpos).oline_num = (file_pos).oline_num, ((wd)->os1.ou1.ofpos).ocol_num = (file_pos).ocol_num ); for( c = 0; c < *bufftop; c++ ) (wd)->os1.ostring[c] = buff[c]; (wd)->os1.ostring[c] = '\0'; };
                                                           ;
  *bufftop = 0;
  ...
  else
  {
    ...
    if( (current)->os1.ou1.os11.otype == 11 )
    ...
    ((gp)->os5.ogap).omark = 0;
    ((gp)->os5.ogap).ojoin = 0;
    ( ((gp)->os1.ou1.ofpos).ofile_num = (file_pos).ofile_num, ((gp)->os1.ou1.ofpos).oline_num = (file_pos).oline_num, ((gp)->os1.ou1.ofpos).ocol_num = (file_pos).ocol_num );
    gpword = MakeWord(11, ( (FULL_CHAR *) ("1vx") ), &file_pos);
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((gp)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((gpword)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
...
FILE *fp; unsigned end_stop; FILE_POS *err_pos; unsigned lessskip;
{
  register FULL_CHAR *p;
  int depth;
  unsigned finished;
  unsigned skipping;
  FULL_CHAR hs_buff[512];
  int hs_top;
  FULL_CHAR buff[512];
  int bufftop;
  OBJECT res = ( (OBJECT) ((void*)0) );


                                                         ;
  if( next_token != ( (OBJECT) ((void*)0) ) )
  { Error(2, 16, "filter parameter in macro", 1, err_pos);
  }
 ...
 skipping = 0;
 { int i; for( i = 0; i < hs_top; i++ ) { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl[hs_buff[i]] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = hs_buff[i]; } } else putc(hs_buff[i], fp); }; hs_top = 0; };
 { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl[*(p-1)] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = *(p-1); } } else putc(*(p-1), fp); };
 break;
 ...
 if( !skipping ) { if( hs_top == 512 ) { int i; for( i = 0; i < hs_top; i++ ) { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl[hs_buff[i]] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = hs_buff[i]; } } else putc(hs_buff[i], fp); }; hs_top = 0; }; hs_buff[hs_top++] = *(p-1); };
 break;
 ...
 if( fp == ((void*)0) )
   Error(2, 22, "end of file reached while reading %s",
     1, err_pos, lessskip ? ( (FULL_CHAR *) ("@RawVerbatim") ) : ( (FULL_CHAR *) ("@Verbatim") ));
 else
 ...
 {
   p--;
   if( end_stop && StringBeginsWith(p, ( (FULL_CHAR *) ("@End") )) )
   { finished = 1;
   }
   else if( StringBeginsWith(p, ( (FULL_CHAR *) ("@Include") )) ||
     StringBeginsWith(p, ( (FULL_CHAR *) ("@SysInclude") )) )
   { OBJECT incl_fname, t; FILE *incl_fp; int ch; FILE_NUM fnum;
     unsigned sysinc = StringBeginsWith(p, ( (FULL_CHAR *) ("@SysInclude") ));
     { int i; for( i = 0; i < hs_top; i++ ) { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl[hs_buff[i]] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = hs_buff[i]; } } else putc(hs_buff[i], fp); }; hs_top = 0; };
     p += sysinc ? strlen((char *)(( (FULL_CHAR *) ("@SysInclude") ))):strlen((char *)(( (FULL_CHAR *) ("@Include") )));
     chpt = p;
     t = LexGetToken();
     if( (t)->os1.ou1.os11.otype != 102 ) Error(2, 18, "expected %s here (after %s)",
  1, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("{") ), sysinc ? ( (FULL_CHAR *) ("@SysInclude") ) : ( (FULL_CHAR *) ("@Include") ));
     incl_fname = Parse(&t, ( (OBJECT) ((void*)0) ), 0, 0);
     p = chpt;
     incl_fname = ReplaceWithTidy(incl_fname, 0);
     if( !(((incl_fname)->os1.ou1.os11.otype) == 11 || ((incl_fname)->os1.ou1.os11.otype) == 12) )
       Error(2, 19, "expected file name here", 1,&(incl_fname)->os1.ou1.ofpos);
                                                                ;
     fnum = DefineFile((incl_fname)->os1.ostring, ( (FULL_CHAR *) ("") ), &(incl_fname)->os1.ou1.ofpos,
       1, sysinc ? 2 : 1);
     { zz_hold = (incl_fname); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
     incl_fp = OpenFile(fnum, 0, 1);
     if( incl_fp == ((void*)0) )
       Error(2, 20, "cannot open include file %s",
  1, PosOfFile(fnum), FullFileName(fnum));
     while( (ch = getc(incl_fp)) != (-1) )
       { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl[ch] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = ch; } } else putc(ch, fp); };
     fclose(incl_fp);
   }
   else
   { { int i; for( i = 0; i < hs_top; i++ ) { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl[hs_buff[i]] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = hs_buff[i]; } } else putc(hs_buff[i], fp); }; hs_top = 0; };
     { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl[*p] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = *p; } } else putc(*p, fp); };
     p++;
   }
 }
 else
 ...
 Error(2, 22, "unreadable character (octal %o)",0,&file_pos,*(p-1));
 { if( !(0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LexScanVerbatim: bad chtbl[]"); };
 break;

  };
  { ; if( fp == ((void*)0) ) { if( bufftop < 512 ) { if( chtbl['\n'] == 8 ) { res = BuildLines(res, buff, &bufftop); } else buff[bufftop++] = '\n'; } } else putc('\n', fp); };

  if( p - startline >= 2048 )
  { (file_pos).ocol_num = 1;
    Error(2, 21, "line is too long (or final newline missing)",1,&file_pos);
  }

  chpt = p;
  if( fp == ((void*)0) && res == ( (OBJECT) ((void*)0) ) )
    res = MakeWord(11, ( (FULL_CHAR *) ("") ), &file_pos);
