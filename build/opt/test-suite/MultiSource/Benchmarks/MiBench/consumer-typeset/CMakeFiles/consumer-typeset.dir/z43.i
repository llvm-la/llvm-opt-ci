# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c" 2
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
...
# 32 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c" 2
# 49 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
typedef struct
{ int langtab_size;
  int langtab_count;
  OBJECT langtab_item[1];
} *LANGUAGE_TABLE;
# 66 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
...
{ LANGUAGE_TABLE S; int i;
  ...
  if( S == (LANGUAGE_TABLE) ((void*)0) )
    Error(43, 1, "run out of memory enlarging language table", 1, no_fpos);
  (S)->langtab_size = newsize;
  (S)->langtab_count = 0;
  for( i = 0; i < newsize; i++ ) (S)->langtab_item[i] = ( (OBJECT) ((void*)0) );
  return S;
}
...
{ LANGUAGE_TABLE NewS; int i;
  ...
  for( i = 1; i <= (S)->langtab_size; i++ )
  { if( (S)->langtab_item[i] != ( (OBJECT) ((void*)0) ) )
      ltab_insert((S)->langtab_item[i], &NewS);
  }
  free(S);
  return NewS;
}
...
{ int pos; OBJECT z, link, y;
  if( (*S)->langtab_count == (*S)->langtab_size - 1 )
    *S = ltab_rehash(*S, 2*(*S)->langtab_size);
  { FULL_CHAR *p = (x)->os1.ostring; pos = *p++; while( *p ) pos += *p++; pos = pos % (*S)->langtab_size; };
  if( (*S)->langtab_item[pos] == ( (OBJECT) ((void*)0) ) ) { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; (*S)->langtab_item[pos] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  z = (*S)->langtab_item[pos];
...
# 145 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
static LANGUAGE_TABLE names_tab;
static OBJECT *hyph_tab;
static OBJECT *canonical_tab;
static int lang_tabsize;
static int lang_count;
static OBJECT lang_ends[64];
# 161 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
unsigned LanguageSentenceEnds[256];
# 172 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
void LanguageInit(void)
{ int i;
                                  ;
  names_tab = ltab_new(100);
  lang_count = 0;
  lang_tabsize = 100;

                                        ;
  hyph_tab = (OBJECT *) malloc(100 * sizeof(OBJECT));

                                        ;
  canonical_tab = (OBJECT *) malloc(100 * sizeof(OBJECT));
  for( i = 0; i < 256; i++ ) LanguageSentenceEnds[i] = 0;
                                           ;
}
# 198 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
void LanguageDefine(OBJECT names, OBJECT inside)
{ OBJECT link, y, hyph_file; unsigned junk; FULL_CHAR ch;
  int len;
  { if( !(names != ( (OBJECT) ((void*)0) ) && (names)->os1.ou1.os11.otype == 17) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LanguageDefine: names!"); };
  { if( !((names)->os1.olist[0].osucc != names) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LanguageDefine: names is empty!"); };
  ...
  for( link = (names)->os1.olist[0].osucc; link != names; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    { if( !((((y)->os1.ou1.os11.otype) == 11 || ((y)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LanguageDefine: type(y) != WORD!"); };
    (y)->os1.ou2.os22.oword_language = lang_count;
    ltab_insert(y, &names_tab);
  }


  for( y = ((names)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
  canonical_tab[lang_count] = y;


  if( (inside)->os1.ou1.os11.otype != 17 )
  ...
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    ...
    { ;
      ...
      Error(43, 4, "expected word ending pattern here", 1, &(y)->os1.ou1.ofpos);
    }
    len = strlen((char *)((y)->os1.ostring));
    if( len == 0 )
      Error(43, 5, "empty word ending pattern", 1, &(y)->os1.ou1.ofpos);
    ch = (y)->os1.ostring[len - 1];
    LanguageSentenceEnds[ch] = 1;
  }


  if( InitializeAll )
  { if( hyph_tab[lang_count] != ( (OBJECT) ((void*)0) ) )
    junk = ReadHyphTable(lang_count);
  }

                                             ;
}
# 297 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
unsigned LanguageWordEndsSentence(OBJECT wd, unsigned lc_prec)
{ OBJECT x, y, link; int pos;
  { if( !((((wd)->os1.ou1.os11.otype) == 11 || ((wd)->os1.ou1.os11.otype) == 12)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LanguageWordEndsSentence: wd!"); };

                                      ;
  x = lang_ends[(wd)->os1.ou2.os22.oword_language];
  for( link = (x)->os1.olist[0].osucc; link != x; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    if( StringEndsWith((wd)->os1.ostring, (y)->os1.ostring) )
    {
      if( !lc_prec )
      { ;
        return 1;
      ...
      pos = strlen((char *)((wd)->os1.ostring)) - strlen((char *)((y)->os1.ostring)) - 1;
      if( pos >= 0 &&
 MapIsLowerCase((wd)->os1.ostring[pos], FontMapping((wd)->os1.ou2.os22.oword_font, &(wd)->os1.ou1.ofpos)))
      {
                                                                            ;
        return 1;
      }
...
# 335 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
void LanguageChange(STYLE *style, OBJECT x)
{ OBJECT lname;
                                                                           ;


  if( !(((x)->os1.ou1.os11.otype) == 11 || ((x)->os1.ou1.os11.otype) == 12) )
  { Error(43, 6, "%s ignored (illegal left parameter)", 2, &(x)->os1.ou1.ofpos,
      ( (FULL_CHAR *) ("@Language") ));
                                                                   ;
    return;
  }
  ...
  if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("") )))==0) )
  { ;
    return;
  }


  lname = ltab_retrieve((x)->os1.ostring, names_tab);
  if( lname == ( (OBJECT) ((void*)0) ) )
    Error(43, 7, "%s ignored (unknown language %s)", 2, &(x)->os1.ou1.ofpos,
      ( (FULL_CHAR *) ("@Language") ), (x)->os1.ostring);
  else (*style).olanguage = (lname)->os1.ou2.os22.oword_language;

                                                                           ;
                                                 ;
}
# 373 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
FULL_CHAR *LanguageString(LANGUAGE_NUM lnum)
{ FULL_CHAR *res;
                                            ;
  { if( !(lnum > 0 && lnum <= lang_count) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LanguageString: unknown number"); };

  res = (canonical_tab[lnum])->os1.ostring;

                                                    ;
  return res;
}
# 393 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z43.c"
OBJECT LanguageHyph(LANGUAGE_NUM lnum)
{ OBJECT res;
                                          ;
  { if( !(lnum > 0 && lnum <= lang_count) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "LanguageHyph: unknown number"); };
