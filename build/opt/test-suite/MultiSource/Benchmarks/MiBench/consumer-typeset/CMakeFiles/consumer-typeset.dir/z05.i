# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c" 2
# 53 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
static void ReadLangDef(OBJECT encl)
{ OBJECT t, names, inside;

  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; names = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  t = LexGetToken();
  while( (((t)->os1.ou1.os11.otype) == 11 || ((t)->os1.ou1.os11.otype) == 12) )
  { { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((names)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    t = LexGetToken();
  }
  if( (t)->os1.ou1.os11.otype != 102 )
  { Error(5, 4, "expected opening %s of langdef here", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("{") ));
  ...
  inside = Parse(&t, encl, 0, 0);
  inside = ReplaceWithTidy(inside, 0);
  LanguageDefine(names, inside);
  return;
}
# 82 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
void ReadPrependDef(unsigned typ, OBJECT encl)
{ OBJECT t, fname;
  t = LexGetToken();
  if( (t)->os1.ou1.os11.otype != 102 )
  { Error(5, 5, "left brace expected here in %s declaration",
      2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@PrependGraphic") ));
    { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
    return;
  }
  fname = Parse(&t, encl, 0, 0);
  fname = ReplaceWithTidy(fname, 0);
  if( !(((fname)->os1.ou1.os11.otype) == 11 || ((fname)->os1.ou1.os11.otype) == 12) )
  { Error(5, 6, "name of %s file expected here", 2, &(fname)->os1.ou1.ofpos,( (FULL_CHAR *) ("@PrependGraphic") ));
    DisposeObject(fname);
    return;
  }
                                                            ;
  DefineFile((fname)->os1.ostring, ( (FULL_CHAR *) ("") ), &(fname)->os1.ou1.ofpos, 6,
    typ == 114 ? 1 : 2);

}
# 113 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
void ReadDatabaseDef(unsigned typ, OBJECT encl)
{ OBJECT symbs, t, fname;
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; symbs = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  t = LexGetToken();
  while( (t)->os1.ou1.os11.otype==2 || ((t)->os1.ou1.os11.otype==11 && (t)->os1.ostring[0]=='@') )
  { if( (t)->os1.ou1.os11.otype == 2 )
    { { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((symbs)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    }
    else
    { Error(5, 7, "unknown or misspelt symbol %s", 2, &(t)->os1.ou1.ofpos, (t)->os1.ostring);
      { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
    }
    t = LexGetToken();
  }
  ...
  { Error(5, 8, "symbol name or %s expected here (%s declaration)",
      2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("{") ), ( (FULL_CHAR *) ("@Database") ));
    { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
    return;
  }
  if( (symbs)->os1.olist[0].osucc == symbs )
  { Error(5, 9, "symbol names missing in %s declaration",
      2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@Database") ));
  }
  fname = Parse(&t, encl, 0, 0);
  fname = ReplaceWithTidy(fname, 0);
  if( !(((fname)->os1.ou1.os11.otype) == 11 || ((fname)->os1.ou1.os11.otype) == 12) )
  { Error(5, 10, "name of %s file expected here", 2, &(fname)->os1.ou1.ofpos,
      ( (FULL_CHAR *) ("@Database") ));
    DisposeObject(fname);
    return;
  }
  if( StringEndsWith((fname)->os1.ostring, ( (FULL_CHAR *) (".ld") )) )
  { Error(5, 47, "%s suffix should be omitted in %s clause", 2,
      &(fname)->os1.ou1.ofpos, ( (FULL_CHAR *) (".ld") ), ( (FULL_CHAR *) ("@Database") ));
    DisposeObject(fname);
    return;
  }
  if( (symbs)->os1.olist[0].osucc != symbs )
    (void) DbLoad(fname, typ == 116 ? 3 : 4,
      1, symbs, InMemoryDbIndexes);
}
# 170 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
static void ReadTokenList(OBJECT token, OBJECT res)
{ OBJECT t, xsym, new_par, imps, link, y; int scope_count, i;
  t = LexGetToken(); (res)->os6.osym_body = ( zz_res = ((res)->os6.osym_body), zz_hold = (t), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );;
  for(;;) switch((t)->os1.ou1.os11.otype)
  {
    case 11:

      if( (t)->os1.ostring[0] == '@' )
 Error(5, 11, "symbol %s unknown or misspelt", 2, &(t)->os1.ou1.ofpos,
   (t)->os1.ostring);
      t = LexGetToken(); (res)->os6.osym_body = ( zz_res = ((res)->os6.osym_body), zz_hold = (t), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );;
      break;
    ...
    case 92:
      ...
      Error(5, 12, "symbol %s not allowed in macro", 2, &(t)->os1.ou1.ofpos,
 SymName((t)->os2.oactual));
      t = LexGetToken(); (res)->os6.osym_body = ( zz_res = ((res)->os6.osym_body), zz_hold = (t), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );;
      break;
    ...
    case 111:
      ...
      Error(5, 13, "unexpected end of input", 1, &(t)->os1.ou1.ofpos);
      break;


    case 104:

      Error(5, 14, "%s not expected here", 2, &(t)->os1.ou1.ofpos, SymName((t)->os2.oactual));
      t = LexGetToken(); (res)->os6.osym_body = ( zz_res = ((res)->os6.osym_body), zz_hold = (t), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );;
      break;
    ...
    case 103:
      ...
      if( (token)->os1.ou1.os11.otype != 102 )
 Error(5, 15, "unmatched %s in macro", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("}") ));
      return;


    case 105:

      if( (token)->os1.ou1.os11.otype != 104 )
 Error(5, 16, "unmatched %s in macro", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("@End") ));
      else
      { t = LexGetToken(); (res)->os6.osym_body = ( zz_res = ((res)->os6.osym_body), zz_hold = (t), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );;
        if( (t)->os1.ou1.os11.otype != 2 )
 {
   if( (t)->os1.ou1.os11.otype == 11 && (t)->os1.ostring[0] == '@' )
     Error(5, 17, "symbol %s unknown or misspelt",
       2, &(t)->os1.ou1.ofpos, (t)->os1.ostring);
   else
     Error(5, 18, "symbol name expected after %s", 2,&(t)->os1.ou1.ofpos,( (FULL_CHAR *) ("@End") ));
 }
        else if( (token)->os2.oactual != (t)->os2.oactual )
   Error(5, 19, "%s %s does not match %s %s", 2, &(t)->os1.ou1.ofpos,
     SymName((token)->os2.oactual), ( (FULL_CHAR *) ("@Begin") ), SymName((t)->os2.oactual), ( (FULL_CHAR *) ("@End") ));
      }
      return;
 ...
 t = LexGetToken(); (res)->os6.osym_body = ( zz_res = ((res)->os6.osym_body), zz_hold = (t), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );;
 if( (t)->os1.ou1.os11.otype != 102 )
 { if( (t)->os1.ou1.os11.otype == 103 )
   { if( (token)->os1.ou1.os11.otype != 102 )
       Error(5, 20, "unmatched %s in macro", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("}") ));
     return;
   }
 ...
 PopScope();
      ...
      {
 if( (t)->os1.ou1.os11.otype == 102 || (t)->os1.ou1.os11.otype == 104 )
 { PushScope(xsym, 0, 1);
   PushScope(ChildSym(xsym, 146), 0, 0);
   if( (t)->os1.ou1.os11.otype == 104 ) (t)->os2.oactual = xsym;
   ReadTokenList(t, res);
   PopScope();
   PopScope();
   t = LexGetToken(); (res)->os6.osym_body = ( zz_res = ((res)->os6.osym_body), zz_hold = (t), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) );;
 }
 else if( (t)->os1.ou1.os11.otype != 103 && (t)->os1.ou1.os11.otype != 105 )
   Error(5, 22, "right parameter of %s must begin with %s",
     2, &(t)->os1.ou1.ofpos, SymName(xsym), ( (FULL_CHAR *) ("{") ));
      }
      break;
    ...
    default:
      ...
      Error(5, 23, "ReadTokenList: %s", 0, &(t)->os1.ou1.ofpos, Image((t)->os1.ou1.os11.otype));
      break;

  }
}
# 427 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
static OBJECT ReadMacro(OBJECT *token, OBJECT curr_encl, OBJECT encl)
{ OBJECT t, res;


  SuppressScope();
  { zz_hold = (*token); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
  if( !(((t)->os1.ou1.os11.otype) == 11 || ((t)->os1.ou1.os11.otype) == 12) )
  { Error(5, 24, "%s ignored (name is missing)", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("macro") ));
                                                          ;
    UnSuppressScope();
    *token = t;
    return ( (OBJECT) ((void*)0) );
  }
  res = InsertSym((t)->os1.ostring, 142, &(t)->os1.ou1.ofpos, 0, 0,1,0,curr_encl,( (OBJECT) ((void*)0) ));
  if( curr_encl != encl ) (res)->os1.ou2.os26.ovisible = 1;
  UnSuppressScope();
  ...
  while( (((t)->os1.ou1.os11.otype) == 11 || ((t)->os1.ou1.os11.otype) == 12) )
  {
    InsertAlternativeName((t)->os1.ostring, res, &(t)->os1.ou1.ofpos);
    { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
  }
  ...
  { Error(5, 25, "%s ignored (opening %s is missing)",
      2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("macro") ), ( (FULL_CHAR *) ("{") ));
    *token = t;
    return ( (OBJECT) ((void*)0) );
  }
  ...
  t = ((res)->os6.osym_body)->os1.olist[1].opred;
  (res)->os6.osym_body = ( zz_hold = (t), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) );
  { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
  (res)->os1.ou2.os26.orecursive = 0;
  *token = ( (OBJECT) ((void*)0) );
  return res;
}
# 486 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
...
{ OBJECT t, res, res_target, export_list, import_list, link, y, z;
  OBJECT curr_encl; unsigned compulsory_par, has_import_encl;
  t = *token;

  while( res_type==143 || ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("named") )))==0) ) || ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("import") )))==0) ) )
  {
    curr_encl = encl;

    if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("langdef") )))==0) ) )
    { ReadLangDef(encl);
      t = LexGetToken();
      continue;
    }
    ...
    if( !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("def") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("macro") )))==0) ) &&
 !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("named") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("import") )))==0) ) &&
        !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("extend") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("export") )))==0) ) )
      break;


    BodyParNotAllowed();
    { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; import_list = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
    has_import_encl = 0;
    if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("import") )))==0) ) )
    { { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
      t = LexGetToken();
      while( (t)->os1.ou1.os11.otype == 2 ||
        ((t)->os1.ou1.os11.otype==11 && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("export") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("def") )))==0) )
        && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("macro") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("named") )))==0) )) )
      { if( (t)->os1.ou1.os11.otype == 2 )
 { if( ((t)->os2.oactual)->os1.ou1.os11.otype == 143 )
   {
# 540 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z05.c"
       PushScope((t)->os2.oactual, 0, 1);
       if( (t)->os2.oactual == encl ) has_import_encl = 1;
       { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((import_list)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };



   }
   else
   { Error(5, 26, "import name expected here", 2, &(t)->os1.ou1.ofpos);
     { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
   }
 }
 else
 { Error(5, 27, "import %s not in scope", 2, &(t)->os1.ou1.ofpos, (t)->os1.ostring);
   { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
 }
 t = LexGetToken();
      }
    }
    else if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("extend") )))==0) ) )
    { { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
      t = LexGetToken();
      while( (t)->os1.ou1.os11.otype == 2 ||
        ((t)->os1.ou1.os11.otype==11 && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("export") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("def") )))==0) )
        && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("macro") )))==0) )) )
      { if( (t)->os1.ou1.os11.otype == 2 )
 { if( ((t)->os2.oactual)->os6.oimports != ( (OBJECT) ((void*)0) ) )
   { Error(5, 48, "%s has %s clause, so cannot be extended",
       2, &(t)->os1.ou1.ofpos, SymName((t)->os2.oactual), ( (FULL_CHAR *) ("import") ));
   }
   else if( ((t)->os2.oactual)->os1.ou1.os11.otype == 143 )
   { PushScope((t)->os2.oactual, 0, 0);
     curr_encl = (t)->os2.oactual;
                                                                  ;
     { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((import_list)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
   }
   else
   { Error(5, 28, "%s symbol name expected here",
       2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("extend") ));
     { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
   }
 }
 else
 { Error(5, 29, "extend symbol %s not in scope", 2,&(t)->os1.ou1.ofpos,(t)->os1.ostring);
   { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
 }
 t = LexGetToken();
      }
    ...
    { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; export_list = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
    if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("export") )))==0) ) )
    { { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
      SuppressScope();
      t = LexGetToken();
      while( (((t)->os1.ou1.os11.otype) == 11 || ((t)->os1.ou1.os11.otype) == 12) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("def") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("import") )))==0) )
 && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("macro") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("extend") )))==0) ) )
      { { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((export_list)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((t)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
 t = LexGetToken();
      }
      UnSuppressScope();
    }
    ...
    if( res_type == 143 && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("def") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("macro") )))==0) ) )
    { Error(5, 30, "keyword %s or %s expected here", 2, &(t)->os1.ou1.ofpos,
 ( (FULL_CHAR *) ("def") ), ( (FULL_CHAR *) ("macro") ));
      break;
    }
    if( res_type == 145 && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("named") )))==0) ) )
    { Error(5, 31, "keyword %s expected here", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("named") ));
      break;
    }

    if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("macro") )))==0) ) )
    { if( (export_list)->os1.olist[0].osucc != export_list )
 Error(5, 32, "ignoring export list of macro", 2, &(t)->os1.ou1.ofpos);
      res = ReadMacro(&t, curr_encl, encl);
    }
    else
    {
      SuppressScope(); { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();


      if( res_type == 145 && ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("compulsory") )))==0) ) )
      { compulsory_par = 1;
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
      }
      else compulsory_par = 0;


      if( !(((t)->os1.ou1.os11.otype) == 11 || ((t)->os1.ou1.os11.otype) == 12) )
      { Error(5, 33, "symbol name expected here", 2, &(t)->os1.ou1.ofpos);
                                                       ;
 UnSuppressScope();
 *token = t;
 return;
      }
      res = InsertSym((t)->os1.ostring, res_type, &(t)->os1.ou1.ofpos, 100,
  0, 0, 0, curr_encl, ( (OBJECT) ((void*)0) ));
      if( curr_encl != encl ) (res)->os1.ou2.os26.ovisible = 1;
      if( has_import_encl )
      {
 (res)->os1.ou2.os26.oimports_encl = 1;
                                                                  ;
      }
      if( compulsory_par )
 ...
 (res)->os6.ois_compulsory = 1;
      ...
      while( (((t)->os1.ou1.os11.otype) == 11 || ((t)->os1.ou1.os11.otype) == 12) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("named") )))==0) ) &&
 !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("import") )))==0) ) &&
 !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("force") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("into") )))==0) ) &&
 !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("horizontally") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("precedence") )))==0) ) &&
 !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("associativity") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("left") )))==0) ) &&
 !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("right") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("body") )))==0) ) &&
 !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("{") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("@Begin") )))==0) ) )
      {
 InsertAlternativeName((t)->os1.ostring, res, &(t)->os1.ou1.ofpos);
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
      }
      ...
      if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("force") )))==0) ) )
      { (res)->os1.ou2.os26.oforce_target = 1;
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
 if( !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("into") )))==0) ) && !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("horizontally") )))==0) ) )
    Error(5, 34, "%s expected here", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("into") ));
      }


      if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("horizontally") )))==0) ) )
      { (res)->os1.ou2.os26.ohoriz_galley = 0;
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
      ...
      res_target = ( (OBJECT) ((void*)0) );
      if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("into") )))==0) ) )
      { UnSuppressScope();
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
 if( (t)->os1.ou1.os11.otype != 102 )
 { Error(5, 36, "%s expected here", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("{") ));
                                                         ;
   UnSuppressScope();
   *token = t;
   return;
 }
 res_target = Parse(&t, curr_encl, 0, 0);
 SuppressScope();
 if( t == ( (OBJECT) ((void*)0) ) ) t = LexGetToken();
      }


      if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("precedence") )))==0) ) )
      { int prec = 0;
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
 t = LexGetToken();
 while( (t)->os1.ou1.os11.otype == 11 && ( ((t)->os1.ostring[0]) >= '0' && ((t)->os1.ostring[0]) <= '9' ) )
 {
   prec = prec * 10 + ( ((t)->os1.ostring[0]) - '0' );
   { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
 }

 if( prec < 10 )
 { Error(5, 37, "precedence is too low (%d substituted)",
     2, &(t)->os1.ou1.ofpos, 10);
   prec = 10;
 }
 else if( prec > 100 )
 { Error(5, 38, "precedence is too high (%d substituted)",
     2, &(t)->os1.ou1.ofpos, 100);
   prec = 100;
 }
 (res)->os1.ou2.os21.oprecedence = prec;
      }


      if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("associativity") )))==0) ) )
      { { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
 if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("left") )))==0) ) ) (res)->os1.ou2.os26.oright_assoc = 0;
 else if( !((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("right") )))==0) ) )
   Error(5, 39, "associativity altered to %s", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("right") ));
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
      }


      if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("left") )))==0) ) )
      { { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
 if( (t)->os1.ou1.os11.otype != 11 )
 { Error(5, 40, "cannot find %s parameter name", 2, &(t)->os1.ou1.ofpos, ( (FULL_CHAR *) ("left") ));
                                                         ;
   UnSuppressScope();
   *token = t;
   return;
 }
 InsertSym((t)->os1.ostring, 144, &(t)->os1.ou1.ofpos, 100,
   0, 0, 0, res, ( (OBJECT) ((void*)0) ));
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
      }


      UnSuppressScope();
      ReadDefinitions(&t, res, 145);


      if( ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("right") )))==0) ) || ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("body") )))==0) ) )
      { (res)->os1.ou2.os26.ohas_body = ((t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("body") )))==0) );
 SuppressScope();
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
 if( (t)->os1.ou1.os11.otype != 11 )
 { Error(5, 41, "cannot find %s parameter name", 2,&(t)->os1.ou1.ofpos,( (FULL_CHAR *) ("right") ));
                                                         ;
   UnSuppressScope();
   *token = t;
   return;
 }
 InsertSym((t)->os1.ostring, 146, &(t)->os1.ou1.ofpos, 100,
   0, 0, 0, res, ( (OBJECT) ((void*)0) ));
 UnSuppressScope();
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; }; t = LexGetToken();
      }
      ...
      if( res_target != ( (OBJECT) ((void*)0) ) )
 InsertSym(( (FULL_CHAR *) ("@Target") ), 143, &(res_target)->os1.ou1.ofpos, 100,
   0, 0, 0, res, res_target);
      if( (t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("{") )))==0) )
      { z = NewToken(102, &(t)->os1.ou1.ofpos, 0, 0, 3, StartSym);
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
 t = z;
      }
      else if( (t)->os1.ou1.os11.otype == 11 && (strcmp((char *)((t)->os1.ostring), (char *)(( (FULL_CHAR *) ("@Begin") )))==0) )
      { z = NewToken(104, &(t)->os1.ou1.ofpos, 0, 0, 1, StartSym);
 { zz_hold = (t); { ; zz_hold = (zz_hold); zz_size = ((((zz_hold)->os1.ou1.os11.otype) == 11 || ((zz_hold)->os1.ou1.os11.otype) == 12) ? (zz_hold)->os1.ou1.os11.orec_size : zz_lengths[(zz_hold)->os1.ou1.os11.otype]); ; (zz_hold)->os1.olist[0].opred = zz_free[zz_size]; zz_free[zz_size] = zz_hold; }; ; };
 t = z;
      }
      else if( (t)->os1.ou1.os11.otype != 102 && (t)->os1.ou1.os11.otype != 104 )
 Error(5, 42, "opening left brace or @Begin of %s expected",
   1, &(t)->os1.ou1.ofpos, SymName(res));
      if( (t)->os1.ou1.os11.otype == 104 ) (t)->os2.oactual = res;
      PushScope(res, 0, 0);
      BodyParAllowed();
      (res)->os6.osym_body = Parse(&t, res, 1, 0);


      for( link=(export_list)->os1.olist[0].osucc; link != export_list; link=(link)->os1.olist[0].osucc )
      { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
 z = SearchSym((y)->os1.ostring, strlen((char *)((y)->os1.ostring)));
 if( z == ( (OBJECT) ((void*)0) ) || (z)->os6.oenclosing != res )
   Error(5, 43, "exported symbol %s is not defined in %s",
     2, &(y)->os1.ou1.ofpos, (y)->os1.ostring, SymName(res));
 else if( (res)->os1.ou2.os26.ohas_body && (z)->os1.ou1.os11.otype == 146 )
   Error(5, 44, "body parameter %s may not be exported",
     2, &(y)->os1.ou1.ofpos, (y)->os1.ostring);
 else if( (z)->os1.ou2.os26.ovisible )
   Error(5, 45, "symbol %s exported twice", 2, &(y)->os1.ou1.ofpos, (y)->os1.ostring);
 else (z)->os1.ou2.os26.ovisible = 1;
      }
    ...
    for( link=(import_list)->os1.olist[0].osucc; link != import_list; link=(link)->os1.olist[0].osucc )
    {
      PopScope();
    }
    if( (import_list)->os1.olist[0].osucc == import_list || curr_encl != encl )
    { DisposeObject(import_list);
      import_list = ( (OBJECT) ((void*)0) );
    }
    else
    {
      (res)->os6.oimports = import_list;
    }
