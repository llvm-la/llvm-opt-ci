# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z31.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z31.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z31.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z31.c" 2
# 153 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z31.c"
OBJECT zz_free[( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 )], zz_hold, zz_tmp, zz_res;
int zz_size;
unsigned char zz_lengths[150];
OBJECT xx_link, xx_tmp, xx_res, xx_hold;
# 167 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z31.c"
void MemInit(void)
{
  zz_lengths[ 11 ] = 0;
  zz_lengths[ 12 ] = 0;
  zz_lengths[ 0 ] = ( ((sizeof(struct link_type)) - 1)/(sizeof(ALIGN)) + 1 );
  ...
  zz_lengths[ 98 ] =
  zz_lengths[ 99 ] =
 ( ((sizeof(struct closure_type)) - 1)/(sizeof(ALIGN)) + 1 );

  zz_lengths[ 8 ] =
 ( ((sizeof(struct head_type)) - 1)/(sizeof(ALIGN)) + 1 );
 ...
 ( ((sizeof(struct closure_type)) - 1)/(sizeof(ALIGN)) + 1 );
  ...
  zz_lengths[ 146 ] =
  zz_lengths[ 145 ] =
 ( ((sizeof(struct symbol_type)) - 1)/(sizeof(ALIGN)) + 1 );


  zz_lengths[ 100 ] =
  zz_lengths[ 101 ] =
  zz_lengths[ 1 ] =
 ( ((sizeof(struct gapobj_type)) - 1)/(sizeof(ALIGN)) + 1 );


  zz_lengths[ 140 ] =
  zz_lengths[ 141 ] = ( ((sizeof(struct cr_type)) - 1)/(sizeof(ALIGN)) + 1 );


  zz_lengths[ 147 ] = ( ((sizeof(struct ext_gall_type)) - 1)/(sizeof(ALIGN)) + 1 );

}
# 344 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z31.c"
OBJECT GetMemory(int siz, FILE_POS *pos)
{ static ALIGN *next_free = (ALIGN *) ( (OBJECT) ((void*)0) );
  static ALIGN *top_free = (ALIGN *) ( (OBJECT) ((void*)0) );
  OBJECT res;
  ...
  if( !next_free || &next_free[siz] > top_free )
  {
    ...
    next_free = (ALIGN *) calloc(1020, sizeof(ALIGN));

    if( next_free == ((void*)0) )
      Error(31, 1, "exiting now (run out of memory)", 1, pos);
    top_free = &next_free[1020];
