# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c" 2
# 51 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
typedef struct
{ int coltab_size;
  int coltab_count;
  struct coltab_rec
...
# 72 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
...
{ COLOUR_TABLE S; int i;
  ...
  if( S == (COLOUR_TABLE) ((void*)0) )
    Error(42, 1, "ran out of memory when enlarging colour table",
      1, no_fpos);
  (S)->coltab_size = newsize;
  (S)->coltab_count = 0;
  for( i = 0; i < newsize; i++ )
  { (S)->coltab[i].by_number = (S)->coltab[i].by_name_hash = ( (OBJECT) ((void*)0) );
  }
  return S;
}
...
{ COLOUR_TABLE NewS; int i;
  ...
  for( i = 1; i <= (S)->coltab_count; i++ )
     ctab_insert((S)->coltab[i].by_number, &NewS);
  for( i = 0; i < (S)->coltab_size; i++ )
  { if( (S)->coltab[i].by_name_hash != ( (OBJECT) ((void*)0) ) ) DisposeObject((S)->coltab[i].by_name_hash);
  }
...
# 161 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
static COLOUR_TABLE col_tab;
# 171 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
void ColourInit(void)
{ col_tab = ctab_new(100);
}
# 184 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
...
{ OBJECT cname;
  ...
  { Error(42, 3, "%s ignored (illegal left parameter)", 2, &(x)->os1.ou1.ofpos,
      ( (FULL_CHAR *) ("@SetColour") ));
                                                               ;
    return;
  }
  ...
  { if( BackEnd->colour_avail )
      Error(42, 4, "%s ignored (empty left parameter)", 2, &(x)->os1.ou1.ofpos,
        ( (FULL_CHAR *) ("@SetColour") ));
                                                               ;
    return;
  }
  ...
  if( (strcmp((char *)((x)->os1.ostring), (char *)(( (FULL_CHAR *) ("nochange") )))==0) )
  { ;
    return;
  }


  { cname = ctab_retrieve((x)->os1.ostring, col_tab);
    if( cname == ( (OBJECT) ((void*)0) ) )
    { cname = MakeWord((x)->os1.ou1.os11.otype, (x)->os1.ostring, &(x)->os1.ou1.ofpos);
      ctab_insert(cname, &col_tab);
      (*style).ocolour = (cname)->os1.ou2.os22.oword_colour;
    }
    else (*style).ocolour = (cname)->os1.ou2.os22.oword_colour;
  }

                                                                       ;
                                               ;
}
# 234 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z42.c"
FULL_CHAR *ColourCommand(COLOUR_NUM cnum)
{ FULL_CHAR *res;
                                           ;
  { if( !(cnum > 0 && cnum <= (col_tab)->coltab_count) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "ColourCommand: number"); };

  res = ((col_tab)->coltab[cnum].by_number)->os1.ostring;
