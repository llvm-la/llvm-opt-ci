# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c" 2
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c" 2
...
# 38 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c" 2
# 48 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
void MinConstraint(CONSTRAINT *xc, CONSTRAINT *yc)
{ (*xc).obc = (((*xc).obc) < ((*yc).obc) ? ((*xc).obc) : ((*yc).obc));
  (*xc).obfc = (((*xc).obfc) < ((*yc).obfc) ? ((*xc).obfc) : ((*yc).obfc));
  (*xc).ofc = (((*xc).ofc) < ((*yc).ofc) ? ((*xc).ofc) : ((*yc).ofc));
}
# 64 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
void SetSizeToMaxForwardConstraint(FULL_LENGTH *b, FULL_LENGTH *f, CONSTRAINT *c)
{
  *f = (((*c).obfc) < ((*c).ofc) ? ((*c).obfc) : ((*c).ofc));
  *b = (((*c).obc) < ((*c).obfc - *f) ? ((*c).obc) : ((*c).obfc - *f));
}
# 79 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
void EnlargeToConstraint(FULL_LENGTH *b, FULL_LENGTH *f, CONSTRAINT *c)
{
  *f = (((*c).obfc - *b) < ((*c).ofc) ? ((*c).obfc - *b) : ((*c).ofc));
}
# 105 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
int ScaleToConstraint(FULL_LENGTH b, FULL_LENGTH f, CONSTRAINT *c)
{ float scale_factor; int res;

                                     ;
  scale_factor = 1.0;
  if( b > 0 ) scale_factor = ((scale_factor) < ((float) (*c).obc/b) ? (scale_factor) : ((float) (*c).obc/b));
  if( b + f > 0 ) scale_factor = ((scale_factor) < ((float) (*c).obfc/(b + f)) ? (scale_factor) : ((float) (*c).obfc/(b + f)));
  if( f > 0 ) scale_factor = ((scale_factor) < ((float) (*c).ofc/f) ? (scale_factor) : ((float) (*c).ofc/f));
  res = scale_factor * 128;
                                                                             ;
  return res;
}
# 127 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
void InvScaleConstraint(CONSTRAINT *yc, FULL_LENGTH sf, CONSTRAINT *xc)
{
                                                          ...
                                                          ;
                                                                             ;
  { if( !(sf > 0) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "InvScaleConstraint: sf <= 0!"); };
  (*yc).obc = (*xc).obc == 8388607 ? 8388607 :
    ((8388607) < ((*xc).obc * 128 / sf) ? (8388607) : ((*xc).obc * 128 / sf));
  (*yc).obfc = (*xc).obfc == 8388607 ? 8388607 :
    ((8388607) < ((*xc).obfc* 128 / sf) ? (8388607) : ((*xc).obfc* 128 / sf));
  (*yc).ofc = (*xc).ofc == 8388607 ? 8388607 :
    ((8388607) < ((*xc).ofc * 128 / sf) ? (8388607) : ((*xc).ofc * 128 / sf));
                                                                        ;
}
# 153 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
...
{ float cs, sn;
  ...
  if( fabs(cs) < 1e-6 )
    ((*xc).obc = (8388607), (*xc).obfc = (8388607), (*xc).ofc = (8388607));
  else
    ((*xc).obc = (((8388607) < (((*yc).obc - u * sn) / cs) ? (8388607) : (((*yc).obc - u * sn) / cs))), (*xc).obfc = (((8388607) < (((*yc).obfc - u * sn - v * sn) / cs) ? (8388607) : (((*yc).obfc - u * sn - v * sn) / cs))), (*xc).ofc = (((8388607) < (((*yc).ofc - v * sn) / cs) ? (8388607) : (((*yc).ofc - v * sn) / cs))));



                                                                          ;
}
# 187 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
...
{ CONSTRAINT c1, c2, c3, dc; float theta, psi;
  ...
  theta = (float) angle * 2 * 3.14159265358979323846 / (float) (128 * 360);
  while( theta < 0 ) theta += 2 * 3.14159265358979323846;
  while( theta >= 2 * 3.14159265358979323846 ) theta -= 2 * 3.14159265358979323846;
  { if( !(0 <= theta && theta <= 2 * 3.14159265358979323846) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "RotateConstraint: theta!"); };


  if( theta <= 3.14159265358979323846 / 2.0 )
  { theta = theta;
    ((c1).obc = (*hc).obc, (c1).obfc = (*hc).obfc, (c1).ofc = (*hc).ofc);
    ((c2).obc = (*vc).obc, (c2).obfc = (*vc).obfc, (c2).ofc = (*vc).ofc);
  }
  else if ( theta <= 3.14159265358979323846 )
  { theta -= 3.14159265358979323846 / 2.0;
    ((c1).obc = ((*vc).ofc), (c1).obfc = ((*vc).obfc), (c1).ofc = ((*vc).obc));
    ((c2).obc = (*hc).obc, (c2).obfc = (*hc).obfc, (c2).ofc = (*hc).ofc);
  }
  else if ( theta <= 3.0 * 3.14159265358979323846 / 2.0 )
  { theta -= 3.14159265358979323846;
    ((c1).obc = ((*hc).ofc), (c1).obfc = ((*hc).obfc), (c1).ofc = ((*hc).obc));
    ((c2).obc = ((*vc).ofc), (c2).obfc = ((*vc).obfc), (c2).ofc = ((*vc).obc));
  }
  else
  { theta -= 3.0 * 3.14159265358979323846 / 2.0;
    ((c1).obc = (*vc).obc, (c1).obfc = (*vc).obfc, (c1).ofc = (*vc).ofc);
    ((c2).obc = ((*hc).ofc), (c2).obfc = ((*hc).obfc), (c2).ofc = ((*hc).obc));
  }
  psi = 3.14159265358979323846 / 2.0 - theta;
                                                                                ;


  if( dim == 0 )
  { SemiRotateConstraint(c, (y)->os1.ou3.os31.oback[1], (y)->os1.ou3.os31.ofwd[1], theta, &c1);
    ((c3).obc = ((c2).ofc), (c3).obfc = ((c2).obfc), (c3).ofc = ((c2).obc));
    SemiRotateConstraint(&dc, (y)->os1.ou3.os31.ofwd[1], (y)->os1.ou3.os31.oback[1], psi, &c3);
    MinConstraint(c, &dc);
  }
  else
  { SemiRotateConstraint(c, (y)->os1.ou3.os31.oback[0], (y)->os1.ou3.os31.ofwd[0], psi, &c1);
    SemiRotateConstraint(&dc, (y)->os1.ou3.os31.ofwd[0], (y)->os1.ou3.os31.oback[0], theta, &c2);
    MinConstraint(c, &dc);
  }

                                                                     ;
}
# 253 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
unsigned InsertScale(OBJECT x, CONSTRAINT *c)
{ int scale_factor; OBJECT prnt;
  scale_factor = ScaleToConstraint((x)->os1.ou3.os31.oback[0], (x)->os1.ou3.os31.ofwd[0], c);
  if( scale_factor >= 0.2 * 128 )
  {
    { ; { ; if( (zz_size=(zz_lengths[34])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 34; ; prnt = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
    (prnt)->os1.ou2.os22.ounderline = (x)->os1.ou2.os22.ounderline;
    ( ((prnt)->os1.ou1.ofpos).ofile_num = ((x)->os1.ou1.ofpos).ofile_num, ((prnt)->os1.ou1.ofpos).oline_num = ((x)->os1.ou1.ofpos).oline_num, ((prnt)->os1.ou1.ofpos).ocol_num = ((x)->os1.ou1.ofpos).ocol_num );


    ((prnt)->os2.ou4.oconstraint).obc = scale_factor;
    (prnt)->os1.ou3.os31.oback[0] = ( (x)->os1.ou3.os31.oback[0] * scale_factor ) / 128;




    (prnt)->os1.ou3.os31.ofwd[0] = (((*c).obfc - (prnt)->os1.ou3.os31.oback[0]) < ((*c).ofc) ? ((*c).obfc - (prnt)->os1.ou3.os31.oback[0]) : ((*c).ofc));


    ((prnt)->os2.ou4.oconstraint).ofc = 1 * 128;
    (prnt)->os1.ou3.os31.oback[1] = (x)->os1.ou3.os31.oback[1];
    (prnt)->os1.ou3.os31.ofwd[1] = (x)->os1.ou3.os31.ofwd[1];


    ( xx_tmp = ( zz_hold = ((x)), (zz_hold)->os1.olist[1].osucc == zz_hold ? ( (OBJECT) ((void*)0) ) : ( zz_res = (zz_hold)->os1.olist[1].osucc, (zz_res)->os1.olist[1].opred = (zz_hold)->os1.olist[1].opred, ((zz_hold)->os1.olist[1].opred)->os1.olist[1].osucc = zz_res, (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold, zz_res ) ), ( zz_res = ((prnt)), zz_hold = (xx_tmp), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ) );
    { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((prnt)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((x)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    return 1;
  }
  else return 0;
}
# 310 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
static void CatConstrained(OBJECT x, CONSTRAINT *xc, unsigned ratm,
OBJECT y, int dim, OBJECT *why)
{ int side;
  CONSTRAINT yc;
  FULL_LENGTH backy, fwdy;
  FULL_LENGTH be, fe;
  ...
  if( ((yc).obc != 8388607 || (yc).obfc != 8388607 || (yc).ofc != 8388607) )
  {
    ...
    be = pg == ( (OBJECT) ((void*)0) ) ? 0 : ExtraGap((prec_def)->os1.ou3.os31.ofwd[dim], 0, &(pg)->os5.ogap, 151);
    fe = sg == ( (OBJECT) ((void*)0) ) ? 0 : ExtraGap(0, (sd)->os1.ou3.os31.oback[dim], &(sg)->os5.ogap, 153);

    if( (((x)->os1.ou1.os11.otype) >= 2 && ((x)->os1.ou1.os11.otype) <= 8) )
    {

      beffect = pg==( (OBJECT) ((void*)0) ) ? 0 : MinGap((prec_def)->os1.ou3.os31.ofwd[dim], 0, 0, &(pg)->os5.ogap);
      feffect = sg==( (OBJECT) ((void*)0) ) ? 0 : MinGap(0, (sd)->os1.ou3.os31.oback[dim], (sd)->os1.ou3.os31.ofwd[dim], &(sg)->os5.ogap);
      seffect = pg==( (OBJECT) ((void*)0) ) ?
   sg == ( (OBJECT) ((void*)0) ) ? 0 : (sd)->os1.ou3.os31.oback[dim] :
   sg == ( (OBJECT) ((void*)0) ) ? (prec_def)->os1.ou3.os31.ofwd[dim] :
     MinGap((prec_def)->os1.ou3.os31.ofwd[dim], (sd)->os1.ou3.os31.oback[dim], (sd)->os1.ou3.os31.ofwd[dim], &(sg)->os5.ogap);

      switch( side )
      {
 case 151: backy = (y)->os1.ou3.os31.oback[dim] + beffect + feffect - seffect;
   fwdy = (y)->os1.ou3.os31.ofwd[dim];
   break;

 case 152:
   backy = 0;
   fwdy = (y)->os1.ou3.os31.ofwd[dim] + feffect;
   break;

 case 153: backy = (y)->os1.ou3.os31.oback[dim];
   fwdy = (y)->os1.ou3.os31.ofwd[dim] + beffect + feffect - seffect;
   break;
      }
    }
    ...
    { beffect = pg == ( (OBJECT) ((void*)0) ) ? (x)->os1.ou3.os31.oback[dim] :
 MinGap((prec_def)->os1.ou3.os31.ofwd[dim], (x)->os1.ou3.os31.oback[dim], (x)->os1.ou3.os31.ofwd[dim], &(pg)->os5.ogap) -
 MinGap((prec_def)->os1.ou3.os31.ofwd[dim], 0, 0, &(pg)->os5.ogap);

      feffect = sg == ( (OBJECT) ((void*)0) ) ? (x)->os1.ou3.os31.ofwd[dim] :
 MinGap((x)->os1.ou3.os31.ofwd[dim], (sd)->os1.ou3.os31.oback[dim], (sd)->os1.ou3.os31.ofwd[dim], &(sg)->os5.ogap) -
 MinGap(0, (sd)->os1.ou3.os31.oback[dim], (sd)->os1.ou3.os31.ofwd[dim], &(sg)->os5.ogap);

      switch( side )
      {
 case 151: backy = (y)->os1.ou3.os31.oback[dim] - beffect - feffect;
   fwdy = (y)->os1.ou3.os31.ofwd[dim];
   break;

 case 152: backy = (y)->os1.ou3.os31.oback[dim] - beffect;
   fwdy = (y)->os1.ou3.os31.ofwd[dim] - feffect;
   break;

 case 153: backy = (y)->os1.ou3.os31.oback[dim];
   fwdy = (y)->os1.ou3.os31.ofwd[dim] - beffect - feffect;
   break;
      }
    }
    ...
    if( !(backy <= (yc).obc && backy + fwdy <= (yc).obfc && fwdy <= (yc).ofc) )
      ((*xc).obc = (-1), (*xc).obfc = (-1), (*xc).ofc = (-1));
    else switch( side )
    {

      case 151:

 tbc = (yc).obc == 8388607 ? 8388607 : (yc).obc - backy;
 tbfc = (yc).obfc == 8388607 ? 8388607 : (yc).obfc - backy - fwdy;
 mxy = ((tbc) < (tbfc) ? (tbc) : (tbfc));
 tb = ((8388607) < (be + mxy) ? (8388607) : (be + mxy));
 tbf = ((8388607) < (be + fe + mxy) ? (8388607) : (be + fe + mxy));
 tf = ((8388607) < (fe + mxy) ? (8388607) : (fe + mxy));
 ((*xc).obc = (tb), (*xc).obfc = (tbf), (*xc).ofc = (tf));
 break;
 ...
 tbc = (yc).obc == 8388607 ? 8388607 : (yc).obc - backy;
 tbfc = (yc).obfc == 8388607 ? 8388607 : (yc).obfc - backy - fwdy;
 tfc = (yc).ofc == 8388607 ? 8388607 : (yc).ofc - fwdy;
 mxy = ((tbc) < (tbfc) ? (tbc) : (tbfc));
 myz = ((tfc) < (tbfc) ? (tfc) : (tbfc));
 tb = ((8388607) < (be + mxy) ? (8388607) : (be + mxy));
 tbf = ((8388607) < (be + fe + tbfc) ? (8388607) : (be + fe + tbfc));
 tf = ((8388607) < (fe + myz) ? (8388607) : (fe + myz));
 ((*xc).obc = (tb), (*xc).obfc = (tbf), (*xc).ofc = (tf));
 break;
 ...
 break;
  ...
  else ((*xc).obc = (8388607), (*xc).obfc = (8388607), (*xc).ofc = (8388607));
}
# 450 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
void Constrained(OBJECT x, CONSTRAINT *xc, int dim, OBJECT *why)
{ OBJECT y, link, lp, rp, z, tlink, g; CONSTRAINT yc, hc, vc;
  unsigned ratm; FULL_LENGTH xback, xfwd; int tb, tf, tbf, tbc, tfc;
  SetLengthDim(dim);

                               ;
                                  ;
  { if( !((x)->os1.olist[1].osucc != x) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Constrained: x has no parent!"); };



  if( (x)->os1.ou1.os11.otype == 2 && ((dim==1 && (x)->os1.ou2.os23.oexternal_ver) || (x)->os1.ou2.os23.oexternal_hor) )
  {
    ((*xc).obc = (8388607), (*xc).obfc = (8388607), (*xc).ofc = (8388607));
                                                                               ;
    return;
  ...
  link = ( (dim) == 0 ? (x)->os1.olist[1].osucc : (x)->os1.olist[1].opred ); ratm = 0;
  for( tlink = (link)->os1.olist[0].osucc; (tlink)->os1.ou1.os11.otype == 0; tlink = (tlink)->os1.olist[0].osucc )
  { for( g = (tlink)->os1.olist[1].opred; (g)->os1.ou1.os11.otype == 0; g = (g)->os1.olist[1].opred );
    if( (g)->os1.ou1.os11.otype == 1 && ((g)->os5.ogap).omark ) ratm = 1;
  }
  y = tlink;
                                                   ;
                                   ;
  ...
  switch( (y)->os1.ou1.os11.otype )
  {
    ...
    case 31:
      ...
      if( (dim == 0) != ((y)->os1.ou1.os11.otype == 30) ) Constrained(y, xc, dim, why);
      else ((*xc).obc = (8388607), (*xc).obfc = (8388607), (*xc).ofc = (8388607));
      break;
    ...
    case 33:
      ...
      if( (dim == 0) != ((y)->os1.ou1.os11.otype == 32) ) Constrained(y, xc, dim, why);
      else ((*xc).obc = (8388607), (*xc).obfc = (8388607), (*xc).ofc = (8388607));
      break;
    ...
    case 34:
      ...
      Constrained(y, &yc, dim, why);
      if( dim == 0 && ((y)->os2.ou4.oconstraint).obc == 0 )
      {
 ...
 ((*xc).obc = (8388607), (*xc).obfc = (8388607), (*xc).ofc = (8388607));
   ...
   dim == 0 ? ((y)->os2.ou4.oconstraint).obc : ((y)->os2.ou4.oconstraint).ofc, &yc);
      }
      break;
    ...
    case 50:
      ...
      Constrained(y, &hc, 0, why); Constrained(y, &vc, 1, why);
      RotateConstraint(xc, x, ((y)->os2.ou4.oconstraint).osparec, &hc, &vc, dim);
      break;
    ...
    case 27:
      ...
      Constrained(y, xc, dim, why);
      if( ((y)->os1.ou1.os11.otype==26) == (dim==0) )
      { MinConstraint(xc, &(y)->os2.ou4.oconstraint);
 *why = y;
      }
      break;
    ...
    case 39:
      ...
      if( ((y)->os1.ou1.os11.otype == 38) == (dim == 0) )
      {
 unsigned still_searching = 1;
 z = y;
 ((*xc).obc = ((z)->os1.ou3.os31.oback[dim]), (*xc).obfc = (((z)->os1.ou3.os31.oback[dim] + (z)->os1.ou3.os31.ofwd[dim])), (*xc).ofc = ((z)->os1.ou3.os31.ofwd[dim]));
                                                                  ;
 while( still_searching && (z)->os1.olist[1].osucc != z )
 {
          for( z = (( (dim) == 0 ? (z)->os1.olist[1].osucc : (z)->os1.olist[1].opred ))->os1.olist[0].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[0].opred );
   switch( (z)->os1.ou1.os11.otype )
   {
     ...
     case 14:
       ...
       ((*xc).obc = ((z)->os2.ou4.oconstraint).obc, (*xc).obfc = ((z)->os2.ou4.oconstraint).obfc, (*xc).ofc = ((z)->os2.ou4.oconstraint).ofc);
 ...
 *why = y;
    ...
    case 13:
      ...
      ((*xc).obc = ((y)->os2.ou4.oconstraint).obc, (*xc).obfc = ((y)->os2.ou4.oconstraint).obfc, (*xc).ofc = ((y)->os2.ou4.oconstraint).ofc);
                                                                                   ;
    ...
    case 29:
      ...
      if( ((y)->os1.ou1.os11.otype == 28) == (dim == 0) )
      { Constrained(y, &yc, dim, why);
 tf = FindShift(y, x, dim);
 ((*xc).obc = ((((yc).obc) < ((yc).obfc) ? ((yc).obc) : ((yc).obfc)) - tf), (*xc).obfc = ((yc).obfc), (*xc).ofc = ((((yc).ofc) < ((yc).obfc) ? ((yc).ofc) : ((yc).obfc)) + tf));
 ...
 ((*xc).obc = (8388607), (*xc).obfc = (8388607), (*xc).ofc = (8388607));
      ...
      { ((yc).obc = ((y)->os2.ou4.oconstraint).obc, (yc).obfc = ((y)->os2.ou4.oconstraint).obfc, (yc).ofc = ((y)->os2.ou4.oconstraint).ofc);
                                                            ;
                                 ;
 goto REST_OF_HEAD;
      }
    ...
    case 15:
      ...
      { if( !(((y)->os1.ou1.os11.otype==16) == (dim==0)) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "Constrained: COL_THR!"); };
      Constrained(y, &yc, dim, why);
      tb = (yc).obfc == 8388607 ? 8388607 : (yc).obfc - (y)->os1.ou3.os31.ofwd[dim];
      tb = (((yc).obc) < (tb) ? ((yc).obc) : (tb));
      tf = (yc).obfc == 8388607 ? 8388607 : (yc).obfc - (y)->os1.ou3.os31.oback[dim];
      tf = (((yc).ofc) < (tf) ? ((yc).ofc) : (tf));
      ((*xc).obc = (tb), (*xc).obfc = ((yc).obfc), (*xc).ofc = (tf));
      break;
    ...
    case 17:
      ...
      if( ((y)->os1.ou1.os11.otype==19) == (dim==1) )
 ...
 for( lp = (link)->os1.olist[0].opred; lp != y; lp = (lp)->os1.olist[0].opred )
 { for( z = (lp)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
   if( (z)->os1.ou1.os11.otype == 1 && !((z)->os5.ogap).ojoin ) break;
 }
 for( rp = (link)->os1.olist[0].osucc; rp != y; rp = (rp)->os1.olist[0].osucc )
 { for( z = (rp)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
   if( (z)->os1.ou1.os11.otype == 1 && !((z)->os5.ogap).ojoin ) break;
 }
 if( lp == y && rp == y && !((y)->os1.ou1.os11.otype == 8 && (y)->os1.ou2.os23.oblocked) )
 {
 ...
 else
 {
   ...
   xback = xfwd = 0;
   for(link = (lp)->os1.olist[0].osucc; link != rp; link = (link)->os1.olist[0].osucc )
   { for( z = (link)->os1.olist[1].opred; (z)->os1.ou1.os11.otype == 0; z = (z)->os1.olist[1].opred );
     if( (z)->os1.ou1.os11.otype == 1 || (((z)->os1.ou1.os11.otype) >= 119 && ((z)->os1.ou1.os11.otype) <= 138) ) continue;
     xback = ((xback) < ((z)->os1.ou3.os31.oback[dim]) ? ((z)->os1.ou3.os31.oback[dim]) : (xback));
     xfwd = ((xfwd) < ((z)->os1.ou3.os31.ofwd[dim]) ? ((z)->os1.ou3.os31.ofwd[dim]) : (xfwd));
   }

                                       ;
   tbf = (((yc).obfc) < ((yc).ofc) ? ((yc).obfc) : ((yc).ofc));
   tbc = tbf == 8388607 ? 8388607 : tbf - xfwd;
   tfc = tbf == 8388607 ? 8388607 : tbf - xback;
   ((*xc).obc = (tbc), (*xc).obfc = (tbf), (*xc).ofc = (tfc));
 }
      }
      break;
    ...
    default:
      ...
      { if( !(0) ) Error(1, 3, "assert failed in %s %s", 0,no_fpos,"Constrained:", Image((y)->os1.ou1.os11.otype)); };
      break;
