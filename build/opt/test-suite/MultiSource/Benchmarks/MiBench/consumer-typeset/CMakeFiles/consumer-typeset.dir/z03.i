# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c" 2
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c" 2
...
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c" 2
# 66 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
typedef struct
{ int filetab_size;
  int filetab_count;
  struct filetab_rec
...
# 87 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
static FILE_TABLE ftab_new(int newsize)
{ FILE_TABLE S; int i;

                                                          ;
  S = (FILE_TABLE) malloc(2*sizeof(int) + newsize * sizeof(struct filetab_rec));
  if( S == (FILE_TABLE) ((void*)0) )
    Error(3, 1, "run out of memory when enlarging file table", 1, no_fpos);
  (S)->filetab_size = newsize;
  (S)->filetab_count = 0;
  for( i = 0; i < newsize; i++ )
  { (S)->filetab[i].by_number = (S)->filetab[i].by_name_hash = ( (OBJECT) ((void*)0) );
  }
  return S;
}
...
{ FILE_TABLE NewS; int i;
  ...
  for( i = 1; i <= (S)->filetab_count; i++ )
     ftab_insert((S)->filetab[i].by_number, &NewS);
  for( i = 0; i < (S)->filetab_size; i++ )
  { if( (S)->filetab[i].by_name_hash != ( (OBJECT) ((void*)0) ) ) DisposeObject((S)->filetab[i].by_name_hash);
  }
...
# 180 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
static OBJECT empty_path;
static FILE_TABLE file_tab;
static OBJECT file_type[11];
static OBJECT file_path[8];
static char *file_mode[11] =
{ "r", "r", "r", "r", "r", "r",
  "r", "r", "r", "r", "r" };
# 197 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
static FILE_POS no_file_pos = {0, 0, 0, 0, 0};
FILE_POS *no_fpos = &no_file_pos;
# 209 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
void InitFiles(void)
{ int i; OBJECT tmp;
  for( i = 0; i < 11; i++ ) { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; file_type[i] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  for( i = 0; i < 8; i++ ) { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; file_path[i] = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  file_tab = ftab_new(3);
  { ; { ; if( (zz_size=(zz_lengths[17])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 17; ; empty_path = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; };
  tmp = MakeWord(11, ( (FULL_CHAR *) ("") ), no_fpos);
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((empty_path)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((tmp)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
}
# 228 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
void AddToPath(int fpath, OBJECT dirname)
{ { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((file_path[fpath])), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((dirname)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
}
# 242 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FILE_NUM DefineFile(FULL_CHAR *str, FULL_CHAR *suffix,
FILE_POS *xfpos, int ftype, int fpath)
{ register int i;
  OBJECT fname;
  { if( !(ftype < 11) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "DefineFile: ftype!"); };

                                                              ;
  if( ftype == 0 && (i = strlen((char *)(str))) >= 3 )
  {

    if( (strcmp((char *)(&str[i-strlen((char *)(( (FULL_CHAR *) (".ld") )))]), (char *)(( (FULL_CHAR *) (".ld") )))==0) )
      Error(3, 3, "database file %s where source file expected",
        1, xfpos, str);
    if( (strcmp((char *)(&str[i-strlen((char *)(( (FULL_CHAR *) (".li") )))]), (char *)(( (FULL_CHAR *) (".li") )))==0) )
      Error(3, 4, "database index file %s where source file expected",
        1, xfpos, str);
  }
  if( strlen((char *)(str)) + strlen((char *)(suffix)) >= 2048 )
    Error(3, 5, "file name %s%s is too long", 1, no_fpos, str, suffix);
  fname = MakeWordTwo(11, str, suffix, xfpos);
  { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((file_type[ftype])), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((fname)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
  (fname)->os1.ou3.os31.oback[0] = fpath;
  (fname)->os1.ou3.os31.ofwd[0] = 0;
  (fname)->os1.ou3.os31.ofwd[1] = 0;
  (fname)->os1.ou2.os22.oword_colour = ftype;
  (fname)->os1.ou2.os22.oword_hyph = 0;
  ftab_insert(fname, &file_tab);
                                                           ;
                                                ;
  return (fname)->os1.ou2.os22.oword_font;
}
# 283 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FILE_NUM FirstFile(int ftype)
{ FILE_NUM i;
  OBJECT link, y;
                                                       ;
  link = (file_type[ftype])->os1.olist[0].osucc;
  if( (link)->os1.ou1.os11.otype == 17 ) i = 0;
  else
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    i = (y)->os1.ou2.os22.oword_font;
  }
                                                                                ;
  return i;
}
# 306 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FILE_NUM NextFile(FILE_NUM i)
{ OBJECT link, y;
                                                ;
  link = (((file_tab)->filetab[i].by_number)->os1.olist[1].osucc)->os1.olist[0].osucc;
  if( (link)->os1.ou1.os11.otype == 17 ) i = 0;
  else
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    i = (y)->os1.ou2.os22.oword_font;
...
# 328 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FILE_NUM FileNum(FULL_CHAR *str, FULL_CHAR *suffix)
{ register int i; OBJECT fname;
  FULL_CHAR buff[512];
                                                 ;
  if( strlen((char *)(str)) + strlen((char *)(suffix)) >= 512 )
    Error(3, 6, "file name %s%s is too long", 1, no_fpos, str, suffix);
  strcpy((char *)(buff),(char *)(str));
  strcat((char *)(buff),(char *)(suffix));
  fname = ftab_retrieve(buff, file_tab);
  i = fname == ( (OBJECT) ((void*)0) ) ? 0 : (fname)->os1.ou2.os22.oword_font;

                                                      ;
  return (FILE_NUM) i;
}
# 352 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FILE_NUM DatabaseFileNum(FILE_POS *xfpos)
{ OBJECT x;
  FILE_NUM fnum; FULL_CHAR *str;

                                     ;
  x = (file_tab)->filetab[(*xfpos).ofile_num].by_number;
  switch( (x)->os1.ou2.os22.oword_colour )
  {
    case 0:
    case 1:


      str = FileName((*xfpos).ofile_num);
      fnum = FileNum(str, ( (FULL_CHAR *) (".ld") ));
      if( fnum == 0 )
      { ;
 fnum = DefineFile(str, ( (FULL_CHAR *) (".ld") ), xfpos, 3, 0);
      }
      break;
    ...
    case 3:
      ...
      if( ((x)->os1.ou1.ofpos).ofile_num == 0 )
      {
 ...
 fnum = (*xfpos).ofile_num;
      }
      else
      {

        fnum = DatabaseFileNum(&(x)->os1.ou1.ofpos);
      }
      break;
 ...
 Error(3, 7, "DatabaseFileNum: filter file position unknown",
   0, no_fpos);
    ...
    default:
      ...
      Error(3, 8, "DatabaseFileNum: unexpected file type", 0, no_fpos);
      fnum = 0;
      break;
...
# 429 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FULL_CHAR *FileName(FILE_NUM fnum)
{ OBJECT x;
  x = (file_tab)->filetab[fnum].by_number;
  { if( !(x != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FileName: x == nilobj!"); };
  if( (x)->os1.olist[0].osucc != x ) for( x = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (x)->os1.ou1.os11.otype == 0; x = (x)->os1.olist[1].opred );
  return (x)->os1.ostring;
}


FULL_CHAR *FullFileName(FILE_NUM fnum)
{ OBJECT x;
  static FULL_CHAR ffbuff[2][512];
  static int ffbp = 1;

  x = (file_tab)->filetab[fnum].by_number;
  { if( !(x != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "FileName: x == nilobj!"); };
  if( (x)->os1.ou2.os22.oword_hyph )
  {
    if( (x)->os1.olist[0].osucc != x ) for( x = ((x)->os1.olist[0].osucc)->os1.olist[1].opred; (x)->os1.ou1.os11.otype == 0; x = (x)->os1.olist[1].opred );
    ffbp = (ffbp + 1) % 2;
    strcpy((char *)(ffbuff[ffbp]),(char *)((x)->os1.ostring));
    strcat((char *)(ffbuff[ffbp]),(char *)(( (FULL_CHAR *) (".lt") )));
    return ffbuff[ffbp];
  }
  else
  {
...
# 469 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
static FULL_CHAR buff[2][512]; static int bp = 1;

static void append_fpos(FILE_POS *pos)
{ OBJECT x;
  x = (file_tab)->filetab[(*pos).ofile_num].by_number;
  { if( !(x != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "EchoFilePos: file_tab entry is nilobj!"); };
  if( ((x)->os1.ou1.ofpos).ofile_num > 0 )
  { append_fpos( &(x)->os1.ou1.ofpos );
    if( strlen((char *)(buff[bp])) + 2 >= 512 )
      Error(3, 9, "file position %s... is too long to print",
        1, no_fpos, buff[bp]);
    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("/") )));
  }
  if( strlen((char *)(buff[bp])) + strlen((char *)((x)->os1.ostring)) + 13 >= 512 )
    Error(3, 10, "file position %s... is too long to print",
      1, no_fpos, buff[bp]);
  strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
  strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("\"") )));
  strcat((char *)(buff[bp]),(char *)((x)->os1.ostring));
  strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("\"") )));
  if( (*pos).oline_num != 0 )
  { strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
    strcat((char *)(buff[bp]),(char *)(StringInt( (int) (*pos).oline_num)));
    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (",") )));
    strcat((char *)(buff[bp]),(char *)(StringInt( (int) (*pos).ocol_num)));
  }
}

FULL_CHAR *EchoFilePos(FILE_POS *pos)
{ bp = (bp + 1) % 2;
  strcpy((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("") )));
  if( (*pos).ofile_num > 0 ) append_fpos(pos);
  return buff[bp];
}
...
FULL_CHAR *EchoAltFilePos(FILE_POS *pos)
{
  ...
  if( (*pos).ofile_num > 0 )
  {
    ...
    strcat((char *)(buff[bp]),(char *)(FullFileName((*pos).ofile_num)));
    if( (*pos).oline_num != 0 )
    { strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (":") )));
      strcat((char *)(buff[bp]),(char *)(StringInt( (int) (*pos).oline_num)));
      strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (":") )));
...
# 532 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
...
{ OBJECT x, nextx;
  ...
  { strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
    x = (file_tab)->filetab[fnum].by_number;
    { if( !(x != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "EchoFileSource: x == nilobj!"); };
    if( (x)->os1.ou2.os22.oword_colour == 10 )
    { strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ((MsgCat ? catgets(MsgCat, 3, 11, "filter") : "filter")) )));

      strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
    }
    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ((MsgCat ? catgets(MsgCat, 3, 12, "file") : "file")) )));

    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));

    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("\"") )));
    strcat((char *)(buff[bp]),(char *)(FullFileName(fnum)));
    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("\"") )));
    if( ((x)->os1.ou1.ofpos).ofile_num > 0 )
    { strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" (") )));
      for(;;)
      { nextx = (file_tab)->filetab[((x)->os1.ou1.ofpos).ofile_num].by_number;
 strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ((MsgCat ? catgets(MsgCat, 3, 13, "from") : "from")) )));

 strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
        strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("\"") )));
        strcat((char *)(buff[bp]),(char *)((nextx)->os1.ostring));
        strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("\"") )));
 strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
        strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ((MsgCat ? catgets(MsgCat, 3, 14, "line") : "line")) )));

 strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (" ") )));
        strcat((char *)(buff[bp]),(char *)(StringInt( (int) ((x)->os1.ou1.ofpos).oline_num)));
 if( ((nextx)->os1.ou1.ofpos).ofile_num == 0 ) break;
 strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (", ") )));
 x = nextx;
      }
      strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (")") )));
...
# 586 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FULL_CHAR *EchoFileLine(FILE_POS *pos)
{ bp = (bp + 1) % 2;
  strcpy((char *)(buff[bp]),(char *)(( (FULL_CHAR *) ("") )));
  if( (*pos).ofile_num > 0 && (*pos).oline_num != 0 )
  { strcat((char *)(buff[bp]),(char *)(StringInt( (int) (*pos).oline_num)));
    strcat((char *)(buff[bp]),(char *)(( (FULL_CHAR *) (",") )));
    strcat((char *)(buff[bp]),(char *)(StringInt( (int) (*pos).ocol_num)));
  }
...
# 606 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FILE_POS *PosOfFile(FILE_NUM fnum)
{ OBJECT x = (file_tab)->filetab[fnum].by_number;
  { if( !(x != ( (OBJECT) ((void*)0) )) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "PosOfFile: file_tab entry is nilobj!"); };
  return &(x)->os1.ou1.ofpos;
}
# 636 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
static FILE *SearchPath(FULL_CHAR *str, OBJECT fpath, unsigned check_ld,
unsigned check_lt, OBJECT *full_name, FILE_POS *xfpos, char *read_mode,
unsigned *used_source_suffix)
{ FULL_CHAR buff[512], buff2[512];
  OBJECT link, y, cpath; FILE *fp, *fp2;

                                ;

  *used_source_suffix = 0;


  if( (strcmp((char *)(str), (char *)(( (FULL_CHAR *) ("-") )))==0) )
  {
                                                   ;
    *full_name = ( (OBJECT) ((void*)0) );
    return stdin;
  }


  cpath = StringBeginsWith(str, ( (FULL_CHAR *) ("/") )) ? empty_path : fpath;


  fp = ( (FILE *) ((void*)0) );
  for( link = (cpath)->os1.olist[0].osucc; fp == ( (FILE *) ((void*)0) ) && link != cpath; link = (link)->os1.olist[0].osucc )
  { for( y = (link)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );


    if( strlen((char *)((y)->os1.ostring)) == 0 )
    { strcpy((char *)(buff),(char *)(str));
    }
    else
    { if( strlen((char *)((y)->os1.ostring)) + strlen((char *)(( (FULL_CHAR *) ("/") ))) +
   strlen((char *)(str)) >= 512 )
 Error(3, 15, "file path name %s%s%s is too long",
   1, &(y)->os1.ou1.ofpos, (y)->os1.ostring, ( (FULL_CHAR *) ("/") ), str);
      strcpy((char *)(buff),(char *)((y)->os1.ostring));
      strcat((char *)(buff),(char *)(( (FULL_CHAR *) ("/") )));
      strcat((char *)(buff),(char *)(str));
    }


    fp = fopen( (char *) (buff), (read_mode) );
                                                                    ;


    if( check_ld && fp == ( (FILE *) ((void*)0) ) )
    {
        strcpy((char *)(buff2),(char *)(buff));
        strcpy((char *)(&buff2[strlen((char *)(buff2)) - strlen((char *)(( (FULL_CHAR *) (".li") )))]),(char *)(( (FULL_CHAR *) (".ld") )));

        fp2 = fopen( (char *) (buff2), ("r") );
                                                                          ;
        if( fp2 != ( (FILE *) ((void*)0) ) )
        { fclose(fp2);
                                                                     ;
...
# 710 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
    if( check_ld && fp != ( (FILE *) ((void*)0) ) )
    {
   ...
   stat( (char *) buff2, &datastat) == 0 )
      {
                                                     ...
                                                     ;
 if( datastat.st_mtim.tv_sec > indexstat.st_mtim.tv_sec )
 { fclose(fp);
                                                               ;
   remove((char *)(buff));
                                                                   ;
   *full_name = ( (OBJECT) ((void*)0) );
   return ( (FILE *) ((void*)0) );
    ...
    {
      strcpy((char *)(buff2),(char *)(buff));
      strcat((char *)(buff2),(char *)(( (FULL_CHAR *) (".lt") )));
      fp2 = fopen( (char *) (buff2), ("r") );
                                                                        ;
      if( fp2 != ( (FILE *) ((void*)0) ) )
      { if( fp != ( (FILE *) ((void*)0) ) )
   Error(3, 16, "files %s and %s both exist", 1, xfpos,buff,buff2);
 fp = fp2;
 *used_source_suffix = 1;
      }
    }

  }
                                                                                ;
  *full_name = (fp == ( (FILE *) ((void*)0) ) || strlen((char *)((y)->os1.ostring)) == 0) ? ( (OBJECT) ((void*)0) ) :
    MakeWord(11, buff, xfpos);
  return fp;
}
# 776 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
FILE *OpenFile(FILE_NUM fnum, unsigned check_ld, unsigned check_lt)
{ FILE *fp; OBJECT fname, full_name, y; unsigned used_source_suffix;
                                        ;
                                                                       ;
  fname = (file_tab)->filetab[fnum].by_number;
  if( (fname)->os1.olist[0].osucc != fname )
  { for( y = ((fname)->os1.olist[0].osucc)->os1.olist[1].opred; (y)->os1.ou1.os11.otype == 0; y = (y)->os1.olist[1].opred );
    fp = fopen( (char *) ((y)->os1.ostring), (file_mode[(fname)->os1.ou2.os22.oword_colour]) );
                                                                               ;
  }
  else
  { fp = SearchPath((fname)->os1.ostring, file_path[(fname)->os1.ou3.os31.oback[0]], check_ld,
    check_lt, &full_name, &(fname)->os1.ou1.ofpos, file_mode[(fname)->os1.ou2.os22.oword_colour],
    &used_source_suffix);
    if( full_name != ( (OBJECT) ((void*)0) ) ) { { ; { ; if( (zz_size=(zz_lengths[0])) >= ( ((sizeof(struct word_type)+2048) - 1)/(sizeof(ALIGN)) + 1 ) ) Error(1, 1, "word is too long", 1, no_fpos); else if( zz_free[zz_size] == ( (OBJECT) ((void*)0) ) ) zz_hold = GetMemory(zz_size, no_fpos); else { zz_hold = zz_hold = zz_free[zz_size]; ; zz_free[zz_size] = (zz_hold)->os1.olist[0].opred; } }; (zz_hold)->os1.ou1.os11.otype = 0; ; xx_link = (zz_hold)->os1.olist[0].opred = (zz_hold)->os1.olist[0].osucc = (zz_hold)->os1.olist[1].opred = (zz_hold)->os1.olist[1].osucc = zz_hold; }; ( zz_res = (xx_link), zz_hold = ((fname)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[0].opred, (zz_hold)->os1.olist[0].opred = (zz_res)->os1.olist[0].opred, ((zz_res)->os1.olist[0].opred)->os1.olist[0].osucc = zz_hold, (zz_res)->os1.olist[0].opred = zz_tmp, (zz_tmp)->os1.olist[0].osucc = zz_res ) ); ( zz_res = (xx_link), zz_hold = ((full_name)), zz_hold == ( (OBJECT) ((void*)0) ) ? zz_res : zz_res == ( (OBJECT) ((void*)0) ) ? zz_hold : ( zz_tmp = (zz_hold)->os1.olist[1].opred, (zz_hold)->os1.olist[1].opred = (zz_res)->os1.olist[1].opred, ((zz_res)->os1.olist[1].opred)->os1.olist[1].osucc = zz_hold, (zz_res)->os1.olist[1].opred = zz_tmp, (zz_tmp)->os1.olist[1].osucc = zz_res ) ); };
    (fname)->os1.ou2.os22.oword_hyph = used_source_suffix;
  }
                                         ;
                                                                              ;
  return fp;
}
# 809 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
static char *compress_suffixes[6]
  = { ".gz", "-gz", ".z", "-z", "_z", ".Z" };

FILE *OpenIncGraphicFile(FULL_CHAR *str, unsigned char typ,
OBJECT *full_name, FILE_POS *xfpos, unsigned *compressed)
{ FILE *fp; int p, i; unsigned used_source_suffix;
                                                                   ;
  { if( !(typ == 94 || typ == 95) ) Error(1, 2, "assert failed in %s", 0, no_fpos, "OpenIncGraphicFile!"); };
  p = (typ == 94 ? 1 : 2);
  fp = SearchPath(str, file_path[p], 0, 0, full_name, xfpos,
 "r", &used_source_suffix);
  if( *full_name == ( (OBJECT) ((void*)0) ) ) *full_name = MakeWord(11, str, xfpos);
  ...
  else
  {
    ...
    for( i = 0; i < 6; i++ )
    { if( StringEndsWith((*full_name)->os1.ostring, ( (FULL_CHAR *) (compress_suffixes[i]) )) )
        break;
    }
    if( i < 6 )
    { char buff[512];
      fclose(fp);
      sprintf(buff, "gunzip -c %s > %s", (char *) (*full_name)->os1.ostring, "lout.eps");
      if( SafeExecution )
      {
        Error(3, 17, "safe execution prohibiting command: %s", 2, xfpos,buff);
        *compressed = 0;
        fp = ( (FILE *) ((void*)0) );
      }
      else
...
# 872 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
void FileSetUpdated(FILE_NUM fnum, int newlines)
{
                                                                     ;
  ((file_tab)->filetab[fnum].by_number)->os1.ou3.os31.ofwd[0] = 1;
  ((file_tab)->filetab[fnum].by_number)->os1.ou3.os31.ofwd[1] = newlines;
                                             ;
}
# 889 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
int FileGetLineCount(FILE_NUM fnum)
{ int res;
                                                         ;
  res = ((file_tab)->filetab[fnum].by_number)->os1.ou3.os31.ofwd[1];
                                                       ;
  return res;
}
# 906 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
unsigned FileTestUpdated(FILE_NUM fnum)
{ return (unsigned) ((file_tab)->filetab[fnum].by_number)->os1.ou3.os31.ofwd[0];
}
