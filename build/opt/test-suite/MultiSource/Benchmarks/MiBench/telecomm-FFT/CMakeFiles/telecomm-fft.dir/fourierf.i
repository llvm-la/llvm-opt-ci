# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c" 2
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c"
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c" 2
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c" 2
...
# 23 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c" 2

# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourier.h" 1
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourier.h"
void fft_double (
    unsigned NumSamples,
...
# 25 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/ddcmath.h" 1
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c" 2
...
# 108 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c"
        if ((-2 * delta_angle) == ((3.14159265358979323846) / 4)) {
          sm2 = SinPi4Result;
          cm2 = CosPi4Result;
        } else if ((-2 * delta_angle) == ((3.14159265358979323846) / 16))
          sm2 = SinPi16Result;
        if ((-delta_angle) == ((3.14159265358979323846) / 4)) {
          sm1 = SinPi4Result;
          cm1 = CosPi4Result;
        } else if ((-delta_angle) == ((3.14159265358979323846) / 16))
          sm1 = SinPi16Result;
        double w = 2 * cm1;
        double ar[3], ai[3];
        double temp;
...
#pragma STDC FP_CONTRACT OFF
    ...
    for ( BlockSize = 2; BlockSize <= NumSamples; BlockSize <<= 1 )
    {
        ...
        double cm2 = cos ( -2 * delta_angle );
        double cm1 = cos ( -delta_angle );
# 237 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-FFT/fourierf.c"
        if ((-2 * delta_angle) == ((3.14159265358979323846) / 4)) {
          sm2 = SinPi4Result;
          cm2 = CosPi4Result;
        } else if ((-2 * delta_angle) == ((3.14159265358979323846) / 16))
