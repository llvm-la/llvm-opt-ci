# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.h" 1
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/build/build-llvm/lib/clang/22/include/__stddef_offsetof.h" 1 3
# 129 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/build/build-llvm/lib/clang/22/include/stddef.h" 2 3
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.h" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Bra.h" 1
# 57 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Bra.h"
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2




# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.h" 1
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.h" 1
...
# 15 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/LzmaEnc.h"
...
SRes LzmaEncode(Byte *dest, SizeT *destLen, const Byte *src, SizeT srcLen,
    ...
    ICompressProgress *progress, ISzAlloc *alloc, ISzAlloc *allocBig);
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.h" 2
...
# 36 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Lzma2Enc.h"
...
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.h" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.h" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c" 2
...
{
  return (s->Write(s, buf, size) == size) ? 0 : 9;
}
...
SRes Xz_WriteHeader(CXzStreamFlags f, ISeqOutStream *s)
{
  UInt32 crc;
  Byte header[(6 + 2 + 4)];
  memcpy(header, XZ_SIG, 6);
  header[6] = (Byte)(f >> 8);
  header[6 + 1] = (Byte)(f & 0xFF);
  crc = CrcCalc(header + 6, 2);
  { UInt32 _x_ = (crc); ((Byte *)(header + 6 + 2))[0] = (Byte)_x_; ((Byte *)(header + 6 + 2))[1] = (Byte)(_x_ >> 8); ((Byte *)(header + 6 + 2))[2] = (Byte)(_x_ >> 16); ((Byte *)(header + 6 + 2))[3] = (Byte)(_x_ >> 24); };
  return WriteBytes(s, header, (6 + 2 + 4));
}
...
SRes XzBlock_WriteHeader(const CXzBlock *p, ISeqOutStream *s)
{
  ...
  if ((((p)->flags & (1 << 6)) != 0)) pos += Xz_WriteVarInt(header + pos, p->packSize);
  if ((((p)->flags & (1 << 7)) != 0)) pos += Xz_WriteVarInt(header + pos, p->unpackSize);
  numFilters = (((p)->flags & 3) + 1);
  ...
  while((pos & 3) != 0)
    header[pos++] = 0;
  header[0] = (Byte)(pos >> 2);
  { UInt32 _x_ = (CrcCalc(header, pos)); ((Byte *)(header + pos))[0] = (Byte)_x_; ((Byte *)(header + pos))[1] = (Byte)(_x_ >> 8); ((Byte *)(header + pos))[2] = (Byte)(_x_ >> 16); ((Byte *)(header + pos))[3] = (Byte)(_x_ >> 24); };
...
SRes Xz_WriteFooter(CXzStream *p, ISeqOutStream *s)
{
  ...
  UInt64 globalPos;
  {
    ...
    globalPos = pos;
    buf[0] = 0;
    { int __result__ = (WriteBytesAndCrc(s, buf, pos, &crc)); if (__result__ != 0) return __result__; };
    ...
    {
      buf[0] = buf[1] = buf[2] = 0;
      { int __result__ = (WriteBytesAndCrc(s, buf, 4 - pos, &crc)); if (__result__ != 0) return __result__; };
      globalPos += 4 - pos;
    }
    {
      { UInt32 _x_ = (((crc) ^ 0xFFFFFFFF)); ((Byte *)(buf))[0] = (Byte)_x_; ((Byte *)(buf))[1] = (Byte)(_x_ >> 8); ((Byte *)(buf))[2] = (Byte)(_x_ >> 16); ((Byte *)(buf))[3] = (Byte)(_x_ >> 24); };
      { int __result__ = (WriteBytes(s, buf, 4)); if (__result__ != 0) return __result__; };
      globalPos += 4;
    }
  }

  {
    ...
    { UInt32 _x_ = (indexSize); ((Byte *)(buf + 4))[0] = (Byte)_x_; ((Byte *)(buf + 4))[1] = (Byte)(_x_ >> 8); ((Byte *)(buf + 4))[2] = (Byte)(_x_ >> 16); ((Byte *)(buf + 4))[3] = (Byte)(_x_ >> 24); };
    buf[8] = (Byte)(p->flags >> 8);
    buf[9] = (Byte)(p->flags & 0xFF);
    { UInt32 _x_ = (CrcCalc(buf + 4, 6)); ((Byte *)(buf))[0] = (Byte)_x_; ((Byte *)(buf))[1] = (Byte)(_x_ >> 8); ((Byte *)(buf))[2] = (Byte)(_x_ >> 16); ((Byte *)(buf))[3] = (Byte)(_x_ >> 24); };
    memcpy(buf + 10, XZ_FOOTER_SIG, 2);
...
# 346 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c"
typedef struct
{
    ...
    ICompressProgress *progress)
{
  ...
  { int __result__ = (Lzma2Enc_SetProps(lzmaf->lzma2, lzma2Props)); if (__result__ != 0) return __result__; };
  { int __result__ = (Xz_WriteHeader(xz->flags, outStream)); if (__result__ != 0) return __result__; };

  {
    ...
    (&block)->flags = 0;;
    (&block)->flags |= ((1 + (useSubblock ? 1 : 0)) - 1);;
    ...
    { int __result__ = (XzBlock_WriteHeader(&block, &seqSizeOutStream.p)); if (__result__ != 0) return __result__; };

    checkInStream.p.Read = SeqCheckInStream_Read;
    checkInStream.realStream = inStream;
    SeqCheckInStream_Init(&checkInStream, ((xz->flags) & 0xF));
# 443 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c"
    {
...

    {
      ...
      { int __result__ = (WriteBytes(&seqSizeOutStream.p, buf, padSize + XzFlags_GetCheckSize(xz->flags))); if (__result__ != 0) return __result__; };
      { int __result__ = (Xz_AddIndexRecord(xz, block.unpackSize, seqSizeOutStream.processed - padSize, &g_Alloc)); if (__result__ != 0) return __result__; };
    }
  }
