# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
# 16 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
# 18 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 19 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
# 20 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
# 61 "/usr/include/loongarch64-linux-gnu/sys/mman.h" 3 4
...
# 21 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
# 1 "/usr/include/mntent.h" 1 3 4
# 23 "/usr/include/mntent.h" 3 4
# 1 "/usr/include/paths.h" 1 3 4
# 24 "/usr/include/mntent.h" 2 3 4
# 51 "/usr/include/mntent.h" 3 4
struct mntent
  {
    char *mnt_fsname;
    char *mnt_dir;
...
# 22 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
...
# 26 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c" 2
# 37 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Alloc.c"
void *MyAlloc(size_t size)
{
  if (size == 0)
    return 0;
...
static void *VirtualAlloc(size_t size, int memLargePages)
{
  ...
  if (memLargePages)
  {
    ...
    static pthread_mutex_t mutex = { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { 0, 0 } } };
    ...
    for (i = 0; i < 64; ++i)
    {
      if (g_HugePageAddr[i] == ((void*)0))
      {
        ...
        if (fd < 0)
        {
          fprintf(stderr,"cant't open %s (%s)\n",tempname,strerror((*__errno_location ())));
          break;
        }
        address = mmap(((void*)0), size, 0x1 | 0x2, 0x01, fd, 0);
        close(fd);
        if (address == ((void *) -1))
        {
          address = ((void*)0);
...
size_t largePageMinimum()
{
  ...
  if (g_HugetlbPath == ((void*)0) || (size = pathconf(g_HugetlbPath, _PC_REC_MIN_XFER_SIZE)) <= getpagesize())
    return 0;
  return size;
}
