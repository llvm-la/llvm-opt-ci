# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/backpropKernel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/backpropKernel.c" 2
# 11 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/backpropKernel.c"
...
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/backpropKernel.c" 2
...
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/backpropKernel.c" 2
...
# 14 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/backprop/backpropKernel.c" 2
...
float bpnn_train_kernel(
  ...
  for (int iteration = 0; iteration < iterations; iteration++) {
    ...
    for (j = 1; j <= out; j++) {
      for (k = 0; k <= hid; k++) {
        new_dw = ((0.3 * output_delta[j] * hidden_units[k]) +
                  (0.3 * hidden_prev_weights[k][j]));
    ...
    for (j = 1; j <= hid; j++) {
      for (k = 0; k <= in; k++) {
        new_dw = ((0.3 * hidden_delta[j] * input_units[k]) +
                  (0.3 * input_prev_weights[k][j]));
