# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/pathfinderKernel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/pathfinderKernel.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/pathfinderKernel.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/pathfinder/pathfinderKernel.c" 2
...
void pathFinderKernel(int row, int col, int data[row][col], int result[col],
  ...
  for (int t = 0; t < row - 1; t++) {
    ...
    for (int n = 0; n < col; n++) {
      if (n == 0) {
        result[n] = data[t + 1][n] + ((src[n]) <= (src[n + 1]) ? (src[n]) : (src[n + 1]));
      } else if (n == col - 1) {
        result[n] = data[t + 1][n] + ((src[n]) <= (src[col - 2]) ? (src[n]) : (src[col - 2]));
      } else {
        result[n] = data[t + 1][n] + ((src[n]) <= (((src[n - 1]) <= (src[n + 1]) ? (src[n - 1]) : (src[n + 1]))) ? (src[n]) : (((src[n - 1]) <= (src[n + 1]) ? (src[n - 1]) : (src[n + 1]))));
      }
    }
  }
}
