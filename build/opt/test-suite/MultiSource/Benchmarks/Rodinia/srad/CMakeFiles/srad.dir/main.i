# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/../Common/glibc_compat_rand.h" 1
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/../Common/glibc_compat_rand.h"
int glibc_compat_rand(void);
void glibc_compat_srand(unsigned int seed);
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c" 2
...
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c" 2
...
# 4 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c" 2
...
# 5 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c" 2
...
# 6 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 7 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/Rodinia/srad/main.c" 2
...
int main(int argc, char *argv[]) {
  ...
  I = (float(*)[2048][1024])malloc(sizeof(float) * size_I);
  J = (float(*)[2048][1024])malloc(sizeof(float) * size_I);
  c = (float(*)[2048][1024])malloc(sizeof(float) * size_I);
  dN = (float(*)[2048][1024])malloc(sizeof(float) * size_I);
  dS = (float(*)[2048][1024])malloc(sizeof(float) * size_I);
  dW = (float(*)[2048][1024])malloc(sizeof(float) * size_I);
  dE = (float(*)[2048][1024])malloc(sizeof(float) * size_I);
...
void random_matrix(float I[2048][1024]) {
  ...
  for (int i = 0; i < 2048; i++) {
    for (int j = 0; j < 1024; j++) {
      ...
      I[i][j] = glibc_compat_rand() / (float)2147483647;
