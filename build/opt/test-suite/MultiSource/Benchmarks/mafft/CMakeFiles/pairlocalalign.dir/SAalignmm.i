# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/SAalignmm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/SAalignmm.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/SAalignmm.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/SAalignmm.c" 2
                        ...
                        int **ijp, int icyc, int jcyc )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 65 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/SAalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
...

{
 ...
 if( lgth1 > orlgth1 || lgth2 > orlgth2 )
 {
  ...
  ll1 = ( (((int)(1.1*lgth1))>(orlgth1))?((int)(1.1*lgth1)):(orlgth1) ) + 100;
  ll2 = ( (((int)(1.1*lgth2))>(orlgth2))?((int)(1.1*lgth2)):(orlgth2) ) + 100;
...
# 358 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/SAalignmm.c"
