# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c" 2
...
void display( char **seq, int nseq )
{
 ...
 if( !disp ) return;
  ...
  for( i=0; i<+imax; i++ )
  {
   strncpy( b, seq[i]+0, 120 );
   b[120] = 0;
   fprintf( stderr, "%3d %s\n", i+1, b );
  }
}
# 169 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
...
double score_calc3( char **seq, int s, double **eff, int ex )
{
    int i, j, k, c;
    int len = strlen( seq[0] );
    double score;
    long tmpscore;
    static char mseq1[5000000*2], mseq2[5000000*2];
 double totaleff;
...
# 528 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
...
double score_calc5( char **seq, int s, double **eff, int ex )
{
    int i, j, k;
    double c;
    int len = strlen( seq[0] );
 ...
 for( i=0; i<s; i++ )
 {
   ...
   if( i == ex || j == ex ) continue;
    ...
    return( (double)score );
# 652 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
}



double score_calc4( char **seq, int s, double **eff, int ex )
{
    int i, j, k;
 double c;
    int len = strlen( seq[0] );
 ...
 double efficient;
    ...
    score = 0.0;
 c = 0.0;
# 680 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    for( i=0; i<s-1; i++ )
    {
        for( j=i+1; j<s; j++ )
        {
 ...
 for( i=0; i<nseq; i++ ) tmplen[i] = 0.0;
  ...
  tmplen[im] = minscore / 2.0;
        ...
        for( i=0; i<nseq; i++ )
        {
            if( i != im && i != jm )
            {
                eff[( ((i)<(im))?(i):(im) )][( ((i)>(im))?(i):(im) )] =
                ( eff[( ((i)<(im))?(i):(im) )][( ((i)>(im))?(i):(im) )] + eff[( ((i)<(jm))?(i):(jm) )][( ((i)>(jm))?(i):(jm) )] ) / 2.0;
                eff[( ((i)<(jm))?(i):(jm) )][( ((i)>(jm))?(i):(jm) )] = 9999.0;
            }
            eff[im][jm] = 9999.0;
        }
# 802 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
}
 ...
 *nearestpt = -1;
 ...
 for( acptj=(acpt+pos)->next; acptj!=((void*)0); acptj=acptj->next )
 {
  j = acptj->pos;
...
void loadtree( int nseq, int ***topol, float **len, char **name, int *nlen )
{
 ...
 int *intpt, *intpt2;
 static int *hist = ((void*)0);
 static Bchain *ac = ((void*)0);
 int im = -1, jm = -1;
    ...
    for( i=0; i<nseq; i++ )
 {
  ...
  for( j=0; j<30; j++ )
  {
   if( ((*__ctype_b_loc ())[(int) ((name[i][j]))] & (unsigned short int) _ISalnum) )
    nametmp[j] = name[i][j];
   else
    nametmp[j] = '_';
  }
...
# 962 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
  minscore = 0.0;
  len[k][0] = len[k][1] = -1.0;
  ...
  mindisfrom[im] = 999.9;
  for( acpti=ac; acpti!=((void*)0); acpti=acpti->next )
        {
   i = acpti->pos;
            if( i != im && i != jm )
            {
...
# 1123 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 fclose( fp );
 ...
 free( treetmp );
 free( nametmp );
 free( hist ); hist = ((void*)0);
 free( (char *)ac ); ac = ((void*)0);
 free( (void *)nmemar ); nmemar = ((void*)0);
 free( mindisfrom );
 free( nearest );
...
{
 return( ( ((d1)<(d2))?(d1):(d2) ) * sueff1_double + ( d1 + d2 ) * sueff05_double );
}
...
void loadtop( int nseq, float **eff, int ***topol, float **len )
{
 int i, k, miniim, maxiim, minijm, maxijm;
 int *intpt, *intpt2;
 static Bchain *ac = ((void*)0);
 float eff1, eff0;
 static float *tmptmplen = ((void*)0);
 static int *hist = ((void*)0);
 int im = -1, jm = -1;
 Bchain *acjmnext, *acjmprev;
 int prevnode;
 ...
 {
  if( k % 10 == 0 ) fprintf( stderr, "\r% 5d / %d", k, nseq );
# 1267 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
  dumfl[0] = dumfl[1] = -1.0;
  ...
  if( acjmnext != ((void*)0) )
   acjmnext->prev = acjmprev;
  free( (void *)eff[jm] ); eff[jm] = ((void*)0);
# 1417 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 ...
 free( (void *)tmptmplen ); tmptmplen = ((void*)0);
 free( hist ); hist = ((void*)0);
 free( (char *)ac ); ac = ((void*)0);
 free( (void *)nmemar ); nmemar = ((void*)0);
...
void fixed_musclesupg_float_realloc_nobk_halfmtx_treeout( int nseq, float **eff, int ***topol, float **len, char **name, int *nlen )
{
 ...
 for( i=0; i<nseq; i++ ) setnearest( nseq, ac, eff, mindisfrom+i, nearest+i, i );
 ...
 for( k=0; k<nseq-1; k++ )
 {
  ...
  minscore = 999.9;
  for( acpti=ac; acpti->next!=((void*)0); acpti=acpti->next )
  {
   i = acpti->pos;
...
# 1700 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 fp = fopen( "infile.tree", "w" );
  fprintf( fp, "%s\n", treetmp );
 fclose( fp );
...
# 1962 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 free( (void *)tmptmplen ); tmptmplen = ((void*)0);
 free( hist ); hist = ((void*)0);
 free( (char *)ac ); ac = ((void*)0);
...
# 1978 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
void veryfastsupg_double_loadtop( int nseq, double **eff, int ***topol, double **len )
{
    int i, k, miniim, maxiim, minijm, maxijm;
 int *intpt, *intpt2;
 double eff1, eff0;
 static double *tmptmplen = ((void*)0);
    static int *hist = ((void*)0);
 static Achain *ac = ((void*)0);
 double minscore;
 static char **tree;
 static char *treetmp;
 int im = -1, jm = -1;
...
# 2044 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
  dumfl[0] = dumfl[1] = -1.0;
  loadtreeoneline( node, dumfl, fp );
  im = node[0];
  jm = node[1];
  ...
  sprintf( treetmp, "(%s:%7.5f,%s:%7.5f)", tree[im], len[k][0], tree[jm], len[k][1] );
  strcpy( tree[im], treetmp );
# 2179 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 fclose( fp );
...
void veryfastsupg_double_loadtree( int nseq, double **eff, int ***topol, double **len )
{
 ...
 fprintf( stderr, "\n" );
    ...
    {
  if( k % 10 == 0 ) fprintf( stderr, "%d / %d\r", k, nseq );
# 2264 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
  lenfl[0] = lenfl[1] = -1.0;
  ...
  sprintf( treetmp, "(%s:%7.5f,%s:%7.5f)", tree[im], len[k][0], tree[jm], len[k][1] );
  strcpy( tree[im], treetmp );
# 2405 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 fclose( fp );
...
# 2600 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
void veryfastsupg_double_outtree( int nseq, double **eff, int ***topol, double **len, char name[50000][256] )
{
    int i, j, k, miniim, maxiim, minijm, maxijm;
 int *intpt, *intpt2;
 double tmpdouble;
 ...
 fprintf( stderr, "\n" );
  ...
  sprintf( treetmp, "(%s:%7.5f,%s:%7.5f)", tree[im], len[k][0], tree[jm], len[k][1] );
  strcpy( tree[im], treetmp );
# 2810 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
...
void veryfastsupg( int nseq, double **oeff, int ***topol, double **len )
{
 ...
 for( i=0; i<nseq; i++ )
 {
  for( j=0; j<nseq; j++ )
  {
   eff[i][j] = (int)( oeff[i][j] * 1000000.0 + 0.5 );
  }
 }
...
# 2960 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
  ...
  if( acjmnext != -1 )
   ac[acjmnext].prev = acjmprev;
# 3013 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }

 FreeIntMtx( eff ); eff = ((void*)0);
 free( (void *)tmptmplen ); tmptmplen = ((void*)0);
 free( hist ); hist = ((void*)0);
 free( (char *)ac ); ac = ((void*)0);
...

{
 ...
 fprintf( stderr, "\n" );
  ...
  for( i=0; i!=-1; i=ac[i].next )
    ...
    eff1 = eff[minijm][maxijm];
                eff[miniim][maxiim] =
    (int) ( (float)( ((eff0)<(eff1))?(eff0):(eff1) ) * ( 1.0 - 0.1 ) + (float)( eff0 + eff1 ) * 0.5 * 0.1 );
            }
        }
  acjmprev = ac[jm].prev;
  acjmnext = ac[jm].next;
  ...
  if( acjmnext != -1 )
   ac[acjmnext].prev = acjmprev;
# 3203 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 FreeIntMtx( eff ); eff = ((void*)0);
 free( (void *)tmptmplen ); tmptmplen = ((void*)0);
 free( hist ); hist = ((void*)0);
...
# 3345 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
 fprintf( stderr, "\n" );
...
# 3483 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
}
 ...
 for( i=0; i<nseq; i++ ) tmplen[i] = 0.0;
  ...
  tmplen[im] = minscore / 2.0;
        ...
        for( i=0; i<nseq; i++ )
        {
            ...
            {
                eff[( ((i)<(im))?(i):(im) )][( ((i)>(im))?(i):(im) )] =
                ( ((eff[( ((i)<(im))?(i):(im) )][( ((i)>(im))?(i):(im) )])<(eff[( ((i)<(jm))?(i):(jm) )][( ((i)>(jm))?(i):(jm) )]))?(eff[( ((i)<(im))?(i):(im) )][( ((i)>(im))?(i):(im) )]):(eff[( ((i)<(jm))?(i):(jm) )][( ((i)>(jm))?(i):(jm) )]) );
                eff[( ((i)<(jm))?(i):(jm) )][( ((i)>(jm))?(i):(jm) )] = 9999.0;
            }
            eff[im][jm] = 9999.0;
        }
# 3564 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    }
}
...
void countnode( int nseq, int ***topol, double **node )
{
    int i, j, k, s1, s2;
    static double rootnode[50000];
  ...
  exit( 1 );
    ...
    for( i=0; i<nseq-2; i++ )
    {
        ...
        for( j=0; topol[i][0][j]>-1; j++ )
        {
            ...
            {
                s2 = topol[i][1][k];
                node[( ((s1)<(s2))?(s1):(s2) )][( ((s1)>(s2))?(s1):(s2) )] = rootnode[s1] + rootnode[s2] - 1;
            }
        }
    }
    for( j=0; topol[nseq-2][0][j]>-1; j++ )
    {
        ...
        {
            s2 = topol[nseq-2][1][k];
            node[( ((s1)<(s2))?(s1):(s2) )][( ((s1)>(s2))?(s1):(s2) )] = rootnode[s1] + rootnode[s2];
        }
    }
}

void countnode_int( int nseq, int ***topol, int **node )
{
    int i, j, k, s1, s2;
    int rootnode[50000];
 ...
 for( i=0; i<nseq-1; i++ ) for( j=i+1; j<nseq; j++ )
  node[j][i] = node[i][j];
# 3663 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
}
...
# 3738 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
}
...
# 3813 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
}
...
# 3938 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
}
...
float score_calc1( char *seq1, char *seq2 )
{
 int k;
 float score = 0.0;
 int count = 0;
...
float substitution_hosei( char *seq1, char *seq2 )
# 4052 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
{
 int count = 0;
 float score;
 int iscore = 0;
...
float substitution( char *seq1, char *seq2 )
{
 int k;
 float score = 0.0;
 int count = 0;
...
# 4128 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
...
# 4148 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
}

float bscore_calc( char **seq, int s, double **eff )
{
 int i, j, k;
 int gb1, gb2, gc1, gc2;
 int cob;
...
# 4468 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
void strins( char *str1, char *str2 )
{
 ...
 while( str2 >= bk+len1 ) { *str2 = *(str2-len1); str2--;}
...
float score_calc_a( char **seq, int s, double **eff )
{
 int i, j, k;
 int gb1, gb2, gc1, gc2;
 int cob;
...
float score_calc_s( char **seq, int s, double **eff )
{
 int i, j, k;
 int gb1, gb2, gc1, gc2;
 int cob;
   ...
   gc2 = ( seq[j][k] == '-' );
            ...
            * !gb2 * gc2
                 ...
                 * gb2 * !gc2
                 ...
                 + gb1 * !gc1
                 * !gb2 * gc2
# 4678 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
                 ;
   score += 0.5 * (float)cob * penalty * efficient;
   score += (float)amino_dis[(int)seq[i][k]][(int)seq[j][k]] * (float)efficient;
   nglen += ( !gc1 * !gc2 );
...
double score_calc_for_score_s( int s, char **seq )
{
 int i, j, k;
 int gb1, gb2, gc1, gc2;
 int cob;
   ...
   gc2 = ( seq[j][k] == '-' );
            ...
            * !gb2 * gc2
                 ...
                 * gb2 * !gc2
                 ...
                 + gb1 * !gc1
                 * !gb2 * gc2
# 4743 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
                 ;
...
double SSPscore___( int s, char **seq, int ex )
{
 int i, j, k;
 int gb1, gb2, gc1, gc2;
 int cob;
   ...
   gc2 = ( seq[j][k] == '-' );
            ...
            * !gb2 * gc2
                 ...
                 * gb2 * !gc2 * 2.0
                 ...
                 + gb1 * !gc1
                 * !gb2 * gc2 * 2.0
# 4814 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
                 ;
   score += 0.5 * (float)cob * penalty;
   score += (float)amino_dis[(int)seq[i][k]][(int)seq[j][k]];
   nglen += ( !gc1 * !gc2 );
...
double SSPscore( int s, char **seq )
{
 int i, j, k;
 int gb1, gb2, gc1, gc2;
 int cob;
   ...
   gc2 = ( seq[j][k] == '-' );
            ...
            * !gb2 * gc2
                 ...
                 * gb2 * !gc2
                 ...
                 + gb1 * !gc1
                 * !gb2 * gc2
# 4883 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
                 ;
   score += 0.5 * (float)cob * penalty;
   score += (float)amino_dis[(int)seq[i][k]][(int)seq[j][k]];
   nglen += ( !gc1 * !gc2 );
...
double DSPscore( int s, char **seq )
{
    int i, j, k;
    double c;
    int len = strlen( seq[0] );
...
int searchAnchors( int nseq, char **seq, Segment *seg )
{
 ...
 for( i=0; i<len; i++ )
 {
# 5010 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
  stra[i] = 0.0;
 ...
 for( i=1; i<len-divWinSize; i++ )
 {
  ...
  if( score <= threshold || length > 150 )
  {
   if( status )
   {
    ...
    value++;
    seg++;
    if( value > 100000 - 3 ) ErrorExit( "TOO MANY SEGMENTS!");
   }
  }
 }
 if( status )
...
# 5156 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
 for( i=0; i<nseq; i++ )
 {
...
# 5228 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
  }
 }
# 5246 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
 for( i=0; i<nseq-1; i++ ) for( j=i+1; j<nseq; j++ )
 {
  double imp;
...
# 5291 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
}
# 5615 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
...
void extendlocalhom2( int nseq, LocalHom **localhom, double **dist )
{
 ...
 int *ipt;
 int co;
 static int *ini = ((void*)0);
 static int *inj = ((void*)0);
 LocalHom *pt;
 ...
 for( i=0; i<nseq-1; i++ )
 {
  for( j=i+1; j<nseq; j++ )
  {
# 5684 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
   for( k=0; k<nseq; k++ )
   {


    if( k == i || k == j ) continue;
    if( dist[( ((i)<(k))?(i):(k) )][( ((i)>(k))?(i):(k) )] > dist[i][j] * thrinter || dist[( ((j)<(k))?(j):(k) )][( ((j)>(k))?(j):(k) )] > dist[i][j] * thrinter ) continue;
...
# 5747 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
    overlp = 0;
    plim = nlenmax+1;
    for( pk = 0; pk < plim; pk++ )
    ...
    for( pk=0; pk<plim; pk++ )
    {
     ...
     if( status )
     {
      if( ini[pk] == -1 || inj[pk] == -1 || ini[pk-1] != ini[pk] - 1 || inj[pk-1] != inj[pk] - 1 )
      {
       status = 0;
       ...
       addlocalhom2_e( pt, localhom[i]+j, sti, stj, ini[pk-1], inj[pk-1], ( ((localhom[i][k].opt)<(localhom[j][k].opt))?(localhom[i][k].opt):(localhom[j][k].opt) ) * 1.0, overlp, k );


       pt = localhom[j][i].last;


       addlocalhom2_e( pt, localhom[j]+i, stj, sti, inj[pk-1], ini[pk-1], ( ((localhom[i][k].opt)<(localhom[j][k].opt))?(localhom[i][k].opt):(localhom[j][k].opt) ) * 1.0, overlp, k );
...
# 5923 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
{
 int i, j, gc, gb;
 float feff;
 float *fpt;
...
# 5977 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
{
 int i, j, gc, gb;
 float feff;
 float *fpt;
...
# 6040 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
{
 int i, j, gc, gb;
 float feff;
 float *fpt;
...
# 6104 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
{
 int i, j, gc, gb;
 float feff;
 float *fpt;
...
# 6282 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/mltaln9.c"
 }
 for( j=0; j<len; j++ )
 {
  fprintf( stderr, "%d, %f\n", j, fgcp[j] );
...

  {
   ...
   else
   {
    if( gb && gaplen )
    {
     ...
     if( known == 0 )
     {
      *fpt = (Gappat *)realloc( *fpt, (k+3) * sizeof( Gappat ) );
      if( !*fpt )
      {
