...
.LBB2_240:                              # %.lr.ph19.i609
	...
	addi.d	$t4, $t4, -1
	bnez	$t3, .LBB2_240
.LBB2_241:                              # %._crit_edge20.loopexit.i610
                                        #   in Loop: Header=BB2_218 Depth=1
	add.d	$a5, $s6, $a5
	add.d	$a5, $t2, $a5
	move	$s8, $t5
	move	$s1, $t4
	bne	$t1, $a0, .LBB2_223
.LBB2_242:                              #   in Loop: Header=BB2_218 Depth=1
	move	$t3, $s8
	move	$t2, $s1
	blez	$a7, .LBB2_246
.LBB2_243:                              # %._crit_edge30.i615
                                        #   in Loop: Header=BB2_218 Depth=1
	blez	$t0, .LBB2_246
# %bb.244:                              #   in Loop: Header=BB2_218 Depth=1
	add.d	$s4, $t1, $s4
	addi.d	$s8, $t3, -1
	st.b	$a1, $t3, -1
	addi.d	$s1, $t2, -1
...
.LBB2_246:
	...
	ld.d	$s6, $sp, 104                   # 8-byte Folded Reload
	blez	$s5, .LBB2_249
.LBB2_247:                              # %.lr.ph50.preheader.i627
	move	$fp, $s6
	move	$s0, $s5
	.p2align	4, , 16
.LBB2_248:                              # %.lr.ph50.i629
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_248
.LBB2_249:                              # %.preheader.i620
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 128                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 336                   # 8-byte Folded Reload
	blez	$s2, .LBB2_296
# %bb.250:                              # %.lr.ph52.preheader.i621
	move	$fp, $s3
	move	$s0, $s2
	.p2align	4, , 16
.LBB2_251:                              # %.lr.ph52.i623
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s7, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s1
...
.LBB2_253:                              # %vector.body1043
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_253
# %bb.254:                              # %middle.block1049
	beq	$a4, $a5, .LBB2_257
.LBB2_255:                              # %scalar.ph1038.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_256:                              # %scalar.ph1038
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.261:                              #   in Loop: Header=BB2_259 Depth=1
	...
	b	.LBB2_274
	.p2align	4, , 16
.LBB2_262:                              #   in Loop: Header=BB2_259 Depth=1
	addi.d	$t1, $s6, -1
	nor	$t7, $t1, $zero
	add.w	$t8, $s6, $t7
	bnez	$t8, .LBB2_275
	.p2align	4, , 16
.LBB2_263:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_259 Depth=1
	beq	$t4, $a1, .LBB2_283
.LBB2_264:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_259 Depth=1
	addi.w	$t7, $zero, -9
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB2_269
# %bb.265:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_259 Depth=1
	sub.d	$t7, $s8, $s1
	bltu	$t7, $a5, .LBB2_269
# %bb.266:                              # %vector.ph1058
	...
	vori.b	$vr4, $vr0, 0
	.p2align	4, , 16
.LBB2_267:                              # %vector.body1062
                                        #   Parent Loop BB2_259 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vstelm.w	$vr1, $t0, 0, 0
	vstelm.w	$vr1, $t0, -4, 0
	vstelm.w	$vr2, $s1, 0, 0
...
# %bb.268:                              # %middle.block1070
	...
	b	.LBB2_272
	.p2align	4, , 16
.LBB2_269:                              #   in Loop: Header=BB2_259 Depth=1
	move	$fp, $s0
	move	$t7, $s1
	move	$t8, $s8
.LBB2_270:                              # %.lr.ph29.i.preheader
                                        #   in Loop: Header=BB2_259 Depth=1
	add.d	$t0, $t0, $fp
	.p2align	4, , 16
.LBB2_271:                              # %.lr.ph29.i
	...
	addi.d	$t7, $t7, -1
	bnez	$fp, .LBB2_271
.LBB2_272:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_259 Depth=1
	ld.d	$fp, $sp, 368                   # 8-byte Folded Reload
	bne	$t2, $fp, .LBB2_284
	b	.LBB2_286
	.p2align	4, , 16
.LBB2_273:                              #   in Loop: Header=BB2_259 Depth=1
	addi.d	$t1, $s6, -1
.LBB2_274:                              #   in Loop: Header=BB2_259 Depth=1
	move	$t4, $a1
	nor	$t7, $t1, $zero
	add.w	$t8, $s6, $t7
	beqz	$t8, .LBB2_263
.LBB2_275:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_259 Depth=1
	bltu	$t8, $a6, .LBB2_280
# %bb.276:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_259 Depth=1
	sub.d	$fp, $s8, $s1
	bltu	$fp, $a6, .LBB2_280
# %bb.277:                              # %vector.ph1081
                                        #   in Loop: Header=BB2_259 Depth=1
...
.LBB2_278:                              # %vector.body1085
	...
	addi.d	$s1, $s1, -16
	bnez	$ra, .LBB2_278
# %bb.279:                              # %middle.block1092
                                        #   in Loop: Header=BB2_259 Depth=1
	ld.d	$ra, $sp, 360                   # 8-byte Folded Reload
	bne	$s5, $s3, .LBB2_281
	b	.LBB2_282
	.p2align	4, , 16
.LBB2_280:                              #   in Loop: Header=BB2_259 Depth=1
	move	$fp, $s1
	move	$s0, $s8
	.p2align	4, , 16
.LBB2_281:                              # %.lr.ph19.i
	...
	addi.d	$fp, $fp, -1
	bnez	$t8, .LBB2_281
.LBB2_282:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB2_259 Depth=1
	add.d	$t0, $s6, $t0
	add.d	$t0, $t7, $t0
	move	$s8, $s0
	...
	move	$s5, $a0
	bne	$t4, $a1, .LBB2_264
.LBB2_283:                              #   in Loop: Header=BB2_259 Depth=1
	move	$t8, $s8
	move	$t7, $s1
	ld.d	$fp, $sp, 368                   # 8-byte Folded Reload
	beq	$t2, $fp, .LBB2_286
.LBB2_284:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_259 Depth=1
	addi.w	$fp, $s4, 0
	beq	$t3, $fp, .LBB2_286
...
.LBB2_286:                              #   in Loop: Header=BB2_259 Depth=1
	blez	$t2, .LBB2_290
# %bb.287:                              #   in Loop: Header=BB2_259 Depth=1
	blez	$t3, .LBB2_290
...
.LBB2_292:                              # %.lr.ph50.i
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_292
.LBB2_293:                              # %.preheader.i585
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 128                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 336                   # 8-byte Folded Reload
	blez	$s2, .LBB2_296
# %bb.294:                              # %.lr.ph52.preheader.i
	move	$fp, $s3
	move	$s0, $s2
	.p2align	4, , 16
.LBB2_295:                              # %.lr.ph52.i
	...
	addi.d	$s7, $s7, 8
	bnez	$s0, .LBB2_295
.LBB2_296:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 344                   # 8-byte Folded Reload
	...
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	blt	$a2, $a3, .LBB2_298
# %bb.297:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	blt	$a3, $a0, .LBB2_299
.LBB2_298:
