# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
...
# 79 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
 ...
 for( i=0; i<clus1; i++ )
 {
  for( j=0; j<clus2; j++ )
  {
   ...
   while( tmpptr )
   {
    ...
    {
# 114 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
     while( *pt != 0 )
     {
    ...
    {
# 143 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
     while( *pt != 0 )
     {
      if( *pt++ != '-' ) tmpint++;
...
# 210 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
}
...
# 262 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
 for( i=0; i<lgth1; i++ ) for( j=0; j<lgth2; j++ )
  impmtx[i][j] = 0.0;
 for( i=0; i<clus1; i++ )
 {
...
# 369 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
}
...
# 458 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
}
      ...
      int *gapmap1, int *gapmap2 )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 481 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
                        ...
                        int **ijp, int icyc, int jcyc )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 592 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
...
# 877 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
  orlgth1 = ll1 - 100;
  orlgth2 = ll2 - 100;
 }
 ...
 lastj = lgth2+1;
# 1063 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
  previousw = currentw;
...
# 1082 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
  if( localhom )
  {
...
# 1098 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
...
# 1227 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
 if( localhom )
 {
...
# 1256 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c"
 return( wm );
}
