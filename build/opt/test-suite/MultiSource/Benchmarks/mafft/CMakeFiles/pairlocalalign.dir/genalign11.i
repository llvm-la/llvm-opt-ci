# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c" 2
...
# 90 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
                        ...
                        int **ijpi, int **ijpj, int *off1pt, int *off2pt, int endi, int endj )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 109 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
    for( i=0; i<lgth1+1; i++ )
    {
        ijpi[i][0] = localstop;
        ijpj[i][0] = localstop;
...

{
 ...
 if( lgth1 > orlgth1 || lgth2 > orlgth2 )
 {
  ...
  floatwork = AllocateFloatMtx( 26, ( ((ll1)>(ll2))?(ll1):(ll2) )+2 );
  intwork = AllocateIntMtx( 26, ( ((ll1)>(ll2))?(ll1):(ll2) )+2 );
...
# 376 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
 localstop = lgth1+lgth2+1;
 maxwm = -999999999.9;
 endali = endalj = 0;
# 388 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
 lasti = lgth1+1;
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
...
# 423 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
...
# 570 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
   *curpt += wm;
   ijpipt++;
   ijpjpt++;
   mjpt++;
...
# 594 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
 if( ijpi[endali][endalj] == localstop )
 {
  strcpy( seq1[0], "" );
  strcpy( seq2[0], "" );
  *off1pt = *off2pt = 0;
...
# 625 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/genalign11.c"
 return( maxwm );
}
