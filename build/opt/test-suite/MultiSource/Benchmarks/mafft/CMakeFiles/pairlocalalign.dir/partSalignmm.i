# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c" 2
# 59 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
...
# 126 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
 ...
 for( i=0; i<clus1; i++ )
 {
  for( j=0; j<clus2; j++ )
  {
   ...
   while( tmpptr )
   {
    ...
    {
# 161 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
     while( *pt != 0 )
     {
    ...
    {
# 190 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
     while( *pt != 0 )
     {
      if( *pt++ != '-' ) tmpint++;
...
# 257 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
}
...
# 309 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
 for( i=0; i<lgth1; i++ ) for( j=0; j<lgth2; j++ )
  impmtx[i][j] = 0.0;
 for( i=0; i<clus1; i++ )
 {
...
# 416 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
}
...
# 505 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
}
      ...
      int *gapmap1, int *gapmap2 )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 528 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
                        ...
                        int **ijp, int icyc, int jcyc )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 639 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
 if( outgap == 1 )
  ;
 else
 {
...
# 858 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
  orlgth1 = ll1 - 100;
  orlgth2 = ll2 - 100;
 }
 ...
 lastj = lgth2+1;
# 996 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
 for( i=1; i<lasti; i++ )
 {
  wtmp = previousw;
  previousw = currentw;
...
# 1015 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
  if( localhom )
  {
...
# 1031 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
...
# 1125 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
 if( localhom )
 {
...
# 1152 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
 return( wm );
}
