# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c" 2
# 13 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
...
# 77 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 matchpt = match;
 cpmxpdnpt = cpmxpdn;
 cpmxpdpt = cpmxpd;
 while( lgth2-- )
...
# 117 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
    for( i=0; i<lgth1+1; i++ )
    {
        ijp[i][0] = i + 1;
    }
...

{
 ...
 lgth1 = ien-ist+1;
 lgth2 = jen-jst+1;
# 244 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 ll1 = ( (int)(lgth1) ) + 100;
 ll2 = ( (int)(lgth2) ) + 100;
# 254 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 ...
 floatwork = AllocateFloatMtx( ( ((ll1)>(ll2))?(ll1):(ll2) )+2, 27 );
...

{
 ...
 lgth1 = ien-ist+1;
 lgth2 = jen-jst+1;
# 501 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 if( lgth2 <= 0 )
 {
    ...
    if( lgth1 < 100 || lgth2 < 100 )
 {
  ...
  free( aseq1 );
  free( aseq2 );
# 555 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
  return( value );
 }
...
# 605 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 currentw = w1;
 previousw = w2;
...
# 634 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 for( j=1; j<lgth2+1; ++j )
 {
...

 {
  ...
  lastverticalw[i] = currentw[lgth2-1];
# 774 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 }
# 802 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
...
# 834 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 for( j=lgth2-1; j>0; --j )
 {
...
# 1039 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
  }
  if( i == jumpi )
  {
...
# 1060 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
   else if( jmid >= lgth2 )
   {
...
# 1082 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
   break;

  }
 }
# 1174 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 FreeFloatVec( w1 );
 FreeFloatVec( w2 );
 FreeFloatVec( initverticalw );
 FreeFloatVec( lastverticalw );
 ...
 FreeFloatMtx( floatwork );
 FreeIntMtx( intwork );
# 1206 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
...
# 1220 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 len = strlen( mseq1[0] );
...
# 1274 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
...
# 1323 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 free( gaps );
...
# 1450 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 gapinfo[0] = ogcp1;
 gapinfo[1] = fgcp1;
 gapinfo[2] = ogcp2;
 gapinfo[3] = fgcp2;
# 1471 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
 wm = MSalignmm_rec( icyc, jcyc, eff1, eff2, seq1, seq2, cpmx1, cpmx2, 0, lgth1-1, 0, lgth2-1, alloclen, mseq1, mseq2, 0, gapinfo );
# 1482 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalignmm.c"
