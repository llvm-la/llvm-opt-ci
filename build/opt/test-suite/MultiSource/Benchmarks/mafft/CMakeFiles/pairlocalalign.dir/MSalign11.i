# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c" 2
                        ...
                        int **ijp )
{
 ...
 lgth1 = strlen( seq1[0] );
 lgth2 = strlen( seq2[0] );
# 64 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c"
    for( i=0; i<lgth1+1; i++ )
    {
        ijp[i][0] = i + 1;
    }
...
# 171 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c"
 for( j=lgth2-1; j>0; --j )
 {
  m[j-1] = currentw[j];
  mp[j] = 0;
...
# 253 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c"
   forwwm = wm + ( ((maxinw[i])<(maxinh[j]))?(maxinw[i]):(maxinh[j]) );
   WMMTX[i][j] = forwwm;
...

{
 ...
 float *maxinw = ((void*)0), *maxinwpt = ((void*)0);
 float *maxinh = ((void*)0);
...
# 607 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c"
 mseq1[0] += lgth1+lgth2;
 *mseq1[0] = 0;
 mseq2[0] += lgth1+lgth2;
 *mseq2[0] = 0;
 ...
 fprintf( stderr, ">MSres\n%s\n", mseq2[0] );
# 632 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/MSalign11.c"
 mseq1[0] = mseq[0];
 mseq2[0] = mseq[1];
 mseq1[0] += lgth1+lgth2;
 *mseq1[0] = 0;
