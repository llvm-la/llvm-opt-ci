# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c" 2
...
# 2 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/dp.h" 1
extern int commonAlloc1;
extern int commonAlloc2;
extern int **commonIP;
extern int **commonJP;
# 3 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c" 2
# 12 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
...
# 177 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
 free( pairnum );
...
void rnaalifoldcall( char **seq, int nseq, RNApair **pairprob )
{
 ...
 clustalout_pointer( fp, nseq, lgth, seq, name, ((void*)0), ((void*)0), order );
 fclose( fp );
...
# 243 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
 while( 1 )
 {
  fgets( gett, 999, fp );
  if( gett[0] == '(' ) break;
  ...
  left--;
  right--;
# 263 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
  if( prob > 0.0 )
  {
   pairprob[left] = (RNApair *)realloc( pairprob[left], (pairnum[left]+2) * sizeof( RNApair ) );
...
# 309 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
 free( pairnum );
}
...
void foldrna( int nseq1, int nseq2, char **seq1, char **seq2, double *eff1, double *eff2, RNApair ***grouprna1, RNApair ***grouprna2, float **impmtx, int *gapmap1, int *gapmap2, RNApair *additionalpair )
{
 ...
 nogapdum = AllocateCharVec( ( ((lgth1)>(lgth2))?(lgth1):(lgth2) ) );
...
# 430 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
 Lalignmm_hmout( oseq1, oseq2, eff1, eff2, nseq1, nseq2, 10000, ((void*)0), ((void*)0), ((void*)0), ((void*)0), map );
 ...
 if( 1 )
 {
  ...
  for( i=0; i<lgth1; i++ ) for( pairpt1=pairprob1[i]; pairpt1->bestpos!=-1; pairpt1++ )
  {
   ...
   for( j=0; j<lgth2; j++ ) for( pairpt2=pairprob2[j]; pairpt2->bestpos!=-1; pairpt2++ )
   {
    ...
    ujdo = pairpt2->bestpos;
    prob = pairpt1->bestscore * pairpt2->bestscore;
# 510 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
    if( uido > -1 && ujdo > -1 && ( ( i > uido && j > ujdo ) || ( i < uido && j < ujdo ) ) )
    {
     {
      impmtx2[i][j] += ( ((0)>(map[uido][ujdo]))?(0):(map[uido][ujdo]) ) * consweight_rna * 600 * prob;
     }
    }
...
# 543 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mafft/rna.c"
 }
