# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c" 2
# 30 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
...
# 31 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c" 2
...
# 33 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c" 2
...
# 34 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c" 2
...
int dc_dct_pred[];
{
  ...
  for (i=1; ; i++)
  {
    ...
    Flush_Buffer(tab->len);
# 345 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
    if (tab->run==64)
    {
    ...
    if (tab->run==65)
    {
# 364 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
      i+= run = Get_Bits(6);
# 374 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
      val = Get_Bits(12);
      if ((val&2047)==0)
      {
        if (!Quiet_Flag)
...
int comp;
{
  ...
  for (i=0; ; i++)
  {
    ...
    Flush_Buffer(tab->len);
# 497 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
    if (tab->run==64)
    {
    ...
    if (tab->run==65)
    {
# 516 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
      i+= run = Get_Bits(6);
# 526 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getblk.c"
      val = Get_Bits(12);
      if ((val&2047)==0)
      {
        if (!Quiet_Flag)
