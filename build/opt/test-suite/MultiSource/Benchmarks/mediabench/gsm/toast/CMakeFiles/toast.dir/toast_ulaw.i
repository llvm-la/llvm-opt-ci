# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_ulaw.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_ulaw.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_ulaw.c" 2
...
int ulaw_input (gsm_signal * buf)
{
 ...
 for (i = 0; i < 160 && (c = fgetc(in)) != (-1); i++) buf[i] = (u2s[ (unsigned char)(c) ]);
