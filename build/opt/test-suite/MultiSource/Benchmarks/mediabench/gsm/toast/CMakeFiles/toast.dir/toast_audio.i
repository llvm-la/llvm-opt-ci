# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_audio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_audio.c" 2
...
# 10 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_audio.c" 2
...
static int put_u32 (FILE * f, unsigned long u)
{
 ...
 if ( putc( (char)((u>>24) & 0x0FF), f) == (-1)
    || putc( (char)((u>>16) & 0x0FF), f) == (-1)
    || putc( (char)((u>> 8) & 0x0FF), f) == (-1)
    || putc( (char)( u & 0x0FF), f) == (-1)) return -1;
...
static int get_u32 (FILE * f, unsigned long * up)
{
 ...
 if ( (i = getc(f)) == (-1)
    || ((u = (unsigned char)i), (i = getc(f)) == (-1))
    || ((u = (u<<8)|(unsigned char)i), (i = getc(f)) == (-1))
    || ((u = (u<<8)|(unsigned char)i), (i = getc(f)) == (-1))) return -1;
