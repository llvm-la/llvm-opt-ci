# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/BilateralFiltering/bilateralFilterKernel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 399 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/BilateralFiltering/bilateralFilterKernel.c" 2
...
# 1 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/BilateralFiltering/bilateralFiltering.h" 1
# 8 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/BilateralFiltering/bilateralFilterKernel.c" 2
...
# 9 "/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/ImageProcessing/BilateralFiltering/bilateralFilterKernel.c" 2
...
void bilateralFilterKernel(int height, int width, int inputImage[128][128],
    ...
    for (int y = half; y < width - half; y++) {
      ...
      for (int i = 0; i < diameter; i++) {
        for (int j = 0; j < diameter; j++) {
          neighbor_x = x - (half - i);
          neighbor_y = y - (half - j);
          double gi = (exp(-(inputImage[neighbor_x][neighbor_y] - inputImage[x][y] * inputImage[neighbor_x][neighbor_y] - inputImage[x][y]) / (2 * 12.0 * 12.0)) / (2 * 3.14159265358979323846 * (12.0 * 12.0)));

          double gs =
              (exp(-((float)(sqrt(((x - neighbor_x) * (x - neighbor_x)) + ((y - neighbor_y) * (y - neighbor_y)))) * (float)(sqrt(((x - neighbor_x) * (x - neighbor_x)) + ((y - neighbor_y) * (y - neighbor_y))))) / (2 * 16.0 * 16.0)) / (2 * 3.14159265358979323846 * (16.0 * 16.0)));
