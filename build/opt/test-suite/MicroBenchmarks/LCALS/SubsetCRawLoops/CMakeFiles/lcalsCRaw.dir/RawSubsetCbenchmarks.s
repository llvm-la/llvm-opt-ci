...
# %bb.10:                               #   in Loop: Header=BB20_4 Depth=1
	...
	b	.LBB20_14
	.p2align	4, , 16
.LBB20_11:                              # %vector.body.preheader
                                        #   in Loop: Header=BB20_4 Depth=1
	move	$a3, $s1
	move	$a4, $s5
	move	$a5, $s2
...
.LBB21_7:                               # %.preheader200.us
	...
	ori	$a1, $zero, 4
	bgeu	$a0, $a1, .LBB21_10
.LBB21_8:                               # %scalar.ph607.preheader
                                        #   in Loop: Header=BB21_7 Depth=2
...
.LBB21_32:                              # %.preheader199.us
	...
	ori	$a1, $zero, 4
	bgeu	$a0, $a1, .LBB21_35
.LBB21_33:                              # %scalar.ph494.preheader
                                        #   in Loop: Header=BB21_32 Depth=2
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	sub.d	$a4, $a0, $t4
	slli.d	$a5, $t4, 3
...
# %bb.58:                               #   in Loop: Header=BB21_4 Depth=1
	...
	ori	$fp, $zero, 16
.LBB21_59:                              # %scalar.ph387.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	alsl.d	$a1, $a0, $a3, 3
	alsl.d	$a2, $a0, $a4, 3
	alsl.d	$a3, $a0, $a5, 3
...
.LBB21_61:                              # %._crit_edge.us213
	...
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	bgeu	$a1, $t8, .LBB21_85
.LBB21_62:                              # %scalar.ph353.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
...
.LBB21_64:                              # %._crit_edge.us213.1
	...
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	bgeu	$a1, $t8, .LBB21_97
.LBB21_65:                              # %scalar.ph319.preheader
                                        #   in Loop: Header=BB21_4 Depth=1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a2, $a0, $t0, 3
