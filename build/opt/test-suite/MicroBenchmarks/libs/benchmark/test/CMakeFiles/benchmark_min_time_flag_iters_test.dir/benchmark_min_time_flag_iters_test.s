...
# %bb.10:                               # %._crit_edge.i.i
	...
	addi.d	$s4, $a0, %pc_lo12(_ZTVN12_GLOBAL__N_112TestReporterE+16)
	st.d	$s4, $sp, 48
	st.d	$zero, $sp, 144
	vrepli.b	$vr0, 0
	vst	$vr0, $sp, 152
...
# %bb.15:
	...
	lu52i.d	$a0, $a0, 2047
	bgeu	$s1, $a0, .LBB2_26
# %bb.16:                               # %_ZNSt15__new_allocatorIlE8allocateEmPKv.exit.i.i.i.i
.Ltmp15:                                # EH_LABEL
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Znwm)
	jirl	$ra, $ra, 0
...
.LBB2_19:                               # %.thread
	move	$s0, $zero
	move	$s5, $s1
.LBB2_20:                               # %_ZNSt6vectorIlSaIlEEC2ERKS1_.exit
	beq	$s0, $s5, .LBB2_28
# %bb.21:
	ld.d	$a0, $s0, 0
	ori	$a1, $zero, 4
	bne	$a0, $a1, .LBB2_28
# %bb.22:                               # %_ZNSt6vectorIlSaIlEED2Ev.exit
	sub.d	$a1, $s5, $s0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
# %bb.23:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB2_24:                               # %_ZNSt6vectorIlSaIlEED2Ev.exit.i
...
.Ltmp20:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp21:                                # EH_LABEL
# %bb.25:                               # %_ZNSt6vectorIPKcSaIS1_EED2Ev.exit
	addi.d	$a0, $sp, 48
...
.Ltmp14:                                # EH_LABEL
	...
	move	$s0, $a0
	beq	$a2, $s1, .LBB2_39
# %bb.35:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i29
	ld.d	$a0, $sp, 32
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.Ltmp19:                                # EH_LABEL
	move	$s0, $a0
.LBB2_39:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit31
	addi.d	$a0, $sp, 48
	pcaddu18i	$ra, %call36(_ZN12_GLOBAL__N_112TestReporterD2Ev)
	jirl	$ra, $ra, 0
.LBB2_40:                               # %_ZNSt6vectorIPKcSaIS1_EED2Ev.exit38
	sub.d	$a1, $s3, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.Lcst_begin1:
	...
	.uleb128 .Ltmp19-.Lfunc_begin1          #     jumps to .Ltmp19
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp18-.Lfunc_begin1          # >> Call Site 11 <<
...
# %bb.1:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_2:                                # %_ZNSt6vectorIlSaIlEED2Ev.exit
	pcalau12i	$a0, %got_pc_hi20(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a0, $a0, %got_pc_lo12(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a1, $fp, 56
	addi.d	$a0, $a0, 16
...
.LBB6_3:
	...
	lu52i.d	$a0, $a0, 2047
	beq	$s0, $a0, .LBB6_11
# %bb.4:                                # %_ZNSt12_Vector_baseIlSaIlEE11_M_allocateEm.exit.i.i
	move	$s2, $a1
	srai.d	$a0, $s0, 3
	ori	$a1, $zero, 1
	sltu	$a2, $a1, $a0
...
# %bb.5:
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB6_6:                                # %_ZNSt6vectorIlSaIlEE11_S_relocateEPlS2_S2_RS0_.exit.i.i
	add.d	$s5, $s1, $s0
	beqz	$fp, .LBB6_8
# %bb.7:
	move	$a0, $fp
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB6_8:                                # %_ZNSt6vectorIlSaIlEE17_M_realloc_appendIJRKlEEEvDpOT_.exit.i
	addi.d	$a1, $s5, 8
	move	$a0, $s3
	st.d	$s1, $s3, 96
	st.d	$a1, $s3, 104
	...
	st.d	$a1, $s3, 112
	move	$a1, $s2
.LBB6_9:                                # %_ZNSt6vectorIlSaIlEE9push_backERKl.exit
...
# %bb.1:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB8_2:                                # %_ZNSt6vectorIlSaIlEED2Ev.exit.i
	pcalau12i	$a0, %got_pc_hi20(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a0, $a0, %got_pc_lo12(_ZTVN9benchmark15ConsoleReporterE)
	ld.d	$a1, $fp, 56
	addi.d	$a0, $a0, 16
...
# %bb.7:                                # %_ZNSt10unique_ptrIN9benchmark9BenchmarkESt14default_deleteIS1_EED2Ev.exit4.i
	...
	st.d	$zero, $sp, 24
	bnez	$a0, .LBB11_10
.LBB11_8:                               # %_ZNSt10unique_ptrIN9benchmark8internal17FunctionBenchmarkESt14default_deleteIS2_EED2Ev.exit7.i
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB11_9:                               # %_ZNKSt14default_deleteIN9benchmark9BenchmarkEEclEPS1_.exit.i3.i
	ld.d	$a0, $a1, 0
	ld.d	$a2, $a0, 8
	move	$a0, $a1
	jirl	$ra, $a2, 0
	...
	st.d	$zero, $sp, 24
	beqz	$a0, .LBB11_8
.LBB11_10:                              # %_ZNKSt14default_deleteIN9benchmark8internal17FunctionBenchmarkEEclEPS2_.exit.i6.i
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 8
	jirl	$ra, $a1, 0
	move	$a0, $fp
	...
	jirl	$ra, $ra, 0
.Lfunc_end11:
	.size	_GLOBAL__sub_I_benchmark_min_time_flag_iters_test.cc, .Lfunc_end11-_GLOBAL__sub_I_benchmark_min_time_flag_iters_test.cc
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table11:
...
.Lcst_begin4:
	...
	.uleb128 .Lfunc_end11-.Ltmp30           #   Call between .Ltmp30 and .Lfunc_end11
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end4:
	.p2align	2, 0x0
...
.L.str.4:
	.asciz	"/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MicroBenchmarks/libs/benchmark/test/benchmark_min_time_flag_iters_test.cc"
	.size	.L.str.4, 157
